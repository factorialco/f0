...
export const maturityLevels: Maturity[] = [
  {
    ...
    examples: "F0Select, F0TextInput, F0Drawer, F0Accordion…",
  ...
  },
  {
    ...
    examples: "F0Alert, F0Button, F0Checkbox, F0DatePicker…",
    storybookTag: "stable",
    jsdocMarker: null,
  },
  {
    ...
    canIUse:
      "Not for new work. It keeps working for at least one quarter, but it's on its way out — use the suggested replacement instead.",
    rules: [
    ...
    examples: "Anything carrying @deprecated + @removeIn + @migration — migrate before removal.",

...
export const competencies: Competency[] = [
  ...
  },
  {
    ...
    name: "Code Quality",
    category: "technical",
    description: "Writing clean, tested, and well-documented code",
  },
  {
    id: "comp-003",
    name: "People Management",
    category: "leadership",
    description: "Coaching, growing, and supporting direct reports",
  },
  {
    id: "comp-004",
    name: "Strategic Thinking",
    category: "leadership",
    description: "Setting direction and making long-term decisions",
  },
  {
    id: "comp-005",
    name: "Written Communication",
    category: "communication",
    description: "Clear, concise, and effective written communication",
  },
  {
    id: "comp-006",
    name: "Presentation Skills",
    category: "communication",
    description: "Delivering engaging and clear presentations",
  },
  {
    id: "comp-007",
    name: "Delivery",
    category: "execution",
    description: "Consistently shipping high-quality work on time",
  },
  {
    id: "comp-008",
    name: "Problem Solving",
    category: "execution",
    description: "Breaking down complex problems into actionable steps",
  },
]
...
export const feedbacks: Feedback[] = [
  {
    ...
    visibility: "public",
    content:
      "Alan's architecture proposal for the event system was exceptional — clear trade-offs, pragmatic choices.",
  ...
  },
  {
    ...
    visibility: "public",
    content:
      "Lin shipped the payroll migration ahead of schedule with zero regressions. Incredible attention to detail.",
    createdAt: "2026-04-28",
  },
  {
    id: "fb-003",
    fromEmployeeId: "emp-005",
    toEmployeeId: "emp-004",
    type: "constructive",
    visibility: "private",
    content:
      "It would help if sprint priorities were communicated earlier — the late changes last week caused some churn.",
    createdAt: "2026-04-25",
  },
  {
    id: "fb-004",
    fromEmployeeId: "emp-010",
    toEmployeeId: "emp-009",
    type: "praise",
    visibility: "public",
    content:
      "Great job facilitating the cross-team alignment. The outcome was much better than expected.",
  ...
  },
  {
    ...
    content:
      "The onboarding redesign needs more stakeholder input before moving to implementation.",
  ...
  },
  {
    ...
    visibility: "public",
    content:
      "Ada's mentorship during the architecture review process has been invaluable.",
    createdAt: "2026-04-15",
  },
  {
    id: "fb-007",
    ...
    visibility: "public",
    content:
      "The onboarding flow improvements show real user empathy. Drop-off metrics are already improving.",
    createdAt: "2026-04-12",
  },
  {
    id: "fb-008",
    fromEmployeeId: "emp-014",
    toEmployeeId: "emp-013",
    type: "constructive",
    visibility: "private",
    content:
      "Pipeline updates need to be more frequent — the team was surprised by the Q1 miss.",
    createdAt: "2026-04-10",
  },
  {
    id: "fb-009",
    ...
    visibility: "private",
    content:
      "Would love your input on the new engineering ladder draft — your perspective on IC growth would be valuable.",
    createdAt: "2026-05-05",
  },
  {
    id: "fb-010",
    ...
    visibility: "public",
    content:
      "Lin's documentation on the new charting API saved the team hours of onboarding time.",

...
export type JobCatalogNodeType =
  | "root"
  | "family"
  | "function"
  | "role"
          ...
          children: [
            {
              ...
              type: "role",
              description:
                "Designs, builds, and maintains server-side applications and APIs.",
              children: [
                {
                  id: "lvl-be-jr",
                  name: "Junior",
          ...
          children: [
            {
              ...
              type: "role",
              description:
                "Builds and maintains client-side web applications using React and TypeScript.",
              children: [
                {
                  id: "lvl-fe-jr",
                  name: "Junior",
          ...
          children: [
            {
              ...
              type: "role",
              description:
                "Ensures the reliability, scalability, and performance of production systems.",
              children: [
            ...
            },
            {
              ...
              type: "role",
              description:
                "Builds and maintains CI/CD pipelines and infrastructure automation.",
              children: [
                {
                  id: "lvl-devops-mid",
                  name: "Mid",
          ...
          children: [
            {
              ...
              type: "role",
              description:
                "Leads engineering teams, manages delivery and people development.",
              children: [
          ...
          children: [
            {
              ...
              type: "role",
              description:
                "Defines product strategy and roadmap, works with engineering and design.",
              children: [
                {
                  id: "lvl-pm-jr",
                  name: "Junior",
          ...
          children: [
            {
              ...
              type: "role",
              description:
                "Creates user-centered designs and prototypes for product features.",
              children: [
                {
                  id: "lvl-pd-jr",
                  name: "Junior",
          ...
          children: [
            {
              ...
              type: "role",
              description:
                "Manages the full sales cycle from prospecting to close.",
              children: [
                {
                  id: "lvl-ae-jr",
                  name: "Junior",
          ...
          children: [
            {
              ...
              type: "role",
              description:
                "Generates qualified pipeline through outbound prospecting.",
              children: [

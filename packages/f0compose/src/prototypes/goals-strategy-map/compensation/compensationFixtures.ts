...
export const incentivePlans: IncentivePlan[] = [
  {
    ...
    description:
      "Standard commission plan for all AEs — 10% on new ARR, 5% on expansion.",
    status: "active",
    type: "commission",
    frequency: "quarterly",
    currency: "EUR",
  ...
  },
  {
    ...
    description:
      "Performance-based bonus pool for engineering tied to OKR completion.",
    status: "active",
    type: "bonus",
    frequency: "annual",
    currency: "EUR",
  ...
  },
  {
    ...
    description:
      "Management by objectives for VP+ roles. Payout tied to company KPIs.",
    status: "active",
    type: "mbo",
    frequency: "annual",
    currency: "EUR",
  ...
  },
  {
    ...
    description:
      "One-time bonus for closing deals with the new Analytics add-on.",
    status: "draft",
    type: "spiff",
    frequency: "one-time",
    currency: "EUR",
...
export const compensationReviews: CompensationReview[] = [
  ...
  },
  {
    ...
    effectiveDate: "2026-07-01",
    managerId: "emp-004",
    reason: "Market adjustment + strong performance",
  },
  {
    id: "cr-003",
    employeeId: "emp-007",
    ...
    effectiveDate: "2026-07-01",
    managerId: "emp-008",
    reason: "Exceeds expectations in onboarding redesign",
  },
  {
    id: "cr-004",
    employeeId: "emp-009",
    ...
    effectiveDate: "2026-07-01",
    managerId: "emp-010",
    reason: "No change — recently promoted",
  },
  {
    id: "cr-005",
    employeeId: "emp-013",
    ...
    effectiveDate: "2026-07-01",
    managerId: "emp-014",
    reason: "Performance improvement plan completed",
  },
  {
    id: "cr-006",
    employeeId: "emp-006",
    ...
    effectiveDate: "2026-07-01",
    managerId: "emp-004",
    reason: "Strong delivery on payroll editor",
  },
  {
    id: "cr-007",
    employeeId: "emp-011",
    ...
    effectiveDate: "2026-07-01",
    managerId: "emp-002",
    reason: "Standard annual increase",
  },
  {
    id: "cr-008",
    employeeId: "emp-015",
    ...
    effectiveDate: "2026-07-01",
    managerId: "emp-010",
    reason: "Retention risk — below market midpoint",
  },
]
...
export const equityGrants: EquityGrant[] = [
  {
    ...
    vestingSchedule: "4y / 1y cliff",
    cliffDate: "2024-06-01",
    fullyVestedDate: "2027-06-01",
  },
  {
    id: "eq-002",
    employeeId: "emp-003",
  ...
  },
  {
    ...
    vestingSchedule: "4y / 1y cliff",
    cliffDate: "2023-09-01",
    fullyVestedDate: "2026-09-01",
  },
  {
    id: "eq-005",
    employeeId: "emp-008",
  ...
  },
  {
    ...
    vestingSchedule: "4y / 1y cliff",
    cliffDate: "2027-07-01",
    fullyVestedDate: "2030-07-01",
  },
  {
    id: "eq-008",
    employeeId: "emp-002",

...
export function OneHomeRecommendation({
  ...
  return (
    <button
      ...
      // 124px backdrop blur under every weight (Angel, 2026-09-15).
      className={`f0c-pressable inline-flex h-8 shrink-0 cursor-pointer items-center overflow-hidden whitespace-nowrap rounded border-none text-base font-medium backdrop-blur-[124px] ${done ? "px-1.5" : "pl-2.5 pr-3.5"} ${CHROME[variant]}`}
    >

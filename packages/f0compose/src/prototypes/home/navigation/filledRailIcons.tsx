...
/** The tray closes and fills; its inner lip is an open path, which lands
 *  on top of the fill in the same colour and so simply disappears. */
...
/** The body subpath closes across the top edge and fills; the two hanging
 *  pins are zero-area segments in the same path, so they keep drawing
 *  from the stroke. */

/**
 * Deterministic helpers for mocks. Use a fixed TODAY (not `new Date()`) so
 * prototypes render the same dates on every visit.
 */
...
/**
 * Natural-language relative date vs. mock TODAY: "today", "yesterday",
 * "3 days ago", "2 weeks ago", "5 months ago". Deterministic.
 */

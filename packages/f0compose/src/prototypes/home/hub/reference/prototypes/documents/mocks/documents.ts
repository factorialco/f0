...
export const documents: DocNode[] = [
  ...
  // The reports One produces land in the library like any other file
  // (Angel, 2026-09-15): Files lost its separate Reports and Artifacts
  // destinations, so this is where they live.
  {
    id: "doc-headcount-report",
    name: "Headcount plan vs actuals.xlsx",
    name_es: "Plan de plantilla vs real.xlsx",
    kind: "document",
    section: "company",
    visibility: "private",
    parentId: null,
  ...
  {
    id: "doc-hiring-funnel",
    name: "Q2 hiring funnel.pdf",
    name_es: "Embudo de contratacion T2.pdf",
    kind: "document",
    section: "company",
    visibility: "private",
    parentId: null,
  ...
  {
    id: "doc-absence-trends",
    name: "Absence trends H1 2026.xlsx",
    name_es: "Tendencias de ausencias S1 2026.xlsx",
    kind: "document",
    section: "company",
    visibility: "private",
    parentId: null,

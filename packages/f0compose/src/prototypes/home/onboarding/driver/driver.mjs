...
function M() {
  ...
  ;(e && window.cancelAnimationFrame(e),
    k("__resizeTimeout", window.requestAnimationFrame(xe)))
}
function Pe(e) {
  var r
...
function ke() {
  ;(window.addEventListener("keyup", ne, !1),
...
function Q(e, o) {
  ...
  const m =
    ((b = o.popover) == null ? void 0 : b.popoverClass) ||
    s("popoverClass") ||
    ""
  ;((u.className = `driver-popover ${m}`.trim()),
    re(
      ...
      (E) => {
        ...
        const T = E.target,
          A =
            ((B = o.popover) == null ? void 0 : B.onNextClick) ||
            s("onNextClick"),
          H =
            ((R = o.popover) == null ? void 0 : R.onPrevClick) ||
            s("onPrevClick"),
          $ =
            ((W = o.popover) == null ? void 0 : W.onCloseClick) ||
            s("onCloseClick")
...
function Ae(e = {}) {
  ...
  function f() {
    ...
    if (
      ...
      return
    const m =
      ((x = c.popover) == null ? void 0 : x.onPrevClick) || s("onPrevClick")
    if (m)
      return m(u, c, {
        config: s(),
        state: l(),
  ...
  function v(a = 0) {
    ...
    const c = p[a],
      ...
      h = p[a - 1],
      m =
        (($ = c.popover) == null ? void 0 : $.doneBtnText) ||
        s("doneBtnText") ||
        "Done",
      x = s("allowClose"),
      C =
        typeof ((B = c.popover) == null ? void 0 : B.showProgress) !=
        "undefined"
          ? (R = c.popover) == null
            ? void 0
            : R.showProgress
          : s("showProgress"),
      b = (
        ((W = c.popover) == null ? void 0 : W.progressText) ||
        s("progressText") ||
        "{{current}} of {{total}}"
      )
        .replace("{{current}}", `${a + 1}`)
      ...
      P =
        ((V = c.popover) == null ? void 0 : V.showButtons) || s("showButtons"),
      E = ["next", "previous", ...(x ? ["close"] : [])].filter(
        (ce) => !(P != null && P.length) || P.includes(ce)
      ),
      T =
        ((q = c.popover) == null ? void 0 : q.onNextClick) || s("onNextClick"),
      A =
        ((K = c.popover) == null ? void 0 : K.onPrevClick) || s("onPrevClick"),
      H =
        ((Y = c.popover) == null ? void 0 : Y.onCloseClick) || s("onCloseClick")
    j({
      ...c,
      popover: {
        showButtons: E,

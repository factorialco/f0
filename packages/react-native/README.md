...
## 🤖 PR Previews (Automated with EAS Update)

For pull requests, CI automatically publishes an Expo preview for each PR update.

- Trigger: `pull_request` (`opened`, `synchronize`)
- Scope: PRs targeting any base branch
- Publish branch: `development`
- Update message: latest commit subject + short SHA

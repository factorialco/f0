 ...
 */
export const F0_LINK_VARIANTS = ["link", "unstyled", "mention"] as const
 ...
 */
export const F0_LINK_SIZES = ["xs", "sm", "md"] as const
 ...
 */
export const F0_LINK_TARGETS = ["_blank", "_self", "_parent", "_top"] as const
 ...
 */
const F0_LINK_CONTROLLED_PASSTHROUGH_PROPS = [
  "onPressIn",
  "onPressOut",
  "accessibilityRole",
  "accessibilityState",
...
export const F0_LINK_BANNED_PROPS = ["style"] as const

export const F0_LINK_BLOCKED_FORWARD_PROPS = [
  ...F0_LINK_CONTROLLED_PASSTHROUGH_PROPS,
  ...F0_LINK_BANNED_PROPS,
] as const

interface F0LinkPropsInternal extends Omit<
  PressableFeedbackProps,
  | "children"
  | "variant"
  | "disabled"
  | (typeof F0_LINK_CONTROLLED_PASSTHROUGH_PROPS)[number]
> {
  /**
   * Link content.
   */
 ...
 */
export type F0LinkProps = Omit<
  F0LinkPropsInternal,
  (typeof F0_LINK_BANNED_PROPS)[number]
>

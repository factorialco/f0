...
export const getMask = {
  base: {
    ...
    lg: "path('M40 0H0V40H30.2547C29.4638 38.8662 29 37.4872 29 36C29 32.134 32.134 29 36 29C37.4872 29 38.8662 29.4638 40 30.2547V0Z')",
    medium:
  ...
  rounded: {
    ...
    lg: "path('M38.7127 29.8197C39.5447 27.3489 40 24.7268 40 22C40 9.84974 30.1503 0 18 0C5.84974 0 0 9.84974 0 22C0 30.1503 5.84974 40 18 40C20.7268 40 24.7489 39.5447 29.8197 38.7127C28.6421 36.4324 28 34.2912 28 32C28 28.134 31.134 25 35 25C36.2912 25 37.4324 25.6421 38.7127 29.8197Z')",
    medium:

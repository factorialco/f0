...
export const F0_CHIP_VARIANTS = ["default", "selected"] as const
...
export type F0ChipProps = F0ChipBaseProps &
  (F0ChipWithAvatar | F0ChipWithIcon | F0ChipWithoutLeadingVisual)

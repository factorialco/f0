      ...
      >
        <View className="p-6">
          ...
          <ColorGroup
            ...
            colors={[
              { name: "f0-foreground", color: f1Foreground },
              { name: "f0-foreground-secondary", color: f1ForegroundSecondary },
              { name: "f0-foreground-tertiary", color: f1ForegroundTertiary },
              { name: "f0-foreground-disabled", color: f1ForegroundDisabled },
              { name: "f0-foreground-inverse", color: f1ForegroundInverse },
              {
                name: "f0-foreground-inverse-secondary",
                color: f1ForegroundInverseSecondary,
              },
              { name: "f0-foreground-accent", color: f1ForegroundAccent },
              { name: "f0-foreground-critical", color: f1ForegroundCritical },
              { name: "f0-foreground-info", color: f1ForegroundInfo },
              { name: "f0-foreground-warning", color: f1ForegroundWarning },
              { name: "f0-foreground-positive", color: f1ForegroundPositive },
              { name: "f0-foreground-selected", color: f1ForegroundSelected },
            ]}
          />
          ...
          <ColorGroup
            ...
            colors={[
              { name: "f0-background", color: f1Background },
              { name: "f0-background-hover", color: f1BackgroundHover },
              { name: "f0-background-secondary", color: f1BackgroundSecondary },
              {
                name: "f0-background-secondary-hover",
                color: f1BackgroundSecondaryHover,
              },
              { name: "f0-background-tertiary", color: f1BackgroundTertiary },
              { name: "f0-background-inverse", color: f1BackgroundInverse },
              {
                name: "f0-background-inverse-secondary",
                color: f1BackgroundInverseSecondary,
              },
              { name: "f0-background-bold", color: f1BackgroundBold },
              { name: "f0-background-accent", color: f1BackgroundAccent },
              {
              ...
              { name: "f0-background-promote", color: f1BackgroundPromote },
              {
                name: "f0-background-promote-hover",
                color: f1BackgroundPromoteHover,
              },
              { name: "f0-background-critical", color: f1BackgroundCritical },
              {
                name: "f0-background-critical-bold",
                color: f1BackgroundCriticalBold,
              },
              { name: "f0-background-info", color: f1BackgroundInfo },
              { name: "f0-background-info-bold", color: f1BackgroundInfoBold },
              { name: "f0-background-warning", color: f1BackgroundWarning },
              {
                name: "f0-background-warning-bold",
                color: f1BackgroundWarningBold,
              },
              { name: "f0-background-positive", color: f1BackgroundPositive },
              {
                name: "f0-background-positive-bold",
                color: f1BackgroundPositiveBold,
              },
              { name: "f0-background-selected", color: f1BackgroundSelected },
              {
              ...
              { name: "f0-background-overlay", color: f1BackgroundOverlay },
            ]}
          />
          ...
          <ColorGroup
            ...
            colors={[
              { name: "f0-border", color: f1Border },
              { name: "f0-border-hover", color: f1BorderHover },
              { name: "f0-border-secondary", color: f1BorderSecondary },
              { name: "f0-border-inverse", color: f1BorderInverse },
              { name: "f0-border-bold", color: f1BorderBold },
              { name: "f0-border-promote", color: f1BorderPromote },
              { name: "f0-border-selected", color: f1BorderSelected },
              { name: "f0-border-selected-bold", color: f1BorderSelectedBold },
              { name: "f0-border-critical", color: f1BorderCritical },
              { name: "f0-border-critical-bold", color: f1BorderCriticalBold },
              { name: "f0-border-warning", color: f1BorderWarning },
              { name: "f0-border-warning-bold", color: f1BorderWarningBold },
              { name: "f0-border-info", color: f1BorderInfo },
              { name: "f0-border-info-bold", color: f1BorderInfoBold },
              { name: "f0-border-positive", color: f1BorderPositive },
              { name: "f0-border-positive-bold", color: f1BorderPositiveBold },
            ]}
          />
          ...
          <ColorGroup
            ...
            colors={[
              { name: "f0-icon", color: f1Icon },
              { name: "f0-icon-secondary", color: f1IconSecondary },
              { name: "f0-icon-inverse", color: f1IconInverse },
              { name: "f0-icon-bold", color: f1IconBold },
              { name: "f0-icon-critical", color: f1IconCritical },
              { name: "f0-icon-critical-bold", color: f1IconCriticalBold },
              { name: "f0-icon-accent", color: f1IconAccent },
              { name: "f0-icon-info", color: f1IconInfo },
              { name: "f0-icon-warning", color: f1IconWarning },
              { name: "f0-icon-positive", color: f1IconPositive },
              { name: "f0-icon-promote", color: f1IconPromote },
              { name: "f0-icon-selected", color: f1IconSelected },
              { name: "f0-icon-selected-hover", color: f1IconSelectedHover },
              {
                name: "f0-icon-mood-super-negative",
                color: f1IconMoodSuperNegative,
              },
              { name: "f0-icon-mood-negative", color: f1IconMoodNegative },
              { name: "f0-icon-mood-neutral", color: f1IconMoodNeutral },
              { name: "f0-icon-mood-positive", color: f1IconMoodPositive },
              {
          ...
          <ColorGroup
            ...
            colors={[
              { name: "f0-special-ring", color: f1SpecialRing },
              { name: "f0-special-page", color: f1SpecialPage },
              { name: "f0-special-highlight", color: f1SpecialHighlight },
            ]}
          />
        </View>
      </ScrollView>

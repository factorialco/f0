...
- Promoting a component to stable? Use the [`f0-component-promotion`](https://github.com/factorialco/f0/blob/main/vendor/skills/f0-component-promotion/SKILL.md) skill.

...
export const defaultTranslations = {
  ...
  meeting: {
    ...
    roomChatEmpty:
      "Messages here are only for this call and disappear when it ends.",
    sendMessage: "Send",
    ...
    recording: "Recording",
    // Media permissions. The browser only tells us it failed, so the copy has
    // to point at the fix rather than restate the error.
    cameraBlocked:
      "Camera access is blocked. Allow it in your browser settings to turn it on.",
    microphoneBlocked:
      "Microphone access is blocked. Allow it in your browser settings to speak.",
    cameraUnavailable: "No camera found",
    microphoneUnavailable: "No microphone found",
    cameraInUse: "Your camera is being used by another app",
    microphoneInUse: "Your microphone is being used by another app",
    audioBlocked: "Click to enable sound",
    // Controls
    ...
    moveWindow: "Move meeting window",
    resizeWindow: "Resize meeting window",
    pinParticipant: "Pin",
    unpinParticipant: "Unpin",
    // Mode switch
    modeSwitch: "Meeting position",
    modeSidePanel: "Show in the side panel",
    modeFloating: "Show in a floating window",
    modeFullscreen: "Fill the screen",
    resizePanel: "Resize the meeting panel",
    // Screen-reader announcements
    movedToCorner: "Meeting window moved to the {{corner}}",

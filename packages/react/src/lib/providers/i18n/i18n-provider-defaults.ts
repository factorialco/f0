...
export const defaultTranslations = {
  ...
  npsWidget: {
    ...
    back: "Back",
    submit: "Submit",
    feedbackPlaceholder: "Write your answer here...",
    feedbackLow: "What could we improve?",
    feedbackHigh: "What do you value most?",
    thankYouHigh: "That means a lot, thank you!",
    thankYouDefault: "Thanks for helping us improve.",
  },
  wizard: {
    previous: "Previous",
    next: "Continue",

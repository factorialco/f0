...
function MyComponent() {
  const handleSave = async () => {
    const result = await confirmDialog("Save Changes", "Do you want to save?", {
      confirm: {
        value: async () => {
          // Simulate API call

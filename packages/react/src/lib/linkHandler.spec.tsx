...
describe("useLink", () => {
  ...
  test("isActive matches correctly when currentPath includes search params", async () => {
    render(
  ...
  test("isActive distinguishes different search params on the same pathname", async () => {
    render(
      <LinkProvider currentPath="/foo?tab=form">

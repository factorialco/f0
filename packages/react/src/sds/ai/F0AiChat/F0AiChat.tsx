...
import { useCopilotKitBridge } from "./hooks/useCopilotKitBridge"
...
/** Renders children inside the CopilotKit tree after wiring the bridge. */
const CopilotKitInner = ({ children }: { children: ReactNode }) => {
  useCopilotKitBridge()
  return <>{children}</>
}

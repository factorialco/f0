...
import { useAuraVoiceAnimation } from "./useAuraVoiceAnimation"
...
export interface AuraVoiceAnimationProps {
  className?: string
  state?: AgentState
  color?: string
  colorShift?: number
...
export function AuraVoiceAnimation({
  className,
  state,
  color,
  colorShift = 0.05,
  ...
  ref,
  ...props
}: AuraVoiceAnimationProps & ComponentProps<"div">) {

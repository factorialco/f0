...
const toastVariants = cva({
  base: "isolation-isolate pointer-events-auto relative flex w-full flex-col gap-3 rounded-lg border border-solid border-f1-border-inverse p-3 shadow-lg bg-f1-foreground overflow-hidden",
  variants: {
    variant: {
      error: "",
      warning: "",

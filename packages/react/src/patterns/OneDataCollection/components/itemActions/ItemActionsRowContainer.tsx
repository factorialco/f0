  ...
  return (
    <aside
      className={cn(
        ...
        // `focus-within` alongside the hover: a keyboard user never hovers, so without it
        // the actions can be tabbed to while staying invisible.
        "pointer-events-none absolute bottom-0 right-0 top-0 z-20 hidden items-center justify-end gap-2 py-2 pl-20 pr-3 opacity-0 transition-all focus-within:opacity-100 group-hover:opacity-100 md:flex",

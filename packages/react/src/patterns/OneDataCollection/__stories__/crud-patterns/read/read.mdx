...
Read patterns define how a user opens and inspects a resource from a Data
...
<DoDonts
  ...
  dont={{
    description:
      "Do not mix dialog-based and page-based open behavior without a strong product reason.",
  }}
/>
...
- [Page with breadcrumbs](/?path=/story/patterns-data-collection-crud-patterns-read--open-as-page-with-breadcrumbs)

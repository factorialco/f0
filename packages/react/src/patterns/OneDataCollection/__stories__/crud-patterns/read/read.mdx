...
- Use a page with breadcrumbs when the resource needs persistent navigation,
...
<Unstyled>
  <table className="mb-8 w-full dark:text-f1-foreground-inverse/80">
    ...
    <tbody>
      ...
      <tr>
        <td>
          <a href="/?path=/story/patterns-data-collection-crud-patterns-read--page-with-breadcrumbs">
...
- [Page with breadcrumbs](/?path=/story/patterns-data-collection-crud-patterns-read--page-with-breadcrumbs)

...
<Unstyled>
  <table className="mb-8 w-full dark:text-f1-foreground-inverse/80">
    ...
    <tbody>
      ...
      <tr>
        <td>
          <a href="/?path=/story/patterns-data-collection-crud-patterns-read--card-to-dialog">
            Card to dialog
          </a>
        </td>
        <td>
        ...
        <td>
          Requires edit/delete to remain explicit actions, not hidden behind the
          same click.
        </td>
      </tr>
      <tr>
        <td>
          <a href="/?path=/story/patterns-data-collection-crud-patterns-read--kanban-card-to-dialog">
...
delete as explicit actions so read, edit, drag, and destructive behavior do not
compete for the same click target.
...
- [Table to Page](/?path=/story/patterns-data-collection-crud-patterns-read--table-to-page)
- [List to Page](/?path=/story/patterns-data-collection-crud-patterns-read--list-to-page)
- [Card to dialog](/?path=/story/patterns-data-collection-crud-patterns-read--card-to-dialog)
- [Kanban card to dialog](/?path=/story/patterns-data-collection-crud-patterns-read--kanban-card-to-dialog)

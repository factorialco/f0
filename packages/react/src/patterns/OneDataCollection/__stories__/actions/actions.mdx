...
For guidance on which UX container should open after create, item, update, or
delete actions, see
[CRUD patterns](/?path=/docs/patterns-data-collection-crud-patterns-overview--documentation).
...
> F0Dropdown component yet so this only works for the expanded actions.

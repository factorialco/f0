...
import { Kanban, List, Pencil, Pin, Table } from "@/icons/app"
  ...
  <FeatureGrid
    features={[
      ...
      },
      {
        ...
        title: "Map",
        description:
          "Map visualization projects each record onto a coordinate and draws it as a marker, with optional list and detail panels beside it.",
        href: "/?path=/docs/patterns-data-collection-visualizations-map--documentation",
      },
    ]}
  />
</Unstyled>

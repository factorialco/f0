...
<Unstyled>
  <figure className="mx-auto mb-8 mt-0 max-w-2xl">
    ...
    <figcaption className="mt-2 text-sm text-f1-foreground-secondary">
      The chat opens full width, with an action-driven header. The user types what they want
      (or dictates it with the mic), or picks a starting-point card.
    </figcaption>
  </figure>
</Unstyled>
  ...
  <table className="mb-8 w-full dark:text-f1-foreground-inverse/80">
    ...
    <tbody>
      <tr>
        ...
        <td>Creates a blank survey and walks the user through it with clarifying questions.</td>
      </tr>
      <tr>
        <td>
          <strong>Templates</strong>
        </td>
        <td>Opens the templates canvas to browse and preview pre-made surveys.</td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          Seeds a ready-made eNPS survey; the eNPS question is locked so scores stay
          comparable, the rest is editable.
        </td>
      </tr>
      <tr>
        <td>
...
<Unstyled>
  <figure className="mx-auto mb-8 mt-0 max-w-2xl">
    ...
    />
    <figcaption className="mt-2 text-sm text-f1-foreground-secondary">
      After choosing Empty survey: the resource canvas fills the center, the chat
      docks on the right with the resource card and clarifying questions.
    </figcaption>
  </figure>
</Unstyled>
  ...
  <table className="mb-8 w-full dark:text-f1-foreground-inverse/80">
    ...
    <tbody>
      <tr>
        ...
        <td>
          The survey rendered as it will be answered (the answering form), for reviewing a
          template or draft.
        </td>
      </tr>
      <tr>
        ...
        <td>
          The survey builder, with a Questions tab for the survey content and a Settings tab
          for metadata (title, description, participants, schedule, visibility, editors).
        </td>
      </tr>
    </tbody>
  </table>

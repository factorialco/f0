...
- **Active vs. inactive** — a card is *active* when its resource is the one currently shown in
...
- **Live vs. superseded** — when the AI applies an accepted change, it posts a **fresh card** for
  the same resource. The new card is *live* (interactive); the previous one is *superseded* — it
  ...
  <table className="mb-8 w-full dark:text-f1-foreground-inverse/80">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Latest card for the resource, not currently shown — offers Open.</td>
        <td>Yes</td>
      </tr>
      <tr>
        <td>Resource card</td>
        ...
        <td>
          Replaced by a newer card — Open/Close removed, dimmed, kept in history.
        </td>
        <td>No</td>
      </tr>
      <tr>

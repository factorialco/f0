    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          gates the first generated draft before anything is written.
        </td>
        <td>
          Enters from Collection. Opens full width via the Create button, or as
          a side panel via the One switch. Exits to Split when the user accepts
          the draft (or opens a template) and there is a resource to show.
        </td>
      </tr>
      <tr>
        <td>

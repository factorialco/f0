  ...
  <table className="mb-8 w-full dark:text-f1-foreground-inverse/80">
    ...
    <tbody>
      <tr>
        ...
        <td>
          The starting surface — a data collection, page, or list. The user works as
          usual; co-creation is one trigger away.
        </td>
        <td>
          Enters from the surface itself. Exits to Chat when the user opens the AI via the
          header <strong>One switch</strong> (side panel) or the <strong>Create</strong>{" "}
      ...
      <tr>
        ...
        <td>
          The chat animates in so the user can describe what they want. Clarifying
          questions narrow the intent before anything is drafted.
        </td>
        <td>
          Enters from Collection. Opens full width via the Create button, or as a side
          panel via the One switch. Exits to Split once there is a resource to show.
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          The chat docks as the right side panel and the resource canvas fills the center.
          The user reviews, edits, and refines the draft while the conversation continues
          alongside it.
        </td>
        <td>
          Enters from Chat when a resource is created or opened. The conversation and the
          canvas stay visible together until the resource is done.
        </td>
      </tr>
    </tbody>
  </table>

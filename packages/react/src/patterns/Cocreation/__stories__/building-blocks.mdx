  ...
  <table className="mb-8 w-full dark:text-f1-foreground-inverse/80">
    ...
    <tbody>
      <tr>
        ...
        <td>
          The One switch in the application header. Entry point that opens the AI from
          any phase.
        </td>
        <td>Collection → Chat</td>
        <td>
          <a target="_parent" href="/?path=/docs/sds-ai-f0oneswitch--documentation">
            AI / F0OneSwitch
          </a>
        </td>
      </tr>
      <tr>
        ...
        <td>
          The conversation surface and runtime. Hosts the messages, input, welcome cards
          and suggestions, and in-chat cards.
        </td>
        <td>Chat, Split</td>
        <td>
      ...
      <tr>
        ...
        <td>
          Structured clarifying questions that narrow the intent before drafting (e.g.
          resource type, audience, length).
        </td>
        <td>Chat</td>
        <td>
          <a target="_parent" href="/?path=/docs/sds-ai-f0clarifyingpanel--documentation">
      ...
      <tr>
        ...
        <td>
          ...
          active, inactive, and confirm/reject variants drive the card lifecycle.
        </td>
        <td>Chat, Split</td>
        <td>
          <a
      ...
      <tr>
        ...
        <td>
          The "applying changes" overlay shown over the resource while a proposed change is
          being written.
        </td>
        <td>Split</td>
        <td>

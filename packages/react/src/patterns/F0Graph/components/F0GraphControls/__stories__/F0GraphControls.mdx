...
<DoDonts
  do={{
    description:
      "Show the controls the surface actually needs, and keep them reachable wherever the reader is on the canvas.",
    guidelines: [
      "Fit-to-view earns its place on any graph larger than a screen",
      "Find me matters most in a big org chart, where the reader's own node is off-screen",
      "Pass controlLabels so every control translates",
    ],
  }}
  dont={{
    description: "Don't build a second toolbar next to this one.",
    guidelines: [
      "Two control surfaces on one canvas leave the reader guessing which one pans",
      "Don't hide the controls on small screens — that is where fit-to-view matters most",
    ],
  }}
/>

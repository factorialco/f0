...
Review multiple selected options, a date range, and a numeric range. Boolean and valueless filters are not native `F0FilterPicker` filter types, and are intentionally not represented as supported dashboard controls.

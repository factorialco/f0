...
const dollarTransition: Transition = {
  duration: 0.4,
...
const dotsTransition: Transition = {
  duration: 0.4,
  ease: [0.645, 0.045, 0.355, 1],
  delay: 0.3,
}
    ...
    return (
      ...
      >
        <motion.g
          ...
          animate={animate}
        >
          <path d="M5.54981 14.121L6.2641 10.121C6.68993 7.73641 8.76387 6 11.1862 6H12.8138C15.2361 6 17.3101 7.73641 17.7359 10.121L18.4502 14.121C18.9974 17.1857 16.6412 20 13.528 20H10.472C7.35882 20 5.00255 17.1857 5.54981 14.121Z" />
          <path d="M10.3257 2.5H13.6743C14.3386 2.5 14.8183 3.13591 14.6358 3.77472L14 6H10L9.36421 3.77472C9.18169 3.1359 9.66135 2.5 10.3257 2.5Z" />
        </motion.g>
        <motion.path

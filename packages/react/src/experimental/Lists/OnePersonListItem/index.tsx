...
const BaseOnePersonListItem = React.forwardRef<HTMLDivElement, OnePersonListItemProps>(
      ...
      >
        ...
        <div className="flex flex-1 flex-col">
          <div className="flex flex-1 flex-row items-center gap-1">
            ...
            {props.info && (
              <Tooltip label={props.info}>
                <F0Icon icon={InfoCircle} size="sm" className="text-f1-icon-secondary" />
              </Tooltip>
            )}
          </div>
          {"bottomTags" in props && (
          ...
          {"description" in props && props.description && (
            <p className="truncate text-f1-foreground-secondary">{props.description}</p>
          )}
        </div>
        <div className="flex flex-row items-center justify-between gap-2">
          {"rightTag" in props && props.rightTag && <F0TagDot {...props.rightTag} />}
          {"actions" in props && (
...
export const OnePersonListItem = withSkeleton(BaseOnePersonListItem, OnePersonListItemSkeleton)

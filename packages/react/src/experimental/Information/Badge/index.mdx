...
Badges are compact visual indicators. They provide quick visual cues to users about the state or
nature of an item.

A badge displays status through icons. Useful for showing status or alert levels.

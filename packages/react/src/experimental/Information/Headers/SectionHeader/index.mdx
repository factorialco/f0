...
The Section header is a component used to organize and present content into distinct sections in
Factorial's interface. It provides a consistent structure for displaying hierarchical information
with titles, descriptions, and optional elements.
...
- Enable basic interactions related to the section's content, such as help links or other
...
- Use action verbs in [verb + noun] format (e.g., "Learn more" instead of "Help center link")
...
- Elements follow a clear hierarchy to ensure scanability and consistency in the user experience.
- Predictable visual alignment and logical interaction order reduce friction and facilitate
  navigation.
- Mandatory components establish the base structure, while optional ones add flexibility.

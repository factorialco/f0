...
## ListNavigation (type: "list-navigator")

The ListNavigation filter is a navigation filter that allows you to filter the
data by a list of values.

### Options

- `options`: The options of the list navigation filter.
...
<Canvas
  of={DataCollectionNavigationFiltersStories.ListNavigation}
  meta={DataCollectionNavigationFiltersStories}
/>

...
export const NumberInputInternal = forwardRef<HTMLInputElement, NumberInputInternalProps>(
  function NumberInput(
    ...
    const handleChange = (value: string) => {
       ...
       */
      const finalValue = Math.max(min ?? -Infinity, Math.min(max ?? Infinity, parsedValue))

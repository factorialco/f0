...
export const ChartWidgetEmptyState = forwardRef<HTMLDivElement, Props>(function WidgetEmptyState(
  ...
  return (
    <Card
      className={cn("relative flex gap-4 overflow-hidden border-dashed", rootClassName)}
      ref={ref}
    >

...
const BaseBannerComponent = forwardRef<HTMLDivElement, BaseBannerProps>(function BaseBanner(
  {
    title,
    subtitle,
    mediaUrl,
    ...
    >
      ...
      <div className="flex flex-col justify-center gap-5 px-3 pb-3 sm:py-3 sm:pl-0 sm:pr-3">
        ...
        >
          ...
          {subtitle && <p className="text-base text-f1-foreground-secondary">{subtitle}</p>}
        </div>
...
const BaseBannerSkeleton = forwardRef<HTMLDivElement>(function BaseBannerSkeleton(props, ref) {
  return (
    <div
      ref={ref}
      className="bg-white relative flex w-full flex-col gap-4 rounded-xl border border-f1-border-secondary shadow-md sm:flex-row sm:gap-5"

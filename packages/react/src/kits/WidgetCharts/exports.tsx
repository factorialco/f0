...
import { RadialProgressWidget as RadialProgressWidgetComponent } from "./RadialProgressWidget"
...
export const RadialProgressWidget = Component(
  {
    name: "RadialProgressWidget",
    type: "info",
  },
  RadialProgressWidgetComponent
)

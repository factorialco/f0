...
export const createPageLayoutBlock = <Props = unknown>(
  ...
  const WrappedComponent = Component as React.ComponentType<Props> & PageLayoutBlockComponent
...
export const createPageLayoutBlockGroup = <Props = unknown>(
  ...
  const WrappedComponent = Component as React.ComponentType<Props> & PageLayoutGroupComponent
  WrappedComponent.displayName = displayName

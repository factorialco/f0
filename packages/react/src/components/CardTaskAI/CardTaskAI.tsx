...
/**
 * Simple validation for CardTaskAI
 */
const validateCardTaskAI = (props: CardTaskAIProps) => {
  const { title, taskType } = props
  if (!title) console.warn("[CardTaskAI] Title is required")
  if (!taskType) console.warn("[CardTaskAI] taskType is required")
}
  ...
  (
    ...
    if (process.env.NODE_ENV === "development") {
      try {
        ...
        console.error("[CardTaskAI] Validation error:", e)
      }
    }

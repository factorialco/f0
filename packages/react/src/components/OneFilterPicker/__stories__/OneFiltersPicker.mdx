...
The filter returns always a tuple of two numbers, the first one is the minimum
value and the second one is the maximum value. If the mode is `single` the
second value is the same as the first one.

```tsx
[100, 100], // Means = 100
// or
[0, 100], // Means >= 0 and <= 100
// or
[0, undefined], // Means >= 0
// or
[undefined, 100], // Means <= 100
// or
[undefined, undefined], // Means no range
```

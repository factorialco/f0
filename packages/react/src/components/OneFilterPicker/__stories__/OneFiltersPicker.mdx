...
The filter returns the selection type and the value.
...
{
  mode: "range",
  value: [0, 100], // Means >= 0 and <= 100
}
// or
{
  mode: "range",
  value: [0, undefined], // Means >= 0
}
// or
{
  mode: "range",
  value: [undefined, 100], // Means <= 100
}
// or
{
  mode: "range",
  value: [undefined, undefined], // Means no range
}
```

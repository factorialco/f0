...
<Meta title="Primitives/InputField" />
...
extended features from the F0 design system.
...
| Prop       | Type                            | Description                                                           | Default     |
| ---------- | ------------------------------- | --------------------------------------------------------------------- | ----------- |
| `disabled` | `boolean`                       | If `true`, the input field is disabled with a tertiary background.    | `false`     |

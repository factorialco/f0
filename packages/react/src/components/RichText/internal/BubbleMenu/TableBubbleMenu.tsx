...
export const TableBubbleMenu = ({
  ...
  // The content is always rendered (like the text bubble menu); tippy's
  // `shouldShow` handles visibility. Gating it on a React-computed "in table"
  // flag would break on editors that don't re-render on every selection
  // change, leaving the menu empty when it does show.
  const renderMenu = () => {

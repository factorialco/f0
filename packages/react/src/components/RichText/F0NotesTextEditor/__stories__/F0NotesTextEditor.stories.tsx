...
const meta = {
  ...
  argTypes: {
    onChange: {
      description:
        "Callback triggered when editor content changes. Receives { json, html }",
      control: false,
    },
    placeholder: {
    ...
    initialEditorState: {
      description:
        "Pre-populates the editor with content and/or title. Format: { content?: JSONContent | string, title?: string }",
      control: false,
    },
    readonly: {
      description: "Puts the editor in read-only mode",
      control: "boolean",
    },
    enhanceConfig: {
      description:
        "Configures AI text enhancement with onEnhanceText function and enhancement options",
      control: false,
    },
    imageUploadConfig: {
      description:
        "Configures image upload with onUpload function and optional constraints",
      control: false,
    },
    aiBlockConfig: {
      description: "Configures AI block insertion with custom actions",
      control: false,
    },
    onTitleChange: {
      description:
        "Callback triggered when the title changes. If not provided, title editing is disabled",
      control: false,
    },
    titlePlaceholder: {
    ...
    primaryAction: {
      description: "Primary action button configuration for the header",
      control: false,
    },
    secondaryActions: {
      description: "Secondary action buttons for the header",
      control: false,
    },
    otherActions: {
      description: "Additional dropdown actions for the header",
      control: false,
    },
    metadata: {
      description: "Metadata items displayed in the header",
      control: false,
    },
    status: {
      description:
        "Status configuration displayed as the first metadata item in the header. Includes label, text, variant (StatusVariant), and optional actions",
      control: false,
    },
    alert: {
      description:
        "Alert configuration displayed below the header actions. Uses F0Alert with title, description, variant, and optional action/link",
      control: false,
    },
  },
} satisfies Meta<typeof F0NotesTextEditor>
...
const enhancementOptions: EnhancementOption[] = [
  ...
  },
  {
    ...
    subOptions: [
      ...
      { id: "tone-straightforward", label: "Straightforward" },
  ...
  },
  {
    ...
    icon: Globe,
    subOptions: [
      { id: "translate-to-spanish", label: "Spanish" },
      { id: "translate-to-english", label: "English" },
      { id: "translate-to-french", label: "French" },
      { id: "translate-to-german", label: "German" },
    ],
  },
]
...
type SkeletonStory = StoryObj<typeof F0NotesTextEditorSkeleton>

export const Skeleton: SkeletonStory = {
  name: "Skeleton - Basic",
  render: (args) => (
    <div className="h-96 w-full">
      <F0NotesTextEditorSkeleton {...args} />
    </div>
  ),
  args: {
    withHeader: true,

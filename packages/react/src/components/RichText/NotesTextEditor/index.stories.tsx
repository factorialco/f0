...
// PoC: a document that already contains a PDF attachment block. This exercises
// the node's parseHTML/renderHTML round-trip and the NodeView (chip + click to
// open in a browser viewer) without going through the native file picker.
...
// PoC: same attachment in readonly mode. The delete action must NOT appear,
// but the chip must still be clickable to open the document.

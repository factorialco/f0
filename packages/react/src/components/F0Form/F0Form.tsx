 ...
 * being true. Only declarative conditions are detected — function-form renderIf
 * cannot be statically analysed and will render as regular fields.
 */
 ...
 * Also absorbs subsequent fields whose renderIf targets a switch in the group
 * with `equalsTo: true` — those fields render inside the switch card.
 */

 ...
 */
const ButtonInternal = forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonInternalProps>(
  function Button(
    {
      label,
      hideLabel,
    ...
    return (
      <>
        ...
        <Action
          ...
          title={noTitle ? undefined : props.title || (hideLabel ? buttonLabel : undefined)}
        ...
        >
          ...
          >
              ...
              (iconRotate ? (
                <IconMotion
                  ...
                  animate={{
                    ...
                    filter: isHovered ? ["blur(0px)", "blur(1px)", "blur(0px)"] : "blur(0px)",
                  }}
                  transition={{
                    rotate: {
                      duration: 0.5,
            ...
            {emoji && <EmojiImage emoji={emoji} size={size === "sm" ? "sm" : "md"} alt={""} />}
            {!shouldHideLabel ? (
              <OneEllipsis
                className={cn(

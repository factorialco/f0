...
Import the Icon component and the icon you want to display. Then, pass the icon to the Icon
component as a prop.
...
- **Token colors**: Use predefined icon color tokens like `secondary`, `accent` or `critical`.
...
Please, use the token colors unless you have a specific reason to use a hex color.

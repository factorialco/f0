  ...
  <table className="mb-8 w-full dark:text-f1-foreground-inverse/80">
    ...
    <tbody>
      <tr>
        ...
        <td>Yes</td>
        <td>
          The icon to render, either as a kebab-case name (<code>"pencil"</code>
          , <code>"modules:payroll"</code>, <code>"ai:summary"</code>) or as a
          generated icon component. Prefer the name — it needs no import and is
          still type-checked. Animated icons must be passed as components.
        </td>
      </tr>
      <tr>
        <td>

...
<DoDonts
  do={{
    description:
      "Use one chip for the single date the row is about, and pass a real Date.",
    guidelines: [
      "Contract start, review due date, the day of an absence",
      "Let the component format day and month so it follows the reader's locale",
    ],
    children: <F0AvatarDate date={new Date(2026, 0, 15)} />,
  }}
  dont={{
    description: "Don't chain chips to stand in for a period.",
    guidelines: [
      "A leave request has a start and an end — show them as a text range",
      'Don\'t render a relative label like "In 3 days" as a date chip',
    ],
    children: (
      <div className="flex items-center gap-1">
        <F0AvatarDate date={new Date(2026, 0, 15)} />
        <F0AvatarDate date={new Date(2026, 0, 22)} />
      </div>
    ),
  }}
/>

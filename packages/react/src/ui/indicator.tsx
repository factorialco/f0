...
export const Indicator = forwardRef<HTMLDivElement, IndicatorProps>(function Indicator(
  { content, label, color, ...props },
  ref
) {
  return (
    <div key={label} className="flex flex-col gap-1" ref={ref}>
      ...
      <div className="flex items-center gap-1">
        <p className="line-clamp-1 text-f1-foreground-secondary" title={label}>
          {label}
        </p>

  ...
  <FeatureGrid
    features={[
      ...
      },
      {
        ...
        href: "/?path=/docs/components-value-display-long-text--documentation",
      },
      {
        icon: Numbers,
        title: "Number",
      ...
      },
      {
        ...
        title: "Compound",
        description:
          "Renders multiple value segments (text, number, amount, percentage) with custom separators and per-segment semantic tones.",
        href: "/?path=/docs/components-value-display-compound--documentation",
      },
      {
        icon: Calendar,
        title: "Date",
      ...
      },
      {
        ...
        href: "/?path=/docs/components-value-display-avatar-list--documentation",
      },
      {
        icon: CheckCircle,
        title: "Status",
      ...
      },
      {
        ...
        href: "/?path=/docs/components-value-display-dot-tag--documentation",
      },
      {
        icon: Circle,
        title: "Tag List",
        ...
        href: "/?path=/docs/components-value-display-tag-list--documentation",
      },
      {
        icon: Image,
        title: "Icon",

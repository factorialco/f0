...
the badge. Useful to display information about the member of the badge. It also
supports an avatar-level tooltip, shown when hovering anywhere on the avatar.
...
type value = {
    ...
    badge?: AvatarBadge
    tooltip?: string // wraps the whole avatar, shown when hovering anywhere on it
    deactivated?: boolean
}

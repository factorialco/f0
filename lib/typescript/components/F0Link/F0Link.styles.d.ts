...
export declare const f0LinkContainerVariants: import("node_modules/tailwind-variants/dist").TVReturnType<{
    variant: {
        link: string;
        unstyled: string;
        mention: string;
...
export declare const f0LinkUnderlineVariants: import("node_modules/tailwind-variants/dist").TVReturnType<{
    disabled: {
        true: string;
        false: string;
    };

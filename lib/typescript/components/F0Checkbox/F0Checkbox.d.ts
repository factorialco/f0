 ...
 */
export declare const F0Checkbox: React.MemoExoticComponent<({ checked: checkedProp, indeterminate, onValueChange, disabled, label, hideLabel, accessibilityLabel, testID, }: F0CheckboxProps) => React.JSX.Element>;

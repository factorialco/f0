import type { F0AvatarListCompanyItem, F0AvatarListPersonItem, F0AvatarListTeamItem } from "../F0Avatar/F0AvatarList.types";
import type { F0TagDotColor, F0TagStatusVariant } from "../F0Tag/F0Tag.types";
export declare const F0_METADATA_ORIENTATIONS: readonly ["vertical", "horizontal"];
...
export type MetadataItemValue = {
    ...
    type: "list";
    variant: "person";
    avatars: F0AvatarListPersonItem[];
} | {
    type: "list";
    variant: "team";
    avatars: F0AvatarListTeamItem[];
} | {
    type: "list";
    variant: "company";
    avatars: F0AvatarListCompanyItem[];
} | {
    type: "data-list";
    data: string[];
} | {
...
//# sourceMappingURL=F0Metadata.types.d.ts.map
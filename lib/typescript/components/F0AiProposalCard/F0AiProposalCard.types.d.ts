...
export type F0AiProposalCardProps = F0AiProposalCardBaseProps & (F0AiProposalCardActions | F0AiProposalCardHiddenActions);
//# sourceMappingURL=F0AiProposalCard.types.d.ts.map
 ...
 */
export declare const F0BlurView: React.MemoExoticComponent<({ intensity, tint, blurReductionFactor, blurMethod, className, style, children, testID, }: F0BlurViewProps) => React.JSX.Element>;

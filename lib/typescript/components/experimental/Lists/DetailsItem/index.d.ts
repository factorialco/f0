...
export declare const DetailsItem: ({ title, content, isHorizontalItem, tableView, fullWidth, spacingAtTheBottom, }: DetailsItemType) => import("node_modules/@types/react").JSX.Element;

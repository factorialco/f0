 ...
 */
declare const F0Preset: React.MemoExoticComponent<({ label, number, onPress, selected, className, }: F0PresetProps) => React.JSX.Element>;
export { F0Preset };
//# sourceMappingURL=F0Preset.d.ts.map
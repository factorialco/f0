 ...
 */
export declare const chipContainerVariants: import("node_modules/tailwind-variants/dist").TVReturnType<{
    variant: {
        default: string;
        selected: string;
    };
 ...
 */
export declare const chipTextVariants: import("node_modules/tailwind-variants/dist").TVReturnType<{
    variant: {
        default: string;
        selected: string;
    };
 ...
 */
export declare const OneChip: ({ label, variant, onClick, onClose, icon, }: OneChipProps) => import("node_modules/@types/react").JSX.Element;
export {};

import type { PressableFeedbackProps, PressableFeedbackVariant } from "../PressableFeedback";
 ...
 * @private
 */
interface F0ButtonPropsInternal extends Omit<PressableFeedbackProps, "style" | "children" | "variant" | "disabled"> {
    /**

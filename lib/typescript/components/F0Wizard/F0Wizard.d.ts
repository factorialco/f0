 ...
 * />
 */
declare const F0Wizard: React.MemoExoticComponent<({ steps, defaultStepIndex, nextLabel: globalNextLabel, previousLabel: globalPreviousLabel, submitLabel, stepLabel, onStepChanged, onSubmit, ScrollComponent, accessibilityLabel, testID, }: F0WizardProps) => React.JSX.Element | null>;
export { F0Wizard };

...
import type { F0CounterProps } from "./F0Counter.types";
/**
 ...
 */
declare const F0Counter: React.MemoExoticComponent<({ value, maxValue, size, type, className, }: F0CounterProps) => React.JSX.Element>;
export { F0Counter };
//# sourceMappingURL=F0Counter.d.ts.map
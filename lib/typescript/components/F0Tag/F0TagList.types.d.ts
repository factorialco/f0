import type { F0TagAlertProps, F0TagBalanceProps, F0TagCompanyProps, F0TagDotProps, F0TagPersonProps, F0TagRawProps, F0TagStatusProps, F0TagTeamProps } from "./F0Tag.types";
/**
 * Supported homogeneous tag types for `F0TagList`.
 */
export declare const F0_TAG_LIST_TYPES: readonly ["dot", "person", "team", "company", "alert", "status", "balance", "raw"];
...
export {};
//# sourceMappingURL=F0TagList.types.d.ts.map
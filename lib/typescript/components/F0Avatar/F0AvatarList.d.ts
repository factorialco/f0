 ...
 * />
 */
export declare const F0AvatarList: React.MemoExoticComponent<({ avatars, size, type, max, remainingCount, }: F0AvatarListAnyProps) => React.JSX.Element>;
//# sourceMappingURL=F0AvatarList.d.ts.map
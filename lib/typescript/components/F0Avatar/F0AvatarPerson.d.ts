 ...
 */
export declare const F0AvatarPerson: React.MemoExoticComponent<({ firstName, lastName, src, size, badge, deactivated, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, }: F0AvatarPersonProps) => React.JSX.Element>;
//# sourceMappingURL=F0AvatarPerson.d.ts.map
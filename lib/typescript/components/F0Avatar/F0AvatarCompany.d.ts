 ...
 */
export declare const F0AvatarCompany: React.MemoExoticComponent<({ name, src, size, badge, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, }: F0AvatarCompanyProps) => React.JSX.Element>;
//# sourceMappingURL=F0AvatarCompany.d.ts.map
...
import { ak as Ar, d5 as $r, Z as nt, c4 as Br, d6 as Ir, d7 as Pr, d8 as Dr, d9 as jr, c5 as Zr, ce as st, c3 as _r, da as Or, a6 as s1, db as Ur, aV as zr, dc as Gr, dd as Wr, de as qr, as as Xr, df as Yr, cB as Kr, aa as it, ad as Qr, dg as Jr, bj as i1, a1 as at, S as We, bW as ct, bq as eo, ca as to, dh as ro, bc as oo, cA as no, $ as Fe, aG as so, bu as lt, di as io, cy as ao, c2 as Me, cw as co, dj as lo, bY as dt, bb as fo, dk as uo, dl as ho, dm as go, dn as po, dp as Co, dq as ft, cp as mo, cq as vo, dr as wo, ds as xo, dt as ko, du as Lo, dv as bo, bE as yo, c7 as Mo, dw as Eo, aj as Ro, dx as Fo, dy as No, dz as Vo, dA as So, dB as To, dC as Ho, bD as Ao, cz as $o, ab as Bo, cl as Io, dD as Po, dE as Do, dF as jo, dG as Zo, dH as _o, dI as Oo, dJ as Uo, aB as zo, bF as Go, b_ as ut, M as Wo, a0 as qo, bG as ht, bX as Xo, bZ as gt, al as Yo, bt as Ko, bs as Qo, ap as Jo, dK as en, dL as tn, bH as pt, bI as rn, bJ as on, ba as nn, aK as sn, dM as an, aE as cn, bo as Ct, bn as mt, bh as ln, dN as vt, bg as dn, c6 as a1, dO as fn, bl as c1, ai as un, dP as hn, dQ as l1, c8 as gn, c9 as pn, cx as wt, dR as Cn, G as mn, E as vn, dS as wn, dT as xn, dU as kn, dV as Ln, bU as bn, dW as xt, dX as yn, ac as Mn, dY as En, L as ce, o as k, q as Se, cf as Rn, u as G, bT as Fn, U as he, bS as kt, H as le, v as ge, a2 as Nn, Q as Ce, dZ as Vn, ae as ie, aq as xe, A as Ee, p as J, cG as Lt, aP as d1, d_ as Sn, aQ as f1, aR as u1, b as be, bQ as Tn, d$ as Hn, bR as An, V as $n, b9 as Bn, a5 as h1, bK as In, bL as Pn, bM as Dn, bN as y1, a3 as jn, aw as bt, b0 as yt, e0 as Zn, cN as _n, e1 as On, e2 as Un, b5 as Mt, e3 as zn, cH as Gn, e4 as Wn, b2 as $e, bi as Et, e5 as Rt, bk as Ft, c as r1, cd as M1, e6 as Nt, cb as qn, cc as Xn, by as Yn, e7 as Kn, bp as g1, cm as Qn, e8 as Jn, e9 as es, ea as ts, eb as rs, ec as os, a8 as ns, af as ss, y as is, z as as, av as E1, ed as Vt, ee as St, ef as cs, eg as ls, au as ds, a7 as fs, eh as us, ei as hs, d as gs } from "./F0CanvasPanel-4w0h0e9n.js";
...
const e2 = /[\\`*_{}[\]()#+\-.!|~>]/g, t2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(e2, "\\$&")).join(""), T4 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  ) : null, Nr = N && I && !!E && E.length > 0, x1 = I && N, { motionProps: Vr } = Hn(
    N,
    160,
    0.5
  );
...
const fr = Ge(void 0), B4 = () => Be(fr), D2 = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), j2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
...
}, I4 = (e) => /* @__PURE__ */ t(_2, { children: /* @__PURE__ */ t(sl, { ...e }) }), sl = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
...
function Pl(e, r) {
  const [o, n] = B(Hl), {
    ...
    animate: i,
    motionValue: l
  } = Ue(Bl), { value: d, animate: c } = Ue(Al), { value: u, animate: f } = Ue($l), { value: p, animate: C } = Ue(Il), h = Cs(r, {
    fftSize: 512,
...
const Ql = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], br = 180, Jl = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : br, e4 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, t4 = (e) => e.showActions !== !1, r4 = (e) => Object.fromEntries(
...
function o4(e) {
  const {
    ...
    d
  ), h = i.length > C, m = c ? i : e4(i, C), v = t4(e) ? e : null, x = r4(e);
  return q(() => {
    c && p.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
...
}, s4 = (e) => cc[e] ?? ft, i4 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: s4(e), size: "md", color: "default" }) }) : null;
function a4({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(n4, { icon: c1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
function d4({ credits: e, trigger: r }) {
...
) : e ? /* @__PURE__ */ t(d4, { credits: e, trigger: o }) : null, q4 = n1, X4 = ({
  historyEnabled: e = !1,
  title: r,
...
const J1 = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], v4 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(he, { className: k("h-4 rounded", e) }) }), et = ({
  titleWidth: e,
  rows: r
  ...
  r.map((o, n) => /* @__PURE__ */ t(v4, { width: o }, n))
] });
function w4() {
...
function K4({
  ...
  const [i, l] = B([]), [d, c] = B(!1), [u, f] = B(null), [p, C] = B(x4), [h, m] = B(() => /* @__PURE__ */ new Set()), v = _(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);

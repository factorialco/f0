...
import { useInsertionEffect as Tr, forwardRef as g, useRef as D, useEffect as q, useLayoutEffect as rt, useState as B, useMemo as J, useCallback as _, useContext as Ie, createContext as Ge, useId as ot, createElement as Hr, memo as Ar } from "react";
import { d9 as $r, da as Br, af as nt, c7 as Ir, db as Pr, dc as Dr, dd as jr, de as Zr, c8 as _r, cg as st, c6 as Or, df as Ur, ao as s1, dg as zr, aX as Gr, dh as Wr, di as qr, dj as Xr, aw as Yr, dk as Kr, cH as Qr, aq as it, at as Jr, dl as eo, r as i1, aj as at, aa as We, q as ct, bv as to, ce as ro, dm as oo, bg as no, cG as so, ah as Fe, aJ as io, bz as lt, dn as ao, cE as co, l as Me, cC as lo, dp as fo, c0 as dt, bf as uo, dq as ho, dr as go, ds as po, dt as Co, du as mo, dv as ft, cu as vo, cv as wo, dw as xo, dx as ko, dy as Lo, dz as bo, dA as yo, bJ as Mo, ca as Eo, dB as Ro, dC as Fo, dD as No, dE as Vo, dF as So, dG as To, dH as Ho, dI as Ao, bI as $o, cF as Bo, ar as Io, cq as Po, dJ as Do, dK as jo, dL as Zo, dM as _o, dN as Oo, dO as Uo, dP as zo, aF as Go, bK as Wo, c2 as ut, a7 as qo, ai as Xo, bL as ht, b$ as Yo, c1 as gt, i as Ko, by as Qo, bx as Jo, dQ as en, dR as tn, bM as pt, bN as rn, bO as on, be as nn, aM as sn, dS as an, j as cn, bt as Ct, bs as mt, bm as ln, dT as vt, bl as dn, c9 as a1, s as fn, bp as c1, dU as un, dV as hn, dW as l1, cc as gn, cd as pn, cD as wt, dX as Cn, a2 as mn, a1 as vn, dY as wn, dZ as xn, d_ as kn, d$ as Ln, bZ as bn, e0 as xt, e1 as yn, as as Mn, e2 as En, g as G, bY as Rn, a6 as ce, S as he, bX as kt, a3 as le, X as ge, ak as Fn, t as k, o as ve, e3 as Nn, au as se, b1 as Le, a0 as Ee, N as ee, cR as Lt, aR as d1, e4 as Vn, aS as f1, aT as u1, u as ye, bV as Sn, e5 as Tn, bW as Hn, ab as An, bd as $n, an as h1, bP as Bn, bQ as In, bR as Pn, bS as y1, al as Dn, aA as bt, b4 as yt, cb as jn, cP as Zn, e6 as _n, e7 as On, b9 as Mt, e8 as Un, cS as zn, e9 as Gn, b6 as Be, bn as Et, ea as Rt, bo as Ft, F as r1, cf as M1, eb as Nt, ec as Wn, ed as qn, O as Te, bD as Xn, ee as Yn, bu as g1, cr as Kn, ef as Qn, eg as Jn, eh as es, ei as ts, ej as rs, w as os, x as ns, cl as ss, _ as is, $ as as, az as E1, ek as Vt, el as St, em as cs, en as ls, ay as ds, ap as fs, eo as us, ep as hs, e as gs } from "./F0CanvasPanel-DviuzWSH.js";
...
`) ? o + "_" : o
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, wc).map((r) => /* @__PURE__ */ t(
  Lt,
  {
        ...
        l && /* @__PURE__ */ a(
          u1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: Lc(l.items).map((d, c) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
` || z === "	";
  ...
  const A = J(() => {
    ...
    const V = s.current;
    if (!V) return null;
    const $ = Sc(V, F.current), U = V.offsetLeft + $.left, z = (V.offsetParent ? V.offsetParent.offsetHeight : 0) - (V.offsetTop + $.top);
...
const Ac = /[\\`*_{}[\]()#+\-.!|~>]/g, $c = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(Ac, "\\$&")).join(""), T6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const Ze = async (Q) => {
    if (Q.preventDefault(), !ie) {
      if (ne.close(), o)
        ...
        const ke = ne.transformMentions(E.trim()), Je = $c(ke), Oe = Ae.flatMap(
  ...
  }, m1 = X ? X.prompt ?? X.title : null, v1 = Pe ? [L.ai.listening] : m1 ? [m1] : s ?? [], Rr = v1.length > 1, Fr = J(() => yc(E, ne.mentions, {
    cursorPosition: $,
  ...
  ) : null, Vr = I && H && !!w && w.length > 0, x1 = H && I, { motionProps: Sr } = Tn(
    I,
    160,
    0.5
  );
    ...
    ee.div,
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(gc, { creditWarning: i, children: /* @__PURE__ */ a(
            ee.form,
            {
              "aria-busy": o,
              ref: j,
        ...
        Vr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(xc, { cards: w }) }),
...
jt.displayName = "CandidateTrigger";
function t2({
  id: e,
  label: r
}) {
...
_t.displayName = "JobPostingTrigger";
function o2({
  id: e,
  label: r
}) {
...
Ot.displayName = "RequisitionTrigger";
function s2({
  id: e,
  label: r
}) {
...
Ut.displayName = "PersonTrigger";
function i2({ id: e, label: r }) {
...
const F1 = 7, u2 = 625, N1 = /* @__PURE__ */ new Set();
function h2(e) {
...
function Wt(e, r) {
  ...
  return { type: "item", text: g2(String(e)) };
}
function qt({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = ye(), p = f2(e), C = d ?? p, h = D(() => {
  ...
  h.current = F, q(() => {
    typeof window > "u" || window.innerWidth < u2 || N1.has(e) || (N1.add(e), h.current());
  }, [e]);
  const I = i && l ? Object.entries(i).map(([M, w]) => {
    ...
    if (!L && w.fieldType === "custom" && typeof N == "object" && N !== null)
      return null;
    const A = L ?? Wt(N, w.fieldType), E = ["richtext", "textarea"];
    return {
      label: w.label,
      content: A,
...
const H1 = 8, $e = 8;
function Yt({ anchor: e, onReply: r }) {
...
const Kt = Ge(void 0), I6 = () => Ie(Kt), w2 = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), x2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, p = D(null), { anchor: C, clear: h } = Xt({
    containerRef: p,
    enabled: !!(o?.id && d)
  });
  return q(() => {
    o?.id && !r && !e && i?.(o);
  }, [o, r, e, i]), !r && !e && f ? null : /* @__PURE__ */ t(Kt.Provider, { value: u, children: /* @__PURE__ */ a("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ t(
      "div",
      {
        ref: p,
  ...
  return /* @__PURE__ */ t(Qt.Provider, { value: n, children: e });
}, Jt = () => {
  const e = Ie(Qt);
  if (e === null)
    throw new Error(
...
const y2 = ({
  ...
  const n = G(), { open: s } = Jt(), [i, l] = B(null);
...
const er = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), N2 = ({
  text: e,
  renderMarkdown: r
  ...
  /* @__PURE__ */ t("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (r ?? er)(e) })
] }), V2 = ({
  message: e,
  onReplyQuote: r,
  ...
  const l = e.rawData, d = F2(
    e?.content,
    l
  ), c = (R2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: p, clear: C } = Xt({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(N2, { text: u, renderMarkdown: n }),
...
}, S2 = 35, T2 = 22, H2 = 400, A2 = 2500, $2 = 220, B2 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  ...
  q(() => {
    ...
    let C;
    if (d === "starting")
      C = setTimeout(() => c("writing"), H2);
    else if (d === "writing")
      i < u.length ? C = setTimeout(() => l((h) => h + 1), S2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      C = setTimeout(() => c("erasing"), A2);
    } else d === "erasing" && (i > 0 ? C = setTimeout(() => l((h) => h - 1), T2) : C = setTimeout(() => {
...
const P2 = {
...
}, D6 = (e) => /* @__PURE__ */ t(L2, { children: /* @__PURE__ */ t(D2, { ...e }) }), D2 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: H, handleSubmit: S, handleClose: M } = b2(
    f ?? P2
  ), w = G(), N = x ?? x2, L = v ?? V2, A = J(() => {
    const j = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((K) => typeof K == "string" && K.length > 0);
  }, [n, w.ai.defaultInitialMessage]), E = !r && e.length === 0 && A.length > 0, V = D(null), $ = D(null), U = D(null), O = D(null), z = D(null), { showScrollBtn: te, turnMinHeight: oe, scrollToBottom: X } = I2({
    viewportRef: V,
    contentRef: $,
    endRef: U,
    lastTurnRef: z,
...
}, j2 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
...
function Z6({
  ...
  return /* @__PURE__ */ t(tr.Provider, { value: r, children: e });
}
function _6() {
  const e = Ie(tr);
  if (e === null)
...
const _2 = ({
  ...
  const C = G().ai.clarifyingQuestion.typeYourAnswer, h = e === "single" ? /* @__PURE__ */ t(rr, { isSelected: o && !r }) : /* @__PURE__ */ t(
    Nt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
class z6 {
  ...
  setupGL() {
    ...
    const S = (this.options.colors || Q2).map(J2);
...
const B1 = ["lowp", "mediump", "highp"], el = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, tl = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, P1 = "iTime", D1 = "iTimeDelta", j1 = "iDate", Z1 = "iFrame", _1 = "iMouse", O1 = "iResolution", rl = "iChannel", U1 = "iChannelResolution", z1 = "iDeviceOrientation";
function ol(e, r) {
...
}, e1 = 9729, G1 = 9728, cl = 9987, W1 = 33071, q1 = 10497;
class ll {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    return (r.wrapS !== W1 || r.wrapT !== W1 || r.minFilter !== G1 && r.minFilter !== e1) && !w && (M = this.makePowerOf2(M), w = !0), o.bindTexture(o.TEXTURE_2D, H), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, c), o.texImage2D(
      o.TEXTURE_2D,
      p,
      C,
      v,
      F,
      M
    ), w && r.minFilter !== G1 && r.minFilter !== e1 && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || q1
    ), o.texParameteri(
...
}, Y1 = (e, r, o) => e * (1 - o) + r * o, dl = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function fl({
  fs: e,
  vs: r = I1,
  textures: o = [],
...
${R}`));
    ...
    if (n)
      for (const b of Object.keys(n)) {
        ...
        } else nl(P, y) && (Z.arraySize = `[${Math.floor(y.length / Number.parseInt(P.charAt(0)))}]`);
        E.current[b] = {
          type: T,
          isNeeded: !1,
          value: y,
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (y, P) => (E.current[`${rl}${P}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, $(y, P), N.current[P] = new ll(b), N.current[P]?.load(y).then((T) => {
            $(T, P);
          }))
        );
        Promise.all(R).then(() => {
...
`,
    ...
    return b.includes("mainImage") && (P = P.concat(el)), P;
  }, pe = (b) => {
    const R = m.current;
  ...
  return q(() => {
    ...
    function R() {
      U();
      const y = m.current;
      y && h.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, K(), ie(), W(ue(e || tl), r || I1), O(), requestAnimationFrame(re), de(), Y());
    }
...
}`, hl = 10, gl = 2, pl = 0.5, Cl = 0.2, ml = 1.5, Ce = {
  duration: 0.5,
  ease: "easeOut"
}, K1 = {
  duration: 0.35,
...
function vl(e, r) {
  const [o, n] = B(hl), {
    ...
    animate: i,
    motionValue: l
  } = Ue(Cl), { value: d, animate: c } = Ue(gl), { value: u, animate: f } = Ue(pl), { value: p, animate: C } = Ue(ml), h = Cs(r, {
    fftSize: 512,
...
function G6({
  ...
  const { speed: u, scale: f, amplitude: p, frequency: C, brightness: h } = vl(r, s);
  return /* @__PURE__ */ t(
    nr,
    {
      ref: d,
...
const yl = Te({
  ...
  const n = G(), s = Le();
  return /* @__PURE__ */ a(Re, { children: [
    e && /* @__PURE__ */ t("span", { className: k(Ml(), "truncate"), children: e }),
    ...
    /* @__PURE__ */ a(
      ee.div,
      {
        ...
        children: [
          ...
          n === "balance" && /* @__PURE__ */ t(Fl, { balance: e.balance })
        ]
      }
    ),
...
const Sl = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), Tl = ({
  label: e,
  direction: r
}) => {
  const o = ar[r];
  ...
  const s = `sparkline-gradient-${ot().replace(/:/g, "")}`, i = Vl(e, o), l = ar[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(Tl, { label: r, direction: i })
      ]
    }
  ) });
}, cr = g(
...
const Al = ["className"], lr = g((e, r) => {
  const o = Al.reduce((n, s) => {
    const { [s]: i, ...l } = n;
    return l;
  }, e);
...
const $l = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], dr = 180, Bl = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : dr, Il = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, Pl = (e) => e.showActions !== !1, Dl = (e) => Object.fromEntries(
...
function jl(e) {
  const {
    ...
    description: i,
    seeMoreLabel: l,
    maxCollapsedDescriptionLength: d = dr
  } = e, [c, u] = B(!1), f = ot(), p = D(null), C = Bl(
    d
  ), h = i.length > C, m = c ? i : Il(i, C), x = Pl(e) ? e : null, v = Dl(e);
  return q(() => {
    c && p.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
...
}, _l = (e) => lc[e] ?? ft, Ol = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: _l(e), size: "md", color: "default" }) }) : null;
function Ul({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(Zl, { icon: c1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const l = /* @__PURE__ */ t(Ol, { iconName: s.icon });
...
Ul.displayName = "F0AiMessageSources";
const fr = {
  background: {
...
const a6 = Te({
  ...
  ({
    ...
    const Ae = j && j !== "none" || W && W !== "none" || K && K !== "none" || ie && ie !== "none", Se = Y && Y !== "none" || Ae, De = { sm: xe, md: Xe, lg: Ye, xl: Ke }, je = c6.map((Ze) => {
      const _e = De[Ze];
      return _e ? i6(Ze, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(

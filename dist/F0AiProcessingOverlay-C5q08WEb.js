...
import { cH as Fr, cI as Nr, _ as rt, bK as Vr, cJ as Sr, cK as Tr, cL as Hr, cM as Ar, bN as ot, bI as $r, cN as Br, a5 as i1, cO as Ir, aJ as Pr, cP as jr, cQ as Dr, cR as Zr, ag as _r, cS as Ur, cb as Or, a9 as nt, ac as zr, cT as Gr, b9 as a1, J as st, K as Ge, bA as it, be as Wr, cU as qr, cV as Xr, b2 as Yr, ca as Kr, a0 as Fe, au as Qr, bi as at, cW as Jr, c8 as eo, bM as Me, c4 as to, cX as ro, bJ as oo, b1 as ct, cY as no, cZ as so, c_ as io, c$ as ao, d0 as co, d1 as lt, bY as lo, bZ as fo, d2 as uo, d3 as ho, d4 as Co, d5 as go, d6 as po, bL as mo, d7 as vo, d8 as wo, d9 as xo, da as ko, db as Lo, dc as bo, dd as yo, de as Mo, df as Eo, c9 as Ro, aa as Fo, bU as No, dg as Vo, dh as So, di as To, dj as Ho, dk as Ao, dl as $o, dm as Bo, ap as Io, bH as dt, O as Po, a1 as jo, bx as ft, bF as Do, bG as ut, dn as Zo, bh as _o, bg as Uo, dp as Oo, dq as zo, bw as ht, dr as Go, b0 as Wo, ay as qo, ds as Xo, as as Yo, b7 as Ko, dt as Ct, b6 as Qo, bs as c1, du as Jo, bj as l1, dv as en, dw as tn, dx as d1, c6 as rn, c5 as on, c7 as gt, dy as nn, G as sn, E as an, dz as cn, dA as ln, dB as dn, dC as fn, by as un, dD as pt, dE as hn, ab as Cn, dF as gn, L as le, o as x, q as Ve, bO as pn, u as W, bv as mn, V as me, bu as mt, H as ie, v as de, a2 as vn, U as Ce, dG as wn, ad as ae, aP as ke, A as Ee, p as te, aD as f1, dH as xn, aE as u1, aF as h1, b as be, bt as kn, dI as Ln, c0 as bn, W as yn, a$ as Mn, a4 as C1, bB as En, bC as Rn, bD as Fn, bE as y1, a3 as Nn, ak as vt, aS as wt, dJ as Vn, cn as Sn, dK as Tn, dL as Hn, aX as xt, dM as An, ch as $n, dN as Bn, aU as $e, b8 as kt, dO as Lt, ba as bt, c as n1, dP as yt, dQ as In, dR as Pn, cg as jn, bn as Dn, dS as Zn, bd as g1, bV as _n, dT as Un, dU as On, dV as zn, dW as Gn, dX as Wn, a7 as qn, ae as Xn, y as Yn, z as Kn, dY as Mt, dZ as Et, d_ as Qn, aj as M1, d$ as Jn, ai as es, e0 as ts, e1 as rs, d as os } from "./F0CanvasPanel-BbTSm0Wd.js";
...
const e2 = /[\\`*_{}[\]()#+\-.!|~>]/g, t2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(e2, "\\$&")).join(""), S4 = ({
  ...
  }, v1 = re ? re.prompt ?? re.title : null, w1 = Ie ? [k.ai.listening] : v1 ? [v1] : s ?? [], kr = w1.length > 1, Lr = J(() => Oc(S, K.mentions, {
    cursorPosition: R,
...
const R1 = 7, T2 = 625, F1 = /* @__PURE__ */ new Set();
function H2(e) {
...
function nr({
  ...
  C.current = M, X(() => {
    typeof window > "u" || window.innerWidth < T2 || F1.has(e) || (F1.add(e), C.current());
  }, [e]);
...
const nl = {
  ...
  }, [n, k.ai.defaultInitialMessage]), R = !r && e.length === 0 && j.length > 0, F = B(null), A = B(null), O = B(null), U = B(null), G = B(null), { showScrollBtn: re, turnMinHeight: oe, scrollToBottom: Y } = ol({
    viewportRef: F,
    contentRef: A,
    endRef: O,
    lastTurnRef: G,
...
function g4(e, r) {
  const o = new Date(e), n = h4(), s = M1(o, "p", { locale: n });

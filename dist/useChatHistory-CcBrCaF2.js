import { jsxs as f, jsx as o, Fragment as qe } from "react/jsx-runtime";
import * as ws from "react";
import { useInsertionEffect as xs, forwardRef as m, useRef as j, useState as z, useCallback as Q, useEffect as ce, useMemo as de, createContext as Pt, useContext as yt, useLayoutEffect as mo, useImperativeHandle as ks, useId as go, createElement as ys } from "react";
import { c3 as bs, c4 as Ls, c5 as Ms, c6 as Es, c7 as vo, c8 as _s, c9 as Rs, ca as Ss, cb as Ns, cc as Ts, cd as Co, ce as As, cf as Vs, cg as Fs, ch as Ps, ci as $s, cj as Is, ck as Hs, cl as Wt, cm as js, cn as Os, co as Ds, cp as Zs, cq as Bs, cr as Us, W as wo, cs as zs, ct as Ws, cu as Gs, cv as qs, cw as Xs, cx as xo, cy as Ys, cz as Ks, a4 as Vr, cA as Qs, aG as Js, cB as ea, cC as ta, cD as ra, ae as na, cE as oa, bB as sa, a8 as Fr, ab as aa, cF as ia, a2 as Pr, _ as ko, N as tr, a1 as yo, b2 as ca, cG as la, aY as da, bA as ua, Y as Ye, as as fa, b6 as bo, cH as ha, by as Lo, cI as ot, bu as pa, cJ as ma, cK as Mo, aX as Eo, cL as ga, cM as va, cN as Ca, cO as wa, cP as _o, bn as xa, bo as ka, cQ as ya, cR as ba, cS as La, cT as Ma, cU as Ea, cV as _a, cW as Ra, cX as Sa, cY as Na, cZ as Ta, c_ as Aa, c$ as Va, d0 as Fa, bz as Pa, a9 as $a, bj as Ia, d1 as Ha, d2 as ja, d3 as Oa, d4 as Da, d5 as Za, d6 as Ba, d7 as Ua, an as za, d8 as Ro, J as Wa, Z as Ga, d9 as So, da as qa, b5 as Xa, b4 as Ya, db as Ka, dc as No, dd as Qa, aW as Ja, aw as ei, de as ti, aq as ri, b0 as ni, df as To, dg as oi, dh as si, ba as $r, di as Ir, bw as ai, bv as ii, bx as Ao, dj as ci, z as li, y as di, dk as ui, dl as fi, dm as hi, dn as pi, dp as mi, dq as Vo, dr as gi, aa as vi, ds as Ci, H as Me, m as V, o as ct, bd as wi, dt as Fo, aj as xi, du as ki, dv as yi, A as Be, n as Ce, ar as Jr, M as Ee, u as pe, dw as bi, dx as Li, bS as Mi, l as Ei, k as _i, i as Ri, w as Po, dy as en, dz as Si, dA as Ni, dB as Ti, dC as Ai, dD as Vi, a6 as $o, a7 as Fi, S as $e, c1 as Io, C as be, s as Te, $ as Pi, dE as $i, ac as _e, aL as ze, aB as Hr, dF as Ii, aC as jr, aD as Or, b as Ke, br as Hi, O as ji, aV as Oi, a3 as Dr, dG as Di, dH as Zi, dI as Bi, dJ as tn, a0 as Ui, ai as Ho, aN as jo, dK as zi, bN as Wi, aS as Oo, bH as Gi, dL as qi, aP as Tt, b8 as Do, dM as Zo, b9 as Bo, dN as Uo, dO as Xi, bc as Yi, dP as Ki, b1 as Zr, bk as Qi, dQ as Ji, dR as ec, dS as tc, dT as rc, dU as nc, ad as oc, x as sc, dV as zo, dW as Wo, dX as ac, ah as rn, dY as ic, ag as cc, dZ as lc, d_ as dc } from "./F0CanvasPanel-B-1mMsX1.js";
import { createPortal as Go } from "react-dom";
import { defaultTranslations as uc } from "./i18n-provider-defaults.js";
import { useTrackVolume as fc } from "@livekit/components-react";
import './useChatHistory.css';function hc(t, e, r) {
  xs(() => t.on(e, r), [t, e, r]);
}
function Br(t) {
...
function qo(t, e, r, n) {
  return typeof t == "string" && Br(e) ? bs(t, r, n) : t instanceof NodeList ? Array.from(t) : Array.isArray(t) ? t : [t];
}
function pc(t, e, r) {
  return t * (e + 1);
}
...
function Xo(t, e) {
  return Ls(t) ? t[mc(0, t.length, e)] : t;
}
function gc(t, e, r) {
  for (let n = 0; n < t.length; n++) {
    const s = t[n];
    s.at > e && s.at < r && (Es(t, s), n--);
  }
}
function vc(t, e, r, n, s, a) {
  gc(t, s, a);
...
const xc = "easeInOut", kc = 20;
function yc(t, { defaultTransition: e = {}, ...r } = {}, n, s) {
  ...
  for (let p = 0; p < t.length; p++) {
    ...
    if (typeof g == "string") {
      ...
      d.set(g.name, nn(h, g.at, u, d));
      continue;
    }
    let [k, C, M = {}] = g;
    M.at !== void 0 && (h = nn(h, M.at, u, d));
    let P = 0;
    const $ = (N, w, x, y = 0, S = 0) => {
      const E = bc(N), { delay: b = 0, times: L = _s(E), type: R = "keyframes", repeat: B, repeatType: X, repeatDelay: J = 0, ...te } = w;
      let { ease: oe = e.ease || "easeOut", duration: ee } = w;
      const _ = typeof b == "function" ? b(y, S) : b, q = E.length, O = Ns(R) ? R : s?.[R];
      if (q <= 2 && O) {
        let D = 100;
        if (q === 2 && Ec(E)) {
          const ye = E[1] - E[0];
        ...
        const re = { ...te };
        ee !== void 0 && (re.duration = Ts(ee));
        const ie = Rs(re, D, O);
        oe = ie.ease, ee = ie.duration;
      }
      ee ?? (ee = a);
      const U = h + _;
      L.length === 1 && L[0] === 0 && (L[1] = 1);
      const me = L.length - E.length;
      if (me > 0 && Ss(L, me), E.length === 1 && E.unshift(null), B) {
        Co(B < kc, "Repeat count too high, must be less than 20"), ee = pc(ee, B);
        const D = [...E], re = [...L];
        ...
        for (let ye = 0; ye < B; ye++) {
          ...
          for (let T = 0; T < D.length; T++)
            L.push(re[T] + (ye + 1)), oe.push(T === 0 ? "linear" : Xo(ie, T - 1));
        }
        Cc(L, B);
      }
      const ue = U + ee;
      vc(x, E, oe, L, U, ue), P = Math.max(_ + ee, P), v = Math.max(ue, v);
    };
    if (vo(k)) {
      const N = on(k, l);
      $(C, M, sn("default", N));
    } else {
      const N = qo(k, C, n, c), w = N.length;
      for (let x = 0; x < w; x++) {
        C = C, M = M;
        const y = N[x], S = on(y, l);
        for (const E in C)
          $(C[E], Lc(M, E), sn(E, S), x, w);
      }
    }
    u = h, h += P;
  }
  return l.forEach((p, g) => {
    for (const k in p) {
      ...
      for (let w = 0; w < C.length; w++) {
        const { at: x, value: y, easing: S } = C[w];
        M.push(y), P.push(As(0, v, x)), $.push(S || "easeOut");
      }
      P[0] !== 0 && (P.unshift(0), M.unshift(M[0]), $.unshift(xc)), P[P.length - 1] !== 1 && (P.push(1), M.push(null)), i.has(g) || i.set(g, {
        keyframes: {},
        transition: {}
      });
      const N = i.get(g);
      N.keyframes[k] = M, N.transition[k] = {
        ...e,
        duration: v,
        ease: $,
        times: P,
...
const Mc = (t) => typeof t == "number", Ec = (t) => t.every(Mc);
function _c(t, e) {
  return t in e;
}
class Rc extends Vs {
...
function Tc(t, e) {
  return vo(t) || typeof t == "number" || typeof t == "string" && !Br(e);
}
function Yo(t, e, r, n) {
  const s = [];
  if (Tc(t, e))
    s.push(js(t, Br(e) && e.default || e, r && (r.default || r)));
  else {
    const a = qo(t, e, n), i = a.length;
    Co(!!i, "No valid elements provided.");
    for (let l = 0; l < i; l++) {
      const c = a[l], d = c instanceof Element ? Sc : Nc;
      Wt.has(c) || d(c);
      const u = Wt.get(c), h = { ...r };
      "delay" in h && typeof h.delay == "function" && (h.delay = h.delay(l, i)), s.push(...Os(u, { ...e, transition: h }, {}));
    }
  }
  return s;
}
function Ac(t, e, r) {
  const n = [];
  return yc(t, e, r, { spring: Ds }).forEach(({ keyframes: a, transition: i }, l) => {
    n.push(...Yo(l, a, i));
  }), n;
}
class Vc {
...
function $c(t) {
  function e(r, n, s) {
    let a = [];
    return Pc(r) ? a = Ac(r, n, t) : a = Yo(r, n, s, t), new Fc(a);
  }
  return e;
}
const Ic = $c(), Hc = (t, e) => /* @__PURE__ */ f(
  "svg",
  {
...
t1.displayName = "ShoppingCart";
const m2 = (t, e) => /* @__PURE__ */ f(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
), eu = m(J2), tu = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: jc,
  Add: Zs,
  Ai: Bs,
  ...
  Calculator: oa,
  Calendar: sa,
  CalendarArrowDown: ul,
  CalendarArrowLeft: hl,
  CalendarArrowRight: ml,
  CameraPlus: vl,
  CardPin: wl,
  ChartFunnel: kl,
  ChartHorizontalBars: bl,
  ChartLine: Ml,
  ChartPie: _l,
  ChartVerticalBars: Sl,
  Check: Fr,
  CheckCircle: aa,
  CheckCircleLine: Tl,
  CheckDouble: ia,
  ...
  DropdownOpen: ma,
  Ellipsis: Mo,
  EllipsisHorizontal: Eo,
  Envelope: h0,
  EnvelopeOpen: m0,
  Equal: ga,
  EqualApproximately: va,
  EqualGreater: Ca,
  EqualLess: wa,
  Exit: v0,
  ExternalLink: _o,
  ...
  FaceNeutral: ba,
  FacePositive: La,
  FaceSuperNegative: Ma,
  FaceSuperPositive: Ea,
  Feed: w0,
  File: k0,
  FileFilled: b0,
  FileSigned: M0,
  ...
  Wifi: eu,
  Windows: Ci
}, Symbol.toStringTag, { value: "Module" })), ru = (t, e) => /* @__PURE__ */ o(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ o(
    Me,
    {
      ...
      variant: "ai",
      ref: e,
      iconRotate: t.icon == nu
    }
  );
});
a1.displayName = "AIButton";
const i1 = {
  background: {
...
const ku = ct({
  ...
  ({
    ...
    const It = q && q !== "none" || O && O !== "none" || U && U !== "none" || me && me !== "none", dt = _ && _ !== "none" || It, Ht = { sm: rr, md: De, lg: nr, xl: or }, jt = yu.map((Ot) => {
      const Dt = Ht[Ot];
      return Dt ? xu(Ot, Dt) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ o(
      "div",
      {
        ...
        className: V(
          ...
          jt,
          dt && !ee && "border-f1-border",
          W && !se && "divide-f1-border",
          "scrollbar-macos"
        ),
        ...$t
      }
...
const ir = wi(
  ...
  const { position: r } = Fo(), n = j(null), [s, a] = z(!0), [i, l] = z(!0), c = Q(() => {
    const d = n.current;
    if (!d) return;
    const { scrollTop: u, scrollHeight: h, clientHeight: v } = d;
    a(u <= 0), l(u + v >= h - 1);
  }, []);
  return ce(() => {
    const d = n.current;
    ...
    /* @__PURE__ */ f(
      xi,
      {
        ...
        children: [
          /* @__PURE__ */ o(ki, { layout: null, children: t }),
          /* @__PURE__ */ o(
            yi,
            {
    ...
    /* @__PURE__ */ f(Be, { children: [
      !s && /* @__PURE__ */ o(an, { position: "top" }, "shadow-top"),
      !i && /* @__PURE__ */ o(an, { position: "bottom" }, "shadow-bottom")
    ] })
  ] });
}, bu = (t) => Array.isArray(t), Lu = (t) => Array.isArray(t), ln = ({
  primaryAction: t,
  secondaryAction: e
}) => {
  const r = e, n = t;
  ...
  const l = pe(), { onClose: c } = Fo(), d = !!s, u = () => /* @__PURE__ */ o("div", { className: "h-4 w-px self-center bg-f1-background-secondary" }), h = n?.filter(
    (g) => g.type !== "separator" && g.type !== "label"
  ) ?? [], v = () => {
    if (!h.length || !n) return null;
    const g = h.some((k) => k.critical);
    return h.length <= 2 && !g ? /* @__PURE__ */ o("div", { className: "flex flex-row gap-2", children: h.map((k) => /* @__PURE__ */ o(
      Me,
      {
        variant: "outline",
        icon: k.icon,
      ...
      k.label
    )) }) : /* @__PURE__ */ o(Ri, { items: n, icon: Mo });
  }, p = () => r ? /* @__PURE__ */ o(Ei, { children: /* @__PURE__ */ o(
    _i,
    {
      item: {
        id: r.id,
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ f("div", { className: "flex flex-col gap-1", children: [
            r ? /* @__PURE__ */ o(p, {}) : t && /* @__PURE__ */ o(bi, { className: "py-1 text-lg font-semibold text-f1-foreground", children: t }),
  ...
  activeTabId: p,
  setActiveTabId: g,
  disableContentPadding: k,
  container: C
}) => {
  const [M, P] = z(null), $ = Q((L) => {
    P(L);
  }, []), N = (L) => {
    L || r();
  }, w = Mu(), x = e === "left" || e === "right", y = de(() => w && t ? "bottomSheet" : e === "fullscreen" ? "fullscreen" : x ? "sidePosition" : "center", [w, t, x, e]), S = de(() => (a && !["center", "left", "right"].includes(e) && console.warn(
  ...
  return w && t ? /* @__PURE__ */ o(
    en,
    {
      ...
      portalContainer: M,
      shownBottomSheet: !0,
      children: /* @__PURE__ */ f(Si, { open: n, onOpenChange: N, children: [
        /* @__PURE__ */ o(Ni, { className: "bg-f1-background-overlay" }),
        /* @__PURE__ */ f(Ti, { ref: $, className: E, children: [
          /* @__PURE__ */ o(dn, { ...b }),
          /* @__PURE__ */ o(cn, { disableContentPadding: k, children: s }),
          /* @__PURE__ */ o(
            ln,
            {
              primaryAction: i,
...
}, x1 = (t) => /* @__PURE__ */ o(Ru, { ...t });
x1.displayName = "F0Dialog";
const Su = $o(
  Fi("F0Dialog", x1)
), Nu = ["days", "hours", "minutes", "seconds"], hf = ["sm", "md"], k1 = [...Nu], pf = ["hours", "minutes"], We = {
  days: 86400,
  hours: 3600,
  minutes: 60,
  seconds: 1
...
function Tu(t) {
  ...
  const n = Math.floor(r / We.days);
  r = r % We.days;
  const s = Math.floor(r / We.hours);
  r = r % We.hours;
  const a = Math.floor(r / We.minutes), i = r % We.minutes;
  return { days: n, hours: s, minutes: a, seconds: i };
}
function mf(t) {
  return k1.reduce((e, r) => {
...
function gf(t, e) {
  ...
  const s = { days: 0, hours: 0, minutes: 0, seconds: 0 }, a = k1.filter((i) => e.includes(i));
  for (const i of a)
    s[i] = Math.floor(n / We[i]), n = n % We[i];
  return s;
}
function vf(t, e) {
...
const ne = Object.freeze({
  status: "aborted"
}), _t = (t) => ({ status: "dirty", value: t }), Ie = (t) => ({ status: "valid", value: t }), fn = (t) => t.status === "aborted", hn = (t) => t.status === "dirty", vt = (t) => t.status === "valid", Gt = (t) => typeof Promise < "u" && t instanceof Promise;
var Y;
(function(t) {
...
class le {
  ...
  "~validate"(e) {
    ...
    return this._parseAsync({ data: e, path: [], parent: r }).then((n) => vt(n) ? {
      value: n.value
    } : {
      issues: r.common.issues
    });
  ...
  async safeParseAsync(e, r) {
    const n = {
      ...
      data: e,
      parsedType: rt(e)
    }, s = this._parse({ data: e, path: n.path, parent: n }), a = await (Gt(s) ? s : Promise.resolve(s));
    return pn(n, a);
  }
  refine(e, r) {
...
const Pu = /^c[^\s-]{8,}$/i, $u = /^[0-9a-z]+$/, Iu = /^[0-9A-HJKMNP-TV-Z]{26}$/i, Hu = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i, ju = /^[a-z0-9_-]{21}$/i, Ou = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/, Du = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/, Zu = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i, Bu = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let cr;
const Uu = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, zu = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/, Wu = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/, Gu = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/, qu = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/, Xu = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/, y1 = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))", Yu = new RegExp(`^${y1}$`);
function b1(t) {
  let e = "[0-5]\\d";
...
function Ju(t, e) {
  return !!((e === "v4" || !e) && Uu.test(t) || (e === "v6" || !e) && Wu.test(t));
}
function e4(t, e) {
  if (!Ou.test(t))
    return !1;
...
function t4(t, e) {
  return !!((e === "v4" || !e) && zu.test(t) || (e === "v6" || !e) && Gu.test(t));
}
class nt extends le {
  _parse(e) {
    ...
    for (const a of this._def.checks)
      if (a.kind === "min")
        ...
        Zu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "email",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "emoji")
        cr || (cr = new RegExp(Bu, "u")), cr.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "emoji",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
        ...
        ju.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "nanoid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
        ...
        $u.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "cuid2",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "ulid")
        Iu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "ulid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
        ...
        validation: "datetime",
        message: a.message
      }), n.dirty()) : a.kind === "date" ? Yu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
        code: A.invalid_string,
        validation: "date",
        message: a.message
      }), n.dirty()) : a.kind === "time" ? Ku(a).test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
        code: A.invalid_string,
        validation: "time",
        message: a.message
      }), n.dirty()) : a.kind === "duration" ? Du.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
        validation: "duration",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "ip" ? Ju(e.data, a.version) || (s = this._getOrReturnCtx(e, s), Z(s, {
        validation: "ip",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "jwt" ? e4(e.data, a.alg) || (s = this._getOrReturnCtx(e, s), Z(s, {
        validation: "jwt",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "cidr" ? t4(e.data, a.version) || (s = this._getOrReturnCtx(e, s), Z(s, {
        validation: "cidr",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "base64" ? qu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
        validation: "base64",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "base64url" ? Xu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
  ...
  _parse(e) {
    ...
    for (const a of this._def.checks)
      a.kind === "int" ? fe.isInteger(e.data) || (n = this._getOrReturnCtx(e, n), Z(n, {
        ...
        exact: !1,
        message: a.message
      }), s.dirty()) : a.kind === "multipleOf" ? r4(e.data, a.value) !== 0 && (n = this._getOrReturnCtx(e, n), Z(n, {
...
class Ue extends le {
  _parse(e) {
    ...
    if (s.minLength !== null && r.data.length < s.minLength.value && (Z(r, {
      ...
      return Promise.all([...r.data].map((i, l) => s.type._parseAsync(new at(r, i, r.path, l)))).then((i) => Fe.mergeArray(n, i));
    const a = [...r.data].map((i, l) => s.type._parseSync(new at(r, i, r.path, l)));
...
function pt(t) {
  if (t instanceof ke) {
    ...
    ...t._def,
    type: pt(t.element)
  }) : t instanceof st ? st.create(pt(t.unwrap())) : t instanceof kt ? kt.create(pt(t.unwrap())) : t instanceof lt ? lt.create(t.items.map((e) => pt(e))) : t;
}
class ke extends le {
  constructor() {
  ...
  _parse(e) {
    ...
    for (const d of i) {
      ...
      c.push({
        ...
        value: u._parse(new at(s, h, s.path, d)),
  ...
  keyof() {
    return L1(fe.objectKeys(this.shape));
  }
}
...
class qt extends le {
  _parse(e) {
    ...
    function s(a) {
      ...
      const i = a.map((l) => new Xe(l.ctx.common.issues));
      return Z(r, {
...
class Xt extends le {
  _parse(e) {
    const { status: r, ctx: n } = this._processInputParams(e), s = (a, i) => {
      ...
      return l.valid ? ((hn(a) || hn(i)) && r.dirty(), { status: r.value, value: l.data }) : (Z(n, {
...
class lt extends le {
  _parse(e) {
    ...
    const a = [...n.data].map((i, l) => {
      ...
      return c ? c._parse(new at(n, i, n.path, l)) : null;
    }).filter((i) => !!i);
...
class wn extends le {
  ...
  _parse(e) {
    ...
    const s = this._def.keyType, a = this._def.valueType, i = [...n.data.entries()].map(([l, c], d) => ({
      key: s._parse(new at(n, l, n.path, [d, "key"])),
      value: a._parse(new at(n, c, n.path, [d, "value"]))
    }));
    if (n.common.async) {
...
class Ft extends le {
  _parse(e) {
    ...
    const l = [...n.data.values()].map((c, d) => a._parse(new at(n, c, n.path, d)));
...
class wt extends le {
  ...
  exclude(e, r = this._def) {
    return wt.create(this.options.filter((n) => !e.includes(n)), {
      ...this._def,
      ...r
    });
  }
  ...
  _parse(e) {
    ...
    if (a.addIssue = a.addIssue.bind(a), s.type === "preprocess") {
      ...
      if (n.common.async)
        return Promise.resolve(i).then(async (l) => {
          ...
          return c.status === "aborted" ? ne : c.status === "dirty" || r.value === "dirty" ? _t(c.value) : c;
        });
      {
        if (r.value === "aborted")
          return ne;
        ...
        return l.status === "aborted" ? ne : l.status === "dirty" || r.value === "dirty" ? _t(l.value) : l;
      }
    }
    ...
    if (s.type === "transform")
      if (n.common.async === !1) {
        ...
        return this._def.schema._parseAsync({ data: n.data, path: n.path, parent: n }).then((i) => vt(i) ? Promise.resolve(s.transform(i.value, a)).then((l) => ({
          status: r.value,
          value: l
        })) : ne);
    fe.assertNever(s);
...
xt.createWithPreprocess = (t, e, r) => new xt({
  schema: e,
  ...
  _parse(e) {
    ...
    if (n.common.async)
      return (async () => {
        ...
        return a.status === "aborted" ? ne : a.status === "dirty" ? (r.dirty(), _t(a.value)) : this._def.out._parseAsync({
          data: a.value,
          path: n.path,
          parent: n
        });
...
class Sr extends le {
  _parse(e) {
    const r = this._def.innerType._parse(e), n = (s) => (vt(s) && (s.value = Object.freeze(s.value)), s);
    return Gt(r) ? r.then((s) => n(s)) : n(r);
  }
  unwrap() {
    return this._def.innerType;
  }
...
const Re = nt.create, ut = Ct.create, bn = yr.create, et = Vt.create, Cf = br.create, wf = Lr.create;
it.create;
const Lt = Ue.create, Nr = ke.create;
qt.create;
Xt.create;
lt.create;
const Ln = Er.create, Mt = wt.create;
Yt.create;
st.create;
kt.create;
function Oe(t, e) {
...
function E1(t) {
  const e = t;
  return e._f0Config ? e._f0Config : M1.get(t);
}
function kf(t) {
  return E1(t) !== void 0;
}
...
((t) => {
  function e({
    ...
    let E = Re();
    const b = !w && x === void 0 ? 1 : x;
    b !== void 0 && (E = E.min(b)), y !== void 0 && (E = E.max(y));
    const L = w ? E.optional() : E;
    return t(L, S);
  }
  t.text = e;
  function r({ optional: w, ...x }) {
    const y = w ? Re().email().optional() : Re().email();
    return t(y, x);
  }
  t.email = r;
  function n({ optional: w, ...x }) {
    const y = w ? Re().optional() : Re().min(1);
    return t(
      y,
  ...
  function s({
    ...
    let b = ut();
    S && (b = b.int()), x !== void 0 && (b = b.min(x)), y !== void 0 && (b = b.max(y));
    const L = w ? b.optional() : b;
    return t(L, E);
  }
  t.number = s;
  function a({ optional: w, ...x }) {
    const y = w ? bn() : Ln(!0);
    return t(
      y,
      { ...x, fieldType: "switch" }
  ...
  t.checkbox = i;
  function l({ optional: w, ...x }) {
    const y = w ? et().optional() : et();
    return t(y, x);
  }
  t.date = l;
  function c({ optional: w, ...x }) {
    const y = w ? Re().url().optional() : Re().url();
    return t(y, x);
  }
  t.url = c;
  function d({ optional: w, ...x }) {
    const y = w ? ut().optional() : ut();
    return t(
      y,
      { ...x, fieldType: "money" }
    );
  ...
  function u({
    ...
    let E = ut();
    x !== void 0 && (E = E.min(x)), y !== void 0 && (E = E.max(y));
    const b = w ? E.optional() : E;
    return t(
      b,
  ...
  function h(w) {
    ...
    const { optional: x, ...y } = w, S = y.options.map((b) => b.value), E = x ? Mt(S).optional() : Mt(S);
    return t(
      E,
  ...
  t.cardSelect = h;
  function v({ optional: w, ...x }) {
    const y = w ? Re().optional() : Re().min(1);
    return t(
      y,
      { ...x, fieldType: "file", multiple: !1 }
    );
  }
  t.file = v;
  function p({ optional: w, ...x }) {
    const y = w ? Lt(Re()).optional() : Lt(Re()).min(1);
    return t(
      y,
      { ...x, fieldType: "file", multiple: !0 }
    );
  }
  t.multiFile = p;
  function g({ optional: w, ...x }) {
    const y = w ? et().optional() : et();
    return t(
      y,
      { ...x, fieldType: "time" }
  ...
  t.time = g;
  function k({ optional: w, ...x }) {
    const y = w ? et().optional() : et();
    return t(
      y,
      { ...x, fieldType: "datetime" }
    );
  }
  t.datetime = k;
  function C({ optional: w, ...x }) {
    ...
    return t(
      y,
      { ...x, fieldType: "duration" }
    );
  }
  t.duration = C;
  function M({ optional: w, ...x }) {
    const y = Nr({ from: et(), to: et() }), S = w ? y.optional() : y;
    return t(
      S,
      { ...x, fieldType: "daterange" }
    );
  }
  t.dateRange = M;
  function P({ optional: w, ...x }) {
    const y = Nr({
      value: Re(),
      mentionIds: Lt(Re()).optional()
    }), S = w ? y.optional() : y;
    return t(
      S,
      { ...x, fieldType: "richtext" }
    );
  }
  t.richText = P;
  function $(w) {
    ...
    const x = w, { optional: y, ...S } = x, E = Array.isArray(x.options) ? x.options : void 0;
    if (E && E.length > 0) {
      const L = E.filter(
        (R) => typeof R == "object" && R !== null && "value" in R && typeof R.value == "string"
      ).map((R) => R.value);
      if (L.length > 0) {
        const R = y ? Mt(L).optional() : Mt(L);
        return t(R, S);
      }
    }
    const b = y ? Re().optional() : Re();
    return t(b, S);
  }
  t.select = $;
  function N(w) {
    ...
    if (E && E.length > 0) {
      ...
      if (R.length > 0) {
        const B = Lt(Mt(R)).min(1), X = y ? B.optional() : B;
        return t(
          X,
          { ...S, multiple: !0 }
        );
    ...
    const b = Lt(Re()).min(1), L = y ? b.optional() : b;
    return t(L, { ...S, multiple: !0 });
  }
  t.multiSelect = N;
})(Mn || (Mn = {}));
const o4 = /* @__PURE__ */ Symbol("Let zodToJsonSchema decide on which parser to use"), s4 = {
  name: void 0,
  $refStrategy: "root",
  basePath: ["#"],
  ...
  const e = a4(t), r = e.name !== void 0 ? [...e.basePath, e.definitionPath, e.name] : e.basePath;
  return {
    ...e,
...
function Ae(t) {
  ...
  return t.flags.hasReferencedOpenAiAnyType = !0, {
    $ref: t.$refStrategy === "relative" ? R1(e, t.currentPath) : e.join("/")
  };
}
function c4(t, e) {
  const r = {
...
const u4 = (t, e) => he(t.innerType._def, e);
function N1(t, e, r) {
  const n = r ?? e.dateStrategy;
  if (Array.isArray(n))
    return {
      anyOf: n.map((s, a) => N1(t, e, s))
    };
  switch (n) {
    case "string":
    ...
    for (const n of t.checks)
      switch (n.kind) {
        ...
        case "regex":
          ...
          break;
        case "cuid":
          Ne(r, He.cuid, n.message, e);
          break;
        case "cuid2":
          Ne(r, He.cuid2, n.message, e);
          break;
        case "startsWith":
          Ne(r, RegExp(`^${dr(n.value, e)}`), n.message, e);
          break;
        case "endsWith":
          Ne(r, RegExp(`${dr(n.value, e)}$`), n.message, e);
          break;
        ...
        case "base64url":
          Ne(r, He.base64url, n.message, e);
          break;
        case "jwt":
          Ne(r, He.jwt, n.message, e);
          break;
        case "cidr": {
          n.version !== "v6" && Ne(r, He.ipv4Cidr, n.message, e), n.version !== "v4" && Ne(r, He.ipv6Cidr, n.message, e);
          break;
        }
        case "emoji":
          Ne(r, He.emoji(), n.message, e);
          break;
        case "ulid": {
          Ne(r, He.ulid, n.message, e);
          break;
        }
        case "base64": {
        ...
        case "nanoid":
          Ne(r, He.nanoid, n.message, e);
      }
  return r;
}
function dr(t, e) {
  return e.patternStrategy === "escape" ? x4(t) : t;
}
const w4 = new Set("ABCDEFGHIJKLMNOPQRSTUVXYZabcdefghijklmnopqrstuvxyz0123456789");
function x4(t) {
  let e = "";
  for (let r = 0; r < t.length; r++)
    w4.has(t[r]) || (e += "\\"), e += t[r];
...
function A1(t, e) {
  ...
  if (t.keyType?._def.typeName === F.ZodString && t.keyType._def.checks?.length) {
    const { type: n, ...s } = T1(t.keyType._def, e);
    return {
      ...r,
      propertyNames: s
    };
    ...
    if (t.keyType?._def.typeName === F.ZodBranded && t.keyType._def.type._def.typeName === F.ZodString && t.keyType._def.type._def.checks?.length) {
      const { type: n, ...s } = S1(t.keyType._def, e);
      return {
        ...r,
        propertyNames: s
      };
...
function _4(t, e) {
  ...
  for (const n of t.checks)
    switch (n.kind) {
      case "int":
        r.type = "integer", _1(r, "type", n.message, e);
        break;
      case "min":
        e.target === "jsonSchema7" ? n.inclusive ? ve(r, "minimum", n.value, n.message, e) : ve(r, "exclusiveMinimum", n.value, n.message, e) : (n.inclusive || (r.exclusiveMinimum = !0), ve(r, "minimum", n.value, n.message, e));
        break;
...
const H4 = (t, e) => he(t.innerType._def, e), j4 = (t, e, r) => {
  switch (e) {
    case F.ZodString:
      return T1(t, r);
    case F.ZodNumber:
...
function he(t, e, r = !1) {
  ...
  e.seen.set(t, s);
  const a = j4(t, t.typeName, e), i = typeof a == "function" ? he(a(), e) : a;
  if (i && D4(t, e, i), e.postProcess) {
...
const O4 = (t, e) => {
  switch (e.$refStrategy) {
    ...
    case "relative":
      return { $ref: R1(e.currentPath, t.path) };
    case "none":
    case "seen":
...
}, D4 = (t, e, r) => (t.description && (r.description = t.description, e.markdownDescription && (r.markdownDescription = t.description)), r), ft = (t, e) => {
  const r = i4(e);
...
function Sn(t) {
  ...
  for (; e; ) {
    ...
    if ("schema" in r && r.schema instanceof le) {
      e = r.schema;
      continue;
    }
    if ("innerType" in r && r.innerType instanceof le) {
      e = r.innerType;
      continue;
    }
    break;
  ...
  const e = t._brand === "per-section" ? Object.fromEntries(
    ...
    (() => {
      ...
      for (const [c, d] of Object.entries(
        ...
        const u = Sn(d);
        if (u.shape)
          for (const [h, v] of Object.entries(u.shape))
            h in l && console.warn(
...
function bf({
  ...
  const r = de(
    () => e?.map(V1),
    [e]
  ), n = j(/* @__PURE__ */ new Map()), s = j(""), a = j(/* @__PURE__ */ new Map()), i = j(/* @__PURE__ */ new Set()), l = j(/* @__PURE__ */ new Map()), c = j(/* @__PURE__ */ new Map()), [d, u] = z([]), [h, v] = z(
    []
  ), [p, g] = z(
    null
  ), k = j(null), C = j({}), M = Q(() => {
    queueMicrotask(() => {
      const _ = Array.from(n.current.entries()), q = [], O = [];
      let U = null;
      for (const [ue, D] of _) {
        ...
        if (re && (D.virtual ? O.push({
          ...
          U = {
            ...
            ...D.description ? { description: D.description } : {},
            ...D.module ? { module: D.module } : {},
            cardTitle: ie.cardTitle ?? "",
            cardDescription: ie.cardDescription ?? "",
            formSchema: ft(D.schema),
            fieldDescriptions: ur(D.schema),
            sectionDescriptions: fr(D.sections),
            formValues: re.getValues(),
      ...
      const me = JSON.stringify({
        formsOnCurrentPage: q,
        availableForms: O,
        activeForm: U
      });
      me !== s.current && (s.current = me, u(q), v(O), g(U));
    });
  }, []), P = Q(
    (_, q, O, U, me, ue, D, re) => {
      const ie = n.current.get(_);
      n.current.set(_, {
        ref: q,
        schema: O,
        description: D,
        module: re,
        sections: U,
        defaultValuesParamsSchema: me ?? ie?.defaultValuesParamsSchema,
        defaultValuesFn: ue ?? ie?.defaultValuesFn,
        defaultValuesParams: ie?.defaultValuesParams,
        onSubmit: ie?.onSubmit,
        steps: ie?.steps,
        submitConfig: ie?.submitConfig,
        errorTriggerMode: ie?.errorTriggerMode
      }), M();
    },
    [M]
  ), $ = Q(
    (_) => {
      const q = n.current.get(_);
      if (q?.virtual) return;
      const O = q?.ref.current?.getValues() ?? {};
      n.current.delete(_);
      const U = r?.find((me) => me.name === _);
      if (U) {
        const ue = { ...typeof U.defaultValues == "function" ? {} : Nn(U.defaultValues), ...O }, { ref: D, dirtyFields: re } = Tn(
          U.schema,
          ue,
          U.onSubmit
        ), ie = typeof U.defaultValues == "function" ? (() => {
          const ye = U.defaultValues;
          return async (T) => {
            const H = ye(T);
        ...
        n.current.set(_, {
          ...
          sections: U.sections,
          virtual: !0,
          defaultValuesParamsSchema: U.defaultValuesParamsSchema,
          defaultValuesFn: ie,
          defaultValuesParams: q?.defaultValuesParams,
          dirtyFields: re,
          onSubmit: U.onSubmit,
          steps: U.steps,
          submitConfig: U.submitConfig,
    ...
    [M, r]
  ), N = Q((_) => n.current.get(_), []), w = Q(() => Array.from(n.current.keys()), []), x = Q(
    (_, q) => {
      const O = n.current.get(_);
      if (!O) {
        const U = Array.from(n.current.keys());
        return {
          success: !1,
          error: `Form "${_}" not found. Available forms: ${U.join(", ")}`
        };
      }
      return O.virtual ? (k.current = _, C.current = {
        cardTitle: q?.cardTitle ?? "",
        cardDescription: q?.cardDescription ?? ""
      }, M(), { success: !0 }) : {
        success: !1,
        error: `Form "${_}" is a rendered form on the current page. You can co-edit it directly without picking it as active.`
      };
    },
    [M]
  ), y = Q(() => {
    k.current = null, C.current = { cardTitle: "", cardDescription: "" }, M();
  }, [M]), S = Q(
    (_, q) => {
      const O = n.current.get(_);
      O && (O.defaultValuesParams = q);
    },
    []
  ), E = Q((_) => {
    const q = a.current.get(_) ?? 0;
    a.current.set(_, q + 1);
  }, []), b = Q((_) => {
    a.current.delete(_), i.current.delete(_), l.current.delete(_), c.current.delete(_);
  }, []), L = Q((_) => a.current.get(_) ?? 0, []), R = Q((_) => !i.current.has(_), []), B = Q((_) => {
    i.current.add(_);
  }, []), X = Q(
    (_, q) => {
      i.current.delete(_), l.current.set(_, q ?? null);
      const O = c.current.get(_);
      if (O?.length) {
        c.current.delete(_);
        for (const U of O)
          U();
    ...
    (_, q) => {
      const O = c.current.get(_) ?? [];
      O.push(q), c.current.set(_, O);
    },
    []
  ), te = Q(
    (_, q) => l.current.has(_) ? q === void 0 ? !0 : l.current.get(_) === q : !1,
    []
  ), oe = j(/* @__PURE__ */ new Set());
  ce(() => {
    const _ = r ?? [], q = /* @__PURE__ */ new Set();
    for (const O of _) {
      q.add(O.name);
      const U = n.current.get(O.name);
      if (U && !U.virtual || U?.virtual) continue;
      const me = typeof O.defaultValues == "function" ? {} : Nn(O.defaultValues), { ref: ue, dirtyFields: D } = Tn(
        O.schema,
        me,
        O.onSubmit
      ), re = typeof O.defaultValues == "function" ? (() => {
        const ie = O.defaultValues;
        return async (ye) => {
          const T = ie(ye);
    ...
    for (const O of oe.current)
      q.has(O) || n.current.get(O)?.virtual && n.current.delete(O);
    return oe.current = q, M(), () => {
      for (const O of q)
  ...
  const ee = de(
    () => ({
      ...
      incrementFillVersion: E,
      resetFillVersion: b,
      getFillVersion: L,
      isDefaultValuesResolved: R,
  ...
  return /* @__PURE__ */ o(F1.Provider, { value: ee, children: t });
}
function B4() {
  return yt(F1);
}
const U4 = 2, An = 2, z4 = 70, Vn = 0.08, W4 = 6, G4 = 0.6, q4 = () => {
  ...
  return ce(() => {
    ...
    const c = () => {
      ...
      s(
        Math.max(1, Math.floor((u + An) / (U4 + An)))
      );
    };
    ...
    const h = new Uint8Array(u.fftSize), v = setInterval(() => {
      ...
      const g = Math.sqrt(p / h.length), k = Math.min(1, Math.pow(g * W4, G4));
      i((C) => {
        const M = C.length >= n ? C.slice(C.length - n + 1) : C.slice();
        return M.push(k), M;
      });
    }, z4);
    return () => {
      clearInterval(v), d.disconnect(), u.disconnect(), c.close(), i([]);
    };
  }, [t, n]), /* @__PURE__ */ o(
    "div",
    {
  ...
  const C = pe();
  return h === "recording" ? /* @__PURE__ */ f("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    /* @__PURE__ */ o(
      X4,
      {
        stream: v ?? null,
    ...
    /* @__PURE__ */ o("div", { className: "flex items-center gap-2", children: t && /* @__PURE__ */ f(qe, { children: [
      /* @__PURE__ */ o(
        Me,
        {
          ...
          variant: "outline",
          size: "md",
          disabled: e || h === "transcribing",
          onClick: (M) => {
            M.preventDefault(), s.current?.click();
          }
        }
      ),
      /* @__PURE__ */ o(
    ...
    /* @__PURE__ */ f("div", { className: "flex items-center gap-2", children: [
      u && /* @__PURE__ */ o(
        Me,
        {
          ...
          disabled: i,
          onClick: p,
          loading: h === "transcribing"
        }
      ),
      d && (h !== "transcribing" && i ? /* @__PURE__ */ o(
        Me,
        {
          type: "submit",
          variant: "neutral",
  ...
  "div",
  {
    ...
    children: t.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ o($e, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ o(
        Q4,
        {
          att: s,
          onRemove: r,
...
function Q4({
  ...
  const n = /* @__PURE__ */ f("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ o(be, { icon: wo, size: "md", color: "critical" }),
  ...
  return t.errorMessage ? /* @__PURE__ */ o(Pi, { label: t.errorMessage, children: n }) : n;
}
const J4 = {
  soft: {
    text: "",
...
function t6({
  ...
  const i = j(null), l = j(null);
  ce(() => {
    l.current?.scrollIntoView({ block: "nearest" });
  }, [n]), mo(() => {
    const u = i.current, h = u?.offsetParent;
    if (!u || !h) return;
    const v = u.offsetLeft + u.offsetWidth - h.clientWidth;
    v > 0 && (u.style.left = `${Math.max(0, u.offsetLeft - v)}px`);
  }, [s]);
    ...
    "div",
    {
      ...
      children: c ? Array.from({ length: 3 }, (u, h) => /* @__PURE__ */ f(
        "div",
        {
          ...
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ o($e, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ o(
              $e,
              {
        ...
        const v = h === n, p = `${u.firstName} ${u.lastName}`.trim();
        return /* @__PURE__ */ f(
          "div",
          {
            ref: v ? l : void 0,
            ...
            className: V(
              ...
              "transition-colors",
              v ? "bg-f1-background-secondary" : "hover:bg-f1-background-secondary-hover"
            ),
            onMouseDown: (g) => {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ o(_e, { className: "text-base font-medium text-f1-foreground", children: p }) })
            ]
          },
          String(u.id)
        );
...
const r6 = ({
  ...
  const s = ze(), [a, i] = z(""), [l, c] = z(0), [d, u] = z(!1), h = j(null), v = j(null), p = j(null), g = t[l] ?? e;
  return ce(() => {
    const k = () => {
      v.current && (clearInterval(v.current), v.current = null), p.current && (clearInterval(p.current), p.current = null), h.current && (clearTimeout(h.current), h.current = null);
    };
    if (r.length > 0 || n) {
      u(!1), i(""), k();
      return;
    ...
    if (s)
      return u(!1), i(g), k(), h.current = setTimeout(() => {
    ...
    u(!0), i("");
    let C = 0;
    const M = 50, P = 30, $ = 2e3, N = 1e3;
    return v.current = setInterval(() => {
      C < g.length ? (i(g.slice(0, C + 1)), C++) : (v.current && (clearInterval(v.current), v.current = null), h.current = setTimeout(() => {
        p.current = setInterval(() => {
          C > 0 ? (C--, i(g.slice(0, C))) : (p.current && (clearInterval(p.current), p.current = null), h.current = setTimeout(() => {
            const w = (l + 1) % Math.max(t.length, 1);
            c(w);
          }, N));
        }, P);
    ...
    t.length,
    s
  ]), r.length > 0 || n ? null : /* @__PURE__ */ o(Be, { children: /* @__PURE__ */ o(
    Ce.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
const i6 = ({
  ...
  const [n, s] = z(null), a = n !== null ? t[n] : null;
  return t.length === 0 ? null : /* @__PURE__ */ f(
    Hr,
    {
      ...
      children: [
        /* @__PURE__ */ o(Ii, { asChild: !0, children: /* @__PURE__ */ o("div", { className: "flex w-full flex-wrap items-center gap-2", children: t.map((i, l) => /* @__PURE__ */ o(jr, { asChild: !0, children: /* @__PURE__ */ o(
          Me,
          {
            variant: "outline",
            label: i.label,
        ...
        a && /* @__PURE__ */ f(
          Or,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "flex flex-col", children: a6(a.items).map((i, l) => /* @__PURE__ */ f(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
function c6(t, e, r) {
  ...
  for (const u of e) {
    ...
    let v = 0;
    for (; ; ) {
      const p = t.indexOf(h, v);
      if (p === -1) break;
      a.push({ start: p, end: p + h.length }), v = p + h.length;
    }
  }
...
const l6 = 250, d6 = 12e4, u6 = () => typeof navigator < "u" && !!navigator.mediaDevices?.getUserMedia && typeof MediaRecorder < "u";
function f6({
  onTranscribe: t,
  onPartial: e,
  onFinal: r,
  ...
  const [a, i] = z("idle"), [l, c] = z(0), [d] = z(u6), [u, h] = z(null), v = j(null), p = j(null), g = j([]), k = j(null), C = j(!1), M = j(null), P = j(null), $ = j(0), N = j({ onTranscribe: t, onPartial: e, onFinal: r, onError: n });
  N.current = { onTranscribe: t, onPartial: e, onFinal: r, onError: n };
  const w = Q(() => {
    p.current?.getTracks().forEach((b) => b.stop()), p.current = null, v.current = null, h(null), M.current && (clearInterval(M.current), M.current = null), P.current && (clearTimeout(P.current), P.current = null);
  }, []), x = Q(async () => {
    const { onTranscribe: b, onPartial: L, onFinal: R, onError: B } = N.current, X = g.current;
    if (g.current = [], X.length === 0 || !b) {
      i("idle"), c(0);
      return;
    }
    const J = new Blob(X, { type: X[0]?.type || "audio/webm" }), te = new AbortController();
    k.current = te, i("transcribing");
    try {
      const oe = await b(J, {
        onPartial: L,
        signal: te.signal
      });
      te.signal.aborted || R(oe);
    } catch {
      te.signal.aborted || B("transcription-failed");
    } finally {
      k.current = null, i("idle"), c(0);
    }
  }, []), y = Q(() => {
    const b = v.current;
    ...
    p.current = b, h(b);
    const L = new MediaRecorder(b);
    v.current = L, L.ondataavailable = (R) => {
      R.data.size > 0 && g.current.push(R.data);
    }, L.onstop = () => {
      if (w(), C.current) {
        g.current = [], i("idle"), c(0);
        return;
      }
      x();
    }, L.start(l6), $.current = Date.now(), i("recording"), c(0), M.current = setInterval(() => {
      c(Date.now() - $.current);
    ...
    a === "recording" ? (C.current = !0, y()) : a === "transcribing" && (k.current?.abort(), k.current = null, i("idle"), c(0));
  }, [a, y]);
  return ce(
    () => () => {
      C.current = !0, k.current?.abort();
      const b = v.current;
      b && b.state !== "inactive" && b.stop(), w();
    },
    [w]
  ), { status: a, durationMs: l, isSupported: d, stream: u, start: S, stop: y, cancel: E };
}
function h6(t, e) {
  if (e === "*/*") return !0;
  if (e.endsWith("/*")) {
...
function p6(t, e) {
  ...
  return r.length === 0 ? t : t.filter(
    (n) => r.some((s) => h6(n.type, s))
  );
}
const m6 = 4e3;
function g6(t) {
  const [e, r] = z([]), [n, s] = z(null), a = j(
    null
  ), i = j(null), l = pe(), c = t?.onUploadFiles, d = t?.allowedMimeTypes, u = t?.maxFiles, h = de(() => {
    if (d)
      return Array.isArray(d) ? d.join(",") : d;
  }, [d]), v = u !== void 0 && e.length >= u, p = j(0);
  ce(() => {
    p.current = e.length;
  }, [e]);
  const g = Q(($) => {
  ...
  const k = Q(
    async ($) => {
      ...
      const y = (S) => r(
        (E) => E.map(
          (b) => x.includes(b.id) ? { ...b, status: "error", errorMessage: S } : b
        )
      );
      try {
        const S = await c(N);
        if (!Array.isArray(S) || S.length !== N.length) {
          y(l.ai.fileUploadError);
          return;
        }
        r(
          (E) => E.map((b) => {
            const L = w.findIndex((R) => R.id === b.id);
            return L === -1 ? b : S[L] ? {
              ...b,
              status: "uploaded",
              uploadedFile: S[L]
        ...
        const E = S instanceof Error && S.message ? S.message : l.ai.fileUploadError;
        y(E);
      }
    },
    [
    ...
    async ($) => {
      await k(Array.from($.target.files ?? [])), $.target.value = "";
    },
    [k]
  ), M = Q(($) => {
    r((N) => N.filter((w) => w.id !== $));
...
function k6({
  ...
  const [a, i] = z(!1), [l, c] = z(""), [d, u] = z([]), [h, v] = z(!1), [p, g] = z(0), [k, C] = z([]), M = j(-1), P = j(null), $ = j(0), N = j(-1);
  ce(() => {
    if (!n) {
      i(!1);
      return;
    ...
    const L = v6(t, r, k);
    if (!L) {
      i(!1), c(""), u([]), g(0), M.current = -1, N.current = -1;
      return;
    }
    if (L.atIndex === N.current)
      return;
    M.current = L.atIndex, c(L.query), i(!0), g(0), v(!0), P.current && clearTimeout(P.current);
    const R = ++$.current;
    return P.current = setTimeout(() => {
      n(L.query).then((B) => {
        R === $.current && (u(B), g(0), B.length === 0 && L.query.length > 0 && (N.current = L.atIndex, i(!1)));
      }).catch(() => {
        R === $.current && u([]);
      }).finally(() => {
        R === $.current && v(!1);
  ...
  const w = Q(() => {
    ...
    (L) => {
      const R = M.current;
      if (R === -1) return;
      const B = `${L.firstName} ${L.lastName}`.trim(), X = String(L.id), J = t.slice(0, R), te = t.slice(r), oe = `@${B} `, ee = J + oe + te, _ = J.length + oe.length;
      e(ee), C((q) => [...q.filter((U) => !(U.id === X && U.name === B)), { id: X, name: B }]), w(), requestAnimationFrame(() => {
        const q = s.current;
        q && (q.focus(), q.setSelectionRange(_, _));
      });
    },
    [t, r, e, s, w]
  ), y = Q(
    (L) => {
      if (!a) return !1;
      if (L.key === "Escape")
        return L.preventDefault(), w(), !0;
      if (d.length === 0) return !1;
      switch (L.key) {
        case "ArrowDown":
          return L.preventDefault(), g((R) => (R + 1) % d.length), !0;
        case "ArrowUp":
          return L.preventDefault(), g(
            (R) => (R + d.length - 1) % d.length
          ), !0;
        case "Tab": {
          const R = d[p];
          if (R) {
            const B = `${R.firstName} ${R.lastName}`.trim();
            if (l.length === 0 || B.toLowerCase().startsWith(l.toLowerCase()))
              return L.preventDefault(), x(R), !0;
          }
          return !1;
        }
        case "Enter":
          return L.preventDefault(), d[p] && x(d[p]), !0;
        default:
          return !1;
      }
    },
    ...
    (L) => {
      ...
      let R = L;
      const B = [...k].sort((X, J) => J.name.length - X.name.length);
      for (const X of B) {
        const J = `@${X.name}`, te = `<entity-ref type="person" id="${Fn(X.id)}">${Fn(X.name)}</entity-ref>`;
        for (; R.includes(J); )
          R = R.replace(J, te);
      }
      return R;
...
` || J === "	";
  ...
  const E = de(() => {
    ...
    const L = s.current;
    if (!L) return null;
    const R = w6(L, M.current), B = L.offsetLeft + R.left, J = (L.offsetParent ? L.offsetParent.offsetHeight : 0) - (L.offsetTop + R.top);
    return { left: B, bottom: J };
  }, [a, t, r, s]), b = de(() => {
    if (!a || d.length === 0) return null;
    const L = d[p];
    if (!L) return null;
    const R = `${L.firstName} ${L.lastName}`.trim();
    return l.length === 0 ? R : R.toLowerCase().startsWith(l.toLowerCase()) ? R.slice(l.length) : null;
  }, [a, d, p, l]);
  return {
    isOpen: a,
    query: l,
...
const y6 = /[\\`*_{}[\]()#+\-.!|~>]/g, b6 = (t) => t.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((e, r) => r % 2 === 1 ? e : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(y6, "\\$&")).join(""), Lf = ({
  onSubmit: t,
  onStop: e,
  inProgress: r,
  onBeforeSubmit: n,
  ...
  apiRef: x,
  onChange: y,
  showSubmitButton: S = !0
}) => {
  const E = pe(), b = ze(), [L, R] = z(""), [B, X] = z(0), [J, te] = z(!1), [oe, ee] = z(!1), [_, q] = z(null), O = j(null), U = j(null), me = j(null), ue = i != null, { tracking: D } = Ke(), re = Q(
    (ge, Ze) => {
      D?.onWelcomeSuggestionClick?.({
        item: ge,
        group: Ze,
        prompt: ge.prompt || ge.title
      }), N?.(ge, Ze);
    },
    [D, N]
  ), {
    ...
    const Ze = Qe.current, ar = Ze && !/\s$/.test(Ze) ? " " : "", Zt = `${Ze}${ar}${ge}`;
    R(Zt), X(Zt.length);
  }, []), rr = {
    "permission-denied": E.ai.micPermissionDenied,
    "device-error": E.ai.micError,
    "transcription-failed": E.ai.transcriptionError
  }, De = f6({
    onTranscribe: v,
    onPartial: Je,
    onFinal: (ge) => {
      Je(ge), U.current?.focus();
    },
    onError: (ge) => Pe(rr[ge])
  }), nr = !!v && De.isSupported, or = Q(() => {
    Qe.current = L, De.start();
  }, [L, De]);
  ks(x, () => ({
    setContent: (ge) => {
      R(ge), X(ge.length);
    ...
    submit: () => O.current?.requestSubmit(),
    focus: () => U.current?.focus()
  })), ce(() => {
    y?.(L);
  }, [L, y]), ce(() => {
    typeof window < "u" && window.location.hash.length === 0 && U.current?.focus();
  }, []), ce(() => {
    if (g)
      return g((ge) => {
        W(ge);
  ...
  const $t = De.status === "recording", sr = $t ? E.ai.listening : E.ai.inputPlaceholder, It = ie.filter((ge) => ge.status === "uploaded"), dt = ie.some((ge) => ge.status === "uploading"), Ht = ie.some((ge) => ge.status === "error"), jt = L.trim().length > 0;
  ce(() => {
    if (!(!oe || dt)) {
      if (ee(!1), Ht) {
        Pe(E.ai.fileUploadBlockedSubmit);
        return;
      }
    ...
    Ht,
    Pe,
    E.ai.fileUploadBlockedSubmit
  ]);
  const Ot = async (ge) => {
    if (ge.preventDefault(), !ue) {
      if (xe.close(), r)
        e?.();
      else if (jt && !J) {
        if (dt) {
        ...
        const Ze = xe.transformMentions(L.trim()), ar = b6(Ze), Zt = It.flatMap(
          (Qr) => Qr.uploadedFile ? [Qr.uploadedFile] : []
        ), Yr = l, Kr = d;
        Yr && c?.(null), Kr && u?.(null), await t({
          text: ar,
          files: Zt,
          context: Yr,
          quote: Kr
    ...
    ue || xe.handleKeyDown(ge) || ge.key === "Enter" && !ge.shiftKey && (ge.preventDefault(), r || O.current?.requestSubmit());
  }, ps = () => {
    X(U.current?.selectionStart ?? 0);
  }, ms = () => {
    me.current && U.current && (me.current.scrollTop = U.current.scrollTop);
  }, qr = _ ? _.prompt ?? _.title : null, Xr = $t ? [E.ai.listening] : qr ? [qr] : s ?? [], gs = Xr.length > 1, vs = de(() => c6(L, xe.mentions, {
    cursorPosition: B,
    inlineCompletion: xe.inlineCompletion
  }), [L, xe.mentions, B, xe.inlineCompletion]), Cs = xe.mentions.length > 0 || xe.inlineCompletion !== null;
  return /* @__PURE__ */ f("div", { ref: w, className: "flex flex-col items-center gap-2 px-4 pb-3 pt-2", children: [
    /* @__PURE__ */ f("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
      ...
      /* @__PURE__ */ o(e6, { creditWarning: a, children: /* @__PURE__ */ f(
        Ce.form,
        {
          "aria-busy": r,
          ref: O,
          className: V(
            ...
            ue && "after:scale-100 after:opacity-100 border-f1-background-tertiary"
          ),
          animate: {
          ...
          children: [
            /* @__PURE__ */ o(
              t6,
              {
                isOpen: xe.isOpen,
                results: xe.results,
                isLoading: xe.isLoading,
                selectedIndex: xe.selectedIndex,
                position: xe.popoverPosition,
                onSelect: xe.selectPerson
              }
            ),
            /* @__PURE__ */ o(Be, { initial: !1, children: ue ? /* @__PURE__ */ o("div", { children: i }, "clarifying") : /* @__PURE__ */ f(
              Ce.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ o(Be, { initial: !1, children: Se && /* @__PURE__ */ o(
                    Ce.div,
                    {
                      role: "alert",
                      "aria-live": "polite",
                      ...
                      children: /* @__PURE__ */ f(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ o("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ o(Hi, { type: "critical", size: "sm" }) }),
                  ...
                  /* @__PURE__ */ o(
                    o6,
                    {
                      ...
                      onCursorUpdate: ps,
                      onScroll: ms,
                      highlightSegments: vs,
                      hasOverlay: Cs,
                      multiplePlaceholders: gs,
                      placeholders: Xr,
                      resolvedDefaultPlaceholder: sr,
                      inProgress: r
                    }
                  ),
                  /* @__PURE__ */ o(
                    Y4,
                    {
                      ...
                      showSubmitButton: S,
                      canRecord: nr,
                      recordingStatus: De.status,
                      recordingStream: De.stream,
                      onStartRecording: or,
                      onStopRecording: De.stop,
                      onCancelRecording: De.cancel
                    }
                  )
                ]
              },
    ...
    /* @__PURE__ */ o(Be, { mode: "wait", initial: !1, children: ue ? /* @__PURE__ */ f(
      Ce.div,
      {
        ...
        children: [
          /* @__PURE__ */ f("span", { children: [
            ...
            " ",
            E.ai.clarifyingQuestion.navHint.navigate
          ] }),
          /* @__PURE__ */ f("span", { children: [
            /* @__PURE__ */ o("kbd", { className: "font-sans", children: "Enter" }),
            " ",
            E.ai.clarifyingQuestion.navHint.select
          ] }),
          /* @__PURE__ */ f("span", { children: [
            /* @__PURE__ */ o("kbd", { className: "font-sans", children: "Esc" }),
            " ",
            E.ai.clarifyingQuestion.navHint.cancel
          ] })
        ]
      },
      "clarifying-nav-hint"
      ...
      Ce.div,
      {
        ...
        children: [
          ...
          ) : /* @__PURE__ */ o(_e, { className: "text-sm font-medium text-f1-foreground-tertiary", children: k.text }),
          k.link && k.linkText && /* @__PURE__ */ o(
            ji,
            {
              href: k.link,
              target: "_blank",
    ...
    /* @__PURE__ */ o(Be, { children: C && M && /* @__PURE__ */ o(
      Ce.div,
      {
        className: V(
...
function S6({
  ...
  return /* @__PURE__ */ o(Oi, { ...e, variant: "link", href: e.href, children: t });
}
function N6({
  children: t,
  ...e
...
function bt({
  ...
  const a = j(/* @__PURE__ */ new Map()), [i, l] = z(
    () => a.current.get(t) ?? null
  ), [c, d] = z(!1), [u, h] = z(!1), v = j(!0);
  ce(() => () => {
    v.current = !1;
  }, []);
  const p = Q(() => {
    if (i || c) return;
    const k = a.current.get(t);
    if (k) {
      l(k);
      return;
    }
    d(!0), h(!1), r(t).then((C) => {
      a.current.set(t, C), v.current && l(C);
    }).catch(() => {
      v.current && h(!0);
    }).finally(() => {
      v.current && d(!1);
  ...
  return /* @__PURE__ */ f(
    Di,
    {
      ...
      children: [
        /* @__PURE__ */ o(Zi, { asChild: !0, children: e }),
        /* @__PURE__ */ o(
          Bi,
          {
            side: "top",
            ...
            children: c ? /* @__PURE__ */ o(tn.Skeleton, {}) : /* @__PURE__ */ o(tn, { ...g })
          }
        )
      ]
    }
...
P1.displayName = "CandidateTrigger";
function B6({
  id: t,
  label: e
}) {
  const { entityRefs: r } = Ke(), n = r?.resolvers?.candidate, s = pe(), a = r?.urls?.candidate?.(t), i = de(
    () => (c) => {
      const d = [];
...
$1.displayName = "ExpenseTrigger";
function U6({ id: t, label: e }) {
  const { entityRefs: r } = Ke(), n = r?.resolvers?.expense, s = pe(), a = r?.urls?.expense?.(t), i = de(
    () => (c) => ({
      avatar: {
        type: "icon",
        icon: Jo
...
I1.displayName = "JobPostingTrigger";
function z6({
  id: t,
  label: e
}) {
  const { entityRefs: r } = Ke(), n = r?.resolvers?.jobPosting, s = pe(), a = r?.urls?.jobPosting?.(t), i = de(
    () => (c) => ({
      title: c.title,
...
H1.displayName = "RequisitionTrigger";
function G6({
  id: t,
  label: e
}) {
  const { entityRefs: r } = Ke(), n = r?.resolvers?.requisition, s = pe(), a = r?.urls?.requisition?.(t), i = de(
    () => (c) => {
...
j1.displayName = "PersonTrigger";
function q6({ id: t, label: e }) {
  const { entityRefs: r } = Ke(), n = r?.resolvers?.person, s = pe(), a = r?.urls?.person?.(t), i = de(
    () => (c) => ({
      avatar: {
        type: "person",
        firstName: c.firstName,
...
O1.displayName = "VacancyTrigger";
function X6({ id: t, label: e }) {
  const { entityRefs: r } = Ke(), n = r?.resolvers?.vacancy, s = pe(), a = r?.urls?.vacancy?.(t), i = de(
    () => (c) => ({
      title: c.name,
...
}, D1 = ws.forwardRef(({ animate: t = "normal", ...e }, r) => /* @__PURE__ */ f(
  "svg",
  {
    ref: r,
    viewBox: "0 0 24 24",
...
D1.displayName = "CheckCircleLineAnimated";
const Z1 = 60, B1 = 40, Pn = 2e3, n9 = 500, o9 = 12e3, U1 = 2, Rt = 40, ht = [255, 60, 0], hr = [160, 140, 220], pr = { x: -12, y: 0, z: 0 }, mr = { x: -12, y: 12, z: 90 }, mt = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, gr = Math.PI / 180, s9 = U1 / 8 * Math.PI, a9 = 4 * Math.PI;
function Jt(t, e) {
  return [
...
function z1(t, e, r) {
  const n = St(1, 0, 0, t * gr), s = St(0, 1, 0, e * gr), a = St(0, 0, 1, r * gr);
  return i9(Jt(Jt(s, n), a));
}
function c9(t) {
...
const Nt = 256, l9 = (() => {
  ...
  for (let e = 0; e < Nt; e++) {
    const r = e / (Nt - 1), n = Math.round(ht[0] + (hr[0] - ht[0]) * r), s = Math.round(ht[1] + (hr[1] - ht[1]) * r), a = Math.round(ht[2] + (hr[2] - ht[2]) * r);
    t[e] = `rgb(${n},${s},${a})`;
  }
  return t;
})();
function d9(t) {
  const e = t <= 0 ? 0 : t >= 1 ? Nt - 1 : t * (Nt - 1) | 0;
  return l9[e];
}
const u9 = Object.keys(mt).map(Number).sort((t, e) => t - e);
function f9(t) {
  const e = u9;
  if (t <= e[0]) return mt[e[0]];
  if (t >= e[e.length - 1])
    return mt[e[e.length - 1]];
  for (let r = 0; r < e.length - 1; r++)
    if (t >= e[r] && t <= e[r + 1]) {
      const n = (t - e[r]) / (e[r + 1] - e[r]);
      return mt[e[r]] + (mt[e[r + 1]] - mt[e[r]]) * n;
    }
  return 0.72;
}
const In = Math.sqrt(Z1 ** 2 + B1 ** 2), vr = [Z1 / In, B1 / In, 0], h9 = z1(pr.x, pr.y, pr.z), p9 = z1(mr.x, mr.y, mr.z), gt = U1 * 3, zt = Rt + 1, Hn = (gt + 1) * zt, er = 4 * gt * Rt, Cr = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
], m9 = (t, e) => t.avgZ - e.avgZ;
function g9() {
  const t = new Array(er);
  for (let r = 0; r < er; r++)
    t[r] = { points: "", color: "", avgZ: 1 / 0 };
  const e = new Array(Hn);
  for (let r = 0; r < Hn; r++)
    e[r] = { x: 0, y: 0, z: 0, t: 0 };
  return { quads: t, grid: e };
}
function jn(t, e, r, n) {
  const { quads: s, grid: a } = t, i = r * 0.392, l = r / 2, c = r / 2, d = s9 * f9(r), u = e * a9, h = St(0, 0, 1, n * 2 * Math.PI);
  $n(h, vr[0], vr[1], vr[2], tt);
  const v = St(tt[0], tt[1], tt[2], u), p = Jt(v, h9), g = Jt(v, p9);
  Cr[0] = p, Cr[1] = g;
  let k = 0;
  for (let C = 0; C < 4; C++) {
    const M = Cr[C >> 1], P = C & 1 ? -1 : 1;
    for (let $ = 0; $ <= gt; $++) {
      const N = P * (Math.PI / 2 - $ / gt * d), w = Math.cos(N), x = Math.sin(N), y = Math.sin($ / gt * Math.PI), S = $ * zt;
      for (let E = 0; E <= Rt; E++) {
        const b = E / Rt * Math.PI * 2;
        $n(M, w * Math.cos(b), x, w * Math.sin(b), tt);
        const L = a[S + E];
        L.x = tt[0], L.y = tt[1], L.z = tt[2], L.t = y;
      }
    }
    for (let $ = 0; $ < gt; $++) {
      const N = $ * zt, w = ($ + 1) * zt;
      for (let x = 0; x < Rt; x++) {
        const y = a[N + x], S = a[N + x + 1], E = a[w + x], b = a[w + x + 1];
        if ((y.t + S.t + E.t + b.t) * 0.25 < 1e-3) continue;
        const R = (y.x + S.x + E.x + b.x) * 0.25, B = (y.y + S.y + E.y + b.y) * 0.25, X = (y.z + S.z + E.z + b.z) * 0.25, J = R * i, te = B * i, oe = y.x * i - J, ee = y.y * i - te, _ = Math.sqrt(oe * oe + ee * ee), q = _ > 0 ? (_ + 0.9) / _ : 1, O = l + J + oe * q, U = c - te - ee * q, me = S.x * i - J, ue = S.y * i - te, D = Math.sqrt(me * me + ue * ue), re = D > 0 ? (D + 0.9) / D : 1, ie = l + J + me * re, ye = c - te - ue * re, T = b.x * i - J, H = b.y * i - te, I = Math.sqrt(T * T + H * H), K = I > 0 ? (I + 0.9) / I : 1, W = l + J + T * K, se = c - te - H * K, we = E.x * i - J, Le = E.y * i - te, Se = Math.sqrt(we * we + Le * Le), Pe = Se > 0 ? (Se + 0.9) / Se : 1, xe = l + J + we * Pe, Qe = c - te - Le * Pe, Je = s[k];
        Je.points = `${O},${U} ${ie},${ye} ${W},${se} ${xe},${Qe}`, Je.color = d9((R + 1) * 0.5), Je.avgZ = X, k++;
      }
    }
  }
  for (let C = k; C < er; C++)
...
const v9 = ({ size: t = 20, className: e, style: r, variant: n = "default" }, s) => {
  const a = j(null), i = j(null), l = j(null);
  l.current === null && (l.current = g9());
  const c = de(() => new Array(er).fill(0), []), d = (u) => {
  ...
  return ce(() => {
    ...
    let g = null, k = 0, C = 0, M = 0, P = null, $ = "spin", N = !0, w = !1;
    const x = (L) => {
      const R = p.quads;
      ...
      let R = 0, B = !0;
      if (n === "continuous") {
        const oe = Pn * 2, ee = (L - k) % oe / oe;
        R = ee < 0.5 ? ee * 2 : (1 - ee) * 2, B = !1;
      } else $ === "spin" ? (R = Math.min((L - k) / Pn, 1), R >= 1 && (R = 0, $ = "pause", M = L)) : (R = 0, L - M >= n9 && ($ = "spin", k = L));
      const X = (L - C) / o9 % 1, J = B ? c9(R) : R, te = jn(p, J, t, X);
      x(te), g = requestAnimationFrame(y);
    }, S = () => {
...
const On = {
  ...
  return /* @__PURE__ */ f("div", { className: "flex w-full items-start gap-1 text-f1-foreground-secondary", children: [
    /* @__PURE__ */ o("div", { className: "flex h-5 w-6 shrink-0 items-center justify-start", children: /* @__PURE__ */ f(Be, { mode: "wait", children: [
      a && /* @__PURE__ */ o(
        Ce.div,
        {
      ...
      (i || c) && /* @__PURE__ */ o("div", { className: "flex h-5 w-5 shrink-0 items-center justify-center", children: /* @__PURE__ */ o(W1, { variant: i ? "default" : "continuous" }) }),
      l && /* @__PURE__ */ o(
        Ce.div,
        {
          ...On,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ f("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          t?.type === "file" && /* @__PURE__ */ o(zi, { file: t.file, size: "lg" }),
          /* @__PURE__ */ f("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ o(_e, { className: "text-lg font-semibold text-f1-foreground", children: e }),
            r && /* @__PURE__ */ o(_e, { className: "text-base text-f1-foreground-secondary", children: r })
          ] }),
...
G1.displayName = "F0CanvasCard";
const Gr = Pt(null);
function _f({
  children: t
}) {
  const [e, r] = z(0), n = j([]), s = Q(
    (i) => {
...
const Dn = 7, w9 = 625, Zn = /* @__PURE__ */ new Set();
function x9(t) {
...
function y9(t) {
  const { days: e, hours: r, minutes: n, seconds: s } = Tu(t), a = [];
...
function q1(t, e) {
  ...
  if (e === "duration" && typeof t == "number")
    return { type: "item", text: y9(t) };
  if (e === "richtext" && typeof t == "object" && t !== null && "value" in t) {
    const r = t.value;
    return { type: "item", text: (r ? x9(r) : "") || "—" };
  }
  if (e === "daterange" && typeof t == "object" && t !== null && "from" in t && "to" in t) {
    const { from: r, to: n } = t, s = Bn(r) ? Un(r) : String(r), a = Bn(n) ? Un(n) : String(n);
  ...
  if (Array.isArray(t))
    return { type: "item", text: t.map((n) => {
      const s = q1(n);
      return Array.isArray(s) ? s.map(zn).join(", ") : zn(s);
    }).filter(Boolean).join(", ") || "—" };
  ...
  return { type: "item", text: k9(String(t)) };
}
function X1({
  formName: t,
  formDescription: e,
  ...
  const { canvasContent: c, openCanvas: d, closeCanvas: u } = Ke(), h = C9(t), v = l ?? h, p = j(() => {
  }), g = n ?? t, k = s ?? e ?? "", C = c?.type === "form" && c.formName === t, M = () => d({
    type: "form",
    title: g,
    description: k,
    formName: t,
  ...
  p.current = M, ce(() => {
    typeof window > "u" || window.innerWidth < w9 || Zn.has(t) || (Zn.add(t), p.current());
  }, [t]);
  const P = a && i ? Object.entries(a).map(([w, x]) => {
    const y = i[w], S = v?.(w, y, {
      fieldType: x.fieldType,
      customFieldName: x.customFieldName
    });
    if (!S && x.fieldType === "custom" && typeof y == "object" && y !== null)
      return null;
    const E = S ?? q1(y, x.fieldType), b = ["richtext", "textarea"];
    return {
      label: x.label,
      content: E,
      verticalLayout: b.includes(x.fieldType ?? "")
    };
  }).filter((w) => {
    if (!w) return !1;
    const x = Array.isArray(w.content) ? w.content[0] : w.content;
    return !(x?.type === "item" && x.text === "—");
  }) : [], $ = P.slice(0, Dn), N = P.length > Dn;
  return /* @__PURE__ */ o(
    G1,
    {
      ...
      children: $.length > 0 && !C && /* @__PURE__ */ o("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ o(
        Wi,
        {
          details: $.map((w) => ({
            title: w.label,
...
X1.displayName = "FormCard";
function b9() {
  const t = B4(), e = t?.activeForm;
  if (!e) return null;
...
const Wn = 8, Et = 8;
function K1({ anchor: t, onReply: e }) {
  const r = pe(), n = j(null), [s, a] = z(
    null
  );
  if (mo(() => {
    if (!t) {
    ...
    let v = t.rect.top - d - Wn;
    v < Et && (v = t.rect.bottom + Wn), v = Math.min(
      Math.max(v, Et),
      h - d - Et
    );
...
const Q1 = Pt(void 0), Sf = () => yt(Q1), E9 = (t) => /* @__PURE__ */ o(Oo, { content: t, format: "markdown" }), _9 = ({
  isGenerating: t,
  isLoading: e,
  message: r,
  renderToolCall: n,
  ...
  const l = typeof r?.content == "string" ? r.content : "", c = (r && n?.(r)) ?? r?.generativeUI?.() ?? null, d = r?.toolCalls?.[0]?.id, u = !l && !c, h = j(null), { anchor: v, clear: p } = Y1({
    containerRef: h,
    enabled: !!(r?.id && l)
  });
  return ce(() => {
    r?.id && !e && !t && a?.(r);
  }, [r, e, t, a]), !e && !t && u ? null : /* @__PURE__ */ o(Q1.Provider, { value: d, children: /* @__PURE__ */ f("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    r && l && /* @__PURE__ */ o(
      "div",
      {
        ref: h,
  ...
  const [s, a] = z(""), i = pe(), { title: l, label: c, placeholder: d } = r === "like" ? i.ai.feedbackModal.positive : i.ai.feedbackModal.negative, u = Q(() => {
    e(n, s);
  }, [s, n, e]), h = () => {
    t(n);
  };
...
}, J1 = Pt(null), S9 = ({ children: t }) => {
  const [e, r] = z(null), n = e ? {
    isOpen: !0,
  ...
  return /* @__PURE__ */ o(J1.Provider, { value: n, children: t });
}, es = () => {
  const t = yt(J1);
  if (t === null)
    throw new Error(
...
const T9 = ({
  ...
  const n = pe(), { open: s } = es(), [a, i] = z(null);
  ...
  const [l, c] = z(s), d = ze(), u = n !== void 0, h = u ? n : l;
  return /* @__PURE__ */ f(
    Do,
    {
        ...
        /* @__PURE__ */ f(
          Zo,
          {
            ...
            children: [
              ...
              !i && /* @__PURE__ */ o(be, { icon: tr })
            ]
          }
        ),
        /* @__PURE__ */ o(Bo, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ o(
          Ce.div,
          {
            initial: !1,
            animate: {
  ...
  return /* @__PURE__ */ o(
    A9,
    {
      ...
      onOpenChange: i,
      lockOpen: r,
      children: /* @__PURE__ */ o("div", { className: "flex flex-col gap-3 pb-4", children: t.map((h, v) => /* @__PURE__ */ f("div", { className: "relative", children: [
        /* @__PURE__ */ o(
          Ar,
          {
            title: h,
...
const ts = (t) => /* @__PURE__ */ o(Oo, { content: t, format: "markdown" }), $9 = ({
  text: t,
  renderMarkdown: e
  ...
  /* @__PURE__ */ o("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (e ?? ts)(t) })
] }), I9 = ({
  message: t,
  onReplyQuote: e,
  ...
  const i = t.rawData, l = P9(
    t?.content,
    i
  ), c = (F9(t?.content) ?? "").trim(), d = t?.replyQuote ?? null, u = c.length > 0, { anchor: h, clear: v } = Y1({
    containerRef: a,
    enabled: u
  });
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        d && /* @__PURE__ */ o($9, { text: d, renderMarkdown: n }),
        ...
        /* @__PURE__ */ o(
          K1,
          {
            anchor: h,
            onReply: (p) => {
              e?.(p), v(), window.getSelection()?.removeAllRanges();
            }
          }
        )
      ]
...
}, H9 = 35, j9 = 22, O9 = 400, D9 = 2500, Z9 = 220, B9 = ({ messages: t, onClick: e }) => {
  const [r, n] = z(0), [s, a] = z(0), [i, l] = z("starting"), c = t[r] ?? "";
  ce(() => {
    t.length > 0 && r >= t.length && (n(0), a(0), l("starting"));
  }, [t.length, r]), ce(() => {
    let h;
    if (i === "starting")
      h = setTimeout(() => l("writing"), O9);
    else if (i === "writing")
      s < c.length ? h = setTimeout(() => a((v) => v + 1), H9) : l("holding");
    else if (i === "holding") {
      if (t.length <= 1) return;
      h = setTimeout(() => l("erasing"), D9);
    } else i === "erasing" && (s > 0 ? h = setTimeout(() => a((v) => v - 1), j9) : h = setTimeout(() => {
      n((v) => (v + 1) % t.length), l("starting");
    }, Z9));
    return () => {
      h && clearTimeout(h);
    };
...
function U9({
  ...
  const [i, l] = z(0), [c, d] = z(!1), u = j(s), h = j(a);
  h.current = a;
  const v = Q(
    (g = "smooth") => {
  ...
  ce(() => {
    const g = t.current, k = e.current;
    if (!g || !k) return;
    const C = new ResizeObserver(() => {
      if (h.current) return;
      const M = parseFloat(getComputedStyle(k).paddingTop) + parseFloat(getComputedStyle(k).paddingBottom) + 1;
      l(g.clientHeight - M);
    });
    return C.observe(g), C.observe(k), () => C.disconnect();
  }, [t, e]);
  const p = Q(() => {
    const g = t.current;
    if (!g) return;
    const { scrollTop: k, scrollHeight: C, clientHeight: M } = g, P = C - k - M;
    d(P > M);
  }, [t]);
  return ce(() => {
    const g = t.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const g = t.current, k = n.current;
        if (!g || !k) return;
        const C = g.getBoundingClientRect(), M = k.getBoundingClientRect(), P = g.scrollTop + (M.top - C.top);
        g.scrollTo({ top: P, behavior: "smooth" });
      });
    }), s === 0 && d(!1), u.current = s;
  }, [s, n, t]), { showScrollBtn: c, turnMinHeight: i, scrollToBottom: v };
}
const z9 = {
  threadId: "",
  onThumbsUp: () => {
...
}, Nf = (t) => /* @__PURE__ */ o(S9, { children: /* @__PURE__ */ o(W9, { ...t }) }), W9 = ({
  turns: t,
  isLoadingThread: e = !1,
  interrupt: r,
  initialMessage: n,
  ...
  const { modal: P, handleSubmit: $, handleClose: N } = N9(
    u ?? z9
  ), w = pe(), x = g ?? _9, y = k ?? I9, S = de(() => {
    const _ = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(_) ? _ : [_]).filter((O) => typeof O == "string" && O.length > 0);
  }, [n, w.ai.defaultInitialMessage]), E = !e && t.length === 0 && S.length > 0, b = j(null), L = j(null), R = j(null), B = j(null), X = j(null), { showScrollBtn: J, turnMinHeight: te, scrollToBottom: oe } = U9({
    viewportRef: b,
    contentRef: L,
    endRef: R,
    lastTurnRef: X,
    ...
    const O = q === t.length - 1, U = {
      ...
      const ie = O && re === _.assistantMessages.length - 1, ye = _.userMessages.length + re, T = {
        message: D,
        inProgress: _.isInProgress,
        index: ye,
        isCurrentMessage: ie,
      ...
      return /* @__PURE__ */ o(
        ...
        {
          ...T,
          isGenerating: _.isInProgress && ie,
          isLoading: _.isInProgress && ie && !D.content
        },
        `${q}-a-${re}`
      );
    };
    return /* @__PURE__ */ f(
      "div",
      {
        ...
        children: [
          ...
          _.thinking && _.thinking.titles.length > 0 && /* @__PURE__ */ o(
            V9,
            {
          ...
          _.endIndicator === "thinking" && /* @__PURE__ */ o(Ar, { title: w.ai.thinking, status: "executing" }),
          _.endIndicator === "activity" && /* @__PURE__ */ o(Ar, { status: "writing" }),
          _.feedback && /* @__PURE__ */ o(
            T9,
            {
  ...
  return /* @__PURE__ */ f(qe, { children: [
    /* @__PURE__ */ f("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
          ...
          children: /* @__PURE__ */ f(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ o("footer", { className: "copilotKitMessagesFooter", ref: R, children: p }),
                /* @__PURE__ */ o(Be, { children: J && /* @__PURE__ */ o(
                  Ce.div,
                  {
      ...
      !v && !E && /* @__PURE__ */ f(qe, { children: [
        /* @__PURE__ */ o(Gn, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ o(Gn, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    P.isOpen && /* @__PURE__ */ o(
      R9,
...
}, G9 = () => /* @__PURE__ */ o("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ f("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ o("div", { className: "flex justify-end", children: /* @__PURE__ */ o($e, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ o($e, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ o($e, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ o($e, { className: "h-5 w-4/5 rounded-md" })
] }) }), Tf = {
  ai: uc.ai
}, rs = Pt(null);
function Af({
  ...
  return /* @__PURE__ */ o(rs.Provider, { value: e, children: t });
}
function Vf() {
  const t = yt(rs);
  if (t === null)
...
const X9 = ({
  ...
  const v = pe().ai.clarifyingQuestion.typeYourAnswer, p = t === "single" ? /* @__PURE__ */ o(ns, { isSelected: r && !e }) : /* @__PURE__ */ o(
    Uo,
    {
      checked: s,
      onCheckedChange: () => d(!s),
...
const K9 = ({
  ...
  onToggleCustomActive: k,
  onConfirm: C
}) => {
  const M = (() => {
    if (t !== "single") return 0;
    const x = r.findIndex((y) => n.includes(y.id));
    return x >= 0 ? x : 0;
  })(), [P, $] = z(M), N = j([]);
  ce(() => {
  ...
  const w = (x) => {
    ...
    x.preventDefault(), $(S), N.current[S]?.focus();
  };
  return /* @__PURE__ */ f(
    "div",
    {
  ...
  } = s, y = j(null), S = P ?? "single", E = i > 1, b = a === 0, L = a === i - 1, R = E ? r.t("ai.clarifyingQuestion.stepOf", {
    current: String(a + 1),
    total: String(i)
  }) : void 0, B = M.length > 0, X = (w ?? "").trim().length > 0, J = B || x && X || $ === !0, te = e === !0 && L, oe = () => {
    te || c();
  }, ee = () => {
    te || d();
  }, _ = (D) => {
    const re = S === "single" && M.includes(D);
    l(D), S === "single" && !L && !re && Promise.resolve().then(c);
  }, q = L ? r.ai.clarifyingQuestion.submit : r.ai.clarifyingQuestion.next, O = $ === !0 && !B && !(x && X), U = () => {
  ...
  return /* @__PURE__ */ f("div", { className: "flex flex-col", onKeyDown: me, children: [
    /* @__PURE__ */ o("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ o(Be, { mode: "wait", initial: !1, children: /* @__PURE__ */ f(
      Ce.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ue, ease: ss },
        children: [
          /* @__PURE__ */ o(
            Q9,
            {
...
function qn(t, e, r, n) {
  const s = Math.max(1, Math.min(t, e)), a = Math.min(r, 20), l = Math.min(a + n, s), c = Math.min(l, Math.floor(t / 2)), d = Math.min(l, Math.floor(e / 2)), u = (U) => U / t * 2 - 1, h = (U) => U / e * 2 - 1, v = 0, p = t, g = 0, k = e, C = c, M = t - c, P = d, $ = e - d, N = u(v), w = u(p), x = h(g), y = h(k), S = u(C), E = u(M), b = h(P), L = h($), R = 0, B = 0, X = 1, J = 1, te = c / t, oe = 1 - c / t, ee = d / e, _ = 1 - d / e, q = new Float32Array([
    // Top strip
    N,
    x,
    w,
...
function e3(t, e, r) {
  const n = Xn(t, t.VERTEX_SHADER, e), s = Xn(t, t.FRAGMENT_SHADER, r), a = t.createProgram();
...
class $f {
  ...
  resize(e, r, n) {
    ...
    const { gl: s, program: a, vao: i, positionBuffer: l, uvBuffer: c, uResolution: d } = this.glr, u = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, h = Math.max(1, Math.floor(e * u)), v = Math.max(1, Math.floor(r * u));
    this.canvas.style.width = `${e}px`, this.canvas.style.height = `${r}px`, (this.canvas.width !== h || this.canvas.height !== v) && (this.canvas.width = h, this.canvas.height = v), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
    const { positions: p, uvs: g } = qn(
      this.canvas.width,
      this.canvas.height,
    ...
    const k = s.getAttribLocation(a, "aPosition");
    s.enableVertexAttribArray(k), s.vertexAttribPointer(k, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, c), s.bufferData(s.ARRAY_BUFFER, g, s.STATIC_DRAW);
    const C = s.getAttribLocation(a, "aUV");
    s.enableVertexAttribArray(C), s.vertexAttribPointer(C, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after UV buffer update"), s.useProgram(a), s.uniform2f(d, this.canvas.width, this.canvas.height), s.uniform1f(this.glr.uBorderWidth, this.options.borderWidth * u), s.uniform1f(this.glr.uGlowWidth, this.options.glowWidth * u), s.uniform1f(this.glr.uBorderRadius, this.options.borderRadius * u), this.checkGLError(s, "resize: after uniform updates");
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, a = this.canvas.height || 2, { positions: i, uvs: l } = qn(
      s,
      a,
    ...
    const v = e.getUniformLocation(r, "uResolution"), p = e.getUniformLocation(r, "uTime"), g = e.getUniformLocation(r, "uBorderWidth"), k = e.getUniformLocation(r, "uGlowWidth"), C = e.getUniformLocation(r, "uBorderRadius"), M = e.getUniformLocation(r, "uColors"), P = e.getUniformLocation(r, "uGlowExponent"), $ = e.getUniformLocation(r, "uGlowFactor");
    e.useProgram(r), e.uniform1f(g, this.options.borderWidth), e.uniform1f(k, this.options.glowWidth), e.uniform1f(C, this.options.borderRadius), this.options.mode === "dark" ? (e.uniform1f(P, 2), e.uniform1f($, 1.8)) : (e.uniform1f(P, 1), e.uniform1f($, 1));
    const N = (this.options.colors || n3).map(o3);
...
const Yn = ["lowp", "mediump", "highp"], s3 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, a3 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
    vec2 uv = fragCoord/iResolution.xy;
    vec3 col = 0.5 + 0.5*cos(iTime+uv.xyx+vec3(0,2,4));
    fragColor = vec4(col,1.0);
}`, Kn = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, Qn = "iTime", Jn = "iTimeDelta", eo = "iDate", to = "iFrame", ro = "iMouse", no = "iResolution", i3 = "iChannel", oo = "iChannelResolution", so = "iDeviceOrientation";
function c3(t, e) {
...
}, wr = 9729, ao = 9728, h3 = 9987, io = 33071, co = 10497;
class p3 {
  gl;
  url;
  wrapS;
  ...
  load = async (e) => {
    ...
    const h = 0, v = r.RGBA, p = 1, g = 1, k = 0, C = r.RGBA, M = r.UNSIGNED_BYTE, P = new Uint8Array([255, 255, 255, 0]), $ = r.createTexture();
    ...
    async function N() {
      return new Promise((y, S) => {
        ...
        E.crossOrigin = "anonymous", E.onload = () => {
          ...
          S(new Error(Ge(`failed loading url: ${n}`)));
        }, E.src = n ?? "";
      });
    }
    let w = await N(), x = (w.width & w.width - 1) === 0 && (w.height & w.height - 1) === 0;
    return (e.wrapS !== io || e.wrapT !== io || e.minFilter !== ao && e.minFilter !== wr) && !x && (w = this.makePowerOf2(w), x = !0), r.bindTexture(r.TEXTURE_2D, $), r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL, c), r.texImage2D(
      r.TEXTURE_2D,
      h,
      v,
      C,
      M,
      w
    ), x && e.minFilter !== ao && e.minFilter !== wr && r.generateMipmap(r.TEXTURE_2D), r.texParameteri(
      r.TEXTURE_2D,
      r.TEXTURE_WRAP_S,
      this.wrapS || co
    ), r.texParameteri(
...
const Ge = (t) => `react-shaders: ${t}`, lo = (t) => {
  if ("changedTouches" in t) {
    const e = t.changedTouches[0];
    return [e?.clientX ?? 0, e?.clientY ?? 0];
  }
  return [t.clientX, t.clientY];
}, uo = (t, e, r) => t * (1 - r) + e * r, m3 = (t, e, r) => r > 0 ? t.substring(0, r) + e + t.substring(r, t.length) : e + t;
function g3({
  fs: t,
  vs: e = Kn,
  textures: r = [],
  ...
  const p = j(null), g = j(null), k = j(null), C = j(null), M = j(void 0), P = j(void 0), $ = j(!1), N = j(void 0), w = j(0), x = j([0, 0]), y = j([]), S = j(0), E = j(void 0), b = j({
    [Qn]: { type: "float", isNeeded: !1, value: 0 },
    [Jn]: { type: "float", isNeeded: !1, value: 0 },
    [eo]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [ro]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [no]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    [to]: { type: "int", isNeeded: !1, value: 0 },
    [so]: {
      type: "vec4",
      isNeeded: !1,
      value: [0, 0, 0, 0]
    ...
    const I = "width" in T ? T.width ?? 0 : 0, K = "height" in T ? T.height ?? 0 : 0, W = b.current.iChannelResolution;
    if (!W) return;
    const se = Array.isArray(W.value) ? W.value : W.value = [];
    se[H * 3] = I * d, se[H * 3 + 1] = K * d, se[H * 3 + 2] = 0;
  }, B = () => {
    ...
    const T = g.current;
    k.current = T?.createBuffer() ?? null, T?.bindBuffer(T.ARRAY_BUFFER, k.current);
    const H = [
      1,
      1,
      0,
    ...
    T?.bufferData(T.ARRAY_BUFFER, new Float32Array(H), T.STATIC_DRAW);
  }, J = ({
    alpha: T,
    beta: H,
    gamma: I
    ...
    const [H = 0, I = 0] = lo(T), K = H - (N.current?.left ?? 0) - window.pageXOffset, W = (N.current?.height ?? 0) - I - (N.current?.top ?? 0) - window.pageYOffset;
    $.current = !0;
    const se = Array.isArray(b.current.iMouse?.value) ? b.current.iMouse.value : void 0;
    se && (se[2] = K, se[3] = W), x.current[0] = K, x.current[1] = W;
  }, oe = (T) => {
    N.current = p.current?.getBoundingClientRect();
    const [H = 0, I = 0] = lo(T), K = H - (N.current?.left ?? 0), W = (N.current?.height ?? 0) - I - (N.current?.top ?? 0);
    if (c !== 1)
      x.current[0] = K, x.current[1] = W;
    else {
      const se = Array.isArray(b.current.iMouse?.value) ? b.current.iMouse.value : void 0;
      se && (se[0] = K, se[1] = W);
    }
    ...
    if (!T) return;
    N.current = p.current?.getBoundingClientRect();
    const H = d, I = Math.floor(
      (N.current?.width ?? 1) * H
    ), K = Math.floor(
      (N.current?.height ?? 1) * H
    );
    if (T.canvas.width = I, T.canvas.height = K, b.current.iResolution?.isNeeded && C.current) {
      const W = T.getUniformLocation(
        C.current,
        no
      );
      T.uniform2fv(W, [T.canvas.width, T.canvas.height]);
    }
  }, q = (T, H) => {
    const I = g.current;
    if (!I) return null;
    const K = I.createShader(T);
    if (!K) return null;
    if (I.shaderSource(K, H), I.compileShader(K), !I.getShaderParameter(K, I.COMPILE_STATUS)) {
      v?.(Ge(`Error compiling the shader:
${H}`));
      const W = I.getShaderInfoLog(K);
      I.deleteShader(K), h?.(Ge(`Shader compiler log: ${W}`));
    }
    return K;
  }, O = (T, H) => {
    const I = g.current;
    if (!I) return;
    const K = q(I.FRAGMENT_SHADER, T), W = q(I.VERTEX_SHADER, H);
    if (C.current = I.createProgram(), !(!C.current || !W || !K)) {
      if (I.attachShader(C.current, W), I.attachShader(C.current, K), I.linkProgram(C.current), !I.getProgramParameter(C.current, I.LINK_STATUS)) {
        h?.(
          Ge(
      ...
      I.useProgram(C.current), M.current = I.getAttribLocation(
        C.current,
        "aVertexPosition"
      ), I.enableVertexAttribArray(M.current);
    }
  }, U = () => {
    if (n)
      for (const T of Object.keys(n)) {
        const H = n[T];
        if (!H) continue;
        const { value: I, type: K } = H, W = f3(K);
        if (!W) continue;
        const se = {};
        if (c3(K, I)) {
          const we = K.length, Le = Number.parseInt(K.charAt(we - 3)), Se = Math.floor(I.length / (Le * Le));
          I.length > Le * Le && (se.arraySize = `[${Se}]`);
        } else l3(K, I) && (se.arraySize = `[${Math.floor(I.length / Number.parseInt(K.charAt(0)))}]`);
        b.current[T] = {
          type: W,
          isNeeded: !1,
          value: I,
      ...
      if (r && r.length > 0) {
        ...
        const H = r.map(
          (I, K) => (b.current[`${i3}${K}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, R(I, K), y.current[K] = new p3(T), y.current[K]?.load(I).then((W) => {
            R(W, K);
          }))
        );
        Promise.all(H).then(() => {
    ...
    const H = Yn.includes(a ?? "highp"), I = `precision ${H ? a : Yn[1]} float;
`;
    H || v?.(
      Ge(
    ...
    let K = I.concat(`#define DPR ${d.toFixed(1)}
`).concat(T.replace(/texture\(/g, "texture2D("));
    for (const se of Object.keys(b.current))
      if (T.includes(se)) {
        const we = b.current[se];
        if (!we) continue;
        K = m3(
          K,
          `uniform ${we.type} ${se}${we.arraySize || ""}; 
`,
          K.lastIndexOf(I) + I.length
        ), we.isNeeded = !0;
      }
    return T.includes("mainImage") && (K = K.concat(s3)), K;
  }, D = (T) => {
    const H = g.current;
    if (!H || !C.current) return;
    const I = S.current ? (T - S.current) / 1e3 : 0;
    S.current = T;
    const K = L.current;
    if (K)
      for (const W of Object.keys(K)) {
        const se = K[W];
        if (se && b.current[W]?.isNeeded) {
          if (!C.current) return;
          const we = H.getUniformLocation(
            C.current,
            W
          );
          if (!we) return;
    ...
    if (b.current.iMouse?.isNeeded) {
      const W = H.getUniformLocation(
        C.current,
        ro
      );
      H.uniform4fv(W, b.current.iMouse.value);
    }
    ...
    if (b.current.iDate?.isNeeded) {
      const W = /* @__PURE__ */ new Date(), se = W.getMonth() + 1, we = W.getDate(), Le = W.getFullYear(), Se = W.getHours() * 60 * 60 + W.getMinutes() * 60 + W.getSeconds() + W.getMilliseconds() * 1e-3, Pe = H.getUniformLocation(
        C.current,
        eo
      );
      H.uniform4fv(Pe, [Le, se, we, Se]);
    }
    if (b.current.iFrame?.isNeeded) {
      ...
      H.uniform1i(W, se), b.current.iFrame.value = se + 1;
    }
    if (y.current.length > 0)
      for (let W = 0; W < y.current.length; W++) {
        const se = y.current[W];
        if (!se) return;
        const { isVideo: we, _webglTexture: Le, source: Se, flipY: Pe, isLoaded: xe } = se;
        if (!xe || !Le || !Se) return;
        if (b.current[`iChannel${W}`]?.isNeeded) {
          if (!C.current) return;
          const Qe = H.getUniformLocation(
            C.current,
            `iChannel${W}`
          );
          H.activeTexture(H.TEXTURE0 + W), H.bindTexture(H.TEXTURE_2D, Le), H.uniform1i(Qe, W), we && se.updateTexture(
            Le,
            Se,
            Pe
          );
    ...
    const H = g.current;
    if (!H) return;
    H.viewport(0, 0, H.drawingBufferWidth, H.drawingBufferHeight), H.clear(H.COLOR_BUFFER_BIT | H.DEPTH_BUFFER_BIT), H.bindBuffer(H.ARRAY_BUFFER, k.current), H.vertexAttribPointer(
      M.current ?? 0,
      3,
      H.FLOAT,
      !1,
      0,
      0
    ), D(T), H.drawArrays(H.TRIANGLE_STRIP, 0, 4);
    const I = b.current.iMouse?.value;
    if (b.current.iMouse?.isNeeded && c !== 1 && Array.isArray(I)) {
      const K = I[0] ?? 0, W = I[1] ?? 0;
      I[0] = uo(K, x.current[0] ?? 0, c), I[1] = uo(W, x.current[1] ?? 0, c);
    }
    ...
    b.current.iMouse?.isNeeded && p.current && (p.current.addEventListener("mousemove", oe, T), p.current.addEventListener("mouseout", ee, T), p.current.addEventListener("mouseup", ee, T), p.current.addEventListener("mousedown", te, T), p.current.addEventListener("touchmove", oe, T), p.current.addEventListener("touchend", ee, T), p.current.addEventListener("touchstart", te, T)), b.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      ...
      J,
      T
    ), p.current && (E.current = new ResizeObserver(_), E.current.observe(p.current), window.addEventListener("resize", _, T));
  }, ye = () => {
    const T = { passive: !0 };
    b.current.iMouse?.isNeeded && p.current && (p.current.removeEventListener("mousemove", oe, T), p.current.removeEventListener("mouseout", ee, T), p.current.removeEventListener("mouseup", ee, T), p.current.removeEventListener("mousedown", te, T), p.current.removeEventListener("touchmove", oe, T), p.current.removeEventListener("touchend", ee, T), p.current.removeEventListener("touchstart", te, T)), b.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      ...
      J,
      T
    ), E.current && (E.current.disconnect(), window.removeEventListener("resize", _, T));
  };
  return ce(() => {
    L.current = n;
  }, [n]), ce(() => {
    ...
    function H() {
      B();
      const I = g.current;
      I && p.current && (I.clearColor(...s), I.clearDepth(1), I.enable(I.DEPTH_TEST), I.depthFunc(I.LEQUAL), I.viewport(0, 0, p.current.width, p.current.height), p.current.height = p.current.clientHeight, p.current.width = p.current.clientWidth, U(), me(), O(ue(t || a3), e || Kn), X(), requestAnimationFrame(re), ie(), _());
    }
    return requestAnimationFrame(H), () => {
      const I = g.current;
      if (I) {
        if (I.getExtension("WEBGL_lose_context")?.loseContext(), I.useProgram(null), I.deleteProgram(C.current ?? null), T.length > 0)
          for (const K of T)
            I.deleteTexture(K._webglTexture);
        C.current = null;
      }
...
}`, C3 = 10, w3 = 2, x3 = 0.5, k3 = 0.2, y3 = 1.5, Ve = {
  duration: 0.5,
  ease: "easeOut"
}, fo = {
  duration: 0.35,
...
function b3(t, e) {
  const [r, n] = z(C3), {
    ...
    animate: a,
    motionValue: i
  } = Bt(k3), { value: l, animate: c } = Bt(w3), { value: d, animate: u } = Bt(x3), { value: h, animate: v } = Bt(y3), p = fc(e, {
    fftSize: 512,
  ...
  return ce(() => {
    switch (t) {
      ...
      case "failed":
      case "disconnected":
        n(10), a(0.2, Ve), c(1.2, Ve), u(0.4, Ve), v(1, Ve);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), a(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, Ve), u(0.7, Ve), v([1.5, 2], fo);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), a(0.3, Ve), c(0.5, Ve), u(1, Ve), v([0.5, 2.5], fo);
        return;
      case "speaking":
        n(70), a(0.3, Ve), c(0.75, Ve), u(1.25, Ve), v(1.5, Ve);
        return;
    }
  }, [
    t,
...
function is({
  ...
  const p = de(() => M3(i), [i]);
  return /* @__PURE__ */ o("div", { ref: u, className: h, ...v, children: /* @__PURE__ */ o(
    g3,
    {
      fs: v3,
...
function If({
  ...
  const { speed: d, scale: u, amplitude: h, frequency: v, brightness: p } = b3(e, s);
  return /* @__PURE__ */ o(
    is,
    {
      ref: l,
...
const Hf = ({
  ...
  const n = pe(), s = ze();
  return /* @__PURE__ */ f(qe, { children: [
    t && /* @__PURE__ */ o("span", { className: V(_3(), "truncate"), children: t }),
    /* @__PURE__ */ o(Be, { children: r && e && /* @__PURE__ */ o(
      Ce.div,
      {
  ...
  return /* @__PURE__ */ f("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ o("span", { className: V(cs()), children: e }),
    /* @__PURE__ */ f(
      Ce.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ f("div", { className: "flex items-center gap-1", children: [
            ...
            r && /* @__PURE__ */ o("span", { className: V(Ut()), children: r })
          ] }),
          n === "people" && /* @__PURE__ */ o(
            Yi,
            {
          ...
          n === "balance" && /* @__PURE__ */ o(N3, { balance: t.balance })
        ]
      }
    ),
    r && !S3.has(n) && /* @__PURE__ */ o(
      Ce.span,
      {
        className: V(Ut()),
        animate: { opacity: s ? 0 : 1 },
...
const V3 = ({
  ...
  dataLength: n,
  color: s
}) => r !== n - 1 || t == null || e == null ? null : /* @__PURE__ */ o("circle", { cx: t, cy: e, r: 2, fill: s, stroke: "none" }), F3 = ({
  label: t,
  direction: e
}) => {
  const r = ls[e];
  ...
  const s = `sparkline-gradient-${go().replace(/:/g, "")}`, a = A3(t, r), i = ls[a];
  return /* @__PURE__ */ o("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(ec, { width: "100%", height: "100%", children: /* @__PURE__ */ f(
          tc,
          {
            data: t,
            ...
            children: [
              ...
              /* @__PURE__ */ o(rc, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ o(
                nc,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ o(F3, { label: e, direction: a })
      ]
    }
  ) });
}, ds = m(
  (t, e) => {
    const {
      ...
      className: c,
      ...d
    } = t, [u, h] = z(!1), [v, p] = z(!1), g = u || v, k = ze(), C = g && !!l, M = {
      duration: k ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, P = () => {
      i?.();
        ...
        "div",
        {
          ...
          children: [
            ...
            d.content === "sparkline" ? /* @__PURE__ */ f("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ o("span", { className: V(cs()), children: n }),
              /* @__PURE__ */ o(
                Ce.div,
                {
...
ds.displayName = "F0AiInsightCardInternal";
const $3 = ["className"], us = m((t, e) => {
  const r = $3.reduce((n, s) => {
    const { [s]: a, ...i } = n;
    return i;
  }, t);
  return /* @__PURE__ */ o(ds, { ref: e, ...r });
});
us.displayName = "F0AiInsightCard";
const I3 = () => /* @__PURE__ */ f(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ o($e, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ f("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ f("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ o($e, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ o($e, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ f("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ o($e, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ o($e, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], fs = 180, H3 = (t) => Number.isFinite(t) ? Math.max(0, Math.floor(t)) : fs, j3 = (t, e) => t.length <= e ? t : `${t.slice(0, e).trimEnd()}...`, O3 = (t) => t.showActions !== !1, D3 = (t) => Object.fromEntries(
...
function Z3(t) {
  const {
    ...
    description: a,
    seeMoreLabel: i,
    maxCollapsedDescriptionLength: l = fs
  } = t, [c, d] = z(!1), u = go(), h = j(null), v = H3(
    l
  ), p = a.length > v, g = c ? a : j3(a, v), k = O3(t) ? t : null, C = D3(t);
  return ce(() => {
    c && h.current?.focus();
  }, [c]), /* @__PURE__ */ f(
    "section",
    {
      ...
      children: [
        ...
        k && /* @__PURE__ */ o("div", { className: "flex items-center justify-end gap-3 border-0 border-t border-solid border-f1-border-secondary px-4 py-3", children: /* @__PURE__ */ o(
          Ee,
          {
            type: "button",
            label: k.primaryActionLabel,
            icon: k.primaryActionIcon,
            onClick: k.onPrimaryAction
          }
        ) })
      ]
    }
...
Z3.displayName = "F0AiProposalCard";
const B3 = ({
  icon: t,
  title: e,
  children: r
  ...
  return /* @__PURE__ */ f(
    Do,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ f(Zo, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, U3 = (t) => tu[t] ?? _o, z3 = ({ iconName: t }) => t ? /* @__PURE__ */ o("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ o(be, { icon: U3(t), size: "md", color: "default" }) }) : null;
function W3({
  sources: t,
  title: e
}) {
  ...
  return /* @__PURE__ */ o(B3, { icon: $r, title: n, children: /* @__PURE__ */ o("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: t.map((s, a) => {
    const i = /* @__PURE__ */ o(z3, { iconName: s.icon });
...
W3.displayName = "F0AiMessageSources";
async function G3(t, e, r) {
  const n = await import("./xlsx-Bedf3nwD.js"), s = n.utils.table_to_book(t, { sheet: "Data" });
  n.writeFile(s, `${r}.${e}`);
}
function q3({
  ...
  const n = pe(), s = j(null), a = e ?? n.ai.aiTable.title, i = Q(
    (l) => {
      if (!s.current) return;
              ...
              /* @__PURE__ */ o("tbody", { children: t.rows.map((l, c) => /* @__PURE__ */ o("tr", { children: t.columns.map((d) => {
                ...
                return /* @__PURE__ */ o(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ o(_e, { children: u == null ? "" : String(u) })
                  },
                  d
                );
              }) }, c)) })
...
q3.displayName = "F0AiTableCard";
function X3({ credits: t }) {
  const e = pe(), [r, n] = z(!1), [s, a] = z(!1), [i, l] = z(!1), [c, d] = z(null), u = Q(
    (p) => {
  ...
  if (!t) return null;
  const h = c ? Math.min(100, Math.round(c.used / c.total * 100)) : 0, v = t.companyName;
  return /* @__PURE__ */ f(Hr, { open: r, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ f(
      Or,
      {
        ...
        children: [
          v && /* @__PURE__ */ f("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            /* @__PURE__ */ o(
              Zr,
              {
                name: t.companyName ?? "",
            ...
            /* @__PURE__ */ f("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ o(_e, { tag: "span", className: "font-medium", children: t.companyName ?? "" }),
...
const Y3 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function K3({
  employeeCredits: t
}) {
  const e = pe(), r = ze(), [n, s] = z(!1), [a, i] = z(!1), [l, c] = z(!1), [d, u] = z(null), h = Q(
    (k) => {
      s(k), k && t?.fetchUsage && (i(!0), c(!1), t.fetchUsage().then((C) => {
        u(C), c(!1);
      }).catch(() => {
        c(!0);
      }).finally(() => {
  ...
  if (!t) return null;
  const v = !!t.companyName, p = d && d.total > 0 ? Math.min(100, Math.round(d.used / d.total * 100)) : 0, g = d ? Math.max(0, d.total - d.used) : 0;
...
const ho = ({
  credits: t,
  employeeCredits: e
}) => e ? /* @__PURE__ */ o(K3, { employeeCredits: e }) : t ? /* @__PURE__ */ o(X3, { credits: t }) : null, Df = ({
  historyEnabled: t = !1,
  title: e,
  ...
  const v = pe(), p = Po(`(max-width: ${sc.md}px)`, {
    ...
    Me,
    {
      variant: "ghost",
      hideLabel: !0,
      label: n ? v.ai.collapseChat : v.ai.expandChat,
      icon: n ? So : Ro,
      onClick: a
    }
  ), k = /* @__PURE__ */ o(
        ...
        /* @__PURE__ */ o("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ o(
          Tt,
          {
            ...
            children: /* @__PURE__ */ f("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ o(_e, { lines: 1, className: "min-w-0 text-left", children: r ?? v.ai.newConversation }),
...
function Q3() {
  if (!(typeof navigator > "u"))
    return cc(navigator.language);
}
function J3(t) {
  const e = new Date(t), r = /* @__PURE__ */ new Date();
  return zo(e) ? "today" : Wo(e) ? "yesterday" : ac(e, r) ? "thisMonth" : "older";
}
function ef(t, e) {
  const r = new Date(t), n = Q3(), s = rn(r, "p", { locale: n });
  if (zo(r)) return `${e.today}, ${s}`;
  if (Wo(r)) return `${e.yesterday}, ${s}`;
  const a = !ic(r, /* @__PURE__ */ new Date());
  return `${rn(r, a ? "MMM d yyyy" : "MMM d", {
    locale: n
  })}, ${s}`;
}
function tf(t) {
      ...
      children: [
        /* @__PURE__ */ f(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ o(_e, { lines: 1, className: "text-left font-medium", children: t.title }),
                  ...
                  /* @__PURE__ */ o(
                    Tt,
                    {
                      ...
                      children: /* @__PURE__ */ f("div", { className: "flex w-full items-center gap-2", children: [
                        ...
                        /* @__PURE__ */ o(_e, { lines: 1, className: "text-left", children: u.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ o(nf, {}),
...
function Bf({
  ...
  const [n, s] = z([]), [a, i] = z(!1), [l, c] = z(null), [d, u] = z(of), h = Q(async () => {
    i(!0), c(null);
    try {
      const k = await e();
      s(k);
    } catch (k) {
      const C = k instanceof Error ? k.message : "Failed to fetch chat history";
      c(C), s([]);
    } finally {
      i(!1);
    }
  ...
  const v = Q((k) => {
    u((C) => {
      const M = new Set(C);
      return M.add(k), xr(M), M;
    });
  }, []), p = Q((k) => {
    u((C) => {
      const M = new Set(C);
      return M.delete(k), xr(M), M;
    });
  }, []), g = Q(
    async (k) => {
      try {
        await r(k), s((C) => C.filter((M) => M.id !== k)), u((C) => {
          if (!C.has(k)) return C;
          const M = new Set(C);
          return M.delete(k), xr(M), M;
        });

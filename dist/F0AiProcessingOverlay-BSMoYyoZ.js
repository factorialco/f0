...
import { useInsertionEffect as Fr, forwardRef as h, useRef as I, useEffect as q, useLayoutEffect as et, useState as $, useMemo as Q, useCallback as z, createContext as z1, useContext as B1, useId as tt, createElement as Nr, memo as Vr } from "react";
import { cn as Sr, co as Hr, _ as rt, cp as Tr, cq as Ar, cr as $r, cs as Br, ct as Ir, cu as ot, cv as Pr, cw as jr, a5 as se, cx as Dr, aJ as Zr, cy as _r, cz as Or, cA as Ur, ag as zr, cB as Gr, bR as Wr, a9 as nt, ac as qr, cC as Xr, b9 as ie, J as st, K as G1, cD as it, be as Yr, cE as Kr, cF as Qr, b2 as Jr, bQ as eo, a0 as F1, au as to, bi as at, cG as ro, bO as oo, cH as M1, bK as no, cI as so, cJ as io, b1 as ct, cK as ao, cL as co, cM as lo, cN as fo, cO as uo, cP as lt, bC as ho, bD as Co, cQ as go, cR as po, cS as mo, cT as vo, cU as wo, cV as xo, cW as ko, cX as Lo, cY as bo, cZ as yo, c_ as Mo, c$ as Eo, d0 as Ro, d1 as Fo, bP as No, aa as Vo, by as So, d2 as Ho, d3 as To, d4 as Ao, d5 as $o, d6 as Bo, d7 as Io, d8 as Po, ap as jo, d9 as dt, O as Do, a1 as Zo, da as ft, db as ut, dc as _o, bh as Oo, bg as Uo, dd as zo, de as Go, df as ht, dg as Wo, b0 as qo, ay as Xo, dh as Yo, as as Ko, b7 as Qo, di as Ct, b6 as Jo, dj as en, bj as ae, dk as tn, dl as rn, dm as ce, bM as on, bL as nn, bN as gt, dn as sn, G as an, E as cn, dp as ln, dq as dn, dr as fn, ds as un, dt as hn, du as pt, dv as Cn, ab as gn, dw as pn, L as u1, o as x, q as S1, bs as mn, u as G, dx as vn, V as p1, ck as mt, H as a1, v as h1, a2 as wn, U as g1, dy as xn, ad as c1, aP as x1, A as E1, p as J, bW as vt, aD as le, dz as kn, aE as de, aF as fe, b as b1, dA as Ln, dB as bn, bG as yn, W as Mn, a$ as En, a4 as ue, dC as Rn, dD as Fn, dE as Nn, dF as ye, a3 as Vn, ak as wt, aS as xt, dG as Sn, c2 as Hn, dH as Tn, dI as An, aX as kt, dJ as $n, bY as Bn, dK as In, aU as $1, b8 as Lt, dL as bt, ba as yt, c as oe, dM as Mt, dN as Pn, dO as jn, bn as Dn, dP as Zn, bd as he, bz as _n, dQ as On, dR as Un, dS as zn, dT as Gn, dU as Wn, a7 as qn, ae as Xn, y as Yn, z as Kn, dV as Et, dW as Rt, dX as Qn, aj as Me, dY as Jn, ai as es, dZ as ts, d_ as rs, d as os } from "./F0CanvasPanel-CoyEHW5U.js";
...
const $2 = S1({
  ...
  ({
    ...
    const N1 = B && B !== "none" || o1 && o1 !== "none" || W && W !== "none" || i1 && i1 !== "none", P1 = X && X !== "none" || N1, j1 = { sm: W1, md: q1, lg: X1, xl: I1 }, Q1 = B2.map((D1) => {
      const Z1 = j1[D1];
      return Z1 ? A2(D1, Z1) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
...
const O2 = ({
  ...
  const s = x1(), [i, l] = $(""), [d, c] = $(0), [u, f] = $(!1), g = I(null), p = I(null), C = I(null), m = e[d] ?? r;
  return q(() => {
    const v = () => {
...
const Y2 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ a(
    le,
    {
      ...
      children: [
        /* @__PURE__ */ t(kn, { asChild: !0, children: /* @__PURE__ */ t("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, c) => /* @__PURE__ */ t(de, { asChild: !0, children: /* @__PURE__ */ t(
          u1,
          {
            variant: "outline",
            label: d.label,
        ...
        l && /* @__PURE__ */ a(
          fe,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: X2(l.items).map((d, c) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
const ec = 4e3;
function tc(e) {
  const [r, o] = $([]), [n, s] = $(null), i = I(
    null
  ), l = I(null), d = G(), c = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, g = Q(() => {
    if (u)
  ...
  const v = z(
    async (T) => {
      ...
      try {
        ...
        o(
          (j) => j.map((E) => {
            const F = M.findIndex((A) => A.id === E.id);
            return F === -1 ? E : H[F] ? {
              ...E,
              status: "uploaded",
              uploadedFile: H[F]
        ...
        const j = H instanceof Error && H.message ? H.message : d.ai.fileUploadError;
        N(j);
      }
    },
    [
...
function ic({
  ...
  const [i, l] = $(!1), [d, c] = $(""), [u, f] = $([]), [g, p] = $(!1), [C, m] = $(0), [v, w] = $([]), b = I(-1), D = I(null), T = I(0), V = I(-1);
  q(() => {
    if (!n) {
      l(!1);
      return;
    ...
    if (F.atIndex === V.current)
      return;
    b.current = F.atIndex, c(F.query), l(!0), m(0), p(!0), D.current && clearTimeout(D.current);
    const A = ++T.current;
    return D.current = setTimeout(() => {
      n(F.query).then((O) => {
        A === T.current && (f(O), m(0), O.length === 0 && F.query.length > 0 && (V.current = F.atIndex, l(!1)));
      }).catch(() => {
        A === T.current && f([]);
      }).finally(() => {
        A === T.current && p(!1);
  ...
  const M = z(() => {
    ...
    (F) => {
      const A = b.current;
      if (A === -1) return;
      const O = `${F.firstName} ${F.lastName}`.trim(), _ = String(F.id), U = e.slice(0, A), t1 = e.slice(o), r1 = `@${O} `, Y = U + r1 + t1, X = U.length + r1.length;
      r(Y), w((B) => [...B.filter((W) => !(W.id === _ && W.name === O)), { id: _, name: O }]), M(), requestAnimationFrame(() => {
        const B = s.current;
        B && (B.focus(), B.setSelectionRange(X, X));
      });
    },
    [e, o, r, s, M]
  ), N = z(
    ...
    (F) => {
      ...
      let A = F;
      const O = [...v].sort((_, U) => U.name.length - _.name.length);
      for (const _ of O) {
        const U = `@${_.name}`, t1 = `<entity-ref type="person" id="${Ee(_.id)}">${Ee(_.name)}</entity-ref>`;
        for (; A.includes(U); )
          A = A.replace(U, t1);
      }
      return A;
  ...
  q(() => {
    w(
      (F) => F.filter((A) => {
        const O = `@${A.name}`, _ = e.indexOf(O);
        if (_ === -1) return !1;
        const U = e[_ + O.length];
        return U === " " || U === `
` || U === "	";
      })
    );
  ...
  const j = Q(() => {
    ...
    const F = s.current;
    if (!F) return null;
    const A = nc(F, b.current), O = F.offsetLeft + A.left, U = (F.offsetParent ? F.offsetParent.offsetHeight : 0) - (F.offsetTop + A.top);
    return { left: O, bottom: U };
  }, [i, e, o, s]), E = Q(() => {
...
const ac = /[\\`*_{}[\]()#+\-.!|~>]/g, cc = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(ac, "\\$&")).join(""), P6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const N = G(), H = x1(), [j, E] = $(""), [F, A] = $(0), [O, _] = $(!1), [U, t1] = $(!1), [r1, Y] = $(null), X = I(null), B = I(null), o1 = I(null), W = l != null, { tracking: i1 } = b1(), k1 = z(
    (K, w1) => {
    ...
    const w1 = y1.current, J1 = w1 && !/\s$/.test(w1) ? " " : "", _1 = `${w1}${J1}${K}`;
    E(_1), A(_1.length);
  }, []), T1 = {
    ...
    onPartial: V1,
    onFinal: (K) => {
      V1(K), B.current?.focus();
    },
    onError: (K) => f1(T1[K])
  }), W1 = !!p && v1.isSupported, q1 = z(() => {
    i1?.onDictationStart?.(), y1.current = j, v1.start();
  }, [j, v1, i1]), X1 = z(() => {
    i1?.onDictationCancel?.(), v1.cancel();
  }, [v1, i1]);
  q(() => {
  ...
  const I1 = v1.status === "recording", Y1 = I1 ? N.ai.listening : N.ai.inputPlaceholder, K1 = l1.filter((K) => K.status === "uploaded"), N1 = l1.some((K) => K.status === "uploading"), P1 = l1.some((K) => K.status === "error"), j1 = j.trim().length > 0;
  q(() => {
    if (!(!U || N1)) {
      if (t1(!1), P1) {
  ...
  const Q1 = async (K) => {
    if (K.preventDefault(), !W) {
      if (e1.close(), o)
        ...
        const w1 = e1.transformMentions(j.trim()), J1 = cc(w1), _1 = K1.flatMap(
    ...
    A(B.current?.selectionStart ?? 0);
  }, Lr = () => {
    o1.current && B.current && (o1.current.scrollTop = B.current.scrollTop);
  }, me = r1 ? r1.prompt ?? r1.title : null, ve = I1 ? [N.ai.listening] : me ? [me] : s ?? [], br = ve.length > 1, yr = Q(() => K2(j, e1.mentions, {
    cursorPosition: F,
    inlineCompletion: e1.inlineCompletion
  }), [j, e1.mentions, F, e1.inlineCompletion]), Mr = e1.mentions.length > 0 || e1.inlineCompletion !== null, we = b && !!T && T.length > 0 && !!V ? /* @__PURE__ */ t(
    Y2,
    {
      suggestions: T,
      onItemClick: k1,
  ...
  ) : null, Er = b && D && !!M && M.length > 0, xe = D && b, { motionProps: Rr } = bn(
    b,
    160,
    0.5
  );
  return /* @__PURE__ */ a(
    J.div,
    {
      ...
      children: [
        ...
        Er && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(W2, { cards: M }) }),
        w && b && D && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: w }),
...
function H1({
  ...
  const i = I(/* @__PURE__ */ new Map()), [l, d] = $(
...
function Fc({
  ...
  const { entityRefs: o } = b1(), n = o?.resolvers?.candidate, s = G(), i = o?.urls?.candidate?.(e), l = Q(
    () => (c) => {
      const u = [];
...
function Nc({ id: e, label: r }) {
  const { entityRefs: o } = b1(), n = o?.resolvers?.expense, s = G(), i = o?.urls?.expense?.(e), l = Q(
    () => (c) => ({
      avatar: {
        type: "icon",
        icon: Vt
...
function Vc({
  ...
  const { entityRefs: o } = b1(), n = o?.resolvers?.jobPosting, s = G(), i = o?.urls?.jobPosting?.(e), l = Q(
    () => (c) => ({
      title: c.title,
...
function Hc({
  ...
  const { entityRefs: o } = b1(), n = o?.resolvers?.requisition, s = G(), i = o?.urls?.requisition?.(e), l = Q(
    () => (c) => {
...
function Tc({ id: e, label: r }) {
  const { entityRefs: o } = b1(), n = o?.resolvers?.person, s = G(), i = o?.urls?.person?.(e), l = Q(
    () => (c) => ({
      avatar: {
        type: "person",
        firstName: c.firstName,
...
function Ac({ id: e, label: r }) {
  const { entityRefs: o } = b1(), n = o?.resolvers?.vacancy, s = G(), i = o?.urls?.vacancy?.(e), l = Q(
    () => (c) => ({
      title: c.name,
...
const Re = 7, jc = 625, Fe = /* @__PURE__ */ new Set();
function Dc(e) {
...
function _c(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = Tn(e), i = [];
...
function nr(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: _c(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? Dc(o) : "") || "—" };
  }
  ...
  return { type: "item", text: Zc(String(e)) };
}
function sr({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = b1(), g = Pc(e), p = d ?? g, C = I(() => {
  ...
  C.current = b, q(() => {
    typeof window > "u" || window.innerWidth < jc || Fe.has(e) || (Fe.add(e), C.current());
  }, [e]);
  const D = i && l ? Object.entries(i).map(([M, R]) => {
    const N = l[M], H = p?.(M, N, {
    ...
    if (!H && R.fieldType === "custom" && typeof N == "object" && N !== null)
      return null;
    const j = H ?? nr(N, R.fieldType), E = ["richtext", "textarea"];
    return {
      label: R.label,
      content: j,
...
const cr = z1(void 0), _6 = () => B1(cr), Gc = (e) => /* @__PURE__ */ t(kt, { content: e, format: "markdown" }), Wc = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, g = I(null), { anchor: p, clear: C } = ir({
    containerRef: g,
    enabled: !!(o?.id && d)
  });
  return q(() => {
  ...
  const [s, i] = $(""), l = G(), { title: d, label: c, placeholder: u } = o === "like" ? l.ai.feedbackModal.positive : l.ai.feedbackModal.negative, f = z(() => {
    r(n, s);
  }, [s, n, r]), g = () => {
    e(n);
  };
...
const Kc = ({
  ...
  const [d, c] = $(s), u = x1(), f = n !== void 0, g = f ? n : d;
  return /* @__PURE__ */ a(
    Lt,
    {
...
const fr = (e) => /* @__PURE__ */ t(kt, { content: e, format: "markdown" }), r4 = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = t4(
    e?.content,
    l
  ), c = (e4(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: g, clear: p } = ir({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(r4, { text: u, renderMarkdown: n }),
...
}, n4 = 35, s4 = 22, i4 = 400, a4 = 2500, c4 = 220, l4 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  ...
  q(() => {
    ...
    let p;
    if (d === "starting")
      p = setTimeout(() => c("writing"), i4);
    else if (d === "writing")
      i < u.length ? p = setTimeout(() => l((C) => C + 1), n4) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), a4);
    } else d === "erasing" && (i > 0 ? p = setTimeout(() => l((C) => C - 1), s4) : p = setTimeout(() => {
...
function d4({
  ...
  const C = z(() => {
    const m = e.current;
    if (!m) return;
    const { scrollTop: v, scrollHeight: w, clientHeight: b } = m, D = w - v - b;
    u(D > b);
  }, [e]);
  return q(() => {
    const m = e.current;
    ...
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!m || !v) return;
        const w = m.getBoundingClientRect(), b = v.getBoundingClientRect(), D = m.scrollTop + (b.top - w.top);
        m.scrollTo({ top: D, behavior: "smooth" });
      });
    }), s === 0 && u(!1), f.current = s;
...
const f4 = {
...
}, O6 = (e) => /* @__PURE__ */ t(Xc, { children: /* @__PURE__ */ t(u4, { ...e }) }), u4 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: T, handleSubmit: V, handleClose: M } = Yc(
    f ?? f4
  ), R = G(), N = v ?? Wc, H = w ?? o4, j = Q(() => {
    const B = n ?? R.ai.defaultInitialMessage;
    return (Array.isArray(B) ? B : [B]).filter((W) => typeof W == "string" && W.length > 0);
  }, [n, R.ai.defaultInitialMessage]), E = !r && e.length === 0 && j.length > 0, F = I(null), A = I(null), O = I(null), _ = I(null), U = I(null), { showScrollBtn: t1, turnMinHeight: r1, scrollToBottom: Y } = d4({
    viewportRef: F,
    contentRef: A,
    endRef: O,
    lastTurnRef: U,
    ...
    const W = o1 === e.length - 1, i1 = {
      ...
      const m1 = W && d1 === B.assistantMessages.length - 1, k = B.userMessages.length + d1, y = {
        message: n1,
        inProgress: B.isInProgress,
        index: k,
        isCurrentMessage: m1,
      ...
      return /* @__PURE__ */ t(
        ...
        {
          ...y,
          isGenerating: B.isInProgress && m1,
          isLoading: B.isInProgress && m1 && !n1.content
        },
        `${o1}-a-${d1}`
      );
    };
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        children: [
          ...
          B.thinking && B.thinking.titles.length > 0 && /* @__PURE__ */ t(
            Jc,
            {
          ...
          B.endIndicator === "thinking" && /* @__PURE__ */ t(oe, { title: R.ai.thinking, status: "executing" }),
          B.endIndicator === "activity" && /* @__PURE__ */ t(oe, { status: "writing" }),
          B.feedback && /* @__PURE__ */ t(
            Kc,
            {
...
}, h4 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
...
const m4 = ({
  ...
  const R = (N) => {
    ...
    N.preventDefault(), V(j), M.current[j]?.focus();
  };
  return /* @__PURE__ */ a(
    "div",
    {
  ...
  } = s, N = I(null), H = D ?? "single", j = l > 1, E = i === 0, F = i === l - 1, A = j ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(l)
  }) : void 0, O = b.length > 0, _ = (M ?? "").trim().length > 0, U = O || R && _ || T === !0, t1 = r === !0 && F, r1 = () => {
    t1 || c();
  }, Y = () => {
    t1 || u();
  }, X = (l1) => {
    const n1 = H === "single" && b.includes(l1);
    d(l1), H === "single" && !F && !n1 && Promise.resolve().then(c);
  }, B = F ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, o1 = T === !0 && !O && !(R && _), W = () => {
  ...
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: i1, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(E1, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      J.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: k1, ease: w4 },
        children: [
          /* @__PURE__ */ t(
            v4,
            {
...
function Ae(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (W) => W / e * 2 - 1, g = (W) => W / r * 2 - 1, p = 0, C = e, m = 0, v = r, w = c, b = e - c, D = u, T = r - u, V = f(p), M = f(C), R = g(m), N = g(v), H = f(w), j = f(b), E = g(D), F = g(T), A = 0, O = 0, _ = 1, U = 1, t1 = c / e, r1 = 1 - c / e, Y = u / r, X = 1 - u / r, B = new Float32Array([
    // Top strip
    V,
    R,
    M,
...
class X6 {
  ...
  setupGL() {
    ...
    const p = r.getUniformLocation(o, "uResolution"), C = r.getUniformLocation(o, "uTime"), m = r.getUniformLocation(o, "uBorderWidth"), v = r.getUniformLocation(o, "uGlowWidth"), w = r.getUniformLocation(o, "uBorderRadius"), b = r.getUniformLocation(o, "uColors"), D = r.getUniformLocation(o, "uGlowExponent"), T = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(m, this.options.borderWidth), r.uniform1f(v, this.options.glowWidth), r.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(D, 2), r.uniform1f(T, 1.8)) : (r.uniform1f(D, 1), r.uniform1f(T, 1));
    const V = (this.options.colors || M4).map(E4);
...
const Be = ["lowp", "mediump", "highp"], R4 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, F4 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, Pe = "iTime", je = "iTimeDelta", De = "iDate", Ze = "iFrame", _e = "iMouse", Oe = "iResolution", N4 = "iChannel", Ue = "iChannelResolution", ze = "iDeviceOrientation";
function V4(e, r) {
...
}, te = 9729, Ge = 9728, $4 = 9987, We = 33071, qe = 10497;
class B4 {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    const g = 0, p = o.RGBA, C = 1, m = 1, v = 0, w = o.RGBA, b = o.UNSIGNED_BYTE, D = new Uint8Array([255, 255, 255, 0]), T = o.createTexture();
    ...
    return (r.wrapS !== We || r.wrapT !== We || r.minFilter !== Ge && r.minFilter !== te) && !R && (M = this.makePowerOf2(M), R = !0), o.bindTexture(o.TEXTURE_2D, T), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, c), o.texImage2D(
      o.TEXTURE_2D,
      g,
      p,
      w,
      b,
      M
    ), R && r.minFilter !== Ge && r.minFilter !== te && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || qe
    ), o.texParameteri(
...
}, Ye = (e, r, o) => e * (1 - o) + r * o, I4 = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function P4({
  fs: e,
  vs: r = Ie,
  textures: o = [],
  ...
  const C = I(null), m = I(null), v = I(null), w = I(null), b = I(void 0), D = I(void 0), T = I(!1), V = I(void 0), M = I(0), R = I([0, 0]), N = I([]), H = I(0), j = I(void 0), E = I({
...
${y}`));
    ...
    const L = m.current;
    if (!L) return;
    const P = B(L.FRAGMENT_SHADER, k), S = B(L.VERTEX_SHADER, y);
      ...
      if (o && o.length > 0) {
        ...
        const y = o.map(
          (L, P) => (E.current[`${N4}${P}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, A(L, P), N.current[P] = new B4(k), N.current[P]?.load(L).then((S) => {
            A(S, P);
          }))
        );
        Promise.all(y).then(() => {
...
`,
    ...
    return k.includes("mainImage") && (P = P.concat(R4)), P;
  }, l1 = (k) => {
    const y = m.current;
    ...
    if (N.current.length > 0)
      for (let S = 0; S < N.current.length; S++) {
        ...
        if (E.current[`iChannel${S}`]?.isNeeded) {
          ...
          y.activeTexture(y.TEXTURE0 + S), y.bindTexture(y.TEXTURE_2D, f1), y.uniform1i(T1, S), s1 && Z.updateTexture(
            f1,
            e1,
            y1
          );
    ...
    if (E.current.iMouse?.isNeeded && c !== 1 && Array.isArray(L)) {
      const P = L[0] ?? 0, S = L[1] ?? 0;
      L[0] = Ye(P, R.current[0] ?? 0, c), L[1] = Ye(S, R.current[1] ?? 0, c);
    }
    D.current = requestAnimationFrame(n1);
  }, d1 = () => {
    const k = { passive: !0 };
    E.current.iMouse?.isNeeded && C.current && (C.current.addEventListener("mousemove", r1, k), C.current.addEventListener("mouseout", Y, k), C.current.addEventListener("mouseup", Y, k), C.current.addEventListener("mousedown", t1, k), C.current.addEventListener("touchmove", r1, k), C.current.addEventListener("touchend", Y, k), C.current.addEventListener("touchstart", t1, k)), E.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      ...
      U,
      k
    ), C.current && (j.current = new ResizeObserver(X), j.current.observe(C.current), window.addEventListener("resize", X, k));
  }, m1 = () => {
    const k = { passive: !0 };
    E.current.iMouse?.isNeeded && C.current && (C.current.removeEventListener("mousemove", r1, k), C.current.removeEventListener("mouseout", Y, k), C.current.removeEventListener("mouseup", Y, k), C.current.removeEventListener("mousedown", t1, k), C.current.removeEventListener("touchmove", r1, k), C.current.removeEventListener("touchend", Y, k), C.current.removeEventListener("touchstart", t1, k)), E.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      ...
      U,
      k
    ), j.current && (j.current.disconnect(), window.removeEventListener("resize", X, k));
  };
  return q(() => {
    F.current = n;
  }, [n]), q(() => {
    ...
    function y() {
      O();
      const L = m.current;
      L && C.current && (L.clearColor(...s), L.clearDepth(1), L.enable(L.DEPTH_TEST), L.depthFunc(L.LEQUAL), L.viewport(0, 0, C.current.width, C.current.height), C.current.height = C.current.clientHeight, C.current.width = C.current.clientWidth, W(), i1(), o1(k1(e || F4), r || Ie), _(), requestAnimationFrame(n1), d1(), X());
    }
    return requestAnimationFrame(y), () => {
      ...
      m1(), cancelAnimationFrame(D.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
}`, D4 = 10, Z4 = 2, _4 = 0.5, O4 = 0.2, U4 = 1.5, C1 = {
  duration: 0.5,
  ease: "easeOut"
}, Ke = {
  duration: 0.35,
...
function z4(e, r) {
  const [o, n] = $(D4), {
    ...
    animate: i,
    motionValue: l
  } = O1(O4), { value: d, animate: c } = O1(Z4), { value: u, animate: f } = O1(_4), { value: g, animate: p } = O1(U4), C = ss(r, {
    fftSize: 512,
  ...
  return q(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, C1), c(1.2, C1), f(0.4, C1), p(1, C1);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, C1), f(0.7, C1), p([1.5, 2], Ke);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, C1), c(0.5, C1), f(1, C1), p([0.5, 2.5], Ke);
        return;
      case "speaking":
        n(70), i(0.3, C1), c(0.75, C1), f(1.25, C1), p(1.5, C1);
        return;
    }
  }, [
    e,
...
const K6 = ({
  ...
  const n = G(), s = x1();
  return /* @__PURE__ */ a(R1, { children: [
    e && /* @__PURE__ */ t("span", { className: x(X4(), "truncate"), children: e }),
...
const t6 = ({
  ...
  const s = `sparkline-gradient-${tt().replace(/:/g, "")}`, i = e6(e, o), l = mr[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(Un, { width: "100%", height: "100%", children: /* @__PURE__ */ a(
          zn,
          {
            data: e,
  ...
  (e, r) => {
    const {
      ...
      className: c,
      ...u
    } = e, [f, g] = $(!1), [p, C] = $(!1), m = f || p, v = x1(), w = m && !!d, b = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, D = () => {
      l?.();
...
const s6 = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], xr = 180, i6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : xr, a6 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, c6 = (e) => e.showActions !== !1, l6 = (e) => Object.fromEntries(
...
function d6(e) {
  ...
  } = e, [c, u] = $(!1), f = tt(), g = I(null), p = i6(
    d
  ), C = i.length > p, m = c ? i : a6(i, p), v = c6(e) ? e : null, w = l6(e);
  return q(() => {
    c && g.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
...
}, u6 = (e) => g2[e] ?? lt, h6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(a1, { icon: u6(e), size: "md", color: "default" }) }) : null;
function C6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(f6, { icon: ae, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
function p6({
  ...
  const n = G(), s = I(null), i = r ?? n.ai.aiTable.title, l = z(
    (d) => {
      if (!s.current) return;
...
p6.displayName = "F0AiTableCard";
function m6({ credits: e }) {
  const r = G(), [o, n] = $(!1), [s, i] = $(!1), [l, d] = $(!1), [c, u] = $(null), f = z(
    (C) => {
...
function w6({
  ...
  const r = G(), o = x1(), [n, s] = $(!1), [i, l] = $(!1), [d, c] = $(!1), [u, f] = $(null), g = z(
    (v) => {
...
const Qe = ({
  credits: e,
  employeeCredits: r
}) => r ? /* @__PURE__ */ t(w6, { employeeCredits: r }) : e ? /* @__PURE__ */ t(m6, { credits: e }) : null, el = ({
  historyEnabled: e = !1,
  title: r,
...
function L6(e, r) {
  const o = new Date(e), n = x6(), s = Me(o, "p", { locale: n });
...
function rl({
  ...
  const [n, s] = $([]), [i, l] = $(!1), [d, c] = $(null), [u, f] = $(E6), g = z(async () => {
    l(!0), c(null);
    try {
      const v = await r();
      s(v);
...
const R6 = J.create(os), F6 = ({
  ...
  const { t: i } = G(), l = x1(), d = o ?? i("ai.applyingChanges");
  return q(() => {
    if (!r) return;

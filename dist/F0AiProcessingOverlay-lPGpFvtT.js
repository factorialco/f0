...
import { useInsertionEffect as wr, forwardRef as C, useRef as $, useEffect as W, useLayoutEffect as X1, useState as B, useId as je, useMemo as X, useCallback as Z, createContext as Ze, useContext as Te, createElement as kr, memo as Lr } from "react";
import { ao as xr, d7 as br, a5 as Y1, c4 as yr, d8 as Mr, d9 as Er, da as Rr, db as Fr, c5 as Nr, cd as K1, c3 as Vr, dc as Sr, ae as Xe, dd as Tr, aX as Hr, de as Ar, df as $r, dg as Br, aw as Ir, dh as Pr, cE as Dr, ag as Q1, aj as jr, di as Zr, o as Ye, a9 as J1, a0 as _e, n as et, bs as _r, cb as Ur, dj as Or, be as zr, cD as Gr, a7 as Fe, aJ as Wr, bw as tt, dk as qr, cB as Xr, l as Me, cz as Yr, dl as Kr, bZ as rt, bd as Qr, dm as Jr, dn as eo, dp as to, dq as ro, dr as oo, ds as ot, cs as no, ct as so, dt as ao, du as io, dv as co, dw as lo, dx as fo, bG as uo, c7 as ho, dy as Co, am as go, dz as po, dA as vo, dB as mo, dC as wo, dD as ko, dE as Lo, bF as xo, cC as bo, ah as yo, co as Mo, dF as Eo, dG as Ro, dH as Fo, dI as No, dJ as Vo, dK as So, dL as To, aF as Ho, bH as Ao, b$ as nt, Z as $o, a8 as Bo, bI as st, bY as Io, b_ as at, i as Po, bv as Do, bu as jo, at as Zo, dM as _o, dN as Uo, bJ as it, bK as Oo, bL as zo, bc as Go, aM as Wo, dO as qo, j as Xo, bq as ct, bp as lt, bk as Yo, dP as dt, bj as Ko, c6 as Ke, q as Qo, bn as Qe, dQ as Jo, dR as en, dS as Je, c9 as tn, ca as rn, cA as ft, dT as on, U as nn, Q as sn, dU as an, dV as cn, an as ln, dW as dn, dX as fn, bW as un, dY as ut, dZ as hn, ai as Cn, d_ as gn, Y as se, u as z, bV as pn, S as de, bU as ht, V as ie, aa as vn, m as pe, d$ as mn, ak as ae, au as me, O as Ee, H as Q, cJ as Ct, aR as e1, e0 as wn, aT as t1, b as ye, bS as kn, e1 as Ln, bT as xn, a1 as bn, bb as yn, ad as r1, bM as Mn, bN as En, bO as Rn, bP as v1, ab as Fn, aA as gt, b2 as pt, c8 as Nn, cP as Vn, e2 as Sn, e3 as Tn, b7 as vt, e4 as Hn, cL as An, e5 as $n, b4 as Se, bl as mt, e6 as wt, bm as kt, c as Ge, cc as m1, e7 as Lt, e8 as Bn, e9 as In, J as He, bA as Pn, ea as Dn, br as o1, cp as jn, eb as Zn, ec as _n, ed as Un, ee as On, ef as zn, w as Gn, s as Wn, ap as Oe, aS as xt, M as qn, N as Xn, az as w1, eg as bt, eh as yt, ei as Yn, ej as Kn, ay as Qn, af as Jn, ek as es, el as ts, d as rs } from "./F0CanvasPanel-BXpM2H2J.js";
import { f as fe, d as L } from "./tooltip-BH6Se8A4.js";
import { createPortal as Mt } from "react-dom";
import { defaultTranslations as os } from "./i18n-provider-defaults.js";
import { useTrackVolume as ns } from "@livekit/components-react";
import { F as ss } from "./Printer-B7iDPx2r.js";
function as(e, r, o) {
  wr(() => e.on(r, o), [e, r, o]);
}
const is = (e, r) => /* @__PURE__ */ i(
  "svg",
  {
...
const l0 = (e, r) => /* @__PURE__ */ i(
...
), Q0 = C(K0), J0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: cs,
  Add: xr,
  Ai: ds,
  ...
  Wifi: Q0,
  Windows: gn
}, Symbol.toStringTag, { value: "Module" })), ec = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const s6 = ["xs", "sm", "md", "lg"], a6 = [
  ...
  const m = z();
  return p === "recording" ? /* @__PURE__ */ i("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    /* @__PURE__ */ t(
      pn,
      {
        stream: g ?? null,
      ...
      e && /* @__PURE__ */ i(Re, { children: [
        /* @__PURE__ */ t(
          se,
          {
            ...
            onClick: (M) => {
              M.preventDefault(), a.current?.click();
            }
          }
        ),
        /* @__PURE__ */ t(
...
function sc({
  ...
  const n = /* @__PURE__ */ i("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ t(ie, { icon: Y1, size: "md", color: "critical" }),
...
function cc({
  ...
  W(() => {
    ...
    if (!f || !p) return;
    const g = f.offsetLeft + f.offsetWidth - p.clientWidth;
    g > 0 && (f.style.left = `${Math.max(0, f.offsetLeft - g)}px`);
  }, [s]);
  ...
  return !e || u ? null : /* @__PURE__ */ t(
    "div",
    {
      ...
      children: c ? Array.from({ length: 3 }, (f, p) => /* @__PURE__ */ i(
        "div",
        {
        ...
        const g = p === n, h = `${f.firstName} ${f.lastName}`.trim();
        return /* @__PURE__ */ i(
          "div",
          {
            ref: g ? d : void 0,
...
const lc = ({
  ...
  return /* @__PURE__ */ t("div", { className: "p-1", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ t(ie, { icon: Ke, size: "md", color: "default" }) }),
        /* @__PURE__ */ t(
          ae,
          {
  ...
  const s = me(), [a, l] = B(""), [d, c] = B(0), [u, f] = B(!1), p = $(null), g = $(null), h = $(null), v = e[d] ?? r;
  return W(() => {
    const k = () => {
      g.current && (clearInterval(g.current), g.current = null), h.current && (clearInterval(h.current), h.current = null), p.current && (clearTimeout(p.current), p.current = null);
    };
    if (o.length > 0 || n) {
      f(!1), l(""), k();
      return;
    ...
    if (s)
      return f(!1), l(v), k(), p.current = setTimeout(() => {
    ...
    return g.current = setInterval(() => {
      m < v.length ? (l(v.slice(0, m + 1)), m++) : (g.current && (clearInterval(g.current), g.current = null), p.current = setTimeout(() => {
        h.current = setInterval(() => {
          m > 0 ? (m--, l(v.slice(0, m))) : (h.current && (clearInterval(h.current), h.current = null), p.current = setTimeout(() => {
            const E = (d + 1) % Math.max(e.length, 1);
            c(E);
          }, V));
        }, A);
...
`) ? o + "_" : o
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, uc).map((r) => /* @__PURE__ */ t(
  Ct,
  {
...
const pc = ({
  ...
  const [s, a] = B(null), l = $(null), d = $(null), c = $(!1), u = je(), f = je(), p = s !== null ? e[s] : null;
  return e.length === 0 ? null : /* @__PURE__ */ i(
    e1,
    {
      ...
      children: [
        /* @__PURE__ */ t(wn, { asChild: !0, children: /* @__PURE__ */ t("div", { ref: l, className: "flex w-full flex-wrap items-center gap-2", children: e.map((g, h) => /* @__PURE__ */ t(
          se,
          {
            variant: "outline",
            label: g.label,
            ...
            onClick: (v) => {
              d.current = v.currentTarget, c.current = !1, a((k) => k === h ? null : h), o?.(null);
            }
          },
          `${g.label}-${h}`
        )) }) }),
        p && /* @__PURE__ */ i(
          t1,
          {
            ...
            onCloseAutoFocus: (g) => {
              g.preventDefault(), c.current && d.current?.focus(), c.current = !1;
            },
            onEscapeKeyDown: () => {
              c.current = !0;
            },
            onPointerDownOutside: (g) => {
              const h = g.target;
              h && l.current?.contains(h) ? g.preventDefault() : c.current = !1;
            },
            className: L(
            ...
            children: [
              /* @__PURE__ */ i(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ t(ie, { "aria-hidden": !0, icon: p.icon, size: "sm" }),
                    /* @__PURE__ */ t("span", { children: p.label })
                  ]
                }
              ),
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: gc(p.items).map((g, h) => /* @__PURE__ */ i(
                "button",
                {
                  type: "button",
                  onClick: (v) => {
                    r(g, p), c.current = document.activeElement === v.currentTarget, a(null), o?.(null);
                  },
                  onMouseEnter: () => o?.(g),
                  onMouseLeave: () => o?.(null),
                  onFocus: () => o?.(g),
                  ...
                  children: [
                    /* @__PURE__ */ t("span", { className: "min-w-0 flex-1 truncate", children: g.title }),
                    /* @__PURE__ */ t(
                      "span",
                      {
                        "aria-hidden": !0,
                        ...
                        children: /* @__PURE__ */ t(ie, { icon: Xe, size: "sm" })
                      }
                    )
                  ]
                },
...
function vc(e, r, o) {
  ...
  for (const f of r) {
    ...
    let g = 0;
    for (; ; ) {
      const h = e.indexOf(p, g);
      if (h === -1) break;
      a.push({ start: h, end: h + p.length }), g = h + p.length;
    }
  }
  a.sort((f, p) => f.start - p.start);
  const l = [];
  let d = 0, c = !1;
  const u = (f) => {
    if (!s || c || n < d || n > f) {
...
function wc(e, r) {
  ...
  return o.length === 0 ? e : e.filter(
    (n) => o.some((s) => mc(n.type, s))
  );
}
const kc = 4e3;
function Lc(e) {
  const [r, o] = B([]), [n, s] = B(null), a = $(
    null
  ), l = $(null), d = z(), c = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, p = X(() => {
    if (u)
      return Array.isArray(u) ? u.join(",") : u;
  }, [u]), g = f !== void 0 && r.length >= f, h = $(0);
  W(() => {
    h.current = r.length;
  }, [r]);
  const v = Z((T) => {
  ...
  const k = Z(
    async (T) => {
      ...
      const N = (x) => o(
        (I) => I.map(
          (R) => w.includes(R.id) ? { ...R, status: "error", errorMessage: x } : R
        )
      );
      try {
        const x = await c(V);
        if (!Array.isArray(x) || x.length !== V.length) {
          N(d.ai.fileUploadError);
          return;
        }
        o(
          (I) => I.map((R) => {
            const S = E.findIndex((P) => P.id === R.id);
            return S === -1 ? R : x[S] ? {
              ...R,
              status: "uploaded",
              uploadedFile: x[S]
        ...
        const I = x instanceof Error && x.message ? x.message : d.ai.fileUploadError;
        N(I);
      }
    },
    [
    ...
    async (T) => {
      await k(Array.from(T.target.files ?? [])), T.target.value = "";
    },
    [k]
  ), M = Z((T) => {
...
function Ec({
  ...
  const [a, l] = B(!1), [d, c] = B(""), [u, f] = B([]), [p, g] = B(!1), [h, v] = B(0), [k, m] = B([]), M = $(-1), A = $(null), T = $(0), V = $(-1);
  W(() => {
    if (!n) {
      l(!1);
      return;
    ...
    const S = xc(e, o, k);
    if (!S) {
      l(!1), c(""), f([]), v(0), M.current = -1, V.current = -1;
      return;
    }
    if (S.atIndex === V.current)
      return;
    M.current = S.atIndex, c(S.query), l(!0), v(0), g(!0), A.current && clearTimeout(A.current);
    const P = ++T.current;
    return A.current = setTimeout(() => {
      n(S.query).then((O) => {
        P === T.current && (f(O), v(0), O.length === 0 && S.query.length > 0 && (V.current = S.atIndex, l(!1)));
      }).catch(() => {
        P === T.current && f([]);
      }).finally(() => {
        P === T.current && g(!1);
  ...
  const E = Z(() => {
    l(!1), c(""), f([]), v(0), M.current = -1;
  }, []), w = Z(
    (S) => {
      const P = M.current;
      if (P === -1) return;
      const O = `${S.firstName} ${S.lastName}`.trim(), U = String(S.id), G = e.slice(0, P), te = e.slice(o), oe = `@${O} `, Y = G + oe + te, J = G.length + oe.length;
      r(Y), m((j) => [...j.filter((ee) => !(ee.id === U && ee.name === O)), { id: U, name: O }]), E(), requestAnimationFrame(() => {
        const j = s.current;
    ...
    (S) => {
      ...
      switch (S.key) {
        case "ArrowDown":
          return S.preventDefault(), v((P) => (P + 1) % u.length), !0;
        case "ArrowUp":
          return S.preventDefault(), v(
            (P) => (P + u.length - 1) % u.length
          ), !0;
        case "Tab": {
          const P = u[h];
          if (P) {
...
` || G === "	";
  ...
  const I = X(() => {
    ...
    const S = s.current;
    if (!S) return null;
    const P = yc(S, M.current), O = S.offsetLeft + P.left, G = (S.offsetParent ? S.offsetParent.offsetHeight : 0) - (S.offsetTop + P.top);
...
const Rc = /[\\`*_{}[\]()#+\-.!|~>]/g, Fc = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(Rc, "\\$&")).join(""), i6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const x = z(), I = me(), [R, S] = B(""), [P, O] = B(0), [U, G] = B(!1), [te, oe] = B(!1), [Y, J] = B(null), j = $(null), K = $(null), ee = $(null), ue = l != null, { tracking: ge } = ye(), ve = Z(
    (q, ke) => {
    ...
    const ke = Ae.current, Ue = ke && !/\s$/.test(ke) ? " " : "", Ie = `${ke}${Ue}${q}`;
    S(Ie), O(Ie.length);
  }, []), sr = {
    ...
    onError: (q) => we(sr[q])
  }), ar = !!h && xe.isSupported, ir = Z(() => {
    ge?.onDictationStart?.(), Ae.current = R, xe.start();
  }, [R, xe, ge]), cr = Z(() => {
  ...
  const a1 = xe.status === "recording", lr = a1 ? x.ai.listening : x.ai.inputPlaceholder, i1 = re.filter((q) => q.status === "uploaded"), Be = re.some((q) => q.status === "uploading"), c1 = re.some((q) => q.status === "error"), l1 = R.trim().length > 0 || i1.length > 0;
  W(() => {
    if (!(!te || Be)) {
      if (oe(!1), c1) {
        we(x.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const dr = async (q) => {
    if (q.preventDefault(), !ue) {
      if (ne.close(), o)
        ...
        const ke = ne.transformMentions(R.trim()), Ue = Fc(ke), Ie = i1.flatMap(
  ...
  }, d1 = Y ? Y.prompt ?? Y.title : null, f1 = a1 ? [x.ai.listening] : d1 ? [d1] : s ?? [], Cr = f1.length > 1, gr = X(() => vc(R, ne.mentions, {
    cursorPosition: P,
    inlineCompletion: ne.inlineCompletion
  }), [R, ne.mentions, P, ne.inlineCompletion]), pr = ne.mentions.length > 0 || ne.inlineCompletion !== null, u1 = A && !!V && V.length > 0 && !!E ? /* @__PURE__ */ t(
    pc,
    {
      suggestions: V,
      onItemClick: ve,
  ...
  ) : null, vr = A && T && !!w && w.length > 0, h1 = T && A, { motionProps: mr } = Ln(
    A,
    160,
    0.5
  );
    ...
    Q.div,
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(ic, { creditWarning: a, children: /* @__PURE__ */ i(
            Q.form,
            {
              "aria-busy": o,
              ref: j,
                        ...
                        Q.div,
                        {
                          ...
                          children: /* @__PURE__ */ i(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ t("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ t(xn, { type: "critical", size: "sm" }) }),
        ...
        vr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(hc, { cards: w }) }),
        ...
        /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: ue ? /* @__PURE__ */ i(
          ...
          Q.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ t(ae, { className: "text-sm font-medium text-f1-foreground-tertiary", children: m.text }),
...
function Ne({
  ...
  const a = $(/* @__PURE__ */ new Map()), [l, d] = B(
...
function We(e) {
  return typeof e == "string" ? e : typeof e == "number" ? String(e) : Array.isArray(e) ? e.map(We).join("") : e && typeof e == "object" && "props" in e ? We(e.props.children) : "";
}
function o2({
  type: e,
  id: r,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ t(pt, { module: e.module, size: "md" }),
...
const L1 = 7, s2 = 625, x1 = /* @__PURE__ */ new Set();
function a2(e) {
...
function c2(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = Sn(e), a = [];
...
function _t({
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = ye(), p = n2(e), g = d ?? p, h = $(() => {
  }), v = n ?? e, k = s ?? r ?? "", m = c?.type === "form" && c.formName === e, M = () => u({
    type: "form",
    title: v,
    description: k,
    formName: e,
  ...
  h.current = M, W(() => {
    typeof window > "u" || window.innerWidth < s2 || x1.has(e) || (x1.add(e), h.current());
  }, [e]);
  const A = a && l ? Object.entries(a).map(([E, w]) => {
    ...
    if (!x && w.fieldType === "custom" && typeof N == "object" && N !== null)
      return null;
    const I = x ?? Zt(N, w.fieldType), R = ["richtext", "textarea"];
    return {
      label: w.label,
      content: I,
...
function Ot({ anchor: e, onReply: r }) {
  ...
  if (X1(() => {
    ...
    let g = e.rect.top - u - E1;
    g < Ve && (g = e.rect.bottom + E1), g = Math.min(
      Math.max(g, Ve),
      p - u - Ve
    );
...
const zt = Ze(void 0), f6 = () => Te(zt), u2 = (e) => /* @__PURE__ */ t(vt, { content: e, format: "markdown" }), h2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, p = $(null), { anchor: g, clear: h } = Ut({
    containerRef: p,
    enabled: !!(o?.id && d)
  });
  return W(() => {
  ...
  const [s, a] = B(""), l = z(), { title: d, label: c, placeholder: u } = o === "like" ? l.ai.feedbackModal.positive : l.ai.feedbackModal.negative, f = Z(() => {
    r(n, s);
  }, [s, n, r]), p = () => {
    e(n);
  };
...
const v2 = ({
  ...
  const n = z(), { open: s } = Wt(), [a, l] = B(null);
  ...
  const [d, c] = B(s), u = me(), f = n !== void 0, p = f ? n : d;
  return /* @__PURE__ */ i(
    mt,
    {
        ...
        /* @__PURE__ */ i(
          wt,
          {
            ...
            children: [
              ...
              !l && /* @__PURE__ */ t(ie, { icon: _e })
            ]
          }
        ),
        /* @__PURE__ */ t(kt, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ t(
          Q.div,
          {
            initial: !1,
            animate: {
  ...
  return /* @__PURE__ */ t(
    m2,
    {
      ...
      onOpenChange: l,
      lockOpen: o,
      children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pb-4", children: e.map((p, g) => /* @__PURE__ */ i("div", { className: "relative", children: [
        /* @__PURE__ */ t(
          Ge,
          {
            title: p,
...
const qt = (e) => /* @__PURE__ */ t(vt, { content: e, format: "markdown" }), x2 = ({
  text: e,
  renderMarkdown: r
}) => /* @__PURE__ */ i("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ t("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ t(ie, { icon: Ke }) }),
  ...
  const l = e.rawData, d = L2(
    e?.content,
    l
  ), c = (k2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: p, clear: g } = Ut({
    containerRef: a,
    enabled: f
  });
  return /* @__PURE__ */ i(
...
}, y2 = 35, M2 = 22, E2 = 400, R2 = 2500, F2 = 220, N2 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  const [n, s] = B(0), [a, l] = B(0), [d, c] = B("starting"), u = e[n] ?? "";
  W(() => {
    e.length > 0 && n >= e.length && (s(0), l(0), c("starting"));
  }, [e.length, n]), W(() => {
    let g;
    if (d === "starting")
      g = setTimeout(() => c("writing"), E2);
    else if (d === "writing")
      a < u.length ? g = setTimeout(() => l((h) => h + 1), y2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      g = setTimeout(() => c("erasing"), R2);
    } else d === "erasing" && (a > 0 ? g = setTimeout(() => l((h) => h - 1), M2) : g = setTimeout(() => {
...
function V2({
  ...
  const h = Z(() => {
    const v = e.current;
    if (!v) return;
    const { scrollTop: k, scrollHeight: m, clientHeight: M } = v, A = m - k - M;
    u(A > M);
  }, [e]);
  return W(() => {
    const v = e.current;
    ...
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!v || !k) return;
        const m = v.getBoundingClientRect(), M = k.getBoundingClientRect(), A = v.scrollTop + (M.top - m.top);
        v.scrollTo({ top: A, behavior: "smooth" });
      });
    }), s === 0 && u(!1), f.current = s;
  }, [s, n, e]), { showScrollBtn: c, turnMinHeight: l, scrollToBottom: g };
}
const S2 = {
  threadId: "",
  onThumbsUp: () => {
...
}, u6 = (e) => /* @__PURE__ */ t(g2, { children: /* @__PURE__ */ t(T2, { ...e }) }), T2 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: T, handleSubmit: V, handleClose: E } = p2(
    f ?? S2
  ), w = z(), N = k ?? h2, x = m ?? b2, I = X(() => {
    const j = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((ee) => typeof ee == "string" && ee.length > 0);
  }, [n, w.ai.defaultInitialMessage]), R = !r && e.length === 0 && I.length > 0, S = $(null), P = $(null), O = $(null), U = $(null), G = $(null), { showScrollBtn: te, turnMinHeight: oe, scrollToBottom: Y } = V2({
    viewportRef: S,
    contentRef: P,
    endRef: O,
    lastTurnRef: G,
    ...
    const ee = K === e.length - 1, ue = {
      ...
      const Le = ee && le === j.assistantMessages.length - 1, b = j.userMessages.length + le, F = {
        message: re,
        inProgress: j.isInProgress,
        index: b,
        isCurrentMessage: Le,
    ...
    return /* @__PURE__ */ i(
      "div",
      {
        ...
        children: [
          ...
          j.endIndicator === "thinking" && /* @__PURE__ */ t(Ge, { title: w.ai.thinking, status: "executing" }),
          j.endIndicator === "activity" && /* @__PURE__ */ t(Ge, { status: "writing" }),
...
const $2 = ({
  ...
  const g = z().ai.clarifyingQuestion.typeYourAnswer, h = e === "single" ? /* @__PURE__ */ t(Yt, { isSelected: o && !r }) : /* @__PURE__ */ t(
    Lt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const I2 = ({
  ...
  const w = (N) => {
    ...
    N.preventDefault(), V(I), E.current[I]?.focus();
  };
  return /* @__PURE__ */ i(
    "div",
    {
  ...
  } = s, N = $(null), x = A ?? "single", I = l > 1, R = a === 0, S = a === l - 1, P = I ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(a + 1),
    total: String(l)
  }) : void 0, O = M.length > 0, U = (E ?? "").trim().length > 0, G = O || w && U || T === !0, te = r === !0 && S, oe = () => {
    te || c();
  }, Y = () => {
    te || u();
  }, J = (ve) => {
    const re = x === "single" && M.includes(ve);
    d(ve), x === "single" && !S && !re && Promise.resolve().then(c);
  }, j = S ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, K = T === !0 && !O && !(w && U), ee = () => {
  ...
  return /* @__PURE__ */ i("div", { className: "flex flex-col", onKeyDown: ue, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ i(
      Q.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ge, ease: D2 },
        children: [
          /* @__PURE__ */ t(
            P2,
            {
...
function R1(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), a = Math.min(o, 20), d = Math.min(a + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (ee) => ee / e * 2 - 1, p = (ee) => ee / r * 2 - 1, g = 0, h = e, v = 0, k = r, m = c, M = e - c, A = u, T = r - u, V = f(g), E = f(h), w = p(v), N = p(k), x = f(m), I = f(M), R = p(A), S = p(T), P = 0, O = 0, U = 1, G = 1, te = c / e, oe = 1 - c / e, Y = u / r, J = 1 - u / r, j = new Float32Array([
    // Top strip
    V,
    w,
    E,
...
class m6 {
  ...
  resize(r, o, n) {
    ...
    const { gl: s, program: a, vao: l, positionBuffer: d, uvBuffer: c, uResolution: u } = this.glr, f = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, p = Math.max(1, Math.floor(r * f)), g = Math.max(1, Math.floor(o * f));
    this.canvas.style.width = `${r}px`, this.canvas.style.height = `${o}px`, (this.canvas.width !== p || this.canvas.height !== g) && (this.canvas.width = p, this.canvas.height = g), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
  ...
  setupGL() {
    ...
    const g = r.getUniformLocation(o, "uResolution"), h = r.getUniformLocation(o, "uTime"), v = r.getUniformLocation(o, "uBorderWidth"), k = r.getUniformLocation(o, "uGlowWidth"), m = r.getUniformLocation(o, "uBorderRadius"), M = r.getUniformLocation(o, "uColors"), A = r.getUniformLocation(o, "uGlowExponent"), T = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(v, this.options.borderWidth), r.uniform1f(k, this.options.glowWidth), r.uniform1f(m, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(A, 2), r.uniform1f(T, 1.8)) : (r.uniform1f(A, 1), r.uniform1f(T, 1));
    const V = (this.options.colors || z2).map(G2);
...
const N1 = ["lowp", "mediump", "highp"], W2 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, q2 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, S1 = "iTime", T1 = "iTimeDelta", H1 = "iDate", A1 = "iFrame", $1 = "iMouse", B1 = "iResolution", X2 = "iChannel", I1 = "iChannelResolution", P1 = "iDeviceOrientation";
function Y2(e, r) {
...
}, ze = 9729, D1 = 9728, tl = 9987, j1 = 33071, Z1 = 10497;
class rl {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    const p = 0, g = o.RGBA, h = 1, v = 1, k = 0, m = o.RGBA, M = o.UNSIGNED_BYTE, A = new Uint8Array([255, 255, 255, 0]), T = o.createTexture();
    ...
    return (r.wrapS !== j1 || r.wrapT !== j1 || r.minFilter !== D1 && r.minFilter !== ze) && !w && (E = this.makePowerOf2(E), w = !0), o.bindTexture(o.TEXTURE_2D, T), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, c), o.texImage2D(
      o.TEXTURE_2D,
      p,
      g,
      m,
      M,
      E
    ), w && r.minFilter !== D1 && r.minFilter !== ze && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || Z1
    ), o.texParameteri(
...
}, U1 = (e, r, o) => e * (1 - o) + r * o, ol = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function nl({
  fs: e,
  vs: r = V1,
  textures: o = [],
  ...
  const h = $(null), v = $(null), k = $(null), m = $(null), M = $(void 0), A = $(void 0), T = $(!1), V = $(void 0), E = $(0), w = $([0, 0]), N = $([]), x = $(0), I = $(void 0), R = $({
    ...
    const y = "width" in b ? b.width ?? 0 : 0, D = "height" in b ? b.height ?? 0 : 0, H = R.current.iChannelResolution;
    if (!H) return;
    const _ = Array.isArray(H.value) ? H.value : H.value = [];
    _[F * 3] = y * u, _[F * 3 + 1] = D * u, _[F * 3 + 2] = 0;
  }, O = () => {
    ...
    const [F = 0, y = 0] = _1(b), D = F - (V.current?.left ?? 0) - window.pageXOffset, H = (V.current?.height ?? 0) - y - (V.current?.top ?? 0) - window.pageYOffset;
    T.current = !0;
    ...
    const [F = 0, y = 0] = _1(b), D = F - (V.current?.left ?? 0), H = (V.current?.height ?? 0) - y - (V.current?.top ?? 0);
    if (c !== 1)
    ...
    if (b.canvas.width = y, b.canvas.height = D, R.current.iResolution?.isNeeded && m.current) {
    ...
    if (!D) return null;
    if (y.shaderSource(D, F), y.compileShader(D), !y.getShaderParameter(D, y.COMPILE_STATUS)) {
      g?.(be(`Error compiling the shader:
${F}`));
      const H = y.getShaderInfoLog(D);
      y.deleteShader(D), p?.(be(`Shader compiler log: ${H}`));
    }
    return D;
  }, K = (b, F) => {
    const y = v.current;
    if (!y) return;
    const D = j(y.FRAGMENT_SHADER, b), H = j(y.VERTEX_SHADER, F);
    if (m.current = y.createProgram(), !(!m.current || !H || !D)) {
      if (y.attachShader(m.current, H), y.attachShader(m.current, D), y.linkProgram(m.current), !y.getProgramParameter(m.current, y.LINK_STATUS)) {
        p?.(
          be(
      ...
      y.useProgram(m.current), M.current = y.getAttribLocation(
        m.current,
        "aVertexPosition"
    ...
    if (n)
      for (const b of Object.keys(n)) {
        const F = n[b];
        if (!F) continue;
        const { value: y, type: D } = F, H = el(D);
        if (!H) continue;
        const _ = {};
        if (Y2(D, y)) {
          const ce = D.length, he = Number.parseInt(D.charAt(ce - 3)), we = Math.floor(y.length / (he * he));
          y.length > he * he && (_.arraySize = `[${we}]`);
        } else K2(D, y) && (_.arraySize = `[${Math.floor(y.length / Number.parseInt(D.charAt(0)))}]`);
        R.current[b] = {
          type: H,
          isNeeded: !1,
          value: y,
      ...
      if (o && o.length > 0) {
        ...
        const F = o.map(
          (y, D) => (R.current[`${X2}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, P(y, D), N.current[D] = new rl(b), N.current[D]?.load(y).then((H) => {
            P(H, D);
          }))
        );
        Promise.all(F).then(() => {
    ...
    const F = N1.includes(a ?? "highp"), y = `precision ${F ? a : N1[1]} float;
`;
    F || g?.(
      be(
...
`,
    ...
    return b.includes("mainImage") && (D = D.concat(W2)), D;
  }, ve = (b) => {
    const F = v.current;
    ...
    if (R.current.iDate?.isNeeded) {
      const H = /* @__PURE__ */ new Date(), _ = H.getMonth() + 1, ce = H.getDate(), he = H.getFullYear(), we = H.getHours() * 60 * 60 + H.getMinutes() * 60 + H.getSeconds() + H.getMilliseconds() * 1e-3, ne = F.getUniformLocation(
        m.current,
        H1
      );
      F.uniform4fv(ne, [he, _, ce, we]);
    }
    ...
    if (N.current.length > 0)
      for (let H = 0; H < N.current.length; H++) {
        const _ = N.current[H];
        if (!_) return;
        const { isVideo: ce, _webglTexture: he, source: we, flipY: ne, isLoaded: Ae } = _;
        if (!Ae || !he || !we) return;
        if (R.current[`iChannel${H}`]?.isNeeded) {
          if (!m.current) return;
          const $e = F.getUniformLocation(
            m.current,
            `iChannel${H}`
          );
          F.activeTexture(F.TEXTURE0 + H), F.bindTexture(F.TEXTURE_2D, he), F.uniform1i($e, H), ce && _.updateTexture(
            he,
            we,
            ne
          );
    ...
    const F = v.current;
    if (!F) return;
    F.viewport(0, 0, F.drawingBufferWidth, F.drawingBufferHeight), F.clear(F.COLOR_BUFFER_BIT | F.DEPTH_BUFFER_BIT), F.bindBuffer(F.ARRAY_BUFFER, k.current), F.vertexAttribPointer(
      M.current ?? 0,
      3,
      F.FLOAT,
      !1,
      0,
      0
    ), ve(b), F.drawArrays(F.TRIANGLE_STRIP, 0, 4);
    const y = R.current.iMouse?.value;
    if (R.current.iMouse?.isNeeded && c !== 1 && Array.isArray(y)) {
      const D = y[0] ?? 0, H = y[1] ?? 0;
      y[0] = U1(D, w.current[0] ?? 0, c), y[1] = U1(H, w.current[1] ?? 0, c);
    }
    A.current = requestAnimationFrame(re);
  }, le = () => {
    const b = { passive: !0 };
    R.current.iMouse?.isNeeded && h.current && (h.current.addEventListener("mousemove", oe, b), h.current.addEventListener("mouseout", Y, b), h.current.addEventListener("mouseup", Y, b), h.current.addEventListener("mousedown", te, b), h.current.addEventListener("touchmove", oe, b), h.current.addEventListener("touchend", Y, b), h.current.addEventListener("touchstart", te, b)), R.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      G,
      b
    ), h.current && (I.current = new ResizeObserver(J), I.current.observe(h.current), window.addEventListener("resize", J, b));
  }, Le = () => {
    const b = { passive: !0 };
    R.current.iMouse?.isNeeded && h.current && (h.current.removeEventListener("mousemove", oe, b), h.current.removeEventListener("mouseout", Y, b), h.current.removeEventListener("mouseup", Y, b), h.current.removeEventListener("mousedown", te, b), h.current.removeEventListener("touchmove", oe, b), h.current.removeEventListener("touchend", Y, b), h.current.removeEventListener("touchstart", te, b)), R.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      G,
      b
    ), I.current && (I.current.disconnect(), window.removeEventListener("resize", J, b));
  };
  return W(() => {
    S.current = n;
  }, [n]), W(() => {
    ...
    function F() {
      O();
      const y = v.current;
      y && h.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, ee(), ue(), K(ge(e || q2), r || V1), U(), requestAnimationFrame(re), le(), J());
    }
    return requestAnimationFrame(F), () => {
      ...
      Le(), cancelAnimationFrame(A.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
}`, al = 10, il = 2, cl = 0.5, ll = 0.2, dl = 1.5, Ce = {
  duration: 0.5,
  ease: "easeOut"
}, O1 = {
  duration: 0.35,
...
function fl(e, r) {
  const [o, n] = B(al), {
    ...
    animate: a,
    motionValue: l
  } = Pe(ll), { value: d, animate: c } = Pe(il), { value: u, animate: f } = Pe(cl), { value: p, animate: g } = Pe(dl), h = ns(r, {
    fftSize: 512,
  ...
  return W(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), a(0.2, Ce), c(1.2, Ce), f(0.4, Ce), g(1, Ce);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), a(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, Ce), f(0.7, Ce), g([1.5, 2], O1);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), a(0.3, Ce), c(0.5, Ce), f(1, Ce), g([0.5, 2.5], O1);
        return;
      case "speaking":
        n(70), a(0.3, Ce), c(0.75, Ce), f(1.25, Ce), g(1.5, Ce);
        return;
    }
  }, [
    e,
...
function Qt({
  ...
  const h = X(() => hl(l), [l]);
  return /* @__PURE__ */ t("div", { ref: f, className: p, ...g, children: /* @__PURE__ */ t(
    nl,
    {
      fs: sl,
...
function w6({
  ...
  const { speed: u, scale: f, amplitude: p, frequency: g, brightness: h } = fl(r, s);
  return /* @__PURE__ */ t(
    Qt,
    {
      ref: d,
...
const k6 = ({
  ...
  const n = z(), s = me();
  return /* @__PURE__ */ i(Re, { children: [
    e && /* @__PURE__ */ t("span", { className: L(gl(), "truncate"), children: e }),
    ...
    /* @__PURE__ */ i(
      Q.div,
      {
        ...
        children: [
          ...
          n === "balance" && /* @__PURE__ */ t(ml, { balance: e.balance })
        ]
      }
    ),
    o && !vl.has(n) && /* @__PURE__ */ t(
      Q.span,
      {
        className: L(De()),
        animate: { opacity: s ? 0 : 1 },
...
const Ll = ({
  ...
  const s = `sparkline-gradient-${je().replace(/:/g, "")}`, a = kl(e, o), l = er[a];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(_n, { width: "100%", height: "100%", children: /* @__PURE__ */ i(
          Un,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(On, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                zn,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(xl, { label: r, direction: a })
      ]
    }
  ) });
}, tr = C(
  (e, r) => {
    const {
      ...
      className: c,
      ...u
    } = e, [f, p] = B(!1), [g, h] = B(!1), v = f || g, k = me(), m = v && !!d, M = {
      duration: k ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, A = () => {
      l?.();
...
const Ml = () => /* @__PURE__ */ i(
  ...
  "balance",
  "sparkline"
], or = 180, El = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : or, Rl = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, Fl = (e) => e.showActions !== !1, Nl = (e) => Object.fromEntries(
...
function Vl(e) {
  ...
  } = e, [c, u] = B(!1), f = je(), p = $(null), g = El(
    d
  ), h = a.length > g, v = c ? a : Rl(a, g), k = Fl(e) ? e : null, m = Nl(e);
  return W(() => {
    c && p.current?.focus();
  }, [c]), /* @__PURE__ */ i(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          r && /* @__PURE__ */ t(pt, { module: r, size: "md" }),
...
Vl.displayName = "F0AiProposalCard";
const Sl = ({
  icon: e,
  title: r,
  children: o
  ...
  return /* @__PURE__ */ i(
    mt,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ i(wt, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, Tl = (e) => J0[e] ?? ot, Hl = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(ie, { icon: Tl(e), size: "md", color: "default" }) }) : null;
function Al({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(Sl, { icon: Qe, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, a) => {
    const l = /* @__PURE__ */ t(Hl, { iconName: s.icon });
...
Al.displayName = "F0AiMessageSources";
...
function Bl({
  ...
  const n = z(), s = $(null), a = r ?? n.ai.aiTable.title, l = Z(
    (d) => {
      if (!s.current) return;
  ...
  return e.columns?.length ? /* @__PURE__ */ i(
    Oe,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(Oe, { overflowX: "auto", children: /* @__PURE__ */ i(
          "table",
          {
            ref: s,
            className: L(
...
Bl.displayName = "F0AiTableCard";
function Il({ credits: e, trigger: r }) {
  const o = z(), [n, s] = B(!1), [a, l] = B(!1), [d, c] = B(!1), [u, f] = B(null), p = Z(
    (v) => {
  ...
  if (!e) return null;
  const g = u ? Math.min(100, Math.round(u.used / u.total * 100)) : 0, h = e.companyName;
  return /* @__PURE__ */ i(e1, { open: n, onOpenChange: p, children: [
    /* @__PURE__ */ t(xt, { asChild: !0, children: r ?? /* @__PURE__ */ t(
      se,
      {
        variant: "ghost",
        hideLabel: !0,
...
const Pl = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function Dl({
  employeeCredits: e,
  trigger: r
}) {
  const o = z(), n = me(), [s, a] = B(!1), [l, d] = B(!1), [c, u] = B(!1), [f, p] = B(null), g = Z(
    (m) => {
      a(m), m && e?.fetchUsage && (d(!0), u(!1), e.fetchUsage().then((M) => {
        p(M), u(!1);
      }).catch(() => {
        u(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const h = !!e.companyName, v = f && f.total > 0 ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, k = f ? Math.max(0, f.total - f.used) : 0;
  return /* @__PURE__ */ i(e1, { open: s, onOpenChange: g, children: [
    /* @__PURE__ */ t(xt, { asChild: !0, children: r ?? /* @__PURE__ */ t(
      se,
      {
        variant: "ghost",
...
const qe = ({
...
) : e ? /* @__PURE__ */ t(Il, { credits: e, trigger: o }) : null, b6 = qe, y6 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const v = z(), k = me(), m = qn(`(max-width: ${Xn.md}px)`, {
      ...
      children: [
        /* @__PURE__ */ t(
          ae,
          {
            ...
            children: o ?? v.ai.newConversation
          }
        ),
        /* @__PURE__ */ i(
          Q.div,
        ...
        /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ t(
          Se,
          {
            ...
            children: /* @__PURE__ */ i("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ t(ae, { lines: 1, className: "min-w-0 text-left", children: o ?? v.ai.newConversation }),
              /* @__PURE__ */ t(ie, { icon: Ye, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ i(
...
function Zl(e) {
  ...
  return bt(r) ? "today" : yt(r) ? "yesterday" : Kn(r, o) ? "thisMonth" : "older";
}
function _l(e, r) {
  const o = new Date(e), n = jl(), s = w1(o, "p", { locale: n });
  if (bt(o)) return `${r.today}, ${s}`;
  if (yt(o)) return `${r.yesterday}, ${s}`;
  const a = !Yn(o, /* @__PURE__ */ new Date());
...
function Ol({
  ...
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      onKeyDown: (g) => {
        (g.key === "Enter" || g.key === " ") && (g.preventDefault(), s(e.id, e.title));
      },
      children: [
        /* @__PURE__ */ i(
          "div",
        ...
        n ? (
          ...
          /* @__PURE__ */ t(
            "div",
            {
              ...
              children: /* @__PURE__ */ t(Jn, { size: "small" })
            }
          )
        ) : /* @__PURE__ */ t(
          "div",
...
const G1 = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], zl = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(de, { className: L("h-4 rounded", e) }) }), W1 = ({
  titleWidth: e,
  rows: r
  ...
  r.map((o, n) => /* @__PURE__ */ t(zl, { width: o }, n))
] });
function Gl() {
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ i("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ t(ie, { icon: Qe, color: "secondary", size: "md" }),
                  /* @__PURE__ */ t(
                    "input",
                    {
                      type: "text",
...
function E6({
  ...
  const [a, l] = B([]), [d, c] = B(!1), [u, f] = B(null), [p, g] = B(Wl), [h, v] = B(() => /* @__PURE__ */ new Set()), k = Z(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);
  ...
  const m = Z((w, N) => {
    g((x) => {
      ...
      const I = new Set(x);
      return N ? I.add(w) : I.delete(w), q1(I), I;
    });
  }, []), M = Z((w, N) => {
    v((x) => {
      if (N === x.has(w)) return x;
      const I = new Set(x);
      return N ? I.add(w) : I.delete(w), I;
    });
  }, []), A = Z(
    (w, N) => {
      const x = N ? n : s;
      m(w, N), x && (M(w, !0), x(w).catch(() => m(w, !N)).finally(() => M(w, !1)));
    },
    [n, s, m, M]
  ), T = Z((w) => A(w, !0), [A]), V = Z(
    (w) => A(w, !1),
    ...
    async (w) => {
      M(w, !0);
      try {
        await o(w), l((N) => N.filter((x) => x.id !== w)), g((N) => {
          if (!N.has(w)) return N;
          const x = new Set(N);
...
const ql = Q.create(rs), Xl = ({
  ...
  const { t: a } = z(), l = me(), d = o ?? a("ai.applyingChanges");
  return W(() => {
    if (!r) return;

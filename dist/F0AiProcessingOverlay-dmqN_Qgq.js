...
import { useInsertionEffect as Zr, forwardRef as g, useRef as j, useEffect as K, useLayoutEffect as at, useState as P, useMemo as J, useCallback as z, createContext as We, useContext as Be, useId as ct, createElement as _r, memo as Or } from "react";
import { cU as Ur, cV as zr, cW as Gr, cX as Wr, cY as lt, cZ as qr, c_ as Xr, c$ as Yr, d0 as Kr, d1 as Qr, d2 as dt, d3 as Jr, d4 as en, d5 as tn, d6 as rn, d7 as nn, d8 as on, d9 as sn, da as Ge, db as an, dc as cn, dd as ln, de as dn, df as un, Z as ut, bX as fn, dg as hn, dh as gn, di as pn, dj as mn, b$ as ft, bW as Cn, dk as vn, a6 as i1, dl as wn, aK as xn, dm as kn, dn as Ln, dp as bn, ah as yn, dq as Mn, co as En, aa as ht, ad as Rn, dr as Fn, ba as a1, a1 as gt, S as qe, bN as pt, bi as Nn, ds as Vn, dt as Sn, b3 as Tn, cn as An, $ as Fe, av as Hn, bm as mt, du as $n, cl as Bn, bV as Me, ch as In, dv as Pn, bP as Ct, b2 as jn, dw as Dn, dx as Zn, dy as _n, dz as On, dA as Un, dB as vt, ca as zn, cb as Gn, dC as Wn, dD as qn, dE as Xn, dF as Yn, dG as Kn, bw as Qn, bZ as Jn, dH as eo, dI as to, dJ as ro, dK as no, dL as oo, dM as so, dN as io, dO as ao, bv as co, cm as lo, ab as uo, c6 as fo, dP as ho, dQ as go, dR as po, dS as mo, dT as Co, dU as vo, dV as wo, aq as xo, bR as wt, M as ko, a0 as Lo, bK as xt, bO as bo, bQ as kt, dW as yo, bl as Mo, bk as Eo, dX as Ro, dY as Fo, bx as Lt, by as No, bz as Vo, b1 as So, az as To, dZ as Ao, at as Ho, bg as bt, bf as yt, b8 as $o, d_ as Mt, b7 as Bo, bY as c1, d$ as Io, bc as l1, e0 as Po, e1 as jo, e2 as d1, cj as Do, ci as Zo, ck as Et, e3 as _o, G as Oo, E as Uo, e4 as zo, e5 as Go, e6 as Wo, e7 as qo, bL as Xo, e8 as Rt, e9 as Yo, ac as Ko, ea as Qo, L as ue, o as L, q as Se, c0 as Jo, u as Y, bJ as es, U as ge, bI as Ft, H as fe, v as pe, a2 as ts, Q as ve, eb as rs, ae as le, aQ as ke, A as Ee, p as re, ct as Nt, aE as u1, ec as ns, aF as f1, aG as h1, b as be, bG as os, ed as ss, bH as is, V as as, b0 as cs, a5 as g1, bA as ls, bB as ds, bC as us, bD as E1, a3 as fs, al as Vt, aT as St, ee as hs, cA as gs, ef as ps, eg as ms, aY as Tt, eh as Cs, cu as vs, ei as ws, aV as $e, b9 as At, ej as Ht, bb as $t, c as n1, b_ as R1, ek as Bt, el as xs, bq as ks, em as Ls, bh as p1, c7 as bs, en as ys, eo as Ms, ep as Es, eq as Rs, er as Fs, a8 as Ns, af as Vs, y as Ss, z as Ts, ak as F1, es as It, et as Pt, eu as As, ev as Hs, aj as $s, a7 as Bs, ew as Is, ex as Ps, d as js } from "./F0CanvasPanel-B-DoVa5H.js";
import { createPortal as jt } from "react-dom";
import { defaultTranslations as Ds } from "./i18n-provider-defaults.js";
import { useTrackVolume as Zs } from "@livekit/components-react";
function _s(e, t, n) {
  Zr(() => e.on(t, n), [e, t, n]);
}
function m1(e) {
...
function Dt(e, t, n, o) {
  return typeof e == "string" && m1(t) ? Ur(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Os(e, t, n) {
  return e * (t + 1);
}
...
function Zt(e, t) {
  return zr(e) ? e[Us(0, e.length, t)] : e;
}
function zs(e, t, n) {
  for (let o = 0; o < e.length; o++) {
    const s = e[o];
    s.at > t && s.at < n && (Wr(e, s), o--);
  }
}
function Gs(e, t, n, o, s, i) {
  zs(e, s, i);
...
const Xs = "easeInOut", Ys = 20;
function Ks(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let h = 0; h < e.length; h++) {
    ...
    if (typeof C == "string") {
      ...
      f.set(C.name, N1(p, C.at, u, f));
      continue;
    }
    let [v, w, M = {}] = C;
    M.at !== void 0 && (p = N1(p, M.at, u, f));
    let A = 0;
    const H = (N, b, x, k = 0, E = 0) => {
      const V = Qs(N), { delay: S = 0, times: F = qr(V), type: B = "keyframes", repeat: Z, repeatType: U, repeatDelay: G = 0, ...ee } = b;
      let { ease: X = t.ease || "easeOut", duration: _ } = b;
      const q = typeof S == "function" ? S(k, E) : S, I = V.length, te = Kr(B) ? B : s?.[B];
      if (I <= 2 && te) {
        let se = 100;
        if (I === 2 && ti(V)) {
          const de = V[1] - V[0];
        ...
        const ne = { ...ee };
        _ !== void 0 && (ne.duration = Qr(_));
        const ie = Xr(ne, se, te);
        X = ie.ease, _ = ie.duration;
      }
      _ ?? (_ = i);
      const W = p + q;
      F.length === 1 && F[0] === 0 && (F[1] = 1);
      const ae = F.length - V.length;
      if (ae > 0 && Yr(F, ae), V.length === 1 && V.unshift(null), Z) {
        dt(Z < Ys, "Repeat count too high, must be less than 20"), _ = Os(_, Z);
        const se = [...V], ne = [...F];
        ...
        for (let de = 0; de < Z; de++) {
          ...
          for (let y = 0; y < se.length; y++)
            F.push(ne[y] + (de + 1)), X.push(y === 0 ? "linear" : Zt(ie, y - 1));
        }
        Ws(F, Z);
      }
      const Ce = W + _;
      Gs(x, V, X, F, W, Ce), A = Math.max(q + _, A), m = Math.max(Ce, m);
    };
    if (lt(v)) {
      const N = V1(v, d);
      H(w, M, S1("default", N));
    } else {
      const N = Dt(v, w, o, l), b = N.length;
      for (let x = 0; x < b; x++) {
        w = w, M = M;
        const k = N[x], E = V1(k, d);
        for (const V in w)
          H(w[V], Js(M, V), S1(V, E), x, b);
      }
    }
    u = p, p += A;
  }
  return d.forEach((h, C) => {
    for (const v in h) {
      ...
      for (let b = 0; b < w.length; b++) {
        const { at: x, value: k, easing: E } = w[b];
        M.push(k), A.push(Jr(0, m, x)), H.push(E || "easeOut");
      }
      A[0] !== 0 && (A.unshift(0), M.unshift(M[0]), H.unshift(Xs)), A[A.length - 1] !== 1 && (A.push(1), M.push(null)), a.has(C) || a.set(C, {
        keyframes: {},
        transition: {}
      });
      const N = a.get(C);
      N.keyframes[v] = M, N.transition[v] = {
        ...t,
        duration: m,
        ease: H,
        times: A,
...
const ei = (e) => typeof e == "number", ti = (e) => e.every(ei);
function ri(e, t) {
  return e in t;
}
class ni extends en {
...
function oi(e) {
  ...
  }, n = rn(e) && !nn(e) ? new on(t) : new sn(t);
  n.mount(e), Ge.set(e, n);
}
function si(e) {
  const t = {
    presenceContext: null,
...
function ii(e, t) {
  return lt(e) || typeof e == "number" || typeof e == "string" && !m1(t);
}
function _t(e, t, n, o) {
  const s = [];
  if (ii(e, t))
    s.push(an(e, m1(t) && t.default || t, n && (n.default || n)));
  else {
    const i = Dt(e, t, o), a = i.length;
    dt(!!a, "No valid elements provided.");
    for (let d = 0; d < a; d++) {
      const l = i[d], f = l instanceof Element ? oi : si;
      Ge.has(l) || f(l);
      const u = Ge.get(l), p = { ...n };
      "delay" in p && typeof p.delay == "function" && (p.delay = p.delay(d, a)), s.push(...cn(u, { ...t, transition: p }, {}));
    }
  }
  return s;
}
function ai(e, t, n) {
  const o = [];
  return Ks(e, t, n, { spring: ln }).forEach(({ keyframes: i, transition: a }, d) => {
    o.push(..._t(d, i, a));
  }), o;
}
class ci {
...
function ui(e) {
  function t(n, o, s) {
    let i = [];
    return di(n) ? i = ai(n, o, e) : i = _t(n, o, s, e), new li(i);
  }
  return t;
}
const fi = ui(), hi = (e, t) => /* @__PURE__ */ c(
  "svg",
  {
...
const bc = (e, t) => /* @__PURE__ */ c(
...
), cl = g(al), ll = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: gi,
  Add: dn,
  Ai: mi,
  ...
  Calculator: Mn,
  Calendar: En,
  CalendarArrowDown: _i,
  CalendarArrowLeft: Ui,
  CalendarArrowRight: Gi,
  CameraPlus: qi,
  CardPin: Yi,
  ChartFunnel: Qi,
  ...
  DropdownOpen: Pn,
  Ellipsis: Ct,
  EllipsisHorizontal: jn,
  Envelope: Dn,
  EnvelopeOpen: _a,
  Equal: Zn,
  EqualApproximately: _n,
  EqualGreater: On,
  EqualLess: Un,
  Exit: Ua,
  ExternalLink: vt,
  ...
  FaceNeutral: qn,
  FacePositive: Xn,
  FaceSuperNegative: Yn,
  FaceSuperPositive: Kn,
  Feed: Ga,
  File: Qn,
  FileFilled: qa,
  FileSigned: Ya,
  ...
  Wifi: cl,
  Windows: Qo
}, Symbol.toStringTag, { value: "Module" })), dl = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ r(
    ue,
    {
      ...
      variant: "ai",
      ref: t,
      iconRotate: e.icon == ul
    }
  );
});
Yt.displayName = "AIButton";
const Kt = {
  background: {
...
const Nl = Se({
  ...
  ({
    ...
    const Ne = I && I !== "none" || te && te !== "none" || W && W !== "none" || ae && ae !== "none", je = q && q !== "none" || Ne, De = { sm: Xe, md: Ye, lg: Ke, xl: Ie }, Je = Vl.map((Ze) => {
      const _e = De[Ze];
      return _e ? Fl(Ze, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
function Al({
  ...
  const o = /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(fe, { icon: ut, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ r(
      "button",
      {
        ...
        onClick: () => t(e.id),
        children: /* @__PURE__ */ r(fe, { icon: Fe, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ r(ts, { label: e.errorMessage, children: o }) : o;
}
const Hl = {
  soft: {
    text: "",
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      className: L("flex flex-col rounded-xl", o.bg, o.formBorder),
      children: [
        /* @__PURE__ */ c("div", { className: "flex items-center justify-between gap-2 px-4 pb-1.5 pt-2", children: [
          /* @__PURE__ */ r(
            "p",
            {
              className: L("min-w-0 flex-1 text-sm font-medium", o.fontColor),
              children: o.text
            }
          ),
  ...
  return !e || f ? null : /* @__PURE__ */ r(
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (u, p) => /* @__PURE__ */ c(
        ...
        const m = p === o, h = `${u.firstName} ${u.lastName}`.trim();
        return /* @__PURE__ */ c(
          "div",
          {
            ref: m ? d : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ r(le, { className: "text-base font-medium text-f1-foreground", children: h }) })
            ]
          },
          String(u.id)
        );
...
const Il = ({
  ...
  return /* @__PURE__ */ r("div", { className: "p-1", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ r(fe, { icon: c1, size: "md", color: "default" }) }),
        /* @__PURE__ */ r(
          le,
          {
  ...
  const s = ke(), [i, a] = P(""), [d, l] = P(0), [f, u] = P(!1), p = j(null), m = j(null), h = j(null), C = e[d] ?? t;
  return K(() => {
    const v = () => {
      m.current && (clearInterval(m.current), m.current = null), h.current && (clearInterval(h.current), h.current = null), p.current && (clearTimeout(p.current), p.current = null);
    };
    if (n.length > 0 || o) {
      u(!1), a(""), v();
      return;
    ...
    if (s)
      return u(!1), a(C), v(), p.current = setTimeout(() => {
        const b = (d + 1) % Math.max(e.length, 1);
        l(b);
      }, 4e3), () => {
        v();
      };
    u(!0), a("");
    let w = 0;
    const M = 50, A = 30, H = 2e3, N = 1e3;
    return m.current = setInterval(() => {
      w < C.length ? (a(C.slice(0, w + 1)), w++) : (m.current && (clearInterval(m.current), m.current = null), p.current = setTimeout(() => {
        h.current = setInterval(() => {
          w > 0 ? (w--, a(C.slice(0, w))) : (h.current && (clearInterval(h.current), h.current = null), p.current = setTimeout(() => {
            const b = (d + 1) % Math.max(e.length, 1);
            l(b);
          }, N));
        }, A);
    ...
    e.length,
    s
  ]), n.length > 0 || o ? null : /* @__PURE__ */ r(Ee, { children: /* @__PURE__ */ r(
    re.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
`) ? n + "_" : n
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ r("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, Dl).map((t) => /* @__PURE__ */ r(
  Nt,
  {
...
const Ul = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ c(
    u1,
    {
      ...
      children: [
        /* @__PURE__ */ r(ns, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ r(f1, { asChild: !0, children: /* @__PURE__ */ r(
          ue,
          {
            variant: "outline",
            label: d.label,
          ...
          h1,
          {
            ...
            children: [
              /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ r(fe, { icon: a.icon, size: "sm" }),
                /* @__PURE__ */ r("span", { children: a.label })
              ] }),
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: Ol(a.items).map((d, l) => /* @__PURE__ */ c(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ r(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ r(fe, { icon: i1, size: "sm" })
                      }
                    )
                  ]
                },
...
function zl(e, t, n) {
  ...
  for (const u of t) {
    ...
    let m = 0;
    for (; ; ) {
      const h = e.indexOf(p, m);
      if (h === -1) break;
      i.push({ start: h, end: h + p.length }), m = h + p.length;
    }
  }
  ...
  const f = (u) => {
    ...
    o > d && a.push({ type: "text", text: e.slice(d, o) }), a.push({ type: "ghost", text: s }), l = !0, o < u && a.push({ type: "text", text: e.slice(o, u) }), d = u;
  };
  for (const u of i)
    f(u.start), a.push({ type: "mention", text: e.slice(u.start, u.end) }), d = u.end;
  return f(e.length), !l && s && o >= d && a.push({ type: "ghost", text: s }), a.length === 0 ? [{ type: "text", text: e }] : a;
}
function Gl(e, t) {
  if (t === "*/*") return !0;
  if (t.endsWith("/*")) {
...
function Wl(e, t) {
  ...
  return n.length === 0 ? e : e.filter(
    (o) => n.some((s) => Gl(o.type, s))
  );
}
const ql = 4e3;
function Xl(e) {
  const [t, n] = P([]), [o, s] = P(null), i = j(
    null
  ), a = j(null), d = Y(), l = e?.onUploadFiles, f = e?.allowedMimeTypes, u = e?.maxFiles, p = J(() => {
    if (f)
      return Array.isArray(f) ? f.join(",") : f;
  }, [f]), m = u !== void 0 && t.length >= u, h = j(0);
  K(() => {
    h.current = t.length;
  }, [t]);
  const C = z((H) => {
  ...
  const v = z(
    async (H) => {
      ...
      if (u !== void 0 && h.current + N.length > u) {
        C(
      ...
      const k = (E) => n(
        (V) => V.map(
          (S) => x.includes(S.id) ? { ...S, status: "error", errorMessage: E } : S
        )
      );
      try {
        const E = await l(N);
        if (!Array.isArray(E) || E.length !== N.length) {
          k(d.ai.fileUploadError);
          return;
        }
        n(
          (V) => V.map((S) => {
            const F = b.findIndex((B) => B.id === S.id);
            return F === -1 ? S : E[F] ? {
              ...S,
              status: "uploaded",
              uploadedFile: E[F]
        ...
        const V = E instanceof Error && E.message ? E.message : d.ai.fileUploadError;
        k(V);
      }
    },
    [
...
function e2({
  ...
  const [i, a] = P(!1), [d, l] = P(""), [f, u] = P([]), [p, m] = P(!1), [h, C] = P(0), [v, w] = P([]), M = j(-1), A = j(null), H = j(0), N = j(-1);
  K(() => {
    if (!o) {
      a(!1);
      return;
    ...
    const F = Yl(e, n, v);
    if (!F) {
      a(!1), l(""), u([]), C(0), M.current = -1, N.current = -1;
      return;
    }
    if (F.atIndex === N.current)
      return;
    M.current = F.atIndex, l(F.query), a(!0), C(0), m(!0), A.current && clearTimeout(A.current);
    const B = ++H.current;
    return A.current = setTimeout(() => {
      o(F.query).then((Z) => {
        B === H.current && (u(Z), C(0), Z.length === 0 && F.query.length > 0 && (N.current = F.atIndex, a(!1)));
      }).catch(() => {
        B === H.current && u([]);
      }).finally(() => {
        B === H.current && m(!1);
  ...
  const b = z(() => {
    a(!1), l(""), u([]), C(0), M.current = -1;
  }, []), x = z(
    (F) => {
      const B = M.current;
      if (B === -1) return;
      const Z = `${F.firstName} ${F.lastName}`.trim(), U = String(F.id), G = e.slice(0, B), ee = e.slice(n), X = `@${Z} `, _ = G + X + ee, q = G.length + X.length;
      t(_), w((I) => [...I.filter((W) => !(W.id === U && W.name === Z)), { id: U, name: Z }]), b(), requestAnimationFrame(() => {
        const I = s.current;
        I && (I.focus(), I.setSelectionRange(q, q));
      });
    },
    [e, n, t, s, b]
  ), k = z(
    (F) => {
      ...
      switch (F.key) {
        case "ArrowDown":
          return F.preventDefault(), C((B) => (B + 1) % f.length), !0;
        case "ArrowUp":
        ...
        case "Tab": {
          const B = f[h];
          if (B) {
            const Z = `${B.firstName} ${B.lastName}`.trim();
            if (d.length === 0 || Z.toLowerCase().startsWith(d.toLowerCase()))
              return F.preventDefault(), x(B), !0;
          }
          return !1;
        }
        case "Enter":
          return F.preventDefault(), f[h] && x(f[h]), !0;
        default:
          return !1;
      }
    },
    ...
    (F) => {
      ...
      let B = F;
      const Z = [...v].sort((U, G) => G.name.length - U.name.length);
      for (const U of Z) {
        const G = `@${U.name}`, ee = `<entity-ref type="person" id="${T1(U.id)}">${T1(U.name)}</entity-ref>`;
        for (; B.includes(G); )
          B = B.replace(G, ee);
      }
      return B;
  ...
  K(() => {
    w(
      (F) => F.filter((B) => {
        const Z = `@${B.name}`, U = e.indexOf(Z);
        if (U === -1) return !1;
        const G = e[U + Z.length];
        return G === " " || G === `
` || G === "	";
      })
    );
  ...
  const V = J(() => {
    ...
    const F = s.current;
    if (!F) return null;
    const B = Ql(F, M.current), Z = F.offsetLeft + B.left, G = (F.offsetParent ? F.offsetParent.offsetHeight : 0) - (F.offsetTop + B.top);
    return { left: Z, bottom: G };
  }, [i, e, n, s]), S = J(() => {
    if (!i || f.length === 0) return null;
    const F = f[h];
    if (!F) return null;
    const B = `${F.firstName} ${F.lastName}`.trim();
...
const t2 = /[\\`*_{}[\]()#+\-.!|~>]/g, r2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(t2, "\\$&")).join(""), A4 = ({
  onSubmit: e,
  onStop: t,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const k = Y(), E = ke(), [V, S] = P(""), [F, B] = P(0), [Z, U] = P(!1), [G, ee] = P(!1), [X, _] = P(null), q = j(null), I = j(null), te = j(null), W = a != null, { tracking: ae } = be(), Ce = z(
    (Q, xe) => {
    ...
    const xe = ye.current, e1 = xe && !/\s$/.test(xe) ? " " : "", Oe = `${xe}${e1}${Q}`;
    S(Oe), B(Oe.length);
  }, []), Ae = {
    ...
    onPartial: Ve,
    onFinal: (Q) => {
      Ve(Q), I.current?.focus();
    },
    onError: (Q) => he(Ae[Q])
  }), Xe = !!m && we.isSupported, Ye = z(() => {
    ae?.onDictationStart?.(), ye.current = V, we.start();
  }, [V, we, ae]), Ke = z(() => {
    ae?.onDictationCancel?.(), we.cancel();
  }, [we, ae]);
  K(() => {
  ...
  const Ie = we.status === "recording", Qe = Ie ? k.ai.listening : k.ai.inputPlaceholder, Pe = se.filter((Q) => Q.status === "uploaded"), Ne = se.some((Q) => Q.status === "uploading"), je = se.some((Q) => Q.status === "error"), De = V.trim().length > 0 || Pe.length > 0;
  K(() => {
    if (!(!G || Ne)) {
      if (ee(!1), je) {
        he(k.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const Je = async (Q) => {
    if (Q.preventDefault(), !W) {
      if (oe.close(), n)
        ...
        const xe = oe.transformMentions(V.trim()), e1 = r2(xe), Oe = Pe.flatMap(
    ...
    W || oe.handleKeyDown(Q) || Q.key === "Enter" && !Q.shiftKey && (Q.preventDefault(), n || q.current?.requestSubmit());
  }, _e = () => {
    B(I.current?.selectionStart ?? 0);
  }, $r = () => {
    te.current && I.current && (te.current.scrollTop = I.current.scrollTop);
  }, w1 = X ? X.prompt ?? X.title : null, x1 = Ie ? [k.ai.listening] : w1 ? [w1] : s ?? [], Br = x1.length > 1, Ir = J(() => zl(V, oe.mentions, {
    cursorPosition: F,
    inlineCompletion: oe.inlineCompletion
  }), [V, oe.mentions, F, oe.inlineCompletion]), Pr = oe.mentions.length > 0 || oe.inlineCompletion !== null, k1 = M && !!H && H.length > 0 && !!N ? /* @__PURE__ */ r(
    Ul,
    {
      suggestions: H,
      onItemClick: Ce,
  ...
  ) : null, jr = M && A && !!b && b.length > 0, L1 = A && M, { motionProps: Dr } = ss(
    M,
    160,
    0.5
  );
    ...
    re.div,
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          k1 && /* @__PURE__ */ r("div", { children: k1 }),
          /* @__PURE__ */ r($l, { creditWarning: i, children: /* @__PURE__ */ c(
            re.form,
            {
              "aria-busy": n,
              ref: q,
              ...
              children: [
                /* @__PURE__ */ r(
                  Bl,
                  {
                    ...
                    selectedIndex: oe.selectedIndex,
                    position: oe.popoverPosition,
                    onSelect: oe.selectPerson
                  }
                ),
                /* @__PURE__ */ r(Ee, { initial: !1, children: W ? /* @__PURE__ */ r(
                  re.div,
                  {
                  ...
                  re.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ r(Ee, { initial: !1, children: ce && /* @__PURE__ */ r(
                        re.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ c(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ r("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ r(is, { type: "critical", size: "sm" }) }),
                                /* @__PURE__ */ r("p", { className: "font-medium text-f1-foreground-critical", children: ce })
                              ]
                            }
                          )
                        },
                      ...
                      /* @__PURE__ */ r(
                        jl,
                        {
                          ...
                          onCursorUpdate: _e,
                          onScroll: $r,
                          highlightSegments: Ir,
                          hasOverlay: Pr,
                          multiplePlaceholders: Br,
                          placeholders: x1,
                          resolvedDefaultPlaceholder: Qe,
                          inProgress: n
                        }
                      ),
                      /* @__PURE__ */ r(
                        Sl,
                        {
                          ...
                          isPreSending: Z || G,
                          canRecord: Xe,
                          recordingStatus: we.status,
                          recordingStream: we.stream,
                          onStartRecording: Ye,
                          onStopRecording: we.stop,
                          onCancelRecording: Ke
                        }
                      )
                    ]
                  },
        ...
        jr && /* @__PURE__ */ r("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ r(Zl, { cards: b }) }),
        w && M && A && /* @__PURE__ */ r("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: w }),
        /* @__PURE__ */ r(Ee, { mode: "wait", initial: !1, children: W ? /* @__PURE__ */ c(
          re.div,
          {
          ...
          re.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ r(le, { className: "text-sm font-medium text-f1-foreground-tertiary", children: v.text }),
  ...
  return /* @__PURE__ */ c("div", { className: "relative w-fit", children: [
    /* @__PURE__ */ r(
      "img",
      {
        ...
        src: e,
        alt: t,
        className: L("max-w-full rounded-md", n.className)
      }
    ),
...
function c2({
  ...
  return /* @__PURE__ */ r(cs, { ...t, variant: "link", href: t.href, children: e });
}
function l2({
  children: e,
  ...t
...
function Te({
  ...
  const i = j(/* @__PURE__ */ new Map()), [a, d] = P(
    () => i.current.get(e) ?? null
  ), [l, f] = P(!1), [u, p] = P(!1), m = j(!0);
  K(() => () => {
    m.current = !1;
  }, []);
  const h = z(() => {
  ...
  return /* @__PURE__ */ c(
    ls,
    {
      ...
      children: [
        /* @__PURE__ */ r(ds, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          us,
          {
            side: "top",
            ...
            children: l ? /* @__PURE__ */ r(E1.Skeleton, {}) : /* @__PURE__ */ r(E1, { ...C })
          }
        )
      ]
    }
...
dr.displayName = "CandidateTrigger";
function L2({
  id: e,
  label: t
}) {
  const { entityRefs: n } = be(), o = n?.resolvers?.candidate, s = Y(), i = n?.urls?.candidate?.(e), a = J(
    () => (l) => {
      const f = [];
...
ur.displayName = "ExpenseTrigger";
function b2({ id: e, label: t }) {
  const { entityRefs: n } = be(), o = n?.resolvers?.expense, s = Y(), i = n?.urls?.expense?.(e), a = J(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: Ut
...
function y2({
  ...
  const { entityRefs: n } = be(), o = n?.resolvers?.jobPosting, s = Y(), i = n?.urls?.jobPosting?.(e), a = J(
    () => (l) => ({
      title: l.title,
...
hr.displayName = "RequisitionTrigger";
function E2({
  id: e,
  label: t
}) {
  const { entityRefs: n } = be(), o = n?.resolvers?.requisition, s = Y(), i = n?.urls?.requisition?.(e), a = J(
    () => (l) => {
...
gr.displayName = "PersonTrigger";
function R2({ id: e, label: t }) {
  const { entityRefs: n } = be(), o = n?.resolvers?.person, s = Y(), i = n?.urls?.person?.(e), a = J(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
pr.displayName = "VacancyTrigger";
function F2({ id: e, label: t }) {
  const { entityRefs: n } = be(), o = n?.resolvers?.vacancy, s = Y(), i = n?.urls?.vacancy?.(e), a = J(
    () => (l) => ({
      title: l.name,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ r(St, { module: e.module, size: "md" }),
          e?.type === "file" && /* @__PURE__ */ r(hs, { file: e.file, size: "lg" }),
          /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ r(le, { className: "text-lg font-semibold text-f1-foreground", children: t }),
            n && /* @__PURE__ */ r(le, { className: "text-base text-f1-foreground-secondary", children: n })
          ] }),
...
mr.displayName = "F0CanvasCard";
const v1 = We(null);
function $4({
  children: e
}) {
  const [t, n] = P(0), o = j([]), s = z(
    (a) => {
  ...
  return /* @__PURE__ */ r(v1.Provider, { value: i, children: e });
}
function T2(e) {
  const n = Be(v1)?.formatters;
  return J(() => !n || n.length === 0 ? null : (o, s, i) => {
    let a, d = -1;
    for (const l of n) {
...
const A1 = 7, A2 = 625, H1 = /* @__PURE__ */ new Set();
function H2(e) {
...
function B2(e) {
  const { days: t, hours: n, minutes: o, seconds: s } = ps(e), i = [];
...
function Cr(e, t) {
  ...
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const n = e.value;
    return { type: "item", text: (n ? H2(n) : "") || "—" };
  }
  if (t === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: n, to: o } = e, s = $1(n) ? B1(n) : String(n), i = $1(o) ? B1(o) : String(o);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((o) => {
      const s = Cr(o);
      return Array.isArray(s) ? s.map(I1).join(", ") : I1(s);
    }).filter(Boolean).join(", ") || "—" };
...
function vr({
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: u } = be(), p = T2(e), m = d ?? p, h = j(() => {
  }), C = o ?? e, v = s ?? t ?? "", w = l?.type === "form" && l.formName === e, M = () => f({
    type: "form",
    title: C,
    description: v,
    formName: e,
  ...
  h.current = M, K(() => {
    typeof window > "u" || window.innerWidth < A2 || H1.has(e) || (H1.add(e), h.current());
  }, [e]);
  const A = i && a ? Object.entries(i).map(([b, x]) => {
    const k = a[b], E = m?.(b, k, {
      fieldType: x.fieldType,
      customFieldName: x.customFieldName
    });
    if (!E && x.fieldType === "custom" && typeof k == "object" && k !== null)
      return null;
    const V = E ?? Cr(k, x.fieldType), S = ["richtext", "textarea"];
    return {
      label: x.label,
      content: V,
      verticalLayout: S.includes(x.fieldType ?? "")
    };
  }).filter((b) => {
    if (!b) return !1;
    const x = Array.isArray(b.content) ? b.content[0] : b.content;
    return !(x?.type === "item" && x.text === "—");
  }) : [], H = A.slice(0, A1), N = A.length > A1;
  return /* @__PURE__ */ r(
    mr,
    {
      ...
      children: H.length > 0 && !w && /* @__PURE__ */ r("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ r(
        gs,
        {
          details: H.map((b) => ({
            title: b.label,
            content: b.content,
            ...b.verticalLayout && { verticalLayout: !0 }
          })),
          showSeeMore: N,
          onClickSeeMore: M,
          tableView: !0
...
vr.displayName = "FormCard";
function I2() {
  const e = ms(), t = e?.activeForm;
  if (!t) return null;
...
const P1 = 8, He = 8;
function xr({ anchor: e, onReply: t }) {
  const n = Y(), o = j(null), [s, i] = P(
    null
  );
  if (at(() => {
    if (!e) {
    ...
    let m = e.rect.top - f - P1;
    m < He && (m = e.rect.bottom + P1), m = Math.min(
      Math.max(m, He),
      p - f - He
    );
...
const kr = We(void 0), I4 = () => Be(kr), D2 = (e) => /* @__PURE__ */ r(Tt, { content: e, format: "markdown" }), Z2 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const d = typeof n?.content == "string" ? n.content : "", l = (n && o?.(n)) ?? n?.generativeUI?.() ?? null, f = n?.toolCalls?.[0]?.id, u = !d && !l, p = j(null), { anchor: m, clear: h } = wr({
    containerRef: p,
    enabled: !!(n?.id && d)
  });
  return K(() => {
    n?.id && !t && !e && i?.(n);
  }, [n, t, e, i]), !t && !e && u ? null : /* @__PURE__ */ r(kr.Provider, { value: f, children: /* @__PURE__ */ c("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    n && d && /* @__PURE__ */ r(
      "div",
      {
        ref: p,
  ...
  const [s, i] = P(""), a = Y(), { title: d, label: l, placeholder: f } = n === "like" ? a.ai.feedbackModal.positive : a.ai.feedbackModal.negative, u = z(() => {
    t(o, s);
  }, [s, o, t]), p = () => {
    e(o);
  };
  ...
  return /* @__PURE__ */ r(Lr.Provider, { value: o, children: e });
}, br = () => {
  const e = Be(Lr);
  if (e === null)
    throw new Error(
...
const z2 = ({
  ...
  const o = Y(), { open: s } = br(), [i, a] = P(null);
  ...
  const [d, l] = P(s), f = ke(), u = o !== void 0, p = u ? o : d;
  return /* @__PURE__ */ c(
    At,
    {
      ...
      children: [
        /* @__PURE__ */ c(
          Ht,
          {
            ...
            children: [
              /* @__PURE__ */ r("span", { className: "flex items-center justify-start h-6 w-6", children: /* @__PURE__ */ r(fe, { icon: e, className: "block" }) }),
              /* @__PURE__ */ r("div", { className: "min-h-6 flex items-center", children: /* @__PURE__ */ r("span", { children: t }) }),
              !a && /* @__PURE__ */ r(fe, { icon: qe })
            ]
          }
        ),
        /* @__PURE__ */ r($t, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ r(
          re.div,
          {
            initial: !1,
            animate: {
  ...
  const s = Y(), [i, a] = P(!!n), d = j(n);
  K(() => {
    d.current && !n ? a(!1) : n && !i && a(!0), d.current = n;
  }, [n, i]);
  const l = n ? s.ai.thoughtsGroupTitle : t ?? s.ai.thoughtsGroupTitle, f = e.length - 1, u = (p) => !n || o ? "completed" : p === f ? "executing" : "completed";
  return /* @__PURE__ */ r(
    G2,
    {
      icon: Ot,
      ...
      onOpenChange: a,
      lockOpen: n,
      children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pb-4", children: e.map((p, m) => /* @__PURE__ */ c("div", { className: "relative", children: [
        /* @__PURE__ */ r(
          n1,
          {
            title: p,
...
const yr = (e) => /* @__PURE__ */ r(Tt, { content: e, format: "markdown" }), Y2 = ({
  text: e,
  renderMarkdown: t
}) => /* @__PURE__ */ c("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ r("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ r(fe, { icon: c1 }) }),
  /* @__PURE__ */ r("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (t ?? yr)(e) })
] }), K2 = ({
  message: e,
  onReplyQuote: t,
  ...
  const a = e.rawData, d = X2(
    e?.content,
    a
  ), l = (q2(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = l.length > 0, { anchor: p, clear: m } = wr({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ r(Y2, { text: f, renderMarkdown: o }),
...
}, Q2 = 35, J2 = 22, e6 = 400, t6 = 2500, r6 = 220, n6 = ({
  messages: e,
  onClick: t,
  fullscreen: n = !1
}) => {
  const [o, s] = P(0), [i, a] = P(0), [d, l] = P("starting"), f = e[o] ?? "";
  K(() => {
    e.length > 0 && o >= e.length && (s(0), a(0), l("starting"));
  }, [e.length, o]), K(() => {
    let m;
    if (d === "starting")
      m = setTimeout(() => l("writing"), e6);
    else if (d === "writing")
      i < f.length ? m = setTimeout(() => a((h) => h + 1), Q2) : l("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      m = setTimeout(() => l("erasing"), t6);
    } else d === "erasing" && (i > 0 ? m = setTimeout(() => a((h) => h - 1), J2) : m = setTimeout(() => {
...
function o6({
  ...
  const [a, d] = P(0), [l, f] = P(!1), u = j(s), p = j(i);
  p.current = i;
  const m = z(
    (C = "smooth") => {
  ...
  K(() => {
    ...
    const w = new ResizeObserver(() => {
      if (p.current) return;
      const M = parseFloat(getComputedStyle(v).paddingTop) + parseFloat(getComputedStyle(v).paddingBottom) + 1;
      d(C.clientHeight - M);
    });
  ...
  const h = z(() => {
    const C = e.current;
    if (!C) return;
    const { scrollTop: v, scrollHeight: w, clientHeight: M } = C, A = w - v - M;
    f(A > M);
  }, [e]);
  return K(() => {
    const C = e.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!C || !v) return;
        const w = C.getBoundingClientRect(), M = v.getBoundingClientRect(), A = C.scrollTop + (M.top - w.top);
...
const s6 = {
...
}, P4 = (e) => /* @__PURE__ */ r(O2, { children: /* @__PURE__ */ r(i6, { ...e }) }), i6 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: H, handleSubmit: N, handleClose: b } = U2(
    u ?? s6
  ), x = Y(), k = v ?? Z2, E = w ?? K2, V = J(() => {
    const I = o ?? x.ai.defaultInitialMessage;
    return (Array.isArray(I) ? I : [I]).filter((W) => typeof W == "string" && W.length > 0);
  }, [o, x.ai.defaultInitialMessage]), S = !t && e.length === 0 && V.length > 0, F = j(null), B = j(null), Z = j(null), U = j(null), G = j(null), { showScrollBtn: ee, turnMinHeight: X, scrollToBottom: _ } = o6({
    viewportRef: F,
    contentRef: B,
    endRef: Z,
    lastTurnRef: G,
    ...
    const W = te === e.length - 1, ae = {
      ...
      const de = W && ie === I.assistantMessages.length - 1, y = I.userMessages.length + ie, T = {
        message: ne,
        inProgress: I.isInProgress,
        index: y,
        isCurrentMessage: de,
      ...
      return /* @__PURE__ */ r(
        ...
        {
          ...T,
          isGenerating: I.isInProgress && de,
          isLoading: I.isInProgress && de && !ne.content
        },
        `${te}-a-${ie}`
      );
    };
    return /* @__PURE__ */ c(
      "div",
      {
        ...
        style: {
          minHeight: W && X || void 0
        },
        children: [
          I.userMessages.map(
            (ne, ie) => Ce(ne, ie)
          ),
          I.thinking && I.thinking.titles.length > 0 && /* @__PURE__ */ r(
            W2,
            {
              titles: I.thinking.titles,
              title: x.ai.thoughtsGroupTitle,
              inProgress: I.thinking.inProgress,
              isWriting: I.thinking.isWriting
            }
          ),
          I.assistantMessages.map(
            (ne, ie) => se(ne, ie)
          ),
          I.endIndicator === "thinking" && /* @__PURE__ */ r(n1, { title: x.ai.thinking, status: "executing" }),
          I.endIndicator === "activity" && /* @__PURE__ */ r(n1, { status: "writing" }),
          I.feedback && /* @__PURE__ */ r(
            z2,
            {
              content: I.feedback.content,
              targetMessage: I.feedback.targetMessage,
              onCopy: A
            }
          ),
          W && /* @__PURE__ */ r(I2, {})
  ...
  return /* @__PURE__ */ c(Re, { children: [
    /* @__PURE__ */ c("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
          ...
          children: /* @__PURE__ */ c(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { ref: U, className: "h-px shrink-0", "aria-hidden": !0 }),
                /* @__PURE__ */ r("footer", { className: "copilotKitMessagesFooter", ref: Z, children: C }),
                /* @__PURE__ */ r(Ee, { children: ee && /* @__PURE__ */ r(
                  re.div,
                  {
      ...
      !m && !S && /* @__PURE__ */ c(Re, { children: [
        /* @__PURE__ */ r(R1, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ r(R1, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    H.isOpen && /* @__PURE__ */ r(
      _2,
...
}, a6 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
...
function D4({
  ...
  return /* @__PURE__ */ r(Mr.Provider, { value: t, children: e });
}
function Z4() {
  const e = Be(Mr);
  if (e === null)
...
const l6 = ({
  ...
  const m = Y().ai.clarifyingQuestion.typeYourAnswer, h = e === "single" ? /* @__PURE__ */ r(Er, { isSelected: n && !t }) : /* @__PURE__ */ r(
    Bt,
    {
      checked: s,
      onCheckedChange: () => f(!s),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          "input",
          {
            ...
            onFocus: d,
            onKeyDown: (C) => {
              C.key === "Enter" && i && (C.preventDefault(), u());
            },
            placeholder: m,
            "aria-label": m,
...
const u6 = ({
  ...
  const M = ke(), A = (() => {
    ...
    const k = n.findIndex((E) => o.includes(E.id));
    return k >= 0 ? k : 0;
  })(), [H, N] = P(A), b = j([]);
  K(() => {
    p && e === "single" && b.current[H]?.focus();
  }, []);
  const x = (k) => {
    if (e !== "single") return;
    const E = n.length - 1;
    ...
    k.preventDefault(), N(V), b.current[V]?.focus();
  };
  return /* @__PURE__ */ c(
    "div",
    {
          ...
          re.div,
          {
            ...
            children: /* @__PURE__ */ r(
              Rr,
              {
                ...
                option: k,
                isSelected: o.includes(k.id),
                mode: e,
                isTabStop: e === "single" ? E === H : void 0,
                onToggle: m,
                onKeyNavigate: x
              }
            )
  ...
  } = s, k = j(null), E = A ?? "single", V = a > 1, S = i === 0, F = i === a - 1, B = V ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  }) : void 0, Z = M.length > 0, U = (b ?? "").trim().length > 0, G = Z || x && U || H === !0, ee = t === !0 && F, X = () => {
    ee || l();
  }, _ = () => {
    ee || f();
  }, q = (se) => {
    const ne = E === "single" && M.includes(se);
    d(se), E === "single" && !F && !ne && Promise.resolve().then(l);
  }, I = F ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, te = H === !0 && !Z && !(x && U), W = () => {
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-col", onKeyDown: ae, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ c(
      re.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: Ce, ease: h6 },
        children: [
          /* @__PURE__ */ r(
            f6,
            {
...
function j1(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), d = Math.min(i + o, s), l = Math.min(d, Math.floor(e / 2)), f = Math.min(d, Math.floor(t / 2)), u = (W) => W / e * 2 - 1, p = (W) => W / t * 2 - 1, m = 0, h = e, C = 0, v = t, w = l, M = e - l, A = f, H = t - f, N = u(m), b = u(h), x = p(C), k = p(v), E = u(w), V = u(M), S = p(A), F = p(H), B = 0, Z = 0, U = 1, G = 1, ee = l / e, X = 1 - l / e, _ = f / t, q = 1 - f / t, I = new Float32Array([
    // Top strip
    N,
    x,
    b,
...
function m6(e, t, n) {
  const o = D1(e, e.VERTEX_SHADER, t), s = D1(e, e.FRAGMENT_SHADER, n), i = e.createProgram();
...
class U4 {
  ...
  resize(t, n, o) {
    ...
    const { gl: s, program: i, vao: a, positionBuffer: d, uvBuffer: l, uResolution: f } = this.glr, u = o ?? this.options.ratio ?? window.devicePixelRatio ?? 1, p = Math.max(1, Math.floor(t * u)), m = Math.max(1, Math.floor(n * u));
    this.canvas.style.width = `${t}px`, this.canvas.style.height = `${n}px`, (this.canvas.width !== p || this.canvas.height !== m) && (this.canvas.width = p, this.canvas.height = m), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
    const { positions: h, uvs: C } = j1(
      this.canvas.width,
      this.canvas.height,
  ...
  setupGL() {
    ...
    const p = t.getAttribLocation(n, "aUV");
    t.enableVertexAttribArray(p), t.vertexAttribPointer(p, 2, t.FLOAT, !1, 0, 0), this.checkGLError(t, "setupGL: after UV buffer setup");
    const m = t.getUniformLocation(n, "uResolution"), h = t.getUniformLocation(n, "uTime"), C = t.getUniformLocation(n, "uBorderWidth"), v = t.getUniformLocation(n, "uGlowWidth"), w = t.getUniformLocation(n, "uBorderRadius"), M = t.getUniformLocation(n, "uColors"), A = t.getUniformLocation(n, "uGlowExponent"), H = t.getUniformLocation(n, "uGlowFactor");
    t.useProgram(n), t.uniform1f(C, this.options.borderWidth), t.uniform1f(v, this.options.glowWidth), t.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (t.uniform1f(A, 2), t.uniform1f(H, 1.8)) : (t.uniform1f(A, 1), t.uniform1f(H, 1));
    const N = (this.options.colors || w6).map(x6);
    for (let b = 0; b < N.length; b++)
      t.uniform3f(
        t.getUniformLocation(n, `uColors[${b}]`),
        ...N[b]
      );
...
const Z1 = ["lowp", "mediump", "highp"], k6 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, L6 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, O1 = "iTime", U1 = "iTimeDelta", z1 = "iDate", G1 = "iFrame", W1 = "iMouse", q1 = "iResolution", b6 = "iChannel", X1 = "iChannelResolution", Y1 = "iDeviceOrientation";
function y6(e, t) {
...
}, r1 = 9729, K1 = 9728, N6 = 9987, Q1 = 33071, J1 = 10497;
class V6 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const p = 0, m = n.RGBA, h = 1, C = 1, v = 0, w = n.RGBA, M = n.UNSIGNED_BYTE, A = new Uint8Array([255, 255, 255, 0]), H = n.createTexture();
    if (n.bindTexture(n.TEXTURE_2D, H), n.texImage2D(
      ...
      const k = this.setupVideo(o);
      return n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_S, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_T, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.LINEAR), this._webglTexture = H, this.source = k, this.isVideo = !0, k.play().then(() => this);
    }
    async function N() {
      return new Promise((k, E) => {
        ...
        V.crossOrigin = "anonymous", V.onload = () => {
          ...
          E(new Error(Le(`failed loading url: ${o}`)));
        }, V.src = o ?? "";
      });
    }
    let b = await N(), x = (b.width & b.width - 1) === 0 && (b.height & b.height - 1) === 0;
    return (t.wrapS !== Q1 || t.wrapT !== Q1 || t.minFilter !== K1 && t.minFilter !== r1) && !x && (b = this.makePowerOf2(b), x = !0), n.bindTexture(n.TEXTURE_2D, H), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, l), n.texImage2D(
      n.TEXTURE_2D,
      p,
      m,
      w,
      M,
      b
    ), x && t.minFilter !== K1 && t.minFilter !== r1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || J1
    ), n.texParameteri(
      ...
      this.magFilter || r1
    ), this._webglTexture = H, this.source = b, this.isVideo = !1, this.isLoaded = !0, this.width = b.width || 0, this.height = b.height || 0, this;
  };
}
const Le = (e) => `react-shaders: ${e}`, et = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, tt = (e, t, n) => e * (1 - n) + t * n, S6 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function T6({
  fs: e,
  vs: t = _1,
  textures: n = [],
  ...
  const h = j(null), C = j(null), v = j(null), w = j(null), M = j(void 0), A = j(void 0), H = j(!1), N = j(void 0), b = j(0), x = j([0, 0]), k = j([]), E = j(0), V = j(void 0), S = j({
    ...
    const R = "width" in y ? y.width ?? 0 : 0, D = "height" in y ? y.height ?? 0 : 0, $ = S.current.iChannelResolution;
    if (!$) return;
    const O = Array.isArray($.value) ? $.value : $.value = [];
    O[T * 3] = R * f, O[T * 3 + 1] = D * f, O[T * 3 + 2] = 0;
  }, Z = () => {
    ...
    y?.bufferData(y.ARRAY_BUFFER, new Float32Array(T), y.STATIC_DRAW);
  }, G = ({
    alpha: y,
    beta: T,
    gamma: R
    ...
    const [T = 0, R = 0] = et(y), D = T - (N.current?.left ?? 0) - window.pageXOffset, $ = (N.current?.height ?? 0) - R - (N.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    const O = Array.isArray(S.current.iMouse?.value) ? S.current.iMouse.value : void 0;
    O && (O[2] = D, O[3] = $), x.current[0] = D, x.current[1] = $;
  }, X = (y) => {
    N.current = h.current?.getBoundingClientRect();
    const [T = 0, R = 0] = et(y), D = T - (N.current?.left ?? 0), $ = (N.current?.height ?? 0) - R - (N.current?.top ?? 0);
    if (l !== 1)
      x.current[0] = D, x.current[1] = $;
    else {
      const O = Array.isArray(S.current.iMouse?.value) ? S.current.iMouse.value : void 0;
      O && (O[0] = D, O[1] = $);
    }
  }, _ = () => {
    const y = Array.isArray(S.current.iMouse?.value) ? S.current.iMouse.value : void 0;
    y && (y[2] = 0, y[3] = 0);
  }, q = () => {
    const y = C.current;
    if (!y) return;
    N.current = h.current?.getBoundingClientRect();
    const T = f, R = Math.floor(
      (N.current?.width ?? 1) * T
    ), D = Math.floor(
      (N.current?.height ?? 1) * T
    );
    if (y.canvas.width = R, y.canvas.height = D, S.current.iResolution?.isNeeded && w.current) {
      const $ = y.getUniformLocation(
        w.current,
        q1
      );
      y.uniform2fv($, [y.canvas.width, y.canvas.height]);
    }
  }, I = (y, T) => {
    const R = C.current;
    if (!R) return null;
    const D = R.createShader(y);
    if (!D) return null;
    if (R.shaderSource(D, T), R.compileShader(D), !R.getShaderParameter(D, R.COMPILE_STATUS)) {
      m?.(Le(`Error compiling the shader:
${T}`));
      const $ = R.getShaderInfoLog(D);
      R.deleteShader(D), p?.(Le(`Shader compiler log: ${$}`));
    }
    return D;
  }, te = (y, T) => {
    const R = C.current;
    if (!R) return;
    const D = I(R.FRAGMENT_SHADER, y), $ = I(R.VERTEX_SHADER, T);
    if (w.current = R.createProgram(), !(!w.current || !$ || !D)) {
      if (R.attachShader(w.current, $), R.attachShader(w.current, D), R.linkProgram(w.current), !R.getProgramParameter(w.current, R.LINK_STATUS)) {
        p?.(
          Le(
      ...
      R.useProgram(w.current), M.current = R.getAttribLocation(
        w.current,
        "aVertexPosition"
      ), R.enableVertexAttribArray(M.current);
    }
  }, W = () => {
    if (o)
      for (const y of Object.keys(o)) {
        const T = o[y];
        if (!T) continue;
        const { value: R, type: D } = T, $ = F6(D);
        if (!$) continue;
        const O = {};
        if (y6(D, R)) {
          const ce = D.length, he = Number.parseInt(D.charAt(ce - 3)), oe = Math.floor(R.length / (he * he));
          R.length > he * he && (O.arraySize = `[${oe}]`);
        } else M6(D, R) && (O.arraySize = `[${Math.floor(R.length / Number.parseInt(D.charAt(0)))}]`);
        S.current[y] = {
          type: $,
          isNeeded: !1,
          value: R,
      ...
      if (n && n.length > 0) {
        ...
        const T = n.map(
          (R, D) => (S.current[`${b6}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(R, D), k.current[D] = new V6(y), k.current[D]?.load(R).then(($) => {
            B($, D);
          }))
        );
        Promise.all(T).then(() => {
    ...
    const T = Z1.includes(i ?? "highp"), R = `precision ${T ? i : Z1[1]} float;
`;
    T || m?.(
      Le(
    ...
    let D = R.concat(`#define DPR ${f.toFixed(1)}
`).concat(y.replace(/texture\(/g, "texture2D("));
    for (const O of Object.keys(S.current))
      if (y.includes(O)) {
        const ce = S.current[O];
        if (!ce) continue;
        D = S6(
          D,
          `uniform ${ce.type} ${O}${ce.arraySize || ""}; 
`,
          D.lastIndexOf(R) + R.length
        ), ce.isNeeded = !0;
      }
    return y.includes("mainImage") && (D = D.concat(k6)), D;
  }, se = (y) => {
    const T = C.current;
    if (!T || !w.current) return;
    const R = E.current ? (y - E.current) / 1e3 : 0;
    E.current = y;
    const D = F.current;
    if (D)
      for (const $ of Object.keys(D)) {
        const O = D[$];
        if (O && S.current[$]?.isNeeded) {
          if (!w.current) return;
          const ce = T.getUniformLocation(
            w.current,
            $
          );
          if (!ce) return;
    ...
    if (S.current.iMouse?.isNeeded) {
      const $ = T.getUniformLocation(
        w.current,
        W1
      );
      T.uniform4fv($, S.current.iMouse.value);
    }
    ...
    if (S.current.iDate?.isNeeded) {
      const $ = /* @__PURE__ */ new Date(), O = $.getMonth() + 1, ce = $.getDate(), he = $.getFullYear(), oe = $.getHours() * 60 * 60 + $.getMinutes() * 60 + $.getSeconds() + $.getMilliseconds() * 1e-3, ye = T.getUniformLocation(
        w.current,
        z1
      );
      T.uniform4fv(ye, [he, O, ce, oe]);
    }
    if (S.current.iFrame?.isNeeded) {
      const $ = T.getUniformLocation(
        w.current,
        G1
      ), O = S.current.iFrame.value;
      T.uniform1i($, O), S.current.iFrame.value = O + 1;
    }
    if (k.current.length > 0)
      for (let $ = 0; $ < k.current.length; $++) {
        const O = k.current[$];
        if (!O) return;
        const { isVideo: ce, _webglTexture: he, source: oe, flipY: ye, isLoaded: Ve } = O;
        if (!Ve || !he || !oe) return;
        if (S.current[`iChannel${$}`]?.isNeeded) {
          if (!w.current) return;
          const Ae = T.getUniformLocation(
            w.current,
            `iChannel${$}`
          );
          T.activeTexture(T.TEXTURE0 + $), T.bindTexture(T.TEXTURE_2D, he), T.uniform1i(Ae, $), ce && O.updateTexture(
            he,
            oe,
            ye
          );
    ...
    const T = C.current;
    if (!T) return;
    T.viewport(0, 0, T.drawingBufferWidth, T.drawingBufferHeight), T.clear(T.COLOR_BUFFER_BIT | T.DEPTH_BUFFER_BIT), T.bindBuffer(T.ARRAY_BUFFER, v.current), T.vertexAttribPointer(
      M.current ?? 0,
      3,
      T.FLOAT,
      !1,
      0,
      0
    ), se(y), T.drawArrays(T.TRIANGLE_STRIP, 0, 4);
    const R = S.current.iMouse?.value;
    if (S.current.iMouse?.isNeeded && l !== 1 && Array.isArray(R)) {
      const D = R[0] ?? 0, $ = R[1] ?? 0;
      R[0] = tt(D, x.current[0] ?? 0, l), R[1] = tt($, x.current[1] ?? 0, l);
    }
    A.current = requestAnimationFrame(ne);
  }, ie = () => {
    const y = { passive: !0 };
    S.current.iMouse?.isNeeded && h.current && (h.current.addEventListener("mousemove", X, y), h.current.addEventListener("mouseout", _, y), h.current.addEventListener("mouseup", _, y), h.current.addEventListener("mousedown", ee, y), h.current.addEventListener("touchmove", X, y), h.current.addEventListener("touchend", _, y), h.current.addEventListener("touchstart", ee, y)), S.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      G,
      y
    ), h.current && (V.current = new ResizeObserver(q), V.current.observe(h.current), window.addEventListener("resize", q, y));
  }, de = () => {
    const y = { passive: !0 };
    S.current.iMouse?.isNeeded && h.current && (h.current.removeEventListener("mousemove", X, y), h.current.removeEventListener("mouseout", _, y), h.current.removeEventListener("mouseup", _, y), h.current.removeEventListener("mousedown", ee, y), h.current.removeEventListener("touchmove", X, y), h.current.removeEventListener("touchend", _, y), h.current.removeEventListener("touchstart", ee, y)), S.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      G,
      y
    ), V.current && (V.current.disconnect(), window.removeEventListener("resize", q, y));
  };
  return K(() => {
    F.current = o;
  }, [o]), K(() => {
    ...
    function T() {
      Z();
      const R = C.current;
      R && h.current && (R.clearColor(...s), R.clearDepth(1), R.enable(R.DEPTH_TEST), R.depthFunc(R.LEQUAL), R.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, W(), ae(), te(Ce(e || L6), t || _1), U(), requestAnimationFrame(ne), ie(), q());
    }
    return requestAnimationFrame(T), () => {
      const R = C.current;
      if (R) {
        if (R.getExtension("WEBGL_lose_context")?.loseContext(), R.useProgram(null), R.deleteProgram(w.current ?? null), y.length > 0)
          for (const D of y)
            R.deleteTexture(D._webglTexture);
        w.current = null;
      }
      de(), cancelAnimationFrame(A.current ?? 0);
    };
  }, []), /* @__PURE__ */ r(
    "canvas",
    {
...
}`, H6 = 10, $6 = 2, B6 = 0.5, I6 = 0.2, P6 = 1.5, me = {
  duration: 0.5,
  ease: "easeOut"
}, rt = {
  duration: 0.35,
...
function j6(e, t) {
  const [n, o] = P(H6), {
    ...
    animate: i,
    motionValue: a
  } = Ue(I6), { value: d, animate: l } = Ue($6), { value: f, animate: u } = Ue(B6), { value: p, animate: m } = Ue(P6), h = Zs(t, {
    fftSize: 512,
  ...
  return K(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        o(10), i(0.2, me), l(1.2, me), u(0.4, me), m(1, me);
        return;
      case "listening":
      case "pre-connect-buffering":
        o(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, me), u(0.7, me), m([1.5, 2], rt);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        o(30), i(0.3, me), l(0.5, me), u(1, me), m([0.5, 2.5], rt);
        return;
      case "speaking":
        o(70), i(0.3, me), l(0.75, me), u(1.25, me), m(1.5, me);
        return;
    }
  }, [
    e,
...
function Fr({
  ...
  const h = J(() => Z6(a), [a]);
  return /* @__PURE__ */ r("div", { ref: u, className: p, ...m, children: /* @__PURE__ */ r(
    T6,
    {
      fs: A6,
...
function z4({
  ...
  const { speed: f, scale: u, amplitude: p, frequency: m, brightness: h } = j6(t, s);
  return /* @__PURE__ */ r(
    Fr,
    {
      ref: d,
...
const G4 = ({
  ...
  const o = Y(), s = ke();
  return /* @__PURE__ */ c(Re, { children: [
    e && /* @__PURE__ */ r("span", { className: L(O6(), "truncate"), children: e }),
    /* @__PURE__ */ r(Ee, { children: n && t && /* @__PURE__ */ r(
      re.div,
      {
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: L(Nr()), children: t }),
    /* @__PURE__ */ c(
      re.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ c("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ r("span", { className: L(ze()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ r(
            ks,
            {
          ...
          o === "alert" && /* @__PURE__ */ r(bs, { text: e.alertLabel, level: e.level }),
          o === "balance" && /* @__PURE__ */ r(G6, { balance: e.balance })
        ]
      }
    ),
    n && !z6.has(o) && /* @__PURE__ */ r(
      re.span,
      {
        className: L(ze()),
        animate: { opacity: s ? 0 : 1 },
...
const X6 = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), Y6 = ({
  label: e,
  direction: t
}) => {
  const n = Vr[t];
  ...
  const s = `sparkline-gradient-${ct().replace(/:/g, "")}`, i = q6(e, n), a = Vr[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ms, { width: "100%", height: "100%", children: /* @__PURE__ */ c(
          Es,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ r(Rs, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                Fs,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ r(Y6, { label: t, direction: i })
      ]
    }
  ) });
}, Sr = g(
  (e, t) => {
    const {
      ...
      className: l,
      ...f
    } = e, [u, p] = P(!1), [m, h] = P(!1), C = u || m, v = ke(), w = C && !!d, M = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, A = () => {
      a?.();
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: L(Nr()), children: o }),
              /* @__PURE__ */ r(
                re.div,
                {
...
Sr.displayName = "F0AiInsightCardInternal";
const Q6 = ["className"], Tr = g((e, t) => {
  const n = Q6.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
  return /* @__PURE__ */ r(Sr, { ref: t, ...n });
});
Tr.displayName = "F0AiInsightCard";
const J6 = () => /* @__PURE__ */ c(
  "div",
  {
  ...
  "balance",
  "sparkline"
], Ar = 180, e4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Ar, t4 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, r4 = (e) => e.showActions !== !1, n4 = (e) => Object.fromEntries(
...
function o4(e) {
  const {
    ...
    description: i,
    seeMoreLabel: a,
    maxCollapsedDescriptionLength: d = Ar
  } = e, [l, f] = P(!1), u = ct(), p = j(null), m = e4(
    d
  ), h = i.length > m, C = l ? i : t4(i, m), v = r4(e) ? e : null, w = n4(e);
  return K(() => {
    l && p.current?.focus();
  }, [l]), /* @__PURE__ */ c(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          t && /* @__PURE__ */ r(St, { module: t, size: "md" }),
...
const s4 = ({
  ...
  return /* @__PURE__ */ c(
    At,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ c(Ht, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
          /* @__PURE__ */ r("span", { className: "mr-2 *:block", children: /* @__PURE__ */ r(fe, { icon: e, className: "block" }) }),
...
}, i4 = (e) => ll[e] ?? vt, a4 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(fe, { icon: i4(e), size: "md", color: "default" }) }) : null;
function c4({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(s4, { icon: l1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(a4, { iconName: s.icon });
...
function d4({
  ...
  const o = Y(), s = j(null), i = t ?? o.ai.aiTable.title, a = z(
    (d) => {
      if (!s.current) return;
  ...
  return e.columns?.length ? /* @__PURE__ */ c(
    t1,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r(t1, { overflowX: "auto", children: /* @__PURE__ */ c(
          "table",
          {
            ref: s,
            className: L(
              ...
              /* @__PURE__ */ r("tbody", { children: e.rows.map((d, l) => /* @__PURE__ */ r("tr", { children: e.columns.map((f) => {
                ...
                return /* @__PURE__ */ r(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ r(le, { children: u == null ? "" : String(u) })
                  },
                  f
                );
              }) }, l)) })
...
function u4({ credits: e, trigger: t }) {
  const n = Y(), [o, s] = P(!1), [i, a] = P(!1), [d, l] = P(!1), [f, u] = P(null), p = z(
    (C) => {
      s(C), C && e?.fetchUsage && (a(!0), l(!1), e.fetchUsage().then((v) => {
        u(v), l(!1);
      }).catch(() => {
        l(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const m = f ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, h = e.companyName;
  return /* @__PURE__ */ c(u1, { open: o, onOpenChange: p, children: [
    /* @__PURE__ */ r(f1, { asChild: !0, children: t ?? /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
        hideLabel: !0,
        ...
        children: [
          h && /* @__PURE__ */ c("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            ...
            /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ r(le, { tag: "span", className: "font-medium", children: e.companyName ?? "" }),
          ...
          /* @__PURE__ */ c("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: [
            /* @__PURE__ */ c("div", { className: "flex flex-col gap-2 p-3", children: [
              i && /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
...
function h4({
  ...
  const n = Y(), o = ke(), [s, i] = P(!1), [a, d] = P(!1), [l, f] = P(!1), [u, p] = P(null), m = z(
    (w) => {
      i(w), w && e?.fetchUsage && (d(!0), f(!1), e.fetchUsage().then((M) => {
        p(M), f(!1);
      }).catch(() => {
        f(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const h = !!e.companyName, C = u && u.total > 0 ? Math.min(100, Math.round(u.used / u.total * 100)) : 0, v = u ? Math.max(0, u.total - u.used) : 0;
  return /* @__PURE__ */ c(u1, { open: s, onOpenChange: m, children: [
    /* @__PURE__ */ r(f1, { asChild: !0, children: t ?? /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
      ...
      h1,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2 p-3", children: [
            ...
            l && /* @__PURE__ */ r("span", { className: "text-sm text-f1-foreground-secondary", children: n.t("ai.credits.creditsError") }),
            !a && !l && u && /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ c("div", { className: "flex justify-between", children: [
...
const s1 = ({
...
) : e ? /* @__PURE__ */ r(u4, { credits: e, trigger: n }) : null, X4 = s1, Y4 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const h = Y(), C = Ss(`(max-width: ${Ts.md}px)`, {
    ...
    ue,
    {
      variant: "ghost",
      hideLabel: !0,
      label: o ? h.ai.collapseChat : h.ai.expandChat,
      icon: o ? kt : wt,
      onClick: i
    }
  ), w = /* @__PURE__ */ r(
      ...
      children: [
        /* @__PURE__ */ r(
          le,
          {
            ...
            children: n ?? h.ai.newConversation
          }
        ),
        /* @__PURE__ */ c(
          re.div,
        ...
        /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ r(
          $e,
          {
            ...
            children: /* @__PURE__ */ c("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ r(le, { lines: 1, className: "min-w-0 text-left", children: n ?? h.ai.newConversation }),
              /* @__PURE__ */ r(fe, { icon: a1, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ c(
...
function g4() {
  if (!(typeof navigator > "u"))
    return $s(navigator.language);
}
function p4(e) {
  const t = new Date(e), n = /* @__PURE__ */ new Date();
  return It(t) ? "today" : Pt(t) ? "yesterday" : Hs(t, n) ? "thisMonth" : "older";
}
function m4(e, t) {
  const n = new Date(e), o = g4(), s = F1(n, "p", { locale: o });
  if (It(n)) return `${t.today}, ${s}`;
  if (Pt(n)) return `${t.yesterday}, ${s}`;
  const i = !As(n, /* @__PURE__ */ new Date());
  return `${F1(n, i ? "MMM d yyyy" : "MMM d", {
    locale: o
  })}, ${s}`;
}
function C4(e) {
...
function v4({
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      onKeyDown: (m) => {
        (m.key === "Enter" || m.key === " ") && (m.preventDefault(), s(e.id, e.title));
      },
      children: [
        /* @__PURE__ */ c(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ r(le, { lines: 1, className: "py-0.5 text-left font-medium", children: e.title }),
        ...
        o ? (
          ...
          /* @__PURE__ */ r(
            "div",
            {
              ...
              children: /* @__PURE__ */ r(Bs, { size: "small" })
            }
          )
        ) : /* @__PURE__ */ r(
          "div",
          {
            ...
            children: /* @__PURE__ */ r(g1, { items: u, children: /* @__PURE__ */ r(
              ue,
              {
                icon: Ct,
                variant: "ghost",
...
const ot = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], w4 = ({ width: e }) => /* @__PURE__ */ r("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ r(ge, { className: L("h-4 rounded", e) }) }), st = ({
  titleWidth: e,
  rows: t
}) => /* @__PURE__ */ c("div", { className: "flex flex-col gap-0.5", children: [
  /* @__PURE__ */ r("div", { className: "flex items-center p-1.5", children: /* @__PURE__ */ r(ge, { className: L("h-3 rounded", e) }) }),
  t.map((n, o) => /* @__PURE__ */ r(w4, { width: n }, o))
] });
function x4() {
  return /* @__PURE__ */ c("div", { "aria-hidden": "true", className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ r(st, { titleWidth: "w-12", rows: ot.slice(0, 2) }),
    /* @__PURE__ */ r(st, { titleWidth: "w-24", rows: ot })
  ] });
}
const K4 = ({
  onClose: e,
  ...
  const h = J(
    ...
    return o.filter((k) => k.title.toLowerCase().includes(x));
  }, [o, p]), v = J(
    () => C.filter((x) => a.has(x.id)),
    [C, a]
  ), w = J(
    () => C.filter((x) => !a.has(x.id)),
    [C, a]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ c("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ r(fe, { icon: l1, color: "secondary", size: "md" }),
                  /* @__PURE__ */ r(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ r(
                    $e,
                    {
                      ...
                      children: /* @__PURE__ */ c("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ r(fe, { icon: C1, color: "default", size: "md" }),
                        /* @__PURE__ */ r(le, { lines: 1, className: "text-left", children: u.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ r(x4, {}),
                  !s && i && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: i }),
                  !s && !i && !b && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: u.ai.noPreviousChats }),
...
function Q4({
  ...
  const [i, a] = P([]), [d, l] = P(!1), [f, u] = P(null), [p, m] = P(k4), [h, C] = P(() => /* @__PURE__ */ new Set()), v = z(async () => {
    l(!0), u(null);
    try {
      const x = await t();
      a(x);
  ...
  const w = z((x, k) => {
    m((E) => {
      if (k === E.has(x)) return E;
      const V = new Set(E);
      return k ? V.add(x) : V.delete(x), it(V), V;
    });
  }, []), M = z((x, k) => {
    C((E) => {
      if (k === E.has(x)) return E;
      const V = new Set(E);
      return k ? V.add(x) : V.delete(x), V;
    });
  }, []), A = z(
    (x, k) => {
      const E = k ? o : s;
      w(x, k), E && (M(x, !0), E(x).catch(() => w(x, !k)).finally(() => M(x, !1)));
    },
    [o, s, w, M]
  ), H = z((x) => A(x, !0), [A]), N = z(
    (x) => A(x, !1),
    ...
    async (x) => {
      M(x, !0);
      try {
        await n(x), a((k) => k.filter((E) => E.id !== x)), m((k) => {
          if (!k.has(x)) return k;
          const E = new Set(k);
          return E.delete(x), it(E), E;
        });
      } catch {
        v();
      } finally {
...
const L4 = re.create(js), b4 = ({
  ...
  const { t: i } = Y(), a = ke(), d = n ?? i("ai.applyingChanges");
  return K(() => {
    if (!t) return;
    const l = document.activeElement;
    l && l.getAttribute("name") !== "one-ai-input" && l.blur();
  }, [t]), /* @__PURE__ */ c("div", { className: L("relative flex flex-1 flex-col", o), children: [
    ...
    /* @__PURE__ */ r(
      re.div,
      {
        ...
        initial: { opacity: 0, scale: a ? 1 : 0.95 },
        animate: { opacity: 1, scale: 1 },
        exit: { opacity: 0, scale: a ? 1 : 0.95 },

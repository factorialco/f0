...
import { I as s, M as c, N as l, O as u, R as d, S as f, Tt as p, f as m, i as h, r as ee, yt as g, z as te } from "./F0Button-BFtTqm8n.js";
import { n as _, t as v } from "./utils-CVzxZnoI.js";
import { St as y, c as ne, ot as b } from "./F0Checkbox-B2ZT94HT.js";
import { d as x, f as S, t as C, u as w, y as T } from "./F0Card-SSGaEK9S.js";
import { S as re, a as E } from "./progress-BJOpxq7D.js";
...
var ie = M((e, t) => /* @__PURE__ */ H("svg", {
	...
	return /* @__PURE__ */ V("div", {
		ref: a,
		className: v("rich-text-display-container", !s && "whitespace-pre-wrap", t),
		dangerouslySetInnerHTML: { __html: o },
		...i
	});
}), U = p("F0RichTextDisplay", se), ce = U, W = "f0:widget-drag-start", le = "f0:widget-drag-end";
//#endregion
...
var de = j(null), fe = "ONE-ai-chat-width", pe = 150, me = "ONE-ai-chat-open", he = "ONE-ai-chat-visualization-mode", ge = "ONE-ai-chat-panel-content-id", _e = 300, ve = 712, ye = 5e3, be = (e) => e === "sidepanel" || e === "fullscreen", xe = () => {}, Se = ({ children: e, enabled: t, side: n = "right", panelContentSide: r, agent: i, initialMessage: a, chatHeader: o, chatMessages: s, chatInput: c, chatOverlay: l, welcomeScreenSuggestions: u = [], welcomeScreenCards: d = [], disclaimer: p, resizable: m = !1, defaultVisualizationMode: h = "sidepanel", lockVisualizationMode: ee = !1, historyEnabled: g = !1, footer: te, VoiceMode: _, entityRefs: v, canvasActions: y, canvasEntities: ne, credits: b, employeeCredits: x, creditWarning: S, fileAttachments: C, onTranscribe: w, onThumbsDown: T, onThumbsUp: re, tracking: E }) => {
	let [D, O] = z(te), [k, A] = z(t), [j, M] = q(fe, 360, (e) => typeof e == "number" && !isNaN(e) && e >= _e && e <= ve, void 0, pe), [P, I] = z(!1), [L, B] = q(me, h === "fullscreen", (e) => typeof e == "boolean"), [H, ie] = q(he, h === "canvas" ? "sidepanel" : h, (e) => e === "sidepanel" || e === "fullscreen", be), [ae, oe] = z("chat"), [se, U] = z(() => H !== "fullscreen"), [ce, W] = z(i), [le, G] = z(u), [ue, K] = z(d), xe = f(), [Se, Ce] = z([xe.t("ai.inputPlaceholder")]), [we, Te] = z(a);
	F(() => {
		L && E?.onVisibility?.();
	}, [L]);
...
var Ke = ({ onClose: e }) => {
	let t = f(), n = u(), r = R(null), i = R(null), a = R(null), o = R(null), [c, l] = z(null), d = R(/* @__PURE__ */ new Set()), p = R({
		x: 0,
		y: 0,
		vx: 0,
		vy: 0,
		speed: Z
	}), m = R(0), h = R(0), g = R(0), te = R({
		player: 0,
		ai: 0
	}), _ = R("countdown"), y = R(0), ne = R(0), b = R([]), x = R(0), S = R(0), C = R({
		width: 0,
		height: 0
		...
		p.current.vx = t * r, p.current.vy = n * r, p.current.speed = e, _.current = "playing", le("playing"), j.current = null, ve(null);
	}, []), xe = N(() => {
		ye(), _.current = "countdown", le("countdown"), ue(3);
		...
		let r = { ...te.current };
		if (n === "player" ? r.player++ : r.ai++, te.current = r, se(r), w.current = 8, j.current = n, ve(n), D.current = Math.min(11, D.current + Re), n === "player" && Se(), r.player >= 3 || r.ai >= 3) {
			_.current = "gameover", le("gameover"), ye(), ge(r.player >= 3 ? t.ai.pong.youWin : t.ai.pong.youLose), setTimeout(() => e(), 2e3);
			return;
		}
		_.current = "scored", le("scored"), ye(), y.current = ze, setTimeout(() => {
			_.current === "scored" && xe();
		}, ze);
	}, [
		ye,
	...
	if (F(() => {
		...
		let t = (t) => {
			t.key === "Escape" && e(), (t.key === "ArrowLeft" || t.key === "ArrowRight") && (t.preventDefault(), d.current.add(t.key));
		}, n = (e) => {
			d.current.delete(e.key);
		};
		...
		let n = t.width / 2;
		m.current = n, h.current = n, g.current = n, te.current = {
			player: 0,
			ai: 0
		}, se({
			player: 0,
		...
		let o = (e) => {
			...
			if (d.current.has("ArrowLeft") && (m.current = $(m.current - Fe * n, s / 2 + X, r - s / 2 - X)), d.current.has("ArrowRight") && (m.current = $(m.current + Fe * n, s / 2 + X, r - s / 2 - X)), w.current > 0 && (w.current *= .85, w.current < .5 && (w.current = 0)), _.current === "playing") {
				b.current.push({
					x: a.x,
					y: a.y
					...
					children: [/* @__PURE__ */ H("div", {
						...
						children: [
							...
							W === "scored" && _e && /* @__PURE__ */ V("div", {
								className: v("pointer-events-none absolute left-4 flex items-center", _e === "player" ? "top-1/2 mt-4" : "bottom-1/2 -mt-4"),
								children: /* @__PURE__ */ V("span", {
						...
						children: /* @__PURE__ */ H("div", {
							...
							children: [/* @__PURE__ */ V("span", {
								className: v("text-2xl font-semibold", oe.ai > 0 ? "text-f1-foreground-secondary" : "text-f1-foreground-disabled"),
								children: oe.ai
							}), /* @__PURE__ */ V("span", {
								className: v("text-2xl font-semibold", oe.player > 0 ? "text-f1-foreground-secondary" : "text-f1-foreground-disabled"),
								children: oe.player
							})]
						})
					})]
	...
	return F(() => {
		...
		className: v("group relative z-10 h-full flex-shrink-0 cursor-ew-resize w-1", i && "border border-solid border-x-0 border-f1-border-secondary bg-f1-special-page"),
		onMouseDown: l,
		onDoubleClick: u,
		children: [/* @__PURE__ */ V("div", {
			...
			"aria-hidden": !0,
			className: v("pointer-events-none absolute inset-y-0 left-1/2 -translate-x-1/2 rounded-full", "transition-[width,background-color] duration-150 ease-out", "w-px bg-transparent", "group-hover:w-1 group-hover:bg-f1-background-secondary-hover", n && "!w-1 !bg-f1-background-secondary-hover")
		})]
	});
}, Je = ({ children: e, visible: t, side: n, exitStyle: r = "shrink", acceptsWidgetDrop: i = !1 }) => {
	let { open: a, visualizationMode: o, shouldPlayEntranceAnimation: s, setShouldPlayEntranceAnimation: c, resizable: d, setChatWidth: f, resetChatWidth: p, setIsResizing: m, fileAttachments: h, isClarifying: ee, fileDragOver: _, setFileDragOver: y, processDroppedFiles: b, setPendingQuote: x, focusChatInput: S, activeGame: C, closeGame: w, panelSide: T } = J(), re = t ?? a, E = i && C === null && re && !ee, D = R(E);
	D.current = E;
	let O = R(null), k = o === "canvas", A = u(), j = (n ?? T) === "left", M = R(!1);
	F(() => {
		M.current = a;
	});
	let P = R(0), I = h?.onUploadFiles != null && !ee;
	F(() => {
	...
	return /* @__PURE__ */ V(g, { children: re && /* @__PURE__ */ H(te.div, {
		className: v("bg-f1-transparent pointer-events-auto relative flex h-full dark:bg-f1-background md:py-1", K ? "md:pr-1" : j ? "mr-auto" : "ml-auto md:pr-1"),
		...
		children: [
			...
			/* @__PURE__ */ H("div", {
				ref: O,
				"aria-hidden": !re,
				className: v("relative flex h-full w-full flex-col overflow-hidden bg-f1-special-page border border-solid border-f1-border-secondary", k && (j ? "border-r-transparent" : "border-l-transparent"), k ? j ? "xs:rounded-l-xl" : "xs:rounded-r-xl" : "xs:rounded-xl"),
				...
				children: [
					...
					C === "pong" && /* @__PURE__ */ V(Ke, { onClose: w })
				]
			}),
			d && !K && !fe && j && /* @__PURE__ */ V(qe, {
				onResize: pe,
	...
	onTranscribe: x,
	children: w
}), Xe = p("F0AiChat", ({ header: e, messages: t, input: n, overlay: r }) => {
	let { enabled: i, open: a, setOpen: o, mode: s, visualizationMode: c, VoiceMode: l, tracking: d, chatHeader: p, chatMessages: ee, chatInput: _, chatOverlay: v, panelContent: y, panelSide: ne, panelContentSide: b, restoringPanelContentId: x } = J(), S = f(), C = b !== ne, { motionProps: w } = G(c === "fullscreen" ? "fullscreen" : "docked", (e, t) => t === "fullscreen" ? 220 : 460), T = u(), E = e ?? p, D = t ?? ee, O = n ?? _, k = r ?? v;
	if (!i) return null;
	let A, j;
	return y && !C ? (A = `panel:${y.id}`, j = y.content) : x && !C ? (A = `restoring:${x}`, j = /* @__PURE__ */ V(m, {
		role: "status",
		"aria-busy": !0,
...
function Qe({ children: e, ...t }) {
	return /* @__PURE__ */ V("pre", {
		...t,
		className: v("relative mx-0 overflow-x-auto whitespace-pre-wrap rounded-md bg-f1-background-secondary p-2", t.className),
		children: e
	});
}
function $e({ children: e, ...t }) {
	return /* @__PURE__ */ V("code", {
		...t,
		className: v("rounded bg-f1-background-secondary px-1 py-0.5 font-mono text-base text-f1-foreground", "[pre_&]:rounded-none [pre_&]:bg-transparent [pre_&]:p-0 [pre_&]:text-base", t.className),
		children: e
	});
}
function et({ children: e, ...t }) {
	return /* @__PURE__ */ V("blockquote", {
		...t,
		className: v("mr-1 my-2 mb-2.5 border-0 border-l-4 border-solid border-f1-border pl-3 text-base", t.className),
		children: e
	});
}
function tt({ ...e }) {
	return /* @__PURE__ */ V("hr", {
		...e,
		className: v("my-3 border-0 border-t border-f1-border", e.className)
	});
}
//#endregion
...
function nt({ src: e, alt: t, ...n }) {
	...
	return /* @__PURE__ */ H("div", {
		...
		children: [/* @__PURE__ */ V("img", {
			...
			src: e,
			alt: t,
			className: v("max-w-full rounded-md", n.className)
		}), /* @__PURE__ */ V("div", {
...
function it({ children: e, ...t }) {
	return /* @__PURE__ */ V("ul", {
		...t,
		className: v("list-disc pl-5 [&>li>ol]:mt-2 [&>li>ul]:mt-2", t.className),
		children: e
	});
}
function at({ children: e, ...t }) {
	return /* @__PURE__ */ V("ol", {
		...t,
		className: v("list-decimal pl-5 [&>li>ol]:mt-2 [&>li>ul]:mt-2", t.className),
		children: e
	});
}
	...
	return /* @__PURE__ */ H("div", {
		...
		children: [/* @__PURE__ */ H("div", {
			...
			children: /* @__PURE__ */ V("table", {
				ref: i,
				...n,
				className: v("w-full border-separate border-spacing-0 [&_tbody_tr:last-child_td]:border-b-0", n.className),
				children: e
			})
		})]
	});
...
function lt({ children: e, ...t }) {
	return /* @__PURE__ */ V("th", {
		...t,
		className: v("sticky top-0 z-10 whitespace-nowrap border-0 border-b border-solid border-f1-border-secondary bg-f1-background px-3 py-2 text-left font-medium text-f1-foreground-secondary", t.className),
		children: e
	});
}
function ut({ children: e, ...t }) {
	return /* @__PURE__ */ V("td", {
		...t,
		className: v("max-w-80 truncate border-0 border-b border-solid border-f1-border-secondary px-3 py-2", t.className),
		children: e
	});
}
//#endregion
...
function dt({ children: e, ...t }) {
	return /* @__PURE__ */ V("p", {
		...t,
		className: v("text-base font-normal", t.className),
		children: e
	});
}
function ft({ children: e, ...t }) {
	return /* @__PURE__ */ V("h1", {
		...t,
		className: v("mb-2.5 mt-4 text-2xl font-medium first:mt-0 last:mb-0", t.className),
		children: e
	});
}
function pt({ children: e, ...t }) {
	return /* @__PURE__ */ V("h2", {
		...t,
		className: v("mb-2.5 mt-4 text-lg font-medium leading-6 first:mt-0 last:mb-0", t.className),
		children: e
	});
}
function mt({ children: e, ...t }) {
	return /* @__PURE__ */ V("h3", {
		...t,
		className: v("mb-2 mt-3.5 text-base font-semibold first:mt-0 last:mb-0", t.className),
		children: e
	});
}
function ht({ children: e, ...t }) {
	return /* @__PURE__ */ V("strong", {
		...t,
		className: v("font-semibold", t.className),
		children: e
	});
}
function gt({ children: e, ...t }) {
	return /* @__PURE__ */ V("em", {
		...t,
		className: v("italic", t.className),
		children: e
	});
}
//#endregion
...
var vt = M(({ label: e, ...t }, n) => /* @__PURE__ */ V("button", {
	ref: n,
	type: "button",
	className: v("cursor-pointer font-medium text-f1-foreground-secondary hover:text-f1-foreground", _()),
	...t,
	children: e
}));
vt.displayName = "CandidateTrigger";
function yt({ id: e, label: t }) {
	let { entityRefs: n } = J(), r = n?.resolvers?.candidate, i = f(), a = n?.urls?.candidate?.(e), o = L(() => (e) => {
		let t = [];
...
function xt({ id: e, label: t }) {
	let { entityRefs: n } = J(), r = n?.resolvers?.expense, i = f(), a = n?.urls?.expense?.(e), o = L(() => (e) => ({
		avatar: {
			type: "icon",
			icon: ae
		},
...
function Ct({ id: e, label: t }) {
	let { entityRefs: n } = J(), r = n?.resolvers?.jobPosting, i = f(), a = n?.urls?.jobPosting?.(e), o = L(() => (e) => ({
		title: e.title,
...
function Et({ id: e, label: t }) {
	let { entityRefs: n } = J(), r = n?.resolvers?.requisition, i = f(), a = n?.urls?.requisition?.(e), o = L(() => (e) => {
...
function Ot({ id: e, label: t }) {
	let { entityRefs: n } = J(), r = n?.resolvers?.person, i = f(), a = n?.urls?.person?.(e), o = L(() => (e) => ({
		avatar: {
			type: "person",
			firstName: e.firstName,
			lastName: e.lastName,
...
function At({ id: e, label: t }) {
	let { entityRefs: n } = J(), r = n?.resolvers?.vacancy, i = f(), a = n?.urls?.vacancy?.(e), o = L(() => (e) => ({
		title: e.name,
...
function Gt({ anchor: e, onReply: t }) {
	...
	return B(/* @__PURE__ */ V("div", {
		...
		className: v("z-50 rounded-md bg-f1-background p-1 border border-solid border-f1-border-secondary", "drop-shadow"),
		children: /* @__PURE__ */ V(h, {
			ref: r,
			type: "button",
			variant: "ghost",

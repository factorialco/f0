...
import { useInsertionEffect as Bn, forwardRef as C, createElement as _e, useRef as $, useMemo as te, useEffect as K, useState as P, useLayoutEffect as Ot, useCallback as X, createContext as a1, useContext as Ge, useId as Zt } from "react";
import { cb as $n, cc as In, cd as Pn, ce as jn, cf as Ut, cg as Dn, ch as _n, ci as On, cj as Zn, ck as Un, cl as zt, cm as zn, cn as Gn, co as Wn, cp as qn, cq as Xn, cr as Yn, cs as Kn, ct as r1, cu as Qn, cv as Jn, cw as eo, cx as to, cy as ro, cz as no, W as Gt, cA as oo, cB as so, cC as io, cD as ao, cE as co, cF as Wt, cG as lo, cH as uo, a3 as T1, cI as fo, aG as ho, cJ as go, cK as po, cL as mo, ad as Co, cM as vo, bJ as wo, a7 as A1, aa as xo, cN as ko, b7 as H1, _ as qt, N as c1, cO as Xt, b6 as bo, cP as Lo, cQ as yo, a$ as Mo, bI as Eo, Y as Me, ar as Ro, bb as Yt, cR as No, bG as Kt, cS as Ne, bC as Fo, cT as So, cU as Qt, a_ as Jt, cV as Vo, cW as To, cX as Ao, cY as Ho, cZ as Bo, c_ as er, bu as $o, bv as Io, c$ as Po, d0 as jo, d1 as Do, d2 as _o, d3 as Oo, d4 as Zo, d5 as Uo, d6 as zo, d7 as Go, d8 as Wo, d9 as qo, da as Xo, db as Yo, bH as Ko, a8 as Qo, bq as Jo, dc as es, dd as ts, de as rs, df as ns, dg as os, dh as ss, di as is, am as as, dj as tr, J as cs, Z as ls, dk as rr, dl as ds, ba as us, b9 as fs, dm as hs, dn as nr, dp as gs, aZ as ps, av as ms, dq as Cs, ap as vs, b4 as ws, dr as or, b3 as xs, ds as ks, bf as B1, dt as bs, du as $1, bE as Ls, bD as ys, bF as sr, dv as Ms, z as Es, y as Rs, dw as Ns, dx as Fs, dy as Ss, dz as Vs, dA as Ts, dB as ir, dC as As, a9 as Hs, dD as Bs, H as he, o as Se, m as M, ab as fe, dE as $s, bk as Is, bx as Ps, w as ar, dF as js, a2 as l1, bW as Ds, aq as _s, M as Ce, C as ce, a5 as cr, ac as lr, bl as dr, dG as Os, aY as ur, s as ve, dH as Zs, dI as Us, S as ge, u as ee, c9 as fr, $ as zs, dJ as Gs, aM as Le, A as Fe, n as oe, aA as I1, dK as Ws, aB as P1, aC as j1, b as Ee, dL as qs, by as Xs, O as Ys, dM as Ks, dN as Qs, dO as Js, dP as Q1, a0 as ei, ah as hr, aP as gr, dQ as ti, bV as ri, dR as ni, dS as oi, aU as pr, dT as si, bP as ii, dU as ai, aR as ze, bd as mr, dV as Cr, be as vr, dW as wr, dX as ci, bh as li, dY as di, b5 as D1, br as ui, dZ as fi, d_ as hi, d$ as gi, e0 as pi, e1 as mi, x as Ci, e2 as xr, e3 as kr, e4 as vi, ag as J1, e5 as wi, af as xi, e6 as ki, e7 as bi } from "./F0CanvasPanel-CRF8oTKE.js";
import { createPortal as br } from "react-dom";
import { defaultTranslations as Li } from "./i18n-provider-defaults.js";
import { useTrackVolume as yi } from "@livekit/components-react";
import './useChatHistory.css';function Mi(e, t, n) {
  Bn(() => e.on(t, n), [e, t, n]);
}
function _1(e) {
...
function Lr(e, t, n, o) {
  return typeof e == "string" && _1(t) ? $n(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Ei(e, t, n) {
  return e * (t + 1);
}
...
function yr(e, t) {
  return In(e) ? e[Ri(0, e.length, t)] : e;
}
function Ni(e, t, n) {
  for (let o = 0; o < e.length; o++) {
    const s = e[o];
    s.at > t && s.at < n && (jn(e, s), o--);
  }
}
...
const Ti = "easeInOut", Ai = 20;
function Hi(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let g = 0; g < e.length; g++) {
    ...
    if (typeof p == "string") {
      ...
      f.set(p.name, et(h, p.at, u, f));
      continue;
    }
    let [w, v, x = {}] = p;
    x.at !== void 0 && (h = et(h, x.at, u, f));
    let S = 0;
    const N = (R, E, L, V = 0, b = 0) => {
      const T = Bi(R), { delay: k = 0, times: y = Dn(T), type: A = "keyframes", repeat: j, repeatType: _, repeatDelay: Z = 0, ...G } = E;
      let { ease: q = t.ease || "easeOut", duration: U } = E;
      const z = typeof k == "function" ? k(V, b) : k, O = T.length, J = Zn(A) ? A : s?.[A];
      if (O <= 2 && J) {
        let se = 100;
        if (O === 2 && Pi(T)) {
          const ue = T[1] - T[0];
      ...
      if (le > 0 && On(y, le), T.length === 1 && T.unshift(null), j) {
        zt(j < Ai, "Repeat count too high, must be less than 20"), U = Ei(U, j);
        const se = [...T], re = [...y];
        ...
        for (let ue = 0; ue < j; ue++) {
          ...
          for (let F = 0; F < se.length; F++)
            y.push(re[F] + (ue + 1)), q.push(F === 0 ? "linear" : yr(ie, F - 1));
        }
        Si(y, j);
      }
      const de = Y + U;
      Fi(L, T, q, y, Y, de), S = Math.max(z + U, S), m = Math.max(de, m);
    };
    if (Ut(w)) {
      const R = tt(w, l);
      N(v, x, rt("default", R));
    } else {
      const R = Lr(w, v, o, c), E = R.length;
      for (let L = 0; L < E; L++) {
        v = v, x = x;
        const V = R[L], b = tt(V, l);
        for (const T in v)
          N(v[T], $i(x, T), rt(T, b), L, E);
      }
    }
    u = h, h += S;
  }
  return l.forEach((g, p) => {
    for (const w in g) {
      ...
      for (let E = 0; E < v.length; E++) {
        ...
        x.push(V), S.push(zn(0, m, L)), N.push(b || "easeOut");
      }
      S[0] !== 0 && (S.unshift(0), x.unshift(x[0]), N.unshift(Ti)), S[S.length - 1] !== 1 && (S.push(1), x.push(null)), a.has(p) || a.set(p, {
        keyframes: {},
        transition: {}
      });
      const R = a.get(p);
...
const Ii = (e) => typeof e == "number", Pi = (e) => e.every(Ii);
function ji(e, t) {
  return e in t;
}
class Di extends Gn {
...
function Zi(e, t) {
  return Ut(e) || typeof e == "number" || typeof e == "string" && !_1(t);
}
function Mr(e, t, n, o) {
  const s = [];
  if (Zi(e, t))
    s.push(Qn(e, _1(t) && t.default || t, n && (n.default || n)));
  else {
    const i = Lr(e, t, o), a = i.length;
    zt(!!a, "No valid elements provided.");
    for (let l = 0; l < a; l++) {
      const c = i[l], f = c instanceof Element ? _i : Oi;
      r1.has(c) || f(c);
      const u = r1.get(c), h = { ...n };
      "delay" in h && typeof h.delay == "function" && (h.delay = h.delay(l, a)), s.push(...Jn(u, { ...t, transition: h }, {}));
    }
  }
  return s;
}
function Ui(e, t, n) {
  const o = [];
  return Hi(e, t, n, { spring: eo }).forEach(({ keyframes: i, transition: a }, l) => {
    o.push(...Mr(l, i, a));
  }), o;
}
class zi {
...
function qi(e) {
  function t(n, o, s) {
    let i = [];
    return Wi(n) ? i = Ui(n, o, e) : i = Mr(n, o, s, e), new Gi(i);
  }
  return t;
}
const Xi = qi(), Yi = (e, t) => /* @__PURE__ */ d(
  "svg",
  {
...
const k5 = (e, t) => /* @__PURE__ */ d(
...
), i2 = C(s2), a2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Ki,
  Add: to,
  Ai: ro,
  ...
  DropdownOpen: So,
  Ellipsis: Qt,
  EllipsisHorizontal: Jt,
  Envelope: Vo,
  EnvelopeOpen: Lc,
  Equal: To,
  EqualApproximately: Ao,
  EqualGreater: Ho,
  EqualLess: Bo,
  Exit: Mc,
  ExternalLink: er,
  ...
  FaceNeutral: jo,
  FacePositive: Do,
  FaceSuperNegative: _o,
  FaceSuperPositive: Oo,
  Feed: Rc,
  File: Fc,
  FileFilled: Vc,
  FileSigned: Ac,
  ...
  Wifi: i2,
  Windows: Bs
}, Symbol.toStringTag, { value: "Module" })), c2 = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ r(
    he,
    {
      ...
      variant: "ai",
      ref: t,
      iconRotate: e.icon == l2
    }
  );
});
Br.displayName = "AIButton";
const je = Se({
  ...
  ({
    ...
    const h = s ?? u2[t ?? "body"], m = c ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (i !== void 0) {
      ...
      return m ? _e(
        ...
        fe,
        {
          ...
          noTooltip: a,
          tag: h,
          className: M(je({ variant: t, align: n }), o),
          markdown: l,
          ...f,
          children: e
        }
...
const N2 = Se({
  ...
  ({
    ...
    const Pe = O && O !== "none" || J && J !== "none" || Y && Y !== "none" || le && le !== "none", qe = z && z !== "none" || Pe, g1 = { sm: d1, md: u1, lg: We, xl: f1 }, p1 = F2.map((Xe) => {
      const Ye = g1[Xe];
      return Ye ? R2(Xe, Ye) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
const C1 = Is(
...
}), v1 = { sm: 640, md: 768, "container-md": 448 }, F1 = (e) => "type" in e && e.type === "separator", n1 = (e) => "type" in e && e.type === "split", V2 = (e) => !("type" in e), o1 = (e, t, n) => /* @__PURE__ */ r(
  Ce,
  {
    label: e.label,
    icon: e.icon,
  ...
  "secondary-link"
), Yr = (e, t) => n1(e) ? U1(e, t, "default") : o1(e, t, "default");
function nt({
  primaryAction: e,
  secondaryActions: t,
  otherActions: n = [],
  ...
  const u = $(null), { width: h = 0 } = Ps({
    ref: u,
    box: "border-box"
  }), m = a === "sm" || a === "md" ? v1[a] : v1.md, g = ar(`(min-width: ${m}px)`, {
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: { gap: s },
      children: p ? /* @__PURE__ */ r(A2, { ...R }, "row") : /* @__PURE__ */ r(T2, { ...R }, "stacked")
    }
  );
}
function T2({
...
function A2({
  ...
  const p = g ? h : l, w = g ? m : [], v = new Set(p.map((b) => b.id)), x = e ? Yr(e, s) : null, S = t.filter(n1), N = t[t.length - 1], R = N != null && F1(N) && (S.length > 0 || x != null), E = [];
  t.forEach((b, T) => {
    if (!n1(b)) {
      if (F1(b)) {
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          V.length > 0 && /* @__PURE__ */ r("div", { ref: u, children: /* @__PURE__ */ r(l1, { items: V, icon: Qt, size: s }) }),
          L.map(
            (b) => b.kind === "sep" ? /* @__PURE__ */ r(ot, {}, b.key) : b.node
          ),
          n && Xr(n, s)
        ]
      }
...
const Kr = C(
  function({
        ...
        children: [
          m && !v && /* @__PURE__ */ r(
            ur,
            {
              href: m,
              variant: "unstyled",
              className: M("z-1 absolute inset-0 block rounded-xl", ve()),
              "aria-label": t,
              children: " "
            }
          ),
          /* @__PURE__ */ d("div", { className: H2[x], children: [
            /* @__PURE__ */ d("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
              o && /* @__PURE__ */ r(Zs, { avatar: o, size: "lg" }),
    ...
    return N ? /* @__PURE__ */ r(Us, { ref: S, alert: p, fullHeight: g, children: R }) : R;
  }
);
Kr.displayName = "F0CardRow";
const D2 = ({ compact: e = !1 }) => /* @__PURE__ */ r(
  dr,
  {
    className: M(
  ...
  lr(Kr, D2)
), f3 = ["xs", "sm", "md", "lg"], O2 = 2, it = 2, Z2 = 70, at = 0.08, U2 = 6, z2 = 0.6, G2 = () => {
  ...
  return K(() => {
    ...
    const c = () => {
      ...
      s(
        Math.max(1, Math.floor((u + it) / (O2 + it)))
      );
    };
    ...
    const h = new Uint8Array(u.fftSize), m = setInterval(() => {
      ...
      const p = Math.sqrt(g / h.length), w = Math.min(1, Math.pow(p * U2, z2));
      a((v) => {
...
function Y2({
  ...
  const o = /* @__PURE__ */ d("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(ce, { icon: Gt, size: "md", color: "critical" }),
  ...
  return e.errorMessage ? /* @__PURE__ */ r(zs, { label: e.errorMessage, children: o }) : o;
}
const K2 = {
  soft: {
    text: "",
...
const s4 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ d(
    I1,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ws, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((l, c) => /* @__PURE__ */ r(P1, { asChild: !0, children: /* @__PURE__ */ r(
          he,
          {
            variant: "outline",
            label: l.label,
        ...
        a && /* @__PURE__ */ d(
          j1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: o4(a.items).map((l, c) => /* @__PURE__ */ d(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
const a4 = 250, c4 = 12e4, l4 = () => typeof navigator < "u" && !!navigator.mediaDevices?.getUserMedia && typeof MediaRecorder < "u";
function d4({
  onTranscribe: e,
  onPartial: t,
  onFinal: n,
  ...
  const [i, a] = P("idle"), [l, c] = P(0), [f] = P(l4), [u, h] = P(null), m = $(null), g = $(null), p = $([]), w = $(null), v = $(!1), x = $(null), S = $(null), N = $(0), R = $({ onTranscribe: e, onPartial: t, onFinal: n, onError: o });
  ...
  const E = X(() => {
    ...
    m.current = y, y.ondataavailable = (A) => {
      ...
      L();
    }, y.start(a4), N.current = Date.now(), a("recording"), c(0), x.current = setInterval(() => {
...
function w4({
  ...
  const E = X(() => {
    ...
    (y) => {
      ...
      t(U), v((O) => [...O.filter((Y) => !(Y.id === _ && Y.name === j)), { id: _, name: j }]), E(), requestAnimationFrame(() => {
        const O = s.current;
    ...
    (y) => {
      ...
      for (const _ of j) {
        const Z = `@${_.name}`, G = `<entity-ref type="person" id="${ct(_.id)}">${ct(_.name)}</entity-ref>`;
        for (; A.includes(Z); )
          A = A.replace(Z, G);
      }
      return A;
...
` || Z === "	";
  ...
  const T = te(() => {
    ...
    const y = s.current;
    if (!y) return null;
    const A = C4(y, x.current), j = y.offsetLeft + A.left, Z = (y.offsetParent ? y.offsetParent.offsetHeight : 0) - (y.offsetTop + A.top);
...
const x4 = /[\\`*_{}[\]()#+\-.!|~>]/g, k4 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(x4, "\\$&")).join(""), h3 = ({
  onSubmit: e,
  onStop: t,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const L = ee(), V = Le(), [b, T] = P(""), [k, y] = P(0), [A, j] = P(!1), [_, Z] = P(!1), [G, q] = P(null), U = $(null), z = $(null), O = $(null), J = a != null, { tracking: Y } = Ee(), le = X(
    (ne, be) => {
    ...
    onError: (ne) => ae(Ve[ne])
  }), Te = !!m && me.isSupported, d1 = X(() => {
    Y?.onDictationStart?.(), pe.current = b, me.start();
  }, [b, me, Y]), u1 = X(() => {
    Y?.onDictationCancel?.(), me.cancel();
  }, [me, Y]);
  K(() => {
  ...
  const We = me.status === "recording", f1 = We ? L.ai.listening : L.ai.inputPlaceholder, h1 = de.filter((ne) => ne.status === "uploaded"), Ae = de.some((ne) => ne.status === "uploading"), Pe = de.some((ne) => ne.status === "error"), qe = b.trim().length > 0;
  K(() => {
    if (!(!_ || Ae)) {
      if (Z(!1), Pe) {
  ...
  const g1 = async (ne) => {
    if (ne.preventDefault(), !J) {
      if (Q.close(), n)
        ...
        const be = Q.transformMentions(b.trim()), m1 = k4(be), Qe = h1.flatMap(
          (K1) => K1.uploadedFile ? [K1.uploadedFile] : []
        ), X1 = l, Y1 = f;
        X1 && c?.(null), Y1 && u?.(null), await e({
          text: m1,
          files: Qe,
          context: X1,
          quote: Y1
    ...
    J || Q.handleKeyDown(ne) || ne.key === "Enter" && !ne.shiftKey && (ne.preventDefault(), n || U.current?.requestSubmit());
  }, Xe = () => {
    y(z.current?.selectionStart ?? 0);
  }, Ye = () => {
    O.current && z.current && (O.current.scrollTop = z.current.scrollTop);
  }, G1 = G ? G.prompt ?? G.title : null, W1 = We ? [L.ai.listening] : G1 ? [G1] : s ?? [], Sn = W1.length > 1, Vn = te(() => i4(b, Q.mentions, {
    cursorPosition: k,
    inlineCompletion: Q.inlineCompletion
  }), [b, Q.mentions, k, Q.inlineCompletion]), Tn = Q.mentions.length > 0 || Q.inlineCompletion !== null, Ke = x && !!N && N.length > 0 && !!R ? /* @__PURE__ */ r(
    s4,
    {
      suggestions: N,
      onItemClick: le,
                    ...
                    children: [
                        ...
                        oe.div,
                        {
                          ...
                          children: /* @__PURE__ */ d(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ r("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ r(Xs, { type: "critical", size: "sm" }) }),
                      ...
                      /* @__PURE__ */ r(
                        r4,
                        {
                          ...
                          onCursorUpdate: Xe,
                          onScroll: Ye,
                          highlightSegments: Vn,
                          hasOverlay: Tn,
                          multiplePlaceholders: Sn,
                          placeholders: W1,
                          resolvedDefaultPlaceholder: f1,
                          inProgress: n
                        }
                      ),
                      /* @__PURE__ */ r(
...
function R4({
  ...
  return /* @__PURE__ */ r(ur, { ...t, variant: "link", href: t.href, children: e });
}
function N4({
  children: e,
  ...t
...
function Ie({
  ...
  return /* @__PURE__ */ d(
    Ks,
    {
      ...
      children: [
        /* @__PURE__ */ r(Qs, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          Js,
          {
            side: "top",
            ...
            children: c ? /* @__PURE__ */ r(Q1.Skeleton, {}) : /* @__PURE__ */ r(Q1, { ...p })
          }
        )
      ]
    }
...
Qr.displayName = "CandidateTrigger";
function _4({
  id: e,
  label: t
}) {
...
Jr.displayName = "ExpenseTrigger";
function O4({ id: e, label: t }) {
...
en.displayName = "JobPostingTrigger";
function Z4({
  id: e,
  label: t
}) {
...
tn.displayName = "RequisitionTrigger";
function z4({
  id: e,
  label: t
}) {
...
nn.displayName = "VacancyTrigger";
function W4({ id: e, label: t }) {
...
}, on = Hn.forwardRef(({ animate: e = "normal", ...t }, n) => /* @__PURE__ */ d(
  "svg",
  {
    ref: n,
    viewBox: "0 0 24 24",
...
on.displayName = "CheckCircleLineAnimated";
const sn = 60, an = 40, lt = 2e3, t6 = 500, r6 = 12e3, cn = 2, Oe = 40, He = [255, 60, 0], x1 = [160, 140, 220], k1 = { x: -12, y: 0, z: 0 }, b1 = { x: -12, y: 12, z: 90 }, Be = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, L1 = Math.PI / 180, n6 = cn / 8 * Math.PI, o6 = 4 * Math.PI;
function s1(e, t) {
  return [
...
function ln(e, t, n) {
  const o = Ze(1, 0, 0, e * L1), s = Ze(0, 1, 0, t * L1), i = Ze(0, 0, 1, n * L1);
  return s6(s1(s1(s, o), i));
}
function i6(e) {
  return e < 0.5 ? 4 * e * e * e : 1 - Math.pow(-2 * e + 2, 3) / 2;
}
const Ue = 256, a6 = (() => {
  const e = new Array(Ue);
  for (let t = 0; t < Ue; t++) {
    const n = t / (Ue - 1), o = Math.round(He[0] + (x1[0] - He[0]) * n), s = Math.round(He[1] + (x1[1] - He[1]) * n), i = Math.round(He[2] + (x1[2] - He[2]) * n);
    e[t] = `rgb(${o},${s},${i})`;
  }
  return e;
})();
function c6(e) {
  const t = e <= 0 ? 0 : e >= 1 ? Ue - 1 : e * (Ue - 1) | 0;
  return a6[t];
}
const l6 = Object.keys(Be).map(Number).sort((e, t) => e - t);
function d6(e) {
  const t = l6;
...
const ut = Math.sqrt(sn ** 2 + an ** 2), y1 = [sn / ut, an / ut, 0], u6 = ln(k1.x, k1.y, k1.z), f6 = ln(b1.x, b1.y, b1.z), $e = cn * 3, t1 = Oe + 1, ft = ($e + 1) * t1, i1 = 4 * $e * Oe, M1 = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
], h6 = (e, t) => e.avgZ - t.avgZ;
function g6() {
  const e = new Array(i1);
  for (let n = 0; n < i1; n++)
    e[n] = { points: "", color: "", avgZ: 1 / 0 };
  const t = new Array(ft);
  for (let n = 0; n < ft; n++)
    t[n] = { x: 0, y: 0, z: 0, t: 0 };
  return { quads: e, grid: t };
}
function ht(e, t, n, o) {
  const { quads: s, grid: i } = e, a = n * 0.392, l = n / 2, c = n / 2, f = n6 * d6(n), u = t * o6, h = Ze(0, 0, 1, o * 2 * Math.PI);
  dt(h, y1[0], y1[1], y1[2], Re);
  const m = Ze(Re[0], Re[1], Re[2], u), g = s1(m, u6), p = s1(m, f6);
  M1[0] = g, M1[1] = p;
  let w = 0;
  for (let v = 0; v < 4; v++) {
    ...
    for (let N = 0; N <= $e; N++) {
      ...
      for (let T = 0; T <= Oe; T++) {
        const k = T / Oe * Math.PI * 2;
        dt(x, E * Math.cos(k), L, E * Math.sin(k), Re);
        const y = i[b + T];
    ...
    for (let N = 0; N < $e; N++) {
      ...
      for (let L = 0; L < Oe; L++) {
        ...
        const A = (V.x + b.x + T.x + k.x) * 0.25, j = (V.y + b.y + T.y + k.y) * 0.25, _ = (V.z + b.z + T.z + k.z) * 0.25, Z = A * a, G = j * a, q = V.x * a - Z, U = V.y * a - G, z = Math.sqrt(q * q + U * U), O = z > 0 ? (z + 0.9) / z : 1, J = l + Z + q * O, Y = c - G - U * O, le = b.x * a - Z, de = b.y * a - G, se = Math.sqrt(le * le + de * de), re = se > 0 ? (se + 0.9) / se : 1, ie = l + Z + le * re, ue = c - G - de * re, F = k.x * a - Z, B = k.y * a - G, H = Math.sqrt(F * F + B * B), D = H > 0 ? (H + 0.9) / H : 1, I = l + Z + F * D, W = c - G - B * D, ae = T.x * a - Z, Q = T.y * a - G, pe = Math.sqrt(ae * ae + Q * Q), xe = pe > 0 ? (pe + 0.9) / pe : 1, Ve = l + Z + ae * xe, me = c - G - Q * xe, Te = s[w];
        Te.points = `${J},${Y} ${ie},${ue} ${I},${W} ${Ve},${me}`, Te.color = c6((A + 1) * 0.5), Te.avgZ = _, w++;
      }
    }
  }
  for (let v = w; v < i1; v++)
...
const p6 = ({ size: e = 20, className: t, style: n, variant: o = "default" }, s) => {
  const i = $(null), a = $(null), l = $(null);
  l.current === null && (l.current = g6());
  ...
  return K(() => {
    ...
    const L = (y) => {
      ...
      let A = 0, j = !0;
      if (o === "continuous") {
        const q = lt * 2, U = (y - w) % q / q;
        A = U < 0.5 ? U * 2 : (1 - U) * 2, j = !1;
      } else N === "spin" ? (A = Math.min((y - w) / lt, 1), A >= 1 && (A = 0, N = "pause", x = y)) : (A = 0, y - x >= t6 && (N = "spin", w = y));
      const _ = (y - v) / r6 % 1, Z = j ? i6(A) : A, G = ht(g, Z, e, _);
...
const gt = {
  ...
  return /* @__PURE__ */ d("div", { className: "flex w-full items-start gap-1 text-f1-foreground-secondary", children: [
    /* @__PURE__ */ r("div", { className: "flex h-5 w-6 shrink-0 items-center justify-start", children: /* @__PURE__ */ d(Fe, { mode: "wait", children: [
      ...
      (a || c) && /* @__PURE__ */ r("div", { className: "flex h-5 w-5 shrink-0 items-center justify-center", children: /* @__PURE__ */ r(dn, { variant: a ? "default" : "continuous" }) }),
      l && /* @__PURE__ */ r(
        oe.div,
        {
          ...gt,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ r(gr, { module: e.module, size: "lg" }),
          e?.type === "file" && /* @__PURE__ */ r(ti, { file: e.file, size: "lg" }),
...
const pt = 7, C6 = 625, mt = /* @__PURE__ */ new Set();
function v6(e) {
...
function x6(e) {
  const { days: t, hours: n, minutes: o, seconds: s } = ni(e), i = [];
...
function fn(e, t) {
  ...
  if (t === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: n, to: o } = e, s = Ct(n) ? vt(n) : String(n), i = Ct(o) ? vt(o) : String(o);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((o) => {
      const s = fn(o);
      return Array.isArray(s) ? s.map(wt).join(", ") : wt(s);
    }).filter(Boolean).join(", ") || "—" };
  ...
  return { type: "item", text: w6(String(e)) };
}
function hn({
  formName: e,
  formDescription: t,
  ...
  const { canvasContent: c, openCanvas: f, closeCanvas: u } = Ee(), h = m6(e), m = l ?? h, g = $(() => {
  ...
  g.current = x, K(() => {
    typeof window > "u" || window.innerWidth < C6 || mt.has(e) || (mt.add(e), g.current());
  }, [e]);
  const S = i && a ? Object.entries(i).map(([E, L]) => {
    ...
    if (!b && L.fieldType === "custom" && typeof V == "object" && V !== null)
      return null;
    const T = b ?? fn(V, L.fieldType), k = ["richtext", "textarea"];
    return {
      label: L.label,
      content: T,
...
hn.displayName = "FormCard";
function k6() {
  const e = oi(), t = e?.activeForm;
  if (!t) return null;
...
const xt = 8, De = 8;
function pn({ anchor: e, onReply: t }) {
  ...
  if (Ot(() => {
    ...
    let m = e.rect.top - f - xt;
    m < De && (m = e.rect.bottom + xt), m = Math.min(
      Math.max(m, De),
      h - f - De
    );
...
const mn = a1(void 0), v3 = () => Ge(mn), y6 = (e) => /* @__PURE__ */ r(pr, { content: e, format: "markdown" }), M6 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const l = typeof n?.content == "string" ? n.content : "", c = (n && o?.(n)) ?? n?.generativeUI?.() ?? null, f = n?.toolCalls?.[0]?.id, u = !l && !c, h = $(null), { anchor: m, clear: g } = gn({
    containerRef: h,
    enabled: !!(n?.id && l)
  });
  return K(() => {
    n?.id && !t && !e && i?.(n);
  }, [n, t, e, i]), !t && !e && u ? null : /* @__PURE__ */ r(mn.Provider, { value: f, children: /* @__PURE__ */ d("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    n && l && /* @__PURE__ */ r(
      "div",
      {
        ref: h,
  ...
  return /* @__PURE__ */ r(Cn.Provider, { value: o, children: e });
}, vn = () => {
  const e = Ge(Cn);
  if (e === null)
    throw new Error(
...
const F6 = ({
  ...
  const o = ee(), { open: s } = vn(), [i, a] = P(null);
  ...
  return /* @__PURE__ */ d(
    mr,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r(vr, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ r(
          oe.div,
          {
            initial: !1,
            animate: {
...
const wn = (e) => /* @__PURE__ */ r(pr, { content: e, format: "markdown" }), H6 = ({
  text: e,
  renderMarkdown: t
  ...
  /* @__PURE__ */ r("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (t ?? wn)(e) })
] }), B6 = ({
  message: e,
  onReplyQuote: t,
  ...
  const a = e.rawData, l = A6(
    e?.content,
    a
  ), c = (T6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = c.length > 0, { anchor: h, clear: m } = gn({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ r(H6, { text: f, renderMarkdown: o }),
...
}, $6 = 35, I6 = 22, P6 = 400, j6 = 2500, D6 = 220, _6 = ({
  messages: e,
  onClick: t,
  fullscreen: n = !1
}) => {
  ...
  K(() => {
    ...
    let m;
    if (l === "starting")
      m = setTimeout(() => c("writing"), P6);
    else if (l === "writing")
      i < f.length ? m = setTimeout(() => a((g) => g + 1), $6) : c("holding");
    else if (l === "holding") {
      if (e.length <= 1) return;
      m = setTimeout(() => c("erasing"), j6);
    } else l === "erasing" && (i > 0 ? m = setTimeout(() => a((g) => g - 1), I6) : m = setTimeout(() => {
...
const Z6 = {
...
}, w3 = (e) => /* @__PURE__ */ r(R6, { children: /* @__PURE__ */ r(U6, { ...e }) }), U6 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: N, handleSubmit: R, handleClose: E } = N6(
    u ?? Z6
  ), L = ee(), V = w ?? M6, b = v ?? B6, T = te(() => {
    const O = o ?? L.ai.defaultInitialMessage;
    return (Array.isArray(O) ? O : [O]).filter((Y) => typeof Y == "string" && Y.length > 0);
  }, [o, L.ai.defaultInitialMessage]), k = !t && e.length === 0 && T.length > 0, y = $(null), A = $(null), j = $(null), _ = $(null), Z = $(null), { showScrollBtn: G, turnMinHeight: q, scrollToBottom: U } = O6({
    viewportRef: y,
    contentRef: A,
    endRef: j,
    lastTurnRef: Z,
    ...
    const Y = J === e.length - 1, le = {
      ...
      const ue = Y && ie === O.assistantMessages.length - 1, F = O.userMessages.length + ie, B = {
        message: re,
        inProgress: O.isInProgress,
        index: F,
        isCurrentMessage: ue,
  ...
  return /* @__PURE__ */ d(ke, { children: [
    /* @__PURE__ */ d("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
      ...
      !m && !k && /* @__PURE__ */ d(ke, { children: [
        /* @__PURE__ */ r(kt, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ r(kt, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    N.isOpen && /* @__PURE__ */ r(
      E6,
...
}, z6 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ d("div", { className: "flex flex-col gap-2", children: [
...
function k3({
  ...
  return /* @__PURE__ */ r(xn.Provider, { value: t, children: e });
}
function b3() {
  const e = Ge(xn);
  if (e === null)
...
const W6 = ({
  ...
  const m = ee().ai.clarifyingQuestion.typeYourAnswer, g = e === "single" ? /* @__PURE__ */ r(kn, { isSelected: n && !t }) : /* @__PURE__ */ r(
    wr,
    {
      checked: s,
      onCheckedChange: () => f(!s),
...
const X6 = ({
  ...
  }, O = y ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, J = N === !0 && !j && !(L && _), Y = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-col", onKeyDown: le, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(Fe, { mode: "wait", initial: !1, children: /* @__PURE__ */ d(
      oe.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: de, ease: K6 },
        children: [
          /* @__PURE__ */ r(
            Y6,
            {
...
function bt(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), l = Math.min(i + o, s), c = Math.min(l, Math.floor(e / 2)), f = Math.min(l, Math.floor(t / 2)), u = (Y) => Y / e * 2 - 1, h = (Y) => Y / t * 2 - 1, m = 0, g = e, p = 0, w = t, v = c, x = e - c, S = f, N = t - f, R = u(m), E = u(g), L = h(p), V = h(w), b = u(v), T = u(x), k = h(S), y = h(N), A = 0, j = 0, _ = 1, Z = 1, G = c / e, q = 1 - c / e, U = f / t, z = 1 - f / t, O = new Float32Array([
    // Top strip
    R,
    L,
    E,
...
function e9(e, t, n) {
  const o = Lt(e, e.VERTEX_SHADER, t), s = Lt(e, e.FRAGMENT_SHADER, n), i = e.createProgram();
...
class M3 {
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: a, uvs: l } = bt(
      s,
      i,
    ...
    const R = (this.options.colors || n9).map(o9);
...
const yt = ["lowp", "mediump", "highp"], s9 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, i9 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
    vec2 uv = fragCoord/iResolution.xy;
    vec3 col = 0.5 + 0.5*cos(iTime+uv.xyx+vec3(0,2,4));
    fragColor = vec4(col,1.0);
}`, Mt = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, Et = "iTime", Rt = "iTimeDelta", Nt = "iDate", Ft = "iFrame", St = "iMouse", Vt = "iResolution", a9 = "iChannel", Tt = "iChannelResolution", At = "iDeviceOrientation";
function c9(e, t) {
...
}, E1 = 9729, Ht = 9728, h9 = 9987, Bt = 33071, $t = 10497;
class g9 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    return (t.wrapS !== Bt || t.wrapT !== Bt || t.minFilter !== Ht && t.minFilter !== E1) && !L && (E = this.makePowerOf2(E), L = !0), n.bindTexture(n.TEXTURE_2D, N), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, c), n.texImage2D(
      n.TEXTURE_2D,
      h,
      m,
      v,
      x,
      E
    ), L && t.minFilter !== Ht && t.minFilter !== E1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || $t
    ), n.texParameteri(
...
const ye = (e) => `react-shaders: ${e}`, It = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, Pt = (e, t, n) => e * (1 - n) + t * n, p9 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function m9({
  fs: e,
  vs: t = Mt,
  textures: n = [],
  ...
  const g = $(null), p = $(null), w = $(null), v = $(null), x = $(void 0), S = $(void 0), N = $(!1), R = $(void 0), E = $(0), L = $([0, 0]), V = $([]), b = $(0), T = $(void 0), k = $({
    ...
    [Vt]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    ...
    const [B = 0, H = 0] = It(F), D = B - (R.current?.left ?? 0) - window.pageXOffset, I = (R.current?.height ?? 0) - H - (R.current?.top ?? 0) - window.pageYOffset;
    N.current = !0;
    ...
    const [B = 0, H = 0] = It(F), D = B - (R.current?.left ?? 0), I = (R.current?.height ?? 0) - H - (R.current?.top ?? 0);
    if (c !== 1)
...
${B}`));
    ...
    if (o)
      for (const F of Object.keys(o)) {
        const B = o[F];
        if (!B) continue;
        const { value: H, type: D } = B, I = f9(D);
        if (!I) continue;
        const W = {};
        if (c9(D, H)) {
          const ae = D.length, Q = Number.parseInt(D.charAt(ae - 3)), pe = Math.floor(H.length / (Q * Q));
          H.length > Q * Q && (W.arraySize = `[${pe}]`);
        } else l9(D, H) && (W.arraySize = `[${Math.floor(H.length / Number.parseInt(D.charAt(0)))}]`);
        k.current[F] = {
          type: I,
          isNeeded: !1,
          value: H,
      ...
      if (n && n.length > 0) {
        ...
        const B = n.map(
          (H, D) => (k.current[`${a9}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, A(H, D), V.current[D] = new g9(F), V.current[D]?.load(H).then((I) => {
            A(I, D);
          }))
        );
        Promise.all(B).then(() => {
    ...
    const B = yt.includes(i ?? "highp"), H = `precision ${B ? i : yt[1]} float;
`;
    B || m?.(
      ye(
...
`,
    ...
    return F.includes("mainImage") && (D = D.concat(s9)), D;
  }, se = (F) => {
    const B = p.current;
    ...
    if (k.current.iDate?.isNeeded) {
      const I = /* @__PURE__ */ new Date(), W = I.getMonth() + 1, ae = I.getDate(), Q = I.getFullYear(), pe = I.getHours() * 60 * 60 + I.getMinutes() * 60 + I.getSeconds() + I.getMilliseconds() * 1e-3, xe = B.getUniformLocation(
        v.current,
        Nt
      );
      B.uniform4fv(xe, [Q, W, ae, pe]);
    }
    ...
    if (V.current.length > 0)
      for (let I = 0; I < V.current.length; I++) {
        const W = V.current[I];
        if (!W) return;
        const { isVideo: ae, _webglTexture: Q, source: pe, flipY: xe, isLoaded: Ve } = W;
        if (!Ve || !Q || !pe) return;
        if (k.current[`iChannel${I}`]?.isNeeded) {
          if (!v.current) return;
          const me = B.getUniformLocation(
            v.current,
            `iChannel${I}`
          );
          B.activeTexture(B.TEXTURE0 + I), B.bindTexture(B.TEXTURE_2D, Q), B.uniform1i(me, I), ae && W.updateTexture(
            Q,
            pe,
            xe
          );
    ...
    if (k.current.iMouse?.isNeeded && c !== 1 && Array.isArray(H)) {
      ...
      H[0] = Pt(D, L.current[0] ?? 0, c), H[1] = Pt(I, L.current[1] ?? 0, c);
    }
  ...
  return K(() => {
    ...
    function B() {
      j();
      const H = p.current;
      H && g.current && (H.clearColor(...s), H.clearDepth(1), H.enable(H.DEPTH_TEST), H.depthFunc(H.LEQUAL), H.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, Y(), le(), J(de(e || i9), t || Mt), _(), requestAnimationFrame(re), ie(), z());
    }
...
}`, v9 = 10, w9 = 2, x9 = 0.5, k9 = 0.2, b9 = 1.5, we = {
  duration: 0.5,
  ease: "easeOut"
}, jt = {
  duration: 0.35,
...
function L9(e, t) {
  const [n, o] = P(v9), {
    ...
    animate: i,
    motionValue: a
  } = Je(k9), { value: l, animate: c } = Je(w9), { value: f, animate: u } = Je(x9), { value: h, animate: m } = Je(b9), g = yi(t, {
    fftSize: 512,
  ...
  return K(() => {
    switch (e) {
      ...
      case "pre-connect-buffering":
        o(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, we), u(0.7, we), m([1.5, 2], jt);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        o(30), i(0.3, we), c(0.5, we), u(1, we), m([0.5, 2.5], jt);
        return;
      case "speaking":
...
function E3({
  ...
  const { speed: f, scale: u, amplitude: h, frequency: m, brightness: g } = L9(t, s);
  return /* @__PURE__ */ r(
    Ln,
    {
      ref: l,
...
const R3 = ({
  ...
  const o = ee(), s = Le();
  return /* @__PURE__ */ d(ke, { children: [
    e && /* @__PURE__ */ r("span", { className: M(R9(), "truncate"), children: e }),
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: M(yn()), children: t }),
    /* @__PURE__ */ d(
      oe.div,
      {
        ...
        children: [
          ...
          o === "alert" && /* @__PURE__ */ r(ui, { text: e.alertLabel, level: e.level }),
          o === "balance" && /* @__PURE__ */ r(S9, { balance: e.balance })
        ]
      }
    ),
    n && !F9.has(o) && /* @__PURE__ */ r(
      oe.span,
      {
        className: M(e1()),
        animate: { opacity: s ? 0 : 1 },
...
const A9 = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), H9 = ({
  label: e,
  direction: t
}) => {
  const n = Mn[t];
  ...
  const s = `sparkline-gradient-${Zt().replace(/:/g, "")}`, i = T9(e, n), a = Mn[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(hi, { width: "100%", height: "100%", children: /* @__PURE__ */ d(
          gi,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ r(pi, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                mi,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ r(H9, { label: t, direction: i })
      ]
    }
  ) });
}, En = C(
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: M(yn()), children: o }),
              /* @__PURE__ */ r(
                oe.div,
                {
...
En.displayName = "F0AiInsightCardInternal";
const $9 = ["className"], Rn = C((e, t) => {
  const n = $9.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
  return /* @__PURE__ */ r(En, { ref: t, ...n });
});
Rn.displayName = "F0AiInsightCard";
const I9 = () => /* @__PURE__ */ d(
  "div",
  {
  ...
  "balance",
  "sparkline"
], Nn = 180, P9 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Nn, j9 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, D9 = (e) => e.showActions !== !1, _9 = (e) => Object.fromEntries(
...
function O9(e) {
  const {
    ...
    description: i,
    seeMoreLabel: a,
    maxCollapsedDescriptionLength: l = Nn
  } = e, [c, f] = P(!1), u = Zt(), h = $(null), m = P9(
    l
  ), g = i.length > m, p = c ? i : j9(i, m), w = D9(e) ? e : null, v = _9(e);
  return K(() => {
    c && h.current?.focus();
  }, [c]), /* @__PURE__ */ d(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          t && /* @__PURE__ */ r(gr, { module: t, size: "lg" }),
...
O9.displayName = "F0AiProposalCard";
const Z9 = ({
  icon: e,
  title: t,
  children: n
  ...
  return /* @__PURE__ */ d(
    mr,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ d(Cr, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, U9 = (e) => a2[e] ?? er, z9 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(ce, { icon: U9(e), size: "md", color: "default" }) }) : null;
function G9({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(Z9, { icon: B1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(z9, { iconName: s.icon });
...
G9.displayName = "F0AiMessageSources";
async function W9(e, t, n) {
  const o = await import("./xlsx-Bedf3nwD.js"), s = o.utils.table_to_book(e, { sheet: "Data" });
  o.writeFile(s, `${n}.${t}`);
}
function q9({
...
q9.displayName = "F0AiTableCard";
function X9({ credits: e }) {
...
const Y9 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function K9({
  employeeCredits: e
}) {
...
const Dt = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(K9, { employeeCredits: t }) : e ? /* @__PURE__ */ r(X9, { credits: e }) : null, S3 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const m = ee(), g = ar(`(max-width: ${Ci.md}px)`, {
...
function Q9() {
  if (!(typeof navigator > "u"))
    return xi(navigator.language);
}
function J9(e) {
  const t = new Date(e), n = /* @__PURE__ */ new Date();
  return xr(t) ? "today" : kr(t) ? "yesterday" : vi(t, n) ? "thisMonth" : "older";
}
function e3(e, t) {
  const n = new Date(e), o = Q9(), s = J1(n, "p", { locale: o });
  if (xr(n)) return `${t.today}, ${s}`;
  if (kr(n)) return `${t.yesterday}, ${s}`;
  const i = !wi(n, /* @__PURE__ */ new Date());
  return `${J1(n, i ? "MMM d yyyy" : "MMM d", {
    locale: o
  })}, ${s}`;
}
function t3(e) {
...
function T3({
  ...
  const [o, s] = P([]), [i, a] = P(!1), [l, c] = P(null), [f, u] = P(o3), h = X(async () => {
    a(!0), c(null);
    try {
      const w = await t();
      s(w);

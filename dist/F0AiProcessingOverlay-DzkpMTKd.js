...
import { useInsertionEffect as Tr, forwardRef as g, useRef as $, useEffect as q, useLayoutEffect as rt, useState as I, useId as Ge, useMemo as J, useCallback as _, createContext as We, useContext as Ie, createElement as Hr, memo as Ar } from "react";
import { d9 as $r, da as Br, af as ot, c7 as Ir, db as Pr, dc as Dr, dd as jr, de as Zr, c8 as _r, cg as nt, c6 as Or, df as Ur, ao as i1, dg as zr, aX as Gr, dh as Wr, di as qr, dj as Xr, aw as Yr, dk as Kr, cH as Qr, aq as st, at as Jr, dl as eo, s as a1, aj as it, aa as qe, r as at, bv as to, ce as ro, dm as oo, bg as no, cG as so, ah as Fe, aJ as io, bz as ct, dn as ao, cE as co, l as Me, cC as lo, dp as fo, c0 as lt, bf as uo, dq as ho, dr as go, ds as po, dt as Co, du as mo, dv as dt, cv as vo, cw as wo, dw as xo, dx as ko, dy as Lo, dz as bo, dA as yo, bJ as Mo, ca as Eo, dB as Ro, dC as Fo, dD as No, dE as Vo, dF as So, dG as To, dH as Ho, dI as Ao, bI as $o, cF as Bo, ar as Io, cr as Po, dJ as Do, dK as jo, dL as Zo, dM as _o, dN as Oo, dO as Uo, dP as zo, aF as Go, bK as Wo, c2 as ft, a7 as qo, ai as Xo, bL as ut, b$ as Yo, c1 as ht, i as Ko, by as Qo, bx as Jo, dQ as en, dR as tn, bM as gt, bN as rn, bO as on, be as nn, aM as sn, dS as an, j as cn, bt as pt, bs as Ct, bm as ln, dT as mt, bl as dn, c9 as c1, t as fn, bp as l1, dU as un, dV as hn, dW as d1, cc as gn, cd as pn, cD as vt, dX as Cn, a2 as mn, a1 as vn, dY as wn, dZ as xn, d_ as kn, d$ as Ln, bZ as bn, e0 as wt, e1 as yn, as as Mn, e2 as En, a6 as ce, q as k, O as Te, cl as Rn, u as G, bY as Fn, S as he, bX as xt, a3 as le, X as ge, ak as Nn, o as ve, e3 as Vn, au as se, b1 as Le, a0 as Ee, N as ee, cM as kt, aR as f1, e4 as Sn, aT as u1, b as ye, bV as Tn, e5 as Hn, bW as An, ab as $n, bd as Bn, an as h1, bP as In, bQ as Pn, bR as Dn, bS as y1, al as jn, aA as Lt, b4 as bt, cb as Zn, cR as _n, e6 as On, e7 as Un, b9 as yt, e8 as zn, cN as Gn, e9 as Wn, b6 as Be, bn as Mt, ea as Et, bo as Rt, c as o1, cf as M1, eb as Ft, ec as qn, ed as Xn, bD as Yn, ee as Kn, bu as g1, cs as Qn, ef as Jn, eg as es, eh as ts, ei as rs, ej as os, w as ns, x as ss, aS as Nt, _ as is, $ as as, az as E1, ek as Vt, el as St, em as cs, en as ls, ay as ds, ap as fs, eo as us, ep as hs, d as gs } from "./F0CanvasPanel-DrV1MNII.js";
...
const Nc = Te({
  ...
  ({
    ...
    const Ae = j && j !== "none" || W && W !== "none" || K && K !== "none" || ie && ie !== "none", Se = Y && Y !== "none" || Ae, De = { sm: xe, md: Ye, lg: Ke, xl: Qe }, je = Vc.map((Ze) => {
      const _e = De[Ze];
      return _e ? Fc(Ze, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
...
const Ic = ({
  ...
  const s = Le(), [i, l] = I(""), [d, c] = I(0), [u, f] = I(!1), C = $(null), p = $(null), h = $(null), m = e[d] ?? r;
  return q(() => {
    const x = () => {
...
const Uc = ({
  ...
  const [s, i] = I(null), l = $(null), d = $(null), c = $(!1), u = Ge(), f = Ge(), C = s !== null ? e[s] : null;
        ...
        C && /* @__PURE__ */ a(
          u1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: Oc(C.items).map((p, h) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: (m) => {
...
function e2({
  ...
  const [i, l] = I(!1), [d, c] = I(""), [u, f] = I([]), [C, p] = I(!1), [h, m] = I(0), [x, v] = I([]), F = $(-1), P = $(null), H = $(0), S = $(-1);
  q(() => {
    if (!n) {
      l(!1);
      return;
    ...
    if (V.atIndex === S.current)
      return;
    F.current = V.atIndex, c(V.query), l(!0), m(0), p(!0), P.current && clearTimeout(P.current);
    const B = ++H.current;
    return P.current = setTimeout(() => {
      n(V.query).then((U) => {
        B === H.current && (f(U), m(0), U.length === 0 && V.query.length > 0 && (S.current = V.atIndex, l(!1)));
      }).catch(() => {
        B === H.current && f([]);
      }).finally(() => {
        B === H.current && p(!1);
  ...
  const M = _(() => {
    ...
    (V) => {
      const B = F.current;
      if (B === -1) return;
      const U = `${V.firstName} ${V.lastName}`.trim(), O = String(V.id), z = e.slice(0, B), te = e.slice(o), oe = `@${U} `, X = z + oe + te, Y = z.length + oe.length;
    ...
    (V) => {
      ...
      switch (V.key) {
        case "ArrowDown":
          return V.preventDefault(), m((B) => (B + 1) % u.length), !0;
        case "ArrowUp":
...
` || z === "	";
  ...
  const A = J(() => {
    ...
    const V = s.current;
    if (!V) return null;
    const B = Qc(V, F.current), U = V.offsetLeft + B.left, z = (V.offsetParent ? V.offsetParent.offsetHeight : 0) - (V.offsetTop + B.top);
...
const t2 = /[\\`*_{}[\]()#+\-.!|~>]/g, r2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(t2, "\\$&")).join(""), A6 = ({
  ...
  const L = G(), A = Le(), [E, V] = I(""), [B, U] = I(0), [O, z] = I(!1), [te, oe] = I(!1), [X, Y] = I(null), j = $(null), W = $(null), K = $(null), ie = l != null, { tracking: ue } = ye(), pe = _(
    (Q, ke) => {
    ...
    const ke = Ne.current, e1 = ke && !/\s$/.test(ke) ? " " : "", Oe = `${ke}${e1}${Q}`;
    V(Oe), U(Oe.length);
  }, []), Xe = {
  ...
  const Pe = xe.status === "recording", Je = Pe ? L.ai.listening : L.ai.inputPlaceholder, Ae = re.filter((Q) => Q.status === "uploaded"), Se = re.some((Q) => Q.status === "uploading"), De = re.some((Q) => Q.status === "error"), je = E.trim().length > 0 || Ae.length > 0;
  q(() => {
    if (!(!te || Se)) {
      if (oe(!1), De) {
  ...
  const Ze = async (Q) => {
    if (Q.preventDefault(), !ie) {
      if (ne.close(), o)
        ...
        const ke = ne.transformMentions(E.trim()), e1 = r2(ke), Oe = Ae.flatMap(
  ...
  }), [E, ne.mentions, B, ne.inlineCompletion]), Nr = ne.mentions.length > 0 || ne.inlineCompletion !== null, w1 = P && !!S && S.length > 0 && !!M ? /* @__PURE__ */ t(
    Uc,
    {
      suggestions: S,
      onItemClick: pe,
  ...
  ) : null, Vr = P && H && !!w && w.length > 0, x1 = H && P, { motionProps: Sr } = Hn(
    P,
    160,
    0.5
  );
...
function He({
  ...
  const i = $(/* @__PURE__ */ new Map()), [l, d] = I(
...
function cr({
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = ye(), C = T2(e), p = d ?? C, h = $(() => {
  ...
  const P = i && l ? Object.entries(i).map(([M, w]) => {
    const N = l[M], L = p?.(M, N, {
...
const fr = We(void 0), P6 = () => Ie(fr), j2 = (e) => /* @__PURE__ */ t(yt, { content: e, format: "markdown" }), Z2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, C = $(null), { anchor: p, clear: h } = lr({
    containerRef: C,
    enabled: !!(o?.id && d)
  });
  return q(() => {
...
const z2 = ({
  ...
  const [d, c] = I(s), u = Le(), f = n !== void 0, C = f ? n : d;
  return /* @__PURE__ */ a(
    Mt,
    {
...
const gr = (e) => /* @__PURE__ */ t(yt, { content: e, format: "markdown" }), Y2 = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = X2(
    e?.content,
    l
  ), c = (q2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: C, clear: p } = lr({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
  ...
  q(() => {
    ...
    let p;
    if (d === "starting")
      p = setTimeout(() => c("writing"), el);
    else if (d === "writing")
      i < u.length ? p = setTimeout(() => l((h) => h + 1), Q2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), tl);
    } else d === "erasing" && (i > 0 ? p = setTimeout(() => l((h) => h - 1), J2) : p = setTimeout(() => {
...
function nl({
  ...
  const h = _(() => {
    const m = e.current;
    if (!m) return;
    const { scrollTop: x, scrollHeight: v, clientHeight: F } = m, P = v - x - F;
    u(P > F);
  }, [e]);
  return q(() => {
    const m = e.current;
    ...
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!m || !x) return;
        const v = m.getBoundingClientRect(), F = x.getBoundingClientRect(), P = m.scrollTop + (F.top - v.top);
...
const sl = {
  ...
  }, [n, w.ai.defaultInitialMessage]), E = !r && e.length === 0 && A.length > 0, V = $(null), B = $(null), U = $(null), O = $(null), z = $(null), { showScrollBtn: te, turnMinHeight: oe, scrollToBottom: X } = nl({
    viewportRef: V,
    contentRef: B,
    endRef: U,
    lastTurnRef: z,
...
const fl = ({
  ...
  } = s, N = $(null), L = P ?? "single", A = l > 1, E = i === 0, V = i === l - 1, B = A ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(l)
...
function A1(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (K) => K / e * 2 - 1, C = (K) => K / r * 2 - 1, p = 0, h = e, m = 0, x = r, v = c, F = e - c, P = u, H = r - u, S = f(p), M = f(h), w = C(m), N = C(x), L = f(v), A = f(F), E = C(P), V = C(H), B = 0, U = 0, O = 1, z = 1, te = c / e, oe = 1 - c / e, X = u / r, Y = 1 - u / r, j = new Float32Array([
    // Top strip
    S,
    w,
    M,
...
class z6 {
  ...
  setupGL() {
    ...
    const p = r.getUniformLocation(o, "uResolution"), h = r.getUniformLocation(o, "uTime"), m = r.getUniformLocation(o, "uBorderWidth"), x = r.getUniformLocation(o, "uGlowWidth"), v = r.getUniformLocation(o, "uBorderRadius"), F = r.getUniformLocation(o, "uColors"), P = r.getUniformLocation(o, "uGlowExponent"), H = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(m, this.options.borderWidth), r.uniform1f(x, this.options.glowWidth), r.uniform1f(v, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(P, 2), r.uniform1f(H, 1.8)) : (r.uniform1f(P, 1), r.uniform1f(H, 1));
...
}, r1 = 9729, G1 = 9728, Nl = 9987, W1 = 33071, q1 = 10497;
class Vl {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    const C = 0, p = o.RGBA, h = 1, m = 1, x = 0, v = o.RGBA, F = o.UNSIGNED_BYTE, P = new Uint8Array([255, 255, 255, 0]), H = o.createTexture();
    ...
    return (r.wrapS !== W1 || r.wrapT !== W1 || r.minFilter !== G1 && r.minFilter !== r1) && !w && (M = this.makePowerOf2(M), w = !0), o.bindTexture(o.TEXTURE_2D, H), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, c), o.texImage2D(
      o.TEXTURE_2D,
      C,
      p,
      v,
...
function Tl({
  ...
  const h = $(null), m = $(null), x = $(null), v = $(null), F = $(void 0), P = $(void 0), H = $(!1), S = $(void 0), M = $(0), w = $([0, 0]), N = $([]), L = $(0), A = $(void 0), E = $({
    ...
    if (b.canvas.width = y, b.canvas.height = D, E.current.iResolution?.isNeeded && v.current) {
...
${R}`));
      ...
      y.deleteShader(D), C?.(be(`Shader compiler log: ${T}`));
    }
    return D;
  }, W = (b, R) => {
    const y = m.current;
    ...
    if (v.current = y.createProgram(), !(!v.current || !T || !D)) {
      if (y.attachShader(v.current, T), y.attachShader(v.current, D), y.linkProgram(v.current), !y.getProgramParameter(v.current, y.LINK_STATUS)) {
        C?.(
          be(
    ...
    if (n)
      for (const b of Object.keys(n)) {
        ...
        const Z = {};
        if (yl(D, y)) {
          const ae = D.length, fe = Number.parseInt(D.charAt(ae - 3)), me = Math.floor(y.length / (fe * fe));
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (y, D) => (E.current[`${bl}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(y, D), N.current[D] = new Vl(b), N.current[D]?.load(y).then((T) => {
            B(T, D);
          }))
        );
        Promise.all(R).then(() => {
...
function Dl(e, r) {
  const [o, n] = I(Al), {
    ...
    animate: i,
    motionValue: l
  } = Ue(Il), { value: d, animate: c } = Ue($l), { value: u, animate: f } = Ue(Bl), { value: C, animate: p } = Ue(Pl), h = Cs(r, {
    fftSize: 512,
...
function G6({
  ...
  const { speed: u, scale: f, amplitude: C, frequency: p, brightness: h } = Dl(r, s);
  return /* @__PURE__ */ t(
    vr,
    {
      ref: d,
...
const Xl = ({
  ...
  const s = `sparkline-gradient-${Ge().replace(/:/g, "")}`, i = ql(e, o), l = xr[i];
  ...
  (e, r) => {
    const {
      ...
      className: c,
      ...u
    } = e, [f, C] = I(!1), [p, h] = I(!1), m = f || p, x = Le(), v = m && !!d, F = {
      duration: x ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, P = () => {
      l?.();
...
function n6(e) {
  ...
  } = e, [c, u] = I(!1), f = Ge(), C = $(null), p = e6(
    d
  ), h = i.length > p, m = c ? i : t6(i, p), x = r6(e) ? e : null, v = o6(e);
  return q(() => {
    c && C.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
...
}, i6 = (e) => lc[e] ?? dt, a6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: i6(e), size: "md", color: "default" }) }) : null;
function c6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(s6, { icon: l1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
function f6({ credits: e, trigger: r }) {
  const o = G(), [n, s] = I(!1), [i, l] = I(!1), [d, c] = I(!1), [u, f] = I(null), C = _(
    (m) => {
...
function h6({
  ...
  const o = G(), n = Le(), [s, i] = I(!1), [l, d] = I(!1), [c, u] = I(!1), [f, C] = I(null), p = _(
    (v) => {
...
) : e ? /* @__PURE__ */ t(f6, { credits: e, trigger: o }) : null, Y6 = s1, K6 = ({
  historyEnabled: e = !1,
  title: r,
...
function J6({
  ...
  const [i, l] = I([]), [d, c] = I(!1), [u, f] = I(null), [C, p] = I(k6), [h, m] = I(() => /* @__PURE__ */ new Set()), x = _(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);

...
import { useInsertionEffect as Sr, forwardRef as h, useRef as j, useEffect as q, useLayoutEffect as rt, useState as B, useMemo as Q, useCallback as _, createContext as ze, useContext as Be, useId as ot, createElement as Tr, memo as Hr } from "react";
import { cS as Ar, cT as $r, Z as nt, bV as Br, cU as Ir, cV as Pr, cW as jr, cX as Dr, bZ as st, bU as Zr, cY as _r, a6 as s1, cZ as Or, aK as Ur, c_ as zr, c$ as Gr, d0 as Wr, ah as qr, d1 as Xr, cm as Yr, aa as it, ad as Kr, d2 as Qr, ba as i1, a1 as at, S as Ge, bN as ct, bi as Jr, d3 as eo, d4 as to, b3 as ro, cl as oo, $ as Fe, av as no, bm as lt, d5 as so, cj as io, bT as Me, cf as ao, d6 as co, bP as dt, b2 as lo, d7 as fo, d8 as uo, d9 as ho, da as go, db as Co, dc as ft, c8 as po, c9 as mo, dd as vo, de as wo, df as xo, dg as ko, dh as Lo, bw as bo, bX as yo, di as Mo, dj as Eo, dk as Ro, dl as Fo, dm as No, dn as Vo, dp as So, dq as To, bv as Ho, ck as Ao, ab as $o, c4 as Bo, dr as Io, ds as Po, dt as jo, du as Do, dv as Zo, dw as _o, dx as Oo, aq as Uo, bR as ut, M as zo, a0 as Go, bK as ht, bO as Wo, bQ as gt, dy as qo, bl as Xo, bk as Yo, dz as Ko, dA as Qo, bx as Ct, by as Jo, bz as en, b1 as tn, az as rn, dB as on, at as nn, bg as pt, bf as mt, b8 as sn, dC as vt, b7 as an, bW as a1, dD as cn, bc as c1, dE as ln, dF as dn, dG as l1, ch as fn, cg as un, ci as wt, dH as hn, G as gn, E as Cn, dI as pn, dJ as mn, dK as vn, dL as wn, bL as xn, dM as xt, dN as kn, ac as Ln, dO as bn, L as ce, o as k, q as Se, b_ as yn, u as G, bJ as Mn, U as he, bI as kt, H as le, v as ge, a2 as En, Q as pe, dP as Rn, ae as ie, aQ as xe, A as Ee, p as J, cr as Lt, aE as d1, dQ as Fn, aF as f1, aG as u1, b as be, bG as Nn, dR as Vn, bH as Sn, V as Tn, b0 as Hn, a5 as h1, bA as An, bB as $n, bC as Bn, bD as y1, a3 as In, al as bt, aT as yt, dS as Pn, cy as jn, dT as Dn, dU as Zn, aY as Mt, dV as _n, cs as On, dW as Un, aV as $e, b9 as Et, dX as Rt, bb as Ft, c as r1, bY as M1, dY as Nt, dZ as zn, d_ as Gn, bq as Wn, d$ as qn, bh as g1, c5 as Xn, e0 as Yn, e1 as Kn, e2 as Qn, e3 as Jn, e4 as es, a8 as ts, af as rs, y as os, z as ns, ak as E1, e5 as Vt, e6 as St, e7 as ss, e8 as is, aj as as, a7 as cs, e9 as ls, ea as ds, d as fs } from "./F0CanvasPanel-qKA2YZnp.js";
import { createPortal as Tt } from "react-dom";
import { defaultTranslations as us } from "./i18n-provider-defaults.js";
import { useTrackVolume as hs } from "@livekit/components-react";
function gs(e, r, o) {
  Sr(() => e.on(r, o), [e, r, o]);
}
...
const M0 = (e, r) => /* @__PURE__ */ a(
...
), dc = h(lc), fc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: ps,
  Add: Ar,
  Ai: vs,
  ...
  Wifi: dc,
  Windows: bn
}, Symbol.toStringTag, { value: "Module" })), uc = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const Sc = Se({
  ...
  ({
    ...
    const Ne = P && P !== "none" || oe && oe !== "none" || W && W !== "none" || ae && ae !== "none", Pe = X && X !== "none" || Ne, je = { sm: We, md: qe, lg: Xe, xl: Ie }, Qe = Tc.map((De) => {
      const Ze = je[De];
      return Ze ? Vc(De, Ze) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
...
const jc = ({
  ...
  const s = xe(), [i, l] = B(""), [d, c] = B(0), [u, f] = B(!1), C = j(null), p = j(null), g = j(null), m = e[d] ?? r;
  return q(() => {
    const v = () => {
    ...
    return p.current = setInterval(() => {
      x < m.length ? (l(m.slice(0, x + 1)), x++) : (p.current && (clearInterval(p.current), p.current = null), C.current = setTimeout(() => {
        g.current = setInterval(() => {
          x > 0 ? (x--, l(m.slice(0, x))) : (g.current && (clearInterval(g.current), g.current = null), C.current = setTimeout(() => {
            const E = (d + 1) % Math.max(e.length, 1);
            c(E);
          }, S));
        }, I);
...
`) ? o + "_" : o
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, _c).map((r) => /* @__PURE__ */ t(
  Lt,
  {
...
const Gc = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ a(
    d1,
    {
      ...
      children: [
        /* @__PURE__ */ t(Fn, { asChild: !0, children: /* @__PURE__ */ t("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, c) => /* @__PURE__ */ t(f1, { asChild: !0, children: /* @__PURE__ */ t(
          ce,
          {
            variant: "outline",
            label: d.label,
...
function Kc(e) {
  const [r, o] = B([]), [n, s] = B(null), i = j(
    null
  ), l = j(null), d = G(), c = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, C = Q(() => {
    if (u)
      return Array.isArray(u) ? u.join(",") : u;
  }, [u]), p = f !== void 0 && r.length >= f, g = j(0);
  q(() => {
    g.current = r.length;
  }, [r]);
  const m = _((H) => {
...
function r2({
  ...
  const [i, l] = B(!1), [d, c] = B(""), [u, f] = B([]), [C, p] = B(!1), [g, m] = B(0), [v, x] = B([]), N = j(-1), I = j(null), H = j(0), S = j(-1);
  q(() => {
    if (!n) {
      l(!1);
      return;
    ...
    if (V.atIndex === S.current)
      return;
    N.current = V.atIndex, c(V.query), l(!0), m(0), p(!0), I.current && clearTimeout(I.current);
    const $ = ++H.current;
...
` || z === "	";
  ...
  const A = Q(() => {
    ...
    const V = s.current;
    if (!V) return null;
    const $ = e2(V, N.current), U = V.offsetLeft + $.left, z = (V.offsetParent ? V.offsetParent.offsetHeight : 0) - (V.offsetTop + $.top);
...
const o2 = /[\\`*_{}[\]()#+\-.!|~>]/g, n2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(o2, "\\$&")).join(""), $6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const L = G(), M = xe(), [A, F] = B(""), [V, $] = B(0), [U, O] = B(!1), [z, te] = B(!1), [re, Y] = B(null), X = j(null), P = j(null), oe = j(null), W = l != null, { tracking: ae } = be(), ke = _(
    ...
    const we = ye.current, Je = we && !/\s$/.test(we) ? " " : "", _e = `${we}${Je}${K}`;
    F(_e), $(_e.length);
  }, []), He = {
  ...
  const Ie = ve.status === "recording", Ye = Ie ? L.ai.listening : L.ai.inputPlaceholder, Ke = de.filter((K) => K.status === "uploaded"), Ne = de.some((K) => K.status === "uploading"), Pe = de.some((K) => K.status === "error"), je = A.trim().length > 0;
  q(() => {
    if (!(!z || Ne)) {
      if (te(!1), Pe) {
  ...
  const Qe = async (K) => {
    if (K.preventDefault(), !W) {
      if (ee.close(), o)
        ...
        const we = ee.transformMentions(A.trim()), Je = n2(we), _e = Ke.flatMap(
  ...
  }, m1 = re ? re.prompt ?? re.title : null, v1 = Ie ? [L.ai.listening] : m1 ? [m1] : s ?? [], Er = v1.length > 1, Rr = Q(() => Wc(A, ee.mentions, {
    cursorPosition: V,
  ...
  ) : null, Nr = N && I && !!E && E.length > 0, x1 = I && N, { motionProps: Vr } = Vn(
    N,
    160,
    0.5
  );
    ...
    J.div,
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(Ic, { creditWarning: i, children: /* @__PURE__ */ a(
            J.form,
            {
              "aria-busy": o,
              ref: X,
                        ...
                        J.div,
                        {
                          ...
                          children: /* @__PURE__ */ a(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ t("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ t(Sn, { type: "critical", size: "sm" }) }),
        ...
        Nr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(Oc, { cards: E }) }),
...
function d2({
  ...
  return /* @__PURE__ */ t(Hn, { ...r, variant: "link", href: r.href, children: e });
}
function f2({
  children: e,
  ...r
...
function Te({
  ...
  const g = _(() => {
    ...
    u(!0), C(!1), o(e).then((x) => {
      i.current.set(e, x), p.current && d(x);
    }).catch(() => {
      p.current && C(!0);
    }).finally(() => {
      p.current && u(!1);
  ...
  return /* @__PURE__ */ a(
    An,
    {
      ...
      children: [
        /* @__PURE__ */ t($n, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          Bn,
          {
            side: "top",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ t(Pn, { file: e.file, size: "lg" }),
...
function I6({
  ...
  return /* @__PURE__ */ t(p1.Provider, { value: i, children: e });
}
function A2(e) {
  const o = Be(p1)?.formatters;
...
const F1 = 7, $2 = 625, N1 = /* @__PURE__ */ new Set();
function B2(e) {
...
function P2(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = Dn(e), i = [];
...
function ar(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: P2(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? B2(o) : "") || "—" };
  }
  ...
  return { type: "item", text: I2(String(e)) };
}
function cr({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = be(), C = A2(e), p = d ?? C, g = j(() => {
  ...
  g.current = N, q(() => {
    typeof window > "u" || window.innerWidth < $2 || N1.has(e) || (N1.add(e), g.current());
  }, [e]);
...
const fr = ze(void 0), j6 = () => Be(fr), _2 = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), O2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, C = j(null), { anchor: p, clear: g } = lr({
    containerRef: C,
    enabled: !!(o?.id && d)
  });
  return q(() => {
...
const W2 = ({
  ...
  const [d, c] = B(s), u = xe(), f = n !== void 0, C = f ? n : d;
  return /* @__PURE__ */ a(
    Et,
    {
...
const gr = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), Q2 = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = K2(
    e?.content,
    l
  ), c = (Y2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: C, clear: p } = lr({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
...
}, el = 35, tl = 22, rl = 400, ol = 2500, nl = 220, sl = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  ...
  q(() => {
    ...
    let p;
    if (d === "starting")
      p = setTimeout(() => c("writing"), rl);
    else if (d === "writing")
      i < u.length ? p = setTimeout(() => l((g) => g + 1), el) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), ol);
    } else d === "erasing" && (i > 0 ? p = setTimeout(() => l((g) => g - 1), tl) : p = setTimeout(() => {
...
function il({
  ...
  const [l, d] = B(0), [c, u] = B(!1), f = j(s), C = j(i);
  C.current = i;
  const p = _(
    (m = "smooth") => {
...
const al = {
...
}, D6 = (e) => /* @__PURE__ */ t(z2, { children: /* @__PURE__ */ t(cl, { ...e }) }), cl = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: H, handleSubmit: S, handleClose: E } = G2(
    f ?? al
  ), w = G(), L = v ?? O2, M = x ?? J2, A = Q(() => {
    const P = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(P) ? P : [P]).filter((W) => typeof W == "string" && W.length > 0);
  }, [n, w.ai.defaultInitialMessage]), F = !r && e.length === 0 && A.length > 0, V = j(null), $ = j(null), U = j(null), O = j(null), z = j(null), { showScrollBtn: te, turnMinHeight: re, scrollToBottom: Y } = il({
    viewportRef: V,
    contentRef: $,
    endRef: U,
    lastTurnRef: z,
...
}, ll = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
...
const fl = ({
  ...
  const p = G().ai.clarifyingQuestion.typeYourAnswer, g = e === "single" ? /* @__PURE__ */ t(pr, { isSelected: o && !r }) : /* @__PURE__ */ t(
    Nt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
  ...
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: ae, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      J.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ke, ease: Cl },
        children: [
          /* @__PURE__ */ t(
            gl,
            {
...
function A1(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (W) => W / e * 2 - 1, C = (W) => W / r * 2 - 1, p = 0, g = e, m = 0, v = r, x = c, N = e - c, I = u, H = r - u, S = f(p), E = f(g), w = C(m), L = C(v), M = f(x), A = f(N), F = C(I), V = C(H), $ = 0, U = 0, O = 1, z = 1, te = c / e, re = 1 - c / e, Y = u / r, X = 1 - u / r, P = new Float32Array([
    // Top strip
    S,
    w,
    E,
...
class G6 {
  ...
  setupGL() {
    ...
    const p = r.getUniformLocation(o, "uResolution"), g = r.getUniformLocation(o, "uTime"), m = r.getUniformLocation(o, "uBorderWidth"), v = r.getUniformLocation(o, "uGlowWidth"), x = r.getUniformLocation(o, "uBorderRadius"), N = r.getUniformLocation(o, "uColors"), I = r.getUniformLocation(o, "uGlowExponent"), H = r.getUniformLocation(o, "uGlowFactor");
    ...
    const S = (this.options.colors || kl).map(Ll);
...
const B1 = ["lowp", "mediump", "highp"], bl = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, yl = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, P1 = "iTime", j1 = "iTimeDelta", D1 = "iDate", Z1 = "iFrame", _1 = "iMouse", O1 = "iResolution", Ml = "iChannel", U1 = "iChannelResolution", z1 = "iDeviceOrientation";
function El(e, r) {
...
}, t1 = 9729, G1 = 9728, Sl = 9987, W1 = 33071, q1 = 10497;
class Tl {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    const C = 0, p = o.RGBA, g = 1, m = 1, v = 0, x = o.RGBA, N = o.UNSIGNED_BYTE, I = new Uint8Array([255, 255, 255, 0]), H = o.createTexture();
...
}, Y1 = (e, r, o) => e * (1 - o) + r * o, Hl = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function Al({
  fs: e,
  vs: r = I1,
  textures: o = [],
  ...
  const g = j(null), m = j(null), v = j(null), x = j(null), N = j(void 0), I = j(void 0), H = j(!1), S = j(void 0), E = j(0), w = j([0, 0]), L = j([]), M = j(0), A = j(void 0), F = j({
...
${R}`));
      ...
      y.deleteShader(D), C?.(Le(`Shader compiler log: ${T}`));
    }
    return D;
  }, oe = (b, R) => {
    const y = m.current;
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (y, D) => (F.current[`${Ml}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, $(y, D), L.current[D] = new Tl(b), L.current[D]?.load(y).then((T) => {
            $(T, D);
          }))
        );
        Promise.all(R).then(() => {
...
`,
    ...
    return b.includes("mainImage") && (D = D.concat(bl)), D;
  }, de = (b) => {
    const R = m.current;
    ...
    const b = { passive: !0 };
    F.current.iMouse?.isNeeded && g.current && (g.current.addEventListener("mousemove", re, b), g.current.addEventListener("mouseout", Y, b), g.current.addEventListener("mouseup", Y, b), g.current.addEventListener("mousedown", te, b), g.current.addEventListener("touchmove", re, b), g.current.addEventListener("touchend", Y, b), g.current.addEventListener("touchstart", te, b)), F.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      z,
      b
    ), g.current && (A.current = new ResizeObserver(X), A.current.observe(g.current), window.addEventListener("resize", X, b));
  }, me = () => {
    const b = { passive: !0 };
    F.current.iMouse?.isNeeded && g.current && (g.current.removeEventListener("mousemove", re, b), g.current.removeEventListener("mouseout", Y, b), g.current.removeEventListener("mouseup", Y, b), g.current.removeEventListener("mousedown", te, b), g.current.removeEventListener("touchmove", re, b), g.current.removeEventListener("touchend", Y, b), g.current.removeEventListener("touchstart", te, b)), F.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      z,
      b
  ...
  return q(() => {
    ...
    function R() {
      U();
      const y = m.current;
      y && g.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, W(), ae(), oe(ke(e || yl), r || I1), O(), requestAnimationFrame(ne), fe(), X());
    }
...
}`, Bl = 10, Il = 2, Pl = 0.5, jl = 0.2, Dl = 1.5, Ce = {
  duration: 0.5,
  ease: "easeOut"
}, K1 = {
  duration: 0.35,
...
function Zl(e, r) {
  const [o, n] = B(Bl), {
    ...
    animate: i,
    motionValue: l
  } = Oe(jl), { value: d, animate: c } = Oe(Il), { value: u, animate: f } = Oe(Pl), { value: C, animate: p } = Oe(Dl), g = hs(r, {
    fftSize: 512,
...
function W6({
  ...
  const { speed: u, scale: f, amplitude: C, frequency: p, brightness: g } = Zl(r, s);
  return /* @__PURE__ */ t(
    vr,
    {
      ref: d,
...
const q6 = ({
  ...
  const n = G(), s = xe();
  return /* @__PURE__ */ a(Re, { children: [
    e && /* @__PURE__ */ t("span", { className: k(zl(), "truncate"), children: e }),
      ...
      J.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ a("div", { className: "flex items-center gap-1", children: [
            ...
            o && /* @__PURE__ */ t("span", { className: k(Ue()), children: o })
          ] }),
          n === "people" && /* @__PURE__ */ t(
            Wn,
            {
          ...
          n === "alert" && /* @__PURE__ */ t(Xn, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ t(ql, { balance: e.balance })
        ]
      }
    ),
    o && !Wl.has(n) && /* @__PURE__ */ t(
      J.span,
      {
        className: k(Ue()),
        animate: { opacity: s ? 0 : 1 },
...
const Kl = ({
  ...
  const s = `sparkline-gradient-${ot().replace(/:/g, "")}`, i = Yl(e, o), l = xr[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(Kn, { width: "100%", height: "100%", children: /* @__PURE__ */ a(
          Qn,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(Jn, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                es,
                {
                  type: "linear",
  ...
  (e, r) => {
    const {
      ...
      className: c,
      ...u
    } = e, [f, C] = B(!1), [p, g] = B(!1), m = f || p, v = xe(), x = m && !!d, N = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, I = () => {
      l?.();
...
const t6 = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], br = 180, r6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : br, o6 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, n6 = (e) => e.showActions !== !1, s6 = (e) => Object.fromEntries(
...
function i6(e) {
  ...
  } = e, [c, u] = B(!1), f = ot(), C = j(null), p = r6(
    d
  ), g = i.length > p, m = c ? i : o6(i, p), v = n6(e) ? e : null, x = s6(e);
  return q(() => {
    c && C.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
...
}, c6 = (e) => fc[e] ?? ft, l6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: c6(e), size: "md", color: "default" }) }) : null;
function d6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(a6, { icon: c1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
function h6({ credits: e, trigger: r }) {
  const o = G(), [n, s] = B(!1), [i, l] = B(!1), [d, c] = B(!1), [u, f] = B(null), C = _(
    (m) => {
  ...
  if (!e) return null;
  const p = u ? Math.min(100, Math.round(u.used / u.total * 100)) : 0, g = e.companyName;
  return /* @__PURE__ */ a(d1, { open: n, onOpenChange: C, children: [
...
function C6({
  ...
  const o = G(), n = xe(), [s, i] = B(!1), [l, d] = B(!1), [c, u] = B(!1), [f, C] = B(null), p = _(
    (x) => {
  ...
  if (!e) return null;
  const g = !!e.companyName, m = f && f.total > 0 ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, v = f ? Math.max(0, f.total - f.used) : 0;
  return /* @__PURE__ */ a(d1, { open: s, onOpenChange: p, children: [
    /* @__PURE__ */ t(f1, { asChild: !0, children: r ?? /* @__PURE__ */ t(
      ce,
      {
        variant: "ghost",
...
const n1 = ({
...
) : e ? /* @__PURE__ */ t(h6, { credits: e, trigger: o }) : null, K6 = n1, Q6 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const g = G(), m = os(`(max-width: ${ns.md}px)`, {
        ...
        /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ t(
          $e,
          {
            ...
            children: /* @__PURE__ */ a("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ t(ie, { lines: 1, className: "min-w-0 text-left", children: o ?? g.ai.newConversation }),
...
function p6() {
  if (!(typeof navigator > "u"))
    return as(navigator.language);
}
function m6(e) {
  const r = new Date(e), o = /* @__PURE__ */ new Date();
  return Vt(r) ? "today" : St(r) ? "yesterday" : is(r, o) ? "thisMonth" : "older";
}
function v6(e, r) {
  const o = new Date(e), n = p6(), s = E1(o, "p", { locale: n });
  if (Vt(o)) return `${r.today}, ${s}`;
  if (St(o)) return `${r.yesterday}, ${s}`;
  const i = !ss(o, /* @__PURE__ */ new Date());
...
const J1 = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], k6 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(he, { className: k("h-4 rounded", e) }) }), et = ({
  titleWidth: e,
  rows: r
...
function e4({
  ...
  const [i, l] = B([]), [d, c] = B(!1), [u, f] = B(null), [C, p] = B(b6), [g, m] = B(() => /* @__PURE__ */ new Set()), v = _(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);
  ...
  const x = _((w, L) => {
    ...
    async (w) => {
      N(w, !0);
      try {
        await o(w), l((L) => L.filter((M) => M.id !== w)), p((L) => {
          if (!L.has(w)) return L;
          const M = new Set(L);

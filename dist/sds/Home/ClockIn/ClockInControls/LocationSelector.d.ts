...
export declare const toLocationTree: (locations: ClockInLocation[]) => TreeSelectorItem[];
/**
 ...
 */
export declare function LocationSelector({ locations, locationId, onChangeLocationId, label, searchPlaceholder, required, disabled, }: LocationSelectorProps): import("react").JSX.Element;

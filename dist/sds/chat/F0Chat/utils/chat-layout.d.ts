export declare const CHAT_COMPOSER_HEIGHT_PROPERTY = "--f0-chat-composer-overlay-height";
/**
 ...
 */
export declare const CHAT_COMPOSER_HEIGHT = "var(--f0-chat-composer-overlay-height, 7.5rem)";

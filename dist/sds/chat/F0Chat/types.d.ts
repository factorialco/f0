...
import { VideoPlayerContent } from '../../../components/F0VideoPlayer';
...
export type F0ChatAttachment = F0ChatImageAttachment | F0ChatFileAttachment | F0ChatLocationAttachment | F0ChatVoiceAttachment | F0ChatCardAttachment;
/**
 ...
 */
export type F0ChatComposableAttachment = Exclude<F0ChatAttachment, F0ChatCardAttachment>;
/**
 ...
 * `readBy` / `readByCount`.
 */
export type F0ChatMessageStatus = "sending" | "sent" | "delivered" | "read" | "failed";
 ...
 */
export type F0ChatSystemEvent = "member.added" | "member.removed" | "member.left";
 ...
 */
export type F0ChatStatus = "connecting" | "ready" | "reconnecting" | "offline" | "error";
/**
 ...
 * all of them. */
export type F0ChatReactionSource = "quickRow" | "menuPicker" | "existingPill" | "inlinePicker";

import { S as L, m as ye, g as Z, n as Se, o as Re, i as ke, j as _e, k as Ne, q as Ce, l as Le, w as Fe, r as Ve, s as Te } from "./F0CanvasPanel-_W3I4tue.js";
...
import { e as Ee, D as Ue, P as je, c as De } from "./pdfWorker-zLQ-tyob.js";
import { F as We } from "./Printer-BD-FEi_2.js";
import { d as ae } from "./tooltip-B1FTntAE.js";
import './index.css';const Oe = ({
  ...
  return a.forEach((l, d) => {
    if (!l)
      return;
    const g = l.offsetHeight, m = l.offsetTop, v = m + g, k = o.offsetHeight - e, P = o.scrollTop + e, p = P + k;
    if (!(P < v && p > m))
      return;
    let x;
    if (P <= m)
...
Ee();
const qe = J(() => import("./SheetViewer-BN1ihTU4.js")), Ge = J(() => import("./DocxViewer-qiIB-ZUY.js")), Ze = J(() => import("./TextViewer-DD6hYL5G.js")), oe = 48, le = ne(
  (o, a) => {

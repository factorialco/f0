import { fs as Mr, al as ae, by as An, t as B, w as xt, ft as Ir, v as bt, du as Io, av as Br, Y as he, u as re, N as se, fj as Xt, fu as Wt, K as Bo, D as Po, Q as Pr, fv as gn, am as Me, aa as pi, fw as Ho, fx as Wo, fy as qo, fz as tr, fA as $o, fB as Go, fC as Hr, fD as jo, aS as vi, aT as bi, A as Ln, aU as yi, aB as Wr, cF as pn, fE as qr, fF as Uo, e8 as Vo, fG as nr, e6 as Qo, fH as Ko, fI as wt, fJ as Yt, fK as Xo, fL as Yo, an as We, aG as Jo, cU as ci, cT as $r, fM as Zo, c3 as ea, fN as Gr, fO as ta, fP as On, eX as xi, fQ as na, a7 as wi, W as ce, a8 as ia, a9 as qt, bV as ra, at as zn, ff as Ci, ab as sa, fR as oa, fS as aa, fT as la, cp as ca, m as da, dd as ua, M as jr, eZ as ft, fU as Ur, fV as Vr, bY as Si, fW as Qr, O as Ni, P as Ei, fX as Di, V as _i, a0 as Re, a2 as yt, fY as Ot, fZ as zt, U as Mt, f_ as It, f$ as ha, g0 as At, g1 as Kr, aI as fa, g2 as vn, br as $t, g3 as _e, cf as ma, g4 as Gt, ce as ga, cd as pa, g5 as va, g6 as ba, bs as Mn, a3 as In, bo as Ri, bt as ki, aR as ya, g7 as Oe, g8 as xa, g9 as wa, ga as Xr, gb as Bn, gc as Ca, gd as Sa, ck as Yr, b_ as Jr, ge as Na, gf as Ea, gg as Da, gh as _a, b3 as Zr, b9 as Ra, fm as ka, fn as Ta, fp as Fa, gi as es, bA as Ct, bE as St, bM as Jt, gj as Ti, gk as Aa, bB as La, bk as Oa, X as ts, ag as za, a5 as Ma } from "./useDataCollectionSource-DOo2SyQt.js";
import { gM as Wf, d as qf, cb as $f, l as Gf, gY as jf, b2 as Uf, k as Vf, F as Qf, a as Kf, C as Xf, gE as Yf, b as Jf, gt as Zf, bO as em, bl as tm, bP as nm, gm as im, aW as rm, ad as sm, aA as om, gn as am, aJ as lm, c1 as cm, gr as dm, gs as um, gu as hm, h1 as fm, bb as mm, n as gm, aL as pm, bG as vm, gH as bm, bf as ym, gI as xm, gK as wm, gL as Cm, cR as Sm, cP as Nm, e as Em, h as Dm, gN as _m, cB as Rm, cC as km, au as Tm, gl as Fm, h0 as Am, b8 as Lm, cQ as Om, gJ as zm, cD as Mm, c2 as Im, h2 as Bm, go as Pm, gp as Hm, gq as Wm, cE as qm, gX as $m, gS as Gm, gG as jm, gA as Um, gz as Vm, gy as Qm, gV as Km, gR as Xm, b6 as Ym, cA as Jm, cx as Zm, cz as eg, cw as tg, gB as ng, gQ as ig, gP as rg, gC as sg, cj as og, cy as ag, gw as lg, gx as cg, gD as dg, g as ug, c as hg, gO as fg, gT as mg, gZ as gg, g_ as pg, g$ as vg, b4 as bg, gF as yg, gv as xg, i as wg, gU as Cg, bz as Sg, b1 as Ng, gW as Eg, j as Dg, f as _g, h3 as Rg } from "./useDataCollectionSource-DOo2SyQt.js";
import { jsx as l, jsxs as x, Fragment as we } from "react/jsx-runtime";
import le, { forwardRef as Ze, useRef as W, useImperativeHandle as Ia, Children as bn, createContext as Ke, useContext as ke, useState as G, useMemo as P, useEffect as U, useCallback as I, useLayoutEffect as di, isValidElement as ns, Fragment as Ba, memo as is, useReducer as Pa, cloneElement as Ha, useId as rs } from "react";
import { t as Wa, v as qa, w as ss, x as $a, y as Ga, z as Pn, B as ja, E as Fi, G as Ua, H as Va, I as os, J as yn, K as Ai, L as as, N as Qa, O as ls, P as ir, Q as Ka } from "./F0AiProposalCard-CktzUH_D.js";
import { A as Tg, U as Fg, C as Ag, c as Lg, D as Og, a as zg, b as Mg, S as Ig, e as Bg, f as Pg, g as Hg, h as Wg, p as qg, l as $g, r as Gg, m as jg, R as Ug, $ as Vg, n as Qg, i as Kg, a4 as Xg, F as Yg, d as Jg, V as Zg, W as ep, X as tp, Y as np, M as ip, Z as rp, _ as sp, k as op, j as ap, T as lp, q as cp, a2 as dp, a1 as up, o as hp, s as fp, u as mp, a3 as gp, a5 as pp, a0 as vp } from "./F0AiProposalCard-CktzUH_D.js";
import { createPortal as cs, unstable_batchedUpdates as on } from "react-dom";
import { C as Xa, D as Ya, E as Ja, l as Za } from "./index-C8Eyc8Ho.js";
import { n as yp, o as xp, p as wp, u as Cp, F as Sp, q as Np, x as Ep, y as Dp, N as _p, z as Rp, r as kp, P as Tp, t as Fp, R as Ap, s as Lp, j as Op, k as zp, w as Mp, v as Ip } from "./index-C8Eyc8Ho.js";
...
import './f0.css';const el = {
  ...
  md: 2,
  lg: 2
}, tl = Ze(function({ widgets: e, children: t }, i) {
  const r = W(null);
  Ia(i, () => r.current);
  const s = bn.toArray(e).filter((o) => !!o).map((o, a) => /* @__PURE__ */ l("div", { className: "h-full @5xl:h-auto [&>div]:h-full", children: o }, a));
  return /* @__PURE__ */ l(Mr, { layout: "home", children: /* @__PURE__ */ x("div", { ref: r, className: "@container", children: [
    /* @__PURE__ */ x("div", { className: "flex flex-col gap-6 px-5 pt-4 @md:pt-2 @5xl:hidden", children: [
      /* @__PURE__ */ l(Xa, { columns: el, showArrows: !1, children: s }),
...
}), ds = le.forwardRef(({ children: n, variant: e, className: t, ...i }, r) => /* @__PURE__ */ l(Mr, { layout: "standard", children: /* @__PURE__ */ l(
  "section",
  {
    ref: r,
    className: B("relative flex-1 overflow-auto", t),
    ...i,
    children: /* @__PURE__ */ l("div", { className: B(nl({ variant: e })), children: n })
  }
) }));
...
function dl({
  ...
  const [a, d] = G(null), u = W(null), c = W(!1), h = P(() => ({
    ...e,
    children: (r || []).map((b) => pt(b))
  }), [e, r]), [f, m] = G(() => {
    const b = /* @__PURE__ */ new Map(), S = r || [], k = (T) => {
  ...
  Ir(() => {
    ...
    if (!Array.isArray(b))
      return;
    const S = b.map((A) => A.id), k = r || [], T = k.map((A) => A.id), E = k.filter(
      (A) => !S.includes(A.id)
    );
    ...
    if (_.length > 0) {
      ...
      _.forEach((O) => {
        ...
        if (M.length > 0) {
          const K = {}, Y = ["w", "h", "x", "y"], V = ["noMove", "noResize", "locked"], ne = M.filter(
            (q) => Y.includes(q)
          ), Z = M.filter(
            (q) => V.includes(q)
          );
          if (ne.length > 0 && Z.length > 0 && ne.length + Z.length === M.length ? Z.forEach((q) => {
            const ie = O[q];
            ie !== void 0 && (K[q] = ie);
          }) : M.forEach((q) => {
            const ie = O[q];
  ...
  const N = I(() => {
    ...
    if (Array.isArray(b)) {
      const S = b.map((k) => {
        const T = k.id;
        if (!T) return null;
        const E = p.current.get(T), L = y.current.get(T), _ = k;
        return {
          ...k,
          id: T,
          w: k.w ?? 1,
  ...
  return U(() => {
    ...
    try {
      a.on("resizestop", b), a.on("change added removed", N);
    } catch (S) {
    ...
    a && a.el && a.el.parentElement && c.current && N();
  }, [a]), /* @__PURE__ */ l(
    us.Provider,
    {
      value: {
...
const hl = Ke(null);
function fl() {
  const { _reactContentMap: n } = hs(), { getWidgetContainer: e } = ul();
  return /* @__PURE__ */ l(we, { children: Array.from(n.value.entries()).map(([t, i]) => {
    const r = e(t);
    return r ? /* @__PURE__ */ l(hl.Provider, { value: { widget: { id: t } }, children: i && cs(i, r) }, t) : (console.error(`Widget container not found for widget ${t}`), null);
  }) });
}
...
class D {
    ...
    return t.forEach((i) => {
      for (const r in i) {
        if (!i.hasOwnProperty(r))
          return;
        e[r] === null || e[r] === void 0 ? e[r] = i[r] : typeof i[r] == "object" && typeof e[r] == "object" && D.defaults(e[r], i[r]);
      }
    }), e;
  }
  /**
  ...
  static removeInternalAndSame(e, t) {
    if (!(typeof e != "object" || typeof t != "object"))
      for (let i in e) {
        const r = e[i], s = t[i];
        i[0] === "_" || r === s ? delete e[i] : r && typeof r == "object" && s !== void 0 && (D.removeInternalAndSame(r, s), Object.keys(r).length || delete e[i]);
      }
  }
  ...
  static updateScrollResize(e, t, i) {
    const r = D.getScrollElement(t), s = r.clientHeight, o = r === D.getScrollElement() ? 0 : r.getBoundingClientRect().top, a = e.clientY - o, d = a < i, u = a > s - i;
   ...
   */
  static cloneDeep(e) {
    const t = ["parentGrid", "el", "grid", "subGrid", "engine"], i = D.clone(e);
    for (const r in i)
      i.hasOwnProperty(r) && typeof i[r] == "object" && r.substring(0, 2) !== "__" && !t.find((s) => s === r) && (i[r] = D.cloneDeep(e[r]));
    return i;
  }
  ...
  static appendTo(e, t) {
    let i;
    typeof t == "string" ? i = D.getElement(t) : i = t, i && i.appendChild(e);
  }
...
class it {
  ...
  _fixCollisions(e, t = e, i, r = {}) {
    ...
    for (; i = i || this.collide(e, s, r.skip); ) {
      ...
      (!this.collide(i, { ...i, y: e.y }, e) || !this.collide(i, { ...i, y: t.y - i.h }, e))) {
        ...
        u = this._loading && D.samePos(e, c) ? !0 : this.moveNode(e, c), (i.locked || this._loading) && u ? D.copyPos(t, e) : !i.locked && u && r.pack && (this._packNodes(), t.y = i.y + i.h, D.copyPos(e, t)), o = o || u;
      } else
  ...
  collide(e, t = e, i) {
    ...
    return this.nodes.find((o) => o._id !== r && o._id !== s && D.isIntercepted(o, t));
  }
  /**
  ...
  collideAll(e, t = e, i) {
    const r = e._id, s = i?._id;
    return this.nodes.filter((o) => o._id !== r && o._id !== s && D.isIntercepted(o, t));
  }
  ...
  */
  ...
  swap(e, t) {
    ...
    let r;
    if (e.w === t.w && e.h === t.h && (e.x === t.x || e.y === t.y) && (r = D.isTouching(e, t)))
      return i();
    if (r !== !1) {
      if (e.w === t.w && e.x === t.x && (r || (r = D.isTouching(e, t)))) {
        if (t.y < e.y) {
          const s = e;
          e = t, t = s;
        }
      ...
      if (r !== !1) {
        if (e.h === t.h && e.y === t.y && (r || (r = D.isTouching(e, t)))) {
          if (t.x < e.x) {
            const s = e;
            e = t, t = s;
          }
  ...
  prepareNode(e, t) {
    ...
    return D.defaults(e, r), e.autoPosition || delete e.autoPosition, e.noResize || delete e.noResize, e.noMove || delete e.noMove, D.sanitizeMinMax(e), typeof e.x == "string" && (e.x = Number(e.x)), typeof e.y == "string" && (e.y = Number(e.y)), typeof e.w == "string" && (e.w = Number(e.w)), typeof e.h == "string" && (e.h = Number(e.h)), isNaN(e.x) && (e.x = r.x, e.autoPosition = !0), isNaN(e.y) && (e.y = r.y, e.autoPosition = !0), isNaN(e.w) && (e.w = r.w), isNaN(e.h) && (e.h = r.h), this.nodeBoundFix(e, t), e;
  }
  /**
  ...
  nodeBoundFix(e, t) {
    ...
    return e.w > this.column ? e.w = this.column : e.w < 1 && (e.w = 1), this.maxRow && e.h > this.maxRow ? e.h = this.maxRow : e.h < 1 && (e.h = 1), e.x < 0 && (e.x = 0), e.y < 0 && (e.y = 0), e.x + e.w > this.column && (t ? e.w = this.column - e.x : e.x = this.column - e.w), this.maxRow && e.y + e.h > this.maxRow && (t ? e.h = this.maxRow - e.y : e.y = this.maxRow - e.h), D.samePos(e, i) || (e._dirty = !0), this;
  }
  /**
  ...
  findEmptyPosition(e, t = this.nodes, i = this.column, r) {
    ...
    for (let a = s; !o; ++a) {
      ...
      t.find((h) => D.isIntercepted(c, h)) || ((e.x !== d || e.y !== u) && (e._dirty = !0), e.x = d, e.y = u, delete e.autoPosition, o = !0);
    }
    return o;
  }
  /**
  ...
  willItFit(e) {
    ...
    return this.cleanupNode(i), delete i.el, delete i._id, delete i.content, delete i.grid, t.addNode(i), t.getRow() <= this.maxRow ? (e._willFitPos = D.copyPos({}, i), !0) : !1;
  }
  ...
  moveNode(e, t) {
    ...
    const r = e.w !== t.w || e.h !== t.h, s = D.copyPos({}, e, !0);
    if (D.copyPos(s, t), this.nodeBoundFix(s, r), D.copyPos(t, s), !t.forceCollide && D.samePos(e, t))
      return !1;
    ...
    if (a.length) {
      ...
      if (u && c && e.grid?.opts?.subGridDynamic && !e.grid._isTemp) {
        const h = D.areaIntercept(t.rect, c._rect), f = D.area(t.rect), m = D.area(c._rect);
        h / (f < m ? f : m) > 0.8 && (c.grid.makeSubGrid(c.el, void 0, e), c = void 0);
      }
      c ? d = !this._fixCollisions(e, s, c, t) : (d = !1, i && delete t.pack);
    }
    return d && !D.samePos(e, s) && (e._dirty = !0, D.copyPos(e, s)), t.pack && this._packNodes()._notify(), !D.samePos(e, o);
  }
  getRow() {
  ...
  */
  save(e = !0, t, i) {
    ...
    return this.sortNodes(), this.nodes.forEach((a) => {
      ...
      D.removeInternalForSave(u, !e), t && t(a, u), o.push(u);
    }), o;
  }
  ...
  columnChanged(e, t, i = "moveScale") {
    ...
    let s = [], o = r ? this.nodes : D.sort(this.nodes, -1);
...
const Ue = typeof window < "u" && typeof document < "u" && ("ontouchstart" in document || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0);
class Je {
}
function xn(n, e) {
  n.touches.length > 1 || (n.cancelable && n.preventDefault(), D.simulateMouseEvent(n.changedTouches[0], e));
}
function ms(n, e) {
  n.cancelable && n.preventDefault(), D.simulateMouseEvent(n, e);
}
function wn(n) {
  Je.touchHandled || (Je.touchHandled = !0, xn(n, "mousedown"));
}
function Cn(n) {
  Je.touchHandled && xn(n, "mousemove");
}
function Sn(n) {
  if (!Je.touchHandled)
    return;
  Je.pointerLeaveTimeout && (window.clearTimeout(Je.pointerLeaveTimeout), delete Je.pointerLeaveTimeout);
  const e = !!Q.dragElement;
  xn(n, "mouseup"), e || xn(n, "click"), Je.touchHandled = !1;
}
function Nn(n) {
...
function sr(n) {
  Q.dragElement && n.pointerType !== "mouse" && (Je.pointerLeaveTimeout = window.setTimeout(() => {
    delete Je.pointerLeaveTimeout, ms(n, "mouseleave");
  }, 10));
}
class Hn {
  constructor(e, t, i) {
  ...
  _init() {
    ...
    return e.classList.add("ui-resizable-handle"), e.classList.add(`${Hn.prefix}${this.dir}`), e.style.zIndex = "100", e.style.userSelect = "none", this.host.appendChild(this.el), this.el.addEventListener("mousedown", this._mouseDown), Ue && (this.el.addEventListener("touchstart", wn), this.el.addEventListener("pointerdown", Nn)), this;
  }
  /** call this when resize handle needs to be removed and cleaned up */
  destroy() {
    return this.moving && this._mouseUp(this.mouseDownEvent), this.el.removeEventListener("mousedown", this._mouseDown), Ue && (this.el.removeEventListener("touchstart", wn), this.el.removeEventListener("pointerdown", Nn)), this.host.removeChild(this.el), delete this.el, delete this.host, this;
  }
  /** @internal called on mouse down on us: capture move on the entire document (mouse might not stay on us) until we release the mouse */
  _mouseDown(e) {
    this.mouseDownEvent = e, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), Ue && (this.el.addEventListener("touchmove", Cn), this.el.addEventListener("touchend", Sn)), e.stopPropagation(), e.preventDefault();
  }
  /** @internal */
  _mouseMove(e) {
  ...
  /** @internal */
  _mouseUp(e) {
    this.moving && (this._triggerEvent("stop", e), document.removeEventListener("keydown", this._keyEvent)), document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), Ue && (this.el.removeEventListener("touchmove", Cn), this.el.removeEventListener("touchend", Sn)), delete this.moving, delete this.mouseDownEvent, e.stopPropagation(), e.preventDefault();
  }
...
class jt extends Li {
  ...
  /** @internal */
  _setupHandlers() {
    return this.handlers = this.option.handles.split(",").map((e) => e.trim()).map((e) => new Hn(this.el, e, {
      start: (t) => {
        this._resizeStart(t);
      },
      stop: (t) => {
  ...
  _resizing(e, t) {
    ...
    const i = D.initEvent(e, { type: "resize", target: this.el });
...
const gl = 'input,textarea,button,select,option,[contenteditable="true"],.ui-resizable-handle';
class Ut extends Li {
  constructor(e, t = {}) {
  ...
  enable() {
    this.disabled !== !1 && (super.enable(), this.dragEls.forEach((e) => {
      e.addEventListener("mousedown", this._mouseDown), Ue && (e.addEventListener("touchstart", wn), e.addEventListener("pointerdown", Nn));
    }), this.el.classList.remove("ui-draggable-disabled"));
  }
  disable(e = !1) {
    this.disabled !== !0 && (super.disable(), this.dragEls.forEach((t) => {
      t.removeEventListener("mousedown", this._mouseDown), Ue && (t.removeEventListener("touchstart", wn), t.removeEventListener("pointerdown", Nn));
  ...
  _mouseDown(e) {
    if (!Q.mouseHandled)
      return e.button !== 0 || !this.dragEls.find((t) => t === e.target) && e.target.closest(gl) || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e, delete this.dragging, delete Q.dragElement, delete Q.dropElement, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), Ue && (e.currentTarget.addEventListener("touchmove", Cn), e.currentTarget.addEventListener("touchend", Sn)), e.preventDefault(), document.activeElement && document.activeElement.blur(), Q.mouseHandled = !0), !0;
  }
  ...
  _mouseMove(e) {
    ...
    if (this.lastDrag = e, this.dragging)
      ...
      i ? Q.dropElement = i.el.ddElement.ddDroppable : delete Q.dropElement, this.helper = this._createHelper(), this._setupHelperContainmentStyle(), this.dragTransform = D.getValuesFromTransformedElement(this.helperContainment), this.dragOffset = this._getDragOffset(e, this.el, this.helperContainment), this._setupHelperStyle(e);
      const r = D.initEvent(e, { target: this.el, type: "dragstart" });
  ...
  _mouseUp(e) {
    if (document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), Ue && e.currentTarget && (e.currentTarget.removeEventListener("touchmove", Cn, !0), e.currentTarget.removeEventListener("touchend", Sn, !0)), this.dragging) {
  ...
  _createHelper() {
    let e = this.el;
    return typeof this.option.helper == "function" ? e = this.option.helper(this.el) : this.option.helper === "clone" && (e = D.cloneNode(this.el)), e.parentElement || D.appendTo(e, this.option.appendTo === "parent" ? this.el.parentElement : this.option.appendTo), this.dragElementOriginStyle = Ut.originStyleProp.map((t) => this.el.style[t]), e;
  }
...
class pl extends Li {
  ...
  _mouseLeave(e, t = !1) {
    ...
    const i = D.initEvent(e, { target: this.el, type: "dropout" });
...
class Oi {
  ...
  setupDroppable(e) {
    return this.ddDroppable ? this.ddDroppable.updateOption(e) : this.ddDroppable = new pl(this.el, e), this;
  }
  cleanDroppable() {
...
class vl {
  ...
  _getDDElements(e, t) {
    const i = e.gridstack || t !== "destroy" && t !== "disable", r = D.getElements(e);
...
class $ {
  ...
  static init(e = {}, t = ".grid-stack") {
    ...
    return i ? (i.gridstack || (i.gridstack = new $(i, D.cloneDeep(e))), i.gridstack) : (console.error(typeof t == "string" ? 'GridStack.initAll() no grid was found with selector "' + t + `" - element missing or wrong selector ?
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.` : "GridStack.init() no grid element was passed."), null);
  ...
  static initAll(e = {}, t = ".grid-stack") {
    ...
    return typeof document > "u" || ($.getGridElements(t).forEach((r) => {
      r.gridstack || (r.gridstack = new $(r, D.cloneDeep(e))), i.push(r.gridstack);
...
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.`)), i;
  ...
  static addGrid(e, t = {}) {
    ...
    return (!e.classList.contains("grid-stack") || $.addRemoveCB) && ($.addRemoveCB ? i = $.addRemoveCB(e, t, !0, !0) : i = D.createDiv(["grid-stack", t.class], e)), $.init(t, i);
  }
  ...
  get placeholder() {
    if (!this._placeholder) {
      this._placeholder = D.createDiv([this.opts.placeholderClass, ze.itemClass, this.opts.itemClass]);
  ...
  constructor(e, t = {}) {
    ...
    const i = D.toNumber(e.getAttribute("gs-row"));
    ...
    const s = {
      ...D.cloneDeep(ze),
      column: D.toNumber(e.getAttribute("gs-column")) || ze.column,
      minRow: i || D.toNumber(e.getAttribute("gs-min-row")) || ze.minRow,
      maxRow: i || D.toNumber(e.getAttribute("gs-max-row")) || ze.maxRow,
      staticGrid: D.toBool(e.getAttribute("gs-static")) || ze.staticGrid,
    ...
    t.alwaysShowResizeHandle === "mobile" && (t.alwaysShowResizeHandle = Ue), this._setStaticClass();
  ...
  addWidget(e) {
    ...
    return D.defaults(e, r), this.engine.prepareNode(e), this.el.appendChild(t), this.makeWidget(t, e), t;
  }
  /**
   ...
   */
  createWidgetDivs(e) {
    const t = D.createDiv(["grid-stack-item", this.opts.itemClass]), i = D.createDiv(["grid-stack-item-content"], t);
    return D.lazyLoad(e) ? e.visibleObservable || (e.visibleObservable = new IntersectionObserver(([r]) => {
  ...
  makeSubGrid(e, t, i, r = !0) {
    ...
    if (r && (this._removeDD(s.el), h = { ...s, x: 0, y: 0 }, D.removeInternalForSave(h), delete h.subGridOpts, s.content && (h.content = s.content, delete s.content), $.addRemoveCB ? c = $.addRemoveCB(this.el, h, !0, !1) : (c = D.createDiv(["grid-stack-item"]), c.appendChild(u), u = D.createDiv(["grid-stack-item-content"], s.el)), this.prepareDragDrop(s.el)), i) {
    ...
    return i?._moving && (f._isTemp = !0), d && (f._autoColumn = !0), r && f.makeWidget(c, h), i && (i._moving ? window.setTimeout(() => D.simulateMouseEvent(i._event, "mouseenter", f.el), 0) : f.makeWidget(s.el, s)), this.resizeToContentCheck(!1, s), f;
  }
  /**
  ...
  save(e = !0, t = !1, i = $.saveCB, r) {
    ...
    if (s.forEach((o) => {
      ...
      return delete o._alwaysShowResizeHandle, a !== void 0 ? o.alwaysShowResizeHandle = a : delete o.alwaysShowResizeHandle, D.removeInternalAndSame(o, ze), o.children = s, o;
    }
    return s;
  }
  /**
  ...
  load(e, t = $.addRemoveCB || !0) {
    ...
    d && this.setAnimation(!1), !a && t && [...this.engine.nodes].forEach((h) => {
      if (!h.id)
        return;
      D.find(e, h.id) || ($.addRemoveCB && $.addRemoveCB(this.el, h, !1, !1), o.push(h), this.removeWidget(h.el, !0, !1));
    }), this.engine._loading = !0;
    const u = [];
    return this.engine.nodes = this.engine.nodes.filter((c) => D.find(e, c.id) ? (u.push(c), !1) : !0), e.forEach((c) => {
      const h = D.find(u, c.id);
      if (h) {
        if (D.shouldSizeToContent(h) && (c.h = h.h), this.engine.nodeBoundFix(c), (c.autoPosition || c.x === void 0 || c.y === void 0) && (c.w = c.w || h.w, c.h = c.h || h.h, this.engine.findEmptyPosition(c)), this.engine.nodes.push(h), D.samePos(h, c) && this.engine.nodes.length > 1 && (this.moveNode(h, { ...c, forceCollide: !0 }), D.copyPos(c, h)), this.update(h.el, c), c.subGridOpts?.children) {
  ...
  getCellHeight(e = !1) {
    ...
    if (t) {
      const r = D.toNumber(t.getAttribute("gs-h")) || 1;
  ...
  update(e, t) {
    return $.getElements(e).forEach((i) => {
      ...
      if (!r)
        return;
      const s = { ...D.copyPos({}, r), ...D.cloneDeep(t) };
  ...
  _updateContainerHeight() {
    ...
    return this.el.setAttribute("gs-current-row", String(t)), this.el.style.removeProperty("min-height"), this.el.style.removeProperty("height"), t && (this.el.style[e ? "minHeight" : "height"] = t * i + r), e && D.shouldSizeToContent(e) && e.grid.resizeToContentCBCheck(e.el), this;
  }
  /** @internal */
  _prepareElement(e, t = !1, i) {
    ...
    const r = D.shouldSizeToContent(i);
    return r ? e.classList.add("size-to-content") : e.classList.remove("size-to-content"), r && this.resizeToContentCheck(!1, i), D.lazyLoad(i) || this.prepareDragDrop(i.el), this;
  }
  ...
  resizeToContentCheck(e = !1, t = void 0) {
    if (this.engine) {
      ...
      else if (this.engine.nodes.some((i) => D.shouldSizeToContent(i))) {
        const i = [...this.engine.nodes];
        this.batchUpdate(), i.forEach((r) => {
          D.shouldSizeToContent(r) && this.resizeToContentCBCheck(r.el);
  ...
  _initMargin() {
    let e, t = 0, i = [];
    typeof this.opts.margin == "string" && (i = this.opts.margin.split(" ")), i.length === 2 ? (this.opts.marginTop = this.opts.marginBottom = i[0], this.opts.marginLeft = this.opts.marginRight = i[1]) : i.length === 4 ? (this.opts.marginTop = i[0], this.opts.marginRight = i[1], this.opts.marginBottom = i[2], this.opts.marginLeft = i[3]) : (e = D.parseHeight(this.opts.margin), this.opts.marginUnit = e.unit, t = this.opts.margin = e.h), ["marginTop", "marginRight", "marginBottom", "marginLeft"].forEach((o) => {
  ...
  static setupDragIn(e, t, i, r = document) {
    t?.pause !== void 0 && (Q.pauseDrag = t.pause), t = { appendTo: "body", helper: "clone", ...t || {} }, (typeof e == "string" ? D.getElements(e, r) : e).forEach((o, a) => {
  ...
  _setupAcceptWidget() {
    ...
    return Se.droppable(this.el, {
      ...
      a._temporaryRemoved = !0) : (a.w = d, a.h = u, a._temporaryRemoved = !0), $._itemRemoving(a.el, !1), Se.on(s, "drag", i), i(r, s, o), !1;
  ...
  _setupRemoveDrop() {
    ...
    return e ? (!this.opts.staticGrid && !Se.isDroppable(e) && Se.droppable(e, this.opts.removableOptions).on(e, "dropover", (t, i) => $._itemRemoving(i, !0)).on(e, "dropout", (t, i) => $._itemRemoving(i, !1)), this) : this;
  }
  /**
      ...
      const u = (f, m) => {
        ...
        if (!(!p.gridstackNode || p.gridstackNode.grid !== this)) {
          if (i.el = p, i._isAboutToRemove) {
            ...
            D.removePositioningStyles(p), i._temporaryRemoved ? (this._writePosAttr(p, i), this.engine.addNode(i)) : this._writePosAttr(p, i), this.triggerEvent(f, p);
  ...
  _dragOrResize(e, t, i, r, s, o) {
    ...
    if (u = Math.min(u, p), c = Math.min(c, p), h = Math.min(h, m), f = Math.min(f, m), t.type === "drag") {
      ...
      r._prevYPix = i.position.top, this.opts.draggable.scroll !== !1 && D.updateScrollPosition(e, i.position, g);
      ...
      if (this.engine.collide(r, a)) {
        const F = this.getRow();
        let R = Math.max(0, a.y + r.h - F);
        this.opts.maxRow && F + R > this.opts.maxRow && (R = Math.max(0, this.opts.maxRow - F)), this._extraDragRow = R;
      } else
        this._extraDragRow = 0;
      if (this._extraDragRow !== w && this._updateContainerHeight(), r.x === a.x && r.y === a.y)
        return;
    } else if (t.type === "resize") {
      if (a.x < 0 || (D.updateScrollResize(t, e, o), a.w = Math.round((i.size.width - u) / s), a.h = Math.round((i.size.height - h) / o), r.w === a.w && r.h === a.h) || r._lastTried && r._lastTried.w === a.w && r._lastTried.h === a.h)
        return;
  ...
  commit() {
    return ml(this, this.batchUpdate(!1), "commit", "batchUpdate", "5.2"), this;
  }
}
$.renderCB = (n, e) => {
...
function bl({ children: n }) {
  const {
    ...
    (c, h) => {
      if (h.id && h.grid) {
        let f = an.get(h.grid);
        f || (f = /* @__PURE__ */ new Map(), an.set(h.grid, f)), f.set(h.id, c), r.current.set(h.id, c);
      }
    },
    []
  ), d = I(() => {
  ...
  return di(() => {
    if (!u(i, o.current) && e)
      try {
        e.removeAll(!1), e.destroy(!1), r.current.clear(), an.delete(e), o.current = i, t(null);
      } catch (c) {
...
const zi = ({
  ...
  return /* @__PURE__ */ l(
    dl,
    {
      ...
      static: r,
      forcePositionSync: s,
      children: /* @__PURE__ */ l(bl, { children: /* @__PURE__ */ l(fl, {}) })
    }
  );
};
zi.displayName = "F0GridStack";
const yl = (n, e, t) => /* @__PURE__ */ l("div", { children: n }), Wn = ({
  widgets: n = [],
  editMode: e = !1,
  onChange: t = () => {
  },
  ...
  const o = I(
    ...
    if (typeof R.content == "function" && R.deps && N) {
      const b = {};
      return R.deps.forEach((S) => {
        typeof S == "string" && N[S] !== void 0 && (b[S] = N[S]);
      }), R.content(b);
    }
    ...
    const k = d(S, b), T = {
      ...
      h: S.h ?? 1,
      w: S.w ?? 1,
      allowedSizes: S.availableSizes,
      noMove: !N,
      noResize: !N,
      locked: S.locked,
      meta: S.meta,
      _originalContent: k,
      content: o(k, S.meta, N)
    };
    return S.x !== void 0 && (T.x = S.x), S.y !== void 0 && (T.y = S.y), T;
  }), [c, h] = G(
    u(n, e)
  ...
  const y = W(s), C = P(() => {
    ...
    return !s || Object.keys(s).length === 0 || n.forEach((N) => {
      if (N.deps && N.deps.length > 0) {
        const b = N.deps.map((S) => typeof S == "string" && s[S] !== void 0 ? s[S] : S).filter((S) => S !== null);
        R.set(N.id, b);
      }
    }), R;
  }, [n, s]), w = I(
      ...
      h(R), p.current || t(
        R.map((N) => {
          ...
          return {
            ...
            content: typeof b?.content == "function" ? b.content : N._originalContent,
            x: N.x ?? 0,
            y: N.y ?? 0,
            locked: N.locked,
            deps: b?.deps
    ...
    [t]
  ), F = (R, N) => !R && !N ? !1 : !R || !N || R.length !== N.length ? !0 : R.some((b, S) => b !== N[S]);
  return U(() => {
    const R = f.current !== e, N = m.current !== n, b = y.current !== s && (y.current === void 0 || s === void 0 || Object.keys(y.current).length !== Object.keys(s).length || Object.keys(s).some(
      (E) => y.current?.[E] !== s[E]
    )), S = /* @__PURE__ */ new Map();
    n.forEach((E) => {
      if (E.deps && E.deps.length > 0) {
        const L = v.current.get(E.id), _ = C.get(E.id);
        S.set(
          E.id,
          F(L, _)
        ), _ ? v.current.set(E.id, _) : v.current.delete(E.id);
      }
    });
    const k = new Set(n.map((E) => E.id));
    v.current.forEach((E, L) => {
      k.has(L) || v.current.delete(L);
    });
    const T = Array.from(S.values()).some((E) => E) || b;
    R && !N && !T ? (p.current = !0, h(
      (E) => E.map((L) => {
        const _ = n.find((O) => O.id === L.id);
        if (!_)
          return L;
        const A = d(_, s);
        return {
      ...
      return n.map((_) => {
        const A = L.get(_.id), O = S.get(_.id) ?? !1;
        let z;
        O || !A ? z = d(_, s) : z = A._originalContent ?? d(_, s);
        const M = {
          id: _.id,
          h: A?.h ?? _.h ?? 1,
          w: A?.w ?? _.w ?? 1,
          ...
          meta: _.meta,
          _originalContent: z,
          content: o(z, _.meta, e)
        }, K = A?.x ?? _.x, Y = A?.y ?? _.y;
        return K !== void 0 && (M.x = K), Y !== void 0 && (M.y = Y), M;
      });
    ...
    zi,
    {
      className: B(r && "h-full flex-1 overflow-auto"),
      options: a,
      onChange: w,
      widgets: c
    }
...
Wn.displayName = "GroupGrid";
Wn.__isPageLayoutGroup = !0;
const xl = (n, e) => {
  const t = e;
              ...
              children: [
                e && /* @__PURE__ */ l(
                  "div",
                  {
                    ...
                    onMouseDown: t,
                    "data-gs-handle": "true",
                    children: /* @__PURE__ */ l(se, { icon: Xt, size: "xs" })
                  }
                ),
                /* @__PURE__ */ l(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ l(Wt, { variant: "label", content: n, ellipsis: !0 })
                  }
                )
              ]
            }
          ),
          /* @__PURE__ */ l(Bo, { children: (s || o) && v && /* @__PURE__ */ x(
            bt.div,
            {
              className: B(
...
}, Cl = () => /* @__PURE__ */ x("div", { className: "relative flex h-full w-full cursor-progress flex-col rounded-xl border border-solid border-f1-border-secondary bg-f1-background", children: [
...
gs.displayName = "F0Widget";
const Sl = Br(gs, Cl), Nl = ({
  children: n,
  title: e,
  draggable: t = !1,
  actions: i,
...
ps.displayName = "Dashboard";
const El = wl("Dashboard", ps), Jh = ae(
  Me("Dashboard", El)
), Dl = xt({
...
}), _l = (n) => (n || []).map((e) => e.items).reduce((e, t) => (e.length > 0 && e.push({ type: "separator" }), e.push(...t), e), []), Rl = (n) => {
  ...
  ({
    ...
    return /* @__PURE__ */ x(
      ...
      {
        ref: c,
        className: B(Dl({ variant: e }), "relative", t),
        draggable: i,
        onDragStart: r,
        onDragEnd: s,
        onDrop: o,
...
const kl = ({
  ...
  if (!n) return null;
  const o = t;
  return /* @__PURE__ */ x(qn, { ...s, className: B("space-y-4", r), children: [
    /* @__PURE__ */ x("div", { className: "space-y-2", children: [
      /* @__PURE__ */ l(
        o,
        {
          className: B("font-semibold text-f1-foreground", {
            "text-2xl": t === "h1",
            "text-xl": t === "h2",
            "text-lg": t === "h3",
            "text-base": t === "h4",
  ...
  "BlockContent",
  kl
), Fl = (n) => !ns(n) || !n.type || typeof n.type == "string" || typeof n.type == "symbol" ? !1 : "__isPageLayoutBlock" in n.type, Al = (n) => !ns(n) || !n.type || typeof n.type == "string" || typeof n.type == "symbol" ? !1 : "__isPageLayoutGroup" in n.type, vs = (n, e, t) => {
  const i = bn.toArray(e);
  for (const r of i)
    t.includes("block") && Fl(r) || t.includes("group") && Al(r) || console.warn(
  ...
  ({ children: n, onSort: e, ...t }, i) => {
    ...
    const [r, s] = G(bn.toArray(n));
    return U(() => {
      s(bn.toArray(n));
    }, [n]), U(() => {
      e?.(r);
    }, [r, e]), /* @__PURE__ */ l("div", { ref: i, ...t, children: r.map((o, a) => /* @__PURE__ */ l(Ba, { children: o }, a)) });
  }
);
...
function Ee(n) {
  var e, t;
  return n ? Nt(n) ? n : Ii(n) && (e = (t = n.ownerDocument) == null ? void 0 : t.defaultView) != null ? e : window : window;
}
function Bi(n) {
  const {
    Document: e
...
function Zt(n) {
  return Nt(n) ? !1 : n instanceof Ee(n).HTMLElement;
}
function bs(n) {
  return n instanceof Ee(n).SVGElement;
}
function Et(n) {
  return n ? Nt(n) ? n.document : Ii(n) ? Bi(n) ? n : Zt(n) || bs(n) ? n.ownerDocument : document : document : document;
}
const Ve = $n ? di : U;
function Gn(n) {
  const e = W(n);
...
const vt = /* @__PURE__ */ ys(1), Qt = /* @__PURE__ */ ys(-1);
function zl(n) {
...
function Il(n) {
  return n.matches(or) ? n : n.querySelector(or);
}
const Bl = {
  display: "none"
};
...
function $l() {
  const [n] = G(() => /* @__PURE__ */ new Set()), e = I((i) => (n.add(i), () => n.delete(i)), [n]);
  return [I((i) => {
    let {
      type: r,
      event: s
...
function Ul(n) {
  ...
  if (U(() => {
    ...
    return null;
  const c = le.createElement(le.Fragment, null, le.createElement(Pl, {
    id: i,
    value: r.draggable
  }), le.createElement(Hl, {
    id: a,
...
const Jl = (n) => {
  ...
  for (const o of i) {
    ...
    if (d) {
      const u = lr(d), c = r.reduce((f, m, p) => f + Ql(u[p], m), 0), h = Number((c / 4).toFixed(4));
      s.push({
        id: a,
        data: {
...
function Un(n, e) {
  ...
  function i(r) {
    if (e != null && t.length >= e || !r)
      return t;
    if (Bi(r) && r.scrollingElement != null && !t.includes(r.scrollingElement))
      return t.push(r.scrollingElement), t;
    if (!Zt(r) || bs(r) || t.includes(r))
      return t;
    const s = Ee(n).getComputedStyle(r);
    return r !== n && lc(r, s) && t.push(r), ac(r, s) ? t : i(r.parentNode);
  }
  return n ? i(n) : t;
}
function Ns(n) {
...
function ei(n) {
  return !$n || !n ? null : Nt(n) ? n : Ii(n) ? Bi(n) || n === Et(n).scrollingElement ? window : Zt(n) ? n : null : null;
}
function Es(n) {
  return Nt(n) ? n.scrollX : n.scrollLeft;
}
function Ds(n) {
  return Nt(n) ? n.scrollY : n.scrollTop;
}
function ui(n) {
  return {
    x: Es(n),
...
function _s(n) {
  return !$n || !n ? !1 : n === document.scrollingElement;
}
function Rs(n) {
  const e = {
    x: 0,
...
function ks(n) {
  return n.reduce((e, t) => vt(e, ui(t)), Qe);
}
function hc(n) {
  return n.reduce((e, t) => e + Es(t), 0);
}
function fc(n) {
...
const mc = [["x", ["left", "right"], hc], ["y", ["top", "bottom"], fc]];
class Pi {
  constructor(e, t) {
...
class Hi {
  constructor(e) {
    ...
    this.props = e, this.listeners = new Bt(Et(t)), this.windowListeners = new Bt(Ee(t)), this.handleKeyDown = this.handleKeyDown.bind(this), this.handleCancel = this.handleCancel.bind(this), this.attach();
  }
  attach() {
    ...
    if (jn(e)) {
      ...
      if (h) {
        ...
        for (const v of p) {
          ...
          }, k = g === ee.Right && !C || g === ee.Left && !w, T = g === ee.Down && !F || g === ee.Up && !y;
          if (k && S.x !== h.x) {
            const E = v.scrollLeft + f.x, L = g === ee.Right && E <= R.x || g === ee.Left && E >= N.x;
            if (L && !f.y) {
              v.scrollTo({
                left: E,
                behavior: a
            ...
            L ? m.x = v.scrollLeft - E : m.x = g === ee.Right ? v.scrollLeft - R.x : v.scrollLeft - N.x, m.x && v.scrollBy({
              left: -m.x,
              behavior: a
            });
            break;
          } else if (T && S.y !== h.y) {
            const E = v.scrollTop + f.y, L = g === ee.Down && E <= R.y || g === ee.Up && E >= N.y;
            if (L && !f.x) {
              v.scrollTo({
                top: E,
                behavior: a
            ...
            L ? m.y = v.scrollTop - E : m.y = g === ee.Down ? v.scrollTop - R.y : v.scrollTop - N.y, m.y && v.scrollBy({
              top: -m.y,
              behavior: a
            });
            break;
        ...
        this.handleMove(e, vt(Qt(h, this.referenceCoordinates), m));
      }
    }
  }
  handleMove(e, t) {
...
class Wi {
  constructor(e, t, i) {
    var r;
    i === void 0 && (i = gc(e.event.target)), this.props = void 0, this.events = void 0, this.autoScrollEnabled = !0, this.document = void 0, this.activated = !1, this.initialCoordinates = void 0, this.timeoutId = null, this.listeners = void 0, this.documentListeners = void 0, this.windowListeners = void 0, this.props = e, this.events = t;
    const {
      event: s
    } = e, {
      target: o
    } = s;
    this.props = e, this.events = t, this.document = Et(o), this.documentListeners = new Bt(this.document), this.listeners = new Bt(i), this.windowListeners = new Bt(Ee(o)), this.initialCoordinates = (r = _n(s)) != null ? r : Qe, this.handleStart = this.handleStart.bind(this), this.handleMove = this.handleMove.bind(this), this.handleEnd = this.handleEnd.bind(this), this.handleCancel = this.handleCancel.bind(this), this.handleKeydown = this.handleKeydown.bind(this), this.removeTextSelection = this.removeTextSelection.bind(this), this.attach();
  }
  attach() {
    const {
      events: e,
    ...
    if (this.listeners.add(e.move.name, this.handleMove, {
      passive: !1
    }), this.listeners.add(e.end.name, this.handleEnd), e.cancel && this.listeners.add(e.cancel.name, this.handleCancel), this.windowListeners.add(He.Resize, this.handleCancel), this.windowListeners.add(He.DragStart, dr), this.windowListeners.add(He.VisibilityChange, this.handleCancel), this.windowListeners.add(He.ContextMenu, dr), this.documentListeners.add(He.Keydown, this.handleKeydown), t) {
      if (i != null && i({
  ...
  handleStart() {
    ...
    e && (this.activated = !0, this.documentListeners.add(He.Click, pc, {
      capture: !0
  ...
  handleMove(e) {
    ...
    if (!r)
      return;
    const d = (t = _n(e)) != null ? t : Qe, u = Qt(r, d);
    if (!i && a) {
      if (ur(a)) {
        if (a.tolerance != null && ti(u, a.tolerance))
          return this.handleCancel();
        if (ti(u, a.distance))
          return this.handleStart();
      }
      if (hr(a) && ti(u, a.tolerance))
        return this.handleCancel();
...
xc.activators = [{
  ...
  handler: (n, e) => {
    ...
    return t.button === hi.RightClick ? !1 : (i?.({
      event: t
    }), !0);
  }
}];
...
function Cc(n) {
  let {
    acceleration: e,
    activator: t = Pt.Pointer,
    canScroll: i,
    draggingRect: r,
    enabled: s,
    interval: o = 5,
    order: a = kn.TreeOrder,
  ...
  const m = Nc({
    ...
    if (!N)
      return;
    const b = g.current.x * y.current.x, S = g.current.y * y.current.y;
    N.scrollBy(b, S);
  }, []), R = P(() => a === kn.TreeOrder ? [...u].reverse() : u, [a, u]);
  U(
    () => {
      if (!s || !u.length || !C) {
        v();
      ...
      for (const N of R) {
        ...
        for (const E of ["x", "y"])
          m[E][k[E]] || (T[E] = 0, k[E] = 0);
        if (T.x > 0 || T.y > 0) {
          v(), w.current = N, p(F, o), g.current = T, y.current = k;
          return;
        }
      }
      g.current = {
  ...
  const [s, o] = G(null), {
    ...
    if (!y || y === fr || c.current !== n || s != null) {
      ...
      for (let w of n) {
        ...
        const F = w.node.current, R = F ? new Pi(d(F), F) : null;
        w.rect.current = R, R && C.set(w.id, R);
      }
      return C;
    }
    return y;
...
function $i(n, e) {
  return en((t) => n ? t || (typeof e == "function" ? e(n) : n) : null, [e, n]);
}
function Rc(n, e) {
  return $i(n, e);
}
...
const gr = [];
function Ac(n) {
  const e = W(n), t = en((i) => n ? i && i !== gr && n && e.current && n.parentNode === e.current.parentNode ? i : Un(n) : gr, [n]);
  return U(() => {
    e.current = n;
  }, [n]), t;
}
function Lc(n) {
  const [e, t] = G(null), i = W(n), r = I((s) => {
    const o = ei(s.target);
    o && t((a) => a ? (a.set(o, ui(o)), new Map(a)) : null);
  }, []);
  return U(() => {
    const s = i.current;
    if (n !== s) {
  ...
  }, [r, n]), P(() => n.length ? e ? Array.from(e.values()).reduce((s, o) => vt(s, o), Qe) : ks(n) : Qe, [n, e]);
}
function pr(n, e) {
  e === void 0 && (e = []);
  const t = W(null);
...
function As(n) {
  return P(() => n ? oc(n) : null, [n]);
}
const vr = [];
function Mc(n, e) {
  e === void 0 && (e = Dt);
  const [t] = n, i = As(t ? Ee(t) : null), [r, s] = G(vr);
  function o() {
    s(() => n.length ? n.map((d) => _s(d) ? i : new Pi(e(d), d)) : vr);
  }
  const a = Vn({
    callback: o
  });
...
const Bc = [{
  ...
  droppable: {
    measure: cr,
    strategy: Kt.WhileDragging,
    frequency: fi.Optimized
  },
  dragOverlay: {
    measure: Dt
  }
...
const Hc = {
  ...
  over: null,
  measureDroppableContainers: Rn
}, nn = /* @__PURE__ */ Ke(Os), zs = /* @__PURE__ */ Ke(Hc);
function Wc() {
  return {
    draggable: {
      active: null,
...
const Uc = /* @__PURE__ */ is(function(e) {
  var t, i, r, s;
  let {
    id: o,
    accessibility: a,
    ...
    children: u,
    sensors: c = Bc,
    collisionDetection: h = ec,
    measuring: f,
    modifiers: m,
    ...p
  } = e;
  const v = Pa(qc, void 0, Wc), [g, y] = v, [C, w] = $l(), [F, R] = G(dt.Uninitialized), N = F === dt.Initialized, {
    draggable: {
      active: b,
      nodes: S,
      translate: k
    ...
    return b != null ? {
      ...
      data: (Ce = E?.data) != null ? Ce : Pc,
      rect: L
    } : null;
  }, [b, E]), A = W(null), [O, z] = G(null), [M, K] = G(null), Y = Vt(p, Object.values(p)), V = tn("DndDescribedBy", o), ne = P(() => T.getEnabled(), [T]), Z = Gc(f), {
    droppableRects: q,
    ...
    config: Z.droppable
  }), de = Ec(S, b), J = P(() => M ? _n(M) : null, [M]), te = Mo(), oe = Rc(de, Z.draggable.measure);
  jc({
    activeNode: b != null ? S.get(b) : null,
    config: te.layoutShiftCompensation,
    initialRect: oe,
    measure: Z.draggable.measure
  });
  const H = mr(de, Z.draggable.measure, oe), X = mr(de ? de.parentElement : null), j = W({
    activatorEvent: null,
    active: null,
    activeNode: de,
    collisionRect: null,
  ...
  }), me = T.getNodeFor((t = j.current.over) == null ? void 0 : t.id), ve = Ic({
    measure: Z.dragOverlay.measure
  }), Ie = (i = ve.nodeRef.current) != null ? i : de, Be = N ? (r = ve.rect) != null ? r : H : null, rt = !!(ve.nodeRef.current && ve.rect), ye = Fc(rt ? null : H), qe = As(Ie ? Ee(Ie) : null), De = Ac(N ? me ?? de : null), $e = Mc(De), Te = Ms(m, {
    transform: {
      x: k.x - ye.x,
      y: k.y - ye.y,
      scaleX: 1,
    ...
    windowRect: qe
  }), et = J ? vt(J, k) : null, rn = Lc(De), Kn = pr(rn), Xn = pr(rn, [H]), tt = vt(Te, Kn), st = Be ? ic(Be, Te) : null, ht = _ && st ? h({
    active: _,
    collisionRect: st,
    droppableRects: q,
    droppableContainers: ne,
    pointerCoordinates: et
  }) : null, sn = ws(ht, "id"), [Ge, Rt] = G(null), Fo = rt ? Te : vt(Te, Xn), Ao = tc(Fo, (s = Ge?.rect) != null ? s : null, H), Yn = W(null), Zi = I(
    (Ce, Fe) => {
      let {
        sensor: Ae,
        options: ot
      ...
      function gt(xe) {
        return async function() {
          ...
          A.current = null, on(() => {
            y({
              type: xe
            }), R(dt.Uninitialized), Rt(null), z(null), K(null), Yn.current = null;
            const Ft = xe === pe.DragEnd ? "onDragEnd" : "onDragCancel";
            if (lt) {
              const Jn = Y.current[Ft];
              Jn?.(lt), C({
                type: Ft,
                event: lt
              });
    ...
    const Pe = Ae.nativeEvent, Le = S.get(ot);
    if (
    ...
    }, A.current = ot, Zi(Ae, Fe));
  }, [S, Zi]), er = Dc(c, Lo);
  Oc(c), Ve(() => {
    H && F === dt.Initializing && R(dt.Initialized);
  }, [H, F]), U(
    () => {
      const {
        onDragMove: Ce
    ...
    () => {
      ...
      const {
        onDragOver: Le
      } = Y.current, Xe = ot.get(sn), gt = Xe && Xe.rect.current ? {
        id: Xe.id,
  ...
  }, [_, de, ht, st, S, Ie, Be, q, T, Ge, De, tt]), Cc({
    ...te,
    delta: k,
    draggingRect: st,
    pointerCoordinates: et,
  ...
  const Oo = P(() => ({
    ...
    measuringScheduled: ge,
    windowRect: qe
  }), [_, de, H, M, ht, X, ve, S, T, q, Ge, ie, De, $e, Z, ge, qe]), zo = P(() => ({
    activatorEvent: M,
    activators: er,
    active: _,
    activeNodeRect: H,
    ...
    over: Ge,
    measureDroppableContainers: ie
  }), [M, er, _, H, y, V, S, Ge, ie]);
  return le.createElement(xs.Provider, {
    value: w
  }, le.createElement(nn.Provider, {
    value: zo
  }, le.createElement(zs.Provider, {
    value: Oo
  }, le.createElement(Qn.Provider, {
    value: Ao
  }, u)), le.createElement($c, {
  ...
  function Mo() {
    const Ce = O?.autoScrollEnabled === !1, Fe = typeof d == "object" ? d.enabled === !1 : d === !1, Ae = N && !Ce && !Fe;
...
}), Vc = /* @__PURE__ */ Ke(null), br = "button", Qc = "Draggable";
function Kc(n) {
  let {
    id: e,
    data: t,
  ...
  const s = tn(Qc), {
    ...
    tabIndex: v = 0
  } = r ?? {}, g = d?.id === e, y = ke(g ? Qn : Vc), [C, w] = En(), [F, R] = En(), N = zc(o, e), b = Vt(t);
  Ve(
    () => (h.set(e, {
      id: e,
      key: s,
...
function Jc(n) {
  ...
  const s = tn(Xc), {
    ...
    w && (k && (w.unobserve(k), h.current = !1), S && w.observe(S));
  }, [w]), [R, N] = En(F), b = Vt(e);
  return U(() => {
    !w || !R.current || (w.disconnect(), h.current = !1, w.observe(R.current));
  }, [R, w]), U(
    () => (a({
...
function Zc(n) {
  ...
  const [i, r] = G(null), [s, o] = G(null), a = Dn(t);
  return !t && !i && a && r(a), Ve(() => {
    if (!s)
      return;
  ...
  }, [e, i, s]), le.createElement(le.Fragment, null, t, i ? Ha(i, {
    ref: o
  }) : null);
}
const ed = {
...
function td(n) {
  ...
  return le.createElement(nn.Provider, {
    value: Os
  }, le.createElement(Qn.Provider, {
    value: ed
  }, e));
...
const nd = {
  position: "fixed",
  touchAction: "none"
}, id = (n) => jn(n) ? "transform 250ms ease" : void 0, rd = /* @__PURE__ */ Ze((n, e) => {
  let {
    as: t,
    activatorEvent: i,
    adjustScale: r,
  ...
  const h = r ? u : {
    ...
    transformOrigin: r && i ? Kl(i, a) : void 0,
...
function ld(n) {
  ...
  return Gn((s, o) => {
    ...
    const {
      transform: c
    } = Ee(o).getComputedStyle(o), h = Ss(c);
    if (!h)
      return;
    const f = typeof e == "function" ? e : cd(e);
    return Ts(d, r.draggable.measure), f({
      active: {
        id: s,
        data: a.data,
        node: d,
...
const ud = /* @__PURE__ */ le.memo((n) => {
  ...
  return le.createElement(td, null, le.createElement(Zc, {
    animation: T
  }, h && b ? le.createElement(rd, {
    key: b,
    id: h.id,
    ref: E,
    as: a,
...
}, Ps = "Sortable", Hs = /* @__PURE__ */ le.createContext({
  activeIndex: -1,
  containerId: Ps,
  disableTransforms: !1,
  items: [],
...
function gd(n) {
  ...
  } = Is(), h = tn(Ps, t), f = a.rect !== null, m = P(() => i.map((N) => typeof N == "object" && "id" in N ? N.id : N), [i]), p = o != null, v = o ? m.indexOf(o.id) : -1, g = u ? m.indexOf(u.id) : -1, y = W(m), C = !fd(m, y.current), w = g !== -1 && v === -1 || C, F = md(s);
  Ve(() => {
    C && p && c(m);
  }, [C, m, p, c]), U(() => {
    y.current = m;
  ...
  return le.createElement(Hs.Provider, {
    value: R
  }, e);
}
const pd = (n) => {
  ...
  duration: 200,
  easing: "ease"
}, Ws = "transform", yd = /* @__PURE__ */ ut.Transition.toString({
  property: Ws,
  duration: 0,
  easing: "linear"
}), xd = {
...
function Cd(n) {
  ...
  const {
    ...
    useDragOverlay: y,
    strategy: C
  } = ke(Hs), w = Sd(i, m), F = c.indexOf(o), R = P(() => ({
    sortable: {
      containerId: h,
      index: F,
      items: c
    ...
    ...r
  }), [h, r, F, c]), N = P(() => c.slice(c.indexOf(o)), [c, o]), {
    rect: b,
    node: S,
    isOver: k,
    setNodeRef: T
  ...
  }), ne = Ll(T, O), Z = !!E, q = Z && !p && ln(f) && ln(g), ie = !y && M, ge = ie && q ? V : null, J = q ? ge ?? (a ?? C)({
    rects: v,
    activeNodeRect: _,
    activeIndex: f,
    overIndex: g,
  ...
  return U(() => {
    ...
    if (oe === H.current.activeId)
      return;
    if (oe != null && H.current.activeId == null) {
      H.current.activeId = oe;
      return;
    }
    const Ie = setTimeout(() => {
      H.current.activeId = oe;
...
const Nd = [ee.Down, ee.Right, ee.Up, ee.Left], Ed = (n, e) => {
  let {
    context: {
      active: t,
      collisionRect: i,
  ...
  if (Nd.includes(n.code)) {
    ...
    if (c === o?.id && u.length > 1 && (c = u[1].id), c != null) {
      ...
      if (p && m && h && f) {
        const g = Un(p).some((N, b) => a[b] !== N), y = qs(h, f), C = Dd(h, f), w = g || !y ? {
          x: 0,
          y: 0
        } : {
        ...
        return w.x && w.y ? F : Qt(F, w);
      }
    }
  }
};
function qs(n, e) {
  return !Tn(n) || !Tn(e) ? !1 : n.data.current.sortable.containerId === e.data.current.sortable.containerId;
}
function Dd(n, e) {
  return !Tn(n) || !Tn(e) || !qs(n, e) ? !1 : n.data.current.sortable.index < e.data.current.sortable.index;
}
const xr = ({ id: n, children: e }) => {
  const { attributes: t, listeners: i, setNodeRef: r, transform: s, transition: o } = Cd({ id: n }), a = {
  ...
  return /* @__PURE__ */ l("div", { className: B("flex flex-wrap items-stretch gap-4", i && "flex-1"), children: /* @__PURE__ */ x(
    Uc,
    {
      sensors: d,
      onDragStart: u,
      onDragEnd: c,
      children: [
        /* @__PURE__ */ l(gd, { items: r, children: r.map((h) => /* @__PURE__ */ l(xr, { id: h.id, children: h.render }, h.id)) }),
        /* @__PURE__ */ l(ud, { children: o ? /* @__PURE__ */ l(xr, { id: o, children: r.find((h) => h.id === o)?.render }) : null })
      ]
    }
  ) });
};
...
const _d = Ze(function({ children: e, aside: t, header: i, variant: r = "main-aside" }, s) {
  return process.env.NODE_ENV === "development" && vs("Page", e, ["block", "group"]), /* @__PURE__ */ l("div", { ref: s, className: "h-full", children: /* @__PURE__ */ x(
    "div",
    {
      className: B(
        "flex h-full max-w-full overflow-auto text-f1-foreground md:flex-row",
  ...
  Page: ae(Me("Page", _d)),
  Block: ae(Me("Block", qn)),
  BlockContent: ae(
    Me("BlockContent", Tl)
  ),
  Group: ae(Me("Group", Mi)),
  GroupGrid: ae(
    Me("GroupGrid", Wn)
  ),
  GroupMasonry: ae(
...
const rf = [
  ...
  }), r = kd(e.trend), s = t(e.comparison), o = qo(
    i.numericValue,
    i.formatterOptions
  ), a = tr(s.numericValue), d = tr(i.numericValue), u = P(() => {
    if (!(!a || !r.show) && !(!a || !d))
      return (d - a) / a * 100;
  }, [d, a, r.show]);
...
}, Td = () => /* @__PURE__ */ x("div", { className: "relative flex h-full w-full cursor-progress flex-col gap-2", children: [
...
const Fd = Br($s, Td), sf = ae(Fd), of = Go.filter(
  (n) => n !== "ai"
), af = Hr, lf = ["default", "outline", "neutral"], cf = Hr, df = ["split", "dropdown"], uf = jo, Gs = {
  background: {
...
const Vd = xt({
  ...
  ({
    ...
    const tt = V && V !== "none" || ne && ne !== "none" || Z && Z !== "none" || q && q !== "none", st = Y && Y !== "none" || tt, ht = { sm: $e, md: Te, lg: et, xl: rn }, sn = Qd.map((Ge) => {
      const Rt = ht[Ge];
      return Rt ? Ud(Ge, Rt) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ l(
...
const io = An(
  ...
  const [t, i] = G(!1), r = /* @__PURE__ */ l(pn, { label: `+${n}` });
  return e?.length ? /* @__PURE__ */ x(vi, { open: t, onOpenChange: i, children: [
    /* @__PURE__ */ l(bi, { asChild: !0, children: /* @__PURE__ */ l("button", { className: Ln("inline-flex flex-shrink-0 items-center"), children: r }) }),
    /* @__PURE__ */ l(
      yi,
      {
        className: "rounded-md border border-solid border-f1-border-secondary p-1 shadow-md",
        align: "end",
        children: /* @__PURE__ */ x(Wr, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[172px] flex-col", children: [
          e.map((s, o) => /* @__PURE__ */ l(
            "div",
            {
              className: "flex w-[220px] min-w-0 items-center gap-1.5 px-2 py-1 [&:first-child]:pt-2 [&:last-child]:pb-2",
              children: /* @__PURE__ */ l(pn, { ...s })
            },
            o
          )),
          /* @__PURE__ */ l(
...
const ro = ({
  ...
  if (i === "fill")
    return /* @__PURE__ */ l(
      ...
      {
        items: n,
        renderListItem: (d) => /* @__PURE__ */ l(pn, { ...d }),
...
function so({
  ...
  U(() => {
    ...
    if (!h && n) {
      ...
      if (C.length > 0) {
        const w = C.find((F) => {
          const R = m[F], N = nr(n[F].type);
          return R !== void 0 && !N.isEmpty(R, {
            schema: n[F],
            i18n: u
          });
        });
  ...
  const v = (C, w) => {
    ...
    t(m);
  }, y = P(() => i || Object.entries(n).reduce((w, [F, R]) => {
    const N = nr(R.type);
    return Math.max(w, N?.formHeight || Kd);
  }, 0), [n, i]);
...
so.displayName = "F0FilterPickerContent";
const pf = so;
function Xd(n) {
...
function Ne({
  ...
  const f = rs(), m = d ?? (n.validation ? ss(n.validation) : !1), p = !c && n.type !== "checkbox" && n.type !== "custom", v = {
    value: e,
    onChange: t,
    onBlur: i ?? (() => {
    }),
  ...
  return /* @__PURE__ */ x("div", { className: "space-y-2", id: f, children: [
    ...
    /* @__PURE__ */ l(Yo, { status: y })
  ] });
}
Ne.displayName = "F0FormField";
const oo = Ke(null);
function Zd() {
  const n = ke(oo);
  if (!n)
...
function eu({ children: n, ...e }) {
  return /* @__PURE__ */ l(oo.Provider, { value: e, children: n });
}
const tu = xt({
...
function ru() {
  const { steps: n, currentStep: e, goToStep: t, allowStepSkipping: i } = Zd();
  return /* @__PURE__ */ l("nav", { "aria-label": "Wizard steps", className: "flex flex-col gap-1.5 p-1", children: n.map((r, s) => {
    const o = s < e || r.isCompleted?.() === !0, a = nu(s, e, o), d = n[e]?.hasErrors?.() === !0, u = s > e && n.slice(e, s).some((m) => m.hasErrors?.() === !0);
    ...
    return c && !i && s > e + 1 && (c = !1), /* @__PURE__ */ x(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ l(iu, { state: a, index: s }),
          /* @__PURE__ */ l("span", { className: tu({ state: a }), children: r.title })
        ]
      },
      s
    );
...
const ou = () => {
  ...
  const v = P(() => {
    ...
    onClose: i
  }), y = re(), C = n[g.currentStep], w = g.currentStep === 0, F = g.currentStep === n.length - 1, R = F ? C?.nextLabel ?? u ?? y.wizard.submit : C?.nextLabel ?? a ?? y.wizard.next, N = C?.previousLabel ?? d ?? y.wizard.previous, b = P(
    () => ({
      label: R,
      icon: F ? void 0 : ci,
      onClick: () => {
      ...
      children: /* @__PURE__ */ l(
        eu,
        {
          ...
          children: /* @__PURE__ */ x("div", { className: "flex h-[58vh] flex-1 flex-row", children: [
            /* @__PURE__ */ l("div", { className: "w-1/3 shrink-0 overflow-y-auto border-x-0 border-b-0 border-r border-t-0 border-dashed border-f1-border-secondary p-2", children: /* @__PURE__ */ l(ru, {}) }),
...
Ui.displayName = "F0Wizard";
function ao(n) {
  const t = wt(n).shape, i = Object.entries(t);
  return i.length === 0 ? !1 : i.every(([, r]) => Yt(r)?.disabled === !0);
}
function au(n, e) {
...
function cu({
  ...
  } = n, N = F?.label, b = P(() => Object.keys(g), [g]), S = e ?? n.steps, k = P(() => S ? S.some(
  ...
  const z = I(
    ...
    (H) => Lt(H, b, k).some((j) => O.current[j] === !0),
    [b, k]
  ), Y = P(
    () => k ?? b.map((H) => ({
      title: y?.[H]?.title ?? H,
  ...
  ), q = W(null), { showSuccess: ie, ActionBar: ge } = co(), de = I(
    (H) => async (X) => {
      T.current[H] = X;
      const j = await w({
        sectionId: H,
...
function uu({
  ...
  ), V = W(null), ne = W(null), { showSuccess: Z, ActionBar: q } = co(), ie = I(
    async (J) => {
      Object.assign(E.current, J);
      const te = { ...E.current };
      ne.current = te;
      const oe = await w({ data: te });
      return V.current = oe, oe;
    },
    [w]
  ), ge = I(() => {
    const J = V.current;
...
ho.displayName = "F0WizardForm";
const yf = ae(ho), fo = Ze((n, e) => /* @__PURE__ */ l(ta, { ref: e, variant: "heading", ...n }));
fo.displayName = "F0Heading";
const xf = ae(fo), hu = ({
  props: n
}) => {
  const { status: e, title: t, taskCount: i, completedCount: r, expanded: s, onExpandToggle: o } = n;
  return /* @__PURE__ */ x(we, { children: [
    /* @__PURE__ */ l(On, { icon: xi, size: "sm" }),
  ...
  return /* @__PURE__ */ x("div", { className: "flex flex-col gap-2 xs:flex-row xs:items-center [&>*]:w-full [&>*]:xs:w-auto", children: [
    r && /* @__PURE__ */ l(pi, { items: t, size: "md" }),
    e?.map((s, o) => /* @__PURE__ */ l(
      ce,
      {
        label: s.label,
      ...
      h ? /* @__PURE__ */ x(
        "button",
        {
          ...
          children: [
            ...
            s && /* @__PURE__ */ l(Wt, { content: s, variant: "description", as: "span" }),
            /* @__PURE__ */ l(
              se,
              {
                icon: d ? ia : qt,
  ...
  completed: /* @__PURE__ */ l(se, { icon: zn, color: "positive", size: "lg" }),
  "in-progress": /* @__PURE__ */ l(se, { icon: Va, size: "lg", color: "warning" }),
  "not-started": /* @__PURE__ */ l(se, { icon: ra, size: "lg", color: "secondary" })
}, Vi = ({
  status: n,
  isLast: e,
  hideStatus: t,
  ...
  return /* @__PURE__ */ x("div", { className: "flex min-h-8 items-center gap-3", children: [
    ...
    r && /* @__PURE__ */ l(Wt, { content: r, variant: "description" })
  ] });
}, go = ({
  props: n
}) => {
  const {
    ...
    secondaryActions: d,
    otherActions: u
  } = n, c = rs(), h = o?.some(Boolean), f = a || d && d.length > 0 || u && u.length > 0;
  return /* @__PURE__ */ x(Vi, { status: e, isLast: t, hideStatus: i, children: [
    /* @__PURE__ */ l("div", { className: "flex min-h-8 items-center gap-3", children: /* @__PURE__ */ l(fu, { props: n, contentId: c }) }),
    o && h && /* @__PURE__ */ l("div", { className: "pl-9", children: /* @__PURE__ */ l(Ci, { items: o }) }),
    r && /* @__PURE__ */ l("div", { id: c, role: "region", className: "flex flex-col gap-0 pl-4", children: s.map((m, p) => /* @__PURE__ */ l(pu, { props: m }, `${m.title}-${p}`)) }),
  ...
  return /* @__PURE__ */ x("div", { className: "pl-9", children: [
    e && s && /* @__PURE__ */ l("div", { className: "mb-3", children: /* @__PURE__ */ l(Ci, { items: e }) }),
  ...
  const { status: e, icon: t = os, title: i, description: r, metadata: s } = n, o = s?.some(Boolean);
  return /* @__PURE__ */ x("div", { className: "flex justify-between gap-3 w-full flex-wrap", children: [
    ...
    /* @__PURE__ */ l("div", { className: "flex justify-end items-center gap-3 pl-9", children: e === "completed" && s && o && /* @__PURE__ */ l(Ci, { items: s }) })
  ] });
}, po = ({ props: n }) => {
  ...
  return /* @__PURE__ */ x(Vi, { status: e, isLast: t, hideStatus: i, children: [
    ...
    e !== "completed" && /* @__PURE__ */ l(vu, { props: n })
  ] });
}, yu = (n) => "items" in n && "icon" in n && n.icon !== void 0, xu = ({
  props: n
}) => {
  const { status: e, isLast: t = !1, hideStatus: i = !1, expanded: r, items: s } = n;
  return /* @__PURE__ */ x(Vi, { status: e, isLast: t, hideStatus: i, children: [
    /* @__PURE__ */ l("div", { className: "flex min-h-8 items-center gap-2", children: /* @__PURE__ */ l(hu, { props: n }) }),
...
}, wu = (n) => "items" in n && "icon" in n && n.icon !== void 0, Cu = (n) => "items" in n && !("icon" in n && n.icon !== void 0), Su = (n) => wu(n) ? /* @__PURE__ */ l(go, { props: n }) : Cu(n) ? /* @__PURE__ */ l(xu, { props: n }) : /* @__PURE__ */ l(po, { props: n }), wf = [
  "completed",
  "in-progress",
  "not-started"
], Cf = ae(
...
function vo(n, e = 0) {
  return n.flatMap((t) => [
    ...
    ...t.children ? vo(t.children, e + 1) : []
  ]);
}
function Eu(n, e) {
  const t = n.length;
  if (t <= si) return n;
  const i = t / (si - 1), r = new Set(
    Array.from(
      { length: si - 1 },
...
function _u(n, e) {
  ...
  return U(() => i, [i]), { deferClose: I(() => {
    if (!document.querySelector(oi)) return !1;
    i();
    const s = () => {
...
function bo({
  ...
  const [f, m] = G(!1), p = W(!1), v = W(null), { deferClose: g } = _u(v, () => m(!1)), y = (w) => {
  ...
  return /* @__PURE__ */ x(
    oa,
    {
      ...
      closeDelay: Ru,
      children: [
        /* @__PURE__ */ l(aa, { asChild: !0, children: /* @__PURE__ */ l(
          "button",
          {
            className: B(
              Ln(),
...
function Qi({
  ...
  const m = P(() => {
    ...
    const L = E.id, _ = h.current.map((A) => {
      if (A.type === "question")
    ...
    const L = E.id, _ = h.current.map((A) => A.type === "section" && A.section.id === L ? {
      ...A,
      section: {
        ...A.section,
        ...E
    ...
    ({
      ...
      const _ = [...h.current];
      if (!L) {
        _.push(E), f.current(_);
        return;
      }
      ((O) => {
        _.forEach((z, M) => {
          z.type === "section" && z.section.id === O && _.splice(M + 1, 0, E), z.type === "question" && z.question.id === O && _.splice(M + 1, 0, E);
        });
      })(L), E.type === "question" && _.length === h.current.length && _.forEach((O, z) => {
        if (O.type !== "section")
          return;
        const M = [...O.section.questions ?? []];
        M?.forEach((K, Y) => {
          K.id === L && M.splice(Y + 1, 0, E.question);
        }), _.splice(z, 1, {
          ...O,
          section: {
            ...O.section,
    ...
    ({ type: E, afterId: L, datasetKey: _ }) => {
      if ((E === "dropdown-single" || E === "dropdown-multi") && !_)
    ...
    ({ elementId: E }) => {
      ...
      _ && (A = _.type === "section" ? {
        ...
        type: "question",
        question: { ..._, id: cn("question") }
      }), A && g({ element: A, afterId: E });
    },
    [g]
  ), w = I((E) => Cr(
    h.current.map(
      (_) => _.type === "question" ? [_.question] : _.section.questions
    )
  ).find((_) => _?.id === E), []), F = I((E) => {
    let L = h.current.filter((_) => _.type === "section" ? _.section.id !== E : _.type === "question" ? _.question.id !== E : !0);
    L.length === h.current.length && (L = L.map((_) => _.type === "section" ? {
      ..._,
      section: {
        ..._.section,
        questions: _.section.questions?.filter(
          (A) => A.id !== E
        )
      }
    } : _)), f.current(L);
  }, []), R = I((E) => {
    const L = h.current.find((_) => _.type === "section" ? _.section.questions?.some(
      (A) => A.id === E
    ) : !1);
  ...
  const k = I(
    ...
    () => ({
      ...
      getSectionContainingQuestion: N,
      disabled: t,
      answering: i,
      getQuestionById: w,
      deleteElement: F,
  ...
  return /* @__PURE__ */ l(wo.Provider, { value: T, children: e });
}
function fe() {
  const n = ke(wo);
  if (!n)
...
const Xi = () => {
  ...
  const { disabled: n, answering: e, onAddNewElement: t, isQuestionTypeAllowed: i } = fe(), [r, s] = G(!1), o = Xi(), { t: a } = re(), d = (f, m) => {
  ...
  return n || e ? null : /* @__PURE__ */ l("div", { className: "ml-6 flex justify-center", children: /* @__PURE__ */ x(Ni, { open: r, onOpenChange: s, children: [
    /* @__PURE__ */ l(Ei, { asChild: !0, children: /* @__PURE__ */ l(
      ce,
      {
        icon: Di,
    ...
    /* @__PURE__ */ x(_i, { align: "center", className: "w-80", children: [
      /* @__PURE__ */ l(Re, { onClick: u, children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
        /* @__PURE__ */ l(se, { icon: Ai, color: "default" }),
      ...
      c.map((f) => /* @__PURE__ */ l(
        Re,
        {
          ...
          children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
            /* @__PURE__ */ l(se, { icon: f.icon, color: "default" }),
      ...
      h.length > 0 && /* @__PURE__ */ x(we, { children: [
        ...
        h.map((f) => {
          ...
          return /* @__PURE__ */ x(Ot, { children: [
            /* @__PURE__ */ l(zt, { className: "mx-1 px-2 data-[state=open]:rounded-sm data-[state=closed]:bg-transparent data-[state=open]:bg-f1-background-hover", children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
              m && /* @__PURE__ */ l(se, { icon: m.icon, color: "default" }),
              /* @__PURE__ */ l("span", { className: "flex-1 text-base font-medium", children: m?.label ?? f })
            ] }) }),
            /* @__PURE__ */ l(Mt, { children: /* @__PURE__ */ x(It, { children: [
              i("dropdown-single") && /* @__PURE__ */ l(
                Re,
                {
                  onClick: () => d("dropdown-single", f),
                  children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
                    /* @__PURE__ */ l(se, { icon: We, color: "default" }),
              ...
              i("dropdown-multi") && /* @__PURE__ */ l(
                Re,
                {
                  ...
                  children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
                    /* @__PURE__ */ l(se, { icon: ft, color: "default" }),
...
function Pu(n, e) {
  if (n !== "rating" || !e || e.type !== "rating")
    return null;
  const t = e.options;
  return !Array.isArray(t) || t.length === 0 || typeof t[0]?.value != "number" ? null : xo(t);
}
function Hu(n, e, t) {
...
function So() {
  ...
  return { getActionsForQuestion: I(
    (d, u, c) => {
      const h = e(d), f = h && "datasetKey" in h && typeof h.datasetKey == "string" ? h.datasetKey : void 0, m = Pu(u, h), p = (S) => {
        n?.({
          id: d,
          type: u,
          required: S
        ...
        const T = Hu(
          ...
          u,
          h
        ), E = S === "dropdown-single" || S === "dropdown-multi", L = u === "dropdown-single" || u === "dropdown-multi";
        n?.({
          id: d,
          type: S,
          // Set datasetKey for dropdown types, clear it for non-dropdown types
          ...E ? { datasetKey: k } : { datasetKey: void 0 },
          ...
          ...E && L && S !== u || E && !L ? { value: S === "dropdown-multi" ? [] : null } : {},
          ...T && {
            ...gi(S)
          }
        });
      ...
      }, y = u === "dropdown-multi" && !!f, C = (S) => {
        if (!f) return;
        n?.({
          id: d,
          type: S ? "dropdown-multi" : "dropdown-single",
          datasetKey: f,
          value: S ? [] : null
        });
...
function Wu({
  ...
  const { getActionsForQuestion: i } = So();
  return P(
    () => i(n, e, t),
    [i, n, e, t]
  );
...
const ai = ({
  ...
  return /* @__PURE__ */ x(Ot, { children: [
    /* @__PURE__ */ l(zt, { className: "mx-1 px-2 data-[state=open]:rounded-sm data-[state=closed]:bg-transparent data-[state=open]:bg-f1-background-hover", children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
      /* @__PURE__ */ l(_e, { icon: as, color: "default" }),
    ...
    /* @__PURE__ */ l(Mt, { children: /* @__PURE__ */ x(It, { children: [
      u.map((f) => {
        ...
        return m ? /* @__PURE__ */ x(Ot, { children: [
          /* @__PURE__ */ l(zt, { className: "mx-1 mt-1 px-2 data-[state=open]:rounded-sm data-[state=closed]:bg-transparent data-[state=open]:bg-f1-background-hover", children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2 text-base font-medium", children: [
            /* @__PURE__ */ l(_e, { icon: f.icon, color: "default" }),
            /* @__PURE__ */ l("span", { className: "flex-1", children: f.label }),
            r && /* @__PURE__ */ l("span", { className: "mr-1 text-base text-f1-foreground-secondary", children: Fn.find(
              (v) => v.value === r
            )?.label })
          ] }) }),
          /* @__PURE__ */ l(Mt, { children: /* @__PURE__ */ l(It, { children: Fn.map((v) => /* @__PURE__ */ l(
            Re,
            {
              onClick: () => a(v.value),
  ...
  {
    onClick: t,
    className: B(i ? "text-f1-foreground-critical" : void 0),
    children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
...
function $u({
  ...
  const { t: o } = re(), { isQuestionTypeAllowed: a } = fe(), {
    ...
    questionType: i,
    canDelete: r
  }), b = (A) => s?.includes(A) ?? !1, S = !v && !b("required"), k = !!h && !b("multiSelect"), T = !!h && p && i === "dropdown-single" && !b("allowCreate"), E = !b("questionType"), L = !b("duplicate"), _ = r && !b("delete");
  return !S && !k && !T && !E && !L && !_ ? null : /* @__PURE__ */ x(Ni, { open: n, onOpenChange: e, children: [
    /* @__PURE__ */ l(Ei, { tabIndex: -1, asChild: !0, children: /* @__PURE__ */ l(
      ce,
      {
        icon: gn,
    ...
    /* @__PURE__ */ x(_i, { className: "w-80", align: "start", children: [
      /* @__PURE__ */ l(ha, { className: "p-4 pb-2 font-medium text-f1-foreground-secondary", children: o("surveyFormBuilder.labels.questionOptions") }),
      S && /* @__PURE__ */ l(At, { children: /* @__PURE__ */ l(
        ai,
        {
      ...
      k && /* @__PURE__ */ l(At, { children: /* @__PURE__ */ l(
        ai,
        {
      ...
      (S || k || T || E) && (L || _) && /* @__PURE__ */ l(yt, {}),
      (L || _) && /* @__PURE__ */ x(At, { children: [
        L && /* @__PURE__ */ l(
          Nr,
          {
...
const Er = {
  ...
  } = fe(), v = m(n), g = v?.locked || s, y = !!v, [C, w] = G(!1), [F, R] = G(!1), { isDragging: N } = _t(), { t: b } = re(), S = (V) => {
    d?.({
      id: n,
      type: o,
  ...
  }, L = Xi(), _ = L.filter((V) => !V.datasetKey), A = Array.from(
    new Set(
      L.filter((V) => !!V.datasetKey).map((V) => V.datasetKey)
    )
  ), O = f(n), z = W(null), M = W(!O);
  U(() => {
    M.current && z.current?.focus({ preventScroll: !0 });
  }, []);
  const K = c || g || h, Y = !h && K;
  return /* @__PURE__ */ x(
    "div",
    {
      ...
      className: B(
        ...
        !N && !h && "hover:border-f1-border-hover",
        !h || t ? "gap-4" : "gap-2"
      ),
      children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ x(_i, { align: "center", className: "w-80", children: [
                    !y && /* @__PURE__ */ x(we, { children: [
                      /* @__PURE__ */ l(Re, { onClick: E, children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
                        /* @__PURE__ */ l(se, { icon: Ai, color: "default" }),
                    ...
                    _.map((V) => /* @__PURE__ */ l(
                      Re,
                      {
                        ...
                        children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
                          /* @__PURE__ */ l(se, { icon: V.icon, color: "default" }),
                    ...
                    A.length > 0 && /* @__PURE__ */ x(we, { children: [
                      ...
                      A.map((V) => {
                        ...
                        return /* @__PURE__ */ x(Ot, { children: [
                          /* @__PURE__ */ l(zt, { className: "mx-1 px-2 data-[state=open]:rounded-sm data-[state=closed]:bg-transparent data-[state=open]:bg-f1-background-hover", children: /* @__PURE__ */ x("div", { className: "flex w-full flex-row items-center gap-2", children: [
                            ne && /* @__PURE__ */ l(se, { icon: ne.icon, color: "default" }),
  ...
  const { onQuestionChange: i, answering: r, disabled: s } = fe(), o = mt(t), { t: a } = re();
  if (r)
  ...
  const { onQuestionChange: t } = fe(), i = mt(e), { t: r } = re(), s = {
    id: e.id,
    type: "date",
  ...
  const { onQuestionChange: r, answering: s, datasets: o } = fe(), a = mt(i), { t: d } = re(), u = o?.[n];
  if (!u)
  ...
  const { onQuestionChange: s, useUpload: o } = fe(), a = mt(r), { t: d } = re(), u = e ?? o, c = {
    id: r.id,
    type: "file",
    label: d("surveyFormBuilder.answer.label"),
    multiple: !0,
  ...
  const { t } = re(), { onQuestionChange: i, answering: r } = fe(), s = mt(e), o = t("surveyFormBuilder.answer.linkPlaceholder"), a = {
    id: e.id,
    type: "text",
    inputType: "url",
  ...
  const { t } = re(), { onQuestionChange: i, answering: r } = fe(), s = mt(e), o = (d) => {
    i?.({
      ...e,
      type: "numeric",
      value: d
    ...
    "div",
    {
      ...
      children: s ? /* @__PURE__ */ x(
        vi,
        {
          ...
          children: [
            /* @__PURE__ */ l(bi, { asChild: !0, children: /* @__PURE__ */ l(
              ce,
              {
                emoji: a,
                label: o.toString(),
  ...
  const { onQuestionChange: i, disabled: r, answering: s } = fe(), a = xo(n) === "emojis", d = (c) => {
    i?.({
      id: t.id,
      value: c,
      type: "rating"
...
}, eh = (n) => /* @__PURE__ */ l(Zu, { ...n, type: "rating" });
function th({
  checked: n,
  disabled: e
}) {
...
const nh = {
  ...
  const { value: h, label: f } = e, { isDragging: m, setIsDragging: p, setDraggedItemId: v, draggedItemId: g } = _t(), { t: y } = re(), C = m && g === h, w = () => {
    !s && !o || t(h);
  }, F = (L) => {
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ l(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ l(_e, { icon: Xt, size: "sm" })
                  }
                )
              }
            ),
  ...
  return o ? null : /* @__PURE__ */ l(ue, { ...e, children: /* @__PURE__ */ x("div", { className: "-mx-0.5 flex flex-col items-start [&>div]:w-full", children: [
    /* @__PURE__ */ l(Ki, { children: /* @__PURE__ */ l(
      Ri,
      {
        axis: "y",
        values: n,
  ...
  const { onQuestionChange: t, answering: i } = fe(), r = mt(e), { t: s } = re(), o = s("surveyFormBuilder.answer.textPlaceholder"), a = P(
    () => e.type === "text" ? {
      id: e.id,
      type: "text",
  ...
  const { isDragging: i, setIsDragging: r, setDraggedItemId: s, draggedItemId: o } = _t(), a = ki(), { disabled: d, answering: u, getSectionContainingQuestion: c } = fe(), h = c(n.question.id), f = !!h && o === h.id, m = () => {
    r(!0), s(n.question.id);
  }, p = () => {
    r(!1), s(null);
            ...
            children: [
              !d && !u && /* @__PURE__ */ l(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ l(se, { icon: Xt, size: "sm" })
                }
              ),
              /* @__PURE__ */ l(
                Yi,
  ...
  const { isDragging: e, setIsDragging: t, setDraggedItemId: i } = _t(), r = ki(), { disabled: s, answering: o, getSectionContainingQuestion: a } = fe(), d = a(n.id), u = () => {
    t(!0), i(n.id);
  }, c = () => {
    t(!1), i(null);
        ...
        !s && /* @__PURE__ */ x(we, { children: [
          /* @__PURE__ */ l(Ki, { children: /* @__PURE__ */ l(
            Ri,
            {
              ...
              onReorder: y,
              as: "div",
              children: /* @__PURE__ */ l("div", { className: "group/section-list flex flex-col gap-4", children: i.map((b) => /* @__PURE__ */ l(ah, { question: b }, b.id)) })
            }
          ) }),
  ...
  const { isDragging: t, setIsDragging: i, setDraggedItemId: r, draggedItemId: s } = _t(), o = ki(), { disabled: a, answering: d } = fe(), u = s === n.section.id, c = () => {
    i(!0), r(n.section.id);
  }, h = () => {
    i(!1), r(null);
    ...
    Mn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "w-full", children: /* @__PURE__ */ x("div", { className: "group/element w-full", children: [
        ...
        u && (n.section.questions ?? []).length > 0 && /* @__PURE__ */ x("div", { className: "flex flex-col gap-4 w-full mt-4 ml-7", children: [
          (n.section.questions ?? []).map((m) => /* @__PURE__ */ l(Yi, { ...m }, m.id)),
          /* @__PURE__ */ l(Eo, {})
        ] })
      ] }) })
    }
  ...
  } = e, { deleteElement: m, onDuplicateElement: p, disabled: v, answering: g } = fe(), { getActionsForQuestion: y, questionTypes: C } = So(), w = I((R) => {
    uh(R);
  }, []), F = I(
    (R, N, b) => {
      const {
      ...
      const K = C.filter((q) => !q.datasetKey), Y = C.filter((q) => !!q.datasetKey), V = K.map((q) => {
        if (q.questionType === "rating") {
          ...
          return {
            ...
            label: q.label,
            icon: q.icon,
            selectedLabel: k ? Fn.find((ge) => ge.value === k)?.label : void 0,
            children: ie
          };
        }
        return {
          label: q.label,
          icon: q.icon,
          onClick: () => _(q.questionType),
          selected: N === q.questionType && !T
        };
      }), ne = /* @__PURE__ */ new Map();
      for (const q of Y)
      ...
      if (ne.size > 0) {
        ...
        for (const [q, ie] of ne)
          V.push({
            ...
            label: ie.label,
            icon: ie.icon,
            selectedLabel: T === q ? N === "dropdown-multi" ? f : h : void 0,
            children: [
              {
                label: h,
                icon: We,
                onClick: () => _("dropdown-single", q),
                selected: T === q && N === "dropdown-single"
              },
              {
                label: f,
                icon: ft,
                onClick: () => _("dropdown-multi", q),
                selected: T === q && N === "dropdown-multi"
              }
            ]
          });
      }
  ...
  return P(
    () => n.map((R) => {
      if (R.type === "section") {
        const b = R.section, S = `co-creation-section-${b.id}`, k = b.questions ?? [], T = k.length === 1;
        return {
          id: S,
          label: b.title || t,
          icon: Ai,
...
}, li = "co-creation-section-", dn = "co-creation-question-";
function fh(n, e) {
  ...
  const r = [], s = (o) => {
    if (o.id.startsWith(li)) {
      const a = o.id.slice(li.length), d = t.get(a);
      if (!d) return;
      const u = (o.children ?? []).filter((c) => c.id.startsWith(dn)).map((c) => i.get(c.id.slice(dn.length))).filter((c) => c != null);
      r.push({
        type: "section",
        section: { ...d, questions: u }
      });
      for (const c of o.children ?? [])
        c.id.startsWith(li) && s(c);
      return;
    }
    if (o.id.startsWith(dn)) {
      const a = o.id.slice(dn.length), d = i.get(a);
...
const Do = ({
  ...
  const { t: i } = re(), { disabled: r } = fe(), { portalContainer: s } = ke(ya), o = hh(n, {
...
function vh({
  ...
  const [t, i] = G(
    ...
    (u) => {
      ...
      let f = null;
      for (const N of n)
        N.type === "section-header" ? (f = N.id, c.set(N.id, /* @__PURE__ */ new Set()), N.section.locked && h.add(N.id)) : N.type === "section-end" ? f = null : f && c.get(f).add(N.id);
      const m = n.filter((N) => N.type === "section-header").map((N) => N.id), p = u.filter((N) => N.type === "section-header").map((N) => N.id), v = m.some(
        (N, b) => p[b] !== N
      ), g = new Map(
        n.filter((N) => N.type !== "section-end").map((N, b) => [N.id, b])
      ), y = new Set(h);
      if (v)
        for (const [N, b] of u.entries())
          b.type === "section-header" && g.get(b.id) !== N && y.add(b.id);
      let C;
      if (y.size > 0) {
        ...
        for (const k of u) {
          const T = N.get(k.id);
          T ? b.get(T).push(k) : S.push(k);
        }
        C = [];
        for (const k of S)
          C.push(k), k.type === "section-header" && y.has(k.id) && C.push(...b.get(k.id));
      } else
        C = u;
...
function bh({ children: n }) {
  const { isDragging: e } = _t();
  return /* @__PURE__ */ l("div", { className: B("relative @container", e && "select-none"), children: n });
}
const yh = ({
  elements: n,
  disabled: e,
  ...
  const d = !e, u = P(
    ...
    for (const F of u)
      if (F.type === "section")
        for (const R of F.section.questions ?? [])
          w.add(`question-${R.id}`);
    return w;
  }, [u]), {
    handleFlatReorder: p,
  ...
  return /* @__PURE__ */ x(
    Qi,
    {
      ...
      datasets: a,
      children: [
        /* @__PURE__ */ l(Ki, { children: /* @__PURE__ */ x(bh, { children: [
          C && /* @__PURE__ */ l(Do, { elements: u, onChange: t }),
                  ...
                  /* @__PURE__ */ l(
                    Ri,
                    {
                      ...
                      children: /* @__PURE__ */ l("div", { className: "flex flex-col", children: h.map((w, F) => {
                        const R = F === 0 ? "" : m.has(w.id) ? "mt-4" : "mt-8";
...
const fn = /* @__PURE__ */ l(he, { className: "h-10 w-full rounded-sm" }), Rr = /* @__PURE__ */ l(he, { className: "h-24 w-full rounded-sm" }), xh = /* @__PURE__ */ l(he, { className: "h-10 w-56 max-w-full rounded-sm" });
function wh() {
...
function Nh(n) {
  const [e, t] = G(0), [i, r] = G(null), s = n.length, o = s > 0 ? e / s * 100 : 0, a = i ?? o, d = n[e], u = e === 0, c = e === s - 1, h = I(() => {
...
const _h = /^(https?:\/\/)?[\w.-]+\.[a-z]{2,}(:\d+)?(\/[^\s]*)?$/i, Rh = () => ({
  upload: async (n) => ({
    type: "success",
    value: `local-${n.name}-${Date.now()}`
  }),
...
function un(n, e) {
  return Bn().optional().superRefine((t, i) => {
...
function Fr(n, e) {
  return Ca().optional().superRefine((t, i) => {
    n && t == null && i.addIssue({
      code: "custom",
      message: e("forms.validation.required")
    });
...
function Ar(n, e) {
  return Xr(Bn()).optional().superRefine((t, i) => {
...
function Th(n, e) {
  return Sa().optional().superRefine((t, i) => {
    n && !t && i.addIssue({
      code: "custom",
      message: e("forms.validation.required")
    });
...
function Ah(n, e) {
  return wa().optional().superRefine((t, i) => {
    n && !t && i.addIssue({
      code: "custom",
      message: e("forms.validation.required")
    });
...
function Ro(n, e, t, i, r, s, o = !1, a = o, d, u) {
  return P(() => {
    const c = {}, h = {}, f = {}, m = Ji(n), p = e === "stepped";
    for (const v of n)
      if (v.type === "section") {
...
function _f(n) {
  return n.inline ? /* @__PURE__ */ l(Oh, { ...n }) : /* @__PURE__ */ l(Lh, { ...n });
}
function Lh({
  elements: n,
  onSubmit: e,
  ...
  const { t: C } = re(), w = d === "fullscreen", F = d === "fullscreen" ? "center" : d, [R, N] = G(w), { formRef: b, submit: S, isSubmitting: k, hasErrors: T } = Fi(), E = W({}), L = P(
    () => Ji(n),
    [n]
  ), _ = Nh(L), A = L.length > 0, O = {
  ...
  }, z = t === "stepped", K = v && !!h && Object.keys(h).length > 0, Y = v && !K, V = z ? _.currentQuestion?.id : void 0, {
    schema: ne,
    defaultValues: Z,
    sections: q
  } = Ro(
    ...
    g,
    y
  ), ie = R ? "fullscreen" : F, ge = ie === "center" ? "xl" : void 0, de = W(null), J = I(
    (ye) => {
    ...
    async (ye) => {
      ...
      if (z && !_.isLastStep)
        return E.current = {
          ...E.current,
          ...ye
        }, _.goToNext(), { success: !0 };
      const qe = z ? { ...E.current, ...ye } : ye, De = {};
      for (const [Te, et] of Object.entries(qe))
        De[Te] = et === void 0 ? null : et;
      if (z) {
        _.setProgress(100);
        ...
        return Te.success ? (J(Te.message ? 1e3 : 0), { success: !0, message: Te.message }) : (_.setProgress(null), { success: !1, errors: Te.errors });
      }
      const $e = await e(De);
      return $e.success ? (J($e.message ? 1e3 : 0), { success: !0, message: $e.message }) : { success: !1, errors: $e.errors };
    },
    [
      e,
      v,
  ...
  }, [b, _.goToPrevious]), X = c && !m ? [
    {
      label: C(R ? "surveyAnsweringForm.actions.collapse" : "surveyAnsweringForm.actions.expand"),
      icon: R ? Na : Ea,
      onClick: () => N((ye) => !ye)
    }
  ] : void 0, j = A ? m || K ? void 0 : Y ? z && !_.isLastStep ? {
    ...
    disabled: k || T,
    loading: k
  } : void 0, me = A ? m || K ? void 0 : z && !_.isFirstStep ? {
    label: C("surveyAnsweringForm.actions.previous"),
    onClick: H,
    icon: $r
  } : void 0 : void 0, ve = t === "all-questions" && A && !m, Ie = z && A && !m, Be = z && !!_.currentQuestion?.sectionTitle && !m, rt = ie === "center" || ie === "fullscreen";
  return /* @__PURE__ */ l(
    Da,
    {
      isOpen: o,
        ...
        Qi,
        {
          ...
          children: /* @__PURE__ */ x(
            "div",
            {
              ...
              children: [
                ve && /* @__PURE__ */ l(Do, { elements: n, onChange: mn, answering: !0 }),
                ...
                /* @__PURE__ */ x(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      m ? t === "stepped" ? /* @__PURE__ */ l(Sh, {}) : /* @__PURE__ */ l(_o, {}) : A ? null : /* @__PURE__ */ l(
                        io,
                        {
                          display: "flex",
                          flexDirection: "column",
                      ...
                      Be && /* @__PURE__ */ x("div", { className: "py-1 pl-5", children: [
                        /* @__PURE__ */ l("span", { className: "text-lg font-semibold text-f1-foreground", children: _.currentQuestion?.sectionTitle }),
                        _.currentQuestion?.sectionDescription && /* @__PURE__ */ l("p", { className: "text-f1-foreground-secondary", children: _.currentQuestion?.sectionDescription })
                      ] }),
                      A && !m && /* @__PURE__ */ l(
                        Pn,
                        {
...
const zh = ({ benefits: n }) => /* @__PURE__ */ l("div", { className: "flex flex-col gap-2", children: n.map((e, t) => /* @__PURE__ */ l(Mh, { text: e }, t)) }), Mh = ({ text: n }) => /* @__PURE__ */ x("div", { className: "flex flex-row items-start gap-2", children: [
  /* @__PURE__ */ l(se, { icon: zn, size: "md", className: "text-f1-icon-positive" }),
          ...
          /* @__PURE__ */ x("div", { className: "flex flex-col gap-5", children: [
            /* @__PURE__ */ x("div", { className: "flex flex-col gap-2", children: [
              ...
              (a || d) && /* @__PURE__ */ x("div", { className: "flex justify-start gap-2", children: [
                a && /* @__PURE__ */ l(Ra, { icon: a.icon, text: a.label }),
                d && /* @__PURE__ */ l(
                  wi,
                  {
...
ko.displayName = "ProductBlankslate";
const Ih = ae(ko);
function Bh({
  isOpen: n,
  onClose: e,
  ...
  return U(() => {
    a(n);
  }, [n]), /* @__PURE__ */ l(ka, { open: o, onOpenChange: (u) => {
    a(u), u || e();
    ...
    Ta,
    {
      ...
      children: [
        /* @__PURE__ */ x("div", { className: "flex flex-row items-center justify-between px-4 py-4", children: [
          /* @__PURE__ */ x(Fa, { className: "flex flex-row items-center gap-2 text-lg font-semibold text-f1-foreground", children: [
            r && /* @__PURE__ */ l(Zr, { module: r, size: "lg" }),
            t
          ] }),
          /* @__PURE__ */ l(
            Pr,
        ...
        /* @__PURE__ */ x(Wr, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[512px] flex-col", children: [
          i,
          /* @__PURE__ */ l(
            qr,
            {
...
function Ph({
  ...
  const [C, w] = G(n), [F, R] = G(null), [N, b] = G(!1), S = async () => {
    if (c?.onClick) {
      b(!0);
      try {
        await c.onClick(), w(!1), y && R("success");
      } catch {
        y && R("error");
      } finally {
        b(!1);
    ...
    /* @__PURE__ */ x(St, { children: [
      ...
      /* @__PURE__ */ x("div", { children: [
        ...
        /* @__PURE__ */ x("div", { className: "flex flex-col gap-[2px] p-3", children: [
          /* @__PURE__ */ l(ir, { className: "text-lg font-medium", children: e }),
          /* @__PURE__ */ l(ir, { className: "line-clamp-3 text-base font-normal text-f1-foreground-secondary", children: t })
        ] })
      ] })
    ] }),
    a && /* @__PURE__ */ l(Jt, { className: "p-3", children: a.map(
          ...
          children: [
            /* @__PURE__ */ x(
              "div",
              {
                ...
                children: [
                  n && /* @__PURE__ */ l("div", { className: "flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-sm border border-solid text-f1-icon-promote [background:hsl(var(--promote-50)/0.1)] [border-color:hsl(var(--promote-50)/0.1)]", children: /* @__PURE__ */ l(se, { icon: n, size: "sm" }) }),
                  /* @__PURE__ */ x("div", { className: "flex flex-col gap-0.5", children: [
            ...
            /* @__PURE__ */ l("div", { className: B("flex flex-shrink-0 @xs:pl-0", n && "pl-8"), children: /* @__PURE__ */ l(
              Ti,
              {
                label: i.label,
...
To.displayName = "UpsellingBanner";
const Tf = ae(To);
function $h({
  isOpen: n,
  setIsOpen: e,
  ...
  const [y, C] = G(!1), [w, F] = G(null), [R, N] = G(null), b = (L) => {
    e(L), v && v();
  }, S = async (L) => {
    if (L.type === "upsell") {
      N(L);
    ...
    F(null), C(!1), N(null), e(!1);
  }, T = n && !y, E = p?.map((L) => L.type === "upsell" ? {
    ...L,
    onClick: () => S(L)
  } : L);
  return /* @__PURE__ */ x(we, { children: [
    /* @__PURE__ */ x(vi, { open: T, onOpenChange: b, children: [
      /* @__PURE__ */ l(bi, { asChild: !0, children: /* @__PURE__ */ l(
        ce,
        {
          variant: i,
    ...
    R?.type === "upsell" && R.showConfirmation && w && /* @__PURE__ */ l(
      es,
      {
        open: !0,
        onClose: k,
...
const Ff = ae($h), Af = ({
  ...
  return /* @__PURE__ */ x(Ct, { className: "flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ x(St, { className: "flex flex-col gap-4 p-0", children: [
      /* @__PURE__ */ l(
        "div",
        {
          className: B(
    ...
    /* @__PURE__ */ l(Jt, { className: "-mx-4 -mb-4 mt-4 flex justify-end rounded-b-xl border-0 border-t border-t-f1-border bg-f1-background-secondary px-4 py-3", children: r ? /* @__PURE__ */ l(
      ce,
      {
        variant: "default",
        size: "md",
...
}, Gh = ({ item: n, isExpanded: e, onToggle: t }) => /* @__PURE__ */ x(
  "div",
  {
    className: B(
  ...
  const d = re()?.ai?.growth?.faqCard?.title ?? "Questions before getting started", u = n ?? Oa, [c, h] = G(
    () => new Set(t ? [t] : [])
  ), f = i !== void 0, m = I(
    (v) => f ? i === v : c.has(v),
    [f, i, c]
  ...
  return e.length === 0 ? null : /* @__PURE__ */ x(Ct, { className: "flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ x(La, { className: "-mx-4 -mt-4 mb-2 flex flex-row items-center gap-2 rounded-t-xl bg-f1-background-secondary px-4 py-3", children: [
    ...
    /* @__PURE__ */ l(St, { className: "flex flex-col divide-y divide-f1-border p-0", children: e.map((v) => /* @__PURE__ */ l(
      Gh,
      {
        item: v,
        isExpanded: m(v.id),
  ...
  return /* @__PURE__ */ x(Ct, { className: "flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ l(St, { className: "flex flex-col gap-3 p-0", children: /* @__PURE__ */ x("div", { className: "flex items-start gap-3", children: [
      /* @__PURE__ */ l(
        za,
        {
          avatar: {
    ...
    /* @__PURE__ */ l(Jt, { className: "-mx-4 -mb-4 mt-4 flex justify-end rounded-b-xl border-0 border-t border-t-f1-border bg-f1-background-secondary px-4 py-3", children: i ? /* @__PURE__ */ l(
      ce,
      {
        variant: "outline",
        size: "md",
  ...
  return /* @__PURE__ */ x(Ct, { className: "flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ x(St, { className: "flex flex-col gap-3 p-0", children: [
      /* @__PURE__ */ l(se, { icon: Si, size: "lg" }),
      /* @__PURE__ */ x("div", { className: "flex flex-col gap-0.5", children: [
    ...
    /* @__PURE__ */ l(Jt, { className: "-mx-4 -mb-4 mt-4 flex justify-end rounded-b-xl border-0 border-t border-t-f1-border bg-f1-background-secondary px-4 py-3", children: e ? /* @__PURE__ */ l(
      ce,
      {
        variant: "default",
        size: "md",
  ...
  const [s, o] = G(0), [a, d] = G({}), u = re(), c = n.length, h = n[s], f = a[s] ?? [], m = I(
    (w, F) => {
      d((R) => {
        const N = R[s] ?? [], b = F ? [...N, w] : N.filter((S) => S !== w);
        return { ...R, [s]: b };
      });
    },
    [s]
    ...
    if (s < c - 1)
      ...
      if (i && r) {
        const w = Object.entries(a).map(([F, R]) => n[parseInt(F)].options.filter((b) => R.includes(b.id)).map((b) => b.label)).flat();
        w.length > 0 && r(w.join(", "));
      }
      e?.(a);
    }
  ...
  return c === 0 || !h ? null : /* @__PURE__ */ x(Ct, { className: "flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ x(St, { className: "flex flex-col gap-4", children: [
    ...
    /* @__PURE__ */ x(Jt, { className: "-mx-4 -mb-4 mt-4 flex items-center justify-between rounded-b-xl border-0 border-t border-t-f1-border bg-f1-background-secondary px-4 py-3", children: [
      /* @__PURE__ */ l("div", { className: "flex min-w-[7.5rem] items-center justify-start gap-1", children: y && /* @__PURE__ */ x(we, { children: [
        /* @__PURE__ */ l(
          "button",
          {
            ...
            "aria-label": "Previous",
            children: /* @__PURE__ */ l(se, { icon: Ma, size: "sm" })
          }
        ),
        ...
        /* @__PURE__ */ l(
          "button",
          {
            ...
            className: "flex h-8 w-8 shrink-0 items-center justify-center rounded text-f1-foreground-secondary transition-colors hover:bg-f1-background-tertiary hover:text-f1-foreground disabled:pointer-events-none disabled:opacity-50",
            "aria-label": "Next",
            children: /* @__PURE__ */ l(se, { icon: ts, size: "sm" })
          }
        )
      ] }) }),
  ...
  Ka
), zr = (n) => `datacollection-${n}`, Bf = {
  get: async (n) => JSON.parse(
    localStorage.getItem(zr(n)) ?? "{}"
  ),
  set: async (n, e) => {
    localStorage.setItem(zr(n), JSON.stringify(e));
  }
};
export {
  Tg as AiChatTranslationsProvider,
  yp as AreaChart,
  Wf as Await,
  xp as BarChart,
  Fg as BarChartSkeleton,
  qf as CanvasCard,
  $f as CardSelectableContainer,
  wp as CategoryBarChart,
  Gf as ChatSpinner,
  pn as Chip,
  Ag as CloseCanvasButton,
  Cp as ComboChart,
  Jh as Dashboard,
  Lg as DashboardCanvasProvider,
  Og as DashboardCard,
  zg as DashboardContent,
  Mg as DashboardHeader,
  Ig as DataChartEmptyStateView,
  Bg as DataDownloadCard,
  Pg as DataDownloadContent,
  Hg as DataDownloadHeader,
  Wg as DataDownloadProvider,
  ...
  Vf as F0ActionItem,
  Qf as F0AiChat,
  Kf as F0AiChatProvider,
  Xf as F0AiChatTextArea,
  Yf as F0AiFormRegistryProvider,
  Jf as F0AiFullscreenChat,
  qg as F0AiInsightCard,
  $g as F0AiMask,
  Gg as F0AiProposalCard,
  Zf as F0Alert,
  If as F0AnalyticsDashboard,
  jg as F0AuraVoiceAnimation,
  za as F0Avatar,
  em as F0AvatarAlert,
  tm as F0AvatarCompany,
  Sp as F0AvatarDate,
  nm as F0AvatarEmoji,
  im as F0AvatarFile,
  rm as F0AvatarIcon,
  sm as F0AvatarList,
  Zr as F0AvatarModule,
  om as F0AvatarPerson,
  am as F0AvatarTeam,
  sf as F0BigNumber,
  zf as F0BookAMeetingCard,
  io as F0Box,
  ce as F0Button,
  lm as F0ButtonDropdown,
  ...
  Af as F0DemoCard,
  Da as F0Dialog,
  ya as F0DialogContext,
  hm as F0DialogProvider,
  Vg as F0DurationInput,
  fm as F0EventCatcherProvider,
  Lf as F0FAQCard,
  ...
  se as F0Icon,
  mm as F0Link,
  Kg as F0MessageCreditsWarning,
  Of as F0ModuleCard,
  da as F0OneIcon,
  gm as F0OneSwitch,
  Xg as F0Provider,
  Mf as F0QuestionCardMultiStep,
  pm as F0Select,
  Ef as F0TableOfContentPopover,
  vm as F0TagAlert,
  $o as F0TagBalance,
  bm as F0TagCompany,
  ym as F0TagDot,
  ...
  Nm as FileItem,
  Em as FormCard,
  Dm as FormCardValueFormatterProvider,
  Yg as FormContent,
  Jg as FormHeader,
  Zg as FunnelChartSkeleton,
  _m as GROUP_ID_SYMBOL,
  ep as GaugeChartSkeleton,
  tp as HeatmapChartSkeleton,
  nf as HomeLayout,
  Zh as Layout,
  Np as LineChart,
  np as LineChartSkeleton,
  ip as MessageSources,
  Ep as NotesTextEditor,
  Dp as NotesTextEditorPatchTargetNotFoundError,
  _p as NotesTextEditorSkeleton,
  Rp as NotesTextEditorUnsupportedPatchTypeError,
  Rm as OneCalendar,
  km as OneCalendarInternal,
  Tm as OneEllipsis,
  Jr as OneEmptyState,
  Fm as OneFilterPicker,
  kp as PieChart,
  rp as PieChartSkeleton,
  Am as PrivacyModeProvider,
  Ih as ProductBlankslate,
  Tp as ProductCard,
  Rf as ProductModal,
  Wh as ProductWidget,
  Fp as ProgressBarChart,
  Ap as RadarChart,
  sp as RadarChartSkeleton,
  Lm as RichTextDisplay,
  Om as RichTextEditor,
  ef as StandardLayout,
  _o as SurveyAllQuestionsLoadingSkeleton,
  _f as SurveyAnsweringForm,
  Df as SurveyFormBuilder,
  Sh as SurveySteppedLoadingSkeleton,
  Sf as Tag,
  zm as TagCounter,
  tf as TwoColumnLayout,
  es as UpsellRequestResponseDialog,
  kf as UpsellingAlert,
  Tf as UpsellingBanner,
  Ti as UpsellingButton,
  Ff as UpsellingPopover,
  Lp as VerticalBarChart,
  Mm as WeekStartDay,
  Im as actionBarStatuses,
  op as actionItemStatuses,
  ap as aiTranslations,
  gf as alertVariantOptions,
  Yh as avatarVariants,
  Bm as buildTranslations,
  df as buttonDropdownModes,
  cf as buttonDropdownSizes,
  lf as buttonDropdownVariants,
  af as buttonSizes,
  Op as buttonToggleSizes,
  zp as buttonToggleVariants,
  of as buttonVariants,
  hf as cardAlertVariants,
  Pm as cardImageAspectRatios,
  Hm as cardImageFits,
  Wm as cardImageSizes,
  lp as chartColorTokens,
  qm as chipVariants,
  ph as computeSectionEndIds,
  cp as contentTypes,
  $m as createAtlaskitDriver,
  Gm as createDataSourceDefinition,
  vf as createF0FormDefinitionTester,
  Jd as createF0FormTester,
  xl as createPageLayoutBlock,
  wl as createPageLayoutBlockGroup,
  Bf as dataCollectionLocalStorageHandler,
  mf as datepickerSizes,
  Pp as defaultTranslations,
  jm as defineAvailableForm,
  Xd as describeFormSchema,
  Um as durationInputSizes,
  Vm as durationUnits,
  $a as evaluateRenderIf,
  Me as experimental,
  Oe as f0FormField,
  Qm as fieldsToSeconds,
  mh as flattenElements,
  dp as generateAnchorId,
  Km as getAnimationVariants,
  Xm as getDataSourcePaginationType,
  Ym as getEmojiLabel,
  Yt as getF0Config,
  Jm as getGranularityDefinition,
  Zm as getGranularityDefinitions,
  eg as getGranularitySimpleDefinition,
  up as getSchemaDefinition,
  tg as granularityDefinitions,
  ng as hasF0Config,
  Xo as inferFieldType,
  gh as injectSectionEnds,
  ig as isInfiniteScrollPagination,
  rg as isPageBasedPagination,
  sg as isZodType,
  uf as linkVariants,
  og as modules,
  hp as oneIconSizes,
  Mp as predefinedPresets,
  ag as rangeSeparator,
  _r as reconstructElements,
  fp as savedDashboardConfigStore,
  lg as secondsToFields,
  cg as secondsToVisibleFields,
  Ip as selectSizes,
  rf as tagDotColors,
  wf as timelineRowStatuses,
  dg as unwrapZodSchema,
  ug as useAiChat,
  mp as useAiChatTranslations,
  hg as useCanvasEntity,
  fg as useData,
  mg as useDataSource,
  gg as useDndEvents,
  pg as useDraggable,
  vg as useDroppableList,
  bg as useEmojiConfetti,
  yg as useF0AiFormRegistry,
  xg as useF0Dialog,
  Fi as useF0Form,
  gp as useF0FormDefinition,
  wg as useFormCardValueFormatter,
  pp as useFormComponent,
  Cg as useGroups,
  Sg as usePrivacyMode,
  Ng as useReducedMotion,
  vp as useSchemaDefinition,
  Eg as useSelectable,
  Dg as useSetFormCardValueFormatter,
  _g as useToolCallId,
  Rg as useXRay,
  ae as withDataTestId
};

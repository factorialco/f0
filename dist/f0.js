import { O as Eo, P as xe, Q as gt, K as Q, L as nn, R as Hn, T as Io, U as ga, W as ii, X as Bu, Y as Ro, Z as Le, u as Fe, _ as ht, $ as rr, a0 as Vu, a1 as $u, a2 as _r, a3 as ot, a4 as sr, a5 as zu, a6 as qu, a7 as Zu, a8 as Vn, a9 as xs, aa as Wu, ab as Uu, ac as Qu, ad as oi, ae as Hu, af as Gu, ag as Po, ah as Ku, ai as va, aj as ba, ak as Kr, al as ya, am as Lo, an as kr, ao as Mo, ap as Xu, aq as Yu, ar as Ju, as as ed, at as xa, au as li, av as td, aw as nd, ax as rd, ay as jo, az as sd, M as Ve, aA as ad, aB as wa, aC as Gn, aD as Bo, aE as Xr, aF as id, aG as od, aH as ar, aI as Sa, aJ as Vo, aK as vn, aL as $o, aM as ld, aN as _a, aO as cd, aP as zo, aQ as qo, N as Kn, aR as ud, aS as Ws, aT as Zo, aU as dd, aV as Wo, aW as yn, aX as Uo, aY as fd, aZ as hd, a_ as Qo, a$ as md, b0 as pd, b1 as gd, b2 as Yr, b3 as vd, b4 as bd, b5 as yd, b6 as xd, j as wd, b7 as Sd, b8 as Ho, b9 as Go, ba as Ko, bb as Xo, bc as Cr, bd as Yo, be as ka, bf as Ca, bg as _d, bh as kd, bi as Cd, bj as Nd, bk as ws, bl as Jo, bm as Dd, bn as Nr, bo as Dr, bp as Ht, bq as ci, br as ui, bs as el, bt as di, bu as fi, bv as Jr, bw as tl, bx as Na, by as Da, bz as Ad, bA as Fd, bB as Td, bC as Od, bD as Ed, bE as nl, bF as Id, bG as Rd, bH as Pd, bI as Ld, bJ as rl, bK as Md, bL as jd, bM as Bd, bN as sl, bO as Vd, bP as $d, bQ as zd, bR as qd, I as Zd, bS as Wd, bT as Ud, bU as Qd, bV as Hd, bW as Gd, bX as Kd } from "./F0AiChat-BbipqmNB.js";
import { cn as rw, i as sw, cz as aw, cH as iw, h as ow, F as lw, a as cw, C as uw, b as dw, bY as fw, bZ as hw, b_ as mw, b$ as pw, c0 as gw, c1 as vw, c3 as bw, c4 as yw, c5 as xw, c6 as ww, ca as Sw, cd as _w, cD as kw, k as Cw, cg as Nw, ch as Dw, ci as Aw, cj as Fw, cl as Tw, cm as Ow, co as Ew, cf as Iw, ck as Rw, cE as Pw, c7 as Lw, c8 as Mw, c9 as jw, cc as Bw, cb as Vw, cy as $w, ct as zw, cw as qw, g as Zw, cs as Ww, cI as Uw, cr as Qw, cq as Hw, c2 as Gw, c as Kw, cp as Xw, cu as Yw, d as Jw, cA as e1, cB as t1, cC as n1, cJ as r1, ce as s1, cv as a1, f as i1, e as o1, cG as l1, cx as c1, cF as u1 } from "./F0AiChat-BbipqmNB.js";
...
import { C as sf, S as hi, a as af, f as Ss, L as Rn, b as of, A as lf, i as mr, c as ll, E as cf, g as yr, d as uf, e as df, h as ff, j as pn, k as cl, u as hf, G as mf, l as pf, m as mi, r as gf, n as vf, o as ul, p as bf, B as dl, X as fl, Y as Us, q as yf, s as hl, t as xf, v as wf, w as Sf, x as _f, y as kf, z as Cf, D as Nf, F as Df, H as pi, I as Af, J as Ff, K as Tf, M as Of, N as Ef, O as If, P as Rf, Q as Pf, V as Lf, R as Qs, T as Mf, U as jf, W as Bf, Z as ml, _ as Fa, $ as pl, a0 as Vf, a1 as $f, a2 as zf, a3 as qf, a4 as Zf, a5 as Wf, a6 as Uf } from "./index-l-11cEZ4.js";
import { a7 as f1, aa as h1, a8 as m1, a9 as p1, ab as g1 } from "./index-l-11cEZ4.js";
import { A as b1, F as y1, c as x1, d as w1, b as S1, a as _1, o as k1, u as C1 } from "./F0HILActionConfirmation-CLqZVL95.js";
...
), eh = (e, t, n) => /* @__PURE__ */ c("div", { children: e }), es = ({
  widgets: e = [],
  editMode: t = !1,
  onChange: n = () => {
  },
...
const Pn = nn({
  ...
  ({
    ...
    const f = s ?? ah[t ?? "body"], m = l ? /* @__PURE__ */ c("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (a !== void 0) {
...
}, ih = () => /* @__PURE__ */ O("div", { className: "relative flex h-full w-full cursor-progress flex-col rounded-xl border border-solid border-f1-border-secondary bg-f1-background", children: [
...
const ch = nh("Dashboard", Sl), o0 = xe(
  ot("Dashboard", ch)
), uh = nn({
...
}), dh = (e) => (e || []).map((t) => t.items).reduce((t, n) => (t.length > 0 && t.push({ type: "separator" }), t.push(...n), t), []), fh = (e) => {
  ...
  ({
    ...
    return /* @__PURE__ */ O(
      ...
      {
        ref: d,
        className: Q(uh({ variant: t }), "relative", n),
        draggable: r,
        onDragStart: s,
        onDragEnd: a,
        onDrop: i,
...
const hh = ({
  ...
  "BlockContent",
  hh
), ph = (e) => !al(e) || !e.type || typeof e.type == "string" || typeof e.type == "symbol" ? !1 : "__isPageLayoutBlock" in e.type, gh = (e) => !al(e) || !e.type || typeof e.type == "string" || typeof e.type == "symbol" ? !1 : "__isPageLayoutGroup" in e.type, _l = (e, t, n) => {
  const r = Ar.toArray(t);
  for (const s of r)
    n.includes("block") && ph(s) || n.includes("group") && gh(s) || console.warn(
...
function Th(e) {
  ...
  const {
    announce: a,
    announcement: i
  } = Ch(), o = lr("DndLiveRegion"), [l, u] = ee(!1);
  if (ie(() => {
    u(!0);
  }, []), Nh(V(() => ({
    onDragStart(f) {
    ...
    return null;
  const d = K.createElement(K.Fragment, null, K.createElement(_h, {
    id: r,
    value: s.draggable
  }), K.createElement(kh, {
    id: o,
...
const Lh = (e) => {
  ...
  for (const i of r) {
    ...
    if (l) {
      const u = bi(l), d = s.reduce((m, h, x) => m + Eh(u[x], h), 0), f = Number((d / 4).toFixed(4));
      a.push({
        id: o,
        data: {
...
function as(e, t) {
  ...
  function r(s) {
    ...
    return s !== e && Uh(s, a) && n.push(s), Wh(s, a) ? n : r(s.parentNode);
  }
  return e ? r(e) : n;
}
function Tl(e) {
...
const Yh = [["x", ["left", "right"], Kh], ["y", ["top", "bottom"], Xh]];
class Ra {
  constructor(t, n) {
...
class La {
  constructor(t, n, r) {
    var s;
    r === void 0 && (r = Jh(t.event.target)), this.props = void 0, this.events = void 0, this.autoScrollEnabled = !0, this.document = void 0, this.activated = !1, this.initialCoordinates = void 0, this.timeoutId = null, this.listeners = void 0, this.documentListeners = void 0, this.windowListeners = void 0, this.props = t, this.events = n;
    const {
      event: a
    } = t, {
      target: i
  ...
  handleStart() {
    ...
    t && (this.activated = !0, this.documentListeners.add(xt.Click, em, {
      capture: !0
...
const km = {
  ...
  over: null,
  measureDroppableContainers: Er
}, cr = /* @__PURE__ */ Tt(Vl), $l = /* @__PURE__ */ Tt(km);
function Cm() {
  return {
    draggable: {
      active: null,
...
const Tm = /* @__PURE__ */ ol(function(t) {
  var n, r, s, a;
  let {
    id: i,
    accessibility: o,
  ...
  const w = Jd(Nm, void 0, Cm), [g, v] = w, [p, b] = Dh(), [C, k] = ee(Ut.Uninitialized), S = C === Ut.Initialized, {
    draggable: {
      active: _,
      nodes: D,
      translate: R
    ...
    return _ != null ? {
      ...
      data: (He = I?.data) != null ? He : _m,
      rect: N
    } : null;
  }, [_, I]), M = W(null), [U, le] = ee(null), [G, ce] = ee(null), te = Xn(x, Object.values(x)), me = lr("DndDescribedBy", i), J = V(() => F.getEnabled(), [F]), z = Am(m), {
    droppableRects: $,
    ...
    config: z.droppable
  }), ae = cm(D, _), pe = V(() => G ? Or(G) : null, [G]), be = ju(), oe = fm(ae, z.draggable.measure);
  Fm({
  ...
  const X = ki(ae, z.draggable.measure, oe), ue = ki(ae ? ae.parentElement : null), De = W({
  ...
  }), Te = F.getNodeFor((n = De.current.over) == null ? void 0 : n.id), Pe = wm({
    measure: z.dragOverlay.measure
  }), Ge = (r = Pe.nodeRef.current) != null ? r : ae, Ke = S ? (s = Pe.rect) != null ? s : X : null, ct = !!(Pe.nodeRef.current && Pe.rect), y = pm(ct ? null : X), A = jl(Ge ? rt(Ge) : null), T = gm(S ? Te ?? ae : null), Z = xm(T), j = zl(h, {
    transform: {
      x: R.x - y.x,
      y: R.y - y.y,
      scaleX: 1,
    ...
    windowRect: A
  }), L = pe ? bn(pe, R) : null, re = vm(T), de = Ni(re), Ee = Ni(re, [X]), _e = bn(j, de), Ue = Ke ? $h(Ke, j) : null, Mt = E && Ue ? f({
    active: E,
    collisionRect: Ue,
    droppableRects: $,
    droppableContainers: J,
    pointerCoordinates: L
  }) : null, jt = Dl(Mt, "id"), [ge, Ie] = ee(null), Re = ct ? j : bn(j, Ee), Xe = Bh(Re, (a = ge?.rect) != null ? a : null, X), Ot = W(null), si = P(
    (He, ut) => {
      let {
        sensor: dt,
        options: qt
  ...
  }, [E, ae, Mt, Ue, D, Ge, Ke, $, F, ge, T, _e]), im({
    ...be,
    delta: R,
    draggingRect: Ue,
    pointerCoordinates: L,
...
}), Om = /* @__PURE__ */ Tt(null), Ai = "button", Em = "Draggable";
function Im(e) {
  let {
    id: t,
    data: n,
  ...
  const a = lr(Em), {
    ...
    tabIndex: w = 0
  } = s ?? {}, g = l?.id === t, v = et(g ? os : Om), [p, b] = Fr(), [C, k] = Fr(), S = ym(i, t), _ = Xn(n);
  At(
    () => (f.set(t, {
      id: t,
      key: a,
...
const Vm = {
  position: "fixed",
  touchAction: "none"
}, $m = (e) => ss(e) ? "transform 250ms ease" : void 0, zm = /* @__PURE__ */ nt((e, t) => {
  let {
    as: n,
    activatorEvent: r,
    adjustScale: s,
  ...
  const f = s ? u : {
    ...
    transformOrigin: s && r ? Ih(r, o) : void 0,
...
const Gm = /* @__PURE__ */ K.memo((e) => {
  ...
  return K.createElement(Bm, null, K.createElement(Mm, {
    animation: F
  }, f && _ ? K.createElement(zm, {
    key: _,
    id: f.id,
    ref: I,
    as: o,
...
function Jm(e) {
  ...
  } = ql(), f = lr(Wl, n), m = o.rect !== null, h = V(() => r.map((S) => typeof S == "object" && "id" in S ? S.id : S), [r]), x = i != null, w = i ? h.indexOf(i.id) : -1, g = u ? h.indexOf(u.id) : -1, v = W(h), p = !Xm(h, v.current), b = g !== -1 && w === -1 || p, C = Ym(a);
  At(() => {
    p && x && d(h);
  }, [p, h, x, d]), ie(() => {
    v.current = h;
...
function ip(e) {
  ...
  const {
    ...
    useDragOverlay: v,
    strategy: p
  } = et(Ul), b = op(r, h), C = d.indexOf(i), k = V(() => ({
    sortable: {
      containerId: f,
      index: C,
      items: d
  ...
  }), J = vh(F, U), z = !!I, $ = z && !x && pr(m) && pr(g), fe = !v && G, Ce = fe && $ ? me : null, pe = $ ? Ce ?? (o ?? p)({
    rects: w,
    activeNodeRect: E,
    activeIndex: m,
    overIndex: g,
...
const lp = [ye.Down, ye.Right, ye.Up, ye.Left], cp = (e, t) => {
  ...
  if (lp.includes(e.code)) {
    ...
    if (d === i?.id && u.length > 1 && (d = u[1].id), d != null) {
      ...
      if (x && h && f && m) {
        const g = as(x).some((S, _) => o[_] !== S), v = Hl(f, m), p = up(f, m), b = g || !v ? {
          x: 0,
          y: 0
        } : {
...
const Ti = ({ id: e, children: t }) => {
  ...
  return /* @__PURE__ */ c("div", { className: Q("flex flex-wrap items-stretch gap-4", r && "flex-1"), children: /* @__PURE__ */ O(
    Tm,
    {
      ...
      onDragEnd: d,
      children: [
        /* @__PURE__ */ c(Jm, { items: s, children: s.map((f) => /* @__PURE__ */ c(Ti, { id: f.id, children: f.render }, f.id)) }),
        /* @__PURE__ */ c(Gm, { children: i ? /* @__PURE__ */ c(Ti, { id: i, children: s.find((f) => f.id === i)?.render }) : null })
      ]
    }
  ) });
};
  ...
  return Fp(t, e), Cp(t, [{
    ...
    value: function() {
      ...
      if (i === "joint")
        ...
        var m = uf(s), h = m.xmin, x = m.xmax, w = m.a, g = m.b, v = function(C) {
          return w * C + g;
        };
        d = [{
          x: h,
...
Kt(ur, "defaultProps", {
  ...
  shape: "circle",
  hide: !1,
  isAnimationActive: !mf.isSsr,
  animationBegin: 0,
  animationDuration: 400,
  animationEasing: "linear"
});
Kt(ur, "getComposedData", function(e) {
  var t = e.xAxis, n = e.yAxis, r = e.zAxis, s = e.item, a = e.displayedData, i = e.xAxisTicks, o = e.yAxisTicks, l = e.offset, u = s.props.tooltipType, d = ll(s.props.children, pf), f = pn(t.dataKey) ? s.props.dataKey : t.dataKey, m = pn(n.dataKey) ? s.props.dataKey : n.dataKey, h = r && r.dataKey, x = r ? r.range : ls.defaultProps.range, w = x && x[0], g = t.scale.bandwidth ? t.scale.bandwidth() : 0, v = n.scale.bandwidth ? n.scale.bandwidth() : 0, p = a.map(function(b, C) {
...
const Ip = (e) => {
  ...
  const w = xf(t), g = d?.categories ? Array.isArray(d.categories) ? d.categories : [d.categories] : [], v = f?.categories ? Array.isArray(f.categories) ? f.categories : [f.categories] : [], p = m?.categories ? Array.isArray(m.categories) ? m.categories : [m.categories] : [], b = [
    ...g,
    ...v,
    ...p
  ], C = Math.max(
...
}, Pp = hl(Rp), Lp = ({ value: e, max: t = 100, label: n, color: r }, s) => {
...
var Be = (e) => !Je(e) && !Array.isArray(e) && pc(e) && !ln(e), gc = (e) => Be(e) && e.target ? dr(e.target) ? e.target.checked : e.target.value : e, hg = (e) => e.substring(0, e.search(/\.\d+(\.|$)/)) || e, vc = (e, t) => e.has(hg(t)), mg = (e) => {
...
function Tg(e = {}) {
  ...
  const d = {
    ...
    (T.shouldDirty || T.shouldTouch) && S(y, j, T.shouldTouch, T.shouldDirty, !0), T.shouldValidate && me(y);
  }, le = (y, A, T) => {
    for (const Z in A) {
    ...
    if (j) {
      let de, Ee;
      const _e = L(), Ue = y.type === jr.BLUR || y.type === jr.FOCUS_OUT, Mt = !Ng(j._f) && !t.resolver && !H(n.errors, T) && !j._f.deps || Dg(Ue, H(n.touchedFields, T), n.isSubmitted, h, m), jt = Mi(T, o, Ue);
      ...
      Z && (j._f.deps && me(j._f.deps), _(T, Ee, de, ge));
    }
  }, te = (y, A) => {
  ...
  ({ className: e, children: t, fallback: n, ...r }, s) => {
    ...
    return l ? /* @__PURE__ */ O(
      "div",
      {
        ...
        ...r,
        children: [
          /* @__PURE__ */ c(ht, { icon: jo, color: "critical" }),
    ...
    Qs,
    {
      ...
      leftContent: r ? /* @__PURE__ */ O("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ O("div", { className: "flex items-center gap-0.5", children: [
          /* @__PURE__ */ c(ht, { icon: jo, size: "md", color: "critical" }),
    ...
    if (a.addIssue = a.addIssue.bind(a), s.type === "preprocess") {
      ...
      if (r.common.async)
        return Promise.resolve(i).then(async (o) => {
          ...
          return l.status === "aborted" ? he : l.status === "dirty" || n.value === "dirty" ? jn(l.value) : l;
        });
      {
        if (n.value === "aborted")
          return he;
        ...
        return o.status === "aborted" ? he : o.status === "dirty" || n.value === "dirty" ? jn(o.value) : o;
      }
    }
  ...
  _parse(t) {
    ...
    if (r.common.async)
      return (async () => {
        ...
        return a.status === "aborted" ? he : a.status === "dirty" ? (n.dirty(), jn(a.value)) : this._def.out._parseAsync({
          data: a.value,
          path: r.path,
          parent: r
        });
...
const fs = Xt.create, uv = _n.create, dv = ra.create, fv = tr.create, hv = sa.create, mv = aa.create;
tn.create;
...
const Ka = "gap-4", Qc = "mt-6", Hc = "max-w-[720px]", on = "md", ms = Tt(null);
function Xa() {
  const e = et(ms);
  if (!e)
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ O("div", { className: "flex min-w-0 flex-1 flex-col gap-0.5", children: [
          ...
          /* @__PURE__ */ c("span", { className: "text-sm text-f1-foreground-secondary", children: h || (p ? m === "processing" ? i.processing : `${i.uploading} ${b}%` : S != null ? Av(S) : null) })
        ] }),
        !a && /* @__PURE__ */ c(
          Ve,
          {
...
function Rv({
  ...
  }, []), G = d ? v.dropzoneActive : e.description ?? (m ? v.dropzoneMultiple : v.dropzone), ce = !!(n || w || r === "error"), te = ce || r === "warning" || r === "info", me = Ev({
    isDragOver: d,
...
function tu({
  ...
  const h = Fe(), x = Jc(n), w = i?.label ?? "Submit", g = i?.icon === null ? void 0 : i?.icon ?? qo, v = i?.showSubmitWhenDirty ?? !1, p = i?.hideSubmitButton ?? !1, b = V(() => eu(h), [h]), C = eb[o], k = V(
    () => Uc(n, { errorMap: b }),
    [n, b]
  ), S = Oc({
    resolver: k,
...
}, zb = (e, t, n) => (e.description && (n.description = e.description, t.markdownDescription && (n.markdownDescription = e.description)), n), mo = (e, t) => {
  const n = lb(t);
...
function Hb() {
  ...
  return /* @__PURE__ */ c("nav", { "aria-label": "Wizard steps", className: "flex flex-col gap-1.5 p-1", children: e.map((s, a) => {
    const i = a < t || s.isCompleted?.() === !0, o = Ub(a, t, i), l = e[t]?.hasErrors?.() === !0, u = a > t && e.slice(t, a).some((h) => h.hasErrors?.() === !0);
...
function mu(e) {
  ...
  } = e, u = typeof s == "function" && l ? s : void 0, d = !!l, { resolved: f, isLoading: m } = ry(
    s,
    d
  );
  return V(() => {
    const h = ny(n) ? "single" : "per-section";
    return {
      name: t,
      schema: n,
      sections: r,
...
function gu(e) {
  ...
  })), [r, x, h, w]), b = /* @__PURE__ */ c("div", { className: Q("flex w-full flex-col", Hc, o), children: x.map((C, k) => {
...
function vu(e) {
  const t = Fe(), { forms: n } = t, {
    ...
    label: a[ge]?.title ?? ge,
    onClick: () => ce(ge)
  })), [a, U, g, ce]), me = V(() => eu(t), [t]), J = yy[d], z = V(
    () => Uc(s, { errorMap: me }),
    [s, me]
  ), $ = Oc({
    resolver: z,
...
const $0 = xe(bu), Sy = ({
  ...
  const { status: t, icon: n = md, title: r, description: s, metadata: a } = e, i = a?.some(Boolean);
...
function Su({
  ...
  const [m, h] = ee(!1), x = W(!1), w = W(null), { deferClose: g } = Ry(w, () => h(!1)), v = (b) => {
  ...
  switch (e.type) {
    ...
    case "dropdown-single": {
      ...
      return bt(br(!!e.required, t), {
        ...o,
        fieldType: "custom",
        render: ({ value: f, onChange: m, onBlur: h, error: x }) => /* @__PURE__ */ c(Me, { ...l, children: /* @__PURE__ */ c("div", { className: "flex flex-col items-start px-0.5 [&>div]:w-full", children: /* @__PURE__ */ c(
          it,
          {
            field: d,
            value: f ?? "",
...
function qx(e, t, n, r, s, a, i = !1, o = i, l) {
  return V(() => {
    const u = {}, d = {}, f = {}, m = Eu(e), h = t === "stepped";
    for (const x of e)
      if (x.type === "section") {
            ...
            /* @__PURE__ */ O(
              "div",
              {
                ...
                children: [
                  ...
                  h ? n === "stepped" ? /* @__PURE__ */ c(Ex, {}) : /* @__PURE__ */ c(Ox, {}) : E ? null : /* @__PURE__ */ c(
                    sg,
                    {
                      display: "flex",
                      flexDirection: "column",
...
function Gx({
  ...
  return /* @__PURE__ */ c(mt, { children: u ? null : /* @__PURE__ */ O(Md, { style: { width: a }, className: "relative bg-f1-background p-1", children: [
...
export {
  b1 as AiChatTranslationsProvider,
  f0 as AreaChart,
  rw as Await,
  h0 as BarChart,
  m0 as CategoryBarChart,
  sw as ChatSpinner,
  y0 as ComboChart,
  o0 as Dashboard,
  ...
  x1 as F0AuraVoiceAnimation,
  fw as F0Avatar,
  hw as F0AvatarAlert,
  mw as F0AvatarCompany,
  f1 as F0AvatarDate,
  pw as F0AvatarEmoji,
  od as F0AvatarFile,
  gw as F0AvatarIcon,
  ...
  Bw as chipVariantValues,
  Vw as chipVariants,
  kx as computeSectionEndIds,
  $w as createAtlaskitDriver,
  zw as createDataSourceDefinition,
  th as createPageLayoutBlock,
  nh as createPageLayoutBlockGroup,
  ...
  qw as getAnimationVariants,
  Zw as getCanvasEntity,
  Ww as getDataSourcePaginationType,
  Uw as getEmojiLabel,
  an as getF0Config,
  ...
  Qw as isInfiniteScrollPagination,
  Hw as isPageBasedPagination,
  Oe as isZodType,
  A0 as linkVariants,
  Gw as modules,
  k1 as oneIconSizes,
  m1 as predefinedPresets,
  ...
  Xw as useData,
  Yw as useDataSource,
  Jw as useDefaultCopilotActions,
  e1 as useDndEvents,
  t1 as useDraggable,
  n1 as useDroppableList,
  r1 as useEmojiConfetti,
  dy as useF0AiFormRegistry,
  s1 as useF0Dialog,
  vs as useF0Form,
  mu as useF0FormDefinition,
  a1 as useGroups,
  i1 as useMessageSourcesAction,
  o1 as useOrchestratorThinkingAction,
  g1 as usePrivacyMode,
  l1 as useReducedMotion,

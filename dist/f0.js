...
import { L as ya, C as wc, i as ba, D as _c, S as rs, a as Cc, f as Zn, b as br, c as Ec, A as kc, d as Xr, e as xa, E as Sc, g as en, h as Dc, j as Nc, k as Rc, l as tr, m as wa, u as Ac, G as Tc, n as Oc, o as ns, p as Mc, q as _a, r as Lc, B as Ca, X as Ea, Y as oi, s as Ic, t as ka, v as Pc, w as zc, x as Fc, y as Bc, z as Hc, F as Vc, H as jc, I as $c, J as is, K as Wc, M as Er, N as qn, O as Gc, P as Uc, Q as Zc, R as qc, T as Kc, U as Yc, V as Xc, W as Jc, Z as Qc, _ as ed, $ as td, a0 as ss, a1 as rd, a2 as nd, a3 as as, a4 as Sa, a5 as id, a6 as sd, a7 as ad, a8 as od, a9 as Da, aa as Ei, ab as ld, ac as cd, ad as dd, ae as ud, af as hd, ag as Na, ah as Ra, ai as fd, aj as md, ak as pd, al as gd } from "./DataCollectionStorageProvider-DBnav5cC.js";
import { aB as ly, am as cy, an as dy, aq as uy, at as hy, au as fy, av as my, ax as py, ay as gy, az as vy, aw as yy, ao as by, ap as xy, aA as wy, ar as _y, as as Cy, aC as Ey, aD as ky, aE as Sy, aF as Dy } from "./DataCollectionStorageProvider-DBnav5cC.js";
import { A as Ry, F as Ay, c as Ty, b as Oy, a as My, o as Ly, u as Iy } from "./F0HILActionConfirmation-DRfQGPsn.js";
...
import './f0.css';const vd = {
  ...
  const i = K(null);
  mc(n, () => i.current);
  const s = sn.toArray(e).filter((a) => !!a).map((a, o) => /* @__PURE__ */ f("div", { className: "h-full @5xl:h-auto [&>div]:h-full", children: a }, o));
  return /* @__PURE__ */ f(ya, { layout: "home", children: /* @__PURE__ */ j("div", { ref: i, className: "@container", children: [
    /* @__PURE__ */ j("div", { className: "flex flex-col gap-6 px-5 pt-4 @md:pt-2 @5xl:hidden", children: [
      /* @__PURE__ */ f(wc, { columns: vd, showArrows: !1, children: s }),
...
}), Aa = B.forwardRef(({ children: r, variant: e, className: t, ...n }, i) => /* @__PURE__ */ f(ya, { layout: "standard", children: /* @__PURE__ */ f(
  "section",
  {
    ref: i,
    className: re("relative flex-1 overflow-auto", t),
    ...n,
    children: /* @__PURE__ */ f("div", { className: re(bd({ variant: e })), children: r })
  }
) }));
Aa.displayName = "StandardLayout";
const xd = he(
  lt(
    {
      name: "StandardLayout",
...
function Dd({
  ...
  ra(() => {
    ...
    if (!Array.isArray(D))
      return;
    const O = D.map((z) => z.id), b = i || [], k = b.map((z) => z.id), E = b.filter(
      (z) => !O.includes(z.id)
    );
    ...
    if ($.length > 0) {
      ...
      $.forEach((N) => {
        ...
        if (A.length > 0) {
          const V = {}, ie = ["w", "h", "x", "y"], de = ["noMove", "noResize", "locked"], se = A.filter(
            (X) => ie.includes(X)
          ), ye = A.filter(
            (X) => de.includes(X)
          );
          if (se.length > 0 && ye.length > 0 && se.length + ye.length === A.length ? ye.forEach((X) => {
            const we = N[X];
            we !== void 0 && (V[X] = we);
          }) : A.forEach((X) => {
            const we = N[X];
...
const Rd = Et(null);
function Ad() {
  const { _reactContentMap: r } = Oa(), { getWidgetContainer: e } = Nd();
  return /* @__PURE__ */ f(Hr, { children: Array.from(r.value.entries()).map(([t, n]) => {
    const i = e(t);
    return i ? /* @__PURE__ */ f(Rd.Provider, { value: { widget: { id: t } }, children: n && va(n, i) }, t) : (console.error(`Widget container not found for widget ${t}`), null);
  }) });
}
...
function os(r) {
  Y.dragElement && r.pointerType !== "mouse" && La(r, "mouseenter");
}
function ls(r) {
  Y.dragElement && r.pointerType !== "mouse" && (xt.pointerLeaveTimeout = window.setTimeout(() => {
    delete xt.pointerLeaveTimeout, La(r, "mouseleave");
  }, 10));
}
class Tn {
  constructor(e, t, n) {
  ...
  _init() {
    ...
    return e.classList.add("ui-resizable-handle"), e.classList.add(`${Tn.prefix}${this.dir}`), e.style.zIndex = "100", e.style.userSelect = "none", this.host.appendChild(this.el), this.el.addEventListener("mousedown", this._mouseDown), ht && (this.el.addEventListener("touchstart", on), this.el.addEventListener("pointerdown", dn)), this;
  }
  /** call this when resize handle needs to be removed and cleaned up */
  destroy() {
    return this.moving && this._mouseUp(this.mouseDownEvent), this.el.removeEventListener("mousedown", this._mouseDown), ht && (this.el.removeEventListener("touchstart", on), this.el.removeEventListener("pointerdown", dn)), this.host.removeChild(this.el), delete this.el, delete this.host, this;
  }
  /** @internal called on mouse down on us: capture move on the entire document (mouse might not stay on us) until we release the mouse */
  _mouseDown(e) {
    this.mouseDownEvent = e, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), ht && (this.el.addEventListener("touchmove", ln), this.el.addEventListener("touchend", cn)), e.stopPropagation(), e.preventDefault();
  }
  /** @internal */
  _mouseMove(e) {
...
const Od = 'input,textarea,button,select,option,[contenteditable="true"],.ui-resizable-handle';
class Mr extends ki {
  constructor(e, t = {}) {
  ...
  enable() {
    this.disabled !== !1 && (super.enable(), this.dragEls.forEach((e) => {
      e.addEventListener("mousedown", this._mouseDown), ht && (e.addEventListener("touchstart", on), e.addEventListener("pointerdown", dn));
    }), this.el.classList.remove("ui-draggable-disabled"));
  }
  disable(e = !1) {
    this.disabled !== !0 && (super.disable(), this.dragEls.forEach((t) => {
      t.removeEventListener("mousedown", this._mouseDown), ht && (t.removeEventListener("touchstart", on), t.removeEventListener("pointerdown", dn));
  ...
  _mouseDown(e) {
    if (!Y.mouseHandled)
      return e.button !== 0 || !this.dragEls.find((t) => t === e.target) && e.target.closest(Od) || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e, delete this.dragging, delete Y.dragElement, delete Y.dropElement, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), ht && (e.currentTarget.addEventListener("touchmove", ln), e.currentTarget.addEventListener("touchend", cn)), e.preventDefault(), document.activeElement && document.activeElement.blur(), Y.mouseHandled = !0), !0;
  }
  ...
  _mouseUp(e) {
    if (document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), ht && e.currentTarget && (e.currentTarget.removeEventListener("touchmove", ln, !0), e.currentTarget.removeEventListener("touchend", cn, !0)), this.dragging) {
...
class Si {
  static init(e) {
    return e.ddElement || (e.ddElement = new Si(e)), e.ddElement;
  }
  constructor(e) {
    this.el = e;
  }
  ...
  setupDroppable(e) {
    return this.ddDroppable ? this.ddDroppable.updateOption(e) : this.ddDroppable = new Md(this.el, e), this;
  }
  cleanDroppable() {
...
class Ld {
  ...
  _getDDElements(e, t) {
    ...
    return i.length ? i.map((a) => a.ddElement || (n ? Si.init(a) : null)).filter((a) => a) : [];
  }
}
const Be = new Ld();
class q {
...
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.`)), n;
  ...
  _setupAcceptWidget() {
    ...
    return Be.droppable(this.el, {
      ...
      o._temporaryRemoved = !0) : (o.w = l, o.h = c, o._temporaryRemoved = !0), q._itemRemoving(o.el, !1), Be.on(s, "drag", n), n(i, s, a), !1;
  ...
  commit() {
    return Td(this, this.batchUpdate(!1), "commit", "batchUpdate", "5.2"), this;
  }
}
q.renderCB = (r, e) => {
...
function Id({ children: r }) {
  const {
    _gridStack: { value: e, set: t },
    options: n
  } = Oa(), i = K(/* @__PURE__ */ new Map()), s = K(null), a = K(n), o = le(
    (d, u) => {
      if (u.id && u.grid) {
        let h = Jr.get(u.grid);
        h || (h = /* @__PURE__ */ new Map(), Jr.set(u.grid, h)), h.set(u.id, d), i.current.set(u.id, d);
      }
    },
    []
  ), l = le(() => {
...
const Di = ({
  ...
  return /* @__PURE__ */ f(
    Dd,
    {
      ...
      onChange: t,
      children: /* @__PURE__ */ f(Id, { children: /* @__PURE__ */ f(Ad, {}) })
    }
  );
};
Di.displayName = "F0GridStack";
const Pd = (r, e, t) => /* @__PURE__ */ f("div", { children: r }), On = ({
  widgets: r = [],
  editMode: e = !1,
  onChange: t = () => {
  },
  ...
  const a = le(
    ...
    c(r, e)
  ), h = K(e), m = K(r), g = K(!1), y = K(/* @__PURE__ */ new Map()), S = K(r);
  S.current = r;
  const _ = K(s), R = U(() => {
    ...
    [t]
  ), O = (b, k) => !b && !k ? !1 : !b || !k || b.length !== k.length ? !0 : b.some((E, T) => E !== k[T]);
  return J(() => {
    const b = h.current !== e, k = m.current !== r, E = _.current !== s && (_.current === void 0 || s === void 0 || Object.keys(_.current).length !== Object.keys(s).length || Object.keys(s).some(
      (N) => _.current?.[N] !== s[N]
    )), T = /* @__PURE__ */ new Map();
    r.forEach((N) => {
      if (N.deps && N.deps.length > 0) {
        ...
        T.set(
          N.id,
          O(C, A)
        ), A ? y.current.set(N.id, A) : y.current.delete(N.id);
      }
    });
    ...
    b && !k && !z ? (g.current = !0, u(
      ...
      return r.map((A) => {
        ...
        }, ye = V?.x ?? A.x, X = V?.y ?? A.y;
        return ye !== void 0 && (se.x = ye), X !== void 0 && (se.y = X), se;
      });
...
const zd = (r, e) => {
  ...
  return /* @__PURE__ */ f(
    Ci,
    {
      ...
      variant: "ai",
      ref: e,
      iconRotate: r.icon == Ia
    }
  );
});
Pa.displayName = "AIButton";
const xr = jt({
  ...
  ({
    ...
    const u = i ?? Vd[e ?? "body"], h = l ? /* @__PURE__ */ f("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (s !== void 0) {
      ...
      return h ? Kr(
        ...
        es,
        {
          ...
          noTooltip: a,
          tag: u,
          className: re(xr({ variant: e, align: t }), n),
          markdown: o,
          ...c,
          children: r
        }
...
Ni.displayName = "Text";
const za = Ge((r, e) => /* @__PURE__ */ f(Ni, { ref: e, markdown: r.markdown ?? !0, ...r }));
...
const jd = he(za), ng = [
  ...
  const [c, d] = Q(!1), [u, h] = Q(!1), m = hr(), g = (S) => {
    d(S);
  }, y = u || c;
  return J(() => {
    if (!i || !n) return;
              ...
              children: [
                e && /* @__PURE__ */ f(
                  "div",
                  {
                    ...
                    onMouseDown: t,
                    "data-gs-handle": "true",
                    children: /* @__PURE__ */ f(An, { icon: Rl, size: "xs" })
                  }
                ),
                /* @__PURE__ */ f(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ f(jd, { variant: "label", content: r, ellipsis: !0 })
                  }
                )
              ]
            }
          ),
          /* @__PURE__ */ f(Al, { children: (s || a) && y && /* @__PURE__ */ j(
            _i.div,
            {
              className: re(
...
}, $d = () => /* @__PURE__ */ j("div", { className: "relative flex h-full w-full cursor-progress flex-col rounded-xl border border-solid border-f1-border-secondary bg-f1-background", children: [
...
Ba.displayName = "Dashboard";
const Ud = Fd("Dashboard", Ba), ig = he(
  at("Dashboard", Ud)
), Zd = jt({
...
}), qd = (r) => (r || []).map((e) => e.items).reduce((e, t) => (e.length > 0 && e.push({ type: "separator" }), e.push(...t), e), []), Kd = (r) => {
  ...
  ({
    ...
    return /* @__PURE__ */ j(
      ...
      {
        ref: d,
        className: re(Zd({ variant: e }), "relative", t),
        draggable: n,
        onDragStart: i,
        onDragEnd: s,
        onDrop: a,
...
const Yd = ({
  ...
  if (!r) return null;
  const a = t;
  return /* @__PURE__ */ j(Mn, { ...s, className: re("space-y-4", i), children: [
  ...
  "BlockContent",
  Yd
), Jd = (r) => !ga(r) || !r.type || typeof r.type == "string" || typeof r.type == "symbol" ? !1 : "__isPageLayoutBlock" in r.type, Qd = (r) => !ga(r) || !r.type || typeof r.type == "string" || typeof r.type == "symbol" ? !1 : "__isPageLayoutGroup" in r.type, Ha = (r, e, t) => {
  const n = sn.toArray(e);
  for (const i of n)
    t.includes("block") && Jd(i) || t.includes("group") && Qd(i) || console.warn(
      `${r}: Children components must inherit from PageLayoutBlock or PageLayoutGroup. Found:`,
      i
    );
}, Ri = Ge(
  ({ children: r, onSort: e, ...t }, n) => {
    Ha("GroupLinear", r, ["block"]);
    const [i, s] = Q(sn.toArray(r));
    return J(() => {
      s(sn.toArray(r));
    }, [r]), J(() => {
      e?.(i);
    }, [i, e]), /* @__PURE__ */ f("div", { ref: n, ...t, children: i.map((a, o) => /* @__PURE__ */ f(pc, { children: a }, o)) });
  }
);
Ri.displayName = "GroupLinear";
...
function Ve(r) {
  var e, t;
  return r ? fr(r) ? r : Ai(r) && (e = (t = r.ownerDocument) == null ? void 0 : t.defaultView) != null ? e : window : window;
}
function Ti(r) {
  const {
    Document: e
...
function Vr(r) {
  return fr(r) ? !1 : r instanceof Ve(r).HTMLElement;
}
function Va(r) {
  return r instanceof Ve(r).SVGElement;
}
function mr(r) {
  return r ? fr(r) ? r.document : Ai(r) ? Ti(r) ? r : Vr(r) || Va(r) ? r.ownerDocument : document : document : document;
}
const mt = Ln ? ai : J;
function In(r) {
  const e = K(r);
...
const sr = /* @__PURE__ */ ja(1), Ir = /* @__PURE__ */ ja(-1);
function ru(r) {
...
function fu(r) {
  let {
    ...
    screenReaderInstructions: i = uu
  } = r;
  const {
    announce: s,
    announcement: a
  } = lu(), o = $r("DndLiveRegion"), [l, c] = Q(!1);
  if (J(() => {
    c(!0);
  }, []), cu(U(() => ({
    onDragStart(u) {
    ...
    return null;
  const d = B.createElement(B.Fragment, null, B.createElement(au, {
    id: n,
    value: i.draggable
  }), B.createElement(ou, {
    id: o,
...
const bu = (r) => {
  ...
  for (const a of n) {
    ...
    if (l) {
      const c = us(l), d = i.reduce((h, m, g) => h + pu(c[g], m), 0), u = Number((d / 4).toFixed(4));
      s.push({
        id: o,
        data: {
...
function zn(r, e) {
  ...
  function n(i) {
    if (e != null && t.length >= e || !i)
      return t;
    if (Ti(i) && i.scrollingElement != null && !t.includes(i.scrollingElement))
      return t.push(i.scrollingElement), t;
    if (!Vr(i) || Va(i) || t.includes(i))
      return t;
    const s = Ve(r).getComputedStyle(i);
    return i !== r && Ru(i, s) && t.push(i), Nu(i, s) ? t : n(i.parentNode);
  }
  return r ? n(r) : t;
}
function Za(r) {
...
function Yn(r) {
  return !Ln || !r ? null : fr(r) ? r : Ai(r) ? Ti(r) || r === mr(r).scrollingElement ? window : Vr(r) ? r : null : null;
}
function qa(r) {
  return fr(r) ? r.scrollX : r.scrollLeft;
}
function Ka(r) {
  return fr(r) ? r.scrollY : r.scrollTop;
}
function li(r) {
  return {
    x: qa(r),
...
function Tu(r, e, t, n, i) {
  ...
  return !c && s <= e.top + y.height ? (m.y = Ae.Backward, g.y = n * Math.abs((e.top + y.height - s) / y.height)) : !d && l >= e.bottom - y.height && (m.y = Ae.Forward, g.y = n * Math.abs((e.bottom - y.height - l) / y.height)), !h && o >= e.right - y.width ? (m.x = Ae.Forward, g.x = n * Math.abs((e.right - y.width - o) / y.width)) : !u && a <= e.left + y.width && (m.x = Ae.Backward, g.x = n * Math.abs((e.left + y.width - a) / y.width)), {
    direction: m,
    speed: g
  };
}
...
function Ja(r) {
  return r.reduce((e, t) => sr(e, li(t)), pt);
}
function Mu(r) {
  return r.reduce((e, t) => e + qa(t), 0);
}
function Lu(r) {
  return r.reduce((e, t) => e + Ka(t), 0);
}
function Qa(r, e) {
  if (e === void 0 && (e = pr), !r)
    return;
  ...
  Za(r) && (i <= 0 || s <= 0 || t >= window.innerHeight || n >= window.innerWidth) && r.scrollIntoView({
    block: "center",
    inline: "center"
  });
}
const Iu = [["x", ["left", "right"], Mu], ["y", ["top", "bottom"], Lu]];
class Oi {
  constructor(e, t) {
...
class Mi {
  constructor(e) {
    ...
    this.props = e, this.listeners = new kr(mr(t)), this.windowListeners = new kr(Ve(t)), this.handleKeyDown = this.handleKeyDown.bind(this), this.handleCancel = this.handleCancel.bind(this), this.attach();
  }
  attach() {
  ...
  handleKeyDown(e) {
    if (Pn(e)) {
      ...
      if (u) {
        ...
        this.handleMove(e, sr(Ir(u, this.referenceCoordinates), m));
      }
    }
  }
  handleMove(e, t) {
...
class Li {
  constructor(e, t, n) {
    var i;
    n === void 0 && (n = Pu(e.event.target)), this.props = void 0, this.events = void 0, this.autoScrollEnabled = !0, this.document = void 0, this.activated = !1, this.initialCoordinates = void 0, this.timeoutId = null, this.listeners = void 0, this.documentListeners = void 0, this.windowListeners = void 0, this.props = e, this.events = t;
    const {
      event: s
    } = e, {
      target: a
    } = s;
    this.props = e, this.events = t, this.document = mr(a), this.documentListeners = new kr(this.document), this.listeners = new kr(n), this.windowListeners = new kr(Ve(a)), this.initialCoordinates = (i = fn(s)) != null ? i : pt, this.handleStart = this.handleStart.bind(this), this.handleMove = this.handleMove.bind(this), this.handleEnd = this.handleEnd.bind(this), this.handleCancel = this.handleCancel.bind(this), this.handleKeydown = this.handleKeydown.bind(this), this.removeTextSelection = this.removeTextSelection.bind(this), this.attach();
  }
  attach() {
    const {
      events: e,
    ...
    if (this.listeners.add(e.move.name, this.handleMove, {
      passive: !1
    }), this.listeners.add(e.end.name, this.handleEnd), e.cancel && this.listeners.add(e.cancel.name, this.handleCancel), this.windowListeners.add(it.Resize, this.handleCancel), this.windowListeners.add(it.DragStart, fs), this.windowListeners.add(it.VisibilityChange, this.handleCancel), this.windowListeners.add(it.ContextMenu, fs), this.documentListeners.add(it.Keydown, this.handleKeydown), t) {
      if (n != null && n({
  ...
  handleStart() {
    ...
    e && (this.activated = !0, this.documentListeners.add(it.Click, zu, {
      capture: !0
  ...
  handleMove(e) {
    ...
    if (!i)
      return;
    const l = (t = fn(e)) != null ? t : pt, c = Ir(i, l);
    if (!n && o) {
      if (ms(o)) {
        if (o.tolerance != null && Xn(c, o.tolerance))
          return this.handleCancel();
        if (Xn(c, o.distance))
          return this.handleStart();
      }
      if (ps(o) && Xn(c, o.tolerance))
        return this.handleCancel();
...
function $u(r) {
  ...
  const m = Gu({
    ...
    k.scrollBy(E, T);
  }, []), b = U(() => o === pn.TreeOrder ? [...c].reverse() : c, [o, c]);
  J(
    () => {
      if (!s || !c.length || !R) {
        y();
  ...
  const [s, a] = Q(null), {
    ...
    if (!_ || _ === gs || d.current !== r || s != null) {
      ...
      for (let D of r) {
        ...
        const O = D.node.current, b = O ? new Oi(l(O), O) : null;
...
const ys = [];
function Qu(r) {
  const e = K(r), t = jr((n) => r ? n && n !== ys && r && e.current && r.parentNode === e.current.parentNode ? n : zn(r) : ys, [r]);
  return J(() => {
    e.current = r;
  }, [r]), t;
}
function eh(r) {
  ...
  }, [i, r]), U(() => r.length ? e ? Array.from(e.values()).reduce((s, a) => sr(s, a), pt) : Ja(r) : pt, [r, e]);
}
function bs(r, e) {
  e === void 0 && (e = []);
  const t = K(null);
...
function to(r) {
  return U(() => r ? Du(r) : null, [r]);
}
const xs = [];
function nh(r, e) {
  e === void 0 && (e = pr);
  const [t] = r, n = to(t ? Ve(t) : null), [i, s] = Q(xs);
  function a() {
    s(() => r.length ? r.map((l) => Ya(l) ? n : new Oi(e(l), l)) : xs);
  }
  const o = Fn({
    callback: a
  });
...
const oh = {
  ...
  over: null,
  measureDroppableContainers: mn
}, Wr = /* @__PURE__ */ Et(no), io = /* @__PURE__ */ Et(oh);
function lh() {
  return {
    draggable: {
      active: null,
...
const fh = /* @__PURE__ */ gc(function(e) {
  var t, n, i, s;
  let {
    id: a,
    accessibility: o,
  ...
  const y = vc(ch, void 0, lh), [S, _] = y, [R, D] = du(), [O, b] = Q(Lt.Uninitialized), k = O === Lt.Initialized, {
    draggable: {
      active: E,
      nodes: T,
      translate: $
    ...
    return E != null ? {
      ...
      data: (Pe = N?.data) != null ? Pe : ah,
      rect: C
    } : null;
  }, [E, N]), V = K(null), [ie, de] = Q(null), [se, ye] = Q(null), X = Lr(g, Object.values(g)), we = $r("DndDescribedBy", a), Ue = U(() => z.getEnabled(), [z]), be = uh(h), {
    droppableRects: ze,
    ...
    dependencies: [$.x, $.y],
    config: be.droppable
  }), ke = Uu(T, E), je = U(() => se ? fn(se) : null, [se]), pe = Dl(), _e = Ku(ke, be.draggable.measure);
  hh({
  ...
  const ce = vs(ke, be.draggable.measure, _e), et = vs(ke ? ke.parentElement : null), Me = K({
    activatorEvent: null,
    active: null,
    activeNode: ke,
    collisionRect: null,
  ...
  }), Le = z.getNodeFor((t = Me.current.over) == null ? void 0 : t.id), Ie = ih({
    measure: be.dragOverlay.measure
  }), Ze = (n = Ie.nodeRef.current) != null ? n : ke, dt = k ? (i = Ie.rect) != null ? i : ce : null, kt = !!(Ie.nodeRef.current && Ie.rect), p = Ju(kt ? null : ce), v = to(Ze ? Ve(Ze) : null), w = Qu(k ? Le ?? ke : null), L = nh(w), I = so(m, {
    transform: {
      x: $.x - p.x,
      y: $.y - p.y,
      scaleX: 1,
    ...
    windowRect: v
  }), M = je ? sr(je, $) : null, W = eh(w), ee = bs(W), xe = bs(W, [ce]), ge = sr(I, ee), Fe = dt ? Eu(dt, I) : null, Gt = A && Fe ? u({
    active: A,
    collisionRect: Fe,
    droppableRects: ze,
    droppableContainers: Ue,
    pointerCoordinates: M
  }) : null, Yt = Wa(Gt, "id"), [tt, Zr] = Q(null), qr = kt ? I : sr(I, xe), Gn = _u(qr, (s = tt?.rect) != null ? s : null, ce), Xt = K(null), Ji = le(
    (Pe, qe) => {
      let {
        sensor: Ke,
        options: At
      ...
      if (V.current == null)
        return;
      const rt = T.get(V.current);
      if (!rt)
        return;
      const Ye = Pe.nativeEvent, vt = new Ke({
        active: V.current,
        activeNode: rt,
        event: Ye,
        options: At,
        ...
        return async function() {
          ...
          if (yt && vr) {
            ...
            Ot = {
              ...
              delta: vr,
              over: gr
            }, Te === Ne.DragEnd && typeof yr == "function" && await Promise.resolve(yr(Ot)) && (Te = Ne.DragCancel);
          }
          V.current = null, Yr(() => {
            _({
              type: Te
            }), b(Lt.Uninitialized), Zr(null), de(null), ye(null), Xt.current = null;
            const yr = Te === Ne.DragEnd ? "onDragEnd" : "onDragCancel";
            if (Ot) {
              const Un = X.current[yr];
              Un?.(Ot), R({
                type: yr,
                event: Ot
              });
    ...
    const rt = Ke.nativeEvent, Ye = T.get(At);
    if (
  ...
  th(d), mt(() => {
    ...
    () => {
      ...
      if (!Pe || V.current == null || !qe || !rt)
        return;
      const {
        onDragOver: Ye
      } = X.current, vt = At.get(Yt), Jt = vt && vt.rect.current ? {
        id: vt.id,
  ...
  }, [A, ke, Gt, Fe, T, Ze, dt, ze, z, tt, w, ge]), $u({
    ...pe,
    delta: $,
    draggingRect: Fe,
    pointerCoordinates: M,
  ...
  const kl = U(() => ({
    ...
    measuringScheduled: Oe,
    windowRect: v
  }), [A, ke, ce, se, Gt, et, Ie, T, z, ze, tt, Re, w, L, be, Oe, v]), Sl = U(() => ({
    activatorEvent: se,
    activators: Qi,
    active: A,
    activeNodeRect: ce,
    ...
    over: tt,
    measureDroppableContainers: Re
  }), [se, Qi, A, ce, _, we, T, tt, Re]);
  return B.createElement($a.Provider, {
    value: D
  }, B.createElement(Wr.Provider, {
    value: Sl
  }, B.createElement(io.Provider, {
    value: kl
  }, B.createElement(Bn.Provider, {
    value: Gn
  }, c)), B.createElement(dh, {
  ...
  function Dl() {
    const Pe = ie?.autoScrollEnabled === !1, qe = typeof l == "object" ? l.enabled === !1 : l === !1, Ke = k && !Pe && !qe;
...
}), mh = /* @__PURE__ */ Et(null), ws = "button", ph = "Draggable";
function gh(r) {
  let {
    id: e,
    data: t,
  ...
  const s = $r(ph), {
    ...
    tabIndex: y = 0
  } = i ?? {}, S = l?.id === e, _ = ft(S ? Bn : mh), [R, D] = un(), [O, b] = un(), k = rh(a, e), E = Lr(t);
  mt(
    () => (u.set(e, {
      id: e,
      key: s,
...
function xh(r) {
  ...
  const [n, i] = Q(null), [s, a] = Q(null), o = hn(t);
  return !t && !n && o && i(o), mt(() => {
    if (!s)
      return;
  ...
  }, [e, n, s]), B.createElement(B.Fragment, null, t, n ? yc(n, {
    ref: a
  }) : null);
}
const wh = {
...
const Ch = {
  position: "fixed",
  touchAction: "none"
}, Eh = (r) => Pn(r) ? "transform 250ms ease" : void 0, kh = /* @__PURE__ */ Ge((r, e) => {
  let {
    as: t,
    activatorEvent: n,
    adjustScale: i,
  ...
  const u = i ? c : {
    ...
    transformOrigin: i && n ? gu(n, o) : void 0,
...
function Rh(r) {
  ...
  return In((s, a) => {
    ...
    const {
      transform: d
    } = Ve(a).getComputedStyle(a), u = Ua(d);
    if (!u)
      return;
    const h = typeof e == "function" ? e : Ah(e);
    return Qa(l, i.draggable.measure), h({
      active: {
        id: s,
        data: o.data,
        node: l,
...
const Oh = /* @__PURE__ */ B.memo((r) => {
  ...
  return B.createElement(_h, null, B.createElement(xh, {
    animation: z
  }, u && E ? B.createElement(kh, {
    key: E,
    id: u.id,
    ref: N,
    as: o,
...
}, lo = "Sortable", co = /* @__PURE__ */ B.createContext({
  activeIndex: -1,
  containerId: lo,
  disableTransforms: !1,
  items: [],
...
function Ph(r) {
  ...
  } = ao(), u = $r(lo, t), h = o.rect !== null, m = U(() => n.map((k) => typeof k == "object" && "id" in k ? k.id : k), [n]), g = a != null, y = a ? m.indexOf(a.id) : -1, S = c ? m.indexOf(c.id) : -1, _ = K(m), R = !Lh(m, _.current), D = S !== -1 && y === -1 || R, O = Ih(s);
  mt(() => {
    R && g && d(m);
  }, [R, m, g, d]), J(() => {
    _.current = m;
  ...
  return B.createElement(co.Provider, {
    value: b
  }, e);
}
const zh = (r) => {
  ...
  duration: 200,
  easing: "ease"
}, uo = "transform", Hh = /* @__PURE__ */ Bt.Transition.toString({
  property: uo,
  duration: 0,
  easing: "linear"
}), Vh = {
...
function $h(r) {
  ...
  const {
    ...
    useDragOverlay: _,
    strategy: R
  } = ft(co), D = Wh(n, m), O = d.indexOf(a), b = U(() => ({
    sortable: {
      containerId: u,
      index: O,
      items: d
  ...
  }), Ue = eu(z, ie), be = !!N, ze = be && !g && Qr(h) && Qr(S), Re = !_ && se, Oe = Re && ze ? we : null, je = ze ? Oe ?? (o ?? R)({
    rects: y,
    activeNodeRect: A,
    activeIndex: h,
    overIndex: S,
  ...
  return J(() => {
    be && ce.current.newIndex !== pe && (ce.current.newIndex = pe), u !== ce.current.containerId && (ce.current.containerId = u), d !== ce.current.items && (ce.current.items = d);
  }, [be, pe, u, d]), J(() => {
...
const Gh = [oe.Down, oe.Right, oe.Up, oe.Left], Uh = (r, e) => {
  let {
    context: {
      active: t,
      collisionRect: n,
  ...
  if (Gh.includes(r.code)) {
    ...
    if (d === a?.id && c.length > 1 && (d = c[1].id), d != null) {
      ...
      if (g && m && u && h) {
        const S = zn(g).some((k, E) => o[E] !== k), _ = ho(u, h), R = Zh(u, h), D = S || !_ ? {
          x: 0,
          y: 0
        } : {
...
function Zh(r, e) {
  return !gn(r) || !gn(e) || !ho(r, e) ? !1 : r.data.current.sortable.index < e.data.current.sortable.index;
}
const Cs = ({ id: r, children: e }) => {
  const { attributes: t, listeners: n, setNodeRef: i, transform: s, transition: a } = $h({ id: r }), o = {
  ...
  return /* @__PURE__ */ f("div", { className: re("flex flex-wrap items-stretch gap-4", n && "flex-1"), children: /* @__PURE__ */ j(
    fh,
    {
      sensors: l,
      onDragStart: c,
      onDragEnd: d,
      children: [
        /* @__PURE__ */ f(Ph, { items: i, children: i.map((u) => /* @__PURE__ */ f(Cs, { id: u.id, children: u.render }, u.id)) }),
        /* @__PURE__ */ f(Oh, { children: a ? /* @__PURE__ */ f(Cs, { id: a, children: i.find((u) => u.id === a)?.render }) : null })
      ]
    }
  ) });
};
Fi.displayName = "GroupMasonry";
Fi.__isPageLayoutGroup = !0;
const qh = Ge(function({ children: e, aside: t, header: n, variant: i = "main-aside" }, s) {
  return process.env.NODE_ENV === "development" && Ha("Page", e, ["block", "group"]), /* @__PURE__ */ f("div", { ref: s, className: "h-full", children: /* @__PURE__ */ j(
    "div",
    {
      className: re(
        "flex h-full max-w-full overflow-auto text-f1-foreground md:flex-row",
  ...
  Page: he(at("Page", qh)),
  Block: he(at("Block", Mn)),
  BlockContent: he(
    at("BlockContent", Xd)
  ),
  Group: he(at("Group", Ri)),
  GroupGrid: he(
    at("GroupGrid", On)
  ),
  GroupMasonry: he(
...
function Yh(r, e) {
  for (var t = 0; t < e.length; t++) {
    var n = e[t];
    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(r, po(n.key), n);
  }
}
function Xh(r, e, t) {
  return e && Yh(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function Jh(r, e, t) {
  return e = vn(e), Qh(r, fo() ? Reflect.construct(e, t || [], vn(r).constructor) : e.apply(r, t));
}
function Qh(r, e) {
...
function mo(r, e, t) {
  return e = po(e), e in r ? Object.defineProperty(r, e, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : r[e] = t, r;
}
function po(r) {
  var e = rf(r, "string");
...
var Hn = /* @__PURE__ */ (function(r) {
  function e() {
    return Kh(this, e), Jh(this, e, arguments);
  }
  return tf(e, r), Xh(e, [{
    key: "render",
    value: function() {
...
function of(r) {
  var e = r.option, t = r.isActive, n = sf(r, nf);
  return typeof e == "string" ? /* @__PURE__ */ B.createElement(rs, Nr({
    option: /* @__PURE__ */ B.createElement(Cc, Nr({
      type: e
    }, n)),
    isActive: t,
    shapeType: "symbols"
  }, n)) : /* @__PURE__ */ B.createElement(rs, Nr({
    option: e,
    isActive: t,
    shapeType: "symbols"
  }, n));
...
function nt(r) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? Es(Object(t), !0).forEach(function(n) {
      zt(r, n, t[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(r, Object.getOwnPropertyDescriptors(t)) : Es(Object(t)).forEach(function(n) {
...
function ks(r, e) {
  for (var t = 0; t < e.length; t++) {
    var n = e[t];
    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(r, vo(n.key), n);
  }
}
function cf(r, e, t) {
  return e && ks(r.prototype, e), t && ks(r, t), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
function df(r, e, t) {
  return e = yn(e), uf(r, go() ? Reflect.construct(e, t || [], yn(r).constructor) : e.apply(r, t));
}
function uf(r, e) {
...
var Gr = /* @__PURE__ */ (function(r) {
  function e() {
    ...
    for (var n = arguments.length, i = new Array(n), s = 0; s < n; s++)
      i[s] = arguments[s];
    return t = df(this, e, [].concat(i)), zt(t, "state", {
  ...
  return ff(e, r), cf(e, [{
    ...
    value: function(n) {
      ...
      return n.map(function(d, u) {
        ...
        return /* @__PURE__ */ B.createElement(br, Rr({
          ...
          role: "img"
        }), /* @__PURE__ */ B.createElement(of, Rr({
          option: m,
          isActive: h,
          key: "symbol-".concat(u)
        }, g)));
    ...
    value: function() {
      ...
      return /* @__PURE__ */ B.createElement(kc, {
        begin: o,
        duration: l,
        isActive: a,
        easing: c,
        ...
        var m = h.t, g = s.map(function(y, S) {
          var _ = u && u[S];
          if (_) {
            var R = Xr(_.cx, y.cx), D = Xr(_.cy, y.cy), O = Xr(_.size, y.size);
            return nt(nt({}, y), {}, {
              cx: R(m),
              cy: D(m),
              size: O(m)
    ...
    value: function() {
      ...
      return s && i && i.length && (!a || !ba(a, i)) ? this.renderSymbolsWithAnimation() : this.renderSymbolsStatically(i);
    }
  }, {
    key: "renderErrorBar",
    value: function() {
      ...
      if (n && !this.state.isAnimationFinished)
        return null;
      var i = this.props, s = i.points, a = i.xAxis, o = i.yAxis, l = i.children, c = xa(l, Sc);
    ...
    value: function() {
      ...
      if (a === "joint")
        ...
        var h = Dc(i), m = h.xmin, g = h.xmax, y = h.a, S = h.b, _ = function(O) {
          return y * O + S;
        };
        d = [{
          x: m,
      ...
      return /* @__PURE__ */ B.isValidElement(s) ? u = /* @__PURE__ */ B.cloneElement(s, R) : Nc(s) ? u = s(R) : u = /* @__PURE__ */ B.createElement(Rc, Rr({}, R, {
        type: o
    ...
    value: function() {
      ...
      if (i || !s || !s.length)
        return null;
      var S = this.state.isAnimationFinished, _ = Ml("recharts-scatter", o), R = l && l.allowDataOverflow, D = c && c.allowDataOverflow, O = R || D, b = tr(g) ? this.id : g;
      ...
      }, this.renderSymbols()), (!y || S) && wa.renderCallByParent(this.props, s));
    }
  }], [{
...
zt(Gr, "defaultProps", {
  ...
  shape: "circle",
  hide: !1,
  isAnimationActive: !Tc.isSsr,
  animationBegin: 0,
  animationDuration: 400,
  animationEasing: "linear"
});
zt(Gr, "getComposedData", function(r) {
  var e = r.xAxis, t = r.yAxis, n = r.zAxis, i = r.item, s = r.displayedData, a = r.xAxisTicks, o = r.yAxisTicks, l = r.offset, c = i.props.tooltipType, d = xa(i.props.children, Oc), u = tr(e.dataKey) ? i.props.dataKey : e.dataKey, h = tr(t.dataKey) ? i.props.dataKey : t.dataKey, m = n && n.dataKey, g = n ? n.range : Hn.defaultProps.range, y = g && g[0], S = e.scale.bandwidth ? e.scale.bandwidth() : 0, _ = t.scale.bandwidth ? t.scale.bandwidth() : 0, R = s.map(function(D, O) {
    var b = en(D, u), k = en(D, h), E = !tr(m) && en(D, m) || "-", T = [{
      name: tr(e.dataKey) ? i.props.name : e.name || e.dataKey,
      unit: e.unit || "",
      value: b,
      payload: D,
      dataKey: u,
      ...
      name: tr(t.dataKey) ? i.props.name : t.name || t.dataKey,
      unit: t.unit || "",
      value: k,
      payload: D,
      dataKey: h,
...
const gf = (r) => {
  ...
  const y = Pc(e), S = d?.categories ? Array.isArray(d.categories) ? d.categories : [d.categories] : [], _ = u?.categories ? Array.isArray(u.categories) ? u.categories : [u.categories] : [], R = h?.categories ? Array.isArray(h.categories) ? h.categories : [h.categories] : [], D = [
    ...S,
    ..._,
    ...R
  ], O = Math.max(
  ...
  return /* @__PURE__ */ f(Fc, { config: r, ref: g, aspect: o, children: /* @__PURE__ */ j(
    pf,
    {
      ...
      children: [
        !s && /* @__PURE__ */ f(
          ...
          {
            ...Hc(),
            content: /* @__PURE__ */ f(Vc, { yAxisFormatter: n.tickFormatter })
          }
        ),
        !a && /* @__PURE__ */ f(jc, { ...$c() }),
        ...
        /* @__PURE__ */ f(
          Ea,
          {
            ...
            tick: c ? (E) => {
              ...
              return /* @__PURE__ */ j("g", { transform: `translate(${T},${$})`, children: [
                /* @__PURE__ */ f(
                  "text",
                  {
                    x: 0,
        ...
        S.map((E, T) => /* @__PURE__ */ f(
          Ca,
          {
            isAnimationActive: !1,
            dataKey: String(E),
            fill: r[E].color ? Er(r[E].color) : qn(T),
            radius: 4,
            maxBarSize: 32,
        ...
        _.map((E, T) => /* @__PURE__ */ f(
          _a,
          {
            type: u?.lineType ?? "natural",
            dataKey: String(E),
            stroke: r[E].color ? Er(r[E].color) : qn(S.length + T),
            strokeWidth: 2,
            dot: u?.dot ?? !1,
            isAnimationActive: !1,
        ...
        R.map((E, T) => /* @__PURE__ */ f(
          ...
          {
            dataKey: String(E),
            fill: r[E].color ? Er(r[E].color) : qn(
              S.length + _.length + T
            ),
            r: 4,
            isAnimationActive: !1,
        ...
        l && /* @__PURE__ */ f(
          Gc,
          {
            content: /* @__PURE__ */ f(Uc, { nameKey: "label" }),
            align: "center",
...
}, yf = ka(vf), bf = ({ value: r, max: e = 100, label: t, color: n }, i) => {
  ...
  lt({ name: "AreaChart", type: "info" }, qc)
), dg = he(
  lt({ name: "BarChart", type: "info" }, Kc)
), ug = he(
  lt(
  ...
  lt({ name: "LineChart", type: "info" }, Xc)
), fg = he(
  lt({ name: "PieChart", type: "info" }, Jc)
), mg = he(
  lt(
  ...
  lt({ name: "ProgressBarChart", type: "info" }, xf)
), gg = he(
  lt({ name: "ComboChart", type: "info" }, yf)
), wf = (r) => typeof r == "boolean" || !r ? {
  show: !!r,
  invertStatus: !1
} : {
  show: r.show ?? !0,
  ...
  const t = ed(), n = t(e.value, {
    formatterOptions: {
      decimalPlaces: 2
    }
  }), i = wf(e.trend), s = t(e.comparison), a = td(
    n.numericValue,
    n.formatterOptions
  ), o = ss(s.numericValue), l = ss(n.numericValue), c = U(() => {
    if (!(!o || !i.show) && !(!o || !l))
      return (l - o) / o * 100;
  }, [l, o, i.show]);
...
}, _f = () => /* @__PURE__ */ j("div", { className: "relative flex h-full w-full cursor-progress flex-col gap-2", children: [
...
yo.displayName = "F0BigNumber";
const Cf = na(yo, _f), vg = he(
  at("F0BigNumber", Cf)
), bo = {
  background: {
...
const Bf = jt({
  ...
  ({
    ...
    const I = ie && ie !== "none" || de && de !== "none" || se && se !== "none" || ye && ye !== "none", M = V && V !== "none" || I, W = { sm: dt, md: kt, lg: p, xl: v }, ee = Hf.map((xe) => {
      const ge = W[xe];
      return ge ? Ff(xe, ge) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ f(
...
const yg = lt(
  ...
  (r) => r !== "ai"
), xg = ia, wg = ["default", "outline", "neutral"], _g = ia, Cg = ["sm", "md", "lg"], Eg = ["compact", "expanded"], kg = Il, Sg = [
  "viridian",
  "malibu",
  "yellow",
  "purple",
  ...
  const [t, n] = Q(!1), i = /* @__PURE__ */ f(nn, { label: `+${r}` });
  return e?.length ? /* @__PURE__ */ j(sa, { open: t, onOpenChange: n, children: [
    /* @__PURE__ */ f(aa, { asChild: !0, children: /* @__PURE__ */ f("button", { className: oa("inline-flex flex-shrink-0 items-center"), children: i }) }),
    /* @__PURE__ */ f(
      la,
      {
        className: "rounded-md border border-solid border-f1-border-secondary p-1 shadow-md",
        align: "end",
        children: /* @__PURE__ */ j(ca, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[172px] flex-col", children: [
          e.map((s, a) => /* @__PURE__ */ f(
            "div",
            {
              className: "flex w-[220px] min-w-0 items-center gap-1.5 px-2 py-1 [&:first-child]:pt-2 [&:last-child]:pb-2",
              children: /* @__PURE__ */ f(nn, { ...s })
            },
            a
          )),
          /* @__PURE__ */ f(
...
const Ao = ({
  ...
  if (n === "fill")
    return /* @__PURE__ */ f(
      ...
      {
        items: r,
        renderListItem: (l) => /* @__PURE__ */ f(nn, { ...l }),
...
const Dg = he(
  ...
  const a = K(null);
  return /* @__PURE__ */ f("div", { ref: a, className: "@container", children: /* @__PURE__ */ f("div", { className: Vf({ variant: s }), children: /* @__PURE__ */ j(
    "div",
    {
      className: re(
      ...
      children: [
        /* @__PURE__ */ j("div", { className: "flex flex-row gap-2", children: [
          /* @__PURE__ */ f("div", { className: "h-6 w-6 flex-shrink-0", children: s === "neutral" ? /* @__PURE__ */ f(Fl, { icon: i || Bl, size: "sm" }) : /* @__PURE__ */ f(nd, { type: s, size: "sm" }) }),
          /* @__PURE__ */ j("div", { className: "flex flex-col gap-0.5", children: [
            /* @__PURE__ */ f("p", { className: jf({ variant: s }), children: r }),
...
function To({
  ...
  const l = hr(), c = Object.keys(r)[0] ?? null, [d, u] = Q(c), [h, m] = Q(e);
  J(() => {
    m(e);
  }, [e]), J(() => {
    if (!d && r) {
  ...
  const g = (_, R) => {
    ...
    const b = ts(O.type);
    return Math.max(R, b?.formHeight || Wf);
  }, 0), [r, n]);
...
To.displayName = "F0FilterPickerContent";
const Ag = he(
  To
);
var Ur = (r) => r.type === "checkbox", Ut = (r) => r instanceof Date, He = (r) => r == null;
const Oo = (r) => typeof r == "object";
var Ee = (r) => !He(r) && !Array.isArray(r) && Oo(r) && !Ut(r), Mo = (r) => Ee(r) && r.target ? Ur(r.target) ? r.target.checked : r.target.value : r, Gf = (r) => r.substring(0, r.search(/\.\d+(\.|$)/)) || r, Lo = (r, e) => r.has(Gf(e)), Uf = (r) => {
  const e = r.constructor && r.constructor.prototype;
  return Ee(e) && e.hasOwnProperty("isPrototypeOf");
}, Bi = typeof window < "u" && typeof window.HTMLElement < "u" && typeof document < "u";
function $e(r) {
  let e;
  ...
  if (r instanceof Date)
    ...
    e = new Set(r);
  else if (!(Bi && (r instanceof Blob || n)) && (t || Ee(r)))
    if (e = t ? [] : {}, !t && !Uf(r))
      e = r;
    else
      for (const i in r)
...
var Vn = (r) => Array.isArray(r) ? r.filter(Boolean) : [], Ce = (r) => r === void 0, F = (r, e, t) => {
  if (!e || !Ee(r))
    return t;
  const n = Vn(e.split(/[,[\].]+?/)).reduce((i, s) => He(i) ? i : i[s], r);
  return Ce(n) || n === r ? Ce(r[e]) ? t : r[e] : n;
}, st = (r) => typeof r == "boolean", Hi = (r) => /^\w*$/.test(r), Io = (r) => Vn(r.replace(/["|']|\]/g, "").split(/\.|\[/)), me = (r, e, t) => {
  let n = -1;
  const i = Hi(e) ? [e] : Io(e), s = i.length, a = s - 1;
  for (; ++n < s; ) {
    const o = i[n];
    let l = t;
    if (n !== a) {
...
const bn = {
  ...
  required: "required",
  validate: "validate"
}, Po = B.createContext(null), $t = () => B.useContext(Po), Zf = (r) => {
  const { children: e, ...t } = r;
  return B.createElement(Po.Provider, { value: t }, e);
};
var zo = (r, e, t, n = !0) => {
  const i = {
  ...
  return i;
}, We = (r) => Ee(r) && !Object.keys(r).length, Fo = (r, e, t, n) => {
  t(r);
  const { name: i, ...s } = r;
  return We(s) || Object.keys(s).length >= Object.keys(e).length || Object.keys(s).find((a) => e[a] === (!n || ut.all));
}, Ar = (r) => Array.isArray(r) ? r : [r], Bo = (r, e, t) => !r || !e || r === e || Ar(r).some((n) => n && (t ? n === e : n.startsWith(e) || e.startsWith(n)));
function Vi(r) {
  const e = B.useRef(r);
...
function qf(r) {
  const e = $t(), { control: t = e.control, disabled: n, name: i, exact: s } = r || {}, [a, o] = B.useState(t._formState), l = B.useRef(!0), c = B.useRef({
    isDirty: !1,
    isLoading: !1,
    dirtyFields: !1,
    touchedFields: !1,
  ...
  return d.current = i, Vi({
    disabled: n,
    next: (u) => l.current && Bo(d.current, u.name, s) && Fo(u, c.current, t._updateFormState) && o({
      ...t._formState,
      ...u
    }),
    ...
    l.current = !1;
  }), [t]), B.useMemo(() => zo(a, t, c.current, !1), [a, t]);
}
var _t = (r) => typeof r == "string", Ho = (r, e, t, n, i) => _t(r) ? (n && e.watch.add(r), F(t, r, i)) : Array.isArray(r) ? r.map((s) => (n && e.watch.add(s), F(t, s))) : (n && (e.watchAll = !0), t);
function Kf(r) {
  ...
  o.current = n, Vi({
    ...
    next: (d) => {
      Bo(o.current, d.name, a) && c($e(Ho(o.current, t._names, d.values || t._formValues, !1, i)));
    }
  });
...
function Yf(r) {
  const e = $t(), { name: t, disabled: n, control: i = e.control, shouldUnregister: s } = r, a = Lo(i._names.array, t), o = Kf({
    control: i,
    name: t,
...
}), Ds = (r, e, t) => !t && (e.watchAll || e.watch.has(r) || [...e.watch].some((n) => r.startsWith(n) && /^\.\w+/.test(r.slice(n.length))));
const Tr = (r, e, t, n) => {
...
}, ji = (r) => r.type === "file", wt = (r) => typeof r == "function", xn = (r) => {
  if (!Bi)
    return !1;
  const e = r ? r.ownerDocument : 0;
  return r instanceof (e && e.defaultView ? e.defaultView.HTMLElement : HTMLElement);
}, rn = (r) => _t(r), $i = (r) => r.type === "radio", wn = (r) => r instanceof RegExp;
const Ns = {
  value: !1,
  isValid: !1
}, Rs = { value: !0, isValid: !0 };
var jo = (r) => {
  if (Array.isArray(r)) {
    if (r.length > 1) {
    ...
    return r[0].checked && !r[0].disabled ? (
      ...
      r[0].attributes && !Ce(r[0].attributes.value) ? Ce(r[0].value) || r[0].value === "" ? Rs : { value: r[0].value, isValid: !0 } : Rs
    ) : Ns;
  }
  return Ns;
};
...
var $o = (r) => Array.isArray(r) ? r.reduce((e, t) => t && t.checked && !t.disabled ? {
  isValid: !0,
  value: t.value
} : e, As) : As;
function Ts(r, e, t = "validate") {
  if (rn(r) || Array.isArray(r) && r.every(rn) || st(r) && !r)
    return {
      type: t,
      message: rn(r) ? r : "",
      ref: e
...
var Qt = (r) => Ee(r) && !wn(r) ? r : {
  value: r,
  message: ""
}, Os = async (r, e, t, n, i, s) => {
  ...
  if (!_ || e.has(y))
    return {};
  const D = o ? o[0] : a, O = (C) => {
    i && D.reportValidity && (D.setCustomValidity(st(C) ? "" : C || ""), D.reportValidity());
  }, b = {}, k = $i(a), E = Ur(a), T = k || E, $ = (S || ji(a)) && Ce(a.value) && Ce(R) || xn(a) && a.value === "" || R === "" || Array.isArray(R) && !R.length, z = Vo.bind(null, y, n, b), N = (C, A, V, ie = Dt.maxLength, de = Dt.minLength) => {
    const se = C ? A : V;
    b[y] = {
      type: C ? ie : de,
      message: se,
  ...
  if (s ? !Array.isArray(R) || !R.length : l && (!T && ($ || He(R)) || st(R) && !R || E && !jo(o).isValid || k && !$o(o).isValid)) {
    const { value: C, message: A } = rn(l) ? { value: !!l, message: l } : Qt(l);
    if (C && (b[y] = {
      type: Dt.required,
      message: A,
      ref: D,
  ...
  if (!$ && (!He(u) || !He(h))) {
    let C, A;
    const V = Qt(h), ie = Qt(u);
    if (!He(R) && !isNaN(R)) {
      const de = a.valueAsNumber || R && +R;
      He(V.value) || (C = de > V.value), He(ie.value) || (A = de < ie.value);
    } else {
      const de = a.valueAsDate || new Date(R), se = (we) => /* @__PURE__ */ new Date((/* @__PURE__ */ new Date()).toDateString() + " " + we), ye = a.type == "time", X = a.type == "week";
      _t(V.value) && R && (C = ye ? se(R) > se(V.value) : X ? R > V.value : de > new Date(V.value)), _t(ie.value) && R && (A = ye ? se(R) < se(ie.value) : X ? R < ie.value : de < new Date(ie.value));
    }
    if ((C || A) && (N(!!C, V.message, ie.message, Dt.max, Dt.min), !n))
      return O(b[y].message), b;
  }
  if ((c || d) && !$ && (_t(R) || s && Array.isArray(R))) {
    const C = Qt(c), A = Qt(d), V = !He(C.value) && R.length > +C.value, ie = !He(A.value) && R.length < +A.value;
    if ((V || ie) && (N(V, C.message, A.message), !n))
      return O(b[y].message), b;
  }
  if (m && !$ && _t(R)) {
    const { value: C, message: A } = Qt(m);
    if (wn(C) && !R.match(C) && (b[y] = {
      type: Dt.pattern,
      message: A,
      ref: a,
      ...z(Dt.pattern, A)
...
function De(r, e) {
  const t = Array.isArray(e) ? e : Hi(e) ? [e] : Io(e), n = t.length === 1 ? r : Qf(r, t), i = t.length - 1, s = t[i];
  return n && delete n[s], i !== 0 && (Ee(n) && We(n) || Array.isArray(n) && em(n)) && De(r, t.slice(0, -1)), r;
}
var Qn = () => {
  let r = [];
  return {
...
function Pt(r, e) {
  ...
  for (const i of t) {
    ...
    if (i !== "ref") {
      const a = e[i];
      if (Ut(s) && Ut(a) || Ee(s) && Ee(a) || Array.isArray(s) && Array.isArray(a) ? !Pt(s, a) : s !== a)
        return !1;
    }
  }
  return !0;
}
var Wo = (r) => r.type === "select-multiple", tm = (r) => $i(r) || Ur(r), ei = (r) => xn(r) && r.isConnected, Go = (r) => {
  for (const e in r)
    if (wt(r[e]))
      return !0;
  return !1;
...
function _n(r, e = {}) {
  ...
  if (Ee(r) || t)
    for (const n in r)
      Array.isArray(r[n]) || Ee(r[n]) && !Go(r[n]) ? (e[n] = Array.isArray(r[n]) ? [] : {}, _n(r[n], e[n])) : He(r[n]) || (e[n] = !0);
  return e;
}
function Uo(r, e, t) {
  ...
  if (Ee(r) || n)
    for (const i in r)
      Array.isArray(r[i]) || Ee(r[i]) && !Go(r[i]) ? Ce(e) || mi(t[i]) ? t[i] = Array.isArray(r[i]) ? _n(r[i], []) : { ..._n(r[i]) } : Uo(r[i], He(e) ? {} : e[i], t[i]) : t[i] = !Pt(r[i], e[i]);
  return t;
}
var wr = (r, e) => Uo(r, e, _n(e)), Zo = (r, { valueAsNumber: e, valueAsDate: t, setValueAs: n }) => Ce(r) ? r : e ? r === "" ? NaN : r && +r : t && _t(r) ? new Date(r) : n ? n(r) : r;
function ti(r) {
  const e = r.ref;
  return ji(e) ? e.files : $i(e) ? $o(r.refs).value : Wo(e) ? [...e.selectedOptions].map(({ value: t }) => t) : Ur(e) ? jo(r.refs).value : Zo(Ce(e.value) ? r.ref.value : e.value, r);
}
var rm = (r, e, t, n) => {
  const i = {};
  for (const s of r) {
...
}, _r = (r) => Ce(r) ? r : wn(r) ? r.source : Ee(r) ? wn(r.value) ? r.value.source : r.value : r;
const Ms = "AsyncFunction";
var nm = (r) => !!r && !!r.validate && !!(wt(r.validate) && r.validate.constructor.name === Ms || Ee(r.validate) && Object.values(r.validate).find((e) => e.constructor.name === Ms)), im = (r) => r.mount && (r.required || r.min || r.max || r.maxLength || r.minLength || r.pattern || r.validate);
function Ls(r, e, t) {
  const n = F(r, t);
  if (n || Hi(t))
    return {
...
var sm = (r, e, t, n, i) => i.isOnAll ? !1 : !t && i.isOnTouch ? !(e || r) : (t ? n.isOnBlur : i.isOnBlur) ? !r : (t ? n.isOnChange : i.isOnChange) ? r : !0, am = (r, e) => !Vn(F(r, e)).length && De(r, e);
const om = {
  mode: ut.onSubmit,
...
function lm(r = {}) {
  ...
  const d = {
    ...
    array: Qn(),
    state: Qn()
  }, h = Ss(e.mode), m = Ss(e.reValidateMode), g = e.criteriaMode === ut.all, y = (p) => (v) => {
    clearTimeout(c), c = setTimeout(p, v);
  }, S = async (p) => {
    if (!e.disabled && (d.isValid || p)) {
      const v = e.resolver ? We((await T()).errors) : await z(n, !0);
    ...
    !e.disabled && (d.isValidating || d.validatingFields) && ((p || Array.from(o.mount)).forEach((w) => {
      w && (v ? me(t.validatingFields, w, v) : De(t.validatingFields, w));
    }), u.state.next({
    ...
    const I = F(n, p);
    if (I) {
      const M = F(s, p, Ce(w) ? F(i, p) : w);
      Ce(M) || L && L.defaultChecked || v ? me(s, p, v ? M : ti(I._f)) : ie(p, M), a.mount && S();
    }
  }, k = (p, v, w, L, I) => {
    let M = !1, W = !1;
    const ee = {
    ...
    if (!e.disabled) {
      ...
      if (!w || L) {
        ...
        const ge = xe || Pt(F(i, p), v);
        W = !!(!xe && F(t.dirtyFields, p)), ge || xe ? De(t.dirtyFields, p) : me(t.dirtyFields, p, !0), ee.dirtyFields = t.dirtyFields, M = M || d.dirtyFields && W !== !ge;
      }
      if (w) {
        const ge = F(t.touchedFields, p);
        ge || (me(t.touchedFields, p, w), ee.touchedFields = t.touchedFields, M = M || d.touchedFields && ge !== w);
      }
      M && I && u.state.next(ee);
    }
    return M ? ee : {};
  }, E = (p, v, w, L) => {
    const I = F(t.errors, p), M = d.isValid && st(v) && t.isValid !== v;
    if (e.delayError && w ? (l = y(() => D(p, w)), l(e.delayError)) : (clearTimeout(c), l = null, w ? me(t.errors, p, w) : De(t.errors, p)), (w ? !Pt(I, w) : I) || !We(L) || M) {
      const W = {
        ...L,
        ...M && st(v) ? { isValid: v } : {},
        errors: t.errors,
    ...
    _(p, !0);
    const v = await e.resolver(s, e.context, rm(p || o.mount, n, e.criteriaMode, e.shouldUseNativeValidation));
    return _(p), v;
  }, $ = async (p) => {
    ...
    if (p)
      for (const w of p) {
        const L = F(v, w);
        L ? me(t.errors, w, L) : De(t.errors, w);
      }
    else
      t.errors = v;
    return v;
    ...
    for (const L in p) {
      ...
      if (I) {
        const { _f: M, ...W } = I;
        if (M) {
          const ee = o.array.has(M.name), xe = I._f && nm(I._f);
          xe && d.validatingFields && _([L], !0);
          const ge = await Os(I, o.disabled, s, g, e.shouldUseNativeValidation && !v, ee);
          if (xe && d.validatingFields && _([L]), ge[M.name] && (w.valid = !1, v))
            break;
          !v && (F(ge, M.name) ? ee ? Jf(t.errors, ge, M.name) : me(t.errors, M.name, ge[M.name]) : De(t.errors, M.name));
        }
        !We(W) && await z(W, v, w);
      }
    }
    ...
    for (const p of o.unMount) {
      const v = F(n, p);
      v && (v._f.refs ? v._f.refs.every((w) => !ei(w)) : !ei(v._f.ref)) && ke(p);
    }
    o.unMount = /* @__PURE__ */ new Set();
  }, C = (p, v) => !e.disabled && (p && v && me(s, p, v), !Pt(Ue(), i)), A = (p, v, w) => Ho(p, o, {
    ...a.mount ? s : Ce(v) ? i : _t(p) ? { [p]: v } : v
  }, w, v), V = (p) => Vn(F(a.mount ? s : i, p, e.shouldUnregister ? F(i, p, []) : [])), ie = (p, v, w = {}) => {
    const L = F(n, p);
    let I = v;
    if (L) {
      const M = L._f;
      M && (!M.disabled && me(s, p, Zo(v, M)), I = xn(M.ref) && He(v) ? "" : v, Wo(M.ref) ? [...M.ref.options].forEach((W) => W.selected = I.includes(W.value)) : M.refs ? Ur(M.ref) ? M.refs.length > 1 ? M.refs.forEach((W) => (!W.defaultChecked || !W.disabled) && (W.checked = Array.isArray(I) ? !!I.find((ee) => ee === W.value) : I === W.value)) : M.refs[0] && (M.refs[0].checked = !!I) : M.refs.forEach((W) => W.checked = W.value === I) : ji(M.ref) ? M.ref.value = "" : (M.ref.value = I, M.ref.type || u.values.next({
        name: p,
        values: { ...s }
      })));
    }
    (w.shouldDirty || w.shouldTouch) && k(p, I, w.shouldTouch, w.shouldDirty, !0), w.shouldValidate && we(p);
  }, de = (p, v, w) => {
    for (const L in v) {
      const I = v[L], M = `${p}.${L}`, W = F(n, M);
      (o.array.has(p) || Ee(I) || W && !W._f) && !Ut(I) ? de(M, I, w) : ie(M, I, w);
    }
  }, se = (p, v, w = {}) => {
    const L = F(n, p), I = o.array.has(p), M = $e(v);
    me(s, p, M), I ? (u.array.next({
      ...
      dirtyFields: wr(i, s),
      isDirty: C(p, M)
    })) : L && !L._f && !He(M) ? de(p, M, w) : ie(p, M, w), Ds(p, o) && u.state.next({ ...t }), u.values.next({
    ...
    const v = p.target;
    let w = v.name, L = !0;
    const I = F(n, w), M = () => v.type ? ti(I._f) : Mo(p), W = (ee) => {
      L = Number.isNaN(ee) || Ut(ee) && isNaN(ee.getTime()) || Pt(ee, F(s, w, ee));
    };
    if (I) {
      let ee, xe;
      const ge = M(), Fe = p.type === bn.BLUR || p.type === bn.FOCUS_OUT, Gt = !im(I._f) && !e.resolver && !F(t.errors, w) && !I._f.deps || sm(Fe, F(t.touchedFields, w), t.isSubmitted, m, h), Yt = Ds(w, o, Fe);
      me(s, w, ge), Fe ? (I._f.onBlur && I._f.onBlur(p), l && l(0)) : I._f.onChange && I._f.onChange(p);
      const tt = k(w, ge, Fe, !1), Zr = !We(tt) || Yt;
      if (!Fe && u.values.next({
        name: w,
        type: p.type,
        values: { ...s }
      }), Gt)
        return d.isValid && (e.mode === "onBlur" && Fe ? S() : Fe || S()), Zr && u.state.next({ name: w, ...Yt ? {} : tt });
      if (!Fe && Yt && u.state.next({ ...t }), e.resolver) {
        const { errors: qr } = await T([w]);
        if (W(ge), L) {
          const Gn = Ls(t.errors, n, w), Xt = Ls(qr, n, Gn.name || w);
          ee = Xt.error, w = Xt.name, xe = We(qr);
        }
      } else
        _([w], !0), ee = (await Os(I, o.disabled, s, g, e.shouldUseNativeValidation))[w], _([w]), W(ge), L && (ee ? xe = !1 : d.isValid && (xe = await z(n, !0)));
      L && (I._f.deps && we(I._f.deps), E(w, xe, ee, tt));
    }
  }, X = (p, v) => {
    ...
    const I = Ar(p);
    if (e.resolver) {
      const M = await $(Ce(p) ? p : I);
      w = We(M), L = p ? !I.some((W) => F(M, W)) : w;
    } else p ? (L = (await Promise.all(I.map(async (M) => {
      const W = F(n, M);
      return await z(W && W._f ? { [M]: W } : W);
    }))).every(Boolean), !(!L && !t.isValid) && S()) : L = w = await z(n);
    return u.state.next({
      ...!_t(p) || d.isValid && w !== t.isValid ? {} : { name: p },
      ...e.resolver || !p ? { isValid: w } : {},
      errors: t.errors
    }), v.shouldFocus && !L && Tr(n, X, p ? I : o.mount), L;
  }, Ue = (p) => {
    const v = {
      ...a.mount ? s : i
    };
    return Ce(p) ? v : _t(p) ? F(v, p) : p.map((w) => F(v, w));
  }, be = (p, v) => ({
    ...
    p && Ar(p).forEach((v) => De(t.errors, v)), u.state.next({
      errors: p ? t.errors : {}
    });
  }, Re = (p, v, w) => {
    const L = (F(n, p, { _f: {} })._f || {}).ref, I = F(t.errors, p) || {}, { ref: M, message: W, type: ee, ...xe } = I;
    me(t.errors, p, {
      ...xe,
      ...v,
      ref: L
  ...
  }, Oe = (p, v) => wt(p) ? u.values.subscribe({
    next: (w) => p(A(void 0, v), w)
  }) : A(p, v, !0), ke = (p, v = {}) => {
    for (const w of p ? Ar(p) : o.mount)
      o.mount.delete(w), o.array.delete(w), v.keepValue || (De(n, w), De(s, w)), !v.keepError && De(t.errors, w), !v.keepDirty && De(t.dirtyFields, w), !v.keepTouched && De(t.touchedFields, w), !v.keepIsValidating && De(t.validatingFields, w), !e.shouldUnregister && !v.keepDefaultValue && De(i, w);
    u.values.next({
      values: { ...s }
    }), u.state.next({
      ...t,
  ...
  }, je = ({ disabled: p, name: v, field: w, fields: L }) => {
    (st(p) && a.mount || p || o.disabled.has(v)) && (p ? o.disabled.add(v) : o.disabled.delete(v), k(v, ti(w ? w._f : F(L, v)._f), !1, !1, !0));
  }, pe = (p, v = {}) => {
    let w = F(n, p);
    const L = st(v.disabled) || st(e.disabled);
    return me(n, p, {
      ...w || {},
      _f: {
      ...
      ...e.progressive ? {
        ...
        min: _r(v.min),
        max: _r(v.max),
        minLength: _r(v.minLength),
        maxLength: _r(v.maxLength),
        pattern: _r(v.pattern)
      } : {},
      name: p,
      onChange: ye,
      onBlur: ye,
      ref: (I) => {
        if (I) {
          pe(p, v), w = F(n, p);
          const M = Ce(I.value) && I.querySelectorAll && I.querySelectorAll("input,select,textarea")[0] || I, W = tm(M), ee = w._f.refs || [];
          if (W ? ee.find((xe) => xe === M) : M === w._f.ref)
            return;
          me(n, p, {
            _f: {
              ...w._f,
          ...
          w = F(n, p, {}), w._f && (w._f.mount = !1), (e.shouldUnregister || v.shouldUnregister) && !(Lo(o.array, p) && a.action) && o.unMount.add(p);
      }
    };
  }, _e = () => e.shouldFocusError && Tr(n, X, o.mount), ce = (p) => {
    st(p) && (u.state.next({ disabled: p }), Tr(n, (v, w) => {
      const L = F(n, w);
    ...
    if (De(t.errors, "root"), We(t.errors)) {
      ...
      v && await v({ ...t.errors }, w), _e(), setTimeout(_e);
    if (u.state.next({
      isSubmitted: !0,
      isSubmitting: !1,
    ...
    F(n, p) && (Ce(v.defaultValue) ? se(p, $e(F(i, p))) : (se(p, v.defaultValue), me(i, p, $e(v.defaultValue))), v.keepTouched || De(t.touchedFields, p), v.keepDirty || (De(t.dirtyFields, p), t.isDirty = v.defaultValue ? C(p, $e(F(i, p))) : C()), v.keepError || (De(t.errors, p), d.isValid && S()), u.state.next({ ...t }));
  }, Le = (p, v = {}) => {
    const w = p ? $e(p) : i, L = $e(w), I = We(p), M = I ? i : L;
    if (v.keepDefaultValues || (i = w), !v.keepValues) {
      ...
      s = e.shouldUnregister ? v.keepDefaultValues ? $e(i) : {} : $e(M), u.array.next({
        values: { ...M }
      }), u.values.next({
        values: { ...M }
      });
    ...
    o = {
      ...
      isDirty: I ? !1 : v.keepDirty ? t.isDirty : !!(v.keepDefaultValues && !Pt(p, i)),
      isSubmitted: v.keepIsSubmitted ? t.isSubmitted : !1,
      dirtyFields: I ? {} : v.keepDirtyValues ? v.keepDefaultValues && s ? wr(i, s) : t.dirtyFields : v.keepDefaultValues && p ? wr(i, p) : v.keepDirty ? t.dirtyFields : {},
  ...
  return {
    ...
    setFocus: (p, v = {}) => {
      ...
      if (L) {
        ...
        I.focus && (I.focus(), v.shouldSelect && wt(I.select) && I.select());
      }
    },
    getFieldState: be
  };
...
function qo(r = {}) {
  ...
  return s._options = r, Vi({
    subject: s._subjects.state,
    next: (a) => {
      Fo(a, s._proxyFormState, s._updateFormState, !0) && i({ ...s._formState });
    }
  ...
  }, [r.shouldUnregister, s]), e.current.formState = zo(n, s), e.current;
}
var cm = "Label", Ko = ot.forwardRef((r, e) => /* @__PURE__ */ f(
  jl.label,
  {
    ...r,
    ref: e,
...
Ko.displayName = cm;
var Yo = Ko;
const Cn = ot.forwardRef(({ className: r, ...e }, t) => /* @__PURE__ */ f(
  Yo,
  {
    ref: t,
    className: re(
...
Cn.displayName = Yo.displayName;
const Xo = Zf, Jo = ot.createContext(
  {}
), Is = ({
  ...r
}) => {
  const { formState: e } = $t();
  return /* @__PURE__ */ f(Jo.Provider, { value: { name: r.name }, children: /* @__PURE__ */ f(Xf, { ...r, disabled: e.isSubmitting }) });
}, jn = () => {
  const r = ot.useContext(Jo), e = ot.useContext(Qo), { getFieldState: t, formState: n } = $t(), i = t(r.name, n);
  if (!r)
  ...
  {}
), el = ot.forwardRef(({ className: r, ...e }, t) => {
  const n = ot.useId();
  return /* @__PURE__ */ f(Qo.Provider, { value: { id: n }, children: /* @__PURE__ */ f("div", { ref: t, className: re("space-y-2", r), ...e }) });
});
el.displayName = "FormItem";
const dm = ot.forwardRef(({ className: r, ...e }, t) => {
...
const rl = ot.forwardRef(({ className: r, ...e }, t) => {
...
rl.displayName = "FormDescription";
const nl = ot.forwardRef(
  ({ className: r, children: e, fallback: t, ...n }, i) => {
    const { error: s, formMessageId: a } = jn(), { forms: o } = hr(), l = s ? s.message ?? t ?? o.validation.invalidType : e;
    return l ? /* @__PURE__ */ j(
      "div",
      {
        ref: i,
        ...
        ...n,
        children: [
          /* @__PURE__ */ f(An, { icon: ua, color: "critical" }),
    ...
    as,
    {
      ...
      leftContent: n ? /* @__PURE__ */ j("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ j("div", { className: "flex items-center gap-0.5", children: [
          /* @__PURE__ */ f(An, { icon: ua, size: "md", color: "critical" }),
...
const Wi = "gap-4", il = "mt-6", sl = "max-w-[720px]", Wt = "md", Gi = Et(null);
function al() {
  const r = ft(Gi);
  if (!r)
...
function Zi(r) {
  const e = r;
  return e._f0Config ? e._f0Config : ol.get(r);
}
function Og(r) {
  return Zi(r) !== void 0;
}
...
function ll(r) {
  return ve(r, "ZodOptional") || ve(r, "ZodNullable") || ve(r, "ZodDefault") && ll(r._def.innerType);
}
...
function mm(r) {
  const e = gt(r);
  return ve(e, "ZodString") ? (e._def.checks || []).some((n) => n.kind === "min" ? (n.value ?? 0) >= 1 : fm.has(n.kind)) : !1;
}
function cl(r) {
  if (ll(r))
    return !1;
  const e = gt(r);
  return ve(e, "ZodString") ? mm(r) : !0;
}
function pm(r, e) {
  const t = e[r.fieldId];
  if ("equalsTo" in r)
...
function $n(r, e) {
  return typeof r == "function" ? r({ values: e }) : pm(r, e);
}
function qi(r, e) {
...
function ym({
  ...
  return /* @__PURE__ */ f(Hr, { children: r.render(s) });
}
function bm(r, e) {
  if (r)
    return {
...
function _m({
  ...
  const i = e.value ?? void 0, s = U(() => pi(i), [i]), a = le(
    (h) => {
      if (!h) {
        e.onChange(null);
        return;
...
function Om({
  ...
  const t = r.validation && Tm(r.validation);
  return /* @__PURE__ */ f(
    ql,
    {
      ...e,
...
function Im({
  ...
  const i = r.inputType ?? "text", s = r.placeholder ?? Mm[i] ?? void 0, a = Lm[i];
  return /* @__PURE__ */ f(
    ha,
    {
      ...e,
...
function zm({
  ...
  const a = !!t.error, { isValidating: o } = t, l = qi(r.disabled, s) || n, c = {
    error: a,
    loading: o
  };
  switch (r.type) {
      ...
      return /* @__PURE__ */ f(
        dl,
        {
          field: {
            ...
            minDate: er(r.minDate, s),
            maxDate: er(r.maxDate, s)
          },
          formField: e,
          ...c
        }
...
function Wn({ field: r, sectionId: e }) {
  const t = $t(), n = t.watch(), { isSubmitting: i } = t.formState, { formName: s } = al(), { forms: a } = hr(), o = qi(r.disabled, n), l = K(o);
  J(() => {
    const m = l.current;
  ...
  const c = !r.renderIf || $n(r.renderIf, n), d = r.type !== "checkbox" && r.type !== "custom", u = r.validation && cl(r.validation), h = qt(s, e, r.id);
  return c ? /* @__PURE__ */ f(
    Is,
    {
      control: t.control,
      name: r.id,
      render: ({ field: m, fieldState: g }) => /* @__PURE__ */ j(el, { id: h, className: "scroll-mt-4", children: [
        d && /* @__PURE__ */ j(
          "label",
          {
            htmlFor: r.id,
        ...
        r.helpText && /* @__PURE__ */ f(rl, { children: r.helpText }),
        /* @__PURE__ */ f(
          nl,
          {
...
function Ki({ row: r, sectionId: e }) {
  return /* @__PURE__ */ f("div", { className: `flex xs:flex-row flex-col ${Wi} [&>*]:flex-1`, children: r.fields.map((t) => /* @__PURE__ */ f(Wn, { field: t, sectionId: e }, t.id)) });
}
function Fm(r) {
  const e = gt(r);
  return ve(e, "ZodLiteral") && e._def.value === !0;
}
function Yi({ fields: r }) {
  const e = $t(), { watch: t, setValue: n } = e, { isSubmitting: i } = e.formState, s = t(), a = U(
    () => r.filter(
  ...
  const c = U(
    () => a.map((h) => ({
      ...
      disabled: o[h.id] ?? !1,
      required: !!(h.validation && Fm(h.validation))
    })),
    [a, o]
  ), d = U(
...
const Ps = (r, e, t) => {
  ...
  for (const t in e.fields) {
    const n = e.fields[t];
    n && n.ref && "reportValidity" in n.ref ? Ps(n.ref, t, r) : n.refs && n.refs.forEach((i) => Ps(i, t, r));
  }
}, Bm = (r, e) => {
  e.shouldUseNativeValidation && hl(r, e);
  const t = {};
  for (const n in r) {
    const i = F(e.fields, n), s = Object.assign(r[n] || {}, { ref: i && i.ref });
    if (Hm(e.names || Object.keys(r), n)) {
      const a = Object.assign({}, F(t, n));
      me(a, "root", s), me(t, n, a);
    } else me(t, n, s);
  }
  return t;
}, Hm = (r, e) => r.some((t) => t.startsWith(e + "."));
var Vm = function(r, e) {
  for (var t = {}; r.length; ) {
    ...
    if ("unionErrors" in n && n.unionErrors.forEach(function(d) {
      ...
      t[a] = Vo(a, e, t, i, c ? [].concat(c, n.message) : n.message);
    }
    r.shift();
  }
  return t;
      ...
      return Promise.resolve((function(a, o) {
        try {
          var l = Promise.resolve(r[t.mode === "sync" ? "parse" : "parseAsync"](n, e)).then(function(c) {
            return s.shouldUseNativeValidation && hl({}, s), { errors: {}, values: t.raw ? n : c };
          });
        } catch (c) {
          return o(c);
        }
        ...
        })(a)) return { values: {}, errors: Bm(Vm(a.errors, !s.shouldUseNativeValidation && s.criteriaMode === "all"), s) };
        throw a;
      }));
    } catch (a) {
...
const te = Object.freeze({
  status: "aborted"
}), Cr = (r) => ({ status: "dirty", value: r }), ct = (r) => ({ status: "valid", value: r }), Fs = (r) => r.status === "aborted", Bs = (r) => r.status === "dirty", lr = (r) => r.status === "valid", En = (r) => typeof Promise < "u" && r instanceof Promise;
var Z;
(function(r) {
...
class ue {
  ...
  "~validate"(e) {
    ...
    return this._parseAsync({ data: e, path: [], parent: t }).then((n) => lr(n) ? {
      value: n.value
    } : {
      issues: t.common.issues
    });
...
const Um = /^c[^\s-]{8,}$/i, Zm = /^[0-9a-z]+$/, qm = /^[0-9A-HJKMNP-TV-Z]{26}$/i, Km = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i, Ym = /^[a-z0-9_-]{21}$/i, Xm = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/, Jm = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/, Qm = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i, ep = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let ni;
const tp = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, rp = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/, np = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/, ip = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/, sp = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/, ap = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/, fl = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))", op = new RegExp(`^${fl}$`);
function ml(r) {
  let e = "[0-5]\\d";
...
function dp(r, e) {
  return !!((e === "v4" || !e) && tp.test(r) || (e === "v6" || !e) && np.test(r));
}
function up(r, e) {
  if (!Xm.test(r))
    return !1;
...
function hp(r, e) {
  return !!((e === "v4" || !e) && rp.test(r) || (e === "v6" || !e) && ip.test(r));
}
class Zt extends ue {
  _parse(e) {
    ...
    for (const s of this._def.checks)
      if (s.kind === "min")
        ...
        ni || (ni = new RegExp(ep, "u")), ni.test(e.data) || (i = this._getOrReturnCtx(e, i), H(i, {
          validation: "emoji",
          code: P.invalid_string,
          message: s.message
        }), n.dirty());
        ...
        Um.test(e.data) || (i = this._getOrReturnCtx(e, i), H(i, {
          validation: "cuid",
          code: P.invalid_string,
          message: s.message
        }), n.dirty());
        ...
        message: s.message
      }), n.dirty()) : s.kind === "datetime" ? cp(s).test(e.data) || (i = this._getOrReturnCtx(e, i), H(i, {
        code: P.invalid_string,
        validation: "datetime",
        message: s.message
      }), n.dirty()) : s.kind === "date" ? op.test(e.data) || (i = this._getOrReturnCtx(e, i), H(i, {
        code: P.invalid_string,
        validation: "date",
        message: s.message
      }), n.dirty()) : s.kind === "time" ? lp(s).test(e.data) || (i = this._getOrReturnCtx(e, i), H(i, {
        code: P.invalid_string,
        validation: "time",
        message: s.message
      }), n.dirty()) : s.kind === "duration" ? Jm.test(e.data) || (i = this._getOrReturnCtx(e, i), H(i, {
        validation: "duration",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "ip" ? dp(e.data, s.version) || (i = this._getOrReturnCtx(e, i), H(i, {
        validation: "ip",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "jwt" ? up(e.data, s.alg) || (i = this._getOrReturnCtx(e, i), H(i, {
        validation: "jwt",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "cidr" ? hp(e.data, s.version) || (i = this._getOrReturnCtx(e, i), H(i, {
        validation: "cidr",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "base64" ? sp.test(e.data) || (i = this._getOrReturnCtx(e, i), H(i, {
        validation: "base64",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "base64url" ? ap.test(e.data) || (i = this._getOrReturnCtx(e, i), H(i, {
...
class zr extends ue {
  ...
  _parse(e) {
    ...
    const i = new Qe();
    for (const s of this._def.checks)
      s.kind === "int" ? fe.isInteger(e.data) || (n = this._getOrReturnCtx(e, n), H(n, {
        code: P.invalid_type,
        expected: "integer",
        received: "float",
        message: s.message
        ...
        exact: !1,
        message: s.message
      }), i.dirty()) : s.kind === "multipleOf" ? fp(e.data, s.value) !== 0 && (n = this._getOrReturnCtx(e, n), H(n, {
...
class Ct extends ue {
  _parse(e) {
    ...
    if (i.minLength !== null && t.data.length < i.minLength.value && (H(t, {
      ...
      return Promise.all([...t.data].map((a, o) => i.type._parseAsync(new Ht(t, a, t.path, o)))).then((a) => Qe.mergeArray(n, a));
...
function nr(r) {
  if (r instanceof Se) {
    ...
    ...r._def,
    type: nr(r.element)
  }) : r instanceof Ft ? Ft.create(nr(r.unwrap())) : r instanceof ur ? ur.create(nr(r.unwrap())) : r instanceof Kt ? Kt.create(r.items.map((e) => nr(e))) : r;
}
class Se extends ue {
  constructor() {
  ...
  _parse(e) {
    ...
    return i.common.async ? Promise.resolve().then(async () => {
      ...
      return c;
    }).then((c) => Qe.mergeObjectSync(n, c)) : Qe.mergeObjectSync(n, l);
  }
  get shape() {
  ...
  keyof() {
    return pl(fe.objectKeys(this.shape));
  }
}
...
class Dn extends ue {
  _parse(e) {
    const { status: t, ctx: n } = this._processInputParams(e), i = (s, a) => {
      ...
      return o.valid ? ((Bs(s) || Bs(a)) && t.dirty(), { status: t.value, value: o.data }) : (H(n, {
  ...
  _parse(e) {
    ...
    if (i.type === "transform")
      if (n.common.async === !1) {
        ...
        return this._def.schema._parseAsync({ data: n.data, path: n.path, parent: n }).then((a) => lr(a) ? Promise.resolve(i.transform(a.value, s)).then((o) => ({
          status: t.value,
          value: o
        })) : te);
    fe.assertNever(i);
...
dr.create = (r, e, t) => new dr({
  schema: r,
  typeName: ne.ZodEffects,
  effect: e,
  ...ae(t)
});
dr.createWithPreprocess = (r, e, t) => new dr({
  schema: e,
...
class Ft extends ue {
  _parse(e) {
    return this._getType(e) === G.undefined ? ct(void 0) : this._def.innerType._parse(e);
  }
  unwrap() {
...
class ur extends ue {
  _parse(e) {
    return this._getType(e) === G.null ? ct(null) : this._def.innerType._parse(e);
  }
  unwrap() {
    return this._def.innerType;
  }
...
class wi extends ue {
  _parse(e) {
    const t = this._def.innerType._parse(e), n = (i) => (lr(i) && (i.value = Object.freeze(i.value)), i);
...
function Js(r) {
  return xp(r) ? "email" : wp(r) ? "url" : "text";
}
function Qs(r, e, t, n) {
  const i = {
    id: r,
  ...
  switch (n) {
    case "text": {
      const a = "inputType" in t && t.inputType ? t.inputType : Js(e);
      return {
        ...i,
        type: "text",
        inputType: a,
  ...
  for (let n = 0; n < r.length; n++) {
    ...
    if (s) {
      ...
      const o = {
        type: "row",
        fields: a.map(
          (l) => Qs(l.id, l.schema, l.config, l.fieldType)
        )
      };
      e.push(o);
    } else {
...
function Ep({
  ...
  const c = hr(), d = yl(t), u = a?.label ?? "Submit", h = a?.icon === null ? void 0 : a?.icon ?? fa, m = a?.showSubmitWhenDirty ?? !1, g = U(() => bl(c), [c]), y = _p[o], S = U(
    () => gl(t, { errorMap: g }),
    [t, g]
  ), _ = qo({
    resolver: S,
    mode: y,
    defaultValues: i
  }), R = _.formState.errors.root, { isSubmitting: D, isDirty: O } = _.formState, b = Object.keys(_.formState.errors).filter((N) => N !== "root").length > 0, k = le(
    async (N) => {
      const C = { ...N };
      ...
      A.success ? _.reset(N) : (A.errors && Object.entries(A.errors).forEach(([V, ie]) => {
        _.setError(V, { message: ie });
      }), A.rootMessage && _.setError("root", { message: A.rootMessage }));
    },
    [s, _]
  ), E = Cp(d), T = U(() => ({ formName: r }), [r]), $ = n?.title ?? e, z = n?.description;
  return /* @__PURE__ */ f(Gi.Provider, { value: T, children: /* @__PURE__ */ f(Xo, { ..._, children: /* @__PURE__ */ j(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ j(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ f(Da, { title: $, description: z ?? "" }),
              n?.action && /* @__PURE__ */ f(
                Je,
                {
        ...
        /* @__PURE__ */ f("div", { className: `flex flex-col ${Wi}`, children: E.map((N, C) => {
          switch (N.type) {
            case "switchGroup":
              return /* @__PURE__ */ f(
                Yi,
        ...
        R && /* @__PURE__ */ f("p", { className: "mt-4 text-base font-medium text-f1-foreground-critical", children: R.message }),
        (!m || O) && /* @__PURE__ */ f("div", { className: "mt-4", children: /* @__PURE__ */ f(
          Je,
          {
            type: "submit",
            label: u,
...
function Sp({ section: r }) {
  const t = $t().watch(), { formName: n } = al(), { title: i, description: s, renderIf: a, action: o, fields: l } = r.section, c = r.id;
  if (a && !$n(a, t))
    return null;
  const d = kp(l), u = qt(n, c);
  return /* @__PURE__ */ j("section", { id: u, className: "flex flex-col scroll-mt-4", children: [
    /* @__PURE__ */ j(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ f(Da, { title: i, description: s ?? "" }),
          o && /* @__PURE__ */ f(
            Je,
            {
              label: o.label,
    ...
    /* @__PURE__ */ f("div", { className: `flex flex-col ${Wi}`, children: d.map((h, m) => h.type === "switchGroup" ? /* @__PURE__ */ f(
      Yi,
      {
        fields: h.fields,
        sectionId: c
...
function Tp(r) {
  const {
    ...
    styling: c
  } = r, d = c?.showSectionsSidepanel ?? !1, u = U(() => Object.keys(t), [t]), h = le(
    (_) => {
      const R = qt(e, _), D = document.getElementById(R);
  ...
  })), [n, u, d, h]), S = /* @__PURE__ */ f("div", { className: re("flex w-full flex-col", sl, o), children: u.map((_, R) => {
    const D = t[_], O = n?.[_], b = i?.[_], k = O?.submitConfig ?? a;
    return /* @__PURE__ */ f(
      "div",
      {
        id: qt(e, _),
        className: re("scroll-mt-4", R !== 0 && il),
        children: /* @__PURE__ */ f(
          Ep,
          {
            formName: e,
  ...
  return d && y.length > 0 ? /* @__PURE__ */ j("div", { className: "flex w-full gap-4", children: [
    ...
    /* @__PURE__ */ f("div", { className: "flex flex-1 justify-center", children: S })
  ] }) : S;
}
function Op(r) {
  return Rp(r.schema) ? /* @__PURE__ */ f(
    Mp,
    {
      ...r
    }
...
function Mp(r) {
  const e = hr(), { forms: t } = e, {
    ...
    styling: u,
    formRef: h
  } = r, m = u?.showSectionsSidepanel ?? !1, g = l?.type === "action-bar", y = l?.label ?? "Submit", S = l?.icon === null ? void 0 : l?.icon ?? fa, _ = l?.type !== "action-bar" && l?.hideSubmitButton, R = !g && !_, D = l?.type === "action-bar" && l?.discardable, O = g ? l?.discardConfig : void 0, b = O?.label ?? t.actionBar.discard, k = O?.icon === null ? void 0 : O?.icon ?? Xl, E = g ? l?.actionBarLabel ?? t.actionBar.unsavedChanges : t.actionBar.unsavedChanges, T = l?.savingMessage ?? t.actionBar.saving, $ = g && !!l?.centerActionBarInFrameContent, z = yl(i, s), N = U(() => z.filter((L) => L.type === "section").map((L) => L.id), [z]), [C, A] = Q(
    N[0]
  ), V = le(
    (L) => {
      A(L);
    ...
    label: s[L]?.title ?? L,
    onClick: () => V(L)
  })), [s, N, m, V]), de = U(() => bl(e), [e]), se = Ap[d], ye = U(
    () => gl(i, { errorMap: de }),
    [i, de]
  ), X = qo({
    resolver: ye,
    mode: se,
    defaultValues: a
  }), we = X.formState.errors.root, { isDirty: Ue, isSubmitting: be, errors: ze } = X.formState, [Re, Oe] = Q("idle"), [ke, je] = Q(), pe = K(null), {
    hasErrors: _e,
    errorCount: ce,
    ...
    if (!_e)
      return Re === "loading" ? T : Re === "success" ? ke ?? t.actionBar.saved : E;
  })(), Ze = async (L) => {
    pe.current && (clearTimeout(pe.current), pe.current = null), xc(() => {
      Oe("loading");
    });
    const I = { ...L };
    for (const W of Object.keys(I))
      I[W] === null && (I[W] = void 0);
    const M = await o(I);
    M.success ? (X.reset(L), Le(), je(M.message), Oe("success"), pe.current = setTimeout(() => {
      Oe("idle"), je(void 0), pe.current = null;
    }, 3e3)) : (Oe("idle"), M.errors && Object.entries(M.errors).forEach(([W, ee]) => {
      X.setError(W, { message: ee });
    }), M.rootMessage && X.setError("root", { message: M.rootMessage }));
  };
  J(() => () => {
  ...
  const dt = () => {
    X.reset(), Le(), Oe("idle"), je(void 0), pe.current && (clearTimeout(pe.current), pe.current = null);
  }, kt = K(null);
  J(() => {
    if (h) {
      const L = {
  ...
  const p = Np(z), v = U(() => ({ formName: n }), [n]), w = /* @__PURE__ */ j(
    "form",
    {
      onSubmit: X.handleSubmit(Ze),
      className: re("flex flex-col", sl, c),
      children: [
        p.map((L, I) => {
          const M = I !== 0 && L.type !== "section" ? "mt-4" : "";
          switch (L.type) {
            case "switchGroup":
              return /* @__PURE__ */ f("div", { className: M, children: /* @__PURE__ */ f(Yi, { fields: L.fields }) }, `switch-group-${I}`);
            case "field":
              return /* @__PURE__ */ f("div", { className: M, children: /* @__PURE__ */ f(Wn, { field: L.item.field }) }, L.item.field.id);
            case "row":
              return /* @__PURE__ */ f("div", { className: M, children: /* @__PURE__ */ f(Ki, { row: L.item }) }, `row-${L.index}`);
            case "section":
              return /* @__PURE__ */ f(
                "div",
                {
                  className: I !== 0 ? il : "",
                  children: /* @__PURE__ */ f(Sp, { section: L.item })
                },
                L.item.id
              );
            default:
        ...
        we && /* @__PURE__ */ f("p", { className: "mt-4 text-base font-medium text-f1-foreground-critical", children: we.message }),
        !g && R && /* @__PURE__ */ f("div", { className: "mt-4", children: /* @__PURE__ */ f(
          Je,
          {
            type: "submit",
            label: y,
  ...
  return /* @__PURE__ */ f(Gi.Provider, { value: v, children: /* @__PURE__ */ j(Xo, { ...X, children: [
    m && ie.length > 0 ? /* @__PURE__ */ j("div", { className: "flex w-full gap-4", children: [
      /* @__PURE__ */ f("div", { className: "sticky top-4 h-fit shrink-0 self-start pt-3", children: /* @__PURE__ */ f(
        Ei,
        {
          items: ie,
      ...
      /* @__PURE__ */ f("div", { className: "w-px bg-f1-border-secondary" }),
      /* @__PURE__ */ f("div", { className: "flex flex-1 justify-center", children: w })
    ] }) : w,
    /* @__PURE__ */ f(
      um,
      {
...
const Ig = at("F0Form", Op), xl = Ge((r, e) => /* @__PURE__ */ f(Ni, { ref: e, variant: "heading", ...r }));
xl.displayName = "F0Heading";
const Pg = he(xl), zg = he(ld), Fg = he(
  at(
    "F0GridStack",
    Di
  )
...
function Hp({
  ...
  return /* @__PURE__ */ j(
    cd,
    {
      ...
      closeDelay: zp,
      children: [
        /* @__PURE__ */ f(dd, { asChild: !0, children: /* @__PURE__ */ f(
          "button",
          {
            className: re(
              oa(),
...
), Vp = ({ benefits: r }) => /* @__PURE__ */ f("div", { className: "flex flex-col gap-2", children: r.map((e, t) => /* @__PURE__ */ f(jp, { text: e }, t)) }), jp = ({ text: r }) => /* @__PURE__ */ j("div", { className: "flex flex-row items-start gap-2", children: [
  /* @__PURE__ */ f(An, { icon: Ql, size: "md", className: "text-f1-icon-positive" }),
          ...
          /* @__PURE__ */ j("div", { className: "flex flex-col gap-5", children: [
            /* @__PURE__ */ j("div", { className: "flex flex-col gap-2", children: [
              ...
              (o || l) && /* @__PURE__ */ j("div", { className: "flex justify-start gap-2", children: [
                o && /* @__PURE__ */ f(Jl, { icon: o.icon, text: o.label }),
                l && /* @__PURE__ */ f(
                  hd,
                  {
...
_l.displayName = "ProductBlankslate";
const $p = he(_l);
function Wp({
  isOpen: r,
  onClose: e,
  ...
  return J(() => {
    o(r);
  }, [r]), /* @__PURE__ */ f(ec, { open: a, onOpenChange: (c) => {
    o(c), c || e();
    ...
    tc,
    {
      ...
      children: [
        /* @__PURE__ */ j("div", { className: "flex flex-row items-center justify-between px-4 py-4", children: [
          /* @__PURE__ */ j(rc, { className: "flex flex-row items-center gap-2 text-lg font-semibold text-f1-foreground", children: [
            i && /* @__PURE__ */ f(ma, { module: i, size: "lg" }),
            t
          ] }),
          /* @__PURE__ */ f(
            Ci,
        ...
        /* @__PURE__ */ j(ca, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[512px] flex-col", children: [
          n,
          /* @__PURE__ */ f(
            da,
            {
...
function Up({
  ...
  return /* @__PURE__ */ f(Hr, { children: c ? null : /* @__PURE__ */ j(nc, { style: { width: s }, className: "relative bg-f1-background p-1", children: [
    /* @__PURE__ */ j(ic, { children: [
      ...
      /* @__PURE__ */ j("div", { children: [
        ...
        /* @__PURE__ */ j("div", { className: "flex flex-col gap-[2px] p-3", children: [
          /* @__PURE__ */ f(Cn, { className: "text-lg font-medium", children: e }),
          /* @__PURE__ */ f(Cn, { className: "line-clamp-3 text-base font-normal text-f1-foreground-secondary", children: t })
        ] })
      ] })
    ] }),
    o && /* @__PURE__ */ f(sc, { className: "p-3", children: o.map(
...
Cl.displayName = "UpsellingBanner";
const Vg = he(Cl);
function qp({
  isOpen: r,
  setIsOpen: e,
  ...
  return /* @__PURE__ */ j(Hr, { children: [
    /* @__PURE__ */ j(sa, { open: z, onOpenChange: E, children: [
    ...
    b?.type === "upsell" && b.showConfirmation && D && /* @__PURE__ */ f(
      Na,
      {
        open: !0,
        onClose: $,
...
const jg = he(qp), Kp = Et(
  null
), Yp = ({ children: r, fullScreen: e = !0 }) => {
  const t = K(null), [n, i] = Q(t.current);
  return fc(() => {
    i(t.current);
  }, []), /* @__PURE__ */ f(Kp.Provider, { value: { element: n }, children: /* @__PURE__ */ f(
    "div",
    {
      ref: t,
      id: "f0-layout",
  ...
  children: r
}) => /* @__PURE__ */ f(gd, { reducedMotion: "user", children: r }), $g = ({
  children: r,
  layout: e,
  link: t,
...
}) => /* @__PURE__ */ f(Xp, { children: /* @__PURE__ */ f(
  oc,
  {
    isDev: o,
    showExperimentalWarnings: c,
    renderDataTestIdAttribute: d,
    children: /* @__PURE__ */ f(lc, { ...a, children: /* @__PURE__ */ f(cc, { ...s, children: /* @__PURE__ */ f(dc, { ...t, children: /* @__PURE__ */ f(Yp, { ...e, children: /* @__PURE__ */ f(uc, { children: /* @__PURE__ */ f(
      md,
      {
        initiallyEnabled: n,
        children: /* @__PURE__ */ f(hc, { ...i, children: /* @__PURE__ */ f(
          pd,
          {
            handler: l,
            children: r
...
) }), ta = (r) => `datacollection-${r}`, Wg = {
  get: async (r) => JSON.parse(
    localStorage.getItem(ta(r)) ?? "{}"
  ),
  set: async (r, e) => {
    localStorage.setItem(ta(r), JSON.stringify(e));
  }
};
export {
  Zg as A,
  Ry as AiChatTranslationsProvider,
  cg as AreaChart,
  qg as Await,
  dg as BarChart,
  Kg as Blockquote,
  ...
  Qg as F0ActionItem,
  ev as F0AiChat,
  tv as F0AiChatProvider,
  rv as F0AiChatTextArea,
  nv as F0AiCollapsibleMessage,
  iv as F0AiFullscreenChat,
  Rg as F0Alert,
  Ay as F0AuraVoiceAnimation,
  sv as F0Avatar,
  nd as F0AvatarAlert,
  av as F0AvatarCompany,
  cy as F0AvatarDate,
  ov as F0AvatarEmoji,
  lv as F0AvatarFile,
  Fl as F0AvatarIcon,
  ...
  cv as F0AvatarPerson,
  dv as F0AvatarTeam,
  vg as F0BigNumber,
  yg as F0Box,
  Je as F0Button,
  uv as F0ButtonDropdown,
  hv as F0ButtonToggle,
  uy as F0Card,
  Ul as F0Checkbox,
  Dg as F0ChipList,
  Sa as F0DatePicker,
  fv as F0Dialog,
  mv as F0DialogContext,
  pv as F0DialogProvider,
  gv as F0EventCatcherProvider,
  Ag as F0FilterPickerContent,
  Ig as F0Form,
  Fg as F0GridStack,
  Ty as F0HILActionConfirmation,
  Pg as F0Heading,
  An as F0Icon,
  Hl as F0Link,
  vv as F0MessageSources,
  yv as F0OneIcon,
  bv as F0OneSwitch,
  $g as F0Provider,
  ir as F0Select,
  Bg as F0TableOfContentPopover,
  hy as F0TagAlert,
  rd as F0TagBalance,
  fy as F0TagCompany,
  xv as F0TagDot,
  ...
  hg as LineChart,
  Av as Ol,
  Tv as OneFilterPicker,
  Ov as P,
  fg as PieChart,
  Mv as Pre,
  md as PrivacyModeProvider,
  $p as ProductBlankslate,
  vy as ProductCard,
  Hg as ProductModal,
  Zp as ProductWidget,
  ...
  Fv as Ul,
  Na as UpsellRequestResponseDialog,
  Vg as UpsellingBanner,
  Ra as UpsellingButton,
  jg as UpsellingPopover,
  mg as VerticalBarChart,
  Oy as actionItemStatuses,
  My as aiTranslations,
  ng as avatarVariants,
  Bv as buildTranslations,
  _g as buttonDropdownSizes,
  wg as buttonDropdownVariants,
  xg as buttonSizes,
  Cg as buttonToggleSizes,
  Eg as buttonToggleVariants,
  bg as buttonVariants,
  by as cardImageFits,
  xy as cardImageSizes,
  wy as createAtlaskitDriver,
  Hv as createDataSourceDefinition,
  zd as createPageLayoutBlock,
  Fd as createPageLayoutBlockGroup,
  Wg as dataCollectionLocalStorageHandler,
  Ng as datepickerSizes,
  zy as defaultTranslations,
  Vv as downloadTableAsExcel,
  $n as evaluateRenderIf,
  at as experimental,
  Tg as f0FormField,
  jv as f0MarkdownRenderers,
  qt as generateAnchorId,
  $v as getAnimationVariants,
  Wv as getDataSourcePaginationType,
  Gv as getEmojiLabel,
  Zi as getF0Config,
  Mg as getSchemaDefinition,
  Og as hasF0Config,
  hm as inferFieldType,
  Uv as isInfiniteScrollPagination,
  Zv as isPageBasedPagination,
  ve as isZodType,
  kg as linkVariants,
  qv as modules,
  Ly as oneIconSizes,
  ...
  Kv as useAiChat,
  Iy as useAiChatTranslations,
  Yv as useData,
  Xv as useDataSource,
  Jv as useDefaultCopilotActions,
  Ey as useDndEvents,
  ky as useDraggable,
  Sy as useDroppableList,
  Qv as useEmojiConfetti,
  ey as useF0Dialog,
  Lg as useF0Form,
  ty as useGroups,
  ry as useMessageSourcesAction,
  ny as useOrchestratorThinkingAction,
  Dy as usePrivacyMode,
  iy as useReducedMotion,
  yl as useSchemaDefinition,
  sy as useSelectable,
  ay as useXRay,

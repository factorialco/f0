...
import { C as xu, X as wu, D as Os, U as Su, T as ku, E as _u, S as Zo, I as ba, Y as qo, N as Cu, $ as Nu, Z as Du, a0 as Fu, H as Tu, l as Au, a1 as Eu } from "./index-Hr0E6M1j.js";
import { n as Ow, o as Lw, p as Mw, x as Pw, F as Bw, W as Vw, q as jw, Q as $w, O as zw, r as Zw, P as qw, w as Uw, y as Ww, R as Qw, v as Hw, _ as Gw, z as Kw, M as Xw, G as Yw, u as Jw } from "./index-Hr0E6M1j.js";
import { A as t0, F as n0, c as r0, d as s0, b as a0, a as i0, o as o0, u as l0 } from "./F0HILActionConfirmation-CudGQMTQ.js";
...
const gh = /* @__PURE__ */ zo(function(t) {
  ...
  const Y = ii(ie, V.draggable.measure, le), de = ii(ie ? ie.parentElement : null), De = Q({
  ...
  }), Xe = (r = Le.nodeRef.current) != null ? r : ie, it = w ? (s = Le.rect) != null ? s : Y : null, ht = !!(Le.nodeRef.current && Le.rect), y = th(ht ? null : Y), F = hl(Xe ? at(Xe) : null), E = nh(w ? Te ?? ie : null), U = ih(E), $ = vl(m, {
    transform: {
      x: L.x - y.x,
      y: L.y - y.y,
      scaleX: 1,
  ...
  }) : null, Vt = nl(Bt, "id"), [ge, Re] = ee(null), Oe = ht ? $ : vn($, Ee), Ye = Cf(Oe, (a = ge?.rect) != null ? a : null, Y), Rt = Q(null), Qa = O(
    (Ke, mt) => {
      let {
        sensor: pt,
        options: qt
      ...
      if (!yt)
        return;
      const gt = Ke.nativeEvent, It = new pt({
        active: M.current,
        activeNode: yt,
        event: gt,
        options: qt,
    ...
    const yt = pt.nativeEvent, gt = A.get(qt);
    if (
    ...
    Ke(pt, mt.options, It) === !0 && (yt.dndKit = {
      capturedBy: mt.sensor
    }, M.current = qt, Qa(pt, mt));
  }, [A, Qa]), Ha = Kf(u, ad);
  sh(u), Tt(() => {
  ...
  function ld() {
    const Ke = H?.autoScrollEnabled === !1, mt = typeof l == "object" ? l.enabled === !1 : l === !1, pt = w && !Ke && !mt;
...
const Xh = st(function({ children: t, aside: n, header: r, variant: s = "main-aside" }, a) {
  ...
  Page: Ie(dt("Page", Xh)),
  Block: Ie(dt("Block", Qr)),
  BlockContent: Ie(
    dt("BlockContent", Ju)
  ),
  Group: Ie(dt("Group", xa)),
  GroupGrid: Ie(
    dt("GroupGrid", Wr)
  ),
  GroupMasonry: Ie(
...
const vm = tn({
  ...
  ({
    ...
    const $ = H && H !== "none" || X && X !== "none" || te && te !== "none" || se && se !== "none", B = M && M !== "none" || $, ne = { sm: it, md: ht, lg: y, xl: F }, he = bm.map((Ee) => {
      const ke = ne[Ee];
      return ke ? gm(Ee, ke) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ c(
                ...
                children: [
                  ...
                  /* @__PURE__ */ D(ha, { align: "center", className: "w-80", children: [
                    !g && /* @__PURE__ */ D(Ge, { children: [
                      /* @__PURE__ */ c(ut, { onClick: P, children: /* @__PURE__ */ D("div", { className: "flex w-full flex-row items-center gap-2", children: [
                        /* @__PURE__ */ c(Me, { icon: ma, color: "default" }),
...
function Jy({
  ...
  const { t: p } = Ne(), v = l === "fullscreen", k = l === "fullscreen" ? "center" : l, [_, w] = ee(v), { formRef: C, submit: A, isSubmitting: L, hasErrors: P } = ls(), T = Q({}), R = z(
    ...
    onClick: Y,
    icon: No
  } : void 0 : void 0, Le = n === "all-questions" && M && !m, Xe = X && M && !m, it = X && !!N.currentQuestion?.sectionTitle && !m, ht = !M && !m || X, y = ce === "center" || ce === "fullscreen";
  return /* @__PURE__ */ c(
    Do,
    {
      isOpen: i,

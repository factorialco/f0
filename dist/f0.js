...
const To = (n, e, t) => f("div", {
  ...
  }), [l, u] = B(d(n, e)), h = L(e), g = L(n), _ = L(!1), b = L(/* @__PURE__ */ new Map()), x = L(n);
  x.current = n;
  const D = L(s), N = H(() => {
...
function Za(n, e) {
  e === void 0 && (e = tt);
  const [t] = n, i = br(t ? Z(t) : null), [r, s] = B(vn);
  function o() {
...
const ll = /* @__PURE__ */ uo(function(e) {
  ...
  }, [m, C]), F = L(null), [Q, ee] = B(null), [K, ue] = B(null), $ = vt(_, Object.values(_)), he = Ct("DndDescribedBy", o), Dt = H(() => A.getEnabled(), [A]), te = ol(h), {
    droppableRects: Ee,
...
const Tl = (n) => {
  ...
  duration: 200,
  easing: "ease"
}, Nr = "transform", Ml = /* @__PURE__ */ Be.Transition.toString({
  property: Nr,
  duration: 0,
  easing: "linear"
}), Ll = {
...
function Hl(n) {
  ...
  const {
    ...
    useDragOverlay: D,
    strategy: N
  } = _e(Sr), w = Bl(i, g), R = l.indexOf(o), v = H(() => ({
    sortable: {
      containerId: u,
      index: R,
      items: l
  ...
  }), Dt = Vo(A, Q), te = !!C, Ee = te && !_ && Tt(h) && Tt(x), Fe = !D && K, it = Fe && Ee ? he : null, Rt = Ee ? it ?? (a ?? N)({
    rects: b,
    activeNodeRect: O,
    activeIndex: h,
    overIndex: x,
...
const Fl = [W.Down, W.Right, W.Up, W.Left], Wl = (n, e) => {
  let {
    context: {
      active: t,
      collisionRect: i,
...
const xn = ({ id: n, children: e }) => {
  ...
  const [o, a] = B(null), c = ca(an(Hi), an(Li, {
    coordinateGetter: Wl
  })), d = (u) => {
    a(u.active.id);
  }, l = (u) => {
...
export {
  ...
  Ud as createAtlaskitDriver,
  jd as createDataSourceDefinition,
  ...
  iu as useDndEvents,
  nu as useDraggable,
  ru as useDroppableList,
  su as useEmojiConfetti,
  ou as useGroups,
  au as usePrivacyMode,
  lu as useReducedMotion,
  cu as useSelectable,
  du as useXRay
};

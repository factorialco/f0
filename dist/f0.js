import { S as xe, a as mt, f as ne, L as K, b as ht, A as vt, i as J, c as yt, d as De, E as bt, g as X, e as gt, h as xt, C as wt, j as St, k as $, l as Fe, u as Pt, G as Ct, m as Nt, n as we, o as At, p as Ie, q as Ot, B as Ee, X as _e, Y as le, r as kt, s as je, t as Lt, v as Tt, w as Dt, x as Ft, y as It, z as Et, D as _t, F as jt, H as Se, I as $t, J as q, K as oe, M as Bt, N as Mt, O as Rt, P as $e, Q as _, R as I, T as zt, U as Kt, V as qt, W as Wt, Z as Gt, _ as Vt, $ as Ht, a0 as Be, a1 as Yt, a2 as Z, a3 as Me, a4 as Re, a5 as Ut, a6 as ze, a7 as Ke, a8 as qe, a9 as We, aa as Jt, ab as Ge, ac as Xt, ad as Zt, ae as Qt, af as Pe, ag as se, ah as ea, ai as ta, aj as Ve, ak as aa, al as ra, am as He, an as na, ao as oa, ap as sa, aq as ia, ar as la, as as ca, at as ua, au as da, av as Ye, aw as M, ax as Ue, ay as fa, az as pa, aA as Ce, aB as ma, aC as Je, aD as ha, aE as va, aF as ya, aG as ba, aH as ga, aI as xa, aJ as wa, aK as Sa, aL as Pa, aM as Ca, aN as Na, aO as Aa } from "./hooks-DuOfaIFi.js";
import { bp as tn, br as an, bA as rn, aP as nn, aQ as on, aR as sn, aS as ln, aT as cn, aU as un, aV as dn, aW as fn, aY as pn, aZ as mn, a_ as hn, a$ as vn, b0 as yn, b1 as bn, bw as gn, b3 as xn, b5 as wn, b6 as Sn, b7 as Pn, b8 as Cn, bb as Nn, bc as An, bd as On, bf as kn, b4 as Ln, be as Tn, ba as Dn, bx as Fn, bq as In, bk as En, bn as _n, bj as jn, bB as $n, bi as Bn, bh as Mn, aX as Rn, b2 as zn, b9 as Kn, bg as qn, bl as Wn, bs as Gn, bt as Vn, bu as Hn, bC as Yn, bm as Un, bv as Jn, bz as Xn, bo as Zn, by as Qn } from "./hooks-DuOfaIFi.js";
import { jsx as n, jsxs as C, Fragment as ae } from "react/jsx-runtime";
import * as fe from "react";
import k, { PureComponent as Oa, useState as T, forwardRef as V, useEffect as B, useMemo as ie, useCallback as Ne, useRef as pe, useImperativeHandle as ka, Children as La, createContext as Ta } from "react";
const Ar = {
  approvals: {
  ...
  return Ya(t, e), Wa(t, [{
    ...
    value: function() {
      ...
      return /* @__PURE__ */ k.createElement(vt, {
        ...
        var u = h.t, g = i.map(function(N, A) {
          var O = f && f[A];
          if (O) {
    ...
    value: function() {
      ...
      if (o || !i || !i.length)
        return null;
      var A = this.state.isAnimationFinished, O = St("recharts-scatter", d), x = s && s.allowDataOverflow, b = m && m.allowDataOverflow, w = x || b, S = $(g) ? this.id : g;
      ...
      }, this.renderSymbols()), (!N || A) && Fe.renderCallByParent(this.props, i));
    }
  }], [{
...
const Xa = (e) => {
  ...
  var v, L, D, E;
  const N = Lt(t), A = c != null && c.categories ? Array.isArray(c.categories) ? c.categories : [c.categories] : [], O = f != null && f.categories ? Array.isArray(f.categories) ? f.categories : [f.categories] : [], x = h != null && h.categories ? Array.isArray(h.categories) ? h.categories : [h.categories] : [], b = [...A, ...O, ...x], w = Math.max(...N.flatMap((p) => b.map((P) => Tt(a != null && a.tickFormatter ? a.tickFormatter(`${p[P]}`) : `${p[P]}`)))), S = [c, f, h].filter((p) => (p == null ? void 0 : p.axisPosition) === "left"), y = [c, f, h].filter((p) => (p == null ? void 0 : p.axisPosition) === "right");
  return n(Dt, {
    config: e,
    ref: g,
    aspect: d,
    children: C(Ja, {
      ...
      children: [!i && n(Ft, {
        ...
        dataKey: String(p),
        stroke: e[p].color ? q(e[p].color) : oe(A.length + P),
        strokeWidth: 2,
        ...
        dataKey: String(p),
        fill: e[p].color ? q(e[p].color) : oe(A.length + O.length + P),
        r: 4,
        isAnimationActive: !1,
...
function cr({ onChange: e, value: t, presets: r = [], granularities: a = ["day"], minDate: o, maxDate: i, open: l = !1, ...d }) {
  ...
  }, [g]), A = ie(() => g(s == null ? void 0 : s.granularity), [s == null ? void 0 : s.granularity, g]);
  B(() => {
    const y = N(t);
    se(s, y) || m(y);
  }, [t]);
...
function Ur({ isOpen: e, onClose: t, title: r, image: a, benefits: o, errorMessage: i, successMessage: l, loadingState: d, nextSteps: s, closeLabel: m, primaryAction: c, modalTitle: f, modalModule: h, secondaryAction: u, portalContainer: g, tag: N, promoTag: A, showResponseDialog: O = !0 }) {
...
function Jr({ isOpen: e, setIsOpen: t, label: r, variant: a = "promote", size: o = "md", showIcon: i = !0, side: l = "right", align: d = "center", icon: s = va, mediaUrl: m, title: c, description: f, width: h = "300px", trackVisibility: u, actions: g, onClick: N, hideLabel: A = !1 }) {

import { C as g, L as ge, c as ve, P as G, a as b, f as be, g as A, A as xe, B as Ce, b as ye, d as we, e as Ne, V as Pe, h as M, i as H, j as U, k as Le, l as J, S as Y, m as X, n as Se, O as Fe, o as K, p as ke, q as De, F as Q, r as Me, s as Te, t as Ie, D as Re, u as Be, v as Oe, w as $e, x as Z, y as w, U as ee, z as Ee, E as _e, G as z, H as je, I as ae, J as Ae, K as ze, M as Ve, N as qe, Q as We, R as Ge, X as He, T as Ue, W as Je, Y as Ye, Z as Xe, _ as Ke } from "./hooks-BlVC9KtT.js";
import { aD as Ja, $ as Ya, aF as Xa, aO as Ka, a0 as Qa, a1 as Za, a2 as es, a3 as as, a4 as ss, a5 as rs, a6 as ts, a7 as ls, a9 as os, aa as ns, ab as is, ac as ds, aK as cs, ae as us, af as fs, ag as ms, ah as hs, ak as ps, al as gs, am as vs, an as bs, ap as xs, ad as Cs, ao as ys, aj as ws, aL as Ns, aE as Ps, ar as Ls, au as Ss, aw as Fs, aP as ks, ax as Ds, aB as Ms, aA as Ts, ay as Is, az as Rs, aC as Bs, a8 as Os, ai as $s, aq as Es, as as _s, aG as js, aH as As, aI as zs, aQ as Vs, at as qs, aJ as Ws, aN as Gs, av as Hs, aM as Us } from "./hooks-BlVC9KtT.js";
import { jsx as e, jsxs as c, Fragment as $ } from "react/jsx-runtime";
import * as E from "react";
import Qe, { useState as v, forwardRef as I, useRef as se, useImperativeHandle as Ze, Children as ea, useEffect as re, createContext as aa } from "react";
const Fa = {
  approvals: {
...
var _ = "Progress", j = 100, [sa, Ma] = ve(_), [ra, ta] = sa(_), te = E.forwardRef(
  (a, s) => {
    const {
      __scopeProgress: r,
      value: l = null,
    ...
    return /* @__PURE__ */ e(ra, { scope: r, value: o, max: d, children: /* @__PURE__ */ e(
      G.div,
      {
        "aria-valuemax": d,
        "aria-valuemin": 0,
...
var le = "ProgressIndicator", oe = E.forwardRef(
  (a, s) => {
    const { __scopeProgress: r, ...l } = a, t = ta(le, r);
    return /* @__PURE__ */ e(
      G.div,
      {
...
var ie = te, ia = oe;
const de = E.forwardRef(({ className: a, value: s, ...r }, l) => e(ie, {
  ref: l,
...
const da = ({ value: a, max: s = 100, label: r, color: l }, t) => {
  const i = l ? A(l) : A("categorical-1"), n = a / s * 100;
  return c("div", {
...
const ce = ({ chips: a, max: s = 4, remainingCount: r, layout: l = "compact" }) => {
  if (l === "fill")
    return e(Fe, {
      items: a,
...
const _a = Se("F0ChipList", ce), ua = {
  ...
  md: 2,
  lg: 2
}, fa = I(function({ widgets: s, children: r }, l) {
  const t = se(null);
  Ze(l, () => t.current);
  const i = ea.toArray(s).filter((n) => !!n).map((n, d) => e("div", {
...
}), ma = I(function({ children: s, sideContent: r, mainColumnPosition: l = "left", sticky: t = !1 }, i) {
  return e("div", {
    ref: i,
    className: "h-full",
    children: c("div", {
...
}), ha = ({ children: a, className: s }) => e("aside", {
...
}), ue = Qe.forwardRef(({ children: a, variant: s, className: r, ...l }, t) => e(K, {
  layout: "standard",
  children: e("section", {
    ref: t,
...
}), fe = I(({ title: a, image: s, benefits: r, actions: l, withShadow: t = !0, module: i, moduleName: n, tag: d }, o) => c("div", {
  ref: o,
...
function ba({ isOpen: a, onClose: s, title: r, children: l, module: t, portalContainer: i }) {
  const [n, d] = v(a);
  return re(() => {
    d(a);
  }, [a]), e(Re, {
...
function Va({ isOpen: a, onClose: s, title: r, image: l, benefits: t, errorMessage: i, successMessage: n, loadingState: d, nextSteps: o, closeLabel: f, primaryAction: m, modalTitle: N, modalModule: P, secondaryAction: u, portalContainer: x, tag: S }) {
...
function xa({ mediaUrl: a, title: s, description: r, onClose: l, dismissible: t, width: i, trackVisibility: n, actions: d, showConfirmation: o = !0 }) {
  const [f, m] = v(!1), N = () => {
    m(!0), l && l();
  };
  re(() => {
...
const Ca = I(function({ primaryAction: s, secondaryAction: r, ...l }, t) {
...
function qa({ isOpen: a, setIsOpen: s, label: r, variant: l = "promote", size: t = "md", showIcon: i = !0, side: n = "right", align: d = "center", icon: o = ze, mediaUrl: f, title: m, description: N, width: P = "300px", trackVisibility: u, actions: x, onClick: S, hideLabel: R = !1 }) {
...
const ya = aa(null), wa = ({ children: a, fullScreen: s = !0 }) => {
  const r = se(null), [l, t] = v(r.current);
  return Ke(() => {
    t(r.current);
  }, []), e(ya.Provider, {
    value: {
  ...
  reducedMotion: "user",
  children: a
}), Wa = ({ children: a, layout: s, link: r, privacyModeInitiallyEnabled: l, image: t, i18n: i, l10n: n, isDev: d = !1, dataCollectionStorageHandler: o, showExperimentalWarnings: f = !1 }) => e(Na, {
  children: e(Ve, {
    isDev: d,
...
export {
  ...
  Ps as createAtlaskitDriver,
  Ls as createDataSourceDefinition,
  ...
  ks as getEmojiLabel,
  Ds as getPaginationType,
  Ms as isAccumulativePagination,
  Ts as isInfiniteScrollPagination,
  Is as isNotPaginatedResponse,
  Rs as isPagesPagination,
  Bs as isPaginatedPagination,
  Os as modules,
  $s as tagDotColors,
  Es as useData,
  _s as useDataSource,
  js as useDndEvents,
  As as useDraggable,
  zs as useDroppableList,
  Vs as useEmojiConfetti,
  qs as useGroups,
  Ws as usePrivacyMode,

import { y as G, z as ye, D as $, G as $e, J as Sn, K as Ni, M as Ai, N as Qr, Q as es, R as Rn, V as Ce, W as Nn, X as An, Y as ts, Z as is, _ as ns, $ as rs, a0 as ge, a1 as ss, a2 as os, a3 as On, a4 as as, a5 as kn, a6 as Tn, a7 as zn, a8 as Pn, a9 as Mn, aa as It, ab as Ln, ac as ls, ad as cs, ae as ds, af as us, ag as hs, w as Ge, ah as Zi, ai as fs, aj as gs, ak as ps, al as ms, am as In, an as vs, ao as ys, ap as bs, aq as xs, ar as ws, as as Hn, at as Cs, au as _s, av as Es, aw as Ds, ax as Ss, ay as Rs, az as Ns, aA as As } from "./F0AiChat-Cdk-JKhj.js";
import { A as Kd, aR as Xd, B as Yd, C as qd, E as Jd, b4 as Zd, g as Qd, F as eu, a as tu, v as iu, h as nu, b as ru, aB as su, aC as ou, aD as au, aE as lu, aG as cu, aH as du, aI as uu, aJ as hu, aK as fu, aL as gu, aM as pu, aN as mu, b0 as vu, q as yu, r as bu, s as xu, aP as wu, t as Cu, c as _u, aS as Eu, l as Du, m as Su, n as Ru, H as Nu, I as Au, L as Ou, O as ku, aQ as Tu, o as zu, P as Pu, S as Mu, T as Lu, j as Iu, k as Hu, U as Fu, b1 as Bu, aX as Wu, p as Gu, i as $u, a_ as Uu, aW as ju, b5 as Vu, aV as Ku, aU as Xu, aF as Yu, u as qu, aT as Ju, aY as Zu, d as Qu, b6 as eh, aO as th, aZ as ih, f as nh, e as rh, b3 as sh, a$ as oh, b2 as ah } from "./F0AiChat-Cdk-JKhj.js";
import { jsx as f, jsxs as T, Fragment as Zt } from "react/jsx-runtime";
import L, { forwardRef as ae, useRef as M, useImperativeHandle as Os, Children as Ht, createContext as Oe, useContext as Ee, useState as F, useMemo as H, useEffect as I, useCallback as V, useLayoutEffect as xi, createElement as Qi, isValidElement as Fn, Fragment as ks, memo as Ts, useReducer as zs, cloneElement as Ps, PureComponent as Ms } from "react";
import { createPortal as Bn, unstable_batchedUpdates as kt } from "react-dom";
import { L as Wn, C as Ls, i as Gn, D as Is, S as en, a as Hs, f as hi, b as dt, c as Fs, A as Bs, d as Tt, e as $n, E as Ws, g as Mt, h as Gs, j as $s, k as Us, l as qe, m as Un, u as js, G as Vs, n as Ks, o as tn, p as Xs, q as jn, r as Ys, B as Vn, X as Kn, Y as wi, s as qs, t as Xn, v as Js, w as Zs, x as Qs, y as eo, z as to, F as io, H as no, I as ro, J as nn, K as so, M as ut, N as fi, O as oo, P as ao, Q as lo, R as co, T as uo, U as ho, V as fo, W as go, Z as po, _ as mo, $ as vo, a0 as rn, a1 as yo, a2 as bo, a3 as xo, a4 as wo, a5 as Co, a6 as Yn, a7 as _o, a8 as Eo, a9 as sn, aa as Do, ab as qn, ac as So, ad as Ro, ae as No, af as Ao } from "./DataCollectionStorageProvider-DTlqmdJN.js";
import { ax as ch, ag as dh, ah as uh, ak as hh, al as fh, ao as gh, ap as ph, aq as mh, ar as vh, at as yh, au as bh, av as xh, as as wh, ai as Ch, aj as _h, aw as Eh, am as Dh, an as Sh, ay as Rh, az as Nh, aA as Ah, aB as Oh } from "./DataCollectionStorageProvider-DTlqmdJN.js";
import { A as Th, F as zh, b as Ph, a as Mh, o as Lh, u as Ih } from "./F0HILActionConfirmation-CrongceJ.js";
import { defaultTranslations as Fh } from "./i18n-provider-defaults.js";
import './f0.css';const Oo = {
  ...
  const r = M(null);
  Os(i, () => r.current);
  const s = Ht.toArray(e).filter((o) => !!o).map((o, a) => /* @__PURE__ */ f("div", { className: "h-full @5xl:h-auto [&>div]:h-full", children: o }, a));
  return /* @__PURE__ */ f(Wn, { layout: "home", children: /* @__PURE__ */ T("div", { ref: r, className: "@container", children: [
    /* @__PURE__ */ T("div", { className: "flex flex-col gap-6 px-5 pt-4 @md:pt-2 @5xl:hidden", children: [
      /* @__PURE__ */ f(Ls, { columns: Oo, showArrows: !1, children: s }),
...
}), Jn = L.forwardRef(({ children: n, variant: e, className: t, ...i }, r) => /* @__PURE__ */ f(Wn, { layout: "standard", children: /* @__PURE__ */ f(
  "section",
  {
    ref: r,
    className: $("relative flex-1 overflow-auto", t),
    ...i,
    children: /* @__PURE__ */ f("div", { className: $(To({ variant: e })), children: n })
  }
) }));
...
const zo = G(
  ...
  function({
    ...
    return /* @__PURE__ */ f("div", { ref: s, className: "h-full", children: /* @__PURE__ */ T(
      "div",
      {
        className: $(
...
function Bo({
  ...
  Sn(() => {
    ...
    if (!Array.isArray(w))
      return;
    const S = w.map((A) => A.id), v = r || [], y = v.map((A) => A.id), m = v.filter(
      (A) => !S.includes(A.id)
    );
    ...
    if (z.length > 0) {
      ...
      z.forEach((_) => {
        ...
        if (O.length > 0) {
          const B = {}, ee = ["w", "h", "x", "y"], te = ["noMove", "noResize", "locked"], K = O.filter(
            (j) => ee.includes(j)
          ), he = O.filter(
            (j) => te.includes(j)
          );
    ...
    if (Array.isArray(w)) {
      const S = w.map((v) => {
        ...
        return {
          ...
          content: m ?? /* @__PURE__ */ f("div", { children: "No content" })
        };
      }).filter((v) => v !== null);
      i?.(S);
    }
...
const Go = Oe(null);
function $o() {
  const { _reactContentMap: n } = Qn(), { getWidgetContainer: e } = Wo();
  return /* @__PURE__ */ f(Zt, { children: Array.from(n.value.entries()).map(([t, i]) => {
    const r = e(t);
    return r ? /* @__PURE__ */ f(Go.Provider, { value: { widget: { id: t } }, children: i && Bn(i, r) }, t) : (console.error(`Widget container not found for widget ${t}`), null);
  }) });
}
...
class yt extends Oi {
  ...
  _mouseDown(e) {
    if (!P.mouseHandled)
      return e.button !== 0 || !this.dragEls.find((t) => t === e.target) && e.target.closest(jo) || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e, delete this.dragging, delete P.dragElement, delete P.dropElement, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), pe && (e.currentTarget.addEventListener("touchmove", Wt), e.currentTarget.addEventListener("touchend", Gt)), e.preventDefault(), document.activeElement && document.activeElement.blur(), P.mouseHandled = !0), !0;
  }
...
class ki {
  ...
  setupDroppable(e) {
    return this.ddDroppable ? this.ddDroppable.updateOption(e) : this.ddDroppable = new Vo(this.el, e), this;
  }
  cleanDroppable() {
...
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.`)), i;
  ...
  commit() {
    return Uo(this, this.batchUpdate(!1), "commit", "batchUpdate", "5.2"), this;
  }
}
k.renderCB = (n, e) => {
...
function Xo({ children: n }) {
  const {
    ...
    options: i
  } = Qn(), r = M(/* @__PURE__ */ new Map()), s = M(null), o = M(i), a = V(
    (l, u) => {
      if (u.id && u.grid) {
        let h = zt.get(u.grid);
  ...
  return xi(() => {
    ...
    er.Provider,
    {
      ...
      children: /* @__PURE__ */ f("div", { ref: s, children: e ? n : null })
    }
  );
}
const Ti = ({
  ...
  return /* @__PURE__ */ f(
    Bo,
    {
      ...
      onResizeStop: (c, d) => {
        ...
        (l.w !== h.w || l.h !== h.h) && l.grid?.update(d, { w: h.w, h: h.h });
      },
      onChange: t,
      children: /* @__PURE__ */ f(Xo, { children: /* @__PURE__ */ f($o, {}) })
    }
  );
};
Ti.displayName = "F0GridStack";
const Yo = (n, e, t) => /* @__PURE__ */ f("div", { children: n }), ei = ({
  widgets: n = [],
  editMode: e = !1,
  onChange: t = () => {
  },
  ...
  const o = V(
    ...
    d(n, e)
  ), h = M(e), g = M(n), C = M(!1), b = M(/* @__PURE__ */ new Map()), x = M(n);
  x.current = n;
  const D = M(s), N = H(() => {
    ...
    [t]
  ), S = (v, y) => !v && !y ? !1 : !v || !y || v.length !== y.length ? !0 : v.some((m, E) => m !== y[E]);
  return I(() => {
    const v = h.current !== e, y = g.current !== n, m = D.current !== s && (D.current === void 0 || s === void 0 || Object.keys(D.current).length !== Object.keys(s).length || Object.keys(s).some(
      (_) => D.current?.[_] !== s[_]
    )), E = /* @__PURE__ */ new Map();
    n.forEach((_) => {
      if (_.deps && _.deps.length > 0) {
        ...
        E.set(
          _.id,
          S(R, O)
        ), O ? b.current.set(_.id, O) : b.current.delete(_.id);
      }
    });
    ...
    v && !y && !A ? (C.current = !0, u(
      ...
      return n.map((O) => {
        const B = R.get(O.id), ee = E.get(O.id) ?? !1;
        let te;
    ...
    if (s !== void 0)
      return /* @__PURE__ */ f(
        Qr,
        {
          ...
          noTooltip: o,
          tag: l,
          className: $(gi({ variant: e, align: t }), i),
          markdown: a,
          ...c,
          children: n
        }
...
zi.displayName = "Text";
const rr = ae((n, e) => /* @__PURE__ */ f(zi, { ref: e, markdown: n.markdown ?? !0, ...n }));
  ...
  return I(() => {
    ...
    "div",
    {
      className: $(
        ...
        c && "border-f1-border-selected-bold shadow-[0_0_0_4px_hsl(var(--selected-50)/0.1)]",
              ...
              children: [
                e && /* @__PURE__ */ f(
                  "div",
                  {
                    ...
                    onMouseDown: t,
                    "data-gs-handle": "true",
                    children: /* @__PURE__ */ f(An, { icon: ts, size: "xs" })
                  }
                ),
                /* @__PURE__ */ f(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ f(ta, { variant: "label", content: n, ellipsis: !0 })
                  }
                )
              ]
            }
          ),
          /* @__PURE__ */ f(is, { children: (s || o) && b && /* @__PURE__ */ T(
            Ni.div,
            {
              className: $(
...
}, ia = () => /* @__PURE__ */ T("div", { className: "relative flex h-full w-full cursor-progress flex-col rounded-xl border border-solid border-f1-border-secondary bg-f1-background", children: [
  /* @__PURE__ */ f("div", { className: "flex h-12 w-full items-center px-4", children: /* @__PURE__ */ f(Ce, { className: "h-3 w-full max-w-16 rounded-md" }) }),
  /* @__PURE__ */ T("div", { className: "flex flex-1 items-end gap-2 px-4 pb-4", children: [
    /* @__PURE__ */ f(Ce, { className: "h-1/2 w-full rounded-sm" }),
    /* @__PURE__ */ f(Ce, { className: "h-1/3 w-full rounded-sm" }),
    /* @__PURE__ */ f(Ce, { className: "h-1/5 w-full rounded-sm" }),
    /* @__PURE__ */ f(Ce, { className: "h-1/3 w-full rounded-sm" }),
    /* @__PURE__ */ f(Ce, { className: "h-full w-full rounded-sm" }),
    /* @__PURE__ */ f(Ce, { className: "h-3/4 w-full rounded-sm" })
  ] })
] });
sr.displayName = "F0Widget";
const na = Rn(sr, ia), ra = ({
  children: n,
  title: e,
  draggable: t = !1,
  actions: i,
...
const sa = Jo("Dashboard", or), dd = G(
...
}), aa = (n) => (n || []).map((e) => e.items).reduce((e, t) => (e.length > 0 && e.push({ type: "separator" }), e.push(...t), e), []), la = (n) => {
  ...
  ({
    ...
    return /* @__PURE__ */ T(
      ...
      {
        ref: l,
        className: $(oa({ variant: e }), "relative", t),
        draggable: i,
        onDragStart: r,
        onDragEnd: s,
        onDrop: o,
        ...
        ...d,
        children: [
          g && /* @__PURE__ */ T("div", { className: "absolute right-0 top-0 flex items-center justify-end gap-2 p-4", children: [
            !!c && c,
          ...
          /* @__PURE__ */ f("div", { "data-testid": "content", children: n })
        ]
      }
    );
  }
...
const ca = ({
  ...
  if (!n) return null;
  const o = t;
  return /* @__PURE__ */ T(ti, { ...s, className: $("space-y-4", r), children: [
    ...
    /* @__PURE__ */ f("div", { className: "flex-1", children: i })
  ] });
}, da = qo(
  "BlockContent",
  ca
), ua = (n) => !Fn(n) || !n.type || typeof n.type == "string" || typeof n.type == "symbol" ? !1 : "__isPageLayoutBlock" in n.type, ha = (n) => !Fn(n) || !n.type || typeof n.type == "string" || typeof n.type == "symbol" ? !1 : "__isPageLayoutGroup" in n.type, ar = (n, e, t) => {
  const i = Ht.toArray(e);
  for (const r of i)
    t.includes("block") && ua(r) || t.includes("group") && ha(r) || console.warn(
  ...
  ({ children: n, onSort: e, ...t }, i) => {
    ...
    return I(() => {
      ...
      e?.(r);
    }, [r, e]), /* @__PURE__ */ f("div", { ref: i, ...t, children: r.map((o, a) => /* @__PURE__ */ f(ks, { children: o }, a)) });
  }
);
...
function _a() {
  const [n] = F(() => /* @__PURE__ */ new Set()), e = V((i) => (n.add(i), () => n.delete(i)), [n]);
  return [V((i) => {
    let {
      type: r,
      event: s
...
function Sa(n) {
  let {
    ...
    screenReaderInstructions: r = Ea
  } = n;
  const {
    announce: s,
    announcement: o
  } = wa(), a = Et("DndLiveRegion"), [c, d] = F(!1);
  if (I(() => {
    d(!0);
  }, []), Ca(H(() => ({
    onDragStart(u) {
    ...
    return null;
  const l = L.createElement(L.Fragment, null, L.createElement(ba, {
    id: i,
    value: r.draggable
  }), L.createElement(xa, {
    id: a,
...
const Ta = (n) => {
  ...
  for (const o of i) {
    ...
    if (c) {
      const d = dn(c), l = r.reduce((h, g, C) => h + Na(d[C], g), 0), u = Number((l / 4).toFixed(4));
      s.push({
        id: a,
        data: {
...
function si(n, e) {
  ...
  function i(r) {
    ...
    return r !== n && Ga(r, s) && t.push(r), Wa(r, s) ? t : i(r.parentNode);
  }
  return n ? i(n) : t;
}
function gr(n) {
...
const Xa = [["x", ["left", "right"], Va], ["y", ["top", "bottom"], Ka]];
class Ii {
  constructor(e, t) {
...
class Fi {
  constructor(e, t, i) {
    var r;
    i === void 0 && (i = Ya(e.event.target)), this.props = void 0, this.events = void 0, this.autoScrollEnabled = !0, this.document = void 0, this.activated = !1, this.initialCoordinates = void 0, this.timeoutId = null, this.listeners = void 0, this.documentListeners = void 0, this.windowListeners = void 0, this.props = e, this.events = t;
    const {
      event: s
    } = e, {
      target: o
  ...
  handleStart() {
    ...
    e && (this.activated = !0, this.documentListeners.add(ue.Click, qa, {
      capture: !0
...
function al(n, e) {
  ...
  const [s, o] = F(null), {
    ...
    measure: c,
    strategy: d
  } = r, l = M(n), u = x(), h = bt(u), g = V(function(D) {
    ...
    if (!D || D === pn || l.current !== n || s != null) {
      ...
      for (let w of n) {
        ...
        const S = w.node.current, v = S ? new Ii(c(S), S) : null;
...
const xl = {
  ...
  over: null,
  measureDroppableContainers: Kt
}, Dt = /* @__PURE__ */ Oe(Er), Dr = /* @__PURE__ */ Oe(xl);
function wl() {
  return {
    draggable: {
      active: null,
...
const Sl = /* @__PURE__ */ Ts(function(e) {
  var t, i, r, s;
  let {
    id: o,
    accessibility: a,
    ...
    children: d,
    sensors: l = yl,
    collisionDetection: u = Pa,
    measuring: h,
    modifiers: g,
    ...C
  } = e;
  const b = zs(Cl, void 0, wl), [x, D] = b, [N, w] = _a(), [S, v] = F(He.Uninitialized), y = S === He.Initialized, {
    draggable: {
      active: m,
      nodes: E,
      translate: z
    ...
    return m != null ? {
      ...
      data: (J = _?.data) != null ? J : bl,
      rect: R
    } : null;
  }, [m, _]), B = M(null), [ee, te] = F(null), [K, he] = F(null), j = bt(C, Object.values(C)), fe = Et("DndDescribedBy", o), Rt = H(() => A.getEnabled(), [A]), ie = El(h), {
    droppableRects: De,
    ...
    config: ie.droppable
  }), le = sl(E, m), Nt = H(() => K ? Vt(K) : null, [K]), ke = Zr(), Se = ll(le, ie.draggable.measure);
  Dl({
  ...
  const U = mn(le, ie.draggable.measure, Se), st = mn(le ? le.parentElement : null), be = M({
    activatorEvent: null,
    active: null,
    activeNode: le,
    collisionRect: null,
  ...
  }), Ue = A.getNodeFor((t = be.current.over) == null ? void 0 : t.id), Re = vl({
    measure: ie.dragOverlay.measure
  }), je = (i = Re.nodeRef.current) != null ? i : le, Ve = y ? (r = Re.rect) != null ? r : U : null, Ui = !!(Re.nodeRef.current && Re.rect), ji = ul(Ui ? null : U), ci = Cr(je ? Q(je) : null), Te = hl(y ? Ue ?? le : null), At = ml(Te), Ot = Sr(g, {
    transform: {
      x: z.x - ji.x,
      y: z.y - ji.y,
      scaleX: 1,
    ...
    windowRect: ci
  }), Vi = Nt ? Ze(Nt, z) : null, Ki = fl(Te), jr = yn(Ki), Vr = yn(Ki, [U]), Ke = Ze(Ot, jr), Xe = Ve ? Ia(Ve, Ot) : null, ot = O && Xe ? u({
    active: O,
    collisionRect: Xe,
    droppableRects: De,
    droppableContainers: Rt,
    pointerCoordinates: Vi
  }) : null, Xi = ur(ot, "id"), [ze, Yi] = F(null), Kr = Ui ? Ot : Ze(Ot, Vr), Xr = Ma(Kr, (s = ze?.rect) != null ? s : null, U), di = M(null), qi = V(
    (J, ne) => {
      let {
        sensor: re,
        options: Pe
  ...
  gl(l), me(() => {
    U && S === He.Initializing && v(He.Initialized);
  }, [U, S]), I(
    () => {
      const {
        onDragMove: J
  ...
  }, [O, le, ot, Xe, E, je, Ve, De, A, ze, Te, Ke]), il({
    ...ke,
    delta: z,
    draggingRect: Xe,
    pointerCoordinates: Vi,
  ...
  const qr = H(() => ({
    ...
    measuringScheduled: rt,
    windowRect: ci
  }), [O, le, U, K, ot, st, Re, E, A, De, ze, We, Te, At, ie, rt, ci]), Jr = H(() => ({
    activatorEvent: K,
    activators: Ji,
    active: O,
    activeNodeRect: U,
...
}), Rl = /* @__PURE__ */ Oe(null), xn = "button", Nl = "Draggable";
function Al(n) {
  let {
    id: e,
    data: t,
  ...
  const s = Et(Nl), {
    ...
    tabIndex: b = 0
  } = r ?? {}, x = c?.id === e, D = Ee(x ? ai : Rl), [N, w] = Ut(), [S, v] = Ut(), y = pl(o, e), m = bt(t);
  me(
    () => (u.set(e, {
      id: e,
      key: s,
...
const Ll = {
  position: "fixed",
  touchAction: "none"
}, Il = (n) => ri(n) ? "transform 250ms ease" : void 0, Hl = /* @__PURE__ */ ae((n, e) => {
  let {
    as: t,
    activatorEvent: i,
    adjustScale: r,
  ...
  const u = r ? d : {
    ...
    transformOrigin: r && i ? Aa(i, a) : void 0,
...
function Gl(n) {
  ...
  return ni((s, o) => {
    ...
    if (!u)
      return;
    const h = typeof e == "function" ? e : $l(e);
...
const jl = /* @__PURE__ */ L.memo((n) => {
  ...
  return L.createElement(Ml, null, L.createElement(zl, {
    animation: A
  }, u && m ? L.createElement(Hl, {
    key: m,
    id: u.id,
    ref: _,
    as: a,
...
function Yl(n) {
  ...
  } = Rr(), u = Et(Ar, t), h = a.rect !== null, g = H(() => i.map((y) => typeof y == "object" && "id" in y ? y.id : y), [i]), C = o != null, b = o ? g.indexOf(o.id) : -1, x = d ? g.indexOf(d.id) : -1, D = M(g), N = !Kl(g, D.current), w = x !== -1 && b === -1 || N, S = Xl(s);
  me(() => {
    N && C && l(g);
  }, [N, g, C, l]), I(() => {
    D.current = g;
...
const ql = (n) => {
  ...
  duration: 200,
  easing: "ease"
}, kr = "transform", Ql = /* @__PURE__ */ Be.Transition.toString({
  property: kr,
  duration: 0,
  easing: "linear"
}), ec = {
...
function ic(n) {
  ...
  const {
    ...
    useDragOverlay: D,
    strategy: N
  } = Ee(Or), w = nc(i, g), S = l.indexOf(o), v = H(() => ({
    sortable: {
      containerId: u,
      index: S,
      items: l
  ...
  }), Rt = fa(A, ee), ie = !!_, De = ie && !C && Pt(h) && Pt(x), We = !D && K, rt = We && De ? fe : null, Nt = De ? rt ?? (a ?? N)({
    rects: b,
    activeNodeRect: O,
    activeIndex: h,
    overIndex: x,
  ...
  return I(() => {
    ie && U.current.newIndex !== ke && (U.current.newIndex = ke), u !== U.current.containerId && (U.current.containerId = u), l !== U.current.items && (U.current.items = l);
  }, [ie, ke, u, l]), I(() => {
    if (Se === U.current.activeId)
      return;
    if (Se != null && U.current.activeId == null) {
      U.current.activeId = Se;
      return;
    }
    const je = setTimeout(() => {
      U.current.activeId = Se;
...
const rc = [W.Down, W.Right, W.Up, W.Left], sc = (n, e) => {
  let {
    context: {
      active: t,
      collisionRect: i,
  ...
  if (rc.includes(n.code)) {
    ...
    if (l === o?.id && d.length > 1 && (l = d[1].id), l != null) {
      ...
      if (C && g && u && h) {
        const x = si(C).some((y, m) => a[m] !== y), D = Tr(u, h), N = oc(u, h), w = x || !D ? {
          x: 0,
          y: 0
        } : {
...
const Cn = ({ id: n, children: e }) => {
  const { attributes: t, listeners: i, setNodeRef: r, transform: s, transition: o } = ic({ id: n }), a = {
  ...
  return /* @__PURE__ */ f("div", { ref: r, style: a, ...t, ...i, children: e });
}, $i = ({
  blocks: n,
  sortable: e = !1,
  onSort: t = () => {
  ...
  return /* @__PURE__ */ f("div", { className: $("flex flex-wrap items-stretch gap-4", i && "flex-1"), children: /* @__PURE__ */ T(
    Sl,
    {
      sensors: c,
      onDragStart: d,
      onDragEnd: l,
      children: [
        /* @__PURE__ */ f(Yl, { items: r, children: r.map((u) => /* @__PURE__ */ f(Cn, { id: u.id, children: u.render }, u.id)) }),
        /* @__PURE__ */ f(jl, { children: o ? /* @__PURE__ */ f(Cn, { id: o, children: r.find((u) => u.id === o)?.render }) : null })
      ]
    }
  ) });
};
...
const ac = ae(function({ children: e, aside: t, header: i, variant: r = "main-aside" }, s) {
  return process.env.NODE_ENV === "development" && ar("Page", e, ["block", "group"]), /* @__PURE__ */ f("div", { ref: s, className: "h-full", children: /* @__PURE__ */ T(
    "div",
    {
      className: $(
        "flex h-full max-w-full overflow-auto text-f1-foreground md:flex-row",
...
function dc(n, e, t) {
  return e && cc(n.prototype, e), Object.defineProperty(n, "prototype", { writable: !1 }), n;
}
function uc(n, e, t) {
  return e = qt(e), hc(n, zr() ? Reflect.construct(e, t || [], qt(n).constructor) : e.apply(n, t));
}
function hc(n, e) {
...
var li = /* @__PURE__ */ (function(n) {
  function e() {
    return lc(this, e), uc(this, e, arguments);
  }
  return gc(e, n), dc(e, [{
    key: "render",
    value: function() {
...
function bc(n) {
  var e = n.option, t = n.isActive, i = vc(n, mc);
...
function Cc(n, e, t) {
  return e = Jt(e), _c(n, Lr() ? Reflect.construct(e, t || [], Jt(n).constructor) : e.apply(n, t));
}
function _c(n, e) {
...
function Dc(n, e) {
  if (typeof e != "function" && e !== null)
    throw new TypeError("Super expression must either be null or a function");
  n.prototype = Object.create(e && e.prototype, { constructor: { value: n, writable: !0, configurable: !0 } }), Object.defineProperty(n, "prototype", { writable: !1 }), e && Si(n, e);
}
function Si(n, e) {
  return Si = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(i, r) {
    return i.__proto__ = r, i;
  }, Si(n, e);
}
function Fe(n, e, t) {
...
var St = /* @__PURE__ */ (function(n) {
  function e() {
    ...
    for (var i = arguments.length, r = new Array(i), s = 0; s < i; s++)
      r[s] = arguments[s];
    return t = Cc(this, e, [].concat(r)), Fe(t, "state", {
  ...
  return Dc(e, n), wc(e, [{
    ...
    value: function(i) {
      ...
      return i.map(function(l, u) {
        ...
        return /* @__PURE__ */ L.createElement(dt, mt({
          ...
          role: "img"
        }), /* @__PURE__ */ L.createElement(bc, mt({
          option: g,
          isActive: h,
          key: "symbol-".concat(u)
        }, C)));
    ...
    value: function() {
      ...
      return /* @__PURE__ */ L.createElement(Bs, {
        ...
        var g = h.t, C = s.map(function(b, x) {
          var D = u && u[x];
          if (D) {
            var N = Tt(D.cx, b.cx), w = Tt(D.cy, b.cy), S = Tt(D.size, b.size);
            return de(de({}, b), {}, {
              cx: N(g),
              cy: w(g),
              size: S(g)
    ...
    value: function() {
      ...
      if (o === "joint")
        ...
        var h = Gs(r), g = h.xmin, C = h.xmax, b = h.a, x = h.b, D = function(S) {
          return b * S + x;
        };
        l = [{
          x: g,
      ...
      return /* @__PURE__ */ L.isValidElement(s) ? u = /* @__PURE__ */ L.cloneElement(s, N) : $s(s) ? u = s(N) : u = /* @__PURE__ */ L.createElement(Us, mt({}, N, {
        type: a
    ...
    value: function() {
      ...
      if (r || !s || !s.length)
        return null;
      var x = this.state.isAnimationFinished, D = ss("recharts-scatter", a), N = c && c.allowDataOverflow, w = d && d.allowDataOverflow, S = N || w, v = qe(C) ? this.id : C;
      ...
      }, this.renderSymbols()), (!b || x) && Un.renderCallByParent(this.props, s));
    }
  }], [{
...
Fe(St, "getComposedData", function(n) {
...
const Nc = (n) => {
  ...
  const b = Js(e), x = l?.categories ? Array.isArray(l.categories) ? l.categories : [l.categories] : [], D = u?.categories ? Array.isArray(u.categories) ? u.categories : [u.categories] : [], N = h?.categories ? Array.isArray(h.categories) ? h.categories : [h.categories] : [], w = [
    ...x,
    ...D,
    ...N
  ], S = Math.max(
    ...b.flatMap(
      (m) => w.map(
        (E) => Zs(
          i?.tickFormatter ? i.tickFormatter(`${m[E]}`) : `${m[E]}`
        )
      )
    )
  ), v = [l, u, h].filter(
    (m) => m?.axisPosition === "left"
  ), y = [l, u, h].filter(
    (m) => m?.axisPosition === "right"
  );
  return /* @__PURE__ */ f(Qs, { config: n, ref: C, aspect: a, children: /* @__PURE__ */ T(
    Rc,
    {
      ...
      children: [
        !s && /* @__PURE__ */ f(
          ...
          {
            ...to(),
            content: /* @__PURE__ */ f(io, { yAxisFormatter: i.tickFormatter })
          }
        ),
        !o && /* @__PURE__ */ f(no, { ...ro() }),
        ...
        /* @__PURE__ */ f(
          Kn,
          {
            ...
            tick: d ? (m) => {
              ...
              return /* @__PURE__ */ T("g", { transform: `translate(${E},${z})`, children: [
                /* @__PURE__ */ f(
                  "text",
                  {
                    x: 0,
        ...
        N.map((m, E) => /* @__PURE__ */ f(
          St,
          {
            dataKey: String(m),
            fill: n[m].color ? ut(n[m].color) : fi(
              x.length + D.length + E
            ),
            r: 4,
            isAnimationActive: !1,
        ...
        c && /* @__PURE__ */ f(
          oo,
          {
            content: /* @__PURE__ */ f(ao, { nameKey: "label" }),
            align: "center",
...
}, Oc = Xn(Ac), kc = ({ value: n, max: e = 100, label: t, color: i }, r) => {
  ...
  ye({ name: "ProgressBarChart", type: "info" }, Tc)
), Cd = G(
  ye({ name: "ComboChart", type: "info" }, Oc)
), zc = (n) => typeof n == "boolean" || !n ? {
  show: !!n,
  invertStatus: !1
} : {
  show: n.show ?? !0,
  ...
  }), r = zc(e.trend), s = t(e.comparison), o = vo(
    i.numericValue,
    i.formatterOptions
  ), a = rn(s.numericValue), c = rn(i.numericValue), d = H(() => {
    if (!(!a || !r.show) && !(!a || !c))
      return (c - a) / a * 100;
  }, [c, a, r.show]);
...
}, Pc = () => /* @__PURE__ */ T("div", { className: "relative flex h-full w-full cursor-progress flex-col gap-2", children: [
  /* @__PURE__ */ f(Ce, { className: "h-3 w-full max-w-16 rounded-md" }),
  /* @__PURE__ */ T("div", { className: "flex flex-row flex-wrap items-end gap-2", children: [
    /* @__PURE__ */ f(Ce, { className: "h-8 w-full max-w-36 rounded-sm" }),
    /* @__PURE__ */ f(Ce, { className: "h-6 w-full max-w-18 rounded-sm" })
  ] })
] });
Hr.displayName = "F0BigNumber";
const Mc = Rn(Hr, Pc), _d = G(
  ge("F0BigNumber", Mc)
), Ed = os.filter(
  (n) => n !== "ai"
), Dd = On, Sd = ["default", "outline", "neutral"], Rd = On, Nd = ["sm", "md", "lg"], Ad = ["compact", "expanded"], Od = as, kd = [
  "viridian",
  "malibu",
  "yellow",
  "purple",
  ...
  const [t, i] = F(!1), r = /* @__PURE__ */ f(It, { label: `+${n}` });
  return e?.length ? /* @__PURE__ */ T(kn, { open: t, onOpenChange: i, children: [
    /* @__PURE__ */ f(Tn, { asChild: !0, children: /* @__PURE__ */ f("button", { className: zn("inline-flex flex-shrink-0 items-center"), children: r }) }),
    /* @__PURE__ */ f(
      Pn,
      {
        className: "rounded-md border border-solid border-f1-border-secondary p-1 shadow-md",
        align: "end",
        children: /* @__PURE__ */ T(Mn, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[172px] flex-col", children: [
          e.map((s, o) => /* @__PURE__ */ f(
            "div",
            {
              className: "flex w-[220px] min-w-0 items-center gap-1.5 px-2 py-1 [&:first-child]:pt-2 [&:last-child]:pb-2",
              children: /* @__PURE__ */ f(It, { ...s })
            },
            o
          )),
          /* @__PURE__ */ f(
...
const Fr = ({
  ...
  if (i === "fill")
    return /* @__PURE__ */ f(
      ...
      {
        items: n,
        renderListItem: (c) => /* @__PURE__ */ f(It, { ...c }),
        renderDropdownItem: () => null,
        forceShowingOverflowIndicator: t !== void 0,
        renderOverflowIndicator: (c) => /* @__PURE__ */ f(
          Ri,
          {
            count: (t ?? 0) + c,
...
const Td = G(
  ...
  const o = M(null);
  return /* @__PURE__ */ f("div", { ref: o, className: "@container", children: /* @__PURE__ */ f("div", { className: Lc({ variant: s }), children: /* @__PURE__ */ T(
    "div",
    {
      className: $(
      ...
      children: [
        /* @__PURE__ */ T("div", { className: "flex flex-row gap-2", children: [
          /* @__PURE__ */ f("div", { className: "h-6 w-6 flex-shrink-0", children: s === "neutral" ? /* @__PURE__ */ f(ds, { icon: r || us, size: "sm" }) : /* @__PURE__ */ f(bo, { type: s, size: "sm" }) }),
          /* @__PURE__ */ T("div", { className: "flex flex-col gap-0.5", children: [
            /* @__PURE__ */ f("p", { className: Ic({ variant: s }), children: n }),
...
function Br({
  ...
  const g = (x, D) => {
    ...
    const S = Zi(w.type);
    return Math.max(D, S?.formHeight || Fc);
  }, 0), [n, i]);
  return !n || Object.keys(n).length === 0 ? null : /* @__PURE__ */ f(
    "div",
    {
      className: $(
...
const Md = G(Br), Wr = ae((n, e) => /* @__PURE__ */ f(zi, { ref: e, variant: "heading", ...n }));
Wr.displayName = "F0Heading";
const Ld = G(Wr), Id = G(xo), Hd = G(
  ge(
    "F0GridStack",
    Ti
  )
...
function Wc(n, e) {
  ...
  if (r.add(t - 1), e) {
    ...
    if (s !== -1 && !r.has(s)) {
      const o = [...r].reduce(
        (a, c) => Math.abs(c - s) < Math.abs(a - s) ? c : a
      );
      r.delete(o), r.add(s);
    }
  }
...
function Vc({
  ...
  const [d, l] = F(!1), u = M(!1), h = (C) => {
    ...
    !C || !u.current || (u.current = !1, requestAnimationFrame(() => {
      C.querySelector("[data-active]")?.scrollIntoView({ block: "center", behavior: "smooth" });
    }));
  }, []);
  return /* @__PURE__ */ T(
    gs,
...
), Kc = ({ benefits: n }) => /* @__PURE__ */ f("div", { className: "flex flex-col gap-2", children: n.map((e, t) => /* @__PURE__ */ f(Xc, { text: e }, t)) }), Xc = ({ text: n }) => /* @__PURE__ */ T("div", { className: "flex flex-row items-start gap-2", children: [
  /* @__PURE__ */ f(An, { icon: ys, size: "md", className: "text-f1-icon-positive" }),
          ...
          /* @__PURE__ */ T("div", { className: "flex flex-col gap-5", children: [
            /* @__PURE__ */ T("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ T("div", { className: "flex flex-row items-center gap-2", children: [
                s && /* @__PURE__ */ f(In, { module: s }),
                o && /* @__PURE__ */ f("p", { className: "text-base font-medium text-f1-foreground", children: o })
              ] }),
              (a || c) && /* @__PURE__ */ T("div", { className: "flex justify-start gap-2", children: [
                a && /* @__PURE__ */ f(vs, { icon: a.icon, text: a.label }),
                c && /* @__PURE__ */ f(
                  Co,
                  {
              ...
              /* @__PURE__ */ f("h2", { className: "font-bold text-xl text-f1-foreground", children: n })
            ] }),
            /* @__PURE__ */ f(Kc, { benefits: t })
          ] }),
          i && /* @__PURE__ */ f("div", { className: "flex gap-3", children: i })
        ] })
      ]
    }
  )
...
function qc({
  ...
  return I(() => {
    a(n);
  }, [n]), /* @__PURE__ */ f(bs, { open: o, onOpenChange: (d) => {
    a(d), d || e();
    ...
    xs,
    {
      ...
      children: [
        /* @__PURE__ */ T("div", { className: "flex flex-row items-center justify-between px-4 py-4", children: [
          /* @__PURE__ */ T(ws, { className: "flex flex-row items-center gap-2 text-lg font-semibold text-f1-foreground", children: [
            r && /* @__PURE__ */ f(In, { module: r, size: "lg" }),
            t
          ] }),
          /* @__PURE__ */ f(
            Ai,
        ...
        /* @__PURE__ */ T(Mn, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[512px] flex-col", children: [
          i,
          /* @__PURE__ */ f(
            Ln,
            {
...
function Zc({
  ...
  return /* @__PURE__ */ f(Zt, { children: d ? null : /* @__PURE__ */ T(_o, { style: { width: s }, className: "relative bg-f1-background p-1", children: [
    /* @__PURE__ */ T(Eo, { children: [
      r && /* @__PURE__ */ f("div", { className: "absolute right-2 top-2 z-10", children: /* @__PURE__ */ f(
        Ge,
        {
          variant: "ghost",
          icon: Hn,
      ...
      /* @__PURE__ */ T("div", { children: [
        /* @__PURE__ */ f("div", { children: n && (h ? /* @__PURE__ */ f(
          "video",
          {
            src: n,
            autoPlay: !0,
        ...
        /* @__PURE__ */ T("div", { className: "flex flex-col gap-[2px] p-3", children: [
          /* @__PURE__ */ f(sn, { className: "text-lg font-medium", children: e }),
          /* @__PURE__ */ f(sn, { className: "line-clamp-3 text-base font-normal text-f1-foreground-secondary", children: t })
        ] })
      ] })
    ] }),
    a && /* @__PURE__ */ f(Do, { className: "p-3", children: a.map(
      (g) => g.type === "upsell" ? /* @__PURE__ */ f(
        qn,
        {
          label: g.label,
          onRequest: g.onClick,
...
const Qc = G(Zc), Ur = ae(
  function({ primaryAction: e, secondaryAction: t, ...i }, r) {
    const s = (c) => c.variant === "promote" ? /* @__PURE__ */ f(
      qn,
      {
        label: c.label,
        onRequest: async () => {
...
Ur.displayName = "UpsellingBanner";
const Wd = G(Ur);
function ed({
  isOpen: n,
  setIsOpen: e,
  ...
  return /* @__PURE__ */ T(Zt, { children: [
    /* @__PURE__ */ T(kn, { open: A, onOpenChange: m, children: [
      /* @__PURE__ */ f(Tn, { asChild: !0, children: /* @__PURE__ */ f(
        Ge,
        {
          variant: i,
          label: t,
    ...
    v?.type === "upsell" && v.showConfirmation && w && /* @__PURE__ */ f(
      Yn,
      {
        open: !0,
        onClose: z,
...
const Gd = G(ed), td = Oe(
  null
), id = ({ children: n, fullScreen: e = !0 }) => {
  const t = M(null), [i, r] = F(t.current);
  return As(() => {
    r(t.current);
  }, []), /* @__PURE__ */ f(td.Provider, { value: { element: i }, children: /* @__PURE__ */ f(
    "div",
    {
      ref: t,
      id: "f0-layout",
  ...
  children: n
}) => /* @__PURE__ */ f(Ao, { reducedMotion: "user", children: n }), $d = ({
  children: n,
  layout: e,
  link: t,
  ...
  l10n: o,
  isDev: a = !1,
  dataCollectionStorageHandler: c,
  showExperimentalWarnings: d = !1,
  renderDataTestIdAttribute: l = !1
  ...
  _s,
  {
    ...
    children: /* @__PURE__ */ f(Es, { ...o, children: /* @__PURE__ */ f(Ds, { ...s, children: /* @__PURE__ */ f(Ss, { ...t, children: /* @__PURE__ */ f(id, { ...e, children: /* @__PURE__ */ f(Rs, { children: /* @__PURE__ */ f(
      Ro,
      {
        initiallyEnabled: i,
        children: /* @__PURE__ */ f(Ns, { ...r, children: /* @__PURE__ */ f(
          No,
          {
            handler: c,
            children: n
...
export {
  Kd as A,
  Th as AiChatTranslationsProvider,
  pd as AreaChart,
  Xd as Await,
  md as BarChart,
  Yd as Blockquote,
  vd as CategoryBarChart,
  qd as ChatSpinner,
  Cd as ComboChart,
  dd as Dashboard,
  ch as DndProvider,
  ...
  Qd as F0ActionItem,
  eu as F0AiChat,
  tu as F0AiChatProvider,
  iu as F0AiChatTextArea,
  nu as F0AiCollapsibleMessage,
  ru as F0AiFullscreenChat,
  Pd as F0Alert,
  su as F0Avatar,
  bo as F0AvatarAlert,
  ou as F0AvatarCompany,
  dh as F0AvatarDate,
  au as F0AvatarEmoji,
  lu as F0AvatarFile,
  ds as F0AvatarIcon,
  ...
  cu as F0AvatarPerson,
  du as F0AvatarTeam,
  _d as F0BigNumber,
  Ge as F0Button,
  uu as F0ButtonDropdown,
  hu as F0ButtonToggle,
  hh as F0Card,
  fu as F0Checkbox,
  Td as F0ChipList,
  fh as F0DatePicker,
  gu as F0Dialog,
  pu as F0DialogContext,
  mu as F0DialogProvider,
  vu as F0EventCatcherProvider,
  Md as F0FilterPickerContent,
  Hd as F0GridStack,
  zh as F0HILActionConfirmation,
  Ld as F0Heading,
  An as F0Icon,
  hs as F0Link,
  yu as F0MessageSources,
  bu as F0OneIcon,
  xu as F0OneSwitch,
  $d as F0Provider,
  wu as F0Select,
  Fd as F0TableOfContentPopover,
  gh as F0TagAlert,
  yo as F0TagBalance,
  ph as F0TagCompany,
  mh as F0TagDot,
  ...
  ta as F0Text,
  Cu as F0Thinking,
  _u as FullscreenChatContext,
  Eu as GROUP_ID_SYMBOL,
  Du as H1,
  Su as H2,
  Ru as H3,
  gd as HomeLayout,
  ...
  yd as LineChart,
  ku as Ol,
  Tu as OneFilterPicker,
  zu as P,
  bd as PieChart,
  Pu as Pre,
  Ro as PrivacyModeProvider,
  Yc as ProductBlankslate,
  xh as ProductCard,
  Bd as ProductModal,
  Qc as ProductWidget,
  wd as ProgressBarChart,
  hd as StandardLayout,
  Mu as Strong,
  Lu as Table,
  Id as Tag,
  wh as TagCounter,
  Iu as Td,
  Hu as Th,
  fd as TwoColumnLayout,
  Fu as Ul,
  Yn as UpsellRequestResponseDialog,
  Wd as UpsellingBanner,
  qn as UpsellingButton,
  Gd as UpsellingPopover,
  xd as VerticalBarChart,
  Ph as actionItemStatuses,
  Mh as aiTranslations,
  cd as avatarVariants,
  Bu as buildTranslations,
  Rd as buttonDropdownSizes,
  Sd as buttonDropdownVariants,
  Dd as buttonSizes,
  Nd as buttonToggleSizes,
  Ad as buttonToggleVariants,
  Ed as buttonVariants,
  Ch as cardImageFits,
  _h as cardImageSizes,
  Eh as createAtlaskitDriver,
  Wu as createDataSourceDefinition,
  qo as createPageLayoutBlock,
  Jo as createPageLayoutBlockGroup,
  Ud as dataCollectionLocalStorageHandler,
  zd as datepickerSizes,
  Fh as defaultTranslations,
  Gu as downloadTableAsExcel,
  ge as experimental,
  $u as f0MarkdownRenderers,
  Uu as getAnimationVariants,
  ju as getDataSourcePaginationType,
  Vu as getEmojiLabel,
  Ku as isInfiniteScrollPagination,
  Xu as isPageBasedPagination,
  Od as linkVariants,
  Yu as modules,
  Lh as oneIconSizes,
  Dh as predefinedPresets,
  Sh as selectSizes,
  kd as tagDotColors,
  qu as useAiChat,
  Ih as useAiChatTranslations,
  Ju as useData,
  Zu as useDataSource,
  Qu as useDefaultCopilotActions,
  Rh as useDndEvents,
  Nh as useDraggable,
  Ah as useDroppableList,
  eh as useEmojiConfetti,
  th as useF0Dialog,
  ih as useGroups,
  nh as useMessageSourcesAction,
  rh as useOrchestratorThinkingAction,
  Oh as usePrivacyMode,

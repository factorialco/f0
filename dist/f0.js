...
const Bu = {
  ...
  return /* @__PURE__ */ c(ko, { layout: "home", children: /* @__PURE__ */ D("div", { ref: s, className: "@container", children: [
    /* @__PURE__ */ D("div", { className: "flex flex-col gap-6 px-5 pt-4 @md:pt-2 @5xl:hidden", children: [
      /* @__PURE__ */ c(gd, { columns: Bu, showArrows: !1, children: a }),
...
}), Yo = ce.forwardRef(({ children: e, variant: t, className: n, ...r }, s) => /* @__PURE__ */ c(ko, { layout: "standard", children: /* @__PURE__ */ c(
  "section",
  {
    ref: s,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ D("div", { className: "flex h-12 w-full items-center justify-between gap-3", children: [
          ...
          /* @__PURE__ */ c(Fd, { children: (a || i) && b && /* @__PURE__ */ D(
            Kn.div,
            {
              className: Q(
...
const sf = ({
  ...
  "BlockContent",
  sf
), of = (e) => !Go(e) || !e.type || typeof e.type == "string" || typeof e.type == "symbol" ? !1 : "__isPageLayoutBlock" in e.type, lf = (e) => !Go(e) || !e.type || typeof e.type == "string" || typeof e.type == "symbol" ? !1 : "__isPageLayoutGroup" in e.type, al = (e, t, n) => {
...
const Sm = /* @__PURE__ */ Xo(function(t) {
  var n, r, s, a;
  let {
    id: i,
    accessibility: o,
  ...
  const b = Ou(bm, void 0, vm), [p, S] = b, [g, k] = yf(), [_, y] = ee(Qt.Uninitialized), w = _ === Qt.Initialized, {
    draggable: {
      active: C,
      nodes: A,
      translate: R
...
function Tm(e) {
  ...
  }, [t, r, a]), ce.createElement(ce.Fragment, null, n, r ? Lu(r, {
    ref: i
  }) : null);
}
const Am = {
...
const Fy = [
  ...
  const n = Ed(), r = n(t.value, {
    formatterOptions: {
      decimalPlaces: 2
    }
  }), s = ah(t.trend), a = n(t.comparison), i = Id(
    r.numericValue,
    r.formatterOptions
...
const Ch = sr(
  ...
  return t?.length ? /* @__PURE__ */ D(ca, { open: n, onOpenChange: r, children: [
    /* @__PURE__ */ c(da, { asChild: !0, children: /* @__PURE__ */ c("button", { className: Gr("inline-flex flex-shrink-0 items-center"), children: s }) }),
    /* @__PURE__ */ c(
      ua,
      {
        className: "rounded-md border border-solid border-f1-border-secondary p-1 shadow-md",
        align: "end",
        children: /* @__PURE__ */ D(Do, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[172px] flex-col", children: [
...
const Fh = {
  ...
  function({
    ...
    const g = ka(), k = H(/* @__PURE__ */ new Map()), _ = H(!1), y = z(() => {
...
function Ul({
  ...
  return !e || Object.keys(e).length === 0 ? null : /* @__PURE__ */ c(jd, { dataTestId: l, children: /* @__PURE__ */ c(
    "div",
    {
      className: Q(
  ...
  ({ className: e, children: t, fallback: n, ...r }, s) => {
    ...
    return l ? /* @__PURE__ */ D(
      "div",
      {
        ...
        ...r,
        children: [
          /* @__PURE__ */ c(Le, { icon: To, color: "critical" }),
      ...
      Bs,
      {
        ...
        leftContent: s ? /* @__PURE__ */ D("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ D("div", { className: "flex items-center gap-0.5", children: [
            /* @__PURE__ */ c(Le, { icon: To, size: "md", color: "critical" }),
...
function tg({
  ...
  const { forms: a } = Ne(), i = Dc(), o = i?.useUpload ?? e.useUpload, l = s ?? i?.initialFiles, d = ka(), u = H(null), [f, h] = ee(!1), m = e.multiple ?? !1, [v, b] = ee(
    () => eg(l, t.value, m)
    ...
    Us,
    {
      ...
      render: ({ field: p, fieldState: S }) => /* @__PURE__ */ D(ja, { id: b, className: "scroll-mt-4", children: [
        ...
        (() => {
          ...
          return g ? /* @__PURE__ */ c(Ro, { ...g, variant: g.variant ?? "info" }) : null;
        })(),
        m && !S.error && /* @__PURE__ */ c(fa, { status: e.status }),
        m && /* @__PURE__ */ c(
          ls,
          {
    ...
    /* @__PURE__ */ D(
      "div",
      {
        ...
        children: [
          ...
          p.map(({ fieldId: _, props: y }) => /* @__PURE__ */ c(Ro, { ...y, variant: y.variant ?? "info" }, _))
        ]
      }
    ),
...
function Rc({
  ...
  const v = Ne(), b = Ec(n), p = i?.label ?? "Submit", S = i?.icon === null ? void 0 : i?.icon ?? Oo, g = i?.showSubmitWhenDirty ?? !1, k = i?.hideSubmitButton ?? !1, _ = z(() => Ic(v), [v]), y = wg[o], w = z(
    () => _c(n, { errorMap: _ }),
    [n, _]
  ), C = lc({
    resolver: w,
      ...
      children: [
        /* @__PURE__ */ D(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ c(wo, { title: te, description: fe ?? "" }),
              r?.action && /* @__PURE__ */ c(
                Me,
                {
  ...
  return /* @__PURE__ */ D("section", { id: h, className: "flex scroll-mt-4 flex-col", children: [
    /* @__PURE__ */ D(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ c(wo, { title: s, description: a ?? "" }),
          l && /* @__PURE__ */ c(
            Me,
            {
              label: l.label,
...
function Gc(e) {
  ...
  const se = U.formState.errors.root, { isDirty: ge, isSubmitting: ve, errors: de } = U.formState, [J, oe] = ee("idle"), [Ie, Ve] = ee(), De = H(null), Xe = H(null), {
    ...
    De.current && (clearTimeout(De.current), De.current = null), Pu(() => {
      oe("loading");
    });
    const Fe = { ...ye };
...
function rt({
  ...
  const h = ka(), m = l ?? (e.validation ? fs(e.validation) : !1), v = !u && e.type !== "checkbox" && e.type !== "custom", b = {
    value: t,
    onChange: n,
    onBlur: r ?? (() => {
    }),
...
const Gy = Oe(Kc), jv = ({
  ...
  return /* @__PURE__ */ D("div", { className: "flex flex-col gap-2 xs:flex-row xs:items-center [&>*]:w-full [&>*]:xs:w-auto", children: [
    s && /* @__PURE__ */ c(la, { items: n, size: "md" }),
    t?.map((a, i) => /* @__PURE__ */ c(
      Me,
      {
        label: a.label,
  ...
  return /* @__PURE__ */ D("div", { className: "pl-9", children: [
    t && a && /* @__PURE__ */ c("div", { className: "mb-3", children: /* @__PURE__ */ c(So, { items: t }) }),
  ...
  const { status: t, icon: n = Jd, title: r, description: s, metadata: a } = e, i = a?.some(Boolean);
  return /* @__PURE__ */ D("div", { className: "flex justify-between gap-3 w-full flex-wrap", children: [
    ...
    /* @__PURE__ */ c("div", { className: "flex justify-end items-center gap-3 pl-9", children: t === "completed" && a && i && /* @__PURE__ */ c(So, { items: a }) })
  ] });
  ...
  "in-progress": /* @__PURE__ */ c(Le, { icon: tu, size: "lg", color: "warning" }),
  "not-started": /* @__PURE__ */ c(Le, { icon: eu, size: "lg", color: "secondary" })
}, Xc = ({
  status: e,
  isLast: t,
  hideStatus: n,
...
function ed({
  ...
  return /* @__PURE__ */ D(
    ru,
    {
      ...
      closeDelay: Jv,
      children: [
        /* @__PURE__ */ c(su, { asChild: !0, children: /* @__PURE__ */ c(
          "button",
          {
            className: Q(
              Gr(),
...
const Xa = () => {
  ...
  return e || t ? null : /* @__PURE__ */ c("div", { className: "ml-6 flex justify-center", children: /* @__PURE__ */ D(ga, { open: s, onOpenChange: a, children: [
    /* @__PURE__ */ c(va, { asChild: !0, children: /* @__PURE__ */ c(
      Me,
      {
        icon: ba,
...
const io = ({
  ...
  return /* @__PURE__ */ D($n, { children: [
    /* @__PURE__ */ c(zn, { className: "mx-1 px-2 data-[state=open]:rounded-sm data-[state=closed]:bg-transparent data-[state=open]:bg-f1-background-hover", children: /* @__PURE__ */ D("div", { className: "flex w-full flex-row items-center gap-2", children: [
      /* @__PURE__ */ c(lt, { icon: Zo, color: "default" }),
...
function hb({
  ...
  return /* @__PURE__ */ D(ga, { open: e, onOpenChange: t, children: [
    /* @__PURE__ */ c(va, { tabIndex: -1, asChild: !0, children: /* @__PURE__ */ c(
      Me,
      {
        icon: _r,
    ...
    /* @__PURE__ */ D(ya, { className: "w-80", align: "start", children: [
      /* @__PURE__ */ c(lu, { className: "p-4 pb-2 font-medium text-f1-foreground-secondary", children: a("surveyFormBuilder.labels.questionOptions") }),
...
const lo = {
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      onClick: u,
      children: a ? /* @__PURE__ */ D(ca, { open: l, onOpenChange: d, children: [
        /* @__PURE__ */ c(da, { asChild: !0, children: /* @__PURE__ */ c(
          Me,
          {
            emoji: o,
            label: i.toString(),
...
const Db = {
  ...
  const { isDragging: r, setIsDragging: s, setDraggedItemId: a, draggedItemId: i } = En(), o = Sa(), { disabled: l, answering: d, getSectionContainingQuestion: u } = ze(), f = u(e.question.id), h = !!f && i === f.id, m = () => {
    s(!0), a(e.question.id);
  }, v = () => {
    s(!1), a(null);
  ...
  const { isDragging: t, setIsDragging: n, setDraggedItemId: r } = En(), s = Sa(), { disabled: a, answering: i, getSectionContainingQuestion: o } = ze(), l = o(e.id), d = () => {
    n(!0), r(e.id);
  }, u = () => {
    n(!1), r(null);
  ...
  const { isDragging: n, setIsDragging: r, setDraggedItemId: s, draggedItemId: a } = En(), i = Sa(), { disabled: o, answering: l } = ze(), d = a === e.section.id, u = () => {
    r(!0), s(e.section.id);
  }, f = () => {
    r(!1), s(null);
...
const cd = ({
  ...
  const { t: r } = Ne(), { disabled: s } = ze(), { portalContainer: a } = et(cu), i = Pb(e, {
          ...
          /* @__PURE__ */ D("div", { className: "flex flex-col gap-5", children: [
            /* @__PURE__ */ D("div", { className: "flex flex-col gap-2", children: [
              ...
              (o || l) && /* @__PURE__ */ D("div", { className: "flex justify-start gap-2", children: [
                o && /* @__PURE__ */ c(hu, { icon: o.icon, text: o.label }),
                l && /* @__PURE__ */ c(
                  Bo,
                  {
...
function cy({
  ...
  return ie(() => {
    o(e);
  }, [e]), /* @__PURE__ */ c(pu, { open: i, onOpenChange: (d) => {
    o(d), d || t();
    ...
    gu,
    {
      ...
      children: [
        /* @__PURE__ */ D("div", { className: "flex flex-row items-center justify-between px-4 py-4", children: [
          /* @__PURE__ */ D(vu, { className: "flex flex-row items-center gap-2 text-lg font-semibold text-f1-foreground", children: [
        ...
        /* @__PURE__ */ D(Do, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[512px] flex-col", children: [
          r,
          /* @__PURE__ */ c(
            Fo,
            {
...
function uy({
  ...
  return /* @__PURE__ */ c(Ke, { children: d ? null : /* @__PURE__ */ D(bu, { style: { width: a }, className: "relative bg-f1-background p-1", children: [
    /* @__PURE__ */ D(yu, { children: [
    ...
    o && /* @__PURE__ */ c(xu, { className: "p-3", children: o.map(
...
function my({
  ...
  return /* @__PURE__ */ D(Ke, { children: [
    /* @__PURE__ */ D(ca, { open: M, onOpenChange: C, children: [
      /* @__PURE__ */ c(da, { asChild: !0, children: /* @__PURE__ */ c(
        Me,
        {
          variant: r,
...
const ax = Oe(my), ix = bt(
  ...
  children: e
}) => /* @__PURE__ */ c(Au, { reducedMotion: "user", children: e }), ox = ({
  children: e,
  layout: t,
  link: n,
  ...
  ku,
  {
    ...
    children: /* @__PURE__ */ c(_u, { ...i, children: /* @__PURE__ */ c(Cu, { ...a, children: /* @__PURE__ */ c(Nu, { ...n, children: /* @__PURE__ */ c(py, { ...t, children: /* @__PURE__ */ c(Du, { children: /* @__PURE__ */ c(
      Nd,
      {
        initiallyEnabled: r,

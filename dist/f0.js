import { L as Cn, C as Wr, c as $, a as Di, u as _n, m as Ri, i as En, B as Si, O as Gr, p as $r, w as jr, S as Fe, b as Ur, F as Dn, d as Kr, A as Xr, D as Yr, e as qr, f as De, g as Vr, h as pe, j as Vi, k as Jr, l as di, n as lt, o as Zr, q as Qr, r as Ot, s as Rn, E as es, t as zt, v as ts, x as is, y as ns, z as rs, G as Xe, H as Sn, I as ss, J as os, K as as, M as Ji, N as ls, P as Nn, Q as cs, R as On, X as An, Y as vi, T as ds, U as Tn, V as us, W as hs, Z as fs, _ as gs, $ as ps, a0 as ms, a1 as vs, a2 as ys, a3 as Zi, a4 as bs, a5 as ct, a6 as ui, a7 as xs, a8 as ws, a9 as Cs, aa as _s, ab as Es, ac as Ds, ad as Rs, ae as Ss, af as Ns, ag as Os, ah as kn, ai as As, aj as Mt, ak as zn, al as Pn, am as Ts, an as Mn, ao as Ln, ap as In, aq as ks, ar as zs, as as Hn, at as Ps, au as Ms, av as Ls, aw as Is, ax as Hs, ay as Bs, az as Bn, aA as Ve, aB as Fn, aC as Fs, aD as Ws, aE as Qi, aF as Gs, aG as Wn, aH as $s, aI as js, aJ as Us, aK as Ks, aL as Xs, aM as Ys, aN as qs, aO as Vs, aP as Js, aQ as Zs, aR as Qs, aS as eo } from "./hooks-D1U1PpkP.js";
import { bl as Vc, by as Jc, bH as Zc, aT as Qc, aU as ed, aV as td, aW as id, aX as nd, aY as rd, aZ as sd, a_ as od, b0 as ad, b1 as ld, b2 as cd, b3 as dd, b4 as ud, b5 as hd, b6 as fd, bD as gd, b8 as pd, b9 as md, bc as vd, bd as yd, be as bd, bf as xd, bi as wd, bj as Cd, bk as _d, bn as Ed, bb as Dd, bm as Rd, bh as Sd, bE as Nd, bx as Od, bs as Ad, bv as Td, br as kd, bI as zd, bq as Pd, bp as Md, a$ as Ld, b7 as Id, ba as Hd, bg as Bd, bo as Fd, bt as Wd, bz as Gd, bA as $d, bB as jd, bJ as Ud, bu as Kd, bC as Xd, bG as Yd, bw as qd, bF as Vd } from "./hooks-D1U1PpkP.js";
import { jsx as g, jsxs as P, Fragment as Vt } from "react/jsx-runtime";
import M, { forwardRef as ae, useRef as L, useImperativeHandle as to, Children as Lt, createContext as Se, useContext as xe, useState as W, useMemo as B, useEffect as I, useCallback as X, useLayoutEffect as yi, createElement as en, isValidElement as Gn, Fragment as io, memo as no, useReducer as ro, cloneElement as so, PureComponent as oo } from "react";
import { createPortal as $n, unstable_batchedUpdates as At } from "react-dom";
import { defaultTranslations as Zd } from "./i18n-provider-defaults.js";
import './f0.css';const ao = {
  xs: 1,
  sm: 2,
  md: 2,
  lg: 2
}, lo = ae(function({ widgets: e, children: t }, i) {
  const r = L(null);
  to(i, () => r.current);
...
}), co = ae(function({ children: e, sideContent: t, mainColumnPosition: i = "left", sticky: r = !1 }, s) {
  return g("div", {
    ref: s,
    className: "h-full",
    children: P("div", {
...
}), jn = M.forwardRef(({ children: n, variant: e, className: t, ...i }, r) => g(Cn, {
  layout: "standard",
  children: g("section", {
    ref: r,
...
function mo({ children: n, options: e, onResizeStop: t, onChange: i, widgets: r }) {
  const [s, o] = W(null), a = L(null), l = B(() => ({
    ...e,
    children: (r || []).map((_) => Ye(_))
  }), [e, r]), [u, c] = W(() => {
    const _ = /* @__PURE__ */ new Map(), C = r || [], E = (v) => {
      var w;
      v.id && v.content && _.set(v.id, v.content), (w = v.subGridOpts) != null && w.children && v.subGridOpts.children.forEach((R) => {
        E(R);
      });
    };
    return C.forEach((v) => {
  ...
  const [h, f] = W(() => {
    const _ = /* @__PURE__ */ new Map(), C = r || [], E = (v) => {
      var w;
      v.id && v._originalContent !== void 0 && _.set(v.id, v._originalContent), (w = v.subGridOpts) != null && w.children && v.subGridOpts.children.forEach((R) => {
        E(R);
      });
    };
    return C.forEach((v) => {
  ...
  const [y, x] = W(() => {
    const _ = /* @__PURE__ */ new Map(), C = r || [], E = (v) => {
      ...
      (w = v.subGridOpts) != null && w.children && v.subGridOpts.children.forEach((R) => {
        E(R);
      });
    };
    return C.forEach((v) => {
  ...
  _n(() => {
    ...
    if (!Array.isArray(_))
      return;
    const C = _.map((A) => A.id), E = r || [], v = E.map((A) => A.id), w = E.filter((A) => !C.includes(A.id));
    w.length > 0 && (w.forEach((A) => {
      A.content && d.current.set(A.id, A.content), A._originalContent !== void 0 && b.current.set(A.id, A._originalContent);
    }), w.forEach((A) => {
      const N = Ye(A);
      s.addWidget(N);
    }), x((A) => {
      ...
      const N = new Map(A);
      return w.forEach((m) => {
        m.content && N.set(m.id, m.content);
      }), N;
    }), f((A) => {
      const N = new Map(A);
      return w.forEach((m) => {
        m._originalContent !== void 0 && N.set(m.id, m._originalContent);
      }), N;
    }));
    const R = _.filter((A) => !v.includes(A.id));
    if (R.length > 0) {
      const A = R.map((N) => N.id).filter(Boolean);
      A.forEach((N) => {
        setTimeout(() => {
          d.current.delete(N), b.current.delete(N);
        }, Pe);
      }), R.forEach((N) => {
        const m = s.el.querySelector(`[gs-id="${N.id}"]`);
        m && setTimeout(() => {
          s.removeWidget(m, !0);
        }, Pe);
      }), x((N) => {
        ...
        return A.forEach((S) => {
          if (m.get(S)) {
            const H = s.el.querySelector(`[gs-id="${S}"] .grid-stack-item-content`);
            let V = "";
            H && (V = po(H)), m.set(S, g(Ri.div, {
    ...
    const D = E.filter((A) => C.includes(A.id));
    if (D.length > 0) {
      const A = [];
      D.forEach((N) => {
        const m = _.find((k) => k.id === N.id);
        if (!m)
          return;
        const S = go.filter((k) => m[k] !== N[k]);
        if (S.length > 0) {
          const k = {}, H = ["w", "h", "x", "y"], V = ["noMove", "noResize", "locked"], J = S.filter((U) => H.includes(U)), j = S.filter((U) => V.includes(U));
          if (J.length > 0 && j.length > 0 && J.length + j.length === S.length ? j.forEach((U) => {
            const K = N[U];
            K !== void 0 && (k[U] = K);
          }) : S.forEach((U) => {
            const K = N[U];
            ...
            const U = s.el.querySelector(`[gs-id="${N.id}"]`);
            U && A.push({
              id: N.id,
              element: U,
              updateOptions: k
        ...
        N.content && d.current.set(N.id, N.content), N._originalContent !== void 0 && b.current.set(N.id, N._originalContent);
      }), A.forEach(({ element: N, updateOptions: m }) => {
        try {
          s.update(N, m);
        } catch (S) {
          console.warn("Error updating widget:", S);
        }
      }), x((N) => {
        const m = new Map(N);
        return D.forEach((S) => {
        ...
        const m = new Map(N);
        return D.forEach((S) => {
          S.content && m.set(S.id, S.content);
        }), m;
      }), f((N) => {
        const m = new Map(N);
        return D.forEach((S) => {
          S._originalContent !== void 0 && m.set(S.id, S._originalContent);
        }), m;
      });
    }
  }, [r]), I(() => {
    ...
    const _ = setTimeout(() => {
      ...
      if (s && s.el && l.handle && s.el.querySelectorAll(l.handle).length > 0)
        try {
          !((C = s.opts) != null && C.disableResize) && (s.disable(!1), s.enable(!1));
        } catch {
        }
    }, 0);
  ...
  const O = X(() => {
    ...
    if (Array.isArray(_)) {
      const C = _.map((E) => {
        const v = E.id;
        if (!v) return null;
        const w = d.current.get(v), R = b.current.get(v), D = E;
        return {
          ...E,
          id: v,
          w: E.w ?? 1,
  ...
  return I(() => {
    ...
    try {
      s.on("resizestop", _), s.on("change added removed", O);
    } catch (C) {
      console.error("Error attaching GridStack event listeners:", C);
      return;
    }
    return () => {
      const C = a.current;
      if (C && C.el)
        try {
          C.off("resizestop"), C.off("change added removed");
        } catch (E) {
  ...
  moveNode(e, t) {
    ...
    if (a.length) {
      ...
      if (d && h && ((c = (u = e.grid) == null ? void 0 : u.opts) != null && c.subGridDynamic) && !e.grid._isTemp) {
        const f = p.areaIntercept(t.rect, h._rect), b = p.area(t.rect), y = p.area(h._rect);
        f / (b < y ? b : y) > 0.8 && (h.grid.makeSubGrid(h.el, void 0, e), h = void 0);
      }
...
function nn(n) {
  z.dragElement && n.pointerType !== "mouse" && (be.pointerLeaveTimeout = window.setTimeout(() => {
...
class Jt {
  ...
  _init() {
    ...
    return e.classList.add("ui-resizable-handle"), e.classList.add(`${Jt.prefix}${this.dir}`), e.style.zIndex = "100", e.style.userSelect = "none", this.host.appendChild(this.el), this.el.addEventListener("mousedown", this._mouseDown), he && (this.el.addEventListener("touchstart", Ht), this.el.addEventListener("pointerdown", Wt)), this;
  }
  /** call this when resize handle needs to be removed and cleaned up */
  destroy() {
    return this.moving && this._mouseUp(this.mouseDownEvent), this.el.removeEventListener("mousedown", this._mouseDown), he && (this.el.removeEventListener("touchstart", Ht), this.el.removeEventListener("pointerdown", Wt)), this.host.removeChild(this.el), delete this.el, delete this.host, this;
  }
...
class mt extends Ni {
  ...
  enable() {
    this.disabled !== !1 && (super.enable(), this.dragEls.forEach((e) => {
      e.addEventListener("mousedown", this._mouseDown), he && (e.addEventListener("touchstart", Ht), e.addEventListener("pointerdown", Wt));
    }), this.el.classList.remove("ui-draggable-disabled"));
  }
  disable(e = !1) {
    this.disabled !== !0 && (super.disable(), this.dragEls.forEach((t) => {
      t.removeEventListener("mousedown", this._mouseDown), he && (t.removeEventListener("touchstart", Ht), t.removeEventListener("pointerdown", Wt));
  ...
  _mouseDown(e) {
    if (!z.mouseHandled)
      return e.button !== 0 || !this.dragEls.find((t) => t === e.target) && e.target.closest(wo) || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e, delete this.dragging, delete z.dragElement, delete z.dropElement, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), he && (e.currentTarget.addEventListener("touchmove", Bt), e.currentTarget.addEventListener("touchend", Ft)), e.preventDefault(), document.activeElement && document.activeElement.blur(), z.mouseHandled = !0), !0;
  }
  ...
  _mouseMove(e) {
    ...
    if (this.lastDrag = e, this.dragging)
      if (this._dragFollow(e), z.pauseDrag) {
        const r = Number.isInteger(z.pauseDrag) ? z.pauseDrag : 100;
      ...
      r ? z.dropElement = r.el.ddElement.ddDroppable : delete z.dropElement, this.helper = this._createHelper(), this._setupHelperContainmentStyle(), this.dragTransform = p.getValuesFromTransformedElement(this.helperContainment), this.dragOffset = this._getDragOffset(e, this.el, this.helperContainment), this._setupHelperStyle(e);
  ...
  _mouseUp(e) {
    ...
    if (document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), he && e.currentTarget && (e.currentTarget.removeEventListener("touchmove", Bt, !0), e.currentTarget.removeEventListener("touchend", Ft, !0)), this.dragging) {
      ...
      this.option.stop && this.option.stop(r), this.triggerEvent("dragstop", r), z.dropElement && z.dropElement.drop(e);
    }
  ...
  _keyEvent(e) {
    var r, s;
    const t = this.el.gridstackNode, i = (t == null ? void 0 : t.grid) || ((s = (r = z.dropElement) == null ? void 0 : r.el) == null ? void 0 : s.gridstack);
    if (e.key === "Escape")
...
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.`)), i;
  ...
  constructor(e, t = {}) {
    ...
    const o = this.el.closest("." + oe.itemClass), a = o == null ? void 0 : o.gridstackNode;
    ...
    const l = t.engineClass || T.engineClass || Re;
    ...
    this.setAnimation(), t.subGridDynamic && !z.pauseDrag && (z.pauseDrag = !0), ((u = t.draggable) == null ? void 0 : u.pause) !== void 0 && (z.pauseDrag = t.draggable.pause), this._setupRemoveDrop(), this._setupAcceptWidget(), this._updateResizeEvent();
  }
  ...
  makeSubGrid(e, t, i, r = !0) {
    ...
    let o, a = this;
    for (; a && !o; )
      o = (b = a.opts) == null ? void 0 : b.subGridOpts, a = (y = a.parentGridNode) == null ? void 0 : y.grid;
    t = p.cloneDeep({
    ...
    if (r && (this._removeDD(s.el), d = { ...s, x: 0, y: 0 }, p.removeInternalForSave(d), delete d.subGridOpts, s.content && (d.content = s.content, delete s.content), T.addRemoveCB ? c = T.addRemoveCB(this.el, d, !0, !1) : (c = p.createDiv(["grid-stack-item"]), c.appendChild(u), u = p.createDiv(["grid-stack-item-content"], s.el)), this.prepareDragDrop(s.el)), i) {
      const x = l ? t.column : s.w, O = s.h + i.h, _ = s.el.style;
      _.transition = "none", this.update(s.el, { w: x, h: O }), setTimeout(() => _.transition = null);
    }
  ...
  resizeToContent(e) {
    ...
    if (t.subGrid) {
      ...
      const b = t.subGrid.el.getBoundingClientRect(), y = e.getBoundingClientRect();
      u += b.top - y.top;
    } else {
        ...
        return;
      {
        ...
        u = b.getBoundingClientRect().height || l;
      }
    }
    if (l === u)
      return;
  ...
  static setupDragIn(e, t, i, r = document) {
    (t == null ? void 0 : t.pause) !== void 0 && (z.pauseDrag = t.pause), t = { appendTo: "body", helper: "clone", ...t || {} }, (typeof e == "string" ? p.getElements(e, r) : e).forEach((o, a) => {
      ee.isDraggable(o) || ee.dragIn(o, t), i != null && i[a] && (o.gridstackNode = i[a]);
    });
  }
  /**
  ...
  _setupAcceptWidget() {
    ...
    return ee.droppable(this.el, {
      ...
      a._temporaryRemoved = !0) : (a.w = l, a.h = u, a._temporaryRemoved = !0), T._itemRemoving(a.el, !1), ee.on(s, "drag", i), i(r, s, o), !1;
      ...
      if (delete s._gridstackNodeOrig, l && (c != null && c.grid) && c.grid !== this) {
        const y = c.grid;
        y.engine.removeNodeFromLayoutCache(c), y.engine.removedNodes.push(c), y._triggerRemoveEvent()._triggerChangeEvent(), y.parentGridNode && !y.engine.nodes.length && y.opts.subGridDynamic && y.removeAsSubGrid();
      }
      if (!a || (l && (this.engine.cleanupNode(a), a.grid = this), (h = a.grid) == null || delete h._isTemp, ee.off(s, "drag"), o !== s ? (o.remove(), s = o) : s.remove(), this._removeDD(s), !l))
        return !1;
      const d = (b = (f = a.subGrid) == null ? void 0 : f.el) == null ? void 0 : b.gridstack;
  ...
  _setupRemoveDrop() {
    ...
    return e ? (!this.opts.staticGrid && !ee.isDroppable(e) && ee.droppable(e, this.opts.removableOptions).on(e, "dropover", (t, i) => T._itemRemoving(i, !0)).on(e, "dropout", (t, i) => T._itemRemoving(i, !1)), this) : this;
  }
  /**
  ...
  prepareDragDrop(e, t = !1) {
    ...
    if (!i._initDD) {
      ...
      const u = (h, f) => {
        ...
        const f = i.w !== i._orig.w, b = h.target;
        if (!(!b.gridstackNode || b.gridstackNode.grid !== this)) {
          if (i.el = b, i._isAboutToRemove) {
            const y = e.gridstackNode.grid;
            y._gsEventHandler[h.type] && y._gsEventHandler[h.type](h, b), y.engine.nodes.push(i), y.removeWidget(e, !0, !0);
          } else
            p.removePositioningStyles(b), i._temporaryRemoved ? (this._writePosAttr(b, i), this.engine.addNode(i)) : this._writePosAttr(b, i), this.triggerEvent(h, b);
  ...
  _dragOrResize(e, t, i, r, s, o) {
    ...
    const f = Math.round(o * 0.1), b = Math.round(s * 0.1);
    if (u = Math.min(u, b), c = Math.min(c, b), d = Math.min(d, f), h = Math.min(h, f), t.type === "drag") {
      ...
      const O = i.position.left + (i.position.left > r._lastUiPosition.left ? -c : u), _ = i.position.top + (i.position.top > r._lastUiPosition.top ? -h : d);
      a.x = Math.round(O / s), a.y = Math.round(_ / o);
      const C = this._extraDragRow;
      if (this.engine.collide(r, a)) {
        const E = this.getRow();
        let v = Math.max(0, a.y + r.h - E);
      ...
      if (a.x < 0 || (p.updateScrollResize(t, e, o), a.w = Math.round((i.size.width - u) / s), a.h = Math.round((i.size.height - d) / o), r.w === a.w && r.h === a.h) || r._lastTried && r._lastTried.w === a.w && r._lastTried.h === a.h)
        return;
      const x = i.position.left + u, O = i.position.top + d;
      a.x = Math.round(x / s), a.y = Math.round(O / o), l = !0;
    }
    ...
    if (this.engine.moveNodeCheck(r, { ...a, cellWidth: s, cellHeight: o, rect: y, resizing: l })) {
  ...
  _leave(e, t) {
    ...
    if (!i || (t.style.transform = t.style.transformOrigin = null, ee.off(e, "drag"), i._temporaryRemoved))
      return;
...
function Eo({ children: n }) {
  const { _gridStack: { value: e, set: t }, options: i } = Kn(), r = L(/* @__PURE__ */ new Map()), s = L(null), o = L(i), a = X((c, d) => {
    if (d.id && d.grid) {
      let h = Tt.get(d.grid);
    ...
    const { children: h, ...f } = c, { children: b, ...y } = d;
    return En(f, y);
  };
  return yi(() => {
    if (!u(i, o.current) && e)
...
const Ai = ({ options: n, widgets: e, onChange: t, className: i }) => {
  const r = B(() => JSON.stringify(e.map((l) => {
    var u, c;
    return {
      id: l.id,
      w: l.w,
    ...
    let d = c[0], h = 1 / 0;
    for (const f of c) {
      const b = f.w - l, y = f.h - u, x = b * b + y * y;
      x < h && (h = x, d = f);
    }
    return d;
  };
  return g(mo, {
    ...
    onResizeStop: (l, u) => {
      ...
      (c.w !== h.w || c.h !== h.h) && ((b = c.grid) == null || b.update(u, {
        w: h.w,
        h: h.h
      }));
    },
...
}, WidgetWrapper: i = Do, main: r = !1, deps: s }) => {
  const o = X((v, w, R) => g(Ri.div, {
    className: "h-full w-full",
    initial: {
      opacity: 0,
      scale: 0.8,
    ...
    let A;
    typeof D.content == "function" && D.deps && R || (typeof D.content == "function" ? A = null : A = D.content);
    const N = {
      id: D.id,
      h: D.h ?? 1,
      w: D.w ?? 1,
      ...
      meta: D.meta,
      _originalContent: A,
      content: o(A, D.meta, w)
    };
    return D.x !== void 0 && (N.x = D.x), D.y !== void 0 && (N.y = D.y), N;
  ...
  const x = L(s), O = B(() => {
    ...
    return !s || Object.keys(s).length === 0 || n.forEach((w) => {
      if (w.deps && w.deps.length > 0) {
        const R = w.deps.map((D) => typeof D == "string" && s[D] !== void 0 ? s[D] : D);
        v.set(w.id, R);
      }
    }), v;
  }, [n, s]), _ = X((v) => {
    c(v), f.current || t(v.map((w) => {
      const R = y.current.find((D) => D.id === w.id);
      return {
        id: w.id,
        w: w.w ?? 1,
        h: w.h ?? 1,
        ...
        meta: w.meta,
        content: typeof (R == null ? void 0 : R.content) == "function" ? R.content : w._originalContent,
        x: w.x ?? 0,
        y: w.y ?? 0,
        locked: w.locked,
        deps: R == null ? void 0 : R.deps
      };
    })), f.current = !1;
  }, [t]), C = (v, w) => !v && !w ? !1 : !v || !w || v.length !== w.length ? !0 : v.some((R, D) => R !== w[D]), E = (v, w) => {
    if (typeof v.content == "function" && v.deps && w) {
      const R = {};
      return v.deps.forEach((D) => {
        typeof D == "string" && w[D] !== void 0 && (R[D] = w[D]);
      }), v.content(R);
    }
    return typeof v.content == "function" ? null : v.content;
  };
  return I(() => {
    const v = d.current !== e, w = h.current !== n, R = x.current !== s && (x.current === void 0 || s === void 0 || Object.keys(x.current).length !== Object.keys(s).length || Object.keys(s).some((m) => {
      var S;
      return ((S = x.current) == null ? void 0 : S[m]) !== s[m];
    })), D = /* @__PURE__ */ new Map();
    n.forEach((m) => {
      if (m.deps && m.deps.length > 0) {
        const S = b.current.get(m.id), k = O.get(m.id);
        D.set(m.id, C(S, k)), k ? b.current.set(m.id, k) : b.current.delete(m.id);
      }
    });
    const A = new Set(n.map((m) => m.id));
    b.current.forEach((m, S) => {
      A.has(S) || b.current.delete(S);
    });
    const N = Array.from(D.values()).some((m) => m) || R;
    v && !w && !N ? (f.current = !0, c((m) => m.map((S) => {
      const k = n.find((V) => V.id === S.id);
      if (!k)
        return S;
      const H = E(k, s);
      return {
      ...
      const S = new Map(m.map((k) => [k.id, k]));
      return n.map((k) => {
        const H = S.get(k.id), V = D.get(k.id) ?? !1;
        let J;
        V || !H ? J = E(k, s) : J = H._originalContent ?? E(k, s);
        const j = {
          id: k.id,
          h: (H == null ? void 0 : H.h) ?? k.h ?? 1,
          w: (H == null ? void 0 : H.w) ?? k.w ?? 1,
...
}), qn = ae(No), Oo = ["append", "className", "pressed", "compact", "noTitle", "noAutoTooltip", "style", "variant", "loading", "emoji"], Vn = ae((n, e) => {
  const t = Oo.reduce((i, r) => {
    const { [r]: s, ...o } = i;
    return o;
  }, n);
  return g(Si, {
    ...
    variant: "ai",
    ref: e,
    iconRotate: n.icon == qn
  });
});
Vn.displayName = "AIButton";
const hi = Di({
  ...
  "info-strong": "p",
  code: "code"
}, Ti = ae(({ content: n, variant: e, align: t, className: i, as: r, ellipsis: s, noEllipsisTooltip: o, markdown: a, ...l }, u) => {
  const c = r ?? Ao[e ?? "body"];
  if (s !== void 0)
    return g(Gr, {
      ref: u,
...
const wc = [
  ...
  const [u, c] = W(!1), [d, h] = W(!1), f = Ur(), b = (x) => {
    c(x);
  }, y = d || u;
  return I(() => {
    if (!r || !i) return;
...
const ko = jr(Zn, To), zo = ({ children: n, title: e, draggable: t = !1, actions: i, aiButton: r }) => g(ko, {
  ...
  deps: i,
  ...r,
  WidgetWrapper: (s, o, a) => g(zo, {
    title: (o == null ? void 0 : o.title) ?? "",
    draggable: a,
    actions: o == null ? void 0 : o.actions,
    aiButton: o == null ? void 0 : o.aiButton,
    children: s
  })
});
Qn.displayName = "Dashboard";
const Po = So("Dashboard", Qn), Cc = De("Dashboard", Po), Mo = Di({
...
}), Lo = (n) => (n || []).map((e) => e.items).reduce((e, t) => (e.length > 0 && e.push({
  type: "separator"
}), e.push(...t), e), []), Io = (n) => {
...
}, Qt = ae(({ children: n, variant: e = "default", className: t, draggable: i = !1, onDragStart: r, onDragEnd: s, onDrop: o, dragId: a, primaryAction: l, ...u }, c) => {
  const d = B(() => Io(u.actions || []), [u.actions]), h = B(() => d.flatMap((b) => b.items), [d]), f = B(() => h.length > 0 || !!l, [h, l]);
  return P("div", {
    ref: c,
    className: $(Mo({
      variant: e
...
const Ho = ({ title: n = "", description: e, titleLevel: t = "h2", children: i, className: r, ...s }) => {
  if (!n) return null;
  const o = t;
  return P(Qt, {
    ...s,
...
}, Bo = Ro("BlockContent", Ho), Fo = (n) => Gn(n) && "__isPageLayoutBlock" in n, Wo = (n) => Gn(n) && "__isPageLayoutGroup" in n, er = (n, e, t) => {
  const i = Lt.toArray(e);
  for (const r of i)
    (t.includes("block") && !Fo(r) || t.includes("group") && !Wo(r)) && console.warn(
      `${n}: Children components must inherit from PageLayoutBlock or PageLayoutGroup. Found:`,
      r
    );
}, ki = ae(({ children: n, onSort: e, ...t }, i) => {
...
function xt(n) {
  return Qe(n) ? !1 : n instanceof te(n).HTMLElement;
}
function tr(n) {
  return n instanceof te(n).SVGElement;
}
function et(n) {
...
const qe = /* @__PURE__ */ ir(1), yt = /* @__PURE__ */ ir(-1);
function jo(n) {
...
function Zo() {
  const [n] = W(() => /* @__PURE__ */ new Set()), e = X((i) => (n.add(i), () => n.delete(i)), [n]);
  return [X((i) => {
    let {
      type: r,
      event: s
...
function ta(n) {
  let {
    ...
    screenReaderInstructions: r = Qo
  } = n;
  const {
    announce: s,
    announcement: o
  } = Vo(), a = Ct("DndLiveRegion"), [l, u] = W(!1);
  if (I(() => {
    u(!0);
  }, []), Jo(B(() => ({
    onDragStart(d) {
    ...
    return null;
  const c = M.createElement(M.Fragment, null, M.createElement(Yo, {
    id: i,
    value: r.draggable
  }), M.createElement(qo, {
    id: a,
...
const aa = (n) => {
  ...
  for (const o of i) {
    ...
    if (l) {
      const u = on(l), c = r.reduce((h, f, b) => h + na(u[b], f), 0), d = Number((c / 4).toFixed(4));
      s.push({
        id: a,
        data: {
...
function ma(n, e) {
  return e === void 0 && (e = te(n).getComputedStyle(n)), e.position === "fixed";
}
function va(n, e) {
  e === void 0 && (e = te(n).getComputedStyle(n));
...
function ni(n, e) {
  ...
  function i(r) {
    ...
    if (!xt(r) || tr(r) || t.includes(r))
      return t;
    const s = te(n).getComputedStyle(r);
    return r !== n && va(r, s) && t.push(r), ma(r, s) ? t : i(r.parentNode);
  }
  return n ? i(n) : t;
}
function ar(n) {
...
function ba(n, e, t, i, r) {
  ...
  return !u && s <= e.top + y.height ? (f.y = q.Backward, b.y = i * Math.abs((e.top + y.height - s) / y.height)) : !c && l >= e.bottom - y.height && (f.y = q.Forward, b.y = i * Math.abs((e.bottom - y.height - l) / y.height)), !h && a >= e.right - y.width ? (f.x = q.Forward, b.x = i * Math.abs((e.right - y.width - a) / y.width)) : !d && o <= e.left + y.width && (f.x = q.Backward, b.x = i * Math.abs((e.left + y.width - o) / y.width)), {
    direction: f,
    speed: b
  };
}
...
function hr(n) {
  return n.reduce((e, t) => qe(e, bi(t)), ge);
}
function wa(n) {
...
const _a = [["x", ["left", "right"], wa], ["y", ["top", "bottom"], Ca]];
class Mi {
  constructor(e, t) {
...
class Li {
  constructor(e) {
    ...
    this.props = e, this.listeners = new dt(et(t)), this.windowListeners = new dt(te(t)), this.handleKeyDown = this.handleKeyDown.bind(this), this.handleCancel = this.handleCancel.bind(this), this.attach();
  }
  attach() {
      ...
      if (d) {
        ...
        for (const y of b) {
          const x = e.code, {
            ...
            x: Math.min(x === F.Right ? R.right - R.width / 2 : R.right, Math.max(x === F.Right ? R.left : R.left + R.width / 2, d.x)),
            y: Math.min(x === F.Down ? R.bottom - R.height / 2 : R.bottom, Math.max(x === F.Down ? R.top : R.top + R.height / 2, d.y))
          }, A = x === F.Right && !_ || x === F.Left && !C, N = x === F.Down && !E || x === F.Up && !O;
          if (A && D.x !== d.x) {
            const m = y.scrollLeft + h.x, S = x === F.Right && m <= v.x || x === F.Left && m >= w.x;
            if (S && !h.y) {
              y.scrollTo({
                left: m,
                behavior: a
            ...
            S ? f.x = y.scrollLeft - m : f.x = x === F.Right ? y.scrollLeft - v.x : y.scrollLeft - w.x, f.x && y.scrollBy({
              left: -f.x,
              behavior: a
            });
            break;
          } else if (N && D.y !== d.y) {
            const m = y.scrollTop + h.y, S = x === F.Down && m <= v.y || x === F.Up && m >= w.y;
            if (S && !h.x) {
              y.scrollTo({
                top: m,
                behavior: a
            ...
            S ? f.y = y.scrollTop - m : f.y = x === F.Down ? y.scrollTop - v.y : y.scrollTop - w.y, f.y && y.scrollBy({
              top: -f.y,
              behavior: a
            });
            break;
        ...
        this.handleMove(e, qe(yt(d, this.referenceCoordinates), f));
      }
    }
  }
  handleMove(e, t) {
...
class Ii {
  constructor(e, t, i) {
    var r;
    i === void 0 && (i = Ea(e.event.target)), this.props = void 0, this.events = void 0, this.autoScrollEnabled = !0, this.document = void 0, this.activated = !1, this.initialCoordinates = void 0, this.timeoutId = null, this.listeners = void 0, this.documentListeners = void 0, this.windowListeners = void 0, this.props = e, this.events = t;
    const {
      event: s
    } = e, {
      target: o
    } = s;
    this.props = e, this.events = t, this.document = et(o), this.documentListeners = new dt(this.document), this.listeners = new dt(i), this.windowListeners = new dt(te(o)), this.initialCoordinates = (r = jt(s)) != null ? r : ge, this.handleStart = this.handleStart.bind(this), this.handleMove = this.handleMove.bind(this), this.handleEnd = this.handleEnd.bind(this), this.handleCancel = this.handleCancel.bind(this), this.handleKeydown = this.handleKeydown.bind(this), this.removeTextSelection = this.removeTextSelection.bind(this), this.attach();
  }
  attach() {
    const {
      events: e,
  ...
  handleStart() {
    ...
    e && (this.activated = !0, this.documentListeners.add(ue.Click, Da, {
      capture: !0
  ...
  handleMove(e) {
    ...
    if (!r)
      return;
    const l = (t = jt(e)) != null ? t : ge, u = yt(r, l);
    if (!i && a) {
      if (cn(a)) {
...
function Ta(n) {
  ...
  const f = za({
    ...
    if (!w)
      return;
    const R = x.current.x * O.current.x, D = x.current.y * O.current.y;
    w.scrollBy(R, D);
  }, []), v = B(() => a === Kt.TreeOrder ? [...u].reverse() : u, [a, u]);
  I(
    () => {
      if (!s || !u.length || !_) {
        y();
      ...
      for (const w of v) {
        if ((i == null ? void 0 : i(w)) === !1)
          continue;
        const R = u.indexOf(w), D = c[R];
        if (!D)
          continue;
        const {
          direction: A,
        ...
        for (const m of ["x", "y"])
          f[m][A[m]] || (N[m] = 0, A[m] = 0);
        if (N.x > 0 || N.y > 0) {
          y(), C.current = w, b(E, o), x.current = N, O.current = A;
          return;
        }
      }
      x.current = {
...
function La(n, e) {
  ...
  const [s, o] = W(null), {
    ...
    measure: l,
    strategy: u
  } = r, c = L(n), d = x(), h = vt(d), f = X(function(O) {
    O === void 0 && (O = []), !h.current && o((_) => _ === null ? O : _.concat(O.filter((C) => !_.includes(C))));
  }, [h]), b = L(null), y = wt((O) => {
    if (d && !t)
      return un;
    if (!O || O === un || c.current !== n || s != null) {
      const _ = /* @__PURE__ */ new Map();
      for (let C of n) {
        if (!C)
          continue;
        if (s && s.length > 0 && !s.includes(C.id) && C.rect.current) {
          _.set(C.id, C.rect.current);
          continue;
        }
        const E = C.node.current, v = E ? new Mi(l(E), E) : null;
        C.rect.current = v, v && _.set(C.id, v);
      }
      return _;
    }
    return O;
...
function Ha(n) {
  ...
  return I(() => () => r == null ? void 0 : r.disconnect(), [r]), r;
}
function ri(n) {
  let {
    callback: e,
...
function Ga(n) {
  ...
  }, [r, n]), B(() => n.length ? e ? Array.from(e.values()).reduce((s, o) => qe(s, o), ge) : hr(n) : ge, [n, e]);
}
function gn(n, e) {
  e === void 0 && (e = []);
  const t = L(null);
...
function pr(n) {
  return B(() => n ? pa(n) : null, [n]);
}
const pn = [];
function Ua(n, e) {
  e === void 0 && (e = tt);
  const [t] = n, i = pr(t ? te(t) : null), [r, s] = W(pn);
  function o() {
...
const qa = {
  ...
  over: null,
  measureDroppableContainers: Ut
}, _t = /* @__PURE__ */ Se(vr), yr = /* @__PURE__ */ Se(qa);
function Va() {
  return {
    draggable: {
      active: null,
...
const tl = /* @__PURE__ */ no(function(e) {
  var t, i, r, s;
  let {
    id: o,
    accessibility: a,
    ...
    children: u,
    sensors: c = Xa,
    collisionDetection: d = ca,
    measuring: h,
    modifiers: f,
    ...b
  } = e;
  const y = ro(Ja, void 0, Va), [x, O] = y, [_, C] = Zo(), [E, v] = W(Me.Uninitialized), w = E === Me.Initialized, {
    draggable: {
      active: R,
      nodes: D,
      translate: A
    ...
    return R != null ? {
      ...
      data: (Q = m == null ? void 0 : m.data) != null ? Q : Ya,
      rect: S
    } : null;
  }, [R, m]), H = L(null), [V, J] = W(null), [j, U] = W(null), K = vt(b, Object.values(b)), He = Ct("DndDescribedBy", o), Dt = B(() => N.getEnabled(), [N]), ie = Qa(h), {
    droppableRects: we,
    ...
    config: ie.droppable
  }), le = Pa(D, R), Rt = B(() => j ? jt(j) : null, [j]), Ne = Fr(), Ce = Ia(le, ie.draggable.measure);
  el({
  ...
  const G = hn(le, ie.draggable.measure, Ce), nt = hn(le ? le.parentElement : null), me = L({
    activatorEvent: null,
    active: null,
    activeNode: le,
    collisionRect: null,
  ...
  }), We = N.getNodeFor((t = me.current.over) == null ? void 0 : t.id), _e = Ka({
    measure: ie.dragOverlay.measure
  }), Ge = (i = _e.nodeRef.current) != null ? i : le, $e = w ? (r = _e.rect) != null ? r : G : null, Gi = !!(_e.nodeRef.current && _e.rect), $i = Fa(Gi ? null : G), ai = pr(Ge ? te(Ge) : null), Oe = Wa(w ? We ?? le : null), St = Ua(Oe), Nt = br(f, {
    transform: {
      x: A.x - $i.x,
      y: A.y - $i.y,
      scaleX: 1,
    ...
    windowRect: ai
  }), ji = Rt ? qe(Rt, A) : null, Ui = Ga(Oe), zr = gn(Ui), Pr = gn(Ui, [G]), je = qe(Nt, zr), Ue = $e ? ha($e, Nt) : null, rt = k && Ue ? d({
    active: k,
    collisionRect: Ue,
    droppableRects: we,
    droppableContainers: Dt,
    pointerCoordinates: ji
  }) : null, Ki = rr(rt, "id"), [Ae, Xi] = W(null), Mr = Gi ? Nt : qe(Nt, Pr), Lr = da(Mr, (s = Ae == null ? void 0 : Ae.rect) != null ? s : null, G), li = L(null), Yi = X(
    (Q, ne) => {
      let {
        sensor: re,
        options: Te
      ...
      if (H.current == null)
        return;
      const ce = D.get(H.current);
      if (!ce)
        return;
      const se = Q.nativeEvent, ve = new re({
        active: H.current,
        activeNode: ce,
        event: se,
        options: Te,
        ...
        onStart(Z) {
          ...
          At(() => {
            Ee == null || Ee(st), v(Me.Initializing), O({
              type: Y.DragStart,
        ...
        return async function() {
          ...
          if (ye && ot) {
            ...
            ze = {
              ...
              delta: ot,
              over: st
            }, Z === Y.DragEnd && typeof at == "function" && await Promise.resolve(at(ze)) && (Z = Y.DragCancel);
          }
          H.current = null, At(() => {
            O({
              type: Z
            }), v(Me.Uninitialized), Xi(null), J(null), U(null), li.current = null;
            const at = Z === Y.DragEnd ? "onDragEnd" : "onDragCancel";
            if (ze) {
              const ci = K.current[at];
              ci == null || ci(ze), _({
                type: at,
                event: ze
              });
    ...
    const ce = re.nativeEvent, se = D.get(Te);
    if (
    ...
    Q(re, ne.options, ve) === !0 && (ce.dndKit = {
      capturedBy: ne.sensor
    }, H.current = Te, Yi(re, ne));
  }, [D, Yi]), qi = Ma(c, Ir);
  $a(c), fe(() => {
    G && E === Me.Initializing && v(Me.Initialized);
  }, [G, E]), I(
    () => {
      const {
        onDragMove: Q
    ...
    () => {
      ...
      if (!Q || H.current == null || !ne || !ce)
        return;
      const {
        onDragOver: se
      } = K.current, ve = Te.get(Ki), Ke = ve && ve.rect.current ? {
        id: ve.id,
  ...
  }, [k, le, rt, Ue, D, Ge, $e, we, N, Ae, Oe, je]), Ta({
    ...Ne,
    delta: A,
    draggingRect: Ue,
    pointerCoordinates: ji,
  ...
  const Hr = B(() => ({
    ...
    measuringScheduled: it,
    windowRect: ai
  }), [k, le, G, j, rt, nt, _e, D, N, we, Ae, Be, Oe, St, ie, it, ai]), Br = B(() => ({
    activatorEvent: j,
    activators: qi,
    active: k,
    activeNodeRect: G,
    ...
    over: Ae,
    measureDroppableContainers: Be
  }), [j, qi, k, G, O, He, D, Ae, Be]);
  return M.createElement(nr.Provider, {
    value: C
  ...
  function Fr() {
    const Q = (V == null ? void 0 : V.autoScrollEnabled) === !1, ne = typeof l == "object" ? l.enabled === !1 : l === !1, re = w && !Q && !ne;
...
}), il = /* @__PURE__ */ Se(null), mn = "button", nl = "Draggable";
function rl(n) {
  let {
    id: e,
    data: t,
  ...
  const s = Ct(nl), {
    ...
    tabIndex: y = 0
  } = r ?? {}, x = (l == null ? void 0 : l.id) === e, O = xe(x ? si : il), [_, C] = Gt(), [E, v] = Gt(), w = ja(o, e), R = vt(t);
  fe(
    () => (d.set(e, {
      id: e,
      key: s,
  ...
  const s = Ct(sl), {
    ...
    () => {
      ...
      f.current != null && clearTimeout(f.current), f.current = setTimeout(() => {
        u(Array.isArray(O.current) ? O.current : [O.current]), f.current = null;
      }, x);
    },
    //eslint-disable-next-line react-hooks/exhaustive-deps
    [x]
    ...
    C && (A && (C.unobserve(A), d.current = !1), D && C.observe(D));
  }, [C]), [v, w] = Gt(E), R = vt(e);
  return I(() => {
    !C || !v.current || (C.disconnect(), d.current = !1, C.observe(v.current));
  }, [v, C]), I(
    () => (a({
...
function ll(n) {
  ...
  }, [e, i, s]), M.createElement(M.Fragment, null, t, i ? so(i, {
    ref: o
  }) : null);
}
const cl = {
...
const ul = {
  position: "fixed",
  touchAction: "none"
}, hl = (n) => ii(n) ? "transform 250ms ease" : void 0, fl = /* @__PURE__ */ ae((n, e) => {
  let {
    as: t,
    activatorEvent: i,
    adjustScale: r,
  ...
  const d = r ? u : {
    ...
    transformOrigin: r && i ? ra(i, a) : void 0,
...
function vl(n) {
  ...
  return ti((s, o) => {
    ...
    const {
      transform: c
    } = te(o).getComputedStyle(o), d = or(c);
    if (!d)
      return;
    const h = typeof e == "function" ? e : yl(e);
...
function yl(n) {
  ...
  return (s) => {
    ...
    if (JSON.stringify(b) === JSON.stringify(y))
      return;
...
const xl = /* @__PURE__ */ M.memo((n) => {
  ...
  const {
    ...
    windowRect: v
  } = xr(), w = xe(si), R = bl(d == null ? void 0 : d.id), D = br(o, {
    activatorEvent: c,
    active: d,
    activeNodeRect: h,
    containerNodeRect: f,
  ...
  return M.createElement(dl, null, M.createElement(ll, {
    animation: N
  }, d && R ? M.createElement(fl, {
    key: R,
    id: d.id,
    ref: m,
    as: a,
...
}, Cr = "Sortable", _r = /* @__PURE__ */ M.createContext({
  activeIndex: -1,
  containerId: Cr,
  disableTransforms: !1,
  items: [],
...
function El(n) {
  ...
  } = xr(), d = Ct(Cr, t), h = a.rect !== null, f = B(() => i.map((w) => typeof w == "object" && "id" in w ? w.id : w), [i]), b = o != null, y = o ? f.indexOf(o.id) : -1, x = u ? f.indexOf(u.id) : -1, O = L(f), _ = !Cl(f, O.current), C = x !== -1 && y === -1 || _, E = _l(s);
  fe(() => {
    _ && b && c(f);
  }, [_, f, b, c]), I(() => {
    O.current = f;
  ...
  const v = B(
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [y, d, E.draggable, E.droppable, C, f, x, l, h, r]
  );
  return M.createElement(_r.Provider, {
    value: v
  }, e);
}
const Dl = (n) => {
  ...
  duration: 200,
  easing: "ease"
}, Er = "transform", Nl = /* @__PURE__ */ Ie.Transition.toString({
  property: Er,
  duration: 0,
  easing: "linear"
}), Ol = {
...
function Tl(n) {
  ...
  const {
    ...
    useDragOverlay: O,
    strategy: _
  } = xe(_r), C = kl(i, f), E = c.indexOf(o), v = B(() => ({
    sortable: {
      containerId: d,
      index: E,
      items: c
    ...
    ...r
  }), [d, r, E, c]), w = B(() => c.slice(c.indexOf(o)), [c, o]), {
    rect: R,
    node: D,
    isOver: A,
    setNodeRef: N
  ...
  }), Dt = Go(N, V), ie = !!m, we = ie && !b && kt(h) && kt(x), Be = !O && j, it = Be && we ? He : null, Rt = we ? it ?? (a ?? _)({
    rects: y,
    activeNodeRect: k,
    activeIndex: h,
    overIndex: x,
  ...
  return I(() => {
    ie && G.current.newIndex !== Ne && (G.current.newIndex = Ne), d !== G.current.containerId && (G.current.containerId = d), c !== G.current.items && (G.current.items = c);
  }, [ie, Ne, d, c]), I(() => {
...
const zl = [F.Down, F.Right, F.Up, F.Left], Pl = (n, e) => {
  let {
    context: {
      active: t,
      collisionRect: i,
  ...
  if (zl.includes(n.code)) {
    ...
    if (c === (o == null ? void 0 : o.id) && u.length > 1 && (c = u[1].id), c != null) {
      const d = s.get(t.id), h = s.get(c), f = h ? r.get(h.id) : null, b = h == null ? void 0 : h.node.current;
      if (b && f && d && h) {
        const x = ni(b).some((w, R) => a[R] !== w), O = Dr(d, h), _ = Ml(d, h), C = x || !O ? {
          x: 0,
          y: 0
        } : {
...
const yn = ({ id: n, children: e }) => {
  ...
  const [o, a] = W(null), l = ia(sn(Hi), sn(Li, {
    coordinateGetter: Pl
  })), u = (h) => {
    a(h.active.id);
  }, c = (h) => {
    const { active: f, over: b } = h;
    a(null), b && f.id !== b.id && s((y) => {
      const x = y.findIndex((_) => _.id === f.id), O = y.findIndex((_) => _.id === b.id);
      return Fi(y, x, O);
    });
  };
  return g("div", {
...
const Ll = ae(function({ children: e, aside: t, header: i, variant: r = "main-aside" }, s) {
  ...
  Page: De("Page", Ll),
  Block: De("Block", Qt),
  BlockContent: De("BlockContent", Bo),
  Group: De("Group", ki),
  GroupGrid: De("GroupGrid", Zt),
  GroupMasonry: De("GroupMasonry", Wi)
}, Ec = pe({
  name: "StandardLayout",
  type: "layout"
}, jn), Dc = pe({
...
function Bl(n, e, t) {
  return e && Hl(n.prototype, e), Object.defineProperty(n, "prototype", { writable: !1 }), n;
}
function Fl(n, e, t) {
  return e = Yt(e), Wl(n, Rr() ? Reflect.construct(e, t || [], Yt(n).constructor) : e.apply(n, t));
}
function Wl(n, e) {
...
function Yl(n) {
  var e = n.option, t = n.isActive, i = Kl(n, Ul);
  return typeof e == "string" ? /* @__PURE__ */ M.createElement(Vi, ft({
    option: /* @__PURE__ */ M.createElement(Jr, ft({
      type: e
    }, i)),
    isActive: t,
    shapeType: "symbols"
  }, i)) : /* @__PURE__ */ M.createElement(Vi, ft({
    option: e,
    isActive: t,
    shapeType: "symbols"
  }, i));
...
function Jl(n, e, t) {
  return e = qt(e), Zl(n, Or() ? Reflect.construct(e, t || [], qt(n).constructor) : e.apply(n, t));
}
function Zl(n, e) {
...
var Et = /* @__PURE__ */ function(n) {
  function e() {
    ...
    for (var i = arguments.length, r = new Array(i), s = 0; s < i; s++)
      r[s] = arguments[s];
    return t = Jl(this, e, [].concat(r)), Le(t, "state", {
  ...
  return ec(e, n), Vl(e, [{
    ...
    value: function(i) {
      ...
      return i.map(function(c, d) {
        ...
        return /* @__PURE__ */ M.createElement(lt, gt({
          ...
          role: "img"
        }), /* @__PURE__ */ M.createElement(Yl, gt({
          option: f,
          isActive: h,
          key: "symbol-".concat(d)
        }, b)));
    ...
    value: function() {
      ...
      return /* @__PURE__ */ M.createElement(Qr, {
        begin: a,
        duration: l,
        isActive: o,
        easing: u,
        ...
        var f = h.t, b = s.map(function(y, x) {
          var O = d && d[x];
          if (O) {
            var _ = Ot(O.cx, y.cx), C = Ot(O.cy, y.cy), E = Ot(O.size, y.size);
            return de(de({}, y), {}, {
              cx: _(f),
              cy: C(f),
              size: E(f)
        ...
        return /* @__PURE__ */ M.createElement(lt, null, i.renderSymbolsStatically(b));
      });
    }
  }, {
    key: "renderSymbols",
    ...
    value: function() {
      ...
      return u ? u.map(function(c, d) {
        var h = c.props, f = h.direction, b = h.dataKey;
        return /* @__PURE__ */ M.cloneElement(c, {
          key: "".concat(f, "-").concat(b, "-").concat(s[d]),
          data: s,
          xAxis: o,
          yAxis: a,
          layout: f === "x" ? "vertical" : "horizontal",
          dataPointFormatter: function(x, O) {
            return {
              x: x.cx,
              y: x.cy,
              value: f === "x" ? +x.node.x : +x.node.y,
              errorVal: zt(x, O)
            };
          }
        });
    ...
    value: function() {
      ...
      if (o === "joint")
        ...
        var h = ts(r), f = h.xmin, b = h.xmax, y = h.a, x = h.b, O = function(E) {
          return y * E + x;
        };
        c = [{
          x: f,
      ...
      return /* @__PURE__ */ M.isValidElement(s) ? d = /* @__PURE__ */ M.cloneElement(s, _) : is(s) ? d = s(_) : d = /* @__PURE__ */ M.createElement(ns, gt({}, _, {
        type: a
    ...
    key: "render",
    value: function() {
      var i = this.props, r = i.hide, s = i.points, o = i.line, a = i.className, l = i.xAxis, u = i.yAxis, c = i.left, d = i.top, h = i.width, f = i.height, b = i.id, y = i.isAnimationActive;
      if (r || !s || !s.length)
        return null;
      var x = this.state.isAnimationFinished, O = rs("recharts-scatter", a), _ = l && l.allowDataOverflow, C = u && u.allowDataOverflow, E = _ || C, v = Xe(b) ? this.id : b;
      return /* @__PURE__ */ M.createElement(lt, {
        className: O,
        clipPath: E ? "url(#clipPath-".concat(v, ")") : null
      }, _ || C ? /* @__PURE__ */ M.createElement("defs", null, /* @__PURE__ */ M.createElement("clipPath", {
      ...
      }, this.renderSymbols()), (!y || x) && Sn.renderCallByParent(this.props, s));
    }
  }], [{
...
Le(Et, "getComposedData", function(n) {
  var e = n.xAxis, t = n.yAxis, i = n.zAxis, r = n.item, s = n.displayedData, o = n.xAxisTicks, a = n.yAxisTicks, l = n.offset, u = r.props.tooltipType, c = Rn(r.props.children, as), d = Xe(e.dataKey) ? r.props.dataKey : e.dataKey, h = Xe(t.dataKey) ? r.props.dataKey : t.dataKey, f = i && i.dataKey, b = i ? i.range : oi.defaultProps.range, y = b && b[0], x = e.scale.bandwidth ? e.scale.bandwidth() : 0, O = t.scale.bandwidth ? t.scale.bandwidth() : 0, _ = s.map(function(C, E) {
    var v = zt(C, d), w = zt(C, h), R = !Xe(f) && zt(C, f) || "-", D = [{
    ...
    var A = Ji({
      ...
      index: E,
      dataKey: h
    }), m = R !== "-" ? i.scale(R) : y, S = Math.sqrt(Math.max(m, 0) / Math.PI);
    return de(de({}, C), {}, {
      cx: A,
      cy: N,
      x: A - S,
...
const nc = (n) => {
  ...
  hide: !0
}, label: r = !1, hideTooltip: s = !1, hideGrid: o = !1, aspect: a, legend: l, showValueUnderLabel: u = !1, bar: c, line: d, scatter: h, onClick: f }, b) => {
  var R, D, A, N;
  const y = us(e), x = c != null && c.categories ? Array.isArray(c.categories) ? c.categories : [c.categories] : [], O = d != null && d.categories ? Array.isArray(d.categories) ? d.categories : [d.categories] : [], _ = h != null && h.categories ? Array.isArray(h.categories) ? h.categories : [h.categories] : [], C = [...x, ...O, ..._], E = Math.max(...y.flatMap((m) => C.map((S) => hs(i != null && i.tickFormatter ? i.tickFormatter(`${m[S]}`) : `${m[S]}`)))), v = [c, d, h].filter((m) => (m == null ? void 0 : m.axisPosition) === "left"), w = [c, d, h].filter((m) => (m == null ? void 0 : m.axisPosition) === "right");
  return g(fs, {
    config: n,
    ref: b,
    aspect: a,
    children: P(ic, {
      ...
      stackOffset: void 0,
      onClick: (m) => {
        if (!f || !m.activeLabel || !m.activePayload)
          return;
        const S = {
          label: m.activeLabel,
          values: {}
        };
        for (const k of m.activePayload)
          S.values[k.name] = k.value;
        f(S);
      },
      children: [!s && g(gs, {
        ...ps(),
        ...
        ...Zi(i),
        tick: !0,
        width: i.width ?? E + 20 + (w.length > 0 && ((R = v[0]) != null && R.axisLabel) ? 20 : 0),
        hide: i.hide || v.some((m) => m == null ? void 0 : m.hideAxis),
        label: (D = v[0]) != null && D.axisLabel ? {
          value: v[0].axisLabel,
          angle: -90,
          position: "insideLeft"
        } : void 0
        ...
        orientation: "right",
        tick: !0,
        width: i.width ?? E + 20 + (v.length > 0 && ((A = w[0]) != null && A.axisLabel) ? 20 : 0),
        hide: i.hide || w.some((m) => m == null ? void 0 : m.hideAxis),
        label: (N = w[0]) != null && N.axisLabel ? {
          value: w[0].axisLabel,
          angle: 90,
        ...
        tick: u ? (m) => {
          var U, K;
          const { x: S, y: k, payload: H } = m, V = ((U = e.find((He) => He.label === H.value)) == null ? void 0 : U.values) || "", J = Object.keys(V).length === 1 ? (K = Object.values(V)) == null ? void 0 : K[0] : void 0, j = J !== void 0 && i.tickFormatter ? i.tickFormatter(`${J}`) : J.toLocaleString();
          return P("g", {
            transform: `translate(${S},${k})`,
            children: [g("text", {
              x: 0,
              y: 0,
              dy: 12,
        ...
        isAnimationActive: !1,
        dataKey: String(m),
        fill: n[m].color ? ct(n[m].color) : ui(S),
        radius: 4,
        maxBarSize: 32,
        children: r && g(Sn, {
          position: "top",
  ...
  (n) => n !== "ai"
), Lc = kn, Ic = ["default", "outline", "neutral"], Hc = kn, Bc = ["sm", "md", "lg"], Fc = As, Ei = ({ count: n, list: e }) => {
  const [t, i] = W(!1), r = g(Mt, {
    label: `+${n}`
  });
  return e != null && e.length ? P(zn, {
    open: t,
    onOpenChange: i,
    children: [g(Pn, {
      asChild: !0,
...
const Wc = De("F0ChipList", Tr), Gc = zs, lc = ae((n, e) => g(Ti, {
  ref: e,
  variant: "heading",
  ...n
}));
...
}), kr = ae(({ title: n, image: e, benefits: t, actions: i, withShadow: r = !0, module: s, moduleName: o, tag: a, promoTag: l }, u) => P("div", {
  ref: u,
...
function jc({ isOpen: n, onClose: e, title: t, image: i, benefits: r, errorMessage: s, successMessage: o, loadingState: a, nextSteps: l, closeLabel: u, primaryAction: c, modalTitle: d, modalModule: h, secondaryAction: f, portalContainer: b, tag: y, promoTag: x, showResponseDialog: O = !0 }) {
  const [_, C] = W(n), [E, v] = W(null), [w, R] = W(!1), D = async () => {
    if (c != null && c.onClick) {
      R(!0);
      try {
        await c.onClick(), C(!1), O && v("success");
      } catch {
        O && v("error");
      } finally {
        R(!1);
...
function hc({ mediaUrl: n, title: e, description: t, onClose: i, dismissible: r, width: s, trackVisibility: o, actions: a, showConfirmation: l = !0 }) {
  const [u, c] = W(!1), d = () => {
    c(!0), i && i();
  };
  I(() => {
  ...
  return g(Vt, {
    children: u ? null : P(Fs, {
      ...
      children: [P(Ws, {
        ...
        className: "p-3",
        children: a.map((f) => f.type === "upsell" ? g(Wn, {
          label: f.label,
          onRequest: f.onClick,
...
const fc = ae(function({ primaryAction: e, secondaryAction: t, ...i }, r) {
  const s = (l) => l.variant === "promote" ? g(Wn, {
    label: l.label,
    onRequest: async () => {
      await l.onClick();
    },
...
function Uc({ isOpen: n, setIsOpen: e, label: t, variant: i = "promote", size: r = "md", showIcon: s = !0, side: o = "right", align: a = "center", icon: l = js, mediaUrl: u, title: c, description: d, width: h = "300px", trackVisibility: f, actions: b, onClick: y, hideLabel: x = !1 }) {
  const [O, _] = W(!1), [C, E] = W(null), [v, w] = W(null), R = (S) => {
    e(S), y && y();
  }, D = async (S) => {
    if (S.type === "upsell") {
      w(S);
      try {
        await S.onClick(), S.showConfirmation && (_(!0), E("success"));
      } catch {
        _(!0), E("error");
      }
    }
  ...
  }, N = n && !O, m = b == null ? void 0 : b.map((S) => S.type === "upsell" ? {
    ...S,
    onClick: () => D(S)
  } : S);
  return P(Vt, {
    ...
    }), (v == null ? void 0 : v.type) === "upsell" && v.showConfirmation && C && g(Fn, {
      open: !0,
      onClose: A,
      success: C === "success",
...
const gc = Se(null), pc = ({ children: n, fullScreen: e = !0 }) => {
  ...
  reducedMotion: "user",
  children: n
}), Kc = ({ children: n, layout: e, link: t, privacyModeInitiallyEnabled: i, image: r, i18n: s, l10n: o, isDev: a = !1, dataCollectionStorageHandler: l, showExperimentalWarnings: u = !1 }) => g(mc, {
  children: g(Us, {
    isDev: a,
...
export {
  ...
  ld as F0AvatarTeam,
  Ve as F0Button,
  cd as F0ButtonDropdown,
  dd as F0ButtonToggle,
  ud as F0Card,
  hd as F0Checkbox,
  Wc as F0ChipList,
  fd as F0DatePicker,
  gd as F0EventCatcherProvider,
  $c as F0GridStack,
  lc as F0Heading,
  Dn as F0Icon,
  pd as F0Link,
  ...
  _d as F0TagTeam,
  Jn as F0Text,
  Ed as GROUP_ID_SYMBOL,
  Rc as HomeLayout,
  _c as Layout,
  Ac as LineChart,
  Dd as OneFilterPicker,
  Tc as PieChart,
  ...
  Uc as UpsellingPopover,
  kc as VerticalBarChart,
  wc as avatarVariants,
  Nd as buildTranslations,
  Hc as buttonDropdownSizes,
  Ic as buttonDropdownVariants,
  Lc as buttonSizes,
  Bc as buttonToggleSizes,
  Mc as buttonVariants,
  Od as createAtlaskitDriver,
  Ad as createDataSourceDefinition,
  Xc as dataCollectionLocalStorageHandler,
  Gc as datepickerSizes,
  Zd as defaultTranslations,
  De as experimental,
  Td as getAnimationVariants,
  kd as getDataSourcePaginationType,
  zd as getEmojiLabel,
  Pd as isInfiniteScrollPagination,
  Md as isPageBasedPagination,
  Fc as linkVariants,
  Ld as modules,
  Id as predefinedPresets,
  Hd as selectSizes,
  Bd as tagDotColors,
  Fd as useData,
  Wd as useDataSource,
  Gd as useDndEvents,
  $d as useDraggable,
  jd as useDroppableList,
  Ud as useEmojiConfetti,
  Kd as useGroups,
  Xd as usePrivacyMode,
  Yd as useReducedMotion,
  qd as useSelectable,
  Vd as useXRay
};

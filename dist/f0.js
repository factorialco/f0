import { S as xe, a as mt, f as ne, L as K, b as ht, A as vt, i as J, c as yt, d as De, E as bt, g as X, e as gt, h as xt, C as wt, j as Pt, k as $, l as Fe, u as St, G as Ct, m as Nt, n as we, o as At, p as Ie, q as Ot, B as _e, X as Ee, Y as le, r as kt, s as je, t as Lt, v as Tt, w as Dt, x as Ft, y as It, z as _t, D as Et, F as jt, H as Pe, I as $t, J as W, K as oe, M as Bt, N as Mt, O as Rt, P as $e, Q as _, R as I, T as zt, U as Kt, V as Wt, W as qt, Z as Gt, _ as Vt, $ as Yt, a0 as Be, a1 as Ut, a2 as Z, a3 as Me, a4 as Re, a5 as Ht, a6 as ze, a7 as Ke, a8 as We, a9 as qe, aa as Jt, ab as Ge, ac as Xt, ad as Zt, ae as Qt, af as Se, ag as ie, ah as ea, ai as ta, aj as Ve, ak as aa, al as ra, am as Ye, an as na, ao as oa, ap as ia, aq as sa, ar as la, as as ca, at as ua, au as Ue, av as M, aw as He, ax as da, ay as fa, az as Ce, aA as pa, aB as Je, aC as ma, aD as ha, aE as va, aF as ya, aG as ba, aH as ga, aI as xa, aJ as wa, aK as Pa, aL as Sa, aM as Ca, aN as Na } from "./hooks-C_xGBpy7.js";
import { bp as en, br as tn, bA as an, aO as rn, aP as nn, aQ as on, aR as sn, aS as ln, aT as cn, aU as un, aV as dn, aX as fn, aY as pn, aZ as mn, a_ as hn, a$ as vn, b0 as yn, bw as bn, b2 as gn, b4 as xn, b5 as wn, b6 as Pn, b7 as Sn, ba as Cn, bb as Nn, bc as An, bd as On, bf as kn, b3 as Ln, be as Tn, b9 as Dn, bx as Fn, bq as In, bk as _n, bn as En, bj as jn, bB as $n, bi as Bn, bh as Mn, aW as Rn, b1 as zn, b8 as Kn, bg as Wn, bl as qn, bs as Gn, bt as Vn, bu as Yn, bC as Un, bm as Hn, bv as Jn, bz as Xn, bo as Zn, by as Qn } from "./hooks-C_xGBpy7.js";
import { jsx as n, jsxs as N, Fragment as ae } from "react/jsx-runtime";
import * as fe from "react";
import k, { PureComponent as Aa, useState as T, forwardRef as V, useEffect as B, useMemo as se, useCallback as Ne, useRef as pe, useImperativeHandle as Oa, Children as ka, createContext as La } from "react";
const Nr = {
  approvals: {
...
function Fa(e, t, r) {
  return t && Da(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function Ia(e, t, r) {
...
var re = /* @__PURE__ */ function(e) {
  function t() {
    return Ta(this, t), Ia(this, t, arguments);
  }
  return ja(t, e), Fa(t, [{
    key: "render",
    value: function() {
...
function qa(e, t, r) {
  return t = ee(t), Ga(e, et() ? Reflect.construct(t, r || [], ee(e).constructor) : t.apply(e, r));
}
function Ga(e, t) {
...
var Y = /* @__PURE__ */ function(e) {
  function t() {
    ...
    for (var a = arguments.length, o = new Array(a), s = 0; s < a; s++)
      o[s] = arguments[s];
    return r = qa(this, t, [].concat(o)), j(r, "state", {
  ...
  return Ya(t, e), Wa(t, [{
    ...
    value: function() {
      ...
      return /* @__PURE__ */ k.createElement(vt, {
        ...
        var u = h.t, x = s.map(function(A, S) {
          var O = f && f[S];
          if (O) {
            var g = J(O.cx, A.cx), b = J(O.cy, A.cy), w = J(O.size, A.size);
            return F(F({}, A), {}, {
              cx: g(u),
              cy: b(u),
              size: w(u)
    ...
    value: function() {
      ...
      return /* @__PURE__ */ k.isValidElement(s) ? f = /* @__PURE__ */ k.cloneElement(s, g) : xt(s) ? f = s(g) : f = /* @__PURE__ */ k.createElement(wt, G({}, g, {
        type: d
  ...
  return n(Dt, {
    ...
    children: N(Ha, {
      ...
      children: [!s && n(Ft, {
        ...
        tick: m ? (p) => {
          var be, ge;
          const { x: P, y: U, payload: ve } = p, ye = ((be = t.find((pt) => pt.label === ve.value)) == null ? void 0 : be.values) || "", H = Object.keys(ye).length === 1 ? (ge = Object.values(ye)) == null ? void 0 : ge[0] : void 0, ft = H !== void 0 && a.tickFormatter ? a.tickFormatter(`${H}`) : H.toLocaleString();
          return N("g", {
...
const ir = ({ value: e, max: t = 100, label: r, color: a }, o) => {
  ...
  Za
), jr = Yt, $r = Be, Br = ["default", "outline", "neutral"], Mr = Be, Rr = ["sm", "md", "lg"], zr = Ut, de = ({ count: e, list: t }) => {
  const [r, a] = T(!1), o = n(Z, {
    label: `+${e}`
  });
...
const Kr = qe("F0ChipList", lt), ct = V(({ value: e, onDateChange: t, granularity: r, onOpenChange: a, minDate: o, maxDate: s, onClear: l, ...d }, i) => {
...
const Wr = ta, qr = qe(
  ...
  md: 2,
  lg: 2
}, ur = V(function({ widgets: t, children: r }, a) {
  const o = pe(null);
  Oa(a, () => o.current);
...
}), dr = V(function({ children: t, sideContent: r, mainColumnPosition: a = "left", sticky: o = !1 }, s) {
  return n("div", {
    ref: s,
    className: "h-full",
    children: N("div", {
...
}), dt = V(({ title: e, image: t, benefits: r, actions: a, withShadow: o = !0, module: s, moduleName: l, tag: d }, i) => N("div", {
  ref: i,
...
const br = V(function({ primaryAction: t, secondaryAction: r, ...a }, o) {
...
function Hr({ isOpen: e, setIsOpen: t, label: r, variant: a = "promote", size: o = "md", showIcon: s = !0, side: l = "right", align: d = "center", icon: i = ha, mediaUrl: m, title: c, description: f, width: h = "300px", trackVisibility: u, actions: x, onClick: A, hideLabel: S = !1 }) {
...
const gr = La(null), xr = ({ children: e, fullScreen: t = !0 }) => {
  ...
  reducedMotion: "user",
  children: e
}), Jr = ({ children: e, layout: t, link: r, privacyModeInitiallyEnabled: a, image: o, i18n: s, l10n: l, isDev: d = !1, dataCollectionStorageHandler: i, showExperimentalWarnings: m = !1 }) => n(wr, {
  children: n(va, {
    isDev: d,

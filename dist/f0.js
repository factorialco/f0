...
import './f0.css';const $l = {
  ...
  md: 2,
  lg: 2
}, Wl = Ee(function({ widgets: e, children: t }, r) {
  const i = F(null);
  zo(r, () => i.current);
  const s = kn.toArray(e).filter((a) => !!a).map((a, o) => f("div", {
...
}), _s = V.forwardRef(({ children: n, variant: e, className: t, ...r }, i) => f(ds, {
  layout: "standard",
  children: f("section", {
    ref: i,
...
_s.displayName = "StandardLayout";
const Vl = Ee(function({ children: e, sideContent: t, mainColumnPosition: r = "left", sticky: i = !1 }, s) {
  return f("div", {
    ref: s,
    className: "h-full",
    children: M("div", {
...
}), Zl = ({ children: n, className: e }) => f("aside", {
...
const ql = ["noMove", "noResize", "locked", "w", "h", "x", "y"], ct = 200;
function Yl(n) {
...
function Kl({ children: n, options: e, onResizeStop: t, onChange: r, widgets: i }) {
  const [s, a] = Z(null), o = F(null), l = F(!1), d = B(() => ({
    ...e,
    children: (i || []).map((_) => St(_))
  }), [e, i]), [c, u] = Z(() => {
    const _ = /* @__PURE__ */ new Map(), R = i || [], b = (x) => {
  ...
  Ki(() => {
    ...
    if (!Array.isArray(_))
      return;
    const R = _.map((T) => T.id), b = i || [], x = b.map((T) => T.id), y = b.filter((T) => !R.includes(T.id));
    ...
    if (E.length > 0) {
      ...
      T.forEach((C) => {
        ...
        return T.forEach((A) => {
          if (N.get(A)) {
            const ae = s.el.querySelector(`[gs-id="${A}"] .grid-stack-item-content`);
            let oe = "";
            ae && (oe = Yl(ae)), N.set(A, f(Or.div, {
    ...
    const L = b.filter((T) => R.includes(T.id));
    if (L.length > 0) {
      const T = [];
      L.forEach((C) => {
        const N = _.find((G) => G.id === C.id);
        if (!N)
          return;
        const A = ql.filter((G) => N[G] !== C[G]);
        if (A.length > 0) {
          const G = {}, ae = ["w", "h", "x", "y"], oe = ["noMove", "noResize", "locked"], re = A.filter((te) => ae.includes(te)), ne = A.filter((te) => oe.includes(te));
...
const Jl = Xe(null);
function Ql() {
  const { _reactContentMap: n } = Es(), { getWidgetContainer: e } = Xl();
  return f(ln, {
    children: Array.from(n.value.entries()).map(([t, r]) => {
      const i = e(t);
      return i ? f(Jl.Provider, {
        value: {
          widget: {
            id: t
          }
...
function Rn(n) {
  Ye.touchHandled || (Ye.touchHandled = !0, Sn(n, "mousedown"));
}
function Nn(n) {
  Ye.touchHandled && Sn(n, "mousemove");
}
function Dn(n) {
  if (!Ye.touchHandled)
    return;
  ...
  Sn(n, "mouseup"), e || Sn(n, "click"), Ye.touchHandled = !1;
}
function Tn(n) {
  n.pointerType !== "mouse" && n.target.releasePointerCapture(n.pointerId);
}
function hi(n) {
  H.dragElement && n.pointerType !== "mouse" && Ss(n, "mouseenter");
}
function fi(n) {
  H.dragElement && n.pointerType !== "mouse" && (Ye.pointerLeaveTimeout = window.setTimeout(() => {
    delete Ye.pointerLeaveTimeout, Ss(n, "mouseleave");
  }, 10));
}
class Zn {
  constructor(e, t, r) {
  ...
  _init() {
    ...
    return e.classList.add("ui-resizable-handle"), e.classList.add(`${Zn.prefix}${this.dir}`), e.style.zIndex = "100", e.style.userSelect = "none", this.host.appendChild(this.el), this.el.addEventListener("mousedown", this._mouseDown), Pe && (this.el.addEventListener("touchstart", Rn), this.el.addEventListener("pointerdown", Tn)), this;
  }
  /** call this when resize handle needs to be removed and cleaned up */
  destroy() {
    return this.moving && this._mouseUp(this.mouseDownEvent), this.el.removeEventListener("mousedown", this._mouseDown), Pe && (this.el.removeEventListener("touchstart", Rn), this.el.removeEventListener("pointerdown", Tn)), this.host.removeChild(this.el), delete this.el, delete this.host, this;
  }
  /** @internal called on mouse down on us: capture move on the entire document (mouse might not stay on us) until we release the mouse */
  _mouseDown(e) {
    this.mouseDownEvent = e, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), Pe && (this.el.addEventListener("touchmove", Nn), this.el.addEventListener("touchend", Dn)), e.stopPropagation(), e.preventDefault();
  }
  /** @internal */
  _mouseMove(e) {
...
class Jt extends Lr {
  ...
  /** @internal */
  _setupHandlers() {
    return this.handlers = this.option.handles.split(",").map((e) => e.trim()).map((e) => new Zn(this.el, e, {
      start: (t) => {
        this._resizeStart(t);
      },
      stop: (t) => {
  ...
  /** @internal */
  _setupHelper() {
    this.elOriginStyleVal = Jt._originStyleProp.map((r) => this.el.style[r]), this.parentOriginStylePosition = this.el.parentElement.style.position;
...
const tc = 'input,textarea,button,select,option,[contenteditable="true"],.ui-resizable-handle';
class Qt extends Lr {
  constructor(e, t = {}) {
  ...
  enable() {
    this.disabled !== !1 && (super.enable(), this.dragEls.forEach((e) => {
      e.addEventListener("mousedown", this._mouseDown), Pe && (e.addEventListener("touchstart", Rn), e.addEventListener("pointerdown", Tn));
    }), this.el.classList.remove("ui-draggable-disabled"));
  }
  disable(e = !1) {
    this.disabled !== !0 && (super.disable(), this.dragEls.forEach((t) => {
      t.removeEventListener("mousedown", this._mouseDown), Pe && (t.removeEventListener("touchstart", Rn), t.removeEventListener("pointerdown", Tn));
  ...
  _mouseDown(e) {
    if (!H.mouseHandled)
      return e.button !== 0 || !this.dragEls.find((t) => t === e.target) && e.target.closest(tc) || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e, delete this.dragging, delete H.dragElement, delete H.dropElement, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), Pe && (e.currentTarget.addEventListener("touchmove", Nn), e.currentTarget.addEventListener("touchend", Dn)), e.preventDefault(), document.activeElement && document.activeElement.blur(), H.mouseHandled = !0), !0;
  }
  ...
  _mouseUp(e) {
    if (document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), Pe && e.currentTarget && (e.currentTarget.removeEventListener("touchmove", Nn, !0), e.currentTarget.removeEventListener("touchend", Dn, !0)), this.dragging) {
  ...
  _createHelper() {
    let e = this.el;
    return typeof this.option.helper == "function" ? e = this.option.helper(this.el) : this.option.helper === "clone" && (e = p.cloneNode(this.el)), e.parentElement || p.appendTo(e, this.option.appendTo === "parent" ? this.el.parentElement : this.option.appendTo), this.dragElementOriginStyle = Qt.originStyleProp.map((t) => this.el.style[t]), e;
  }
  ...
  _removeHelperStyle() {
    if (this.helper.classList.remove("ui-draggable-dragging"), this.el.gridstackNode?.grid?.el.classList.remove("grid-stack-dragging"), !this.helper?.gridstackNode?._isAboutToRemove && this.dragElementOriginStyle) {
      ...
      t.style.transition = this.dragElementOriginStyle.transition = "none", Qt.originStyleProp.forEach((i) => t.style[i] = this.dragElementOriginStyle[i] || null), setTimeout(() => t.style.transition = r, 50);
    }
...
class Pr {
  static init(e) {
    return e.ddElement || (e.ddElement = new Pr(e)), e.ddElement;
  }
  constructor(e) {
    this.el = e;
  }
  ...
  setupDroppable(e) {
    return this.ddDroppable ? this.ddDroppable.updateOption(e) : this.ddDroppable = new nc(this.el, e), this;
  }
  cleanDroppable() {
...
class rc {
  ...
  _getDDElements(e, t) {
    ...
    return i.length ? i.map((a) => a.ddElement || (r ? Pr.init(a) : null)).filter((a) => a) : [];
  }
}
const be = new rc();
class P {
...
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.`)), r;
  ...
  makeSubGrid(e, t, r, i = !0) {
    ...
    if (i && (this._removeDD(s.el), u = { ...s, x: 0, y: 0 }, p.removeInternalForSave(u), delete u.subGridOpts, s.content && (u.content = s.content, delete s.content), P.addRemoveCB ? c = P.addRemoveCB(this.el, u, !0, !1) : (c = p.createDiv(["grid-stack-item"]), c.appendChild(d), d = p.createDiv(["grid-stack-item-content"], s.el)), this.prepareDragDrop(s.el)), r) {
      const m = l ? t.column : s.w, g = s.h + r.h, v = s.el.style;
      v.transition = "none", this.update(s.el, { w: m, h: g }), setTimeout(() => v.transition = null);
    }
    const h = s.subGrid = P.addGrid(d, t);
  ...
  update(e, t) {
    return P.getElements(e).forEach((r) => {
      ...
      (o || l) && this._writeAttr(r, i), d && this.prepareDragDrop(i.el), P.updateCB && P.updateCB(i);
    }), this;
  }
  moveNode(e, t) {
    const r = e._updating;
  ...
  _setupAcceptWidget() {
    ...
    return be.droppable(this.el, {
      ...
      o._temporaryRemoved = !0) : (o.w = l, o.h = d, o._temporaryRemoved = !0), P._itemRemoving(o.el, !1), be.on(s, "drag", r), r(i, s, a), !1;
  ...
  _dragOrResize(e, t, r, i, s, a) {
    ...
    if (d = Math.min(d, g), c = Math.min(c, g), u = Math.min(u, m), h = Math.min(h, m), t.type === "drag") {
      ...
      const S = r.position.left + (r.position.left > i._lastUiPosition.left ? -c : d), D = r.position.top + (r.position.top > i._lastUiPosition.top ? -h : u);
      o.x = Math.round(S / s), o.y = Math.round(D / a);
      const _ = this._extraDragRow;
      if (this.engine.collide(i, o)) {
        const R = this.getRow();
        let b = Math.max(0, o.y + i.h - R);
        this.opts.maxRow && R + b > this.opts.maxRow && (b = Math.max(0, this.opts.maxRow - R)), this._extraDragRow = b;
      } else
      ...
      if (o.x < 0 || (p.updateScrollResize(t, e, a), o.w = Math.round((r.size.width - d) / s), o.h = Math.round((r.size.height - u) / a), i.w === o.w && i.h === o.h) || i._lastTried && i._lastTried.w === o.w && i._lastTried.h === o.h)
        return;
      const w = r.position.left + d, S = r.position.top + u;
  ...
  commit() {
    return ec(this, this.batchUpdate(!1), "commit", "batchUpdate", "5.2"), this;
  }
}
P.renderCB = (n, e) => {
...
function ic({ children: n }) {
  const { _gridStack: { value: e, set: t }, options: r } = Es(), i = F(/* @__PURE__ */ new Map()), s = F(null), a = F(r), o = J((c, u) => {
    if (u.id && u.grid) {
      let h = xn.get(u.grid);
      h || (h = /* @__PURE__ */ new Map(), xn.set(u.grid, h)), h.set(u.id, c), i.current.set(u.id, c);
    }
  }, []), l = J(() => {
    if (s.current) {
      P.renderCB = o;
      const c = P.init(a.current, s.current);
  ...
  return vr(() => {
    if (!d(r, a.current) && e)
      try {
        e.removeAll(!1), e.destroy(!1), i.current.clear(), xn.delete(e), a.current = r, t(null);
      } catch (c) {
...
const Br = ({ options: n, widgets: e, onChange: t, className: r }) => {
  const i = B(() => JSON.stringify(e.map((l) => ({
    ...
    let u = c[0], h = 1 / 0;
    for (const m of c) {
      const g = m.w - l, v = m.h - d, w = g * g + v * v;
      w < h && (h = w, u = m);
    }
    return u;
  };
...
Br.displayName = "F0GridStack";
const sc = (n, e, t) => f("div", {
  children: n
}), Un = ({ widgets: n = [], editMode: e = !1, onChange: t = () => {
}, WidgetWrapper: r = sc, main: i = !1, deps: s }) => {
  const a = J((b, x, y) => f(Or.div, {
    className: "h-full w-full",
    initial: {
      opacity: 0,
      scale: 0.8,
  ...
  }), [c, u] = Z(d(n, e)), h = F(e), m = F(n), g = F(!1), v = F(/* @__PURE__ */ new Map()), w = F(n);
  w.current = n;
  const S = F(s), D = B(() => {
  ...
  }, [t]), R = (b, x) => !b && !x ? !1 : !b || !x || b.length !== x.length ? !0 : b.some((y, E) => y !== x[E]);
  return j(() => {
    ...
    v.current.forEach((C, N) => {
      L.has(N) || v.current.delete(N);
    });
    const T = Array.from(E.values()).some((C) => C) || y;
    b && !x && !T ? (g.current = !0, u((C) => C.map((N) => {
      const A = n.find((ae) => ae.id === N.id);
      if (!A)
        return N;
      const G = l(A, s);
      return {
        ...
        meta: A.meta,
        _originalContent: G,
        content: a(G, A.meta, e)
      };
    }))) : (x || T) && u((C) => {
      const N = new Map(C.map((A) => [A.id, A]));
      return n.map((A) => {
        const G = N.get(A.id), ae = E.get(A.id) ?? !1;
        let oe;
        ae || !G ? oe = l(A, s) : oe = G._originalContent ?? l(A, s);
        const re = {
          id: A.id,
          h: G?.h ?? A.h ?? 1,
          w: G?.w ?? A.w ?? 1,
          ...
          meta: A.meta,
          _originalContent: oe,
          content: a(oe, A.meta, e)
        }, ne = G?.x ?? A.x, te = G?.y ?? A.y;
...
Un.displayName = "GroupGrid";
Un.__isPageLayoutGroup = !0;
const ac = (n, e) => {
  const t = e;
...
}), Rs = Ee(lc), cc = ["append", "className", "pressed", "compact", "noTitle", "noAutoTooltip", "style", "variant", "loading", "emoji"], Ns = Ee((n, e) => {
  const t = cc.reduce((r, i) => {
    const { [i]: s, ...a } = r;
    return a;
  }, n);
  return f(Mr, {
    ...
    variant: "ai",
    ref: e,
    iconRotate: n.icon == Rs
  });
});
Ns.displayName = "AIButton";
const lr = vt({
  ...
  "info-strong": "p",
  code: "code"
}, Fr = Ee(({ content: n, variant: e, align: t, className: r, as: i, ellipsis: s, noEllipsisTooltip: a, markdown: o, ...l }, d) => {
  const c = i ?? dc[e ?? "body"];
  if (s !== void 0)
    return f(Ga, {
      ref: d,
...
Fr.displayName = "Text";
const Ds = Ee((n, e) => f(Fr, {
  ref: e,
  markdown: n.markdown ?? !0,
  ...n
}));
Ds.displayName = "F0Text";
const Xf = [
  "person",
  "team",
  "company",
  "file",
  "flag"
], Ts = ({ title: n, draggable: e = !1, onDragStart: t, onDragEnd: r, isDragging: i = !1, AIButton: s, actions: a, children: o, selected: l = !1 }) => {
  const [d, c] = Z(!1), [u, h] = Z(!1), m = Vn(), g = (w) => {
    c(w);
  }, v = u || d;
  return j(() => {
    if (!i || !r) return;
...
Ts.displayName = "F0Widget";
const hc = Xi(Ts, uc), fc = ({ children: n, title: e, draggable: t = !1, actions: r, aiButton: i }) => f(hc, {
  title: e,
  draggable: t,
  actions: r,
  AIButton: i,
  children: n
}), As = ({ widgets: n, editMode: e = !1, onChange: t = () => {
}, deps: r, ...i }) => f(Un, {
  widgets: n,
  editMode: e,
  onChange: t,
...
As.displayName = "Dashboard";
const mc = oc("Dashboard", As), Jf = Me("Dashboard", mc), pc = vt({
...
}), gc = (n) => (n || []).map((e) => e.items).reduce((e, t) => (e.length > 0 && e.push({
  type: "separator"
}), e.push(...t), e), []), vc = (n) => {
...
}, qn = Ee(({ children: n, variant: e = "default", className: t, draggable: r = !1, onDragStart: i, onDragEnd: s, onDrop: a, dragId: o, primaryAction: l, ...d }, c) => {
  const u = B(() => vc(d.actions || []), [d.actions]), h = B(() => u.flatMap((g) => g.items), [u]), m = B(() => h.length > 0 || !!l, [h, l]);
  return M("div", {
    ref: c,
    className: X(pc({
      variant: e
...
const yc = ({ title: n = "", description: e, titleLevel: t = "h2", children: r, className: i, ...s }) => {
  if (!n) return null;
  const a = t;
  return M(qn, {
    ...s,
...
}, bc = ac("BlockContent", yc), xc = (n) => !ls(n) || !n.type || typeof n.type == "string" || typeof n.type == "symbol" ? !1 : "__isPageLayoutBlock" in n.type, wc = (n) => !ls(n) || !n.type || typeof n.type == "string" || typeof n.type == "symbol" ? !1 : "__isPageLayoutGroup" in n.type, Os = (n, e, t) => {
  const r = kn.toArray(e);
  for (const i of r)
    t.includes("block") && xc(i) || t.includes("group") && wc(i) || console.warn(
      `${n}: Children components must inherit from PageLayoutBlock or PageLayoutGroup. Found:`,
      i
    );
}, Hr = Ee(({ children: n, onSort: e, ...t }, r) => {
  Os("GroupLinear", n, ["block"]);
  const [i, s] = Z(kn.toArray(n));
  return j(() => {
    s(kn.toArray(n));
  }, [n]), j(() => {
    e?.(i);
    ...
    ref: r,
    ...t,
    children: i.map((a, o) => f(Lo, {
      children: a
    }, o))
  });
});
Hr.displayName = "GroupLinear";
Hr.__isPageLayoutGroup = !0;
function _c() {
...
function xe(n) {
  var e, t;
  return n ? Lt(n) ? n : jr(n) && (e = (t = n.ownerDocument) == null ? void 0 : t.defaultView) != null ? e : window : window;
}
function $r(n) {
  const {
    Document: e
...
function cn(n) {
  return Lt(n) ? !1 : n instanceof xe(n).HTMLElement;
}
function Ms(n) {
  return n instanceof xe(n).SVGElement;
}
function Pt(n) {
  return n ? Lt(n) ? n.document : jr(n) ? $r(n) ? n : cn(n) || Ms(n) ? n.ownerDocument : document : document : document;
}
const He = Yn ? vr : j;
function Kn(n) {
  const e = F(n);
...
const Dt = /* @__PURE__ */ Is(1), tn = /* @__PURE__ */ Is(-1);
function Ec(n) {
...
function Sc(n) {
  return n.matches(mi) ? n : n.querySelector(mi);
}
const Rc = {
  display: "none"
};
...
function zc(n) {
  let {
    ...
    screenReaderInstructions: i = Mc
  } = n;
  const {
    announce: s,
    announcement: a
  } = Tc(), o = un("DndLiveRegion"), [l, d] = Z(!1);
  if (j(() => {
    d(!0);
  }, []), Ac(B(() => ({
    onDragStart(u) {
    ...
    return null;
  const c = V.createElement(V.Fragment, null, V.createElement(Nc, {
    id: r,
    value: i.draggable
  }), V.createElement(Dc, {
    id: o,
...
const jc = (n) => {
  ...
  for (const a of r) {
    ...
    if (l) {
      const d = gi(l), c = i.reduce((h, m, g) => h + Pc(d[g], m), 0), u = Number((c / 4).toFixed(4));
      s.push({
        id: o,
        data: {
...
function Jn(n, e) {
  ...
  function r(i) {
    if (e != null && t.length >= e || !i)
      return t;
    if ($r(i) && i.scrollingElement != null && !t.includes(i.scrollingElement))
      return t.push(i.scrollingElement), t;
    if (!cn(i) || Ms(i) || t.includes(i))
      return t;
    const s = xe(n).getComputedStyle(i);
    return i !== n && Xc(i, s) && t.push(i), Kc(i, s) ? t : r(i.parentNode);
  }
  return n ? r(n) : t;
}
function Fs(n) {
...
function dr(n) {
  return !Yn || !n ? null : Lt(n) ? n : jr(n) ? $r(n) || n === Pt(n).scrollingElement ? window : cn(n) ? n : null : null;
}
function Hs(n) {
  return Lt(n) ? n.scrollX : n.scrollLeft;
}
function js(n) {
  return Lt(n) ? n.scrollY : n.scrollTop;
}
function br(n) {
  return {
    x: Hs(n),
...
function $s(n) {
  return !Yn || !n ? !1 : n === document.scrollingElement;
}
function Ws(n) {
  const e = {
    x: 0,
...
function Gs(n) {
  return n.reduce((e, t) => Dt(e, br(t)), je);
}
function td(n) {
  return n.reduce((e, t) => e + Hs(t), 0);
}
function nd(n) {
  return n.reduce((e, t) => e + js(t), 0);
}
function Vs(n, e) {
  if (e === void 0 && (e = Bt), !n)
    return;
  ...
  Fs(n) && (i <= 0 || s <= 0 || t >= window.innerHeight || r >= window.innerWidth) && n.scrollIntoView({
    block: "center",
    inline: "center"
  });
}
const rd = [["x", ["left", "right"], td], ["y", ["top", "bottom"], nd]];
class Wr {
  constructor(e, t) {
...
class Gr {
  constructor(e) {
    ...
    this.props = e, this.listeners = new Ut(Pt(t)), this.windowListeners = new Ut(xe(t)), this.handleKeyDown = this.handleKeyDown.bind(this), this.handleCancel = this.handleCancel.bind(this), this.attach();
  }
  attach() {
    ...
    if (Xn(e)) {
      ...
      if (u) {
        ...
        for (const v of g) {
          ...
          }, L = w === Y.Right && !D || w === Y.Left && !_, T = w === Y.Down && !R || w === Y.Up && !S;
          if (L && E.x !== u.x) {
            const C = v.scrollLeft + h.x, N = w === Y.Right && C <= b.x || w === Y.Left && C >= x.x;
            if (N && !h.y) {
              v.scrollTo({
                left: C,
                behavior: o
            ...
            N ? m.x = v.scrollLeft - C : m.x = w === Y.Right ? v.scrollLeft - b.x : v.scrollLeft - x.x, m.x && v.scrollBy({
              left: -m.x,
              behavior: o
            });
            break;
          } else if (T && E.y !== u.y) {
            const C = v.scrollTop + h.y, N = w === Y.Down && C <= b.y || w === Y.Up && C >= x.y;
            if (N && !h.x) {
              v.scrollTo({
                top: C,
                behavior: o
            ...
            N ? m.y = v.scrollTop - C : m.y = w === Y.Down ? v.scrollTop - b.y : v.scrollTop - x.y, m.y && v.scrollBy({
              top: -m.y,
              behavior: o
            });
            break;
        ...
        this.handleMove(e, Dt(tn(u, this.referenceCoordinates), m));
      }
    }
  }
  handleMove(e, t) {
...
class Vr {
  constructor(e, t, r) {
    var i;
    r === void 0 && (r = id(e.event.target)), this.props = void 0, this.events = void 0, this.autoScrollEnabled = !0, this.document = void 0, this.activated = !1, this.initialCoordinates = void 0, this.timeoutId = null, this.listeners = void 0, this.documentListeners = void 0, this.windowListeners = void 0, this.props = e, this.events = t;
    const {
      event: s
    } = e, {
      target: a
    } = s;
    this.props = e, this.events = t, this.document = Pt(a), this.documentListeners = new Ut(this.document), this.listeners = new Ut(r), this.windowListeners = new Ut(xe(a)), this.initialCoordinates = (i = Mn(s)) != null ? i : je, this.handleStart = this.handleStart.bind(this), this.handleMove = this.handleMove.bind(this), this.handleEnd = this.handleEnd.bind(this), this.handleCancel = this.handleCancel.bind(this), this.handleKeydown = this.handleKeydown.bind(this), this.removeTextSelection = this.removeTextSelection.bind(this), this.attach();
  }
  attach() {
    const {
      events: e,
    ...
    if (this.listeners.add(e.move.name, this.handleMove, {
      passive: !1
    }), this.listeners.add(e.end.name, this.handleEnd), e.cancel && this.listeners.add(e.cancel.name, this.handleCancel), this.windowListeners.add(Oe.Resize, this.handleCancel), this.windowListeners.add(Oe.DragStart, yi), this.windowListeners.add(Oe.VisibilityChange, this.handleCancel), this.windowListeners.add(Oe.ContextMenu, yi), this.documentListeners.add(Oe.Keydown, this.handleKeydown), t) {
      if (r != null && r({
  ...
  handleStart() {
    ...
    e && (this.activated = !0, this.documentListeners.add(Oe.Click, sd, {
      capture: !0
  ...
  handleMove(e) {
    ...
    if (!i)
      return;
    const l = (t = Mn(e)) != null ? t : je, d = tn(i, l);
    if (!r && o) {
      if (bi(o)) {
        if (o.tolerance != null && ur(d, o.tolerance))
          return this.handleCancel();
        if (ur(d, o.distance))
          return this.handleStart();
      }
      if (xi(o) && ur(d, o.tolerance))
        return this.handleCancel();
...
cd.activators = [{
  ...
  handler: (n, e) => {
    ...
    return t.button === xr.RightClick ? !1 : (r?.({
      event: t
    }), !0);
  }
}];
...
class dd extends Vr {
  ...
  static setup() {
    return window.addEventListener(hr.move.name, e, {
      capture: !1,
      passive: !1
    }), function() {
      window.removeEventListener(hr.move.name, e);
    };
    function e() {
    }
  }
...
function ud(n) {
  ...
  const m = fd({
    ...
    x.scrollBy(y, E);
  }, []), b = B(() => o === zn.TreeOrder ? [...d].reverse() : d, [o, d]);
  j(
    () => {
      if (!s || !d.length || !D) {
        v();
      ...
      for (const x of b) {
        ...
        for (const C of ["x", "y"])
          m[C][L[C]] || (T[C] = 0, L[C] = 0);
        if (T.x > 0 || T.y > 0) {
          v(), _.current = x, g(R, a), w.current = T, S.current = L;
          return;
        }
      }
      w.current = {
...
function gd(n, e) {
  ...
  const [s, a] = Z(null), {
    ...
    measure: l,
    strategy: d
  } = i, c = F(n), u = w(), h = en(u), m = J(function(S) {
    S === void 0 && (S = []), !h.current && a((D) => D === null ? S : D.concat(S.filter((_) => !D.includes(_))));
  }, [h]), g = F(null), v = dn((S) => {
    if (u && !t)
      return wi;
    if (!S || S === wi || c.current !== n || s != null) {
      ...
      for (let _ of n) {
        ...
        const R = _.node.current, b = R ? new Wr(l(R), R) : null;
        _.rect.current = b, b && D.set(_.id, b);
      }
      return D;
    }
    return S;
...
function Ur(n, e) {
  return dn((t) => n ? t || (typeof e == "function" ? e(n) : n) : null, [e, n]);
}
function vd(n, e) {
  return Ur(n, e);
}
...
const Ci = [];
function wd(n) {
  const e = F(n), t = dn((r) => n ? r && r !== Ci && n && e.current && n.parentNode === e.current.parentNode ? r : Jn(n) : Ci, [n]);
  return j(() => {
    e.current = n;
  }, [n]), t;
}
function _d(n) {
  const [e, t] = Z(null), r = F(n), i = J((s) => {
    const a = dr(s.target);
    a && t((o) => o ? (o.set(a, br(a)), new Map(o)) : null);
  }, []);
  return j(() => {
    const s = r.current;
    if (n !== s) {
  ...
  }, [i, n]), B(() => n.length ? e ? Array.from(e.values()).reduce((s, a) => Dt(s, a), je) : Gs(n) : je, [n, e]);
}
function Ei(n, e) {
  e === void 0 && (e = []);
  const t = F(null);
...
function Us(n) {
  return B(() => n ? Yc(n) : null, [n]);
}
const ki = [];
function kd(n, e) {
  e === void 0 && (e = Bt);
  const [t] = n, r = Us(t ? xe(t) : null), [i, s] = Z(ki);
  function a() {
    s(() => n.length ? n.map((l) => $s(l) ? r : new Wr(e(l), l)) : ki);
  }
  const o = Qn({
    callback: a
  });
...
const Dd = {
  ...
  over: null,
  measureDroppableContainers: In
}, hn = /* @__PURE__ */ Xe(Ys), Ks = /* @__PURE__ */ Xe(Dd);
function Td() {
  return {
    draggable: {
      active: null,
  ...
  switch (e.type) {
    ...
    case de.RegisterDroppable: {
      const {
        ...
        id: r
      } = t, i = new Yt(n.droppable.containers);
      return i.set(r, t), {
        ...n,
        droppable: {
          ...n.droppable,
    ...
    case de.SetDroppableDisabled: {
      ...
      if (!s || r !== s.key)
        return n;
      const a = new Yt(n.droppable.containers);
      return a.set(t, {
        ...s,
        disabled: i
      }), {
    ...
    case de.UnregisterDroppable: {
      ...
      if (!i || r !== i.key)
        return n;
      const s = new Yt(n.droppable.containers);
      return s.delete(t), {
        ...n,
        droppable: {
          ...n.droppable,
...
function Od(n) {
  ...
  const {
    ...
    activatorEvent: r,
    draggableNodes: i
  } = Fe(hn), s = On(r), a = On(t?.id);
  return j(() => {
    if (!e && !r && s && a != null) {
      if (!Xn(s) || document.activeElement === s.target)
        return;
      const o = i.get(a);
      if (!o)
        return;
...
const zd = /* @__PURE__ */ Po(function(e) {
  var t, r, i, s;
  let {
    id: a,
    accessibility: o,
    ...
    children: d,
    sensors: c = Rd,
    collisionDetection: u = Wc,
    measuring: h,
    modifiers: m,
    ...g
  } = e;
  const v = Bo(Ad, void 0, Td), [w, S] = v, [D, _] = Oc(), [R, b] = Z(dt.Uninitialized), x = R === dt.Initialized, {
    draggable: {
      active: y,
      nodes: E,
      translate: L
    ...
    return y != null ? {
      ...
      data: (ge = C?.data) != null ? ge : Nd,
      rect: N
    } : null;
  }, [y, C]), G = F(null), [ae, oe] = Z(null), [re, ne] = Z(null), te = en(g, Object.values(g)), ve = un("DndDescribedBy", a), We = B(() => T.getEnabled(), [T]), ue = Md(h), {
    droppableRects: he,
    ...
    config: ue.droppable
  }), pe = md(E, y), Ge = B(() => re ? Mn(re) : null, [re]), ye = Wa(), _e = vd(pe, ue.draggable.measure);
  Id({
  ...
  const K = _i(pe, ue.draggable.measure, _e), Qe = _i(pe ? pe.parentElement : null), Ce = F({
    activatorEvent: null,
    active: null,
    activeNode: pe,
    collisionRect: null,
  ...
  }), Le = T.getNodeFor((t = Ce.current.over) == null ? void 0 : t.id), q = Sd({
    measure: ue.dragOverlay.measure
  }), ie = (r = q.nodeRef.current) != null ? r : pe, ce = x ? (i = q.rect) != null ? i : K : null, it = !!(q.nodeRef.current && q.rect), mn = xd(it ? null : K), Ft = Us(ie ? xe(ie) : null), Ve = wd(x ? Le ?? pe : null), _t = kd(Ve), bt = Xs(m, {
    transform: {
      x: L.x - mn.x,
      y: L.y - mn.y,
      scaleX: 1,
    ...
    windowRect: Ft
  }), pn = Ge ? Dt(Ge, L) : null, gn = _d(Ve), rr = Ei(gn), vn = Ei(gn, [K]), et = Dt(bt, rr), Ct = ce ? Zc(ce, bt) : null, Ht = A && Ct ? u({
    active: A,
    collisionRect: Ct,
    droppableRects: he,
    droppableContainers: We,
    pointerCoordinates: pn
  }) : null, ei = Ls(Ht, "id"), [st, ti] = Z(null), Ba = it ? bt : Dt(bt, vn), Fa = Gc(Ba, (s = st?.rect) != null ? s : null, K), ir = F(null), ni = J(
    (ge, ke) => {
      let {
        sensor: Se,
        options: at
      ...
      if (!Te)
        return;
      const Re = ge.nativeEvent, Ze = new Se({
        active: G.current,
        activeNode: Te,
        event: Re,
        options: at,
        ...
        return async function() {
          ...
          if (Ue && $t) {
            ...
            lt = {
              ...
              delta: $t,
              over: jt
            }, me === de.DragEnd && typeof Wt == "function" && await Promise.resolve(Wt(lt)) && (me = de.DragCancel);
          }
          G.current = null, yn(() => {
            S({
              type: me
            }), b(dt.Uninitialized), ti(null), oe(null), ne(null), ir.current = null;
            const Wt = me === de.DragEnd ? "onDragEnd" : "onDragCancel";
            if (lt) {
              const sr = te.current[Wt];
              sr?.(lt), D({
                type: Wt,
                event: lt
              });
    ...
    const Te = Se.nativeEvent, Re = E.get(at);
    if (
    ...
    }, G.current = at, ni(Se, ke));
  }, [E, ni]), ri = pd(c, Ha);
  Cd(c), He(() => {
    K && R === dt.Initializing && b(dt.Initialized);
  }, [K, R]), j(
    () => {
      const {
        onDragMove: ge
    ...
    () => {
      ...
      const {
        onDragOver: Re
      } = te.current, Ze = at.get(ei), Et = Ze && Ze.rect.current ? {
        id: Ze.id,
  ...
  }, [A, pe, Ht, Ct, E, ie, ce, he, T, st, Ve, et]), ud({
    ...ye,
    delta: L,
    draggingRect: Ct,
    pointerCoordinates: pn,
  ...
  const ja = B(() => ({
    ...
    measuringScheduled: Je,
    windowRect: Ft
  }), [A, pe, K, re, Ht, Qe, q, E, T, he, st, we, Ve, _t, ue, Je, Ft]), $a = B(() => ({
    activatorEvent: re,
    activators: ri,
    active: A,
    activeNodeRect: K,
    ...
    over: st,
    measureDroppableContainers: we
  }), [re, ri, A, K, S, ve, E, st, we]);
  return V.createElement(zs.Provider, {
    value: _
  }, V.createElement(hn.Provider, {
    value: $a
  }, V.createElement(Ks.Provider, {
    value: ja
  }, V.createElement(er.Provider, {
    value: Fa
  }, d)), V.createElement(Od, {
...
}), Ld = /* @__PURE__ */ Xe(null), Si = "button", Pd = "Draggable";
function Bd(n) {
  let {
    id: e,
    data: t,
  ...
  const s = un(Pd), {
    ...
    tabIndex: v = 0
  } = i ?? {}, w = l?.id === e, S = Fe(w ? er : Ld), [D, _] = An(), [R, b] = An(), x = Ed(a, e), y = en(t);
  He(
    () => (u.set(e, {
      id: e,
      key: s,
  ...
  const E = B(() => ({
    ...
    tabIndex: v,
    "aria-disabled": r,
    "aria-pressed": w && m === Si ? !0 : void 0,
    "aria-roledescription": g,
    "aria-describedby": c.draggable
  }), [r, m, v, w, g, c.draggable]);
  return {
    active: l,
    activatorEvent: o,
    activeNodeRect: d,
...
function $d(n) {
  ...
  const [r, i] = Z(null), [s, a] = Z(null), o = On(t);
  return !t && !r && o && i(o), He(() => {
    if (!s)
      return;
  ...
  }, [e, r, s]), V.createElement(V.Fragment, null, t, r ? Fo(r, {
    ref: a
  }) : null);
}
const Wd = {
...
const Vd = {
  position: "fixed",
  touchAction: "none"
}, Zd = (n) => Xn(n) ? "transform 250ms ease" : void 0, Ud = /* @__PURE__ */ Ee((n, e) => {
  let {
    as: t,
    activatorEvent: r,
    adjustScale: i,
  ...
  const u = i ? d : {
    ...
    transformOrigin: i && r ? Bc(r, o) : void 0,
...
function Xd(n) {
  ...
  return Kn((s, a) => {
    ...
    const {
      transform: c
    } = xe(a).getComputedStyle(a), u = Bs(c);
    if (!u)
      return;
    const h = typeof e == "function" ? e : Jd(e);
    return Vs(l, i.draggable.measure), h({
      active: {
        id: s,
        data: o.data,
        node: l,
...
const eu = /* @__PURE__ */ V.memo((n) => {
  ...
  return V.createElement(Gd, null, V.createElement($d, {
    animation: T
  }, u && y ? V.createElement(Ud, {
    key: y,
    id: u.id,
    ref: C,
    as: o,
...
}, ea = "Sortable", ta = /* @__PURE__ */ V.createContext({
  activeIndex: -1,
  containerId: ea,
  disableTransforms: !1,
  items: [],
...
function iu(n) {
  ...
  } = Js(), u = un(ea, t), h = o.rect !== null, m = B(() => r.map((x) => typeof x == "object" && "id" in x ? x.id : x), [r]), g = a != null, v = a ? m.indexOf(a.id) : -1, w = d ? m.indexOf(d.id) : -1, S = F(m), D = !nu(m, S.current), _ = w !== -1 && v === -1 || D, R = ru(s);
  He(() => {
    D && g && c(m);
  }, [D, m, g, c]), j(() => {
    S.current = m;
  ...
  const b = B(
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [v, u, R.draggable, R.droppable, _, m, w, l, h, i]
  );
  return V.createElement(ta.Provider, {
    value: b
  }, e);
}
const su = (n) => {
  ...
  duration: 200,
  easing: "ease"
}, na = "transform", lu = /* @__PURE__ */ mt.Transition.toString({
  property: na,
  duration: 0,
  easing: "linear"
}), cu = {
...
function uu(n) {
  ...
  const {
    ...
    useDragOverlay: S,
    strategy: D
  } = Fe(ta), _ = hu(r, m), R = c.indexOf(a), b = B(() => ({
    sortable: {
      containerId: u,
      index: R,
      items: c
    ...
    ...i
  }), [u, i, R, c]), x = B(() => c.slice(c.indexOf(a)), [c, a]), {
    rect: y,
    node: E,
    isOver: L,
    setNodeRef: T
  ...
  }), We = _c(T, ae), ue = !!C, he = ue && !g && wn(h) && wn(w), we = !S && re, Je = we && he ? ve : null, Ge = he ? Je ?? (o ?? D)({
    rects: v,
    activeNodeRect: A,
    activeIndex: h,
    overIndex: w,
  ...
  return j(() => {
    ue && K.current.newIndex !== ye && (K.current.newIndex = ye), u !== K.current.containerId && (K.current.containerId = u), c !== K.current.items && (K.current.items = c);
  }, [ue, ye, u, c]), j(() => {
...
const fu = [Y.Down, Y.Right, Y.Up, Y.Left], mu = (n, e) => {
  let {
    context: {
      active: t,
      collisionRect: r,
  ...
  if (fu.includes(n.code)) {
    ...
    if (c === a?.id && d.length > 1 && (c = d[1].id), c != null) {
      ...
      if (g && m && u && h) {
        const w = Jn(g).some((x, y) => o[y] !== x), S = ra(u, h), D = pu(u, h), _ = w || !S ? {
          x: 0,
          y: 0
        } : {
          x: D ? r.width - m.width : 0,
          y: D ? r.height - m.height : 0
        }, R = {
          x: m.left,
          y: m.top
        };
        return _.x && _.y ? R : tn(R, _);
      }
    }
  }
};
...
function pu(n, e) {
  return !Ln(n) || !Ln(e) || !ra(n, e) ? !1 : n.data.current.sortable.index < e.data.current.sortable.index;
}
const Ni = ({ id: n, children: e }) => {
  const { attributes: t, listeners: r, setNodeRef: i, transform: s, transition: a } = uu({
    id: n
  }), o = {
...
}, Yr = ({ blocks: n, sortable: e = !1, onSort: t = () => {
}, main: r = !1 }) => {
  const [i, s] = Z([]);
  Ki(() => {
    s(n.map((u, h) => ({
  ...
  const [a, o] = Z(null), l = Lc(pi(Zr), pi(Gr, {
    coordinateGetter: mu
  })), d = (u) => {
    o(u.active.id);
  }, c = (u) => {
...
Yr.displayName = "GroupMasonry";
Yr.__isPageLayoutGroup = !0;
const gu = Ee(function({ children: e, aside: t, header: r, variant: i = "main-aside" }, s) {
  return process.env.NODE_ENV === "development" && Os("Page", e, ["block", "group"]), f("div", {
    ref: s,
    className: "h-full",
    children: M("div", {
  ...
  Page: Me("Page", gu),
  Block: Me("Block", qn),
  BlockContent: Me("BlockContent", bc),
  Group: Me("Group", Hr),
  GroupGrid: Me("GroupGrid", Un),
  GroupMasonry: Me("GroupMasonry", Yr)
}, em = Ie({
  name: "StandardLayout",
  type: "layout"
}, _s), tm = Ie({
...
function yu(n, e) {
  for (var t = 0; t < e.length; t++) {
    var r = e[t];
    r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(n, aa(r.key), r);
  }
}
function bu(n, e, t) {
  return e && yu(n.prototype, e), Object.defineProperty(n, "prototype", { writable: !1 }), n;
}
function xu(n, e, t) {
  return e = Pn(e), wu(n, ia() ? Reflect.construct(e, t || [], Pn(n).constructor) : e.apply(n, t));
}
function wu(n, e) {
...
function Cu(n, e) {
  ...
  n.prototype = Object.create(e && e.prototype, { constructor: { value: n, writable: !0, configurable: !0 } }), Object.defineProperty(n, "prototype", { writable: !1 }), e && _r(n, e);
}
function _r(n, e) {
...
function sa(n, e, t) {
  return e = aa(e), e in n ? Object.defineProperty(n, e, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : n[e] = t, n;
}
function aa(n) {
  var e = Eu(n, "string");
...
var tr = /* @__PURE__ */ (function(n) {
  function e() {
    return vu(this, e), xu(this, e, arguments);
  }
  return Cu(e, n), bu(e, [{
    key: "render",
    value: function() {
...
function Nu(n) {
  var e = n.option, t = n.isActive, r = Su(n, ku);
  return typeof e == "string" ? /* @__PURE__ */ V.createElement(ai, Kt({
    option: /* @__PURE__ */ V.createElement(Wo, Kt({
      type: e
    }, r)),
    isActive: t,
    shapeType: "symbols"
  }, r)) : /* @__PURE__ */ V.createElement(ai, Kt({
    option: e,
    isActive: t,
    shapeType: "symbols"
  }, r));
...
function Ae(n) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? Di(Object(t), !0).forEach(function(r) {
      ht(n, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t)) : Di(Object(t)).forEach(function(r) {
...
function Tu(n, e, t) {
  return e && Ti(n.prototype, e), t && Ti(n, t), Object.defineProperty(n, "prototype", { writable: !1 }), n;
}
function Au(n, e, t) {
  return e = Bn(e), Ou(n, oa() ? Reflect.construct(e, t || [], Bn(n).constructor) : e.apply(n, t));
}
function Ou(n, e) {
...
var fn = /* @__PURE__ */ (function(n) {
  function e() {
    ...
    for (var r = arguments.length, i = new Array(r), s = 0; s < r; s++)
      i[s] = arguments[s];
    return t = Au(this, e, [].concat(i)), ht(t, "state", {
    ...
    }), ht(t, "id", Ko("recharts-scatter-")), t;
  }
  return Iu(e, n), Tu(e, [{
    key: "renderSymbolsStatically",
    value: function(r) {
      var i = this, s = this.props, a = s.shape, o = s.activeShape, l = s.activeIndex, d = ar(this.props, !1);
      return r.map(function(c, u) {
        var h = l === u, m = h ? o : a, g = Ae(Ae({}, d), c);
        return /* @__PURE__ */ V.createElement(Gt, Xt({
          className: "recharts-scatter-symbol",
          key: "symbol-".concat(c?.cx, "-").concat(c?.cy, "-").concat(c?.size, "-").concat(u)
        }, Go(i.props, c, u), {
          role: "img"
        }), /* @__PURE__ */ V.createElement(Nu, Xt({
          option: m,
          isActive: h,
          key: "symbol-".concat(u)
        }, g)));
    ...
    value: function() {
      ...
      return /* @__PURE__ */ V.createElement(Vo, {
        begin: o,
        duration: l,
        isActive: a,
        easing: d,
        ...
        var m = h.t, g = s.map(function(v, w) {
          var S = u && u[w];
          if (S) {
            var D = bn(S.cx, v.cx), _ = bn(S.cy, v.cy), R = bn(S.size, v.size);
            return Ae(Ae({}, v), {}, {
              cx: D(m),
              cy: _(m),
              size: R(m)
        ...
        return /* @__PURE__ */ V.createElement(Gt, null, r.renderSymbolsStatically(g));
      });
    }
  }, {
    key: "renderSymbols",
    value: function() {
      ...
      return s && i && i.length && (!a || !us(a, i)) ? this.renderSymbolsWithAnimation() : this.renderSymbolsStatically(i);
    }
  }, {
    key: "renderErrorBar",
    value: function() {
      ...
      if (r && !this.state.isAnimationFinished)
        return null;
      var i = this.props, s = i.points, a = i.xAxis, o = i.yAxis, l = i.children, d = hs(l, Zo);
    ...
    key: "renderLine",
    value: function() {
      var r = this.props, i = r.points, s = r.line, a = r.lineType, o = r.lineJointType, l = ar(this.props, !1), d = ar(s, !1), c, u;
      if (a === "joint")
        c = i.map(function(_) {
          return {
            x: _.cx,
        ...
        var h = Uo(i), m = h.xmin, g = h.xmax, v = h.a, w = h.b, S = function(R) {
          return v * R + w;
        };
        c = [{
          x: m,
      ...
      return /* @__PURE__ */ V.isValidElement(s) ? u = /* @__PURE__ */ V.cloneElement(s, D) : qo(s) ? u = s(D) : u = /* @__PURE__ */ V.createElement(Yo, Xt({}, D, {
        type: o
      })), /* @__PURE__ */ V.createElement(Gt, {
    ...
    value: function() {
      ...
      if (i || !s || !s.length)
        return null;
      var w = this.state.isAnimationFinished, S = Ka("recharts-scatter", o), D = l && l.allowDataOverflow, _ = d && d.allowDataOverflow, R = D || _, b = kt(g) ? this.id : g;
      return /* @__PURE__ */ V.createElement(Gt, {
        className: S,
        clipPath: R ? "url(#clipPath-".concat(b, ")") : null
      }, D || _ ? /* @__PURE__ */ V.createElement("defs", null, /* @__PURE__ */ V.createElement("clipPath", {
        ...
        width: D ? h : h * 2,
        height: _ ? m : m * 2
      }))) : null, a && this.renderLine(), this.renderErrorBar(), /* @__PURE__ */ V.createElement(Gt, {
        key: "recharts-scatter-symbols"
      }, this.renderSymbols()), (!v || w) && fs.renderCallByParent(this.props, s));
    }
  }], [{
...
ht(fn, "defaultProps", {
  ...
  shape: "circle",
  hide: !1,
  isAnimationActive: !Xo.isSsr,
  animationBegin: 0,
  animationDuration: 400,
  animationEasing: "linear"
});
ht(fn, "getComposedData", function(n) {
  var e = n.xAxis, t = n.yAxis, r = n.zAxis, i = n.item, s = n.displayedData, a = n.xAxisTicks, o = n.yAxisTicks, l = n.offset, d = i.props.tooltipType, c = hs(i.props.children, Jo), u = kt(e.dataKey) ? i.props.dataKey : e.dataKey, h = kt(t.dataKey) ? i.props.dataKey : t.dataKey, m = r && r.dataKey, g = r ? r.range : tr.defaultProps.range, v = g && g[0], w = e.scale.bandwidth ? e.scale.bandwidth() : 0, S = t.scale.bandwidth ? t.scale.bandwidth() : 0, D = s.map(function(_, R) {
    var b = _n(_, u), x = _n(_, h), y = !kt(m) && _n(_, m) || "-", E = [{
      name: kt(e.dataKey) ? i.props.name : e.name || e.dataKey,
      unit: e.unit || "",
      value: b,
      payload: _,
      dataKey: u,
      ...
      name: kt(t.dataKey) ? i.props.name : t.name || t.dataKey,
      unit: t.unit || "",
      value: x,
      payload: _,
      dataKey: h,
    ...
    var L = oi({
      ...
      index: R,
      dataKey: h
    }), C = y !== "-" ? r.scale(y) : v, N = Math.sqrt(Math.max(C, 0) / Math.PI);
    return Ae(Ae({}, _), {}, {
      cx: L,
      cy: T,
      x: L - N,
...
const Pu = (n) => {
...
}, Bu = ({ dataConfig: n, data: e, xAxis: t, yAxis: r = {
  hide: !0
}, label: i = !1, hideTooltip: s = !1, hideGrid: a = !1, aspect: o, legend: l, showValueUnderLabel: d = !1, bar: c, line: u, scatter: h, onClick: m }, g) => {
  const v = nl(e), w = c?.categories ? Array.isArray(c.categories) ? c.categories : [c.categories] : [], S = u?.categories ? Array.isArray(u.categories) ? u.categories : [u.categories] : [], D = h?.categories ? Array.isArray(h.categories) ? h.categories : [h.categories] : [], _ = [...w, ...S, ...D], R = Math.max(...v.flatMap((y) => _.map((E) => rl(r?.tickFormatter ? r.tickFormatter(`${y[E]}`) : `${y[E]}`)))), b = [c, u, h].filter((y) => y?.axisPosition === "left"), x = [c, u, h].filter((y) => y?.axisPosition === "right");
  return f(il, {
    config: n,
    ref: g,
    aspect: o,
    children: M(Lu, {
      ...
      children: [!s && f(sl, {
        ...
        ...li(r),
        tick: !0,
        width: r.width ?? R + 20 + (x.length > 0 && b[0]?.axisLabel ? 20 : 0),
        ...
        orientation: "right",
        tick: !0,
        width: r.width ?? R + 20 + (b.length > 0 && x[0]?.axisLabel ? 20 : 0),
        ...
        hide: t?.hide,
        tick: d ? (y) => {
          const { x: E, y: L, payload: T } = y, C = e.find((G) => G.label === T.value)?.values || "", N = Object.keys(C).length === 1 ? Object.values(C)?.[0] : void 0, A = N !== void 0 && r.tickFormatter ? r.tickFormatter(`${N}`) : N.toLocaleString();
          return M("g", {
        ...
        isAnimationActive: !1,
        dataKey: String(y),
        fill: n[y].color ? Zt(n[y].color) : or(E),
        radius: 4,
        maxBarSize: 32,
        children: i && f(fs, {
          position: "top",
      ...
      }, `bar-${String(y)}`)), S.map((y, E) => f(ms, {
        type: u?.lineType ?? "natural",
        dataKey: String(y),
        stroke: n[y].color ? Zt(n[y].color) : or(w.length + E),
        strokeWidth: 2,
        dot: u?.dot ?? !1,
        isAnimationActive: !1,
        yAxisId: u?.axisPosition === "right" ? "right" : void 0
      }, `line-${String(y)}`)), D.map((y, E) => f(fn, {
        dataKey: String(y),
        fill: n[y].color ? Zt(n[y].color) : or(w.length + S.length + E),
        r: 4,
        isAnimationActive: !1,
        yAxisId: h?.axisPosition === "right" ? "right" : void 0,
        shape: Pu(String(y))
      }, `scatter-${String(y)}`)), l && f(ul, {
        content: f(hl, {
          nameKey: "label"
        }),
        align: "center",
...
}, Fu = vs(Bu), Hu = ({ value: n, max: e = 100, label: t, color: r }, i) => {
  const s = r ? Zt(r) : Zt("categorical-1"), a = n / e * 100;
  return M("div", {
  ...
  const t = xl(), r = t(e.value, {
    formatterOptions: {
      decimalPlaces: 2
    }
  }), i = $u(e.trend), s = t(e.comparison), a = wl(r.numericValue, r.formatterOptions), o = ci(s.numericValue), l = ci(r.numericValue), d = B(() => {
    if (!(!o || !i.show) && !(!o || !l))
      return (l - o) / o * 100;
  }, [l, o, i.show]);
  return M("div", {
...
ca.displayName = "F0BigNumber";
const Gu = Xi(ca, Wu), um = Me("F0BigNumber", Gu), da = {
  background: {
...
const ah = vt({
...
}), oh = ["sm", "md", "lg", "xl"], xa = Ee(({ display: n, position: e, padding: t, paddingX: r, paddingY: i, paddingTop: s, paddingBottom: a, paddingLeft: o, paddingRight: l, margin: d, marginX: c, marginY: u, marginTop: h, marginBottom: m, marginLeft: g, marginRight: v, gap: w, columns: S, rows: D, colSpan: _, colStart: R, rowSpan: b, width: x, height: y, minWidth: E, minHeight: L, maxWidth: T, maxHeight: C, background: N, borderColor: A, border: G, borderTop: ae, borderBottom: oe, borderLeft: re, borderRight: ne, borderRadius: te, borderRadiusTopLeft: ve, borderRadiusTopRight: We, borderRadiusBottomLeft: ue, borderRadiusBottomRight: he, borderStyle: we, overflow: Je, overflowX: pe, overflowY: Ge, divider: ye, dividerColor: _e, alignItems: K, justifyContent: Qe, flexDirection: Ce, flexWrap: Le, grow: q, shrink: ie, sm: ce, md: it, lg: mn, xl: Ft, ...Ve }, _t) => {
  const bt = ae && ae !== "none" || oe && oe !== "none" || re && re !== "none" || ne && ne !== "none", pn = G && G !== "none" || bt, gn = {
    sm: ce,
    md: it,
    lg: mn,
    xl: Ft
  ...
  return f("div", {
    ...
    className: X(bt && "border-0", ah({
      ...
      grow: q,
      shrink: ie
    }), rr, pn && !A && "border-f1-border", ye && !_e && "divide-f1-border", "scrollbar-macos"),
    ...Ve
  });
});
xa.displayName = "F0Box";
const hm = Ie({
  name: "F0Box",
  type: "layout"
}, xa), fm = Xa.filter(
  (n) => n !== "ai"
), mm = Ji, pm = ["default", "outline", "neutral"], gm = Ji, vm = ["sm", "md", "lg"], ym = ["compact", "expanded"], bm = Ja, xm = [
  "viridian",
  "malibu",
  "yellow",
  "purple",
  ...
  const [t, r] = Z(!1), i = f(En, {
    label: `+${n}`
  });
  return e?.length ? M(Qi, {
    open: t,
    onOpenChange: r,
    children: [f(es, {
      asChild: !0,
...
Er.displayName = "ChipCounter";
const wa = ({ chips: n, max: e = 4, remainingCount: t, layout: r = "compact" }) => {
  if (r === "fill")
    return f(Qa, {
      items: n,
      ...
      renderOverflowIndicator: (l) => f(Er, {
        count: (t ?? 0) + l,
...
const wm = Me("F0ChipList", wa), _m = eo, lh = vt({
...
}), Cm = ({ title: n, description: e, action: t, link: r, icon: i, variant: s = "neutral" }) => {
  const a = F(null);
  return f("div", {
    ref: a,
    className: "@container",
...
function uh({ filters: n, value: e, onChange: t, height: r, width: i = 600, className: s, showApplyButton: a = !0, applyButtonLabel: o }) {
  const l = Vn(), [d, c] = Z(null), [u, h] = Z(e);
  j(() => {
    h(e);
  }, [e]), j(() => {
    if (!d && n) {
  ...
  const m = (w, S) => {
    ...
    t(u);
  }, v = B(() => r || Object.entries(n).reduce((S, [D, _]) => {
    const R = ii(_.type);
    return Math.max(S, R?.formHeight || dh);
  }, 0), [n, r]);
...
uh.displayName = "F0FilterPickerContent";
const _a = "gap-4", hh = "mt-6", fh = "max-w-[720px]", yt = "md", Ca = Xe(null);
function Ea() {
  const n = Fe(Ca);
  if (!n)
...
function Kr(n) {
  const e = n;
  return e._f0Config ? e._f0Config : ka.get(n);
}
function km(n) {
  return Kr(n) !== void 0;
}
function $e(n) {
  let e = n;
  for (; se(e, "ZodOptional") || se(e, "ZodNullable") || se(e, "ZodDefault"); )
    e = e._def.innerType;
  return e;
}
function mh(n, e) {
  ...
  if ("options" in e && e.options || "source" in e && e.source)
    return "select";
  const t = $e(n);
  return se(t, "ZodString") ? "rows" in e && e.rows ? "textarea" : "text" : se(t, "ZodNumber") ? "number" : se(t, "ZodBoolean") ? "switch" : se(t, "ZodDate") ? "date" : se(t, "ZodEnum") || se(t, "ZodArray") && ("options" in e && e.options || "source" in e && e.source) ? "select" : se(t, "ZodObject") && "render" in e && e.render ? "custom" : "text";
}
function Sa(n) {
  return se(n, "ZodOptional") || se(n, "ZodNullable") || se(n, "ZodDefault") && Sa(n._def.innerType);
}
...
function gh(n) {
  const e = $e(n);
  return se(e, "ZodString") ? (e._def.checks || []).some((r) => r.kind === "min" ? (r.value ?? 0) >= 1 : ph.has(r.kind)) : !1;
}
function Ra(n) {
  if (Sa(n))
    return !1;
  const e = $e(n);
  return se(e, "ZodString") ? gh(n) : !0;
}
function vh(n, e) {
  const t = e[n.fieldId];
  if ("equalsTo" in n)
...
function nr(n, e) {
  return typeof n == "function" ? n({ values: e }) : vh(n, e);
}
function Xr(n, e) {
...
function yh(n) {
  const e = $e(n);
  return se(e, "ZodLiteral") && e._def.value === !0;
}
function bh({ field: n, formField: e }) {
...
function xh({ field: n, formField: e, error: t, isValidating: r, required: i }) {
  const s = {
    id: n.id,
    label: n.label,
...
function Na({ field: n, formField: e, error: t, loading: r }) {
  const i = B(() => wh(e.value, n.granularities), [e.value, n.granularities]), s = (a) => {
    e.onChange(_h(a));
  };
  return f(ys, {
    label: n.label,
...
function Da({ field: n, formField: e, error: t, loading: r }) {
  const i = B(() => kr(e.value), [e.value]), s = J((a) => {
    if (!a) {
      e.onChange(void 0);
      return;
    }
...
function Eh({ field: n, formField: e, error: t, loading: r }) {
  const i = e.value, s = B(() => kr(i), [i]), a = J((h) => {
    if (!h) {
      e.onChange(void 0);
      return;
    }
    ...
    if (!i) {
      ...
      g.setHours(0, 0, 0, 0), e.onChange(fr(g, m));
      return;
    }
    e.onChange(fr(i, m));
  }, [e, i]), l = B(() => ({
...
function Rh({ field: n, formField: e, error: t, loading: r }) {
  const i = B(() => kh(e.value), [e.value]), s = (o) => {
    e.onChange(Sh(o));
...
function Dh({ field: n, formField: e }) {
  const t = e.value;
  return f(kl, {
    title: n.label,
    placeholder: n.placeholder ?? "",
...
function Oh(n) {
  const { field: e } = n;
  return "source" in e && e.source !== void 0 && e.mapOptions !== void 0 ? f(Ah, {
    ...n,
    field: e
  }) : "options" in e && e.options !== void 0 ? f(Th, {
    ...n,
    field: e
  }) : null;
}
...
function Ih({ field: n, formField: e }) {
  const t = n.validation && Mh(n.validation);
  return f(oo, {
    ...e,
    title: n.label,
    disabled: n.disabled,
...
function Ph({ field: n, formField: e, error: t, loading: r }) {
  const i = n.inputType ?? "text", s = n.placeholder ?? zh[i] ?? void 0, a = Lh[i];
  return f(ss, {
    ...e,
    label: n.label,
    type: i,
...
function Bh({ field: n, formField: e, error: t, loading: r }) {
  return f(Sl, {
    ...e,
    label: n.label,
    placeholder: n.placeholder,
...
function Fh({ field: n, formField: e, fieldState: t, isSubmitting: r, isRequired: i, values: s }) {
  const a = !!t.error, { isValidating: o } = t, l = Xr(n.disabled, s) || r, d = {
    error: a,
    loading: o
  };
  switch (n.type) {
...
function Jr({ field: n, sectionId: e }) {
  const t = zr(), r = t.watch(), { isSubmitting: i } = t.formState, { formName: s } = Ea(), { forms: a } = Vn(), o = Xr(n.disabled, r), l = F(o);
  j(() => {
    const m = l.current;
  ...
  const d = !n.renderIf || nr(n.renderIf, r), c = n.type !== "checkbox" && n.type !== "custom", u = n.validation && Ra(n.validation), h = rn(s, e, n.id);
  return d ? f(di, {
    control: t.control,
    name: n.id,
    render: ({ field: m, fieldState: g }) => M(Rl, {
      id: h,
...
function Ta({ row: n, sectionId: e }) {
  return f("div", {
    className: `flex xs:flex-row flex-col ${_a} [&>*]:flex-1`,
    children: n.fields.map((t) => f(Jr, {
      field: t,
      sectionId: e
    }, t.id))
  });
...
function Aa({ fields: n }) {
  const e = zr(), { watch: t, setValue: r } = e, { isSubmitting: i } = e.formState, s = t(), a = B(() => n.filter((h) => !h.renderIf || nr(h.renderIf, s)), [n, s]), o = B(() => Object.fromEntries(a.map((h) => [h.id, Xr(h.disabled, s) || i])), [a, i, s]), l = F({});
  j(() => {
  ...
  const d = B(() => a.map((h) => ({
    ...
    disabled: o[h.id] ?? !1,
    required: !!(h.validation && Hh(h.validation))
  })), [a, o]), c = B(() => a.filter((h) => s[h.id]).map((h) => h.id), [a, s]);
  return a.length === 0 ? null : f(Al, {
    multiple: !0,
    isToggle: !0,
    grouped: !0,
    items: d,
...
function $h({ section: n }) {
  const t = zr().watch(), { formName: r } = Ea(), { title: i, description: s, renderIf: a, action: o, fields: l } = n.section, d = n.id;
  if (a && !nr(a, t))
    return null;
  const c = jh(l), u = rn(r, d);
  return M("section", {
    id: u,
    ...
    children: [M("div", {
      ...
      className: `flex flex-col ${_a}`,
      children: c.map((h, m) => h.type === "switchGroup" ? f(Aa, {
        fields: h.fields,
        sectionId: d
      }, `switch-group-${m}`) : h.type === "field" ? f(Jr, {
        field: h.item.field,
        sectionId: d
      }, h.item.field.id) : h.type === "row" ? f(Ta, {
        row: h.item,
        sectionId: d
      }, `row-${h.index}`) : null)
    })]
...
const $ = Object.freeze({
  status: "aborted"
}), Vt = (n) => ({ status: "dirty", value: n }), ze = (n) => ({ status: "valid", value: n }), Oi = (n) => n.status === "aborted", Mi = (n) => n.status === "dirty", Ot = (n) => n.status === "valid", Fn = (n) => typeof Promise < "u" && n instanceof Promise;
var z;
(function(n) {
...
class Q {
  ...
  async safeParseAsync(e, t) {
    const r = {
      ...
      data: e,
      parsedType: ut(e)
    }, i = this._parse({ data: e, path: r.path, parent: r }), s = await (Fn(i) ? i : Promise.resolve(i));
    return Ii(r, s);
  }
  refine(e, t) {
...
const Zh = /^c[^\s-]{8,}$/i, Uh = /^[0-9a-z]+$/, qh = /^[0-9A-HJKMNP-TV-Z]{26}$/i, Yh = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i, Kh = /^[a-z0-9_-]{21}$/i, Xh = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/, Jh = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/, Qh = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i, ef = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let mr;
const tf = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, nf = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/, rf = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/, sf = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/, af = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/, of = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/, Oa = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))", lf = new RegExp(`^${Oa}$`);
function Ma(n) {
  let e = "[0-5]\\d";
...
function uf(n, e) {
  return !!((e === "v4" || !e) && tf.test(n) || (e === "v6" || !e) && rf.test(n));
}
function hf(n, e) {
  if (!Xh.test(n))
    return !1;
...
function ff(n, e) {
  return !!((e === "v4" || !e) && nf.test(n) || (e === "v6" || !e) && sf.test(n));
}
class xt extends Q {
  _parse(e) {
    ...
    for (const s of this._def.checks)
      if (s.kind === "min")
        ...
        Qh.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
          validation: "email",
          code: k.invalid_string,
          message: s.message
        }), r.dirty());
      else if (s.kind === "emoji")
        mr || (mr = new RegExp(ef, "u")), mr.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
          validation: "emoji",
          code: k.invalid_string,
          message: s.message
        }), r.dirty());
      else if (s.kind === "uuid")
        Yh.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
          validation: "uuid",
          code: k.invalid_string,
          message: s.message
        }), r.dirty());
      else if (s.kind === "nanoid")
        Kh.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
          validation: "nanoid",
          code: k.invalid_string,
          message: s.message
        }), r.dirty());
      else if (s.kind === "cuid")
        Zh.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
          validation: "cuid",
          code: k.invalid_string,
          message: s.message
        }), r.dirty());
      else if (s.kind === "cuid2")
        Uh.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
          validation: "cuid2",
          code: k.invalid_string,
          message: s.message
        }), r.dirty());
        ...
        message: s.message
      }), r.dirty()) : s.kind === "datetime" ? df(s).test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
        code: k.invalid_string,
        validation: "datetime",
        message: s.message
      }), r.dirty()) : s.kind === "date" ? lf.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
        code: k.invalid_string,
        validation: "date",
        message: s.message
      }), r.dirty()) : s.kind === "time" ? cf(s).test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
        code: k.invalid_string,
        validation: "time",
        message: s.message
      }), r.dirty()) : s.kind === "duration" ? Jh.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
        validation: "duration",
        code: k.invalid_string,
        message: s.message
      }), r.dirty()) : s.kind === "ip" ? uf(e.data, s.version) || (i = this._getOrReturnCtx(e, i), O(i, {
        validation: "ip",
        code: k.invalid_string,
        message: s.message
      }), r.dirty()) : s.kind === "jwt" ? hf(e.data, s.alg) || (i = this._getOrReturnCtx(e, i), O(i, {
        validation: "jwt",
        code: k.invalid_string,
        message: s.message
      }), r.dirty()) : s.kind === "cidr" ? ff(e.data, s.version) || (i = this._getOrReturnCtx(e, i), O(i, {
        validation: "cidr",
        code: k.invalid_string,
        message: s.message
      }), r.dirty()) : s.kind === "base64" ? af.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
        validation: "base64",
        code: k.invalid_string,
        message: s.message
      }), r.dirty()) : s.kind === "base64url" ? of.test(e.data) || (i = this._getOrReturnCtx(e, i), O(i, {
  ...
  _parse(e) {
    ...
    for (const s of this._def.checks)
      s.kind === "int" ? ee.isInteger(e.data) || (r = this._getOrReturnCtx(e, r), O(r, {
        ...
        exact: !1,
        message: s.message
      }), i.dirty()) : s.kind === "multipleOf" ? mf(e.data, s.value) !== 0 && (r = this._getOrReturnCtx(e, r), O(r, {
...
class Ke extends Q {
  _parse(e) {
    ...
    if (i.minLength !== null && t.data.length < i.minLength.value && (O(t, {
      ...
      return Promise.all([...t.data].map((a, o) => i.type._parseAsync(new pt(t, a, t.path, o)))).then((a) => De.mergeArray(r, a));
    const s = [...t.data].map((a, o) => i.type._parseSync(new pt(t, a, t.path, o)));
    return De.mergeArray(r, s);
  }
  get element() {
...
function Rt(n) {
  if (n instanceof le) {
    ...
    ...n._def,
    type: Rt(n.element)
  }) : n instanceof ft ? ft.create(Rt(n.unwrap())) : n instanceof zt ? zt.create(Rt(n.unwrap())) : n instanceof wt ? wt.create(n.items.map((e) => Rt(e))) : n;
}
class le extends Q {
  constructor() {
  ...
  _parse(e) {
    ...
    return i.common.async ? Promise.resolve().then(async () => {
      ...
      return d;
    }).then((d) => De.mergeObjectSync(r, d)) : De.mergeObjectSync(r, l);
  }
  get shape() {
  ...
  keyof() {
    return Ia(ee.objectKeys(this.shape));
  }
}
...
class $n extends Q {
  _parse(e) {
    const { status: t, ctx: r } = this._processInputParams(e), i = (s, a) => {
      ...
      return o.valid ? ((Mi(s) || Mi(a)) && t.dirty(), { status: t.value, value: o.data }) : (O(r, {
...
class wt extends Q {
  _parse(e) {
    ...
    return r.common.async ? Promise.all(s).then((a) => De.mergeArray(t, a)) : De.mergeArray(t, s);
  }
  get items() {
...
class Mt extends Q {
  ...
  exclude(e, t = this._def) {
    return Mt.create(this.options.filter((r) => !e.includes(r)), {
      ...this._def,
      ...t
    });
  }
  ...
  _parse(e) {
    ...
    if (s.addIssue = s.addIssue.bind(s), i.type === "preprocess") {
      ...
      if (r.common.async)
        return Promise.resolve(a).then(async (o) => {
          ...
          return l.status === "aborted" ? $ : l.status === "dirty" || t.value === "dirty" ? Vt(l.value) : l;
        });
      {
        if (t.value === "aborted")
          return $;
        ...
        return o.status === "aborted" ? $ : o.status === "dirty" || t.value === "dirty" ? Vt(o.value) : o;
      }
    }
    ...
    if (i.type === "transform")
      if (r.common.async === !1) {
        ...
        return this._def.schema._parseAsync({ data: r.data, path: r.path, parent: r }).then((a) => Ot(a) ? Promise.resolve(i.transform(a.value, s)).then((o) => ({
          status: t.value,
          value: o
        })) : $);
    ee.assertNever(i);
  ...
  _parse(e) {
    ...
    if (r.common.async)
      return (async () => {
        ...
        return s.status === "aborted" ? $ : s.status === "dirty" ? (t.dirty(), Vt(s.value)) : this._def.out._parseAsync({
          data: s.value,
          path: r.path,
          parent: r
        });
...
class Ar extends Q {
  _parse(e) {
    const t = this._def.innerType._parse(e), r = (i) => (Ot(i) && (i.value = Object.freeze(i.value)), i);
    return Fn(t) ? t.then((i) => r(i)) : r(t);
  }
  unwrap() {
    return this._def.innerType;
  }
...
function Cf(n) {
  const e = $e(n);
  return se(e, "ZodString") ? (e._def.checks || []).some((r) => r.kind === "email") : !1;
}
function Ef(n) {
  const e = $e(n);
  return se(e, "ZodString") ? (e._def.checks || []).some((r) => r.kind === "url") : !1;
}
function Ui(n) {
  return Cf(n) ? "email" : Ef(n) ? "url" : "text";
}
function qi(n, e, t, r) {
  const i = {
    id: n,
  ...
  switch (r) {
    case "text": {
      const a = "inputType" in t && t.inputType ? t.inputType : Ui(e);
      return {
        ...i,
        type: "text",
        inputType: a,
    ...
    case "date": {
      const { minDate: a, maxDate: o } = pr(e);
      return {
        ...i,
        type: "date",
...
function kf(n, e) {
  return B(() => {
    ...
    for (const o of t) {
      ...
      l ? (i[l] || (i[l] = []), i[l].push(o)) : r.push(o);
    }
    r.sort((o, l) => o.position - l.position);
    for (const o of Object.keys(i))
      i[o].sort((l, d) => l.position - d.position);
    const s = [];
    s.push(...Gn(r));
    const a = e ? Object.keys(e).filter((o) => i[o]) : Object.keys(i);
    for (const o of a) {
      const l = e?.[o], d = i[o], c = {
        id: o,
        type: "section",
...
function Df(n) {
  const e = Vn(), { forms: t } = e, { name: r, schema: i, sections: s, defaultValues: a, onSubmit: o, submitConfig: l, className: d, errorTriggerMode: c = "on-blur", styling: u, formRef: h } = n, m = u?.showSectionsSidepanel ?? !1, g = l?.type === "action-bar", v = l?.label ?? "Submit", w = l?.icon === null ? void 0 : l?.icon ?? uo, S = l?.type !== "action-bar" && l?.hideSubmitButton, D = !g && !S, _ = l?.type === "action-bar" && l?.discardable, R = g ? l?.discardConfig : void 0, b = R?.label ?? t.actionBar.discard, x = R?.icon === null ? void 0 : R?.icon ?? ho, y = g ? l?.actionBarLabel ?? t.actionBar.unsavedChanges : t.actionBar.unsavedChanges, E = g && !!l?.centerActionBarInFrameContent, L = kf(i, s), T = B(() => L.filter((q) => q.type === "section").map((q) => q.id), [L]), [C, N] = Z(T[0]), A = J((q) => {
    N(q);
    const ie = rn(r, q), ce = document.getElementById(ie);
    ...
    label: s[q]?.title ?? q,
    onClick: () => A(q)
  })), [s, T, m, A]), ae = B(() => Sf(e), [e]), oe = Nf[c], re = B(() => yf(i, {
    errorMap: ae
  }), [i, ae]), ne = Il({
    resolver: re,
    mode: oe,
    defaultValues: a
  }), te = ne.formState.errors.root, { isDirty: ve, isSubmitting: We, errors: ue } = ne.formState, { hasErrors: he, errorCount: we, goToPreviousError: Je, goToNextError: pe, resetErrorNavigation: Ge } = xf({
    formName: r,
    errors: ue
  }), ye = async (q) => {
    const ie = await o(q);
    ie.success || (ie.errors && Object.entries(ie.errors).forEach(([ce, it]) => {
      ne.setError(ce, {
        message: it
      });
    }), ie.rootMessage && ne.setError("root", {
      message: ie.rootMessage
    }));
  }, _e = () => {
    ne.reset(), Ge();
  }, K = F(null);
  ...
  const Qe = Rf(L), Ce = B(() => ({
    ...
    className: X("flex flex-col", fh, d),
    children: [Qe.map((q, ie) => {
      const ce = ie !== 0 && q.type !== "section" ? "mt-4" : "";
      switch (q.type) {
        case "switchGroup":
          return f("div", {
            className: ce,
...
function Rm() {
  const [n, e] = Z(!1), [t, r] = Z(!1), i = F((c) => {
    ...
    s.current.reset();
  }, []), d = J(() => s.current ? s.current.isDirty() : !1, []);
  return {
    formRef: a.current,
    submit: o,
    reset: l,
...
const Nm = Me("F0Form", Df), Tf = Ee((n, e) => f(Fr, {
  ref: e,
  variant: "heading",
  ...n
}));
Tf.displayName = "F0Heading";
const Dm = Me(
  "F0GridStack",
  Br
), gr = 16, Af = vt({
...
function La(n, e = 0) {
  return n.flatMap((t) => [{
    id: t.id,
    depth: Math.min(e, 3)
  }, ...t.children ? La(t.children, e + 1) : []]);
}
function Of(n, e) {
  const t = n.length;
  if (t <= gr) return n;
  const r = t / (gr - 1), i = new Set(Array.from({
    length: gr - 1
...
function Mf({ items: n, activeItem: e, className: t, align: r = "left", variant: i = "dark" }) {
  const s = B(() => Of(La(n), e), [n, e]);
  return f("div", {
...
function Pf({ title: n, items: e, className: t, activeItem: r, collapsible: i = !1, showChildrenCounter: s = !1, barsAlign: a = "left", size: o = "md", variant: l = "light" }) {
  const [d, c] = Z(!1), u = F(!1), h = (g) => {
    g && !d && (u.current = !0), c(g);
  }, m = J((g) => {
  ...
  return M(go, {
    ...
    children: [f(vo, {
      asChild: !0,
      children: f("button", {
        className: X(ts(), "flex cursor-pointer items-center rounded-md px-1.5 py-1", t),
        "aria-label": n ?? "Menu",
        children: f(Mf, {
          items: e,
          activeItem: r,
...
}), Pa = Ee(({ title: n, image: e, benefits: t, actions: r, withShadow: i = !0, module: s, moduleName: a, tag: o, promoTag: l }, d) => M("div", {
  ref: d,
...
Pa.displayName = "ProductBlankslate";
function Hf({ isOpen: n, onClose: e, title: t, children: r, module: i, portalContainer: s }) {
  const [a, o] = Z(n);
  return j(() => {
    o(n);
  }, [n]), f(wo, {
...
function Am({ isOpen: n, onClose: e, title: t, image: r, benefits: i, errorMessage: s, successMessage: a, loadingState: o, nextSteps: l, closeLabel: d, primaryAction: c, modalTitle: u, modalModule: h, secondaryAction: m, portalContainer: g, tag: v, promoTag: w, showResponseDialog: S = !0 }) {
  const [D, _] = Z(n), [R, b] = Z(null), [x, y] = Z(!1), E = async () => {
    if (c?.onClick) {
      y(!0);
      try {
        await c.onClick(), _(!1), S && b("success");
      } catch {
        S && b("error");
      } finally {
        y(!1);
...
function jf({ mediaUrl: n, title: e, description: t, onClose: r, dismissible: i, width: s, trackVisibility: a, actions: o, showConfirmation: l = !0 }) {
  const [d, c] = Z(!1), u = () => {
    c(!0), r && r();
  };
  j(() => {
  ...
  return f(ln, {
    children: d ? null : M(Eo, {
      ...
      children: [M(ko, {
        ...
        className: "p-3",
        children: o.map((m) => m.type === "upsell" ? f(ws, {
          label: m.label,
          onRequest: m.onClick,
...
const $f = Ee(function({ primaryAction: e, secondaryAction: t, ...r }, i) {
  const s = (l) => l.variant === "promote" ? f(ws, {
    label: l.label,
    onRequest: async () => {
      await l.onClick();
    },
...
$f.displayName = "UpsellingBanner";
function Om({ isOpen: n, setIsOpen: e, label: t, variant: r = "promote", size: i = "md", showIcon: s = !0, side: a = "right", align: o = "center", icon: l = Ro, mediaUrl: d, title: c, description: u, width: h = "300px", trackVisibility: m, actions: g, onClick: v, hideLabel: w = !1 }) {
  const [S, D] = Z(!1), [_, R] = Z(null), [b, x] = Z(null), y = (N) => {
    e(N), v && v();
  }, E = async (N) => {
    if (N.type === "upsell") {
      x(N);
    ...
    R(null), D(!1), x(null), e(!1);
  }, T = n && !S, C = g?.map((N) => N.type === "upsell" ? {
    ...N,
    onClick: () => E(N)
  } : N);
  return M(ln, {
    ...
    }), b?.type === "upsell" && b.showConfirmation && _ && f(xs, {
      open: !0,
      onClose: L,
      success: _ === "success",
...
const Wf = Xe(null), Gf = ({ children: n, fullScreen: e = !0 }) => {
  ...
  reducedMotion: "user",
  children: n
}), Mm = ({ children: n, layout: e, link: t, privacyModeInitiallyEnabled: r, image: i, i18n: s, l10n: a, isDev: o = !1, dataCollectionStorageHandler: l, showExperimentalWarnings: d = !1 }) => f(Vf, {
  children: f(No, {
    isDev: o,
...
}), Yi = (n) => `datacollection-${n}`, Im = {
  get: async (n) => JSON.parse(
    localStorage.getItem(Yi(n)) ?? "{}"
  ),
  set: async (n, e) => {
    localStorage.setItem(Yi(n), JSON.stringify(e));
  }
};
export {
  Pm as A,
  xg as AiChatTranslationsProvider,
  rm as AreaChart,
  Bm as Await,
  im as BarChart,
  Fm as Blockquote,
  sm as CategoryBarChart,
  Hm as ChatSpinner,
  dm as ComboChart,
  Jf as Dashboard,
  Xp as DndProvider,
  ...
  Wm as F0ActionItem,
  Gm as F0AiChat,
  Vm as F0AiChatProvider,
  Zm as F0AiChatTextArea,
  Um as F0AiCollapsibleMessage,
  qm as F0AiFullscreenChat,
  Cm as F0Alert,
  wg as F0AuraVoiceAnimation,
  Ym as F0Avatar,
  Cl as F0AvatarAlert,
  Km as F0AvatarCompany,
  Jp as F0AvatarDate,
  Xm as F0AvatarEmoji,
  Jm as F0AvatarFile,
  to as F0AvatarIcon,
  Qp as F0AvatarList,
  as as F0AvatarModule,
  Qm as F0AvatarPerson,
  ep as F0AvatarTeam,
  um as F0BigNumber,
  hm as F0Box,
  Be as F0Button,
  tp as F0ButtonDropdown,
  np as F0ButtonToggle,
  eg as F0Card,
  so as F0Checkbox,
  wm as F0ChipList,
  ys as F0DatePicker,
  rp as F0Dialog,
  ip as F0DialogContext,
  sp as F0DialogProvider,
  ap as F0EventCatcherProvider,
  uh as F0FilterPickerContent,
  Nm as F0Form,
  Dm as F0GridStack,
  _g as F0HILActionConfirmation,
  Tf as F0Heading,
  Ir as F0Icon,
  ro as F0Link,
  ...
  Ds as F0Text,
  dp as F0Thinking,
  up as FullscreenChatContext,
  hp as GROUP_ID_SYMBOL,
  fp as H1,
  mp as H2,
  pp as H3,
  nm as HomeLayout,
  ...
  am as LineChart,
  bp as Ol,
  xp as OneFilterPicker,
  wp as P,
  om as PieChart,
  _p as Pre,
  Fl as PrivacyModeProvider,
  Pa as ProductBlankslate,
  og as ProductCard,
  Am as ProductModal,
  jf as ProductWidget,
  cm as ProgressBarChart,
  em as StandardLayout,
  Cp as Strong,
  Ep as Table,
  lg as Tag,
  cg as TagCounter,
  kp as Td,
  Sp as Th,
  tm as TwoColumnLayout,
  Rp as Ul,
  xs as UpsellRequestResponseDialog,
  $f as UpsellingBanner,
  ws as UpsellingButton,
  Om as UpsellingPopover,
  lm as VerticalBarChart,
  Cg as actionItemStatuses,
  Eg as aiTranslations,
  Xf as avatarVariants,
  Np as buildTranslations,
  gm as buttonDropdownSizes,
  pm as buttonDropdownVariants,
  mm as buttonSizes,
  vm as buttonToggleSizes,
  ym as buttonToggleVariants,
  fm as buttonVariants,
  dg as cardImageFits,
  ug as cardImageSizes,
  hg as createAtlaskitDriver,
  Dp as createDataSourceDefinition,
  ac as createPageLayoutBlock,
  oc as createPageLayoutBlockGroup,
  Im as dataCollectionLocalStorageHandler,
  _m as datepickerSizes,
  Ng as defaultTranslations,
  Tp as downloadTableAsExcel,
  nr as evaluateRenderIf,
  Me as experimental,
  Em as f0FormField,
  Ap as f0MarkdownRenderers,
  rn as generateAnchorId,
  Op as getAnimationVariants,
  Mp as getDataSourcePaginationType,
  Ip as getEmojiLabel,
  Kr as getF0Config,
  Sm as getSchemaDefinition,
  km as hasF0Config,
  mh as inferFieldType,
  zp as isInfiniteScrollPagination,
  Lp as isPageBasedPagination,
  se as isZodType,
  bm as linkVariants,
  Pp as modules,
  kg as oneIconSizes,
  ...
  Bp as useAiChat,
  Sg as useAiChatTranslations,
  Fp as useData,
  Hp as useDataSource,
  jp as useDefaultCopilotActions,
  pg as useDndEvents,
  gg as useDraggable,
  vg as useDroppableList,
  $p as useEmojiConfetti,
  Wp as useF0Dialog,
  Rm as useF0Form,
  Gp as useGroups,
  Vp as useMessageSourcesAction,
  Zp as useOrchestratorThinkingAction,
  yg as usePrivacyMode,
  Up as useReducedMotion,
  kf as useSchemaDefinition,
  qp as useSelectable,
  Yp as useXRay
};

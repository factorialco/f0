import { C as h, L as ge, c as ve, P as W, a as b, f as be, g as j, A as ye, B as xe, b as Ce, d as we, e as Ne, V as Le, h as M, i as G, j as H, k as Pe, l as J, S as Y, m as X, n as Se, O as Fe, o as K, p as ke, q as De, F as Q, r as Me, s as Te, t as Ie, D as Re, u as Be, v as Ae, w as Oe, x as Z, y as C, U as ee, z as $e, E as Ee, G as z, H as _e, I as ae, J as je, K as ze, M as Ue, N as Ve, Q as qe, R as We, X as Ge, T as He, W as Je, Y as Ye, Z as Xe, _ as Ke } from "./hooks-BbqtD23h.js";
import { az as Ha, $ as Ja, aB as Ya, aK as Xa, a0 as Ka, a1 as Qa, a2 as Za, a3 as er, a4 as ar, a5 as rr, a6 as sr, a7 as tr, a9 as or, aa as lr, ab as nr, ac as ir, aG as cr, ae as dr, af as ur, ag as mr, ah as fr, ak as pr, al as hr, am as gr, an as vr, ap as br, ad as yr, ao as xr, aj as Cr, aH as wr, aA as Nr, au as Lr, ax as Pr, at as Sr, aL as Fr, as as kr, ar as Dr, a8 as Mr, ai as Tr, aq as Ir, av as Rr, aC as Br, aD as Ar, aE as Or, aM as $r, aw as Er, aF as _r, aJ as jr, ay as zr, aI as Ur } from "./hooks-BbqtD23h.js";
import { jsx as e, jsxs as d, Fragment as O } from "react/jsx-runtime";
import * as $ from "react";
import Qe, { useState as g, forwardRef as I, useRef as re, useImperativeHandle as Ze, Children as ea, useEffect as se, createContext as aa } from "react";
const Fa = {
  approvals: {
...
var E = "Progress", _ = 100, [ra] = ve(E), [sa, ta] = ra(E), te = $.forwardRef(
  (a, r) => {
    const {
      __scopeProgress: s,
      value: o = null,
    ...
    const l = V(o, c) ? o : null, m = T(l) ? i(l, c) : void 0;
...
var oe = "ProgressIndicator", le = $.forwardRef(
  (a, r) => {
    const { __scopeProgress: s, ...o } = a, t = ta(oe, s);
    return /* @__PURE__ */ e(
      W.div,
      {
...
var ie = te, ia = le;
const ce = $.forwardRef(({ className: a, value: r, ...s }, o) => e(ie, {
  ref: o,
...
const ca = ({ value: a, max: r = 100, label: s, color: o }, t) => {
  const i = o ? j(o) : j("categorical-1"), n = a / r * 100;
  return d("div", {
...
const $a = Se("F0ChipList", de), ua = {
  xs: 1,
  sm: 2,
  md: 2,
  lg: 2
}, ma = I(function({ widgets: r, children: s }, o) {
  const t = re(null);
  Ze(o, () => t.current);
...
}), fa = I(function({ children: r, sideContent: s, mainColumnPosition: o = "left", sticky: t = !1 }, i) {
  return e("div", {
    ref: i,
    className: "h-full",
    children: d("div", {
...
}), ue = Qe.forwardRef(({ children: a, variant: r, className: s, ...o }, t) => e(K, {
  layout: "standard",
  children: e("section", {
    ref: t,
...
function za({ isOpen: a, onClose: r, title: s, image: o, benefits: t, errorMessage: i, successMessage: n, loadingState: c, nextSteps: l, closeLabel: m, primaryAction: f, modalTitle: w, modalModule: N, secondaryAction: u, portalContainer: P, tag: S }) {
  const [R, F] = g(a), [y, x] = g(null), [L, v] = g(!1), k = async () => {
    if (f?.onClick) {
      v(!0);
      try {
        await f.onClick(), F(!1), x("success");
      } catch {
        x("error");
      } finally {
        v(!1);
  ...
  return e(O, {
    children: m ? null : d($e, {
      ...
      children: [d(Ee, {
        ...
        className: "p-3",
        children: c.map((u) => u.type === "upsell" ? e(ae, {
          label: u.label,
          onRequest: u.onClick,
...
const xa = I(function({ primaryAction: r, secondaryAction: s, ...o }, t) {
  const i = (l) => l.variant === "promote" ? e(ae, {
    label: l.label,
    onRequest: async () => {
      await l.onClick();
    },
...
function Ua({ isOpen: a, setIsOpen: r, label: s, variant: o = "promote", size: t = "md", showIcon: i = !0, side: n = "right", align: c = "center", icon: l = ze, mediaUrl: m, title: f, description: w, width: N = "300px", trackVisibility: u, actions: P, onClick: S, hideLabel: R = !1 }) {
  ...
  return d(O, {
    ...
    }), v?.type === "upsell" && v.showConfirmation && x && e(ee, {
      open: !0,
      onClose: fe,
      success: x === "success",
...
const Ca = aa(null), wa = ({ children: a, fullScreen: r = !0 }) => {
  const s = re(null), [o, t] = g(s.current);
  return Ke(() => {
    t(s.current);
  }, []), e(Ca.Provider, {
    value: {
  ...
  reducedMotion: "user",
  children: a
}), Va = ({ children: a, layout: r, link: s, privacyModeInitiallyEnabled: o, image: t, i18n: i, l10n: n, isDev: c = !1, dataCollectionStorageHandler: l, showExperimentalWarnings: m = !1 }) => e(Na, {
  children: e(Ue, {
    isDev: c,

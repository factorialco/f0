...
import { A as Rv, bS as Tv, B as Av, C as Ov, q as Mv, c5 as Lv, E as Fv, h as Iv, F as Pv, a as zv, D as Bv, i as Vv, b as Hv, bu as jv, bv as $v, bw as Wv, bx as Gv, bz as Uv, bA as Zv, bB as qv, bC as Kv, bF as Xv, j as Yv, bG as Jv, bH as Qv, bI as ey, c1 as ty, w as ry, x as ny, y as iy, bL as sy, bM as oy, bN as ay, bO as ly, bQ as cy, bR as dy, z as uy, c as fy, bT as hy, r as my, s as py, t as gy, H as vy, m as yy, L as by, O as xy, bK as wy, v as _y, P as Cy, S as Ey, T as Sy, n as ky, bP as Dy, o as Ny, p as Ry, U as Ty, c2 as Ay, bD as Oy, bE as My, bY as Ly, k as Fy, l as Iy, b$ as Py, bX as zy, c6 as By, bW as Vy, bV as Hy, by as jy, d as $y, bU as Wy, bZ as Gy, e as Uy, c7 as Zy, bJ as qy, b_ as Ky, g as Xy, f as Yy, c4 as Jy, c0 as Qy, c3 as eb } from "./F0AiChat-B4lChBtT.js";
...
import { L as Eo, C as Qc, i as So, S as cs, a as ed, f as Yn, b as _r, c as td, A as rd, d as tn, e as ko, E as nd, g as sn, h as id, j as sd, k as od, l as ir, m as Do, u as ad, G as ld, n as cd, o as ds, p as dd, q as No, r as ud, B as Ro, X as To, Y as di, s as fd, t as Ao, v as hd, w as md, x as pd, y as gd, z as vd, D as yd, F as bd, H as xd, I as us, J as wd, K as _d, M as Cd, N as Ed, O as Sd, P as kd, Q as Dd, R as Nd, V as Rd, T as Td, U as ui, W as Oo, Z as Ad, _ as Od, $ as Md, a0 as Ld, a1 as Mo, a2 as Lo, a3 as Fd, a4 as Fo, a5 as Io, a6 as Id, a7 as Pd, a8 as zd, a9 as Bd } from "./DataCollectionStorageProvider-n3CHJHQe.js";
import { af as rb, aa as nb, ad as ib, ae as sb, ab as ob, ac as ab, ag as lb, ah as cb, ai as db, aj as ub } from "./DataCollectionStorageProvider-n3CHJHQe.js";
import { A as hb, F as mb, c as pb, b as gb, a as vb, o as yb, u as bb } from "./F0HILActionConfirmation-Di2_THkS.js";
import { defaultTranslations as wb } from "./i18n-provider-defaults.js";
import './f0.css';const Vd = {
  xs: 1,
  sm: 2,
  md: 2,
  lg: 2
}, Hd = Ke(function({ widgets: e, children: t }, n) {
  const i = Y(null);
  Gc(n, () => i.current);
  const s = cn.toArray(e).filter((o) => !!o).map((o, a) => /* @__PURE__ */ f("div", { className: "h-full @5xl:h-auto [&>div]:h-full", children: o }, a));
  return /* @__PURE__ */ f(Eo, { layout: "home", children: /* @__PURE__ */ W("div", { ref: i, className: "@container", children: [
    /* @__PURE__ */ W("div", { className: "flex flex-col gap-6 px-5 pt-4 @md:pt-2 @5xl:hidden", children: [
      /* @__PURE__ */ f(Qc, { columns: Vd, showArrows: !1, children: s }),
...
}), Po = q.forwardRef(({ children: r, variant: e, className: t, ...n }, i) => /* @__PURE__ */ f(Eo, { layout: "standard", children: /* @__PURE__ */ f(
  "section",
  {
    ref: i,
    className: ue("relative flex-1 overflow-auto", t),
    ...n,
    children: /* @__PURE__ */ f("div", { className: ue(jd({ variant: e })), children: r })
  }
) }));
Po.displayName = "StandardLayout";
const $d = ye(
  dt(
    {
      name: "StandardLayout",
...
function Xd({
  ...
  const [s, o] = ie(null), a = Y(null), l = Y(!1), c = j(() => ({
    ...e,
  ...
  co(() => {
    ...
    if (!Array.isArray(S))
      return;
    const k = S.map((L) => L.id), b = i || [], x = b.map((L) => L.id), w = b.filter(
      (L) => !k.includes(L.id)
    );
    w.length > 0 && (w.forEach((L) => {
      ...
      const A = new Map(L);
      return w.forEach((D) => {
        D.content && A.set(D.id, D.content);
      }), A;
    }), v((L) => {
      const A = new Map(L);
      return w.forEach((D) => {
        D._originalContent !== void 0 && A.set(D.id, D._originalContent);
      }), A;
    }));
    const R = S.filter(
      (L) => !x.includes(L.id)
    ...
    if (R.length > 0) {
      const L = R.map((A) => A.id).filter(Boolean);
      L.forEach((A) => {
        setTimeout(() => {
          h.current.delete(A), y.current.delete(A);
        }, Lt);
      }), R.forEach((A) => {
    ...
    if (z.length > 0) {
      ...
      z.forEach((A) => {
        ...
        if (O.length > 0) {
          const G = {}, I = ["w", "h", "x", "y"], U = ["noMove", "noResize", "locked"], H = O.filter(
            (le) => I.includes(le)
          ), re = O.filter(
            (le) => U.includes(le)
          );
          if (H.length > 0 && re.length > 0 && H.length + re.length === O.length ? re.forEach((le) => {
            const he = A[le];
            he !== void 0 && (G[le] = he);
          }) : O.forEach((le) => {
            const he = A[le];
      ...
      }), L.forEach(({ element: A, updateOptions: D }) => {
        try {
          s.update(A, D);
        } catch (O) {
...
const Jd = vt(null);
function Qd() {
  const { _reactContentMap: r } = Bo(), { getWidgetContainer: e } = Yd();
  return /* @__PURE__ */ f(Yt, { children: Array.from(r.value.entries()).map(([t, n]) => {
    const i = e(t);
    return i ? /* @__PURE__ */ f(Jd.Provider, { value: { widget: { id: t } }, children: n && Co(n, i) }, t) : (console.error(`Widget container not found for widget ${t}`), null);
  }) });
}
...
function fs(r) {
  ae.dragElement && r.pointerType !== "mouse" && Ho(r, "mouseenter");
}
function hs(r) {
  ae.dragElement && r.pointerType !== "mouse" && (_t.pointerLeaveTimeout = window.setTimeout(() => {
    delete _t.pointerLeaveTimeout, Ho(r, "mouseleave");
  }, 10));
}
class Ln {
  constructor(e, t, n) {
  ...
  _init() {
    ...
    return e.classList.add("ui-resizable-handle"), e.classList.add(`${Ln.prefix}${this.dir}`), e.style.zIndex = "100", e.style.userSelect = "none", this.host.appendChild(this.el), this.el.addEventListener("mousedown", this._mouseDown), mt && (this.el.addEventListener("touchstart", un), this.el.addEventListener("pointerdown", mn)), this;
  }
  /** call this when resize handle needs to be removed and cleaned up */
  destroy() {
    return this.moving && this._mouseUp(this.mouseDownEvent), this.el.removeEventListener("mousedown", this._mouseDown), mt && (this.el.removeEventListener("touchstart", un), this.el.removeEventListener("pointerdown", mn)), this.host.removeChild(this.el), delete this.el, delete this.host, this;
  }
  /** @internal called on mouse down on us: capture move on the entire document (mouse might not stay on us) until we release the mouse */
  _mouseDown(e) {
    this.mouseDownEvent = e, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), mt && (this.el.addEventListener("touchmove", fn), this.el.addEventListener("touchend", hn)), e.stopPropagation(), e.preventDefault();
  }
  /** @internal */
  _mouseMove(e) {
...
class Ir extends Ai {
  ...
  /** @internal */
  _setupHelper() {
    this.elOriginStyleVal = Ir._originStyleProp.map((n) => this.el.style[n]), this.parentOriginStylePosition = this.el.parentElement.style.position;
  ...
  /** @internal */
  _cleanHelper() {
    return Ir._originStyleProp.forEach((e, t) => {
...
Ir._originStyleProp = ["width", "height", "position", "left", "top", "opacity", "zIndex"];
const tu = 'input,textarea,button,select,option,[contenteditable="true"],.ui-resizable-handle';
class Pr extends Ai {
  constructor(e, t = {}) {
  ...
  enable() {
    this.disabled !== !1 && (super.enable(), this.dragEls.forEach((e) => {
      e.addEventListener("mousedown", this._mouseDown), mt && (e.addEventListener("touchstart", un), e.addEventListener("pointerdown", mn));
    }), this.el.classList.remove("ui-draggable-disabled"));
  }
  disable(e = !1) {
    this.disabled !== !0 && (super.disable(), this.dragEls.forEach((t) => {
      t.removeEventListener("mousedown", this._mouseDown), mt && (t.removeEventListener("touchstart", un), t.removeEventListener("pointerdown", mn));
  ...
  _mouseDown(e) {
    if (!ae.mouseHandled)
      return e.button !== 0 || !this.dragEls.find((t) => t === e.target) && e.target.closest(tu) || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e, delete this.dragging, delete ae.dragElement, delete ae.dropElement, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), mt && (e.currentTarget.addEventListener("touchmove", fn), e.currentTarget.addEventListener("touchend", hn)), e.preventDefault(), document.activeElement && document.activeElement.blur(), ae.mouseHandled = !0), !0;
  }
  ...
  _mouseUp(e) {
    if (document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), mt && e.currentTarget && (e.currentTarget.removeEventListener("touchmove", fn, !0), e.currentTarget.removeEventListener("touchend", hn, !0)), this.dragging) {
  ...
  _createHelper() {
    let e = this.el;
    return typeof this.option.helper == "function" ? e = this.option.helper(this.el) : this.option.helper === "clone" && (e = E.cloneNode(this.el)), e.parentElement || E.appendTo(e, this.option.appendTo === "parent" ? this.el.parentElement : this.option.appendTo), this.dragElementOriginStyle = Pr.originStyleProp.map((t) => this.el.style[t]), e;
  }
  ...
  _removeHelperStyle() {
    if (this.helper.classList.remove("ui-draggable-dragging"), this.el.gridstackNode?.grid?.el.classList.remove("grid-stack-dragging"), !this.helper?.gridstackNode?._isAboutToRemove && this.dragElementOriginStyle) {
      ...
      t.style.transition = this.dragElementOriginStyle.transition = "none", Pr.originStyleProp.forEach((i) => t.style[i] = this.dragElementOriginStyle[i] || null), setTimeout(() => t.style.transition = n, 50);
    }
...
Pr.originStyleProp = ["width", "height", "transform", "transform-origin", "transition", "pointerEvents", "position", "left", "top", "minWidth", "willChange"];
class ru extends Ai {
  constructor(e, t = {}) {
...
class Oi {
  ...
  setupDraggable(e) {
    return this.ddDraggable ? this.ddDraggable.updateOption(e) : this.ddDraggable = new Pr(this.el, e), this;
  }
  cleanDraggable() {
    return this.ddDraggable && (this.ddDraggable.destroy(), delete this.ddDraggable), this;
  }
  setupResizable(e) {
    return this.ddResizable ? this.ddResizable.updateOption(e) : this.ddResizable = new Ir(this.el, e), this;
  }
  cleanResizable() {
    return this.ddResizable && (this.ddResizable.destroy(), delete this.ddResizable), this;
  }
  setupDroppable(e) {
    return this.ddDroppable ? this.ddDroppable.updateOption(e) : this.ddDroppable = new ru(this.el, e), this;
  }
  cleanDroppable() {
...
class nu {
  ...
  _getDDElements(e, t) {
    ...
    return i.length ? i.map((o) => o.ddElement || (n ? Oi.init(o) : null)).filter((o) => o) : [];
  }
}
const $e = new nu();
class te {
...
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.`)), n;
  ...
  constructor(e, t = {}) {
    ...
    const l = t.engineClass || te.engineClass || Nt;
      ...
      const c = (h, m) => {
        ...
        if (!(!v.gridstackNode || v.gridstackNode.grid !== this)) {
          if (n.el = v, n._isAboutToRemove) {
            ...
            E.removePositioningStyles(v), n._temporaryRemoved ? (this._writePosAttr(v, n), this.engine.addNode(n)) : this._writePosAttr(v, n), this.triggerEvent(h, v);
  ...
  _dragOrResize(e, t, n, i, s, o) {
    ...
    if (c = Math.min(c, v), d = Math.min(d, v), u = Math.min(u, m), h = Math.min(h, m), t.type === "drag") {
      if (i._temporaryRemoved)
        return;
      const g = n.position.top - i._prevYPix;
      i._prevYPix = n.position.top, this.opts.draggable.scroll !== !1 && E.updateScrollPosition(e, n.position, g);
      const T = n.position.left + (n.position.left > i._lastUiPosition.left ? -d : c), _ = n.position.top + (n.position.top > i._lastUiPosition.top ? -h : u);
      a.x = Math.round(T / s), a.y = Math.round(_ / o);
      ...
      if (a.x < 0 || (E.updateScrollResize(t, e, o), a.w = Math.round((n.size.width - c) / s), a.h = Math.round((n.size.height - u) / o), i.w === a.w && i.h === a.h) || i._lastTried && i._lastTried.w === a.w && i._lastTried.h === a.h)
        return;
      const g = n.position.left + c, T = n.position.top + u;
      a.x = Math.round(g / s), a.y = Math.round(T / o), l = !0;
    }
  ...
  commit() {
    return eu(this, this.batchUpdate(!1), "commit", "batchUpdate", "5.2"), this;
  }
}
te.renderCB = (r, e) => {
...
function iu({ children: r }) {
  const {
    _gridStack: { value: e, set: t },
    options: n
  } = Bo(), i = Y(/* @__PURE__ */ new Map()), s = Y(null), o = Y(n), a = X(
    (d, u) => {
      if (u.id && u.grid) {
        let h = rn.get(u.grid);
    ...
    const { children: h, ...m } = d, { children: v, ...y } = u;
    return So(m, y);
  };
  return ci(() => {
    if (!c(n, o.current) && e)
...
const Mi = ({
  ...
  const i = j(() => JSON.stringify(
    ...
    let u = d[0], h = 1 / 0;
    for (const m of d) {
      const v = m.w - l, y = m.h - c, g = v * v + y * y;
      g < h && (h = g, u = m);
    }
    return u;
  };
  return /* @__PURE__ */ f(
    Xd,
    {
      ...
      onChange: t,
      children: /* @__PURE__ */ f(iu, { children: /* @__PURE__ */ f(Qd, {}) })
    }
  );
};
Mi.displayName = "F0GridStack";
const su = (r, e, t) => /* @__PURE__ */ f("div", { children: r }), Fn = ({
  widgets: r = [],
  editMode: e = !1,
  onChange: t = () => {
  },
  ...
  const o = X(
    ...
    return R.x !== void 0 && (L.x = R.x), R.y !== void 0 && (L.y = R.y), L;
  }), [d, u] = ie(
    c(r, e)
  ...
  return ne(() => {
    const b = h.current !== e, x = m.current !== r, w = T.current !== s && (T.current === void 0 || s === void 0 || Object.keys(T.current).length !== Object.keys(s).length || Object.keys(s).some(
      (A) => T.current?.[A] !== s[A]
    )), R = /* @__PURE__ */ new Map();
    r.forEach((A) => {
      if (A.deps && A.deps.length > 0) {
        const D = y.current.get(A.id), O = _.get(A.id);
        R.set(
          A.id,
          k(D, O)
        ), O ? y.current.set(A.id, O) : y.current.delete(A.id);
      }
    });
    const z = new Set(r.map((A) => A.id));
    y.current.forEach((A, D) => {
      z.has(D) || y.current.delete(D);
    });
    const L = Array.from(R.values()).some((A) => A) || w;
    b && !x && !L ? (v.current = !0, u(
      (A) => A.map((D) => {
      ...
      return r.map((O) => {
        ...
        return re !== void 0 && (H.x = re), le !== void 0 && (H.y = le), H;
      });
    }), h.current = e, m.current = r, T.current = s;
  }, [
    r,
    e,
    o,
...
Li.displayName = "Text";
const Wo = Ke((r, e) => /* @__PURE__ */ f(Li, { ref: e, markdown: r.markdown ?? !0, ...r }));
Wo.displayName = "F0Text";
const uu = ye(Wo), zg = [
  "person",
  "team",
  "company",
  ...
  const [c, d] = ie(!1), [u, h] = ie(!1), m = Tt(), v = (g) => {
    d(g);
  }, y = u || c;
  return ne(() => {
    if (!i || !n) return;
              ...
              children: [
                e && /* @__PURE__ */ f(
                  "div",
                  {
                    ...
                    onMouseDown: t,
                    "data-gs-handle": "true",
                    children: /* @__PURE__ */ f(Wr, { icon: Gl, size: "xs" })
                  }
                ),
                /* @__PURE__ */ f(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ f(uu, { variant: "label", content: r, ellipsis: !0 })
                  }
                )
              ]
            }
          ),
          /* @__PURE__ */ f(Ul, { children: (s || o) && y && /* @__PURE__ */ W(
            Di.div,
            {
              className: ue(
...
}, fu = () => /* @__PURE__ */ W("div", { className: "relative flex h-full w-full cursor-progress flex-col rounded-xl border border-solid border-f1-border-secondary bg-f1-background", children: [
...
Go.displayName = "F0Widget";
const hu = uo(Go, fu), mu = ({
  children: r,
  title: e,
  draggable: t = !1,
  actions: n,
...
const pu = au("Dashboard", Uo), Bg = ye(
  at("Dashboard", pu)
), gu = Xt({
...
}), vu = (r) => (r || []).map((e) => e.items).reduce((e, t) => (e.length > 0 && e.push({ type: "separator" }), e.push(...t), e), []), yu = (r) => {
  ...
  ({
    ...
    return /* @__PURE__ */ W(
      ...
      {
        ref: d,
        className: ue(gu({ variant: e }), "relative", t),
        draggable: n,
        onDragStart: i,
        onDragEnd: s,
        onDrop: o,
...
In.displayName = "Block";
In.__isPageLayoutBlock = !0;
const bu = ({
  title: r = "",
  description: e,
  titleLevel: t = "h2",
  ...
  if (!r) return null;
  const o = t;
  return /* @__PURE__ */ W(In, { ...s, className: ue("space-y-4", i), children: [
  ...
  "BlockContent",
  bu
), wu = (r) => !_o(r) || !r.type || typeof r.type == "string" || typeof r.type == "symbol" ? !1 : "__isPageLayoutBlock" in r.type, _u = (r) => !_o(r) || !r.type || typeof r.type == "string" || typeof r.type == "symbol" ? !1 : "__isPageLayoutGroup" in r.type, Zo = (r, e, t) => {
  const n = cn.toArray(e);
  for (const i of n)
    t.includes("block") && wu(i) || t.includes("group") && _u(i) || console.warn(
      `${r}: Children components must inherit from PageLayoutBlock or PageLayoutGroup. Found:`,
      i
    );
}, Fi = Ke(
  ({ children: r, onSort: e, ...t }, n) => {
    Zo("GroupLinear", r, ["block"]);
    const [i, s] = ie(cn.toArray(r));
    return ne(() => {
      s(cn.toArray(r));
    }, [r]), ne(() => {
      e?.(i);
    }, [i, e]), /* @__PURE__ */ f("div", { ref: n, ...t, children: i.map((o, a) => /* @__PURE__ */ f(Uc, { children: o }, a)) });
  }
);
Fi.displayName = "GroupLinear";
Fi.__isPageLayoutGroup = !0;
function Cu() {
...
const Pn = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u";
function pr(r) {
...
function Ge(r) {
  var e, t;
  return r ? pr(r) ? r : Ii(r) && (e = (t = r.ownerDocument) == null ? void 0 : t.defaultView) != null ? e : window : window;
}
function Pi(r) {
  const {
    Document: e
...
function gr(r) {
  return r ? pr(r) ? r.document : Ii(r) ? Pi(r) ? r : Gr(r) || qo(r) ? r.ownerDocument : document : document : document;
}
const pt = Pn ? ci : ne;
function zn(r) {
  const e = Y(r);
...
const lr = /* @__PURE__ */ Ko(1), Br = /* @__PURE__ */ Ko(-1);
function Su(r) {
...
function Du(r) {
  return r.matches(ms) ? r : r.querySelector(ms);
}
const Nu = {
  display: "none"
};
...
function Mu() {
  const [r] = ie(() => /* @__PURE__ */ new Set()), e = X((n) => (r.add(n), () => r.delete(n)), [r]);
  return [X((n) => {
    let {
      type: i,
      event: s
...
function Iu(r) {
  ...
  const {
    announce: s,
    announcement: o
  } = Au(), a = Zr("DndLiveRegion"), [l, c] = ie(!1);
  if (ne(() => {
    c(!0);
  }, []), Ou(j(() => ({
    onDragStart(u) {
    ...
    return null;
  const d = q.createElement(q.Fragment, null, q.createElement(Ru, {
    id: n,
    value: i.draggable
  }), q.createElement(Tu, {
    id: a,
...
const ju = (r) => {
  ...
  for (const o of n) {
    ...
    if (l) {
      const c = gs(l), d = i.reduce((h, m, v) => h + zu(c[v], m), 0), u = Number((d / 4).toFixed(4));
      s.push({
        id: a,
        data: {
...
function Vn(r, e) {
  ...
  function n(i) {
    ...
    if (!Gr(i) || qo(i) || t.includes(i))
      return t;
    const s = Ge(r).getComputedStyle(i);
    return i !== r && Ju(i, s) && t.push(i), Yu(i, s) ? t : n(i.parentNode);
  }
  return r ? n(r) : t;
}
function ea(r) {
...
function Qn(r) {
  return !Pn || !r ? null : pr(r) ? r : Ii(r) ? Pi(r) || r === gr(r).scrollingElement ? window : Gr(r) ? r : null : null;
}
function ta(r) {
...
function na(r) {
  return !Pn || !r ? !1 : r === document.scrollingElement;
}
function ia(r) {
  const e = {
    x: 0,
...
function ef(r, e, t, n, i) {
  ...
  return !c && s <= e.top + y.height ? (m.y = Ie.Backward, v.y = n * Math.abs((e.top + y.height - s) / y.height)) : !d && l >= e.bottom - y.height && (m.y = Ie.Forward, v.y = n * Math.abs((e.bottom - y.height - l) / y.height)), !h && a >= e.right - y.width ? (m.x = Ie.Forward, v.x = n * Math.abs((e.right - y.width - a) / y.width)) : !u && o <= e.left + y.width && (m.x = Ie.Backward, v.x = n * Math.abs((e.left + y.width - o) / y.width)), {
    direction: m,
    speed: v
  };
}
...
function sa(r) {
  return r.reduce((e, t) => lr(e, fi(t)), gt);
}
function rf(r) {
  return r.reduce((e, t) => e + ta(t), 0);
}
function nf(r) {
  return r.reduce((e, t) => e + ra(t), 0);
}
function oa(r, e) {
  if (e === void 0 && (e = vr), !r)
    return;
  ...
  ea(r) && (i <= 0 || s <= 0 || t >= window.innerHeight || n >= window.innerWidth) && r.scrollIntoView({
    block: "center",
    inline: "center"
  });
}
const sf = [["x", ["left", "right"], rf], ["y", ["top", "bottom"], nf]];
class zi {
  constructor(e, t) {
      ...
      if (u) {
        ...
        for (const y of v) {
          const g = e.code, {
            ...
            x: Math.min(g === ge.Right ? w.right - w.width / 2 : w.right, Math.max(g === ge.Right ? w.left : w.left + w.width / 2, u.x)),
            y: Math.min(g === ge.Down ? w.bottom - w.height / 2 : w.bottom, Math.max(g === ge.Down ? w.top : w.top + w.height / 2, u.y))
          }, z = g === ge.Right && !_ || g === ge.Left && !S, L = g === ge.Down && !k || g === ge.Up && !T;
          if (z && R.x !== u.x) {
            const A = y.scrollLeft + h.x, D = g === ge.Right && A <= b.x || g === ge.Left && A >= x.x;
            if (D && !h.y) {
              y.scrollTo({
                left: A,
                behavior: a
            ...
            D ? m.x = y.scrollLeft - A : m.x = g === ge.Right ? y.scrollLeft - b.x : y.scrollLeft - x.x, m.x && y.scrollBy({
              left: -m.x,
              behavior: a
            });
            break;
          } else if (L && R.y !== u.y) {
            const A = y.scrollTop + h.y, D = g === ge.Down && A <= b.y || g === ge.Up && A >= x.y;
            if (D && !h.x) {
              y.scrollTo({
                top: A,
                behavior: a
            ...
            D ? m.y = y.scrollTop - A : m.y = g === ge.Down ? y.scrollTop - b.y : y.scrollTop - x.y, m.y && y.scrollBy({
              top: -m.y,
              behavior: a
            });
            break;
...
class Vi {
  constructor(e, t, n) {
    var i;
    n === void 0 && (n = of(e.event.target)), this.props = void 0, this.events = void 0, this.autoScrollEnabled = !0, this.document = void 0, this.activated = !1, this.initialCoordinates = void 0, this.timeoutId = null, this.listeners = void 0, this.documentListeners = void 0, this.windowListeners = void 0, this.props = e, this.events = t;
    const {
      event: s
    } = e, {
      target: o
    } = s;
    this.props = e, this.events = t, this.document = gr(o), this.documentListeners = new Rr(this.document), this.listeners = new Rr(n), this.windowListeners = new Rr(Ge(o)), this.initialCoordinates = (i = vn(s)) != null ? i : gt, this.handleStart = this.handleStart.bind(this), this.handleMove = this.handleMove.bind(this), this.handleEnd = this.handleEnd.bind(this), this.handleCancel = this.handleCancel.bind(this), this.handleKeydown = this.handleKeydown.bind(this), this.removeTextSelection = this.removeTextSelection.bind(this), this.attach();
  }
  attach() {
    const {
      events: e,
    ...
    if (this.listeners.add(e.move.name, this.handleMove, {
      passive: !1
    }), this.listeners.add(e.end.name, this.handleEnd), e.cancel && this.listeners.add(e.cancel.name, this.handleCancel), this.windowListeners.add(st.Resize, this.handleCancel), this.windowListeners.add(st.DragStart, ys), this.windowListeners.add(st.VisibilityChange, this.handleCancel), this.windowListeners.add(st.ContextMenu, ys), this.documentListeners.add(st.Keydown, this.handleKeydown), t) {
      if (n != null && n({
  ...
  handleStart() {
    ...
    e && (this.activated = !0, this.documentListeners.add(st.Click, af, {
      capture: !0
  ...
  handleMove(e) {
    ...
    if (!i)
      return;
    const l = (t = vn(e)) != null ? t : gt, c = Br(i, l);
    if (!n && a) {
      if (bs(a)) {
        if (a.tolerance != null && ei(c, a.tolerance))
          return this.handleCancel();
        if (ei(c, a.distance))
          return this.handleStart();
      }
      if (xs(a) && ei(c, a.tolerance))
        return this.handleCancel();
...
uf.activators = [{
  ...
  handler: (r, e) => {
    ...
    return t.button === hi.RightClick ? !1 : (n?.({
      event: t
    }), !0);
  }
}];
...
class ff extends Vi {
  ...
  static setup() {
    return window.addEventListener(ti.move.name, e, {
      capture: !1,
      passive: !1
    }), function() {
      window.removeEventListener(ti.move.name, e);
    };
    function e() {
    }
  }
...
function hf(r) {
  ...
  const m = pf({
    ...
    if (!x)
      return;
    const w = g.current.x * T.current.x, R = g.current.y * T.current.y;
    x.scrollBy(w, R);
  }, []), b = j(() => a === bn.TreeOrder ? [...c].reverse() : c, [a, c]);
  ne(
    () => {
      if (!s || !c.length || !_) {
        y();
      ...
      for (const x of b) {
        ...
        for (const A of ["x", "y"])
          m[A][z[A]] || (L[A] = 0, z[A] = 0);
        if (L.x > 0 || L.y > 0) {
          y(), S.current = x, v(k, o), g.current = L, T.current = z;
          return;
        }
      }
      g.current = {
...
function yf(r, e) {
  ...
  const [s, o] = ie(null), {
    ...
    measure: l,
    strategy: c
  } = i, d = Y(r), u = g(), h = zr(u), m = X(function(T) {
    T === void 0 && (T = []), !h.current && o((_) => _ === null ? T : _.concat(T.filter((S) => !_.includes(S))));
  }, [h]), v = Y(null), y = Ur((T) => {
    if (u && !t)
      return ws;
    if (!T || T === ws || d.current !== r || s != null) {
      ...
      for (let S of r) {
        ...
        const k = S.node.current, b = k ? new zi(l(k), k) : null;
...
const Cs = [];
function Cf(r) {
  const e = Y(r), t = Ur((n) => r ? n && n !== Cs && r && e.current && r.parentNode === e.current.parentNode ? n : Vn(r) : Cs, [r]);
  return ne(() => {
    e.current = r;
  }, [r]), t;
}
function Ef(r) {
  const [e, t] = ie(null), n = Y(r), i = X((s) => {
    const o = Qn(s.target);
  ...
  }, [i, r]), j(() => r.length ? e ? Array.from(e.values()).reduce((s, o) => lr(s, o), gt) : sa(r) : gt, [r, e]);
}
function Es(r, e) {
  e === void 0 && (e = []);
  const t = Y(null);
...
function la(r) {
  return j(() => r ? Xu(r) : null, [r]);
}
const Ss = [];
function Df(r, e) {
  e === void 0 && (e = vr);
  const [t] = r, n = la(t ? Ge(t) : null), [i, s] = ie(Ss);
  function o() {
    s(() => r.length ? r.map((l) => na(l) ? n : new zi(e(l), l)) : Ss);
  }
  const a = Hn({
    callback: o
  });
...
const Af = {
  ...
  over: null,
  measureDroppableContainers: yn
}, qr = /* @__PURE__ */ vt(da), ua = /* @__PURE__ */ vt(Af);
function Of() {
  return {
    draggable: {
      active: null,
...
const Pf = /* @__PURE__ */ Zc(function(e) {
  var t, n, i, s;
  let {
    id: o,
    accessibility: a,
    ...
    children: c,
    sensors: d = Rf,
    collisionDetection: u = Wu,
    measuring: h,
    modifiers: m,
    ...v
  } = e;
  const y = qc(Mf, void 0, Of), [g, T] = y, [_, S] = Mu(), [k, b] = ie(Ft.Uninitialized), x = k === Ft.Initialized, {
    draggable: {
      active: w,
      nodes: R,
      translate: z
    ...
    return w != null ? {
      ...
      data: (Ve = A?.data) != null ? Ve : Tf,
      rect: D
    } : null;
  }, [w, A]), G = Y(null), [I, U] = ie(null), [H, re] = ie(null), le = zr(v, Object.values(v)), he = Zr("DndDescribedBy", o), Pe = j(() => L.getEnabled(), [L]), we = Ff(h), {
    droppableRects: ke,
    ...
    config: we.droppable
  }), ce = gf(R, w), Se = j(() => H ? vn(H) : null, [H]), se = $l(), ee = bf(ce, we.draggable.measure);
  If({
  ...
  const $ = _s(ce, we.draggable.measure, ee), De = _s(ce ? ce.parentElement : null), Ae = Y({
    activatorEvent: null,
    active: null,
    activeNode: ce,
    collisionRect: null,
  ...
  }), He = L.getNodeFor((t = Ae.current.over) == null ? void 0 : t.id), Ne = Nf({
    measure: we.dragOverlay.measure
  }), tt = (n = Ne.nodeRef.current) != null ? n : ce, Be = x ? (i = Ne.rect) != null ? i : $ : null, ft = !!(Ne.nodeRef.current && Ne.rect), p = _f(ft ? null : $), C = la(tt ? Ge(tt) : null), N = Cf(x ? He ?? ce : null), B = Df(N), M = fa(m, {
    transform: {
      x: z.x - p.x,
      y: z.y - p.y,
      scaleX: 1,
    ...
    windowRect: C
  }), F = Se ? lr(Se, z) : null, Z = Ef(N), oe = Es(Z), Ce = Es(Z, [$]), _e = lr(M, oe), je = Be ? Zu(Be, M) : null, Gt = O && je ? u({
    active: O,
    collisionRect: je,
    droppableRects: ke,
    droppableContainers: Pe,
    pointerCoordinates: F
  }) : null, Qt = Yo(Gt, "id"), [rt, Yr] = ie(null), Jr = ft ? M : lr(M, Ce), qn = Gu(Jr, (s = rt?.rect) != null ? s : null, $), er = Y(null), is = X(
    (Ve, Xe) => {
      let {
        sensor: Ye,
        options: At
        ...
        return async function() {
          ...
          if (xt && xr) {
            ...
            Mt = {
              ...
              delta: xr,
              over: br
            }, ze === Le.DragEnd && typeof wr == "function" && await Promise.resolve(wr(Mt)) && (ze = Le.DragCancel);
          }
          G.current = null, en(() => {
            T({
              type: ze
            }), b(Ft.Uninitialized), Yr(null), U(null), re(null), er.current = null;
            const wr = ze === Le.DragEnd ? "onDragEnd" : "onDragCancel";
            if (Mt) {
              const Kn = le.current[wr];
              Kn?.(Mt), _({
                type: wr,
                event: Mt
              });
    ...
    const nt = Ye.nativeEvent, Je = R.get(At);
    if (
    ...
    }, G.current = At, is(Ye, Xe));
  }, [R, is]), ss = vf(d, Vl);
  Sf(d), pt(() => {
    $ && k === Ft.Initializing && b(Ft.Initialized);
  }, [$, k]), ne(
    () => {
      const {
        onDragMove: Ve
  ...
  }, [O, ce, Gt, je, R, tt, Be, ke, L, rt, N, _e]), hf({
    ...se,
    delta: z,
    draggingRect: je,
    pointerCoordinates: F,
  ...
  const Hl = j(() => ({
    ...
    measuringScheduled: me,
    windowRect: C
  }), [O, ce, $, H, Gt, De, Ne, R, L, ke, rt, Fe, N, B, we, me, C]), jl = j(() => ({
    activatorEvent: H,
    activators: ss,
    active: O,
    activeNodeRect: $,
  ...
  return q.createElement(Xo.Provider, {
    value: S
  }, q.createElement(qr.Provider, {
    value: jl
  }, q.createElement(ua.Provider, {
    value: Hl
  }, q.createElement(jn.Provider, {
    value: qn
  }, c)), q.createElement(Lf, {
...
}), zf = /* @__PURE__ */ vt(null), ks = "button", Bf = "Draggable";
function Vf(r) {
  let {
    id: e,
    data: t,
  ...
  const s = Zr(Bf), {
    ...
    tabIndex: y = 0
  } = i ?? {}, g = l?.id === e, T = ct(g ? jn : zf), [_, S] = pn(), [k, b] = pn(), x = kf(o, e), w = zr(t);
  pt(
    () => (u.set(e, {
      id: e,
      key: s,
  ...
  const R = j(() => ({
    ...
    tabIndex: y,
    "aria-disabled": n,
    "aria-pressed": g && m === ks ? !0 : void 0,
    "aria-roledescription": v,
    "aria-describedby": d.draggable
  }), [n, m, y, g, v, d.draggable]);
  return {
    active: l,
    activatorEvent: a,
    activeNodeRect: c,
  ...
  const s = Zr(Hf), {
    ...
    () => {
      ...
      m.current != null && clearTimeout(m.current), m.current = setTimeout(() => {
        c(Array.isArray(T.current) ? T.current : [T.current]), m.current = null;
      }, g);
    },
    //eslint-disable-next-line react-hooks/exhaustive-deps
    [g]
...
function Wf(r) {
  ...
  }, [e, n, s]), q.createElement(q.Fragment, null, t, n ? Kc(n, {
    ref: o
  }) : null);
}
const Gf = {
...
const Zf = {
  position: "fixed",
  touchAction: "none"
}, qf = (r) => Bn(r) ? "transform 250ms ease" : void 0, Kf = /* @__PURE__ */ Ke((r, e) => {
  let {
    as: t,
    activatorEvent: n,
    adjustScale: i,
  ...
  const u = i ? c : {
    ...
    transformOrigin: i && n ? Bu(n, a) : void 0,
...
function Qf(r) {
  ...
  return zn((s, o) => {
    ...
    const {
      transform: d
    } = Ge(o).getComputedStyle(o), u = Qo(d);
    if (!u)
      return;
    const h = typeof e == "function" ? e : eh(e);
    return oa(l, i.draggable.measure), h({
      active: {
        id: s,
        data: a.data,
        node: l,
...
const rh = /* @__PURE__ */ q.memo((r) => {
  ...
  return q.createElement(Uf, null, q.createElement(Wf, {
    animation: L
  }, u && w ? q.createElement(Kf, {
    key: w,
    id: u.id,
    ref: A,
    as: a,
...
}, pa = "Sortable", ga = /* @__PURE__ */ q.createContext({
  activeIndex: -1,
  containerId: pa,
  disableTransforms: !1,
  items: [],
...
function oh(r) {
  ...
  } = ha(), u = Zr(pa, t), h = a.rect !== null, m = j(() => n.map((x) => typeof x == "object" && "id" in x ? x.id : x), [n]), v = o != null, y = o ? m.indexOf(o.id) : -1, g = c ? m.indexOf(c.id) : -1, T = Y(m), _ = !ih(m, T.current), S = g !== -1 && y === -1 || _, k = sh(s);
  pt(() => {
    _ && v && d(m);
  }, [_, m, v, d]), ne(() => {
    T.current = m;
  ...
  const b = j(
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [y, u, k.draggable, k.droppable, S, m, g, l, h, i]
  );
  return q.createElement(ga.Provider, {
    value: b
  }, e);
}
const ah = (r) => {
  ...
  duration: 200,
  easing: "ease"
}, va = "transform", dh = /* @__PURE__ */ Vt.Transition.toString({
  property: va,
  duration: 0,
  easing: "linear"
}), uh = {
...
function hh(r) {
  ...
  const {
    ...
    useDragOverlay: T,
    strategy: _
  } = ct(ga), S = mh(n, m), k = d.indexOf(o), b = j(() => ({
    sortable: {
      containerId: u,
      index: k,
      items: d
    ...
    ...i
  }), [u, i, k, d]), x = j(() => d.slice(d.indexOf(o)), [d, o]), {
    rect: w,
    node: R,
    isOver: z,
    setNodeRef: L
  ...
  }), Pe = Cu(L, I), we = !!A, ke = we && !v && nn(h) && nn(g), Fe = !T && H, me = Fe && ke ? he : null, Se = ke ? me ?? (a ?? _)({
    rects: y,
    activeNodeRect: O,
    activeIndex: h,
    overIndex: g,
...
const ph = [ge.Down, ge.Right, ge.Up, ge.Left], gh = (r, e) => {
  let {
    context: {
      active: t,
      collisionRect: n,
  ...
  if (ph.includes(r.code)) {
    ...
    if (d === o?.id && c.length > 1 && (d = c[1].id), d != null) {
      const u = s.get(t.id), h = s.get(d), m = h ? i.get(h.id) : null, v = h?.node.current;
      if (v && m && u && h) {
        const g = Vn(v).some((x, w) => a[w] !== x), T = ya(u, h), _ = vh(u, h), S = g || !T ? {
          x: 0,
          y: 0
        } : {
...
function vh(r, e) {
  return !xn(r) || !xn(e) || !ya(r, e) ? !1 : r.data.current.sortable.index < e.data.current.sortable.index;
}
const Ns = ({ id: r, children: e }) => {
  const { attributes: t, listeners: n, setNodeRef: i, transform: s, transition: o } = hh({ id: r }), a = {
  ...
  const [o, a] = ie(null), l = Pu(
    ...
    a(null), m && h.id !== m.id && s((v) => {
      const y = v.findIndex((T) => T.id === h.id), g = v.findIndex((T) => T.id === m.id);
      return $i(v, y, g);
    });
  };
  return /* @__PURE__ */ f("div", { className: ue("flex flex-wrap items-stretch gap-4", n && "flex-1"), children: /* @__PURE__ */ W(
    Pf,
    {
      ...
      onDragEnd: d,
      children: [
        /* @__PURE__ */ f(oh, { items: i, children: i.map((u) => /* @__PURE__ */ f(Ns, { id: u.id, children: u.render }, u.id)) }),
        /* @__PURE__ */ f(rh, { children: o ? /* @__PURE__ */ f(Ns, { id: o, children: i.find((u) => u.id === o)?.render }) : null })
      ]
    }
  ) });
};
...
const yh = Ke(function({ children: e, aside: t, header: n, variant: i = "main-aside" }, s) {
  return process.env.NODE_ENV === "development" && Zo("Page", e, ["block", "group"]), /* @__PURE__ */ f("div", { ref: s, className: "h-full", children: /* @__PURE__ */ W(
    "div",
    {
      className: ue(
        "flex h-full max-w-full overflow-auto text-f1-foreground md:flex-row",
  ...
  Page: ye(at("Page", yh)),
  Block: ye(at("Block", In)),
  BlockContent: ye(
    at("BlockContent", xu)
  ),
  Group: ye(at("Group", Fi)),
  GroupGrid: ye(
    at("GroupGrid", Fn)
  ),
  GroupMasonry: ye(
...
function xh(r, e) {
  for (var t = 0; t < e.length; t++) {
    var n = e[t];
    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(r, wa(n.key), n);
  }
}
function wh(r, e, t) {
...
function _h(r, e, t) {
  return e = wn(e), Ch(r, ba() ? Reflect.construct(e, t || [], wn(r).constructor) : e.apply(r, t));
}
function Ch(r, e) {
...
function xa(r, e, t) {
  return e = wa(e), e in r ? Object.defineProperty(r, e, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : r[e] = t, r;
}
function wa(r) {
  var e = kh(r, "string");
...
var $n = /* @__PURE__ */ (function(r) {
  function e() {
    return bh(this, e), _h(this, e, arguments);
  }
  return Sh(e, r), wh(e, [{
    key: "render",
    value: function() {
...
function Th(r) {
  var e = r.option, t = r.isActive, n = Nh(r, Dh);
  return typeof e == "string" ? /* @__PURE__ */ q.createElement(cs, Or({
    option: /* @__PURE__ */ q.createElement(ed, Or({
      type: e
    }, n)),
    isActive: t,
    shapeType: "symbols"
  }, n)) : /* @__PURE__ */ q.createElement(cs, Or({
    option: e,
    isActive: t,
    shapeType: "symbols"
  }, n));
...
function it(r) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? Rs(Object(t), !0).forEach(function(n) {
      zt(r, n, t[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(r, Object.getOwnPropertyDescriptors(t)) : Rs(Object(t)).forEach(function(n) {
...
function Mh(r, e, t) {
  return e = _n(e), Lh(r, _a() ? Reflect.construct(e, t || [], _n(r).constructor) : e.apply(r, t));
}
function Lh(r, e) {
...
function Ih(r, e) {
  if (typeof e != "function" && e !== null)
    throw new TypeError("Super expression must either be null or a function");
  r.prototype = Object.create(e && e.prototype, { constructor: { value: r, writable: !0, configurable: !0 } }), Object.defineProperty(r, "prototype", { writable: !1 }), e && gi(r, e);
}
function gi(r, e) {
...
var Kr = /* @__PURE__ */ (function(r) {
  function e() {
    ...
    for (var n = arguments.length, i = new Array(n), s = 0; s < n; s++)
      i[s] = arguments[s];
    return t = Mh(this, e, [].concat(i)), zt(t, "state", {
    ...
    }), zt(t, "id", ad("recharts-scatter-")), t;
  }
  return Ih(e, r), Oh(e, [{
    key: "renderSymbolsStatically",
    value: function(n) {
      var i = this, s = this.props, o = s.shape, a = s.activeShape, l = s.activeIndex, c = Yn(this.props, !1);
      return n.map(function(d, u) {
        var h = l === u, m = h ? a : o, v = it(it({}, c), d);
        return /* @__PURE__ */ q.createElement(_r, Mr({
          className: "recharts-scatter-symbol",
          key: "symbol-".concat(d?.cx, "-").concat(d?.cy, "-").concat(d?.size, "-").concat(u)
        }, td(i.props, d, u), {
          role: "img"
        }), /* @__PURE__ */ q.createElement(Th, Mr({
          option: m,
          isActive: h,
          key: "symbol-".concat(u)
        }, v)));
    ...
    value: function() {
      ...
      return /* @__PURE__ */ q.createElement(rd, {
        begin: a,
        duration: l,
        isActive: o,
        easing: c,
        ...
        var m = h.t, v = s.map(function(y, g) {
          var T = u && u[g];
          if (T) {
            var _ = tn(T.cx, y.cx), S = tn(T.cy, y.cy), k = tn(T.size, y.size);
            return it(it({}, y), {}, {
              cx: _(m),
              cy: S(m),
              size: k(m)
        ...
        return /* @__PURE__ */ q.createElement(_r, null, n.renderSymbolsStatically(v));
      });
    }
  }, {
    key: "renderSymbols",
    value: function() {
      ...
      return s && i && i.length && (!o || !So(o, i)) ? this.renderSymbolsWithAnimation() : this.renderSymbolsStatically(i);
    }
  }, {
    key: "renderErrorBar",
    value: function() {
      ...
      if (n && !this.state.isAnimationFinished)
        return null;
      var i = this.props, s = i.points, o = i.xAxis, a = i.yAxis, l = i.children, c = ko(l, nd);
      return c ? c.map(function(d, u) {
        var h = d.props, m = h.direction, v = h.dataKey;
        return /* @__PURE__ */ q.cloneElement(d, {
          ...
          dataPointFormatter: function(g, T) {
            return {
              x: g.cx,
              y: g.cy,
    ...
    key: "renderLine",
    value: function() {
      var n = this.props, i = n.points, s = n.line, o = n.lineType, a = n.lineJointType, l = Yn(this.props, !1), c = Yn(s, !1), d, u;
      if (o === "joint")
        d = i.map(function(S) {
          return {
            x: S.cx,
        ...
        var h = id(i), m = h.xmin, v = h.xmax, y = h.a, g = h.b, T = function(k) {
          return y * k + g;
        };
        d = [{
          x: m,
      ...
      return /* @__PURE__ */ q.isValidElement(s) ? u = /* @__PURE__ */ q.cloneElement(s, _) : sd(s) ? u = s(_) : u = /* @__PURE__ */ q.createElement(od, Mr({}, _, {
        type: a
    ...
    key: "render",
    value: function() {
      var n = this.props, i = n.hide, s = n.points, o = n.line, a = n.className, l = n.xAxis, c = n.yAxis, d = n.left, u = n.top, h = n.width, m = n.height, v = n.id, y = n.isAnimationActive;
      if (i || !s || !s.length)
        return null;
      var g = this.state.isAnimationFinished, T = Xl("recharts-scatter", a), _ = l && l.allowDataOverflow, S = c && c.allowDataOverflow, k = _ || S, b = ir(v) ? this.id : v;
      ...
      }, this.renderSymbols()), (!y || g) && Do.renderCallByParent(this.props, s));
    }
  }], [{
...
zt(Kr, "defaultProps", {
  ...
  shape: "circle",
  hide: !1,
  isAnimationActive: !ld.isSsr,
  animationBegin: 0,
  animationDuration: 400,
  animationEasing: "linear"
});
zt(Kr, "getComposedData", function(r) {
  var e = r.xAxis, t = r.yAxis, n = r.zAxis, i = r.item, s = r.displayedData, o = r.xAxisTicks, a = r.yAxisTicks, l = r.offset, c = i.props.tooltipType, d = ko(i.props.children, cd), u = ir(e.dataKey) ? i.props.dataKey : e.dataKey, h = ir(t.dataKey) ? i.props.dataKey : t.dataKey, m = n && n.dataKey, v = n ? n.range : $n.defaultProps.range, y = v && v[0], g = e.scale.bandwidth ? e.scale.bandwidth() : 0, T = t.scale.bandwidth ? t.scale.bandwidth() : 0, _ = s.map(function(S, k) {
    ...
    var z = ds({
      ...
      index: k,
      dataKey: h
    }), A = w !== "-" ? n.scale(w) : y, D = Math.sqrt(Math.max(A, 0) / Math.PI);
    return it(it({}, S), {}, {
      cx: z,
      cy: L,
      x: z - D,
...
const Bh = (r) => {
  ...
  const y = hd(e), g = d?.categories ? Array.isArray(d.categories) ? d.categories : [d.categories] : [], T = u?.categories ? Array.isArray(u.categories) ? u.categories : [u.categories] : [], _ = h?.categories ? Array.isArray(h.categories) ? h.categories : [h.categories] : [], S = [
    ...g,
    ...T,
    ..._
  ], k = Math.max(
  ...
  return /* @__PURE__ */ f(pd, { config: r, ref: v, aspect: a, children: /* @__PURE__ */ W(
    zh,
    {
      ...
      children: [
        !s && /* @__PURE__ */ f(
          ...
          {
            ...vd(),
            content: /* @__PURE__ */ f(yd, { yAxisFormatter: n.tickFormatter })
          }
        ),
        !o && /* @__PURE__ */ f(bd, { ...xd() }),
        ...
        /* @__PURE__ */ f(
          To,
          {
            ...
            hide: t?.hide,
            tick: c ? (w) => {
              const { x: R, y: z, payload: L } = w, A = e.find((G) => G.label === L.value)?.values || "", D = Object.keys(A).length === 1 ? Object.values(A)?.[0] : void 0, O = D !== void 0 && n.tickFormatter ? n.tickFormatter(`${D}`) : D.toLocaleString();
        ...
        g.map((w, R) => /* @__PURE__ */ f(
          Ro,
          {
            isAnimationActive: !1,
            dataKey: String(w),
            fill: r[w].color ? Nr(r[w].color) : Xn(R),
            radius: 4,
            maxBarSize: 32,
        ...
        T.map((w, R) => /* @__PURE__ */ f(
          No,
          {
            type: u?.lineType ?? "natural",
            dataKey: String(w),
            stroke: r[w].color ? Nr(r[w].color) : Xn(g.length + R),
            strokeWidth: 2,
            dot: u?.dot ?? !1,
            isAnimationActive: !1,
        ...
        _.map((w, R) => /* @__PURE__ */ f(
          ...
          {
            dataKey: String(w),
            fill: r[w].color ? Nr(r[w].color) : Xn(
              g.length + T.length + R
            ),
            r: 4,
            isAnimationActive: !1,
        ...
        l && /* @__PURE__ */ f(
          _d,
          {
            content: /* @__PURE__ */ f(Cd, { nameKey: "label" }),
            align: "center",
...
}, Hh = Ao(Vh), jh = ({ value: r, max: e = 100, label: t, color: n }, i) => {
  ...
  dt({ name: "AreaChart", type: "info" }, Ed)
), Gg = ye(
  dt({ name: "BarChart", type: "info" }, Sd)
), Ug = ye(
  dt(
  ...
  dt({ name: "LineChart", type: "info" }, Dd)
), qg = ye(
  dt({ name: "PieChart", type: "info" }, Nd)
), Kg = ye(
  dt(
  ...
  dt({ name: "ProgressBarChart", type: "info" }, $h)
), Yg = ye(
  dt({ name: "ComboChart", type: "info" }, Hh)
), Wh = (r) => typeof r == "boolean" || !r ? {
  show: !!r,
  invertStatus: !1
} : {
  show: r.show ?? !0,
  ...
  const t = Jl(), n = t(e.value, {
    formatterOptions: {
      decimalPlaces: 2
    }
  }), i = Wh(e.trend), s = t(e.comparison), o = Ql(
    n.numericValue,
    n.formatterOptions
  ), a = as(s.numericValue), l = as(n.numericValue), c = j(() => {
    if (!(!a || !i.show) && !(!a || !l))
      return (l - a) / a * 100;
  }, [l, a, i.show]);
...
}, Gh = () => /* @__PURE__ */ W("div", { className: "relative flex h-full w-full cursor-progress flex-col gap-2", children: [
...
Ea.displayName = "F0BigNumber";
const Uh = uo(Ea, Gh), Jg = ye(
  at("F0BigNumber", Uh)
), Sa = {
  background: {
...
const lm = Xt({
  ...
  ({
    ...
    const M = I && I !== "none" || U && U !== "none" || H && H !== "none" || re && re !== "none", F = G && G !== "none" || M, Z = { sm: Be, md: ft, lg: p, xl: C }, oe = cm.map((Ce) => {
      const _e = Z[Ce];
      return _e ? am(Ce, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ f(
...
const Qg = dt(
  ...
  (r) => r !== "ai"
), tv = fo, rv = ["default", "outline", "neutral"], nv = fo, iv = ["sm", "md", "lg"], sv = ["compact", "expanded"], ov = rc, av = [
  "viridian",
  "malibu",
  "yellow",
  "purple",
  ...
  return e?.length ? /* @__PURE__ */ W(ho, { open: t, onOpenChange: n, children: [
    /* @__PURE__ */ f(mo, { asChild: !0, children: /* @__PURE__ */ f("button", { className: Ri("inline-flex flex-shrink-0 items-center"), children: i }) }),
    /* @__PURE__ */ f(
      po,
      {
        className: "rounded-md border border-solid border-f1-border-secondary p-1 shadow-md",
        align: "end",
        children: /* @__PURE__ */ W(go, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[172px] flex-col", children: [
...
const lv = ye(
  ...
  const o = Y(null);
  return /* @__PURE__ */ f("div", { ref: o, className: "@container", children: /* @__PURE__ */ f("div", { className: dm({ variant: s }), children: /* @__PURE__ */ W(
    "div",
    {
      className: ue(
      ...
      children: [
        /* @__PURE__ */ W("div", { className: "flex flex-row gap-2", children: [
          /* @__PURE__ */ f("div", { className: "h-6 w-6 flex-shrink-0", children: s === "neutral" ? /* @__PURE__ */ f(sc, { icon: i || oc, size: "sm" }) : /* @__PURE__ */ f(Td, { type: s, size: "sm" }) }),
          /* @__PURE__ */ W("div", { className: "flex flex-col gap-0.5", children: [
            /* @__PURE__ */ f("p", { className: um({ variant: s }), children: r }),
...
function Pa({
  ...
  const c = Tt(), d = Object.keys(r)[0] ?? null, [u, h] = ie(d), [m, v] = ie(e);
  ne(() => {
    v(e);
  }, [e]), ne(() => {
    if (!u && r) {
  ...
  const y = (_, S) => {
    ...
    t(m);
  }, T = j(() => n || Object.entries(r).reduce((S, [k, b]) => {
    const x = ls(b.type);
    return Math.max(S, x?.formHeight || hm);
  }, 0), [r, n]);
  return !r || Object.keys(r).length === 0 ? null : /* @__PURE__ */ f(lc, { dataTestId: l, children: /* @__PURE__ */ f(
    "div",
    {
      className: ue(
...
}, Gi = typeof window < "u" && typeof window.HTMLElement < "u" && typeof document < "u";
function Ue(r) {
  let e;
  ...
  if (r instanceof Date)
    ...
    e = new Set(r);
  else if (!(Gi && (r instanceof Blob || n)) && (t || Te(r)))
    if (e = t ? [] : {}, !t && !pm(r))
      e = r;
    else
      for (const i in r)
...
}, ot = (r) => typeof r == "boolean", Ui = (r) => /^\w*$/.test(r), Ha = (r) => Wn(r.replace(/["|']|\]/g, "").split(/\.|\[/)), xe = (r, e, t) => {
  let n = -1;
  const i = Ui(e) ? [e] : Ha(e), s = i.length, o = s - 1;
  for (; ++n < s; ) {
    const a = i[n];
    let l = t;
    if (n !== o) {
...
const Cn = {
  ...
  required: "required",
  validate: "validate"
}, ja = q.createContext(null), $t = () => q.useContext(ja), gm = (r) => {
  const { children: e, ...t } = r;
  return q.createElement(ja.Provider, { value: t }, e);
};
var $a = (r, e, t, n = !0) => {
  const i = {
  ...
  return i;
}, Ze = (r) => Te(r) && !Object.keys(r).length, Wa = (r, e, t, n) => {
  t(r);
  const { name: i, ...s } = r;
  return Ze(s) || Object.keys(s).length >= Object.keys(e).length || Object.keys(s).find((o) => e[o] === (!n || ht.all));
}, Lr = (r) => Array.isArray(r) ? r : [r], Ga = (r, e, t) => !r || !e || r === e || Lr(r).some((n) => n && (t ? n === e : n.startsWith(e) || e.startsWith(n)));
function Zi(r) {
  const e = q.useRef(r);
...
function vm(r) {
  ...
  return d.current = i, Zi({
    disabled: n,
    next: (u) => l.current && Ga(d.current, u.name, s) && Wa(u, c.current, t._updateFormState) && a({
      ...t._formState,
      ...u
    }),
    ...
    l.current = !1;
  }), [t]), q.useMemo(() => $a(o, t, c.current, !1), [o, t]);
}
var Et = (r) => typeof r == "string", Ua = (r, e, t, n, i) => Et(r) ? (n && e.watch.add(r), V(t, r, i)) : Array.isArray(r) ? r.map((s) => (n && e.watch.add(s), V(t, s))) : (n && (e.watchAll = !0), t);
function ym(r) {
  ...
  a.current = n, Zi({
    ...
    next: (d) => {
      Ga(a.current, d.name, o) && c(Ue(Ua(a.current, t._names, d.values || t._formValues, !1, i)));
    }
  });
...
function bm(r) {
  const e = $t(), { name: t, disabled: n, control: i = e.control, shouldUnregister: s } = r, o = Va(i._names.array, t), a = ym({
    control: i,
    name: t,
  ...
  return q.useEffect(() => {
    const h = i._options.shouldUnregister || s, m = (v, y) => {
      const g = V(i._fields, v);
      g && g._f && (g._f.mount = y);
    };
    if (m(t, !0), h) {
      const v = Ue(V(i._options.defaultValues, t));
      xe(i._defaultValues, t, v), Re(V(i._formValues, t)) && xe(i._formValues, t, v);
    }
...
}), Os = (r, e, t) => !t && (e.watchAll || e.watch.has(r) || [...e.watch].some((n) => r.startsWith(n) && /^\.\w+/.test(r.slice(n.length))));
const Fr = (r, e, t, n) => {
...
}, qi = (r) => r.type === "file", Ct = (r) => typeof r == "function", En = (r) => {
  if (!Gi)
    return !1;
  const e = r ? r.ownerDocument : 0;
  return r instanceof (e && e.defaultView ? e.defaultView.HTMLElement : HTMLElement);
}, an = (r) => Et(r), Ki = (r) => r.type === "radio", Sn = (r) => r instanceof RegExp;
const Ms = {
  value: !1,
  isValid: !1
}, Ls = { value: !0, isValid: !0 };
var qa = (r) => {
  if (Array.isArray(r)) {
    if (r.length > 1) {
    ...
    return r[0].checked && !r[0].disabled ? (
      ...
      r[0].attributes && !Re(r[0].attributes.value) ? Re(r[0].value) || r[0].value === "" ? Ls : { value: r[0].value, isValid: !0 } : Ls
    ) : Ms;
  }
  return Ms;
};
...
var Ka = (r) => Array.isArray(r) ? r.reduce((e, t) => t && t.checked && !t.disabled ? {
  isValid: !0,
  value: t.value
} : e, Fs) : Fs;
...
var rr = (r) => Te(r) && !Sn(r) ? r : {
  ...
  const { ref: o, refs: a, required: l, maxLength: c, minLength: d, min: u, max: h, pattern: m, validate: v, name: y, valueAsNumber: g, mount: T } = r._f, _ = V(t, y);
  if (!T || e.has(y))
    return {};
  const S = a ? a[0] : o, k = (D) => {
    i && S.reportValidity && (S.setCustomValidity(ot(D) ? "" : D || ""), S.reportValidity());
  }, b = {}, x = Ki(o), w = Xr(o), R = x || w, z = (g || qi(o)) && Re(o.value) && Re(_) || En(o) && o.value === "" || _ === "" || Array.isArray(_) && !_.length, L = Za.bind(null, y, n, b), A = (D, O, G, I = Dt.maxLength, U = Dt.minLength) => {
    const H = D ? O : G;
    b[y] = {
      type: D ? I : U,
      message: H,
  ...
  if (s ? !Array.isArray(_) || !_.length : l && (!R && (z || We(_)) || ot(_) && !_ || w && !qa(a).isValid || x && !Ka(a).isValid)) {
  ...
  if (!z && (!We(u) || !We(h))) {
    ...
    if (!We(_) && !isNaN(_)) {
      ...
      const U = o.valueAsDate || new Date(_), H = (he) => /* @__PURE__ */ new Date((/* @__PURE__ */ new Date()).toDateString() + " " + he), re = o.type == "time", le = o.type == "week";
      Et(G.value) && _ && (D = re ? H(_) > H(G.value) : le ? _ > G.value : U > new Date(G.value)), Et(I.value) && _ && (O = re ? H(_) < H(I.value) : le ? _ < I.value : U < new Date(I.value));
    }
    if ((D || O) && (A(!!D, G.message, I.message, Dt.max, Dt.min), !n))
  ...
  if ((c || d) && !z && (Et(_) || s && Array.isArray(_))) {
    ...
    if ((G || I) && (A(G, D.message, O.message), !n))
      return k(b[y].message), b;
  }
  if (m && !z && Et(_)) {
    const { value: D, message: O } = rr(m);
    if (Sn(D) && !_.match(D) && (b[y] = {
      type: Dt.pattern,
      message: O,
      ref: o,
      ...L(Dt.pattern, O)
  ...
  if (v) {
    if (Ct(v)) {
      const D = await v(_, t), O = Is(D, S);
      if (O && (b[y] = {
        ...O,
        ...L(Dt.validate, O.message)
      }, !n))
...
function Me(r, e) {
  const t = Array.isArray(e) ? e : Ui(e) ? [e] : Ha(e), n = t.length === 1 ? r : _m(r, t), i = t.length - 1, s = t[i];
  return n && delete n[s], i !== 0 && (Te(n) && Ze(n) || Array.isArray(n) && Cm(n)) && Me(r, t.slice(0, -1)), r;
}
var ri = () => {
  let r = [];
  return {
...
function Pt(r, e) {
  ...
  for (const i of t) {
    ...
    if (i !== "ref") {
      const o = e[i];
      if (Ut(s) && Ut(o) || Te(s) && Te(o) || Array.isArray(s) && Array.isArray(o) ? !Pt(s, o) : s !== o)
        return !1;
    }
  }
  return !0;
}
var Xa = (r) => r.type === "select-multiple", Em = (r) => Ki(r) || Xr(r), ni = (r) => En(r) && r.isConnected, Ya = (r) => {
  for (const e in r)
    if (Ct(r[e]))
      return !0;
  return !1;
...
function kn(r, e = {}) {
  ...
  if (Te(r) || t)
    for (const n in r)
      Array.isArray(r[n]) || Te(r[n]) && !Ya(r[n]) ? (e[n] = Array.isArray(r[n]) ? [] : {}, kn(r[n], e[n])) : We(r[n]) || (e[n] = !0);
  return e;
}
function Ja(r, e, t) {
  ...
  if (Te(r) || n)
    for (const i in r)
      Array.isArray(r[i]) || Te(r[i]) && !Ya(r[i]) ? Re(e) || yi(t[i]) ? t[i] = Array.isArray(r[i]) ? kn(r[i], []) : { ...kn(r[i]) } : Ja(r[i], We(e) ? {} : e[i], t[i]) : t[i] = !Pt(r[i], e[i]);
  return t;
}
var Er = (r, e) => Ja(r, e, kn(e)), Qa = (r, { valueAsNumber: e, valueAsDate: t, setValueAs: n }) => Re(r) ? r : e ? r === "" ? NaN : r && +r : t && Et(r) ? new Date(r) : n ? n(r) : r;
function ii(r) {
  const e = r.ref;
  return qi(e) ? e.files : Ki(e) ? Ka(r.refs).value : Xa(e) ? [...e.selectedOptions].map(({ value: t }) => t) : Xr(e) ? qa(r.refs).value : Qa(Re(e.value) ? r.ref.value : e.value, r);
}
var Sm = (r, e, t, n) => {
  const i = {};
  for (const s of r) {
...
var km = (r) => !!r && !!r.validate && !!(Ct(r.validate) && r.validate.constructor.name === zs || Te(r.validate) && Object.values(r.validate).find((e) => e.constructor.name === zs)), Dm = (r) => r.mount && (r.required || r.min || r.max || r.maxLength || r.minLength || r.pattern || r.validate);
function Bs(r, e, t) {
  const n = V(r, t);
  if (n || Ui(t))
    return {
...
var Nm = (r, e, t, n, i) => i.isOnAll ? !1 : !t && i.isOnTouch ? !(e || r) : (t ? n.isOnBlur : i.isOnBlur) ? !r : (t ? n.isOnChange : i.isOnChange) ? r : !0, Rm = (r, e) => !Wn(V(r, e)).length && Me(r, e);
const Tm = {
  mode: ht.onSubmit,
...
function Am(r = {}) {
  ...
  const d = {
    ...
    array: ri(),
    state: ri()
  }, h = As(e.mode), m = As(e.reValidateMode), v = e.criteriaMode === ht.all, y = (p) => (C) => {
    clearTimeout(c), c = setTimeout(p, C);
  }, g = async (p) => {
    if (!e.disabled && (d.isValid || p)) {
      const C = e.resolver ? Ze((await R()).errors) : await L(n, !0);
    ...
    if (B && N && !e.disabled) {
      if (o.action = !0, F && Array.isArray(V(n, p))) {
        const Z = N(V(n, p), B.argA, B.argB);
        M && xe(n, p, Z);
      }
      if (F && Array.isArray(V(t.errors, p))) {
        const Z = N(V(t.errors, p), B.argA, B.argB);
        M && xe(t.errors, p, Z), Rm(t.errors, p);
      }
      if (d.touchedFields && F && Array.isArray(V(t.touchedFields, p))) {
    ...
    const M = V(n, p);
    if (M) {
      const F = V(s, p, Re(N) ? V(i, p) : N);
      Re(F) || B && B.defaultChecked || C ? xe(s, p, C ? F : ii(M._f)) : I(p, F), o.mount && g();
    }
  }, x = (p, C, N, B, M) => {
    let F = !1, Z = !1;
    const oe = {
    ...
    if (!e.disabled) {
      ...
      if (!N || B) {
        d.isDirty && (Z = t.isDirty, t.isDirty = oe.isDirty = D(), F = Z !== oe.isDirty);
        const _e = Ce || Pt(V(i, p), C);
        Z = !!(!Ce && V(t.dirtyFields, p)), _e || Ce ? Me(t.dirtyFields, p) : xe(t.dirtyFields, p, !0), oe.dirtyFields = t.dirtyFields, F = F || d.dirtyFields && Z !== !_e;
      }
      if (N) {
        const _e = V(t.touchedFields, p);
        _e || (xe(t.touchedFields, p, N), oe.touchedFields = t.touchedFields, F = F || d.touchedFields && _e !== N);
      }
      F && M && u.state.next(oe);
    }
    return F ? oe : {};
  }, w = (p, C, N, B) => {
    const M = V(t.errors, p), F = d.isValid && ot(C) && t.isValid !== C;
    if (e.delayError && N ? (l = y(() => S(p, N)), l(e.delayError)) : (clearTimeout(c), l = null, N ? xe(t.errors, p, N) : Me(t.errors, p)), (N ? !Pt(M, N) : M) || !Ze(B) || F) {
      const Z = {
        ...B,
        ...F && ot(C) ? { isValid: C } : {},
        errors: t.errors,
    ...
    T(p, !0);
    const C = await e.resolver(s, e.context, Sm(p || a.mount, n, e.criteriaMode, e.shouldUseNativeValidation));
    return T(p), C;
  }, z = async (p) => {
    ...
    for (const B in p) {
      ...
      if (M) {
        const { _f: F, ...Z } = M;
        if (F) {
          const oe = a.array.has(F.name), Ce = M._f && km(M._f);
          Ce && d.validatingFields && T([B], !0);
          const _e = await Ps(M, a.disabled, s, v, e.shouldUseNativeValidation && !C, oe);
          if (Ce && d.validatingFields && T([B]), _e[F.name] && (N.valid = !1, C))
            break;
          !C && (V(_e, F.name) ? oe ? wm(t.errors, _e, F.name) : xe(t.errors, F.name, _e[F.name]) : Me(t.errors, F.name));
        }
        !Ze(Z) && await L(Z, C, N);
      }
    }
    ...
    for (const p of a.unMount) {
      const C = V(n, p);
      C && (C._f.refs ? C._f.refs.every((N) => !ni(N)) : !ni(C._f.ref)) && ce(p);
    }
    a.unMount = /* @__PURE__ */ new Set();
  }, D = (p, C) => !e.disabled && (p && C && xe(s, p, C), !Pt(Pe(), i)), O = (p, C, N) => Ua(p, a, {
    ...o.mount ? s : Re(C) ? i : Et(p) ? { [p]: C } : C
  }, N, C), G = (p) => Wn(V(o.mount ? s : i, p, e.shouldUnregister ? V(i, p, []) : [])), I = (p, C, N = {}) => {
    const B = V(n, p);
    let M = C;
    if (B) {
      const F = B._f;
      F && (!F.disabled && xe(s, p, Qa(C, F)), M = En(F.ref) && We(C) ? "" : C, Xa(F.ref) ? [...F.ref.options].forEach((Z) => Z.selected = M.includes(Z.value)) : F.refs ? Xr(F.ref) ? F.refs.length > 1 ? F.refs.forEach((Z) => (!Z.defaultChecked || !Z.disabled) && (Z.checked = Array.isArray(M) ? !!M.find((oe) => oe === Z.value) : M === Z.value)) : F.refs[0] && (F.refs[0].checked = !!M) : F.refs.forEach((Z) => Z.checked = Z.value === M) : qi(F.ref) ? F.ref.value = "" : (F.ref.value = M, F.ref.type || u.values.next({
        name: p,
        values: { ...s }
      })));
    }
    ...
    for (const B in C) {
      const M = C[B], F = `${p}.${B}`, Z = V(n, F);
      (a.array.has(p) || Te(M) || Z && !Z._f) && !Ut(M) ? U(F, M, N) : I(F, M, N);
    }
  }, H = (p, C, N = {}) => {
    const B = V(n, p), M = a.array.has(p), F = Ue(C);
    xe(s, p, F), M ? (u.array.next({
      ...
      dirtyFields: Er(i, s),
      isDirty: D(p, F)
    })) : B && !B._f && !We(F) ? U(p, F, N) : I(p, F, N), Os(p, a) && u.state.next({ ...t }), u.values.next({
    ...
    const C = p.target;
    let N = C.name, B = !0;
    const M = V(n, N), F = () => C.type ? ii(M._f) : Ba(p), Z = (oe) => {
      B = Number.isNaN(oe) || Ut(oe) && isNaN(oe.getTime()) || Pt(oe, V(s, N, oe));
    };
    if (M) {
      let oe, Ce;
      const _e = F(), je = p.type === Cn.BLUR || p.type === Cn.FOCUS_OUT, Gt = !Dm(M._f) && !e.resolver && !V(t.errors, N) && !M._f.deps || Nm(je, V(t.touchedFields, N), t.isSubmitted, m, h), Qt = Os(N, a, je);
      xe(s, N, _e), je ? (M._f.onBlur && M._f.onBlur(p), l && l(0)) : M._f.onChange && M._f.onChange(p);
      const rt = x(N, _e, je, !1), Yr = !Ze(rt) || Qt;
      if (!je && u.values.next({
        name: N,
        type: p.type,
        values: { ...s }
      }), Gt)
        return d.isValid && (e.mode === "onBlur" && je ? g() : je || g()), Yr && u.state.next({ name: N, ...Qt ? {} : rt });
      if (!je && Qt && u.state.next({ ...t }), e.resolver) {
        const { errors: Jr } = await R([N]);
        if (Z(_e), B) {
          const qn = Bs(t.errors, n, N), er = Bs(Jr, n, qn.name || N);
          oe = er.error, N = er.name, Ce = Ze(Jr);
        }
      } else
        T([N], !0), oe = (await Ps(M, a.disabled, s, v, e.shouldUseNativeValidation))[N], T([N]), Z(_e), B && (oe ? Ce = !1 : d.isValid && (Ce = await L(n, !0)));
      B && (M._f.deps && he(M._f.deps), w(N, Ce, oe, rt));
    }
  }, le = (p, C) => {
    ...
    if (e.resolver) {
      ...
      N = Ze(F), B = p ? !M.some((Z) => V(F, Z)) : N;
    } else p ? (B = (await Promise.all(M.map(async (F) => {
      const Z = V(n, F);
      return await L(Z && Z._f ? { [F]: Z } : Z);
    }))).every(Boolean), !(!B && !t.isValid) && g()) : B = N = await L(n);
    return u.state.next({
      ...!Et(p) || d.isValid && N !== t.isValid ? {} : { name: p },
      ...e.resolver || !p ? { isValid: N } : {},
      errors: t.errors
    }), C.shouldFocus && !B && Fr(n, le, p ? M : a.mount), B;
  }, Pe = (p) => {
    const C = {
      ...o.mount ? s : i
    };
    ...
    const B = (V(n, p, { _f: {} })._f || {}).ref, M = V(t.errors, p) || {}, { ref: F, message: Z, type: oe, ...Ce } = M;
    xe(t.errors, p, {
      ...Ce,
      ...C,
      ref: B
    ...
    (ot(p) && o.mount || p || a.disabled.has(C)) && (p ? a.disabled.add(C) : a.disabled.delete(C), x(C, ii(N ? N._f : V(B, C)._f), !1, !1, !0));
  }, se = (p, C = {}) => {
    let N = V(n, p);
    const B = ot(C.disabled) || ot(e.disabled);
    return xe(n, p, {
      ...N || {},
      _f: {
      ...
      field: N,
      disabled: ot(C.disabled) ? C.disabled : e.disabled,
      name: p
    }) : b(p, !0, C.value), {
      ...
      ref: (M) => {
        if (M) {
          se(p, C), N = V(n, p);
          const F = Re(M.value) && M.querySelectorAll && M.querySelectorAll("input,select,textarea")[0] || M, Z = Em(F), oe = N._f.refs || [];
          if (Z ? oe.find((Ce) => Ce === F) : F === N._f.ref)
            return;
          xe(n, p, {
            _f: {
              ...N._f,
          ...
          N = V(n, p, {}), N._f && (N._f.mount = !1), (e.shouldUnregister || C.shouldUnregister) && !(Va(a.array, p) && o.action) && a.unMount.add(p);
      }
    };
  }, ee = () => e.shouldFocusError && Fr(n, le, a.mount), $ = (p) => {
    ot(p) && (u.state.next({ disabled: p }), Fr(n, (C, N) => {
      const B = V(n, N);
    ...
    if (u.state.next({
      ...
      const { errors: F, values: Z } = await R();
      t.errors = F, M = Z;
    } else
      await L(n);
    ...
    V(n, p) && (Re(C.defaultValue) ? H(p, Ue(V(i, p))) : (H(p, C.defaultValue), xe(i, p, Ue(C.defaultValue))), C.keepTouched || Me(t.touchedFields, p), C.keepDirty || (Me(t.dirtyFields, p), t.isDirty = C.defaultValue ? D(p, Ue(V(i, p))) : D()), C.keepError || (Me(t.errors, p), d.isValid && g()), u.state.next({ ...t }));
  }, He = (p, C = {}) => {
    const N = p ? Ue(p) : i, B = Ue(N), M = Ze(p), F = M ? i : B;
    if (C.keepDefaultValues || (i = N), !C.keepValues) {
      if (C.keepDirtyValues) {
        ...
        for (const oe of Array.from(Z))
          V(t.dirtyFields, oe) ? xe(F, oe, V(s, oe)) : H(oe, V(F, oe));
      } else {
        if (Gi && Re(p))
    ...
    a = {
      ...
      isDirty: M ? !1 : C.keepDirty ? t.isDirty : !!(C.keepDefaultValues && !Pt(p, i)),
...
function el(r = {}) {
  ...
  return s._options = r, Zi({
    ...
    next: (o) => {
      Wa(o, s._proxyFormState, s._updateFormState, !0) && i({ ...s._formState });
    }
  ...
  }, [r.shouldUnregister, s]), e.current.formState = $a(n, s), e.current;
}
var Om = "Label", tl = lt.forwardRef((r, e) => /* @__PURE__ */ f(
  dc.label,
  {
    ...r,
    ref: e,
...
Dn.displayName = rl.displayName;
const nl = gm, il = lt.createContext(
  {}
), Vs = ({
  ...r
}) => {
  const { formState: e } = $t();
  return /* @__PURE__ */ f(il.Provider, { value: { name: r.name }, children: /* @__PURE__ */ f(xm, { ...r, disabled: e.isSubmitting }) });
}, Gn = () => {
  const r = lt.useContext(il), e = lt.useContext(sl), { getFieldState: t, formState: n } = $t(), i = t(r.name, n);
  if (!r)
  ...
  {}
), ol = lt.forwardRef(({ className: r, ...e }, t) => {
  const n = lt.useId();
  return /* @__PURE__ */ f(sl.Provider, { value: { id: n }, children: /* @__PURE__ */ f("div", { ref: t, className: ue("space-y-2", r), ...e }) });
});
ol.displayName = "FormItem";
const Mm = lt.forwardRef(({ className: r, ...e }, t) => {
...
al.displayName = "FormControl";
const ll = lt.forwardRef(({ className: r, ...e }, t) => {
...
const cl = lt.forwardRef(
  ({ className: r, children: e, fallback: t, ...n }, i) => {
    const { error: s, formMessageId: o } = Gn(), { forms: a } = Tt(), l = s ? s.message ?? t ?? a.validation.invalidType : e;
    return l ? /* @__PURE__ */ W(
      "div",
      {
        ref: i,
        ...
        ...n,
        children: [
          /* @__PURE__ */ f(Wr, { icon: yo, color: "critical" }),
    ...
    ui,
    {
      ...
      leftContent: n ? /* @__PURE__ */ W("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ W("div", { className: "flex items-center gap-0.5", children: [
          /* @__PURE__ */ f(Wr, { icon: yo, size: "md", color: "critical" }),
...
const Xi = "gap-4", dl = "mt-6", ul = "max-w-[720px]", Wt = "md", Yi = vt(null);
function Ji() {
  const r = ct(Yi);
  if (!r)
...
function hl(r) {
  return Ee(r, "ZodOptional") || Ee(r, "ZodNullable") || Ee(r, "ZodDefault") && hl(r._def.innerType);
}
...
function Pm(r) {
  const e = yt(r);
  return Ee(e, "ZodString") ? (e._def.checks || []).some((n) => n.kind === "min" ? (n.value ?? 0) >= 1 : Im.has(n.kind)) : !1;
}
function ml(r) {
  if (hl(r))
    return !1;
  const e = yt(r);
  return Ee(e, "ZodString") ? Pm(r) : !0;
}
function zm(r, e) {
  const t = e[r.fieldId];
  if ("equalsTo" in r)
...
function Un(r, e) {
  return typeof r == "function" ? r({ values: e }) : zm(r, e);
}
function Qi(r, e) {
...
function Vm({
  ...
  const t = r.validation && Bm(r.validation);
  return /* @__PURE__ */ f(
    mc,
    {
      ...e,
...
function Gm({
  ...
  const i = e.value ?? void 0, s = j(() => bi(i), [i]), o = X(
    (h) => {
      if (!h) {
        e.onChange(null);
        return;
    ...
    (h) => {
      ...
      if (!i) {
        ...
        v.setHours(0, 0, 0, 0), e.onChange(si(v, m));
        return;
      }
      e.onChange(si(i, m));
    },
...
function tp({
  ...
  const t = r.validation && ep(r.validation);
  return /* @__PURE__ */ f(
    gc,
    {
      ...e,
...
function ip({
  ...
  const i = r.inputType ?? "text", s = r.placeholder ?? rp[i] ?? void 0, o = np[i];
  return /* @__PURE__ */ f(
    bo,
    {
      ...e,
...
function op({
  ...
  const a = !!r.file, l = e?.(), c = l?.upload, d = l?.cancelUpload, u = l?.progress ?? 0, h = l?.status ?? "idle", [m, v] = ie(null), y = Y(!1), g = X(async () => {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ W("div", { className: "flex min-w-0 flex-1 flex-col gap-0.5", children: [
          ...
          /* @__PURE__ */ f("span", { className: "text-sm text-f1-foreground-secondary", children: m || (_ ? h === "processing" ? o.processing : `${o.uploading} ${S}%` : x != null ? sp(x) : null) })
        ] }),
        !s && /* @__PURE__ */ f(
          qe,
          {
...
function dp({
  ...
  const { forms: n } = Tt(), { initialFiles: i } = Ji(), s = Yc(), o = Y(null), [a, l] = ie(!1), c = r.multiple ?? !1, [d, u] = ie(
    () => cp(i, e.value, c)
  ), [h, m] = ie(null), v = n.file, y = d.length > 0, g = c || !y, T = r.accept ? r.accept.map(xi).join(",") : void 0, _ = j(
    () => lp(r.accept),
    [r.accept]
  ), S = X(
    (I) => r.accept && !r.accept.some((U) => {
      const H = xi(U);
      return H.endsWith("/*") ? I.type.startsWith(H.replace("/*", "/")) : I.type === H;
    }) ? v.invalidFileType.replace(
      "{{types}}",
      _ ?? ""
    ) : r.maxSizeMB && I.size > r.maxSizeMB * 1024 * 1024 ? v.fileTooLarge.replace(
      "{{maxSize}}",
      String(r.maxSizeMB)
    ) : null,
    [r.accept, r.maxSizeMB, v, _]
  ), k = X(
    (I) => {
      m(null);
      const U = c ? I : [I[0]];
      for (const H of U) {
        ...
        const le = `${H.name}-${H.size}-${Date.now()}-${Math.random()}`;
        u((he) => c ? [...he, { key: le, file: H }] : [{ key: le, file: H }]);
      }
    },
    [c, S]
  ), b = X(
    ...
    (I, U) => {
      if (u(
        (H) => H.map((re) => re.key === I ? { ...re, value: U } : re)
      ), c) {
        const H = Array.isArray(e.value) ? e.value : [];
        e.onChange([...H, U]);
      } else
        e.onChange(U);
    },
    ...
    (I) => {
      const U = d.find((H) => H.key === I);
      if (u((H) => H.filter((re) => re.key !== I)), U?.value)
        if (c) {
          const H = Array.isArray(e.value) ? e.value : [];
          e.onChange(H.filter((re) => re !== U.value));
        } else
          e.onChange(void 0);
    ...
    u(
      (H) => H.map(
        (re) => re.key === I ? { ...re, error: U } : re
      )
    );
  }, []), G = a ? v.dropzoneActive : r.description ?? (c ? v.dropzoneMultiple : v.dropzone);
  return /* @__PURE__ */ W("div", { className: "flex flex-col gap-2", children: [
    g && /* @__PURE__ */ W(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ f("div", { className: "flex aspect-square items-center justify-center rounded-md border border-solid border-f1-border p-1 text-f1-icon", children: /* @__PURE__ */ f(Wr, { icon: xc, size: "lg" }) }),
          /* @__PURE__ */ W("div", { className: "flex flex-col items-center gap-0.5", children: [
            ...
            !a && _ && /* @__PURE__ */ f("span", { className: "text-center text-sm text-f1-foreground-secondary/70", children: v.acceptedTypes.replace(
              "{{types}}",
              _
            ) })
          ] })
...
function fp({
  ...
  const o = !!t.error, { isValidating: a } = t, l = Qi(r.disabled, s) || n, c = {
    error: o,
    loading: a
  };
  switch (r.type) {
...
function Zn({ field: r, sectionId: e }) {
  const t = $t(), n = t.watch(), { isSubmitting: i } = t.formState, { formName: s } = Ji(), { forms: o } = Tt(), a = Qi(r.disabled, n), l = Y(a);
  ne(() => {
    const m = l.current;
  ...
  const c = !r.renderIf || Un(r.renderIf, n), d = r.type !== "checkbox" && r.type !== "custom", u = r.validation && ml(r.validation), h = qt(s, e, r.id);
  return c ? /* @__PURE__ */ f(
    Vs,
    {
      control: t.control,
      name: r.id,
      render: ({ field: m, fieldState: v }) => /* @__PURE__ */ W(ol, { id: h, className: "scroll-mt-4", children: [
        d && /* @__PURE__ */ W(
          "label",
          {
            htmlFor: r.id,
        ...
        r.helpText && /* @__PURE__ */ f(ll, { children: r.helpText }),
        /* @__PURE__ */ f(
          cl,
          {
...
function es({ row: r, sectionId: e }) {
  return /* @__PURE__ */ f("div", { className: `flex xs:flex-row flex-col ${Xi} [&>*]:flex-1`, children: r.fields.map((t) => /* @__PURE__ */ f(Zn, { field: t, sectionId: e }, t.id)) });
}
function hp(r) {
  const e = yt(r);
  return Ee(e, "ZodLiteral") && e._def.value === !0;
}
function ts({ fields: r }) {
  const e = $t(), { watch: t, setValue: n } = e, { isSubmitting: i } = e.formState, s = t(), o = j(
    () => r.filter(
      (h) => !h.renderIf || Un(h.renderIf, s)
    ),
    [r, s]
  ), a = j(
    () => Object.fromEntries(
  ...
  const c = j(
    () => o.map((h) => ({
      ...
      disabled: a[h.id] ?? !1,
      required: !!(h.validation && hp(h.validation))
    })),
    [o, a]
  ), d = j(
...
const $s = (r, e, t) => {
  ...
  for (const t in e.fields) {
    const n = e.fields[t];
    n && n.ref && "reportValidity" in n.ref ? $s(n.ref, t, r) : n.refs && n.refs.forEach((i) => $s(i, t, r));
  }
}, mp = (r, e) => {
  e.shouldUseNativeValidation && vl(r, e);
  const t = {};
  for (const n in r) {
    const i = V(e.fields, n), s = Object.assign(r[n] || {}, { ref: i && i.ref });
    if (pp(e.names || Object.keys(r), n)) {
      const o = Object.assign({}, V(t, n));
      xe(o, "root", s), xe(t, n, o);
    } else xe(t, n, s);
  }
  return t;
}, pp = (r, e) => r.some((t) => t.startsWith(e + "."));
var gp = function(r, e) {
  for (var t = {}; r.length; ) {
    ...
    if ("unionErrors" in n && n.unionErrors.forEach(function(d) {
      ...
      t[o] = Za(o, e, t, i, c ? [].concat(c, n.message) : n.message);
    }
    r.shift();
  }
  return t;
      ...
      return Promise.resolve((function(o, a) {
        try {
          var l = Promise.resolve(r[t.mode === "sync" ? "parse" : "parseAsync"](n, e)).then(function(c) {
            return s.shouldUseNativeValidation && vl({}, s), { errors: {}, values: t.raw ? n : c };
          });
        } catch (c) {
          return a(c);
        }
        ...
        })(o)) return { values: {}, errors: mp(gp(o.errors, !s.shouldUseNativeValidation && s.criteriaMode === "all"), s) };
        throw o;
      }));
    } catch (o) {
...
const de = Object.freeze({
  status: "aborted"
}), kr = (r) => ({ status: "dirty", value: r }), ut = (r) => ({ status: "valid", value: r }), Gs = (r) => r.status === "aborted", Us = (r) => r.status === "dirty", ur = (r) => r.status === "valid", Nn = (r) => typeof Promise < "u" && r instanceof Promise;
var Q;
(function(r) {
...
const wp = /^c[^\s-]{8,}$/i, _p = /^[0-9a-z]+$/, Cp = /^[0-9A-HJKMNP-TV-Z]{26}$/i, Ep = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i, Sp = /^[a-z0-9_-]{21}$/i, kp = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/, Dp = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/, Np = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i, Rp = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let oi;
const Tp = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, Ap = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/, Op = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/, Mp = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/, Lp = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/, Fp = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/, yl = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))", Ip = new RegExp(`^${yl}$`);
function bl(r) {
  let e = "[0-5]\\d";
...
function Bp(r, e) {
  return !!((e === "v4" || !e) && Tp.test(r) || (e === "v6" || !e) && Op.test(r));
}
function Vp(r, e) {
  if (!kp.test(r))
    return !1;
...
function Hp(r, e) {
  return !!((e === "v4" || !e) && Ap.test(r) || (e === "v6" || !e) && Mp.test(r));
}
class Zt extends ve {
  _parse(e) {
    ...
    for (const s of this._def.checks)
      if (s.kind === "min")
        ...
        (o || a) && (i = this._getOrReturnCtx(e, i), o ? K(i, {
          code: P.too_big,
          maximum: s.value,
          type: "string",
          inclusive: !0,
        ...
        Np.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
          validation: "email",
          code: P.invalid_string,
          message: s.message
        }), n.dirty());
      else if (s.kind === "emoji")
        oi || (oi = new RegExp(Rp, "u")), oi.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
          validation: "emoji",
          code: P.invalid_string,
          message: s.message
        }), n.dirty());
      else if (s.kind === "uuid")
        Ep.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
          validation: "uuid",
          code: P.invalid_string,
          message: s.message
        }), n.dirty());
      else if (s.kind === "nanoid")
        Sp.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
          validation: "nanoid",
          code: P.invalid_string,
          message: s.message
        }), n.dirty());
      else if (s.kind === "cuid")
        wp.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
          validation: "cuid",
          code: P.invalid_string,
          message: s.message
        }), n.dirty());
      else if (s.kind === "cuid2")
        _p.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
          validation: "cuid2",
          code: P.invalid_string,
          message: s.message
        }), n.dirty());
      else if (s.kind === "ulid")
        Cp.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
          validation: "ulid",
          code: P.invalid_string,
          message: s.message
        }), n.dirty());
        ...
        message: s.message
      }), n.dirty()) : s.kind === "datetime" ? zp(s).test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
        code: P.invalid_string,
        validation: "datetime",
        message: s.message
      }), n.dirty()) : s.kind === "date" ? Ip.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
        code: P.invalid_string,
        validation: "date",
        message: s.message
      }), n.dirty()) : s.kind === "time" ? Pp(s).test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
        code: P.invalid_string,
        validation: "time",
        message: s.message
      }), n.dirty()) : s.kind === "duration" ? Dp.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
        validation: "duration",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "ip" ? Bp(e.data, s.version) || (i = this._getOrReturnCtx(e, i), K(i, {
        validation: "ip",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "jwt" ? Vp(e.data, s.alg) || (i = this._getOrReturnCtx(e, i), K(i, {
        validation: "jwt",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "cidr" ? Hp(e.data, s.version) || (i = this._getOrReturnCtx(e, i), K(i, {
        validation: "cidr",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "base64" ? Lp.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
        validation: "base64",
        code: P.invalid_string,
        message: s.message
      }), n.dirty()) : s.kind === "base64url" ? Fp.test(e.data) || (i = this._getOrReturnCtx(e, i), K(i, {
...
class Hr extends ve {
  ...
  _parse(e) {
    ...
    const i = new et();
    for (const s of this._def.checks)
      s.kind === "int" ? be.isInteger(e.data) || (n = this._getOrReturnCtx(e, n), K(n, {
        code: P.invalid_type,
        expected: "integer",
        received: "float",
        message: s.message
        ...
        exact: !1,
        message: s.message
      }), i.dirty()) : s.kind === "multipleOf" ? jp(e.data, s.value) !== 0 && (n = this._getOrReturnCtx(e, n), K(n, {
...
class Oe extends ve {
  ...
  keyof() {
    return xl(be.objectKeys(this.shape));
  }
}
...
class An extends ve {
  _parse(e) {
    const { status: t, ctx: n } = this._processInputParams(e), i = (s, o) => {
      ...
      return a.valid ? ((Us(s) || Us(o)) && t.dirty(), { status: t.value, value: a.data }) : (K(n, {
...
function so(r) {
  return qp(r) ? "email" : Kp(r) ? "url" : "text";
}
function oo(r, e, t, n) {
  const i = {
    id: r,
  ...
  switch (n) {
    case "text": {
      const o = "inputType" in t && t.inputType ? t.inputType : so(e);
      return {
        ...i,
        type: "text",
        inputType: o,
    ...
    case "date": {
      const o = ai(e), a = "minDate" in t ? t.minDate : void 0, l = "maxDate" in t ? t.maxDate : void 0;
      return {
        ...i,
        type: "date",
...
function kl({
  ...
  const u = Tt(), h = El(t), m = o?.label ?? "Submit", v = o?.icon === null ? void 0 : o?.icon ?? xo, y = o?.showSubmitWhenDirty ?? !1, g = o?.hideSubmitButton ?? !1, T = j(() => Sl(u), [u]), _ = Xp[a], S = j(
    () => _l(t, { errorMap: T }),
    [t, T]
  ), k = el({
    resolver: S,
    mode: _,
    defaultValues: i
  }), b = k.formState.errors.root, { isSubmitting: x, isDirty: w } = k.formState, R = Object.keys(k.formState.errors).filter((I) => I !== "root").length > 0, z = Y(null), L = X(
    async (I) => {
      const U = { ...I };
      for (const re of Object.keys(U))
        U[re] === null && (U[re] = void 0);
      const H = await s(U);
      H.success ? k.reset(I) : (H.errors && Object.entries(H.errors).forEach(([re, le]) => {
        k.setError(re, { message: le });
      }), H.rootMessage && k.setError("root", { message: H.rootMessage }));
    },
    [s, k]
  );
  ne(() => {
  ...
  return /* @__PURE__ */ f(Yi.Provider, { value: D, children: /* @__PURE__ */ f(nl, { ...k, children: /* @__PURE__ */ W(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ W(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ f(Mo, { title: O, description: G ?? "" }),
              n?.action && /* @__PURE__ */ f(
                qe,
                {
        ...
        /* @__PURE__ */ f("div", { className: `flex flex-col ${Xi}`, children: A.map((I, U) => {
          switch (I.type) {
            case "switchGroup":
              return /* @__PURE__ */ f(
                ts,
        ...
        !g && (!y || w) && /* @__PURE__ */ f("div", { className: "mt-4", children: /* @__PURE__ */ f(
          qe,
          {
            type: "submit",
            label: m,
...
function Qp({ section: r }) {
  const t = $t().watch(), { formName: n } = Ji(), { title: i, description: s, renderIf: o, action: a, fields: l } = r.section, c = r.id;
  if (o && !Un(o, t))
    return null;
  const d = Jp(l), u = qt(n, c);
  return /* @__PURE__ */ W("section", { id: u, className: "flex flex-col scroll-mt-4", children: [
    /* @__PURE__ */ W(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ f(Mo, { title: i, description: s ?? "" }),
          a && /* @__PURE__ */ f(
            qe,
            {
              label: a.label,
    ...
    /* @__PURE__ */ f("div", { className: `flex flex-col ${Xi}`, children: d.map((h, m) => h.type === "switchGroup" ? /* @__PURE__ */ f(
      ts,
      {
        fields: h.fields,
        sectionId: c
...
function eg({
  ...
  const t = Object.keys(e).filter((h) => h !== "root"), n = t.length > 0, i = t.length, [s, o] = ie(0), a = Y([]);
  ne(() => {
    const h = t, m = a.current, v = h.find(
      (y) => !m.includes(y)
    );
    if (v) {
      const y = qt(r, void 0, v);
      ao(y);
      const g = h.indexOf(v);
      g !== -1 && o(g);
    }
...
function Dl(r) {
  const {
    ...
    styling: c,
    initialFiles: d
  } = r, u = c?.showSectionsSidepanel ?? !1, h = j(() => Object.keys(t), [t]), m = X(
    (_) => {
      const S = qt(e, _), k = document.getElementById(S);
  ...
  })), [n, h, u, m]), T = /* @__PURE__ */ f("div", { className: ue("flex w-full flex-col", ul, a), children: h.map((_, S) => {
    const k = t[_], b = n?.[_], x = i?.[_], w = b?.submitConfig ?? o;
    return /* @__PURE__ */ f(
      "div",
      {
        id: qt(e, _),
        className: ue("scroll-mt-4", S !== 0 && dl),
        children: /* @__PURE__ */ f(
          kl,
          {
            formName: e,
  ...
  return u && g.length > 0 ? /* @__PURE__ */ W("div", { className: "flex w-full gap-4", children: [
    ...
    /* @__PURE__ */ f("div", { className: "flex flex-1 justify-center", children: T })
  ] }) : T;
}
function ig(r) {
...
function Nl(r) {
  const e = r;
  if (ig(e))
    return /* @__PURE__ */ f(sg, { ...e });
  const t = e;
  return rg(t.schema) ? /* @__PURE__ */ f(
    Rl,
    {
      ...t
    }
...
function Rl(r) {
  const e = Tt(), { forms: t } = e, {
    ...
    styling: u,
    formRef: h
  } = r, m = u?.showSectionsSidepanel ?? !1, v = l?.type === "action-bar", y = l?.label ?? "Submit", g = l?.icon === null ? void 0 : l?.icon ?? xo, T = l?.type !== "action-bar" && l?.hideSubmitButton, _ = l?.type !== "action-bar" && !!l?.hideActionBar, S = !v && !T, k = l?.type === "action-bar" && l?.discardable, b = v ? l?.discardConfig : void 0, x = b?.label ?? t.actionBar.discard, w = b?.icon === null ? void 0 : b?.icon ?? wc, R = v ? l?.actionBarLabel ?? t.actionBar.unsavedChanges : t.actionBar.unsavedChanges, z = l?.savingMessage ?? t.actionBar.saving, L = v && !!l?.centerActionBarInFrameContent, A = El(i, s), D = j(() => A.filter((M) => M.type === "section").map((M) => M.id), [A]), [O, G] = ie(
    D[0]
  ), I = X(
    (M) => {
      G(M);
      const F = qt(n, M), Z = document.getElementById(F);
    ...
    label: s[M]?.title ?? M,
    onClick: () => I(M)
  })), [s, D, m, I]), H = j(() => Sl(e), [e]), re = ng[d], le = j(
    () => _l(i, { errorMap: H }),
    [i, H]
  ), he = el({
    resolver: le,
    mode: re,
    defaultValues: o
  }), Pe = he.formState.errors.root, { isDirty: we, isSubmitting: ke, errors: Fe } = he.formState, [me, ce] = ie("idle"), [Se, se] = ie(), ee = Y(null), {
    hasErrors: $,
    errorCount: De,
    ...
    ee.current && (clearTimeout(ee.current), ee.current = null), Jc(() => {
      ce("loading");
    });
    const F = { ...M };
    ...
    }, 3e3)) : (ce("idle"), Z.errors && Object.entries(Z.errors).forEach(([oe, Ce]) => {
  ...
  const C = tg(A), N = j(
    ...
    "form",
    {
      ...
      className: ue("flex flex-col", ul, c),
      children: [
        C.map((M, F) => {
          const Z = F !== 0 && M.type !== "section" ? "mt-4" : "";
          switch (M.type) {
            case "switchGroup":
              return /* @__PURE__ */ f("div", { className: Z, children: /* @__PURE__ */ f(ts, { fields: M.fields }) }, `switch-group-${F}`);
            case "field":
              return /* @__PURE__ */ f("div", { className: Z, children: /* @__PURE__ */ f(Zn, { field: M.item.field }) }, M.item.field.id);
            case "row":
              return /* @__PURE__ */ f("div", { className: Z, children: /* @__PURE__ */ f(es, { row: M.item }) }, `row-${M.index}`);
            case "section":
              return /* @__PURE__ */ f(
                "div",
                {
                  className: F !== 0 ? dl : "",
                  children: /* @__PURE__ */ f(Qp, { section: M.item })
                },
                M.item.id
              );
            default:
        ...
        !v && S && /* @__PURE__ */ f("div", { className: "mt-4", children: /* @__PURE__ */ f(
          qe,
          {
            type: "submit",
            label: y,
  ...
  return /* @__PURE__ */ f(Yi.Provider, { value: N, children: /* @__PURE__ */ W(nl, { ...he, children: [
...
function Tl() {
  const [r, e] = ie(!1), [t, n] = ie(!1), i = Y((u) => {
    ...
    s.current.reset();
  }, []), c = X(() => s.current ? s.current.isDirty() : (console.warn("useF0Form: formRef is not attached to an F0Form component"), !1), []), d = X(() => s.current ? s.current.getValues() : (console.warn("useF0Form: formRef is not attached to an F0Form component"), {}), []);
  return {
    formRef: o.current,
    submit: a,
    reset: l,
...
const pv = at("F0Form", Nl), Al = vt(null);
function lg() {
  const r = ct(Al);
  if (!r)
...
function cg({ children: r, ...e }) {
  return /* @__PURE__ */ f(Al.Provider, { value: e, children: r });
}
const dg = Xt({
...
function fg({ state: r, index: e }) {
  return r === "completed" ? /* @__PURE__ */ f("span", { className: "flex h-5 w-5 min-w-5 shrink-0 items-center justify-center rounded-xs bg-f1-background-secondary text-f1-foreground-secondary", children: /* @__PURE__ */ f(_c, { className: "h-3 w-3" }) }) : /* @__PURE__ */ f(
    Cc,
    {
      value: e + 1,
...
function hg() {
  const { steps: r, currentStep: e, goToStep: t, allowStepSkipping: n } = lg();
  return /* @__PURE__ */ f("nav", { "aria-label": "Wizard steps", className: "flex flex-col gap-1.5 p-1", children: r.map((i, s) => {
    const o = s < e || i.isCompleted?.() === !0, a = ug(s, e, o), l = r[e]?.hasErrors?.() === !0, c = s > e && r.slice(e, s).some((m) => m.hasErrors?.() === !0);
    ...
    return d && !n && s > e + 1 && (d = !1), /* @__PURE__ */ W(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ f("span", { className: dg({ state: a }), children: i.title })
        ]
      },
      s
    );
...
function mg({
  ...
  const h = X(
    ...
    async (g) => {
      if (!(g < 0 || g >= u.current.length || u.current[a]?.hasErrors?.() === !0 || !i && g > a + 1 || g > a && u.current.slice(a, g).some((S) => S.hasErrors?.() === !0) || !u.current.slice(0, g).every((_) => _.isCompleted?.() !== !1))) {
        if (g > a) {
          d(!0);
          try {
            for (let _ = a; _ < g; _++) {
...
const pg = () => {
  ...
  const y = j(() => {
    ...
    onClose: n
  }), T = Tt(), _ = r[g.currentStep], S = g.currentStep === 0, k = g.currentStep === r.length - 1, b = k ? _?.nextLabel ?? c ?? T.wizard.submit : _?.nextLabel ?? a ?? T.wizard.next, x = _?.previousLabel ?? l ?? T.wizard.previous, w = j(
    () => ({
      label: b,
      icon: k ? void 0 : Ec,
      onClick: () => {
      ...
      children: /* @__PURE__ */ f(
        cg,
        {
          ...
          children: /* @__PURE__ */ W("div", { className: "flex h-[58vh] flex-1 flex-row", children: [
            /* @__PURE__ */ f("div", { className: "w-1/3 shrink-0 overflow-y-auto border-x-0 border-b-0 border-r border-t-0 border-dashed border-f1-border-secondary p-2", children: /* @__PURE__ */ f(hg, {}) }),
...
const vg = 3e3;
function Ll() {
  const { forms: r } = Tt(), [e, t] = ie("idle"), [n, i] = ie(), s = Y(null);
  ne(() => () => {
  ...
  }, []), a = e === "success" ? n ?? r.actionBar.saved : void 0, l = j(
    () => /* @__PURE__ */ f(
      ui,
      {
        isOpen: e === "success",
...
function yg({
  ...
  } = r, b = S?.label, x = j(() => Object.keys(y), [y]), w = j(() => e ? e.some(
  ...
  const G = X(
    ...
    (se) => {
      ...
      return ee ? ee.sectionIds.every(($) => {
        const De = y[$];
        if (!De) return !1;
        const Ae = T?.[$] ?? R.current[$];
        return Ml(De, Ae, ee.isCompleted);
      }) : !1;
    },
    [m, H, y, T]
  ), le = j(() => {
    if (o !== void 0) return o;
    if (!m) return;
    const se = H.findIndex(
      (ee, $) => !re($)
    );
    return se === -1 ? H.length - 1 : se;
  }, [o, m, H, re]), he = j(
    () => Fl(
      x,
      g,
  ...
  ), Pe = Y(null), { showSuccess: we, ActionBar: ke } = Ll(), Fe = X(
    (se) => async (ee) => {
      R.current[se] = ee;
      const $ = await _({
        sectionId: se,
...
function xg({
  ...
  const {
  ...
  ), re = Y(null), le = Y(null), { showSuccess: he, ActionBar: Pe } = Ll(), we = X(
    async (me) => {
      Object.assign(L.current, me);
      const ce = { ...L.current };
      le.current = ce;
      const Se = await _({ data: ce });
    ...
    (me) => {
      ...
      Object.assign(L.current, ce), A.current = me, c?.(me);
    },
    [z, c]
  );
  return /* @__PURE__ */ f(
...
function gv(r) {
  ...
  return j(() => {
    const l = wg(t) ? "single" : "per-section";
    return {
      name: e,
      schema: t,
      sections: n,
...
const vv = ye(Il), Pl = Ke((r, e) => /* @__PURE__ */ f(Li, { ref: e, variant: "heading", ...r }));
Pl.displayName = "F0Heading";
const yv = ye(Pl), bv = ye(Dc), xv = ye(
  at(
    "F0GridStack",
    Mi
  )
...
), _g = ({ benefits: r }) => /* @__PURE__ */ f("div", { className: "flex flex-col gap-2", children: r.map((e, t) => /* @__PURE__ */ f(Cg, { text: e }, t)) }), Cg = ({ text: r }) => /* @__PURE__ */ W("div", { className: "flex flex-row items-start gap-2", children: [
  /* @__PURE__ */ f(Wr, { icon: Tc, size: "md", className: "text-f1-icon-positive" }),
          ...
          /* @__PURE__ */ W("div", { className: "flex flex-col gap-5", children: [
            /* @__PURE__ */ W("div", { className: "flex flex-col gap-2", children: [
              ...
              (a || l) && /* @__PURE__ */ W("div", { className: "flex justify-start gap-2", children: [
                a && /* @__PURE__ */ f(Nc, { icon: a.icon, text: a.label }),
                l && /* @__PURE__ */ f(
                  Rc,
                  {
...
zl.displayName = "ProductBlankslate";
const Eg = ye(zl);
function Sg({
  isOpen: r,
  onClose: e,
  ...
  return ne(() => {
    a(r);
  }, [r]), /* @__PURE__ */ f(Ac, { open: o, onOpenChange: (c) => {
    a(c), c || e();
    ...
    Oc,
    {
      ...
      children: [
        /* @__PURE__ */ W("div", { className: "flex flex-row items-center justify-between px-4 py-4", children: [
          /* @__PURE__ */ W(Mc, { className: "flex flex-row items-center gap-2 text-lg font-semibold text-f1-foreground", children: [
            i && /* @__PURE__ */ f(wo, { module: i, size: "lg" }),
            t
          ] }),
          /* @__PURE__ */ f(
            Ni,
        ...
        /* @__PURE__ */ W(go, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[512px] flex-col", children: [
          n,
          /* @__PURE__ */ f(
            vo,
            {
...
function kg({
  ...
  const [_, S] = ie(r), [k, b] = ie(null), [x, w] = ie(!1), R = async () => {
    if (d?.onClick) {
      w(!0);
      try {
        await d.onClick(), S(!1), T && b("success");
      } catch {
        T && b("error");
      } finally {
        w(!1);
...
function Dg({
  ...
  return /* @__PURE__ */ f(Yt, { children: c ? null : /* @__PURE__ */ W(Lc, { style: { width: s }, className: "relative bg-f1-background p-1", children: [
    ...
    a && /* @__PURE__ */ f(Ic, { className: "p-3", children: a.map(
...
function Rg({
  ...
  const [T, _] = ie(!1), [S, k] = ie(null), [b, x] = ie(null), w = (D) => {
    e(D), y && y();
  }, R = async (D) => {
    if (D.type === "upsell") {
      x(D);
  ...
  }, L = r && !T, A = v?.map((D) => D.type === "upsell" ? {
    ...D,
    onClick: () => R(D)
  } : D);
  return /* @__PURE__ */ W(Yt, { children: [
    /* @__PURE__ */ W(ho, { open: L, onOpenChange: w, children: [
      /* @__PURE__ */ f(mo, { asChild: !0, children: /* @__PURE__ */ f(
        qe,
        {
          variant: n,
          label: t,
...
const Ev = ye(Rg), Tg = vt(
  null
), Ag = ({ children: r, fullScreen: e = !0 }) => {
  const t = Y(null), [n, i] = ie(t.current);
  return Wc(() => {
    i(t.current);
  }, []), /* @__PURE__ */ f(Tg.Provider, { value: { element: n }, children: /* @__PURE__ */ f(
    "div",
    {
      ref: t,
      id: "f0-layout",
  ...
  children: r
}) => /* @__PURE__ */ f(Bd, { reducedMotion: "user", children: r }), Sv = ({
  children: r,
  layout: e,
  link: t,
...
}) => /* @__PURE__ */ f(Og, { children: /* @__PURE__ */ f(
  zc,
  {
    isDev: a,
    showExperimentalWarnings: c,
    renderDataTestIdAttribute: d,
    children: /* @__PURE__ */ f(Bc, { ...o, children: /* @__PURE__ */ f(Vc, { ...s, children: /* @__PURE__ */ f(Hc, { ...t, children: /* @__PURE__ */ f(Ag, { ...e, children: /* @__PURE__ */ f(jc, { children: /* @__PURE__ */ f(
      Pd,
      {
        initiallyEnabled: n,
        children: /* @__PURE__ */ f($c, { ...i, children: /* @__PURE__ */ f(
          zd,
          {
            handler: l,
            children: r
...
) }), lo = (r) => `datacollection-${r}`, kv = {
  get: async (r) => JSON.parse(
    localStorage.getItem(lo(r)) ?? "{}"
  ),
  set: async (r, e) => {
    localStorage.setItem(lo(r), JSON.stringify(e));
  }
};
export {
  Rv as A,
  hb as AiChatTranslationsProvider,
  Wg as AreaChart,
  Tv as Await,
  Gg as BarChart,
  Av as Blockquote,
  ...
  Iv as F0ActionItem,
  Pv as F0AiChat,
  zv as F0AiChatProvider,
  Bv as F0AiChatTextArea,
  Vv as F0AiCollapsibleMessage,
  Hv as F0AiFullscreenChat,
  dv as F0Alert,
  mb as F0AuraVoiceAnimation,
  jv as F0Avatar,
  Td as F0AvatarAlert,
  $v as F0AvatarCompany,
  nb as F0AvatarDate,
  Wv as F0AvatarEmoji,
  bc as F0AvatarFile,
  sc as F0AvatarIcon,
  ...
  Uv as F0AvatarPerson,
  Zv as F0AvatarTeam,
  Jg as F0BigNumber,
  Qg as F0Box,
  qe as F0Button,
  qv as F0ButtonDropdown,
  Kv as F0ButtonToggle,
  Xv as F0Card,
  mc as F0Checkbox,
  lv as F0ChipList,
  Yv as F0DataDownload,
  Oo as F0DatePicker,
  Jv as F0Dialog,
  Qv as F0DialogContext,
  ey as F0DialogProvider,
  ty as F0EventCatcherProvider,
  uv as F0FilterPickerContent,
  pv as F0Form,
  xv as F0GridStack,
  ...
  Wr as F0Icon,
  ac as F0Link,
  ry as F0MessageSources,
  ny as F0OneIcon,
  iy as F0OneSwitch,
  Sv as F0Provider,
  ar as F0Select,
  wv as F0TableOfContentPopover,
  sy as F0TagAlert,
  ec as F0TagBalance,
  oy as F0TagCompany,
  ay as F0TagDot,
  ...
  uy as F0Thinking,
  vv as F0WizardForm,
  fy as FullscreenChatContext,
  hy as GROUP_ID_SYMBOL,
  my as H1,
  py as H2,
  gy as H3,
  $g as HomeLayout,
  ...
  Cv as UpsellingBanner,
  Io as UpsellingButton,
  Ev as UpsellingPopover,
  Kg as VerticalBarChart,
  gb as actionItemStatuses,
  vb as aiTranslations,
  zg as avatarVariants,
  Ay as buildTranslations,
  nv as buttonDropdownSizes,
  rv as buttonDropdownVariants,
  tv as buttonSizes,
  iv as buttonToggleSizes,
  sv as buttonToggleVariants,
  ev as buttonVariants,
  Oy as cardImageFits,
  My as cardImageSizes,
  sb as createAtlaskitDriver,
  Ly as createDataSourceDefinition,
  ou as createPageLayoutBlock,
  au as createPageLayoutBlockGroup,
  kv as dataCollectionLocalStorageHandler,
  cv as datepickerSizes,
  wb as defaultTranslations,
  Un as evaluateRenderIf,
  at as experimental,
  fv as f0FormField,
  Fy as f0MarkdownRenderers,
  Iy as f0MarkdownRenderersSimple,
  qt as generateAnchorId,
  Py as getAnimationVariants,
  zy as getDataSourcePaginationType,
  By as getEmojiLabel,
  yr as getF0Config,
  mv as getSchemaDefinition,
  hv as hasF0Config,
  Fm as inferFieldType,
  Vy as isInfiniteScrollPagination,
  Hy as isPageBasedPagination,
  Ee as isZodType,
  ov as linkVariants,
  jy as modules,
  yb as oneIconSizes,
  ob as predefinedPresets,
  ab as selectSizes,
  av as tagDotColors,
  yt as unwrapZodSchema,
  $y as useAiChat,
  bb as useAiChatTranslations,
  Wy as useData,
  Gy as useDataSource,
  Uy as useDefaultCopilotActions,
  lb as useDndEvents,
  cb as useDraggable,
  db as useDroppableList,
  Zy as useEmojiConfetti,
  qy as useF0Dialog,
  Tl as useF0Form,
  gv as useF0FormDefinition,
  Ky as useGroups,
  Xy as useMessageSourcesAction,
  Yy as useOrchestratorThinkingAction,
  ub as usePrivacyMode,
  Jy as useReducedMotion,

import { c as G, a as Ge, b as Dn, m as Si, B as Ni, O as Yr, p as qr, w as Rn, S as we, u as Sn, F as Nn, d as Jr, A as Zr, D as Qr, e as es, f as fe, C as ve, g as ts, h as is, i as An, j as ns, k as Lt, P as On, l as kn, n as Tn, o as zn, q as Pn, r as Mn, s as rs, t as ss, v as os, x as as, y as ls, z as We, E as Ji, G as cs, H as ds, J as us, K as hs, L as Ln, M as fs, N as gs, Q as ps, R as ms, T as vs, U as In, V as ys, W as bs, X as xs, I as ws, Y as Cs, Z as _s, _ as Es, $ as Ds } from "./index-CzM1iuC5.js";
import { ag as zd, av as Pd, a0 as Md, a1 as Ld, a2 as Id, a3 as Hd, a5 as Fd, a6 as Bd, a7 as Wd, a8 as Gd, a9 as $d, aa as jd, ab as Ud, ac as Vd, ar as Kd, ae as Xd, ah as Yd, af as qd, as as Jd, am as Zd, ap as Qd, al as eu, aw as tu, ak as iu, aj as nu, a4 as ru, ai as su, an as ou, ax as au, ad as lu, ao as cu, au as du, aq as uu, at as hu } from "./index-CzM1iuC5.js";
import { jsx as f, jsxs as z, Fragment as Jt } from "react/jsx-runtime";
...
import { L as Bn, C as Ts, i as Wn, D as zs, S as Qi, a as Ps, f as ui, b as ct, c as Ms, A as Ls, d as kt, e as Gn, E as Is, g as Pt, h as Hs, j as Fs, k as Bs, l as Ye, m as $n, u as Ws, G as Gs, n as $s, o as en, p as js, q as jn, r as Us, B as Un, X as Vn, Y as xi, s as Vs, t as Kn, v as Ks, w as Xs, x as Ys, y as qs, z as Js, F as Zs, H as Qs, I as eo, J as tn, K as to, M as dt, N as hi, O as io, P as no, Q as ro, R as so, T as oo, U as ao, V as lo, W as co, Z as uo, _ as ho, $ as fo, a0 as nn, a1 as go, a2 as po, a3 as mo, a4 as vo, a5 as Xn, a6 as yo, a7 as bo, a8 as rn, a9 as xo, aa as Yn, ab as wo, ac as Co, ad as _o, ae as Eo } from "./DataCollectionStorageProvider-jXeeGHG1.js";
import { ax as gu, af as pu, ag as mu, aj as vu, ak as yu, ao as bu, ap as xu, aq as wu, as as Cu, at as _u, au as Eu, av as Du, an as Ru, ar as Su, ah as Nu, ai as Au, aw as Ou, al as ku, am as Tu, ay as zu, az as Pu, aA as Mu, aB as Lu } from "./DataCollectionStorageProvider-jXeeGHG1.js";
...
function zo({ children: n, options: e, onResizeStop: t, onChange: i, widgets: r }) {
  const [s, o] = F(null), a = M(null), c = M(!1), d = H(() => ({
    ...e,
    children: (r || []).map((x) => qe(x))
  }), [e, r]), [l, u] = F(() => {
    const x = /* @__PURE__ */ new Map(), R = r || [], y = (v) => {
      v.id && v.content && x.set(v.id, v.content), v.subGridOpts?.children && v.subGridOpts.children.forEach((D) => {
        y(D);
      });
    };
    return R.forEach((v) => {
  ...
  const [g, w] = F(() => {
    const x = /* @__PURE__ */ new Map(), R = r || [], y = (v) => {
      v.id && v._originalContent !== void 0 && x.set(v.id, v._originalContent), v.subGridOpts?.children && v.subGridOpts.children.forEach((D) => {
        y(D);
      });
    };
    return R.forEach((v) => {
  ...
  const [_, E] = F(() => {
    const x = /* @__PURE__ */ new Map(), R = r || [], y = (v) => {
      ...
      v.subGridOpts?.children && v.subGridOpts.children.forEach((D) => {
        y(D);
      });
    };
    return R.forEach((v) => {
  ...
  Dn(() => {
    ...
    if (!Array.isArray(x))
      return;
    const R = x.map((A) => A.id), y = r || [], v = y.map((A) => A.id), D = y.filter((A) => !R.includes(A.id));
    ...
    const m = x.filter((A) => !v.includes(A.id));
    if (m.length > 0) {
      const A = m.map((C) => C.id).filter(Boolean);
      A.forEach((C) => {
        setTimeout(() => {
    ...
    if (k.length > 0) {
      const A = [];
      k.forEach((C) => {
        const S = x.find((B) => B.id === C.id);
        if (!S)
          return;
        const O = ko.filter((B) => S[B] !== C[B]);
        if (O.length > 0) {
  ...
  const N = U(() => {
    ...
    if (Array.isArray(x)) {
      const R = x.map((y) => {
        const v = y.id;
        if (!v) return null;
        const D = h.current.get(v), m = b.current.get(v), k = y;
        return {
          ...y,
          id: v,
          w: y.w ?? 1,
...
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.`)), i;
  ...
  constructor(e, t = {}) {
    ...
    const c = t.engineClass || T.engineClass || Ne;
  ...
  createWidgetDivs(e) {
    ...
    return p.lazyLoad(e) ? e.visibleObservable || (e.visibleObservable = new IntersectionObserver(([r]) => {
      r.isIntersecting && (e.visibleObservable?.disconnect(), delete e.visibleObservable, T.renderCB(i, e), e.grid?.prepareDragDrop(e.el));
    }), window.setTimeout(() => e.visibleObservable?.observe(t))) : T.renderCB(i, e), t;
  }
  /**
  ...
  makeSubGrid(e, t, i, r = !0) {
    ...
    if (r && (this._removeDD(s.el), u = { ...s, x: 0, y: 0 }, p.removeInternalForSave(u), delete u.subGridOpts, s.content && (u.content = s.content, delete s.content), T.addRemoveCB ? l = T.addRemoveCB(this.el, u, !0, !1) : (l = p.createDiv(["grid-stack-item"]), l.appendChild(d), d = p.createDiv(["grid-stack-item-content"], s.el)), this.prepareDragDrop(s.el)), i) {
      const g = c ? t.column : s.w, w = s.h + i.h, b = s.el.style;
      b.transition = "none", this.update(s.el, { w: g, h: w }), setTimeout(() => b.transition = null);
    }
    const h = s.subGrid = T.addGrid(d, t);
  ...
  load(e, t = T.addRemoveCB || !0) {
    ...
    c && this.setAnimation(!1), !a && t && [...this.engine.nodes].forEach((u) => {
      if (!u.id)
        return;
      p.find(e, u.id) || (T.addRemoveCB && T.addRemoveCB(this.el, u, !1, !1), o.push(u), this.removeWidget(u.el, !0, !1));
    ...
    }), delete this.engine._loading, this.engine.removedNodes = o, this.batchUpdate(!1), delete this._ignoreLayoutsNodeChange, delete this.engine.skipCacheUpdate, s ? T.addRemoveCB = s : delete T.addRemoveCB, c && this.setAnimation(!0, !0), this;
  }
  /**
  ...
  update(e, t) {
    return T.getElements(e).forEach((i) => {
      ...
      if (o.some((l) => s[l] !== void 0 && s[l] !== r[l]) && (a = {}, o.forEach((l) => {
        ...
        l && l.textContent !== s.content && (r.content = s.content, T.renderCB(l, s), r.subGrid?.el && (l.appendChild(r.subGrid.el), r.subGrid._updateContainerHeight())), delete s.content;
      }
      let c = !1, d = !1;
      for (const l in s)
      ...
      (a || c) && this._writeAttr(i, r), d && this.prepareDragDrop(r.el), T.updateCB && T.updateCB(r);
    }), this;
  }
  moveNode(e, t) {
    const i = e._updating;
  ...
  _setupAcceptWidget() {
    ...
    return Z.droppable(this.el, {
      ...
      a._temporaryRemoved = !0) : (a.w = c, a.h = d, a._temporaryRemoved = !0), T._itemRemoving(a.el, !1), Z.on(s, "drag", i), i(r, s, o), !1;
  ...
  _setupRemoveDrop() {
    ...
    return e ? (!this.opts.staticGrid && !Z.isDroppable(e) && Z.droppable(e, this.opts.removableOptions).on(e, "dropover", (t, i) => T._itemRemoving(i, !0)).on(e, "dropout", (t, i) => T._itemRemoving(i, !1)), this) : this;
  }
  /**
      ...
      const d = (h, g) => {
        ...
        if (!(!w.gridstackNode || w.gridstackNode.grid !== this)) {
          if (i.el = w, i._isAboutToRemove) {
            ...
            b._gsEventHandler[h.type] && b._gsEventHandler[h.type](h, w), b.engine.nodes.push(i), b.removeWidget(e, !0, !0);
          } else
  ...
  _dragOrResize(e, t, i, r, s, o) {
    ...
    if (d = Math.min(d, w), l = Math.min(l, w), u = Math.min(u, g), h = Math.min(h, g), t.type === "drag") {
      if (r._temporaryRemoved)
        return;
      const _ = i.position.top - r._prevYPix;
      r._prevYPix = i.position.top, this.opts.draggable.scroll !== !1 && p.updateScrollPosition(e, i.position, _);
      const E = i.position.left + (i.position.left > r._lastUiPosition.left ? -l : d), N = i.position.top + (i.position.top > r._lastUiPosition.top ? -h : u);
      a.x = Math.round(E / s), a.y = Math.round(N / o);
      ...
      if (a.x < 0 || (p.updateScrollResize(t, e, o), a.w = Math.round((i.size.width - d) / s), a.h = Math.round((i.size.height - u) / o), r.w === a.w && r.h === a.h) || r._lastTried && r._lastTried.w === a.w && r._lastTried.h === a.h)
        return;
      const _ = i.position.left + d, E = i.position.top + u;
      a.x = Math.round(_ / s), a.y = Math.round(E / o), c = !0;
    }
    ...
    if (this.engine.moveNodeCheck(r, { ...a, cellWidth: s, cellHeight: o, rect: b, resizing: c })) {
      ...
      const _ = t.target;
      r._sidebarOrig || this._writePosAttr(_, r), this.triggerEvent(t, _);
    }
  }
...
function Wo({ children: n }) {
  const { _gridStack: { value: e, set: t }, options: i } = Zn(), r = M(/* @__PURE__ */ new Map()), s = M(null), o = M(i), a = U((l, u) => {
    ...
    if (s.current) {
      T.renderCB = a;
      const l = T.init(o.current, s.current);
      return l && o.current.handle && l.opts && (l.opts.handle = o.current.handle), l;
    }
    return null;
  }, [a]), d = (l, u) => {
    const { children: h, ...g } = l, { children: w, ...b } = u;
    return Wn(g, b);
  };
  return bi(() => {
    if (!d(i, o.current) && e)
...
const ki = ({ options: n, widgets: e, onChange: t, className: i }) => {
  const r = H(() => JSON.stringify(e.map((c) => ({
    ...
    let u = l[0], h = 1 / 0;
    for (const g of l) {
      const w = g.w - c, b = g.h - d, _ = w * w + b * b;
      _ < h && (h = _, u = g);
    }
    return u;
  };
...
const Go = (n, e, t) => f("div", {
  ...
  const o = U((y, v, D) => f(Si.div, {
    ...
    if (typeof y.content == "function" && y.deps && v) {
      const D = {};
      return y.deps.forEach((m) => {
        typeof m == "string" && v[m] !== void 0 && (D[m] = v[m]);
      }), y.content(D);
    }
    ...
    const k = c(m, D), A = {
      ...
      meta: m.meta,
      _originalContent: k,
      content: o(k, m.meta, v)
    };
    return m.x !== void 0 && (A.x = m.x), m.y !== void 0 && (A.y = m.y), A;
  }), [l, u] = F(d(n, e)), h = M(e), g = M(n), w = M(!1), b = M(/* @__PURE__ */ new Map()), _ = M(n);
  _.current = n;
  const E = M(s), N = H(() => {
    const y = /* @__PURE__ */ new Map();
    return !s || Object.keys(s).length === 0 || n.forEach((v) => {
      if (v.deps && v.deps.length > 0) {
        const D = v.deps.map((m) => typeof m == "string" && s[m] !== void 0 ? s[m] : m).filter((m) => m !== null);
        y.set(v.id, D);
      }
    }), y;
  }, [n, s]), x = U((y) => {
    u(y), w.current || t(y.map((v) => {
      const D = _.current.find((m) => m.id === v.id);
      return {
        id: v.id,
        w: v.w ?? 1,
        h: v.h ?? 1,
        allowedSizes: v.allowedSizes,
        meta: v.meta,
        content: typeof D?.content == "function" ? D.content : v._originalContent,
        x: v.x ?? 0,
        y: v.y ?? 0,
        locked: v.locked,
        deps: D?.deps
  ...
  }, [t]), R = (y, v) => !y && !v ? !1 : !y || !v || y.length !== v.length ? !0 : y.some((D, m) => D !== v[m]);
  return I(() => {
    const y = h.current !== e, v = g.current !== n, D = E.current !== s && (E.current === void 0 || s === void 0 || Object.keys(E.current).length !== Object.keys(s).length || Object.keys(s).some((C) => E.current?.[C] !== s[C])), m = /* @__PURE__ */ new Map();
    n.forEach((C) => {
      if (C.deps && C.deps.length > 0) {
        const S = b.current.get(C.id), O = N.get(C.id);
        m.set(C.id, R(S, O)), O ? b.current.set(C.id, O) : b.current.delete(C.id);
      }
    });
    const k = new Set(n.map((C) => C.id));
    b.current.forEach((C, S) => {
      k.has(S) || b.current.delete(S);
    });
    const A = Array.from(m.values()).some((C) => C) || D;
    y && !v && !A ? (w.current = !0, u((C) => C.map((S) => {
      ...
      return n.map((O) => {
        const B = S.get(O.id), q = m.get(O.id) ?? !1;
        let ee;
    ...
    }), h.current = e, g.current = n, E.current = s;
  }, [n, e, o, N, s]), f(ki, {
...
Ti.displayName = "Text";
const nr = oe(({ testId: n, ...e }, t) => f(Ti, {
  ref: t,
  markdown: e.markdown ?? !0,
  ...e
}));
...
const Qc = [
  ...
  "file",
  "flag"
], rr = ({ title: n, draggable: e = !1, onDragStart: t, onDragEnd: i, isDragging: r = !1, AIButton: s, actions: o, children: a, selected: c = !1, testId: d }) => {
  const [l, u] = F(!1), [h, g] = F(!1), w = Sn(), b = (E) => {
    u(E);
  }, _ = h || l;
  return I(() => {
    if (!r || !i) return;
...
const Jo = jo("Dashboard", sr), ed = fe("Dashboard", Jo), Zo = Ge({
  ...
  const u = H(() => ea(d.actions || []), [d.actions]), h = H(() => u.flatMap((w) => w.items), [u]), g = H(() => h.length > 0 || !!c, [h, c]);
  return z("div", {
    ref: l,
    className: G(Zo({
      variant: e
...
function wt(n) {
  return et(n) ? !1 : n instanceof Q(n).HTMLElement;
}
function ar(n) {
...
const Ea = (n) => {
  ...
  for (const o of i) {
    ...
    if (c) {
      const d = cn(c), l = r.reduce((h, g, w) => h + xa(d[w], g), 0), u = Number((l / 4).toFixed(4));
      s.push({
        id: a,
        data: {
...
function La(n, e, t, i, r) {
  ...
  return !d && s <= e.top + b.height ? (g.y = X.Backward, w.y = i * Math.abs((e.top + b.height - s) / b.height)) : !l && c >= e.bottom - b.height && (g.y = X.Forward, w.y = i * Math.abs((e.bottom - b.height - c) / b.height)), !h && a >= e.right - b.width ? (g.x = X.Forward, w.x = i * Math.abs((e.right - b.width - a) / b.width)) : !u && o <= e.left + b.width && (g.x = X.Backward, w.x = i * Math.abs((e.left + b.width - o) / b.width)), {
    direction: g,
    speed: w
  };
}
...
class Ii {
  constructor(e) {
    ...
    this.props = e, this.listeners = new ut(tt(t)), this.windowListeners = new ut(Q(t)), this.handleKeyDown = this.handleKeyDown.bind(this), this.handleCancel = this.handleCancel.bind(this), this.attach();
  }
  attach() {
      ...
      if (u) {
        ...
        for (const b of w) {
          const _ = e.code, {
            ...
            x: Math.min(_ === W.Right ? D.right - D.width / 2 : D.right, Math.max(_ === W.Right ? D.left : D.left + D.width / 2, u.x)),
            y: Math.min(_ === W.Down ? D.bottom - D.height / 2 : D.bottom, Math.max(_ === W.Down ? D.top : D.top + D.height / 2, u.y))
          }, k = _ === W.Right && !N || _ === W.Left && !x, A = _ === W.Down && !R || _ === W.Up && !E;
          if (k && m.x !== u.x) {
            const C = b.scrollLeft + h.x, S = _ === W.Right && C <= y.x || _ === W.Left && C >= v.x;
            if (S && !h.y) {
              b.scrollTo({
                left: C,
                behavior: a
            ...
            S ? g.x = b.scrollLeft - C : g.x = _ === W.Right ? b.scrollLeft - y.x : b.scrollLeft - v.x, g.x && b.scrollBy({
              left: -g.x,
              behavior: a
            });
            break;
          } else if (A && m.y !== u.y) {
            const C = b.scrollTop + h.y, S = _ === W.Down && C <= y.y || _ === W.Up && C >= v.y;
            if (S && !h.x) {
              b.scrollTo({
                top: C,
                behavior: a
            ...
            S ? g.y = b.scrollTop - C : g.y = _ === W.Down ? b.scrollTop - y.y : b.scrollTop - v.y, g.y && b.scrollBy({
              top: -g.y,
              behavior: a
            });
            break;
...
function Xa(n) {
  ...
  const g = qa({
    ...
    if (!v)
      return;
    const D = _.current.x * E.current.x, m = _.current.y * E.current.y;
    v.scrollBy(D, m);
  }, []), y = H(() => a === Kt.TreeOrder ? [...d].reverse() : d, [a, d]);
  I(
    () => {
      if (!s || !d.length || !N) {
        b();
      ...
      for (const v of y) {
        ...
        for (const C of ["x", "y"])
          g[C][k[C]] || (A[C] = 0, k[C] = 0);
        if (A.x > 0 || A.y > 0) {
          b(), x.current = v, w(R, o), _.current = A, E.current = k;
          return;
        }
      }
      _.current = {
...
function Qa(n, e) {
  ...
  const [s, o] = F(null), {
    ...
    measure: c,
    strategy: d
  } = r, l = M(n), u = _(), h = yt(u), g = U(function(E) {
    E === void 0 && (E = []), !h.current && o((N) => N === null ? E : N.concat(E.filter((x) => !N.includes(x))));
  }, [h]), w = M(null), b = Ct((E) => {
    if (u && !t)
      return gn;
    if (!E || E === gn || l.current !== n || s != null) {
      ...
      for (let x of n) {
        ...
        const R = x.node.current, y = R ? new Li(c(R), R) : null;
        x.rect.current = y, y && N.set(x.id, y);
      }
      return N;
    }
    return E;
...
function ll(n, e) {
  e === void 0 && (e = it);
  const [t] = n, i = wr(t ? Q(t) : null), [r, s] = F(yn);
  function o() {
...
const yl = /* @__PURE__ */ Ns(function(e) {
  ...
  const b = As(gl, void 0, fl), [_, E] = b, [N, x] = pa(), [R, y] = F(Ie.Uninitialized), v = R === Ie.Initialized, {
    draggable: {
      active: D,
      nodes: m,
      translate: k
    ...
    return D != null ? {
      ...
      data: (J = C?.data) != null ? J : ul,
      rect: S
    } : null;
  }, [D, C]), B = M(null), [q, ee] = F(null), [V, ue] = F(null), j = yt(w, Object.values(w)), he = _t("DndDescribedBy", o), Rt = H(() => A.getEnabled(), [A]), te = ml(h), {
    droppableRects: Ee,
    ...
    config: te.droppable
  }), ae = Ja(m, D), St = H(() => V ? Ut(V) : null, [V]), Oe = Xr(), De = el(ae, te.draggable.measure);
  vl({
    activeNode: D != null ? m.get(D) : null,
  ...
  const $ = pn(ae, te.draggable.measure, De), rt = pn(ae ? ae.parentElement : null), ye = M({
  ...
  }), je = (i = Re.nodeRef.current) != null ? i : ae, Ue = v ? (r = Re.rect) != null ? r : $ : null, $i = !!(Re.nodeRef.current && Re.rect), ji = nl($i ? null : $), li = wr(je ? Q(je) : null), ke = rl(v ? $e ?? ae : null), Nt = ll(ke), At = Dr(g, {
    transform: {
      x: k.x - ji.x,
      y: k.y - ji.y,
      scaleX: 1,
    ...
    windowRect: li
  }), Ui = St ? Je(St, k) : null, Vi = sl(ke), Wr = vn(Vi), Gr = vn(Vi, [$]), Ve = Je(At, Wr), Ke = Ue ? Aa(Ue, At) : null, st = O && Ke ? u({
    active: O,
    collisionRect: Ke,
    droppableRects: Ee,
    ...
    (J, ie) => {
      ...
      if (B.current == null)
        return;
      const le = m.get(B.current);
      if (!le)
        return;
      const re = J.nativeEvent, be = new ne({
        active: B.current,
        activeNode: le,
        event: re,
        options: ze,
      ...
      function Xe(Y) {
        return async function() {
          ...
          B.current = null, Ot(() => {
            E({
              type: Y
            }), y(Ie.Uninitialized), Xi(null), ee(null), ue(null), ci.current = null;
    ...
    const le = ne.nativeEvent, re = m.get(ze);
    if (
    ...
    J(ne, ie.options, be) === !0 && (le.dndKit = {
  ...
  }, [O, ae, st, Ke, m, je, Ue, Ee, A, Te, ke, Ve]), Xa({
    ...Oe,
    delta: k,
    draggingRect: Ke,
    pointerCoordinates: Ui,
  ...
  const Vr = H(() => ({
    ...
    measuringScheduled: nt,
    windowRect: li
  }), [O, ae, $, V, st, rt, Re, m, A, Ee, Te, Be, ke, Nt, te, nt, li]), Kr = H(() => ({
    activatorEvent: V,
    activators: qi,
    active: O,
    activeNodeRect: $,
  ...
  function Xr() {
    const J = q?.autoScrollEnabled === !1, ie = typeof c == "object" ? c.enabled === !1 : c === !1, ne = v && !J && !ie;
...
function wl(n) {
  ...
  const s = _t(xl), {
    ...
    tabIndex: b = 0
  } = r ?? {}, _ = c?.id === e, E = _e(_ ? oi : bl), [N, x] = $t(), [R, y] = $t(), v = al(o, e), D = yt(t);
  pe(
    () => (u.set(e, {
      id: e,
      key: s,
  ...
  const s = _t(Cl), {
    ...
    () => {
      ...
      g.current != null && clearTimeout(g.current), g.current = setTimeout(() => {
        d(Array.isArray(E.current) ? E.current : [E.current]), g.current = null;
      }, _);
    },
    //eslint-disable-next-line react-hooks/exhaustive-deps
    [_]
    ...
    x && (k && (x.unobserve(k), u.current = !1), m && x.observe(m));
  }, [x]), [y, v] = $t(R), D = yt(e);
  return I(() => {
    !x || !y.current || (x.disconnect(), u.current = !1, x.observe(y.current));
  }, [y, x]), I(
    () => (a({
...
function Wl(n) {
  ...
  } = Rr(), u = _t(Nr, t), h = a.rect !== null, g = H(() => i.map((v) => typeof v == "object" && "id" in v ? v.id : v), [i]), w = o != null, b = o ? g.indexOf(o.id) : -1, _ = d ? g.indexOf(d.id) : -1, E = M(g), N = !Fl(g, E.current), x = _ !== -1 && b === -1 || N, R = Bl(s);
  pe(() => {
    N && w && l(g);
  }, [N, g, w, l]), I(() => {
    E.current = g;
  ...
  const y = H(
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [b, u, R.draggable, R.droppable, x, g, _, c, h, r]
  );
...
function Xl(n) {
  ...
  const {
    ...
    useDragOverlay: E,
    strategy: N
  } = _e(Ar), x = Yl(i, g), R = l.indexOf(o), y = H(() => ({
    sortable: {
      containerId: u,
      index: R,
      items: l
    ...
    ...r
  }), [u, r, R, l]), v = H(() => l.slice(l.indexOf(o)), [l, o]), {
    rect: D,
    node: m,
    isOver: k,
    setNodeRef: A
  ...
  }), Rt = sa(A, q), te = !!C, Ee = te && !w && zt(h) && zt(_), Be = !E && V, nt = Be && Ee ? he : null, St = Ee ? nt ?? (a ?? N)({
    rects: b,
    activeNodeRect: O,
    activeIndex: h,
    overIndex: _,
...
const ql = [W.Down, W.Right, W.Up, W.Left], Jl = (n, e) => {
  ...
  if (ql.includes(n.code)) {
    ...
    if (l === o?.id && d.length > 1 && (l = d[1].id), l != null) {
      ...
      if (w && g && u && h) {
        const _ = ri(w).some((v, D) => a[D] !== v), E = kr(u, h), N = Zl(u, h), x = _ || !E ? {
          x: 0,
          y: 0
        } : {
...
const wn = ({ id: n, children: e }) => {
  ...
  const [o, a] = F(null), c = ba(ln(Fi), ln(Ii, {
    ...
    a(null), g && h.id !== g.id && s((w) => {
      const b = w.findIndex((E) => E.id === h.id), _ = w.findIndex((E) => E.id === g.id);
      return Wi(w, b, _);
    });
  };
  return f("div", {
  ...
  return vc(e, n), fc(e, [{
    ...
    value: function() {
      ...
      return /* @__PURE__ */ L.createElement(Ls, {
        ...
        var g = h.t, w = s.map(function(b, _) {
          var E = u && u[_];
          if (E) {
            var N = kt(E.cx, b.cx), x = kt(E.cy, b.cy), R = kt(E.size, b.size);
            return ce(ce({}, b), {}, {
              cx: N(g),
              cy: x(g),
              size: R(g)
        ...
        return /* @__PURE__ */ L.createElement(ct, null, i.renderSymbolsStatically(w));
      });
    }
  }, {
    key: "renderSymbols",
    ...
    value: function() {
      ...
      return d ? d.map(function(l, u) {
        ...
        return /* @__PURE__ */ L.cloneElement(l, {
          ...
          dataPointFormatter: function(_, E) {
            return {
              x: _.cx,
              y: _.cy,
              value: g === "x" ? +_.node.x : +_.node.y,
              errorVal: Pt(_, E)
            };
          }
        });
    ...
    value: function() {
      ...
      if (o === "joint")
        ...
        var h = Hs(r), g = h.xmin, w = h.xmax, b = h.a, _ = h.b, E = function(R) {
          return b * R + _;
        };
        l = [{
          x: g,
    ...
    key: "render",
    value: function() {
      var i = this.props, r = i.hide, s = i.points, o = i.line, a = i.className, c = i.xAxis, d = i.yAxis, l = i.left, u = i.top, h = i.width, g = i.height, w = i.id, b = i.isAnimationActive;
      if (r || !s || !s.length)
        return null;
      var _ = this.state.isAnimationFinished, E = ts("recharts-scatter", a), N = c && c.allowDataOverflow, x = d && d.allowDataOverflow, R = N || x, y = Ye(w) ? this.id : w;
      return /* @__PURE__ */ L.createElement(ct, {
        className: E,
        clipPath: R ? "url(#clipPath-".concat(y, ")") : null
      }, N || x ? /* @__PURE__ */ L.createElement("defs", null, /* @__PURE__ */ L.createElement("clipPath", {
      ...
      }, this.renderSymbols()), (!b || _) && $n.renderCallByParent(this.props, s));
    }
  }], [{
...
He(Dt, "getComposedData", function(n) {
  var e = n.xAxis, t = n.yAxis, i = n.zAxis, r = n.item, s = n.displayedData, o = n.xAxisTicks, a = n.yAxisTicks, c = n.offset, d = r.props.tooltipType, l = Gn(r.props.children, $s), u = Ye(e.dataKey) ? r.props.dataKey : e.dataKey, h = Ye(t.dataKey) ? r.props.dataKey : t.dataKey, g = i && i.dataKey, w = i ? i.range : ai.defaultProps.range, b = w && w[0], _ = e.scale.bandwidth ? e.scale.bandwidth() : 0, E = t.scale.bandwidth ? t.scale.bandwidth() : 0, N = s.map(function(x, R) {
    var y = Pt(x, u), v = Pt(x, h), D = !Ye(g) && Pt(x, g) || "-", m = [{
    ...
    var k = en({
      ...
      index: R,
      dataKey: h
    }), C = D !== "-" ? i.scale(D) : b, S = Math.sqrt(Math.max(C, 0) / Math.PI);
    return ce(ce({}, x), {}, {
      cx: k,
      cy: A,
      x: k - S,
...
const xc = (n) => {
  ...
  hide: !0
}, label: r = !1, hideTooltip: s = !1, hideGrid: o = !1, aspect: a, legend: c, showValueUnderLabel: d = !1, bar: l, line: u, scatter: h, onClick: g, testId: w }, b) => {
  const _ = Ks(e), E = l?.categories ? Array.isArray(l.categories) ? l.categories : [l.categories] : [], N = u?.categories ? Array.isArray(u.categories) ? u.categories : [u.categories] : [], x = h?.categories ? Array.isArray(h.categories) ? h.categories : [h.categories] : [], R = [...E, ...N, ...x], y = Math.max(..._.flatMap((m) => R.map((k) => Xs(i?.tickFormatter ? i.tickFormatter(`${m[k]}`) : `${m[k]}`)))), v = [l, u, h].filter((m) => m?.axisPosition === "left"), D = [l, u, h].filter((m) => m?.axisPosition === "right");
  return f(Ys, {
    config: n,
    ref: b,
    aspect: a,
    children: z(bc, {
      ...
      onClick: (m) => {
        ...
        for (const A of m.activePayload)
          k.values[A.name] = A.value;
        g(k);
      },
      children: [!s && f(qs, {
        ...Js(),
        ...
        ...tn(i),
        tick: !0,
        width: i.width ?? y + 20 + (D.length > 0 && v[0]?.axisLabel ? 20 : 0),
        ...
        orientation: "right",
        tick: !0,
        width: i.width ?? y + 20 + (v.length > 0 && D[0]?.axisLabel ? 20 : 0),
        hide: i.hide || D.some((m) => m?.hideAxis),
        label: D[0]?.axisLabel ? {
          value: D[0].axisLabel,
          angle: 90,
        ...
        hide: t?.hide,
        tick: d ? (m) => {
          const { x: k, y: A, payload: C } = m, S = e.find((q) => q.label === C.value)?.values || "", O = Object.keys(S).length === 1 ? Object.values(S)?.[0] : void 0, B = O !== void 0 && i.tickFormatter ? i.tickFormatter(`${O}`) : O.toLocaleString();
          return z("g", {
            transform: `translate(${k},${A})`,
            children: [f("text", {
              x: 0,
              y: 0,
              dy: 12,
        ...
        isAnimationActive: !1,
        dataKey: String(m),
        fill: n[m].color ? dt(n[m].color) : hi(k),
        radius: 4,
        maxBarSize: 32,
        children: r && f($n, {
          position: "top",
      ...
      }, `bar-${String(m)}`)), N.map((m, k) => f(jn, {
        type: u?.lineType ?? "natural",
        dataKey: String(m),
        stroke: n[m].color ? dt(n[m].color) : hi(E.length + k),
        strokeWidth: 2,
        dot: u?.dot ?? !1,
        isAnimationActive: !1,
        yAxisId: u?.axisPosition === "right" ? "right" : void 0
      }, `line-${String(m)}`)), x.map((m, k) => f(Dt, {
        dataKey: String(m),
        fill: n[m].color ? dt(n[m].color) : hi(E.length + N.length + k),
        r: 4,
        isAnimationActive: !1,
...
}, Cc = Kn(wc), _c = ({ value: n, max: e = 100, label: t, color: i, testId: r }, s) => {
  const o = i ? dt(i) : dt("categorical-1"), a = n / e * 100;
  return z("div", {
...
}, Ir = ({ label: n, testId: e, ...t }) => {
  const i = ho(), r = i(t.value, {
    formatterOptions: {
      decimalPlaces: 2
    }
  }), s = Dc(t.trend), o = i(t.comparison), a = fo(r.numericValue, r.formatterOptions), c = nn(o.numericValue), d = nn(r.numericValue), l = H(() => {
    if (!(!c || !s.show) && !(!c || !d))
      return (d - c) / c * 100;
  }, [d, c, s.show]);
  return z("div", {
...
const Hr = ({ chips: n, max: e = 4, remainingCount: t, layout: i = "compact", testId: r }) => {
  if (i === "fill")
    return f(rs, {
      items: n,
      renderListItem: (d) => f(Lt, {
        ...d
      }),
      renderDropdownItem: () => null,
      forceShowingOverflowIndicator: t !== void 0,
      renderOverflowIndicator: (d) => f(Ri, {
        count: (t ?? 0) + d,
  ...
  const s = n.slice(0, e), o = n.slice(e), a = t ?? n.length - e, c = a > 0;
  return z("div", {
    className: "flex items-center gap-2",
    children: [s.map((d, l) => f(Lt, {
      ...d
    }, l)), c && f(Ri, {
      count: a,
      list: t ? void 0 : o
...
}), Ed = ({ title: n, description: e, action: t, link: i, icon: r, variant: s = "neutral", testId: o }) => {
  const a = M(null);
  return f("div", {
    ref: a,
    className: "@container",
...
function kc({ filters: n, value: e, onChange: t, height: i, width: r = 600, className: s, showApplyButton: o = !0, applyButtonLabel: a }) {
  ...
  I(() => {
    ...
    if (!d && n) {
      ...
      if (_.length > 0) {
        const E = _.find((N) => {
          const x = u[N], R = Ji(n[N].type);
          return x !== void 0 && !R.isEmpty(x, {
            schema: n[N],
            i18n: c
          });
        });
  ...
  const g = (_, E) => {
    ...
    t(u);
  }, b = H(() => i || Object.entries(n).reduce((E, [N, x]) => {
    const R = Ji(x.type);
    return Math.max(E, R?.formHeight || Oc);
  }, 0), [n, i]);
...
}), Br = oe(({ title: n, image: e, benefits: t, actions: i, withShadow: r = !0, module: s, moduleName: o, tag: a, promoTag: c }, d) => z("div", {
  ref: d,
...
function Sd({ isOpen: n, onClose: e, title: t, image: i, benefits: r, errorMessage: s, successMessage: o, loadingState: a, nextSteps: c, closeLabel: d, primaryAction: l, modalTitle: u, modalModule: h, secondaryAction: g, portalContainer: w, tag: b, promoTag: _, showResponseDialog: E = !0 }) {
  const [N, x] = F(n), [R, y] = F(null), [v, D] = F(!1), m = async () => {
    if (l?.onClick) {
      D(!0);
      try {
        await l.onClick(), x(!1), E && y("success");
      } catch {
        E && y("error");
      } finally {
        D(!1);
...
function Nd({ isOpen: n, setIsOpen: e, label: t, variant: i = "promote", size: r = "md", showIcon: s = !0, side: o = "right", align: a = "center", icon: c = ys, mediaUrl: d, title: l, description: u, width: h = "300px", trackVisibility: g, actions: w, onClick: b, hideLabel: _ = !1 }) {
  const [E, N] = F(!1), [x, R] = F(null), [y, v] = F(null), D = (S) => {
    e(S), b && b();
  }, m = async (S) => {
    if (S.type === "upsell") {
      v(S);
    ...
    R(null), N(!1), v(null), e(!1);
  }, A = n && !E, C = w?.map((S) => S.type === "upsell" ? {
    ...S,
    onClick: () => m(S)
  } : S);
  return z(Jt, {
    ...
    }), y?.type === "upsell" && y.showConfirmation && x && f(Xn, {
      open: !0,
      onClose: k,
      success: x === "success",

...
import { g as $a, h as ja } from "./types-DsNlRwHY.js";
import { A as Om, e as Mm, F as zm, c as Im, d as Bm, b as Pm, a as Hm, f as Wm, o as qm, u as Gm } from "./types-DsNlRwHY.js";
import { createPortal as ls, unstable_batchedUpdates as en } from "react-dom";
import { C as Ua, M as Ni, D as Va, z as Qa, u as cs, j as Ka } from "./index-CUX7nORv.js";
import { l as jm, m as Um, n as Vm, s as Qm, F as Km, o as Xm, w as Ym, x as Jm, N as Zm, y as ep, p as tp, P as np, r as ip, R as rp, q as sp, _ as op, v as ap, t as lp } from "./index-CUX7nORv.js";
...
import './f0.css';const Xa = {
  ...
  md: 2,
  lg: 2
}, Ya = qe(function({ widgets: e, children: t }, i) {
  const r = W(null);
  Ha(i, () => r.current);
  ...
  return /* @__PURE__ */ l(Or, { layout: "home", children: /* @__PURE__ */ C("div", { ref: r, className: "@container", children: [
    /* @__PURE__ */ C("div", { className: "flex flex-col gap-6 px-5 pt-4 @md:pt-2 @5xl:hidden", children: [
      /* @__PURE__ */ l(Ua, { columns: Xa, showArrows: !1, children: s }),
  ...
  "section",
  {
    ...
    ...i,
    children: /* @__PURE__ */ l("div", { className: P(Ja({ variant: e })), children: n })
  }
) }));
...
function ol({
  ...
  Mr(() => {
    ...
    if (!Array.isArray(b))
      return;
    const _ = b.map((A) => A.id), k = r || [], F = k.map((A) => A.id), E = k.filter(
      (A) => !_.includes(A.id)
    );
    ...
    if (M.length > 0) {
      ...
      A.forEach((L) => {
        setTimeout(() => {
          p.current.delete(L), y.current.delete(L);
        }, ct);
      }), M.forEach((L) => {
...
const ll = Qe(null);
function cl() {
  const { _reactContentMap: n } = hs(), { getWidgetContainer: e } = al();
  return /* @__PURE__ */ l(we, { children: Array.from(n.value.entries()).map(([t, i]) => {
    const r = e(t);
    return r ? /* @__PURE__ */ l(ll.Provider, { value: { widget: { id: t } }, children: i && ls(i, r) }, t) : (console.error(`Widget container not found for widget ${t}`), null);
  }) });
}
...
class Bn {
  ...
  _init() {
    ...
    return e.classList.add("ui-resizable-handle"), e.classList.add(`${Bn.prefix}${this.dir}`), e.style.zIndex = "100", e.style.userSelect = "none", this.host.appendChild(this.el), this.el.addEventListener("mousedown", this._mouseDown), je && (this.el.addEventListener("touchstart", bn), this.el.addEventListener("pointerdown", wn)), this;
  }
  /** call this when resize handle needs to be removed and cleaned up */
  destroy() {
    return this.moving && this._mouseUp(this.mouseDownEvent), this.el.removeEventListener("mousedown", this._mouseDown), je && (this.el.removeEventListener("touchstart", bn), this.el.removeEventListener("pointerdown", wn)), this.host.removeChild(this.el), delete this.el, delete this.host, this;
  }
  /** @internal called on mouse down on us: capture move on the entire document (mouse might not stay on us) until we release the mouse */
  _mouseDown(e) {
    this.mouseDownEvent = e, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), je && (this.el.addEventListener("touchmove", yn), this.el.addEventListener("touchend", xn)), e.stopPropagation(), e.preventDefault();
  }
  /** @internal */
  _mouseMove(e) {
...
class Ht extends _i {
  ...
  enable() {
    this.disabled !== !1 && (super.enable(), this.dragEls.forEach((e) => {
      e.addEventListener("mousedown", this._mouseDown), je && (e.addEventListener("touchstart", bn), e.addEventListener("pointerdown", wn));
    }), this.el.classList.remove("ui-draggable-disabled"));
  }
  disable(e = !1) {
    this.disabled !== !0 && (super.disable(), this.dragEls.forEach((t) => {
      t.removeEventListener("mousedown", this._mouseDown), je && (t.removeEventListener("touchstart", bn), t.removeEventListener("pointerdown", wn));
  ...
  _mouseDown(e) {
    if (!Q.mouseHandled)
      return e.button !== 0 || !this.dragEls.find((t) => t === e.target) && e.target.closest(ul) || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e, delete this.dragging, delete Q.dragElement, delete Q.dropElement, document.addEventListener("mousemove", this._mouseMove, { capture: !0, passive: !0 }), document.addEventListener("mouseup", this._mouseUp, !0), je && (e.currentTarget.addEventListener("touchmove", yn), e.currentTarget.addEventListener("touchend", xn)), e.preventDefault(), document.activeElement && document.activeElement.blur(), Q.mouseHandled = !0), !0;
  }
  ...
  _mouseUp(e) {
    if (document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), je && e.currentTarget && (e.currentTarget.removeEventListener("touchmove", yn, !0), e.currentTarget.removeEventListener("touchend", xn, !0)), this.dragging) {
...
class Di {
  ...
  setupDroppable(e) {
    return this.ddDroppable ? this.ddDroppable.updateOption(e) : this.ddDroppable = new hl(this.el, e), this;
  }
  cleanDroppable() {
...
Note: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.`)), i;
  ...
  commit() {
    return dl(this, this.batchUpdate(!1), "commit", "batchUpdate", "5.2"), this;
  }
}
G.renderCB = (n, e) => {
...
const Ri = ({
  ...
  return /* @__PURE__ */ l(
    ol,
    {
      ...
      static: r,
      forcePositionSync: s,
      children: /* @__PURE__ */ l(gl, { children: /* @__PURE__ */ l(cl, {}) })
    }
  );
};
Ri.displayName = "F0GridStack";
const ml = (n, e, t) => /* @__PURE__ */ l("div", { children: n }), Pn = ({
  widgets: n = [],
  editMode: e = !1,
  onChange: t = () => {
  },
  ...
  const o = I(
    ...
    u(n, e)
  ), f = W(e), g = W(n), p = W(!1), v = W(/* @__PURE__ */ new Map()), m = W(n);
  m.current = n;
  const y = W(s), w = B(() => {
...
const pl = (n, e) => {
  ...
  ({
    ...
    const h = r ?? bl[e ?? "body"], f = d ? /* @__PURE__ */ l("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (s !== void 0) {
      ...
      return f ? Zt(
        ...
        Yi,
        {
          ...
          noTooltip: o,
          tag: h,
          className: P(kt({ variant: e, align: t }), i),
          markdown: a,
          ...u,
          children: n
        }
...
}, yl = () => /* @__PURE__ */ C("div", { className: "relative flex h-full w-full cursor-progress flex-col rounded-xl border border-solid border-f1-border-secondary bg-f1-background", children: [
...
const Cl = vl("Dashboard", vs), $h = se(
...
}), El = (n) => (n || []).map((e) => e.items).reduce((e, t) => (e.length > 0 && e.push({ type: "separator" }), e.push(...t), e), []), Nl = (n) => {
  ...
  ({
    ...
    return /* @__PURE__ */ C(
      ...
      {
        ref: c,
        className: P(Sl({ variant: e }), "relative", t),
        draggable: i,
        onDragStart: r,
        onDragEnd: s,
        onDrop: o,
...
const _l = ({
  ...
  "BlockContent",
  _l
), Rl = (n) => !ss(n) || !n.type || typeof n.type == "string" || typeof n.type == "symbol" ? !1 : "__isPageLayoutBlock" in n.type, kl = (n) => !ss(n) || !n.type || typeof n.type == "string" || typeof n.type == "symbol" ? !1 : "__isPageLayoutGroup" in n.type, bs = (n, e, t) => {
  const i = pn.toArray(e);
  for (const r of i)
    t.includes("block") && Rl(r) || t.includes("group") && kl(r) || console.warn(
  ...
  ({ children: n, onSort: e, ...t }, i) => {
    ...
    return V(() => {
      ...
      e?.(r);
    }, [r, e]), /* @__PURE__ */ l("div", { ref: i, ...t, children: r.map((o, a) => /* @__PURE__ */ l(Wa, { children: o }, a)) });
  }
);
...
function Gl(n) {
  let {
    ...
    screenReaderInstructions: r = Wl
  } = n;
  const {
    announce: s,
    announcement: o
  } = Bl(), a = Kt("DndLiveRegion"), [d, u] = j(!1);
  if (V(() => {
    u(!0);
  }, []), Pl(B(() => ({
    onDragStart(h) {
    ...
    return null;
  const c = ae.createElement(ae.Fragment, null, ae.createElement(zl, {
    id: i,
    value: r.draggable
  }), ae.createElement(Il, {
    id: a,
...
const Kl = (n) => {
  ...
  for (const o of i) {
    ...
    if (d) {
      const u = sr(d), c = r.reduce((f, g, p) => f + jl(u[p], g), 0), h = Number((c / 4).toFixed(4));
      s.push({
        id: a,
        data: {
...
function $n(n, e) {
  ...
  function i(r) {
    ...
    return r !== n && sc(r, s) && t.push(r), rc(r, s) ? t : i(r.parentNode);
  }
  return n ? i(n) : t;
}
function Ns(n) {
...
const uc = [["x", ["left", "right"], cc], ["y", ["top", "bottom"], dc]];
class Li {
  constructor(e, t) {
...
class Mi {
  constructor(e, t, i) {
    var r;
    i === void 0 && (i = hc(e.event.target)), this.props = void 0, this.events = void 0, this.autoScrollEnabled = !0, this.document = void 0, this.activated = !1, this.initialCoordinates = void 0, this.timeoutId = null, this.listeners = void 0, this.documentListeners = void 0, this.windowListeners = void 0, this.props = e, this.events = t;
    const {
      event: s
    } = e, {
      target: o
    } = s;
    this.props = e, this.events = t, this.document = Ct(o), this.documentListeners = new Mt(this.document), this.listeners = new Mt(i), this.windowListeners = new Mt(Ne(o)), this.initialCoordinates = (r = En(s)) != null ? r : Ve, this.handleStart = this.handleStart.bind(this), this.handleMove = this.handleMove.bind(this), this.handleEnd = this.handleEnd.bind(this), this.handleCancel = this.handleCancel.bind(this), this.handleKeydown = this.handleKeydown.bind(this), this.removeTextSelection = this.removeTextSelection.bind(this), this.attach();
  }
  attach() {
    const {
      events: e,
  ...
  handleStart() {
    ...
    e && (this.activated = !0, this.documentListeners.add(He.Click, fc, {
      capture: !0
  ...
  handleMove(e) {
    ...
    if (!r)
      return;
    const d = (t = En(e)) != null ? t : Ve, u = Gt(r, d);
    if (!i && a) {
      if (lr(a)) {
...
function yc(n) {
  ...
  const g = wc({
    ...
    x.scrollBy(b, _);
  }, []), R = B(() => a === _n.TreeOrder ? [...u].reverse() : u, [a, u]);
  V(
    () => {
      if (!s || !u.length || !w) {
        v();
...
function Ec(n, e) {
  ...
  const [s, o] = j(null), {
    ...
    measure: d,
    strategy: u
  } = r, c = W(n), h = m(), f = qt(h), g = I(function(y) {
...
const hr = [];
function kc(n) {
  const e = W(n), t = Qt((i) => n ? i && i !== hr && n && e.current && n.parentNode === e.current.parentNode ? i : $n(n) : hr, [n]);
  return V(() => {
    e.current = n;
  }, [n]), t;
}
...
const Ic = {
  ...
  over: null,
  measureDroppableContainers: Nn
}, Xt = /* @__PURE__ */ Qe(Ms), zs = /* @__PURE__ */ Qe(Ic);
function Bc() {
  return {
    draggable: {
      active: null,
...
const Gc = /* @__PURE__ */ os(function(e) {
  var t, i, r, s;
  let {
    id: o,
    accessibility: a,
    ...
    children: u,
    sensors: c = Mc,
    collisionDetection: h = Yl,
    measuring: f,
    modifiers: g,
    ...p
  } = e;
  const v = qa(Pc, void 0, Bc), [m, y] = v, [w, S] = Hl(), [T, R] = j(dt.Uninitialized), x = T === dt.Initialized, {
    draggable: {
      active: b,
      nodes: _,
      translate: k
    ...
    return b != null ? {
      ...
      data: (xe = E?.data) != null ? xe : zc,
      rect: M
    } : null;
  }, [b, E]), A = W(null), [L, O] = j(null), [z, K] = j(null), $ = qt(p, Object.values(p)), ee = Kt("DndDescribedBy", o), re = B(() => F.getEnabled(), [F]), te = Wc(f), {
    droppableRects: q,
    ...
    config: te.droppable
  }), le = Cc(_, b), Y = B(() => z ? En(z) : null, [z]), Z = Mo(), ie = Nc(le, te.draggable.measure);
  qc({
  ...
  const H = ur(le, te.draggable.measure, ie), X = ur(le ? le.parentElement : null), U = W({
  ...
  }), ge = F.getNodeFor((t = U.current.over) == null ? void 0 : t.id), be = Oc({
    measure: te.dragOverlay.measure
  }), Me = (i = be.nodeRef.current) != null ? i : le, ze = x ? (r = be.rect) != null ? r : H : null, rt = !!(be.nodeRef.current && be.rect), Ke = Rc(rt ? null : H), me = Ls(Me ? Ne(Me) : null), Ie = kc(x ? ge ?? le : null), Xe = Lc(Ie), Be = Is(g, {
    transform: {
      x: k.x - Ke.x,
      y: k.y - Ke.y,
      scaleX: 1,
    ...
    windowRect: me
  }), Ge = Y ? bt(Y, k) : null, et = Tc(Ie), Vn = fr(et), Yt = fr(et, [H]), tt = bt(Be, Vn), mt = ze ? ec(ze, Be) : null, Nt = D && mt ? h({
    active: D,
    collisionRect: mt,
    droppableRects: q,
    droppableContainers: re,
    pointerCoordinates: Ge
  }) : null, Vi = Cs(Nt, "id"), [st, Qi] = j(null), To = rt ? Be : bt(Be, Yt), Fo = Jl(To, (s = st?.rect) != null ? s : null, H), Qn = W(null), Ki = I(
    (xe, ke) => {
      let {
        sensor: Te,
        options: ot
  ...
  }, [D, le, Nt, mt, _, Me, ze, q, F, st, Ie, tt]), yc({
    ...Z,
    delta: k,
    draggingRect: mt,
    pointerCoordinates: Ge,
  ...
  const Lo = B(() => ({
    ...
    measuringScheduled: fe,
    windowRect: me
  }), [D, le, H, z, Nt, X, be, _, F, q, st, ne, Ie, Xe, te, fe, me]), Oo = B(() => ({
    activatorEvent: z,
    activators: Xi,
    active: D,
    activeNodeRect: H,
...
}), $c = /* @__PURE__ */ Qe(null), mr = "button", jc = "Draggable";
function Uc(n) {
  let {
    id: e,
    data: t,
  ...
  const s = Kt(jc), {
    ...
    tabIndex: v = 0
  } = r ?? {}, m = d?.id === e, y = Re(m ? Un : $c), [w, S] = Cn(), [T, R] = Cn(), x = Ac(o, e), b = qt(t);
  Ue(
    () => (h.set(e, {
      id: e,
      key: s,
...
function Xc(n) {
  ...
  }, [e, i, s]), ae.createElement(ae.Fragment, null, t, i ? Ga(i, {
    ref: o
  }) : null);
}
const Yc = {
...
const Zc = {
  position: "fixed",
  touchAction: "none"
}, ed = (n) => Gn(n) ? "transform 250ms ease" : void 0, td = /* @__PURE__ */ qe((n, e) => {
  let {
    as: t,
    activatorEvent: i,
    adjustScale: r,
  ...
  const h = r ? u : {
    ...
    transformOrigin: r && i ? Ul(i, a) : void 0,
...
function sd(n) {
  ...
  return qn((s, o) => {
    ...
    if (!h)
      return;
    const f = typeof e == "function" ? e : od(e);
...
const ld = /* @__PURE__ */ ae.memo((n) => {
  ...
  return ae.createElement(Jc, null, ae.createElement(Xc, {
    animation: F
  }, h && b ? ae.createElement(td, {
    key: b,
    id: h.id,
    ref: E,
    as: a,
...
function hd(n) {
  ...
  } = Bs(), h = Kt(Hs, t), f = a.rect !== null, g = B(() => i.map((x) => typeof x == "object" && "id" in x ? x.id : x), [i]), p = o != null, v = o ? g.indexOf(o.id) : -1, m = u ? g.indexOf(u.id) : -1, y = W(g), w = !dd(g, y.current), S = m !== -1 && v === -1 || w, T = ud(s);
  Ue(() => {
    w && p && c(g);
  }, [w, g, p, c]), V(() => {
    y.current = g;
...
const fd = (n) => {
  ...
  duration: 200,
  easing: "ease"
}, qs = "transform", pd = /* @__PURE__ */ ut.Transition.toString({
  property: qs,
  duration: 0,
  easing: "linear"
}), vd = {
...
function yd(n) {
  ...
  const {
    ...
    useDragOverlay: y,
    strategy: w
  } = Re(Ws), S = xd(i, g), T = c.indexOf(o), R = B(() => ({
    sortable: {
      containerId: h,
      index: T,
      items: c
  ...
  }), re = Tl(F, L), te = !!E, q = te && !p && nn(f) && nn(m), ne = !y && z, fe = ne && q ? ee : null, Y = q ? fe ?? (a ?? w)({
    rects: v,
    activeNodeRect: D,
    activeIndex: f,
    overIndex: m,
...
const wd = [J.Down, J.Right, J.Up, J.Left], Cd = (n, e) => {
  let {
    context: {
      active: t,
      collisionRect: i,
  ...
  if (wd.includes(n.code)) {
    ...
    if (c === o?.id && u.length > 1 && (c = u[1].id), c != null) {
      ...
      if (p && g && h && f) {
        const m = $n(p).some((x, b) => a[b] !== x), y = Gs(h, f), w = Sd(h, f), S = m || !y ? {
          x: 0,
          y: 0
        } : {
...
const vr = ({ id: n, children: e }) => {
  const { attributes: t, listeners: i, setNodeRef: r, transform: s, transition: o } = yd({ id: n }), a = {
  ...
  return /* @__PURE__ */ l("div", { className: P("flex flex-wrap items-stretch gap-4", i && "flex-1"), children: /* @__PURE__ */ C(
    Gc,
    {
      ...
      onDragEnd: c,
      children: [
        /* @__PURE__ */ l(hd, { items: r, children: r.map((h) => /* @__PURE__ */ l(vr, { id: h.id, children: h.render }, h.id)) }),
        /* @__PURE__ */ l(ld, { children: o ? /* @__PURE__ */ l(vr, { id: o, children: r.find((h) => h.id === o)?.render }) : null })
      ]
    }
  ) });
};
...
const Ed = qe(function({ children: e, aside: t, header: i, variant: r = "main-aside" }, s) {
...
const Kh = [
  ...
  }), r = _d(e.trend), s = t(e.comparison), o = qo(
    i.numericValue,
    i.formatterOptions
...
}, Dd = () => /* @__PURE__ */ C("div", { className: "relative flex h-full w-full cursor-progress flex-col gap-2", children: [
...
const Rd = zr($s, Dd), Xh = se(Rd), Yh = $o.filter(
  (n) => n !== "ai"
), Jh = Br, Zh = ["default", "outline", "neutral"], ef = Br, tf = ["split", "dropdown"], nf = jo, js = {
  background: {
...
const $d = ht({
  ...
  ({
    ...
    const Be = L && L !== "none" || O && O !== "none" || z && z !== "none" || K && K !== "none", Ge = A && A !== "none" || Be, et = { sm: ze, md: rt, lg: Ke, xl: me }, Vn = jd.map((Yt) => {
      const tt = et[Yt];
      return tt ? Gd(Yt, tt) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ l(
...
const no = kn(
  ...
  to
), rf = ["sm", "md", "lg"], sf = ["compact", "expanded"], di = ({ count: n, list: e }) => {
...
function ro({
  ...
  const v = (w, S) => {
    ...
    t(g);
  }, y = B(() => i || Object.entries(n).reduce((S, [T, R]) => {
    const x = Zi(R.type);
    return Math.max(S, x?.formHeight || Ud);
  }, 0), [n, i]);
...
function Jd() {
  const { steps: n, currentStep: e, goToStep: t, allowStepSkipping: i } = Vd();
  return /* @__PURE__ */ l("nav", { "aria-label": "Wizard steps", className: "flex flex-col gap-1.5 p-1", children: n.map((r, s) => {
    const o = s < e || r.isCompleted?.() === !0, a = Xd(s, e, o), d = n[e]?.hasErrors?.() === !0, u = s > e && n.slice(e, s).some((g) => g.hasErrors?.() === !0);
    ...
    return c && !i && s > e + 1 && (c = !1), /* @__PURE__ */ C(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ l(Yd, { state: a, index: s }),
          /* @__PURE__ */ l("span", { className: Kd({ state: a }), children: r.title })
        ]
      },
      s
    );
...
const eu = () => {
  ...
  const v = B(() => {
    ...
    onClose: i
  }), y = oe(), w = n[m.currentStep], S = m.currentStep === 0, T = m.currentStep === n.length - 1, R = T ? w?.nextLabel ?? u ?? y.wizard.submit : w?.nextLabel ?? a ?? y.wizard.next, x = w?.previousLabel ?? d ?? y.wizard.previous, b = B(
    () => ({
      label: R,
      icon: T ? void 0 : si,
      onClick: () => {
      ...
      children: /* @__PURE__ */ l(
        Qd,
        {
          ...
          children: /* @__PURE__ */ C("div", { className: "flex h-[58vh] flex-1 flex-row", children: [
            /* @__PURE__ */ l("div", { className: "w-1/3 shrink-0 overflow-y-auto border-x-0 border-b-0 border-r border-t-0 border-dashed border-f1-border-secondary p-2", children: /* @__PURE__ */ l(Jd, {}) }),
...
function iu({
  ...
  } = n, x = T?.label, b = B(() => Object.keys(m), [m]), _ = e ?? n.steps, k = B(() => _ ? _.some(
  ...
  const O = I(
    ...
    (H) => Tt(H, b, k).some((U) => L.current[U] === !0),
    [b, k]
  ), $ = B(
    () => k ?? b.map((H) => ({
      title: y?.[H]?.title ?? H,
...
const hf = se(uo), ho = qe((n, e) => /* @__PURE__ */ l(ki, { ref: e, variant: "heading", ...n }));
...
const ff = se(ho), ou = ({
  ...
  return /* @__PURE__ */ C(Wi, { status: e, isLast: t, hideStatus: i, children: [
    /* @__PURE__ */ l("div", { className: "flex min-h-8 items-center gap-3", children: /* @__PURE__ */ l(au, { props: n, contentId: c }) }),
    o && h && /* @__PURE__ */ l("div", { className: "pl-9", children: /* @__PURE__ */ l(Ni, { items: o }) }),
    r && /* @__PURE__ */ l("div", { id: c, role: "region", className: "flex flex-col gap-0 pl-4", children: s.map((g, p) => /* @__PURE__ */ l(du, { props: g }, `${g.title}-${p}`)) }),
  ...
  return /* @__PURE__ */ C(Wi, { status: e, isLast: t, hideStatus: i, children: [
    ...
    e !== "completed" && /* @__PURE__ */ l(uu, { props: n })
  ] });
}, fu = (n) => "items" in n && "icon" in n && n.icon !== void 0, gu = ({
  props: n
}) => {
  const { status: e, isLast: t = !1, hideStatus: i = !1, expanded: r, items: s } = n;
  return /* @__PURE__ */ C(Wi, { status: e, isLast: t, hideStatus: i, children: [
    /* @__PURE__ */ l("div", { className: "flex min-h-8 items-center gap-2", children: /* @__PURE__ */ l(ou, { props: n }) }),
...
}, mu = (n) => "items" in n && "icon" in n && n.icon !== void 0, pu = (n) => "items" in n && !("icon" in n && n.icon !== void 0), vu = (n) => mu(n) ? /* @__PURE__ */ l(go, { props: n }) : pu(n) ? /* @__PURE__ */ l(gu, { props: n }) : /* @__PURE__ */ l(mo, { props: n }), gf = [
  "completed",
  "in-progress",
  "not-started"
], mf = se(
...
function vo({
  ...
  const [f, g] = j(!1), p = W(!1), v = W(null), { deferClose: m } = wu(v, () => g(!1)), y = (S) => {
      ...
      h.length > 0 && /* @__PURE__ */ C(we, { children: [
        ...
        h.map((f) => {
          ...
          return /* @__PURE__ */ C(Ft, { children: [
            /* @__PURE__ */ l(At, { className: "mx-1 px-2 data-[state=open]:rounded-sm data-[state=closed]:bg-transparent data-[state=open]:bg-f1-background-hover", children: /* @__PURE__ */ C("div", { className: "flex w-full flex-row items-center gap-2", children: [
              g && /* @__PURE__ */ l(he, { icon: g.icon, color: "default" }),
              /* @__PURE__ */ l("span", { className: "flex-1 text-base font-medium", children: g?.label ?? f })
            ] }) }),
            /* @__PURE__ */ l(Lt, { children: /* @__PURE__ */ C(Ot, { children: [
...
function Co() {
  ...
  return { getActionsForQuestion: I(
    (a, d, u) => {
      const c = e(a), h = c && "datasetKey" in c && typeof c.datasetKey == "string" ? c.datasetKey : void 0, f = Lu(d, c);
      return {
        question: c,
        questionTypes: s,
        currentRatingType: f,
    ...
    /* @__PURE__ */ l(Lt, { children: /* @__PURE__ */ C(Ot, { children: [
      u.map((f) => {
        ...
        return g ? /* @__PURE__ */ C(Ft, { children: [
          /* @__PURE__ */ l(At, { className: "mx-1 mt-1 px-2 data-[state=open]:rounded-sm data-[state=closed]:bg-transparent data-[state=open]:bg-f1-background-hover", children: /* @__PURE__ */ C("div", { className: "flex w-full flex-row items-center gap-2 text-base font-medium", children: [
...
}, Qu = (n) => /* @__PURE__ */ l(Vu, { ...n, type: "rating" });
function Ku({
  checked: n,
  disabled: e
}) {
...
const Xu = {
  ...
  } = ue(), o = new Set(n.map((m) => m.value)).size !== n.length, a = s(e.id), d = e.locked || a?.locked, { t: u } = oe(), c = B(
    () => ({
      id: e.id,
      type: e.type,
      options: n
  ...
  const { onQuestionChange: t, answering: i } = ue(), r = gt(e), { t: s } = oe(), o = s("surveyFormBuilder.answer.textPlaceholder"), a = B(
    () => e.type === "text" ? {
      id: e.id,
      type: "text",
  ...
  switch (n.type) {
    ...
    case "dropdown-single":
    case "dropdown-multi":
      return /* @__PURE__ */ l(Wu, { ...n });
    case "numeric":
      return /* @__PURE__ */ l(ju, { ...n });
    case "link":
      return /* @__PURE__ */ l($u, { ...n });
    case "date":
      return /* @__PURE__ */ l(Hu, { ...n });
    case "file":
      return /* @__PURE__ */ l(Gu, { ...n });
    case "checkbox":
      return /* @__PURE__ */ l(Pu, { ...n });
    default:
        ...
        !s && /* @__PURE__ */ C(we, { children: [
          /* @__PURE__ */ l(Gi, { children: /* @__PURE__ */ l(
            Si,
            {
              ...
              onReorder: y,
              as: "div",
              children: /* @__PURE__ */ l("div", { className: "group/section-list flex flex-col gap-4", children: i.map((b) => /* @__PURE__ */ l(th, { question: b }, b.id)) })
            }
          ) }),
        ...
        /* @__PURE__ */ C(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ l(ih, { ...n.section, hideQuestions: !0 })
            ]
          }
        ),
...
const No = ({
  ...
  const { t: i } = oe(), { disabled: r } = ue(), { portalContainer: s } = Re(Ca), o = oh(n, {
...
const fh = ({
  ...
  return /* @__PURE__ */ C(
    qi,
    {
      ...
      datasets: a,
      children: [
        /* @__PURE__ */ l(Gi, { children: /* @__PURE__ */ C(hh, { children: [
...
const ln = /* @__PURE__ */ l(de, { className: "h-10 w-full rounded-sm" }), _r = /* @__PURE__ */ l(de, { className: "h-24 w-full rounded-sm" }), gh = /* @__PURE__ */ l(de, { className: "h-10 w-56 max-w-full rounded-sm" });
function mh() {
...
const wh = /^(https?:\/\/)?[\w.-]+\.[a-z]{2,}(:\d+)?(\/[^\s]*)?$/i, Ch = () => ({
  upload: async (n) => ({
    type: "success",
    value: `local-${n.name}-${Date.now()}`
  }),
...
function xf(n) {
  return n.inline ? /* @__PURE__ */ l(Rh, { ...n }) : /* @__PURE__ */ l(Dh, { ...n });
}
function Dh({
  elements: n,
  onSubmit: e,
  ...
  const { t: w } = oe(), S = d === "fullscreen", T = d === "fullscreen" ? "center" : d, [R, x] = j(S), { formRef: b, submit: _, isSubmitting: k, hasErrors: F } = pi(), E = W({}), M = B(
    () => Ui(n),
    [n]
  ), D = bh(M), A = M.length > 0, L = {
  ...
  ] : void 0, U = A ? g || K ? void 0 : $ ? O && !D.isLastStep ? {
    ...
    disabled: k || F,
    loading: k
  } : void 0, ge = A ? g || K ? void 0 : O && !D.isFirstStep ? {
    label: w("surveyAnsweringForm.actions.previous"),
    onClick: H,
    icon: qr
  } : void 0 : void 0, be = t === "all-questions" && A && !g, Me = O && A && !g, ze = O && !!D.currentQuestion?.sectionTitle && !g, rt = !A && !g || O, Ke = ne === "center" || ne === "fullscreen";
  return /* @__PURE__ */ l(
    ka,
    {
      isOpen: o,
                ...
                /* @__PURE__ */ C(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      g ? t === "stepped" ? /* @__PURE__ */ l(vh, {}) : /* @__PURE__ */ l(_o, {}) : A ? null : /* @__PURE__ */ l(
                        no,
                        {
                          display: "flex",
                          flexDirection: "column",
...
const kh = ({ benefits: n }) => /* @__PURE__ */ l("div", { className: "flex flex-col gap-2", children: n.map((e, t) => /* @__PURE__ */ l(Th, { text: e }, t)) }), Th = ({ text: n }) => /* @__PURE__ */ C("div", { className: "flex flex-row items-start gap-2", children: [
...
const Sf = se(zh), Ef = Oe(
  "F0AnalyticsDashboard",
  Pa
), Lr = (n) => `datacollection-${n}`, Nf = {
...
export {
  ...
  Rf as Await,
  Um as BarChart,
  kf as BarChartSkeleton,
  Tf as CardSelectableContainer,
  Vm as CategoryBarChart,
  Ff as ChatSpinner,
  un as Chip,
  Qm as ComboChart,
  $h as Dashboard,
  ...
  If as F0AiChatTextArea,
  Bf as F0AiFormRegistryProvider,
  Pf as F0AiFullscreenChat,
  Mm as F0AiInsightCard,
  zm as F0AiMask,
  Hf as F0Alert,
  Ef as F0AnalyticsDashboard,
  Im as F0AuraVoiceAnimation,
  Wf as F0Avatar,
  qf as F0AvatarAlert,
  Gf as F0AvatarCompany,
  Km as F0AvatarDate,
  $f as F0AvatarEmoji,
  jf as F0AvatarFile,
  Uf as F0AvatarIcon,
  ...
  Qf as F0AvatarPerson,
  Kf as F0AvatarTeam,
  Xh as F0BigNumber,
  no as F0Box,
  Ce as F0Button,
  Xf as F0ButtonDropdown,
  Yf as F0ButtonToggle,
  Jf as F0Card,
  mn as F0Checkbox,
  of as F0ChipList,
  Zf as F0DataChart,
  ...
  tg as F0DialogProvider,
  ng as F0DurationInput,
  ig as F0EventCatcherProvider,
  cf as F0FilterPickerContent,
  uf as F0Form,
  Ee as F0FormField,
  vf as F0GridStack,
  Bm as F0HILActionConfirmation,
  ff as F0Heading,
  he as F0Icon,
  rg as F0Link,
  fa as F0OneIcon,
  ...
  gg as FILE_TYPES,
  mg as FileItem,
  pg as FormCardValueFormatterProvider,
  vg as FunnelChartSkeleton,
  bg as GROUP_ID_SYMBOL,
  yg as GaugeChartSkeleton,
  xg as HeatmapChartSkeleton,
  Qh as HomeLayout,
  jh as Layout,
  Xm as LineChart,
  wg as LineChartSkeleton,
  Ym as NotesTextEditor,
  Jm as NotesTextEditorPatchTargetNotFoundError,
  Zm as NotesTextEditorSkeleton,
  ep as NotesTextEditorUnsupportedPatchTypeError,
  Cg as OneCalendar,
  Sg as OneCalendarInternal,
  Yi as OneEllipsis,
  ts as OneEmptyState,
  Eg as OneFilterPicker,
  tp as PieChart,
  Ng as PieChartSkeleton,
  _g as PrivacyModeProvider,
  Fh as ProductBlankslate,
  np as ProductCard,
  wf as ProductModal,
  Mh as ProductWidget,
  ip as ProgressBarChart,
  rp as RadarChart,
  Dg as RadarChartSkeleton,
  Rg as RichTextDisplay,
  kg as RichTextEditor,
  Uh as StandardLayout,
  _o as SurveyAllQuestionsLoadingSkeleton,
  xf as SurveyAnsweringForm,
  yf as SurveyFormBuilder,
  vh as SurveySteppedLoadingSkeleton,
  pf as Tag,
  Tg as TagCounter,
  Vh as TwoColumnLayout,
  is as UpsellRequestResponseDialog,
  Cf as UpsellingBanner,
  rs as UpsellingButton,
  Sf as UpsellingPopover,
  sp as VerticalBarChart,
  Fg as WeekStartDay,
  op as _RadarChart,
  Ag as actionBarStatuses,
  Pm as actionItemStatuses,
  Hm as aiTranslations,
  lf as alertVariantOptions,
  Gh as avatarVariants,
  Lg as buildTranslations,
  tf as buttonDropdownModes,
  ef as buttonDropdownSizes,
  Zh as buttonDropdownVariants,
  Jh as buttonSizes,
  rf as buttonToggleSizes,
  sf as buttonToggleVariants,
  Yh as buttonVariants,
  Og as cardImageAspectRatios,
  Mg as cardImageFits,
  zg as cardImageSizes,
  Ig as chartColorTokens,
  Bg as chipVariants,
  dh as computeSectionEndIds,
  Wm as contentTypes,
  Pg as createAtlaskitDriver,
  Hg as createDataSourceDefinition,
  pl as createPageLayoutBlock,
  vl as createPageLayoutBlockGroup,
  Nf as dataCollectionLocalStorageHandler,
  af as datepickerSizes,
  dp as defaultTranslations,
  Wg as defineAvailableForm,
  df as describeFormSchema,
  qg as durationInputSizes,
  Gg as durationUnits,
  $g as evaluateRenderIf,
  Oe as experimental,
  Ae as f0FormField,
  jg as fieldsToSeconds,
  lh as flattenElements,
  Ug as generateAnchorId,
  Vg as getAnimationVariants,
  Qg as getCanvasEntity,
  Kg as getDataSourcePaginationType,
  Xg as getEmojiLabel,
  Fn as getF0Config,
  Yg as getGranularityDefinition,
  Jg as getGranularityDefinitions,
  Zg as getGranularitySimpleDefinition,
  em as getSchemaDefinition,
  tm as granularityDefinitions,
  nm as hasF0Config,
  Xo as inferFieldType,
  ch as injectSectionEnds,
  im as isInfiniteScrollPagination,
  rm as isPageBasedPagination,
  sm as isZodType,
  nf as linkVariants,
  om as modules,
  qm as oneIconSizes,
  ap as predefinedPresets,
  am as rangeSeparator,
  Nr as reconstructElements,
  lm as secondsToFields,
  cm as secondsToVisibleFields,
  lp as selectSizes,
  Kh as tagDotColors,
  gf as timelineRowStatuses,
  dm as unwrapZodSchema,
  um as useAiChat,
  Gm as useAiChatTranslations,
  hm as useData,
  fm as useDataSource,
  gm as useDefaultCopilotActions,
  mm as useDndEvents,
  pm as useDraggable,
  vm as useDroppableList,
  bm as useEmojiConfetti,
  ym as useF0AiFormRegistry,
  xm as useF0Dialog,
  pi as useF0Form,
  wm as useF0FormDefinition,
  Cm as useFormCardValueFormatter,
  Sm as useFormComponent,
  Em as useGroups,
  Nm as useMessageSourcesAction,
  _m as useOrchestratorThinkingAction,
  Dm as usePrivacyMode,
  Rm as useReducedMotion,
  km as useSchemaDefinition,
  Tm as useSelectable,
  Fm as useSetFormCardValueFormatter,
  Am as useXRay,

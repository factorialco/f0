...
import { cr as Fr, cs as Nr, Z as rt, ct as Vr, cu as Sr, cv as Hr, cw as Tr, cx as Ar, cy as ot, cz as $r, cA as Br, a6 as ie, cB as Ir, aN as Pr, cC as jr, cD as Dr, cE as Zr, ak as _r, cF as Ur, bV as Or, aa as nt, ad as zr, cG as Gr, bd as ae, a1 as st, S as G1, cH as it, bi as Wr, cI as qr, cJ as Xr, b6 as Yr, bU as Kr, $ as F1, ay as Qr, bm as at, cK as Jr, bS as eo, cL as M1, bO as to, cM as ro, cN as oo, b5 as ct, cO as no, cP as so, cQ as io, cR as ao, cS as co, cT as lt, bG as lo, bH as fo, cU as uo, cV as ho, cW as Co, cX as go, cY as po, cZ as mo, c_ as vo, c$ as wo, d0 as xo, d1 as ko, d2 as Lo, d3 as bo, d4 as yo, d5 as Mo, bT as Eo, ab as Ro, bC as Fo, d6 as No, d7 as Vo, d8 as So, d9 as Ho, da as To, db as Ao, dc as $o, at as Bo, dd as dt, M as Io, a0 as Po, de as ft, df as ut, dg as jo, bl as Do, bk as Zo, dh as _o, di as Uo, dj as ht, dk as Oo, b4 as zo, aC as Go, dl as Wo, aw as qo, bb as Xo, dm as Ct, ba as Yo, dn as Ko, bn as ce, dp as Qo, dq as Jo, dr as le, bQ as en, bP as tn, bR as gt, ds as rn, G as on, E as nn, dt as sn, du as an, dv as cn, dw as ln, dx as dn, dy as pt, dz as fn, ac as un, dA as hn, L as l1, o as x, q as V1, bw as Cn, u as W, dB as gn, U as m1, co as mt, H as i1, v as d1, a2 as pn, Q as C1, dC as mn, ae as a1, aT as k1, A as E1, p as t1, aH as de, dD as vn, aI as fe, aJ as ue, b as b1, dE as wn, dF as xn, bK as kn, V as Ln, b3 as bn, a5 as he, dG as yn, dH as Mn, dI as En, dJ as ye, a3 as Rn, ao as vt, aW as wt, dK as Fn, c6 as Nn, dL as Vn, dM as Sn, a$ as xt, dN as Hn, c0 as Tn, dO as An, aY as $1, bc as kt, dP as Lt, be as bt, c as ne, dQ as yt, dR as $n, dS as Bn, b_ as In, br as Pn, dT as jn, bh as Ce, bD as Dn, dU as Zn, dV as _n, dW as Un, dX as On, dY as zn, a8 as Gn, af as Wn, y as qn, z as Xn, dZ as Mt, d_ as Et, d$ as Yn, an as Me, e0 as Kn, am as Qn, e1 as Jn, e2 as es, d as ts } from "./F0CanvasPanel-v-kZR0z6.js";
...
function rc({
  ...
  X(() => {
    ...
    return P.current = setTimeout(() => {
      n(F.query).then((O) => {
        A === T.current && (f(O), m(0), O.length === 0 && F.query.length > 0 && (N.current = F.atIndex, l(!1)));
      }).catch(() => {
        A === T.current && f([]);
      }).finally(() => {
        A === T.current && p(!1);
  ...
  const E = z(() => {
    ...
    (F) => {
      const A = M.current;
      if (A === -1) return;
      const O = `${F.firstName} ${F.lastName}`.trim(), U = String(F.id), G = e.slice(0, A), r1 = e.slice(o), o1 = `@${O} `, Y = G + o1 + r1, _ = G.length + o1.length;
    ...
    (F) => {
      ...
      for (const U of O) {
        const G = `@${U.name}`, r1 = `<entity-ref type="person" id="${Ee(U.id)}">${Ee(U.name)}</entity-ref>`;
        for (; A.includes(G); )
          A = A.replace(G, r1);
      }
      return A;
...
` || G === "	";
  ...
  const j = J(() => {
    ...
    const F = s.current;
    if (!F) return null;
    const A = ec(F, M.current), O = F.offsetLeft + A.left, G = (F.offsetParent ? F.offsetParent.offsetHeight : 0) - (F.offsetTop + A.top);
...
const oc = /[\\`*_{}[\]()#+\-.!|~>]/g, nc = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(oc, "\\$&")).join(""), A6 = ({
  ...
  const k = W(), H = k1(), [S, j] = $(""), [R, F] = $(0), [A, O] = $(!1), [U, G] = $(!1), [r1, o1] = $(null), Y = B(null), _ = B(null), D = B(null), e1 = l != null, { tracking: q } = b1(), g1 = z(
    (Q, x1) => {
...
const ar = z1(void 0), P6 = () => B1(ar), _c = (e) => /* @__PURE__ */ t(xt, { content: e, format: "markdown" }), Uc = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
...
const a4 = {
  ...
  const { modal: T, handleSubmit: N, handleClose: E } = Gc(
    f ?? a4
  ), k = W(), H = v ?? Uc, S = w ?? Jc, j = J(() => {
    const D = n ?? k.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((q) => typeof q == "string" && q.length > 0);
  }, [n, k.ai.defaultInitialMessage]), R = !r && e.length === 0 && j.length > 0, F = B(null), A = B(null), O = B(null), U = B(null), G = B(null), { showScrollBtn: r1, turnMinHeight: o1, scrollToBottom: Y } = i4({
    viewportRef: F,
    contentRef: A,
    endRef: O,
    lastTurnRef: G,
...
const h4 = ({
  ...
  const o = W(), n = k1(), {
    ...
    current: String(i + 1),
    total: String(l)
  }) : void 0, O = M.length > 0, U = (E ?? "").trim().length > 0, G = O || k && U || T === !0, r1 = r === !0 && F, o1 = () => {
    r1 || c();
  }, Y = () => {
    r1 || u();
  }, _ = (f1) => {
  ...
  }, D = F ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, e1 = T === !0 && !O && !(k && U), q = () => {
...
function Ae(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (q) => q / e * 2 - 1, g = (q) => q / r * 2 - 1, p = 0, C = e, m = 0, v = r, w = c, M = e - c, P = u, T = r - u, N = f(p), E = f(C), k = g(m), H = g(v), S = f(w), j = f(M), R = g(P), F = g(T), A = 0, O = 0, U = 1, G = 1, r1 = c / e, o1 = 1 - c / e, Y = u / r, _ = 1 - u / r, D = new Float32Array([
    // Top strip
    N,
    k,
    E,
...
}`, Pe = "iTime", je = "iTimeDelta", De = "iDate", Ze = "iFrame", _e = "iMouse", Ue = "iResolution", M4 = "iChannel", Oe = "iChannelResolution", ze = "iDeviceOrientation";
function E4(e, r) {
...
`,
  ...
  return X(() => {
    ...
    function y() {
      O();
      const b = m.current;
      b && C.current && (b.clearColor(...s), b.clearDepth(1), b.enable(b.DEPTH_TEST), b.depthFunc(b.LEQUAL), b.viewport(0, 0, C.current.width, C.current.height), C.current.height = C.current.clientHeight, C.current.width = C.current.clientWidth, q(), g1(), e1(p1(e || y4), r || Ie), U(), requestAnimationFrame(n1), c1(), _());
    }
...
function Z4(e, r) {
  const [o, n] = $(B4), {
    ...
    animate: i,
    motionValue: l
  } = U1(j4), { value: d, animate: c } = U1(I4), { value: u, animate: f } = U1(P4), { value: g, animate: p } = U1(D4), C = os(r, {
    fftSize: 512,
      ...
      t1.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ a("div", { className: "flex items-center gap-1", children: [
            ...
            o && /* @__PURE__ */ t("span", { className: x(O1()), children: o })
          ] }),
          n === "people" && /* @__PURE__ */ t(
            Pn,
            {

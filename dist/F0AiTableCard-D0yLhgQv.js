...
import { ce as Ye, cf as qe, cg as Ke, ch as Qe, ci as se, cj as Je, ck as er, cl as rr, cm as or, cn as tr, co as ie, cp as nr, cq as sr, cr as ir, cs as ar, ct as cr, cu as lr, cv as dr, cw as v1, cx as fr, cy as ur, cz as Cr, cA as hr, cB as gr, cC as vr, a4 as pr, cD as wr, cE as mr, cF as kr, cG as Lr, cH as xr, cI as Mr, cJ as br, cK as Er, ae as Vr, cL as Rr, aR as Fr, cM as yr, ao as Hr, bS as Sr, ai as ae, al as Ar, cN as Tr, ac as Br, a8 as $r, _ as ce, ab as Nr, bl as Pr, cO as jr, b7 as Zr, bR as Ir, a6 as _r, aC as Dr, bp as Ur, cP as Or, bP as Gr, cQ as g1, bL as zr, cR as Wr, cS as Xr, b6 as Yr, cT as qr, cU as Kr, cV as Qr, cW as Jr, b9 as le, bE as eo, bF as ro, cX as oo, cY as to, cZ as no, c_ as so, c$ as io, d0 as ao, d1 as co, d2 as lo, d3 as fo, d4 as uo, d5 as Co, d6 as ho, d7 as go, bQ as vo, aj as po, bB as wo, d8 as mo, d9 as ko, b8 as Lo, da as xo, db as Mo, dc as bo, dd as Eo, de as Vo, ax as Ro, df as Fo, W as yo, a7 as Ho, dg as So, dh as Ao, di as To, bo as Bo, bn as $o, dj as No, dk as Po, dl as jo, dm as Zo, b5 as Io, aG as _o, dn as Do, aA as Uo, dp as Oo, bk as Go, dq as zo, dr as Wo, ds as Xo, dt as Yo, bt as de, du as qo, bN as Ko, bM as Qo, bO as Jo, dv as et, O as rt, N as ot, dw as tt, dx as nt, dy as st, dz as it, dA as at, dB as ct, dC as lt, dD as dt, dE as ft, dF as ut, dG as Ct, ak as ht, dH as gt, V as vt, w as D, y as c1, bv as pt, u as m1, aY as fe, am as p1, Z as w1, d as wt, dI as mt, aW as H1, M as kt, x as u1, as as Lt, bg as xt, bb as Mt, ba as bt, bd as Et, be as Vt, dJ as Rt, dK as Ft, dL as yt, dM as Ht, G as b1, ag as St, an as At, $ as d1, br as Tt, dN as Bt, Q as E1, bs as $t, a_ as Nt, ad as Pt } from "./F0AiChat-EaDukg85.js";
import { useTrackVolume as jt } from "@livekit/components-react";
function Zt(r, e, t) {
  We(() => r.on(e, t), [r, e, t]);
}
function S1(r) {
...
function Xt(r, { defaultTransition: e = {}, ...t } = {}, n, s) {
  ...
  for (let h = 0; h < r.length; h++) {
    ...
    if (typeof M == "string") {
      ...
      x.set(M.name, N1(m, M.at, p, x));
      continue;
    }
    let [H, w, y = {}] = M;
    y.at !== void 0 && (m = N1(m, y.at, p, x));
    let A = 0;
    const N = (b, E, T, $ = 0, _ = 0) => {
      const F = Yt(b), { delay: k = 0, times: B = Je(F), type: I = "keyframes", repeat: G, repeatType: O, repeatDelay: Q = 0, ...W } = E;
      let { ease: j = e.ease || "easeOut", duration: S } = E;
      const P = typeof k == "function" ? k($, _) : k, q = F.length, K = or(I) ? I : s?.[I];
      if (q <= 2 && K) {
        let J = 100;
        if (q === 2 && Qt(F)) {
          const r1 = F[1] - F[0];
      ...
      if (t1 > 0 && rr(B, t1), F.length === 1 && F.unshift(null), G) {
        ...
        for (let r1 = 0; r1 < G; r1++) {
          ...
          for (let d = 0; d < J.length; d++)
            B.push(e1[d] + (r1 + 1)), j.push(d === 0 ? "linear" : Ce(n1, d - 1));
        }
        Ot(B, G);
      }
      const a1 = X + S;
      Ut(T, F, j, B, X, a1), A = Math.max(P + S, A), V = Math.max(a1, V);
    };
    if (se(H)) {
      const b = P1(H, v);
      N(w, y, j1("default", b));
  ...
  return v.forEach((h, M) => {
    for (const H in h) {
      ...
      for (let E = 0; E < w.length; E++) {
        ...
        y.push($), A.push(nr(0, V, T)), N.push(_ || "easeOut");
      }
      A[0] !== 0 && (A.unshift(0), y.unshift(y[0]), N.unshift(zt)), A[A.length - 1] !== 1 && (A.push(1), y.push(null)), l.has(M) || l.set(M, {
        keyframes: {},
        transition: {}
      });
      const b = l.get(M);
...
const I6 = (r, e) => /* @__PURE__ */ a(
...
), L4 = i(k4), x4 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: un,
  Add: hr,
  Ai: gr,
  ...
  Wifi: L4,
  Windows: gt
}, Symbol.toStringTag, { value: "Module" })), M4 = (r, e) => /* @__PURE__ */ o(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const _4 = c1({
  ...
  ({
    ...
    const T1 = q && q !== "none" || K && K !== "none" || X && X !== "none" || t1 && t1 !== "none", Ue = P && P !== "none" || T1, Oe = { sm: Pe, md: je, lg: Ze, xl: Ie }, Ge = D4.map((B1) => {
      const $1 = Oe[B1];
      return $1 ? I4(B1, $1) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ o(
...
function Z1(r, e, t, n) {
  const s = Math.max(1, Math.min(r, e)), c = Math.min(t, 20), v = Math.min(c + n, s), C = Math.min(v, Math.floor(r / 2)), x = Math.min(v, Math.floor(e / 2)), p = (X) => X / r * 2 - 1, m = (X) => X / e * 2 - 1, V = 0, h = r, M = 0, H = e, w = C, y = r - C, A = x, N = e - x, b = p(V), E = p(h), T = m(M), $ = m(H), _ = p(w), F = p(y), k = m(A), B = m(N), I = 0, G = 0, O = 1, Q = 1, W = C / r, j = 1 - C / r, S = x / e, P = 1 - x / e, q = new Float32Array([
    // Top strip
    b,
    T,
    E,
...
class e3 {
  ...
  setupGL() {
    ...
    const V = e.getUniformLocation(t, "uResolution"), h = e.getUniformLocation(t, "uTime"), M = e.getUniformLocation(t, "uBorderWidth"), H = e.getUniformLocation(t, "uGlowWidth"), w = e.getUniformLocation(t, "uBorderRadius"), y = e.getUniformLocation(t, "uColors"), A = e.getUniformLocation(t, "uGlowExponent"), N = e.getUniformLocation(t, "uGlowFactor");
    e.useProgram(t), e.uniform1f(M, this.options.borderWidth), e.uniform1f(H, this.options.glowWidth), e.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (e.uniform1f(A, 2), e.uniform1f(N, 1.8)) : (e.uniform1f(A, 1), e.uniform1f(N, 1));
    const b = (this.options.colors || X4).map(Y4);
...
const _1 = ["lowp", "mediump", "highp"], q4 = `
void main(void){
...
}`, U1 = "iTime", O1 = "iTimeDelta", G1 = "iDate", z1 = "iFrame", W1 = "iMouse", X1 = "iResolution", Q4 = "iChannel", Y1 = "iChannelResolution", q1 = "iDeviceOrientation";
function J4(r, e) {
...
}, M1 = 9729, K1 = 9728, n9 = 9987, Q1 = 33071, J1 = 10497;
class s9 {
  gl;
  url;
  wrapS;
  ...
  load = async (e) => {
    ...
    const m = 0, V = t.RGBA, h = 1, M = 1, H = 0, w = t.RGBA, y = t.UNSIGNED_BYTE, A = new Uint8Array([255, 255, 255, 0]), N = t.createTexture();
    if (t.bindTexture(t.TEXTURE_2D, N), t.texImage2D(
      t.TEXTURE_2D,
      m,
      V,
      h,
      ...
      return t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.LINEAR), this._webglTexture = N, this.source = $, this.isVideo = !0, $.play().then(() => this);
    }
    async function b() {
    ...
    return (e.wrapS !== Q1 || e.wrapT !== Q1 || e.minFilter !== K1 && e.minFilter !== M1) && !T && (E = this.makePowerOf2(E), T = !0), t.bindTexture(t.TEXTURE_2D, N), t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL, C), t.texImage2D(
      t.TEXTURE_2D,
      m,
      V,
      w,
...
}, re = (r, e, t) => r * (1 - t) + e * t, i9 = (r, e, t) => t > 0 ? r.substring(0, t) + e + r.substring(t, r.length) : e + r;
function a9({
  fs: r,
  vs: e = D1,
  textures: t = [],
  ...
  const h = Z(null), M = Z(null), H = Z(null), w = Z(null), y = Z(void 0), A = Z(void 0), N = Z(!1), b = Z(void 0), E = Z(0), T = Z([0, 0]), $ = Z([]), _ = Z(0), F = Z(void 0), k = Z({
      ...
      if (t && t.length > 0) {
        ...
        const u = t.map(
          (f, L) => (k.current[`${Q4}${L}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, I(f, L), $.current[L] = new s9(d), $.current[L]?.load(f).then((g) => {
            I(g, L);
          }))
        );
        Promise.all(u).then(() => {
...
`,
    ...
    return d.includes("mainImage") && (L = L.concat(q4)), L;
  }, J = (d) => {
    const u = M.current;
    ...
    const d = { passive: !0 };
    k.current.iMouse?.isNeeded && h.current && (h.current.addEventListener("mousemove", j, d), h.current.addEventListener("mouseout", S, d), h.current.addEventListener("mouseup", S, d), h.current.addEventListener("mousedown", W, d), h.current.addEventListener("touchmove", j, d), h.current.addEventListener("touchend", S, d), h.current.addEventListener("touchstart", W, d)), k.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      Q,
      d
    ), h.current && (F.current = new ResizeObserver(P), F.current.observe(h.current), window.addEventListener("resize", P, d));
  }, r1 = () => {
    const d = { passive: !0 };
    k.current.iMouse?.isNeeded && h.current && (h.current.removeEventListener("mousemove", j, d), h.current.removeEventListener("mouseout", S, d), h.current.removeEventListener("mouseup", S, d), h.current.removeEventListener("mousedown", W, d), h.current.removeEventListener("touchmove", j, d), h.current.removeEventListener("touchend", S, d), h.current.removeEventListener("touchstart", W, d)), k.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      Q,
      d
    ), F.current && (F.current.disconnect(), window.removeEventListener("resize", P, d));
  };
  return f1(() => {
    B.current = n;
  }, [n]), f1(() => {
    ...
    function u() {
      G();
      const f = M.current;
      f && h.current && (f.clearColor(...s), f.clearDepth(1), f.enable(f.DEPTH_TEST), f.depthFunc(f.LEQUAL), f.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, X(), t1(), K(a1(r || K4), e || D1), O(), requestAnimationFrame(e1), n1(), P());
    }
...
}`, l9 = 10, d9 = 2, f9 = 0.5, u9 = 0.2, C9 = 1.5, z = {
  duration: 0.5,
  ease: "easeOut"
}, oe = {
  duration: 0.35,
...
function h9(r, e) {
  const [t, n] = i1(l9), {
    ...
    animate: c,
    motionValue: l
  } = C1(u9), { value: v, animate: C } = C1(d9), { value: x, animate: p } = C1(f9), { value: m, animate: V } = C1(C9), h = jt(e, {
    fftSize: 512,
...
function r3({
  ...
  const { speed: x, scale: p, amplitude: m, frequency: V, brightness: h } = h9(e, s);
  return /* @__PURE__ */ o(
    Se,
    {
      ref: v,
...
const o3 = ({
  ...
  return /* @__PURE__ */ a(V1, { children: [
    r && /* @__PURE__ */ o("span", { className: D(w9(), "truncate"), children: r }),
    ...
    /* @__PURE__ */ a(
      u1.div,
      {
        ...
        children: [
          ...
          n === "balance" && /* @__PURE__ */ o(L9, { balance: r.balance })
        ]
      }
    ),
    t && !k9.has(n) && /* @__PURE__ */ o(
      u1.span,
      {
        className: D(h1()),
        animate: { opacity: s ? 0 : 1 },
...
const b9 = ({
  ...
  dataLength: n,
  color: s
}) => t !== n - 1 || r == null || e == null ? null : /* @__PURE__ */ o("circle", { cx: r, cy: e, r: 2, fill: s, stroke: "none" }), E9 = ({
  label: r,
  direction: e
}) => {
  const t = Te[e];
  ...
  const s = `sparkline-gradient-${ne().replace(/:/g, "")}`, c = M9(r, t), l = Te[c];
  return /* @__PURE__ */ o("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ o(E9, { label: e, direction: c })
      ]
    }
  ) });
}, Be = i(
...
const R9 = ["className"], $e = i((r, e) => {
  const t = R9.reduce((n, s) => {
    const { [s]: c, ...l } = n;
    return l;
  }, r);
...
const F9 = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], Ne = 180, y9 = (r) => Number.isFinite(r) ? Math.max(0, Math.floor(r)) : Ne, H9 = (r, e) => r.length <= e ? r : `${r.slice(0, e).trimEnd()}...`, S9 = (r) => r.showActions !== !1, A9 = (r) => Object.fromEntries(
...
function T9(r) {
  const {
    ...
    description: c,
    seeMoreLabel: l,
    maxCollapsedDescriptionLength: v = Ne
  } = r, [C, x] = i1(!1), p = ne(), m = Z(null), V = y9(
    v
  ), h = c.length > V, M = C ? c : H9(c, V), H = S9(r) ? r : null, w = A9(r);
  return f1(() => {
    C && m.current?.focus();
  }, [C]), /* @__PURE__ */ a(
    "section",
...
T9.displayName = "F0AiProposalCard";
const B9 = ({
  icon: r,
  title: e,
  children: t
...
}, $9 = (r) => x4[r] ?? le, N9 = ({ iconName: r }) => r ? /* @__PURE__ */ o("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ o(E1, { icon: $9(r), size: "md", color: "default" }) }) : null;
function P9({
  sources: r,
  title: e
}) {
  ...
  return /* @__PURE__ */ o(B9, { icon: de, title: n, children: /* @__PURE__ */ o("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: r.map((s, c) => {
    const l = /* @__PURE__ */ o(N9, { iconName: s.icon });
...
P9.displayName = "F0AiMessageSources";
async function j9(r, e, t) {

...
import { n, t as r } from "./ToggleGroup-cYQUb8rS.js";
import { n as i, t as a } from "./DocumentToolbar-aAHlf-_C.js";
import { n as o, t as s } from "./sheetPreview-C6JnzQhP.js";
...
var p = 1e3, m = 100, h = ({ url: h, filename: g, withCredentials: _ = !0, actions: v }) => {
	let y = t(), b = i(), [x, S] = l(null), [C, w] = l(!1), [T, E] = l(0);
	c(() => {
		let e = !1;

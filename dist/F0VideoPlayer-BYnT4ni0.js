import { u as W, E as je, G as Xe, w as $, H as Ge, J as Ze, K as qe, L as Ye, M as Je, N as Qe, O as et, Q as tt, R as nt, U as rt, V as at, W as ot, X as ye, Y as st, Z as Ce, l as it, _ as ct, $ as lt, s as ut, z as dt, A as ft } from "./F0CanvasPanel-CNzjQ3Am.js";
import { jsxs as S, jsx as c } from "react/jsx-runtime";
import { forwardRef as re, useId as mt, useState as E, useRef as F, useEffect as N, useMemo as J, useCallback as T } from "react";
import { c as H, f as ue } from "./tooltip-DVUyzeYN.js";
...
function Ct({
  ...
  const { t: s } = W(), r = F(null), [d, u] = E(!1), [m, g] = E(null), y = t > 0 ? Math.min(1, e / t) : 0, l = a !== void 0 && t > 0 ? Math.min(1, a / t) : 0, f = a !== void 0 && t > 0 && a > 0 && a < t - le && e < a - le, h = (v) => {
    const P = r.current;
    if (!P)
      return 0;
...
function St({
  ...
  const { t: h } = W(), b = e.current, x = h("videoPlayer.off");
...
function At({ value: e, onChange: t }) {
  const { t: a } = W(), n = F(null), [o, s] = E(!1), r = Math.max(0, Math.min(1, e)), d = (l) => {
    const f = n.current;
    if (!f)
      return 0;
...
const Ee = "descriptions";
function It(e, { enabled: t, describedSrc: a, descriptions: n }) {
  const o = a !== void 0, { trackSrc: s, needsCrossOrigin: r } = Ie(n), [d, u] = E(!1), m = o || n !== void 0 || d, [g, y] = E(), l = F(!1);
  return N(() => {
    if (!e)
      return;
    const f = e.textTracks, h = typeof window < "u" && "speechSynthesis" in window, b = t && !o && h, x = () => {
      l.current && (l.current = !1, e.play().catch(() => {
      }));
    }, A = (C) => {
      window.speechSynthesis.cancel();
      const i = new SpeechSynthesisUtterance(C);
      i.onend = x, i.onerror = x, window.speechSynthesis.speak(i);
    }, k = /* @__PURE__ */ new WeakSet(), w = [], O = (C) => {
      if (C.kind !== Ee || (C.mode = "hidden", k.has(C)) || typeof C.addEventListener != "function")
        return;
      k.add(C);
      const i = () => {
      ...
      for (const i of Array.from(f))
        i.kind === Ee && (n === void 0 && (C = !0), O(i));
      u(C);
    };
    v();
    const P = typeof f.addEventListener == "function", M = () => v();
    return P && (f.addEventListener("addtrack", M), f.addEventListener("removetrack", M)), () => {
      P && (f.removeEventListener("addtrack", M), f.removeEventListener("removetrack", M)), w.forEach((C) => C()), h && window.speechSynthesis.cancel(), x();
    };
  }, [e, t, o, n, s]), J(
...
function Ut(e, t) {
  const { trackSrc: a, needsCrossOrigin: n } = Ie(t), [o, s] = E(!1), [r, d] = E(!1), [u, m] = E(!1), y = r || t !== void 0 && !u;
  return N(() => {
    m(!1), d(!1);
  }, [a]), N(() => {
    if (!e)
    ...
    const l = e.textTracks, f = e.querySelector(
      ...
      for (const w of Array.from(l))
        xe.has(w.kind) && (w.mode = o ? "showing" : "hidden", w.cues && w.cues.length > 0 && (k = !0));
      if (d(k), f) {
        if (f.readyState === Vt)
          m(!0);
    ...
    for (const k of Array.from(l)) {
      if (!xe.has(k.kind) || typeof k.addEventListener != "function")
        continue;
      const w = () => h();
      k.addEventListener("cuechange", w), b.push(() => k.removeEventListener("cuechange", w));
    }
    const x = typeof l.addEventListener == "function", A = () => h();
    return x && (l.addEventListener("addtrack", A), l.addEventListener("removetrack", A)), e.addEventListener("loadedmetadata", h), () => {
      b.forEach((k) => k()), x && (l.removeEventListener("addtrack", A), l.removeEventListener("removetrack", A)), e.removeEventListener("loadedmetadata", h);
    };
  }, [e, t, o, a]), J(
    () => ({
      trackSrc: a,
...
function Bt(e) {
  const t = F(null), [a, n] = E(
    null
  ), o = F(0), s = T((i) => {
    t.current = i, n(i);
  }, []), [r, d] = E(!1), [u, m] = E(!1), [g, y] = E(0), [l, f] = E(0), [h, b] = E(1), [x, A] = E(!1), [k, w] = E(
    oe
  );
  N(() => {
    ...
    const D = () => m(!0), R = () => m(!1), B = () => m(!1), j = () => {
      ...
      Et(i.playbackRate) && w(i.playbackRate);
    }, _ = () => {
...
function Wt({
  ...
  const { t: b } = W(), x = F(null), A = J(() => ae(e), [e]), [k, w] = E(
    () => Z(A, r)
    ...
    s?.describedSrc,
    K
  ), [U, Y] = E(!1), G = U && _ ? _ : v, p = Bt(G), I = Ut(p.videoElement, D), z = It(p.videoElement, {
    enabled: U,
    describedSrc: _,
    descriptions: X
  }), V = T(() => {

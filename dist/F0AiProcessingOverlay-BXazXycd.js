...
import { useInsertionEffect as Sr, forwardRef as h, useRef as I, useEffect as q, useLayoutEffect as et, useState as B, useMemo as Q, useCallback as z, createContext as G1, useContext as I1, useId as tt, createElement as Hr, memo as Tr } from "react";
import { cn as Ar, co as $r, _ as rt, cp as Br, cq as Ir, cr as Pr, cs as jr, ct as Dr, cu as ot, cv as Zr, cw as _r, a5 as se, cx as Or, aJ as Ur, cy as zr, cz as Gr, cA as Wr, ag as qr, cB as Xr, bR as Yr, a9 as nt, ac as Kr, cC as Qr, b9 as ie, J as st, K as W1, cD as it, be as Jr, cE as eo, cF as to, b2 as ro, bQ as oo, a0 as N1, au as no, bi as at, cG as so, bO as io, cH as E1, bK as ao, cI as co, cJ as lo, b1 as ct, cK as fo, cL as uo, cM as ho, cN as Co, cO as go, cP as lt, bC as po, bD as mo, cQ as vo, cR as wo, cS as xo, cT as ko, cU as Lo, cV as bo, cW as yo, cX as Mo, cY as Eo, cZ as Ro, c_ as Fo, c$ as No, d0 as Vo, d1 as So, bP as Ho, aa as To, by as Ao, d2 as $o, d3 as Bo, d4 as Io, d5 as Po, d6 as jo, d7 as Do, d8 as Zo, ap as _o, d9 as dt, O as Oo, a1 as Uo, da as ft, db as ut, dc as zo, bh as Go, bg as Wo, dd as qo, de as Xo, df as ht, dg as Yo, b0 as Ko, ay as Qo, dh as Jo, as as en, b7 as tn, di as Ct, b6 as rn, dj as gt, bj as ae, dk as on, dl as nn, dm as ce, bM as sn, bL as an, bN as pt, dn as cn, G as ln, E as dn, dp as fn, dq as un, dr as hn, ds as Cn, dt as gn, du as mt, dv as pn, ab as mn, dw as vn, L as f1, o as x, q as T1, bs as wn, u as W, dx as xn, V as m1, ck as vt, H as a1, v as C1, a2 as kn, U as p1, dy as Ln, ad as l1, aP as L1, A as R1, p as J, bW as wt, aD as le, dz as bn, aE as de, aF as fe, b as M1, dA as yn, dB as Mn, bG as En, W as Rn, a$ as Fn, a4 as ue, dC as Nn, dD as Vn, dE as Sn, dF as ye, a3 as Hn, ak as xt, aS as kt, dG as Tn, c2 as An, dH as $n, dI as Bn, aX as Lt, dJ as In, bY as Pn, dK as jn, aU as H1, dL as Dn, b8 as bt, dM as yt, ba as Mt, c as oe, dN as Et, dO as Zn, dP as _n, bn as On, dQ as Un, bd as he, bz as zn, dR as Gn, dS as Wn, dT as qn, dU as Xn, dV as Yn, a7 as Kn, ae as Qn, y as Jn, z as es, dW as Rt, dX as Ft, dY as ts, aj as Me, dZ as rs, ai as os, d_ as ns, d$ as ss, d as is } from "./F0CanvasPanel-CeqS2022.js";
...
const H0 = (e, r) => /* @__PURE__ */ a(
...
), m2 = h(p2), v2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: fs,
  Add: Ar,
  Ai: hs,
  ...
  CalendarArrowLeft: Zs,
  CalendarArrowRight: Os,
  CameraPlus: zs,
  CardPin: Ws,
  ChartFunnel: Xs,
  ChartHorizontalBars: Ks,
  ChartLine: Js,
  ChartPie: ti,
  ChartVerticalBars: oi,
  Check: nt,
  CheckCircle: Kr,
  CheckCircleLine: si,
  CheckDouble: Qr,
  ...
  DropdownOpen: co,
  Ellipsis: lo,
  EllipsisHorizontal: ct,
  Envelope: fo,
  EnvelopeOpen: ji,
  Equal: uo,
  EqualApproximately: ho,
  EqualGreater: Co,
  EqualLess: go,
  Exit: Zi,
  ExternalLink: lt,
  ...
  FaceNeutral: wo,
  FacePositive: xo,
  FaceSuperNegative: ko,
  FaceSuperPositive: Lo,
  Feed: Oi,
  File: zi,
  FileFilled: Wi,
  FileSigned: Xi,
  ...
  Wifi: m2,
  Windows: vn
}, Symbol.toStringTag, { value: "Module" })), w2 = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ t(
    f1,
    {
      ...
      variant: "ai",
      ref: r,
      iconRotate: e.icon == x2
    }
  );
});
Pt.displayName = "AIButton";
const jt = {
  background: {
...
const P2 = T1({
  ...
  ({
    ...
    const D1 = o1 && o1 !== "none" || D && D !== "none" || O && O !== "none" || n1 && n1 !== "none", Q1 = X && X !== "none" || D1, S1 = { sm: q1, md: w1, lg: X1, xl: Y1 }, Z1 = j2.map(($1) => {
      const _1 = S1[$1];
      return _1 ? I2($1, _1) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
      "div",
      {
        ...
        className: x(
          ...
          Z1,
          Q1 && !Y && "border-f1-border",
          N && !_ && "divide-f1-border",
          "scrollbar-macos"
        ),
        ...K1
      }
...
const ee = wn(
  ...
  return f === "recording" ? /* @__PURE__ */ a("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    ...
    /* @__PURE__ */ t("div", { className: "flex items-center gap-2", children: e && /* @__PURE__ */ a(F1, { children: [
      /* @__PURE__ */ t(
        f1,
        {
  ...
  "div",
  {
    ...
    children: e.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ t(m1, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ t(
        _2,
        {
          att: s,
          onRemove: o,
...
function _2({
  ...
  const n = /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ t(a1, { icon: rt, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ t(
      "button",
      {
        ...
        onClick: () => r(e.id),
        children: /* @__PURE__ */ t(a1, { icon: N1, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ t(kn, { label: e.errorMessage, children: n }) : n;
}
const O2 = {
  soft: {
    text: "",
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      className: x("flex flex-col rounded-xl", n.bg, n.formBorder),
      children: [
        /* @__PURE__ */ a("div", { className: "flex items-center justify-between gap-2 px-4 pb-1.5 pt-2", children: [
          /* @__PURE__ */ t(
            "p",
            {
              className: x("min-w-0 flex-1 text-sm font-medium", n.fontColor),
              children: n.text
            }
          ),
...
function z2({
  ...
  return !e || u ? null : /* @__PURE__ */ t(
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (f, g) => /* @__PURE__ */ a(
        "div",
        {
          className: "flex items-center gap-2 p-2",
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ t(m1, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ t(
              m1,
              {
                className: x("h-4 rounded", g === 1 ? "w-24" : "w-32")
              }
            )
          ]
        },
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ t(l1, { className: "text-base font-medium text-f1-foreground", children: C }) })
            ]
          },
          String(f.id)
        );
...
const G2 = ({
  ...
  return /* @__PURE__ */ t("div", { className: "p-1", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ t(a1, { icon: ge, size: "md", color: "default" }) }),
        /* @__PURE__ */ t(
          l1,
          {
  ...
  const s = L1(), [i, c] = B(""), [d, l] = B(0), [u, f] = B(!1), g = I(null), p = I(null), C = I(null), m = e[d] ?? r;
  return q(() => {
    const v = () => {
    ...
    if (s)
      return f(!1), c(m), v(), g.current = setTimeout(() => {
    ...
    f(!0), c("");
    let w = 0;
    const b = 50, j = 30, H = 2e3, F = 1e3;
    return p.current = setInterval(() => {
      w < m.length ? (c(m.slice(0, w + 1)), w++) : (p.current && (clearInterval(p.current), p.current = null), g.current = setTimeout(() => {
        C.current = setInterval(() => {
          w > 0 ? (w--, c(m.slice(0, w))) : (C.current && (clearInterval(C.current), C.current = null), g.current = setTimeout(() => {
            const M = (d + 1) % Math.max(e.length, 1);
            l(M);
          }, F));
        }, j);
...
`) ? o + "_" : o
        ...
        "div",
        {
          ...
          children: d.map(
            (C, m) => C.type === "mention" ? /* @__PURE__ */ t(
              ...
              m
            ) : C.type === "ghost" ? /* @__PURE__ */ t("span", { className: "text-f1-foreground-secondary opacity-50", children: C.text }, m) : /* @__PURE__ */ t("span", { children: C.text }, m)
          )
        }
      ),
      !o && !u && /* @__PURE__ */ t(
      ...
      /* @__PURE__ */ t(
        "textarea",
        {
          ...
          className: x(
            ...
            !l && (o || !u ? "caret-f1-foreground" : "caret-transparent")
          )
        }
      ),
      u && /* @__PURE__ */ t(
  ...
  cards: e,
  onCardSelect: r
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, X2).map((o) => /* @__PURE__ */ t(
  wt,
  {
    ...
    onClick: () => {
      o.onClick ? o.onClick() : o.message && r?.(o.message);
    }
  },
  o.title
)) }), K2 = 5;
...
const J2 = ({
  ...
  const [s, i] = B(null), c = s !== null ? e[s] : null;
  return e.length === 0 ? null : /* @__PURE__ */ a(
    le,
    {
      ...
      children: [
        /* @__PURE__ */ t(bn, { asChild: !0, children: /* @__PURE__ */ t("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ t(de, { asChild: !0, children: /* @__PURE__ */ t(
          f1,
          {
            variant: "outline",
            label: d.label,
          ...
          fe,
          {
            ...
            children: [
              /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ t(a1, { icon: c.icon, size: "sm" }),
                /* @__PURE__ */ t("span", { children: c.label })
              ] }),
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: Q2(c.items).map((d, l) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ t(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ t(a1, { icon: se, size: "sm" })
                      }
                    )
                  ]
                },
...
function ec(e, r, o) {
  ...
  for (const f of r) {
    ...
    for (; ; ) {
      ...
      if (C === -1) break;
      i.push({ start: C, end: C + g.length }), p = C + g.length;
    }
  }
  ...
  const u = (f) => {
    if (!s || l || n < d || n > f) {
      f > d && c.push({ type: "text", text: e.slice(d, f) }), d = f;
      return;
    }
    n > d && c.push({ type: "text", text: e.slice(d, n) }), c.push({ type: "ghost", text: s }), l = !0, n < f && c.push({ type: "text", text: e.slice(n, f) }), d = f;
  };
  for (const f of i)
    u(f.start), c.push({ type: "mention", text: e.slice(f.start, f.end) }), d = f.end;
  return u(e.length), !l && s && n >= d && c.push({ type: "ghost", text: s }), c.length === 0 ? [{ type: "text", text: e }] : c;
}
function tc(e, r) {
  if (r === "*/*") return !0;
  if (r.endsWith("/*")) {
...
function rc(e, r) {
  ...
  return o.length === 0 ? e : e.filter(
    (n) => o.some((s) => tc(n.type, s))
  );
}
const oc = 4e3;
function nc(e) {
  const [r, o] = B([]), [n, s] = B(null), i = I(
    null
  ), c = I(null), d = W(), l = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, g = Q(() => {
    if (u)
  ...
  const v = z(
    async (H) => {
      ...
      if (f !== void 0 && C.current + F.length > f) {
        m(
      ...
      const T = (A) => o(
        ($) => $.map(
          (R) => V.includes(R.id) ? { ...R, status: "error", errorMessage: A } : R
        )
      );
      try {
        const A = await l(F);
        if (!Array.isArray(A) || A.length !== F.length) {
          T(d.ai.fileUploadError);
          return;
        }
        o(
          ($) => $.map((R) => {
            const E = M.findIndex((S) => S.id === R.id);
            return E === -1 ? R : A[E] ? {
              ...R,
              status: "uploaded",
              uploadedFile: A[E]
        ...
        const $ = A instanceof Error && A.message ? A.message : d.ai.fileUploadError;
        T($);
      }
    },
    [
...
function ac(e, r) {
  ...
  const c = i.offsetLeft, d = i.offsetTop - e.scrollTop;
...
function lc({
  ...
  const [i, c] = B(!1), [d, l] = B(""), [u, f] = B([]), [g, p] = B(!1), [C, m] = B(0), [v, w] = B([]), b = I(-1), j = I(null), H = I(0), F = I(-1);
  q(() => {
    if (!n) {
      c(!1);
      return;
    ...
    const E = sc(e, o, v);
    if (!E) {
      c(!1), l(""), f([]), m(0), b.current = -1, F.current = -1;
      return;
    }
    if (E.atIndex === F.current)
      return;
    b.current = E.atIndex, l(E.query), c(!0), m(0), p(!0), j.current && clearTimeout(j.current);
    const S = ++H.current;
    return j.current = setTimeout(() => {
      n(E.query).then((U) => {
        S === H.current && (f(U), m(0), U.length === 0 && E.query.length > 0 && (F.current = E.atIndex, c(!1)));
      }).catch(() => {
        S === H.current && f([]);
      }).finally(() => {
        S === H.current && p(!1);
  ...
  const M = z(() => {
    c(!1), l(""), f([]), m(0), b.current = -1;
  }, []), V = z(
    (E) => {
      const S = b.current;
      if (S === -1) return;
      const U = `${E.firstName} ${E.lastName}`.trim(), Z = String(E.id), G = e.slice(0, S), e1 = e.slice(o), t1 = `@${U} `, Y = G + t1 + e1, X = G.length + t1.length;
      r(Y), w((o1) => [...o1.filter((O) => !(O.id === Z && O.name === U)), { id: Z, name: U }]), M(), requestAnimationFrame(() => {
        const o1 = s.current;
        o1 && (o1.focus(), o1.setSelectionRange(X, X));
      });
    },
    [e, o, r, s, M]
  ), T = z(
    (E) => {
      if (!i) return !1;
      if (E.key === "Escape")
        return E.preventDefault(), M(), !0;
      if (u.length === 0) return !1;
      switch (E.key) {
        case "ArrowDown":
          return E.preventDefault(), m((S) => (S + 1) % u.length), !0;
        case "ArrowUp":
          return E.preventDefault(), m(
            (S) => (S + u.length - 1) % u.length
          ), !0;
        case "Tab": {
          const S = u[C];
          if (S) {
            const U = `${S.firstName} ${S.lastName}`.trim();
            if (d.length === 0 || U.toLowerCase().startsWith(d.toLowerCase()))
              return E.preventDefault(), V(S), !0;
          }
          return !1;
        }
        case "Enter":
          return E.preventDefault(), u[C] && V(u[C]), !0;
        default:
          return !1;
      }
    },
    ...
    (E) => {
      ...
      let S = E;
      const U = [...v].sort((Z, G) => G.name.length - Z.name.length);
      for (const Z of U) {
        const G = `@${Z.name}`, e1 = `<entity-ref type="person" id="${Ee(Z.id)}">${Ee(Z.name)}</entity-ref>`;
        for (; S.includes(G); )
          S = S.replace(G, e1);
      }
      return S;
  ...
  q(() => {
    w(
      (E) => E.filter((S) => {
        const U = `@${S.name}`, Z = e.indexOf(U);
        if (Z === -1) return !1;
        const G = e[Z + U.length];
        return G === " " || G === `
` || G === "	";
      })
    );
  ...
  const $ = Q(() => {
    ...
    const E = s.current;
    if (!E) return null;
    const S = ac(E, b.current), U = E.offsetLeft + S.left, G = (E.offsetParent ? E.offsetParent.offsetHeight : 0) - (E.offsetTop + S.top);
    return { left: U, bottom: G };
  }, [i, e, o, s]), R = Q(() => {
    if (!i || u.length === 0) return null;
    const E = u[C];
    if (!E) return null;
    const S = `${E.firstName} ${E.lastName}`.trim();
    return d.length === 0 ? S : S.toLowerCase().startsWith(d.toLowerCase()) ? S.slice(d.length) : null;
  }, [i, u, C, d]);
  return {
    isOpen: i,
    query: d,
...
const dc = /[\\`*_{}[\]()#+\-.!|~>]/g, fc = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(dc, "\\$&")).join(""), Z4 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const $ = W(), R = L1(), [E, S] = B(T ?? ""), [U, Z] = B(0), [G, e1] = B(!1), [t1, Y] = B(!1), [X, o1] = B(null), D = I(null), O = I(null), n1 = I(null), u1 = c != null, { tracking: i1 } = M1(), x1 = z(
    (K, k1) => {
      i1?.onWelcomeSuggestionClick?.({
        item: K,
        group: k1,
    ...
    const k1 = V1.current, J1 = k1 && !/\s$/.test(k1) ? " " : "", O1 = `${k1}${J1}${K}`;
    S(O1), Z(O1.length);
  }, []), q1 = {
    "permission-denied": $.ai.micPermissionDenied,
    "device-error": $.ai.micError,
    "transcription-failed": $.ai.transcriptionError
  }, w1 = yn({
    onTranscribe: p,
    onPartial: P1,
    onFinal: (K) => {
      P1(K), O.current?.focus();
    },
    onError: (K) => b1(q1[K])
  }), X1 = !!p && w1.isSupported, Y1 = z(() => {
    i1?.onDictationStart?.(), V1.current = E, w1.start();
  }, [E, w1, i1]), K1 = z(() => {
    i1?.onDictationCancel?.(), w1.cancel();
  }, [w1, i1]);
  q(() => {
    typeof window < "u" && window.location.hash.length === 0 && O.current?.focus();
  }, []), q(() => {
    if (m)
      return m((K) => {
        N(K);
  ...
  const j1 = w1.status === "recording", D1 = j1 ? $.ai.listening : $.ai.inputPlaceholder, Q1 = r1.filter((K) => K.status === "uploaded"), S1 = r1.some((K) => K.status === "uploading"), Z1 = r1.some((K) => K.status === "error"), $1 = E.trim().length > 0;
  q(() => {
    if (!(!t1 || S1)) {
      if (Y(!1), Z1) {
        b1($.ai.fileUploadBlockedSubmit);
        return;
      }
      D.current?.requestSubmit();
    }
  }, [
    t1,
    S1,
    Z1,
    b1,
    $.ai.fileUploadBlockedSubmit
  ]);
  const _1 = async (K) => {
    if (K.preventDefault(), !u1) {
      if (s1.close(), o)
        r?.();
      else if ($1 && !G) {
        if (S1) {
        ...
        const k1 = s1.transformMentions(E.trim()), J1 = fc(k1), O1 = Q1.flatMap(
          (be) => be.uploadedFile ? [be.uploadedFile] : []
        ), ke = d, Le = u;
        ke && l?.(null), Le && f?.(null), await e({
          text: J1,
          files: O1,
          context: ke,
          quote: Le
    ...
    u1 || s1.handleKeyDown(K) || K.key === "Enter" && !K.shiftKey && (K.preventDefault(), o || D.current?.requestSubmit());
  }, yr = () => {
    Z(O.current?.selectionStart ?? 0);
  }, Mr = () => {
    n1.current && O.current && (n1.current.scrollTop = O.current.scrollTop);
  }, me = X ? X.prompt ?? X.title : null, ve = j1 ? [$.ai.listening] : me ? [me] : s ?? [], Er = ve.length > 1, Rr = Q(() => ec(E, s1.mentions, {
    cursorPosition: U,
    inlineCompletion: s1.inlineCompletion
  }), [E, s1.mentions, U, s1.inlineCompletion]), Fr = s1.mentions.length > 0 || s1.inlineCompletion !== null, we = b && !!H && H.length > 0 && !!F ? /* @__PURE__ */ t(
    J2,
    {
      suggestions: H,
      onItemClick: x1,
  ...
  ) : null, Nr = b && j && !!M && M.length > 0, xe = j && b, { motionProps: Vr } = Mn(
    b,
    160,
    0.5
  );
  return /* @__PURE__ */ a(
    J.div,
    {
      ...
      className: x(
        ...
        xe && "min-h-0 flex-1 justify-start -mt-20"
      ),
      ...j ? Vr : {},
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          we && /* @__PURE__ */ t("div", { children: we }),
          /* @__PURE__ */ t(U2, { creditWarning: i, children: /* @__PURE__ */ a(
            J.form,
            {
              "aria-busy": o,
              ref: D,
              className: x(
                ...
                u1 && "after:scale-100 after:opacity-100 border-f1-background-tertiary"
              ),
              animate: {
                ...
                /* @__PURE__ */ t(R1, { initial: !1, children: u1 ? /* @__PURE__ */ t(
                  ...
                  J.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ t(R1, { initial: !1, children: v1 && /* @__PURE__ */ t(
                        J.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ a(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ t("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ t(En, { type: "critical", size: "sm" }) }),
                      ...
                      /* @__PURE__ */ t(
                        D2,
                        {
                          ...
                          isPreSending: G || t1,
                          canRecord: X1,
                          recordingStatus: w1.status,
                          recordingStream: w1.stream,
                          onStartRecording: Y1,
                          onStopRecording: w1.stop,
        ...
        Nr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(
          Y2,
          {
            cards: M,
            onCardSelect: V
        ...
        w && b && j && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: w }),
        /* @__PURE__ */ t(R1, { mode: "wait", initial: !1, children: u1 ? /* @__PURE__ */ a(
          J.div,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { children: [
                ...
                " ",
                $.ai.clarifyingQuestion.navHint.navigate
              ] }),
              /* @__PURE__ */ a("span", { children: [
                /* @__PURE__ */ t("kbd", { className: "font-sans", children: "Enter" }),
                " ",
                $.ai.clarifyingQuestion.navHint.select
              ] }),
              /* @__PURE__ */ a("span", { children: [
                /* @__PURE__ */ t("kbd", { className: "font-sans", children: "Esc" }),
                " ",
                $.ai.clarifyingQuestion.navHint.cancel
              ] })
            ]
          },
          "clarifying-nav-hint"
        ) : v?.text && !xe && /* @__PURE__ */ a(
          J.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ t(l1, { className: "text-sm font-medium text-f1-foreground-tertiary", children: v.text }),
...
function mc({
  ...
  return /* @__PURE__ */ t(Fn, { ...r, variant: "link", href: r.href, children: e });
}
function vc({
  children: e,
  ...r
...
function A1({
  ...
  const i = I(/* @__PURE__ */ new Map()), [c, d] = B(
    () => i.current.get(e) ?? null
  ), [l, u] = B(!1), [f, g] = B(!1), p = I(!0);
  q(() => () => {
    p.current = !1;
  }, []);
  const C = z(() => {
    ...
    u(!0), g(!1), o(e).then((w) => {
      i.current.set(e, w), p.current && d(w);
    }).catch(() => {
      p.current && g(!0);
    }).finally(() => {
      p.current && u(!1);
  ...
  return /* @__PURE__ */ a(
    Nn,
    {
      ...
      children: [
        /* @__PURE__ */ t(Vn, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          Sn,
          {
            side: "top",
            ...
            children: l ? /* @__PURE__ */ t(ye.Skeleton, {}) : /* @__PURE__ */ t(ye, { ...m })
          }
        )
      ]
    }
...
function Sc({
  ...
  const { entityRefs: o } = M1(), n = o?.resolvers?.candidate, s = W(), i = o?.urls?.candidate?.(e), c = Q(
    () => (l) => {
      const u = [];
...
function Hc({ id: e, label: r }) {
  const { entityRefs: o } = M1(), n = o?.resolvers?.expense, s = W(), i = o?.urls?.expense?.(e), c = Q(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: St
...
function Tc({
  ...
  const { entityRefs: o } = M1(), n = o?.resolvers?.jobPosting, s = W(), i = o?.urls?.jobPosting?.(e), c = Q(
    () => (l) => ({
      title: l.title,
...
function $c({
  ...
  const { entityRefs: o } = M1(), n = o?.resolvers?.requisition, s = W(), i = o?.urls?.requisition?.(e), c = Q(
    () => (l) => {
...
function Bc({ id: e, label: r }) {
  const { entityRefs: o } = M1(), n = o?.resolvers?.person, s = W(), i = o?.urls?.person?.(e), c = Q(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
or.displayName = "VacancyTrigger";
function Ic({ id: e, label: r }) {
  const { entityRefs: o } = M1(), n = o?.resolvers?.vacancy, s = W(), i = o?.urls?.vacancy?.(e), c = Q(
    () => (l) => ({
      title: l.name,
...
function nr({
  ...
  const c = W(), d = s.type === "open", l = d ? n ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ a(
    "div",
    {
      className: x(
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ t(kt, { module: e.module, size: "md" }),
          e?.type === "file" && /* @__PURE__ */ t(Tn, { file: e.file, size: "lg" }),
...
function O4({
  ...
  const [r, o] = B(0), n = I([]), s = z(
    (c) => {
      const d = n.current, l = d.findIndex(
        (f) => f.formName === c.formName && f.customFieldName === c.customFieldName
      ), u = c;
      l >= 0 ? d[l] = u : d.push(u), o((f) => f + 1);
    },
    []
  ), i = Q(
    () => ({
  ...
  return /* @__PURE__ */ t(pe.Provider, { value: i, children: e });
}
function Zc(e) {
  const o = I1(pe)?.formatters;
  return Q(() => !o || o.length === 0 ? null : (n, s, i) => {
    ...
    for (const l of o) {
      ...
      if (!u || !f) continue;
      let g = 0;
      l.formName !== void 0 && (g += 2), l.customFieldName !== void 0 && (g += 1), g > d && (d = g, c = l);
    }
    if (c)
...
const Re = 7, _c = 625, Fe = /* @__PURE__ */ new Set();
function Oc(e) {
...
function zc(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = $n(e), i = [];
...
function sr(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: zc(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? Oc(o) : "") || "—" };
  }
  if (r === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: o, to: n } = e, s = Ne(o) ? Ve(o) : String(o), i = Ne(n) ? Ve(n) : String(n);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((n) => {
      const s = sr(n);
      return Array.isArray(s) ? s.map(Se).join(", ") : Se(s);
    }).filter(Boolean).join(", ") || "—" };
  ...
  return { type: "item", text: Uc(String(e)) };
}
function ir({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: l, openCanvas: u, closeCanvas: f } = M1(), g = Zc(e), p = d ?? g, C = I(() => {
  }), m = n ?? e, v = s ?? r ?? "", w = l?.type === "form" && l.formName === e, b = () => u({
    type: "form",
    title: m,
    description: v,
    formName: e,
  ...
  C.current = b, q(() => {
    typeof window > "u" || window.innerWidth < _c || Fe.has(e) || (Fe.add(e), C.current());
  }, [e]);
  const j = i && c ? Object.entries(i).map(([M, V]) => {
    const T = c[M], A = p?.(M, T, {
      fieldType: V.fieldType,
      customFieldName: V.customFieldName
    });
    if (!A && V.fieldType === "custom" && typeof T == "object" && T !== null)
      return null;
    const $ = A ?? sr(T, V.fieldType), R = ["richtext", "textarea"];
    return {
      label: V.label,
      content: $,
      verticalLayout: R.includes(V.fieldType ?? "")
    };
  }).filter((M) => {
    if (!M) return !1;
    const V = Array.isArray(M.content) ? M.content[0] : M.content;
    return !(V?.type === "item" && V.text === "—");
  }) : [], H = j.slice(0, Re), F = j.length > Re;
  return /* @__PURE__ */ t(
    nr,
    {
...
ir.displayName = "FormCard";
function Gc() {
  const e = Bn(), r = e?.activeForm;
  if (!r) return null;
...
const He = 8, B1 = 8;
function cr({ anchor: e, onReply: r }) {
  const o = W(), n = I(null), [s, i] = B(
    null
  );
  if (et(() => {
    if (!e) {
    ...
    let p = e.rect.top - u - He;
    p < B1 && (p = e.rect.bottom + He), p = Math.min(
      Math.max(p, B1),
      g - u - B1
    );
    const C = e.rect.left + e.rect.width / 2 - l / 2, m = Math.min(
      Math.max(C, B1),
      f - l - B1
    );
    i({ top: p, left: m });
...
const lr = G1(void 0), z4 = () => I1(lr), Xc = (e) => /* @__PURE__ */ t(Lt, { content: e, format: "markdown" }), Yc = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", l = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !l, g = I(null), { anchor: p, clear: C } = ar({
    containerRef: g,
    enabled: !!(o?.id && d)
  });
  return q(() => {
    o?.id && !r && !e && i?.(o);
  }, [o, r, e, i]), !r && !e && f ? null : /* @__PURE__ */ t(lr.Provider, { value: u, children: /* @__PURE__ */ a("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ t(
      "div",
      {
        ref: g,
    ...
    /* @__PURE__ */ t(
      cr,
      {
        anchor: p,
        onReply: (m) => {
          s?.(m), C(), window.getSelection()?.removeAllRanges();
        }
      }
    )
  ] }) });
  ...
  const [s, i] = B(""), c = W(), { title: d, label: l, placeholder: u } = o === "like" ? c.ai.feedbackModal.positive : c.ai.feedbackModal.negative, f = z(() => {
    r(n, s);
  }, [s, n, r]), g = () => {
    e(n);
  };
  ...
  return /* @__PURE__ */ t(dr.Provider, { value: n, children: e });
}, fr = () => {
  const e = I1(dr);
  if (e === null)
    throw new Error(
...
const el = ({
  ...
  const s = W(), { open: i } = fr(), [c, d] = B(null);
  return /* @__PURE__ */ a("div", { className: "flex", children: [
    ...
    /* @__PURE__ */ t(
      ...
      {
        onClick: (l) => {
          const u = c === "like" ? null : "like";
          u && i(u, r), d(u), l.currentTarget.blur();
        },
        compact: !0,
        mode: "only",
        variant: "ghost",
        "aria-label": s.actions.thumbsUp,
    ...
    /* @__PURE__ */ t(
      ...
      {
        onClick: (l) => {
          const u = c === "dislike" ? null : "dislike";
          u && i(u, r), d(u), l.currentTarget.blur();
        },
        compact: !0,
        mode: "only",
        variant: "ghost",
        "aria-label": s.actions.thumbsDown,
        children: /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center justify-center gap-1", children: /* @__PURE__ */ t(
          a1,
          {
            size: "md",
    ...
    n && /* @__PURE__ */ t(Dn, { description: s.actions.rewind, instant: !0, children: /* @__PURE__ */ t(
      H1,
      {
        onClick: (l) => {
          n(), l.currentTarget.blur();
        },
        compact: !0,
        mode: "only",
        variant: "ghost",
        "aria-label": s.actions.rewind,
        children: /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center justify-center gap-1", children: /* @__PURE__ */ t(a1, { size: "md", icon: gt, color: "default" }) })
      }
    ) })
  ] });
}, Te = ({ position: e }) => /* @__PURE__ */ t(
  J.div,
  {
  ...
  const [d, l] = B(s), u = L1(), f = n !== void 0, g = f ? n : d;
  return /* @__PURE__ */ a(
    bt,
    {
        ...
        /* @__PURE__ */ a(
          yt,
          {
            ...
            children: [
              ...
              !c && /* @__PURE__ */ t(a1, { icon: W1 })
            ]
          }
        ),
        /* @__PURE__ */ t(Mt, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ t(
          J.div,
          {
            initial: !1,
            animate: {
  ...
  const s = W(), [i, c] = B(!!o), d = I(o);
  q(() => {
    d.current && !o ? c(!1) : o && !i && c(!0), d.current = o;
  }, [o, i]);
  const l = o ? s.ai.thoughtsGroupTitle : r ?? s.ai.thoughtsGroupTitle, u = e.length - 1, f = (g) => !o || n ? "completed" : g === u ? "executing" : "completed";
  return /* @__PURE__ */ t(
    tl,
    {
      icon: Vt,
      ...
      onOpenChange: c,
      lockOpen: o,
      children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pb-4", children: e.map((g, p) => /* @__PURE__ */ a("div", { className: "relative", children: [
        /* @__PURE__ */ t(
          oe,
          {
            title: g,
...
const ur = (e) => /* @__PURE__ */ t(Lt, { content: e, format: "markdown" }), sl = ({
  text: e,
  renderMarkdown: r
}) => /* @__PURE__ */ a("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ t("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ t(a1, { icon: ge }) }),
  ...
  const c = e.rawData, d = nl(
    e?.content,
    c
  ), l = (ol(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = l.length > 0, { anchor: g, clear: p } = ar({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(sl, { text: u, renderMarkdown: n }),
        d.length > 0 && /* @__PURE__ */ t("div", { className: "flex max-w-[90%] flex-wrap justify-end gap-1.5", children: d.map((C, m) => /* @__PURE__ */ t(
          vt,
          {
...
}, al = 35, cl = 22, ll = 400, dl = 2500, fl = 220, ul = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  const [n, s] = B(0), [i, c] = B(0), [d, l] = B("starting"), u = e[n] ?? "";
  q(() => {
    e.length > 0 && n >= e.length && (s(0), c(0), l("starting"));
  }, [e.length, n]), q(() => {
    let p;
    if (d === "starting")
      p = setTimeout(() => l("writing"), ll);
    else if (d === "writing")
      i < u.length ? p = setTimeout(() => c((C) => C + 1), al) : l("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => l("erasing"), dl);
    } else d === "erasing" && (i > 0 ? p = setTimeout(() => c((C) => C - 1), cl) : p = setTimeout(() => {
      s((C) => (C + 1) % e.length), l("starting");
    }, fl));
    return () => {
      p && clearTimeout(p);
    };
...
function hl({
  ...
  const [c, d] = B(0), [l, u] = B(!1), f = I(s), g = I(i);
  g.current = i;
  const p = z(
    (m = "smooth") => {
  ...
  const C = z(() => {
    const m = e.current;
    if (!m) return;
    const { scrollTop: v, scrollHeight: w, clientHeight: b } = m, j = w - v - b;
    u(j > b);
  }, [e]);
  return q(() => {
    const m = e.current;
    if (m)
      return m.addEventListener("scroll", C, { passive: !0 }), () => m.removeEventListener("scroll", C);
  }, [C, e]), q(() => {
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const m = e.current, v = n.current;
        if (!m || !v) return;
        const w = m.getBoundingClientRect(), b = v.getBoundingClientRect(), j = m.scrollTop + (b.top - w.top);
        m.scrollTo({ top: j, behavior: "smooth" });
      });
    }), s === 0 && u(!1), f.current = s;
...
const Cl = {
...
}, G4 = (e) => /* @__PURE__ */ t(Qc, { children: /* @__PURE__ */ t(gl, { ...e }) }), gl = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: F, handleSubmit: M, handleClose: V } = Jc(
    f ?? Cl
  ), T = W(), A = v ?? Yc, $ = w ?? il, R = Q(() => {
    const D = n ?? T.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((n1) => typeof n1 == "string" && n1.length > 0);
  }, [n, T.ai.defaultInitialMessage]), E = !r && e.length === 0 && R.length > 0, S = I(null), U = I(null), Z = I(null), G = I(null), e1 = I(null), { showScrollBtn: t1, turnMinHeight: Y, scrollToBottom: X } = hl({
    viewportRef: S,
    contentRef: U,
    endRef: Z,
    lastTurnRef: e1,
    ...
    const n1 = O === e.length - 1, u1 = {
      ...
      const k = n1 && d1 === D.assistantMessages.length - 1, y = D.userMessages.length + d1, L = {
        message: r1,
        inProgress: D.isInProgress,
        index: y,
        isCurrentMessage: k,
      ...
      return /* @__PURE__ */ t(
        ...
        {
          ...L,
          isGenerating: D.isInProgress && k,
          isLoading: D.isInProgress && k && !r1.content
        },
        `${O}-a-${d1}`
      );
    };
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        style: {
          minHeight: n1 && Y || void 0
        },
        children: [
          D.userMessages.map(
            (r1, d1) => i1(r1, d1)
          ),
          D.thinking && D.thinking.titles.length > 0 && /* @__PURE__ */ t(
            rl,
            {
              titles: D.thinking.titles,
              title: T.ai.thoughtsGroupTitle,
          ...
          D.endIndicator === "thinking" && /* @__PURE__ */ t(oe, { title: T.ai.thinking, status: "executing" }),
          D.endIndicator === "activity" && /* @__PURE__ */ t(oe, { status: "writing" }),
          (() => {
            const r1 = !!H && !D.isInProgress && D.canUndo !== !1;
            return !D.feedback && !r1 ? null : /* @__PURE__ */ t(
              el,
              {
                content: D.feedback?.content ?? "",
                targetMessage: D.feedback?.targetMessage ?? {},
                onCopy: D.feedback ? j : void 0,
                onUndo: r1 ? () => H(O) : void 0
              }
            );
          })(),
          n1 && /* @__PURE__ */ t(Gc, {})
  ...
  return /* @__PURE__ */ a(F1, { children: [
    /* @__PURE__ */ a("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
          ...
          children: /* @__PURE__ */ a(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ t("div", { ref: G, className: "h-px shrink-0", "aria-hidden": !0 }),
                /* @__PURE__ */ t("footer", { className: "copilotKitMessagesFooter", ref: Z, children: m }),
      ...
      !p && !E && /* @__PURE__ */ a(F1, { children: [
        /* @__PURE__ */ t(Te, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ t(Te, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    F.isOpen && /* @__PURE__ */ t(
      Kc,
...
}, pl = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ t("div", { className: "flex justify-end", children: /* @__PURE__ */ t(m1, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ t(m1, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ t(m1, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ t(m1, { className: "h-5 w-4/5 rounded-md" })
] }) }), W4 = {
  ai: as.ai
}, hr = G1(null);
function q4({
...
const vl = ({
  ...
  const p = W().ai.clarifyingQuestion.typeYourAnswer, C = e === "single" ? /* @__PURE__ */ t(Cr, { isSelected: o && !r }) : /* @__PURE__ */ t(
    Et,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const xl = ({
  ...
  const b = L1(), j = (() => {
    ...
    const T = o.findIndex((A) => n.includes(A.id));
    return T >= 0 ? T : 0;
  })(), [H, F] = B(j), M = I([]);
  q(() => {
  ...
  const V = (T) => {
    ...
    T.preventDefault(), F($), M.current[$]?.focus();
  };
  return /* @__PURE__ */ a(
    "div",
    {
  ...
  } = s, T = I(null), A = j ?? "single", $ = c > 1, R = i === 0, E = i === c - 1, S = $ ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(c)
  }) : void 0, U = b.length > 0, Z = (M ?? "").trim().length > 0, G = U || V && Z || H === !0, e1 = r === !0 && E, t1 = () => {
    e1 || l();
  }, Y = () => {
    e1 || u();
  }, X = (i1) => {
    const x1 = A === "single" && b.includes(i1);
    d(i1), A === "single" && !E && !x1 && Promise.resolve().then(l);
  }, o1 = E ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, D = H === !0 && !U && !(V && Z), O = () => {
    m(), requestAnimationFrame(() => {
      T.current?.focus();
    });
  }, n1 = (i1) => {
    i1.key === "Escape" && (i1.preventDefault(), f());
  }, u1 = n ? 0 : bl / 2;
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: n1, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(R1, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      J.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: u1, ease: Ll },
        children: [
          /* @__PURE__ */ t(
            kl,
            {
...
function Ae(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), l = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (O) => O / e * 2 - 1, g = (O) => O / r * 2 - 1, p = 0, C = e, m = 0, v = r, w = l, b = e - l, j = u, H = r - u, F = f(p), M = f(C), V = g(m), T = g(v), A = f(w), $ = f(b), R = g(j), E = g(H), S = 0, U = 0, Z = 1, G = 1, e1 = l / e, t1 = 1 - l / e, Y = u / r, X = 1 - u / r, o1 = new Float32Array([
    // Top strip
    F,
    V,
    M,
...
function Ml(e, r, o) {
  const n = $e(e, e.VERTEX_SHADER, r), s = $e(e, e.FRAGMENT_SHADER, o), i = e.createProgram();
...
class Q4 {
  ...
  resize(r, o, n) {
    ...
    const { gl: s, program: i, vao: c, positionBuffer: d, uvBuffer: l, uResolution: u } = this.glr, f = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, g = Math.max(1, Math.floor(r * f)), p = Math.max(1, Math.floor(o * f));
    ...
    const { positions: C, uvs: m } = Ae(
      this.canvas.width,
      this.canvas.height,
      this.options.borderWidth * f,
      this.options.glowWidth * f
    );
    s.bindVertexArray(c), s.bindBuffer(s.ARRAY_BUFFER, d), s.bufferData(s.ARRAY_BUFFER, C, s.STATIC_DRAW);
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: c, uvs: d } = Ae(
      s,
      i,
    ...
    const p = r.getUniformLocation(o, "uResolution"), C = r.getUniformLocation(o, "uTime"), m = r.getUniformLocation(o, "uBorderWidth"), v = r.getUniformLocation(o, "uGlowWidth"), w = r.getUniformLocation(o, "uBorderRadius"), b = r.getUniformLocation(o, "uColors"), j = r.getUniformLocation(o, "uGlowExponent"), H = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(m, this.options.borderWidth), r.uniform1f(v, this.options.glowWidth), r.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(j, 2), r.uniform1f(H, 1.8)) : (r.uniform1f(j, 1), r.uniform1f(H, 1));
    const F = (this.options.colors || Fl).map(Nl);
...
const Be = ["lowp", "mediump", "highp"], Vl = `
void main(void){
...
}`, Ie = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, Pe = "iTime", je = "iTimeDelta", De = "iDate", Ze = "iFrame", _e = "iMouse", Oe = "iResolution", Hl = "iChannel", Ue = "iChannelResolution", ze = "iDeviceOrientation";
function Tl(e, r) {
...
}, te = 9729, Ge = 9728, Pl = 9987, We = 33071, qe = 10497;
class jl {
  gl;
  url;
  wrapS;
  ...
  updateTexture = (r, o, n) => {
    const { gl: s } = this, i = 0, c = s.RGBA, d = s.RGBA, l = s.UNSIGNED_BYTE;
  ...
  load = async (r) => {
    ...
    Object.assign(this, { url: n, wrapS: s, wrapT: i, minFilter: c, magFilter: d, flipY: l });
    const g = 0, p = o.RGBA, C = 1, m = 1, v = 0, w = o.RGBA, b = o.UNSIGNED_BYTE, j = new Uint8Array([255, 255, 255, 0]), H = o.createTexture();
    if (o.bindTexture(o.TEXTURE_2D, H), o.texImage2D(
      ...
      return o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.LINEAR), this._webglTexture = H, this.source = T, this.isVideo = !0, T.play().then(() => this);
    }
    async function F() {
      return new Promise((T, A) => {
        ...
        $.crossOrigin = "anonymous", $.onload = () => {
          ...
          A(new Error(y1(`failed loading url: ${n}`)));
        }, $.src = n ?? "";
      });
    }
    let M = await F(), V = (M.width & M.width - 1) === 0 && (M.height & M.height - 1) === 0;
    return (r.wrapS !== We || r.wrapT !== We || r.minFilter !== Ge && r.minFilter !== te) && !V && (M = this.makePowerOf2(M), V = !0), o.bindTexture(o.TEXTURE_2D, H), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, l), o.texImage2D(
      o.TEXTURE_2D,
      g,
      p,
      w,
      b,
      M
    ), V && r.minFilter !== Ge && r.minFilter !== te && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || qe
    ), o.texParameteri(
...
const y1 = (e) => `react-shaders: ${e}`, Xe = (e) => {
  if ("changedTouches" in e) {
    const r = e.changedTouches[0];
    return [r?.clientX ?? 0, r?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, Ye = (e, r, o) => e * (1 - o) + r * o, Dl = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function Zl({
  fs: e,
  vs: r = Ie,
  textures: o = [],
  ...
  const C = I(null), m = I(null), v = I(null), w = I(null), b = I(void 0), j = I(void 0), H = I(!1), F = I(void 0), M = I(0), V = I([0, 0]), T = I([]), A = I(0), $ = I(void 0), R = I({
    ...
    const L = "width" in k ? k.width ?? 0 : 0, P = "height" in k ? k.height ?? 0 : 0, N = R.current.iChannelResolution;
    if (!N) return;
    const _ = Array.isArray(N.value) ? N.value : N.value = [];
    _[y * 3] = L * u, _[y * 3 + 1] = P * u, _[y * 3 + 2] = 0;
  }, U = () => {
    C.current && (m.current = C.current.getContext("webgl", d) || C.current.getContext(
      "experimental-webgl",
      d
    ...
    const [y = 0, L = 0] = Xe(k), P = y - (F.current?.left ?? 0) - window.pageXOffset, N = (F.current?.height ?? 0) - L - (F.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    const _ = Array.isArray(R.current.iMouse?.value) ? R.current.iMouse.value : void 0;
    _ && (_[2] = P, _[3] = N), V.current[0] = P, V.current[1] = N;
  }, t1 = (k) => {
    F.current = C.current?.getBoundingClientRect();
    const [y = 0, L = 0] = Xe(k), P = y - (F.current?.left ?? 0), N = (F.current?.height ?? 0) - L - (F.current?.top ?? 0);
    if (l !== 1)
      V.current[0] = P, V.current[1] = N;
    else {
      const _ = Array.isArray(R.current.iMouse?.value) ? R.current.iMouse.value : void 0;
      _ && (_[0] = P, _[1] = N);
    }
    ...
    if (!k) return;
    F.current = C.current?.getBoundingClientRect();
    const y = u, L = Math.floor(
      (F.current?.width ?? 1) * y
    ), P = Math.floor(
      (F.current?.height ?? 1) * y
    );
    if (k.canvas.width = L, k.canvas.height = P, R.current.iResolution?.isNeeded && w.current) {
      const N = k.getUniformLocation(
        w.current,
        Oe
      );
      k.uniform2fv(N, [k.canvas.width, k.canvas.height]);
    }
  }, o1 = (k, y) => {
    const L = m.current;
    if (!L) return null;
    const P = L.createShader(k);
    if (!P) return null;
    if (L.shaderSource(P, y), L.compileShader(P), !L.getShaderParameter(P, L.COMPILE_STATUS)) {
      p?.(y1(`Error compiling the shader:
${y}`));
      const N = L.getShaderInfoLog(P);
      L.deleteShader(P), g?.(y1(`Shader compiler log: ${N}`));
    }
    return P;
  }, D = (k, y) => {
    const L = m.current;
    if (!L) return;
    const P = o1(L.FRAGMENT_SHADER, k), N = o1(L.VERTEX_SHADER, y);
    if (w.current = L.createProgram(), !(!w.current || !N || !P)) {
      if (L.attachShader(w.current, N), L.attachShader(w.current, P), L.linkProgram(w.current), !L.getProgramParameter(w.current, L.LINK_STATUS)) {
        g?.(
          y1(
      ...
      L.useProgram(w.current), b.current = L.getAttribLocation(
        w.current,
        "aVertexPosition"
      ), L.enableVertexAttribArray(b.current);
    }
  }, O = () => {
    if (n)
      for (const k of Object.keys(n)) {
        const y = n[k];
        if (!y) continue;
        const { value: L, type: P } = y, N = Il(P);
        if (!N) continue;
        const _ = {};
        if (Tl(P, L)) {
          const c1 = P.length, h1 = Number.parseInt(P.charAt(c1 - 3)), v1 = Math.floor(L.length / (h1 * h1));
          L.length > h1 * h1 && (_.arraySize = `[${v1}]`);
        } else Al(P, L) && (_.arraySize = `[${Math.floor(L.length / Number.parseInt(P.charAt(0)))}]`);
        R.current[k] = {
          type: N,
          isNeeded: !1,
          value: L,
      ...
      if (o && o.length > 0) {
        ...
        const y = o.map(
          (L, P) => (R.current[`${Hl}${P}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, S(L, P), T.current[P] = new jl(k), T.current[P]?.load(L).then((N) => {
            S(N, P);
          }))
        );
        Promise.all(y).then(() => {
    ...
    const y = Be.includes(i ?? "highp"), L = `precision ${y ? i : Be[1]} float;
`;
    y || p?.(
      y1(
    ...
    let P = L.concat(`#define DPR ${u.toFixed(1)}
`).concat(k.replace(/texture\(/g, "texture2D("));
    for (const _ of Object.keys(R.current))
      if (k.includes(_)) {
        const c1 = R.current[_];
        if (!c1) continue;
        P = Dl(
          P,
          `uniform ${c1.type} ${_}${c1.arraySize || ""}; 
`,
          P.lastIndexOf(L) + L.length
        ), c1.isNeeded = !0;
      }
    return k.includes("mainImage") && (P = P.concat(Vl)), P;
  }, i1 = (k) => {
    const y = m.current;
    if (!y || !w.current) return;
    const L = A.current ? (k - A.current) / 1e3 : 0;
    A.current = k;
    const P = E.current;
    if (P)
      for (const N of Object.keys(P)) {
        const _ = P[N];
        if (_ && R.current[N]?.isNeeded) {
          if (!w.current) return;
          const c1 = y.getUniformLocation(
            w.current,
            N
          );
          if (!c1) return;
    ...
    if (R.current.iMouse?.isNeeded) {
      ...
      y.uniform4fv(N, R.current.iMouse.value);
    }
    ...
    if (R.current.iDate?.isNeeded) {
      const N = /* @__PURE__ */ new Date(), _ = N.getMonth() + 1, c1 = N.getDate(), h1 = N.getFullYear(), v1 = N.getHours() * 60 * 60 + N.getMinutes() * 60 + N.getSeconds() + N.getMilliseconds() * 1e-3, b1 = y.getUniformLocation(
        w.current,
        De
      );
      y.uniform4fv(b1, [h1, _, c1, v1]);
    }
    if (R.current.iFrame?.isNeeded) {
      ...
      y.uniform1i(N, _), R.current.iFrame.value = _ + 1;
    }
    if (T.current.length > 0)
      for (let N = 0; N < T.current.length; N++) {
        const _ = T.current[N];
        if (!_) return;
        const { isVideo: c1, _webglTexture: h1, source: v1, flipY: b1, isLoaded: s1 } = _;
        if (!s1 || !h1 || !v1) return;
        if (R.current[`iChannel${N}`]?.isNeeded) {
          if (!w.current) return;
          const V1 = y.getUniformLocation(
            w.current,
            `iChannel${N}`
          );
          y.activeTexture(y.TEXTURE0 + N), y.bindTexture(y.TEXTURE_2D, h1), y.uniform1i(V1, N), c1 && _.updateTexture(
            h1,
            v1,
            b1
          );
    ...
    y.viewport(0, 0, y.drawingBufferWidth, y.drawingBufferHeight), y.clear(y.COLOR_BUFFER_BIT | y.DEPTH_BUFFER_BIT), y.bindBuffer(y.ARRAY_BUFFER, v.current), y.vertexAttribPointer(
      ...
      0,
      0
    ), i1(k), y.drawArrays(y.TRIANGLE_STRIP, 0, 4);
    const L = R.current.iMouse?.value;
    if (R.current.iMouse?.isNeeded && l !== 1 && Array.isArray(L)) {
      const P = L[0] ?? 0, N = L[1] ?? 0;
      L[0] = Ye(P, V.current[0] ?? 0, l), L[1] = Ye(N, V.current[1] ?? 0, l);
    }
    j.current = requestAnimationFrame(x1);
  }, r1 = () => {
    const k = { passive: !0 };
    R.current.iMouse?.isNeeded && C.current && (C.current.addEventListener("mousemove", t1, k), C.current.addEventListener("mouseout", Y, k), C.current.addEventListener("mouseup", Y, k), C.current.addEventListener("mousedown", e1, k), C.current.addEventListener("touchmove", t1, k), C.current.addEventListener("touchend", Y, k), C.current.addEventListener("touchstart", e1, k)), R.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      G,
      k
    ), C.current && ($.current = new ResizeObserver(X), $.current.observe(C.current), window.addEventListener("resize", X, k));
  }, d1 = () => {
    const k = { passive: !0 };
    R.current.iMouse?.isNeeded && C.current && (C.current.removeEventListener("mousemove", t1, k), C.current.removeEventListener("mouseout", Y, k), C.current.removeEventListener("mouseup", Y, k), C.current.removeEventListener("mousedown", e1, k), C.current.removeEventListener("touchmove", t1, k), C.current.removeEventListener("touchend", Y, k), C.current.removeEventListener("touchstart", e1, k)), R.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      G,
      k
    ), $.current && ($.current.disconnect(), window.removeEventListener("resize", X, k));
  };
  return q(() => {
    E.current = n;
  }, [n]), q(() => {
    ...
    function y() {
      U();
      const L = m.current;
      L && C.current && (L.clearColor(...s), L.clearDepth(1), L.enable(L.DEPTH_TEST), L.depthFunc(L.LEQUAL), L.viewport(0, 0, C.current.width, C.current.height), C.current.height = C.current.clientHeight, C.current.width = C.current.clientWidth, O(), n1(), D(u1(e || Sl), r || Ie), Z(), requestAnimationFrame(x1), r1(), X());
    }
    return requestAnimationFrame(y), () => {
      const L = m.current;
      if (L) {
        if (L.getExtension("WEBGL_lose_context")?.loseContext(), L.useProgram(null), L.deleteProgram(w.current ?? null), k.length > 0)
          for (const P of k)
            L.deleteTexture(P._webglTexture);
        w.current = null;
      }
      d1(), cancelAnimationFrame(j.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
}`, Ol = 10, Ul = 2, zl = 0.5, Gl = 0.2, Wl = 1.5, g1 = {
  duration: 0.5,
  ease: "easeOut"
}, Ke = {
  duration: 0.35,
...
function ql(e, r) {
  const [o, n] = B(Ol), {
    ...
    animate: i,
    motionValue: c
  } = U1(Gl), { value: d, animate: l } = U1(Ul), { value: u, animate: f } = U1(zl), { value: g, animate: p } = U1(Wl), C = cs(r, {
    fftSize: 512,
  ...
  return q(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, g1), l(1.2, g1), f(0.4, g1), p(1, g1);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, g1), f(0.7, g1), p([1.5, 2], Ke);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, g1), l(0.5, g1), f(1, g1), p([0.5, 2.5], Ke);
        return;
      case "speaking":
        n(70), i(0.3, g1), l(0.75, g1), f(1.25, g1), p(1.5, g1);
        return;
    }
  }, [
    e,
    ...
    e === "speaking" && C > 0 && !c.isAnimating() && i(0.2 + 0.2 * C, { duration: 0 });
  }, [
    e,
    C,
    c,
...
function J4({
  ...
  const { speed: u, scale: f, amplitude: g, frequency: p, brightness: C } = ql(r, s);
  return /* @__PURE__ */ t(
    pr,
    {
      ref: d,
...
const e6 = ({
  ...
  const n = W(), s = L1();
  return /* @__PURE__ */ a(F1, { children: [
    e && /* @__PURE__ */ t("span", { className: x(Ql(), "truncate"), children: e }),
  ...
  return /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ t("span", { className: x(mr()), children: r }),
    /* @__PURE__ */ a(
      J.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ a("div", { className: "flex items-center gap-1", children: [
            ...
            o && /* @__PURE__ */ t("span", { className: x(z1()), children: o })
          ] }),
          n === "people" && /* @__PURE__ */ t(
            On,
            {
          ...
          n === "alert" && /* @__PURE__ */ t(zn, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ t(t4, { balance: e.balance })
        ]
      }
    ),
    o && !e4.has(n) && /* @__PURE__ */ t(
      J.span,
      {
        className: x(z1()),
        animate: { opacity: s ? 0 : 1 },
...
const n4 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), s4 = ({
  label: e,
  direction: r
}) => {
  const o = vr[r];
  ...
  const s = `sparkline-gradient-${tt().replace(/:/g, "")}`, i = o4(e, o), c = vr[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(Wn, { width: "100%", height: "100%", children: /* @__PURE__ */ a(
          qn,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(Xn, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                Yn,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(s4, { label: r, direction: i })
      ]
    }
  ) });
}, wr = h(
  (e, r) => {
    const {
      ...
      className: l,
      ...u
    } = e, [f, g] = B(!1), [p, C] = B(!1), m = f || p, v = L1(), w = m && !!d, b = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, j = () => {
      c?.();
    }, H = (F) => {
      F.currentTarget === F.target && (F.key === "Enter" || F.key === " ") && (F.preventDefault(), c?.());
    };
    return /* @__PURE__ */ a("div", { className: "relative", children: [
      i && /* @__PURE__ */ a(F1, { children: [
        /* @__PURE__ */ t(
          "div",
          {
        ...
        "div",
        {
          ...
          children: [
            ...
            u.content === "sparkline" ? /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ t("span", { className: x(mr()), children: n }),
              /* @__PURE__ */ t(
                J.div,
                {
...
const a4 = ["className"], xr = h((e, r) => {
  const o = a4.reduce((n, s) => {
    const { [s]: i, ...c } = n;
    return c;
  }, e);
  return /* @__PURE__ */ t(wr, { ref: r, ...o });
});
...
const c4 = () => /* @__PURE__ */ a(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ t(m1, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ a("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ t(m1, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ t(m1, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ t(m1, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ t(m1, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], kr = 180, l4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : kr, d4 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, f4 = (e) => e.showActions !== !1, u4 = (e) => Object.fromEntries(
...
function h4(e) {
  const {
    ...
    description: i,
    seeMoreLabel: c,
    maxCollapsedDescriptionLength: d = kr
  } = e, [l, u] = B(!1), f = tt(), g = I(null), p = l4(
    d
  ), C = i.length > p, m = l ? i : d4(i, p), v = f4(e) ? e : null, w = u4(e);
  return q(() => {
    l && g.current?.focus();
  }, [l]), /* @__PURE__ */ a(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          r && /* @__PURE__ */ t(kt, { module: r, size: "md" }),
...
h4.displayName = "F0AiProposalCard";
const C4 = ({
  icon: e,
  title: r,
  children: o
  ...
  return /* @__PURE__ */ a(
    bt,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ a(yt, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, g4 = (e) => v2[e] ?? lt, p4 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(a1, { icon: g4(e), size: "md", color: "default" }) }) : null;
function m4({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(C4, { icon: ae, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
function w4({
  ...
  const n = W(), s = I(null), i = r ?? n.ai.aiTable.title, c = z(
    (d) => {
      if (!s.current) return;
  ...
  return e.columns?.length ? /* @__PURE__ */ a(
    ee,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(ee, { overflowX: "auto", children: /* @__PURE__ */ a(
          "table",
          {
            ref: s,
            className: x(
            ...
            children: [
              ...
              /* @__PURE__ */ t("tbody", { children: e.rows.map((d, l) => /* @__PURE__ */ t("tr", { children: e.columns.map((u) => {
                const f = d[u];
                return /* @__PURE__ */ t(
                  "td",
                  {
                    className: "max-w-72 border-0 border-b border-solid border-f1-border-secondary px-3 py-2 text-f1-foreground",
                    children: /* @__PURE__ */ t(l1, { children: f == null ? "" : String(f) })
                  },
                  u
                );
              }) }, l)) })
...
w4.displayName = "F0AiTableCard";
function x4({ credits: e }) {
  const r = W(), [o, n] = B(!1), [s, i] = B(!1), [c, d] = B(!1), [l, u] = B(null), f = z(
    (C) => {
      n(C), C && e?.fetchUsage && (i(!0), d(!1), e.fetchUsage().then((m) => {
        u(m), d(!1);
      }).catch(() => {
        d(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const g = l ? Math.min(100, Math.round(l.used / l.total * 100)) : 0, p = e.companyName;
  return /* @__PURE__ */ a(le, { open: o, onOpenChange: f, children: [
    /* @__PURE__ */ t(de, { asChild: !0, children: /* @__PURE__ */ t(
      f1,
      {
        variant: "ghost",
        hideLabel: !0,
        label: r.t("ai.credits.title"),
        icon: ce,
        pressed: o
      }
    ) }),
    /* @__PURE__ */ a(
      fe,
      {
        ...
        children: [
          p && /* @__PURE__ */ a("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            /* @__PURE__ */ t(
              he,
              {
                name: e.companyName ?? "",
          ...
          /* @__PURE__ */ a("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: [
            /* @__PURE__ */ a("div", { className: "flex flex-col gap-2 p-3", children: [
              ...
              c && /* @__PURE__ */ t("span", { className: "text-sm text-f1-foreground-secondary", children: r.t("ai.credits.creditsError") }),
              !s && !c && l && /* @__PURE__ */ a(F1, { children: [
                /* @__PURE__ */ a("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ t("span", { className: "text-base font-medium text-f1-foreground", children: r.t("ai.credits.title") }),
                  /* @__PURE__ */ t("span", { className: "font-medium text-f1-foreground-secondary", children: r.t("ai.credits.creditsLeft", {
                    total: Math.max(
                      0,
                      l.total - l.used
                    ).toLocaleString()
                ...
                /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5", children: [
                  ...
                  /* @__PURE__ */ t("span", { className: "text-sm tabular-nums text-f1-foreground-secondary", children: r.t("ai.credits.monthlyCredits") })
                ] })
              ] })
            ] }),
            e.upgradePlanUrl && /* @__PURE__ */ a("div", { className: "flex items-center justify-between border-0 border-t border-solid border-f1-border-secondary p-3", children: [
              /* @__PURE__ */ t("span", { children: r.t("ai.credits.needMoreCredits") }),
              /* @__PURE__ */ t(
                p1,
                {
                  variant: "outlinePromote",
                  href: e.upgradePlanUrl,
                  label: r.t("ai.credits.upgradePlan"),
                  icon: mt
                }
              )
            ] })
...
const k4 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function L4({
  employeeCredits: e
}) {
  const r = W(), o = L1(), [n, s] = B(!1), [i, c] = B(!1), [d, l] = B(!1), [u, f] = B(null), g = z(
    (v) => {
      s(v), v && e?.fetchUsage && (c(!0), l(!1), e.fetchUsage().then((w) => {
        f(w), l(!1);
      }).catch(() => {
        l(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const p = !!e.companyName, C = u && u.total > 0 ? Math.min(100, Math.round(u.used / u.total * 100)) : 0, m = u ? Math.max(0, u.total - u.used) : 0;
  return /* @__PURE__ */ a(le, { open: n, onOpenChange: g, children: [
    /* @__PURE__ */ t(de, { asChild: !0, children: /* @__PURE__ */ t(
      f1,
      {
        variant: "ghost",
      ...
      fe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ t("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2 p-3", children: [
            ...
            d && /* @__PURE__ */ t("span", { className: "text-sm text-f1-foreground-secondary", children: r.t("ai.credits.creditsError") }),
            !i && !d && u && /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ a("div", { className: "flex justify-between", children: [
                /* @__PURE__ */ t("span", { className: "text-base font-medium text-f1-foreground", children: r.t("ai.credits.employeeCredits") }),
                /* @__PURE__ */ t("span", { className: "font-medium text-f1-foreground-secondary", children: r.t("ai.credits.creditsLeft", {
...
const Qe = ({
  credits: e,
  employeeCredits: r
}) => r ? /* @__PURE__ */ t(L4, { employeeCredits: r }) : e ? /* @__PURE__ */ t(x4, { credits: e }) : null, o6 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const p = W(), C = Jn(`(max-width: ${es.md}px)`, {
    ...
    f1,
    {
      variant: "ghost",
      hideLabel: !0,
      label: n ? p.ai.collapseChat : p.ai.expandChat,
      icon: n ? ut : dt,
      onClick: i
    }
  ), v = /* @__PURE__ */ t(
        ...
        /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ t(
          H1,
          {
            ...
            children: /* @__PURE__ */ a("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ t(l1, { lines: 1, className: "min-w-0 text-left", children: o ?? p.ai.newConversation }),
              /* @__PURE__ */ t(a1, { icon: ie, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ a(
  ...
  ) : /* @__PURE__ */ a("header", { className: x("flex justify-between px-4 py-3"), children: [
...
function y4(e) {
  ...
  return Rt(r) ? "today" : Ft(r) ? "yesterday" : ts(r, o) ? "thisMonth" : "older";
}
function M4(e, r) {
  const o = new Date(e), n = b4(), s = Me(o, "p", { locale: n });
  if (Rt(o)) return `${r.today}, ${s}`;
  if (Ft(o)) return `${r.yesterday}, ${s}`;
  const i = !rs(o, /* @__PURE__ */ new Date());
  return `${Me(o, i ? "MMM d yyyy" : "MMM d", {
    locale: n
  })}, ${s}`;
}
function E4(e) {
...
function R4({
  ...
  const c = W(), d = Q(
    () => [
      {
        label: r ? c.ai.unpinChat : c.ai.pinChat,
        icon: Ht,
        onClick: () => r ? s(e.id) : n(e.id)
      },
      {
        label: c.ai.deleteChat,
        icon: at,
        critical: !0,
        onClick: () => i(e.id)
      }
    ...
    [e.updatedAt, c.ai.today, c.ai.yesterday]
  );
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      tabIndex: 0,
      onKeyDown: (u) => {
        (u.key === "Enter" || u.key === " ") && (u.preventDefault(), o(e.id, e.title));
      },
      children: [
        /* @__PURE__ */ a(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ t(l1, { lines: 1, className: "text-left font-medium", children: e.title }),
              /* @__PURE__ */ t("span", { className: "shrink-0 font-medium text-f1-foreground-tertiary", children: `- ${l}` })
            ]
          }
        ),
        /* @__PURE__ */ t(
          "div",
          {
            ...
            children: /* @__PURE__ */ t(ue, { items: d, children: /* @__PURE__ */ t(
              p1,
              {
                icon: ct,
                variant: "ghost",
                size: "md",
                label: c.ai.threadOptions,
                hideLabel: !0
              }
            ) })
          }
...
function F4() {
  return /* @__PURE__ */ t("div", { className: "flex flex-col gap-2 py-3", children: Array.from({ length: 5 }).map((e, r) => /* @__PURE__ */ a(
    "div",
    {
      className: "flex items-center justify-between gap-3 rounded-lg px-3 py-2",
      children: [
        /* @__PURE__ */ t("div", { className: "h-5 w-full animate-pulse rounded bg-f1-background-secondary" }),
        /* @__PURE__ */ t("div", { className: "h-5 w-6 animate-pulse rounded bg-f1-background-secondary" })
      ]
    },
    r
  )) });
...
const n6 = ({
  ...
  const C = Q(
    ...
    return n.filter((T) => T.title.toLowerCase().includes(V));
  }, [n, g]), v = Q(
    () => m.filter((V) => c.has(V.id)),
    [m, c]
  ), w = Q(
    () => m.filter((V) => !c.has(V.id)),
    [m, c]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ t(a1, { icon: ae, color: "secondary", size: "md" }),
                  /* @__PURE__ */ t(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ t(
                    H1,
                    {
                      ...
                      children: /* @__PURE__ */ a("div", { className: "flex w-full items-center gap-2", children: [
                        ...
                        /* @__PURE__ */ t(l1, { lines: 1, className: "text-left", children: f.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ t(F4, {}),
                  !s && i && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: i }),
                  !s && !i && !M && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: f.ai.noPreviousChats }),
...
function s6({
  ...
  const [n, s] = B([]), [i, c] = B(!1), [d, l] = B(null), [u, f] = B(N4), g = z(async () => {
    c(!0), l(null);
    try {
      const v = await r();
      s(v);
  ...
  const p = z((v) => {
    f((w) => {
      const b = new Set(w);
      return b.add(v), re(b), b;
    });
  }, []), C = z((v) => {
    f((w) => {
      const b = new Set(w);
      return b.delete(v), re(b), b;
    });
  }, []), m = z(
    async (v) => {
      try {
        await o(v), s((w) => w.filter((b) => b.id !== v)), f((w) => {
          if (!w.has(v)) return w;
          const b = new Set(w);
          return b.delete(v), re(b), b;
        });
...
const V4 = J.create(is), S4 = ({
  ...
  const { t: i } = W(), c = L1(), d = o ?? i("ai.applyingChanges");
  return q(() => {
    if (!r) return;
    const l = document.activeElement;
    l && l.getAttribute("name") !== "one-ai-input" && l.blur();
  }, [r]), /* @__PURE__ */ a("div", { className: x("relative flex flex-1 flex-col", n), children: [

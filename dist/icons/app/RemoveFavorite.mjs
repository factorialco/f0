...
// src/icons/app/RemoveFavorite.tsx
...
var ForwardRef = forwardRef(SvgRemoveFavorite);
var RemoveFavorite_default = ForwardRef;

export { RemoveFavorite_default as default };

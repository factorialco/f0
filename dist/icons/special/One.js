...
const o = [
  ...
  const r = d.className?.includes("text-") && !d.className?.includes("text-current") || d.style?.color !== void 0, a = s();
  return /* @__PURE__ */ l(
    "svg",
    {
      viewBox: "0 0 24 24",
      ...
      ...d,
      children: [
        /* @__PURE__ */ i("defs", { children: o.map((t) => /* @__PURE__ */ i("clipPath", { id: `${a}-${t.id}`, children: /* @__PURE__ */ i("path", { d: t.path }) }, t.id)) }),
        r ? o.map((t) => /* @__PURE__ */ i(
          "path",
          {
            d: t.path,
            fill: "currentColor",

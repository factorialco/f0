...
import { useInsertionEffect as Nr, forwardRef as h, useRef as B, useEffect as q, useLayoutEffect as et, useState as A, useMemo as J, useCallback as U, createContext as G1, useContext as B1, useId as tt, createElement as Vr, memo as Sr } from "react";
import { cn as Hr, co as Tr, _ as rt, cp as Ar, cq as $r, cr as Br, cs as Ir, ct as Pr, cu as ot, cv as jr, cw as Dr, a5 as se, cx as Zr, aJ as _r, cy as Or, cz as Ur, cA as zr, ag as Gr, cB as Wr, bR as qr, a9 as nt, ac as Xr, cC as Yr, b9 as ie, J as st, K as W1, cD as it, be as Kr, cE as Qr, cF as Jr, b2 as eo, bQ as to, a0 as F1, au as ro, bi as at, cG as oo, bO as no, cH as M1, bK as so, cI as io, cJ as ao, b1 as ct, cK as co, cL as lo, cM as fo, cN as uo, cO as ho, cP as lt, bC as Co, bD as go, cQ as po, cR as mo, cS as vo, cT as wo, cU as xo, cV as ko, cW as Lo, cX as bo, cY as yo, cZ as Mo, c_ as Eo, c$ as Ro, d0 as Fo, d1 as No, bP as Vo, aa as So, by as Ho, d2 as To, d3 as Ao, d4 as $o, d5 as Bo, d6 as Io, d7 as Po, d8 as jo, ap as Do, d9 as dt, O as Zo, a1 as _o, da as ft, db as ut, dc as Oo, bh as Uo, bg as zo, dd as Go, de as Wo, df as ht, dg as qo, b0 as Xo, ay as Yo, dh as Ko, as as Qo, b7 as Jo, di as Ct, b6 as en, dj as tn, bj as ae, dk as rn, dl as on, dm as ce, bM as nn, bL as sn, bN as gt, dn as an, G as cn, E as ln, dp as dn, dq as fn, dr as un, ds as hn, dt as Cn, du as pt, dv as gn, ab as pn, dw as mn, L as d1, o as x, q as H1, bs as vn, u as G, dx as wn, V as v1, ck as mt, H as a1, v as h1, a2 as xn, U as p1, dy as kn, ad as c1, aP as L1, A as E1, p as e1, bW as vt, aD as le, dz as Ln, aE as de, aF as fe, b as y1, dA as bn, dB as yn, bG as Mn, W as En, a$ as Rn, a4 as ue, dC as Fn, dD as Nn, dE as Vn, dF as ye, a3 as Sn, ak as wt, aS as xt, dG as Hn, c2 as Tn, dH as An, dI as $n, aX as kt, dJ as Bn, bY as In, dK as Pn, aU as $1, b8 as Lt, dL as bt, ba as yt, c as oe, dM as Mt, dN as jn, dO as Dn, bn as Zn, dP as _n, bd as he, bz as On, dQ as Un, dR as zn, dS as Gn, dT as Wn, dU as qn, a7 as Xn, ae as Yn, y as Kn, z as Qn, dV as Et, dW as Rt, dX as Jn, aj as Me, dY as es, ai as ts, dZ as rs, d_ as os, d as ns } from "./F0CanvasPanel-BEzGEeY6.js";
import { createPortal as Ft } from "react-dom";
import { defaultTranslations as ss } from "./i18n-provider-defaults.js";
import { useTrackVolume as is } from "@livekit/components-react";
function as(e, r, o) {
  Nr(() => e.on(r, o), [e, r, o]);
}
const cs = (e, r) => /* @__PURE__ */ a(
  "svg",
  {
...
const V0 = (e, r) => /* @__PURE__ */ a(
...
), g2 = h(C2), p2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: ls,
  Add: Hr,
  Ai: fs,
  ...
  Calculator: Wr,
  Calendar: qr,
  CalendarArrowDown: Is,
  CalendarArrowLeft: js,
  CalendarArrowRight: Zs,
  CameraPlus: Os,
  CardPin: zs,
  ChartFunnel: Ws,
  ChartHorizontalBars: Xs,
  ChartLine: Ks,
  ChartPie: Js,
  ChartVerticalBars: ti,
  Check: nt,
  CheckCircle: Xr,
  CheckCircleLine: oi,
  CheckDouble: Yr,
  ...
  FaceNeutral: mo,
  FacePositive: vo,
  FaceSuperNegative: wo,
  FaceSuperPositive: xo,
  Feed: Zi,
  File: Oi,
  FileFilled: zi,
  FileSigned: Wi,
  ...
  Wifi: g2,
  Windows: mn
}, Symbol.toStringTag, { value: "Module" })), m2 = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const B2 = H1({
  ...
  ({
    ...
    borderRight: s1,
    borderRadius: u1,
    borderRadiusTopLeft: C1,
    borderRadiusTopRight: r1,
    borderRadiusBottomLeft: l1,
    borderRadiusBottomRight: w1,
    borderStyle: k,
    // Overflow
    overflow: M,
    overflowX: L,
    ...
    const P1 = D && D !== "none" || W && W !== "none" || K && K !== "none" || s1 && s1 !== "none", S1 = Y && Y !== "none" || P1, j1 = { sm: x1, md: X1, lg: Y1, xl: K1 }, D1 = I2.map((Z1) => {
      const _1 = j1[Z1];
      return _1 ? $2(Z1, _1) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
...
const ee = vn(
  ...
  "div",
  {
    ...
    children: e.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ t(v1, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ t(
        D2,
        {
          att: s,
          onRemove: o,
...
function D2({
  ...
  return e.errorMessage ? /* @__PURE__ */ t(xn, { label: e.errorMessage, children: n }) : n;
}
const Z2 = {
  soft: {
    text: "",
...
function O2({
  ...
  return !e || u ? null : /* @__PURE__ */ t(
    "div",
    {
      ...
      children: c ? Array.from({ length: 3 }, (f, g) => /* @__PURE__ */ a(
        "div",
        {
          className: "flex items-center gap-2 p-2",
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ t(v1, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ t(
              v1,
              {
...
const U2 = ({
  ...
  const s = L1(), [i, l] = A(""), [d, c] = A(0), [u, f] = A(!1), g = B(null), p = B(null), C = B(null), m = e[d] ?? r;
  return q(() => {
    const v = () => {
    ...
    if (s)
      return f(!1), l(m), v(), g.current = setTimeout(() => {
    ...
    f(!0), l("");
    let w = 0;
    const b = 50, P = 30, H = 2e3, V = 1e3;
    return p.current = setInterval(() => {
      w < m.length ? (l(m.slice(0, w + 1)), w++) : (p.current && (clearInterval(p.current), p.current = null), g.current = setTimeout(() => {
        C.current = setInterval(() => {
          w > 0 ? (w--, l(m.slice(0, w))) : (C.current && (clearInterval(C.current), C.current = null), g.current = setTimeout(() => {
            const E = (d + 1) % Math.max(e.length, 1);
            c(E);
          }, V));
        }, P);
...
`) ? o + "_" : o
  ...
  cards: e,
  onCardSelect: r
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, W2).map((o) => /* @__PURE__ */ t(
  vt,
  {
    avatar: { type: "icon", icon: o.icon },
    title: o.title,
    description: o.description,
    onClick: () => r?.(o.id, o.message)
  },
  o.id
)) }), X2 = 5;
function Y2(e, r = X2) {
...
const K2 = ({
  ...
  const [s, i] = A(null), l = s !== null ? e[s] : null;
  return e.length === 0 ? null : /* @__PURE__ */ a(
    le,
    {
      ...
      children: [
        /* @__PURE__ */ t(Ln, { asChild: !0, children: /* @__PURE__ */ t("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, c) => /* @__PURE__ */ t(de, { asChild: !0, children: /* @__PURE__ */ t(
          d1,
          {
            variant: "outline",
            label: d.label,
          ...
          fe,
          {
            ...
            children: [
              /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ t(a1, { icon: l.icon, size: "sm" }),
                /* @__PURE__ */ t("span", { children: l.label })
              ] }),
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: Y2(l.items).map((d, c) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
const tc = 4e3;
function rc(e) {
  const [r, o] = A([]), [n, s] = A(null), i = B(
    null
  ), l = B(null), d = G(), c = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, g = J(() => {
    if (u)
      return Array.isArray(u) ? u.join(",") : u;
  }, [u]), p = f !== void 0 && r.length >= f, C = B(0);
  q(() => {
    C.current = r.length;
  }, [r]);
  const m = U((H) => {
  ...
  const v = U(
    async (H) => {
      ...
      const I = (N) => o(
        (j) => j.map(
          (y) => F.includes(y.id) ? { ...y, status: "error", errorMessage: N } : y
        )
      );
      try {
        const N = await c(V);
        if (!Array.isArray(N) || N.length !== V.length) {
          I(d.ai.fileUploadError);
          return;
        }
        o(
          (j) => j.map((y) => {
            const R = E.findIndex((T) => T.id === y.id);
            return R === -1 ? y : N[R] ? {
              ...y,
              status: "uploaded",
              uploadedFile: N[R]
        ...
        const j = N instanceof Error && N.message ? N.message : d.ai.fileUploadError;
        I(j);
      }
    },
    [
...
function ac({
  ...
  const [i, l] = A(!1), [d, c] = A(""), [u, f] = A([]), [g, p] = A(!1), [C, m] = A(0), [v, w] = A([]), b = B(-1), P = B(null), H = B(0), V = B(-1);
  q(() => {
    if (!n) {
      l(!1);
      return;
    ...
    const R = oc(e, o, v);
    if (!R) {
      l(!1), c(""), f([]), m(0), b.current = -1, V.current = -1;
      return;
    }
    if (R.atIndex === V.current)
      return;
    b.current = R.atIndex, c(R.query), l(!0), m(0), p(!0), P.current && clearTimeout(P.current);
    const T = ++H.current;
    return P.current = setTimeout(() => {
      n(R.query).then((O) => {
        T === H.current && (f(O), m(0), O.length === 0 && R.query.length > 0 && (V.current = R.atIndex, l(!1)));
      }).catch(() => {
        T === H.current && f([]);
      }).finally(() => {
        T === H.current && p(!1);
  ...
  const E = U(() => {
    l(!1), c(""), f([]), m(0), b.current = -1;
  }, []), F = U(
    (R) => {
      const T = b.current;
      if (T === -1) return;
      const O = `${R.firstName} ${R.lastName}`.trim(), _ = String(R.id), z = e.slice(0, T), t1 = e.slice(o), o1 = `@${O} `, X = z + o1 + t1, Y = z.length + o1.length;
      r(X), w((D) => [...D.filter((K) => !(K.id === _ && K.name === O)), { id: _, name: O }]), E(), requestAnimationFrame(() => {
        const D = s.current;
    ...
    (R) => {
      if (!i) return !1;
      if (R.key === "Escape")
        return R.preventDefault(), E(), !0;
      if (u.length === 0) return !1;
      switch (R.key) {
        case "ArrowDown":
          return R.preventDefault(), m((T) => (T + 1) % u.length), !0;
        case "ArrowUp":
          return R.preventDefault(), m(
            (T) => (T + u.length - 1) % u.length
          ), !0;
        case "Tab": {
          const T = u[C];
          if (T) {
            const O = `${T.firstName} ${T.lastName}`.trim();
            if (d.length === 0 || O.toLowerCase().startsWith(d.toLowerCase()))
              return R.preventDefault(), F(T), !0;
          }
          return !1;
        }
        case "Enter":
          return R.preventDefault(), u[C] && F(u[C]), !0;
        default:
          return !1;
      }
    },
    ...
    (R) => {
      ...
      let T = R;
      const O = [...v].sort((_, z) => z.name.length - _.name.length);
      for (const _ of O) {
        const z = `@${_.name}`, t1 = `<entity-ref type="person" id="${Ee(_.id)}">${Ee(_.name)}</entity-ref>`;
        for (; T.includes(z); )
          T = T.replace(z, t1);
      }
      return T;
  ...
  q(() => {
    w(
      (R) => R.filter((T) => {
        const O = `@${T.name}`, _ = e.indexOf(O);
        if (_ === -1) return !1;
        const z = e[_ + O.length];
        return z === " " || z === `
` || z === "	";
      })
    );
  ...
  const j = J(() => {
    ...
    const R = s.current;
    if (!R) return null;
    const T = sc(R, b.current), O = R.offsetLeft + T.left, z = (R.offsetParent ? R.offsetParent.offsetHeight : 0) - (R.offsetTop + T.top);
    return { left: O, bottom: z };
  }, [i, e, o, s]), y = J(() => {
    if (!i || u.length === 0) return null;
    const R = u[C];
    if (!R) return null;
    const T = `${R.firstName} ${R.lastName}`.trim();
    return d.length === 0 ? T : T.toLowerCase().startsWith(d.toLowerCase()) ? T.slice(d.length) : null;
  }, [i, u, C, d]);
  return {
    isOpen: i,
    query: d,
...
const cc = /[\\`*_{}[\]()#+\-.!|~>]/g, lc = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(cc, "\\$&")).join(""), j6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const N = G(), j = L1(), [y, R] = A(""), [T, O] = A(0), [_, z] = A(!1), [t1, o1] = A(!1), [X, Y] = A(null), D = B(null), W = B(null), K = B(null), s1 = l != null, { tracking: u1 } = y1(), C1 = U(
    (Q, k1) => {
      u1?.onWelcomeSuggestionClick?.({
        item: Q,
        group: k1,
    ...
    const k1 = N1.current, J1 = k1 && !/\s$/.test(k1) ? " " : "", O1 = `${k1}${J1}${Q}`;
    R(O1), O(O1.length);
  }, []), q1 = {
    ...
    onPartial: V1,
    onFinal: (Q) => {
      V1(Q), W.current?.focus();
    },
    onError: (Q) => m1(q1[Q])
  }), X1 = !!p && x1.isSupported, Y1 = U(() => {
    u1?.onDictationStart?.(), N1.current = y, x1.start();
  }, [y, x1, u1]), K1 = U(() => {
    u1?.onDictationCancel?.(), x1.cancel();
  }, [x1, u1]);
  q(() => {
  ...
  const I1 = x1.status === "recording", Q1 = I1 ? N.ai.listening : N.ai.inputPlaceholder, P1 = r1.filter((Q) => Q.status === "uploaded"), S1 = r1.some((Q) => Q.status === "uploading"), j1 = r1.some((Q) => Q.status === "error"), D1 = y.trim().length > 0;
  q(() => {
    if (!(!t1 || S1)) {
      if (o1(!1), j1) {
        m1(N.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const Z1 = async (Q) => {
    if (Q.preventDefault(), !s1) {
      if (n1.close(), o)
        ...
        const k1 = n1.transformMentions(y.trim()), J1 = lc(k1), O1 = P1.flatMap(
          (be) => be.uploadedFile ? [be.uploadedFile] : []
        ), ke = d, Le = u;
        ke && c?.(null), Le && f?.(null), await e({
          text: J1,
          files: O1,
          context: ke,
          quote: Le
    ...
    s1 || n1.handleKeyDown(Q) || Q.key === "Enter" && !Q.shiftKey && (Q.preventDefault(), o || D.current?.requestSubmit());
  }, Lr = () => {
    O(W.current?.selectionStart ?? 0);
  }, br = () => {
    K.current && W.current && (K.current.scrollTop = W.current.scrollTop);
  }, me = X ? X.prompt ?? X.title : null, ve = I1 ? [N.ai.listening] : me ? [me] : s ?? [], yr = ve.length > 1, Mr = J(() => Q2(y, n1.mentions, {
    cursorPosition: T,
    inlineCompletion: n1.inlineCompletion
  }), [y, n1.mentions, T, n1.inlineCompletion]), Er = n1.mentions.length > 0 || n1.inlineCompletion !== null, we = b && !!H && H.length > 0 && !!V ? /* @__PURE__ */ t(
    K2,
    {
      suggestions: H,
      onItemClick: C1,
  ...
  ) : null, Rr = b && P && !!E && E.length > 0, xe = P && b, { motionProps: Fr } = yn(
    b,
    160,
    0.5
  );
  return /* @__PURE__ */ a(
    e1.div,
    {
      ...
      children: [
          ...
          /* @__PURE__ */ t(_2, { creditWarning: i, children: /* @__PURE__ */ a(
            e1.form,
            {
              ...
              className: x(
                ...
                s1 && "after:scale-100 after:opacity-100 border-f1-background-tertiary"
              ),
              animate: {
                ...
                /* @__PURE__ */ t(E1, { initial: !1, children: s1 ? /* @__PURE__ */ t(
                  ...
                  e1.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ t(E1, { initial: !1, children: f1 && /* @__PURE__ */ t(
                        e1.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ a(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ t("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ t(Mn, { type: "critical", size: "sm" }) }),
        ...
        Rr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(
          q2,
          {
            cards: E,
            onCardSelect: F
        ...
        w && b && P && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: w }),
        /* @__PURE__ */ t(E1, { mode: "wait", initial: !1, children: s1 ? /* @__PURE__ */ a(
          e1.div,
          {
...
function gc({
  ...
  return /* @__PURE__ */ t(Rn, { ...r, variant: "link", href: r.href, children: e });
}
function pc({
  children: e,
  ...r
...
function T1({
  ...
  const i = B(/* @__PURE__ */ new Map()), [l, d] = A(
    () => i.current.get(e) ?? null
  ), [c, u] = A(!1), [f, g] = A(!1), p = B(!0);
  q(() => () => {
    p.current = !1;
  }, []);
  const C = U(() => {
  ...
  return /* @__PURE__ */ a(
    Fn,
    {
      ...
      children: [
        /* @__PURE__ */ t(Nn, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          Vn,
          {
            side: "top",
            ...
            children: c ? /* @__PURE__ */ t(ye.Skeleton, {}) : /* @__PURE__ */ t(ye, { ...m })
          }
        )
      ]
    }
...
function Nc({
  ...
  const { entityRefs: o } = y1(), n = o?.resolvers?.candidate, s = G(), i = o?.urls?.candidate?.(e), l = J(
    () => (c) => {
      const u = [];
...
function Vc({ id: e, label: r }) {
  const { entityRefs: o } = y1(), n = o?.resolvers?.expense, s = G(), i = o?.urls?.expense?.(e), l = J(
    () => (c) => ({
      avatar: {
        type: "icon",
        icon: Vt
...
function Sc({
  ...
  const { entityRefs: o } = y1(), n = o?.resolvers?.jobPosting, s = G(), i = o?.urls?.jobPosting?.(e), l = J(
    () => (c) => ({
      title: c.title,
...
function Tc({
  ...
  const { entityRefs: o } = y1(), n = o?.resolvers?.requisition, s = G(), i = o?.urls?.requisition?.(e), l = J(
    () => (c) => {
...
function Ac({ id: e, label: r }) {
  const { entityRefs: o } = y1(), n = o?.resolvers?.person, s = G(), i = o?.urls?.person?.(e), l = J(
    () => (c) => ({
      avatar: {
        type: "person",
        firstName: c.firstName,
...
function $c({ id: e, label: r }) {
  const { entityRefs: o } = y1(), n = o?.resolvers?.vacancy, s = G(), i = o?.urls?.vacancy?.(e), l = J(
    () => (c) => ({
      title: c.name,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ t(Hn, { file: e.file, size: "lg" }),
...
function jc(e) {
  const o = B1(pe)?.formatters;
  return J(() => !o || o.length === 0 ? null : (n, s, i) => {
    let l, d = -1;
    for (const c of o) {
...
const Re = 7, Dc = 625, Fe = /* @__PURE__ */ new Set();
function Zc(e) {
...
function Oc(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = An(e), i = [];
...
function nr(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: Oc(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? Zc(o) : "") || "—" };
  }
  ...
  return { type: "item", text: _c(String(e)) };
}
function sr({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = y1(), g = jc(e), p = d ?? g, C = B(() => {
  }), m = n ?? e, v = s ?? r ?? "", w = c?.type === "form" && c.formName === e, b = () => u({
    type: "form",
    title: m,
    description: v,
    formName: e,
  ...
  C.current = b, q(() => {
    typeof window > "u" || window.innerWidth < Dc || Fe.has(e) || (Fe.add(e), C.current());
  }, [e]);
  const P = i && l ? Object.entries(i).map(([E, F]) => {
    const I = l[E], N = p?.(E, I, {
      fieldType: F.fieldType,
      customFieldName: F.customFieldName
    });
    if (!N && F.fieldType === "custom" && typeof I == "object" && I !== null)
      return null;
    const j = N ?? nr(I, F.fieldType), y = ["richtext", "textarea"];
    return {
      label: F.label,
      content: j,
      verticalLayout: y.includes(F.fieldType ?? "")
    };
  }).filter((E) => {
    if (!E) return !1;
    const F = Array.isArray(E.content) ? E.content[0] : E.content;
    return !(F?.type === "item" && F.text === "—");
  }) : [], H = P.slice(0, Re), V = P.length > Re;
  return /* @__PURE__ */ t(
    or,
    {
...
function ar({ anchor: e, onReply: r }) {
  ...
  if (et(() => {
    ...
    p < A1 && (p = e.rect.bottom + He), p = Math.min(
      Math.max(p, A1),
      g - u - A1
    );
    const C = e.rect.left + e.rect.width / 2 - c / 2, m = Math.min(
      Math.max(C, A1),
      f - c - A1
    );
    i({ top: p, left: m });
...
const cr = G1(void 0), O6 = () => B1(cr), Wc = (e) => /* @__PURE__ */ t(kt, { content: e, format: "markdown" }), qc = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, g = B(null), { anchor: p, clear: C } = ir({
    containerRef: g,
    enabled: !!(o?.id && d)
  });
  return q(() => {
  ...
  const [s, i] = A(""), l = G(), { title: d, label: c, placeholder: u } = o === "like" ? l.ai.feedbackModal.positive : l.ai.feedbackModal.negative, f = U(() => {
    r(n, s);
  }, [s, n, r]), g = () => {
    e(n);
  };
...
const Qc = ({
  ...
  const n = G(), { open: s } = dr(), [i, l] = A(null);
  ...
  const [d, c] = A(s), u = L1(), f = n !== void 0, g = f ? n : d;
  return /* @__PURE__ */ a(
    Lt,
    {
...
const fr = (e) => /* @__PURE__ */ t(kt, { content: e, format: "markdown" }), o4 = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = r4(
    e?.content,
    l
  ), c = (t4(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: g, clear: p } = ir({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(o4, { text: u, renderMarkdown: n }),
...
}, s4 = 35, i4 = 22, a4 = 400, c4 = 2500, l4 = 220, d4 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  const [n, s] = A(0), [i, l] = A(0), [d, c] = A("starting"), u = e[n] ?? "";
  q(() => {
    e.length > 0 && n >= e.length && (s(0), l(0), c("starting"));
  }, [e.length, n]), q(() => {
    let p;
    if (d === "starting")
      p = setTimeout(() => c("writing"), a4);
    else if (d === "writing")
      i < u.length ? p = setTimeout(() => l((C) => C + 1), s4) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), c4);
    } else d === "erasing" && (i > 0 ? p = setTimeout(() => l((C) => C - 1), i4) : p = setTimeout(() => {
...
function f4({
  ...
  const [l, d] = A(0), [c, u] = A(!1), f = B(s), g = B(i);
  g.current = i;
  const p = U(
    (m = "smooth") => {
  ...
  const C = U(() => {
    const m = e.current;
    if (!m) return;
    const { scrollTop: v, scrollHeight: w, clientHeight: b } = m, P = w - v - b;
    u(P > b);
  }, [e]);
  return q(() => {
    const m = e.current;
    ...
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!m || !v) return;
        const w = m.getBoundingClientRect(), b = v.getBoundingClientRect(), P = m.scrollTop + (b.top - w.top);
...
const u4 = {
...
}, U6 = (e) => /* @__PURE__ */ t(Yc, { children: /* @__PURE__ */ t(h4, { ...e }) }), h4 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: H, handleSubmit: V, handleClose: E } = Kc(
    f ?? u4
  ), F = G(), I = v ?? qc, N = w ?? n4, j = J(() => {
    const D = n ?? F.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((K) => typeof K == "string" && K.length > 0);
  }, [n, F.ai.defaultInitialMessage]), y = !r && e.length === 0 && j.length > 0, R = B(null), T = B(null), O = B(null), _ = B(null), z = B(null), { showScrollBtn: t1, turnMinHeight: o1, scrollToBottom: X } = f4({
    viewportRef: R,
    contentRef: T,
    endRef: O,
    lastTurnRef: z,
    ...
    const K = W === e.length - 1, s1 = {
      ...
      const w1 = K && l1 === D.assistantMessages.length - 1, k = D.userMessages.length + l1, M = {
        message: r1,
        inProgress: D.isInProgress,
        index: k,
        isCurrentMessage: w1,
      ...
      return /* @__PURE__ */ t(
        ...
        {
          ...M,
          isGenerating: D.isInProgress && w1,
          isLoading: D.isInProgress && w1 && !r1.content
        },
        `${W}-a-${l1}`
      );
    };
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        children: [
          ...
          D.endIndicator === "thinking" && /* @__PURE__ */ t(oe, { title: F.ai.thinking, status: "executing" }),
          D.endIndicator === "activity" && /* @__PURE__ */ t(oe, { status: "writing" }),
          D.feedback && /* @__PURE__ */ t(
            Qc,
            {
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a(
                  ...
                  {
                    className: x(
                      y ? "flex flex-1" : "flex flex-col gap-6",
                ...
                /* @__PURE__ */ t("footer", { className: "copilotKitMessagesFooter", ref: O, children: m }),
...
}, C4 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ t("div", { className: "flex justify-end", children: /* @__PURE__ */ t(v1, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ t(v1, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ t(v1, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ t(v1, { className: "h-5 w-4/5 rounded-md" })
] }) }), z6 = {
  ai: ss.ai
}, ur = G1(null);
function G6({
...
const v4 = ({
  ...
  const b = L1(), P = (() => {
    ...
    const I = o.findIndex((N) => n.includes(N.id));
    return I >= 0 ? I : 0;
  })(), [H, V] = A(P), E = B([]);
  q(() => {
    g && e === "single" && E.current[H]?.focus();
  }, []);
  const F = (I) => {
    if (e !== "single") return;
    const N = o.length - 1;
    ...
    I.preventDefault(), V(j), E.current[j]?.focus();
  };
  return /* @__PURE__ */ a(
    "div",
    {
          ...
          e1.div,
          {
            ...
            children: /* @__PURE__ */ t(
              Cr,
              {
                ...
                option: I,
                isSelected: n.includes(I.id),
                mode: e,
                isTabStop: e === "single" ? N === H : void 0,
                onToggle: p,
                onKeyNavigate: F
              }
            )
  ...
  const o = G(), n = L1(), {
    ...
    allowCustomAnswer: V,
    customAnswerText: E,
    isCustomAnswerActive: F
  } = s, I = B(null), N = P ?? "single", j = l > 1, y = i === 0, R = i === l - 1, T = j ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(l)
  }) : void 0, O = b.length > 0, _ = (E ?? "").trim().length > 0, z = O || F && _ || H === !0, t1 = r === !0 && R, o1 = () => {
    t1 || c();
  }, X = () => {
    t1 || u();
  }, Y = (C1) => {
    const r1 = N === "single" && b.includes(C1);
    d(C1), N === "single" && !R && !r1 && Promise.resolve().then(c);
  }, D = R ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, W = H === !0 && !O && !(F && _), K = () => {
    m(), requestAnimationFrame(() => {
      I.current?.focus();
    });
  }, s1 = (C1) => {
    C1.key === "Escape" && (C1.preventDefault(), f());
  }, u1 = n ? 0 : k4 / 2;
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: s1, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(E1, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      e1.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: u1, ease: x4 },
        children: [
          /* @__PURE__ */ t(
            w4,
            {
...
function Ae(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (K) => K / e * 2 - 1, g = (K) => K / r * 2 - 1, p = 0, C = e, m = 0, v = r, w = c, b = e - c, P = u, H = r - u, V = f(p), E = f(C), F = g(m), I = g(v), N = f(w), j = f(b), y = g(P), R = g(H), T = 0, O = 0, _ = 1, z = 1, t1 = c / e, o1 = 1 - c / e, X = u / r, Y = 1 - u / r, D = new Float32Array([
    // Top strip
    V,
    F,
    E,
...
class Y6 {
  ...
  resize(r, o, n) {
    ...
    const { gl: s, program: i, vao: l, positionBuffer: d, uvBuffer: c, uResolution: u } = this.glr, f = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, g = Math.max(1, Math.floor(r * f)), p = Math.max(1, Math.floor(o * f));
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: l, uvs: d } = Ae(
      s,
      i,
    ...
    const p = r.getUniformLocation(o, "uResolution"), C = r.getUniformLocation(o, "uTime"), m = r.getUniformLocation(o, "uBorderWidth"), v = r.getUniformLocation(o, "uGlowWidth"), w = r.getUniformLocation(o, "uBorderRadius"), b = r.getUniformLocation(o, "uColors"), P = r.getUniformLocation(o, "uGlowExponent"), H = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(m, this.options.borderWidth), r.uniform1f(v, this.options.glowWidth), r.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(P, 2), r.uniform1f(H, 1.8)) : (r.uniform1f(P, 1), r.uniform1f(H, 1));
    const V = (this.options.colors || E4).map(R4);
...
const Be = ["lowp", "mediump", "highp"], F4 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, N4 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, Pe = "iTime", je = "iTimeDelta", De = "iDate", Ze = "iFrame", _e = "iMouse", Oe = "iResolution", V4 = "iChannel", Ue = "iChannelResolution", ze = "iDeviceOrientation";
function S4(e, r) {
...
}, te = 9729, Ge = 9728, B4 = 9987, We = 33071, qe = 10497;
class I4 {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    const g = 0, p = o.RGBA, C = 1, m = 1, v = 0, w = o.RGBA, b = o.UNSIGNED_BYTE, P = new Uint8Array([255, 255, 255, 0]), H = o.createTexture();
    if (o.bindTexture(o.TEXTURE_2D, H), o.texImage2D(
      ...
      const I = this.setupVideo(n);
      return o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.LINEAR), this._webglTexture = H, this.source = I, this.isVideo = !0, I.play().then(() => this);
    }
    async function V() {
      return new Promise((I, N) => {
        ...
        j.crossOrigin = "anonymous", j.onload = () => {
          ...
          N(new Error(b1(`failed loading url: ${n}`)));
        }, j.src = n ?? "";
      });
    }
    let E = await V(), F = (E.width & E.width - 1) === 0 && (E.height & E.height - 1) === 0;
    return (r.wrapS !== We || r.wrapT !== We || r.minFilter !== Ge && r.minFilter !== te) && !F && (E = this.makePowerOf2(E), F = !0), o.bindTexture(o.TEXTURE_2D, H), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, c), o.texImage2D(
      o.TEXTURE_2D,
      g,
      p,
      w,
      b,
      E
    ), F && r.minFilter !== Ge && r.minFilter !== te && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || qe
    ), o.texParameteri(
...
const b1 = (e) => `react-shaders: ${e}`, Xe = (e) => {
  if ("changedTouches" in e) {
    const r = e.changedTouches[0];
    return [r?.clientX ?? 0, r?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, Ye = (e, r, o) => e * (1 - o) + r * o, P4 = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function j4({
  fs: e,
  vs: r = Ie,
  textures: o = [],
  ...
  const C = B(null), m = B(null), v = B(null), w = B(null), b = B(void 0), P = B(void 0), H = B(!1), V = B(void 0), E = B(0), F = B([0, 0]), I = B([]), N = B(0), j = B(void 0), y = B({
    ...
    const L = "width" in k ? k.width ?? 0 : 0, $ = "height" in k ? k.height ?? 0 : 0, S = y.current.iChannelResolution;
    if (!S) return;
    const Z = Array.isArray(S.value) ? S.value : S.value = [];
    Z[M * 3] = L * u, Z[M * 3 + 1] = $ * u, Z[M * 3 + 2] = 0;
  }, O = () => {
    ...
    y.current.iDeviceOrientation.value = [
      k ?? 0,
      M ?? 0,
      L ?? 0,
    ...
    const [M = 0, L = 0] = Xe(k), $ = M - (V.current?.left ?? 0) - window.pageXOffset, S = (V.current?.height ?? 0) - L - (V.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    const Z = Array.isArray(y.current.iMouse?.value) ? y.current.iMouse.value : void 0;
    Z && (Z[2] = $, Z[3] = S), F.current[0] = $, F.current[1] = S;
  }, o1 = (k) => {
    V.current = C.current?.getBoundingClientRect();
    const [M = 0, L = 0] = Xe(k), $ = M - (V.current?.left ?? 0), S = (V.current?.height ?? 0) - L - (V.current?.top ?? 0);
    if (c !== 1)
      F.current[0] = $, F.current[1] = S;
    else {
      const Z = Array.isArray(y.current.iMouse?.value) ? y.current.iMouse.value : void 0;
      Z && (Z[0] = $, Z[1] = S);
    }
  }, X = () => {
    const k = Array.isArray(y.current.iMouse?.value) ? y.current.iMouse.value : void 0;
    k && (k[2] = 0, k[3] = 0);
  }, Y = () => {
    const k = m.current;
    if (!k) return;
    V.current = C.current?.getBoundingClientRect();
    const M = u, L = Math.floor(
      (V.current?.width ?? 1) * M
    ), $ = Math.floor(
      (V.current?.height ?? 1) * M
    );
    if (k.canvas.width = L, k.canvas.height = $, y.current.iResolution?.isNeeded && w.current) {
    ...
    const L = m.current;
    if (!L) return null;
    const $ = L.createShader(k);
    if (!$) return null;
    if (L.shaderSource($, M), L.compileShader($), !L.getShaderParameter($, L.COMPILE_STATUS)) {
      p?.(b1(`Error compiling the shader:
${M}`));
      const S = L.getShaderInfoLog($);
      L.deleteShader($), g?.(b1(`Shader compiler log: ${S}`));
    }
    return $;
  }, W = (k, M) => {
    const L = m.current;
    if (!L) return;
    const $ = D(L.FRAGMENT_SHADER, k), S = D(L.VERTEX_SHADER, M);
    if (w.current = L.createProgram(), !(!w.current || !S || !$)) {
      if (L.attachShader(w.current, S), L.attachShader(w.current, $), L.linkProgram(w.current), !L.getProgramParameter(w.current, L.LINK_STATUS)) {
        g?.(
          b1(
    ...
    if (n)
      for (const k of Object.keys(n)) {
        const M = n[k];
        if (!M) continue;
        const { value: L, type: $ } = M, S = $4($);
        if (!S) continue;
        const Z = {};
        if (S4($, L)) {
          const i1 = $.length, f1 = Number.parseInt($.charAt(i1 - 3)), m1 = Math.floor(L.length / (f1 * f1));
          L.length > f1 * f1 && (Z.arraySize = `[${m1}]`);
        } else H4($, L) && (Z.arraySize = `[${Math.floor(L.length / Number.parseInt($.charAt(0)))}]`);
        y.current[k] = {
          type: S,
          isNeeded: !1,
          value: L,
      ...
      if (o && o.length > 0) {
        ...
        const M = o.map(
          (L, $) => (y.current[`${V4}${$}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, T(L, $), I.current[$] = new I4(k), I.current[$]?.load(L).then((S) => {
            T(S, $);
          }))
        );
        Promise.all(M).then(() => {
    ...
    const M = Be.includes(i ?? "highp"), L = `precision ${M ? i : Be[1]} float;
`;
    M || p?.(
      b1(
    ...
    let $ = L.concat(`#define DPR ${u.toFixed(1)}
`).concat(k.replace(/texture\(/g, "texture2D("));
    for (const Z of Object.keys(y.current))
      if (k.includes(Z)) {
        const i1 = y.current[Z];
        if (!i1) continue;
        $ = P4(
          $,
          `uniform ${i1.type} ${Z}${i1.arraySize || ""}; 
`,
          $.lastIndexOf(L) + L.length
        ), i1.isNeeded = !0;
      }
    return k.includes("mainImage") && ($ = $.concat(F4)), $;
  }, C1 = (k) => {
    const M = m.current;
    if (!M || !w.current) return;
    const L = N.current ? (k - N.current) / 1e3 : 0;
    N.current = k;
    const $ = R.current;
    if ($)
      for (const S of Object.keys($)) {
        const Z = $[S];
        if (Z && y.current[S]?.isNeeded) {
          if (!w.current) return;
    ...
    if (y.current.iMouse?.isNeeded) {
      const S = M.getUniformLocation(
        w.current,
        _e
      );
      M.uniform4fv(S, y.current.iMouse.value);
    }
    if (y.current.iChannelResolution?.isNeeded) {
      const S = M.getUniformLocation(
        w.current,
        Ue
      );
      M.uniform3fv(
        S,
        y.current.iChannelResolution.value
      );
    }
    if (y.current.iDeviceOrientation?.isNeeded) {
      const S = M.getUniformLocation(
        w.current,
        ze
      );
    ...
    if (y.current.iTime?.isNeeded) {
      const S = M.getUniformLocation(
        w.current,
        Pe
      );
      M.uniform1f(S, E.current += L);
    }
    if (y.current.iTimeDelta?.isNeeded) {
      const S = M.getUniformLocation(
        w.current,
        je
      );
    ...
    if (y.current.iDate?.isNeeded) {
      const S = /* @__PURE__ */ new Date(), Z = S.getMonth() + 1, i1 = S.getDate(), f1 = S.getFullYear(), m1 = S.getHours() * 60 * 60 + S.getMinutes() * 60 + S.getSeconds() + S.getMilliseconds() * 1e-3, n1 = M.getUniformLocation(
        w.current,
        De
      );
      M.uniform4fv(n1, [f1, Z, i1, m1]);
    }
    if (y.current.iFrame?.isNeeded) {
      const S = M.getUniformLocation(
        w.current,
        Ze
      ), Z = y.current.iFrame.value;
      M.uniform1i(S, Z), y.current.iFrame.value = Z + 1;
    }
    if (I.current.length > 0)
      for (let S = 0; S < I.current.length; S++) {
        const Z = I.current[S];
        if (!Z) return;
        const { isVideo: i1, _webglTexture: f1, source: m1, flipY: n1, isLoaded: N1 } = Z;
        if (!N1 || !f1 || !m1) return;
        if (y.current[`iChannel${S}`]?.isNeeded) {
          if (!w.current) return;
          const V1 = M.getUniformLocation(
            w.current,
            `iChannel${S}`
          );
          M.activeTexture(M.TEXTURE0 + S), M.bindTexture(M.TEXTURE_2D, f1), M.uniform1i(V1, S), i1 && Z.updateTexture(
            f1,
            m1,
            n1
          );
    ...
    M.viewport(0, 0, M.drawingBufferWidth, M.drawingBufferHeight), M.clear(M.COLOR_BUFFER_BIT | M.DEPTH_BUFFER_BIT), M.bindBuffer(M.ARRAY_BUFFER, v.current), M.vertexAttribPointer(
      ...
      0,
      0
    ), C1(k), M.drawArrays(M.TRIANGLE_STRIP, 0, 4);
    const L = y.current.iMouse?.value;
    if (y.current.iMouse?.isNeeded && c !== 1 && Array.isArray(L)) {
      const $ = L[0] ?? 0, S = L[1] ?? 0;
      L[0] = Ye($, F.current[0] ?? 0, c), L[1] = Ye(S, F.current[1] ?? 0, c);
    }
    P.current = requestAnimationFrame(r1);
  }, l1 = () => {
    const k = { passive: !0 };
    y.current.iMouse?.isNeeded && C.current && (C.current.addEventListener("mousemove", o1, k), C.current.addEventListener("mouseout", X, k), C.current.addEventListener("mouseup", X, k), C.current.addEventListener("mousedown", t1, k), C.current.addEventListener("touchmove", o1, k), C.current.addEventListener("touchend", X, k), C.current.addEventListener("touchstart", t1, k)), y.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      z,
      k
    ), C.current && (j.current = new ResizeObserver(Y), j.current.observe(C.current), window.addEventListener("resize", Y, k));
  }, w1 = () => {
    const k = { passive: !0 };
    y.current.iMouse?.isNeeded && C.current && (C.current.removeEventListener("mousemove", o1, k), C.current.removeEventListener("mouseout", X, k), C.current.removeEventListener("mouseup", X, k), C.current.removeEventListener("mousedown", t1, k), C.current.removeEventListener("touchmove", o1, k), C.current.removeEventListener("touchend", X, k), C.current.removeEventListener("touchstart", t1, k)), y.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      z,
      k
    ), j.current && (j.current.disconnect(), window.removeEventListener("resize", Y, k));
  };
  return q(() => {
    R.current = n;
  }, [n]), q(() => {
    ...
    function M() {
      O();
      const L = m.current;
      L && C.current && (L.clearColor(...s), L.clearDepth(1), L.enable(L.DEPTH_TEST), L.depthFunc(L.LEQUAL), L.viewport(0, 0, C.current.width, C.current.height), C.current.height = C.current.clientHeight, C.current.width = C.current.clientWidth, K(), s1(), W(u1(e || N4), r || Ie), _(), requestAnimationFrame(r1), l1(), Y());
    }
    return requestAnimationFrame(M), () => {
      ...
      if (L) {
        if (L.getExtension("WEBGL_lose_context")?.loseContext(), L.useProgram(null), L.deleteProgram(w.current ?? null), k.length > 0)
          for (const $ of k)
            L.deleteTexture($._webglTexture);
        w.current = null;
      }
      w1(), cancelAnimationFrame(P.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
}`, Z4 = 10, _4 = 2, O4 = 0.5, U4 = 0.2, z4 = 1.5, g1 = {
  duration: 0.5,
  ease: "easeOut"
}, Ke = {
  duration: 0.35,
...
function G4(e, r) {
  const [o, n] = A(Z4), {
    ...
    animate: i,
    motionValue: l
  } = U1(U4), { value: d, animate: c } = U1(_4), { value: u, animate: f } = U1(O4), { value: g, animate: p } = U1(z4), C = is(r, {
    fftSize: 512,
  ...
  return q(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, g1), c(1.2, g1), f(0.4, g1), p(1, g1);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, g1), f(0.7, g1), p([1.5, 2], Ke);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, g1), c(0.5, g1), f(1, g1), p([0.5, 2.5], Ke);
        return;
      case "speaking":
        n(70), i(0.3, g1), c(0.75, g1), f(1.25, g1), p(1.5, g1);
        return;
    }
  }, [
    e,
    ...
    e === "speaking" && C > 0 && !l.isAnimating() && i(0.2 + 0.2 * C, { duration: 0 });
  }, [
    e,
    C,
    l,
...
function K6({
  ...
  const { speed: u, scale: f, amplitude: g, frequency: p, brightness: C } = G4(r, s);
  return /* @__PURE__ */ t(
    gr,
    {
      ref: d,
...
const Q6 = ({
  ...
  const n = G(), s = L1();
  return /* @__PURE__ */ a(R1, { children: [
    e && /* @__PURE__ */ t("span", { className: x(Y4(), "truncate"), children: e }),
    ...
    /* @__PURE__ */ a(
      e1.div,
      {
        ...
        children: [
          ...
          n === "alert" && /* @__PURE__ */ t(On, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ t(J4, { balance: e.balance })
        ]
      }
    ),
    o && !Q4.has(n) && /* @__PURE__ */ t(
      e1.span,
      {
        className: x(z1()),
        animate: { opacity: s ? 0 : 1 },
...
const r6 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), o6 = ({
  label: e,
  direction: r
}) => {
  const o = mr[r];
  ...
  const s = `sparkline-gradient-${tt().replace(/:/g, "")}`, i = t6(e, o), l = mr[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(zn, { width: "100%", height: "100%", children: /* @__PURE__ */ a(
          Gn,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(Wn, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                qn,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(o6, { label: r, direction: i })
      ]
    }
  ) });
}, vr = h(
  (e, r) => {
    const {
      ...
      className: c,
      ...u
    } = e, [f, g] = A(!1), [p, C] = A(!1), m = f || p, v = L1(), w = m && !!d, b = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, P = () => {
      l?.();
...
const s6 = ["className"], wr = h((e, r) => {
  const o = s6.reduce((n, s) => {
    const { [s]: i, ...l } = n;
    return l;
  }, e);
...
const i6 = () => /* @__PURE__ */ a(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ t(v1, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ a("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ t(v1, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ t(v1, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ t(v1, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ t(v1, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], xr = 180, a6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : xr, c6 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, l6 = (e) => e.showActions !== !1, d6 = (e) => Object.fromEntries(
...
function f6(e) {
  ...
  } = e, [c, u] = A(!1), f = tt(), g = B(null), p = a6(
    d
  ), C = i.length > p, m = c ? i : c6(i, p), v = l6(e) ? e : null, w = d6(e);
  return q(() => {
    c && g.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
...
f6.displayName = "F0AiProposalCard";
const u6 = ({
  icon: e,
  title: r,
  children: o
...
}, h6 = (e) => p2[e] ?? lt, C6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(a1, { icon: h6(e), size: "md", color: "default" }) }) : null;
function g6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(u6, { icon: ae, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
g6.displayName = "F0AiMessageSources";
async function p6(e, r, o) {
  const n = await import("./xlsx-Bedf3nwD.js"), s = n.utils.table_to_book(e, { sheet: "Data" });
  n.writeFile(s, `${o}.${r}`);
}
function m6({
  ...
  const n = G(), s = B(null), i = r ?? n.ai.aiTable.title, l = U(
    (d) => {
      if (!s.current) return;
...
m6.displayName = "F0AiTableCard";
function v6({ credits: e }) {
  const r = G(), [o, n] = A(!1), [s, i] = A(!1), [l, d] = A(!1), [c, u] = A(null), f = U(
    (C) => {
  ...
  if (!e) return null;
  const g = c ? Math.min(100, Math.round(c.used / c.total * 100)) : 0, p = e.companyName;
        ...
        children: [
          ...
          /* @__PURE__ */ a("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: [
            /* @__PURE__ */ a("div", { className: "flex flex-col gap-2 p-3", children: [
              ...
              l && /* @__PURE__ */ t("span", { className: "text-sm text-f1-foreground-secondary", children: r.t("ai.credits.creditsError") }),
              !s && !l && c && /* @__PURE__ */ a(R1, { children: [
                /* @__PURE__ */ a("div", { className: "flex justify-between", children: [
...
const w6 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function x6({
  employeeCredits: e
}) {
  const r = G(), o = L1(), [n, s] = A(!1), [i, l] = A(!1), [d, c] = A(!1), [u, f] = A(null), g = U(
    (v) => {
      s(v), v && e?.fetchUsage && (l(!0), c(!1), e.fetchUsage().then((w) => {
        f(w), c(!1);
      }).catch(() => {
        c(!0);
      }).finally(() => {
...
const Qe = ({
  credits: e,
  employeeCredits: r
}) => r ? /* @__PURE__ */ t(x6, { employeeCredits: r }) : e ? /* @__PURE__ */ t(v6, { credits: e }) : null, tl = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const p = G(), C = Kn(`(max-width: ${Qn.md}px)`, {
...
function k6() {
  if (!(typeof navigator > "u"))
    return ts(navigator.language);
}
function L6(e) {
  const r = new Date(e), o = /* @__PURE__ */ new Date();
  return Et(r) ? "today" : Rt(r) ? "yesterday" : Jn(r, o) ? "thisMonth" : "older";
}
function b6(e, r) {
  const o = new Date(e), n = k6(), s = Me(o, "p", { locale: n });
  if (Et(o)) return `${r.today}, ${s}`;
  if (Rt(o)) return `${r.yesterday}, ${s}`;
  const i = !es(o, /* @__PURE__ */ new Date());
...
function M6({
  ...
  const l = G(), d = J(
    () => [
      {
        label: r ? l.ai.unpinChat : l.ai.pinChat,
        icon: St,
        onClick: () => r ? s(e.id) : n(e.id)
      },
      {
        label: l.ai.deleteChat,
        icon: at,
        critical: !0,
        onClick: () => i(e.id)
      }
    ...
    () => b6(e.updatedAt, {
      today: l.ai.today,
      yesterday: l.ai.yesterday
    }),
    [e.updatedAt, l.ai.today, l.ai.yesterday]
  );
  return /* @__PURE__ */ a(
    "div",
    {
        ...
        /* @__PURE__ */ a(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("span", { className: "shrink-0 font-medium text-f1-foreground-tertiary", children: `- ${c}` })
            ]
          }
        ),
        /* @__PURE__ */ t(
...
const rl = ({
  ...
  const C = J(
    ...
    return n.filter((I) => I.title.toLowerCase().includes(F));
  }, [n, g]), v = J(
    () => m.filter((F) => l.has(F.id)),
    [m, l]
  ), w = J(
    () => m.filter((F) => !l.has(F.id)),
    [m, l]
...
function ol({
  ...
  const [n, s] = A([]), [i, l] = A(!1), [d, c] = A(null), [u, f] = A(R6), g = U(async () => {
    l(!0), c(null);
    try {
      const v = await r();
      s(v);
...
const F6 = e1.create(ns), N6 = ({
  ...
  const { t: i } = G(), l = L1(), d = o ?? i("ai.applyingChanges");
  return q(() => {
    if (!r) return;

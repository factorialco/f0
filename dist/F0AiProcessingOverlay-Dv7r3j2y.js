...
import { useInsertionEffect as Sr, forwardRef as p, useRef as j, useEffect as q, useLayoutEffect as rt, useState as B, useMemo as Q, useCallback as _, createContext as ze, useContext as Be, useId as ot, createElement as Tr, memo as Hr } from "react";
import { c$ as Ar, d0 as $r, Z as nt, c3 as Br, d1 as Ir, d2 as Pr, d3 as jr, d4 as Dr, c7 as st, c2 as Zr, d5 as _r, a6 as s1, d6 as Or, aX as Ur, d7 as zr, d8 as Gr, d9 as Wr, aK as qr, ah as Xr, da as Yr, cw as Kr, aa as it, ad as Qr, db as Jr, bi as i1, a1 as at, S as Ge, bh as ct, bu as eo, dc as to, dd as ro, bg as oo, cv as no, $ as Fe, av as so, by as lt, de as io, ct as ao, c1 as Me, cp as co, df as lo, bZ as dt, bf as fo, dg as uo, dh as ho, di as po, dj as go, dk as Co, dl as ft, ci as mo, cj as vo, dm as wo, dn as xo, dp as ko, dq as Lo, dr as bo, bH as yo, c5 as Mo, ds as Eo, dt as Ro, du as Fo, aI as No, dv as Vo, dw as So, dx as To, dy as Ho, dz as Ao, bG as $o, cu as Bo, ab as Io, ce as Po, dA as jo, dB as Do, dC as Zo, dD as _o, dE as Oo, dF as Uo, dG as zo, aq as Go, aL as Wo, b$ as ut, M as qo, a0 as Xo, bV as ht, bY as Yo, b_ as pt, dH as Ko, bx as Qo, bw as Jo, dI as en, dJ as tn, bI as gt, bJ as rn, bK as on, be as nn, az as sn, dK as an, at as cn, bs as Ct, br as mt, bn as ln, dL as vt, bm as dn, c4 as a1, dM as fn, aT as c1, dN as un, dO as hn, aJ as pn, dP as l1, cr as gn, cq as Cn, cs as wt, dQ as mn, G as vn, E as wn, dR as xn, dS as kn, dT as Ln, dU as bn, bW as yn, dV as xt, dW as Mn, ac as En, dX as Rn, L as ce, o as k, q as Se, c8 as Fn, u as G, bU as Nn, U as he, bT as kt, H as le, v as pe, a2 as Vn, Q as Ce, dY as Sn, ae as ie, b1 as xe, A as Ee, p as J, cB as Lt, aE as d1, aS as Tn, aF as f1, aG as u1, b as be, bR as Hn, dZ as An, bS as $n, V as Bn, bd as In, a5 as h1, bL as Pn, bM as jn, bN as Dn, bO as y1, a3 as Zn, al as bt, b4 as yt, d_ as _n, cI as On, d$ as Un, e0 as zn, b9 as Mt, e1 as Gn, cC as Wn, e2 as qn, b6 as $e, bo as Et, e3 as Rt, bp as Ft, c as r1, c6 as M1, e4 as Nt, e5 as Xn, e6 as Yn, bC as Kn, e7 as Qn, bt as p1, cf as Jn, e8 as es, e9 as ts, ea as rs, eb as os, ec as ns, a8 as ss, af as is, y as as, z as cs, ak as E1, ed as Vt, ee as St, ef as ls, eg as ds, aj as fs, a7 as us, eh as hs, ei as ps, d as gs } from "./F0CanvasPanel-BPHV_hza.js";
import { createPortal as Tt } from "react-dom";
import { defaultTranslations as Cs } from "./i18n-provider-defaults.js";
import { useTrackVolume as ms } from "@livekit/components-react";
function vs(e, r, o) {
  Sr(() => e.on(r, o), [e, r, o]);
}
...
), ic = p(sc), ac = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: xs,
  Add: Ar,
  Ai: Ls,
...
const Rc = Se({
  ...
  ({
    ...
    const Ne = P && P !== "none" || oe && oe !== "none" || W && W !== "none" || ae && ae !== "none", Pe = X && X !== "none" || Ne, je = { sm: We, md: qe, lg: Xe, xl: Ie }, Qe = Fc.map((De) => {
      const Ze = je[De];
      return Ze ? Ec(De, Ze) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
...
function Ac({
  ...
  q(() => {
    ...
    if (!f || !g) return;
    const C = f.offsetLeft + f.offsetWidth - g.clientWidth;
  ...
  return !e || u ? null : /* @__PURE__ */ t(
    "div",
    {
      ...
      children: c ? Array.from({ length: 3 }, (f, g) => /* @__PURE__ */ a(
        ...
        const C = g === n, h = `${f.firstName} ${f.lastName}`.trim();
        return /* @__PURE__ */ a(
          "div",
          {
            ref: C ? d : void 0,
...
const $c = ({
  ...
  const s = xe(), [i, l] = B(""), [d, c] = B(0), [u, f] = B(!1), g = j(null), C = j(null), h = j(null), m = e[d] ?? r;
  return q(() => {
    const v = () => {
      C.current && (clearInterval(C.current), C.current = null), h.current && (clearInterval(h.current), h.current = null), g.current && (clearTimeout(g.current), g.current = null);
    };
    if (o.length > 0 || n) {
      f(!1), l(""), v();
      return;
    ...
    return C.current = setInterval(() => {
      x < m.length ? (l(m.slice(0, x + 1)), x++) : (C.current && (clearInterval(C.current), C.current = null), g.current = setTimeout(() => {
        h.current = setInterval(() => {
          x > 0 ? (x--, l(m.slice(0, x))) : (h.current && (clearInterval(h.current), h.current = null), g.current = setTimeout(() => {
            const E = (d + 1) % Math.max(e.length, 1);
            c(E);
          }, S));
        }, I);
...
`) ? o + "_" : o
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, Pc).map((r) => /* @__PURE__ */ t(
  Lt,
  {
...
const _c = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ a(
    d1,
    {
      ...
      children: [
        /* @__PURE__ */ t(Tn, { asChild: !0, children: /* @__PURE__ */ t("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, c) => /* @__PURE__ */ t(f1, { asChild: !0, children: /* @__PURE__ */ t(
          ce,
          {
            variant: "outline",
            label: d.label,
...
function Oc(e, r, o) {
  ...
  for (const f of r) {
    ...
    let C = 0;
    for (; ; ) {
      const h = e.indexOf(g, C);
      if (h === -1) break;
      i.push({ start: h, end: h + g.length }), C = h + g.length;
    }
  }
...
function Wc(e) {
  const [r, o] = B([]), [n, s] = B(null), i = j(
    null
  ), l = j(null), d = G(), c = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, g = Q(() => {
    if (u)
...
function Qc({
  ...
  const [i, l] = B(!1), [d, c] = B(""), [u, f] = B([]), [g, C] = B(!1), [h, m] = B(0), [v, x] = B([]), N = j(-1), I = j(null), H = j(0), S = j(-1);
  q(() => {
    if (!n) {
      l(!1);
      return;
...
` || z === "	";
  ...
  const A = Q(() => {
    ...
    const V = s.current;
    if (!V) return null;
    const $ = Yc(V, N.current), U = V.offsetLeft + $.left, z = (V.offsetParent ? V.offsetParent.offsetHeight : 0) - (V.offsetTop + $.top);
...
const Jc = /[\\`*_{}[\]()#+\-.!|~>]/g, e2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(Jc, "\\$&")).join(""), S6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const Qe = async (K) => {
    if (K.preventDefault(), !W) {
      if (ee.close(), o)
        ...
        const we = ee.transformMentions(A.trim()), Je = e2(we), _e = Ke.flatMap(
  ...
  }, m1 = re ? re.prompt ?? re.title : null, v1 = Ie ? [L.ai.listening] : m1 ? [m1] : s ?? [], Er = v1.length > 1, Rr = Q(() => Oc(A, ee.mentions, {
    cursorPosition: V,
  ...
  ) : null, Nr = N && I && !!E && E.length > 0, x1 = I && N, { motionProps: Vr } = An(
    N,
    160,
    0.5
  );
  return /* @__PURE__ */ a(
    J.div,
    {
      ...
      children: [
        ...
        Nr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(jc, { cards: E }) }),
...
function cr({
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = be(), g = V2(e), C = d ?? g, h = j(() => {
  ...
  h.current = N, q(() => {
    typeof window > "u" || window.innerWidth < S2 || N1.has(e) || (N1.add(e), h.current());
  }, [e]);
...
const fr = ze(void 0), $6 = () => Be(fr), P2 = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), j2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, g = j(null), { anchor: C, clear: h } = lr({
    containerRef: g,
    enabled: !!(o?.id && d)
  });
  return q(() => {
...
const O2 = ({
  ...
  const [d, c] = B(s), u = xe(), f = n !== void 0, g = f ? n : d;
  return /* @__PURE__ */ a(
    Et,
    {
  ...
  return /* @__PURE__ */ t(
    U2,
    {
      ...
      onOpenChange: l,
      lockOpen: o,
      children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pb-4", children: e.map((g, C) => /* @__PURE__ */ a("div", { className: "relative", children: [
        /* @__PURE__ */ t(
          r1,
          {
            title: g,
...
const pr = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), q2 = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = W2(
    e?.content,
    l
  ), c = (G2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: g, clear: C } = lr({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
  ...
  q(() => {
    ...
    let C;
    if (d === "starting")
      C = setTimeout(() => c("writing"), Q2);
    else if (d === "writing")
      i < u.length ? C = setTimeout(() => l((h) => h + 1), Y2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      C = setTimeout(() => c("erasing"), J2);
    } else d === "erasing" && (i > 0 ? C = setTimeout(() => l((h) => h - 1), K2) : C = setTimeout(() => {
...
function rl({
  ...
  const [l, d] = B(0), [c, u] = B(!1), f = j(s), g = j(i);
  g.current = i;
  const C = _(
    (m = "smooth") => {
...
const ol = {
...
}, B6 = (e) => /* @__PURE__ */ t(Z2, { children: /* @__PURE__ */ t(nl, { ...e }) }), nl = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: H, handleSubmit: S, handleClose: E } = _2(
    f ?? ol
  ), w = G(), L = v ?? j2, M = x ?? X2, A = Q(() => {
    const P = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(P) ? P : [P]).filter((W) => typeof W == "string" && W.length > 0);
  }, [n, w.ai.defaultInitialMessage]), F = !r && e.length === 0 && A.length > 0, V = j(null), $ = j(null), U = j(null), O = j(null), z = j(null), { showScrollBtn: te, turnMinHeight: re, scrollToBottom: Y } = rl({
    viewportRef: V,
    contentRef: $,
    endRef: U,
    lastTurnRef: z,
...
function P6({
  ...
  return /* @__PURE__ */ t(gr.Provider, { value: r, children: e });
}
function j6() {
  const e = Be(gr);
  if (e === null)
  ...
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: ae, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      J.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ke, ease: fl },
        children: [
          /* @__PURE__ */ t(
            dl,
            {
...
function A1(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (W) => W / e * 2 - 1, g = (W) => W / r * 2 - 1, C = 0, h = e, m = 0, v = r, x = c, N = e - c, I = u, H = r - u, S = f(C), E = f(h), w = g(m), L = g(v), M = f(x), A = f(N), F = g(I), V = g(H), $ = 0, U = 0, O = 1, z = 1, te = c / e, re = 1 - c / e, Y = u / r, X = 1 - u / r, P = new Float32Array([
    // Top strip
    S,
    w,
    E,
...
class _6 {
  ...
  resize(r, o, n) {
    ...
    const { gl: s, program: i, vao: l, positionBuffer: d, uvBuffer: c, uResolution: u } = this.glr, f = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, g = Math.max(1, Math.floor(r * f)), C = Math.max(1, Math.floor(o * f));
    this.canvas.style.width = `${r}px`, this.canvas.style.height = `${o}px`, (this.canvas.width !== g || this.canvas.height !== C) && (this.canvas.width = g, this.canvas.height = C), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
  ...
  setupGL() {
    ...
    const S = (this.options.colors || ml).map(vl);
...
}`, P1 = "iTime", j1 = "iTimeDelta", D1 = "iDate", Z1 = "iFrame", _1 = "iMouse", O1 = "iResolution", kl = "iChannel", U1 = "iChannelResolution", z1 = "iDeviceOrientation";
function Ll(e, r) {
...
}, t1 = 9729, G1 = 9728, Rl = 9987, W1 = 33071, q1 = 10497;
class Fl {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    const g = 0, C = o.RGBA, h = 1, m = 1, v = 0, x = o.RGBA, N = o.UNSIGNED_BYTE, I = new Uint8Array([255, 255, 255, 0]), H = o.createTexture();
...
${R}`));
      ...
      y.deleteShader(D), g?.(Le(`Shader compiler log: ${T}`));
    }
    return D;
  }, oe = (b, R) => {
    const y = m.current;
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (y, D) => (F.current[`${kl}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, $(y, D), L.current[D] = new Fl(b), L.current[D]?.load(y).then((T) => {
            $(T, D);
          }))
        );
        Promise.all(R).then(() => {
...
`,
    ...
    return b.includes("mainImage") && (D = D.concat(wl)), D;
  }, de = (b) => {
    const R = m.current;
  ...
  return q(() => {
    ...
    function R() {
      U();
      const y = m.current;
      y && h.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, W(), ae(), oe(ke(e || xl), r || I1), O(), requestAnimationFrame(ne), fe(), X());
    }
...
}`, Tl = 10, Hl = 2, Al = 0.5, $l = 0.2, Bl = 1.5, ge = {
  duration: 0.5,
  ease: "easeOut"
}, K1 = {
  duration: 0.35,
...
function Il(e, r) {
  const [o, n] = B(Tl), {
    ...
    animate: i,
    motionValue: l
  } = Oe($l), { value: d, animate: c } = Oe(Hl), { value: u, animate: f } = Oe(Al), { value: g, animate: C } = Oe(Bl), h = ms(r, {
    fftSize: 512,
  ...
  return q(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, ge), c(1.2, ge), f(0.4, ge), C(1, ge);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, ge), f(0.7, ge), C([1.5, 2], K1);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, ge), c(0.5, ge), f(1, ge), C([0.5, 2.5], K1);
        return;
      case "speaking":
        n(70), i(0.3, ge), c(0.75, ge), f(1.25, ge), C(1.5, ge);
        return;
    }
  }, [
    e,
...
function vr({
  ...
  const h = Q(() => jl(l), [l]);
  return /* @__PURE__ */ t("div", { ref: f, className: g, ...C, children: /* @__PURE__ */ t(
    Vl,
    {
      fs: Sl,
...
function O6({
  ...
  const { speed: u, scale: f, amplitude: g, frequency: C, brightness: h } = Il(r, s);
  return /* @__PURE__ */ t(
    vr,
    {
      ref: d,
    ...
    /* @__PURE__ */ a(
      J.div,
      {
        ...
        children: [
          ...
          n === "balance" && /* @__PURE__ */ t(Ul, { balance: e.balance })
        ]
      }
    ),
    o && !Ol.has(n) && /* @__PURE__ */ t(
      J.span,
      {
        className: k(Ue()),
        animate: { opacity: s ? 0 : 1 },
...
const Wl = ({
  ...
  const s = `sparkline-gradient-${ot().replace(/:/g, "")}`, i = Gl(e, o), l = xr[i];
  ...
  (e, r) => {
    const {
      ...
      className: c,
      ...u
    } = e, [f, g] = B(!1), [C, h] = B(!1), m = f || C, v = xe(), x = m && !!d, N = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, I = () => {
      l?.();
...
const Kl = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], br = 180, Ql = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : br, Jl = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, e6 = (e) => e.showActions !== !1, t6 = (e) => Object.fromEntries(
...
function r6(e) {
  ...
  } = e, [c, u] = B(!1), f = ot(), g = j(null), C = Ql(
    d
  ), h = i.length > C, m = c ? i : Jl(i, C), v = e6(e) ? e : null, x = t6(e);
  return q(() => {
    c && g.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
...
}, n6 = (e) => ac[e] ?? ft, s6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: n6(e), size: "md", color: "default" }) }) : null;
function i6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(o6, { icon: c1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const l = /* @__PURE__ */ t(s6, { iconName: s.icon });
...
function l6({ credits: e, trigger: r }) {
  const o = G(), [n, s] = B(!1), [i, l] = B(!1), [d, c] = B(!1), [u, f] = B(null), g = _(
    (m) => {
  ...
  return /* @__PURE__ */ a(d1, { open: n, onOpenChange: g, children: [
...
function f6({
  ...
  const o = G(), n = xe(), [s, i] = B(!1), [l, d] = B(!1), [c, u] = B(!1), [f, g] = B(null), C = _(
    (x) => {
...
const n1 = ({
...
) : e ? /* @__PURE__ */ t(l6, { credits: e, trigger: o }) : null, W6 = n1, q6 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const h = G(), m = as(`(max-width: ${cs.md}px)`, {
...
function h6(e) {
  ...
  return Vt(r) ? "today" : St(r) ? "yesterday" : ds(r, o) ? "thisMonth" : "older";
}
function p6(e, r) {
  const o = new Date(e), n = u6(), s = E1(o, "p", { locale: n });
                  ...
                  /* @__PURE__ */ t(
                    $e,
                    {
                      ...
                      children: /* @__PURE__ */ a("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ t(le, { icon: g1, color: "default", size: "md" }),
...
function Y6({
  ...
  const [i, l] = B([]), [d, c] = B(!1), [u, f] = B(null), [g, C] = B(w6), [h, m] = B(() => /* @__PURE__ */ new Set()), v = _(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);

...
import { useInsertionEffect as $n, forwardRef as C, createElement as _e, useRef as $, useMemo as re, useEffect as K, useState as P, useLayoutEffect as Ot, useCallback as X, createContext as a1, useContext as Ge, useId as Zt, memo as In } from "react";
import { cb as Pn, cc as jn, cd as Dn, ce as _n, cf as Ut, cg as On, ch as Zn, ci as Un, cj as zn, ck as Gn, cl as zt, cm as Wn, cn as qn, co as Xn, cp as Yn, cq as Kn, cr as Qn, cs as Jn, ct as r1, cu as eo, cv as to, cw as ro, cx as no, cy as oo, cz as so, W as Gt, cA as io, cB as ao, cC as co, cD as lo, cE as uo, cF as Wt, cG as fo, cH as ho, a3 as T1, cI as po, aG as go, cJ as mo, cK as Co, cL as vo, ad as wo, cM as xo, bJ as ko, a7 as A1, aa as bo, cN as Lo, b7 as H1, _ as qt, N as c1, cO as Xt, b6 as yo, cP as Mo, cQ as Eo, a$ as Ro, bI as No, Y as Ee, ar as Fo, bb as Yt, cR as So, bG as Kt, cS as Fe, bC as Vo, cT as To, cU as Qt, a_ as Jt, cV as Ao, cW as Ho, cX as Bo, cY as $o, cZ as Io, c_ as er, bu as Po, bv as jo, c$ as Do, d0 as _o, d1 as Oo, d2 as Zo, d3 as Uo, d4 as zo, d5 as Go, d6 as Wo, d7 as qo, d8 as Xo, d9 as Yo, da as Ko, db as Qo, bH as Jo, a8 as es, bq as ts, dc as rs, dd as ns, de as os, df as ss, dg as is, dh as as, di as cs, am as ls, dj as tr, J as ds, Z as us, dk as rr, dl as fs, ba as hs, b9 as ps, dm as gs, dn as nr, dp as ms, aZ as Cs, av as vs, dq as ws, ap as xs, b4 as ks, dr as or, b3 as bs, ds as Ls, bf as B1, dt as ys, du as $1, bE as Ms, bD as Es, bF as sr, dv as Rs, z as Ns, y as Fs, dw as Ss, dx as Vs, dy as Ts, dz as As, dA as Hs, dB as ir, dC as Bs, a9 as $s, dD as Is, H as he, o as Se, m as L, ab as fe, dE as Ps, bk as js, bx as Ds, w as ar, dF as _s, a2 as l1, bW as Os, aq as Zs, M as Ce, C as ce, a5 as cr, ac as lr, bl as dr, dG as Us, aY as ur, s as ve, dH as zs, dI as Gs, S as pe, u as J, c9 as fr, $ as Ws, dJ as qs, aM as Le, A as Me, n as te, aA as I1, dK as Xs, aB as P1, aC as j1, b as Re, dL as Ys, by as Ks, O as Qs, dM as Js, dN as ei, dO as ti, dP as Q1, a0 as ri, ah as hr, aP as pr, dQ as ni, bV as oi, dR as si, dS as ii, aU as gr, dT as ai, bP as ci, dU as li, aR as ze, bd as mr, dV as Cr, be as vr, dW as wr, dX as di, bh as ui, dY as fi, b5 as D1, br as hi, dZ as pi, d_ as gi, d$ as mi, e0 as Ci, e1 as vi, x as wi, e2 as xr, e3 as kr, e4 as xi, ag as J1, e5 as ki, af as bi, e6 as Li, e7 as yi, c as Mi } from "./F0CanvasPanel-Dj0jmiC3.js";
...
function Lr(e, t, n, o) {
  return typeof e == "string" && _1(t) ? Pn(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Fi(e, t, n) {
  return e * (t + 1);
}
...
function Ii(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let p = 0; p < e.length; p++) {
    ...
    let S = 0;
    const N = (R, E, y, V = 0, b = 0) => {
      const T = Pi(R), { delay: k = 0, times: M = On(T), type: A = "keyframes", repeat: j, repeatType: _, repeatDelay: Z = 0, ...G } = E;
      let { ease: q = t.ease || "easeOut", duration: U } = E;
      const z = typeof k == "function" ? k(V, b) : k, O = T.length, ee = zn(A) ? A : s?.[A];
      if (O <= 2 && ee) {
        let se = 100;
        if (O === 2 && _i(T)) {
          const ue = T[1] - T[0];
      ...
      const le = M.length - T.length;
      if (le > 0 && Un(M, le), T.length === 1 && T.unshift(null), j) {
        ...
        for (let ue = 0; ue < j; ue++) {
          ...
          for (let F = 0; F < se.length; F++)
            M.push(ne[F] + (ue + 1)), q.push(F === 0 ? "linear" : yr(ie, F - 1));
        }
        Ai(M, j);
      }
      const de = Y + U;
      Ti(y, T, q, M, Y, de), S = Math.max(z + U, S), m = Math.max(de, m);
    };
    if (Ut(w)) {
      const R = tt(w, l);
      N(v, x, rt("default", R));
      ...
      for (let y = 0; y < E; y++) {
        v = v, x = x;
        const V = R[y], b = tt(V, l);
        for (const T in v)
          N(v[T], ji(x, T), rt(T, b), y, E);
      }
    }
    u = h, h += S;
  }
  return l.forEach((p, g) => {
    for (const w in p) {
      ...
      for (let E = 0; E < v.length; E++) {
        const { at: y, value: V, easing: b } = v[E];
        x.push(V), S.push(Wn(0, m, y)), N.push(b || "easeOut");
      }
      S[0] !== 0 && (S.unshift(0), x.unshift(x[0]), N.unshift(Bi)), S[S.length - 1] !== 1 && (S.push(1), x.push(null)), a.has(g) || a.set(g, {
        keyframes: {},
        transition: {}
      });
      const R = a.get(g);
...
function Mr(e, t, n, o) {
  const s = [];
  if (Gi(e, t))
    s.push(eo(e, _1(t) && t.default || t, n && (n.default || n)));
  else {
    ...
    if (i !== void 0) {
      ...
      return m ? _e(
        ...
        fe,
        {
          ...
          noTooltip: a,
          tag: h,
          className: L(je({ variant: t, align: n }), o),
          markdown: l,
          ...f,
          children: e
        }
...
const V2 = Se({
  ...
  ({
    ...
    const Pe = O && O !== "none" || ee && ee !== "none" || Y && Y !== "none" || le && le !== "none", qe = z && z !== "none" || Pe, p1 = { sm: d1, md: u1, lg: We, xl: f1 }, g1 = T2.map((Xe) => {
      const Ye = p1[Xe];
      return Ye ? S2(Xe, Ye) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
}), v1 = { sm: 640, md: 768, "container-md": 448 }, F1 = (e) => "type" in e && e.type === "separator", n1 = (e) => "type" in e && e.type === "split", H2 = (e) => !("type" in e), o1 = (e, t, n) => /* @__PURE__ */ r(
  Ce,
  {
    label: e.label,
    icon: e.icon,
...
function nt({
  ...
  const u = $(null), { width: h = 0 } = Ds({
    ref: u,
    box: "border-box"
  }), m = a === "sm" || a === "md" ? v1[a] : v1.md, p = ar(`(min-width: ${m}px)`, {
    initializeWithValue: !1
  }), g = a === "none" ? !0 : a === "container-md" ? h >= v1["container-md"] : p, w = typeof o == "string" ? o : o.base, v = typeof o == "string" ? o : o.md, x = g ? v : w, S = Array.isArray(
    t
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: { gap: s },
      children: g ? /* @__PURE__ */ r($2, { ...R }, "row") : /* @__PURE__ */ r(B2, { ...R }, "stacked")
    }
  );
}
function B2({
...
function $2({
  ...
  const g = p ? h : l, w = p ? m : [], v = new Set(g.map((b) => b.id)), x = e ? Yr(e, s) : null, S = t.filter(n1), N = t[t.length - 1], R = N != null && F1(N) && (S.length > 0 || x != null), E = [];
  t.forEach((b, T) => {
    if (!n1(b)) {
      if (F1(b)) {
...
const Kr = C(
  function({
    ...
    const N = !!g && g.visible !== !1, R = /* @__PURE__ */ d(
      dr,
      {
        ref: N ? void 0 : S,
        className: L(
        ...
        children: [
          m && !v && /* @__PURE__ */ r(
            ur,
            {
              href: m,
              variant: "unstyled",
              className: L("z-1 absolute inset-0 block rounded-xl", ve()),
              "aria-label": t,
              children: " "
            }
          ),
    ...
    return N ? /* @__PURE__ */ r(Gs, { ref: S, alert: g, fullHeight: p, children: R }) : R;
  }
);
    ...
    children: /* @__PURE__ */ d("div", { className: "flex flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ d("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
        /* @__PURE__ */ r(
          pe,
          {
            className: L("h-10 w-10 rounded-full", e && "h-8 w-8")
          }
        ),
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(
              pe,
              {
                className: L("h-4 rounded", h === 1 ? "w-24" : "w-32")
              }
            )
          ]
        },
...
const a4 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ d(
    I1,
    {
      ...
      children: [
        /* @__PURE__ */ r(Xs, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((l, c) => /* @__PURE__ */ r(P1, { asChild: !0, children: /* @__PURE__ */ r(
          he,
          {
            variant: "outline",
            label: l.label,
...
function f4({
  ...
  const [i, a] = P("idle"), [l, c] = P(0), [f] = P(u4), [u, h] = P(null), m = $(null), p = $(null), g = $([]), w = $(null), v = $(!1), x = $(null), S = $(null), N = $(0), R = $({ onTranscribe: e, onPartial: t, onFinal: n, onError: o });
  R.current = { onTranscribe: e, onPartial: t, onFinal: n, onError: o };
  const E = X(() => {
    p.current?.getTracks().forEach((k) => k.stop()), p.current = null, m.current = null, h(null), x.current && (clearInterval(x.current), x.current = null), S.current && (clearTimeout(S.current), S.current = null);
  }, []), y = X(async () => {
    const { onTranscribe: k, onPartial: M, onFinal: A, onError: j } = R.current, _ = g.current;
    ...
    p.current = k, h(k);
    const M = new MediaRecorder(k);
    m.current = M, M.ondataavailable = (A) => {
      A.data.size > 0 && g.current.push(A.data);
    }, M.onstop = () => {
      if (E(), v.current) {
      ...
      y();
    }, M.start(l4), N.current = Date.now(), a("recording"), c(0), x.current = setInterval(() => {
...
function m4(e) {
  ...
  const w = X(
    async (N) => {
      ...
      if (u !== void 0 && p.current + R.length > u) {
        g(
      ...
      const V = (b) => n(
        (T) => T.map(
          (k) => y.includes(k.id) ? { ...k, status: "error", errorMessage: b } : k
        )
      );
      try {
        const b = await c(R);
        ...
        n(
          (T) => T.map((k) => {
            const M = E.findIndex((A) => A.id === k.id);
            return M === -1 ? k : b[M] ? {
              ...k,
              status: "uploaded",
              uploadedFile: b[M]
...
function k4({
  ...
  const [i, a] = P(!1), [l, c] = P(""), [f, u] = P([]), [h, m] = P(!1), [p, g] = P(0), [w, v] = P([]), x = $(-1), S = $(null), N = $(0), R = $(-1);
  K(() => {
    if (!o) {
      a(!1);
      return;
    ...
    const M = C4(e, n, w);
    if (!M) {
      a(!1), c(""), u([]), g(0), x.current = -1, R.current = -1;
      return;
    }
    if (M.atIndex === R.current)
      return;
    x.current = M.atIndex, c(M.query), a(!0), g(0), m(!0), S.current && clearTimeout(S.current);
    const A = ++N.current;
    return S.current = setTimeout(() => {
      o(M.query).then((j) => {
        A === N.current && (u(j), g(0), j.length === 0 && M.query.length > 0 && (R.current = M.atIndex, a(!1)));
      }).catch(() => {
        A === N.current && u([]);
      }).finally(() => {
        A === N.current && m(!1);
  ...
  const E = X(() => {
    ...
    (M) => {
      const A = x.current;
      if (A === -1) return;
      const j = `${M.firstName} ${M.lastName}`.trim(), _ = String(M.id), Z = e.slice(0, A), G = e.slice(n), q = `@${j} `, U = Z + q + G, z = Z.length + q.length;
    ...
    (M) => {
      if (!i) return !1;
      if (M.key === "Escape")
        return M.preventDefault(), E(), !0;
      if (f.length === 0) return !1;
      switch (M.key) {
        case "ArrowDown":
          return M.preventDefault(), g((A) => (A + 1) % f.length), !0;
        case "ArrowUp":
          return M.preventDefault(), g(
        ...
        case "Tab": {
          ...
          if (A) {
            ...
            if (l.length === 0 || j.toLowerCase().startsWith(l.toLowerCase()))
              return M.preventDefault(), y(A), !0;
          }
          return !1;
        }
        case "Enter":
          return M.preventDefault(), f[p] && y(f[p]), !0;
        default:
          return !1;
      }
    },
...
` || Z === "	";
  ...
  const T = re(() => {
    ...
    const M = s.current;
    if (!M) return null;
    const A = w4(M, x.current), j = M.offsetLeft + A.left, Z = (M.offsetParent ? M.offsetParent.offsetHeight : 0) - (M.offsetTop + A.top);
...
const b4 = /[\\`*_{}[\]()#+\-.!|~>]/g, L4 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(b4, "\\$&")).join(""), C3 = ({
  ...
  const y = J(), V = Le(), [b, T] = P(""), [k, M] = P(0), [A, j] = P(!1), [_, Z] = P(!1), [G, q] = P(null), U = $(null), z = $(null), O = $(null), ee = a != null, { tracking: Y } = Re(), le = X(
    (oe, be) => {
    ...
    const be = ge.current, m1 = be && !/\s$/.test(be) ? " " : "", Qe = `${be}${m1}${oe}`;
    T(Qe), M(Qe.length);
  }, []), Ve = {
    ...
    Y?.onDictationStart?.(), ge.current = b, me.start();
  }, [b, me, Y]), u1 = X(() => {
  ...
  const We = me.status === "recording", f1 = We ? y.ai.listening : y.ai.inputPlaceholder, h1 = de.filter((oe) => oe.status === "uploaded"), Ae = de.some((oe) => oe.status === "uploading"), Pe = de.some((oe) => oe.status === "error"), qe = b.trim().length > 0;
  K(() => {
    if (!(!_ || Ae)) {
      if (Z(!1), Pe) {
        ae(y.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const p1 = async (oe) => {
    if (oe.preventDefault(), !ee) {
      if (Q.close(), n)
        ...
        const be = Q.transformMentions(b.trim()), m1 = L4(be), Qe = h1.flatMap(
  ...
  }, G1 = G ? G.prompt ?? G.title : null, W1 = We ? [y.ai.listening] : G1 ? [G1] : s ?? [], Vn = W1.length > 1, Tn = re(() => c4(b, Q.mentions, {
    cursorPosition: k,
    inlineCompletion: Q.inlineCompletion
  }), [b, Q.mentions, k, Q.inlineCompletion]), An = Q.mentions.length > 0 || Q.inlineCompletion !== null, Ke = x && !!N && N.length > 0 && !!R ? /* @__PURE__ */ r(
    a4,
    {
      suggestions: N,
      onItemClick: le,
...
const an = 60, cn = 40, lt = 2e3, n6 = 500, o6 = 12e3, ln = 2, Oe = 40, He = [255, 60, 0], x1 = [160, 140, 220], k1 = { x: -12, y: 0, z: 0 }, b1 = { x: -12, y: 12, z: 90 }, Be = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, L1 = Math.PI / 180, s6 = ln / 8 * Math.PI, i6 = 4 * Math.PI;
function s1(e, t) {
  return [
...
const ut = Math.sqrt(an ** 2 + cn ** 2), y1 = [an / ut, cn / ut, 0], h6 = dn(k1.x, k1.y, k1.z), p6 = dn(b1.x, b1.y, b1.z), $e = ln * 3, t1 = Oe + 1, ft = ($e + 1) * t1, i1 = 4 * $e * Oe, M1 = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
...
function ht(e, t, n, o) {
  ...
  dt(h, y1[0], y1[1], y1[2], Ne);
  const m = Ze(Ne[0], Ne[1], Ne[2], u), p = s1(m, h6), g = s1(m, p6);
  M1[0] = p, M1[1] = g;
  let w = 0;
  for (let v = 0; v < 4; v++) {
    const x = M1[v >> 1], S = v & 1 ? -1 : 1;
    for (let N = 0; N <= $e; N++) {
      const R = S * (Math.PI / 2 - N / $e * f), E = Math.cos(R), y = Math.sin(R), V = Math.sin(N / $e * Math.PI), b = N * t1;
      for (let T = 0; T <= Oe; T++) {
        const k = T / Oe * Math.PI * 2;
        dt(x, E * Math.cos(k), y, E * Math.sin(k), Ne);
        const M = i[b + T];
        M.x = Ne[0], M.y = Ne[1], M.z = Ne[2], M.t = V;
      }
    }
    for (let N = 0; N < $e; N++) {
      const R = N * t1, E = (N + 1) * t1;
      for (let y = 0; y < Oe; y++) {
        const V = i[R + y], b = i[R + y + 1], T = i[E + y], k = i[E + y + 1];
        if ((V.t + b.t + T.t + k.t) * 0.25 < 1e-3) continue;
        const A = (V.x + b.x + T.x + k.x) * 0.25, j = (V.y + b.y + T.y + k.y) * 0.25, _ = (V.z + b.z + T.z + k.z) * 0.25, Z = A * a, G = j * a, q = V.x * a - Z, U = V.y * a - G, z = Math.sqrt(q * q + U * U), O = z > 0 ? (z + 0.9) / z : 1, ee = l + Z + q * O, Y = c - G - U * O, le = b.x * a - Z, de = b.y * a - G, se = Math.sqrt(le * le + de * de), ne = se > 0 ? (se + 0.9) / se : 1, ie = l + Z + le * ne, ue = c - G - de * ne, F = k.x * a - Z, B = k.y * a - G, H = Math.sqrt(F * F + B * B), D = H > 0 ? (H + 0.9) / H : 1, I = l + Z + F * D, W = c - G - B * D, ae = T.x * a - Z, Q = T.y * a - G, ge = Math.sqrt(ae * ae + Q * Q), xe = ge > 0 ? (ge + 0.9) / ge : 1, Ve = l + Z + ae * xe, me = c - G - Q * xe, Te = s[w];
        Te.points = `${ee},${Y} ${ie},${ue} ${I},${W} ${Ve},${me}`, Te.color = d6((A + 1) * 0.5), Te.avgZ = _, w++;
      }
    }
  }
  for (let v = w; v < i1; v++)
...
const C6 = ({ size: e = 20, className: t, style: n, variant: o = "default" }, s) => {
  ...
  const c = re(() => new Array(i1).fill(0), []), f = (u) => {
  ...
  return K(() => {
    ...
    let g = null, w = 0, v = 0, x = 0, S = null, N = "spin", R = !0, E = !1;
    const y = (M) => {
      const A = p.quads;
      ...
      let A = 0, j = !0;
      if (o === "continuous") {
        const q = lt * 2, U = (M - w) % q / q;
        A = U < 0.5 ? U * 2 : (1 - U) * 2, j = !1;
      } else N === "spin" ? (A = Math.min((M - w) / lt, 1), A >= 1 && (A = 0, N = "pause", x = M)) : (A = 0, M - x >= n6 && (N = "spin", w = M));
      const _ = (M - v) / o6 % 1, Z = j ? c6(A) : A, G = ht(p, Z, e, _);
      y(G), g = requestAnimationFrame(V);
    }, b = () => {
      g === null && (g = requestAnimationFrame(V));
    }, T = () => {
    ...
    "div",
    {
      ...
      role: "progressbar",
      "aria-label": "Loading",
      className: L("shrink-0 globe-spin-anim", t),
...
function pn({
  ...
  const S = i && a ? Object.entries(i).map(([E, y]) => {
    const V = a[E], b = m?.(E, V, {
      fieldType: y.fieldType,
      customFieldName: y.customFieldName
    });
    if (!b && y.fieldType === "custom" && typeof V == "object" && V !== null)
      return null;
    const T = b ?? hn(V, y.fieldType), k = ["richtext", "textarea"];
    return {
      label: y.label,
      content: T,
      verticalLayout: k.includes(y.fieldType ?? "")
    };
  }).filter((E) => {
    if (!E) return !1;
    const y = Array.isArray(E.content) ? E.content[0] : E.content;
    return !(y?.type === "item" && y.text === "—");
...
const Cn = a1(void 0), b3 = () => Ge(Cn), E6 = (e) => /* @__PURE__ */ r(gr, { content: e, format: "markdown" }), R6 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
...
function U6({
  ...
  const p = X(() => {
    const g = e.current;
    if (!g) return;
    const { scrollTop: w, scrollHeight: v, clientHeight: x } = g, S = v - w - x;
    f(S > x);
  }, [e]);
  return K(() => {
    const g = e.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!g || !w) return;
        const v = g.getBoundingClientRect(), x = w.getBoundingClientRect(), S = g.scrollTop + (x.top - v.top);
        g.scrollTo({ top: S, behavior: "smooth" });
      });
    }), s === 0 && f(!1), u.current = s;
...
const z6 = {
  ...
  const { modal: N, handleSubmit: R, handleClose: E } = S6(
    u ?? z6
  ), y = J(), V = w ?? R6, b = v ?? I6, T = re(() => {
    const O = o ?? y.ai.defaultInitialMessage;
    return (Array.isArray(O) ? O : [O]).filter((Y) => typeof Y == "string" && Y.length > 0);
  }, [o, y.ai.defaultInitialMessage]), k = !t && e.length === 0 && T.length > 0, M = $(null), A = $(null), j = $(null), _ = $(null), Z = $(null), { showScrollBtn: G, turnMinHeight: q, scrollToBottom: U } = U6({
    viewportRef: M,
    contentRef: A,
    endRef: j,
    lastTurnRef: Z,
    ...
    return /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          O.endIndicator === "thinking" && /* @__PURE__ */ r(V1, { title: y.ai.thinking, status: "executing" }),
...
const K6 = ({
  ...
  const n = J(), o = Le(), {
    ...
    allowCustomAnswer: R,
    customAnswerText: E,
    isCustomAnswerActive: y
  } = s, V = $(null), b = S ?? "single", T = a > 1, k = i === 0, M = i === a - 1, A = T ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  }) : void 0, j = x.length > 0, _ = (E ?? "").trim().length > 0, Z = j || y && _ || N === !0, G = t === !0 && M, q = () => {
    G || c();
  }, U = () => {
    G || f();
  }, z = (se) => {
    const ne = b === "single" && x.includes(se);
    l(se), b === "single" && !M && !ne && Promise.resolve().then(c);
  }, O = M ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, ee = N === !0 && !j && !(y && _), Y = () => {
...
function bt(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), l = Math.min(i + o, s), c = Math.min(l, Math.floor(e / 2)), f = Math.min(l, Math.floor(t / 2)), u = (Y) => Y / e * 2 - 1, h = (Y) => Y / t * 2 - 1, m = 0, p = e, g = 0, w = t, v = c, x = e - c, S = f, N = t - f, R = u(m), E = u(p), y = h(g), V = h(w), b = u(v), T = u(x), k = h(S), M = h(N), A = 0, j = 0, _ = 1, Z = 1, G = c / e, q = 1 - c / e, U = f / t, z = 1 - f / t, O = new Float32Array([
    // Top strip
    R,
    y,
    E,
...
class F3 {
  ...
  setupGL() {
    ...
    const m = t.getUniformLocation(n, "uResolution"), p = t.getUniformLocation(n, "uTime"), g = t.getUniformLocation(n, "uBorderWidth"), w = t.getUniformLocation(n, "uGlowWidth"), v = t.getUniformLocation(n, "uBorderRadius"), x = t.getUniformLocation(n, "uColors"), S = t.getUniformLocation(n, "uGlowExponent"), N = t.getUniformLocation(n, "uGlowFactor");
    t.useProgram(n), t.uniform1f(g, this.options.borderWidth), t.uniform1f(w, this.options.glowWidth), t.uniform1f(v, this.options.borderRadius), this.options.mode === "dark" ? (t.uniform1f(S, 2), t.uniform1f(N, 1.8)) : (t.uniform1f(S, 1), t.uniform1f(N, 1));
    const R = (this.options.colors || s9).map(i9);
...
}, E1 = 9729, Ht = 9728, g9 = 9987, Bt = 33071, $t = 10497;
class m9 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const h = 0, m = n.RGBA, p = 1, g = 1, w = 0, v = n.RGBA, x = n.UNSIGNED_BYTE, S = new Uint8Array([255, 255, 255, 0]), N = n.createTexture();
    ...
    let E = await R(), y = (E.width & E.width - 1) === 0 && (E.height & E.height - 1) === 0;
    return (t.wrapS !== Bt || t.wrapT !== Bt || t.minFilter !== Ht && t.minFilter !== E1) && !y && (E = this.makePowerOf2(E), y = !0), n.bindTexture(n.TEXTURE_2D, N), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, c), n.texImage2D(
      n.TEXTURE_2D,
      h,
      m,
      v,
      x,
      E
    ), y && t.minFilter !== Ht && t.minFilter !== E1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || $t
    ), n.texParameteri(
...
function v9({
  ...
  const p = $(null), g = $(null), w = $(null), v = $(null), x = $(void 0), S = $(void 0), N = $(!1), R = $(void 0), E = $(0), y = $([0, 0]), V = $([]), b = $(0), T = $(void 0), k = $({
    ...
    W && (W[2] = D, W[3] = I), y.current[0] = D, y.current[1] = I;
  }, q = (F) => {
    R.current = p.current?.getBoundingClientRect();
    const [B = 0, H = 0] = It(F), D = B - (R.current?.left ?? 0), I = (R.current?.height ?? 0) - H - (R.current?.top ?? 0);
    if (c !== 1)
      y.current[0] = D, y.current[1] = I;
    else {
      const W = Array.isArray(k.current.iMouse?.value) ? k.current.iMouse.value : void 0;
      W && (W[0] = D, W[1] = I);
    }
      ...
      if (n && n.length > 0) {
        ...
        const B = n.map(
          (H, D) => (k.current[`${l9}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, A(H, D), V.current[D] = new m9(F), V.current[D]?.load(H).then((I) => {
            A(I, D);
          }))
        );
        Promise.all(B).then(() => {
...
`,
    ...
    if (k.current.iMouse?.isNeeded && c !== 1 && Array.isArray(H)) {
      ...
      H[0] = Pt(D, y.current[0] ?? 0, c), H[1] = Pt(I, y.current[1] ?? 0, c);
    }
    ...
    k.current.iMouse?.isNeeded && p.current && (p.current.addEventListener("mousemove", q, F), p.current.addEventListener("mouseout", U, F), p.current.addEventListener("mouseup", U, F), p.current.addEventListener("mousedown", G, F), p.current.addEventListener("touchmove", q, F), p.current.addEventListener("touchend", U, F), p.current.addEventListener("touchstart", G, F)), k.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      ...
      Z,
      F
    ), p.current && (T.current = new ResizeObserver(z), T.current.observe(p.current), window.addEventListener("resize", z, F));
  }, ue = () => {
    const F = { passive: !0 };
...
function M9(e, t) {
  const [n, o] = P(x9), {
    ...
    animate: i,
    motionValue: a
  } = Je(L9), { value: l, animate: c } = Je(k9), { value: f, animate: u } = Je(b9), { value: h, animate: m } = Je(y9), p = Ri(t, {
    fftSize: 512,
...
const V3 = ({
  ...
  const o = J(), s = Le();
  return /* @__PURE__ */ d(ke, { children: [
    e && /* @__PURE__ */ r("span", { className: L(F9(), "truncate"), children: e }),
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: L(Mn()), children: t }),
    /* @__PURE__ */ d(
      te.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ d("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ r("span", { className: L(e1()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ r(
            ui,
            {
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: L(Mn()), children: o }),
              /* @__PURE__ */ r(
                te.div,
                {
...
const Dt = ({
  ...
  ) : /* @__PURE__ */ d("header", { className: L("flex justify-between px-4 py-3"), children: [
...
const B3 = ({
  ...
  const p = re(
    ...
    return o.filter((V) => V.title.toLowerCase().includes(y));
  }, [o, h]), w = re(
    () => g.filter((y) => a.has(y.id)),
    [g, a]
  ), v = re(
    () => g.filter((y) => !a.has(y.id)),
    [g, a]
...
const a3 = te.create(Mi), c3 = ({ label: e }) => /* @__PURE__ */ d("div", { className: "flex flex-row items-center gap-1 rounded-full border border-solid border-f1-border-secondary bg-f1-background px-2 py-1.5 pr-2.5 shadow-md", children: [
  ...
  }, [t]), /* @__PURE__ */ d("div", { className: L("relative flex flex-1 flex-col", o), children: [

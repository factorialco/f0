 ...
 */
export declare type CurrentFilters<F extends FilterOptions<string, unknown, RecordType>> = F extends {
 ...
 */
export declare type FilterDefinition<T = unknown, R extends RecordType = RecordType> = FilterDefinitionsByType<T, R>[keyof FilterDefinitionsByType];
...
export declare type FilterOptions<FilterKeys extends string, T = unknown, R extends RecordType = RecordType> = Record<FilterKeys, FilterDefinition<T, R>>;
 ...
 */
export declare type FiltersDefinition<FilterKeys extends string = string, T = unknown, R extends RecordType = RecordType> = Record<FilterKeys, FilterDefinition<T, R>>;
 ...
 */
export declare type FiltersState<Definition extends Record<string, FilterDefinition<unknown, RecordType>>> = {
 ...
 * @template Filters - The available filter configurations
 */
export declare type PresetDefinition<Filters extends Record<string, FilterDefinition<unknown, RecordType>>> = {
...
export declare type PresetsDefinition<Filters extends Record<string, FilterDefinition<unknown, RecordType>>> = PresetDefinition<Filters>[];

...
declare interface CheckboxBaseProps extends DataAttributes_2 {
    /**
...
declare function _F0Checkbox({ variant, editing: _editing, onDismiss: _onDismiss, title, description, onCheckedChange, id, disabled, indeterminate, checked, value, hideLabel, presentational, stopPropagation, name, required, ...rest }: F0CheckboxProps): JSX_2.Element;
...
export declare type F0CheckboxFieldProps = CheckboxBaseProps & {
    /**
     * @default "field"
     */
    variant?: "field";
...
export declare type F0CheckboxProps = F0CheckboxFieldProps | F0CheckboxInlineProps;
 ...
 * and file.
 */
export declare function F0FormField({ field, value, onChange, onBlur, error, errorMessage, status, loading, required, disabled, hideLabel: hideLabelProp, initialFiles, inline, }: F0FormFieldProps): JSX_2.Element;

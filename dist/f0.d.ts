...
declare type DateNavigatorFilterDefinition = NavigationFilterDefinitionBase<Date | DateRange | DateValue, typeof dateNavigatorFilterType> & DateNavigationOptions_2;
...
declare interface F0ListNavigationProps {
    value: string;
    disabled?: boolean;
...
declare interface ListNavigationOption {
    value: string;
    label: string;
}

declare type ListNavigationOptions = {
    options: F0ListNavigationProps["options"];
};

declare type ListNavigatorFilterDefinition = NavigationFilterDefinitionBase<ListValue, typeof listNavigatorFilterType> & ListNavigationOptions;

declare const listNavigatorFilterType: "list-navigator";
...
declare type NavigationFilterDefinition = NavigationFilterDefinitionMap[keyof NavigationFilterDefinitionMap];

declare type NavigationFilterDefinitionBase<T, Type extends string> = {
    type: Readonly<Type>;
    defaultValue: T;
};

declare type NavigationFilterDefinitionMap = {
 ...
 */
declare type NavigationFilterValue<T> = T extends DateNavigatorFilterDefinition ? DateValue : T extends ListNavigatorFilterDefinition ? ListValue : T extends undefined ? undefined : never;

 ...
 */
export declare function CategoryBarChartSkeleton({ showLegend, }?: {
    showLegend?: boolean;
}): JSX_2.Element;
 ...
 */
export declare interface F0DataChartCategoryBarDataPoint {
 ...
 */
export declare interface F0DataChartCategoryBarProps extends F0DataChartCommonProps {
    /** Chart type */
    type: "categoryBar";
 ...
 * prop.
 */
export declare type F0DataChartProps = F0DataChartBarProps | F0DataChartLineProps | F0DataChartFunnelProps | F0DataChartPieProps | F0DataChartRadarProps | F0DataChartGaugeProps | F0DataChartHeatmapProps | F0DataChartCategoryBarProps;

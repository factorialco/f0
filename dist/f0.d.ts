...
export declare interface GranularityDefinition {
    ...
    toRangeString: (date: Date | DateRange | undefined | null, i18n: TranslationsType, format?: DateStringFormat, locale?: string) => DateRangeString;
    ...
    fromString: (dateStr: string | DateRangeString, i18n: TranslationsType, locale?: string) => DateRange | null;
...
export declare const OneCalendarInternal: ({ mode, view, onSelect, defaultMonth, defaultSelected, showNavigation, showInput, minDate, maxDate, compact, weekStartsOn, selectOnCellOnly, localizedDayFormat, }: OneCalendarInternalProps) => JSX_2.Element;

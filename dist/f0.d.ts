...
({ name, src, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, badge, bgColor, }: F0AvatarCompanyProps_2): JSX_2.Element;
displayName: string;
}>;
...
({ firstName, lastName, src, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, badge, deactivated, bgColor, }: F0AvatarPersonProps_2): JSX_2.Element;
displayName: string;
}>;
...
({ name, src, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, badge, bgColor, }: F0AvatarTeamProps_2): JSX_2.Element;
displayName: string;
}>;

...
declare type NestedChildrenDisplayMode = (typeof nestedChildrenDisplayModes)[number];
 ...
 */
declare const nestedChildrenDisplayModes: readonly ["paginated", "all"];

declare type NestedExpandAllOptions<R extends RecordType> = NestedExpandOptions & {
    /**
...
declare type NestedExpandAnimation = (typeof nestedExpandAnimations)[number];
 ...
 */
declare const nestedExpandAnimations: readonly ["none", "fade", "stagger", "slide", "pop"];

declare type NestedExpandOptions = {
    /**
 ...
 */
declare type NestedExpansionCriteria<R extends RecordType> = boolean | number | ((context: NestedExpansionContext<R>) => boolean);
 ...
 */
declare type NestedRowTarget<R extends RecordType> = string | number | ((context: NestedExpansionContext<R>) => boolean);
 ...
 */
declare interface NestedTableController<R extends RecordType> {
     ...
     * ```
     */
    expandTo: (path: Array<string | number>, options?: NestedExpandOptions) => void;
 ...
 */
declare type NestedTableOptions<R extends RecordType> = {
    /**
     ...
     */
    onExpandedChange?: (event: NestedExpansionContext<R> & {
        expanded: boolean;
    }) => void;
};

...
import { AxisConfig } from './utils/types';
...
import { ChartContainerComponentProps } from '../../ui/chart';
...
import { TestableProps as TestableProps_2 } from '../../global.types';
import { TestableProps as TestableProps_3 } from '../../../global.types';
...
export declare const AreaChart: ForwardRefExoticComponent<Omit<TestableProps_2 & {
dataConfig: LineChartConfig;
data: ChartItem<LineChartConfig>[];
xAxis?: AxisConfig;
yAxis?: AxisConfig;
aspect?: ComponentProps<ForwardRefExoticComponent<Omit<ChartContainerComponentProps, "ref"> & RefAttributes<HTMLDivElement>>>["aspect"];
hideGrid?: boolean;
hideTooltip?: boolean;
} & {
...
declare type AvatarProps = TestableProps & {
...
export declare const BarChart: ForwardRefExoticComponent<Omit<TestableProps_2 & {
...
declare type BaseAvatarProps = TestableProps & {
    /**
...
export declare type BigNumberProps = TestableProps & {
...
declare type ButtonInternalProps = Pick<ActionProps, "size" | "disabled" | "className" | "pressed" | "compact" | "tooltip" | "fontSize"> & DataAttributes & TestableProps & {
    /**
...
declare interface CardInternalProps extends TestableProps {
    /**
...
declare interface CheckboxProps extends DataAttributes_2, TestableProps {
    /**
...
declare type ChipProps = BaseChipProps & ChipVariants & TestableProps & {
...
export declare const ComboChart: ForwardRefExoticComponent<Omit<TestableProps_2 & {
dataConfig: ChartConfig;
data: ChartItem<ChartConfig>[];
xAxis?: AxisConfig;
yAxis?: AxisConfig;
...
export declare const F0Alert: ({ title, description, action, link, icon, variant, testId, }: F0AlertProps) => JSX_2.Element;

export declare interface F0AlertProps extends TestableProps {
    title: string;
    description: string;
    action?: {
        label: string;
...
export declare const F0Avatar: ({ avatar, size, testId, }: AvatarProps) => ReactNode;

export declare const F0AvatarAlert: ({ type, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, testId, }: AlertAvatarProps) => JSX_2.Element;

export declare const F0AvatarCompany: {
    ({ name, src, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, badge, testId, }: F0AvatarCompanyProps): JSX_2.Element;
    displayName: string;
};
...
export declare const F0AvatarDate: ({ date, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, testId, }: F0AvatarDateProps) => JSX_2.Element;
...
export declare const F0AvatarEmoji: {
    ({ emoji, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, testId, }: F0AvatarEmojiProps): JSX_2.Element;
    displayName: string;
};
...
size?: AvatarFileSize;
badge?: AvatarBadge;
} & Pick<BaseAvatarProps, "aria-label" | "aria-labelledby" | "testId"> & RefAttributes<HTMLSpanElement>>;
...
export declare const F0AvatarIcon: {
    ({ icon, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, testId, }: F0AvatarIconProps): JSX_2.Element;
    displayName: string;
};
...
export declare const F0AvatarList: {
    ({ avatars, size, type, noTooltip, remainingCount: initialRemainingCount, max, testId, }: F0AvatarListProps): JSX_2.Element;
    displayName: string;
};

export declare type F0AvatarListProps = TestableProps & {
    /**
 ...
 * @returns
 */
export declare function F0AvatarModule({ size, module, testId, ...props }: F0AvatarModuleProps): JSX_2.Element;
...
export declare const F0AvatarPerson: {
    ({ firstName, lastName, src, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, badge, deactivated, testId, }: F0AvatarPersonProps): JSX_2.Element;
    displayName: string;
};
...
export declare const F0AvatarTeam: {
    ({ name, src, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, badge, testId, }: F0AvatarTeamProps): JSX_2.Element;
    displayName: string;
};
...
export declare const F0BigNumber: {
    ({ label, testId, ...props }: BigNumberProps_2): JSX_2.Element;
    displayName: string;
} & {
...
export declare const F0ButtonDropdown: ({ onClick, value, testId, ...props }: F0ButtonDropdownProps) => JSX_2.Element | undefined;

export declare type F0ButtonDropdownProps<T = string> = TestableProps & {
    /**
...
declare type F0ButtonToggleInternalProps = TestableProps & {
    /**
...
declare function _F0Checkbox({ title, onCheckedChange, id, disabled, indeterminate, checked, value, hideLabel, presentational, stopPropagation, name, testId, ...rest }: CheckboxProps): JSX_2.Element;

/**
 * @experimental This is an experimental component use it at your own risk
 */
export declare const F0ChipList: {
    ({ chips, max, remainingCount: initialRemainingCount, layout, testId, }: Props): JSX_2.Element;
    displayName: string;
};
...
declare function F0DatePicker_2({ onChange, value, presets, granularities, minDate, maxDate, open, testId, ...inputProps }: F0DatePickerProps): JSX_2.Element;

export declare type F0DatePickerProps = Pick<DatePickerPopupProps, "granularities" | "minDate" | "maxDate" | "presets" | "open" | "onOpenChange"> & TestableProps & {
...
export declare type F0HeadingProps = Omit<TextProps, "className" | "variant" | "as"> & TestableProps & {
...
export declare interface F0IconProps extends SVGProps<SVGSVGElement>, VariantProps<typeof iconVariants>, TestableProps {
    icon: IconType;
    size?: "lg" | "md" | "sm" | "xs";
...
export declare const F0Link: ForwardRefExoticComponent<Omit<ActionLinkProps, "href" | "variant"> & TestableProps & {
variant?: ActionLinkVariant;
stopPropagation?: boolean;
href?: string;
} & RefAttributes<HTMLAnchorElement>>;

export declare type F0LinkProps = Omit<ActionLinkProps, "variant" | "href"> & TestableProps & {
    variant?: ActionLinkVariant;
    stopPropagation?: boolean;
    href?: string;
};
 ...
 */
declare type F0SelectBaseProps<T extends string, R = unknown> = TestableProps & {
...
export declare const F0TagAlert: ForwardRefExoticComponent<TestableProps_3 & {
text: string;
level: Level;
...
export declare const F0TagList: {
    <T extends TagType>({ type, tags, max, remainingCount: initialRemainingCount, testId, }: TagListProps<T>): JSX_2.Element;
    displayName: string;
};

export declare const F0TagPerson: ForwardRefExoticComponent<TestableProps_3 & {
src?: string;
name: string;
} & RefAttributes<HTMLDivElement>>;

export declare type F0TagPersonProps = TestableProps & {
    src?: string;
    name: string;
};
...
export declare type F0TextProps = Omit<TextProps, "className" | "variant" | "as"> & TestableProps & {
...
export declare const LineChart: ForwardRefExoticComponent<Omit<TestableProps_2 & {
dataConfig: LineChartConfig;
data: ChartItem<LineChartConfig>[];
xAxis?: AxisConfig;
yAxis?: AxisConfig;
...
export declare const PieChart: ForwardRefExoticComponent<Omit<TestableProps_2 & {
dataConfig: ChartConfig_2;
data: PieChartItem[];
...
export declare const ProgressBarChart: ForwardRefExoticComponent<Omit<TestableProps_2 & {
dataConfig: ChartConfig_2;
data: ChartItem<ChartConfig_2>[];
xAxis?: AxisConfig;
yAxis?: AxisConfig;
aspect?: ComponentProps<ForwardRefExoticComponent<Omit<ChartContainerComponentProps, "ref"> & RefAttributes<HTMLDivElement>>>["aspect"];
hideGrid?: boolean;
...
declare type Props = TestableProps & {
    /**
...
export declare type TagAlertProps<Text extends string = string> = TestableProps & {
    text: Text extends "" ? never : Text;
    level: Level;
};

export declare type TagBalanceProps = TestableProps & {
    /**
...
export declare interface TagCompanyProps extends TestableProps {
    name: string;
    src?: string;
}
...
export declare type TagDotProps = TestableProps & {
    text: string;
} & ({
    color: NewColor;
} | {
...
export declare type TagListProps<T extends TagType> = TestableProps & {
    /**
...
export declare type TagRawProps = TestableProps & {
    /**
...
export declare interface TagStatusProps extends TestableProps {
    text: string;
    variant: Variant;
    /**
...
export declare interface TagTeamProps extends TestableProps {
    name: string;
    src?: string;
}
...
export declare const VerticalBarChart: ForwardRefExoticComponent<Omit<TestableProps_2 & {
dataConfig: ChartConfig_2;
data: ChartItem<ChartConfig_2>[];
xAxis?: AxisConfig;
yAxis?: AxisConfig;

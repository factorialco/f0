...
export declare const F0AiAnnouncementCard: ForwardRefExoticComponent<F0AiAnnouncementCardProps & RefAttributes<HTMLDivElement>> & {
    Skeleton: ForwardRefExoticComponent<RefAttributes<HTMLDivElement>>;
};

export declare interface F0AiAnnouncementCardProps extends DataAttributes_2 {

 ...
 */
export declare type DashboardChartConfig = BarChartConfig | LineChartConfig | ComboChartConfig | FunnelChartConfig | PieChartConfig | RadarChartConfig | GaugeChartConfig | HeatmapChartConfig;
 ...
 * radar, gauge, and heatmap chart types via a discriminated `type` prop.
 */
export declare type F0DataChartProps = F0DataChartBarProps | F0DataChartLineProps | F0DataChartComboProps | F0DataChartFunnelProps | F0DataChartPieProps | F0DataChartRadarProps | F0DataChartGaugeProps | F0DataChartHeatmapProps;

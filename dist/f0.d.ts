 ...
 */
export declare const F0TableExport: ({ markdown, primaryAction, secondaryActions, }: F0TableExportProps) => JSX_2.Element;

/**
 * Action item for table export (download or custom action)
 */
export declare type F0TableExportActionItem = {
    /**
 ...
 */
export declare type F0TableExportProps = {
    /**
...
/**
 * Table component with download button
 */
...
/**
 * Table component without download button - for use when parent provides download controls
 */

...
export declare interface ComboChartConfig extends ChartConfigBase {
    type: "combo";
 ...
 */
export declare function ComboChartSkeleton({ stacked, showLegend, }?: ComboChartSkeletonProps): JSX_2.Element;

declare interface ComboChartSkeletonProps {
    /** Show stacked bar segments. @default false */
    stacked?: boolean;
    /** Show legend below chart. @default true */
    showLegend?: boolean;
 ...
 */
export declare type DashboardChartConfig = BarChartConfig | LineChartConfig | ComboChartConfig | FunnelChartConfig | PieChartConfig | RadarChartConfig | GaugeChartConfig | HeatmapChartConfig | ScatterChartConfig;
...
export declare type F0DataChartComboLineSeries = Omit<F0DataChartLineSeries, "showArea">;
 ...
 */
export declare interface F0DataChartComboProps extends F0DataChartBaseProps {
    /** Chart type */
    type: "combo";
 ...
 */
export declare type F0DataChartProps = F0DataChartBarProps | F0DataChartLineProps | F0DataChartComboProps | F0DataChartFunnelProps | F0DataChartPieProps | F0DataChartRadarProps | F0DataChartGaugeProps | F0DataChartHeatmapProps | F0DataChartScatterProps;

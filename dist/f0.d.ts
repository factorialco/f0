...
declare const F0FilterPicker: <Definition extends FiltersDefinition>(props: OneFilterPickerRootProps<Definition> & {
    dataTestId?: string;
}) => ReactElement | null;
export { F0FilterPicker }
export { F0FilterPicker as OneFilterPicker }
 ...
 */
export declare type OneFilterPickerRootProps<Definition extends FiltersDefinition> = {

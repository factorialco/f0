...
export declare const F0_HIL_ACTION_CONFIRMATION_VARIANTS: readonly ["default", "destructive"];
...
export declare const F0HILActionConfirmation: ({ text, confirmationText, onConfirm, cancelText, onCancel, variant, }: F0HILActionConfirmationProps) => JSX_2.Element;
...
export declare type F0HILActionConfirmationVariant = (typeof F0_HIL_ACTION_CONFIRMATION_VARIANTS)[number];

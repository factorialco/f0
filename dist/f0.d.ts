...
export declare function F0NpsWidget({ title, module, open, onClose, onScoreChange, onFeedbackChange, onSubmit, isSubmitting, score: controlledScore, feedback: controlledFeedback, }: F0NpsWidgetProps): JSX_2.Element | null;

export declare namespace F0NpsWidget {
    var displayName: string;
}

export declare interface F0NpsWidgetProps {
...
export declare type NpsStep = "scoring" | "feedback" | "thank-you";

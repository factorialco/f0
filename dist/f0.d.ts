...
export declare const F0AnalyticsDashboard: {
    <Filters extends FiltersDefinition_2 = FiltersDefinition_2>({ filters, presets, defaultFilters, filtersValue, onFiltersChange, items, itemFilters, editMode, onLayoutChange, enableExport, exportFilename, onExportReady, resetKey, onTransformChart, onAskAi, onAskAiTarget, navigationFilters, navigationActions, filtersLoading, dataKey, }: F0AnalyticsDashboardProps_2<Filters>): JSX_2.Element;
    displayName: string;
};

 ...
 */
export declare type DashboardChartConfig = BarChartConfig | LineChartConfig | FunnelChartConfig;

export declare interface DashboardChartData {
    /** Category axis labels. Required for bar/line charts, unused for funnel. */
    categories?: string[];
    series: F0DataChartBarSeries[] | F0DataChartLineSeries[] | F0DataChartFunnelSeries;
}
...
declare interface FunnelChartConfig {
    type: "funnel";

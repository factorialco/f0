...
export declare interface ChatChartBarConfig extends ChatChartCategoryBase {
    type: "bar";
...
declare interface ChatChartCardBase {
...
declare interface ChatChartCategoryBase extends ChatChartCardBase {
 ...
 */
export declare type ChatChartConfig = ChatChartBarConfig | ChatChartLineConfig | ChatChartFunnelConfig | ChatChartPieConfig | ChatChartRadarConfig | ChatChartGaugeConfig | ChatChartHeatmapConfig;

export declare interface ChatChartFunnelConfig extends ChatChartCardBase {
    type: "funnel";
...
export declare interface ChatChartGaugeConfig extends ChatChartCardBase {
    type: "gauge";
...
export declare interface ChatChartHeatmapConfig extends ChatChartCardBase {
    type: "heatmap";
...
export declare interface ChatChartLineConfig extends ChatChartCategoryBase {
    type: "line";
    series: ChatChartSeries[];
...
export declare interface ChatChartPieConfig extends ChatChartCardBase {
    type: "pie";
...
export declare interface ChatChartRadarConfig extends ChatChartCardBase {
    type: "radar";

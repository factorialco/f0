...
import { F0ChipProps as F0ChipProps_2 } from './types';
...
export declare type ChipVariantValue = (typeof chipVariantValues)[number];

export declare const chipVariantValues: readonly ["default", "selected"];
...
export declare const F0Chip: WithDataTestIdReturnType_3<    {
({ deactivated, label, variant, onClick, onClose, avatar, icon, }: F0ChipProps_2): JSX_2.Element;
displayName: string;
}>;
...
export declare type F0ChipProps = BaseChipProps & ChipMediaVariant & {

...
import { NotesTextEditorHandle as NotesTextEditorHandle_2 } from './types';
import { NotesTextEditorProps as NotesTextEditorProps_2 } from './types';
...
import { RichTextEditorHandle as RichTextEditorHandle_2 } from './types';
import { RichTextEditorProps as RichTextEditorProps_2 } from './types';
import { RichTextEditorSkeletonProps as RichTextEditorSkeletonProps_2 } from './types';
...
export declare type BannerVariant = "info" | "warning" | "critical" | "neutral" | "positive";
...
export declare const F0NotesTextEditor: ForwardRefExoticComponent<NotesTextEditorProps_2 & RefAttributes<NotesTextEditorHandle_2>>;
...
export declare const F0RichTextEditor: ForwardRefExoticComponent<RichTextEditorProps_2 & RefAttributes<RichTextEditorHandle_2>> & {
    Skeleton: ({ rows, }: RichTextEditorSkeletonProps_2) => JSX_2.Element;
};
...
export declare interface FileItemProps extends React.HTMLAttributes<HTMLDivElement> {
    file: File | FileDef;
    actions?: FileAction[];
    disabled?: boolean;
    size?: FileItemSize;
...
export declare type FileItemSize = "md" | "lg";
...
export declare type HeaderSecondaryAction = SecondaryAction & {
    hideLabel?: boolean;
};
...
export declare type ImageUploadErrorType = "file-too-large" | "invalid-type" | "upload-failed";
...
export declare interface RichTextEditorSkeletonProps {
    rows?: number;
}

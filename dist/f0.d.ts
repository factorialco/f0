 ...
 */
export declare type CanvasContent = DashboardCanvasContent | FormCanvasContent | DataDownloadCanvasContent | TicketCanvasContent;
...
declare type TicketCanvasContent = CanvasContentBase & {
    type: "ticket";
    categoryName: string;

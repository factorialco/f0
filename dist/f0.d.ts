 ...
 * inside that shell.
 */
export declare interface DashboardCustomItem<Filters extends FiltersDefinition = FiltersDefinition> extends DashboardItemBase {
    type: "custom";
    /**
 ...
 */
export declare type DashboardItem<Filters extends FiltersDefinition = FiltersDefinition> = DashboardChartItem<Filters> | DashboardMetricItem<Filters> | DashboardCollectionItem<Filters> | DashboardLocationItem<Filters> | DashboardCustomItem<Filters>;
...
export declare interface DashboardLocationConfig {
...
export declare interface DashboardLocationData {
...
export declare interface DashboardLocationDetailRow {
    id: string;
    title: string;
    description?: string;
    avatar: AvatarVariant;
...
export declare interface DashboardLocationDetailValue {
 ...
 */
export declare interface DashboardLocationItem<Filters extends FiltersDefinition = FiltersDefinition> extends DashboardItemBase {
    type: "location";
...
export declare interface DashboardLocationPoint {
    id: string;
    name: string;
...
export declare interface DashboardLocationSummaryMetric {
...
export declare type DashboardLocationSummaryTone = (typeof dashboardLocationSummaryTones)[number];

/** Semantic treatment for one of the three summary metrics. */
export declare const dashboardLocationSummaryTones: readonly ["default", "positive", "critical", "selected"];

/** Generic line timeline displayed along the bottom of the map. */
export declare interface DashboardLocationTimelineData {
...
export declare type F0DataChartGridLineContrast = (typeof f0DataChartGridLineContrasts)[number];

/** Semantic contrast levels for value-axis grid lines. */
export declare const f0DataChartGridLineContrasts: readonly ["subtle", "strong"];

/** Value-axis grid pattern. A numeric sequence defines an ECharts dash pattern. */
export declare type F0DataChartGridLineType = (typeof f0DataChartGridLineTypes)[number] | readonly number[];

/** Named value-axis grid patterns supported by ECharts. */
export declare const f0DataChartGridLineTypes: readonly ["solid", "dashed", "dotted"];
 ...
 */
declare interface F0MapStylePair {

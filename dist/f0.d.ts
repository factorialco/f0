...
import { F0AvatarColorProps as F0AvatarColorProps_2 } from './F0AvatarColor';
...
declare type AvatarVariant_2 = ({
    ...
    type: "color";
} & DistributiveOmit<F0AvatarColorProps, "size">);
...
export declare type ColorAvatarVariant = Extract<AvatarVariant, {
    type: "color";
}>;
...
export declare const F0AvatarColor: WithDataTestIdReturnType_4<    {
(props: F0AvatarColorProps_2): JSX_2.Element;
displayName: string;
}>;
 ...
 */
export declare type F0AvatarColorProps = {
    size?: AvatarSize;
} & ({
    color: NewColor;
} | {

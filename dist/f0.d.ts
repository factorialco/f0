 ...
 */
export declare type AiChatOpenOptions = {
    /**
...
} & Pick<AiChatState, "greeting" | "agent" | "disclaimer" | "resizable" | "voice" | "entityResolvers" | "toolHints"> & {
...
export declare const aiTranslations: {
    ai: {
        ...
        textModeEnabled: string;
        voiceChatRegion: string;
        ask: string;
        viewProfile: string;
        tools: string;
    };
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const F0AiChatProvider: ({ enabled, greeting, initialMessage, welcomeScreenSuggestions, disclaimer, resizable, defaultVisualizationMode, lockVisualizationMode, footer, entityResolvers, toolHints, voice, onThumbsUp, onThumbsDown, children, agent, tracking, ...copilotKitProps }: AiChatProviderProps) => JSX_2.Element;

...
declare type F0FieldChangeRequest = {
    from: string;
    to: string;
    reason?: string;
};
...
declare type F0FieldInlineConfig = {
 ...
 */
declare type F0FieldInlineProp = boolean | F0FieldInlineConfig;

/** A request already on the record, waiting for an answer. */
declare type F0FieldPendingChange = {
    id: string;
    to: string;
};

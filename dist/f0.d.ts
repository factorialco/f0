...
declare type ChatTextareaOnSend = (text: string, context?: ChatTextareaSendContext) => ReturnType<InputProps["onSend"]> | void;

declare interface ChatTextareaProps extends Omit<InputProps, "onSend"> {
...
declare interface ChatTextareaSendContext {
    message: Message_2;

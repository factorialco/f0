...
export declare type DataSourceDefinition<R extends RecordType = RecordType, Filters extends FiltersDefinition = FiltersDefinition, Sortings extends SortingsDefinition = SortingsDefinition, Grouping extends GroupingDefinition<R> = GroupingDefinition<R>> = {
     ...
     */
    fetchSelectableTotal?: (options: SelectableTotalOptions<Filters>) => Promise<number>;
 ...
 */
export declare const resolveSelectableTotal: ({ fetchedTotal, paginationTotal, hasNonSelectableRows, }: {
 ...
 */
export declare type SelectableTotalOptions<Filters extends FiltersDefinition> = {
    filters: FiltersState<Filters>;
    search?: string;
};
 ...
 */
export declare const useSelectableTotal: <Filters extends FiltersDefinition>({ fetchSelectableTotal, filters, search, }: {
    fetchSelectableTotal?: (options: SelectableTotalOptions<Filters>) => Promise<number>;
    filters: FiltersState<Filters>;
    search: string | undefined;
}) => number | undefined;

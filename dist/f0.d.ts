...
declare const F0EmptyState: WithDataTestIdReturnType_3<typeof _F0EmptyState>;
export { F0EmptyState }
export { F0EmptyState as OneEmptyState }

declare function _F0EmptyState({ title, description, variant, emoji, actions, ...rest }: Types.F0EmptyStateProps): JSX_2.Element;

declare type F0EmptyStateProps = {
    /**
...
export { F0EmptyStateProps }
export { F0EmptyStateProps as OneEmptyStateProps }

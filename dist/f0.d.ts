 ...
 */
export declare type AiChatDisclaimer = {
    text: string;
    link?: string;
    linkText?: string;
};
...
} & Pick<AiChatState, "greeting" | "agent" | "disclaimer">;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const F0AiChatProvider: ({ enabled, greeting, initialMessage, welcomeScreenSuggestions, disclaimer, onThumbsUp, onThumbsDown, children, agent, ...copilotKitProps }: AiChatProviderProps) => JSX_2.Element;

 ...
 */
export declare interface DashboardItemBadge {
...
export declare type DashboardItemRenderState = (typeof dashboardItemRenderStates)[number];

export declare interface DashboardItemRenderStateChange {
...
export declare const dashboardItemRenderStates: readonly ["loading", "ready", "error"];
...
export declare const F0AnalyticsDashboard: {
    <Filters extends FiltersDefinition_2 = FiltersDefinition_2>({ filters, presets, defaultFilters, filtersValue, onFiltersChange, items, itemFilters, itemBadge, renderCycleKey, onItemRenderStateChange, editMode, onLayoutChange, enableExport, exportFilename, onExportReady, resetKey, onTransformChart, onAskAi, onAskAiTarget, navigationFilters, filtersLoading, }: F0AnalyticsDashboardProps_2<Filters>): JSX_2.Element;
    displayName: string;
};

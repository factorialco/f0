...
declare type GroupGridWidget<Meta extends Record<string, unknown> = Record<string, unknown>, Deps extends string[] = string[]> = {
    id: string;
    availableSizes?: GroupGridWidgetSize[];
    content: React.ReactNode | ((deps: Partial<Record<Deps[number], unknown>>) => React.ReactNode);
    x: number;
    y: number;
    locked?: boolean;
    meta?: Meta;
...
export declare const Layout: {
    ...
    GroupGrid: {
        <Widget extends GroupGridWidget_2>({ widgets, editMode, onChange, WidgetWrapper, main, deps: dependencyValues, }: GroupGridProps_2<Widget>): JSX_2.Element;
        displayName: string;
    };
    GroupMasonry: {

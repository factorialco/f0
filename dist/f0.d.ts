...
export declare type F0AnalyticsDashboardAreaSelection = F0DataChartAreaSelection;

export declare type F0AnalyticsDashboardAskAiTarget = F0AnalyticsDashboardAskAiTargetBase & ({
 ...
 * exclusive.
 */
declare interface F0AnalyticsDashboardAskAiTargetBase {
    id: string;
    title: string;
}
...
export declare type F0DataChartAreaSelectionPoint = Omit<F0DataChartPointClick, "source" | "clientX" | "clientY">;

declare interface F0DataChartAreaSelectionProps {
    /**
...
declare interface F0DataChartBaseProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps, F0DataChartAreaSelectionProps {
 ...
 * value→color mapping.
 */
export declare interface F0DataChartHeatmapProps extends F0DataChartCommonProps, F0DataChartAreaSelectionProps {
    /** Chart type */
    type: "heatmap";
 ...
 */
export declare interface F0DataChartScatterProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps, F0DataChartAreaSelectionProps {
    /** Chart type */
    type: "scatter";

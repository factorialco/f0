 ...
 * Response
 */
export declare type DataResponse<T> = NotPaginatedResponse<T> | PaginatedResponse<T>;
...
export declare function getPaginationType(paginationType: PaginationType | undefined): PaginationType;
...
export declare function isAccumulativePagination(paginationType?: PaginationType): boolean;

export declare function isAccumulativePagination(paginationInfo?: PaginationInfo | null): boolean;

export declare function isInfiniteScrollPagination(paginationType?: PaginationType): boolean;
 ...
 */
export declare function isNotPaginatedResponse<R>(response: DataResponse<R>): response is NotPaginatedResponse<R>;

export declare function isPagesPagination(paginationType?: PaginationType): boolean;

export declare function isPagesPagination<R extends RecordType>(pagination: PaginationInfo | null): pagination is PageBasedPaginatedResponse<R>;

/**
 * Is the data paginated?
 */
export declare function isPaginatedPagination(paginationType?: PaginationType): boolean;

export declare function isPaginatedPagination<R extends RecordType>(pagination?: PaginationInfo | null): pagination is PaginatedResponse<R>;
 ...
 */
export declare type NotPaginatedResponse<T> = T[];

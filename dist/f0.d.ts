...
declare type AiChatProviderReturnValue = {
    ...
    setClarifyingQuestion: React.Dispatch<React.SetStateAction<ClarifyingQuestion | undefined>>;
};
 ...
 */
declare interface ClarifyingQuestion {
...
export declare const F0AiChatTextArea: ({ submitLabel, inProgress, onSend, onStop, placeholders, defaultPlaceholder, autoFocus, entityResolvers, toolHints, activeToolHint, onActiveToolHintChange, clarifyingQuestion, }: F0AiChatTextAreaProps) => JSX_2.Element;

 ...
 */
declare type ChatDashboardInsightContent = {
    content: "text";
} | {
    content: "person";
    avatar: {
...
declare interface ChatDashboardInsightItem extends ChatDashboardItemBase {
    type: "insight";
...
declare type ChatDashboardItem = ChatDashboardChartItem | ChatDashboardMetricItem | ChatDashboardCollectionItem | ChatDashboardInsightItem;
 ...
 */
declare interface DashboardInsightItem extends DashboardItemBase {
    type: "insight";
 ...
 */
export declare type DashboardItem<Filters extends FiltersDefinition = FiltersDefinition> = DashboardChartItem<Filters> | DashboardMetricItem<Filters> | DashboardCollectionItem<Filters> | DashboardInsightItem;

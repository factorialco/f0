...
import { useInsertionEffect as Bn, forwardRef as C, createElement as Oe, useRef as $, useMemo as re, useEffect as Y, useState as P, useLayoutEffect as _t, useCallback as X, createContext as a1, useContext as We, useId as Ot, memo as $n } from "react";
import { c9 as In, ca as Pn, cb as jn, cc as Dn, cd as Zt, ce as _n, cf as On, cg as Zn, ch as Un, ci as zn, cj as Ut, ck as Gn, cl as Wn, cm as qn, cn as Xn, co as Yn, cp as Kn, cq as Qn, cr as r1, cs as Jn, ct as eo, cu as to, cv as ro, cw as no, cx as oo, W as zt, cy as so, cz as io, cA as ao, cB as co, cC as lo, cD as Gt, cE as uo, cF as fo, a3 as T1, cG as ho, aG as po, cH as go, cI as mo, cJ as Co, ad as vo, cK as wo, bH as xo, a7 as A1, aa as ko, cL as bo, b7 as H1, _ as Wt, N as c1, cM as qt, b6 as Lo, cN as yo, cO as Mo, a$ as Eo, bG as Ro, Y as Ee, ar as No, bb as Xt, cP as Fo, bE as Yt, cQ as Fe, bA as So, cR as Vo, cS as Kt, a_ as Qt, cT as To, cU as Ao, cV as Ho, cW as Bo, cX as $o, cY as Jt, bs as Io, bt as Po, cZ as jo, c_ as Do, c$ as _o, d0 as Oo, d1 as Zo, d2 as Uo, d3 as zo, d4 as Go, d5 as Wo, d6 as qo, d7 as Xo, d8 as Yo, d9 as Ko, bF as Qo, a8 as Jo, bo as es, da as ts, db as rs, dc as ns, dd as os, de as ss, df as is, dg as as, am as cs, dh as er, J as ls, Z as ds, di as tr, dj as us, ba as fs, b9 as hs, dk as ps, dl as rr, dm as gs, aZ as ms, av as Cs, dn as vs, ap as ws, b4 as xs, dp as nr, dq as ks, dr as bs, bf as B1, ds as Ls, dt as $1, bC as ys, bB as Ms, bD as or, du as Es, z as Rs, y as Ns, dv as Fs, dw as Ss, dx as Vs, dy as Ts, dz as As, dA as sr, dB as Hs, a9 as Bs, dC as $s, H as he, o as Se, m as L, ab as fe, dD as Is, bi as Ps, bv as js, w as ir, dE as Ds, a2 as l1, bU as _s, aq as Os, M as me, C as ce, a5 as ar, ac as cr, bj as lr, dF as Zs, aY as dr, s as Ce, dG as Us, dH as zs, S as pe, u as J, c7 as ur, $ as Gs, dI as Ws, aM as Le, A as Me, n as te, aA as I1, dJ as qs, aB as P1, aC as j1, b as Re, dK as Xs, bw as Ys, O as Ks, dL as Qs, dM as Js, dN as ei, dO as K1, a0 as ti, ah as fr, aP as hr, dP as ri, bT as ni, dQ as oi, dR as si, aU as pr, dS as ii, bN as ai, dT as ci, aR as Ge, bd as gr, dU as mr, be as Cr, dV as vr, dW as li, bh as di, dX as ui, b5 as D1, bp as fi, dY as hi, dZ as pi, d_ as gi, d$ as mi, e0 as Ci, x as vi, e1 as wr, e2 as xr, e3 as wi, ag as Q1, e4 as xi, af as ki, e5 as bi, e6 as Li, c as yi } from "./F0CanvasPanel-gWAodcny.js";
import { createPortal as kr } from "react-dom";
import { defaultTranslations as Mi } from "./i18n-provider-defaults.js";
import { useTrackVolume as Ei } from "@livekit/components-react";
import './F0AiChatWelcomeCards.css';function Ri(e, t, n) {
  Bn(() => e.on(t, n), [e, t, n]);
}
function _1(e) {
...
function br(e, t, n, o) {
  return typeof e == "string" && _1(t) ? In(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Ni(e, t, n) {
  return e * (t + 1);
}
...
function Lr(e, t) {
  return Pn(e) ? e[Fi(0, e.length, t)] : e;
}
function Si(e, t, n) {
...
const Hi = "easeInOut", Bi = 20;
function $i(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let p = 0; p < e.length; p++) {
    ...
    const N = (R, E, y, V = 0, b = 0) => {
      const T = Ii(R), { delay: k = 0, times: M = _n(T), type: A = "keyframes", repeat: j, repeatType: _, repeatDelay: Z = 0, ...G } = E;
      let { ease: q = t.ease || "easeOut", duration: U } = E;
      const z = typeof k == "function" ? k(V, b) : k, O = T.length, ee = Un(A) ? A : s?.[A];
      if (O <= 2 && ee) {
        let se = 100;
        if (O === 2 && Di(T)) {
          const ue = T[1] - T[0];
        ...
        const ne = { ...G };
        U !== void 0 && (ne.duration = zn(U));
        const ie = On(ne, se, ee);
      ...
      if (le > 0 && Zn(M, le), T.length === 1 && T.unshift(null), j) {
        Ut(j < Bi, "Repeat count too high, must be less than 20"), U = Ni(U, j);
        const se = [...T], ne = [...M];
        ...
        for (let ue = 0; ue < j; ue++) {
          ...
          for (let F = 0; F < se.length; F++)
            M.push(ne[F] + (ue + 1)), q.push(F === 0 ? "linear" : Lr(ie, F - 1));
        }
        Ti(M, j);
      }
      const de = Q + U;
      Vi(y, T, q, M, Q, de), S = Math.max(z + U, S), m = Math.max(de, m);
    };
    if (Zt(w)) {
      const R = et(w, l);
      N(v, x, tt("default", R));
      ...
      for (let y = 0; y < E; y++) {
        v = v, x = x;
        const V = R[y], b = et(V, l);
        for (const T in v)
          N(v[T], Pi(x, T), tt(T, b), y, E);
      }
    }
    u = h, h += S;
  }
  return l.forEach((p, g) => {
    for (const w in p) {
      ...
      for (let E = 0; E < v.length; E++) {
        ...
        x.push(V), S.push(Gn(0, m, y)), N.push(b || "easeOut");
      }
      S[0] !== 0 && (S.unshift(0), x.unshift(x[0]), N.unshift(Hi)), S[S.length - 1] !== 1 && (S.push(1), x.push(null)), a.has(g) || a.set(g, {
        keyframes: {},
        transition: {}
      });
      const R = a.get(g);
...
const ji = (e) => typeof e == "number", Di = (e) => e.every(ji);
function _i(e, t) {
  return e in t;
}
class Oi extends Wn {
...
function yr(e, t, n, o) {
  const s = [];
  if (zi(e, t))
    s.push(Jn(e, _1(t) && t.default || t, n && (n.default || n)));
  else {
    const i = br(e, t, o), a = i.length;
    Ut(!!a, "No valid elements provided.");
    for (let l = 0; l < a; l++) {
      const c = i[l], f = c instanceof Element ? Zi : Ui;
      r1.has(c) || f(c);
      const u = r1.get(c), h = { ...n };
      "delay" in h && typeof h.delay == "function" && (h.delay = h.delay(l, a)), s.push(...eo(u, { ...t, transition: h }, {}));
    }
  }
  return s;
}
function Gi(e, t, n) {
  const o = [];
  return $i(e, t, n, { spring: to }).forEach(({ keyframes: i, transition: a }, l) => {
    o.push(...yr(l, i, a));
  }), o;
}
class Wi {
...
function Yi(e) {
  function t(n, o, s) {
    let i = [];
    return Xi(n) ? i = Gi(n, o, e) : i = yr(n, o, s, e), new qi(i);
  }
  return t;
}
const Ki = Yi(), Qi = (e, t) => /* @__PURE__ */ d(
  "svg",
  {
...
), c2 = C(a2), l2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Ji,
  Add: ro,
  Ai: no,
...
const De = Se({
  ...
  ({
    ...
    const h = s ?? h2[t ?? "body"], m = c ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (i !== void 0) {
      ...
      return m ? Oe(
        ...
        fe,
        {
          ...
          noTooltip: a,
          tag: h,
          className: L(De({ variant: t, align: n }), o),
          markdown: l,
          ...f,
          children: e
        }
...
const S2 = Se({
  ...
  ({
    ...
    const Pe = O && O !== "none" || ee && ee !== "none" || Q && Q !== "none" || le && le !== "none", h1 = z && z !== "none" || Pe, p1 = { sm: d1, md: qe, lg: u1, xl: f1 }, g1 = V2.map((Ye) => {
      const je = p1[Ye];
      return je ? F2(Ye, je) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
}), v1 = { sm: 640, md: 768, "container-md": 448 }, F1 = (e) => "type" in e && e.type === "separator", n1 = (e) => "type" in e && e.type === "split", A2 = (e) => !("type" in e), o1 = (e, t, n) => /* @__PURE__ */ r(
  me,
  {
    label: e.label,
    icon: e.icon,
...
function rt({
  ...
  const u = $(null), { width: h = 0 } = js({
    ref: u,
    box: "border-box"
  }), m = a === "sm" || a === "md" ? v1[a] : v1.md, p = ir(`(min-width: ${m}px)`, {
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: { gap: s },
      children: g ? /* @__PURE__ */ r(B2, { ...R }, "row") : /* @__PURE__ */ r(H2, { ...R }, "stacked")
    }
  );
}
function H2({
...
function B2({
  ...
  const g = p ? h : l, w = p ? m : [], v = new Set(g.map((b) => b.id)), x = e ? Xr(e, s) : null, S = t.filter(n1), N = t[t.length - 1], R = N != null && F1(N) && (S.length > 0 || x != null), E = [];
  t.forEach((b, T) => {
    if (!n1(b)) {
      if (F1(b)) {
...
const Yr = C(
  function({
        ...
        children: [
          m && !v && /* @__PURE__ */ r(
            dr,
            {
              href: m,
              variant: "unstyled",
              className: L("z-1 absolute inset-0 block rounded-xl", Ce()),
              "aria-label": t,
              children: " "
            }
          ),
          /* @__PURE__ */ d("div", { className: $2[x], children: [
    ...
    return N ? /* @__PURE__ */ r(zs, { ref: S, alert: g, fullHeight: p, children: R }) : R;
  }
);
Yr.displayName = "F0CardRow";
const O2 = ({ compact: e = !1 }) => /* @__PURE__ */ r(
  lr,
  {
    className: L(
  ...
  cr(Yr, O2)
), g3 = ["xs", "sm", "md", "lg"], Z2 = 2, st = 2, U2 = 70, it = 0.08, z2 = 6, G2 = 0.6, W2 = () => {
  ...
  return Y(() => {
    ...
    const c = () => {
      ...
      s(
        Math.max(1, Math.floor((u + st) / (Z2 + st)))
      );
    };
    ...
    const h = new Uint8Array(u.fftSize), m = setInterval(() => {
      ...
      const g = Math.sqrt(p / h.length), w = Math.min(1, Math.pow(g * z2, G2));
      a((v) => {
        ...
        a && /* @__PURE__ */ d(
          j1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: s4(a.items).map((l, c) => /* @__PURE__ */ d(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
const c4 = 250, l4 = 12e4, d4 = () => typeof navigator < "u" && !!navigator.mediaDevices?.getUserMedia && typeof MediaRecorder < "u";
function u4({
  onTranscribe: e,
  onPartial: t,
  onFinal: n,
  ...
  const [i, a] = P("idle"), [l, c] = P(0), [f] = P(d4), [u, h] = P(null), m = $(null), p = $(null), g = $([]), w = $(null), v = $(!1), x = $(null), S = $(null), N = $(0), R = $({ onTranscribe: e, onPartial: t, onFinal: n, onError: o });
  ...
  const E = X(() => {
    ...
    m.current = M, M.ondataavailable = (A) => {
      ...
      y();
    }, M.start(c4), N.current = Date.now(), a("recording"), c(0), x.current = setInterval(() => {
...
` || Z === "	";
  ...
  const T = re(() => {
    ...
    const M = s.current;
    if (!M) return null;
    const A = v4(M, x.current), j = M.offsetLeft + A.left, Z = (M.offsetParent ? M.offsetParent.offsetHeight : 0) - (M.offsetTop + A.top);
...
const k4 = /[\\`*_{}[\]()#+\-.!|~>]/g, b4 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(k4, "\\$&")).join(""), m3 = ({
  onSubmit: e,
  onStop: t,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const y = J(), V = Le(), [b, T] = P(""), [k, M] = P(0), [A, j] = P(!1), [_, Z] = P(!1), [G, q] = P(null), U = $(null), z = $(null), O = $(null), ee = a != null, { tracking: Q } = Re(), le = X(
    (oe, be) => {
  ...
  const qe = ve.status === "recording", u1 = qe ? y.ai.listening : y.ai.inputPlaceholder, f1 = de.filter((oe) => oe.status === "uploaded"), Ae = de.some((oe) => oe.status === "uploading"), Xe = de.some((oe) => oe.status === "error"), Pe = b.trim().length > 0;
  Y(() => {
    if (!(!_ || Ae)) {
      if (Z(!1), Xe) {
  ...
  const h1 = async (oe) => {
    if (oe.preventDefault(), !ee) {
      if (K.close(), n)
        ...
        const be = K.transformMentions(b.trim()), m1 = b4(be), Qe = f1.flatMap(
    ...
    ee || K.handleKeyDown(oe) || oe.key === "Enter" && !oe.shiftKey && (oe.preventDefault(), n || U.current?.requestSubmit());
  }, g1 = () => {
    M(z.current?.selectionStart ?? 0);
  }, Ye = () => {
    O.current && z.current && (O.current.scrollTop = z.current.scrollTop);
  }, je = G ? G.prompt ?? G.title : null, G1 = qe ? [y.ai.listening] : je ? [je] : s ?? [], Sn = G1.length > 1, Vn = re(() => a4(b, K.mentions, {
    cursorPosition: k,
    inlineCompletion: K.inlineCompletion
  }), [b, K.mentions, k, K.inlineCompletion]), Tn = K.mentions.length > 0 || K.inlineCompletion !== null, Ke = x && !!N && N.length > 0 && !!R ? /* @__PURE__ */ r(
    i4,
    {
      suggestions: N,
      onItemClick: le,
    ...
    te.div,
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ r(J2, { creditWarning: i, children: /* @__PURE__ */ d(
            te.form,
            {
              "aria-busy": n,
              ref: U,
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          ei,
          {
            ...
            children: c ? /* @__PURE__ */ r(K1.Skeleton, {}) : /* @__PURE__ */ r(K1, { ...g })
          }
        )
      ]
    }
...
const sn = 60, an = 40, ct = 2e3, r6 = 500, n6 = 12e3, cn = 2, Ze = 40, He = [255, 60, 0], x1 = [160, 140, 220], k1 = { x: -12, y: 0, z: 0 }, b1 = { x: -12, y: 12, z: 90 }, Be = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, L1 = Math.PI / 180, o6 = cn / 8 * Math.PI, s6 = 4 * Math.PI;
function s1(e, t) {
  return [
...
const d6 = Object.keys(Be).map(Number).sort((e, t) => e - t);
function u6(e) {
  const t = d6;
...
const dt = Math.sqrt(sn ** 2 + an ** 2), y1 = [sn / dt, an / dt, 0], f6 = ln(k1.x, k1.y, k1.z), h6 = ln(b1.x, b1.y, b1.z), $e = cn * 3, t1 = Ze + 1, ut = ($e + 1) * t1, i1 = 4 * $e * Ze, M1 = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
], p6 = (e, t) => e.avgZ - t.avgZ;
function g6() {
...
function ft(e, t, n, o) {
  const { quads: s, grid: i } = e, a = n * 0.392, l = n / 2, c = n / 2, f = o6 * u6(n), u = t * s6, h = Ue(0, 0, 1, o * 2 * Math.PI);
  lt(h, y1[0], y1[1], y1[2], Ne);
  const m = Ue(Ne[0], Ne[1], Ne[2], u), p = s1(m, f6), g = s1(m, h6);
  M1[0] = p, M1[1] = g;
  let w = 0;
  for (let v = 0; v < 4; v++) {
    ...
    for (let N = 0; N <= $e; N++) {
      ...
      for (let T = 0; T <= Ze; T++) {
        ...
        lt(x, E * Math.cos(k), y, E * Math.sin(k), Ne);
        const M = i[b + T];
    ...
    for (let N = 0; N < $e; N++) {
      ...
      for (let y = 0; y < Ze; y++) {
        ...
        const A = (V.x + b.x + T.x + k.x) * 0.25, j = (V.y + b.y + T.y + k.y) * 0.25, _ = (V.z + b.z + T.z + k.z) * 0.25, Z = A * a, G = j * a, q = V.x * a - Z, U = V.y * a - G, z = Math.sqrt(q * q + U * U), O = z > 0 ? (z + 0.9) / z : 1, ee = l + Z + q * O, Q = c - G - U * O, le = b.x * a - Z, de = b.y * a - G, se = Math.sqrt(le * le + de * de), ne = se > 0 ? (se + 0.9) / se : 1, ie = l + Z + le * ne, ue = c - G - de * ne, F = k.x * a - Z, B = k.y * a - G, H = Math.sqrt(F * F + B * B), D = H > 0 ? (H + 0.9) / H : 1, I = l + Z + F * D, W = c - G - B * D, ae = T.x * a - Z, K = T.y * a - G, ge = Math.sqrt(ae * ae + K * K), xe = ge > 0 ? (ge + 0.9) / ge : 1, Ve = l + Z + ae * xe, ve = c - G - K * xe, Te = s[w];
        Te.points = `${ee},${Q} ${ie},${ue} ${I},${W} ${Ve},${ve}`, Te.color = l6((A + 1) * 0.5), Te.avgZ = _, w++;
      }
    }
  }
  for (let v = w; v < i1; v++)
...
const m6 = ({ size: e = 20, className: t, style: n, variant: o = "default" }, s) => {
  ...
  return Y(() => {
    ...
    const y = (M) => {
      ...
      let A = 0, j = !0;
      if (o === "continuous") {
        const q = ct * 2, U = (M - w) % q / q;
        A = U < 0.5 ? U * 2 : (1 - U) * 2, j = !1;
      } else N === "spin" ? (A = Math.min((M - w) / ct, 1), A >= 1 && (A = 0, N = "pause", x = M)) : (A = 0, M - x >= r6 && (N = "spin", w = M));
      const _ = (M - v) / n6 % 1, Z = j ? a6(A) : A, G = ft(p, Z, e, _);
...
const pt = 7, v6 = 625, gt = /* @__PURE__ */ new Set();
function w6(e) {
...
function fn(e, t) {
  ...
  return { type: "item", text: x6(String(e)) };
}
function hn({
  formName: e,
  formDescription: t,
  ...
  const { canvasContent: c, openCanvas: f, closeCanvas: u } = Re(), h = C6(e), m = l ?? h, p = $(() => {
  ...
  p.current = x, Y(() => {
    typeof window > "u" || window.innerWidth < v6 || gt.has(e) || (gt.add(e), p.current());
  }, [e]);
  const S = i && a ? Object.entries(i).map(([E, y]) => {
    ...
    if (!b && y.fieldType === "custom" && typeof V == "object" && V !== null)
      return null;
    const T = b ?? fn(V, y.fieldType), k = ["richtext", "textarea"];
    return {
      label: y.label,
      content: T,
...
const mn = a1(void 0), k3 = () => We(mn), M6 = (e) => /* @__PURE__ */ r(pr, { content: e, format: "markdown" }), E6 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const l = typeof n?.content == "string" ? n.content : "", c = (n && o?.(n)) ?? n?.generativeUI?.() ?? null, f = n?.toolCalls?.[0]?.id, u = !l && !c, h = $(null), { anchor: m, clear: p } = pn({
    containerRef: h,
    enabled: !!(n?.id && l)
  });
  return Y(() => {
...
const S6 = ({
  ...
  const o = J(), { open: s } = vn(), [i, a] = P(null);
...
const wn = (e) => /* @__PURE__ */ r(pr, { content: e, format: "markdown" }), B6 = ({
  text: e,
  renderMarkdown: t
  ...
  const a = e.rawData, l = H6(
    e?.content,
    a
  ), c = (A6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = c.length > 0, { anchor: h, clear: m } = pn({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ r(B6, { text: f, renderMarkdown: o }),
...
}, I6 = 35, P6 = 22, j6 = 400, D6 = 2500, _6 = 220, O6 = ({
  messages: e,
  onClick: t,
  fullscreen: n = !1
}) => {
  ...
  Y(() => {
    ...
    let m;
    if (l === "starting")
      m = setTimeout(() => c("writing"), j6);
    else if (l === "writing")
      i < f.length ? m = setTimeout(() => a((p) => p + 1), I6) : c("holding");
    else if (l === "holding") {
      if (e.length <= 1) return;
      m = setTimeout(() => c("erasing"), D6);
    } else l === "erasing" && (i > 0 ? m = setTimeout(() => a((p) => p - 1), P6) : m = setTimeout(() => {
...
const U6 = {
...
}, b3 = (e) => /* @__PURE__ */ r(N6, { children: /* @__PURE__ */ r(z6, { ...e }) }), z6 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: N, handleSubmit: R, handleClose: E } = F6(
    u ?? U6
  ), y = J(), V = w ?? E6, b = v ?? $6, T = re(() => {
    const O = o ?? y.ai.defaultInitialMessage;
    return (Array.isArray(O) ? O : [O]).filter((Q) => typeof Q == "string" && Q.length > 0);
  }, [o, y.ai.defaultInitialMessage]), k = !t && e.length === 0 && T.length > 0, M = $(null), A = $(null), j = $(null), _ = $(null), Z = $(null), { showScrollBtn: G, turnMinHeight: q, scrollToBottom: U } = Z6({
    viewportRef: M,
    contentRef: A,
    endRef: j,
    lastTurnRef: Z,
...
}, G6 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ d("div", { className: "flex flex-col gap-2", children: [
...
const q6 = ({
  ...
  const m = J().ai.clarifyingQuestion.typeYourAnswer, p = e === "single" ? /* @__PURE__ */ r(kn, { isSelected: n && !t }) : /* @__PURE__ */ r(
    vr,
    {
      checked: s,
      onCheckedChange: () => f(!s),
...
const Y6 = ({
  ...
  }, O = M ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, ee = N === !0 && !j && !(y && _), Q = () => {
...
function kt(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), l = Math.min(i + o, s), c = Math.min(l, Math.floor(e / 2)), f = Math.min(l, Math.floor(t / 2)), u = (Q) => Q / e * 2 - 1, h = (Q) => Q / t * 2 - 1, m = 0, p = e, g = 0, w = t, v = c, x = e - c, S = f, N = t - f, R = u(m), E = u(p), y = h(g), V = h(w), b = u(v), T = u(x), k = h(S), M = h(N), A = 0, j = 0, _ = 1, Z = 1, G = c / e, q = 1 - c / e, U = f / t, z = 1 - f / t, O = new Float32Array([
    // Top strip
    R,
    y,
    E,
...
class N3 {
  ...
  setupGL() {
    ...
    const R = (this.options.colors || o9).map(s9);
...
const Lt = ["lowp", "mediump", "highp"], i9 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, a9 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, Mt = "iTime", Et = "iTimeDelta", Rt = "iDate", Nt = "iFrame", Ft = "iMouse", St = "iResolution", c9 = "iChannel", Vt = "iChannelResolution", Tt = "iDeviceOrientation";
function l9(e, t) {
...
}, E1 = 9729, At = 9728, p9 = 9987, Ht = 33071, Bt = 10497;
class g9 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    return (t.wrapS !== Ht || t.wrapT !== Ht || t.minFilter !== At && t.minFilter !== E1) && !y && (E = this.makePowerOf2(E), y = !0), n.bindTexture(n.TEXTURE_2D, N), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, c), n.texImage2D(
      n.TEXTURE_2D,
      h,
      m,
      v,
      x,
      E
    ), y && t.minFilter !== At && t.minFilter !== E1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || Bt
    ), n.texParameteri(
...
}, It = (e, t, n) => e * (1 - n) + t * n, m9 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function C9({
  fs: e,
  vs: t = yt,
  textures: n = [],
...
${B}`));
    ...
    if (o)
      for (const F of Object.keys(o)) {
        const B = o[F];
        if (!B) continue;
        const { value: H, type: D } = B, I = h9(D);
        if (!I) continue;
        const W = {};
        if (l9(D, H)) {
          const ae = D.length, K = Number.parseInt(D.charAt(ae - 3)), ge = Math.floor(H.length / (K * K));
          H.length > K * K && (W.arraySize = `[${ge}]`);
        } else d9(D, H) && (W.arraySize = `[${Math.floor(H.length / Number.parseInt(D.charAt(0)))}]`);
        k.current[F] = {
          type: I,
          isNeeded: !1,
          value: H,
...
`,
    ...
    return F.includes("mainImage") && (D = D.concat(i9)), D;
  }, se = (F) => {
    const B = g.current;
    ...
    if (k.current.iDate?.isNeeded) {
      const I = /* @__PURE__ */ new Date(), W = I.getMonth() + 1, ae = I.getDate(), K = I.getFullYear(), ge = I.getHours() * 60 * 60 + I.getMinutes() * 60 + I.getSeconds() + I.getMilliseconds() * 1e-3, xe = B.getUniformLocation(
        v.current,
        Rt
      );
      B.uniform4fv(xe, [K, W, ae, ge]);
    }
    ...
    if (V.current.length > 0)
      for (let I = 0; I < V.current.length; I++) {
        const W = V.current[I];
        if (!W) return;
        const { isVideo: ae, _webglTexture: K, source: ge, flipY: xe, isLoaded: Ve } = W;
        if (!Ve || !K || !ge) return;
    ...
    if (k.current.iMouse?.isNeeded && c !== 1 && Array.isArray(H)) {
      ...
      H[0] = It(D, y.current[0] ?? 0, c), H[1] = It(I, y.current[1] ?? 0, c);
    }
  ...
  return Y(() => {
    ...
    function B() {
      j();
      const H = g.current;
      H && p.current && (H.clearColor(...s), H.clearDepth(1), H.enable(H.DEPTH_TEST), H.depthFunc(H.LEQUAL), H.viewport(0, 0, p.current.width, p.current.height), p.current.height = p.current.clientHeight, p.current.width = p.current.clientWidth, Q(), le(), ee(de(e || a9), t || yt), _(), requestAnimationFrame(ne), ie(), z());
    }
...
}`, w9 = 10, x9 = 2, k9 = 0.5, b9 = 0.2, L9 = 1.5, we = {
  duration: 0.5,
  ease: "easeOut"
}, Pt = {
  duration: 0.35,
...
function y9(e, t) {
  const [n, o] = P(w9), {
    ...
    animate: i,
    motionValue: a
  } = Je(b9), { value: l, animate: c } = Je(x9), { value: f, animate: u } = Je(k9), { value: h, animate: m } = Je(L9), p = Ei(t, {
    fftSize: 512,
...
function F3({
  ...
  const { speed: f, scale: u, amplitude: h, frequency: m, brightness: p } = y9(t, s);
  return /* @__PURE__ */ r(
    Ln,
    {
      ref: l,
...
const S3 = ({
  ...
  const o = J(), s = Le();
  return /* @__PURE__ */ d(ke, { children: [
    e && /* @__PURE__ */ r("span", { className: L(N9(), "truncate"), children: e }),
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: L(yn()), children: t }),
    /* @__PURE__ */ d(
      te.div,
      {
        ...
        children: [
          ...
          o === "balance" && /* @__PURE__ */ r(V9, { balance: e.balance })
        ]
      }
    ),
    n && !S9.has(o) && /* @__PURE__ */ r(
      te.span,
      {
        className: L(e1()),
        animate: { opacity: s ? 0 : 1 },
...
const H9 = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), B9 = ({
  label: e,
  direction: t
}) => {
  const n = Mn[t];
  ...
  const s = `sparkline-gradient-${Ot().replace(/:/g, "")}`, i = A9(e, n), a = Mn[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(pi, { width: "100%", height: "100%", children: /* @__PURE__ */ d(
          gi,
          {
            data: e,
        ...
        /* @__PURE__ */ r(B9, { label: t, direction: i })
      ]
    }
  ) });
}, En = C(
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: L(yn()), children: o }),
              /* @__PURE__ */ r(
                te.div,
                {
...
const I9 = ["className"], Rn = C((e, t) => {
  const n = I9.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
...
const P9 = () => /* @__PURE__ */ d(
  ...
  "balance",
  "sparkline"
], Nn = 180, j9 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Nn, D9 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, _9 = (e) => e.showActions !== !1, O9 = (e) => Object.fromEntries(
...
function Z9(e) {
  ...
  } = e, [c, f] = P(!1), u = Ot(), h = $(null), m = j9(
    l
  ), p = i.length > m, g = c ? i : D9(i, m), w = _9(e) ? e : null, v = O9(e);
  return Y(() => {
    c && h.current?.focus();
  }, [c]), /* @__PURE__ */ d(
    "section",
...
}, z9 = (e) => l2[e] ?? Jt, G9 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(ce, { icon: z9(e), size: "md", color: "default" }) }) : null;
function W9({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(U9, { icon: B1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(G9, { iconName: s.icon });
...
W9.displayName = "F0AiMessageSources";
async function q9(e, t, n) {
  const o = await import("./xlsx-Bedf3nwD.js"), s = o.utils.table_to_book(e, { sheet: "Data" });
  o.writeFile(s, `${n}.${t}`);
}
function X9({
...
X9.displayName = "F0AiTableCard";
function Y9({ credits: e }) {
...
const K9 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function Q9({
  employeeCredits: e
}) {
...
const jt = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(Q9, { employeeCredits: t }) : e ? /* @__PURE__ */ r(Y9, { credits: e }) : null, A3 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const m = J(), p = ir(`(max-width: ${vi.md}px)`, {
...
function t3(e, t) {
  const n = new Date(e), o = J9(), s = Q1(n, "p", { locale: o });
...
function B3({
  ...
  const [o, s] = P([]), [i, a] = P(!1), [l, c] = P(null), [f, u] = P(s3), h = X(async () => {
    a(!0), c(null);
    try {
      const w = await t();
      s(w);
...
const i3 = te.create(yi), a3 = ({ label: e }) => /* @__PURE__ */ d("div", { className: "flex flex-row items-center gap-1 rounded-full border border-solid border-f1-border-secondary bg-f1-background px-2 py-1.5 pr-2.5 shadow-md", children: [
  /* @__PURE__ */ r(
    i3,
    {
      size: "xs",
  ...
  return Y(() => {
    ...
    /* @__PURE__ */ r(
      te.div,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "mt-[40vh]", children: /* @__PURE__ */ r(a3, { label: a }) })
      }
    ) }),
    /* @__PURE__ */ r(
      te.div,

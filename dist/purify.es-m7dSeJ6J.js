...
function x(t) {
	let n = s(null);
	for (let [r, i] of e(t)) h(t, r) && (n[r] = Array.isArray(i) ? b(i) : i && typeof i == "object" && i.constructor === Object ? x(i) : i);
	return n;
}
function S(e, t) {
	for (; e !== null;) {
...
function Ae() {
		...
		for (; i--;) {
			...
			if (D && typeof C == "object" && typeof C.getAttributeType == "function" && !o) switch (C.getAttributeType(f, c)) {
				case "TrustedHTML":
					d = D.createHTML(d);
					break;
				case "TrustedScriptURL": d = D.createScriptURL(d);
			}
			if (d !== l) try {
	...
	return n.sanitize = function(e) {
		...
		if (lt = !e, lt && (e = "<!-->"), typeof e != "string" && !Tt(e)) {

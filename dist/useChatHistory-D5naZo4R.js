import { jsxs as c, jsx as r, Fragment as we } from "react/jsx-runtime";
import { useInsertionEffect as Or, forwardRef as g, createElement as He, useRef as I, useMemo as K, useEffect as q, useLayoutEffect as lt, useState as P, useCallback as G, createContext as Ue, useContext as $e, useId as dt } from "react";
import { cf as Ur, cg as zr, ch as Gr, ci as Wr, cj as ft, ck as qr, cl as Xr, cm as Yr, cn as Kr, co as Qr, cp as ut, cq as Jr, cr as en, cs as tn, ct as rn, cu as nn, cv as on, cw as sn, cx as Ze, cy as an, cz as cn, cA as ln, cB as dn, cC as fn, W as ht, cD as un, cE as hn, cF as Cn, cG as gn, cH as pn, cI as Ct, cJ as mn, cK as vn, a3 as o1, cL as wn, aG as kn, cM as xn, cN as Ln, cO as bn, ad as yn, cP as Mn, bK as En, a7 as s1, aa as Rn, cQ as Fn, b7 as i1, _ as gt, N as ze, cR as pt, b6 as Nn, cS as Sn, cT as Vn, a$ as Tn, bJ as Hn, Y as be, ar as An, bb as mt, cU as $n, bH as Bn, cV as Ee, bD as In, cW as Pn, cX as vt, a_ as wt, cY as jn, cZ as Dn, c_ as Zn, c$ as _n, d0 as On, d1 as kt, bv as Un, bw as zn, d2 as Gn, d3 as Wn, d4 as qn, d5 as Xn, d6 as Yn, d7 as Kn, d8 as Qn, d9 as Jn, da as eo, db as to, dc as ro, dd as no, de as oo, df as so, bI as io, a8 as ao, br as co, dg as lo, dh as fo, di as uo, dj as ho, dk as Co, dl as go, dm as po, am as mo, dn as xt, J as vo, Z as wo, dp as Lt, dq as bt, dr as ko, ba as xo, b9 as Lo, ds as bo, dt as yo, du as yt, dv as Mo, aZ as Eo, av as Ro, dw as Fo, ap as No, b4 as So, dx as Mt, b3 as Vo, dy as To, bf as a1, dz as Ho, dA as Ao, dB as c1, bF as $o, bE as Bo, bG as Et, dC as Io, y as Po, x as jo, dD as Do, dE as Zo, dF as _o, dG as Oo, dH as Uo, dI as Rt, dJ as zo, a9 as Go, dK as Wo, H as de, ab as ie, dL as qo, by as Xo, v as Ft, dM as Yo, a2 as Ge, bX as Ko, M as he, aq as Qo, z as ae, a5 as Nt, a6 as Jo, ac as St, bm as Vt, dN as es, aY as Tt, dO as ts, dP as rs, S as fe, u as X, dQ as ns, cc as Ht, $ as os, dR as ss, aM as ye, A as Re, o as oe, aA as l1, dS as is, aB as d1, aC as f1, b as Me, dT as as, dU as cs, bz as ls, O as ds, dV as fs, dW as us, dX as hs, dY as R1, a0 as Cs, ah as At, aP as $t, dZ as gs, bW as ps, d_ as ms, d$ as vs, aU as Bt, e0 as ws, bQ as ks, e1 as xs, aR as Ae, bd as It, e2 as Pt, be as jt, c as e1, e3 as Dt, e4 as Ls, bh as bs, e5 as ys, b5 as u1, bs as Ms, e6 as Es, e7 as Rs, e8 as Fs, e9 as Ns, ea as Ss, w as Vs, eb as Zt, ec as _t, ed as Ts, ag as F1, ee as Hs, af as As, ef as $s, eg as Bs } from "./F0CanvasPanel-B_jvSEjq.js";
import { a as Fe, c as k, f as Ce } from "./utils-BFYuLEg3.js";
...
import { F as Xe } from "./index-DyKGEeWw.js";
function js(e, t, n) {
  Or(() => e.on(t, n), [e, t, n]);
}
function h1(e) {
...
function Ut(e, t, n, o) {
  return typeof e == "string" && h1(t) ? Ur(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Ds(e, t, n) {
  return e * (t + 1);
}
...
function zt(e, t) {
  return zr(e) ? e[Zs(0, e.length, t)] : e;
}
function _s(e, t, n) {
...
const Gs = "easeInOut", Ws = 20;
function qs(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let h = 0; h < e.length; h++) {
    ...
    if (typeof m == "string") {
      ...
      u.set(m.name, N1(C, m.at, f, u));
      continue;
    }
    let [v, w, x = {}] = m;
    x.at !== void 0 && (C = N1(C, x.at, f, u));
    let V = 0;
    const T = (E, b, L, A = 0, H = 0) => {
      const y = Xs(E), { delay: R = 0, times: F = qr(y), type: B = "keyframes", repeat: Z, repeatType: U, repeatDelay: W = 0, ...te } = b;
      let { ease: Q = t.ease || "easeOut", duration: _ } = b;
      const O = typeof R == "function" ? R(A, H) : R, D = y.length, re = Kr(B) ? B : s?.[B];
      if (D <= 2 && re) {
        let ce = 100;
        if (D === 2 && Qs(y)) {
          const ue = y[1] - y[0];
        ...
        const se = Xr(ne, ce, re);
        Q = se.ease, _ = se.duration;
      }
      _ ?? (_ = i);
      const Y = C + O;
      F.length === 1 && F[0] === 0 && (F[1] = 1);
      const me = F.length - y.length;
      if (me > 0 && Yr(F, me), y.length === 1 && y.unshift(null), Z) {
        ut(Z < Ws, "Repeat count too high, must be less than 20"), _ = Ds(_, Z);
        const ce = [...y], ne = [...F];
        ...
        for (let ue = 0; ue < Z; ue++) {
          ...
          for (let M = 0; M < ce.length; M++)
            F.push(ne[M] + (ue + 1)), Q.push(M === 0 ? "linear" : zt(se, M - 1));
        }
        Us(F, Z);
      }
      const ge = Y + _;
      Os(L, y, Q, F, Y, ge), V = Math.max(O + _, V), p = Math.max(ge, p);
    };
    if (ft(v)) {
      const E = S1(v, d);
      T(w, x, V1("default", E));
    } else {
      const E = Ut(v, w, o, l), b = E.length;
      for (let L = 0; L < b; L++) {
        w = w, x = x;
        const A = E[L], H = S1(A, d);
        for (const y in w)
          T(w[y], Ys(x, y), V1(y, H), L, b);
      }
    }
    f = C, C += V;
  }
  return d.forEach((h, m) => {
    for (const v in h) {
      ...
      for (let b = 0; b < w.length; b++) {
        const { at: L, value: A, easing: H } = w[b];
        x.push(A), V.push(Jr(0, p, L)), T.push(H || "easeOut");
      }
      V[0] !== 0 && (V.unshift(0), x.unshift(x[0]), T.unshift(Gs)), V[V.length - 1] !== 1 && (V.push(1), x.push(null)), a.has(m) || a.set(m, {
        keyframes: {},
        transition: {}
      });
      const E = a.get(m);
...
const Ks = (e) => typeof e == "number", Qs = (e) => e.every(Ks);
function Js(e, t) {
  return e in t;
}
class ei extends en {
...
function ni(e, t) {
  return ft(e) || typeof e == "number" || typeof e == "string" && !h1(t);
}
function Gt(e, t, n, o) {
  const s = [];
  if (ni(e, t))
    s.push(an(e, h1(t) && t.default || t, n && (n.default || n)));
  else {
    const i = Ut(e, t, o), a = i.length;
    ut(!!a, "No valid elements provided.");
    for (let d = 0; d < a; d++) {
      const l = i[d], u = l instanceof Element ? ti : ri;
      Ze.has(l) || u(l);
      const f = Ze.get(l), C = { ...n };
      "delay" in C && typeof C.delay == "function" && (C.delay = C.delay(d, a)), s.push(...cn(f, { ...t, transition: C }, {}));
    }
  }
  return s;
}
function oi(e, t, n) {
  const o = [];
  return qs(e, t, n, { spring: ln }).forEach(({ keyframes: i, transition: a }, d) => {
    o.push(...Gt(d, i, a));
  }), o;
}
class si {
...
function ci(e) {
  function t(n, o, s) {
    let i = [];
    return ai(n) ? i = oi(n, o, e) : i = Gt(n, o, s, e), new ii(i);
  }
  return t;
}
const li = ci(), di = (e, t) => /* @__PURE__ */ c(
  "svg",
  {
...
Yt.displayName = "ShoppingCart";
const Tc = (e, t) => /* @__PURE__ */ c(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
), m2 = g(p2), v2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: fi,
  Add: dn,
  Ai: hi,
  ...
  Calculator: Mn,
  Calendar: En,
  CalendarArrowDown: ji,
  CalendarArrowLeft: Zi,
  CalendarArrowRight: Oi,
  CameraPlus: zi,
  CardPin: Wi,
  ChartFunnel: Xi,
  ChartHorizontalBars: Ki,
  ChartLine: Ji,
  ChartPie: ta,
  ChartVerticalBars: na,
  Check: s1,
  CheckCircle: Rn,
  CheckCircleLine: sa,
  CheckDouble: Fn,
  ...
  FaceNeutral: Wn,
  FacePositive: qn,
  FaceSuperNegative: Xn,
  FaceSuperPositive: Yn,
  Feed: Oa,
  File: za,
  FileFilled: Wa,
  FileSigned: Xa,
  ...
  Wifi: m2,
  Windows: Wo
}, Symbol.toStringTag, { value: "Module" })), w2 = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const Ve = Fe({
  ...
  ({
    ...
    const C = s ?? L2[t ?? "body"], p = l ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (i !== void 0) {
      ...
      return p ? He(
        ...
        ie,
        {
          ...
          noTooltip: a,
          tag: C,
          className: k(Ve({ variant: t, align: n }), o),
          markdown: d,
          ...u,
          children: e
        }
...
}), Ye = { sm: 640, md: 768, "container-md": 448 }, r1 = (e) => "type" in e && e.type === "separator", _e = (e) => "type" in e && e.type === "split", y2 = (e) => !("type" in e), Oe = (e, t, n) => /* @__PURE__ */ r(
  he,
  {
    label: e.label,
    icon: e.icon,
...
function T1({
  ...
  const C = I(null), { width: p = 0 } = Xo({
    ref: C,
    box: "border-box"
  }), h = a === "sm" || a === "md" ? Ye[a] : Ye.md, m = Ft(`(min-width: ${h}px)`, {
    initializeWithValue: !1
  }), v = a === "none" ? !0 : a === "container-md" ? p >= Ye["container-md"] : m, w = typeof o == "string" ? o : o.base, x = typeof o == "string" ? o : o.md, V = v ? x : w, T = Array.isArray(
    t
  ) ? t : [], E = t != null && !Array.isArray(t) ? t : void 0, b = {
    primaryAction: e,
    secondaryItems: T,
    secondaryLink: E,
    otherActions: n,
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: { gap: s },
      children: v ? /* @__PURE__ */ r(E2, { ...b }, "row") : /* @__PURE__ */ r(M2, { ...b }, "stacked")
    }
  );
}
function M2({
  ...
  const i = t.filter(
    ...
    (a) => _e(a) ? p1(a, s, "outline") : Oe(a, s, "outline")
  );
  return /* @__PURE__ */ c(we, { children: [
    o.length > 0 && /* @__PURE__ */ r(Ko, { items: o }),
    i,
    n && rr(n, s),
    e && nr(e, s)
  ] });
...
function E2({
  ...
  const v = d && m ? p : l, w = d ? m ? h : [] : [], x = new Set(v.map((y) => y.id)), V = e ? nr(e, s) : null, T = t.filter(_e), E = t[t.length - 1], b = E != null && r1(E) && (T.length > 0 || V != null), L = [];
  t.forEach((y, R) => {
    if (!_e(y)) {
      if (r1(y)) {
        L.push({ kind: "sep", key: `sep-${R}` });
        return;
      }
      x.has(y.id) && L.push({
        kind: "node",
  ...
  const A = L.filter(
    (y, R) => y.kind === "node" || L[R - 1]?.kind === "node" && L[R + 1]?.kind === "node"
  ), H = [
    ...w.map(
      (y) => ({
        label: y.label,
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          H.length > 0 && /* @__PURE__ */ r("div", { ref: C, children: /* @__PURE__ */ r(Ge, { items: H, icon: vt, size: s }) }),
          A.map(
            (y) => y.kind === "sep" ? /* @__PURE__ */ r(H1, {}, y.key) : y.node
          ),
          n && rr(n, s)
        ]
      }
...
function T2({
  ...
  const u = k(
    ...
    /* @__PURE__ */ r("div", { className: u, onClick: (v) => v.stopPropagation(), children: m })
  );
  if (o || s) {
    const m = (w) => {
      const x = s ? {
    ...
    return d === "never" ? v : /* @__PURE__ */ c(we, { children: [
      v,
      /* @__PURE__ */ r(
        "div",
        {
  ...
  return !!p || (Array.isArray(t) ? t.length > 0 : !!t) || (n?.length ?? 0) > 0 ? f(
    /* @__PURE__ */ r(
      T1,
      {
        primaryAction: p,
...
const or = g(
  function({
    ...
    const T = !!h && h.visible !== !1, b = /* @__PURE__ */ c(
      Vt,
      {
        ref: T ? void 0 : V,
        className: k(
          ...
          (!!m || !!v) && "cursor-pointer focus-within:border-f1-border-hover focus-within:shadow-md hover:border-f1-border-hover hover:shadow-md"
        ),
        style: T ? {
          borderColor: es[h.variant],
          borderWidth: "2px"
        } : void 0,
        onClick: v,
        "data-testid": "card",
        children: [
          m && !w && /* @__PURE__ */ r(
            Tt,
            {
              href: m,
              variant: "unstyled",
              className: k("z-1 absolute inset-0 block rounded-xl", Ce()),
              "aria-label": t,
              children: " "
            }
          ),
          /* @__PURE__ */ c("div", { className: R2[x], children: [
            /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
              o && /* @__PURE__ */ r(ts, { avatar: o, size: "lg" }),
    ...
    return T ? /* @__PURE__ */ r(rs, { ref: V, alert: h, fullHeight: p, children: b }) : b;
  }
);
or.displayName = "F0CardRow";
const H2 = ({ compact: e = !1 }) => /* @__PURE__ */ r(
  Vt,
  {
    className: k(
    ...
    children: /* @__PURE__ */ c("div", { className: "flex flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
        /* @__PURE__ */ r(
          fe,
          {
            className: k("h-10 w-10 rounded-full", e && "h-8 w-8")
          }
        ),
  ...
  return f === "recording" ? /* @__PURE__ */ c("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    ...
    /* @__PURE__ */ r("div", { className: "flex items-center gap-2", children: e && /* @__PURE__ */ c(we, { children: [
      /* @__PURE__ */ r(
        de,
        {
...
function I2({
  ...
  const o = /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(ae, { icon: ht, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ r(
      "button",
      {
        ...
        onClick: () => t(e.id),
        children: /* @__PURE__ */ r(ae, { icon: be, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ r(os, { label: e.errorMessage, children: o }) : o;
}
const P2 = {
  soft: {
    text: "",
...
function D2({
  ...
  q(() => {
    ...
    const f = a.current, C = f?.offsetParent;
    if (!f || !C) return;
  ...
  return !e || u ? null : /* @__PURE__ */ r(
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (f, C) => /* @__PURE__ */ c(
        "div",
        {
        ...
        const p = C === o, h = `${f.firstName} ${f.lastName}`.trim();
        return /* @__PURE__ */ c(
          "div",
          {
            ref: p ? d : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ r(ie, { className: "text-base font-medium text-f1-foreground", children: h }) })
            ]
          },
          String(f.id)
        );
...
const Z2 = ({
  ...
  return /* @__PURE__ */ r("div", { className: "p-1", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ r(ae, { icon: g1, size: "md", color: "default" }) }),
        /* @__PURE__ */ r(
          ie,
          {
  ...
  const s = ye(), [i, a] = P(""), [d, l] = P(0), [u, f] = P(!1), C = I(null), p = I(null), h = I(null), m = e[d] ?? t;
  return q(() => {
    const v = () => {
    ...
    if (s)
      return f(!1), a(m), v(), C.current = setTimeout(() => {
    ...
    return p.current = setInterval(() => {
      w < m.length ? (a(m.slice(0, w + 1)), w++) : (p.current && (clearInterval(p.current), p.current = null), C.current = setTimeout(() => {
        h.current = setInterval(() => {
          w > 0 ? (w--, a(m.slice(0, w))) : (h.current && (clearInterval(h.current), h.current = null), C.current = setTimeout(() => {
            const b = (d + 1) % Math.max(e.length, 1);
            l(b);
          }, E));
        }, V);
    ...
    e.length,
    s
  ]), n.length > 0 || o ? null : /* @__PURE__ */ r(Re, { children: /* @__PURE__ */ r(
    oe.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
        ...
        "div",
        {
          ...
          children: d.map(
            (h, m) => h.type === "mention" ? /* @__PURE__ */ r(
              ...
              m
            ) : h.type === "ghost" ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-secondary opacity-50", children: h.text }, m) : /* @__PURE__ */ r("span", { children: h.text }, m)
          )
        }
      ),
      !n && !u && /* @__PURE__ */ r(
...
const G2 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ c(
    l1,
    {
      ...
      children: [
        /* @__PURE__ */ r(is, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ r(d1, { asChild: !0, children: /* @__PURE__ */ r(
          de,
          {
            variant: "outline",
            label: d.label,
          ...
          f1,
          {
            ...
            children: [
              /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ r(ae, { icon: a.icon, size: "sm" }),
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ r(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ r(ae, { icon: o1, size: "sm" })
                      }
                    )
                  ]
                },
...
function K2(e) {
  const [t, n] = P([]), [o, s] = P(null), i = I(
    null
  ), a = I(null), d = X(), l = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, C = K(() => {
    if (u)
      return Array.isArray(u) ? u.join(",") : u;
  }, [u]), p = f !== void 0 && t.length >= f, h = I(0);
  q(() => {
    h.current = t.length;
  }, [t]);
  const m = G((T) => {
  ...
  const v = G(
    async (T) => {
      ...
      try {
        const H = await l(E);
        if (!Array.isArray(H) || H.length !== E.length) {
          A(d.ai.fileUploadError);
          return;
        }
        n(
          (y) => y.map((R) => {
            const F = b.findIndex((B) => B.id === R.id);
            return F === -1 ? R : H[F] ? {
              ...R,
              status: "uploaded",
              uploadedFile: H[F]
        ...
        const y = H instanceof Error && H.message ? H.message : d.ai.fileUploadError;
        A(y);
      }
    },
    [
...
function rl({
  ...
  const [i, a] = P(!1), [d, l] = P(""), [u, f] = P([]), [C, p] = P(!1), [h, m] = P(0), [v, w] = P([]), x = I(-1), V = I(null), T = I(0), E = I(-1);
  q(() => {
    if (!o) {
      a(!1);
      return;
    ...
    const F = Q2(e, n, v);
    if (!F) {
      a(!1), l(""), f([]), m(0), x.current = -1, E.current = -1;
      return;
    }
    if (F.atIndex === E.current)
      return;
    x.current = F.atIndex, l(F.query), a(!0), m(0), p(!0), V.current && clearTimeout(V.current);
    const B = ++T.current;
    return V.current = setTimeout(() => {
      o(F.query).then((Z) => {
        B === T.current && (f(Z), m(0), Z.length === 0 && F.query.length > 0 && (E.current = F.atIndex, a(!1)));
      }).catch(() => {
        B === T.current && f([]);
      }).finally(() => {
        B === T.current && p(!1);
  ...
  const b = G(() => {
    a(!1), l(""), f([]), m(0), x.current = -1;
  }, []), L = G(
    (F) => {
      const B = x.current;
      if (B === -1) return;
      const Z = `${F.firstName} ${F.lastName}`.trim(), U = String(F.id), W = e.slice(0, B), te = e.slice(n), Q = `@${Z} `, _ = W + Q + te, O = W.length + Q.length;
      t(_), w((D) => [...D.filter((Y) => !(Y.id === U && Y.name === Z)), { id: U, name: Z }]), b(), requestAnimationFrame(() => {
        const D = s.current;
        D && (D.focus(), D.setSelectionRange(O, O));
      });
    },
    [e, n, t, s, b]
  ), A = G(
    (F) => {
      ...
      switch (F.key) {
        case "ArrowDown":
          return F.preventDefault(), m((B) => (B + 1) % u.length), !0;
        case "ArrowUp":
        ...
        case "Tab": {
          ...
          if (B) {
            ...
            if (d.length === 0 || Z.toLowerCase().startsWith(d.toLowerCase()))
              return F.preventDefault(), L(B), !0;
          }
          return !1;
        }
        case "Enter":
          return F.preventDefault(), u[h] && L(u[h]), !0;
        default:
          return !1;
      }
    },
    ...
    (F) => {
      ...
      let B = F;
      const Z = [...v].sort((U, W) => W.name.length - U.name.length);
      for (const U of Z) {
        const W = `@${U.name}`, te = `<entity-ref type="person" id="${$1(U.id)}">${$1(U.name)}</entity-ref>`;
        for (; B.includes(W); )
          B = B.replace(W, te);
      }
      return B;
...
` || W === "	";
  ...
  const y = K(() => {
    ...
    const F = s.current;
    if (!F) return null;
    const B = el(F, x.current), Z = F.offsetLeft + B.left, W = (F.offsetParent ? F.offsetParent.offsetHeight : 0) - (F.offsetTop + B.top);
    return { left: Z, bottom: W };
  }, [i, e, n, s]), R = K(() => {
...
const nl = /[\\`*_{}[\]()#+\-.!|~>]/g, ol = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(nl, "\\$&")).join(""), A4 = ({
  onSubmit: e,
  onStop: t,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const L = X(), A = ye(), [H, y] = P(""), [R, F] = P(0), [B, Z] = P(!1), [U, W] = P(!1), [te, Q] = P(null), _ = I(null), O = I(null), D = I(null), re = a != null, { tracking: Y } = Me(), me = G(
    (J, ke) => {
    ...
    const ke = xe.current, qe = ke && !/\s$/.test(ke) ? " " : "", Pe = `${ke}${qe}${J}`;
    y(Pe), F(Pe.length);
  }, []), We = {
    ...
    onPartial: Ne,
    onFinal: (J) => {
      Ne(J), O.current?.focus();
    },
    onError: (J) => le(We[J])
  }), Sr = !!p && ve.isSupported, Vr = G(() => {
    Y?.onDictationStart?.(), xe.current = H, ve.start();
  }, [H, ve, Y]), Tr = G(() => {
    Y?.onDictationCancel?.(), ve.cancel();
  }, [ve, Y]);
  q(() => {
  ...
  const v1 = ve.status === "recording", Hr = v1 ? L.ai.listening : L.ai.inputPlaceholder, Ar = ge.filter((J) => J.status === "uploaded"), Be = ge.some((J) => J.status === "uploading"), w1 = ge.some((J) => J.status === "error"), k1 = H.trim().length > 0;
  q(() => {
    if (!(!U || Be)) {
      if (W(!1), w1) {
        le(L.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const $r = async (J) => {
    if (J.preventDefault(), !re) {
      if (ee.close(), n)
        ...
        const ke = ee.transformMentions(H.trim()), qe = ol(ke), Pe = Ar.flatMap(
          (E1) => E1.uploadedFile ? [E1.uploadedFile] : []
        ), y1 = d, M1 = u;
        y1 && l?.(null), M1 && f?.(null), await e({
          text: qe,
          files: Pe,
          context: y1,
          quote: M1
    ...
    re || ee.handleKeyDown(J) || J.key === "Enter" && !J.shiftKey && (J.preventDefault(), n || _.current?.requestSubmit());
  }, Ir = () => {
    F(O.current?.selectionStart ?? 0);
  }, Pr = () => {
    D.current && O.current && (D.current.scrollTop = O.current.scrollTop);
  }, x1 = te ? te.prompt ?? te.title : null, L1 = v1 ? [L.ai.listening] : x1 ? [x1] : s ?? [], jr = L1.length > 1, Dr = K(() => W2(H, ee.mentions, {
    cursorPosition: R,
    inlineCompletion: ee.inlineCompletion
  }), [H, ee.mentions, R, ee.inlineCompletion]), Zr = ee.mentions.length > 0 || ee.inlineCompletion !== null, Ie = x && !!T && T.length > 0 && !!E ? /* @__PURE__ */ r(
    G2,
    {
      suggestions: T,
      onItemClick: me,
  ...
  return /* @__PURE__ */ c(
    oe.div,
    {
      ...
      className: k(
        ...
        b1 && "min-h-0 flex-1 justify-start -mt-20"
      ),
      ...V ? _r : {},
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          Ie && !V && /* @__PURE__ */ r("div", { children: Ie }),
          /* @__PURE__ */ r(j2, { creditWarning: i, children: /* @__PURE__ */ c(
            oe.form,
            {
              "aria-busy": n,
              ref: _,
              className: k(
                ...
                re && "after:scale-100 after:opacity-100 border-f1-background-tertiary"
              ),
              animate: {
              ...
              children: [
                ...
                /* @__PURE__ */ r(Re, { initial: !1, children: re ? /* @__PURE__ */ r(
                  oe.div,
                  {
                  ...
                  oe.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ r(Re, { initial: !1, children: z && /* @__PURE__ */ r(
                        oe.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ c(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ r("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ r(ls, { type: "critical", size: "sm" }) }),
                                /* @__PURE__ */ r("p", { className: "font-medium text-f1-foreground-critical", children: z })
                              ]
                            }
                          )
                        },
                      ...
                      /* @__PURE__ */ r(
                        O2,
                        {
                          ...
                          onCursorUpdate: Ir,
                          onScroll: Pr,
                          highlightSegments: Dr,
                          hasOverlay: Zr,
                          multiplePlaceholders: jr,
                          placeholders: L1,
        ...
        Ie && V && /* @__PURE__ */ r("div", { className: "w-full max-w-content", children: Ie }),
        w && x && V && /* @__PURE__ */ r("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: w }),
        /* @__PURE__ */ r(Re, { mode: "wait", initial: !1, children: re ? /* @__PURE__ */ c(
          oe.div,
          {
          ...
          oe.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ r(ie, { className: "text-sm font-medium text-f1-foreground-tertiary", children: v.text }),
...
function dl({
  ...
  return /* @__PURE__ */ r(Tt, { ...t, variant: "link", href: t.href, children: e });
}
function fl({
  children: e,
  ...t
...
function Se({
  ...
  return /* @__PURE__ */ c(
    fs,
    {
      ...
      children: [
        /* @__PURE__ */ r(us, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          hs,
          {
            side: "top",
            ...
            children: l ? /* @__PURE__ */ r(R1.Skeleton, {}) : /* @__PURE__ */ r(R1, { ...m })
          }
        )
      ]
    }
...
function yl({
  ...
  const { entityRefs: n } = Me(), o = n?.resolvers?.candidate, s = X(), i = n?.urls?.candidate?.(e), a = K(
    () => (l) => {
      const u = [];
...
ir.displayName = "ExpenseTrigger";
function Ml({ id: e, label: t }) {
  const { entityRefs: n } = Me(), o = n?.resolvers?.expense, s = X(), i = n?.urls?.expense?.(e), a = K(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: qt
...
ar.displayName = "JobPostingTrigger";
function El({
  id: e,
  label: t
}) {
  const { entityRefs: n } = Me(), o = n?.resolvers?.jobPosting, s = X(), i = n?.urls?.jobPosting?.(e), a = K(
    () => (l) => ({
      title: l.title,
...
function Fl({
  ...
  const { entityRefs: n } = Me(), o = n?.resolvers?.requisition, s = X(), i = n?.urls?.requisition?.(e), a = K(
    () => (l) => {
      const u = l.lineManager ? `${l.lineManager.firstName} ${l.lineManager.lastName}` : void 0, C = [
        l.status ? {
...
function Nl({ id: e, label: t }) {
  const { entityRefs: n } = Me(), o = n?.resolvers?.person, s = X(), i = n?.urls?.person?.(e), a = K(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
function Sl({ id: e, label: t }) {
  const { entityRefs: n } = Me(), o = n?.resolvers?.vacancy, s = X(), i = n?.urls?.vacancy?.(e), a = K(
    () => (l) => ({
      title: l.name,
...
function fr({
  ...
  const a = X(), d = s.type === "open", l = d ? o ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ c(
    "div",
    {
      className: k(
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ r($t, { module: e.module, size: "lg" }),
          e?.type === "file" && /* @__PURE__ */ r(gs, { file: e.file, size: "lg" }),
          /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ r(ie, { className: "text-lg font-semibold text-f1-foreground", children: t }),
            n && /* @__PURE__ */ r(ie, { className: "text-base text-f1-foreground-secondary", children: n })
          ] }),
...
function B4({
  ...
  return /* @__PURE__ */ r(m1.Provider, { value: i, children: e });
}
function Al(e) {
  const n = $e(m1)?.formatters;
  return K(() => !n || n.length === 0 ? null : (o, s, i) => {
    let a, d = -1;
    for (const l of n) {
...
const B1 = 7, $l = 625, I1 = /* @__PURE__ */ new Set();
function Bl(e) {
...
function Pl(e) {
  const { days: t, hours: n, minutes: o, seconds: s } = ms(e), i = [];
...
function ur(e, t) {
  ...
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const n = e.value;
    return { type: "item", text: (n ? Bl(n) : "") || "—" };
  }
  if (t === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: n, to: o } = e, s = P1(n) ? j1(n) : String(n), i = P1(o) ? j1(o) : String(o);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((o) => {
      const s = ur(o);
      return Array.isArray(s) ? s.map(D1).join(", ") : D1(s);
    }).filter(Boolean).join(", ") || "—" };
...
function hr({
  ...
  const { canvasContent: l, openCanvas: u, closeCanvas: f } = Me(), C = Al(e), p = d ?? C, h = I(() => {
  }), m = o ?? e, v = s ?? t ?? "", w = l?.type === "form" && l.formName === e, x = () => u({
    type: "form",
    title: m,
    description: v,
    formName: e,
  ...
  h.current = x, q(() => {
    typeof window > "u" || window.innerWidth < $l || I1.has(e) || (I1.add(e), h.current());
  }, [e]);
  const V = i && a ? Object.entries(i).map(([b, L]) => {
    const A = a[b], H = p?.(b, A, {
      fieldType: L.fieldType,
      customFieldName: L.customFieldName
    });
    if (!H && L.fieldType === "custom" && typeof A == "object" && A !== null)
      return null;
    const y = H ?? ur(A, L.fieldType), R = ["richtext", "textarea"];
    return {
      label: L.label,
      content: y,
    ...
    if (!b) return !1;
    const L = Array.isArray(b.content) ? b.content[0] : b.content;
    return !(L?.type === "item" && L.text === "—");
  }) : [], T = V.slice(0, B1), E = V.length > B1;
  return /* @__PURE__ */ r(
    fr,
    {
...
const Z1 = 8, Te = 8;
function gr({ anchor: e, onReply: t }) {
  const n = X(), o = I(null), [s, i] = P(
    null
  );
  if (lt(() => {
    if (!e) {
    ...
    const d = o.current;
    if (!d) return;
    const l = d.offsetWidth, u = d.offsetHeight, f = window.innerWidth, C = window.innerHeight;
    let p = e.rect.top - u - Z1;
    p < Te && (p = e.rect.bottom + Z1), p = Math.min(
      Math.max(p, Te),
      C - u - Te
    );
    const h = e.rect.left + e.rect.width / 2 - l / 2, m = Math.min(
      Math.max(h, Te),
      f - l - Te
    );
    i({ top: p, left: m });
...
const pr = Ue(void 0), P4 = () => $e(pr), _l = (e) => /* @__PURE__ */ r(Bt, { content: e, format: "markdown" }), Ol = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const d = typeof n?.content == "string" ? n.content : "", l = (n && o?.(n)) ?? n?.generativeUI?.() ?? null, u = n?.toolCalls?.[0]?.id, f = !d && !l, C = I(null), { anchor: p, clear: h } = Cr({
    containerRef: C,
    enabled: !!(n?.id && d)
  });
  return q(() => {
    n?.id && !t && !e && i?.(n);
  }, [n, t, e, i]), !t && !e && f ? null : /* @__PURE__ */ r(pr.Provider, { value: u, children: /* @__PURE__ */ c("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    n && d && /* @__PURE__ */ r(
      "div",
      {
        ref: C,
  ...
  const [s, i] = P(""), a = X(), { title: d, label: l, placeholder: u } = n === "like" ? a.ai.feedbackModal.positive : a.ai.feedbackModal.negative, f = G(() => {
    t(o, s);
  }, [s, o, t]), C = () => {
    e(o);
  };
  ...
  return /* @__PURE__ */ r(mr.Provider, { value: o, children: e });
}, vr = () => {
  const e = $e(mr);
  if (e === null)
    throw new Error(
...
const Wl = ({
  ...
  const o = X(), { open: s } = vr(), [i, a] = P(null);
  ...
  const [d, l] = P(s), u = ye(), f = o !== void 0, C = f ? o : d;
  return /* @__PURE__ */ c(
    It,
    {
        ...
        /* @__PURE__ */ c(
          Pt,
          {
            ...
            children: [
              ...
              !a && /* @__PURE__ */ r(ae, { icon: ze })
            ]
          }
        ),
        /* @__PURE__ */ r(jt, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ r(
          oe.div,
          {
            initial: !1,
            animate: {
  ...
  const s = X(), [i, a] = P(!!n), d = I(n);
  q(() => {
    d.current && !n ? a(!1) : n && !i && a(!0), d.current = n;
  }, [n, i]);
  const l = n ? s.ai.thoughtsGroupTitle : t ?? s.ai.thoughtsGroupTitle, u = e.length - 1, f = (C) => !n || o ? "completed" : C === u ? "executing" : "completed";
  return /* @__PURE__ */ r(
    ql,
    {
      icon: Wt,
...
const wr = (e) => /* @__PURE__ */ r(Bt, { content: e, format: "markdown" }), Ql = ({
  text: e,
  renderMarkdown: t
}) => /* @__PURE__ */ c("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ r("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ r(ae, { icon: g1 }) }),
  /* @__PURE__ */ r("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (t ?? wr)(e) })
] }), Jl = ({
  message: e,
  onReplyQuote: t,
  ...
  const a = e.rawData, d = Kl(
    e?.content,
    a
  ), l = (Yl(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = l.length > 0, { anchor: C, clear: p } = Cr({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ r(Ql, { text: u, renderMarkdown: o }),
        d.length > 0 && /* @__PURE__ */ r("div", { className: "flex max-w-[90%] flex-wrap justify-end gap-1.5", children: d.map((h, m) => /* @__PURE__ */ r(
          Ht,
          {
        ...
        /* @__PURE__ */ r(
          gr,
          {
            anchor: C,
            onReply: (h) => {
              t?.(h), p(), window.getSelection()?.removeAllRanges();
            }
          }
        )
      ]
...
}, e6 = 35, t6 = 22, r6 = 400, n6 = 2500, o6 = 220, s6 = ({
  messages: e,
  onClick: t,
  fullscreen: n = !1
}) => {
  ...
  q(() => {
    ...
    if (d === "starting")
      ...
      i < u.length ? p = setTimeout(() => a((h) => h + 1), e6) : l("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => l("erasing"), n6);
    } else d === "erasing" && (i > 0 ? p = setTimeout(() => a((h) => h - 1), t6) : p = setTimeout(() => {
...
function i6({
  ...
  const [a, d] = P(0), [l, u] = P(!1), f = I(s), C = I(i);
  C.current = i;
  const p = G(
    (m = "smooth") => {
      n.current?.scrollIntoView({ behavior: m });
    },
    [n]
  );
  q(() => {
  ...
  const h = G(() => {
    const m = e.current;
    if (!m) return;
    const { scrollTop: v, scrollHeight: w, clientHeight: x } = m, V = w - v - x;
    u(V > x);
  }, [e]);
  return q(() => {
    const m = e.current;
    ...
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const m = e.current, v = o.current;
        if (!m || !v) return;
        const w = m.getBoundingClientRect(), x = v.getBoundingClientRect(), V = m.scrollTop + (x.top - w.top);
        m.scrollTo({ top: V, behavior: "smooth" });
      });
    }), s === 0 && u(!1), f.current = s;
  }, [s, o, e]), { showScrollBtn: l, turnMinHeight: a, scrollToBottom: p };
}
const a6 = {
  threadId: "",
  onThumbsUp: () => {
...
}, j4 = (e) => /* @__PURE__ */ r(zl, { children: /* @__PURE__ */ r(c6, { ...e }) }), c6 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: T, handleSubmit: E, handleClose: b } = Gl(
    f ?? a6
  ), L = X(), A = v ?? Ol, H = w ?? Jl, y = K(() => {
    const D = o ?? L.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((Y) => typeof Y == "string" && Y.length > 0);
  }, [o, L.ai.defaultInitialMessage]), R = !t && e.length === 0 && y.length > 0, F = I(null), B = I(null), Z = I(null), U = I(null), W = I(null), { showScrollBtn: te, turnMinHeight: Q, scrollToBottom: _ } = i6({
    viewportRef: F,
    contentRef: B,
    endRef: Z,
    lastTurnRef: W,
    ...
    const Y = re === e.length - 1, me = {
      ...
      const ue = Y && se === D.assistantMessages.length - 1, M = D.userMessages.length + se, S = {
        message: ne,
        inProgress: D.isInProgress,
        index: M,
        isCurrentMessage: ue,
      ...
      return /* @__PURE__ */ r(
        ...
        {
          ...S,
          isGenerating: D.isInProgress && ue,
          isLoading: D.isInProgress && ue && !ne.content
        },
        `${re}-a-${se}`
      );
    };
    return /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          D.endIndicator === "thinking" && /* @__PURE__ */ r(e1, { title: L.ai.thinking, status: "executing" }),
          D.endIndicator === "activity" && /* @__PURE__ */ r(e1, { status: "writing" }),
  ...
  return /* @__PURE__ */ c(we, { children: [
    /* @__PURE__ */ c("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
          ...
          children: /* @__PURE__ */ c(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("footer", { className: "copilotKitMessagesFooter", ref: Z, children: m }),
                /* @__PURE__ */ r(Re, { children: te && /* @__PURE__ */ r(
                  oe.div,
                  {
      ...
      !p && !R && /* @__PURE__ */ c(we, { children: [
        /* @__PURE__ */ r(_1, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ r(_1, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    T.isOpen && /* @__PURE__ */ r(
      Ul,
...
}, l6 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
...
const f6 = ({
  ...
  const p = X().ai.clarifyingQuestion.typeYourAnswer, h = e === "single" ? /* @__PURE__ */ r(xr, { isSelected: n && !t }) : /* @__PURE__ */ r(
    Dt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const h6 = ({
  ...
  const x = ye(), V = (() => {
    ...
    const A = n.findIndex((H) => o.includes(H.id));
    return A >= 0 ? A : 0;
  })(), [T, E] = P(V), b = I([]);
  q(() => {
    C && e === "single" && b.current[T]?.focus();
  }, []);
  const L = (A) => {
    if (e !== "single") return;
    const H = n.length - 1;
    ...
    A.preventDefault(), E(y), b.current[y]?.focus();
  };
  return /* @__PURE__ */ c(
    "div",
    {
  ...
  const n = X(), o = ye(), {
    ...
    customAnswerText: b,
    isCustomAnswerActive: L
  } = s, A = I(null), H = V ?? "single", y = a > 1, R = i === 0, F = i === a - 1, B = y ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  }) : void 0, Z = x.length > 0, U = (b ?? "").trim().length > 0, W = Z || L && U || T === !0, te = t === !0 && F, Q = () => {
    te || l();
  }, _ = () => {
    te || u();
  }, O = (ce) => {
    const ne = H === "single" && x.includes(ce);
    d(ce), H === "single" && !F && !ne && Promise.resolve().then(l);
  }, D = F ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, re = T === !0 && !Z && !(L && U), Y = () => {
    m(), requestAnimationFrame(() => {
      A.current?.focus();
    });
  }, me = (ce) => {
    ce.key === "Escape" && (ce.preventDefault(), f());
  }, ge = o ? 0 : p6 / 2;
  return /* @__PURE__ */ c("div", { className: "flex flex-col", onKeyDown: me, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(Re, { mode: "wait", initial: !1, children: /* @__PURE__ */ c(
      oe.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ge, ease: g6 },
        children: [
          /* @__PURE__ */ r(
            C6,
            {
...
function O1(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), d = Math.min(i + o, s), l = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(t / 2)), f = (Y) => Y / e * 2 - 1, C = (Y) => Y / t * 2 - 1, p = 0, h = e, m = 0, v = t, w = l, x = e - l, V = u, T = t - u, E = f(p), b = f(h), L = C(m), A = C(v), H = f(w), y = f(x), R = C(V), F = C(T), B = 0, Z = 0, U = 1, W = 1, te = l / e, Q = 1 - l / e, _ = u / t, O = 1 - u / t, D = new Float32Array([
    // Top strip
    E,
    L,
    b,
...
function v6(e, t, n) {
  const o = U1(e, e.VERTEX_SHADER, t), s = U1(e, e.FRAGMENT_SHADER, n), i = e.createProgram();
...
class z4 {
  ...
  resize(t, n, o) {
    ...
    const { gl: s, program: i, vao: a, positionBuffer: d, uvBuffer: l, uResolution: u } = this.glr, f = o ?? this.options.ratio ?? window.devicePixelRatio ?? 1, C = Math.max(1, Math.floor(t * f)), p = Math.max(1, Math.floor(n * f));
    this.canvas.style.width = `${t}px`, this.canvas.style.height = `${n}px`, (this.canvas.width !== C || this.canvas.height !== p) && (this.canvas.width = C, this.canvas.height = p), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
    const { positions: h, uvs: m } = O1(
      this.canvas.width,
      this.canvas.height,
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: a, uvs: d } = O1(
      s,
      i,
    ...
    const C = t.getAttribLocation(n, "aUV");
    t.enableVertexAttribArray(C), t.vertexAttribPointer(C, 2, t.FLOAT, !1, 0, 0), this.checkGLError(t, "setupGL: after UV buffer setup");
    const p = t.getUniformLocation(n, "uResolution"), h = t.getUniformLocation(n, "uTime"), m = t.getUniformLocation(n, "uBorderWidth"), v = t.getUniformLocation(n, "uGlowWidth"), w = t.getUniformLocation(n, "uBorderRadius"), x = t.getUniformLocation(n, "uColors"), V = t.getUniformLocation(n, "uGlowExponent"), T = t.getUniformLocation(n, "uGlowFactor");
    t.useProgram(n), t.uniform1f(m, this.options.borderWidth), t.uniform1f(v, this.options.glowWidth), t.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (t.uniform1f(V, 2), t.uniform1f(T, 1.8)) : (t.uniform1f(V, 1), t.uniform1f(T, 1));
    const E = (this.options.colors || x6).map(L6);
...
const z1 = ["lowp", "mediump", "highp"], b6 = `
void main(void){
...
}`, G1 = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, W1 = "iTime", q1 = "iTimeDelta", X1 = "iDate", Y1 = "iFrame", K1 = "iMouse", Q1 = "iResolution", M6 = "iChannel", J1 = "iChannelResolution", et = "iDeviceOrientation";
function E6(e, t) {
...
}, Qe = 9729, tt = 9728, V6 = 9987, rt = 33071, nt = 10497;
class T6 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const C = 0, p = n.RGBA, h = 1, m = 1, v = 0, w = n.RGBA, x = n.UNSIGNED_BYTE, V = new Uint8Array([255, 255, 255, 0]), T = n.createTexture();
    if (n.bindTexture(n.TEXTURE_2D, T), n.texImage2D(
      ...
      const A = this.setupVideo(o);
      return n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_S, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_T, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.LINEAR), this._webglTexture = T, this.source = A, this.isVideo = !0, A.play().then(() => this);
    }
    async function E() {
      return new Promise((A, H) => {
        ...
        y.crossOrigin = "anonymous", y.onload = () => {
          ...
          H(new Error(Le(`failed loading url: ${o}`)));
        }, y.src = o ?? "";
      });
    }
    let b = await E(), L = (b.width & b.width - 1) === 0 && (b.height & b.height - 1) === 0;
    return (t.wrapS !== rt || t.wrapT !== rt || t.minFilter !== tt && t.minFilter !== Qe) && !L && (b = this.makePowerOf2(b), L = !0), n.bindTexture(n.TEXTURE_2D, T), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, l), n.texImage2D(
      n.TEXTURE_2D,
      C,
      p,
      w,
      x,
      b
    ), L && t.minFilter !== tt && t.minFilter !== Qe && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || nt
    ), n.texParameteri(
      ...
      this.magFilter || Qe
    ), this._webglTexture = T, this.source = b, this.isVideo = !1, this.isLoaded = !0, this.width = b.width || 0, this.height = b.height || 0, this;
  };
}
const Le = (e) => `react-shaders: ${e}`, ot = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, st = (e, t, n) => e * (1 - n) + t * n, H6 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function A6({
  fs: e,
  vs: t = G1,
  textures: n = [],
  ...
  const h = I(null), m = I(null), v = I(null), w = I(null), x = I(void 0), V = I(void 0), T = I(!1), E = I(void 0), b = I(0), L = I([0, 0]), A = I([]), H = I(0), y = I(void 0), R = I({
    [W1]: { type: "float", isNeeded: !1, value: 0 },
    [q1]: { type: "float", isNeeded: !1, value: 0 },
    [X1]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [K1]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [Q1]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    [Y1]: { type: "int", isNeeded: !1, value: 0 },
    [et]: {
      type: "vec4",
      isNeeded: !1,
      value: [0, 0, 0, 0]
    ...
    const N = "width" in M ? M.width ?? 0 : 0, j = "height" in M ? M.height ?? 0 : 0, $ = R.current.iChannelResolution;
    if (!$) return;
    const z = Array.isArray($.value) ? $.value : $.value = [];
    z[S * 3] = N * u, z[S * 3 + 1] = j * u, z[S * 3 + 2] = 0;
  }, Z = () => {
    ...
    const [S = 0, N = 0] = ot(M), j = S - (E.current?.left ?? 0) - window.pageXOffset, $ = (E.current?.height ?? 0) - N - (E.current?.top ?? 0) - window.pageYOffset;
    T.current = !0;
    const z = Array.isArray(R.current.iMouse?.value) ? R.current.iMouse.value : void 0;
    z && (z[2] = j, z[3] = $), L.current[0] = j, L.current[1] = $;
  }, Q = (M) => {
    E.current = h.current?.getBoundingClientRect();
    const [S = 0, N = 0] = ot(M), j = S - (E.current?.left ?? 0), $ = (E.current?.height ?? 0) - N - (E.current?.top ?? 0);
    if (l !== 1)
      L.current[0] = j, L.current[1] = $;
    else {
      const z = Array.isArray(R.current.iMouse?.value) ? R.current.iMouse.value : void 0;
      z && (z[0] = j, z[1] = $);
    }
  }, _ = () => {
    const M = Array.isArray(R.current.iMouse?.value) ? R.current.iMouse.value : void 0;
    M && (M[2] = 0, M[3] = 0);
  }, O = () => {
    const M = m.current;
    if (!M) return;
    ...
    if (M.canvas.width = N, M.canvas.height = j, R.current.iResolution?.isNeeded && w.current) {
      const $ = M.getUniformLocation(
        w.current,
        Q1
      );
      M.uniform2fv($, [M.canvas.width, M.canvas.height]);
    }
  }, D = (M, S) => {
    const N = m.current;
    if (!N) return null;
...
${S}`));
      const $ = N.getShaderInfoLog(j);
      N.deleteShader(j), C?.(Le(`Shader compiler log: ${$}`));
    }
    return j;
  }, re = (M, S) => {
    const N = m.current;
    if (!N) return;
    const j = D(N.FRAGMENT_SHADER, M), $ = D(N.VERTEX_SHADER, S);
    if (w.current = N.createProgram(), !(!w.current || !$ || !j)) {
      if (N.attachShader(w.current, $), N.attachShader(w.current, j), N.linkProgram(w.current), !N.getProgramParameter(w.current, N.LINK_STATUS)) {
        C?.(
          Le(
      ...
      N.useProgram(w.current), x.current = N.getAttribLocation(
        w.current,
        "aVertexPosition"
    ...
    if (o)
      for (const M of Object.keys(o)) {
        const S = o[M];
        if (!S) continue;
        const { value: N, type: j } = S, $ = S6(j);
        if (!$) continue;
        const z = {};
        if (E6(j, N)) {
          const le = j.length, ee = Number.parseInt(j.charAt(le - 3)), xe = Math.floor(N.length / (ee * ee));
          N.length > ee * ee && (z.arraySize = `[${xe}]`);
        } else R6(j, N) && (z.arraySize = `[${Math.floor(N.length / Number.parseInt(j.charAt(0)))}]`);
        R.current[M] = {
          type: $,
          isNeeded: !1,
          value: N,
      ...
      if (n && n.length > 0) {
        ...
        const S = n.map(
          (N, j) => (R.current[`${M6}${j}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(N, j), A.current[j] = new T6(M), A.current[j]?.load(N).then(($) => {
            B($, j);
          }))
        );
        Promise.all(S).then(() => {
    ...
    const S = z1.includes(i ?? "highp"), N = `precision ${S ? i : z1[1]} float;
`;
    S || p?.(
      Le(
...
`).concat(M.replace(/texture\(/g, "texture2D("));
    for (const z of Object.keys(R.current))
      if (M.includes(z)) {
        const le = R.current[z];
        if (!le) continue;
        j = H6(
          j,
          `uniform ${le.type} ${z}${le.arraySize || ""}; 
`,
          j.lastIndexOf(N) + N.length
        ), le.isNeeded = !0;
      }
    return M.includes("mainImage") && (j = j.concat(b6)), j;
  }, ce = (M) => {
    const S = m.current;
    if (!S || !w.current) return;
    const N = H.current ? (M - H.current) / 1e3 : 0;
    H.current = M;
    const j = F.current;
    if (j)
      for (const $ of Object.keys(j)) {
        const z = j[$];
        if (z && R.current[$]?.isNeeded) {
          if (!w.current) return;
          const le = S.getUniformLocation(
            w.current,
            $
          );
          if (!le) return;
    ...
    if (R.current.iMouse?.isNeeded) {
      const $ = S.getUniformLocation(
        w.current,
        K1
      );
      S.uniform4fv($, R.current.iMouse.value);
    }
    ...
    if (R.current.iDate?.isNeeded) {
      const $ = /* @__PURE__ */ new Date(), z = $.getMonth() + 1, le = $.getDate(), ee = $.getFullYear(), xe = $.getHours() * 60 * 60 + $.getMinutes() * 60 + $.getSeconds() + $.getMilliseconds() * 1e-3, Ne = S.getUniformLocation(
        w.current,
        X1
      );
      S.uniform4fv(Ne, [ee, z, le, xe]);
    }
    if (R.current.iFrame?.isNeeded) {
      ...
      S.uniform1i($, z), R.current.iFrame.value = z + 1;
    }
    if (A.current.length > 0)
      for (let $ = 0; $ < A.current.length; $++) {
        const z = A.current[$];
        if (!z) return;
        const { isVideo: le, _webglTexture: ee, source: xe, flipY: Ne, isLoaded: We } = z;
        if (!We || !ee || !xe) return;
        if (R.current[`iChannel${$}`]?.isNeeded) {
          if (!w.current) return;
          const ve = S.getUniformLocation(
            w.current,
            `iChannel${$}`
          );
          S.activeTexture(S.TEXTURE0 + $), S.bindTexture(S.TEXTURE_2D, ee), S.uniform1i(ve, $), le && z.updateTexture(
            ee,
            xe,
            Ne
          );
    ...
    S.viewport(0, 0, S.drawingBufferWidth, S.drawingBufferHeight), S.clear(S.COLOR_BUFFER_BIT | S.DEPTH_BUFFER_BIT), S.bindBuffer(S.ARRAY_BUFFER, v.current), S.vertexAttribPointer(
      ...
      0,
      0
    ), ce(M), S.drawArrays(S.TRIANGLE_STRIP, 0, 4);
    const N = R.current.iMouse?.value;
    if (R.current.iMouse?.isNeeded && l !== 1 && Array.isArray(N)) {
      const j = N[0] ?? 0, $ = N[1] ?? 0;
      N[0] = st(j, L.current[0] ?? 0, l), N[1] = st($, L.current[1] ?? 0, l);
    }
    V.current = requestAnimationFrame(ne);
  }, se = () => {
    const M = { passive: !0 };
    R.current.iMouse?.isNeeded && h.current && (h.current.addEventListener("mousemove", Q, M), h.current.addEventListener("mouseout", _, M), h.current.addEventListener("mouseup", _, M), h.current.addEventListener("mousedown", te, M), h.current.addEventListener("touchmove", Q, M), h.current.addEventListener("touchend", _, M), h.current.addEventListener("touchstart", te, M)), R.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      W,
      M
    ), h.current && (y.current = new ResizeObserver(O), y.current.observe(h.current), window.addEventListener("resize", O, M));
  }, ue = () => {
    const M = { passive: !0 };
    R.current.iMouse?.isNeeded && h.current && (h.current.removeEventListener("mousemove", Q, M), h.current.removeEventListener("mouseout", _, M), h.current.removeEventListener("mouseup", _, M), h.current.removeEventListener("mousedown", te, M), h.current.removeEventListener("touchmove", Q, M), h.current.removeEventListener("touchend", _, M), h.current.removeEventListener("touchstart", te, M)), R.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      W,
      M
    ), y.current && (y.current.disconnect(), window.removeEventListener("resize", O, M));
  };
  return q(() => {
    F.current = o;
  }, [o]), q(() => {
    ...
    function S() {
      Z();
      const N = m.current;
      N && h.current && (N.clearColor(...s), N.clearDepth(1), N.enable(N.DEPTH_TEST), N.depthFunc(N.LEQUAL), N.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, Y(), me(), re(ge(e || y6), t || G1), U(), requestAnimationFrame(ne), se(), O());
    }
    return requestAnimationFrame(S), () => {
      ...
      ue(), cancelAnimationFrame(V.current ?? 0);
    };
  }, []), /* @__PURE__ */ r(
    "canvas",
    {
...
}`, B6 = 10, I6 = 2, P6 = 0.5, j6 = 0.2, D6 = 1.5, pe = {
  duration: 0.5,
  ease: "easeOut"
}, it = {
  duration: 0.35,
...
function Z6(e, t) {
  const [n, o] = P(B6), {
    ...
    animate: i,
    motionValue: a
  } = je(j6), { value: d, animate: l } = je(I6), { value: u, animate: f } = je(P6), { value: C, animate: p } = je(D6), h = Ps(t, {
    fftSize: 512,
  ...
  return q(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        o(10), i(0.2, pe), l(1.2, pe), f(0.4, pe), p(1, pe);
        return;
      case "listening":
      case "pre-connect-buffering":
        o(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, pe), f(0.7, pe), p([1.5, 2], it);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        o(30), i(0.3, pe), l(0.5, pe), f(1, pe), p([0.5, 2.5], it);
        return;
      case "speaking":
        o(70), i(0.3, pe), l(0.75, pe), f(1.25, pe), p(1.5, pe);
        return;
    }
  }, [
    e,
...
function br({
  ...
  const h = K(() => O6(a), [a]);
  return /* @__PURE__ */ r("div", { ref: f, className: C, ...p, children: /* @__PURE__ */ r(
    A6,
    {
      fs: $6,
...
function G4({
  ...
  const { speed: u, scale: f, amplitude: C, frequency: p, brightness: h } = Z6(t, s);
  return /* @__PURE__ */ r(
    br,
    {
      ref: d,
...
const W4 = ({
  ...
  const o = X(), s = ye();
  return /* @__PURE__ */ c(we, { children: [
    e && /* @__PURE__ */ r("span", { className: k(z6(), "truncate"), children: e }),
    /* @__PURE__ */ r(Re, { children: n && t && /* @__PURE__ */ r(
      oe.div,
      {
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: k(yr()), children: t }),
    /* @__PURE__ */ c(
      oe.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ c("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ r("span", { className: k(De()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ r(
            bs,
            {
          ...
          o === "balance" && /* @__PURE__ */ r(q6, { balance: e.balance })
        ]
      }
    ),
    n && !W6.has(o) && /* @__PURE__ */ r(
      oe.span,
      {
        className: k(De()),
        animate: { opacity: s ? 0 : 1 },
...
const K6 = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), Q6 = ({
  label: e,
  direction: t
}) => {
  const n = Mr[t];
  ...
  const s = `sparkline-gradient-${dt().replace(/:/g, "")}`, i = Y6(e, n), a = Mr[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r(Q6, { label: t, direction: i })
      ]
    }
  ) });
}, Er = g(
  (e, t) => {
    const {
      ...
      className: l,
      ...u
    } = e, [f, C] = P(!1), [p, h] = P(!1), m = f || p, v = ye(), w = m && !!d, x = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, V = () => {
      a?.();
        ...
        "div",
        {
          ...
          children: [
            ...
            u.content === "sparkline" ? /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: k(yr()), children: o }),
              /* @__PURE__ */ r(
                oe.div,
                {
...
Er.displayName = "F0AiInsightCardInternal";
const e4 = ["className"], Rr = g((e, t) => {
  const n = e4.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
  return /* @__PURE__ */ r(Er, { ref: t, ...n });
});
...
const t4 = () => /* @__PURE__ */ c(
  ...
  "balance",
  "sparkline"
], Fr = 180, r4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Fr, n4 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, o4 = (e) => e.showActions !== !1, s4 = (e) => Object.fromEntries(
...
function i4(e) {
  ...
  } = e, [l, u] = P(!1), f = dt(), C = I(null), p = r4(
    d
  ), h = i.length > p, m = l ? i : n4(i, p), v = o4(e) ? e : null, w = s4(e);
  return q(() => {
    l && C.current?.focus();
  }, [l]), /* @__PURE__ */ c(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          t && /* @__PURE__ */ r($t, { module: t, size: "lg" }),
...
const a4 = ({
  ...
  return /* @__PURE__ */ c(
    It,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ c(Pt, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, c4 = (e) => v2[e] ?? kt, l4 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(ae, { icon: c4(e), size: "md", color: "default" }) }) : null;
function d4({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(a4, { icon: a1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(l4, { iconName: s.icon });
...
function u4({
  ...
  const o = X(), s = I(null), i = t ?? o.ai.aiTable.title, a = G(
    (d) => {
      if (!s.current) return;
  ...
  return e.columns?.length ? /* @__PURE__ */ c(
    Xe,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r(Xe, { overflowX: "auto", children: /* @__PURE__ */ c(
          "table",
          {
            ref: s,
            className: k(
              ...
              /* @__PURE__ */ r("tbody", { children: e.rows.map((d, l) => /* @__PURE__ */ r("tr", { children: e.columns.map((u) => {
                ...
                return /* @__PURE__ */ r(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ r(ie, { children: f == null ? "" : String(f) })
                  },
                  u
                );
              }) }, l)) })
...
function h4({ credits: e }) {
  const t = X(), [n, o] = P(!1), [s, i] = P(!1), [a, d] = P(!1), [l, u] = P(null), f = G(
    (h) => {
      o(h), h && e?.fetchUsage && (i(!0), d(!1), e.fetchUsage().then((m) => {
        u(m), d(!1);
      }).catch(() => {
        d(!0);
      }).finally(() => {
  ...
  return /* @__PURE__ */ c(l1, { open: n, onOpenChange: f, children: [
    /* @__PURE__ */ r(d1, { asChild: !0, children: /* @__PURE__ */ r(
      de,
      {
        variant: "ghost",
        hideLabel: !0,
        ...
        children: [
          p && /* @__PURE__ */ c("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            ...
            /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ r(ie, { tag: "span", className: "font-medium", children: e.companyName ?? "" }),
...
const C4 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function g4({
  employeeCredits: e
}) {
  const t = X(), n = ye(), [o, s] = P(!1), [i, a] = P(!1), [d, l] = P(!1), [u, f] = P(null), C = G(
    (v) => {
  ...
  if (!e) return null;
  const p = !!e.companyName, h = u && u.total > 0 ? Math.min(100, Math.round(u.used / u.total * 100)) : 0, m = u ? Math.max(0, u.total - u.used) : 0;
  return /* @__PURE__ */ c(l1, { open: o, onOpenChange: C, children: [
    /* @__PURE__ */ r(d1, { asChild: !0, children: /* @__PURE__ */ r(
      de,
      {
        variant: "ghost",
...
const at = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(g4, { employeeCredits: t }) : e ? /* @__PURE__ */ r(h4, { credits: e }) : null, Y4 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const p = X(), h = Ft(`(max-width: ${Vs.md}px)`, {
        ...
        /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ r(
          Ae,
          {
            ...
            children: /* @__PURE__ */ c("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ r(ie, { lines: 1, className: "min-w-0 text-left", children: n ?? p.ai.newConversation }),
              /* @__PURE__ */ r(ae, { icon: i1, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ c(
...
function m4(e) {
  ...
  return Zt(t) ? "today" : _t(t) ? "yesterday" : Ts(t, n) ? "thisMonth" : "older";
}
function v4(e, t) {
  const n = new Date(e), o = p4(), s = F1(n, "p", { locale: o });
  if (Zt(n)) return `${t.today}, ${s}`;
  if (_t(n)) return `${t.yesterday}, ${s}`;
      ...
      children: [
        /* @__PURE__ */ c(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ r(ie, { lines: 1, className: "text-left font-medium", children: e.title }),
        ...
        /* @__PURE__ */ r(
          "div",
          {
            ...
            children: /* @__PURE__ */ r(Ge, { items: d, children: /* @__PURE__ */ r(
              he,
              {
                icon: wt,
                variant: "ghost",
...
const K4 = ({
  ...
  const h = K(
    ...
    return o.filter((A) => A.title.toLowerCase().includes(L));
  }, [o, C]), v = K(
    () => m.filter((L) => a.has(L.id)),
    [m, a]
  ), w = K(
    () => m.filter((L) => !a.has(L.id)),
    [m, a]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ c("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ r(ae, { icon: a1, color: "secondary", size: "md" }),
                  /* @__PURE__ */ r(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ r(
                    Ae,
                    {
                      ...
                      children: /* @__PURE__ */ c("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ r(ae, { icon: C1, color: "default", size: "md" }),
                        /* @__PURE__ */ r(ie, { lines: 1, className: "text-left", children: f.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ r(x4, {}),
...
function Q4({
  ...
  const [o, s] = P([]), [i, a] = P(!1), [d, l] = P(null), [u, f] = P(L4), C = G(async () => {
    a(!0), l(null);
    try {
      const v = await t();
      s(v);
  ...
  const p = G((v) => {
    f((w) => {
      const x = new Set(w);
      return x.add(v), Je(x), x;
    });
  }, []), h = G((v) => {
    f((w) => {
      const x = new Set(w);
      return x.delete(v), Je(x), x;
    });
  }, []), m = G(
    async (v) => {
      try {

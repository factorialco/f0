...
import { useInsertionEffect as vn, forwardRef as C, createElement as De, useRef as B, useMemo as ee, useEffect as X, useState as D, useLayoutEffect as Tt, useCallback as W, createContext as t1, useContext as Ue, useId as At } from "react";
import { c9 as wn, ca as kn, cb as xn, cc as Ln, cd as Ht, ce as bn, cf as yn, cg as Mn, ch as En, ci as Rn, cj as $t, ck as Nn, cl as Fn, cm as Sn, cn as Vn, co as Tn, cp as An, cq as Hn, cr as Ye, cs as $n, ct as Bn, cu as In, cv as Pn, cw as Dn, cx as jn, W as Bt, cy as _n, cz as On, cA as Zn, cB as Un, cC as zn, cD as It, cE as Gn, cF as Wn, a3 as k1, cG as qn, aG as Xn, cH as Yn, cI as Kn, cJ as Qn, ad as Jn, cK as eo, bH as to, a7 as x1, aa as ro, cL as no, b7 as L1, _ as Pt, N as r1, cM as Dt, b6 as oo, cN as so, cO as io, a$ as ao, bG as co, Y as Ee, ar as lo, bb as jt, cP as uo, bE as _t, cQ as Fe, bA as fo, cR as ho, cS as Ot, a_ as Zt, cT as go, cU as po, cV as Co, cW as mo, cX as vo, cY as Ut, bs as wo, bt as ko, cZ as xo, c_ as Lo, c$ as bo, d0 as yo, d1 as Mo, d2 as Eo, d3 as Ro, d4 as No, d5 as Fo, d6 as So, d7 as Vo, d8 as To, d9 as Ao, bF as Ho, a8 as $o, bo as Bo, da as Io, db as Po, dc as Do, dd as jo, de as _o, df as Oo, dg as Zo, am as Uo, dh as zt, J as zo, Z as Go, di as Gt, dj as Wo, ba as qo, b9 as Xo, dk as Yo, dl as Wt, dm as Ko, aZ as Qo, av as Jo, dn as es, ap as ts, b4 as rs, dp as qt, dq as ns, dr as os, bf as b1, ds as ss, dt as y1, bC as is, bB as as, bD as Xt, du as cs, z as ls, y as ds, dv as us, dw as fs, dx as hs, dy as gs, dz as ps, dA as Yt, dB as Cs, a9 as ms, dC as vs, H as ue, o as Se, m as M, ab as ce, dD as ws, bv as ks, w as Kt, dE as xs, a2 as n1, bU as Ls, aq as bs, M as he, C as ae, a5 as Qt, ac as Jt, bj as er, dF as ys, aY as tr, s as ge, dG as Ms, dH as Es, S as fe, u as J, c7 as rr, $ as Rs, dI as Ns, aM as Le, A as ye, n as ne, aA as M1, dJ as Fs, aB as E1, aC as R1, b as Re, bw as Ss, O as Vs, dK as Ts, dL as As, dM as Hs, dN as O1, a0 as $s, ah as nr, aP as or, dO as Bs, bT as Is, dP as Ps, dQ as Ds, aU as sr, dR as js, bN as _s, dS as Os, aR as Ze, bd as ir, dT as ar, be as cr, dU as lr, dV as Zs, bh as Us, dW as zs, b5 as N1, bp as Gs, dX as Ws, dY as qs, dZ as Xs, d_ as Ys, d$ as Ks, e0 as s1, x as Qs, e1 as dr, e2 as ur, e3 as Js, ag as Z1, e4 as ei, af as ti, e5 as ri, e6 as ni } from "./F0CanvasPanel-osMATVN7.js";
import { createPortal as fr } from "react-dom";
import { defaultTranslations as oi } from "./i18n-provider-defaults.js";
import { useTrackVolume as si } from "@livekit/components-react";
import './useChatHistory.css';function ii(e, t, n) {
  vn(() => e.on(t, n), [e, t, n]);
}
function F1(e) {
...
function hr(e, t, n, o) {
  return typeof e == "string" && F1(t) ? wn(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function ai(e, t, n) {
  return e * (t + 1);
}
...
function gr(e, t) {
  return kn(e) ? e[ci(0, e.length, t)] : e;
}
function li(e, t, n) {
  for (let o = 0; o < e.length; o++) {
    const s = e[o];
    s.at > t && s.at < n && (Ln(e, s), o--);
  }
}
...
const hi = "easeInOut", gi = 20;
function pi(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let g = 0; g < e.length; g++) {
    ...
    if (typeof p == "string") {
      ...
      f.set(p.name, U1(h, p.at, u, f));
      continue;
    }
    let [w, v, k = {}] = p;
    k.at !== void 0 && (h = U1(h, k.at, u, f));
    let H = 0;
    const N = (R, x, E, V = 0, b = 0) => {
      const S = Ci(R), { delay: L = 0, times: y = bn(S), type: T = "keyframes", repeat: j, repeatType: O, repeatDelay: Z = 0, ...z } = x;
      let { ease: q = t.ease || "easeOut", duration: U } = x;
      const I = typeof L == "function" ? L(V, b) : L, Y = S.length, te = En(T) ? T : s?.[T];
      if (Y <= 2 && te) {
        let K = 100;
        if (Y === 2 && wi(S)) {
          const Ce = S[1] - S[0];
        ...
        const oe = { ...z };
        U !== void 0 && (oe.duration = Rn(U));
        const de = yn(oe, K, te);
        q = de.ease, U = de.duration;
      }
      U ?? (U = i);
      const se = h + I;
      y.length === 1 && y[0] === 0 && (y[1] = 1);
      const pe = y.length - S.length;
      if (pe > 0 && Mn(y, pe), S.length === 1 && S.unshift(null), j) {
        $t(j < gi, "Repeat count too high, must be less than 20"), U = ai(U, j);
        const K = [...S], oe = [...y];
        ...
        for (let Ce = 0; Ce < j; Ce++) {
          ...
          for (let F = 0; F < K.length; F++)
            y.push(oe[F] + (Ce + 1)), q.push(F === 0 ? "linear" : gr(de, F - 1));
        }
        ui(y, j);
      }
      const le = se + U;
      di(E, S, q, y, se, le), H = Math.max(I + U, H), m = Math.max(le, m);
    };
    if (Ht(w)) {
      const R = z1(w, l);
      N(v, k, G1("default", R));
    } else {
      const R = hr(w, v, o, c), x = R.length;
      for (let E = 0; E < x; E++) {
        v = v, k = k;
        const V = R[E], b = z1(V, l);
        for (const S in v)
          N(v[S], mi(k, S), G1(S, b), E, x);
      }
    }
    u = h, h += H;
  }
  return l.forEach((g, p) => {
    for (const w in g) {
      ...
      for (let x = 0; x < v.length; x++) {
        const { at: E, value: V, easing: b } = v[x];
        k.push(V), H.push(Nn(0, m, E)), N.push(b || "easeOut");
      }
      H[0] !== 0 && (H.unshift(0), k.unshift(k[0]), N.unshift(hi)), H[H.length - 1] !== 1 && (H.push(1), k.push(null)), a.has(p) || a.set(p, {
        keyframes: {},
        transition: {}
      });
      const R = a.get(p);
      R.keyframes[w] = k, R.transition[w] = {
        ...t,
        duration: m,
        ease: N,
        times: H,
...
const vi = (e) => typeof e == "number", wi = (e) => e.every(vi);
function ki(e, t) {
  return e in t;
}
class xi extends Fn {
...
function yi(e, t) {
  return Ht(e) || typeof e == "number" || typeof e == "string" && !F1(t);
}
function pr(e, t, n, o) {
  const s = [];
  if (yi(e, t))
    s.push($n(e, F1(t) && t.default || t, n && (n.default || n)));
  else {
    const i = hr(e, t, o), a = i.length;
    $t(!!a, "No valid elements provided.");
    for (let l = 0; l < a; l++) {
      const c = i[l], f = c instanceof Element ? Li : bi;
      Ye.has(c) || f(c);
      const u = Ye.get(c), h = { ...n };
      "delay" in h && typeof h.delay == "function" && (h.delay = h.delay(l, a)), s.push(...Bn(u, { ...t, transition: h }, {}));
    }
  }
  return s;
}
function Mi(e, t, n) {
  const o = [];
  return pi(e, t, n, { spring: In }).forEach(({ keyframes: i, transition: a }, l) => {
    o.push(...pr(l, i, a));
  }), o;
}
class Ei {
...
function Fi(e) {
  function t(n, o, s) {
    let i = [];
    return Ni(n) ? i = Mi(n, o, e) : i = pr(n, o, s, e), new Ri(i);
  }
  return t;
}
const Si = Fi(), Vi = (e, t) => /* @__PURE__ */ d(
  "svg",
  {
...
kr.displayName = "ShoppingCart";
const rl = (e, t) => /* @__PURE__ */ d(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
), _l = C(jl), Ol = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Ti,
  Add: Pn,
  Ai: Dn,
  ...
  Calculator: eo,
  Calendar: to,
  CalendarArrowDown: oa,
  CalendarArrowLeft: ia,
  CalendarArrowRight: ca,
  CameraPlus: da,
  CardPin: fa,
  ChartFunnel: ga,
  ChartHorizontalBars: Ca,
  ChartLine: va,
  ChartPie: ka,
  ChartVerticalBars: La,
  Check: x1,
  CheckCircle: ro,
  CheckCircleLine: ya,
  CheckDouble: no,
  ...
  Wifi: _l,
  Windows: vs
}, Symbol.toStringTag, { value: "Module" })), Zl = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const Ie = Se({
  ...
  ({
    ...
    const h = s ?? Gl[t ?? "body"], m = c ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (i !== void 0) {
      ...
      return m ? De(
        ...
        ce,
        {
          ...
          noTooltip: a,
          tag: h,
          className: M(Ie({ variant: t, align: n }), o),
          markdown: l,
          ...f,
          children: e
        }
...
const Wl = Se({
...
}), i1 = { sm: 640, md: 768, "container-md": 448 }, m1 = (e) => "type" in e && e.type === "separator", Ke = (e) => "type" in e && e.type === "split", ql = (e) => !("type" in e), Qe = (e, t, n) => /* @__PURE__ */ r(
  he,
  {
    label: e.label,
    icon: e.icon,
  ...
  "secondary-link"
), Rr = (e, t) => Ke(e) ? T1(e, t, "default") : Qe(e, t, "default");
function W1({
  primaryAction: e,
  secondaryActions: t,
  otherActions: n = [],
  ...
  const u = B(null), { width: h = 0 } = ks({
    ref: u,
    box: "border-box"
  }), m = a === "sm" || a === "md" ? i1[a] : i1.md, g = Kt(`(min-width: ${m}px)`, {
    initializeWithValue: !1
  }), p = a === "none" ? !0 : a === "container-md" ? h >= i1["container-md"] : g, w = typeof o == "string" ? o : o.base, v = typeof o == "string" ? o : o.md, k = p ? v : w, H = Array.isArray(
    t
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: { gap: s },
      children: p ? /* @__PURE__ */ r(Yl, { ...R }, "row") : /* @__PURE__ */ r(Xl, { ...R }, "stacked")
    }
  );
}
function Xl({
  ...
  const i = t.filter(
    ...
    (a) => Ke(a) ? T1(a, s, "outline") : Qe(a, s, "outline")
  );
  return /* @__PURE__ */ d(ke, { children: [
    o.length > 0 && /* @__PURE__ */ r(Ls, { items: o }),
    i,
    n && Er(n, s),
    e && Rr(e, s)
  ] });
...
function Yl({
  ...
  const p = g ? h : l, w = g ? m : [], v = new Set(p.map((b) => b.id)), k = e ? Rr(e, s) : null, H = t.filter(Ke), N = t[t.length - 1], R = N != null && m1(N) && (H.length > 0 || k != null), x = [];
  t.forEach((b, S) => {
    if (!Ke(b)) {
      if (m1(b)) {
        x.push({ kind: "sep", key: `sep-${S}` });
        return;
      }
      v.has(b.id) && x.push({
        kind: "node",
  ...
  const E = x.filter(
    (b, S) => b.kind === "node" || x[S - 1]?.kind === "node" && x[S + 1]?.kind === "node"
  ), V = [
    ...w.map(
      (b) => ({
        label: b.label,
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          V.length > 0 && /* @__PURE__ */ r("div", { ref: u, children: /* @__PURE__ */ r(n1, { items: V, icon: Ot, size: s }) }),
          E.map(
            (b) => b.kind === "sep" ? /* @__PURE__ */ r(q1, {}, b.key) : b.node
          ),
          n && Er(n, s)
        ]
      }
...
const Nr = C(
  function({
        ...
        children: [
          m && !v && /* @__PURE__ */ r(
            tr,
            {
              href: m,
              variant: "unstyled",
              className: M("z-1 absolute inset-0 block rounded-xl", ge()),
              "aria-label": t,
              children: " "
            }
          ),
          /* @__PURE__ */ d("div", { className: Kl[k], children: [
            /* @__PURE__ */ d("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
              o && /* @__PURE__ */ r(Ms, { avatar: o, size: "lg" }),
    ...
    return N ? /* @__PURE__ */ r(Es, { ref: H, alert: p, fullHeight: g, children: R }) : R;
  }
);
Nr.displayName = "F0CardRow";
const n2 = ({ compact: e = !1 }) => /* @__PURE__ */ r(
  er,
  {
    className: M(
    ...
    children: /* @__PURE__ */ d("div", { className: "flex flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ d("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
        ...
        /* @__PURE__ */ d("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ r(fe, { className: "h-3 w-32 rounded-md" }),
          /* @__PURE__ */ r(fe, { className: "h-3 w-20 rounded-md" })
        ] })
      ] }),
      /* @__PURE__ */ r(fe, { className: "h-9 w-24 rounded-md" })
    ] })
  }
), o2 = Qt(
  Jt(Nr, n2)
), N9 = ["xs", "sm", "md", "lg"], s2 = 2, Y1 = 2, i2 = 70, K1 = 0.08, a2 = 6, c2 = 0.6, l2 = () => {
  ...
  return X(() => {
    ...
    const c = () => {
      ...
      s(
        Math.max(1, Math.floor((u + Y1) / (s2 + Y1)))
      );
    };
    ...
    const h = new Uint8Array(u.fftSize), m = setInterval(() => {
      ...
      const p = Math.sqrt(g / h.length), w = Math.min(1, Math.pow(p * a2, c2));
      a((v) => {
        const k = v.length >= o ? v.slice(v.length - o + 1) : v.slice();
        return k.push(w), k;
      });
    }, i2);
    return () => {
  ...
  "div",
  {
    ...
    children: e.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ r(fe, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ r(
        h2,
        {
          att: s,
          onRemove: n,
...
function h2({
  ...
  const o = /* @__PURE__ */ d("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(ae, { icon: Bt, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ r(
      "button",
      {
        ...
        onClick: () => t(e.id),
        children: /* @__PURE__ */ r(ae, { icon: Ee, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ r(Rs, { label: e.errorMessage, children: o }) : o;
}
const g2 = {
  soft: {
    text: "",
    ...
    "div",
    {
      ...
      children: c ? Array.from({ length: 3 }, (u, h) => /* @__PURE__ */ d(
        "div",
        {
          ...
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ r(fe, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ r(
              fe,
              {
        ...
        return /* @__PURE__ */ d(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ r(ce, { className: "text-base font-medium text-f1-foreground", children: g }) })
            ]
          },
          String(u.id)
        );
...
const m2 = ({
  ...
  return /* @__PURE__ */ r("div", { className: "p-1", children: /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ r(ae, { icon: V1, size: "md", color: "default" }) }),
        /* @__PURE__ */ r(
          ce,
          {
  ...
  const s = Le(), [i, a] = D(""), [l, c] = D(0), [f, u] = D(!1), h = B(null), m = B(null), g = B(null), p = e[l] ?? t;
  return X(() => {
    const w = () => {
    ...
    if (s)
      return u(!1), a(p), w(), h.current = setTimeout(() => {
        const x = (l + 1) % Math.max(e.length, 1);
        c(x);
      }, 4e3), () => {
        w();
      };
    ...
    e.length,
    s
  ]), n.length > 0 || o ? null : /* @__PURE__ */ r(ye, { children: /* @__PURE__ */ r(
    ne.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
const L2 = ({
  ...
  const [o, s] = D(null), i = o !== null ? e[o] : null;
  return e.length === 0 ? null : /* @__PURE__ */ d(
    M1,
    {
      ...
      children: [
        /* @__PURE__ */ r(Fs, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((a, l) => /* @__PURE__ */ r(E1, { asChild: !0, children: /* @__PURE__ */ r(
          ue,
          {
            variant: "outline",
            label: a.label,
          ...
          R1,
          {
            ...
            children: [
              /* @__PURE__ */ d("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ r(ae, { icon: i.icon, size: "sm" }),
                /* @__PURE__ */ r("span", { children: i.label })
              ] }),
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: x2(i.items).map((a, l) => /* @__PURE__ */ d(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    /* @__PURE__ */ r("span", { className: "min-w-0 flex-1 truncate", children: a.title }),
                    /* @__PURE__ */ r(
                      "span",
                      {
                        "aria-hidden": !0,
                        ...
                        children: /* @__PURE__ */ r(ae, { icon: k1, size: "sm" })
                      }
                    )
                  ]
                },
...
const y2 = 250, M2 = 12e4, E2 = () => typeof navigator < "u" && !!navigator.mediaDevices?.getUserMedia && typeof MediaRecorder < "u";
function R2({
  onTranscribe: e,
  onPartial: t,
  onFinal: n,
  ...
  const [i, a] = D("idle"), [l, c] = D(0), [f] = D(E2), [u, h] = D(null), m = B(null), g = B(null), p = B([]), w = B(null), v = B(!1), k = B(null), H = B(null), N = B(0), R = B({ onTranscribe: e, onPartial: t, onFinal: n, onError: o });
  R.current = { onTranscribe: e, onPartial: t, onFinal: n, onError: o };
  const x = W(() => {
    g.current?.getTracks().forEach((L) => L.stop()), g.current = null, m.current = null, h(null), k.current && (clearInterval(k.current), k.current = null), H.current && (clearTimeout(H.current), H.current = null);
  }, []), E = W(async () => {
    const { onTranscribe: L, onPartial: y, onFinal: T, onError: j } = R.current, O = p.current;
    if (p.current = [], O.length === 0 || !L) {
      a("idle"), c(0);
      return;
    }
    const Z = new Blob(O, { type: O[0]?.type || "audio/webm" }), z = new AbortController();
    w.current = z, a("transcribing");
    try {
      const q = await L(Z, {
        onPartial: y,
        signal: z.signal
      });
      z.signal.aborted || T(q);
    } catch {
      z.signal.aborted || j("transcription-failed");
    } finally {
    ...
    g.current = L, h(L);
    const y = new MediaRecorder(L);
    m.current = y, y.ondataavailable = (T) => {
      T.data.size > 0 && p.current.push(T.data);
    }, y.onstop = () => {
      if (x(), v.current) {
      ...
      E();
    }, y.start(y2), N.current = Date.now(), a("recording"), c(0), k.current = setInterval(() => {
      c(Date.now() - N.current);
    }, 200), H.current = setTimeout(V, s);
  }, [
    i,
    e,
    f,
  ...
  return X(
    ...
    [x]
  ), { status: i, durationMs: l, isSupported: f, stream: u, start: b, stop: V, cancel: S };
}
function N2(e, t) {
  if (t === "*/*") return !0;
  if (t.endsWith("/*")) {
...
const S2 = 4e3;
function V2(e) {
  const [t, n] = D([]), [o, s] = D(null), i = B(
    null
  ), a = B(null), l = J(), c = e?.onUploadFiles, f = e?.allowedMimeTypes, u = e?.maxFiles, h = ee(() => {
    if (f)
      return Array.isArray(f) ? f.join(",") : f;
  }, [f]), m = u !== void 0 && t.length >= u, g = B(0);
  X(() => {
    g.current = t.length;
  }, [t]);
  const p = W((N) => {
  ...
  const w = W(
    async (N) => {
      ...
      const V = (b) => n(
        (S) => S.map(
          (L) => E.includes(L.id) ? { ...L, status: "error", errorMessage: b } : L
        )
      );
      try {
        const b = await c(R);
        ...
        n(
          (S) => S.map((L) => {
            const y = x.findIndex((T) => T.id === L.id);
            return y === -1 ? L : b[y] ? {
              ...L,
              status: "uploaded",
              uploadedFile: b[y]
        ...
        const S = b instanceof Error && b.message ? b.message : l.ai.fileUploadError;
        V(S);
      }
    },
    [
...
function B2({
  ...
  const [i, a] = D(!1), [l, c] = D(""), [f, u] = D([]), [h, m] = D(!1), [g, p] = D(0), [w, v] = D([]), k = B(-1), H = B(null), N = B(0), R = B(-1);
  X(() => {
    if (!o) {
      a(!1);
      return;
    ...
    const y = T2(e, n, w);
    if (!y) {
      a(!1), c(""), u([]), p(0), k.current = -1, R.current = -1;
      return;
    }
    if (y.atIndex === R.current)
      return;
    k.current = y.atIndex, c(y.query), a(!0), p(0), m(!0), H.current && clearTimeout(H.current);
    const T = ++N.current;
    return H.current = setTimeout(() => {
      o(y.query).then((j) => {
        T === N.current && (u(j), p(0), j.length === 0 && y.query.length > 0 && (R.current = y.atIndex, a(!1)));
      }).catch(() => {
        T === N.current && u([]);
      }).finally(() => {
        T === N.current && m(!1);
  ...
  const x = W(() => {
    a(!1), c(""), u([]), p(0), k.current = -1;
  }, []), E = W(
    (y) => {
      const T = k.current;
      if (T === -1) return;
      const j = `${y.firstName} ${y.lastName}`.trim(), O = String(y.id), Z = e.slice(0, T), z = e.slice(n), q = `@${j} `, U = Z + q + z, I = Z.length + q.length;
      t(U), v((Y) => [...Y.filter((se) => !(se.id === O && se.name === j)), { id: O, name: j }]), x(), requestAnimationFrame(() => {
        const Y = s.current;
        Y && (Y.focus(), Y.setSelectionRange(I, I));
      });
    },
    [e, n, t, s, x]
  ), V = W(
    (y) => {
      if (!i) return !1;
      if (y.key === "Escape")
        return y.preventDefault(), x(), !0;
      if (f.length === 0) return !1;
      switch (y.key) {
        case "ArrowDown":
          return y.preventDefault(), p((T) => (T + 1) % f.length), !0;
        case "ArrowUp":
          return y.preventDefault(), p(
            (T) => (T + f.length - 1) % f.length
          ), !0;
        case "Tab": {
          const T = f[g];
          if (T) {
            const j = `${T.firstName} ${T.lastName}`.trim();
            if (l.length === 0 || j.toLowerCase().startsWith(l.toLowerCase()))
              return y.preventDefault(), E(T), !0;
          }
          return !1;
        }
        case "Enter":
          return y.preventDefault(), f[g] && E(f[g]), !0;
        default:
          return !1;
      }
    },
    ...
    (y) => {
      ...
      let T = y;
      const j = [...w].sort((O, Z) => Z.name.length - O.name.length);
      for (const O of j) {
        const Z = `@${O.name}`, z = `<entity-ref type="person" id="${Q1(O.id)}">${Q1(O.name)}</entity-ref>`;
        for (; T.includes(Z); )
          T = T.replace(Z, z);
      }
      return T;
  ...
  X(() => {
    v(
      (y) => y.filter((T) => {
        const j = `@${T.name}`, O = e.indexOf(j);
        if (O === -1) return !1;
        const Z = e[O + j.length];
        return Z === " " || Z === `
` || Z === "	";
      })
    );
  ...
  const S = ee(() => {
    ...
    const y = s.current;
    if (!y) return null;
    const T = H2(y, k.current), j = y.offsetLeft + T.left, Z = (y.offsetParent ? y.offsetParent.offsetHeight : 0) - (y.offsetTop + T.top);
    return { left: j, bottom: Z };
  }, [i, e, n, s]), L = ee(() => {
    if (!i || f.length === 0) return null;
    const y = f[g];
    if (!y) return null;
    const T = `${y.firstName} ${y.lastName}`.trim();
    return l.length === 0 ? T : T.toLowerCase().startsWith(l.toLowerCase()) ? T.slice(l.length) : null;
  }, [i, f, g, l]);
  return {
    isOpen: i,
    query: l,
...
const I2 = /[\\`*_{}[\]()#+\-.!|~>]/g, P2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(I2, "\\$&")).join(""), F9 = ({
  onSubmit: e,
  onStop: t,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const E = J(), V = Le(), [b, S] = D(""), [L, y] = D(0), [T, j] = D(!1), [O, Z] = D(!1), [z, q] = D(null), U = B(null), I = B(null), Y = B(null), te = a != null, { tracking: se } = Re(), pe = W(
    (re, xe) => {
      se?.onWelcomeSuggestionClick?.({
        item: re,
        group: xe,
        prompt: re.prompt || re.title
      }), R?.(re, xe);
    },
    [se, R]
  ), {
    ...
    const xe = me.current, o1 = xe && !/\s$/.test(xe) ? " " : "", Ge = `${xe}${o1}${re}`;
    S(Ge), y(Ge.length);
  }, []), $e = {
    ...
    onPartial: be,
    onFinal: (re) => {
      be(re), I.current?.focus();
    },
    onError: (re) => ie($e[re])
  }), Be = !!m && we.isSupported, an = W(() => {
    me.current = b, we.start();
  }, [b, we]);
  X(() => {
  ...
  const H1 = we.status === "recording", cn = H1 ? E.ai.listening : E.ai.inputPlaceholder, ln = le.filter((re) => re.status === "uploaded"), ze = le.some((re) => re.status === "uploading"), $1 = le.some((re) => re.status === "error"), B1 = b.trim().length > 0;
  X(() => {
    if (!(!O || ze)) {
      if (Z(!1), $1) {
        ie(E.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const dn = async (re) => {
    if (re.preventDefault(), !te) {
      if (Q.close(), n)
        ...
        const xe = Q.transformMentions(b.trim()), o1 = P2(xe), Ge = ln.flatMap(
          (_1) => _1.uploadedFile ? [_1.uploadedFile] : []
        ), D1 = l, j1 = f;
        D1 && c?.(null), j1 && u?.(null), await e({
          text: o1,
          files: Ge,
          context: D1,
          quote: j1
    ...
    te || Q.handleKeyDown(re) || re.key === "Enter" && !re.shiftKey && (re.preventDefault(), n || U.current?.requestSubmit());
  }, fn = () => {
    y(I.current?.selectionStart ?? 0);
  }, hn = () => {
    Y.current && I.current && (Y.current.scrollTop = I.current.scrollTop);
  }, I1 = z ? z.prompt ?? z.title : null, P1 = H1 ? [E.ai.listening] : I1 ? [I1] : s ?? [], gn = P1.length > 1, pn = ee(() => b2(b, Q.mentions, {
    cursorPosition: L,
    inlineCompletion: Q.inlineCompletion
  }), [b, Q.mentions, L, Q.inlineCompletion]), Cn = Q.mentions.length > 0 || Q.inlineCompletion !== null;
  return /* @__PURE__ */ d("div", { ref: x, className: "flex flex-col items-center gap-2 px-4 pb-3 pt-2", children: [
    /* @__PURE__ */ d("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
      k && N && N.length > 0 && R && /* @__PURE__ */ r(
        L2,
        {
          suggestions: N,
          onItemClick: pe,
      ...
      /* @__PURE__ */ r(p2, { creditWarning: i, children: /* @__PURE__ */ d(
        ne.form,
        {
          "aria-busy": n,
          ref: U,
          className: M(
            ...
            te && "after:scale-100 after:opacity-100 border-f1-background-tertiary"
          ),
          animate: {
          ...
          children: [
            /* @__PURE__ */ r(
              C2,
              {
                ...
                position: Q.popoverPosition,
                onSelect: Q.selectPerson
              }
            ),
            /* @__PURE__ */ r(ye, { initial: !1, children: te ? /* @__PURE__ */ r(
              ne.div,
              {
              ...
              ne.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ r(ye, { initial: !1, children: G && /* @__PURE__ */ r(
                    ne.div,
                    {
                      role: "alert",
                      "aria-live": "polite",
                      ...
                      children: /* @__PURE__ */ d(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ r("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ r(Ss, { type: "critical", size: "sm" }) }),
                            /* @__PURE__ */ r("p", { className: "font-medium text-f1-foreground-critical", children: G })
                          ]
                        }
                      )
                    },
                  ...
                  /* @__PURE__ */ r(
                    w2,
                    {
                      ...
                      onCursorUpdate: fn,
                      onScroll: hn,
                      highlightSegments: pn,
                      hasOverlay: Cn,
                      multiplePlaceholders: gn,
                      placeholders: P1,
                      resolvedDefaultPlaceholder: cn,
                      inProgress: n
                    }
                  ),
                  /* @__PURE__ */ r(
    ...
    /* @__PURE__ */ r(ye, { mode: "wait", initial: !1, children: te ? /* @__PURE__ */ d(
      ne.div,
      {
      ...
      ne.div,
      {
        ...
        children: [
          ...
          ) : /* @__PURE__ */ r(ce, { className: "text-sm font-medium text-f1-foreground-tertiary", children: w.text }),
    ...
    /* @__PURE__ */ r(ye, { children: v && k && /* @__PURE__ */ r(
      ne.div,
      {
        className: M(
...
function U2({
  ...
  return /* @__PURE__ */ r(tr, { ...t, variant: "link", href: t.href, children: e });
}
function z2({
  children: e,
  ...t
...
function He({
  ...
  const i = B(/* @__PURE__ */ new Map()), [a, l] = D(
    () => i.current.get(e) ?? null
  ), [c, f] = D(!1), [u, h] = D(!1), m = B(!0);
  X(() => () => {
    m.current = !1;
  }, []);
  const g = W(() => {
  ...
  return /* @__PURE__ */ d(
    Ts,
    {
      ...
      children: [
        /* @__PURE__ */ r(As, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          Hs,
          {
            side: "top",
            ...
            children: c ? /* @__PURE__ */ r(O1.Skeleton, {}) : /* @__PURE__ */ r(O1, { ...p })
          }
        )
      ]
    }
...
function o6({
  ...
  const { entityRefs: n } = Re(), o = n?.resolvers?.candidate, s = J(), i = n?.urls?.candidate?.(e), a = ee(
    () => (c) => {
      const f = [];
...
Sr.displayName = "ExpenseTrigger";
function s6({ id: e, label: t }) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.expense, s = J(), i = n?.urls?.expense?.(e), a = ee(
    () => (c) => ({
      avatar: {
        type: "icon",
        icon: vr
...
Vr.displayName = "JobPostingTrigger";
function i6({
  id: e,
  label: t
}) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.jobPosting, s = J(), i = n?.urls?.jobPosting?.(e), a = ee(
    () => (c) => ({
      title: c.title,
...
function c6({
  ...
  const { entityRefs: n } = Re(), o = n?.resolvers?.requisition, s = J(), i = n?.urls?.requisition?.(e), a = ee(
    () => (c) => {
...
Ar.displayName = "PersonTrigger";
function l6({ id: e, label: t }) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.person, s = J(), i = n?.urls?.person?.(e), a = ee(
    () => (c) => ({
      avatar: {
        type: "person",
        firstName: c.firstName,
...
Hr.displayName = "VacancyTrigger";
function d6({ id: e, label: t }) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.vacancy, s = J(), i = n?.urls?.vacancy?.(e), a = ee(
    () => (c) => ({
      title: c.name,
...
function v1(e) {
  return typeof e == "string" ? e : typeof e == "number" ? String(e) : Array.isArray(e) ? e.map(v1).join("") : e && typeof e == "object" && "props" in e ? v1(e.props.children) : "";
}
function h6({
  type: e,
  id: t,
...
}, $r = mn.forwardRef(({ animate: e = "normal", ...t }, n) => /* @__PURE__ */ d(
  "svg",
  {
    ref: n,
    viewBox: "0 0 24 24",
...
$r.displayName = "CheckCircleLineAnimated";
const Br = 60, Ir = 40, J1 = 2e3, v6 = 500, w6 = 12e3, Pr = 2, je = 40, Ve = [255, 60, 0], c1 = [160, 140, 220], l1 = { x: -12, y: 0, z: 0 }, d1 = { x: -12, y: 12, z: 90 }, Te = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, u1 = Math.PI / 180, k6 = Pr / 8 * Math.PI, x6 = 4 * Math.PI;
function Je(e, t) {
  return [
...
function Dr(e, t, n) {
  const o = _e(1, 0, 0, e * u1), s = _e(0, 1, 0, t * u1), i = _e(0, 0, 1, n * u1);
  return L6(Je(Je(s, o), i));
}
function b6(e) {
  return e < 0.5 ? 4 * e * e * e : 1 - Math.pow(-2 * e + 2, 3) / 2;
}
const Oe = 256, y6 = (() => {
  const e = new Array(Oe);
  for (let t = 0; t < Oe; t++) {
    const n = t / (Oe - 1), o = Math.round(Ve[0] + (c1[0] - Ve[0]) * n), s = Math.round(Ve[1] + (c1[1] - Ve[1]) * n), i = Math.round(Ve[2] + (c1[2] - Ve[2]) * n);
    e[t] = `rgb(${o},${s},${i})`;
  }
  return e;
})();
function M6(e) {
  const t = e <= 0 ? 0 : e >= 1 ? Oe - 1 : e * (Oe - 1) | 0;
  return y6[t];
}
const E6 = Object.keys(Te).map(Number).sort((e, t) => e - t);
function R6(e) {
  const t = E6;
  if (e <= t[0]) return Te[t[0]];
  if (e >= t[t.length - 1])
    return Te[t[t.length - 1]];
  for (let n = 0; n < t.length - 1; n++)
    if (e >= t[n] && e <= t[n + 1]) {
      const o = (e - t[n]) / (t[n + 1] - t[n]);
      return Te[t[n]] + (Te[t[n + 1]] - Te[t[n]]) * o;
    }
  return 0.72;
}
const tt = Math.sqrt(Br ** 2 + Ir ** 2), f1 = [Br / tt, Ir / tt, 0], N6 = Dr(l1.x, l1.y, l1.z), F6 = Dr(d1.x, d1.y, d1.z), Ae = Pr * 3, Xe = je + 1, rt = (Ae + 1) * Xe, e1 = 4 * Ae * je, h1 = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
], S6 = (e, t) => e.avgZ - t.avgZ;
function V6() {
  const e = new Array(e1);
  for (let n = 0; n < e1; n++)
...
function nt(e, t, n, o) {
  const { quads: s, grid: i } = e, a = n * 0.392, l = n / 2, c = n / 2, f = k6 * R6(n), u = t * x6, h = _e(0, 0, 1, o * 2 * Math.PI);
  et(h, f1[0], f1[1], f1[2], Ne);
  const m = _e(Ne[0], Ne[1], Ne[2], u), g = Je(m, N6), p = Je(m, F6);
  h1[0] = g, h1[1] = p;
  let w = 0;
  for (let v = 0; v < 4; v++) {
    const k = h1[v >> 1], H = v & 1 ? -1 : 1;
    for (let N = 0; N <= Ae; N++) {
      const R = H * (Math.PI / 2 - N / Ae * f), x = Math.cos(R), E = Math.sin(R), V = Math.sin(N / Ae * Math.PI), b = N * Xe;
      for (let S = 0; S <= je; S++) {
        const L = S / je * Math.PI * 2;
        et(k, x * Math.cos(L), E, x * Math.sin(L), Ne);
        const y = i[b + S];
        y.x = Ne[0], y.y = Ne[1], y.z = Ne[2], y.t = V;
      }
    }
    for (let N = 0; N < Ae; N++) {
      const R = N * Xe, x = (N + 1) * Xe;
      for (let E = 0; E < je; E++) {
        const V = i[R + E], b = i[R + E + 1], S = i[x + E], L = i[x + E + 1];
        if ((V.t + b.t + S.t + L.t) * 0.25 < 1e-3) continue;
        const T = (V.x + b.x + S.x + L.x) * 0.25, j = (V.y + b.y + S.y + L.y) * 0.25, O = (V.z + b.z + S.z + L.z) * 0.25, Z = T * a, z = j * a, q = V.x * a - Z, U = V.y * a - z, I = Math.sqrt(q * q + U * U), Y = I > 0 ? (I + 0.9) / I : 1, te = l + Z + q * Y, se = c - z - U * Y, pe = b.x * a - Z, le = b.y * a - z, K = Math.sqrt(pe * pe + le * le), oe = K > 0 ? (K + 0.9) / K : 1, de = l + Z + pe * oe, Ce = c - z - le * oe, F = L.x * a - Z, $ = L.y * a - z, A = Math.sqrt(F * F + $ * $), _ = A > 0 ? (A + 0.9) / A : 1, P = l + Z + F * _, G = c - z - $ * _, ie = S.x * a - Z, Q = S.y * a - z, me = Math.sqrt(ie * ie + Q * Q), be = me > 0 ? (me + 0.9) / me : 1, $e = l + Z + ie * be, we = c - z - Q * be, Be = s[w];
        Be.points = `${te},${se} ${de},${Ce} ${P},${G} ${$e},${we}`, Be.color = M6((T + 1) * 0.5), Be.avgZ = O, w++;
      }
    }
  }
  for (let v = w; v < e1; v++)
...
const T6 = ({ size: e = 20, className: t, style: n, variant: o = "default" }, s) => {
  const i = B(null), a = B(null), l = B(null);
  l.current === null && (l.current = V6());
  const c = ee(() => new Array(e1).fill(0), []), f = (u) => {
  ...
  return X(() => {
    ...
    let p = null, w = 0, v = 0, k = 0, H = null, N = "spin", R = !0, x = !1;
    const E = (y) => {
      const T = g.quads;
      for (let j = 0; j < m.length; j++) {
        ...
        if (j < y) {
          const Z = T[j];
          O.setAttribute("points", Z.points), O.setAttribute("fill", Z.color), O.hasAttribute("display") && O.removeAttribute("display");
        } else O.hasAttribute("display") || O.setAttribute("display", "none");
      }
    }, V = (y) => {
      x || (w = y, v = y, x = !0);
      let T = 0, j = !0;
      if (o === "continuous") {
        const q = J1 * 2, U = (y - w) % q / q;
        T = U < 0.5 ? U * 2 : (1 - U) * 2, j = !1;
      } else N === "spin" ? (T = Math.min((y - w) / J1, 1), T >= 1 && (T = 0, N = "pause", k = y)) : (T = 0, y - k >= v6 && (N = "spin", w = y));
      const O = (y - v) / w6 % 1, Z = j ? b6(T) : T, z = nt(g, Z, e, O);
      E(z), p = requestAnimationFrame(V);
    }, b = () => {
    ...
    return typeof IntersectionObserver < "u" && (L = new IntersectionObserver(
      (y) => {
        const T = y[0]?.isIntersecting ?? !0;
        if (T !== R)
          if (R = T, T) {
            if (H !== null && x) {
              const j = performance.now() - H;
              w += j, v += j, k += j;
            }
            H = null, b();
          } else
...
jr.displayName = "ChatSpinner";
const ot = {
  initial: { opacity: 0 },
  animate: { opacity: 1 },
  exit: { opacity: 0 }
}, w1 = ({ title: e, status: t, inGroup: n }) => {
  const s = {
    duration: Le() ? 0 : 0.18,
    ease: [0.33, 1, 0.68, 1]
  ...
  return /* @__PURE__ */ d("div", { className: "flex w-full items-start gap-1 text-f1-foreground-secondary", children: [
    /* @__PURE__ */ r("div", { className: "flex h-5 w-6 shrink-0 items-center justify-start", children: /* @__PURE__ */ d(ye, { mode: "wait", children: [
      i && /* @__PURE__ */ r(
        ne.div,
        {
      ...
      (a || c) && /* @__PURE__ */ r("div", { className: "flex h-5 w-5 shrink-0 items-center justify-center", children: /* @__PURE__ */ r(jr, { variant: a ? "default" : "continuous" }) }),
      l && /* @__PURE__ */ r(
        ne.div,
        {
          ...ot,
...
function _r({
  ...
  const a = J(), l = s.type === "open", c = l ? o ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ d(
    "div",
    {
      className: M(
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ r(or, { module: e.module, size: "lg" }),
          e?.type === "file" && /* @__PURE__ */ r(Bs, { file: e.file, size: "lg" }),
...
_r.displayName = "F0CanvasCard";
const A1 = t1(null);
function T9({
  children: e
}) {
  const [t, n] = D(0), o = B([]), s = W(
    (a) => {
  ...
  return /* @__PURE__ */ r(A1.Provider, { value: i, children: e });
}
function A6(e) {
  const n = Ue(A1)?.formatters;
...
const st = 7, H6 = 625, it = /* @__PURE__ */ new Set();
function $6(e) {
...
function Or(e, t) {
  ...
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const n = e.value;
    return { type: "item", text: (n ? $6(n) : "") || "—" };
  }
  if (t === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: n, to: o } = e, s = at(n) ? ct(n) : String(n), i = at(o) ? ct(o) : String(o);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((o) => {
      const s = Or(o);
      return Array.isArray(s) ? s.map(lt).join(", ") : lt(s);
    }).filter(Boolean).join(", ") || "—" };
...
function Zr({
  ...
  const { canvasContent: c, openCanvas: f, closeCanvas: u } = Re(), h = A6(e), m = l ?? h, g = B(() => {
  }), p = o ?? e, w = s ?? t ?? "", v = c?.type === "form" && c.formName === e, k = () => f({
    type: "form",
    title: p,
    description: w,
    formName: e,
  ...
  g.current = k, X(() => {
    typeof window > "u" || window.innerWidth < H6 || it.has(e) || (it.add(e), g.current());
  }, [e]);
  const H = i && a ? Object.entries(i).map(([x, E]) => {
    const V = a[x], b = m?.(x, V, {
      fieldType: E.fieldType,
      customFieldName: E.customFieldName
    });
    if (!b && E.fieldType === "custom" && typeof V == "object" && V !== null)
      return null;
    const S = b ?? Or(V, E.fieldType), L = ["richtext", "textarea"];
    return {
      label: E.label,
      content: S,
      verticalLayout: L.includes(E.fieldType ?? "")
    };
  }).filter((x) => {
    if (!x) return !1;
    const E = Array.isArray(x.content) ? x.content[0] : x.content;
    return !(E?.type === "item" && E.text === "—");
  }) : [], N = H.slice(0, st), R = H.length > st;
  return /* @__PURE__ */ r(
    _r,
    {
...
Zr.displayName = "FormCard";
function P6() {
  const e = Ds(), t = e?.activeForm;
  if (!t) return null;
...
const dt = 8, Pe = 8;
function zr({ anchor: e, onReply: t }) {
  const n = J(), o = B(null), [s, i] = D(
    null
  );
  if (Tt(() => {
    if (!e) {
    ...
    let m = e.rect.top - f - dt;
    m < Pe && (m = e.rect.bottom + dt), m = Math.min(
      Math.max(m, Pe),
      h - f - Pe
    );
...
const Gr = t1(void 0), H9 = () => Ue(Gr), _6 = (e) => /* @__PURE__ */ r(sr, { content: e, format: "markdown" }), O6 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const l = typeof n?.content == "string" ? n.content : "", c = (n && o?.(n)) ?? n?.generativeUI?.() ?? null, f = n?.toolCalls?.[0]?.id, u = !l && !c, h = B(null), { anchor: m, clear: g } = Ur({
    containerRef: h,
    enabled: !!(n?.id && l)
  });
  return X(() => {
    n?.id && !t && !e && i?.(n);
  }, [n, t, e, i]), !t && !e && u ? null : /* @__PURE__ */ r(Gr.Provider, { value: f, children: /* @__PURE__ */ d("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    n && l && /* @__PURE__ */ r(
      "div",
      {
        ref: h,
  ...
  const [s, i] = D(""), a = J(), { title: l, label: c, placeholder: f } = n === "like" ? a.ai.feedbackModal.positive : a.ai.feedbackModal.negative, u = W(() => {
    t(o, s);
  }, [s, o, t]), h = () => {
    e(o);
  };
...
}, Wr = t1(null), U6 = ({ children: e }) => {
  const [t, n] = D(null), o = t ? {
    isOpen: !0,
  ...
  return /* @__PURE__ */ r(Wr.Provider, { value: o, children: e });
}, qr = () => {
  const e = Ue(Wr);
  if (e === null)
    throw new Error(
...
const G6 = ({
  ...
  const o = J(), { open: s } = qr(), [i, a] = D(null);
  ...
  const [l, c] = D(s), f = Le(), u = o !== void 0, h = u ? o : l;
  return /* @__PURE__ */ d(
    ir,
    {
      ...
      children: [
        /* @__PURE__ */ d(
          ar,
          {
            ...
            children: [
              /* @__PURE__ */ r("span", { className: "flex items-center justify-start h-6 w-6", children: /* @__PURE__ */ r(ae, { icon: e, className: "block" }) }),
              /* @__PURE__ */ r("div", { className: "min-h-6 flex items-center", children: /* @__PURE__ */ r("span", { children: t }) }),
              !a && /* @__PURE__ */ r(ae, { icon: r1 })
            ]
          }
        ),
...
const Xr = (e) => /* @__PURE__ */ r(sr, { content: e, format: "markdown" }), K6 = ({
  text: e,
  renderMarkdown: t
}) => /* @__PURE__ */ d("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ r("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ r(ae, { icon: V1 }) }),
  ...
  const a = e.rawData, l = Y6(
    e?.content,
    a
  ), c = (X6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = c.length > 0, { anchor: h, clear: m } = Ur({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ r(K6, { text: f, renderMarkdown: o }),
...
}, J6 = 35, e4 = 22, t4 = 400, r4 = 2500, n4 = 220, o4 = ({ messages: e, onClick: t }) => {
  const [n, o] = D(0), [s, i] = D(0), [a, l] = D("starting"), c = e[n] ?? "";
  X(() => {
    e.length > 0 && n >= e.length && (o(0), i(0), l("starting"));
  }, [e.length, n]), X(() => {
    let h;
    if (a === "starting")
      h = setTimeout(() => l("writing"), t4);
    else if (a === "writing")
      s < c.length ? h = setTimeout(() => i((m) => m + 1), J6) : l("holding");
    else if (a === "holding") {
      if (e.length <= 1) return;
      h = setTimeout(() => l("erasing"), r4);
    } else a === "erasing" && (s > 0 ? h = setTimeout(() => i((m) => m - 1), e4) : h = setTimeout(() => {
      o((m) => (m + 1) % e.length), l("starting");
    }, n4));
    return () => {
      h && clearTimeout(h);
    };
  }, [a, s, c.length, e.length]);
  const f = !!t;
  return /* @__PURE__ */ r("div", { className: "flex w-full flex-1 items-center justify-center px-4", children: /* @__PURE__ */ r(
    "p",
    {
...
function s4({
  ...
  const [a, l] = D(0), [c, f] = D(!1), u = B(s), h = B(i);
  h.current = i;
  const m = W(
    (p = "smooth") => {
  ...
  X(() => {
    ...
    const v = new ResizeObserver(() => {
      if (h.current) return;
      const k = parseFloat(getComputedStyle(w).paddingTop) + parseFloat(getComputedStyle(w).paddingBottom) + 1;
      l(p.clientHeight - k);
    });
  ...
  const g = W(() => {
    const p = e.current;
    if (!p) return;
    const { scrollTop: w, scrollHeight: v, clientHeight: k } = p, H = v - w - k;
    f(H > k);
  }, [e]);
  return X(() => {
    const p = e.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!p || !w) return;
        const v = p.getBoundingClientRect(), k = w.getBoundingClientRect(), H = p.scrollTop + (k.top - v.top);
        p.scrollTo({ top: H, behavior: "smooth" });
      });
    }), s === 0 && f(!1), u.current = s;
...
const i4 = {
...
}, $9 = (e) => /* @__PURE__ */ r(U6, { children: /* @__PURE__ */ r(a4, { ...e }) }), a4 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: H, handleSubmit: N, handleClose: R } = z6(
    u ?? i4
  ), x = J(), E = p ?? O6, V = w ?? Q6, b = ee(() => {
    const I = o ?? x.ai.defaultInitialMessage;
    return (Array.isArray(I) ? I : [I]).filter((te) => typeof te == "string" && te.length > 0);
  }, [o, x.ai.defaultInitialMessage]), S = !t && e.length === 0 && b.length > 0, L = B(null), y = B(null), T = B(null), j = B(null), O = B(null), { showScrollBtn: Z, turnMinHeight: z, scrollToBottom: q } = s4({
    viewportRef: L,
    contentRef: y,
    endRef: T,
    lastTurnRef: O,
    ...
    const te = Y === e.length - 1, se = {
      ...
      const de = te && oe === I.assistantMessages.length - 1, Ce = I.userMessages.length + oe, F = {
        message: K,
        inProgress: I.isInProgress,
        index: Ce,
        isCurrentMessage: de,
      ...
      return /* @__PURE__ */ r(
        E,
        {
          ...
          isLoading: I.isInProgress && de && !K.content
        },
        `${Y}-a-${oe}`
      );
    };
    return /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          I.endIndicator === "thinking" && /* @__PURE__ */ r(w1, { title: x.ai.thinking, status: "executing" }),
          I.endIndicator === "activity" && /* @__PURE__ */ r(w1, { status: "writing" }),
  ...
  return /* @__PURE__ */ d(ke, { children: [
    /* @__PURE__ */ d("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
          ...
          children: /* @__PURE__ */ d(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { ref: j, className: "h-px shrink-0", "aria-hidden": !0 }),
                /* @__PURE__ */ r("footer", { className: "copilotKitMessagesFooter", ref: T, children: g }),
                /* @__PURE__ */ r(ye, { children: Z && /* @__PURE__ */ r(
                  ne.div,
                  {
      ...
      !m && !S && /* @__PURE__ */ d(ke, { children: [
        /* @__PURE__ */ r(ut, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ r(ut, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    H.isOpen && /* @__PURE__ */ r(
      Z6,
...
}, c4 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ d("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ r("div", { className: "flex justify-end", children: /* @__PURE__ */ r(fe, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ r(fe, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ r(fe, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ r(fe, { className: "h-5 w-4/5 rounded-md" })
] }) }), B9 = {
  ai: oi.ai
}, Yr = t1(null);
function I9({
  ...
  return /* @__PURE__ */ r(Yr.Provider, { value: t, children: e });
}
function P9() {
  const e = Ue(Yr);
  if (e === null)
...
const d4 = ({
  ...
  const m = J().ai.clarifyingQuestion.typeYourAnswer, g = e === "single" ? /* @__PURE__ */ r(Kr, { isSelected: n && !t }) : /* @__PURE__ */ r(
    lr,
    {
      checked: s,
      onCheckedChange: () => f(!s),
...
const f4 = ({
  ...
  const E = (V) => {
    ...
    V.preventDefault(), R(S), x.current[S]?.focus();
  };
  return /* @__PURE__ */ d(
    "div",
    {
  ...
  } = s, V = B(null), b = H ?? "single", S = a > 1, L = i === 0, y = i === a - 1, T = S ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  }) : void 0, j = k.length > 0, O = (x ?? "").trim().length > 0, Z = j || E && O || N === !0, z = t === !0 && y, q = () => {
    z || c();
  }, U = () => {
    z || f();
  }, I = (K) => {
    const oe = b === "single" && k.includes(K);
    l(K), b === "single" && !y && !oe && Promise.resolve().then(c);
  }, Y = y ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, te = N === !0 && !j && !(E && O), se = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-col", onKeyDown: pe, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(ye, { mode: "wait", initial: !1, children: /* @__PURE__ */ d(
      ne.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: le, ease: g4 },
        children: [
          /* @__PURE__ */ r(
            h4,
            {
...
function ft(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), l = Math.min(i + o, s), c = Math.min(l, Math.floor(e / 2)), f = Math.min(l, Math.floor(t / 2)), u = (se) => se / e * 2 - 1, h = (se) => se / t * 2 - 1, m = 0, g = e, p = 0, w = t, v = c, k = e - c, H = f, N = t - f, R = u(m), x = u(g), E = h(p), V = h(w), b = u(v), S = u(k), L = h(H), y = h(N), T = 0, j = 0, O = 1, Z = 1, z = c / e, q = 1 - c / e, U = f / t, I = 1 - f / t, Y = new Float32Array([
    // Top strip
    R,
    E,
    x,
...
function m4(e, t, n) {
  const o = ht(e, e.VERTEX_SHADER, t), s = ht(e, e.FRAGMENT_SHADER, n), i = e.createProgram();
...
class _9 {
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: a, uvs: l } = ft(
      s,
      i,
    ...
    const m = t.getUniformLocation(n, "uResolution"), g = t.getUniformLocation(n, "uTime"), p = t.getUniformLocation(n, "uBorderWidth"), w = t.getUniformLocation(n, "uGlowWidth"), v = t.getUniformLocation(n, "uBorderRadius"), k = t.getUniformLocation(n, "uColors"), H = t.getUniformLocation(n, "uGlowExponent"), N = t.getUniformLocation(n, "uGlowFactor");
    t.useProgram(n), t.uniform1f(p, this.options.borderWidth), t.uniform1f(w, this.options.glowWidth), t.uniform1f(v, this.options.borderRadius), this.options.mode === "dark" ? (t.uniform1f(H, 2), t.uniform1f(N, 1.8)) : (t.uniform1f(H, 1), t.uniform1f(N, 1));
    const R = (this.options.colors || k4).map(x4);
    for (let x = 0; x < R.length; x++)
      t.uniform3f(
        t.getUniformLocation(n, `uColors[${x}]`),
        ...R[x]
      );
...
const gt = ["lowp", "mediump", "highp"], L4 = `
void main(void){
...
}`, pt = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, Ct = "iTime", mt = "iTimeDelta", vt = "iDate", wt = "iFrame", kt = "iMouse", xt = "iResolution", y4 = "iChannel", Lt = "iChannelResolution", bt = "iDeviceOrientation";
function M4(e, t) {
...
}, g1 = 9729, yt = 9728, S4 = 9987, Mt = 33071, Et = 10497;
class V4 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const h = 0, m = n.RGBA, g = 1, p = 1, w = 0, v = n.RGBA, k = n.UNSIGNED_BYTE, H = new Uint8Array([255, 255, 255, 0]), N = n.createTexture();
    ...
    async function R() {
      return new Promise((V, b) => {
        ...
        S.crossOrigin = "anonymous", S.onload = () => {
          ...
          b(new Error(Me(`failed loading url: ${o}`)));
        }, S.src = o ?? "";
      });
    }
    let x = await R(), E = (x.width & x.width - 1) === 0 && (x.height & x.height - 1) === 0;
    return (t.wrapS !== Mt || t.wrapT !== Mt || t.minFilter !== yt && t.minFilter !== g1) && !E && (x = this.makePowerOf2(x), E = !0), n.bindTexture(n.TEXTURE_2D, N), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, c), n.texImage2D(
      n.TEXTURE_2D,
      h,
      m,
      v,
      k,
      x
    ), E && t.minFilter !== yt && t.minFilter !== g1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || Et
    ), n.texParameteri(
      ...
      this.magFilter || g1
    ), this._webglTexture = N, this.source = x, this.isVideo = !1, this.isLoaded = !0, this.width = x.width || 0, this.height = x.height || 0, this;
  };
}
const Me = (e) => `react-shaders: ${e}`, Rt = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, Nt = (e, t, n) => e * (1 - n) + t * n, T4 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function A4({
  fs: e,
  vs: t = pt,
  textures: n = [],
  ...
  const g = B(null), p = B(null), w = B(null), v = B(null), k = B(void 0), H = B(void 0), N = B(!1), R = B(void 0), x = B(0), E = B([0, 0]), V = B([]), b = B(0), S = B(void 0), L = B({
    [Ct]: { type: "float", isNeeded: !1, value: 0 },
    [mt]: { type: "float", isNeeded: !1, value: 0 },
    [vt]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [kt]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [xt]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    [wt]: { type: "int", isNeeded: !1, value: 0 },
    [bt]: {
      type: "vec4",
      isNeeded: !1,
      value: [0, 0, 0, 0]
    ...
    const A = "width" in F ? F.width ?? 0 : 0, _ = "height" in F ? F.height ?? 0 : 0, P = L.current.iChannelResolution;
    if (!P) return;
    const G = Array.isArray(P.value) ? P.value : P.value = [];
    G[$ * 3] = A * f, G[$ * 3 + 1] = _ * f, G[$ * 3 + 2] = 0;
  }, j = () => {
    ...
    F?.bufferData(F.ARRAY_BUFFER, new Float32Array($), F.STATIC_DRAW);
  }, Z = ({
    alpha: F,
    beta: $,
    gamma: A
    ...
    const [$ = 0, A = 0] = Rt(F), _ = $ - (R.current?.left ?? 0) - window.pageXOffset, P = (R.current?.height ?? 0) - A - (R.current?.top ?? 0) - window.pageYOffset;
    N.current = !0;
    const G = Array.isArray(L.current.iMouse?.value) ? L.current.iMouse.value : void 0;
    G && (G[2] = _, G[3] = P), E.current[0] = _, E.current[1] = P;
  }, q = (F) => {
    R.current = g.current?.getBoundingClientRect();
    const [$ = 0, A = 0] = Rt(F), _ = $ - (R.current?.left ?? 0), P = (R.current?.height ?? 0) - A - (R.current?.top ?? 0);
    if (c !== 1)
      E.current[0] = _, E.current[1] = P;
    else {
      const G = Array.isArray(L.current.iMouse?.value) ? L.current.iMouse.value : void 0;
      G && (G[0] = _, G[1] = P);
    }
    ...
    if (!F) return;
    R.current = g.current?.getBoundingClientRect();
    const $ = f, A = Math.floor(
      (R.current?.width ?? 1) * $
    ), _ = Math.floor(
      (R.current?.height ?? 1) * $
    );
    if (F.canvas.width = A, F.canvas.height = _, L.current.iResolution?.isNeeded && v.current) {
      const P = F.getUniformLocation(
        v.current,
        xt
      );
      F.uniform2fv(P, [F.canvas.width, F.canvas.height]);
    }
  }, Y = (F, $) => {
    const A = p.current;
    if (!A) return null;
    const _ = A.createShader(F);
    if (!_) return null;
    if (A.shaderSource(_, $), A.compileShader(_), !A.getShaderParameter(_, A.COMPILE_STATUS)) {
      m?.(Me(`Error compiling the shader:
${$}`));
      const P = A.getShaderInfoLog(_);
      A.deleteShader(_), h?.(Me(`Shader compiler log: ${P}`));
    }
    return _;
  }, te = (F, $) => {
    const A = p.current;
    if (!A) return;
    const _ = Y(A.FRAGMENT_SHADER, F), P = Y(A.VERTEX_SHADER, $);
    if (v.current = A.createProgram(), !(!v.current || !P || !_)) {
      if (A.attachShader(v.current, P), A.attachShader(v.current, _), A.linkProgram(v.current), !A.getProgramParameter(v.current, A.LINK_STATUS)) {
        h?.(
          Me(
      ...
      A.useProgram(v.current), k.current = A.getAttribLocation(
        v.current,
        "aVertexPosition"
      ), A.enableVertexAttribArray(k.current);
    }
  }, se = () => {
    if (o)
      for (const F of Object.keys(o)) {
        const $ = o[F];
        if (!$) continue;
        const { value: A, type: _ } = $, P = F4(_);
        if (!P) continue;
        const G = {};
        if (M4(_, A)) {
          const ie = _.length, Q = Number.parseInt(_.charAt(ie - 3)), me = Math.floor(A.length / (Q * Q));
          A.length > Q * Q && (G.arraySize = `[${me}]`);
        } else E4(_, A) && (G.arraySize = `[${Math.floor(A.length / Number.parseInt(_.charAt(0)))}]`);
        L.current[F] = {
          type: P,
          isNeeded: !1,
          value: A,
      ...
      if (n && n.length > 0) {
        ...
        const $ = n.map(
          (A, _) => (L.current[`${y4}${_}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, T(A, _), V.current[_] = new V4(F), V.current[_]?.load(A).then((P) => {
            T(P, _);
          }))
        );
        Promise.all($).then(() => {
    ...
    const $ = gt.includes(i ?? "highp"), A = `precision ${$ ? i : gt[1]} float;
`;
    $ || m?.(
      Me(
    ...
    let _ = A.concat(`#define DPR ${f.toFixed(1)}
`).concat(F.replace(/texture\(/g, "texture2D("));
    for (const G of Object.keys(L.current))
      if (F.includes(G)) {
        const ie = L.current[G];
        if (!ie) continue;
        _ = T4(
          _,
          `uniform ${ie.type} ${G}${ie.arraySize || ""}; 
`,
          _.lastIndexOf(A) + A.length
        ), ie.isNeeded = !0;
      }
    return F.includes("mainImage") && (_ = _.concat(L4)), _;
  }, K = (F) => {
    const $ = p.current;
    if (!$ || !v.current) return;
    const A = b.current ? (F - b.current) / 1e3 : 0;
    b.current = F;
    const _ = y.current;
    if (_)
      for (const P of Object.keys(_)) {
        const G = _[P];
        if (G && L.current[P]?.isNeeded) {
          if (!v.current) return;
          const ie = $.getUniformLocation(
            v.current,
            P
          );
          if (!ie) return;
    ...
    if (L.current.iMouse?.isNeeded) {
      const P = $.getUniformLocation(
        v.current,
        kt
      );
      $.uniform4fv(P, L.current.iMouse.value);
    }
    ...
    if (L.current.iDate?.isNeeded) {
      const P = /* @__PURE__ */ new Date(), G = P.getMonth() + 1, ie = P.getDate(), Q = P.getFullYear(), me = P.getHours() * 60 * 60 + P.getMinutes() * 60 + P.getSeconds() + P.getMilliseconds() * 1e-3, be = $.getUniformLocation(
        v.current,
        vt
      );
      $.uniform4fv(be, [Q, G, ie, me]);
    }
    if (L.current.iFrame?.isNeeded) {
      const P = $.getUniformLocation(
        v.current,
        wt
      ), G = L.current.iFrame.value;
      $.uniform1i(P, G), L.current.iFrame.value = G + 1;
    }
    if (V.current.length > 0)
      for (let P = 0; P < V.current.length; P++) {
        const G = V.current[P];
        if (!G) return;
        const { isVideo: ie, _webglTexture: Q, source: me, flipY: be, isLoaded: $e } = G;
        if (!$e || !Q || !me) return;
        if (L.current[`iChannel${P}`]?.isNeeded) {
          if (!v.current) return;
          const we = $.getUniformLocation(
            v.current,
            `iChannel${P}`
          );
          $.activeTexture($.TEXTURE0 + P), $.bindTexture($.TEXTURE_2D, Q), $.uniform1i(we, P), ie && G.updateTexture(
            Q,
            me,
            be
          );
    ...
    const $ = p.current;
    if (!$) return;
    $.viewport(0, 0, $.drawingBufferWidth, $.drawingBufferHeight), $.clear($.COLOR_BUFFER_BIT | $.DEPTH_BUFFER_BIT), $.bindBuffer($.ARRAY_BUFFER, w.current), $.vertexAttribPointer(
      k.current ?? 0,
      3,
      $.FLOAT,
      !1,
      0,
      0
    ), K(F), $.drawArrays($.TRIANGLE_STRIP, 0, 4);
    const A = L.current.iMouse?.value;
    if (L.current.iMouse?.isNeeded && c !== 1 && Array.isArray(A)) {
      const _ = A[0] ?? 0, P = A[1] ?? 0;
      A[0] = Nt(_, E.current[0] ?? 0, c), A[1] = Nt(P, E.current[1] ?? 0, c);
    }
    H.current = requestAnimationFrame(oe);
  }, de = () => {
    const F = { passive: !0 };
    L.current.iMouse?.isNeeded && g.current && (g.current.addEventListener("mousemove", q, F), g.current.addEventListener("mouseout", U, F), g.current.addEventListener("mouseup", U, F), g.current.addEventListener("mousedown", z, F), g.current.addEventListener("touchmove", q, F), g.current.addEventListener("touchend", U, F), g.current.addEventListener("touchstart", z, F)), L.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      Z,
      F
    ), g.current && (S.current = new ResizeObserver(I), S.current.observe(g.current), window.addEventListener("resize", I, F));
  }, Ce = () => {
    const F = { passive: !0 };
    L.current.iMouse?.isNeeded && g.current && (g.current.removeEventListener("mousemove", q, F), g.current.removeEventListener("mouseout", U, F), g.current.removeEventListener("mouseup", U, F), g.current.removeEventListener("mousedown", z, F), g.current.removeEventListener("touchmove", q, F), g.current.removeEventListener("touchend", U, F), g.current.removeEventListener("touchstart", z, F)), L.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      Z,
      F
    ), S.current && (S.current.disconnect(), window.removeEventListener("resize", I, F));
  };
  return X(() => {
    y.current = o;
  }, [o]), X(() => {
    ...
    function $() {
      j();
      const A = p.current;
      A && g.current && (A.clearColor(...s), A.clearDepth(1), A.enable(A.DEPTH_TEST), A.depthFunc(A.LEQUAL), A.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, se(), pe(), te(le(e || b4), t || pt), O(), requestAnimationFrame(oe), de(), I());
    }
    return requestAnimationFrame($), () => {
      const A = p.current;
      if (A) {
        if (A.getExtension("WEBGL_lose_context")?.loseContext(), A.useProgram(null), A.deleteProgram(v.current ?? null), F.length > 0)
          for (const _ of F)
            A.deleteTexture(_._webglTexture);
        v.current = null;
      }
...
}`, $4 = 10, B4 = 2, I4 = 0.5, P4 = 0.2, D4 = 1.5, ve = {
  duration: 0.5,
  ease: "easeOut"
}, Ft = {
  duration: 0.35,
...
function j4(e, t) {
  const [n, o] = D($4), {
    ...
    animate: i,
    motionValue: a
  } = We(P4), { value: l, animate: c } = We(B4), { value: f, animate: u } = We(I4), { value: h, animate: m } = We(D4), g = si(t, {
    fftSize: 512,
  ...
  return X(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        o(10), i(0.2, ve), c(1.2, ve), u(0.4, ve), m(1, ve);
        return;
      case "listening":
      case "pre-connect-buffering":
        o(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, ve), u(0.7, ve), m([1.5, 2], Ft);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        o(30), i(0.3, ve), c(0.5, ve), u(1, ve), m([0.5, 2.5], Ft);
        return;
      case "speaking":
        o(70), i(0.3, ve), c(0.75, ve), u(1.25, ve), m(1.5, ve);
        return;
    }
  }, [
    e,
...
function O9({
  ...
  const { speed: f, scale: u, amplitude: h, frequency: m, brightness: g } = j4(t, s);
  return /* @__PURE__ */ r(
    Jr,
    {
      ref: l,
...
const Z9 = ({
  ...
  const o = J(), s = Le();
  return /* @__PURE__ */ d(ke, { children: [
    e && /* @__PURE__ */ r("span", { className: M(U4(), "truncate"), children: e }),
    /* @__PURE__ */ r(ye, { children: n && t && /* @__PURE__ */ r(
      ne.div,
      {
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: M(en()), children: t }),
    /* @__PURE__ */ d(
      ne.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ d("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ r("span", { className: M(qe()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ r(
            Us,
            {
          ...
          o === "alert" && /* @__PURE__ */ r(Gs, { text: e.alertLabel, level: e.level }),
          o === "balance" && /* @__PURE__ */ r(W4, { balance: e.balance })
        ]
      }
    ),
    n && !G4.has(o) && /* @__PURE__ */ r(
      ne.span,
      {
        className: M(qe()),
        animate: { opacity: s ? 0 : 1 },
...
const Y4 = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), K4 = ({
  label: e,
  direction: t
}) => {
  const n = tn[t];
  ...
  const s = `sparkline-gradient-${At().replace(/:/g, "")}`, i = X4(e, n), a = tn[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(qs, { width: "100%", height: "100%", children: /* @__PURE__ */ d(
          Xs,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ r(Ys, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                Ks,
                {
                  type: "linear",
  ...
  (e, t) => {
    const {
      ...
      className: c,
      ...f
    } = e, [u, h] = D(!1), [m, g] = D(!1), p = u || m, w = Le(), v = p && !!l, k = {
      duration: w ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, H = () => {
      a?.();
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: M(en()), children: o }),
              /* @__PURE__ */ r(
                ne.div,
                {
...
rn.displayName = "F0AiInsightCardInternal";
const J4 = ["className"], nn = C((e, t) => {
  const n = J4.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
  return /* @__PURE__ */ r(rn, { ref: t, ...n });
});
nn.displayName = "F0AiInsightCard";
const e9 = () => /* @__PURE__ */ d(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ r(fe, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ d("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ r(fe, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ r(fe, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ d("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ r(fe, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ r(fe, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], on = 180, t9 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : on, r9 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, n9 = (e) => e.showActions !== !1, o9 = (e) => Object.fromEntries(
...
function s9(e) {
  const {
    ...
    description: i,
    seeMoreLabel: a,
    maxCollapsedDescriptionLength: l = on
  } = e, [c, f] = D(!1), u = At(), h = B(null), m = t9(
    l
  ), g = i.length > m, p = c ? i : r9(i, m), w = n9(e) ? e : null, v = o9(e);
  return X(() => {
    c && h.current?.focus();
  }, [c]), /* @__PURE__ */ d(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          t && /* @__PURE__ */ r(or, { module: t, size: "lg" }),
...
s9.displayName = "F0AiProposalCard";
const i9 = ({
  icon: e,
  title: t,
  children: n
  ...
  return /* @__PURE__ */ d(
    ir,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ d(ar, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
          /* @__PURE__ */ r("span", { className: "mr-2 *:block", children: /* @__PURE__ */ r(ae, { icon: e, className: "block" }) }),
...
}, a9 = (e) => Ol[e] ?? Ut, c9 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(ae, { icon: a9(e), size: "md", color: "default" }) }) : null;
function l9({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(i9, { icon: b1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(c9, { iconName: s.icon });
...
l9.displayName = "F0AiMessageSources";
...
function u9({
  ...
  const o = J(), s = B(null), i = t ?? o.ai.aiTable.title, a = W(
    (l) => {
      if (!s.current) return;
  ...
  return e.columns?.length ? /* @__PURE__ */ d(
    s1,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r(s1, { overflowX: "auto", children: /* @__PURE__ */ d(
          "table",
          {
            ref: s,
            className: M(
              ...
              /* @__PURE__ */ r("tbody", { children: e.rows.map((l, c) => /* @__PURE__ */ r("tr", { children: e.columns.map((f) => {
                ...
                return /* @__PURE__ */ r(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ r(ce, { children: u == null ? "" : String(u) })
                  },
                  f
                );
              }) }, c)) })
...
function f9({ credits: e }) {
  const t = J(), [n, o] = D(!1), [s, i] = D(!1), [a, l] = D(!1), [c, f] = D(null), u = W(
    (g) => {
  ...
  return /* @__PURE__ */ d(M1, { open: n, onOpenChange: u, children: [
    /* @__PURE__ */ r(E1, { asChild: !0, children: /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
        hideLabel: !0,
...
const h9 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function g9({
  employeeCredits: e
}) {
  const t = J(), n = Le(), [o, s] = D(!1), [i, a] = D(!1), [l, c] = D(!1), [f, u] = D(null), h = W(
    (w) => {
  ...
  return /* @__PURE__ */ d(M1, { open: o, onOpenChange: h, children: [
    /* @__PURE__ */ r(E1, { asChild: !0, children: /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
...
const St = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(g9, { employeeCredits: t }) : e ? /* @__PURE__ */ r(f9, { credits: e }) : null, G9 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const m = J(), g = Kt(`(max-width: ${Qs.md}px)`, {
        ...
        /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ r(
          Ze,
          {
            ...
            children: /* @__PURE__ */ d("div", { className: "flex min-w-0 items-center gap-1", children: [
              ...
              /* @__PURE__ */ r(ae, { icon: L1, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ d(
...
function p9() {
  if (!(typeof navigator > "u"))
    return ti(navigator.language);
}
function C9(e) {
  const t = new Date(e), n = /* @__PURE__ */ new Date();
  return dr(t) ? "today" : ur(t) ? "yesterday" : Js(t, n) ? "thisMonth" : "older";
}
function m9(e, t) {
  const n = new Date(e), o = p9(), s = Z1(n, "p", { locale: o });
  if (dr(n)) return `${t.today}, ${s}`;
  if (ur(n)) return `${t.yesterday}, ${s}`;
  const i = !ei(n, /* @__PURE__ */ new Date());
  return `${Z1(n, i ? "MMM d yyyy" : "MMM d", {
    locale: o
  })}, ${s}`;
}
function v9(e) {
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          "div",
          {
            ...
            children: /* @__PURE__ */ r(n1, { items: l, children: /* @__PURE__ */ r(
              he,
              {
                icon: Zt,
                variant: "ghost",
...
const W9 = ({
  ...
  const g = ee(
    ...
    return o.filter((V) => V.title.toLowerCase().includes(E));
  }, [o, h]), w = ee(
    () => p.filter((E) => a.has(E.id)),
    [p, a]
  ), v = ee(
    () => p.filter((E) => !a.has(E.id)),
    [p, a]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ d("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ r(ae, { icon: b1, color: "secondary", size: "md" }),
                  /* @__PURE__ */ r(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ r(
                    Ze,
                    {
                      ...
                      children: /* @__PURE__ */ d("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ r(ae, { icon: S1, color: "default", size: "md" }),
                        /* @__PURE__ */ r(ce, { lines: 1, className: "text-left", children: u.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ r(k9, {}),
                  !s && i && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: i }),
                  !s && !i && !x && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: u.ai.noPreviousChats }),
...
function q9({
  ...
  const [o, s] = D([]), [i, a] = D(!1), [l, c] = D(null), [f, u] = D(x9), h = W(async () => {
    a(!0), c(null);
    try {
      const w = await t();
      s(w);
  ...
  const m = W((w) => {
    u((v) => {
      const k = new Set(v);
      return k.add(w), p1(k), k;
    });
  }, []), g = W((w) => {
    u((v) => {
      const k = new Set(v);
      return k.delete(w), p1(k), k;
    });
  }, []), p = W(
    async (w) => {
      try {
        await n(w), s((v) => v.filter((k) => k.id !== w)), u((v) => {
          if (!v.has(w)) return v;
          const k = new Set(v);
          return k.delete(w), p1(k), k;
        });

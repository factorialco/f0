 ...
 */
export declare const TABLE_CELL_BAND_PX = 24;
/** Line box of `text-base`, the single line every cell's value aligns on. */
export declare const TABLE_CELL_LINE_PX = 20;
/**
 ...
 * their data arrives.
 */
export declare const tableCellContentClassName = "min-h-6 items-center";
export declare const tableDisplayClassNames: {
    text: string;
    avatar: string;
    avatarList: string;
    /**

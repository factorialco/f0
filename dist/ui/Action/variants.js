...
import { mentionClasses as o } from "../../lib/recipes/mention.js";
import { cn as e } from "../../lib/utils.js";
const t = "group relative inline-flex items-center justify-center gap-1 whitespace-nowrap rounded border-none p-0 text-base font-medium shadow-[0_2px_6px_-1px_rgba(13,22,37,.04),inset_0_-2px_4px_rgba(13,22,37,.04)] transition-colors [&_.main]:transform-gpu [&_.main]:transition-transform [&_.main]:duration-100 active:[&_.main]:translate-y-px [&_.main]:flex [&_.main]:items-center [&_.main]:justify-center disabled:opacity-30 disabled:cursor-not-allowed no-underline [&_.main]:z-20", a = "relative flex-row font-medium [&[aria-disabled=true]]:pointer-events-none [&[aria-disabled=true]]:cursor-not-allowed [&[aria-disabled=true]]:opacity-30 transition-colors", i = r({
  ...
  variants: {
    variant: {
      ...
      unstyled: e(a, "text-inherit no-underline"),
      mention: e(a, o),
      selected: e(
        t,
  ...
  compoundVariants: [
    ...
    },
    {
      variant: "ai",
      mode: "default",
      class: "[&_svg>circle]:[stroke:url(#ai-gradient)] [&_svg>path]:[fill:url(#ai-gradient)] [&_svg>rect]:[fill:url(#ai-gradient)]"
    },
    {
      variant: "link",
      mode: "default",
...
export {
  i as actionVariants,
  c as buttonSizeVariants,
  l as iconVariants,
  f as linkSizeVariants,
  g as loadingVariants
};

...
import { DayPicker as i } from "../node_modules/.pnpm/react-day-picker@8.10.1_date-fns@3.6.0_react@18.3.1/node_modules/react-day-picker/dist/index.esm.js";
import { cn as r } from "../lib/utils.js";
import f from "../node_modules/.pnpm/lucide-react@0.383.0_react@18.3.1/node_modules/lucide-react/dist/esm/icons/chevron-right.js";
import u from "../node_modules/.pnpm/lucide-react@0.383.0_react@18.3.1/node_modules/lucide-react/dist/esm/icons/chevron-left.js";
function b({
  className: n,
  classNames: s,
  showOutsideDays: o = !0,
  ...
  return /* @__PURE__ */ t(
    i,
    {
      ...
      classNames: {
        ...
        head_row: r(
          "flex items-center",
          a.showWeekNumber ? "justify-start" : "justify-between"
        ),
        head_cell: r(
          "text-f1-foreground-secondary rounded-xs font-medium flex justify-center items-center",
          a.showWeekNumber && e ? "w-[30px] flex-shrink-0" : "w-full",
          e ? "h-6 text-sm" : "h-8 text-md"
        ),
        row: r(
        ...
        cell: r(
          ...
          a.showWeekNumber && e ? "w-[30px] flex-shrink-0" : "w-full",
          e ? "rounded-sm h-7 text-md" : "rounded-md h-10 text-md",
          ...
          e ? "before:rounded-sm" : "before:rounded-md",
          ...
          e ? "first:[&:has([aria-selected].day-range-middle)]:rounded-l-sm last:[&:has([aria-selected].day-range-middle)]:rounded-r-sm first:[&:has([aria-selected].day-range-end)]:rounded-r-sm first:[&:has([aria-selected].day-range-end)]:rounded-l-sm last:[&:has([aria-selected].day-range-start)]:rounded-l-sm last:[&:has([aria-selected].day-range-start)]:rounded-r-sm" : "first:[&:has([aria-selected].day-range-middle)]:rounded-l-md last:[&:has([aria-selected].day-range-middle)]:rounded-r-md first:[&:has([aria-selected].day-range-end)]:rounded-r-md first:[&:has([aria-selected].day-range-end)]:rounded-l-md last:[&:has([aria-selected].day-range-start)]:rounded-l-md last:[&:has([aria-selected].day-range-start)]:rounded-r-md",
          ...
          r(
            ...
            e ? "[&>span.rdp-weeknumber]:w-[30px] [&>span.rdp-weeknumber]:flex-shrink-0" : "[&>span.rdp-weeknumber]:w-7 [&>span.rdp-weeknumber]:flex-shrink-0",
            "[&>span.rdp-weeknumber]:text-md"
          ),
          a.mode === "single" && "[&:has([aria-selected].day-selected)]:before:opacity-100",
          a.showWeekNumber && "[&:has([aria-selected].day-range-middle)]:bg-f1-background-selected-bold [&:has([aria-selected].day-range-start)]:bg-f1-background-selected-bold [&:has([aria-selected].day-range-end)]:bg-f1-background-selected-bold hover:before:bg-f1-background-selected-bold"
        ),
        day: r(
          "rounded-[inherit] p-0 aria-selected:opacity-100 z-20 relative",
          e ? a.showWeekNumber ? "h-7 w-[30px] text-sm" : "h-7 w-7 text-sm" : "h-10 w-10 text-md"
        ),
        ...
        day_today: r(
          ...
          e ? "after:bottom-0.5 after:h-0.5 after:w-1" : "after:bottom-1 after:h-0.5 after:w-1.5"
        ),
        day_selected: r(
          "day-selected",
          a.mode === "single" && "aria-selected:text-f1-foreground-inverse"
        ),
        ...
        day_range_middle: r(
          ...
          a.showWeekNumber && "aria-selected:text-f1-foreground-inverse"
        ),
      ...
      components: {
        IconLeft: () => /* @__PURE__ */ t(u, { className: e ? "h-3 w-3" : "h-4 w-4" }),
        IconRight: () => /* @__PURE__ */ t(f, { className: e ? "h-3 w-3" : "h-4 w-4" })
      },
      ...a
    }
  );

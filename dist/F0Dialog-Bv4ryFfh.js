...
import { $ as n, Q as r, _ as i, at as a, f as o, it as s, n as c, nt as l, s as u, t as d, y as f } from "./variants-BhCxKzs5.js";
import { n as p, t as m } from "./utils-CVzxZnoI.js";
import { i as h, l as g, o as _, p as v, r as y, u as b } from "./F0Button-CYTXun0O.js";
import { A as x } from "./tooltip-BPSwDQpD.js";
import { F as S, I as C, J as w, K as T, Y as ee, nn as te, t as ne, tn as E } from "./F0Select-_dXXh4fu.js";
import { a as D, r as O } from "./F0AvatarIcon-dGQ2qbg6.js";
import { D as k, T as re, dt as ie, gt as A, ht as j, i as M, m as ae, mt as oe, o as se, p as ce, r as le, ut as ue, v as de } from "./F0Checkbox-Bc_SibvL.js";
import { _ as fe, g as pe, p as me, v as he, x as ge } from "./popover-By8ytmVb.js";
import { t as _e } from "./Cross-BIv5udZr.js";
import { _ as ve, a as ye, c as be, d as xe, g as Se, h as Ce, i as we, l as Te, m as Ee, o as De, p as Oe, r as ke, s as Ae, t as je, u as Me, x as Ne } from "./progress-dgj09l6I.js";
import { t as Pe } from "./Maximize-CyNX1-Xd.js";
import { h as Fe } from "./F0Avatar-BNV2fsD_.js";
import "./chevron-right-DQKib3pL.js";
import { c as Ie, d as Le, i as Re, l as N, n as P, o as ze, r as F, s as I, t as Be } from "./dist-zRL9MpsG.js";
import { n as Ve } from "./skeleton-gsHEXIPQ.js";
import { t as He } from "./dist-m0B3zKBj.js";
...
function Ze() {
	let e = Xe(), [t, n] = W(0), i = z(() => {
		e.current && n(t + 1);
	}, [t]);
	return [z(() => r.postRender(i), [i]), t];
}
//#endregion
...
var et = (e) => e === !0, tt = (e) => et(e === !0) || e === "id", nt = ({ children: e, id: t, inherit: n = !0 }) => {
	let r = B(s), i = B(Ye), [a, o] = Ze(), c = U(null), l = r.id || i;
	c.current === null && (tt(n) && l && (t = t ? l + "-" + t : l), c.current = {
		id: t,
...
var ut = ({ onClick: e, value: t, items: n, size: r, variant: a, disabled: s, loading: l, tooltip: u }) => {
	let f = o(), [h, g] = W(!1), v = H(() => ct(n), [n]), y = H(() => v.flatMap((e) => e.items), [v]), b = H(() => t || y[0]?.value, [t, y]), x = H(() => y.find((e) => e.value === b), [b, y]), S = () => {
		let t = y.find((e) => e.value === b);
		t && e(b, t);
	}, C = H(() => v.map((e) => e.items).reduce((t, n) => (t.length > 0 && t.push({ type: "separator" }), t.push(...n.filter((e) => e.value !== b).map((t) => ({
		...t,
		onClick: () => {
			e(t.value, t), g(!1);
		}
		...
		e,
		b
	]), w = r === "sm" ? "[&_.main]:w-6" : r === "lg" ? "[&_.main]:w-10" : "[&_.main]:w-8";
	return x && /* @__PURE__ */ K("div", {
		className: m(s && "opacity-30"),
		children: /* @__PURE__ */ K(_, {
			...
			"aria-label": x.label,
			prepend: x.icon && /* @__PURE__ */ K(i, { icon: x.icon }),
			className: "rounded-r-none after:rounded-r-none disabled:opacity-100",
			tooltip: {
				label: u,
				description: x.label
			},
			appendOutside: /* @__PURE__ */ K(ve, {
				items: C,
				align: "end",
				open: h && !s,
				onOpenChange: (e) => {
				...
				children: /* @__PURE__ */ K("button", {
					className: m(d({
						variant: a,
						pressed: h && !s
					}), c({ size: r }), "-translate-x-px rounded-l-none px-0 after:rounded-l-none disabled:opacity-100", w, p()),
					disabled: s,
...
}, dt = ({ onClick: e, trigger: t, value: n, items: r, size: a, variant: o, disabled: s, loading: c, tooltip: l }) => {
	let [u, d] = W(!1), f = H(() => ct(r), [r]), p = H(() => f.flatMap((e) => e.items), [f]), m = H(() => p.find((e) => e.value === n), [n, p]), h = t || m?.label || p[0]?.label, g = m ? {
		label: l,
		description: m.label
	...
	return h ? /* @__PURE__ */ K(ve, {
		...
		children: /* @__PURE__ */ K(_, {
			...
			"aria-label": h,
			prepend: m?.icon && /* @__PURE__ */ K(i, { icon: m.icon }),
			append: /* @__PURE__ */ K(i, {
				icon: A,
				size: a === "sm" ? "sm" : "md"
			}),
...
}) : ee(e) ? e.then(t) : t(e), mt = (e) => {
	if (T(e) !== "pages") return e;
	let t = e;
	return {
		...t,
...
}, ht = R(({ className: e, ...t }, n) => /* @__PURE__ */ K(Oe, {
	ref: n,
	className: m("fixed inset-0 z-50 bg-f1-background-overlay data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", e),
	...t
}));
ht.displayName = Oe.displayName;
//#endregion
//#region src/ui/Dialog/components/DialogPortal.tsx
var gt = Ee, _t = R(({ wrapperClassName: e, className: t, children: n, withTranslateAnimation: r = !0, animation: i = "scale", overlayClassName: a, container: o, defaultContainerId: s = "content", ...c }, l) => {
	let [u, d] = W();
	return V(() => {
		d(o === void 0 ? document.getElementById(s) ?? document.getElementById("content") ?? document.body : o);
	}, [o, s]), u === void 0 ? null : /* @__PURE__ */ q(gt, {
		container: u,
		children: [/* @__PURE__ */ K(ht, { className: a }), /* @__PURE__ */ K(xe, {
			ref: l,
			className: m("fixed inset-0 z-50 flex items-center justify-center", "pointer-events-none duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", i === "scale" && "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95", i === "scale" && r && "data-[state=closed]:slide-out-to-top-[10%] data-[state=open]:slide-in-from-top-[10%]", e),
			...c,
			children: /* @__PURE__ */ K("div", {
				className: m("relative flex w-[90%] flex-col rounded-xl bg-f1-background shadow-lg", "pointer-events-auto", t),
				children: n
			})
		})]
	});
});
_t.displayName = xe.displayName;
//#endregion
//#region src/ui/Dialog/components/DialogTitle.tsx
var Y = R(({ className: e, ...t }, n) => /* @__PURE__ */ K(Se, {
	ref: n,
	className: m("text-lg font-medium text-f1-foreground", e),
	...t
}));
Y.displayName = Se.displayName;
//#endregion
//#region src/ui/Dialog/dialog.tsx
var vt = Ce, yt = ({ position: e }) => /* @__PURE__ */ K(f.div, {
	initial: { opacity: 0 },
	animate: { opacity: .6 },
	exit: { opacity: 0 },
	transition: {
	...
	className: m("pointer-events-none absolute inset-x-0 z-10 h-4", e === "top" ? [
		"top-0",
	...
	let { position: r } = C(), i = U(null), [a, o] = W(!0), [s, c] = W(!0), l = z(() => {
		let e = i.current;
		if (!e) return;
	...
	return V(() => {
		let e = i.current;
		if (!e) return;
		e.addEventListener("scroll", l, { passive: !0 }), l();
		...
		children: [/* @__PURE__ */ q(ce, {
			viewportRef: i,
			className: m("[*[data-state=visible]_div]:bg-f1-background flex flex-1 flex-col", "[&_.resource-header]:p-0 [&_.resource-header]:pr-1", !t && "px-4 [&>div]:py-4", r === "fullscreen" && "h-full [&>div]:h-full [&>div>div]:h-full"),
		...
		}), /* @__PURE__ */ q(n, { children: [!a && /* @__PURE__ */ K(yt, { position: "top" }, "shadow-top"), !s && /* @__PURE__ */ K(yt, { position: "bottom" }, "shadow-bottom")] })]
	});
	...
	let [t, n] = W(!1), [r, i] = W(!1), a = o(), s = U(null), c = U(null), l = k({ ref: s }), u = k({ ref: c });
	return V(() => {
		u.height && l.height && i(u.height > l.height);
	}, [u.height, l.height]), /* @__PURE__ */ q("div", {
		className: "flex max-w-[640px] flex-col gap-1",
		children: [/* @__PURE__ */ q(f.div, {
			initial: !1,
			animate: { height: t ? u.height ?? l.height : l.height ?? "3rem" },
			transition: {
				duration: r ? .15 : 0,
				ease: [
					.165,
			...
			className: m(t ? "overflow-y-scroll" : "overflow-clip", "relative max-h-80"),
			children: [/* @__PURE__ */ K("div", {
				ref: c,
				...
				ref: s,
				className: m("text-lg text-f1-foreground-secondary", !t && "line-clamp-2"),
				children: e
			})]
		}), (r || t) && /* @__PURE__ */ K("button", {
			onClick: () => n((e) => !e),
	...
	duration: .15,
	ease: "easeOut"
}, Dt = R(({ valueToCopy: e, onCopy: t, copyTooltipLabel: r, copiedTooltipLabel: a, variant: s = "neutral", size: c = "sm", ...l }, u) => {
	let [d, p] = W(!1), m = o(), h = r ?? m.actions.copy, g = d ? a ?? "Copied" : h;
	return V(() => {
		let e = null;
		return d && (e = setTimeout(() => p(!1), 1e3)), () => {
			e && clearTimeout(e);
		};
	}, [d]), /* @__PURE__ */ K(_, {
		ref: u,
...
function kt({ item: e, collapse: t = !1 }) {
	...
	switch (n.type) {
		...
		case "status": return /* @__PURE__ */ K(ie, {
			text: n.label,
			variant: n.variant
		});
		case "list": return /* @__PURE__ */ K(we, {
			type: n.variant,
			avatars: n.avatars,
			size: "xs",
			max: n.max ?? 3
		...
		case "tag-list": return t ? /* @__PURE__ */ q("div", {
			...
			children: [/* @__PURE__ */ K(M, { text: n.tags[0] }), n.tags.length > 1 && /* @__PURE__ */ q("span", {
				className: "tabular-nums text-f1-foreground-secondary",
				children: ["+", n.tags.length - 1]
			})]
		}) : /* @__PURE__ */ K("div", {
			className: m("flex flex-col gap-1 [&>div]:w-fit", n.tags.length > 1 && "-mt-[3px]"),
			children: n.tags.map((e) => /* @__PURE__ */ K(M, { text: e }, e))
		});
		...
		case "date": {
			...
			let { icon: e, iconColor: t, textColor: r } = Ot[n.icon];
		...
		case "progress-bar": {
			let t = n.color ? ke(n.color) : ke("categorical-1"), r = n.max && n.max > 0 ? n.max : 100, i = Math.min(Math.max(0, n.value), r), a = i / r * 100;
			return /* @__PURE__ */ q("div", {
...
function Nt({ item: e }) {
	let [t, r] = W(!1), a = e.value.type === "data-list" && e.value.data.length > 1 || e.value.type === "tag-list" && e.value.tags.length > 1, o = !!e.actions?.length, s = o || a, c = (e, t) => {
		if (t) return t;
		let n;
		switch (e.type) {
	...
	return /* @__PURE__ */ q("div", {
		...
		children: [
			...
			/* @__PURE__ */ q("div", {
				className: m("flex w-28 items-center gap-1 truncate text-f1-foreground-secondary md:w-fit", e.hideLabel && "md:hidden"),
			...
			/* @__PURE__ */ q("div", {
				...
				children: [
					/* @__PURE__ */ K("div", {
						className: m("hidden font-medium text-f1-foreground md:block", !o && "block"),
					...
					/* @__PURE__ */ K(n, { children: t && s && /* @__PURE__ */ q(f.div, {
						className: m("absolute -left-1.5 -top-1.5 z-50 hidden max-h-[80vh] items-start justify-center gap-1.5 overflow-y-auto whitespace-nowrap rounded-sm bg-f1-background py-1 pl-1.5 shadow-md ring-1 ring-inset ring-f1-border-secondary md:flex", !a && "h-8 items-start", o ? "pr-1" : "pr-1.5"),
						initial: { opacity: 0 },
						animate: { opacity: 1 },
						exit: { opacity: 0 },
						transition: { duration: .1 },
						children: [/* @__PURE__ */ K("div", {
							className: m("flex h-6 items-center font-medium text-f1-foreground", a && "h-auto items-start pt-0.5"),
							...
							exit: { x: -16 },
							transition: { duration: .1 },
							children: e.actions?.map((t, n) => jt(t) ? /* @__PURE__ */ K(Dt, { valueToCopy: c(e.value, t.copyValue) }, `copy-${n}`) : /* @__PURE__ */ K(u, {
								label: t.label,
...
var Pt = Ge(function({ items: e, rowGap: t = "none" }) {
	...
	return /* @__PURE__ */ K("div", {
		className: m("flex flex-col items-start gap-x-3 md:flex-row md:flex-wrap md:items-center", Mt[t]),
...
}), Ft = a("Metadata", Pt), It = (e) => e.isVisible !== !1;
function Lt({ title: e, avatar: t, deactivated: n, description: r, primaryAction: i, secondaryActions: a = [], otherActions: s = [], status: c, metadata: l = [], metadataRowGap: u = "none", showBottomBorder: d = !1, onClose: f }) {
	let p = o(), h = [c && {
		label: c.label,
		value: {
			type: "status",
		...
		actions: c.actions,
		hideLabel: !0
	}, ...l], g = a.filter(It), _ = s.filter(It), v = i && It(i), b = g.length > 0, x = _.length > 0, S = (e) => !!e && "items" in e, C = (e) => !!e && "label" in e && !("items" in e), w = (e, t) => `${Rt(e) ? `${e.value ?? "default"}-${e.items.map((e) => e.value).join("-")}` : e.label}-${t}`;
	return /* @__PURE__ */ q("div", {
		className: m("resource-header px-page flex flex-col gap-3 pb-5 pt-3", d && "border-0 border-b border-solid border-f1-border-secondary"),
		children: [/* @__PURE__ */ q("div", {
			className: m("flex flex-col items-start justify-start gap-4 md:flex-row", !r && "md:items-center"),
			children: [
				/* @__PURE__ */ q("div", {
					className: m("flex grow flex-col items-start justify-start gap-3 md:flex-row md:items-start", !r && "md:items-center"),
					children: [t && /* @__PURE__ */ K("div", {
						...
						children: [/* @__PURE__ */ K("span", {
							className: m("text-2xl font-semibold", n ? "text-f1-foreground/[0.61]" : "text-f1-foreground"),
							children: e
				...
				/* @__PURE__ */ q("div", {
					...
					children: [
						...
						_.length > 0 && /* @__PURE__ */ K("div", {
							...
							children: /* @__PURE__ */ K(De, { items: _ })
						}),
						f && /* @__PURE__ */ K("div", {
							className: "w-full md:hidden [&>*]:w-full",
							children: /* @__PURE__ */ K(y, {
				...
				/* @__PURE__ */ q("div", {
					...
					children: [
						_.length > 0 && /* @__PURE__ */ K("div", { children: /* @__PURE__ */ K(ye, { items: _ }) }),
						g.map((e, t) => /* @__PURE__ */ K(Ue, { children: /* @__PURE__ */ K("div", {
						...
						v && (b || x) && /* @__PURE__ */ K("div", { className: "mx-1 h-4 w-px bg-f1-background-secondary-hover" }),
						v && C(i) && /* @__PURE__ */ K("div", {
							className: "hidden md:block",
							children: /* @__PURE__ */ K(y, {
								label: i.label,
...
var Ut = R(({ className: e, children: t, ...r }, i) => {
	let a = Ke();
	return /* @__PURE__ */ K("ol", {
		ref: i,
		className: m("flex h-8 list-none flex-nowrap items-center text-f1-foreground-secondary", e),
		...r,
...
var Wt = ({ className: e, ...t }) => /* @__PURE__ */ K("li", {
	className: m("inline-flex items-center gap-0.5 pr-1", e),
	...t
});
Wt.displayName = "BreadcrumbItem";
var Gt = R(({ asChild: e, className: t, ...n }, r) => /* @__PURE__ */ K(e ? x : b, {
	ref: r,
	className: m("rounded-sm px-1.5 py-0.5 font-medium text-f1-foreground no-underline transition-colors hover:bg-f1-background-secondary", t),
	...n
}));
...
var Kt = R(({ className: e, ...t }, n) => /* @__PURE__ */ K("span", {
	...
	"aria-disabled": "true",
	"aria-current": "page",
	className: m("truncate px-1.5 py-0.5 text-f1-foreground", e),
	...t
}));
...
var ln = R(({ item: e, isLast: t, isOnly: n = !1, isFirst: r = !1 }, i) => {
	let a = "loading" in e && e.loading, o = a ? "loading" : "type" in e && e.type ? e.type : t || n ? "page" : "link", s = /* @__PURE__ */ q(f.div, {
		layoutId: `breadcrumb-${e.id}`,
		className: m("flex items-center gap-2 px-1.5", r && "pl-0", n && "text-2xl font-semibold"),
		transition: { duration: .15 },
		children: [!a && "module" in e && e.module && (n || r) && /* @__PURE__ */ K(Fe, {
			module: e.module,
			size: n ? "md" : "xs"
		}), /* @__PURE__ */ K("span", {
			className: "truncate",
	...
	return /* @__PURE__ */ K(f.div, {
		ref: i,
		layout: !l,
		className: m(a && "max-w-40"),
		transition: { duration: .15 },
		children: c[o]
	});
});
...
var fn = "VisuallyHidden", pn = L.forwardRef((e, t) => /* @__PURE__ */ K(F.span, {
	...e,
	ref: t,
	style: {
		position: "absolute",
...
pn.displayName = fn;
var mn = pn, X = "NavigationMenu", [hn, gn, _n] = He(X), [vn, yn, bn] = He(X), [xn, Sn] = Le(X, [_n, bn]), [Cn, Z] = xn(X), [wn, Tn] = xn(X), En = L.forwardRef((e, t) => {
	let { __scopeNavigationMenu: n, value: r, onValueChange: i, defaultValue: a, delayDuration: o = 200, skipDelayDuration: s = 300, orientation: c = "horizontal", dir: l, ...u } = e, [d, f] = L.useState(null), p = I(t, (e) => f(e)), m = de(l), h = L.useRef(0), g = L.useRef(0), _ = L.useRef(0), [v, y] = L.useState(!0), [b = "", x] = Be({
		prop: r,
		onChange: (e) => {
			let t = e !== "", n = s > 0;
...
var Dn = "NavigationMenuSub", On = L.forwardRef((e, t) => {
	let { __scopeNavigationMenu: n, value: r, onValueChange: i, defaultValue: a, orientation: o = "horizontal", ...s } = e, c = Z(Dn, n), [l = "", u] = Be({
		prop: r,
		onChange: i,
		defaultProp: a
	});
...
var kn = (e) => {
	...
	let { __scopeNavigationMenu: n, ...r } = e, i = Z(An, n), a = /* @__PURE__ */ K(F.ul, {
...
var Mn = "NavigationMenuItem", [Nn, Pn] = xn(Mn), Fn = L.forwardRef((e, t) => {
	let { __scopeNavigationMenu: n, value: r, ...i } = e, a = fe(), o = r || a || "LEGACY_REACT_AUTO_VALUE", s = L.useRef(null), c = L.useRef(null), l = L.useRef(null), u = L.useRef(() => {}), d = L.useRef(!1), f = L.useCallback((e = "start") => {
		if (s.current) {
			u.current();
			let t = nr(s.current);
...
var In = "NavigationMenuTrigger", Ln = L.forwardRef((e, t) => {
	let { __scopeNavigationMenu: n, disabled: r, ...i } = e, a = Z(In, e.__scopeNavigationMenu), o = Pn(In, e.__scopeNavigationMenu), s = L.useRef(null), c = I(s, o.triggerRef, t), l = sr(a.baseId, o.value), u = cr(a.baseId, o.value), d = L.useRef(!1), f = L.useRef(!1), p = o.value === a.value;
	return /* @__PURE__ */ q(G, { children: [/* @__PURE__ */ K(hn.ItemSlot, {
		scope: n,
		value: o.value,
		children: /* @__PURE__ */ K(tr, {
			asChild: !0,
			children: /* @__PURE__ */ K(F.button, {
				id: l,
				disabled: r,
	...
	return /* @__PURE__ */ K(tr, {
		...
		children: /* @__PURE__ */ K(F.a, {
			...
			onClick: P(e.onClick, (e) => {
				...
				if (t.addEventListener(zn, (e) => i?.(e), { once: !0 }), Re(t, n), !n.defaultPrevented && !e.metaKey) {
...
var Vn = "NavigationMenuIndicator", Hn = L.forwardRef((e, t) => {
	...
	return i.indicatorTrack ? Je.createPortal(/* @__PURE__ */ K(me, {
		present: n || a,
		children: /* @__PURE__ */ K(Un, {
			...r,
			ref: t
...
var Un = L.forwardRef((e, t) => {
	...
	return ar(o, f), ar(i.indicatorTrack, f), c ? /* @__PURE__ */ K(F.div, {
		"aria-hidden": !0,
	...
	let { forceMount: n, ...r } = e, i = Z(Q, e.__scopeNavigationMenu), a = Pn(Q, e.__scopeNavigationMenu), o = I(a.contentRef, t), s = a.value === i.value, c = {
		value: a.value,
	...
	return i.viewport ? /* @__PURE__ */ K(Gn, {
		...
		children: /* @__PURE__ */ K(qn, {
			...
			onPointerLeave: P(e.onPointerLeave, lr(i.onContentLeave)),
			style: {
...
var Gn = L.forwardRef((e, t) => {
	...
	return Ie(() => {
		...
		t,
		n
	]), Ie(() => () => r(e.value), [e.value, r]), null;
}), Kn = "navigationMenu.rootContentDismiss", qn = L.forwardRef((e, t) => {
	let { __scopeNavigationMenu: n, value: r, triggerRef: i, focusProxyRef: a, wasEscapeCloseRef: o, onRootContentClose: s, onContentFocusOutside: c, ...l } = e, u = Z(Q, n), d = L.useRef(null), f = I(d, t), p = sr(u.baseId, r), m = cr(u.baseId, r), h = gn(n), g = L.useRef(null), { onItemDismiss: _ } = u;
	L.useEffect(() => {
		let e = d.current;
		if (u.isRootMenu && e) {
			let t = () => {
...
var Xn = L.forwardRef((e, t) => {
	let { __scopeNavigationMenu: n, children: r, ...i } = e, a = Z(Jn, n), o = I(t, a.onViewportChange), s = Tn(Q, e.__scopeNavigationMenu), [c, l] = L.useState(null), [u, d] = L.useState(null), f = c ? c?.width + "px" : void 0, p = c ? c?.height + "px" : void 0, m = !!a.value, h = m ? a.value : a.previousValue;
	return ar(u, () => {
		u && l({
			width: u.offsetWidth,
		...
		onPointerLeave: P(e.onPointerLeave, lr(a.onContentLeave)),
...
var _r = e({
	...
	return /* @__PURE__ */ K(fr, {
		...
		children: /* @__PURE__ */ K(pr, {
			...
			className: m("group relative flex shrink-0 select-none items-center justify-center rounded-md no-underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-f1-special-ring focus-visible:ring-offset-1", t ? "pointer-events-none" : ""),
			ref: s,
			onSelect: () => {},
			asChild: e,
			...o,
			children: mr({
				...
				className: m("text-f1-foreground-secondary ring-1 ring-inset ring-transparent", _r({
					secondary: a,
					disabled: t
				}), r),
				children: [e, n && !a && /* @__PURE__ */ K(f.div, {
					layoutId: "underline",
	...
	className: "list-none",
	children: /* @__PURE__ */ K(g, {
		className: m("mr-4 w-20 rounded-md py-1.5 ring-1 ring-inset ring-transparent", e),
		children: "\xA0"
	})
})), yr = ({ tabs: e, activeTabId: t, setActiveTabId: n, secondary: r = !1, embedded: a = !1 }) => {
	let o = e[0], [s, c] = W(t ?? ("id" in o ? o.id : void 0));
	V(() => {
		s && n?.(s);
	}, [n, s]);
	let { isActive: l } = v(), u = a ? [e[0]] : e, d = [...u].sort((e, t) => e.index ? 1 : t.index ? -1 : 0).find((e) => "href" in e ? l(e.href) : s === e.id);
		...
		children: u.length === 1 ? /* @__PURE__ */ K("li", {
			...
			return /* @__PURE__ */ K($, {
				...
				children: /* @__PURE__ */ q(b, {
					role: "link",
					...t,
					children: [t.variant === "upsell" && /* @__PURE__ */ K(i, {
						icon: it,
						size: "md",
...
}), xr = t(a("Tabs", Ve(yr, br))), Sr = ({ title: e, description: t, module: n, otherActions: r, navigation: i, resourceHeader: a, controls: s, headerStatus: c, dismissable: l = !0, tabs: u, activeTabId: d, setActiveTabId: f }) => {
	let p = o(), { onClose: g } = C(), _ = !!u, v = () => /* @__PURE__ */ K("div", { className: "h-4 w-px self-center bg-f1-background-secondary" }), y = r?.filter((e) => e.type !== "separator" && e.type !== "label") ?? [], b = () => {
		if (!y.length || !r) return null;
		let e = y.some((e) => e.critical);
		return y.length <= 2 && !e ? /* @__PURE__ */ K("div", {
			className: "flex flex-row gap-2",
			children: y.map((e) => /* @__PURE__ */ K(h, {
				variant: "outline",
				icon: e.icon,
				onClick: e.onClick,
				label: e.label,
	...
	}, x = () => n ? /* @__PURE__ */ K(Ut, { children: /* @__PURE__ */ K(cn, {
		item: {
			id: n.id,
			label: n.label,
			href: n.href,
		...
		isLast: !1,
		isFirst: !0
	}) }) : null, S = () => c ? /* @__PURE__ */ K("span", {
		className: "whitespace-nowrap text-f1-foreground-secondary",
		children: c
	}) : null, w = () => l ? /* @__PURE__ */ K(h, {
		variant: "outline",
		icon: _e,
		onClick: g,
		label: p.actions.close,
		hideLabel: !0
	}) : null, T = () => u ? /* @__PURE__ */ K("div", {
	...
	return a || s ? /* @__PURE__ */ q(G, { children: [
		/* @__PURE__ */ q("div", {
			className: "flex flex-row items-center justify-between gap-3 px-4 py-3",
			children: [/* @__PURE__ */ K("div", {
				className: "flex flex-row items-center gap-2",
				children: /* @__PURE__ */ K(() => s ? s.kind === "back" ? /* @__PURE__ */ K(h, {
					variant: "outline",
					icon: te,
					onClick: s.onClick,
					label: s.label
				}) : /* @__PURE__ */ q(G, { children: [
					s.expand && (s.expand.url === void 0 ? /* @__PURE__ */ K(h, {
						variant: "outline",
						icon: Pe,
					...
					s.expand && s.navigation && /* @__PURE__ */ K(v, {}),
		...
		a ? /* @__PURE__ */ q(G, { children: [/* @__PURE__ */ K(Y, {
			className: "sr-only",
			children: a.title
		}), /* @__PURE__ */ K("div", {
			className: "[&_.resource-header]:px-4",
			children: /* @__PURE__ */ K(Lt, { ...a })
		})] }) : e && /* @__PURE__ */ K(Y, {
			className: "sr-only",
			children: e
		}),
		...
		className: m("flex flex-row items-start justify-between gap-3 px-4 py-3", !_ && "border border-x-0 border-b border-t-0 border-solid border-f1-border-secondary"),
		children: [/* @__PURE__ */ K("div", {
			className: "flex flex-row items-center gap-3",
			children: (n || e || !!t) && /* @__PURE__ */ q("div", {
				className: "flex flex-col gap-1",
				children: [n ? /* @__PURE__ */ K(x, {}) : e && /* @__PURE__ */ K(Y, {
...
}, Cr = () => re("(max-width: 560px)", { initializeWithValue: !1 }), wr = e({
	variants: {
		variant: {
	...
	defaultVariants: { variant: "center" }
}), Er = ({ dismissable: e = !0, asBottomSheetInMobile: t = !0, position: n = "center", onClose: r, isOpen: i, children: a, width: o = "md", primaryAction: s, secondaryAction: c, title: l, description: u, module: d, otherActions: f, navigation: p, resourceHeader: h, controls: g, headerStatus: _, sideControls: v, tabs: y, activeTabId: b, setActiveTabId: x, disableContentPadding: C, container: w }) => {
	let [T, ee] = W(null), te = z((e) => {
		ee(e);
	}, []), ne = (t) => {
		!t && e && r();
	}, E = Cr(), D = n === "left" || n === "right", O = H(() => E && t ? "bottomSheet" : n === "fullscreen" ? "fullscreen" : D ? "sidePosition" : "center", [
		E,
		t,
		D,
		n
		...
		n,
		k
	]), ie = D ? "content" : "f0-overlay-root";
	h && !D && console.warn("F0Dialog: `resourceHeader` is only applicable to side panel positions (left/right)");
	let A = {
		title: l,
		description: u,
		module: d,
		...
		activeTabId: b,
		setActiveTabId: x
	}, j = E, M = E && n === "fullscreen", ae = "absolute top-1/2 z-10 -translate-y-1/2", oe = v ? j ? /* @__PURE__ */ q("div", {
		className: m("sticky bottom-0 z-10 flex shrink-0 flex-row items-center justify-between gap-2", "border border-x-0 border-b-0 border-t border-solid border-f1-border-secondary", "bg-f1-background px-4 py-3"),
		children: [v.previous, v.next]
	}) : /* @__PURE__ */ q(G, { children: [v.previous ? /* @__PURE__ */ K("div", {
		className: m(ae, "-left-14"),
		children: v.previous
	}) : null, v.next ? /* @__PURE__ */ K("div", {
		className: m(ae, "-right-14"),
		children: v.next
	}) : null] }) : null;
	return E && t ? /* @__PURE__ */ K(S, {
		isOpen: i,
		onClose: r,
		position: n,
		portalContainer: T,
		...
		children: /* @__PURE__ */ q(Ae, {
			open: i,
			onOpenChange: ne,
			children: [/* @__PURE__ */ K(Me, { className: "bg-f1-background-overlay" }), /* @__PURE__ */ q(be, {
				ref: te,
				className: re,
				children: [
					/* @__PURE__ */ K(Sr, { ...A }),
		...
		children: /* @__PURE__ */ K(vt, {
			...
			children: /* @__PURE__ */ q(_t, {
				...
				animation: M ? "fade" : "scale",
				overlayClassName: M ? "bg-transparent" : void 0,
				wrapperClassName: wr({
					variant: O,
					position: n
				}),

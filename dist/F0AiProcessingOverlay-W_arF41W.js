...
import { X as Vr, Y as Tr, Z as Hr, _ as rt, $ as Ar, a0 as Er, a1 as $r, a2 as Br, a3 as Ir, a4 as Pr, a5 as ot, a6 as Dr, a7 as jr, a8 as te, a9 as _r, aa as Zr, ab as Or, ac as Ur, ad as zr, ae as Gr, af as Wr, ag as qr, y as nt, ah as Xr, ai as Yr, o as re, aj as st, ak as z1, n as at, al as Kr, am as Qr, an as Jr, ao as eo, ap as to, aq as F1, ar as ro, as as it, at as oo, au as no, l as y1, av as so, aw as ao, ax as lt, ay as io, az as lo, aA as co, aB as uo, aC as fo, aD as ho, aE as ct, aF as Co, aG as po, aH as mo, aI as go, aJ as wo, aK as vo, aL as Lo, aM as xo, aN as bo, aO as ko, aP as yo, aQ as Mo, E as Ro, aR as Fo, aS as No, aT as So, aU as Vo, aV as To, aW as Ho, aX as Ao, aY as Eo, aZ as $o, a_ as Bo, a$ as Io, b0 as Po, b1 as Do, b2 as jo, b3 as _o, b4 as Zo, b5 as Oo, b6 as Uo, b7 as zo, U as dt, b8 as Go, b9 as Wo, ba as qo, bb as ut, R as ft, bc as Xo, i as Yo, bd as Ko, be as Qo, bf as Jo, bg as en, bh as tn, bi as ht, bj as rn, bk as on, bl as nn, bm as sn, bn as an, bo as ln, j as cn, bp as Ct, bq as pt, br as dn, bs as mt, bt as un, bu as oe, q as fn, bv as ne, bw as hn, bx as Cn, by as se, O as pn, Q as mn, bz as gt, bA as gn, bB as wn, bC as vn, bD as Ln, bE as xn, bF as bn, bG as kn, bH as yn, bI as Mn, bJ as Rn, bK as wt, bL as Fn, bM as Nn, bN as Sn, bO as Vn, u as z, bP as o1, bQ as Tn, S as u1, bR as vt, V as n1, bS as Hn, m as m1, bT as An, bU as s1, bV as C1, bW as M1, bX as K, bY as Lt, t as ae, bZ as En, x as ie, b as x1, b_ as $n, b$ as Bn, c0 as In, d as xt, c1 as Pn, c2 as Dn, c3 as le, c4 as jn, c5 as _n, c6 as Zn, c7 as ke, c8 as On, c9 as bt, ca as kt, cb as Un, cc as zn, cd as Gn, ce as Wn, cf as qn, cg as yt, ch as Xn, ci as Yn, cj as Kn, ck as $1, cl as Mt, cm as Rt, cn as Ft, c as K1, co as ye, cp as Nt, cq as Qn, cr as Jn, cs as I1, ct as es, cu as ts, cv as rs, cw as ce, cx as os, cy as ns, cz as ss, cA as as, cB as is, cC as ls, w as cs, s as ds, cD as X1, v as St, cE as us, cF as fs, cG as Me, cH as Vt, cI as Tt, cJ as hs, cK as Cs, cL as ps, cM as ms, cN as gs, cO as ws } from "./F0CanvasPanel-D-P2VhXZ.js";
import { f as f1, d as x, u as vs } from "./tooltip-DTpaXpXW.js";
...
import { F as ks, c as ys, b as Ms, a as Rs } from "./VolumeMuted-DKLKhxyd.js";
function Fs(e, r, o) {
  Fr(() => e.on(r, o), [e, r, o]);
}
...
const N0 = (e, r) => /* @__PURE__ */ i(
  ...
  Calculator: Wr,
  Calendar: qr,
  CalendarArrowDown: t5,
  CalendarArrowLeft: o5,
  CalendarArrowRight: s5,
  CameraPlus: i5,
  CardPin: c5,
  ChartFunnel: u5,
  ChartHorizontalBars: h5,
  ChartLine: p5,
  ChartPie: g5,
  ChartVerticalBars: v5,
  Check: nt,
  CheckCircle: Xr,
  CheckCircleLine: x5,
  CheckDouble: Yr,
      ...
      children: [
        /* @__PURE__ */ t(
          "div",
          {
            ...
            children: /* @__PURE__ */ t(En, { asChild: !0, children: /* @__PURE__ */ t(
              "div",
              {
                ref: u,
...
` || G === "	";
  ...
  const P = Y(() => {
    ...
    const T = s.current;
    if (!T) return null;
    const B = $2(T, M.current), U = T.offsetLeft + B.left, G = (T.offsetParent ? T.offsetParent.offsetHeight : 0) - (T.offsetTop + B.top);
...
const P2 = /[\\`*_{}[\]()#+\-.!|~>]/g, D2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(P2, "\\$&")).join(""), v9 = ({
  ...
  const mr = async (q) => {
    if (q.preventDefault(), !e1) {
      if (a1.close(), o)
        ...
        const v1 = a1.transformMentions(B.trim()), q1 = D2(v1), j1 = pe.flatMap(
  ...
  }, ge = r1 ? r1.prompt ?? r1.title : null, we = G1 ? [R.ai.listening] : ge ? [ge] : s ?? [], Lr = we.length > 1, xr = Y(() => N2(B, a1.mentions, {
    cursorPosition: Z,
  ...
  ) : null, A1 = H1, kr = !A1 || (!!k || !!m || Ce), yr = A1 && !G1, Mr = N && A && !!V && V.length > 0, ve = A && N, { motionProps: Rr } = Bn(
    N,
    160,
    0.5
  );
  return /* @__PURE__ */ i(
    K.div,
    {
      ...
      children: [
        ...
        Mr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(v2, { cards: V }) }),
...
const Fe = 7, m6 = 625, Ne = /* @__PURE__ */ new Set();
function g6(e) {
...
function Xt({
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: d } = x1(), C = p6(e), m = u ?? C, h = $(() => {
  ...
  h.current = M, W(() => {
    typeof window > "u" || window.innerWidth < m6 || Ne.has(e) || (Ne.add(e), h.current());
  }, [e]);
...
const Qt = U1(void 0), k9 = () => B1(Qt), k6 = (e) => /* @__PURE__ */ t(yt, { content: e, format: "markdown" }), y6 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
...
const tr = (e) => /* @__PURE__ */ t(yt, { content: e, format: "markdown" }), A6 = ({
  text: e,
  renderMarkdown: r
  ...
  const c = e.rawData, u = H6(
    e?.content,
    c
  ), l = (T6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, d = l.length > 0, { anchor: C, clear: m } = Yt({
    containerRef: a,
    enabled: d
  });
  return /* @__PURE__ */ i(
  ...
  W(() => {
    ...
    let N;
    if (d === "starting")
      N = setTimeout(() => C("writing"), I6);
    else if (d === "writing")
      l < h.length ? N = setTimeout(() => f((A) => A + 1), $6) : C("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      N = setTimeout(() => C("erasing"), P6);
    } else d === "erasing" && (l > 0 ? N = setTimeout(() => f((A) => A - 1), B6) : N = setTimeout(() => {
...
const Z6 = {
  ...
  const { modal: L, handleSubmit: V, handleClose: H } = F6(
    h ?? Z6
  ), P = z(), R = N ?? y6, T = A ?? E6, B = Y(() => {
    const j = n ?? P.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((e1) => typeof e1 == "string" && e1.length > 0);
  }, [n, P.ai.defaultInitialMessage]), U = !r && e.length === 0 && B.length > 0, Z = $(null), G = $(null), J = $(null), t1 = $(null), X = $(null), { showScrollBtn: Q, turnMinHeight: r1, scrollToBottom: g1 } = _6({
    viewportRef: Z,
    contentRef: G,
    endRef: J,
    lastTurnRef: X,
...
const G6 = ({
  ...
  const m = z().ai.clarifyingQuestion.typeYourAnswer, h = $(null), g = vs(h, c);
  ee(() => {
    const w = h.current;
    if (!w) return;
    w.style.height = "auto";
  ...
  return /* @__PURE__ */ i("div", { className: "flex flex-col", onKeyDown: j, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(M1, { mode: "wait", initial: !1, children: /* @__PURE__ */ i(
      K.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: l1, ease: Y6 },
        children: [
          /* @__PURE__ */ t(
            X6,
            {
...
const Be = ["lowp", "mediump", "highp"], n4 = `
void main(void){
...
}`, Pe = "iTime", De = "iTimeDelta", je = "iDate", _e = "iFrame", Ze = "iMouse", Oe = "iResolution", a4 = "iChannel", Ue = "iChannelResolution", ze = "iDeviceOrientation";
function i4(e, r) {
...
}, Y1 = 9729, Ge = 9728, f4 = 9987, We = 33071, qe = 10497;
class h4 {
  gl;
  url;
  wrapS;
...
}, Ye = (e, r, o) => e * (1 - o) + r * o, C4 = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function p4({
  fs: e,
  vs: r = Ie,
  textures: o = [],
      ...
      if (o && o.length > 0) {
        ...
        const k = o.map(
          (y, D) => (R.current[`${a4}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(y, D), V.current[D] = new h4(b), V.current[D]?.load(y).then((E) => {
            B(E, D);
          }))
        );
        Promise.all(k).then(() => {
...
`,
    ...
    return b.includes("mainImage") && (D = D.concat(n4)), D;
  }, e1 = (b) => {
    const k = g.current;
  ...
  return W(() => {
    ...
    function k() {
      U();
      const y = g.current;
      y && h.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, i1(), j(), g1(l1(e || s4), r || Ie), Z(), requestAnimationFrame(d1), V1(), Q());
    }
...
function b4(e, r) {
  const [o, n] = I(g4), {
    ...
    animate: a,
    motionValue: c
  } = _1(L4), { value: u, animate: l } = _1(w4), { value: f, animate: d } = _1(v4), { value: C, animate: m } = _1(x4), h = xs(r, {
    fftSize: 512,
...
const H4 = ({
  ...
  const s = `sparkline-gradient-${O1().replace(/:/g, "")}`, a = T4(e, o), c = ir[a];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(ss, { width: "100%", height: "100%", children: /* @__PURE__ */ i(
          as,
          {
            data: e,
...
const B4 = () => /* @__PURE__ */ i(
  ...
  "balance",
  "sparkline"
], dr = 180, I4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : dr, P4 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, D4 = (e) => e.showActions !== !1, j4 = (e) => Object.fromEntries(
...
}, O4 = (e) => l2[e] ?? ct, U4 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(n1, { icon: O4(e), size: "md", color: "default" }) }) : null;
function z4({
  sources: e,
  title: r
}) {
...
const J1 = ({
  ...
  const g = z(), v = C1(), w = us(`(max-width: ${fs.md}px)`, {
...
const Je = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], t9 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(u1, { className: x("h-4 rounded", e) }) }), et = ({
  titleWidth: e,
  rows: r

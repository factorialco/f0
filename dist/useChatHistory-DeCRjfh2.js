import { jsxs as f, jsx as o, Fragment as Ue } from "react/jsx-runtime";
import * as zo from "react";
import { useInsertionEffect as Wo, forwardRef as m, useRef as W, useState as X, useCallback as ee, useEffect as fe, useMemo as we, createContext as Tt, useContext as Ct, useLayoutEffect as Qn, useId as Jn, createElement as Go } from "react";
import { bX as qo, bY as Yo, bZ as Xo, b_ as Ko, b$ as e1, c0 as Qo, c1 as Jo, c2 as es, c3 as ts, c4 as rs, c5 as t1, c6 as ns, c7 as os, c8 as ss, c9 as as, ca as is, cb as cs, cc as ls, cd as Zt, ce as ds, cf as us, cg as fs, ch as hs, ci as ps, cj as ms, W as r1, ck as gs, cl as vs, cm as Cs, cn as ws, co as ks, cp as n1, cq as xs, cr as ys, a4 as Mr, cs as bs, aG as Ls, ct as Ms, ae as Es, cu as _s, bt as Ss, a8 as o1, ab as Rs, cv as Vs, a2 as Er, _ as s1, N as Yt, a1, b1 as Ts, cw as As, aX as Ns, bs as Fs, Y as rt, as as Ps, b5 as i1, cx as $s, bq as c1, cy as It, bm as Hs, cz as Is, cA as l1, aW as d1, cB as js, cC as Zs, cD as Os, cE as Ds, cF as u1, bg as Bs, bh as Us, cG as zs, cH as Ws, cI as Gs, cJ as qs, cK as Ys, cL as Xs, cM as Ks, cN as Qs, cO as Js, cP as ea, cQ as ta, cR as ra, cS as na, br as oa, a9 as sa, be as aa, cT as ia, cU as ca, cV as la, cW as da, cX as ua, cY as fa, cZ as ha, an as pa, c_ as f1, J as ma, Z as ga, c$ as h1, d0 as va, b4 as Ca, b3 as wa, d1 as ka, d2 as p1, d3 as xa, aV as ya, aw as ba, d4 as La, aq as Ma, a$ as Ea, d5 as m1, d6 as _a, d7 as Sa, b9 as _r, d8 as Sr, bo as Ra, bn as Va, bp as g1, d9 as Ta, z as Aa, y as Na, da as Fa, db as Pa, dc as $a, dd as Ha, de as Ia, df as v1, dg as ja, aa as Za, dh as Oa, H as Ee, m as G, o as nt, bd as Da, di as C1, aj as Ba, dj as Ua, dk as za, A as je, n as pe, ar as Zr, M as _e, u as ge, dl as Wa, dm as Ga, bK as qa, l as Ya, k as Xa, i as Ka, w as w1, dn as Or, dp as Qa, dq as Ja, dr as ei, ds as ti, dt as ri, a6 as k1, a7 as ni, S as Ne, bV as x1, C as be, s as Je, $ as oi, du as si, ac as Se, aL as Oe, aB as Rr, dv as ai, aC as Vr, aD as Tr, b as Ar, bj as ii, O as ci, aN as y1, bF as li, aS as b1, bz as di, dw as ui, aP as _t, b7 as L1, dx as M1, b8 as E1, dy as _1, dz as fi, ai as hi, bb as pi, dA as mi, b0 as Nr, bf as gi, dB as vi, dC as Ci, dD as wi, dE as ki, dF as xi, ad as yi, a3 as S1, x as bi, dG as R1, dH as V1, dI as Li, ah as Dr, dJ as Mi, ag as Ei, dK as _i, dL as Si } from "./F0CanvasPanel-DUAlJdKv.js";
import { createPortal as T1 } from "react-dom";
import { defaultTranslations as Ri } from "./i18n-provider-defaults.js";
import { useTrackVolume as Vi } from "@livekit/components-react";
import './useChatHistory.css';function Ti(t, e, r) {
  Wo(() => t.on(e, r), [t, e, r]);
}
function Fr(t) {
...
function A1(t, e, r, n) {
  return typeof t == "string" && Fr(e) ? qo(t, r, n) : t instanceof NodeList ? Array.from(t) : Array.isArray(t) ? t : [t];
}
function Ai(t, e, r) {
  return t * (e + 1);
}
...
function N1(t, e) {
  return Yo(t) ? t[Ni(0, t.length, e)] : t;
}
function Fi(t, e, r) {
  for (let n = 0; n < t.length; n++) {
    const s = t[n];
    s.at > e && s.at < r && (Ko(t, s), n--);
  }
}
function Pi(t, e, r, n, s, a) {
  Fi(t, s, a);
...
const Ii = "easeInOut", ji = 20;
function Zi(t, { defaultTransition: e = {}, ...r } = {}, n, s) {
  ...
  for (let p = 0; p < t.length; p++) {
    ...
    if (typeof v == "string") {
      ...
      d.set(v.name, Br(h, v.at, u, d));
      continue;
    }
    let [y, x, b = {}] = v;
    b.at !== void 0 && (h = Br(h, b.at, u, d));
    let V = 0;
    const I = (T, g, C, k = 0, F = 0) => {
      const _ = Oi(T), { delay: M = 0, times: L = Qo(_), type: R = "keyframes", repeat: D, repeatType: K, repeatDelay: J = 0, ...te } = g;
      let { ease: oe = e.ease || "easeOut", duration: Q } = g;
      const E = typeof M == "function" ? M(k, F) : M, z = _.length, H = ts(R) ? R : s?.[R];
      if (z <= 2 && H) {
        let O = 100;
        if (z === 2 && Ui(_)) {
          const xe = _[1] - _[0];
        ...
        const ne = { ...te };
        Q !== void 0 && (ne.duration = rs(Q));
        const ce = Jo(ne, O, H);
        oe = ce.ease, Q = ce.duration;
      }
      Q ?? (Q = a);
      const Y = h + E;
      L.length === 1 && L[0] === 0 && (L[1] = 1);
      const he = L.length - _.length;
      if (he > 0 && es(L, he), _.length === 1 && _.unshift(null), D) {
        t1(D < ji, "Repeat count too high, must be less than 20"), Q = Ai(Q, D);
        const O = [..._], ne = [...L];
        ...
        for (let xe = 0; xe < D; xe++) {
          ...
          for (let S = 0; S < O.length; S++)
            L.push(ne[S] + (xe + 1)), oe.push(S === 0 ? "linear" : N1(ce, S - 1));
        }
        $i(L, D);
      }
      const me = Y + Q;
      Pi(C, _, oe, L, Y, me), V = Math.max(E + Q, V), w = Math.max(me, w);
    };
    if (e1(y)) {
      const T = Ur(y, c);
      I(x, b, zr("default", T));
    } else {
      const T = A1(y, x, n, l), g = T.length;
      for (let C = 0; C < g; C++) {
        x = x, b = b;
        const k = T[C], F = Ur(k, c);
        for (const _ in x)
          I(x[_], Di(b, _), zr(_, F), C, g);
      }
    }
    u = h, h += V;
  }
  return c.forEach((p, v) => {
    for (const y in p) {
      ...
      for (let g = 0; g < x.length; g++) {
        const { at: C, value: k, easing: F } = x[g];
        b.push(k), V.push(ns(0, w, C)), I.push(F || "easeOut");
      }
      V[0] !== 0 && (V.unshift(0), b.unshift(b[0]), I.unshift(Ii)), V[V.length - 1] !== 1 && (V.push(1), b.push(null)), i.has(v) || i.set(v, {
        keyframes: {},
        transition: {}
      });
      const T = i.get(v);
      T.keyframes[y] = b, T.transition[y] = {
        ...e,
        duration: w,
        ease: I,
        times: V,
...
const Bi = (t) => typeof t == "number", Ui = (t) => t.every(Bi);
function zi(t, e) {
  return t in e;
}
class Wi extends os {
...
function Gi(t) {
  ...
  }, r = as(t) && !is(t) ? new cs(e) : new ls(e);
  r.mount(t), Zt.set(t, r);
}
function qi(t) {
  const e = {
    presenceContext: null,
...
function Yi(t, e) {
  return e1(t) || typeof t == "number" || typeof t == "string" && !Fr(e);
}
function F1(t, e, r, n) {
  const s = [];
  if (Yi(t, e))
    s.push(ds(t, Fr(e) && e.default || e, r && (r.default || r)));
  else {
    const a = A1(t, e, n), i = a.length;
    t1(!!i, "No valid elements provided.");
    for (let c = 0; c < i; c++) {
      const l = a[c], d = l instanceof Element ? Gi : qi;
      Zt.has(l) || d(l);
      const u = Zt.get(l), h = { ...r };
      "delay" in h && typeof h.delay == "function" && (h.delay = h.delay(c, i)), s.push(...us(u, { ...e, transition: h }, {}));
    }
  }
  return s;
}
function Xi(t, e, r) {
  const n = [];
  return Zi(t, e, r, { spring: fs }).forEach(({ keyframes: a, transition: i }, c) => {
    n.push(...F1(c, a, i));
  }), n;
}
class Ki {
...
function ec(t) {
  function e(r, n, s) {
    let a = [];
    return Ji(r) ? a = Xi(r, n, t) : a = F1(r, n, s, t), new Qi(a);
  }
  return e;
}
const tc = ec(), rc = (t, e) => /* @__PURE__ */ f(
  "svg",
  {
...
H1.displayName = "ShoppingCart";
const j2 = (t, e) => /* @__PURE__ */ f(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
), Ld = m(bd), Md = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: nc,
  Add: hs,
  Ai: ps,
  ...
  Calculator: _s,
  Calendar: Ss,
  CalendarArrowDown: Nc,
  CalendarArrowLeft: Pc,
  CalendarArrowRight: Hc,
  CameraPlus: jc,
  CardPin: Oc,
  ChartFunnel: Bc,
  ChartHorizontalBars: zc,
  ChartLine: Gc,
  ChartPie: Yc,
  ChartVerticalBars: Kc,
  Check: o1,
  CheckCircle: Rs,
  CheckCircleLine: Jc,
  CheckDouble: Vs,
  ...
  DropdownOpen: Is,
  Ellipsis: l1,
  EllipsisHorizontal: d1,
  Envelope: Pl,
  EnvelopeOpen: Hl,
  Equal: js,
  EqualApproximately: Zs,
  EqualGreater: Os,
  EqualLess: Ds,
  Exit: jl,
  ExternalLink: u1,
  ...
  FaceNeutral: Ws,
  FacePositive: Gs,
  FaceSuperNegative: qs,
  FaceSuperPositive: Ys,
  Feed: Ol,
  File: Bl,
  FileFilled: zl,
  FileSigned: Gl,
  ...
  Wifi: Ld,
  Windows: Oa
}, Symbol.toStringTag, { value: "Module" })), Ed = (t, e) => /* @__PURE__ */ o(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ o(
    Ee,
    {
      ...
      variant: "ai",
      ref: e,
      iconRotate: t.icon == _d
    }
  );
});
D1.displayName = "AIButton";
const B1 = {
  background: {
...
const zd = nt({
  ...
  ({
    ...
    const Nt = z && z !== "none" || H && H !== "none" || Y && Y !== "none" || he && he !== "none", Jt = E && E !== "none" || Nt, Ft = { sm: At, md: Xt, lg: Kt, xl: Qt }, Pt = Wd.map((wt) => {
      const jr = Ft[wt];
      return jr ? Ud(wt, jr) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ o(
      "div",
      {
        ...
        className: G(
          ...
          Pt,
          Jt && !Q && "border-f1-border",
          B && !se && "divide-f1-border",
          "scrollbar-macos"
        ),
        ...Ce
      }
...
const er = Da(
  ...
  const { position: r } = C1(), n = W(null), [s, a] = X(!0), [i, c] = X(!0), l = ee(() => {
    const d = n.current;
    if (!d) return;
  ...
  return fe(() => {
    ...
    /* @__PURE__ */ f(
      Ba,
      {
        ...
        children: [
          /* @__PURE__ */ o(Ua, { layout: null, children: t }),
          /* @__PURE__ */ o(
            za,
            {
    ...
    /* @__PURE__ */ f(je, { children: [
      !s && /* @__PURE__ */ o(Wr, { position: "top" }, "shadow-top"),
      !i && /* @__PURE__ */ o(Wr, { position: "bottom" }, "shadow-bottom")
    ] })
  ] });
}, Gd = (t) => Array.isArray(t), qd = (t) => Array.isArray(t), qr = ({
  primaryAction: t,
  secondaryAction: e
}) => {
  const r = e, n = t;
  ...
  const c = ge(), { onClose: l } = C1(), d = !!s, u = () => /* @__PURE__ */ o("div", { className: "h-4 w-px self-center bg-f1-background-secondary" }), h = n?.filter(
    (v) => v.type !== "separator" && v.type !== "label"
  ) ?? [], w = () => {
    if (!h.length || !n) return null;
    const v = h.some((y) => y.critical);
    return h.length <= 2 && !v ? /* @__PURE__ */ o("div", { className: "flex flex-row gap-2", children: h.map((y) => /* @__PURE__ */ o(
      Ee,
      {
        variant: "outline",
        icon: y.icon,
      ...
      y.label
    )) }) : /* @__PURE__ */ o(Ka, { items: n, icon: l1 });
  }, p = () => r ? /* @__PURE__ */ o(Ya, { children: /* @__PURE__ */ o(
    Xa,
    {
      item: {
        id: r.id,
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ f("div", { className: "flex flex-col gap-1", children: [
            r ? /* @__PURE__ */ o(p, {}) : t && /* @__PURE__ */ o(Wa, { className: "py-1 text-lg font-semibold text-f1-foreground", children: t }),
            !!e && /* @__PURE__ */ o(Ga, { className: "text-base text-f1-foreground-secondary", children: e })
          ] }),
  ...
  const [b, V] = X(null), I = ee((L) => {
    V(L);
  }, []), T = (L) => {
    L || r();
  }, g = Yd(), C = e === "left" || e === "right", k = we(() => g && t ? "bottomSheet" : e === "fullscreen" ? "fullscreen" : C ? "sidePosition" : "center", [g, t, C, e]), F = we(() => (a && !["center", "left", "right"].includes(e) && console.warn(
  ...
  return g && t ? /* @__PURE__ */ o(
    Or,
    {
      ...
      portalContainer: b,
      shownBottomSheet: !0,
      children: /* @__PURE__ */ f(Qa, { open: n, onOpenChange: T, children: [
        /* @__PURE__ */ o(Ja, { className: "bg-f1-background-overlay" }),
        /* @__PURE__ */ f(ei, { ref: I, className: _, children: [
          /* @__PURE__ */ o(Yr, { ...M }),
          /* @__PURE__ */ o(Gr, { disableContentPadding: y, children: s }),
          /* @__PURE__ */ o(
            qr,
            {
              primaryAction: i,
...
}, ro = (t) => /* @__PURE__ */ o(Qd, { ...t });
ro.displayName = "F0Dialog";
const Jd = k1(
  ni("F0Dialog", ro)
), e4 = ["days", "hours", "minutes", "seconds"], K9 = ["sm", "md"], no = [...e4], Q9 = ["hours", "minutes"], De = {
  days: 86400,
  hours: 3600,
  minutes: 60,
  seconds: 1
...
function t4(t) {
  ...
  const n = Math.floor(r / De.days);
  r = r % De.days;
  const s = Math.floor(r / De.hours);
  r = r % De.hours;
  const a = Math.floor(r / De.minutes), i = r % De.minutes;
  return { days: n, hours: s, minutes: a, seconds: i };
}
function J9(t) {
  return no.reduce((e, r) => {
...
function e3(t, e) {
  ...
  const s = { days: 0, hours: 0, minutes: 0, seconds: 0 }, a = no.filter((i) => e.includes(i));
  for (const i of a)
    s[i] = Math.floor(n / De[i]), n = n % De[i];
  return s;
}
function t3(t, e) {
...
const re = Object.freeze({
  status: "aborted"
}), bt = (t) => ({ status: "dirty", value: t }), Fe = (t) => ({ status: "valid", value: t }), Kr = (t) => t.status === "aborted", Qr = (t) => t.status === "dirty", ht = (t) => t.status === "valid", Ot = (t) => typeof Promise < "u" && t instanceof Promise;
var q;
(function(t) {
...
class ie {
  ...
  "~validate"(e) {
    ...
    return this._parseAsync({ data: e, path: [], parent: r }).then((n) => ht(n) ? {
      value: n.value
    } : {
      issues: r.common.issues
    });
  ...
  async safeParseAsync(e, r) {
    const n = {
      ...
      data: e,
      parsedType: Xe(e)
    }, s = this._parse({ data: e, path: n.path, parent: n }), a = await (Ot(s) ? s : Promise.resolve(s));
    return Jr(n, a);
  }
  refine(e, r) {
...
const s4 = /^c[^\s-]{8,}$/i, a4 = /^[0-9a-z]+$/, i4 = /^[0-9A-HJKMNP-TV-Z]{26}$/i, c4 = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i, l4 = /^[a-z0-9_-]{21}$/i, d4 = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/, u4 = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/, f4 = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i, h4 = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let tr;
const p4 = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, m4 = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/, g4 = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/, v4 = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/, C4 = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/, w4 = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/, oo = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))", k4 = new RegExp(`^${oo}$`);
function so(t) {
  let e = "[0-5]\\d";
...
function b4(t, e) {
  return !!((e === "v4" || !e) && p4.test(t) || (e === "v6" || !e) && g4.test(t));
}
function L4(t, e) {
  if (!d4.test(t))
    return !1;
...
function M4(t, e) {
  return !!((e === "v4" || !e) && m4.test(t) || (e === "v6" || !e) && v4.test(t));
}
class Ke extends ie {
  _parse(e) {
    ...
    for (const a of this._def.checks)
      if (a.kind === "min")
        e.data.length < a.value && (s = this._getOrReturnCtx(e, s), j(s, {
          code: A.too_small,
          minimum: a.value,
          type: "string",
          inclusive: !0,
        ...
        (i || c) && (s = this._getOrReturnCtx(e, s), i ? j(s, {
          code: A.too_big,
          maximum: a.value,
          type: "string",
          inclusive: !0,
        ...
        f4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
          validation: "email",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "emoji")
        tr || (tr = new RegExp(h4, "u")), tr.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
          validation: "emoji",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "uuid")
        c4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
          validation: "uuid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "nanoid")
        l4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
          validation: "nanoid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "cuid")
        s4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
          validation: "cuid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "cuid2")
        a4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
          validation: "cuid2",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "ulid")
        i4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
          validation: "ulid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      ...
      else a.kind === "regex" ? (a.regex.lastIndex = 0, a.regex.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
        validation: "regex",
        code: A.invalid_string,
        message: a.message
      }), n.dirty())) : a.kind === "trim" ? e.data = e.data.trim() : a.kind === "includes" ? e.data.includes(a.value, a.position) || (s = this._getOrReturnCtx(e, s), j(s, {
        code: A.invalid_string,
        validation: { includes: a.value, position: a.position },
        message: a.message
      }), n.dirty()) : a.kind === "toLowerCase" ? e.data = e.data.toLowerCase() : a.kind === "toUpperCase" ? e.data = e.data.toUpperCase() : a.kind === "startsWith" ? e.data.startsWith(a.value) || (s = this._getOrReturnCtx(e, s), j(s, {
        code: A.invalid_string,
        validation: { startsWith: a.value },
        message: a.message
      }), n.dirty()) : a.kind === "endsWith" ? e.data.endsWith(a.value) || (s = this._getOrReturnCtx(e, s), j(s, {
        code: A.invalid_string,
        validation: { endsWith: a.value },
        message: a.message
      }), n.dirty()) : a.kind === "datetime" ? y4(a).test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
        code: A.invalid_string,
        validation: "datetime",
        message: a.message
      }), n.dirty()) : a.kind === "date" ? k4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
        code: A.invalid_string,
        validation: "date",
        message: a.message
      }), n.dirty()) : a.kind === "time" ? x4(a).test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
        code: A.invalid_string,
        validation: "time",
        message: a.message
      }), n.dirty()) : a.kind === "duration" ? u4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
        validation: "duration",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "ip" ? b4(e.data, a.version) || (s = this._getOrReturnCtx(e, s), j(s, {
        validation: "ip",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "jwt" ? L4(e.data, a.alg) || (s = this._getOrReturnCtx(e, s), j(s, {
        validation: "jwt",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "cidr" ? M4(e.data, a.version) || (s = this._getOrReturnCtx(e, s), j(s, {
        validation: "cidr",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "base64" ? C4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
        validation: "base64",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "base64url" ? w4.test(e.data) || (s = this._getOrReturnCtx(e, s), j(s, {
        validation: "base64url",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : le.assertNever(a);
...
class pt extends ie {
  ...
  _parse(e) {
    ...
    const s = new Ae();
    for (const a of this._def.checks)
      a.kind === "int" ? le.isInteger(e.data) || (n = this._getOrReturnCtx(e, n), j(n, {
        code: A.invalid_type,
        expected: "integer",
        received: "float",
        message: a.message
      }), s.dirty()) : a.kind === "min" ? (a.inclusive ? e.data < a.value : e.data <= a.value) && (n = this._getOrReturnCtx(e, n), j(n, {
        code: A.too_small,
        minimum: a.value,
        type: "number",
        ...
        exact: !1,
        message: a.message
      }), s.dirty()) : a.kind === "max" ? (a.inclusive ? e.data > a.value : e.data >= a.value) && (n = this._getOrReturnCtx(e, n), j(n, {
        code: A.too_big,
        maximum: a.value,
        type: "number",
        inclusive: a.inclusive,
        exact: !1,
        message: a.message
      }), s.dirty()) : a.kind === "multipleOf" ? E4(e.data, a.value) !== 0 && (n = this._getOrReturnCtx(e, n), j(n, {
        code: A.not_multiple_of,
        multipleOf: a.value,
        message: a.message
      }), s.dirty()) : a.kind === "finite" ? Number.isFinite(e.data) || (n = this._getOrReturnCtx(e, n), j(n, {
        code: A.not_finite,
        message: a.message
      }), s.dirty()) : le.assertNever(a);
  ...
  _parse(e) {
    ...
    for (const a of this._def.checks)
      a.kind === "min" ? (a.inclusive ? e.data < a.value : e.data <= a.value) && (n = this._getOrReturnCtx(e, n), j(n, {
        ...
        inclusive: a.inclusive,
        message: a.message
      }), s.dirty()) : a.kind === "multipleOf" ? e.data % a.value !== BigInt(0) && (n = this._getOrReturnCtx(e, n), j(n, {
        code: A.not_multiple_of,
        multipleOf: a.value,
        message: a.message
      }), s.dirty()) : le.assertNever(a);
...
class Rt extends ie {
  _parse(e) {
    ...
    let s;
    for (const a of this._def.checks)
      a.kind === "min" ? e.data.getTime() < a.value && (s = this._getOrReturnCtx(e, s), j(s, {
        code: A.too_small,
        message: a.message,
        inclusive: !0,
        exact: !1,
        minimum: a.value,
        type: "date"
      }), n.dirty()) : a.kind === "max" ? e.data.getTime() > a.value && (s = this._getOrReturnCtx(e, s), j(s, {
        code: A.too_big,
        message: a.message,
        inclusive: !0,
        exact: !1,
...
class Ze extends ie {
  _parse(e) {
    ...
    if (s.minLength !== null && r.data.length < s.minLength.value && (j(r, {
      ...
      return Promise.all([...r.data].map((i, c) => s.type._parseAsync(new et(r, i, r.path, c)))).then((i) => Ae.mergeArray(n, i));
    const a = [...r.data].map((i, c) => s.type._parseSync(new et(r, i, r.path, c)));
...
function dt(t) {
  if (t instanceof ke) {
    ...
    ...t._def,
    type: dt(t.element)
  }) : t instanceof Qe ? Qe.create(dt(t.unwrap())) : t instanceof vt ? vt.create(dt(t.unwrap())) : t instanceof at ? at.create(t.items.map((e) => dt(e))) : t;
}
class ke extends ie {
  constructor() {
  ...
  _parse(e) {
    ...
    for (const d of i) {
      ...
      l.push({
        ...
        value: u._parse(new et(s, h, s.path, d)),
    ...
    return s.common.async ? Promise.resolve().then(async () => {
      ...
      return d;
    }).then((d) => Ae.mergeObjectSync(n, d)) : Ae.mergeObjectSync(n, l);
  }
  get shape() {
  ...
  pick(e) {
    const r = {};
    for (const n of le.objectKeys(e))
  ...
  keyof() {
    return ao(le.objectKeys(this.shape));
  }
}
...
class Dt extends ie {
  _parse(e) {
    ...
    function s(a) {
      ...
      const i = a.map((c) => new ze(c.ctx.common.issues));
      return j(r, {
...
function Cr(t, e) {
  ...
  if (r === U.object && n === U.object) {
    const s = le.objectKeys(e), a = le.objectKeys(t).filter((c) => s.indexOf(c) !== -1), i = { ...t, ...e };
    for (const c of a) {
      const l = Cr(t[c], e[c]);
      if (!l.valid)
        return { valid: !1 };
...
class Bt extends ie {
  _parse(e) {
    const { status: r, ctx: n } = this._processInputParams(e), s = (a, i) => {
      if (Kr(a) || Kr(i))
        return re;
      const c = Cr(a.value, i.value);
      return c.valid ? ((Qr(a) || Qr(i)) && r.dirty(), { status: r.value, value: c.data }) : (j(n, {
...
class at extends ie {
  _parse(e) {
    ...
    const a = [...n.data].map((i, c) => {
      ...
      return l ? l._parse(new et(n, i, n.path, c)) : null;
    }).filter((i) => !!i);
    return n.common.async ? Promise.all(a).then((i) => Ae.mergeArray(r, i)) : Ae.mergeArray(r, a);
  }
  get items() {
...
class on extends ie {
  ...
  _parse(e) {
    ...
    const s = this._def.keyType, a = this._def.valueType, i = [...n.data.entries()].map(([c, l], d) => ({
      key: s._parse(new et(n, c, n.path, [d, "key"])),
      value: a._parse(new et(n, l, n.path, [d, "value"]))
    }));
    if (n.common.async) {
...
class Vt extends ie {
  _parse(e) {
    ...
    const c = [...n.data.values()].map((l, d) => a._parse(new et(n, l, n.path, d)));
...
class Ut extends ie {
  ...
  _parse(e) {
    ...
    return Fe(n.then((s) => this._def.type.parseAsync(s, {
      path: r.path,
  ...
  _parse(e) {
    ...
    if (a.addIssue = a.addIssue.bind(a), s.type === "preprocess") {
      ...
      if (n.common.async)
        return Promise.resolve(i).then(async (c) => {
          ...
          return l.status === "aborted" ? re : l.status === "dirty" || r.value === "dirty" ? bt(l.value) : l;
        });
      {
        if (r.value === "aborted")
          return re;
        ...
        return c.status === "aborted" ? re : c.status === "dirty" || r.value === "dirty" ? bt(c.value) : c;
      }
    }
    if (s.type === "refinement") {
      ...
      if (n.common.async === !1) {
        ...
        return c.status === "aborted" ? re : (c.status === "dirty" && r.dirty(), i(c.value), { status: r.value, value: c.value });
      } else
        return this._def.schema._parseAsync({ data: n.data, path: n.path, parent: n }).then((c) => c.status === "aborted" ? re : (c.status === "dirty" && r.dirty(), i(c.value).then(() => ({ status: r.value, value: c.value }))));
    }
    if (s.type === "transform")
      if (n.common.async === !1) {
        ...
        return this._def.schema._parseAsync({ data: n.data, path: n.path, parent: n }).then((i) => ht(i) ? Promise.resolve(s.transform(i.value, a)).then((c) => ({
          status: r.value,
          value: c
        })) : re);
    le.assertNever(s);
...
class Qe extends ie {
  _parse(e) {
    return this._getType(e) === U.undefined ? Fe(void 0) : this._def.innerType._parse(e);
  }
  unwrap() {
...
class vt extends ie {
  _parse(e) {
    return this._getType(e) === U.null ? Fe(null) : this._def.innerType._parse(e);
  }
  unwrap() {
    return this._def.innerType;
  }
  ...
  _parse(e) {
    ...
    if (n.common.async)
      return (async () => {
        ...
        return a.status === "aborted" ? re : a.status === "dirty" ? (r.dirty(), bt(a.value)) : this._def.out._parseAsync({
          data: a.value,
          path: n.path,
          parent: n
        });
...
class yr extends ie {
  _parse(e) {
    const r = this._def.innerType._parse(e), n = (s) => (ht(s) && (s.value = Object.freeze(s.value)), s);
...
const Le = Ke.create, it = pt.create, ln = mr.create, qe = Rt.create, r3 = gr.create, n3 = vr.create;
tt.create;
const kt = Ze.create, br = ke.create;
Dt.create;
Bt.create;
at.create;
const dn = wr.create, xt = mt.create;
Ut.create;
Qe.create;
vt.create;
function He(t, e) {
...
function o3(t) {
  return He(t, "ZodEffects") ? t._def.schema : t;
}
...
function co(t) {
  const e = t;
  return e._f0Config ? e._f0Config : io.get(t);
}
function s3(t) {
  return co(t) !== void 0;
}
function zt(t) {
  let e = t;
  for (; He(e, "ZodOptional") || He(e, "ZodNullable") || He(e, "ZodDefault"); )
    e = e._def.innerType;
  return e;
}
function fn(t, e) {
  ...
  if ("options" in e && e.options || "source" in e && e.source)
    return "select";
  const r = zt(t);
  return He(r, "ZodString") ? "rows" in e && e.rows ? "textarea" : "text" : He(r, "ZodNumber") ? "number" : He(r, "ZodBoolean") ? "switch" : He(r, "ZodDate") ? "date" : He(r, "ZodEnum") || He(r, "ZodArray") && ("options" in e && e.options || "source" in e && e.source) ? "select" : He(r, "ZodObject") && "render" in e && e.render ? "custom" : "text";
}
((t) => {
  function e({
    optional: g,
    ...
    let _ = Le();
    const M = !g && C === void 0 ? 1 : C;
    M !== void 0 && (_ = _.min(M)), k !== void 0 && (_ = _.max(k));
    const L = g ? _.optional() : _;
    return t(L, F);
  }
  t.text = e;
  function r({ optional: g, ...C }) {
    const k = g ? Le().email().optional() : Le().email();
    return t(k, C);
  }
  t.email = r;
  function n({ optional: g, ...C }) {
    const k = g ? Le().optional() : Le().min(1);
    return t(
      k,
  ...
  function s({
    ...
    let M = it();
    F && (M = M.int()), C !== void 0 && (M = M.min(C)), k !== void 0 && (M = M.max(k));
    const L = g ? M.optional() : M;
    return t(L, _);
  }
  t.number = s;
  function a({ optional: g, ...C }) {
    const k = g ? ln() : dn(!0);
    return t(
      k,
      { ...C, fieldType: "switch" }
  ...
  t.checkbox = i;
  function c({ optional: g, ...C }) {
    const k = g ? qe().optional() : qe();
    return t(k, C);
  }
  t.date = c;
  function l({ optional: g, ...C }) {
    const k = g ? Le().url().optional() : Le().url();
    return t(k, C);
  }
  t.url = l;
  function d({ optional: g, ...C }) {
    const k = g ? it().optional() : it();
    return t(
      k,
      { ...C, fieldType: "money" }
    );
  ...
  function u({
    ...
    let _ = it();
    C !== void 0 && (_ = _.min(C)), k !== void 0 && (_ = _.max(k));
    const M = g ? _.optional() : _;
    return t(
      M,
  ...
  function h(g) {
    ...
    const { optional: C, ...k } = g, F = k.options.map((M) => M.value), _ = C ? xt(F).optional() : xt(F);
    return t(
      _,
      { ...k, fieldType: "cardSelect" }
    );
  }
  t.cardSelect = h;
  function w({ optional: g, ...C }) {
    const k = g ? Le().optional() : Le().min(1);
    return t(
      k,
  ...
  t.file = w;
  function p({ optional: g, ...C }) {
    const k = g ? kt(Le()).optional() : kt(Le()).min(1);
    return t(
      k,
  ...
  t.duration = x;
  function b({ optional: g, ...C }) {
    const k = br({ from: qe(), to: qe() }), F = g ? k.optional() : k;
    return t(
      F,
  ...
  function I(g) {
    ...
    const C = g, { optional: k, ...F } = C, _ = Array.isArray(C.options) ? C.options : void 0;
    if (_ && _.length > 0) {
      const L = _.filter(
        (R) => typeof R == "object" && R !== null && "value" in R && typeof R.value == "string"
      ).map((R) => R.value);
      if (L.length > 0) {
        const R = k ? xt(L).optional() : xt(L);
        return t(R, F);
      }
    }
    const M = k ? Le().optional() : Le();
    return t(M, F);
  }
  t.select = I;
  function T(g) {
    ...
    if (_ && _.length > 0) {
      ...
      if (R.length > 0) {
        const D = kt(xt(R)).min(1), K = k ? D.optional() : D;
        return t(
          K,
          { ...F, multiple: !0 }
        );
    ...
    const M = kt(Le()).min(1), L = k ? M.optional() : M;
    return t(L, { ...F, multiple: !0 });
  }
  t.multiSelect = T;
})(un || (un = {}));
const S4 = /* @__PURE__ */ Symbol("Let zodToJsonSchema decide on which parser to use"), R4 = {
  name: void 0,
  $refStrategy: "root",
  basePath: ["#"],
  ...
  const e = V4(t), r = e.name !== void 0 ? [...e.basePath, e.definitionPath, e.name] : e.basePath;
  return {
    ...e,
...
function Ve(t) {
  ...
  return t.flags.hasReferencedOpenAiAnyType = !0, {
    $ref: t.$refStrategy === "relative" ? uo(e, t.currentPath) : e.join("/")
  };
}
function A4(t, e) {
  const r = {
  ...
  return t.type?._def && t.type?._def?.typeName !== N.ZodAny && (r.items = de(t.type._def, {
    ...e,
    currentPath: [...e.currentPath, "items"]
  })), t.minLength && ue(r, "minItems", t.minLength.value, t.minLength.message, e), t.maxLength && ue(r, "maxItems", t.maxLength.value, t.maxLength.message, e), t.exactLength && (ue(r, "minItems", t.exactLength.value, t.exactLength.message, e), ue(r, "maxItems", t.exactLength.value, t.exactLength.message, e)), r;
}
function N4(t, e) {
  const r = {
    type: "integer",
  ...
  for (const n of t.checks)
    switch (n.kind) {
      case "min":
        e.target === "jsonSchema7" ? n.inclusive ? ue(r, "minimum", n.value, n.message, e) : ue(r, "exclusiveMinimum", n.value, n.message, e) : (n.inclusive || (r.exclusiveMinimum = !0), ue(r, "minimum", n.value, n.message, e));
        break;
      case "max":
        e.target === "jsonSchema7" ? n.inclusive ? ue(r, "maximum", n.value, n.message, e) : ue(r, "exclusiveMaximum", n.value, n.message, e) : (n.inclusive || (r.exclusiveMaximum = !0), ue(r, "maximum", n.value, n.message, e));
        break;
      case "multipleOf":
        ue(r, "multipleOf", n.value, n.message, e);
        break;
    }
  return r;
}
...
const P4 = (t, e) => de(t.innerType._def, e);
function ho(t, e, r) {
  const n = r ?? e.dateStrategy;
  if (Array.isArray(n))
    return {
      anyOf: n.map((s, a) => ho(t, e, s))
    };
  switch (n) {
    case "string":
...
function I4(t, e) {
  return e.effectStrategy === "input" ? de(t.schema._def, e) : Ve(e);
}
function j4(t) {
  return {
    type: "string",
...
const Z4 = (t) => "type" in t && t.type === "string" ? !1 : "allOf" in t;
function O4(t, e) {
  const r = [
    de(t.left._def, {
      ...e,
...
function po(t, e) {
  ...
  if (t.checks)
    for (const n of t.checks)
      switch (n.kind) {
        case "min":
          ue(r, "minLength", typeof r.minLength == "number" ? Math.max(r.minLength, n.value) : n.value, n.message, e);
          break;
        case "max":
          ue(r, "maxLength", typeof r.maxLength == "number" ? Math.min(r.maxLength, n.value) : n.value, n.message, e);
          break;
        case "email":
          switch (e.emailStrategy) {
            case "format:email":
              $e(r, "email", n.message, e);
              break;
            case "format:idn-email":
              $e(r, "idn-email", n.message, e);
              break;
            case "pattern:zod":
              Me(r, Pe.email, n.message, e);
              break;
          }
          break;
        case "url":
          ...
          break;
        case "uuid":
          $e(r, "uuid", n.message, e);
          break;
        case "regex":
          Me(r, n.regex, n.message, e);
          break;
        case "cuid":
          Me(r, Pe.cuid, n.message, e);
          break;
        case "cuid2":
          Me(r, Pe.cuid2, n.message, e);
          break;
        case "startsWith":
          Me(r, RegExp(`^${nr(n.value, e)}`), n.message, e);
          break;
        case "endsWith":
          Me(r, RegExp(`${nr(n.value, e)}$`), n.message, e);
          break;
        case "datetime":
          $e(r, "date-time", n.message, e);
          break;
        case "date":
          $e(r, "date", n.message, e);
          break;
        case "time":
          $e(r, "time", n.message, e);
          break;
        case "duration":
          $e(r, "duration", n.message, e);
          break;
        case "length":
          ue(r, "minLength", typeof r.minLength == "number" ? Math.max(r.minLength, n.value) : n.value, n.message, e), ue(r, "maxLength", typeof r.maxLength == "number" ? Math.min(r.maxLength, n.value) : n.value, n.message, e);
          break;
        case "includes": {
          Me(r, RegExp(nr(n.value, e)), n.message, e);
          break;
        ...
        case "ip": {
          n.version !== "v6" && $e(r, "ipv4", n.message, e), n.version !== "v4" && $e(r, "ipv6", n.message, e);
          break;
        }
        case "base64url":
          Me(r, Pe.base64url, n.message, e);
          break;
        case "jwt":
          Me(r, Pe.jwt, n.message, e);
          break;
        case "cidr": {
          n.version !== "v6" && Me(r, Pe.ipv4Cidr, n.message, e), n.version !== "v4" && Me(r, Pe.ipv6Cidr, n.message, e);
          break;
        }
        case "emoji":
          Me(r, Pe.emoji(), n.message, e);
          break;
        case "ulid": {
          Me(r, Pe.ulid, n.message, e);
          break;
        }
        case "base64": {
          switch (e.base64Strategy) {
            case "format:binary": {
              $e(r, "binary", n.message, e);
              break;
            }
            case "contentEncoding:base64": {
              ue(r, "contentEncoding", "base64", n.message, e);
              break;
            }
            case "pattern:zod": {
              Me(r, Pe.base64, n.message, e);
              break;
            }
          }
          break;
        ...
        case "nanoid":
          Me(r, Pe.nanoid, n.message, e);
      }
  return r;
}
function nr(t, e) {
  return e.patternStrategy === "escape" ? U4(t) : t;
}
const B4 = new Set("ABCDEFGHIJKLMNOPQRSTUVXYZabcdefghijklmnopqrstuvxyz0123456789");
function U4(t) {
  let e = "";
  for (let r = 0; r < t.length; r++)
    B4.has(t[r]) || (e += "\\"), e += t[r];
...
function mo(t, e) {
  if (e.target === "openAi" && console.warn("Warning: OpenAI may not support records in schemas! Try an array of key-value pairs instead."), e.target === "openApi3" && t.keyType?._def.typeName === N.ZodEnum)
    return {
      type: "object",
      required: t.keyType._def.values,
      properties: t.keyType._def.values.reduce((n, s) => ({
        ...n,
        [s]: de(t.valueType._def, {
          ...e,
  ...
  if (e.target === "openApi3")
    return r;
  if (t.keyType?._def.typeName === N.ZodString && t.keyType._def.checks?.length) {
    const { type: n, ...s } = po(t.keyType._def, e);
    return {
      ...r,
      propertyNames: s
    };
  } else {
    if (t.keyType?._def.typeName === N.ZodEnum)
      return {
        ...r,
        propertyNames: {
    ...
    if (t.keyType?._def.typeName === N.ZodBranded && t.keyType._def.type._def.typeName === N.ZodString && t.keyType._def.type._def.checks?.length) {
      const { type: n, ...s } = fo(t.keyType._def, e);
      return {
        ...r,
        propertyNames: s
      };
...
function z4(t, e) {
  if (e.mapStrategy === "record")
    return mo(t, e);
  const r = de(t.keyType._def, {
    ...e,
    currentPath: [...e.currentPath, "items", "items", "0"]
  }) || Ve(e), n = de(t.valueType._def, {
    ...e,
...
function Y4(t, e) {
  ...
  if (r.every((n) => n._def.typeName in Wt && (!n._def.checks || !n._def.checks.length))) {
    const n = r.reduce((s, a) => {
      const i = Wt[a._def.typeName];
...
const pn = (t, e) => {
  const r = (t.options instanceof Map ? Array.from(t.options.values()) : t.options).map((n, s) => de(n._def, {
    ...e,
...
function X4(t, e) {
  if (["ZodString", "ZodNumber", "ZodBigInt", "ZodBoolean", "ZodNull"].includes(t.innerType._def.typeName) && (!t.innerType._def.checks || !t.innerType._def.checks.length))
    return e.target === "openApi3" ? {
      type: Wt[t.innerType._def.typeName],
      nullable: !0
    } : {
      type: [
        Wt[t.innerType._def.typeName],
        "null"
      ]
    };
  if (e.target === "openApi3") {
...
function K4(t, e) {
  ...
  for (const n of t.checks)
    switch (n.kind) {
      case "int":
        r.type = "integer", lo(r, "type", n.message, e);
        break;
      case "min":
        e.target === "jsonSchema7" ? n.inclusive ? ue(r, "minimum", n.value, n.message, e) : ue(r, "exclusiveMinimum", n.value, n.message, e) : (n.inclusive || (r.exclusiveMinimum = !0), ue(r, "minimum", n.value, n.message, e));
        break;
...
function o6(t, e) {
  ...
  return t.minSize && ue(n, "minItems", t.minSize.value, t.minSize.message, e), t.maxSize && ue(n, "maxItems", t.maxSize.value, t.maxSize.message, e), n;
}
function s6(t, e) {
  return t.rest ? {
    type: "array",
    minItems: t.items.length,
    items: t.items.map((r, n) => de(r._def, {
      ...e,
...
const c6 = (t, e) => de(t.innerType._def, e), l6 = (t, e, r) => {
  switch (e) {
    case N.ZodString:
      return po(t, r);
    case N.ZodNumber:
...
function de(t, e, r = !1) {
  ...
  e.seen.set(t, s);
  const a = l6(t, t.typeName, e), i = typeof a == "function" ? de(a(), e) : a;
  if (i && u6(t, e, i), e.postProcess) {
...
const d6 = (t, e) => {
  switch (e.$refStrategy) {
    ...
    case "relative":
      return { $ref: uo(e.currentPath, t.path) };
    case "none":
    case "seen":
...
}, u6 = (t, e, r) => (t.description && (r.description = t.description, e.markdownDescription && (r.markdownDescription = t.description)), r), ct = (t, e) => {
  const r = T4(e);
  ...
  const s = typeof e == "string" ? e : e?.name, a = de(
    t._def,
    r,
    !1
  ) ?? Ve(r);
...
function mn(t) {
  ...
  for (; e; ) {
    ...
    if ("schema" in r && r.schema instanceof ie) {
      e = r.schema;
      continue;
    }
    if ("innerType" in r && r.innerType instanceof ie) {
      e = r.innerType;
      continue;
    }
    break;
...
function i3({
  ...
  const r = we(
    () => e?.map(go),
    [e]
  ), n = W(/* @__PURE__ */ new Map()), s = W(""), a = W(/* @__PURE__ */ new Map()), i = W(/* @__PURE__ */ new Set()), c = W(/* @__PURE__ */ new Map()), l = W(/* @__PURE__ */ new Map()), [d, u] = X([]), [h, w] = X(
    []
  ), [p, v] = X(
    null
  ), y = W(null), x = W({}), b = ee(() => {
    queueMicrotask(() => {
      const E = Array.from(n.current.entries()), z = [], H = [];
      let Y = null;
      for (const [me, O] of E) {
        const ne = O.ref.current;
        if (ne && (O.virtual ? H.push({
          formName: me,
          ...O.description ? { description: O.description } : {},
          ...O.module ? { module: O.module } : {},
          cardTitle: "",
          cardDescription: "",
          formSchema: ct(O.schema),
          fieldDescriptions: or(O.schema),
          sectionDescriptions: sr(O.sections),
          formValues: ne.getValues(),
          formErrors: ne.getErrors(),
          isDirty: ne.isDirty(),
          ...O.defaultValuesParamsSchema ? {
            defaultValuesParamsSchema: ct(
              O.defaultValuesParamsSchema
            )
          } : {},
          ...O.defaultValuesParams ? { defaultValuesParams: O.defaultValuesParams } : {}
        }) : z.push({
          formName: me,
          ...O.description ? { description: O.description } : {},
          ...O.module ? { module: O.module } : {},
          ...
          Y = {
            ...
            ...O.description ? { description: O.description } : {},
            ...O.module ? { module: O.module } : {},
            cardTitle: ce.cardTitle ?? "",
            cardDescription: ce.cardDescription ?? "",
            formSchema: ct(O.schema),
            fieldDescriptions: or(O.schema),
            sectionDescriptions: sr(O.sections),
            formValues: ne.getValues(),
      ...
      const he = JSON.stringify({
        formsOnCurrentPage: z,
        availableForms: H,
        activeForm: Y
      });
      he !== s.current && (s.current = he, u(z), w(H), v(Y));
    });
  }, []), V = ee(
    (E, z, H, Y, he, me, O, ne) => {
      const ce = n.current.get(E);
      n.current.set(E, {
        ref: z,
        schema: H,
        description: O,
        module: ne,
        sections: Y,
        defaultValuesParamsSchema: he ?? ce?.defaultValuesParamsSchema,
        defaultValuesFn: me ?? ce?.defaultValuesFn,
        defaultValuesParams: ce?.defaultValuesParams,
        onSubmit: ce?.onSubmit,
        steps: ce?.steps,
        submitConfig: ce?.submitConfig,
        errorTriggerMode: ce?.errorTriggerMode
      }), b();
    },
    [b]
  ), I = ee(
    (E) => {
      const z = n.current.get(E);
      if (z?.virtual) return;
      const H = z?.ref.current?.getValues() ?? {};
      n.current.delete(E);
      const Y = r?.find((he) => he.name === E);
      if (Y) {
        const me = { ...typeof Y.defaultValues == "function" ? {} : gn(Y.defaultValues), ...H }, { ref: O, dirtyFields: ne } = vn(
          Y.schema,
          me,
          Y.onSubmit
        ), ce = typeof Y.defaultValues == "function" ? (() => {
          const xe = Y.defaultValues;
          return async (S) => {
            const $ = xe(S);
        ...
        n.current.set(E, {
          ...
          defaultValuesFn: ce,
          defaultValuesParams: z?.defaultValuesParams,
          dirtyFields: ne,
          onSubmit: Y.onSubmit,
          steps: Y.steps,
    ...
    [b, r]
  ), T = ee((E) => n.current.get(E), []), g = ee(() => Array.from(n.current.keys()), []), C = ee(
    (E, z) => {
      ...
      return H.virtual ? (y.current = E, x.current = {
        cardTitle: z?.cardTitle ?? "",
        cardDescription: z?.cardDescription ?? ""
      }, b(), { success: !0 }) : {
        success: !1,
    ...
    y.current = null, x.current = { cardTitle: "", cardDescription: "" }, b();
  }, [b]), F = ee(
    (E, z) => {
      const H = n.current.get(E);
      H && (H.defaultValuesParams = z);
    },
    []
  ), _ = ee((E) => {
    const z = a.current.get(E) ?? 0;
    a.current.set(E, z + 1);
  }, []), M = ee((E) => {
    a.current.delete(E), i.current.delete(E), c.current.delete(E), l.current.delete(E);
  }, []), L = ee((E) => a.current.get(E) ?? 0, []), R = ee((E) => !i.current.has(E), []), D = ee((E) => {
    i.current.add(E);
  }, []), K = ee(
    (E, z) => {
      i.current.delete(E), c.current.set(E, z ?? null);
      const H = l.current.get(E);
      if (H?.length) {
        l.current.delete(E);
        for (const Y of H)
          Y();
    ...
    (E, z) => {
      const H = l.current.get(E) ?? [];
      H.push(z), l.current.set(E, H);
    },
    []
  ), te = ee(
    (E, z) => c.current.has(E) ? z === void 0 ? !0 : c.current.get(E) === z : !1,
    []
  ), oe = W(/* @__PURE__ */ new Set());
  fe(() => {
    const E = r ?? [], z = /* @__PURE__ */ new Set();
    for (const H of E) {
      z.add(H.name);
      const Y = n.current.get(H.name);
      if (Y && !Y.virtual || Y?.virtual) continue;
      const he = typeof H.defaultValues == "function" ? {} : gn(H.defaultValues), { ref: me, dirtyFields: O } = vn(
        H.schema,
        he,
        H.onSubmit
      ), ne = typeof H.defaultValues == "function" ? (() => {
        const ce = H.defaultValues;
        return async (xe) => {
          const S = ce(xe);
          return typeof S?.then == "function" ? await S : S;
        };
      })() : void 0;
      n.current.set(H.name, {
        ref: me,
        schema: H.schema,
        ...
        sections: H.sections,
        virtual: !0,
        defaultValuesParamsSchema: H.defaultValuesParamsSchema,
        defaultValuesFn: ne,
        dirtyFields: O,
        onSubmit: H.onSubmit,
        steps: H.steps,
        submitConfig: H.submitConfig,
        errorTriggerMode: H.errorTriggerMode
      });
    }
    for (const H of oe.current)
      z.has(H) || n.current.get(H)?.virtual && n.current.delete(H);
    return oe.current = z, b(), () => {
      for (const H of z)
        n.current.get(H)?.virtual && n.current.delete(H);
      b();
    };
  }, [r, b]);
  const Q = we(
  ...
  return /* @__PURE__ */ o(vo.Provider, { value: Q, children: t });
}
function h6() {
  return Ct(vo);
}
const p6 = ({
  ...
  return /* @__PURE__ */ f("div", { className: "flex shrink-0 items-center justify-between p-3", children: [
    /* @__PURE__ */ o("div", { className: "flex items-center gap-2", children: t && /* @__PURE__ */ f(Ue, { children: [
      /* @__PURE__ */ o(
        Ee,
        {
          label: u.ai.attachFile,
          hideLabel: !0,
          type: "button",
          icon: p1,
          variant: "outline",
          ...
          disabled: e,
          onClick: (h) => {
            h.preventDefault(), s.current?.click();
          }
        }
      ),
      /* @__PURE__ */ o(
  ...
  "div",
  {
    ...
    children: t.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ o(Ne, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ o(
        g6,
        {
          att: s,
          onRemove: r,
...
function g6({
  ...
  const n = /* @__PURE__ */ f("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ o(be, { icon: r1, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ o(
      "button",
      {
        ...
        onClick: () => e(t.id),
        children: /* @__PURE__ */ o(be, { icon: rt, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return t.errorMessage ? /* @__PURE__ */ o(oi, { label: t.errorMessage, children: n }) : n;
}
const v6 = {
  soft: {
    text: "",
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      className: G("flex flex-col rounded-xl", n.bg, n.formBorder),
      children: [
        /* @__PURE__ */ f("div", { className: "flex items-center justify-between gap-2 px-4 pb-1.5 pt-2", children: [
          /* @__PURE__ */ o(
            "p",
            {
              className: G("min-w-0 flex-1 text-sm font-medium", n.fontColor),
              children: n.text
            }
          ),
    ...
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (u, h) => /* @__PURE__ */ f(
        "div",
        {
          ...
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ o(Ne, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ o(
              Ne,
              {
                className: G("h-4 rounded", h === 1 ? "w-24" : "w-32")
              }
            )
          ]
        },
        ...
        return /* @__PURE__ */ f(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ o(Se, { className: "text-base font-medium text-f1-foreground", children: p }) })
            ]
          },
          String(u.id)
        );
...
const k6 = ({
  ...
  return /* @__PURE__ */ o("div", { className: "p-1", children: /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ o(be, { icon: $r, size: "md", color: "default" }) }),
        /* @__PURE__ */ o(
          Se,
          {
  ...
  const s = Oe(), [a, i] = X(""), [c, l] = X(0), [d, u] = X(!1), h = W(null), w = W(null), p = W(null), v = t[c] ?? e;
  return fe(() => {
    const y = () => {
    ...
    if (s)
      return u(!1), i(v), y(), h.current = setTimeout(() => {
        const g = (c + 1) % Math.max(t.length, 1);
        l(g);
      }, 4e3), () => {
        y();
      };
    u(!0), i("");
    let x = 0;
    const b = 50, V = 30, I = 2e3, T = 1e3;
    return w.current = setInterval(() => {
      x < v.length ? (i(v.slice(0, x + 1)), x++) : (w.current && (clearInterval(w.current), w.current = null), h.current = setTimeout(() => {
        p.current = setInterval(() => {
          x > 0 ? (x--, i(v.slice(0, x))) : (p.current && (clearInterval(p.current), p.current = null), h.current = setTimeout(() => {
            const g = (c + 1) % Math.max(t.length, 1);
            l(g);
          }, T));
        }, V);
    ...
    t.length,
    s
  ]), r.length > 0 || n ? null : /* @__PURE__ */ o(je, { children: /* @__PURE__ */ o(
    pe.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
  ...
  "div",
  {
    className: G("grid flex-1 grid-cols-1 grid-rows-1", "min-h-[20px] py-0"),
    children: [
      /* @__PURE__ */ o(
        "div",
        {
...
const M6 = ({
  ...
  const [n, s] = X(null), a = n !== null ? t[n] : null;
  return t.length === 0 ? null : /* @__PURE__ */ f(
    Rr,
    {
      ...
      children: [
        /* @__PURE__ */ o(ai, { asChild: !0, children: /* @__PURE__ */ o("div", { className: "flex w-full flex-wrap items-center gap-2", children: t.map((i, c) => /* @__PURE__ */ o(Vr, { asChild: !0, children: /* @__PURE__ */ o(
          Ee,
          {
            variant: "outline",
            label: i.label,
        ...
        a && /* @__PURE__ */ f(
          Tr,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "flex flex-col", children: L6(a.items).map((i, c) => /* @__PURE__ */ f(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ o(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ o(be, { icon: Mr, size: "sm" })
                      }
                    )
                  ]
                },
...
function S6(t, e) {
  ...
  return r.length === 0 ? t : t.filter(
    (n) => r.some((s) => _6(n.type, s))
  );
}
const R6 = 4e3;
function V6(t) {
  const [e, r] = X([]), [n, s] = X(null), a = W(
    null
  ), i = W(null), c = ge(), l = t?.onUploadFiles, d = t?.allowedMimeTypes, u = t?.maxFiles, h = we(() => {
    if (d)
      return Array.isArray(d) ? d.join(",") : d;
  }, [d]), w = u !== void 0 && e.length >= u, p = ee((V) => {
    a.current && clearTimeout(a.current), s(V), a.current = setTimeout(() => {
  ...
  const v = ee(
    async (V) => {
      if (V.length === 0 || !l) return;
      const I = S6(V, d);
      if (I.length === 0) return;
      if (u !== void 0 && e.length + I.length > u) {
        p(
      ...
      try {
        ...
        r(
          (C) => C.map((k) => {
            const F = T.findIndex((_) => _.id === k.id);
            return F === -1 ? k : g[F] ? {
              ...k,
              status: "uploaded",
              uploadedFile: g[F]
        ...
        const C = g instanceof Error && g.message ? g.message : c.ai.fileUploadError, k = T.map((F) => F.id);
        r(
          (F) => F.map(
            (_) => k.includes(_.id) ? { ..._, status: "error", errorMessage: C } : _
          )
        );
      }
    },
    ...
    async (V) => {
      await v(Array.from(V.target.files ?? [])), V.target.value = "";
    },
    [v]
  ), x = ee((V) => {
    r((I) => I.filter((T) => T.id !== V));
  }, []), b = ee(() => {
    r([]);
  }, []);
  return {
...
function P6({
  ...
  const [a, i] = X(!1), [c, l] = X(""), [d, u] = X([]), [h, w] = X(!1), [p, v] = X(0), [y, x] = X([]), b = W(-1), V = W(null), I = W(0), T = W(-1);
  fe(() => {
    if (!n) {
      i(!1);
      return;
    ...
    const L = T6(t, r, y);
    if (!L) {
      i(!1), l(""), u([]), v(0), b.current = -1, T.current = -1;
      return;
    }
    if (L.atIndex === T.current)
      return;
    b.current = L.atIndex, l(L.query), i(!0), v(0), w(!0), V.current && clearTimeout(V.current);
    const R = ++I.current;
    return V.current = setTimeout(() => {
      n(L.query).then((D) => {
        R === I.current && (u(D), v(0), D.length === 0 && L.query.length > 0 && (T.current = L.atIndex, i(!1)));
      }).catch(() => {
        R === I.current && u([]);
      }).finally(() => {
        R === I.current && w(!1);
  ...
  const g = ee(() => {
    i(!1), l(""), u([]), v(0), b.current = -1;
  }, []), C = ee(
    (L) => {
      const R = b.current;
      if (R === -1) return;
      const D = `${L.firstName} ${L.lastName}`.trim(), K = String(L.id), J = t.slice(0, R), te = t.slice(r), oe = `@${D} `, Q = J + oe + te, E = J.length + oe.length;
      e(Q), x((z) => [...z.filter((Y) => !(Y.id === K && Y.name === D)), { id: K, name: D }]), g(), requestAnimationFrame(() => {
        const z = s.current;
        z && (z.focus(), z.setSelectionRange(E, E));
      });
    },
    [t, r, e, s, g]
  ), k = ee(
    (L) => {
      if (!a) return !1;
      if (L.key === "Escape")
        return L.preventDefault(), g(), !0;
      if (d.length === 0) return !1;
      switch (L.key) {
        case "ArrowDown":
          return L.preventDefault(), v((R) => (R + 1) % d.length), !0;
        case "ArrowUp":
          return L.preventDefault(), v(
            (R) => (R + d.length - 1) % d.length
          ), !0;
        case "Tab": {
          const R = d[p];
          if (R) {
            const D = `${R.firstName} ${R.lastName}`.trim();
            if (c.length === 0 || D.toLowerCase().startsWith(c.toLowerCase()))
              return L.preventDefault(), C(R), !0;
          }
          return !1;
        }
        case "Enter":
    ...
    (L) => {
      ...
      let R = L;
      const D = [...y].sort((K, J) => J.name.length - K.name.length);
      for (const K of D) {
        const J = `@${K.name}`, te = `<entity-ref type="person" id="${Cn(K.id)}">${Cn(K.name)}</entity-ref>`;
        for (; R.includes(J); )
          R = R.replace(J, te);
      }
      return R;
  ...
  fe(() => {
    x(
      (L) => L.filter((R) => {
        const D = `@${R.name}`, K = t.indexOf(D);
        if (K === -1) return !1;
        const J = t[K + D.length];
        return J === " " || J === `
` || J === "	";
      })
    );
  ...
  const _ = we(() => {
    ...
    const L = s.current;
    if (!L) return null;
    const R = N6(L, b.current), D = L.offsetLeft + R.left, J = (L.offsetParent ? L.offsetParent.offsetHeight : 0) - (L.offsetTop + R.top);
    ...
    return c.length === 0 ? R : R.toLowerCase().startsWith(c.toLowerCase()) ? R.slice(c.length) : null;
  }, [a, d, p, c]);
  return {
    isOpen: a,
    query: c,
...
const $6 = /[\\`*_{}[\]()#+\-.!|~>]/g, H6 = (t) => t.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((e, r) => r % 2 === 1 ? e : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace($6, "\\$&")).join(""), c3 = ({
  onSubmit: t,
  onStop: e,
  inProgress: r,
  onBeforeSubmit: n,
  ...
  const g = ge(), C = Oe(), [k, F] = X(""), [_, M] = X(0), [L, R] = X(!1), [D, K] = X(null), J = W(null), te = W(null), oe = W(null), Q = i != null, { tracking: E } = Ar(), z = ee(
    (Ce, Ge) => {
      E?.onWelcomeSuggestionClick?.({
        item: Ce,
        group: Ge,
  ...
  fe(() => {
    typeof window < "u" && window.location.hash.length === 0 && te.current?.focus();
  }, []), fe(() => {
    if (p)
      return p((Ce) => {
        ce(Ce);
  ...
  const B = g.ai.inputPlaceholder, se = H.filter((Ce) => Ce.status === "uploaded"), ve = H.some((Ce) => Ce.status === "uploading"), ye = k.trim().length > 0, Re = async (Ce) => {
    if (Ce.preventDefault(), !Q) {
      if (Z.close(), r)
        e?.();
      else if (ye && !ve && !L) {
        if (n) {
        ...
        const Ge = Z.transformMentions(k.trim()), Nt = H6(Ge), Jt = se.flatMap(
          (wt) => wt.uploadedFile ? [wt.uploadedFile] : []
        ), Ft = c, Pt = d;
        Ft && l?.(null), Pt && u?.(null), await t({
          text: Nt,
          files: Jt,
          context: Ft,
          quote: Pt
    ...
    Q || Z.handleKeyDown(Ce) || Ce.key === "Enter" && !Ce.shiftKey && (Ce.preventDefault(), r || J.current?.requestSubmit());
  }, ot = () => {
    M(te.current?.selectionStart ?? 0);
  }, st = () => {
    oe.current && te.current && (oe.current.scrollTop = te.current.scrollTop);
  }, We = D ? D.prompt ?? D.title : null, At = We ? [We] : s ?? [], Xt = At.length > 1, Kt = we(() => E6(k, Z.mentions, {
    cursorPosition: _,
    inlineCompletion: Z.inlineCompletion
  }), [k, Z.mentions, _, Z.inlineCompletion]), Qt = Z.mentions.length > 0 || Z.inlineCompletion !== null;
  return /* @__PURE__ */ f("div", { ref: T, className: "flex flex-col items-center gap-2 px-4 pb-3 pt-2", children: [
    /* @__PURE__ */ f("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
      ...
      /* @__PURE__ */ o(C6, { creditWarning: a, children: /* @__PURE__ */ f(
        pe.form,
        {
          "aria-busy": r,
          ref: J,
          ...
          children: [
            /* @__PURE__ */ o(
              w6,
              {
                ...
                position: Z.popoverPosition,
                onSelect: Z.selectPerson
              }
            ),
            /* @__PURE__ */ o(je, { initial: !1, children: Q ? /* @__PURE__ */ o("div", { children: i }, "clarifying") : /* @__PURE__ */ f(
              pe.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ o(je, { initial: !1, children: P && /* @__PURE__ */ o(
                    pe.div,
                    {
                      role: "alert",
                      "aria-live": "polite",
                      ...
                      children: /* @__PURE__ */ f(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ o("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ o(ii, { type: "critical", size: "sm" }) }),
                            /* @__PURE__ */ o("p", { className: "font-medium text-f1-foreground-critical", children: P })
                          ]
                        }
                      )
                    },
                  ...
                  /* @__PURE__ */ o(
                    y6,
                    {
                      ...
                      onCursorUpdate: ot,
                      onScroll: st,
                      highlightSegments: Kt,
                      hasOverlay: Qt,
                      multiplePlaceholders: Xt,
                      placeholders: At,
                      resolvedDefaultPlaceholder: B,
                      inProgress: r
                    }
                  ),
                  /* @__PURE__ */ o(
    ...
    /* @__PURE__ */ o(je, { mode: "wait", initial: !1, children: Q ? /* @__PURE__ */ f(
      pe.div,
      {
      ...
      pe.div,
      {
        ...
        transition: { duration: 0.15, ease: "easeOut" },
        children: [
          /* @__PURE__ */ o(Se, { className: "text-sm font-medium text-f1-foreground-tertiary", children: v.text }),
          v.link && v.linkText && /* @__PURE__ */ o(
            ci,
            {
              href: v.link,
              target: "_blank",
    ...
    /* @__PURE__ */ o(je, { children: y && x && /* @__PURE__ */ o(
      pe.div,
      {
        className: G(
...
}, Co = zo.forwardRef(({ animate: t = "normal", ...e }, r) => /* @__PURE__ */ f(
  "svg",
  {
    ref: r,
    viewBox: "0 0 24 24",
...
Co.displayName = "CheckCircleLineAnimated";
const wo = 60, ko = 40, wn = 2e3, D6 = 500, B6 = 12e3, xo = 2, Lt = 40, lt = [255, 60, 0], ar = [160, 140, 220], ir = { x: -12, y: 0, z: 0 }, cr = { x: -12, y: 12, z: 90 }, ut = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, lr = Math.PI / 180, U6 = xo / 8 * Math.PI, z6 = 4 * Math.PI;
function Gt(t, e) {
  return [
...
function yo(t, e, r) {
  const n = Mt(1, 0, 0, t * lr), s = Mt(0, 1, 0, e * lr), a = Mt(0, 0, 1, r * lr);
  return W6(Gt(Gt(s, n), a));
}
function G6(t) {
...
const Et = 256, q6 = (() => {
  ...
  for (let e = 0; e < Et; e++) {
    const r = e / (Et - 1), n = Math.round(lt[0] + (ar[0] - lt[0]) * r), s = Math.round(lt[1] + (ar[1] - lt[1]) * r), a = Math.round(lt[2] + (ar[2] - lt[2]) * r);
    t[e] = `rgb(${n},${s},${a})`;
  }
  return t;
})();
function Y6(t) {
  const e = t <= 0 ? 0 : t >= 1 ? Et - 1 : t * (Et - 1) | 0;
  return q6[e];
}
const X6 = Object.keys(ut).map(Number).sort((t, e) => t - e);
function K6(t) {
  const e = X6;
  if (t <= e[0]) return ut[e[0]];
  if (t >= e[e.length - 1])
    return ut[e[e.length - 1]];
  for (let r = 0; r < e.length - 1; r++)
    if (t >= e[r] && t <= e[r + 1]) {
      const n = (t - e[r]) / (e[r + 1] - e[r]);
      return ut[e[r]] + (ut[e[r + 1]] - ut[e[r]]) * n;
    }
  return 0.72;
}
const xn = Math.sqrt(wo ** 2 + ko ** 2), dr = [wo / xn, ko / xn, 0], Q6 = yo(ir.x, ir.y, ir.z), J6 = yo(cr.x, cr.y, cr.z), ft = xo * 3, jt = Lt + 1, yn = (ft + 1) * jt, qt = 4 * ft * Lt, ur = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
], eu = (t, e) => t.avgZ - e.avgZ;
function tu() {
  const t = new Array(qt);
  for (let r = 0; r < qt; r++)
    t[r] = { points: "", color: "", avgZ: 1 / 0 };
  const e = new Array(yn);
  for (let r = 0; r < yn; r++)
    e[r] = { x: 0, y: 0, z: 0, t: 0 };
  return { quads: t, grid: e };
}
function bn(t, e, r, n) {
  const { quads: s, grid: a } = t, i = r * 0.392, c = r / 2, l = r / 2, d = U6 * K6(r), u = e * z6, h = Mt(0, 0, 1, n * 2 * Math.PI);
  kn(h, dr[0], dr[1], dr[2], Ye);
  const w = Mt(Ye[0], Ye[1], Ye[2], u), p = Gt(w, Q6), v = Gt(w, J6);
  ur[0] = p, ur[1] = v;
  let y = 0;
  for (let x = 0; x < 4; x++) {
    const b = ur[x >> 1], V = x & 1 ? -1 : 1;
    for (let I = 0; I <= ft; I++) {
      const T = V * (Math.PI / 2 - I / ft * d), g = Math.cos(T), C = Math.sin(T), k = Math.sin(I / ft * Math.PI), F = I * jt;
      for (let _ = 0; _ <= Lt; _++) {
        const M = _ / Lt * Math.PI * 2;
        kn(b, g * Math.cos(M), C, g * Math.sin(M), Ye);
        const L = a[F + _];
        L.x = Ye[0], L.y = Ye[1], L.z = Ye[2], L.t = k;
      }
    }
    for (let I = 0; I < ft; I++) {
      const T = I * jt, g = (I + 1) * jt;
      for (let C = 0; C < Lt; C++) {
        const k = a[T + C], F = a[T + C + 1], _ = a[g + C], M = a[g + C + 1];
        if ((k.t + F.t + _.t + M.t) * 0.25 < 1e-3) continue;
        const R = (k.x + F.x + _.x + M.x) * 0.25, D = (k.y + F.y + _.y + M.y) * 0.25, K = (k.z + F.z + _.z + M.z) * 0.25, J = R * i, te = D * i, oe = k.x * i - J, Q = k.y * i - te, E = Math.sqrt(oe * oe + Q * Q), z = E > 0 ? (E + 0.9) / E : 1, H = c + J + oe * z, Y = l - te - Q * z, he = F.x * i - J, me = F.y * i - te, O = Math.sqrt(he * he + me * me), ne = O > 0 ? (O + 0.9) / O : 1, ce = c + J + he * ne, xe = l - te - me * ne, S = M.x * i - J, $ = M.y * i - te, P = Math.sqrt(S * S + $ * $), Z = P > 0 ? (P + 0.9) / P : 1, B = c + J + S * Z, se = l - te - $ * Z, ve = _.x * i - J, ye = _.y * i - te, Re = Math.sqrt(ve * ve + ye * ye), Ie = Re > 0 ? (Re + 0.9) / Re : 1, ot = c + J + ve * Ie, st = l - te - ye * Ie, We = s[y];
        We.points = `${H},${Y} ${ce},${xe} ${B},${se} ${ot},${st}`, We.color = Y6((R + 1) * 0.5), We.avgZ = K, y++;
      }
    }
  }
  for (let x = y; x < qt; x++)
...
const ru = ({ size: t = 20, className: e, style: r, variant: n = "default" }, s) => {
  const a = W(null), i = W(null), c = W(null);
  c.current === null && (c.current = tu());
  const l = we(() => new Array(qt).fill(0), []), d = (u) => {
  ...
  return fe(() => {
    ...
    let v = null, y = 0, x = 0, b = 0, V = null, I = "spin", T = !0, g = !1;
    const C = (L) => {
      const R = p.quads;
      for (let D = 0; D < w.length; D++) {
        ...
        if (D < L) {
          const J = R[D];
          K.setAttribute("points", J.points), K.setAttribute("fill", J.color), K.hasAttribute("display") && K.removeAttribute("display");
        } else K.hasAttribute("display") || K.setAttribute("display", "none");
      }
    }, k = (L) => {
      g || (y = L, x = L, g = !0);
      let R = 0, D = !0;
      if (n === "continuous") {
        const oe = wn * 2, Q = (L - y) % oe / oe;
        R = Q < 0.5 ? Q * 2 : (1 - Q) * 2, D = !1;
      } else I === "spin" ? (R = Math.min((L - y) / wn, 1), R >= 1 && (R = 0, I = "pause", b = L)) : (R = 0, L - b >= D6 && (I = "spin", y = L));
      const K = (L - x) / B6 % 1, J = D ? G6(R) : R, te = bn(p, J, t, K);
      C(te), v = requestAnimationFrame(k);
    }, F = () => {
      v === null && (v = requestAnimationFrame(k));
    }, _ = () => {
      v !== null && (cancelAnimationFrame(v), v = null);
    };
    C(bn(p, 0, t, 0));
    let M = null;
    return typeof IntersectionObserver < "u" && (M = new IntersectionObserver(
      (L) => {
        const R = L[0]?.isIntersecting ?? !0;
        if (R !== T)
          if (T = R, R) {
            if (V !== null && g) {
              const D = performance.now() - V;
              y += D, x += D, b += D;
            }
            V = null, F();
          } else
    ...
    "div",
    {
      ...
      role: "progressbar",
      "aria-label": "Loading",
      className: G("shrink-0 globe-spin-anim", e),
...
bo.displayName = "ChatSpinner";
const Ln = {
  initial: { opacity: 0 },
  animate: { opacity: 1 },
  exit: { opacity: 0 }
}, Lr = ({ title: t, status: e, inGroup: r }) => {
  const s = {
    duration: Oe() ? 0 : 0.18,
    ease: [0.33, 1, 0.68, 1]
  ...
  return /* @__PURE__ */ f("div", { className: "flex w-full items-start gap-1 text-f1-foreground-secondary", children: [
    /* @__PURE__ */ o("div", { className: "flex h-5 w-6 shrink-0 items-center justify-start", children: /* @__PURE__ */ f(je, { mode: "wait", children: [
      a && /* @__PURE__ */ o(
        pe.div,
        {
      ...
      (i || l) && /* @__PURE__ */ o("div", { className: "flex h-5 w-5 shrink-0 items-center justify-center", children: /* @__PURE__ */ o(bo, { variant: i ? "default" : "continuous" }) }),
      c && /* @__PURE__ */ o(
        pe.div,
        {
          ...Ln,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ f("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          !!t && /* @__PURE__ */ o(y1, { module: t, size: "lg" }),
          /* @__PURE__ */ f("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ o(Se, { className: "text-lg font-semibold text-f1-foreground", children: e }),
            /* @__PURE__ */ o(Se, { className: "text-base text-f1-foreground-secondary", children: r })
          ] }),
          s && /* @__PURE__ */ o(
            _e,
            {
              variant: "neutral",
              size: "md",
              label: i ? l.actions.close : l.ai.reportCard.openButton,
              onClick: i ? a : n
            }
          )
        ] }),
...
Lo.displayName = "F0CanvasCard";
const Ir = Tt(null);
function d3({
  children: t
}) {
  const [e, r] = X(0), n = W([]), s = ee(
    (i) => {
  ...
  return /* @__PURE__ */ o(Ir.Provider, { value: a, children: t });
}
function nu(t) {
  const r = Ct(Ir)?.formatters;
  return we(() => !r || r.length === 0 ? null : (n, s, a) => {
    let i, c = -1;
    for (const l of r) {
...
const Mn = 7, ou = 625, En = /* @__PURE__ */ new Set();
function su(t) {
...
function iu(t) {
  const { days: e, hours: r, minutes: n, seconds: s } = t4(t), a = [];
...
function Mo(t, e) {
  ...
  if (e === "duration" && typeof t == "number")
    return { type: "item", text: iu(t) };
  if (e === "richtext" && typeof t == "object" && t !== null && "value" in t) {
    const r = t.value;
    return { type: "item", text: (r ? su(r) : "") || "—" };
  }
  if (e === "daterange" && typeof t == "object" && t !== null && "from" in t && "to" in t) {
    const { from: r, to: n } = t, s = _n(r) ? Sn(r) : String(r), a = _n(n) ? Sn(n) : String(n);
  ...
  if (Array.isArray(t))
    return { type: "item", text: t.map((n) => {
      const s = Mo(n);
      return Array.isArray(s) ? s.map(Rn).join(", ") : Rn(s);
    }).filter(Boolean).join(", ") || "—" };
  ...
  return { type: "item", text: au(String(t)) };
}
function Eo({
  formName: t,
  formDescription: e,
  ...
  const { canvasContent: l, openCanvas: d, closeCanvas: u } = Ar(), h = nu(t), w = c ?? h, p = W(() => {
  }), v = n ?? t, y = s ?? e ?? "", x = l?.type === "form" && l.formName === t, b = () => d({
    type: "form",
    title: v,
    description: y,
    formName: t,
  ...
  p.current = b, fe(() => {
    typeof window > "u" || window.innerWidth < ou || En.has(t) || (En.add(t), p.current());
  }, [t]);
  const V = a && i ? Object.entries(a).map(([g, C]) => {
    const k = i[g], F = w?.(g, k, {
      fieldType: C.fieldType,
      customFieldName: C.customFieldName
    });
    if (!F && C.fieldType === "custom" && typeof k == "object" && k !== null)
      return null;
    const _ = F ?? Mo(k, C.fieldType), M = ["richtext", "textarea"];
    return {
      label: C.label,
      content: _,
    ...
    if (!g) return !1;
    const C = Array.isArray(g.content) ? g.content[0] : g.content;
    return !(C?.type === "item" && C.text === "—");
  }) : [], I = V.slice(0, Mn), T = V.length > Mn;
  return /* @__PURE__ */ o(
    Lo,
    {
      module: r,
      ...
      onOpen: b,
      showOpenButton: x,
      children: I.length > 0 && !x && /* @__PURE__ */ o("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ o(
        li,
        {
          details: I.map((g) => ({
            title: g.label,
            content: g.content,
            ...g.verticalLayout && { verticalLayout: !0 }
          })),
          showSeeMore: T,
          onClickSeeMore: b,
          tableView: !0
...
Eo.displayName = "FormCard";
function cu() {
  const t = h6(), e = t?.activeForm;
  if (!e) return null;
...
const Vn = 8, yt = 8;
function So({ anchor: t, onReply: e }) {
  const r = ge(), n = W(null), [s, a] = X(
    null
  );
  if (Qn(() => {
    if (!t) {
    ...
    let w = t.rect.top - d - Vn;
    w < yt && (w = t.rect.bottom + Vn), w = Math.min(
      Math.max(w, yt),
      h - d - yt
    );
    const p = t.rect.left + t.rect.width / 2 - l / 2, v = Math.min(
      Math.max(p, yt),
      u - l - yt
    );
    a({ top: w, left: v });
...
const Ro = Tt(void 0), f3 = () => Ct(Ro), uu = (t) => /* @__PURE__ */ o(b1, { content: t, format: "markdown" }), fu = ({
  isGenerating: t,
  isLoading: e,
  message: r,
  renderToolCall: n,
  ...
  const c = typeof r?.content == "string" ? r.content : "", l = (r && n?.(r)) ?? r?.generativeUI?.() ?? null, d = r?.toolCalls?.[0]?.id, u = !c && !l, h = W(null), { anchor: w, clear: p } = _o({
    containerRef: h,
    enabled: !!(r?.id && c)
  });
  return fe(() => {
    r?.id && !e && !t && a?.(r);
  }, [r, e, t, a]), !e && !t && u ? null : /* @__PURE__ */ o(Ro.Provider, { value: d, children: /* @__PURE__ */ f("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    r && c && /* @__PURE__ */ o(
      "div",
      {
        ref: h,
  ...
  const [s, a] = X(""), i = ge(), { title: c, label: l, placeholder: d } = r === "like" ? i.ai.feedbackModal.positive : i.ai.feedbackModal.negative, u = ee(() => {
    e(n, s);
  }, [s, n, e]), h = () => {
    t(n);
  };
...
}, Vo = Tt(null), pu = ({ children: t }) => {
  const [e, r] = X(null), n = e ? {
    isOpen: !0,
  ...
  return /* @__PURE__ */ o(Vo.Provider, { value: n, children: t });
}, To = () => {
  const t = Ct(Vo);
  if (t === null)
    throw new Error(
...
const gu = ({
  ...
  const n = ge(), { open: s } = To(), [a, i] = X(null);
  ...
  const [c, l] = X(s), d = Oe(), u = n !== void 0, h = u ? n : c;
  return /* @__PURE__ */ f(
    L1,
    {
        ...
        /* @__PURE__ */ f(
          M1,
          {
            ...
            children: [
              ...
              !i && /* @__PURE__ */ o(be, { icon: Yt })
            ]
          }
        ),
        /* @__PURE__ */ o(E1, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ o(
          pe.div,
          {
            initial: !1,
            animate: {
...
const Ao = (t) => /* @__PURE__ */ o(b1, { content: t, format: "markdown" }), xu = ({
  text: t,
  renderMarkdown: e
}) => /* @__PURE__ */ f("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ o("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ o(be, { icon: $r }) }),
  /* @__PURE__ */ o("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (e ?? Ao)(t) })
] }), yu = ({
  message: t,
  onReplyQuote: e,
  ...
  const s = W(null), a = W(null);
  fe(() => {
    !s.current || !r || s.current.scrollIntoView({
      behavior: "smooth"
    });
  }, [r]);
  const i = t.rawData, c = ku(
    t?.content,
    i
  ), l = (wu(t?.content) ?? "").trim(), d = t?.replyQuote ?? null, u = l.length > 0, { anchor: h, clear: w } = _o({
    containerRef: a,
    enabled: u
  });
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        d && /* @__PURE__ */ o(xu, { text: d, renderMarkdown: n }),
        c.length > 0 && /* @__PURE__ */ o("div", { className: "flex max-w-[90%] flex-wrap justify-end gap-1.5", children: c.map((p, v) => /* @__PURE__ */ o(
          x1,
          {
...
}, bu = 35, Lu = 22, Mu = 400, Eu = 2500, _u = 220, Su = ({ messages: t, onClick: e }) => {
  const [r, n] = X(0), [s, a] = X(0), [i, c] = X("starting"), l = t[r] ?? "";
  fe(() => {
    t.length > 0 && r >= t.length && (n(0), a(0), c("starting"));
  }, [t.length, r]), fe(() => {
    let h;
    if (i === "starting")
      h = setTimeout(() => c("writing"), Mu);
    else if (i === "writing")
      s < l.length ? h = setTimeout(() => a((w) => w + 1), bu) : c("holding");
    else if (i === "holding") {
      if (t.length <= 1) return;
      h = setTimeout(() => c("erasing"), Eu);
    } else i === "erasing" && (s > 0 ? h = setTimeout(() => a((w) => w - 1), Lu) : h = setTimeout(() => {
      n((w) => (w + 1) % t.length), c("starting");
    }, _u));
    return () => {
      h && clearTimeout(h);
    };
...
function Ru({
  ...
  const [i, c] = X(0), [l, d] = X(!1), u = W(s), h = W(a);
  h.current = a;
  const w = ee(
    (v = "smooth") => {
  ...
  fe(() => {
    const v = t.current, y = e.current;
    if (!v || !y) return;
    const x = new ResizeObserver(() => {
      if (h.current) return;
      const b = parseFloat(getComputedStyle(y).paddingTop) + parseFloat(getComputedStyle(y).paddingBottom) + 1;
      c(v.clientHeight - b);
    });
    return x.observe(v), x.observe(y), () => x.disconnect();
  }, [t, e]);
  const p = ee(() => {
    const v = t.current;
    if (!v) return;
    const { scrollTop: y, scrollHeight: x, clientHeight: b } = v, V = x - y - b;
    d(V > b);
  }, [t]);
  return fe(() => {
    const v = t.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const v = t.current, y = n.current;
        if (!v || !y) return;
        const x = v.getBoundingClientRect(), b = y.getBoundingClientRect(), V = v.scrollTop + (b.top - x.top);
        v.scrollTo({ top: V, behavior: "smooth" });
      });
    }), s === 0 && d(!1), u.current = s;
  }, [s, n, t]), { showScrollBtn: l, turnMinHeight: i, scrollToBottom: w };
}
const Vu = {
  threadId: "",
  onThumbsUp: () => {
...
}, h3 = (t) => /* @__PURE__ */ o(pu, { children: /* @__PURE__ */ o(Tu, { ...t }) }), Tu = ({
  turns: t,
  isLoadingThread: e = !1,
  interrupt: r,
  initialMessage: n,
  ...
  const { modal: V, handleSubmit: I, handleClose: T } = mu(
    u ?? Vu
  ), g = ge(), C = v ?? fu, k = y ?? yu, F = we(() => {
    const E = n ?? g.ai.defaultInitialMessage;
    return (Array.isArray(E) ? E : [E]).filter((H) => typeof H == "string" && H.length > 0);
  }, [n, g.ai.defaultInitialMessage]), _ = !e && t.length === 0 && F.length > 0, M = W(null), L = W(null), R = W(null), D = W(null), K = W(null), { showScrollBtn: J, turnMinHeight: te, scrollToBottom: oe } = Ru({
    viewportRef: M,
    contentRef: L,
    endRef: R,
    lastTurnRef: K,
    ...
    const H = z === t.length - 1, Y = {
      ...
      const ce = H && ne === E.assistantMessages.length - 1, xe = E.userMessages.length + ne, S = {
        message: O,
        inProgress: E.isInProgress,
        index: xe,
        isCurrentMessage: ce,
      ...
      return /* @__PURE__ */ o(
        ...
        {
          ...S,
          isGenerating: E.isInProgress && ce,
          isLoading: E.isInProgress && ce && !O.content
        },
        `${z}-a-${ne}`
      );
    };
    return /* @__PURE__ */ f(
      "div",
      {
        ...
        children: [
          ...
          E.endIndicator === "thinking" && /* @__PURE__ */ o(Lr, { title: g.ai.thinking, status: "executing" }),
          E.endIndicator === "activity" && /* @__PURE__ */ o(Lr, { status: "writing" }),
  ...
  return /* @__PURE__ */ f(Ue, { children: [
    /* @__PURE__ */ f("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
      /* @__PURE__ */ o(
        "div",
        {
          ...
          children: /* @__PURE__ */ f(
            ...
            {
              ref: L,
              className: G("flex h-full flex-col items-center p-4"),
              children: [
                /* @__PURE__ */ f(
                  "div",
                  {
                ...
                /* @__PURE__ */ o(je, { children: J && /* @__PURE__ */ o(
                  pe.div,
                  {
      ...
      !w && !_ && /* @__PURE__ */ f(Ue, { children: [
        /* @__PURE__ */ o(Tn, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ o(Tn, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    V.isOpen && /* @__PURE__ */ o(
      hu,
...
}, Au = () => /* @__PURE__ */ o("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ f("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ o("div", { className: "flex justify-end", children: /* @__PURE__ */ o(Ne, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ o(Ne, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ o(Ne, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ o(Ne, { className: "h-5 w-4/5 rounded-md" })
] }) }), p3 = {
  ai: Ri.ai
}, No = Tt(null);
function m3({
  ...
  return /* @__PURE__ */ o(No.Provider, { value: e, children: t });
}
function g3() {
  const t = Ct(No);
  if (t === null)
...
const Fu = ({
  ...
  const w = ge().ai.clarifyingQuestion.typeYourAnswer, p = t === "single" ? /* @__PURE__ */ o(Fo, { isSelected: r && !e }) : /* @__PURE__ */ o(
    _1,
    {
      checked: s,
      onCheckedChange: () => d(!s),
...
const $u = ({
  ...
  const b = (() => {
    ...
    const C = r.findIndex((k) => n.includes(k.id));
    return C >= 0 ? C : 0;
  })(), [V, I] = X(b), T = W([]);
  fe(() => {
    h && t === "single" && T.current[V]?.focus();
  }, []);
  const g = (C) => {
    if (t !== "single") return;
    const k = r.length - 1;
    ...
    C.preventDefault(), I(F), T.current[F]?.focus();
  };
  return /* @__PURE__ */ f(
    "div",
    {
  ...
  return /* @__PURE__ */ o(
    pe.div,
    {
      ...
      className: "overflow-hidden",
      children: /* @__PURE__ */ o(Iu, { clarifyingQuestion: t })
    }
  );
}, Iu = ({
  clarifyingQuestion: t
  ...
  } = n, C = W(null), k = b ?? "single", F = a > 1, _ = s === 0, M = s === a - 1, L = F ? e.t("ai.clarifyingQuestion.stepOf", {
    current: String(s + 1),
    total: String(a)
  }) : void 0, R = x.length > 0, D = (T ?? "").trim().length > 0, K = R || g && D || V === !0, J = (H) => {
    const Y = k === "single" && x.includes(H);
    i(H), k === "single" && !M && !Y && Promise.resolve().then(c);
  }, te = M ? e.ai.clarifyingQuestion.submit : e.ai.clarifyingQuestion.next, oe = V === !0 && !R && !(g && D), Q = () => {
  ...
  return /* @__PURE__ */ f("div", { className: "flex flex-col", onKeyDown: E, children: [
    /* @__PURE__ */ o("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ o(je, { mode: "wait", initial: !1, children: /* @__PURE__ */ f(
      pe.div,
      {
...
function An(t, e, r, n) {
  const s = Math.max(1, Math.min(t, e)), a = Math.min(r, 20), c = Math.min(a + n, s), l = Math.min(c, Math.floor(t / 2)), d = Math.min(c, Math.floor(e / 2)), u = (Y) => Y / t * 2 - 1, h = (Y) => Y / e * 2 - 1, w = 0, p = t, v = 0, y = e, x = l, b = t - l, V = d, I = e - d, T = u(w), g = u(p), C = h(v), k = h(y), F = u(x), _ = u(b), M = h(V), L = h(I), R = 0, D = 0, K = 1, J = 1, te = l / t, oe = 1 - l / t, Q = d / e, E = 1 - d / e, z = new Float32Array([
    // Top strip
    T,
    C,
    g,
...
function ju(t, e, r) {
  const n = Nn(t, t.VERTEX_SHADER, e), s = Nn(t, t.FRAGMENT_SHADER, r), a = t.createProgram();
...
class w3 {
  ...
  resize(e, r, n) {
    ...
    const { gl: s, program: a, vao: i, positionBuffer: c, uvBuffer: l, uResolution: d } = this.glr, u = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, h = Math.max(1, Math.floor(e * u)), w = Math.max(1, Math.floor(r * u));
    ...
    s.enableVertexAttribArray(y), s.vertexAttribPointer(y, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, l), s.bufferData(s.ARRAY_BUFFER, v, s.STATIC_DRAW);
    const x = s.getAttribLocation(a, "aUV");
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, a = this.canvas.height || 2, { positions: i, uvs: c } = An(
      s,
      a,
    ...
    const w = e.getUniformLocation(r, "uResolution"), p = e.getUniformLocation(r, "uTime"), v = e.getUniformLocation(r, "uBorderWidth"), y = e.getUniformLocation(r, "uGlowWidth"), x = e.getUniformLocation(r, "uBorderRadius"), b = e.getUniformLocation(r, "uColors"), V = e.getUniformLocation(r, "uGlowExponent"), I = e.getUniformLocation(r, "uGlowFactor");
    e.useProgram(r), e.uniform1f(v, this.options.borderWidth), e.uniform1f(y, this.options.glowWidth), e.uniform1f(x, this.options.borderRadius), this.options.mode === "dark" ? (e.uniform1f(V, 2), e.uniform1f(I, 1.8)) : (e.uniform1f(V, 1), e.uniform1f(I, 1));
    const T = (this.options.colors || Du).map(Bu);
    for (let g = 0; g < T.length; g++)
      e.uniform3f(
        e.getUniformLocation(r, `uColors[${g}]`),
        ...T[g]
      );
...
const Fn = ["lowp", "mediump", "highp"], Uu = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, zu = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
    vec2 uv = fragCoord/iResolution.xy;
    vec3 col = 0.5 + 0.5*cos(iTime+uv.xyx+vec3(0,2,4));
    fragColor = vec4(col,1.0);
}`, Pn = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, $n = "iTime", Hn = "iTimeDelta", In = "iDate", jn = "iFrame", Zn = "iMouse", On = "iResolution", Wu = "iChannel", Dn = "iChannelResolution", Bn = "iDeviceOrientation";
function Gu(t, e) {
...
}, fr = 9729, Un = 9728, Qu = 9987, zn = 33071, Wn = 10497;
class Ju {
  gl;
  url;
  wrapS;
  ...
  load = async (e) => {
    ...
    const h = 0, w = r.RGBA, p = 1, v = 1, y = 0, x = r.RGBA, b = r.UNSIGNED_BYTE, V = new Uint8Array([255, 255, 255, 0]), I = r.createTexture();
    if (r.bindTexture(r.TEXTURE_2D, I), r.texImage2D(
      ...
      const k = this.setupVideo(n);
      return r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_S, r.CLAMP_TO_EDGE), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_T, r.CLAMP_TO_EDGE), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MIN_FILTER, r.LINEAR), this._webglTexture = I, this.source = k, this.isVideo = !0, k.play().then(() => this);
    }
    async function T() {
      return new Promise((k, F) => {
        ...
        _.crossOrigin = "anonymous", _.onload = () => {
          ...
          F(new Error(Be(`failed loading url: ${n}`)));
        }, _.src = n ?? "";
      });
    }
    let g = await T(), C = (g.width & g.width - 1) === 0 && (g.height & g.height - 1) === 0;
    return (e.wrapS !== zn || e.wrapT !== zn || e.minFilter !== Un && e.minFilter !== fr) && !C && (g = this.makePowerOf2(g), C = !0), r.bindTexture(r.TEXTURE_2D, I), r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL, l), r.texImage2D(
      r.TEXTURE_2D,
      h,
      w,
      x,
      b,
      g
    ), C && e.minFilter !== Un && e.minFilter !== fr && r.generateMipmap(r.TEXTURE_2D), r.texParameteri(
      r.TEXTURE_2D,
      r.TEXTURE_WRAP_S,
      this.wrapS || Wn
    ), r.texParameteri(
      ...
      this.magFilter || fr
    ), this._webglTexture = I, this.source = g, this.isVideo = !1, this.isLoaded = !0, this.width = g.width || 0, this.height = g.height || 0, this;
  };
}
const Be = (t) => `react-shaders: ${t}`, Gn = (t) => {
  if ("changedTouches" in t) {
    const e = t.changedTouches[0];
    return [e?.clientX ?? 0, e?.clientY ?? 0];
  }
  return [t.clientX, t.clientY];
}, qn = (t, e, r) => t * (1 - r) + e * r, e9 = (t, e, r) => r > 0 ? t.substring(0, r) + e + t.substring(r, t.length) : e + t;
function t9({
  fs: t,
  vs: e = Pn,
  textures: r = [],
  ...
  const p = W(null), v = W(null), y = W(null), x = W(null), b = W(void 0), V = W(void 0), I = W(!1), T = W(void 0), g = W(0), C = W([0, 0]), k = W([]), F = W(0), _ = W(void 0), M = W({
    [$n]: { type: "float", isNeeded: !1, value: 0 },
    [Hn]: { type: "float", isNeeded: !1, value: 0 },
    [In]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [Zn]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [On]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    [jn]: { type: "int", isNeeded: !1, value: 0 },
    [Bn]: {
      type: "vec4",
      isNeeded: !1,
      value: [0, 0, 0, 0]
    ...
    const P = "width" in S ? S.width ?? 0 : 0, Z = "height" in S ? S.height ?? 0 : 0, B = M.current.iChannelResolution;
    if (!B) return;
    const se = Array.isArray(B.value) ? B.value : B.value = [];
    se[$ * 3] = P * d, se[$ * 3 + 1] = Z * d, se[$ * 3 + 2] = 0;
  }, D = () => {
    p.current && (v.current = p.current.getContext("webgl", c) || p.current.getContext(
      "experimental-webgl",
      c
    ), v.current?.getExtension("OES_standard_derivatives"), v.current?.getExtension("EXT_shader_texture_lod"));
  }, K = () => {
    const S = v.current;
    y.current = S?.createBuffer() ?? null, S?.bindBuffer(S.ARRAY_BUFFER, y.current);
    const $ = [
      1,
      1,
      0,
    ...
    const [$ = 0, P = 0] = Gn(S), Z = $ - (T.current?.left ?? 0) - window.pageXOffset, B = (T.current?.height ?? 0) - P - (T.current?.top ?? 0) - window.pageYOffset;
    I.current = !0;
    const se = Array.isArray(M.current.iMouse?.value) ? M.current.iMouse.value : void 0;
    se && (se[2] = Z, se[3] = B), C.current[0] = Z, C.current[1] = B;
  }, oe = (S) => {
    T.current = p.current?.getBoundingClientRect();
    const [$ = 0, P = 0] = Gn(S), Z = $ - (T.current?.left ?? 0), B = (T.current?.height ?? 0) - P - (T.current?.top ?? 0);
    if (l !== 1)
      C.current[0] = Z, C.current[1] = B;
    else {
      const se = Array.isArray(M.current.iMouse?.value) ? M.current.iMouse.value : void 0;
      se && (se[0] = Z, se[1] = B);
    }
  }, Q = () => {
    const S = Array.isArray(M.current.iMouse?.value) ? M.current.iMouse.value : void 0;
    S && (S[2] = 0, S[3] = 0);
  }, E = () => {
    const S = v.current;
    if (!S) return;
    T.current = p.current?.getBoundingClientRect();
    const $ = d, P = Math.floor(
      (T.current?.width ?? 1) * $
    ), Z = Math.floor(
      (T.current?.height ?? 1) * $
    );
    if (S.canvas.width = P, S.canvas.height = Z, M.current.iResolution?.isNeeded && x.current) {
      const B = S.getUniformLocation(
        x.current,
        On
      );
      S.uniform2fv(B, [S.canvas.width, S.canvas.height]);
    }
  }, z = (S, $) => {
    const P = v.current;
    if (!P) return null;
    const Z = P.createShader(S);
    if (!Z) return null;
    if (P.shaderSource(Z, $), P.compileShader(Z), !P.getShaderParameter(Z, P.COMPILE_STATUS)) {
      w?.(Be(`Error compiling the shader:
${$}`));
      const B = P.getShaderInfoLog(Z);
      P.deleteShader(Z), h?.(Be(`Shader compiler log: ${B}`));
    }
    return Z;
  }, H = (S, $) => {
    const P = v.current;
    if (!P) return;
    const Z = z(P.FRAGMENT_SHADER, S), B = z(P.VERTEX_SHADER, $);
    if (x.current = P.createProgram(), !(!x.current || !B || !Z)) {
      if (P.attachShader(x.current, B), P.attachShader(x.current, Z), P.linkProgram(x.current), !P.getProgramParameter(x.current, P.LINK_STATUS)) {
        h?.(
          Be(
            `Unable to initialize the shader program: ${P.getProgramInfoLog(
              x.current
            )}`
          )
        );
      ...
      P.useProgram(x.current), b.current = P.getAttribLocation(
        x.current,
        "aVertexPosition"
      ), P.enableVertexAttribArray(b.current);
    }
  }, Y = () => {
    if (n)
      for (const S of Object.keys(n)) {
        const $ = n[S];
        if (!$) continue;
        const { value: P, type: Z } = $, B = Ku(Z);
        if (!B) continue;
        const se = {};
        if (Gu(Z, P)) {
          const ve = Z.length, ye = Number.parseInt(Z.charAt(ve - 3)), Re = Math.floor(P.length / (ye * ye));
          P.length > ye * ye && (se.arraySize = `[${Re}]`);
        } else qu(Z, P) && (se.arraySize = `[${Math.floor(P.length / Number.parseInt(Z.charAt(0)))}]`);
        M.current[S] = {
          type: B,
          isNeeded: !1,
          value: P,
      ...
      if (r && r.length > 0) {
        ...
        const $ = r.map(
          (P, Z) => (M.current[`${Wu}${Z}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, R(P, Z), k.current[Z] = new Ju(S), k.current[Z]?.load(P).then((B) => {
            R(B, Z);
          }))
        );
        Promise.all($).then(() => {
    ...
    const $ = Fn.includes(a ?? "highp"), P = `precision ${$ ? a : Fn[1]} float;
`;
    $ || w?.(
      Be(
    ...
    let Z = P.concat(`#define DPR ${d.toFixed(1)}
`).concat(S.replace(/texture\(/g, "texture2D("));
    for (const se of Object.keys(M.current))
      if (S.includes(se)) {
        const ve = M.current[se];
        if (!ve) continue;
        Z = e9(
          Z,
          `uniform ${ve.type} ${se}${ve.arraySize || ""}; 
`,
          Z.lastIndexOf(P) + P.length
        ), ve.isNeeded = !0;
      }
    return S.includes("mainImage") && (Z = Z.concat(Uu)), Z;
  }, O = (S) => {
    const $ = v.current;
    if (!$ || !x.current) return;
    const P = F.current ? (S - F.current) / 1e3 : 0;
    F.current = S;
    const Z = L.current;
    if (Z)
      for (const B of Object.keys(Z)) {
        const se = Z[B];
        if (se && M.current[B]?.isNeeded) {
          if (!x.current) return;
          const ve = $.getUniformLocation(
            x.current,
            B
          );
          if (!ve) return;
    ...
    if (M.current.iMouse?.isNeeded) {
      const B = $.getUniformLocation(
        x.current,
        Zn
      );
      $.uniform4fv(B, M.current.iMouse.value);
    }
    ...
    if (M.current.iDate?.isNeeded) {
      const B = /* @__PURE__ */ new Date(), se = B.getMonth() + 1, ve = B.getDate(), ye = B.getFullYear(), Re = B.getHours() * 60 * 60 + B.getMinutes() * 60 + B.getSeconds() + B.getMilliseconds() * 1e-3, Ie = $.getUniformLocation(
        x.current,
        In
      );
      $.uniform4fv(Ie, [ye, se, ve, Re]);
    }
    if (M.current.iFrame?.isNeeded) {
      const B = $.getUniformLocation(
        x.current,
        jn
      ), se = M.current.iFrame.value;
      $.uniform1i(B, se), M.current.iFrame.value = se + 1;
    }
    if (k.current.length > 0)
      for (let B = 0; B < k.current.length; B++) {
        const se = k.current[B];
        if (!se) return;
        const { isVideo: ve, _webglTexture: ye, source: Re, flipY: Ie, isLoaded: ot } = se;
        if (!ot || !ye || !Re) return;
        if (M.current[`iChannel${B}`]?.isNeeded) {
          if (!x.current) return;
          const st = $.getUniformLocation(
            x.current,
            `iChannel${B}`
          );
          $.activeTexture($.TEXTURE0 + B), $.bindTexture($.TEXTURE_2D, ye), $.uniform1i(st, B), ve && se.updateTexture(
            ye,
            Re,
            Ie
          );
    ...
    const $ = v.current;
    if (!$) return;
    $.viewport(0, 0, $.drawingBufferWidth, $.drawingBufferHeight), $.clear($.COLOR_BUFFER_BIT | $.DEPTH_BUFFER_BIT), $.bindBuffer($.ARRAY_BUFFER, y.current), $.vertexAttribPointer(
      b.current ?? 0,
      3,
      $.FLOAT,
      !1,
      0,
      0
    ), O(S), $.drawArrays($.TRIANGLE_STRIP, 0, 4);
    const P = M.current.iMouse?.value;
    if (M.current.iMouse?.isNeeded && l !== 1 && Array.isArray(P)) {
      const Z = P[0] ?? 0, B = P[1] ?? 0;
      P[0] = qn(Z, C.current[0] ?? 0, l), P[1] = qn(B, C.current[1] ?? 0, l);
    }
    V.current = requestAnimationFrame(ne);
  }, ce = () => {
    const S = { passive: !0 };
    M.current.iMouse?.isNeeded && p.current && (p.current.addEventListener("mousemove", oe, S), p.current.addEventListener("mouseout", Q, S), p.current.addEventListener("mouseup", Q, S), p.current.addEventListener("mousedown", te, S), p.current.addEventListener("touchmove", oe, S), p.current.addEventListener("touchend", Q, S), p.current.addEventListener("touchstart", te, S)), M.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      J,
      S
    ), p.current && (_.current = new ResizeObserver(E), _.current.observe(p.current), window.addEventListener("resize", E, S));
  }, xe = () => {
    const S = { passive: !0 };
    M.current.iMouse?.isNeeded && p.current && (p.current.removeEventListener("mousemove", oe, S), p.current.removeEventListener("mouseout", Q, S), p.current.removeEventListener("mouseup", Q, S), p.current.removeEventListener("mousedown", te, S), p.current.removeEventListener("touchmove", oe, S), p.current.removeEventListener("touchend", Q, S), p.current.removeEventListener("touchstart", te, S)), M.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      J,
      S
    ), _.current && (_.current.disconnect(), window.removeEventListener("resize", E, S));
  };
  return fe(() => {
    L.current = n;
  }, [n]), fe(() => {
    ...
    function $() {
      D();
      const P = v.current;
      P && p.current && (P.clearColor(...s), P.clearDepth(1), P.enable(P.DEPTH_TEST), P.depthFunc(P.LEQUAL), P.viewport(0, 0, p.current.width, p.current.height), p.current.height = p.current.clientHeight, p.current.width = p.current.clientWidth, Y(), he(), H(me(t || zu), e || Pn), K(), requestAnimationFrame(ne), ce(), E());
    }
    return requestAnimationFrame($), () => {
      const P = v.current;
      if (P) {
        if (P.getExtension("WEBGL_lose_context")?.loseContext(), P.useProgram(null), P.deleteProgram(x.current ?? null), S.length > 0)
          for (const Z of S)
            P.deleteTexture(Z._webglTexture);
        x.current = null;
      }
      xe(), cancelAnimationFrame(V.current ?? 0);
    };
  }, []), /* @__PURE__ */ o(
    "canvas",
    {
...
}`, n9 = 10, o9 = 2, s9 = 0.5, a9 = 0.2, i9 = 1.5, Te = {
  duration: 0.5,
  ease: "easeOut"
}, Yn = {
  duration: 0.35,
...
function c9(t, e) {
  const [r, n] = X(n9), {
    ...
    animate: a,
    motionValue: i
  } = $t(a9), { value: c, animate: l } = $t(o9), { value: d, animate: u } = $t(s9), { value: h, animate: w } = $t(i9), p = Vi(e, {
    fftSize: 512,
  ...
  return fe(() => {
    switch (t) {
      ...
      case "failed":
      case "disconnected":
        n(10), a(0.2, Te), l(1.2, Te), u(0.4, Te), w(1, Te);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), a(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, Te), u(0.7, Te), w([1.5, 2], Yn);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), a(0.3, Te), l(0.5, Te), u(1, Te), w([0.5, 2.5], Yn);
        return;
      case "speaking":
        n(70), a(0.3, Te), l(0.75, Te), u(1.25, Te), w(1.5, Te);
        return;
    }
  }, [
    t,
...
function k3({
  ...
  const { speed: d, scale: u, amplitude: h, frequency: w, brightness: p } = c9(e, s);
  return /* @__PURE__ */ o(
    Io,
    {
      ref: c,
...
const x3 = ({
  ...
  const n = ge(), s = Oe();
  return /* @__PURE__ */ f(Ue, { children: [
    t && /* @__PURE__ */ o("span", { className: G(f9(), "truncate"), children: t }),
    /* @__PURE__ */ o(je, { children: r && e && /* @__PURE__ */ o(
      pe.div,
      {
  ...
  return /* @__PURE__ */ f("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ o("span", { className: G(jo()), children: e }),
    /* @__PURE__ */ f(
      pe.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ f("div", { className: "flex items-center gap-1", children: [
            ...
            r && /* @__PURE__ */ o("span", { className: G(Ht()), children: r })
          ] }),
          n === "people" && /* @__PURE__ */ o(
            pi,
            {
          ...
          n === "alert" && /* @__PURE__ */ o(gi, { text: t.alertLabel, level: t.level }),
          n === "balance" && /* @__PURE__ */ o(m9, { balance: t.balance })
        ]
      }
    ),
    r && !p9.has(n) && /* @__PURE__ */ o(
      pe.span,
      {
        className: G(Ht()),
        animate: { opacity: s ? 0 : 1 },
...
const C9 = ({
  ...
  dataLength: n,
  color: s
}) => r !== n - 1 || t == null || e == null ? null : /* @__PURE__ */ o("circle", { cx: t, cy: e, r: 2, fill: s, stroke: "none" }), w9 = ({
  label: t,
  direction: e
}) => {
  const r = Zo[e];
  ...
  const s = `sparkline-gradient-${Jn().replace(/:/g, "")}`, a = v9(t, r), i = Zo[a];
  return /* @__PURE__ */ o("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ci, { width: "100%", height: "100%", children: /* @__PURE__ */ f(
          wi,
          {
            data: t,
            ...
            children: [
              ...
              /* @__PURE__ */ o(ki, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ o(
                xi,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ o(w9, { label: e, direction: a })
      ]
    }
  ) });
}, Oo = m(
  (t, e) => {
    const {
      ...
      className: l,
      ...d
    } = t, [u, h] = X(!1), [w, p] = X(!1), v = u || w, y = Oe(), x = v && !!c, b = {
      duration: y ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, V = () => {
      i?.();
        ...
        "div",
        {
          ...
          children: [
            ...
            d.content === "sparkline" ? /* @__PURE__ */ f("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ o("span", { className: G(jo()), children: n }),
              /* @__PURE__ */ o(
                pe.div,
                {
...
Oo.displayName = "F0AiInsightCardInternal";
const x9 = ["className"], Do = m((t, e) => {
  const r = x9.reduce((n, s) => {
    const { [s]: a, ...i } = n;
    return i;
  }, t);
  return /* @__PURE__ */ o(Oo, { ref: e, ...r });
});
Do.displayName = "F0AiInsightCard";
const y9 = () => /* @__PURE__ */ f(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ o(Ne, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ f("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ f("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ o(Ne, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ o(Ne, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ f("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ o(Ne, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ o(Ne, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], Bo = 180, b9 = (t) => Number.isFinite(t) ? Math.max(0, Math.floor(t)) : Bo, L9 = (t, e) => t.length <= e ? t : `${t.slice(0, e).trimEnd()}...`, M9 = (t) => t.showActions !== !1, E9 = (t) => Object.fromEntries(
...
function _9(t) {
  const {
    ...
    description: a,
    seeMoreLabel: i,
    maxCollapsedDescriptionLength: c = Bo
  } = t, [l, d] = X(!1), u = Jn(), h = W(null), w = b9(
    c
  ), p = a.length > w, v = l ? a : L9(a, w), y = M9(t) ? t : null, x = E9(t);
  return fe(() => {
    l && h.current?.focus();
  }, [l]), /* @__PURE__ */ f(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ f("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          e && /* @__PURE__ */ o(y1, { module: e, size: "lg" }),
...
const S9 = ({
  ...
  return /* @__PURE__ */ f(
    L1,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ f(M1, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, R9 = (t) => Md[t] ?? u1, V9 = ({ iconName: t }) => t ? /* @__PURE__ */ o("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ o(be, { icon: R9(t), size: "md", color: "default" }) }) : null;
function T9({
  sources: t,
  title: e
}) {
  ...
  return /* @__PURE__ */ o(S9, { icon: _r, title: n, children: /* @__PURE__ */ o("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: t.map((s, a) => {
    const i = /* @__PURE__ */ o(V9, { iconName: s.icon });
...
T9.displayName = "F0AiMessageSources";
async function A9(t, e, r) {
...
function N9({
  ...
  const n = ge(), s = W(null), a = e ?? n.ai.aiTable.title, i = ee(
    (c) => {
      if (!s.current) return;
  ...
  return t.columns?.length ? /* @__PURE__ */ f(
    er,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ o(er, { overflowX: "auto", children: /* @__PURE__ */ f(
          "table",
          {
            ref: s,
            className: G(
              ...
              /* @__PURE__ */ o("tbody", { children: t.rows.map((c, l) => /* @__PURE__ */ o("tr", { children: t.columns.map((d) => {
                ...
                return /* @__PURE__ */ o(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ o(Se, { children: u == null ? "" : String(u) })
                  },
                  d
                );
              }) }, l)) })
...
N9.displayName = "F0AiTableCard";
function F9({ credits: t }) {
  const e = ge(), [r, n] = X(!1), [s, a] = X(!1), [i, c] = X(!1), [l, d] = X(null), u = ee(
    (p) => {
      n(p), p && t?.fetchUsage && (a(!0), c(!1), t.fetchUsage().then((v) => {
        d(v), c(!1);
      }).catch(() => {
        c(!0);
      }).finally(() => {
  ...
  if (!t) return null;
  const h = l ? Math.min(100, Math.round(l.used / l.total * 100)) : 0, w = t.companyName;
  return /* @__PURE__ */ f(Rr, { open: r, onOpenChange: u, children: [
    /* @__PURE__ */ o(Vr, { asChild: !0, children: /* @__PURE__ */ o(
      Ee,
      {
        variant: "ghost",
        hideLabel: !0,
        ...
        children: [
          w && /* @__PURE__ */ f("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            ...
            /* @__PURE__ */ f("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ o(Se, { tag: "span", className: "font-medium", children: t.companyName ?? "" }),
...
const P9 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function $9({
  employeeCredits: t
}) {
  const e = ge(), r = Oe(), [n, s] = X(!1), [a, i] = X(!1), [c, l] = X(!1), [d, u] = X(null), h = ee(
    (y) => {
      s(y), y && t?.fetchUsage && (i(!0), l(!1), t.fetchUsage().then((x) => {
        u(x), l(!1);
      }).catch(() => {
        l(!0);
      }).finally(() => {
  ...
  if (!t) return null;
  const w = !!t.companyName, p = d && d.total > 0 ? Math.min(100, Math.round(d.used / d.total * 100)) : 0, v = d ? Math.max(0, d.total - d.used) : 0;
  return /* @__PURE__ */ f(Rr, { open: n, onOpenChange: h, children: [
    /* @__PURE__ */ o(Vr, { asChild: !0, children: /* @__PURE__ */ o(
      Ee,
      {
        variant: "ghost",
...
const Xn = ({
  credits: t,
  employeeCredits: e
}) => e ? /* @__PURE__ */ o($9, { employeeCredits: e }) : t ? /* @__PURE__ */ o(F9, { credits: t }) : null, L3 = ({
  historyEnabled: t = !1,
  title: e,
  ...
  const w = ge(), p = w1(`(max-width: ${bi.md}px)`, {
        ...
        /* @__PURE__ */ o("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ o(
          _t,
          {
            ...
            children: /* @__PURE__ */ f("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ o(Se, { lines: 1, className: "min-w-0 text-left", children: r ?? w.ai.newConversation }),
              /* @__PURE__ */ o(be, { icon: Er, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ f(
  ...
  ) : /* @__PURE__ */ f("header", { className: G("flex justify-between px-4 py-3"), children: [
...
function H9() {
  if (!(typeof navigator > "u"))
    return Ei(navigator.language);
}
function I9(t) {
  const e = new Date(t), r = /* @__PURE__ */ new Date();
  return R1(e) ? "today" : V1(e) ? "yesterday" : Li(e, r) ? "thisMonth" : "older";
}
function j9(t, e) {
  const r = new Date(t), n = H9(), s = Dr(r, "p", { locale: n });
  if (R1(r)) return `${e.today}, ${s}`;
  if (V1(r)) return `${e.yesterday}, ${s}`;
  const a = !Mi(r, /* @__PURE__ */ new Date());
  return `${Dr(r, a ? "MMM d yyyy" : "MMM d", {
    locale: n
  })}, ${s}`;
}
function Z9(t) {
      ...
      children: [
        /* @__PURE__ */ f(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ o(Se, { lines: 1, className: "text-left font-medium", children: t.title }),
        ...
        /* @__PURE__ */ o(
          "div",
          {
            ...
            children: /* @__PURE__ */ o(S1, { items: c, children: /* @__PURE__ */ o(
              _e,
              {
                icon: d1,
                variant: "ghost",
...
const M3 = ({
  ...
  const p = we(
    ...
    return n.filter((k) => k.title.toLowerCase().includes(C));
  }, [n, h]), y = we(
    () => v.filter((C) => i.has(C.id)),
    [v, i]
  ), x = we(
    () => v.filter((C) => !i.has(C.id)),
    [v, i]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ f("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ o(be, { icon: _r, color: "secondary", size: "md" }),
                  /* @__PURE__ */ o(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ o(
                    _t,
                    {
                      ...
                      children: /* @__PURE__ */ f("div", { className: "flex w-full items-center gap-2", children: [
                        ...
                        /* @__PURE__ */ o(Se, { lines: 1, className: "text-left", children: u.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ o(D9, {}),
                  !s && a && /* @__PURE__ */ o("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: a }),
                  !s && !a && !g && /* @__PURE__ */ o("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: u.ai.noPreviousChats }),
...
function E3({
  ...
  const [n, s] = X([]), [a, i] = X(!1), [c, l] = X(null), [d, u] = X(B9), h = ee(async () => {
    i(!0), l(null);
    try {
      const y = await e();
      s(y);
    } catch (y) {
      const x = y instanceof Error ? y.message : "Failed to fetch chat history";
      l(x), s([]);
    } finally {
      i(!1);
    }
  ...
  const w = ee((y) => {
    u((x) => {
      const b = new Set(x);
      return b.add(y), hr(b), b;
    });
  }, []), p = ee((y) => {
    u((x) => {
      const b = new Set(x);
      return b.delete(y), hr(b), b;
    });
  }, []), v = ee(
    async (y) => {
      try {
        await r(y), s((x) => x.filter((b) => b.id !== y)), u((x) => {
          if (!x.has(y)) return x;
          const b = new Set(x);
          return b.delete(y), hr(b), b;
        });

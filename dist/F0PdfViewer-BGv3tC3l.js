...
import { f as n, ht as r } from "./variants-BOK7SMP_.js";
import { t as i } from "./utils-CVzxZnoI.js";
import { l as a } from "./F0Button-DTIyyURd.js";
import { Kt as o, t as s } from "./F0Select-D82qzEFD.js";
import { lt as c, ot as l } from "./F0Checkbox-BNfJ1XN6.js";
import { r as u } from "./internal-BI1QOfl-.js";
...
import { a as v, n as y, o as b, r as x, s as S, t as C } from "./scales-DYYl2quG.js";
...
}), F = "flex flex-row items-center gap-2", ne = ({ toolbarRef: e, currentPage: t, totalPages: r, hasDocument: a, selectedScale: m, scaleOptions: ee, onPreviousPage: h, onNextPage: g, onZoomIn: _, onZoomOut: v, onScaleChange: y, rotatable: b, onRotate: x, onPrint: C, onDownload: w, actions: T }) => {
	let { pdfViewer: E } = n();
...
h();
var I = D(() => import("./SheetViewer-DXs3joxJ.js")), L = D(() => import("./DocxViewer-shCmspkI.js")), R = D(() => import("./TextViewer-Zxi4nrV6.js")), z = 48, B = E((e, t) => {
...
var V = E((e, t) => {
	let { url: r, filename: i = "document.pdf", page: o = 0, pagesToDisplay: s = [], initialScale: c = "page-width", withCredentials: l = !0, rotatable: u = !1, initialRotation: d = 0, onRotationChange: f, onPdfLoaded: p, onPageChange: m, actions: h, ..._ } = e, { pdfViewer: S } = n(), [w, T] = M(null), [E, D] = M([]), [F, I] = M(1), [L, R] = M(0), [B, V] = M(c), [H, U] = M(d), W = j(null), G = j(null), K = j([]), q = s.length > 0 ? s.length : w?.numPages, J = E.find(Boolean), Y = (J?.originalWidth ?? 595) * F, X = (J?.originalHeight ?? 842) * F, ie = A(() => [
		{
			value: "page-width",
			label: S.pageWidth
		},

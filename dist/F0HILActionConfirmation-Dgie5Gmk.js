...
import { y as Oe, z as De, D as Be, G as Ve, J as ee, K as ke } from "./F0AiChat-CbHEot_C.js";
...
class Je {
  ...
  load = async (t) => {
    ...
    Object.assign(this, { url: n, wrapS: d, wrapT: h, minFilter: g, magFilter: y, flipY: p });
    ...
    return (t.wrapS !== de || t.wrapT !== de || t.minFilter !== fe && t.minFilter !== H) && !_ && (L = this.makePowerOf2(L), _ = !0), e.bindTexture(e.TEXTURE_2D, P), e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, p), e.texImage2D(
      e.TEXTURE_2D,
      A,
      E,
      m,
      N,
      L
    ), _ && t.minFilter !== fe && t.minFilter !== H && e.generateMipmap(e.TEXTURE_2D), e.texParameteri(
      e.TEXTURE_2D,
      e.TEXTURE_WRAP_S,
      this.wrapS || me
    ), e.texParameteri(
...
${a}`));
    ...
    if (m.current = o.createProgram(), !(!m.current || !s || !c)) {
      ...
      o.useProgram(m.current), N.current = o.getAttribLocation(
        m.current,
        "aVertexPosition"
...
`;
    a || E?.(
      U(
        `wrong precision type ${h}, please make sure to pass one of a valid precision lowp, mediump, highp, by default you shader precision will be set to highp.`
      )
    );
...
`,
    ...
    l.current.iMouse?.isNeeded && u.current && (u.current.addEventListener("mousemove", $, i), u.current.addEventListener("mouseout", O, i), u.current.addEventListener("mouseup", O, i), u.current.addEventListener("mousedown", X, i), u.current.addEventListener("touchmove", $, i), u.current.addEventListener("touchend", O, i), u.current.addEventListener("touchstart", X, i)), l.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      ...
      K,
      i
    ), u.current && (I.current = new ResizeObserver(G), I.current.observe(u.current), window.addEventListener("resize", G, i));
  }, Fe = () => {
    const i = { passive: !0 };
    l.current.iMouse?.isNeeded && u.current && (u.current.removeEventListener("mousemove", $, i), u.current.removeEventListener("mouseout", O, i), u.current.removeEventListener("mouseup", O, i), u.current.removeEventListener("mousedown", X, i), u.current.removeEventListener("touchmove", $, i), u.current.removeEventListener("touchend", O, i), u.current.removeEventListener("touchstart", X, i)), l.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      ...
      K,
      i
    ), I.current && (I.current.disconnect(), window.removeEventListener("resize", G, i));
  };
  return Y(() => {
    W.current = n;
  }, [n]), Y(() => {

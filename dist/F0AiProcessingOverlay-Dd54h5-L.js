...
import { useInsertionEffect as Sr, forwardRef as g, useRef as D, useEffect as q, useLayoutEffect as rt, useState as B, useMemo as Q, useCallback as _, createContext as Ge, useContext as Be, useId as ot, createElement as Tr, memo as Hr } from "react";
import { d9 as Ar, da as $r, af as nt, c7 as Br, db as Ir, dc as Pr, dd as Dr, de as jr, c8 as Zr, cg as st, c6 as _r, df as Or, ao as s1, dg as Ur, aX as zr, dh as Gr, di as Wr, dj as qr, aw as Xr, dk as Yr, cH as Kr, aq as it, at as Qr, dl as Jr, s as i1, aj as at, aa as We, r as ct, bv as eo, ce as to, dm as ro, bg as oo, cG as no, ah as Fe, aJ as so, bz as lt, dn as io, cE as ao, l as Me, cC as co, dp as lo, c0 as dt, bf as fo, dq as uo, dr as ho, ds as go, dt as po, du as Co, dv as ft, cv as mo, cw as vo, dw as wo, dx as xo, dy as ko, dz as Lo, dA as bo, bJ as yo, ca as Mo, dB as Eo, dC as Ro, dD as Fo, dE as No, dF as Vo, dG as So, dH as To, dI as Ho, bI as Ao, cF as $o, ar as Bo, cr as Io, dJ as Po, dK as Do, dL as jo, dM as Zo, dN as _o, dO as Oo, dP as Uo, aF as zo, bK as Go, c2 as ut, a7 as Wo, ai as qo, bL as ht, b$ as Xo, c1 as gt, i as Yo, by as Ko, bx as Qo, dQ as Jo, dR as en, bM as pt, bN as tn, bO as rn, be as on, aM as nn, dS as sn, j as an, bt as Ct, bs as mt, bm as cn, dT as vt, bl as ln, c9 as a1, t as dn, bp as c1, dU as fn, dV as un, dW as l1, cc as hn, cd as gn, cD as wt, dX as pn, a2 as Cn, a1 as mn, dY as vn, dZ as wn, d_ as xn, d$ as kn, bZ as Ln, e0 as xt, e1 as bn, as as yn, e2 as Mn, a6 as ce, q as k, O as Se, cl as En, u as G, bY as Rn, S as he, bX as kt, a3 as le, X as ge, ak as Fn, o as Ce, e3 as Nn, au as ie, b1 as xe, a0 as Ee, N as J, cM as Lt, aR as d1, e4 as Vn, aS as f1, aT as u1, b as be, bV as Sn, e5 as Tn, bW as Hn, ab as An, bd as $n, an as h1, bP as Bn, bQ as In, bR as Pn, bS as y1, al as Dn, aA as bt, b4 as yt, cb as jn, cR as Zn, e6 as _n, e7 as On, b9 as Mt, e8 as Un, cN as zn, e9 as Gn, b6 as $e, bn as Et, ea as Rt, bo as Ft, c as r1, cf as M1, eb as Nt, ec as Wn, ed as qn, bD as Xn, ee as Yn, bu as g1, cs as Kn, ef as Qn, eg as Jn, eh as es, ei as ts, ej as rs, w as os, x as ns, _ as ss, $ as is, az as E1, ek as Vt, el as St, em as as, en as cs, ay as ls, ap as ds, eo as fs, ep as us, d as hs } from "./F0CanvasPanel-DLRj27Uc.js";
...
import { F as Cs } from "./Printer-B7iDPx2r.js";
function ms(e, r, o) {
  Sr(() => e.on(r, o), [e, r, o]);
}
...
const L0 = (e, r) => /* @__PURE__ */ a(
...
), ac = g(ic), cc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: ws,
  Add: Ar,
  Ai: ks,
  ...
  Calculator: Yr,
  Calendar: Kr,
  CalendarArrowDown: zs,
  CalendarArrowLeft: Ws,
  CalendarArrowRight: Xs,
  CameraPlus: Ks,
  CardPin: Js,
  ChartFunnel: ti,
  ChartHorizontalBars: oi,
  ChartLine: si,
  ChartPie: ai,
  ChartVerticalBars: li,
  Check: it,
  CheckCircle: Qr,
  CheckCircleLine: fi,
  CheckDouble: Jr,
  ...
  Wifi: ac,
  Windows: Mn
}, Symbol.toStringTag, { value: "Module" })), lc = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const Fc = Se({
  ...
  ({
    ...
    const Ne = P && P !== "none" || oe && oe !== "none" || W && W !== "none" || ae && ae !== "none", De = X && X !== "none" || Ne, je = { sm: qe, md: Xe, lg: Ye, xl: Ie }, Qe = Nc.map((Ze) => {
      const _e = je[Ze];
      return _e ? Rc(Ze, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
...
const Bc = ({
  ...
  const s = xe(), [i, l] = B(""), [d, c] = B(0), [u, f] = B(!1), p = D(null), C = D(null), h = D(null), m = e[d] ?? r;
  return q(() => {
    const v = () => {
        ...
        l && /* @__PURE__ */ a(
          u1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: _c(l.items).map((d, c) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
function qc(e) {
  const [r, o] = B([]), [n, s] = B(null), i = D(
    null
  ), l = D(null), d = G(), c = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, p = Q(() => {
    if (u)
...
function Jc({
  ...
  const [i, l] = B(!1), [d, c] = B(""), [u, f] = B([]), [p, C] = B(!1), [h, m] = B(0), [v, x] = B([]), N = D(-1), I = D(null), H = D(0), S = D(-1);
  q(() => {
    if (!n) {
      l(!1);
      return;
...
` || z === "	";
  ...
  const A = Q(() => {
    ...
    const V = s.current;
    if (!V) return null;
    const $ = Kc(V, N.current), U = V.offsetLeft + $.left, z = (V.offsetParent ? V.offsetParent.offsetHeight : 0) - (V.offsetTop + $.top);
...
const e2 = /[\\`*_{}[\]()#+\-.!|~>]/g, t2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(e2, "\\$&")).join(""), H6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const L = G(), M = xe(), [A, F] = B(""), [V, $] = B(0), [U, O] = B(!1), [z, te] = B(!1), [re, Y] = B(null), X = D(null), P = D(null), oe = D(null), W = l != null, { tracking: ae } = be(), ke = _(
    (K, we) => {
  ...
  const Ie = ve.status === "recording", Ke = Ie ? L.ai.listening : L.ai.inputPlaceholder, Pe = de.filter((K) => K.status === "uploaded"), Ne = de.some((K) => K.status === "uploading"), De = de.some((K) => K.status === "error"), je = A.trim().length > 0 || Pe.length > 0;
  q(() => {
    if (!(!z || Ne)) {
      if (te(!1), De) {
  ...
  const Qe = async (K) => {
    if (K.preventDefault(), !W) {
      if (ee.close(), o)
        ...
        const we = ee.transformMentions(A.trim()), Je = t2(we), Oe = Pe.flatMap(
  ...
  }, m1 = re ? re.prompt ?? re.title : null, v1 = Ie ? [L.ai.listening] : m1 ? [m1] : s ?? [], Er = v1.length > 1, Rr = Q(() => Uc(A, ee.mentions, {
    cursorPosition: V,
    ...
    J.div,
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(Ac, { creditWarning: i, children: /* @__PURE__ */ a(
            J.form,
            {
              "aria-busy": o,
              ref: X,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ t(jn, { file: e.file, size: "lg" }),
...
const F1 = 7, T2 = 625, N1 = /* @__PURE__ */ new Set();
function H2(e) {
...
function ar(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: $2(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? H2(o) : "") || "—" };
  }
...
function cr({
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = be(), p = S2(e), C = d ?? p, h = D(() => {
  ...
  h.current = N, q(() => {
    typeof window > "u" || window.innerWidth < T2 || N1.has(e) || (N1.add(e), h.current());
  }, [e]);
...
const fr = Ge(void 0), I6 = () => Be(fr), D2 = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), j2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
...
const gr = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), X2 = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = q2(
    e?.content,
    l
  ), c = (W2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: p, clear: C } = lr({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(X2, { text: u, renderMarkdown: n }),
...
}, K2 = 35, Q2 = 22, J2 = 400, el = 2500, tl = 220, rl = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  ...
  q(() => {
    ...
    let C;
    if (d === "starting")
      C = setTimeout(() => c("writing"), J2);
    else if (d === "writing")
      i < u.length ? C = setTimeout(() => l((h) => h + 1), K2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      C = setTimeout(() => c("erasing"), el);
    } else d === "erasing" && (i > 0 ? C = setTimeout(() => l((h) => h - 1), Q2) : C = setTimeout(() => {
...
const nl = {
...
}, P6 = (e) => /* @__PURE__ */ t(_2, { children: /* @__PURE__ */ t(sl, { ...e }) }), sl = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: H, handleSubmit: S, handleClose: E } = O2(
    f ?? nl
  ), w = G(), L = v ?? j2, M = x ?? Y2, A = Q(() => {
    const P = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(P) ? P : [P]).filter((W) => typeof W == "string" && W.length > 0);
  }, [n, w.ai.defaultInitialMessage]), F = !r && e.length === 0 && A.length > 0, V = D(null), $ = D(null), U = D(null), O = D(null), z = D(null), { showScrollBtn: te, turnMinHeight: re, scrollToBottom: Y } = ol({
    viewportRef: V,
    contentRef: $,
    endRef: U,
    lastTurnRef: z,
...
}, il = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
...
const dl = ({
  ...
  } = s, L = D(null), M = I ?? "single", A = l > 1, F = i === 0, V = i === l - 1, $ = A ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(l)
  ...
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: ae, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      J.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ke, ease: ul },
        children: [
          /* @__PURE__ */ t(
            fl,
            {
...
class U6 {
  ...
  setupGL() {
    ...
    const S = (this.options.colors || vl).map(wl);
...
const B1 = ["lowp", "mediump", "highp"], xl = `
void main(void){
...
}`, P1 = "iTime", D1 = "iTimeDelta", j1 = "iDate", Z1 = "iFrame", _1 = "iMouse", O1 = "iResolution", Ll = "iChannel", U1 = "iChannelResolution", z1 = "iDeviceOrientation";
function bl(e, r) {
...
}, t1 = 9729, G1 = 9728, Fl = 9987, W1 = 33071, q1 = 10497;
class Nl {
  gl;
  url;
  wrapS;
...
}, Y1 = (e, r, o) => e * (1 - o) + r * o, Vl = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function Sl({
  fs: e,
  vs: r = I1,
  textures: o = [],
  ...
  const h = D(null), m = D(null), v = D(null), x = D(null), N = D(void 0), I = D(void 0), H = D(!1), S = D(void 0), E = D(0), w = D([0, 0]), L = D([]), M = D(0), A = D(void 0), F = D({
    ...
    const y = "width" in b ? b.width ?? 0 : 0, j = "height" in b ? b.height ?? 0 : 0, T = F.current.iChannelResolution;
    if (!T) return;
    const Z = Array.isArray(T.value) ? T.value : T.value = [];
    Z[R * 3] = y * u, Z[R * 3 + 1] = j * u, Z[R * 3 + 2] = 0;
  }, U = () => {
    ...
    const [R = 0, y = 0] = X1(b), j = R - (S.current?.left ?? 0) - window.pageXOffset, T = (S.current?.height ?? 0) - y - (S.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    const Z = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
    Z && (Z[2] = j, Z[3] = T), w.current[0] = j, w.current[1] = T;
  }, re = (b) => {
    S.current = h.current?.getBoundingClientRect();
    const [R = 0, y = 0] = X1(b), j = R - (S.current?.left ?? 0), T = (S.current?.height ?? 0) - y - (S.current?.top ?? 0);
    if (c !== 1)
      w.current[0] = j, w.current[1] = T;
    else {
      const Z = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
      Z && (Z[0] = j, Z[1] = T);
    }
    ...
    if (b.canvas.width = y, b.canvas.height = j, F.current.iResolution?.isNeeded && x.current) {
    ...
    if (!j) return null;
    if (y.shaderSource(j, R), y.compileShader(j), !y.getShaderParameter(j, y.COMPILE_STATUS)) {
      C?.(Le(`Error compiling the shader:
${R}`));
      const T = y.getShaderInfoLog(j);
      y.deleteShader(j), p?.(Le(`Shader compiler log: ${T}`));
    }
    return j;
  }, oe = (b, R) => {
    const y = m.current;
    if (!y) return;
    const j = P(y.FRAGMENT_SHADER, b), T = P(y.VERTEX_SHADER, R);
    if (x.current = y.createProgram(), !(!x.current || !T || !j)) {
      if (y.attachShader(x.current, T), y.attachShader(x.current, j), y.linkProgram(x.current), !y.getProgramParameter(x.current, y.LINK_STATUS)) {
        p?.(
          Le(
    ...
    if (n)
      for (const b of Object.keys(n)) {
        const R = n[b];
        if (!R) continue;
        const { value: y, type: j } = R, T = Rl(j);
        if (!T) continue;
        const Z = {};
        if (bl(j, y)) {
          const se = j.length, ue = Number.parseInt(j.charAt(se - 3)), ee = Math.floor(y.length / (ue * ue));
          y.length > ue * ue && (Z.arraySize = `[${ee}]`);
        } else yl(j, y) && (Z.arraySize = `[${Math.floor(y.length / Number.parseInt(j.charAt(0)))}]`);
        F.current[b] = {
          type: T,
          isNeeded: !1,
          value: y,
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (y, j) => (F.current[`${Ll}${j}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, $(y, j), L.current[j] = new Nl(b), L.current[j]?.load(y).then((T) => {
            $(T, j);
          }))
        );
        Promise.all(R).then(() => {
...
`,
    ...
    return b.includes("mainImage") && (j = j.concat(xl)), j;
  }, de = (b) => {
    const R = m.current;
    ...
    if (F.current.iMouse?.isNeeded && c !== 1 && Array.isArray(y)) {
      const j = y[0] ?? 0, T = y[1] ?? 0;
      y[0] = Y1(j, w.current[0] ?? 0, c), y[1] = Y1(T, w.current[1] ?? 0, c);
    }
  ...
  return q(() => {
    ...
    function R() {
      U();
      const y = m.current;
      y && h.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, W(), ae(), oe(ke(e || kl), r || I1), O(), requestAnimationFrame(ne), fe(), X());
    }
...
}`, Hl = 10, Al = 2, $l = 0.5, Bl = 0.2, Il = 1.5, pe = {
  duration: 0.5,
  ease: "easeOut"
}, K1 = {
  duration: 0.35,
...
function Pl(e, r) {
  const [o, n] = B(Hl), {
    ...
    animate: i,
    motionValue: l
  } = Ue(Bl), { value: d, animate: c } = Ue(Al), { value: u, animate: f } = Ue($l), { value: p, animate: C } = Ue(Il), h = ps(r, {
    fftSize: 512,
...
function z6({
  ...
  const { speed: u, scale: f, amplitude: p, frequency: C, brightness: h } = Pl(r, s);
  return /* @__PURE__ */ t(
    vr,
    {
      ref: d,
...
const G6 = ({
  ...
  const n = G(), s = xe();
  return /* @__PURE__ */ a(Re, { children: [
    e && /* @__PURE__ */ t("span", { className: k(_l(), "truncate"), children: e }),
    ...
    /* @__PURE__ */ a(
      J.div,
      {
        ...
        children: [
          ...
          n === "balance" && /* @__PURE__ */ t(zl, { balance: e.balance })
        ]
      }
    ),
...
const ql = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), Xl = ({
  label: e,
  direction: r
}) => {
  const o = xr[r];
  ...
  const s = `sparkline-gradient-${ot().replace(/:/g, "")}`, i = Wl(e, o), l = xr[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(Xl, { label: r, direction: i })
      ]
    }
  ) });
}, kr = g(
...
const Kl = ["className"], Lr = g((e, r) => {
  const o = Kl.reduce((n, s) => {
    const { [s]: i, ...l } = n;
    return l;
  }, e);
...
const Ql = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], br = 180, Jl = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : br, e6 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, t6 = (e) => e.showActions !== !1, r6 = (e) => Object.fromEntries(
...
function o6(e) {
  ...
  } = e, [c, u] = B(!1), f = ot(), p = D(null), C = Jl(
    d
  ), h = i.length > C, m = c ? i : e6(i, C), v = t6(e) ? e : null, x = r6(e);
  return q(() => {
    c && p.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
...
o6.displayName = "F0AiProposalCard";
const n6 = ({
  icon: e,
  title: r,
  children: o
...
}, s6 = (e) => cc[e] ?? ft, i6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: s6(e), size: "md", color: "default" }) }) : null;
function a6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(n6, { icon: c1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const l = /* @__PURE__ */ t(i6, { iconName: s.icon });
...
a6.displayName = "F0AiMessageSources";
async function c6(e, r, o) {
  const n = await import("./xlsx-CzlURDDb.js"), s = n.utils.table_to_book(e, { sheet: "Data" });
  n.writeFile(s, `${o}.${r}`);
}
function l6({
...
l6.displayName = "F0AiTableCard";
function d6({ credits: e, trigger: r }) {
...
) : e ? /* @__PURE__ */ t(d6, { credits: e, trigger: o }) : null, X6 = n1, Y6 = ({
  historyEnabled: e = !1,
  title: r,
...
function p6(e, r) {
  const o = new Date(e), n = h6(), s = E1(o, "p", { locale: n });
...
const J1 = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], v6 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(he, { className: k("h-4 rounded", e) }) }), et = ({
  titleWidth: e,
  rows: r
  ...
  r.map((o, n) => /* @__PURE__ */ t(v6, { width: o }, n))
] });
function w6() {
...
function Q6({
  ...
  const [i, l] = B([]), [d, c] = B(!1), [u, f] = B(null), [p, C] = B(x6), [h, m] = B(() => /* @__PURE__ */ new Set()), v = _(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);

...
const N0 = (e, r) => /* @__PURE__ */ i(
  ...
  Wifi: i2,
  Windows: Nn
}, Symbol.toStringTag, { value: "Module" })), g9 = ["xs", "sm", "md", "lg"], Dt = ({
  inProgress: e,
  hasDataToSend: r,
  isPreSending: o,
...
const P2 = /[\\`*_{}[\]()#+\-.!|~>]/g, D2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(P2, "\\$&")).join(""), w9 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,

...
import { useInsertionEffect as Zr, forwardRef as g, useRef as D, useEffect as K, useLayoutEffect as it, useState as P, useMemo as J, useCallback as z, createContext as Ge, useContext as Be, useId as at, createElement as _r, memo as Or } from "react";
import { cU as Ur, cV as zr, cW as Gr, cX as Wr, cY as ct, cZ as qr, c_ as Xr, c$ as Yr, d0 as Kr, d1 as Qr, d2 as lt, d3 as Jr, d4 as en, d5 as tn, d6 as rn, d7 as nn, d8 as on, d9 as sn, da as ze, db as an, dc as cn, dd as ln, de as dn, df as un, Z as dt, bX as fn, dg as hn, dh as gn, di as pn, dj as mn, b$ as ut, bW as Cn, dk as vn, a6 as i1, dl as wn, aK as xn, dm as kn, dn as Ln, dp as bn, ah as yn, dq as Mn, co as En, aa as ft, ad as Rn, dr as Fn, ba as a1, a1 as ht, S as We, bN as gt, bi as Nn, ds as Vn, dt as Sn, b3 as Tn, cn as An, $ as Fe, av as Hn, bm as pt, du as $n, cl as Bn, bV as Me, ch as In, dv as Pn, bP as mt, b2 as Dn, dw as jn, dx as Zn, dy as _n, dz as On, dA as Un, dB as Ct, ca as zn, cb as Gn, dC as Wn, dD as qn, dE as Xn, dF as Yn, dG as Kn, bw as Qn, bZ as Jn, dH as eo, dI as to, dJ as ro, dK as no, dL as oo, dM as so, dN as io, dO as ao, bv as co, cm as lo, ab as uo, c6 as fo, dP as ho, dQ as go, dR as po, dS as mo, dT as Co, dU as vo, dV as wo, aq as xo, bR as vt, M as ko, a0 as Lo, bK as wt, bO as bo, bQ as xt, dW as yo, bl as Mo, bk as Eo, dX as Ro, dY as Fo, bx as kt, by as No, bz as Vo, b1 as So, az as To, dZ as Ao, at as Ho, bg as Lt, bf as bt, b8 as $o, d_ as yt, b7 as Bo, bY as c1, d$ as Io, bc as l1, e0 as Po, e1 as Do, e2 as d1, cj as jo, ci as Zo, ck as Mt, e3 as _o, G as Oo, E as Uo, e4 as zo, e5 as Go, e6 as Wo, e7 as qo, bL as Xo, e8 as Et, e9 as Yo, ac as Ko, ea as Qo, L as ue, o as L, q as Se, c0 as Jo, u as Y, bJ as es, U as ge, bI as Rt, H as fe, v as pe, a2 as ts, Q as ve, eb as rs, ae as le, aQ as ke, A as Ee, p as re, ct as Ft, aE as u1, ec as ns, aG as f1, b as be, bG as os, ed as ss, bH as is, V as as, b0 as cs, a5 as h1, bA as ls, bB as ds, bC as us, bD as M1, a3 as fs, al as Nt, aT as Vt, ee as hs, cA as gs, ef as ps, eg as ms, aY as St, eh as Cs, cu as vs, ei as ws, aV as $e, b9 as Tt, ej as At, bb as Ht, c as n1, b_ as E1, ek as $t, el as xs, bq as ks, em as Ls, bh as g1, c7 as bs, en as ys, eo as Ms, ep as Es, eq as Rs, er as Fs, a8 as Ns, af as Vs, aF as Bt, y as Ss, z as Ts, ak as R1, es as It, et as Pt, eu as As, ev as Hs, aj as $s, a7 as Bs, ew as Is, ex as Ps, d as Ds } from "./F0CanvasPanel-BgGyMiWm.js";
...
function jt(e, t, n, o) {
  return typeof e == "string" && p1(t) ? Ur(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Os(e, t, n) {
  return e * (t + 1);
}
...
function Ks(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  const i = t.duration || 0.3, l = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), a = {}, f = /* @__PURE__ */ new Map();
  let u = 0, p = 0, m = 0;
  for (let h = 0; h < e.length; h++) {
    ...
    if (typeof C == "string") {
      ...
      f.set(C.name, F1(p, C.at, u, f));
      continue;
    }
    let [v, w, M = {}] = C;
    M.at !== void 0 && (p = F1(p, M.at, u, f));
    let A = 0;
    const H = (N, b, x, k = 0, E = 0) => {
      ...
      if (ae > 0 && Yr(F, ae), V.length === 1 && V.unshift(null), Z) {
        lt(Z < Ys, "Repeat count too high, must be less than 20"), _ = Os(_, Z);
        const se = [...V], ne = [...F];
    ...
    if (ct(v)) {
      ...
      const N = jt(v, w, o, a), b = N.length;
      for (let x = 0; x < b; x++) {
        w = w, M = M;
        const k = N[x], E = N1(k, d);
        for (const V in w)
          H(w[V], Js(M, V), V1(V, E), x, b);
      }
    }
    u = p, p += A;
  }
  return d.forEach((h, C) => {
    for (const v in h) {
      ...
      A[0] !== 0 && (A.unshift(0), M.unshift(M[0]), H.unshift(Xs)), A[A.length - 1] !== 1 && (A.push(1), M.push(null)), l.has(C) || l.set(C, {
        keyframes: {},
        transition: {}
      });
      const N = l.get(C);
...
function ii(e, t) {
  return ct(e) || typeof e == "number" || typeof e == "string" && !p1(t);
}
function _t(e, t, n, o) {
  const s = [];
  if (ii(e, t))
    s.push(an(e, p1(t) && t.default || t, n && (n.default || n)));
  else {
    const i = jt(e, t, o), l = i.length;
    lt(!!l, "No valid elements provided.");
    for (let d = 0; d < l; d++) {
      const a = i[d], f = a instanceof Element ? oi : si;
      ze.has(a) || f(a);
      const u = ze.get(a), p = { ...n };
      "delay" in p && typeof p.delay == "function" && (p.delay = p.delay(d, l)), s.push(...cn(u, { ...t, transition: p }, {}));
    }
  }
  return s;
}
function ai(e, t, n) {
  const o = [];
  return Ks(e, t, n, { spring: ln }).forEach(({ keyframes: i, transition: l }, d) => {
    o.push(..._t(d, i, l));
  }), o;
}
class ci {
...
const Nl = Se({
  ...
  ({
    ...
    const Ne = I && I !== "none" || te && te !== "none" || W && W !== "none" || ae && ae !== "none", Pe = q && q !== "none" || Ne, De = { sm: qe, md: Xe, lg: Ye, xl: Ie }, Je = Vl.map((je) => {
      const Ze = De[je];
      return Ze ? Fl(je, Ze) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
function Al({
  ...
  const o = /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(fe, { icon: dt, size: "md", color: "critical" }),
...
function Bl({
  ...
  return !e || f ? null : /* @__PURE__ */ r(
    "div",
    {
      ...
      children: a ? Array.from({ length: 3 }, (u, p) => /* @__PURE__ */ c(
        "div",
        {
...
const Il = ({
  ...
  const s = ke(), [i, l] = P(""), [d, a] = P(0), [f, u] = P(!1), p = D(null), m = D(null), h = D(null), C = e[d] ?? t;
  return K(() => {
    const v = () => {
    ...
    if (s)
      return u(!1), l(C), v(), p.current = setTimeout(() => {
    ...
    return m.current = setInterval(() => {
      w < C.length ? (l(C.slice(0, w + 1)), w++) : (m.current && (clearInterval(m.current), m.current = null), p.current = setTimeout(() => {
        h.current = setInterval(() => {
          w > 0 ? (w--, l(C.slice(0, w))) : (h.current && (clearInterval(h.current), h.current = null), p.current = setTimeout(() => {
            const b = (d + 1) % Math.max(e.length, 1);
            a(b);
          }, N));
        }, A);
...
`) ? n + "_" : n
      ...
      /* @__PURE__ */ r(
        "textarea",
        {
          ...
          className: L(
            ...
            !a && (n || !f ? "caret-f1-foreground" : "caret-transparent")
          )
        }
      ),
      f && /* @__PURE__ */ r(
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ r("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, jl).map((t) => /* @__PURE__ */ r(
  Ft,
  {
...
const Ul = ({
  ...
  const [s, i] = P(null), l = D(null), d = s !== null ? e[s] : null;
  return e.length === 0 ? null : /* @__PURE__ */ c(
    u1,
    {
      ...
      children: [
        /* @__PURE__ */ r(ns, { asChild: !0, children: /* @__PURE__ */ r("div", { ref: l, className: "flex w-full flex-wrap items-center gap-2", children: e.map((a, f) => /* @__PURE__ */ r(
          ue,
          {
            variant: "outline",
            label: a.label,
        ...
        d && /* @__PURE__ */ c(
          f1,
          {
            ...
            onPointerDownOutside: (a) => {
              const f = a.target;
              f && l.current?.contains(f) && a.preventDefault();
            },
            className: L(
            ...
            children: [
              /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ r(fe, { icon: d.icon, size: "sm" }),
                /* @__PURE__ */ r("span", { children: d.label })
              ] }),
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: Ol(d.items).map((a, f) => /* @__PURE__ */ c(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
function zl(e, t, n) {
  ...
  const f = (u) => {
    ...
    o > d && l.push({ type: "text", text: e.slice(d, o) }), l.push({ type: "ghost", text: s }), a = !0, o < u && l.push({ type: "text", text: e.slice(o, u) }), d = u;
  };
  for (const u of i)
    f(u.start), l.push({ type: "mention", text: e.slice(u.start, u.end) }), d = u.end;
  return f(e.length), !a && s && o >= d && l.push({ type: "ghost", text: s }), l.length === 0 ? [{ type: "text", text: e }] : l;
}
function Gl(e, t) {
  if (t === "*/*") return !0;
  if (t.endsWith("/*")) {
...
function Xl(e) {
  const [t, n] = P([]), [o, s] = P(null), i = D(
    null
  ), l = D(null), d = Y(), a = e?.onUploadFiles, f = e?.allowedMimeTypes, u = e?.maxFiles, p = J(() => {
    if (f)
...
function Ql(e, t) {
  ...
  for (const a of Kl)
    o.setProperty(a, s.getPropertyValue(a));
...
function e2({
  ...
  const [i, l] = P(!1), [d, a] = P(""), [f, u] = P([]), [p, m] = P(!1), [h, C] = P(0), [v, w] = P([]), M = D(-1), A = D(null), H = D(0), N = D(-1);
  K(() => {
    if (!o) {
      l(!1);
      return;
    ...
    const F = Yl(e, n, v);
    if (!F) {
      l(!1), a(""), u([]), C(0), M.current = -1, N.current = -1;
      return;
    }
    if (F.atIndex === N.current)
      return;
    M.current = F.atIndex, a(F.query), l(!0), C(0), m(!0), A.current && clearTimeout(A.current);
    const B = ++H.current;
    return A.current = setTimeout(() => {
      o(F.query).then((Z) => {
        B === H.current && (u(Z), C(0), Z.length === 0 && F.query.length > 0 && (N.current = F.atIndex, l(!1)));
      }).catch(() => {
        B === H.current && u([]);
      }).finally(() => {
        B === H.current && m(!1);
  ...
  const b = z(() => {
    ...
    (F) => {
      ...
      for (const U of Z) {
        const G = `@${U.name}`, ee = `<entity-ref type="person" id="${S1(U.id)}">${S1(U.name)}</entity-ref>`;
        for (; B.includes(G); )
          B = B.replace(G, ee);
      }
      return B;
...
const t2 = /[\\`*_{}[\]()#+\-.!|~>]/g, r2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(t2, "\\$&")).join(""), A4 = ({
  ...
  const k = Y(), E = ke(), [V, S] = P(""), [F, B] = P(0), [Z, U] = P(!1), [G, ee] = P(!1), [X, _] = P(null), q = D(null), I = D(null), te = D(null), W = l != null, { tracking: ae } = be(), Ce = z(
    (Q, xe) => {
  ...
  const Ie = we.status === "recording", Ke = Ie ? k.ai.listening : k.ai.inputPlaceholder, Qe = se.filter((Q) => Q.status === "uploaded"), Ne = se.some((Q) => Q.status === "uploading"), Pe = se.some((Q) => Q.status === "error"), De = V.trim().length > 0;
  K(() => {
    if (!(!G || Ne)) {
      if (ee(!1), Pe) {
  ...
  }, v1 = X ? X.prompt ?? X.title : null, w1 = Ie ? [k.ai.listening] : v1 ? [v1] : s ?? [], Br = w1.length > 1, Ir = J(() => zl(V, oe.mentions, {
    cursorPosition: F,
    inlineCompletion: oe.inlineCompletion
  }), [V, oe.mentions, F, oe.inlineCompletion]), Pr = oe.mentions.length > 0 || oe.inlineCompletion !== null, x1 = M && !!H && H.length > 0 && !!N ? /* @__PURE__ */ r(
    Ul,
    {
      suggestions: H,
      onItemClick: Ce,
  ...
  ) : null, Dr = M && A && !!b && b.length > 0, k1 = A && M, { motionProps: jr } = ss(
    M,
    160,
    0.5
  );
  return /* @__PURE__ */ c(
    re.div,
    {
      ...
      children: [
        ...
        Dr && /* @__PURE__ */ r("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ r(Zl, { cards: b }) }),
...
function Te({
  ...
  const i = D(/* @__PURE__ */ new Map()), [l, d] = P(
    () => i.current.get(e) ?? null
  ), [a, f] = P(!1), [u, p] = P(!1), m = D(!0);
  K(() => () => {
    m.current = !1;
  }, []);
  const h = z(() => {
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          us,
          {
            ...
            children: a ? /* @__PURE__ */ r(M1.Skeleton, {}) : /* @__PURE__ */ r(M1, { ...C })
          }
        )
      ]
    }
...
function L2({
  ...
  const { entityRefs: n } = be(), o = n?.resolvers?.candidate, s = Y(), i = n?.urls?.candidate?.(e), l = J(
    () => (a) => {
      const f = [];
...
function b2({ id: e, label: t }) {
  const { entityRefs: n } = be(), o = n?.resolvers?.expense, s = Y(), i = n?.urls?.expense?.(e), l = J(
    () => (a) => ({
      avatar: {
        type: "icon",
        icon: Ut
...
function y2({
  ...
  const { entityRefs: n } = be(), o = n?.resolvers?.jobPosting, s = Y(), i = n?.urls?.jobPosting?.(e), l = J(
    () => (a) => ({
      title: a.title,
...
function E2({
  ...
  const { entityRefs: n } = be(), o = n?.resolvers?.requisition, s = Y(), i = n?.urls?.requisition?.(e), l = J(
    () => (a) => {
      const f = a.lineManager ? `${a.lineManager.firstName} ${a.lineManager.lastName}` : void 0, p = [
        a.status ? {
...
function R2({ id: e, label: t }) {
  const { entityRefs: n } = be(), o = n?.resolvers?.person, s = Y(), i = n?.urls?.person?.(e), l = J(
    () => (a) => ({
      avatar: {
        type: "person",
        firstName: a.firstName,
...
function F2({ id: e, label: t }) {
  const { entityRefs: n } = be(), o = n?.resolvers?.vacancy, s = Y(), i = n?.urls?.vacancy?.(e), l = J(
    () => (a) => ({
      title: a.name,
...
function mr({
  ...
  const l = Y(), d = s.type === "open", a = d ? o ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ c(
    "div",
    {
      className: L(
...
function $4({
  ...
  return /* @__PURE__ */ r(C1.Provider, { value: i, children: e });
}
function T2(e) {
  const n = Be(C1)?.formatters;
  return J(() => !n || n.length === 0 ? null : (o, s, i) => {
    ...
    for (const a of n) {
      ...
      if (!f || !u) continue;
      let p = 0;
      a.formName !== void 0 && (p += 2), a.customFieldName !== void 0 && (p += 1), p > d && (d = p, l = a);
    }
    if (l)
      return l.format(s, { key: o, ...i });
  }, [n, e]);
}
function B4() {
  const e = Be(C1);
...
const T1 = 7, A2 = 625, A1 = /* @__PURE__ */ new Set();
function H2(e) {
...
function Cr(e, t) {
  ...
  if (t === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: n, to: o } = e, s = H1(n) ? $1(n) : String(n), i = H1(o) ? $1(o) : String(o);
...
function vr({
  ...
  const { canvasContent: a, openCanvas: f, closeCanvas: u } = be(), p = T2(e), m = d ?? p, h = D(() => {
  }), C = o ?? e, v = s ?? t ?? "", w = a?.type === "form" && a.formName === e, M = () => f({
    type: "form",
    title: C,
    description: v,
    formName: e,
  ...
  h.current = M, K(() => {
    typeof window > "u" || window.innerWidth < A2 || A1.has(e) || (A1.add(e), h.current());
  }, [e]);
  const A = i && l ? Object.entries(i).map(([b, x]) => {
    const k = l[b], E = m?.(b, k, {
...
function xr({ anchor: e, onReply: t }) {
  ...
  if (it(() => {
    ...
    const d = o.current;
    if (!d) return;
    const a = d.offsetWidth, f = d.offsetHeight, u = window.innerWidth, p = window.innerHeight;
    let m = e.rect.top - f - I1;
    m < He && (m = e.rect.bottom + I1), m = Math.min(
      Math.max(m, He),
      p - f - He
    );
    const h = e.rect.left + e.rect.width / 2 - a / 2, C = Math.min(
      Math.max(h, He),
      u - a - He
    );
    i({ top: m, left: C });
...
const kr = Ge(void 0), I4 = () => Be(kr), j2 = (e) => /* @__PURE__ */ r(St, { content: e, format: "markdown" }), Z2 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const d = typeof n?.content == "string" ? n.content : "", a = (n && o?.(n)) ?? n?.generativeUI?.() ?? null, f = n?.toolCalls?.[0]?.id, u = !d && !a, p = D(null), { anchor: m, clear: h } = wr({
    containerRef: p,
    enabled: !!(n?.id && d)
  });
  return K(() => {
  ...
  const [s, i] = P(""), l = Y(), { title: d, label: a, placeholder: f } = n === "like" ? l.ai.feedbackModal.positive : l.ai.feedbackModal.negative, u = z(() => {
    t(o, s);
  }, [s, o, t]), p = () => {
    e(o);
  };
...
const z2 = ({
  ...
  const o = Y(), { open: s } = br(), [i, l] = P(null);
  ...
  const [d, a] = P(s), f = ke(), u = o !== void 0, p = u ? o : d;
  return /* @__PURE__ */ c(
    Tt,
    {
        ...
        /* @__PURE__ */ c(
          At,
          {
            ...
            children: [
              ...
              !l && /* @__PURE__ */ r(fe, { icon: We })
            ]
          }
        ),
        /* @__PURE__ */ r(Ht, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ r(
          re.div,
          {
            initial: !1,
            animate: {
  ...
  const s = Y(), [i, l] = P(!!n), d = D(n);
  K(() => {
    d.current && !n ? l(!1) : n && !i && l(!0), d.current = n;
  }, [n, i]);
  const a = n ? s.ai.thoughtsGroupTitle : t ?? s.ai.thoughtsGroupTitle, f = e.length - 1, u = (p) => !n || o ? "completed" : p === f ? "executing" : "completed";
  return /* @__PURE__ */ r(
    G2,
    {
      icon: Ot,
...
const yr = (e) => /* @__PURE__ */ r(St, { content: e, format: "markdown" }), Y2 = ({
  text: e,
  renderMarkdown: t
  ...
  const l = e.rawData, d = X2(
    e?.content,
    l
  ), a = (q2(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = a.length > 0, { anchor: p, clear: m } = wr({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ c(
  ...
  const [o, s] = P(0), [i, l] = P(0), [d, a] = P("starting"), f = e[o] ?? "";
  K(() => {
    e.length > 0 && o >= e.length && (s(0), l(0), a("starting"));
  }, [e.length, o]), K(() => {
    let m;
    if (d === "starting")
      m = setTimeout(() => a("writing"), e6);
    else if (d === "writing")
      i < f.length ? m = setTimeout(() => l((h) => h + 1), Q2) : a("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      m = setTimeout(() => a("erasing"), t6);
    } else d === "erasing" && (i > 0 ? m = setTimeout(() => l((h) => h - 1), J2) : m = setTimeout(() => {
      s((h) => (h + 1) % e.length), a("starting");
    }, r6));
    return () => {
      m && clearTimeout(m);
    };
...
function o6({
  ...
  const [l, d] = P(0), [a, f] = P(!1), u = D(s), p = D(i);
  p.current = i;
  const m = z(
    (C = "smooth") => {
  ...
  }, [s, o, e]), { showScrollBtn: a, turnMinHeight: l, scrollToBottom: m };
}
const s6 = {
  threadId: "",
  onThumbsUp: () => {
  ...
  }, [o, x.ai.defaultInitialMessage]), S = !t && e.length === 0 && V.length > 0, F = D(null), B = D(null), Z = D(null), U = D(null), G = D(null), { showScrollBtn: ee, turnMinHeight: X, scrollToBottom: _ } = o6({
    viewportRef: F,
    contentRef: B,
    endRef: Z,
    lastTurnRef: G,
  ...
  return /* @__PURE__ */ c(Re, { children: [
    /* @__PURE__ */ c("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
      ...
      !m && !S && /* @__PURE__ */ c(Re, { children: [
        /* @__PURE__ */ r(E1, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ r(E1, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    H.isOpen && /* @__PURE__ */ r(
      _2,
...
const l6 = ({
  ...
  ({ option: e, isSelected: t, mode: n, isTabStop: o, onToggle: s, onKeyNavigate: i }, l) => n === "single" ? /* @__PURE__ */ c(
    "div",
    {
      ref: l,
      role: "radio",
...
const u6 = ({
  ...
  const n = Y(), o = ke(), {
  ...
  } = s, k = D(null), E = A ?? "single", V = l > 1, S = i === 0, F = i === l - 1, B = V ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(l)
    ...
    d(se), E === "single" && !F && !ne && Promise.resolve().then(a);
...
function P1(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), d = Math.min(i + o, s), a = Math.min(d, Math.floor(e / 2)), f = Math.min(d, Math.floor(t / 2)), u = (W) => W / e * 2 - 1, p = (W) => W / t * 2 - 1, m = 0, h = e, C = 0, v = t, w = a, M = e - a, A = f, H = t - f, N = u(m), b = u(h), x = p(C), k = p(v), E = u(w), V = u(M), S = p(A), F = p(H), B = 0, Z = 0, U = 1, G = 1, ee = a / e, X = 1 - a / e, _ = f / t, q = 1 - f / t, I = new Float32Array([
    // Top strip
    N,
    x,
    b,
...
function m6(e, t, n) {
  ...
  if (e.attachShader(i, o), e.attachShader(i, s), e.linkProgram(i), !e.getProgramParameter(i, e.LINK_STATUS)) {
    ...
    throw e.deleteProgram(i), e.deleteShader(o), e.deleteShader(s), new Error(l);
  }
...
class U4 {
  ...
  resize(t, n, o) {
    ...
    const { gl: s, program: i, vao: l, positionBuffer: d, uvBuffer: a, uResolution: f } = this.glr, u = o ?? this.options.ratio ?? window.devicePixelRatio ?? 1, p = Math.max(1, Math.floor(t * u)), m = Math.max(1, Math.floor(n * u));
    ...
    s.enableVertexAttribArray(v), s.vertexAttribPointer(v, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, a), s.bufferData(s.ARRAY_BUFFER, C, s.STATIC_DRAW);
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: l, uvs: d } = P1(
      s,
      i,
...
const j1 = ["lowp", "mediump", "highp"], k6 = `
void main(void){
...
}`, _1 = "iTime", O1 = "iTimeDelta", U1 = "iDate", z1 = "iFrame", G1 = "iMouse", W1 = "iResolution", b6 = "iChannel", q1 = "iChannelResolution", X1 = "iDeviceOrientation";
function y6(e, t) {
...
}, r1 = 9729, Y1 = 9728, N6 = 9987, K1 = 33071, Q1 = 10497;
class V6 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    Object.assign(this, { url: o, wrapS: s, wrapT: i, minFilter: l, magFilter: d, flipY: a });
    ...
    return (t.wrapS !== K1 || t.wrapT !== K1 || t.minFilter !== Y1 && t.minFilter !== r1) && !x && (b = this.makePowerOf2(b), x = !0), n.bindTexture(n.TEXTURE_2D, H), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, a), n.texImage2D(
      n.TEXTURE_2D,
      p,
      m,
      w,
      M,
      b
    ), x && t.minFilter !== Y1 && t.minFilter !== r1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || Q1
    ), n.texParameteri(
...
const Le = (e) => `react-shaders: ${e}`, J1 = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, et = (e, t, n) => e * (1 - n) + t * n, S6 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function T6({
  fs: e,
  vs: t = Z1,
  textures: n = [],
  ...
  const h = D(null), C = D(null), v = D(null), w = D(null), M = D(void 0), A = D(void 0), H = D(!1), N = D(void 0), b = D(0), x = D([0, 0]), k = D([]), E = D(0), V = D(void 0), S = D({
    ...
    [W1]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    ...
    const R = "width" in y ? y.width ?? 0 : 0, j = "height" in y ? y.height ?? 0 : 0, $ = S.current.iChannelResolution;
    if (!$) return;
    ...
    const [T = 0, R = 0] = J1(y), j = T - (N.current?.left ?? 0) - window.pageXOffset, $ = (N.current?.height ?? 0) - R - (N.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    ...
    const [T = 0, R = 0] = J1(y), j = T - (N.current?.left ?? 0), $ = (N.current?.height ?? 0) - R - (N.current?.top ?? 0);
    if (a !== 1)
    ...
    if (y.canvas.width = R, y.canvas.height = j, S.current.iResolution?.isNeeded && w.current) {
...
${T}`));
      ...
      R.deleteShader(j), p?.(Le(`Shader compiler log: ${$}`));
    }
    return j;
  }, te = (y, T) => {
    const R = C.current;
      ...
      if (n && n.length > 0) {
        ...
        const T = n.map(
          (R, j) => (S.current[`${b6}${j}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(R, j), k.current[j] = new V6(y), k.current[j]?.load(R).then(($) => {
            B($, j);
          }))
        );
        Promise.all(T).then(() => {
    ...
    const T = j1.includes(i ?? "highp"), R = `precision ${T ? i : j1[1]} float;
`;
    T || m?.(
      Le(
...
`,
    ...
    return y.includes("mainImage") && (j = j.concat(k6)), j;
  }, se = (y) => {
    const T = C.current;
    ...
    if (S.current.iMouse?.isNeeded && a !== 1 && Array.isArray(R)) {
      const j = R[0] ?? 0, $ = R[1] ?? 0;
      R[0] = et(j, x.current[0] ?? 0, a), R[1] = et($, x.current[1] ?? 0, a);
    }
  ...
  return K(() => {
    ...
    function T() {
      Z();
      const R = C.current;
      R && h.current && (R.clearColor(...s), R.clearDepth(1), R.enable(R.DEPTH_TEST), R.depthFunc(R.LEQUAL), R.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, W(), ae(), te(Ce(e || L6), t || Z1), U(), requestAnimationFrame(ne), ie(), q());
    }
...
function D6(e, t) {
  const [n, o] = P(H6), {
    ...
    animate: i,
    motionValue: l
  } = Oe(I6), { value: d, animate: a } = Oe($6), { value: f, animate: u } = Oe(B6), { value: p, animate: m } = Oe(P6), h = Zs(t, {
    fftSize: 512,
  ...
  return K(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        o(10), i(0.2, me), a(1.2, me), u(0.4, me), m(1, me);
        return;
      case "listening":
      case "pre-connect-buffering":
        o(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), a(1, me), u(0.7, me), m([1.5, 2], tt);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        o(30), i(0.3, me), a(0.5, me), u(1, me), m([0.5, 2.5], tt);
        return;
      case "speaking":
        o(70), i(0.3, me), a(0.75, me), u(1.25, me), m(1.5, me);
        return;
    }
  }, [
    e,
...
function z4({
  ...
  const { speed: f, scale: u, amplitude: p, frequency: m, brightness: h } = D6(t, s);
  return /* @__PURE__ */ r(
    Fr,
    {
      ref: d,
...
const X6 = ({
  ...
  const s = `sparkline-gradient-${at().replace(/:/g, "")}`, i = q6(e, n), l = Vr[i];
...
function o4(e) {
  ...
  } = e, [a, f] = P(!1), u = at(), p = D(null), m = e4(
    d
  ), h = i.length > m, C = a ? i : t4(i, m), v = r4(e) ? e : null, w = n4(e);
  return K(() => {
    a && p.current?.focus();
  }, [a]), /* @__PURE__ */ c(
    "section",
...
const s4 = ({
  ...
  return /* @__PURE__ */ c(
    Tt,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ c(At, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, i4 = (e) => ll[e] ?? Ct, a4 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(fe, { icon: i4(e), size: "md", color: "default" }) }) : null;
function c4({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(s4, { icon: l1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const l = /* @__PURE__ */ r(a4, { iconName: s.icon });
...
function d4({
  ...
  const o = Y(), s = D(null), i = t ?? o.ai.aiTable.title, l = z(
    (d) => {
      if (!s.current) return;
      const a = n ?? (i.replace(/\s+/g, "_").toLowerCase() || "table");
      l4(s.current, d, a);
    },
    [i, n]
  );
...
function u4({ credits: e, trigger: t }) {
  const n = Y(), [o, s] = P(!1), [i, l] = P(!1), [d, a] = P(!1), [f, u] = P(null), p = z(
    (C) => {
      s(C), C && e?.fetchUsage && (l(!0), a(!1), e.fetchUsage().then((v) => {
        u(v), a(!1);
      }).catch(() => {
        a(!0);
      }).finally(() => {
  ...
  return /* @__PURE__ */ c(u1, { open: o, onOpenChange: p, children: [
    /* @__PURE__ */ r(Bt, { asChild: !0, children: t ?? /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
        hideLabel: !0,
...
function h4({
  ...
  const n = Y(), o = ke(), [s, i] = P(!1), [l, d] = P(!1), [a, f] = P(!1), [u, p] = P(null), m = z(
    (w) => {
      ...
      f1,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2 p-3", children: [
            ...
            a && /* @__PURE__ */ r("span", { className: "text-sm text-f1-foreground-secondary", children: n.t("ai.credits.creditsError") }),
            !l && !a && u && /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ c("div", { className: "flex justify-between", children: [
      ...
      children: [
        ...
        o ? (
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ r(h1, { items: u, children: /* @__PURE__ */ r(
              ue,
              {
                icon: mt,
                variant: "ghost",
...
const nt = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], w4 = ({ width: e }) => /* @__PURE__ */ r("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ r(ge, { className: L("h-4 rounded", e) }) }), ot = ({
  titleWidth: e,
  rows: t
...
function x4() {
  return /* @__PURE__ */ c("div", { "aria-hidden": "true", className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ r(ot, { titleWidth: "w-12", rows: nt.slice(0, 2) }),
    /* @__PURE__ */ r(ot, { titleWidth: "w-24", rows: nt })
  ] });
}
const K4 = ({
  onClose: e,
                  ...
                  /* @__PURE__ */ r(
                    $e,
                    {
                      ...
                      children: /* @__PURE__ */ c("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ r(fe, { icon: m1, color: "default", size: "md" }),
...
function Q4({
  ...
  const [i, l] = P([]), [d, a] = P(!1), [f, u] = P(null), [p, m] = P(k4), [h, C] = P(() => /* @__PURE__ */ new Set()), v = z(async () => {
    a(!0), u(null);
    try {
      const x = await t();
      l(x);
  ...
  const w = z((x, k) => {
    m((E) => {
      ...
      const V = new Set(E);
      return k ? V.add(x) : V.delete(x), st(V), V;
    });
  }, []), M = z((x, k) => {
    C((E) => {
      if (k === E.has(x)) return E;
    ...
    async (x) => {
      M(x, !0);
      try {
        await n(x), l((k) => k.filter((E) => E.id !== x)), m((k) => {
          if (!k.has(x)) return k;
          const E = new Set(k);
          return E.delete(x), st(E), E;
        });
      } catch {
        v();
      } finally {
...
const L4 = re.create(Ds), b4 = ({
  ...
  const { t: i } = Y(), l = ke(), d = n ?? i("ai.applyingChanges");
  return K(() => {
    if (!t) return;

...
import { L as t, R as n, S as r, Tt as i, r as a } from "./F0Button-BFtTqm8n.js";
import { n as o, t as s } from "./utils-CVzxZnoI.js";
import { L as c, a as l, i as u, t as d } from "./popover-DDfM6CZG.js";
...
import { c as S, d as ee, f as te, n as ne, o as C, p as w, s as T, t as re, u as E } from "./dropdown-menu-BiGeoaAq.js";
...
function oe({ value: e, onChange: t, containerRef: n }) {
	...
	return /* @__PURE__ */ F(d, {
		...
		children: [/* @__PURE__ */ P(l, {
			...
			align: "end",
			sideOffset: 8,
			className: s("flex w-auto min-w-[7rem] flex-col gap-0.5 rounded-md border", "border-solid border-f1-border-secondary bg-f1-background p-1 shadow-md"),
			role: "menu",
...
function ue({ containerRef: e, audioLanguages: t, audioLanguage: n, onAudioLanguageChange: i, captionLanguages: o, captionLanguage: s, captionsOn: c, onCaptionLanguageChange: l, onCaptionsOff: u, audioDescriptionLanguages: d, audioDescriptionLanguage: f, audioDescriptionOn: m, onAudioDescriptionLanguageChange: h, onAudioDescriptionOff: _ }) {
...
function fe({ currentTime: e, duration: t, markerTime: n, blockSeekPastMarker: i = !1, onSeek: a }) {
	...
	return /* @__PURE__ */ F("div", {
		ref: l,
		className: s("relative flex h-4 flex-1 items-center rounded-sm", "cursor-pointer touch-none", o()),
		role: "slider",
		tabIndex: 0,
		...
		onKeyDown: (n) => {
			...
			n.preventDefault(), n.stopPropagation(), a(r);
		},
		children: [
...
function me({ volume: e, isMuted: t, onToggleMute: n, onVolumeChange: i, silent: o = !1 }) {
	let { t: s } = r(), c = t || e === 0;
	return o ? /* @__PURE__ */ P(a, {
		variant: "ghost",
		size: "sm",
		hideLabel: !0,
		disabled: !0,
		...
		children: [/* @__PURE__ */ P(a, {
			...
			hideLabel: !0,
			icon: pe(e, c),
			label: s(c ? "videoPlayer.unmute" : "videoPlayer.mute"),
			onClick: n
		}), /* @__PURE__ */ P(he, {
			value: c ? 0 : e,
			onChange: i
...
function he({ value: e, onChange: t }) {
	let { t: n } = r(), i = M(null), [a, c] = N(!1), l = Math.max(0, Math.min(1, e)), u = (e) => {
		let t = i.current;
		if (!t) return 0;
		...
		a && (c(!1), e.currentTarget.hasPointerCapture(e.pointerId) && e.currentTarget.releasePointerCapture(e.pointerId));
	};
	return /* @__PURE__ */ F("div", {
		ref: i,
		className: s("relative flex h-4 w-[60px] items-center rounded-sm", "cursor-pointer touch-none", o()),
		role: "slider",
		tabIndex: 0,
...
function Ne({ src: e, poster: n, ariaLabel: i, silent: a = !1, persistControls: c = !1, content: l, defaultLanguage: u, autoPlay: d = !1, autoFocus: f = !1, download: p, restrictForwardSeek: m = !1, onTrackAction: h, onMilestone: g, onComplete: _, ...v }) {
	...
	let me = Se({
		...
		toggleMute: a ? fe : q.toggleMute,
		toggleFullscreen: de,
		setVolume: a ? fe : q.setVolume
	});
	k(() => {
	...
	return /* @__PURE__ */ F("div", {
		ref: b,
		className: s("group relative h-full w-full overflow-hidden rounded-[inherit] bg-f1-foreground dark:bg-f1-background", "[&:fullscreen]:h-screen [&:fullscreen]:w-screen [&:fullscreen]:rounded-none", o()),
		role: "region",
		"aria-label": i ?? y("videoPlayer.regionLabel"),
		tabIndex: 0,
		onKeyDown: me,
		"data-video-captions": a ? "no-audio" : J.available ? "available" : "missing",
		...v,
		children: [
			/* @__PURE__ */ F("video", {
				ref: q.setVideoNode,
				...
				className: s("block h-full w-full cursor-pointer rounded-[inherit] object-contain transition-opacity duration-300", "[&::-webkit-media-text-track-container]:![transform:translateY(-3.5rem)]"),

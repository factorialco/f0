...
import { X as Zr, Y as Ur, Z as zr, _ as ft, $ as Gr, a0 as Wr, a1 as qr, a2 as Xr, a3 as Yr, a4 as Kr, a5 as ht, a6 as Qr, a7 as Jr, a8 as ne, a9 as en, aa as tn, ab as rn, ac as nn, ad as on, ae as sn, af as an, ag as ln, y as Ct, ah as cn, ai as dn, o as oe, aj as pt, ak as G1, n as mt, al as un, am as fn, an as hn, ao as Cn, ap as pn, aq as mn, ar as N1, as as gn, at as gt, au as wn, av as vn, l as R1, aw as Ln, ax as xn, ay as wt, az as bn, aA as kn, aB as yn, aC as Mn, aD as Rn, aE as Fn, aF as vt, aG as Nn, aH as Sn, aI as Vn, aJ as Tn, aK as Hn, aL as An, aM as En, aN as $n, aO as Bn, aP as In, aQ as Pn, aR as Dn, E as _n, aS as jn, aT as On, aU as Zn, aV as Un, aW as zn, aX as Gn, aY as Wn, aZ as qn, a_ as Xn, a$ as Yn, b0 as Kn, b1 as Qn, b2 as Jn, b3 as eo, b4 as to, b5 as ro, b6 as no, b7 as oo, U as Lt, b8 as so, b9 as ao, ba as io, bb as lo, bc as xt, R as bt, bd as co, i as uo, be as fo, bf as ho, bg as Co, bh as po, bi as mo, bj as kt, bk as go, bl as wo, bm as vo, bn as Lo, bo as xo, bp as bo, j as ko, bq as yt, br as Mt, bs as yo, bt as Rt, bu as Mo, bv as se, q as Ro, bw as ae, bx as Fo, by as No, bz as ie, O as So, Q as Vo, bA as Ft, bB as To, bC as Ho, bD as Ao, bE as Eo, bF as $o, bG as Bo, bH as Io, bI as Po, bJ as Do, bK as _o, bL as Nt, bM as jo, bN as Oo, bO as Zo, bP as Uo, u as G, bQ as r1, bR as zo, S as u1, bS as St, V as n1, bT as Go, m as w1, bU as Wo, bV as o1, bW as C1, bX as L1, bY as Y, bZ as Vt, t as le, b_ as qo, x as ce, b as y1, b$ as Xo, c0 as Yo, c1 as Ko, d as Tt, c2 as Qo, c3 as Jo, c4 as de, c5 as es, c6 as ts, c7 as rs, c8 as He, c9 as ns, ca as Ht, cb as At, cc as os, cd as ss, ce as as, cf as is, cg as ls, ch as Et, ci as cs, cj as ds, ck as us, cl as E1, cm as $t, cn as Bt, co as It, c as J1, cp as Ae, cq as Pt, cr as fs, cs as hs, ct as B1, cu as Cs, cv as ps, cw as ms, cx as ue, cy as gs, cz as ws, cA as vs, cB as Ls, cC as xs, cD as bs, w as ks, s as ys, cE as K1, v as Dt, cF as Ms, cG as Rs, cH as Ee, cI as _t, cJ as jt, cK as Fs, cL as Ns, cM as Ss, cN as Vs, cO as Ts, cP as Hs } from "./F0CanvasPanel-Bpwz5hl9.js";
import { d as b, f as f1, u as As } from "./tooltip-CMBdJvJA.js";
...
const _0 = (e, r) => /* @__PURE__ */ i(
...
), v2 = m(w2), L2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Zs,
  Add: Zr,
  Ai: Ur,
  ...
  CardPin: ka,
  ChartFunnel: Ma,
  ChartHorizontalBars: Fa,
  ChartLine: Sa,
  ChartPie: Ta,
  ChartVerticalBars: Aa,
  Check: Ct,
  CheckCircle: cn,
  CheckCircleLine: $a,
  CheckDouble: dn,
  ...
  DropdownOpen: xn,
  Ellipsis: wt,
  EllipsisHorizontal: bn,
  Envelope: kn,
  EnvelopeOpen: hi,
  Equal: yn,
  EqualApproximately: Mn,
  EqualGreater: Rn,
  EqualLess: Fn,
  Exit: pi,
  ExternalLink: vt,
  ...
  FaceNeutral: Tn,
  FacePositive: Hn,
  FaceSuperNegative: An,
  FaceSuperPositive: En,
  Feed: gi,
  File: $n,
  FileFilled: vi,
  FileSigned: xi,
  ...
  Minimize: bt,
  MinimizeHorizontal: co,
  Minus: uo,
  Mobile: V5,
  Money: Ut,
  MoneyBag: A5,
  MonitorDot: $5,
  MonitorSmartphone: I5,
  Moon: D5,
  Mouse: j5,
  MoveDown: fo,
  MoveTop: Z5,
  ...
  Wifi: v2,
  Windows: Uo
}, Symbol.toStringTag, { value: "Module" })), E4 = ["xs", "sm", "md", "lg"], $4 = [
  "inProgress",
  "executing",
  "writing",
  "completed"
...
function k2({
  ...
  return e.errorMessage ? /* @__PURE__ */ t(Go, { label: e.errorMessage, children: o }) : o;
}
const y2 = {
  soft: {
    text: "",
...
`) ? n + "_" : n
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, V2).map((r) => /* @__PURE__ */ t(
  Vt,
  {
...
const E2 = 5, $2 = 46, B2 = 400, I2 = 16, P2 = 16;
function D2(e, r = E2) {
...
const _2 = ({
  ...
  const [c, d] = I(null), l = $(null), f = a === "scroll", u = A2(), C = $(null), g = $(!1), h = U1(), w = U1(), v = c !== null ? e[c] : null;
      ...
      children: [
        /* @__PURE__ */ t(
          "div",
          {
            ...
            children: /* @__PURE__ */ t(qo, { asChild: !0, children: /* @__PURE__ */ t(
              "div",
              {
                ref: (p) => {
        ...
        v && /* @__PURE__ */ i(
          ce,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: D2(v.items).map((p, k) => /* @__PURE__ */ t(
                j2,
                {
                  item: p,
                  onHover: n,
...
function j2({ item: e, onSelect: r, onHover: n }) {
  const o = $(null), s = $(null), a = $(null), c = C1(), d = _(() => {
    ...
    c || (a.current = window.setTimeout(() => {
      ...
      if (h <= 0) return;
      const w = h + I2, v = w / $2 * 1e3;
      C.style.overflow = "visible";
      const p = `linear-gradient(90deg, transparent 0, #000 ${P2}px)`;
...
` || W === "	";
  ...
  const P = X(() => {
    ...
    const S = s.current;
    if (!S) return null;
    const B = X2(S, k.current), j = S.offsetLeft + B.left, W = (S.offsetParent ? S.offsetParent.offsetHeight : 0) - (S.offsetTop + B.top);
...
const Q2 = /[\\`*_{}[\]()#+\-.!|~>]/g, J2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, n) => n % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(Q2, "\\$&")).join(""), B4 = ({
  onSubmit: e,
  onStop: r,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const Nr = async (Z) => {
    if (Z.preventDefault(), !L) {
      if (l1.close(), n)
        ...
        const v1 = l1.transformMentions(j.trim()), Y1 = J2(v1), j1 = Le.flatMap(
  ...
  }, be = p1 ? p1.prompt ?? p1.title : null, ke = ve ? [S.ai.listening] : be ? [be] : s ?? [], Hr = ke.length > 1, Ar = X(() => O2(j, l1.mentions, {
    cursorPosition: W,
  ...
  ), Pr = R && H && !!V && V.length > 0, Ne = H && R, { motionProps: Dr } = Yo(
    R,
    160,
    0.5
  );
    ...
    Y.div,
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(M2, { creditWarning: a, children: /* @__PURE__ */ i(
            "form",
            {
              "aria-busy": n,
              ref: a1,
                        ...
                        Y.div,
                        {
                          ...
                          children: /* @__PURE__ */ i(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ t("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ t(Ko, { type: "critical", size: "sm" }) }),
        ...
        Pr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(T2, { cards: V }) }),
...
function s6({
  ...
  return /* @__PURE__ */ t(Jo, { ...r, variant: "link", href: r.href, children: e });
}
function a6({
  children: e,
  ...r
...
function S1({
  ...
  return /* @__PURE__ */ i(
    es,
    {
      ...
      children: [
        /* @__PURE__ */ t(ts, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          rs,
          {
            side: "top",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ t(os, { file: e.file, size: "lg" }),
          e?.type === "icon" && /* @__PURE__ */ t(ss, { icon: e.icon, size: "md" }),
...
const Be = 7, V6 = 625, Ie = /* @__PURE__ */ new Set();
function T6(e) {
...
function A6(e) {
  const { days: r, hours: n, minutes: o, seconds: s } = is(e), a = [];
...
function sr(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: A6(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const n = e.value;
    return { type: "item", text: (n ? T6(n) : "") || "—" };
  }
  ...
  return { type: "item", text: H6(String(e)) };
}
function ar({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: u } = y1(), C = S6(e), g = d ?? C, h = $(() => {
  ...
  h.current = k, z(() => {
    typeof window > "u" || window.innerWidth < V6 || Ie.has(e) || (Ie.add(e), h.current());
  }, [e]);
...
const cr = z1(void 0), _4 = () => $1(cr), I6 = (e) => /* @__PURE__ */ t(Et, { content: e, format: "markdown" }), P6 = ({
  isGenerating: e,
  isLoading: r,
  message: n,
  renderToolCall: o,
...
const fr = (e) => /* @__PURE__ */ t(Et, { content: e, format: "markdown" }), W6 = ({
  text: e,
  renderMarkdown: r
  ...
  const c = e.rawData, d = G6(
    e?.content,
    c
  ), l = (z6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = l.length > 0, { anchor: C, clear: g } = ir({
    containerRef: a,
    enabled: u
  });
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ t(W6, { text: f, renderMarkdown: o }),
...
}, X6 = 35, Y6 = 22, K6 = 400, Q6 = 2500, J6 = 220, el = ({
  messages: e,
  caption: r,
  subtitle: n,
  cta: o,
  ...
  z(() => {
    ...
    let R;
    if (u === "starting")
      R = setTimeout(() => C("writing"), K6);
    else if (u === "writing")
      l < h.length ? R = setTimeout(() => f((H) => H + 1), X6) : C("holding");
    else if (u === "holding") {
      if (e.length <= 1) return;
      R = setTimeout(() => C("erasing"), Q6);
    } else u === "erasing" && (l > 0 ? R = setTimeout(() => f((H) => H - 1), Y6) : R = setTimeout(() => {
...
const rl = {
...
}, j4 = (e) => /* @__PURE__ */ t(_6, { children: /* @__PURE__ */ t(nl, { ...e }) }), nl = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: x, handleSubmit: E, handleClose: V } = j6(
    h ?? rl
  ), P = G(), N = R ?? P6, S = H ?? q6, B = X(() => {
    const q = o ?? P.ai.defaultInitialMessage;
    return (Array.isArray(q) ? q : [q]).filter((a1) => typeof a1 == "string" && a1.length > 0);
  }, [o, P.ai.defaultInitialMessage]), j = !r && e.length === 0 && B.length > 0, O = $(null), W = $(null), e1 = $(null), t1 = $(null), K = $(null), { showScrollBtn: Q, turnMinHeight: s1, scrollToBottom: p1 } = tl({
    viewportRef: O,
    contentRef: W,
    endRef: e1,
    lastTurnRef: K,
...
}, ol = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ i("div", { className: "flex flex-col gap-2", children: [
...
const al = ({
  ...
  const g = G().ai.clarifyingQuestion.typeYourAnswer, h = $(null), w = As(h, c);
  re(() => {
    const p = h.current;
    if (!p) return;
    p.style.height = "auto";
...
const ll = [0.23, 1, 0.32, 1], cl = 0.2, dl = 0.03, ul = 4, fl = ({
  mode: e,
  question: r,
  options: n,
  selectedOptionIds: o,
...
class W4 {
  ...
  setupGL() {
    ...
    const T = (this.options.colors || Ll).map(xl);
...
const Ge = ["lowp", "mediump", "highp"], bl = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, kl = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, qe = "iTime", Xe = "iTimeDelta", Ye = "iDate", Ke = "iFrame", Qe = "iMouse", Je = "iResolution", yl = "iChannel", et = "iChannelResolution", tt = "iDeviceOrientation";
function Ml(e, r) {
...
}, Q1 = 9729, rt = 9728, Vl = 9987, nt = 33071, ot = 10497;
class Tl {
  gl;
  url;
  wrapS;
...
}, at = (e, r, n) => e * (1 - n) + r * n, Hl = (e, r, n) => n > 0 ? e.substring(0, n) + r + e.substring(n, e.length) : r + e;
function Al({
  fs: e,
  vs: r = We,
  textures: n = [],
      ...
      if (n && n.length > 0) {
        ...
        const y = n.map(
          (M, D) => (N.current[`${yl}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(M, D), E.current[D] = new Tl(L), E.current[D]?.load(M).then((A) => {
            B(A, D);
          }))
        );
        Promise.all(y).then(() => {
...
`,
    ...
    return L.includes("mainImage") && (D = D.concat(bl)), D;
  }, a1 = (L) => {
    const y = w.current;
  ...
  return z(() => {
    ...
    function y() {
      j();
      const M = w.current;
      M && h.current && (M.clearColor(...s), M.clearDepth(1), M.enable(M.DEPTH_TEST), M.depthFunc(M.LEQUAL), M.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, c1(), q(), p1(d1(e || kl), r || We), O(), requestAnimationFrame(J), x1(), Q());
    }
...
}`, $l = 10, Bl = 2, Il = 0.5, Pl = 0.2, Dl = 1.5, h1 = {
  duration: 0.5,
  ease: "easeOut"
}, it = {
  duration: 0.35,
...
function _l(e, r) {
  const [n, o] = I($l), {
    ...
    animate: a,
    motionValue: c
  } = O1(Pl), { value: d, animate: l } = O1(Bl), { value: f, animate: u } = O1(Il), { value: C, animate: g } = O1(Dl), h = $s(r, {
    fftSize: 512,
...
function q4({
  ...
  const { speed: f, scale: u, amplitude: C, frequency: g, brightness: h } = _l(r, s);
  return /* @__PURE__ */ t(
    mr,
    {
      ref: d,
...
const X4 = ({
  ...
  const o = G(), s = C1();
  return /* @__PURE__ */ i(F1, { children: [
    e && /* @__PURE__ */ t("span", { className: b(Ul(), "truncate"), children: e }),
    ...
    /* @__PURE__ */ i(
      Y.div,
      {
        ...
        children: [
          ...
          o === "alert" && /* @__PURE__ */ t(gs, { text: e.alertLabel, level: e.level }),
          o === "balance" && /* @__PURE__ */ t(Wl, { balance: e.balance })
        ]
      }
    ),
    n && !Gl.has(o) && /* @__PURE__ */ t(
      Y.span,
      {
        className: b(Z1()),
        animate: { opacity: s ? 0 : 1 },
...
const Yl = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), Kl = ({
  label: e,
  direction: r
}) => {
  const n = wr[r];
  ...
  const s = `sparkline-gradient-${U1().replace(/:/g, "")}`, a = Xl(e, n), c = wr[a];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(vs, { width: "100%", height: "100%", children: /* @__PURE__ */ i(
          Ls,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(xs, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                bs,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(Kl, { label: r, direction: a })
      ]
    }
  ) });
}, vr = m(
...
const Jl = ["className"], Lr = m((e, r) => {
  const n = Jl.reduce((o, s) => {
    const { [s]: a, ...c } = o;
    return c;
  }, e);
...
const e4 = () => /* @__PURE__ */ i(
  ...
  "balance",
  "sparkline"
], xr = 180, t4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : xr, r4 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, n4 = (e) => e.showActions !== !1, o4 = (e) => Object.fromEntries(
...
function s4(e) {
  ...
  } = e, [l, f] = I(!1), u = U1(), C = $(null), g = t4(
    d
  ), h = a.length > g, w = l ? a : r4(a, g), v = n4(e) ? e : null, p = o4(e);
  return z(() => {
    l && C.current?.focus();
  }, [l]), /* @__PURE__ */ i(
    "section",
...
s4.displayName = "F0AiProposalCard";
const a4 = ({
  icon: e,
  title: r,
  children: n
...
}, i4 = (e) => L2[e] ?? vt, l4 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(n1, { icon: i4(e), size: "md", color: "default" }) }) : null;
function c4({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(a4, { icon: ae, title: o, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, a) => {
    const c = /* @__PURE__ */ t(l4, { iconName: s.icon });
...
const h4 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function C4({
  employeeCredits: e,
  trigger: r
}) {
...
const te = ({
...
) : e ? /* @__PURE__ */ t(f4, { credits: e, trigger: n }) : null, Q4 = te, J4 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const w = G(), v = C1(), p = Ms(`(max-width: ${Rs.md}px)`, {
...
const ct = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], v4 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(u1, { className: b("h-4 rounded", e) }) }), dt = ({
  titleWidth: e,
  rows: r
  ...
  r.map((n, o) => /* @__PURE__ */ t(v4, { width: n }, o))
] });
function L4() {
...
function t9({
  ...
  const [a, c] = I([]), [d, l] = I(!1), [f, u] = I(null), [C, g] = I(x4), [h, w] = I(() => /* @__PURE__ */ new Set()), v = _(async () => {
    l(!0), u(null);
    try {
      const x = await r();
      c(x);

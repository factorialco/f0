...
const D0 = (e, r) => /* @__PURE__ */ i(
  ...
  Wifi: w2,
  Windows: zo
}, Symbol.toStringTag, { value: "Module" })), A4 = ["xs", "sm", "md", "lg"], Yt = ({
  inProgress: e,
...
const K2 = /[\\`*_{}[\]()#+\-.!|~>]/g, Q2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, n) => n % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(K2, "\\$&")).join(""), E4 = ({
  onSubmit: e,
  onStop: r,
  inProgress: n,
  onBeforeSubmit: o,

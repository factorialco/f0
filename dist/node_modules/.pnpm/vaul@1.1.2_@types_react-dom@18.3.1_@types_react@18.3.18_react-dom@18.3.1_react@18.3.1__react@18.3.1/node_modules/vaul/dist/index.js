import { Trigger as me, Root as pe, Overlay as we, Portal as he, Content as ge, Description as ve, Title as ye } from "../../../../@radix-ui_react-dialog@1.1.5_@types_react-dom@18.3.1_@types_react@18.3.18_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@radix-ui/react-dialog/dist/index.js";
...
const $e = 24, Ae = typeof window < "u" ? Se : Te;
function Bt(...t) {
  return (...n) => {
    for (let e of t)
...
function Ie() {
  let t, n = 0, e = (f) => {
    ...
    window.scrollTo(0, 0);
  }, w = window.pageXOffset, T = window.pageYOffset, E = Bt(_e(document.documentElement, "paddingRight", `${window.innerWidth - document.documentElement.clientWidth}px`));
  window.scrollTo(0, 0);
...
function Ft(t) {
  ...
  for (; t && t !== n; ) {
    ...
    if (e !== document.documentElement && e !== document.body && e !== t) {
      ...
      const v = e.getBoundingClientRect().bottom + $e;
      a > v && (e.scrollTop += i - o);
    }
    t = e.parentElement;
  }
...
function Dt(t) {
  return t instanceof HTMLInputElement && !Me.has(t.type) || t instanceof HTMLTextAreaElement || t instanceof HTMLElement && t.isContentEditable;
}
function He(t, n) {
  typeof t == "function" ? t(n) : t != null && (t.current = n);
}
function Ne(...t) {
  return (n) => t.forEach((e) => He(e, n));
}
function Yt(...t) {
  return be.useCallback(Ne(...t), t);
}
...
}, qt = 0.4, Ue = 0.25, Fe = 100, Xt = 8, Z = 16, Ot = 26, Et = "vaul-dragging";
function Kt(t) {
  const n = r.useRef(t);
  return r.useEffect(() => {
    n.current = t;
...
function We({ defaultProp: t, onChange: n }) {
...
function ze({ activeSnapPointProp: t, setActiveSnapPointProp: n, snapPoints: e, drawerRef: o, overlayRef: i, fadeFromIndex: a, onSnapPointChange: v, direction: w = "bottom", container: T, snapToSequentialPoint: E }) {
  const [h, f] = Gt({
    prop: t,
    defaultProp: e?.[0],
    onChange: n
...
function Ye() {
  const { direction: t, isOpen: n, shouldScaleBackground: e, setBackgroundColorOnScale: o, noBodyStyles: i } = ct(), a = r.useRef(null), v = Re(() => document.body.style.backgroundColor, []);
  function w() {
...
function qe({ open: t, onOpenChange: n, children: e, onDrag: o, onRelease: i, snapPoints: a, shouldScaleBackground: v = !1, setBackgroundColorOnScale: w = !0, closeThreshold: T = Ue, scrollLockTimeout: E = Fe, dismissible: h = !0, handleOnly: f = !1, fadeFromIndex: m = a && a.length - 1, activeSnapPoint: B, setActiveSnapPoint: L, fixed: D, modal: U = !0, onClose: p, nested: M, noBodyStyles: A = !1, direction: c = "bottom", defaultOpen: Y = !1, disablePreventScroll: J = !0, snapToSequentialPoint: u = !1, preventScrollRestoration: b = !1, repositionInputs: y = !0, onAnimationEnd: _, container: P, autoFocus: W = !1 }) {
  ...
  }, []), { activeSnapPoint: ee, activeSnapPointIndex: nt, setActiveSnapPoint: It, onRelease: ne, snapPointsOffset: it, onDrag: re, shouldFade: _t, getPercentageDragged: ae } = ze({
    snapPoints: a,
  ...
  const { restorePositionSetting: oe } = je({
    isOpen: H,
    modal: U,
    nested: M ?? !1,
    hasBeenOpened: I,
  ...
  function le(l) {
    if (d.current && X) {
      ...
      if (d.current.classList.add(Et), ot.current = !0, $(d.current, {
        ...
        const j = ke(R), mt = Math.min(j * -1, 0) * S;
        $(d.current, {
  ...
  r.useEffect(() => {
    ...
    function S() {
      ...
      if (Dt(R) || et.current) {
        ...
        } else De() || (d.current.style.height = `${bt.current}px`);
...
const Xe = 250, Ke = 120, Ge = /* @__PURE__ */ r.forwardRef(function({ preventCycle: t = !1, children: n, ...e }, o) {

...
function p(r, e, t) {
  return e = a(e), e in r ? Object.defineProperty(r, e, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : r[e] = t, r;
}
function a(r) {
  var e = b(r, "string");
...
var l = ["Webkit", "Moz", "O", "ms"], s = function(e, t) {
  var n = e.replace(/(\w)/, function(u) {
    return u.toUpperCase();
  }), i = l.reduce(function(u, y) {
    return f(f({}, u), {}, p({}, y + n, t));
  }, {});
  return i[e] = t, i;
};
export {
  s as generatePrefixStyle
};

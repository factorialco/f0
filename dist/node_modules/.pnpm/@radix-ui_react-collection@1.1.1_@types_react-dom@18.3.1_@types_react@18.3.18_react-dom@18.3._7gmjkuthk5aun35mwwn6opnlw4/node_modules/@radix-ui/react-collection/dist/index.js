...
import { Slot as x } from "../../../../../@radix-ui_react-slot@1.1.1_@types_react@18.3.18_react@18.3.1/node_modules/@radix-ui/react-slot/dist/index.js";
...
function h(s) {
  ...
  const C = s + "CollectionItemSlot", R = "data-radix-collection-item", M = n.forwardRef(
    (c, e) => {
      ...
      return n.useEffect(() => (i.itemMap.set(r, { ref: r, ...t }), () => {
        i.itemMap.delete(r);
      })), /* @__PURE__ */ d(x, { [R]: "", ref: I, children: o });
    }
  );
  M.displayName = C;
  function E(c) {

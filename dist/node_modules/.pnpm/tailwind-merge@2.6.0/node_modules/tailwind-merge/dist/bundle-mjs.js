const re = (e) => {
  ...
  return {
    getClassGroupId: (a) => {
      const s = a.split("-");
      return s[0] === "" && s.length !== 1 && s.shift(), Q(s, r) || te(a);
    },
  ...
  const t = e[0], o = r.nextPart.get(t), i = o ? Q(e.slice(1), o) : void 0;
  if (i)
    return i;
...
}, ne = (e) => e.isThemeGetter, se = (e, r) => r ? e.map(([t, o]) => {
...
const ie = (e) => {
  ...
  for (let u = a.length - 1; u >= 0; u -= 1) {
    ...
    const p = ae(m).join(":"), f = y ? p + "!" : p, h = f + b;
    if (n.includes(h))
      continue;
    n.push(h);
    const P = i(b, w);
...
function be(e, ...r) {
  ...
  function a(u) {
    ...
    return t = ce(g), o = t.cache.get, i = t.cache.set, n = s, s(u);
  }
  function s(u) {
    const g = o(u);
    if (g)
...
const c = (e) => {
...
}, D = /^\[(?:([a-z-]+):)?(.+)\]$/i, ge = /^\d+\/\d+$/, fe = /* @__PURE__ */ new Set(["px", "full", "screen"]), me = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, he = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, ye = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, xe = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, we = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, k = (e) => R(e) || fe.has(e) || ge.test(e), z = (e) => M(e, "length", Me), R = (e) => !!e && !Number.isNaN(Number(e)), V = (e) => M(e, "number", R), G = (e) => !!e && Number.isInteger(Number(e)), ve = (e) => e.endsWith("%") && R(e.slice(0, -1)), l = (e) => D.test(e), A = (e) => me.test(e), Ce = /* @__PURE__ */ new Set(["length", "size", "percentage"]), ke = (e) => M(e, Ce, ee), ze = (e) => M(e, "position", ee), Ae = /* @__PURE__ */ new Set(["image", "url"]), Se = (e) => M(e, Ae, Ie), Re = (e) => M(e, "", Pe), T = () => !0, M = (e, r, t) => {
  const o = D.exec(e);
  ...
  he.test(e) && !ye.test(e)
), ee = () => !1, Pe = (e) => xe.test(e), Ie = (e) => we.test(e), Ge = () => {
  const e = c("colors"), r = c("spacing"), t = c("blur"), o = c("brightness"), i = c("borderColor"), n = c("borderRadius"), a = c("borderSpacing"), s = c("borderWidth"), u = c("contrast"), g = c("grayscale"), m = c("hueRotate"), y = c("invert"), x = c("gap"), v = c("gradientColorStops"), w = c("gradientColorStopPositions"), b = c("inset"), p = c("margin"), f = c("opacity"), h = c("padding"), P = c("saturate"), S = c("scale"), E = c("sepia"), F = c("skew"), B = c("space"), U = c("translate"), L = () => ["auto", "contain", "none"], _ = () => ["auto", "hidden", "clip", "visible", "scroll"], O = () => ["auto", l, r], d = () => [l, r], q = () => ["", k, z], N = () => ["auto", R, l], J = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], j = () => ["solid", "dashed", "dotted", "double", "none"], X = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], W = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], I = () => ["", "0", l], Z = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], C = () => [R, l];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
      ...
      gradientColorStopPositions: [ve, z],
      inset: O(),
      margin: O(),
      opacity: C(),
      padding: d(),

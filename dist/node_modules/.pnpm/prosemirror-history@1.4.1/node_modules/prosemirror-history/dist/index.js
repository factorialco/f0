import b from "../../../../rope-sequence@1.3.4/node_modules/rope-sequence/dist/index.js";
import { Mapping as k } from "../../../../prosemirror-transform@1.10.3/node_modules/prosemirror-transform/dist/index.js";
import { Plugin as H, PluginKey as O } from "../../../../prosemirror-state@1.4.3/node_modules/prosemirror-state/dist/index.js";
const D = 500;
class c {
  constructor(t, e) {
  ...
  compress(t = this.items.length) {
    ...
    }, this.items.length, 0), new c(b.from(s.reverse()), p);
  }
}
c.empty = new c(b.empty, 0);
function x(n, t) {
  let e;
    ...
    props: {
      handleDOMEvents: {
        beforeinput(t, e) {
          ...
          return s ? (e.preventDefault(), s(t.state, t.dispatch)) : !1;
        }
      }
    }
  });

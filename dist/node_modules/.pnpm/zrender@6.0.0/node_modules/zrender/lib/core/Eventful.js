var e = (function() {
  ...
  return u.prototype.on = function(r, a, t, i) {
    ...
    return n && n.callAtLast ? s[r].splice(l, 0, o) : s[r].push(o), this;
  }, u.prototype.isSilent = function(r) {
    ...
    if (a) {
      ...
      delete t[r];
    return this;
  }, u.prototype.trigger = function(r) {
    ...
    if (i)
      for (var f = a.length, h = i.length, o = 0; o < h; o++) {
        var l = i[o];
  ...
  }, u.prototype.triggerWithContext = function(r) {
    for (var a = [], t = 1; t < arguments.length; t++)
      a[t - 1] = arguments[t];
    if (!this._$handlers)
      return this;
    var i = this._$handlers[r], s = this._$eventProcessor;
    if (i)
      for (var f = a.length, h = a[f - 1], o = i.length, l = 0; l < o; l++) {
        var n = i[l];

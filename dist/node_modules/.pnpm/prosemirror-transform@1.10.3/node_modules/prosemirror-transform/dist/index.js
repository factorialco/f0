import { Slice as w, Fragment as g, Mark as se, MarkType as oe, ReplaceError as le } from "../../../../prosemirror-model@1.25.0/node_modules/prosemirror-model/dist/index.js";
...
class E extends k {
  ...
  */
  ...
  map(e) {
    let t = e.mapResult(this.pos, 1);
    return t.deletedAfter ? null : new E(t.pos, this.mark);
  }
  toJSON() {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new E(t.pos, e.markFromJSON(t.mark));
  }
}
k.jsonID("removeNodeMark", E);
class v extends k {
  /**
  ...
  */
  ...
  map(e) {
    let t = e.mapResult(this.from, 1), r = e.mapResult(this.to, -1);
    return t.deletedAcross && r.deletedAcross ? null : new v(t.pos, Math.max(t.pos, r.pos), this.slice);
  }
  merge(e) {
...
class De {
  ...
  */
  setNodeAttribute(e, t, r) {
    return this.step(new R(e, t, r)), this;
  }
  /**
  ...
  */
  removeNodeMark(e, t) {
    ...
    return this.step(new E(e, t)), this;
  }
  /**

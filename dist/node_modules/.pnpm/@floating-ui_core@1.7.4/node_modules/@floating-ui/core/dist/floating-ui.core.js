import { evaluate as L, getSideAxis as T, getSide as j, clamp as $, getOppositePlacement as Z, getExpandedPlacements as ee, getOppositeAxisPlacements as te, getAlignmentSides as ne, getAlignment as z, min as Y, max as W, getOppositeAxis as G, getPaddingObject as J, getAlignmentAxis as K, sides as ie, rectToClientRect as X, getAxisLength as N } from "../../../../../@floating-ui_utils@0.2.10/node_modules/@floating-ui/utils/dist/floating-ui.utils.js";
function I(t, e, d) {
  let {
    reference: a,
    floating: m
  } = t;
  const n = T(e), s = K(e), l = N(s), g = j(e), p = n === "y", r = a.x + a.width / 2 - m.width / 2, o = a.y + a.height / 2 - m.height / 2, f = a[l] / 2 - m[l] / 2;
  let i;
  switch (g) {
    case "top":
      i = {
...
const le = async (t, e, d) => {
  ...
  async fn(e) {
    ...
    const o = J(r), f = {
      x: d,
      y: a
    }, i = K(m), c = N(i), u = await s.getDimensions(p), x = i === "y", v = x ? "top" : "left", y = x ? "bottom" : "right", w = x ? "clientHeight" : "clientWidth", h = n.reference[c] + n.reference[i] - f[i] - n.floating[c], A = f[i] - n.reference[i], b = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(p));
    let C = b ? b[w] : 0;
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        x: d,
        y: a
      }, o = await n.detectOverflow(e, p), f = T(j(m)), i = G(f);
      let c = r[i], u = r[f];
      if (s) {

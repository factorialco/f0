...
import { g as x, S as p, p as w } from "./F0CanvasPanel-DviuzWSH.js";
import { u as y, D as g } from "./DocumentToolbar-CzmFgKPO.js";
const k = 2 * 1024 * 1024, v = [
  ...
  const n = x(), a = y(), [d, c] = _(null), [u, m] = _(!1);
  return h(() => {
    let s = !1;
    ...
    u ? /* @__PURE__ */ e("div", { className: "flex min-h-0 grow items-center justify-center text-f1-foreground-secondary", children: n.pdfViewer.previewFailed }) : d === null ? /* @__PURE__ */ e(
      p,
      {
        role: "status",
        "aria-busy": !0,

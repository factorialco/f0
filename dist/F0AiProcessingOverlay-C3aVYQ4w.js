...
function z2(e) {
  ...
  const v = _(
    async (H) => {
      ...
      const E = (V) => n(
        (P) => P.map(
          (N) => x.includes(N.id) ? { ...N, status: "error", errorMessage: V } : N
        )
      );
      try {
        const V = await l(T);
        ...
        n(
          (P) => P.map((N) => {
            const S = F.findIndex((B) => B.id === N.id);
            return S === -1 ? N : V[S] ? {
              ...N,
              status: "uploaded",
              uploadedFile: V[S]
...
function Y2({
  ...
  z(() => {
    ...
    if (S.atIndex === T.current)
      return;
    k.current = S.atIndex, l(S.query), c(!0), w(0), g(!0), R.current && clearTimeout(R.current);
    const B = ++H.current;
    return R.current = setTimeout(() => {
      o(S.query).then((j) => {
        B === H.current && (u(j), w(0), j.length === 0 && S.query.length > 0 && (T.current = S.atIndex, c(!1)));
      }).catch(() => {
        B === H.current && u([]);
      }).finally(() => {
        B === H.current && g(!1);
  ...
  const F = _(() => {
    ...
    (S) => {
      const B = k.current;
      if (B === -1) return;
      const j = `${S.firstName} ${S.lastName}`.trim(), O = String(S.id), W = e.slice(0, B), e1 = e.slice(n), t1 = `@${j} `, K = W + t1 + e1, Q = W.length + t1.length;
      r(K), p((s1) => [...s1.filter((c1) => !(c1.id === O && c1.name === j)), { id: O, name: j }]), F(), requestAnimationFrame(() => {
        const s1 = s.current;
    ...
    (S) => {
      ...
      switch (S.key) {
        case "ArrowDown":
          return S.preventDefault(), w((B) => (B + 1) % f.length), !0;
        case "ArrowUp":
        ...
        case "Tab": {
          ...
          if (B) {
            ...
            if (d.length === 0 || j.toLowerCase().startsWith(d.toLowerCase()))
              return S.preventDefault(), x(B), !0;
          }
          return !1;
        }
        case "Enter":
          return S.preventDefault(), f[h] && x(f[h]), !0;
        default:
          return !1;
      }
    },
...
` || W === "	";
  ...
  const P = X(() => {
    if (!a || k.current === -1) return null;
    const S = s.current;
    if (!S) return null;
    const B = q2(S, k.current), j = S.offsetLeft + B.left, W = (S.offsetParent ? S.offsetParent.offsetHeight : 0) - (S.offsetTop + B.top);
...
const K2 = /[\\`*_{}[\]()#+\-.!|~>]/g, Q2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, n) => n % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(K2, "\\$&")).join(""), $4 = ({
  ...
  const S = G(), B = C1(), [j, O] = I(""), [W, e1] = I(0), [t1, K] = I(!1), [Q, s1] = I(!1), [p1, c1] = I(null), [q, d1] = I(!1), a1 = $(null), J = $(null), x1 = $(null), b1 = $(null);
  z(
    () => () => {
  ...
  const L = c != null, { tracking: y, setFocusChatInputFunction: M } = y1(), D = _(
    (Z, v1) => {
  ...
  const ve = g1.status === "recording", Fr = ve ? S.ai.listening : S.ai.inputPlaceholder, Le = A.filter((Z) => Z.status === "uploaded"), P1 = A.some((Z) => Z.status === "uploading"), xe = A.some((Z) => Z.status === "error"), D1 = j.trim().length > 0 || Le.length > 0;
  z(() => {
    if (!(!Q || P1)) {
      if (s1(!1), xe) {
  ...
  const Nr = async (Z) => {
    ...
    L || l1.handleKeyDown(Z) || Z.key === "Enter" && !Z.shiftKey && (Z.preventDefault(), n || a1.current?.requestSubmit());
  }, Vr = () => {
    e1(J.current?.selectionStart ?? 0);
  }, Tr = () => {
    x1.current && J.current && (x1.current.scrollTop = J.current.scrollTop);
  }, be = p1 ? p1.prompt ?? p1.title : null, ke = ve ? [S.ai.listening] : be ? [be] : s ?? [], Hr = ke.length > 1, Ar = X(() => j2(j, l1.mentions, {
    cursorPosition: W,
    inlineCompletion: l1.inlineCompletion
  }), [j, l1.mentions, W, l1.inlineCompletion]), Er = l1.mentions.length > 0 || l1.inlineCompletion !== null, T1 = x === "inside", H1 = R && !!T && T.length > 0 && !!F ? /* @__PURE__ */ t(
    D2,
    {
      suggestions: T,
      onItemClick: D,
  ...
  return /* @__PURE__ */ i(
    Y.div,
    {
      ...
      children: [
          ...
          /* @__PURE__ */ t(y2, { creditWarning: a, children: /* @__PURE__ */ i(
            "form",
            {
              ...
              className: b(
                ...
                !B && !L && "after:[animation:rotate-gradient_6s_linear_infinite_paused] has-[textarea:focus]:after:[animation:rotate-gradient_6s_linear_infinite_running]",
                !B && L && "after:[animation:rotate-gradient_6s_linear_infinite_running]",
                L && "after:opacity-100 border-f1-background-tertiary"
              ),
              onClick: () => {
                L || J.current?.focus();
              },
              ...
              children: [
                ...
                /* @__PURE__ */ t(L1, { initial: !1, children: L ? /* @__PURE__ */ t(
                  Y.div,
                  {
                    className: "overflow-hidden",
        ...
        Pr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(V2, { cards: V }) }),
        k && R && H && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: k }),
        /* @__PURE__ */ t(L1, { mode: "wait", initial: !1, children: L ? /* @__PURE__ */ i(
          Y.div,
          {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ t(ss, { file: e.file, size: "lg" }),
          e?.type === "icon" && /* @__PURE__ */ t(as, { icon: e.icon, size: "md" }),
          /* @__PURE__ */ i("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            ...
            n && /* @__PURE__ */ t(o1, { className: "text-base text-f1-foreground-secondary", children: n })
          ] }),
...
const Be = 7, S6 = 625, Ie = /* @__PURE__ */ new Set();
function V6(e) {
...
function sr(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: H6(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const n = e.value;
    return { type: "item", text: (n ? V6(n) : "") || "—" };
  }
  ...
  return { type: "item", text: T6(String(e)) };
}
function ar({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: u } = y1(), C = N6(e), g = d ?? C, h = $(() => {
  ...
  h.current = k, z(() => {
    typeof window > "u" || window.innerWidth < S6 || Ie.has(e) || (Ie.add(e), h.current());
  }, [e]);
  const R = a && c ? Object.entries(a).map(([F, x]) => {
    const E = c[F], V = g?.(F, E, {
      fieldType: x.fieldType,
      customFieldName: x.customFieldName
    });
    if (!V && x.fieldType === "custom" && typeof E == "object" && E !== null)
      return null;
    const P = V ?? sr(E, x.fieldType), N = ["richtext", "textarea"];
    return {
      label: x.label,
      content: P,
      verticalLayout: N.includes(x.fieldType ?? "")
    };
  }).filter((F) => {
    if (!F) return !1;
...
const cr = z1(void 0), D4 = () => $1(cr), B6 = (e) => /* @__PURE__ */ t(Et, { content: e, format: "markdown" }), I6 = ({
  isGenerating: e,
  isLoading: r,
  message: n,
  renderToolCall: o,
...
const fr = (e) => /* @__PURE__ */ t(Et, { content: e, format: "markdown" }), G6 = ({
  text: e,
  renderMarkdown: r
  ...
  const c = e.rawData, d = z6(
    e?.content,
    c
  ), l = (U6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = l.length > 0, { anchor: C, clear: g } = ir({
    containerRef: a,
    enabled: u
  });
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ t(G6, { text: f, renderMarkdown: o }),
...
}, q6 = 35, X6 = 22, Y6 = 400, K6 = 2500, Q6 = 220, J6 = ({
  messages: e,
  caption: r,
  subtitle: n,
  cta: o,
  ...
  z(() => {
    ...
    let R;
    if (u === "starting")
      R = setTimeout(() => C("writing"), Y6);
    else if (u === "writing")
      l < h.length ? R = setTimeout(() => f((H) => H + 1), q6) : C("holding");
    else if (u === "holding") {
      if (e.length <= 1) return;
      R = setTimeout(() => C("erasing"), K6);
    } else u === "erasing" && (l > 0 ? R = setTimeout(() => f((H) => H - 1), X6) : R = setTimeout(() => {
...
const tl = {
...
}, _4 = (e) => /* @__PURE__ */ t(D6, { children: /* @__PURE__ */ t(rl, { ...e }) }), rl = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: x, handleSubmit: E, handleClose: V } = _6(
    h ?? tl
  ), P = G(), N = R ?? I6, S = H ?? W6, B = X(() => {
    const q = o ?? P.ai.defaultInitialMessage;
    return (Array.isArray(q) ? q : [q]).filter((a1) => typeof a1 == "string" && a1.length > 0);
  }, [o, P.ai.defaultInitialMessage]), j = !r && e.length === 0 && B.length > 0, O = $(null), W = $(null), e1 = $(null), t1 = $(null), K = $(null), { showScrollBtn: Q, turnMinHeight: s1, scrollToBottom: p1 } = el({
    viewportRef: O,
    contentRef: W,
    endRef: e1,
    lastTurnRef: K,
    ...
    const a1 = d1 === e.length - 1, J = {
      ...
      return /* @__PURE__ */ t(
        N,
        {
          ...
          isLoading: q.isInProgress && M && !L.content
        },
        `${d1}-a-${y}`
      );
    };
    return /* @__PURE__ */ i(
      "div",
      {
        ...
        children: [
          ...
          q.endIndicator === "thinking" && /* @__PURE__ */ t(J1, { title: P.ai.thinking, status: "executing" }),
          q.endIndicator === "activity" && /* @__PURE__ */ t(J1, { status: "writing" }),
...
}, nl = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ i("div", { className: "flex flex-col gap-2", children: [
...
const il = [0.23, 1, 0.32, 1], ll = 0.2, cl = 0.03, dl = 4, ul = ({
  mode: e,
  question: r,
  options: n,
  selectedOptionIds: o,
  ...
  const x = (V) => {
    ...
    V.preventDefault(), T(N), F.current[N]?.focus();
  }, E = (V) => ({
    initial: k ? !1 : { opacity: 0, y: dl },
    animate: { opacity: 1, y: 0 },
    transition: {
      duration: k ? 0 : ll,
      ease: il,
  ...
  } = s, E = $(null), V = R ?? "single", P = c > 1, N = a === 0, S = a === c - 1, B = P ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(a + 1),
    total: String(c)
  }) : void 0, j = k.length > 0, O = (F ?? "").trim().length > 0, W = j || x && O || H === !0, e1 = r === !0 && S, t1 = () => {
    e1 || l();
  }, K = () => {
    e1 || f();
  }, Q = (J) => {
    const x1 = V === "single" && k.includes(J);
    d(J), V === "single" && !S && !x1 && Promise.resolve().then(l);
  }, s1 = S ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, p1 = H === !0 && !j && !(x && O), c1 = () => {
...
function Ue(e, r, n, o) {
  const s = Math.max(1, Math.min(e, r)), a = Math.min(n, 20), d = Math.min(a + o, s), l = Math.min(d, Math.floor(e / 2)), f = Math.min(d, Math.floor(r / 2)), u = (c1) => c1 / e * 2 - 1, C = (c1) => c1 / r * 2 - 1, g = 0, h = e, w = 0, v = r, p = l, k = e - l, R = f, H = r - f, T = u(g), F = u(h), x = C(w), E = C(v), V = u(p), P = u(k), N = C(R), S = C(H), B = 0, j = 0, O = 1, W = 1, e1 = l / e, t1 = 1 - l / e, K = f / r, Q = 1 - f / r, s1 = new Float32Array([
    // Top strip
    T,
    x,
    F,
...
class G4 {
  ...
  setupGL() {
    ...
    const T = (this.options.colors || vl).map(Ll);
...
const Ge = ["lowp", "mediump", "highp"], xl = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, bl = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, qe = "iTime", Xe = "iTimeDelta", Ye = "iDate", Ke = "iFrame", Qe = "iMouse", Je = "iResolution", kl = "iChannel", et = "iChannelResolution", tt = "iDeviceOrientation";
function yl(e, r) {
...
}, Q1 = 9729, rt = 9728, Sl = 9987, nt = 33071, ot = 10497;
class Vl {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    return (r.wrapS !== nt || r.wrapT !== nt || r.minFilter !== rt && r.minFilter !== Q1) && !x && (F = this.makePowerOf2(F), x = !0), n.bindTexture(n.TEXTURE_2D, H), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, l), n.texImage2D(
      n.TEXTURE_2D,
      C,
      g,
      p,
      k,
      F
    ), x && r.minFilter !== rt && r.minFilter !== Q1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || ot
    ), n.texParameteri(
      ...
      this.magFilter || Q1
    ), this._webglTexture = H, this.source = F, this.isVideo = !1, this.isLoaded = !0, this.width = F.width || 0, this.height = F.height || 0, this;
  };
}
...
}, at = (e, r, n) => e * (1 - n) + r * n, Tl = (e, r, n) => n > 0 ? e.substring(0, n) + r + e.substring(n, e.length) : r + e;
function Hl({
  fs: e,
  vs: r = We,
  textures: n = [],
  ...
  const h = $(null), w = $(null), v = $(null), p = $(null), k = $(void 0), R = $(void 0), H = $(!1), T = $(void 0), F = $(0), x = $([0, 0]), E = $([]), V = $(0), P = $(void 0), N = $({
    ...
    const M = "width" in L ? L.width ?? 0 : 0, D = "height" in L ? L.height ?? 0 : 0, A = N.current.iChannelResolution;
    if (!A) return;
    const U = Array.isArray(A.value) ? A.value : A.value = [];
    ...
    L?.bufferData(L.ARRAY_BUFFER, new Float32Array(y), L.STATIC_DRAW);
  }, W = ({
    alpha: L,
    beta: y,
    gamma: M
    ...
    const [y = 0, M = 0] = st(L), D = y - (T.current?.left ?? 0) - window.pageXOffset, A = (T.current?.height ?? 0) - M - (T.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    const U = Array.isArray(N.current.iMouse?.value) ? N.current.iMouse.value : void 0;
    U && (U[2] = D, U[3] = A), x.current[0] = D, x.current[1] = A;
  }, t1 = (L) => {
    T.current = h.current?.getBoundingClientRect();
    const [y = 0, M = 0] = st(L), D = y - (T.current?.left ?? 0), A = (T.current?.height ?? 0) - M - (T.current?.top ?? 0);
    if (l !== 1)
      x.current[0] = D, x.current[1] = A;
    else {
      const U = Array.isArray(N.current.iMouse?.value) ? N.current.iMouse.value : void 0;
      U && (U[0] = D, U[1] = A);
    }
    ...
    if (L.canvas.width = M, L.canvas.height = D, N.current.iResolution?.isNeeded && p.current) {
      const A = L.getUniformLocation(
        p.current,
        Je
      );
      L.uniform2fv(A, [L.canvas.width, L.canvas.height]);
    }
  }, s1 = (L, y) => {
    const M = w.current;
    if (!M) return null;
...
${y}`));
    ...
    const M = w.current;
    if (!M) return;
    const D = s1(M.FRAGMENT_SHADER, L), A = s1(M.VERTEX_SHADER, y);
    ...
    if (o)
      for (const L of Object.keys(o)) {
        const y = o[L];
        if (!y) continue;
        const { value: M, type: D } = y, A = Nl(D);
        if (!A) continue;
        const U = {};
        if (yl(D, M)) {
          const i1 = D.length, m1 = Number.parseInt(D.charAt(i1 - 3)), M1 = Math.floor(M.length / (m1 * m1));
          M.length > m1 * m1 && (U.arraySize = `[${M1}]`);
        } else Ml(D, M) && (U.arraySize = `[${Math.floor(M.length / Number.parseInt(D.charAt(0)))}]`);
        N.current[L] = {
          type: A,
          isNeeded: !1,
          value: M,
      ...
      if (n && n.length > 0) {
        ...
        const y = n.map(
          (M, D) => (N.current[`${kl}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(M, D), E.current[D] = new Vl(L), E.current[D]?.load(M).then((A) => {
            B(A, D);
          }))
        );
        Promise.all(y).then(() => {
    ...
    const y = Ge.includes(a ?? "highp"), M = `precision ${y ? a : Ge[1]} float;
`;
    y || g?.(
      k1(
...
`).concat(L.replace(/texture\(/g, "texture2D("));
    for (const U of Object.keys(N.current))
      if (L.includes(U)) {
        const i1 = N.current[U];
        if (!i1) continue;
        D = Tl(
          D,
...
`,
    ...
    return L.includes("mainImage") && (D = D.concat(xl)), D;
  }, a1 = (L) => {
    const y = w.current;
    if (!y || !p.current) return;
    const M = V.current ? (L - V.current) / 1e3 : 0;
    V.current = L;
    const D = S.current;
    if (D)
      for (const A of Object.keys(D)) {
        const U = D[A];
        if (U && N.current[A]?.isNeeded) {
          if (!p.current) return;
    ...
    if (N.current.iMouse?.isNeeded) {
      ...
      y.uniform4fv(A, N.current.iMouse.value);
    }
    ...
    if (N.current.iFrame?.isNeeded) {
      const A = y.getUniformLocation(
        p.current,
        Ke
      ), U = N.current.iFrame.value;
      y.uniform1i(A, U), N.current.iFrame.value = U + 1;
    }
    if (E.current.length > 0)
      for (let A = 0; A < E.current.length; A++) {
        ...
        if (!I1 || !m1 || !M1) return;
        if (N.current[`iChannel${A}`]?.isNeeded) {
          if (!p.current) return;
    ...
    y.viewport(0, 0, y.drawingBufferWidth, y.drawingBufferHeight), y.clear(y.COLOR_BUFFER_BIT | y.DEPTH_BUFFER_BIT), y.bindBuffer(y.ARRAY_BUFFER, v.current), y.vertexAttribPointer(
      ...
      0,
      0
    ), a1(L), y.drawArrays(y.TRIANGLE_STRIP, 0, 4);
    const M = N.current.iMouse?.value;
    if (N.current.iMouse?.isNeeded && l !== 1 && Array.isArray(M)) {
      const D = M[0] ?? 0, A = M[1] ?? 0;
      M[0] = at(D, x.current[0] ?? 0, l), M[1] = at(A, x.current[1] ?? 0, l);
    }
    R.current = requestAnimationFrame(J);
  }, x1 = () => {
    const L = { passive: !0 };
    N.current.iMouse?.isNeeded && h.current && (h.current.addEventListener("mousemove", t1, L), h.current.addEventListener("mouseout", K, L), h.current.addEventListener("mouseup", K, L), h.current.addEventListener("mousedown", e1, L), h.current.addEventListener("touchmove", t1, L), h.current.addEventListener("touchend", K, L), h.current.addEventListener("touchstart", e1, L)), N.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      W,
      L
    ), h.current && (P.current = new ResizeObserver(Q), P.current.observe(h.current), window.addEventListener("resize", Q, L));
  }, b1 = () => {
    const L = { passive: !0 };
    N.current.iMouse?.isNeeded && h.current && (h.current.removeEventListener("mousemove", t1, L), h.current.removeEventListener("mouseout", K, L), h.current.removeEventListener("mouseup", K, L), h.current.removeEventListener("mousedown", e1, L), h.current.removeEventListener("touchmove", t1, L), h.current.removeEventListener("touchend", K, L), h.current.removeEventListener("touchstart", e1, L)), N.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      W,
      L
    ), P.current && (P.current.disconnect(), window.removeEventListener("resize", Q, L));
  };
  return z(() => {
    S.current = o;
  }, [o]), z(() => {
    ...
    function y() {
      j();
      const M = w.current;
      M && h.current && (M.clearColor(...s), M.clearDepth(1), M.enable(M.DEPTH_TEST), M.depthFunc(M.LEQUAL), M.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, c1(), q(), p1(d1(e || bl), r || We), O(), requestAnimationFrame(J), x1(), Q());
    }
    return requestAnimationFrame(y), () => {
      const M = w.current;
      if (M) {
        if (M.getExtension("WEBGL_lose_context")?.loseContext(), M.useProgram(null), M.deleteProgram(p.current ?? null), L.length > 0)
          for (const D of L)
...
}`, El = 10, $l = 2, Bl = 0.5, Il = 0.2, Pl = 1.5, h1 = {
  duration: 0.5,
  ease: "easeOut"
}, it = {
  duration: 0.35,
...
function Dl(e, r) {
  const [n, o] = I(El), {
    ...
    animate: a,
    motionValue: c
  } = O1(Il), { value: d, animate: l } = O1($l), { value: f, animate: u } = O1(Bl), { value: C, animate: g } = O1(Pl), h = Bs(r, {
    fftSize: 512,
...
function W4({
  ...
  const { speed: f, scale: u, amplitude: C, frequency: g, brightness: h } = Dl(r, s);
  return /* @__PURE__ */ t(
    mr,
    {
      ref: d,
...
const q4 = ({
  ...
  const o = G(), s = C1();
  return /* @__PURE__ */ i(F1, { children: [
    e && /* @__PURE__ */ t("span", { className: b(Zl(), "truncate"), children: e }),
      ...
      Y.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ i("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ t("span", { className: b(Z1()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ t(
            ms,
            {
          ...
          o === "alert" && /* @__PURE__ */ t(ws, { text: e.alertLabel, level: e.level }),
          o === "balance" && /* @__PURE__ */ t(Gl, { balance: e.balance })
        ]
      }
    ),
    n && !zl.has(o) && /* @__PURE__ */ t(
      Y.span,
      {
        className: b(Z1()),
        animate: { opacity: s ? 0 : 1 },
...
const Xl = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), Yl = ({
  label: e,
  direction: r
}) => {
  const n = wr[r];
  ...
  const s = `sparkline-gradient-${U1().replace(/:/g, "")}`, a = ql(e, n), c = wr[a];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(Yl, { label: r, direction: a })
      ]
    }
  ) });
}, vr = m(
...
const Ql = ["className"], Lr = m((e, r) => {
  const n = Ql.reduce((o, s) => {
    const { [s]: a, ...c } = o;
    return c;
  }, e);
...
const J4 = ({
  ...
  const h = X(
    ...
    return o.filter((E) => E.title.toLowerCase().includes(x));
  }, [o, C]), v = X(
    () => w.filter((x) => c.has(x.id)),
    [w, c]
  ), p = X(
    () => w.filter((x) => !c.has(x.id)),
    [w, c]
...
function e9({
  ...
  const [a, c] = I([]), [d, l] = I(!1), [f, u] = I(null), [C, g] = I(L4), [h, w] = I(() => /* @__PURE__ */ new Set()), v = _(async () => {
    ...
    try {
      ...
      const E = x instanceof Error ? x.message : "Failed to fetch chat history";
      u(E), c([]);
    } finally {
      l(!1);
    }
  ...
  const p = _((x, E) => {
    g((V) => {
      if (E === V.has(x)) return V;
      const P = new Set(V);
      return E ? P.add(x) : P.delete(x), ut(P), P;
    });
  }, []), k = _((x, E) => {
    w((V) => {
      if (E === V.has(x)) return V;
      const P = new Set(V);
      return E ? P.add(x) : P.delete(x), P;
    });
  }, []), R = _(
    (x, E) => {
      const V = E ? o : s;
      p(x, E), V && (k(x, !0), V(x).catch(() => p(x, !E)).finally(() => k(x, !1)));
    },
    [o, s, p, k]
  ), H = _((x) => R(x, !0), [R]), T = _(
    (x) => R(x, !1),
    ...
    async (x) => {
      k(x, !0);
      try {
        await n(x), c((E) => E.filter((V) => V.id !== x)), g((E) => {
          if (!E.has(x)) return E;
          const V = new Set(E);
          return V.delete(x), ut(V), V;
        });
      } catch {
        v();
      } finally {

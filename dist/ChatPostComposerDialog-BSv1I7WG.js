...
import { F as R } from "./index-wmss4jv7.js";
import { g as _, h as x } from "./F0CanvasPanel-FplHMFtP.js";
import { u as B, a as L, s as P } from "./experimental-DbQWSHOP.js";
const N = 140, O = 1e4, K = ({
  onClose: d,
  searchMembers: f
}) => {
  const t = _(), { createPost: p } = B(), g = L(), a = M(null), [r, D] = n(""), [m, E] = n(""), [T, k] = n([]), [w, A] = n([]), [l, y] = n(!1), [H, u] = n(!1), s = r.trim().length > 0 || P(m).length > 0, b = r.trim().length > 0 && !l, h = v(() => {
    g.onPostCompositionCancelled({ hadDraft: s }), d();
  }, [g, s, d]), C = v(() => {
    if (s) {
      u(!0);
      return;

...
const Ec = (e, r) => /* @__PURE__ */ i(
...
), l0 = m(c0), d0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Ns,
  Add: Br,
  Ai: Ir,
  ...
  CalendarArrowLeft: ta,
  CalendarArrowRight: oa,
  CameraPlus: sa,
  CardPin: ia,
  ChartFunnel: la,
  ...
  Wifi: l0,
  Windows: Nn
}, Symbol.toStringTag, { value: "Module" })), f0 = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const V0 = Te({
  ...
  ({
    ...
    const Ae = j && j !== "none" || W && W !== "none" || K && K !== "none" || ie && ie !== "none", Se = Y && Y !== "none" || Ae, De = { sm: xe, md: Ye, lg: Ke, xl: Qe }, je = S0.map((_e) => {
      const Ze = De[_e];
      return Ze ? N0(_e, Ze) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
...
`) ? o + "_" : o
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, _0).map((r) => /* @__PURE__ */ t(
  bt,
  {
        ...
        g && /* @__PURE__ */ i(
          h1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: U0(g.items).map((p, h) => /* @__PURE__ */ i(
                "button",
                {
                  type: "button",
                  onClick: (C) => {
...
` || z === "	";
  ...
  const B = J(() => {
    ...
    const S = s.current;
    if (!S) return null;
    const I = J0(S, y.current), U = S.offsetLeft + I.left, z = (S.offsetParent ? S.offsetParent.offsetHeight : 0) - (S.offsetTop + I.top);
...
const rl = /[\\`*_{}[\]()#+\-.!|~>]/g, ol = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(rl, "\\$&")).join(""), I6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const _e = async (Q) => {
    if (Q.preventDefault(), !ie) {
      if (ne.close(), o)
        ...
        const be = ne.transformMentions(R.trim()), e1 = ol(be), Oe = Ae.flatMap(
  ...
  }, v1 = X ? X.prompt ?? X.title : null, w1 = Pe ? [b.ai.listening] : v1 ? [v1] : s ?? [], Fr = w1.length > 1, Nr = J(() => G0(R, ne.mentions, {
    cursorPosition: I,
    ...
    ee.div,
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(B0, { creditWarning: a, children: /* @__PURE__ */ i(
            ee.form,
            {
              "aria-busy": o,
              ref: j,
        ...
        Sr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(Z0, { cards: w }) }),
...
const N1 = 7, Al = 625, V1 = /* @__PURE__ */ new Set();
function $l(e) {
...
function Il(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = Gn(e), a = [];
...
function cr(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: Il(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? $l(o) : "") || "—" };
  }
  ...
  return { type: "item", text: Bl(String(e)) };
}
function lr({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = ye(), g = Hl(e), p = d ?? g, h = $(() => {
  ...
  h.current = y, q(() => {
    typeof window > "u" || window.innerWidth < Al || V1.has(e) || (V1.add(e), h.current());
  }, [e]);
...
const ur = We(void 0), _6 = () => Ie(ur), _l = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), Zl = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
...
const gr = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), Kl = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = Yl(
    e?.content,
    l
  ), c = (Xl(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: g, clear: p } = dr({
    containerRef: a,
    enabled: f
  });
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(Kl, { text: u, renderMarkdown: n }),
...
}, Jl = 35, e2 = 22, t2 = 400, r2 = 2500, o2 = 220, n2 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  ...
  q(() => {
    ...
    let p;
    if (d === "starting")
      p = setTimeout(() => c("writing"), t2);
    else if (d === "writing")
      a < u.length ? p = setTimeout(() => l((h) => h + 1), Jl) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), r2);
    } else d === "erasing" && (a > 0 ? p = setTimeout(() => l((h) => h - 1), e2) : p = setTimeout(() => {
...
const a2 = {
...
}, Z6 = (e) => /* @__PURE__ */ t(Ul, { children: /* @__PURE__ */ t(i2, { ...e }) }), i2 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: T, handleSubmit: V, handleClose: E } = zl(
    f ?? a2
  ), w = G(), N = x ?? Zl, b = v ?? Ql, B = J(() => {
    const j = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((K) => typeof K == "string" && K.length > 0);
  }, [n, w.ai.defaultInitialMessage]), R = !r && e.length === 0 && B.length > 0, S = $(null), I = $(null), U = $(null), O = $(null), z = $(null), { showScrollBtn: te, turnMinHeight: oe, scrollToBottom: X } = s2({
    viewportRef: S,
    contentRef: I,
    endRef: U,
    lastTurnRef: z,
...
}, c2 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ i("div", { className: "flex flex-col gap-2", children: [
...
const d2 = ({
  ...
  const p = G().ai.clarifyingQuestion.typeYourAnswer, h = $(null), C = vs(h, l);
  a1(() => {
    const v = h.current;
    if (!v) return;
    v.style.height = "auto";
  ...
  return /* @__PURE__ */ i("div", { className: "flex flex-col", onKeyDown: ie, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ i(
      ee.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ue, ease: p2 },
        children: [
          /* @__PURE__ */ t(
            h2,
            {
...
class q6 {
  ...
  setupGL() {
    ...
    const V = (this.options.colors || x2).map(k2);
...
const P1 = ["lowp", "mediump", "highp"], b2 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, L2 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, j1 = "iTime", _1 = "iTimeDelta", Z1 = "iDate", O1 = "iFrame", U1 = "iMouse", z1 = "iResolution", y2 = "iChannel", G1 = "iChannelResolution", W1 = "iDeviceOrientation";
function M2(e, r) {
...
}, r1 = 9729, q1 = 9728, V2 = 9987, X1 = 33071, Y1 = 10497;
class S2 {
  gl;
  url;
  wrapS;
...
}, Q1 = (e, r, o) => e * (1 - o) + r * o, T2 = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function H2({
  fs: e,
  vs: r = D1,
  textures: o = [],
      ...
      if (o && o.length > 0) {
        ...
        const F = o.map(
          (M, D) => (R.current[`${y2}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, I(M, D), N.current[D] = new S2(L), N.current[D]?.load(M).then((H) => {
            I(H, D);
          }))
        );
        Promise.all(F).then(() => {
...
`,
    ...
    return L.includes("mainImage") && (D = D.concat(b2)), D;
  }, ge = (L) => {
    const F = C.current;
  ...
  return q(() => {
    ...
    function F() {
      U();
      const M = C.current;
      M && h.current && (M.clearColor(...s), M.clearDepth(1), M.enable(M.DEPTH_TEST), M.depthFunc(M.LEQUAL), M.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, K(), ie(), W(ue(e || L2), r || D1), O(), requestAnimationFrame(re), de(), Y());
    }
...
}`, $2 = 10, B2 = 2, I2 = 0.5, P2 = 0.2, D2 = 1.5, me = {
  duration: 0.5,
  ease: "easeOut"
}, J1 = {
  duration: 0.35,
...
function j2(e, r) {
  const [o, n] = P($2), {
    ...
    animate: a,
    motionValue: l
  } = Ue(P2), { value: d, animate: c } = Ue(B2), { value: u, animate: f } = Ue(I2), { value: g, animate: p } = Ue(D2), h = xs(r, {
    fftSize: 512,
...
function X6({
  ...
  const { speed: u, scale: f, amplitude: g, frequency: p, brightness: h } = j2(r, s);
  return /* @__PURE__ */ t(
    wr,
    {
      ref: d,
...
const Y6 = ({
  ...
  const n = G(), s = ke();
  return /* @__PURE__ */ i(Re, { children: [
    e && /* @__PURE__ */ t("span", { className: k(U2(), "truncate"), children: e }),
    ...
    /* @__PURE__ */ i(
      ee.div,
      {
        ...
        children: [
          ...
          n === "alert" && /* @__PURE__ */ t(ts, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ t(W2, { balance: e.balance })
        ]
      }
    ),
    o && !G2.has(n) && /* @__PURE__ */ t(
      ee.span,
      {
        className: k(ze()),
        animate: { opacity: s ? 0 : 1 },
...
const Y2 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), K2 = ({
  label: e,
  direction: r
}) => {
  const o = kr[r];
  ...
  const s = `sparkline-gradient-${Ge().replace(/:/g, "")}`, a = X2(e, o), l = kr[a];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(os, { width: "100%", height: "100%", children: /* @__PURE__ */ i(
          ns,
          {
            data: e,
        ...
        /* @__PURE__ */ t(K2, { label: r, direction: a })
      ]
    }
  ) });
}, br = m(
...
const J2 = ["className"], Lr = m((e, r) => {
  const o = J2.reduce((n, s) => {
    const { [s]: a, ...l } = n;
    return l;
  }, e);
...
const e6 = () => /* @__PURE__ */ i(
  ...
  "balance",
  "sparkline"
], yr = 180, t6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : yr, r6 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, o6 = (e) => e.showActions !== !1, n6 = (e) => Object.fromEntries(
...
function s6(e) {
  ...
  } = e, [c, u] = P(!1), f = Ge(), g = $(null), p = t6(
    d
  ), h = a.length > p, C = c ? a : r6(a, p), x = o6(e) ? e : null, v = n6(e);
  return q(() => {
    c && g.current?.focus();
  }, [c]), /* @__PURE__ */ i(
    "section",
...
s6.displayName = "F0AiProposalCard";
const a6 = ({
  icon: e,
  title: r,
  children: o
...
}, i6 = (e) => d0[e] ?? ft, c6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: i6(e), size: "md", color: "default" }) }) : null;
function l6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(a6, { icon: d1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, a) => {
    const l = /* @__PURE__ */ t(c6, { iconName: s.icon });
...
l6.displayName = "F0AiMessageSources";
async function d6(e, r, o) {
  const n = await import("./xlsx-CzlURDDb.js"), s = n.utils.table_to_book(e, { sheet: "Data" });
  n.writeFile(s, `${o}.${r}`);
}
function f6({
...
f6.displayName = "F0AiTableCard";
function u6({ credits: e, trigger: r }) {
...
const h6 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function p6({
  employeeCredits: e,
  trigger: r
}) {
...
const s1 = ({
...
) : e ? /* @__PURE__ */ t(u6, { credits: e, trigger: o }) : null, J6 = s1, e4 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const C = G(), x = ke(), v = ls(`(max-width: ${ds.md}px)`, {
...
function g6() {
  if (!(typeof navigator > "u"))
    return hs(navigator.language);
}
function m6(e) {
  const r = new Date(e), o = /* @__PURE__ */ new Date();
  return St(r) ? "today" : Tt(r) ? "yesterday" : us(r, o) ? "thisMonth" : "older";
}
function C6(e, r) {
        ...
        n ? (
          ...
          /* @__PURE__ */ t(
            "div",
            {
              ...
              children: /* @__PURE__ */ t(ps, { size: "small" })
            }
          )
        ) : /* @__PURE__ */ t(
          "div",
...
const tt = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], x6 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(he, { className: k("h-4 rounded", e) }) }), rt = ({
  titleWidth: e,
  rows: r
  ...
  r.map((o, n) => /* @__PURE__ */ t(x6, { width: o }, n))
] });
function k6() {
...
function r4({
  ...
  const [a, l] = P([]), [d, c] = P(!1), [u, f] = P(null), [g, p] = P(b6), [h, C] = P(() => /* @__PURE__ */ new Set()), x = Z(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);

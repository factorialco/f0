...
import { _n as t, at as n, q as r, rt as i, yn as a } from "./popover-Sbb5IAHu.js";
import { I as o } from "./tooltip-BGly0G_l.js";
import { Ar as s, Dr as c, a as l, fr as u, lr as d } from "./OneCalendar-BhwqRMhL.js";
import { t as f } from "./Printer-snTHysV7.js";
import { n as p, r as m } from "./skeleton-B_dXdxA6.js";
import { i as h, n as g, r as _, t as v } from "./pdfWorker-DatDdrj_.js";
import { a as y, n as b, o as x, r as S, s as C, t as w } from "./scales-DwhBkfK1.js";
...
}), I = "flex flex-row items-center gap-2", te = ({ toolbarRef: e, currentPage: t, totalPages: r, hasDocument: a, selectedScale: p, scaleOptions: h, onPreviousPage: g, onNextPage: _, onZoomIn: v, onZoomOut: y, onScaleChange: b, rotatable: x, onRotate: S, onPrint: w, onDownload: T, actions: E }) => {
	let { pdfViewer: D } = i();
	return /* @__PURE__ */ F("div", {
		ref: e,
		role: "toolbar",
		"aria-label": D.toolbar,
		className: o("F0PdfViewer__surface sticky top-0 z-10 flex flex-row items-center justify-between gap-2", "px-6 py-4"),
		children: [
			/* @__PURE__ */ F("div", {
				className: I,
				children: [
...
g();
var L = O(() => import("./SheetViewer-nG_fzQ_L.js")), R = O(() => import("./DocxViewer-Bd26Luh9.js")), z = O(() => import("./TextViewer-B4dRhQ_X.js")), B = 48, V = D((e, t) => {
	let { kind: n = "pdf", mimeType: i, ...a } = e;
	...
	return /* @__PURE__ */ P("div", {
		...
		children: /* @__PURE__ */ F(E, {
			fallback: /* @__PURE__ */ P(r, { className: "h-full w-full rounded-none" }),
			children: [
...
var H = D((e, t) => {
	let { url: n, filename: a = "document.pdf", page: o = 0, pagesToDisplay: s = [], initialScale: c = "page-width", withCredentials: l = !0, rotatable: u = !1, initialRotation: d = 0, onRotationChange: f, onPdfLoaded: p, onPageChange: m, actions: g, ...v } = e, { pdfViewer: C } = i(), [T, E] = N(null), [D, O] = N([]), [I, L] = N(1), [R, z] = N(0), [V, H] = N(c), [U, re] = N(d), W = M(null), G = M(null), K = M([]), q = s.length > 0 ? s.length : T?.numPages, J = D.find(Boolean), Y = (J?.originalWidth ?? 595) * I, X = (J?.originalHeight ?? 842) * I, ie = j(() => [
		{
			value: "page-width",
			label: C.pageWidth
		},
...
var U = () => {
	...
	return /* @__PURE__ */ F("div", {
		...
		className: o("F0PdfViewer__surface flex h-full w-full flex-col overflow-hidden", "border border-solid border-f1-border-secondary"),
		children: [/* @__PURE__ */ F("div", {
			className: "flex flex-row items-center justify-between gap-2 px-6 py-4",
			children: [
				/* @__PURE__ */ P(r, { className: "h-8 w-24 rounded-md" }),
				/* @__PURE__ */ P(r, { className: "h-8 w-40 rounded-md" }),
				/* @__PURE__ */ P(r, { className: "h-8 w-20 rounded-md" })
			]
		}), /* @__PURE__ */ P("div", {
			className: "flex flex-1 justify-center p-4",
			children: /* @__PURE__ */ P(r, { className: "h-full w-full max-w-[600px] rounded-md" })
		})]
	});
}, re = /* @__PURE__ */ e({
	F0PdfViewer: () => W,

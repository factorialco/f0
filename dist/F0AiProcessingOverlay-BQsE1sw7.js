...
import { cG as Fr, cH as Nr, _ as rt, cI as Vr, cJ as Sr, cK as Tr, cL as Hr, cM as Ar, bL as ot, cN as $r, cO as Br, a5 as i1, cP as Ir, aJ as Pr, cQ as jr, cR as Dr, cS as Zr, ag as _r, cT as Ur, c9 as Or, a9 as nt, ac as zr, bG as Gr, b9 as a1, J as st, K as Ge, cU as it, be as Wr, cV as qr, cW as Xr, b2 as Yr, c8 as Kr, a0 as Fe, au as Qr, bi as at, cX as Jr, c6 as eo, bK as Me, c2 as to, cY as ro, bH as oo, b1 as ct, cZ as no, c_ as so, c$ as io, d0 as ao, d1 as co, d2 as lt, bW as lo, bX as fo, d3 as uo, d4 as ho, d5 as Co, d6 as go, d7 as po, bI as mo, d8 as vo, d9 as wo, da as xo, db as ko, dc as Lo, dd as bo, de as yo, df as Mo, dg as Eo, c7 as Ro, bJ as Fo, aa as No, bS as Vo, dh as So, di as To, dj as Ho, dk as Ao, dl as $o, dm as Bo, dn as Io, ap as Po, bF as dt, O as jo, a1 as Do, bx as ft, bD as Zo, bE as ut, dp as _o, bh as Uo, bg as Oo, dq as zo, dr as Go, bw as ht, ds as Wo, b0 as qo, ay as Xo, dt as Yo, as as Ko, b7 as Qo, du as Ct, b6 as Jo, bs as c1, dv as en, bj as l1, dw as tn, dx as rn, dy as d1, c4 as on, c3 as nn, c5 as gt, dz as sn, G as an, E as cn, dA as ln, dB as dn, dC as fn, dD as un, by as hn, dE as pt, dF as Cn, ab as gn, dG as pn, L as le, o as x, q as Ve, bM as mn, u as W, bv as vn, V as me, bu as mt, H as ie, v as de, a2 as wn, U as Ce, dH as xn, ad as ae, aP as ke, A as Ee, p as te, aD as f1, dI as kn, aE as u1, aF as h1, b as be, bt as Ln, dJ as bn, b_ as yn, W as Mn, a$ as En, a4 as C1, bz as Rn, bA as Fn, bB as Nn, bC as y1, a3 as Vn, ak as vt, aS as wt, dK as Sn, cm as Tn, dL as Hn, dM as An, aX as xt, dN as $n, cg as Bn, dO as In, aU as $e, b8 as kt, dP as Lt, ba as bt, c as n1, dQ as yt, dR as Pn, dS as jn, ce as Dn, bn as Zn, dT as _n, bd as g1, bT as Un, dU as On, dV as zn, dW as Gn, dX as Wn, dY as qn, a7 as Xn, ae as Yn, y as Kn, z as Qn, dZ as Mt, d_ as Et, d$ as Jn, aj as M1, e0 as es, ai as ts, e1 as rs, e2 as os, d as ns } from "./F0CanvasPanel-cOfywQR5.js";
...
function Qc({
  ...
  const E = z(() => {
    ...
    (F) => {
      const A = M.current;
      if (A === -1) return;
      const O = `${F.firstName} ${F.lastName}`.trim(), U = String(F.id), G = e.slice(0, A), re = e.slice(o), oe = `@${O} `, Y = G + oe + re, _ = G.length + oe.length;
    ...
    (F) => {
      ...
      for (const U of O) {
        const G = `@${U.name}`, re = `<entity-ref type="person" id="${E1(U.id)}">${E1(U.name)}</entity-ref>`;
        for (; A.includes(G); )
          A = A.replace(G, re);
      }
      return A;
...
const Jc = /[\\`*_{}[\]()#+\-.!|~>]/g, e2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(Jc, "\\$&")).join(""), V4 = ({
  ...
  const k = W(), T = ke(), [S, j] = $(""), [R, F] = $(0), [A, O] = $(!1), [U, G] = $(!1), [re, oe] = $(null), Y = B(null), _ = B(null), D = B(null), ee = l != null, { tracking: q } = be(), ge = z(
    (Q, xe) => {
  ...
  }, v1 = re ? re.prompt ?? re.title : null, w1 = Ie ? [k.ai.listening] : v1 ? [v1] : s ?? [], kr = w1.length > 1, Lr = J(() => Uc(S, K.mentions, {
    cursorPosition: R,
...
const R1 = 7, S2 = 625, F1 = /* @__PURE__ */ new Set();
function T2(e) {
...
function or(e, r) {
  ...
  if (r === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: o, to: n } = e, s = N1(o) ? V1(o) : String(o), i = N1(n) ? V1(n) : String(n);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((n) => {
      const s = or(n);
      return Array.isArray(s) ? s.map(S1).join(", ") : S1(s);
    }).filter(Boolean).join(", ") || "—" };
...
function nr({
  ...
  C.current = M, X(() => {
    typeof window > "u" || window.innerWidth < S2 || F1.has(e) || (F1.add(e), C.current());
  }, [e]);
...
function ir({ anchor: e, onReply: r }) {
  ...
  if (et(() => {
    ...
    let p = e.rect.top - u - T1;
    p < Ae && (p = e.rect.bottom + T1), p = Math.min(
      Math.max(p, Ae),
      g - u - Ae
    );
...
const ol = {
  ...
  }, [n, k.ai.defaultInitialMessage]), R = !r && e.length === 0 && j.length > 0, F = B(null), A = B(null), O = B(null), U = B(null), G = B(null), { showScrollBtn: re, turnMinHeight: oe, scrollToBottom: Y } = rl({
    viewportRef: F,
    contentRef: A,
    endRef: O,
    lastTurnRef: G,
...
const ll = ({
  ...
  const o = W(), n = ke(), {
    ...
    current: String(i + 1),
    total: String(l)
  }) : void 0, O = M.length > 0, U = (E ?? "").trim().length > 0, G = O || k && U || H === !0, re = r === !0 && F, oe = () => {
    re || c();
  }, Y = () => {
    re || u();
  }, _ = (fe) => {
...
function A1(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (q) => q / e * 2 - 1, g = (q) => q / r * 2 - 1, p = 0, C = e, m = 0, v = r, w = c, M = e - c, P = u, H = r - u, N = f(p), E = f(C), k = g(m), T = g(v), S = f(w), j = f(M), R = g(P), F = g(H), A = 0, O = 0, U = 1, G = 1, re = c / e, oe = 1 - c / e, Y = u / r, _ = 1 - u / r, D = new Float32Array([
    // Top strip
    N,
    k,
    E,
...
`,
    ...
    const L = { passive: !0 };
    R.current.iMouse?.isNeeded && C.current && (C.current.removeEventListener("mousemove", oe, L), C.current.removeEventListener("mouseout", Y, L), C.current.removeEventListener("mouseup", Y, L), C.current.removeEventListener("mousedown", re, L), C.current.removeEventListener("touchmove", oe, L), C.current.removeEventListener("touchend", Y, L), C.current.removeEventListener("touchstart", re, L)), R.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      G,
      L

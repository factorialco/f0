...
import { useInsertionEffect as jr, forwardRef as h, useRef as j, useEffect as Q, useLayoutEffect as st, useState as I, useMemo as te, useCallback as W, createContext as We, useContext as Be, useId as it, createElement as Dr, memo as Zr } from "react";
import { ck as _r, cl as Or, cm as Ur, cn as zr, co as at, cp as Gr, cq as Wr, cr as qr, cs as Xr, ct as Yr, cu as ct, cv as Kr, cw as Qr, cx as Jr, cy as eo, cz as to, cA as ro, cB as oo, cC as Ge, cD as no, cE as so, cF as io, cG as ao, cH as co, Z as lt, cI as lo, cJ as uo, cK as fo, cL as ho, cM as go, cN as dt, cO as po, cP as Co, a6 as i1, cQ as mo, aJ as vo, cR as wo, cS as xo, cT as ko, ag as Lo, cU as bo, bO as yo, aa as ut, ad as Mo, cV as Eo, ba as a1, a1 as ft, S as qe, cW as ht, b9 as Ro, cX as Fo, cY as No, b2 as Vo, bN as So, $ as Fe, au as To, be as gt, cZ as Ho, bL as Ao, c_ as Me, bH as $o, c$ as Bo, d0 as Io, b1 as pt, d1 as Po, d2 as jo, d3 as Do, d4 as Zo, d5 as _o, d6 as Ct, bz as Oo, bA as Uo, d7 as zo, d8 as Go, d9 as Wo, da as qo, db as Xo, dc as Yo, dd as Ko, de as Qo, df as Jo, dg as en, dh as tn, di as rn, dj as on, dk as nn, bM as sn, ab as an, bv as cn, dl as ln, dm as dn, dn as un, dp as fn, dq as hn, dr as gn, ds as pn, ap as Cn, dt as mt, M as mn, a0 as vn, du as vt, dv as wt, dw as wn, bd as xn, bc as kn, dx as Ln, dy as bn, dz as xt, dA as yn, b0 as Mn, ay as En, dB as Rn, as as Fn, b7 as Nn, dC as kt, b6 as Vn, dD as Sn, bi as c1, dE as Tn, dF as Hn, dG as l1, bJ as An, bI as $n, bK as Lt, dH as Bn, G as In, E as Pn, dI as jn, dJ as Dn, dK as Zn, dL as _n, dM as On, dN as bt, dO as Un, ac as zn, dP as Gn, L as he, o as k, q as Te, bp as Wn, u as q, dQ as qn, U as we, ch as yt, H as ue, v as pe, a2 as Xn, Q as me, dR as Yn, ae as fe, aP as Le, A as Ee, p as oe, bT as Mt, aD as d1, dS as Kn, aE as u1, aF as f1, b as ye, dT as Qn, dU as Jn, bD as es, V as ts, a$ as rs, a5 as h1, dV as os, dW as ns, dX as ss, dY as E1, a3 as is, ak as Et, aS as Rt, dZ as as, b$ as cs, d_ as ls, d$ as ds, aX as Ft, e0 as us, bV as fs, e1 as hs, aU as $e, bg as Nt, e2 as Vt, bh as St, c as n1, e3 as Tt, e4 as gs, bk as ps, e5 as Cs, b8 as g1, bw as ms, e6 as vs, e7 as ws, e8 as xs, e9 as ks, ea as Ls, a8 as bs, af as ys, y as Ms, z as Es, eb as Ht, ec as At, ed as Rs, aj as R1, ee as Fs, ai as Ns, ef as Vs, eg as Ss, d as Ts } from "./F0CanvasPanel-QOULpskY.js";
...
function Bt(e, t, o, n) {
  return typeof e == "string" && p1(t) ? _r(e, o, n) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Bs(e, t, o) {
  return e * (t + 1);
}
...
function It(e, t) {
  return Or(e) ? e[Is(0, e.length, t)] : e;
}
function Ps(e, t, o) {
  for (let n = 0; n < e.length; n++) {
    const s = e[n];
    s.at > t && s.at < o && (zr(e, s), n--);
  }
}
function js(e, t, o, n, s, i) {
  Ps(e, s, i);
...
const _s = "easeInOut", Os = 20;
function Us(e, { defaultTransition: t = {}, ...o } = {}, n, s) {
  ...
  for (let g = 0; g < e.length; g++) {
    ...
    let A = 0;
    const S = (N, b, R, B = 0, V = 0) => {
      const T = zs(N), { delay: y = 0, times: M = Gr(T), type: $ = "keyframes", repeat: Z, repeatType: U, repeatDelay: z = 0, ...re } = b;
      let { ease: X = t.ease || "easeOut", duration: _ } = b;
      const Y = typeof y == "function" ? y(B, V) : y, D = T.length, G = Xr($) ? $ : s?.[$];
      if (D <= 2 && G) {
        let ae = 100;
        if (D === 2 && qs(T)) {
          const le = T[1] - T[0];
        ...
        const J = { ...re };
        _ !== void 0 && (J.duration = Yr(_));
        const ne = Wr(J, ae, G);
        X = ne.ease, _ = ne.duration;
      }
      _ ?? (_ = i);
      const K = p + Y;
      M.length === 1 && M[0] === 0 && (M[1] = 1);
      const ie = M.length - T.length;
      if (ie > 0 && qr(M, ie), T.length === 1 && T.unshift(null), Z) {
        ct(Z < Os, "Repeat count too high, must be less than 20"), _ = Bs(_, Z);
        const ae = [...T], J = [...M];
        ...
        for (let le = 0; le < Z; le++) {
          ...
          for (let L = 0; L < ae.length; L++)
            M.push(J[L] + (le + 1)), X.push(L === 0 ? "linear" : It(ne, L - 1));
        }
        Ds(M, Z);
      }
      const ce = K + _;
      js(R, T, X, M, K, ce), A = Math.max(Y + _, A), C = Math.max(ce, C);
    };
    if (at(v)) {
      const N = N1(v, d);
      S(w, x, V1("default", N));
    } else {
      const N = Bt(v, w, n, l), b = N.length;
      for (let R = 0; R < b; R++) {
        w = w, x = x;
        const B = N[R], V = N1(B, d);
        for (const T in w)
          S(w[T], Gs(x, T), V1(T, V), R, b);
      }
    }
    u = p, p += A;
  }
  return d.forEach((g, m) => {
    for (const v in g) {
      ...
      for (let b = 0; b < w.length; b++) {
        const { at: R, value: B, easing: V } = w[b];
        x.push(B), A.push(Kr(0, C, R)), S.push(V || "easeOut");
      }
      A[0] !== 0 && (A.unshift(0), x.unshift(x[0]), S.unshift(_s)), A[A.length - 1] !== 1 && (A.push(1), x.push(null)), a.has(m) || a.set(m, {
        keyframes: {},
        transition: {}
      });
      const N = a.get(m);
...
const Ws = (e) => typeof e == "number", qs = (e) => e.every(Ws);
function Xs(e, t) {
  return e in t;
}
class Ys extends Qr {
...
function Ks(e) {
  ...
  }, o = eo(e) && !to(e) ? new ro(t) : new oo(t);
  o.mount(e), Ge.set(e, o);
}
function Qs(e) {
  const t = {
    presenceContext: null,
...
function Pt(e, t, o, n) {
  const s = [];
  if (Js(e, t))
    s.push(no(e, p1(t) && t.default || t, o && (o.default || o)));
  else {
    const i = Bt(e, t, n), a = i.length;
    ct(!!a, "No valid elements provided.");
    for (let d = 0; d < a; d++) {
      const l = i[d], f = l instanceof Element ? Ks : Qs;
      Ge.has(l) || f(l);
      const u = Ge.get(l), p = { ...o };
      "delay" in p && typeof p.delay == "function" && (p.delay = p.delay(d, a)), s.push(...so(u, { ...t, transition: p }, {}));
    }
  }
  return s;
}
function ei(e, t, o) {
  const n = [];
  return Us(e, t, o, { spring: io }).forEach(({ keyframes: i, transition: a }, d) => {
    n.push(...Pt(d, i, a));
  }), n;
}
class ti {
...
function ni(e) {
  function t(o, n, s) {
    let i = [];
    return oi(o) ? i = ei(o, n, e) : i = Pt(o, n, s, e), new ri(i);
  }
  return t;
}
const si = ni(), ii = (e, t) => /* @__PURE__ */ c(
  "svg",
  {
...
const Fc = (e, t) => /* @__PURE__ */ c(
...
), h2 = h(f2), g2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: ai,
  Add: ao,
  Ai: li,
  ...
  Calendar: yo,
  CalendarArrowDown: $i,
  CalendarArrowLeft: Ii,
  CalendarArrowRight: ji,
  CameraPlus: Zi,
  CardPin: Oi,
  ChartFunnel: zi,
...
const A2 = Te({
  ...
  ({
    ...
    const Pe = D && D !== "none" || G && G !== "none" || K && K !== "none" || ie && ie !== "none", Se = Y && Y !== "none" || Pe, je = { sm: xe, md: Ye, lg: Ke, xl: Qe }, De = $2.map((Ze) => {
      const _e = je[Ze];
      return _e ? H2(Ze, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        className: k(
          ...
          De,
          Se && !_ && "border-f1-border",
          H && !O && "divide-f1-border",
          "scrollbar-macos"
        ),
        ...Ie
      }
...
const t1 = Wn(
  ...
  "div",
  {
    ...
    children: e.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ r(we, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ r(
        P2,
        {
          att: s,
          onRemove: o,
...
function P2({
  ...
  const n = /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(ue, { icon: lt, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ r(
      "button",
      {
        ...
        onClick: () => t(e.id),
        children: /* @__PURE__ */ r(ue, { icon: Fe, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ r(Xn, { label: e.errorMessage, children: n }) : n;
}
const j2 = {
  soft: {
    text: "",
    ...
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (u, p) => /* @__PURE__ */ c(
        "div",
        {
          ...
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ r(we, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ r(
              we,
              {
...
const _2 = ({
  ...
  return /* @__PURE__ */ r("div", { className: "p-1", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ r(ue, { icon: m1, size: "md", color: "default" }) }),
        /* @__PURE__ */ r(
          fe,
          {
  ...
  const s = Le(), [i, a] = I(""), [d, l] = I(0), [f, u] = I(!1), p = j(null), C = j(null), g = j(null), m = e[d] ?? t;
  return Q(() => {
    const v = () => {
...
`) ? o + "_" : o
  ...
  cards: e,
  onCardSelect: t
}) => e.length === 0 ? null : /* @__PURE__ */ r("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, z2).map((o) => /* @__PURE__ */ r(
  Mt,
  {
...
const X2 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ c(
    d1,
    {
      ...
      children: [
        /* @__PURE__ */ r(Kn, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ r(u1, { asChild: !0, children: /* @__PURE__ */ r(
          he,
          {
            variant: "outline",
            label: d.label,
          ...
          f1,
          {
            ...
            children: [
              /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ r(ue, { icon: a.icon, size: "sm" }),
                /* @__PURE__ */ r("span", { children: a.label })
              ] }),
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: q2(a.items).map((d, l) => /* @__PURE__ */ c(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ r(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ r(ue, { icon: i1, size: "sm" })
                      }
                    )
                  ]
                },
...
function Q2(e, t) {
  ...
  return o.length === 0 ? e : e.filter(
    (n) => o.some((s) => K2(n.type, s))
  );
}
const J2 = 4e3;
function el(e) {
  const [t, o] = I([]), [n, s] = I(null), i = j(
    null
  ), a = j(null), d = q(), l = e?.onUploadFiles, f = e?.allowedMimeTypes, u = e?.maxFiles, p = te(() => {
    if (f)
      return Array.isArray(f) ? f.join(",") : f;
  }, [f]), C = u !== void 0 && t.length >= u, g = j(0);
  Q(() => {
    g.current = t.length;
  }, [t]);
  const m = W((S) => {
  ...
  const v = W(
    async (S) => {
      ...
      const B = (V) => o(
        (T) => T.map(
          (y) => R.includes(y.id) ? { ...y, status: "error", errorMessage: V } : y
        )
      );
      try {
        const V = await l(N);
        ...
        const T = V instanceof Error && V.message ? V.message : d.ai.fileUploadError;
        B(T);
      }
    },
    [
...
function sl({
  ...
  const [i, a] = I(!1), [d, l] = I(""), [f, u] = I([]), [p, C] = I(!1), [g, m] = I(0), [v, w] = I([]), x = j(-1), A = j(null), S = j(0), N = j(-1);
  Q(() => {
    if (!n) {
      a(!1);
      return;
    ...
    if (M.atIndex === N.current)
      return;
    x.current = M.atIndex, l(M.query), a(!0), m(0), C(!0), A.current && clearTimeout(A.current);
    const $ = ++S.current;
    return A.current = setTimeout(() => {
      n(M.query).then((Z) => {
        $ === S.current && (u(Z), m(0), Z.length === 0 && M.query.length > 0 && (N.current = M.atIndex, a(!1)));
      }).catch(() => {
        $ === S.current && u([]);
      }).finally(() => {
        $ === S.current && C(!1);
  ...
  const b = W(() => {
    ...
    (M) => {
      const $ = x.current;
      if ($ === -1) return;
      const Z = `${M.firstName} ${M.lastName}`.trim(), U = String(M.id), z = e.slice(0, $), re = e.slice(o), X = `@${Z} `, _ = z + X + re, Y = z.length + X.length;
      t(_), w((D) => [...D.filter((K) => !(K.id === U && K.name === Z)), { id: U, name: Z }]), b(), requestAnimationFrame(() => {
        const D = s.current;
    ...
    (M) => {
      if (!i) return !1;
      if (M.key === "Escape")
        return M.preventDefault(), b(), !0;
      if (f.length === 0) return !1;
      switch (M.key) {
        case "ArrowDown":
          return M.preventDefault(), m(($) => ($ + 1) % f.length), !0;
        case "ArrowUp":
        ...
        case "Tab": {
          ...
          if ($) {
            ...
            if (d.length === 0 || Z.toLowerCase().startsWith(d.toLowerCase()))
              return M.preventDefault(), R($), !0;
          }
          return !1;
        }
        case "Enter":
          return M.preventDefault(), f[g] && R(f[g]), !0;
        default:
          return !1;
      }
    },
    ...
    (M) => {
      ...
      let $ = M;
      const Z = [...v].sort((U, z) => z.name.length - U.name.length);
      for (const U of Z) {
        const z = `@${U.name}`, re = `<entity-ref type="person" id="${S1(U.id)}">${S1(U.name)}</entity-ref>`;
        for (; $.includes(z); )
          $ = $.replace(z, re);
      }
      return $;
  ...
  Q(() => {
    w(
      (M) => M.filter(($) => {
        const Z = `@${$.name}`, U = e.indexOf(Z);
        if (U === -1) return !1;
        const z = e[U + Z.length];
        return z === " " || z === `
` || z === "	";
      })
    );
  ...
  const T = te(() => {
    ...
    const M = s.current;
    if (!M) return null;
    const $ = ol(M, x.current), Z = M.offsetLeft + $.left, z = (M.offsetParent ? M.offsetParent.offsetHeight : 0) - (M.offsetTop + $.top);
    return { left: Z, bottom: z };
  }, [i, e, o, s]), y = te(() => {
    if (!i || f.length === 0) return null;
    const M = f[g];
    if (!M) return null;
    const $ = `${M.firstName} ${M.lastName}`.trim();
...
const il = /[\\`*_{}[\]()#+\-.!|~>]/g, al = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, o) => o % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(il, "\\$&")).join(""), I6 = ({
  onSubmit: e,
  onStop: t,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const V = q(), T = Le(), [y, M] = I(""), [$, Z] = I(0), [U, z] = I(!1), [re, X] = I(!1), [_, Y] = I(null), D = j(null), G = j(null), K = j(null), ie = a != null, { tracking: ce } = ye(), ae = W(
    (ee, ke) => {
    ...
    const ke = Ne.current, e1 = ke && !/\s$/.test(ke) ? " " : "", Oe = `${ke}${e1}${ee}`;
    M(Oe), Z(Oe.length);
  }, []), Xe = {
    ...
    onPartial: Ve,
    onFinal: (ee) => {
      Ve(ee), G.current?.focus();
    },
    onError: (ee) => ve(Xe[ee])
  }), Ye = !!C && xe.isSupported, Ke = W(() => {
    ce?.onDictationStart?.(), Ne.current = y, xe.start();
  }, [y, xe, ce]), Qe = W(() => {
    ce?.onDictationCancel?.(), xe.cancel();
  }, [xe, ce]);
  Q(() => {
  ...
  const Ie = xe.status === "recording", Je = Ie ? V.ai.listening : V.ai.inputPlaceholder, Pe = J.filter((ee) => ee.status === "uploaded"), Se = J.some((ee) => ee.status === "uploading"), je = J.some((ee) => ee.status === "error"), De = y.trim().length > 0;
  Q(() => {
    if (!(!re || Se)) {
      if (X(!1), je) {
        ve(V.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const Ze = async (ee) => {
    if (ee.preventDefault(), !ie) {
      if (se.close(), o)
        ...
        const ke = se.transformMentions(y.trim()), e1 = al(ke), Oe = Pe.flatMap(
    ...
    ie || se.handleKeyDown(ee) || ee.key === "Enter" && !ee.shiftKey && (ee.preventDefault(), o || D.current?.requestSubmit());
  }, Tr = () => {
    Z(G.current?.selectionStart ?? 0);
  }, Hr = () => {
    K.current && G.current && (K.current.scrollTop = G.current.scrollTop);
  }, w1 = _ ? _.prompt ?? _.title : null, x1 = Ie ? [V.ai.listening] : w1 ? [w1] : s ?? [], Ar = x1.length > 1, $r = te(() => Y2(y, se.mentions, {
    cursorPosition: $,
    inlineCompletion: se.inlineCompletion
  }), [y, se.mentions, $, se.inlineCompletion]), Br = se.mentions.length > 0 || se.inlineCompletion !== null, k1 = x && !!S && S.length > 0 && !!N ? /* @__PURE__ */ r(
    X2,
    {
      suggestions: S,
      onItemClick: ae,
  ...
  ) : null, Ir = x && A && !!b && b.length > 0, L1 = A && x, { motionProps: Pr } = Jn(
    x,
    160,
    0.5
  );
    ...
    oe.div,
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ r(D2, { creditWarning: i, children: /* @__PURE__ */ c(
            oe.form,
            {
              "aria-busy": o,
              ref: D,
              ...
              children: [
                /* @__PURE__ */ r(
                  Z2,
                  {
                    ...
                    selectedIndex: se.selectedIndex,
                    position: se.popoverPosition,
                    onSelect: se.selectPerson
                  }
                ),
                /* @__PURE__ */ r(Ee, { initial: !1, children: ie ? /* @__PURE__ */ r(
                  oe.div,
                  {
                  ...
                  oe.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ r(Ee, { initial: !1, children: ge && /* @__PURE__ */ r(
                        oe.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ c(
                            "div",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ r("p", { className: "font-medium text-f1-foreground-critical", children: ge })
                              ]
                            }
                          )
                        },
        ...
        Ir && /* @__PURE__ */ r("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ r(
          G2,
          {
            cards: b,
            onCardSelect: R
        ...
        w && x && A && /* @__PURE__ */ r("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: w }),
        /* @__PURE__ */ r(Ee, { mode: "wait", initial: !1, children: ie ? /* @__PURE__ */ c(
          oe.div,
          {
          ...
          oe.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ r(fe, { className: "text-sm font-medium text-f1-foreground-tertiary", children: v.text }),
...
function He({
  ...
  const i = j(/* @__PURE__ */ new Map()), [a, d] = I(
    () => i.current.get(e) ?? null
  ), [l, f] = I(!1), [u, p] = I(!1), C = j(!0);
  Q(() => () => {
    C.current = !1;
  }, []);
  const g = W(() => {
...
function Rl({
  ...
  const { entityRefs: o } = ye(), n = o?.resolvers?.candidate, s = q(), i = o?.urls?.candidate?.(e), a = te(
    () => (l) => {
      const f = [];
...
function Fl({ id: e, label: t }) {
  const { entityRefs: o } = ye(), n = o?.resolvers?.expense, s = q(), i = o?.urls?.expense?.(e), a = te(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: Dt
...
function Nl({
  ...
  const { entityRefs: o } = ye(), n = o?.resolvers?.jobPosting, s = q(), i = o?.urls?.jobPosting?.(e), a = te(
    () => (l) => ({
      title: l.title,
...
function Sl({
  ...
  const { entityRefs: o } = ye(), n = o?.resolvers?.requisition, s = q(), i = o?.urls?.requisition?.(e), a = te(
    () => (l) => {
...
function Tl({ id: e, label: t }) {
  const { entityRefs: o } = ye(), n = o?.resolvers?.person, s = q(), i = o?.urls?.person?.(e), a = te(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
function Hl({ id: e, label: t }) {
  const { entityRefs: o } = ye(), n = o?.resolvers?.vacancy, s = q(), i = o?.urls?.vacancy?.(e), a = te(
    () => (l) => ({
      title: l.name,
...
function hr({
  ...
  const a = q(), d = s.type === "open", l = d ? n ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ c(
    "div",
    {
      className: k(
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ r(Rt, { module: e.module, size: "md" }),
          e?.type === "file" && /* @__PURE__ */ r(as, { file: e.file, size: "lg" }),
          /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            ...
            o && /* @__PURE__ */ r(fe, { className: "text-base text-f1-foreground-secondary", children: o })
          ] }),
...
const T1 = 7, Pl = 625, H1 = /* @__PURE__ */ new Set();
function jl(e) {
...
function Zl(e) {
  const { days: t, hours: o, minutes: n, seconds: s } = ls(e), i = [];
...
function gr(e, t) {
  ...
  return { type: "item", text: Dl(String(e)) };
}
function pr({
  formName: e,
  formDescription: t,
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: u } = ye(), p = Il(e), C = d ?? p, g = j(() => {
  ...
  g.current = x, Q(() => {
    typeof window > "u" || window.innerWidth < Pl || H1.has(e) || (H1.add(e), g.current());
  }, [e]);
  const A = i && a ? Object.entries(i).map(([b, R]) => {
    const B = a[b], V = C?.(b, B, {
      fieldType: R.fieldType,
      customFieldName: R.customFieldName
    });
    if (!V && R.fieldType === "custom" && typeof B == "object" && B !== null)
      return null;
    const T = V ?? gr(B, R.fieldType), y = ["richtext", "textarea"];
    return {
      label: R.label,
      content: T,
      verticalLayout: y.includes(R.fieldType ?? "")
    };
  }).filter((b) => {
    if (!b) return !1;
    const R = Array.isArray(b.content) ? b.content[0] : b.content;
    return !(R?.type === "item" && R.text === "—");
  }) : [], S = A.slice(0, T1), N = A.length > T1;
  return /* @__PURE__ */ r(
    hr,
    {
...
const vr = We(void 0), Z6 = () => Be(vr), zl = (e) => /* @__PURE__ */ r(Ft, { content: e, format: "markdown" }), Gl = ({
  isGenerating: e,
  isLoading: t,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", l = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, f = o?.toolCalls?.[0]?.id, u = !d && !l, p = j(null), { anchor: C, clear: g } = Cr({
    containerRef: p,
    enabled: !!(o?.id && d)
  });
  return Q(() => {
  ...
  const [s, i] = I(""), a = q(), { title: d, label: l, placeholder: f } = o === "like" ? a.ai.feedbackModal.positive : a.ai.feedbackModal.negative, u = W(() => {
    t(n, s);
  }, [s, n, t]), p = () => {
    e(n);
  };
...
const Yl = ({
  ...
  const n = q(), { open: s } = xr(), [i, a] = I(null);
      ...
      children: [
        /* @__PURE__ */ c(
          Vt,
          {
            ...
            children: [
              /* @__PURE__ */ r("span", { className: "flex items-center justify-start h-6 w-6", children: /* @__PURE__ */ r(ue, { icon: e, className: "block" }) }),
              /* @__PURE__ */ r("div", { className: "min-h-6 flex items-center", children: /* @__PURE__ */ r("span", { children: t }) }),
              !a && /* @__PURE__ */ r(ue, { icon: qe })
            ]
          }
        ),
        /* @__PURE__ */ r(St, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ r(
          oe.div,
          {
            initial: !1,
            animate: {
...
const kr = (e) => /* @__PURE__ */ r(Ft, { content: e, format: "markdown" }), t4 = ({
  text: e,
  renderMarkdown: t
}) => /* @__PURE__ */ c("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ r("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ r(ue, { icon: m1 }) }),
  ...
  const a = e.rawData, d = e4(
    e?.content,
    a
  ), l = (Jl(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = l.length > 0, { anchor: p, clear: C } = Cr({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ r(t4, { text: f, renderMarkdown: n }),
...
}, o4 = 35, n4 = 22, s4 = 400, i4 = 2500, a4 = 220, c4 = ({
  messages: e,
  onClick: t,
  fullscreen: o = !1
}) => {
  ...
  Q(() => {
    ...
    let C;
    if (d === "starting")
      C = setTimeout(() => l("writing"), s4);
    else if (d === "writing")
      i < f.length ? C = setTimeout(() => a((g) => g + 1), o4) : l("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      C = setTimeout(() => l("erasing"), i4);
    } else d === "erasing" && (i > 0 ? C = setTimeout(() => a((g) => g - 1), n4) : C = setTimeout(() => {
...
function l4({
  ...
  const [a, d] = I(0), [l, f] = I(!1), u = j(s), p = j(i);
  p.current = i;
  const C = W(
    (m = "smooth") => {
  ...
  const g = W(() => {
    const m = e.current;
    if (!m) return;
    const { scrollTop: v, scrollHeight: w, clientHeight: x } = m, A = w - v - x;
    f(A > x);
  }, [e]);
  return Q(() => {
    const m = e.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!m || !v) return;
        const w = m.getBoundingClientRect(), x = v.getBoundingClientRect(), A = m.scrollTop + (x.top - w.top);
...
const d4 = {
...
}, _6 = (e) => /* @__PURE__ */ r(ql, { children: /* @__PURE__ */ r(u4, { ...e }) }), u4 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: S, handleSubmit: N, handleClose: b } = Xl(
    u ?? d4
  ), R = q(), B = v ?? Gl, V = w ?? r4, T = te(() => {
    const D = n ?? R.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((K) => typeof K == "string" && K.length > 0);
  }, [n, R.ai.defaultInitialMessage]), y = !t && e.length === 0 && T.length > 0, M = j(null), $ = j(null), Z = j(null), U = j(null), z = j(null), { showScrollBtn: re, turnMinHeight: X, scrollToBottom: _ } = l4({
    viewportRef: M,
    contentRef: $,
    endRef: Z,
    lastTurnRef: z,
    ...
    const K = G === e.length - 1, ie = {
      ...
      const le = K && ne === D.assistantMessages.length - 1, L = D.userMessages.length + ne, F = {
        message: J,
        inProgress: D.isInProgress,
        index: L,
        isCurrentMessage: le,
      ...
      return /* @__PURE__ */ r(
        ...
        {
          ...F,
          isGenerating: D.isInProgress && le,
          isLoading: D.isInProgress && le && !J.content
        },
        `${G}-a-${ne}`
      );
    };
    return /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          D.endIndicator === "thinking" && /* @__PURE__ */ r(n1, { title: R.ai.thinking, status: "executing" }),
          D.endIndicator === "activity" && /* @__PURE__ */ r(n1, { status: "writing" }),
...
}, f4 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ r("div", { className: "flex justify-end", children: /* @__PURE__ */ r(we, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ r(we, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ r(we, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ r(we, { className: "h-5 w-4/5 rounded-md" })
] }) }), O6 = {
  ai: Hs.ai
}, Lr = We(null);
function U6({
...
const g4 = ({
  ...
  const C = q().ai.clarifyingQuestion.typeYourAnswer, g = e === "single" ? /* @__PURE__ */ r(br, { isSelected: o && !t }) : /* @__PURE__ */ r(
    Tt,
    {
      checked: s,
      onCheckedChange: () => f(!s),
...
const C4 = ({
  ...
  const x = Le(), A = (() => {
    ...
    const B = o.findIndex((V) => n.includes(V.id));
    return B >= 0 ? B : 0;
  })(), [S, N] = I(A), b = j([]);
  Q(() => {
    p && e === "single" && b.current[S]?.focus();
  }, []);
  const R = (B) => {
    if (e !== "single") return;
    const V = o.length - 1;
    ...
    B.preventDefault(), N(T), b.current[T]?.focus();
  };
  return /* @__PURE__ */ c(
    "div",
    {
  ...
  } = s, B = j(null), V = A ?? "single", T = a > 1, y = i === 0, M = i === a - 1, $ = T ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  }) : void 0, Z = x.length > 0, U = (b ?? "").trim().length > 0, z = Z || R && U || S === !0, re = t === !0 && M, X = () => {
    re || l();
  }, _ = () => {
    re || f();
  }, Y = (ae) => {
    const J = V === "single" && x.includes(ae);
    d(ae), V === "single" && !M && !J && Promise.resolve().then(l);
  }, D = M ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, G = S === !0 && !Z && !(R && U), K = () => {
    m(), requestAnimationFrame(() => {
      B.current?.focus();
    });
  }, ie = (ae) => {
    ae.key === "Escape" && (ae.preventDefault(), u());
  }, ce = n ? 0 : w4 / 2;
  return /* @__PURE__ */ c("div", { className: "flex flex-col", onKeyDown: ie, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ c(
      oe.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ce, ease: v4 },
        children: [
          /* @__PURE__ */ r(
            m4,
            {
...
function j1(e, t, o, n) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(o, 20), d = Math.min(i + n, s), l = Math.min(d, Math.floor(e / 2)), f = Math.min(d, Math.floor(t / 2)), u = (K) => K / e * 2 - 1, p = (K) => K / t * 2 - 1, C = 0, g = e, m = 0, v = t, w = l, x = e - l, A = f, S = t - f, N = u(C), b = u(g), R = p(m), B = p(v), V = u(w), T = u(x), y = p(A), M = p(S), $ = 0, Z = 0, U = 1, z = 1, re = l / e, X = 1 - l / e, _ = f / t, Y = 1 - f / t, D = new Float32Array([
    // Top strip
    N,
    R,
    b,
...
class q6 {
  ...
  setupGL() {
    ...
    const C = t.getUniformLocation(o, "uResolution"), g = t.getUniformLocation(o, "uTime"), m = t.getUniformLocation(o, "uBorderWidth"), v = t.getUniformLocation(o, "uGlowWidth"), w = t.getUniformLocation(o, "uBorderRadius"), x = t.getUniformLocation(o, "uColors"), A = t.getUniformLocation(o, "uGlowExponent"), S = t.getUniformLocation(o, "uGlowFactor");
    t.useProgram(o), t.uniform1f(m, this.options.borderWidth), t.uniform1f(v, this.options.glowWidth), t.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (t.uniform1f(A, 2), t.uniform1f(S, 1.8)) : (t.uniform1f(A, 1), t.uniform1f(S, 1));
    const N = (this.options.colors || y4).map(M4);
    for (let b = 0; b < N.length; b++)
      t.uniform3f(
        t.getUniformLocation(o, `uColors[${b}]`),
        ...N[b]
      );
...
const Z1 = ["lowp", "mediump", "highp"], E4 = `
void main(void){
...
}`, O1 = "iTime", U1 = "iTimeDelta", z1 = "iDate", G1 = "iFrame", W1 = "iMouse", q1 = "iResolution", F4 = "iChannel", X1 = "iChannelResolution", Y1 = "iDeviceOrientation";
function N4(e, t) {
...
}, r1 = 9729, K1 = 9728, A4 = 9987, Q1 = 33071, J1 = 10497;
class $4 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const p = 0, C = o.RGBA, g = 1, m = 1, v = 0, w = o.RGBA, x = o.UNSIGNED_BYTE, A = new Uint8Array([255, 255, 255, 0]), S = o.createTexture();
    if (o.bindTexture(o.TEXTURE_2D, S), o.texImage2D(
      ...
      const B = this.setupVideo(n);
      return o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.LINEAR), this._webglTexture = S, this.source = B, this.isVideo = !0, B.play().then(() => this);
    }
    async function N() {
    ...
    let b = await N(), R = (b.width & b.width - 1) === 0 && (b.height & b.height - 1) === 0;
    return (t.wrapS !== Q1 || t.wrapT !== Q1 || t.minFilter !== K1 && t.minFilter !== r1) && !R && (b = this.makePowerOf2(b), R = !0), o.bindTexture(o.TEXTURE_2D, S), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, l), o.texImage2D(
      o.TEXTURE_2D,
      p,
      C,
      w,
      x,
      b
    ), R && t.minFilter !== K1 && t.minFilter !== r1 && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || J1
    ), o.texParameteri(
      ...
      this.magFilter || r1
    ), this._webglTexture = S, this.source = b, this.isVideo = !1, this.isLoaded = !0, this.width = b.width || 0, this.height = b.height || 0, this;
  };
}
const be = (e) => `react-shaders: ${e}`, et = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, tt = (e, t, o) => e * (1 - o) + t * o, B4 = (e, t, o) => o > 0 ? e.substring(0, o) + t + e.substring(o, e.length) : t + e;
function I4({
  fs: e,
  vs: t = _1,
  textures: o = [],
  ...
  const g = j(null), m = j(null), v = j(null), w = j(null), x = j(void 0), A = j(void 0), S = j(!1), N = j(void 0), b = j(0), R = j([0, 0]), B = j([]), V = j(0), T = j(void 0), y = j({
    ...
    const E = "width" in L ? L.width ?? 0 : 0, P = "height" in L ? L.height ?? 0 : 0, H = y.current.iChannelResolution;
    if (!H) return;
    const O = Array.isArray(H.value) ? H.value : H.value = [];
    O[F * 3] = E * f, O[F * 3 + 1] = P * f, O[F * 3 + 2] = 0;
  }, Z = () => {
    ...
    const [F = 0, E = 0] = et(L), P = F - (N.current?.left ?? 0) - window.pageXOffset, H = (N.current?.height ?? 0) - E - (N.current?.top ?? 0) - window.pageYOffset;
    S.current = !0;
    const O = Array.isArray(y.current.iMouse?.value) ? y.current.iMouse.value : void 0;
    O && (O[2] = P, O[3] = H), R.current[0] = P, R.current[1] = H;
  }, X = (L) => {
    N.current = g.current?.getBoundingClientRect();
    const [F = 0, E = 0] = et(L), P = F - (N.current?.left ?? 0), H = (N.current?.height ?? 0) - E - (N.current?.top ?? 0);
    if (l !== 1)
      R.current[0] = P, R.current[1] = H;
    else {
      const O = Array.isArray(y.current.iMouse?.value) ? y.current.iMouse.value : void 0;
      O && (O[0] = P, O[1] = H);
    }
  }, _ = () => {
    const L = Array.isArray(y.current.iMouse?.value) ? y.current.iMouse.value : void 0;
    L && (L[2] = 0, L[3] = 0);
  }, Y = () => {
    const L = m.current;
    if (!L) return;
    N.current = g.current?.getBoundingClientRect();
    const F = f, E = Math.floor(
      (N.current?.width ?? 1) * F
    ), P = Math.floor(
      (N.current?.height ?? 1) * F
    );
    if (L.canvas.width = E, L.canvas.height = P, y.current.iResolution?.isNeeded && w.current) {
    ...
    const E = m.current;
    if (!E) return null;
    const P = E.createShader(L);
    if (!P) return null;
    if (E.shaderSource(P, F), E.compileShader(P), !E.getShaderParameter(P, E.COMPILE_STATUS)) {
      C?.(be(`Error compiling the shader:
${F}`));
      const H = E.getShaderInfoLog(P);
      E.deleteShader(P), p?.(be(`Shader compiler log: ${H}`));
    }
    return P;
  }, G = (L, F) => {
    const E = m.current;
    if (!E) return;
    const P = D(E.FRAGMENT_SHADER, L), H = D(E.VERTEX_SHADER, F);
    if (w.current = E.createProgram(), !(!w.current || !H || !P)) {
      if (E.attachShader(w.current, H), E.attachShader(w.current, P), E.linkProgram(w.current), !E.getProgramParameter(w.current, E.LINK_STATUS)) {
        p?.(
          be(
    ...
    if (n)
      for (const L of Object.keys(n)) {
        const F = n[L];
        if (!F) continue;
        const { value: E, type: P } = F, H = H4(P);
        if (!H) continue;
        const O = {};
        if (N4(P, E)) {
          const de = P.length, ge = Number.parseInt(P.charAt(de - 3)), ve = Math.floor(E.length / (ge * ge));
          E.length > ge * ge && (O.arraySize = `[${ve}]`);
        } else V4(P, E) && (O.arraySize = `[${Math.floor(E.length / Number.parseInt(P.charAt(0)))}]`);
        y.current[L] = {
          type: H,
          isNeeded: !1,
          value: E,
      ...
      if (o && o.length > 0) {
        ...
        const F = o.map(
          (E, P) => (y.current[`${F4}${P}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, $(E, P), B.current[P] = new $4(L), B.current[P]?.load(E).then((H) => {
            $(H, P);
          }))
        );
        Promise.all(F).then(() => {
    ...
    const F = Z1.includes(i ?? "highp"), E = `precision ${F ? i : Z1[1]} float;
`;
    F || C?.(
      be(
    ...
    let P = E.concat(`#define DPR ${f.toFixed(1)}
`).concat(L.replace(/texture\(/g, "texture2D("));
    for (const O of Object.keys(y.current))
      if (L.includes(O)) {
        const de = y.current[O];
        if (!de) continue;
        P = B4(
          P,
          `uniform ${de.type} ${O}${de.arraySize || ""}; 
`,
          P.lastIndexOf(E) + E.length
        ), de.isNeeded = !0;
      }
    return L.includes("mainImage") && (P = P.concat(E4)), P;
  }, ae = (L) => {
    const F = m.current;
    ...
    if (P)
      for (const H of Object.keys(P)) {
        const O = P[H];
        if (O && y.current[H]?.isNeeded) {
          if (!w.current) return;
          const de = F.getUniformLocation(
            w.current,
            H
          );
          if (!de) return;
    ...
    if (y.current.iMouse?.isNeeded) {
      ...
      F.uniform4fv(H, y.current.iMouse.value);
    }
    ...
    if (y.current.iDate?.isNeeded) {
      const H = /* @__PURE__ */ new Date(), O = H.getMonth() + 1, de = H.getDate(), ge = H.getFullYear(), ve = H.getHours() * 60 * 60 + H.getMinutes() * 60 + H.getSeconds() + H.getMilliseconds() * 1e-3, se = F.getUniformLocation(
        w.current,
        z1
      );
      F.uniform4fv(se, [ge, O, de, ve]);
    }
    if (y.current.iFrame?.isNeeded) {
      ...
      F.uniform1i(H, O), y.current.iFrame.value = O + 1;
    }
    if (B.current.length > 0)
      for (let H = 0; H < B.current.length; H++) {
        const O = B.current[H];
        if (!O) return;
        const { isVideo: de, _webglTexture: ge, source: ve, flipY: se, isLoaded: Ne } = O;
        if (!Ne || !ge || !ve) return;
        if (y.current[`iChannel${H}`]?.isNeeded) {
          if (!w.current) return;
          const Ve = F.getUniformLocation(
            w.current,
            `iChannel${H}`
          );
          F.activeTexture(F.TEXTURE0 + H), F.bindTexture(F.TEXTURE_2D, ge), F.uniform1i(Ve, H), de && O.updateTexture(
            ge,
            ve,
            se
          );
    ...
    F.viewport(0, 0, F.drawingBufferWidth, F.drawingBufferHeight), F.clear(F.COLOR_BUFFER_BIT | F.DEPTH_BUFFER_BIT), F.bindBuffer(F.ARRAY_BUFFER, v.current), F.vertexAttribPointer(
      ...
      0,
      0
    ), ae(L), F.drawArrays(F.TRIANGLE_STRIP, 0, 4);
    const E = y.current.iMouse?.value;
    if (y.current.iMouse?.isNeeded && l !== 1 && Array.isArray(E)) {
      const P = E[0] ?? 0, H = E[1] ?? 0;
      E[0] = tt(P, R.current[0] ?? 0, l), E[1] = tt(H, R.current[1] ?? 0, l);
    }
    A.current = requestAnimationFrame(J);
  }, ne = () => {
    const L = { passive: !0 };
    y.current.iMouse?.isNeeded && g.current && (g.current.addEventListener("mousemove", X, L), g.current.addEventListener("mouseout", _, L), g.current.addEventListener("mouseup", _, L), g.current.addEventListener("mousedown", re, L), g.current.addEventListener("touchmove", X, L), g.current.addEventListener("touchend", _, L), g.current.addEventListener("touchstart", re, L)), y.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      z,
      L
    ), g.current && (T.current = new ResizeObserver(Y), T.current.observe(g.current), window.addEventListener("resize", Y, L));
  }, le = () => {
    const L = { passive: !0 };
    y.current.iMouse?.isNeeded && g.current && (g.current.removeEventListener("mousemove", X, L), g.current.removeEventListener("mouseout", _, L), g.current.removeEventListener("mouseup", _, L), g.current.removeEventListener("mousedown", re, L), g.current.removeEventListener("touchmove", X, L), g.current.removeEventListener("touchend", _, L), g.current.removeEventListener("touchstart", re, L)), y.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      z,
      L
    ), T.current && (T.current.disconnect(), window.removeEventListener("resize", Y, L));
  };
  return Q(() => {
    M.current = n;
  }, [n]), Q(() => {
    ...
    function F() {
      Z();
      const E = m.current;
      E && g.current && (E.clearColor(...s), E.clearDepth(1), E.enable(E.DEPTH_TEST), E.depthFunc(E.LEQUAL), E.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, K(), ie(), G(ce(e || R4), t || _1), U(), requestAnimationFrame(J), ne(), Y());
    }
    return requestAnimationFrame(F), () => {
      ...
      if (E) {
        if (E.getExtension("WEBGL_lose_context")?.loseContext(), E.useProgram(null), E.deleteProgram(w.current ?? null), L.length > 0)
          for (const P of L)
            E.deleteTexture(P._webglTexture);
        w.current = null;
      }
...
}`, j4 = 10, D4 = 2, Z4 = 0.5, _4 = 0.2, O4 = 1.5, Ce = {
  duration: 0.5,
  ease: "easeOut"
}, rt = {
  duration: 0.35,
...
function U4(e, t) {
  const [o, n] = I(j4), {
    ...
    animate: i,
    motionValue: a
  } = Ue(_4), { value: d, animate: l } = Ue(D4), { value: f, animate: u } = Ue(Z4), { value: p, animate: C } = Ue(O4), g = As(t, {
    fftSize: 512,
...
function X6({
  ...
  const { speed: f, scale: u, amplitude: p, frequency: C, brightness: g } = U4(t, s);
  return /* @__PURE__ */ r(
    Mr,
    {
      ref: d,
...
const Y6 = ({
  ...
  const n = q(), s = Le();
  return /* @__PURE__ */ c(Re, { children: [
    e && /* @__PURE__ */ r("span", { className: k(q4(), "truncate"), children: e }),
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: k(Er()), children: t }),
    /* @__PURE__ */ c(
      oe.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ c("div", { className: "flex items-center gap-1", children: [
            ...
            o && /* @__PURE__ */ r("span", { className: k(ze()), children: o })
          ] }),
          n === "people" && /* @__PURE__ */ r(
            ps,
            {
          ...
          n === "alert" && /* @__PURE__ */ r(ms, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ r(K4, { balance: e.balance })
        ]
      }
    ),
    o && !Y4.has(n) && /* @__PURE__ */ r(
      oe.span,
      {
        className: k(ze()),
        animate: { opacity: s ? 0 : 1 },
...
const e6 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), t6 = ({
  label: e,
  direction: t
}) => {
  const o = Rr[t];
  ...
  const s = `sparkline-gradient-${it().replace(/:/g, "")}`, i = J4(e, o), a = Rr[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(ws, { width: "100%", height: "100%", children: /* @__PURE__ */ c(
          xs,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ r(ks, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                Ls,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ r(t6, { label: t, direction: i })
      ]
    }
  ) });
}, Fr = h(
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: k(Er()), children: n }),
              /* @__PURE__ */ r(
                oe.div,
                {
...
const o6 = ["className"], Nr = h((e, t) => {
  const o = o6.reduce((n, s) => {
    const { [s]: i, ...a } = n;
    return a;
  }, e);
...
const n6 = () => /* @__PURE__ */ c(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ r(we, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ c("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ r(we, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ r(we, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ r(we, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ r(we, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], Vr = 180, s6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Vr, i6 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, a6 = (e) => e.showActions !== !1, c6 = (e) => Object.fromEntries(
...
function l6(e) {
  ...
  } = e, [l, f] = I(!1), u = it(), p = j(null), C = s6(
    d
  ), g = i.length > C, m = l ? i : i6(i, C), v = a6(e) ? e : null, w = c6(e);
  return Q(() => {
    l && p.current?.focus();
  }, [l]), /* @__PURE__ */ c(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          t && /* @__PURE__ */ r(Rt, { module: t, size: "md" }),
...
l6.displayName = "F0AiProposalCard";
const d6 = ({
  icon: e,
  title: t,
  children: o
  ...
  return /* @__PURE__ */ c(
    Nt,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ c(Vt, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
          /* @__PURE__ */ r("span", { className: "mr-2 *:block", children: /* @__PURE__ */ r(ue, { icon: e, className: "block" }) }),
...
}, u6 = (e) => g2[e] ?? Ct, f6 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(ue, { icon: u6(e), size: "md", color: "default" }) }) : null;
function h6({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(d6, { icon: c1, title: n, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(f6, { iconName: s.icon });
...
h6.displayName = "F0AiMessageSources";
...
function p6({
  ...
  const n = q(), s = j(null), i = t ?? n.ai.aiTable.title, a = W(
    (d) => {
      if (!s.current) return;
...
function C6({ credits: e }) {
  const t = q(), [o, n] = I(!1), [s, i] = I(!1), [a, d] = I(!1), [l, f] = I(null), u = W(
    (g) => {
  ...
  return /* @__PURE__ */ c(d1, { open: o, onOpenChange: u, children: [
    /* @__PURE__ */ r(u1, { asChild: !0, children: /* @__PURE__ */ r(
      he,
      {
        variant: "ghost",
        hideLabel: !0,
...
const m6 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function v6({
  employeeCredits: e
}) {
  const t = q(), o = Le(), [n, s] = I(!1), [i, a] = I(!1), [d, l] = I(!1), [f, u] = I(null), p = W(
    (v) => {
  ...
  return /* @__PURE__ */ c(d1, { open: n, onOpenChange: p, children: [
    /* @__PURE__ */ r(u1, { asChild: !0, children: /* @__PURE__ */ r(
      he,
      {
        variant: "ghost",
...
const ot = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(v6, { employeeCredits: t }) : e ? /* @__PURE__ */ r(C6, { credits: e }) : null, J6 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const C = q(), g = Ms(`(max-width: ${Es.md}px)`, {
        ...
        /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ r(
          $e,
          {
            ...
            children: /* @__PURE__ */ c("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ r(fe, { lines: 1, className: "min-w-0 text-left", children: o ?? C.ai.newConversation }),
              /* @__PURE__ */ r(ue, { icon: a1, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ c(
...
function w6() {
  if (!(typeof navigator > "u"))
    return Ns(navigator.language);
}
function x6(e) {
  const t = new Date(e), o = /* @__PURE__ */ new Date();
  return Ht(t) ? "today" : At(t) ? "yesterday" : Rs(t, o) ? "thisMonth" : "older";
}
function k6(e, t) {
  const o = new Date(e), n = w6(), s = R1(o, "p", { locale: n });
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          "div",
          {
            ...
            children: /* @__PURE__ */ r(h1, { items: d, children: /* @__PURE__ */ r(
              me,
              {
                icon: pt,
                variant: "ghost",
...
const e9 = ({
  ...
  const g = te(
    ...
    return n.filter((B) => B.title.toLowerCase().includes(R));
  }, [n, p]), v = te(
    () => m.filter((R) => a.has(R.id)),
    [m, a]
  ), w = te(
    () => m.filter((R) => !a.has(R.id)),
    [m, a]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ c("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ r(ue, { icon: c1, color: "secondary", size: "md" }),
                  /* @__PURE__ */ r(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ r(
                    $e,
                    {
                      ...
                      children: /* @__PURE__ */ c("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ r(ue, { icon: C1, color: "default", size: "md" }),
...
function t9({
  ...
  const [n, s] = I([]), [i, a] = I(!1), [d, l] = I(null), [f, u] = I(M6), p = W(async () => {
    a(!0), l(null);
    try {
      const v = await t();
      s(v);
  ...
  const C = W((v) => {
    u((w) => {
      const x = new Set(w);
      return x.add(v), o1(x), x;
    });
  }, []), g = W((v) => {
    u((w) => {
      const x = new Set(w);
      return x.delete(v), o1(x), x;
    });
  }, []), m = W(
    async (v) => {
      try {
...
const E6 = oe.create(Ts), R6 = ({
  ...
  const { t: i } = q(), a = Le(), d = o ?? i("ai.applyingChanges");
  return Q(() => {
    if (!t) return;

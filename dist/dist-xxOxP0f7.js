import { Pt as e } from "./OneCalendar-B6RjA05-.js";
import { S as t } from "./F0Checkbox-C-oCrD_5.js";
import { _ as n } from "./popover-By8ytmVb.js";
import { l as r } from "./input-CAEigqto.js";
import { d as i, l as a, n as o, r as s, s as c, t as l } from "./dist-zRL9MpsG.js";
...
var p = "rovingFocusGroup.onEntryFocus", m = {
	bubbles: !1,
	cancelable: !0
}, h = "RovingFocusGroup", [g, _, v] = e(h), [y, b] = i(h, [v]), [x, S] = y(h), C = u.forwardRef((e, t) => /* @__PURE__ */ f(g.Provider, {
...
C.displayName = h;
var w = u.forwardRef((e, n) => {
	let { __scopeRovingFocusGroup: r, orientation: i, loop: d = !1, dir: h, currentTabStopId: g, defaultCurrentTabStopId: v, onCurrentTabStopIdChange: y, onEntryFocus: b, preventScrollOnEntryFocus: S = !1, ...C } = e, w = u.useRef(null), T = c(n, w), E = t(h), [D = null, O] = l({
		prop: g,
		defaultProp: v,
		onChange: y
	}), [k, j] = u.useState(!1), M = a(b), N = _(r), P = u.useRef(!1), [F, I] = u.useState(0);
	return u.useEffect(() => {
		let e = w.current;
	...
	let { __scopeRovingFocusGroup: r, focusable: i = !0, active: a = !1, tabStopId: c, ...l } = e, d = n(), p = c || d, m = S(T, r), h = m.currentTabStopId === p, v = _(r), { onFocusableItemAdd: y, onFocusableItemRemove: b } = m;
	return u.useEffect(() => {
		if (i) return y(), () => b();
	}, [
		i,
		...
		children: /* @__PURE__ */ f(s.span, {
			...
			onFocus: o(e.onFocus, () => m.onItemFocus(p)),
...
var M = C, N = E, P = "ToggleGroup", [F, I] = i(P, [b]), L = b(), R = d.forwardRef((e, t) => {
	let { type: n, ...r } = e;
...
var [z, B] = F(P), V = d.forwardRef((e, t) => {
	let { value: n, defaultValue: r, onValueChange: i = () => {}, ...a } = e, [o, s] = l({
		prop: n,
		defaultProp: r,
		onChange: i
	});
	...
	let { value: n, defaultValue: r, onValueChange: i = () => {}, ...a } = e, [o = [], s] = l({
		...
		defaultProp: r,
		onChange: i
	}), c = d.useCallback((e) => s((t = []) => [...t, e]), [s]), u = d.useCallback((e) => s((t = []) => t.filter((t) => t !== e)), [s]);
	return /* @__PURE__ */ f(z, {
		scope: e.__scopeToggleGroup,
		type: "multiple",
		value: o,
...
var [U, W] = F(P), G = d.forwardRef((e, n) => {
	let { __scopeToggleGroup: r, disabled: i = !1, rovingFocus: a = !0, orientation: o, dir: c, loop: l = !0, ...u } = e, d = L(r), p = t(c), m = {
		role: "group",
		dir: p,
		...u
	};
...
var J = d.forwardRef((e, t) => {
	let { __scopeToggleGroup: n, value: i, ...a } = e, o = B(K, n), s = {
		role: "radio",

...
import { C as i, L as a, N as o, O as s, S as c, _ as l, f as u, i as d, o as f, p, r as m, yt as h, z as g } from "./F0Button-BFtTqm8n.js";
import { n as _, t as v } from "./utils-CVzxZnoI.js";
import { N as y, P as b, t as x, w as S } from "./F0Dialog-Bh28_1sh.js";
import { C, D as w, E as T, O as E, S as D, T as O, _ as ee, b as k, c as A, d as j, f as M, g as N, h as P, l as F, m as I, p as te, s as L, t as ne, u as re, v as R, w as ie, x as ae, y as oe } from "./F0TextInput-DFE9ZYg6.js";
import { At as se, Bt as ce, Ct as le, Dt as z, Et as ue, Ft as de, It as B, Lt as fe, Mt as pe, Nt as me, Ot as he, Pt as ge, Rt as _e, St as ve, Tt as ye, Vt as be, _t as xe, a as Se, bt as Ce, c as we, ft as Te, gt as Ee, i as De, jt as V, kt as Oe, l as ke, r as Ae, vt as H, wt as je, xt as Me, zt as Ne } from "./F0AiFormRegistry-DtlE1Tj7.js";
import { P as Pe } from "./tooltip-BPSwDQpD.js";
import { _n as Fe, an as Ie, bn as Le, bt as Re, cn as ze, dn as Be, fn as Ve, gn as He, hn as Ue, in as We, ln as Ge, mn as Ke, nn as qe, on as Je, pn as Ye, rn as Xe, sn as Ze, tn as Qe, un as $e, vn as et, vt as tt, xt as nt, yn as rt } from "./F0Select-D7w3Lovd.js";
import { $t as it, At as at, Bt as ot, Ct as st, Dt as ct, Et as lt, Ft as ut, G as dt, Gt as ft, Ht as pt, It as mt, Jt as ht, Kt as gt, Lt as _t, Mt as vt, Nt as yt, Ot as bt, Pt as xt, Qt as St, Rt as Ct, St as wt, Tt, Ut as Et, Vt as Dt, Wt as Ot, Xt as kt, Yt as At, Zt as jt, _t as Mt, bt as Nt, c as Pt, d as Ft, gt as It, i as Lt, jt as Rt, kt as zt, l as Bt, mt as Vt, p as Ht, qt as Ut, r as Wt, s as Gt, vt as Kt, wt as qt, xt as Jt, yt as Yt, zt as Xt } from "./F0CanvasPanel-Dn4gpL8t.js";
import { At as Zt, D as Qt, Dt as $t, Et as en, Ft as tn, Mt as nn, Nt as rn, Ot as an, Pt as on, Tt as sn, at as cn, bt as ln, c as un, ct as dn, ft as fn, jt as pn, kt as mn, mt as hn, ot as gn, st as _n, t as vn, wt as yn, x as bn } from "./F0Checkbox-B2ZT94HT.js";
import { C as xn, K as Sn, Y as Cn, at as wn, it as Tn, ot as En, q as Dn, rt as On, st as kn } from "./F0Card-SSGaEK9S.js";
import { L as An, a as jn, i as Mn, n as Nn, t as Pn } from "./popover-DDfM6CZG.js";
import { S as U, a as Fn, b as In, i as Ln, x as Rn } from "./progress-BJOpxq7D.js";
import { t as zn } from "./Download-Dvj6cfxp.js";
import { t as Bn } from "./Globe-h1NiqzRt.js";
import { t as Vn } from "./Maximize-CyNX1-Xd.js";
import { D as Hn, E as Un, b as Wn, i as Gn, l as Kn, o as qn, s as Jn, v as Yn, w as Xn, x as Zn, y as Qn } from "./AiChatTranslationsProvider-CB3DRj6q.js";
import { t as $n } from "./Minimize-C1HdMgmx.js";
import { t as er } from "./Printer-snTHysV7.js";
import { n as tr, t as nr } from "./RichText-CW-0xoDy.js";
import { t as rr } from "./Reset-gUsyzwG8.js";
import { i as ir, n as ar, r as or, t as sr } from "./VolumeMuted-oJgKMeaA.js";
import { n as cr, t as lr } from "./SolidPlay-BNctDF_s.js";
import { n as ur } from "./skeleton-gsHEXIPQ.js";
import { t as dr } from "./F0Box-DNqLlvz3.js";
...
var Ca = W((e, t) => /* @__PURE__ */ Z("svg", {
	...
	DropdownOpen: () => Ke,
	Ellipsis: () => Rn,
	EllipsisHorizontal: () => In,
	Envelope: () => k,
	EnvelopeOpen: () => ci,
	Equal: () => Ye,
	EqualApproximately: () => Ve,
	EqualGreater: () => Be,
	EqualLess: () => $e,
	Exit: () => li,
	ExternalLink: () => wn,
	...
	FaceNeutral: () => Et,
	FacePositive: () => pt,
	FaceSuperNegative: () => Dt,
	FaceSuperPositive: () => ot,
	Feed: () => ui,
	File: () => Xt,
	FileFilled: () => di,
	FileSigned: () => fi,
	...
	let a = c();
	return r !== "transcribing" && e ? /* @__PURE__ */ X(d, {
		type: "submit",
		variant: "neutral",
		size: i,
...
}, qa = ({ onUploadFiles: e, toolbarStart: t, center: n, isAtMaxFiles: r, maxFiles: i, acceptValue: a, fileInputRef: o, handleFileSelect: s, inProgress: l, hasDataToSend: u, isPreSending: f, canRecord: p, recordingStatus: m = "idle", recordingStream: h, onStartRecording: g, onStopRecording: _, onCancelRecording: y }) => {
	let b = c();
	return m === "recording" ? /* @__PURE__ */ Z("div", {
		...
		children: [
			(e || t) && /* @__PURE__ */ Z("div", {
				className: v("flex items-center gap-2", n ? "shrink-0" : "min-w-0"),
				children: [e && /* @__PURE__ */ Z(br, { children: [/* @__PURE__ */ X(d, {
	...
	children: e.map((e) => e.status === "uploading" ? /* @__PURE__ */ X(u, { className: "h-9 w-36 rounded-[10px]" }, e.id) : e.status === "error" ? /* @__PURE__ */ X(Ya, {
		att: e,
		onRemove: n,
		removeLabel: r
	}, e.id) : /* @__PURE__ */ X(Se, {
...
function Ya({ att: e, onRemove: t, removeLabel: n }) {
	let r = /* @__PURE__ */ Z("div", {
		...
		children: [
			...
			/* @__PURE__ */ X("button", {
				type: "button",
				"aria-label": n,
				className: _("rounded-full text-f1-foreground-critical hover:text-f1-foreground-critical/80"),
				onClick: () => t(e.id),
	...
	return e.errorMessage ? /* @__PURE__ */ X(l, {
...
function Qa({ isOpen: e, results: t, isLoading: n, selectedIndex: i, position: a, onSelect: o }) {
	...
	let l = n && t.length === 0, d = !n && t.length === 0;
	return !e || d ? null : /* @__PURE__ */ X("div", {
		ref: s,
		role: "listbox",
		style: {
			position: "absolute",
		...
		className: v("z-50", "w-64 max-h-60 overflow-y-auto", "rounded-lg border border-solid border-f1-border-secondary", "bg-f1-background shadow-md", "p-1"),
		children: l ? Array.from({ length: 3 }, (e, t) => /* @__PURE__ */ Z("div", {
			className: "flex items-center gap-2 p-2",
			"aria-hidden": "true",
			children: [/* @__PURE__ */ X(u, { className: "size-5 shrink-0 rounded-full" }), /* @__PURE__ */ X(u, { className: v("h-4 rounded", t === 1 ? "w-24" : "w-32") })]
		}, t)) : t.map((e, t) => {
			...
			return /* @__PURE__ */ Z("div", {
				...
				role: "option",
				"aria-selected": n,
				className: v("flex cursor-pointer items-center gap-2 p-2 rounded", "transition-colors", n ? "bg-f1-background-secondary" : "hover:bg-f1-background-secondary-hover"),
				onMouseDown: (t) => {
...
var $a = ({ quote: e, onRemove: t }) => {
	...
	return /* @__PURE__ */ X("div", {
		...
		role: "status",
		children: /* @__PURE__ */ Z("div", {
			className: v("flex items-start gap-2 justify-center", "rounded-[10px] bg-f1-background-hover pl-2 py-1.5 pr-1.5"),
			children: [
				/* @__PURE__ */ X("div", {
	...
	let i = s(), [a, o] = Y(""), [c, l] = Y(0), [u, d] = Y(!1), f = J(null), p = J(null), m = J(null), _ = e[c] ?? t;
	return K(() => {
		let t = () => {
			p.current &&= (clearInterval(p.current), null), m.current &&= (clearInterval(m.current), null), f.current &&= (clearTimeout(f.current), null);
		};
		if (n.length > 0 || r) {
			d(!1), o(""), t();
			return;
		}
		if (i) return d(!1), o(_), t(), f.current = setTimeout(() => {
			let t = (c + 1) % Math.max(e.length, 1);
			l(t);
		}, 4e3), () => {
			t();
		};
		...
		return p.current = setInterval(() => {
			a < _.length ? (o(_.slice(0, a + 1)), a++) : (p.current &&= (clearInterval(p.current), null), f.current = setTimeout(() => {
				m.current = setInterval(() => {
					a > 0 ? (a--, o(_.slice(0, a))) : (m.current &&= (clearInterval(m.current), null), f.current = setTimeout(() => {
						let t = (c + 1) % Math.max(e.length, 1);
						l(t);
					}, 1e3));
				}, 30);
		...
		e.length,
		i
	]), n.length > 0 || r ? null : /* @__PURE__ */ X(h, { children: /* @__PURE__ */ X(g.div, {
		initial: { opacity: 0 },
		animate: { opacity: 1 },
		exit: { opacity: 0 },
		transition: { duration: i ? 0 : .4 },
		className: v("col-start-1 row-start-1", "pointer-events-none", "text-f1-foreground-secondary", "text-[16px] sm:text-[14px] leading-[20px] font-normal", "pt-3 px-3"),
		children: /* @__PURE__ */ Z("div", {
			className: v("overflow-hidden text-ellipsis whitespace-nowrap", "whitespace-pre-wrap break-words overflow-visible"),
			children: [a, u && !i && /* @__PURE__ */ X("span", {
	...
	children: [
		/* @__PURE__ */ X("div", {
			"aria-hidden": !0,
			className: v("col-start-1 row-start-1", "pointer-events-none invisible", "min-h-[20px] max-h-[240px]", "whitespace-pre-wrap break-words", "text-[16px] sm:text-[14px] leading-[20px] font-normal text-f1-foreground", "my-3 px-3"),
			children: n.endsWith("\n") ? n + "_" : n
		}),
		c && /* @__PURE__ */ X("div", {
			ref: t,
			"aria-hidden": !0,
			className: v("col-start-1 row-start-1", "pointer-events-none", "min-h-[20px] max-h-[240px]", "whitespace-pre-wrap break-words", "text-[16px] sm:text-[14px] leading-[20px] font-normal text-f1-foreground", "my-3 px-3", "overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"),
		...
		!n && !l && /* @__PURE__ */ X("p", {
			className: v("col-start-1 row-start-1", "pointer-events-none", "text-f1-foreground-secondary", "text-[16px] sm:text-[14px] leading-[20px] font-normal", "pt-3 px-3", "overflow-hidden text-ellipsis whitespace-nowrap"),
	...
	children: e.slice(0, 4).map((e) => /* @__PURE__ */ X(Gt, {
		avatar: {
			type: "icon",
			icon: e.icon
		},
...
var uo = ({ suggestions: e, onItemClick: t, onItemHover: n, side: r = "top", reserveTwoRows: i = !0, overflow: o = "wrap" }) => {
	let [s, c] = Y(null), l = J(null), u = o === "scroll", f = ro(), p = J(null), m = J(!1), h = gr(), g = gr(), _ = s === null ? null : e[s];
	return e.length === 0 ? null : /* @__PURE__ */ Z(Pn, {
		open: _ !== null,
		onOpenChange: (e) => {
			e || (c(null), n?.(null));
		},
		children: [/* @__PURE__ */ X("div", {
			className: v("flex w-full items-end", i && "min-h-[72px]"),
			children: /* @__PURE__ */ X(Nn, {
				asChild: !0,
				children: /* @__PURE__ */ X("div", {
					ref: (e) => {
						l.current = e, u && f.ref(e);
					},
					style: u ? f.style : void 0,
					className: v("flex w-full items-center gap-2", u ? v("flex-nowrap overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden", "p-1 -m-1") : "flex-wrap"),
					children: e.map((e, t) => /* @__PURE__ */ X(d, {
						type: "button",
						variant: "outline",
						label: e.label,
						icon: e.icon,
						...
						onClick: (e) => {
							p.current = e.currentTarget, m.current = !1, c((e) => e === t ? null : t), n?.(null);
						}
					}, `${e.label}-${t}`))
				})
			})
			...
			onCloseAutoFocus: (e) => {
				e.preventDefault(), m.current && p.current?.focus(), m.current = !1;
			},
			onEscapeKeyDown: () => {
				m.current = !0;
			},
			...
			className: v("flex flex-col gap-1 rounded-md border border-solid border-f1-border-secondary bg-f1-background p-2", "w-[var(--radix-popover-trigger-width)]"),
			children: [/* @__PURE__ */ Z("div", {
				id: g,
...
function fo({ item: e, onSelect: t, onHover: n }) {
	let r = J(null), i = J(null), o = J(null), c = s(), l = G(() => {
		...
		c || (o.current = window.setTimeout(() => {
			...
			if (n <= 0) return;
			let a = n + so, o = a / ao * 1e3;
			e.style.overflow = "visible";
			let s = `linear-gradient(90deg, transparent 0, #000 ${co}px)`;
			t.style.setProperty("mask-image", s), t.style.setProperty("-webkit-mask-image", s), e.style.transition = `transform ${o}ms linear`, e.style.transform = `translateX(-${a}px)`;
		}, oo));
	}, [c]), d = G(() => {
		n?.(e), u();
	}, [
	...
	return K(() => () => {
		...
		onFocus: d,
		onBlur: f,
		className: v("group flex items-center justify-between gap-2 rounded-sm px-2 py-2 text-left text-base font-medium text-f1-foreground transition-colors hover:bg-f1-background-hover focus-visible:bg-f1-background-hover", _()),
...
var _o = 4e3;
function vo(e) {
	let [t, n] = Y([]), [r, i] = Y(null), a = J(null), o = J(null), s = c(), l = e?.onUploadFiles, u = e?.allowedMimeTypes, d = e?.maxFiles, f = q(() => {
	...
	let g = G(async (e) => {
		...
		if (d !== void 0 && m.current + t.length > d) {
			h(s.ai.tooManyFilesError.replace("{{maxFiles}}", String(d)));
			return;
		}
		let r = t.map((e) => ({
		...
		try {
			...
			n((t) => t.map((t) => {
				...
				return n === -1 ? t : e[n] ? {
					...
					...t,
					status: "error",
					errorMessage: s.ai.fileUploadError
				};
			}));
		} catch (e) {
			a(e instanceof Error && e.message ? e.message : s.ai.fileUploadError);
		}
	}, [
		l,
		d,
		u,
		s.ai.tooManyFilesError,
		s.ai.fileUploadError,
		h
	]);
	return {
		attachedFiles: t,
...
var wo = /[\\`*_{}[\]()#+\-.!|~>]/g, To = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((e, t) => t % 2 == 1 ? e : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(wo, "\\$&")).join(""), Eo = ({ onSubmit: e, onStop: t, inProgress: n, onBeforeSubmit: i, placeholders: a, creditWarning: o, clarifyingUI: l, pendingContext: u = null, onPendingContextChange: d, pendingQuote: f = null, onPendingQuoteChange: m, fileAttachments: _, toolbarStart: y, onTranscribe: b, searchPersons: x, onProcessFilesRef: S, disclaimer: C, footer: w, isWelcomeScreen: T = !1, fullscreen: E = !1, welcomeScreenSuggestions: D, onSuggestionClick: O, welcomeScreenSuggestionsPlacement: ee = "above", welcomeScreenSuggestionsCollapsedByDefault: k = !1, welcomeScreenCards: A, padding: j = "default", ref: M }) => {
	let N = c(), P = s(), [F, I] = Y(""), [te, L] = Y(0), [ne, re] = Y(!1), [R, ie] = Y(!1), [ae, oe] = Y(null), [se, ce] = Y(!1), le = J(null), z = J(null), ue = J(null), de = J(null);
	K(() => () => {
		de.current && clearTimeout(de.current);
	}, []);
	let B = l != null, { tracking: fe, setFocusChatInputFunction: pe } = Yn(), me = G((e, t) => {
		fe?.onWelcomeSuggestionClick?.({
			item: e,
			group: t,
			prompt: e.prompt || e.title
		}), O?.(e, t);
	}, [fe, O]), { attachedFiles: he, fileInputRef: ge, onUploadFiles: _e, acceptValue: ve, isAtMaxFiles: ye, maxFiles: be, processFiles: xe, handleFileSelect: Se, handleRemoveFile: Ce, clearFiles: Te, transientError: Ee, showTransientError: De } = vo(_), V = Co({
		inputValue: F,
		setInputValue: I,
		cursorPosition: te,
		searchPersons: x,
		...
		let t = Oe.current, n = `${t}${t && !/\s$/.test(t) ? " " : ""}${e}`;
		I(n), L(n.length);
	}, []), Ae = {
		...
		onPartial: ke,
		onFinal: (e) => {
			ke(e), z.current?.focus();
		},
		onError: (e) => De(Ae[e])
	}), je = !!b && H.isSupported, Me = G(() => {
		fe?.onDictationStart?.(), Oe.current = F, H.start();
	}, [
		F,
		H,
		fe
	]), Ne = G(() => {
		fe?.onDictationCancel?.(), H.cancel();
	}, [H, fe]);
	K(() => {
		k || typeof window < "u" && window.location.hash.length === 0 && z.current?.focus();
	}, []), K(() => {
		if (B) {
			pe(null);
			return;
	...
	let Pe = H.status === "recording", Fe = Pe ? N.ai.listening : N.ai.inputPlaceholder, Ie = he.filter((e) => e.status === "uploaded"), Le = he.some((e) => e.status === "uploading"), Re = he.some((e) => e.status === "error"), ze = F.trim().length > 0 || Ie.length > 0;
	K(() => {
		if (!(!R || Le)) {
			if (ie(!1), Re) {
				De(N.ai.fileUploadBlockedSubmit);
				return;
			}
	...
	let Be = async (r) => {
		if (r.preventDefault(), !B) {
			if (V.close(), n) t?.();
				...
				let t = To(V.transformMentions(F.trim())), n = Ie.flatMap((e) => e.uploadedFile ? [e.uploadedFile] : []), r = u, a = f;
				r && d?.(null), a && m?.(null), await e({
					text: t,
					files: n,
					context: r,
					quote: a
		...
		B || V.handleKeyDown(e) || e.key === "Enter" && !e.shiftKey && (e.preventDefault(), n || le.current?.requestSubmit());
	}, He = () => {
		L(z.current?.selectionStart ?? 0);
	}, Ue = () => {
		ue.current && z.current && (ue.current.scrollTop = z.current.scrollTop);
	}, We = ae ? ae.prompt ?? ae.title : null, Ge = Pe ? [N.ai.listening] : We ? [We] : a ?? [], Ke = Ge.length > 1, qe = q(() => mo(F, V.mentions, {
		cursorPosition: te,
		...
		te,
		V.inlineCompletion
	]), Je = V.mentions.length > 0 || V.inlineCompletion !== null, Ye = ee === "inside", Xe = T && D && D.length > 0 && O ? /* @__PURE__ */ X(uo, {
		suggestions: D,
		onItemClick: me,
		onItemHover: oe,
		side: Ye ? "bottom" : "top",
		reserveTwoRows: !Ye,
		overflow: Ye ? "scroll" : "wrap"
	}) : null, Ze = !k || se || ze || H.status !== "idle", Qe = (e) => e instanceof Node ? le.current?.contains(e) ? !0 : e instanceof Element && e.closest("[data-radix-popper-content-wrapper]") !== null : !1, $e = () => {
		de.current && clearTimeout(de.current), de.current = setTimeout(() => {
			Qe(document.activeElement) || ce(!1);
		}, 0);
	}, et = Ye, tt = et && k, nt = tt && !Ze, rt = et && Xe ? /* @__PURE__ */ X("div", {
		onClick: (e) => e.stopPropagation(),
		children: Xe
	}) : void 0, it = {
		duration: P ? 0 : .32,
		...
		isPreSending: ne || R,
		canRecord: je,
		recordingStatus: H.status,
		recordingStream: H.stream,
		onStartRecording: Me,
		onStopRecording: H.stop,
		onCancelRecording: Ne
	}), ot = T && E && !!A && A.length > 0, st = E && T, { motionProps: ct } = Zn(T, 160, .5);
	return /* @__PURE__ */ Z(g.div, {
		ref: M,
		className: v("flex flex-col items-center gap-2", j === "default" && "px-4 pb-3 pt-2", st && "min-h-0 flex-1 justify-start -mt-20"),
		...E ? ct : {},
		children: [
			/* @__PURE__ */ Z("div", {
				className: "flex w-full max-w-content flex-col gap-2",
				children: [Xe && !Ye && /* @__PURE__ */ X("div", { children: k ? /* @__PURE__ */ X(h, {
					initial: !1,
					children: Ze && /* @__PURE__ */ X(g.div, {
								...
								children: [
									...
									/* @__PURE__ */ X(h, {
										...
										children: Ee && /* @__PURE__ */ X(g.div, {
											...
											children: /* @__PURE__ */ Z("div", {
												className: v("flex w-full flex-row items-center gap-2 rounded-md p-2 pr-3", "bg-f1-background-critical text-f1-foreground"),
												children: [/* @__PURE__ */ X("div", {
									...
									/* @__PURE__ */ Z("div", {
										className: v(et && "flex items-end", nt && "pr-3"),
										children: [
											et && /* @__PURE__ */ X("div", {
											...
											/* @__PURE__ */ X(to, {
												...
												onCursorUpdate: He,
												onScroll: Ue,
												highlightSegments: qe,
												hasOverlay: Je,
												multiplePlaceholders: Ke,
												placeholders: Ge,
			...
			ot && /* @__PURE__ */ X("div", {
				...
				children: /* @__PURE__ */ X(no, { cards: A })
			}),
			w && T && E && /* @__PURE__ */ X("div", {
			...
			/* @__PURE__ */ X(h, {
				...
				children: B ? /* @__PURE__ */ Z(g.div, {
				...
				}, "clarifying-nav-hint") : C?.text && !st && /* @__PURE__ */ Z(g.div, {
					...
					children: [C.onClick ? /* @__PURE__ */ X("button", {
						type: "button",
						onClick: C.onClick,
						className: v("group min-w-0 cursor-pointer bg-transparent p-0 text-inherit", "transition-transform duration-700 ease-out", "hover:scale-[1.02] focus-visible:scale-[1.02]", "motion-reduce:transition-none motion-reduce:hover:scale-100 motion-reduce:focus-visible:scale-100"),
						children: /* @__PURE__ */ X(r, {
							className: v("text-sm font-medium text-f1-foreground-tertiary transition-colors duration-700 ease-out", "group-hover:bg-gradient-to-r group-hover:from-[#E55619] group-hover:to-[#A1ADE5] group-hover:bg-clip-text group-hover:text-transparent", "group-focus-visible:bg-gradient-to-r group-focus-visible:from-[#E55619] group-focus-visible:to-[#A1ADE5] group-focus-visible:bg-clip-text group-focus-visible:text-transparent"),
							children: C.text
						})
					}) : /* @__PURE__ */ X(r, {
						className: "text-sm font-medium text-f1-foreground-tertiary",
						children: C.text
					}), C.link && C.linkText && /* @__PURE__ */ X(p, {
						href: C.link,
						target: "_blank",
...
function Do({ avatar: e, title: t, description: n, isActive: i = !1, action: a, children: o }) {
	let s = c(), l = a.type === "open", u = l ? i ? a.onClose : a.onOpen : void 0;
	return /* @__PURE__ */ Z("div", {
		className: v("flex flex-col items-center justify-between gap-3 rounded-lg border border-solid px-3 py-2", l && "cursor-pointer", i ? "border-f1-border-hover" : "border-f1-border-secondary"),
		onClick: u,
		children: [/* @__PURE__ */ Z("div", {
			className: "flex w-full min-w-0 flex-row items-center gap-3",
			children: [
				e?.type === "module" && /* @__PURE__ */ X(ln, {
					module: e.module,
					size: "md"
				}),
				e?.type === "file" && /* @__PURE__ */ X(fn, {
					file: e.file,
					size: "lg"
				}),
				e?.type === "icon" && /* @__PURE__ */ X(dn, {
					icon: e.icon,
					size: "md"
				}),
				/* @__PURE__ */ Z("div", {
				...
				a.type === "open" && a.showButton !== !1 && /* @__PURE__ */ X(m, {
					variant: "outline",
					size: "md",
					label: i ? s.actions.close : s.ai.reportCard.openButton,
					onClick: i ? a.onClose : a.onOpen
				}),
				a.type === "custom" && /* @__PURE__ */ X(m, {
					variant: "outline",
					size: "md",
					icon: a.icon,
					label: a.label,
...
function No(e) {
	let { days: t, hours: n, minutes: r, seconds: i } = Te(e), a = [];
...
function Ro({ formName: e, formDescription: t, module: n, cardTitle: r, cardDescription: i, fieldDescriptions: a, formValues: o, valueFormatter: s }) {
	let { canvasContent: c, openCanvas: l, closeCanvas: u } = Yn(), d = Kn(e), f = s ?? d, p = J(() => {}), m = r ?? e, h = i ?? t ?? "", g = c?.type === "form" && c.formName === e, _ = () => l({
		type: "form",
		title: m,
		description: h,
		formName: e,
...
var Bo = ({ onClose: e, onSubmit: t, reactionType: n, message: r }) => {
	let [i, a] = Y(""), o = c(), { title: s, label: l, placeholder: u } = n === "like" ? o.ai.feedbackModal.positive : o.ai.feedbackModal.negative, d = G(() => {
		t(r, i);
	}, [
		i,
		r,
...
var Go = ({ content: e, targetMessage: t, onCopy: n }) => {
		...
		children: [
			...
			/* @__PURE__ */ X(f, {
				onClick: (e) => {
					...
					n && i(n, t), s(n), e.currentTarget.blur();
				},
				compact: !0,
				mode: "only",
				variant: "ghost",
...
}, Ko = ({ icon: e, title: t, children: n, open: r, defaultOpen: i = !1, onOpenChange: o, lockOpen: c = !1 }) => {
	let [l, u] = Y(i), d = s(), f = r !== void 0, p = f ? r : l;
	return /* @__PURE__ */ Z(Ee, {
		...
		children: [/* @__PURE__ */ Z(H, {
			disabled: c,
			className: v("gap-1", c ? "flex w-full items-center text-base text-f1-foreground-secondary" : "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90"),
			children: [
				/* @__PURE__ */ X("span", {
				...
				!c && /* @__PURE__ */ X(a, { icon: Zt })
			]
		}), /* @__PURE__ */ X(xe, {
			forceMount: !0,
			className: "data-[state=open]:mt-3",
			children: /* @__PURE__ */ X(g.div, {
				initial: !1,
				animate: {
					height: p ? "auto" : 0,
					opacity: +!!p,
	...
	let i = c(), [a, o] = Y(!!n), s = J(n);
	K(() => {
		s.current && !n ? o(!1) : n && !a && o(!0), s.current = n;
	}, [n, a]);
...
var Xo = (e) => /* @__PURE__ */ X(Xn, {
	...
	let o = e.rawData, s = Yo(e?.content, o), c = (Jo(e?.content) ?? "").trim(), l = e?.replyQuote ?? null, u = c.length > 0, { anchor: d, clear: f } = Jn({
		containerRef: a,
		enabled: u
	});
	return /* @__PURE__ */ Z("div", {
		...
		children: [
			...
			s.length > 0 && /* @__PURE__ */ X("div", {
				...
				children: s.map((e, t) => /* @__PURE__ */ X(Se, {
					file: {
						name: e.filename,
						type: e.mimetype
					},
	...
	let [o, c] = Y(0), [l, u] = Y(0), [f, p] = Y("starting"), m = s(), h = e[o] ?? "", g = e.join("\0"), _ = J(!0);
	K(() => {
		if (_.current) {
			_.current = !1;
			return;
		...
		if (m) return;
		let t;
		if (f === "starting") t = setTimeout(() => p("writing"), ts);
		else if (f === "writing") l < h.length ? t = setTimeout(() => u((e) => e + 1), $o) : p("holding");
		else if (f === "holding") {
			if (e.length <= 1) return;
			t = setTimeout(() => p("erasing"), ns);
		} else f === "erasing" && (t = l > 0 ? setTimeout(() => u((e) => e - 1), es) : setTimeout(() => {
			c((t) => (t + 1) % e.length), p("starting");
		}, rs));
		return () => {
			t && clearTimeout(t);
		};
	...
	return /* @__PURE__ */ X("div", {
		className: v("flex w-full flex-1 justify-center px-4", a ? "items-end pb-24" : "items-center"),
		children: /* @__PURE__ */ Z("div", {
			...
			children: [
				...
				/* @__PURE__ */ Z("p", {
					...
					onClick: i,
					onKeyDown: b,
					className: v("min-h-[28px] bg-gradient-to-r from-[#E55619] via-[#E51943] to-[#A1ADE5] bg-clip-text text-center text-2xl font-semibold leading-[28px] text-transparent", y && v("cursor-pointer transition-transform duration-200", "hover:scale-[1.02] focus-visible:scale-[1.02]", "motion-reduce:transition-none motion-reduce:hover:scale-100 motion-reduce:focus-visible:scale-100")),
					"aria-label": y ? h : void 0,
					children: [/* @__PURE__ */ X("span", {
						"aria-hidden": "true",
...
var os = {
	...
	onThumbsUp: () => {},
	onThumbsDown: () => {}
}, ss = (e) => /* @__PURE__ */ X(Ho, { children: /* @__PURE__ */ X(cs, { ...e }) }), cs = ({ turns: e, isLoadingThread: t = !1, interrupt: n, initialMessage: r, initialMessageCaption: i, initialMessageSubtitle: a, initialMessageCta: o, onWelcomeClick: s, renderToolCall: l, onReplyQuote: u, onAssistantMessageRendered: f, autoScrollUserIntoView: p = !0, renderMarkdown: m, feedback: _, freezeLayout: y = !1, noShadows: b = !1, fullscreen: x = !1, children: S, AssistantMessage: C, UserMessage: w, onRegenerate: T, onCopy: E }) => {
	let { modal: D, handleSubmit: O, handleClose: ee } = Wo(_ ?? os), k = c(), A = C ?? Gn, j = w ?? Qo, M = q(() => {
		let e = r ?? k.ai.defaultInitialMessage;
		return (Array.isArray(e) ? e : [e]).filter((e) => typeof e == "string" && e.length > 0);
	}, [r, k.ai.defaultInitialMessage]), N = !t && e.length === 0 && M.length > 0, P = J(null), F = J(null), I = J(null), te = J(null), L = J(null), { showScrollBtn: ne, turnMinHeight: re, scrollToBottom: R } = as({
		viewportRef: P,
		contentRef: F,
		endRef: I,
		lastTurnRef: L,
		turnsCount: e.length,
		freezeTurnMinHeight: y
	}), ie = (t, n) => {
		let r = n === e.length - 1, i = {
			renderToolCall: l,
			onReplyQuote: u,
			onRendered: f,
			autoScrollIntoView: p,
			renderMarkdown: m
		}, a = (e, r) => {
			let a = {
				message: e,
		...
		return /* @__PURE__ */ Z("div", {
			ref: r ? L : void 0,
			className: v("flex flex-col items-start justify-start gap-2 px-1", r && "pb-5"),
			style: { minHeight: r && re || void 0 },
			children: [
				t.userMessages.map((e, t) => a(e, t)),
				t.thinking && t.thinking.titles.length > 0 && /* @__PURE__ */ X(qo, {
					titles: t.thinking.titles,
					title: k.ai.thoughtsGroupTitle,
					inProgress: t.thinking.inProgress,
					isWriting: t.thinking.isWriting
				}),
				t.assistantMessages.map((e, t) => o(e, t)),
				t.endIndicator === "thinking" && /* @__PURE__ */ X(ke, {
					title: k.ai.thinking,
					status: "executing"
				}),
				t.endIndicator === "activity" && /* @__PURE__ */ X(ke, { status: "writing" }),
	...
	return /* @__PURE__ */ Z(br, { children: [/* @__PURE__ */ Z("div", {
		...
		children: [/* @__PURE__ */ X("div", {
			ref: P,
			className: v("flex-1 overflow-y-scroll", "[scrollbar-width:thin] [scrollbar-color:transparent_transparent]", "hover:[scrollbar-color:var(--scrollbar-thumb)_transparent]", "[&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent", "[&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-transparent", "hover:[&::-webkit-scrollbar-thumb]:bg-f1-background-inverse/30"),
			children: /* @__PURE__ */ Z("div", {
				ref: F,
				className: v("flex h-full flex-col items-center p-4"),
				children: [
					/* @__PURE__ */ Z("div", {
						className: v(N ? "flex flex-1" : "flex flex-col gap-6", "w-full max-w-content"),
						children: [
							t && /* @__PURE__ */ X(ls, {}),
							N && /* @__PURE__ */ X(is, {
								messages: M,
					...
					/* @__PURE__ */ X(h, { children: ne && /* @__PURE__ */ X(g.div, {
		...
		}), !b && !N && /* @__PURE__ */ Z(br, { children: [/* @__PURE__ */ X(Wt, { position: "top" }, "shadow-top"), /* @__PURE__ */ X(Wt, { position: "bottom" }, "shadow-bottom")] })]
	}), D.isOpen && /* @__PURE__ */ X(Bo, {
		onSubmit: O,
		onClose: ee,
	...
	children: /* @__PURE__ */ Z("div", {
		...
		children: [
			/* @__PURE__ */ X("div", {
				...
				children: /* @__PURE__ */ X(u, { className: "h-12 w-2/5 rounded-full" })
			}),
			/* @__PURE__ */ X(u, { className: "mt-6 h-5 w-full rounded-md" }),
			/* @__PURE__ */ X(u, { className: "h-5 w-2/5 rounded-md" }),
			/* @__PURE__ */ X(u, { className: "h-5 w-4/5 rounded-md" })
		]
	})
});
//#endregion
...
var fs = ({ canProceed: e, submitDisabled: t, label: n, onConfirm: r, onSkip: i, showSkip: a }) => {
	...
	className: v("flex h-5 w-5 shrink-0 items-center justify-center rounded-full transition-colors", e ? "bg-f1-background-selected-bold" : "border-2 border-solid border-f1-border bg-f1-background"),
	children: e && /* @__PURE__ */ X("div", { className: "h-2 w-2 rounded-full bg-f1-background" })
}), ms = 132, hs = ({ mode: e, hasSelection: t, hasCustomText: n, customAnswerText: r, isCustomAnswerActive: i, canProceed: a, inputRef: o, onActivate: s, onChangeText: l, onToggleActive: u, onConfirm: d }) => {
	let f = c().ai.clarifyingQuestion.typeYourAnswer, p = J(null), m = Pe(p, o);
	vr(() => {
		let e = p.current;
		if (!e) return;
		e.style.height = "auto";
	...
	let h = e === "single" ? /* @__PURE__ */ X(ps, { isSelected: n && !t }) : /* @__PURE__ */ X(vn, {
		checked: i,
		onCheckedChange: () => u(!i),
		title: f,
		hideLabel: !0
	...
	return /* @__PURE__ */ Z("div", {
		className: v("flex items-start gap-2 rounded-md px-2 py-2", "transition-colors hover:bg-f1-background-hover"),
		children: [h, /* @__PURE__ */ X("textarea", {
			ref: m,
			rows: 1,
			value: r ?? "",
	...
	"aria-checked": t,
	tabIndex: r ? 0 : -1,
	className: v("flex cursor-pointer items-center gap-2 rounded-md px-2 py-2 transition-colors hover:bg-f1-background-secondary", _()),
	onClick: () => i(e.id),
	onKeyDown: (t) => {
	...
	ref: o,
	className: v("flex cursor-pointer items-center rounded-md pl-2 transition-colors hover:bg-f1-background-secondary"),
...
var _s = ({ mode: e, question: t, options: n, selectedOptionIds: r, allowCustomAnswer: i, hasSelection: a, hasCustomText: o, customAnswerText: c, isCustomAnswerActive: l, canProceed: u, customInputRef: d, autoFocus: f, onToggleOption: p, onActivateCustom: m, onChangeCustomText: h, onToggleCustomActive: _, onConfirm: v }) => {
	let y = s(), b = (() => {
	...
	return /* @__PURE__ */ Z("div", {
		...
		"aria-label": t,
		children: [n.map((t, n) => /* @__PURE__ */ X(g.div, {
			initial: !y && {
				opacity: 0,
				y: 4
			},
...
}, vs = ({ question: e, stepLabel: t, isFirstStep: n, isFinalStep: i, canProceed: a, onBack: o, onNext: s, onCancel: l }) => {
	let u = c();
	return /* @__PURE__ */ Z("div", {
	...
	let n = c(), r = s(), { currentStep: i, currentStepIndex: a, totalSteps: o, toggleOption: l, confirm: u, skip: d, cancel: f, back: p, setCustomAnswerText: m, setCustomAnswerActive: _, activateCustomAnswer: v } = e, { question: y, options: b, selectedOptionIds: x, selectionMode: S, optional: C, allowCustomAnswer: w, customAnswerText: T, isCustomAnswerActive: E } = i, D = J(null), O = S ?? "single", ee = o > 1, k = a === 0, A = a === o - 1, j = ee ? n.t("ai.clarifyingQuestion.stepOf", {
		current: String(a + 1),
		total: String(o)
		...
		let t = O === "single" && x.includes(e);
		l(e), O === "single" && !A && !t && Promise.resolve().then(u);
	}, ne = A ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, re = C === !0 && !M && !(E && N), R = () => {
		v(), requestAnimationFrame(() => {
			D.current?.focus();
		});
	}, ie = (e) => {
		e.key === "Escape" && (e.preventDefault(), f());
	}, ae = r ? 0 : bs / 2;
	return /* @__PURE__ */ Z("div", {
		className: "flex flex-col",
		onKeyDown: ie,
...
function ic({ fs: e, vs: t = Ps, textures: n = [], uniforms: r, clearColor: i = [
		...
		if (e) {
			if (n && n.length > 0) {
				...
				let t = n.map((t, n) => (E.current[`${Vs}${n}`] = {
					type: "sampler2D",
					isNeeded: !1
				}, O(t, n), C.current[n] = new ec(e), C.current[n]?.load(t).then((e) => {
					O(e, n);
				})));
				Promise.all(t).then(() => {
					u && u();
	...
	return K(() => {
		...
		function r() {
			ee();
			let n = m.current;
			n && p.current && (n.clearColor(...i), n.clearDepth(1), n.enable(n.DEPTH_TEST), n.depthFunc(n.LEQUAL), n.viewport(0, 0, p.current.width, p.current.height), p.current.height = p.current.clientHeight, p.current.width = p.current.clientWidth, te(), L(), I(ne(e || Ns), t || Ps), k(), requestAnimationFrame(R), ie(), P());
		}
		return requestAnimationFrame(r), () => {
			...
			ae(), cancelAnimationFrame(v.current ?? 0);
		};
	}, []), /* @__PURE__ */ X("canvas", {
		ref: p,
		style: {
...
function _c({ size: e = "lg", state: t, color: n, colorShift: r = .05, audioTrack: i, themeMode: a, className: o, ref: s, ...c }) {
	let { speed: l, scale: u, amplitude: d, frequency: f, brightness: p } = pc(t, i);
	return /* @__PURE__ */ X(gc, {
		...
		frequency: f,
		brightness: p,
		className: v(mc({ size: e }), "overflow-hidden rounded-full", o),
		...c
	});
}
//#endregion
//#region src/kits/ai/F0HILActionConfirmation/F0HILActionConfirmation.tsx
var vc = ({ text: e, description: t, avatar: n, confirmationText: r, onConfirm: i, cancelText: a, onCancel: o, stackAt: s = "sm" }) => /* @__PURE__ */ X(Gt, {
	title: e,
	description: t,
	avatar: n,
	stackAt: s,
	...
	return /* @__PURE__ */ Z(br, { children: [e && /* @__PURE__ */ X("span", {
		className: v(xc(), "truncate"),
		children: e
	}), /* @__PURE__ */ X(h, { children: n && t && /* @__PURE__ */ X(g.div, {
...
var kc = ({ cx: e, cy: t, index: n, dataLength: r, color: i }) => n !== r - 1 || e == null || t == null ? null : /* @__PURE__ */ X("circle", {
	...
	return /* @__PURE__ */ X("span", {
		className: v("absolute right-0 inline-flex items-center rounded-full border border-solid bg-f1-background px-1.5 py-px text-xs font-medium shadow", t === "negative" ? "bottom-0 translate-y-full" : "top-0 -translate-y-full", n.border, {
	...
	let { description: n, heading: r, label: i, selected: a = !1, onClick: o, onAskOne: c, className: l, ...u } = e, [d, f] = Y(!1), [p, m] = Y(!1), h = d || p, y = s(), b = h && !!c, x = {
		duration: y ? 0 : .2,
		ease: [
			.33,
			1,
	...
	return /* @__PURE__ */ Z("div", {
		...
		children: [a && /* @__PURE__ */ Z(br, { children: [/* @__PURE__ */ X("div", {
			...
			className: v("absolute -inset-px rounded-2xl", "[--gradient-angle:0deg]", "bg-[conic-gradient(from_var(--gradient-angle),hsla(229,57%,76%,0.7),hsla(348,80%,50%,0.7),hsla(348,80%,50%,0.7),hsla(18,80%,50%,0.7),hsla(229,57%,76%,0.7),hsla(229,57%,76%,0.7))]", "animate-rotate-gradient")
		}), /* @__PURE__ */ X("div", {
			"aria-hidden": !0,
			className: v("pointer-events-none absolute -inset-px rounded-2xl", "[--gradient-angle:0deg]", "bg-[conic-gradient(from_var(--gradient-angle),hsla(229,57%,76%,0.7),hsla(348,80%,50%,0.7),hsla(348,80%,50%,0.7),hsla(18,80%,50%,0.7),hsla(229,57%,76%,0.7),hsla(229,57%,76%,0.7))]", "animate-rotate-gradient opacity-80 blur-sm")
		})] }), /* @__PURE__ */ Z("div", {
			ref: t,
			role: o ? "button" : void 0,
			tabIndex: o ? 0 : void 0,
			className: v(yc({ selected: a }), a && "relative border-transparent", o && "cursor-pointer select-none", o && _(), l),
			onClick: o ? () => {
				o?.();
			} : void 0,
			onKeyDown: o ? (e) => {
				e.currentTarget === e.target && (e.key === "Enter" || e.key === " ") && (e.preventDefault(), o?.());
			} : void 0,
			onMouseEnter: () => f(!0),
			onMouseLeave: () => f(!1),
			onFocus: () => m(!0),
			...
			children: [/* @__PURE__ */ X(Cc, {
				...
				isRevealed: h,
				onAskOne: c
			}), u.content === "sparkline" ? /* @__PURE__ */ Z("div", {
				className: "flex flex-1 flex-col gap-2",
				children: [/* @__PURE__ */ X("span", {
					className: v(bc()),
					children: r
...
var Fc = n(ur(Pc, () => /* @__PURE__ */ Z("div", {
	...
	"aria-busy": "true",
	"aria-live": "polite",
	children: [/* @__PURE__ */ X(u, { className: "h-3 w-3/4 rounded" }), /* @__PURE__ */ Z("div", {
		className: "flex flex-1 flex-col justify-end gap-2",
		children: [/* @__PURE__ */ Z("div", {
			className: "flex flex-col gap-1.5",
			children: [/* @__PURE__ */ X(u, { className: "h-5 w-full rounded" }), /* @__PURE__ */ X(u, { className: "h-5 w-2/3 rounded" })]
		}), /* @__PURE__ */ Z("div", {
			className: "flex items-center gap-1.5",
			children: [/* @__PURE__ */ X(u, { className: "h-5 w-5 rounded-full" }), /* @__PURE__ */ X(u, { className: "h-3 w-20 rounded" })]
		})]
	})]
}))), Ic = [
	"text",
...
function Hc(e) {
	let { module: t, heading: n, title: r, subtitle: i, description: a, seeMoreLabel: o, maxCollapsedDescriptionLength: s = Lc } = e, [c, l] = Y(!1), u = gr(), d = J(null), f = Rc(s), p = a.length > f, h = c ? a : zc(a, f), g = Bc(e) ? e : null, y = Vc(e);
	return K(() => {
		c && d.current?.focus();
		...
		children: [
			...
			/* @__PURE__ */ Z("div", {
				...
				children: [/* @__PURE__ */ X("h3", {
					...
					ref: d,
					tabIndex: c ? -1 : void 0,
					className: v("text-base text-f1-foreground whitespace-pre-wrap break-words", c && _(), !c && "inline"),
					children: [h, p && !c && /* @__PURE__ */ Z(br, { children: [" ", /* @__PURE__ */ X("button", {
						type: "button",
						className: v("inline cursor-pointer rounded-none border-0 bg-transparent p-0 text-base text-f1-foreground underline underline-offset-2 hover:text-f1-foreground-secondary", _()),
						"aria-controls": u,
						"aria-expanded": c,
						onClick: () => l(!0),
						children: o
			...
			g && /* @__PURE__ */ X("div", {
				...
				children: /* @__PURE__ */ X(m, {
					type: "button",
					label: g.primaryActionLabel,
					icon: g.primaryActionIcon,
					onClick: g.onPrimaryAction
				})
			})
		]
	});
...
}, Wc = (e) => Ha[e] ?? wn, Gc = ({ iconName: e }) => e ? /* @__PURE__ */ X("div", {
...
function Jc({ dataset: e, title: t, filename: n }) {
	let i = c(), a = J(null), o = t ?? i.ai.aiTable.title, s = G((e) => {
		if (!a.current) return;
		let t = n ?? (o.replace(/\s+/g, "_").toLowerCase() || "table");
		qc(a.current, e, t);
	}, [o, n]);
	return e.columns?.length ? /* @__PURE__ */ Z(dr, {
		display: "flex",
		...
		children: [/* @__PURE__ */ Z(dr, {
			...
			children: /* @__PURE__ */ Z("table", {
				ref: a,
				className: v("w-full border-separate border-spacing-0 text-md", "[&_tbody_tr:last-child_td]:border-b-0"),
...
function Yc({ credits: e, trigger: t }) {
	let n = c(), [i, a] = Y(!1), [o, s] = Y(!1), [l, u] = Y(!1), [f, p] = Y(null), h = G((t) => {
		a(t), t && e?.fetchUsage && (s(!0), u(!1), e.fetchUsage().then((e) => {
			p(e), u(!1);
		}).catch(() => {
			u(!0);
		}).finally(() => {
	...
	if (!e) return null;
	let _ = f ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, v = e.companyName;
	return /* @__PURE__ */ Z(Pn, {
		open: i,
		onOpenChange: h,
		children: [/* @__PURE__ */ X(jn, {
			asChild: !0,
			children: t ?? /* @__PURE__ */ X(d, {
				variant: "ghost",
				hideLabel: !0,
			...
			children: [v && /* @__PURE__ */ Z("div", {
				...
				children: [/* @__PURE__ */ Z("div", {
					...
					children: [/* @__PURE__ */ X("span", { children: n.t("ai.credits.needMoreCredits") }), /* @__PURE__ */ X(m, {
...
function Zc({ employeeCredits: e, trigger: t }) {
	let n = c(), i = s(), [a, o] = Y(!1), [l, u] = Y(!1), [f, p] = Y(!1), [m, h] = Y(null), _ = G((t) => {
		o(t), t && e?.fetchUsage && (u(!0), p(!1), e.fetchUsage().then((e) => {
			h(e), p(!1);
		}).catch(() => {
			p(!0);
		}).finally(() => {
	...
	if (!e) return null;
	let v = !!e.companyName, y = m && m.total > 0 ? Math.min(100, Math.round(m.used / m.total * 100)) : 0, b = m ? Math.max(0, m.total - m.used) : 0;
	return /* @__PURE__ */ Z(Pn, {
		open: a,
		onOpenChange: _,
		children: [/* @__PURE__ */ X(jn, {
							...
							children: [
								/* @__PURE__ */ Z("div", {
									...
									children: [/* @__PURE__ */ X("span", {
										...
										className: "font-medium text-f1-foreground-secondary",
										children: n.t("ai.credits.creditsLeft", { total: b.toLocaleString() })
									})]
								}),
								/* @__PURE__ */ X("div", {
									className: "flex items-center gap-2",
...
var Qc = ({ credits: e, employeeCredits: t, trigger: n }) => t ? /* @__PURE__ */ X(Zc, {
	...
	credits: e,
	trigger: n
}) : null, $c = Qc, el = ({ historyEnabled: e = !1, title: t, currentThreadTitle: n, fullscreen: i = !1, lockVisualizationMode: l = !1, onToggleVisualizationMode: u, onClose: p, onNewChat: m, onOpenHistory: h, hasMessages: _ = !1, credits: y, employeeCredits: b, compact: x = !1, actions: S }) => {
	let C = c(), w = s(), T = o(`(max-width: ${un.md}px)`, { initializeWithValue: !0 }), E = !l && !T && /* @__PURE__ */ X(d, {
		variant: "ghost",
		hideLabel: !0,
		label: i ? C.ai.collapseChat : C.ai.expandChat,
		icon: i ? $n : Vn,
		onClick: u
	}), D = /* @__PURE__ */ X(d, {
		variant: "ghost",
	...
	return x ? /* @__PURE__ */ Z("header", {
		className: v("flex items-center justify-between gap-3 pr-4 pl-5 py-3"),
		children: [/* @__PURE__ */ X(r, {
			lines: 1,
			className: "min-w-0 flex-1 text-left font-semibold text-f1-foreground",
			children: n ?? C.ai.newConversation
		}), /* @__PURE__ */ Z(g.div, {
		...
		className: v("flex justify-between pl-2.5 pr-3 py-3 w-full overflow-hidden gap-3"),
		children: [/* @__PURE__ */ X("div", {
			className: "flex min-w-0 flex-1 items-center",
			children: !l && /* @__PURE__ */ X(f, {
				variant: "ghost",
				size: "md",
		...
		className: v("flex justify-between px-4 py-3"),
		children: [/* @__PURE__ */ X("div", {
			className: "flex items-center",
			children: /* @__PURE__ */ X("h2", {
...
function tl(e) {
	...
	return Dn(t) ? "today" : Sn(t) ? "yesterday" : nt(t, n) ? "thisMonth" : "older";
}
function nl(e, t, n) {
	let r = new Date(e), i = Qt(r, "p", { locale: n });
	if (Dn(r)) return `${t.today}, ${i}`;
	if (Sn(r)) return `${t.yesterday}, ${i}`;
	let a = !Re(r, /* @__PURE__ */ new Date());
	return `${Qt(r, a ? "MMM d yyyy" : "MMM d", { locale: n })}, ${i}`;
}
function rl(e) {
	let t = {
		today: [],
...
function il({ thread: e, isPinned: t, isActive: n = !1, isPending: i = !1, onSelect: o, onPin: s, onUnpin: l, onDelete: u, className: f }) {
	let p = c(), m = bn(), h = q(() => [{
		label: t ? p.ai.unpinChat : p.ai.pinChat,
		icon: t ? qt : Tt,
		onClick: () => t ? l(e.id) : s(e.id)
	}, {
		label: p.ai.deleteChat,
		icon: C,
		critical: !0,
		onClick: () => u(e.id)
	}], [
	...
	return /* @__PURE__ */ Z("div", {
		className: v("group flex gap-1 cursor-pointer items-center justify-between rounded-md py-1.5 pl-3 pr-1.5 hover:bg-f1-background-hover", _("rounded"), f, n && "bg-f1-background-secondary"),
		role: "button",
		tabIndex: 0,
		...
		children: [
			...
			i ? /* @__PURE__ */ X("div", {
				...
				"aria-label": p.ai.threadOptions,
				children: /* @__PURE__ */ X(tt, { size: "small" })
			}) : /* @__PURE__ */ X("div", {
				className: v("hidden items-center", "group-hover:flex group-focus-within:flex", "has-[[aria-expanded=true]]:flex"),
...
function al({ label: e, threads: t, pinnedIds: n, onSelect: r, onPin: i, onUnpin: o, onDelete: s }) {
	let [c, l] = Y(!0), u = G(() => {
		l((e) => !e);
	}, []), d = G((e) => {
	...
	return /* @__PURE__ */ Z("div", { children: [/* @__PURE__ */ Z("div", {
		...
		onClick: u,
		onKeyDown: d,
		className: v("flex cursor-pointer items-center p-3 gap-1 hover:bg-f1-background-hover", _("rounded")),
		children: [/* @__PURE__ */ X("span", {
...
var ol = [
	...
	children: /* @__PURE__ */ X(u, { className: v("h-4 rounded", e) })
}), cl = ({ titleWidth: e, rows: t }) => /* @__PURE__ */ Z("div", {
	className: "flex flex-col gap-0.5",
	children: [/* @__PURE__ */ X("div", {
		className: "flex items-center p-1.5",
		children: /* @__PURE__ */ X(u, { className: v("h-3 rounded", e) })
...
var ul = ({ onClose: e, onSelectThread: t, onNewChat: n, threads: i, isLoading: o, error: s, pinnedIds: l, onPinThread: u, onUnpinThread: d, onDeleteThread: p }) => {
	let m = c(), [h, g] = Y("");
	K(() => {
		let t = (t) => {
			t.key === "Escape" && e();
	...
	let _ = q(() => ({
		...
		if (!h.trim()) return i;
		let e = h.toLowerCase();
		return i.filter((t) => t.title.toLowerCase().includes(e));
	}, [i, h]), b = q(() => y.filter((e) => l.has(e.id)), [y, l]), x = q(() => y.filter((e) => !l.has(e.id)), [y, l]), S = q(() => rl(x), [x]), C = G((n, r) => {
		t(n, r), e();
	}, [t, e]), w = G(() => {
		n(), e();
	}, [n, e]), T = G((e) => {
		p(e);
	}, [p]), E = b.length > 0 || S.length > 0;
	return yr(/* @__PURE__ */ Z(br, { children: [/* @__PURE__ */ X("div", {
		...
		className: v("fixed inset-0 z-50 flex items-center justify-center", "pointer-events-none", "animate-in fade-in-0 zoom-in-95"),
		children: /* @__PURE__ */ Z("div", {
			className: v("pointer-events-auto relative flex w-full max-w-[600px] flex-col", "rounded-xl bg-f1-background shadow-lg", "max-h-[min(600px,80vh)]"),
			children: [/* @__PURE__ */ Z("div", {
				...
				children: [/* @__PURE__ */ X(a, {
					...
					className: v("w-full", "py-2.5 pr-3", "text-base text-f1-foreground-secondary placeholder:text-f1-foreground-tertiary focus:outline-none", "outline-none")
				})]
			}), /* @__PURE__ */ Z("div", {
...
var hl = g.create(Pt), gl = ({ label: e, reduceMotion: t }) => /* @__PURE__ */ Z("div", {
	role: "status",
	"aria-live": "polite",
	...
	let { t: i } = c(), a = s(), o = t ?? i("ai.applyingChanges");
	return K(() => {
		if (!e) return;
		let t = document.activeElement;
		t && t.getAttribute("name") !== "one-ai-input" && t.blur();
	}, [e]), /* @__PURE__ */ Z("div", {
		className: v("relative flex flex-1 flex-col", n),
		children: [/* @__PURE__ */ X(h, { children: e && /* @__PURE__ */ X(g.div, {
			...
			className: v("flex flex-1 flex-col", e && "pointer-events-none"),

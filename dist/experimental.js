import { a9 as oa, aa as ca, ab as da, ac as ua, ad as Ft, ae as Te, af as fa, O as g, W as Z, P as be, u as se, ag as ma, ah as ha, ai as ga, aj as ba, ak as pa, a5 as oe, al as xa, am as ht, an as rt, ao as Be, U as Ee, ap as va, aq as wa, ar as $, as as ya, at as Na, M as _e, au as ln, av as Ca, aw as ka, Q as B, ax as sn, a8 as E, ay as ve, az as Sa, aA as Ia, aB as Fa, aC as Aa, aD as La, aE as Ce, aF as on, aG as Ea, aH as pe, aI as $e, aJ as _a, aK as gt, n as cn, aL as Ne, aM as Oa, aN as dn, a6 as ne, aO as H, R as un, aP as fn, aQ as Ta, aR as mn, aS as me, a7 as ee, aT as za, aU as Da, aV as Pa, aW as Ra, X as ge, aX as Ge, aY as Ba, aZ as $a, a_ as Wa, a$ as Ma, b0 as He, b1 as hn, b2 as ja, b3 as Va, b4 as Ga, b5 as We, b6 as Ha, b7 as Ua, b8 as Ka, b9 as qa, ba as Ya, bb as Za, bc as Xa, bd as Ja, be as Qa, bf as er, bg as lt, bh as it, bi as gn, bj as tr, bk as nr, bl as bn, bm as ar, bn as rr, T as Ue, bo as bt, bp as pn, bq as lr, br as xn, bs as ir, bt as sr, bu as or, bv as Le, bw as cr, bx as ze, by as At, bz as st, bA as dr, bB as ur, a as fr, c as mr, bC as hr, bD as vn, bE as gr, bF as br, F as pr, bG as wn, _ as xr, bH as yn, bI as vr, bJ as Lt, bK as wr, bL as yr, bM as Nr, bN as Cr, bO as Nn, bP as kr, bQ as Sr, bR as Ir, bS as Fr, bT as Ar, Y as Cn, bU as ue, bV as kn, bW as pt, bX as xt, bY as vt, bZ as Sn, b_ as wt, b$ as In, $ as Fn, c0 as Lr, c1 as Er, c2 as _r, c3 as Or, c4 as Tr, c5 as zr, c6 as Dr, c7 as Pr, c8 as Rr, c9 as Br, ca as $r, cb as Et, cc as _t, cd as Ot, ce as Wr, cf as Mr, cg as jr, ch as Vr, ci as An, cj as Gr, ck as Hr, cl as Ur } from "./F0AiChat-CqAcgo3K.js";
import { cG as Ac, cF as Lc, co as Ec, cS as _c, cz as Oc, cA as Tc, cn as zc, cC as Dc, cp as Pc, d2 as Rc, d0 as Bc, cq as $c, cD as Wc, cE as Mc, cB as jc, cr as Vc, cO as Gc, cP as Hc, cT as Uc, c_ as Kc, c$ as qc, cx as Yc, d1 as Zc, cy as Xc, cs as Jc, cI as Qc, cH as ed, ct as td, cu as nd, cv as ad, cQ as rd, d3 as ld, cm as id, cR as sd, cV as od, cW as cd, cN as dd, cK as ud, cM as fd, cJ as md, cw as hd, cL as gd, cX as bd, cY as pd, cU as xd, cZ as vd } from "./F0AiChat-CqAcgo3K.js";
...
import { l as yd, m as Nd, j as Cd, n as kd, s as Sd, D as Id, k as Fd, o as Ad, v as Ld, w as Ed, N as _d, x as Od, p as Td, r as zd, R as Dd, q as Pd, _ as Rd, u as Bd, t as $d } from "./index-wIMye6ru.js";
const dl = oa("Search", [
        ...
        Z.svg,
        {
          ...
          children: [
            /* @__PURE__ */ o("defs", { children: [
              ...
              Dt.map((p) => /* @__PURE__ */ e("clipPath", { id: `${s}-${p.id}`, children: /* @__PURE__ */ e("path", { d: p.path }) }, p.id))
            ] }),
            /* @__PURE__ */ e("g", { clipPath: `url(#${s}-circle)`, children: Dt.map((p) => /* @__PURE__ */ e(
              Z.foreignObject,
              {
                x: "0",
                y: "0",
...
}, zn = j(pl), Dn = yt(null), xl = 15, vl = ({ children: t, enabled: n, onShow: a, ...r }) => {
...
const Pn = ({
  ...
  return a ? /* @__PURE__ */ e("div", { className: "flex items-center", children: /* @__PURE__ */ e(ma, { children: /* @__PURE__ */ o(ha, { delayDuration: 850, disableHoverableContent: !0, children: [
    /* @__PURE__ */ e(ga, { asChild: !0, children: /* @__PURE__ */ e(
      Z.div,
      {
        animate: {
          "--gradient-angle": ["0deg", "360deg"]
...
const Rt = Z.create($), Bt = {
  ...
  const [m, h] = _("idle"), [b, p] = _(null), [x, ...w] = b ?? [], [A, z] = _(!1);
  W(() => {
    p(null), h("idle");
  }, [t]);
  const R = Q(async () => {
          ...
          ka,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "scrollbar-macos flex-1 overflow-y-auto", children: [
                m === "idle" && b !== null && b.length === 0 && /* @__PURE__ */ e("div", { className: "p-2 pt-0", children: /* @__PURE__ */ e(Il, { ...l, buttonUrl: r }) }),
                m === "idle" && b !== null && b.length > 0 && /* @__PURE__ */ o("div", { className: "px-1", children: [
                  ...
                  b.length > 1 && /* @__PURE__ */ e(U, { children: /* @__PURE__ */ e("div", { className: "pb-1", children: w.map((O, L) => /* @__PURE__ */ e(
                    kl,
                    {
                      ...O,
                      onClick: d
...
function Do({
  ...
  const { sidebarState: u, toggleSidebar: m } = ke(), h = [
    ...
    ...a
  ], b = n && Object.keys(n).length !== 0, p = l && a.length > 0, x = !l && r.length > 0, w = !l && !!s?.isVisible, A = h[h.length - 1], z = "navigation" in window ? window.navigation : null, R = l && (z ? !!z.canGoBack : window.history.length > 1);
  return /* @__PURE__ */ o(
    "div",
    {
      className: g(
          ...
          /* @__PURE__ */ o(
            "div",
            {
              ...
              children: [
                ...
                R || p ? /* @__PURE__ */ e("div", { className: "text-lg font-semibold text-f1-foreground", children: "loading" in A ? /* @__PURE__ */ e(E, { className: "h-4 w-24" }) : A.label }) : /* @__PURE__ */ e(
                  gl,
                  {
                    breadcrumbs: h,
...
function jl({
  ...
  return /* @__PURE__ */ o(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ e($, { icon: za, size: "md", color: "selected" }),
        /* @__PURE__ */ e(
          me,
          {
            lines: 1,
...
function Vl({
  ...
  const { locale: l } = Da(), i = Pa(l), s = Ra(n, "PPPp", { locale: i }), c = `${t.firstName} ${t.lastName}`;
  return /* @__PURE__ */ o(
    "button",
    {
      type: "button",
...
const Hl = ({
  ...
  const m = t.name.split(" "), h = m[0] || "", b = m.slice(1).join(" "), p = (w) => {
...
const jt = ({
  ...
  ) : u && (b = /* @__PURE__ */ e(Ae, { primaryAction: x, secondaryActions: [] }), w && (p = /* @__PURE__ */ e(Ae, { primaryAction: w, secondaryActions: [] }))), /* @__PURE__ */ e("footer", { className: "rounded-bl-xl border-0 border-r-[1px] border-t-[1px] border-solid border-f1-border-secondary bg-f1-background/30 backdrop-blur-2xl", children: /* @__PURE__ */ o("div", { className: "flex flex-1 justify-between p-2", children: [
    b,
    p
  ] }) });
}, Kl = ({
  ...
  const I = re.useRef(null), M = K(
    ...
    return [J, Y];
  }, [n, D, t]), Ie = ae.length, aa = !T && (w || A), ra = L && L.length > 0, la = !y && (!T && aa || ra);
  return /* @__PURE__ */ o(
    "div",
    {
      className: g(
...
}, De = (t, n) => t.find((a) => a.id === n), Zl = (t, n) => t.find((a) => a.value === n)?.groupType === "team", Xl = ({
  entity: t,
  onRemove: n,
  disabled: a = !1,
  deactivated: r = !1,
  ...
  const b = (i ?? Ut) < Ql, p = !c && !s && !b, x = i ?? Ut, w = p ? x - Kt : x;
  return /* @__PURE__ */ o(
    "div",
    {
  ...
  return /* @__PURE__ */ e(
    qa,
    {
      ...
      append: A ?? /* @__PURE__ */ e(U, { children: /* @__PURE__ */ e(Ya, { open: R, disabled: r, size: z }) }),
      children: /* @__PURE__ */ e(
        "span",
        {
          role: "button",
  ...
  const [l, i] = _(t.entities), [s, c] = _(""), [d, f] = Za("", 300), u = K(
    ...
    [t.entities]
  ), m = Ke(Xa), b = m.portalContainer && (m.position === "center" || m.position === "fullscreen") ? m.portalContainer : void 0;
  function p(y) {
    if (t.singleSelector) {
      t.onSelect(y), a(!1);
      return;
    }
    const S = t.selectedEntities ?? [], N = l.find((D) => D.id === y.id);
    if (!N)
      return;
    const I = new Set(
    ...
    const v = [...S];
    function C(D) {
      const G = v.findIndex((ce) => ce.id === D.id);
      G >= 0 ? v[G] = D : v.push(D);
    }
    M.forEach((D) => {
      const G = l.find((P) => P.id === D);
      if (!G) return;
      const ce = G.subItems?.filter(
        (P) => I.has(P.subId)
      ) ?? [], ae = v.findIndex((P) => P.id === D);
      if (ae >= 0) {
  ...
  function A(y, S) {
    ...
    for (const v of N) {
      const C = v.subItems?.filter((D) => D.subId !== I) ?? [];
      C.length > 0 && M.push({
        ...v,
        subItems: C
      });
...
const gi = ({
  ...
  const [m, h] = _(s), b = V(null);
  W(() => {
    h(s);
  }, [s]);
  const p = (O) => {
    h(O), c?.(O);
  }, x = Ue(), { canvasRef: w, handleMouseEnter: A, handleMouseLeave: z } = hi(x), R = bt({
    emoji: ui[d],
    size: "sm"
  });
  return /* @__PURE__ */ o(
...
function pi({
  ...
  const [i, s] = _(a), [c, d] = _(n), f = V(null), { fireEmojiConfetti: u } = lr(), m = (p, x) => {
    p.stopPropagation(), d(c + (i ? -1 : 1)), s(!i), l?.(x), i || u(x, f);
  }, h = r?.map((p) => p.name).join(", ") || "", b = /* @__PURE__ */ e(
    xn,
    {
      ref: f,
      variant: "outline",
...
const vi = H("Reactions", xi), wi = ({
  ...
  const w = [f.views, f.comments].filter(Boolean).join(" · "), A = !0, z = On(r), R = () => {
    s(t);
  }, O = (k) => {
    k.stopPropagation();
...
function zi({
  ...
  const { sidebarState: i, toggleSidebar: s, isSmallScreen: c, setForceFloat: d } = ke(), f = Ue(), {
    ...
    chatWidth: b,
    resizable: p
  } = mr(), x = m === "fullscreen", w = m === "canvas", { open: A } = qe(), z = p ? b : gr, R = V(x), O = x && !R.current, L = !x && R.current, [
    k,
    X
  ] = _(!1);
  W(() => {
...
function qn({
  ...
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ e("div", { className: Di({ period: a }) }),
          ...
          children: [
            ...
            /* @__PURE__ */ e("div", { className: "flex w-5 shrink-0 items-center justify-center", children: /* @__PURE__ */ e("div", { className: "flex h-3 w-3 items-center justify-center rounded-2xs bg-f1-background-secondary transition-all", children: /* @__PURE__ */ e(
              Z.div,
              {
                ...
                children: /* @__PURE__ */ e($, { icon: gt, size: "xs" })
              }
            ) }) })
          ]
        }
  ...
  return W(() => {
    ...
    xn,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ e("div", { className: g("hidden", { flex: r }), children: /* @__PURE__ */ e($, { icon: Ce, size: "md" }) })
      ]
    }
  );
}
...
const Gi = ({
  ...
  const f = se(), { isDragging: u, setIsDragging: m, draggedItemId: h, setDraggedItemId: b } = St(), { isActive: p } = ht(), x = p(t.href, { exact: t.exactMatch }), w = V(!1), [A, z] = _(!1), R = l === 0, O = l === i - 1, L = i === 1, k = K(() => {
    const I = [];
    return !L && !R && I.push({
    ...
    m(!0), z(!1), b(t.href || null), w.current = !0;
  }, T = () => {
    ...
    Xn,
    {
      ...
      children: /* @__PURE__ */ e(
        "div",
        {
          ...
          children: t.items.map((p, x) => /* @__PURE__ */ e(Hi, { item: p }, x))
        }
      )
    }
  );
...
function Ki({
  ...
  const u = se(), { isDragging: m } = St(), h = t.some((v) => v.isRoot), b = t.filter((v) => !v.isRoot).length > 0, p = n.length > 0, x = V(null), [w, A] = _(s), z = s.length > 0;
  W(() => {
  ...
  const R = (v) => {
    ...
    (v) => {
      const C = w.filter((D) => D.href !== v.href);
      A(C), c?.(C);
    },
    [w, c]
  ), L = Q(
    (v, C) => {
      ...
      const D = [...w], [G] = D.splice(v, 1);
      D.splice(C, 0, G), A(D), c?.(D);
    },
    [w, c]
  ), [k, X] = _(!1), T = V(null);
  W(() => {
  ...
  const y = "flex flex-col gap-0.5", S = K(
    () => w.reduce(
      (v, C, D) => (C.label in v || (v[C.label] = []), v[C.label].push(D), v),
      {}
    ),
    [w]
  ), N = K(
  ...
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      children: [
        ...
        z && /* @__PURE__ */ e("div", { className: "mt-3 flex w-full flex-col gap-3 bg-transparent px-3", children: /* @__PURE__ */ e(Xn, { title: u.favorites.favorites, children: /* @__PURE__ */ e("div", { ref: x, children: f ? /* @__PURE__ */ e("div", { className: y, children: N }) : /* @__PURE__ */ e(
          Lt,
          {
            axis: "y",
            values: w,
...
const es = ({
  ...
  const m = (b) => !!b && !(re.isValidElement(b) && b.type === re.Fragment && re.Children.count(b.props.children) === 0), h = () => {
    n?.link?.onClick?.();
  };
  return /* @__PURE__ */ o(
    pt,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ o(wt, { className: "flex h-full flex-col gap-4", children: [
          l && /* @__PURE__ */ e("div", { className: "flex flex-row", children: l.map((b, p) => /* @__PURE__ */ o("div", { className: "grow", children: [
          ...
          re.Children.toArray(a).filter(m).map((b, p) => /* @__PURE__ */ o(re.Fragment, { children: [
            p > 0 && /* @__PURE__ */ e(Tr, { bare: !0 }),
            b
          ] }, p))
        ] }),
        r && /* @__PURE__ */ e(zr, { children: /* @__PURE__ */ e(B, { variant: "neutral", size: "sm", ...r }) })
      ]
    }
  );
}), fs = be({
...
const Xe = function({
  ...
  const { containerRef: c, measurementContainerRef: d, visibleItems: f } = Ds(n, l);
  return W(() => {
    s?.(f);
  }, [s, f]), /* @__PURE__ */ o(
    "div",
  ...
  function({ content: n, label: a, color: r, ...l }, i) {
    return /* @__PURE__ */ o("div", { className: "flex flex-col gap-1", ref: i, children: [
      ...
      /* @__PURE__ */ o("div", { className: "flex items-center gap-1", children: [
        ...
        "icon" in l && l.icon && /* @__PURE__ */ e("span", { className: g("flex", r), children: /* @__PURE__ */ e($, { icon: l.icon }) }),
...
function xc({
  ...
  const { status: O, statusText: L, subtitle: k, statusColor: X } = js({
    ...
    h?.(P), N(!1), u?.(P);
  }, v = T && i.length && !c && s, C = i.find((P) => P.id === l), D = i.map((P) => ({
    value: P.id,
    label: P.name,
    icon: P.icon
  })), G = O === "break", [ce, ae] = _(!1);
...
var po = ({ stones: t, containerSize: n }) => {
  ...
  return W(() => {
    var u, m;
    let h = xo(t.current), b = (m = (u = n.current) == null ? void 0 : u.offsetWidth) != null ? m : 0;
    if (b === null) return;
    let p = po({ stones: h, containerSize: b });
    f(Je(le({}, p), { stones: h }));
...
var So = () => {
  ...
  let d = V([]), f = V(null), u = So(), m = Io(f), { positions: h, containerHeight: b } = vo({ boxesRefs: d, wrapperRef: f, children: a, windowWidth: u, wrapperWidth: m }), p = le({ minHeight: b ?? 0, position: "relative" }, r);
  return e("div", Je(le({ ref: f, style: p }, c), { children: _n.map(a, (x, w) => {
    if (typeof x != "object" || !x || !("type" in x)) return x;
    let A = { style: Co({ style: x.props.style, position: h[w], transition: l, transitionDuration: i }), ref: (z) => d.current[w] = z };
...
export {
  ...
  Ld as NotesTextEditor,
  Ed as NotesTextEditorPatchTargetNotFoundError,
  _d as NotesTextEditorSkeleton,
  Od as NotesTextEditorUnsupportedPatchTypeError,
  Vc as NumberInput,
  Uo as OmniButton,
  ...
  cs as PrivateBox,
  zd as ProgressBarChart,
  Dd as RadarChart,
  vi as Reactions,
  Yc as ResourceHeader,
  or as RichTextDisplay,
  Zc as RichTextEditor,
  Sc as ScrollArea,
  Xo as SearchBar,
  Xc as SectionHeader,
  We as Select,
  ...
  sd as chipVariants,
  od as downloadAsCSV,
  cd as generateCSVContent,
  dd as getGranularityDefinition,
  ud as getGranularityDefinitions,

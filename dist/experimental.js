import { P as sr, Q as lr, R as ir, T as or, U as Wt, W as ze, X as cr, Y as wt, Z as dt, _ as je, L as g, $ as Y, M as be, u as oe, a0 as dr, a1 as ur, a2 as fr, a3 as mr, a4 as hr, a5 as se, a6 as pr, a7 as Te, a8 as gr, a9 as br, aa as B, ab as xr, ac as vr, ad as Re, ae as wn, af as yr, ag as wr, N as j, ah as Nt, ai as E, aj as fe, ak as Nr, al as Cr, am as Ir, an as kr, ao as Sr, ap as Fe, aq as Nn, ar as Tr, as as ve, at as De, au as Fr, av as Ct, k as Cn, aw as ke, ax as Ar, ay as In, az as re, aA as $, O as kn, aB as Sn, aC as _r, aD as It, aE as pe, aF as ne, aG as Lr, aH as Er, aI as Dr, aJ as Rr, aK as ge, aL as Ye, aM as Pr, aN as Or, aO as zr, aP as $r, aQ as Ze, aR as Tn, aS as Br, aT as Mr, aU as Wr, aV as Ge, aW as jr, aX as Gr, aY as Vr, aZ as Ur, a_ as Hr, a$ as Kr, b0 as qr, b1 as Yr, b2 as Zr, b3 as Fn, b4 as Jr, b5 as Xr, b6 as Ve, b7 as Ce, b8 as Qr, b9 as An, ba as kt, bb as es, bc as ts, bd as _n, be as ut, bf as ft, bg as Ln, bh as ns, bi as as, bj as rs, bk as ss, bl as Je, bm as St, bn as En, bo as ls, bp as Dn, bq as is, br as os, bs as Se, bt as cs, bu as $e, bv as jt, bw as mt, bx as ds, by as us, bz as fs, bA as Rn, bB as ms, bC as Pn, bD as Tt, bE as hs, bF as ps, bG as Ft, bH as gs, a as bs, c as xs, bI as vs, bJ as On, bK as ys, bL as ws, F as Ns, bM as zn, bN as $n, bO as Cs, bP as Gt, bQ as Is, bR as ks, bS as Ss, bT as Ts, bU as Bn, bV as Fs, bW as As, bX as _s, bY as Ls, bZ as Es, b_ as me, b$ as At, c0 as _t, c1 as Lt, c2 as Mn, c3 as Et, c4 as Wn, c5 as Ds, c6 as Rs, c7 as Ps, c8 as Os, c9 as zs, ca as $s, cb as Bs, cc as Ms, cd as Ws, ce as js, cf as Gs, cg as Vt, ch as Ut, ci as Ht, cj as Vs, ck as Us, cl as Hs, cm as Ks, cn as jn, co as qs, cp as Ys, cq as Zs } from "./F0AiChat-CEho3LOj.js";
import { cA as xu, cz as vu, cM as yu, cs as wu, ct as Nu, cW as Cu, cu as Iu, cy as ku, cv as Su, cI as Tu, cJ as Fu, cN as Au, cU as _u, cV as Lu, cw as Eu, cC as Du, cB as Ru, cK as Pu, cr as Ou, cL as zu, cP as $u, cQ as Bu, cH as Mu, cE as Wu, cG as ju, cD as Gu, cx as Vu, cF as Uu, cR as Hu, cS as Ku, cO as qu, cT as Yu } from "./F0AiChat-CEho3LOj.js";
import { jsx as t, jsxs as o, Fragment as H } from "react/jsx-runtime";
import * as ee from "react";
import K, { forwardRef as R, useRef as V, useTransition as Js, useState as L, useLayoutEffect as Gn, useContext as Dt, createContext as Rt, useCallback as te, useMemo as Z, useEffect as G, useId as Xs, memo as Vn, Fragment as Qs, isValidElement as el, cloneElement as Un, Children as Hn } from "react";
import { C as tl, P as nl, g as Kn, c as al, a as qn, F as ht, R as rl, f as sl, b as ll, u as Yn, A as il, B as ol, L as cl, d as dl, V as ul, e as fl, h as Kt, i as ml, j as hl } from "./index-CzaXJ_8m.js";
import { m as Ju, n as Xu, k as Qu, w as ef, o as tf, t as nf, G as af, l as rf, z as sf, K as lf, I as of, D as cf, p as df, H as uf, N as ff, q as mf, s as hf, v as pf, y as gf, J as bf, S as xf, T as vf, r as yf, _ as wf, E as Nf, x as Cf } from "./index-CzaXJ_8m.js";
const pl = sr("Search", [
...
function yl({ breadcrumbs: e, append: n }) {
  const a = V(null), r = V(null), [, s] = Js(), [l, i] = L(null), c = (l?.collapsedItems || []).length > 0;
  return Gn(() => {
...
function Id({
  ...
  const { sidebarState: u, toggleSidebar: m } = Ae(), h = [
    ...
    ...a
  ], b = n && Object.keys(n).length !== 0, p = a.length > 0, x = !s && r.length > 0, w = !s && !!i?.isVisible, C = h[h.length - 1], F = p ? h[h.length - 2] : null;
  return /* @__PURE__ */ o(
    "div",
    {
      className: g(
...
const nn = ({
  ...
  const _ = K.useRef(null), M = Z(
    ...
    (T) => {
      ...
      const J = v ? T.index - 1 : T.index, Q = n[J], { selected: X, partialSelected: ce } = q(Q);
      return /* @__PURE__ */ t(
        Me,
        {
    ...
    return [
      {
        ...
        subItem: {
          ...
          subName: T.name,
          subAvatar: T.avatar,
          expanded: T.expanded ?? J?.expanded ?? !1,
          subItems: T.subItems,
    ...
    (T) => {
      ...
      const J = v ? T.index - 1 : T.index, Q = ue[J].parent, X = ue[J].subItem;
      if (!Q) {
        const ae = {
          id: X.subId,
          name: X.subName,
    ...
    if (!e)
      ...
      n.forEach((ae) => {
        ...
        T += he.length, J += he.filter(
          (xe) => ce.has(xe.subId)
        ).length;
      });
    }
    const Q = T > 0 && J === T, X = J > 0;
    return [Q, X];
...
var it = "rovingFocusGroup.onEntryFocus", ii = { bubbles: !1, cancelable: !0 }, tt = "RovingFocusGroup", [bt, la, oi] = Jr(tt), [ci, ia] = Fn(
  tt,
  [oi]
...
var bi = oa, xi = da, _e = "ToggleGroup", [fa] = Fn(_e, [
  ia
...
const Ii = ({
  ...
  title: e,
  numItems: n
}) => /* @__PURE__ */ t(Ia, { title: e, children: Array.from({ length: n }).map((a, r) => /* @__PURE__ */ t($t.Skeleton, {}, r)) }), We = ne(Si, Ti), Fi = 3, Ai = ["today", "yesterday", "lastWeek", "lastMonth"], _i = (e) => as(e, ([n]) => {
  ...
  const l = oe(), i = al(e, "createdAt"), c = Object.values(i).slice().flatMap((u) => u.map((m) => m.id)).slice(-s), d = ns((u) => {
    c.includes(u) && r?.();
  }, 1e3), f = _i(
  ...
  return /* @__PURE__ */ o("div", { className: "flex flex-col gap-2 p-2", children: [
    ...
    n && new Array(Fi).fill(null).map((u, m) => /* @__PURE__ */ t($t.Skeleton, {}, m))
  ] });
}, Ei = () => {
  const e = oe();
  return /* @__PURE__ */ o("div", { className: "flex flex-col gap-2 p-2", children: [
...
const zi = ({
  ...
  const p = (P) => {
    h(P), c?.(P);
  }, x = Je(), { canvasRef: w, handleMouseEnter: C, handleMouseLeave: F } = Oi(x), O = St({
    emoji: Di[d],
    size: "sm"
  });
  return /* @__PURE__ */ o(
...
function Bi({
  ...
  const [l, i] = L(a), [c, d] = L(n), f = V(null), { fireEmojiConfetti: u } = ls(), m = (p, x) => {
...
const Wi = $("Reactions", Mi), ji = ({
  ...
  return /* @__PURE__ */ o(
    "button",
    {
      ...
      children: [
        n,
        /* @__PURE__ */ t("div", { className: "relative h-5 w-5", children: /* @__PURE__ */ o(Te, { mode: "wait", children: [
          !a && /* @__PURE__ */ t(
            Y.div,
            {
...
const fo = $("DataList", Ma), de = Object.assign(fo, {
  ...
  function({ title: n, tableView: a = !1, details: r, dataTestId: s }, l) {
    return /* @__PURE__ */ t(gs, { dataTestId: s, children: /* @__PURE__ */ o("div", { ref: l, className: "flex flex-col gap-4", children: [
...
function yo({
  ...
  const l = r?.enabled ? bs : s?.enabled ? Gl : Qs, i = r?.enabled ? r : s?.enabled ? s : void 0;
...
function To({ label: e, options: n, hasNewUpdate: a }) {
  return /* @__PURE__ */ t(
    "div",
    {
...
function $d({
  ...
  return /* @__PURE__ */ o("div", { className: "flex flex-row items-center justify-between gap-1 p-3", children: [
    ...
    a && /* @__PURE__ */ t(ve, { label: c.notifications, shortcut: r, children: /* @__PURE__ */ o("div", { className: "relative", children: [
      ...
      i && /* @__PURE__ */ t("div", { className: "absolute -right-1 -top-1 rounded-full bg-f1-background", children: /* @__PURE__ */ t(Cs, { type: "highlight", size: "sm", icon: $n }) })
    ] }) })
  ] });
}
...
const Ro = ({
  ...
  const f = oe(), { isDragging: u, setIsDragging: m, draggedItemId: h, setDraggedItemId: b } = Bt(), { isActive: p } = wt(), x = p(e.href, { exact: e.exactMatch }), w = V(!1), [C, F] = L(!1), O = s === 0, P = s === l - 1, A = l === 1, v = Z(() => {
    const _ = [];
    return !A && !O && _.push({
  ...
  return /* @__PURE__ */ t("div", { children: /* @__PURE__ */ o(As, { open: c, children: [
  ...
  const { isDragging: i, setIsDragging: c } = Bt(), d = V(!1), f = Fs(), u = () => {
    c(!0), d.current = !0;
  }, m = () => {
    c(!1), setTimeout(() => {
      d.current = !1, l && s?.(l);
...
function zo({
  ...
  const u = oe(), { isDragging: m } = Bt(), h = e.some((N) => N.isRoot), b = e.filter((N) => !N.isRoot).length > 0, p = n.length > 0, x = V(null), [w, C] = L(i), F = i.length > 0;
  G(() => {
      ...
      children: [
        n && /* @__PURE__ */ t(_t, { className: "-mr-1 -mt-1", children: /* @__PURE__ */ o("div", { className: "flex w-full flex-1 flex-col gap-4", children: [
          ...
          n.comment && /* @__PURE__ */ o("div", { className: "flex flex-row items-center gap-3 overflow-visible", children: [
            /* @__PURE__ */ t(Qo, { children: /* @__PURE__ */ t(Rs, { children: n.comment }) }),
  ...
  R(function({ canBeBlurred: n, ...a }, r) {
    ...
    return /* @__PURE__ */ t(
      ie,
      {
        ref: r,
        ...s,
        chart: /* @__PURE__ */ t(il, { ...l, canBeBlurred: n })
      }
    );
  }),
  ie.Skeleton
...
const mu = re(
  ...
  const s = Zs(), l = window.location.pathname, i = Z(() => n?.length ? n.includes(l) : a?.length ? !a.includes(l) : !0, [l, n, a]), c = Z(() => {
...
export {
  ...
  Qo as PrivateBox,
  hf as ProgressBarChart,
  pf as RadarChart,
  Wi as Reactions,
  gf as ResourceHeader,
  rl as RichTextDisplay,
  bf as RichTextEditor,
  pu as ScrollArea,
  Wd as SearchBar,
  xf as SectionHeader,
  Ge as Select,

import { h as Ca, B as ka, i as Ia, j as Sa, k as zt, l as Me, m as Be, n as Fa, o as b, p as Y, q as ye, u as se, T as Aa, r as La, s as Oa, R as Pa, t as Ea, v as ie, w as Ta, x as Ct, y as ft, z as Ge, A as Se, E as _a, G as Da, H as V, J as za, K as Ba, L as xe, M as pn, N as Ra, O as $a, Q as H, S as bn, U as z, V as Fe, W as Ma, X as ja, Y as Wa, Z as Va, _ as Ua, $ as Ee, a0 as xn, a1 as Ha, a2 as we, a3 as Ke, a4 as Ga, e as vn, a5 as Oe, a6 as Ka, a7 as yn, a8 as le, a9 as Z, aa as wn, ab as Nn, ac as qa, ad as Cn, ae as ge, af as ae, ag as Ya, ah as Ja, ai as Za, aj as Xa, ak as Qa, al as ve, am as Xe, an as er, ao as tr, ap as nr, aq as ar, ar as Qe, as as kn, at as rr, au as ir, av as sr, aw as qe, ax as lr, ay as In, az as or, aA as cr, aB as dr, aC as ur, aD as fr, aE as mr, aF as hr, aG as gr, aH as mt, aI as Sn, aJ as ht, aK as Fn, aL as pr, aM as br, aN as xr, aO as vr, aP as yr, aQ as $e, aR as et, aS as gt, aT as An, aU as wr, aV as kt, aW as Nr, aX as Cr, aY as kr, aZ as Pe, a_ as Ir, a$ as Sr, b0 as je, b1 as Bt, b2 as pt, b3 as Fr, b4 as Ar, a as Lr, b as Or, b5 as Ln, b6 as Pr, g as Er, F as Tr, b7 as _r, b8 as On, b9 as Dr, ba as Pn, bb as zr, bc as En, bd as Br, be as Rr, bf as Tn, bg as $r, bh as Mr, bi as jr, bj as Wr, bk as _n, bl as Vr, bm as Ur, bn as Hr, bo as Dn, bp as Gr, bq as Kr, br as qr, bs as Yr, bt as pe, bu as It, bv as St, bw as Ft, bx as zn, by as At, bz as Bn, bA as Rn, bB as Jr, bC as Zr, bD as Xr, bE as Qr, bF as ei, bG as ti, bH as ni, bI as ai, bJ as Rt, bK as ri, bL as ii, bM as $t, bN as Mt, bO as jt, bP as si, bQ as li, bR as oi, bS as ci, bT as $n, bU as di, bV as ui } from "./F0CanvasPanel-qR9r8qMq.js";
import { c6 as pd, c5 as bd, ci as xd, c2 as vd, c3 as yd, bW as wd, bX as Nd, cl as Cd, bY as kd, bZ as Id, cm as Sd, c4 as Fd, ce as Ad, cf as Ld, cj as Od, b_ as Pd, c8 as Ed, c7 as Td, b$ as _d, c0 as Dd, cg as zd, cn as Bd, ch as Rd, ck as $d, cd as Md, ca as jd, cc as Wd, c9 as Vd, c1 as Ud, cb as Hd } from "./F0CanvasPanel-qR9r8qMq.js";
import { jsx as t, jsxs as o, Fragment as X } from "react/jsx-runtime";
import ue, { forwardRef as K, useRef as W, useTransition as fi, useState as E, useLayoutEffect as Mn, useId as bt, useContext as Ne, createContext as Te, useEffect as j, useCallback as ne, useMemo as G, Fragment as mi, isValidElement as hi, cloneElement as jn, Children as Wn } from "react";
import { C as gi, P as pi, a as Vn, M as bi, p as xi, b as vi, R as Wt, c as Un, u as yi, d as wi, e as Ni, f as Ci, g as ki, h as Hn, S as Ii, A as Si, B as Fi, L as Ai, i as Li, V as Oi, j as Pi, k as Ei, l as Ti, O as _i } from "./useDataCollectionSource-7_N0o7S1.js";
import { r as Kd, s as qd, o as Yd, H as Jd, t as Zd, z as Xd, a8 as Qd, G as eu, q as tu, aa as nu, a9 as au, Q as ru, ad as iu, F as su, Y as lu, U as ou, J as cu, af as du, K as uu, Z as fu, _ as mu, v as hu, ab as gu, ac as pu, N as bu, $ as xu, a5 as vu, a7 as yu, w as wu, y as Nu, D as Cu, W as ku, ae as Iu, X as Su, T as Fu, ag as Au, x as Lu, E as Ou, m as Pu, n as Eu, a1 as Tu, a2 as _u, a6 as Du, I as zu, a3 as Bu, a0 as Ru, a4 as $u } from "./useDataCollectionSource-7_N0o7S1.js";
const Di = Ca("Search", [
...
}, Kn = K(Wi), qn = Te(null), Vi = 15, Ui = ({ children: e, enabled: n, onShow: a, ...r }) => {
...
}, Ht = "one_sidebar_locked", Jn = Te(void 0);
function _e() {
  const e = Ne(Jn);
  return e === void 0 ? {
    isSmallScreen: !1,
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "scrollbar-macos flex-1 overflow-y-auto", children: [
                ...
                m === "idle" && g !== null && g.length > 0 && /* @__PURE__ */ o("div", { className: "px-1", children: [
                  ...
                  g.length > 1 && /* @__PURE__ */ t(X, { children: /* @__PURE__ */ t("div", { className: "pb-1", children: v.map((_, O) => /* @__PURE__ */ t(
                    Yi,
                    {
                      ..._,
                      onClick: d
...
function ts(e, n) {
  ...
  return G(() => {
    if (!i) return null;
    const x = f !== null && u !== void 0 ? { current: f + 1, total: u } : void 0, v = (B, _) => (B !== null ? a?.(B) : void 0) ?? _, N = r === "callback" ? m ? { onClick: g, title: v(s, "Previous") } : void 0 : c !== null ? { url: c, title: v(s, "Previous") } : void 0, T = r === "callback" ? h ? { onClick: p, title: v(l, "Next") } : void 0 : d !== null ? { url: d, title: v(l, "Next") } : void 0;
...
function bc({
  ...
  const { sidebarState: u, toggleSidebar: m } = _e(), h = Ne(Pt), g = s ?? h ?? void 0, p = [
    {
      id: e.href,
      label: e.name,
      href: e.href,
    ...
    ...a
  ], x = n && Object.keys(n).length !== 0, v = i && a.length > 0, N = !i && r.length > 0, T = !i && !!l?.isVisible, B = p[p.length - 1], _ = "navigation" in window ? window.navigation : null, O = i && (_ ? !!_.canGoBack : window.history.length > 1);
  return /* @__PURE__ */ o(
    "div",
    {
      className: b(
  ...
  const A = ue.useRef(null), M = G(
    ...
    (F) => {
      ...
      if (!ee) {
        ...
        ), he = (D.subItems?.length ?? 0) === ce.length, wa = !he && ce.length > 0;
        return /* @__PURE__ */ t(
          Ue,
          {
            groupView: !0,
    ...
    return [ee, J];
  }, [n, I, e]), ke = te.length, oe = !R && (v || N), st = O && O.length > 0, De = !w && (!R && oe || st);
  return /* @__PURE__ */ o(
    "div",
    {
      className: b(
...
const As = ({
  ...
  title: e,
  numItems: n
}) => /* @__PURE__ */ t(aa, { title: e, children: Array.from({ length: n }).map((a, r) => /* @__PURE__ */ t(Et.Skeleton, {}, r)) }), He = ae(Os, Ps), Es = 3, Ts = ["today", "yesterday", "lastWeek", "lastMonth"], _s = (e) => xr(e, ([n]) => {
...
const js = ({
  ...
  const p = (_) => {
    h(_), c?.(_);
  }, x = $e(), { canvasRef: v, handleMouseEnter: N, handleMouseLeave: T } = Ms(x), B = et({
    emoji: Bs[d],
    size: "sm"
  });
  return /* @__PURE__ */ o(
...
const Gs = () => /* @__PURE__ */ o("div", { className: "flex flex-col justify-around gap-3 py-2", children: [
  ...
  const N = bt(), T = bt(), B = W(null), [_, O] = E(null), [L, U] = E(!1), R = [f.views, f.comments].filter(Boolean).join(" · "), w = v && _?.id === e && _.description === s, S = !w, k = Sn(r), A = () => {
    l(e);
  }, M = (I) => {
    I.stopPropagation();
...
function sl({
  ...
  const { sidebarState: s, toggleSidebar: l, isSmallScreen: c, setForceFloat: d } = _e(), f = $e(), {
    ...
    chatWidth: x,
    resizable: v
  } = Or(), N = m === "fullscreen", T = m === "canvas", { open: B } = tt(), _ = v ? x : Pr, O = W(N), L = N && !O.current, U = !N && O.current, [
    R,
    w
  ] = E(!1);
  j(() => {
                ...
                e?.enabled && /* @__PURE__ */ t(
                  Y.div,
                  {
                    ...
                    children: /* @__PURE__ */ t(
                      Tr,
                      {
                        revealChatOnCanvasToggle: e?.revealChatOnCanvasToggle ?? !0
                      }
                    )
                  }
                )
...
const Oc = le(Z("Page", ua)), dl = (e) => e.reduce(
  ...
  0
), fa = Te(null), ma = Te(null), sn = (e, n, a) => e.map((r) => r.id === n ? a(r) : r), Ve = (e, n) => e.map((a) => ({ ...a, chats: n(a.chats) })), Pc = ({
  children: e,
  initialGroups: n = [],
...
function _c({
  ...
  return /* @__PURE__ */ o("div", { className: "flex flex-row items-center justify-between gap-1 p-3", children: [
    ...
    a && /* @__PURE__ */ t(we, { label: c.notifications, shortcut: r, children: /* @__PURE__ */ o("div", { className: "relative", children: [
      ...
      l && /* @__PURE__ */ t("div", { className: "absolute -right-1 -top-1 rounded-full bg-f1-background", children: /* @__PURE__ */ t($r, { type: "highlight", size: "sm", icon: Tn }) })
    ] }) })
  ] });
}
...
const Nl = ({
  ...
  const f = se(), { isDragging: u, setIsDragging: m, draggedItemId: h, setDraggedItemId: g } = _t(), { isActive: p } = Ct(), x = p(e.href, { exact: e.exactMatch }), v = W(!1), [N, T] = E(!1), B = i === 0, _ = i === s - 1, O = s === 1, L = G(() => {
    const A = [];
    return !O && !B && A.push({
...
function Fl({
  ...
  const { sidebarState: i, isSmallScreen: s } = _e(), l = $e(), [c, d] = mt({ threshold: 1 }), [f, u] = mt({ threshold: 1 }), m = se(), h = {
    x: {
...
function jc(e) {
  ...
  }), De = G(() => l || (x.idProvider ? (D, Q) => x.idProvider(D, Q) : ki), [l, x.idProvider]), F = G(() => {
...
function sd({
  ...
  const { status: _, statusText: O, subtitle: L, statusColor: U } = Co({
    data: a,
    labels: r,
    trackedMinutes: e,
    remainingMinutes: n,
...
var Eo = Object.defineProperty, To = Object.defineProperties, _o = Object.getOwnPropertyDescriptors, Ze = Object.getOwnPropertySymbols, xa = Object.prototype.hasOwnProperty, va = Object.prototype.propertyIsEnumerable, mn = (e, n, a) => n in e ? Eo(e, n, { enumerable: !0, configurable: !0, writable: !0, value: a }) : e[n] = a, fe = (e, n) => {
  for (var a in n || (n = {})) xa.call(n, a) && mn(e, a, n[a]);
  if (Ze) for (var a of Ze(n)) va.call(n, a) && mn(e, a, n[a]);
  return e;
}, it = (e, n) => To(e, _o(n)), Do = (e, n) => {
  var a = {};
...
var ic = () => {
  ...
  var n = e, { children: a, style: r, transition: i = !1, transitionDuration: s = 500, transitionStep: l = 50 } = n, c = Do(n, ["children", "style", "transition", "transitionDuration", "transitionStep"]);
  ...
  return t("div", it(fe({ ref: f, style: p }, c), { children: Wn.map(a, (x, v) => {
    ...
    let N = { style: ac({ style: x.props.style, position: h[v], transition: i, transitionDuration: s }), ref: (T) => d.current[v] = T };

...
function wl({ breadcrumbs: t, append: n }) {
  const a = G(null), r = G(null), [, l] = Ur(), [s, i] = _(null), c = (s?.collapsedItems || []).length > 0;
  return In(() => {
    ...
    At,
    {
      ...
      children: [
        ...
        s && s.headItem && /* @__PURE__ */ o(ga, { children: [
          ...
          !c && /* @__PURE__ */ e(K, { children: s.tailItems.map((d, f) => /* @__PURE__ */ e(
            De,
            {
              item: d,
              isLast: f === s.tailItems.length - 1,
...
}, zn = j(Nl), Pn = xt(null), Cl = 15, kl = ({ children: t, enabled: n, onShow: a, ...r }) => {
...
const Bn = ({
  ...
  const { enabled: a, setOpen: r, open: l } = qe(), s = se(), [i, c] = _(!1);
...
}, Bt = "one_sidebar_locked", Rn = xt(void 0);
function Se() {
  const t = Ke(Rn);
  return t === void 0 ? {
    isSmallScreen: !1,
...
function Sl({ children: t }) {
  const { currentPath: n } = gt(), [a, r] = _(!1), [l, s] = _(!1), i = a ? Re.xl : Re.md, c = rt(`(max-width: ${i}px)`, {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "scrollbar-macos flex-1 overflow-y-auto", children: [
                ...
                m === "idle" && p !== null && p.length > 0 && /* @__PURE__ */ o("div", { className: "px-1", children: [
                  ...
                  p.length > 1 && /* @__PURE__ */ e(K, { children: /* @__PURE__ */ e("div", { className: "pb-1", children: y.map((D, E) => /* @__PURE__ */ e(
                    Ll,
                    {
                      ...D,
                      onClick: d
...
function Wo({
  ...
  const { sidebarState: u, toggleSidebar: m } = Se(), h = [
    ...
    ...a
  ], p = n && Object.keys(n).length !== 0, b = l && a.length > 0, v = !l && r.length > 0, y = !l && !!i?.isVisible, I = h[h.length - 1], z = "navigation" in window ? window.navigation : null, R = l && (z ? !!z.canGoBack : window.history.length > 1);
  return /* @__PURE__ */ o(
    "div",
    {
      className: g(
      ...
      children: [
        ...
        /* @__PURE__ */ o("div", { className: "flex items-center gap-3", children: [
          ...
          !l && p && (s || v || y) && /* @__PURE__ */ e("div", { className: "h-4 w-px bg-f1-border-secondary" }),
          ...
          (y || v) && /* @__PURE__ */ o("div", { className: "flex items-center gap-2", children: [
            ...
            v && /* @__PURE__ */ e("div", { className: "items-right flex gap-2", children: r.map((D, E) => /* @__PURE__ */ e(zl, { action: D }, E)) })
          ] }),
          /* @__PURE__ */ o("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ e(
              dn,
...
const Pl = () => {
  ...
  return t ? /* @__PURE__ */ o(Rl, { children: [
...
const Zl = ({
  ...
  const m = t.name.split(" "), h = m[0] || "", p = m.slice(1).join(" "), b = (y) => {
    ...
    if (y.key === "Enter" || y.key === " ") {
      ...
      n ? n && r(t) : a(t);
    } else y.key === "ArrowDown" ? Ye(y.currentTarget, i) : y.key === "ArrowUp" && Ze(y.currentTarget, c);
  };
...
const Vt = ({
  ...
  const F = ie.useRef(null), B = q(
    ...
    return [J, Z];
  }, [n, S, t]), Fe = le.length, sa = !T && (y || I), ia = E && E.length > 0, oa = !w && (!T && sa || ia);
  return /* @__PURE__ */ o(
    "div",
    {
      className: g(
  ...
  const p = (s ?? Kt) < rs, b = !c && !i && !p, v = s ?? Kt, y = b ? v - qt : v;
  return /* @__PURE__ */ o(
    "div",
    {
  ...
  })), [D, a]), L = E.length === 0 ? void 0 : E.length === 1 ? E[0].subItem.subName : E.length + " " + n, U = E.length === 1 ? E[0].subItem.subName : void 0;
  return /* @__PURE__ */ e(
    er,
    {
      onClickContent: m,
      ...
      append: I ?? /* @__PURE__ */ e(K, { children: /* @__PURE__ */ e(tr, { open: R, disabled: r, size: z }) }),
      children: /* @__PURE__ */ e(
        "span",
        {
          role: "button",
  ...
  const [l, s] = _(t.entities), [i, c] = _(""), [d, f] = nr("", 300), u = q(
    () => t.entities.some(
  ...
  function b(w) {
    ...
    const x = [...k];
    function N(S) {
      const V = x.findIndex((re) => re.id === S.id);
      V >= 0 ? x[V] = S : x.push(S);
    }
    B.forEach((S) => {
  ...
  $(() => {
    ...
    if (u && !t.applySearchToGroup) {
      const k = t.entities.map((C) => {
        const F = ss(C, d), B = C.subItems?.map((x) => ({
          ...x,
          score: je(
            d,
...
const is = ({
  ...
  const s = se(), i = Xr(t, "createdAt"), c = Object.values(i).slice().flatMap((u) => u.map((m) => m.id)).slice(-l), d = ir((u) => {
    c.includes(u) && r?.();
  }, 1e3), f = ms(
...
const ws = ({
  ...
  const [m, h] = _(i), p = G(null);
  $(() => {
    h(i);
  }, [i]);
  const b = (D) => {
    h(D), c?.(D);
  }, v = Ue(), { canvasRef: y, handleMouseEnter: I, handleMouseLeave: z } = vs(v), R = bt({
    emoji: ps[d],
    size: "sm"
  });
  return /* @__PURE__ */ o(
...
function Ns({
  ...
  const [s, i] = _(a), [c, d] = _(n), f = G(null), { fireEmojiConfetti: u } = ur(), m = (b, v) => {
...
const Ss = () => /* @__PURE__ */ o("div", { className: "flex flex-col justify-around gap-3 py-2", children: [
  ...
  const I = ot(), z = ot(), R = G(null), [D, E] = _(null), [L, U] = _(!1), T = [f.views, f.comments].filter(Boolean).join(" · "), w = y && D?.id === t && D.description === s, k = !w, C = Ln(r), F = () => {
    i(t);
  }, B = (S) => {
    S.stopPropagation();
  }, x = n ? `${n.firstName} ${n.lastName}` : void 0, N = (S) => {
    S.preventDefault(), S.stopPropagation(), s && E({ id: t, description: s });
  };
  return $(() => {
    w && R.current?.focus();
  }, [w]), $(() => {
    ...
    return re.observe(S), () => re.disconnect();
  }, [y, w, s]), /* @__PURE__ */ o(
    "div",
    {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ o("div", { className: "flex flex-1 flex-col", children: [
          ...
          "bottomTags" in a && /* @__PURE__ */ e("div", { className: "-ml-1.5 flex flex-row items-center [&>div]:-mr-1", children: a.bottomTags.map((s, i) => /* @__PURE__ */ o(K, { children: [
            /* @__PURE__ */ e(Ee, { ...s }, s.text),
...
function zs({
  ...
  const s = r?.enabled ? xr : l?.enabled ? Vl : Kr, i = r?.enabled ? r : l?.enabled ? l : void 0;
...
function $s({
  ...
  const { sidebarState: s, toggleSidebar: i, isSmallScreen: c, setForceFloat: d } = Se(), f = Ue(), {
    open: u,
    visualizationMode: m,
    canvasContent: h,
    canvasEntities: p,
    ...
    chatWidth: v,
    resizable: y
  } = vr(), I = m === "fullscreen", z = m === "canvas", { open: R } = qe(), D = y ? v : wr, E = G(I), L = I && !E.current, U = !I && E.current, [
    T,
    w
  ] = _(!1);
  $(() => {
  ...
  const k = I || T || U, C = q(() => L ? { duration: 0.15, ease: "easeOut" } : U ? { duration: 0.4, ease: [0.25, 0.1, 0.25, 1] } : { duration: 0 }, [L, U]), F = rt(
    `(max-width: ${Re.xl}px)`,
    { initializeWithValue: !0 }
    ...
    Qr,
    {
      ...
      children: /* @__PURE__ */ o("div", { className: "scrollbar-macos grid h-screen grid-cols-1 grid-rows-[auto_minmax(0,1fr)]", children: [
        ...
        /* @__PURE__ */ e(vn, { id: "ai-chat-group", children: /* @__PURE__ */ o("div", { className: "relative isolate flex h-full", children: [
          /* @__PURE__ */ e(_e, { children: s === "unlocked" && /* @__PURE__ */ e(
            X.nav,
            {
              className: g(
...
function js({ label: t, options: n, hasNewUpdate: a }) {
  return /* @__PURE__ */ e(
    "div",
    {
      ...
      children: /* @__PURE__ */ e(Ce, { items: Ms(n), children: /* @__PURE__ */ o(
        "button",
        {
          className: g(
...
function ec({
  ...
  return /* @__PURE__ */ o("div", { className: "flex flex-row items-center justify-between gap-1 p-3", children: [
    ...
    a && /* @__PURE__ */ e(be, { label: c.notifications, shortcut: r, children: /* @__PURE__ */ o("div", { className: "relative", children: [
      ...
      i && /* @__PURE__ */ e("div", { className: "absolute -right-1 -top-1 rounded-full bg-f1-background", children: /* @__PURE__ */ e(kr, { type: "highlight", size: "sm", icon: yn }) })
    ] }) })
  ] });
}
...
const Ys = ({
  ...
  const f = se(), { isDragging: u, setIsDragging: m, draggedItemId: h, setDraggedItemId: p } = It(), { isActive: b } = gt(), v = b(t.href, { exact: t.exactMatch }), y = G(!1), [I, z] = _(!1), R = l === 0, D = l === s - 1, E = s === 1, L = q(() => {
    const F = [];
    return !E && !R && F.push({
    ...
    /* @__PURE__ */ e("div", { className: "flex w-full items-center justify-between px-1.5 py-1.5", children: /* @__PURE__ */ e(Qs, { tooltip: n, children: /* @__PURE__ */ o(
      we,
      {
        ...
        children: [
          ...
          ) : t.avatar ? /* @__PURE__ */ e(Ar, { size: "xs", avatar: t.avatar }) : null,
          /* @__PURE__ */ e(
            me,
            {
              tag: "span",
  ...
  return /* @__PURE__ */ e("div", { children: /* @__PURE__ */ o(Lr, { open: c, children: [
  ...
  const { isDragging: i, setIsDragging: c } = It(), d = G(!1), f = tl(), u = () => {
    c(!0), d.current = !0;
  }, m = () => {
    c(!1), setTimeout(() => {
      d.current = !1, s && l?.(s);
    ...
    ea,
    {
      ...
      children: /* @__PURE__ */ e(
        "div",
        {
          ...
          children: t.items.map((b, v) => /* @__PURE__ */ e(Zs, { item: b }, v))
        }
      )
    }
  );
...
function nc({
  ...
  return /* @__PURE__ */ e(qs, { children: /* @__PURE__ */ e(vn, { id: "sidebar-menu", children: /* @__PURE__ */ e(
    Js,
    {
      disableDragging: p,
      nonSortableItems: i,
...
function Js({
  ...
  const u = se(), { isDragging: m } = It(), h = t.some((x) => x.isRoot), p = t.filter((x) => !x.isRoot).length > 0, b = n.length > 0, v = G(null), [y, I] = _(i), z = i.length > 0;
  $(() => {
  ...
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      children: [
        ...
        z && /* @__PURE__ */ e("div", { className: "mt-3 flex w-full flex-col gap-3 bg-transparent px-3", children: /* @__PURE__ */ e(ea, { title: u.favorites.favorites, children: /* @__PURE__ */ e("div", { ref: v, children: f ? /* @__PURE__ */ e("div", { className: w, children: C }) : /* @__PURE__ */ e(
          Dt,
          {
            axis: "y",
            values: y,
  ...
  return /* @__PURE__ */ e("div", { className: "px-3", children: /* @__PURE__ */ o(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ e("div", { className: "hidden xs:block", children: /* @__PURE__ */ e(Or, { keys: a }) })
      ]
    }
  ) });
}
...
function ei({
  ...
  const { sidebarState: l, isSmallScreen: s } = Se(), i = Ue(), [c, d] = lt({ threshold: 1 }), [f, u] = lt({ threshold: 1 }), m = se(), h = {
    x: {
...
const li = ({
  ...
  return /* @__PURE__ */ o("div", { className: "flex w-full flex-col gap-4", children: [
    ...
    /* @__PURE__ */ o("div", { className: "flex flex-row gap-4", children: [
      ...
      /* @__PURE__ */ e("div", { className: "flex w-full flex-col rounded-xl border border-solid border-f1-border", children: t.map((l, s) => /* @__PURE__ */ o(K, { children: [
        /* @__PURE__ */ e(
          li,
          {
            title: l.title,
      ...
      children: [
        n && /* @__PURE__ */ e(wt, { className: "-mr-1 -mt-1", children: /* @__PURE__ */ o("div", { className: "flex w-full flex-1 flex-col gap-4", children: [
          /* @__PURE__ */ o("div", { className: "flex flex-1 flex-row flex-nowrap items-center justify-between gap-2", children: [
            /* @__PURE__ */ o("div", { className: "flex min-h-6 grow flex-row items-center gap-1 truncate", children: [
              ...
              n.subtitle && /* @__PURE__ */ o("div", { className: "flex flex-row items-center gap-1", children: [
                /* @__PURE__ */ e(gi, {}),
                /* @__PURE__ */ e(Dn, { className: "truncate", children: n.subtitle })
              ] }),
            ...
            /* @__PURE__ */ o("div", { className: "flex flex-row items-center gap-3", children: [
              s && /* @__PURE__ */ e(kn, { text: s, level: "critical" }),
          ...
          n.comment && /* @__PURE__ */ o("div", { className: "flex flex-row items-center gap-3 overflow-visible", children: [
            /* @__PURE__ */ e(hi, { children: /* @__PURE__ */ e(al, { children: n.comment }) }),
        ...
        /* @__PURE__ */ o(Nt, { className: "flex h-full flex-col gap-4", children: [
          ...
          ie.Children.toArray(a).filter(m).map((p, b) => /* @__PURE__ */ o(ie.Fragment, { children: [
            b > 0 && /* @__PURE__ */ e(rl, { bare: !0 }),
            p
          ] }, b))
        ] }),
        r && /* @__PURE__ */ e(ll, { children: /* @__PURE__ */ e(M, { variant: "neutral", size: "sm", ...r }) })
      ]
    }
  );
}), bi = pe({
        ...
        children: [
          /* @__PURE__ */ e(wt, { className: "-mr-1 -mt-1", children: /* @__PURE__ */ o(
            "div",
            {
              ...
              "aria-hidden": !0,
              children: [
                n?.title ? /* @__PURE__ */ e(yt, { children: n.title }) : /* @__PURE__ */ e(O, { className: "h-4 w-full max-w-16" }),
                n?.subtitle && /* @__PURE__ */ e(Dn, { children: n.subtitle })
              ]
            }
          ) }),
          /* @__PURE__ */ e(
  ...
  j(function({ canBeBlurred: n, ...a }, r) {
    ...
    return /* @__PURE__ */ e(
      ce,
      {
        ref: r,
        ...l,
        chart: /* @__PURE__ */ e(sl, { ...s, canBeBlurred: n })
      }
    );
  }),
  ce.Skeleton
    ...
    function(n, a) {
      return /* @__PURE__ */ e(
        ce,
        {
          ref: a,
          ...n,
          chart: /* @__PURE__ */ e(dl, { xAxis: { hide: !0 }, ...n.chart })
        }
      );
    }
  ),
    ...
    return /* @__PURE__ */ o(
      vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Nt, { className: g("flex flex-col gap-4", f), children: [
            /* @__PURE__ */ o(
              "div",
              {
                className: g(
  ...
  return /* @__PURE__ */ o(
    Vi,
    {
      ...
      children: [
        ...
        "emoji" in c && c.emoji && /* @__PURE__ */ e(Br, { emoji: c.emoji }),
        /* @__PURE__ */ o("div", { className: "flex-1", children: [
        ...
        /* @__PURE__ */ o("div", { className: "flex items-center gap-1", children: [
          ...
          r && /* @__PURE__ */ e("div", { className: "flex h-4 w-4 items-center text-f1-foreground-tertiary hover:cursor-help", children: /* @__PURE__ */ e(
            be,
            {
              ...
              children: /* @__PURE__ */ e(W, { icon: Cn, size: "sm" })
            }
          ) })
        ] }),
...
function Xi({
  ...
  return /* @__PURE__ */ o("div", { className: "relative h-40 w-40", children: [
    /* @__PURE__ */ e(fl, { width: 156, height: 156, children: /* @__PURE__ */ e(
      ml,
      {
        data: r,
        cx: 74,
...
function kc({
  ...
  const { status: D, statusText: E, subtitle: L, statusColor: U } = Ki({
    data: a,
    labels: r,
    trackedMinutes: t,
    remainingMinutes: n,
    ...
    h?.(P), C(!1), u?.(P);
  }, x = T && s.length && !c && i, N = s.find((P) => P.id === l), S = s.map((P) => ({
    value: P.id,
    label: P.name,
    icon: P.icon
  })), V = D === "break", [re, le] = _(!1);
  return /* @__PURE__ */ e("div", { className: "@container", children: /* @__PURE__ */ o("div", { className: "flex-grow flex-col", children: [
    /* @__PURE__ */ o("div", { className: "flex flex-col-reverse items-center gap-2 @xs:flex-row", children: [
      /* @__PURE__ */ o("div", { className: "flex-1 space-y-4", children: [
        ...
        /* @__PURE__ */ o("div", { className: "flex justify-center gap-2 @xs:justify-start", children: [
          ...
          D === "clocked-in" && /* @__PURE__ */ o(K, { children: [
            p && /* @__PURE__ */ e(K, { children: w.length > 1 && h ? /* @__PURE__ */ e(
              We,
              {
                label: r.break,
                hideLabel: !0,
    ...
    /* @__PURE__ */ e("div", { className: "mt-6 flex flex-row flex-wrap items-center justify-center gap-2 @xs:justify-start", children: x ? /* @__PURE__ */ o(K, { children: [
      ...
      i && N && /* @__PURE__ */ e(K, { children: /* @__PURE__ */ e(Ee, { text: N.name, icon: N.icon }) }),
      I && z,
...
var Eo = () => {
  ...
  return e("div", Je(oe({ ref: f, style: b }, c), { children: An.map(a, (v, y) => {
    if (typeof v != "object" || !v || !("type" in v)) return v;
    let I = { style: Ao({ style: v.props.style, position: h[y], transition: l, transitionDuration: s }), ref: (z) => d.current[y] = z };
    return Fn(v, oe(oe({}, v.props), I));
  }) }));
};
const Do = { sm: 340, md: 480, lg: 640 }, rn = j(
  function({ children: n, widgetWidth: a = "sm" }, r) {
    const l = Do[a], [s, i] = _(), c = An.toArray(n), d = G(null);
    return $(() => {
      const f = () => {
...
), To = ["sm", "lg", "md", "md", "lg", "sm", "lg", "lg", "sm", "sm", "md", "md"], Ic = ee(rn, () => /* @__PURE__ */ e(Sn, { children: /* @__PURE__ */ e(rn, { children: To.map((t, n) => /* @__PURE__ */ e(Ne.Skeleton, { height: t }, n)) }) })), ln = ({ children: t }) => /* @__PURE__ */ e("div", { className: "flex min-h-40 flex-row items-stretch gap-4 text-f1-foreground @container [&>div]:min-w-[calc(100vw-64px)] @2xl:[&>div]:min-w-[calc(50vw-48px)]", children: t }), Fc = ee(
  j(function({ children: n }, a) {
    return /* @__PURE__ */ e(Ge, { ref: a, showBar: !1, children: /* @__PURE__ */ e(ln, { children: n }) });
  }),
  () => /* @__PURE__ */ e(Sn, { orientation: "horizontal", children: /* @__PURE__ */ o(ln, { children: [
...
const Lc = ae(
  ...
  const l = Hr(), s = window.location.pathname, i = q(() => n?.length ? n.includes(s) : a?.length ? !a.includes(s) : !0, [s, n, a]), c = q(() => {
...
export {
  ...
  nd as getGranularitySimpleDefinition,
  ad as granularityDefinitions,
  rd as modules,
  jd as predefinedPresets,
  ld as rangeSeparator,
  Vd as selectSizes,

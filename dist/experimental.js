import { o as Ba, B as $a, p as Wa, q as Ma, r as Pt, s as Re, t as ja, v as h, w as q, x as ge, u as le, T as Va, y as Ga, z as Ha, R as Ua, A as Ka, E as ne, G as qa, H as vt, J as ot, K as je, L as Se, M as Ya, N as Za, O as W, Q as Ja, S as Xa, U as we, V as pn, W as Qa, X as er, Y as V, Z as yt, _ as D, $ as be, a0 as tr, a1 as nr, a2 as ar, a3 as rr, a4 as lr, a5 as Ae, a6 as gn, a7 as sr, a8 as ve, a9 as Ee, aa as ir, ab as wt, g as bn, ac as Ie, ad as or, ae as xn, af as ae, ag as R, ah as vn, ai as cr, aj as yn, ak as dr, al as Nt, am as he, an as ee, ao as ur, ap as fr, aq as mr, ar as hr, as as pe, at as Ke, au as pr, av as gr, aw as br, ax as xr, ay as qe, az as wn, aA as vr, aB as yr, aC as wr, aD as Ve, aE as Nr, aF as Cr, aG as Ir, aH as kr, aI as Sr, aJ as Ar, aK as Fr, aL as Lr, aM as Tr, aN as _r, aO as Nn, aP as ct, aQ as dt, aR as Cn, aS as Dr, aT as Er, aU as Or, aV as zr, aW as Ye, aX as Ct, aY as In, aZ as Pr, a_ as kn, a$ as Rr, b0 as Br, b1 as $r, b2 as ke, b3 as Wr, b4 as Be, b5 as Rt, b6 as ut, b7 as Mr, b8 as jr, b9 as Vr, ba as Sn, bb as Gr, bc as An, bd as It, be as Hr, bf as Ur, bg as kt, bh as Kr, a as qr, c as Yr, bi as Fn, bj as Zr, n as Jr, F as Xr, bk as Ln, bl as Tn, bm as Qr, bn as el, bo as tl, bp as nl, bq as al, br as rl, bs as ll, bt as sl, bu as il, bv as fe, bw as St, bx as At, by as Ft, bz as _n, bA as Lt, bB as Dn, bC as ol, bD as cl, bE as dl, bF as ul, bG as fl, bH as ml, bI as hl, bJ as pl, bK as gl, bL as bl, bM as Bt, bN as $t, bO as Wt, bP as xl, bQ as vl, bR as yl, bS as wl, bT as En, bU as Nl, bV as Cl } from "./F0CanvasPanel-ClSoMwWX.js";
import { c1 as zd, c0 as Pd, cd as Rd, bW as Bd, bX as $d, ce as Wd, bY as Md, b$ as jd, c9 as Vd, ca as Gd, bZ as Hd, c3 as Ud, c2 as Kd, cb as qd, cc as Yd, c8 as Zd, c5 as Jd, c7 as Xd, c4 as Qd, b_ as eu, c6 as tu } from "./F0CanvasPanel-ClSoMwWX.js";
import { jsx as e, jsxs as o, Fragment as U } from "react/jsx-runtime";
import * as Oe from "react";
import ie, { forwardRef as E, useRef as H, useTransition as Il, useState as T, useLayoutEffect as On, useId as ft, useContext as Ze, createContext as Tt, useEffect as j, useCallback as Q, useMemo as Y, memo as zn, Fragment as kl, isValidElement as Sl, cloneElement as Pn, Children as Rn } from "react";
import { C as Al, P as Fl, T as Ll, a as Tl, R as Bn, I as $n, g as Wn, c as _l, b as Mn, F as mt, f as Dl, M as El, d as Ol, e as Mt, h as jn, u as zl, i as Vn, S as Pl, A as Rl, B as Bl, L as $l, j as Wl, V as Ml, k as jl, l as jt, m as Vl, n as Gl, O as Hl } from "./index-2WEjr-1D.js";
import { s as au, t as ru, q as lu, J as su, v as iu, D as ou, a8 as cu, H as du, r as uu, X as fu, ae as mu, Y as hu, Z as pu, w as gu, aa as bu, ab as xu, a9 as vu, ac as yu, N as wu, _ as Nu, a5 as Cu, a7 as Iu, x as ku, z as Su, E as Au, U as Fu, ad as Lu, W as Tu, Q as _u, y as Du, G as Eu, o as Ou, p as zu, a0 as Pu, a1 as Ru, a6 as Bu, K as $u, a2 as Wu, a3 as Mu, $ as ju, a4 as Vu } from "./index-2WEjr-1D.js";
const Ul = Ba("Search", [
...
const Ut = q.create(W), Kt = {
  ...
  Yn,
  {
    ...
    button: /* @__PURE__ */ e(be, { href: a, children: /* @__PURE__ */ e(V, { label: n }) })
  }
), cs = ({
  title: t,
  description: n,
...
function Wc({
  ...
  const { sidebarState: u, toggleSidebar: m } = Fe(), p = [
    {
      id: t.href,
      label: t.name,
      href: t.href,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o("div", { className: "flex flex-grow items-center", children: [
          /* @__PURE__ */ e(Se, { children: !l && u !== "locked" && /* @__PURE__ */ e(
            q.div,
            {
        ...
        /* @__PURE__ */ o("div", { className: "flex items-center gap-3", children: [
          ...
          ) }) }) : /* @__PURE__ */ e(Ee, { text: n.text, variant: n.variant }) }),
...
function fs({ action: t }) {
  const n = H(null), [a, r] = T(!1), l = t.variant ?? "outline";
  return "actions" in t ? /* @__PURE__ */ e(Ie, { items: t.actions, open: a, onOpenChange: r, children: /* @__PURE__ */ e(
    we,
    {
      size: "md",
      variant: l,
...
const Jt = ({
  ...
  ) : u && (g = /* @__PURE__ */ e(De, { primaryAction: v, secondaryActions: [] }), w && (b = /* @__PURE__ */ e(De, { primaryAction: w, secondaryActions: [] }))), /* @__PURE__ */ e("footer", { className: "rounded-bl-xl border-0 border-r-[1px] border-t-[1px] border-solid border-f1-border-secondary bg-f1-background/30 backdrop-blur-2xl", children: /* @__PURE__ */ o("div", { className: "flex flex-1 justify-between p-2", children: [
    g,
    b
  ] }) });
}, Ls = ({
  ...
  const A = ie.useRef(null), $ = Y(
    ...
    return [X, J];
  }, [n, k, t]), Te = se.length, Ea = !z && (w || S), Oa = _ && _.length > 0, za = !y && (!z && Ea || Oa);
  return /* @__PURE__ */ o(
    "div",
    {
      className: h(
  ...
  function b(y) {
    ...
    $.forEach((k) => {
      ...
      if (se >= 0) {
        const B = x[se].subItems ?? [], Le = new Set(B.map((Te) => Te.subId)), at = [
          ...B,
          ...re.filter((Te) => !Le.has(Te.subId))
        ];
        N({
          ...G,
          subItems: at
...
}), Bs = Oe.forwardRef(({ className: t, variant: n, size: a, ...r }, l) => /* @__PURE__ */ e(
  Nn,
  {
    ref: l,
...
const na = Oe.createContext({
  size: "default",
  variant: "default"
}), aa = Oe.forwardRef(({ className: t, variant: n, size: a, children: r, ...l }, s) => /* @__PURE__ */ e(
  Bn,
  {
    ref: s,
...
const ra = Oe.forwardRef(({ className: t, children: n, variant: a, size: r, ...l }, s) => {
  const i = Oe.useContext(na);
  return /* @__PURE__ */ e(
    $n,
    {
      ref: s,
...
const ai = () => /* @__PURE__ */ o("div", { className: "flex flex-col justify-around gap-3 py-2", children: [
  ...
  return /* @__PURE__ */ o(
    "button",
    {
      ...
      children: [
        n,
        /* @__PURE__ */ e("div", { className: "relative h-5 w-5", children: /* @__PURE__ */ o(Se, { mode: "wait", children: [
          !a && /* @__PURE__ */ e(
            q.div,
            {
...
const wi = R(
  ...
  ({ ...t }, n) => /* @__PURE__ */ e("li", { ref: n, className: "flex items-start pt-1", children: /* @__PURE__ */ e(Ee, { ...t }) })
);
...
function Bi(t, n) {
  const { sidebarState: a, toggleSidebar: r } = Fe(), l = H(t);
  j(() => {
    n && Ri(
      t,
      l.current,
    ...
    El,
    {
      ...
      children: /* @__PURE__ */ o("div", { className: "scrollbar-macos grid h-screen grid-cols-1 grid-rows-[auto_minmax(0,1fr)]", children: [
        ...
        /* @__PURE__ */ e(Fn, { id: "ai-chat-group", children: /* @__PURE__ */ o("div", { className: "relative isolate flex h-full", children: [
          /* @__PURE__ */ e(Se, { children: s === "unlocked" && /* @__PURE__ */ e(
            q.nav,
            {
              className: h(
...
function ji({ label: t, options: n, hasNewUpdate: a }) {
  return /* @__PURE__ */ e(
    "div",
    {
      ...
      children: /* @__PURE__ */ e(Ie, { items: Mi(n), children: /* @__PURE__ */ o(
        "button",
        {
          className: h(
...
function td({
  ...
  return /* @__PURE__ */ o("div", { className: "flex flex-row items-center justify-between gap-1 p-3", children: [
    /* @__PURE__ */ e("div", { className: "min-w-0 flex-1", children: /* @__PURE__ */ e(Ie, { items: n, children: /* @__PURE__ */ o(
      "button",
      {
        className: h(
...
function Ui() {
  const { prevSidebarState: t, sidebarState: n, toggleSidebar: a, isSmallScreen: r } = Fe(), l = H(null);
  return j(() => {
    ...
    kn,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ e("div", { className: h("hidden", { flex: r }), children: /* @__PURE__ */ e(W, { icon: Ae, size: "md" }) })
      ]
    }
  );
}
...
function eo({
  ...
  const { sidebarState: l, isSmallScreen: s } = Fe(), i = Ye(), [c, d] = ct({ threshold: 1 }), [f, u] = ct({ threshold: 1 }), m = le(), p = {
    x: {
...
const lo = ({
  ...
  return /* @__PURE__ */ o("div", { className: "flex flex-col gap-3 pb-5 pl-4 pr-3 pt-3", children: [
    /* @__PURE__ */ o("div", { className: "flex flex-row items-start justify-between", children: [
      ...
      /* @__PURE__ */ e(Ee, { text: i, variant: to[a] })
    ] }),
  ...
  return /* @__PURE__ */ o(
    St,
    {
      ...
      children: [
        ...
        r && /* @__PURE__ */ e(fl, { children: /* @__PURE__ */ e(V, { variant: "neutral", size: "sm", ...r }) })
      ]
    }
  );
}), xo = ge({
  ...
  E(function({ chart: n, summaries: a, ...r }, l) {
    return /* @__PURE__ */ e(Ce, { ref: l, ...r, summaries: a, children: n && /* @__PURE__ */ e("div", { className: "min-h-52 min-w-52 grow pt-2", children: n }) });
  }),
  {
    Skeleton: Ce.Skeleton
  }
), yo = ee(
...
function kd({
  ...
  return /* @__PURE__ */ e("div", { className: "@container", children: /* @__PURE__ */ o("div", { className: "flex-grow flex-col", children: [
    ...
    /* @__PURE__ */ e("div", { className: "mt-6 flex flex-row flex-wrap items-center justify-center gap-2 @xs:justify-start", children: x ? /* @__PURE__ */ o(U, { children: [
      ...
      i && N && /* @__PURE__ */ e(U, { children: /* @__PURE__ */ e(ke, { text: N.name, icon: N.icon }) }),
      S && P,
...
), Oc = ["sm", "lg", "md", "md", "lg", "sm", "lg", "lg", "sm", "sm", "md", "md"], Ad = ee(mn, () => /* @__PURE__ */ e(En, { children: /* @__PURE__ */ e(mn, { children: Oc.map((t, n) => /* @__PURE__ */ e(Ce.Skeleton, { height: t }, n)) }) })), hn = ({ children: t }) => /* @__PURE__ */ e("div", { className: "flex min-h-40 flex-row items-stretch gap-4 text-f1-foreground @container [&>div]:min-w-[calc(100vw-64px)] @2xl:[&>div]:min-w-[calc(50vw-48px)]", children: t }), Fd = ee(

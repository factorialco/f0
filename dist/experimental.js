...
function gl({ breadcrumbs: t, append: n }) {
  const a = G(null), r = G(null), [, l] = jr(), [i, s] = _(null), c = (i?.collapsedItems || []).length > 0;
  return In(() => {
...
}, zn = j(xl), Pn = xt(null), vl = 15, wl = ({ children: t, enabled: n, onShow: a, ...r }) => {
...
const Vt = ({
  ...
  const F = se.useRef(null), B = q(
    ...
    (A) => {
      ...
      const Y = L ? A.index - 1 : A.index, X = n[Y], { selected: Z, partialSelected: de } = V(X);
      return /* @__PURE__ */ e(
        Pe,
        {
    ...
    (A) => {
      ...
      const Y = L ? A.index - 1 : A.index, X = le[Y].parent, Z = le[Y].subItem;
      if (!X) {
        const te = {
          id: Z.subId,
          name: Z.subName,
...
}, ze = (t, n) => t.find((a) => a.id === n), Jl = (t, n) => t.find((a) => a.value === n)?.groupType === "team", Xl = ({
  entity: t,
  onRemove: n,
  disabled: a = !1,
  deactivated: r = !1,
  ...
  return /* @__PURE__ */ e(
    Za,
    {
      ...
      append: I ?? /* @__PURE__ */ e(U, { children: /* @__PURE__ */ e(Ja, { open: R, disabled: r, size: z }) }),
      children: /* @__PURE__ */ e(
        "span",
        {
          role: "button",
...
const ai = ({
  ...
  const i = ie(), s = Kr(t, "createdAt"), c = Object.values(s).slice().flatMap((u) => u.map((m) => m.id)).slice(-l), d = ar((u) => {
    c.includes(u) && r?.();
  }, 1e3), f = ci(
...
const yi = () => /* @__PURE__ */ o("div", { className: "flex flex-col justify-around gap-3 py-2", children: [
  ...
  const I = ot(), z = ot(), R = G(null), [D, E] = _(null), [L, H] = _(!1), T = [f.views, f.comments].filter(Boolean).join(" · "), w = y && D?.id === t && D.description === i, k = !w, C = Ln(r), F = () => {
    s(t);
  }, B = (S) => {
    S.stopPropagation();
...
function _i({
  ...
  const i = r?.enabled ? hr : l?.enabled ? $l : Vr, s = r?.enabled ? r : l?.enabled ? l : void 0;
...
function zi({
  ...
  const { sidebarState: i, toggleSidebar: s, isSmallScreen: c, setForceFloat: d } = Se(), f = Ue(), {
    ...
    chatWidth: v,
    resizable: y
  } = pr(), I = m === "fullscreen", z = m === "canvas", { open: R } = qe(), D = y ? v : gr, E = G(I), L = I && !E.current, H = !I && E.current, [
    T,
    w
  ] = _(!1);
  $(() => {
...
const Hi = ({
  ...
  const { isDragging: s, setIsDragging: c } = It(), d = G(!1), f = Jr(), u = () => {
    c(!0), d.current = !0;
  }, m = () => {
    c(!1), setTimeout(() => {
      d.current = !1, i && l?.(i);
...
const ts = ({
  ...
  return /* @__PURE__ */ o("div", { className: "flex flex-col gap-3 pb-5 pl-4 pr-3 pt-3", children: [
    /* @__PURE__ */ o("div", { className: "flex flex-row items-start justify-between", children: [
      ...
      /* @__PURE__ */ e($e, { text: s, variant: Ji[a] })
    ] }),
  ...
  return /* @__PURE__ */ o(
    vt,
    {
      ...
      children: [
        n && /* @__PURE__ */ e(wt, { className: "-mr-1 -mt-1", children: /* @__PURE__ */ o("div", { className: "flex w-full flex-1 flex-col gap-4", children: [
          /* @__PURE__ */ o("div", { className: "flex flex-1 flex-row flex-nowrap items-center justify-between gap-2", children: [
            ...
            /* @__PURE__ */ o("div", { className: "flex flex-row items-center gap-3", children: [
              i && /* @__PURE__ */ e(kn, { text: i, level: "critical" }),
          ...
          n.comment && /* @__PURE__ */ o("div", { className: "flex flex-row items-center gap-3 overflow-visible", children: [
            /* @__PURE__ */ e(ds, { children: /* @__PURE__ */ e(Qr, { children: n.comment }) }),
        ...
        r && /* @__PURE__ */ e(tl, { children: /* @__PURE__ */ e(W, { variant: "neutral", size: "sm", ...r }) })
      ]
    }
  );
}), ms = ge({
...
Je.displayName = "VerticalOverflowList";
const uc = ({
  events: t,
  showAllItems: n,
  gap: a = 8,
...
function hc({
  ...
  return /* @__PURE__ */ o(
    $s,
    {
      ...
      withPointerCursor: i,
      children: [
        "alert" in c && c.alert && /* @__PURE__ */ e(Or, { type: c.alert }),
        "emoji" in c && c.emoji && /* @__PURE__ */ e(Dr, { emoji: c.emoji }),
        /* @__PURE__ */ o("div", { className: "flex-1", children: [
        ...
        /* @__PURE__ */ o("div", { className: "flex items-center gap-1", children: [
          ...
          r && /* @__PURE__ */ e("div", { className: "flex h-4 w-4 items-center text-f1-foreground-tertiary hover:cursor-help", children: /* @__PURE__ */ e(
            be,
            {
              ...
              children: /* @__PURE__ */ e(M, { icon: Cn, size: "sm" })
            }
          ) })
        ] }),
...
var Xs = Object.defineProperty, Qs = Object.defineProperties, eo = Object.getOwnPropertyDescriptors, Ve = Object.getOwnPropertySymbols, na = Object.prototype.hasOwnProperty, aa = Object.prototype.propertyIsEnumerable, an = (t, n, a) => n in t ? Xs(t, n, { enumerable: !0, configurable: !0, writable: !0, value: a }) : t[n] = a, oe = (t, n) => {
  for (var a in n || (n = {})) na.call(n, a) && an(t, a, n[a]);
  if (Ve) for (var a of Ve(n)) aa.call(n, a) && an(t, a, n[a]);
  return t;
}, Xe = (t, n) => Qs(t, eo(n)), to = (t, n) => {
  var a = {};
...
var xo = ({ stones: t, containerSize: n }) => {
  ...
  `, move: `
    ${t}ms top ease,
    ${t}ms left ease
  ` }), No = ({ transition: t, transitionDuration: n }) => t ? { transition: yo(n)[t] } : null, Co = (t) => t ? Xe(oe({}, t), { opacity: 1 }) : { opacity: 0, top: 0, left: 0 }, ko = ({ style: t, position: n, transition: a, transitionDuration: r }) => oe(oe(Xe(oe({}, t), { position: "absolute" }), Co(n)), No({ transition: a, transitionDuration: r }));
function So(t, n, a) {
  let r;
  return function(...l) {
...
var Io = () => {
  ...
  return e("div", Xe(oe({ ref: f, style: b }, c), { children: An.map(a, (v, y) => {
...
const Lo = { sm: 340, md: 480, lg: 640 }, rn = j(
  function({ children: n, widgetWidth: a = "sm" }, r) {
    const l = Lo[a], [i, s] = _(), c = An.toArray(n), d = G(null);
    return $(() => {
      const f = () => {
...
const kc = ne(
  ...
  const l = Mr(), i = window.location.pathname, s = q(() => n?.length ? n.includes(i) : a?.length ? !a.includes(i) : !0, [i, n, a]), c = q(() => {
...
export {
  ...
  Bc as Input,
  hd as Item,
  pd as ItemSectionHeader,
  gd as LineChart,
  ic as LineChartWidget,
  Jo as Menu,
  Rc as MobileDropdown,
  bd as NotesTextEditor,
  xd as NotesTextEditorPatchTargetNotFoundError,
  vd as NotesTextEditorSkeleton,
  ...
  Nd as OneDataCollection,
  Cd as OneDateNavigator,
  dl as OneEmptyState,
  kd as OnePagination,
  ...
  Nc as WidgetStrip,
  Dd as actionBarStatuses,
  Td as buttonToggleSizes,
  zd as buttonToggleVariants,
  qc as chipVariants,
  Pd as downloadAsCSV,
  Bd as generateCSVContent,
  Yc as getGranularityDefinition,
  Zc as getGranularityDefinitions,
  Jc as getGranularitySimpleDefinition,

...
import { C as Xr, P as Jr, g as On, c as Qr, F as ot, f as el, a as tl, A as nl, B as al, L as rl, b as ll, V as il, d as sl, e as Tt, h as ol, i as cl } from "./index-9Xff_7lW.js";
import { l as yd, m as Nd, j as Cd, n as kd, s as Sd, D as Id, k as Fd, o as Ad, v as Ld, w as Ed, N as _d, x as Od, p as Td, r as Dd, R as zd, q as Pd, u as Bd, t as Rd } from "./index-9Xff_7lW.js";
const dl = oa("Search", [
...
function wl({ children: t }) {
  const { currentPath: n } = ht(), [a, r] = _(!1), [l, i] = _(!1), s = a ? Re.xl : Re.md, c = rt(`(max-width: ${s}px)`, {
...
function zo({
  ...
  const { sidebarState: u, toggleSidebar: m } = ke(), h = [
    ...
    ...a
  ], p = n && Object.keys(n).length !== 0, g = l && a.length > 0, x = !l && r.length > 0, w = !l && !!s?.isVisible, A = h[h.length - 1], D = "navigation" in window ? window.navigation : null, B = l && (D ? !!D.canGoBack : window.history.length > 1);
  return /* @__PURE__ */ o(
    "div",
    {
      className: b(
          ...
          /* @__PURE__ */ o(
            "div",
            {
              ...
              children: [
                ...
                B || g ? /* @__PURE__ */ e("div", { className: "text-lg font-semibold text-f1-foreground", children: "loading" in A ? /* @__PURE__ */ e(E, { className: "h-4 w-24" }) : A.label }) : /* @__PURE__ */ e(
                  bl,
                  {
                    breadcrumbs: h,
...
function Vl({
  ...
  const { locale: l } = za(), i = Pa(l), s = Ba(n, "PPPp", { locale: i }), c = `${t.firstName} ${t.lastName}`;
  return /* @__PURE__ */ o(
    "button",
    {
      type: "button",
...
const jt = ({
  ...
  return /* @__PURE__ */ e(
    qa,
    {
      ...
      append: A ?? /* @__PURE__ */ e(U, { children: /* @__PURE__ */ e(Ya, { open: B, disabled: r, size: D }) }),
      children: /* @__PURE__ */ e(
        "span",
        {
          role: "button",
...
const ni = ({
  ...
  title: t,
  numItems: n
}) => /* @__PURE__ */ e(Vn, { title: t, children: Array.from({ length: n }).map((a, r) => /* @__PURE__ */ e(kt.Skeleton, {}, r)) }), Be = ee(ri, li), ii = 3, si = ["today", "yesterday", "lastWeek", "lastMonth"], oi = (t) => nr(t, ([n]) => {
...
const bi = ({
  ...
  const g = (O) => {
    h(O), c?.(O);
  }, x = Ue(), { canvasRef: w, handleMouseEnter: A, handleMouseLeave: D } = hi(x), B = pt({
    emoji: ui[d],
    size: "sm"
  });
  return /* @__PURE__ */ o(
...
const vi = H("Reactions", xi), wi = ({
  ...
  const w = [f.views, f.comments].filter(Boolean).join(" · "), A = !0, D = On(r), B = () => {
    s(t);
  }, O = (k) => {
    k.stopPropagation();
...
function Ei({
  ...
  const i = r?.enabled ? fr : l?.enabled ? Rl : Yr, s = r?.enabled ? r : l?.enabled ? l : void 0;
...
function Di({
  ...
  const { sidebarState: i, toggleSidebar: s, isSmallScreen: c, setForceFloat: d } = ke(), f = Ue(), {
    ...
    chatWidth: p,
    resizable: g
  } = mr(), x = m === "fullscreen", w = m === "canvas", { open: A } = qe(), D = g ? p : br, B = V(x), O = x && !B.current, L = !x && B.current, [
    k,
    X
  ] = _(!1);
  W(() => {
    !x && B.current && X(!0), B.current = x;
  }, [x]);
...
const Gi = ({
  ...
  const f = se(), { isDragging: u, setIsDragging: m, draggedItemId: h, setDraggedItemId: p } = St(), { isActive: g } = ht(), x = g(t.href, { exact: t.exactMatch }), w = V(!1), [A, D] = _(!1), B = l === 0, O = l === i - 1, L = i === 1, k = K(() => {
    const I = [];
    return !L && !B && I.push({
  ...
  return /* @__PURE__ */ o(
    gt,
    {
      ...
      children: [
        ...
        r && /* @__PURE__ */ e(Dr, { children: /* @__PURE__ */ e(R, { variant: "neutral", size: "sm", ...r }) })
      ]
    }
  );
}), fs = pe({

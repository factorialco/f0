...
const F4 = ({
  ...
  const i = Y(), [a, d] = P(!!o), l = I(o);
  X(() => {
    l.current && !o ? d(!1) : o && !a && d(!0), l.current = o;
  }, [o, a]);
  const u = o ? i.ai.thoughtsGroupTitle : n ?? i.ai.thoughtsGroupTitle, f = t ?? (e ?? []).map((h) => ({ title: h })), g = f.length - 1, m = (h) => !o || s ? "completed" : h === g ? "executing" : "completed";
  return /* @__PURE__ */ r(
    N4,
    {
      icon: tr,
      ...
      onOpenChange: d,
      lockOpen: o,
      children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pb-4", children: f.map((h, C) => /* @__PURE__ */ c("div", { className: "relative", children: [
        /* @__PURE__ */ r(
          u1,
          {
            title: h.title,
    ...
    return /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          D.thinking && ((D.thinking.items?.length ?? 0) > 0 || (D.thinking.titles?.length ?? 0) > 0) && /* @__PURE__ */ r(
            S4,
            {
              titles: D.thinking.titles,
              items: D.thinking.items,

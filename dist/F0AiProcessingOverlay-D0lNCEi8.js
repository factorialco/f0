...
import { useInsertionEffect as Rr, forwardRef as h, useRef as I, useEffect as q, useLayoutEffect as et, useState as B, useMemo as Q, useCallback as z, createContext as G1, useContext as B1, useId as tt, createElement as Fr, memo as Nr } from "react";
import { co as Vr, cp as Sr, Z as rt, cq as Hr, cr as Tr, cs as Ar, ct as $r, cu as Br, cv as ot, cw as Ir, cx as Pr, a6 as ie, cy as jr, aK as Dr, cz as Zr, cA as _r, cB as Ur, ah as Or, cC as zr, bS as Gr, aa as nt, ad as Wr, cD as qr, ba as ae, a1 as st, S as W1, cE as it, bf as Xr, cF as Yr, cG as Kr, b3 as Qr, bR as Jr, $ as F1, av as eo, bj as at, cH as to, bP as ro, cI as M1, bL as oo, cJ as no, cK as so, b2 as ct, cL as io, cM as ao, cN as co, cO as lo, cP as fo, cQ as lt, bD as uo, bE as ho, cR as Co, cS as go, cT as po, cU as mo, cV as vo, cW as wo, cX as xo, cY as ko, cZ as Lo, c_ as bo, c$ as yo, d0 as Mo, d1 as Eo, d2 as Ro, bQ as Fo, ab as No, bz as Vo, d3 as So, d4 as Ho, d5 as To, d6 as Ao, d7 as $o, d8 as Bo, d9 as Io, aq as Po, da as dt, M as jo, a0 as Do, db as ft, dc as ut, dd as Zo, bi as _o, bh as Uo, de as Oo, df as zo, dg as ht, dh as Go, b1 as Wo, az as qo, di as Xo, at as Yo, b8 as Ko, dj as Ct, b7 as Qo, dk as gt, bk as ce, dl as Jo, dm as en, dn as le, bN as tn, bM as rn, bO as pt, dp as on, G as nn, E as sn, dq as an, dr as cn, ds as ln, dt as dn, du as fn, dv as mt, dw as un, ac as hn, dx as Cn, L as u1, o as x, q as H1, bt as gn, u as G, dy as pn, U as p1, cl as vt, H as i1, v as h1, a2 as mn, Q as g1, dz as vn, ae as c1, aQ as x1, A as E1, p as J, aE as de, dA as wn, aF as fe, aG as ue, b as b1, dB as xn, dC as kn, bH as Ln, V as bn, b0 as yn, a5 as he, dD as Mn, dE as En, dF as Rn, dG as ye, a3 as Fn, al as wt, aT as xt, dH as Nn, c3 as Vn, dI as Sn, dJ as Hn, aY as kt, dK as Tn, bZ as An, dL as $n, aV as S1, dM as Bn, b9 as Lt, dN as bt, bb as yt, c as ne, dO as Mt, dP as In, dQ as Pn, bX as jn, bo as Dn, dR as Zn, be as Ce, bA as _n, dS as Un, dT as On, dU as zn, dV as Gn, dW as Wn, a8 as qn, af as Xn, y as Yn, z as Kn, dX as Et, dY as Rt, dZ as Qn, ak as Me, d_ as Jn, aj as es, d$ as ts, e0 as rs, d as os } from "./F0CanvasPanel-q36Yh3t_.js";
...
Ht.displayName = "ShoppingCart";
const N0 = (e, r) => /* @__PURE__ */ a(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
), C2 = h(h2), g2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: cs,
  Add: Vr,
  Ai: ds,
  ...
  Calculator: zr,
  Calendar: Gr,
  CalendarArrowDown: Bs,
  CalendarArrowLeft: Ps,
  CalendarArrowRight: Ds,
  CameraPlus: _s,
  CardPin: Os,
  ChartFunnel: Gs,
  ChartHorizontalBars: qs,
  ChartLine: Ys,
  ChartPie: Qs,
  ChartVerticalBars: ei,
  Check: nt,
  CheckCircle: Wr,
  CheckCircleLine: ri,
  CheckDouble: qr,
  ...
  Wifi: C2,
  Windows: Cn
}, Symbol.toStringTag, { value: "Module" })), p2 = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const $2 = H1({
  ...
  ({
    ...
    borderRight: a1,
    borderRadius: k1,
    borderRadiusTopLeft: l1,
    borderRadiusTopRight: n1,
    borderRadiusBottomLeft: d1,
    borderRadiusBottomRight: m1,
    borderStyle: k,
    // Overflow
    overflow: y,
    overflowX: L,
    ...
    const N1 = A && A !== "none" || o1 && o1 !== "none" || W && W !== "none" || a1 && a1 !== "none", P1 = X && X !== "none" || N1, j1 = { sm: q1, md: X1, lg: Y1, xl: I1 }, J1 = B2.map((D1) => {
      const Z1 = j1[D1];
      return Z1 ? A2(D1, Z1) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
      "div",
      {
        ...
        className: x(
          ...
          J1,
          P1 && !Y && "border-f1-border",
          S && !Z && "divide-f1-border",
          "scrollbar-macos"
        ),
        ...K1
      }
...
const te = gn(
  ...
  return f === "recording" ? /* @__PURE__ */ a("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    ...
    /* @__PURE__ */ t("div", { className: "flex items-center gap-2", children: e && /* @__PURE__ */ a(R1, { children: [
      /* @__PURE__ */ t(
        u1,
        {
  ...
  "div",
  {
    ...
    children: e.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ t(p1, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ t(
        j2,
        {
          att: s,
          onRemove: o,
...
function j2({
  ...
  const n = /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ t(i1, { icon: rt, size: "md", color: "critical" }),
  ...
  return e.errorMessage ? /* @__PURE__ */ t(mn, { label: e.errorMessage, children: n }) : n;
}
const D2 = {
  soft: {
    text: "",
    ...
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (f, g) => /* @__PURE__ */ a(
        "div",
        {
          ...
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ t(p1, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ t(
              p1,
              {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ t(c1, { className: "text-base font-medium text-f1-foreground", children: C }) })
            ]
          },
          String(f.id)
        );
...
const U2 = ({
  ...
  return /* @__PURE__ */ t("div", { className: "p-1", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ t(i1, { icon: pe, size: "md", color: "default" }) }),
        /* @__PURE__ */ t(
          c1,
          {
  ...
  const s = x1(), [i, c] = B(""), [d, l] = B(0), [u, f] = B(!1), g = I(null), p = I(null), C = I(null), m = e[d] ?? r;
  return q(() => {
    const v = () => {
    ...
    e.length,
    s
  ]), o.length > 0 || n ? null : /* @__PURE__ */ t(E1, { children: /* @__PURE__ */ t(
    J.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
const q2 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ a(
    de,
    {
      ...
      children: [
        /* @__PURE__ */ t(wn, { asChild: !0, children: /* @__PURE__ */ t("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ t(fe, { asChild: !0, children: /* @__PURE__ */ t(
          u1,
          {
            variant: "outline",
            label: d.label,
          ...
          ue,
          {
            ...
            children: [
              /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ t(i1, { icon: c.icon, size: "sm" }),
                /* @__PURE__ */ t("span", { children: c.label })
              ] }),
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: W2(c.items).map((d, l) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ t(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ t(i1, { icon: ie, size: "sm" })
                      }
                    )
                  ]
                },
...
function J2(e) {
  const [r, o] = B([]), [n, s] = B(null), i = I(
    null
  ), c = I(null), d = G(), l = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, g = Q(() => {
    if (u)
  ...
  const v = z(
    async (T) => {
      ...
      if (f !== void 0 && C.current + V.length > f) {
        m(
      ...
      const N = (H) => o(
        (D) => D.map(
          (E) => R.includes(E.id) ? { ...E, status: "error", errorMessage: H } : E
        )
      );
      try {
        const H = await l(V);
        if (!Array.isArray(H) || H.length !== V.length) {
          N(d.ai.fileUploadError);
          return;
        }
        o(
          (D) => D.map((E) => {
            const F = M.findIndex(($) => $.id === E.id);
            return F === -1 ? E : H[F] ? {
              ...E,
              status: "uploaded",
              uploadedFile: H[F]
        ...
        const D = H instanceof Error && H.message ? H.message : d.ai.fileUploadError;
        N(D);
      }
    },
    [
...
function nc({
  ...
  const [i, c] = B(!1), [d, l] = B(""), [u, f] = B([]), [g, p] = B(!1), [C, m] = B(0), [v, w] = B([]), b = I(-1), j = I(null), T = I(0), V = I(-1);
  q(() => {
    if (!n) {
      c(!1);
      return;
    ...
    const F = ec(e, o, v);
    if (!F) {
      c(!1), l(""), f([]), m(0), b.current = -1, V.current = -1;
      return;
    }
    if (F.atIndex === V.current)
      return;
    b.current = F.atIndex, l(F.query), c(!0), m(0), p(!0), j.current && clearTimeout(j.current);
    const $ = ++T.current;
    return j.current = setTimeout(() => {
      n(F.query).then((U) => {
        $ === T.current && (f(U), m(0), U.length === 0 && F.query.length > 0 && (V.current = F.atIndex, c(!1)));
      }).catch(() => {
        $ === T.current && f([]);
      }).finally(() => {
        $ === T.current && p(!1);
  ...
  const M = z(() => {
    ...
    (F) => {
      const $ = b.current;
      if ($ === -1) return;
      const U = `${F.firstName} ${F.lastName}`.trim(), _ = String(F.id), O = e.slice(0, $), t1 = e.slice(o), r1 = `@${U} `, Y = O + r1 + t1, X = O.length + r1.length;
      r(Y), w((A) => [...A.filter((W) => !(W.id === _ && W.name === U)), { id: _, name: U }]), M(), requestAnimationFrame(() => {
        const A = s.current;
        A && (A.focus(), A.setSelectionRange(X, X));
      });
    },
    [e, o, r, s, M]
  ), N = z(
    (F) => {
      if (!i) return !1;
      if (F.key === "Escape")
        return F.preventDefault(), M(), !0;
      if (u.length === 0) return !1;
      switch (F.key) {
        case "ArrowDown":
          return F.preventDefault(), m(($) => ($ + 1) % u.length), !0;
        case "ArrowUp":
        ...
        case "Tab": {
          ...
          if ($) {
            ...
            if (d.length === 0 || U.toLowerCase().startsWith(d.toLowerCase()))
              return F.preventDefault(), R($), !0;
          }
          return !1;
        }
        case "Enter":
          return F.preventDefault(), u[C] && R(u[C]), !0;
        default:
          return !1;
      }
    },
    ...
    (F) => {
      ...
      let $ = F;
      const U = [...v].sort((_, O) => O.name.length - _.name.length);
      for (const _ of U) {
        const O = `@${_.name}`, t1 = `<entity-ref type="person" id="${Ee(_.id)}">${Ee(_.name)}</entity-ref>`;
        for (; $.includes(O); )
          $ = $.replace(O, t1);
      }
      return $;
  ...
  q(() => {
    w(
      (F) => F.filter(($) => {
        const U = `@${$.name}`, _ = e.indexOf(U);
        if (_ === -1) return !1;
        const O = e[_ + U.length];
        return O === " " || O === `
` || O === "	";
      })
    );
  ...
  const D = Q(() => {
    ...
    const F = s.current;
    if (!F) return null;
    const $ = rc(F, b.current), U = F.offsetLeft + $.left, O = (F.offsetParent ? F.offsetParent.offsetHeight : 0) - (F.offsetTop + $.top);
    return { left: U, bottom: O };
  }, [i, e, o, s]), E = Q(() => {
...
const sc = /[\\`*_{}[\]()#+\-.!|~>]/g, ic = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(sc, "\\$&")).join(""), B6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const N = G(), H = x1(), [D, E] = B(M ?? ""), [F, $] = B(0), [U, _] = B(!1), [O, t1] = B(!1), [r1, Y] = B(null), X = I(null), A = I(null), o1 = I(null), W = c != null, { tracking: a1 } = b1(), k1 = z(
    (K, w1) => {
      a1?.onWelcomeSuggestionClick?.({
        item: K,
        group: w1,
    ...
    const w1 = y1.current, ee = w1 && !/\s$/.test(w1) ? " " : "", U1 = `${w1}${ee}${K}`;
    E(U1), $(U1.length);
  }, []), A1 = {
    ...
    onPartial: V1,
    onFinal: (K) => {
      V1(K), A.current?.focus();
    },
    onError: (K) => f1(A1[K])
  }), q1 = !!p && v1.isSupported, X1 = z(() => {
    a1?.onDictationStart?.(), y1.current = D, v1.start();
  }, [D, v1, a1]), Y1 = z(() => {
    a1?.onDictationCancel?.(), v1.cancel();
  }, [v1, a1]);
  q(() => {
    typeof window < "u" && window.location.hash.length === 0 && A.current?.focus();
  }, []), q(() => {
    if (m)
      return m((K) => {
        L(K);
  ...
  const I1 = v1.status === "recording", K1 = I1 ? N.ai.listening : N.ai.inputPlaceholder, Q1 = l1.filter((K) => K.status === "uploaded"), N1 = l1.some((K) => K.status === "uploading"), P1 = l1.some((K) => K.status === "error"), j1 = D.trim().length > 0;
  q(() => {
    if (!(!O || N1)) {
      if (t1(!1), P1) {
        f1(N.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const J1 = async (K) => {
    if (K.preventDefault(), !W) {
      if (e1.close(), o)
        ...
        const w1 = e1.transformMentions(D.trim()), ee = ic(w1), U1 = Q1.flatMap(
    ...
    W || e1.handleKeyDown(K) || K.key === "Enter" && !K.shiftKey && (K.preventDefault(), o || X.current?.requestSubmit());
  }, Z1 = () => {
    $(A.current?.selectionStart ?? 0);
  }, Lr = () => {
    o1.current && A.current && (o1.current.scrollTop = A.current.scrollTop);
  }, ve = r1 ? r1.prompt ?? r1.title : null, we = I1 ? [N.ai.listening] : ve ? [ve] : s ?? [], br = we.length > 1, yr = Q(() => X2(D, e1.mentions, {
    cursorPosition: F,
    inlineCompletion: e1.inlineCompletion
  }), [D, e1.mentions, F, e1.inlineCompletion]), Mr = e1.mentions.length > 0 || e1.inlineCompletion !== null, _1 = b && !!T && T.length > 0 && !!V ? /* @__PURE__ */ t(
    q2,
    {
      suggestions: T,
      onItemClick: k1,
    ...
    J.div,
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          _1 && !j && /* @__PURE__ */ t("div", { children: _1 }),
              ...
              children: [
                /* @__PURE__ */ t(
                  _2,
                  {
                    isOpen: e1.isOpen,
                    results: e1.results,
                    isLoading: e1.isLoading,
                    selectedIndex: e1.selectedIndex,
                    position: e1.popoverPosition,
                    onSelect: e1.selectPerson
                  }
                ),
                /* @__PURE__ */ t(E1, { initial: !1, children: W ? /* @__PURE__ */ t(
                  J.div,
                  {
                  ...
                  J.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ t(E1, { initial: !1, children: s1 && /* @__PURE__ */ t(
                        J.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ a(
                            "div",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ t("p", { className: "font-medium text-f1-foreground-critical", children: s1 })
                              ]
                            }
                          )
                        },
                      ...
                      /* @__PURE__ */ t(
                        z2,
                        {
                          ...
                          onCursorUpdate: Z1,
                          onScroll: Lr,
                          highlightSegments: yr,
                          hasOverlay: Mr,
                          multiplePlaceholders: br,
                          placeholders: we,
                          resolvedDefaultPlaceholder: K1,
                          inProgress: o
                        }
                      ),
                      /* @__PURE__ */ t(
                        I2,
                        {
                          ...
                          isPreSending: U || O,
                          canRecord: q1,
                          recordingStatus: v1.status,
                          recordingStream: v1.stream,
                          onStartRecording: X1,
                          onStopRecording: v1.stop,
                          onCancelRecording: Y1
                        }
                      )
                    ]
                  },
        ...
        _1 && j && /* @__PURE__ */ t("div", { className: "w-full max-w-content", children: _1 }),
        w && b && j && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: w }),
        /* @__PURE__ */ t(E1, { mode: "wait", initial: !1, children: W ? /* @__PURE__ */ a(
          J.div,
          {
          ...
          J.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ t(c1, { className: "text-sm font-medium text-f1-foreground-tertiary", children: v.text }),
...
function uc({
  ...
  return /* @__PURE__ */ t(yn, { ...r, variant: "link", href: r.href, children: e });
}
function hc({
  children: e,
  ...r
...
function T1({
  ...
  return /* @__PURE__ */ a(
    Mn,
    {
      ...
      children: [
        /* @__PURE__ */ t(En, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          Rn,
          {
            side: "top",
...
function Ec({
  ...
  const { entityRefs: o } = b1(), n = o?.resolvers?.candidate, s = G(), i = o?.urls?.candidate?.(e), c = Q(
    () => (l) => {
      const u = [];
...
function Rc({ id: e, label: r }) {
  const { entityRefs: o } = b1(), n = o?.resolvers?.expense, s = G(), i = o?.urls?.expense?.(e), c = Q(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: Vt
...
function Fc({
  ...
  const { entityRefs: o } = b1(), n = o?.resolvers?.jobPosting, s = G(), i = o?.urls?.jobPosting?.(e), c = Q(
    () => (l) => ({
      title: l.title,
...
function Vc({
  ...
  const { entityRefs: o } = b1(), n = o?.resolvers?.requisition, s = G(), i = o?.urls?.requisition?.(e), c = Q(
    () => (l) => {
...
function Sc({ id: e, label: r }) {
  const { entityRefs: o } = b1(), n = o?.resolvers?.person, s = G(), i = o?.urls?.person?.(e), c = Q(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
function Hc({ id: e, label: r }) {
  const { entityRefs: o } = b1(), n = o?.resolvers?.vacancy, s = G(), i = o?.urls?.vacancy?.(e), c = Q(
    () => (l) => ({
      title: l.name,
...
function se(e) {
  return typeof e == "string" ? e : typeof e == "number" ? String(e) : Array.isArray(e) ? e.map(se).join("") : e && typeof e == "object" && "props" in e ? se(e.props.children) : "";
}
function $c({
  type: e,
  id: r,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ t(xt, { module: e.module, size: "md" }),
          e?.type === "file" && /* @__PURE__ */ t(Nn, { file: e.file, size: "lg" }),
          /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ t(c1, { className: "text-lg font-semibold text-f1-foreground", children: r }),
            o && /* @__PURE__ */ t(c1, { className: "text-base text-f1-foreground-secondary", children: o })
          ] }),
...
const Re = 7, Ic = 625, Fe = /* @__PURE__ */ new Set();
function Pc(e) {
...
function Dc(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = Sn(e), i = [];
...
function nr(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: Dc(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? Pc(o) : "") || "—" };
  }
  ...
  return { type: "item", text: jc(String(e)) };
}
function sr({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: l, openCanvas: u, closeCanvas: f } = b1(), g = Bc(e), p = d ?? g, C = I(() => {
  ...
  C.current = b, q(() => {
    typeof window > "u" || window.innerWidth < Ic || Fe.has(e) || (Fe.add(e), C.current());
  }, [e]);
  const j = i && c ? Object.entries(i).map(([M, R]) => {
    const N = c[M], H = p?.(M, N, {
      fieldType: R.fieldType,
      customFieldName: R.customFieldName
    });
    if (!H && R.fieldType === "custom" && typeof N == "object" && N !== null)
      return null;
    const D = H ?? nr(N, R.fieldType), E = ["richtext", "textarea"];
    return {
      label: R.label,
      content: D,
      verticalLayout: E.includes(R.fieldType ?? "")
    };
  }).filter((M) => {
    if (!M) return !1;
    const R = Array.isArray(M.content) ? M.content[0] : M.content;
    return !(R?.type === "item" && R.text === "—");
  }) : [], T = j.slice(0, Re), V = j.length > Re;
  return /* @__PURE__ */ t(
    or,
    {
      ...
      children: T.length > 0 && !w && /* @__PURE__ */ t("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ t(
        Vn,
        {
          details: T.map((M) => ({
            title: M.label,
...
const He = 8, $1 = 8;
function ar({ anchor: e, onReply: r }) {
  const o = G(), n = I(null), [s, i] = B(
    null
  );
  if (et(() => {
    if (!e) {
    ...
    p < $1 && (p = e.rect.bottom + He), p = Math.min(
      Math.max(p, $1),
      g - u - $1
    );
...
const cr = G1(void 0), D6 = () => B1(cr), Oc = (e) => /* @__PURE__ */ t(kt, { content: e, format: "markdown" }), zc = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", l = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !l, g = I(null), { anchor: p, clear: C } = ir({
    containerRef: g,
    enabled: !!(o?.id && d)
  });
  return q(() => {
    o?.id && !r && !e && i?.(o);
  }, [o, r, e, i]), !r && !e && f ? null : /* @__PURE__ */ t(cr.Provider, { value: u, children: /* @__PURE__ */ a("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ t(
      "div",
      {
        ref: g,
  ...
  const [s, i] = B(""), c = G(), { title: d, label: l, placeholder: u } = o === "like" ? c.ai.feedbackModal.positive : c.ai.feedbackModal.negative, f = z(() => {
    r(n, s);
  }, [s, n, r]), g = () => {
    e(n);
  };
  ...
  return /* @__PURE__ */ t(lr.Provider, { value: n, children: e });
}, dr = () => {
  const e = B1(lr);
  if (e === null)
    throw new Error(
...
const Xc = ({
  ...
  const s = G(), { open: i } = dr(), [c, d] = B(null);
    ...
    /* @__PURE__ */ t(
      S1,
      {
        ...
        children: /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center justify-center gap-1", children: /* @__PURE__ */ t(
          ...
          {
            size: "md",
            icon: c === "dislike" ? At : Tt,
            color: "default"
          }
        ) })
      }
    ),
    n && /* @__PURE__ */ t(Bn, { description: s.actions.rewind, instant: !0, children: /* @__PURE__ */ t(
      S1,
      {
        onClick: (l) => {
        ...
        children: /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center justify-center gap-1", children: /* @__PURE__ */ t(i1, { size: "md", icon: gt, color: "default" }) })
      }
    ) })
  ] });
  ...
  const [d, l] = B(s), u = x1(), f = n !== void 0, g = f ? n : d;
  return /* @__PURE__ */ a(
    Lt,
    {
        ...
        /* @__PURE__ */ a(
          bt,
          {
            ...
            children: [
              ...
              !c && /* @__PURE__ */ t(i1, { icon: W1 })
            ]
          }
        ),
        /* @__PURE__ */ t(yt, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ t(
          J.div,
          {
            initial: !1,
            animate: {
...
const fr = (e) => /* @__PURE__ */ t(kt, { content: e, format: "markdown" }), e4 = ({
  text: e,
  renderMarkdown: r
}) => /* @__PURE__ */ a("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ t("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ t(i1, { icon: pe }) }),
  ...
  const c = e.rawData, d = Jc(
    e?.content,
    c
  ), l = (Qc(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = l.length > 0, { anchor: g, clear: p } = ir({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(e4, { text: u, renderMarkdown: n }),
...
}, r4 = 35, o4 = 22, n4 = 400, s4 = 2500, i4 = 220, a4 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  ...
  q(() => {
    ...
    let p;
    if (d === "starting")
      p = setTimeout(() => l("writing"), n4);
    else if (d === "writing")
      i < u.length ? p = setTimeout(() => c((C) => C + 1), r4) : l("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => l("erasing"), s4);
    } else d === "erasing" && (i > 0 ? p = setTimeout(() => c((C) => C - 1), o4) : p = setTimeout(() => {
...
const l4 = {
...
}, Z6 = (e) => /* @__PURE__ */ t(Wc, { children: /* @__PURE__ */ t(d4, { ...e }) }), d4 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: T, handleSubmit: V, handleClose: M } = qc(
    f ?? l4
  ), R = G(), N = v ?? zc, H = w ?? t4, D = Q(() => {
    const A = n ?? R.ai.defaultInitialMessage;
    return (Array.isArray(A) ? A : [A]).filter((W) => typeof W == "string" && W.length > 0);
  }, [n, R.ai.defaultInitialMessage]), E = !r && e.length === 0 && D.length > 0, F = I(null), $ = I(null), U = I(null), _ = I(null), O = I(null), { showScrollBtn: t1, turnMinHeight: r1, scrollToBottom: Y } = c4({
    viewportRef: F,
    contentRef: $,
    endRef: U,
    lastTurnRef: O,
    ...
    const W = o1 === e.length - 1, a1 = {
      ...
      const m1 = W && d1 === A.assistantMessages.length - 1, k = A.userMessages.length + d1, y = {
        message: n1,
        inProgress: A.isInProgress,
        index: k,
        isCurrentMessage: m1,
      ...
      return /* @__PURE__ */ t(
        ...
        {
          ...y,
          isGenerating: A.isInProgress && m1,
          isLoading: A.isInProgress && m1 && !n1.content
        },
        `${o1}-a-${d1}`
      );
    };
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        style: {
          minHeight: W && r1 || void 0
        },
        children: [
          A.userMessages.map(
            (n1, d1) => k1(n1, d1)
          ),
          A.thinking && A.thinking.titles.length > 0 && /* @__PURE__ */ t(
            Kc,
            {
              titles: A.thinking.titles,
              title: R.ai.thoughtsGroupTitle,
              inProgress: A.thinking.inProgress,
              isWriting: A.thinking.isWriting
            }
          ),
          A.assistantMessages.map(
            (n1, d1) => l1(n1, d1)
          ),
          A.endIndicator === "thinking" && /* @__PURE__ */ t(ne, { title: R.ai.thinking, status: "executing" }),
          A.endIndicator === "activity" && /* @__PURE__ */ t(ne, { status: "writing" }),
          !A.feedback && !A.onUndo ? null : /* @__PURE__ */ t(
            Xc,
            {
              content: A.feedback?.content ?? "",
              targetMessage: A.feedback?.targetMessage ?? {},
              onCopy: A.feedback ? j : void 0,
              onUndo: A.onUndo
            }
          ),
          W && /* @__PURE__ */ t(Zc, {})
          ...
          children: /* @__PURE__ */ a(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ t("div", { ref: _, className: "h-px shrink-0", "aria-hidden": !0 }),
                /* @__PURE__ */ t("footer", { className: "copilotKitMessagesFooter", ref: U, children: m }),
                /* @__PURE__ */ t(E1, { children: t1 && /* @__PURE__ */ t(
                  J.div,
                  {
...
}, f4 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ t("div", { className: "flex justify-end", children: /* @__PURE__ */ t(p1, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ t(p1, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ t(p1, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ t(p1, { className: "h-5 w-4/5 rounded-md" })
] }) }), _6 = {
  ai: ns.ai
}, ur = G1(null);
function U6({
  ...
  return /* @__PURE__ */ t(ur.Provider, { value: r, children: e });
}
function O6() {
  const e = B1(ur);
  if (e === null)
...
const h4 = ({
  ...
  const p = G().ai.clarifyingQuestion.typeYourAnswer, C = e === "single" ? /* @__PURE__ */ t(hr, { isSelected: o && !r }) : /* @__PURE__ */ t(
    Mt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const g4 = ({
  ...
  const b = x1(), j = (() => {
    ...
    const N = o.findIndex((H) => n.includes(H.id));
    return N >= 0 ? N : 0;
  })(), [T, V] = B(j), M = I([]);
  q(() => {
    g && e === "single" && M.current[T]?.focus();
  }, []);
  const R = (N) => {
    if (e !== "single") return;
    const H = o.length - 1;
    ...
    N.preventDefault(), V(D), M.current[D]?.focus();
  };
  return /* @__PURE__ */ a(
    "div",
    {
  ...
  } = s, N = I(null), H = j ?? "single", D = c > 1, E = i === 0, F = i === c - 1, $ = D ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(c)
  }) : void 0, U = b.length > 0, _ = (M ?? "").trim().length > 0, O = U || R && _ || T === !0, t1 = r === !0 && F, r1 = () => {
    t1 || l();
  }, Y = () => {
    t1 || u();
  }, X = (l1) => {
    const n1 = H === "single" && b.includes(l1);
    d(l1), H === "single" && !F && !n1 && Promise.resolve().then(l);
  }, A = F ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, o1 = T === !0 && !U && !(R && _), W = () => {
    m(), requestAnimationFrame(() => {
      N.current?.focus();
    });
  }, a1 = (l1) => {
    l1.key === "Escape" && (l1.preventDefault(), f());
  }, k1 = n ? 0 : v4 / 2;
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: a1, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(E1, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      J.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: k1, ease: m4 },
        children: [
          /* @__PURE__ */ t(
            p4,
            {
...
function Ae(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), l = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (W) => W / e * 2 - 1, g = (W) => W / r * 2 - 1, p = 0, C = e, m = 0, v = r, w = l, b = e - l, j = u, T = r - u, V = f(p), M = f(C), R = g(m), N = g(v), H = f(w), D = f(b), E = g(j), F = g(T), $ = 0, U = 0, _ = 1, O = 1, t1 = l / e, r1 = 1 - l / e, Y = u / r, X = 1 - u / r, A = new Float32Array([
    // Top strip
    V,
    R,
    M,
...
class W6 {
  ...
  setupGL() {
    ...
    const p = r.getUniformLocation(o, "uResolution"), C = r.getUniformLocation(o, "uTime"), m = r.getUniformLocation(o, "uBorderWidth"), v = r.getUniformLocation(o, "uGlowWidth"), w = r.getUniformLocation(o, "uBorderRadius"), b = r.getUniformLocation(o, "uColors"), j = r.getUniformLocation(o, "uGlowExponent"), T = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(m, this.options.borderWidth), r.uniform1f(v, this.options.glowWidth), r.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(j, 2), r.uniform1f(T, 1.8)) : (r.uniform1f(j, 1), r.uniform1f(T, 1));
    const V = (this.options.colors || b4).map(y4);
...
const Be = ["lowp", "mediump", "highp"], M4 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, E4 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, Pe = "iTime", je = "iTimeDelta", De = "iDate", Ze = "iFrame", _e = "iMouse", Ue = "iResolution", R4 = "iChannel", Oe = "iChannelResolution", ze = "iDeviceOrientation";
function F4(e, r) {
...
}, re = 9729, Ge = 9728, T4 = 9987, We = 33071, qe = 10497;
class A4 {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    const g = 0, p = o.RGBA, C = 1, m = 1, v = 0, w = o.RGBA, b = o.UNSIGNED_BYTE, j = new Uint8Array([255, 255, 255, 0]), T = o.createTexture();
    ...
    async function V() {
      return new Promise((N, H) => {
        ...
        D.crossOrigin = "anonymous", D.onload = () => {
          ...
          H(new Error(L1(`failed loading url: ${n}`)));
        }, D.src = n ?? "";
      });
    }
    let M = await V(), R = (M.width & M.width - 1) === 0 && (M.height & M.height - 1) === 0;
    return (r.wrapS !== We || r.wrapT !== We || r.minFilter !== Ge && r.minFilter !== re) && !R && (M = this.makePowerOf2(M), R = !0), o.bindTexture(o.TEXTURE_2D, T), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, l), o.texImage2D(
      o.TEXTURE_2D,
      g,
      p,
      w,
      b,
      M
    ), R && r.minFilter !== Ge && r.minFilter !== re && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || qe
    ), o.texParameteri(
      ...
      this.magFilter || re
    ), this._webglTexture = T, this.source = M, this.isVideo = !1, this.isLoaded = !0, this.width = M.width || 0, this.height = M.height || 0, this;
  };
}
const L1 = (e) => `react-shaders: ${e}`, Xe = (e) => {
  if ("changedTouches" in e) {
    const r = e.changedTouches[0];
    return [r?.clientX ?? 0, r?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, Ye = (e, r, o) => e * (1 - o) + r * o, $4 = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function B4({
  fs: e,
  vs: r = Ie,
  textures: o = [],
  ...
  const C = I(null), m = I(null), v = I(null), w = I(null), b = I(void 0), j = I(void 0), T = I(!1), V = I(void 0), M = I(0), R = I([0, 0]), N = I([]), H = I(0), D = I(void 0), E = I({
    ...
    [Ue]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    ...
    const L = "width" in k ? k.width ?? 0 : 0, P = "height" in k ? k.height ?? 0 : 0, S = E.current.iChannelResolution;
    if (!S) return;
    const Z = Array.isArray(S.value) ? S.value : S.value = [];
    Z[y * 3] = L * u, Z[y * 3 + 1] = P * u, Z[y * 3 + 2] = 0;
  }, U = () => {
    ...
    const [y = 0, L = 0] = Xe(k), P = y - (V.current?.left ?? 0) - window.pageXOffset, S = (V.current?.height ?? 0) - L - (V.current?.top ?? 0) - window.pageYOffset;
    T.current = !0;
    const Z = Array.isArray(E.current.iMouse?.value) ? E.current.iMouse.value : void 0;
    Z && (Z[2] = P, Z[3] = S), R.current[0] = P, R.current[1] = S;
  }, r1 = (k) => {
    V.current = C.current?.getBoundingClientRect();
    const [y = 0, L = 0] = Xe(k), P = y - (V.current?.left ?? 0), S = (V.current?.height ?? 0) - L - (V.current?.top ?? 0);
    if (l !== 1)
      R.current[0] = P, R.current[1] = S;
    else {
      const Z = Array.isArray(E.current.iMouse?.value) ? E.current.iMouse.value : void 0;
      Z && (Z[0] = P, Z[1] = S);
    }
  }, Y = () => {
    const k = Array.isArray(E.current.iMouse?.value) ? E.current.iMouse.value : void 0;
    k && (k[2] = 0, k[3] = 0);
  }, X = () => {
    const k = m.current;
    if (!k) return;
    ...
    const y = u, L = Math.floor(
      ...
      (V.current?.height ?? 1) * y
    );
    if (k.canvas.width = L, k.canvas.height = P, E.current.iResolution?.isNeeded && w.current) {
      const S = k.getUniformLocation(
        w.current,
        Ue
      );
      k.uniform2fv(S, [k.canvas.width, k.canvas.height]);
    }
  }, A = (k, y) => {
    const L = m.current;
    if (!L) return null;
    ...
    if (L.shaderSource(P, y), L.compileShader(P), !L.getShaderParameter(P, L.COMPILE_STATUS)) {
      p?.(L1(`Error compiling the shader:
${y}`));
      const S = L.getShaderInfoLog(P);
      L.deleteShader(P), g?.(L1(`Shader compiler log: ${S}`));
    }
    return P;
  }, o1 = (k, y) => {
    const L = m.current;
    if (!L) return;
    const P = A(L.FRAGMENT_SHADER, k), S = A(L.VERTEX_SHADER, y);
    if (w.current = L.createProgram(), !(!w.current || !S || !P)) {
      if (L.attachShader(w.current, S), L.attachShader(w.current, P), L.linkProgram(w.current), !L.getProgramParameter(w.current, L.LINK_STATUS)) {
        g?.(
          L1(
    ...
    if (n)
      for (const k of Object.keys(n)) {
        const y = n[k];
        if (!y) continue;
        const { value: L, type: P } = y, S = H4(P);
        if (!S) continue;
        const Z = {};
        if (F4(P, L)) {
          const s1 = P.length, f1 = Number.parseInt(P.charAt(s1 - 3)), e1 = Math.floor(L.length / (f1 * f1));
          L.length > f1 * f1 && (Z.arraySize = `[${e1}]`);
        } else N4(P, L) && (Z.arraySize = `[${Math.floor(L.length / Number.parseInt(P.charAt(0)))}]`);
        E.current[k] = {
          type: S,
          isNeeded: !1,
          value: L,
      ...
      if (o && o.length > 0) {
        ...
        const y = o.map(
          (L, P) => (E.current[`${R4}${P}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, $(L, P), N.current[P] = new A4(k), N.current[P]?.load(L).then((S) => {
            $(S, P);
          }))
        );
        Promise.all(y).then(() => {
...
`).concat(k.replace(/texture\(/g, "texture2D("));
    for (const Z of Object.keys(E.current))
      if (k.includes(Z)) {
        const s1 = E.current[Z];
        if (!s1) continue;
        P = $4(
          P,
          `uniform ${s1.type} ${Z}${s1.arraySize || ""}; 
`,
          P.lastIndexOf(L) + L.length
        ), s1.isNeeded = !0;
      }
    return k.includes("mainImage") && (P = P.concat(M4)), P;
  }, l1 = (k) => {
    const y = m.current;
    if (!y || !w.current) return;
    const L = H.current ? (k - H.current) / 1e3 : 0;
    H.current = k;
    const P = F.current;
    if (P)
      for (const S of Object.keys(P)) {
        const Z = P[S];
        if (Z && E.current[S]?.isNeeded) {
          if (!w.current) return;
          const s1 = y.getUniformLocation(
            w.current,
            S
          );
          if (!s1) return;
    ...
    if (E.current.iMouse?.isNeeded) {
      ...
      y.uniform4fv(S, E.current.iMouse.value);
    }
    ...
    if (E.current.iDate?.isNeeded) {
      const S = /* @__PURE__ */ new Date(), Z = S.getMonth() + 1, s1 = S.getDate(), f1 = S.getFullYear(), e1 = S.getHours() * 60 * 60 + S.getMinutes() * 60 + S.getSeconds() + S.getMilliseconds() * 1e-3, y1 = y.getUniformLocation(
        w.current,
        De
      );
      y.uniform4fv(y1, [f1, Z, s1, e1]);
    }
    if (E.current.iFrame?.isNeeded) {
      const S = y.getUniformLocation(
        w.current,
        Ze
      ), Z = E.current.iFrame.value;
      y.uniform1i(S, Z), E.current.iFrame.value = Z + 1;
    }
    if (N.current.length > 0)
      for (let S = 0; S < N.current.length; S++) {
        const Z = N.current[S];
        if (!Z) return;
        const { isVideo: s1, _webglTexture: f1, source: e1, flipY: y1, isLoaded: V1 } = Z;
        if (!V1 || !f1 || !e1) return;
        if (E.current[`iChannel${S}`]?.isNeeded) {
          if (!w.current) return;
          const A1 = y.getUniformLocation(
            w.current,
            `iChannel${S}`
          );
          y.activeTexture(y.TEXTURE0 + S), y.bindTexture(y.TEXTURE_2D, f1), y.uniform1i(A1, S), s1 && Z.updateTexture(
            f1,
            e1,
            y1
          );
    ...
    y.viewport(0, 0, y.drawingBufferWidth, y.drawingBufferHeight), y.clear(y.COLOR_BUFFER_BIT | y.DEPTH_BUFFER_BIT), y.bindBuffer(y.ARRAY_BUFFER, v.current), y.vertexAttribPointer(
      ...
      0,
      0
    ), l1(k), y.drawArrays(y.TRIANGLE_STRIP, 0, 4);
    const L = E.current.iMouse?.value;
    if (E.current.iMouse?.isNeeded && l !== 1 && Array.isArray(L)) {
      const P = L[0] ?? 0, S = L[1] ?? 0;
      L[0] = Ye(P, R.current[0] ?? 0, l), L[1] = Ye(S, R.current[1] ?? 0, l);
    }
    j.current = requestAnimationFrame(n1);
  }, d1 = () => {
    const k = { passive: !0 };
    E.current.iMouse?.isNeeded && C.current && (C.current.addEventListener("mousemove", r1, k), C.current.addEventListener("mouseout", Y, k), C.current.addEventListener("mouseup", Y, k), C.current.addEventListener("mousedown", t1, k), C.current.addEventListener("touchmove", r1, k), C.current.addEventListener("touchend", Y, k), C.current.addEventListener("touchstart", t1, k)), E.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      O,
      k
    ), C.current && (D.current = new ResizeObserver(X), D.current.observe(C.current), window.addEventListener("resize", X, k));
  }, m1 = () => {
    const k = { passive: !0 };
    E.current.iMouse?.isNeeded && C.current && (C.current.removeEventListener("mousemove", r1, k), C.current.removeEventListener("mouseout", Y, k), C.current.removeEventListener("mouseup", Y, k), C.current.removeEventListener("mousedown", t1, k), C.current.removeEventListener("touchmove", r1, k), C.current.removeEventListener("touchend", Y, k), C.current.removeEventListener("touchstart", t1, k)), E.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      O,
      k
    ), D.current && (D.current.disconnect(), window.removeEventListener("resize", X, k));
  };
  return q(() => {
    F.current = n;
  }, [n]), q(() => {
    ...
    function y() {
      U();
      const L = m.current;
      L && C.current && (L.clearColor(...s), L.clearDepth(1), L.enable(L.DEPTH_TEST), L.depthFunc(L.LEQUAL), L.viewport(0, 0, C.current.width, C.current.height), C.current.height = C.current.clientHeight, C.current.width = C.current.clientWidth, W(), a1(), o1(k1(e || E4), r || Ie), _(), requestAnimationFrame(n1), d1(), X());
    }
    return requestAnimationFrame(y), () => {
      ...
      m1(), cancelAnimationFrame(j.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
}`, P4 = 10, j4 = 2, D4 = 0.5, Z4 = 0.2, _4 = 1.5, C1 = {
  duration: 0.5,
  ease: "easeOut"
}, Ke = {
  duration: 0.35,
...
function U4(e, r) {
  const [o, n] = B(P4), {
    ...
    animate: i,
    motionValue: c
  } = O1(Z4), { value: d, animate: l } = O1(j4), { value: u, animate: f } = O1(D4), { value: g, animate: p } = O1(_4), C = ss(r, {
    fftSize: 512,
  ...
  return q(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, C1), l(1.2, C1), f(0.4, C1), p(1, C1);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, C1), f(0.7, C1), p([1.5, 2], Ke);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, C1), l(0.5, C1), f(1, C1), p([0.5, 2.5], Ke);
        return;
      case "speaking":
        n(70), i(0.3, C1), l(0.75, C1), f(1.25, C1), p(1.5, C1);
        return;
    }
  }, [
    e,
...
function q6({
  ...
  const { speed: u, scale: f, amplitude: g, frequency: p, brightness: C } = U4(r, s);
  return /* @__PURE__ */ t(
    gr,
    {
      ref: d,
...
const X6 = ({
  ...
  const n = G(), s = x1();
  return /* @__PURE__ */ a(R1, { children: [
    e && /* @__PURE__ */ t("span", { className: x(W4(), "truncate"), children: e }),
    /* @__PURE__ */ t(E1, { children: o && r && /* @__PURE__ */ t(
      J.div,
      {
  ...
  return /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ t("span", { className: x(pr()), children: r }),
    /* @__PURE__ */ a(
      J.div,
      {
        ...
        children: [
          ...
          n === "alert" && /* @__PURE__ */ t(_n, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ t(Y4, { balance: e.balance })
        ]
      }
    ),
    o && !X4.has(n) && /* @__PURE__ */ t(
      J.span,
      {
        className: x(z1()),
        animate: { opacity: s ? 0 : 1 },
...
const J4 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), e6 = ({
  label: e,
  direction: r
}) => {
  const o = mr[r];
  ...
  const s = `sparkline-gradient-${tt().replace(/:/g, "")}`, i = Q4(e, o), c = mr[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(On, { width: "100%", height: "100%", children: /* @__PURE__ */ a(
          zn,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(Gn, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                Wn,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(e6, { label: r, direction: i })
      ]
    }
  ) });
}, vr = h(
  (e, r) => {
    const {
      ...
      className: l,
      ...u
    } = e, [f, g] = B(!1), [p, C] = B(!1), m = f || p, v = x1(), w = m && !!d, b = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, j = () => {
      c?.();
        ...
        "div",
        {
          ...
          children: [
            ...
            u.content === "sparkline" ? /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ t("span", { className: x(pr()), children: n }),
              /* @__PURE__ */ t(
                J.div,
                {
...
const r6 = ["className"], wr = h((e, r) => {
  const o = r6.reduce((n, s) => {
    const { [s]: i, ...c } = n;
    return c;
  }, e);
  return /* @__PURE__ */ t(vr, { ref: r, ...o });
});
wr.displayName = "F0AiInsightCard";
const o6 = () => /* @__PURE__ */ a(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ t(p1, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ a("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ t(p1, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ t(p1, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ t(p1, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ t(p1, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], xr = 180, n6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : xr, s6 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, i6 = (e) => e.showActions !== !1, a6 = (e) => Object.fromEntries(
...
function c6(e) {
  ...
  } = e, [l, u] = B(!1), f = tt(), g = I(null), p = n6(
    d
  ), C = i.length > p, m = l ? i : s6(i, p), v = i6(e) ? e : null, w = a6(e);
  return q(() => {
    l && g.current?.focus();
  }, [l]), /* @__PURE__ */ a(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          r && /* @__PURE__ */ t(xt, { module: r, size: "md" }),
...
c6.displayName = "F0AiProposalCard";
const l6 = ({
  icon: e,
  title: r,
  children: o
...
}, d6 = (e) => g2[e] ?? lt, f6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(i1, { icon: d6(e), size: "md", color: "default" }) }) : null;
function u6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(l6, { icon: ce, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const c = /* @__PURE__ */ t(f6, { iconName: s.icon });
...
u6.displayName = "F0AiMessageSources";
async function h6(e, r, o) {
  const n = await import("./xlsx-Bedf3nwD.js"), s = n.utils.table_to_book(e, { sheet: "Data" });
  n.writeFile(s, `${o}.${r}`);
}
function C6({
  ...
  const n = G(), s = I(null), i = r ?? n.ai.aiTable.title, c = z(
    (d) => {
      if (!s.current) return;
              ...
              /* @__PURE__ */ t("tbody", { children: e.rows.map((d, l) => /* @__PURE__ */ t("tr", { children: e.columns.map((u) => {
                ...
                return /* @__PURE__ */ t(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ t(c1, { children: f == null ? "" : String(f) })
                  },
                  u
                );
              }) }, l)) })
...
function g6({ credits: e }) {
  const r = G(), [o, n] = B(!1), [s, i] = B(!1), [c, d] = B(!1), [l, u] = B(null), f = z(
    (C) => {
  ...
  return /* @__PURE__ */ a(de, { open: o, onOpenChange: f, children: [
    /* @__PURE__ */ t(fe, { asChild: !0, children: /* @__PURE__ */ t(
      u1,
      {
        variant: "ghost",
        hideLabel: !0,
        ...
        children: [
          p && /* @__PURE__ */ a("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            ...
            /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ t(c1, { tag: "span", className: "font-medium", children: e.companyName ?? "" }),
...
function m6({
  ...
  const r = G(), o = x1(), [n, s] = B(!1), [i, c] = B(!1), [d, l] = B(!1), [u, f] = B(null), g = z(
    (v) => {
  ...
  return /* @__PURE__ */ a(de, { open: n, onOpenChange: g, children: [
    /* @__PURE__ */ t(fe, { asChild: !0, children: /* @__PURE__ */ t(
      u1,
      {
        variant: "ghost",
...
const Qe = ({
  credits: e,
  employeeCredits: r
}) => r ? /* @__PURE__ */ t(m6, { employeeCredits: r }) : e ? /* @__PURE__ */ t(g6, { credits: e }) : null, Q6 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const p = G(), C = Yn(`(max-width: ${Kn.md}px)`, {
        ...
        /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ t(
          S1,
          {
            ...
            children: /* @__PURE__ */ a("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ t(c1, { lines: 1, className: "min-w-0 text-left", children: o ?? p.ai.newConversation }),
              /* @__PURE__ */ t(i1, { icon: ae, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ a(
...
function w6(e) {
  ...
  return Et(r) ? "today" : Rt(r) ? "yesterday" : Qn(r, o) ? "thisMonth" : "older";
}
function x6(e, r) {
  const o = new Date(e), n = v6(), s = Me(o, "p", { locale: n });
  if (Et(o)) return `${r.today}, ${s}`;
  if (Rt(o)) return `${r.yesterday}, ${s}`;
  const i = !Jn(o, /* @__PURE__ */ new Date());
      ...
      children: [
        /* @__PURE__ */ a(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ t(c1, { lines: 1, className: "text-left font-medium", children: e.title }),
        ...
        /* @__PURE__ */ t(
          "div",
          {
            ...
            children: /* @__PURE__ */ t(he, { items: d, children: /* @__PURE__ */ t(
              g1,
              {
                icon: ct,
                variant: "ghost",
...
const J6 = ({
  ...
  const C = Q(
    ...
    return n.filter((N) => N.title.toLowerCase().includes(R));
  }, [n, g]), v = Q(
    () => m.filter((R) => c.has(R.id)),
    [m, c]
  ), w = Q(
    () => m.filter((R) => !c.has(R.id)),
    [m, c]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ t(i1, { icon: ce, color: "secondary", size: "md" }),
                  /* @__PURE__ */ t(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ t(
                    S1,
                    {
                      ...
                      children: /* @__PURE__ */ a("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ t(i1, { icon: ge, color: "default", size: "md" }),
                        /* @__PURE__ */ t(c1, { lines: 1, className: "text-left", children: f.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ t(b6, {}),
...
function el({
  ...
  const [n, s] = B([]), [i, c] = B(!1), [d, l] = B(null), [u, f] = B(y6), g = z(async () => {
    c(!0), l(null);
    try {
      const v = await r();
      s(v);
  ...
  const p = z((v) => {
    f((w) => {
      const b = new Set(w);
      return b.add(v), oe(b), b;
    });
  }, []), C = z((v) => {
    f((w) => {
      const b = new Set(w);
      return b.delete(v), oe(b), b;
    });
  }, []), m = z(
    async (v) => {
      try {
...
const M6 = J.create(os), E6 = ({
  ...
  const { t: i } = G(), c = x1(), d = o ?? i("ai.applyingChanges");
  return q(() => {
    if (!r) return;
    const l = document.activeElement;
    l && l.getAttribute("name") !== "one-ai-input" && l.blur();
  }, [r]), /* @__PURE__ */ a("div", { className: x("relative flex flex-1 flex-col", n), children: [
    /* @__PURE__ */ t(E1, { children: r && // Zero-height sticky anchor pinned to the top of the scroll viewport,

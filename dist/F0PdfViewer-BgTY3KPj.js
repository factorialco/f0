...
import { f as n, ht as r } from "./variants-CSJ-yF0i.js";
import { t as i } from "./utils-CVzxZnoI.js";
import { a, wn as o } from "./OneCalendar-BxfqTY4J.js";
import { l as s } from "./F0Button-DAqSZkXo.js";
import { Dt as c, Mt as l, bt as u } from "./F0Checkbox-D80nhG7S.js";
import { r as d } from "./internal-DUTjEW68.js";
import { t as f } from "./Download-Dvj6cfxp.js";
import { t as p } from "./Printer-snTHysV7.js";
import { t as m } from "./Reset-gUsyzwG8.js";
import { i as ee, n as h, r as g, t as _ } from "./pdfWorker-CrMWSIlN.js";
import { a as v, n as y, o as b, r as x, s as S, t as C } from "./scales-WWMMynum.js";
...
}), F = "flex flex-row items-center gap-2", ne = ({ toolbarRef: e, currentPage: t, totalPages: r, hasDocument: s, selectedScale: u, scaleOptions: ee, onPreviousPage: h, onNextPage: g, onZoomIn: _, onZoomOut: v, onScaleChange: y, rotatable: b, onRotate: x, onPrint: C, onDownload: w, actions: T }) => {
	let { pdfViewer: E } = n();
...
h();
var I = D(() => import("./SheetViewer-ClN1iZA8.js")), L = D(() => import("./DocxViewer-dAV9wbpW.js")), R = D(() => import("./TextViewer-I2C9-DqT.js")), z = 48, B = E((e, t) => {
	let { kind: n = "pdf", mimeType: r, ...i } = e;
	if (n === "pdf") return /* @__PURE__ */ N(V, {
		ref: t,
		...i
	});
	let { url: a, filename: o, actions: c, withCredentials: l = !0, page: u, pagesToDisplay: d, initialScale: f, rotatable: p, initialRotation: m, onRotationChange: ee, onPdfLoaded: h, onPageChange: g, ..._ } = i;
	return /* @__PURE__ */ N("div", {
		...
		children: /* @__PURE__ */ P(T, {
			fallback: /* @__PURE__ */ N(s, { className: "h-full w-full rounded-none" }),
			children: [
...
var V = E((e, t) => {
	let { url: r, filename: i = "document.pdf", page: a = 0, pagesToDisplay: o = [], initialScale: c = "page-width", withCredentials: l = !0, rotatable: u = !1, initialRotation: d = 0, onRotationChange: f, onPdfLoaded: p, onPageChange: m, actions: h, ..._ } = e, { pdfViewer: S } = n(), [w, T] = M(null), [E, D] = M([]), [F, I] = M(1), [L, R] = M(0), [B, V] = M(c), [H, U] = M(d), W = j(null), G = j(null), K = j([]), q = o.length > 0 ? o.length : w?.numPages, J = E.find(Boolean), Y = (J?.originalWidth ?? 595) * F, X = (J?.originalHeight ?? 842) * F, ie = A(() => [
		{
			value: "page-width",
			label: S.pageWidth
		},
...
var H = () => {
	...
	return /* @__PURE__ */ P("div", {
		...
		children: [/* @__PURE__ */ P("div", {
			...
			children: [
				/* @__PURE__ */ N(s, { className: "h-8 w-24 rounded-md" }),
				/* @__PURE__ */ N(s, { className: "h-8 w-40 rounded-md" }),
				/* @__PURE__ */ N(s, { className: "h-8 w-20 rounded-md" })
			]
		}), /* @__PURE__ */ N("div", {
			className: "flex flex-1 justify-center p-4",
			children: /* @__PURE__ */ N(s, { className: "h-full w-full max-w-[600px] rounded-md" })
		})]
	});
}, U = /* @__PURE__ */ e({
	F0PdfViewer: () => W,

...
import { g as p, S as v } from "./F0CanvasPanel-_W3I4tue.js";
import { u as x, D as y } from "./DocumentToolbar-mSp78UEw.js";
const V = ({
  url: t,
  filename: d,
  withCredentials: a = !0,
  ...
  const s = p(), i = x(), f = b(null), [l, n] = h("loading");
  return w(() => {
    const u = f.current;
    if (!u)
      return;

import { a as e, d as t, s as n } from "./dist-zRL9MpsG.js";
import r from "react";
...
function a(a) {
	let o = a + "CollectionProvider", [s, c] = t(o), [l, u] = s(o, {
	...
	d.displayName = o;
	let f = a + "CollectionSlot", p = r.forwardRef((t, r) => {
		let { scope: a, children: o } = t, s = u(f, a), c = n(r, s.collectionRef);
		return /* @__PURE__ */ i(e, {
			ref: c,
			children: o
		});
	...
	p.displayName = f;
	let m = a + "CollectionItemSlot", h = "data-radix-collection-item", g = r.forwardRef((t, a) => {
		let { scope: o, children: s, ...c } = t, l = r.useRef(null), d = n(a, l), f = u(m, o);
		return r.useEffect(() => (f.itemMap.set(l, {
			ref: l,
			...c
		}), () => void f.itemMap.delete(l))), /* @__PURE__ */ i(e, {
			[h]: "",
			ref: d,
			children: s
		});

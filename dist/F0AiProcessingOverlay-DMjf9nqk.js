...
import { useInsertionEffect as mr, forwardRef as C, useRef as I, useEffect as W, useLayoutEffect as X1, useState as $, useMemo as X, useCallback as Z, createContext as De, useContext as Te, useId as Y1, createElement as wr, memo as kr } from "react";
import { ak as Lr, d6 as xr, Z as K1, c5 as br, d7 as yr, d8 as Mr, d9 as Er, da as Rr, c6 as Fr, cf as Q1, c4 as Nr, db as Vr, a6 as qe, dc as Sr, aW as Tr, dd as Hr, de as Ar, df as $r, at as Br, dg as Ir, cC as Pr, aa as J1, ad as Dr, dh as jr, bk as Xe, a1 as et, S as je, bX as tt, br as Zr, cb as _r, di as Ur, bd as Or, cB as zr, $ as Ee, aH as Gr, bv as rt, dj as Wr, cz as qr, c3 as be, cx as Xr, dk as Yr, bZ as ot, bc as Kr, dl as Qr, dm as Jr, dn as eo, dp as to, dq as ro, dr as nt, cq as oo, cr as no, ds as so, dt as ao, du as io, dv as co, dw as lo, bF as fo, c8 as uo, dx as ho, ai as Co, dy as go, dz as po, dA as vo, dB as mo, dC as wo, dD as ko, bE as Lo, cA as xo, ab as bo, cm as yo, dE as Mo, dF as Eo, dG as Ro, dH as Fo, dI as No, dJ as Vo, dK as So, aC as To, bG as Ho, b$ as st, M as Ao, a0 as $o, bH as at, bY as Bo, b_ as it, al as Io, bu as Po, bt as Do, aq as jo, dL as Zo, dM as _o, bI as ct, bJ as Uo, bK as Oo, bb as zo, aL as Go, dN as Wo, aF as qo, bp as lt, bo as dt, bi as Xo, dO as ft, bh as Yo, c7 as Ye, dP as Ko, bm as Ke, aj as Qo, dQ as Jo, dR as Qe, c9 as en, ca as tn, cy as ut, dS as rn, G as on, E as nn, dT as sn, dU as an, dV as cn, dW as ln, bV as dn, dX as ht, dY as fn, ac as un, dZ as hn, L as ae, u as G, bU as Cn, U as ue, bT as Ct, H as ie, v as he, a2 as gn, o as L, Q as pe, d_ as pn, ae as ne, ar as me, A as ye, p as Q, cH as gt, aQ as Je, d$ as vn, aR as e1, aS as t1, b as xe, bR as mn, e0 as wn, bS as kn, V as Ln, ba as xn, a5 as r1, bL as bn, bM as yn, bN as Mn, bO as v1, a3 as En, ax as pt, b1 as vt, e1 as Rn, cO as Fn, e2 as Nn, e3 as Vn, b6 as mt, e4 as Sn, cI as Tn, e5 as Hn, b3 as Se, bj as wt, e6 as kt, bl as Lt, c as ze, ce as m1, e7 as xt, cc as An, cd as $n, q as He, bz as Bn, e8 as In, bq as o1, cn as Pn, e9 as Dn, ea as jn, eb as Zn, ec as _n, ed as Un, a8 as On, af as zn, am as Ue, y as Gn, z as Wn, aw as w1, ee as bt, ef as yt, eg as qn, eh as Xn, av as Yn, a7 as Kn, ei as Qn, ej as Jn, d as es } from "./F0CanvasPanel-3ezPU2as.js";
import { createPortal as Mt } from "react-dom";
import { defaultTranslations as ts } from "./i18n-provider-defaults.js";
import { useTrackVolume as rs } from "@livekit/components-react";
function os(e, r, o) {
  mr(() => e.on(r, o), [e, r, o]);
}
...
const c0 = (e, r) => /* @__PURE__ */ i(
...
), W0 = C(G0), q0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: ss,
  Add: Lr,
  Ai: is,
  ...
  Calculator: Ir,
  Calendar: Pr,
  CalendarArrowDown: Ss,
  CalendarArrowLeft: Hs,
  CalendarArrowRight: $s,
  CameraPlus: Is,
  CardPin: Ds,
  ChartFunnel: Zs,
  ChartHorizontalBars: Us,
  ChartLine: zs,
  ChartPie: Ws,
  ChartVerticalBars: Xs,
  Check: J1,
  CheckCircle: Dr,
  CheckCircleLine: Ks,
  CheckDouble: jr,
  ...
  DropdownOpen: Yr,
  Ellipsis: ot,
  EllipsisHorizontal: Kr,
  Envelope: Qr,
  EnvelopeOpen: Sa,
  Equal: Jr,
  EqualApproximately: eo,
  EqualGreater: to,
  EqualLess: ro,
  Exit: Ha,
  ExternalLink: nt,
  ...
  Wifi: W0,
  Windows: hn
}, Symbol.toStringTag, { value: "Module" })), X0 = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ t(
    ae,
    {
      ...
      variant: "ai",
      ref: r,
      iconRotate: e.icon == Y0
    }
  );
});
Ht.displayName = "AIButton";
const Q6 = ["xs", "sm", "md", "lg"], J6 = [
  "inProgress",
  "executing",
  "writing",
  "completed"
  ...
  const m = G();
  return f === "recording" ? /* @__PURE__ */ i("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    /* @__PURE__ */ t(
      Cn,
      {
        stream: g ?? null,
    ...
    /* @__PURE__ */ t("div", { className: "flex items-center gap-2", children: e && /* @__PURE__ */ i(Me, { children: [
      /* @__PURE__ */ t(
        ae,
        {
  ...
  const n = /* @__PURE__ */ i("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    ...
    /* @__PURE__ */ t(
      "button",
      {
        ...
        onClick: () => r(e.id),
        children: /* @__PURE__ */ t(ie, { icon: Ee, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ t(gn, { label: e.errorMessage, children: n }) : n;
}
const tc = {
  soft: {
    text: "",
        ...
        return /* @__PURE__ */ i(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ t(ne, { className: "text-base font-medium text-f1-foreground", children: h }) })
            ]
          },
          String(f.id)
        );
...
const nc = ({
  ...
  const s = me(), [a, l] = $(""), [d, c] = $(0), [u, f] = $(!1), g = I(null), p = I(null), h = I(null), v = e[d] ?? r;
  return W(() => {
    const m = () => {
    ...
    if (s)
      return f(!1), l(v), m(), g.current = setTimeout(() => {
    ...
    f(!0), l("");
    let k = 0;
    const N = 50, P = 30, H = 2e3, S = 1e3;
    return p.current = setInterval(() => {
      k < v.length ? (l(v.slice(0, k + 1)), k++) : (p.current && (clearInterval(p.current), p.current = null), g.current = setTimeout(() => {
        h.current = setInterval(() => {
          k > 0 ? (k--, l(v.slice(0, k))) : (h.current && (clearInterval(h.current), h.current = null), g.current = setTimeout(() => {
            const E = (d + 1) % Math.max(e.length, 1);
            c(E);
          }, S));
        }, P);
    ...
    e.length,
    s
  ]), o.length > 0 || n ? null : /* @__PURE__ */ t(ye, { children: /* @__PURE__ */ t(
    Q.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
`) ? o + "_" : o
        ...
        "div",
        {
          ...
          children: d.map(
            (h, v) => h.type === "mention" ? /* @__PURE__ */ t(
              ...
              v
            ) : h.type === "ghost" ? /* @__PURE__ */ t("span", { className: "text-f1-foreground-secondary opacity-50", children: h.text }, v) : /* @__PURE__ */ t("span", { children: h.text }, v)
          )
        }
      ),
      !o && !u && /* @__PURE__ */ t(
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, ic).map((r) => /* @__PURE__ */ t(
  gt,
  {
...
const fc = ({
  ...
  const [s, a] = $(null), l = s !== null ? e[s] : null;
  return e.length === 0 ? null : /* @__PURE__ */ i(
    Je,
    {
      ...
      children: [
        /* @__PURE__ */ t(vn, { asChild: !0, children: /* @__PURE__ */ t("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, c) => /* @__PURE__ */ t(e1, { asChild: !0, children: /* @__PURE__ */ t(
          ae,
          {
            variant: "outline",
            label: d.label,
        ...
        l && /* @__PURE__ */ i(
          t1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: dc(l.items).map((d, c) => /* @__PURE__ */ i(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
function Cc(e, r) {
  ...
  return o.length === 0 ? e : e.filter(
    (n) => o.some((s) => hc(n.type, s))
  );
}
const gc = 4e3;
function pc(e) {
  const [r, o] = $([]), [n, s] = $(null), a = I(
    null
  ), l = I(null), d = G(), c = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, g = X(() => {
    if (u)
      return Array.isArray(u) ? u.join(",") : u;
  }, [u]), p = f !== void 0 && r.length >= f, h = I(0);
  W(() => {
    h.current = r.length;
  }, [r]);
  const v = Z((H) => {
  ...
  const m = Z(
    async (H) => {
      ...
      try {
        ...
        if (!Array.isArray(M) || M.length !== S.length) {
          x(d.ai.fileUploadError);
          return;
        }
        o(
          (A) => A.map((F) => {
            const V = E.findIndex((B) => B.id === F.id);
            return V === -1 ? F : M[V] ? {
              ...F,
              status: "uploaded",
              uploadedFile: M[V]
    ...
    async (H) => {
      await m(Array.from(H.target.files ?? [])), H.target.value = "";
    },
    [m]
  ), N = Z((H) => {
...
function Lc({
  ...
  const [a, l] = $(!1), [d, c] = $(""), [u, f] = $([]), [g, p] = $(!1), [h, v] = $(0), [m, k] = $([]), N = I(-1), P = I(null), H = I(0), S = I(-1);
  W(() => {
    if (!n) {
      l(!1);
      return;
    ...
    const V = vc(e, o, m);
    if (!V) {
      l(!1), c(""), f([]), v(0), N.current = -1, S.current = -1;
      return;
    }
    if (V.atIndex === S.current)
      return;
    N.current = V.atIndex, c(V.query), l(!0), v(0), p(!0), P.current && clearTimeout(P.current);
    const B = ++H.current;
  ...
  const E = Z(() => {
    l(!1), c(""), f([]), v(0), N.current = -1;
  }, []), w = Z(
    (V) => {
      const B = N.current;
      if (B === -1) return;
      const O = `${V.firstName} ${V.lastName}`.trim(), U = String(V.id), z = e.slice(0, B), te = e.slice(o), re = `@${O} `, J = z + re + te, K = z.length + re.length;
      r(J), k((j) => [...j.filter((Y) => !(Y.id === U && Y.name === O)), { id: U, name: O }]), E(), requestAnimationFrame(() => {
        const j = s.current;
        j && (j.focus(), j.setSelectionRange(K, K));
      });
    },
    [e, o, r, s, E]
  ), x = Z(
    ...
    (V) => {
      ...
      let B = V;
      const O = [...m].sort((U, z) => z.name.length - U.name.length);
      for (const U of O) {
        const z = `@${U.name}`, te = `<entity-ref type="person" id="${k1(U.id)}">${k1(U.name)}</entity-ref>`;
        for (; B.includes(z); )
          B = B.replace(z, te);
      }
      return B;
...
` || z === "	";
  ...
  const A = X(() => {
    if (!a || N.current === -1) return null;
    const V = s.current;
    if (!V) return null;
    const B = wc(V, N.current), O = V.offsetLeft + B.left, z = (V.offsetParent ? V.offsetParent.offsetHeight : 0) - (V.offsetTop + B.top);
...
const xc = /[\\`*_{}[\]()#+\-.!|~>]/g, bc = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(xc, "\\$&")).join(""), e4 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const x = G(), M = me(), [A, F] = $(""), [V, B] = $(0), [O, U] = $(!1), [z, te] = $(!1), [re, J] = $(null), K = I(null), j = I(null), oe = I(null), Y = l != null, { tracking: Ce } = xe(), Re = Z(
    (q, ve) => {
    ...
    const ve = Fe.current, _e = ve && !/\s$/.test(ve) ? " " : "", Be = `${ve}${_e}${q}`;
    F(Be), B(Be.length);
  }, []), Ze = {
    ...
    onPartial: Ae,
    onFinal: (q) => {
      Ae(q), j.current?.focus();
    },
    onError: (q) => fe(Ze[q])
  }), sr = !!p && ke.isSupported, ar = Z(() => {
    Ce?.onDictationStart?.(), Fe.current = A, ke.start();
  }, [A, ke, Ce]), ir = Z(() => {
    Ce?.onDictationCancel?.(), ke.cancel();
  }, [ke, Ce]);
  W(() => {
  ...
  const a1 = ke.status === "recording", cr = a1 ? x.ai.listening : x.ai.inputPlaceholder, i1 = le.filter((q) => q.status === "uploaded"), $e = le.some((q) => q.status === "uploading"), c1 = le.some((q) => q.status === "error"), l1 = A.trim().length > 0 || i1.length > 0;
  W(() => {
    if (!(!z || $e)) {
      if (te(!1), c1) {
        fe(x.ai.fileUploadBlockedSubmit);
        return;
      }
      K.current?.requestSubmit();
    }
  }, [
    z,
    $e,
  ...
  const lr = async (q) => {
    if (q.preventDefault(), !Y) {
      if (ee.close(), o)
        r?.();
      else if (l1 && !O) {
        if ($e) {
          te(!0), j.current?.focus();
          return;
        }
        if (n) {
          U(!0);
        ...
        const ve = ee.transformMentions(A.trim()), _e = bc(ve), Be = i1.flatMap(
    ...
    Y || ee.handleKeyDown(q) || q.key === "Enter" && !q.shiftKey && (q.preventDefault(), o || K.current?.requestSubmit());
  }, fr = () => {
    B(j.current?.selectionStart ?? 0);
  }, ur = () => {
    oe.current && j.current && (oe.current.scrollTop = j.current.scrollTop);
  }, d1 = re ? re.prompt ?? re.title : null, f1 = a1 ? [x.ai.listening] : d1 ? [d1] : s ?? [], hr = f1.length > 1, Cr = X(() => uc(A, ee.mentions, {
    cursorPosition: V,
    inlineCompletion: ee.inlineCompletion
  }), [A, ee.mentions, V, ee.inlineCompletion]), gr = ee.mentions.length > 0 || ee.inlineCompletion !== null, u1 = N && !!H && H.length > 0 && !!S ? /* @__PURE__ */ t(
    fc,
    {
      suggestions: H,
      onItemClick: Re,
  ...
  ) : null, pr = N && P && !!E && E.length > 0, h1 = P && N, { motionProps: vr } = wn(
    N,
    160,
    0.5
  );
    ...
    Q.div,
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(rc, { creditWarning: a, children: /* @__PURE__ */ i(
            Q.form,
            {
              "aria-busy": o,
              ref: K,
              className: L(
                ...
                Y && "after:scale-100 after:opacity-100 border-f1-background-tertiary"
              ),
              animate: {
              ...
              children: [
                ...
                /* @__PURE__ */ t(ye, { initial: !1, children: Y ? /* @__PURE__ */ t(
                  Q.div,
                  {
                  ...
                  Q.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ t(ye, { initial: !1, children: ce && /* @__PURE__ */ t(
                        Q.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                      ...
                      /* @__PURE__ */ t(
                        ac,
                        {
                          ...
                          onCursorUpdate: fr,
                          onScroll: ur,
                          highlightSegments: Cr,
                          hasOverlay: gr,
                          multiplePlaceholders: hr,
                          placeholders: f1,
                          resolvedDefaultPlaceholder: cr,
                          inProgress: o
                        }
                      ),
                      /* @__PURE__ */ t(
                        Q0,
                        {
                          ...
                          isPreSending: O || z,
                          canRecord: sr,
                          recordingStatus: ke.status,
                          recordingStream: ke.stream,
                          onStartRecording: ar,
                          onStopRecording: ke.stop,
        ...
        pr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(cc, { cards: E }) }),
        k && N && P && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: k }),
        /* @__PURE__ */ t(ye, { mode: "wait", initial: !1, children: Y ? /* @__PURE__ */ i(
          Q.div,
          {
          ...
          Q.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ t(ne, { className: "text-sm font-medium text-f1-foreground-tertiary", children: m.text }),
...
function Nc({
  ...
  return /* @__PURE__ */ t(xn, { ...r, variant: "link", href: r.href, children: e });
}
function Vc({
  children: e,
  ...r
...
function Ne({
  ...
  const a = I(/* @__PURE__ */ new Map()), [l, d] = $(
  ...
  const h = Z(() => {
    if (l || c) return;
    const m = a.current.get(e);
    if (m) {
      d(m);
      return;
    }
    u(!0), g(!1), o(e).then((k) => {
      a.current.set(e, k), p.current && d(k);
    }).catch(() => {
      p.current && g(!0);
    }).finally(() => {
      p.current && u(!1);
  ...
  return /* @__PURE__ */ i(
    bn,
    {
      ...
      children: [
        /* @__PURE__ */ t(yn, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          Mn,
          {
            side: "top",
...
function Uc({
  ...
  const { entityRefs: o } = xe(), n = o?.resolvers?.candidate, s = G(), a = o?.urls?.candidate?.(e), l = X(
    () => (c) => {
      const u = [];
...
function Oc({ id: e, label: r }) {
  const { entityRefs: o } = xe(), n = o?.resolvers?.expense, s = G(), a = o?.urls?.expense?.(e), l = X(
    () => (c) => ({
      avatar: {
        type: "icon",
        icon: Rt
...
function zc({
  ...
  const { entityRefs: o } = xe(), n = o?.resolvers?.jobPosting, s = G(), a = o?.urls?.jobPosting?.(e), l = X(
    () => (c) => ({
      title: c.title,
...
function Wc({
  ...
  const { entityRefs: o } = xe(), n = o?.resolvers?.requisition, s = G(), a = o?.urls?.requisition?.(e), l = X(
    () => (c) => {
...
function qc({ id: e, label: r }) {
  const { entityRefs: o } = xe(), n = o?.resolvers?.person, s = G(), a = o?.urls?.person?.(e), l = X(
    () => (c) => ({
      avatar: {
        type: "person",
        firstName: c.firstName,
...
function Xc({ id: e, label: r }) {
  const { entityRefs: o } = xe(), n = o?.resolvers?.vacancy, s = G(), a = o?.urls?.vacancy?.(e), l = X(
    () => (c) => ({
      title: c.name,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ t(Rn, { file: e.file, size: "lg" }),
          /* @__PURE__ */ i("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ t(ne, { className: "text-lg font-semibold text-f1-foreground", children: r }),
            o && /* @__PURE__ */ t(ne, { className: "text-base text-f1-foreground-secondary", children: o })
          ] }),
...
const L1 = 7, e2 = 625, x1 = /* @__PURE__ */ new Set();
function t2(e) {
...
function o2(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = Nn(e), a = [];
...
function Zt(e, r) {
  ...
  return { type: "item", text: r2(String(e)) };
}
function _t({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = xe(), g = Jc(e), p = d ?? g, h = I(() => {
  }), v = n ?? e, m = s ?? r ?? "", k = c?.type === "form" && c.formName === e, N = () => u({
    type: "form",
    title: v,
    description: m,
    formName: e,
  ...
  h.current = N, W(() => {
    typeof window > "u" || window.innerWidth < e2 || x1.has(e) || (x1.add(e), h.current());
  }, [e]);
  const P = a && l ? Object.entries(a).map(([E, w]) => {
    const x = l[E], M = p?.(E, x, {
      fieldType: w.fieldType,
      customFieldName: w.customFieldName
    });
    if (!M && w.fieldType === "custom" && typeof x == "object" && x !== null)
      return null;
    const A = M ?? Zt(x, w.fieldType), F = ["richtext", "textarea"];
    return {
      label: w.label,
      content: A,
  ...
  return /* @__PURE__ */ t(
    jt,
    {
      ...
      children: H.length > 0 && !k && /* @__PURE__ */ t("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ t(
        Fn,
        {
          details: H.map((E) => ({
            title: E.label,
...
function Ot({ anchor: e, onReply: r }) {
  ...
  if (X1(() => {
    ...
    const h = e.rect.left + e.rect.width / 2 - c / 2, v = Math.min(
      Math.max(h, Ve),
      f - c - Ve
    );
    a({ top: p, left: v });
...
const zt = De(void 0), n4 = () => Te(zt), i2 = (e) => /* @__PURE__ */ t(mt, { content: e, format: "markdown" }), c2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, g = I(null), { anchor: p, clear: h } = Ut({
    containerRef: g,
    enabled: !!(o?.id && d)
  });
  return W(() => {
    ...
    /* @__PURE__ */ t(
      Ot,
      {
        anchor: p,
        onReply: (v) => {
          s?.(v), h(), window.getSelection()?.removeAllRanges();
        }
      }
    )
  ] }) });
  ...
  const [s, a] = $(""), l = G(), { title: d, label: c, placeholder: u } = o === "like" ? l.ai.feedbackModal.positive : l.ai.feedbackModal.negative, f = Z(() => {
    r(n, s);
  }, [s, n, r]), g = () => {
    e(n);
  };
...
const u2 = ({
  ...
  const [d, c] = $(s), u = me(), f = n !== void 0, g = f ? n : d;
  return /* @__PURE__ */ i(
    wt,
    {
...
const qt = (e) => /* @__PURE__ */ t(mt, { content: e, format: "markdown" }), v2 = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = p2(
    e?.content,
    l
  ), c = (g2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: g, clear: p } = Ut({
    containerRef: a,
    enabled: f
  });
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(v2, { text: u, renderMarkdown: n }),
        d.length > 0 && /* @__PURE__ */ t("div", { className: "flex max-w-[90%] flex-wrap justify-end gap-1.5", children: d.map((h, v) => /* @__PURE__ */ t(
          Ct,
          {
...
}, w2 = 35, k2 = 22, L2 = 400, x2 = 2500, b2 = 220, y2 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  const [n, s] = $(0), [a, l] = $(0), [d, c] = $("starting"), u = e[n] ?? "";
  W(() => {
    e.length > 0 && n >= e.length && (s(0), l(0), c("starting"));
  }, [e.length, n]), W(() => {
    let p;
    if (d === "starting")
      p = setTimeout(() => c("writing"), L2);
    else if (d === "writing")
      a < u.length ? p = setTimeout(() => l((h) => h + 1), w2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), x2);
    } else d === "erasing" && (a > 0 ? p = setTimeout(() => l((h) => h - 1), k2) : p = setTimeout(() => {
...
function M2({
  ...
  W(() => {
    const v = e.current, m = r.current;
    if (!v || !m) return;
    const k = new ResizeObserver(() => {
      if (g.current) return;
      const N = parseFloat(getComputedStyle(m).paddingTop) + parseFloat(getComputedStyle(m).paddingBottom) + 1;
      d(v.clientHeight - N);
    });
    return k.observe(v), k.observe(m), () => k.disconnect();
  }, [e, r]);
  const h = Z(() => {
    const v = e.current;
    if (!v) return;
    const { scrollTop: m, scrollHeight: k, clientHeight: N } = v, P = k - m - N;
    u(P > N);
  }, [e]);
  return W(() => {
    const v = e.current;
    ...
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const v = e.current, m = n.current;
        if (!v || !m) return;
        const k = v.getBoundingClientRect(), N = m.getBoundingClientRect(), P = v.scrollTop + (N.top - k.top);
...
const E2 = {
...
}, s4 = (e) => /* @__PURE__ */ t(d2, { children: /* @__PURE__ */ t(R2, { ...e }) }), R2 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: H, handleSubmit: S, handleClose: E } = f2(
    f ?? E2
  ), w = G(), x = m ?? c2, M = k ?? m2, A = X(() => {
    const j = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((Y) => typeof Y == "string" && Y.length > 0);
  }, [n, w.ai.defaultInitialMessage]), F = !r && e.length === 0 && A.length > 0, V = I(null), B = I(null), O = I(null), U = I(null), z = I(null), { showScrollBtn: te, turnMinHeight: re, scrollToBottom: J } = M2({
    viewportRef: V,
    contentRef: B,
    endRef: O,
    lastTurnRef: z,
    ...
    const Y = oe === e.length - 1, Ce = {
      ...
      const we = Y && de === j.assistantMessages.length - 1, b = j.userMessages.length + de, R = {
        message: se,
        inProgress: j.isInProgress,
        index: b,
        isCurrentMessage: we,
      ...
      return /* @__PURE__ */ t(
        x,
        {
          ...
          isLoading: j.isInProgress && we && !se.content
        },
        `${oe}-a-${de}`
      );
    };
          ...
          children: /* @__PURE__ */ i(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ t(ye, { children: te && /* @__PURE__ */ t(
                  Q.div,
                  {
...
}, F2 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ i("div", { className: "flex flex-col gap-2", children: [
...
const V2 = ({
  ...
  const p = G().ai.clarifyingQuestion.typeYourAnswer, h = e === "single" ? /* @__PURE__ */ t(Yt, { isSelected: o && !r }) : /* @__PURE__ */ t(
    xt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const T2 = ({
  ...
  onToggleCustomActive: m,
  onConfirm: k
}) => {
  const N = me(), P = (() => {
    if (e !== "single") return 0;
    const x = o.findIndex((M) => n.includes(M.id));
    return x >= 0 ? x : 0;
  })(), [H, S] = $(P), E = I([]);
  W(() => {
  ...
  const w = (x) => {
    ...
    x.preventDefault(), S(A), E.current[A]?.focus();
  };
  return /* @__PURE__ */ i(
    "div",
    {
  ...
  } = s, x = I(null), M = P ?? "single", A = l > 1, F = a === 0, V = a === l - 1, B = A ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(a + 1),
    total: String(l)
  }) : void 0, O = N.length > 0, U = (E ?? "").trim().length > 0, z = O || w && U || H === !0, te = r === !0 && V, re = () => {
    te || c();
  }, J = () => {
    te || u();
  }, K = (le) => {
    const se = M === "single" && N.includes(le);
    d(le), M === "single" && !V && !se && Promise.resolve().then(c);
  }, j = V ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, oe = H === !0 && !O && !(w && U), Y = () => {
    v(), requestAnimationFrame(() => {
      x.current?.focus();
    });
  }, Ce = (le) => {
    le.key === "Escape" && (le.preventDefault(), f());
  }, Re = n ? 0 : $2 / 2;
  return /* @__PURE__ */ i("div", { className: "flex flex-col", onKeyDown: Ce, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(ye, { mode: "wait", initial: !1, children: /* @__PURE__ */ i(
      Q.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: Re, ease: A2 },
        children: [
          /* @__PURE__ */ t(
            H2,
            {
...
function R1(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), a = Math.min(o, 20), d = Math.min(a + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (Y) => Y / e * 2 - 1, g = (Y) => Y / r * 2 - 1, p = 0, h = e, v = 0, m = r, k = c, N = e - c, P = u, H = r - u, S = f(p), E = f(h), w = g(v), x = g(m), M = f(k), A = f(N), F = g(P), V = g(H), B = 0, O = 0, U = 1, z = 1, te = c / e, re = 1 - c / e, J = u / r, K = 1 - u / r, j = new Float32Array([
    // Top strip
    S,
    w,
    E,
...
class f4 {
  ...
  resize(r, o, n) {
    ...
    const m = s.getAttribLocation(a, "aPosition");
    s.enableVertexAttribArray(m), s.vertexAttribPointer(m, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, c), s.bufferData(s.ARRAY_BUFFER, v, s.STATIC_DRAW);
  ...
  setupGL() {
    ...
    const p = r.getUniformLocation(o, "uResolution"), h = r.getUniformLocation(o, "uTime"), v = r.getUniformLocation(o, "uBorderWidth"), m = r.getUniformLocation(o, "uGlowWidth"), k = r.getUniformLocation(o, "uBorderRadius"), N = r.getUniformLocation(o, "uColors"), P = r.getUniformLocation(o, "uGlowExponent"), H = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(v, this.options.borderWidth), r.uniform1f(m, this.options.glowWidth), r.uniform1f(k, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(P, 2), r.uniform1f(H, 1.8)) : (r.uniform1f(P, 1), r.uniform1f(H, 1));
    const S = (this.options.colors || j2).map(Z2);
...
const N1 = ["lowp", "mediump", "highp"], _2 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, U2 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, S1 = "iTime", T1 = "iTimeDelta", H1 = "iDate", A1 = "iFrame", $1 = "iMouse", B1 = "iResolution", O2 = "iChannel", I1 = "iChannelResolution", P1 = "iDeviceOrientation";
function z2(e, r) {
...
}, Oe = 9729, D1 = 9728, Y2 = 9987, j1 = 33071, Z1 = 10497;
class K2 {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    const g = 0, p = o.RGBA, h = 1, v = 1, m = 0, k = o.RGBA, N = o.UNSIGNED_BYTE, P = new Uint8Array([255, 255, 255, 0]), H = o.createTexture();
    if (o.bindTexture(o.TEXTURE_2D, H), o.texImage2D(
      ...
      return o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.LINEAR), this._webglTexture = H, this.source = x, this.isVideo = !0, x.play().then(() => this);
    }
    async function S() {
    ...
    return (r.wrapS !== j1 || r.wrapT !== j1 || r.minFilter !== D1 && r.minFilter !== Oe) && !w && (E = this.makePowerOf2(E), w = !0), o.bindTexture(o.TEXTURE_2D, H), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, c), o.texImage2D(
      o.TEXTURE_2D,
      g,
      p,
      k,
...
const Le = (e) => `react-shaders: ${e}`, _1 = (e) => {
  if ("changedTouches" in e) {
    const r = e.changedTouches[0];
    return [r?.clientX ?? 0, r?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, U1 = (e, r, o) => e * (1 - o) + r * o, Q2 = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function J2({
  fs: e,
  vs: r = V1,
  textures: o = [],
  ...
  const h = I(null), v = I(null), m = I(null), k = I(null), N = I(void 0), P = I(void 0), H = I(!1), S = I(void 0), E = I(0), w = I([0, 0]), x = I([]), M = I(0), A = I(void 0), F = I({
    ...
    h.current && (v.current = h.current.getContext("webgl", d) || h.current.getContext(
      "experimental-webgl",
      d
    ), v.current?.getExtension("OES_standard_derivatives"), v.current?.getExtension("EXT_shader_texture_lod"));
  }, U = () => {
    const b = v.current;
    m.current = b?.createBuffer() ?? null, b?.bindBuffer(b.ARRAY_BUFFER, m.current);
    const R = [
      1,
      1,
      0,
    ...
    if (b.canvas.width = y, b.canvas.height = D, F.current.iResolution?.isNeeded && k.current) {
...
${R}`));
    ...
    if (k.current = y.createProgram(), !(!k.current || !T || !D)) {
      if (y.attachShader(k.current, T), y.attachShader(k.current, D), y.linkProgram(k.current), !y.getProgramParameter(k.current, y.LINK_STATUS)) {
        g?.(
          Le(
      ...
      y.useProgram(k.current), N.current = y.getAttribLocation(
        k.current,
        "aVertexPosition"
    ...
    if (n)
      for (const b of Object.keys(n)) {
        const R = n[b];
        if (!R) continue;
        const { value: y, type: D } = R, T = X2(D);
        if (!T) continue;
        const _ = {};
        if (z2(D, y)) {
          const ce = D.length, fe = Number.parseInt(D.charAt(ce - 3)), ee = Math.floor(y.length / (fe * fe));
          y.length > fe * fe && (_.arraySize = `[${ee}]`);
        } else G2(D, y) && (_.arraySize = `[${Math.floor(y.length / Number.parseInt(D.charAt(0)))}]`);
        F.current[b] = {
          type: T,
          isNeeded: !1,
          value: y,
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (y, D) => (F.current[`${O2}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(y, D), x.current[D] = new K2(b), x.current[D]?.load(y).then((T) => {
            B(T, D);
          }))
        );
        Promise.all(R).then(() => {
...
`,
    ...
    return b.includes("mainImage") && (D = D.concat(_2)), D;
  }, le = (b) => {
    const R = v.current;
    ...
    if (F.current.iDate?.isNeeded) {
      const T = /* @__PURE__ */ new Date(), _ = T.getMonth() + 1, ce = T.getDate(), fe = T.getFullYear(), ee = T.getHours() * 60 * 60 + T.getMinutes() * 60 + T.getSeconds() + T.getMilliseconds() * 1e-3, Fe = R.getUniformLocation(
        k.current,
        H1
      );
      R.uniform4fv(Fe, [fe, _, ce, ee]);
    }
    if (F.current.iFrame?.isNeeded) {
      ...
      R.uniform1i(T, _), F.current.iFrame.value = _ + 1;
    }
    if (x.current.length > 0)
      for (let T = 0; T < x.current.length; T++) {
        const _ = x.current[T];
        if (!_) return;
        const { isVideo: ce, _webglTexture: fe, source: ee, flipY: Fe, isLoaded: Ae } = _;
        if (!Ae || !fe || !ee) return;
        if (F.current[`iChannel${T}`]?.isNeeded) {
          if (!k.current) return;
          const Ze = R.getUniformLocation(
            k.current,
            `iChannel${T}`
          );
          R.activeTexture(R.TEXTURE0 + T), R.bindTexture(R.TEXTURE_2D, fe), R.uniform1i(Ze, T), ce && _.updateTexture(
            fe,
            ee,
            Fe
          );
    ...
    const R = v.current;
    if (!R) return;
    R.viewport(0, 0, R.drawingBufferWidth, R.drawingBufferHeight), R.clear(R.COLOR_BUFFER_BIT | R.DEPTH_BUFFER_BIT), R.bindBuffer(R.ARRAY_BUFFER, m.current), R.vertexAttribPointer(
      N.current ?? 0,
      3,
      R.FLOAT,
      !1,
      0,
      0
    ), le(b), R.drawArrays(R.TRIANGLE_STRIP, 0, 4);
    ...
    P.current = requestAnimationFrame(se);
  }, de = () => {
    const b = { passive: !0 };
    F.current.iMouse?.isNeeded && h.current && (h.current.addEventListener("mousemove", re, b), h.current.addEventListener("mouseout", J, b), h.current.addEventListener("mouseup", J, b), h.current.addEventListener("mousedown", te, b), h.current.addEventListener("touchmove", re, b), h.current.addEventListener("touchend", J, b), h.current.addEventListener("touchstart", te, b)), F.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      z,
      b
    ), h.current && (A.current = new ResizeObserver(K), A.current.observe(h.current), window.addEventListener("resize", K, b));
  }, we = () => {
    const b = { passive: !0 };
    F.current.iMouse?.isNeeded && h.current && (h.current.removeEventListener("mousemove", re, b), h.current.removeEventListener("mouseout", J, b), h.current.removeEventListener("mouseup", J, b), h.current.removeEventListener("mousedown", te, b), h.current.removeEventListener("touchmove", re, b), h.current.removeEventListener("touchend", J, b), h.current.removeEventListener("touchstart", te, b)), F.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      z,
      b
    ), A.current && (A.current.disconnect(), window.removeEventListener("resize", K, b));
  };
  return W(() => {
    V.current = n;
  }, [n]), W(() => {
    ...
    function R() {
      O();
      const y = v.current;
      y && h.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, Y(), Ce(), oe(Re(e || U2), r || V1), U(), requestAnimationFrame(se), de(), K());
    }
    return requestAnimationFrame(R), () => {
      const y = v.current;
      if (y) {
        if (y.getExtension("WEBGL_lose_context")?.loseContext(), y.useProgram(null), y.deleteProgram(k.current ?? null), b.length > 0)
          for (const D of b)
            y.deleteTexture(D._webglTexture);
        k.current = null;
      }
      we(), cancelAnimationFrame(P.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
}`, t6 = 10, r6 = 2, o6 = 0.5, n6 = 0.2, s6 = 1.5, ge = {
  duration: 0.5,
  ease: "easeOut"
}, O1 = {
  duration: 0.35,
...
function a6(e, r) {
  const [o, n] = $(t6), {
    ...
    animate: a,
    motionValue: l
  } = Ie(n6), { value: d, animate: c } = Ie(r6), { value: u, animate: f } = Ie(o6), { value: g, animate: p } = Ie(s6), h = rs(r, {
    fftSize: 512,
  ...
  return W(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), a(0.2, ge), c(1.2, ge), f(0.4, ge), p(1, ge);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), a(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, ge), f(0.7, ge), p([1.5, 2], O1);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), a(0.3, ge), c(0.5, ge), f(1, ge), p([0.5, 2.5], O1);
        return;
      case "speaking":
        n(70), a(0.3, ge), c(0.75, ge), f(1.25, ge), p(1.5, ge);
        return;
    }
  }, [
    e,
...
function u4({
  ...
  const { speed: u, scale: f, amplitude: g, frequency: p, brightness: h } = a6(r, s);
  return /* @__PURE__ */ t(
    Qt,
    {
      ref: d,
...
const h4 = ({
  ...
  const n = G(), s = me();
  return /* @__PURE__ */ i(Me, { children: [
    e && /* @__PURE__ */ t("span", { className: L(d6(), "truncate"), children: e }),
    /* @__PURE__ */ t(ye, { children: o && r && /* @__PURE__ */ t(
      Q.div,
      {
      ...
      Q.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ i("div", { className: "flex items-center gap-1", children: [
            ...
            o && /* @__PURE__ */ t("span", { className: L(Pe()), children: o })
          ] }),
          n === "people" && /* @__PURE__ */ t(
            Bn,
            {
          ...
          n === "alert" && /* @__PURE__ */ t(Pn, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ t(h6, { balance: e.balance })
        ]
      }
    ),
    o && !u6.has(n) && /* @__PURE__ */ t(
      Q.span,
      {
        className: L(Pe()),
        animate: { opacity: s ? 0 : 1 },
...
const p6 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), v6 = ({
  label: e,
  direction: r
}) => {
  const o = er[r];
  ...
  const s = `sparkline-gradient-${Y1().replace(/:/g, "")}`, a = g6(e, o), l = er[a];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(jn, { width: "100%", height: "100%", children: /* @__PURE__ */ i(
          Zn,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(_n, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                Un,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(v6, { label: r, direction: a })
      ]
    }
  ) });
}, tr = C(
  (e, r) => {
    const {
      ...
      className: c,
      ...u
    } = e, [f, g] = $(!1), [p, h] = $(!1), v = f || p, m = me(), k = v && !!d, N = {
      duration: m ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, P = () => {
      l?.();
...
const w6 = ["className"], rr = C((e, r) => {
  const o = w6.reduce((n, s) => {
    const { [s]: a, ...l } = n;
    return l;
  }, e);
...
const k6 = () => /* @__PURE__ */ i(
  ...
  "balance",
  "sparkline"
], or = 180, L6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : or, x6 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, b6 = (e) => e.showActions !== !1, y6 = (e) => Object.fromEntries(
...
function M6(e) {
  ...
  } = e, [c, u] = $(!1), f = Y1(), g = I(null), p = L6(
    d
  ), h = a.length > p, v = c ? a : x6(a, p), m = b6(e) ? e : null, k = y6(e);
  return W(() => {
    c && g.current?.focus();
  }, [c]), /* @__PURE__ */ i(
    "section",
    {
      ...
      children: [
        ...
        m && /* @__PURE__ */ t("div", { className: "flex items-center justify-end gap-3 border-0 border-t border-solid border-f1-border-secondary px-4 py-3", children: /* @__PURE__ */ t(
          pe,
          {
            type: "button",
            label: m.primaryActionLabel,
            icon: m.primaryActionIcon,
            onClick: m.onPrimaryAction
          }
        ) })
      ]
    }
...
M6.displayName = "F0AiProposalCard";
const E6 = ({
  icon: e,
  title: r,
  children: o
...
}, R6 = (e) => q0[e] ?? nt, F6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(ie, { icon: R6(e), size: "md", color: "default" }) }) : null;
function N6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(E6, { icon: Ke, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, a) => {
    const l = /* @__PURE__ */ t(F6, { iconName: s.icon });
...
function S6({
  ...
  const n = G(), s = I(null), a = r ?? n.ai.aiTable.title, l = Z(
    (d) => {
      if (!s.current) return;
              ...
              /* @__PURE__ */ t("tbody", { children: e.rows.map((d, c) => /* @__PURE__ */ t("tr", { children: e.columns.map((u) => {
                ...
                return /* @__PURE__ */ t(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ t(ne, { children: f == null ? "" : String(f) })
                  },
                  u
                );
              }) }, c)) })
...
S6.displayName = "F0AiTableCard";
function T6({ credits: e, trigger: r }) {
  const o = G(), [n, s] = $(!1), [a, l] = $(!1), [d, c] = $(!1), [u, f] = $(null), g = Z(
    (v) => {
      s(v), v && e?.fetchUsage && (l(!0), c(!1), e.fetchUsage().then((m) => {
        f(m), c(!1);
      }).catch(() => {
        c(!0);
      }).finally(() => {
        ...
        children: [
          h && /* @__PURE__ */ i("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            ...
            /* @__PURE__ */ i("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ t(ne, { tag: "span", className: "font-medium", children: e.companyName ?? "" }),
...
function A6({
  ...
  const o = G(), n = me(), [s, a] = $(!1), [l, d] = $(!1), [c, u] = $(!1), [f, g] = $(null), p = Z(
    (k) => {
      a(k), k && e?.fetchUsage && (d(!0), u(!1), e.fetchUsage().then((N) => {
        g(N), u(!1);
      }).catch(() => {
        u(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const h = !!e.companyName, v = f && f.total > 0 ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, m = f ? Math.max(0, f.total - f.used) : 0;
...
const We = ({
...
) : e ? /* @__PURE__ */ t(T6, { credits: e, trigger: o }) : null, p4 = We, v4 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const h = G(), v = Gn(`(max-width: ${Wn.md}px)`, {
        ...
        /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ t(
          Se,
          {
            ...
            children: /* @__PURE__ */ i("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ t(ne, { lines: 1, className: "min-w-0 text-left", children: o ?? h.ai.newConversation }),
...
function $6() {
  if (!(typeof navigator > "u"))
    return Yn(navigator.language);
}
function B6(e) {
  const r = new Date(e), o = /* @__PURE__ */ new Date();
  return bt(r) ? "today" : yt(r) ? "yesterday" : Xn(r, o) ? "thisMonth" : "older";
}
function I6(e, r) {
  const o = new Date(e), n = $6(), s = w1(o, "p", { locale: n });
  if (bt(o)) return `${r.today}, ${s}`;
  if (yt(o)) return `${r.yesterday}, ${s}`;
  const a = !qn(o, /* @__PURE__ */ new Date());
      ...
      children: [
        /* @__PURE__ */ i(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ t(ne, { lines: 1, className: "py-0.5 text-left font-medium", children: e.title }),
        ...
        n ? (
          ...
          /* @__PURE__ */ t(
            "div",
            {
              ...
              children: /* @__PURE__ */ t(Kn, { size: "small" })
            }
          )
        ) : /* @__PURE__ */ t(
          "div",
...
const G1 = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], j6 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(ue, { className: L("h-4 rounded", e) }) }), W1 = ({
  titleWidth: e,
  rows: r
}) => /* @__PURE__ */ i("div", { className: "flex flex-col gap-0.5", children: [
  /* @__PURE__ */ t("div", { className: "flex items-center p-1.5", children: /* @__PURE__ */ t(ue, { className: L("h-3 rounded", e) }) }),
  r.map((o, n) => /* @__PURE__ */ t(j6, { width: o }, n))
] });
function Z6() {
...
const m4 = ({
  ...
  const h = X(
    ...
    return n.filter((x) => x.title.toLowerCase().includes(w));
  }, [n, g]), m = X(
                  ...
                  /* @__PURE__ */ t(
                    Se,
                    {
                      ...
                      children: /* @__PURE__ */ i("div", { className: "flex w-full items-center gap-2", children: [
                        ...
                        /* @__PURE__ */ t(ne, { lines: 1, className: "text-left", children: f.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ t(Z6, {}),
...
function w4({
  ...
  const [a, l] = $([]), [d, c] = $(!1), [u, f] = $(null), [g, p] = $(_6), [h, v] = $(() => /* @__PURE__ */ new Set()), m = Z(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);
    } catch (w) {
      const x = w instanceof Error ? w.message : "Failed to fetch chat history";
      f(x), l([]);
    } finally {
      c(!1);
    }
  ...
  const k = Z((w, x) => {
    p((M) => {
      if (x === M.has(w)) return M;
      const A = new Set(M);
      return x ? A.add(w) : A.delete(w), q1(A), A;
    });
  }, []), N = Z((w, x) => {
    v((M) => {
      if (x === M.has(w)) return M;
      const A = new Set(M);
      return x ? A.add(w) : A.delete(w), A;
    });
  }, []), P = Z(
    (w, x) => {
      const M = x ? n : s;
      k(w, x), M && (N(w, !0), M(w).catch(() => k(w, !x)).finally(() => N(w, !1)));
    },
    [n, s, k, N]
  ), H = Z((w) => P(w, !0), [P]), S = Z(
    (w) => P(w, !1),
    ...
    async (w) => {
      N(w, !0);
      try {
        await o(w), l((x) => x.filter((M) => M.id !== w)), p((x) => {
          if (!x.has(w)) return x;
          const M = new Set(x);
          return M.delete(w), q1(M), M;
        });
      } catch {
        m();
      } finally {
...
const U6 = Q.create(es), O6 = ({
  ...
  const { t: a } = G(), l = me(), d = o ?? a("ai.applyingChanges");
  return W(() => {
    if (!r) return;
    const c = document.activeElement;
    c && c.getAttribute("name") !== "one-ai-input" && c.blur();
  }, [r]), /* @__PURE__ */ i("div", { className: L("relative flex flex-1 flex-col", n), children: [
    /* @__PURE__ */ t(ye, { children: r && // Zero-height sticky anchor pinned to the top of the scroll viewport,

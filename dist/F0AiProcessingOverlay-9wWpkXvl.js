...
import { dg as Br, aI as Ir, dh as Pr, an as nt, cf as Dr, di as jr, dj as _r, dk as Zr, dl as Or, cg as Ur, cl as st, ce as zr, dm as Gr, ax as ae, dn as Wr, b7 as qr, dp as Xr, dq as Yr, dr as Kr, aP as Qr, ds as Jr, cL as eo, y as it, aC as to, dt as ro, o as le, ar as at, ai as q1, n as lt, bF as oo, cj as no, du as so, bs as io, cK as ao, ap as F1, aZ as lo, bJ as ct, dv as co, cI as uo, l as y1, cG as fo, dw as ho, ca as dt, br as po, dx as mo, dy as Co, dz as go, dA as wo, dB as vo, dC as ut, cz as xo, cA as bo, dD as Lo, dE as ko, dF as yo, dG as Mo, dH as Ro, bU as Fo, ci as No, dI as Vo, dJ as So, dK as To, E as Ho, dL as Ao, dM as Eo, dN as $o, dO as Bo, dP as Io, bT as Po, cJ as Do, aA as jo, cv as _o, dQ as Zo, dR as Oo, dS as Uo, dT as zo, dU as Go, dV as Wo, dW as qo, aV as Xo, bV as Yo, U as ft, dX as Ko, ah as Qo, aq as Jo, bW as ht, c9 as en, R as pt, dY as tn, i as rn, bI as on, bH as nn, dZ as sn, d_ as an, bX as mt, bY as ln, bZ as cn, bq as dn, a$ as un, d$ as fn, j as hn, bD as Ct, bC as gt, bx as pn, e0 as wt, az as mn, ch as ce, q as Cn, bA as de, e1 as gn, e2 as wn, e3 as ue, O as vn, Q as xn, cH as vt, e4 as bn, af as Ln, ae as kn, e5 as yn, e6 as Mn, e7 as Rn, e8 as Fn, c7 as Nn, e9 as xt, ea as Vn, aH as Sn, aB as Tn, eb as Hn, ag as i1, a7 as H1, cq as An, u as G, c6 as En, S as h1, bS as bt, V as a1, as as $n, m as w1, ec as Bn, aD as l1, aJ as v1, ad as M1, a6 as Q, cQ as Lt, t as fe, ed as In, x as he, b as k1, c4 as Pn, ee as Dn, c5 as jn, aj as _n, bp as Zn, av as pe, b_ as On, b$ as Un, c0 as zn, c1 as Me, at as Gn, aQ as kt, bf as yt, bR as Wn, b6 as qn, cY as Xn, ef as Yn, eg as Kn, bl as Mt, eh as Qn, cU as Jn, ei as es, bh as B1, by as Rt, ej as Ft, bz as Nt, c as oe, ck as Re, ek as Vt, el as ts, em as rs, aG as os, en as ns, bE as me, cw as ss, eo as is, ep as as, eq as ls, er as cs, es as ds, w as us, s as fs, v as St, ab as hs, ac as ps, aE as Fe, et as Tt, eu as Ht, ev as ms, ew as Cs, aM as gs, ay as ws, ex as vs, ey as xs, d as bs } from "./F0CanvasPanel-DXAALEao.js";
import { d as k, f as p1, g as Ls } from "./tooltip-Cik7KBQT.js";
import { createPortal as At } from "react-dom";
import { defaultTranslations as ks } from "./i18n-provider-defaults.js";
import { useTrackVolume as ys } from "@livekit/components-react";
import { F as Ms } from "./Printer-BD-FEi_2.js";
import { F as Rs, c as Fs, b as Ns, a as Vs } from "./VolumeMuted-DKLKhxyd.js";
function Ss(e, r, o) {
  Ar(() => e.on(r, o), [e, r, o]);
}
const Ts = (e, r) => /* @__PURE__ */ a(
  "svg",
  {
...
const T0 = (e, r) => /* @__PURE__ */ a(
...
), p2 = m(h2), m2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Hs,
  Add: Br,
  Ai: Ir,
  ...
  Calculator: Jr,
  Calendar: eo,
  CalendarArrowDown: ri,
  CalendarArrowLeft: ni,
  CalendarArrowRight: ii,
  CameraPlus: li,
  CardPin: di,
  ChartFunnel: fi,
  ChartHorizontalBars: pi,
  ChartLine: Ci,
  ChartPie: wi,
  ChartVerticalBars: xi,
  Check: it,
  CheckCircle: to,
  CheckCircleLine: Li,
  CheckDouble: ro,
  ...
  Messages: m5,
  Microphone: ht,
  MicrophoneNegative: en,
  Minimize: pt,
  MinimizeHorizontal: tn,
  Minus: rn,
  Mobile: g5,
  Money: $t,
  MoneyBag: x5,
  MonitorDot: L5,
  MonitorSmartphone: y5,
  Moon: R5,
  Mouse: N5,
  MoveDown: on,
  MoveTop: S5,
  ...
  Wifi: p2,
  Windows: Hn
}, Symbol.toStringTag, { value: "Module" })), C2 = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const $2 = H1({
  ...
  ({
    ...
    const E1 = r1 && r1 !== "none" || e1 && e1 !== "none" || j && j !== "none" || o1 && o1 !== "none", T1 = X && X !== "none" || E1, D1 = { sm: x1, md: Y1, lg: K1, xl: Q1 }, j1 = B2.map((_1) => {
      const Z1 = D1[_1];
      return Z1 ? E2(_1, Z1) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
      ...
      e && /* @__PURE__ */ a(R1, { children: [
        /* @__PURE__ */ t(
          i1,
          {
            ...
            onClick: (b) => {
              b.preventDefault(), i.current?.click();
            }
          }
        ),
        /* @__PURE__ */ t(
...
function D2({
  ...
  return e.errorMessage ? /* @__PURE__ */ t($n, { label: e.errorMessage, children: n }) : n;
}
const j2 = {
  soft: {
    text: "",
...
const O2 = ({
  ...
  return W(() => {
    ...
    if (s)
      return d(!1), c(g), v(), p.current = setTimeout(() => {
...
`) ? o + "_" : o
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, G2).map((r) => /* @__PURE__ */ t(
  Lt,
  {
...
const Y2 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ a(
    fe,
    {
      ...
      children: [
        /* @__PURE__ */ t(In, { asChild: !0, children: /* @__PURE__ */ t(
          "div",
          {
            ref: c,
            ...
            children: e.map((C, h) => /* @__PURE__ */ t(
              i1,
              {
                ...
                onClick: (g) => {
                  u.current = g.currentTarget, l.current = !1, i((v) => v === h ? null : h), o?.(null);
                }
              },
              `${C.label}-${h}`
            ))
        ...
        p && /* @__PURE__ */ a(
          he,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: X2(p.items).map((C, h) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: (g) => {
...
function tl(e) {
  ...
  const v = O(
    async (A) => {
      ...
      const S = (y) => o(
        (B) => B.map(
          (N) => x.includes(N.id) ? { ...N, status: "error", errorMessage: y } : N
        )
      );
      try {
        const y = await l(V);
...
function il({
  ...
  const [i, c] = D(!1), [u, l] = D(""), [f, d] = D([]), [p, C] = D(!1), [h, g] = D(0), [v, w] = D([]), b = $(-1), H = $(null), A = $(0), V = $(-1);
  W(() => {
    if (!n) {
      c(!1);
      return;
    ...
    const T = rl(e, o, v);
    if (!T) {
      c(!1), l(""), d([]), g(0), b.current = -1, V.current = -1;
      return;
    }
    if (T.atIndex === V.current)
      return;
    b.current = T.atIndex, l(T.query), c(!0), g(0), C(!0), H.current && clearTimeout(H.current);
    const I = ++A.current;
  ...
  const F = O(() => {
    ...
    (T) => {
      ...
      let I = T;
      const U = [...v].sort((Z, z) => z.name.length - Z.name.length);
      for (const Z of U) {
...
` || z === "	";
  ...
  const B = K(() => {
    if (!i || b.current === -1) return null;
    const T = s.current;
    if (!T) return null;
    const I = nl(T, b.current), U = T.offsetLeft + I.left, z = (T.offsetParent ? T.offsetParent.offsetHeight : 0) - (T.offsetTop + I.top);
...
const al = /[\\`*_{}[\]()#+\-.!|~>]/g, ll = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(al, "\\$&")).join(""), _4 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const _1 = async (Y) => {
    if (Y.preventDefault(), !o1) {
      if (s1.close(), o)
        ...
        const b1 = s1.transformMentions(N.trim()), ee = ll(b1), O1 = E1.flatMap(
  ...
  }, we = q ? q.prompt ?? q.title : null, ve = P1 ? [y.ai.listening] : we ? [we] : s ?? [], Nr = ve.length > 1, Vr = K(() => K2(N, s1.mentions, {
    cursorPosition: I,
  ...
  ) : null, Tr = H && A && !!x && x.length > 0, be = A && H, { motionProps: Hr } = Dn(
    H,
    160,
    0.5
  );
    ...
    Q.div,
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(_2, { creditWarning: i, children: /* @__PURE__ */ a(
            Q.form,
            {
              "aria-busy": o,
              ref: r1,
                        ...
                        Q.div,
                        {
                          ...
                          children: /* @__PURE__ */ a(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ t("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ t(jn, { type: "critical", size: "sm" }) }),
        ...
        Tr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(W2, { cards: x }) }),
        b && H && A && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: b }),
...
function pl({
  ...
  return /* @__PURE__ */ t(Zn, { ...r, variant: "link", href: r.href, children: e });
}
function ml({
  children: e,
  ...r
...
function A1({
  ...
  return /* @__PURE__ */ a(
    On,
    {
      ...
      children: [
        /* @__PURE__ */ t(Un, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          zn,
          {
            side: "top",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ t(Wn, { file: e.file, size: "lg" }),
          e?.type === "icon" && /* @__PURE__ */ t(qn, { icon: e.icon, size: "md" }),
...
const Ve = 7, Dl = 625, Se = /* @__PURE__ */ new Set();
function jl(e) {
...
function Zl(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = Yn(e), i = [];
...
function lr(e, r) {
  ...
  return { type: "item", text: _l(String(e)) };
}
function cr({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: d } = k1(), p = Pl(e), C = u ?? p, h = $(() => {
  }), g = n ?? e, v = s ?? r ?? "", w = l?.type === "form" && l.formName === e, b = () => f({
    type: "form",
    title: g,
    description: v,
    formName: e,
  ...
  h.current = b, W(() => {
    typeof window > "u" || window.innerWidth < Dl || Se.has(e) || (Se.add(e), h.current());
  }, [e]);
  const H = i && c ? Object.entries(i).map(([F, x]) => {
    const S = c[F], y = C?.(F, S, {
      fieldType: x.fieldType,
      customFieldName: x.customFieldName
    });
    if (!y && x.fieldType === "custom" && typeof S == "object" && S !== null)
      return null;
    const B = y ?? lr(S, x.fieldType), N = ["richtext", "textarea"];
    return {
      label: x.label,
      content: B,
...
const fr = W1(void 0), z4 = () => I1(fr), Gl = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), Wl = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
...
const mr = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), r6 = ({
  text: e,
  renderMarkdown: r
  ...
  const c = e.rawData, u = t6(
    e?.content,
    c
  ), l = (e6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, d = l.length > 0, { anchor: p, clear: C } = dr({
    containerRef: i,
    enabled: d
  });
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ t(r6, { text: f, renderMarkdown: n }),
...
}, n6 = 35, s6 = 22, i6 = 400, a6 = 2500, l6 = 220, c6 = ({
  messages: e,
  caption: r,
  subtitle: o,
  onClick: n,
  ...
  W(() => {
    ...
    let b;
    if (f === "starting")
      b = setTimeout(() => d("writing"), i6);
    else if (f === "writing")
      u < C.length ? b = setTimeout(() => l((H) => H + 1), n6) : d("holding");
    else if (f === "holding") {
      if (e.length <= 1) return;
      b = setTimeout(() => d("erasing"), a6);
    } else f === "erasing" && (u > 0 ? b = setTimeout(() => l((H) => H - 1), s6) : b = setTimeout(() => {
...
function d6({
  ...
  const h = O(() => {
    const g = e.current;
    if (!g) return;
    const { scrollTop: v, scrollHeight: w, clientHeight: b } = g, H = w - v - b;
    f(H > b);
  }, [e]);
  return W(() => {
    const g = e.current;
    ...
    s > d.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!g || !v) return;
        const w = g.getBoundingClientRect(), b = v.getBoundingClientRect(), H = g.scrollTop + (b.top - w.top);
...
const u6 = {
...
}, G4 = (e) => /* @__PURE__ */ t(Xl, { children: /* @__PURE__ */ t(f6, { ...e }) }), f6 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: F, handleSubmit: x, handleClose: S } = Yl(
    C ?? u6
  ), y = G(), B = b ?? Wl, N = H ?? o6, T = K(() => {
    const j = n ?? y.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((n1) => typeof n1 == "string" && n1.length > 0);
  }, [n, y.ai.defaultInitialMessage]), I = !r && e.length === 0 && T.length > 0, U = $(null), Z = $(null), z = $(null), J = $(null), t1 = $(null), { showScrollBtn: q, turnMinHeight: X, scrollToBottom: r1 } = d6({
    viewportRef: U,
    contentRef: Z,
    endRef: z,
    lastTurnRef: t1,
...
}, h6 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
...
const m6 = ({
  ...
  const C = G().ai.clarifyingQuestion.typeYourAnswer, h = $(null), g = Ls(h, c);
  ie(() => {
    const w = h.current;
    if (!w) return;
    w.style.height = "auto";
    const b = Math.min(w.scrollHeight, $e);
    w.style.height = `${b}px`, w.style.overflowY = w.scrollHeight > $e ? "auto" : "hidden";
  }, [n]);
  const v = e === "single" ? /* @__PURE__ */ t(gr, { isSelected: o && !r }) : /* @__PURE__ */ t(
    Vt,
    {
      checked: s,
      onCheckedChange: () => f(!s),
      ...
      children: [
        ...
        /* @__PURE__ */ t(
          "textarea",
          {
            ...
            onFocus: u,
            onKeyDown: (w) => {
              w.key === "Enter" && !w.shiftKey && i && (w.preventDefault(), d());
            },
            placeholder: C,
            "aria-label": C,
...
const g6 = ({
  ...
  const o = G(), n = v1(), {
    ...
    current: String(i + 1),
    total: String(c)
  }) : void 0, U = b.length > 0, Z = (F ?? "").trim().length > 0, z = U || x && Z || A === !0, J = r === !0 && T, t1 = () => {
    J || l();
  }, q = () => {
    J || f();
  }, X = (f1) => {
    const m1 = y === "single" && b.includes(f1);
  ...
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: o1, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(M1, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      Q.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: n1, ease: v6 },
        children: [
          /* @__PURE__ */ t(
            w6,
            {
...
function Be(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), u = Math.min(i + n, s), l = Math.min(u, Math.floor(e / 2)), f = Math.min(u, Math.floor(r / 2)), d = (j) => j / e * 2 - 1, p = (j) => j / r * 2 - 1, C = 0, h = e, g = 0, v = r, w = l, b = e - l, H = f, A = r - f, V = d(C), F = d(h), x = p(g), S = p(v), y = d(w), B = d(b), N = p(H), T = p(A), I = 0, U = 0, Z = 1, z = 1, J = l / e, t1 = 1 - l / e, q = f / r, X = 1 - f / r, r1 = new Float32Array([
    // Top strip
    V,
    x,
    F,
...
class Q4 {
  ...
  resize(r, o, n) {
    ...
    s.enableVertexAttribArray(v), s.vertexAttribPointer(v, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, l), s.bufferData(s.ARRAY_BUFFER, g, s.STATIC_DRAW);
  ...
  setupGL() {
    ...
    const C = r.getUniformLocation(o, "uResolution"), h = r.getUniformLocation(o, "uTime"), g = r.getUniformLocation(o, "uBorderWidth"), v = r.getUniformLocation(o, "uGlowWidth"), w = r.getUniformLocation(o, "uBorderRadius"), b = r.getUniformLocation(o, "uColors"), H = r.getUniformLocation(o, "uGlowExponent"), A = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(g, this.options.borderWidth), r.uniform1f(v, this.options.glowWidth), r.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(H, 2), r.uniform1f(A, 1.8)) : (r.uniform1f(H, 1), r.uniform1f(A, 1));
    const V = (this.options.colors || M6).map(R6);
...
const Pe = ["lowp", "mediump", "highp"], F6 = `
void main(void){
...
}`, je = "iTime", _e = "iTimeDelta", Ze = "iDate", Oe = "iFrame", Ue = "iMouse", ze = "iResolution", V6 = "iChannel", Ge = "iChannelResolution", We = "iDeviceOrientation";
function S6(e, r) {
...
}, re = 9729, qe = 9728, $6 = 9987, Xe = 33071, Ye = 10497;
class B6 {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    const p = 0, C = o.RGBA, h = 1, g = 1, v = 0, w = o.RGBA, b = o.UNSIGNED_BYTE, H = new Uint8Array([255, 255, 255, 0]), A = o.createTexture();
    ...
    let F = await V(), x = (F.width & F.width - 1) === 0 && (F.height & F.height - 1) === 0;
    return (r.wrapS !== Xe || r.wrapT !== Xe || r.minFilter !== qe && r.minFilter !== re) && !x && (F = this.makePowerOf2(F), x = !0), o.bindTexture(o.TEXTURE_2D, A), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, l), o.texImage2D(
      o.TEXTURE_2D,
      p,
      C,
      w,
      b,
      F
    ), x && r.minFilter !== qe && r.minFilter !== re && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || Ye
    ), o.texParameteri(
...
}, Qe = (e, r, o) => e * (1 - o) + r * o, I6 = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function P6({
  fs: e,
  vs: r = De,
  textures: o = [],
  ...
  const h = $(null), g = $(null), v = $(null), w = $(null), b = $(void 0), H = $(void 0), A = $(!1), V = $(void 0), F = $(0), x = $([0, 0]), S = $([]), y = $(0), B = $(void 0), N = $({
...
${R}`));
    ...
    if (w.current = M.createProgram(), !(!w.current || !E || !P)) {
      ...
      M.useProgram(w.current), b.current = M.getAttribLocation(
        w.current,
        "aVertexPosition"
      ), M.enableVertexAttribArray(b.current);
    }
  }, j = () => {
    if (n)
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (M, P) => (N.current[`${V6}${P}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, I(M, P), S.current[P] = new B6(L), S.current[P]?.load(M).then((E) => {
            I(E, P);
          }))
        );
        Promise.all(R).then(() => {
...
`,
    ...
    return L.includes("mainImage") && (P = P.concat(F6)), P;
  }, f1 = (L) => {
    const R = g.current;
    ...
    if (N.current.iMouse?.isNeeded && l !== 1 && Array.isArray(M)) {
      ...
      M[0] = Qe(P, x.current[0] ?? 0, l), M[1] = Qe(E, x.current[1] ?? 0, l);
    }
  ...
  return W(() => {
    ...
    function R() {
      U();
      const M = g.current;
      M && h.current && (M.clearColor(...s), M.clearDepth(1), M.enable(M.DEPTH_TEST), M.depthFunc(M.LEQUAL), M.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, j(), o1(), e1(n1(e || N6), r || De), Z(), requestAnimationFrame(m1), N1(), X());
    }
...
}`, j6 = 10, _6 = 2, Z6 = 0.5, O6 = 0.2, U6 = 1.5, C1 = {
  duration: 0.5,
  ease: "easeOut"
}, Je = {
  duration: 0.35,
...
function z6(e, r) {
  const [o, n] = D(j6), {
    ...
    animate: i,
    motionValue: c
  } = U1(O6), { value: u, animate: l } = U1(_6), { value: f, animate: d } = U1(Z6), { value: p, animate: C } = U1(U6), h = ys(r, {
    fftSize: 512,
...
function J4({
  ...
  const { speed: f, scale: d, amplitude: p, frequency: C, brightness: h } = z6(r, s);
  return /* @__PURE__ */ t(
    vr,
    {
      ref: u,
...
const e3 = ({
  ...
  const n = G(), s = v1();
  return /* @__PURE__ */ a(R1, { children: [
    e && /* @__PURE__ */ t("span", { className: k(X6(), "truncate"), children: e }),
    ...
    /* @__PURE__ */ a(
      Q.div,
      {
        ...
        children: [
          ...
          n === "alert" && /* @__PURE__ */ t(ss, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ t(Q6, { balance: e.balance })
        ]
      }
    ),
    o && !K6.has(n) && /* @__PURE__ */ t(
      Q.span,
      {
        className: k(z1()),
        animate: { opacity: s ? 0 : 1 },
...
const t4 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), r4 = ({
  label: e,
  direction: r
}) => {
  const o = br[r];
  ...
  const s = `sparkline-gradient-${G1().replace(/:/g, "")}`, i = e4(e, o), c = br[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(as, { width: "100%", height: "100%", children: /* @__PURE__ */ a(
          ls,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(cs, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                ds,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(r4, { label: r, direction: i })
      ]
    }
  ) });
}, Lr = m(
  (e, r) => {
    const {
      ...
      className: l,
      ...f
    } = e, [d, p] = D(!1), [C, h] = D(!1), g = d || C, v = v1(), w = g && !!u, b = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, H = () => {
      c?.();
...
const n4 = ["className"], kr = m((e, r) => {
  const o = n4.reduce((n, s) => {
    const { [s]: i, ...c } = n;
    return c;
  }, e);
...
const s4 = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], yr = 180, i4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : yr, a4 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, l4 = (e) => e.showActions !== !1, c4 = (e) => Object.fromEntries(
...
function d4(e) {
  ...
  } = e, [l, f] = D(!1), d = G1(), p = $(null), C = i4(
    u
  ), h = i.length > C, g = l ? i : a4(i, C), v = l4(e) ? e : null, w = c4(e);
  return W(() => {
    l && p.current?.focus();
  }, [l]), /* @__PURE__ */ a(
    "section",
...
d4.displayName = "F0AiProposalCard";
const u4 = ({
  icon: e,
  title: r,
  children: o
...
}, f4 = (e) => m2[e] ?? ut, h4 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(a1, { icon: f4(e), size: "md", color: "default" }) }) : null;
function p4({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(u4, { icon: de, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const c = /* @__PURE__ */ t(h4, { iconName: s.icon });
...
p4.displayName = "F0AiMessageSources";
async function m4(e, r, o) {
  const n = await import("./xlsx-CzlURDDb.js"), s = n.utils.table_to_book(e, { sheet: "Data" });
  n.writeFile(s, `${o}.${r}`);
}
function C4({
...
C4.displayName = "F0AiTableCard";
function g4({ credits: e, trigger: r }) {
  const o = G(), [n, s] = D(!1), [i, c] = D(!1), [u, l] = D(!1), [f, d] = D(null), p = O(
    (g) => {
      s(g), g && e?.fetchUsage && (c(!0), l(!1), e.fetchUsage().then((v) => {
        d(v), l(!1);
      }).catch(() => {
        l(!0);
      }).finally(() => {
...
const w4 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function v4({
  employeeCredits: e,
  trigger: r
}) {
  const o = G(), n = v1(), [s, i] = D(!1), [c, u] = D(!1), [l, f] = D(!1), [d, p] = D(null), C = O(
    (w) => {
      i(w), w && e?.fetchUsage && (u(!0), f(!1), e.fetchUsage().then((b) => {
        p(b), f(!1);
      }).catch(() => {
        f(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const h = !!e.companyName, g = d && d.total > 0 ? Math.min(100, Math.round(d.used / d.total * 100)) : 0, v = d ? Math.max(0, d.total - d.used) : 0;
...
const se = ({
...
) : e ? /* @__PURE__ */ t(g4, { credits: e, trigger: o }) : null, o3 = se, n3 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const g = G(), v = v1(), w = hs(`(max-width: ${ps.md}px)`, {
...
function x4(e) {
  ...
  return Tt(r) ? "today" : Ht(r) ? "yesterday" : Cs(r, o) ? "thisMonth" : "older";
}
function b4(e, r, o) {
  const n = new Date(e), s = Fe(n, "p", { locale: o });
  if (Tt(n)) return `${r.today}, ${s}`;
  if (Ht(n)) return `${r.yesterday}, ${s}`;
  const i = !ms(n, /* @__PURE__ */ new Date());
  return `${Fe(n, i ? "MMM d yyyy" : "MMM d", {
    locale: o
  })}, ${s}`;
}
function L4(e) {
...
function k4({
  ...
  const f = G(), d = gs(), p = K(
    ...
    [e.updatedAt, f.ai.today, f.ai.yesterday, d]
  );
  return /* @__PURE__ */ a(
    "div",
    {
        ...
        /* @__PURE__ */ a(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("span", { className: "hidden shrink-0 text-sm font-medium text-f1-foreground-tertiary group-focus-within:inline group-hover:inline", children: C })
            ]
          }
        ),
        ...
        n ? (
          ...
          /* @__PURE__ */ t(
            "div",
            {
              ...
              children: /* @__PURE__ */ t(ws, { size: "small" })
            }
          )
        ) : /* @__PURE__ */ t(
          "div",
          {
            ...
            children: /* @__PURE__ */ t(pe, { items: p, children: /* @__PURE__ */ t(
              i1,
              {
                icon: dt,
                variant: "ghost",
...
const tt = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], y4 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(h1, { className: k("h-4 rounded", e) }) }), rt = ({
  titleWidth: e,
  rows: r
  ...
  r.map((o, n) => /* @__PURE__ */ t(y4, { width: o }, n))
] });
function M4() {
...
const s3 = ({
  ...
  const h = K(
    ...
    return n.filter((S) => S.title.toLowerCase().includes(x));
  }, [n, p]), v = K(
    () => g.filter((x) => c.has(x.id)),
    [g, c]
  ), w = K(
    () => g.filter((x) => !c.has(x.id)),
    [g, c]
...
function i3({
  ...
  const [i, c] = D([]), [u, l] = D(!1), [f, d] = D(null), [p, C] = D(R4), [h, g] = D(() => /* @__PURE__ */ new Set()), v = O(async () => {
    l(!0), d(null);
    try {
      const x = await r();
      c(x);
  ...
  const w = O((x, S) => {
    C((y) => {
      if (S === y.has(x)) return y;
      const B = new Set(y);
      return S ? B.add(x) : B.delete(x), ot(B), B;
    });
  }, []), b = O((x, S) => {
    g((y) => {
      if (S === y.has(x)) return y;
      const B = new Set(y);
      return S ? B.add(x) : B.delete(x), B;
    });
  }, []), H = O(
    (x, S) => {
      const y = S ? n : s;
      w(x, S), y && (b(x, !0), y(x).catch(() => w(x, !S)).finally(() => b(x, !1)));
    },
    [n, s, w, b]
  ), A = O((x) => H(x, !0), [H]), V = O(
    (x) => H(x, !1),
    ...
    async (x) => {
      b(x, !0);
      try {
        await o(x), c((S) => S.filter((y) => y.id !== x)), C((S) => {
          if (!S.has(x)) return S;
          const y = new Set(S);
          return y.delete(x), ot(y), y;
        });
      } catch {
        v();
      } finally {

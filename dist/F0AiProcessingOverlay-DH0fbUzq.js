...
const S0 = (e, r) => /* @__PURE__ */ i(
  ...
  Wifi: l2,
  Windows: Sn
}, Symbol.toStringTag, { value: "Module" })), w9 = ["xs", "sm", "md", "lg"], jt = ({
  inProgress: e,
  hasDataToSend: r,
  isPreSending: o,
...
const D2 = /[\\`*_{}[\]()#+\-.!|~>]/g, j2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(D2, "\\$&")).join(""), v9 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,

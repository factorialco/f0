...
import { useInsertionEffect as Sr, forwardRef as h, useRef as j, useEffect as q, useLayoutEffect as rt, useState as B, useMemo as Q, useCallback as _, createContext as Ge, useContext as Be, useId as ot, createElement as Tr, memo as Hr } from "react";
import { cU as Ar, cV as $r, Z as nt, bX as Br, cW as Ir, cX as Pr, cY as jr, cZ as Dr, b$ as st, bW as Zr, c_ as _r, a6 as s1, c$ as Or, aK as Ur, d0 as zr, d1 as Gr, d2 as Wr, ah as qr, d3 as Xr, co as Yr, aa as it, ad as Kr, d4 as Qr, ba as i1, a1 as at, S as We, bN as ct, bi as Jr, d5 as eo, d6 as to, b3 as ro, cn as oo, $ as Fe, av as no, bm as lt, d7 as so, cl as io, bV as Me, ch as ao, d8 as co, bP as dt, b2 as lo, d9 as fo, da as uo, db as ho, dc as go, dd as Co, de as ft, ca as po, cb as mo, df as vo, dg as wo, dh as xo, di as ko, dj as Lo, bw as bo, bZ as yo, dk as Mo, dl as Eo, dm as Ro, dn as Fo, dp as No, dq as Vo, dr as So, ds as To, bv as Ho, cm as Ao, ab as $o, c6 as Bo, dt as Io, du as Po, dv as jo, dw as Do, dx as Zo, dy as _o, dz as Oo, aq as Uo, bR as ut, M as zo, a0 as Go, bK as ht, bO as Wo, bQ as gt, dA as qo, bl as Xo, bk as Yo, dB as Ko, dC as Qo, bx as Ct, by as Jo, bz as en, b1 as tn, az as rn, dD as on, at as nn, bg as pt, bf as mt, b8 as sn, dE as vt, b7 as an, bY as a1, dF as cn, bc as c1, dG as ln, dH as dn, dI as l1, cj as fn, ci as un, ck as wt, dJ as hn, G as gn, E as Cn, dK as pn, dL as mn, dM as vn, dN as wn, bL as xn, dO as xt, dP as kn, ac as Ln, dQ as bn, L as ce, o as k, q as Se, c0 as yn, u as G, bJ as Mn, U as he, bI as kt, H as le, v as ge, a2 as En, Q as pe, dR as Rn, ae as ie, aQ as xe, A as Ee, p as J, ct as Lt, aE as d1, dS as Fn, aF as f1, aG as u1, b as be, bG as Nn, dT as Vn, bH as Sn, V as Tn, b0 as Hn, a5 as h1, bA as An, bB as $n, bC as Bn, bD as y1, a3 as In, al as bt, aT as yt, dU as Pn, cA as jn, dV as Dn, dW as Zn, aY as Mt, dX as _n, cu as On, dY as Un, aV as $e, b9 as Et, dZ as Rt, bb as Ft, c as r1, b_ as M1, d_ as Nt, d$ as zn, e0 as Gn, bq as Wn, e1 as qn, bh as g1, c7 as Xn, e2 as Yn, e3 as Kn, e4 as Qn, e5 as Jn, e6 as es, a8 as ts, af as rs, y as os, z as ns, ak as E1, e7 as Vt, e8 as St, e9 as ss, ea as is, aj as as, a7 as cs, eb as ls, ec as ds, d as fs } from "./F0CanvasPanel-1jMeiPUj.js";
...
const Sc = Se({
  ...
  ({
    ...
    const Ne = P && P !== "none" || oe && oe !== "none" || W && W !== "none" || ae && ae !== "none", je = X && X !== "none" || Ne, De = { sm: qe, md: Xe, lg: Ye, xl: Ie }, Qe = Tc.map((Ze) => {
      const _e = De[Ze];
      return _e ? Vc(Ze, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
  ...
  const Qe = async (K) => {
    if (K.preventDefault(), !W) {
      if (ee.close(), o)
        ...
        const we = ee.transformMentions(A.trim()), Je = n2(we), Oe = Pe.flatMap(
...
const fr = Ge(void 0), j6 = () => Be(fr), _2 = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), O2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
...
function Zl(e, r) {
  const [o, n] = B(Bl), {
    ...
    animate: i,
    motionValue: l
  } = Ue(jl), { value: d, animate: c } = Ue(Il), { value: u, animate: f } = Ue(Pl), { value: C, animate: p } = Ue(Dl), g = hs(r, {
    fftSize: 512,

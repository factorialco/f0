...
/**
 * @deprecated Use `F0Chip` from `@factorialco/f0-react` instead.
 */
export declare const Chip: WithDataTestIdReturnType_5<    {
...
/**
 * @deprecated Use `F0ChipProps` from `@factorialco/f0-react` instead.
 */
...
declare type ChipVariantValue = (typeof chipVariantValues)[number];

declare const chipVariantValues: readonly ["default", "selected"];
...
declare type F0ChipProps = BaseChipProps & ChipMediaVariant & {

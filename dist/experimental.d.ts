...
export declare interface ApplicationFrameSidePanelConfig {
    enabled: boolean;
    /**
...
export declare type ApplicationFrameSidePanelReturnValue = {
    ...
    setVisualizationMode: React.Dispatch<React.SetStateAction<ApplicationFrameSidePanelVisualizationMode>>;
...
export declare type ApplicationFrameSidePanelSide = (typeof applicationFrameSidePanelSides)[number];

export declare const applicationFrameSidePanelSides: readonly ["left", "right"];

export declare type ApplicationFrameSidePanelVisualizationMode = "sidepanel" | "fullscreen";
 ...
 */
export declare function useApplicationFrameSidePanel(): ApplicationFrameSidePanelReturnValue;

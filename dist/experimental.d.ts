...
import { F0FilterTagPickerFiltersDefinition as F0FilterTagPickerFiltersDefinition_2 } from './types';
import { F0FilterTagPickerProps as F0FilterTagPickerProps_2 } from './types';
 ...
 */
export declare const F0FilterTagPicker: <Filters extends F0FilterTagPickerFiltersDefinition_2>(props: F0FilterTagPickerProps_2<Filters>) => ReactElement;

export declare type F0FilterTagPickerFilterDefinition<Value extends F0FilterTagPickerOptionValue = F0FilterTagPickerOptionValue> = InFilterDefinition<Value>;

export declare type F0FilterTagPickerFiltersDefinition = Record<string, F0FilterTagPickerFilterDefinition>;

export declare type F0FilterTagPickerFilterToken<Filters extends F0FilterTagPickerFiltersDefinition> = {
    [Key in keyof Filters & string]: Filters[Key] extends InFilterDefinition<infer Value> ? {
...
export declare type F0FilterTagPickerMode = (typeof f0FilterTagPickerModes)[number];

export declare const f0FilterTagPickerModes: readonly ["mixed", "tags"];

export declare type F0FilterTagPickerOptionValue = string | number;

export declare interface F0FilterTagPickerProps<Filters extends F0FilterTagPickerFiltersDefinition> extends WithDataTestIdProps {
...
export declare interface F0FilterTagPickerTextToken {
...
export declare type F0FilterTagPickerValue<Filters extends F0FilterTagPickerFiltersDefinition> = Array<F0FilterTagPickerTextToken | F0FilterTagPickerFilterToken<Filters>>;
...
export declare function filterTagPickerValueToFiltersState<Filters extends F0FilterTagPickerFiltersDefinition>(value: F0FilterTagPickerValue<Filters>): FiltersState<Filters>;

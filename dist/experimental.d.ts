...
export declare function CompanySelector({ companies, selected, onChange, isLoading, withNotification, additionalOptions, variant, }: CompanySelectorProps): JSX_2.Element;
 ...
 */
export declare function SidebarPanelHeader({ title, actions, }: SidebarPanelHeaderProps): JSX_2.Element;
 ...
 */
export declare function SidebarUserMenu({ user, options, onDropdownClick, compact, }: SidebarUserMenuProps): JSX_2.Element;

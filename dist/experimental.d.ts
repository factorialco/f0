...
declare interface CalloutInternalProps extends TestableProps {
    title: string;
    onClose?: () => void;
    children: React.ReactNode;
...
declare interface CategoryBarProps extends TestableProps {
    data: {
        name: string;
        value: number;
        color?: string;
...
declare const DataList: ForwardRefExoticComponent<TestableProps & {
...
export declare interface DetailsItemType extends TestableProps {
    title: string;
...
export declare const Dialog: ForwardRefExoticComponent<Omit<TestableProps_2 & {
header: {
...
export declare const F0ActionBar: ({ isOpen, secondaryActions, label, testId, ...props }: F0ActionBarProps) => JSX_2.Element;

declare interface F0ActionBarProps extends TestableProps {
    /**
...
declare const F0AvatarAlert: ({ type, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, testId, }: AlertAvatarProps) => JSX_2.Element;
...
declare const F0AvatarPulse: {
    ({ firstName, lastName, src, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, pulse, onPulseClick, testId, }: F0AvatarPulseProps): JSX_2.Element;
    displayName: string;
};
...
declare type F0AvatarPulseProps = {
     ...
     */
    onPulseClick: () => void;
} & Pick<BaseAvatarProps_2, "aria-label" | "aria-labelledby" | "testId">;
...
declare interface F0IconProps extends SVGProps<SVGSVGElement>, VariantProps<typeof iconVariants>, TestableProps {
    icon: IconType;
    size?: "lg" | "md" | "sm" | "xs";
...
declare const F0TagAlert: ForwardRefExoticComponent<TestableProps_3 & {
text: string;
level: Level;
...
declare type F0TagRawProps = TestableProps & {
    /**
...
export declare const OneCalendarInternal: ({ mode, view, onSelect, defaultMonth, defaultSelected, showNavigation, showInput, minDate, maxDate, compact, weekStartsOn, testId, }: OneCalendarInternalProps) => JSX_2.Element;

export declare interface OneCalendarInternalProps extends TestableProps {
    mode: CalendarMode;
    view: CalendarView;
    onSelect?: (date: Date | DateRange | null) => void;
    defaultMonth?: Date;
...
export declare function OneDateNavigator({ onSelect, defaultValue, presets, granularities, hideNavigation, hideGoToCurrent, compareTo, defaultCompareTo, onCompareToChange, value, testId, ...props }: OneDatePickerProps): JSX_2.Element;

export declare interface OneDatePickerProps extends Omit<DatePickerPopupProps, "children">, TestableProps {
    hideNavigation?: boolean;
    hideGoToCurrent?: boolean;
}

export declare function OneEmptyState({ title, description, variant, emoji, actions, testId, }: Types.OneEmptyStateProps): JSX_2.Element;

declare type OneEmptyStateProps = TestableProps & {
    /**
...
declare function _OnePagination({ totalPages, currentPage, onPageChange, showControls, ariaLabel, visibleRange, hasNextPage, disabled, testId, }: OnePaginationProps): JSX_2.Element;

declare interface OnePaginationProps extends TestableProps {
    /**
...
declare function _Page({ children, header, embedded, testId }: PageProps): JSX_2.Element;
...
declare interface PageProps extends TestableProps {
    children?: React.ReactNode;
...
declare type Props_3 = TestableProps & {
    text: string;
} & ({
    color: NewColor;
} | {
...
export declare function WidgetInboxList({ items, minSize, onClickItem, showAllItems, onVisibleItemsChange, }: Props_7): JSX_2.Element;
...
export declare type WidgetInboxListProps = Props_7;
...
export declare function WidgetSimpleList({ items, gap, minSize, onClickItem, showAllItems, }: Props_8): JSX_2.Element;
...
export declare type WidgetSimpleListProps = Props_8;

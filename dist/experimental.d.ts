...
declare type DateRangeQuestionProps = BaseQuestionPropsForOtherQuestionComponents & {
    type: "daterange";
...
export declare type QuestionElement = Omit<TextQuestionProps, QuestionPropsToOmit> | Omit<RatingQuestionProps & {
    ...
    type: "date";
}, QuestionPropsToOmit> | Omit<DateRangeQuestionProps, QuestionPropsToOmit>;

declare type QuestionPropsToOmit = "onAction" | "onChange" | "onAddNewElement";

export declare type QuestionType = "rating" | "select" | "multi-select" | "text" | "longText" | "numeric" | "link" | "date" | "daterange";

...
declare type Props = {} & Pick<BaseHeaderProps, "avatar" | "title" | "description" | "primaryAction" | "secondaryActions" | "otherActions" | "metadata" | "status" | "deactivated" | "metadataRowGap" | "collapsed" | "showBottomBorder" | "onClose">;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const ResourceHeader: ({ avatar, title, description, primaryAction, secondaryActions, otherActions, status, metadata, deactivated, metadataRowGap, collapsed, showBottomBorder, onClose, }: Props) => JSX_2.Element;

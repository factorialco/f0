...
declare type EntitySelectQuestionProps = BaseQuestionPropsForOtherQuestionComponents & {
    entities?: EntitySelectEntity[];
    groups?: EntitySelectNamedGroup[];
    onLoadEntities?: () => void;
    entityLabel?: string;
...
export declare type QuestionElement = Omit<TextQuestionProps, QuestionPropsToOmit> | Omit<RatingQuestionProps & {
    ...
    type: "date";
}, QuestionPropsToOmit> | Omit<EntitySelectQuestionProps, QuestionPropsToOmit>;

declare type QuestionPropsToOmit = "onAction" | "onChange" | "onAddNewElement";

export declare type QuestionType = "rating" | "select" | "multi-select" | "text" | "longText" | "numeric" | "link" | "date" | "entity-select" | "entity-select-multi";

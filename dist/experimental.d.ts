...
declare interface AiTutorChatConfig {
    runtimeUrl?: string;
    agent?: string;
...
export declare interface AiTutorConfig {
...
export declare interface AiTutorLabels {
    buttonLabel: string;
    buttonTooltip: string;
}

export declare interface AiTutorMessage {
    role: "user" | "assistant";
    content: string;
}

export declare const AiTutorMessageInjector: ({ messages, }: {
 ...
 */
declare type VisualizationMode = "sidepanel" | "fullscreen" | "canvas" | "floating";

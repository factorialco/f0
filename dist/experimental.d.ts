...
export declare const F0FilterPicker: <Definition extends FiltersDefinition>(props: F0FilterPickerRootProps<Definition> & {
    dataTestId?: string;
}) => ReactElement | null;
 ...
 */
declare type F0FilterPickerRootProps<Definition extends FiltersDefinition> = {

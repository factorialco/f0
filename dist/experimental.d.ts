...
export declare type SelectProps<T extends string, R = unknown> = {
    ...
    clearable: true;
    onChange: (value: T | undefined, originalItem?: ResolvedRecordType<R>, option?: SelectItemObject<T, ResolvedRecordType<R>>) => void;
} | {
    clearable?: false;
...
}) & Pick<InputFieldProps<T>, "loading" | "hideLabel" | "labelIcon" | "size" | "label" | "icon" | "placeholder" | "disabled" | "name" | "error" | "status" | "hint">;

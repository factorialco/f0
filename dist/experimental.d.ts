...
export declare type NavigationFilter<T, FilterDef extends NavigationFilterDefinition, InitialValue = T> = {
    /**
     ...
     */
    valueConverter?: (defaultValue: InitialValue, filterDef: FilterDef, i18n: TranslationsType) => T;
    /**
     * Renders the filter component.
     * @param props - The props of the filter
     * @returns The rendered component
     */
    render: (props: NavigationFilterComponentProps<T, FilterDef>) => React.ReactNode;
};

export declare type NavigationFilterComponentProps<T, FilterDef extends NavigationFilterDefinition> = {
    filter: FilterDef;
    value: T;
    onChange: (value: T) => void;
};

export declare type NavigationFilterDefinition = NavigationFilterDefinitionMap[keyof NavigationFilterDefinitionMap];

export declare type NavigationFilterDefinitionBase<T, Type extends string> = {
    type: Readonly<Type>;
    defaultValue: T;
};

export declare type NavigationFilterDefinitionMap = {
...
export declare type NavigationFilterType = keyof NavigationFilterDefinitionMap;

/**
 * Represents a navigation filter with its current value.
 * @template T - The type of the filter value
 */
export declare type NavigationFilterValue<T> = T extends DateNavigatorFilterDefinition ? DateValue : T extends ListNavigatorFilterDefinition ? ListValue : T extends undefined ? undefined : never;

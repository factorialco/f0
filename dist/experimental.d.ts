...
export declare interface ApplicationFrameProps {
    ai?: Omit<F0AiChatProviderProps, "children">;
...
declare const F0AiChatProvider: ({ enabled, greeting, initialMessage, welcomeScreenSuggestions, onThumbsUp, onThumbsDown, children, agent, ...copilotKitProps }: F0AiChatProviderProps) => JSX_2.Element;

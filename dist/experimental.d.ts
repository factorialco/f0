 ...
 */
export declare const F0SharingDialog: typeof F0SharingDialog_2;

declare function F0SharingDialog_2<Person extends RecordType, Role extends string, PersonId extends string = string>({ isOpen, title, description, onClose, peopleSource, mapPerson, accesses, roles, defaultRole, isAddingPeople, isUpdatingAccess, onAddPeople, onRoleChange, onRemoveAccess, dataTestId, }: F0SharingDialogProps<Person, Role, PersonId>): JSX_2.Element;

declare namespace F0SharingDialog_2 {
    var displayName: string;
}

export declare interface F0SharingDialogAccess<Person extends RecordType, Role extends string> {
    id: string;
...
export declare type F0SharingDialogActionResult = boolean | void;

export declare interface F0SharingDialogProps<Person extends RecordType, Role extends string, PersonId extends string = string> extends WithDataTestIdProps {
    isOpen: boolean;
    title: string;
    description?: string;
    onClose: () => void;
    peopleSource: DataSourceDefinition<ResolvedRecordType<Person>>;
    mapPerson: (person: ResolvedRecordType<Person>) => F0SelectItemObject<PersonId, ResolvedRecordType<Person>>;
    accesses: F0SharingDialogAccess<Person, Role>[];
    roles: F0SharingDialogRole<Role>[];
    defaultRole: Role;
    isAddingPeople?: boolean;
    isUpdatingAccess?: boolean;
    onAddPeople: (selection: F0SharingDialogSelection<Person, Role, PersonId>) => Promise<F0SharingDialogActionResult> | F0SharingDialogActionResult;
    onRoleChange: (access: F0SharingDialogAccess<Person, Role>, role: Role) => Promise<F0SharingDialogActionResult> | F0SharingDialogActionResult;
    onRemoveAccess: (access: F0SharingDialogAccess<Person, Role>) => Promise<F0SharingDialogActionResult> | F0SharingDialogActionResult;
}

export declare interface F0SharingDialogRole<Role extends string> {
    value: Role;
    label: string;
    description?: string;
...
export declare interface F0SharingDialogSelection<Person extends RecordType, Role extends string, PersonId extends string> {
    personIds: PersonId[];

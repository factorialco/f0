...
declare function _ApplicationFrame({ children, sidebar, banner, ai, aiPromotion, meeting, }: ApplicationFrameProps): JSX_2.Element;
 ...
 */
export declare const F0Meeting: ({ runtime, actions, actionOrder, defaultMode, sidePanel, headerContent, overlay, children, }: F0MeetingProviderProps) => ReactNode;
 ...
 */
export declare const F0MeetingRoom: ({ actions, actionOrder, sidePanel, overlay, }: F0MeetingRoomProps) => JSX_2.Element;
 ...
 */
export declare const F0MeetingSlot: () => JSX_2.Element;
 ...
 */
export declare const F0MeetingSurface: ({ actions, actionOrder, sidePanel, headerContent, overlay, }: F0MeetingSurfaceProps) => ReactPortal | null;

export declare type F0MeetingSurfaceMode = (typeof f0MeetingSurfaceModes)[number];

export declare const f0MeetingSurfaceModes: readonly ["fullscreen", "panel", "floating", "minimized", "inline"];

declare type F0MeetingSurfaceProps = {
    actions?: F0MeetingActionsProp;
    actionOrder?: string[];
    sidePanel?: F0MeetingSidePanel;
    headerContent?: React.ReactNode;
 ...
 */
export declare const MeetingNotes: ({ value, onChange }: MeetingNotesProps) => JSX_2.Element;
 ...
 */
export declare const MeetingRoomChat: ({ messages, onSend }: MeetingRoomChatProps) => JSX_2.Element;
 ...
 * on reveal.
 */
export declare const MeetingSidePanel: ({ panel }: MeetingSidePanelProps) => JSX_2.Element | null;
...
export declare const MeetingSurfaceProvider: ({ defaultMode, roomId, children, }: {
    defaultMode?: F0MeetingSurfaceMode;
 ...
 */
export declare const MeetingTranscript: ({ segments }: MeetingTranscriptProps) => JSX_2.Element;
 ...
 */
export declare const panelRect: (area: F0Rect, width: number) => F0Rect;

export declare const panelWidthFor: (area: Viewport, requested: number) => number;
 ...
 */
export declare const useMeetingSignal: (participantId: string) => F0MeetingSignal;
 ...
 */
export declare const useTrackBinding: <T extends HTMLMediaElement>(track: F0MeetingTrack | undefined) => React.RefObject<T>;
 ...
 */
export declare function WidgetCatalog({ isOpen, onClose, widgets, onAdd, groups, area, previewWidth, slotRenderers, rebuildPreview, title, }: WidgetCatalogProps): JSX_2.Element;

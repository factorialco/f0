...
import { F0RatingProps as F0RatingProps_2 } from './types';
...
export declare const F0Rating: WithDataTestIdReturnType_2<ForwardRefExoticComponent<F0RatingProps_2 & RefAttributes<HTMLDivElement>>>;

export declare interface F0RatingProps extends WithDataTestIdProps {
    value?: number | null;
...
export declare type RatingSize = (typeof ratingSizes)[number];

export declare const ratingSizes: readonly ["sm", "md", "lg"];

...
declare type AiIconName = "ai:calendar" | "ai:change-tone" | "ai:chart-line" | "ai:one" | "ai:receipt-ai" | "ai:rewrite" | "ai:search" | "ai:summary" | "ai:translate";
 ...
 */
declare type IconComponent = ForwardRefExoticComponent<SVGProps<SVGSVGElement> & RefAttributes<SVGSVGElement> & {
 ...
 */
declare type IconName<Namespace extends IconNamespace = IconNamespace> = IconNamesByNamespace[Namespace];
 ...
 */
declare interface IconNamesByNamespace {
    app: AppIconName;
...
declare type IconNamespace = keyof IconNamesByNamespace;

...
export declare type NestedChildrenDisplayMode = (typeof nestedChildrenDisplayModes)[number];
 ...
 */
export declare const nestedChildrenDisplayModes: readonly ["paginated", "all"];

export declare type NestedExpandAllOptions<R extends RecordType> = NestedExpandOptions & {
    /**
...
export declare type NestedExpandAnimation = (typeof nestedExpandAnimations)[number];
 ...
 */
export declare const nestedExpandAnimations: readonly ["none", "fade", "stagger", "slide", "pop"];

export declare type NestedExpandOptions = {
    /**
 ...
 */
export declare type NestedExpansionContext<R extends RecordType> = {
    item: R;
    depth: number;
    /**
 ...
 */
export declare type NestedExpansionCriteria<R extends RecordType> = boolean | number | ((context: NestedExpansionContext<R>) => boolean);
 ...
 */
export declare type NestedRowTarget<R extends RecordType> = string | number | ((context: NestedExpansionContext<R>) => boolean);
 ...
 */
export declare interface NestedTableController<R extends RecordType> {
 ...
 */
export declare type NestedTableOptions<R extends RecordType> = {
    /**
 ...
 */
export declare const useNestedTable: <R extends RecordType>() => NestedTableController<R>;

...
export declare type CommandAction = {
    id: string;
    label: string;
    icon?: IconType;
...
export declare type CommandEntityAction = {
    ...
    run: (ref: CommandEntityRef, values: CommandParamValues, context: CommandRunContext) => void;
};
...
export declare type CommandNavigationItem = {
    id: string;
    label: string;
    icon?: IconType;
    keywords?: string;
 ...
 */
export declare const F0CommandPaletteProvider: ({ children, providers, actions, navigation, recent, assistant, onNavigate, shortcut, open: openProp, onOpenChange, }: F0CommandPaletteProviderProps_2) => JSX_2.Element;

...
export declare const OneDropdownButton: ({ onClick, value, ...props }: OneDropdownButtonProps) => JSX_2.Element | undefined;

export declare type OneDropdownButtonGroup<T = string> = {
    label?: string;
...
export declare type OneDropdownButtonProps<T = string> = {
    ...
    items: OneDropdownButtonItem<T>[] | OneDropdownButtonGroup<T>[] | OneDropdownButtonGroup<T>;
...
export declare type OneDropdownButtonSize = (typeof oneDropdownButtonSizes)[number];

export declare const oneDropdownButtonSizes: readonly ["sm", "md", "lg"];

export declare type OneDropdownButtonVariant = (typeof oneDropdownButtonVariants)[number];

export declare const oneDropdownButtonVariants: readonly ["default", "outline", "neutral"];

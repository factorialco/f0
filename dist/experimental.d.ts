...
import { F0AudienceListItemProps as F0AudienceListItemProps_2 } from './types';
import { F0AudienceSelectorProps as F0AudienceSelectorProps_2 } from './types';
...
import { RecordType as RecordType_2 } from './experimental';
...
export declare type AudienceEntityKind = (typeof audienceEntityKinds)[number];
 ...
 */
export declare const audienceEntityKinds: readonly ["individual", "team", "legal_entity", "workplace", "role", "permission_group", "everyone"];

export declare type AudienceGroupKind = Exclude<AudienceEntityKind, "individual">;
 ...
 */
export declare type F0AudienceEntity = F0AudienceIndividual | F0AudienceGroup;

export declare type F0AudienceGroup = {
...
export declare type F0AudienceIndividual = {
    kind: "individual";
    id: string;
    name: string;
    firstName: string;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const F0AudienceListItem: WithDataTestIdReturnType_5<({ entity, isYou, warning, right, members, expanded, onExpandedChange, }: F0AudienceListItemProps_2) => JSX_2.Element>;

export declare type F0AudienceListItemProps = {
...
export declare type F0AudienceMember = {
    id: string;
    firstName: string;
    lastName: string;
    /** Avatar image url */
...
export declare type F0AudienceOption = {
    entity: F0AudienceEntity;
    /**
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const F0AudienceSelector: <R extends RecordType_2 = RecordType_2>({ source, mapEntity, value, onChange, suggestions, trailing, warning, onOpenChange, searchEmptyMessage, label, hideLabel, placeholder, disabled, loading, error, dataTestId, }: F0AudienceSelectorProps_2<R>) => JSX_2.Element;

export declare type F0AudienceSelectorProps<R extends RecordType = RecordType> = {
...
} & Pick<InputFieldProps<string>, "label" | "hideLabel" | "placeholder" | "disabled" | "loading" | "error"> & WithDataTestIdProps;
 ...
 */
export declare type F0AudienceSelectorSource<R extends RecordType = RecordType> = {

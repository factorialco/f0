 ...
 * post for.
 */
export declare interface CommunityPostEvent {
 ...
 * its posts twice.
 */
export declare interface CommunityPostListItem extends CommunityPostSummary {
 ...
 */
export declare const F0CommunityPostsList: ({ posts, labels, visibleCount, loading, expectedItemsCount, }: F0CommunityPostsListProps) => JSX_2.Element;

export declare interface F0CommunityPostsListProps {

...
export declare interface F0ChatMediaFile {
    url: string;
    name: string;
    mimeType?: string;
}

export declare const F0ChatMediaPreview: ({ images, document: file, index, onIndexChange, onClose, onDownload, dataTestId, }: F0ChatMediaPreviewProps) => JSX_2.Element;

export declare type F0ChatMediaPreviewProps = {
    onClose: () => void;

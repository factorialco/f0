...
export declare const defaultMapStyle: (provider: F0MapProvider) => F0MapStyle;
 ...
 */
export declare type F0MapProvider = "maplibre" | "google";
 ...
 */
export declare const googleMapStyles: F0MapStyle;

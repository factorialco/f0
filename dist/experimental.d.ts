...
export declare interface DeferredNodesPayload<T = unknown> {
    nodes: GraphNode<T>[];
    edges?: GraphEdge[];
}

/** Status of the deferred merge lifecycle. */
export declare type DeferredStatus = "idle" | "loading" | "resolved" | "error";
...
export declare type EdgeType = (typeof edgeTypes)[number];

export declare const edgeTypes: readonly ["smoothstep", "straight", "bezier"];

export declare type EdgeVariant = (typeof edgeVariants)[number];
...
export declare function F0Graph<T = unknown>(props: F0GraphProps<T>): JSX_2.Element;

export declare namespace F0Graph {
    var displayName: string;
}

export declare interface F0GraphActionsContextValue {
...
export declare type F0GraphControlLabels = {
    zoomIn?: string;
    zoomOut?: string;
    fitView?: string;
    findMe?: string;
...
export declare const F0GraphControls: ForwardRefExoticComponent<F0GraphControlsProps & RefAttributes<HTMLDivElement>>;

export declare interface F0GraphControlsProps {
    /** Callback to zoom in */
    onZoomIn?: () => void;
...
export declare const F0GraphDetailPanel: (props: F0GraphDetailPanelProps) => JSX_2.Element;

export declare type F0GraphDetailPanelProps = DefaultVariantProps | ResourceVariantProps;

export declare const F0GraphEdge: MemoExoticComponent<typeof F0GraphEdgeBase>;

declare function F0GraphEdgeBase({ variant: variantProp, strokeWidth: propStrokeWidth, pathType: pathTypeProp, type: _rfType, ...edgeProps }: F0GraphEdgeProps & EdgeProps): JSX_2.Element;

declare namespace F0GraphEdgeBase {
    var displayName: string;
}

export declare interface F0GraphEdgeProps {
    /**
...
export declare const F0GraphExpander: ForwardRefExoticComponent<F0GraphExpanderProps & RefAttributes<HTMLDivElement>>;

export declare interface F0GraphExpanderProps {
...
export declare interface F0GraphFocusContextValue {
    focusedNodeId: string | null;
    setFocusedNodeId: (id: string | null) => void;
    registerNodeRef: (nodeId: string, el: HTMLElement | null) => void;
}

export declare const F0GraphNode: ForwardRefExoticComponent<F0GraphNodeProps & RefAttributes<HTMLDivElement>>;

export declare interface F0GraphNodeProps {
 ...
 */
export declare interface F0GraphNodeRenderContext {
    zoomLevel: ZoomLevel;
    variant: GraphNodeVariant;
    state: GraphNodeState;
    expanded: boolean;
 ...
 */
export declare interface F0GraphNodeTagLabels {
    person?: string;
    team?: string;
    company?: string;
    status?: string;
...
export declare type F0GraphNodeTagType = TagVariant["type"];

export declare interface F0GraphProps<T = unknown> {
    nodes?: GraphNode<T>[];
    edges?: GraphEdge[];
...
declare const F0TagAlert: WithDataTestIdReturnType_5<ForwardRefExoticComponent<Props_2 & RefAttributes<HTMLDivElement>>>;

declare const F0TagBalance: WithDataTestIdReturnType_5<ForwardRefExoticComponent<F0TagBalanceProps & RefAttributes<HTMLDivElement>>>;

declare type F0TagBalanceProps_2 = {
    /**
...
export declare interface GraphNode<T = unknown> {
    id: string;
    /**
...
export declare type GraphNodeState = (typeof graphNodeStates)[number];

export declare const graphNodeStates: readonly ["default", "selected", "highlighted", "dimmed"];

export declare type GraphNodeVariant = (typeof graphNodeVariants)[number];
...
export declare type LayoutDirection = "TB" | "LR" | "BT" | "RL";
 ...
 */
export declare interface LayoutEngine {
...
declare type Props_3 = {} & Pick<BaseHeaderProps, "avatar" | "title" | "description" | "primaryAction" | "secondaryActions" | "otherActions" | "metadata" | "status" | "deactivated">;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const ResourceHeader: ({ avatar, title, description, primaryAction, secondaryActions, otherActions, status, metadata, deactivated, }: Props_3) => JSX_2.Element;

export declare type ResourceHeaderProps = Props_3;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const SectionHeader: ({ title, description, action, link, separator, }: Props_4) => JSX_2.Element;
...
} & VisualizationOverrides<R, Filters, Sortings, Summaries, ItemActions, NavigationFilters, Grouping>) | ({
 ...
 */
declare type VisualizationOverrides<R extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, Summaries extends SummariesDefinition, ItemActions extends ItemActionsDefinition<R>, NavigationFilters extends NavigationFiltersDefinition, Grouping extends GroupingDefinition<R>> = VisualizationFilterOverrides<Filters> | (VisualizationSourceOverride<R, Filters, Sortings, Summaries, ItemActions, NavigationFilters, Grouping> & {
    filters?: never;
    presets?: never;
});
 ...
 */
declare type VisualizationSourceOverride<R extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, Summaries extends SummariesDefinition, ItemActions extends ItemActionsDefinition<R>, NavigationFilters extends NavigationFiltersDefinition, Grouping extends GroupingDefinition<R>> = {
...
export declare type ZoomLevel = (typeof zoomLevels)[number];

declare const zoomLevels: readonly ["detail", "compact", "dot"];

export declare type ZoomPreset = keyof typeof zoomPresets;
...
export declare interface ZoomThresholds {
    detail: number;
    compact: number;
    dot: number;
}

...
import React3, { forwardRef, useState, memo, createElement, useEffect, useMemo } from 'react';
import { cva } from 'cva';
import { clsx } from 'clsx';
import { twMerge } from 'tailwind-merge';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { cssInterop } from 'nativewind';
import Svg, { Path, Circle, Rect, Mask, G, Defs, LinearGradient, Stop, SvgUri } from 'react-native-svg';
...
var ActivityItem = ({
  ...
  return /* @__PURE__ */ jsxs(
    Pressable,
    {
      ...
      children: [
        icon && /* @__PURE__ */ jsx(View, { accessibilityLabel: "activity-icon-container", children: /* @__PURE__ */ jsx(IconAvatar, { icon, size: "md" }) }),
        /* @__PURE__ */ jsxs(View, { className: "flex-1", children: [
          /* @__PURE__ */ jsx(Text, { className: "line-clamp-1 text-lg font-medium text-f1-foreground", children: title }),
          /* @__PURE__ */ jsx(Text, { className: "line-clamp-2 text-lg text-f1-foreground-secondary", children: description }),
          /* @__PURE__ */ jsx(View, { className: "mt-1.5 flex flex-row", children: /* @__PURE__ */ jsx(Text, { className: "text-md text-f1-foreground-secondary", children: `${category} \xB7 ${date}` }) })
        ] }),
        /* @__PURE__ */ jsx(View, { className: "ml-1", children: isUnread && /* @__PURE__ */ jsx(
          View,
          {
...
var ActivityItemSkeleton = () => {
  return /* @__PURE__ */ jsxs(
    View,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(View, { className: "h-10 w-10 rounded-lg bg-f1-background-secondary" }),
        /* @__PURE__ */ jsxs(View, { className: "flex-1", children: [
          /* @__PURE__ */ jsx(View, { className: "mb-1 h-5 w-3/4 rounded-sm bg-f1-background-secondary" }),
          /* @__PURE__ */ jsx(View, { className: "mb-1 h-5 w-full rounded-sm bg-f1-background-secondary" }),
          /* @__PURE__ */ jsx(View, { className: "mb-1.5 h-5 w-2/3 rounded-sm bg-f1-background-secondary" }),
          /* @__PURE__ */ jsx(View, { className: "h-5 w-1/2 rounded-sm bg-f1-background-secondary" })
        ] }),
        /* @__PURE__ */ jsx(View, { className: "ml-1 w-2" })
      ]
    }
  );
};
...
var PageHeader = memo(({ title, actions }) => {
  return /* @__PURE__ */ jsxs(View, { className: "flex-row items-center justify-between px-5 py-3", children: [
    /* @__PURE__ */ jsx(Text, { className: "text-3xl font-semibold text-f1-foreground", children: title }),
    /* @__PURE__ */ jsx(View, { className: "flex-row gap-2", children: actions?.map((action) => {
      switch (action.type) {
        case "notifications":
          return /* @__PURE__ */ createElement(NotificationsAction, { ...action, key: action.label });
        default:
          return null;
      }
    }) })
  ...
  return /* @__PURE__ */ jsxs(View, { className: "flex gap-4", children: [
    ...
    /* @__PURE__ */ jsx(
      View,
      {
        ...
        children: details?.map((item, index) => /* @__PURE__ */ jsxs(React3.Fragment, { children: [
          /* @__PURE__ */ jsx(
            DetailsItem,
            {
              title: item.title,
...
export { ActivityItem, ActivityItemSkeleton, AlertTag, app_exports as AppIcons, Avatar2 as Avatar, Badge, Button, CompanyAvatar, Counter, DataList, DateAvatar, DetailsItem, DetailsItemsList, DotTag, EmojiAvatar, ExampleComponent, FileAvatar, Icon, IconAvatar, ModuleAvatar, modules_exports as ModuleIcons, OneChip, OnePreset, PageHeader, PersonAvatar, RawTag, TeamAvatar, applyIconInterop, chipContainerVariants, chipTextVariants, dotTagColors, sizes4 as sizes, variants };

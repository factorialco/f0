import { jsxs as a, jsx as t, Fragment as R1 } from "react/jsx-runtime";
import { useInsertionEffect as Ar, forwardRef as m, useRef as $, useEffect as W, useLayoutEffect as ie, useState as D, useId as G1, useMemo as K, useCallback as O, createContext as W1, useContext as I1, createElement as Er, memo as $r } from "react";
import { dd as Br, aJ as Ir, de as Pr, am as nt, ce as Dr, df as jr, dg as _r, dh as Zr, di as Or, cf as Ur, ck as st, cd as zr, dj as Gr, av as ae, dk as Wr, b7 as qr, dl as Xr, dm as Yr, dn as Kr, aP as Qr, dp as Jr, cK as eo, y as it, aC as to, dq as ro, o as le, aq as at, ah as q1, n as lt, bE as oo, ci as no, dr as so, br as io, cJ as ao, ao as F1, a_ as lo, bI as ct, ds as co, cH as uo, l as y1, cF as fo, dt as ho, c9 as dt, bq as po, du as mo, dv as Co, dw as go, dx as wo, dy as vo, dz as ut, cy as xo, cz as bo, dA as Lo, dB as ko, dC as yo, dD as Mo, dE as Ro, bT as Fo, ch as No, dF as Vo, dG as So, dH as To, dI as Ho, dJ as Ao, dK as Eo, dL as $o, dM as Bo, bS as Io, cI as Po, aA as Do, cu as jo, dN as _o, dO as Zo, dP as Oo, dQ as Uo, dR as zo, dS as Go, dT as Wo, aW as qo, bU as Xo, R as ft, ag as Yo, ap as Ko, bV as ht, c8 as Qo, Q as pt, i as Jo, bH as en, bG as tn, dU as rn, dV as on, bW as mt, bX as nn, bY as sn, bp as an, b0 as ln, dW as cn, j as dn, bC as Ct, bB as gt, bw as un, dX as wt, az as fn, cg as ce, q as hn, bz as de, dY as pn, dZ as mn, d_ as ue, N as Cn, O as gn, cG as vt, d$ as wn, ae as vn, ad as xn, e0 as bn, e1 as Ln, e2 as kn, e3 as yn, c6 as Mn, e4 as xt, e5 as Rn, aI as Fn, aB as Nn, e6 as Vn, af as i1, a6 as H1, cp as Sn, u as G, c5 as Tn, S as h1, bR as bt, U as a1, ar as Hn, m as w1, e7 as An, aD as l1, aK as v1, ac as M1, a5 as Q, cP as Lt, t as fe, e8 as En, x as he, b as k1, c3 as $n, e9 as Bn, c4 as In, ai as Pn, bo as Dn, au as pe, bZ as jn, b_ as _n, b$ as Zn, c0 as Me, as as On, aR as kt, be as yt, bQ as Un, ay as zn, cV as Gn, ea as Wn, eb as qn, bk as Mt, ec as Xn, cR as Yn, ed as Kn, bg as B1, bx as Rt, ee as Ft, by as Nt, c as oe, cj as Re, ef as Vt, eg as Qn, eh as Jn, aH as es, ei as ts, bD as me, cv as rs, ej as os, ek as ns, el as ss, em as is, en as as, w as ls, s as cs, v as St, aa as ds, ab as us, aE as Fe, eo as Tt, ep as Ht, eq as fs, er as hs, aF as ps, aw as ms, es as Cs, et as gs, d as ws } from "./F0CanvasPanel-CAY9Mu_e.js";
import { d as k, f as p1, g as vs } from "./tooltip-Cik7KBQT.js";
...
const F0 = (e, r) => /* @__PURE__ */ a(
...
), d2 = m(c2), u2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Ss,
  Add: Br,
  Ai: Ir,
  ...
  Calculator: Jr,
  Calendar: eo,
  CalendarArrowDown: ei,
  CalendarArrowLeft: ri,
  CalendarArrowRight: ni,
  CameraPlus: ii,
  CardPin: li,
  ChartFunnel: di,
  ChartHorizontalBars: fi,
  ChartLine: pi,
  ChartPie: Ci,
  ChartVerticalBars: wi,
  Check: it,
  CheckCircle: to,
  CheckCircleLine: xi,
  CheckDouble: ro,
...
const T2 = H1({
  ...
  ({
    ...
    borderRight: o1,
    borderRadius: n1,
    borderRadiusTopLeft: f1,
    borderRadiusTopRight: m1,
    borderRadiusBottomLeft: N1,
    borderRadiusBottomRight: d1,
    borderStyle: L,
    // Overflow
    overflow: R,
    overflowX: M,
    ...
    const E1 = r1 && r1 !== "none" || e1 && e1 !== "none" || j && j !== "none" || o1 && o1 !== "none", T1 = X && X !== "none" || E1, D1 = { sm: x1, md: Y1, lg: K1, xl: Q1 }, j1 = H2.map((_1) => {
      const Z1 = D1[_1];
      return Z1 ? S2(_1, Z1) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
      "div",
      {
        ...
        className: k(
          ...
          j1,
          T1 && !q && "border-f1-border",
          E && !_ && "divide-f1-border",
          "scrollbar-macos"
        ),
        ...P1
      }
...
const te = Sn(
  ...
  const w = G();
  return p === "recording" ? /* @__PURE__ */ a("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    /* @__PURE__ */ t(
      Tn,
      {
        stream: C ?? null,
      ...
      e && /* @__PURE__ */ a(R1, { children: [
        /* @__PURE__ */ t(
          i1,
          {
            ...
            onClick: (v) => {
              v.preventDefault(), i.current?.click();
            }
          }
        ),
        /* @__PURE__ */ t(
    ...
    /* @__PURE__ */ a("div", { className: "flex shrink-0 items-center gap-2", children: [
      d && /* @__PURE__ */ t(
        i1,
        {
          ...
          disabled: u,
          onClick: h,
          loading: p === "transcribing"
        }
      ),
      p !== "transcribing" && u ? /* @__PURE__ */ t(
        i1,
        {
          type: "submit",
          variant: "neutral",
...
function $2({
  ...
  const n = /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ t(a1, { icon: nt, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ t(
      "button",
      {
        ...
        onClick: () => r(e.id),
        children: /* @__PURE__ */ t(a1, { icon: F1, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
...
function P2({
  ...
  W(() => {
    ...
    const d = c.current, p = d?.offsetParent;
    if (!d || !p) return;
    const C = d.offsetLeft + d.offsetWidth - p.clientWidth;
    C > 0 && (d.style.left = `${Math.max(0, d.offsetLeft - C)}px`);
  }, [s]);
  ...
  return !e || f ? null : /* @__PURE__ */ t(
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (d, p) => /* @__PURE__ */ a(
        "div",
        {
        ...
        const C = p === n, h = `${d.firstName} ${d.lastName}`.trim();
        return /* @__PURE__ */ a(
          "div",
          {
            ref: C ? u : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ t(l1, { className: "text-base font-medium text-f1-foreground", children: h }) })
            ]
          },
          String(d.id)
        );
...
const D2 = ({
  ...
  return /* @__PURE__ */ t("div", { className: "p-1", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ t(a1, { icon: ce, size: "md", color: "default" }) }),
        /* @__PURE__ */ t(
          l1,
          {
  ...
  const s = v1(), [i, c] = D(""), [u, l] = D(0), [f, d] = D(!1), p = $(null), C = $(null), h = $(null), g = e[u] ?? r;
  return W(() => {
    const x = () => {
    ...
    if (s)
      return d(!1), c(g), x(), p.current = setTimeout(() => {
        const F = (u + 1) % Math.max(e.length, 1);
        l(F);
      }, 4e3), () => {
        x();
      };
    d(!0), c("");
    let w = 0;
    const v = 50, H = 30, A = 2e3, V = 1e3;
    return C.current = setInterval(() => {
      w < g.length ? (c(g.slice(0, w + 1)), w++) : (C.current && (clearInterval(C.current), C.current = null), p.current = setTimeout(() => {
        h.current = setInterval(() => {
          w > 0 ? (w--, c(g.slice(0, w))) : (h.current && (clearInterval(h.current), h.current = null), p.current = setTimeout(() => {
            const F = (u + 1) % Math.max(e.length, 1);
            l(F);
          }, V));
        }, H);
    ...
    e.length,
    s
  ]), o.length > 0 || n ? null : /* @__PURE__ */ t(M1, { children: /* @__PURE__ */ t(
    Q.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
const G2 = ({
  ...
  const [s, i] = D(null), c = $(null), u = $(null), l = $(!1), f = G1(), d = G1(), p = s !== null ? e[s] : null;
      ...
      children: [
          ...
          "div",
          {
            ...
            children: e.map((C, h) => /* @__PURE__ */ t(
              i1,
              {
                ...
                onClick: (g) => {
                  u.current = g.currentTarget, l.current = !1, i((x) => x === h ? null : h), o?.(null);
                }
              },
              `${C.label}-${h}`
            ))
        ...
        p && /* @__PURE__ */ a(
          he,
          {
            ...
            onCloseAutoFocus: (C) => {
              C.preventDefault(), l.current && u.current?.focus(), l.current = !1;
            },
            onEscapeKeyDown: () => {
              l.current = !0;
            },
            ...
            children: [
              /* @__PURE__ */ a(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ t(a1, { "aria-hidden": !0, icon: p.icon, size: "sm" }),
                    /* @__PURE__ */ t("span", { children: p.label })
                  ]
                }
              ),
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: z2(p.items).map((C, h) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: (g) => {
                    r(C, p), l.current = document.activeElement === g.currentTarget, i(null), o?.(null);
                  },
                  onMouseEnter: () => o?.(C),
                  onMouseLeave: () => o?.(null),
                  onFocus: () => o?.(C),
                  ...
                  children: [
                    /* @__PURE__ */ t("span", { className: "min-w-0 flex-1 truncate", children: C.title }),
                    /* @__PURE__ */ t(
                      "span",
                      {
                        "aria-hidden": !0,
                        ...
                        children: /* @__PURE__ */ t(a1, { icon: ae, size: "sm" })
                      }
                    )
                  ]
                },
...
function W2(e, r, o) {
  ...
  i.sort((d, p) => d.start - p.start);
  const c = [];
  let u = 0, l = !1;
  const f = (d) => {
    if (!s || l || n < u || n > d) {
      d > u && c.push({ type: "text", text: e.slice(u, d) }), u = d;
      return;
    }
    n > u && c.push({ type: "text", text: e.slice(u, n) }), c.push({ type: "ghost", text: s }), l = !0, n < d && c.push({ type: "text", text: e.slice(n, d) }), u = d;
  };
  for (const d of i)
    f(d.start), c.push({ type: "mention", text: e.slice(d.start, d.end) }), u = d.end;
  return f(e.length), !l && s && n >= u && c.push({ type: "ghost", text: s }), c.length === 0 ? [{ type: "text", text: e }] : c;
}
function q2(e, r) {
  if (r === "*/*") return !0;
  if (r.endsWith("/*")) {
...
const Y2 = 4e3;
function K2(e) {
  const [r, o] = D([]), [n, s] = D(null), i = $(
    null
  ), c = $(null), u = G(), l = e?.onUploadFiles, f = e?.allowedMimeTypes, d = e?.maxFiles, p = K(() => {
    if (f)
      return Array.isArray(f) ? f.join(",") : f;
  }, [f]), C = d !== void 0 && r.length >= d, h = $(0);
  W(() => {
    h.current = r.length;
  }, [r]);
  const g = O((A) => {
    i.current && clearTimeout(i.current), s(A), i.current = setTimeout(() => {
  ...
  const x = O(
    async (A) => {
      ...
      if (d !== void 0 && h.current + V.length > d) {
        g(
          u.ai.tooManyFilesError.replace(
            "{{maxFiles}}",
            String(d)
          )
        );
      ...
      const S = (y) => o(
        (B) => B.map(
          (N) => b.includes(N.id) ? { ...N, status: "error", errorMessage: y } : N
        )
      );
      try {
        const y = await l(V);
        if (!Array.isArray(y) || y.length !== V.length) {
          S(u.ai.fileUploadError);
          return;
        }
        o(
          (B) => B.map((N) => {
            const T = F.findIndex((I) => I.id === N.id);
            return T === -1 ? N : y[T] ? {
              ...N,
              status: "uploaded",
              uploadedFile: y[T]
              ...
              ...N,
              status: "error",
              errorMessage: u.ai.fileUploadError
            };
          })
        );
      } catch (y) {
        const B = y instanceof Error && y.message ? y.message : u.ai.fileUploadError;
        S(B);
      }
    },
    [
      ...
      d,
      f,
      u.ai.tooManyFilesError,
      u.ai.fileUploadError,
      g
    ]
  ), w = O(
    async (A) => {
      await x(Array.from(A.target.files ?? [])), A.target.value = "";
    },
    [x]
  ), v = O((A) => {
    o((V) => V.filter((F) => F.id !== A));
  }, []), H = O(() => {
    o([]);
  }, []);
  return {
...
`)) return null;
  for (const c of o) {
    const u = e.slice(s + 1), l = s + 1 + c.name.length;
    if (u.startsWith(c.name) && r >= l) {
      const f = e[l];
      if (f === " " || f === `
` || f === "	")
        return null;
...
function el(e, r) {
  ...
  const c = i.offsetLeft, u = i.offsetTop - e.scrollTop;
  return document.body.removeChild(o), { left: c, top: u };
}
const tl = 250;
function rl({
  inputValue: e,
  ...
  const [i, c] = D(!1), [u, l] = D(""), [f, d] = D([]), [p, C] = D(!1), [h, g] = D(0), [x, w] = D([]), v = $(-1), H = $(null), A = $(0), V = $(-1);
  W(() => {
    if (!n) {
      c(!1);
      return;
    ...
    const T = Q2(e, o, x);
    if (!T) {
      c(!1), l(""), d([]), g(0), v.current = -1, V.current = -1;
      return;
    }
    if (T.atIndex === V.current)
      return;
    v.current = T.atIndex, l(T.query), c(!0), g(0), C(!0), H.current && clearTimeout(H.current);
    const I = ++A.current;
    return H.current = setTimeout(() => {
      n(T.query).then((U) => {
        I === A.current && (d(U), g(0), U.length === 0 && T.query.length > 0 && (V.current = T.atIndex, c(!1)));
      }).catch(() => {
        I === A.current && d([]);
      }).finally(() => {
        I === A.current && C(!1);
  ...
  const F = O(() => {
    c(!1), l(""), d([]), g(0), v.current = -1;
  }, []), b = O(
    (T) => {
      const I = v.current;
      if (I === -1) return;
      const U = `${T.firstName} ${T.lastName}`.trim(), Z = String(T.id), z = e.slice(0, I), J = e.slice(o), t1 = `@${U} `, q = z + t1 + J, X = z.length + t1.length;
      r(q), w((r1) => [...r1.filter((j) => !(j.id === Z && j.name === U)), { id: Z, name: U }]), F(), requestAnimationFrame(() => {
        const r1 = s.current;
        r1 && (r1.focus(), r1.setSelectionRange(X, X));
      });
    },
    [e, o, r, s, F]
  ), S = O(
      ...
      switch (T.key) {
        ...
        case "Tab": {
          ...
          if (I) {
            ...
            if (u.length === 0 || U.toLowerCase().startsWith(u.toLowerCase()))
              return T.preventDefault(), b(I), !0;
          }
          return !1;
        }
        case "Enter":
          return T.preventDefault(), f[h] && b(f[h]), !0;
        default:
          return !1;
      }
    },
    ...
    (T) => {
      ...
      let I = T;
      const U = [...x].sort((Z, z) => z.name.length - Z.name.length);
      for (const Z of U) {
        const z = `@${Z.name}`, J = `<entity-ref type="person" id="${Ne(Z.id)}">${Ne(Z.name)}</entity-ref>`;
        for (; I.includes(z); )
          I = I.replace(z, J);
      }
      return I;
  ...
  W(() => {
    w(
      (T) => T.filter((I) => {
        const U = `@${I.name}`, Z = e.indexOf(U);
        if (Z === -1) return !1;
        const z = e[Z + U.length];
        return z === " " || z === `
` || z === "	";
      })
    );
  ...
  const B = K(() => {
    if (!i || v.current === -1) return null;
    const T = s.current;
    if (!T) return null;
    const I = el(T, v.current), U = T.offsetLeft + I.left, z = (T.offsetParent ? T.offsetParent.offsetHeight : 0) - (T.offsetTop + I.top);
    ...
    return u.length === 0 ? I : I.toLowerCase().startsWith(u.toLowerCase()) ? I.slice(u.length) : null;
  }, [i, f, h, u]);
  return {
    isOpen: i,
    query: u,
...
const ol = /[\\`*_{}[\]()#+\-.!|~>]/g, nl = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(ol, "\\$&")).join(""), P4 = ({
  ...
  creditWarning: i,
  clarifyingUI: c,
  pendingContext: u = null,
  onPendingContextChange: l,
  pendingQuote: f = null,
  onPendingQuoteChange: d,
  fileAttachments: p,
  toolbarStart: C,
  onTranscribe: h,
  searchPersons: g,
  ...
  onSuggestionClick: F,
  welcomeScreenCards: b,
  ref: S
}) => {
  const y = G(), B = v1(), [N, T] = D(""), [I, U] = D(0), [Z, z] = D(!1), [J, t1] = D(!1), [q, X] = D(null), r1 = $(null), e1 = $(null), j = $(null), o1 = c != null, { tracking: n1 } = k1(), f1 = O(
    (Y, b1) => {
      n1?.onWelcomeSuggestionClick?.({
        item: Y,
        group: b1,
        prompt: Y.prompt || Y.title
      }), F?.(Y, b1);
    },
    [n1, F]
  ), {
    ...
    const b1 = V1.current, ee = b1 && !/\s$/.test(b1) ? " " : "", O1 = `${b1}${ee}${Y}`;
    T(O1), U(O1.length);
  }, []), X1 = {
    ...
    onPartial: S1,
    onFinal: (Y) => {
      S1(Y), e1.current?.focus();
    },
    onError: (Y) => g1(X1[Y])
  }), Y1 = !!h && x1.isSupported, K1 = O(() => {
    n1?.onDictationStart?.(), V1.current = N, x1.start();
  }, [N, x1, n1]), Q1 = O(() => {
    n1?.onDictationCancel?.(), x1.cancel();
  }, [x1, n1]);
  W(() => {
    typeof window < "u" && window.location.hash.length === 0 && e1.current?.focus();
  }, []), W(() => {
    if (x)
      return x((Y) => {
        P(Y);
  ...
  const P1 = x1.status === "recording", J1 = P1 ? y.ai.listening : y.ai.inputPlaceholder, E1 = m1.filter((Y) => Y.status === "uploaded"), T1 = m1.some((Y) => Y.status === "uploading"), D1 = m1.some((Y) => Y.status === "error"), j1 = N.trim().length > 0 || E1.length > 0;
  W(() => {
    if (!(!J || T1)) {
      if (t1(!1), D1) {
        g1(y.ai.fileUploadBlockedSubmit);
        return;
      }
      r1.current?.requestSubmit();
    }
  }, [
    J,
    T1,
  ...
  const _1 = async (Y) => {
    if (Y.preventDefault(), !o1) {
      if (s1.close(), o)
        r?.();
      else if (j1 && !Z) {
        if (T1) {
          t1(!0), e1.current?.focus();
          return;
        }
        if (n) {
          z(!0);
        ...
        const b1 = s1.transformMentions(N.trim()), ee = nl(b1), O1 = E1.flatMap(
          (ye) => ye.uploadedFile ? [ye.uploadedFile] : []
        ), Le = u, ke = f;
        Le && l?.(null), ke && d?.(null), await e({
          text: ee,
          files: O1,
          context: Le,
          quote: ke
    ...
    o1 || s1.handleKeyDown(Y) || Y.key === "Enter" && !Y.shiftKey && (Y.preventDefault(), o || r1.current?.requestSubmit());
  }, Rr = () => {
    U(e1.current?.selectionStart ?? 0);
  }, Fr = () => {
    j.current && e1.current && (j.current.scrollTop = e1.current.scrollTop);
  }, we = q ? q.prompt ?? q.title : null, ve = P1 ? [y.ai.listening] : we ? [we] : s ?? [], Nr = ve.length > 1, Vr = K(() => W2(N, s1.mentions, {
    cursorPosition: I,
    inlineCompletion: s1.inlineCompletion
  }), [N, s1.mentions, I, s1.inlineCompletion]), Sr = s1.mentions.length > 0 || s1.inlineCompletion !== null, xe = H && !!V && V.length > 0 && !!F ? /* @__PURE__ */ t(
    G2,
    {
      suggestions: V,
      onItemClick: f1,
  ...
  ) : null, Tr = H && A && !!b && b.length > 0, be = A && H, { motionProps: Hr } = Bn(
    H,
    160,
    0.5
  );
    ...
    Q.div,
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(I2, { creditWarning: i, children: /* @__PURE__ */ a(
            Q.form,
            {
              "aria-busy": o,
              ref: r1,
              className: k(
                ...
                o1 && "after:scale-100 after:opacity-100 border-f1-background-tertiary"
              ),
              animate: {
              ...
              children: [
                /* @__PURE__ */ t(
                  P2,
                  {
                    isOpen: s1.isOpen,
                    results: s1.results,
                    isLoading: s1.isLoading,
                    selectedIndex: s1.selectedIndex,
                    position: s1.popoverPosition,
                    onSelect: s1.selectPerson
                  }
                ),
                /* @__PURE__ */ t(M1, { initial: !1, children: o1 ? /* @__PURE__ */ t(
                  Q.div,
                  {
                  ...
                  Q.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ t(M1, { initial: !1, children: u1 && /* @__PURE__ */ t(
                        Q.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
        ...
        Tr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(O2, { cards: b }) }),
        v && H && A && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: v }),
        /* @__PURE__ */ t(M1, { mode: "wait", initial: !1, children: o1 ? /* @__PURE__ */ a(
          Q.div,
          {
          ...
          Q.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ t(l1, { className: "text-sm font-medium text-f1-foreground-tertiary", children: w.text }),
...
function A1({
  ...
  const i = $(/* @__PURE__ */ new Map()), [c, u] = D(
  ...
  const h = O(() => {
    if (c || l) return;
    const x = i.current.get(e);
    if (x) {
      u(x);
      return;
    }
    f(!0), p(!1), o(e).then((w) => {
      i.current.set(e, w), C.current && u(w);
    }).catch(() => {
      C.current && p(!0);
    }).finally(() => {
      C.current && f(!1);
...
function yl({
  ...
  const { entityRefs: o } = k1(), n = o?.resolvers?.candidate, s = G(), i = o?.urls?.candidate?.(e), c = K(
    () => (l) => {
      const f = [];
      return l.source && f.push({
        ...
        ...f.length > 0 && {
          children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-2", children: f.map((d) => /* @__PURE__ */ a("div", { className: "flex flex-col", children: [
...
function Ml({ id: e, label: r }) {
  const { entityRefs: o } = k1(), n = o?.resolvers?.expense, s = G(), i = o?.urls?.expense?.(e), c = K(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: $t
...
function Rl({
  ...
  const { entityRefs: o } = k1(), n = o?.resolvers?.jobPosting, s = G(), i = o?.urls?.jobPosting?.(e), c = K(
    () => (l) => ({
      title: l.title,
...
function Nl({
  ...
  const { entityRefs: o } = k1(), n = o?.resolvers?.requisition, s = G(), i = o?.urls?.requisition?.(e), c = K(
    () => (l) => {
      const f = l.lineManager ? `${l.lineManager.firstName} ${l.lineManager.lastName}` : void 0, p = [
        l.status ? {
...
function Vl({ id: e, label: r }) {
  const { entityRefs: o } = k1(), n = o?.resolvers?.person, s = G(), i = o?.urls?.person?.(e), c = K(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
function Sl({ id: e, label: r }) {
  const { entityRefs: o } = k1(), n = o?.resolvers?.vacancy, s = G(), i = o?.urls?.vacancy?.(e), c = K(
    () => (l) => ({
      title: l.name,
...
function ar({
  ...
  const c = G(), u = s.type === "open", l = u ? n ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ a(
    "div",
    {
      className: k(
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ t(l1, { className: "text-lg font-semibold text-f1-foreground", children: r }),
...
function j4({
  ...
  const [r, o] = D(0), n = $([]), s = O(
    (c) => {
      const u = n.current, l = u.findIndex(
        (d) => d.formName === c.formName && d.customFieldName === c.customFieldName
      ), f = c;
      l >= 0 ? u[l] = f : u.push(f), o((d) => d + 1);
    },
    []
  ), i = K(
    () => ({
  ...
  return /* @__PURE__ */ t(ge.Provider, { value: i, children: e });
}
function El(e) {
  const o = I1(ge)?.formatters;
  return K(() => !o || o.length === 0 ? null : (n, s, i) => {
    let c, u = -1;
    for (const l of o) {
      const f = l.formName === void 0 || l.formName === e, d = l.customFieldName === void 0 || l.customFieldName === i.customFieldName;
      if (!f || !d) continue;
      let p = 0;
      l.formName !== void 0 && (p += 2), l.customFieldName !== void 0 && (p += 1), p > u && (u = p, c = l);
    }
    if (c)
      return c.format(s, { key: n, ...i });
  }, [o, e]);
}
function _4() {
  const e = I1(ge);
...
function Pl(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = Wn(e), i = [];
...
function lr(e, r) {
  ...
  if (r === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: o, to: n } = e, s = Te(o) ? He(o) : String(o), i = Te(n) ? He(n) : String(n);
...
function cr({
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: d } = k1(), p = El(e), C = u ?? p, h = $(() => {
  }), g = n ?? e, x = s ?? r ?? "", w = l?.type === "form" && l.formName === e, v = () => f({
    type: "form",
    title: g,
    description: x,
    formName: e,
  ...
  const H = i && c ? Object.entries(i).map(([F, b]) => {
    const S = c[F], y = C?.(F, S, {
      fieldType: b.fieldType,
      customFieldName: b.customFieldName
    });
    if (!y && b.fieldType === "custom" && typeof S == "object" && S !== null)
      return null;
    const B = y ?? lr(S, b.fieldType), N = ["richtext", "textarea"];
    return {
      label: b.label,
      content: B,
      verticalLayout: N.includes(b.fieldType ?? "")
    };
  }).filter((F) => {
    if (!F) return !1;
    const b = Array.isArray(F.content) ? F.content[0] : F.content;
    return !(b?.type === "item" && b.text === "—");
  }) : [], A = H.slice(0, Ve), V = H.length > Ve;
  return /* @__PURE__ */ t(
    ar,
    {
      ...
      children: A.length > 0 && !w && /* @__PURE__ */ t("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ t(
        Gn,
        {
          details: A.map((F) => ({
            title: F.label,
...
function ur({ anchor: e, onReply: r }) {
  ...
  if (ie(() => {
    ...
    const u = n.current;
    if (!u) return;
    const l = u.offsetWidth, f = u.offsetHeight, d = window.innerWidth, p = window.innerHeight;
    let C = e.rect.top - f - Ee;
    C < $1 && (C = e.rect.bottom + Ee), C = Math.min(
      Math.max(C, $1),
      p - f - $1
    );
...
const fr = W1(void 0), Z4 = () => I1(fr), Zl = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), Ol = ({
  ...
  const u = typeof o?.content == "string" ? o.content : "", l = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, f = o?.toolCalls?.[0]?.id, d = !u && !l, p = $(null), { anchor: C, clear: h } = dr({
    containerRef: p,
    enabled: !!(o?.id && u)
  });
  return W(() => {
    o?.id && !r && !e && i?.(o);
  }, [o, r, e, i]), !r && !e && d ? null : /* @__PURE__ */ t(fr.Provider, { value: f, children: /* @__PURE__ */ a("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && u && /* @__PURE__ */ t(
      "div",
      {
        ref: p,
  ...
  const [s, i] = D(""), c = G(), { title: u, label: l, placeholder: f } = o === "like" ? c.ai.feedbackModal.positive : c.ai.feedbackModal.negative, d = O(() => {
    r(n, s);
  }, [s, n, r]), p = () => {
    e(n);
  };
...
const Wl = ({
  ...
  const n = G(), { open: s } = pr(), [i, c] = D(null);
    ...
    /* @__PURE__ */ t(
      B1,
      {
        onClick: (u) => {
          ...
          l && s(l, r), c(l), u.currentTarget.blur();
        },
        compact: !0,
        mode: "only",
        variant: "ghost",
  ...
  const [u, l] = D(s), f = v1(), d = n !== void 0, p = d ? n : u;
  return /* @__PURE__ */ a(
    Rt,
    {
      ...
      children: [
        /* @__PURE__ */ a(
          Ft,
          {
            ...
            children: [
              /* @__PURE__ */ t("span", { className: "flex items-center justify-start h-6 w-6", children: /* @__PURE__ */ t(a1, { icon: e, className: "block" }) }),
              /* @__PURE__ */ t("div", { className: "min-h-6 flex items-center", children: /* @__PURE__ */ t("span", { children: r }) }),
              !c && /* @__PURE__ */ t(a1, { icon: q1 })
            ]
          }
        ),
  ...
  const s = G(), [i, c] = D(!!o), u = $(o);
  W(() => {
    u.current && !o ? c(!1) : o && !i && c(!0), u.current = o;
  }, [o, i]);
  const l = o ? s.ai.thoughtsGroupTitle : r ?? s.ai.thoughtsGroupTitle, f = e.length - 1, d = (p) => !o || n ? "completed" : p === f ? "executing" : "completed";
  return /* @__PURE__ */ t(
    ql,
    {
      icon: Et,
...
const mr = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), Ql = ({
  ...
  /* @__PURE__ */ t("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ t(a1, { icon: ce }) }),
  ...
  const c = e.rawData, u = Kl(
    e?.content,
    c
  ), l = (Yl(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, d = l.length > 0, { anchor: p, clear: C } = dr({
    containerRef: i,
    enabled: d
  });
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        ...
        u.length > 0 && /* @__PURE__ */ t("div", { className: "flex max-w-[90%] flex-wrap justify-end gap-1.5", children: u.map((h, g) => /* @__PURE__ */ t(
          bt,
          {
  ...
  const [i, c] = D(0), [u, l] = D(0), [f, d] = D("starting"), p = v1(), C = e[i] ?? "", h = e.join("\0"), g = $(!0);
  W(() => {
    if (g.current) {
      g.current = !1;
      return;
    ...
    let v;
    if (f === "starting")
      v = setTimeout(() => d("writing"), r6);
    else if (f === "writing")
      u < C.length ? v = setTimeout(() => l((H) => H + 1), e6) : d("holding");
    else if (f === "holding") {
      if (e.length <= 1) return;
      v = setTimeout(() => d("erasing"), o6);
    } else f === "erasing" && (u > 0 ? v = setTimeout(() => l((H) => H - 1), t6) : v = setTimeout(() => {
      c((H) => (H + 1) % e.length), d("starting");
    }, n6));
    return () => {
      v && clearTimeout(v);
    };
  }, [f, u, C.length, e.length, p]);
  const x = !!n, w = x ? (v) => {
  ...
  return /* @__PURE__ */ t(
    "div",
    {
      ...
      children: /* @__PURE__ */ a("div", { className: "flex flex-col items-center", children: [
        ...
        /* @__PURE__ */ a(
          "p",
          {
            ...
            "aria-label": x ? C : void 0,
            children: [
              /* @__PURE__ */ t("span", { "aria-hidden": "true", children: p ? C : C.slice(0, u) }),
              /* @__PURE__ */ t("span", { className: "sr-only", children: C })
            ]
          },
          i
        ),
        o && /* @__PURE__ */ t("p", { className: "animate-in fade-in-0 mt-3 text-center text-base leading-snug text-f1-foreground-secondary duration-500", children: o })
      ] })
    }
  );
};
function i6({
  ...
  W(() => {
    ...
    const w = new ResizeObserver(() => {
      if (p.current) return;
      const v = parseFloat(getComputedStyle(x).paddingTop) + parseFloat(getComputedStyle(x).paddingBottom) + 1;
      u(g.clientHeight - v);
    });
  ...
  const h = O(() => {
    const g = e.current;
    if (!g) return;
    const { scrollTop: x, scrollHeight: w, clientHeight: v } = g, H = w - x - v;
    f(H > v);
  }, [e]);
  return W(() => {
    const g = e.current;
    ...
    s > d.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!g || !x) return;
        const w = g.getBoundingClientRect(), v = x.getBoundingClientRect(), H = g.scrollTop + (v.top - w.top);
        g.scrollTo({ top: H, behavior: "smooth" });
      });
    }), s === 0 && f(!1), d.current = s;
  }, [s, n, e]), { showScrollBtn: l, turnMinHeight: c, scrollToBottom: C };
}
const a6 = {
  threadId: "",
  onThumbsUp: () => {
  ...
  const { modal: F, handleSubmit: b, handleClose: S } = Gl(
    C ?? a6
  ), y = G(), B = v ?? Ol, N = H ?? Jl, T = K(() => {
    const j = n ?? y.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((n1) => typeof n1 == "string" && n1.length > 0);
  }, [n, y.ai.defaultInitialMessage]), I = !r && e.length === 0 && T.length > 0, U = $(null), Z = $(null), z = $(null), J = $(null), t1 = $(null), { showScrollBtn: q, turnMinHeight: X, scrollToBottom: r1 } = i6({
    viewportRef: U,
    contentRef: Z,
    endRef: z,
    lastTurnRef: t1,
    ...
    const n1 = o1 === e.length - 1, f1 = {
      ...
      const R = n1 && L === j.assistantMessages.length - 1, M = j.userMessages.length + L, P = {
        message: d1,
        inProgress: j.isInProgress,
        index: M,
        isCurrentMessage: R,
      ...
      return /* @__PURE__ */ t(
        B,
        {
          ...
          isLoading: j.isInProgress && R && !d1.content
        },
        `${o1}-a-${L}`
      );
    };
  ...
  return /* @__PURE__ */ a(R1, { children: [
                ...
                /* @__PURE__ */ a(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      !r && e.map((j, o1) => e1(j, o1)),
                      o
                    ]
                  }
                ),
                /* @__PURE__ */ t("div", { ref: J, className: "h-px shrink-0", "aria-hidden": !0 }),
                /* @__PURE__ */ t("footer", { className: "copilotKitMessagesFooter", ref: z, children: w }),
                /* @__PURE__ */ t(M1, { children: q && /* @__PURE__ */ t(
                  Q.div,
                  {
    ...
    F.isOpen && /* @__PURE__ */ t(
      Ul,
      {
        onSubmit: b,
        onClose: S,
        reactionType: F.currentReaction,
        message: F.currentMessage
      }
    )
  ] });
}, c6 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
...
const u6 = ({
  ...
  const C = G().ai.clarifyingQuestion.typeYourAnswer, h = $(null), g = vs(h, c);
  ie(() => {
    const v = h.current;
    if (!v) return;
    v.style.height = "auto";
    const H = Math.min(v.scrollHeight, $e);
    v.style.height = `${H}px`, v.style.overflowY = v.scrollHeight > $e ? "auto" : "hidden";
  }, [n]);
  const w = e === "single" ? /* @__PURE__ */ t(gr, { isSelected: (s || o) && !r }) : /* @__PURE__ */ t(
    Vt,
    {
      checked: s,
      onCheckedChange: () => f(!s),
      ...
      children: [
        ...
        /* @__PURE__ */ t(
          "textarea",
          {
            ...
            onFocus: u,
            onKeyDown: (v) => {
              v.key === "Enter" && !v.shiftKey && i && (v.preventDefault(), d());
            },
            placeholder: C,
            "aria-label": C,
  ...
  ({ option: e, isSelected: r, mode: o, isTabStop: n, onToggle: s, onKeyNavigate: i }, c) => o === "single" ? /* @__PURE__ */ a(
    "div",
    {
      ref: c,
      role: "radio",
...
const h6 = ({
  ...
  const v = v1(), H = (() => {
    ...
    const S = o.findIndex((y) => n.includes(y.id));
    return S >= 0 ? S : 0;
  })(), [A, V] = D(H), F = $([]);
  W(() => {
    p && e === "single" && F.current[A]?.focus();
  }, []);
  const b = (S) => {
    if (e !== "single") return;
    const y = o.length - 1;
    ...
    S.preventDefault(), V(B), F.current[B]?.focus();
  };
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      "aria-label": r,
      children: [
        o.map((S, y) => /* @__PURE__ */ t(
          Q.div,
          {
            initial: v ? !1 : { opacity: 0, y: 4 },
            animate: { opacity: 1, y: 0 },
            transition: {
              duration: v ? 0 : 0.2,
              ease: [0.4, 0, 0.2, 1],
              delay: v ? 0 : 0.12 + y * 0.06
            },
            children: /* @__PURE__ */ t(
              wr,
              {
                ...
                option: S,
                isSelected: n.includes(S.id),
                mode: e,
                isTabStop: e === "single" ? y === A : void 0,
                onToggle: C,
                onKeyNavigate: b
              }
            )
  ...
  } = s, S = $(null), y = H ?? "single", B = c > 1, N = i === 0, T = i === c - 1, I = B ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(c)
  }) : void 0, U = v.length > 0, Z = (F ?? "").trim().length > 0, z = U || b && Z || A === !0, J = r === !0 && T, t1 = () => {
    J || l();
  }, q = () => {
    J || f();
  }, X = (f1) => {
    const m1 = y === "single" && v.includes(f1);
    u(f1), y === "single" && !T && !m1 && Promise.resolve().then(l);
  }, r1 = T ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, e1 = A === !0 && !U && !(b && Z), j = () => {
    g(), requestAnimationFrame(() => {
      S.current?.focus();
    });
  }, o1 = (f1) => {
    f1.key === "Escape" && (f1.preventDefault(), d());
  }, n1 = n ? 0 : C6 / 2;
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: o1, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(M1, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      Q.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: n1, ease: m6 },
        children: [
          /* @__PURE__ */ t(
            p6,
            {
...
function Be(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), u = Math.min(i + n, s), l = Math.min(u, Math.floor(e / 2)), f = Math.min(u, Math.floor(r / 2)), d = (j) => j / e * 2 - 1, p = (j) => j / r * 2 - 1, C = 0, h = e, g = 0, x = r, w = l, v = e - l, H = f, A = r - f, V = d(C), F = d(h), b = p(g), S = p(x), y = d(w), B = d(v), N = p(H), T = p(A), I = 0, U = 0, Z = 1, z = 1, J = l / e, t1 = 1 - l / e, q = f / r, X = 1 - f / r, r1 = new Float32Array([
    // Top strip
    V,
    b,
    F,
...
function w6(e, r, o) {
  const n = Ie(e, e.VERTEX_SHADER, r), s = Ie(e, e.FRAGMENT_SHADER, o), i = e.createProgram();
  ...
  if (e.attachShader(i, n), e.attachShader(i, s), e.linkProgram(i), !e.getProgramParameter(i, e.LINK_STATUS)) {
    const c = e.getProgramInfoLog(i) || "Unknown link error";
    throw e.deleteProgram(i), e.deleteShader(n), e.deleteShader(s), new Error(c);
  }
...
class X4 {
  ...
  resize(r, o, n) {
    ...
    const { gl: s, program: i, vao: c, positionBuffer: u, uvBuffer: l, uResolution: f } = this.glr, d = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, p = Math.max(1, Math.floor(r * d)), C = Math.max(1, Math.floor(o * d));
    ...
    s.bindVertexArray(c), s.bindBuffer(s.ARRAY_BUFFER, u), s.bufferData(s.ARRAY_BUFFER, h, s.STATIC_DRAW);
    const x = s.getAttribLocation(i, "aPosition");
    ...
    s.enableVertexAttribArray(w), s.vertexAttribPointer(w, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after UV buffer update"), s.useProgram(i), s.uniform2f(f, this.canvas.width, this.canvas.height), s.uniform1f(this.glr.uBorderWidth, this.options.borderWidth * d), s.uniform1f(this.glr.uGlowWidth, this.options.glowWidth * d), s.uniform1f(this.glr.uBorderRadius, this.options.borderRadius * d), this.checkGLError(s, "resize: after uniform updates");
    const v = performance.now();
    this.lastTime = v;
    const H = (v - this.startTime) * 1e-3;
    this.render(H);
  }
  /**
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: c, uvs: u } = Be(
      s,
      i,
    ...
    const C = r.getUniformLocation(o, "uResolution"), h = r.getUniformLocation(o, "uTime"), g = r.getUniformLocation(o, "uBorderWidth"), x = r.getUniformLocation(o, "uGlowWidth"), w = r.getUniformLocation(o, "uBorderRadius"), v = r.getUniformLocation(o, "uColors"), H = r.getUniformLocation(o, "uGlowExponent"), A = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(g, this.options.borderWidth), r.uniform1f(x, this.options.glowWidth), r.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(H, 2), r.uniform1f(A, 1.8)) : (r.uniform1f(H, 1), r.uniform1f(A, 1));
    const V = (this.options.colors || b6).map(L6);
    for (let F = 0; F < V.length; F++)
      r.uniform3f(
        r.getUniformLocation(o, `uColors[${F}]`),
        ...V[F]
      );
...
class H6 {
  ...
  updateTexture = (r, o, n) => {
    const { gl: s } = this, i = 0, c = s.RGBA, u = s.RGBA, l = s.UNSIGNED_BYTE;
  ...
  load = async (r) => {
    ...
    const f = /(\.jpg|\.jpeg|\.png|\.gif|\.bmp)$/i.exec(n), d = /(\.mp4|\.3gp|\.webm|\.ogv)$/i.exec(n);
    if (f === null && d === null)
      return Promise.reject(
        new Error(
          L1(
    ...
    Object.assign(this, { url: n, wrapS: s, wrapT: i, minFilter: c, magFilter: u, flipY: l });
    const p = 0, C = o.RGBA, h = 1, g = 1, x = 0, w = o.RGBA, v = o.UNSIGNED_BYTE, H = new Uint8Array([255, 255, 255, 0]), A = o.createTexture();
    if (o.bindTexture(o.TEXTURE_2D, A), o.texImage2D(
      o.TEXTURE_2D,
      p,
      C,
      h,
      ...
      return o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.LINEAR), this._webglTexture = A, this.source = S, this.isVideo = !0, S.play().then(() => this);
    }
    async function V() {
      return new Promise((S, y) => {
        ...
        B.crossOrigin = "anonymous", B.onload = () => {
          ...
          y(new Error(L1(`failed loading url: ${n}`)));
        }, B.src = n ?? "";
      });
    }
    let F = await V(), b = (F.width & F.width - 1) === 0 && (F.height & F.height - 1) === 0;
    return (r.wrapS !== Xe || r.wrapT !== Xe || r.minFilter !== qe && r.minFilter !== re) && !b && (F = this.makePowerOf2(F), b = !0), o.bindTexture(o.TEXTURE_2D, A), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, l), o.texImage2D(
      o.TEXTURE_2D,
      p,
      C,
      w,
      v,
      F
    ), b && r.minFilter !== qe && r.minFilter !== re && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || Ye
    ), o.texParameteri(
...
const L1 = (e) => `react-shaders: ${e}`, Ke = (e) => {
...
function E6({
  ...
  const h = $(null), g = $(null), x = $(null), w = $(null), v = $(void 0), H = $(void 0), A = $(!1), V = $(void 0), F = $(0), b = $([0, 0]), S = $([]), y = $(0), B = $(void 0), N = $({
    ...
    const M = "width" in L ? L.width ?? 0 : 0, P = "height" in L ? L.height ?? 0 : 0, E = N.current.iChannelResolution;
    if (!E) return;
    const _ = Array.isArray(E.value) ? E.value : E.value = [];
    _[R * 3] = M * f, _[R * 3 + 1] = P * f, _[R * 3 + 2] = 0;
  }, U = () => {
    h.current && (g.current = h.current.getContext("webgl", u) || h.current.getContext(
      "experimental-webgl",
      u
    ), g.current?.getExtension("OES_standard_derivatives"), g.current?.getExtension("EXT_shader_texture_lod"));
  }, Z = () => {
    const L = g.current;
    x.current = L?.createBuffer() ?? null, L?.bindBuffer(L.ARRAY_BUFFER, x.current);
    const R = [
      1,
      1,
      0,
    ...
    const [R = 0, M = 0] = Ke(L), P = R - (V.current?.left ?? 0) - window.pageXOffset, E = (V.current?.height ?? 0) - M - (V.current?.top ?? 0) - window.pageYOffset;
    A.current = !0;
    const _ = Array.isArray(N.current.iMouse?.value) ? N.current.iMouse.value : void 0;
    _ && (_[2] = P, _[3] = E), b.current[0] = P, b.current[1] = E;
  }, t1 = (L) => {
    V.current = h.current?.getBoundingClientRect();
    const [R = 0, M = 0] = Ke(L), P = R - (V.current?.left ?? 0), E = (V.current?.height ?? 0) - M - (V.current?.top ?? 0);
    if (l !== 1)
      b.current[0] = P, b.current[1] = E;
    else {
      const _ = Array.isArray(N.current.iMouse?.value) ? N.current.iMouse.value : void 0;
      _ && (_[0] = P, _[1] = E);
    }
    ...
    if (L.canvas.width = M, L.canvas.height = P, N.current.iResolution?.isNeeded && w.current) {
    ...
    const M = g.current;
    if (!M) return null;
    const P = M.createShader(L);
    if (!P) return null;
    if (M.shaderSource(P, R), M.compileShader(P), !M.getShaderParameter(P, M.COMPILE_STATUS)) {
      C?.(L1(`Error compiling the shader:
${R}`));
      const E = M.getShaderInfoLog(P);
      M.deleteShader(P), p?.(L1(`Shader compiler log: ${E}`));
    }
    return P;
  }, e1 = (L, R) => {
    const M = g.current;
    if (!M) return;
    const P = r1(M.FRAGMENT_SHADER, L), E = r1(M.VERTEX_SHADER, R);
    if (w.current = M.createProgram(), !(!w.current || !E || !P)) {
      if (M.attachShader(w.current, E), M.attachShader(w.current, P), M.linkProgram(w.current), !M.getProgramParameter(w.current, M.LINK_STATUS)) {
        p?.(
          L1(
      ...
      M.useProgram(w.current), v.current = M.getAttribLocation(
        w.current,
        "aVertexPosition"
      ), M.enableVertexAttribArray(v.current);
    }
  }, j = () => {
    if (n)
      for (const L of Object.keys(n)) {
        const R = n[L];
        if (!R) continue;
        const { value: M, type: P } = R, E = S6(P);
        if (!E) continue;
        const _ = {};
        if (R6(P, M)) {
          const c1 = P.length, u1 = Number.parseInt(P.charAt(c1 - 3)), g1 = Math.floor(M.length / (u1 * u1));
          M.length > u1 * u1 && (_.arraySize = `[${g1}]`);
        } else F6(P, M) && (_.arraySize = `[${Math.floor(M.length / Number.parseInt(P.charAt(0)))}]`);
        N.current[L] = {
          type: E,
          isNeeded: !1,
          value: M,
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (M, P) => (N.current[`${M6}${P}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, I(M, P), S.current[P] = new H6(L), S.current[P]?.load(M).then((E) => {
            I(E, P);
          }))
        );
        Promise.all(R).then(() => {
...
`).concat(L.replace(/texture\(/g, "texture2D("));
    for (const _ of Object.keys(N.current))
      if (L.includes(_)) {
        ...
        P = A6(
          P,
          `uniform ${c1.type} ${_}${c1.arraySize || ""}; 
`,
          P.lastIndexOf(M) + M.length
        ), c1.isNeeded = !0;
      }
    return L.includes("mainImage") && (P = P.concat(k6)), P;
  }, f1 = (L) => {
    const R = g.current;
    ...
    if (P)
      for (const E of Object.keys(P)) {
        const _ = P[E];
        if (_ && N.current[E]?.isNeeded) {
          if (!w.current) return;
          const c1 = R.getUniformLocation(
            w.current,
            E
          );
          if (!c1) return;
    ...
    if (N.current.iMouse?.isNeeded) {
      const E = R.getUniformLocation(
        w.current,
        Ue
      );
      R.uniform4fv(E, N.current.iMouse.value);
    }
    ...
    if (N.current.iDate?.isNeeded) {
      const E = /* @__PURE__ */ new Date(), _ = E.getMonth() + 1, c1 = E.getDate(), u1 = E.getFullYear(), g1 = E.getHours() * 60 * 60 + E.getMinutes() * 60 + E.getSeconds() + E.getMilliseconds() * 1e-3, s1 = R.getUniformLocation(
        w.current,
        Ze
      );
      R.uniform4fv(s1, [u1, _, c1, g1]);
    }
    if (N.current.iFrame?.isNeeded) {
      const E = R.getUniformLocation(
        w.current,
        Oe
      ), _ = N.current.iFrame.value;
      R.uniform1i(E, _), N.current.iFrame.value = _ + 1;
    }
    if (S.current.length > 0)
      for (let E = 0; E < S.current.length; E++) {
        const _ = S.current[E];
        if (!_) return;
        const { isVideo: c1, _webglTexture: u1, source: g1, flipY: s1, isLoaded: V1 } = _;
        if (!V1 || !u1 || !g1) return;
        if (N.current[`iChannel${E}`]?.isNeeded) {
          if (!w.current) return;
          const S1 = R.getUniformLocation(
            w.current,
            `iChannel${E}`
          );
          R.activeTexture(R.TEXTURE0 + E), R.bindTexture(R.TEXTURE_2D, u1), R.uniform1i(S1, E), c1 && _.updateTexture(
            u1,
            g1,
            s1
          );
    ...
    const R = g.current;
    if (!R) return;
    R.viewport(0, 0, R.drawingBufferWidth, R.drawingBufferHeight), R.clear(R.COLOR_BUFFER_BIT | R.DEPTH_BUFFER_BIT), R.bindBuffer(R.ARRAY_BUFFER, x.current), R.vertexAttribPointer(
      v.current ?? 0,
      3,
      R.FLOAT,
      !1,
      0,
      0
    ), f1(L), R.drawArrays(R.TRIANGLE_STRIP, 0, 4);
    const M = N.current.iMouse?.value;
    if (N.current.iMouse?.isNeeded && l !== 1 && Array.isArray(M)) {
      const P = M[0] ?? 0, E = M[1] ?? 0;
      M[0] = Qe(P, b.current[0] ?? 0, l), M[1] = Qe(E, b.current[1] ?? 0, l);
    }
    H.current = requestAnimationFrame(m1);
  }, N1 = () => {
    const L = { passive: !0 };
  ...
  return W(() => {
    ...
    function R() {
      U();
      const M = g.current;
      M && h.current && (M.clearColor(...s), M.clearDepth(1), M.enable(M.DEPTH_TEST), M.depthFunc(M.LEQUAL), M.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, j(), o1(), e1(n1(e || y6), r || De), Z(), requestAnimationFrame(m1), N1(), X());
    }
    return requestAnimationFrame(R), () => {
      ...
      d1(), cancelAnimationFrame(H.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
function _6(e, r) {
  const [o, n] = D(B6), {
    ...
    animate: i,
    motionValue: c
  } = U1(D6), { value: u, animate: l } = U1(I6), { value: f, animate: d } = U1(P6), { value: p, animate: C } = U1(j6), h = bs(r, {
    fftSize: 512,
  ...
  return W(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, C1), l(1.2, C1), d(0.4, C1), C(1, C1);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, C1), d(0.7, C1), C([1.5, 2], Je);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, C1), l(0.5, C1), d(1, C1), C([0.5, 2.5], Je);
        return;
      case "speaking":
        n(70), i(0.3, C1), l(0.75, C1), d(1.25, C1), C(1.5, C1);
        return;
    }
  }, [
    e,
    ...
    e === "speaking" && h > 0 && !c.isAnimating() && i(0.2 + 0.2 * h, { duration: 0 });
  }, [
    e,
    h,
    c,
...
function vr({
  ...
  const h = K(() => O6(c), [c]);
  return /* @__PURE__ */ t("div", { ref: d, className: p, ...C, children: /* @__PURE__ */ t(
    E6,
    {
      fs: $6,
...
function Y4({
  ...
  const { speed: f, scale: d, amplitude: p, frequency: C, brightness: h } = _6(r, s);
  return /* @__PURE__ */ t(
    vr,
    {
      ref: u,
...
const K4 = ({
  ...
  const n = G(), s = v1();
  return /* @__PURE__ */ a(R1, { children: [
    e && /* @__PURE__ */ t("span", { className: k(z6(), "truncate"), children: e }),
    /* @__PURE__ */ t(M1, { children: o && r && /* @__PURE__ */ t(
      Q.div,
      {
  ...
  return /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ t("span", { className: k(xr()), children: r }),
    /* @__PURE__ */ a(
      Q.div,
      {
...
const K6 = ({
  ...
  const s = `sparkline-gradient-${G1().replace(/:/g, "")}`, i = Y6(e, o), c = br[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(ns, { width: "100%", height: "100%", children: /* @__PURE__ */ a(
          ss,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(is, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                as,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(Q6, { label: r, direction: i })
      ]
    }
  ) });
}, Lr = m(
  (e, r) => {
    const {
      ...
      className: l,
      ...f
    } = e, [d, p] = D(!1), [C, h] = D(!1), g = d || C, x = v1(), w = g && !!u, v = {
      duration: x ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, H = () => {
      c?.();
    }, A = (V) => {
      V.currentTarget === V.target && (V.key === "Enter" || V.key === " ") && (V.preventDefault(), c?.());
    };
    return /* @__PURE__ */ a("div", { className: "relative", children: [
      i && /* @__PURE__ */ a(R1, { children: [
        /* @__PURE__ */ t(
          "div",
          {
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ t("span", { className: k(xr()), children: n }),
              /* @__PURE__ */ t(
                Q.div,
                {
...
function i4(e) {
  const {
    ...
    description: i,
    seeMoreLabel: c,
    maxCollapsedDescriptionLength: u = yr
  } = e, [l, f] = D(!1), d = G1(), p = $(null), C = r4(
    u
  ), h = i.length > C, g = l ? i : o4(i, C), x = n4(e) ? e : null, w = s4(e);
  return W(() => {
    l && p.current?.focus();
  }, [l]), /* @__PURE__ */ a(
    "section",
...
const a4 = ({
  ...
  return /* @__PURE__ */ a(
    Rt,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ a(Ft, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
          /* @__PURE__ */ t("span", { className: "mr-2 *:block", children: /* @__PURE__ */ t(a1, { icon: e, className: "block" }) }),
...
}, l4 = (e) => u2[e] ?? ut, c4 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(a1, { icon: l4(e), size: "md", color: "default" }) }) : null;
function d4({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(a4, { icon: de, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
function f4({
  ...
  const n = G(), s = $(null), i = r ?? n.ai.aiTable.title, c = O(
    (u) => {
      if (!s.current) return;
      const l = o ?? (i.replace(/\s+/g, "_").toLowerCase() || "table");
      u4(s.current, u, l);
    },
    [i, o]
  );
  return e.columns?.length ? /* @__PURE__ */ a(
    te,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(te, { overflowX: "auto", children: /* @__PURE__ */ a(
          "table",
          {
            ref: s,
            className: k(
            ...
            children: [
              ...
              /* @__PURE__ */ t("tbody", { children: e.rows.map((u, l) => /* @__PURE__ */ t("tr", { children: e.columns.map((f) => {
                const d = u[f];
                return /* @__PURE__ */ t(
                  "td",
                  {
                    className: "max-w-72 border-0 border-b border-solid border-f1-border-secondary px-3 py-2 text-f1-foreground",
                    children: /* @__PURE__ */ t(l1, { children: d == null ? "" : String(d) })
                  },
                  f
                );
              }) }, l)) })
...
function h4({ credits: e, trigger: r }) {
  const o = G(), [n, s] = D(!1), [i, c] = D(!1), [u, l] = D(!1), [f, d] = D(null), p = O(
    (g) => {
  ...
  if (!e) return null;
  const C = f ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, h = e.companyName;
  return /* @__PURE__ */ a(fe, { open: n, onOpenChange: p, children: [
        ...
        children: [
          h && /* @__PURE__ */ a("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            ...
            /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ t(l1, { tag: "span", className: "font-medium", children: e.companyName ?? "" }),
          ...
          /* @__PURE__ */ a("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: [
            /* @__PURE__ */ a("div", { className: "flex flex-col gap-2 p-3", children: [
              ...
              u && /* @__PURE__ */ t("span", { className: "text-sm text-f1-foreground-secondary", children: o.t("ai.credits.creditsError") }),
              !i && !u && f && /* @__PURE__ */ a(R1, { children: [
                /* @__PURE__ */ a("div", { className: "flex justify-between", children: [
...
function m4({
  ...
  const o = G(), n = v1(), [s, i] = D(!1), [c, u] = D(!1), [l, f] = D(!1), [d, p] = D(null), C = O(
    (w) => {
      i(w), w && e?.fetchUsage && (u(!0), f(!1), e.fetchUsage().then((v) => {
        p(v), f(!1);
      }).catch(() => {
        f(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const h = !!e.companyName, g = d && d.total > 0 ? Math.min(100, Math.round(d.used / d.total * 100)) : 0, x = d ? Math.max(0, d.total - d.used) : 0;
  return /* @__PURE__ */ a(fe, { open: s, onOpenChange: C, children: [
    /* @__PURE__ */ t(St, { asChild: !0, children: r ?? /* @__PURE__ */ t(
      i1,
      {
        variant: "ghost",
      ...
      he,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ t("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2 p-3", children: [
            ...
            !c && !l && d && /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ a("div", { className: "flex justify-between", children: [
...
const se = ({
  ...
  const g = G(), x = v1(), w = ds(`(max-width: ${us.md}px)`, {
        ...
        /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ t(
          B1,
          {
            ...
            children: /* @__PURE__ */ a("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ t(l1, { lines: 1, className: "min-w-0 text-left", children: o ?? g.ai.newConversation }),
              /* @__PURE__ */ t(a1, { icon: le, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ a(
...
function w4(e, r) {
  ...
  const i = !fs(o, /* @__PURE__ */ new Date());
  return `${Fe(o, i ? "MMM d yyyy" : "MMM d", {
    locale: n
  })}, ${s}`;
}
function v4(e) {
      ...
      children: [
        /* @__PURE__ */ a(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t(l1, { lines: 1, className: "py-0.5 text-left font-medium", children: e.title }),
        ...
        n ? (
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ t(pe, { items: d, children: /* @__PURE__ */ t(
              i1,
              {
                icon: dt,
                variant: "ghost",
...
function et({
  ...
  return /* @__PURE__ */ a("div", { children: [
    ...
    u && /* @__PURE__ */ t("div", { className: "flex flex-col", children: r.map((p) => /* @__PURE__ */ t(
      x4,
      {
        thread: p,
        isPinned: o.has(p.id),
...
const tt = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], b4 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(h1, { className: k("h-4 rounded", e) }) }), rt = ({
  titleWidth: e,
  rows: r
}) => /* @__PURE__ */ a("div", { className: "flex flex-col gap-0.5", children: [
  /* @__PURE__ */ t("div", { className: "flex items-center p-1.5", children: /* @__PURE__ */ t(h1, { className: k("h-3 rounded", e) }) }),
...
const r9 = ({
  ...
  const h = K(
    ...
    return n.filter((S) => S.title.toLowerCase().includes(b));
  }, [n, p]), x = K(
    () => g.filter((b) => c.has(b.id)),
    [g, c]
  ), w = K(
    () => g.filter((b) => !c.has(b.id)),
    [g, c]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ t(a1, { icon: de, color: "secondary", size: "md" }),
                  /* @__PURE__ */ t(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ t(
                    B1,
                    {
                      ...
                      children: /* @__PURE__ */ a("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ t(a1, { icon: Ce, color: "default", size: "md" }),
                        /* @__PURE__ */ t(l1, { lines: 1, className: "text-left", children: d.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ t(L4, {}),
                  !s && i && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: i }),
                  !s && !i && !F && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: d.ai.noPreviousChats }),
...
function o9({
  ...
  const [i, c] = D([]), [u, l] = D(!1), [f, d] = D(null), [p, C] = D(k4), [h, g] = D(() => /* @__PURE__ */ new Set()), x = O(async () => {
    l(!0), d(null);
    try {
      const b = await r();
      c(b);
    } catch (b) {
      const S = b instanceof Error ? b.message : "Failed to fetch chat history";
      d(S), c([]);
    } finally {
      l(!1);
    }
  ...
  const w = O((b, S) => {
    C((y) => {
      if (S === y.has(b)) return y;
      const B = new Set(y);
      return S ? B.add(b) : B.delete(b), ot(B), B;
    });
  }, []), v = O((b, S) => {
    g((y) => {
      if (S === y.has(b)) return y;
      const B = new Set(y);
      return S ? B.add(b) : B.delete(b), B;
    });
  }, []), H = O(
    (b, S) => {
      const y = S ? n : s;
      w(b, S), y && (v(b, !0), y(b).catch(() => w(b, !S)).finally(() => v(b, !1)));
    },
    [n, s, w, v]
  ), A = O((b) => H(b, !0), [H]), V = O(
    (b) => H(b, !1),
    ...
    async (b) => {
      v(b, !0);
      try {
        await o(b), c((S) => S.filter((y) => y.id !== b)), C((S) => {
          if (!S.has(b)) return S;
          const y = new Set(S);
          return y.delete(b), ot(y), y;
        });
      } catch {
        x();
      } finally {
...
const y4 = Q.create(ws), M4 = ({
  ...
  const { t: i } = G(), c = v1(), u = o ?? i("ai.applyingChanges");
  return W(() => {
    if (!r) return;
    const l = document.activeElement;
    l && l.getAttribute("name") !== "one-ai-input" && l.blur();
  }, [r]), /* @__PURE__ */ a("div", { className: k("relative flex flex-1 flex-col", n), children: [
    /* @__PURE__ */ t(M1, { children: r && // Zero-height sticky anchor pinned to the top of the scroll viewport,

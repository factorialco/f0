...
import { useInsertionEffect as es, forwardRef as m, useRef as I, useState as D, useCallback as X, useEffect as ae, useMemo as ce, createContext as $t, useContext as kt, useLayoutEffect as oo, useId as so, createElement as ts } from "react";
import { c3 as rs, c4 as ns, c5 as os, W as ao, c6 as ss, c7 as as, c8 as is, c9 as cs, ca as ls, cb as io, cc as ds, cd as us, a4 as Ar, ce as fs, aG as hs, cf as ps, cg as ms, ch as gs, ae as vs, ci as Cs, bB as ws, a8 as Vr, ab as xs, cj as ks, a2 as Fr, _ as co, N as Qt, a1 as lo, b2 as ys, ck as bs, aY as Ls, bA as Ms, Y as Ye, as as Es, b6 as uo, cl as _s, by as fo, cm as tt, bu as Rs, cn as Ss, co as Ns, aX as ho, cp as Ts, cq as As, cr as Vs, cs as Fs, ct as po, bn as Ps, bo as $s, cu as Hs, cv as Is, cw as js, cx as Os, cy as Zs, cz as Ds, cA as Bs, cB as Us, cC as zs, cD as Ws, cE as Gs, cF as qs, cG as Ys, bz as Xs, a9 as Ks, bj as Qs, cH as Js, cI as ea, cJ as ta, cK as ra, cL as na, cM as oa, cN as sa, an as aa, cO as mo, J as ia, Z as ca, cP as go, cQ as la, b5 as da, b4 as ua, cR as fa, cS as vo, cT as ha, aW as pa, aw as ma, cU as ga, aq as va, b0 as Ca, cV as Co, cW as wa, cX as xa, ba as Pr, cY as $r, bw as ka, bv as ya, bx as wo, cZ as ba, z as La, y as Ma, c_ as Ea, c$ as _a, d0 as Ra, d1 as Sa, d2 as Na, d3 as xo, d4 as Ta, aa as Aa, d5 as Va, H as ye, m as N, o as st, bd as Fa, d6 as ko, aj as Pa, d7 as $a, A as De, n as Ce, d8 as Xr, ar as Ha, u as he, d9 as Ia, da as ja, bS as Oa, l as Za, k as Da, i as Ba, w as yo, db as Ua, dc as za, dd as Wa, de as Ga, df as qa, dg as Ya, a6 as bo, a7 as Xa, S as Pe, c1 as Lo, C as be, s as Ne, $ as Ka, M as Re, dh as Qa, ac as Le, aL as ze, aB as Hr, di as Ja, aC as Ir, aD as jr, b as Xe, br as ei, O as ti, aV as ri, a3 as Or, dj as ni, dk as oi, dl as si, dm as Kr, a0 as ai, ai as Mo, aN as Eo, dn as ii, bN as ci, aS as _o, bH as li, dp as di, aP as At, b8 as Ro, dq as So, b9 as No, dr as To, ds as ui, dt as fi, bc as hi, du as pi, b1 as Zr, bk as mi, dv as gi, dw as vi, dx as Ci, dy as wi, dz as xi, ad as ki, x as yi, dA as Ao, dB as Vo, dC as bi, ah as Qr, dD as Li, ag as Mi, dE as Ei, dF as _i } from "./F0CanvasPanel-Cj_dMojK.js";
...
import './useChatHistory.css';function Ni(t, e, r) {
  es(() => t.on(e, r), [t, e, r]);
}
const Ti = (t, e) => /* @__PURE__ */ f(
  "svg",
  {
...
jo.displayName = "ShoppingCart";
const cd = (t, e) => /* @__PURE__ */ f(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
), Gd = m(Wd), qd = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Ai,
  Add: rs,
  Ai: ns,
  ...
  Calculator: Cs,
  Calendar: ws,
  CalendarArrowDown: oc,
  CalendarArrowLeft: ac,
  CalendarArrowRight: cc,
  CameraPlus: dc,
  CardPin: fc,
  ChartFunnel: pc,
  ChartHorizontalBars: gc,
  ChartLine: Cc,
  ChartPie: xc,
  ChartVerticalBars: yc,
  Check: Vr,
  CheckCircle: xs,
  CheckCircleLine: Lc,
  CheckDouble: ks,
  ...
  FaceNeutral: Is,
  FacePositive: js,
  FaceSuperNegative: Os,
  FaceSuperPositive: Zs,
  Feed: fl,
  File: pl,
  FileFilled: gl,
  FileSigned: Cl,
  ...
  Wifi: Gd,
  Windows: Va
}, Symbol.toStringTag, { value: "Module" })), Yd = (t, e) => /* @__PURE__ */ o(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ o(
    ye,
    {
      ...
      variant: "ai",
      ref: e,
      iconRotate: t.icon == Xd
    }
  );
});
Uo.displayName = "AIButton";
const zo = {
  background: {
...
const p2 = st({
  ...
  ({
    ...
    const bt = G && G !== "none" || j && j !== "none" || K && K !== "none" || we && we !== "none", rr = M && M !== "none" || bt, nr = { sm: Jt, md: Ht, lg: er, xl: tr }, or = m2.map((jt) => {
      const Lt = nr[jt];
      return Lt ? h2(jt, Lt) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ o(
      "div",
      {
        ...
        className: N(
          ...
          or,
          rr && !ne && "border-f1-border",
          U && !re && "divide-f1-border",
          "scrollbar-macos"
        ),
        ...lt
      }
...
const ar = Fa(
  ...
  n1
), g2 = ["variant", "disableClose"], Jr = ({ position: t }) => /* @__PURE__ */ o(
  Ce.div,
  {
    initial: { opacity: 0 },
    animate: { opacity: 0.6 },
  ...
  const { position: r } = ko(), n = I(null), [s, a] = D(!0), [i, l] = D(!0), c = X(() => {
    const d = n.current;
    if (!d) return;
  ...
  const e = Xr(t.primaryAction), r = Xr(t.secondaryAction), n = r.length > 0, s = e.length > 0;
  if (!s && !n)
    return null;
  const a = (l) => new Promise((c) => {
    ...
    if (!s) return null;
    const l = t.type === "critical" ? "critical" : "default";
    return e.length > 1 ? /* @__PURE__ */ o(
      Ha,
      {
        items: e.map((c) => ({
        ...
        onClick: async (c) => {
          const d = e.find((u) => u.value === c);
          await (d ? a(d?.onClick) : Promise.resolve()), d?.closeOnClick && t.onClose();
        },
        variant: "default"
      }
    ) : /* @__PURE__ */ o(
      ye,
      {
        block: t.variant === "notification",
        label: e[0].label,
        onClick: async () => {
          await a(e[0].onClick), e[0]?.closeOnClick && t.onClose();
        },
        variant: l,
        icon: e[0].icon,
  ...
  return /* @__PURE__ */ o("div", { className: "flex flex-row items-center justify-between border-x-0 border-b-0 border-t border-solid border-f1-border-secondary px-4 py-3", children: /* @__PURE__ */ f(
    "div",
    {
      className: N(
      ...
      children: [
        r.length > 0 && r.map((l) => /* @__PURE__ */ o(
          ye,
          {
            block: t.variant === "notification",
            label: l.label,
            onClick: async () => {
              await a(l.onClick), l.closeOnClick && t.onClose();
            },
            variant: "outline",
            icon: l.icon,
            disabled: l.disabled,
  ...
  const c = he(), { onClose: d } = ko(), u = !!s, h = () => /* @__PURE__ */ o("div", { className: "h-4 w-px self-center bg-f1-background-secondary" }), g = n?.filter(
    (C) => C.type !== "separator" && C.type !== "label"
  ) ?? [], p = () => !g.length || !n ? null : g.length <= 2 ? /* @__PURE__ */ o("div", { className: "flex flex-row gap-2", children: g.map((C) => /* @__PURE__ */ o(
    ye,
    {
      variant: "outline",
      icon: C.icon,
    ...
    C.label
  )) }) : /* @__PURE__ */ o(Ba, { items: n }), v = () => r ? /* @__PURE__ */ o(Za, { children: /* @__PURE__ */ o(
    Da,
    {
      item: {
        id: r.id,
  ...
  return /* @__PURE__ */ f(Ue, { children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ f("div", { className: "flex flex-col gap-1", children: [
            r ? /* @__PURE__ */ o(v, {}) : t && /* @__PURE__ */ o(Ia, { className: "py-1 text-lg font-semibold text-f1-foreground", children: t }),
            !!e && /* @__PURE__ */ o(ja, { className: "text-base text-f1-foreground-secondary", children: e })
          ] }),
    ...
    s && s.length > 0 && /* @__PURE__ */ o("div", { className: "-mx-2", children: /* @__PURE__ */ o(
      Oa,
      {
        tabs: s,
        activeTabId: a,
...
}, x2 = () => yo("(max-width: 560px)", {
  initializeWithValue: !1
}), k2 = st({
  variants: {
    position: {
      right: "absolute flex flex-col rounded-md w-full left-auto right-0 items-end p-3",
  ...
  ae(() => {
    v.current === !0 && !t && r(), v.current = t;
  }, [t, r]);
  const C = ce(() => n === "left" || n === "right", [n]), x = ce(() => C ? "sm" : (l && n !== "center" && console.warn(
  ...
  return /* @__PURE__ */ o(
    Ua,
    {
      ...
      shownBottomSheet: !0,
      children: g ? /* @__PURE__ */ f(za, { open: t, onOpenChange: p, children: [
        /* @__PURE__ */ o(
          Wa,
          {
            className: N("bg-f1-background-overlay", c && "h-full")
          }
        ),
        /* @__PURE__ */ o(
          Ga,
        ...
        /* @__PURE__ */ o(
          qa,
          {
            ...
            children: /* @__PURE__ */ o(
              ...
              {
                ref: h,
                wrapperClassName: k2({ position: n }),
                className: N(
                  y2({ size: x }),
                  c && "h-full"
                ),
  ...
  const P = ce(() => /* @__PURE__ */ f(Ue, { children: [
    x !== "notification" && /* @__PURE__ */ o(
      w2,
      {
        title: l,
        description: c,
    ...
    /* @__PURE__ */ o(v2, { disableContentPadding: C ?? !1, children: n }),
    /* @__PURE__ */ o(
      C2,
      {
        primaryAction: a ?? [],
  ...
  const e = M2.reduce((r, n) => {
    const { [n]: s, ...a } = r;
    return a;
  }, t);
  return /* @__PURE__ */ o(L2, { ...e });
};
o1.displayName = "F0Dialog";
const E2 = bo(
  Xa("F0Dialog", o1)
), _2 = ["days", "hours", "minutes", "seconds"], u3 = ["sm", "md"], s1 = [..._2], f3 = ["hours", "minutes"], We = {
  days: 86400,
  hours: 3600,
  minutes: 60,
  seconds: 1
...
function p3(t, e) {
  ...
  const s = { days: 0, hours: 0, minutes: 0, seconds: 0 }, a = s1.filter((i) => e.includes(i));
  for (const i of a)
...
const ee = Object.freeze({
  status: "aborted"
}), Rt = (t) => ({ status: "dirty", value: t }), $e = (t) => ({ status: "valid", value: t }), tn = (t) => t.status === "aborted", rn = (t) => t.status === "dirty", gt = (t) => t.status === "valid", Ut = (t) => typeof Promise < "u" && t instanceof Promise;
var q;
(function(t) {
...
const A2 = /^c[^\s-]{8,}$/i, V2 = /^[0-9a-z]+$/, F2 = /^[0-9A-HJKMNP-TV-Z]{26}$/i, P2 = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i, $2 = /^[a-z0-9_-]{21}$/i, H2 = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/, I2 = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/, j2 = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i, O2 = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let ir;
const Z2 = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, D2 = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/, B2 = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/, U2 = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/, z2 = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/, W2 = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/, a1 = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))", G2 = new RegExp(`^${a1}$`);
function i1(t) {
  let e = "[0-5]\\d";
...
function X2(t, e) {
  return !!((e === "v4" || !e) && Z2.test(t) || (e === "v6" || !e) && B2.test(t));
}
function K2(t, e) {
  if (!H2.test(t))
    return !1;
...
function Q2(t, e) {
  return !!((e === "v4" || !e) && D2.test(t) || (e === "v6" || !e) && U2.test(t));
}
class et extends ie {
  _parse(e) {
    ...
    for (const a of this._def.checks)
      if (a.kind === "min")
        ...
        j2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
          validation: "email",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "emoji")
        ir || (ir = new RegExp(O2, "u")), ir.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
          validation: "emoji",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "uuid")
        P2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
          validation: "uuid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "nanoid")
        $2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
          validation: "nanoid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "cuid")
        A2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
          validation: "cuid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "cuid2")
        V2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
          validation: "cuid2",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "ulid")
        F2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
          validation: "ulid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
        ...
        message: a.message
      }), n.dirty()) : a.kind === "datetime" ? Y2(a).test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
        code: A.invalid_string,
        validation: "datetime",
        message: a.message
      }), n.dirty()) : a.kind === "date" ? G2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
        code: A.invalid_string,
        validation: "date",
        message: a.message
      }), n.dirty()) : a.kind === "time" ? q2(a).test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
        code: A.invalid_string,
        validation: "time",
        message: a.message
      }), n.dirty()) : a.kind === "duration" ? I2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
        validation: "duration",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "ip" ? X2(e.data, a.version) || (s = this._getOrReturnCtx(e, s), O(s, {
        validation: "ip",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "jwt" ? K2(e.data, a.alg) || (s = this._getOrReturnCtx(e, s), O(s, {
        validation: "jwt",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "cidr" ? Q2(e.data, a.version) || (s = this._getOrReturnCtx(e, s), O(s, {
        validation: "cidr",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "base64" ? z2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
        validation: "base64",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "base64url" ? W2.test(e.data) || (s = this._getOrReturnCtx(e, s), O(s, {
  ...
  _parse(e) {
    ...
    for (const a of this._def.checks)
      a.kind === "int" ? ue.isInteger(e.data) || (n = this._getOrReturnCtx(e, n), O(n, {
        ...
        exact: !1,
        message: a.message
      }), s.dirty()) : a.kind === "multipleOf" ? J2(e.data, a.value) !== 0 && (n = this._getOrReturnCtx(e, n), O(n, {
...
class ke extends ie {
  ...
  keyof() {
    return c1(ue.objectKeys(this.shape));
  }
}
...
class Wt extends ie {
  _parse(e) {
    const { status: r, ctx: n } = this._processInputParams(e), s = (a, i) => {
      if (tn(a) || tn(i))
        return ee;
      const l = Lr(a.value, i.value);
      return l.valid ? ((rn(a) || rn(i)) && r.dirty(), { status: r.value, value: l.data }) : (O(n, {
  ...
  _parse(e) {
    ...
    if (a.addIssue = a.addIssue.bind(a), s.type === "preprocess") {
      ...
      if (n.common.async)
        return Promise.resolve(i).then(async (l) => {
          ...
          return c.status === "aborted" ? ee : c.status === "dirty" || r.value === "dirty" ? Rt(c.value) : c;
        });
      {
        if (r.value === "aborted")
          return ee;
        ...
        return l.status === "aborted" ? ee : l.status === "dirty" || r.value === "dirty" ? Rt(l.value) : l;
      }
    }
    if (s.type === "refinement") {
      ...
      if (n.common.async === !1) {
        ...
        return l.status === "aborted" ? ee : (l.status === "dirty" && r.dirty(), i(l.value), { status: r.value, value: l.value });
      } else
        return this._def.schema._parseAsync({ data: n.data, path: n.path, parent: n }).then((l) => l.status === "aborted" ? ee : (l.status === "dirty" && r.dirty(), i(l.value).then(() => ({ status: r.value, value: l.value }))));
    }
    if (s.type === "transform")
      if (n.common.async === !1) {
  ...
  _parse(e) {
    ...
    if (n.common.async)
      return (async () => {
        ...
        return a.status === "aborted" ? ee : a.status === "dirty" ? (r.dirty(), Rt(a.value)) : this._def.out._parseAsync({
          data: a.value,
          path: n.path,
          parent: n
        });
      })();
    {
      ...
      return s.status === "aborted" ? ee : s.status === "dirty" ? (r.dirty(), {
        status: "dirty",
        value: s.value
...
const Me = et.create, dt = vt.create, hn = kr.create, Ke = Ft.create, g3 = yr.create, v3 = br.create;
ot.create;
const Mt = Be.create, Sr = ke.create;
zt.create;
Wt.create;
ct.create;
const pn = Mr.create, Et = Ct.create;
Gt.create;
rt.create;
xt.create;
function Oe(t, e) {
...
((t) => {
  function e({
    ...
    let S = Me();
    const b = !k && w === void 0 ? 1 : w;
    b !== void 0 && (S = S.min(b)), y !== void 0 && (S = S.max(y));
    const E = k ? S.optional() : S;
    return t(E, _);
  }
  t.text = e;
  function r({ optional: k, ...w }) {
    const y = k ? Me().email().optional() : Me().email();
    return t(y, w);
  }
  t.email = r;
  function n({ optional: k, ...w }) {
    const y = k ? Me().optional() : Me().min(1);
    return t(
      y,
      { ...w, fieldType: "textarea" }
    );
  }
  t.textarea = n;
  function s({
    ...
    let b = dt();
    _ && (b = b.int()), w !== void 0 && (b = b.min(w)), y !== void 0 && (b = b.max(y));
    const E = k ? b.optional() : b;
    return t(E, S);
  }
  t.number = s;
  function a({ optional: k, ...w }) {
    const y = k ? hn() : pn(!0);
    return t(
      y,
      { ...w, fieldType: "switch" }
  ...
  t.boolean = a;
  function i({ optional: k, ...w }) {
    const y = k ? hn() : pn(!0);
    return t(
      y,
      { ...w, fieldType: "checkbox" }
    );
  }
  t.checkbox = i;
  function l({ optional: k, ...w }) {
    const y = k ? Ke().optional() : Ke();
    return t(y, w);
  }
  t.date = l;
  function c({ optional: k, ...w }) {
    const y = k ? Me().url().optional() : Me().url();
    return t(y, w);
  }
  t.url = c;
  function d({ optional: k, ...w }) {
    const y = k ? dt().optional() : dt();
    return t(
      y,
      { ...w, fieldType: "money" }
    );
  ...
  function u({
    ...
    let S = dt();
    w !== void 0 && (S = S.min(w)), y !== void 0 && (S = S.max(y));
    const b = k ? S.optional() : S;
    return t(
      b,
  ...
  function h(k) {
    ...
    const { optional: w, ...y } = k, _ = y.options.map((b) => b.value), S = w ? Et(_).optional() : Et(_);
    return t(
      S,
  ...
  t.cardSelect = h;
  function g({ optional: k, ...w }) {
    const y = k ? Me().optional() : Me().min(1);
    return t(
      y,
      { ...w, fieldType: "file", multiple: !1 }
    );
  }
  t.file = g;
  function p({ optional: k, ...w }) {
    const y = k ? Mt(Me()).optional() : Mt(Me()).min(1);
    return t(
      y,
      { ...w, fieldType: "file", multiple: !0 }
    );
  }
  t.multiFile = p;
  function v({ optional: k, ...w }) {
    const y = k ? Ke().optional() : Ke();
    return t(
      y,
      { ...w, fieldType: "time" }
  ...
  function C({ optional: k, ...w }) {
    ...
    return t(
      y,
      { ...w, fieldType: "datetime" }
    );
  }
  t.datetime = C;
  function x({ optional: k, ...w }) {
    const y = k ? dt().optional() : dt();
    return t(
      y,
      { ...w, fieldType: "duration" }
    );
  }
  t.duration = x;
  function L({ optional: k, ...w }) {
    const y = Sr({ from: Ke(), to: Ke() }), _ = k ? y.optional() : y;
    return t(
      _,
      { ...w, fieldType: "daterange" }
    );
  }
  t.dateRange = L;
  function B({ optional: k, ...w }) {
    const y = Sr({
      value: Me(),
      mentionIds: Mt(Me()).optional()
    }), _ = k ? y.optional() : y;
    return t(
      _,
      { ...w, fieldType: "richtext" }
    );
  }
  t.richText = B;
  function T(k) {
    ...
    const w = k, { optional: y, ..._ } = w, S = Array.isArray(w.options) ? w.options : void 0;
    if (S && S.length > 0) {
      const E = S.filter(
        (R) => typeof R == "object" && R !== null && "value" in R && typeof R.value == "string"
      ).map((R) => R.value);
      if (E.length > 0) {
        const R = y ? Et(E).optional() : Et(E);
        return t(R, _);
      }
    }
    const b = y ? Me().optional() : Me();
    return t(b, _);
  }
  t.select = T;
  function P(k) {
    ...
    if (S && S.length > 0) {
      const R = S.filter(
        (z) => typeof z == "object" && z !== null && "value" in z && typeof z.value == "string"
      ).map((z) => z.value);
      if (R.length > 0) {
        const z = Mt(Et(R)).min(1), Y = y ? z.optional() : z;
        return t(
          Y,
          { ..._, multiple: !0 }
        );
    ...
    const b = Mt(Me()).min(1), E = y ? b.optional() : b;
    return t(E, { ..._, multiple: !0 });
  }
  t.multiSelect = P;
})(mn || (mn = {}));
const tu = /* @__PURE__ */ Symbol("Let zodToJsonSchema decide on which parser to use"), ru = {
  name: void 0,
  $refStrategy: "root",
  basePath: ["#"],
  ...
  const e = nu(t), r = e.name !== void 0 ? [...e.basePath, e.definitionPath, e.name] : e.basePath;
  return {
    ...e,
...
function Te(t) {
  ...
  return t.flags.hasReferencedOpenAiAnyType = !0, {
    $ref: t.$refStrategy === "relative" ? f1(e, t.currentPath) : e.join("/")
  };
}
function su(t, e) {
  const r = {
  ...
  return t.type?._def && t.type?._def?.typeName !== F.ZodAny && (r.items = fe(t.type._def, {
    ...e,
    currentPath: [...e.currentPath, "items"]
  })), t.minLength && pe(r, "minItems", t.minLength.value, t.minLength.message, e), t.maxLength && pe(r, "maxItems", t.maxLength.value, t.maxLength.message, e), t.exactLength && (pe(r, "minItems", t.exactLength.value, t.exactLength.message, e), pe(r, "maxItems", t.exactLength.value, t.exactLength.message, e)), r;
}
function au(t, e) {
  const r = {
    type: "integer",
  ...
  for (const n of t.checks)
    switch (n.kind) {
      case "min":
        e.target === "jsonSchema7" ? n.inclusive ? pe(r, "minimum", n.value, n.message, e) : pe(r, "exclusiveMinimum", n.value, n.message, e) : (n.inclusive || (r.exclusiveMinimum = !0), pe(r, "minimum", n.value, n.message, e));
        break;
      case "max":
        e.target === "jsonSchema7" ? n.inclusive ? pe(r, "maximum", n.value, n.message, e) : pe(r, "exclusiveMaximum", n.value, n.message, e) : (n.inclusive || (r.exclusiveMaximum = !0), pe(r, "maximum", n.value, n.message, e));
        break;
      case "multipleOf":
        pe(r, "multipleOf", n.value, n.message, e);
        break;
    }
  return r;
}
...
function h1(t, e) {
  return fe(t.type._def, e);
}
const cu = (t, e) => fe(t.innerType._def, e);
function p1(t, e, r) {
  const n = r ?? e.dateStrategy;
  if (Array.isArray(n))
    return {
      anyOf: n.map((s, a) => p1(t, e, s))
    };
  switch (n) {
    case "string":
...
function du(t, e) {
  return {
    ...fe(t.innerType._def, e),
    default: t.defaultValue()
  };
}
function uu(t, e) {
  return e.effectStrategy === "input" ? fe(t.schema._def, e) : Te(e);
}
function fu(t) {
  return {
    type: "string",
...
const hu = (t) => "type" in t && t.type === "string" ? !1 : "allOf" in t;
function pu(t, e) {
  const r = [
    fe(t.left._def, {
      ...e,
...
const Ie = {
   ...
   */
  emoji: () => (cr === void 0 && (cr = RegExp("^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$", "u")), cr),
  /**
   * Unused
   */
...
function m1(t, e) {
  ...
  if (t.checks)
    for (const n of t.checks)
      switch (n.kind) {
        case "min":
          pe(r, "minLength", typeof r.minLength == "number" ? Math.max(r.minLength, n.value) : n.value, n.message, e);
          break;
        case "max":
          pe(r, "maxLength", typeof r.maxLength == "number" ? Math.min(r.maxLength, n.value) : n.value, n.message, e);
          break;
        case "email":
        ...
        case "regex":
          ...
          break;
        case "cuid":
          _e(r, Ie.cuid, n.message, e);
          break;
        case "cuid2":
          _e(r, Ie.cuid2, n.message, e);
          break;
        case "startsWith":
          _e(r, RegExp(`^${lr(n.value, e)}`), n.message, e);
          break;
        case "endsWith":
          _e(r, RegExp(`${lr(n.value, e)}$`), n.message, e);
          break;
        ...
        case "duration":
          ...
          break;
        case "length":
          pe(r, "minLength", typeof r.minLength == "number" ? Math.max(r.minLength, n.value) : n.value, n.message, e), pe(r, "maxLength", typeof r.maxLength == "number" ? Math.min(r.maxLength, n.value) : n.value, n.message, e);
          break;
        case "includes": {
          _e(r, RegExp(lr(n.value, e)), n.message, e);
          break;
        ...
        case "base64url":
          _e(r, Ie.base64url, n.message, e);
          break;
        case "jwt":
          _e(r, Ie.jwt, n.message, e);
          break;
        case "cidr": {
          n.version !== "v6" && _e(r, Ie.ipv4Cidr, n.message, e), n.version !== "v4" && _e(r, Ie.ipv6Cidr, n.message, e);
          break;
        }
        case "emoji":
          _e(r, Ie.emoji(), n.message, e);
          break;
        case "ulid": {
          _e(r, Ie.ulid, n.message, e);
          break;
        }
        case "base64": {
          switch (e.base64Strategy) {
            ...
            case "contentEncoding:base64": {
              pe(r, "contentEncoding", "base64", n.message, e);
              break;
            }
            case "pattern:zod": {
              _e(r, Ie.base64, n.message, e);
              break;
            }
          }
          break;
        ...
        case "nanoid":
          _e(r, Ie.nanoid, n.message, e);
      }
  return r;
}
function lr(t, e) {
  return e.patternStrategy === "escape" ? vu(t) : t;
}
const gu = new Set("ABCDEFGHIJKLMNOPQRSTUVXYZabcdefghijklmnopqrstuvxyz0123456789");
function vu(t) {
  let e = "";
...
function g1(t, e) {
  ...
  const r = {
    type: "object",
    additionalProperties: fe(t.valueType._def, {
      ...e,
  ...
  if (t.keyType?._def.typeName === F.ZodString && t.keyType._def.checks?.length) {
    const { type: n, ...s } = m1(t.keyType._def, e);
    return {
      ...r,
      propertyNames: s
    };
    ...
    if (t.keyType?._def.typeName === F.ZodBranded && t.keyType._def.type._def.typeName === F.ZodString && t.keyType._def.type._def.checks?.length) {
      const { type: n, ...s } = h1(t.keyType._def, e);
      return {
        ...r,
        propertyNames: s
      };
...
function Cu(t, e) {
  if (e.mapStrategy === "record")
    return g1(t, e);
  const r = fe(t.keyType._def, {
    ...e,
    currentPath: [...e.currentPath, "items", "items", "0"]
  }) || Te(e), n = fe(t.valueType._def, {
    ...e,
...
const Cn = (t, e) => {
  const r = (t.options instanceof Map ? Array.from(t.options.values()) : t.options).map((n, s) => fe(n._def, {
    ...e,
...
const Ru = (t, e) => {
  ...
  if (e.pipeStrategy === "input")
    return fe(t.in._def, e);
  if (e.pipeStrategy === "output")
    return fe(t.out._def, e);
  const r = fe(t.in._def, {
    ...e,
    currentPath: [...e.currentPath, "allOf", "0"]
  }), n = fe(t.out._def, {
    ...e,
...
function Tu(t, e) {
  const n = {
    type: "array",
    uniqueItems: !0,
    items: fe(t.valueType._def, {
      ...e,
      currentPath: [...e.currentPath, "items"]
    })
  };
  return t.minSize && pe(n, "minItems", t.minSize.value, t.minSize.message, e), t.maxSize && pe(n, "maxItems", t.maxSize.value, t.maxSize.message, e), n;
}
function Au(t, e) {
  return t.rest ? {
    type: "array",
    minItems: t.items.length,
    items: t.items.map((r, n) => fe(r._def, {
      ...e,
      currentPath: [...e.currentPath, "items", `${n}`]
    })).reduce((r, n) => n === void 0 ? r : [...r, n], []),
    additionalItems: fe(t.rest._def, {
      ...e,
...
const Pu = (t, e) => fe(t.innerType._def, e), $u = (t, e, r) => {
  switch (e) {
    case F.ZodString:
      return m1(t, r);
    case F.ZodNumber:
...
function fe(t, e, r = !1) {
  ...
  e.seen.set(t, s);
  const a = $u(t, t.typeName, e), i = typeof a == "function" ? fe(a(), e) : a;
  if (i && Iu(t, e, i), e.postProcess) {
...
const Hu = (t, e) => {
  switch (e.$refStrategy) {
    ...
    case "relative":
      return { $ref: f1(e.currentPath, t.path) };
    case "none":
    case "seen":
...
}, Iu = (t, e, r) => (t.description && (r.description = t.description, e.markdownDescription && (r.markdownDescription = t.description)), r), ut = (t, e) => {
  const r = ou(e);
  ...
  const s = typeof e == "string" ? e : e?.name, a = fe(
    t._def,
    r,
    !1
  ) ?? Te(r);
...
function k3({
  ...
  const r = ce(
    () => e?.map(v1),
    [e]
  ), n = I(/* @__PURE__ */ new Map()), s = I(""), a = I(/* @__PURE__ */ new Map()), i = I(/* @__PURE__ */ new Set()), l = I(/* @__PURE__ */ new Map()), c = I(/* @__PURE__ */ new Map()), [d, u] = D([]), [h, g] = D(
    []
  ), [p, v] = D(
    null
  ), C = I(null), x = I({}), L = X(() => {
    queueMicrotask(() => {
      const M = Array.from(n.current.entries()), G = [], j = [];
      let K = null;
      for (const [ge, Z] of M) {
        const oe = Z.ref.current;
        if (oe && (Z.virtual ? j.push({
          formName: ge,
          ...Z.description ? { description: Z.description } : {},
          ...Z.module ? { module: Z.module } : {},
          cardTitle: "",
          cardDescription: "",
          formSchema: ut(Z.schema),
          fieldDescriptions: dr(Z.schema),
          sectionDescriptions: ur(Z.sections),
          formValues: oe.getValues(),
          formErrors: oe.getErrors(),
          isDirty: oe.isDirty(),
          ...
          K = {
            ...
            cardDescription: me.cardDescription ?? "",
            formSchema: ut(Z.schema),
            fieldDescriptions: dr(Z.schema),
            sectionDescriptions: ur(Z.sections),
            formValues: oe.getValues(),
      ...
      const we = JSON.stringify({
        formsOnCurrentPage: G,
        availableForms: j,
        activeForm: K
      });
      we !== s.current && (s.current = we, u(G), g(j), v(K));
    });
  }, []), B = X(
    (M, G, j, K, we, ge, Z, oe) => {
      const me = n.current.get(M);
      n.current.set(M, {
        ref: G,
        schema: j,
        description: Z,
        module: oe,
        sections: K,
        defaultValuesParamsSchema: we ?? me?.defaultValuesParamsSchema,
        defaultValuesFn: ge ?? me?.defaultValuesFn,
        defaultValuesParams: me?.defaultValuesParams,
        onSubmit: me?.onSubmit,
        steps: me?.steps,
        submitConfig: me?.submitConfig,
        errorTriggerMode: me?.errorTriggerMode
      }), L();
    },
    [L]
  ), T = X(
    (M) => {
      const G = n.current.get(M);
      if (G?.virtual) return;
      const j = G?.ref.current?.getValues() ?? {};
      n.current.delete(M);
      const K = r?.find((we) => we.name === M);
      if (K) {
        const ge = { ...typeof K.defaultValues == "function" ? {} : xn(K.defaultValues), ...j }, { ref: Z, dirtyFields: oe } = kn(
          K.schema,
          ge,
          K.onSubmit
        ), me = typeof K.defaultValues == "function" ? (() => {
          const Ae = K.defaultValues;
          return async (V) => {
            const $ = Ae(V);
        ...
        n.current.set(M, {
          ...
          defaultValuesFn: me,
          defaultValuesParams: G?.defaultValuesParams,
          dirtyFields: oe,
          onSubmit: K.onSubmit,
          steps: K.steps,
          submitConfig: K.submitConfig,
          errorTriggerMode: K.errorTriggerMode
        });
      }
      L();
    },
    [L, r]
  ), P = X((M) => n.current.get(M), []), k = X(() => Array.from(n.current.keys()), []), w = X(
    (M, G) => {
      const j = n.current.get(M);
      if (!j) {
        const K = Array.from(n.current.keys());
        return {
          success: !1,
          error: `Form "${M}" not found. Available forms: ${K.join(", ")}`
        };
      }
      return j.virtual ? (C.current = M, x.current = {
        cardTitle: G?.cardTitle ?? "",
        cardDescription: G?.cardDescription ?? ""
      }, L(), { success: !0 }) : {
        success: !1,
        error: `Form "${M}" is a rendered form on the current page. You can co-edit it directly without picking it as active.`
      };
    },
    [L]
  ), y = X(() => {
    C.current = null, x.current = { cardTitle: "", cardDescription: "" }, L();
  }, [L]), _ = X(
    (M, G) => {
      const j = n.current.get(M);
      j && (j.defaultValuesParams = G);
    },
    []
  ), S = X((M) => {
    const G = a.current.get(M) ?? 0;
    a.current.set(M, G + 1);
  }, []), b = X((M) => {
    a.current.delete(M), i.current.delete(M), l.current.delete(M), c.current.delete(M);
  }, []), E = X((M) => a.current.get(M) ?? 0, []), R = X((M) => !i.current.has(M), []), z = X((M) => {
    i.current.add(M);
  }, []), Y = X(
    (M, G) => {
      i.current.delete(M), l.current.set(M, G ?? null);
      const j = c.current.get(M);
      if (j?.length) {
        c.current.delete(M);
        for (const K of j)
          K();
    ...
    (M, G) => {
      const j = c.current.get(M) ?? [];
      j.push(G), c.current.set(M, j);
    },
    []
  ), te = X(
    (M, G) => l.current.has(M) ? G === void 0 ? !0 : l.current.get(M) === G : !1,
    []
  ), le = I(/* @__PURE__ */ new Set());
  ae(() => {
    const M = r ?? [], G = /* @__PURE__ */ new Set();
    for (const j of M) {
      G.add(j.name);
      const K = n.current.get(j.name);
      if (K && !K.virtual || K?.virtual) continue;
      const we = typeof j.defaultValues == "function" ? {} : xn(j.defaultValues), { ref: ge, dirtyFields: Z } = kn(
        j.schema,
        we,
        j.onSubmit
      ), oe = typeof j.defaultValues == "function" ? (() => {
        const me = j.defaultValues;
        return async (Ae) => {
          const V = me(Ae);
    ...
    for (const j of le.current)
      G.has(j) || n.current.get(j)?.virtual && n.current.delete(j);
    return le.current = G, L(), () => {
      for (const j of G)
  ...
  const ne = ce(
    () => ({
      ...
      incrementFillVersion: S,
      resetFillVersion: b,
      getFillVersion: E,
      isDefaultValuesResolved: R,
      markDefaultValuesResolving: z,
  ...
  return /* @__PURE__ */ o(C1.Provider, { value: ne, children: t });
}
function Ou() {
  return kt(C1);
}
const Zu = 2, yn = 2, Du = 70, bn = 0.08, Bu = 6, Uu = 0.6, zu = () => {
  ...
  return ae(() => {
    ...
    const c = () => {
      ...
      s(
        Math.max(1, Math.floor((u + yn) / (Zu + yn)))
      );
    };
    ...
    const h = new Uint8Array(u.fftSize), g = setInterval(() => {
      ...
      const v = Math.sqrt(p / h.length), C = Math.min(1, Math.pow(v * Bu, Uu));
      i((x) => {
        const L = x.length >= n ? x.slice(x.length - n + 1) : x.slice();
        return L.push(C), L;
      });
    }, Du);
    return () => {
      clearInterval(g), d.disconnect(), u.disconnect(), c.close(), i([]);
    };
  }, [t, n]), /* @__PURE__ */ o(
    "div",
    {
...
function Yu({
  ...
  const n = /* @__PURE__ */ f("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ o(be, { icon: ao, size: "md", color: "critical" }),
  ...
  return t.errorMessage ? /* @__PURE__ */ o(Ka, { label: t.errorMessage, children: n }) : n;
}
const Xu = {
  soft: {
    text: "",
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      className: N("flex flex-col rounded-xl", n.bg, n.formBorder),
      children: [
        /* @__PURE__ */ f("div", { className: "flex items-center justify-between gap-2 px-4 pb-1.5 pt-2", children: [
          /* @__PURE__ */ o(
            "p",
            {
              className: N("min-w-0 flex-1 text-sm font-medium", n.fontColor),
              children: n.text
            }
          ),
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ o(
              Pe,
              {
                className: N("h-4 rounded", h === 1 ? "w-24" : "w-32")
              }
            )
          ]
        },
...
const Ju = ({
  ...
  return /* @__PURE__ */ o("div", { className: "p-1", children: /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ o(be, { icon: Br, size: "md", color: "default" }) }),
        /* @__PURE__ */ o(
          Le,
          {
  ...
  const s = ze(), [a, i] = D(""), [l, c] = D(0), [d, u] = D(!1), h = I(null), g = I(null), p = I(null), v = t[l] ?? e;
  return ae(() => {
    const C = () => {
    ...
    if (s)
      return u(!1), i(v), C(), h.current = setTimeout(() => {
        const k = (l + 1) % Math.max(t.length, 1);
        c(k);
      }, 4e3), () => {
        C();
      };
    u(!0), i("");
    let x = 0;
    const L = 50, B = 30, T = 2e3, P = 1e3;
    return g.current = setInterval(() => {
      x < v.length ? (i(v.slice(0, x + 1)), x++) : (g.current && (clearInterval(g.current), g.current = null), h.current = setTimeout(() => {
    ...
    t.length,
    s
  ]), r.length > 0 || n ? null : /* @__PURE__ */ o(De, { children: /* @__PURE__ */ o(
    Ce.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
const o4 = ({
  ...
  const [n, s] = D(null), a = n !== null ? t[n] : null;
  return t.length === 0 ? null : /* @__PURE__ */ f(
    Hr,
    {
      ...
      children: [
        /* @__PURE__ */ o(Ja, { asChild: !0, children: /* @__PURE__ */ o("div", { className: "flex w-full flex-wrap items-center gap-2", children: t.map((i, l) => /* @__PURE__ */ o(Ir, { asChild: !0, children: /* @__PURE__ */ o(
          ye,
          {
            variant: "outline",
            label: i.label,
        ...
        a && /* @__PURE__ */ f(
          jr,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "flex flex-col", children: n4(a.items).map((i, l) => /* @__PURE__ */ f(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ o(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ o(be, { icon: Ar, size: "sm" })
                      }
                    )
                  ]
                },
...
const a4 = 250, i4 = 12e4, c4 = () => typeof navigator < "u" && !!navigator.mediaDevices?.getUserMedia && typeof MediaRecorder < "u";
function l4({
  onTranscribe: t,
  onPartial: e,
  onFinal: r,
  ...
  const [a, i] = D("idle"), [l, c] = D(0), [d] = D(c4), [u, h] = D(null), g = I(null), p = I(null), v = I([]), C = I(null), x = I(!1), L = I(null), B = I(null), T = I(0), P = I({ onTranscribe: t, onPartial: e, onFinal: r, onError: n });
  P.current = { onTranscribe: t, onPartial: e, onFinal: r, onError: n };
  const k = X(() => {
    p.current?.getTracks().forEach((b) => b.stop()), p.current = null, g.current = null, h(null), L.current && (clearInterval(L.current), L.current = null), B.current && (clearTimeout(B.current), B.current = null);
  }, []), w = X(async () => {
    const { onTranscribe: b, onPartial: E, onFinal: R, onError: z } = P.current, Y = v.current;
    if (v.current = [], Y.length === 0 || !b) {
      i("idle"), c(0);
      return;
    }
    ...
    try {
      ...
      te.signal.aborted || R(le);
    } catch {
      te.signal.aborted || z("transcription-failed");
    } finally {
      C.current = null, i("idle"), c(0);
    }
  }, []), y = X(() => {
    const b = g.current;
    ...
    p.current = b, h(b);
    const E = new MediaRecorder(b);
    g.current = E, E.ondataavailable = (R) => {
      R.data.size > 0 && v.current.push(R.data);
    }, E.onstop = () => {
      if (k(), x.current) {
      ...
      w();
    }, E.start(a4), T.current = Date.now(), i("recording"), c(0), L.current = setInterval(() => {
      c(Date.now() - T.current);
    }, 200), B.current = setTimeout(y, s);
  }, [
    a,
    t,
    d,
    ...
    a === "recording" ? (x.current = !0, y()) : a === "transcribing" && (C.current?.abort(), C.current = null, i("idle"), c(0));
  }, [a, y]);
  return ae(
    () => () => {
      x.current = !0, C.current?.abort();
      const b = g.current;
      b && b.state !== "inactive" && b.stop(), k();
    },
    [k]
  ), { status: a, durationMs: l, isSupported: d, stream: u, start: _, stop: y, cancel: S };
}
function d4(t, e) {
  if (e === "*/*") return !0;
  if (e.endsWith("/*")) {
...
const f4 = 4e3;
function h4(t) {
  const [e, r] = D([]), [n, s] = D(null), a = I(
    null
  ), i = I(null), l = he(), c = t?.onUploadFiles, d = t?.allowedMimeTypes, u = t?.maxFiles, h = ce(() => {
    if (d)
      return Array.isArray(d) ? d.join(",") : d;
  }, [d]), g = u !== void 0 && e.length >= u, p = I(0);
  ae(() => {
    p.current = e.length;
  }, [e]);
  const v = X((T) => {
  ...
  const C = X(
    async (T) => {
      ...
      if (u !== void 0 && p.current + P.length > u) {
        v(
      ...
      const y = (_) => r(
        (S) => S.map(
          (b) => w.includes(b.id) ? { ...b, status: "error", errorMessage: _ } : b
        )
      );
      try {
        const _ = await c(P);
        if (!Array.isArray(_) || _.length !== P.length) {
          y(l.ai.fileUploadError);
          return;
        }
        r(
          (S) => S.map((b) => {
            const E = k.findIndex((R) => R.id === b.id);
            return E === -1 ? b : _[E] ? {
              ...b,
              status: "uploaded",
              uploadedFile: _[E]
        ...
        const S = _ instanceof Error && _.message ? _.message : l.ai.fileUploadError;
        y(S);
      }
    },
    [
    ...
    async (T) => {
      await C(Array.from(T.target.files ?? [])), T.target.value = "";
    },
    [C]
  ), L = X((T) => {
    r((P) => P.filter((k) => k.id !== T));
  }, []), B = X(() => {
    r([]);
  }, []);
  return {
...
function C4({
  ...
  const [a, i] = D(!1), [l, c] = D(""), [d, u] = D([]), [h, g] = D(!1), [p, v] = D(0), [C, x] = D([]), L = I(-1), B = I(null), T = I(0), P = I(-1);
  ae(() => {
    if (!n) {
      i(!1);
      return;
    ...
    const E = p4(t, r, C);
    if (!E) {
      i(!1), c(""), u([]), v(0), L.current = -1, P.current = -1;
      return;
    }
    if (E.atIndex === P.current)
      return;
    L.current = E.atIndex, c(E.query), i(!0), v(0), g(!0), B.current && clearTimeout(B.current);
    const R = ++T.current;
    return B.current = setTimeout(() => {
      n(E.query).then((z) => {
        R === T.current && (u(z), v(0), z.length === 0 && E.query.length > 0 && (P.current = E.atIndex, i(!1)));
      }).catch(() => {
        R === T.current && u([]);
      }).finally(() => {
        R === T.current && g(!1);
  ...
  const k = X(() => {
    ...
    (E) => {
      const R = L.current;
      if (R === -1) return;
      const z = `${E.firstName} ${E.lastName}`.trim(), Y = String(E.id), J = t.slice(0, R), te = t.slice(r), le = `@${z} `, ne = J + le + te, M = J.length + le.length;
      e(ne), x((G) => [...G.filter((K) => !(K.id === Y && K.name === z)), { id: Y, name: z }]), k(), requestAnimationFrame(() => {
        const G = s.current;
        G && (G.focus(), G.setSelectionRange(M, M));
      });
    },
    [t, r, e, s, k]
  ), y = X(
    (E) => {
      if (!a) return !1;
      if (E.key === "Escape")
        return E.preventDefault(), k(), !0;
      if (d.length === 0) return !1;
      switch (E.key) {
        case "ArrowDown":
          return E.preventDefault(), v((R) => (R + 1) % d.length), !0;
        case "ArrowUp":
        ...
        case "Tab": {
          const R = d[p];
          if (R) {
            const z = `${R.firstName} ${R.lastName}`.trim();
            if (l.length === 0 || z.toLowerCase().startsWith(l.toLowerCase()))
              return E.preventDefault(), w(R), !0;
          }
          return !1;
        }
        case "Enter":
          return E.preventDefault(), d[p] && w(d[p]), !0;
        default:
          return !1;
      }
    },
    ...
    (E) => {
      ...
      let R = E;
      const z = [...C].sort((Y, J) => J.name.length - Y.name.length);
      for (const Y of z) {
        const J = `@${Y.name}`, te = `<entity-ref type="person" id="${Ln(Y.id)}">${Ln(Y.name)}</entity-ref>`;
        for (; R.includes(J); )
          R = R.replace(J, te);
      }
      return R;
  ...
  ae(() => {
    x(
      (E) => E.filter((R) => {
        const z = `@${R.name}`, Y = t.indexOf(z);
        if (Y === -1) return !1;
        const J = t[Y + z.length];
        return J === " " || J === `
` || J === "	";
      })
    );
  ...
  const S = ce(() => {
    ...
    const E = s.current;
    if (!E) return null;
    const R = g4(E, L.current), z = E.offsetLeft + R.left, J = (E.offsetParent ? E.offsetParent.offsetHeight : 0) - (E.offsetTop + R.top);
    return { left: z, bottom: J };
  }, [a, t, r, s]), b = ce(() => {
    if (!a || d.length === 0) return null;
    const E = d[p];
    if (!E) return null;
    const R = `${E.firstName} ${E.lastName}`.trim();
...
const w4 = /[\\`*_{}[\]()#+\-.!|~>]/g, x4 = (t) => t.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((e, r) => r % 2 === 1 ? e : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(w4, "\\$&")).join(""), y3 = ({
  onSubmit: t,
  onStop: e,
  inProgress: r,
  onBeforeSubmit: n,
  ...
  const w = he(), y = ze(), [_, S] = D(""), [b, E] = D(0), [R, z] = D(!1), [Y, J] = D(!1), [te, le] = D(null), ne = I(null), M = I(null), G = I(null), j = i != null, { tracking: K } = Xe(), we = X(
    (ve, Ze) => {
      K?.onWelcomeSuggestionClick?.({
        item: ve,
        group: Ze,
        prompt: ve.prompt || ve.title
      }), P?.(ve, Ze);
    },
    [K, P]
  ), {
    ...
    const Ze = Ee.current, sr = Ze && !/\s$/.test(Ze) ? " " : "", Ot = `${Ze}${sr}${ve}`;
    S(Ot), E(Ot.length);
  }, []), at = {
    ...
    onPartial: He,
    onFinal: (ve) => {
      He(ve), M.current?.focus();
    },
    onError: (ve) => xe(at[ve])
  }), it = !!g && Se.isSupported, Jt = X(() => {
    Ee.current = _, Se.start();
  }, [_, Se]);
  ae(() => {
    typeof window < "u" && window.location.hash.length === 0 && M.current?.focus();
  }, []), ae(() => {
    if (v)
      return v((ve) => {
        $(ve);
  ...
  const Ht = Se.status === "recording", er = Ht ? w.ai.listening : w.ai.inputPlaceholder, tr = ge.filter((ve) => ve.status === "uploaded"), lt = ge.some((ve) => ve.status === "uploading"), It = ge.some((ve) => ve.status === "error"), bt = _.trim().length > 0;
  ae(() => {
    if (!(!Y || lt)) {
      if (J(!1), It) {
        xe(w.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const rr = async (ve) => {
    if (ve.preventDefault(), !j) {
      if (de.close(), r)
        ...
        const Ze = de.transformMentions(_.trim()), sr = x4(Ze), Ot = tr.flatMap(
          (Yr) => Yr.uploadedFile ? [Yr.uploadedFile] : []
        ), Gr = l, qr = d;
        Gr && c?.(null), qr && u?.(null), await t({
          text: sr,
          files: Ot,
          context: Gr,
          quote: qr
    ...
    j || de.handleKeyDown(ve) || ve.key === "Enter" && !ve.shiftKey && (ve.preventDefault(), r || ne.current?.requestSubmit());
  }, or = () => {
    E(M.current?.selectionStart ?? 0);
  }, jt = () => {
    G.current && M.current && (G.current.scrollTop = M.current.scrollTop);
  }, Lt = te ? te.prompt ?? te.title : null, Wr = Ht ? [w.ai.listening] : Lt ? [Lt] : s ?? [], X1 = Wr.length > 1, K1 = ce(() => s4(_, de.mentions, {
    cursorPosition: b,
    inlineCompletion: de.inlineCompletion
  }), [_, de.mentions, b, de.inlineCompletion]), Q1 = de.mentions.length > 0 || de.inlineCompletion !== null;
  return /* @__PURE__ */ f("div", { ref: k, className: "flex flex-col items-center gap-2 px-4 pb-3 pt-2", children: [
    /* @__PURE__ */ f("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
      L && T && T.length > 0 && P && /* @__PURE__ */ o(
        o4,
        {
          suggestions: T,
          onItemClick: we,
      ...
      /* @__PURE__ */ o(Ku, { creditWarning: a, children: /* @__PURE__ */ f(
        Ce.form,
        {
          "aria-busy": r,
          ref: ne,
          ...
          children: [
            ...
            /* @__PURE__ */ o(De, { initial: !1, children: j ? /* @__PURE__ */ o(
              Ce.div,
              {
              ...
              Ce.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ o(De, { initial: !1, children: re && /* @__PURE__ */ o(
                    Ce.div,
                    {
                      role: "alert",
                      "aria-live": "polite",
                      ...
                      children: /* @__PURE__ */ f(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ o("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ o(ei, { type: "critical", size: "sm" }) }),
                            /* @__PURE__ */ o("p", { className: "font-medium text-f1-foreground-critical", children: re })
                          ]
                        }
                      )
                    },
                  ...
                  /* @__PURE__ */ o(
                    t4,
                    {
                      ...
                      onCursorUpdate: or,
                      onScroll: jt,
                      highlightSegments: K1,
                      hasOverlay: Q1,
                      multiplePlaceholders: X1,
                      placeholders: Wr,
                      resolvedDefaultPlaceholder: er,
                      inProgress: r
                    }
                  ),
                  /* @__PURE__ */ o(
                    Gu,
                    {
                      ...
                      isPreSending: R || Y,
                      canRecord: it,
                      recordingStatus: Se.status,
                      recordingStream: Se.stream,
                      onStartRecording: Jt,
                      onStopRecording: Se.stop,
                      onCancelRecording: Se.cancel
                    }
                  )
                ]
              },
    ...
    /* @__PURE__ */ o(De, { mode: "wait", initial: !1, children: j ? /* @__PURE__ */ f(
      Ce.div,
      {
    ...
    /* @__PURE__ */ o(De, { children: x && L && /* @__PURE__ */ o(
      Ce.div,
      {
        className: N(
...
function L4({ ...t }) {
  return /* @__PURE__ */ o(
    ...
    {
      ...t,
      className: N("my-3 border-0 border-t border-f1-border", t.className)
    }
  );
}
function M4({
  ...
  return /* @__PURE__ */ f("div", { className: "relative w-fit", children: [
    /* @__PURE__ */ o(
      "img",
      {
        ...
        src: t,
        alt: e,
        className: N("max-w-full rounded-md", r.className)
      }
    ),
...
function E4({
  ...
  return /* @__PURE__ */ o(ri, { ...e, variant: "link", href: e.href, children: t });
}
function _4({
  children: t,
  ...e
...
function S4({
  ...
  return /* @__PURE__ */ o("li", { ...e, className: N("mb-2", e.className), children: t });
}
async function N4(t, e, r) {
...
function F4({
  ...
  return /* @__PURE__ */ o("p", { ...e, className: N("text-base font-normal", e.className), children: t });
}
function P4({
  children: t,
  ...e
...
function I4({
  ...
  return /* @__PURE__ */ o("strong", { ...e, className: N("font-semibold", e.className), children: t });
}
function j4({
  children: t,
  ...e
}) {
  return /* @__PURE__ */ o("em", { ...e, className: N("italic", e.className), children: t });
}
function yt({
  id: t,
  trigger: e,
  ...
  const a = I(/* @__PURE__ */ new Map()), [i, l] = D(
    () => a.current.get(t) ?? null
  ), [c, d] = D(!1), [u, h] = D(!1), g = I(!0);
  ae(() => () => {
    g.current = !1;
  }, []);
  const p = X(() => {
    ...
    d(!0), h(!1), r(t).then((x) => {
      a.current.set(t, x), g.current && l(x);
    }).catch(() => {
      g.current && h(!0);
    }).finally(() => {
      g.current && d(!1);
  ...
  return /* @__PURE__ */ f(
    ni,
    {
      ...
      children: [
        /* @__PURE__ */ o(oi, { asChild: !0, children: e }),
        /* @__PURE__ */ o(
          si,
          {
            side: "top",
            ...
            children: c ? /* @__PURE__ */ o(Kr.Skeleton, {}) : /* @__PURE__ */ o(Kr, { ...v })
          }
        )
      ]
    }
...
w1.displayName = "CandidateTrigger";
function O4({
  id: t,
  label: e
}) {
  const { entityRefs: r } = Xe(), n = r?.resolvers?.candidate, s = he(), a = r?.urls?.candidate?.(t), i = ce(
    () => (c) => {
      const d = [];
...
x1.displayName = "ExpenseTrigger";
function Z4({ id: t, label: e }) {
  const { entityRefs: r } = Xe(), n = r?.resolvers?.expense, s = he(), a = r?.urls?.expense?.(t), i = ce(
    () => (c) => ({
      avatar: {
        type: "icon",
        icon: Ho
...
k1.displayName = "JobPostingTrigger";
function D4({
  id: t,
  label: e
}) {
  const { entityRefs: r } = Xe(), n = r?.resolvers?.jobPosting, s = he(), a = r?.urls?.jobPosting?.(t), i = ce(
    () => (c) => ({
      title: c.title,
...
y1.displayName = "RequisitionTrigger";
function U4({
  id: t,
  label: e
}) {
  const { entityRefs: r } = Xe(), n = r?.resolvers?.requisition, s = he(), a = r?.urls?.requisition?.(t), i = ce(
    () => (c) => {
...
b1.displayName = "PersonTrigger";
function z4({ id: t, label: e }) {
  const { entityRefs: r } = Xe(), n = r?.resolvers?.person, s = he(), a = r?.urls?.person?.(t), i = ce(
    () => (c) => ({
      avatar: {
        type: "person",
        firstName: c.firstName,
...
L1.displayName = "VacancyTrigger";
function W4({ id: t, label: e }) {
  const { entityRefs: r } = Xe(), n = r?.resolvers?.vacancy, s = he(), a = r?.urls?.vacancy?.(t), i = ce(
    () => (c) => ({
      title: c.name,
...
function Nr(t) {
  return typeof t == "string" ? t : typeof t == "number" ? String(t) : Array.isArray(t) ? t.map(Nr).join("") : t && typeof t == "object" && "props" in t ? Nr(t.props.children) : "";
}
function Y4({
  type: t,
  id: e,
...
}, M1 = J1.forwardRef(({ animate: t = "normal", ...e }, r) => /* @__PURE__ */ f(
  "svg",
  {
    ref: r,
    viewBox: "0 0 24 24",
...
M1.displayName = "CheckCircleLineAnimated";
const E1 = 60, _1 = 40, Mn = 2e3, e6 = 500, t6 = 12e3, R1 = 2, St = 40, ft = [255, 60, 0], fr = [160, 140, 220], hr = { x: -12, y: 0, z: 0 }, pr = { x: -12, y: 12, z: 90 }, pt = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, mr = Math.PI / 180, r6 = R1 / 8 * Math.PI, n6 = 4 * Math.PI;
function Xt(t, e) {
  return [
...
const Tt = 256, a6 = (() => {
  ...
  for (let e = 0; e < Tt; e++) {
    const r = e / (Tt - 1), n = Math.round(ft[0] + (fr[0] - ft[0]) * r), s = Math.round(ft[1] + (fr[1] - ft[1]) * r), a = Math.round(ft[2] + (fr[2] - ft[2]) * r);
    t[e] = `rgb(${n},${s},${a})`;
  }
  return t;
})();
...
const c6 = Object.keys(pt).map(Number).sort((t, e) => t - e);
function l6(t) {
  const e = c6;
...
const _n = Math.sqrt(E1 ** 2 + _1 ** 2), gr = [E1 / _n, _1 / _n, 0], d6 = S1(hr.x, hr.y, hr.z), u6 = S1(pr.x, pr.y, pr.z), mt = R1 * 3, Bt = St + 1, Rn = (mt + 1) * Bt, Kt = 4 * mt * St, vr = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
], f6 = (t, e) => t.avgZ - e.avgZ;
function h6() {
  const t = new Array(Kt);
  for (let r = 0; r < Kt; r++)
...
function Sn(t, e, r, n) {
  const { quads: s, grid: a } = t, i = r * 0.392, l = r / 2, c = r / 2, d = r6 * l6(r), u = e * n6, h = Nt(0, 0, 1, n * 2 * Math.PI);
  En(h, gr[0], gr[1], gr[2], Qe);
  const g = Nt(Qe[0], Qe[1], Qe[2], u), p = Xt(g, d6), v = Xt(g, u6);
  vr[0] = p, vr[1] = v;
  let C = 0;
  for (let x = 0; x < 4; x++) {
    const L = vr[x >> 1], B = x & 1 ? -1 : 1;
    for (let T = 0; T <= mt; T++) {
      const P = B * (Math.PI / 2 - T / mt * d), k = Math.cos(P), w = Math.sin(P), y = Math.sin(T / mt * Math.PI), _ = T * Bt;
      for (let S = 0; S <= St; S++) {
        const b = S / St * Math.PI * 2;
        En(L, k * Math.cos(b), w, k * Math.sin(b), Qe);
        const E = a[_ + S];
        E.x = Qe[0], E.y = Qe[1], E.z = Qe[2], E.t = y;
      }
    }
    for (let T = 0; T < mt; T++) {
      const P = T * Bt, k = (T + 1) * Bt;
      for (let w = 0; w < St; w++) {
        const y = a[P + w], _ = a[P + w + 1], S = a[k + w], b = a[k + w + 1];
        if ((y.t + _.t + S.t + b.t) * 0.25 < 1e-3) continue;
        const R = (y.x + _.x + S.x + b.x) * 0.25, z = (y.y + _.y + S.y + b.y) * 0.25, Y = (y.z + _.z + S.z + b.z) * 0.25, J = R * i, te = z * i, le = y.x * i - J, ne = y.y * i - te, M = Math.sqrt(le * le + ne * ne), G = M > 0 ? (M + 0.9) / M : 1, j = l + J + le * G, K = c - te - ne * G, we = _.x * i - J, ge = _.y * i - te, Z = Math.sqrt(we * we + ge * ge), oe = Z > 0 ? (Z + 0.9) / Z : 1, me = l + J + we * oe, Ae = c - te - ge * oe, V = b.x * i - J, $ = b.y * i - te, H = Math.sqrt(V * V + $ * $), Q = H > 0 ? (H + 0.9) / H : 1, U = l + J + V * Q, re = c - te - $ * Q, xe = S.x * i - J, de = S.y * i - te, Ee = Math.sqrt(xe * xe + de * de), He = Ee > 0 ? (Ee + 0.9) / Ee : 1, at = l + J + xe * He, Se = c - te - de * He, it = s[C];
        it.points = `${j},${K} ${me},${Ae} ${U},${re} ${at},${Se}`, it.color = i6((R + 1) * 0.5), it.avgZ = Y, C++;
      }
    }
  }
  for (let x = C; x < Kt; x++)
...
const p6 = ({ size: t = 20, className: e, style: r, variant: n = "default" }, s) => {
  const a = I(null), i = I(null), l = I(null);
  l.current === null && (l.current = h6());
  const c = ce(() => new Array(Kt).fill(0), []), d = (u) => {
  ...
  return ae(() => {
    ...
    let v = null, C = 0, x = 0, L = 0, B = null, T = "spin", P = !0, k = !1;
    const w = (E) => {
      const R = p.quads;
      ...
      let R = 0, z = !0;
      if (n === "continuous") {
        const le = Mn * 2, ne = (E - C) % le / le;
        R = ne < 0.5 ? ne * 2 : (1 - ne) * 2, z = !1;
      } else T === "spin" ? (R = Math.min((E - C) / Mn, 1), R >= 1 && (R = 0, T = "pause", L = E)) : (R = 0, E - L >= e6 && (T = "spin", C = E));
      const Y = (E - x) / t6 % 1, J = z ? s6(R) : R, te = Sn(p, J, t, Y);
      w(te), v = requestAnimationFrame(y);
    }, _ = () => {
    ...
    return typeof IntersectionObserver < "u" && (b = new IntersectionObserver(
      (E) => {
        const R = E[0]?.isIntersecting ?? !0;
        if (R !== P)
          if (P = R, R) {
            if (B !== null && k) {
              const z = performance.now() - B;
              C += z, x += z, L += z;
            }
            B = null, _();
          } else
    ...
    "div",
    {
      ...
      role: "progressbar",
      "aria-label": "Loading",
      className: N("shrink-0 globe-spin-anim", e),
...
N1.displayName = "ChatSpinner";
const Nn = {
  initial: { opacity: 0 },
  animate: { opacity: 1 },
  exit: { opacity: 0 }
}, Tr = ({ title: t, status: e, inGroup: r }) => {
  const s = {
    duration: ze() ? 0 : 0.18,
    ease: [0.33, 1, 0.68, 1]
  ...
  return /* @__PURE__ */ f("div", { className: "flex w-full items-start gap-1 text-f1-foreground-secondary", children: [
    /* @__PURE__ */ o("div", { className: "flex h-5 w-6 shrink-0 items-center justify-start", children: /* @__PURE__ */ f(De, { mode: "wait", children: [
      a && /* @__PURE__ */ o(
        Ce.div,
        {
      ...
      (i || c) && /* @__PURE__ */ o("div", { className: "flex h-5 w-5 shrink-0 items-center justify-center", children: /* @__PURE__ */ o(N1, { variant: i ? "default" : "continuous" }) }),
      l && /* @__PURE__ */ o(
        Ce.div,
        {
          ...Nn,
...
function T1({
  ...
  const i = he(), l = s.type === "open", c = l ? n ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ f(
    "div",
    {
      className: N(
      ...
      children: [
        /* @__PURE__ */ f("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          t?.type === "module" && /* @__PURE__ */ o(Eo, { module: t.module, size: "lg" }),
          t?.type === "file" && /* @__PURE__ */ o(ii, { file: t.file, size: "lg" }),
...
T1.displayName = "F0CanvasCard";
const zr = $t(null);
function M3({
  children: t
}) {
  const [e, r] = D(0), n = I([]), s = X(
    (i) => {
  ...
  return /* @__PURE__ */ o(zr.Provider, { value: a, children: t });
}
function m6(t) {
  const r = kt(zr)?.formatters;
  return ce(() => !r || r.length === 0 ? null : (n, s, a) => {
    let i, l = -1;
    for (const c of r) {
...
const Tn = 7, g6 = 625, An = /* @__PURE__ */ new Set();
function v6(t) {
...
function w6(t) {
  const { days: e, hours: r, minutes: n, seconds: s } = R2(t), a = [];
...
function A1(t, e) {
  ...
  if (e === "duration" && typeof t == "number")
    return { type: "item", text: w6(t) };
  if (e === "richtext" && typeof t == "object" && t !== null && "value" in t) {
    const r = t.value;
    return { type: "item", text: (r ? v6(r) : "") || "—" };
  }
  if (e === "daterange" && typeof t == "object" && t !== null && "from" in t && "to" in t) {
    const { from: r, to: n } = t, s = Vn(r) ? Fn(r) : String(r), a = Vn(n) ? Fn(n) : String(n);
  ...
  if (Array.isArray(t))
    return { type: "item", text: t.map((n) => {
      const s = A1(n);
      return Array.isArray(s) ? s.map(Pn).join(", ") : Pn(s);
    }).filter(Boolean).join(", ") || "—" };
  ...
  return { type: "item", text: C6(String(t)) };
}
function V1({
  formName: t,
  formDescription: e,
  ...
  const { canvasContent: c, openCanvas: d, closeCanvas: u } = Xe(), h = m6(t), g = l ?? h, p = I(() => {
  }), v = n ?? t, C = s ?? e ?? "", x = c?.type === "form" && c.formName === t, L = () => d({
    type: "form",
    title: v,
    description: C,
    formName: t,
  ...
  p.current = L, ae(() => {
    typeof window > "u" || window.innerWidth < g6 || An.has(t) || (An.add(t), p.current());
  }, [t]);
  const B = a && i ? Object.entries(a).map(([k, w]) => {
    const y = i[k], _ = g?.(k, y, {
      fieldType: w.fieldType,
      customFieldName: w.customFieldName
    });
    if (!_ && w.fieldType === "custom" && typeof y == "object" && y !== null)
      return null;
    const S = _ ?? A1(y, w.fieldType), b = ["richtext", "textarea"];
    return {
      label: w.label,
      content: S,
      verticalLayout: b.includes(w.fieldType ?? "")
    };
  }).filter((k) => {
    if (!k) return !1;
    const w = Array.isArray(k.content) ? k.content[0] : k.content;
    return !(w?.type === "item" && w.text === "—");
  }) : [], T = B.slice(0, Tn), P = B.length > Tn;
  return /* @__PURE__ */ o(
    T1,
    {
      ...
      children: T.length > 0 && !x && /* @__PURE__ */ o("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ o(
        ci,
        {
          details: T.map((k) => ({
            title: k.label,
            content: k.content,
            ...k.verticalLayout && { verticalLayout: !0 }
          })),
          showSeeMore: P,
          onClickSeeMore: L,
          tableView: !0
...
V1.displayName = "FormCard";
function x6() {
  const t = Ou(), e = t?.activeForm;
  if (!e) return null;
...
const $n = 8, _t = 8;
function P1({ anchor: t, onReply: e }) {
  const r = he(), n = I(null), [s, a] = D(
    null
  );
  if (oo(() => {
    if (!t) {
    ...
    let g = t.rect.top - d - $n;
    g < _t && (g = t.rect.bottom + $n), g = Math.min(
      Math.max(g, _t),
      h - d - _t
    );
...
const $1 = $t(void 0), _3 = () => kt($1), b6 = (t) => /* @__PURE__ */ o(_o, { content: t, format: "markdown" }), L6 = ({
  isGenerating: t,
  isLoading: e,
  message: r,
  renderToolCall: n,
  ...
  const l = typeof r?.content == "string" ? r.content : "", c = (r && n?.(r)) ?? r?.generativeUI?.() ?? null, d = r?.toolCalls?.[0]?.id, u = !l && !c, h = I(null), { anchor: g, clear: p } = F1({
    containerRef: h,
    enabled: !!(r?.id && l)
  });
  return ae(() => {
    r?.id && !e && !t && a?.(r);
  }, [r, e, t, a]), !e && !t && u ? null : /* @__PURE__ */ o($1.Provider, { value: d, children: /* @__PURE__ */ f("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    r && l && /* @__PURE__ */ o(
      "div",
      {
        ref: h,
  ...
  const [s, a] = D(""), i = he(), { title: l, label: c, placeholder: d } = r === "like" ? i.ai.feedbackModal.positive : i.ai.feedbackModal.negative, u = X(() => {
    e(n, s);
  }, [s, n, e]), h = () => {
    t(n);
  };
...
}, H1 = $t(null), E6 = ({ children: t }) => {
  const [e, r] = D(null), n = e ? {
    isOpen: !0,
  ...
  return /* @__PURE__ */ o(H1.Provider, { value: n, children: t });
}, I1 = () => {
  const t = kt(H1);
  if (t === null)
    throw new Error(
...
const R6 = ({
  ...
  const n = he(), { open: s } = I1(), [a, i] = D(null);
  ...
  const [l, c] = D(s), d = ze(), u = n !== void 0, h = u ? n : l;
  return /* @__PURE__ */ f(
    Ro,
    {
        ...
        /* @__PURE__ */ f(
          So,
          {
            ...
            children: [
              ...
              !i && /* @__PURE__ */ o(be, { icon: Qt })
            ]
          }
        ),
        /* @__PURE__ */ o(No, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ o(
          Ce.div,
          {
            initial: !1,
            animate: {
...
const j1 = (t) => /* @__PURE__ */ o(_o, { content: t, format: "markdown" }), V6 = ({
  text: t,
  renderMarkdown: e
}) => /* @__PURE__ */ f("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ o("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ o(be, { icon: Br }) }),
  /* @__PURE__ */ o("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (e ?? j1)(t) })
] }), F6 = ({
  message: t,
  onReplyQuote: e,
  ...
  const i = t.rawData, l = A6(
    t?.content,
    i
  ), c = (T6(t?.content) ?? "").trim(), d = t?.replyQuote ?? null, u = c.length > 0, { anchor: h, clear: g } = F1({
    containerRef: a,
    enabled: u
  });
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        d && /* @__PURE__ */ o(V6, { text: d, renderMarkdown: n }),
...
}, P6 = 35, $6 = 22, H6 = 400, I6 = 2500, j6 = 220, O6 = ({ messages: t, onClick: e }) => {
  const [r, n] = D(0), [s, a] = D(0), [i, l] = D("starting"), c = t[r] ?? "";
  ae(() => {
    t.length > 0 && r >= t.length && (n(0), a(0), l("starting"));
  }, [t.length, r]), ae(() => {
    let h;
    if (i === "starting")
      h = setTimeout(() => l("writing"), H6);
    else if (i === "writing")
      s < c.length ? h = setTimeout(() => a((g) => g + 1), P6) : l("holding");
    else if (i === "holding") {
      if (t.length <= 1) return;
      h = setTimeout(() => l("erasing"), I6);
    } else i === "erasing" && (s > 0 ? h = setTimeout(() => a((g) => g - 1), $6) : h = setTimeout(() => {
      n((g) => (g + 1) % t.length), l("starting");
    }, j6));
    return () => {
      h && clearTimeout(h);
    };
...
function Z6({
  ...
  const [i, l] = D(0), [c, d] = D(!1), u = I(s), h = I(a);
  h.current = a;
  const g = X(
    (v = "smooth") => {
  ...
  ae(() => {
    const v = t.current, C = e.current;
    if (!v || !C) return;
    const x = new ResizeObserver(() => {
      if (h.current) return;
      const L = parseFloat(getComputedStyle(C).paddingTop) + parseFloat(getComputedStyle(C).paddingBottom) + 1;
      l(v.clientHeight - L);
    });
    return x.observe(v), x.observe(C), () => x.disconnect();
  }, [t, e]);
  const p = X(() => {
    const v = t.current;
    if (!v) return;
    const { scrollTop: C, scrollHeight: x, clientHeight: L } = v, B = x - C - L;
    d(B > L);
  }, [t]);
  return ae(() => {
    const v = t.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const v = t.current, C = n.current;
        if (!v || !C) return;
        const x = v.getBoundingClientRect(), L = C.getBoundingClientRect(), B = v.scrollTop + (L.top - x.top);
        v.scrollTo({ top: B, behavior: "smooth" });
      });
    }), s === 0 && d(!1), u.current = s;
  }, [s, n, t]), { showScrollBtn: c, turnMinHeight: i, scrollToBottom: g };
}
const D6 = {
  threadId: "",
  onThumbsUp: () => {
...
}, R3 = (t) => /* @__PURE__ */ o(E6, { children: /* @__PURE__ */ o(B6, { ...t }) }), B6 = ({
  turns: t,
  isLoadingThread: e = !1,
  interrupt: r,
  initialMessage: n,
  ...
  const { modal: B, handleSubmit: T, handleClose: P } = _6(
    u ?? D6
  ), k = he(), w = v ?? L6, y = C ?? F6, _ = ce(() => {
    const M = n ?? k.ai.defaultInitialMessage;
    return (Array.isArray(M) ? M : [M]).filter((j) => typeof j == "string" && j.length > 0);
  }, [n, k.ai.defaultInitialMessage]), S = !e && t.length === 0 && _.length > 0, b = I(null), E = I(null), R = I(null), z = I(null), Y = I(null), { showScrollBtn: J, turnMinHeight: te, scrollToBottom: le } = Z6({
    viewportRef: b,
    contentRef: E,
    endRef: R,
    lastTurnRef: Y,
    ...
    const j = G === t.length - 1, K = {
      ...
      const me = j && oe === M.assistantMessages.length - 1, Ae = M.userMessages.length + oe, V = {
        message: Z,
        inProgress: M.isInProgress,
        index: Ae,
        isCurrentMessage: me,
      ...
      return /* @__PURE__ */ o(
        ...
        {
          ...V,
          isGenerating: M.isInProgress && me,
          isLoading: M.isInProgress && me && !Z.content
        },
        `${G}-a-${oe}`
      );
    };
    return /* @__PURE__ */ f(
      "div",
      {
        ...
        children: [
          ...
          M.thinking && M.thinking.titles.length > 0 && /* @__PURE__ */ o(
            N6,
            {
              titles: M.thinking.titles,
              title: k.ai.thoughtsGroupTitle,
              inProgress: M.thinking.inProgress,
              isWriting: M.thinking.isWriting
            }
          ),
          M.assistantMessages.map(
            (Z, oe) => ge(Z, oe)
          ),
          M.endIndicator === "thinking" && /* @__PURE__ */ o(Tr, { title: k.ai.thinking, status: "executing" }),
          M.endIndicator === "activity" && /* @__PURE__ */ o(Tr, { status: "writing" }),
          M.feedback && /* @__PURE__ */ o(
            R6,
            {
              content: M.feedback.content,
              targetMessage: M.feedback.targetMessage,
              onCopy: L
            }
          ),
          j && /* @__PURE__ */ o(x6, {})
  ...
  return /* @__PURE__ */ f(Ue, { children: [
    /* @__PURE__ */ f("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
      /* @__PURE__ */ o(
        "div",
        {
          ...
          children: /* @__PURE__ */ f(
            ...
            {
              ref: E,
              className: N("flex h-full flex-col items-center p-4"),
              children: [
                /* @__PURE__ */ f(
                  "div",
                  {
                ...
                /* @__PURE__ */ o("div", { ref: z, className: "h-px shrink-0", "aria-hidden": !0 }),
      ...
      !g && !S && /* @__PURE__ */ f(Ue, { children: [
        /* @__PURE__ */ o(Hn, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ o(Hn, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    B.isOpen && /* @__PURE__ */ o(
      M6,
      {
        onSubmit: T,
        onClose: P,
        reactionType: B.currentReaction,
        message: B.currentMessage
      }
    )
  ] });
}, U6 = () => /* @__PURE__ */ o("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ f("div", { className: "flex flex-col gap-2", children: [
...
function N3({
  ...
  return /* @__PURE__ */ o(O1.Provider, { value: e, children: t });
}
function T3() {
  const t = kt(O1);
  if (t === null)
...
const W6 = ({
  ...
  const g = he().ai.clarifyingQuestion.typeYourAnswer, p = t === "single" ? /* @__PURE__ */ o(Z1, { isSelected: r && !e }) : /* @__PURE__ */ o(
    To,
    {
      checked: s,
      onCheckedChange: () => d(!s),
...
const q6 = ({
  ...
  const L = ze(), B = (() => {
    ...
    const y = r.findIndex((_) => n.includes(_.id));
    return y >= 0 ? y : 0;
  })(), [T, P] = D(B), k = I([]);
  ae(() => {
    h && t === "single" && k.current[T]?.focus();
  }, []);
  const w = (y) => {
    if (t !== "single") return;
    const _ = r.length - 1;
    ...
    y.preventDefault(), P(S), k.current[S]?.focus();
  };
  return /* @__PURE__ */ f(
    "div",
    {
  ...
  } = s, y = I(null), _ = B ?? "single", S = i > 1, b = a === 0, E = a === i - 1, R = S ? r.t("ai.clarifyingQuestion.stepOf", {
    current: String(a + 1),
    total: String(i)
  }) : void 0, z = L.length > 0, Y = (k ?? "").trim().length > 0, J = z || w && Y || T === !0, te = e === !0 && E, le = () => {
    te || c();
  }, ne = () => {
    te || d();
  }, M = (Z) => {
    const oe = _ === "single" && L.includes(Z);
    l(Z), _ === "single" && !E && !oe && Promise.resolve().then(c);
  }, G = E ? r.ai.clarifyingQuestion.submit : r.ai.clarifyingQuestion.next, j = T === !0 && !z && !(w && Y), K = () => {
  ...
  return /* @__PURE__ */ f("div", { className: "flex flex-col", onKeyDown: we, children: [
    /* @__PURE__ */ o("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ o(De, { mode: "wait", initial: !1, children: /* @__PURE__ */ f(
      Ce.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ge, ease: X6 },
        children: [
          /* @__PURE__ */ o(
            Y6,
            {
...
function In(t, e, r, n) {
  const s = Math.max(1, Math.min(t, e)), a = Math.min(r, 20), l = Math.min(a + n, s), c = Math.min(l, Math.floor(t / 2)), d = Math.min(l, Math.floor(e / 2)), u = (K) => K / t * 2 - 1, h = (K) => K / e * 2 - 1, g = 0, p = t, v = 0, C = e, x = c, L = t - c, B = d, T = e - d, P = u(g), k = u(p), w = h(v), y = h(C), _ = u(x), S = u(L), b = h(B), E = h(T), R = 0, z = 0, Y = 1, J = 1, te = c / t, le = 1 - c / t, ne = d / e, M = 1 - d / e, G = new Float32Array([
    // Top strip
    P,
    w,
    k,
...
function J6(t, e, r) {
  const n = jn(t, t.VERTEX_SHADER, e), s = jn(t, t.FRAGMENT_SHADER, r), a = t.createProgram();
...
class F3 {
  ...
  resize(e, r, n) {
    ...
    const { gl: s, program: a, vao: i, positionBuffer: l, uvBuffer: c, uResolution: d } = this.glr, u = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, h = Math.max(1, Math.floor(e * u)), g = Math.max(1, Math.floor(r * u));
    ...
    s.enableVertexAttribArray(C), s.vertexAttribPointer(C, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, c), s.bufferData(s.ARRAY_BUFFER, v, s.STATIC_DRAW);
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, a = this.canvas.height || 2, { positions: i, uvs: l } = In(
      s,
      a,
    ...
    const g = e.getUniformLocation(r, "uResolution"), p = e.getUniformLocation(r, "uTime"), v = e.getUniformLocation(r, "uBorderWidth"), C = e.getUniformLocation(r, "uGlowWidth"), x = e.getUniformLocation(r, "uBorderRadius"), L = e.getUniformLocation(r, "uColors"), B = e.getUniformLocation(r, "uGlowExponent"), T = e.getUniformLocation(r, "uGlowFactor");
    e.useProgram(r), e.uniform1f(v, this.options.borderWidth), e.uniform1f(C, this.options.glowWidth), e.uniform1f(x, this.options.borderRadius), this.options.mode === "dark" ? (e.uniform1f(B, 2), e.uniform1f(T, 1.8)) : (e.uniform1f(B, 1), e.uniform1f(T, 1));
    const P = (this.options.colors || r9).map(n9);
    for (let k = 0; k < P.length; k++)
      e.uniform3f(
        e.getUniformLocation(r, `uColors[${k}]`),
        ...P[k]
      );
...
const On = ["lowp", "mediump", "highp"], o9 = `
void main(void){
...
}`, Zn = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, Dn = "iTime", Bn = "iTimeDelta", Un = "iDate", zn = "iFrame", Wn = "iMouse", Gn = "iResolution", a9 = "iChannel", qn = "iChannelResolution", Yn = "iDeviceOrientation";
function i9(t, e) {
...
}, Cr = 9729, Xn = 9728, f9 = 9987, Kn = 33071, Qn = 10497;
class h9 {
  gl;
  url;
  wrapS;
  ...
  load = async (e) => {
    ...
    const h = 0, g = r.RGBA, p = 1, v = 1, C = 0, x = r.RGBA, L = r.UNSIGNED_BYTE, B = new Uint8Array([255, 255, 255, 0]), T = r.createTexture();
    if (r.bindTexture(r.TEXTURE_2D, T), r.texImage2D(
      r.TEXTURE_2D,
      h,
      g,
      p,
      ...
      return r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_S, r.CLAMP_TO_EDGE), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_T, r.CLAMP_TO_EDGE), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MIN_FILTER, r.LINEAR), this._webglTexture = T, this.source = y, this.isVideo = !0, y.play().then(() => this);
    }
    async function P() {
      return new Promise((y, _) => {
        ...
        S.crossOrigin = "anonymous", S.onload = () => {
          ...
          _(new Error(Ge(`failed loading url: ${n}`)));
        }, S.src = n ?? "";
      });
    }
    let k = await P(), w = (k.width & k.width - 1) === 0 && (k.height & k.height - 1) === 0;
    return (e.wrapS !== Kn || e.wrapT !== Kn || e.minFilter !== Xn && e.minFilter !== Cr) && !w && (k = this.makePowerOf2(k), w = !0), r.bindTexture(r.TEXTURE_2D, T), r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL, c), r.texImage2D(
      r.TEXTURE_2D,
      h,
      g,
      x,
      L,
      k
    ), w && e.minFilter !== Xn && e.minFilter !== Cr && r.generateMipmap(r.TEXTURE_2D), r.texParameteri(
      r.TEXTURE_2D,
      r.TEXTURE_WRAP_S,
      this.wrapS || Qn
    ), r.texParameteri(
      ...
      this.magFilter || Cr
    ), this._webglTexture = T, this.source = k, this.isVideo = !1, this.isLoaded = !0, this.width = k.width || 0, this.height = k.height || 0, this;
  };
}
const Ge = (t) => `react-shaders: ${t}`, Jn = (t) => {
  if ("changedTouches" in t) {
    const e = t.changedTouches[0];
    return [e?.clientX ?? 0, e?.clientY ?? 0];
  }
  return [t.clientX, t.clientY];
}, eo = (t, e, r) => t * (1 - r) + e * r, p9 = (t, e, r) => r > 0 ? t.substring(0, r) + e + t.substring(r, t.length) : e + t;
function m9({
  fs: t,
  vs: e = Zn,
  textures: r = [],
  ...
  const p = I(null), v = I(null), C = I(null), x = I(null), L = I(void 0), B = I(void 0), T = I(!1), P = I(void 0), k = I(0), w = I([0, 0]), y = I([]), _ = I(0), S = I(void 0), b = I({
    [Dn]: { type: "float", isNeeded: !1, value: 0 },
    [Bn]: { type: "float", isNeeded: !1, value: 0 },
    [Un]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [Wn]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [Gn]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    ...
    const H = "width" in V ? V.width ?? 0 : 0, Q = "height" in V ? V.height ?? 0 : 0, U = b.current.iChannelResolution;
    if (!U) return;
    const re = Array.isArray(U.value) ? U.value : U.value = [];
    re[$ * 3] = H * d, re[$ * 3 + 1] = Q * d, re[$ * 3 + 2] = 0;
  }, z = () => {
    ...
    V?.bufferData(V.ARRAY_BUFFER, new Float32Array($), V.STATIC_DRAW);
  }, J = ({
    alpha: V,
    beta: $,
    gamma: H
    ...
    const [$ = 0, H = 0] = Jn(V), Q = $ - (P.current?.left ?? 0) - window.pageXOffset, U = (P.current?.height ?? 0) - H - (P.current?.top ?? 0) - window.pageYOffset;
    T.current = !0;
    const re = Array.isArray(b.current.iMouse?.value) ? b.current.iMouse.value : void 0;
    re && (re[2] = Q, re[3] = U), w.current[0] = Q, w.current[1] = U;
  }, le = (V) => {
    P.current = p.current?.getBoundingClientRect();
    const [$ = 0, H = 0] = Jn(V), Q = $ - (P.current?.left ?? 0), U = (P.current?.height ?? 0) - H - (P.current?.top ?? 0);
    if (c !== 1)
      w.current[0] = Q, w.current[1] = U;
    else {
      const re = Array.isArray(b.current.iMouse?.value) ? b.current.iMouse.value : void 0;
      re && (re[0] = Q, re[1] = U);
    }
  }, ne = () => {
    const V = Array.isArray(b.current.iMouse?.value) ? b.current.iMouse.value : void 0;
    V && (V[2] = 0, V[3] = 0);
  }, M = () => {
    const V = v.current;
    if (!V) return;
    P.current = p.current?.getBoundingClientRect();
    const $ = d, H = Math.floor(
      (P.current?.width ?? 1) * $
    ), Q = Math.floor(
      (P.current?.height ?? 1) * $
    );
    if (V.canvas.width = H, V.canvas.height = Q, b.current.iResolution?.isNeeded && x.current) {
      const U = V.getUniformLocation(
        x.current,
        Gn
      );
      V.uniform2fv(U, [V.canvas.width, V.canvas.height]);
    }
  }, G = (V, $) => {
    const H = v.current;
    if (!H) return null;
    const Q = H.createShader(V);
    if (!Q) return null;
    if (H.shaderSource(Q, $), H.compileShader(Q), !H.getShaderParameter(Q, H.COMPILE_STATUS)) {
      g?.(Ge(`Error compiling the shader:
${$}`));
      const U = H.getShaderInfoLog(Q);
      H.deleteShader(Q), h?.(Ge(`Shader compiler log: ${U}`));
    }
    return Q;
  }, j = (V, $) => {
    const H = v.current;
    if (!H) return;
    const Q = G(H.FRAGMENT_SHADER, V), U = G(H.VERTEX_SHADER, $);
    if (x.current = H.createProgram(), !(!x.current || !U || !Q)) {
      if (H.attachShader(x.current, U), H.attachShader(x.current, Q), H.linkProgram(x.current), !H.getProgramParameter(x.current, H.LINK_STATUS)) {
        h?.(
          Ge(
      ...
      H.useProgram(x.current), L.current = H.getAttribLocation(
        x.current,
        "aVertexPosition"
    ...
    if (n)
      for (const V of Object.keys(n)) {
        const $ = n[V];
        if (!$) continue;
        const { value: H, type: Q } = $, U = u9(Q);
        if (!U) continue;
        const re = {};
        if (i9(Q, H)) {
          const xe = Q.length, de = Number.parseInt(Q.charAt(xe - 3)), Ee = Math.floor(H.length / (de * de));
          H.length > de * de && (re.arraySize = `[${Ee}]`);
        } else c9(Q, H) && (re.arraySize = `[${Math.floor(H.length / Number.parseInt(Q.charAt(0)))}]`);
        b.current[V] = {
          type: U,
          isNeeded: !1,
          value: H,
      ...
      if (r && r.length > 0) {
        ...
        const $ = r.map(
          (H, Q) => (b.current[`${a9}${Q}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, R(H, Q), y.current[Q] = new h9(V), y.current[Q]?.load(H).then((U) => {
            R(U, Q);
          }))
        );
        Promise.all($).then(() => {
    ...
    const $ = On.includes(a ?? "highp"), H = `precision ${$ ? a : On[1]} float;
`;
    $ || g?.(
      Ge(
    ...
    let Q = H.concat(`#define DPR ${d.toFixed(1)}
`).concat(V.replace(/texture\(/g, "texture2D("));
    for (const re of Object.keys(b.current))
      if (V.includes(re)) {
        const xe = b.current[re];
        if (!xe) continue;
        Q = p9(
          Q,
          `uniform ${xe.type} ${re}${xe.arraySize || ""}; 
`,
          Q.lastIndexOf(H) + H.length
        ), xe.isNeeded = !0;
      }
    return V.includes("mainImage") && (Q = Q.concat(o9)), Q;
  }, Z = (V) => {
    const $ = v.current;
    if (!$ || !x.current) return;
    const H = _.current ? (V - _.current) / 1e3 : 0;
    _.current = V;
    const Q = E.current;
    if (Q)
      for (const U of Object.keys(Q)) {
        const re = Q[U];
        if (re && b.current[U]?.isNeeded) {
          if (!x.current) return;
          const xe = $.getUniformLocation(
            x.current,
            U
          );
          if (!xe) return;
    ...
    if (b.current.iMouse?.isNeeded) {
      ...
      $.uniform4fv(U, b.current.iMouse.value);
    }
    ...
    if (b.current.iDate?.isNeeded) {
      const U = /* @__PURE__ */ new Date(), re = U.getMonth() + 1, xe = U.getDate(), de = U.getFullYear(), Ee = U.getHours() * 60 * 60 + U.getMinutes() * 60 + U.getSeconds() + U.getMilliseconds() * 1e-3, He = $.getUniformLocation(
        x.current,
        Un
      );
      $.uniform4fv(He, [de, re, xe, Ee]);
    }
    if (b.current.iFrame?.isNeeded) {
      const U = $.getUniformLocation(
        x.current,
        zn
      ), re = b.current.iFrame.value;
      $.uniform1i(U, re), b.current.iFrame.value = re + 1;
    }
    if (y.current.length > 0)
      for (let U = 0; U < y.current.length; U++) {
        const re = y.current[U];
        if (!re) return;
        const { isVideo: xe, _webglTexture: de, source: Ee, flipY: He, isLoaded: at } = re;
        if (!at || !de || !Ee) return;
        if (b.current[`iChannel${U}`]?.isNeeded) {
          if (!x.current) return;
          const Se = $.getUniformLocation(
            x.current,
            `iChannel${U}`
          );
          $.activeTexture($.TEXTURE0 + U), $.bindTexture($.TEXTURE_2D, de), $.uniform1i(Se, U), xe && re.updateTexture(
            de,
            Ee,
            He
          );
    ...
    const $ = v.current;
    if (!$) return;
    $.viewport(0, 0, $.drawingBufferWidth, $.drawingBufferHeight), $.clear($.COLOR_BUFFER_BIT | $.DEPTH_BUFFER_BIT), $.bindBuffer($.ARRAY_BUFFER, C.current), $.vertexAttribPointer(
      L.current ?? 0,
      3,
      $.FLOAT,
      !1,
      0,
      0
    ), Z(V), $.drawArrays($.TRIANGLE_STRIP, 0, 4);
    const H = b.current.iMouse?.value;
    if (b.current.iMouse?.isNeeded && c !== 1 && Array.isArray(H)) {
      const Q = H[0] ?? 0, U = H[1] ?? 0;
      H[0] = eo(Q, w.current[0] ?? 0, c), H[1] = eo(U, w.current[1] ?? 0, c);
    }
    B.current = requestAnimationFrame(oe);
  }, me = () => {
    const V = { passive: !0 };
    b.current.iMouse?.isNeeded && p.current && (p.current.addEventListener("mousemove", le, V), p.current.addEventListener("mouseout", ne, V), p.current.addEventListener("mouseup", ne, V), p.current.addEventListener("mousedown", te, V), p.current.addEventListener("touchmove", le, V), p.current.addEventListener("touchend", ne, V), p.current.addEventListener("touchstart", te, V)), b.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      J,
      V
    ), p.current && (S.current = new ResizeObserver(M), S.current.observe(p.current), window.addEventListener("resize", M, V));
  }, Ae = () => {
    const V = { passive: !0 };
    b.current.iMouse?.isNeeded && p.current && (p.current.removeEventListener("mousemove", le, V), p.current.removeEventListener("mouseout", ne, V), p.current.removeEventListener("mouseup", ne, V), p.current.removeEventListener("mousedown", te, V), p.current.removeEventListener("touchmove", le, V), p.current.removeEventListener("touchend", ne, V), p.current.removeEventListener("touchstart", te, V)), b.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      J,
      V
    ), S.current && (S.current.disconnect(), window.removeEventListener("resize", M, V));
  };
  return ae(() => {
    E.current = n;
  }, [n]), ae(() => {
    ...
    function $() {
      z();
      const H = v.current;
      H && p.current && (H.clearColor(...s), H.clearDepth(1), H.enable(H.DEPTH_TEST), H.depthFunc(H.LEQUAL), H.viewport(0, 0, p.current.width, p.current.height), p.current.height = p.current.clientHeight, p.current.width = p.current.clientWidth, K(), we(), j(ge(t || s9), e || Zn), Y(), requestAnimationFrame(oe), me(), M());
    }
    return requestAnimationFrame($), () => {
      const H = v.current;
      if (H) {
        if (H.getExtension("WEBGL_lose_context")?.loseContext(), H.useProgram(null), H.deleteProgram(x.current ?? null), V.length > 0)
          for (const Q of V)
            H.deleteTexture(Q._webglTexture);
        x.current = null;
      }
      Ae(), cancelAnimationFrame(B.current ?? 0);
    };
  }, []), /* @__PURE__ */ o(
    "canvas",
    {
...
}`, v9 = 10, C9 = 2, w9 = 0.5, x9 = 0.2, k9 = 1.5, Ve = {
  duration: 0.5,
  ease: "easeOut"
}, to = {
  duration: 0.35,
...
function y9(t, e) {
  const [r, n] = D(v9), {
    ...
    animate: a,
    motionValue: i
  } = Zt(x9), { value: l, animate: c } = Zt(C9), { value: d, animate: u } = Zt(w9), { value: h, animate: g } = Zt(k9), p = Si(e, {
    fftSize: 512,
  ...
  return ae(() => {
    switch (t) {
      ...
      case "failed":
      case "disconnected":
        n(10), a(0.2, Ve), c(1.2, Ve), u(0.4, Ve), g(1, Ve);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), a(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, Ve), u(0.7, Ve), g([1.5, 2], to);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), a(0.3, Ve), c(0.5, Ve), u(1, Ve), g([0.5, 2.5], to);
        return;
      case "speaking":
        n(70), a(0.3, Ve), c(0.75, Ve), u(1.25, Ve), g(1.5, Ve);
        return;
    }
  }, [
    t,
...
function P3({
  ...
  const { speed: d, scale: u, amplitude: h, frequency: g, brightness: p } = y9(e, s);
  return /* @__PURE__ */ o(
    B1,
    {
      ref: l,
...
const $3 = ({
  ...
  const n = he(), s = ze();
  return /* @__PURE__ */ f(Ue, { children: [
    t && /* @__PURE__ */ o("span", { className: N(E9(), "truncate"), children: t }),
    /* @__PURE__ */ o(De, { children: r && e && /* @__PURE__ */ o(
      Ce.div,
      {
  ...
  return /* @__PURE__ */ f("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ o("span", { className: N(U1()), children: e }),
    /* @__PURE__ */ f(
      Ce.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ f("div", { className: "flex items-center gap-1", children: [
            ...
            r && /* @__PURE__ */ o("span", { className: N(Dt()), children: r })
          ] }),
          n === "people" && /* @__PURE__ */ o(
            hi,
            {
          ...
          n === "alert" && /* @__PURE__ */ o(mi, { text: t.alertLabel, level: t.level }),
          n === "balance" && /* @__PURE__ */ o(S9, { balance: t.balance })
        ]
      }
    ),
    r && !R9.has(n) && /* @__PURE__ */ o(
      Ce.span,
      {
        className: N(Dt()),
        animate: { opacity: s ? 0 : 1 },
...
const A9 = ({
  ...
  dataLength: n,
  color: s
}) => r !== n - 1 || t == null || e == null ? null : /* @__PURE__ */ o("circle", { cx: t, cy: e, r: 2, fill: s, stroke: "none" }), V9 = ({
  label: t,
  direction: e
}) => {
  const r = z1[e];
  ...
  const s = `sparkline-gradient-${so().replace(/:/g, "")}`, a = T9(t, r), i = z1[a];
  return /* @__PURE__ */ o("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(vi, { width: "100%", height: "100%", children: /* @__PURE__ */ f(
          Ci,
          {
            data: t,
            ...
            children: [
              ...
              /* @__PURE__ */ o(wi, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ o(
                xi,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ o(V9, { label: e, direction: a })
      ]
    }
  ) });
}, W1 = m(
  (t, e) => {
    const {
      ...
      className: c,
      ...d
    } = t, [u, h] = D(!1), [g, p] = D(!1), v = u || g, C = ze(), x = v && !!l, L = {
      duration: C ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, B = () => {
      i?.();
    }, T = (P) => {
      P.currentTarget === P.target && (P.key === "Enter" || P.key === " ") && (P.preventDefault(), i?.());
    };
        ...
        "div",
        {
          ...
          children: [
            ...
            d.content === "sparkline" ? /* @__PURE__ */ f("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ o("span", { className: N(U1()), children: n }),
              /* @__PURE__ */ o(
                Ce.div,
                {
...
W1.displayName = "F0AiInsightCardInternal";
const P9 = ["className"], G1 = m((t, e) => {
  const r = P9.reduce((n, s) => {
    const { [s]: a, ...i } = n;
    return i;
  }, t);
  return /* @__PURE__ */ o(W1, { ref: e, ...r });
});
G1.displayName = "F0AiInsightCard";
const $9 = () => /* @__PURE__ */ f(
  "div",
  {
  ...
  "balance",
  "sparkline"
], q1 = 180, H9 = (t) => Number.isFinite(t) ? Math.max(0, Math.floor(t)) : q1, I9 = (t, e) => t.length <= e ? t : `${t.slice(0, e).trimEnd()}...`, j9 = (t) => t.showActions !== !1, O9 = (t) => Object.fromEntries(
...
function Z9(t) {
  const {
    ...
    description: a,
    seeMoreLabel: i,
    maxCollapsedDescriptionLength: l = q1
  } = t, [c, d] = D(!1), u = so(), h = I(null), g = H9(
    l
  ), p = a.length > g, v = c ? a : I9(a, g), C = j9(t) ? t : null, x = O9(t);
  return ae(() => {
    c && h.current?.focus();
  }, [c]), /* @__PURE__ */ f(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ f("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          e && /* @__PURE__ */ o(Eo, { module: e, size: "lg" }),
...
Z9.displayName = "F0AiProposalCard";
const D9 = ({
  icon: t,
  title: e,
  children: r
  ...
  return /* @__PURE__ */ f(
    Ro,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ f(So, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, B9 = (t) => qd[t] ?? po, U9 = ({ iconName: t }) => t ? /* @__PURE__ */ o("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ o(be, { icon: B9(t), size: "md", color: "default" }) }) : null;
function z9({
  sources: t,
  title: e
}) {
  ...
  return /* @__PURE__ */ o(D9, { icon: Pr, title: n, children: /* @__PURE__ */ o("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: t.map((s, a) => {
    const i = /* @__PURE__ */ o(U9, { iconName: s.icon });
...
function G9({
  ...
  const n = he(), s = I(null), a = e ?? n.ai.aiTable.title, i = X(
    (l) => {
      if (!s.current) return;
  ...
  return t.columns?.length ? /* @__PURE__ */ f(
    ar,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ o(ar, { overflowX: "auto", children: /* @__PURE__ */ f(
          "table",
          {
            ref: s,
            className: N(
...
G9.displayName = "F0AiTableCard";
function q9({ credits: t }) {
  const e = he(), [r, n] = D(!1), [s, a] = D(!1), [i, l] = D(!1), [c, d] = D(null), u = X(
    (p) => {
  ...
  if (!t) return null;
  const h = c ? Math.min(100, Math.round(c.used / c.total * 100)) : 0, g = t.companyName;
  return /* @__PURE__ */ f(Hr, { open: r, onOpenChange: u, children: [
    /* @__PURE__ */ o(Ir, { asChild: !0, children: /* @__PURE__ */ o(
      ye,
      {
        variant: "ghost",
        hideLabel: !0,
...
function X9({
  ...
  const e = he(), r = ze(), [n, s] = D(!1), [a, i] = D(!1), [l, c] = D(!1), [d, u] = D(null), h = X(
    (C) => {
      s(C), C && t?.fetchUsage && (i(!0), c(!1), t.fetchUsage().then((x) => {
        u(x), c(!1);
      }).catch(() => {
        c(!0);
      }).finally(() => {
  ...
  if (!t) return null;
  const g = !!t.companyName, p = d && d.total > 0 ? Math.min(100, Math.round(d.used / d.total * 100)) : 0, v = d ? Math.max(0, d.total - d.used) : 0;
...
const ro = ({
  credits: t,
  employeeCredits: e
}) => e ? /* @__PURE__ */ o(X9, { employeeCredits: e }) : t ? /* @__PURE__ */ o(q9, { credits: t }) : null, j3 = ({
  historyEnabled: t = !1,
  title: e,
  ...
  const g = he(), p = yo(`(max-width: ${yi.md}px)`, {
        ...
        /* @__PURE__ */ o("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ o(
          At,
          {
            ...
            children: /* @__PURE__ */ f("div", { className: "flex min-w-0 items-center gap-1", children: [
              ...
              /* @__PURE__ */ o(be, { icon: Fr, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ f(
  ...
  ) : /* @__PURE__ */ f("header", { className: N("flex justify-between px-4 py-3"), children: [
...
function K9() {
  if (!(typeof navigator > "u"))
    return Mi(navigator.language);
}
function Q9(t) {
  const e = new Date(t), r = /* @__PURE__ */ new Date();
  return Ao(e) ? "today" : Vo(e) ? "yesterday" : bi(e, r) ? "thisMonth" : "older";
}
function J9(t, e) {
  const r = new Date(t), n = K9(), s = Qr(r, "p", { locale: n });
  if (Ao(r)) return `${e.today}, ${s}`;
  if (Vo(r)) return `${e.yesterday}, ${s}`;
  const a = !Li(r, /* @__PURE__ */ new Date());
  return `${Qr(r, a ? "MMM d yyyy" : "MMM d", {
    locale: n
  })}, ${s}`;
}
function e3(t) {
      ...
      children: [
        ...
        /* @__PURE__ */ o(
          "div",
          {
            ...
            children: /* @__PURE__ */ o(Or, { items: l, children: /* @__PURE__ */ o(
              Re,
              {
                icon: ho,
                variant: "ghost",
...
const O3 = ({
  ...
  const p = ce(
    ...
    return n.filter((y) => y.title.toLowerCase().includes(w));
  }, [n, h]), C = ce(
    () => v.filter((w) => i.has(w.id)),
    [v, i]
  ), x = ce(
    () => v.filter((w) => !i.has(w.id)),
    [v, i]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ f("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ o(be, { icon: Pr, color: "secondary", size: "md" }),
                  /* @__PURE__ */ o(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ f("div", { className: "flex flex-1 flex-col gap-1 overflow-y-auto p-2", children: [
                  /* @__PURE__ */ o(
                    At,
                    {
                      ...
                      children: /* @__PURE__ */ f("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ o(be, { icon: Dr, color: "default", size: "md" }),
                  ...
                  !s && !a && !k && /* @__PURE__ */ o("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: u.ai.noPreviousChats }),
...
function Z3({
  ...
  const [n, s] = D([]), [a, i] = D(!1), [l, c] = D(null), [d, u] = D(n3), h = X(async () => {
    i(!0), c(null);
    try {
      const C = await e();
      s(C);
    } catch (C) {
      const x = C instanceof Error ? C.message : "Failed to fetch chat history";
      c(x), s([]);
    } finally {
      i(!1);
    }
  ...
  const g = X((C) => {
    u((x) => {
      const L = new Set(x);
      return L.add(C), wr(L), L;
    });
  }, []), p = X((C) => {
    u((x) => {
      const L = new Set(x);
      return L.delete(C), wr(L), L;
    });
  }, []), v = X(
    async (C) => {
      try {
        await r(C), s((x) => x.filter((L) => L.id !== C)), u((x) => {
          if (!x.has(C)) return x;
          const L = new Set(x);
          return L.delete(C), wr(L), L;
        });

...
import { useInsertionEffect as Vn, forwardRef as m, createElement as Oe, useRef as I, useMemo as te, useEffect as Y, useState as j, useLayoutEffect as jt, useCallback as q, createContext as i1, useContext as We, useId as Dt } from "react";
import { c9 as Tn, ca as An, cb as Hn, cc as Bn, cd as _t, ce as $n, cf as In, cg as Pn, ch as jn, ci as Dn, cj as Ot, ck as _n, cl as On, cm as Zn, cn as Un, co as zn, cp as Gn, cq as Wn, cr as t1, cs as qn, ct as Xn, cu as Yn, cv as Kn, cw as Qn, cx as Jn, W as Zt, cy as eo, cz as to, cA as ro, cB as no, cC as oo, cD as Ut, cE as so, cF as io, a3 as V1, cG as ao, aG as co, cH as lo, cI as uo, cJ as fo, ad as ho, cK as go, bH as po, a7 as T1, aa as mo, cL as Co, b7 as A1, _ as zt, N as a1, cM as Gt, b6 as vo, cN as wo, cO as xo, a$ as ko, bG as bo, Y as Ee, ar as Lo, bb as Wt, cP as yo, bE as qt, cQ as Fe, bA as Mo, cR as Eo, cS as Xt, a_ as Yt, cT as Ro, cU as No, cV as Fo, cW as So, cX as Vo, cY as Kt, bs as To, bt as Ao, cZ as Ho, c_ as Bo, c$ as $o, d0 as Io, d1 as Po, d2 as jo, d3 as Do, d4 as _o, d5 as Oo, d6 as Zo, d7 as Uo, d8 as zo, d9 as Go, bF as Wo, a8 as qo, bo as Xo, da as Yo, db as Ko, dc as Qo, dd as Jo, de as es, df as ts, dg as rs, am as ns, dh as Qt, J as os, Z as ss, di as Jt, dj as is, ba as as, b9 as cs, dk as ls, dl as er, dm as ds, aZ as us, av as fs, dn as hs, ap as gs, b4 as ps, dp as tr, dq as ms, dr as Cs, bf as H1, ds as vs, dt as B1, bC as ws, bB as xs, bD as rr, du as ks, z as bs, y as Ls, dv as ys, dw as Ms, dx as Es, dy as Rs, dz as Ns, dA as nr, dB as Fs, a9 as Ss, dC as Vs, H as fe, o as Se, m as E, ab as le, dD as Ts, bi as As, bv as Hs, w as or, dE as Bs, a2 as c1, bU as $s, aq as Is, M as me, C as ae, a5 as sr, ac as ir, bj as ar, dF as Ps, aY as cr, s as Ce, dG as js, dH as Ds, S as he, u as ee, c7 as lr, $ as _s, dI as Os, aM as Le, A as ye, n as oe, aA as $1, dJ as Zs, aB as I1, aC as P1, b as Re, bw as Us, O as zs, dK as Gs, dL as Ws, dM as qs, dN as X1, a0 as Xs, ah as dr, aP as ur, dO as Ys, bT as Ks, dP as Qs, dQ as Js, aU as fr, dR as ei, bN as ti, dS as ri, aR as Ge, bd as hr, dT as gr, be as pr, dU as mr, dV as ni, bh as oi, dW as si, b5 as j1, bp as ii, dX as ai, dY as ci, dZ as li, d_ as di, d$ as ui, x as fi, e0 as Cr, e1 as vr, e2 as hi, ag as Y1, e3 as gi, af as pi, e4 as mi, e5 as Ci } from "./F0CanvasPanel-DHzu-56s.js";
import { createPortal as wr } from "react-dom";
import { defaultTranslations as vi } from "./i18n-provider-defaults.js";
import { useTrackVolume as wi } from "@livekit/components-react";
import './useChatHistory.css';function xi(e, t, n) {
  Vn(() => e.on(t, n), [e, t, n]);
}
function D1(e) {
...
function xr(e, t, n, o) {
  return typeof e == "string" && D1(t) ? Tn(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function ki(e, t, n) {
  return e * (t + 1);
}
...
function kr(e, t) {
  return An(e) ? e[bi(0, e.length, t)] : e;
}
function Li(e, t, n) {
  for (let o = 0; o < e.length; o++) {
    const s = e[o];
    s.at > t && s.at < n && (Bn(e, s), o--);
  }
}
function yi(e, t, n, o, s, i) {
  Li(e, s, i);
...
function Fi(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let g = 0; g < e.length; g++) {
    ...
    if (typeof p == "string") {
      ...
      f.set(p.name, K1(h, p.at, u, f));
      continue;
    }
    let [w, v, x = {}] = p;
    x.at !== void 0 && (h = K1(h, x.at, u, f));
    let H = 0;
    const N = (R, k, M, V = 0, L = 0) => {
      const S = Si(R), { delay: b = 0, times: y = $n(S), type: T = "keyframes", repeat: D, repeatType: O, repeatDelay: Z = 0, ...z } = k;
      let { ease: W = t.ease || "easeOut", duration: U } = k;
      const $ = typeof b == "function" ? b(V, L) : b, X = S.length, J = jn(T) ? T : s?.[T];
      if (X <= 2 && J) {
        let K = 100;
        if (X === 2 && Ai(S)) {
          const ge = S[1] - S[0];
        ...
        const re = { ...z };
        U !== void 0 && (re.duration = Dn(U));
        const ue = In(re, K, J);
        W = ue.ease, U = ue.duration;
      }
      U ?? (U = i);
      const se = h + $;
      y.length === 1 && y[0] === 0 && (y[1] = 1);
      const de = y.length - S.length;
      if (de > 0 && Pn(y, de), S.length === 1 && S.unshift(null), D) {
        Ot(D < Ni, "Repeat count too high, must be less than 20"), U = ki(U, D);
        const K = [...S], re = [...y];
        ...
        for (let ge = 0; ge < D; ge++) {
          ...
          for (let F = 0; F < K.length; F++)
            y.push(re[F] + (ge + 1)), W.push(F === 0 ? "linear" : kr(ue, F - 1));
        }
        Mi(y, D);
      }
      const ce = se + U;
      yi(M, S, W, y, se, ce), H = Math.max($ + U, H), C = Math.max(ce, C);
    };
    if (_t(w)) {
      const R = Q1(w, l);
      N(v, x, J1("default", R));
    } else {
      const R = xr(w, v, o, c), k = R.length;
      for (let M = 0; M < k; M++) {
        v = v, x = x;
        const V = R[M], L = Q1(V, l);
        for (const S in v)
          N(v[S], Vi(x, S), J1(S, L), M, k);
      }
    }
    u = h, h += H;
  }
  return l.forEach((g, p) => {
    for (const w in g) {
      ...
      for (let k = 0; k < v.length; k++) {
        const { at: M, value: V, easing: L } = v[k];
        x.push(V), H.push(_n(0, C, M)), N.push(L || "easeOut");
      }
      H[0] !== 0 && (H.unshift(0), x.unshift(x[0]), N.unshift(Ri)), H[H.length - 1] !== 1 && (H.push(1), x.push(null)), a.has(p) || a.set(p, {
        keyframes: {},
        transition: {}
      });
      const R = a.get(p);
...
const Ti = (e) => typeof e == "number", Ai = (e) => e.every(Ti);
function Hi(e, t) {
  return e in t;
}
class Bi extends On {
...
function $i(e) {
  ...
  }, n = Un(e) && !zn(e) ? new Gn(t) : new Wn(t);
  n.mount(e), t1.set(e, n);
}
function Ii(e) {
  const t = {
    presenceContext: null,
...
function Pi(e, t) {
  return _t(e) || typeof e == "number" || typeof e == "string" && !D1(t);
}
function br(e, t, n, o) {
  const s = [];
  if (Pi(e, t))
    s.push(qn(e, D1(t) && t.default || t, n && (n.default || n)));
  else {
    const i = xr(e, t, o), a = i.length;
    Ot(!!a, "No valid elements provided.");
    for (let l = 0; l < a; l++) {
      const c = i[l], f = c instanceof Element ? $i : Ii;
      t1.has(c) || f(c);
      const u = t1.get(c), h = { ...n };
      "delay" in h && typeof h.delay == "function" && (h.delay = h.delay(l, a)), s.push(...Xn(u, { ...t, transition: h }, {}));
    }
  }
  return s;
}
function ji(e, t, n) {
  const o = [];
  return Fi(e, t, n, { spring: Yn }).forEach(({ keyframes: i, transition: a }, l) => {
    o.push(...br(l, i, a));
  }), o;
}
class Di {
...
function Zi(e) {
  function t(n, o, s) {
    let i = [];
    return Oi(n) ? i = ji(n, o, e) : i = br(n, o, s, e), new _i(i);
  }
  return t;
}
const Ui = Zi(), zi = (e, t) => /* @__PURE__ */ d(
  "svg",
  {
...
Rr.displayName = "ShoppingCart";
const m5 = (e, t) => /* @__PURE__ */ d(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
), t2 = m(e2), r2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Gi,
  Add: Kn,
  Ai: Qn,
  ...
  Calculator: go,
  Calendar: po,
  CalendarArrowDown: va,
  CalendarArrowLeft: xa,
  CalendarArrowRight: ba,
  CameraPlus: ya,
  CardPin: Ea,
  ChartFunnel: Na,
  ...
  Wifi: t2,
  Windows: Vs
}, Symbol.toStringTag, { value: "Module" })), n2 = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ r(
    fe,
    {
      ...
      variant: "ai",
      ref: t,
      iconRotate: e.icon == o2
    }
  );
});
Tr.displayName = "AIButton";
const De = Se({
  ...
  ({
    ...
    const h = s ?? i2[t ?? "body"], C = c ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (i !== void 0) {
      ...
      return C ? Oe(
        ...
        le,
        {
          ...
          noTooltip: a,
          tag: h,
          className: E(De({ variant: t, align: n }), o),
          markdown: l,
          ...f,
          children: e
        }
...
const L2 = Se({
  ...
  ({
    ...
    const Pe = X && X !== "none" || J && J !== "none" || se && se !== "none" || de && de !== "none", f1 = $ && $ !== "none" || Pe, h1 = { sm: l1, md: qe, lg: d1, xl: u1 }, g1 = y2.map((Ye) => {
      const je = h1[Ye];
      return je ? b2(Ye, je) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        className: E(
          ...
          g1,
          f1 && !U && "border-f1-border",
          P && !G && "divide-f1-border",
          "scrollbar-macos"
        ),
        ...Ae
      }
...
const m1 = As(
...
}), C1 = { sm: 640, md: 768, "container-md": 448 }, N1 = (e) => "type" in e && e.type === "separator", r1 = (e) => "type" in e && e.type === "split", E2 = (e) => !("type" in e), n1 = (e, t, n) => /* @__PURE__ */ r(
  me,
  {
    label: e.label,
    icon: e.icon,
  ...
  "secondary-link"
), Wr = (e, t) => r1(e) ? Z1(e, t, "default") : n1(e, t, "default");
function et({
  primaryAction: e,
  secondaryActions: t,
  otherActions: n = [],
  ...
  const u = I(null), { width: h = 0 } = Hs({
    ref: u,
    box: "border-box"
  }), C = a === "sm" || a === "md" ? C1[a] : C1.md, g = or(`(min-width: ${C}px)`, {
    initializeWithValue: !1
  }), p = a === "none" ? !0 : a === "container-md" ? h >= C1["container-md"] : g, w = typeof o == "string" ? o : o.base, v = typeof o == "string" ? o : o.md, x = p ? v : w, H = Array.isArray(
    t
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: { gap: s },
      children: p ? /* @__PURE__ */ r(N2, { ...R }, "row") : /* @__PURE__ */ r(R2, { ...R }, "stacked")
    }
  );
}
function R2({
  ...
  const i = t.filter(
    ...
    (a) => r1(a) ? Z1(a, s, "outline") : n1(a, s, "outline")
  );
  return /* @__PURE__ */ d(ke, { children: [
    o.length > 0 && /* @__PURE__ */ r($s, { items: o }),
    i,
    n && Gr(n, s),
    e && Wr(e, s)
  ] });
...
function N2({
  ...
  const p = g ? h : l, w = g ? C : [], v = new Set(p.map((L) => L.id)), x = e ? Wr(e, s) : null, H = t.filter(r1), N = t[t.length - 1], R = N != null && N1(N) && (H.length > 0 || x != null), k = [];
  t.forEach((L, S) => {
    if (!r1(L)) {
      if (N1(L)) {
        k.push({ kind: "sep", key: `sep-${S}` });
        return;
      }
      v.has(L.id) && k.push({
        kind: "node",
  ...
  const M = k.filter(
    (L, S) => L.kind === "node" || k[S - 1]?.kind === "node" && k[S + 1]?.kind === "node"
  ), V = [
    ...w.map(
      (L) => ({
        label: L.label,
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          V.length > 0 && /* @__PURE__ */ r("div", { ref: u, children: /* @__PURE__ */ r(c1, { items: V, icon: Xt, size: s }) }),
          M.map(
            (L) => L.kind === "sep" ? /* @__PURE__ */ r(tt, {}, L.key) : L.node
          ),
          n && Gr(n, s)
        ]
      }
...
function H2({
  ...
  return !!C || (Array.isArray(t) ? t.length > 0 : !!t) || (n?.length ?? 0) > 0 ? u(
    /* @__PURE__ */ r(
      et,
      {
        primaryAction: C,
...
const qr = m(
  function({
    ...
    const N = !!p && p.visible !== !1, R = /* @__PURE__ */ d(
      ar,
      {
        ...
        className: E(
          ...
          h && "p-3",
          g && "h-full",
          C && "focus-within:border-f1-border-hover focus-within:shadow-md hover:border-f1-border-hover hover:shadow-md"
        ),
        style: N ? {
          borderColor: Ps[p.variant],
          borderWidth: "2px"
        } : void 0,
        onClick: w,
        "data-testid": "card",
        children: [
          C && !v && /* @__PURE__ */ r(
            cr,
            {
              href: C,
              variant: "unstyled",
              className: E("z-1 absolute inset-0 block rounded-xl", Ce()),
              "aria-label": t,
              children: " "
            }
          ),
          /* @__PURE__ */ d("div", { className: F2[x], children: [
            /* @__PURE__ */ d("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
              o && /* @__PURE__ */ r(js, { avatar: o, size: "lg" }),
    ...
    return N ? /* @__PURE__ */ r(Ds, { ref: H, alert: p, fullHeight: g, children: R }) : R;
  }
);
qr.displayName = "F0CardRow";
const B2 = ({ compact: e = !1 }) => /* @__PURE__ */ r(
  ar,
  {
    className: E(
    ...
    children: /* @__PURE__ */ d("div", { className: "flex flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ d("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
        /* @__PURE__ */ r(
          he,
          {
            className: E("h-10 w-10 rounded-full", e && "h-8 w-8")
          }
        ),
        /* @__PURE__ */ d("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ r(he, { className: "h-3 w-32 rounded-md" }),
          /* @__PURE__ */ r(he, { className: "h-3 w-20 rounded-md" })
        ] })
      ] }),
      /* @__PURE__ */ r(he, { className: "h-9 w-24 rounded-md" })
    ] })
  }
), $2 = sr(
  ir(qr, B2)
), i3 = ["xs", "sm", "md", "lg"], I2 = 2, nt = 2, P2 = 70, ot = 0.08, j2 = 6, D2 = 0.6, _2 = () => {
  ...
  return Y(() => {
    ...
    const c = () => {
      ...
      s(
        Math.max(1, Math.floor((u + nt) / (I2 + nt)))
      );
    };
    ...
    const h = new Uint8Array(u.fftSize), C = setInterval(() => {
      ...
      const p = Math.sqrt(g / h.length), w = Math.min(1, Math.pow(p * j2, D2));
      a((v) => {
    ...
    return () => {
      clearInterval(C), f.disconnect(), u.disconnect(), c.close(), a([]);
    };
  }, [e, o]), /* @__PURE__ */ r(
    "div",
    {
  ...
  "div",
  {
    ...
    children: e.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ r(he, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ r(
        z2,
        {
          att: s,
          onRemove: n,
...
function z2({
  ...
  const o = /* @__PURE__ */ d("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(ae, { icon: Zt, size: "md", color: "critical" }),
  ...
  return e.errorMessage ? /* @__PURE__ */ r(_s, { label: e.errorMessage, children: o }) : o;
}
const G2 = {
  soft: {
    text: "",
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      className: E("flex flex-col rounded-xl", o.bg, o.formBorder),
      children: [
        /* @__PURE__ */ d("div", { className: "flex items-center justify-between gap-2 px-4 pb-1.5 pt-2", children: [
          /* @__PURE__ */ r(
            "p",
            {
              className: E("min-w-0 flex-1 text-sm font-medium", o.fontColor),
              children: o.text
            }
          ),
    ...
    "div",
    {
      ...
      children: c ? Array.from({ length: 3 }, (u, h) => /* @__PURE__ */ d(
        "div",
        {
          ...
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ r(he, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ r(
              he,
              {
                className: E("h-4 rounded", h === 1 ? "w-24" : "w-32")
              }
            )
          ]
        },
        ...
        const C = h === o, g = `${u.firstName} ${u.lastName}`.trim();
        return /* @__PURE__ */ d(
          "div",
          {
            ref: C ? l : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ r(le, { className: "text-base font-medium text-f1-foreground", children: g }) })
            ]
          },
          String(u.id)
        );
...
const X2 = ({
  ...
  return /* @__PURE__ */ r("div", { className: "p-1", children: /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ r(ae, { icon: O1, size: "md", color: "default" }) }),
        /* @__PURE__ */ r(
          le,
          {
  ...
  const s = Le(), [i, a] = j(""), [l, c] = j(0), [f, u] = j(!1), h = I(null), C = I(null), g = I(null), p = e[l] ?? t;
  return Y(() => {
    const w = () => {
      C.current && (clearInterval(C.current), C.current = null), g.current && (clearInterval(g.current), g.current = null), h.current && (clearTimeout(h.current), h.current = null);
    };
    if (n.length > 0 || o) {
      u(!1), a(""), w();
      return;
    ...
    if (s)
      return u(!1), a(p), w(), h.current = setTimeout(() => {
        const k = (l + 1) % Math.max(e.length, 1);
        c(k);
      }, 4e3), () => {
        w();
      };
    u(!0), a("");
    let v = 0;
    const x = 50, H = 30, N = 2e3, R = 1e3;
    return C.current = setInterval(() => {
      v < p.length ? (a(p.slice(0, v + 1)), v++) : (C.current && (clearInterval(C.current), C.current = null), h.current = setTimeout(() => {
...
const e4 = ({
  ...
  const [o, s] = j(null), i = o !== null ? e[o] : null;
  return e.length === 0 ? null : /* @__PURE__ */ d(
    $1,
    {
      ...
      children: [
        /* @__PURE__ */ r(Zs, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((a, l) => /* @__PURE__ */ r(I1, { asChild: !0, children: /* @__PURE__ */ r(
          fe,
          {
            variant: "outline",
            label: a.label,
        ...
        i && /* @__PURE__ */ d(
          P1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: J2(i.items).map((a, l) => /* @__PURE__ */ d(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ r(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ r(ae, { icon: V1, size: "sm" })
                      }
                    )
                  ]
                },
...
function t4(e, t, n) {
  ...
  for (const u of t) {
    ...
    let C = 0;
    for (; ; ) {
      const g = e.indexOf(h, C);
      if (g === -1) break;
      i.push({ start: g, end: g + h.length }), C = g + h.length;
    }
  }
...
const r4 = 250, n4 = 12e4, o4 = () => typeof navigator < "u" && !!navigator.mediaDevices?.getUserMedia && typeof MediaRecorder < "u";
function s4({
  onTranscribe: e,
  onPartial: t,
  onFinal: n,
  ...
  const [i, a] = j("idle"), [l, c] = j(0), [f] = j(o4), [u, h] = j(null), C = I(null), g = I(null), p = I([]), w = I(null), v = I(!1), x = I(null), H = I(null), N = I(0), R = I({ onTranscribe: e, onPartial: t, onFinal: n, onError: o });
  R.current = { onTranscribe: e, onPartial: t, onFinal: n, onError: o };
  const k = q(() => {
    g.current?.getTracks().forEach((b) => b.stop()), g.current = null, C.current = null, h(null), x.current && (clearInterval(x.current), x.current = null), H.current && (clearTimeout(H.current), H.current = null);
  }, []), M = q(async () => {
    const { onTranscribe: b, onPartial: y, onFinal: T, onError: D } = R.current, O = p.current;
    if (p.current = [], O.length === 0 || !b) {
      a("idle"), c(0);
      return;
    }
    ...
    try {
      ...
      z.signal.aborted || T(W);
    } catch {
      z.signal.aborted || D("transcription-failed");
    } finally {
    ...
    g.current = b, h(b);
    const y = new MediaRecorder(b);
    C.current = y, y.ondataavailable = (T) => {
      ...
      M();
    }, y.start(r4), N.current = Date.now(), a("recording"), c(0), x.current = setInterval(() => {
  ...
  return Y(
    ...
    [k]
  ), { status: i, durationMs: l, isSupported: f, stream: u, start: L, stop: V, cancel: S };
}
function i4(e, t) {
  if (t === "*/*") return !0;
  if (t.endsWith("/*")) {
...
function a4(e, t) {
  ...
  return n.length === 0 ? e : e.filter(
    (o) => n.some((s) => i4(o.type, s))
  );
}
const c4 = 4e3;
function l4(e) {
  const [t, n] = j([]), [o, s] = j(null), i = I(
    null
  ), a = I(null), l = ee(), c = e?.onUploadFiles, f = e?.allowedMimeTypes, u = e?.maxFiles, h = te(() => {
    if (f)
      return Array.isArray(f) ? f.join(",") : f;
  }, [f]), C = u !== void 0 && t.length >= u, g = I(0);
  Y(() => {
    g.current = t.length;
  }, [t]);
  const p = q((N) => {
  ...
  const w = q(
    async (N) => {
      ...
      const V = (L) => n(
        (S) => S.map(
          (b) => M.includes(b.id) ? { ...b, status: "error", errorMessage: L } : b
        )
      );
      try {
        const L = await c(R);
        ...
        n(
          (S) => S.map((b) => {
            const y = k.findIndex((T) => T.id === b.id);
            return y === -1 ? b : L[y] ? {
              ...b,
              status: "uploaded",
              uploadedFile: L[y]
        ...
        const S = L instanceof Error && L.message ? L.message : l.ai.fileUploadError;
        V(S);
      }
    },
    [
...
function g4({
  ...
  const [i, a] = j(!1), [l, c] = j(""), [f, u] = j([]), [h, C] = j(!1), [g, p] = j(0), [w, v] = j([]), x = I(-1), H = I(null), N = I(0), R = I(-1);
  Y(() => {
    if (!o) {
      a(!1);
      return;
    ...
    if (y.atIndex === R.current)
      return;
    x.current = y.atIndex, c(y.query), a(!0), p(0), C(!0), H.current && clearTimeout(H.current);
    const T = ++N.current;
    return H.current = setTimeout(() => {
      o(y.query).then((D) => {
        T === N.current && (u(D), p(0), D.length === 0 && y.query.length > 0 && (R.current = y.atIndex, a(!1)));
      }).catch(() => {
        T === N.current && u([]);
      }).finally(() => {
        T === N.current && C(!1);
  ...
  const k = q(() => {
    ...
    (y) => {
      const T = x.current;
      if (T === -1) return;
      const D = `${y.firstName} ${y.lastName}`.trim(), O = String(y.id), Z = e.slice(0, T), z = e.slice(n), W = `@${D} `, U = Z + W + z, $ = Z.length + W.length;
      t(U), v((X) => [...X.filter((se) => !(se.id === O && se.name === D)), { id: O, name: D }]), k(), requestAnimationFrame(() => {
        const X = s.current;
        X && (X.focus(), X.setSelectionRange($, $));
      });
    },
    [e, n, t, s, k]
  ), V = q(
    (y) => {
      ...
      switch (y.key) {
        ...
        case "Tab": {
          const T = f[g];
          if (T) {
            const D = `${T.firstName} ${T.lastName}`.trim();
            if (l.length === 0 || D.toLowerCase().startsWith(l.toLowerCase()))
              return y.preventDefault(), M(T), !0;
          }
          return !1;
        }
        case "Enter":
          return y.preventDefault(), f[g] && M(f[g]), !0;
        default:
          return !1;
      }
    },
    ...
    (y) => {
      ...
      let T = y;
      const D = [...w].sort((O, Z) => Z.name.length - O.name.length);
      for (const O of D) {
        const Z = `@${O.name}`, z = `<entity-ref type="person" id="${st(O.id)}">${st(O.name)}</entity-ref>`;
        for (; T.includes(Z); )
          T = T.replace(Z, z);
      }
      return T;
  ...
  Y(() => {
    v(
      (y) => y.filter((T) => {
        const D = `@${T.name}`, O = e.indexOf(D);
        if (O === -1) return !1;
        const Z = e[O + D.length];
        return Z === " " || Z === `
` || Z === "	";
      })
    );
  ...
  const S = te(() => {
    ...
    const y = s.current;
    if (!y) return null;
    const T = f4(y, x.current), D = y.offsetLeft + T.left, Z = (y.offsetParent ? y.offsetParent.offsetHeight : 0) - (y.offsetTop + T.top);
    return { left: D, bottom: Z };
  }, [i, e, n, s]), b = te(() => {
...
const p4 = /[\\`*_{}[\]()#+\-.!|~>]/g, m4 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(p4, "\\$&")).join(""), a3 = ({
  onSubmit: e,
  onStop: t,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const M = ee(), V = Le(), [L, S] = j(""), [b, y] = j(0), [T, D] = j(!1), [O, Z] = j(!1), [z, W] = j(null), U = I(null), $ = I(null), X = I(null), J = a != null, { tracking: se } = Re(), de = q(
    (ne, be) => {
    ...
    const be = pe.current, p1 = be && !/\s$/.test(be) ? " " : "", Ke = `${be}${p1}${ne}`;
    S(Ke), y(Ke.length);
  }, []), Ve = {
    ...
    onError: (ne) => ie(Ve[ne])
  }), Te = !!C && ve.isSupported, l1 = q(() => {
    pe.current = L, ve.start();
  }, [L, ve]);
  Y(() => {
    typeof window < "u" && window.location.hash.length === 0 && $.current?.focus();
  }, []), Y(() => {
    if (p)
      return p((ne) => {
        B(ne);
  ...
  const qe = ve.status === "recording", d1 = qe ? M.ai.listening : M.ai.inputPlaceholder, u1 = ce.filter((ne) => ne.status === "uploaded"), Ae = ce.some((ne) => ne.status === "uploading"), Xe = ce.some((ne) => ne.status === "error"), Pe = L.trim().length > 0;
  Y(() => {
    if (!(!O || Ae)) {
      if (Z(!1), Xe) {
        ie(M.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const f1 = async (ne) => {
    if (ne.preventDefault(), !J) {
      if (Q.close(), n)
        ...
        const be = Q.transformMentions(L.trim()), p1 = m4(be), Ke = u1.flatMap(
          (q1) => q1.uploadedFile ? [q1.uploadedFile] : []
        ), G1 = l, W1 = f;
        G1 && c?.(null), W1 && u?.(null), await e({
          text: p1,
          files: Ke,
          context: G1,
          quote: W1
    ...
    y($.current?.selectionStart ?? 0);
  }, Ye = () => {
    X.current && $.current && (X.current.scrollTop = $.current.scrollTop);
  }, je = z ? z.prompt ?? z.title : null, z1 = qe ? [M.ai.listening] : je ? [je] : s ?? [], Rn = z1.length > 1, Nn = te(() => t4(L, Q.mentions, {
    cursorPosition: b,
    inlineCompletion: Q.inlineCompletion
  }), [L, Q.mentions, b, Q.inlineCompletion]), Fn = Q.mentions.length > 0 || Q.inlineCompletion !== null;
  return /* @__PURE__ */ d("div", { ref: k, className: "flex flex-col items-center gap-2 px-4 pb-3 pt-2", children: [
    /* @__PURE__ */ d("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
      x && N && N.length > 0 && R && /* @__PURE__ */ r(
        e4,
        {
          suggestions: N,
          onItemClick: de,
      ...
      /* @__PURE__ */ r(W2, { creditWarning: i, children: /* @__PURE__ */ d(
        oe.form,
        {
          "aria-busy": n,
          ref: U,
          ...
          children: [
            ...
            /* @__PURE__ */ r(ye, { initial: !1, children: J ? /* @__PURE__ */ r(
              oe.div,
              {
                ...
                children: [
                    ...
                    oe.div,
                    {
                      ...
                      children: /* @__PURE__ */ d(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ r("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ r(Us, { type: "critical", size: "sm" }) }),
                  ...
                  /* @__PURE__ */ r(
                    K2,
                    {
                      ...
                      onCursorUpdate: g1,
                      onScroll: Ye,
                      highlightSegments: Nn,
                      hasOverlay: Fn,
                      multiplePlaceholders: Rn,
                      placeholders: z1,
    ...
    /* @__PURE__ */ r(ye, { mode: "wait", initial: !1, children: J ? /* @__PURE__ */ d(
      oe.div,
      {
      ...
      oe.div,
      {
        ...
        children: [
          ...
          ) : /* @__PURE__ */ r(le, { className: "text-sm font-medium text-f1-foreground-tertiary", children: w.text }),
    ...
    /* @__PURE__ */ r(ye, { children: v && x && /* @__PURE__ */ r(
      oe.div,
      {
        className: E(
...
function x4({ ...e }) {
  return /* @__PURE__ */ r(
    ...
    {
      ...e,
      className: E("my-3 border-0 border-t border-f1-border", e.className)
    }
  );
}
function k4({
...
function b4({
  ...
  return /* @__PURE__ */ r(cr, { ...t, variant: "link", href: t.href, children: e });
}
function L4({
  children: e,
  ...t
...
function M4({
  ...
  return /* @__PURE__ */ r("li", { ...t, className: E("mb-2", t.className), children: e });
}
...
function S4({
  ...
  return /* @__PURE__ */ r("p", { ...t, className: E("text-base font-normal", t.className), children: e });
}
function V4({
  children: e,
  ...t
...
function H4({
  ...
  return /* @__PURE__ */ r("strong", { ...t, className: E("font-semibold", t.className), children: e });
}
function B4({
  children: e,
  ...t
}) {
  return /* @__PURE__ */ r("em", { ...t, className: E("italic", t.className), children: e });
}
function Ie({
  id: e,
  trigger: t,
  ...
  const i = I(/* @__PURE__ */ new Map()), [a, l] = j(
    () => i.current.get(e) ?? null
  ), [c, f] = j(!1), [u, h] = j(!1), C = I(!0);
  Y(() => () => {
    C.current = !1;
  }, []);
  const g = q(() => {
    ...
    f(!0), h(!1), n(e).then((v) => {
      i.current.set(e, v), C.current && l(v);
    }).catch(() => {
      C.current && h(!0);
    }).finally(() => {
      C.current && f(!1);
  ...
  return /* @__PURE__ */ d(
    Gs,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ws, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          qs,
          {
            side: "top",
            ...
            children: c ? /* @__PURE__ */ r(X1.Skeleton, {}) : /* @__PURE__ */ r(X1, { ...p })
          }
        )
      ]
    }
...
Xr.displayName = "CandidateTrigger";
function $4({
  id: e,
  label: t
}) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.candidate, s = ee(), i = n?.urls?.candidate?.(e), a = te(
    () => (c) => {
      const f = [];
...
Yr.displayName = "ExpenseTrigger";
function I4({ id: e, label: t }) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.expense, s = ee(), i = n?.urls?.expense?.(e), a = te(
    () => (c) => ({
      avatar: {
        type: "icon",
        icon: Mr
...
Kr.displayName = "JobPostingTrigger";
function P4({
  id: e,
  label: t
}) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.jobPosting, s = ee(), i = n?.urls?.jobPosting?.(e), a = te(
    () => (c) => ({
      title: c.title,
...
Qr.displayName = "RequisitionTrigger";
function D4({
  id: e,
  label: t
}) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.requisition, s = ee(), i = n?.urls?.requisition?.(e), a = te(
    () => (c) => {
...
Jr.displayName = "PersonTrigger";
function _4({ id: e, label: t }) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.person, s = ee(), i = n?.urls?.person?.(e), a = te(
    () => (c) => ({
      avatar: {
        type: "person",
        firstName: c.firstName,
...
en.displayName = "VacancyTrigger";
function O4({ id: e, label: t }) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.vacancy, s = ee(), i = n?.urls?.vacancy?.(e), a = te(
    () => (c) => ({
      title: c.name,
...
function F1(e) {
  return typeof e == "string" ? e : typeof e == "number" ? String(e) : Array.isArray(e) ? e.map(F1).join("") : e && typeof e == "object" && "props" in e ? F1(e.props.children) : "";
}
function z4({
  type: e,
  id: t,
...
}, tn = Sn.forwardRef(({ animate: e = "normal", ...t }, n) => /* @__PURE__ */ d(
  "svg",
  {
    ref: n,
    viewBox: "0 0 24 24",
...
tn.displayName = "CheckCircleLineAnimated";
const rn = 60, nn = 40, it = 2e3, Y4 = 500, K4 = 12e3, on = 2, Ze = 40, He = [255, 60, 0], w1 = [160, 140, 220], x1 = { x: -12, y: 0, z: 0 }, k1 = { x: -12, y: 12, z: 90 }, Be = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, b1 = Math.PI / 180, Q4 = on / 8 * Math.PI, J4 = 4 * Math.PI;
function o1(e, t) {
  return [
...
function sn(e, t, n) {
  const o = Ue(1, 0, 0, e * b1), s = Ue(0, 1, 0, t * b1), i = Ue(0, 0, 1, n * b1);
  return e6(o1(o1(s, o), i));
}
function t6(e) {
...
const ze = 256, r6 = (() => {
  ...
  for (let t = 0; t < ze; t++) {
    const n = t / (ze - 1), o = Math.round(He[0] + (w1[0] - He[0]) * n), s = Math.round(He[1] + (w1[1] - He[1]) * n), i = Math.round(He[2] + (w1[2] - He[2]) * n);
    e[t] = `rgb(${o},${s},${i})`;
  }
  return e;
})();
...
const o6 = Object.keys(Be).map(Number).sort((e, t) => e - t);
function s6(e) {
  const t = o6;
...
const ct = Math.sqrt(rn ** 2 + nn ** 2), L1 = [rn / ct, nn / ct, 0], i6 = sn(x1.x, x1.y, x1.z), a6 = sn(k1.x, k1.y, k1.z), $e = on * 3, e1 = Ze + 1, lt = ($e + 1) * e1, s1 = 4 * $e * Ze, y1 = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
], c6 = (e, t) => e.avgZ - t.avgZ;
function l6() {
  const e = new Array(s1);
  for (let n = 0; n < s1; n++)
    e[n] = { points: "", color: "", avgZ: 1 / 0 };
  const t = new Array(lt);
  for (let n = 0; n < lt; n++)
    t[n] = { x: 0, y: 0, z: 0, t: 0 };
  return { quads: e, grid: t };
}
function dt(e, t, n, o) {
  const { quads: s, grid: i } = e, a = n * 0.392, l = n / 2, c = n / 2, f = Q4 * s6(n), u = t * J4, h = Ue(0, 0, 1, o * 2 * Math.PI);
  at(h, L1[0], L1[1], L1[2], Ne);
  const C = Ue(Ne[0], Ne[1], Ne[2], u), g = o1(C, i6), p = o1(C, a6);
  y1[0] = g, y1[1] = p;
  let w = 0;
  for (let v = 0; v < 4; v++) {
    const x = y1[v >> 1], H = v & 1 ? -1 : 1;
    for (let N = 0; N <= $e; N++) {
      const R = H * (Math.PI / 2 - N / $e * f), k = Math.cos(R), M = Math.sin(R), V = Math.sin(N / $e * Math.PI), L = N * e1;
      for (let S = 0; S <= Ze; S++) {
        const b = S / Ze * Math.PI * 2;
        at(x, k * Math.cos(b), M, k * Math.sin(b), Ne);
        const y = i[L + S];
        y.x = Ne[0], y.y = Ne[1], y.z = Ne[2], y.t = V;
      }
    }
    for (let N = 0; N < $e; N++) {
      const R = N * e1, k = (N + 1) * e1;
      for (let M = 0; M < Ze; M++) {
        const V = i[R + M], L = i[R + M + 1], S = i[k + M], b = i[k + M + 1];
        if ((V.t + L.t + S.t + b.t) * 0.25 < 1e-3) continue;
        const T = (V.x + L.x + S.x + b.x) * 0.25, D = (V.y + L.y + S.y + b.y) * 0.25, O = (V.z + L.z + S.z + b.z) * 0.25, Z = T * a, z = D * a, W = V.x * a - Z, U = V.y * a - z, $ = Math.sqrt(W * W + U * U), X = $ > 0 ? ($ + 0.9) / $ : 1, J = l + Z + W * X, se = c - z - U * X, de = L.x * a - Z, ce = L.y * a - z, K = Math.sqrt(de * de + ce * ce), re = K > 0 ? (K + 0.9) / K : 1, ue = l + Z + de * re, ge = c - z - ce * re, F = b.x * a - Z, B = b.y * a - z, A = Math.sqrt(F * F + B * B), _ = A > 0 ? (A + 0.9) / A : 1, P = l + Z + F * _, G = c - z - B * _, ie = S.x * a - Z, Q = S.y * a - z, pe = Math.sqrt(ie * ie + Q * Q), xe = pe > 0 ? (pe + 0.9) / pe : 1, Ve = l + Z + ie * xe, ve = c - z - Q * xe, Te = s[w];
        Te.points = `${J},${se} ${ue},${ge} ${P},${G} ${Ve},${ve}`, Te.color = n6((T + 1) * 0.5), Te.avgZ = O, w++;
      }
    }
  }
  for (let v = w; v < s1; v++)
...
const d6 = ({ size: e = 20, className: t, style: n, variant: o = "default" }, s) => {
  const i = I(null), a = I(null), l = I(null);
  l.current === null && (l.current = l6());
  const c = te(() => new Array(s1).fill(0), []), f = (u) => {
  ...
  return Y(() => {
    ...
    let p = null, w = 0, v = 0, x = 0, H = null, N = "spin", R = !0, k = !1;
    const M = (y) => {
      const T = g.quads;
      ...
      let T = 0, D = !0;
      if (o === "continuous") {
        const W = it * 2, U = (y - w) % W / W;
        T = U < 0.5 ? U * 2 : (1 - U) * 2, D = !1;
      } else N === "spin" ? (T = Math.min((y - w) / it, 1), T >= 1 && (T = 0, N = "pause", x = y)) : (T = 0, y - x >= Y4 && (N = "spin", w = y));
      const O = (y - v) / K4 % 1, Z = D ? t6(T) : T, z = dt(g, Z, e, O);
      M(z), p = requestAnimationFrame(V);
    }, L = () => {
    ...
    "div",
    {
      ...
      role: "progressbar",
      "aria-label": "Loading",
      className: E("shrink-0 globe-spin-anim", t),
...
an.displayName = "ChatSpinner";
const ut = {
  initial: { opacity: 0 },
  animate: { opacity: 1 },
  exit: { opacity: 0 }
}, S1 = ({ title: e, status: t, inGroup: n }) => {
  const s = {
    duration: Le() ? 0 : 0.18,
    ease: [0.33, 1, 0.68, 1]
  ...
  return /* @__PURE__ */ d("div", { className: "flex w-full items-start gap-1 text-f1-foreground-secondary", children: [
    /* @__PURE__ */ r("div", { className: "flex h-5 w-6 shrink-0 items-center justify-start", children: /* @__PURE__ */ d(ye, { mode: "wait", children: [
      ...
      (a || c) && /* @__PURE__ */ r("div", { className: "flex h-5 w-5 shrink-0 items-center justify-center", children: /* @__PURE__ */ r(an, { variant: a ? "default" : "continuous" }) }),
      l && /* @__PURE__ */ r(
        oe.div,
        {
          ...ut,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ r(ur, { module: e.module, size: "lg" }),
          e?.type === "file" && /* @__PURE__ */ r(Ys, { file: e.file, size: "lg" }),
...
cn.displayName = "F0CanvasCard";
const U1 = i1(null);
function d3({
  children: e
}) {
  const [t, n] = j(0), o = I([]), s = q(
    (a) => {
  ...
  return /* @__PURE__ */ r(U1.Provider, { value: i, children: e });
}
function u6(e) {
  const n = We(U1)?.formatters;
...
const ft = 7, f6 = 625, ht = /* @__PURE__ */ new Set();
function h6(e) {
...
function p6(e) {
  const { days: t, hours: n, minutes: o, seconds: s } = Qs(e), i = [];
...
function ln(e, t) {
  ...
  if (t === "duration" && typeof e == "number")
    return { type: "item", text: p6(e) };
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const n = e.value;
    return { type: "item", text: (n ? h6(n) : "") || "—" };
  }
  if (t === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: n, to: o } = e, s = gt(n) ? pt(n) : String(n), i = gt(o) ? pt(o) : String(o);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((o) => {
      const s = ln(o);
      return Array.isArray(s) ? s.map(mt).join(", ") : mt(s);
    }).filter(Boolean).join(", ") || "—" };
...
function dn({
  ...
  const { canvasContent: c, openCanvas: f, closeCanvas: u } = Re(), h = u6(e), C = l ?? h, g = I(() => {
  ...
  g.current = x, Y(() => {
    typeof window > "u" || window.innerWidth < f6 || ht.has(e) || (ht.add(e), g.current());
  }, [e]);
  const H = i && a ? Object.entries(i).map(([k, M]) => {
    const V = a[k], L = C?.(k, V, {
      fieldType: M.fieldType,
      customFieldName: M.customFieldName
    });
    if (!L && M.fieldType === "custom" && typeof V == "object" && V !== null)
      return null;
    const S = L ?? ln(V, M.fieldType), b = ["richtext", "textarea"];
    return {
      label: M.label,
      content: S,
      verticalLayout: b.includes(M.fieldType ?? "")
    };
  }).filter((k) => {
    if (!k) return !1;
    const M = Array.isArray(k.content) ? k.content[0] : k.content;
    return !(M?.type === "item" && M.text === "—");
  }) : [], N = H.slice(0, ft), R = H.length > ft;
  return /* @__PURE__ */ r(
    cn,
    {
...
dn.displayName = "FormCard";
function m6() {
  const e = Js(), t = e?.activeForm;
  if (!t) return null;
...
const Ct = 8, _e = 8;
function fn({ anchor: e, onReply: t }) {
  const n = ee(), o = I(null), [s, i] = j(
    null
  );
  if (jt(() => {
    if (!e) {
    ...
    let C = e.rect.top - f - Ct;
    C < _e && (C = e.rect.bottom + Ct), C = Math.min(
      Math.max(C, _e),
      h - f - _e
    );
...
const hn = i1(void 0), f3 = () => We(hn), w6 = (e) => /* @__PURE__ */ r(fr, { content: e, format: "markdown" }), x6 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const l = typeof n?.content == "string" ? n.content : "", c = (n && o?.(n)) ?? n?.generativeUI?.() ?? null, f = n?.toolCalls?.[0]?.id, u = !l && !c, h = I(null), { anchor: C, clear: g } = un({
    containerRef: h,
    enabled: !!(n?.id && l)
  });
  return Y(() => {
    n?.id && !t && !e && i?.(n);
  }, [n, t, e, i]), !t && !e && u ? null : /* @__PURE__ */ r(hn.Provider, { value: f, children: /* @__PURE__ */ d("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    n && l && /* @__PURE__ */ r(
      "div",
      {
        ref: h,
  ...
  const [s, i] = j(""), a = ee(), { title: l, label: c, placeholder: f } = n === "like" ? a.ai.feedbackModal.positive : a.ai.feedbackModal.negative, u = q(() => {
    t(o, s);
  }, [s, o, t]), h = () => {
    e(o);
  };
...
}, gn = i1(null), b6 = ({ children: e }) => {
  const [t, n] = j(null), o = t ? {
    isOpen: !0,
  ...
  return /* @__PURE__ */ r(gn.Provider, { value: o, children: e });
}, pn = () => {
  const e = We(gn);
  if (e === null)
    throw new Error(
...
const y6 = ({
  ...
  const o = ee(), { open: s } = pn(), [i, a] = j(null);
  ...
  const [l, c] = j(s), f = Le(), u = o !== void 0, h = u ? o : l;
  return /* @__PURE__ */ d(
    hr,
    {
        ...
        /* @__PURE__ */ d(
          gr,
          {
            ...
            children: [
              ...
              !a && /* @__PURE__ */ r(ae, { icon: a1 })
            ]
          }
        ),
        /* @__PURE__ */ r(pr, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ r(
          oe.div,
          {
            initial: !1,
            animate: {
  ...
  return /* @__PURE__ */ r(
    M6,
    {
      ...
      onOpenChange: a,
      lockOpen: n,
      children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pb-4", children: e.map((h, C) => /* @__PURE__ */ d("div", { className: "relative", children: [
        /* @__PURE__ */ r(
          S1,
          {
            title: h,
...
const mn = (e) => /* @__PURE__ */ r(fr, { content: e, format: "markdown" }), F6 = ({
  text: e,
  renderMarkdown: t
}) => /* @__PURE__ */ d("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ r("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ r(ae, { icon: O1 }) }),
  /* @__PURE__ */ r("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (t ?? mn)(e) })
] }), S6 = ({
  message: e,
  onReplyQuote: t,
  ...
  const a = e.rawData, l = N6(
    e?.content,
    a
  ), c = (R6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = c.length > 0, { anchor: h, clear: C } = un({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ r(F6, { text: f, renderMarkdown: o }),
...
}, V6 = 35, T6 = 22, A6 = 400, H6 = 2500, B6 = 220, $6 = ({ messages: e, onClick: t }) => {
  const [n, o] = j(0), [s, i] = j(0), [a, l] = j("starting"), c = e[n] ?? "";
  Y(() => {
    e.length > 0 && n >= e.length && (o(0), i(0), l("starting"));
  }, [e.length, n]), Y(() => {
    let h;
    if (a === "starting")
      h = setTimeout(() => l("writing"), A6);
    else if (a === "writing")
      s < c.length ? h = setTimeout(() => i((C) => C + 1), V6) : l("holding");
    else if (a === "holding") {
      if (e.length <= 1) return;
      h = setTimeout(() => l("erasing"), H6);
    } else a === "erasing" && (s > 0 ? h = setTimeout(() => i((C) => C - 1), T6) : h = setTimeout(() => {
      o((C) => (C + 1) % e.length), l("starting");
    }, B6));
    return () => {
      h && clearTimeout(h);
    };
...
function I6({
  ...
  const [a, l] = j(0), [c, f] = j(!1), u = I(s), h = I(i);
  h.current = i;
  const C = q(
    (p = "smooth") => {
  ...
  const g = q(() => {
    const p = e.current;
    if (!p) return;
    const { scrollTop: w, scrollHeight: v, clientHeight: x } = p, H = v - w - x;
    f(H > x);
  }, [e]);
  return Y(() => {
    const p = e.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!p || !w) return;
        const v = p.getBoundingClientRect(), x = w.getBoundingClientRect(), H = p.scrollTop + (x.top - v.top);
        p.scrollTo({ top: H, behavior: "smooth" });
      });
    }), s === 0 && f(!1), u.current = s;
  }, [s, o, e]), { showScrollBtn: c, turnMinHeight: a, scrollToBottom: C };
}
const P6 = {
  threadId: "",
  onThumbsUp: () => {
...
}, h3 = (e) => /* @__PURE__ */ r(b6, { children: /* @__PURE__ */ r(j6, { ...e }) }), j6 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: H, handleSubmit: N, handleClose: R } = L6(
    u ?? P6
  ), k = ee(), M = p ?? x6, V = w ?? S6, L = te(() => {
    const $ = o ?? k.ai.defaultInitialMessage;
    return (Array.isArray($) ? $ : [$]).filter((J) => typeof J == "string" && J.length > 0);
  }, [o, k.ai.defaultInitialMessage]), S = !t && e.length === 0 && L.length > 0, b = I(null), y = I(null), T = I(null), D = I(null), O = I(null), { showScrollBtn: Z, turnMinHeight: z, scrollToBottom: W } = I6({
    viewportRef: b,
    contentRef: y,
    endRef: T,
    lastTurnRef: O,
    ...
    const J = X === e.length - 1, se = {
      ...
      const ue = J && re === $.assistantMessages.length - 1, ge = $.userMessages.length + re, F = {
        message: K,
        inProgress: $.isInProgress,
        index: ge,
        isCurrentMessage: ue,
      ...
      return /* @__PURE__ */ r(
        ...
        {
          ...F,
          isGenerating: $.isInProgress && ue,
          isLoading: $.isInProgress && ue && !K.content
        },
        `${X}-a-${re}`
      );
    };
    return /* @__PURE__ */ d(
      "div",
      {
        ...
        style: {
          minHeight: J && z || void 0
        },
        children: [
          $.userMessages.map(
            (K, re) => de(K, re)
          ),
          $.thinking && $.thinking.titles.length > 0 && /* @__PURE__ */ r(
            E6,
            {
              titles: $.thinking.titles,
              title: k.ai.thoughtsGroupTitle,
              inProgress: $.thinking.inProgress,
              isWriting: $.thinking.isWriting
            }
          ),
          $.assistantMessages.map(
            (K, re) => ce(K, re)
          ),
          $.endIndicator === "thinking" && /* @__PURE__ */ r(S1, { title: k.ai.thinking, status: "executing" }),
          $.endIndicator === "activity" && /* @__PURE__ */ r(S1, { status: "writing" }),
          $.feedback && /* @__PURE__ */ r(
            y6,
            {
              content: $.feedback.content,
              targetMessage: $.feedback.targetMessage,
              onCopy: x
            }
          ),
          J && /* @__PURE__ */ r(m6, {})
  ...
  return /* @__PURE__ */ d(ke, { children: [
    /* @__PURE__ */ d("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
          ...
          children: /* @__PURE__ */ d(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { ref: D, className: "h-px shrink-0", "aria-hidden": !0 }),
      ...
      !C && !S && /* @__PURE__ */ d(ke, { children: [
        /* @__PURE__ */ r(vt, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ r(vt, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    H.isOpen && /* @__PURE__ */ r(
      k6,
...
}, D6 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ d("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ r("div", { className: "flex justify-end", children: /* @__PURE__ */ r(he, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ r(he, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ r(he, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ r(he, { className: "h-5 w-4/5 rounded-md" })
] }) }), g3 = {
  ai: vi.ai
}, Cn = i1(null);
function p3({
  ...
  return /* @__PURE__ */ r(Cn.Provider, { value: t, children: e });
}
function m3() {
  const e = We(Cn);
  if (e === null)
...
const O6 = ({
  ...
  const C = ee().ai.clarifyingQuestion.typeYourAnswer, g = e === "single" ? /* @__PURE__ */ r(vn, { isSelected: n && !t }) : /* @__PURE__ */ r(
    mr,
    {
      checked: s,
      onCheckedChange: () => f(!s),
...
const U6 = ({
  ...
  const x = Le(), H = (() => {
    ...
    const V = n.findIndex((L) => o.includes(L.id));
    return V >= 0 ? V : 0;
  })(), [N, R] = j(H), k = I([]);
  Y(() => {
    h && e === "single" && k.current[N]?.focus();
  }, []);
  const M = (V) => {
    if (e !== "single") return;
    const L = n.length - 1;
    ...
    V.preventDefault(), R(S), k.current[S]?.focus();
  };
  return /* @__PURE__ */ d(
    "div",
    {
  ...
  const n = ee(), o = Le(), {
    ...
    allowCustomAnswer: R,
    customAnswerText: k,
    isCustomAnswerActive: M
  } = s, V = I(null), L = H ?? "single", S = a > 1, b = i === 0, y = i === a - 1, T = S ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  }) : void 0, D = x.length > 0, O = (k ?? "").trim().length > 0, Z = D || M && O || N === !0, z = t === !0 && y, W = () => {
    z || c();
  }, U = () => {
    z || f();
  }, $ = (K) => {
    const re = L === "single" && x.includes(K);
    l(K), L === "single" && !y && !re && Promise.resolve().then(c);
  }, X = y ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, J = N === !0 && !D && !(M && O), se = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-col", onKeyDown: de, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(ye, { mode: "wait", initial: !1, children: /* @__PURE__ */ d(
      oe.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ce, ease: G6 },
        children: [
          /* @__PURE__ */ r(
            z6,
            {
...
function wt(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), l = Math.min(i + o, s), c = Math.min(l, Math.floor(e / 2)), f = Math.min(l, Math.floor(t / 2)), u = (se) => se / e * 2 - 1, h = (se) => se / t * 2 - 1, C = 0, g = e, p = 0, w = t, v = c, x = e - c, H = f, N = t - f, R = u(C), k = u(g), M = h(p), V = h(w), L = u(v), S = u(x), b = h(H), y = h(N), T = 0, D = 0, O = 1, Z = 1, z = c / e, W = 1 - c / e, U = f / t, $ = 1 - f / t, X = new Float32Array([
    // Top strip
    R,
    M,
    k,
...
function X6(e, t, n) {
  const o = xt(e, e.VERTEX_SHADER, t), s = xt(e, e.FRAGMENT_SHADER, n), i = e.createProgram();
...
class w3 {
  ...
  resize(t, n, o) {
    ...
    const { gl: s, program: i, vao: a, positionBuffer: l, uvBuffer: c, uResolution: f } = this.glr, u = o ?? this.options.ratio ?? window.devicePixelRatio ?? 1, h = Math.max(1, Math.floor(t * u)), C = Math.max(1, Math.floor(n * u));
    this.canvas.style.width = `${t}px`, this.canvas.style.height = `${n}px`, (this.canvas.width !== h || this.canvas.height !== C) && (this.canvas.width = h, this.canvas.height = C), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
    const { positions: g, uvs: p } = wt(
      this.canvas.width,
      this.canvas.height,
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: a, uvs: l } = wt(
      s,
      i,
    ...
    const C = t.getUniformLocation(n, "uResolution"), g = t.getUniformLocation(n, "uTime"), p = t.getUniformLocation(n, "uBorderWidth"), w = t.getUniformLocation(n, "uGlowWidth"), v = t.getUniformLocation(n, "uBorderRadius"), x = t.getUniformLocation(n, "uColors"), H = t.getUniformLocation(n, "uGlowExponent"), N = t.getUniformLocation(n, "uGlowFactor");
    ...
    const R = (this.options.colors || Q6).map(J6);
    for (let k = 0; k < R.length; k++)
      t.uniform3f(
        t.getUniformLocation(n, `uColors[${k}]`),
        ...R[k]
      );
...
const kt = ["lowp", "mediump", "highp"], e9 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, t9 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
    vec2 uv = fragCoord/iResolution.xy;
    vec3 col = 0.5 + 0.5*cos(iTime+uv.xyx+vec3(0,2,4));
    fragColor = vec4(col,1.0);
}`, bt = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, Lt = "iTime", yt = "iTimeDelta", Mt = "iDate", Et = "iFrame", Rt = "iMouse", Nt = "iResolution", r9 = "iChannel", Ft = "iChannelResolution", St = "iDeviceOrientation";
function n9(e, t) {
...
}, M1 = 9729, Vt = 9728, c9 = 9987, Tt = 33071, At = 10497;
class l9 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const h = 0, C = n.RGBA, g = 1, p = 1, w = 0, v = n.RGBA, x = n.UNSIGNED_BYTE, H = new Uint8Array([255, 255, 255, 0]), N = n.createTexture();
    ...
    async function R() {
      return new Promise((V, L) => {
        ...
        S.crossOrigin = "anonymous", S.onload = () => {
          ...
          L(new Error(Me(`failed loading url: ${o}`)));
        }, S.src = o ?? "";
      });
    }
    let k = await R(), M = (k.width & k.width - 1) === 0 && (k.height & k.height - 1) === 0;
    return (t.wrapS !== Tt || t.wrapT !== Tt || t.minFilter !== Vt && t.minFilter !== M1) && !M && (k = this.makePowerOf2(k), M = !0), n.bindTexture(n.TEXTURE_2D, N), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, c), n.texImage2D(
      n.TEXTURE_2D,
      h,
      C,
      v,
      x,
      k
    ), M && t.minFilter !== Vt && t.minFilter !== M1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || At
    ), n.texParameteri(
      ...
      this.magFilter || M1
    ), this._webglTexture = N, this.source = k, this.isVideo = !1, this.isLoaded = !0, this.width = k.width || 0, this.height = k.height || 0, this;
  };
}
const Me = (e) => `react-shaders: ${e}`, Ht = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, Bt = (e, t, n) => e * (1 - n) + t * n, d9 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function u9({
  fs: e,
  vs: t = bt,
  textures: n = [],
  ...
  const g = I(null), p = I(null), w = I(null), v = I(null), x = I(void 0), H = I(void 0), N = I(!1), R = I(void 0), k = I(0), M = I([0, 0]), V = I([]), L = I(0), S = I(void 0), b = I({
    [Lt]: { type: "float", isNeeded: !1, value: 0 },
    [yt]: { type: "float", isNeeded: !1, value: 0 },
    [Mt]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [Rt]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [Nt]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    [Et]: { type: "int", isNeeded: !1, value: 0 },
    [St]: {
      type: "vec4",
      isNeeded: !1,
      value: [0, 0, 0, 0]
    ...
    const A = "width" in F ? F.width ?? 0 : 0, _ = "height" in F ? F.height ?? 0 : 0, P = b.current.iChannelResolution;
    if (!P) return;
    const G = Array.isArray(P.value) ? P.value : P.value = [];
    G[B * 3] = A * f, G[B * 3 + 1] = _ * f, G[B * 3 + 2] = 0;
  }, D = () => {
    ...
    const [B = 0, A = 0] = Ht(F), _ = B - (R.current?.left ?? 0) - window.pageXOffset, P = (R.current?.height ?? 0) - A - (R.current?.top ?? 0) - window.pageYOffset;
    N.current = !0;
    const G = Array.isArray(b.current.iMouse?.value) ? b.current.iMouse.value : void 0;
    G && (G[2] = _, G[3] = P), M.current[0] = _, M.current[1] = P;
  }, W = (F) => {
    R.current = g.current?.getBoundingClientRect();
    const [B = 0, A = 0] = Ht(F), _ = B - (R.current?.left ?? 0), P = (R.current?.height ?? 0) - A - (R.current?.top ?? 0);
    if (c !== 1)
      M.current[0] = _, M.current[1] = P;
    else {
      const G = Array.isArray(b.current.iMouse?.value) ? b.current.iMouse.value : void 0;
      G && (G[0] = _, G[1] = P);
    }
  }, U = () => {
    const F = Array.isArray(b.current.iMouse?.value) ? b.current.iMouse.value : void 0;
    F && (F[2] = 0, F[3] = 0);
  }, $ = () => {
    const F = p.current;
    if (!F) return;
    R.current = g.current?.getBoundingClientRect();
    const B = f, A = Math.floor(
      (R.current?.width ?? 1) * B
    ), _ = Math.floor(
      (R.current?.height ?? 1) * B
    );
    if (F.canvas.width = A, F.canvas.height = _, b.current.iResolution?.isNeeded && v.current) {
    ...
    if (!_) return null;
    if (A.shaderSource(_, B), A.compileShader(_), !A.getShaderParameter(_, A.COMPILE_STATUS)) {
      C?.(Me(`Error compiling the shader:
${B}`));
    ...
    const A = p.current;
    if (!A) return;
    const _ = X(A.FRAGMENT_SHADER, F), P = X(A.VERTEX_SHADER, B);
    if (v.current = A.createProgram(), !(!v.current || !P || !_)) {
      ...
      A.useProgram(v.current), x.current = A.getAttribLocation(
        v.current,
        "aVertexPosition"
      ), A.enableVertexAttribArray(x.current);
    }
  }, se = () => {
    if (o)
      for (const F of Object.keys(o)) {
        const B = o[F];
        if (!B) continue;
        const { value: A, type: _ } = B, P = a9(_);
        if (!P) continue;
        const G = {};
        if (n9(_, A)) {
          const ie = _.length, Q = Number.parseInt(_.charAt(ie - 3)), pe = Math.floor(A.length / (Q * Q));
          A.length > Q * Q && (G.arraySize = `[${pe}]`);
        } else o9(_, A) && (G.arraySize = `[${Math.floor(A.length / Number.parseInt(_.charAt(0)))}]`);
        b.current[F] = {
          type: P,
          isNeeded: !1,
          value: A,
      ...
      if (n && n.length > 0) {
        ...
        const B = n.map(
          (A, _) => (b.current[`${r9}${_}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, T(A, _), V.current[_] = new l9(F), V.current[_]?.load(A).then((P) => {
            T(P, _);
          }))
        );
        Promise.all(B).then(() => {
    ...
    const B = kt.includes(i ?? "highp"), A = `precision ${B ? i : kt[1]} float;
`;
    B || C?.(
      Me(
...
`).concat(F.replace(/texture\(/g, "texture2D("));
    for (const G of Object.keys(b.current))
      if (F.includes(G)) {
...
`,
    ...
    return F.includes("mainImage") && (_ = _.concat(e9)), _;
  }, K = (F) => {
    const B = p.current;
    if (!B || !v.current) return;
    const A = L.current ? (F - L.current) / 1e3 : 0;
    L.current = F;
    const _ = y.current;
    if (_)
      for (const P of Object.keys(_)) {
        const G = _[P];
        if (G && b.current[P]?.isNeeded) {
          if (!v.current) return;
          const ie = B.getUniformLocation(
            v.current,
            P
          );
          if (!ie) return;
    ...
    if (b.current.iMouse?.isNeeded) {
      const P = B.getUniformLocation(
        v.current,
        Rt
      );
      B.uniform4fv(P, b.current.iMouse.value);
    }
    ...
    if (b.current.iDate?.isNeeded) {
      const P = /* @__PURE__ */ new Date(), G = P.getMonth() + 1, ie = P.getDate(), Q = P.getFullYear(), pe = P.getHours() * 60 * 60 + P.getMinutes() * 60 + P.getSeconds() + P.getMilliseconds() * 1e-3, xe = B.getUniformLocation(
        v.current,
        Mt
      );
      B.uniform4fv(xe, [Q, G, ie, pe]);
    }
    if (b.current.iFrame?.isNeeded) {
      const P = B.getUniformLocation(
        v.current,
        Et
      ), G = b.current.iFrame.value;
      B.uniform1i(P, G), b.current.iFrame.value = G + 1;
    }
    if (V.current.length > 0)
      for (let P = 0; P < V.current.length; P++) {
        const G = V.current[P];
        if (!G) return;
        const { isVideo: ie, _webglTexture: Q, source: pe, flipY: xe, isLoaded: Ve } = G;
        if (!Ve || !Q || !pe) return;
        if (b.current[`iChannel${P}`]?.isNeeded) {
          if (!v.current) return;
          const ve = B.getUniformLocation(
            v.current,
            `iChannel${P}`
          );
          B.activeTexture(B.TEXTURE0 + P), B.bindTexture(B.TEXTURE_2D, Q), B.uniform1i(ve, P), ie && G.updateTexture(
            Q,
            pe,
            xe
          );
    ...
    B.viewport(0, 0, B.drawingBufferWidth, B.drawingBufferHeight), B.clear(B.COLOR_BUFFER_BIT | B.DEPTH_BUFFER_BIT), B.bindBuffer(B.ARRAY_BUFFER, w.current), B.vertexAttribPointer(
      ...
      0,
      0
    ), K(F), B.drawArrays(B.TRIANGLE_STRIP, 0, 4);
    const A = b.current.iMouse?.value;
    if (b.current.iMouse?.isNeeded && c !== 1 && Array.isArray(A)) {
      const _ = A[0] ?? 0, P = A[1] ?? 0;
      A[0] = Bt(_, M.current[0] ?? 0, c), A[1] = Bt(P, M.current[1] ?? 0, c);
    }
    H.current = requestAnimationFrame(re);
  }, ue = () => {
    const F = { passive: !0 };
    b.current.iMouse?.isNeeded && g.current && (g.current.addEventListener("mousemove", W, F), g.current.addEventListener("mouseout", U, F), g.current.addEventListener("mouseup", U, F), g.current.addEventListener("mousedown", z, F), g.current.addEventListener("touchmove", W, F), g.current.addEventListener("touchend", U, F), g.current.addEventListener("touchstart", z, F)), b.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      Z,
      F
    ), g.current && (S.current = new ResizeObserver($), S.current.observe(g.current), window.addEventListener("resize", $, F));
  }, ge = () => {
    const F = { passive: !0 };
    b.current.iMouse?.isNeeded && g.current && (g.current.removeEventListener("mousemove", W, F), g.current.removeEventListener("mouseout", U, F), g.current.removeEventListener("mouseup", U, F), g.current.removeEventListener("mousedown", z, F), g.current.removeEventListener("touchmove", W, F), g.current.removeEventListener("touchend", U, F), g.current.removeEventListener("touchstart", z, F)), b.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      Z,
      F
    ), S.current && (S.current.disconnect(), window.removeEventListener("resize", $, F));
  };
  return Y(() => {
    y.current = o;
  }, [o]), Y(() => {
    ...
    function B() {
      D();
      const A = p.current;
      A && g.current && (A.clearColor(...s), A.clearDepth(1), A.enable(A.DEPTH_TEST), A.depthFunc(A.LEQUAL), A.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, se(), de(), J(ce(e || t9), t || bt), O(), requestAnimationFrame(re), ue(), $());
    }
    return requestAnimationFrame(B), () => {
      ...
      ge(), cancelAnimationFrame(H.current ?? 0);
    };
  }, []), /* @__PURE__ */ r(
    "canvas",
    {
...
}`, h9 = 10, g9 = 2, p9 = 0.5, m9 = 0.2, C9 = 1.5, we = {
  duration: 0.5,
  ease: "easeOut"
}, $t = {
  duration: 0.35,
...
function v9(e, t) {
  const [n, o] = j(h9), {
    ...
    animate: i,
    motionValue: a
  } = Qe(m9), { value: l, animate: c } = Qe(g9), { value: f, animate: u } = Qe(p9), { value: h, animate: C } = Qe(C9), g = wi(t, {
    fftSize: 512,
  ...
  return Y(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        o(10), i(0.2, we), c(1.2, we), u(0.4, we), C(1, we);
        return;
      case "listening":
      case "pre-connect-buffering":
        o(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, we), u(0.7, we), C([1.5, 2], $t);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        o(30), i(0.3, we), c(0.5, we), u(1, we), C([0.5, 2.5], $t);
        return;
      case "speaking":
        o(70), i(0.3, we), c(0.75, we), u(1.25, we), C(1.5, we);
        return;
    }
  }, [
    e,
...
function xn({
  ...
  const g = te(() => x9(a), [a]);
  return /* @__PURE__ */ r("div", { ref: u, className: h, ...C, children: /* @__PURE__ */ r(
    u9,
    {
      fs: f9,
...
function x3({
  ...
  const { speed: f, scale: u, amplitude: h, frequency: C, brightness: g } = v9(t, s);
  return /* @__PURE__ */ r(
    xn,
    {
      ref: l,
...
const k3 = ({
  ...
  const o = ee(), s = Le();
  return /* @__PURE__ */ d(ke, { children: [
    e && /* @__PURE__ */ r("span", { className: E(b9(), "truncate"), children: e }),
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: E(kn()), children: t }),
    /* @__PURE__ */ d(
      oe.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ d("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ r("span", { className: E(Je()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ r(
            oi,
            {
          ...
          o === "alert" && /* @__PURE__ */ r(ii, { text: e.alertLabel, level: e.level }),
          o === "balance" && /* @__PURE__ */ r(M9, { balance: e.balance })
        ]
      }
    ),
    n && !y9.has(o) && /* @__PURE__ */ r(
      oe.span,
      {
        className: E(Je()),
        animate: { opacity: s ? 0 : 1 },
...
const N9 = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), F9 = ({
  label: e,
  direction: t
}) => {
  const n = bn[t];
  ...
  const s = `sparkline-gradient-${Dt().replace(/:/g, "")}`, i = R9(e, n), a = bn[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(ci, { width: "100%", height: "100%", children: /* @__PURE__ */ d(
          li,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ r(di, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                ui,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ r(F9, { label: t, direction: i })
      ]
    }
  ) });
}, Ln = m(
  (e, t) => {
    const {
      ...
      className: c,
      ...f
    } = e, [u, h] = j(!1), [C, g] = j(!1), p = u || C, w = Le(), v = p && !!l, x = {
      duration: w ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, H = () => {
      a?.();
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: E(kn()), children: o }),
              /* @__PURE__ */ r(
                oe.div,
                {
...
Ln.displayName = "F0AiInsightCardInternal";
const V9 = ["className"], yn = m((e, t) => {
  const n = V9.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
  return /* @__PURE__ */ r(Ln, { ref: t, ...n });
});
yn.displayName = "F0AiInsightCard";
const T9 = () => /* @__PURE__ */ d(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ r(he, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ d("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ r(he, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ r(he, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ d("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ r(he, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ r(he, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], Mn = 180, A9 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Mn, H9 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, B9 = (e) => e.showActions !== !1, $9 = (e) => Object.fromEntries(
...
function I9(e) {
  const {
    ...
    description: i,
    seeMoreLabel: a,
    maxCollapsedDescriptionLength: l = Mn
  } = e, [c, f] = j(!1), u = Dt(), h = I(null), C = A9(
    l
  ), g = i.length > C, p = c ? i : H9(i, C), w = B9(e) ? e : null, v = $9(e);
  return Y(() => {
    c && h.current?.focus();
  }, [c]), /* @__PURE__ */ d(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          t && /* @__PURE__ */ r(ur, { module: t, size: "lg" }),
...
I9.displayName = "F0AiProposalCard";
const P9 = ({
  icon: e,
  title: t,
  children: n
  ...
  return /* @__PURE__ */ d(
    hr,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ d(gr, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, j9 = (e) => r2[e] ?? Kt, D9 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(ae, { icon: j9(e), size: "md", color: "default" }) }) : null;
function _9({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(P9, { icon: H1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(D9, { iconName: s.icon });
...
function Z9({
  ...
  const o = ee(), s = I(null), i = t ?? o.ai.aiTable.title, a = q(
    (l) => {
      if (!s.current) return;
  ...
  return e.columns?.length ? /* @__PURE__ */ d(
    m1,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r(m1, { overflowX: "auto", children: /* @__PURE__ */ d(
          "table",
          {
            ref: s,
            className: E(
...
function U9({ credits: e }) {
  const t = ee(), [n, o] = j(!1), [s, i] = j(!1), [a, l] = j(!1), [c, f] = j(null), u = q(
    (g) => {
  ...
  if (!e) return null;
  const h = c ? Math.min(100, Math.round(c.used / c.total * 100)) : 0, C = e.companyName;
  return /* @__PURE__ */ d($1, { open: n, onOpenChange: u, children: [
    /* @__PURE__ */ r(I1, { asChild: !0, children: /* @__PURE__ */ r(
      fe,
      {
        variant: "ghost",
        hideLabel: !0,
    ...
    /* @__PURE__ */ d(
      P1,
      {
        ...
        children: [
          C && /* @__PURE__ */ d("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            /* @__PURE__ */ r(
              j1,
              {
                name: e.companyName ?? "",
...
const z9 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function G9({
  employeeCredits: e
}) {
  const t = ee(), n = Le(), [o, s] = j(!1), [i, a] = j(!1), [l, c] = j(!1), [f, u] = j(null), h = q(
    (w) => {
  ...
  if (!e) return null;
  const C = !!e.companyName, g = f && f.total > 0 ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, p = f ? Math.max(0, f.total - f.used) : 0;
  return /* @__PURE__ */ d($1, { open: o, onOpenChange: h, children: [
    /* @__PURE__ */ r(I1, { asChild: !0, children: /* @__PURE__ */ r(
      fe,
      {
        variant: "ghost",
...
const It = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(G9, { employeeCredits: t }) : e ? /* @__PURE__ */ r(U9, { credits: e }) : null, y3 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const C = ee(), g = or(`(max-width: ${fi.md}px)`, {
    ...
    fe,
    {
      variant: "ghost",
      hideLabel: !0,
      label: o ? C.ai.collapseChat : C.ai.expandChat,
      icon: o ? Jt : Qt,
      onClick: i
    }
  ), w = /* @__PURE__ */ r(
        ...
        /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ r(
          Ge,
          {
            ...
            children: /* @__PURE__ */ d("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ r(le, { lines: 1, className: "min-w-0 text-left", children: n ?? C.ai.newConversation }),
              /* @__PURE__ */ r(ae, { icon: A1, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ d(
  ...
  ) : /* @__PURE__ */ d("header", { className: E("flex justify-between px-4 py-3"), children: [
...
function W9() {
  if (!(typeof navigator > "u"))
    return pi(navigator.language);
}
function q9(e) {
  const t = new Date(e), n = /* @__PURE__ */ new Date();
  return Cr(t) ? "today" : vr(t) ? "yesterday" : hi(t, n) ? "thisMonth" : "older";
}
function X9(e, t) {
  const n = new Date(e), o = W9(), s = Y1(n, "p", { locale: o });
  if (Cr(n)) return `${t.today}, ${s}`;
  if (vr(n)) return `${t.yesterday}, ${s}`;
  const i = !gi(n, /* @__PURE__ */ new Date());
  return `${Y1(n, i ? "MMM d yyyy" : "MMM d", {
    locale: o
  })}, ${s}`;
}
function Y9(e) {
      ...
      children: [
        /* @__PURE__ */ d(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ r(le, { lines: 1, className: "text-left font-medium", children: e.title }),
        ...
        /* @__PURE__ */ r(
          "div",
          {
            ...
            children: /* @__PURE__ */ r(c1, { items: l, children: /* @__PURE__ */ r(
              me,
              {
                icon: Yt,
                variant: "ghost",
...
const M3 = ({
  ...
  const g = te(
    ...
    return o.filter((V) => V.title.toLowerCase().includes(M));
  }, [o, h]), w = te(
    () => p.filter((M) => a.has(M.id)),
    [p, a]
  ), v = te(
    () => p.filter((M) => !a.has(M.id)),
    [p, a]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ d("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ r(ae, { icon: H1, color: "secondary", size: "md" }),
                  /* @__PURE__ */ r(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-1 overflow-y-auto p-2", children: [
                  /* @__PURE__ */ r(
                    Ge,
                    {
                      ...
                      children: /* @__PURE__ */ d("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ r(ae, { icon: _1, color: "default", size: "md" }),
                  ...
                  !s && !i && !k && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: u.ai.noPreviousChats }),
...
function E3({
  ...
  const [o, s] = j([]), [i, a] = j(!1), [l, c] = j(null), [f, u] = j(J9), h = q(async () => {
    a(!0), c(null);
    try {
      const w = await t();
      s(w);
  ...
  const C = q((w) => {
    u((v) => {
      const x = new Set(v);
      return x.add(w), E1(x), x;
    });
  }, []), g = q((w) => {
    u((v) => {
      const x = new Set(v);
      return x.delete(w), E1(x), x;
    });
  }, []), p = q(
    async (w) => {
      try {

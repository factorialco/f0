...
function Lr(e, t) {
  return $n(e) ? e[Ri(0, e.length, t)] : e;
}
function Ni(e, t, n) {
...
function Hi(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let g = 0; g < e.length; g++) {
    ...
    const N = (R, E, L, V = 0, b = 0) => {
      const T = Bi(R), { delay: k = 0, times: y = jn(T), type: A = "keyframes", repeat: j, repeatType: _, repeatDelay: Z = 0, ...G } = E;
      ...
      if (le > 0 && _n(y, le), T.length === 1 && T.unshift(null), j) {
        Ut(j < Ai, "Repeat count too high, must be less than 20"), U = Ei(U, j);
        const se = [...T], re = [...y];
      ...
      const de = Q + U;
      Fi(L, T, q, y, Q, de), S = Math.max(z + U, S), m = Math.max(de, m);
    };
    if (Zt(w)) {
      const R = et(w, l);
      N(v, x, tt("default", R));
...
function Ui(e, t, n) {
  const o = [];
  return Hi(e, t, n, { spring: Jn }).forEach(({ keyframes: i, transition: a }, l) => {
    o.push(...yr(l, i, a));
  }), o;
}
class zi {
...
function qi(e) {
  function t(n, o, s) {
    let i = [];
    return Wi(n) ? i = Ui(n, o, e) : i = yr(n, o, s, e), new Gi(i);
  }
  return t;
}
...
const kl = (e, t) => /* @__PURE__ */ d(
...
), o2 = C(n2), s2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Ki,
  Add: eo,
  Ai: to,
  ...
  Wifi: o2,
  Windows: Bs
}, Symbol.toStringTag, { value: "Module" })), i2 = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const De = Se({
  ...
  ({
    ...
    const h = s ?? l2[t ?? "body"], m = c ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (i !== void 0) {
...
const E2 = Se({
  ...
  ({
    ...
    const Pe = O && O !== "none" || J && J !== "none" || Q && Q !== "none" || le && le !== "none", h1 = z && z !== "none" || Pe, g1 = { sm: d1, md: qe, lg: u1, xl: f1 }, p1 = R2.map((Ye) => {
      const je = g1[Ye];
      return je ? M2(Ye, je) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
}), v1 = { sm: 640, md: 768, "container-md": 448 }, F1 = (e) => "type" in e && e.type === "separator", n1 = (e) => "type" in e && e.type === "split", F2 = (e) => !("type" in e), o1 = (e, t, n) => /* @__PURE__ */ r(
  me,
  {
    label: e.label,
    icon: e.icon,
...
function rt({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: { gap: s },
      children: p ? /* @__PURE__ */ r(V2, { ...R }, "row") : /* @__PURE__ */ r(S2, { ...R }, "stacked")
    }
  );
}
function S2({
    ...
    const N = !!p && p.visible !== !1, R = /* @__PURE__ */ d(
      lr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d("div", { className: T2[x], children: [
...
const P2 = ({ compact: e = !1 }) => /* @__PURE__ */ r(
  lr,
  {
    className: M(
  ...
  cr(Yr, P2)
), d3 = ["xs", "sm", "md", "lg"], D2 = 2, st = 2, _2 = 70, it = 0.08, O2 = 6, Z2 = 0.6, U2 = () => {
  ...
  return Y(() => {
    ...
    const c = () => {
      ...
      s(
        Math.max(1, Math.floor((u + st) / (D2 + st)))
      );
    };
    ...
    const h = new Uint8Array(u.fftSize), m = setInterval(() => {
      ...
      const p = Math.sqrt(g / h.length), w = Math.min(1, Math.pow(p * O2, Z2));
      a((v) => {
        ...
        a && /* @__PURE__ */ d(
          j1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: r4(a.items).map((l, c) => /* @__PURE__ */ d(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
const s4 = 250, i4 = 12e4, a4 = () => typeof navigator < "u" && !!navigator.mediaDevices?.getUserMedia && typeof MediaRecorder < "u";
function c4({
  onTranscribe: e,
  onPartial: t,
  onFinal: n,
  ...
  const [i, a] = P("idle"), [l, c] = P(0), [f] = P(a4), [u, h] = P(null), m = $(null), g = $(null), p = $([]), w = $(null), v = $(!1), x = $(null), S = $(null), N = $(0), R = $({ onTranscribe: e, onPartial: t, onFinal: n, onError: o });
  ...
  const E = X(() => {
    ...
    m.current = y, y.ondataavailable = (A) => {
      ...
      L();
    }, y.start(s4), N.current = Date.now(), a("recording"), c(0), x.current = setInterval(() => {
...
` || Z === "	";
  ...
  const T = te(() => {
    ...
    const y = s.current;
    if (!y) return null;
    const A = p4(y, x.current), j = y.offsetLeft + A.left, Z = (y.offsetParent ? y.offsetParent.offsetHeight : 0) - (y.offsetTop + A.top);
...
const v4 = /[\\`*_{}[\]()#+\-.!|~>]/g, w4 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(v4, "\\$&")).join(""), u3 = ({
  onSubmit: e,
  onStop: t,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const h1 = async (ne) => {
    if (ne.preventDefault(), !J) {
      if (K.close(), n)
        ...
        const be = K.transformMentions(b.trim()), m1 = w4(be), Qe = f1.flatMap(
  ...
  }, je = G ? G.prompt ?? G.title : null, G1 = qe ? [L.ai.listening] : je ? [je] : s ?? [], Fn = G1.length > 1, Sn = te(() => o4(b, K.mentions, {
    cursorPosition: k,
    ...
    oe.div,
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ r(Y2, { creditWarning: i, children: /* @__PURE__ */ d(
            oe.form,
            {
              "aria-busy": n,
              ref: U,
...
const on = 60, sn = 40, ct = 2e3, J4 = 500, e6 = 12e3, an = 2, Ze = 40, He = [255, 60, 0], x1 = [160, 140, 220], k1 = { x: -12, y: 0, z: 0 }, b1 = { x: -12, y: 12, z: 90 }, Be = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, L1 = Math.PI / 180, t6 = an / 8 * Math.PI, r6 = 4 * Math.PI;
function s1(e, t) {
  return [
...
const a6 = Object.keys(Be).map(Number).sort((e, t) => e - t);
function c6(e) {
  const t = a6;
...
const dt = Math.sqrt(on ** 2 + sn ** 2), y1 = [on / dt, sn / dt, 0], l6 = cn(k1.x, k1.y, k1.z), d6 = cn(b1.x, b1.y, b1.z), $e = an * 3, t1 = Ze + 1, ut = ($e + 1) * t1, i1 = 4 * $e * Ze, M1 = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
], u6 = (e, t) => e.avgZ - t.avgZ;
function f6() {
...
function ft(e, t, n, o) {
  const { quads: s, grid: i } = e, a = n * 0.392, l = n / 2, c = n / 2, f = t6 * c6(n), u = t * r6, h = Ue(0, 0, 1, o * 2 * Math.PI);
  lt(h, y1[0], y1[1], y1[2], Re);
  const m = Ue(Re[0], Re[1], Re[2], u), g = s1(m, l6), p = s1(m, d6);
  M1[0] = g, M1[1] = p;
  let w = 0;
  for (let v = 0; v < 4; v++) {
    ...
    for (let N = 0; N < $e; N++) {
      ...
      for (let L = 0; L < Ze; L++) {
        ...
        Te.points = `${J},${Q} ${ie},${ue} ${I},${W} ${Ve},${ve}`, Te.color = i6((A + 1) * 0.5), Te.avgZ = _, w++;
      }
    }
  }
  for (let v = w; v < i1; v++)
...
const h6 = ({ size: e = 20, className: t, style: n, variant: o = "default" }, s) => {
  const i = $(null), a = $(null), l = $(null);
  l.current === null && (l.current = f6());
  ...
  return Y(() => {
    ...
    const L = (y) => {
      ...
      } else N === "spin" ? (A = Math.min((y - w) / ct, 1), A >= 1 && (A = 0, N = "pause", x = y)) : (A = 0, y - x >= J4 && (N = "spin", w = y));
      const _ = (y - v) / e6 % 1, Z = j ? o6(A) : A, G = ft(g, Z, e, _);
...
const gt = 7, p6 = 625, pt = /* @__PURE__ */ new Set();
function m6(e) {
...
function un(e, t) {
  ...
  if (t === "duration" && typeof e == "number")
    return { type: "item", text: v6(e) };
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const n = e.value;
    return { type: "item", text: (n ? m6(n) : "") || "—" };
  }
  ...
  return { type: "item", text: C6(String(e)) };
}
function fn({
  formName: e,
  formDescription: t,
  ...
  const { canvasContent: c, openCanvas: f, closeCanvas: u } = Ee(), h = g6(e), m = l ?? h, g = $(() => {
  ...
  g.current = x, Y(() => {
    typeof window > "u" || window.innerWidth < p6 || pt.has(e) || (pt.add(e), g.current());
  }, [e]);
...
const pn = a1(void 0), m3 = () => We(pn), b6 = (e) => /* @__PURE__ */ r(gr, { content: e, format: "markdown" }), L6 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
...
const vn = (e) => /* @__PURE__ */ r(gr, { content: e, format: "markdown" }), T6 = ({
  text: e,
  renderMarkdown: t
  ...
  const a = e.rawData, l = V6(
    e?.content,
    a
  ), c = (S6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = c.length > 0, { anchor: h, clear: m } = hn({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ r(T6, { text: f, renderMarkdown: o }),
...
}, H6 = 35, B6 = 22, $6 = 400, I6 = 2500, P6 = 220, j6 = ({
  messages: e,
  onClick: t,
  fullscreen: n = !1
}) => {
  ...
  Y(() => {
    ...
    let m;
    if (l === "starting")
      m = setTimeout(() => c("writing"), $6);
    else if (l === "writing")
      i < f.length ? m = setTimeout(() => a((g) => g + 1), H6) : c("holding");
    else if (l === "holding") {
      if (e.length <= 1) return;
      m = setTimeout(() => c("erasing"), I6);
    } else l === "erasing" && (i > 0 ? m = setTimeout(() => a((g) => g - 1), B6) : m = setTimeout(() => {
...
const _6 = {
...
}, C3 = (e) => /* @__PURE__ */ r(M6, { children: /* @__PURE__ */ r(O6, { ...e }) }), O6 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: N, handleSubmit: R, handleClose: E } = E6(
    u ?? _6
  ), L = ee(), V = w ?? L6, b = v ?? A6, T = te(() => {
    const O = o ?? L.ai.defaultInitialMessage;
    return (Array.isArray(O) ? O : [O]).filter((Q) => typeof Q == "string" && Q.length > 0);
  }, [o, L.ai.defaultInitialMessage]), k = !t && e.length === 0 && T.length > 0, y = $(null), A = $(null), j = $(null), _ = $(null), Z = $(null), { showScrollBtn: G, turnMinHeight: q, scrollToBottom: U } = D6({
    viewportRef: y,
    contentRef: A,
    endRef: j,
    lastTurnRef: Z,
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-col", onKeyDown: le, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(Fe, { mode: "wait", initial: !1, children: /* @__PURE__ */ d(
      oe.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: de, ease: X6 },
        children: [
          /* @__PURE__ */ r(
            q6,
            {
...
class L3 {
  ...
  setupGL() {
    ...
    const R = (this.options.colors || t9).map(r9);
...
const Lt = ["lowp", "mediump", "highp"], n9 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, o9 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, Mt = "iTime", Et = "iTimeDelta", Rt = "iDate", Nt = "iFrame", Ft = "iMouse", St = "iResolution", s9 = "iChannel", Vt = "iChannelResolution", Tt = "iDeviceOrientation";
function i9(e, t) {
...
}, E1 = 9729, At = 9728, u9 = 9987, Ht = 33071, Bt = 10497;
class f9 {
  gl;
  url;
  wrapS;
...
}, It = (e, t, n) => e * (1 - n) + t * n, h9 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function g9({
  fs: e,
  vs: t = yt,
  textures: n = [],
      ...
      if (n && n.length > 0) {
        ...
        const B = n.map(
          (H, D) => (k.current[`${s9}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, A(H, D), V.current[D] = new f9(F), V.current[D]?.load(H).then((I) => {
            A(I, D);
          }))
        );
        Promise.all(B).then(() => {
...
`,
    ...
    return F.includes("mainImage") && (D = D.concat(n9)), D;
  }, se = (F) => {
    const B = p.current;
  ...
  return Y(() => {
    ...
    function B() {
      j();
      const H = p.current;
      H && g.current && (H.clearColor(...s), H.clearDepth(1), H.enable(H.DEPTH_TEST), H.depthFunc(H.LEQUAL), H.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, Q(), le(), J(de(e || o9), t || yt), _(), requestAnimationFrame(re), ie(), z());
    }
...
}`, m9 = 10, C9 = 2, v9 = 0.5, w9 = 0.2, x9 = 1.5, we = {
  duration: 0.5,
  ease: "easeOut"
}, Pt = {
  duration: 0.35,
...
function k9(e, t) {
  const [n, o] = P(m9), {
    ...
    animate: i,
    motionValue: a
  } = Je(w9), { value: l, animate: c } = Je(C9), { value: f, animate: u } = Je(v9), { value: h, animate: m } = Je(x9), g = yi(t, {
    fftSize: 512,
...
function y3({
  ...
  const { speed: f, scale: u, amplitude: h, frequency: m, brightness: g } = k9(t, s);
  return /* @__PURE__ */ r(
    bn,
    {
      ref: l,
...
const M3 = ({
  ...
  const o = ee(), s = Le();
  return /* @__PURE__ */ d(ke, { children: [
    e && /* @__PURE__ */ r("span", { className: M(M9(), "truncate"), children: e }),
    ...
    /* @__PURE__ */ d(
      oe.div,
      {
        ...
        children: [
          ...
          o === "balance" && /* @__PURE__ */ r(N9, { balance: e.balance })
        ]
      }
    ),
    n && !R9.has(o) && /* @__PURE__ */ r(
      oe.span,
      {
        className: M(e1()),
        animate: { opacity: s ? 0 : 1 },
...
const V9 = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), T9 = ({
  label: e,
  direction: t
}) => {
  const n = yn[t];
  ...
  const s = `sparkline-gradient-${Ot().replace(/:/g, "")}`, i = S9(e, n), a = yn[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r(T9, { label: t, direction: i })
      ]
    }
  ) });
}, Mn = C(
...
const H9 = ["className"], En = C((e, t) => {
  const n = H9.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
...
const B9 = () => /* @__PURE__ */ d(
  ...
  "balance",
  "sparkline"
], Rn = 180, $9 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Rn, I9 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, P9 = (e) => e.showActions !== !1, j9 = (e) => Object.fromEntries(
...
function D9(e) {
  ...
  } = e, [c, f] = P(!1), u = Ot(), h = $(null), m = $9(
    l
  ), g = i.length > m, p = c ? i : I9(i, m), w = P9(e) ? e : null, v = j9(e);
  return Y(() => {
    c && h.current?.focus();
  }, [c]), /* @__PURE__ */ d(
    "section",
...
D9.displayName = "F0AiProposalCard";
const _9 = ({
  icon: e,
  title: t,
  children: n
...
}, O9 = (e) => s2[e] ?? Jt, Z9 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(ce, { icon: O9(e), size: "md", color: "default" }) }) : null;
function U9({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(_9, { icon: B1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
U9.displayName = "F0AiMessageSources";
async function z9(e, t, n) {
  const o = await import("./xlsx-Bedf3nwD.js"), s = o.utils.table_to_book(e, { sheet: "Data" });
  o.writeFile(s, `${n}.${t}`);
}
function G9({
...
const jt = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(X9, { employeeCredits: t }) : e ? /* @__PURE__ */ r(W9, { credits: e }) : null, N3 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const m = ee(), g = ir(`(max-width: ${Ci.md}px)`, {
...
function K9(e) {
  ...
  return wr(t) ? "today" : xr(t) ? "yesterday" : vi(t, n) ? "thisMonth" : "older";
}
function Q9(e, t) {
  const n = new Date(e), o = Y9(), s = Q1(n, "p", { locale: o });
...
function S3({
  ...
  const [o, s] = P([]), [i, a] = P(!1), [l, c] = P(null), [f, u] = P(r3), h = X(async () => {
    a(!0), c(null);
    try {
      const w = await t();
      s(w);

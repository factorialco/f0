import { DataSource, FiltersDefinition, FiltersState, GroupingDefinition, OnSelectItemsCallback, PaginationInfo, RecordType, SelectedItemsState, SelectionId, SortingsDefinition } from '../types';
...
export type UseSelectableProps<R extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, Grouping extends GroupingDefinition<R>> = {
    data: Data<R>;

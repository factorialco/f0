export type SortingsDefinition = Record<string, {
    label: string;
}>;
 ...
 */
export type SortingKey<Definition extends SortingsDefinition> = Definition extends readonly string[] ? Definition[number] : keyof Definition;
/**

...
var h = t.forwardRef(({ id: a, className: o, children: l, aspect: f, config: m, ...h }, _) => {
	...
	return n(() => {
		...
		children: /* @__PURE__ */ c("div", {
			...
			children: [/* @__PURE__ */ s(g, {
				id: y,
				config: m
			}), /* @__PURE__ */ s(u.ResponsiveContainer, {
				height: x,
...
`);
	return /* @__PURE__ */ s("style", { dangerouslySetInnerHTML: { __html: l.sanitize(r.join("\n")) } });
}, _ = u.Tooltip, v = t.forwardRef(({ active: n, payload: r, className: i, indicator: a = "dot", hideLabel: l = !1, hideIndicator: u = !1, label: d, labelFormatter: f, labelClassName: p, formatter: h, yAxisFormatter: g, color: _, nameKey: v, labelKey: y }, b) => {
...
var y = {
	strong: .4,
	faint: .05
}, b = u.Legend, x = t.forwardRef(({ className: t, hideIcon: n = !1, payload: r, verticalAlign: i = "bottom", nameKey: a, hiddenKey: o, leftShift: l = 0 }, u) => {
	let { config: d } = m();

...
import ee from "../../../../icons/app/Download.js";
import r from "../../../../icons/app/Ellipsis.js";
import te from "../../../../icons/app/InfoCircleLine.js";
import i from "../../../../icons/app/Maximize.js";
import ne from "../../../../icons/app/Minimize.js";
...
function S({ title: S, description: C, info: w, isLoading: T, error: E, onRetry: D, skeleton: ue, children: de, actions: fe = [], itemFilters: O, editMode: pe, handleDelete: k, onAskAi: A, onAskAiTarget: me, itemId: j, chartTypeOptions: M, explanation: N, isFullscreen: P = !1, descriptionAction: F, fitContent: I = !1, onFullscreenChange: L }) {
	let [R, he] = v(!1), [ge, z] = v(!1), B = _(!1), [V, H] = v(!1), U = a(), { enabled: _e, setPendingQuote: ve, setOpen: ye, focusChatInput: be } = ce(), W = (e) => {
		he(e), e || H(!1);
						...
						children: [/* @__PURE__ */ b(f, {
							...
							children: V && Y ? /* @__PURE__ */ b("div", {
								...
								Y && /* @__PURE__ */ b(u, { children: /* @__PURE__ */ b(d, {
									...
									children: /* @__PURE__ */ x("div", {
										className: "flex w-full flex-row items-center gap-2",
										children: [/* @__PURE__ */ b(t, { icon: te }), /* @__PURE__ */ b("span", {
											className: "flex-1",
								...
								q && /* @__PURE__ */ b(u, { children: /* @__PURE__ */ b(d, {
									...
									children: /* @__PURE__ */ x("div", {
										className: "flex w-full flex-row items-center gap-2",
										children: [/* @__PURE__ */ b(t, { icon: n }), /* @__PURE__ */ b("span", {
											className: "flex-1",

...
function k({ ai: e, aiPromotion: n, children: i, sidebar: s, banner: c }) {
	let { sidebarState: u, toggleSidebar: f, isSmallScreen: w, setForceFloat: T } = d(), E = r(), { open: O, visualizationMode: k, canvasContent: A, canvasEntities: j, closeCanvas: M, chatWidth: ce, resizable: le, panelSide: N, panelContent: ue, panelContentSide: P, restoringPanelContentId: F, isResizing: I } = a(), L = k === "fullscreen", R = k === "canvas", { open: z } = te(), B = le ? ce : 360, V = A?.coversChat === !0 ? 0 : B, H = N === "left", U = P !== N, W = !!(ue || F), G = (W ? P : N) === "left", K = m(L), q = L && !K.current, J = !L && K.current, [Y, X] = h(!1);
	p(() => {

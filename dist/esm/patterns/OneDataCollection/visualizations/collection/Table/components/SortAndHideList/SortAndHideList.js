...
import r from "../../../../../../../icons/app/Handle.js";
...
var g = (e) => e.locked ?? (!e.sortable && !e.canHide && !e.disabledReason), _ = (e) => !!e.sortable && !g(e), v = (e, t) => {
	...
	let E = a(), D = e("group flex items-center gap-2 text-medium text-sm pr-4", w && "pt-1", T && "pb-1"), O = h(), k = g(v), A = _(v), j = !!v.removable && !k && !!b, M = !!v.lockable && !k && !!x, N = !!v.lockable && k && !!x, P = d(null), F = d(null), I = d(null), L = d(!1), R = (e) => {
	...
	let B = /* @__PURE__ */ p("div", {
		...
		children: [
			...
			/* @__PURE__ */ f("span", {
				...
				children: /* @__PURE__ */ f(s, { children: v.label })
			}),
			(M || j) && /* @__PURE__ */ f("div", {

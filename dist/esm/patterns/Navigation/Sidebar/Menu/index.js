...
import o from "../../../../icons/app/MoveDown.js";
import s from "../../../../icons/app/MoveUp.js";
import { useI18n as c } from "../../../../lib/providers/i18n/i18n-provider.js";
import { Tooltip as l } from "../../../../experimental/Overlays/Tooltip/index.js";
import { Link as u, useNavigation as d } from "../../../../lib/linkHandler.js";
import { Counter as f } from "../../../../ui/Counter/index.js";
...
var j = ({ item: t, active: r }) => /* @__PURE__ */ D("div", {
	...
	children: [/* @__PURE__ */ D("div", {
		...
		children: [t.tag && /* @__PURE__ */ E(h, { text: t.tag }), t.badge && /* @__PURE__ */ E(f, {
			value: t.badge,
			size: "sm",
			type: "bold"
		})]
	...
	let { isActive: r } = d(), { label: i, icon: a, ...o } = n, s = r(o.href, { exact: o.exactMatch });
	return /* @__PURE__ */ E(u, {
		...o,
...
}, N = ({ item: t, tooltip: l, dragConstraints: f, onRemove: h, index: g, total: _, onMove: v, onReorderFinish: b, isSortable: x = !0 }) => {
	let O = c(), { isDragging: A, setIsDragging: j, draggedItemId: M, setDraggedItemId: N } = y(), { isActive: P } = d(), F = P(t.href, { exact: t.exactMatch }), I = C(!1), [R, z] = w(!1), B = g === 0, V = g === _ - 1, H = _ === 1, U = S(() => {
		let e = [];
		return !H && !B && e.push({
...
function I({ nonSortableItems: t, sortableItems: n, setSortableItems: r, containerRef: i, onCollapse: a, onDragEnd: o, favorites: s = [], onFavoritesChange: l, forceUpdate: u, disableDragging: d = !1 }) {
	let f = c(), { isDragging: p } = y(), m = t.some((e) => e.isRoot), h = t.filter((e) => !e.isRoot).length > 0, _ = n.length > 0, v = C(null), [T, O] = w(s), A = s.length > 0;
	x(() => {
		JSON.stringify(s) !== JSON.stringify(T) && O(s);
	}, [s]);
	let j = (e) => {
		O(e);
	}, M = b((e) => {
...
var L = ({ tooltip: e, children: t }) => e ? /* @__PURE__ */ E(l, {
	description: e,
	children: t
}) : t;
//#endregion

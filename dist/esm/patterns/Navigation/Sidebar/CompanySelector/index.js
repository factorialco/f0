...
import a from "../../../../icons/app/Circle.js";
...
function h({ companies: e, selected: t, onChange: n, isLoading: r = !1, withNotification: i = !1, additionalOptions: a = [] }) {
	let o = u(() => e.find((e) => e.id === t) || e[0], [e, t]);
	return r ? /* @__PURE__ */ p("div", {
		className: "flex w-fit items-center gap-2 p-1.5",
		children: [/* @__PURE__ */ f(s, { className: "size-6" }), /* @__PURE__ */ f(s, { className: "h-3 w-14" })]
...
var g = ({ companies: r, selected: a, onChange: s, children: c, additionalOptions: h = [] }) => {
	let g = o(), [_, v] = d(!1), y = u(() => [
		...r.map((e) => ({
			value: e.id,
			label: e.name,

...
}), h = ({ tab: r, isActive: c, showLabel: f, grow: h = !0, probe: g = !1, onClick: _ }) => {
	let v = o(), y = v ? { duration: 0 } : {
		type: "spring",
		duration: .35,
		bounce: 0
	}, b = r.variant === "ai", [x, S] = l(!1);
	return s(() => {
		if (!(b && c)) {
			S(!1);
			return;
		...
		disabled: g,
		tabIndex: g ? -1 : void 0,
		className: e(h && !g ? "flex-1" : "shrink-0", i({ variant: "ghost" }), a({ size: "md" }), t(), "hover:bg-transparent hover:shadow-none", "active:bg-transparent active:shadow-none", "data-[pressed=true]:bg-transparent data-[pressed=true]:shadow-none"),
		children: [
			x && /* @__PURE__ */ d("span", {
				"aria-hidden": "true",
			...
			r.badge && /* @__PURE__ */ u(m, {})
		]
	});
}, g = ({ tabs: e, activeTab: t, onTabChange: n, persistKey: i }) => {
	let a = r(), o = c(null), p = c(null), [m, g] = l(!1), _ = i ? `f0-sidebar-tab:${i}` : null, v = c(!1);
	s(() => {

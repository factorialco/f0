...
var m = ({ value: t, onChange: i, placeholder: a }) => /* @__PURE__ */ u("div", {
...
}), g = ({ groups: t, actions: n, searchPlaceholder: r, loading: g = !1, skeleton: _, emptyState: v, noResultsLabel: y, animateItems: b = !0, className: x }) => {
	let S = i(), [C, w] = c(""), T = r !== void 0 && C.trim().length > 0, E = t.some((e) => e.items.length > 0), D = g && !E, O = t.map((e) => ({
		...e,

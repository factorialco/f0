...
var d = ({ props: i }) => {
	let { status: a, icon: o = t, title: s, description: c } = i;
	...
	let { status: t, isLast: n = !1, hideStatus: r = !1, expanded: f, collapsible: p = !0, items: m, content: h, metadata: g, primaryAction: _, secondaryActions: v, otherActions: y } = e, b = c(), x = !p || f, S = g?.some(Boolean), C = _ || v && v.length > 0 || y && y.length > 0;
	return /* @__PURE__ */ u(s, {
		status: t,
		isLast: n,
		hideStatus: r,

...
import n from "../../../../icons/app/People.js";
...
function m({ isOpen: p, listboxId: m, results: h, isLoading: g, selectedIndex: _, position: v, onSelect: y, everyoneDescription: b }) {
	...
	return !p || h.length === 0 && !g ? null : /* @__PURE__ */ d("div", {
		...
		children: [h.map((r, o) => {
			let s = o === _, c = r.kind === "everyone" ? "@everyone" : r.user.id;
			return /* @__PURE__ */ u("div", {
				...
				onMouseDown: (e) => {
					e.preventDefault(), y(r);
				},
				children: r.kind === "everyone" ? /* @__PURE__ */ d(l, { children: [/* @__PURE__ */ u("span", {
			...
			"aria-hidden": "true",
			children: [/* @__PURE__ */ u(r, { className: "size-5 shrink-0 rounded-full" }), /* @__PURE__ */ u(r, { className: e("h-4 rounded", n === 1 ? "w-24" : "w-32") })]
		}, `skeleton-${n}`))]
	});
}
//#endregion

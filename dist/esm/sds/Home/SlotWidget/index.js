...
import { Widget as o } from "../../../experimental/Widgets/Widget/index.js";
import { Dropdown as s } from "../../../experimental/Navigation/Dropdown/index.js";
	...
	return /* @__PURE__ */ v("div", {
		...
		children: e.map((n, o) => {
			let s = d(i[n.visualization]), c = {
				...r,
				isLastSlot: o === e.length - 1
			};
			return /* @__PURE__ */ y(p, { children: [o > 0 ? /* @__PURE__ */ v("div", {
				className: "my-3",
				children: /* @__PURE__ */ v(a, { bare: !0 })
...
function T({ header: a, params: l, fullHeight: u, action: d, summaries: p, headerControls: T, headerActions: E, headerSelect: D, alert: O, status: k, slots: A, loading: j = !1, slotRenderers: M, actions: N, flipped: P = !1, onFlipBack: F, isDragging: I, ctx: L = {} }) {
	let R = r(), z = c(), [B, V] = g(!1), H = h(!1);
	m(() => {
		if (!H.current) {
			H.current = !0;
			return;
	...
	let [U, W] = g(void 0), G = D ? U ?? D.value ?? D.options[0]?.value : void 0, K = D?.options.find((e) => e.value === G), q = (e) => {
		...
		D ? /* @__PURE__ */ v(s, {
			items: D.options.map((e) => ({
				label: e.label,
				...e.value === G ? { icon: t } : e.icon ? { icon: e.icon } : {},
				onClick: () => q(e.value)
			})),
		...
		T
	] }) : T, { info: Y, ...X } = f(a, l) ?? {}, Z = Object.values(X).some((e) => e !== void 0) || N && N.length > 0 || J ? X : void 0, Q = /* @__PURE__ */ v(o, {
		header: Z,
		fullHeight: u,
		action: d,
		footerClassName: b,

...
import { Popover as a, PopoverAnchor as o, PopoverContent as s } from "../../../../ui/popover.js";
...
var C = ({ suggestions: t, onItemClick: r, onItemHover: c, side: u = "top", reserveTwoRows: d = !0, overflow: _ = "wrap" }) => {
	let [v, y] = m(null), b = p(null), x = _ === "scroll", C = l(), T = p(null), E = p(!1), D = f(), O = f(), k = v === null ? null : t[v];
	return t.length === 0 ? null : /* @__PURE__ */ g(a, {
		open: k !== null,
		onOpenChange: (e) => {
			e || (y(null), c?.(null));
		},
		children: [/* @__PURE__ */ h("div", {
			...
			children: /* @__PURE__ */ h(o, {
				...
				children: /* @__PURE__ */ h("div", {
					...
					children: t.map((e, t) => /* @__PURE__ */ h(i, {
						type: "button",
						variant: "outline",
						label: e.label,
						icon: e.icon,
						...
						onClick: (e) => {
							T.current = e.currentTarget, E.current = !1, y((e) => e === t ? null : t), c?.(null);
						}
					}, `${e.label}-${t}`))
				})
			})
			...
			children: [/* @__PURE__ */ g("div", {
				...
				children: S(k.items).map((e, t) => /* @__PURE__ */ h(w, {
					...
					onHover: c,
					onSelect: (t) => {
						r(e, k), E.current = document.activeElement === t.currentTarget, y(null), c?.(null);
					}
				}, t))
			})]
		})]
...
function w({ item: i, onSelect: a, onHover: o }) {
	let s = p(null), l = p(null), f = p(null), m = c(), _ = u(() => {
		f.current != null && (clearTimeout(f.current), f.current = null);
		let e = l.current, t = s.current;

...
var p = u({
...
}, g = l(function({ title: r, onClose: a, children: o, actions: s = [], variant: l }, u) {
	if (s.length > 2) throw Error(`F0Callout: Maximum of 2 actions allowed, but ${s.length} actions were provided.`);
	let g = s.length > 0;
	return /* @__PURE__ */ f("div", {
		...
		children: [/* @__PURE__ */ f("div", {
			...
			children: [/* @__PURE__ */ d("div", {
				...
				children: s.map((e, t) => /* @__PURE__ */ d("div", { children: /* @__PURE__ */ d(c, {
					label: e.label,
					onClick: e.onClick,
					variant: "outline",
					icon: e.icon
	...
	children: [/* @__PURE__ */ d("div", {
		className: "flex flex-row items-center justify-between px-4 py-2",
		children: /* @__PURE__ */ d(s, { className: "h-5 w-32 rounded-md" })
	}), /* @__PURE__ */ f("div", {
		className: "flex flex-col gap-[1px]",
		children: [/* @__PURE__ */ d("div", {
			...
			children: /* @__PURE__ */ f("div", {
				...
				children: [
					/* @__PURE__ */ d(s, { className: "h-4 w-full rounded-md" }),
					/* @__PURE__ */ d(s, { className: "h-4 w-3/4 rounded-md" }),
					/* @__PURE__ */ d(s, { className: "h-4 w-1/2 rounded-md" })
				]
			})
		}), !t && /* @__PURE__ */ f("div", {
			className: "flex flex-row items-center justify-between gap-3 rounded-b-[13.25px] bg-f1-background px-4 py-3",
			children: [/* @__PURE__ */ d(s, { className: "h-8 w-24 rounded-md" }), /* @__PURE__ */ d(s, { className: "h-8 w-28 rounded-md" })]
		})]
	})]
});
//#endregion

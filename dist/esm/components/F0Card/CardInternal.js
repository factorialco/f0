...
var D = _(function({ compact: r = !1, avatar: _, image: x, imageFit: S = "fit-width", imageSize: C = "sm", imageAspectRatio: T = "default", blurredBackground: D = !0, title: O, description: k, metadata: A, children: j, link: M, primaryAction: N, secondaryActions: P, otherActions: F, bookmark: I, selectable: L = !1, subtleBorder: R = !1, selected: z = !1, onSelect: B, onClick: V, forceVerticalMetadata: H = !1, fullHeight: U = !1, disableOverlayLink: W = !1, alert: G }, K) {
	let q = v(null), J = !W && (!!M || !!V), Y = (e) => {
		...
		children: [
			...
			x && /* @__PURE__ */ b("div", {
				className: e("pointer-events-none relative -mx-3 -mt-3 mb-4 rounded-md", T === "video" ? "aspect-video" : w[C], r && "-mx-2 -mt-2 mb-3", S === "fit-height" && "flex items-center justify-center overflow-hidden", S === "fit-width" && "flex items-center justify-center overflow-hidden", S !== "fit-width" && S !== "fit-height" && "overflow-hidden"),
				children: [
				...
				children: [
					/* @__PURE__ */ b("div", {
						...
						children: [/* @__PURE__ */ b(s, {
							...
							className: e("relative flex-col gap-0 p-0", x && !r && "pt-3", r && "flex-row items-center gap-2"),
							children: [_ && /* @__PURE__ */ y(m, {
								...
								children: [/* @__PURE__ */ y(l, {
									className: e("text-lg font-semibold text-f1-foreground", r && "line-clamp-1 text-base"),
									children: O
								}), k && /* @__PURE__ */ y(c, {
					...
					A && /* @__PURE__ */ y("div", {
						className: e("relative z-10 flex flex-col gap-0.5", r && "gap-x-3 gap-y-0", H && "flex-col gap-y-0.5"),
	...
	children: [/* @__PURE__ */ b(s, {
		...
		children: [/* @__PURE__ */ y(r, { className: e("h-10 w-10 rounded-full", t && "h-6 w-6") }), /* @__PURE__ */ b("div", {
			className: e("flex flex-col gap-0", t && "flex-row items-center gap-1.5"),
			children: [/* @__PURE__ */ y(l, {
				className: "flex h-6 items-center",
				children: /* @__PURE__ */ y(r, { className: e("h-4 w-20 rounded-md", t && "h-3") })
			}), /* @__PURE__ */ y(c, {
				className: "flex h-5 items-center",
				children: /* @__PURE__ */ y(r, { className: "h-3 w-12 rounded-md" })
			})]
		})]
	}), /* @__PURE__ */ y(o, {
		...
		children: Array.from({ length: 3 }).map((e, t) => /* @__PURE__ */ b("div", {
			...
			children: [/* @__PURE__ */ y(r, { className: "h-4 w-4 rounded-full" }), /* @__PURE__ */ y(r, { className: "h-3 w-full max-w-20 rounded-md" })]
		}, t))
	})]
});
//#endregion

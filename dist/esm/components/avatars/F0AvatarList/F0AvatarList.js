...
import { F0Avatar as t } from "../F0Avatar/index.js";
import { OverflowList as n } from "../../../ui/OverflowList/index.js";
import { getAvatarDisplayName as r } from "./utils.js";
import { MaxCounter as i } from "./components/MaxCounter.js";
import { avatarListSizes as a } from "./types.js";
import { useMemo as o } from "react";
import { jsx as s } from "react/jsx-runtime";
//#region src/components/avatars/F0AvatarList/F0AvatarList.tsx
var c = {
	base: {
...
}, l = ({ avatars: l, size: u = "md", type: d, noTooltip: f = !1, remainingCount: p, max: m, tooltipScroll: h, layout: g }) => {
	if (u && !a.includes(u)) {
		let e = {
			small: "sm",
			medium: "md",
		...
		console.warn(`The avatar list size: ${u} is deprecated. Use ${e[u]} instead.`), u = e[u] ?? "md";
	}
	let _ = {
		xs: -2,
		sm: -3,
	...
	return /* @__PURE__ */ s(n, {
		...
		renderListItem: (n, i) => {
			let a = r(d, n), o = n.tooltipDescription, m = !!n.badge, h = i === l.length - 1, g = /* @__PURE__ */ s("div", {
				className: "flex h-fit w-fit shrink-0 items-center justify-center",
				style: (!h || h && p !== void 0) && !m ? { clipPath: c[d === "person" ? "rounded" : "base"][u] } : void 0,
			...
			return /* @__PURE__ */ s("div", { children: f ? g : /* @__PURE__ */ s(e, {
				label: a,
				description: o,
				children: g
			}) }, i);
		...
		forceShowingOverflowIndicator: p !== void 0,
		renderOverflowIndicator: (e) => /* @__PURE__ */ s("div", {
			className: "flex h-fit w-fit items-center",
			style: { marginLeft: _ },
			children: /* @__PURE__ */ s(i, {
				count: (p ?? 0) + e,
				size: u,
				type: d === "person" ? "rounded" : "base",
				avatarType: d,
				list: p ? void 0 : l.slice(l.length - e)
			})
		}),
		overflowIndicatorWithPopover: !1
	});
};
l.displayName = "AvatarList";
//#endregion
export { l as F0AvatarList };

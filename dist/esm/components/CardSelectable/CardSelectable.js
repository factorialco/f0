...
import { F0AvatarEmoji as o } from "../avatars/F0AvatarEmoji/index.js";
import { F0AvatarFile as s } from "../avatars/F0AvatarFile/F0AvatarFile.js";
import { F0AvatarIcon as c } from "../avatars/F0AvatarIcon/index.js";
import { F0Avatar as l } from "../avatars/F0Avatar/index.js";
...
function m({ avatar: e }) {
	return e.type === "emoji" ? /* @__PURE__ */ d(o, {
		emoji: e.emoji,
		size: "md"
	}) : e.type === "file" ? /* @__PURE__ */ d(s, {
		file: e.file,
		size: "md"
	}) : e.type === "icon" ? /* @__PURE__ */ d(c, {
		icon: e.icon,
		size: "md"
	}) : /* @__PURE__ */ d(l, {
		avatar: e,
...
function v({ item: e, selected: n, disabled: i, multiple: o, onSelect: s, isToggle: c, grouped: l, compact: v }) {
	let { forms: y } = a(), b = r(), x = i || e.disabled, S = () => {
		x || s();
	}, C = c ? "switch" : o ? "checkbox" : "radio", w = () => d(c ? _ : o ? g : h, { checked: n }), T = !!e.selectedContent, E = e.moreInfoLink;
	return /* @__PURE__ */ f("div", {
		className: t("relative flex flex-1 flex-col overflow-hidden transition-colors", l ? "" : t("rounded-xl border border-solid", n && !c ? "border-f1-border-selected-bold bg-f1-background-selected-secondary" : "border-f1-border bg-f1-background hover:border-f1-border-hover"), x && "cursor-not-allowed opacity-50"),
		children: [
			/* @__PURE__ */ f("div", {
				role: C,
				"aria-checked": n,
				...
				className: t("flex cursor-pointer items-center gap-3", "focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-f1-special-ring", l ? "px-4 py-3" : v ? "p-3" : "p-4", E && "pb-0"),
				children: [
					...
					/* @__PURE__ */ d("div", {
						...
						children: /* @__PURE__ */ f("div", {
							...
							children: [/* @__PURE__ */ f("span", {
								className: t("text-base text-f1-foreground", l ? "font-medium" : "font-semibold"),
			...
			E && /* @__PURE__ */ f("div", {
				className: t("flex flex-row items-start gap-3 pt-2", l ? "px-4 pb-3" : v ? "px-3 pb-3" : "px-4 pb-4"),

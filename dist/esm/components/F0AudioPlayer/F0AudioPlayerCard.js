...
import { ScrollArea as ee } from "../../ui/scrollarea.js";
...
var y = p((p, y) => {
	let { title: b, subtitle: x, actions: S, className: se, src: ce, preload: le, autoPlay: ue = !1, disabled: C = !1, ariaLabel: w, size: T = "md", content: E, defaultLanguage: D, details: O, expanded: k, defaultExpanded: A = !1, onExpandedChange: j, detailsMaxHeight: M = 200 } = p, N = t(), P = c(ce, D), F = l({
		...p,
		src: P.resolvedSrc
	}), I = i(p), L = r(), R = (e) => {

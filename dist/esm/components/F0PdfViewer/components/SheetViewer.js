...
import { ToggleGroup as n, ToggleGroupItem as r } from "../../../deprecated/ToggleGroup/ToggleGroup.js";
import { DocumentToolbar as i, useDocumentZoom as a } from "./DocumentToolbar.js";
import { columnLetters as o, fetchWorkbook as s } from "../sheetPreview.js";
...
var p = 1e3, m = 100, h = ({ url: h, filename: g, withCredentials: _ = !0, actions: v }) => {
	let y = e(), b = a(), [x, S] = l(null), [C, w] = l(!1), [T, E] = l(0);
	c(() => {
		let e = !1;
		return S(null), w(!1), E(0), s(h, {
			maxRows: p,
			maxCols: m,
			withCredentials: _
		}).then((t) => {
	...
	let D = x ? x[Math.min(T, x.length - 1)] : null, O = D ? o(D.rows) : [];
	return /* @__PURE__ */ f("div", {
		...
		children: [/* @__PURE__ */ d(i, {
			...
			actions: v,
			zoom: b,
			children: x && x.length > 1 && /* @__PURE__ */ d(n, {
				type: "single",
				size: "sm",
				value: String(T),
				onValueChange: (e) => {
				...
				children: x.map((e, t) => /* @__PURE__ */ d(r, {
					value: String(t),

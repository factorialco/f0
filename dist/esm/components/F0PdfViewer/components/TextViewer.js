import { parseMarkdownDocument as e } from "../../../lib/markdown.js";
import { useI18n as t } from "../../../lib/providers/i18n/i18n-provider.js";
import { Skeleton as n } from "../../../ui/skeleton.js";
import { DocumentToolbar as r, useDocumentZoom as i } from "./DocumentToolbar.js";
...
var l = 2097152, u = [
	...
	let _ = t(), v = i(), [y, b] = o(null), [x, S] = o(!1);
	return a(() => {
		let e = !1;

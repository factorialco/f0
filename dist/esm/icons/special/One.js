...
//#region src/icons/special/One.tsx
var i = [
	{
		id: "bottom",
	...
	let o = e.className?.includes("text-") && !e.className?.includes("text-current") || e.style?.color !== void 0, s = t();
	return /* @__PURE__ */ r("svg", {
		...
		ref: a,
		...e,
		children: [/* @__PURE__ */ n("defs", { children: i.map((e) => /* @__PURE__ */ n("clipPath", {
			id: `${s}-${e.id}`,
			children: /* @__PURE__ */ n("path", { d: e.path })
		}, e.id)) }), o ? i.map((e) => /* @__PURE__ */ n("path", {
			d: e.path,
			fill: "currentColor"
		}, e.id)) : i.map((e) => /* @__PURE__ */ n("foreignObject", {
			x: "0",
			y: "0",
			width: "24",
			height: "24",

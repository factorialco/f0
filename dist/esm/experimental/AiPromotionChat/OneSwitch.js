...
import s from "./OneIcon.js";
import { useAiPromotionChat as c } from "./providers/AiPromotionChatStateProvider.js";
...
var p = ({ className: p, disabled: m }) => {
	let { enabled: h, setOpen: g, open: _ } = c(), v = o(), [y, b] = l(!1);
			...
			children: [/* @__PURE__ */ u(a, {
				...
				children: /* @__PURE__ */ u("div", { children: /* @__PURE__ */ u(f.Root, {
					...
					children: /* @__PURE__ */ u(f.Thumb, {
						...
						children: /* @__PURE__ */ u("div", { children: /* @__PURE__ */ u(s, {
							size: "sm",

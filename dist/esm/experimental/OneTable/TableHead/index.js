...
import i from "../../../icons/app/ArrowDown.js";
...
function h({ children: h, width: g = "auto", minWidth: _, sortState: v = "none", onSortClick: y, onClick: b, info: x, infoIcon: S = a, sticky: C, hidden: w = !1, highlighted: T = !1, align: E = "left", className: D, colSpan: O }) {
	let { isScrolled: k, isScrolledRight: A } = c(), j = C?.left !== void 0, M = C?.right !== void 0, N = j || M, P = C?.left ?? 0, F = C?.right ?? 0, I = y || x, L = y || b ? () => {
		...
		children: [typeof h == "string" ? /* @__PURE__ */ d(r, {

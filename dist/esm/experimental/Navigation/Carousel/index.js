...
import { DynamicCarousel as r } from "./DynamicCarousel/index.js";
import { Carousel as i, CarouselContent as a, CarouselControls as o, CarouselDots as s, CarouselItem as c, CarouselNext as l, CarouselPrevious as u } from "../../../ui/carousel.js";
...
var y = e(t("Carousel", ({ children: e, columns: t, showArrows: y = !0, showDots: b = !0, arrowsPlacement: x = "overlay", arrowLabels: S, paging: C, autoplay: w = !1, delay: T = 3e3, showPeek: E = !1, doubleColumns: D }) => {
	...
	return t ? /* @__PURE__ */ m(i, {
		...
		children: /* @__PURE__ */ h("div", {
			...
			children: [/* @__PURE__ */ h("div", {
				className: "relative",
				children: [/* @__PURE__ */ m(a, { children: f.Children.map(O, (e, n) => {
				...
				}) }), y && !k && /* @__PURE__ */ h(p, { children: [/* @__PURE__ */ m(u, { label: S?.previous ?? "Previous" }), /* @__PURE__ */ m(l, { label: S?.next ?? "Next" })] })]
			}), k ? /* @__PURE__ */ m(o, {
				labels: S,
				showDots: b,
				paging: C

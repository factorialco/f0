...
import { DialogPosition } from '../../../patterns/F0Dialog/types';
import { UseFileUpload } from '../../../patterns/F0Form/fields/file/types';
import { F0FormErrorTriggerMode } from '../../../patterns/F0Form/types';
import { F0ResourceHeaderProps } from '../../../patterns/F0ResourceHeader';
import { SurveyDatasets, SurveyFormBuilderElement } from '../SurveyFormBuilder/types';
...
export type SurveySubmitAnswers = Record<string, string | number | boolean | string[] | Date | null>;
...
export type SurveyAnsweringFormInlineReadonlyProps = SurveyAnsweringFormInlineProps & {
    preview?: never;
    onSubmit?: never;
};
export type SurveyAnsweringFormProps = SurveyAnsweringFormDefaultProps | SurveyAnsweringFormPreviewProps | SurveyAnsweringFormInlineReadonlyProps;

...
import { ChartColorToken } from './utils/colors';
 ...
 */
export type F0DataChartBarDataPoint = number | {
    value: number;
 ...
 */
export type F0DataChartLineDataPoint = number | {
    value: number;
};
...
interface F0DataChartBaseProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps {
 ...
 */
export interface F0DataChartFunnelProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps {
    /** Chart type */
    type: "funnel";
 ...
 * points themselves. This interface is separate from `F0DataChartBaseProps`.
 */
export interface F0DataChartPieProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps {
    /** Chart type */
    type: "pie";
 ...
 */
export interface F0DataChartRadarProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps {
    /** Chart type */
    type: "radar";
 ...
 */
export type F0DataChartScatterDataPoint = [number, number] | {
 ...
 */
export interface F0DataChartScatterProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps {
    /** Chart type */
    type: "scatter";
 ...
 */
export type F0DataChartProps = F0DataChartBarProps | F0DataChartLineProps | F0DataChartFunnelProps | F0DataChartPieProps | F0DataChartRadarProps | F0DataChartGaugeProps | F0DataChartHeatmapProps | F0DataChartScatterProps;
export {};

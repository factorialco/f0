...
import { CanvasActions, CanvasContent, CanvasContentBase, CanvasEntityDefinition, DashboardCanvasContent, DataDownloadCanvasContent, FormCanvasContent, AutofillTimesheetCanvasContent } from '../canvas/types';
import { EntityRefs } from './components/markdownRenderers/entityRef/types';
/**
...
export type { CanvasContent, CanvasContentBase, DashboardCanvasContent, DataDownloadCanvasContent, FormCanvasContent, AutofillTimesheetCanvasContent, };
...
export type { EntityResolvers, EntityUrlBuilders, EntityRefs, } from './components/markdownRenderers/entityRef/types';
/**
 ...
 */
export type TranscribeFn = (audio: Blob, options: TranscribeOptions) => Promise<string>;
/**

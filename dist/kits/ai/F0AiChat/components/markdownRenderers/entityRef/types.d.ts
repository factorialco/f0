...
import { ExpenseProfile } from './entities/expense/types';
import { JobPostingProfile } from './entities/jobPosting/types';
import { RequisitionProfile } from './entities/requisition/types';
import { PersonProfile } from './entities/person/types';
import { VacancyProfile } from './entities/vacancy/types';
/**

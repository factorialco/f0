import { CanvasActions, CanvasEntityDefinition } from '../canvas/types';
import { AiChatDisclaimer, AiChatMode, AiChatFileAttachmentConfig, AiChatTrackingOptions, CanvasContent, AiChatCredits, AiChatCreditWarning, AiChatEmployeeCredits, EntityRefs, F0AIMessage, PendingContext, PendingQuote, SidePanelContent, TranscribeFn, VisualizationMode, F0AiChatWelcomeCard, WelcomeScreenSuggestion } from './types';
/**

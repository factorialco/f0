...
import { a7 as Zr, ai as Ur, aj as zr, ak as ft, al as Gr, am as Wr, an as qr, ao as Xr, ap as Yr, aq as Kr, ar as ht, as as Qr, at as Jr, au as ne, av as en, aw as tn, ax as rn, ay as nn, az as on, aA as sn, aB as an, aC as ln, J as Ct, aD as cn, aE as dn, t as oe, aF as pt, aG as G1, x as mt, aH as un, aI as fn, aJ as hn, aK as Cn, aL as pn, aM as mn, ag as N1, aN as gn, aO as gt, aP as wn, aQ as vn, l as R1, aR as Ln, aS as xn, aT as wt, aU as bn, aV as kn, aW as yn, aX as Mn, aY as Rn, aZ as Fn, a_ as vt, a$ as Nn, b0 as Sn, b1 as Vn, b2 as Tn, b3 as Hn, b4 as An, b5 as En, b6 as $n, b7 as Bn, b8 as In, a5 as Pn, b9 as Dn, N as _n, ba as jn, bb as On, bc as Zn, bd as Un, be as zn, bf as Gn, bg as Wn, bh as qn, bi as Xn, bj as Yn, bk as Kn, bl as Qn, bm as Jn, bn as eo, bo as to, bp as ro, bq as no, br as oo, $ as Lt, bs as so, bt as ao, bu as io, bv as lo, bw as xt, _ as bt, bx as co, i as uo, by as fo, bz as ho, ad as Co, bA as po, bB as mo, bC as kt, bD as go, bE as wo, bF as vo, bG as Lo, bH as xo, bI as bo, j as ko, bJ as yt, bK as Mt, bL as yo, bM as Rt, bN as Mo, bO as se, y as Ro, bP as ae, bQ as Fo, bR as No, bS as ie, Y as So, Z as Vo, bT as Ft, bU as To, bV as Ho, bW as Ao, bX as Eo, bY as $o, bZ as Bo, a6 as Io, b_ as Po, b$ as Do, c0 as _o, c1 as Nt, c2 as jo, c3 as Oo, c4 as Zo, c5 as Uo, u as G, c6 as r1, c7 as zo, S as u1, c8 as St, s as n1, c9 as Go, w as w1, ca as Wo, cb as o1, ae as C1, ab as L1, ac as Y, cc as Vt, E as le, cd as qo, H as ce, b as y1, ce as Xo, cf as Yo, cg as Ko, d as Tt, ch as Qo, ci as Jo, cj as de, ck as es, cl as ts, cm as rs, cn as He, co as ns, cp as Ht, cq as At, cr as os, cs as ss, ct as as, cu as is, cv as ls, cw as Et, cx as cs, cy as ds, cz as us, af as E1, q as $t, r as Bt, v as It, c as J1, cA as Ae, cB as Pt, cC as fs, cD as hs, cE as B1, cF as Cs, n as ps, cG as ms, cH as ue, cI as gs, cJ as ws, cK as vs, cL as Ls, cM as xs, cN as bs, z as ks, B as ys, a3 as K1, G as Dt, a1 as Ms, a2 as Rs, cO as Ee, cP as _t, cQ as jt, cR as Fs, cS as Ns, cT as Ss, cU as Vs, cV as Ts, cW as Hs } from "./F0CanvasPanel-CNzjQ3Am.js";
import { c as b, f as f1, g as As } from "./tooltip-DVUyzeYN.js";
...
), x2 = m(L2), b2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Zs,
  Add: Zr,
  Ai: Ur,
...
`) ? n + "_" : n
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, H2).map((r) => /* @__PURE__ */ t(
  Vt,
  {
...
const B2 = 5, I2 = 46, P2 = 400, D2 = 16, _2 = 16;
function j2(e, r = B2) {
...
const O2 = ({
  ...
  const [c, d] = I(null), l = $(null), f = a === "scroll", u = $2(), C = $(null), g = $(!1), h = U1(), w = U1(), v = c !== null ? e[c] : null;
        ...
        v ? /* @__PURE__ */ i(
          ce,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: j2(v.items).map((p, k) => /* @__PURE__ */ t(
                Z2,
                {
                  item: p,
                  onHover: n,
...
function Z2({ item: e, onSelect: r, onHover: n }) {
  const o = $(null), s = $(null), a = $(null), c = C1(), d = _(() => {
    ...
    c || (a.current = window.setTimeout(() => {
      ...
      if (h <= 0)
        return;
      const w = h + D2, v = w / I2 * 1e3;
      C.style.overflow = "visible";
      const p = `linear-gradient(90deg, transparent 0, #000 ${_2}px)`;
...
` || W === "	";
  ...
  const P = X(() => {
    ...
    if (!S)
      return null;
    const B = K2(S, k.current), j = S.offsetLeft + B.left, W = (S.offsetParent ? S.offsetParent.offsetHeight : 0) - (S.offsetTop + B.top);
...
const el = /[\\`*_{}[\]()#+\-.!|~>]/g, tl = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, n) => n % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(el, "\\$&")).join(""), P4 = ({
  onSubmit: e,
  onStop: r,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const Nr = async (Z) => {
    if (Z.preventDefault(), !L) {
      if (l1.close(), n)
        ...
        const v1 = l1.transformMentions(j.trim()), Y1 = tl(v1), j1 = Le.flatMap(
  ...
  }, be = p1 ? p1.prompt ?? p1.title : null, ke = ve ? [S.ai.listening] : be ? [be] : s ?? [], Hr = ke.length > 1, Ar = X(() => U2(j, l1.mentions, {
    cursorPosition: W,
    ...
    Y.div,
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(F2, { creditWarning: a, children: /* @__PURE__ */ i(
            "form",
            {
              "aria-busy": n,
              ref: a1,
        ...
        Pr ? /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(A2, { cards: V }) }) : null,
...
const Be = 7, Hl = 625, Ie = /* @__PURE__ */ new Set();
function Al(e) {
...
function ar({
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: u } = y1(), C = Tl(e), g = d ?? C, h = $(() => {
  ...
  h.current = k, z(() => {
    typeof window > "u" || window.innerWidth < Hl || Ie.has(e) || (Ie.add(e), h.current());
  }, [e]);
...
const cr = z1(void 0), O4 = () => $1(cr), Dl = (e) => /* @__PURE__ */ t(Et, { content: e, format: "markdown" }), _l = ({
  isGenerating: e,
  isLoading: r,
  message: n,
  renderToolCall: o,
...
const fr = (e) => /* @__PURE__ */ t(Et, { content: e, format: "markdown" }), Xl = ({
  text: e,
  renderMarkdown: r
  ...
  const c = e.rawData, d = ql(
    e?.content,
    c
  ), l = (Wl(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = l.length > 0, { anchor: C, clear: g } = ir({
    containerRef: a,
    enabled: u
  });
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        f ? /* @__PURE__ */ t(Xl, { text: f, renderMarkdown: o }) : null,
...
}, Kl = 35, Ql = 22, Jl = 400, e6 = 2500, t6 = 220, r6 = ({
  messages: e,
  caption: r,
  subtitle: n,
  cta: o,
  ...
  z(() => {
    ...
    let F;
    if (u === "starting")
      F = setTimeout(() => C("writing"), Jl);
    else if (u === "writing")
      l < h.length ? F = setTimeout(() => f((H) => H + 1), Kl) : C("holding");
    else if (u === "holding") {
      if (e.length <= 1)
        return;
      F = setTimeout(() => C("erasing"), e6);
    } else u === "erasing" && (l > 0 ? F = setTimeout(() => f((H) => H - 1), Ql) : F = setTimeout(() => {
...
const o6 = {
...
}, Z4 = (e) => /* @__PURE__ */ t(Ol, { children: /* @__PURE__ */ t(s6, { ...e }) }), s6 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: x, handleSubmit: E, handleClose: V } = Zl(
    h ?? o6
  ), P = G(), N = F ?? _l, S = H ?? Yl, B = X(() => {
    const q = o ?? P.ai.defaultInitialMessage;
    return (Array.isArray(q) ? q : [q]).filter((a1) => typeof a1 == "string" && a1.length > 0);
  }, [o, P.ai.defaultInitialMessage]), j = !r && e.length === 0 && B.length > 0, O = $(null), W = $(null), e1 = $(null), t1 = $(null), K = $(null), { showScrollBtn: Q, turnMinHeight: s1, scrollToBottom: p1 } = n6({
    viewportRef: O,
    contentRef: W,
    endRef: e1,
    lastTurnRef: K,
...
}, a6 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ i("div", { className: "flex flex-col gap-2", children: [
...
const d6 = [0.23, 1, 0.32, 1], u6 = 0.2, f6 = 0.03, h6 = 4, C6 = ({
  mode: e,
  question: r,
  options: n,
  selectedOptionIds: o,
...
class X4 {
  ...
  setupGL() {
    ...
    const T = (this.options.colors || b6).map(k6);
...
const y6 = 10, M6 = 2, R6 = 0.5, F6 = 0.2, N6 = 1.5, h1 = {
  duration: 0.5,
  ease: "easeOut"
}, Ge = {
  duration: 0.35,
...
function S6(e, r) {
  const [n, o] = I(y6), {
    ...
    animate: a,
    motionValue: c
  } = O1(F6), { value: d, animate: l } = O1(M6), { value: f, animate: u } = O1(R6), { value: C, animate: g } = O1(N6), h = $s(r, {
    fftSize: 512,
...
const We = ["lowp", "mediump", "highp"], V6 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, T6 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, Xe = "iTime", Ye = "iTimeDelta", Ke = "iDate", Qe = "iFrame", Je = "iMouse", et = "iResolution", H6 = "iChannel", tt = "iChannelResolution", rt = "iDeviceOrientation";
function A6(e, r) {
...
}, Q1 = 9729, nt = 9728, P6 = 9987, ot = 33071, st = 10497;
class D6 {
  gl;
  url;
  wrapS;
...
}, it = (e, r, n) => e * (1 - n) + r * n, _6 = (e, r, n) => n > 0 ? e.substring(0, n) + r + e.substring(n, e.length) : r + e;
function j6({
  fs: e,
  vs: r = qe,
  textures: n = [],
...
${y}`));
    ...
    if (o)
      for (const L of Object.keys(o)) {
        ...
        } else E6(D, M) && (U.arraySize = `[${Math.floor(M.length / Number.parseInt(D.charAt(0), 10))}]`);
        N.current[L] = {
          type: A,
          isNeeded: !1,
          value: M,
      ...
      if (n && n.length > 0) {
        ...
        const y = n.map(
          (M, D) => (N.current[`${H6}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(M, D), E.current[D] = new D6(L), E.current[D]?.load(M).then((A) => B(A, D)))
        );
        Promise.all(y).then(() => {
          u && u();
        }).catch((M) => {
...
`,
    ...
    return L.includes("mainImage") && (D = D.concat(V6)), D;
  }, a1 = (L) => {
    const y = w.current;
    if (!y || !p.current)
      return;
  ...
  return z(() => {
    ...
    function y() {
      j();
      const M = w.current;
      M && h.current && (M.clearColor(...s), M.clearDepth(1), M.enable(M.DEPTH_TEST), M.depthFunc(M.LEQUAL), M.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, c1(), q(), p1(d1(e || T6), r || qe), O(), requestAnimationFrame(J), x1(), Q());
    }
...
function Y4({
  ...
  const { speed: f, scale: u, amplitude: C, frequency: g, brightness: h } = S6(r, s);
  return /* @__PURE__ */ t(
    mr,
    {
      ref: d,
...
const K4 = ({
  ...
  const o = G(), s = C1();
  return /* @__PURE__ */ i(F1, { children: [
    e ? /* @__PURE__ */ t("span", { className: b(G6(), "truncate"), children: e }) : null,
    ...
    /* @__PURE__ */ i(
      Y.div,
      {
        ...
        children: [
          ...
          o === "balance" ? /* @__PURE__ */ t(X6, { balance: e.balance }) : null
        ]
      }
    ),
    n && !q6.has(o) ? /* @__PURE__ */ t(
      Y.span,
      {
        className: b(Z1()),
        animate: { opacity: s ? 0 : 1 },
...
const Q6 = ({
  ...
  const s = `sparkline-gradient-${U1().replace(/:/g, "")}`, a = K6(e, n), c = wr[a];
...
const r4 = () => /* @__PURE__ */ i(
  ...
  "balance",
  "sparkline"
], xr = 180, n4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : xr, o4 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, s4 = (e) => e.showActions !== !1, a4 = (e) => Object.fromEntries(
...
}, c4 = (e) => b2[e] ?? vt, d4 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(n1, { icon: c4(e), size: "md", color: "default" }) }) : null;
function u4({
  sources: e,
  title: r
}) {
...
) : e ? /* @__PURE__ */ t(C4, { credits: e, trigger: n }) : null, e9 = te, t9 = ({
  historyEnabled: e = !1,
  title: r,
...
const ct = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], x4 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(u1, { className: b("h-4 rounded", e) }) }), dt = ({
  titleWidth: e,
  rows: r
...
function n9({
  ...
  const [a, c] = I([]), [d, l] = I(!1), [f, u] = I(null), [C, g] = I(k4), [h, w] = I(() => /* @__PURE__ */ new Set()), v = _(async () => {
    l(!0), u(null);
    try {
      const x = await r();
      c(x);

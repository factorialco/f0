...
import { useInsertionEffect as ro, forwardRef as p, createElement as $e, useRef as I, useMemo as ee, useEffect as X, useLayoutEffect as vt, useState as P, useCallback as q, createContext as Ye, useContext as Pe, useId as wt } from "react";
import { cj as oo, ck as no, cl as so, cm as io, cn as xt, co as ao, cp as co, cq as lo, cr as fo, cs as uo, ct as kt, cu as ho, cv as go, cw as po, cx as mo, cy as Co, cz as vo, cA as wo, cB as We, cC as xo, cD as ko, cE as bo, cF as Lo, cG as yo, Z as bt, cH as Mo, cI as Eo, cJ as Ro, cK as Fo, cL as No, cM as Lt, cN as Vo, cO as So, a6 as m1, cP as To, aJ as Ho, cQ as Ao, cR as Bo, cS as $o, ag as Io, cT as Po, bO as jo, aa as C1, ad as Do, cU as Zo, ba as v1, a1 as yt, S as Ke, cV as Mt, b9 as _o, cW as Oo, cX as Uo, b2 as zo, bN as Go, $ as Le, au as Wo, be as Et, cY as qo, bL as Xo, cZ as Re, bH as Yo, c_ as Ko, c$ as Rt, b1 as Ft, d0 as Qo, d1 as Jo, d2 as en, d3 as tn, d4 as rn, d5 as Nt, bz as on, bA as nn, d6 as sn, d7 as an, d8 as cn, d9 as ln, da as dn, db as fn, dc as un, dd as hn, de as gn, df as pn, dg as mn, dh as Cn, di as vn, bM as wn, ab as xn, bv as kn, dj as bn, dk as Ln, dl as yn, dm as Mn, dn as En, dp as Rn, dq as Fn, ap as Nn, dr as Vt, M as Vn, a0 as Sn, ds as St, dt as Tt, du as Tn, bd as Hn, bc as An, dv as Bn, dw as Ht, dx as $n, b0 as In, ay as Pn, dy as jn, as as Dn, b7 as Zn, dz as At, b6 as _n, dA as On, bi as w1, dB as Un, dC as x1, bJ as zn, bI as Gn, bK as Bt, dD as Wn, G as qn, E as Xn, dE as Yn, dF as Kn, dG as Qn, dH as Jn, dI as es, dJ as $t, dK as ts, ac as rs, dL as os, L as fe, q as Fe, o as x, ae as ce, dM as ns, bp as ss, bC as is, y as It, dN as as, a5 as Qe, b$ as cs, Q as pe, at as ls, H as le, a8 as Pt, a9 as ds, af as jt, bq as Dt, dO as fs, a$ as Zt, v as me, dP as us, dQ as hs, U as ue, u as Y, dR as gs, cg as _t, a2 as ps, dS as ms, aP as ye, A as Ne, p as ne, aD as k1, dT as Cs, aE as b1, aF as L1, b as Me, dU as vs, dV as ws, bD as xs, V as ks, dW as bs, dX as Ls, dY as ys, dZ as $1, a3 as Ms, ak as Ot, aS as Ut, d_ as Es, b_ as Rs, d$ as Fs, e0 as Ns, aX as zt, e1 as Vs, bU as Ss, e2 as Ts, aU as Ie, bg as Gt, e3 as Wt, bh as qt, c as u1, e4 as Xt, e5 as Hs, bk as As, e6 as Bs, b8 as y1, bw as $s, e7 as Is, e8 as Ps, e9 as js, ea as Ds, eb as Zs, z as _s, ec as Yt, ed as Kt, ee as Os, aj as I1, ef as Us, ai as zs, eg as Gs, eh as Ws } from "./F0CanvasPanel-CpN0HPjO.js";
import { createPortal as Qt } from "react-dom";
import { defaultTranslations as qs } from "./i18n-provider-defaults.js";
...
function Jt(e, t, o, n) {
  return typeof e == "string" && M1(t) ? oo(e, o, n) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Ks(e, t, o) {
  return e * (t + 1);
}
...
function er(e, t) {
  return no(e) ? e[Qs(0, e.length, t)] : e;
}
function Js(e, t, o) {
  for (let n = 0; n < e.length; n++) {
    const s = e[n];
    s.at > t && s.at < o && (io(e, s), n--);
  }
}
function ei(e, t, o, n, s, i) {
  Js(e, s, i);
...
const oi = "easeInOut", ni = 20;
function si(e, { defaultTransition: t = {}, ...o } = {}, n, s) {
  ...
  for (let h = 0; h < e.length; h++) {
    ...
    const T = (E, L, b, A = 0, H = 0) => {
      const y = ii(E), { delay: R = 0, times: F = ao(y), type: $ = "keyframes", repeat: _, repeatType: z, repeatDelay: G = 0, ...re } = L;
      let { ease: K = t.ease || "easeOut", duration: O } = L;
      const Z = typeof R == "function" ? R(A, H) : R, D = y.length, Q = fo($) ? $ : s?.[$];
      if (D <= 2 && Q) {
        let ie = 100;
        if (D === 2 && li(y)) {
          const de = y[1] - y[0];
      ...
      if (he > 0 && lo(F, he), y.length === 1 && y.unshift(null), _) {
        kt(_ < ni, "Repeat count too high, must be less than 20"), O = Ks(O, _);
        const ie = [...y], oe = [...F];
      ...
      const ge = W + O;
      ei(b, y, K, F, W, ge), S = Math.max(Z + O, S), m = Math.max(ge, m);
    };
    if (xt(v)) {
      const E = j1(v, d);
      T(w, k, D1("default", E));
    } else {
      const E = Jt(v, w, n, l), L = E.length;
      for (let b = 0; b < L; b++) {
        w = w, k = k;
        const A = E[b], H = j1(A, d);
        for (const y in w)
          T(w[y], ai(k, y), D1(y, H), b, L);
      }
    }
    f = g, g += S;
  }
  return d.forEach((h, C) => {
    for (const v in h) {
      ...
      for (let L = 0; L < w.length; L++) {
        ...
        k.push(A), S.push(ho(0, m, b)), T.push(H || "easeOut");
      }
      S[0] !== 0 && (S.unshift(0), k.unshift(k[0]), T.unshift(oi)), S[S.length - 1] !== 1 && (S.push(1), k.push(null)), a.has(C) || a.set(C, {
        keyframes: {},
        transition: {}
      });
      const E = a.get(C);
...
const ci = (e) => typeof e == "number", li = (e) => e.every(ci);
function di(e, t) {
  return e in t;
}
class fi extends go {
...
function ui(e) {
  ...
  }, o = mo(e) && !Co(e) ? new vo(t) : new wo(t);
  o.mount(e), We.set(e, o);
}
function hi(e) {
  const t = {
    presenceContext: null,
...
function gi(e, t) {
  return xt(e) || typeof e == "number" || typeof e == "string" && !M1(t);
}
function tr(e, t, o, n) {
  const s = [];
  if (gi(e, t))
    s.push(xo(e, M1(t) && t.default || t, o && (o.default || o)));
  else {
    const i = Jt(e, t, n), a = i.length;
    kt(!!a, "No valid elements provided.");
    for (let d = 0; d < a; d++) {
      const l = i[d], u = l instanceof Element ? ui : hi;
      We.has(l) || u(l);
      const f = We.get(l), g = { ...o };
      "delay" in g && typeof g.delay == "function" && (g.delay = g.delay(d, a)), s.push(...ko(f, { ...t, transition: g }, {}));
    }
  }
  return s;
}
function pi(e, t, o) {
  const n = [];
  return si(e, t, o, { spring: bo }).forEach(({ keyframes: i, transition: a }, d) => {
    n.push(...tr(d, i, a));
  }), n;
}
class mi {
...
function wi(e) {
  function t(o, n, s) {
    let i = [];
    return vi(o) ? i = pi(o, n, e) : i = tr(o, n, s, e), new Ci(i);
  }
  return t;
}
const xi = wi(), ki = (e, t) => /* @__PURE__ */ c(
  "svg",
  {
...
const Xc = (e, t) => /* @__PURE__ */ c(
  ...
  Calculator: Po,
  Calendar: jo,
  CalendarArrowDown: Yi,
  CalendarArrowLeft: Qi,
    ...
    if (i !== void 0) {
      ...
      return m ? $e(
        ...
        ce,
        {
          ...
          noTooltip: a,
          tag: g,
          className: x(Ae({ variant: t, align: o }), n),
          markdown: d,
          ...u,
          children: e
        }
...
const r2 = Fe({
  ...
  ({
    ...
    const He = D && D !== "none" || Q && Q !== "none" || W && W !== "none" || he && he !== "none", De = Z && Z !== "none" || He, n1 = { sm: e1, md: t1, lg: je, xl: r1 }, s1 = o2.map((Ze) => {
      const _e = n1[Ze];
      return _e ? t2(Ze, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
const a1 = ss(
...
}), c1 = { sm: 640, md: 768, "container-md": 448 }, g1 = (e) => "type" in e && e.type === "separator", qe = (e) => "type" in e && e.type === "split", s2 = (e) => !("type" in e), Xe = (e, t, o) => /* @__PURE__ */ r(
  pe,
  {
    label: e.label,
    icon: e.icon,
    iconPosition: e.iconPosition,
    variant: e.critical ? "critical" : o,
    size: t,
    disabled: e.disabled,
    loading: e.loading,
  ...
  const o = e.variant ?? "default";
  return qe(e) ? F1(e, t, o) : Xe(e, t, o);
};
function Z1({
  primaryAction: e,
  secondaryActions: t,
  ...
  const g = I(null), { width: m = 0 } = is({
    ref: g,
    box: "border-box"
  }), h = a === "sm" || a === "md" ? c1[a] : c1.md, C = It(`(min-width: ${h}px)`, {
    initializeWithValue: !1
  }), v = a === "none" ? !0 : a === "container-md" ? m >= c1["container-md"] : C, w = typeof n == "string" ? n : n.base, k = typeof n == "string" ? n : n.md, S = v ? k : w, T = Array.isArray(
    t
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: { gap: s },
      children: v ? /* @__PURE__ */ r(a2, { ...L }, "row") : /* @__PURE__ */ r(i2, { ...L }, "stacked")
    }
  );
}
function i2({
  ...
  return /* @__PURE__ */ c(xe, { children: [
    n.length > 0 && /* @__PURE__ */ r(cs, { items: n }),
    i,
    o && yr(o, s),
    e && Mr(e, s)
  ] });
...
function a2({
  ...
  const v = d && C ? m : l, w = d ? C ? h : [] : [], k = new Set(v.map((y) => y.id)), S = e ? Mr(e, s) : null, T = t.filter(qe), E = t[t.length - 1], L = E != null && g1(E) && (T.length > 0 || S != null), b = [];
  t.forEach((y, R) => {
    if (!qe(y)) {
      if (g1(y)) {
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          H.length > 0 && /* @__PURE__ */ r("div", { ref: g, children: /* @__PURE__ */ r(Qe, { items: H, icon: Rt, size: s }) }),
          A.map(
...
function h2({
  ...
  const u = x(
    ...
    /* @__PURE__ */ r("div", { className: u, onClick: (v) => v.stopPropagation(), children: C })
  );
  if (n || s) {
    const C = (w) => {
      const k = s ? {
    ...
    return d === "never" ? v : /* @__PURE__ */ c(xe, { children: [
      v,
      /* @__PURE__ */ r(
        "div",
        {
  ...
  return !!m || (Array.isArray(t) ? t.length > 0 : !!t) || (o?.length ?? 0) > 0 ? f(
    /* @__PURE__ */ r(
      Z1,
      {
        primaryAction: m,
...
const Er = p(
  function({
    ...
    const T = !!h && h.visible !== !1, L = /* @__PURE__ */ c(
      Dt,
      {
        ref: T ? void 0 : S,
        className: x(
          ...
          (!!C || !!v) && "cursor-pointer focus-within:border-f1-border-hover focus-within:shadow-md hover:border-f1-border-hover hover:shadow-md"
        ),
        style: T ? {
          borderColor: fs[h.variant],
          borderWidth: "2px"
        } : void 0,
        onClick: v,
        "data-testid": "card",
    ...
    return T ? /* @__PURE__ */ r(hs, { ref: S, alert: h, fullHeight: m, children: L }) : L;
  }
);
Er.displayName = "F0CardRow";
const g2 = ({ compact: e = !1 }) => /* @__PURE__ */ r(
  Dt,
  {
    className: x(
    ...
    children: /* @__PURE__ */ c("div", { className: "flex flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
        /* @__PURE__ */ r(
          ue,
          {
            className: x("h-10 w-10 rounded-full", e && "h-8 w-8")
          }
        ),
...
function v2({
  ...
  return e.errorMessage ? /* @__PURE__ */ r(ps, { label: e.errorMessage, children: n }) : n;
}
const w2 = {
  soft: {
    text: "",
...
function k2({
  ...
  const l = o && t.length === 0, u = !o && t.length === 0;
  return !e || u ? null : /* @__PURE__ */ r(
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (f, g) => /* @__PURE__ */ c(
        ...
        const m = g === n, h = `${f.firstName} ${f.lastName}`.trim();
        return /* @__PURE__ */ c(
          "div",
          {
            ref: m ? d : void 0,
...
const b2 = ({
  ...
  return X(() => {
    ...
    e.length,
    s
  ]), o.length > 0 || n ? null : /* @__PURE__ */ r(Ne, { children: /* @__PURE__ */ r(
    ne.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
const R2 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ c(
    k1,
    {
      ...
      children: [
        /* @__PURE__ */ r(Cs, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ r(b1, { asChild: !0, children: /* @__PURE__ */ r(
          fe,
          {
            variant: "outline",
            label: d.label,
...
function F2(e, t, o) {
  ...
  const u = (f) => {
    ...
    n > d && a.push({ type: "text", text: e.slice(d, n) }), a.push({ type: "ghost", text: s }), l = !0, n < f && a.push({ type: "text", text: e.slice(n, f) }), d = f;
  };
  for (const f of i)
    u(f.start), a.push({ type: "mention", text: e.slice(f.start, f.end) }), d = f.end;
  return u(e.length), !l && s && n >= d && a.push({ type: "ghost", text: s }), a.length === 0 ? [{ type: "text", text: e }] : a;
}
function N2(e, t) {
  if (t === "*/*") return !0;
  if (t.endsWith("/*")) {
...
function V2(e, t) {
  ...
  return o.length === 0 ? e : e.filter(
    (n) => o.some((s) => N2(n.type, s))
  );
}
const S2 = 4e3;
function T2(e) {
  const [t, o] = P([]), [n, s] = P(null), i = I(
    null
...
function I2({
  ...
  const [i, a] = P(!1), [d, l] = P(""), [u, f] = P([]), [g, m] = P(!1), [h, C] = P(0), [v, w] = P([]), k = I(-1), S = I(null), T = I(0), E = I(-1);
  X(() => {
    if (!n) {
      a(!1);
      return;
    ...
    if (F.atIndex === E.current)
      return;
    k.current = F.atIndex, l(F.query), a(!0), C(0), m(!0), S.current && clearTimeout(S.current);
    const $ = ++T.current;
...
` || G === "	";
  ...
  const y = ee(() => {
    ...
    const F = s.current;
    if (!F) return null;
    const $ = B2(F, k.current), _ = F.offsetLeft + $.left, G = (F.offsetParent ? F.offsetParent.offsetHeight : 0) - (F.offsetTop + $.top);
...
const P2 = /[\\`*_{}[\]()#+\-.!|~>]/g, j2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, o) => o % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(P2, "\\$&")).join(""), h9 = ({
  onSubmit: e,
  onStop: t,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const je = Ce.status === "recording", r1 = je ? b.ai.listening : b.ai.inputPlaceholder, o1 = ge.filter((te) => te.status === "uploaded"), Ve = ge.some((te) => te.status === "uploading"), He = ge.some((te) => te.status === "error"), De = H.trim().length > 0;
  X(() => {
    if (!(!z || Ve)) {
      if (G(!1), He) {
  ...
  const n1 = async (te) => {
    if (te.preventDefault(), !Q) {
      if (J.close(), o)
        ...
        const ke = J.transformMentions(H.trim()), i1 = j2(ke), Ue = o1.flatMap(
  ...
  }, V1 = re ? re.prompt ?? re.title : null, S1 = je ? [b.ai.listening] : V1 ? [V1] : s ?? [], Qr = S1.length > 1, Jr = ee(() => F2(H, J.mentions, {
    cursorPosition: R,
    inlineCompletion: J.inlineCompletion
  }), [H, J.mentions, R, J.inlineCompletion]), eo = J.mentions.length > 0 || J.inlineCompletion !== null, Oe = k && !!T && T.length > 0 && !!E ? /* @__PURE__ */ r(
    R2,
    {
      suggestions: T,
      onItemClick: he,
    ...
    ne.div,
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          Oe && !S && /* @__PURE__ */ r("div", { children: Oe }),
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ r(
                        y2,
                        {
                          ...
                          onCursorUpdate: Ze,
                          onScroll: _e,
                          highlightSegments: Jr,
                          hasOverlay: eo,
                          multiplePlaceholders: Qr,
                          placeholders: S1,
        ...
        Oe && S && /* @__PURE__ */ r("div", { className: "w-full max-w-content", children: Oe }),
        w && k && S && /* @__PURE__ */ r("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: w }),
...
function Se({
  ...
  return /* @__PURE__ */ c(
    bs,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ls, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          ys,
          {
            side: "top",
...
function s4({
  ...
  const { entityRefs: o } = Me(), n = o?.resolvers?.candidate, s = Y(), i = o?.urls?.candidate?.(e), a = ee(
    () => (l) => {
      const u = [];
...
Fr.displayName = "ExpenseTrigger";
function i4({ id: e, label: t }) {
  const { entityRefs: o } = Me(), n = o?.resolvers?.expense, s = Y(), i = o?.urls?.expense?.(e), a = ee(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: or
...
function a4({
  ...
  const { entityRefs: o } = Me(), n = o?.resolvers?.jobPosting, s = Y(), i = o?.urls?.jobPosting?.(e), a = ee(
    () => (l) => ({
      title: l.title,
...
function l4({
  ...
  const { entityRefs: o } = Me(), n = o?.resolvers?.requisition, s = Y(), i = o?.urls?.requisition?.(e), a = ee(
    () => (l) => {
...
function d4({ id: e, label: t }) {
  const { entityRefs: o } = Me(), n = o?.resolvers?.person, s = Y(), i = o?.urls?.person?.(e), a = ee(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
function f4({ id: e, label: t }) {
  const { entityRefs: o } = Me(), n = o?.resolvers?.vacancy, s = Y(), i = o?.urls?.vacancy?.(e), a = ee(
    () => (l) => ({
      title: l.name,
...
function Hr({
  ...
  const a = Y(), d = s.type === "open", l = d ? n ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ c(
    "div",
    {
      className: x(
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ r(Es, { file: e.file, size: "lg" }),
          /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            ...
            o && /* @__PURE__ */ r(ce, { className: "text-base text-f1-foreground-secondary", children: o })
          ] }),
...
function p4(e) {
  const o = Pe(N1)?.formatters;
  return ee(() => !o || o.length === 0 ? null : (n, s, i) => {
    let a, d = -1;
    for (const l of o) {
...
const z1 = 7, m4 = 625, G1 = /* @__PURE__ */ new Set();
function C4(e) {
...
function w4(e) {
  const { days: t, hours: o, minutes: n, seconds: s } = Fs(e), i = [];
...
function Ar(e, t) {
  ...
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? C4(o) : "") || "—" };
  }
  if (t === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: o, to: n } = e, s = W1(o) ? q1(o) : String(o), i = W1(n) ? q1(n) : String(n);
...
function Br({
  ...
  }), C = n ?? e, v = s ?? t ?? "", w = l?.type === "form" && l.formName === e, k = () => u({
    type: "form",
    title: C,
    description: v,
    formName: e,
  ...
  h.current = k, X(() => {
    typeof window > "u" || window.innerWidth < m4 || G1.has(e) || (G1.add(e), h.current());
  }, [e]);
  const S = i && a ? Object.entries(i).map(([L, b]) => {
    const A = a[L], H = m?.(L, A, {
    ...
    if (!H && b.fieldType === "custom" && typeof A == "object" && A !== null)
      return null;
    const y = H ?? Ar(A, b.fieldType), R = ["richtext", "textarea"];
    return {
      label: b.label,
      content: y,
...
Br.displayName = "FormCard";
function x4() {
  const e = Ns(), t = e?.activeForm;
  if (!t) return null;
...
const Y1 = 8, Be = 8;
function Ir({ anchor: e, onReply: t }) {
  const o = Y(), n = I(null), [s, i] = P(
    null
  );
  if (vt(() => {
    if (!e) {
...
const Pr = Ye(void 0), C9 = () => Pe(Pr), L4 = (e) => /* @__PURE__ */ r(zt, { content: e, format: "markdown" }), y4 = ({
  isGenerating: e,
  isLoading: t,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", l = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !l, g = I(null), { anchor: m, clear: h } = $r({
    containerRef: g,
    enabled: !!(o?.id && d)
  });
  return X(() => {
    o?.id && !t && !e && i?.(o);
  }, [o, t, e, i]), !t && !e && f ? null : /* @__PURE__ */ r(Pr.Provider, { value: u, children: /* @__PURE__ */ c("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ r(
      "div",
      {
        ref: g,
  ...
  const [s, i] = P(""), a = Y(), { title: d, label: l, placeholder: u } = o === "like" ? a.ai.feedbackModal.positive : a.ai.feedbackModal.negative, f = q(() => {
    t(n, s);
  }, [s, n, t]), g = () => {
    e(n);
  };
...
}, jr = Ye(null), E4 = ({ children: e }) => {
  const [t, o] = P(null), n = t ? {
    isOpen: !0,
  ...
  return /* @__PURE__ */ r(jr.Provider, { value: n, children: e });
}, Dr = () => {
  const e = Pe(jr);
  if (e === null)
    throw new Error(
...
const F4 = ({
  ...
  const n = Y(), { open: s } = Dr(), [i, a] = P(null);
  ...
  const [d, l] = P(s), u = ye(), f = n !== void 0, g = f ? n : d;
  return /* @__PURE__ */ c(
    Gt,
    {
  ...
  const s = Y(), [i, a] = P(!!o), d = I(o);
  X(() => {
    d.current && !o ? a(!1) : o && !i && a(!0), d.current = o;
  }, [o, i]);
  const l = o ? s.ai.thoughtsGroupTitle : t ?? s.ai.thoughtsGroupTitle, u = e.length - 1, f = (g) => !o || n ? "completed" : g === u ? "executing" : "completed";
  return /* @__PURE__ */ r(
    N4,
    {
      icon: rr,
...
const Zr = (e) => /* @__PURE__ */ r(zt, { content: e, format: "markdown" }), H4 = ({
  text: e,
  renderMarkdown: t
  ...
  /* @__PURE__ */ r("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (t ?? Zr)(e) })
] }), A4 = ({
  message: e,
  onReplyQuote: t,
  ...
  const a = e.rawData, d = T4(
    e?.content,
    a
  ), l = (S4(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = l.length > 0, { anchor: g, clear: m } = $r({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ r(H4, { text: u, renderMarkdown: n }),
  ...
  const [n, s] = P(0), [i, a] = P(0), [d, l] = P("starting"), u = e[n] ?? "";
  X(() => {
...
function Z4({
  ...
  const h = q(() => {
    const C = e.current;
    if (!C) return;
    const { scrollTop: v, scrollHeight: w, clientHeight: k } = C, S = w - v - k;
    u(S > k);
  }, [e]);
  return X(() => {
    const C = e.current;
    ...
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!C || !v) return;
        const w = C.getBoundingClientRect(), k = v.getBoundingClientRect(), S = C.scrollTop + (k.top - w.top);
...
const _4 = {
  ...
  const { modal: T, handleSubmit: E, handleClose: L } = R4(
    f ?? _4
  ), b = Y(), A = v ?? y4, H = w ?? A4, y = ee(() => {
    const D = n ?? b.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((W) => typeof W == "string" && W.length > 0);
  }, [n, b.ai.defaultInitialMessage]), R = !t && e.length === 0 && y.length > 0, F = I(null), $ = I(null), _ = I(null), z = I(null), G = I(null), { showScrollBtn: re, turnMinHeight: K, scrollToBottom: O } = Z4({
    viewportRef: F,
    contentRef: $,
    endRef: _,
    lastTurnRef: G,
    ...
    const W = Q === e.length - 1, he = {
      ...
      const de = W && se === D.assistantMessages.length - 1, M = D.userMessages.length + se, V = {
        message: oe,
        inProgress: D.isInProgress,
        index: M,
        isCurrentMessage: de,
...
function x9({
  ...
  return /* @__PURE__ */ r(_r.Provider, { value: t, children: e });
}
function k9() {
  const e = Pe(_r);
  if (e === null)
...
const G4 = ({
  ...
  const m = Y().ai.clarifyingQuestion.typeYourAnswer, h = e === "single" ? /* @__PURE__ */ r(Or, { isSelected: o && !t }) : /* @__PURE__ */ r(
    Xt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const q4 = ({
  ...
  const k = ye(), S = (() => {
    ...
    const A = o.findIndex((H) => n.includes(H.id));
    return A >= 0 ? A : 0;
  })(), [T, E] = P(S), L = I([]);
  X(() => {
  ...
  } = s, A = I(null), H = S ?? "single", y = a > 1, R = i === 0, F = i === a - 1, $ = y ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  ...
  }, D = F ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, Q = T === !0 && !_ && !(b && z), W = () => {
...
function Q1(e, t, o, n) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(o, 20), d = Math.min(i + n, s), l = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(t / 2)), f = (W) => W / e * 2 - 1, g = (W) => W / t * 2 - 1, m = 0, h = e, C = 0, v = t, w = l, k = e - l, S = u, T = t - u, E = f(m), L = f(h), b = g(C), A = g(v), H = f(w), y = f(k), R = g(S), F = g(T), $ = 0, _ = 0, z = 1, G = 1, re = l / e, K = 1 - l / e, O = u / t, Z = 1 - u / t, D = new Float32Array([
    // Top strip
    E,
    b,
    L,
...
function J4(e, t, o) {
  const n = J1(e, e.VERTEX_SHADER, t), s = J1(e, e.FRAGMENT_SHADER, o), i = e.createProgram();
...
class y9 {
  ...
  resize(t, o, n) {
    ...
    const { gl: s, program: i, vao: a, positionBuffer: d, uvBuffer: l, uResolution: u } = this.glr, f = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, g = Math.max(1, Math.floor(t * f)), m = Math.max(1, Math.floor(o * f));
    this.canvas.style.width = `${t}px`, this.canvas.style.height = `${o}px`, (this.canvas.width !== g || this.canvas.height !== m) && (this.canvas.width = g, this.canvas.height = m), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
  ...
  setupGL() {
    ...
    const u = t.getAttribLocation(o, "aPosition");
    ...
    const m = t.getUniformLocation(o, "uResolution"), h = t.getUniformLocation(o, "uTime"), C = t.getUniformLocation(o, "uBorderWidth"), v = t.getUniformLocation(o, "uGlowWidth"), w = t.getUniformLocation(o, "uBorderRadius"), k = t.getUniformLocation(o, "uColors"), S = t.getUniformLocation(o, "uGlowExponent"), T = t.getUniformLocation(o, "uGlowFactor");
    t.useProgram(o), t.uniform1f(C, this.options.borderWidth), t.uniform1f(v, this.options.glowWidth), t.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (t.uniform1f(S, 2), t.uniform1f(T, 1.8)) : (t.uniform1f(S, 1), t.uniform1f(T, 1));
    const E = (this.options.colors || r6).map(o6);
...
const et = ["lowp", "mediump", "highp"], n6 = `
void main(void){
...
}`, rt = "iTime", ot = "iTimeDelta", nt = "iDate", st = "iFrame", it = "iMouse", at = "iResolution", i6 = "iChannel", ct = "iChannelResolution", lt = "iDeviceOrientation";
function a6(e, t) {
...
}, d1 = 9729, dt = 9728, u6 = 9987, ft = 33071, ut = 10497;
class h6 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const g = 0, m = o.RGBA, h = 1, C = 1, v = 0, w = o.RGBA, k = o.UNSIGNED_BYTE, S = new Uint8Array([255, 255, 255, 0]), T = o.createTexture();
    if (o.bindTexture(o.TEXTURE_2D, T), o.texImage2D(
      ...
      return o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.LINEAR), this._webglTexture = T, this.source = A, this.isVideo = !0, A.play().then(() => this);
    }
    async function E() {
      return new Promise((A, H) => {
        ...
        y.crossOrigin = "anonymous", y.onload = () => {
          ...
          H(new Error(be(`failed loading url: ${n}`)));
        }, y.src = n ?? "";
      });
    }
    let L = await E(), b = (L.width & L.width - 1) === 0 && (L.height & L.height - 1) === 0;
    return (t.wrapS !== ft || t.wrapT !== ft || t.minFilter !== dt && t.minFilter !== d1) && !b && (L = this.makePowerOf2(L), b = !0), o.bindTexture(o.TEXTURE_2D, T), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, l), o.texImage2D(
      o.TEXTURE_2D,
      g,
      m,
      w,
...
}, gt = (e, t, o) => e * (1 - o) + t * o, g6 = (e, t, o) => o > 0 ? e.substring(0, o) + t + e.substring(o, e.length) : t + e;
function p6({
  fs: e,
  vs: t = tt,
  textures: o = [],
  ...
  const h = I(null), C = I(null), v = I(null), w = I(null), k = I(void 0), S = I(void 0), T = I(!1), E = I(void 0), L = I(0), b = I([0, 0]), A = I([]), H = I(0), y = I(void 0), R = I({
    ...
    U[V * 3] = N * u, U[V * 3 + 1] = j * u, U[V * 3 + 2] = 0;
  }, _ = () => {
    ...
    M?.bufferData(M.ARRAY_BUFFER, new Float32Array(V), M.STATIC_DRAW);
  }, G = ({
    alpha: M,
    beta: V,
    gamma: N
    ...
    const [V = 0, N = 0] = ht(M), j = V - (E.current?.left ?? 0) - window.pageXOffset, B = (E.current?.height ?? 0) - N - (E.current?.top ?? 0) - window.pageYOffset;
    T.current = !0;
    ...
    const [V = 0, N = 0] = ht(M), j = V - (E.current?.left ?? 0), B = (E.current?.height ?? 0) - N - (E.current?.top ?? 0);
    if (l !== 1)
    ...
    if (!M) return;
    E.current = h.current?.getBoundingClientRect();
    const V = u, N = Math.floor(
      (E.current?.width ?? 1) * V
    ), j = Math.floor(
      (E.current?.height ?? 1) * V
    );
    ...
    if (!j) return null;
    if (N.shaderSource(j, V), N.compileShader(j), !N.getShaderParameter(j, N.COMPILE_STATUS)) {
...
${V}`));
    ...
    const N = C.current;
    if (!N) return;
    const j = D(N.FRAGMENT_SHADER, M), B = D(N.VERTEX_SHADER, V);
      ...
      if (o && o.length > 0) {
        ...
        const V = o.map(
          (N, j) => (R.current[`${i6}${j}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, $(N, j), A.current[j] = new h6(M), A.current[j]?.load(N).then((B) => {
            $(B, j);
          }))
        );
        Promise.all(V).then(() => {
    ...
    const V = et.includes(i ?? "highp"), N = `precision ${V ? i : et[1]} float;
`;
    V || m?.(
      be(
...
`,
    ...
    return M.includes("mainImage") && (j = j.concat(n6)), j;
  }, ie = (M) => {
    const V = C.current;
    ...
    if (R.current.iMouse?.isNeeded) {
      const B = V.getUniformLocation(
        w.current,
        it
      );
      V.uniform4fv(B, R.current.iMouse.value);
    }
    ...
    if (R.current.iDate?.isNeeded) {
      const B = /* @__PURE__ */ new Date(), U = B.getMonth() + 1, ae = B.getDate(), J = B.getFullYear(), we = B.getHours() * 60 * 60 + B.getMinutes() * 60 + B.getSeconds() + B.getMilliseconds() * 1e-3, Ee = V.getUniformLocation(
        w.current,
        nt
      );
      V.uniform4fv(Ee, [J, U, ae, we]);
    }
    if (R.current.iFrame?.isNeeded) {
      ...
      V.uniform1i(B, U), R.current.iFrame.value = U + 1;
    }
    if (A.current.length > 0)
      for (let B = 0; B < A.current.length; B++) {
        ...
        if (R.current[`iChannel${B}`]?.isNeeded) {
          if (!w.current) return;
          const Ce = V.getUniformLocation(
            w.current,
            `iChannel${B}`
          );
          V.activeTexture(V.TEXTURE0 + B), V.bindTexture(V.TEXTURE_2D, J), V.uniform1i(Ce, B), ae && U.updateTexture(
            J,
            we,
            Ee
          );
    ...
    const V = C.current;
    if (!V) return;
    V.viewport(0, 0, V.drawingBufferWidth, V.drawingBufferHeight), V.clear(V.COLOR_BUFFER_BIT | V.DEPTH_BUFFER_BIT), V.bindBuffer(V.ARRAY_BUFFER, v.current), V.vertexAttribPointer(
      k.current ?? 0,
      3,
      V.FLOAT,
      !1,
      0,
      0
    ), ie(M), V.drawArrays(V.TRIANGLE_STRIP, 0, 4);
    ...
    S.current = requestAnimationFrame(oe);
  }, se = () => {
    const M = { passive: !0 };
  ...
  return X(() => {
    ...
    function V() {
      _();
      const N = C.current;
      N && h.current && (N.clearColor(...s), N.clearDepth(1), N.enable(N.DEPTH_TEST), N.depthFunc(N.LEQUAL), N.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, W(), he(), Q(ge(e || s6), t || tt), z(), requestAnimationFrame(oe), se(), Z());
    }
    return requestAnimationFrame(V), () => {
      ...
      de(), cancelAnimationFrame(S.current ?? 0);
    };
  }, []), /* @__PURE__ */ r(
    "canvas",
    {
...
function b6(e, t) {
  const [o, n] = P(C6), {
    ...
    animate: i,
    motionValue: a
  } = ze(x6), { value: d, animate: l } = ze(v6), { value: u, animate: f } = ze(w6), { value: g, animate: m } = ze(k6), h = Xs(t, {
    fftSize: 512,
  ...
  return X(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, ve), l(1.2, ve), f(0.4, ve), m(1, ve);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, ve), f(0.7, ve), m([1.5, 2], pt);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, ve), l(0.5, ve), f(1, ve), m([0.5, 2.5], pt);
        return;
      case "speaking":
        n(70), i(0.3, ve), l(0.75, ve), f(1.25, ve), m(1.5, ve);
        return;
    }
  }, [
    e,
...
const E9 = ({
  ...
  const n = Y(), s = ye();
  return /* @__PURE__ */ c(xe, { children: [
    e && /* @__PURE__ */ r("span", { className: x(E6(), "truncate"), children: e }),
    /* @__PURE__ */ r(Ne, { children: o && t && /* @__PURE__ */ r(
      ne.div,
      {
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: x(Gr()), children: t }),
    /* @__PURE__ */ c(
      ne.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ c("div", { className: "flex items-center gap-1", children: [
            ...
            o && /* @__PURE__ */ r("span", { className: x(Ge()), children: o })
          ] }),
          n === "people" && /* @__PURE__ */ r(
            As,
            {
          ...
          n === "alert" && /* @__PURE__ */ r($s, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ r(N6, { balance: e.balance })
        ]
      }
    ),
    o && !F6.has(n) && /* @__PURE__ */ r(
      ne.span,
      {
        className: x(Ge()),
        animate: { opacity: s ? 0 : 1 },
...
const T6 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), H6 = ({
  label: e,
  direction: t
}) => {
  const o = Wr[t];
  ...
  const s = `sparkline-gradient-${wt().replace(/:/g, "")}`, i = S6(e, o), a = Wr[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ps, { width: "100%", height: "100%", children: /* @__PURE__ */ c(
          js,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ r(Ds, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                Zs,
                {
                  type: "linear",
        ...
        "div",
        {
          ...
          children: [
            ...
            u.content === "sparkline" ? /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: x(Gr()), children: n }),
              /* @__PURE__ */ r(
                ne.div,
                {
...
qr.displayName = "F0AiInsightCardInternal";
const B6 = ["className"], Xr = p((e, t) => {
  const o = B6.reduce((n, s) => {
    const { [s]: i, ...a } = n;
    return a;
  }, e);
  return /* @__PURE__ */ r(qr, { ref: t, ...o });
});
...
const $6 = () => /* @__PURE__ */ c(
  ...
  "balance",
  "sparkline"
], Yr = 180, I6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Yr, P6 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, j6 = (e) => e.showActions !== !1, D6 = (e) => Object.fromEntries(
...
}, O6 = (e) => Bl[e] ?? Nt, U6 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(le, { icon: O6(e), size: "md", color: "default" }) }) : null;
function z6({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(_6, { icon: w1, title: n, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
function W6({
  ...
  const n = Y(), s = I(null), i = t ?? n.ai.aiTable.title, a = q(
    (d) => {
      if (!s.current) return;
...
function q6({ credits: e }) {
  const t = Y(), [o, n] = P(!1), [s, i] = P(!1), [a, d] = P(!1), [l, u] = P(null), f = q(
    (h) => {
      n(h), h && e?.fetchUsage && (i(!0), d(!1), e.fetchUsage().then((C) => {
        u(C), d(!1);
      }).catch(() => {
        d(!0);
      }).finally(() => {
  ...
  return /* @__PURE__ */ c(k1, { open: o, onOpenChange: f, children: [
...
function Y6({
  ...
  const t = Y(), o = ye(), [n, s] = P(!1), [i, a] = P(!1), [d, l] = P(!1), [u, f] = P(null), g = q(
    (v) => {
  ...
  return /* @__PURE__ */ c(k1, { open: n, onOpenChange: g, children: [
    /* @__PURE__ */ r(b1, { asChild: !0, children: /* @__PURE__ */ r(
      fe,
      {
        variant: "ghost",
...
const mt = ({
  ...
  const m = Y(), h = It(`(max-width: ${_s.md}px)`, {
        ...
        /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ r(
          Ie,
          {
            ...
            children: /* @__PURE__ */ c("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ r(ce, { lines: 1, className: "min-w-0 text-left", children: o ?? m.ai.newConversation }),
...
function K6() {
  if (!(typeof navigator > "u"))
    return zs(navigator.language);
}
function Q6(e) {
  const t = new Date(e), o = /* @__PURE__ */ new Date();
  return Yt(t) ? "today" : Kt(t) ? "yesterday" : Os(t, o) ? "thisMonth" : "older";
}
function J6(e, t) {
  const o = new Date(e), n = K6(), s = I1(o, "p", { locale: n });
  if (Yt(o)) return `${t.today}, ${s}`;
  if (Kt(o)) return `${t.yesterday}, ${s}`;
  const i = !Us(o, /* @__PURE__ */ new Date());
  return `${I1(o, i ? "MMM d yyyy" : "MMM d", {
    locale: n
  })}, ${s}`;
}
function e9(e) {
...
function S9({
  ...
  const [n, s] = P([]), [i, a] = P(!1), [d, l] = P(null), [u, f] = P(o9), g = q(async () => {
    a(!0), l(null);
    try {
      const v = await t();
      s(v);
  ...
  const m = q((v) => {
    f((w) => {
      const k = new Set(w);
      return k.add(v), f1(k), k;
    });
  }, []), h = q((v) => {
    f((w) => {
      const k = new Set(w);
      return k.delete(v), f1(k), k;
    });
  }, []), C = q(
    async (v) => {
      try {
        await o(v), s((w) => w.filter((k) => k.id !== v)), f((w) => {
          if (!w.has(v)) return w;
          const k = new Set(w);
          return k.delete(v), f1(k), k;
        });

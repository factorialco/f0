...
import { d6 as Br, d7 as Ir, aj as nt, c6 as Pr, d8 as Dr, d9 as jr, da as _r, db as Zr, c7 as Or, cc as st, c5 as Ur, dc as zr, as as i1, dd as Gr, aZ as Wr, de as qr, df as Xr, dg as Yr, aC as Kr, dh as Qr, cD as Jr, y as at, az as eo, di as to, o as c1, an as it, ae as qe, n as ct, bv as ro, ca as oo, dj as no, bi as so, cC as ao, al as Fe, aP as io, bz as lt, dk as co, cA as lo, l as Me, cy as fo, dl as uo, c1 as dt, bh as ho, dm as po, dn as go, dp as Co, dq as mo, dr as vo, ds as ft, cr as wo, cs as xo, dt as ko, du as bo, dv as Lo, dw as yo, dx as Mo, bL as Eo, c9 as Ro, dy as Fo, dz as No, dA as Vo, dB as So, dC as To, dD as Ho, dE as Ao, dF as $o, dG as Bo, dH as Io, dI as Po, bK as Do, cB as jo, ax as _o, cn as Zo, dJ as Oo, dK as Uo, dL as zo, dM as Go, dN as Wo, dO as qo, dP as Xo, aL as Yo, bM as Ko, R as ut, ad as Qo, am as Jo, bN as ht, c0 as en, Q as pt, i as tn, by as rn, bx as on, dQ as nn, dR as sn, bO as gt, bP as an, bQ as cn, bg as ln, aS as dn, dS as fn, j as un, bt as Ct, bs as mt, bn as hn, dT as vt, aw as pn, c8 as l1, q as gn, bq as d1, dU as Cn, dV as mn, dW as f1, N as vn, O as wn, cz as wt, dX as xn, ab as kn, aa as bn, dY as Ln, dZ as yn, d_ as Mn, d$ as En, b_ as Rn, e0 as xt, e1 as Fn, ay as Nn, e2 as Vn, ac as se, a3 as Te, ch as Sn, u as G, bZ as Tn, S as he, bJ as kt, U as le, ao as Hn, m as ve, e3 as An, aA as ae, b3 as ke, a9 as Ee, a2 as ee, cI as bt, t as u1, e4 as $n, x as h1, b as ye, bX as Bn, e5 as In, bY as Pn, af as Dn, bf as jn, ar as p1, bR as _n, bS as Zn, bT as On, bU as M1, ap as Un, aG as Lt, b5 as yt, bI as zn, cO as Gn, e6 as Wn, e7 as qn, bb as Mt, e8 as Xn, cK as Yn, e9 as Kn, b7 as Be, bo as Et, ea as Rt, bp as Ft, c as o1, cb as E1, eb as Nt, ec as Qn, ed as Jn, bD as es, ee as ts, bu as g1, co as rs, ef as os, eg as ns, eh as ss, ei as as, ej as is, w as cs, s as ls, v as Vt, a7 as ds, a8 as fs, aF as R1, ek as St, el as Tt, em as us, en as hs, aE as ps, at as gs, eo as Cs, ep as ms, d as vs } from "./F0CanvasPanel-934NjvBp.js";
...
const Nc = (e, r) => /* @__PURE__ */ i(
...
), p0 = g(h0), g0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Vs,
  Add: Br,
  Ai: Ts,
  ...
  Calculator: Qr,
  Calendar: Jr,
  CalendarArrowDown: ra,
  CalendarArrowLeft: na,
  CalendarArrowRight: aa,
  CameraPlus: ca,
  CardPin: da,
  ChartFunnel: ua,
  ChartHorizontalBars: pa,
  ChartLine: Ca,
  ChartPie: va,
  ChartVerticalBars: xa,
  Check: at,
  CheckCircle: eo,
  CheckCircleLine: ba,
  CheckDouble: to,
  ...
  Wifi: p0,
  Windows: Vn
}, Symbol.toStringTag, { value: "Module" })), C0 = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const $0 = Te({
  ...
  ({
    ...
    const Ae = j && j !== "none" || W && W !== "none" || K && K !== "none" || ie && ie !== "none", Se = Y && Y !== "none" || Ae, De = { sm: xe, md: Ye, lg: Ke, xl: Qe }, je = B0.map((_e) => {
      const Ze = De[_e];
      return Ze ? A0(_e, Ze) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
...
`) ? o + "_" : o
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, G0).map((r) => /* @__PURE__ */ t(
  bt,
  {
...
const Y0 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ i(
    u1,
    {
      ...
      children: [
        /* @__PURE__ */ t($n, { asChild: !0, children: /* @__PURE__ */ t("div", { ref: l, className: "flex w-full flex-wrap items-center gap-2", children: e.map((p, h) => /* @__PURE__ */ t(
          se,
          {
            variant: "outline",
            label: p.label,
        ...
        C && /* @__PURE__ */ i(
          h1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: X0(C.items).map((p, h) => /* @__PURE__ */ i(
                "button",
                {
                  type: "button",
                  onClick: (m) => {
...
` || z === "	";
  ...
  const B = J(() => {
    ...
    const S = s.current;
    if (!S) return null;
    const I = nl(S, y.current), U = S.offsetLeft + I.left, z = (S.offsetParent ? S.offsetParent.offsetHeight : 0) - (S.offsetTop + I.top);
...
const il = /[\\`*_{}[\]()#+\-.!|~>]/g, cl = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(il, "\\$&")).join(""), Z6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const _e = async (Q) => {
    if (Q.preventDefault(), !ie) {
      if (ne.close(), o)
        ...
        const be = ne.transformMentions(R.trim()), e1 = cl(be), Oe = Ae.flatMap(
  ...
  }, v1 = X ? X.prompt ?? X.title : null, w1 = Pe ? [b.ai.listening] : v1 ? [v1] : s ?? [], Fr = w1.length > 1, Nr = J(() => K0(R, ne.mentions, {
    cursorPosition: I,
  ...
  ) : null, Sr = A && T && !!w && w.length > 0, k1 = T && A, { motionProps: Tr } = In(
    A,
    160,
    0.5
  );
    ...
    ee.div,
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(_0, { creditWarning: a, children: /* @__PURE__ */ i(
            ee.form,
            {
              "aria-busy": o,
              ref: j,
        ...
        Sr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(W0, { cards: w }) }),
...
const N1 = 7, Dl = 625, V1 = /* @__PURE__ */ new Set();
function jl(e) {
...
function lr({
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = ye(), C = Pl(e), p = d ?? C, h = $(() => {
  ...
  h.current = y, q(() => {
    typeof window > "u" || window.innerWidth < Dl || V1.has(e) || (V1.add(e), h.current());
  }, [e]);
...
const ur = We(void 0), G6 = () => Ie(ur), Gl = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), Wl = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
...
const gr = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), r2 = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = t2(
    e?.content,
    l
  ), c = (e2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: C, clear: p } = dr({
    containerRef: a,
    enabled: f
  });
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(r2, { text: u, renderMarkdown: n }),
...
}, n2 = 35, s2 = 22, a2 = 400, i2 = 2500, c2 = 220, l2 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  ...
  q(() => {
    ...
    let p;
    if (d === "starting")
      p = setTimeout(() => c("writing"), a2);
    else if (d === "writing")
      a < u.length ? p = setTimeout(() => l((h) => h + 1), n2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), i2);
    } else d === "erasing" && (a > 0 ? p = setTimeout(() => l((h) => h - 1), s2) : p = setTimeout(() => {
...
const f2 = {
...
}, W6 = (e) => /* @__PURE__ */ t(Xl, { children: /* @__PURE__ */ t(u2, { ...e }) }), u2 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: T, handleSubmit: V, handleClose: E } = Yl(
    f ?? f2
  ), w = G(), N = x ?? Wl, b = v ?? o2, B = J(() => {
    const j = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((K) => typeof K == "string" && K.length > 0);
  }, [n, w.ai.defaultInitialMessage]), R = !r && e.length === 0 && B.length > 0, S = $(null), I = $(null), U = $(null), O = $(null), z = $(null), { showScrollBtn: te, turnMinHeight: oe, scrollToBottom: X } = d2({
    viewportRef: S,
    contentRef: I,
    endRef: U,
    lastTurnRef: z,
...
}, h2 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ i("div", { className: "flex flex-col gap-2", children: [
...
const g2 = ({
  ...
  const p = G().ai.clarifyingQuestion.typeYourAnswer, h = $(null), m = ws(h, l);
  a1(() => {
    const v = h.current;
    if (!v) return;
    v.style.height = "auto";
  ...
  return /* @__PURE__ */ i("div", { className: "flex flex-col", onKeyDown: ie, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ i(
      ee.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ue, ease: w2 },
        children: [
          /* @__PURE__ */ t(
            v2,
            {
...
class J6 {
  ...
  setupGL() {
    ...
    const V = (this.options.colors || M2).map(E2);
...
const P1 = ["lowp", "mediump", "highp"], R2 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, F2 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, j1 = "iTime", _1 = "iTimeDelta", Z1 = "iDate", O1 = "iFrame", U1 = "iMouse", z1 = "iResolution", N2 = "iChannel", G1 = "iChannelResolution", W1 = "iDeviceOrientation";
function V2(e, r) {
...
}, r1 = 9729, q1 = 9728, $2 = 9987, X1 = 33071, Y1 = 10497;
class B2 {
  gl;
  url;
  wrapS;
...
}, Q1 = (e, r, o) => e * (1 - o) + r * o, I2 = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function P2({
  fs: e,
  vs: r = D1,
  textures: o = [],
      ...
      if (o && o.length > 0) {
        ...
        const F = o.map(
          (M, D) => (R.current[`${N2}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, I(M, D), N.current[D] = new B2(L), N.current[D]?.load(M).then((H) => {
            I(H, D);
          }))
        );
        Promise.all(F).then(() => {
...
`,
    ...
    return L.includes("mainImage") && (D = D.concat(R2)), D;
  }, ge = (L) => {
    const F = m.current;
  ...
  return q(() => {
    ...
    function F() {
      U();
      const M = m.current;
      M && h.current && (M.clearColor(...s), M.clearDepth(1), M.enable(M.DEPTH_TEST), M.depthFunc(M.LEQUAL), M.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, K(), ie(), W(ue(e || F2), r || D1), O(), requestAnimationFrame(re), de(), Y());
    }
...
}`, j2 = 10, _2 = 2, Z2 = 0.5, O2 = 0.2, U2 = 1.5, Ce = {
  duration: 0.5,
  ease: "easeOut"
}, J1 = {
  duration: 0.35,
...
function z2(e, r) {
  const [o, n] = P(j2), {
    ...
    animate: a,
    motionValue: l
  } = Ue(O2), { value: d, animate: c } = Ue(_2), { value: u, animate: f } = Ue(Z2), { value: C, animate: p } = Ue(U2), h = ks(r, {
    fftSize: 512,
...
const t4 = ({
  ...
  const n = G(), s = ke();
  return /* @__PURE__ */ i(Re, { children: [
    e && /* @__PURE__ */ t("span", { className: k(X2(), "truncate"), children: e }),
...
const t6 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), r6 = ({
  label: e,
  direction: r
}) => {
  const o = kr[r];
  ...
  const s = `sparkline-gradient-${Ge().replace(/:/g, "")}`, a = e6(e, o), l = kr[a];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(r6, { label: r, direction: a })
      ]
    }
  ) });
}, br = g(
...
const n6 = ["className"], Lr = g((e, r) => {
  const o = n6.reduce((n, s) => {
    const { [s]: a, ...l } = n;
    return l;
  }, e);
...
const s6 = () => /* @__PURE__ */ i(
  ...
  "balance",
  "sparkline"
], yr = 180, a6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : yr, i6 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, c6 = (e) => e.showActions !== !1, l6 = (e) => Object.fromEntries(
...
function d6(e) {
  ...
  } = e, [c, u] = P(!1), f = Ge(), C = $(null), p = a6(
    d
  ), h = a.length > p, m = c ? a : i6(a, p), x = c6(e) ? e : null, v = l6(e);
  return q(() => {
    c && C.current?.focus();
  }, [c]), /* @__PURE__ */ i(
    "section",
...
d6.displayName = "F0AiProposalCard";
const f6 = ({
  icon: e,
  title: r,
  children: o
...
}, u6 = (e) => g0[e] ?? ft, h6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: u6(e), size: "md", color: "default" }) }) : null;
function p6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(f6, { icon: d1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, a) => {
    const l = /* @__PURE__ */ t(h6, { iconName: s.icon });
...
p6.displayName = "F0AiMessageSources";
async function g6(e, r, o) {
  const n = await import("./xlsx-CzlURDDb.js"), s = n.utils.table_to_book(e, { sheet: "Data" });
  n.writeFile(s, `${o}.${r}`);
}
function C6({
...
const v6 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function w6({
  employeeCredits: e,
  trigger: r
}) {
...
const s1 = ({
...
) : e ? /* @__PURE__ */ t(m6, { credits: e, trigger: o }) : null, n4 = s1, s4 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const m = G(), x = ke(), v = ds(`(max-width: ${fs.md}px)`, {
...
function b6(e, r) {
  const o = new Date(e), n = x6(), s = R1(o, "p", { locale: n });
...
const tt = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], M6 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(he, { className: k("h-4 rounded", e) }) }), rt = ({
  titleWidth: e,
  rows: r
  ...
  r.map((o, n) => /* @__PURE__ */ t(M6, { width: o }, n))
] });
function E6() {
...
function i4({
  ...
  const [a, l] = P([]), [d, c] = P(!1), [u, f] = P(null), [C, p] = P(R6), [h, m] = P(() => /* @__PURE__ */ new Set()), x = Z(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);

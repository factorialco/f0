import { jsxs as i, jsx as t, Fragment as N1 } from "react/jsx-runtime";
  ...
  const o = /* @__PURE__ */ i("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    ...
    /* @__PURE__ */ t(
      "button",
      {
        ...
        onClick: () => r(e.id),
        children: /* @__PURE__ */ t(o1, { icon: R1, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
              ...
              "div",
              {
                ...
                children: e.map((p, k) => /* @__PURE__ */ t(
                  n1,
                  {
                    ...
                    onClick: (F) => {
                      C.current = F.currentTarget, g.current = !1, d((T) => T === k ? null : k), n?.(null);
                    }
                  },
                  `${p.label}-${k}`
                ))
...
function z2(e) {
  ...
  const v = _(
    async (T) => {
      ...
      if (u !== void 0 && h.current + E.length > u) {
        w(
      ...
      try {
        const V = await l(E);
        if (!Array.isArray(V) || V.length !== E.length) {
          S(d.ai.fileUploadError);
          return;
        }
        n(
          (P) => P.map((H) => {
            const N = M.findIndex((B) => B.id === H.id);
            return N === -1 ? H : V[N] ? {
              ...H,
              status: "uploaded",
              uploadedFile: V[N]
...
function Y2({
  ...
  const [a, c] = I(!1), [d, l] = I(""), [f, u] = I([]), [C, g] = I(!1), [h, w] = I(0), [v, p] = I([]), k = $(-1), F = $(null), T = $(0), E = $(-1);
  z(() => {
    if (!o) {
      c(!1);
      return;
    ...
    const N = G2(e, n, v);
    if (!N) {
      c(!1), l(""), u([]), w(0), k.current = -1, E.current = -1;
      return;
    }
    if (N.atIndex === E.current)
      return;
    k.current = N.atIndex, l(N.query), c(!0), w(0), g(!0), F.current && clearTimeout(F.current);
    const B = ++T.current;
    return F.current = setTimeout(() => {
      o(N.query).then((j) => {
        B === T.current && (u(j), w(0), j.length === 0 && N.query.length > 0 && (E.current = N.atIndex, c(!1)));
      }).catch(() => {
        B === T.current && u([]);
      }).finally(() => {
        B === T.current && g(!1);
  ...
  const M = _(() => {
    ...
    (N) => {
      ...
      r(Y), p((a1) => [...a1.filter((c1) => !(c1.id === Z && c1.name === j)), { id: Z, name: j }]), M(), requestAnimationFrame(() => {
        const a1 = s.current;
...
const K2 = /[\\`*_{}[\]()#+\-.!|~>]/g, Q2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, n) => n % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(K2, "\\$&")).join(""), T4 = ({
  ...
  const N = G(), B = C1(), [j, Z] = I(""), [W, J] = I(0), [t1, Y] = I(!1), [K, a1] = I(!1), [p1, c1] = I(null), [q, d1] = I(!1), e1 = $(null), r1 = $(null), F1 = $(null), x1 = $(null);
  z(
    () => () => {
  ...
  const L = c != null, { tracking: y, setFocusChatInputFunction: R } = k1(), D = _(
    (O, v1) => {
  ...
  const ve = g1.status === "recording", Rr = ve ? N.ai.listening : N.ai.inputPlaceholder, Le = A.filter((O) => O.status === "uploaded"), P1 = A.some((O) => O.status === "uploading"), xe = A.some((O) => O.status === "error"), D1 = j.trim().length > 0 || Le.length > 0;
  z(() => {
    if (!(!K || P1)) {
      if (a1(!1), xe) {
  ...
  const Fr = async (O) => {
    ...
    F1.current && r1.current && (F1.current.scrollTop = r1.current.scrollTop);
  ...
  }), [j, l1.mentions, W, l1.inlineCompletion]), Ar = l1.mentions.length > 0 || l1.inlineCompletion !== null, T1 = x === "inside", H1 = F && !!E && E.length > 0 && !!M ? /* @__PURE__ */ t(
    D2,
    {
      suggestions: E,
      onItemClick: D,
  ...
  ), Ir = F && T && !!V && V.length > 0, Ne = T && F, { motionProps: Pr } = Xo(
    F,
    160,
    0.5
  );
  return /* @__PURE__ */ i(
    Q.div,
    {
      ...
      children: [
        ...
        k && F && T && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: k }),
...
function sr({
  ...
  const F = a && c ? Object.entries(a).map(([M, x]) => {
    const S = c[M], V = g?.(M, S, {
    ...
    if (!M) return !1;
    const x = Array.isArray(M.content) ? M.content[0] : M.content;
    return !(x?.type === "item" && x.text === "—");
  }) : [], T = F.slice(0, Be), E = F.length > Be;
  return /* @__PURE__ */ t(
    nr,
    {
      ...
      children: T.length > 0 && !p && /* @__PURE__ */ t("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ t(
        ss,
        {
          details: T.map((M) => ({
            title: M.label,
...
const ur = (e) => /* @__PURE__ */ t(At, { content: e, format: "markdown" }), G6 = ({
  ...
  z(() => {
    ...
    let F;
    if (u === "starting")
      F = setTimeout(() => C("writing"), Y6);
    else if (u === "writing")
      l < h.length ? F = setTimeout(() => f((T) => T + 1), q6) : C("holding");
    else if (u === "holding") {
      if (e.length <= 1) return;
      F = setTimeout(() => C("erasing"), K6);
    } else u === "erasing" && (l > 0 ? F = setTimeout(() => f((T) => T - 1), X6) : F = setTimeout(() => {
      d((T) => (T + 1) % e.length), C("starting");
    }, Q6));
    return () => {
      F && clearTimeout(F);
    };
...
const tl = {
  ...
  const { modal: x, handleSubmit: S, handleClose: V } = _6(
    ...
    const e1 = d1 === e.length - 1, r1 = {
      ...
      const R = e1 && y === q.assistantMessages.length - 1, D = q.userMessages.length + y, A = {
        message: L,
        inProgress: q.isInProgress,
        index: D,
        isCurrentMessage: R,
      ...
      return /* @__PURE__ */ t(
        ...
        {
          ...A,
          isGenerating: q.isInProgress && R,
          isLoading: q.isInProgress && R && !L.content
        },
        `${d1}-a-${y}`
      );
    };
...
const il = ({
  ...
  const x = (S) => {
    ...
    S.preventDefault(), E(P), M.current[P]?.focus();
  };
  return /* @__PURE__ */ i(
    "div",
    {
  ...
  } = s, S = $(null), V = F ?? "single", P = c > 1, H = a === 0, N = a === c - 1, B = P ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(a + 1),
    total: String(c)
  }) : void 0, j = k.length > 0, Z = (M ?? "").trim().length > 0, W = j || x && Z || T === !0, J = r === !0 && N, t1 = () => {
    J || l();
  }, Y = () => {
    J || f();
  }, K = (e1) => {
  ...
  }, a1 = N ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, p1 = T === !0 && !j && !(x && Z), c1 = () => {
...
function Oe(e, r, n, o) {
  const s = Math.max(1, Math.min(e, r)), a = Math.min(n, 20), d = Math.min(a + o, s), l = Math.min(d, Math.floor(e / 2)), f = Math.min(d, Math.floor(r / 2)), u = (c1) => c1 / e * 2 - 1, C = (c1) => c1 / r * 2 - 1, g = 0, h = e, w = 0, v = r, p = l, k = e - l, F = f, T = r - f, E = u(g), M = u(h), x = C(w), S = C(v), V = u(p), P = u(k), H = C(F), N = C(T), B = 0, j = 0, Z = 1, W = 1, J = l / e, t1 = 1 - l / e, Y = f / r, K = 1 - f / r, a1 = new Float32Array([
    // Top strip
    E,
    x,
    M,
...
class Z4 {
  ...
  setupGL() {
    ...
    const g = r.getUniformLocation(n, "uResolution"), h = r.getUniformLocation(n, "uTime"), w = r.getUniformLocation(n, "uBorderWidth"), v = r.getUniformLocation(n, "uGlowWidth"), p = r.getUniformLocation(n, "uBorderRadius"), k = r.getUniformLocation(n, "uColors"), F = r.getUniformLocation(n, "uGlowExponent"), T = r.getUniformLocation(n, "uGlowFactor");
    r.useProgram(n), r.uniform1f(w, this.options.borderWidth), r.uniform1f(v, this.options.glowWidth), r.uniform1f(p, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(F, 2), r.uniform1f(T, 1.8)) : (r.uniform1f(F, 1), r.uniform1f(T, 1));
    const E = (this.options.colors || pl).map(ml);
    for (let M = 0; M < E.length; M++)
      r.uniform3f(
        r.getUniformLocation(n, `uColors[${M}]`),
        ...E[M]
      );
...
class Rl {
  ...
  load = async (r) => {
    ...
    const C = 0, g = n.RGBA, h = 1, w = 1, v = 0, p = n.RGBA, k = n.UNSIGNED_BYTE, F = new Uint8Array([255, 255, 255, 0]), T = n.createTexture();
    if (n.bindTexture(n.TEXTURE_2D, T), n.texImage2D(
      ...
      return n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_S, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_T, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.LINEAR), this._webglTexture = T, this.source = S, this.isVideo = !0, S.play().then(() => this);
    }
    async function E() {
    ...
    let M = await E(), x = (M.width & M.width - 1) === 0 && (M.height & M.height - 1) === 0;
    return (r.wrapS !== rt || r.wrapT !== rt || r.minFilter !== tt && r.minFilter !== Q1) && !x && (M = this.makePowerOf2(M), x = !0), n.bindTexture(n.TEXTURE_2D, T), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, l), n.texImage2D(
      n.TEXTURE_2D,
      C,
      g,
      p,
...
function Nl({
  ...
  const h = $(null), w = $(null), v = $(null), p = $(null), k = $(void 0), F = $(void 0), T = $(!1), E = $(void 0), M = $(0), x = $([0, 0]), S = $([]), V = $(0), P = $(void 0), H = $({
    ...
    const R = "width" in L ? L.width ?? 0 : 0, D = "height" in L ? L.height ?? 0 : 0, A = H.current.iChannelResolution;
    if (!A) return;
    const U = Array.isArray(A.value) ? A.value : A.value = [];
    U[y * 3] = R * f, U[y * 3 + 1] = D * f, U[y * 3 + 2] = 0;
  }, j = () => {
    ...
    const [y = 0, R = 0] = ot(L), D = y - (E.current?.left ?? 0) - window.pageXOffset, A = (E.current?.height ?? 0) - R - (E.current?.top ?? 0) - window.pageYOffset;
    T.current = !0;
    ...
    const [y = 0, R = 0] = ot(L), D = y - (E.current?.left ?? 0), A = (E.current?.height ?? 0) - R - (E.current?.top ?? 0);
    if (l !== 1)
    ...
    if (!L) return;
    E.current = h.current?.getBoundingClientRect();
    const y = f, R = Math.floor(
      (E.current?.width ?? 1) * y
    ), D = Math.floor(
      (E.current?.height ?? 1) * y
    );
    if (L.canvas.width = R, L.canvas.height = D, H.current.iResolution?.isNeeded && p.current) {
    ...
    const R = w.current;
    if (!R) return null;
    const D = R.createShader(L);
    if (!D) return null;
    if (R.shaderSource(D, y), R.compileShader(D), !R.getShaderParameter(D, R.COMPILE_STATUS)) {
      g?.(b1(`Error compiling the shader:
${y}`));
      const A = R.getShaderInfoLog(D);
      R.deleteShader(D), C?.(b1(`Shader compiler log: ${A}`));
    }
    return D;
  }, p1 = (L, y) => {
    const R = w.current;
    if (!R) return;
    const D = a1(R.FRAGMENT_SHADER, L), A = a1(R.VERTEX_SHADER, y);
    if (p.current = R.createProgram(), !(!p.current || !A || !D)) {
      if (R.attachShader(p.current, A), R.attachShader(p.current, D), R.linkProgram(p.current), !R.getProgramParameter(p.current, R.LINK_STATUS)) {
        C?.(
          b1(
      ...
      R.useProgram(p.current), k.current = R.getAttribLocation(
        p.current,
        "aVertexPosition"
      ), R.enableVertexAttribArray(k.current);
    }
  }, c1 = () => {
    if (o)
      for (const L of Object.keys(o)) {
        const y = o[L];
        if (!y) continue;
        const { value: R, type: D } = y, A = yl(D);
        if (!A) continue;
        const U = {};
        if (Ll(D, R)) {
          const i1 = D.length, m1 = Number.parseInt(D.charAt(i1 - 3)), y1 = Math.floor(R.length / (m1 * m1));
          R.length > m1 * m1 && (U.arraySize = `[${y1}]`);
        } else xl(D, R) && (U.arraySize = `[${Math.floor(R.length / Number.parseInt(D.charAt(0)))}]`);
        H.current[L] = {
          type: A,
          isNeeded: !1,
          value: R,
      ...
      if (n && n.length > 0) {
        ...
        const y = n.map(
          (R, D) => (H.current[`${vl}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(R, D), S.current[D] = new Rl(L), S.current[D]?.load(R).then((A) => {
            B(A, D);
          }))
        );
        Promise.all(y).then(() => {
    ...
    const y = ze.includes(a ?? "highp"), R = `precision ${y ? a : ze[1]} float;
`;
    y || g?.(
      b1(
...
`,
    ...
    const R = V.current ? (L - V.current) / 1e3 : 0;
    V.current = L;
    const D = N.current;
    if (D)
      for (const A of Object.keys(D)) {
        const U = D[A];
        if (U && H.current[A]?.isNeeded) {
          if (!p.current) return;
    ...
    if (H.current.iMouse?.isNeeded) {
      ...
      y.uniform4fv(A, H.current.iMouse.value);
    }
    ...
    if (H.current.iDate?.isNeeded) {
      const A = /* @__PURE__ */ new Date(), U = A.getMonth() + 1, i1 = A.getDate(), m1 = A.getFullYear(), y1 = A.getHours() * 60 * 60 + A.getMinutes() * 60 + A.getSeconds() + A.getMilliseconds() * 1e-3, V1 = y.getUniformLocation(
        p.current,
        Xe
      );
    ...
    if (H.current.iFrame?.isNeeded) {
      ...
      y.uniform1i(A, U), H.current.iFrame.value = U + 1;
    }
    if (S.current.length > 0)
      for (let A = 0; A < S.current.length; A++) {
        const U = S.current[A];
        if (!U) return;
        const { isVideo: i1, _webglTexture: m1, source: y1, flipY: V1, isLoaded: I1 } = U;
        if (!I1 || !m1 || !y1) return;
        if (H.current[`iChannel${A}`]?.isNeeded) {
          if (!p.current) return;
    ...
    const R = H.current.iMouse?.value;
    if (H.current.iMouse?.isNeeded && l !== 1 && Array.isArray(R)) {
      const D = R[0] ?? 0, A = R[1] ?? 0;
      R[0] = st(D, x.current[0] ?? 0, l), R[1] = st(A, x.current[1] ?? 0, l);
    }
    F.current = requestAnimationFrame(r1);
  }, F1 = () => {
    const L = { passive: !0 };
  ...
  return z(() => {
    ...
    function y() {
      j();
      const R = w.current;
      R && h.current && (R.clearColor(...s), R.clearDepth(1), R.enable(R.DEPTH_TEST), R.depthFunc(R.LEQUAL), R.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, c1(), q(), p1(d1(e || wl), r || Ge), Z(), requestAnimationFrame(r1), F1(), K());
    }
    return requestAnimationFrame(y), () => {
      const R = w.current;
      if (R) {
        if (R.getExtension("WEBGL_lose_context")?.loseContext(), R.useProgram(null), R.deleteProgram(p.current ?? null), L.length > 0)
          for (const D of L)
            R.deleteTexture(D._webglTexture);
        p.current = null;
      }
      x1(), cancelAnimationFrame(F.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
), Pl = ({ isRevealed: e, onAskOne: r }) => {
  const n = G(), o = C1();
  return /* @__PURE__ */ t(L1, { children: r && e && /* @__PURE__ */ t(
    Q.div,
    {
      ...
      children: /* @__PURE__ */ t(hs, { size: "md", label: n.ai.ask, onClick: () => r() })
    }
  ) });
}, Dl = B1({
  base: [
...
const zl = ({
  ...
  (e, r) => {
    const {
      ...
      M.currentTarget === M.target && (M.key === "Enter" || M.key === " ") && (M.preventDefault(), c?.());
    };
    return /* @__PURE__ */ i(
      "div",
      {
        ...
        onFocus: () => h(!0),
        onBlur: (M) => {
          M.currentTarget.contains(M.relatedTarget) || h(!1);
        },
        children: [
          a && /* @__PURE__ */ i(N1, { children: [
            /* @__PURE__ */ t(
              "div",
              {
          ...
          /* @__PURE__ */ i(
            "div",
            {
              ...
              children: [
                n && /* @__PURE__ */ t("span", { className: b(_l(), "truncate"), children: n }),
          ...
          /* @__PURE__ */ t(Pl, { isRevealed: w, onAskOne: d })
        ]
      }
    );
  }
...
const X4 = ({
  ...
  const h = X(
    ...
    [f]
  ), M = v.length > 0 || k.length > 0;
  return jt(
    /* @__PURE__ */ i(N1, { children: [
      /* @__PURE__ */ t(
        "div",
        {
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ i("div", { className: "flex flex-1 flex-col gap-1 overflow-y-auto p-2", children: [
                  ...
                  !s && !a && !M && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: u.ai.noPreviousChats }),

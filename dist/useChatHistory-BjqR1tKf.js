...
import { useInsertionEffect as Hn, forwardRef as C, createElement as _e, useRef as $, useMemo as te, useEffect as K, useState as P, useLayoutEffect as Ot, useCallback as X, createContext as a1, useContext as Ge, useId as Zt } from "react";
import { cb as Bn, cc as $n, cd as In, ce as Pn, cf as Ut, cg as jn, ch as Dn, ci as _n, cj as On, ck as Zn, cl as zt, cm as Un, cn as zn, co as Gn, cp as Wn, cq as qn, cr as Xn, cs as Yn, ct as r1, cu as Kn, cv as Qn, cw as Jn, cx as eo, cy as to, cz as ro, W as Gt, cA as no, cB as oo, cC as so, cD as io, cE as ao, cF as Wt, cG as co, cH as lo, a3 as T1, cI as uo, aG as fo, cJ as ho, cK as go, cL as po, ad as mo, cM as Co, bJ as vo, a7 as A1, aa as wo, cN as xo, b7 as H1, _ as qt, N as c1, cO as Xt, b6 as ko, cP as bo, cQ as Lo, a$ as yo, bI as Mo, Y as Me, ar as Eo, bb as Yt, cR as Ro, bG as Kt, cS as Ne, bC as No, cT as Fo, cU as Qt, a_ as Jt, cV as So, cW as Vo, cX as To, cY as Ao, cZ as Ho, c_ as er, bu as Bo, bv as $o, c$ as Io, d0 as Po, d1 as jo, d2 as Do, d3 as _o, d4 as Oo, d5 as Zo, d6 as Uo, d7 as zo, d8 as Go, d9 as Wo, da as qo, db as Xo, bH as Yo, a8 as Ko, bq as Qo, dc as Jo, dd as es, de as ts, df as rs, dg as ns, dh as os, di as ss, am as is, dj as tr, J as as, Z as cs, dk as rr, dl as ls, ba as ds, b9 as us, dm as fs, dn as nr, dp as hs, aZ as gs, av as ps, dq as ms, ap as Cs, b4 as vs, dr as or, b3 as ws, ds as xs, bf as B1, dt as ks, du as $1, bE as bs, bD as Ls, bF as sr, dv as ys, z as Ms, y as Es, dw as Rs, dx as Ns, dy as Fs, dz as Ss, dA as Vs, dB as ir, dC as Ts, a9 as As, dD as Hs, H as he, o as Se, m as E, ab as fe, dE as Bs, bk as $s, bx as Is, w as ar, dF as Ps, a2 as l1, bW as js, aq as Ds, M as Ce, C as ce, a5 as cr, ac as lr, bl as dr, dG as _s, dH as Os, dI as Zs, S as ge, u as ee, c9 as ur, s as ve, $ as Us, dJ as zs, aM as Le, A as Fe, n as oe, aA as I1, dK as Gs, aB as P1, aC as j1, b as Ee, dL as Ws, by as qs, O as Xs, aY as Ys, dM as Ks, dN as Qs, dO as Js, dP as Q1, a0 as ei, ah as fr, aP as hr, dQ as ti, bV as ri, dR as ni, dS as oi, aU as gr, dT as si, bP as ii, dU as ai, aR as ze, bd as pr, dV as mr, be as Cr, dW as vr, dX as ci, bh as li, dY as di, b5 as D1, br as ui, dZ as fi, d_ as hi, d$ as gi, e0 as pi, e1 as mi, x as Ci, e2 as wr, e3 as xr, e4 as vi, ag as J1, e5 as wi, af as xi, e6 as ki, e7 as bi } from "./F0CanvasPanel-CC0-kGJd.js";
...
function Hi(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let g = 0; g < e.length; g++) {
    ...
    let A = 0;
    const F = (R, M, L, S = 0, b = 0) => {
      const V = Bi(R), { delay: k = 0, times: y = jn(V), type: T = "keyframes", repeat: j, repeatType: _, repeatDelay: Z = 0, ...G } = M;
      let { ease: q = t.ease || "easeOut", duration: U } = M;
      const z = typeof k == "function" ? k(S, b) : k, O = V.length, J = On(T) ? T : s?.[T];
      if (O <= 2 && J) {
        let se = 100;
        if (O === 2 && Pi(V)) {
          const ue = V[1] - V[0];
      ...
      const le = y.length - V.length;
      if (le > 0 && _n(y, le), V.length === 1 && V.unshift(null), j) {
        ...
        for (let ue = 0; ue < j; ue++) {
          ...
          for (let N = 0; N < se.length; N++)
            y.push(re[N] + (ue + 1)), q.push(N === 0 ? "linear" : Lr(ie, N - 1));
        }
        Si(y, j);
      }
      const de = Y + U;
      Fi(L, V, q, y, Y, de), A = Math.max(z + U, A), m = Math.max(de, m);
    };
    if (Ut(w)) {
      const R = tt(w, l);
      F(v, x, rt("default", R));
    } else {
      const R = br(w, v, o, c), M = R.length;
      for (let L = 0; L < M; L++) {
        v = v, x = x;
        const S = R[L], b = tt(S, l);
        for (const V in v)
          F(v[V], $i(x, V), rt(V, b), L, M);
      }
    }
    u = h, h += A;
  }
  return l.forEach((g, p) => {
    for (const w in g) {
      ...
      for (let M = 0; M < v.length; M++) {
        const { at: L, value: S, easing: b } = v[M];
        x.push(S), A.push(Un(0, m, L)), F.push(b || "easeOut");
      }
      A[0] !== 0 && (A.unshift(0), x.unshift(x[0]), F.unshift(Ti)), A[A.length - 1] !== 1 && (A.push(1), x.push(null)), a.has(p) || a.set(p, {
        keyframes: {},
        transition: {}
      });
      const R = a.get(p);
    ...
    if (i !== void 0) {
      ...
      return m ? _e(
        ...
        fe,
        {
          ...
          noTooltip: a,
          tag: h,
          className: E(je({ variant: t, align: n }), o),
          markdown: l,
          ...f,
          children: e
        }
...
function nt({
  ...
  }), p = a === "none" ? !0 : a === "container-md" ? h >= v1["container-md"] : g, w = typeof o == "string" ? o : o.base, v = typeof o == "string" ? o : o.md, x = p ? v : w, A = Array.isArray(
    t
  ) ? t : [], F = t != null && !Array.isArray(t) ? t : void 0, R = {
    primaryAction: e,
    secondaryItems: A,
    secondaryLink: F,
    otherActions: n,
...
function A2({
  ...
  const p = g ? h : l, w = g ? m : [], v = new Set(p.map((b) => b.id)), x = e ? Xr(e, s) : null, A = t.filter(n1), F = t[t.length - 1], R = F != null && F1(F) && (A.length > 0 || x != null), M = [];
  t.forEach((b, V) => {
    if (!n1(b)) {
      if (F1(b)) {
        M.push({ kind: "sep", key: `sep-${V}` });
        return;
      }
      v.has(b.id) && M.push({
        kind: "node",
  ...
  const L = M.filter(
    (b, V) => b.kind === "node" || M[V - 1]?.kind === "node" && M[V + 1]?.kind === "node"
  ), S = [
    ...w.map(
      (b) => ({
        label: b.label,
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          S.length > 0 && /* @__PURE__ */ r("div", { ref: u, children: /* @__PURE__ */ r(l1, { items: S, icon: Qt, size: s }) }),
          L.map(
...
function j2({
  ...
  const f = E(
    ...
    w1[l],
    l !== "never" && a && "mt-3 pt-3"
  ), u = (p) => /* @__PURE__ */ r("div", { className: f, children: p });
  if (o || s) {
    const p = (v) => {
      const x = s ? {
        id: "reject",
      ...
      /* @__PURE__ */ r("div", { className: E("min-w-0 flex-1", $2[l]), children: p(!0) })
    );
...
const Yr = C(
  function({
    ...
    const v = !!g && g.visible !== !1, x = /* @__PURE__ */ r(
      dr,
      {
        ref: v ? void 0 : w,
        className: E(
        ...
        style: v ? {
          borderColor: _s[g.variant],
          borderWidth: "2px"
        } : void 0,
        "data-testid": "card",
        children: /* @__PURE__ */ d("div", { className: H2[p], children: [
    ...
    return v ? /* @__PURE__ */ r(Zs, { ref: w, alert: g, fullHeight: m, children: x }) : x;
  }
);
  ...
  return K(() => {
    ...
    if (s)
      return u(!1), a(p), w(), h.current = setTimeout(() => {
        const M = (l + 1) % Math.max(e.length, 1);
        c(M);
      }, 4e3), () => {
        w();
      };
...
function d4({
  ...
  const [i, a] = P("idle"), [l, c] = P(0), [f] = P(l4), [u, h] = P(null), m = $(null), g = $(null), p = $([]), w = $(null), v = $(!1), x = $(null), A = $(null), F = $(0), R = $({ onTranscribe: e, onPartial: t, onFinal: n, onError: o });
  R.current = { onTranscribe: e, onPartial: t, onFinal: n, onError: o };
  const M = X(() => {
    g.current?.getTracks().forEach((k) => k.stop()), g.current = null, m.current = null, h(null), x.current && (clearInterval(x.current), x.current = null), A.current && (clearTimeout(A.current), A.current = null);
  }, []), L = X(async () => {
    const { onTranscribe: k, onPartial: y, onFinal: T, onError: j } = R.current, _ = p.current;
    ...
    m.current = y, y.ondataavailable = (T) => {
      ...
      L();
    }, y.start(a4), F.current = Date.now(), a("recording"), c(0), x.current = setInterval(() => {
      c(Date.now() - F.current);
  ...
  return K(
    () => () => {
      ...
      const k = m.current;
      k && k.state !== "inactive" && k.stop(), M();
    },
    [M]
  ), { status: i, durationMs: l, isSupported: f, stream: u, start: b, stop: S, cancel: V };
}
function u4(e, t) {
  if (t === "*/*") return !0;
  if (t.endsWith("/*")) {
...
function g4(e) {
  ...
  const p = X((F) => {
    i.current && clearTimeout(i.current), s(F), i.current = setTimeout(() => {
  ...
  const w = X(
    async (F) => {
      ...
      try {
        ...
        n(
          (V) => V.map((k) => {
            const y = M.findIndex((T) => T.id === k.id);
            return y === -1 ? k : b[y] ? {
              ...k,
              status: "uploaded",
              uploadedFile: b[y]
        ...
        const V = b instanceof Error && b.message ? b.message : l.ai.fileUploadError;
        S(V);
      }
    },
    [
    ...
    async (F) => {
      await w(Array.from(F.target.files ?? [])), F.target.value = "";
    },
    [w]
  ), x = X((F) => {
    n((R) => R.filter((M) => M.id !== F));
  }, []), A = X(() => {
    n([]);
  }, []);
  return {
...
function w4({
  ...
  const [i, a] = P(!1), [l, c] = P(""), [f, u] = P([]), [h, m] = P(!1), [g, p] = P(0), [w, v] = P([]), x = $(-1), A = $(null), F = $(0), R = $(-1);
  K(() => {
    if (!o) {
      a(!1);
      return;
    ...
    if (y.atIndex === R.current)
      return;
    x.current = y.atIndex, c(y.query), a(!0), p(0), m(!0), A.current && clearTimeout(A.current);
    const T = ++F.current;
    return A.current = setTimeout(() => {
      o(y.query).then((j) => {
        T === F.current && (u(j), p(0), j.length === 0 && y.query.length > 0 && (R.current = y.atIndex, a(!1)));
      }).catch(() => {
        T === F.current && u([]);
      }).finally(() => {
        T === F.current && m(!1);
  ...
  const M = X(() => {
    ...
    (y) => {
      const T = x.current;
      if (T === -1) return;
      const j = `${y.firstName} ${y.lastName}`.trim(), _ = String(y.id), Z = e.slice(0, T), G = e.slice(n), q = `@${j} `, U = Z + q + G, z = Z.length + q.length;
      t(U), v((O) => [...O.filter((Y) => !(Y.id === _ && Y.name === j)), { id: _, name: j }]), M(), requestAnimationFrame(() => {
        const O = s.current;
...
` || Z === "	";
  ...
  const V = te(() => {
    ...
    const y = s.current;
    if (!y) return null;
    const T = C4(y, x.current), j = y.offsetLeft + T.left, Z = (y.offsetParent ? y.offsetParent.offsetHeight : 0) - (y.offsetTop + T.top);
...
const x4 = /[\\`*_{}[\]()#+\-.!|~>]/g, k4 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(x4, "\\$&")).join(""), h3 = ({
  ...
  const L = ee(), S = Le(), [b, V] = P(""), [k, y] = P(0), [T, j] = P(!1), [_, Z] = P(!1), [G, q] = P(null), U = $(null), z = $(null), O = $(null), J = a != null, { tracking: Y } = Ee(), le = X(
    (ne, be) => {
  ...
  }, G1 = G ? G.prompt ?? G.title : null, W1 = We ? [L.ai.listening] : G1 ? [G1] : s ?? [], Fn = W1.length > 1, Sn = te(() => i4(b, Q.mentions, {
    cursorPosition: k,
    inlineCompletion: Q.inlineCompletion
  }), [b, Q.mentions, k, Q.inlineCompletion]), Vn = Q.mentions.length > 0 || Q.inlineCompletion !== null, Ke = x && !!F && F.length > 0 && !!R ? /* @__PURE__ */ r(
    s4,
    {
      suggestions: F,
      onItemClick: le,
    ...
    oe.div,
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          Ke && !A && /* @__PURE__ */ r("div", { children: Ke }),
        ...
        Ke && A && /* @__PURE__ */ r("div", { className: "w-full max-w-content", children: Ke }),
...
function R4({
  ...
  return /* @__PURE__ */ r(Ys, { ...t, variant: "link", href: t.href, children: e });
}
function N4({
  children: e,
  ...t
...
const on = 60, sn = 40, lt = 2e3, t6 = 500, r6 = 12e3, an = 2, Oe = 40, He = [255, 60, 0], x1 = [160, 140, 220], k1 = { x: -12, y: 0, z: 0 }, b1 = { x: -12, y: 12, z: 90 }, Be = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, L1 = Math.PI / 180, n6 = an / 8 * Math.PI, o6 = 4 * Math.PI;
function s1(e, t) {
  return [
...
const ut = Math.sqrt(on ** 2 + sn ** 2), y1 = [on / ut, sn / ut, 0], u6 = cn(k1.x, k1.y, k1.z), f6 = cn(b1.x, b1.y, b1.z), $e = an * 3, t1 = Oe + 1, ft = ($e + 1) * t1, i1 = 4 * $e * Oe, M1 = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
...
function ht(e, t, n, o) {
  ...
  let w = 0;
  for (let v = 0; v < 4; v++) {
    const x = M1[v >> 1], A = v & 1 ? -1 : 1;
    for (let F = 0; F <= $e; F++) {
      const R = A * (Math.PI / 2 - F / $e * f), M = Math.cos(R), L = Math.sin(R), S = Math.sin(F / $e * Math.PI), b = F * t1;
      for (let V = 0; V <= Oe; V++) {
        const k = V / Oe * Math.PI * 2;
        dt(x, M * Math.cos(k), L, M * Math.sin(k), Re);
        const y = i[b + V];
        y.x = Re[0], y.y = Re[1], y.z = Re[2], y.t = S;
      }
    }
    for (let F = 0; F < $e; F++) {
      const R = F * t1, M = (F + 1) * t1;
      for (let L = 0; L < Oe; L++) {
        const S = i[R + L], b = i[R + L + 1], V = i[M + L], k = i[M + L + 1];
        if ((S.t + b.t + V.t + k.t) * 0.25 < 1e-3) continue;
        const T = (S.x + b.x + V.x + k.x) * 0.25, j = (S.y + b.y + V.y + k.y) * 0.25, _ = (S.z + b.z + V.z + k.z) * 0.25, Z = T * a, G = j * a, q = S.x * a - Z, U = S.y * a - G, z = Math.sqrt(q * q + U * U), O = z > 0 ? (z + 0.9) / z : 1, J = l + Z + q * O, Y = c - G - U * O, le = b.x * a - Z, de = b.y * a - G, se = Math.sqrt(le * le + de * de), re = se > 0 ? (se + 0.9) / se : 1, ie = l + Z + le * re, ue = c - G - de * re, N = k.x * a - Z, B = k.y * a - G, H = Math.sqrt(N * N + B * B), D = H > 0 ? (H + 0.9) / H : 1, I = l + Z + N * D, W = c - G - B * D, ae = V.x * a - Z, Q = V.y * a - G, pe = Math.sqrt(ae * ae + Q * Q), xe = pe > 0 ? (pe + 0.9) / pe : 1, Ve = l + Z + ae * xe, me = c - G - Q * xe, Te = s[w];
        Te.points = `${J},${Y} ${ie},${ue} ${I},${W} ${Ve},${me}`, Te.color = c6((T + 1) * 0.5), Te.avgZ = _, w++;
      }
    }
  }
  for (let v = w; v < i1; v++)
...
const p6 = ({ size: e = 20, className: t, style: n, variant: o = "default" }, s) => {
  ...
  return K(() => {
    ...
    let p = null, w = 0, v = 0, x = 0, A = null, F = "spin", R = !0, M = !1;
    const L = (y) => {
      const T = g.quads;
      ...
      } else F === "spin" ? (T = Math.min((y - w) / lt, 1), T >= 1 && (T = 0, F = "pause", x = y)) : (T = 0, y - x >= t6 && (F = "spin", w = y));
      const _ = (y - v) / r6 % 1, Z = j ? i6(T) : T, G = ht(g, Z, e, _);
      L(G), p = requestAnimationFrame(S);
    }, b = () => {
      p === null && (p = requestAnimationFrame(S));
    }, V = () => {
...
function fn({
  ...
  const A = i && a ? Object.entries(i).map(([M, L]) => {
    const S = a[M], b = m?.(M, S, {
      fieldType: L.fieldType,
      customFieldName: L.customFieldName
    });
    if (!b && L.fieldType === "custom" && typeof S == "object" && S !== null)
      return null;
    const V = b ?? un(S, L.fieldType), k = ["richtext", "textarea"];
    return {
      label: L.label,
      content: V,
    ...
    if (!M) return !1;
    const L = Array.isArray(M.content) ? M.content[0] : M.content;
    return !(L?.type === "item" && L.text === "—");
  }) : [], F = A.slice(0, pt), R = A.length > pt;
  return /* @__PURE__ */ r(
    dn,
    {
      ...
      children: F.length > 0 && !v && /* @__PURE__ */ r("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ r(
        ri,
        {
          details: F.map((M) => ({
            title: M.label,
...
const pn = a1(void 0), v3 = () => Ge(pn), y6 = (e) => /* @__PURE__ */ r(gr, { content: e, format: "markdown" }), M6 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
...
const vn = (e) => /* @__PURE__ */ r(gr, { content: e, format: "markdown" }), H6 = ({
  text: e,
  renderMarkdown: t
  ...
  const a = e.rawData, l = A6(
    e?.content,
    a
  ), c = (T6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = c.length > 0, { anchor: h, clear: m } = hn({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ d(
...
function O6({
  ...
  const g = X(() => {
    const p = e.current;
    if (!p) return;
    const { scrollTop: w, scrollHeight: v, clientHeight: x } = p, A = v - w - x;
    f(A > x);
  }, [e]);
  return K(() => {
    const p = e.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!p || !w) return;
        const v = p.getBoundingClientRect(), x = w.getBoundingClientRect(), A = p.scrollTop + (x.top - v.top);
        p.scrollTo({ top: A, behavior: "smooth" });
      });
    }), s === 0 && f(!1), u.current = s;
...
const Z6 = {
  ...
  const { modal: F, handleSubmit: R, handleClose: M } = N6(
    u ?? Z6
  ), L = ee(), S = w ?? M6, b = v ?? B6, V = te(() => {
    const O = o ?? L.ai.defaultInitialMessage;
    return (Array.isArray(O) ? O : [O]).filter((Y) => typeof Y == "string" && Y.length > 0);
  }, [o, L.ai.defaultInitialMessage]), k = !t && e.length === 0 && V.length > 0, y = $(null), T = $(null), j = $(null), _ = $(null), Z = $(null), { showScrollBtn: G, turnMinHeight: q, scrollToBottom: U } = O6({
    viewportRef: y,
    contentRef: T,
    endRef: j,
    lastTurnRef: Z,
    ...
    const Y = J === e.length - 1, le = {
      ...
      const ue = Y && ie === O.assistantMessages.length - 1, N = O.userMessages.length + ie, B = {
        message: re,
        inProgress: O.isInProgress,
        index: N,
        isCurrentMessage: ue,
...
const X6 = ({
  ...
  const x = Le(), A = (() => {
    ...
    const S = n.findIndex((b) => o.includes(b.id));
    return S >= 0 ? S : 0;
  })(), [F, R] = P(A), M = $([]);
  K(() => {
    h && e === "single" && M.current[F]?.focus();
  }, []);
  const L = (S) => {
    if (e !== "single") return;
    const b = n.length - 1;
    ...
    S.preventDefault(), R(V), M.current[V]?.focus();
  };
  return /* @__PURE__ */ d(
    "div",
    {
  ...
  } = s, S = $(null), b = A ?? "single", V = a > 1, k = i === 0, y = i === a - 1, T = V ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  }) : void 0, j = x.length > 0, _ = (M ?? "").trim().length > 0, Z = j || L && _ || F === !0, G = t === !0 && y, q = () => {
    G || c();
  }, U = () => {
    G || f();
  }, z = (se) => {
  ...
  }, O = y ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, J = F === !0 && !j && !(L && _), Y = () => {
...
function bt(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), l = Math.min(i + o, s), c = Math.min(l, Math.floor(e / 2)), f = Math.min(l, Math.floor(t / 2)), u = (Y) => Y / e * 2 - 1, h = (Y) => Y / t * 2 - 1, m = 0, g = e, p = 0, w = t, v = c, x = e - c, A = f, F = t - f, R = u(m), M = u(g), L = h(p), S = h(w), b = u(v), V = u(x), k = h(A), y = h(F), T = 0, j = 0, _ = 1, Z = 1, G = c / e, q = 1 - c / e, U = f / t, z = 1 - f / t, O = new Float32Array([
    // Top strip
    R,
    L,
    M,
...
class M3 {
  ...
  setupGL() {
    ...
    const m = t.getUniformLocation(n, "uResolution"), g = t.getUniformLocation(n, "uTime"), p = t.getUniformLocation(n, "uBorderWidth"), w = t.getUniformLocation(n, "uGlowWidth"), v = t.getUniformLocation(n, "uBorderRadius"), x = t.getUniformLocation(n, "uColors"), A = t.getUniformLocation(n, "uGlowExponent"), F = t.getUniformLocation(n, "uGlowFactor");
    t.useProgram(n), t.uniform1f(p, this.options.borderWidth), t.uniform1f(w, this.options.glowWidth), t.uniform1f(v, this.options.borderRadius), this.options.mode === "dark" ? (t.uniform1f(A, 2), t.uniform1f(F, 1.8)) : (t.uniform1f(A, 1), t.uniform1f(F, 1));
    const R = (this.options.colors || n9).map(o9);
    for (let M = 0; M < R.length; M++)
      t.uniform3f(
        t.getUniformLocation(n, `uColors[${M}]`),
        ...R[M]
      );
...
class g9 {
  ...
  load = async (t) => {
    ...
    const h = 0, m = n.RGBA, g = 1, p = 1, w = 0, v = n.RGBA, x = n.UNSIGNED_BYTE, A = new Uint8Array([255, 255, 255, 0]), F = n.createTexture();
    if (n.bindTexture(n.TEXTURE_2D, F), n.texImage2D(
      n.TEXTURE_2D,
      h,
      m,
      g,
      ...
      return n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_S, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_T, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.LINEAR), this._webglTexture = F, this.source = S, this.isVideo = !0, S.play().then(() => this);
    }
    async function R() {
    ...
    let M = await R(), L = (M.width & M.width - 1) === 0 && (M.height & M.height - 1) === 0;
    return (t.wrapS !== Bt || t.wrapT !== Bt || t.minFilter !== Ht && t.minFilter !== E1) && !L && (M = this.makePowerOf2(M), L = !0), n.bindTexture(n.TEXTURE_2D, F), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, c), n.texImage2D(
      n.TEXTURE_2D,
      h,
      m,
      v,
      ...
      this.magFilter || E1
    ), this._webglTexture = F, this.source = M, this.isVideo = !1, this.isLoaded = !0, this.width = M.width || 0, this.height = M.height || 0, this;
  };
}
...
function m9({
  ...
  const g = $(null), p = $(null), w = $(null), v = $(null), x = $(void 0), A = $(void 0), F = $(!1), R = $(void 0), M = $(0), L = $([0, 0]), S = $([]), b = $(0), V = $(void 0), k = $({
    ...
    const H = "width" in N ? N.width ?? 0 : 0, D = "height" in N ? N.height ?? 0 : 0, I = k.current.iChannelResolution;
    if (!I) return;
    ...
    const N = p.current;
    w.current = N?.createBuffer() ?? null, N?.bindBuffer(N.ARRAY_BUFFER, w.current);
    const B = [
      1,
      1,
      0,
    ...
    N?.bufferData(N.ARRAY_BUFFER, new Float32Array(B), N.STATIC_DRAW);
  }, Z = ({
    alpha: N,
    beta: B,
    gamma: H
    ...
    const [B = 0, H = 0] = It(N), D = B - (R.current?.left ?? 0) - window.pageXOffset, I = (R.current?.height ?? 0) - H - (R.current?.top ?? 0) - window.pageYOffset;
    F.current = !0;
    ...
    const [B = 0, H = 0] = It(N), D = B - (R.current?.left ?? 0), I = (R.current?.height ?? 0) - H - (R.current?.top ?? 0);
    if (c !== 1)
    ...
    const N = Array.isArray(k.current.iMouse?.value) ? k.current.iMouse.value : void 0;
    N && (N[2] = 0, N[3] = 0);
  }, z = () => {
    const N = p.current;
    if (!N) return;
    ...
    if (N.canvas.width = H, N.canvas.height = D, k.current.iResolution?.isNeeded && v.current) {
      const I = N.getUniformLocation(
        v.current,
        Vt
      );
      N.uniform2fv(I, [N.canvas.width, N.canvas.height]);
    }
  }, O = (N, B) => {
    const H = p.current;
    if (!H) return null;
    const D = H.createShader(N);
    if (!D) return null;
...
${B}`));
    ...
    const H = p.current;
    if (!H) return;
    const D = O(H.FRAGMENT_SHADER, N), I = O(H.VERTEX_SHADER, B);
      ...
      if (n && n.length > 0) {
        ...
        const B = n.map(
          (H, D) => (k.current[`${a9}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, T(H, D), S.current[D] = new g9(N), S.current[D]?.load(H).then((I) => {
            T(I, D);
          }))
        );
        Promise.all(B).then(() => {
...
`).concat(N.replace(/texture\(/g, "texture2D("));
...
`,
    ...
    return N.includes("mainImage") && (D = D.concat(s9)), D;
  }, se = (N) => {
    const B = p.current;
    if (!B || !v.current) return;
    const H = b.current ? (N - b.current) / 1e3 : 0;
    b.current = N;
    const D = y.current;
    if (D)
    ...
    B.viewport(0, 0, B.drawingBufferWidth, B.drawingBufferHeight), B.clear(B.COLOR_BUFFER_BIT | B.DEPTH_BUFFER_BIT), B.bindBuffer(B.ARRAY_BUFFER, w.current), B.vertexAttribPointer(
      ...
      0,
      0
    ), se(N), B.drawArrays(B.TRIANGLE_STRIP, 0, 4);
    ...
    const N = { passive: !0 };
    k.current.iMouse?.isNeeded && g.current && (g.current.addEventListener("mousemove", q, N), g.current.addEventListener("mouseout", U, N), g.current.addEventListener("mouseup", U, N), g.current.addEventListener("mousedown", G, N), g.current.addEventListener("touchmove", q, N), g.current.addEventListener("touchend", U, N), g.current.addEventListener("touchstart", G, N)), k.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      Z,
      N
    ), g.current && (V.current = new ResizeObserver(z), V.current.observe(g.current), window.addEventListener("resize", z, N));
  }, ue = () => {
    const N = { passive: !0 };
    k.current.iMouse?.isNeeded && g.current && (g.current.removeEventListener("mousemove", q, N), g.current.removeEventListener("mouseout", U, N), g.current.removeEventListener("mouseup", U, N), g.current.removeEventListener("mousedown", G, N), g.current.removeEventListener("touchmove", q, N), g.current.removeEventListener("touchend", U, N), g.current.removeEventListener("touchstart", G, N)), k.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      Z,
      N
    ), V.current && (V.current.disconnect(), window.removeEventListener("resize", z, N));
  };
  return K(() => {
    y.current = o;
  }, [o]), K(() => {
    ...
    return requestAnimationFrame(B), () => {
      const H = p.current;
      if (H) {
        if (H.getExtension("WEBGL_lose_context")?.loseContext(), H.useProgram(null), H.deleteProgram(v.current ?? null), N.length > 0)
          for (const D of N)
...
const R3 = ({
  ...
  const o = ee(), s = Le();
  return /* @__PURE__ */ d(ke, { children: [
    e && /* @__PURE__ */ r("span", { className: E(R9(), "truncate"), children: e }),
  ...
  return /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: E(Ln()), children: t }),
    /* @__PURE__ */ d(
      oe.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ d("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ r("span", { className: E(e1()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ r(
            li,
            {
...
const A9 = ({
  ...
  const s = `sparkline-gradient-${Zt().replace(/:/g, "")}`, i = T9(e, n), a = yn[i];
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: E(Ln()), children: o }),
              /* @__PURE__ */ r(
                oe.div,
                {
...
const I9 = () => /* @__PURE__ */ d(
  ...
  "balance",
  "sparkline"
], Rn = 180, P9 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Rn, j9 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, D9 = (e) => e.showActions !== !1, _9 = (e) => Object.fromEntries(
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "flex flex-1 flex-col gap-1 overflow-y-auto p-2", children: [
                  ...
                  !s && !i && !M && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: u.ai.noPreviousChats }),

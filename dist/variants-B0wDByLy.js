...
}), cu = C(function({ size: e, icon: t, state: n = "normal", color: r = "currentColor", ...i }, a) {
	if (!t) return null;
	let o = t, s = t.displayName?.includes("Animated"), c = r.startsWith("#"), l = ((e) => e === "currentColor" ? "text-current" : e === "default" ? "text-f1-icon" : e.startsWith("#") ? "" : `text-f1-icon-${e}`)(r), d = c ? { color: r } : void 0;
...
var fu = /* @__PURE__ */ i(((e) => {
	...
	t.exports = h;
})), hu = pu(), gu = /* @__PURE__ */ n(mu(), 1), _u = typeof window < "u" ? ie : E;
function vu(e, t, n, r) {
	let i = O(t);
	_u(() => {
		i.current = t;
...
var yu = typeof window > "u";
function bu(e, { defaultValue: t = !1, initializeWithValue: n = !0 } = {}) {
	let r = (e) => yu ? t : window.matchMedia(e).matches, [i, a] = k(() => n ? r(e) : t);
	function o() {
		a(r(e));
	}
	return _u(() => {
...
function Su(e, t = 500, n) {
	let r = O();
	xu(() => {
		r.current && r.current.cancel();
	});
	let i = D(() => {
		let i = (0, gu.default)(e, t, n), a = (...e) => i(...e);
		return a.cancel = () => {
			i.cancel();
...
function Cu(e, t, n) {
	let r = n?.equalityFn ?? ((e, t) => e === t), i = e instanceof Function ? e() : e, [a, o] = k(i), s = O(i), c = Su(o, t, n);
	return r(s.current, i) || (c(i), s.current = i), [a, c];
}
function wu({ threshold: e = 0, root: t = null, rootMargin: n = "0%", freezeOnceVisible: r = !1, initialIsIntersecting: i = !1, onChange: a } = {}) {
...
function Ou(e) {
	let { ref: t, box: n = "content-box" } = e, [{ width: r, height: i }, a] = k(Du), o = Tu(), s = O({ ...Du }), c = O(void 0);
	return c.current = e.onResize, E(() => {
		if (!t.current || typeof window > "u" || !("ResizeObserver" in window)) return;
		let e = new ResizeObserver(([e]) => {
			let t = n === "border-box" ? "borderBoxSize" : n === "device-pixel-content-box" ? "devicePixelContentBoxSize" : "contentBoxSize", r = ku(e, t, "inlineSize"), i = ku(e, t, "blockSize");
...
var Au = () => bu("(prefers-reduced-motion: reduce)", {
...
function Nu({ emoji: e, size: t, alt: n, mode: r = "image" }) {
	let i = r === "native" ? null : Pu(e), a = {
		initial: { scale: .75 },
		animate: { scale: 1 },
		exit: { scale: .75 },
		transition: {
	...
	return r === "native" ? /* @__PURE__ */ A(ou.span, {
		className: u(ju({ size: t }), Mu({ size: t }), "inline-flex items-center justify-center leading-none font-emoji"),
...
var Pu = (e) => {
	let [t] = (0, hu.parse)(e, { buildUrl: (e) => `https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/${e}.svg` });
	return t || null;
};
function Fu(e) {
	return `${e} emoji`;
...
}, Vu = (e) => typeof e == "object" && !!e && !Array.isArray(e), Hu = (e, t) => {
	let n = { ...e };
	for (let [e, r] of Object.entries(t)) {
		if (r === void 0) continue;
		let t = n[e];
		n[e] = Vu(r) && Vu(t) ? Hu(t, r) : r;
	}
	return n;
};
function Uu({ children: e, translations: t }) {
	let n = D(() => Hu(h, t), [t]), r = (e, t = {}) => {
		let r = Bu(e, n);
		if (r === void 0) return console.warn(`Translation key ${e} not found`), e;
		for (let [e, n] of Object.entries(t)) r = r.replace(`{{${e}}}`, n.toString());
		return r;
	};
	return /* @__PURE__ */ A(zu.Provider, {
		value: {
			...n,
			t: r
		},
...
function Zu({ keys: e, variant: t }) {
	...
	return /* @__PURE__ */ oe("div", {
		...
		children: [/* @__PURE__ */ A("span", {
			...
			let r = e.toLowerCase(), a = Xu(r), o = a ? i[r] : e, s = typeof o != "string";
			return /* @__PURE__ */ A("kbd", {
				className: u(qu({ variant: t }), a ? "" : "uppercase", s ? "w-5 px-0.5" : "min-w-5 px-1"),
				children: s ? /* @__PURE__ */ A(lu, {
					icon: o,
					size: "sm"
				}) : o
			}, n);
...
var Qu = s(ce("Shortcut", Zu));
//#endregion
//#region src/experimental/Overlays/Tooltip/index.tsx
function $u({ label: e, description: t, items: n, children: r, shortcut: i, instant: a = !1, delay: o = 700, onOpen: s }) {
...
//#endregion
export { jn as $, iu as A, Ms as B, Eu as C, lu as D, du as E, Cl as F, li as G, Wa as H, Sl as I, ai as J, ci as K, qc as L, Ul as M, Tl as N, cu as O, wl as P, W as Q, uc as R, bu as S, pu as T, Ta as U, X as V, yi as W, Gr as X, ri as Y, q as Z, Au as _, ud as a, Je as at, wu as b, $u as c, F as ct, Ku as d, me as dt, Nn as et, Gu as f, fe as ft, Iu as g, Fu as h, ce as ht, cd as i, R as it, tu as j, ou as k, Qu as l, Ee as lt, Nu as m, le as mt, sd as n, Tn as nt, rd as o, Ge as ot, Ru as p, ue as pt, si as q, ld as r, H as rt, td as s, I as st, od as t, En as tt, Uu as u, Se as ut, Su as v, Ou as w, _u as x, Cu as y, lc as z };

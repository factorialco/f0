import { d as e, t } from "./OneEllipsis-CJ3poPeP.js";
import { D as n, S as r, f as i, ht as a, s as o } from "./variants-CSJ-yF0i.js";
import { n as s, t as c } from "./utils-CVzxZnoI.js";
import { E as l, F as u, M as d, O as f, P as p, c as m, d as h, f as g, i as _, l as v, n as y, o as ee, p as b, r as x, s as S, t as C, u as w } from "./tooltip-BbudvOFU.js";
import { i as te, l as T, m as ne, r as E, u as D } from "./F0Button-DAqSZkXo.js";
import { a as O, i as k, r as re, t as ie } from "./F0AvatarIcon-u_ab66zP.js";
import { At as ae, C as oe, Ct as se, D as ce, Et as le, K as ue, Nt as de, Ot as fe, Pt as pe, Q as me, St as A, T as he, Tt as ge, V as _e, W as ve, X as ye, _ as be, a as xe, at as Se, bt as Ce, c as j, f as we, h as Te, i as Ee, j as M, jt as De, k as Oe, m as N, nt as ke, o as Ae, ot as P, p as je, rt as Me, s as Ne, st as Pe, t as Fe, tt as Ie, wt as Le, z as Re } from "./F0Checkbox-D80nhG7S.js";
import { n as ze, t as Be } from "./Cross-BmL9HU4z.js";
import { n as Ve, t as He } from "./F0Link-C5K9Kgzh.js";
import { a as Ue, c as We, h as Ge, p as Ke, s as qe } from "./F0Avatar-BRF_8pk8.js";
...
var lt = F.forwardRef(({ className: e, title: t, icon: r = De, href: i, ...a }, o) => {
...
function pt(e, t) {
	let n = P(e), r = P(t), i = n.getTime() - r.getTime();
...
function gt(e, t, n) {
	let r = ye(), i = n?.locale ?? r.locale ?? Re, a = pt(e, t);
	if (isNaN(a)) throw RangeError("Invalid time value");
	let o = Object.assign({}, n, {
		addSuffix: n?.addSuffix,
		comparison: a
	}), s, c;
	a > 0 ? (s = P(t), c = P(e)) : (s = P(e), c = P(t));
	let l = ht(n?.roundingMethod ?? "round"), u = c.getTime() - s.getTime(), d = u / me, f = (u - (ue(c) - ue(s))) / me, p = n?.unit, m;
...
function yt(e) {
	return ve(e, Oe(mt(e), 1));
}
//#endregion
//#region src/lib/date.ts
function bt(e, t) {
	return M(e, "p", { locale: t });
}
function xt(e) {
	return M(e, "HH:mm");
}
function St(e, t) {
	return M(e, "LLL", { locale: t });
}
function Ct(e) {
	return e.getDate();
}
...
function Tt(e, { locale: t, yesterdayRelative: n = !0 }) {
	return vt(e) ? wt(e, t) : yt(e) ? n ? wt(e, t) : M(e, "p", { locale: t }) : M(e, "PPPp", { locale: t });
}
var Et = (e, t) => {
	let n = {
		today: [],
	...
	return e.forEach((e) => {
		let r = e[t], i = Math.abs(_e(r, /* @__PURE__ */ new Date()));
...
var Mt = {
	...
	smoke: j.smoke[50],
	army: j.army[50],
	flubber: j.flubber[50],
	indigo: j.indigo[50],
	camel: j.camel[50],
	radical: j.radical[50],
	viridian: j.viridian[50],
	orange: j.orange[50],
	red: j.red[50],
	grass: j.grass[50],
	malibu: j.malibu[50],
...
var bn = e(yn), xn = I(({ name: e, src: t }, n) => /* @__PURE__ */ L(Ne, {
	ref: n,
	avatar: {
		type: "company",
		name: e,
...
var Sn = e(xn), Cn = I(({ name: e, src: t }, n) => /* @__PURE__ */ L(Ne, {
	ref: n,
	avatar: {
		type: "team",
		name: e,
...
function Dn({ primaryAction: e, secondaryActions: t, compact: n = !1 }) {
	...
	return /* @__PURE__ */ R(dt, {
		...
		children: [t && /* @__PURE__ */ L("div", {
			...
			children: Array.isArray(t) ? t.map((e, t) => /* @__PURE__ */ L(E, {
				label: e.label,
				icon: e.icon,
				variant: "outline",
				onClick: (t) => {
...
var In = ({ avatar: e, size: t }) => e.type === "emoji" ? /* @__PURE__ */ L(We, {
	emoji: e.emoji,
	size: t
}) : e.type === "file" ? /* @__PURE__ */ L(qe, {
	file: e.file,
	size: t
}) : e.type === "icon" ? /* @__PURE__ */ L(ie, {
	icon: e.icon,
	size: t
}) : e.type === "module" ? /* @__PURE__ */ L(Ge, {
	module: e.module,
	size: t
}) : e.type === "alert" ? /* @__PURE__ */ L(Ve, {
	type: e.variant,
	size: t
}) : e.type === "date" ? /* @__PURE__ */ L(Dt, { date: e.date }) : /* @__PURE__ */ L(A, {
	avatar: e,
	size: t
});
...
function ur({ dataPoints: e, total: t, hideTooltip: n, meta: r }) {
	let [i, a] = Ze(void 0), o = kt(e, t, (e, t) => e.color ? ar(e.color) : je(t)), l = At(o, t);
	return /* @__PURE__ */ L(x, {
		delayDuration: 350,
		children: /* @__PURE__ */ R(C, { children: [/* @__PURE__ */ L(_, {
			asChild: !0,
...
var dr = (e, t) => {
	if (e?.loading) return /* @__PURE__ */ L("div", {
		...
		"data-cell-type": "categoryBarChart",
		"aria-busy": "true",
		children: /* @__PURE__ */ L(T, { className: "h-2 w-full rounded-2xs" })
	});
	let n = e?.dataPoints;
...
var Ir = (e, t) => {
	...
	let i = n, a = typeof e == "object" && "max" in e ? e.max ?? 100 : 100, o = typeof e == "object" && "label" in e ? e.label : void 0, s = typeof e == "object" && "hideLabel" in e ? e.hideLabel : void 0, c = typeof e == "object" && "color" in e ? e.color : void 0, l = N(c || "categorical-1"), u = i / a * 100;
	return /* @__PURE__ */ R("div", {
...
var si = I(({ bars: e, maxLabels: t = Gr, hideTooltip: n, formatValue: r = String, size: a = "md", loading: o }, s) => {
	...
	if (o) return /* @__PURE__ */ L("div", {
		...
		"aria-busy": "true",
		"aria-live": "polite",
		children: /* @__PURE__ */ L(T, { className: c("w-full rounded-2xs", Yr[a]) })
	});
	...
	children: /* @__PURE__ */ L(se, {
		...
		children: /* @__PURE__ */ L("div", {
			...
			children: /* @__PURE__ */ L(ge, {
				...
				text: e.label,
				icon: e.icon,
				additionalAccessibleText: Le(e.tooltip)
			})
		})
	})
...
var ia = I(function({ compact: e = !1, avatar: n, image: r, imageFit: i = "fit-width", imageSize: a = "sm", imageAspectRatio: o = "default", blurredBackground: l = !0, title: u, description: d, metadata: f, children: p, link: m, primaryAction: h, secondaryActions: g, otherActions: _, bookmark: v, selectable: y = !1, subtleBorder: ee = !1, selected: b = !1, onSelect: x, onClick: S, forceVerticalMetadata: C = !1, fullHeight: w = !1, disableOverlayLink: te = !1, alert: T }, ne) {
	let E = Xe(null), D = !te && (!!m || !!S), O = (e) => {
		E?.current?.click(), S?.(), e.preventDefault(), e.stopPropagation();
	}, k = /* @__PURE__ */ R(z, {
		...
		style: T && T.visible !== !1 && !b ? {
			borderColor: kn[T.variant],
			borderWidth: "2px"
		} : void 0,
		onClick: S,
		"data-testid": "card",
		ref: T && T.visible !== !1 ? void 0 : ne,
		children: [
			m && !te && /* @__PURE__ */ L(He, {
				href: m,
				variant: "unstyled",
			...
			/* @__PURE__ */ R("div", {
				className: c("flex grow flex-col gap-2", D && "cursor-pointer"),
				...D ? { onClick: (e) => {
					e.target instanceof Element && e.target.closest("a[href], input, select, textarea, [aria-haspopup]:not([aria-haspopup=\"false\"])") || O(e);
				} } : {},
				children: [
					/* @__PURE__ */ R("div", {
	...
	return T && T.visible !== !1 ? /* @__PURE__ */ L(Fn, {
		ref: ne,
		alert: T,
		fullHeight: w,
		children: k
	...
	children: [/* @__PURE__ */ R(at, {
		...
		children: [/* @__PURE__ */ L(T, { className: c("h-10 w-10 rounded-full", e && "h-6 w-6") }), /* @__PURE__ */ R("div", {
			className: c("flex flex-col gap-0", e && "flex-row items-center gap-1.5"),
			children: [/* @__PURE__ */ L(ot, {
				className: "flex h-6 items-center",
				children: /* @__PURE__ */ L(T, { className: c("h-4 w-20 rounded-md", e && "h-3") })
			}), /* @__PURE__ */ L(st, {
				className: "flex h-5 items-center",
				children: /* @__PURE__ */ L(T, { className: "h-3 w-12 rounded-md" })
			})]
		})]
	}), /* @__PURE__ */ L(ut, {
		...
		children: Array.from({ length: 3 }).map((e, t) => /* @__PURE__ */ R("div", {
			...
			children: [/* @__PURE__ */ L(T, { className: "h-4 w-4 rounded-full" }), /* @__PURE__ */ L(T, { className: "h-3 w-full max-w-20 rounded-md" })]
		}, t))
	})]
}), oa = [
	"info",

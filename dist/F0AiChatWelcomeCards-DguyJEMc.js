import { jsxs as c, jsx as r, Fragment as Re } from "react/jsx-runtime";
import { useInsertionEffect as Br, forwardRef as h, useRef as P, useEffect as Y, useLayoutEffect as st, useState as I, useMemo as te, useCallback as q, createContext as Ge, useContext as Be, useId as it, createElement as Ir, memo as Pr } from "react";
import { ck as jr, cl as Dr, cm as Zr, cn as _r, co as at, cp as Or, cq as Ur, cr as zr, cs as Gr, ct as Wr, cu as ct, cv as qr, cw as Xr, cx as Yr, cy as Kr, cz as Qr, cA as Jr, cB as eo, cC as ze, cD as to, cE as ro, cF as oo, cG as no, cH as so, Z as lt, cI as io, cJ as ao, cK as co, cL as lo, cM as uo, cN as dt, cO as fo, cP as ho, a6 as a1, cQ as go, aJ as po, cR as Co, cS as mo, cT as vo, ag as wo, cU as xo, bO as ko, aa as ut, ad as Lo, cV as bo, ba as c1, a1 as ft, S as We, cW as ht, b9 as yo, cX as Mo, cY as Eo, b2 as Ro, bN as Fo, $ as Fe, au as No, be as gt, cZ as Vo, bL as So, c_ as Me, bH as To, c$ as Ho, d0 as Ao, b1 as pt, d1 as $o, d2 as Bo, d3 as Io, d4 as Po, d5 as jo, d6 as Ct, bz as Do, bA as Zo, d7 as _o, d8 as Oo, d9 as Uo, da as zo, db as Go, dc as Wo, dd as qo, de as Xo, df as Yo, dg as Ko, dh as Qo, di as Jo, dj as en, dk as tn, bM as rn, ab as on, bv as nn, dl as sn, dm as an, dn as cn, dp as ln, dq as dn, dr as un, ds as fn, ap as hn, dt as mt, M as gn, a0 as pn, du as vt, dv as wt, dw as Cn, bd as mn, bc as vn, dx as wn, dy as xn, dz as xt, dA as kn, b0 as Ln, ay as bn, dB as yn, as as Mn, b7 as En, dC as kt, b6 as Rn, dD as Fn, bi as l1, dE as Nn, dF as Vn, dG as d1, bJ as Sn, bI as Tn, bK as Lt, dH as Hn, G as An, E as $n, dI as Bn, dJ as In, dK as Pn, dL as jn, dM as Dn, dN as bt, dO as Zn, ac as _n, dP as On, L as ue, o as L, q as Ve, bp as Un, u as X, dQ as zn, U as ve, ch as yt, H as le, v as ge, a2 as Gn, Q as me, dR as Wn, ae as de, aP as Le, A as Ee, p as oe, aD as u1, dS as qn, aE as f1, aF as h1, b as be, dT as Xn, dU as Yn, bD as Kn, V as Qn, a$ as Jn, a5 as g1, dV as es, dW as ts, dX as rs, dY as E1, a3 as os, ak as Mt, aS as Et, dZ as ns, b$ as ss, d_ as is, d$ as as, aX as Rt, e0 as cs, bV as ls, e1 as ds, aU as $e, bg as Ft, e2 as Nt, bh as Vt, c as s1, e3 as St, e4 as us, bT as Tt, bk as fs, e5 as hs, b8 as p1, bw as gs, e6 as ps, e7 as Cs, e8 as ms, e9 as vs, ea as ws, a8 as xs, af as ks, y as Ls, z as bs, eb as Ht, ec as At, ed as ys, aj as R1, ee as Ms, ai as Es, ef as Rs, eg as Fs, d as Ns } from "./F0CanvasPanel-CKRcaMY6.js";
import { createPortal as $t } from "react-dom";
import { defaultTranslations as Vs } from "./i18n-provider-defaults.js";
import { useTrackVolume as Ss } from "@livekit/components-react";
function Ts(e, t, o) {
  Br(() => e.on(t, o), [e, t, o]);
}
function C1(e) {
...
function Bt(e, t, o, n) {
  return typeof e == "string" && C1(t) ? jr(e, o, n) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Hs(e, t, o) {
  return e * (t + 1);
}
function F1(e, t, o, n) {
  return typeof t == "number" ? t : t.startsWith("-") || t.startsWith("+") ? Math.max(0, e + parseFloat(t)) : t === "<" ? o : n.get(t) ?? e;
}
const As = (e, t, o) => {
  const n = t - e;
  return ((o - e) % n + n) % n + e;
...
function It(e, t) {
  return Dr(e) ? e[As(0, e.length, t)] : e;
}
function $s(e, t, o) {
  for (let n = 0; n < e.length; n++) {
    const s = e[n];
    s.at > t && s.at < o && (_r(e, s), n--);
  }
}
function Bs(e, t, o, n, s, i) {
  $s(e, s, i);
...
const js = "easeInOut", Ds = 20;
function Zs(e, { defaultTransition: t = {}, ...o } = {}, n, s) {
  const i = t.duration || 0.3, a = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), l = {}, f = /* @__PURE__ */ new Map();
  let u = 0, p = 0, C = 0;
  for (let g = 0; g < e.length; g++) {
    ...
    if (typeof m == "string") {
      ...
      f.set(m.name, F1(p, m.at, u, f));
      continue;
    }
    let [v, w, x = {}] = m;
    x.at !== void 0 && (p = F1(p, x.at, u, f));
    let H = 0;
    const S = (N, y, k, T = 0, V = 0) => {
      const $ = _s(N), { delay: F = 0, times: M = Or($), type: B = "keyframes", repeat: _, repeatType: z, repeatDelay: G = 0, ...re } = y;
      let { ease: K = t.ease || "easeOut", duration: O } = y;
      const Z = typeof F == "function" ? F(T, V) : F, D = $.length, Q = Gr(B) ? B : s?.[B];
      if (D <= 2 && Q) {
        let ie = 100;
        if (D === 2 && zs($)) {
          const ce = $[1] - $[0];
      ...
      const fe = M.length - $.length;
      if (fe > 0 && zr(M, fe), $.length === 1 && $.unshift(null), _) {
        ct(_ < Ds, "Repeat count too high, must be less than 20"), O = Hs(O, _);
        const ie = [...$], ne = [...M];
        ...
        for (let ce = 0; ce < _; ce++) {
          ...
          for (let b = 0; b < ie.length; b++)
            M.push(ne[b] + (ce + 1)), K.push(b === 0 ? "linear" : It(se, b - 1));
        }
        Is(M, _);
      }
      const he = W + O;
      Bs(k, $, K, M, W, he), H = Math.max(Z + O, H), C = Math.max(he, C);
    };
    if (at(v)) {
      const N = N1(v, d);
      S(w, x, V1("default", N));
    } else {
      const N = Bt(v, w, n, l), y = N.length;
      for (let k = 0; k < y; k++) {
        w = w, x = x;
        const T = N[k], V = N1(T, d);
        for (const $ in w)
          S(w[$], Os(x, $), V1($, V), k, y);
      }
    }
  ...
  return d.forEach((g, m) => {
    for (const v in g) {
      ...
      for (let y = 0; y < w.length; y++) {
        const { at: k, value: T, easing: V } = w[y];
        x.push(T), H.push(qr(0, C, k)), S.push(V || "easeOut");
      }
      H[0] !== 0 && (H.unshift(0), x.unshift(x[0]), S.unshift(js)), H[H.length - 1] !== 1 && (H.push(1), x.push(null)), a.has(m) || a.set(m, {
        keyframes: {},
        transition: {}
      });
      const N = a.get(m);
      N.keyframes[v] = x, N.transition[v] = {
        ...t,
        duration: C,
        ease: S,
        times: H,
...
const Us = (e) => typeof e == "number", zs = (e) => e.every(Us);
function Gs(e, t) {
  return e in t;
}
class Ws extends Xr {
  ...
  removeValueFromRenderState(t, o) {
    delete o.output[t];
  }
  ...
  build(t, o) {
    Object.assign(t.output, o);
  }
  renderInstance(t, { output: o }) {
    Object.assign(t, o);
  }
...
function qs(e) {
  ...
  }, o = Kr(e) && !Qr(e) ? new Jr(t) : new eo(t);
  o.mount(e), ze.set(e, o);
}
function Xs(e) {
  const t = {
    presenceContext: null,
...
function Ys(e, t) {
  return at(e) || typeof e == "number" || typeof e == "string" && !C1(t);
}
function Pt(e, t, o, n) {
  const s = [];
  if (Ys(e, t))
    s.push(to(e, C1(t) && t.default || t, o && (o.default || o)));
  else {
    const i = Bt(e, t, n), a = i.length;
    ct(!!a, "No valid elements provided.");
    for (let d = 0; d < a; d++) {
      const l = i[d], f = l instanceof Element ? qs : Xs;
      ze.has(l) || f(l);
      const u = ze.get(l), p = { ...o };
      "delay" in p && typeof p.delay == "function" && (p.delay = p.delay(d, a)), s.push(...ro(u, { ...t, transition: p }, {}));
    }
  }
  return s;
}
function Ks(e, t, o) {
  const n = [];
  return Zs(e, t, o, { spring: oo }).forEach(({ keyframes: i, transition: a }, d) => {
    n.push(...Pt(d, i, a));
  }), n;
}
class Qs {
  ...
  setAll(t, o) {
    for (let n = 0; n < this.animations.length; n++)
      this.animations[n][t] = o;
  }
  attachTimeline(t) {
    const o = this.animations.map((n) => n.attachTimeline(t));
    return () => {
      o.forEach((n, s) => {
  ...
  get duration() {
    ...
    for (let o = 0; o < this.animations.length; o++)
      t = Math.max(t, this.animations[o].duration);
    return t;
  }
  runAll(t) {
    this.animations.forEach((o) => o[t]());
  }
  play() {
    this.runAll("play");
  }
...
function ti(e) {
  function t(o, n, s) {
    let i = [];
    return ei(o) ? i = Ks(o, n, e) : i = Pt(o, n, s, e), new Js(i);
  }
  return t;
}
const ri = ti(), oi = (e, t) => /* @__PURE__ */ c(
  "svg",
  {
...
_t.displayName = "ShoppingCart";
const Mc = (e, t) => /* @__PURE__ */ c(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
), d2 = h(l2), u2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: ni,
  Add: no,
  Ai: ii,
  ...
  CalendarArrowLeft: Ai,
  CalendarArrowRight: Bi,
  CameraPlus: Pi,
  CardPin: Di,
  ChartFunnel: _i,
  ChartHorizontalBars: Ui,
  ChartLine: Gi,
  ChartPie: qi,
  ChartVerticalBars: Yi,
  Check: ut,
  CheckCircle: Lo,
  CheckCircleLine: Qi,
  CheckDouble: bo,
  ...
  DropdownOpen: Ho,
  Ellipsis: Ao,
  EllipsisHorizontal: pt,
  Envelope: $o,
  EnvelopeOpen: Ta,
  Equal: Bo,
  EqualApproximately: Io,
  EqualGreater: Po,
  EqualLess: jo,
  Exit: Aa,
  ExternalLink: Ct,
  ...
  FaceNeutral: Oo,
  FacePositive: Uo,
  FaceSuperNegative: zo,
  FaceSuperPositive: Go,
  Feed: Ba,
  File: Pa,
  FileFilled: Da,
  FileSigned: _a,
  ...
  Wifi: d2,
  Windows: On
}, Symbol.toStringTag, { value: "Module" })), f2 = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const S2 = Ve({
  ...
  ({
    ...
    const He = D && D !== "none" || Q && Q !== "none" || W && W !== "none" || fe && fe !== "none", Pe = Z && Z !== "none" || He, Je = { sm: Xe, md: Ye, lg: Ie, xl: Ke }, e1 = T2.map((je) => {
      const De = Je[je];
      return De ? V2(je, De) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        className: L(
          ...
          e1,
          Pe && !O && "border-f1-border",
          A && !U && "divide-f1-border",
          "scrollbar-macos"
        ),
        ...Qe
      }
...
const r1 = Un(
  ...
  const v = X();
  return u === "recording" ? /* @__PURE__ */ c("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    /* @__PURE__ */ r(
      zn,
      {
        stream: p ?? null,
    ...
    /* @__PURE__ */ r("div", { className: "flex items-center gap-2", children: e && /* @__PURE__ */ c(Re, { children: [
      /* @__PURE__ */ r(
        ue,
        {
  ...
  "div",
  {
    ...
    children: e.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ r(ve, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ r(
        $2,
        {
          att: s,
          onRemove: o,
...
function $2({
  ...
  const n = /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(le, { icon: lt, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ r(
      "button",
      {
        ...
        onClick: () => t(e.id),
        children: /* @__PURE__ */ r(le, { icon: Fe, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ r(Gn, { label: e.errorMessage, children: n }) : n;
}
const B2 = {
  soft: {
    text: "",
...
function P2({
  ...
  const a = P(null), d = P(null);
  Y(() => {
    d.current?.scrollIntoView({ block: "nearest" });
  }, [n]), st(() => {
    const u = a.current, p = u?.offsetParent;
    if (!u || !p) return;
    const C = u.offsetLeft + u.offsetWidth - p.clientWidth;
    C > 0 && (u.style.left = `${Math.max(0, u.offsetLeft - C)}px`);
  }, [s]);
  const l = o && t.length === 0, f = !o && t.length === 0;
  return !e || f ? null : /* @__PURE__ */ r(
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (u, p) => /* @__PURE__ */ c(
        "div",
        {
          className: "flex items-center gap-2 p-2",
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ r(ve, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ r(
              ve,
              {
        ...
        const C = p === n, g = `${u.firstName} ${u.lastName}`.trim();
        return /* @__PURE__ */ c(
          "div",
          {
            ref: C ? d : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ r(de, { className: "text-base font-medium text-f1-foreground", children: g }) })
            ]
          },
          String(u.id)
        );
...
const j2 = ({
  ...
  return /* @__PURE__ */ r("div", { className: "p-1", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ r(le, { icon: v1, size: "md", color: "default" }) }),
        /* @__PURE__ */ r(
          de,
          {
  ...
  const s = Le(), [i, a] = I(""), [d, l] = I(0), [f, u] = I(!1), p = P(null), C = P(null), g = P(null), m = e[d] ?? t;
  return Y(() => {
    const v = () => {
    ...
    if (s)
      return u(!1), a(m), v(), p.current = setTimeout(() => {
    ...
    u(!0), a("");
    let w = 0;
    const x = 50, H = 30, S = 2e3, N = 1e3;
    return C.current = setInterval(() => {
      w < m.length ? (a(m.slice(0, w + 1)), w++) : (C.current && (clearInterval(C.current), C.current = null), p.current = setTimeout(() => {
        g.current = setInterval(() => {
          w > 0 ? (w--, a(m.slice(0, w))) : (g.current && (clearInterval(g.current), g.current = null), p.current = setTimeout(() => {
            const y = (d + 1) % Math.max(e.length, 1);
            l(y);
          }, N));
        }, H);
    ...
    e.length,
    s
  ]), o.length > 0 || n ? null : /* @__PURE__ */ r(Ee, { children: /* @__PURE__ */ r(
    oe.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
`) ? o + "_" : o
        ...
        "div",
        {
          ...
          children: d.map(
            (g, m) => g.type === "mention" ? /* @__PURE__ */ r(
              ...
              m
            ) : g.type === "ghost" ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-secondary opacity-50", children: g.text }, m) : /* @__PURE__ */ r("span", { children: g.text }, m)
          )
        }
      ),
      !o && !f && /* @__PURE__ */ r(
      ...
      /* @__PURE__ */ r(
        "textarea",
        {
          ...
          value: o,
          onChange: (g) => {
            n(g.target.value, g.target.selectionStart ?? 0);
          },
          onKeyDown: s,
          onKeyUp: i,
          onClick: i,
...
const U2 = ({
  ...
  const [s, i] = I(null), a = s !== null ? e[s] : null;
  return e.length === 0 ? null : /* @__PURE__ */ c(
    u1,
    {
      ...
      children: [
        /* @__PURE__ */ r(qn, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ r(f1, { asChild: !0, children: /* @__PURE__ */ r(
          ue,
          {
            variant: "outline",
            label: d.label,
        ...
        a && /* @__PURE__ */ c(
          h1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: O2(a.items).map((d, l) => /* @__PURE__ */ c(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ r(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ r(le, { icon: a1, size: "sm" })
                      }
                    )
                  ]
                },
...
function z2(e, t, o) {
  ...
  for (const u of t) {
    ...
    let C = 0;
    for (; ; ) {
      const g = e.indexOf(p, C);
      if (g === -1) break;
      i.push({ start: g, end: g + p.length }), C = g + p.length;
    }
  }
  i.sort((u, p) => u.start - p.start);
  const a = [];
  let d = 0, l = !1;
  const f = (u) => {
    if (!s || l || n < d || n > u) {
      u > d && a.push({ type: "text", text: e.slice(d, u) }), d = u;
      return;
    }
    n > d && a.push({ type: "text", text: e.slice(d, n) }), a.push({ type: "ghost", text: s }), l = !0, n < u && a.push({ type: "text", text: e.slice(n, u) }), d = u;
  };
  for (const u of i)
    f(u.start), a.push({ type: "mention", text: e.slice(u.start, u.end) }), d = u.end;
  return f(e.length), !l && s && n >= d && a.push({ type: "ghost", text: s }), a.length === 0 ? [{ type: "text", text: e }] : a;
}
function G2(e, t) {
  if (t === "*/*") return !0;
  if (t.endsWith("/*")) {
...
function W2(e, t) {
  ...
  return o.length === 0 ? e : e.filter(
    (n) => o.some((s) => G2(n.type, s))
  );
}
const q2 = 4e3;
function X2(e) {
  const [t, o] = I([]), [n, s] = I(null), i = P(
    null
  ), a = P(null), d = X(), l = e?.onUploadFiles, f = e?.allowedMimeTypes, u = e?.maxFiles, p = te(() => {
    if (f)
      return Array.isArray(f) ? f.join(",") : f;
  }, [f]), C = u !== void 0 && t.length >= u, g = P(0);
  Y(() => {
    g.current = t.length;
  }, [t]);
  const m = q((S) => {
    i.current && clearTimeout(i.current), s(S), i.current = setTimeout(() => {
  ...
  const v = q(
    async (S) => {
      ...
      if (u !== void 0 && g.current + N.length > u) {
        m(
      ...
      const T = (V) => o(
        ($) => $.map(
          (F) => k.includes(F.id) ? { ...F, status: "error", errorMessage: V } : F
        )
      );
      try {
        const V = await l(N);
        if (!Array.isArray(V) || V.length !== N.length) {
          T(d.ai.fileUploadError);
          return;
        }
        o(
          ($) => $.map((F) => {
            const M = y.findIndex((B) => B.id === F.id);
            return M === -1 ? F : V[M] ? {
              ...F,
              status: "uploaded",
              uploadedFile: V[M]
        ...
        const $ = V instanceof Error && V.message ? V.message : d.ai.fileUploadError;
        T($);
      }
    },
    [
    ...
    async (S) => {
      await v(Array.from(S.target.files ?? [])), S.target.value = "";
    },
    [v]
  ), x = q((S) => {
    o((N) => N.filter((y) => y.id !== S));
  }, []), H = q(() => {
    o([]);
  }, []);
  return {
...
function Q2(e, t) {
  ...
  return document.body.removeChild(o), { left: a, top: d };
}
const J2 = 250;
function el({
  inputValue: e,
  ...
  const [i, a] = I(!1), [d, l] = I(""), [f, u] = I([]), [p, C] = I(!1), [g, m] = I(0), [v, w] = I([]), x = P(-1), H = P(null), S = P(0), N = P(-1);
  Y(() => {
    if (!n) {
      a(!1);
      return;
    ...
    const M = Y2(e, o, v);
    if (!M) {
      a(!1), l(""), u([]), m(0), x.current = -1, N.current = -1;
      return;
    }
    if (M.atIndex === N.current)
      return;
    x.current = M.atIndex, l(M.query), a(!0), m(0), C(!0), H.current && clearTimeout(H.current);
    const B = ++S.current;
    return H.current = setTimeout(() => {
      n(M.query).then((_) => {
        B === S.current && (u(_), m(0), _.length === 0 && M.query.length > 0 && (N.current = M.atIndex, a(!1)));
      }).catch(() => {
        B === S.current && u([]);
      }).finally(() => {
        B === S.current && C(!1);
  ...
  const y = q(() => {
    a(!1), l(""), u([]), m(0), x.current = -1;
  }, []), k = q(
    (M) => {
      const B = x.current;
      if (B === -1) return;
      const _ = `${M.firstName} ${M.lastName}`.trim(), z = String(M.id), G = e.slice(0, B), re = e.slice(o), K = `@${_} `, O = G + K + re, Z = G.length + K.length;
    ...
    (M) => {
      if (!i) return !1;
      if (M.key === "Escape")
        return M.preventDefault(), y(), !0;
      if (f.length === 0) return !1;
      switch (M.key) {
        case "ArrowDown":
          return M.preventDefault(), m((B) => (B + 1) % f.length), !0;
        case "ArrowUp":
          return M.preventDefault(), m(
            (B) => (B + f.length - 1) % f.length
          ), !0;
        case "Tab": {
          const B = f[g];
          if (B) {
            const _ = `${B.firstName} ${B.lastName}`.trim();
            if (d.length === 0 || _.toLowerCase().startsWith(d.toLowerCase()))
              return M.preventDefault(), k(B), !0;
          }
          return !1;
        }
        case "Enter":
          return M.preventDefault(), f[g] && k(f[g]), !0;
        default:
          return !1;
      }
    },
    ...
    (M) => {
      ...
      for (const z of _) {
        const G = `@${z.name}`, re = `<entity-ref type="person" id="${S1(z.id)}">${S1(z.name)}</entity-ref>`;
        for (; B.includes(G); )
          B = B.replace(G, re);
      }
      return B;
...
` || G === "	";
  ...
  const $ = te(() => {
    ...
    const M = s.current;
    if (!M) return null;
    const B = Q2(M, x.current), _ = M.offsetLeft + B.left, G = (M.offsetParent ? M.offsetParent.offsetHeight : 0) - (M.offsetTop + B.top);
...
const tl = /[\\`*_{}[\]()#+\-.!|~>]/g, rl = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, o) => o % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(tl, "\\$&")).join(""), T6 = ({
  onSubmit: e,
  onStop: t,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const k = X(), T = Le(), [V, $] = I(""), [F, M] = I(0), [B, _] = I(!1), [z, G] = I(!1), [re, K] = I(null), O = P(null), Z = P(null), D = P(null), Q = a != null, { tracking: W } = be(), fe = q(
    (ee, xe) => {
      W?.onWelcomeSuggestionClick?.({
        item: ee,
        group: xe,
        prompt: ee.prompt || ee.title
      }), N?.(ee, xe);
    },
    [W, N]
  ), {
    ...
    const xe = we.current, t1 = xe && !/\s$/.test(xe) ? " " : "", _e = `${xe}${t1}${ee}`;
    $(_e), M(_e.length);
  }, []), Te = {
    ...
    onPartial: ye,
    onFinal: (ee) => {
      ye(ee), Z.current?.focus();
    },
    onError: (ee) => ae(Te[ee])
  }), qe = !!C && pe.isSupported, Xe = q(() => {
    W?.onDictationStart?.(), we.current = V, pe.start();
  }, [V, pe, W]), Ye = q(() => {
    W?.onDictationCancel?.(), pe.cancel();
  }, [pe, W]);
  Y(() => {
  ...
  const Ie = pe.status === "recording", Ke = Ie ? k.ai.listening : k.ai.inputPlaceholder, Qe = he.filter((ee) => ee.status === "uploaded"), Ne = he.some((ee) => ee.status === "uploading"), He = he.some((ee) => ee.status === "error"), Pe = V.trim().length > 0;
  Y(() => {
    if (!(!z || Ne)) {
      if (G(!1), He) {
        ae(k.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const Je = async (ee) => {
    if (ee.preventDefault(), !Q) {
      if (J.close(), o)
        ...
        const xe = J.transformMentions(V.trim()), t1 = rl(xe), _e = Qe.flatMap(
          (M1) => M1.uploadedFile ? [M1.uploadedFile] : []
        ), b1 = d, y1 = f;
        b1 && l?.(null), y1 && u?.(null), await e({
          text: t1,
          files: _e,
          context: b1,
          quote: y1
    ...
    Q || J.handleKeyDown(ee) || ee.key === "Enter" && !ee.shiftKey && (ee.preventDefault(), o || O.current?.requestSubmit());
  }, je = () => {
    M(Z.current?.selectionStart ?? 0);
  }, De = () => {
    D.current && Z.current && (D.current.scrollTop = Z.current.scrollTop);
  }, x1 = re ? re.prompt ?? re.title : null, k1 = Ie ? [k.ai.listening] : x1 ? [x1] : s ?? [], Tr = k1.length > 1, Hr = te(() => z2(V, J.mentions, {
    cursorPosition: F,
    inlineCompletion: J.inlineCompletion
  }), [V, J.mentions, F, J.inlineCompletion]), Ar = J.mentions.length > 0 || J.inlineCompletion !== null, Ze = x && !!S && S.length > 0 && !!N ? /* @__PURE__ */ r(
    U2,
    {
      suggestions: S,
      onItemClick: fe,
  ...
  return /* @__PURE__ */ c(
    oe.div,
    {
      ...
      className: L(
        ...
        L1 && "min-h-0 flex-1 justify-start -mt-20"
      ),
      ...H ? $r : {},
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          Ze && !H && /* @__PURE__ */ r("div", { children: Ze }),
          /* @__PURE__ */ r(I2, { creditWarning: i, children: /* @__PURE__ */ c(
            oe.form,
            {
              "aria-busy": o,
              ref: O,
              ...
              children: [
                ...
                /* @__PURE__ */ r(Ee, { initial: !1, children: Q ? /* @__PURE__ */ r(
                  oe.div,
                  {
                  ...
                  oe.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ r(Ee, { initial: !1, children: U && /* @__PURE__ */ r(
                        oe.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ c(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ r("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ r(Kn, { type: "critical", size: "sm" }) }),
        ...
        Ze && H && /* @__PURE__ */ r("div", { className: "w-full max-w-content", children: Ze }),
        w && x && H && /* @__PURE__ */ r("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: w }),
        /* @__PURE__ */ r(Ee, { mode: "wait", initial: !1, children: Q ? /* @__PURE__ */ c(
          oe.div,
          {
          ...
          oe.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ r(de, { className: "text-sm font-medium text-f1-foreground-tertiary", children: v.text }),
...
function cl({
  ...
  return /* @__PURE__ */ r(Jn, { ...t, variant: "link", href: t.href, children: e });
}
function ll({
  children: e,
  ...t
...
function ul({
  ...
  return /* @__PURE__ */ r("li", { ...t, className: L("mb-2", t.className), children: e });
}
...
function Cl({
  ...
  return /* @__PURE__ */ r("p", { ...t, className: L("text-base font-normal", t.className), children: e });
}
function ml({
  children: e,
  ...t
...
function xl({
  ...
  return /* @__PURE__ */ r("strong", { ...t, className: L("font-semibold", t.className), children: e });
}
function kl({
  children: e,
  ...t
}) {
  return /* @__PURE__ */ r("em", { ...t, className: L("italic", t.className), children: e });
}
function Se({
  id: e,
  trigger: t,
  ...
  const i = P(/* @__PURE__ */ new Map()), [a, d] = I(
    () => i.current.get(e) ?? null
  ), [l, f] = I(!1), [u, p] = I(!1), C = P(!0);
  Y(() => () => {
    C.current = !1;
  }, []);
  const g = q(() => {
    ...
    f(!0), p(!1), o(e).then((w) => {
      i.current.set(e, w), C.current && d(w);
    }).catch(() => {
      C.current && p(!0);
    }).finally(() => {
      C.current && f(!1);
  ...
  return /* @__PURE__ */ c(
    es,
    {
      ...
      children: [
        /* @__PURE__ */ r(ts, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          rs,
          {
            side: "top",
            ...
            children: l ? /* @__PURE__ */ r(E1.Skeleton, {}) : /* @__PURE__ */ r(E1, { ...m })
          }
        )
      ]
    }
...
ar.displayName = "CandidateTrigger";
function Ll({
  id: e,
  label: t
}) {
  const { entityRefs: o } = be(), n = o?.resolvers?.candidate, s = X(), i = o?.urls?.candidate?.(e), a = te(
    () => (l) => {
      const f = [];
...
cr.displayName = "ExpenseTrigger";
function bl({ id: e, label: t }) {
  const { entityRefs: o } = be(), n = o?.resolvers?.expense, s = X(), i = o?.urls?.expense?.(e), a = te(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: Dt
...
lr.displayName = "JobPostingTrigger";
function yl({
  id: e,
  label: t
}) {
  const { entityRefs: o } = be(), n = o?.resolvers?.jobPosting, s = X(), i = o?.urls?.jobPosting?.(e), a = te(
    () => (l) => ({
      title: l.title,
...
dr.displayName = "RequisitionTrigger";
function El({
  id: e,
  label: t
}) {
  const { entityRefs: o } = be(), n = o?.resolvers?.requisition, s = X(), i = o?.urls?.requisition?.(e), a = te(
    () => (l) => {
...
ur.displayName = "PersonTrigger";
function Rl({ id: e, label: t }) {
  const { entityRefs: o } = be(), n = o?.resolvers?.person, s = X(), i = o?.urls?.person?.(e), a = te(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
fr.displayName = "VacancyTrigger";
function Fl({ id: e, label: t }) {
  const { entityRefs: o } = be(), n = o?.resolvers?.vacancy, s = X(), i = o?.urls?.vacancy?.(e), a = te(
    () => (l) => ({
      title: l.name,
...
function i1(e) {
  return typeof e == "string" ? e : typeof e == "number" ? String(e) : Array.isArray(e) ? e.map(i1).join("") : e && typeof e == "object" && "props" in e ? i1(e.props.children) : "";
}
function Sl({
  type: e,
  id: t,
...
function hr({
  ...
  const a = X(), d = s.type === "open", l = d ? n ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ c(
    "div",
    {
      className: L(
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ r(Et, { module: e.module, size: "md" }),
          e?.type === "file" && /* @__PURE__ */ r(ns, { file: e.file, size: "lg" }),
          /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ r(de, { className: "text-lg font-semibold text-f1-foreground", children: t }),
            o && /* @__PURE__ */ r(de, { className: "text-base text-f1-foreground-secondary", children: o })
          ] }),
          s.type === "open" && s.showButton !== !1 && /* @__PURE__ */ r(
            me,
            {
              variant: "outline",
              size: "md",
              label: n ? a.actions.close : a.ai.reportCard.openButton,
...
hr.displayName = "F0CanvasCard";
const w1 = Ge(null);
function A6({
  children: e
}) {
  const [t, o] = I(0), n = P([]), s = q(
    (a) => {
  ...
  return /* @__PURE__ */ r(w1.Provider, { value: i, children: e });
}
function Tl(e) {
  const o = Be(w1)?.formatters;
  return te(() => !o || o.length === 0 ? null : (n, s, i) => {
    let a, d = -1;
    for (const l of o) {
      const f = l.formName === void 0 || l.formName === e, u = l.customFieldName === void 0 || l.customFieldName === i.customFieldName;
      if (!f || !u) continue;
      let p = 0;
      l.formName !== void 0 && (p += 2), l.customFieldName !== void 0 && (p += 1), p > d && (d = p, a = l);
    }
    if (a)
      return a.format(s, { key: n, ...i });
  }, [o, e]);
}
function $6() {
  const e = Be(w1);
...
const T1 = 7, Hl = 625, H1 = /* @__PURE__ */ new Set();
function Al(e) {
...
function Bl(e) {
  const { days: t, hours: o, minutes: n, seconds: s } = is(e), i = [];
...
function gr(e, t) {
  ...
  if (t === "duration" && typeof e == "number")
    return { type: "item", text: Bl(e) };
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? Al(o) : "") || "—" };
  }
  if (t === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: o, to: n } = e, s = A1(o) ? $1(o) : String(o), i = A1(n) ? $1(n) : String(n);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((n) => {
      const s = gr(n);
      return Array.isArray(s) ? s.map(B1).join(", ") : B1(s);
    }).filter(Boolean).join(", ") || "—" };
  ...
  return { type: "item", text: $l(String(e)) };
}
function pr({
  formName: e,
  formDescription: t,
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: u } = be(), p = Tl(e), C = d ?? p, g = P(() => {
  }), m = n ?? e, v = s ?? t ?? "", w = l?.type === "form" && l.formName === e, x = () => f({
    type: "form",
    title: m,
    description: v,
    formName: e,
  ...
  g.current = x, Y(() => {
    typeof window > "u" || window.innerWidth < Hl || H1.has(e) || (H1.add(e), g.current());
  }, [e]);
  const H = i && a ? Object.entries(i).map(([y, k]) => {
    const T = a[y], V = C?.(y, T, {
      fieldType: k.fieldType,
      customFieldName: k.customFieldName
    });
    if (!V && k.fieldType === "custom" && typeof T == "object" && T !== null)
      return null;
    const $ = V ?? gr(T, k.fieldType), F = ["richtext", "textarea"];
    return {
      label: k.label,
      content: $,
      verticalLayout: F.includes(k.fieldType ?? "")
    };
  }).filter((y) => {
    if (!y) return !1;
    const k = Array.isArray(y.content) ? y.content[0] : y.content;
    return !(k?.type === "item" && k.text === "—");
  }) : [], S = H.slice(0, T1), N = H.length > T1;
  return /* @__PURE__ */ r(
    hr,
    {
      ...
      children: S.length > 0 && !w && /* @__PURE__ */ r("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ r(
        ss,
        {
          details: S.map((y) => ({
            title: y.label,
...
pr.displayName = "FormCard";
function Il() {
  const e = as(), t = e?.activeForm;
  if (!t) return null;
...
const I1 = 8, Ae = 8;
function mr({ anchor: e, onReply: t }) {
  const o = X(), n = P(null), [s, i] = I(
    null
  );
  if (st(() => {
    if (!e) {
    ...
    const d = n.current;
    if (!d) return;
    const l = d.offsetWidth, f = d.offsetHeight, u = window.innerWidth, p = window.innerHeight;
    let C = e.rect.top - f - I1;
    C < Ae && (C = e.rect.bottom + I1), C = Math.min(
      Math.max(C, Ae),
      p - f - Ae
    );
    const g = e.rect.left + e.rect.width / 2 - l / 2, m = Math.min(
      Math.max(g, Ae),
      u - l - Ae
    );
    i({ top: C, left: m });
...
const vr = Ge(void 0), B6 = () => Be(vr), Dl = (e) => /* @__PURE__ */ r(Rt, { content: e, format: "markdown" }), Zl = ({
  isGenerating: e,
  isLoading: t,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", l = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, f = o?.toolCalls?.[0]?.id, u = !d && !l, p = P(null), { anchor: C, clear: g } = Cr({
    containerRef: p,
    enabled: !!(o?.id && d)
  });
  return Y(() => {
    o?.id && !t && !e && i?.(o);
  }, [o, t, e, i]), !t && !e && u ? null : /* @__PURE__ */ r(vr.Provider, { value: f, children: /* @__PURE__ */ c("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ r(
      "div",
      {
        ref: p,
    ...
    /* @__PURE__ */ r(
      mr,
      {
        anchor: C,
        onReply: (m) => {
          s?.(m), g(), window.getSelection()?.removeAllRanges();
        }
      }
    )
  ] }) });
  ...
  const [s, i] = I(""), a = X(), { title: d, label: l, placeholder: f } = o === "like" ? a.ai.feedbackModal.positive : a.ai.feedbackModal.negative, u = q(() => {
    t(n, s);
  }, [s, n, t]), p = () => {
    e(n);
  };
...
}, wr = Ge(null), Ol = ({ children: e }) => {
  const [t, o] = I(null), n = t ? {
    isOpen: !0,
  ...
  return /* @__PURE__ */ r(wr.Provider, { value: n, children: e });
}, xr = () => {
  const e = Be(wr);
  if (e === null)
    throw new Error(
...
const zl = ({
  ...
  const n = X(), { open: s } = xr(), [i, a] = I(null);
  ...
  const [d, l] = I(s), f = Le(), u = n !== void 0, p = u ? n : d;
  return /* @__PURE__ */ c(
    Ft,
    {
        ...
        /* @__PURE__ */ c(
          Nt,
          {
            ...
            children: [
              ...
              !a && /* @__PURE__ */ r(le, { icon: We })
            ]
          }
        ),
        /* @__PURE__ */ r(Vt, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ r(
          oe.div,
          {
            initial: !1,
            animate: {
  ...
  const s = X(), [i, a] = I(!!o), d = P(o);
  Y(() => {
    d.current && !o ? a(!1) : o && !i && a(!0), d.current = o;
  }, [o, i]);
  const l = o ? s.ai.thoughtsGroupTitle : t ?? s.ai.thoughtsGroupTitle, f = e.length - 1, u = (p) => !o || n ? "completed" : p === f ? "executing" : "completed";
  return /* @__PURE__ */ r(
    Gl,
    {
      icon: jt,
      ...
      onOpenChange: a,
      lockOpen: o,
      children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pb-4", children: e.map((p, C) => /* @__PURE__ */ c("div", { className: "relative", children: [
        /* @__PURE__ */ r(
          s1,
          {
            title: p,
...
const kr = (e) => /* @__PURE__ */ r(Rt, { content: e, format: "markdown" }), Yl = ({
  text: e,
  renderMarkdown: t
}) => /* @__PURE__ */ c("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ r("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ r(le, { icon: v1 }) }),
  /* @__PURE__ */ r("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (t ?? kr)(e) })
] }), Kl = ({
  message: e,
  onReplyQuote: t,
  ...
  const s = P(null), i = P(null);
  Y(() => {
    !s.current || !o || s.current.scrollIntoView({
      behavior: "smooth"
    });
  }, [o]);
  const a = e.rawData, d = Xl(
    e?.content,
    a
  ), l = (ql(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = l.length > 0, { anchor: p, clear: C } = Cr({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ r(Yl, { text: f, renderMarkdown: n }),
        d.length > 0 && /* @__PURE__ */ r("div", { className: "flex max-w-[90%] flex-wrap justify-end gap-1.5", children: d.map((g, m) => /* @__PURE__ */ r(
          yt,
          {
        ...
        /* @__PURE__ */ r(
          mr,
          {
            anchor: p,
            onReply: (g) => {
              t?.(g), C(), window.getSelection()?.removeAllRanges();
            }
          }
        )
      ]
...
}, Ql = 35, Jl = 22, e4 = 400, t4 = 2500, r4 = 220, o4 = ({
  messages: e,
  onClick: t,
  fullscreen: o = !1
}) => {
  const [n, s] = I(0), [i, a] = I(0), [d, l] = I("starting"), f = e[n] ?? "";
  Y(() => {
    e.length > 0 && n >= e.length && (s(0), a(0), l("starting"));
  }, [e.length, n]), Y(() => {
    let C;
    if (d === "starting")
      C = setTimeout(() => l("writing"), e4);
    else if (d === "writing")
      i < f.length ? C = setTimeout(() => a((g) => g + 1), Ql) : l("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      C = setTimeout(() => l("erasing"), t4);
    } else d === "erasing" && (i > 0 ? C = setTimeout(() => a((g) => g - 1), Jl) : C = setTimeout(() => {
      s((g) => (g + 1) % e.length), l("starting");
    }, r4));
    return () => {
      C && clearTimeout(C);
    };
  }, [d, i, f.length, e.length]);
  const u = !!t, p = u ? (C) => {
...
function n4({
  ...
  const [a, d] = I(0), [l, f] = I(!1), u = P(s), p = P(i);
  p.current = i;
  const C = q(
    (m = "smooth") => {
  ...
  Y(() => {
    ...
    return w.observe(m), w.observe(v), () => w.disconnect();
  }, [e, t]);
  const g = q(() => {
    const m = e.current;
    if (!m) return;
    const { scrollTop: v, scrollHeight: w, clientHeight: x } = m, H = w - v - x;
    f(H > x);
  }, [e]);
  return Y(() => {
    const m = e.current;
    if (m)
      return m.addEventListener("scroll", g, { passive: !0 }), () => m.removeEventListener("scroll", g);
  }, [g, e]), Y(() => {
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const m = e.current, v = n.current;
        if (!m || !v) return;
        const w = m.getBoundingClientRect(), x = v.getBoundingClientRect(), H = m.scrollTop + (x.top - w.top);
        m.scrollTo({ top: H, behavior: "smooth" });
      });
    }), s === 0 && f(!1), u.current = s;
  }, [s, n, e]), { showScrollBtn: l, turnMinHeight: a, scrollToBottom: C };
}
const s4 = {
  threadId: "",
  onThumbsUp: () => {
...
}, I6 = (e) => /* @__PURE__ */ r(Ol, { children: /* @__PURE__ */ r(i4, { ...e }) }), i4 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: S, handleSubmit: N, handleClose: y } = Ul(
    u ?? s4
  ), k = X(), T = v ?? Zl, V = w ?? Kl, $ = te(() => {
    const D = n ?? k.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((W) => typeof W == "string" && W.length > 0);
  }, [n, k.ai.defaultInitialMessage]), F = !t && e.length === 0 && $.length > 0, M = P(null), B = P(null), _ = P(null), z = P(null), G = P(null), { showScrollBtn: re, turnMinHeight: K, scrollToBottom: O } = n4({
    viewportRef: M,
    contentRef: B,
    endRef: _,
    lastTurnRef: G,
    ...
    const W = Q === e.length - 1, fe = {
      ...
      const ce = W && se === D.assistantMessages.length - 1, b = D.userMessages.length + se, R = {
        message: ne,
        inProgress: D.isInProgress,
        index: b,
        isCurrentMessage: ce,
      ...
      return /* @__PURE__ */ r(
        ...
        {
          ...R,
          isGenerating: D.isInProgress && ce,
          isLoading: D.isInProgress && ce && !ne.content
        },
        `${Q}-a-${se}`
      );
    };
    return /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          D.endIndicator === "thinking" && /* @__PURE__ */ r(s1, { title: k.ai.thinking, status: "executing" }),
          D.endIndicator === "activity" && /* @__PURE__ */ r(s1, { status: "writing" }),
  ...
  return /* @__PURE__ */ c(Re, { children: [
    /* @__PURE__ */ c("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
          ...
          children: /* @__PURE__ */ c(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("footer", { className: "copilotKitMessagesFooter", ref: _, children: m }),
                /* @__PURE__ */ r(Ee, { children: re && /* @__PURE__ */ r(
                  oe.div,
                  {
      ...
      !C && !F && /* @__PURE__ */ c(Re, { children: [
        /* @__PURE__ */ r(P1, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ r(P1, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    S.isOpen && /* @__PURE__ */ r(
      _l,
...
}, a4 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ r("div", { className: "flex justify-end", children: /* @__PURE__ */ r(ve, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ r(ve, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ r(ve, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ r(ve, { className: "h-5 w-4/5 rounded-md" })
] }) }), P6 = {
  ai: Vs.ai
}, Lr = Ge(null);
function j6({
  ...
  return /* @__PURE__ */ r(Lr.Provider, { value: t, children: e });
}
function D6() {
  const e = Be(Lr);
  if (e === null)
...
const l4 = ({
  ...
  const C = X().ai.clarifyingQuestion.typeYourAnswer, g = e === "single" ? /* @__PURE__ */ r(br, { isSelected: o && !t }) : /* @__PURE__ */ r(
    St,
    {
      checked: s,
      onCheckedChange: () => f(!s),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          "input",
          {
            ...
            onFocus: d,
            onKeyDown: (m) => {
              m.key === "Enter" && i && (m.preventDefault(), u());
            },
            placeholder: C,
            "aria-label": C,
  ...
  ({ option: e, isSelected: t, mode: o, isTabStop: n, onToggle: s, onKeyNavigate: i }, a) => o === "single" ? /* @__PURE__ */ c(
    "div",
    {
      ref: a,
      role: "radio",
...
const u4 = ({
  ...
  const x = Le(), H = (() => {
    ...
    const T = o.findIndex((V) => n.includes(V.id));
    return T >= 0 ? T : 0;
  })(), [S, N] = I(H), y = P([]);
  Y(() => {
    p && e === "single" && y.current[S]?.focus();
  }, []);
  const k = (T) => {
    if (e !== "single") return;
    const V = o.length - 1;
    ...
    T.preventDefault(), N($), y.current[$]?.focus();
  };
  return /* @__PURE__ */ c(
    "div",
    {
  ...
  } = s, T = P(null), V = H ?? "single", $ = a > 1, F = i === 0, M = i === a - 1, B = $ ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  }) : void 0, _ = x.length > 0, z = (y ?? "").trim().length > 0, G = _ || k && z || S === !0, re = t === !0 && M, K = () => {
    re || l();
  }, O = () => {
    re || f();
  }, Z = (ie) => {
    const ne = V === "single" && x.includes(ie);
    d(ie), V === "single" && !M && !ne && Promise.resolve().then(l);
  }, D = M ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, Q = S === !0 && !_ && !(k && z), W = () => {
    m(), requestAnimationFrame(() => {
      T.current?.focus();
    });
  }, fe = (ie) => {
    ie.key === "Escape" && (ie.preventDefault(), u());
  }, he = n ? 0 : g4 / 2;
  return /* @__PURE__ */ c("div", { className: "flex flex-col", onKeyDown: fe, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ c(
      oe.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: he, ease: h4 },
        children: [
          /* @__PURE__ */ r(
            f4,
            {
...
function j1(e, t, o, n) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(o, 20), d = Math.min(i + n, s), l = Math.min(d, Math.floor(e / 2)), f = Math.min(d, Math.floor(t / 2)), u = (W) => W / e * 2 - 1, p = (W) => W / t * 2 - 1, C = 0, g = e, m = 0, v = t, w = l, x = e - l, H = f, S = t - f, N = u(C), y = u(g), k = p(m), T = p(v), V = u(w), $ = u(x), F = p(H), M = p(S), B = 0, _ = 0, z = 1, G = 1, re = l / e, K = 1 - l / e, O = f / t, Z = 1 - f / t, D = new Float32Array([
    // Top strip
    N,
    k,
    y,
...
function C4(e, t, o) {
  const n = D1(e, e.VERTEX_SHADER, t), s = D1(e, e.FRAGMENT_SHADER, o), i = e.createProgram();
  ...
  if (e.attachShader(i, n), e.attachShader(i, s), e.linkProgram(i), !e.getProgramParameter(i, e.LINK_STATUS)) {
    ...
    throw e.deleteProgram(i), e.deleteShader(n), e.deleteShader(s), new Error(a);
  }
  return e.deleteShader(n), e.deleteShader(s), i;
}
const m4 = `#version 300 es
...
class O6 {
  ...
  resize(t, o, n) {
    ...
    const { gl: s, program: i, vao: a, positionBuffer: d, uvBuffer: l, uResolution: f } = this.glr, u = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, p = Math.max(1, Math.floor(t * u)), C = Math.max(1, Math.floor(o * u));
    this.canvas.style.width = `${t}px`, this.canvas.style.height = `${o}px`, (this.canvas.width !== p || this.canvas.height !== C) && (this.canvas.width = p, this.canvas.height = C), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
    const { positions: g, uvs: m } = j1(
      this.canvas.width,
      this.canvas.height,
      this.options.borderWidth * u,
      this.options.glowWidth * u
    );
    s.bindVertexArray(a), s.bindBuffer(s.ARRAY_BUFFER, d), s.bufferData(s.ARRAY_BUFFER, g, s.STATIC_DRAW);
    const v = s.getAttribLocation(i, "aPosition");
    s.enableVertexAttribArray(v), s.vertexAttribPointer(v, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, l), s.bufferData(s.ARRAY_BUFFER, m, s.STATIC_DRAW);
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: a, uvs: d } = j1(
      s,
      i,
    ...
    const p = t.getAttribLocation(o, "aUV");
    t.enableVertexAttribArray(p), t.vertexAttribPointer(p, 2, t.FLOAT, !1, 0, 0), this.checkGLError(t, "setupGL: after UV buffer setup");
    const C = t.getUniformLocation(o, "uResolution"), g = t.getUniformLocation(o, "uTime"), m = t.getUniformLocation(o, "uBorderWidth"), v = t.getUniformLocation(o, "uGlowWidth"), w = t.getUniformLocation(o, "uBorderRadius"), x = t.getUniformLocation(o, "uColors"), H = t.getUniformLocation(o, "uGlowExponent"), S = t.getUniformLocation(o, "uGlowFactor");
    t.useProgram(o), t.uniform1f(m, this.options.borderWidth), t.uniform1f(v, this.options.glowWidth), t.uniform1f(w, this.options.borderRadius), this.options.mode === "dark" ? (t.uniform1f(H, 2), t.uniform1f(S, 1.8)) : (t.uniform1f(H, 1), t.uniform1f(S, 1));
    const N = (this.options.colors || w4).map(x4);
...
const Z1 = ["lowp", "mediump", "highp"], k4 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, L4 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
    vec2 uv = fragCoord/iResolution.xy;
    vec3 col = 0.5 + 0.5*cos(iTime+uv.xyx+vec3(0,2,4));
    fragColor = vec4(col,1.0);
}`, _1 = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, O1 = "iTime", U1 = "iTimeDelta", z1 = "iDate", G1 = "iFrame", W1 = "iMouse", q1 = "iResolution", b4 = "iChannel", X1 = "iChannelResolution", Y1 = "iDeviceOrientation";
function y4(e, t) {
...
}, o1 = 9729, K1 = 9728, N4 = 9987, Q1 = 33071, J1 = 10497;
class V4 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const p = 0, C = o.RGBA, g = 1, m = 1, v = 0, w = o.RGBA, x = o.UNSIGNED_BYTE, H = new Uint8Array([255, 255, 255, 0]), S = o.createTexture();
    if (o.bindTexture(o.TEXTURE_2D, S), o.texImage2D(
      o.TEXTURE_2D,
      p,
      C,
      g,
      ...
      const T = this.setupVideo(n);
      return o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.LINEAR), this._webglTexture = S, this.source = T, this.isVideo = !0, T.play().then(() => this);
    }
    async function N() {
      return new Promise((T, V) => {
        ...
        $.crossOrigin = "anonymous", $.onload = () => {
          ...
          V(new Error(ke(`failed loading url: ${n}`)));
        }, $.src = n ?? "";
      });
    }
    let y = await N(), k = (y.width & y.width - 1) === 0 && (y.height & y.height - 1) === 0;
    return (t.wrapS !== Q1 || t.wrapT !== Q1 || t.minFilter !== K1 && t.minFilter !== o1) && !k && (y = this.makePowerOf2(y), k = !0), o.bindTexture(o.TEXTURE_2D, S), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, l), o.texImage2D(
      o.TEXTURE_2D,
      p,
      C,
      w,
      x,
      y
    ), k && t.minFilter !== K1 && t.minFilter !== o1 && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || J1
    ), o.texParameteri(
      ...
      this.magFilter || o1
    ), this._webglTexture = S, this.source = y, this.isVideo = !1, this.isLoaded = !0, this.width = y.width || 0, this.height = y.height || 0, this;
  };
}
const ke = (e) => `react-shaders: ${e}`, et = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, tt = (e, t, o) => e * (1 - o) + t * o, S4 = (e, t, o) => o > 0 ? e.substring(0, o) + t + e.substring(o, e.length) : t + e;
function T4({
  fs: e,
  vs: t = _1,
  textures: o = [],
  ...
  const g = P(null), m = P(null), v = P(null), w = P(null), x = P(void 0), H = P(void 0), S = P(!1), N = P(void 0), y = P(0), k = P([0, 0]), T = P([]), V = P(0), $ = P(void 0), F = P({
    [O1]: { type: "float", isNeeded: !1, value: 0 },
    [U1]: { type: "float", isNeeded: !1, value: 0 },
    [z1]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [W1]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [q1]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    [G1]: { type: "int", isNeeded: !1, value: 0 },
    [Y1]: {
      type: "vec4",
      isNeeded: !1,
      value: [0, 0, 0, 0]
    ...
    const E = "width" in b ? b.width ?? 0 : 0, j = "height" in b ? b.height ?? 0 : 0, A = F.current.iChannelResolution;
    if (!A) return;
    const U = Array.isArray(A.value) ? A.value : A.value = [];
    U[R * 3] = E * f, U[R * 3 + 1] = j * f, U[R * 3 + 2] = 0;
  }, _ = () => {
    ...
    const [R = 0, E = 0] = et(b), j = R - (N.current?.left ?? 0) - window.pageXOffset, A = (N.current?.height ?? 0) - E - (N.current?.top ?? 0) - window.pageYOffset;
    S.current = !0;
    const U = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
    U && (U[2] = j, U[3] = A), k.current[0] = j, k.current[1] = A;
  }, K = (b) => {
    N.current = g.current?.getBoundingClientRect();
    const [R = 0, E = 0] = et(b), j = R - (N.current?.left ?? 0), A = (N.current?.height ?? 0) - E - (N.current?.top ?? 0);
    if (l !== 1)
      k.current[0] = j, k.current[1] = A;
    else {
      const U = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
      U && (U[0] = j, U[1] = A);
    }
    ...
    if (!b) return;
    N.current = g.current?.getBoundingClientRect();
    const R = f, E = Math.floor(
      (N.current?.width ?? 1) * R
    ), j = Math.floor(
      (N.current?.height ?? 1) * R
    );
    if (b.canvas.width = E, b.canvas.height = j, F.current.iResolution?.isNeeded && w.current) {
    ...
    const E = m.current;
    if (!E) return null;
    const j = E.createShader(b);
    if (!j) return null;
    if (E.shaderSource(j, R), E.compileShader(j), !E.getShaderParameter(j, E.COMPILE_STATUS)) {
      C?.(ke(`Error compiling the shader:
${R}`));
      const A = E.getShaderInfoLog(j);
      E.deleteShader(j), p?.(ke(`Shader compiler log: ${A}`));
    }
    return j;
  }, Q = (b, R) => {
    const E = m.current;
    if (!E) return;
    const j = D(E.FRAGMENT_SHADER, b), A = D(E.VERTEX_SHADER, R);
    if (w.current = E.createProgram(), !(!w.current || !A || !j)) {
      if (E.attachShader(w.current, A), E.attachShader(w.current, j), E.linkProgram(w.current), !E.getProgramParameter(w.current, E.LINK_STATUS)) {
        p?.(
          ke(
      ...
      E.useProgram(w.current), x.current = E.getAttribLocation(
        w.current,
        "aVertexPosition"
      ), E.enableVertexAttribArray(x.current);
    }
  }, W = () => {
    if (n)
      for (const b of Object.keys(n)) {
        const R = n[b];
        if (!R) continue;
        const { value: E, type: j } = R, A = F4(j);
        if (!A) continue;
        const U = {};
        if (y4(j, E)) {
          const ae = j.length, J = Number.parseInt(j.charAt(ae - 3)), we = Math.floor(E.length / (J * J));
          E.length > J * J && (U.arraySize = `[${we}]`);
        } else M4(j, E) && (U.arraySize = `[${Math.floor(E.length / Number.parseInt(j.charAt(0)))}]`);
        F.current[b] = {
          type: A,
          isNeeded: !1,
          value: E,
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (E, j) => (F.current[`${b4}${j}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(E, j), T.current[j] = new V4(b), T.current[j]?.load(E).then((A) => {
            B(A, j);
          }))
        );
        Promise.all(R).then(() => {
    ...
    const R = Z1.includes(i ?? "highp"), E = `precision ${R ? i : Z1[1]} float;
`;
    R || C?.(
      ke(
    ...
    let j = E.concat(`#define DPR ${f.toFixed(1)}
`).concat(b.replace(/texture\(/g, "texture2D("));
    for (const U of Object.keys(F.current))
      if (b.includes(U)) {
        const ae = F.current[U];
        if (!ae) continue;
        j = S4(
          j,
          `uniform ${ae.type} ${U}${ae.arraySize || ""}; 
`,
          j.lastIndexOf(E) + E.length
        ), ae.isNeeded = !0;
      }
    return b.includes("mainImage") && (j = j.concat(k4)), j;
  }, ie = (b) => {
    const R = m.current;
    if (!R || !w.current) return;
    const E = V.current ? (b - V.current) / 1e3 : 0;
    V.current = b;
    const j = M.current;
    if (j)
    ...
    if (F.current.iMouse?.isNeeded) {
      const A = R.getUniformLocation(
        w.current,
        W1
      );
      R.uniform4fv(A, F.current.iMouse.value);
    }
    ...
    if (F.current.iDate?.isNeeded) {
      const A = /* @__PURE__ */ new Date(), U = A.getMonth() + 1, ae = A.getDate(), J = A.getFullYear(), we = A.getHours() * 60 * 60 + A.getMinutes() * 60 + A.getSeconds() + A.getMilliseconds() * 1e-3, ye = R.getUniformLocation(
        w.current,
        z1
      );
      R.uniform4fv(ye, [J, U, ae, we]);
    }
    if (F.current.iFrame?.isNeeded) {
      ...
      R.uniform1i(A, U), F.current.iFrame.value = U + 1;
    }
    if (T.current.length > 0)
      for (let A = 0; A < T.current.length; A++) {
        const U = T.current[A];
        if (!U) return;
        const { isVideo: ae, _webglTexture: J, source: we, flipY: ye, isLoaded: Te } = U;
        if (!Te || !J || !we) return;
        if (F.current[`iChannel${A}`]?.isNeeded) {
          if (!w.current) return;
          const pe = R.getUniformLocation(
            w.current,
            `iChannel${A}`
          );
          R.activeTexture(R.TEXTURE0 + A), R.bindTexture(R.TEXTURE_2D, J), R.uniform1i(pe, A), ae && U.updateTexture(
            J,
            we,
            ye
          );
    ...
    R.viewport(0, 0, R.drawingBufferWidth, R.drawingBufferHeight), R.clear(R.COLOR_BUFFER_BIT | R.DEPTH_BUFFER_BIT), R.bindBuffer(R.ARRAY_BUFFER, v.current), R.vertexAttribPointer(
      ...
      0,
      0
    ), ie(b), R.drawArrays(R.TRIANGLE_STRIP, 0, 4);
    const E = F.current.iMouse?.value;
    if (F.current.iMouse?.isNeeded && l !== 1 && Array.isArray(E)) {
      const j = E[0] ?? 0, A = E[1] ?? 0;
      E[0] = tt(j, k.current[0] ?? 0, l), E[1] = tt(A, k.current[1] ?? 0, l);
    }
    H.current = requestAnimationFrame(ne);
  }, se = () => {
    const b = { passive: !0 };
    F.current.iMouse?.isNeeded && g.current && (g.current.addEventListener("mousemove", K, b), g.current.addEventListener("mouseout", O, b), g.current.addEventListener("mouseup", O, b), g.current.addEventListener("mousedown", re, b), g.current.addEventListener("touchmove", K, b), g.current.addEventListener("touchend", O, b), g.current.addEventListener("touchstart", re, b)), F.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      G,
      b
    ), g.current && ($.current = new ResizeObserver(Z), $.current.observe(g.current), window.addEventListener("resize", Z, b));
  }, ce = () => {
    const b = { passive: !0 };
    F.current.iMouse?.isNeeded && g.current && (g.current.removeEventListener("mousemove", K, b), g.current.removeEventListener("mouseout", O, b), g.current.removeEventListener("mouseup", O, b), g.current.removeEventListener("mousedown", re, b), g.current.removeEventListener("touchmove", K, b), g.current.removeEventListener("touchend", O, b), g.current.removeEventListener("touchstart", re, b)), F.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      G,
      b
    ), $.current && ($.current.disconnect(), window.removeEventListener("resize", Z, b));
  };
  return Y(() => {
    M.current = n;
  }, [n]), Y(() => {
    ...
    function R() {
      _();
      const E = m.current;
      E && g.current && (E.clearColor(...s), E.clearDepth(1), E.enable(E.DEPTH_TEST), E.depthFunc(E.LEQUAL), E.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, W(), fe(), Q(he(e || L4), t || _1), z(), requestAnimationFrame(ne), se(), Z());
    }
    return requestAnimationFrame(R), () => {
      const E = m.current;
      if (E) {
        if (E.getExtension("WEBGL_lose_context")?.loseContext(), E.useProgram(null), E.deleteProgram(w.current ?? null), b.length > 0)
          for (const j of b)
            E.deleteTexture(j._webglTexture);
        w.current = null;
      }
      ce(), cancelAnimationFrame(H.current ?? 0);
    };
  }, []), /* @__PURE__ */ r(
    "canvas",
    {
...
}`, A4 = 10, $4 = 2, B4 = 0.5, I4 = 0.2, P4 = 1.5, Ce = {
  duration: 0.5,
  ease: "easeOut"
}, rt = {
  duration: 0.35,
...
function j4(e, t) {
  const [o, n] = I(A4), {
    ...
    animate: i,
    motionValue: a
  } = Oe(I4), { value: d, animate: l } = Oe($4), { value: f, animate: u } = Oe(B4), { value: p, animate: C } = Oe(P4), g = Ss(t, {
    fftSize: 512,
  ...
  return Y(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, Ce), l(1.2, Ce), u(0.4, Ce), C(1, Ce);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, Ce), u(0.7, Ce), C([1.5, 2], rt);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, Ce), l(0.5, Ce), u(1, Ce), C([0.5, 2.5], rt);
        return;
      case "speaking":
        n(70), i(0.3, Ce), l(0.75, Ce), u(1.25, Ce), C(1.5, Ce);
        return;
    }
  }, [
    e,
...
function Z4(e) {
  ...
  if (t) {
    const [, o, n, s] = t;
    return [o, n, s].map((a = "00") => parseInt(a, 16) / 255);
  }
}
function Mr({
  shape: e = 1,
  ...
  const g = te(() => Z4(a), [a]);
  return /* @__PURE__ */ r("div", { ref: u, className: p, ...C, children: /* @__PURE__ */ r(
    T4,
    {
      fs: H4,
...
function U6({
  ...
  const { speed: f, scale: u, amplitude: p, frequency: C, brightness: g } = j4(t, s);
  return /* @__PURE__ */ r(
    Mr,
    {
      ref: d,
...
const z6 = ({
  ...
  const n = X(), s = Le();
  return /* @__PURE__ */ c(Re, { children: [
    e && /* @__PURE__ */ r("span", { className: L(O4(), "truncate"), children: e }),
    /* @__PURE__ */ r(Ee, { children: o && t && /* @__PURE__ */ r(
      oe.div,
      {
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: L(Er()), children: t }),
    /* @__PURE__ */ c(
      oe.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ c("div", { className: "flex items-center gap-1", children: [
            ...
            o && /* @__PURE__ */ r("span", { className: L(Ue()), children: o })
          ] }),
          n === "people" && /* @__PURE__ */ r(
            fs,
            {
          ...
          n === "alert" && /* @__PURE__ */ r(gs, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ r(G4, { balance: e.balance })
        ]
      }
    ),
    o && !z4.has(n) && /* @__PURE__ */ r(
      oe.span,
      {
        className: L(Ue()),
        animate: { opacity: s ? 0 : 1 },
...
const X4 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), Y4 = ({
  label: e,
  direction: t
}) => {
  const o = Rr[t];
  ...
  const s = `sparkline-gradient-${it().replace(/:/g, "")}`, i = q4(e, o), a = Rr[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Cs, { width: "100%", height: "100%", children: /* @__PURE__ */ c(
          ms,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ r(vs, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                ws,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ r(Y4, { label: t, direction: i })
      ]
    }
  ) });
}, Fr = h(
  (e, t) => {
    const {
      ...
      className: l,
      ...f
    } = e, [u, p] = I(!1), [C, g] = I(!1), m = u || C, v = Le(), w = m && !!d, x = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, H = () => {
      a?.();
    }, S = (N) => {
      N.currentTarget === N.target && (N.key === "Enter" || N.key === " ") && (N.preventDefault(), a?.());
    };
    return /* @__PURE__ */ c("div", { className: "relative", children: [
      i && /* @__PURE__ */ c(Re, { children: [
        /* @__PURE__ */ r(
          "div",
          {
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: L(Er()), children: n }),
              /* @__PURE__ */ r(
                oe.div,
                {
...
Fr.displayName = "F0AiInsightCardInternal";
const Q4 = ["className"], Nr = h((e, t) => {
  const o = Q4.reduce((n, s) => {
    const { [s]: i, ...a } = n;
    return a;
  }, e);
  return /* @__PURE__ */ r(Fr, { ref: t, ...o });
});
Nr.displayName = "F0AiInsightCard";
const J4 = () => /* @__PURE__ */ c(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ r(ve, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ c("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ r(ve, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ r(ve, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ r(ve, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ r(ve, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], Vr = 180, e6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Vr, t6 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, r6 = (e) => e.showActions !== !1, o6 = (e) => Object.fromEntries(
...
function n6(e) {
  const {
    ...
    description: i,
    seeMoreLabel: a,
    maxCollapsedDescriptionLength: d = Vr
  } = e, [l, f] = I(!1), u = it(), p = P(null), C = e6(
    d
  ), g = i.length > C, m = l ? i : t6(i, C), v = r6(e) ? e : null, w = o6(e);
  return Y(() => {
    l && p.current?.focus();
  }, [l]), /* @__PURE__ */ c(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          t && /* @__PURE__ */ r(Et, { module: t, size: "md" }),
...
n6.displayName = "F0AiProposalCard";
const s6 = ({
  icon: e,
  title: t,
  children: o
  ...
  return /* @__PURE__ */ c(
    Ft,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ c(Nt, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, i6 = (e) => u2[e] ?? Ct, a6 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(le, { icon: i6(e), size: "md", color: "default" }) }) : null;
function c6({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(s6, { icon: l1, title: n, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(a6, { iconName: s.icon });
...
c6.displayName = "F0AiMessageSources";
async function l6(e, t, o) {
  const n = await import("./xlsx-Bedf3nwD.js"), s = n.utils.table_to_book(e, { sheet: "Data" });
  n.writeFile(s, `${o}.${t}`);
}
function d6({
  ...
  const n = X(), s = P(null), i = t ?? n.ai.aiTable.title, a = q(
    (d) => {
      if (!s.current) return;
  ...
  return e.columns?.length ? /* @__PURE__ */ c(
    r1,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r(r1, { overflowX: "auto", children: /* @__PURE__ */ c(
          "table",
          {
            ref: s,
            className: L(
            ...
            children: [
              ...
              /* @__PURE__ */ r("tbody", { children: e.rows.map((d, l) => /* @__PURE__ */ r("tr", { children: e.columns.map((f) => {
                const u = d[f];
                return /* @__PURE__ */ r(
                  "td",
                  {
                    className: "max-w-72 border-0 border-b border-solid border-f1-border-secondary px-3 py-2 text-f1-foreground",
                    children: /* @__PURE__ */ r(de, { children: u == null ? "" : String(u) })
                  },
                  f
                );
              }) }, l)) })
...
d6.displayName = "F0AiTableCard";
function u6({ credits: e }) {
  const t = X(), [o, n] = I(!1), [s, i] = I(!1), [a, d] = I(!1), [l, f] = I(null), u = q(
    (g) => {
      n(g), g && e?.fetchUsage && (i(!0), d(!1), e.fetchUsage().then((m) => {
        f(m), d(!1);
      }).catch(() => {
        d(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const p = l ? Math.min(100, Math.round(l.used / l.total * 100)) : 0, C = e.companyName;
  return /* @__PURE__ */ c(u1, { open: o, onOpenChange: u, children: [
    /* @__PURE__ */ r(f1, { asChild: !0, children: /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
        hideLabel: !0,
        ...
        children: [
          C && /* @__PURE__ */ c("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            ...
            /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ r(de, { tag: "span", className: "font-medium", children: e.companyName ?? "" }),
...
const f6 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function h6({
  employeeCredits: e
}) {
  const t = X(), o = Le(), [n, s] = I(!1), [i, a] = I(!1), [d, l] = I(!1), [f, u] = I(null), p = q(
    (v) => {
  ...
  if (!e) return null;
  const C = !!e.companyName, g = f && f.total > 0 ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, m = f ? Math.max(0, f.total - f.used) : 0;
  return /* @__PURE__ */ c(u1, { open: n, onOpenChange: p, children: [
    /* @__PURE__ */ r(f1, { asChild: !0, children: /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
      ...
      h1,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2 p-3", children: [
            ...
            !i && !d && f && /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ c("div", { className: "flex justify-between", children: [
...
const ot = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(h6, { employeeCredits: t }) : e ? /* @__PURE__ */ r(u6, { credits: e }) : null, q6 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const C = X(), g = Ls(`(max-width: ${bs.md}px)`, {
        ...
        /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ r(
          $e,
          {
            ...
            children: /* @__PURE__ */ c("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ r(de, { lines: 1, className: "min-w-0 text-left", children: o ?? C.ai.newConversation }),
              /* @__PURE__ */ r(le, { icon: c1, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ c(
  ...
  ) : /* @__PURE__ */ c("header", { className: L("flex justify-between px-4 py-3"), children: [
...
function g6() {
  if (!(typeof navigator > "u"))
    return Es(navigator.language);
}
function p6(e) {
  const t = new Date(e), o = /* @__PURE__ */ new Date();
  return Ht(t) ? "today" : At(t) ? "yesterday" : ys(t, o) ? "thisMonth" : "older";
}
function C6(e, t) {
  const o = new Date(e), n = g6(), s = R1(o, "p", { locale: n });
  if (Ht(o)) return `${t.today}, ${s}`;
  if (At(o)) return `${t.yesterday}, ${s}`;
  const i = !Ms(o, /* @__PURE__ */ new Date());
  return `${R1(o, i ? "MMM d yyyy" : "MMM d", {
    locale: n
  })}, ${s}`;
}
function m6(e) {
...
function v6({
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      tabIndex: 0,
      onKeyDown: (f) => {
        (f.key === "Enter" || f.key === " ") && (f.preventDefault(), o(e.id, e.title));
      },
      children: [
        /* @__PURE__ */ c(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ r(de, { lines: 1, className: "text-left font-medium", children: e.title }),
        ...
        /* @__PURE__ */ r(
          "div",
          {
            ...
            children: /* @__PURE__ */ r(g1, { items: d, children: /* @__PURE__ */ r(
              me,
              {
                icon: pt,
                variant: "ghost",
...
function nt({
  ...
  return /* @__PURE__ */ c("div", { children: [
    ...
    d && /* @__PURE__ */ r("div", { className: "flex flex-col", children: t.map((p) => /* @__PURE__ */ r(
      v6,
      {
        thread: p,
        isPinned: o.has(p.id),
...
const X6 = ({
  ...
  const g = te(
    ...
    return n.filter((T) => T.title.toLowerCase().includes(k));
  }, [n, p]), v = te(
    () => m.filter((k) => a.has(k.id)),
    [m, a]
  ), w = te(
    () => m.filter((k) => !a.has(k.id)),
    [m, a]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ c("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ r(le, { icon: l1, color: "secondary", size: "md" }),
                  /* @__PURE__ */ r(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ r(
                    $e,
                    {
                      ...
                      children: /* @__PURE__ */ c("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ r(le, { icon: m1, color: "default", size: "md" }),
                        /* @__PURE__ */ r(de, { lines: 1, className: "text-left", children: u.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ r(w6, {}),
                  !s && i && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: i }),
                  !s && !i && !y && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: u.ai.noPreviousChats }),
...
function Y6({
  ...
  const [n, s] = I([]), [i, a] = I(!1), [d, l] = I(null), [f, u] = I(x6), p = q(async () => {
    a(!0), l(null);
    try {
      const v = await t();
      s(v);
  ...
  const C = q((v) => {
    u((w) => {
      const x = new Set(w);
      return x.add(v), n1(x), x;
    });
  }, []), g = q((v) => {
    u((w) => {
      const x = new Set(w);
      return x.delete(v), n1(x), x;
    });
  }, []), m = q(
    async (v) => {
      try {
        await o(v), s((w) => w.filter((x) => x.id !== v)), u((w) => {
          if (!w.has(v)) return w;
          const x = new Set(w);
          return x.delete(v), n1(x), x;
        });
...
const k6 = oe.create(Ns), L6 = ({ label: e }) => /* @__PURE__ */ c("div", { className: "flex flex-row items-center gap-1 rounded-full border border-solid border-f1-border-secondary bg-f1-background px-2 py-1.5 pr-2.5 shadow-md", children: [
  /* @__PURE__ */ r(
    k6,
    {
      size: "xs",
  ...
  const { t: i } = X(), a = o ?? i("ai.applyingChanges");
  return Y(() => {
    if (!t) return;
    const d = document.activeElement;
    d && d.getAttribute("name") !== "one-ai-input" && d.blur();
  }, [t]), /* @__PURE__ */ c("div", { className: L("relative flex flex-1 flex-col", n), children: [
    /* @__PURE__ */ r(Ee, { children: t && // Zero-height sticky anchor pinned to the top of the scroll viewport,
    ...
    /* @__PURE__ */ r(
      oe.div,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "mt-[40vh]", children: /* @__PURE__ */ r(L6, { label: a }) })
      }
    ) }),
    /* @__PURE__ */ r(
      oe.div,
      {
        className: L("flex flex-1 flex-col", t && "pointer-events-none"),
...
function Q6({
  ...
  return /* @__PURE__ */ r("div", { className: "grid w-full grid-cols-2 gap-3", children: e.map((o) => /* @__PURE__ */ r(
    Tt,
    {
      avatar: { type: "icon", icon: o.icon },
      title: o.title,
      description: o.description,
      onClick: () => {
        o.onClick ? o.onClick() : o.message && t?.(o.message);
      }
    },
    o.title
  )) });

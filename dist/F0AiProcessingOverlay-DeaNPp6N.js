...
import { F as Ss, c as Ts, b as Hs, a as As } from "./VolumeMuted-DKLKhxyd.js";
function Es(e, r, o) {
  Ir(() => e.on(r, o), [e, r, o]);
}
const $s = (e, r) => /* @__PURE__ */ a(
  "svg",
  {
...
It.displayName = "ShoppingCart";
const $0 = (e, r) => /* @__PURE__ */ a(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  Calculator: oo,
  Calendar: no,
  CalendarArrowDown: ii,
  CalendarArrowLeft: li,
  CalendarArrowRight: di,
  CameraPlus: fi,
  CardPin: pi,
  ChartFunnel: Ci,
  ChartHorizontalBars: wi,
  ChartLine: xi,
  ChartPie: Li,
  ...
  DropdownOpen: go,
  Ellipsis: dt,
  EllipsisHorizontal: wo,
  Envelope: vo,
  EnvelopeOpen: ia,
  Equal: xo,
  EqualApproximately: bo,
  EqualGreater: Lo,
  EqualLess: ko,
  Exit: la,
  ExternalLink: ut,
  ...
  FaceNeutral: Fo,
  FacePositive: No,
  FaceSuperNegative: Vo,
  FaceSuperPositive: So,
  Feed: da,
  File: To,
  FileFilled: fa,
  FileSigned: pa,
  ...
  Messages: v5,
  Microphone: ht,
  MicrophoneNegative: nn,
  Minimize: pt,
  MinimizeHorizontal: sn,
  Minus: an,
  Mobile: b5,
  Money: Bt,
  MoneyBag: y5,
  MonitorDot: R5,
  MonitorSmartphone: N5,
  Moon: S5,
  Mouse: H5,
  MoveDown: ln,
  MoveTop: E5,
...
const te = In(
  ...
  "div",
  {
    ...
    children: e.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ t(i1, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ t(
        j2,
        {
          att: s,
          onRemove: o,
  ...
  const n = /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    ...
    /* @__PURE__ */ t(
      "button",
      {
        ...
        onClick: () => r(e.id),
        children: /* @__PURE__ */ t(a1, { icon: k1, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ t(Dn, { label: e.errorMessage, children: n }) : n;
}
const _2 = {
  soft: {
    text: "",
...
function O2({
  ...
  W(() => {
    ...
    const u = c.current, p = u?.offsetParent;
    if (!u || !p) return;
  ...
  return !e || f ? null : /* @__PURE__ */ t(
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (u, p) => /* @__PURE__ */ a(
        "div",
        {
          className: "flex items-center gap-2 p-2",
          "aria-hidden": "true",
          children: [
            /* @__PURE__ */ t(i1, { className: "size-5 shrink-0 rounded-full" }),
            /* @__PURE__ */ t(
              i1,
              {
        ...
        const C = p === n, h = `${u.firstName} ${u.lastName}`.trim();
        return /* @__PURE__ */ a(
          "div",
          {
            ref: C ? d : void 0,
...
const U2 = ({
  ...
  const s = v1(), [i, c] = P(""), [d, l] = P(0), [f, u] = P(!1), p = $(null), C = $(null), h = $(null), g = e[d] ?? r;
  return W(() => {
    const v = () => {
    ...
    if (s)
      return u(!1), c(g), v(), p.current = setTimeout(() => {
...
const K2 = ({
  ...
  const [s, i] = P(null), c = $(null), d = $(null), l = $(!1), f = G1(), u = G1(), p = s !== null ? e[s] : null;
  return e.length === 0 ? null : /* @__PURE__ */ a(
    fe,
    {
      ...
      children: [
        /* @__PURE__ */ t("div", { className: "flex min-h-[72px] w-full items-end", children: /* @__PURE__ */ t(_n, { asChild: !0, children: /* @__PURE__ */ t(
          "div",
          {
            ref: c,
            ...
            children: e.map((C, h) => /* @__PURE__ */ t(
              d1,
              {
                ...
                onClick: (g) => {
                  d.current = g.currentTarget, l.current = !1, i((v) => v === h ? null : h), o?.(null);
                }
              },
              `${C.label}-${h}`
            ))
        ...
        p && /* @__PURE__ */ a(
          he,
          {
            ...
            onCloseAutoFocus: (C) => {
              C.preventDefault(), l.current && d.current?.focus(), l.current = !1;
            },
            onEscapeKeyDown: () => {
              l.current = !0;
            },
...
const tl = 4e3;
function rl(e) {
  const [r, o] = P([]), [n, s] = P(null), i = $(
    null
  ), c = $(null), d = G(), l = e?.onUploadFiles, f = e?.allowedMimeTypes, u = e?.maxFiles, p = K(() => {
    if (f)
      return Array.isArray(f) ? f.join(",") : f;
  }, [f]), C = u !== void 0 && r.length >= u, h = $(0);
  W(() => {
    h.current = r.length;
  }, [r]);
  const g = O((A) => {
  ...
  const v = O(
    async (A) => {
      ...
      if (u !== void 0 && h.current + V.length > u) {
        g(
      ...
      try {
        ...
        const B = y instanceof Error && y.message ? y.message : d.ai.fileUploadError;
        S(B);
      }
    },
    [
...
function al({
  ...
  const [i, c] = P(!1), [d, l] = P(""), [f, u] = P([]), [p, C] = P(!1), [h, g] = P(0), [v, w] = P([]), b = $(-1), H = $(null), A = $(0), V = $(-1);
  W(() => {
    if (!n) {
      c(!1);
      return;
    ...
    const T = ol(e, o, v);
    if (!T) {
      c(!1), l(""), u([]), g(0), b.current = -1, V.current = -1;
      return;
    }
    ...
    return H.current = setTimeout(() => {
      n(T.query).then((U) => {
        I === A.current && (u(U), g(0), U.length === 0 && T.query.length > 0 && (V.current = T.atIndex, c(!1)));
      }).catch(() => {
        I === A.current && u([]);
      }).finally(() => {
        I === A.current && C(!1);
...
const ll = /[\\`*_{}[\]()#+\-.!|~>]/g, cl = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(ll, "\\$&")).join(""), z4 = ({
  ...
  const P1 = x1.status === "recording", J1 = P1 ? y.ai.listening : y.ai.inputPlaceholder, E1 = C1.filter((Y) => Y.status === "uploaded"), T1 = C1.some((Y) => Y.status === "uploading"), D1 = C1.some((Y) => Y.status === "error"), j1 = N.trim().length > 0 || E1.length > 0;
  W(() => {
    if (!(!J || T1)) {
      if (t1(!1), D1) {
        w1(y.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  }, we = q ? q.prompt ?? q.title : null, ve = P1 ? [y.ai.listening] : we ? [we] : s ?? [], Hr = ve.length > 1, Ar = K(() => Q2(N, s1.mentions, {
    cursorPosition: I,
    inlineCompletion: s1.inlineCompletion
  }), [N, s1.mentions, I, s1.inlineCompletion]), Er = s1.mentions.length > 0 || s1.inlineCompletion !== null, xe = H && !!V && V.length > 0 && !!F ? /* @__PURE__ */ t(
    K2,
    {
      suggestions: V,
      onItemClick: p1,
  ...
  ) : null, $r = H && A && !!x && x.length > 0, be = A && H, { motionProps: Br } = On(
    H,
    160,
    0.5
  );
  return /* @__PURE__ */ a(
    Q.div,
    {
      ...
      children: [
          ...
          /* @__PURE__ */ t(Z2, { creditWarning: i, children: /* @__PURE__ */ a(
            Q.form,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ t(R1, { initial: !1, children: o1 ? /* @__PURE__ */ t(
                  Q.div,
                  {
                  ...
                  Q.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ t(R1, { initial: !1, children: f1 && /* @__PURE__ */ t(
                        Q.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ a(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ t("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ t(Un, { type: "critical", size: "sm" }) }),
                                /* @__PURE__ */ t("p", { className: "font-medium text-f1-foreground-critical", children: f1 })
                              ]
                            }
                          )
                        },
        ...
        $r && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(q2, { cards: x }) }),
        b && H && A && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: b }),
        /* @__PURE__ */ t(R1, { mode: "wait", initial: !1, children: o1 ? /* @__PURE__ */ a(
          Q.div,
          {
...
function ml({
  ...
  return /* @__PURE__ */ t(Gn, { ...r, variant: "link", href: r.href, children: e });
}
function Cl({
  children: e,
  ...r
...
function A1({
  ...
  const i = $(/* @__PURE__ */ new Map()), [c, d] = P(
  ...
  return /* @__PURE__ */ a(
    Wn,
    {
      ...
      children: [
        /* @__PURE__ */ t(qn, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          Xn,
          {
            side: "top",
...
function Vl({
  ...
  const { entityRefs: o } = y1(), n = o?.resolvers?.candidate, s = G(), i = o?.urls?.candidate?.(e), c = K(
    () => (l) => {
      const f = [];
      return l.source && f.push({
        ...
        ...f.length > 0 && {
          children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-2", children: f.map((u) => /* @__PURE__ */ a("div", { className: "flex flex-col", children: [
...
function Sl({ id: e, label: r }) {
  const { entityRefs: o } = y1(), n = o?.resolvers?.expense, s = G(), i = o?.urls?.expense?.(e), c = K(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: Bt
...
function Tl({
  ...
  const { entityRefs: o } = y1(), n = o?.resolvers?.jobPosting, s = G(), i = o?.urls?.jobPosting?.(e), c = K(
    () => (l) => ({
      title: l.title,
...
function Al({
  ...
  const { entityRefs: o } = y1(), n = o?.resolvers?.requisition, s = G(), i = o?.urls?.requisition?.(e), c = K(
    () => (l) => {
...
function El({ id: e, label: r }) {
  const { entityRefs: o } = y1(), n = o?.resolvers?.person, s = G(), i = o?.urls?.person?.(e), c = K(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
function $l({ id: e, label: r }) {
  const { entityRefs: o } = y1(), n = o?.resolvers?.vacancy, s = G(), i = o?.urls?.vacancy?.(e), c = K(
    () => (l) => ({
      title: l.name,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ t(Kn, { file: e.file, size: "lg" }),
...
function Dl(e) {
  ...
  return K(() => !o || o.length === 0 ? null : (n, s, i) => {
    ...
    for (const l of o) {
      ...
      if (!f || !u) continue;
      let p = 0;
      l.formName !== void 0 && (p += 2), l.customFieldName !== void 0 && (p += 1), p > d && (d = p, c = l);
    }
    if (c)
...
function Ol(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = es(e), i = [];
...
function cr({
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: u } = y1(), p = Dl(e), C = d ?? p, h = $(() => {
...
const fr = W1(void 0), X4 = () => I1(fr), Wl = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), ql = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", l = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, f = o?.toolCalls?.[0]?.id, u = !d && !l, p = $(null), { anchor: C, clear: h } = dr({
    containerRef: p,
    enabled: !!(o?.id && d)
  });
  return W(() => {
    o?.id && !r && !e && i?.(o);
  }, [o, r, e, i]), !r && !e && u ? null : /* @__PURE__ */ t(fr.Provider, { value: f, children: /* @__PURE__ */ a("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ t(
      "div",
      {
        ref: p,
  ...
  const [s, i] = P(""), c = G(), { title: d, label: l, placeholder: f } = o === "like" ? c.ai.feedbackModal.positive : c.ai.feedbackModal.negative, u = O(() => {
    r(n, s);
  }, [s, n, r]), p = () => {
    e(n);
  };
...
const Ql = ({
  ...
  const n = G(), { open: s } = pr(), [i, c] = P(null);
  ...
  const [d, l] = P(s), f = v1(), u = n !== void 0, p = u ? n : d;
  return /* @__PURE__ */ a(
    Rt,
    {
  ...
  const s = G(), [i, c] = P(!!o), d = $(o);
  W(() => {
    d.current && !o ? c(!1) : o && !i && c(!0), d.current = o;
  }, [o, i]);
  const l = o ? s.ai.thoughtsGroupTitle : r ?? s.ai.thoughtsGroupTitle, f = e.length - 1, u = (p) => !o || n ? "completed" : p === f ? "executing" : "completed";
  return /* @__PURE__ */ t(
    Jl,
    {
      icon: $t,
...
const mr = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), o6 = ({
  ...
  const c = e.rawData, d = r6(
    e?.content,
    c
  ), l = (t6(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = l.length > 0, { anchor: p, clear: C } = dr({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ a(
  ...
  const [i, c] = P(0), [d, l] = P(0), [f, u] = P("starting"), p = v1(), C = e[i] ?? "", h = e.join("\0"), g = $(!0);
  W(() => {
    if (g.current) {
      g.current = !1;
      return;
    ...
    let b;
    if (f === "starting")
      b = setTimeout(() => u("writing"), a6);
    else if (f === "writing")
      d < C.length ? b = setTimeout(() => l((H) => H + 1), s6) : u("holding");
    else if (f === "holding") {
      if (e.length <= 1) return;
      b = setTimeout(() => u("erasing"), l6);
    } else f === "erasing" && (d > 0 ? b = setTimeout(() => l((H) => H - 1), i6) : b = setTimeout(() => {
      c((H) => (H + 1) % e.length), u("starting");
    }, c6));
    return () => {
      b && clearTimeout(b);
    };
  }, [f, d, C.length, e.length, p]);
  const v = !!n, w = v ? (b) => {
      ...
      children: /* @__PURE__ */ a("div", { className: "flex flex-col items-center", children: [
        ...
        /* @__PURE__ */ a(
          "p",
          {
            ...
            children: [
              /* @__PURE__ */ t("span", { "aria-hidden": "true", children: p ? C : C.slice(0, d) }),
...
const f6 = {
...
}, Y4 = (e) => /* @__PURE__ */ t(Yl, { children: /* @__PURE__ */ t(h6, { ...e }) }), h6 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
          ...
          children: /* @__PURE__ */ a(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ t(R1, { children: q && /* @__PURE__ */ t(
                  Q.div,
                  {
  ...
  /* @__PURE__ */ t("div", { className: "flex justify-end", children: /* @__PURE__ */ t(i1, { className: "h-12 w-2/5 rounded-full" }) }),
  /* @__PURE__ */ t(i1, { className: "mt-6 h-5 w-full rounded-md" }),
  /* @__PURE__ */ t(i1, { className: "h-5 w-2/5 rounded-md" }),
  /* @__PURE__ */ t(i1, { className: "h-5 w-4/5 rounded-md" })
] }) }), K4 = {
  ai: Fs.ai
}, Cr = W1(null);
function Q4({
...
const C6 = ({
  ...
  const C = G().ai.clarifyingQuestion.typeYourAnswer, h = $(null), g = Rs(h, c);
  ie(() => {
    const w = h.current;
    if (!w) return;
    w.style.height = "auto";
...
function Be(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), l = Math.min(d, Math.floor(e / 2)), f = Math.min(d, Math.floor(r / 2)), u = (j) => j / e * 2 - 1, p = (j) => j / r * 2 - 1, C = 0, h = e, g = 0, v = r, w = l, b = e - l, H = f, A = r - f, V = u(C), F = u(h), x = p(g), S = p(v), y = u(w), B = u(b), N = p(H), T = p(A), I = 0, U = 0, Z = 1, z = 1, J = l / e, t1 = 1 - l / e, q = f / r, X = 1 - f / r, r1 = new Float32Array([
    // Top strip
    V,
    x,
    F,
...
class rc {
  ...
  resize(r, o, n) {
    ...
    const { gl: s, program: i, vao: c, positionBuffer: d, uvBuffer: l, uResolution: f } = this.glr, u = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, p = Math.max(1, Math.floor(r * u)), C = Math.max(1, Math.floor(o * u));
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, i = this.canvas.height || 2, { positions: c, uvs: d } = Be(
      s,
      i,
...
`,
    ...
    if (N.current.iDate?.isNeeded) {
      const E = /* @__PURE__ */ new Date(), _ = E.getMonth() + 1, c1 = E.getDate(), f1 = E.getFullYear(), w1 = E.getHours() * 60 * 60 + E.getMinutes() * 60 + E.getSeconds() + E.getMilliseconds() * 1e-3, s1 = R.getUniformLocation(
        w.current,
        Ze
      );
      R.uniform4fv(s1, [f1, _, c1, w1]);
    }
    ...
    if (S.current.length > 0)
      for (let E = 0; E < S.current.length; E++) {
        const _ = S.current[E];
        if (!_) return;
        const { isVideo: c1, _webglTexture: f1, source: w1, flipY: s1, isLoaded: V1 } = _;
        if (!V1 || !f1 || !w1) return;
        if (N.current[`iChannel${E}`]?.isNeeded) {
          ...
          R.activeTexture(R.TEXTURE0 + E), R.bindTexture(R.TEXTURE_2D, f1), R.uniform1i(S1, E), c1 && _.updateTexture(
            f1,
            w1,
            s1
          );
    ...
    if (N.current.iMouse?.isNeeded && l !== 1 && Array.isArray(M)) {
      ...
      M[0] = Qe(D, x.current[0] ?? 0, l), M[1] = Qe(E, x.current[1] ?? 0, l);
    }
  ...
  return W(() => {
    ...
    function R() {
      U();
      const M = g.current;
      M && h.current && (M.clearColor(...s), M.clearDepth(1), M.enable(M.DEPTH_TEST), M.depthFunc(M.LEQUAL), M.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, j(), o1(), e1(n1(e || V6), r || De), Z(), requestAnimationFrame(C1), N1(), X());
    }
    return requestAnimationFrame(R), () => {
      ...
      u1(), cancelAnimationFrame(H.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
}`, _6 = 10, Z6 = 2, O6 = 0.5, U6 = 0.2, z6 = 1.5, g1 = {
  duration: 0.5,
  ease: "easeOut"
}, Je = {
  duration: 0.35,
...
function G6(e, r) {
  const [o, n] = P(_6), {
    ...
    animate: i,
    motionValue: c
  } = U1(U6), { value: d, animate: l } = U1(Z6), { value: f, animate: u } = U1(O6), { value: p, animate: C } = U1(z6), h = Ns(r, {
    fftSize: 512,
  ...
  return W(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, g1), l(1.2, g1), u(0.4, g1), C(1, g1);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, g1), u(0.7, g1), C([1.5, 2], Je);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, g1), l(0.5, g1), u(1, g1), C([0.5, 2.5], Je);
        return;
      case "speaking":
        n(70), i(0.3, g1), l(0.75, g1), u(1.25, g1), C(1.5, g1);
        return;
    }
  }, [
    e,
...
function vr({
  ...
  const h = K(() => q6(c), [c]);
  return /* @__PURE__ */ t("div", { ref: u, className: p, ...C, children: /* @__PURE__ */ t(
    D6,
    {
      fs: j6,
...
function oc({
  ...
  const { speed: f, scale: u, amplitude: p, frequency: C, brightness: h } = G6(r, s);
  return /* @__PURE__ */ t(
    vr,
    {
      ref: d,
...
), xr = "relative flex w-full flex-col overflow-hidden rounded-xl border border-solid border-f1-border-secondary bg-f1-background shadow-md", br = "aspect-video w-full flex-shrink-0 p-1", Lr = "flex flex-col gap-2 p-3", X6 = (e) => Object.fromEntries(
  ...
  function(r, o) {
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        ...r,
        children: [
          /* @__PURE__ */ t("div", { className: br, children: /* @__PURE__ */ t(i1, { className: "h-full w-full rounded-lg" }) }),
          /* @__PURE__ */ a("div", { className: Lr, children: [
            /* @__PURE__ */ a("div", { className: "flex w-full flex-col gap-1", children: [
              /* @__PURE__ */ t(i1, { className: "h-6 w-3/4" }),
              /* @__PURE__ */ t(i1, { className: "h-4 w-full" }),
              /* @__PURE__ */ t(i1, { className: "h-4 w-2/3" })
            ] }),
            /* @__PURE__ */ a("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ t(i1, { className: "h-8 w-24" }),
              /* @__PURE__ */ t(i1, { className: "h-8 w-20" })
            ] })
          ] })
        ]
      }
...
K6.displayName = "F0AiAnnouncementCard";
const Q6 = H1({
  base: [
...
const s4 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), i4 = ({
  label: e,
  direction: r
}) => {
  const o = Mr[r];
  ...
  const s = `sparkline-gradient-${G1().replace(/:/g, "")}`, i = n4(e, o), c = Mr[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(fs, { width: "100%", height: "100%", children: /* @__PURE__ */ a(
          hs,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(ps, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                ms,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(i4, { label: r, direction: i })
      ]
    }
  ) });
}, Rr = m(
  (e, r) => {
    const {
      ...
      className: l,
      ...f
    } = e, [u, p] = P(!1), [C, h] = P(!1), g = u || C, v = v1(), w = g && !!d, b = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, H = () => {
      c?.();
...
Rr.displayName = "F0AiInsightCardInternal";
const l4 = ["className"], Fr = m((e, r) => {
  const o = l4.reduce((n, s) => {
    const { [s]: i, ...c } = n;
    return c;
  }, e);
  return /* @__PURE__ */ t(Rr, { ref: r, ...o });
});
Fr.displayName = "F0AiInsightCard";
const c4 = () => /* @__PURE__ */ a(
  "div",
  {
    ...
    "aria-live": "polite",
    children: [
      /* @__PURE__ */ t(i1, { className: "h-3 w-3/4 rounded" }),
      /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col justify-end gap-2", children: [
        /* @__PURE__ */ a("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ t(i1, { className: "h-5 w-full rounded" }),
          /* @__PURE__ */ t(i1, { className: "h-5 w-2/3 rounded" })
        ] }),
        /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ t(i1, { className: "h-5 w-5 rounded-full" }),
          /* @__PURE__ */ t(i1, { className: "h-3 w-20 rounded" })
        ] })
      ] })
    ]
  }
  ...
  "balance",
  "sparkline"
], Nr = 180, d4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Nr, u4 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, f4 = (e) => e.showActions !== !1, h4 = (e) => Object.fromEntries(
  Object.entries(e).filter(([r]) => r.startsWith("data-"))
);
function p4(e) {
  const {
    ...
    description: i,
    seeMoreLabel: c,
    maxCollapsedDescriptionLength: d = Nr
  } = e, [l, f] = P(!1), u = G1(), p = $(null), C = d4(
    d
  ), h = i.length > C, g = l ? i : u4(i, C), v = f4(e) ? e : null, w = h4(e);
  return W(() => {
    l && p.current?.focus();
  }, [l]), /* @__PURE__ */ a(
    "section",
...
p4.displayName = "F0AiProposalCard";
const m4 = ({
  icon: e,
  title: r,
  children: o
...
}, C4 = (e) => v2[e] ?? ut, g4 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(a1, { icon: C4(e), size: "md", color: "default" }) }) : null;
function w4({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(m4, { icon: de, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const c = /* @__PURE__ */ t(g4, { iconName: s.icon });
...
w4.displayName = "F0AiMessageSources";
              ...
              /* @__PURE__ */ t("tbody", { children: e.rows.map((d, l) => /* @__PURE__ */ t("tr", { children: e.columns.map((f) => {
                ...
                return /* @__PURE__ */ t(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ t(l1, { children: u == null ? "" : String(u) })
                  },
                  f
                );
              }) }, l)) })
...
x4.displayName = "F0AiTableCard";
function b4({ credits: e, trigger: r }) {
  const o = G(), [n, s] = P(!1), [i, c] = P(!1), [d, l] = P(!1), [f, u] = P(null), p = O(
    (g) => {
  ...
  return /* @__PURE__ */ a(fe, { open: n, onOpenChange: p, children: [
    /* @__PURE__ */ t(Tt, { asChild: !0, children: r ?? /* @__PURE__ */ t(
      d1,
      {
        variant: "ghost",
        hideLabel: !0,
...
function k4({
  ...
  const o = G(), n = v1(), [s, i] = P(!1), [c, d] = P(!1), [l, f] = P(!1), [u, p] = P(null), C = O(
    (w) => {
      i(w), w && e?.fetchUsage && (d(!0), f(!1), e.fetchUsage().then((b) => {
        p(b), f(!1);
      }).catch(() => {
        f(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const h = !!e.companyName, g = u && u.total > 0 ? Math.min(100, Math.round(u.used / u.total * 100)) : 0, v = u ? Math.max(0, u.total - u.used) : 0;
      ...
      he,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ t("div", { className: "flex flex-col rounded border border-solid border-f1-border-secondary", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2 p-3", children: [
            ...
            !c && !l && u && /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ a("div", { className: "flex justify-between", children: [
...
const se = ({
...
) : e ? /* @__PURE__ */ t(b4, { credits: e, trigger: o }) : null, ac = se, lc = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const g = G(), v = v1(), w = gs(`(max-width: ${ws.md}px)`, {
...
function y4(e) {
  ...
  return Ht(r) ? "today" : At(r) ? "yesterday" : xs(r, o) ? "thisMonth" : "older";
}
function M4(e, r, o) {
  const n = new Date(e), s = Fe(n, "p", { locale: o });
  if (Ht(n)) return `${r.today}, ${s}`;
  if (At(n)) return `${r.yesterday}, ${s}`;
  const i = !vs(n, /* @__PURE__ */ new Date());
        ...
        n ? (
          ...
          /* @__PURE__ */ t(
            "div",
            {
              ...
              children: /* @__PURE__ */ t(Ls, { size: "small" })
            }
          )
        ) : /* @__PURE__ */ t(
          "div",
                  ...
                  /* @__PURE__ */ t(
                    B1,
                    {
                      ...
                      children: /* @__PURE__ */ a("div", { className: "flex w-full items-center gap-2", children: [
                        ...
                        /* @__PURE__ */ t(l1, { lines: 1, className: "text-left", children: u.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ t(V4, {}),
                  !s && i && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: i }),
                  !s && !i && !F && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: u.ai.noPreviousChats }),
...
function dc({
  ...
  const [i, c] = P([]), [d, l] = P(!1), [f, u] = P(null), [p, C] = P(S4), [h, g] = P(() => /* @__PURE__ */ new Set()), v = O(async () => {
    l(!0), u(null);
    try {
      const x = await r();
      c(x);
...
const T4 = Q.create(Ms), H4 = ({
  ...
  const { t: i } = G(), c = v1(), d = o ?? i("ai.applyingChanges");
  return W(() => {
    if (!r) return;

...
import { useInsertionEffect as wr, forwardRef as h, useRef as I, useEffect as W, useLayoutEffect as X1, useState as A, useMemo as X, useCallback as Z, createContext as je, useContext as Te, useId as Y1, createElement as kr, memo as Lr } from "react";
import { av as xr, dd as br, ac as K1, cb as yr, de as Mr, df as Er, dg as Rr, dh as Fr, cc as Nr, ck as Q1, ca as Vr, di as Sr, al as qe, dj as Tr, b2 as Hr, dk as Ar, dl as $r, dm as Br, aD as Ir, dn as Pr, cL as Dr, an as J1, aq as jr, dp as Zr, q as Xe, ag as et, a7 as Ze, o as tt, bz as _r, ci as Ur, dq as Or, bl as zr, cK as Gr, ae as Fe, aQ as Wr, bD as rt, dr as qr, cI as Xr, l as Me, cG as Yr, ds as Kr, c4 as ot, bk as Qr, dt as Jr, du as eo, dv as to, dw as ro, dx as oo, dy as nt, cz as no, cA as so, dz as ao, dA as io, dB as co, dC as lo, dD as fo, bN as uo, ce as ho, dE as Co, at as go, dF as po, dG as vo, dH as mo, dI as wo, dJ as ko, dK as Lo, bM as xo, cJ as bo, ao as yo, cv as Mo, dL as Eo, dM as Ro, dN as Fo, dO as No, dP as Vo, dQ as So, dR as To, aM as Ho, bO as Ao, c6 as st, a4 as $o, af as Bo, bP as at, c3 as Io, c5 as it, i as Po, bC as Do, bB as jo, aA as Zo, dS as _o, dT as Uo, bQ as ct, bR as Oo, bS as zo, bj as Go, aT as Wo, dU as qo, j as Xo, bx as lt, bw as dt, br as Yo, dV as ft, bq as Ko, cd as Ye, r as Qo, bu as Ke, au as Jo, dW as en, dX as Qe, cg as tn, ch as rn, cH as ut, dY as on, $ as nn, _ as sn, dZ as an, d_ as cn, d$ as ln, e0 as dn, c1 as fn, e1 as ht, e2 as un, ap as hn, e3 as Cn, a3 as ae, u as z, c0 as gn, S as de, b$ as Ct, a0 as ie, U as fe, ah as pn, n as L, m as pe, e4 as vn, ar as se, aB as ke, Z as Ee, K as Q, cQ as gt, aY as Je, e5 as mn, aZ as e1, a_ as t1, b as ye, bZ as wn, e6 as kn, b_ as Ln, a8 as xn, bi as bn, ak as r1, bT as yn, bU as Mn, bV as En, bW as v1, ai as Rn, aH as pt, b9 as vt, cf as Fn, cV as Nn, e7 as Vn, e8 as Sn, be as mt, e9 as Tn, cR as Hn, ea as An, bb as Se, bs as wt, eb as kt, bt as Lt, c as ze, cj as m1, ec as xt, ed as $n, ee as Bn, L as He, bH as In, ef as Pn, by as o1, cw as Dn, eg as jn, eh as Zn, ei as _n, ej as Un, ek as On, w as zn, t as Gn, aw as Ue, X as Wn, Y as qn, aG as w1, el as bt, em as yt, en as Xn, eo as Yn, aF as Kn, am as Qn, ep as Jn, eq as es, d as ts } from "./F0CanvasPanel-n31_4o-u.js";
import { createPortal as Mt } from "react-dom";
import { defaultTranslations as rs } from "./i18n-provider-defaults.js";
import { useTrackVolume as os } from "@livekit/components-react";
import { F as ns } from "./Printer-B7iDPx2r.js";
function ss(e, r, o) {
  wr(() => e.on(r, o), [e, r, o]);
}
const as = (e, r) => /* @__PURE__ */ i(
  "svg",
  {
...
Ft.displayName = "ShoppingCart";
const c0 = (e, r) => /* @__PURE__ */ i(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
), J0 = h(Q0), ec = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: is,
  Add: xr,
  Ai: ls,
  ...
  Calculator: Pr,
  Calendar: Dr,
  CalendarArrowDown: Hs,
  CalendarArrowLeft: $s,
  CalendarArrowRight: Is,
  CameraPlus: Ds,
  CardPin: Zs,
  ChartFunnel: Us,
  ChartHorizontalBars: zs,
  ChartLine: Ws,
  ChartPie: Xs,
  ChartVerticalBars: Ks,
  Check: J1,
  CheckCircle: jr,
  CheckCircleLine: Js,
  CheckDouble: Zr,
  ...
  Wifi: J0,
  Windows: Cn
}, Symbol.toStringTag, { value: "Module" })), tc = (e, r) => /* @__PURE__ */ t(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ t(
    ae,
    {
      ...
      variant: "ai",
      ref: r,
      iconRotate: e.icon == rc
    }
  );
});
Ht.displayName = "AIButton";
const s6 = ["xs", "sm", "md", "lg"], a6 = [
  "inProgress",
  "executing",
  "writing",
  "completed"
  ...
  return g === "recording" ? /* @__PURE__ */ i("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    ...
    /* @__PURE__ */ i("div", { className: "flex min-w-0 items-center gap-2", children: [
      e && /* @__PURE__ */ i(Re, { children: [
        /* @__PURE__ */ t(
          ae,
          {
            label: m.ai.attachFile,
            hideLabel: !0,
            type: "button",
            icon: ct,
            variant: "outline",
            ...
            onClick: (F) => {
              F.preventDefault(), a.current?.click();
            }
          }
        ),
        /* @__PURE__ */ t(
    ...
    /* @__PURE__ */ i("div", { className: "flex shrink-0 items-center gap-2", children: [
      f && /* @__PURE__ */ t(
        ae,
        {
          ...
          disabled: d,
          onClick: C,
          loading: g === "transcribing"
        }
      ),
      g !== "transcribing" && d ? /* @__PURE__ */ t(
        ae,
        {
          type: "submit",
          variant: "neutral",
  ...
  "div",
  {
    ...
    children: e.map(
      (s) => s.status === "uploading" ? /* @__PURE__ */ t(de, { className: "h-9 w-36 rounded-[10px]" }, s.id) : s.status === "error" ? /* @__PURE__ */ t(
        ac,
        {
          att: s,
          onRemove: o,
...
function ac({
  ...
  const n = /* @__PURE__ */ i("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ t(ie, { icon: K1, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ t(
      "button",
      {
        ...
        onClick: () => r(e.id),
        children: /* @__PURE__ */ t(ie, { icon: Fe, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ t(pn, { label: e.errorMessage, children: n }) : n;
}
const ic = {
  soft: {
    text: "",
...
function lc({
  ...
  const l = I(null), d = I(null);
  W(() => {
    d.current?.scrollIntoView({ block: "nearest" });
  }, [n]), X1(() => {
    const f = l.current, g = f?.offsetParent;
    if (!f || !g) return;
    const p = f.offsetLeft + f.offsetWidth - g.clientWidth;
    p > 0 && (f.style.left = `${Math.max(0, f.offsetLeft - p)}px`);
  }, [s]);
  ...
  return !e || u ? null : /* @__PURE__ */ t(
    "div",
    {
      ...
      children: c ? Array.from({ length: 3 }, (f, g) => /* @__PURE__ */ i(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ t(
              de,
              {
                className: L("h-4 rounded", g === 1 ? "w-24" : "w-32")
              }
            )
          ]
        },
        ...
        const p = g === n, C = `${f.firstName} ${f.lastName}`.trim();
        return /* @__PURE__ */ i(
          "div",
          {
            ref: p ? d : void 0,
...
const dc = ({
  ...
  return /* @__PURE__ */ t("div", { className: "p-1", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ t(ie, { icon: Ye, size: "md", color: "default" }) }),
        /* @__PURE__ */ t(
          se,
          {
  ...
  const s = ke(), [a, l] = A(""), [d, c] = A(0), [u, f] = A(!1), g = I(null), p = I(null), C = I(null), v = e[d] ?? r;
  return W(() => {
    const k = () => {
      p.current && (clearInterval(p.current), p.current = null), C.current && (clearInterval(C.current), C.current = null), g.current && (clearTimeout(g.current), g.current = null);
    };
    if (o.length > 0 || n) {
      f(!1), l(""), k();
      return;
    ...
    if (s)
      return f(!1), l(v), k(), g.current = setTimeout(() => {
        const M = (d + 1) % Math.max(e.length, 1);
        c(M);
      }, 4e3), () => {
        k();
      };
    f(!0), l("");
    let m = 0;
    const F = 50, P = 30, H = 2e3, S = 1e3;
    return p.current = setInterval(() => {
      m < v.length ? (l(v.slice(0, m + 1)), m++) : (p.current && (clearInterval(p.current), p.current = null), g.current = setTimeout(() => {
        C.current = setInterval(() => {
          m > 0 ? (m--, l(v.slice(0, m))) : (C.current && (clearInterval(C.current), C.current = null), g.current = setTimeout(() => {
            const M = (d + 1) % Math.max(e.length, 1);
            c(M);
          }, S));
        }, P);
...
`) ? o + "_" : o
        ...
        "div",
        {
          ...
          children: d.map(
            (C, v) => C.type === "mention" ? /* @__PURE__ */ t(
              ...
              v
            ) : C.type === "ghost" ? /* @__PURE__ */ t("span", { className: "text-f1-foreground-secondary opacity-50", children: C.text }, v) : /* @__PURE__ */ t("span", { children: C.text }, v)
          )
        }
      ),
      !o && !u && /* @__PURE__ */ t(
      ...
      /* @__PURE__ */ t(
        "textarea",
        {
          ...
          value: o,
          onChange: (C) => {
            n(C.target.value, C.target.selectionStart ?? 0);
          },
          onKeyDown: s,
          onKeyUp: a,
          onClick: a,
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, hc).map((r) => /* @__PURE__ */ t(
  gt,
  {
...
const vc = ({
  ...
  const [s, a] = A(null), l = s !== null ? e[s] : null;
  return e.length === 0 ? null : /* @__PURE__ */ i(
    Je,
    {
      ...
      children: [
        /* @__PURE__ */ t(mn, { asChild: !0, children: /* @__PURE__ */ t("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, c) => /* @__PURE__ */ t(e1, { asChild: !0, children: /* @__PURE__ */ t(
          ae,
          {
            variant: "outline",
            label: d.label,
        ...
        l && /* @__PURE__ */ i(
          t1,
          {
            ...
            children: [
              /* @__PURE__ */ i("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ t(ie, { icon: l.icon, size: "sm" }),
                /* @__PURE__ */ t("span", { children: l.label })
              ] }),
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: pc(l.items).map((d, c) => /* @__PURE__ */ i(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ t(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ t(ie, { icon: qe, size: "sm" })
                      }
                    )
                  ]
                },
...
function mc(e, r, o) {
  ...
  for (const f of r) {
    ...
    let p = 0;
    for (; ; ) {
      const C = e.indexOf(g, p);
      if (C === -1) break;
      a.push({ start: C, end: C + g.length }), p = C + g.length;
    }
  }
  a.sort((f, g) => f.start - g.start);
  const l = [];
  let d = 0, c = !1;
  const u = (f) => {
    if (!s || c || n < d || n > f) {
...
function kc(e, r) {
  ...
  return o.length === 0 ? e : e.filter(
    (n) => o.some((s) => wc(n.type, s))
  );
}
const Lc = 4e3;
function xc(e) {
  const [r, o] = A([]), [n, s] = A(null), a = I(
    null
  ), l = I(null), d = z(), c = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, g = X(() => {
    if (u)
      return Array.isArray(u) ? u.join(",") : u;
  }, [u]), p = f !== void 0 && r.length >= f, C = I(0);
  W(() => {
    C.current = r.length;
  }, [r]);
  const v = Z((H) => {
  ...
  const k = Z(
    async (H) => {
      ...
      if (f !== void 0 && C.current + S.length > f) {
        v(
      ...
      const N = (x) => o(
        ($) => $.map(
          (E) => w.includes(E.id) ? { ...E, status: "error", errorMessage: x } : E
        )
      );
      try {
        const x = await c(S);
        if (!Array.isArray(x) || x.length !== S.length) {
          N(d.ai.fileUploadError);
          return;
        }
        o(
          ($) => $.map((E) => {
            const V = M.findIndex((B) => B.id === E.id);
            return V === -1 ? E : x[V] ? {
              ...E,
              status: "uploaded",
              uploadedFile: x[V]
        ...
        const $ = x instanceof Error && x.message ? x.message : d.ai.fileUploadError;
        N($);
      }
    },
    [
    ...
    async (H) => {
      await k(Array.from(H.target.files ?? [])), H.target.value = "";
    },
    [k]
  ), F = Z((H) => {
    o((S) => S.filter((M) => M.id !== H));
  }, []), P = Z(() => {
    o([]);
  }, []);
  return {
...
function Rc({
  ...
  const [a, l] = A(!1), [d, c] = A(""), [u, f] = A([]), [g, p] = A(!1), [C, v] = A(0), [k, m] = A([]), F = I(-1), P = I(null), H = I(0), S = I(-1);
  W(() => {
    if (!n) {
      l(!1);
      return;
    ...
    const V = bc(e, o, k);
    if (!V) {
      l(!1), c(""), f([]), v(0), F.current = -1, S.current = -1;
      return;
    }
    if (V.atIndex === S.current)
      return;
    F.current = V.atIndex, c(V.query), l(!0), v(0), p(!0), P.current && clearTimeout(P.current);
    const B = ++H.current;
    return P.current = setTimeout(() => {
      n(V.query).then((O) => {
        B === H.current && (f(O), v(0), O.length === 0 && V.query.length > 0 && (S.current = V.atIndex, l(!1)));
      }).catch(() => {
        B === H.current && f([]);
      }).finally(() => {
        B === H.current && p(!1);
  ...
  const M = Z(() => {
    l(!1), c(""), f([]), v(0), F.current = -1;
  }, []), w = Z(
    (V) => {
      const B = F.current;
      if (B === -1) return;
      const O = `${V.firstName} ${V.lastName}`.trim(), U = String(V.id), G = e.slice(0, B), te = e.slice(o), oe = `@${O} `, Y = G + oe + te, J = G.length + oe.length;
      r(Y), m((j) => [...j.filter((ee) => !(ee.id === U && ee.name === O)), { id: U, name: O }]), M(), requestAnimationFrame(() => {
        const j = s.current;
        j && (j.focus(), j.setSelectionRange(J, J));
      });
    },
    [e, o, r, s, M]
  ), N = Z(
    (V) => {
      if (!a) return !1;
      if (V.key === "Escape")
        return V.preventDefault(), M(), !0;
      if (u.length === 0) return !1;
      switch (V.key) {
        case "ArrowDown":
          return V.preventDefault(), v((B) => (B + 1) % u.length), !0;
        case "ArrowUp":
          return V.preventDefault(), v(
            (B) => (B + u.length - 1) % u.length
          ), !0;
        case "Tab": {
          const B = u[C];
          if (B) {
            const O = `${B.firstName} ${B.lastName}`.trim();
            if (d.length === 0 || O.toLowerCase().startsWith(d.toLowerCase()))
              return V.preventDefault(), w(B), !0;
          }
          return !1;
        }
        case "Enter":
          return V.preventDefault(), u[C] && w(u[C]), !0;
        default:
          return !1;
      }
    },
    ...
    (V) => {
      ...
      let B = V;
      const O = [...k].sort((U, G) => G.name.length - U.name.length);
      for (const U of O) {
        const G = `@${U.name}`, te = `<entity-ref type="person" id="${k1(U.id)}">${k1(U.name)}</entity-ref>`;
        for (; B.includes(G); )
          B = B.replace(G, te);
      }
      return B;
  ...
  W(() => {
    m(
      (V) => V.filter((B) => {
        const O = `@${B.name}`, U = e.indexOf(O);
        if (U === -1) return !1;
        const G = e[U + O.length];
        return G === " " || G === `
` || G === "	";
      })
    );
  ...
  const $ = X(() => {
    if (!a || F.current === -1) return null;
    const V = s.current;
    if (!V) return null;
    const B = Mc(V, F.current), O = V.offsetLeft + B.left, G = (V.offsetParent ? V.offsetParent.offsetHeight : 0) - (V.offsetTop + B.top);
    return { left: O, bottom: G };
  }, [a, e, o, s]), E = X(() => {
    if (!a || u.length === 0) return null;
    const V = u[C];
    if (!V) return null;
    const B = `${V.firstName} ${V.lastName}`.trim();
...
const Fc = /[\\`*_{}[\]()#+\-.!|~>]/g, Nc = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(Fc, "\\$&")).join(""), i6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const x = z(), $ = ke(), [E, V] = A(""), [B, O] = A(0), [U, G] = A(!1), [te, oe] = A(!1), [Y, J] = A(null), j = I(null), K = I(null), ee = I(null), ue = l != null, { tracking: ge } = ye(), ve = Z(
    (q, we) => {
      ge?.onWelcomeSuggestionClick?.({
        item: q,
        group: we,
    ...
    const we = Ae.current, _e = we && !/\s$/.test(we) ? " " : "", Ie = `${we}${_e}${q}`;
    V(Ie), O(Ie.length);
  }, []), sr = {
    "permission-denied": x.ai.micPermissionDenied,
    "device-error": x.ai.micError,
    "transcription-failed": x.ai.transcriptionError
  }, xe = wn({
    onTranscribe: C,
    onPartial: $e,
    onFinal: (q) => {
    ...
    onError: (q) => me(sr[q])
  }), ar = !!C && xe.isSupported, ir = Z(() => {
    ge?.onDictationStart?.(), Ae.current = E, xe.start();
  }, [E, xe, ge]), cr = Z(() => {
    ge?.onDictationCancel?.(), xe.cancel();
  }, [xe, ge]);
  W(() => {
    typeof window < "u" && window.location.hash.length === 0 && K.current?.focus();
  }, []), W(() => {
    if (k)
      return k((q) => {
        D(q);
  ...
  const a1 = xe.status === "recording", lr = a1 ? x.ai.listening : x.ai.inputPlaceholder, i1 = re.filter((q) => q.status === "uploaded"), Be = re.some((q) => q.status === "uploading"), c1 = re.some((q) => q.status === "error"), l1 = E.trim().length > 0 || i1.length > 0;
  W(() => {
    if (!(!te || Be)) {
      if (oe(!1), c1) {
        me(x.ai.fileUploadBlockedSubmit);
        return;
      }
    ...
    c1,
    me,
    x.ai.fileUploadBlockedSubmit
  ]);
  const dr = async (q) => {
    if (q.preventDefault(), !ue) {
      if (ne.close(), o)
        r?.();
      else if (l1 && !U) {
        if (Be) {
        ...
        const we = ne.transformMentions(E.trim()), _e = Nc(we), Ie = i1.flatMap(
          (p1) => p1.uploadedFile ? [p1.uploadedFile] : []
        ), C1 = d, g1 = u;
        C1 && c?.(null), g1 && f?.(null), await e({
          text: _e,
          files: Ie,
          context: C1,
          quote: g1
    ...
    ue || ne.handleKeyDown(q) || q.key === "Enter" && !q.shiftKey && (q.preventDefault(), o || j.current?.requestSubmit());
  }, ur = () => {
    O(K.current?.selectionStart ?? 0);
  }, hr = () => {
    ee.current && K.current && (ee.current.scrollTop = K.current.scrollTop);
  }, d1 = Y ? Y.prompt ?? Y.title : null, f1 = a1 ? [x.ai.listening] : d1 ? [d1] : s ?? [], Cr = f1.length > 1, gr = X(() => mc(E, ne.mentions, {
    cursorPosition: B,
    inlineCompletion: ne.inlineCompletion
  }), [E, ne.mentions, B, ne.inlineCompletion]), pr = ne.mentions.length > 0 || ne.inlineCompletion !== null, u1 = P && !!S && S.length > 0 && !!M ? /* @__PURE__ */ t(
    vc,
    {
      suggestions: S,
      onItemClick: ve,
  ...
  ) : null, vr = P && H && !!w && w.length > 0, h1 = H && P, { motionProps: mr } = kn(
    P,
    160,
    0.5
  );
  return /* @__PURE__ */ i(
    Q.div,
    {
      ...
      className: L(
        ...
        h1 && "min-h-0 flex-1 justify-start -mt-20"
      ),
      ...H ? mr : {},
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          u1 && /* @__PURE__ */ t("div", { children: u1 }),
          /* @__PURE__ */ t(cc, { creditWarning: a, children: /* @__PURE__ */ i(
            Q.form,
            {
              "aria-busy": o,
              ref: j,
              ...
              children: [
                /* @__PURE__ */ t(
                  lc,
                  {
                    ...
                    selectedIndex: ne.selectedIndex,
                    position: ne.popoverPosition,
                    onSelect: ne.selectPerson
                  }
                ),
                /* @__PURE__ */ t(Ee, { initial: !1, children: ue ? /* @__PURE__ */ t(
                  Q.div,
                  {
                  ...
                  Q.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ t(Ee, { initial: !1, children: he && /* @__PURE__ */ t(
                        Q.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ i(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ t("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ t(Ln, { type: "critical", size: "sm" }) }),
                                /* @__PURE__ */ t("p", { className: "font-medium text-f1-foreground-critical", children: he })
                              ]
                            }
                          )
                        },
                      ...
                      /* @__PURE__ */ t(
                        uc,
                        {
                          ...
                          onCursorUpdate: ur,
                          onScroll: hr,
                          highlightSegments: gr,
                          hasOverlay: pr,
                          multiplePlaceholders: Cr,
                          placeholders: f1,
                          resolvedDefaultPlaceholder: lr,
                          inProgress: o
                        }
                      ),
                      /* @__PURE__ */ t(
                        nc,
                        {
                          ...
                          isPreSending: U || te,
                          canRecord: ar,
                          recordingStatus: xe.status,
                          recordingStream: xe.stream,
                          onStartRecording: ir,
                          onStopRecording: xe.stop,
                          onCancelRecording: cr
                        }
                      )
                    ]
                  },
        ...
        vr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(Cc, { cards: w }) }),
        F && P && H && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: F }),
        /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: ue ? /* @__PURE__ */ i(
          Q.div,
          {
            ...
            children: [
              /* @__PURE__ */ i("span", { children: [
                ...
                " ",
                x.ai.clarifyingQuestion.navHint.navigate
              ] }),
              /* @__PURE__ */ i("span", { children: [
                /* @__PURE__ */ t("kbd", { className: "font-sans", children: "Enter" }),
                " ",
                x.ai.clarifyingQuestion.navHint.select
              ] }),
              /* @__PURE__ */ i("span", { children: [
                /* @__PURE__ */ t("kbd", { className: "font-sans", children: "Esc" }),
                " ",
                x.ai.clarifyingQuestion.navHint.cancel
              ] })
            ]
          },
          "clarifying-nav-hint"
        ) : m?.text && !h1 && /* @__PURE__ */ i(
          Q.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ t(se, { className: "text-sm font-medium text-f1-foreground-tertiary", children: m.text }),
...
function $c({
  ...
  return /* @__PURE__ */ t(bn, { ...r, variant: "link", href: r.href, children: e });
}
function Bc({
  children: e,
  ...r
...
function Ne({
  ...
  const a = I(/* @__PURE__ */ new Map()), [l, d] = A(
    () => a.current.get(e) ?? null
  ), [c, u] = A(!1), [f, g] = A(!1), p = I(!0);
  W(() => () => {
    p.current = !1;
  }, []);
  const C = Z(() => {
    if (l || c) return;
    const k = a.current.get(e);
    if (k) {
      d(k);
      return;
    }
    u(!0), g(!1), o(e).then((m) => {
      a.current.set(e, m), p.current && d(m);
    }).catch(() => {
      p.current && g(!0);
    }).finally(() => {
      p.current && u(!1);
  ...
  return /* @__PURE__ */ i(
    yn,
    {
      ...
      children: [
        /* @__PURE__ */ t(Mn, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          En,
          {
            side: "top",
            ...
            children: c ? /* @__PURE__ */ t(v1.Skeleton, {}) : /* @__PURE__ */ t(v1, { ...v })
          }
        )
      ]
    }
...
At.displayName = "CandidateTrigger";
function Xc({
  id: e,
  label: r
}) {
  const { entityRefs: o } = ye(), n = o?.resolvers?.candidate, s = z(), a = o?.urls?.candidate?.(e), l = X(
    () => (c) => {
      const u = [];
      return c.source && u.push({
        ...
        ...u.length > 0 && {
          children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-2", children: u.map((f) => /* @__PURE__ */ i("div", { className: "flex flex-col", children: [
...
$t.displayName = "ExpenseTrigger";
function Yc({ id: e, label: r }) {
  const { entityRefs: o } = ye(), n = o?.resolvers?.expense, s = z(), a = o?.urls?.expense?.(e), l = X(
    () => (c) => ({
      avatar: {
        type: "icon",
        icon: Rt
...
Bt.displayName = "JobPostingTrigger";
function Kc({
  id: e,
  label: r
}) {
  const { entityRefs: o } = ye(), n = o?.resolvers?.jobPosting, s = z(), a = o?.urls?.jobPosting?.(e), l = X(
    () => (c) => ({
      title: c.title,
...
It.displayName = "RequisitionTrigger";
function Jc({
  id: e,
  label: r
}) {
  const { entityRefs: o } = ye(), n = o?.resolvers?.requisition, s = z(), a = o?.urls?.requisition?.(e), l = X(
    () => (c) => {
      const u = c.lineManager ? `${c.lineManager.firstName} ${c.lineManager.lastName}` : void 0, g = [
        c.status ? {
...
Pt.displayName = "PersonTrigger";
function e2({ id: e, label: r }) {
  const { entityRefs: o } = ye(), n = o?.resolvers?.person, s = z(), a = o?.urls?.person?.(e), l = X(
    () => (c) => ({
      avatar: {
        type: "person",
        firstName: c.firstName,
...
Dt.displayName = "VacancyTrigger";
function t2({ id: e, label: r }) {
  const { entityRefs: o } = ye(), n = o?.resolvers?.vacancy, s = z(), a = o?.urls?.vacancy?.(e), l = X(
    () => (c) => ({
      title: c.name,
...
function Ge(e) {
  return typeof e == "string" ? e : typeof e == "number" ? String(e) : Array.isArray(e) ? e.map(Ge).join("") : e && typeof e == "object" && "props" in e ? Ge(e.props.children) : "";
}
function n2({
  type: e,
  id: r,
...
function jt({
  ...
  const l = z(), d = s.type === "open", c = d ? n ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ i(
    "div",
    {
      className: L(
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ t(vt, { module: e.module, size: "md" }),
          e?.type === "file" && /* @__PURE__ */ t(Fn, { file: e.file, size: "lg" }),
          /* @__PURE__ */ i("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            ...
            o && /* @__PURE__ */ t(se, { className: "text-base text-f1-foreground-secondary", children: o })
          ] }),
...
jt.displayName = "F0CanvasCard";
const s1 = je(null);
function l6({
  children: e
}) {
  const [r, o] = A(0), n = I([]), s = Z(
    (l) => {
  ...
  return /* @__PURE__ */ t(s1.Provider, { value: a, children: e });
}
function s2(e) {
  const o = Te(s1)?.formatters;
  return X(() => !o || o.length === 0 ? null : (n, s, a) => {
    let l, d = -1;
    for (const c of o) {
      const u = c.formName === void 0 || c.formName === e, f = c.customFieldName === void 0 || c.customFieldName === a.customFieldName;
      if (!u || !f) continue;
      let g = 0;
      c.formName !== void 0 && (g += 2), c.customFieldName !== void 0 && (g += 1), g > d && (d = g, l = c);
    }
    if (l)
      return l.format(s, { key: n, ...a });
  }, [o, e]);
}
function d6() {
  const e = Te(s1);
...
const L1 = 7, a2 = 625, x1 = /* @__PURE__ */ new Set();
function i2(e) {
...
function l2(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = Vn(e), a = [];
...
function Zt(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: l2(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? i2(o) : "") || "—" };
  }
  if (r === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: o, to: n } = e, s = b1(o) ? y1(o) : String(o), a = b1(n) ? y1(n) : String(n);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((n) => {
      const s = Zt(n);
      return Array.isArray(s) ? s.map(M1).join(", ") : M1(s);
    }).filter(Boolean).join(", ") || "—" };
  ...
  return { type: "item", text: c2(String(e)) };
}
function _t({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = ye(), g = s2(e), p = d ?? g, C = I(() => {
  }), v = n ?? e, k = s ?? r ?? "", m = c?.type === "form" && c.formName === e, F = () => u({
    type: "form",
    title: v,
    description: k,
    formName: e,
  ...
  C.current = F, W(() => {
    typeof window > "u" || window.innerWidth < a2 || x1.has(e) || (x1.add(e), C.current());
  }, [e]);
  const P = a && l ? Object.entries(a).map(([M, w]) => {
    const N = l[M], x = p?.(M, N, {
      fieldType: w.fieldType,
      customFieldName: w.customFieldName
    });
    if (!x && w.fieldType === "custom" && typeof N == "object" && N !== null)
      return null;
    const $ = x ?? Zt(N, w.fieldType), E = ["richtext", "textarea"];
    return {
      label: w.label,
      content: $,
      verticalLayout: E.includes(w.fieldType ?? "")
    };
  }).filter((M) => {
    if (!M) return !1;
    const w = Array.isArray(M.content) ? M.content[0] : M.content;
    return !(w?.type === "item" && w.text === "—");
  }) : [], H = P.slice(0, L1), S = P.length > L1;
  return /* @__PURE__ */ t(
    jt,
    {
      ...
      children: H.length > 0 && !m && /* @__PURE__ */ t("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ t(
        Nn,
        {
          details: H.map((M) => ({
            title: M.label,
            content: M.content,
            ...M.verticalLayout && { verticalLayout: !0 }
          })),
          showSeeMore: S,
          onClickSeeMore: F,
          tableView: !0
...
_t.displayName = "FormCard";
function d2() {
  const e = Sn(), r = e?.activeForm;
  if (!r) return null;
...
const E1 = 8, Ve = 8;
function Ot({ anchor: e, onReply: r }) {
  const o = z(), n = I(null), [s, a] = A(
    null
  );
  if (X1(() => {
    if (!e) {
    ...
    const d = n.current;
    if (!d) return;
    const c = d.offsetWidth, u = d.offsetHeight, f = window.innerWidth, g = window.innerHeight;
    let p = e.rect.top - u - E1;
    p < Ve && (p = e.rect.bottom + E1), p = Math.min(
      Math.max(p, Ve),
      g - u - Ve
    );
    const C = e.rect.left + e.rect.width / 2 - c / 2, v = Math.min(
      Math.max(C, Ve),
      f - c - Ve
    );
    a({ top: p, left: v });
...
const zt = je(void 0), f6 = () => Te(zt), h2 = (e) => /* @__PURE__ */ t(mt, { content: e, format: "markdown" }), C2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, g = I(null), { anchor: p, clear: C } = Ut({
    containerRef: g,
    enabled: !!(o?.id && d)
  });
  return W(() => {
    o?.id && !r && !e && a?.(o);
  }, [o, r, e, a]), !r && !e && f ? null : /* @__PURE__ */ t(zt.Provider, { value: u, children: /* @__PURE__ */ i("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ t(
      "div",
      {
        ref: g,
    ...
    /* @__PURE__ */ t(
      Ot,
      {
        anchor: p,
        onReply: (v) => {
          s?.(v), C(), window.getSelection()?.removeAllRanges();
        }
      }
    )
  ] }) });
  ...
  const [s, a] = A(""), l = z(), { title: d, label: c, placeholder: u } = o === "like" ? l.ai.feedbackModal.positive : l.ai.feedbackModal.negative, f = Z(() => {
    r(n, s);
  }, [s, n, r]), g = () => {
    e(n);
  };
  return W(() => {
    const p = (C) => {
      C.key === "Enter" && (C.preventDefault(), f());
    };
...
}, Gt = je(null), p2 = ({ children: e }) => {
  const [r, o] = A(null), n = r ? {
    isOpen: !0,
  ...
  return /* @__PURE__ */ t(Gt.Provider, { value: n, children: e });
}, Wt = () => {
  const e = Te(Gt);
  if (e === null)
    throw new Error(
...
const m2 = ({
  ...
  const n = z(), { open: s } = Wt(), [a, l] = A(null);
  ...
  const [d, c] = A(s), u = ke(), f = n !== void 0, g = f ? n : d;
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      children: [
        /* @__PURE__ */ i(
          kt,
          {
            ...
            children: [
              /* @__PURE__ */ t("span", { className: "flex items-center justify-start h-6 w-6", children: /* @__PURE__ */ t(ie, { icon: e, className: "block" }) }),
              /* @__PURE__ */ t("div", { className: "min-h-6 flex items-center", children: /* @__PURE__ */ t("span", { children: r }) }),
              !l && /* @__PURE__ */ t(ie, { icon: Ze })
            ]
          }
        ),
        /* @__PURE__ */ t(Lt, { forceMount: !0, className: "data-[state=open]:mt-3", children: /* @__PURE__ */ t(
          Q.div,
          {
            initial: !1,
            animate: {
  ...
  const s = z(), [a, l] = A(!!o), d = I(o);
  W(() => {
    d.current && !o ? l(!1) : o && !a && l(!0), d.current = o;
  }, [o, a]);
  const c = o ? s.ai.thoughtsGroupTitle : r ?? s.ai.thoughtsGroupTitle, u = e.length - 1, f = (g) => !o || n ? "completed" : g === u ? "executing" : "completed";
  return /* @__PURE__ */ t(
    w2,
    {
      icon: Et,
      ...
      onOpenChange: l,
      lockOpen: o,
      children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pb-4", children: e.map((g, p) => /* @__PURE__ */ i("div", { className: "relative", children: [
        /* @__PURE__ */ t(
          ze,
          {
            title: g,
...
const qt = (e) => /* @__PURE__ */ t(mt, { content: e, format: "markdown" }), b2 = ({
  text: e,
  renderMarkdown: r
}) => /* @__PURE__ */ i("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ t("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ t(ie, { icon: Ye }) }),
  /* @__PURE__ */ t("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (r ?? qt)(e) })
] }), y2 = ({
  message: e,
  onReplyQuote: r,
  ...
  const l = e.rawData, d = x2(
    e?.content,
    l
  ), c = (L2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: g, clear: p } = Ut({
    containerRef: a,
    enabled: f
  });
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(b2, { text: u, renderMarkdown: n }),
        d.length > 0 && /* @__PURE__ */ t("div", { className: "flex max-w-[90%] flex-wrap justify-end gap-1.5", children: d.map((C, v) => /* @__PURE__ */ t(
          Ct,
          {
        ...
        /* @__PURE__ */ t(
          Ot,
          {
            anchor: g,
            onReply: (C) => {
              r?.(C), p(), window.getSelection()?.removeAllRanges();
            }
          }
        )
      ]
...
}, M2 = 35, E2 = 22, R2 = 400, F2 = 2500, N2 = 220, V2 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  const [n, s] = A(0), [a, l] = A(0), [d, c] = A("starting"), u = e[n] ?? "";
  W(() => {
    e.length > 0 && n >= e.length && (s(0), l(0), c("starting"));
  }, [e.length, n]), W(() => {
    let p;
    if (d === "starting")
      p = setTimeout(() => c("writing"), R2);
    else if (d === "writing")
      a < u.length ? p = setTimeout(() => l((C) => C + 1), M2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), F2);
    } else d === "erasing" && (a > 0 ? p = setTimeout(() => l((C) => C - 1), E2) : p = setTimeout(() => {
      s((C) => (C + 1) % e.length), c("starting");
    }, N2));
    return () => {
      p && clearTimeout(p);
    };
  }, [d, a, u.length, e.length]);
  const f = !!r, g = f ? (p) => {
...
function S2({
  ...
  const [l, d] = A(0), [c, u] = A(!1), f = I(s), g = I(a);
  g.current = a;
  const p = Z(
    (v = "smooth") => {
      o.current?.scrollIntoView({ behavior: v });
    },
    [o]
  );
  W(() => {
    const v = e.current, k = r.current;
    if (!v || !k) return;
    const m = new ResizeObserver(() => {
      if (g.current) return;
      const F = parseFloat(getComputedStyle(k).paddingTop) + parseFloat(getComputedStyle(k).paddingBottom) + 1;
      d(v.clientHeight - F);
    });
    return m.observe(v), m.observe(k), () => m.disconnect();
  }, [e, r]);
  const C = Z(() => {
    const v = e.current;
    if (!v) return;
    const { scrollTop: k, scrollHeight: m, clientHeight: F } = v, P = m - k - F;
    u(P > F);
  }, [e]);
  return W(() => {
    const v = e.current;
    if (v)
      return v.addEventListener("scroll", C, { passive: !0 }), () => v.removeEventListener("scroll", C);
  }, [C, e]), W(() => {
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const v = e.current, k = n.current;
        if (!v || !k) return;
        const m = v.getBoundingClientRect(), F = k.getBoundingClientRect(), P = v.scrollTop + (F.top - m.top);
        v.scrollTo({ top: P, behavior: "smooth" });
      });
    }), s === 0 && u(!1), f.current = s;
  }, [s, n, e]), { showScrollBtn: c, turnMinHeight: l, scrollToBottom: p };
}
const T2 = {
  threadId: "",
  onThumbsUp: () => {
...
}, u6 = (e) => /* @__PURE__ */ t(p2, { children: /* @__PURE__ */ t(H2, { ...e }) }), H2 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: H, handleSubmit: S, handleClose: M } = v2(
    f ?? T2
  ), w = z(), N = k ?? C2, x = m ?? y2, $ = X(() => {
    const j = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((ee) => typeof ee == "string" && ee.length > 0);
  }, [n, w.ai.defaultInitialMessage]), E = !r && e.length === 0 && $.length > 0, V = I(null), B = I(null), O = I(null), U = I(null), G = I(null), { showScrollBtn: te, turnMinHeight: oe, scrollToBottom: Y } = S2({
    viewportRef: V,
    contentRef: B,
    endRef: O,
    lastTurnRef: G,
    ...
    const ee = K === e.length - 1, ue = {
      ...
      const Le = ee && le === j.assistantMessages.length - 1, b = j.userMessages.length + le, R = {
        message: re,
        inProgress: j.isInProgress,
        index: b,
        isCurrentMessage: Le,
      ...
      return /* @__PURE__ */ t(
        ...
        {
          ...R,
          isGenerating: j.isInProgress && Le,
          isLoading: j.isInProgress && Le && !re.content
        },
        `${K}-a-${le}`
      );
    };
    return /* @__PURE__ */ i(
      "div",
      {
        ...
        children: [
          ...
          j.endIndicator === "thinking" && /* @__PURE__ */ t(ze, { title: w.ai.thinking, status: "executing" }),
          j.endIndicator === "activity" && /* @__PURE__ */ t(ze, { status: "writing" }),
          ...
          children: /* @__PURE__ */ i(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ t("div", { ref: U, className: "h-px shrink-0", "aria-hidden": !0 }),
                /* @__PURE__ */ t("footer", { className: "copilotKitMessagesFooter", ref: O, children: v }),
...
}, A2 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ i("div", { className: "flex flex-col gap-2", children: [
...
function C6({
  ...
  return /* @__PURE__ */ t(Xt.Provider, { value: r, children: e });
}
function g6() {
  const e = Te(Xt);
  if (e === null)
...
const B2 = ({
  ...
  const p = z().ai.clarifyingQuestion.typeYourAnswer, C = e === "single" ? /* @__PURE__ */ t(Yt, { isSelected: o && !r }) : /* @__PURE__ */ t(
    xt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
      ...
      children: [
        ...
        /* @__PURE__ */ t(
          "input",
          {
            ...
            onFocus: d,
            onKeyDown: (v) => {
              v.key === "Enter" && a && (v.preventDefault(), f());
            },
            placeholder: p,
            "aria-label": p,
  ...
  ({ option: e, isSelected: r, mode: o, isTabStop: n, onToggle: s, onKeyNavigate: a }, l) => o === "single" ? /* @__PURE__ */ i(
    "div",
    {
      ref: l,
      role: "radio",
...
const P2 = ({
  ...
  const F = ke(), P = (() => {
    ...
    const N = o.findIndex((x) => n.includes(x.id));
    return N >= 0 ? N : 0;
  })(), [H, S] = A(P), M = I([]);
  W(() => {
    g && e === "single" && M.current[H]?.focus();
  }, []);
  const w = (N) => {
    if (e !== "single") return;
    const x = o.length - 1;
    ...
    N.preventDefault(), S($), M.current[$]?.focus();
  };
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      "aria-label": r,
      children: [
        o.map((N, x) => /* @__PURE__ */ t(
          Q.div,
          {
            initial: F ? !1 : { opacity: 0, y: 4 },
            animate: { opacity: 1, y: 0 },
            transition: {
              duration: F ? 0 : 0.2,
              ease: [0.4, 0, 0.2, 1],
              delay: F ? 0 : 0.12 + x * 0.06
            },
            children: /* @__PURE__ */ t(
              Kt,
              {
  ...
  } = s, N = I(null), x = P ?? "single", $ = l > 1, E = a === 0, V = a === l - 1, B = $ ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(a + 1),
    total: String(l)
  }) : void 0, O = F.length > 0, U = (M ?? "").trim().length > 0, G = O || w && U || H === !0, te = r === !0 && V, oe = () => {
    te || c();
  }, Y = () => {
    te || u();
  }, J = (ve) => {
    const re = x === "single" && F.includes(ve);
    d(ve), x === "single" && !V && !re && Promise.resolve().then(c);
  }, j = V ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, K = H === !0 && !O && !(w && U), ee = () => {
    v(), requestAnimationFrame(() => {
      N.current?.focus();
    });
  }, ue = (ve) => {
    ve.key === "Escape" && (ve.preventDefault(), f());
  }, ge = n ? 0 : Z2 / 2;
  return /* @__PURE__ */ i("div", { className: "flex flex-col", onKeyDown: ue, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ i(
      Q.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ge, ease: j2 },
        children: [
          /* @__PURE__ */ t(
            D2,
            {
...
function R1(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), a = Math.min(o, 20), d = Math.min(a + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (ee) => ee / e * 2 - 1, g = (ee) => ee / r * 2 - 1, p = 0, C = e, v = 0, k = r, m = c, F = e - c, P = u, H = r - u, S = f(p), M = f(C), w = g(v), N = g(k), x = f(m), $ = f(F), E = g(P), V = g(H), B = 0, O = 0, U = 1, G = 1, te = c / e, oe = 1 - c / e, Y = u / r, J = 1 - u / r, j = new Float32Array([
    // Top strip
    S,
    w,
    M,
...
function U2(e, r, o) {
  const n = F1(e, e.VERTEX_SHADER, r), s = F1(e, e.FRAGMENT_SHADER, o), a = e.createProgram();
  ...
  if (e.attachShader(a, n), e.attachShader(a, s), e.linkProgram(a), !e.getProgramParameter(a, e.LINK_STATUS)) {
    ...
    throw e.deleteProgram(a), e.deleteShader(n), e.deleteShader(s), new Error(l);
  }
...
class m6 {
  ...
  resize(r, o, n) {
    ...
    const { gl: s, program: a, vao: l, positionBuffer: d, uvBuffer: c, uResolution: u } = this.glr, f = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, g = Math.max(1, Math.floor(r * f)), p = Math.max(1, Math.floor(o * f));
    this.canvas.style.width = `${r}px`, this.canvas.style.height = `${o}px`, (this.canvas.width !== g || this.canvas.height !== p) && (this.canvas.width = g, this.canvas.height = p), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
    const { positions: C, uvs: v } = R1(
      this.canvas.width,
      this.canvas.height,
      this.options.borderWidth * f,
      this.options.glowWidth * f
    );
    s.bindVertexArray(l), s.bindBuffer(s.ARRAY_BUFFER, d), s.bufferData(s.ARRAY_BUFFER, C, s.STATIC_DRAW);
    const k = s.getAttribLocation(a, "aPosition");
    s.enableVertexAttribArray(k), s.vertexAttribPointer(k, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, c), s.bufferData(s.ARRAY_BUFFER, v, s.STATIC_DRAW);
    const m = s.getAttribLocation(a, "aUV");
    s.enableVertexAttribArray(m), s.vertexAttribPointer(m, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after UV buffer update"), s.useProgram(a), s.uniform2f(u, this.canvas.width, this.canvas.height), s.uniform1f(this.glr.uBorderWidth, this.options.borderWidth * f), s.uniform1f(this.glr.uGlowWidth, this.options.glowWidth * f), s.uniform1f(this.glr.uBorderRadius, this.options.borderRadius * f), this.checkGLError(s, "resize: after uniform updates");
    const F = performance.now();
    this.lastTime = F;
    const P = (F - this.startTime) * 1e-3;
    this.render(P);
  }
  /**
  ...
  setupGL() {
    ...
    const s = this.canvas.width || 2, a = this.canvas.height || 2, { positions: l, uvs: d } = R1(
      s,
      a,
    ...
    const g = r.getAttribLocation(o, "aUV");
    r.enableVertexAttribArray(g), r.vertexAttribPointer(g, 2, r.FLOAT, !1, 0, 0), this.checkGLError(r, "setupGL: after UV buffer setup");
    const p = r.getUniformLocation(o, "uResolution"), C = r.getUniformLocation(o, "uTime"), v = r.getUniformLocation(o, "uBorderWidth"), k = r.getUniformLocation(o, "uGlowWidth"), m = r.getUniformLocation(o, "uBorderRadius"), F = r.getUniformLocation(o, "uColors"), P = r.getUniformLocation(o, "uGlowExponent"), H = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(v, this.options.borderWidth), r.uniform1f(k, this.options.glowWidth), r.uniform1f(m, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(P, 2), r.uniform1f(H, 1.8)) : (r.uniform1f(P, 1), r.uniform1f(H, 1));
    const S = (this.options.colors || G2).map(W2);
    for (let M = 0; M < S.length; M++)
      r.uniform3f(
        r.getUniformLocation(o, `uColors[${M}]`),
        ...S[M]
      );
...
const N1 = ["lowp", "mediump", "highp"], q2 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, X2 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
    vec2 uv = fragCoord/iResolution.xy;
    vec3 col = 0.5 + 0.5*cos(iTime+uv.xyx+vec3(0,2,4));
    fragColor = vec4(col,1.0);
}`, V1 = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, S1 = "iTime", T1 = "iTimeDelta", H1 = "iDate", A1 = "iFrame", $1 = "iMouse", B1 = "iResolution", Y2 = "iChannel", I1 = "iChannelResolution", P1 = "iDeviceOrientation";
function K2(e, r) {
...
}, Oe = 9729, D1 = 9728, rl = 9987, j1 = 33071, Z1 = 10497;
class ol {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    Object.assign(this, { url: n, wrapS: s, wrapT: a, minFilter: l, magFilter: d, flipY: c });
    const g = 0, p = o.RGBA, C = 1, v = 1, k = 0, m = o.RGBA, F = o.UNSIGNED_BYTE, P = new Uint8Array([255, 255, 255, 0]), H = o.createTexture();
    if (o.bindTexture(o.TEXTURE_2D, H), o.texImage2D(
      ...
      return o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.LINEAR), this._webglTexture = H, this.source = N, this.isVideo = !0, N.play().then(() => this);
    }
    async function S() {
      return new Promise((N, x) => {
        ...
        $.crossOrigin = "anonymous", $.onload = () => {
          ...
          x(new Error(be(`failed loading url: ${n}`)));
        }, $.src = n ?? "";
      });
    }
    let M = await S(), w = (M.width & M.width - 1) === 0 && (M.height & M.height - 1) === 0;
    return (r.wrapS !== j1 || r.wrapT !== j1 || r.minFilter !== D1 && r.minFilter !== Oe) && !w && (M = this.makePowerOf2(M), w = !0), o.bindTexture(o.TEXTURE_2D, H), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, c), o.texImage2D(
      o.TEXTURE_2D,
      g,
      p,
      m,
      F,
      M
    ), w && r.minFilter !== D1 && r.minFilter !== Oe && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || Z1
    ), o.texParameteri(
      ...
      this.magFilter || Oe
    ), this._webglTexture = H, this.source = M, this.isVideo = !1, this.isLoaded = !0, this.width = M.width || 0, this.height = M.height || 0, this;
  };
}
const be = (e) => `react-shaders: ${e}`, _1 = (e) => {
  if ("changedTouches" in e) {
    const r = e.changedTouches[0];
    return [r?.clientX ?? 0, r?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, U1 = (e, r, o) => e * (1 - o) + r * o, nl = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function sl({
  fs: e,
  vs: r = V1,
  textures: o = [],
  ...
  const C = I(null), v = I(null), k = I(null), m = I(null), F = I(void 0), P = I(void 0), H = I(!1), S = I(void 0), M = I(0), w = I([0, 0]), N = I([]), x = I(0), $ = I(void 0), E = I({
    [S1]: { type: "float", isNeeded: !1, value: 0 },
    [T1]: { type: "float", isNeeded: !1, value: 0 },
    [H1]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [$1]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [B1]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    [A1]: { type: "int", isNeeded: !1, value: 0 },
    [P1]: {
      type: "vec4",
      isNeeded: !1,
      value: [0, 0, 0, 0]
    ...
    const y = "width" in b ? b.width ?? 0 : 0, D = "height" in b ? b.height ?? 0 : 0, T = E.current.iChannelResolution;
    if (!T) return;
    const _ = Array.isArray(T.value) ? T.value : T.value = [];
    _[R * 3] = y * u, _[R * 3 + 1] = D * u, _[R * 3 + 2] = 0;
  }, O = () => {
    C.current && (v.current = C.current.getContext("webgl", d) || C.current.getContext(
      "experimental-webgl",
      d
    ), v.current?.getExtension("OES_standard_derivatives"), v.current?.getExtension("EXT_shader_texture_lod"));
  }, U = () => {
    const b = v.current;
    k.current = b?.createBuffer() ?? null, b?.bindBuffer(b.ARRAY_BUFFER, k.current);
    const R = [
      1,
      1,
      0,
    ...
    const [R = 0, y = 0] = _1(b), D = R - (S.current?.left ?? 0) - window.pageXOffset, T = (S.current?.height ?? 0) - y - (S.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    const _ = Array.isArray(E.current.iMouse?.value) ? E.current.iMouse.value : void 0;
    _ && (_[2] = D, _[3] = T), w.current[0] = D, w.current[1] = T;
  }, oe = (b) => {
    S.current = C.current?.getBoundingClientRect();
    const [R = 0, y = 0] = _1(b), D = R - (S.current?.left ?? 0), T = (S.current?.height ?? 0) - y - (S.current?.top ?? 0);
    if (c !== 1)
    ...
    const b = Array.isArray(E.current.iMouse?.value) ? E.current.iMouse.value : void 0;
    b && (b[2] = 0, b[3] = 0);
  }, J = () => {
    const b = v.current;
    if (!b) return;
    ...
    if (b.canvas.width = y, b.canvas.height = D, E.current.iResolution?.isNeeded && m.current) {
    ...
    if (y.shaderSource(D, R), y.compileShader(D), !y.getShaderParameter(D, y.COMPILE_STATUS)) {
      p?.(be(`Error compiling the shader:
${R}`));
      const T = y.getShaderInfoLog(D);
      y.deleteShader(D), g?.(be(`Shader compiler log: ${T}`));
    }
    return D;
  }, K = (b, R) => {
    const y = v.current;
    if (!y) return;
    const D = j(y.FRAGMENT_SHADER, b), T = j(y.VERTEX_SHADER, R);
    if (m.current = y.createProgram(), !(!m.current || !T || !D)) {
      if (y.attachShader(m.current, T), y.attachShader(m.current, D), y.linkProgram(m.current), !y.getProgramParameter(m.current, y.LINK_STATUS)) {
        g?.(
          be(
      ...
      y.useProgram(m.current), F.current = y.getAttribLocation(
        m.current,
        "aVertexPosition"
      ), y.enableVertexAttribArray(F.current);
    }
  }, ee = () => {
    if (n)
      for (const b of Object.keys(n)) {
        const R = n[b];
        if (!R) continue;
        const { value: y, type: D } = R, T = tl(D);
        if (!T) continue;
        const _ = {};
        if (K2(D, y)) {
          const ce = D.length, he = Number.parseInt(D.charAt(ce - 3)), me = Math.floor(y.length / (he * he));
          y.length > he * he && (_.arraySize = `[${me}]`);
        } else Q2(D, y) && (_.arraySize = `[${Math.floor(y.length / Number.parseInt(D.charAt(0)))}]`);
        E.current[b] = {
          type: T,
          isNeeded: !1,
          value: y,
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (y, D) => (E.current[`${Y2}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(y, D), N.current[D] = new ol(b), N.current[D]?.load(y).then((T) => {
            B(T, D);
          }))
        );
        Promise.all(R).then(() => {
    ...
    const R = N1.includes(a ?? "highp"), y = `precision ${R ? a : N1[1]} float;
`;
    R || p?.(
      be(
...
`).concat(b.replace(/texture\(/g, "texture2D("));
    for (const _ of Object.keys(E.current))
      if (b.includes(_)) {
        const ce = E.current[_];
        if (!ce) continue;
        D = nl(
          D,
...
`,
    ...
    return b.includes("mainImage") && (D = D.concat(q2)), D;
  }, ve = (b) => {
    const R = v.current;
    if (!R || !m.current) return;
    const y = x.current ? (b - x.current) / 1e3 : 0;
    x.current = b;
    const D = V.current;
    if (D)
      for (const T of Object.keys(D)) {
        const _ = D[T];
        if (_ && E.current[T]?.isNeeded) {
          if (!m.current) return;
          const ce = R.getUniformLocation(
            m.current,
            T
          );
          if (!ce) return;
    ...
    if (E.current.iMouse?.isNeeded) {
      ...
      R.uniform4fv(T, E.current.iMouse.value);
    }
    ...
    if (E.current.iDate?.isNeeded) {
      const T = /* @__PURE__ */ new Date(), _ = T.getMonth() + 1, ce = T.getDate(), he = T.getFullYear(), me = T.getHours() * 60 * 60 + T.getMinutes() * 60 + T.getSeconds() + T.getMilliseconds() * 1e-3, ne = R.getUniformLocation(
        m.current,
        H1
      );
      R.uniform4fv(ne, [he, _, ce, me]);
    }
    if (E.current.iFrame?.isNeeded) {
      const T = R.getUniformLocation(
        m.current,
        A1
      ), _ = E.current.iFrame.value;
      R.uniform1i(T, _), E.current.iFrame.value = _ + 1;
    }
    if (N.current.length > 0)
      for (let T = 0; T < N.current.length; T++) {
        const _ = N.current[T];
        if (!_) return;
        const { isVideo: ce, _webglTexture: he, source: me, flipY: ne, isLoaded: Ae } = _;
        if (!Ae || !he || !me) return;
        if (E.current[`iChannel${T}`]?.isNeeded) {
          if (!m.current) return;
          const $e = R.getUniformLocation(
            m.current,
            `iChannel${T}`
          );
          R.activeTexture(R.TEXTURE0 + T), R.bindTexture(R.TEXTURE_2D, he), R.uniform1i($e, T), ce && _.updateTexture(
            he,
            me,
            ne
          );
    ...
    const R = v.current;
    if (!R) return;
    R.viewport(0, 0, R.drawingBufferWidth, R.drawingBufferHeight), R.clear(R.COLOR_BUFFER_BIT | R.DEPTH_BUFFER_BIT), R.bindBuffer(R.ARRAY_BUFFER, k.current), R.vertexAttribPointer(
      F.current ?? 0,
      3,
      R.FLOAT,
      !1,
      0,
      0
    ), ve(b), R.drawArrays(R.TRIANGLE_STRIP, 0, 4);
    const y = E.current.iMouse?.value;
    if (E.current.iMouse?.isNeeded && c !== 1 && Array.isArray(y)) {
      const D = y[0] ?? 0, T = y[1] ?? 0;
      y[0] = U1(D, w.current[0] ?? 0, c), y[1] = U1(T, w.current[1] ?? 0, c);
    }
    P.current = requestAnimationFrame(re);
  }, le = () => {
    const b = { passive: !0 };
    E.current.iMouse?.isNeeded && C.current && (C.current.addEventListener("mousemove", oe, b), C.current.addEventListener("mouseout", Y, b), C.current.addEventListener("mouseup", Y, b), C.current.addEventListener("mousedown", te, b), C.current.addEventListener("touchmove", oe, b), C.current.addEventListener("touchend", Y, b), C.current.addEventListener("touchstart", te, b)), E.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      G,
      b
    ), C.current && ($.current = new ResizeObserver(J), $.current.observe(C.current), window.addEventListener("resize", J, b));
  }, Le = () => {
    const b = { passive: !0 };
    E.current.iMouse?.isNeeded && C.current && (C.current.removeEventListener("mousemove", oe, b), C.current.removeEventListener("mouseout", Y, b), C.current.removeEventListener("mouseup", Y, b), C.current.removeEventListener("mousedown", te, b), C.current.removeEventListener("touchmove", oe, b), C.current.removeEventListener("touchend", Y, b), C.current.removeEventListener("touchstart", te, b)), E.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      G,
      b
    ), $.current && ($.current.disconnect(), window.removeEventListener("resize", J, b));
  };
  return W(() => {
    V.current = n;
  }, [n]), W(() => {
    ...
    function R() {
      O();
      const y = v.current;
      y && C.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, C.current.width, C.current.height), C.current.height = C.current.clientHeight, C.current.width = C.current.clientWidth, ee(), ue(), K(ge(e || X2), r || V1), U(), requestAnimationFrame(re), le(), J());
    }
    return requestAnimationFrame(R), () => {
      const y = v.current;
      if (y) {
        if (y.getExtension("WEBGL_lose_context")?.loseContext(), y.useProgram(null), y.deleteProgram(m.current ?? null), b.length > 0)
          for (const D of b)
            y.deleteTexture(D._webglTexture);
        m.current = null;
      }
      Le(), cancelAnimationFrame(P.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
}`, il = 10, cl = 2, ll = 0.5, dl = 0.2, fl = 1.5, Ce = {
  duration: 0.5,
  ease: "easeOut"
}, O1 = {
  duration: 0.35,
...
function ul(e, r) {
  const [o, n] = A(il), {
    ...
    animate: a,
    motionValue: l
  } = Pe(dl), { value: d, animate: c } = Pe(cl), { value: u, animate: f } = Pe(ll), { value: g, animate: p } = Pe(fl), C = os(r, {
    fftSize: 512,
  ...
  return W(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), a(0.2, Ce), c(1.2, Ce), f(0.4, Ce), p(1, Ce);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), a(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, Ce), f(0.7, Ce), p([1.5, 2], O1);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), a(0.3, Ce), c(0.5, Ce), f(1, Ce), p([0.5, 2.5], O1);
        return;
      case "speaking":
        n(70), a(0.3, Ce), c(0.75, Ce), f(1.25, Ce), p(1.5, Ce);
        return;
    }
  }, [
    e,
    ...
    e === "speaking" && C > 0 && !l.isAnimating() && a(0.2 + 0.2 * C, { duration: 0 });
  }, [
    e,
    C,
    l,
...
function Qt({
  ...
  const C = X(() => Cl(l), [l]);
  return /* @__PURE__ */ t("div", { ref: f, className: g, ...p, children: /* @__PURE__ */ t(
    sl,
    {
      fs: al,
...
function w6({
  ...
  const { speed: u, scale: f, amplitude: g, frequency: p, brightness: C } = ul(r, s);
  return /* @__PURE__ */ t(
    Qt,
    {
      ref: d,
...
const k6 = ({
  ...
  const n = z(), s = ke();
  return /* @__PURE__ */ i(Re, { children: [
    e && /* @__PURE__ */ t("span", { className: L(pl(), "truncate"), children: e }),
  ...
  return /* @__PURE__ */ i("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ t("span", { className: L(Jt()), children: r }),
    /* @__PURE__ */ i(
      Q.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ i("div", { className: "flex items-center gap-1", children: [
            ...
            o && /* @__PURE__ */ t("span", { className: L(De()), children: o })
          ] }),
          n === "people" && /* @__PURE__ */ t(
            In,
            {
          ...
          n === "alert" && /* @__PURE__ */ t(Dn, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ t(wl, { balance: e.balance })
        ]
      }
    ),
    o && !ml.has(n) && /* @__PURE__ */ t(
      Q.span,
      {
        className: L(De()),
        animate: { opacity: s ? 0 : 1 },
...
const xl = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), bl = ({
  label: e,
  direction: r
}) => {
  const o = er[r];
  ...
  const s = `sparkline-gradient-${Y1().replace(/:/g, "")}`, a = Ll(e, o), l = er[a];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(Zn, { width: "100%", height: "100%", children: /* @__PURE__ */ i(
          _n,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(Un, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                On,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ t(bl, { label: r, direction: a })
      ]
    }
  ) });
}, tr = h(
  (e, r) => {
    const {
      ...
      className: c,
      ...u
    } = e, [f, g] = A(!1), [p, C] = A(!1), v = f || p, k = ke(), m = v && !!d, F = {
      duration: k ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, P = () => {
      l?.();
      ...
      /* @__PURE__ */ i(
        "div",
        {
          ...
          children: [
            ...
            u.content === "sparkline" ? /* @__PURE__ */ i("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ t("span", { className: L(Jt()), children: n }),
              /* @__PURE__ */ t(
                Q.div,
                {
...
tr.displayName = "F0AiInsightCardInternal";
const Ml = ["className"], rr = h((e, r) => {
  const o = Ml.reduce((n, s) => {
    const { [s]: a, ...l } = n;
    return l;
  }, e);
  return /* @__PURE__ */ t(tr, { ref: r, ...o });
});
...
const El = () => /* @__PURE__ */ i(
  ...
  "balance",
  "sparkline"
], or = 180, Rl = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : or, Fl = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, Nl = (e) => e.showActions !== !1, Vl = (e) => Object.fromEntries(
...
function Sl(e) {
  const {
    ...
    description: a,
    seeMoreLabel: l,
    maxCollapsedDescriptionLength: d = or
  } = e, [c, u] = A(!1), f = Y1(), g = I(null), p = Rl(
    d
  ), C = a.length > p, v = c ? a : Fl(a, p), k = Nl(e) ? e : null, m = Vl(e);
  return W(() => {
    c && g.current?.focus();
  }, [c]), /* @__PURE__ */ i(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          r && /* @__PURE__ */ t(vt, { module: r, size: "md" }),
        ...
        k && /* @__PURE__ */ t("div", { className: "flex items-center justify-end gap-3 border-0 border-t border-solid border-f1-border-secondary px-4 py-3", children: /* @__PURE__ */ t(
          pe,
          {
            type: "button",
...
const Tl = ({
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ i(kt, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
          /* @__PURE__ */ t("span", { className: "mr-2 *:block", children: /* @__PURE__ */ t(ie, { icon: e, className: "block" }) }),
...
}, Hl = (e) => ec[e] ?? nt, Al = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(ie, { icon: Hl(e), size: "md", color: "default" }) }) : null;
function $l({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(Tl, { icon: Ke, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, a) => {
    const l = /* @__PURE__ */ t(Al, { iconName: s.icon });
...
$l.displayName = "F0AiMessageSources";
...
function Il({
  ...
  const n = z(), s = I(null), a = r ?? n.ai.aiTable.title, l = Z(
    (d) => {
      if (!s.current) return;
      const c = o ?? (a.replace(/\s+/g, "_").toLowerCase() || "table");
      Bl(s.current, d, c);
    },
    [a, o]
  );
  return e.columns?.length ? /* @__PURE__ */ i(
    Ue,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(Ue, { overflowX: "auto", children: /* @__PURE__ */ i(
          "table",
          {
            ref: s,
            className: L(
              ...
              /* @__PURE__ */ t("tbody", { children: e.rows.map((d, c) => /* @__PURE__ */ t("tr", { children: e.columns.map((u) => {
                ...
                return /* @__PURE__ */ t(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ t(se, { children: f == null ? "" : String(f) })
                  },
                  u
                );
              }) }, c)) })
...
Il.displayName = "F0AiTableCard";
function Pl({ credits: e, trigger: r }) {
  const o = z(), [n, s] = A(!1), [a, l] = A(!1), [d, c] = A(!1), [u, f] = A(null), g = Z(
    (v) => {
      s(v), v && e?.fetchUsage && (l(!0), c(!1), e.fetchUsage().then((k) => {
        f(k), c(!1);
      }).catch(() => {
        c(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const p = u ? Math.min(100, Math.round(u.used / u.total * 100)) : 0, C = e.companyName;
  return /* @__PURE__ */ i(Je, { open: n, onOpenChange: g, children: [
    /* @__PURE__ */ t(e1, { asChild: !0, children: r ?? /* @__PURE__ */ t(
      ae,
      {
        variant: "ghost",
        hideLabel: !0,
    ...
    /* @__PURE__ */ i(
      t1,
      {
        ...
        children: [
          C && /* @__PURE__ */ i("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            /* @__PURE__ */ t(
              o1,
              {
                name: e.companyName ?? "",
...
const Dl = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function jl({
  employeeCredits: e,
  trigger: r
}) {
  const o = z(), n = ke(), [s, a] = A(!1), [l, d] = A(!1), [c, u] = A(!1), [f, g] = A(null), p = Z(
    (m) => {
      a(m), m && e?.fetchUsage && (d(!0), u(!1), e.fetchUsage().then((F) => {
        g(F), u(!1);
      }).catch(() => {
        u(!0);
      }).finally(() => {
  ...
  if (!e) return null;
  const C = !!e.companyName, v = f && f.total > 0 ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, k = f ? Math.max(0, f.total - f.used) : 0;
  return /* @__PURE__ */ i(Je, { open: s, onOpenChange: p, children: [
    /* @__PURE__ */ t(e1, { asChild: !0, children: r ?? /* @__PURE__ */ t(
      ae,
      {
        variant: "ghost",
...
const We = ({
...
) : e ? /* @__PURE__ */ t(Pl, { credits: e, trigger: o }) : null, b6 = We, y6 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const C = z(), v = Wn(`(max-width: ${qn.md}px)`, {
      ...
      children: [
        /* @__PURE__ */ t(
          se,
          {
            ...
            children: o ?? C.ai.newConversation
          }
        ),
        /* @__PURE__ */ i(
          Q.div,
        ...
        /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ t(
          Se,
          {
            ...
            children: /* @__PURE__ */ i("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ t(se, { lines: 1, className: "min-w-0 text-left", children: o ?? C.ai.newConversation }),
              /* @__PURE__ */ t(ie, { icon: Xe, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ i(
  ...
  ) : /* @__PURE__ */ i("header", { className: L("flex justify-between px-4 py-3"), children: [
...
function Zl() {
  if (!(typeof navigator > "u"))
    return Kn(navigator.language);
}
function _l(e) {
  const r = new Date(e), o = /* @__PURE__ */ new Date();
  return bt(r) ? "today" : yt(r) ? "yesterday" : Yn(r, o) ? "thisMonth" : "older";
}
function Ul(e, r) {
  const o = new Date(e), n = Zl(), s = w1(o, "p", { locale: n });
  if (bt(o)) return `${r.today}, ${s}`;
  if (yt(o)) return `${r.yesterday}, ${s}`;
  const a = !Xn(o, /* @__PURE__ */ new Date());
  return `${w1(o, a ? "MMM d yyyy" : "MMM d", {
    locale: n
  })}, ${s}`;
}
function Ol(e) {
        ...
        n ? (
          ...
          /* @__PURE__ */ t(
            "div",
            {
              ...
              children: /* @__PURE__ */ t(Qn, { size: "small" })
            }
          )
        ) : /* @__PURE__ */ t(
          "div",
          {
            ...
            children: /* @__PURE__ */ t(r1, { items: f, children: /* @__PURE__ */ t(
              ae,
              {
                icon: ot,
                variant: "ghost",
...
function z1({
  ...
  return /* @__PURE__ */ i("div", { children: [
    ...
    d && /* @__PURE__ */ t("div", { className: "flex flex-col", children: r.map((g) => /* @__PURE__ */ t(
      zl,
      {
        thread: g,
        isPinned: o.has(g.id),
...
const G1 = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], Gl = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(de, { className: L("h-4 rounded", e) }) }), W1 = ({
  titleWidth: e,
  rows: r
}) => /* @__PURE__ */ i("div", { className: "flex flex-col gap-0.5", children: [
  /* @__PURE__ */ t("div", { className: "flex items-center p-1.5", children: /* @__PURE__ */ t(de, { className: L("h-3 rounded", e) }) }),
  r.map((o, n) => /* @__PURE__ */ t(Gl, { width: o }, n))
] });
function Wl() {
  return /* @__PURE__ */ i("div", { "aria-hidden": "true", className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ t(W1, { titleWidth: "w-12", rows: G1.slice(0, 2) }),
    /* @__PURE__ */ t(W1, { titleWidth: "w-24", rows: G1 })
  ] });
}
const M6 = ({
  onClose: e,
  ...
  const C = X(
    ...
    return n.filter((N) => N.title.toLowerCase().includes(w));
  }, [n, g]), k = X(
    () => v.filter((w) => l.has(w.id)),
    [v, l]
  ), m = X(
    () => v.filter((w) => !l.has(w.id)),
    [v, l]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ i("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ t(ie, { icon: Ke, color: "secondary", size: "md" }),
                  /* @__PURE__ */ t(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ t(
                    Se,
                    {
                      ...
                      children: /* @__PURE__ */ i("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ t(ie, { icon: n1, color: "default", size: "md" }),
                        /* @__PURE__ */ t(se, { lines: 1, className: "text-left", children: f.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ t(Wl, {}),
                  !s && a && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: a }),
                  !s && !a && !M && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: f.ai.noPreviousChats }),
                  !s && !a && k.length > 0 && /* @__PURE__ */ t(
                    z1,
                    {
...
function E6({
  ...
  const [a, l] = A([]), [d, c] = A(!1), [u, f] = A(null), [g, p] = A(ql), [C, v] = A(() => /* @__PURE__ */ new Set()), k = Z(async () => {
    c(!0), f(null);
    try {
      const w = await r();
      l(w);
    } catch (w) {
      const N = w instanceof Error ? w.message : "Failed to fetch chat history";
      f(N), l([]);
    } finally {
      c(!1);
    }
  ...
  const m = Z((w, N) => {
    p((x) => {
      if (N === x.has(w)) return x;
      const $ = new Set(x);
      return N ? $.add(w) : $.delete(w), q1($), $;
    });
  }, []), F = Z((w, N) => {
    v((x) => {
      if (N === x.has(w)) return x;
    ...
    (w, N) => {
      const x = N ? n : s;
      m(w, N), x && (F(w, !0), x(w).catch(() => m(w, !N)).finally(() => F(w, !1)));
    },
    [n, s, m, F]
  ), H = Z((w) => P(w, !0), [P]), S = Z(
    (w) => P(w, !1),
    ...
    async (w) => {
      F(w, !0);
      try {
        await o(w), l((N) => N.filter((x) => x.id !== w)), p((N) => {
          if (!N.has(w)) return N;
          const x = new Set(N);
          return x.delete(w), q1(x), x;
        });
      } catch {
        k();
      } finally {
...
const Xl = Q.create(ts), Yl = ({
  ...
  const { t: a } = z(), l = ke(), d = o ?? a("ai.applyingChanges");
  return W(() => {
    if (!r) return;
    const c = document.activeElement;
    c && c.getAttribute("name") !== "one-ai-input" && c.blur();
  }, [r]), /* @__PURE__ */ i("div", { className: L("relative flex flex-1 flex-col", n), children: [

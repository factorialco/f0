...
import { useInsertionEffect as Hr, forwardRef as g, useRef as $, useEffect as q, useLayoutEffect as a1, useState as P, useId as Ge, useMemo as J, useCallback as Z, useContext as Ie, createContext as We, createElement as Ar, memo as $r } from "react";
import { d6 as Br, d7 as Ir, aj as nt, c6 as Pr, d8 as Dr, d9 as jr, da as _r, db as Zr, c7 as Or, cc as st, c5 as Ur, dc as zr, as as i1, dd as Gr, aZ as Wr, de as qr, df as Xr, dg as Yr, aC as Kr, dh as Qr, cD as Jr, y as at, az as eo, di as to, o as c1, an as it, ae as qe, n as ct, bv as ro, ca as oo, dj as no, bi as so, cC as ao, al as Fe, aP as io, bz as lt, dk as co, cA as lo, l as Me, cy as fo, dl as uo, c1 as dt, bh as ho, dm as po, dn as go, dp as Co, dq as mo, dr as vo, ds as ft, cq as wo, cr as xo, dt as ko, du as Lo, dv as bo, dw as yo, dx as Mo, bL as Eo, c9 as Ro, dy as Fo, dz as No, dA as Vo, dB as So, dC as To, dD as Ho, dE as Ao, dF as $o, bK as Bo, cB as Io, ax as Po, cm as Do, dG as jo, dH as _o, dI as Zo, dJ as Oo, dK as Uo, dL as zo, dM as Go, aL as Wo, bM as qo, R as ut, ad as Xo, am as Yo, bN as ht, c0 as Ko, Q as pt, i as Qo, by as Jo, bx as en, dN as tn, dO as rn, bO as gt, bP as on, bQ as nn, bg as sn, aS as an, dP as cn, j as ln, bt as Ct, bs as mt, bn as dn, dQ as vt, aw as fn, c8 as l1, q as un, bq as d1, dR as hn, dS as pn, dT as f1, N as gn, O as Cn, cz as wt, dU as mn, ab as vn, aa as wn, dV as xn, dW as kn, dX as Ln, dY as bn, b_ as yn, dZ as xt, d_ as Mn, ay as En, d$ as Rn, g as G, bZ as Fn, ac as se, S as he, bJ as kt, U as le, ao as Nn, m as ve, e0 as Vn, aA as ae, b3 as ke, a9 as Ee, a2 as ee, cN as Lt, t as u1, e1 as Sn, x as h1, u as ye, bX as Tn, e2 as Hn, bY as An, af as $n, bf as Bn, ar as p1, bR as In, bS as Pn, bT as Dn, bU as M1, ap as jn, aG as bt, b5 as yt, bI as _n, cL as Zn, e3 as On, e4 as Un, bb as Mt, e5 as zn, cP as Gn, e6 as Wn, b7 as Be, bo as Et, e7 as Rt, bp as Ft, F as o1, cb as E1, e8 as Nt, e9 as qn, ea as Xn, a3 as Te, bD as Yn, eb as Kn, bu as g1, cn as Qn, ec as Jn, ed as es, ee as ts, ef as rs, eg as os, w as ns, s as ss, ch as as, v as Vt, a7 as is, a8 as cs, aF as R1, eh as St, ei as Tt, ej as ls, ek as ds, aE as fs, at as us, el as hs, em as ps, e as gs } from "./F0CanvasPanel-CJ-VRurM.js";
import { f as pe, d as k, g as Cs } from "./tooltip-O9r8Okrx.js";
...
import { a as ws, F as xs, d as ks, c as Ls, b as bs } from "./VolumeMuted-XL3dwOL-.js";
...
`) ? o + "_" : o
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, L0).map((r) => /* @__PURE__ */ t(
  Lt,
  {
        ...
        C && /* @__PURE__ */ i(
          h1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: M0(C.items).map((p, h) => /* @__PURE__ */ i(
                "button",
                {
                  type: "button",
                  onClick: (m) => {
...
` || z === "	";
  ...
  const B = J(() => {
    ...
    const S = s.current;
    if (!S) return null;
    const I = A0(S, y.current), U = S.offsetLeft + I.left, z = (S.offsetParent ? S.offsetParent.offsetHeight : 0) - (S.offsetTop + I.top);
...
const I0 = /[\\`*_{}[\]()#+\-.!|~>]/g, P0 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(I0, "\\$&")).join(""), I6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const L = G(), B = ke(), [R, S] = P(""), [I, U] = P(0), [O, z] = P(!1), [te, oe] = P(!1), [X, Y] = P(null), j = $(null), W = $(null), K = $(null), ie = l != null, { tracking: ue } = ye(), ge = Z(
    (Q, Le) => {
  ...
  const Pe = xe.status === "recording", Je = Pe ? L.ai.listening : L.ai.inputPlaceholder, Ae = re.filter((Q) => Q.status === "uploaded"), Se = re.some((Q) => Q.status === "uploading"), De = re.some((Q) => Q.status === "error"), je = R.trim().length > 0 || Ae.length > 0;
  q(() => {
    if (!(!te || Se)) {
      if (oe(!1), De) {
  ...
  const _e = async (Q) => {
    if (Q.preventDefault(), !ie) {
      if (ne.close(), o)
        ...
        const Le = ne.transformMentions(R.trim()), e1 = P0(Le), Oe = Ae.flatMap(
  ...
  }, v1 = X ? X.prompt ?? X.title : null, w1 = Pe ? [L.ai.listening] : v1 ? [v1] : s ?? [], Fr = w1.length > 1, Nr = J(() => R0(R, ne.mentions, {
    cursorPosition: I,
  ...
  ) : null, Sr = A && T && !!w && w.length > 0, k1 = T && A, { motionProps: Tr } = Hn(
    A,
    160,
    0.5
  );
    ...
    ee.div,
    {
      ...
      children: [
        /* @__PURE__ */ i("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(m0, { creditWarning: a, children: /* @__PURE__ */ i(
            ee.form,
            {
              "aria-busy": o,
              ref: j,
        ...
        Sr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(b0, { cards: w }) }),
...
async function q0(e, r, o) {
  const n = await import("./xlsx-CF422ARu.js"), s = n.utils.table_to_book(e, { sheet: "Data" });
  n.writeFile(s, `${o}.${r}`);
}
function X0({
  children: e,
...
const N1 = 7, gl = 625, V1 = /* @__PURE__ */ new Set();
function Cl(e) {
...
function vl(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = On(e), a = [];
...
function qt(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: vl(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? Cl(o) : "") || "—" };
  }
...
function Xt({
  ...
  h.current = y, q(() => {
    typeof window > "u" || window.innerWidth < gl || V1.has(e) || (V1.add(e), h.current());
  }, [e]);
  const A = a && l ? Object.entries(a).map(([E, w]) => {
    ...
    if (!L && w.fieldType === "custom" && typeof N == "object" && N !== null)
      return null;
    const B = L ?? qt(N, w.fieldType), R = ["richtext", "textarea"];
    return {
      label: w.label,
      content: B,
...
const Qt = We(void 0), Z6 = () => Ie(Qt), Ll = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), bl = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, C = $(null), { anchor: p, clear: h } = Yt({
    containerRef: C,
    enabled: !!(o?.id && d)
  });
  return q(() => {
    o?.id && !r && !e && a?.(o);
  }, [o, r, e, a]), !r && !e && f ? null : /* @__PURE__ */ t(Qt.Provider, { value: u, children: /* @__PURE__ */ i("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ t(
      "div",
      {
        ref: C,
...
const Rl = ({
  ...
  const n = G(), { open: s } = er(), [a, l] = P(null);
...
const tr = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), Tl = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = Sl(
    e?.content,
    l
  ), c = (Vl(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: C, clear: p } = Yt({
    containerRef: a,
    enabled: f
  });
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t(Tl, { text: u, renderMarkdown: n }),
...
}, Al = 35, $l = 22, Bl = 400, Il = 2500, Pl = 220, Dl = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  ...
  q(() => {
    ...
    let p;
    if (d === "starting")
      p = setTimeout(() => c("writing"), Bl);
    else if (d === "writing")
      a < u.length ? p = setTimeout(() => l((h) => h + 1), Al) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), Il);
    } else d === "erasing" && (a > 0 ? p = setTimeout(() => l((h) => h - 1), $l) : p = setTimeout(() => {
...
const _l = {
...
}, U6 = (e) => /* @__PURE__ */ t(Ml, { children: /* @__PURE__ */ t(Zl, { ...e }) }), Zl = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: T, handleSubmit: V, handleClose: E } = El(
    f ?? _l
  ), w = G(), N = x ?? bl, L = v ?? Hl, B = J(() => {
    const j = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(j) ? j : [j]).filter((K) => typeof K == "string" && K.length > 0);
  }, [n, w.ai.defaultInitialMessage]), R = !r && e.length === 0 && B.length > 0, S = $(null), I = $(null), U = $(null), O = $(null), z = $(null), { showScrollBtn: te, turnMinHeight: oe, scrollToBottom: X } = jl({
    viewportRef: S,
    contentRef: I,
    endRef: U,
    lastTurnRef: z,
    ...
    const K = W === e.length - 1, ie = {
      ...
      const we = K && de === j.assistantMessages.length - 1, b = j.userMessages.length + de, F = {
        message: re,
        inProgress: j.isInProgress,
        index: b,
        isCurrentMessage: we,
...
const zl = ({
  ...
  const x = e === "single" ? /* @__PURE__ */ t(or, { isSelected: o && !r }) : /* @__PURE__ */ t(
    Nt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const Wl = ({
  ...
  const o = G(), n = ke(), {
  ...
  } = s, N = $(null), L = A ?? "single", B = l > 1, R = a === 0, S = a === l - 1, I = B ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(a + 1),
    total: String(l)
    ...
    const re = L === "single" && y.includes(ge);
    d(ge), L === "single" && !S && !re && Promise.resolve().then(c);
  ...
  return /* @__PURE__ */ i("div", { className: "flex flex-col", onKeyDown: ie, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ i(
      ee.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ue, ease: Xl },
        children: [
          /* @__PURE__ */ t(
            ql,
            {
...
function B1(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), a = Math.min(o, 20), d = Math.min(a + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (K) => K / e * 2 - 1, C = (K) => K / r * 2 - 1, p = 0, h = e, m = 0, x = r, v = c, y = e - c, A = u, T = r - u, V = f(p), E = f(h), w = C(m), N = C(x), L = f(v), B = f(y), R = C(A), S = C(T), I = 0, U = 0, O = 1, z = 1, te = c / e, oe = 1 - c / e, X = u / r, Y = 1 - u / r, j = new Float32Array([
    // Top strip
    V,
    w,
    E,
...
class Y6 {
  ...
  setupGL() {
    ...
    const V = (this.options.colors || t2).map(r2);
...
const P1 = ["lowp", "mediump", "highp"], o2 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, n2 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, j1 = "iTime", _1 = "iTimeDelta", Z1 = "iDate", O1 = "iFrame", U1 = "iMouse", z1 = "iResolution", s2 = "iChannel", G1 = "iChannelResolution", W1 = "iDeviceOrientation";
function a2(e, r) {
...
}, t1 = 9729, q1 = 9728, f2 = 9987, X1 = 33071, Y1 = 10497;
class u2 {
  gl;
  url;
  wrapS;
  ...
  load = async (r) => {
    ...
    return (r.wrapS !== X1 || r.wrapT !== X1 || r.minFilter !== q1 && r.minFilter !== t1) && !w && (E = this.makePowerOf2(E), w = !0), o.bindTexture(o.TEXTURE_2D, T), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, c), o.texImage2D(
      o.TEXTURE_2D,
      C,
      p,
      v,
      y,
      E
    ), w && r.minFilter !== q1 && r.minFilter !== t1 && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || Y1
    ), o.texParameteri(
...
function p2({
  ...
  const h = $(null), m = $(null), x = $(null), v = $(null), y = $(void 0), A = $(void 0), T = $(!1), V = $(void 0), E = $(0), w = $([0, 0]), N = $([]), L = $(0), B = $(void 0), R = $({
    ...
    const M = "width" in b ? b.width ?? 0 : 0, D = "height" in b ? b.height ?? 0 : 0, H = R.current.iChannelResolution;
    if (!H) return;
    ...
    const [F = 0, M = 0] = K1(b), D = F - (V.current?.left ?? 0) - window.pageXOffset, H = (V.current?.height ?? 0) - M - (V.current?.top ?? 0) - window.pageYOffset;
    T.current = !0;
    ...
    const [F = 0, M = 0] = K1(b), D = F - (V.current?.left ?? 0), H = (V.current?.height ?? 0) - M - (V.current?.top ?? 0);
    if (c !== 1)
    ...
    if (b.canvas.width = M, b.canvas.height = D, R.current.iResolution?.isNeeded && v.current) {
...
${F}`));
      ...
      M.deleteShader(D), C?.(be(`Shader compiler log: ${H}`));
    }
    return D;
  }, W = (b, F) => {
    const M = m.current;
    if (!M) return;
    const D = j(M.FRAGMENT_SHADER, b), H = j(M.VERTEX_SHADER, F);
      ...
      if (o && o.length > 0) {
        ...
        const F = o.map(
          (M, D) => (R.current[`${s2}${D}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, I(M, D), N.current[D] = new u2(b), N.current[D]?.load(M).then((H) => {
            I(H, D);
          }))
        );
        Promise.all(F).then(() => {
...
`,
    ...
    return b.includes("mainImage") && (D = D.concat(o2)), D;
  }, ge = (b) => {
    const F = m.current;
    ...
    F.viewport(0, 0, F.drawingBufferWidth, F.drawingBufferHeight), F.clear(F.COLOR_BUFFER_BIT | F.DEPTH_BUFFER_BIT), F.bindBuffer(F.ARRAY_BUFFER, x.current), F.vertexAttribPointer(
      ...
      0,
      0
    ), ge(b), F.drawArrays(F.TRIANGLE_STRIP, 0, 4);
  ...
  return q(() => {
    ...
    function F() {
      U();
      const M = m.current;
      M && h.current && (M.clearColor(...s), M.clearDepth(1), M.enable(M.DEPTH_TEST), M.depthFunc(M.LEQUAL), M.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, K(), ie(), W(ue(e || n2), r || D1), O(), requestAnimationFrame(re), de(), Y());
    }
...
}`, C2 = 10, m2 = 2, v2 = 0.5, w2 = 0.2, x2 = 1.5, Ce = {
  duration: 0.5,
  ease: "easeOut"
}, J1 = {
  duration: 0.35,
...
function k2(e, r) {
  const [o, n] = P(C2), {
    ...
    animate: a,
    motionValue: l
  } = Ue(w2), { value: d, animate: c } = Ue(m2), { value: u, animate: f } = Ue(v2), { value: C, animate: p } = Ue(x2), h = vs(r, {
    fftSize: 512,
...
function K6({
  ...
  const { speed: u, scale: f, amplitude: C, frequency: p, brightness: h } = k2(r, s);
  return /* @__PURE__ */ t(
    sr,
    {
      ref: d,
...
const R2 = Te({
  ...
  const n = G(), s = ke();
  return /* @__PURE__ */ i(Re, { children: [
    e && /* @__PURE__ */ t("span", { className: k(F2(), "truncate"), children: e }),
  ...
  return /* @__PURE__ */ i("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ t("span", { className: k(ir()), children: r }),
    /* @__PURE__ */ i(
      ee.div,
      {
        ...
        children: [
          ...
          n === "balance" && /* @__PURE__ */ t(S2, { balance: e.balance })
        ]
      }
    ),
    o && !V2.has(n) && /* @__PURE__ */ t(
      ee.span,
      {
        className: k(ze()),
        animate: { opacity: s ? 0 : 1 },
...
const A2 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), $2 = ({
  label: e,
  direction: r
}) => {
  const o = cr[r];
  ...
  const s = `sparkline-gradient-${Ge().replace(/:/g, "")}`, a = H2(e, o), l = cr[a];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(es, { width: "100%", height: "100%", children: /* @__PURE__ */ i(
          ts,
          {
            data: e,
        ...
        /* @__PURE__ */ t($2, { label: r, direction: a })
      ]
    }
  ) });
}, lr = g(
        ...
        "div",
        {
          ...
          children: [
            ...
            u.content === "sparkline" ? /* @__PURE__ */ i("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ t("span", { className: k(ir()), children: n }),
              /* @__PURE__ */ t(
                ee.div,
                {
...
const I2 = ["className"], dr = g((e, r) => {
  const o = I2.reduce((n, s) => {
    const { [s]: a, ...l } = n;
    return l;
  }, e);
...
const P2 = () => /* @__PURE__ */ i(
  ...
  "balance",
  "sparkline"
], fr = 180, D2 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : fr, j2 = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, _2 = (e) => e.showActions !== !1, Z2 = (e) => Object.fromEntries(
...
function O2(e) {
  ...
  } = e, [c, u] = P(!1), f = Ge(), C = $(null), p = D2(
    d
  ), h = a.length > p, m = c ? a : j2(a, p), x = _2(e) ? e : null, v = Z2(e);
  return q(() => {
    c && C.current?.focus();
  }, [c]), /* @__PURE__ */ i(
    "section",
...
O2.displayName = "F0AiProposalCard";
const U2 = ({
  icon: e,
  title: r,
  children: o
...
}, z2 = (e) => u0[e] ?? ft, G2 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: z2(e), size: "md", color: "default" }) }) : null;
function W2({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(U2, { icon: d1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, a) => {
    const l = /* @__PURE__ */ t(G2, { iconName: s.icon });
...
W2.displayName = "F0AiMessageSources";
const ur = {
  background: {
...
const d6 = Te({
  ...
  ({
    ...
    const Ae = j && j !== "none" || W && W !== "none" || K && K !== "none" || ie && ie !== "none", Se = Y && Y !== "none" || Ae, De = { sm: xe, md: Ye, lg: Ke, xl: Qe }, je = f6.map((_e) => {
      const Ze = De[_e];
      return Ze ? l6(_e, Ze) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
  ...
  return e.columns?.length ? /* @__PURE__ */ i(
    r1,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(r1, { overflowX: "auto", children: /* @__PURE__ */ i(
          "table",
          {
            ref: s,
            className: k(
...
const tt = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], L6 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(he, { className: k("h-4 rounded", e) }) }), rt = ({
  titleWidth: e,
  rows: r
  ...
  r.map((o, n) => /* @__PURE__ */ t(L6, { width: o }, n))
] });
function b6() {

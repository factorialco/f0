...
import C, { useRef as Me, useState as he, useCallback as rt, useEffect as Le, useContext as pt, useMemo as Ke, useLayoutEffect as aO, createContext as zt, isValidElement as Rt, Children as Vr, PureComponent as Mt, forwardRef as We, useImperativeHandle as TT, cloneElement as He, createElement as iO, Component as oO, useId as ET } from "react";
import { bi as ny, bg as CT, dn as jT, B as _r, aH as sO, c as Q, aI as uO, aB as MT, aC as $T, a as _s, w as qe, g as ki, dp as to, bt as _e, D as IT, dq as DT, dr as kT, aN as cO, ds as NT, dt as RT, bL as ph, du as LT, F as ct, Q as Ps, aY as lO, b7 as hh, az as fO, dv as xn, dw as qT, dx as BT, dy as FT, dz as ay, dA as iy, dB as oy, dC as sy, dD as uy, dE as dO, dF as xo, dG as zT, dH as WT, dI as UT, cr as Ga, J as pO, K as hO, L as vO, q as vh, a1 as an, s as yO, t as mO, bQ as yh, h as de, cb as HT, bz as mh, bA as gh, bB as bh, bE as xh, cB as KT, cI as wh, d8 as VT, cp as gO, aD as GT, aA as YT, cx as Ni, u as Tr, aZ as XT, bG as ZT, E as Yt, z as bO, a3 as JT, a4 as xO, x as QT, dd as Ts, dJ as eE, O as on, aW as tE, aK as rE, b2 as nE, aL as wO, b6 as aE, m as Kt, N as Oh, f as OO, aa as iE, n as SO, bN as oE, S as _t, d as AO, dK as _O, M as sE, V as PO, v as uE, cS as Ze, dL as TO, dM as EO, dN as Dd, dO as cE, dP as cy, cV as lE, cW as ly, P as fE, l as dE, o as pE, dl as hE, af as vE, da as yE, aE as mE, dQ as gE, aG as bE, A as Na, e as xE, cv as wE, av as OE, b9 as SE, bb as AE, de as _E, R as PE, T as TE, U as EE, W as CE } from "./index-YKXHyb4A.js";
const jE = {
  active: !0,
  breakpoints: {},
  delay: 4e3,
...
function EC(e, t, r, n, a, i, o) {
  const {
  ...
  }, F = iC(n, a, () => E(yu), (hn) => Y(yu, hn)), ae = 0.68, ce = ee[U.get()], oe = $a(ce), Se = $a(ce), Te = $a(ce), me = $a(ce), ye = dC(oe, Te, Se, me, d, ae), Be = xC(f, ee, X, J, me), tr = wC(F, U, V, ye, Be, me, o), dn = mC(J), pn = Za(), Qi = _C(t, r, o, h), {
    slideRegistry: ga
    ...
    animation: F,
    axis: T,
    dragHandler: sC(T, e, n, a, me, uC(T, a), oe, F, tr, ye, Be, U, o, M, p, y, b, ae, m),
    eventStore: pn,
    percentOfView: M,
    index: U,
    indexPrevious: V,
...
function Ch(e = {}, t = []) {
  const r = Me(e), n = Me(t), [a, i] = he(), [o, s] = he(), u = rt(() => {
...
const ke = 28, xy = 16, IC = ({ children: e }) => {
  ...
  let c = "";
  return a && r ? c = `linear-gradient(to right, transparent 0px, transparent ${ke}px, black ${2 * ke}px, black calc(100% - ${3 * ke}px), transparent calc(100% - ${2 * ke}px), transparent 100%)` : a && !r ? c = `linear-gradient(to right, transparent 0px, transparent ${ke}px, black ${2 * ke}px, black 100%)` : !a && r ? c = `linear-gradient(to right, black 0px, black calc(100% - ${3 * ke}px), transparent calc(100% - ${2 * ke}px), transparent 100%)` : c = "none", /* @__PURE__ */ K("div", { className: "relative", children: [
    /* @__PURE__ */ S(
      "div",
      {
        ref: t,
        ...
        children: Array.isArray(e) ? e.map((l, f) => /* @__PURE__ */ S(
          "div",
          {
...
const IO = fe.forwardRef(
  ({
    ...
    const [u, c] = Ch(
      ...
      n
    ), [l, f] = fe.useState(!1), [d, p] = fe.useState(!1), y = fe.useCallback((g) => {
  ...
  return /* @__PURE__ */ S(
    "div",
    {
      className: Q(
        ...
        !o && "opacity-0 group-hover/carousel:opacity-0",
        a === "horizontal" ? "-left-3 top-1/2 -translate-y-1/2" : "-top-3 left-1/2 -translate-x-1/2 rotate-90"
      ),
      children: /* @__PURE__ */ S(
        _r,
        {
...
const RO = fe.forwardRef(
  ({ className: e, variant: t = "outline", ...r }, n) => {
    ...
    return /* @__PURE__ */ S(
      "div",
      {
        className: Q(
          "absolute flex h-6 w-6 items-center justify-center rounded-sm bg-f1-background opacity-0 backdrop-blur-sm transition-opacity group-hover/carousel:opacity-100",
          !o && "opacity-0 group-hover/carousel:opacity-0",
          a === "horizontal" ? "-right-3 top-1/2 -translate-y-1/2" : "-bottom-3 left-1/2 -translate-x-1/2 rotate-90"
        ),
        children: /* @__PURE__ */ S(
          _r,
          {
...
const LO = fe.forwardRef(({ ...e }, t) => {
  ...
  if (fe.useEffect(() => {
    ...
    return d.addEventListener("wheel", p, { passive: !1 }), d.addEventListener("touchmove", p, { passive: !1 }), () => {
      d.removeEventListener("wheel", p), d.removeEventListener("touchmove", p);
    };
  }, []), o <= 1)
    return null;
  const u = o > 5 ? 5 : o, c = Array.from({ length: o }, (d, p) => p), l = Math.min(u, o) * 16, f = (d) => {
    if (u === o) return null;
    const p = Math.abs(d - s);
    if (p === 0 || p === 1) return "scale-100";
    if (p === 2)
      return s === 0 || s === o - 1 ? "scale-100" : "scale-75";
    if (p === 3)
      return s === 0 || s === o - 1 ? "scale-75" : "scale-50";
    if (p >= 4) return "scale-50";
  };
  return /* @__PURE__ */ S("div", { ref: t, className: Q("flex justify-center", e.className), children: /* @__PURE__ */ S(
    "div",
    {
              ...
              children: /* @__PURE__ */ S(
                "div",
                {
                  className: Q(
                    ...
                    d === s && "rounded-[3px] opacity-100 group-hover/dot:opacity-100",
                    f(d)
                  )
                }
              )
...
const kC = ({
  ...
  const u = C.Children.toArray(e), c = C.useRef(
    a ? Sh({ delay: i, stopOnInteraction: !0 }) : void 0
  ), l = () => {
  ...
  return t ? /* @__PURE__ */ S(
    IO,
    {
      ...
      children: /* @__PURE__ */ K("div", { className: "flex flex-col gap-5", children: [
        /* @__PURE__ */ K("div", { className: "relative", children: [
          /* @__PURE__ */ S(DO, { children: C.Children.map(u, (d, p) => {
            const y = s?.find(
              (h) => h.index === p
            );
            return /* @__PURE__ */ S(
          ...
          r && /* @__PURE__ */ K(dt, { children: [
            /* @__PURE__ */ S(NO, { label: "Previous" }),
            /* @__PURE__ */ S(RO, { label: "Next" })
          ] })
        ] }),
        n && /* @__PURE__ */ S(LO, {})
      ] })
    }
  ) : /* @__PURE__ */ S(IC, { children: e });
}, KW = qe(
  ki("Carousel", kC)
), qO = zt(null);
function VW({ children: e, layout: t }) {
  return /* @__PURE__ */ S(qO.Provider, { value: t, children: e });
}
function GW() {
  return pt(qO);
}
...
const en = /* @__PURE__ */ _e(Nj), Rj = [], Lj = (e) => {
  ...
  ki("Dropdown", Lj)
), qj = ({ items: e, children: t }) => {
  const [r, n] = he(!1);
  return /* @__PURE__ */ K(DT, { open: r, onOpenChange: n, children: [
    /* @__PURE__ */ S(kT, { asChild: !0, children: t || /* @__PURE__ */ S(
      _r,
      {
        label: "Other actions",
        icon: cO,
    ...
    /* @__PURE__ */ S(NT, { className: "bg-f1-background-overlay" }),
    /* @__PURE__ */ S(RT, { className: "bg-f1-background", children: /* @__PURE__ */ S("div", { className: "flex flex-col px-2 pb-3 pt-2", children: e.map((a, i) => a.type === "separator" ? /* @__PURE__ */ S(
      "div",
      {
        className: "mx-[-8px] my-2 h-px w-[calc(100%+16px)] bg-f1-border-secondary"
      },
      `separator-${i}`
    ) : a.type === "label" ? /* @__PURE__ */ S(
      "span",
      {
          ...
          a.icon && /* @__PURE__ */ S(
            "span",
            {
              className: Q(
                ...
                a.critical && "text-f1-icon-critical"
              ),
              children: /* @__PURE__ */ S(ct, { icon: a.icon, size: "md" })
            }
          ),
          /* @__PURE__ */ S(
            "span",
            {
              className: Q(
                "font-medium",
                a.critical ? "text-f1-foreground-critical" : "text-f1-foreground"
              ),
              children: a.label
            }
          )
  ...
  return /* @__PURE__ */ S(
    "div",
    {
      className: Bj({ type: e, size: t }),
      "aria-label": r,
      "aria-labelledby": n,
      role: "alert",
      children: /* @__PURE__ */ S(ct, { icon: a[e], size: t })
    }
  );
}, zj = qe(Fj);
function Wj(e, t) {
...
const QW = (e, t) => {
  ...
  return /* @__PURE__ */ K(
    "div",
    {
      ...
      "aria-labelledby": r,
      children: [
        /* @__PURE__ */ S("div", { className: "pt-0.5 text-xs font-semibold uppercase leading-3 text-f1-special-highlight dark:text-f1-foreground-inverse-secondary", children: a }),
        /* @__PURE__ */ S("div", { className: "flex items-center justify-center text-lg font-medium leading-tight text-f1-foreground", children: n })
      ]
    }
  );
}, e7 = qe(Yj);
...
const Xj = _s({
  ...
  const i = /* @__PURE__ */ S(
    "div",
    {
      ...
      children: t === "xs" ? /* @__PURE__ */ S(ct, { icon: cO, size: "xs" }) : `+${e}`
    }
  );
  return n?.length ? /* @__PURE__ */ K(pO, { children: [
    /* @__PURE__ */ S(hO, { asChild: !0, children: i }),
    /* @__PURE__ */ S(vO, { side: "top", children: /* @__PURE__ */ K(vh, { className: "[*[data-state=visible]_div]:bg-f1-background flex max-h-[172px] flex-col", children: [
      n.map((o, s) => /* @__PURE__ */ K(
        "div",
        {
          className: "flex w-[180px] min-w-0 items-center gap-1.5 px-2 py-1 [&:first-child]:pt-2 [&:last-child]:pb-2",
          children: [
            /* @__PURE__ */ S("div", { className: "h-6 w-6 shrink-0", children: /* @__PURE__ */ S(
              an,
              {
                avatar: { type: a, ...o },
                size: "sm"
            ...
            /* @__PURE__ */ S("div", { className: "min-w-0 flex-1 truncate font-semibold", children: rS(a, o) })
          ]
        },
        s
      )),
  ...
  if (t && !Jj.includes(t)) {
    ...
    console.warn(
      `The avatar list size: ${t} is deprecated. Use ${c[t]} instead.`
    ), t = c[t] ?? "md";
  }
  const s = {
    xs: -2,
  ...
  return /* @__PURE__ */ S(
    ...
    {
      max: i,
      items: e.map((c) => ({ type: r, ...c })),
      gap: s,
      itemsWidth: u,
      className: "flex items-center",
      renderListItem: (c, l) => {
        const f = rS(r, c), d = /* @__PURE__ */ S(
          "div",
          {
        ...
        return /* @__PURE__ */ S("div", { children: n ? d : /* @__PURE__ */ S(yh, { label: f, children: d }) }, l);
      },
      renderDropdownItem: () => null,
      forceShowingOverflowIndicator: a !== void 0,
      renderOverflowIndicator: (c) => /* @__PURE__ */ S(
        "div",
        {
...
const e2 = qe(nS), t2 = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";
let r2 = (e = 21) => {
      ...
      var $ = {
        ...
        return (
          ...
          /* @__PURE__ */ C.createElement("li", {
            ...
            style: k
          }, Ye(B) ? /* @__PURE__ */ C.createElement("span", {
            className: "recharts-tooltip-item-name"
          }, B) : null, Ye(B) ? /* @__PURE__ */ C.createElement("span", {
...
var LI = /* @__PURE__ */ We(function(e, t) {
  ...
  }), _ = II(A, 2), P = _[0], D = _[1], T = rt(function(M, j) {
    D(function(I) {
  ...
  var $ = Ke(function() {
    ...
    return C.Children.map(p, function(L) {
      return /* @__PURE__ */ C.isValidElement(L) ? /* @__PURE__ */ He(L, io({
        width: I,
        height: k
      }, R ? {
        style: io({
...
var GS = /[ \f\n\r\t\v\u2028\u2029]+/, YS = function(t) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, s = o === void 0 ? "1em" : o, u = t.capHeight, c = u === void 0 ? "0.71em" : u, l = t.scaleToFit, f = l === void 0 ? !1 : l, d = t.textAnchor, p = d === void 0 ? "start" : d, y = t.verticalAnchor, h = y === void 0 ? "end" : y, v = t.fill, b = v === void 0 ? h0 : v, g = l0(t, sD), x = Ke(function() {
    return vD({
      breakAll: g.breakAll,
      children: g.children,
      maxLines: g.maxLines,
...
zo.every = (e) => (e = Math.floor(e), !isFinite(e) || !(e > 0) ? null : e > 1 ? Xe((t) => {
  t.setTime(Math.floor(t / e) * e);
}, (t, r) => {
  t.setTime(+t + r * e);
}, (t, r) => (r - t) / e) : zo);
zo.range;
const ar = 1e3, Tt = ar * 60, ir = Tt * 60, cr = ir * 24, fv = cr * 7, F0 = cr * 30, Df = cr * 365, Ur = Xe((e) => {
...
fr.every = (e) => !isFinite(e = Math.floor(e)) || !(e > 0) ? null : Xe((t) => {
...
}, Ov, Ie = !0, jt = "[DecimalError] ", Zr = jt + "Invalid argument: ", wv = jt + "Exponent out of range: ", la = Math.floor, Br = Math.pow, JN = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, bt, Je = 1e7, $e = 7, MA = 9007199254740991, Ho = la(MA / $e), re = {};
...
re.squareRoot = re.sqrt = function() {
  ...
  for (e = ze(s), Ie = !1, a = Math.sqrt(+s), a == 0 || a == 1 / 0 ? (t = Vt(s.d), (t.length + e) % 2 == 0 && (t += "0"), a = Math.sqrt(t), e = la((e + 1) / 2) - (e < 0 || e % 2), a == 1 / 0 ? t = "5e" + e : (t = a.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + e), n = new u(t)) : n = new u(a.toString()), r = u.precision, a = o = r + 3; ; )
...
re.times = re.mul = function(e) {
  ...
  for (n = c; --n >= 0; ) {
    for (t = 0, a = u + n; a > n; )
      s = i[a] + p[n] * d[a - n - 1] + t, i[a--] = s % Je | 0, t = s / Je | 0;
    i[a] = (i[a] + t) % Je | 0;
  }
  for (; !i[--o]; ) i.pop();
...
re.toDecimalPlaces = re.todp = function(e, t) {
  ...
  return r = new n(r), e === void 0 ? r : (Jt(e, 0, ca), t === void 0 ? t = n.rounding : Jt(t, 0, 8), Pe(r, e + ze(r) + 1, t));
};
...
re.toFixed = function(e, t) {
  ...
  return e === void 0 ? rn(a) : (Jt(e, 0, ca), t === void 0 ? t = i.rounding : Jt(t, 0, 8), n = Pe(new i(a), e + ze(a) + 1, t), r = rn(n.abs(), !1, e + ze(n) + 1), a.isneg() && !a.isZero() ? "-" + r : r);
};
...
re.toPrecision = function(e, t) {
  var r, n, a = this, i = a.constructor;
  return e === void 0 ? (r = ze(a), n = rn(a, r <= i.toExpNeg || r >= i.toExpPos)) : (Jt(e, 1, ca), t === void 0 ? t = i.rounding : Jt(t, 0, 8), a = Pe(new i(a), e, t), r = ze(a), n = rn(a, e <= r || r <= i.toExpNeg, e)), n;
};
...
var ur = /* @__PURE__ */ (function() {
  ...
  function r(n, a, i) {
    for (var o = 0; i--; )
      n[i] -= o, o = n[i] < a[i] ? 1 : 0, n[i] = o * Je + n[i] - a[i];
  ...
  return function(n, a, i, o) {
    ...
    if (g = g / $e + 2 | 0, c = 0, A == 1)
      for (l = 0, $ = $[0], g++; (c < m || l) && g--; c++)
        x = l * Je + (T[c] || 0), y[c] = x / $ | 0, l = x % $ | 0;
    else {
      for (l = Je / ($[0] + 1) | 0, l > 1 && ($ = e($, l), T = e(T, l), A = $.length, m = T.length), O = A, h = T.slice(0, A), v = h.length; v < A; ) h[v++] = 0;
      _ = $.slice(), _.unshift(0), w = $[0], $[1] >= Je / 2 && ++w;
      do
        l = 0, s = t($, h, A, v), s < 0 ? (b = h[0], A != v && (b = b * Je + (h[1] || 0)), l = b / w | 0, l > 1 ? (l >= Je && (l = Je - 1), f = e($, l), d = f.length, v = h.length, s = t(f, h, d, v), s == 1 && (l--, r(f, A < d ? _ : $, d))) : (l == 0 && (s = l = 1), f = $.slice()), d = f.length, d < v && f.unshift(0), r(h, f, v), s == -1 && (v = h.length, s = t($, h, A, v), s < 1 && (l++, r(h, A < v ? _ : $, v))), v = h.length) : s === 0 && (l++, h = [0]), y[c++] = l, s && h[0] ? h[v++] = T[O] || 0 : (h = [T[O]], v = 1);
...
function IA(e, t) {
  ...
  if (ze(e) > 16) throw Error(wv + ze(e));
...
function li(e, t) {
  ...
  if (c += d, h.precision = c, r = Vt(y), n = r.charAt(0), i = ze(p), Math.abs(i) < 15e14) {
...
function Pe(e, t, r) {
  ...
  (n > 0 ? a > 0 ? c / Br(10, o - a) : 0 : f[l - 1]) % 10 & 1 || r == (e.s < 0 ? 8 : 7))), t < 1 || !f[0])
    return u ? (i = ze(e), f.length = 1, t = t - i - 1, f[0] = Br(10, ($e - t % $e) % $e), e.e = la(-t / $e) || 0) : (f.length = 1, f[0] = e.e = e.s = 0), e;
...
function rn(e, t, r) {
  var n, a = ze(e), i = Vt(e.d), o = i.length;
...
function Re(e, t, r) {
  return le(e) || le(t) ? r : Ye(t) ? xt(e, t, r) : ue(t) ? t(e) : r;
}
function Ba(e, t, r, n) {
...
var RL = function(t) {
  ...
  return i === "insideLeft" ? Ue({
    ...
    textAnchor: b,
    verticalAnchor: p
  }, A) : ia(i) && (G(i.x) || zr(i.x)) && (G(i.y) || zr(i.y)) ? Ue({
    x: s + st(i.x, c),
    y: u + st(i.y, l),
    textAnchor: "end",
    verticalAnchor: "end"
...
function Ge(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = $L(e, PL), a = Ue({
    offset: r
...
var i_ = function(t) {
  ...
  return t ? t === !0 ? /* @__PURE__ */ C.createElement(Ge, {
    ...
    viewBox: r,
    value: t
  }) : /* @__PURE__ */ Rt(t) ? t.type === Ge ? /* @__PURE__ */ He(t, {
    key: "label-implicit",
    viewBox: r
    ...
    content: t,
    viewBox: r
  }) : ia(t) ? /* @__PURE__ */ C.createElement(Ge, yi({
    viewBox: r
  }, t, {
    key: "label-implicit"
  })) : null : null;
  ...
  if (!t || !t.children && n && !t.label)
    return null;
  var a = t.children, i = i_(t), o = wt(a, Ge).map(function(u, c) {
...
function Et(e) {
  ...
  return !a || !a.length ? null : /* @__PURE__ */ C.createElement(pe, {
    ...
    return /* @__PURE__ */ C.createElement(Ge, Zo({}, ie(l, !0), c, p, {
...
const zB = (function(e, t, r, n, a) {
  var i = mB(e, t), o = i.reduce(function(v, b) {
    ...
    c || (c = b);
    var g = b - c, x = g / r.dt;
    s = FB(r, s, x), a(tt(tt(tt({}, e), t), d())), c = b, p() || (u = requestAnimationFrame(f));
  }, h = function(b) {
    l || (l = b);
    var g = (b - l) / n, x = Fa(function(m, w) {
      return es.apply(void 0, r1(w).concat([r(g)]));
    }, o);
    if (a(tt(tt(tt({}, e), t), x)), g < 1)
  ...
  return JB(r, [{
    ...
    value: function() {
      ...
      if (!s || c === 0 || o <= 0)
        return i;
      var f = function(p) {
        var y = p.props, h = y.style, v = h === void 0 ? {} : h, b = y.className, g = /* @__PURE__ */ He(p, It(It({}, u), {}, {
          style: It(It({}, v), l),
          className: b
        }));
        return g;
...
var vr = /* @__PURE__ */ (function(e) {
  ...
  return B5(t, e), N5(t, [{
    ...
    value: function() {
      ...
      }, this.renderSectors(), u && this.renderLabels(o), Ge.renderCallByParent(this.props, null, !1), (!p || y) && Et.renderCallByParent(this.props, o, !1));
    }
  }], [{
...
Sr(Ir, "getComposedData", function(e) {
  ...
  if (!p)
    return null;
  var y = t.layout, h = r.type.defaultProps, v = h !== void 0 ? Fe(Fe({}, h), r.props) : r.props, b = v.dataKey, g = v.children, x = v.minPointSize, O = y === "horizontal" ? o : i, m = c ? O.scale.domain() : null, w = lL({
    numericAxis: O
...
function v4(e) {
  ...
  var p = Tv({
    x: l.scale,
    y: f.scale
  }), y = Ye(t), h = Ye(r), v = n && n.length === 2, b = h4(p, y, h, v, d, e.position, l.orientation, f.orientation, e);
  if (!b)
    return null;
  ...
  }, p4(o, D), Ge.renderCallByParent(e, RF({
    x1: O,
    y1: m,
    x2: A,
    y2: _
...
function F4(e, t, r, n, a) {
  for (var i = (n || []).slice(), o = i.length, s = t.start, u = t.end, c = function(d) {
    ...
    b && (u = p.tickCoord - e * (h() / 2 + a), i[d] = nt(nt({}, p), {}, {
      isShow: !0
    }));
  }, l = o - 1; l >= 0; l--)
    c(l);
...
function z4(e, t, r, n, a, i) {
  ...
  if (i) {
    ...
    p && (c = l.tickCoord - e * (f / 2 + a), o[s - 1] = nt(nt({}, l), {}, {
      isShow: !0
    }));
  }
  for (var y = i ? s - 1 : s, h = function(g) {
    ...
    A && (u = x.tickCoord + e * (m() / 2 + a), o[g] = nt(nt({}, x), {}, {
      isShow: !0
    }));
  }, v = 0; v < y; v++)
    h(v);
...
var f8 = function(t, r) {
  ...
  return XA(Dv(at(at(at({}, fa.defaultProps), n), {}, {
    ticks: or(n, !0),
    viewBox: {
      x: 0,
      y: 0,
...
function Gi(e) {
  var t, r, n, a, i, o, s = jv(), u = Mv(), c = QF(), l = at(at({}, e), {}, {
      ...
      return /* @__PURE__ */ C.createElement(Ft, {
        ...
        if (g) {
          var w = g.length / s.length, A = s.map(function($, M) {
            ...
            if (g[j]) {
              var I = g[j], k = Ve(I.x, $.x), R = Ve(I.y, $.y);
              return vt(vt({}, $), {}, {
                x: k(m),
                y: R(m)
              });
      ...
      return /* @__PURE__ */ C.createElement(Ft, {
        ...
        if (h) {
          var x = h.length / s.length, O = s.map(function(_, P) {
            ...
            if (h[D]) {
              var T = h[D], $ = Ve(T.x, _.x), M = Ve(T.y, _.y);
              return br(br({}, _), {}, {
                x: $(g),
                y: M(g)
              });
          ...
          if (G(u) && typeof u == "number") {
            ...
            m = u.map(function(_, P) {
              var D = Math.floor(P * x);
              if (v[D]) {
                var T = v[D], $ = Ve(T.x, _.x), M = Ve(T.y, _.y);
                return br(br({}, _), {}, {
                  x: $(g),
                  y: M(g)
                });
...
function b6(e) {
  ...
  return /* @__PURE__ */ Rt(p) ? /* @__PURE__ */ He(p, w) : /* @__PURE__ */ iO(h, w);
}
...
var ah = function(t, r, n, a) {
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, s = o === void 0 ? ["axis"] : o, u = t.axisComponents, c = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, d = function(b, g) {
    ...
    return x.forEach(function(z, N) {
      var B = cu(b.data, {
        ...
        dataStartIndex: A,
        dataEndIndex: _
      }), q = z.type.defaultProps !== void 0 ? W(W({}, z.type.defaultProps), z.props) : z.props, H = q.dataKey, X = q.maxBarSize, te = q["".concat(I, "Id")], ne = q["".concat(k, "Id")], ee = {}, J = u.reduce(function(ye, Be) {
        var tr, dn, pn = g["".concat(Be.axisType, "Map")], Qi = q["".concat(Be.axisType, "Id")];
        pn && pn[Qi] || Be.axisType === "zAxis" || (process.env.NODE_ENV !== "production" ? ft(!1, "Specifying a(n) ".concat(Be.axisType, "Id requires a corresponding ").concat(
          Be.axisType,
          "Id on the targeted graphical component "
        ).concat((tr = z == null || (dn = z.type) === null || dn === void 0 ? void 0 : dn.displayName) !== null && tr !== void 0 ? tr : "")) : ft());
        var ga = pn[Qi];
        return W(W({}, ye), {}, se(se({}, Be.axisType, ga), "".concat(Be.axisType, "Ticks"), or(ga)));
    ...
    function b(g) {
      ...
      return P6(this, b), m = C6(this, b, [g]), se(m, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), se(m, "accessibilityManager", new d6()), se(m, "handleLegendBBoxUpdate", function(w) {
        ...
        function V(Be) {
          return typeof M.dataKey == "function" ? M.dataKey(Be.payload) : null;
        }
        if (ee)
          if (j >= 0) {
            var Z, E;
  ...
  se(y, "displayName", r), se(y, "defaultProps", W({
    ...
    var x;
    return /* @__PURE__ */ Rt(v) ? x = /* @__PURE__ */ He(v, b) : ue(v) ? x = v(b) : x = /* @__PURE__ */ C.createElement(Vi, b), /* @__PURE__ */ C.createElement(pe, {
...
}), J6 = { light: "", dark: ".dark" }, bP = fe.createContext(null);
function xP() {
...
const Q6 = ({
  ...
  const s = fe.useId(), u = `chart-${e || s.replace(/:/g, "")}`, c = fe.useRef(null), [l, f] = he(), d = Ke(() => new ResizeObserver(
  ...
  }, [d, o, c]), /* @__PURE__ */ S(bP.Provider, { value: { config: a }, children: /* @__PURE__ */ K(
    "div",
    {
      ...
      className: Q(
        ...
        n ? Z6({ aspect: n }) : "aspect-auto h-full",
        t
      ),
      ...i,
      children: [
        /* @__PURE__ */ S(e9, { id: u, config: a }),
        /* @__PURE__ */ S(
          LI,
          {
            height: l,
...
`))
  ...
  ({
    ...
    const { config: h } = xP(), v = fe.useMemo(() => {
      ...
      return s ? /* @__PURE__ */ S("div", { className: Q("font-medium", u), children: s(m, t) }) : m ? /* @__PURE__ */ S("div", { className: Q("font-medium", u), children: m }) : null;
    }, [
      o,
      s,
      t,
    ...
    return /* @__PURE__ */ K(
      "div",
      {
        ...
        children: [
          b ? null : v,
          /* @__PURE__ */ S("div", { className: "grid gap-2", children: t.map((g, x) => {
            ...
            return /* @__PURE__ */ S(
              "div",
              {
                ...
                children: c && g?.value !== void 0 && g.name ? c(g.value, g.name, g, x, g.payload) : /* @__PURE__ */ K(dt, { children: [
                  m?.icon ? /* @__PURE__ */ S(m.icon, {}) : !i && /* @__PURE__ */ S(
                    "div",
                    {
                      className: Q(
                  ...
                  /* @__PURE__ */ K(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ K("div", { className: "grid gap-2", children: [
                          b ? v : null,
                          /* @__PURE__ */ S("span", { className: "pr-2 text-f1-foreground", children: m?.label || g.name })
                        ] }),
                        g.value && /* @__PURE__ */ S("span", { className: "font-mono font-medium tabular-nums text-f1-foreground", children: l ? l(String(g.value)) : g.value.toLocaleString() })
                      ]
                    }
                  )
                ] })
  ...
  ({
    ...
    return r?.length ? /* @__PURE__ */ S(
      "div",
      {
        ...
        style: { marginLeft: o },
        children: r.map((c) => {
          const l = `${a || c.dataKey || "value"}`, f = ih(
            u,
            c,
            l,
            i
          ...
          return /* @__PURE__ */ K(
            "div",
            {
              ...
              children: [
                f?.icon && !t ? /* @__PURE__ */ S(f.icon, {}) : f && /* @__PURE__ */ S(
                  "div",
                  {
                ...
                /* @__PURE__ */ S("span", { className: "text-f1-foreground", children: f?.label })
              ]
            },
            JSON.stringify(c)
          );
...
const wP = zt({
  ...
  return /* @__PURE__ */ S(wP.Provider, { value: { enable: a, disable: i, toggle: o, enabled: r }, children: t });
}, t9 = () => {
  const e = pt(wP);
  if (!e)
...
const r9 = ({
  ...
  const i = e === 0, o = e === t - 1;
  return /* @__PURE__ */ S(Pr, { ...a, textAnchor: i ? "start" : o ? "end" : "middle", children: n?.(r.value, r.index) ?? r.value });
}, n9 = ({
  data: e,
  dataConfig: t,
  xAxis: r,
  ...
  const { enabled: l } = t9(), f = Object.keys(t), d = r2(12), p = qv(e), y = Math.max(
    ...p.flatMap(
      (x) => f.map(
        (O) => Zi(
          n?.tickFormatter ? n.tickFormatter(`${x[O]}`) : `${x[O]}`
        )
      )
    )
  ), h = n?.width ?? y + 20, v = !n?.hide, b = !r?.hide, g = !a || !l;
  return /* @__PURE__ */ S(da, { config: t, ref: c, aspect: s, children: /* @__PURE__ */ K(
    X6,
    {
      ...
      children: [
        /* @__PURE__ */ K("defs", { children: [
          /* @__PURE__ */ K(
            "linearGradient",
            {
              ...
              y2: "0",
              children: [
                (i === "l" || i === "lr") && /* @__PURE__ */ K(dt, { children: [
                  /* @__PURE__ */ S("stop", { offset: "0%", stopColor: "black", stopOpacity: "0" }),
                  /* @__PURE__ */ S("stop", { offset: "1%", stopColor: "white", stopOpacity: "0.1" }),
                  /* @__PURE__ */ S("stop", { offset: "7%", stopColor: "white", stopOpacity: "1" })
                ] }),
                (i === "r" || i === "lr") && /* @__PURE__ */ K(dt, { children: [
                  /* @__PURE__ */ S("stop", { offset: "93%", stopColor: "white", stopOpacity: "1" }),
                  /* @__PURE__ */ S("stop", { offset: "99%", stopColor: "white", stopOpacity: "0.1" }),
                  /* @__PURE__ */ S("stop", { offset: "100%", stopColor: "black", stopOpacity: "0" })
                ] }),
                !i && /* @__PURE__ */ K(dt, { children: [
                  /* @__PURE__ */ S("stop", { offset: "0%", stopColor: "white", stopOpacity: "1" }),
                  /* @__PURE__ */ S("stop", { offset: "100%", stopColor: "white", stopOpacity: "1" })
                ] })
              ]
            }
          ),
        ...
        Object.keys(t).length > 1 && /* @__PURE__ */ S(
          Nv,
          {
            className: "flex justify-start",
            content: /* @__PURE__ */ S(fu, {})
          }
        )
      ]
    }
  ...
  const y = Object.keys(e), h = qv(t).map((b, g, x) => f && y.length === 1 && !e[y[0]]?.color ? {
    ...
    ...h.flatMap(
      (b) => y.map(
        (g) => Zi(
          n?.tickFormatter ? n.tickFormatter(`${b[g]}`) : `${b[g]}`
        )
      )
    )
  );
  return /* @__PURE__ */ S(da, { config: e, ref: p, aspect: u, children: /* @__PURE__ */ K(
    gP,
    {
      accessibilityLayer: !0,
      data: h,
      ...
      children: [
        !o && /* @__PURE__ */ S(
          ...
          {
            ...pu(),
            content: /* @__PURE__ */ S(pa, { yAxisFormatter: n.tickFormatter })
          }
        ),
        !s && /* @__PURE__ */ S(Gi, { ...du() }),
        /* @__PURE__ */ S(
        ...
        c && /* @__PURE__ */ S(
          Nv,
          {
            content: /* @__PURE__ */ S(fu, { nameKey: "label" }),
            align: "center",
            verticalAlign: "bottom",
            layout: "vertical",
  ...
  return /* @__PURE__ */ K(mh, { children: [
    /* @__PURE__ */ S("div", { className: "w-full", ref: n, children: /* @__PURE__ */ S("div", { className: "flex h-2 gap-1 overflow-hidden", children: e.map((i, o) => {
      const s = i.value / a * 100, u = i.color ? Ct(i.color) : Bt(o), c = (l) => {
        const f = l / a * 100;
        return f % 1 === 0 ? f.toFixed(0) : f.toFixed(1);
      };
      return s === 0 ? null : /* @__PURE__ */ K(gh, { children: [
        /* @__PURE__ */ S(
          bh,
          {
        ...
        !r && /* @__PURE__ */ K(xh, { className: "flex items-center gap-1 text-sm", children: [
          /* @__PURE__ */ S(
            "div",
            {
          ...
          /* @__PURE__ */ S("span", { className: "pl-0.5 pr-2 text-f1-foreground-inverse-secondary dark:text-f1-foreground-secondary", children: i.name }),
          /* @__PURE__ */ K("span", { className: "font-mono font-medium tabular-nums text-f1-foreground-inverse dark:text-f1-foreground", children: [
            i.value,
            " (",
            c(i.value),
            "%)"
          ...
          return /* @__PURE__ */ K(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ S("span", { className: "text-f1-foreground", children: i.name })
              ]
            },
            i.name
          );
  ...
  const c = Object.keys(t), l = qv(e), f = Math.max(
    ...l.flatMap(
      (d) => c.map(
        (p) => Zi(
  ...
  return /* @__PURE__ */ S(da, { config: t, ref: u, aspect: i, children: /* @__PURE__ */ K(
    G6,
    {
      accessibilityLayer: !0,
      data: l,
  ...
  return u === 0 && o.push({
    ...
    da,
    {
      ...
      "data-chromatic": "ignore",
      style: { height: 380 },
      children: /* @__PURE__ */ K(Y6, { accessibilityLayer: !0, margin: { left: 0, right: 0 }, children: [
        u !== 0 && /* @__PURE__ */ S(
          Xi,
          {
            isAnimationActive: !1,
            content: /* @__PURE__ */ S(pa, { yAxisFormatter: a })
          }
        ),
        /* @__PURE__ */ K(
          vr,
        ...
        /* @__PURE__ */ S(
          Nv,
          {
            content: /* @__PURE__ */ S(fu, { nameKey: "label", hiddenKey: "-" }),
            align: "center",
            verticalAlign: "bottom",
            layout: "vertical",
            className: "flex-row items-start gap-4 pr-3 pt-2"
...
var PP = OP, h9 = AP;
const TP = fe.forwardRef(({ className: e, value: t, ...r }, n) => /* @__PURE__ */ S(
  PP,
  {
    ref: n,
    value: t,
...
const y9 = (e) => {
  ...
  const f = Object.keys(e), d = v9(t), p = Math.max(
    ...d.map((b) => Zi(`${b.x}`))
  ), y = f.reduce(
    (b, g) => (b[g] = t.reduce(
      (x, O) => x + O.values[g],
  ...
  return /* @__PURE__ */ S(da, { config: e, ref: l, aspect: i, children: /* @__PURE__ */ K(
    gP,
    {
      layout: "vertical",
      accessibilityLayer: !0,
      ...
      children: [
        ...
        f.map((b, g) => /* @__PURE__ */ S(dt, { children: /* @__PURE__ */ S(
          Ir,
          {
            isAnimationActive: !1,
            layout: "vertical",
  ...
  return /* @__PURE__ */ K("g", { transform: `translate(${l},${f + 4})`, children: [
    i && /* @__PURE__ */ S(
      "text",
      {
        x: 0,
...
typeof e == "object" && "value_x100" in e && (e.value_x100 === void 0 || e.value_x100 === null), sh = (e) => "value" in e ? e.value : e.value_x100 !== void 0 && e.value_x100 !== null ? e.value_x100 / 100 : void 0, $w = (e, t = {}) => {
  ...
  ({ percentage: e, amount: t, invertStatus: r, info: n, hint: a, nullText: i }, o) => {
    const s = w9(), u = s(t, {
      formatterOptions: {
        decimalPlaces: 2
      }
    ...
    if (oh(f))
      ...
      d = [g, x].filter(Boolean).join(" · "), y = `${h} balance`, p = h === "neutral" ? null : /* @__PURE__ */ S(
        ct,
        {
          icon: O9[b],
          size: "sm",
...
const A9 = qe(EP), zv = fe.forwardRef(({ className: e, href: t, onClick: r, disabled: n, children: a, ...i }, o) => {
  const { actions: s } = Tr();
  return /* @__PURE__ */ K(
    "div",
    {
      ...
      className: Q(
        ...
        (t || r) && !n && "cursor-pointer transition-all duration-200 hover:border-f1-border-hover hover:shadow-md",
        e
      ),
      ...i,
      onClick: () => {
      ...
      children: [
        t && !n && /* @__PURE__ */ S(ph, { href: t, className: "absolute inset-0 block", tabIndex: 0, children: /* @__PURE__ */ S("span", { className: "sr-only", children: s.view }) }),
        a
      ]
    }
  );
...
zv.displayName = "Card";
const Wv = fe.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ S(
  "div",
  {
    ref: r,
...
const Uv = fe.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ S(
  "h3",
  {
    ref: r,
...
const Hv = fe.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ S(
  "h3",
  {
    ref: r,
    className: Q(
...
const _9 = fe.forwardRef(({ className: e, content: t }, r) => /* @__PURE__ */ S(
  "div",
  {
    ref: r,
    className: Q("-ml-1 flex h-6 w-6 items-center justify-center", e),
    children: /* @__PURE__ */ S(mh, { children: /* @__PURE__ */ K(gh, { children: [
      /* @__PURE__ */ S(
        bh,
        {
          className: "h-5 w-5 cursor-help text-f1-foreground-secondary",
          "aria-label": t,
          children: /* @__PURE__ */ S(ct, { icon: XT, size: "md" })
        }
      ),
      /* @__PURE__ */ S(xh, { children: /* @__PURE__ */ S("p", { children: t }) })
    ] }) })
  }
));
_9.displayName = "CardInfo";
const P9 = fe.forwardRef(({ className: e, title: t, icon: r = uO, ...n }, a) => /* @__PURE__ */ S(
  ph,
  {
    ref: a,
    className: Q(
      ...
      //layout
      "rounded-sm border border-solid border-f1-border bg-f1-background-inverse-secondary",
      //appearance
    ...
    "aria-label": t,
    ...n,
    children: /* @__PURE__ */ S(ct, { size: "sm", icon: r, className: "text-f1-icon-bold" })
  }
));
P9.displayName = "CardLink";
const Kv = fe.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ S(
  "div",
  {
    ref: r,
...
const Vv = fe.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ S("div", { ref: r, className: Q("flex items-center", e), ...t }));
...
function T9({
  ...
  return /* @__PURE__ */ K(
    Vv,
    {
      ...
      children: [
        t && /* @__PURE__ */ S("div", { className: "flex w-full flex-col gap-md sm:flex-row [&_a]:justify-center sm:[&_a]:justify-start [&_button]:w-full sm:[&_button]:w-fit [&_div]:w-full [&_div]:justify-center sm:[&_div]:w-fit", children: Array.isArray(t) ? t.map((o, s) => /* @__PURE__ */ S(
          Yt,
          {
            label: o.label,
            icon: o.icon,
        ...
        e && /* @__PURE__ */ S("div", { className: "w-full sm:w-fit [&_button]:w-full sm:[&_button]:w-fit [&_div]:w-full [&_div]:justify-center", children: /* @__PURE__ */ S(
          Yt,
          {
            label: e.label,
            icon: e.icon,
...
const E9 = ({
  avatar: e,
  compact: t = !1
}) => e.type === "emoji" ? /* @__PURE__ */ S(JT, { emoji: e.emoji, size: t ? "sm" : "lg" }) : e.type === "file" ? /* @__PURE__ */ S(xO, { file: e.file, size: t ? "sm" : "lg" }) : e.type === "icon" ? /* @__PURE__ */ S(QT, { icon: e.icon, size: t ? "sm" : "lg" }) : /* @__PURE__ */ S(an, { avatar: e, size: t ? "sm" : "lg" });
function C9({
  avatar: e,
  overlay: t = !1,
  compact: r = !1
  ...
  return /* @__PURE__ */ S(
    "div",
    {
      className: Q(
        ...
        t && !r && "absolute -top-9 left-0 rounded-md ring-[3px] ring-f1-background",
        t && n && "rounded-full",
        r && "mb-0"
      ),
      "data-testid": "card-avatar",
      children: /* @__PURE__ */ S(E9, { avatar: e, compact: r })
    }
  );
}
const j9 = {
...
const jP = qe(CP), M9 = (e) => /* @__PURE__ */ S("div", { "data-cell-type": "alert-tag", children: /* @__PURE__ */ S(jP, { level: e.level, text: e.label }) }), Ut = {
  text: "pt-[2px]",
  avatar: "pt-[2px]",
  avatarList: "pt-[3px]"
};
...
const $P = (e, t) => {
  ...
  return /* @__PURE__ */ K(
    "div",
    {
      ...
      children: [
        a.unitsPosition === "left" && a.units && /* @__PURE__ */ S(Dw, { units: a.units }),
        a.decimalPlaces !== void 0 ? a.number?.toFixed(a.decimalPlaces) : a.number?.toString() ?? "",
        a.unitsPosition === "right" && a.units && /* @__PURE__ */ S(Dw, { units: a.units })
      ]
    }
  );
}, Dw = ({ units: e }) => /* @__PURE__ */ S("span", { children: e.toString() }), I9 = (e, t) => {
  const r = {
    // if args is an object, use the amount from args, otherwise use the value
  ...
  return /* @__PURE__ */ S(
    "div",
    {
      className: Q(
        ...
        t.visualization === "table" && Ut.avatarList
      ),
      children: /* @__PURE__ */ S(
        e2,
        {
  ...
  "div",
  {
    className: Q(
      ...
      t.visualization === "table" && Ut.avatar
    ),
    children: [
      /* @__PURE__ */ S(
        an,
      ...
      /* @__PURE__ */ S("span", { className: "text-f1-foreground", children: e.name.toString() })
    ]
  }
), N9 = (e, t) => {
  const r = e.label ?? t.i18n.countries[e.code] ?? e.code;
  return /* @__PURE__ */ K("div", { "data-cell-type": "country", className: "flex items-center gap-2", children: [
    /* @__PURE__ */ S(eE, { size: "sm", flag: e.code, "aria-label": r }),
    " ",
    /* @__PURE__ */ S(on, { className: "min-w-0 flex-1 text-f1-foreground", tag: "span", children: r })
  ] });
}, R9 = (e, t) => {
...
const DP = qe(IP), q9 = (e) => /* @__PURE__ */ S("div", { "data-cell-type": "dot-tag", children: /* @__PURE__ */ S(DP, { text: e.label, color: e.color }) }), B9 = (e) => /* @__PURE__ */ K(
  "div",
  {
    className: "text-f1-text-default text-md flex items-center gap-2 font-medium",
    "data-cell-type": "file",
    children: [
      /* @__PURE__ */ S(xO, { file: e }),
      " ",
  ...
  tooltip: e,
  children: t
}) => e ? /* @__PURE__ */ S(mh, { delayDuration: 100, disableHoverableContent: !0, children: /* @__PURE__ */ K(gh, { children: [
  /* @__PURE__ */ S(bh, { asChild: !0, className: "pointer-events-auto", children: t }),
  /* @__PURE__ */ S(xh, { className: "pointer-events-none max-w-xs", children: /* @__PURE__ */ S("p", { className: "font-semibold", children: e }) })
] }) }) : /* @__PURE__ */ S(dt, { children: t }), NP = (e, t) => /* @__PURE__ */ S(
  "div",
  {
    className: Q(
      "flex items-center gap-2",
    ...
    children: /* @__PURE__ */ S(kP, { tooltip: e.tooltip, children: /* @__PURE__ */ K("div", { className: "inline-flex items-center gap-2", children: [
      /* @__PURE__ */ S(
        ct,
        {
          icon: e.icon,
      ...
      e.hideLabel ? /* @__PURE__ */ S("span", { className: "sr-only", children: e.label }) : /* @__PURE__ */ S("span", { className: "text-f1-foreground", children: e.label })
    ] }) })
  }
), F9 = (e) => /* @__PURE__ */ S(NP, { icon: tE, label: e.name }), z9 = (e) => typeof e == "object" && e !== null && "lines" in e ? e.lines : void 0, W9 = (e) => (typeof e == "object" && e !== null && "full" in e && e.full) ?? !1, U9 = (e, t) => {
  ...
  return /* @__PURE__ */ K("div", { className: "flex items-center gap-2", "data-cell-type": "percentage", children: [
    /* @__PURE__ */ K(
      "svg",
      {
        viewBox: `0 0 ${Td} ${Td}`,
    ...
    /* @__PURE__ */ S("span", { className: "text-f1-foreground", children: c ? e.label : `${r}%` })
  ] });
}, V9 = (e, t) => {
      ...
      children: [
        ...
        /* @__PURE__ */ S(
          on,
          {
            className: Q(
              "min-w-0 flex-1",
              e.deactivated ? "text-f1-foreground/[0.61]" : "text-f1-foreground"
            ),
            tag: "span",
            children: r
          }
  ...
  return /* @__PURE__ */ K(
    "div",
    {
      ...
      "data-cell-type": "progressBar",
      children: [
        /* @__PURE__ */ S("div", { className: "min-w-16 flex-grow", children: /* @__PURE__ */ S(
          TP,
          {
            color: c,
            value: l,
        ...
        !s && /* @__PURE__ */ S("div", { className: "flex-shrink-0 text-sm font-medium text-f1-foreground", children: o })
      ]
    }
  );
}, RP = We(
  ({ text: e, additionalAccessibleText: t, variant: r }, n) => (Ts(
    e,
    { disallowEmpty: !0 },
...
const LP = qe(RP), Y9 = (e) => /* @__PURE__ */ S("div", { "data-cell-type": "status", children: /* @__PURE__ */ S(LP, { variant: e.status, text: e.label }) }), X9 = {
  synced: {
    icon: Ps,
  ...
  const r = X9[e.status], n = t.i18n.syncStatus[e.status], a = e.tooltip ?? n, i = /* @__PURE__ */ S(ct, { icon: r.icon, "aria-label": a });
  return /* @__PURE__ */ S(
    "div",
    {
      className: Q(
      ...
      children: /* @__PURE__ */ S(kP, { tooltip: a, children: /* @__PURE__ */ S("div", { className: Q("inline-flex items-center", r.colorClass), children: r.animated ? /* @__PURE__ */ S(
        Kt.div,
        {
...
}, J9 = (e) => /* @__PURE__ */ S("div", { "data-cell-type": "tag", children: /* @__PURE__ */ S(Oh, { text: e.label, icon: e.icon }) }), hu = We(
  ({ avatar: e, text: t }, r) => (Ts(
    t,
    { disallowEmpty: !0 },
    ...
    Ni,
    {
      ...
      left: /* @__PURE__ */ S(an, { avatar: e, size: "xs" }),
      text: t,
...
const Q9 = qe(qP), BP = We(
  ({ src: e, name: t }, r) => /* @__PURE__ */ S(
    hu,
    {
      ref: r,
      avatar: {
...
const tz = qe(FP), rz = (e) => {
  const { type: t } = e;
  if (t === "dot") return /* @__PURE__ */ S(DP, { ...e });
  if (t === "person") return /* @__PURE__ */ S(ez, { ...e });
  if (t === "team") return /* @__PURE__ */ S(tz, { ...e });
  if (t === "company") return /* @__PURE__ */ S(Q9, { ...e });
  if (t === "alert") return /* @__PURE__ */ S(jP, { ...e });
  if (t === "status") return /* @__PURE__ */ S(LP, { ...e });
  if (t === "balance") return /* @__PURE__ */ S(A9, { ...e });
  if (t === "raw") return /* @__PURE__ */ S(Oh, { ...e });
}, uh = ({ tag: e }) => {
  const t = rz(e);
  return t || "Invalid tag type";
}, zP = ({ count: e, list: t }) => {
  const r = /* @__PURE__ */ S(Oh, { text: `+${e}` });
  return t?.length ? /* @__PURE__ */ K(pO, { children: [
    /* @__PURE__ */ S(hO, { children: /* @__PURE__ */ S("span", { className: "cursor-pointer", children: r }) }),
    /* @__PURE__ */ S(vO, { side: "top", children: /* @__PURE__ */ K(vh, { className: "[*[data-state=visible]_div]:bg-f1-background dark flex max-h-[220px] flex-col", children: [
      t.map((n, a) => /* @__PURE__ */ S(
        "div",
        {
          className: "flex w-[172px] min-w-0 items-center gap-1.5 px-2 py-1 [&:first-child]:pt-2 [&:last-child]:pb-2",
          children: n.description ? /* @__PURE__ */ S(yh, { label: n.description, children: /* @__PURE__ */ S("div", { children: /* @__PURE__ */ S(uh, { tag: n }) }) }) : /* @__PURE__ */ S(uh, { tag: n })
        },
        a
      )),
      /* @__PURE__ */ S(
...
const WP = ({
  ...
  return /* @__PURE__ */ S(
    mO,
    {
      items: a,
      max: r,
      renderListItem: (i) => /* @__PURE__ */ S(uh, { tag: i }),
      renderDropdownItem: () => null,
      forceShowingOverflowIndicator: n !== void 0,
      renderOverflowIndicator: (i) => /* @__PURE__ */ S(
        zP,
        {
          count: (n ?? 0) + i,
...
const nz = qe(WP), az = (e) => /* @__PURE__ */ S(nz, { type: e.type, tags: e.tags, max: e.max }), iz = (e, t) => /* @__PURE__ */ K(
  "div",
  {
    className: Q(
      "flex items-center gap-2",
  ...
  status: et.status,
  tag: et.tag,
  avatarList: et.avatarList,
  tagList: et.tagList,
  alertTag: et.alertTag,
  dotTag: et.dotTag,
  file: et.file,
  folder: et.folder,
  progressBar: et.progressBar
};
function cz({ metadata: e }) {
  const { type: t, value: r } = e.property, n = uz[t];
  if (!n)
    return /* @__PURE__ */ K("div", { className: "flex h-8 items-center gap-1.5", children: [
      "icon" in e && /* @__PURE__ */ S(ct, { icon: e.icon, color: "default", size: "md" }),
  ...
  const a = n;
  return /* @__PURE__ */ K("div", { className: "flex h-8 items-center gap-1.5", children: [
    "icon" in e && /* @__PURE__ */ S("div", { className: "pointer-events-auto flex items-center", children: /* @__PURE__ */ S(yh, { label: e.tooltip, children: /* @__PURE__ */ S(ct, { icon: e.icon, color: "default", size: "md" }) }) }),
  ...
  return !s && !t ? null : /* @__PURE__ */ K(
    "div",
    {
      className: Q(
        ...
        (u || r) && "delay-0 sm:opacity-100",
        i && "absolute right-2 top-2 rounded-sm bg-f1-background/60 p-1 shadow-md backdrop-blur-sm"
      ),
      children: [
        s && /* @__PURE__ */ S("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ S(QO, { items: e, open: u, onOpenChange: c, children: /* @__PURE__ */ S(
          _r,
          {
        ...
        t && /* @__PURE__ */ S("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ S(
          iE,
          {
            title: a,
            checked: r,
...
const pz = We(
  function({
    ...
    avatar: r,
    image: n,
    imageFit: a = "fit-width",
    imageSize: i = "sm",
    blurredBackground: o = !0,
    title: s,
    description: u,
    metadata: c,
    children: l,
    ...
    onSelect: b,
    onClick: g,
    forceVerticalMetadata: x = !1,
    fullHeight: O = !1,
    disableOverlayLink: m = !1
  }, w) {
    const A = Me(null), _ = (P) => {
    ...
    return /* @__PURE__ */ K(
      zv,
      {
        className: Q(
          ...
          t && "p-3",
          O && "h-full",
          (h || y && y.length > 0) && !v && "hover:border-f1-border",
          f && "focus-within:border-f1-border-hover focus-within:shadow-md hover:border-f1-border-hover hover:shadow-md",
          v && "border-f1-border-selected bg-f1-background-selected-secondary"
        ),
        onClick: g,
        "data-testid": "card",
        ref: w,
        children: [
          ...
          n && /* @__PURE__ */ K(
            "div",
            {
              className: Q(
                ...
                lz[i],
                t && "-mx-2 -mt-2 mb-3",
                a === "fit-height" && "flex items-center justify-center overflow-hidden",
                a === "fit-width" && "flex items-center justify-center overflow-hidden",
                a !== "fit-width" && a !== "fit-height" && "overflow-hidden"
              ),
              children: [
                o && (a === "contain" || a === "fit-width" || a === "fit-height" || a === "scale-down") && /* @__PURE__ */ S(
                  "div",
                  {
          ...
          /* @__PURE__ */ K("div", { className: "flex grow flex-col gap-2", children: [
            /* @__PURE__ */ K("div", { className: "flex flex-row items-start justify-between gap-1", children: [
              /* @__PURE__ */ K(
                Wv,
                {
                  ...m ? {} : {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ K("div", { className: Q("flex flex-col gap-0"), children: [
                      /* @__PURE__ */ S(
                        Uv,
                        {
                          className: Q(
                            "text-lg font-semibold text-f1-foreground",
                            t && "line-clamp-1 text-base"
                          ),
                          children: s
                        }
                      ),
                      u && /* @__PURE__ */ S(
                        Hv,
                        {
                          ...
                          children: /* @__PURE__ */ S(on, { lines: t ? 2 : 3, children: u })
                        }
                      )
                    ] })
                  ]
            ...
            (c || l) && /* @__PURE__ */ K(Kv, { className: "pointer-events-none", children: [
              c && /* @__PURE__ */ S(
                "div",
                {
                  className: Q(
                    ...
                    t && "gap-x-3 gap-y-0",
                    x && "flex-col gap-y-0.5"
                  ),
                  children: c.map((P, D) => /* @__PURE__ */ S(cz, { metadata: P }, D))
                }
              ),
              l
            ] })
  ...
  zv,
  {
    ...
    children: [
          ...
          children: [
            ...
            /* @__PURE__ */ K(
              "div",
              {
                className: Q(
                  "flex flex-col gap-0",
                  e && "flex-row items-center gap-1.5"
                ),
                children: [
                  /* @__PURE__ */ S(Uv, { className: "flex h-6 items-center", children: /* @__PURE__ */ S(_t, { className: Q("h-4 w-20 rounded-md", e && "h-3") }) }),
                  /* @__PURE__ */ S(Hv, { className: "flex h-5 items-center", children: /* @__PURE__ */ S(_t, { className: "h-3 w-12 rounded-md" }) })
                ]
              }
            )
          ]
      ...
      /* @__PURE__ */ S(Kv, { className: "flex flex-col gap-0", children: Array.from({ length: 3 }).map((t, r) => /* @__PURE__ */ K("div", { className: "flex h-6 items-center gap-1.5", children: [
        /* @__PURE__ */ S(_t, { className: "h-4 w-4 rounded-full" }),
        /* @__PURE__ */ S(_t, { className: "h-3 w-full max-w-20 rounded-md" })
      ] }, r)) })
    ]
  }
), vz = ["forceVerticalMetadata", "disableOverlayLink"], UP = We((e, t) => {
  const r = vz.reduce((n, a) => {
    const { [a]: i, ...o } = n;
    return o;
  }, e);
  return /* @__PURE__ */ S(pz, { ref: t, ...r });
}), yz = ({ compact: e = !1 }) => /* @__PURE__ */ S(hz, { compact: e });
UP.displayName = "F0Card";
const v7 = qe(AO(UP, yz)), HP = We(({ className: e, ...t }, r) => /* @__PURE__ */ S(
  _O,
  {
    ref: r,
...
const Ed = [
  ...
  return /* @__PURE__ */ K(
    "svg",
    {
      ...
      ...e,
      children: [
        /* @__PURE__ */ S("defs", { children: Ed.map((a) => /* @__PURE__ */ S("clipPath", { id: `${n}-${a.id}`, children: /* @__PURE__ */ S("path", { d: a.path }) }, a.id)) }),
        r ? Ed.map((a) => /* @__PURE__ */ S(
          "path",
          {
            d: a.path,
            fill: "currentColor",
...
function bz({
  ...
  return c && /* @__PURE__ */ S("div", { children: /* @__PURE__ */ S("div", { className: "p-2", children: /* @__PURE__ */ S("div", { style: d(), children: /* @__PURE__ */ K(
    "div",
    {
      className: y(),
      style: p(),
      ...
      children: [
        /* @__PURE__ */ K(dt, { children: [
          s === "one-campaign" ? /* @__PURE__ */ S("div", { className: "relative flex h-8 w-8 shrink-0 items-center justify-center", children: /* @__PURE__ */ S(ct, { icon: gz, size: "lg", className: "!h-8 !w-8" }) }) : /* @__PURE__ */ S("div", { className: "relative flex h-8 w-8 shrink-0 items-center justify-center", children: /* @__PURE__ */ S(
            sE,
            {
              module: u.module,
              size: "lg"
          ...
          /* @__PURE__ */ S("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ K("div", { children: [
            /* @__PURE__ */ S("h3", { className: "text-lg font-medium", children: e }),
            /* @__PURE__ */ S("p", { className: "text-f1-foreground-secondary", children: t })
          ] }) })
        ] }),
        i && /* @__PURE__ */ S("div", { className: "h-6 w-6", children: /* @__PURE__ */ S(
          Yt,
          {
            variant: "ghost",
            icon: PO,
...
function wz({
  ...
  return /* @__PURE__ */ K("div", { className: "flex flex-col gap-2", children: [
    /* @__PURE__ */ S("h6", { className: "text-sm font-medium", children: n.date.selectedBy }),
    /* @__PURE__ */ S(TO, { value: t, onValueChange: a, as: "list", children: /* @__PURE__ */ S(EO, { children: e.map((i) => /* @__PURE__ */ S(Dd, { value: i, children: n.date.granularities[i]?.label || i }, i)) }) })
  ] });
}
const Rw = "__custom__", Oz = (e, t) => {
  ...
  return Le(() => {
    if (t.date) {
      const i = Object.entries(e).find(
        ([o, s]) => Oz(t.date, s)
      );
      n(i ? i[0] : void 0);
    }
  }, [t.date, e]), /* @__PURE__ */ S(TO, { as: "list", value: r, onValueChange: (i) => {
    n(i), t.onSelect?.(i);
  }, children: /* @__PURE__ */ K(EO, { children: [
    Object.entries(e).map(([i, o]) => /* @__PURE__ */ S(Dd, { value: i, children: o?.label || i }, i)),
    /* @__PURE__ */ S(cE, {}),
    /* @__PURE__ */ S(Dd, { value: Rw, children: "Custom" }, Rw)
  ] }) });
...
function Az({
  ...
  const p = Tr(), y = gO(), [h, v] = he(
    c || t
  ), b = f ?? y.date?.weekStartsOn ?? lE.Monday;
  Le(() => {
    Ha(c, h) || v(c || t);
  }, [c, t]);
  const g = Ke(
    () => h?.granularity ?? "day",
    [h?.granularity]
  ), x = Ke(() => ly(b)[g], [g, b]), O = Ke(() => x.calendarMode || "single", [x]), m = (L) => {
    w({
    ...
    const N = ly(b);
    w({
      value: N[z.granularity].toRange(
        typeof z.value == "function" ? z.value() : z.value
      ),
    ...
    () => x.calendarView || "day",
    [x]
  ), [j, I] = he(o || void 0), k = Ke(() => {
    const L = (i ?? {})[g] || [];
    if (!h?.value)
      return [];
    const z = h.value, N = L.map((B, q) => {
      const H = typeof B.value == "function" ? B.value(x.toRange(z)) : xz(
        x.toRange(z),
        B.value.delta,
        B.value.units
      ), X = Array.isArray(H) ? H.map((te) => x.toString(te, p)).join(", ") : x.toString(H, p);
      return {
        label: B.label,
        value: (q + 1).toString(),
  ...
  return Le(() => {
    s?.(
      j ? k[+j]?.dateValue : void 0
    );
  }, [j, s, k]), /* @__PURE__ */ K(fE, { open: d.open, onOpenChange: d.onOpenChange, children: [
    /* @__PURE__ */ S(dE, { asChild: l, children: a }),
    /* @__PURE__ */ S(pE, { className: "w-full overflow-auto", align: "start", children: T ? /* @__PURE__ */ S(
      Sz,
      {
        presets: r,
        date: h,
    ...
    ) : /* @__PURE__ */ K("div", { className: "flex gap-4", children: [
      (r.length > 0 || n.length > 1) && /* @__PURE__ */ K("div", { children: [
      ...
      /* @__PURE__ */ K("div", { className: "min-w-[300px] flex-1", children: [
        /* @__PURE__ */ S(
          hE,
          {
            showInput: !u,
        ...
        k.length > 0 && /* @__PURE__ */ K("div", { className: "mt-4 flex flex-col gap-2", children: [
          /* @__PURE__ */ S("div", { className: "text-gray-500 text-sm", children: p.date.compareTo }),
          /* @__PURE__ */ S(
            vE,
            {
...
const GP = We(
  ({
    ...
    return /* @__PURE__ */ S(dt, { children: /* @__PURE__ */ S(
      yE,
      {
        ...s,
        icon: mE,
...
function _z({
  ...
  const d = Tr(), p = Ke(() => n[0] ?? "day", [n]), y = rt(
    (w) => {
      const A = w || p;
      if (!Ze[A])
    ...
    (w) => {
      ...
      return w ? {
        value: A.toRange(
          A.calendarMode === "range" ? w.value : w.value?.from ?? void 0
        ),
        granularity: w.granularity
      } : void 0;
    },
    [y]
  ), v = Ke(() => y(u?.granularity), [u?.granularity, y]);
  Le(() => {
    const w = h(t);
    Ha(u, w) || c(w);
  }, [t]);
...
const g7 = {
  today: {
    label: "Today",
    granularity: "day",
    value: () => Ze.day.toRange(/* @__PURE__ */ new Date())
  },
  yesterday: {
    label: "Yesterday",
    granularity: "day",
    value: () => Ze.day.toRange(xo(/* @__PURE__ */ new Date(), 1))
  },
  last7Days: {
    label: "Last 7 days",
    granularity: "day",
    value: () => Ze.day.toRange({
  ...
  thisWeek: {
    label: "This week",
    granularity: "week",
    value: () => Ze.week.toRange(/* @__PURE__ */ new Date())
  },
  lastWeek: {
    label: "Last week",
    granularity: "week",
    value: () => Ze.week.toRange(xo(/* @__PURE__ */ new Date(), 7))
  },
  thisMonth: {
    label: "This month",
    granularity: "month",
    value: () => Ze.month.toRange(/* @__PURE__ */ new Date())
  },
  lastMonth: {
    label: "Last month",
    granularity: "month",
    value: () => Ze.month.toRange(xa(/* @__PURE__ */ new Date(), 1))
  },
  last3Months: {
    label: "Last 3 months",
    granularity: "month",
    value: () => Ze.month.toRange(xa(/* @__PURE__ */ new Date(), 3))
  },
  last6Months: {
    label: "Last 6 months",
    granularity: "month",
    value: () => Ze.month.toRange(xa(/* @__PURE__ */ new Date(), 6))
  },
  thisQuarter: {
    label: "This quarter",
    granularity: "quarter",
    value: () => Ze.quarter.toRange(/* @__PURE__ */ new Date())
  },
  lastQuarter: {
    label: "Last quarter",
    granularity: "quarter",
    value: () => Ze.quarter.toRange(xa(/* @__PURE__ */ new Date(), 3))
  },
  thisHalfYear: {
    label: "This half year",
    granularity: "halfyear",
    value: () => Ze.halfyear.toRange(/* @__PURE__ */ new Date())
  },
  lastHalfYear: {
    label: "Last half year",
    granularity: "halfyear",
    value: () => Ze.halfyear.toRange(xa(/* @__PURE__ */ new Date(), 6))
  },
  lastYear: {
    label: "Last year",
    granularity: "year",
    value: () => Ze.year.toRange(rg(/* @__PURE__ */ new Date(), 1))
  },
  last3Years: {
    label: "Last 3 years",
    granularity: "year",
    value: () => Ze.year.toRange(rg(/* @__PURE__ */ new Date(), 3))
  }
}, b7 = qe(
  ki("F0DatePicker", _z)
);
...
function xW({
  ...
  return /* @__PURE__ */ S(sT.Provider, { value: n, children: t });
}
function wW(e) {
...
function AW({
  ...
  return /* @__PURE__ */ K("div", { className: "flex w-full min-w-0 items-center", children: [
    a && /* @__PURE__ */ S(
      _r,
      {
        compact: !0,
    ...
    /* @__PURE__ */ K(
      ...
      {
        className: Q(
          SO("focus:border-f1-border-focus"),
          ...
          y && !v && "cursor-pointer hover:bg-f1-background-hover",
          v && "cursor-not-allowed opacity-30"
        ),
        ...
        onMouseLeave: () => f(!1),
        children: [
          (n || h) && /* @__PURE__ */ S("div", { className: "absolute left-1.5 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ S(Na, { mode: "wait", children: m ? /* @__PURE__ */ S(
            Kt.div,
            {
              ...
              children: /* @__PURE__ */ S(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ S(ct, { icon: xE, size: "xs" })
                }
              )
            },
            "handle"
            ...
            Kt.div,
            {
              ...
              children: /* @__PURE__ */ S(ct, { icon: h, size: "md" })
            },
            "icon"
          ) }) }),
          /* @__PURE__ */ S(
          ...
          /* @__PURE__ */ S(Na, { children: (O || x) && /* @__PURE__ */ S(
            Kt.div,
            {
              initial: { opacity: 0, scale: 0.8 },
              animate: { opacity: 1, scale: 1 },
              ...
              children: /* @__PURE__ */ S(Na, { mode: "wait", children: O ? /* @__PURE__ */ S(
                Kt.div,
                {
                  initial: { opacity: 0, scale: 0.8 },
                  animate: { opacity: 1, scale: 1 },
                  ...
                  className: "flex items-center justify-center",
                  children: /* @__PURE__ */ S(wE, { value: t })
                },
                "counter"
              ) : x && /* @__PURE__ */ S(
                Kt.div,
  ...
  return wW({
    ...
    if (!(!g.current || !o))
      return oT({
        ...
        getData: ({ input: P, element: D }) => {
          ...
          return f && M > I ? { type: "toc-item-target", id: e.id, position: "inside" } : XP(
        ...
        onDrag: ({ self: P, source: D }) => {
          ...
          if ($.position === "inside") {
            const j = A.current;
            (!j || !j.isInside || j.edge !== null) && (w(!0), O(null), A.current = { edge: null, isInside: !0 }, u?.(e.id, "inside"));
    ...
    Kt.div,
    {
      ...
      className: Q(
        ...
        m && f && "bg-f1-background-hover/30",
        p && "bg-f1-background-hover/50 shadow-lg"
      ),
      animate: p ? {
        scale: [1, 1.05, 1],
        y: [0, -2, 0]
      ...
      transition: p ? {
        ...
        // Bouncy ease for more evident effect
      } : {},
      children: /* @__PURE__ */ S(
        AW,
        {
  ...
  return /* @__PURE__ */ K(
    SE,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ S(AE, { forceMount: !0, className: "flex flex-col gap-1", children: /* @__PURE__ */ S(
          Kt.div,
          {
            initial: !1,
            animate: {
            ...
            children: /* @__PURE__ */ S("div", { className: "ml-3 min-w-0 border-0 border-l border-solid border-f1-border-secondary pl-5", children: t })
          }
        ) })
      ]
    }
...
function PW({
  ...
  return /* @__PURE__ */ K(dt, { children: [
    ...
    t && /* @__PURE__ */ S("div", { className: "ml-[18px] min-w-0 border-0 border-l border-solid border-f1-border-secondary pl-4", children: t })
  ] });
}
function Ma({
  item: e,
...
function fT(e, t, r, n, a, i, o, s, u, c, l, f, d, p, y, h, v, b, g) {
  const x = e.children ? Ma : Va, O = o?.has(e.id) ?? !0, m = f === e.id, w = !!(l && l !== e.id && c && e.children !== void 0 && // Item must have children property (is a section)
  !cT(c, l, e.id)), A = !!(l && l !== e.id && m && d === "before"), _ = !!(l && l !== e.id && m && d === "after"), P = y === null ? c?.[0]?.id === e.id : !c || !y ? !1 : gt(c, y)?.item.children?.[0]?.id === e.id;
  return /* @__PURE__ */ K(dt, { children: [
    /* @__PURE__ */ S(Na, { children: A && /* @__PURE__ */ S(
      Kt.div,
      {
    ...
    x === Va ? /* @__PURE__ */ S(
      ...
      x,
      {
        ...
        currentParentId: y,
        draggedItemId: l,
        children: e.children && (x === Ma || O) && /* @__PURE__ */ K(
          "div",
          {
            className: Q(
              "flex flex-col",
              // Show placeholder background when dragging inside this section
              m && d === "inside" && w && "rounded-md bg-f1-background-hover/20 p-1"
            ),
            children: [
              e.children.map((D) => fT(
                D,
              ...
              m && d === "inside" && w && (!O || e.children.length === 0) && /* @__PURE__ */ S("div", { className: "flex h-9 items-center justify-center rounded-md bg-f1-background-hover/30 text-xs text-f1-foreground-secondary", children: "Drop here" })
            ]
          }
        )
      },
    ...
    /* @__PURE__ */ S(Na, { children: _ && /* @__PURE__ */ S(
      Kt.div,
      {
        initial: { opacity: 0, height: 0, marginTop: 0, marginBottom: 0 },
...
function jW({
  ...
  const f = Tr(), [d, p] = he(""), y = (E) => {
    p(E);
  }, h = Ke(() => nO(t, d), [t, d]), [v, b] = he(
    TW(t, n)
  ), [g, x] = he(t);
  Le(() => {
    x(t);
  }, [t]);
  const O = Me(null), m = rt(
    (E) => {
      b((Y) => {
        const F = new Set(Y);
    ...
    [g, u, bn]
  ), P = Ke(() => nO(g, d), [g, d]), [D, T] = he(null), [$, M] = he(null), [j, I] = he(null), [k, R] = he(
    null
  ), L = Me(null), z = Me(!1), N = Me(null), B = Me(null), q = Me(null), H = Me(null), X = Me(null), te = Me(0), ne = Me(0), ee = Me(!1), J = Me(null), U = rt(
    (E, Y) => {
      ...
      if (ae && ce) {
        ...
        if (Y === "inside")
          ...
          if (ae.parentPath.length > 0 ? oe = ae.parentPath[ae.parentPath.length - 1] : oe = null, oe === null)
            ...
            const ye = gt(g, oe);
            ye && (Se = (ye.item.children?.findIndex(
              (Be) => Be.id === E
            ) ?? 0) + 1);
          }
        ...
        if (Te === null)
          ...
          const ye = gt(g, Te);
          ye && (me = ye.item.children?.findIndex(
            (Be) => Be.id === F
          ) ?? -1);
        }
  ...
  return OW(
    ...
    "nav",
    {
      className: Q(
        "w-[248px]",
        l ? "overflow-y-auto" : "overflow-hidden",
        r
      ),
      "aria-label": e,
      ref: O,
      children: [
        (e || o) && /* @__PURE__ */ K(
          "div",
          {
            ...
            children: [
              o && /* @__PURE__ */ S("div", { className: "mb-4", children: /* @__PURE__ */ S(
                _E,
                {
        ...
        /* @__PURE__ */ S(vh, { className: "h-full min-h-0", children: /* @__PURE__ */ S("div", { className: "px-3 pb-2", children: /* @__PURE__ */ S("div", { className: "flex flex-col gap-0.5", children: (i ? P : h).map(
          (E) => fT(
            E,
            i,
            0,
...
function MW(e) {
  const t = Me(/* @__PURE__ */ Symbol("f0-table-of-contents")), r = Ke(() => bW(t.current), []);
  return /* @__PURE__ */ S(xW, { driver: r, children: /* @__PURE__ */ S(jW, { ...e }) });
}
const w7 = qe(
  ki("F0TableOfContent", MW)
), $W = We(
...
), IW = ({ text: e, isCompleted: t }) => /* @__PURE__ */ K("div", { className: "flex flex-row items-center gap-2", children: [
  /* @__PURE__ */ S(
    ct,
    {
...
] }), DW = ({ title: e, items: t }) => /* @__PURE__ */ K("div", { className: "px-4 pb-2", children: [
  /* @__PURE__ */ S("div", { className: "mb-2 text-sm text-f1-foreground-secondary", children: e }),
  /* @__PURE__ */ S("div", { className: "flex flex-col gap-2", children: t.map((r) => /* @__PURE__ */ S(
    IW,
    {
      text: r.text,
  ...
  const i = t && n && r, o = (s = !1) => /* @__PURE__ */ K(dt, { children: [
    /* @__PURE__ */ S(
      Yt,
      {
        variant: "outline",
  ...
  return /* @__PURE__ */ K(KP, { className: "px-4 pb-4 pt-2 [&_div]:w-full", children: [
    /* @__PURE__ */ S("div", { className: "hidden sm:flex sm:flex-row sm:justify-between sm:gap-3", children: o() }),
    /* @__PURE__ */ S("div", { className: "flex flex-col-reverse gap-2 sm:hidden", children: o(!0) })
  ] });
}, dT = We(
  ({
    open: e,
            ...
            children: [
              /* @__PURE__ */ K(
                VP,
                {
                  ...
                  children: [
                    /* @__PURE__ */ S(zj, { type: r ? "positive" : "critical", size: "lg" }),
                    /* @__PURE__ */ K("div", { className: "flex flex-col gap-0.5", children: [
                      /* @__PURE__ */ S(EE, { className: "text-xl font-semibold sm:text-lg", children: r ? a?.title : n?.title }),
                      /* @__PURE__ */ S(HP, { className: "text-lg sm:text-base", children: r ? a?.description : n?.description })
                    ] })
                  ]
                }
              ),
              r && i && i.items?.length > 0 ? /* @__PURE__ */ K(dt, { children: [
                /* @__PURE__ */ S($W, {}),
                /* @__PURE__ */ S(DW, { title: i.title, items: i.items })
              ] }) : null,
              /* @__PURE__ */ S(
                kW,
                {
...
pT.displayName = RW;
var hT = pT;
const LW = fe.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ S(
  hT,
  {
    ref: r,
    className: Q(
...
const O7 = qe(qW), BW = We(
  function({
    ...
    return s ? /* @__PURE__ */ S(vT, { ref: l }) : d ? null : /* @__PURE__ */ K(
      "div",
      {
        ref: l,
        ...
        children: [
          /* @__PURE__ */ S("div", { className: "aspect-video w-full flex-shrink-0 overflow-hidden rounded-xl px-1 pb-0 pt-1 sm:max-w-80 sm:py-1 sm:pl-1", children: f ? /* @__PURE__ */ S(
            "video",
            {
              src: n,
              autoPlay: !0,
          ...
          /* @__PURE__ */ K("div", { className: "flex flex-col justify-center gap-5 px-3 pb-3 sm:py-3 sm:pl-0 sm:pr-3", children: [
            /* @__PURE__ */ K(
              "div",
              {
                className: Q(
                ...
                children: [
                  /* @__PURE__ */ S("h3", { className: "font-bold text-xl text-f1-foreground", children: t }),
                  r && /* @__PURE__ */ S("p", { className: "text-base text-f1-foreground-secondary", children: r })
                ]
              }
            ),
          ...
          o && /* @__PURE__ */ S("div", { className: "absolute right-2 top-2 z-10", children: /* @__PURE__ */ S(
            Yt,
            {
              variant: "ghost",
              icon: PO,
  ...
  function(t, r) {
    return /* @__PURE__ */ K(
      "div",
      {
        ...
        ...t,
        children: [
          /* @__PURE__ */ S("div", { className: "aspect-video w-full flex-shrink-0 overflow-hidden rounded-xl px-1 pb-0 pt-1 sm:max-w-80 sm:py-1 sm:pl-1", children: /* @__PURE__ */ S(_t, { className: "h-full w-full rounded-lg" }) }),
          /* @__PURE__ */ K("div", { className: "flex flex-col justify-center gap-5 px-3 pb-3 sm:py-3 sm:pl-0 sm:pr-3", children: [
            /* @__PURE__ */ K("div", { className: "flex w-full flex-col gap-1 sm:max-w-lg", children: [
              /* @__PURE__ */ S(_t, { className: "h-7 w-3/4" }),
              /* @__PURE__ */ S(_t, { className: "h-4 w-full" }),
              /* @__PURE__ */ S(_t, { className: "h-4 w-2/3" })
            ] }),
            /* @__PURE__ */ K("div", { className: "flex gap-3", children: [
              /* @__PURE__ */ S(_t, { className: "h-9 w-32" }),
              /* @__PURE__ */ S(_t, { className: "h-9 w-24" })
            ] })
          ] }),
          /* @__PURE__ */ S("div", { className: "absolute right-2 top-2 z-10", children: /* @__PURE__ */ S(_t, { className: "h-8 w-8 rounded-md" }) })
        ]
      }
    );
  }
...
const yT = {
  ...
  children: e,
  handler: t
}) => /* @__PURE__ */ S(mT.Provider, { value: t ?? yT, children: e }), A7 = () => {
  const e = pt(mT);
  if (!e)
    throw new Error(

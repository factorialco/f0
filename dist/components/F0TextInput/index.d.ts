import { F0TextInputProps } from './F0TextInput';
 ...
 * @removeIn 2.0.0
 */
export declare const Input: import('react').ForwardRefExoticComponent<Omit<F0TextInputProps, "ref"> & import('react').RefAttributes<HTMLInputElement>>;
/**

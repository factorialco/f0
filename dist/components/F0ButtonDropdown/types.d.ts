 ...
 */
type F0ButtonDropdownDropdownProps<T = string> = F0ButtonDropdownBaseProps<T> & {
    /**
     * The rendering mode.
...
export type F0ButtonDropdownProps<T = string> = F0ButtonDropdownSplitProps<T> | F0ButtonDropdownDropdownProps<T>;
export {};

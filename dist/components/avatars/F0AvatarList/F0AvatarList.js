...
import { OverflowList as u } from "../../../ui/OverflowList/index.js";
import { F0Avatar as g } from "../F0Avatar/index.js";
import { MaxCounter as M } from "./components/MaxCounter.js";
import { avatarListSizes as w } from "./types.js";
import { getAvatarDisplayName as L } from "./utils.js";
const A = {
  base: {
  ...
  if (e && !w.includes(e)) {
    ...
    console.warn(
      `The avatar list size: ${e} is deprecated. Use ${t[e]} instead.`
    ), e = t[e] ?? "md";
  }
  const m = {
    xs: -2,
  ...
  return /* @__PURE__ */ r(
    u,
    {
      max: i,
      min: i,
      items: o.map((t) => ({ type: s, ...t })),
      gap: m,
      itemsWidth: c,
      className: "flex items-center",
      renderListItem: (t, a) => {
        const p = L(s, t), f = t.tooltipDescription, h = !!t.badge, n = /* @__PURE__ */ r(
          "div",
          {
            className: "flex h-fit w-fit shrink-0 items-center justify-center",
            style: a !== o.length - 1 && !h ? {
              clipPath: A[s === "person" ? "rounded" : "base"][e]
            } : void 0,
            children: /* @__PURE__ */ r(
              g,
              {
        ...
        return /* @__PURE__ */ r("div", { children: d ? n : /* @__PURE__ */ r(x, { label: p, description: f, children: n }) }, a);
      },
      renderDropdownItem: () => null,
      forceShowingOverflowIndicator: C !== void 0,
      renderOverflowIndicator: (t) => /* @__PURE__ */ r(
        "div",
        {
          ...
          children: /* @__PURE__ */ r(
            M,
            {
              count: (C ?? 0) + t,
              size: e,
              type: s === "person" ? "rounded" : "base",
              avatarType: s,
              tooltipScroll: l,
              list: C ? void 0 : o.slice(o.length - t)
            }
          )
        }
      ),

import { CompanyAvatarVariant, FileAvatarVariant, FlagAvatarVariant, PersonAvatarVariant, TeamAvatarVariant } from '../F0Avatar/types';
export declare const avatarListSizes: readonly ["xs", "sm", "md"];

import { ModuleId } from '../F0AvatarModule';
...
export type PersonAvatarVariant = Extract<AvatarVariant, {
    type: "person";
}>;
export type TeamAvatarVariant = Extract<AvatarVariant, {
    type: "team";
}>;
export type CompanyAvatarVariant = Extract<AvatarVariant, {
    type: "company";
}>;
export type FileAvatarVariant = Extract<AvatarVariant, {
    type: "file";
}>;
export type FlagAvatarVariant = Extract<AvatarVariant, {
    type: "flag";
}>;
export type IconAvatarVariant = Extract<AvatarVariant, {
    type: "icon";
}>;

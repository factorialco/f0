import { TOCItem, TOCProps } from '../../experimental/Navigation/F0TableOfContent';
export type PopupSize = "sm" | "md" | "lg";
export type TableOfContentPopoverVariant = "dark" | "light";
export interface F0TableOfContentPopoverProps extends Omit<TOCProps, "showSearchBox" | "title" | "hideChildrenCounter"> {

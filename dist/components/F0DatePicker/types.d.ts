...
import { DatePickerPopupProps, DatePickerValue as DatePickerPopupValue } from '../../ui/DatePickerPopup';
...
export type F0DatePickerProps = Pick<DatePickerPopupProps, "minDate" | "maxDate" | "presets" | "open" | "onOpenChange" | "selectOnCellOnly"> & {

...
export type F0ButtonToggleGroupItem = Pick<F0ButtonToggleProps, "label" | "icon" | "disabled" | "tooltip" | "color" | "className"> & {
    value: string;
};
export declare const buttonToggleGroupSizes: readonly ["sm", "md", "lg"];

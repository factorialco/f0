...
// src/components/OneChip/index.tsx
function cn(...inputs) {
...
var ForwardRef59 = forwardRef(SvgCrossedCircle);
...
var OneChip = ({
  ...
  return /* @__PURE__ */ jsx(View, { className: "flex items-start", children: /* @__PURE__ */ jsx(
    Pressable,
    {
      className: cn(
      ...
      "aria-label": "Action",
      children: /* @__PURE__ */ jsxs(View, { className: "flex flex-row items-center gap-0.5", children: [
        icon && /* @__PURE__ */ jsx(
          Icon,
          {
            icon,
        ...
        /* @__PURE__ */ jsx(Text, { className: chipTextVariants({ variant }), children: label }),
...
export { OneChip, chipContainerVariants, chipTextVariants };

...
import { useInsertionEffect as Zr, forwardRef as g, useRef as j, useEffect as K, useLayoutEffect as ct, useState as P, useMemo as J, useCallback as z, createContext as Ge, useContext as Ie, useId as lt, createElement as _r, memo as Or } from "react";
import { cU as Ur, cV as zr, cW as Gr, cX as Wr, cY as dt, cZ as qr, c_ as Xr, c$ as Yr, d0 as Kr, d1 as Qr, d2 as ut, d3 as Jr, d4 as en, d5 as tn, d6 as rn, d7 as nn, d8 as on, d9 as sn, da as ze, db as an, dc as cn, dd as ln, de as dn, df as un, Z as ft, bX as fn, dg as hn, dh as gn, di as pn, dj as mn, b$ as ht, bW as Cn, dk as vn, a6 as a1, dl as wn, aK as xn, dm as kn, dn as Ln, dp as bn, ah as yn, dq as Mn, co as En, aa as gt, ad as Rn, dr as Fn, ba as c1, a1 as pt, S as We, bN as mt, bi as Nn, ds as Vn, dt as Sn, b3 as Tn, cn as An, $ as Fe, av as Hn, bm as Ct, du as $n, cl as Bn, bV as Me, ch as In, dv as Pn, bP as vt, b2 as jn, dw as Dn, dx as Zn, dy as _n, dz as On, dA as Un, dB as wt, ca as zn, cb as Gn, dC as Wn, dD as qn, dE as Xn, dF as Yn, dG as Kn, bw as Qn, bZ as Jn, dH as eo, dI as to, dJ as ro, dK as no, dL as oo, dM as so, dN as io, dO as ao, bv as co, cm as lo, ab as uo, c6 as fo, dP as ho, dQ as go, dR as po, dS as mo, dT as Co, dU as vo, dV as wo, aq as xo, bR as xt, M as ko, a0 as Lo, bK as kt, bO as bo, bQ as Lt, dW as yo, bl as Mo, bk as Eo, dX as Ro, dY as Fo, bx as bt, by as No, bz as Vo, b1 as So, az as To, dZ as Ao, at as Ho, bg as yt, bf as Mt, b8 as $o, d_ as Et, b7 as Bo, bY as l1, d$ as Io, bc as d1, e0 as Po, e1 as jo, e2 as u1, cj as Do, ci as Zo, ck as Rt, e3 as _o, G as Oo, E as Uo, e4 as zo, e5 as Go, e6 as Wo, e7 as qo, bL as Xo, e8 as Ft, e9 as Yo, ac as Ko, ea as Qo, L as ue, o as L, q as Se, c0 as Jo, u as Y, bJ as es, U as ge, bI as Nt, H as fe, v as pe, a2 as ts, Q as ve, eb as rs, ae as le, aQ as ke, A as Ee, p as re, ct as Vt, aE as f1, ec as ns, aF as h1, aG as g1, b as be, bG as os, ed as ss, bH as is, V as as, b0 as cs, a5 as p1, bA as ls, bB as ds, bC as us, bD as R1, a3 as fs, al as St, aT as Tt, ee as hs, cA as gs, ef as ps, eg as ms, aY as At, eh as Cs, cu as vs, ei as ws, aV as Be, b9 as Ht, ej as $t, bb as Bt, c as o1, b_ as F1, ek as It, el as xs, bq as ks, em as Ls, bh as m1, c7 as bs, en as ys, eo as Ms, ep as Es, eq as Rs, er as Fs, a8 as Ns, af as Vs, y as Ss, z as Ts, ak as N1, es as Pt, et as jt, eu as As, ev as Hs, aj as $s, a7 as Bs, ew as Is, ex as Ps, d as js } from "./F0CanvasPanel-CYITfwlc.js";
...
function Zt(e, t, n, o) {
  return typeof e == "string" && C1(t) ? Ur(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Os(e, t, n) {
  return e * (t + 1);
}
...
function Ks(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let h = 0; h < e.length; h++) {
    ...
    if (typeof C == "string") {
      ...
      f.set(C.name, V1(p, C.at, u, f));
      continue;
    }
    let [v, w, M = {}] = C;
    M.at !== void 0 && (p = V1(p, M.at, u, f));
    let A = 0;
    const H = (N, b, x, k = 0, E = 0) => {
      ...
      if (ae > 0 && Yr(F, ae), V.length === 1 && V.unshift(null), Z) {
        ut(Z < Ys, "Repeat count too high, must be less than 20"), _ = Os(_, Z);
        const se = [...V], ne = [...F];
    ...
    if (dt(v)) {
      ...
      const N = Zt(v, w, o, l), b = N.length;
      for (let x = 0; x < b; x++) {
        w = w, M = M;
        const k = N[x], E = S1(k, d);
        for (const V in w)
          H(w[V], Js(M, V), T1(V, E), x, b);
      }
    }
    u = p, p += A;
  }
...
function ii(e, t) {
  return dt(e) || typeof e == "number" || typeof e == "string" && !C1(t);
}
function Ot(e, t, n, o) {
  const s = [];
  if (ii(e, t))
    s.push(an(e, C1(t) && t.default || t, n && (n.default || n)));
  else {
    const i = Zt(e, t, o), a = i.length;
...
function ui(e) {
  function t(n, o, s) {
    let i = [];
    return di(n) ? i = ai(n, o, e) : i = Ot(n, o, s, e), new li(i);
  }
  return t;
}
...
const Nl = Se({
  ...
  ({
    ...
    const He = I && I !== "none" || te && te !== "none" || W && W !== "none" || ae && ae !== "none", je = q && q !== "none" || He, Je = { sm: Xe, md: Ye, lg: Pe, xl: Ke }, e1 = Vl.map((De) => {
      const Ze = Je[De];
      return Ze ? Fl(De, Ze) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
function Al({
  ...
  const o = /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(fe, { icon: ft, size: "md", color: "critical" }),
...
const Il = ({
  ...
  return /* @__PURE__ */ r("div", { className: "p-1", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ r(fe, { icon: l1, size: "md", color: "default" }) }),
        /* @__PURE__ */ r(
          le,
          {
...
const Ul = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ c(
    f1,
    {
      ...
      children: [
        /* @__PURE__ */ r(ns, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ r(h1, { asChild: !0, children: /* @__PURE__ */ r(
          ue,
          {
            variant: "outline",
            label: d.label,
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ r(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ r(fe, { icon: a1, size: "sm" })
                      }
                    )
                  ]
                },
...
function e2({
  ...
  const b = z(() => {
    ...
    (F) => {
      ...
      for (const U of Z) {
        const G = `@${U.name}`, ee = `<entity-ref type="person" id="${A1(U.id)}">${A1(U.name)}</entity-ref>`;
        for (; B.includes(G); )
          B = B.replace(G, ee);
      }
      return B;
...
const t2 = /[\\`*_{}[\]()#+\-.!|~>]/g, r2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(t2, "\\$&")).join(""), A4 = ({
  ...
  const k = Y(), E = ke(), [V, S] = P(""), [F, B] = P(0), [Z, U] = P(!1), [G, ee] = P(!1), [X, _] = P(null), q = j(null), I = j(null), te = j(null), W = a != null, { tracking: ae } = be(), Ce = z(
    ...
    const xe = ye.current, t1 = xe && !/\s$/.test(xe) ? " " : "", _e = `${xe}${t1}${Q}`;
    S(_e), B(_e.length);
  }, []), Ae = {
  ...
  const Pe = we.status === "recording", Ke = Pe ? k.ai.listening : k.ai.inputPlaceholder, Qe = se.filter((Q) => Q.status === "uploaded"), Ve = se.some((Q) => Q.status === "uploading"), He = se.some((Q) => Q.status === "error"), je = V.trim().length > 0;
  K(() => {
    if (!(!G || Ve)) {
      if (ee(!1), He) {
  ...
  const Je = async (Q) => {
    if (Q.preventDefault(), !W) {
      if (oe.close(), n)
        ...
        const xe = oe.transformMentions(V.trim()), t1 = r2(xe), _e = Qe.flatMap(
          (E1) => E1.uploadedFile ? [E1.uploadedFile] : []
        ), y1 = d, M1 = f;
        y1 && l?.(null), M1 && u?.(null), await e({
          text: t1,
          files: _e,
          context: y1,
          quote: M1
  ...
  }, x1 = X ? X.prompt ?? X.title : null, k1 = Pe ? [k.ai.listening] : x1 ? [x1] : s ?? [], Br = k1.length > 1, Ir = J(() => zl(V, oe.mentions, {
    cursorPosition: F,
    inlineCompletion: oe.inlineCompletion
  }), [V, oe.mentions, F, oe.inlineCompletion]), Pr = oe.mentions.length > 0 || oe.inlineCompletion !== null, L1 = M && !!H && H.length > 0 && !!N ? /* @__PURE__ */ r(
    Ul,
    {
      suggestions: H,
      onItemClick: Ce,
  ...
  ) : null, jr = M && A && !!b && b.length > 0, b1 = A && M, { motionProps: Dr } = ss(
    M,
    160,
    0.5
  );
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          us,
          {
            ...
            children: l ? /* @__PURE__ */ r(R1.Skeleton, {}) : /* @__PURE__ */ r(R1, { ...C })
          }
        )
      ]
    }
...
ur.displayName = "CandidateTrigger";
function L2({
  id: e,
  label: t
}) {
...
hr.displayName = "JobPostingTrigger";
function y2({
  id: e,
  label: t
}) {
...
gr.displayName = "RequisitionTrigger";
function E2({
  id: e,
  label: t
}) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ r(Tt, { module: e.module, size: "md" }),
...
const H1 = 7, A2 = 625, $1 = /* @__PURE__ */ new Set();
function H2(e) {
...
function vr(e, t) {
  ...
  if (t === "daterange" && typeof e == "object" && e !== null && "from" in e && "to" in e) {
    const { from: n, to: o } = e, s = B1(n) ? I1(n) : String(n), i = B1(o) ? I1(o) : String(o);
  ...
  if (Array.isArray(e))
    return { type: "item", text: e.map((o) => {
      const s = vr(o);
      return Array.isArray(s) ? s.map(P1).join(", ") : P1(s);
    }).filter(Boolean).join(", ") || "—" };
...
function wr({
  ...
  h.current = M, K(() => {
    typeof window > "u" || window.innerWidth < A2 || $1.has(e) || ($1.add(e), h.current());
  }, [e]);
  const A = i && a ? Object.entries(i).map(([b, x]) => {
    ...
    if (!E && x.fieldType === "custom" && typeof k == "object" && k !== null)
      return null;
    const V = E ?? vr(k, x.fieldType), S = ["richtext", "textarea"];
    return {
      label: x.label,
      content: V,
...
const j1 = 8, $e = 8;
function kr({ anchor: e, onReply: t }) {
  ...
  if (ct(() => {
    ...
    m < $e && (m = e.rect.bottom + j1), m = Math.min(
      Math.max(m, $e),
      p - f - $e
    );
...
const Lr = Ge(void 0), I4 = () => Ie(Lr), D2 = (e) => /* @__PURE__ */ r(At, { content: e, format: "markdown" }), Z2 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const d = typeof n?.content == "string" ? n.content : "", l = (n && o?.(n)) ?? n?.generativeUI?.() ?? null, f = n?.toolCalls?.[0]?.id, u = !d && !l, p = j(null), { anchor: m, clear: h } = xr({
    containerRef: p,
    enabled: !!(n?.id && d)
  });
  return K(() => {
    n?.id && !t && !e && i?.(n);
  }, [n, t, e, i]), !t && !e && u ? null : /* @__PURE__ */ r(Lr.Provider, { value: f, children: /* @__PURE__ */ c("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    n && d && /* @__PURE__ */ r(
      "div",
      {
        ref: p,
  ...
  return /* @__PURE__ */ r(br.Provider, { value: o, children: e });
}, yr = () => {
  const e = Ie(br);
  if (e === null)
    throw new Error(
...
const z2 = ({
  ...
  const o = Y(), { open: s } = yr(), [i, a] = P(null);
...
const Mr = (e) => /* @__PURE__ */ r(At, { content: e, format: "markdown" }), Y2 = ({
  text: e,
  renderMarkdown: t
}) => /* @__PURE__ */ c("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ r("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ r(fe, { icon: l1 }) }),
  /* @__PURE__ */ r("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (t ?? Mr)(e) })
] }), K2 = ({
  message: e,
  onReplyQuote: t,
  ...
  const a = e.rawData, d = X2(
    e?.content,
    a
  ), l = (q2(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = l.length > 0, { anchor: p, clear: m } = xr({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ c(
    ...
    return /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          I.endIndicator === "thinking" && /* @__PURE__ */ r(o1, { title: x.ai.thinking, status: "executing" }),
          I.endIndicator === "activity" && /* @__PURE__ */ r(o1, { status: "writing" }),
  ...
  return /* @__PURE__ */ c(Re, { children: [
    /* @__PURE__ */ c("div", { className: "relative flex flex-1 flex-col overflow-hidden", children: [
      ...
      !m && !S && /* @__PURE__ */ c(Re, { children: [
        /* @__PURE__ */ r(F1, { position: "top" }, "shadow-top"),
        /* @__PURE__ */ r(F1, { position: "bottom" }, "shadow-bottom")
      ] })
    ] }),
    H.isOpen && /* @__PURE__ */ r(
      _2,
...
function D4({
  ...
  return /* @__PURE__ */ r(Er.Provider, { value: t, children: e });
}
function Z4() {
  const e = Ie(Er);
  if (e === null)
...
const l6 = ({
  ...
  const m = Y().ai.clarifyingQuestion.typeYourAnswer, h = e === "single" ? /* @__PURE__ */ r(Rr, { isSelected: n && !t }) : /* @__PURE__ */ r(
    It,
    {
      checked: s,
      onCheckedChange: () => f(!s),
...
function m6(e, t, n) {
  const o = Z1(e, e.VERTEX_SHADER, t), s = Z1(e, e.FRAGMENT_SHADER, n), i = e.createProgram();
...
const _1 = ["lowp", "mediump", "highp"], k6 = `
void main(void){
...
}`, O1 = `attribute vec3 aVertexPosition;
void main(void) {
    gl_Position = vec4(aVertexPosition, 1.0);
}`, U1 = "iTime", z1 = "iTimeDelta", G1 = "iDate", W1 = "iFrame", q1 = "iMouse", X1 = "iResolution", b6 = "iChannel", Y1 = "iChannelResolution", K1 = "iDeviceOrientation";
function y6(e, t) {
...
}, n1 = 9729, Q1 = 9728, N6 = 9987, J1 = 33071, et = 10497;
class V6 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    return (t.wrapS !== J1 || t.wrapT !== J1 || t.minFilter !== Q1 && t.minFilter !== n1) && !x && (b = this.makePowerOf2(b), x = !0), n.bindTexture(n.TEXTURE_2D, H), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, l), n.texImage2D(
      n.TEXTURE_2D,
      p,
      m,
      w,
      M,
      b
    ), x && t.minFilter !== Q1 && t.minFilter !== n1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || et
    ), n.texParameteri(
...
const Le = (e) => `react-shaders: ${e}`, tt = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, rt = (e, t, n) => e * (1 - n) + t * n, S6 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function T6({
  fs: e,
  vs: t = O1,
  textures: n = [],
  ...
  const h = j(null), C = j(null), v = j(null), w = j(null), M = j(void 0), A = j(void 0), H = j(!1), N = j(void 0), b = j(0), x = j([0, 0]), k = j([]), E = j(0), V = j(void 0), S = j({
    ...
    [q1]: { type: "vec4", isNeeded: !1, value: [0, 0, 0, 0] },
    [X1]: { type: "vec2", isNeeded: !1, value: [0, 0] },
    [W1]: { type: "int", isNeeded: !1, value: 0 },
    [K1]: {
      type: "vec4",
      isNeeded: !1,
      value: [0, 0, 0, 0]
    ...
    const [T = 0, R = 0] = tt(y), D = T - (N.current?.left ?? 0) - window.pageXOffset, $ = (N.current?.height ?? 0) - R - (N.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    ...
    const [T = 0, R = 0] = tt(y), D = T - (N.current?.left ?? 0), $ = (N.current?.height ?? 0) - R - (N.current?.top ?? 0);
    if (l !== 1)
...
`,
    ...
    if (k.current.length > 0)
      for (let $ = 0; $ < k.current.length; $++) {
        const O = k.current[$];
        if (!O) return;
        const { isVideo: ce, _webglTexture: he, source: oe, flipY: ye, isLoaded: Ne } = O;
        if (!Ne || !he || !oe) return;
    ...
    if (S.current.iMouse?.isNeeded && l !== 1 && Array.isArray(R)) {
      const D = R[0] ?? 0, $ = R[1] ?? 0;
      R[0] = rt(D, x.current[0] ?? 0, l), R[1] = rt($, x.current[1] ?? 0, l);
    }
  ...
  return K(() => {
    ...
    function T() {
      Z();
      const R = C.current;
      R && h.current && (R.clearColor(...s), R.clearDepth(1), R.enable(R.DEPTH_TEST), R.depthFunc(R.LEQUAL), R.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, W(), ae(), te(Ce(e || L6), t || O1), U(), requestAnimationFrame(ne), ie(), q());
    }
  ...
  return K(() => {
    switch (e) {
      ...
      case "pre-connect-buffering":
        o(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, me), u(0.7, me), m([1.5, 2], nt);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        o(30), i(0.3, me), l(0.5, me), u(1, me), m([0.5, 2.5], nt);
        return;
      case "speaking":
...
const G4 = ({
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: L(Vr()), children: t }),
    /* @__PURE__ */ c(
      re.div,
      {
...
const X6 = ({
  ...
  const s = `sparkline-gradient-${lt().replace(/:/g, "")}`, i = q6(e, n), a = Sr[i];
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: L(Vr()), children: o }),
              /* @__PURE__ */ r(
                re.div,
                {
...
const Q6 = ["className"], Ar = g((e, t) => {
  const n = Q6.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
  return /* @__PURE__ */ r(Tr, { ref: t, ...n });
});
Ar.displayName = "F0AiInsightCard";
const J6 = () => /* @__PURE__ */ c(
  "div",
  {
  ...
  "balance",
  "sparkline"
], Hr = 180, e4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Hr, t4 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, r4 = (e) => e.showActions !== !1, n4 = (e) => Object.fromEntries(
...
function o4(e) {
  const {
    ...
    description: i,
    seeMoreLabel: a,
    maxCollapsedDescriptionLength: d = Hr
  } = e, [l, f] = P(!1), u = lt(), p = j(null), m = e4(
    d
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          t && /* @__PURE__ */ r(Tt, { module: t, size: "md" }),
...
const s4 = ({
  ...
  return /* @__PURE__ */ c(
    Ht,
    {
      ...
      onOpenChange: s,
      children: [
        /* @__PURE__ */ c($t, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
...
}, i4 = (e) => ll[e] ?? wt, a4 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(fe, { icon: i4(e), size: "md", color: "default" }) }) : null;
function c4({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(s4, { icon: d1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
function u4({ credits: e, trigger: t }) {
  ...
  return /* @__PURE__ */ c(f1, { open: o, onOpenChange: p, children: [
    /* @__PURE__ */ r(h1, { asChild: !0, children: t ?? /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
        hideLabel: !0,
...
function h4({
  ...
  return /* @__PURE__ */ c(f1, { open: s, onOpenChange: m, children: [
    /* @__PURE__ */ r(h1, { asChild: !0, children: t ?? /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
...
) : e ? /* @__PURE__ */ r(u4, { credits: e, trigger: n }) : null, X4 = i1, Y4 = ({
  historyEnabled: e = !1,
  title: t,
...
function p4(e) {
  ...
  return Pt(t) ? "today" : jt(t) ? "yesterday" : Hs(t, n) ? "thisMonth" : "older";
}
function m4(e, t) {
  const n = new Date(e), o = g4(), s = N1(n, "p", { locale: o });
  if (Pt(n)) return `${t.today}, ${s}`;
  if (jt(n)) return `${t.yesterday}, ${s}`;
  const i = !As(n, /* @__PURE__ */ new Date());
  return `${N1(n, i ? "MMM d yyyy" : "MMM d", {
    locale: o
  })}, ${s}`;
}
function C4(e) {
      ...
      children: [
        ...
        o ? (
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ r(p1, { items: u, children: /* @__PURE__ */ r(
              ue,
              {
                icon: vt,
                variant: "ghost",
...
const st = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], w4 = ({ width: e }) => /* @__PURE__ */ r("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ r(ge, { className: L("h-4 rounded", e) }) }), it = ({
  titleWidth: e,
  rows: t
...
function x4() {
  return /* @__PURE__ */ c("div", { "aria-hidden": "true", className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ r(it, { titleWidth: "w-12", rows: st.slice(0, 2) }),
    /* @__PURE__ */ r(it, { titleWidth: "w-24", rows: st })
  ] });
}
const K4 = ({
  onClose: e,
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ c("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ r(fe, { icon: d1, color: "secondary", size: "md" }),
                  /* @__PURE__ */ r(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ r(
                    Be,
                    {
                      ...
                      children: /* @__PURE__ */ c("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ r(fe, { icon: v1, color: "default", size: "md" }),
...
function Q4({
  ...
  const w = z((x, k) => {
    m((E) => {
      ...
      const V = new Set(E);
      return k ? V.add(x) : V.delete(x), at(V), V;
    });
  }, []), M = z((x, k) => {
    C((E) => {
      if (k === E.has(x)) return E;

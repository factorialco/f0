...
import { useInsertionEffect as Fr, forwardRef as h, useRef as P, useEffect as X, useLayoutEffect as rt, useState as $, useMemo as J, useCallback as U, createContext as ze, useContext as Be, useId as ot, createElement as Nr, memo as Vr } from "react";
import { cS as Sr, cT as Tr, Z as nt, bV as Hr, cU as Ar, cV as $r, cW as Br, cX as Ir, bZ as st, bU as Pr, cY as jr, a6 as i1, cZ as Dr, aK as Zr, c_ as _r, c$ as Or, d0 as Ur, ah as zr, d1 as Gr, cm as Wr, aa as it, ad as qr, d2 as Xr, ba as a1, a1 as at, S as Ge, bN as ct, bi as Yr, d3 as Kr, d4 as Qr, b3 as Jr, cl as eo, $ as Fe, av as to, bm as lt, d5 as ro, cj as oo, bT as Me, cf as no, d6 as so, bP as dt, b2 as io, d7 as ao, d8 as co, d9 as lo, da as fo, db as uo, dc as ft, c8 as ho, c9 as go, dd as Co, de as po, df as mo, dg as vo, dh as wo, bw as xo, bX as ko, di as Lo, dj as bo, dk as yo, dl as Mo, dm as Eo, dn as Ro, dp as Fo, dq as No, bv as Vo, ck as So, ab as To, c4 as Ho, dr as Ao, ds as $o, dt as Bo, du as Io, dv as Po, dw as jo, dx as Do, aq as Zo, bR as ut, M as _o, a0 as Oo, bK as ht, bO as Uo, bQ as gt, dy as zo, bl as Go, bk as Wo, dz as qo, dA as Xo, bx as Ct, by as Yo, bz as Ko, b1 as Qo, az as Jo, dB as en, at as tn, bg as pt, bf as mt, b8 as rn, dC as vt, b7 as on, bW as c1, dD as nn, bc as l1, dE as sn, dF as an, dG as d1, ch as cn, cg as ln, ci as wt, dH as dn, G as fn, E as un, dI as hn, dJ as gn, dK as Cn, dL as pn, bL as mn, dM as xt, dN as vn, ac as wn, dO as xn, L as ae, o as k, q as Ve, b_ as kn, u as W, bJ as Ln, U as de, bI as kt, H as ce, v as fe, a2 as bn, Q as me, dP as yn, ae as ie, aQ as ke, A as Ee, p as te, aE as f1, dQ as Mn, aF as u1, aG as h1, b as be, bG as En, dR as Rn, bH as Fn, V as Nn, b0 as Vn, a5 as g1, bA as Sn, bB as Tn, bC as Hn, bD as y1, a3 as An, al as Lt, aT as bt, dS as $n, cy as Bn, dT as In, dU as Pn, aY as yt, dV as jn, cs as Dn, dW as Zn, aV as $e, b9 as Mt, dX as Et, bb as Rt, c as o1, bY as M1, dY as Ft, dZ as _n, d_ as On, cr as Un, bq as zn, d$ as Gn, bh as C1, c5 as Wn, e0 as qn, e1 as Xn, e2 as Yn, e3 as Kn, e4 as Qn, a8 as Jn, af as es, y as ts, z as rs, ak as E1, e5 as Nt, e6 as Vt, e7 as os, e8 as ns, aj as ss, a7 as is, e9 as as, ea as cs, d as ls } from "./F0CanvasPanel-C3cwaYHv.js";
import { createPortal as St } from "react-dom";
import { defaultTranslations as ds } from "./i18n-provider-defaults.js";
import { useTrackVolume as fs } from "@livekit/components-react";
function us(e, r, o) {
  Fr(() => e.on(r, o), [e, r, o]);
}
const hs = (e, r) => /* @__PURE__ */ a(
  "svg",
  {
...
const b0 = (e, r) => /* @__PURE__ */ a(
  ...
  Calculator: Gr,
  Calendar: Wr,
  CalendarArrowDown: _s,
  CalendarArrowLeft: Us,
  CalendarArrowRight: Gs,
  CameraPlus: qs,
  CardPin: Ys,
  ChartFunnel: Qs,
  ChartHorizontalBars: ei,
  ChartLine: ri,
  ChartPie: ni,
  ChartVerticalBars: ii,
  Check: it,
  CheckCircle: qr,
  CheckCircleLine: ci,
  CheckDouble: Xr,
...
const Nc = Ve({
  ...
  ({
    ...
    const He = D && D !== "none" || ee && ee !== "none" || q && q !== "none" || Ce && Ce !== "none", Pe = _ && _ !== "none" || He, Qe = { sm: qe, md: Xe, lg: Ie, xl: Ye }, Je = Vc.map((je) => {
      const De = Qe[je];
      return De ? Fc(je, De) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(
...
function Hc({
  ...
  const n = /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ t(ce, { icon: nt, size: "md", color: "critical" }),
    ...
    /* @__PURE__ */ t(
      "button",
      {
        ...
        onClick: () => r(e.id),
        children: /* @__PURE__ */ t(ce, { icon: Fe, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ t(bn, { label: e.errorMessage, children: n }) : n;
}
const Ac = {
  soft: {
    text: "",
...
const Ic = ({
  ...
  return /* @__PURE__ */ t("div", { className: "p-1", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ t(ce, { icon: c1, size: "md", color: "default" }) }),
        /* @__PURE__ */ t(
          ie,
          {
  ...
  const s = ke(), [i, l] = $(""), [d, c] = $(0), [u, f] = $(!1), C = P(null), p = P(null), g = P(null), m = e[d] ?? r;
  return X(() => {
    const w = () => {
    ...
    if (s)
      return f(!1), l(m), w(), C.current = setTimeout(() => {
...
const _c = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ a(
    f1,
    {
      ...
      children: [
        /* @__PURE__ */ t(Mn, { asChild: !0, children: /* @__PURE__ */ t("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, c) => /* @__PURE__ */ t(u1, { asChild: !0, children: /* @__PURE__ */ t(
          ae,
          {
            variant: "outline",
            label: d.label,
          ...
          h1,
          {
            ...
            children: [
              /* @__PURE__ */ a("div", { className: "flex items-center gap-1.5 p-2 pb-1 text-sm font-medium text-f1-foreground-secondary", children: [
                /* @__PURE__ */ t(ce, { icon: l.icon, size: "sm" }),
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ t(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ t(ce, { icon: i1, size: "sm" })
                      }
                    )
                  ]
                },
...
const Gc = 4e3;
function Wc(e) {
  const [r, o] = $([]), [n, s] = $(null), i = P(
    null
  ), l = P(null), d = W(), c = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, C = J(() => {
    if (u)
      return Array.isArray(u) ? u.join(",") : u;
  }, [u]), p = f !== void 0 && r.length >= f, g = P(0);
  X(() => {
    g.current = r.length;
  }, [r]);
  const m = U((H) => {
    ...
    async (H) => {
      ...
      try {
        ...
        if (!Array.isArray(L) || L.length !== S.length) {
          M(d.ai.fileUploadError);
          return;
        }
        o(
          (B) => B.map((F) => {
            const V = R.findIndex((I) => I.id === F.id);
            return V === -1 ? F : L[V] ? {
              ...F,
              status: "uploaded",
              uploadedFile: L[V]
...
function Qc({
  ...
  const [i, l] = $(!1), [d, c] = $(""), [u, f] = $([]), [C, p] = $(!1), [g, m] = $(0), [w, x] = $([]), N = P(-1), A = P(null), H = P(0), S = P(-1);
  X(() => {
    if (!n) {
      l(!1);
      return;
    ...
    if (V.atIndex === S.current)
      return;
    N.current = V.atIndex, c(V.query), l(!0), m(0), p(!0), A.current && clearTimeout(A.current);
    const I = ++H.current;
    return A.current = setTimeout(() => {
      n(V.query).then((z) => {
        I === H.current && (f(z), m(0), z.length === 0 && V.query.length > 0 && (S.current = V.atIndex, l(!1)));
      }).catch(() => {
        I === H.current && f([]);
      }).finally(() => {
        I === H.current && p(!1);
  ...
  const R = U(() => {
    ...
    (V) => {
      const I = N.current;
      if (I === -1) return;
      const z = `${V.firstName} ${V.lastName}`.trim(), O = String(V.id), G = e.slice(0, I), re = e.slice(o), oe = `@${z} `, Y = G + oe + re, _ = G.length + oe.length;
      r(Y), x((D) => [...D.filter((q) => !(q.id === O && q.name === z)), { id: O, name: z }]), R(), requestAnimationFrame(() => {
        const D = s.current;
    ...
    (V) => {
      ...
      switch (V.key) {
        case "ArrowDown":
          return V.preventDefault(), m((I) => (I + 1) % u.length), !0;
        case "ArrowUp":
        ...
        case "Tab": {
          const I = u[g];
          if (I) {
            const z = `${I.firstName} ${I.lastName}`.trim();
            if (d.length === 0 || z.toLowerCase().startsWith(d.toLowerCase()))
              return V.preventDefault(), v(I), !0;
          }
          return !1;
        }
        case "Enter":
          return V.preventDefault(), u[g] && v(u[g]), !0;
        default:
          return !1;
      }
    },
    ...
    (V) => {
      ...
      let I = V;
      const z = [...w].sort((O, G) => G.name.length - O.name.length);
      for (const O of z) {
        const G = `@${O.name}`, re = `<entity-ref type="person" id="${R1(O.id)}">${R1(O.name)}</entity-ref>`;
        for (; I.includes(G); )
          I = I.replace(G, re);
      }
      return I;
  ...
  X(() => {
    x(
      (V) => V.filter((I) => {
        const z = `@${I.name}`, O = e.indexOf(z);
        if (O === -1) return !1;
        const G = e[O + z.length];
        return G === " " || G === `
` || G === "	";
      })
    );
  ...
  const B = J(() => {
    ...
    const V = s.current;
    if (!V) return null;
    const I = Yc(V, N.current), z = V.offsetLeft + I.left, G = (V.offsetParent ? V.offsetParent.offsetHeight : 0) - (V.offsetTop + I.top);
...
const Jc = /[\\`*_{}[\]()#+\-.!|~>]/g, e2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(Jc, "\\$&")).join(""), S6 = ({
  ...
  const v = W(), M = ke(), [L, B] = $(""), [F, V] = $(0), [I, z] = $(!1), [O, G] = $(!1), [re, oe] = $(null), Y = P(null), _ = P(null), D = P(null), ee = l != null, { tracking: q } = be(), Ce = U(
    (Q, xe) => {
    ...
    onError: (Q) => se(Te[Q])
  }), We = !!p && he.isSupported, qe = U(() => {
    q?.onDictationStart?.(), we.current = L, he.start();
  }, [L, he, q]), Xe = U(() => {
    q?.onDictationCancel?.(), he.cancel();
  }, [he, q]);
  X(() => {
  ...
  const Ie = he.status === "recording", Ye = Ie ? v.ai.listening : v.ai.inputPlaceholder, Ke = pe.filter((Q) => Q.status === "uploaded"), Ne = pe.some((Q) => Q.status === "uploading"), He = pe.some((Q) => Q.status === "error"), Pe = L.trim().length > 0;
  X(() => {
    if (!(!O || Ne)) {
      if (G(!1), He) {
        se(v.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const Qe = async (Q) => {
    if (Q.preventDefault(), !ee) {
      if (K.close(), o)
        ...
        const xe = K.transformMentions(L.trim()), e1 = e2(xe), _e = Ke.flatMap(
    ...
    V(_.current?.selectionStart ?? 0);
  }, De = () => {
    D.current && _.current && (D.current.scrollTop = _.current.scrollTop);
  }, v1 = re ? re.prompt ?? re.title : null, w1 = Ie ? [v.ai.listening] : v1 ? [v1] : s ?? [], yr = w1.length > 1, Mr = J(() => Oc(L, K.mentions, {
    cursorPosition: F,
    inlineCompletion: K.inlineCompletion
  }), [L, K.mentions, F, K.inlineCompletion]), Er = K.mentions.length > 0 || K.inlineCompletion !== null, Ze = N && !!H && H.length > 0 && !!S ? /* @__PURE__ */ t(
    _c,
    {
      suggestions: H,
      onItemClick: Ce,
    ...
    te.div,
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          Ze && !A && /* @__PURE__ */ t("div", { children: Ze }),
                    ...
                    children: [
                        ...
                        te.div,
                        {
                          ...
                          children: /* @__PURE__ */ a(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ t("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ t(Fn, { type: "critical", size: "sm" }) }),
                      ...
                      /* @__PURE__ */ t(
                        Sc,
                        {
                          ...
                          isPreSending: I || O,
                          canRecord: We,
                          recordingStatus: he.status,
                          recordingStream: he.stream,
                          onStartRecording: qe,
                          onStopRecording: he.stop,
        ...
        Ze && A && /* @__PURE__ */ t("div", { className: "w-full max-w-content", children: Ze }),
        x && N && A && /* @__PURE__ */ t("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: x }),
        /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: ee ? /* @__PURE__ */ a(
          ...
          te.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ t(ie, { className: "text-sm font-medium text-f1-foreground-tertiary", children: w.text }),
...
function i2({
  ...
  return /* @__PURE__ */ t(Vn, { ...r, variant: "link", href: r.href, children: e });
}
function a2({
  children: e,
  ...r
...
function Se({
  ...
  const i = P(/* @__PURE__ */ new Map()), [l, d] = $(
  ...
  return /* @__PURE__ */ a(
    Sn,
    {
      ...
      children: [
        /* @__PURE__ */ t(Tn, { asChild: !0, children: r }),
        /* @__PURE__ */ t(
          Hn,
          {
            side: "top",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ t($n, { file: e.file, size: "lg" }),
...
function A2(e) {
  const { days: r, hours: o, minutes: n, seconds: s } = In(e), i = [];
...
function ar({
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = be(), C = V2(e), p = d ?? C, g = P(() => {
  }), m = n ?? e, w = s ?? r ?? "", x = c?.type === "form" && c.formName === e, N = () => u({
    type: "form",
    title: m,
    description: w,
    formName: e,
  ...
  g.current = N, X(() => {
    typeof window > "u" || window.innerWidth < S2 || N1.has(e) || (N1.add(e), g.current());
  }, [e]);
  const A = i && l ? Object.entries(i).map(([R, v]) => {
    const M = l[R], L = p?.(R, M, {
      fieldType: v.fieldType,
      customFieldName: v.customFieldName
    });
    if (!L && v.fieldType === "custom" && typeof M == "object" && M !== null)
      return null;
    const B = L ?? ir(M, v.fieldType), F = ["richtext", "textarea"];
    return {
      label: v.label,
      content: B,
...
const dr = ze(void 0), $6 = () => Be(dr), P2 = (e) => /* @__PURE__ */ t(yt, { content: e, format: "markdown" }), j2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, C = P(null), { anchor: p, clear: g } = cr({
    containerRef: C,
    enabled: !!(o?.id && d)
  });
  return X(() => {
    o?.id && !r && !e && i?.(o);
  }, [o, r, e, i]), !r && !e && f ? null : /* @__PURE__ */ t(dr.Provider, { value: u, children: /* @__PURE__ */ a("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ t(
      "div",
      {
        ref: C,
  ...
  const [s, i] = $(""), l = W(), { title: d, label: c, placeholder: u } = o === "like" ? l.ai.feedbackModal.positive : l.ai.feedbackModal.negative, f = U(() => {
    r(n, s);
  }, [s, n, r]), C = () => {
    e(n);
  };
      ...
      children: [
        /* @__PURE__ */ a(
          Et,
          {
            ...
            children: [
              /* @__PURE__ */ t("span", { className: "flex items-center justify-start h-6 w-6", children: /* @__PURE__ */ t(ce, { icon: e, className: "block" }) }),
              /* @__PURE__ */ t("div", { className: "min-h-6 flex items-center", children: /* @__PURE__ */ t("span", { children: r }) }),
              !l && /* @__PURE__ */ t(ce, { icon: Ge })
            ]
          }
        ),
...
const hr = (e) => /* @__PURE__ */ t(yt, { content: e, format: "markdown" }), q2 = ({
  text: e,
  renderMarkdown: r
}) => /* @__PURE__ */ a("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ t("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ t(ce, { icon: c1 }) }),
  ...
  const l = e.rawData, d = W2(
    e?.content,
    l
  ), c = (G2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: C, clear: p } = cr({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
  ...
  X(() => {
    ...
    if (d === "starting")
      ...
      i < u.length ? p = setTimeout(() => l((g) => g + 1), Y2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => c("erasing"), J2);
    } else d === "erasing" && (i > 0 ? p = setTimeout(() => l((g) => g - 1), K2) : p = setTimeout(() => {
...
function rl({
  ...
  X(() => {
    const m = e.current, w = r.current;
    if (!m || !w) return;
    const x = new ResizeObserver(() => {
      if (C.current) return;
      const N = parseFloat(getComputedStyle(w).paddingTop) + parseFloat(getComputedStyle(w).paddingBottom) + 1;
      d(m.clientHeight - N);
    });
    return x.observe(m), x.observe(w), () => x.disconnect();
  }, [e, r]);
  const g = U(() => {
    const m = e.current;
    if (!m) return;
    const { scrollTop: w, scrollHeight: x, clientHeight: N } = m, A = x - w - N;
    u(A > N);
  }, [e]);
  return X(() => {
    const m = e.current;
    ...
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const m = e.current, w = n.current;
        if (!m || !w) return;
        const x = m.getBoundingClientRect(), N = w.getBoundingClientRect(), A = m.scrollTop + (N.top - x.top);
...
const ol = {
  ...
  const { modal: H, handleSubmit: S, handleClose: R } = _2(
    f ?? ol
  ), v = W(), M = w ?? j2, L = x ?? X2, B = J(() => {
    const D = n ?? v.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((q) => typeof q == "string" && q.length > 0);
  }, [n, v.ai.defaultInitialMessage]), F = !r && e.length === 0 && B.length > 0, V = P(null), I = P(null), z = P(null), O = P(null), G = P(null), { showScrollBtn: re, turnMinHeight: oe, scrollToBottom: Y } = rl({
    viewportRef: V,
    contentRef: I,
    endRef: z,
    lastTurnRef: G,
    ...
    const q = ee === e.length - 1, Ce = {
      ...
      const ve = q && le === D.assistantMessages.length - 1, b = D.userMessages.length + le, E = {
        message: ne,
        inProgress: D.isInProgress,
        index: b,
        isCurrentMessage: ve,
    ...
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        children: [
          ...
          D.endIndicator === "thinking" && /* @__PURE__ */ t(o1, { title: v.ai.thinking, status: "executing" }),
          ...
          children: /* @__PURE__ */ a(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ t(Ee, { children: re && /* @__PURE__ */ t(
                  te.div,
                  {
...
const al = ({
  ...
  const p = W().ai.clarifyingQuestion.typeYourAnswer, g = e === "single" ? /* @__PURE__ */ t(Cr, { isSelected: o && !r }) : /* @__PURE__ */ t(
    Ft,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const ll = ({
  ...
  const N = ke(), A = (() => {
    ...
    const M = o.findIndex((L) => n.includes(L.id));
    return M >= 0 ? M : 0;
  })(), [H, S] = $(A), R = P([]);
  X(() => {
  ...
  const v = (M) => {
    ...
    M.preventDefault(), S(B), R.current[B]?.focus();
  };
  return /* @__PURE__ */ a(
    "div",
    {
  ...
  } = s, M = P(null), L = A ?? "single", B = l > 1, F = i === 0, V = i === l - 1, I = B ? o.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(l)
  }) : void 0, z = N.length > 0, O = (R ?? "").trim().length > 0, G = z || v && O || H === !0, re = r === !0 && V, oe = () => {
    re || c();
  }, Y = () => {
    re || u();
  }, _ = (ue) => {
    const ne = L === "single" && N.includes(ue);
    d(ue), L === "single" && !V && !ne && Promise.resolve().then(c);
  }, D = V ? o.ai.clarifyingQuestion.submit : o.ai.clarifyingQuestion.next, ee = H === !0 && !z && !(v && O), q = () => {
    m(), requestAnimationFrame(() => {
      M.current?.focus();
    });
  }, Ce = (ue) => {
    ue.key === "Escape" && (ue.preventDefault(), f());
  }, pe = n ? 0 : ul / 2;
...
function A1(e, r, o, n) {
  const s = Math.max(1, Math.min(e, r)), i = Math.min(o, 20), d = Math.min(i + n, s), c = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(r / 2)), f = (q) => q / e * 2 - 1, C = (q) => q / r * 2 - 1, p = 0, g = e, m = 0, w = r, x = c, N = e - c, A = u, H = r - u, S = f(p), R = f(g), v = C(m), M = C(w), L = f(x), B = f(N), F = C(A), V = C(H), I = 0, z = 0, O = 1, G = 1, re = c / e, oe = 1 - c / e, Y = u / r, _ = 1 - u / r, D = new Float32Array([
    // Top strip
    S,
    v,
    R,
...
class _6 {
  ...
  resize(r, o, n) {
    ...
    s.enableVertexAttribArray(w), s.vertexAttribPointer(w, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, c), s.bufferData(s.ARRAY_BUFFER, m, s.STATIC_DRAW);
  ...
  setupGL() {
    ...
    const p = r.getUniformLocation(o, "uResolution"), g = r.getUniformLocation(o, "uTime"), m = r.getUniformLocation(o, "uBorderWidth"), w = r.getUniformLocation(o, "uGlowWidth"), x = r.getUniformLocation(o, "uBorderRadius"), N = r.getUniformLocation(o, "uColors"), A = r.getUniformLocation(o, "uGlowExponent"), H = r.getUniformLocation(o, "uGlowFactor");
    r.useProgram(o), r.uniform1f(m, this.options.borderWidth), r.uniform1f(w, this.options.glowWidth), r.uniform1f(x, this.options.borderRadius), this.options.mode === "dark" ? (r.uniform1f(A, 2), r.uniform1f(H, 1.8)) : (r.uniform1f(A, 1), r.uniform1f(H, 1));
...
class Fl {
  ...
  load = async (r) => {
    ...
    const C = 0, p = o.RGBA, g = 1, m = 1, w = 0, x = o.RGBA, N = o.UNSIGNED_BYTE, A = new Uint8Array([255, 255, 255, 0]), H = o.createTexture();
    if (o.bindTexture(o.TEXTURE_2D, H), o.texImage2D(
      ...
      return o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.LINEAR), this._webglTexture = H, this.source = M, this.isVideo = !0, M.play().then(() => this);
    }
    async function S() {
      return new Promise((M, L) => {
        ...
        B.crossOrigin = "anonymous", B.onload = () => {
          ...
          L(new Error(Le(`failed loading url: ${n}`)));
        }, B.src = n ?? "";
      });
    }
    let R = await S(), v = (R.width & R.width - 1) === 0 && (R.height & R.height - 1) === 0;
    return (r.wrapS !== W1 || r.wrapT !== W1 || r.minFilter !== G1 && r.minFilter !== r1) && !v && (R = this.makePowerOf2(R), v = !0), o.bindTexture(o.TEXTURE_2D, H), o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL, c), o.texImage2D(
      o.TEXTURE_2D,
      C,
      p,
      x,
      N,
      R
    ), v && r.minFilter !== G1 && r.minFilter !== r1 && o.generateMipmap(o.TEXTURE_2D), o.texParameteri(
      o.TEXTURE_2D,
      o.TEXTURE_WRAP_S,
      this.wrapS || q1
    ), o.texParameteri(
...
function Vl({
  ...
  const g = P(null), m = P(null), w = P(null), x = P(null), N = P(void 0), A = P(void 0), H = P(!1), S = P(void 0), R = P(0), v = P([0, 0]), M = P([]), L = P(0), B = P(void 0), F = P({
    ...
    Z[E * 3] = y * u, Z[E * 3 + 1] = j * u, Z[E * 3 + 2] = 0;
  }, z = () => {
    ...
    const b = m.current;
    w.current = b?.createBuffer() ?? null, b?.bindBuffer(b.ARRAY_BUFFER, w.current);
    const E = [
      1,
      1,
      0,
    ...
    const [E = 0, y = 0] = X1(b), j = E - (S.current?.left ?? 0) - window.pageXOffset, T = (S.current?.height ?? 0) - y - (S.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    const Z = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
    Z && (Z[2] = j, Z[3] = T), v.current[0] = j, v.current[1] = T;
  }, oe = (b) => {
    S.current = g.current?.getBoundingClientRect();
    const [E = 0, y = 0] = X1(b), j = E - (S.current?.left ?? 0), T = (S.current?.height ?? 0) - y - (S.current?.top ?? 0);
    if (c !== 1)
      v.current[0] = j, v.current[1] = T;
    else {
      const Z = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
      Z && (Z[0] = j, Z[1] = T);
    }
    ...
    if (!b) return;
    S.current = g.current?.getBoundingClientRect();
    const E = u, y = Math.floor(
      (S.current?.width ?? 1) * E
    ), j = Math.floor(
      (S.current?.height ?? 1) * E
    );
    ...
    if (!j) return null;
    if (y.shaderSource(j, E), y.compileShader(j), !y.getShaderParameter(j, y.COMPILE_STATUS)) {
      p?.(Le(`Error compiling the shader:
${E}`));
      const T = y.getShaderInfoLog(j);
      y.deleteShader(j), C?.(Le(`Shader compiler log: ${T}`));
    }
    return j;
  }, ee = (b, E) => {
    const y = m.current;
    if (!y) return;
    const j = D(y.FRAGMENT_SHADER, b), T = D(y.VERTEX_SHADER, E);
    ...
    if (n)
      for (const b of Object.keys(n)) {
        const E = n[b];
        if (!E) continue;
        const { value: y, type: j } = E, T = El(j);
        if (!T) continue;
        const Z = {};
        if (Ll(j, y)) {
          const se = j.length, K = Number.parseInt(j.charAt(se - 3)), we = Math.floor(y.length / (K * K));
          y.length > K * K && (Z.arraySize = `[${we}]`);
        } else bl(j, y) && (Z.arraySize = `[${Math.floor(y.length / Number.parseInt(j.charAt(0)))}]`);
        F.current[b] = {
          type: T,
          isNeeded: !1,
          value: y,
      ...
      if (o && o.length > 0) {
        ...
        const E = o.map(
          (y, j) => (F.current[`${kl}${j}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, I(y, j), M.current[j] = new Fl(b), M.current[j]?.load(y).then((T) => {
            I(T, j);
          }))
        );
        Promise.all(E).then(() => {
    ...
    const E = B1.includes(i ?? "highp"), y = `precision ${E ? i : B1[1]} float;
`;
    E || p?.(
      Le(
...
`,
    ...
    return b.includes("mainImage") && (j = j.concat(wl)), j;
  }, ue = (b) => {
    const E = m.current;
    ...
    if (F.current.iMouse?.isNeeded) {
      ...
      E.uniform4fv(T, F.current.iMouse.value);
    }
    ...
    if (F.current.iDate?.isNeeded) {
      const T = /* @__PURE__ */ new Date(), Z = T.getMonth() + 1, se = T.getDate(), K = T.getFullYear(), we = T.getHours() * 60 * 60 + T.getMinutes() * 60 + T.getSeconds() + T.getMilliseconds() * 1e-3, ye = E.getUniformLocation(
        x.current,
        D1
      );
      E.uniform4fv(ye, [K, Z, se, we]);
    }
    if (F.current.iFrame?.isNeeded) {
      ...
      E.uniform1i(T, Z), F.current.iFrame.value = Z + 1;
    }
    if (M.current.length > 0)
      for (let T = 0; T < M.current.length; T++) {
        const Z = M.current[T];
        if (!Z) return;
        ...
        if (F.current[`iChannel${T}`]?.isNeeded) {
          if (!x.current) return;
          const he = E.getUniformLocation(
            x.current,
            `iChannel${T}`
          );
          E.activeTexture(E.TEXTURE0 + T), E.bindTexture(E.TEXTURE_2D, K), E.uniform1i(he, T), se && Z.updateTexture(
            K,
            we,
            ye
          );
    ...
    const E = m.current;
    if (!E) return;
    E.viewport(0, 0, E.drawingBufferWidth, E.drawingBufferHeight), E.clear(E.COLOR_BUFFER_BIT | E.DEPTH_BUFFER_BIT), E.bindBuffer(E.ARRAY_BUFFER, w.current), E.vertexAttribPointer(
      N.current ?? 0,
      3,
      E.FLOAT,
      !1,
      0,
      0
    ), ue(b), E.drawArrays(E.TRIANGLE_STRIP, 0, 4);
    const y = F.current.iMouse?.value;
    if (F.current.iMouse?.isNeeded && c !== 1 && Array.isArray(y)) {
      const j = y[0] ?? 0, T = y[1] ?? 0;
      y[0] = Y1(j, v.current[0] ?? 0, c), y[1] = Y1(T, v.current[1] ?? 0, c);
    }
    A.current = requestAnimationFrame(ne);
  }, le = () => {
    const b = { passive: !0 };
    F.current.iMouse?.isNeeded && g.current && (g.current.addEventListener("mousemove", oe, b), g.current.addEventListener("mouseout", Y, b), g.current.addEventListener("mouseup", Y, b), g.current.addEventListener("mousedown", re, b), g.current.addEventListener("touchmove", oe, b), g.current.addEventListener("touchend", Y, b), g.current.addEventListener("touchstart", re, b)), F.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      G,
      b
    ), g.current && (B.current = new ResizeObserver(_), B.current.observe(g.current), window.addEventListener("resize", _, b));
  }, ve = () => {
    const b = { passive: !0 };
    F.current.iMouse?.isNeeded && g.current && (g.current.removeEventListener("mousemove", oe, b), g.current.removeEventListener("mouseout", Y, b), g.current.removeEventListener("mouseup", Y, b), g.current.removeEventListener("mousedown", re, b), g.current.removeEventListener("touchmove", oe, b), g.current.removeEventListener("touchend", Y, b), g.current.removeEventListener("touchstart", re, b)), F.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      G,
      b
    ), B.current && (B.current.disconnect(), window.removeEventListener("resize", _, b));
  };
  return X(() => {
    V.current = n;
  }, [n]), X(() => {
    ...
    function E() {
      z();
      const y = m.current;
      y && g.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, q(), Ce(), ee(pe(e || xl), r || I1), O(), requestAnimationFrame(ne), le(), _());
    }
    return requestAnimationFrame(E), () => {
      ...
      ve(), cancelAnimationFrame(A.current ?? 0);
    };
  }, []), /* @__PURE__ */ t(
    "canvas",
    {
...
function Il(e, r) {
  const [o, n] = $(Tl), {
    ...
    animate: i,
    motionValue: l
  } = Oe($l), { value: d, animate: c } = Oe(Hl), { value: u, animate: f } = Oe(Al), { value: C, animate: p } = Oe(Bl), g = fs(r, {
    fftSize: 512,
  ...
  return X(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, ge), c(1.2, ge), f(0.4, ge), p(1, ge);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), c(1, ge), f(0.7, ge), p([1.5, 2], K1);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, ge), c(0.5, ge), f(1, ge), p([0.5, 2.5], K1);
        return;
      case "speaking":
        n(70), i(0.3, ge), c(0.75, ge), f(1.25, ge), p(1.5, ge);
        return;
    }
  }, [
    e,
...
function O6({
  ...
  const { speed: u, scale: f, amplitude: C, frequency: p, brightness: g } = Il(r, s);
  return /* @__PURE__ */ t(
    mr,
    {
      ref: d,
    ...
    /* @__PURE__ */ a(
      te.div,
      {
        ...
        children: [
          ...
          n === "alert" && /* @__PURE__ */ t(Wn, { text: e.alertLabel, level: e.level }),
...
const Wl = ({
  ...
  const s = `sparkline-gradient-${ot().replace(/:/g, "")}`, i = Gl(e, o), l = wr[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(Xn, { width: "100%", height: "100%", children: /* @__PURE__ */ a(
          Yn,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ t(Kn, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ t(
                Qn,
                {
                  type: "linear",
  ...
  (e, r) => {
    const {
      ...
      className: c,
      ...u
    } = e, [f, C] = $(!1), [p, g] = $(!1), m = f || p, w = ke(), x = m && !!d, N = {
      duration: w ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, A = () => {
      l?.();
...
const Yl = ["className"], kr = h((e, r) => {
  const o = Yl.reduce((n, s) => {
    const { [s]: i, ...l } = n;
    return l;
  }, e);
  return /* @__PURE__ */ t(xr, { ref: r, ...o });
});
...
const Kl = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], Lr = 180, Ql = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Lr, Jl = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, e6 = (e) => e.showActions !== !1, t6 = (e) => Object.fromEntries(
...
function r6(e) {
  ...
  } = e, [c, u] = $(!1), f = ot(), C = P(null), p = Ql(
    d
  ), g = i.length > p, m = c ? i : Jl(i, p), w = e6(e) ? e : null, x = t6(e);
  return X(() => {
    c && C.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
    {
      ...
      children: [
        ...
        w && /* @__PURE__ */ t("div", { className: "flex items-center justify-end gap-3 border-0 border-t border-solid border-f1-border-secondary px-4 py-3", children: /* @__PURE__ */ t(
          me,
          {
            type: "button",
    ...
    Mt,
    {
      ...
      children: [
        /* @__PURE__ */ a(Et, { className: "flex w-full items-center text-base text-f1-foreground-secondary transition-colors duration-150 hover:text-f1-foreground [&[data-state=open]>svg]:rotate-90", children: [
          /* @__PURE__ */ t("span", { className: "mr-2 *:block", children: /* @__PURE__ */ t(ce, { icon: e, className: "block" }) }),
...
}, n6 = (e) => lc[e] ?? ft, s6 = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(ce, { icon: n6(e), size: "md", color: "default" }) }) : null;
function i6({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(o6, { icon: l1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
...
function c6({
  ...
  const n = W(), s = P(null), i = r ?? n.ai.aiTable.title, l = U(
    (d) => {
      if (!s.current) return;
...
function l6({ credits: e, trigger: r }) {
  const o = W(), [n, s] = $(!1), [i, l] = $(!1), [d, c] = $(!1), [u, f] = $(null), C = U(
    (m) => {
      s(m), m && e?.fetchUsage && (l(!0), c(!1), e.fetchUsage().then((w) => {
        f(w), c(!1);
      }).catch(() => {
        c(!0);
      }).finally(() => {
  ...
  return /* @__PURE__ */ a(f1, { open: n, onOpenChange: C, children: [
    /* @__PURE__ */ t(u1, { asChild: !0, children: r ?? /* @__PURE__ */ t(
      ae,
      {
        variant: "ghost",
        hideLabel: !0,
...
function f6({
  ...
  const o = W(), n = ke(), [s, i] = $(!1), [l, d] = $(!1), [c, u] = $(!1), [f, C] = $(null), p = U(
    (x) => {
  ...
  if (!e) return null;
  const g = !!e.companyName, m = f && f.total > 0 ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, w = f ? Math.max(0, f.total - f.used) : 0;
...
const s1 = ({
...
) : e ? /* @__PURE__ */ t(l6, { credits: e, trigger: o }) : null, W6 = s1, q6 = ({
  historyEnabled: e = !1,
  title: r,
  ...
  const g = W(), m = ts(`(max-width: ${rs.md}px)`, {
        ...
        /* @__PURE__ */ t("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ t(
          $e,
          {
            ...
            children: /* @__PURE__ */ a("div", { className: "flex min-w-0 items-center gap-1", children: [
              ...
              /* @__PURE__ */ t(ce, { icon: a1, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ a(
...
function u6() {
  if (!(typeof navigator > "u"))
    return ss(navigator.language);
}
function h6(e) {
  const r = new Date(e), o = /* @__PURE__ */ new Date();
  return Nt(r) ? "today" : Vt(r) ? "yesterday" : ns(r, o) ? "thisMonth" : "older";
}
function g6(e, r) {
  const o = new Date(e), n = u6(), s = E1(o, "p", { locale: n });
  if (Nt(o)) return `${r.today}, ${s}`;
  if (Vt(o)) return `${r.yesterday}, ${s}`;
  const i = !os(o, /* @__PURE__ */ new Date());
...
const J1 = ["w-3/5", "w-4/5", "w-2/5", "w-3/4", "w-1/2", "w-2/3"], m6 = ({ width: e }) => /* @__PURE__ */ t("div", { className: "flex items-center py-1.5 pl-1.5 pr-2", children: /* @__PURE__ */ t(de, { className: k("h-4 rounded", e) }) }), et = ({
  titleWidth: e,
  rows: r
}) => /* @__PURE__ */ a("div", { className: "flex flex-col gap-0.5", children: [
  /* @__PURE__ */ t("div", { className: "flex items-center p-1.5", children: /* @__PURE__ */ t(de, { className: k("h-3 rounded", e) }) }),
...
const X6 = ({
  ...
  const g = J(
    ...
    return n.filter((M) => M.title.toLowerCase().includes(v));
  }, [n, C]), w = J(
    () => m.filter((v) => l.has(v.id)),
    [m, l]
  ), x = J(
    () => m.filter((v) => !l.has(v.id)),
    [m, l]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ t(ce, { icon: l1, color: "secondary", size: "md" }),
                  /* @__PURE__ */ t(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ a("div", { className: "flex flex-1 flex-col gap-1 overflow-y-auto p-2", children: [
                  /* @__PURE__ */ t(
                    $e,
                    {
                      ...
                      children: /* @__PURE__ */ a("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ t(ce, { icon: p1, color: "default", size: "md" }),
                  ...
                  !s && !i && !R && /* @__PURE__ */ t("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: f.ai.noPreviousChats }),
                  !s && !i && w.length > 0 && /* @__PURE__ */ t(
                    Q1,
                    {
...
function Y6({
  ...
  const [i, l] = $([]), [d, c] = $(!1), [u, f] = $(null), [C, p] = $(w6), [g, m] = $(() => /* @__PURE__ */ new Set()), w = U(async () => {
    c(!0), f(null);
    try {
      const v = await r();
      l(v);
    } catch (v) {
      const M = v instanceof Error ? v.message : "Failed to fetch chat history";
      f(M), l([]);
    } finally {
      c(!1);
    }
  ...
  const x = U((v, M) => {
    p((L) => {
      if (M === L.has(v)) return L;
      const B = new Set(L);
      return M ? B.add(v) : B.delete(v), tt(B), B;
    });
  }, []), N = U((v, M) => {
    m((L) => {
      if (M === L.has(v)) return L;
      const B = new Set(L);
      return M ? B.add(v) : B.delete(v), B;
    });
  }, []), A = U(
    (v, M) => {
      const L = M ? n : s;
      x(v, M), L && (N(v, !0), L(v).catch(() => x(v, !M)).finally(() => N(v, !1)));
    },
    [n, s, x, N]
  ), H = U((v) => A(v, !0), [A]), S = U(
    (v) => A(v, !1),
    ...
    async (v) => {
      N(v, !0);
      try {
        await o(v), l((M) => M.filter((L) => L.id !== v)), p((M) => {
          if (!M.has(v)) return M;
          const L = new Set(M);
          return L.delete(v), tt(L), L;
        });
      } catch {
        w();
      } finally {

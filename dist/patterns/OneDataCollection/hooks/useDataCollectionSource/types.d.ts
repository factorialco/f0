import { BaseDataAdapter, BaseFetchOptions, BaseResponse, DataSource, DataSourceDefinition, FiltersDefinition, FiltersState, GroupingDefinition, PaginatedDataAdapter, PaginatedFetchOptions, PaginatedResponse, RecordType, SortingsDefinition } from '../../../../hooks/datasource/types';
import { AvatarVariant } from '../../../../components/avatars/F0Avatar';
import { PrimaryActionsDefinitionFn, SecondaryActionsDefinition, UpsellActionDefinitionFn } from '../../actions';
...
export type BulkActionsDefinition<R extends RecordType, Filters extends FiltersDefinition> = (selectedItems: Parameters<OnBulkActionCallback<R, Filters>>[1]) => {
...
export type DataCollectionBaseFetchOptions<Filters extends FiltersDefinition, NavigationFilters extends NavigationFiltersDefinition> = BaseFetchOptions<Filters> & DataCollectionExtendFetchOptions<NavigationFilters>;
/**
 * Extended base fetch options for data collection
 */
export type DataCollectionPaginatedFetchOptions<Filters extends FiltersDefinition, NavigationFilters extends NavigationFiltersDefinition> = PaginatedFetchOptions<Filters> & DataCollectionExtendFetchOptions<NavigationFilters>;
/**

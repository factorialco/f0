import { FiltersDefinition, PresetsDefinition } from '../../../OneFilterPicker/types';
import { IconType } from '../../../../components/F0Icon';
import { OnSelectItemsCallback, RecordType } from '../../../../hooks/datasource';
import { SortingsDefinition } from '../../../../hooks/datasource/types/sortings.typings';
import { DataCollectionDataAdapter, DataCollectionSource } from '../../hooks/useDataCollectionSource/types';
import { GroupingDefinition, OnLoadDataCallback, OnLoadErrorCallback } from '../../types';
import { CardVisualizationOptions } from './Card';
import { EditableTableVisualizationOptions } from './EditableTable';
import { GraphVisualizationOptions } from './Graph/types';
import { KanbanVisualizationOptions } from './Kanban';
import { TableVisualizationOptions } from './Table';
 ...
 */
export type VisualizationFilterOverrides<Filters extends FiltersDefinition, Sortings extends SortingsDefinition = SortingsDefinition> = {
 ...
 */
export type Visualization<R extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, Summaries extends SummariesDefinition, ItemActions extends ItemActionsDefinition<R>, NavigationFilters extends NavigationFiltersDefinition, Grouping extends GroupingDefinition<R>> = ({
 ...
 */
export type VisualizationProps<Record extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, Summaries extends SummariesDefinition, ItemActions extends ItemActionsDefinition<Record>, NavigationFilters extends NavigationFiltersDefinition, Grouping extends GroupingDefinition<Record>> = {
...
export type CustomVisualizationProps<Source extends {

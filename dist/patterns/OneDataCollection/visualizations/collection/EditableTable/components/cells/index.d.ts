...
export type EditableCellProps<R extends RecordType> = {
    editableColumn: EditableTableColumnDefinition<R, SortingsDefinition, SummariesDefinition>;
    value: string;
    inputPlaceholder?: string;
    error?: string;
    loading?: boolean;
    onChange: (value: string | string[] | null, context?: {
...
export type EditableTableCellEditType = "text" | "number" | "money" | "date" | "select" | "multiselect" | "display-only" | "disabled";

 ...
 */
export declare function resolveGraphReveal({ isInitialLoading, initialConsumed, revealNodeId, lastRevealed, revealNonce, lastNonce, }: RevealState): RevealDecision;
export {};

...
declare const FlatRowComponentInner: <R extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, Summaries extends SummariesDefinition, ItemActions extends ItemActionsDefinition<R>, NavigationFilters extends NavigationFiltersDefinition, Grouping extends GroupingDefinition<R>>({ source, item, onCheckedChange, selectedItems, columns, frozenColumnsLeft, checkColumnWidth, index, groupIndex, noBorder, loading, nestedRowProps, tableWithChildren, disableHover, isNew, referenceRowType: referenceRowTypeFn, boldRootRows, cellRenderer: CellRenderer, fromVisualization, headerGroups, collapsingCellClasses, registerSelectable, unregisterSelectable, }: RowProps<R, Filters, Sortings, Summaries, ItemActions, NavigationFilters, Grouping>, ref: React.ForwardedRef<HTMLTableRowElement>) => import("react").JSX.Element;
declare const FlatRow: <R extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, Summaries extends SummariesDefinition, ItemActions extends ItemActionsDefinition<R>, NavigationFilters extends NavigationFiltersDefinition, Grouping extends GroupingDefinition<R>>(props: RowProps<R, Filters, Sortings, Summaries, ItemActions, NavigationFilters, Grouping> & {
    ref?: React.ForwardedRef<HTMLTableRowElement>;
    fromVisualization?: TableVisualizationType;
}) => ReturnType<typeof FlatRowComponentInner>;
export { FlatRow };

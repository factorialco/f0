...
import { DateGranularity } from '../date/types';
/**
 ...
 */
export type DateRangeFieldRenderIf = DateRangeRenderIfCondition | CommonRenderIfCondition | F0BaseFieldRenderIfFunction;
/**
 ...
 */
export type F0DateRangeField = F0BaseField & F0DateRangeConfig & {
    type: "daterange";

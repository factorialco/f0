 ...
 */
export type NumberFieldRenderIf = NumberRenderIfCondition | CommonRenderIfCondition | F0BaseFieldRenderIfFunction;
/**
 ...
 */
export type F0NumberField = F0BaseField & F0NumberConfig & {
    type: "number";

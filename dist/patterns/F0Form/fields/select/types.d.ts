...
import { DataSourceDefinition, FiltersDefinition, SortingsDefinition, GroupingDefinition, RecordType } from '../../../../hooks/datasource';
 ...
 */
export type SelectFieldRenderIf = SelectRenderIfCondition | CommonRenderIfCondition | F0BaseFieldRenderIfFunction;
/**
 ...
 */
interface F0SelectConfigWithOptions<T extends SelectValueType = string> extends F0SelectConfigBase {
 ...
 */
interface F0SelectConfigWithSource<T extends SelectValueType = string, R extends RecordType = RecordType> extends F0SelectConfigBase {
 ...
 */
export type F0SelectConfig<T extends SelectValueType = string, R extends RecordType = RecordType> = F0SelectConfigWithOptions<T> | F0SelectConfigWithSource<T, R> | F0SelectConfigWithCustomFieldName;
/**
 * Select field with all properties for rendering
 * Includes properties derived from Zod schema
 */
export type F0SelectField = F0BaseField & F0SelectConfig & {
    type: "select";

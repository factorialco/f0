 ...
 */
export type TextFieldRenderIf = TextRenderIfCondition | CommonRenderIfCondition | F0BaseFieldRenderIfFunction;
/**
 ...
 */
export type F0TextField = F0BaseField & F0TextConfig & {
    type: "text";

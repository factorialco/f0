 ...
 */
export type CustomFieldRenderIf = CommonRenderIfCondition | F0BaseFieldRenderIfFunction;
/**
 ...
 * ```
 */
export type F0CustomConfig<TValue = unknown, TConfig = undefined> = TConfig extends undefined ? F0CustomConfigBase<TValue> : F0CustomConfigWithFieldConfig<TValue, TConfig>;
/**

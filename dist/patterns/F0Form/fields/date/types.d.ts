 ...
 */
export type DateGranularity = "day" | "week" | "month" | "quarter" | "halfyear" | "year" | "range";
/**
 ...
 */
export type DateFieldRenderIf = DateRenderIfCondition | CommonRenderIfCondition | F0BaseFieldRenderIfFunction;
/**
 ...
 */
export type F0DateField = F0BaseField & F0DateConfig & {
    type: "date";
 ...
 */
export type F0TimeField = F0BaseField & F0TimeConfig & {
    type: "time";
 ...
 * Includes properties derived from Zod schema
 */
export type F0DateTimeField = F0BaseField & F0DateTimeConfig & {
    type: "datetime";
 ...
 */
export type ResolvedDateField = Omit<F0DateField, "disabled" | "minDate" | "maxDate"> & {
    disabled?: boolean;
    minDate?: Date;
    maxDate?: Date;
};
 ...
 * Used internally by renderers.
 */
export type ResolvedTimeField = Omit<F0TimeField, "disabled" | "minDate" | "maxDate"> & {
    disabled?: boolean;
    minDate?: Date;
    maxDate?: Date;
};
 ...
 * Used internally by renderers.
 */
export type ResolvedDateTimeField = Omit<F0DateTimeField, "disabled" | "minDate" | "maxDate"> & {
    disabled?: boolean;
    minDate?: Date;
    maxDate?: Date;
};

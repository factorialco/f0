import { F0PhoneInputValue } from '../../../../experimental/Forms/F0PhoneInput';
import { CountryCode } from '../../../../lib/countries';
import { CommonRenderIfCondition, F0BaseField, F0BaseFieldRenderIfFunction } from '../types';
/**
 * All valid renderIf conditions for phone fields
 */
export type PhoneFieldRenderIf = CommonRenderIfCondition | F0BaseFieldRenderIfFunction;
/**
 ...
 */
export type F0PhoneField = F0BaseField & F0PhoneConfig & {
    type: "phone";

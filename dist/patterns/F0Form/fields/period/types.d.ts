import { DatePreset } from '../../../../components/F0DatePicker';
...
import { DateGranularity, F0DateConstraintProp } from '../date/types';
...
export type PeriodFieldRenderIf = PeriodRenderIfCondition | CommonRenderIfCondition | F0BaseFieldRenderIfFunction;
/**
 ...
 */
export type F0PeriodField = F0BaseField & F0PeriodConfig & {
    type: "period";
 ...
 */
export type ResolvedPeriodField = Omit<F0PeriodField, "disabled" | "minDate" | "maxDate"> & {
    disabled?: boolean;
    minDate?: Date;
    maxDate?: Date;
};

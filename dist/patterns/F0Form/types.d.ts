...
import { CustomFieldRenderPropsBase } from './fields/custom/types';
import { UseFileUpload } from './fields/file/types';
import { F0Field, F0BaseFieldRenderIfFunction, RenderIfCondition, InitialFile } from './fields/types';
import { F0FormRef } from './useF0Form';
export type { F0FieldConfig, F0FieldType, F0MoreInfoLink, F0FieldAlertProps, F0FieldAlertFunction, F0FieldAlert, F0ZodType, } from './f0Schema';
export { f0FormField, getF0Config, hasF0Config, inferFieldType, } from './f0Schema';
 ...
 */
export type F0FormSubmitConfig = F0FormDefaultSubmitConfig | F0FormActionBarSubmitConfig | F0FormAutosubmitConfig;
/**
 ...
 */
export type RenderCustomFieldResult = React.ReactNode | RenderCustomFieldSelectConfig;
/**
 ...
 */
export type RenderCustomFieldFunction = (props: RenderCustomFieldProps) => RenderCustomFieldResult;
/**
 ...
 */
type PerSectionSubmitHandler<T extends F0PerSectionSchema> = (...args: PerSectionSubmitArgs<T>) => Promise<F0FormSubmitResult> | F0FormSubmitResult;
/**
 ...
 */
export interface F0FormPropsWithSingleSchemaDefinition<TSchema extends F0FormSchema> {
    formDefinition: import('../F0WizardForm/types').F0FormDefinitionSingleSchema<TSchema>;
    className?: string;
    styling?: F0FormStylingConfig;
    formRef?: React.MutableRefObject<F0FormRef | null>;
    initialFiles?: InitialFile[];
 ...
 * props are passed directly.
 */
export interface F0FormPropsWithPerSectionDefinition<T extends F0PerSectionSchema> {
    formDefinition: import('../F0WizardForm/types').F0FormDefinitionPerSection<T>;
    className?: string;
    styling?: F0FormPerSectionStylingConfig;
    formRef?: React.MutableRefObject<F0FormRef | null>;
    initialFiles?: InitialFile[];
...
export interface F0FormPropsWithDefinition {
    formDefinition: import('../F0WizardForm/types').F0FormDefinition;
    className?: string;
    styling?: F0FormStylingConfig;
    formRef?: React.MutableRefObject<F0FormRef | null>;
    initialFiles?: InitialFile[];
...
export interface F0FormCommonProps {
    formDefinition: import('../F0WizardForm/types').F0FormDefinitionSingleSchema<F0FormSchema> | import('../F0WizardForm/types').F0FormDefinitionPerSection<F0PerSectionSchema>;
    className?: string;
    styling?: F0FormStylingConfig;
    formRef?: React.MutableRefObject<F0FormRef | null>;
    initialFiles?: InitialFile[];

...
import { FilterPickerBaseProps } from './internal-types';
/**
 * Props for the F0FilterPickerContent component.
 * @template Filters - The type defining the structure of available filters
 */
export interface F0FilterPickerContentProps<Filters extends FiltersDefinition> extends FilterPickerBaseProps<Filters> {
 ...
 * @template Filters - The type defining the structure of available filters
 */
export type F0FilterPickerContentPublicProps<Filters extends FiltersDefinition> = F0FilterPickerContentProps<Filters> & {
    dataTestId?: string;
};

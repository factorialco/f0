...
import { EdgeVariant } from './components/F0GraphEdge';
import { F0GraphNodeTagColumn, GraphNodeState, GraphNodeVariant } from './components/F0GraphNode';
import { DeferredNodesPayload, GraphEdge, GraphNode, LayoutEngine, ViewportInset, ZoomLevel, ZoomPreset, ZoomThresholds } from './types';
...
declare function F0GraphInner<T = unknown>(props: F0GraphProps<T>, ref: ForwardedRef<F0GraphHandle>): import("react").JSX.Element;
export declare const F0Graph: <T = unknown>(props: F0GraphProps<T> & {
    ref?: Ref<F0GraphHandle>;

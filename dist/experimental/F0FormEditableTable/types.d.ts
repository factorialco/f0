...
import { EditableTableColumnDefinition, EditableTableOnCellChangeParams } from '../../patterns/OneDataCollection/visualizations/collection/EditableTable/types';
/**
...
export type EditableColumn<R extends RecordType> = EditableTableColumnDefinition<R, SortingsDefinition, SummariesDefinition>;
/**
 ...
 */
export type F0FormEditableTableColumn<R extends RecordType> = Omit<EditableColumn<R>, "render" | "sorting" | "summary" | "summaryPlaceholder" | "order" | "hidden" | "noHiding" | "headerGroupId" | "sticky" | "id"> & {

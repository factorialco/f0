...
import { forwardRef as y, useId as u } from "react";
        ...
        s.svg,
        {
          ...
          children: [
            /* @__PURE__ */ d("defs", { children: [
              /* @__PURE__ */ a("clipPath", { id: `${i}-circle`, children: /* @__PURE__ */ a("circle", { cx: "16", cy: "16", r: "16" }) }),
              l.map((t) => /* @__PURE__ */ a("clipPath", { id: `${i}-${t.id}`, children: /* @__PURE__ */ a("path", { d: t.path }) }, t.id))
            ] }),
            /* @__PURE__ */ a("g", { clipPath: `url(#${i}-circle)`, children: l.map((t) => /* @__PURE__ */ a(
              s.foreignObject,
              {
                x: "0",
                y: "0",

import { F0Select as Select, F0SelectItemObject as SelectItemObject, F0SelectItemProps as SelectItemProps, F0SelectProps as SelectProps } from '../components/F0Select';
...
export declare const ScrollArea: import('../lib/data-testid').WithDataTestIdReturnType<import('react').ForwardRefExoticComponent<Omit<Omit<import('@radix-ui/react-scroll-area').ScrollAreaProps & import('react').RefAttributes<HTMLDivElement>, "ref"> & {
    showBar?: boolean;

...
type AnyDataSourceDefinition = DataSourceDefinition<RecordType, FiltersDefinition, SortingsDefinition, GroupingDefinition<RecordType>>;
 ...
 */
export declare function buildCollectionBoundSource(source: AnyDataSourceDefinition, storage: DataCollectionStorage | null, options?: BuildCollectionBoundSourceOptions): AnyDataSourceDefinition;
export {};

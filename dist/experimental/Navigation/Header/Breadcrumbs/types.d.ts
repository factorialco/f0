...
import { DropdownItemObject } from '../../Dropdown';
import { NavigationItem } from '../../utils';
import { DataAdapter, DataSourceDefinition, GroupingDefinition, RecordType, SortingsDefinition } from '../../../../hooks/datasource';
 ...
 */
export type CollectionSelectSourceDefinition = WithBivariantCallbacks<Omit<DataSourceDefinition<RecordType, FiltersDefinition, SortingsDefinition, GroupingDefinition<RecordType>>, "dataAdapter">> & {
...
export type BreadcrumbItemType = BreadcrumbLoadingItemType | BreadcrumbNavItemType | BreadcrumbSelectItemType | BreadcrumbCollectionSelectItemType;

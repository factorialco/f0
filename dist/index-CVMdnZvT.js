...
import { bU as Li, bV as Bi, bW as mt, bX as yx, bY as Bm, aM as ye, bZ as mx, b_ as Pn, b as ae, b$ as gx, c0 as qm, c1 as nf, c2 as Fm, c3 as Wm, c4 as bx, c5 as xx, c6 as zm, c7 as Ox, c8 as wx, c9 as Px, ca as wo, cb as Ax, cc as Sx, cd as _x, ce as Ex, i as tr, cf as Tx, cg as jx, h as Mt, r as $x, bv as Mx, ao as Ix, ar as Cx } from "./index-Bla76Kfk.js";
...
const iD = ({
  ...
  const o = e.map((s, l) => ({
    ...s,
    fill: t[s.label]?.color ? At(t[s.label].color) : yt(l)
  })), c = e.map((s) => s.value).reduce((s, l) => s + l);
  return c === 0 && o.push({
    label: "-",
    value: 1,
      ...
      children: /* @__PURE__ */ Ae(XN, { accessibilityLayer: !0, margin: { left: 0, right: 0 }, children: [
        ...
        /* @__PURE__ */ Ae(
          Ut,
          {
            ...
            children: [
              o.map((s, l) => {
                const f = i ? i(String(s.value)) : s.value;
                return /* @__PURE__ */ U(
                  $o,
                  {
                    fill: s.fill,
                    "aria-label": `${s.label}: ${f} (${(s.value / c * 100).toFixed(0)}%)`
                  },
                  `cell-${l}`
                );
              }),

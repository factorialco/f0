import { f as e, v as t } from "./variants-BhCxKzs5.js";
import { t as n } from "./utils-CVzxZnoI.js";
import { r } from "./F0Button-CYTXun0O.js";
import { o as i } from "./tooltip-BPSwDQpD.js";
import { a, i as ee, t as o, v as s, x as c } from "./popover-By8ytmVb.js";
import { a as l, i as u, t as d } from "./input-DH5KiXa2.js";
...
var re = f((e, t) => /* @__PURE__ */ _("svg", {
	...
	d: "m6 9 6 6 6-6",
	key: "qrunsl"
}]]), ie = ({ onClickArrow: e, step: n, disabled: r }) => !n || r ? null : /* @__PURE__ */ _("div", {
...
var E = f(function({ locale: t, id: s, value: u, maxDecimals: f, grouping: v = !1, step: y, min: b, max: w, onChange: E, units: oe, extraContent: D, inputWidth: se, popover: O, label: k, hint: A, error: ce, status: le, hideLabel: j = !1, disabled: M, readonly: N, loading: P, onBlur: ue, ...de }, fe) {
	let F = e(), pe = te(), I = s ?? pe, [L, me] = i({
		prop: O?.open,
		defaultProp: !1,
		onChange: O?.onOpenChange
	}), [R, z] = h(!1), [B, V] = h(() => u == null ? "" : S(u, t, f, v)), [he, H] = h(u ?? null), U = ne(() => {
	...
	let X = G ? he : u, Z = ne(() => G ? (e) => H(e) : E, [G, E]), ve = p((e) => {
		...
		if (!y) return;
		if (X == null) return Q(S(y, t, f));
		let n = e === "increase" ? X + y : X - y;
		b != null && n < b || w != null && n > w || Q(S(n, t, f));
	};
	m(() => {
		if (v && !R) {
			V(X == null ? "" : S(X, t, f, !0));
		...
		let e = x(B, { maxDecimals: f });
		X !== void 0 && X != e?.value && V(X == null ? "" : S(X, t, f));
	}, [
		B,
		X,
		t,
	...
	if (O !== void 0) {
		let { icon: e = re, side: t = "bottom", align: i = "start", triggerLabel: s, apply: u } = O, d = G, f = u?.label ?? F.actions.apply, p = u?.icon ?? c, m = u?.closeOnApply ?? !0;
		return /* @__PURE__ */ _(o, {
			open: L,
			onOpenChange: _e,

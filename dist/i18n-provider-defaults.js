const e = {
  ...
  filters: {
    ...
    tagPicker: {
      ...
      keyboardHint: "Write freely. Use arrow keys to navigate suggestions, Enter to add a filter, Shift+Enter to insert a line break, Escape to close, and Backspace or Delete to remove tags.",
      keyboardHintTags: "Type to search. Use arrow keys to navigate suggestions, Enter to add a filter, Escape to close, and Backspace or Delete to remove tags.",

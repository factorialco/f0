const e = {
  ...
  ai: {
    ...
    dataDownload: {
      ...
      exportOverviewDescription: "Preview every dashboard widget here. Use each widget sheet for its full exported data.",
      exportRowsExported: "{{amount}} rows exported",
      exportPreviewTruncated: "Showing the first {{amount}} rows here. Open the widget sheet for the full export.",

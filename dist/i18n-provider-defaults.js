const e = {
  ...
  chat: {
    ...
    community: {
      ...
      noPinnedPostsDescription: "Pin a post and it stays at the top of this community.",
      ...
      noScheduledPostsDescription: "Posts you schedule will wait here until their time.",
  ...
  communities: {
    composer: {
      ...
      isEventDescription: "Select this to include a date, time, and location for this event.",
      ...
      requireActionDescription: "Select how you want to track that users have taken the required action",
      ...
      actionTypeClickedLinkDescription: "Employees click the first link in the post",
      actionTypeComingSoon: "Coming soon",
      // Publish / schedule / draft
      continue: "Continue",
      publishTitle: "Publish",
      publishDescription: "When publishing the post, it will be visible in the dashboard of each employee.",
      publish: "Publish",
    ...
    detail: {
      ...
      closePostDescription: "You haven't acknowledged this post yet. You can acknowledge it later.",

...
const Nl = Se({
  ...
  ({
    ...
    const Ne = I && I !== "none" || te && te !== "none" || W && W !== "none" || ae && ae !== "none", Pe = q && q !== "none" || Ne, je = { sm: qe, md: Xe, lg: Ye, xl: Ie }, Je = Vl.map((De) => {
      const Ze = je[De];
      return Ze ? Fl(De, Ze) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
const t2 = /[\\`*_{}[\]()#+\-.!|~>]/g, r2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(t2, "\\$&")).join(""), A4 = ({
  ...
  const k = Y(), E = ke(), [V, S] = P(""), [F, B] = P(0), [Z, U] = P(!1), [G, ee] = P(!1), [X, _] = P(null), q = j(null), I = j(null), te = j(null), W = a != null, { tracking: ae } = be(), Ce = z(
    ...
    const xe = ye.current, e1 = xe && !/\s$/.test(xe) ? " " : "", _e = `${xe}${e1}${Q}`;
    S(_e), B(_e.length);
  }, []), Ae = {
  ...
  const Ie = we.status === "recording", Ke = Ie ? k.ai.listening : k.ai.inputPlaceholder, Qe = se.filter((Q) => Q.status === "uploaded"), Ne = se.some((Q) => Q.status === "uploading"), Pe = se.some((Q) => Q.status === "error"), je = V.trim().length > 0;
  K(() => {
    if (!(!G || Ne)) {
      if (ee(!1), Pe) {
  ...
  const Je = async (Q) => {
    if (Q.preventDefault(), !W) {
      if (oe.close(), n)
        ...
        const xe = oe.transformMentions(V.trim()), e1 = r2(xe), _e = Qe.flatMap(
...
const kr = Ge(void 0), I4 = () => Be(kr), D2 = (e) => /* @__PURE__ */ r(Tt, { content: e, format: "markdown" }), Z2 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
...
function j6(e, t) {
  const [n, o] = P(H6), {
    ...
    animate: i,
    motionValue: a
  } = Oe(I6), { value: d, animate: l } = Oe($6), { value: f, animate: u } = Oe(B6), { value: p, animate: m } = Oe(P6), h = Zs(t, {
    fftSize: 512,
      ...
      re.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ c("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ r("span", { className: L(Ue()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ r(
            ks,
            {

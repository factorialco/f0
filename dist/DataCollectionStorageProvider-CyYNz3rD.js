...
import C, { useRef as Me, useState as he, useCallback as tt, useEffect as Le, useContext as dt, useMemo as Fe, useLayoutEffect as iO, createContext as Ft, isValidElement as Nt, Children as Kr, PureComponent as jt, forwardRef as We, useImperativeHandle as AT, cloneElement as He, createElement as oO, Component as sO, useId as _T } from "react";
import { be as ay, bc as PT, dj as TT, B as Ar, aF as uO, c as Q, aG as cO, az as ET, aA as CT, a as As, f as ki, dk as eo, bp as _e, D as jT, dl as MT, dm as $T, aL as lO, dn as IT, dp as kT, bH as dh, dq as DT, F as ut, J as _s, aW as fO, b3 as ph, ax as dO, dr as bn, ds as NT, dt as RT, du as LT, dv as iy, dw as oy, dx as sy, dy as uy, dz as cy, dA as pO, dB as bo, dC as qT, dD as BT, cn as Va, dE as FT, H as hO, y as vO, z as yO, q as hh, Z as nn, r as mO, s as gO, bM as vh, g as de, c7 as zT, bv as yh, bw as mh, bx as gh, bA as bh, cx as WT, cE as xh, d4 as UT, cl as bO, aB as HT, ay as KT, ct as Di, u as Pr, aX as VT, bC as GT, Q as Gt, ac as xO, $ as YT, a0 as wO, a1 as XT, e as OO, a7 as ZT, d9 as Ps, dF as JT, O as an, aU as QT, aI as eE, a$ as tE, aJ as SO, b2 as rE, m as Ht, G as wh, n as AO, bJ as nE, S as At, w as _O, dG as PO, E as aE, N as TO, t as iE, cO as Xe, dH as EO, dI as CO, dJ as Id, dK as oE, dL as ly, cR as sE, cS as fy, P as uE, l as cE, o as lE, dh as fE, ad as dE, d6 as pE, aC as hE, dM as vE, aE as yE, A as Da, d as mE, cr as gE, at as bE, b5 as xE, b7 as wE, da as OE, K as SE, L as AE, M as _E, R as PE } from "./index-D_A9uAKT.js";
const TE = {
  active: !0,
  breakpoints: {},
  delay: 4e3,
...
function Oh(e = {}) {
  ...
  function f(j, I) {
    ...
    const {
      mergeOptions: D,
      optionsAtMedia: R
    } = I, L = D(TE, Oh.globalOptions), z = D(L, e);
...
var py = 700, zE = function(t) {
  return Vr({}, t, {
    axisDelta: t.axisDelta.map(function(r) {
      return kE(r, -py, py);
    })
  });
}, xu = process.env.NODE_ENV !== "production", WE = 0.6, UE = 0.96, HE = 2, hy = 5, vy = /* @__PURE__ */ En({
...
function VE(e) {
  e === void 0 && (e = {});
  var t = DE(), r = t.on, n = t.off, a = t.dispatch, i = vy, o = yy(), s, u = !1, c, l = function(j) {
    ...
    return j === void 0 && (j = {}), Object.values(j).some(function(I) {
      return I == null;
    }) ? (xu && console.error("updateOptions ignored! undefined & null options not allowed"), i) : i = En(Vr({}, vy, i, j));
  }, d = function(j) {
    var I = Vr({
      event: s,
      isStart: !1,
    ...
    var I = zE(FE(qE(j), i.reverseSign)), D = I.axisDelta, R = I.timeStamp, L = dy(D);
...
function Sh(e) {
  ...
  function n(i, o) {
    var s, u, c = o.mergeOptions, l = o.optionsAtMedia, f = c(GE, Sh.globalOptions), d = c(f, e);
    t = l(d);
...
function Ah(e, t) {
  ...
  return a !== i ? !1 : r.every((o) => {
    const s = e[o], u = t[o];
    return typeof s == "function" ? `${s}` == `${u}` : !my(s) || !my(u) ? s === u : Ah(s, u);
  });
}
function gy(e) {
...
function cC(e, t, r, n, a, i) {
  ...
  function d() {
    ...
    let _ = 0;
    return A ? (o = 0, r.set(n), e.set(n), _ = w) : (r.set(e), o += w / u, o *= c, l += o, e.add(o), _ = l - f), s = Ph(_), f = l, m;
  }
  function p() {
    const w = n.get() - t.get();
    return ke(w) < 1e-3;
...
function bC(e, t, r, n, a, i, o, s) {
  ...
  function l(p) {
    ...
    function y(h) {
      ...
      _h(g) && (a.useDuration(0), n.index(g, 0), o.emit("slideFocus"));
    }
...
function _C(e, t, r, n, a, i, o) {
  const {
    ...
    limit: J
  } = dC(X, ee, f), U = MO(Ni(ee), l, f), V = U.clone(), Z = Ga(r), E = ({
    dragHandler: pn,
    scrollBody: yu,
    scrollBounds: mu,
    options: {
    ...
    const ty = pn.settled(), OT = !wT.shouldConstrain(), ry = Qv ? ty : ty && OT, ny = ry && !bT.pointerDown();
    ny && xT.stop();
    const ST = mu.get() * ey + yT.get() * (1 - ey);
    Qi.set(ST), Qv && (mT.loop(pn.direction()), gT.loop()), yu.to(Qi.get()), ny && Jv.emit("settle"), ry || Jv.emit("scroll");
  }, F = rC(n, a, () => E(vu), (pn) => Y(vu, pn)), ae = 0.68, ce = ee[U.get()], oe = Ma(ce), Se = Ma(ce), Te = Ma(ce), me = Ma(ce), ye = cC(oe, Te, Se, me, d, ae), qe = mC(f, ee, X, J, me), er = gC(F, U, V, ye, qe, me, o), fn = hC(J), dn = Xa(), Ji = OC(t, r, o, h), {
    slideRegistry: ma
  } = yC(I, g, ee, ne, B, Z), vT = bC(e, r, ma, er, ye, dn, o, w), vu = {
    ownerDocument: n,
    ownerWindow: a,
    eventHandler: o,
    containerRect: P,
    ...
    scrollBody: ye,
    scrollBounds: lC(J, Te, me, ye, M),
    scrollLooper: pC(X, J, Te, [oe, Te, Se, me]),
    scrollProgress: fn,
...
function wo(e, t, r) {
  const n = e.ownerDocument, a = n.defaultView, i = EC(a), o = CC(i), s = Xa(), u = PC(), {
    mergeOptions: c,
    optionsAtMedia: l,
...
function MW({ children: e, isValidProp: t, ...r }) {
  t && TT(t), r = { ...dt(ay), ...r }, r.isStatic = PT(() => r.isStatic);
  const n = Fe(() => r, [
...
const De = 28, wy = 16, jC = ({ children: e }) => {
...
}, $W = ki("Carousel", $C), BO = Ft(null);
function IW({ children: e, layout: t }) {
...
function KC() {
  if (Hy) return Uu;
  Hy = 1;
  var e = jh(), t = HC(), r = Tr(), n = zO(), a = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, o = Function.prototype, s = Object.prototype, u = o.toString, c = s.hasOwnProperty, l = RegExp(
...
function fj() {
  if (wm) return xc;
  wm = 1;
  var e = Li(), t = cj(), r = Ch(), n = VO(), a = lj(), i = Ih(), o = 1, s = 2, u = "[object Boolean]", c = "[object Date]", l = "[object Error]", f = "[object Map]", d = "[object Number]", p = "[object RegExp]", y = "[object Set]", h = "[object String]", v = "[object Symbol]", b = "[object ArrayBuffer]", g = "[object DataView]", x = e ? e.prototype : void 0, O = x ? x.valueOf : void 0;
...
function ZO() {
  if (qm) return Nc;
  qm = 1;
  var e = bj(), t = XO(), r = xj(), n = r && r.isTypedArray, a = n ? t(n) : e;
  return Nc = a, Nc;
}
var Rc, Bm;
function wj() {
  if (Bm) return Rc;
  Bm = 1;
  var e = yj(), t = kh(), r = pt(), n = YO(), a = Dh(), i = ZO(), o = Object.prototype, s = o.hasOwnProperty;
  function u(c, l) {
...
function jj() {
  if (Qm) return Xc;
  Qm = 1;
  var e = Tj(), t = Mh(), r = Ej(), n = QO(), a = Cj(), i = fr(), o = zO(), s = "[object Map]", u = "[object Object]", c = "[object Promise]", l = "[object Set]", f = "[object WeakMap]", d = "[object DataView]", p = o(e), y = o(t), h = o(r), v = o(n), b = o(a), g = i;
...
function Mj() {
  if (eg) return Zc;
  eg = 1;
  var e = WO(), t = VO(), r = fj(), n = Pj(), a = jj(), i = pt(), o = YO(), s = ZO(), u = 1, c = "[object Arguments]", l = "[object Array]", f = "[object Object]", d = Object.prototype, p = d.hasOwnProperty;
...
}, eS = ki("Dropdown", Dj), Nj = ({ items: e, children: t }) => {
  const [r, n] = he(!1);
  return K(MT, {
    open: r,
    onOpenChange: n,
...
function Fj(e, t, r) {
  ...
  const c = Bj(r?.roundingMethod ?? "round"), l = u.getTime() - s.getTime(), f = l / cy, d = iy(u) - iy(s), p = (l - d) / cy, y = r?.unit;
  let h;
...
function LW(e, { yesterdayRelative: t = !0 } = {}) {
...
}, BW = ({ date: e, "aria-label": t, "aria-labelledby": r }) => {
  const n = Uj(e), a = Wj(e);
  return K("div", {
...
const Hj = As({
  ...
  const i = S("div", {
    className: Q("cursor-default font-medium transition hover:bg-f1-background-secondary-hover", Hj({
      size: t,
      type: r
    })),
    children: t === "xs" ? S(ut, {
...
var wg;
function c2() {
  return wg || (wg = 1, process.env.NODE_ENV === "production" ? to.exports = s2() : to.exports = u2()), to.exports;
}
var l2 = c2(), hl, Og;
function cS() {
  if (Og) return hl;
...
var m2 = ["viewBox", "children"], g2 = [
  ...
  return Object.keys(t).forEach(function(i) {
    var o = t[i];
    zh.includes(i) && typeof o == "function" && (a || (a = {}), a[i] = b2(o, r, n));
  }), a;
...
}, Tg = null, ml = null, Wh = function e(t) {
  if (t === Tg && Array.isArray(ml))
    return ml;
  var r = [];
...
var Eg = function(t) {
  ...
  return !ue(t) && (a && o.includes(r) || g2.includes(r)) || n && zh.includes(r);
}, ie = function(t, r, n) {
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var a = t;
  ...
  if (le(t) && le(r))
    return !0;
  if (!le(t) && !le(r)) {
    var n = t.props || {}, a = n.children, i = _g(n, x2), o = r.props || {}, s = o.children, u = _g(o, w2);
    return a && s ? _n(i, u) && Ld(a, s) : !a && !s ? _n(i, u) : !1;
  }
  return !1;
}, jg = function(t, r) {
  var n = [], a = {};
...
const dS = Math.cos, Ao = Math.sin, zt = Math.sqrt, _o = Math.PI, Ds = 2 * _o, zd = Math.PI, Wd = 2 * zd, Lr = 1e-6, W2 = Wd - Lr;
function pS(e) {
  this._ += e[0];
...
class H2 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? pS : U2(t);
  }
  moveTo(t, r) {
  ...
  arc(t, r, n, a, i, o) {
    ...
    this._x1 === null ? this._append`M${c},${l}` : (Math.abs(this._x1 - c) > Lr || Math.abs(this._y1 - l) > Lr) && this._append`L${c},${l}`, n && (d < 0 && (d = d % Wd + Wd), d > W2 ? this._append`A${n},${n},0,1,${f},${t - s},${r - u}A${n},${n},0,1,${f},${this._x1 = c},${this._y1 = l}` : d > Lr && this._append`A${n},${n},0,${+(d >= zd)},${f},${this._x1 = t + n * Math.cos(i)},${this._y1 = r + n * Math.sin(i)}`);
  }
  rect(t, r, n, a) {
...
}, bS = zt(1 / 3), Y2 = bS * 2, X2 = {
  draw(e, t) {
    const r = zt(t / Y2), n = r * bS;
...
}, J2 = 0.8908130915292852, xS = Ao(_o / 10) / Ao(7 * _o / 10), Q2 = Ao(Ds / 10) * xS, eM = -dS(Ds / 10) * xS, tM = {
  draw(e, t) {
    const r = zt(t * J2), n = Q2 * r, a = eM * r;
    e.moveTo(0, -r), e.lineTo(n, a);
    for (let i = 1; i < 5; ++i) {
      const o = Ds * i / 5, s = dS(o), u = Ao(o);
...
}, wt = -0.5, Ot = zt(3) / 2, Ud = 1 / zt(12), nM = (Ud / 2 + 1) * 3, aM = {
  draw(e, t) {
    const r = zt(t / nM), n = r / 2, a = r * Ud, i = n, o = r * Ud + r, s = -i, u = o;
  ...
  lineEnd: function() {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        Tl(this, this._t0, Fg(this, this._t0));
        break;
    }
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  },
    ...
    if (e = +e, t = +t, !(e === this._x1 && t === this._y1)) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          this._point = 3, Tl(this, Fg(this, r = Bg(this, e, t)), r);
          break;
        default:
          Tl(this, this._t0, r = Bg(this, e, t));
          break;
      }
...
(_S.prototype = Object.create(Eo.prototype)).point = function(e, t) {
...
var ES = {
  ...
  ES["symbol".concat(ks(t))] = r;
}, Vh = function(t) {
  var r = t.type, n = r === void 0 ? "circle" : r, a = t.size, i = a === void 0 ? 64 : a, o = t.sizeType, s = o === void 0 ? "area" : o, u = PM(t, OM), c = Ug(Ug({}, u), {}, {
    type: n,
    size: i,
    sizeType: s
  }), l = function() {
...
function NM(e, t, r) {
  return t = Co(t), RM(e, CS() ? Reflect.construct(t, r || [], Co(e).constructor) : t.apply(e, r));
}
function RM(e, t) {
...
function HM() {
  if (Jg) return kl;
  Jg = 1;
  var e = sS(), t = kh(), r = pt(), n = Dh(), a = Nh(), i = Is();
  function o(s, u, c) {
    u = e(u, s);
...
function VM() {
  if (eb) return Nl;
  eb = 1;
  var e = Rh(), t = uS(), r = KM(), n = qh(), a = MS(), i = $S(), o = Is(), s = 1, u = 2;
  function c(l, f) {
...
function n$() {
  if (pb) return Yl;
  pb = 1;
  var e = QO(), t = r$(), r = Ih(), n = 1 / 0, a = e && 1 / r(new e([, -0]))[1] == n ? function(i) {
    return new e(i);
  } : t;
  return Yl = a, Yl;
}
...
function a$() {
  if (hb) return Xl;
  hb = 1;
  var e = UO(), t = e$(), r = t$(), n = KO(), a = n$(), i = Ih(), o = 200;
  function s(u, c, l) {
...
function l$(e, t, r) {
  return t = jo(t), f$(e, DS() ? Reflect.construct(t, r || [], jo(e).constructor) : t.apply(e, r));
}
function f$(e, t) {
...
function P$() {
  if (Mb) return lf;
  Mb = 1;
  var e = Bh(), t = Fh(), r = Qt(), n = qS(), a = S$(), i = XO(), o = _$(), s = oa(), u = pt();
  function c(l, f, d) {
...
function j$() {
  if (Nb) return vf;
  Nb = 1;
  var e = C$(), t = BS(), r = oa(), n = t ? function(a, i) {
    return t(a, "toString", {
      configurable: !0,
      enumerable: !1,
      value: e(i),
...
function k$() {
  if (Fb) return xf;
  Fb = 1;
  var e = RS(), t = P$(), r = I$(), n = qs(), a = r(function(i, o) {
    if (i == null)
      return [];
    var s = o.length;
...
var xa = "recharts-tooltip-wrapper", G$ = {
  visibility: "hidden"
};
function Y$(e) {
...
function tI(e, t, r) {
  return t = Mo(t), rI(e, FS() ? Reflect.construct(t, r || [], Mo(e).constructor) : t.apply(e, r));
}
function rI(e, t) {
...
var Vb = 1, oI = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    J$(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = tI(this, t, [].concat(a)), Jd(r, "state", {
      dismissed: !1,
...
function fI(e, t, r) {
  return t = $o(t), dI(e, WS() ? Reflect.construct(t, r || [], $o(e).constructor) : t.apply(e, r));
}
function dI(e, t) {
...
function HS() {
  if (Qb) return _f;
  Qb = 1;
  var e = xI(), t = Tr(), r = na(), n = NaN, a = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, o = /^0o[0-7]+$/i, s = parseInt;
  function u(c) {
    if (typeof c == "number")
      return c;
    if (r(c))
...
function wI() {
  if (e0) return Pf;
  e0 = 1;
  var e = Tr(), t = gI(), r = HS(), n = "Expected a function", a = Math.max, i = Math.min;
  function o(s, u, c) {
...
var $I = /* @__PURE__ */ We(function(e, t) {
  ...
  var $ = Fe(function() {
    ...
    return C.Children.map(p, function(L) {
      return /* @__PURE__ */ C.isValidElement(L) ? /* @__PURE__ */ He(L, ao({
        width: I,
        height: D
      }, R ? {
        style: ao({
...
var u0 = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, c0 = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, GI = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, YI = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, VS = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
...
function GS(e) {
  ...
  for (var t = e; t.includes("*") || t.includes("/"); ) {
    var r, n = (r = u0.exec(t)) !== null && r !== void 0 ? r : [], a = Io(n, 4), i = a[1], o = a[2], s = a[3], u = io.parse(i ?? ""), c = io.parse(s ?? ""), l = o === "*" ? u.multiply(c) : u.divide(c);
    if (l.isNaN())
      return xn;
    t = t.replace(u0, l.toString());
  }
  for (; t.includes("+") || /.-\d+(?:\.\d+)?/.test(t); ) {
    var f, d = (f = c0.exec(t)) !== null && f !== void 0 ? f : [], p = Io(d, 4), y = p[1], h = p[2], v = p[3], b = io.parse(y ?? ""), g = io.parse(v ?? ""), x = h === "+" ? b.add(g) : b.subtract(g);
    if (x.isNaN())
      return xn;
...
function JI(e) {
  for (var t = e; t.includes("("); ) {
    var r = l0.exec(t), n = Io(r, 2), a = n[1];
    t = t.replace(l0, GS(a));
  }
  return t;
}
...
var YS = /[ \f\n\r\t\v\u2028\u2029]+/, XS = function(t) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, s = o === void 0 ? "1em" : o, u = t.capHeight, c = u === void 0 ? "0.71em" : u, l = t.scaleToFit, f = l === void 0 ? !1 : l, d = t.textAnchor, p = d === void 0 ? "start" : d, y = t.verticalAnchor, h = y === void 0 ? "end" : y, v = t.fill, b = v === void 0 ? v0 : v, g = f0(t, tk), x = Fe(function() {
    return ck({
      breakAll: g.breakAll,
      children: g.children,
      maxLines: g.maxLines,
  ...
  }, [g.breakAll, g.children, g.maxLines, f, g.style, g.width]), O = g.dx, m = g.dy, w = g.angle, A = g.className, _ = g.breakAll, P = f0(g, rk);
  if (!Ge(n) || !Ge(i))
    return null;
...
var ii = 0.7, Do = 1 / ii, Pn = "\\s*([+-]?\\d+)\\s*", oi = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Yt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Ak = /^#([0-9a-f]{3,8})$/, _k = new RegExp(`^rgb\\(${Pn},${Pn},${Pn}\\)$`), Pk = new RegExp(`^rgb\\(${Yt},${Yt},${Yt}\\)$`), Tk = new RegExp(`^rgba\\(${Pn},${Pn},${Pn},${oi}\\)$`), Ek = new RegExp(`^rgba\\(${Yt},${Yt},${Yt},${oi}\\)$`), Ck = new RegExp(`^hsl\\(${oi},${Yt},${Yt}\\)$`), jk = new RegExp(`^hsla\\(${oi},${Yt},${Yt},${oi}\\)$`), x0 = {
  aliceblue: 15792383,
...
ev(Dt, Dk, tA(zi, {
  ...
  clamp() {
    return new Dt(T0(this.h), so(this.s), so(this.l), No(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = No(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${T0(this.h)}, ${so(this.s) * 100}%, ${so(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function T0(e) {
...
function Lk(e) {
  return (e = +e) == 1 ? nA : function(t, r) {
    return r - t ? Rk(t, r, e) : tv(isNaN(t) ? r : t);
  };
}
function nA(e, t) {
  var r = t - e;
  return r ? Nk(e, r) : tv(isNaN(e) ? t : e);
}
const E0 = (function e(t) {
  var r = Lk(t);
  function n(a, i) {
    var o = r((a = op(a)).r, (i = op(i)).r), s = r(a.g, i.g), u = r(a.b, i.b), c = nA(a.opacity, i.opacity);
    return function(l) {
...
function sa(e, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? tv(t) : (r === "number" ? Ro : r === "string" ? (n = si(t)) ? (t = n, E0) : Kk : t instanceof si ? E0 : t instanceof Date ? zk : Bk(t) ? qk : Array.isArray(t) ? Fk : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? Wk : Ro)(e, t);
}
function rv(e, t) {
  return e = +e, t = +t, function(r) {
...
function aD(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? $0 : Qk(I0.call(e.grouping, Number), e.thousands + ""), r = e.currency === void 0 ? "" : e.currency[0] + "", n = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", i = e.numerals === void 0 ? $0 : eD(I0.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", s = e.minus === void 0 ? "−" : e.minus + "", u = e.nan === void 0 ? "NaN" : e.nan + "";
  function c(f) {
    f = ui(f);
    ...
    function k(T) {
      ...
      if (m === "c")
        ...
        T = +T;
        var R = T < 0 || 1 / T < 0;
        if (T = isNaN(T) ? u : _(Math.abs(T), x), O && (T = rD(T)), R && +T == 0 && y !== "+" && (R = !1), $ = (R ? y === "(" ? y : s : y === "-" || y === "(" ? "" : y) + $, M = (m === "s" ? k0[8 + aA / 3] : "") + M + (R && y === "(" ? ")" : ""), P) {
...
function iD(e) {
  return uo = aD(e), iv = uo.format, iA = uo.formatPrefix, uo;
}
function oD(e) {
...
function oA(e, t, r, n) {
  ...
  switch (n = ui(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(i = sD(a, o)) && (n.precision = i), iA(n, o);
    }
    case "":
    case "e":
    case "g":
...
function ov(e) {
  ...
  let n = 10, a, i;
  function o() {
    return a = pD(n), i = dD(n), r()[0] < 0 ? (a = R0(a), i = R0(i), e(cD, lD)) : e(D0, N0), t;
  }
...
function cA() {
  ...
  return e.copy = () => Wi(e, cA()).base(e.base()), Mt.apply(e, arguments), e;
}
function L0(e) {
  return function(t) {
...
function lA() {
  var e = sv(Fs());
  return e.copy = function() {
    return Wi(e, lA()).constant(e.constant());
...
function uv(e) {
  var t = e(st, st), r = 1;
  function n() {
    return r === 1 ? e(st, st) : r === 0.5 ? e(hD, vD) : e(B0(r), B0(1 / r));
  }
...
function fA() {
  ...
  return a.invert = function(i) {
    ...
    return arguments.length ? (e.range((t = Array.from(i, Lo)).map(F0)), a) : t.slice();
...
Fo.range;
const nr = 1e3, Pt = nr * 60, ar = Pt * 60, ur = ar * 24, lv = ur * 7, z0 = ur * 30, If = ur * 365, Wr = Ye((e) => {
...
const [PD, TD] = yA(lr, yv, Us, vA, hv, dv), [ED, CD] = yA(cr, vv, Ws, Ui, pv, fv);
function kf(e) {
  if (0 <= e.y && e.y < 100) {
...
function jN(e) {
  return vn = jD(e), wA = vn.format, vn.parse, OA = vn.utcFormat, vn.utcParse, vn;
}
function MN(e) {
  return new Date(e);
}
...
function IN() {
  return Mt.apply(mv(ED, CD, cr, vv, Ws, Ui, pv, fv, Wr, wA).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function kN() {
  return Mt.apply(mv(PD, TD, lr, yv, Us, zs, hv, dv, Wr, OA).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function Hs() {
...
}, wv, Ie = !0, Ct = "[DecimalError] ", Xr = Ct + "Invalid argument: ", xv = Ct + "Exponent out of range: ", ca = Math.floor, qr = Math.pow, KN = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, gt, Ze = 1e7, $e = 7, $A = 9007199254740991, Uo = ca($A / $e), re = {};
...
var sr = /* @__PURE__ */ (function() {
  ...
  return function(n, a, i, o) {
    ...
    if ($[c] > (T[c] || 0) && --u, i == null ? g = i = P.precision : o ? g = i + (ze(n) - ze(a)) + 1 : g = i, g < 0) return new P(0);
...
function kA(e, t) {
  ...
  if (ze(e) > 16) throw Error(xv + ze(e));
...
function NA(e) {
  ...
  function a(i) {
    ...
    if (typeof i == "number") {
      ...
      throw Error(Xr + i);
    if (i.charCodeAt(0) === 45 ? (i = i.slice(1), o.s = -1) : o.s = 1, KN.test(i)) sx(o, i);
    else throw Error(Xr + i);
  }
  if (a.prototype = re, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.clone = NA, a.config = a.set = VN, e === void 0 && (e = {}), e)
...
function vR(e) {
  ...
  if (c === l)
    return hR(c, a, i);
  var d = WA(c, l, o, i), p = d.step, y = d.tickMin, h = d.tickMax, v = Xs.rangeStep(y, h.add(new Ae(0.1).mul(p)), p);
  return r > n ? fp(v) : v;
}
function yR(e, t) {
  ...
  if (u === c)
    return [u];
  var l = Math.max(t, 2), f = zA(new Ae(c).sub(u).div(l - 1), i, 0), d = [].concat(dp(Xs.rangeStep(new Ae(u), new Ae(c).sub(new Ae(0.99).mul(f)), f)), [c]);
  return n > a ? fp(d) : d;
}
var mR = qA(vR), gR = qA(yR), bR = process.env.NODE_ENV === "production", Uf = "Invariant failed";
function lt(e, t) {
  if (bR)
    throw new Error(Uf);
...
function MR(e, t, r) {
  return t = Ko(t), $R(e, UA() ? Reflect.construct(t, r || [], Ko(e).constructor) : t.apply(e, r));
}
function $R(e, t) {
...
}, yx = /^dataMin[\s]*-[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/, mx = /^dataMax[\s]*\+[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/, yp = function(t, r, n) {
  if (ue(t))
    return t(r, n);
  if (!Array.isArray(t))
    return r;
...
function Ve(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = PL(e, xL), a = Ue({
    offset: r
...
var o_ = function(t) {
  ...
  return t ? t === !0 ? /* @__PURE__ */ C.createElement(Ve, {
    ...
    viewBox: r,
    value: t
  }) : /* @__PURE__ */ Nt(t) ? t.type === Ve ? /* @__PURE__ */ He(t, {
    key: "label-implicit",
    viewBox: r
...
function Tt(e) {
  var t = e.valueAccessor, r = t === void 0 ? QL : t, n = Px(e, zL), a = n.data, i = n.dataKey, o = n.clockWise, s = n.id, u = n.textBreakAll, c = Px(n, WL);
...
var iq = function(t, r) {
  ...
  var r = Ex(Ex({}, sq), t), n = r.cx, a = r.cy, i = r.innerRadius, o = r.outerRadius, s = r.cornerRadius, u = r.forceCornerRadius, c = r.cornerIsExternal, l = r.startAngle, f = r.endAngle, d = r.className;
  if (o < i || l === f)
    return null;
...
var Mx = {
  ...
  return (n === "curveMonotone" || n === "curveBump") && r ? Mx["".concat(n).concat(r === "vertical" ? "Y" : "X")] : Mx[n] || Ns;
}, dq = function(t) {
  ...
  if (Array.isArray(o)) {
    ...
    return s === "vertical" ? d = ro().y(Pa).x1(_a).x0(function(h) {
      return h.base.x;
    }) : d = ro().x(_a).y1(Pa).y0(function(h) {
      return h.base.y;
    }), d.defined(fo).curve(l), d(y);
  }
  return s === "vertical" && G(o) ? d = ro().y(Pa).x1(_a).x0(o) : G(o) ? d = ro().x(_a).y1(Pa).y0(o) : d = mS().x(_a).y(Pa), d.defined(fo).curve(l), d(f);
}, Zr = function(t) {
...
var kx;
function c_() {
  return kx || (kx = 1, process.env.NODE_ENV === "production" ? ho.exports = pq() : ho.exports = hq()), ho.exports;
}
var Vf, Dx;
function vq() {
  if (Dx) return Vf;
...
var Yf, Rx;
function l_() {
  return Rx || (Rx = 1, Yf = Function.call.bind(Object.prototype.hasOwnProperty)), Yf;
}
var Xf, Lx;
function yq() {
  if (Lx) return Xf;
  ...
  if (process.env.NODE_ENV !== "production") {
    var t = /* @__PURE__ */ Sv(), r = {}, n = /* @__PURE__ */ l_();
    e = function(i) {
      var o = "Warning: " + i;
...
function mq() {
  if (qx) return Zf;
  qx = 1;
  var e = c_(), t = vq(), r = /* @__PURE__ */ Sv(), n = /* @__PURE__ */ l_(), a = /* @__PURE__ */ yq(), i = function() {
  };
...
var _q = "__v", Pq = "__o", Tq = "_owner", Ux = Object.getOwnPropertyDescriptor, Hx = Object.keys;
function Eq(e, t, r) {
  var n = e.length;
  if (t.length !== n)
    return !1;
...
var Lq = "[object Arguments]", qq = "[object Boolean]", Bq = "[object Date]", Fq = "[object Error]", zq = "[object Map]", Wq = "[object Number]", Uq = "[object Object]", Hq = "[object RegExp]", Kq = "[object Set]", Vq = "[object String]", Gq = "[object URL]", Yq = Array.isArray, Gx = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Yx = Object.assign, Xq = Object.prototype.toString.call.bind(Object.prototype.toString);
function Zq(e) {
...
var Jo = 1e-4, h_ = function(t, r) {
  ...
  return function(n) {
    var a = h_(t, r), i = [].concat(bB(a.map(function(o, s) {
      return o * s;
    }).slice(1)), [0]);
    return v_(i, n);
  };
  ...
  var f = t1(a, o), d = t1(i, s), p = SB(a, o), y = function(b) {
...
const NB = (function(e, t, r, n, a) {
  var i = fB(e, t), o = i.reduce(function(v, b) {
    ...
    var g = (b - l) / n, x = Ba(function(m, w) {
      return Qo.apply(void 0, n1(w).concat([r(g)]));
    }, o);
    if (a(et(et(et({}, e), t), x)), g < 1)
      u = requestAnimationFrame(f);
    else {
      var O = Ba(function(m, w) {
        return Qo.apply(void 0, n1(w).concat([r(1)]));
      }, o);
      a(et(et(et({}, e), t), O));
    }
  };
...
var c1 = function(t, r, n, a, i) {
  ...
  var r = u1(u1({}, o3), t), n = Me(), a = he(-1), i = ZB(a, 2), o = i[0], s = i[1];
  Le(function() {
...
function R3(e, t, r) {
  return t = rs(t), L3(e, g_() ? Reflect.construct(t, r || [], rs(e).constructor) : t.apply(e, r));
}
function L3(e, t) {
...
var Js = /* @__PURE__ */ (function(e) {
  ...
  return B3(t, e), N3(t, [{
    ...
    key: "renderAxisLine",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, s = n.ticks, u = n.axisLine, c = y1(n, $3), l = s.reduce(function(y, h) {
    ...
    key: "renderTicks",
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, s = a.angle, u = a.tickFormatter, c = a.stroke, l = y1(a, I3), f = this.getTickTextAnchor(), d = ie(l, !1), p = ie(o, !1), y = i.map(function(h, v) {
...
function U3(e, t, r) {
  return t = ns(t), H3(e, x_() ? Reflect.construct(t, r || [], ns(e).constructor) : t.apply(e, r));
}
function H3(e, t) {
...
var Y3 = Math.PI / 180, x1 = 1e-5, eu = /* @__PURE__ */ (function(e) {
  function t() {
...
var T1 = function(t, r, n, a, i) {
  ...
  var r = P1(P1({}, f5), t), n = Me(), a = he(-1), i = n5(a, 2), o = i[0], s = i[1];
  Le(function() {
    if (n.current && n.current.getTotalLength)
      try {
...
function C1(e) {
  ...
  switch (t) {
    case "rectangle":
      return /* @__PURE__ */ C.createElement(Av, r);
    case "trapezoid":
...
function _5(e, t) {
  var r;
  return tu(e, t) ? r = O5 : ru(e, t) ? r = S5 : _i(e, t) && (r = A5), r;
}
function P5(e, t) {
  var r;
  return tu(e, t) ? r = "trapezoids" : ru(e, t) ? r = "sectors" : _i(e, t) && (r = "points"), r;
}
function T5(e, t) {
  if (tu(e, t)) {
    var r;
...
function M5(e, t, r) {
  return t = os(t), $5(e, S_() ? Reflect.construct(t, r || [], os(e).constructor) : t.apply(e, r));
}
function $5(e, t) {
...
function K5(e, t, r) {
  return t = cs(t), V5(e, T_() ? Reflect.construct(t, r || [], cs(e).constructor) : t.apply(e, r));
}
function V5(e, t) {
...
function Y1(e) {
  return /* @__PURE__ */ C.createElement(O_, Rp({
    shapeType: "rectangle",
    propTransformer: yF,
...
function SF(e, t, r) {
  return t = fs(t), AF(e, M_() ? Reflect.construct(t, r || [], fs(e).constructor) : t.apply(e, r));
}
function AF(e, t) {
  ...
  return PF(t, e), OF(t, [{
    ...
    value: function() {
      ...
      return i.map(function(c, l) {
        ...
        return /* @__PURE__ */ C.createElement(Y1, ls({
...
Or($r, "getComposedData", function(e) {
  ...
  var y = t.layout, h = r.type.defaultProps, v = h !== void 0 ? Be(Be({}, h), r.props) : r.props, b = v.dataKey, g = v.children, x = v.minPointSize, O = y === "horizontal" ? o : i, m = c ? O.scale.domain() : null, w = aL({
    ...
    var R = mF(x, j_.defaultProps.minPointSize)(T[1], k);
    if (y === "horizontal") {
...
var Pv = function(t) {
  var r = Object.keys(t).reduce(function(n, a) {
    return It(It({}, n), {}, nu({}, a, D_.create(t[a])));
  }, {});
  return It(It({}, r), {}, {
    apply: function(a) {
...
var Tv = /* @__PURE__ */ Ft(void 0), Ev = /* @__PURE__ */ Ft(void 0), N_ = /* @__PURE__ */ Ft(void 0), R_ = /* @__PURE__ */ Ft({}), L_ = /* @__PURE__ */ Ft(void 0), q_ = /* @__PURE__ */ Ft(0), B_ = /* @__PURE__ */ Ft(0), aw = function(t) {
...
var z_ = function(t) {
  ...
  var n = r[t];
  return n == null && (process.env.NODE_ENV !== "production" ? lt(!1, 'Could not find xAxis by id "'.concat(t, '" [').concat(ds(t), "]. ").concat(F_(r))) : lt()), n;
}, UF = function() {
  var t = dt(Tv);
  return xr(t);
}, HF = function() {
  var t = dt(Ev), r = qF(t, function(n) {
  ...
  r == null && (process.env.NODE_ENV !== "production" ? lt(!1, "Could not find Recharts context; are you sure this is rendered inside a Recharts wrapper component?") : lt());
  var n = r[t];
  return n == null && (process.env.NODE_ENV !== "production" ? lt(!1, 'Could not find yAxis by id "'.concat(t, '" [').concat(ds(t), "]. ").concat(F_(r))) : lt()), n;
}, KF = function() {
  var t = dt(N_);
  return t;
}, VF = function() {
...
function ZF(e, t, r) {
  return t = ps(t), JF(e, U_() ? Reflect.construct(t, r || [], ps(e).constructor) : t.apply(e, r));
}
function JF(e, t) {
...
function c4(e) {
  var t = e.x, r = e.y, n = e.segment, a = e.xAxisId, i = e.yAxisId, o = e.shape, s = e.className, u = e.alwaysShow, c = WF(), l = z_(a), f = W_(i), d = KF();
  if (!c || !d)
    return null;
  ...
  if (!b)
    return null;
  var g = r4(b, 2), x = g[0], O = x.x, m = x.y, w = g[1], A = w.x, _ = w.y, P = Xt(e, "hidden") ? "url(#".concat(c, ")") : void 0, k = ow(ow({
    clipPath: P
  }, ie(e, !0)), {}, {
    x1: O,
    y1: m,
...
function p4(e, t, r) {
  return t = hs(t), h4(e, K_() ? Reflect.construct(t, r || [], hs(e).constructor) : t.apply(e, r));
}
function h4(e, t) {
...
function O4(e, t, r) {
  return t = vs(t), S4(e, G_() ? Reflect.construct(t, r || [], vs(e).constructor) : t.apply(e, r));
}
function S4(e, t) {
...
ou(su, "renderRect", function(e, t) {
  var r;
  return /* @__PURE__ */ C.isValidElement(e) ? r = /* @__PURE__ */ C.cloneElement(e, t) : ue(e) ? r = e(t) : r = /* @__PURE__ */ C.createElement(Av, Wp({}, t, {
...
function W4(e, t, r) {
  return t = ms(t), U4(e, Z_() ? Reflect.construct(t, r || [], ms(e).constructor) : t.apply(e, r));
}
function U4(e, t) {
...
function Q_(e, t) {
  ...
  if (/* @__PURE__ */ C.isValidElement(e))
    ...
    var n = t.x1, a = t.y1, i = t.x2, o = t.y2, s = t.key, u = yw(t, G4), c = ie(u, !1);
    c.offset;
    var l = yw(c, Y4);
...
var i6 = function(t, r) {
  ...
  return ZA(Iv(nt(nt(nt({}, la.defaultProps), n), {}, {
    ticks: ir(n, !0),
    viewBox: {
      x: 0,
      y: 0,
...
function Vi(e) {
  var t, r, n, a, i, o, s = Cv(), u = jv(), c = VF(), l = nt(nt({}, e), {}, {
  ...
  if (!G(p) || p <= 0 || !G(y) || y <= 0 || !G(f) || f !== +f || !G(d) || d !== +d)
    return null;
  var O = l.verticalCoordinatesGenerator || i6, m = l.horizontalCoordinatesGenerator || o6, w = l.horizontalPoints, A = l.verticalPoints;
  if ((!w || !w.length) && ue(m)) {
  ...
  return /* @__PURE__ */ C.createElement("g", {
    ...
    height: l.height,
    ry: l.ry
  }), /* @__PURE__ */ C.createElement(t6, Ur({}, l, {
    offset: c,
    horizontalPoints: w,
    xAxis: g,
    yAxis: x
  })), /* @__PURE__ */ C.createElement(r6, Ur({}, l, {
    offset: c,
    verticalPoints: A,
    xAxis: g,
    yAxis: x
  })), /* @__PURE__ */ C.createElement(n6, Ur({}, l, {
    horizontalPoints: w
  })), /* @__PURE__ */ C.createElement(a6, Ur({}, l, {
    verticalPoints: A
  })));
}
Vi.displayName = "CartesianGrid";
var s6 = ["type", "layout", "connectNulls", "ref"], u6 = ["key"];
function Xn(e) {
  "@babel/helpers - typeof";
...
function y6(e, t, r) {
  return t = gs(t), m6(e, eP() ? Reflect.construct(t, r || [], gs(e).constructor) : t.apply(e, r));
}
function m6(e, t) {
...
var Gi = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = y6(this, t, [].concat(a)), kt(r, "state", {
      isAnimationFinished: !0,
      totalLength: 0
  ...
  return b6(t, e), v6(t, [{
    ...
    value: function(n, a, i, o) {
      ...
      s.ref;
      var f = mw(s, s6), d = ht(ht(ht({}, ie(f, !0)), {}, {
        fill: "none",
    ...
    value: function(n, a) {
      ...
      if (/* @__PURE__ */ C.isValidElement(n))
        ...
        var o = a.key, s = mw(a, u6), u = de("recharts-line-dot", typeof n != "boolean" ? n.className : "");
...
var w6 = ["layout", "type", "stroke", "connectNulls", "isRange", "ref"], O6 = ["key"], rP;
function Zn(e) {
  "@babel/helpers - typeof";
  return Zn = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t) {
    return typeof t;
...
function P6(e, t, r) {
  return t = bs(t), T6(e, aP() ? Reflect.construct(t, r || [], bs(e).constructor) : t.apply(e, r));
}
function T6(e, t) {
  if (t && (Zn(t) === "object" || typeof t == "function"))
    return t;
...
var Ir = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = P6(this, t, [].concat(a)), Vt(r, "state", {
      isAnimationFinished: !0
...
Vt(Ir, "renderDotItem", function(e, t) {
  ...
  if (/* @__PURE__ */ C.isValidElement(e))
    ...
    var n = de("recharts-area-dot", typeof e != "boolean" ? e.className : ""), a = t.key, i = nP(t, O6);
...
function I6(e, t, r) {
  return t && $6(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function k6(e, t, r) {
  return t = xs(t), D6(e, oP() ? Reflect.construct(t, r || [], xs(e).constructor) : t.apply(e, r));
}
function D6(e, t) {
  if (t && (Jn(t) === "object" || typeof t == "function"))
    return t;
...
function q6(e) {
  var t = e.xAxisId, r = Cv(), n = jv(), a = z_(t);
  return a == null ? null : (
...
var vr = /* @__PURE__ */ (function(e) {
  function t() {
    return M6(this, t), k6(this, t, arguments);
  }
  return R6(t, e), I6(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ C.createElement(q6, this.props);
    }
  }]);
})(C.Component);
...
function W6(e, t, r) {
  return t = ws(t), U6(e, cP() ? Reflect.construct(t, r || [], ws(e).constructor) : t.apply(e, r));
}
function U6(e, t) {
  if (t && (Qn(t) === "object" || typeof t == "function"))
    return t;
...
var G6 = function(t) {
  var r = t.yAxisId, n = Cv(), a = jv(), i = W_(r);
  return i == null ? null : (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
  ...
  return K6(t, e), z6(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ C.createElement(G6, this.props);
    }
  }]);
})(C.Component);
...
var eh = function(t, r, n, a, i) {
  var o = xt(t, $v), s = xt(t, iu), u = [].concat(Ow(o), Ow(s)), c = xt(t, su), l = "".concat(a, "Id"), f = a[0], d = r;
...
var e8 = Q6();
const t8 = /* @__PURE__ */ _e(e8);
var Sd = new t8(), Ad = "recharts.syncMouseEvents";
function Ci(e) {
  "@babel/helpers - typeof";
...
var o8 = /* @__PURE__ */ (function() {
  function e() {
    r8(this, e), _d(this, "activeIndex", 0), _d(this, "coordinateList", []), _d(this, "layout", "horizontal");
  }
  return a8(e, [{
    key: "setDetails",
    value: function(r) {
...
function p8(e) {
  ...
  return /* @__PURE__ */ Nt(p) ? /* @__PURE__ */ He(p, w) : /* @__PURE__ */ oO(h, w);
}
var h8 = ["item"], v8 = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function ea(e) {
  "@babel/helpers - typeof";
...
function S8(e, t, r) {
  return t = Os(t), A8(e, hP() ? Reflect.construct(t, r || [], Os(e).constructor) : t.apply(e, r));
}
function A8(e, t) {
...
var nh = function(t, r, n, a) {
  ...
  var i = a || {
    x: t.chartX,
    y: t.chartY
  }, o = I8(i, n), s = t.orderedTooltipTicks, u = t.tooltipAxis, c = t.tooltipTicks, l = HR(o, s, c, u);
  if (l >= 0 && c) {
    var f = c[l] && c[l].value, d = nh(t, r, l, f), p = k8(n, s, l, i);
    return {
  ...
  return n.reduce(function(y, h) {
    ...
    s8(b.domain, O, g) && ($ = yp(b.domain, null, O), p && (g === "number" || w !== "auto") && (j = qa(k, x, "category")));
    var I = gP(g);
    if (!$ || $.length === 0) {
      ...
      if (x) {
        if ($ = qa(k, x, g), g === "category" && p) {
          var L = y2($);
          m && L ? (M = $, $ = ss(0, T)) : m || ($ = gx(R, $, h).reduce(function(q, H) {
      ...
      } else p ? $ = ss(0, T) : s && s[P] && s[P].hasStack && g === "number" ? $ = d === "expand" ? [0, 1] : t_(s[P].stackGroups, u, c) : $ = YA(k, a.filter(function(q) {
  ...
  return n.reduce(function(v, b) {
    ...
    if (!v[x]) {
      h++;
      var m;
      return y ? m = ss(0, p) : s && s[x] && s[x].hasStack ? (m = t_(s[x].stackGroups, u, c), m = eh(f, m, x, i)) : (m = yp(O, YA(d, n.filter(function(w) {
        ...
        hide: !0,
        orientation: bt(M8, "".concat(i, ".").concat(h % 2), null),
        domain: m,
        originalDomain: O,
        isCategorical: y,
        layout: l
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, s = o === void 0 ? ["axis"] : o, u = t.axisComponents, c = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, d = function(b, g) {
    var x = g.graphicalItems, O = g.stackGroups, m = g.offset, w = g.updateId, A = g.dataStartIndex, _ = g.dataEndIndex, P = b.barSize, k = b.layout, T = b.barGap, $ = b.barCategoryGap, M = b.maxBarSize, j = jw(k), I = j.numericAxisName, D = j.cateAxisName, R = q8(x), L = [];
    return x.forEach(function(z, N) {
      ...
      }, ee), U = J[D], V = J["".concat(D, "Ticks")], Z = O && O[te] && O[te].hasStack && iL(z, O[te].stackGroups), E = or(z.type).indexOf("Bar") >= 0, Y = Go(U, V), F = [], ae = R && KR({
        barSize: P,
        stackGroups: O,
        totalSize: F8(J, D)
      });
    ...
    if (!Eg({
      ...
      return null;
    var A = x.children, _ = x.layout, P = x.stackOffset, k = x.data, T = x.reverseStackOrder, $ = jw(_), M = $.numericAxisName, j = $.cateAxisName, I = xt(A, n), D = nL(k, I, "".concat(M, "Id"), "".concat(j, "Id"), P, T), R = u.reduce(function(q, H) {
      var X = "".concat(H.axisType, "Map");
      return W(W({}, q), {}, se({}, X, R8(x, W(W({}, H), {}, {
        graphicalItems: I,
    ...
    var z = R["".concat(j, "Map")], N = L8(z), B = d(x, W(W({}, R), {}, {
      dataStartIndex: O,
      dataEndIndex: m,
      updateId: w,
      graphicalItems: I,
    ...
    function b(g) {
      var x, O, m;
      return x8(this, b), m = S8(this, b, [g]), se(m, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), se(m, "accessibilityManager", new o8()), se(m, "handleLegendBBoxUpdate", function(w) {
        if (w) {
        ...
        return /* @__PURE__ */ C.createElement(p8, {
          key: L,
          activeCoordinate: k,
          activePayload: T,
        ...
        if (!M)
          return null;
        var j = M.item, I = Pw(M, h8);
        return /* @__PURE__ */ He(j, W(W({}, I), {}, {
          chartWidth: P,
          chartHeight: k,
          margin: T,
    ...
    return P8(b, v), O8(b, [{
      ...
      value: function() {
        ...
        if (_) {
          ...
          if (!(typeof P != "number" || P < 0 || P > this.state.tooltipTicks.length - 1)) {
            var k = this.state.tooltipTicks[P] && this.state.tooltipTicks[P].value, T = nh(this.state, m, P, k), $ = this.state.tooltipTicks[P].coordinate, M = (this.state.offset.top + w) / 2, j = A === "horizontal", I = j ? {
              x: $,
              y: M
            } : {
              y: $,
      ...
      value: function() {
        ...
        if (!Eg(this))
          return null;
        var O = this.props, m = O.children, w = O.className, A = O.width, _ = O.height, P = O.style, k = O.compact, T = O.title, $ = O.desc, M = Pw(O, v8), j = ie(M, !1);
        if (k)
          ...
          }, /* @__PURE__ */ C.createElement(Bd, An({}, j, {
            width: A,
            height: _,
            title: T,
            desc: $
  ...
  se(y, "displayName", r), se(y, "defaultProps", W({
    ...
    var x;
    return /* @__PURE__ */ Nt(v) ? x = /* @__PURE__ */ He(v, b) : ue(v) ? x = v(b) : x = /* @__PURE__ */ C.createElement(Ki, b), /* @__PURE__ */ C.createElement(pe, {
...
const V8 = ({ id: e, className: t, children: r, aspect: n, config: a, ...i }, o) => {
  const s = fe.useId(), u = `chart-${e || s.replace(/:/g, "")}`, c = fe.useRef(null), [l, f] = he(), d = Fe(() => new ResizeObserver((p) => f(p[0].contentRect.height)), []);
  return iO(() => {
...
const G8 = ({ id: e, config: t }) => {
  const r = Object.entries(t).filter(([a, i]) => i.theme || i.color);
  if (!r.length)
    return null;
  const n = Object.entries(K8).map(([a, i]) => `
${i} [data-chart=${e}] {
${r.map(([o, s]) => {
...
const OP = Ft({
  ...
  disable: () => null,
  toggle: () => null
}), zW = ({ initiallyEnabled: e = !1, children: t }) => {
  const [r, n] = he(e), a = tt(() => {
    n(!0);
  }, []), i = tt(() => n(!1), []), o = tt(() => n((s) => !s), []);
...
const X8 = ({ index: e, visibleTicksCount: t, payload: r, tickFormatter: n, ...a }) => {
  const i = e === 0, o = e === t - 1;
  return S(_r, {
    ...a,
...
}, Z8 = ({ data: e, dataConfig: t, xAxis: r, yAxis: n, canBeBlurred: a, blurArea: i, lineType: o = "monotoneX", aspect: s, marginTop: u = 0 }, c) => {
  const { enabled: l } = Y8(), f = Object.keys(t), d = Xj(12), p = Lv(e), y = Math.max(...p.flatMap((x) => f.map((O) => Xi(n?.tickFormatter ? n.tickFormatter(`${x[O]}`) : `${x[O]}`)))), h = n?.width ?? y + 20, v = !n?.hide, b = !r?.hide, g = !a || !l;
  return S(fa, {
    config: t,
    ref: c,
    aspect: s,
...
}, WW = pa(Z8), J8 = ({ dataConfig: e, data: t, xAxis: r, yAxis: n = {
  hide: !0
...
}, UW = pa(J8), Q8 = ({ data: e, legend: t = !0, hideTooltip: r = !1 }, n) => {
...
}, HW = pa(Q8), e9 = ({ data: e, dataConfig: t, xAxis: r, yAxis: n = {
  hide: !0
...
}, KW = pa(e9), t9 = ({ data: e, dataConfig: t, overview: r, aspect: n, tickFormatter: a }, i) => {
  const o = e.map((c, l) => ({
    ...c,
...
var qv = "Progress", Bv = 100, [r9] = WT(qv), [n9, a9] = r9(qv), SP = fe.forwardRef(
  (e, t) => {
    const {
      __scopeProgress: r,
      value: n = null,
    ...
    (a || a === 0) && !Mw(a) && console.error(o9(`${a}`, "Progress"));
    const s = Mw(a) ? a : Bv;
    n !== null && !$w(n, s) && console.error(s9(`${n}`, "Progress"));
    const u = $w(n, s) ? n : null, c = Ss(u) ? i(u, s) : void 0;
...
var AP = "ProgressIndicator", _P = fe.forwardRef(
  (e, t) => {
    const { __scopeProgress: r, ...n } = e, a = a9(AP, r);
    return /* @__PURE__ */ S(
      xh.div,
      {
...
}, GW = pa(f9), d9 = ({ viewBox: e, offset: t = 0, value: r, valueFormatter: n, total: a, showLabel: i }) => {
...
typeof e == "object" && "value_x100" in e && (e.value_x100 === void 0 || e.value_x100 === null), oh = (e) => "value" in e ? e.value : e.value_x100 !== void 0 && e.value_x100 !== null ? e.value_x100 / 100 : void 0, Iw = (e, t = {}) => {
  if (ih(e))
  ...
  0: "neutral",
  1: "positive"
}, CP = We(({ percentage: e, amount: t, invertStatus: r, info: n, hint: a, nullText: i }, o) => {
  const s = v9(), u = s(t, {
    formatterOptions: {
      decimalPlaces: 2
    }
...
const b9 = fe.forwardRef(({ className: e, title: t, icon: r = cO, ...n }, a) => S(dh, {
  ref: a,
...
const jP = fe.forwardRef(({ className: e, ...t }, r) => S("div", {
  ref: r,
  className: Q("relative flex grow flex-col", e),
  ...t
}));
jP.displayName = "CardContent";
...
const YW = fe.forwardRef(function({ className: t, ...r }, n) {
  return S("div", {
    ref: n,
...
function x9({ primaryAction: e, compact: t = !1, ...r }) {
  const n = Fe(() => r.secondaryActions && "actions" in r.secondaryActions ? r.secondaryActions : {
    actions: r.secondaryActions,
    hideLabels: !1
  }, [r.secondaryActions]), a = GT("(min-width: 640px)");
  if (!(e || s()))
    return null;
  const o = (u) => Array.isArray(u);
  return K(Hv, {
    className: Q("flex-col gap-2 sm:flex-row sm:justify-between [&>div]:z-[1]", "relative -mx-4 mt-4 border-0 border-t border-solid border-t-f1-border-secondary px-4 pt-4", t && "pt-3"),
    children: [n.actions && S("div", {
      ...
      children: o(n.actions) ? n.actions.map((u, c) => S(Gt, {
        label: u.label,
        icon: u.icon,
        variant: "outline",
        onClick: u.onClick,
        hideLabel: n.hideLabels || a && c > 0,
        size: a ? t ? "sm" : "md" : "lg"
      }, c)) : S(xO, {
        href: n.actions.href,
        target: n.actions.target,
        disabled: n.actions.disabled,
        children: n.actions.label
      })
    }), e && S("div", {
  ...
  function s() {
    return n ? "href" in n ? !0 : n.actions && "length" in n.actions ? n.actions.length > 0 : !1 : !1;
  }
}
...
function kw({ otherActions: e, selectable: t = !1, selected: r = !1, onSelect: n, title: a, overlay: i = !1 }) {
...
const $9 = (e) => S("div", {
  ...
  const r = va(e, "text")?.toString() || "", n = ha(e, "text"), a = N9(e), i = D9(e) || 3;
  return S(an, {
  ...
  const a = Pd / 2, i = a - Rw / 2, o = i - L9, s = 2 * Math.PI * o, u = (100 - Math.min(Number(r), 100)) / 100 * s, c = typeof e == "object" && "label" in e;
  return K("div", {
    className: "flex items-center gap-2",
    "data-cell-type": "percentage",
    children: [K("svg", {
...
}, Gv = We(({ text: e, additionalAccessibleText: t, variant: r }, n) => (Ps(e, {
  disallowEmpty: !0
}, {
...
const DP = We(({ name: e, src: t }, r) => S(pu, {
  ref: r,
  avatar: {
    type: "company",
    name: e,
...
const NP = We(({ src: e, name: t }, r) => S(pu, {
  ref: r,
  avatar: {
    type: "person",
    firstName: t,
...
const RP = We(({ name: e, src: t }, r) => S(pu, {
  ref: r,
  avatar: {
    type: "team",
    name: e,
...
const V9 = (e) => S(qP, {
  ...
  country: C9,
  syncStatus: U9
}, X9 = (e) => e !== void 0 && typeof e == "object", JW = (e, t, r) => {
...
const BP = ({ metadata: e, children: t, compact: r, className: n, forceVerticalMetadata: a }) => K(jP, {
  className: Q("pointer-events-none", n),
  children: [e && S("div", {
    className: Q("flex flex-col gap-0.5", r && "gap-x-3 gap-y-0", a && "flex-col gap-y-0.5"),
    children: e.map((i, o) => S(J9, {
      metadata: i
    }, o))
  }), t]
}), QW = ["contain", "cover", "fit-width", "fit-height", "scale-down"], e7 = ["xs", "sm", "md", "lg", "xl"], Q9 = {
  xs: "h-24",
  sm: "h-32",
  md: "h-40",
  lg: "h-48",
...
const rz = We(function({ compact: t = !1, avatar: r, image: n, imageFit: a = "fit-width", imageSize: i = "sm", blurredBackground: o = !0, title: s, description: u, metadata: c, children: l, link: f, primaryAction: d, secondaryActions: p, otherActions: y, selectable: h = !1, selected: v = !1, onSelect: b, onClick: g, forceVerticalMetadata: x = !1, fullHeight: O = !1, disableOverlayLink: m = !1 }, w) {
  const A = Me(null), _ = (P) => {
  ...
  return K(Fv, {
    ...
    children: [f && !m && S(xO, {
      ...
      className: Q("relative -mx-3 -mt-3 mb-4 rounded-md", Q9[i], t && "-mx-2 -mt-2 mb-3", a === "fit-height" && "flex items-center justify-center overflow-hidden", a === "fit-width" && "flex items-center justify-center overflow-hidden", a !== "fit-width" && a !== "fit-height" && "overflow-hidden"),
...
}), az = ["forceVerticalMetadata", "disableOverlayLink"], FP = We((e, t) => {
...
const t7 = _O(FP, iz), zP = We(({ className: e, ...t }, r) => S(PO, {
  ref: r,
  className: Q("text-f1-foreground-secondary", e),
  ...t
}));
zP.displayName = PO.displayName;
...
function r7({ title: e, description: t, onClick: r, onClose: n, isVisible: a, dismissable: i = !1, trackVisibility: o, type: s, ...u }) {
  const [c, l] = he(a);
  Le(() => {
    l(a), o && o(a);
  }, [a, o]);
...
function dz({ onSelect: e, defaultValue: t, presets: r = [], granularities: n = ["day"], children: a, compareTo: i, defaultCompareTo: o, onCompareToChange: s, hideCalendarInput: u, value: c, asChild: l, weekStartsOn: f, ...d }) {
  const p = Pr(), y = bO(), [h, v] = he(c || t), b = f ?? y.date?.weekStartsOn ?? sE.Monday;
  Le(() => {
    Ua(c, h) || v(c || t);
  }, [c, t]);
  const g = Fe(() => h?.granularity ?? "day", [h?.granularity]), x = Fe(() => fy(b)[g], [g, b]), O = Fe(() => x.calendarMode || "single", [x]), m = (L) => {
    w({
  ...
  }, T = Fe(() => r.length > 0 && !_, [r, _]), $ = () => {
    P(!1);
  }, M = Fe(() => x.calendarView || "day", [x]), [j, I] = he(o || void 0), D = Fe(() => {
    const L = (i ?? {})[g] || [];
    if (!h?.value)
      return [];
...
const HP = We(({ value: e, onDateChange: t, granularity: r, onOpenChange: n, minDate: a, maxDate: i, onClear: o, ...s }, u) => {
...
function pz({ onChange: e, value: t, presets: r = [], granularities: n = ["day"], minDate: a, maxDate: i, open: o = !1, ...s }) {
  ...
  const d = Pr(), p = Fe(() => n[0] ?? "day", [n]), y = tt((w) => {
    const A = w || p;
    if (!Xe[A])
  ...
  }, [y]), v = Fe(() => y(u?.granularity), [u?.granularity, y]);
  Le(() => {
    const w = h(t);
    Ua(u, w) || c(w);
  }, [t]);
  ...
  }, O = Fe(() => r.filter((w) => n.includes(w.granularity)), [r, n]), m = Me(null);
  return Le(() => {
...
function Zi(e, t, r) {
  return (t = vz(t)) in e ? Object.defineProperty(e, t, {
    value: r,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
var ra = /* @__PURE__ */ wz(), ZP = "data-pdnd-honey-pot";
function JP(e) {
...
function Yw(e) {
  var t = e.client, r = Pz(_z(Az(Sz(t))));
...
function kz(e) {
  var t = e.dragLeave;
  return Yv() ? t.hasOwnProperty(ch.isLeavingWindow) : !1;
}
(function() {
...
function Nz(e) {
  return Dz(e) && e.ownerDocument !== document;
}
function Rz(e) {
  var t = e.dragLeave, r = t.type, n = t.relatedTarget;
  return r !== "dragleave" ? !1 : Yv() ? kz({
    dragLeave: t
  }) : n == null ? !0 : Iz() ? Nz(n) : n instanceof HTMLIFrameElement;
}
function Lz(e) {
  var t = e.onDragEnd;
  return [
...
function Qz(e) {
  var t = e.typeKey, r = e.mount, n = e.dispatchEventToSource, a = e.onPostDispatch, i = e.defaultDropEffect, o = Jz(), s = Gz({
    typeKey: t,
    defaultDropEffect: i
  });
  function u(f) {
...
}), tW = "pdnd:android-fallback", rO = "text/plain", rW = "text/uri-list", nW = "application/vnd.pdnd", Ii = /* @__PURE__ */ new WeakMap();
function aW(e) {
...
var nO = Cz(), Xv = Qz({
  ...
  mount: function(t) {
    return hu(nO.bindEvents(), ra.bind(document, {
      type: "dragstart",
      listener: function(n) {
        var a, i, o, s, u, c;
        if (t.canStart(n) && !n.defaultPrevented) {
          ...
          eW() && !n.dataTransfer.types.includes(rO) && !n.dataTransfer.types.includes(rW) && n.dataTransfer.setData(rO, tW), n.dataTransfer.setData(nW, "");
          var m = {
            element: f.element,
...
}), nT = Xv.dropTarget, iW = Xv.monitor;
function oW(e) {
...
function uW({ driver: e, children: t }) {
  const r = Me(e), n = Fe(() => ({
    driver: r.current
  }), []);
...
function fW({ otherActions: e, open: t, setOpen: r, disabled: n }) {
  return S(eS, {
...
function dW({ item: e, counter: t, isActive: r, sortable: n, collapsible: a = !1, isExpanded: i = !1, onToggleExpanded: o = () => {
...
function Ka({ item: e, counter: t, isActive: r, collapsible: n = !1, isExpanded: a = !1, onToggleExpanded: i = () => {
  ...
  const [y, h] = he(!1), [v, b] = he(!1), g = Me(null), [x, O] = he(null), [m, w] = he(!1), A = Me(null), _ = Fe(() => ({
    kind: "toc-item",
    id: e.id,
    data: {
      item: e,
...
function pW({ item: e, children: t, isActive: r, isExpanded: n, onToggleExpanded: a, sortable: i, hideChildrenCounter: o, canDropInside: s = !1, onDragOver: u, onDragLeave: c, onDrop: l, currentParentId: f, draggedItemId: d }) {
  const p = bE();
  return K(xE, {
    open: n,
    onOpenChange: (y) => {
...
function hW({ item: e, children: t, isActive: r, sortable: n, hideChildrenCounter: a, canDropInside: i = !1, onDragOver: o, onDragLeave: s, onDrop: u, currentParentId: c, draggedItemId: l }) {
  return K(ft, {
    children: [S(Ka, {
      item: e,
...
function uT(e, t, r, n, a, i, o, s, u, c, l, f, d, p, y, h, v, b, g) {
  const x = e.children ? ja : Ka, O = o?.has(e.id) ?? !0, m = f === e.id, w = !!(l && l !== e.id && c && e.children !== void 0 && !oT(c, l, e.id)), A = !!(l && l !== e.id && m && d === "before"), _ = !!(l && l !== e.id && m && d === "after"), P = y === null ? c?.[0]?.id === e.id : !c || !y ? !1 : mt(c, y)?.item.children?.[0]?.id === e.id;
  return K(ft, {
    children: [S(Da, {
      children: A && S(Ht.div, {
        initial: {
...
function gW({ title: e, items: t, className: r, activeItem: n, collapsible: a = !1, sortable: i = !1, showSearchBox: o = !1, searchPlaceholder: s, onReorder: u, hideChildrenCounter: c = !1, scrollable: l = !0 }) {
  const f = Pr(), [d, p] = he(""), y = (E) => {
    p(E);
  }, h = Fe(() => aO(t, d), [t, d]), [v, b] = he(vW(t, n)), [g, x] = he(t);
  Le(() => {
    x(t);
  }, [t]);
  const O = Me(null), m = tt((E) => {
    ...
    let oe = iT(g, E);
    const Se = mW(g, E, Y, F);
    oe = yW(oe, ce, Y, Se), x(oe), Y !== null && b((Te) => {
      const me = new Set(Te);
      return me.add(Y), me;
    }), u && u(gn(oe));
  }, [g, u, gn]), P = Fe(() => aO(g, d), [g, d]), [k, T] = he(null), [$, M] = he(null), [j, I] = he(null), [D, R] = he(null), L = Me(null), z = Me(!1), N = Me(null), B = Me(null), q = Me(null), H = Me(null), X = Me(null), te = Me(0), ne = Me(0), ee = Me(!1), J = Me(null), U = tt((E, Y) => {
...
function bW(e) {
  const t = Me(/* @__PURE__ */ Symbol("f0-table-of-contents")), r = Fe(() => sW(t.current), []);
  return S(uW, {
    driver: r,
    children: S(gW, {
      ...e
...
const s7 = ki("F0TableOfContent", bW), xW = We(function({ bare: t = !1, ...r }, n) {
  return S("div", {
    ref: n,
    role: "separator",
  ...
  children: [S("div", {
    ...
    className: "flex flex-col gap-2",
    children: t.map((r) => S(wW, {
      text: r.text,
      isCompleted: r.isCompleted ?? !1
    }, r.text))
  })]
}), SW = ({ onClose: e, success: t, successButtonOnClick: r, successButtonLabel: n, closeLabel: a }) => {
...
}, cT = We(({ open: e, onClose: t, success: r = !0, errorMessage: n, successMessage: a, nextSteps: i, closeLabel: o, portalContainer: s }, u) => {
  const [c, l] = he(!1), f = tt(() => {
    l(!0), setTimeout(() => {
      t?.(), l(!1);
    }, 200);
...
var AW = "Label", lT = fe.forwardRef((e, t) => /* @__PURE__ */ S(
  xh.label,
  {
    ...e,
    ref: t,
...
lT.displayName = AW;
var fT = lT;
const _W = fe.forwardRef(({ className: e, ...t }, r) => S(fT, {
  ref: r,
  className: Q("text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", e),
  ...t
}));
_W.displayName = fT.displayName;
function u7({ label: e, showIcon: t = !0, onRequest: r, showConfirmation: n = !0, loading: a, errorMessage: i, successMessage: o, loadingState: s, nextSteps: u, closeLabel: c, variant: l = "promote", onModalStateChange: f, portalContainer: d, ...p }) {
...
const PW = We(function({ title: t, subtitle: r, mediaUrl: n, primaryAction: a, secondaryAction: i, onClose: o, isLoading: s = !1, children: u, variant: c = "default" }, l) {
...
TW.displayName = "BaseBanner";
const pT = {
  get: () => ({}),
  set: () => Promise.resolve()
}, hT = Ft(pT), c7 = ({ children: e, handler: t }) => S(hT.Provider, {
  value: t ?? pT,
  children: e
}), l7 = () => {
  const e = dt(hT);

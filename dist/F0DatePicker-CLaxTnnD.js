...
import { f as t } from "./variants-BhCxKzs5.js";
import { r as n } from "./F0Button-CYTXun0O.js";
import { $ as r, D as i, E as a, O as o, P as s, Q as c, Z as l, ft as u, g as d, j as f, mt as p, pt as m, t as h, tn as g, tt as _ } from "./F0Select-_dXXh4fu.js";
import { A as v, M as y, j as b } from "./F0Checkbox-Bc_SibvL.js";
import { i as x, n as S, r as C, t as w } from "./Link-CZ2DGAX8.js";
import { a as ee, i as T, t as te } from "./popover-By8ytmVb.js";
import { r as E, t as D } from "./input-DH5KiXa2.js";
...
var z = "__custom__", B = (e, t) => {
	...
	return e.granularity === t.granularity && u(e.value.from, n.from) && (!e.value.to || !n.to || u(e.value.to, n.to));
}, ae = ({ presets: e, ...t }) => {
	let [n, r] = N();
	return A(() => {
		if (t.date) {
...
function q({ onSelect: e, defaultValue: r, presets: i = [], granularities: a = ["day"], children: o, compareTo: c, defaultCompareTo: u, onCompareToChange: f, hideCalendarInput: p, value: m, asChild: _, weekStartsOn: y, selectOnCellOnly: x = !1, periods: S, ...C }) {
	let w = t(), E = v(), [D, O] = N(m || r), k = y ?? E.date?.weekStartsOn ?? b.Monday, P = ne(s), L = P.portalContainer && (P.position === "center" || P.position === "fullscreen") ? P.portalContainer : void 0, R = M(null), z = j(() => oe(() => R.current), []);
	A(() => {
		G(m, D) || O(m || r);
	}, [m, r]);
	let B = j(() => D?.granularity ?? "day", [D?.granularity]), V = j(() => l({
		...
		Z(!1);
	}, ue = j(() => H.calendarView || "day", [H]), [Q, de] = N(u || void 0), $ = j(() => {
		let e = (c ?? {})[B] || [];
		if (!D?.value) return [];

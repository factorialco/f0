...
import { useInsertionEffect as Tr, forwardRef as h, useRef as j, useEffect as q, useLayoutEffect as rt, useState as B, useMemo as J, useCallback as _, useContext as Ie, createContext as Ge, useId as ot, createElement as Hr, memo as Ar } from "react";
import { d6 as $r, d7 as Br, ac as nt, c4 as Ir, d8 as Pr, d9 as jr, da as Dr, db as Zr, c5 as _r, cd as st, c3 as Or, dc as Ur, al as s1, dd as zr, aU as Gr, de as Wr, df as qr, dg as Xr, at as Yr, dh as Kr, cE as Qr, an as it, aq as Jr, di as eo, o as i1, ag as at, a7 as We, n as ct, bs as to, cb as ro, dj as oo, bd as no, cD as so, ae as Fe, aG as io, bw as lt, dk as ao, cB as co, l as Me, cz as lo, dl as fo, bZ as dt, bc as uo, dm as ho, dn as go, dp as po, dq as Co, dr as mo, ds as ft, cr as vo, cs as wo, dt as xo, du as ko, dv as Lo, dw as bo, dx as yo, bG as Mo, c7 as Eo, dy as Ro, dz as Fo, dA as No, dB as Vo, dC as So, dD as To, dE as Ho, dF as Ao, bF as $o, cC as Bo, ao as Io, cn as Po, dG as jo, dH as Do, dI as Zo, dJ as _o, dK as Oo, dL as Uo, dM as zo, aC as Go, bH as Wo, b$ as ut, a4 as qo, af as Xo, bI as ht, bY as Yo, b_ as gt, i as Ko, bv as Qo, bu as Jo, dN as en, dO as tn, bJ as pt, bK as rn, bL as on, bb as nn, aJ as sn, dP as an, j as cn, bq as Ct, bp as mt, bj as ln, dQ as vt, bi as dn, c6 as a1, q as fn, bm as c1, dR as un, dS as hn, dT as l1, c9 as gn, ca as pn, cA as wt, dU as Cn, $ as mn, _ as vn, dV as wn, dW as xn, dX as kn, dY as Ln, bW as bn, dZ as xt, d_ as yn, ap as Mn, d$ as En, g as G, bV as Rn, a3 as ce, S as he, bU as kt, a0 as le, U as ge, ah as Fn, r as k, m as ve, e0 as Nn, ar as se, a_ as Le, Z as Ee, K as ee, cO as Lt, aO as d1, e1 as Vn, aP as f1, aQ as u1, u as ye, bS as Sn, e2 as Tn, bT as Hn, a8 as An, ba as $n, ak as h1, bM as Bn, bN as In, bO as Pn, bP as y1, ai as jn, ax as bt, b1 as yt, c8 as Dn, cM as Zn, e3 as _n, e4 as On, b6 as Mt, e5 as Un, cP as zn, e6 as Gn, b3 as Be, bk as Et, e7 as Rt, bl as Ft, F as r1, cc as M1, e8 as Nt, e9 as Wn, ea as qn, L as Te, bA as Xn, eb as Yn, br as g1, co as Kn, ec as Qn, ed as Jn, ee as es, ef as ts, eg as rs, w as os, t as ns, ci as ss, X as is, Y as as, aw as E1, eh as Vt, ei as St, ej as cs, ek as ls, av as ds, am as fs, el as us, em as hs, e as gs } from "./F0CanvasPanel-B7YrVJps.js";
...
`) ? o + "_" : o
  ...
  cards: e
}) => e.length === 0 ? null : /* @__PURE__ */ t("div", { className: "grid w-full grid-cols-2 gap-3", children: e.slice(0, Mc).map((r) => /* @__PURE__ */ t(
  Lt,
  {
        ...
        l && /* @__PURE__ */ a(
          u1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ t("div", { className: "flex flex-col", children: Fc(l.items).map((d, c) => /* @__PURE__ */ a(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
` || z === "	";
  ...
  const A = J(() => {
    ...
    const V = s.current;
    if (!V) return null;
    const $ = Ic(V, F.current), U = V.offsetLeft + $.left, z = (V.offsetParent ? V.offsetParent.offsetHeight : 0) - (V.offsetTop + $.top);
...
const Dc = /[\\`*_{}[\]()#+\-.!|~>]/g, Zc = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((r, o) => o % 2 === 1 ? r : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(Dc, "\\$&")).join(""), P6 = ({
  onSubmit: e,
  onStop: r,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const Ze = async (Q) => {
    if (Q.preventDefault(), !ie) {
      if (ne.close(), o)
        ...
        const ke = ne.transformMentions(E.trim()), Je = Zc(ke), Oe = Ae.flatMap(
  ...
  }, m1 = X ? X.prompt ?? X.title : null, v1 = Pe ? [L.ai.listening] : m1 ? [m1] : s ?? [], Rr = v1.length > 1, Fr = J(() => Vc(E, ne.mentions, {
    cursorPosition: $,
    ...
    ee.div,
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ t(xc, { creditWarning: i, children: /* @__PURE__ */ a(
            ee.form,
            {
              "aria-busy": o,
              ref: D,
        ...
        Vr && /* @__PURE__ */ t("div", { className: "w-full max-w-content pt-2", children: /* @__PURE__ */ t(Ec, { cards: w }) }),
...
Dt.displayName = "CandidateTrigger";
function a2({
  id: e,
  label: r
}) {
...
const F1 = 7, v2 = 625, N1 = /* @__PURE__ */ new Set();
function w2(e) {
...
function Wt(e, r) {
  ...
  if (r === "duration" && typeof e == "number")
    return { type: "item", text: k2(e) };
  if (r === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? w2(o) : "") || "—" };
  }
  ...
  return { type: "item", text: x2(String(e)) };
}
function qt({
  formName: e,
  formDescription: r,
  ...
  const { canvasContent: c, openCanvas: u, closeCanvas: f } = ye(), p = m2(e), C = d ?? p, g = j(() => {
  ...
  g.current = F, q(() => {
    typeof window > "u" || window.innerWidth < v2 || N1.has(e) || (N1.add(e), g.current());
  }, [e]);
...
const Kt = Ge(void 0), O6 = () => Ie(Kt), M2 = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), E2 = ({
  isGenerating: e,
  isLoading: r,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", c = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, u = o?.toolCalls?.[0]?.id, f = !d && !c, p = j(null), { anchor: C, clear: g } = Xt({
    containerRef: p,
    enabled: !!(o?.id && d)
  });
  return q(() => {
...
const er = (e) => /* @__PURE__ */ t(Mt, { content: e, format: "markdown" }), $2 = ({
  text: e,
  renderMarkdown: r
  ...
  const l = e.rawData, d = A2(
    e?.content,
    l
  ), c = (H2(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = c.length > 0, { anchor: p, clear: C } = Xt({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ t($2, { text: u, renderMarkdown: n }),
...
}, I2 = 35, P2 = 22, j2 = 400, D2 = 2500, Z2 = 220, _2 = ({
  messages: e,
  onClick: r,
  fullscreen: o = !1
}) => {
  ...
  q(() => {
    ...
    if (d === "starting")
      ...
      i < u.length ? C = setTimeout(() => l((g) => g + 1), I2) : c("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      C = setTimeout(() => c("erasing"), D2);
    } else d === "erasing" && (i > 0 ? C = setTimeout(() => l((g) => g - 1), P2) : C = setTimeout(() => {
...
const U2 = {
...
}, z6 = (e) => /* @__PURE__ */ t(F2, { children: /* @__PURE__ */ t(z2, { ...e }) }), z2 = ({
  turns: e,
  isLoadingThread: r = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: H, handleSubmit: S, handleClose: M } = N2(
    f ?? U2
  ), w = G(), N = x ?? E2, L = v ?? B2, A = J(() => {
    const D = n ?? w.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((K) => typeof K == "string" && K.length > 0);
  }, [n, w.ai.defaultInitialMessage]), E = !r && e.length === 0 && A.length > 0, V = j(null), $ = j(null), U = j(null), O = j(null), z = j(null), { showScrollBtn: te, turnMinHeight: oe, scrollToBottom: X } = O2({
    viewportRef: V,
    contentRef: $,
    endRef: U,
    lastTurnRef: z,
...
}, G2 = () => /* @__PURE__ */ t("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ a("div", { className: "flex flex-col gap-2", children: [
...
const q2 = ({
  ...
  const C = G().ai.clarifyingQuestion.typeYourAnswer, g = e === "single" ? /* @__PURE__ */ t(rr, { isSelected: o && !r }) : /* @__PURE__ */ t(
    Nt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
  ...
  return /* @__PURE__ */ a("div", { className: "flex flex-col", onKeyDown: ie, children: [
    /* @__PURE__ */ t("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ t(Ee, { mode: "wait", initial: !1, children: /* @__PURE__ */ a(
      ee.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ue, ease: Q2 },
        children: [
          /* @__PURE__ */ t(
            K2,
            {
...
class K6 {
  ...
  setupGL() {
    ...
    const S = (this.options.colors || nl).map(sl);
...
const B1 = ["lowp", "mediump", "highp"], il = `
void main(void){
...
}`, P1 = "iTime", j1 = "iTimeDelta", D1 = "iDate", Z1 = "iFrame", _1 = "iMouse", O1 = "iResolution", cl = "iChannel", U1 = "iChannelResolution", z1 = "iDeviceOrientation";
function ll(e, r) {
...
}, e1 = 9729, G1 = 9728, gl = 9987, W1 = 33071, q1 = 10497;
class pl {
  gl;
  url;
  wrapS;
...
}, Y1 = (e, r, o) => e * (1 - o) + r * o, Cl = (e, r, o) => o > 0 ? e.substring(0, o) + r + e.substring(o, e.length) : r + e;
function ml({
  fs: e,
  vs: r = I1,
  textures: o = [],
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (y, P) => (E.current[`${cl}${P}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, $(y, P), N.current[P] = new pl(b), N.current[P]?.load(y).then((T) => {
            $(T, P);
          }))
        );
        Promise.all(R).then(() => {
...
`,
    ...
    return b.includes("mainImage") && (P = P.concat(il)), P;
  }, pe = (b) => {
    const R = m.current;
  ...
  return q(() => {
    ...
    function R() {
      U();
      const y = m.current;
      y && g.current && (y.clearColor(...s), y.clearDepth(1), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, K(), ie(), W(ue(e || al), r || I1), O(), requestAnimationFrame(re), de(), Y());
    }
...
}`, wl = 10, xl = 2, kl = 0.5, Ll = 0.2, bl = 1.5, Ce = {
  duration: 0.5,
  ease: "easeOut"
}, K1 = {
  duration: 0.35,
...
function yl(e, r) {
  const [o, n] = B(wl), {
    ...
    animate: i,
    motionValue: l
  } = Ue(Ll), { value: d, animate: c } = Ue(xl), { value: u, animate: f } = Ue(kl), { value: p, animate: C } = Ue(bl), g = Cs(r, {
    fftSize: 512,
...
function Q6({
  ...
  const { speed: u, scale: f, amplitude: p, frequency: C, brightness: g } = yl(r, s);
  return /* @__PURE__ */ t(
    nr,
    {
      ref: d,
...
const Vl = Te({
  ...
  const n = G(), s = Le();
  return /* @__PURE__ */ a(Re, { children: [
    e && /* @__PURE__ */ t("span", { className: k(Sl(), "truncate"), children: e }),
    ...
    /* @__PURE__ */ a(
      ee.div,
      {
        ...
        children: [
          ...
          n === "balance" && /* @__PURE__ */ t(Al, { balance: e.balance })
        ]
      }
    ),
    o && !Hl.has(n) && /* @__PURE__ */ t(
      ee.span,
      {
        className: k(ze()),
        animate: { opacity: s ? 0 : 1 },
...
const Il = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || r == null ? null : /* @__PURE__ */ t("circle", { cx: e, cy: r, r: 2, fill: s, stroke: "none" }), Pl = ({
  label: e,
  direction: r
}) => {
  const o = ar[r];
  ...
  const s = `sparkline-gradient-${ot().replace(/:/g, "")}`, i = Bl(e, o), l = ar[i];
  return /* @__PURE__ */ t("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ a(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t(Pl, { label: r, direction: i })
      ]
    }
  ) });
}, cr = h(
...
const Dl = ["className"], lr = h((e, r) => {
  const o = Dl.reduce((n, s) => {
    const { [s]: i, ...l } = n;
    return l;
  }, e);
...
const Zl = () => /* @__PURE__ */ a(
  ...
  "balance",
  "sparkline"
], dr = 180, _l = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : dr, Ol = (e, r) => e.length <= r ? e : `${e.slice(0, r).trimEnd()}...`, Ul = (e) => e.showActions !== !1, zl = (e) => Object.fromEntries(
...
function Gl(e) {
  ...
  } = e, [c, u] = B(!1), f = ot(), p = j(null), C = _l(
    d
  ), g = i.length > C, m = c ? i : Ol(i, C), x = Ul(e) ? e : null, v = zl(e);
  return q(() => {
    c && p.current?.focus();
  }, [c]), /* @__PURE__ */ a(
    "section",
...
Gl.displayName = "F0AiProposalCard";
const Wl = ({
  icon: e,
  title: r,
  children: o
...
}, ql = (e) => pc[e] ?? ft, Xl = ({ iconName: e }) => e ? /* @__PURE__ */ t("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ t(le, { icon: ql(e), size: "md", color: "default" }) }) : null;
function Yl({
  sources: e,
  title: r
}) {
  ...
  return /* @__PURE__ */ t(Wl, { icon: c1, title: n, children: /* @__PURE__ */ t("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const l = /* @__PURE__ */ t(Xl, { iconName: s.icon });
...
const h6 = Te({
  ...
  ({
    ...
    const Ae = D && D !== "none" || W && W !== "none" || K && K !== "none" || ie && ie !== "none", Se = Y && Y !== "none" || Ae, je = { sm: xe, md: Xe, lg: Ye, xl: Ke }, De = g6.map((Ze) => {
      const _e = je[Ze];
      return _e ? u6(Ze, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ t(

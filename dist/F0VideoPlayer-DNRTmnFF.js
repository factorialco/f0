import { u as W, v as je, x as Xe, m as $, y as Ge, z as Ze, A as qe, B as Ye, E as Je, G as Qe, H as et, J as tt, K as nt, L as rt, M as at, N as ot, O as st, Q as ye, R as Ce, U as it, V as ct, W as lt, X as Pe, l as dt, Y as ut, Z as ft, _ as mt, w as pt, s as ht } from "./F0CanvasPanel-DVhw3WsR.js";
import { jsxs as R, jsx as l } from "react/jsx-runtime";
import { forwardRef as re, useId as gt, useState as x, useRef as O, useEffect as _, useMemo as J, useCallback as M } from "react";
...
function Et({
  ...
  return /* @__PURE__ */ R(je, { open: o, onOpenChange: i, children: [
    /* @__PURE__ */ l(Xe, { asChild: !0, children: /* @__PURE__ */ l(
      $,
      {
        variant: "ghost",
        size: "sm",
...
function Bt(e) {
  ...
  _(() => {
    ...
    return s.addEventListener("play", P), s.addEventListener("pause", D), s.addEventListener("ended", B), s.addEventListener("volumechange", j), s.addEventListener("loadedmetadata", K), s.addEventListener("ratechange", X), s.addEventListener("timeupdate", F), s.readyState >= 1 && s.duration && f(s.duration), () => {
      s.removeEventListener("play", P), s.removeEventListener("pause", D), s.removeEventListener("ended", B), s.removeEventListener("volumechange", j), s.removeEventListener("loadedmetadata", K), s.removeEventListener("ratechange", X), s.removeEventListener("timeupdate", F);
    };
  }, [a]);
  const T = M(() => {
    const s = t.current;
...
function Wt({
  ...
  const { t: b } = W(), E = O(null), A = J(() => ae(e), [e]), [k, L] = x(
    ...
    i?.describedSrc,
    K
  ), [U, Y] = x(!1), G = U && F ? F : v, p = Bt(G), N = Ut(p.videoElement, P), z = It(p.videoElement, {
    enabled: U,
    describedSrc: F,
    descriptions: X
  }), V = M(() => {
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ l(
              "button",
              {
                ...
                children: /* @__PURE__ */ l(mt, { icon: Pe, size: "lg", color: "#fff" })
              }
            )
          }
        ),

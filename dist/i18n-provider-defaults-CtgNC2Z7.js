//#endregion
//#region src/lib/providers/i18n/i18n-provider-defaults.ts
var e = {
	...
	filters: {
		...
		inFilter: { searchPlaceholder: "Search options..." },
	...
	ai: {
		...
		formCard: { moreFields: "Open to see all fields" },
		aiTable: {
			title: "Table",
		...
		growth: {
			...
			moduleCard: { actionLabel: "Learn more" },
			faqCard: { title: "Questions before getting started" }
		}
	},
	chat: {
	...
	surveyFormBuilder: {
		...
		fileQuestion: { uploadButton: "Upload file" },
		checkboxQuestion: { placeholder: "Provide a label for the checkbox" },
		answer: {
			label: "Answer",
	...
	forms: {
		...
		validation: {
			...
			checkbox: { mustBeChecked: "This option must be selected" },

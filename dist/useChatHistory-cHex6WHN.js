import { jsxs as c, jsx as r, Fragment as ke } from "react/jsx-runtime";
import { useInsertionEffect as on, forwardRef as p, createElement as Ie, useRef as I, useMemo as J, useEffect as Y, useLayoutEffect as Ct, useState as P, useCallback as W, useImperativeHandle as sn, createContext as Qe, useContext as je, useId as vt } from "react";
import { cj as an, ck as cn, cl as ln, cm as dn, cn as wt, co as fn, cp as un, cq as hn, cr as gn, cs as pn, ct as xt, cu as mn, cv as Cn, cw as vn, cx as wn, cy as xn, cz as kn, cA as bn, cB as Xe, cC as Ln, cD as yn, cE as Mn, cF as En, cG as Rn, Z as kt, cH as Fn, cI as Nn, cJ as Sn, cK as Vn, cL as Tn, cM as bt, cN as Hn, cO as An, a6 as m1, cP as Bn, aJ as $n, cQ as In, cR as Pn, cS as jn, ag as Dn, cT as Zn, bO as _n, aa as C1, ad as On, cU as Un, ba as v1, a1 as Lt, S as Je, cV as yt, b9 as zn, cW as Gn, cX as Wn, b2 as qn, bN as Xn, $ as Me, au as Yn, be as Mt, cY as Kn, bL as Qn, cZ as Fe, bH as Jn, c_ as eo, c$ as Et, b1 as Rt, d0 as to, d1 as ro, d2 as no, d3 as oo, d4 as so, d5 as Ft, bz as io, bA as ao, d6 as co, d7 as lo, d8 as fo, d9 as uo, da as ho, db as go, dc as po, dd as mo, de as Co, df as vo, dg as wo, dh as xo, di as ko, dj as bo, bM as Lo, ab as yo, bv as Mo, dk as Eo, dl as Ro, dm as Fo, dn as No, dp as So, dq as Vo, dr as To, ap as Ho, ds as Nt, M as Ao, a0 as Bo, dt as St, du as Vt, dv as $o, bd as Io, bc as Po, dw as jo, dx as Do, dy as Tt, dz as Zo, b0 as _o, ay as Oo, dA as Uo, as as zo, b7 as Go, dB as Ht, b6 as Wo, dC as qo, bi as w1, dD as Xo, dE as Yo, dF as x1, bJ as Ko, bI as Qo, bK as At, dG as Jo, G as es, E as ts, dH as rs, dI as ns, dJ as os, dK as ss, dL as is, dM as Bt, dN as as, ac as cs, dO as ls, L as he, q as Ne, o as k, ae, dP as ds, bp as fs, bC as us, y as $t, dQ as hs, a5 as e1, b$ as gs, Q as pe, at as ps, H as ce, a8 as It, a9 as ms, af as Pt, bq as jt, dR as Cs, a$ as Dt, v as me, dS as vs, dT as ws, U as ge, u as Q, dU as xs, cg as Zt, a2 as ks, dV as bs, aP as Ee, A as Se, p as se, aD as k1, dW as Ls, aE as b1, aF as L1, b as Re, dX as ys, dY as Ms, bD as Es, V as Rs, dZ as Fs, d_ as Ns, d$ as Ss, e0 as $1, a3 as Vs, ak as _t, aS as Ot, e1 as Ts, b_ as Hs, e2 as As, e3 as Bs, aX as Ut, e4 as $s, bU as Is, e5 as Ps, aU as Pe, bg as zt, e6 as Gt, bh as Wt, c as u1, e7 as qt, e8 as js, bk as Ds, e9 as Zs, b8 as y1, bw as _s, ea as Os, eb as Us, ec as zs, ed as Gs, ee as Ws, z as qs, ef as Xt, eg as Yt, eh as Xs, aj as I1, ei as Ys, ai as Ks, ej as Qs, ek as Js } from "./F0CanvasPanel-DWqZRYSD.js";
import { createPortal as Kt } from "react-dom";
import { defaultTranslations as ei } from "./i18n-provider-defaults.js";
import { useTrackVolume as ti } from "@livekit/components-react";
function ri(e, t, n) {
  on(() => e.on(t, n), [e, t, n]);
}
function M1(e) {
...
function Qt(e, t, n, o) {
  return typeof e == "string" && M1(t) ? an(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function ni(e, t, n) {
  return e * (t + 1);
}
...
function Jt(e, t) {
  return cn(e) ? e[oi(0, e.length, t)] : e;
}
function si(e, t, n) {
  for (let o = 0; o < e.length; o++) {
    const s = e[o];
    s.at > t && s.at < n && (dn(e, s), o--);
  }
}
function ii(e, t, n, o, s, i) {
  si(e, s, i);
...
const li = "easeInOut", di = 20;
function fi(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let h = 0; h < e.length; h++) {
    ...
    let S = 0;
    const H = (E, b, R, B = 0, y = 0) => {
      const V = ui(E), { delay: F = 0, times: L = fn(V), type: $ = "keyframes", repeat: Z, repeatType: _, repeatDelay: G = 0, ...te } = b;
      let { ease: X = t.ease || "easeOut", duration: U } = b;
      const q = typeof F == "function" ? F(B, y) : F, D = V.length, ee = gn($) ? $ : s?.[$];
      if (D <= 2 && ee) {
        let re = 100;
        if (D === 2 && pi(V)) {
          const fe = V[1] - V[0];
        ...
        const ne = { ...te };
        U !== void 0 && (ne.duration = pn(U));
        const oe = un(ne, re, ee);
        X = oe.ease, U = oe.duration;
      }
      U ?? (U = i);
      const O = g + q;
      L.length === 1 && L[0] === 0 && (L[1] = 1);
      const le = L.length - V.length;
      if (le > 0 && hn(L, le), V.length === 1 && V.unshift(null), Z) {
        xt(Z < di, "Repeat count too high, must be less than 20"), U = ni(U, Z);
        const re = [...V], ne = [...L];
        ...
        for (let fe = 0; fe < Z; fe++) {
          ...
          for (let M = 0; M < re.length; M++)
            L.push(ne[M] + (fe + 1)), X.push(M === 0 ? "linear" : Jt(oe, M - 1));
        }
        ai(L, Z);
      }
      const de = O + U;
      ii(R, V, X, L, O, de), S = Math.max(q + U, S), m = Math.max(de, m);
    };
    if (wt(w)) {
      const E = j1(w, d);
      H(v, x, D1("default", E));
    } else {
      const E = Qt(w, v, o, l), b = E.length;
      for (let R = 0; R < b; R++) {
        v = v, x = x;
        const B = E[R], y = j1(B, d);
        for (const V in v)
          H(v[V], hi(x, V), D1(V, y), R, b);
      }
    }
    f = g, g += S;
  }
  return d.forEach((h, C) => {
    for (const w in h) {
      ...
      for (let b = 0; b < v.length; b++) {
        const { at: R, value: B, easing: y } = v[b];
        x.push(B), S.push(mn(0, m, R)), H.push(y || "easeOut");
      }
      S[0] !== 0 && (S.unshift(0), x.unshift(x[0]), H.unshift(li)), S[S.length - 1] !== 1 && (S.push(1), x.push(null)), a.has(C) || a.set(C, {
        keyframes: {},
        transition: {}
      });
      const E = a.get(C);
      E.keyframes[w] = x, E.transition[w] = {
        ...t,
        duration: m,
        ease: H,
        times: S,
...
const gi = (e) => typeof e == "number", pi = (e) => e.every(gi);
function mi(e, t) {
  return e in t;
}
class Ci extends Cn {
...
function vi(e) {
  ...
  }, n = wn(e) && !xn(e) ? new kn(t) : new bn(t);
  n.mount(e), Xe.set(e, n);
}
function wi(e) {
  const t = {
    presenceContext: null,
...
function er(e, t, n, o) {
  const s = [];
  if (xi(e, t))
    s.push(Ln(e, M1(t) && t.default || t, n && (n.default || n)));
  else {
    const i = Qt(e, t, o), a = i.length;
    xt(!!a, "No valid elements provided.");
    for (let d = 0; d < a; d++) {
      const l = i[d], u = l instanceof Element ? vi : wi;
      Xe.has(l) || u(l);
      const f = Xe.get(l), g = { ...n };
      "delay" in g && typeof g.delay == "function" && (g.delay = g.delay(d, a)), s.push(...yn(f, { ...t, transition: g }, {}));
    }
  }
  return s;
}
function ki(e, t, n) {
  const o = [];
  return fi(e, t, n, { spring: Mn }).forEach(({ keyframes: i, transition: a }, d) => {
    o.push(...er(d, i, a));
  }), o;
}
class bi {
...
function Mi(e) {
  function t(n, o, s) {
    let i = [];
    return yi(n) ? i = ki(n, o, e) : i = er(n, o, s, e), new Li(i);
  }
  return t;
}
const Ei = Mi(), Ri = (e, t) => /* @__PURE__ */ c(
  "svg",
  {
...
const Xc = (e, t) => /* @__PURE__ */ c(
...
), Al = p(Hl), Bl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Fi,
  Add: En,
  Ai: Si,
  ...
  CalendarArrowLeft: oa,
  CalendarArrowRight: ia,
  CameraPlus: ca,
  CardPin: da,
  ChartFunnel: ua,
  ChartHorizontalBars: ga,
  ChartLine: ma,
  ChartPie: va,
  ...
  FaceNeutral: lo,
  FacePositive: fo,
  FaceSuperNegative: uo,
  FaceSuperPositive: ho,
  Feed: i5,
  File: c5,
  FileFilled: d5,
  FileSigned: u5,
  ...
  Wifi: Al,
  Windows: ls
}, Symbol.toStringTag, { value: "Module" })), $l = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const Be = Ne({
  ...
  ({
    ...
    const g = s ?? jl[t ?? "body"], m = l ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (i !== void 0) {
      ...
      return m ? Ie(
        ...
        ae,
        {
          ...
          noTooltip: a,
          tag: g,
          className: k(Be({ variant: t, align: n }), o),
          markdown: d,
          ...u,
          children: e
        }
...
const r2 = Ne({
  ...
  ({
    ...
    borderRight: le,
    borderRadius: de,
    borderRadiusTopLeft: re,
    borderRadiusTopRight: ne,
    borderRadiusBottomLeft: oe,
    borderRadiusBottomRight: fe,
    borderStyle: M,
    // Overflow
    overflow: T,
    overflowX: N,
    ...
    const _e = D && D !== "none" || ee && ee !== "none" || O && O !== "none" || le && le !== "none", s1 = q && q !== "none" || _e, Te = { sm: t1, md: xe, lg: r1, xl: n1 }, Oe = n2.map((Ae) => {
      const Ue = Te[Ae];
      return Ue ? t2(Ae, Ue) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
}), c1 = { sm: 640, md: 768, "container-md": 448 }, s2 = 8, g1 = (e) => "type" in e && e.type === "separator", Ye = (e) => "type" in e && e.type === "split", i2 = (e) => !("type" in e), Ke = (e, t, n) => /* @__PURE__ */ r(
  pe,
  {
    label: e.label,
    icon: e.icon,
...
function Z1({
  ...
  const f = I(null), { width: g = 0 } = us({
    ref: f,
    box: "border-box"
  }), m = i === "sm" || i === "md" ? c1[i] : c1.md, h = $t(`(min-width: ${m}px)`, {
    initializeWithValue: !1
  }), C = i === "none" ? !0 : i === "container-md" ? g >= c1["container-md"] : h, w = typeof o == "string" ? o : o.base, v = typeof o == "string" ? o : o.md, x = C ? v : w, S = Array.isArray(
    t
  ) ? t : [], H = t != null && !Array.isArray(t) ? t : void 0, E = {
    primaryAction: e,
    secondaryItems: S,
    secondaryLink: H,
    otherActions: n,
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: C ? /* @__PURE__ */ r(c2, { ...E }, "row") : /* @__PURE__ */ r(a2, { ...E }, "stacked")
    }
  );
}
function a2({
  ...
  const i = t.filter(
    ...
    (a) => Ye(a) ? F1(a, s, "outline") : Ke(a, s, "outline")
  );
  return /* @__PURE__ */ c(ke, { children: [
    o.length > 0 && /* @__PURE__ */ r(gs, { items: o }),
    i,
    n && Lr(n, s),
    e && yr(e, s)
  ] });
...
function c2({
  ...
  const C = a && h ? g : d, w = a ? h ? m : [] : [], v = new Set(C.map((y) => y.id)), x = e ? yr(e, s) : null, S = t.filter(Ye), H = t[t.length - 1], E = H != null && g1(H) && (S.length > 0 || x != null), b = [];
  t.forEach((y, V) => {
    if (!Ye(y)) {
      if (g1(y)) {
        b.push({ kind: "sep", key: `sep-${V}` });
        return;
      }
      v.has(y.id) && b.push({
        kind: "node",
  ...
  const R = b.filter(
    (y, V) => y.kind === "node" || b[V - 1]?.kind === "node" && b[V + 1]?.kind === "node"
  ), B = [
    ...w.map(
      (y) => ({
        label: y.label,
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          B.length > 0 && /* @__PURE__ */ r("div", { ref: f, children: /* @__PURE__ */ r(e1, { items: B, icon: Et, size: s }) }),
          R.map(
...
function C2({
  ...
  const f = k(
    ...
    /* @__PURE__ */ r("div", { className: f, onClick: (v) => v.stopPropagation(), children: w })
  );
  if (o || s) {
    const w = (x) => {
      const S = s ? {
    ...
    return a === "never" ? v : /* @__PURE__ */ c(ke, { children: [
      v,
      /* @__PURE__ */ r(
        "div",
        {
...
const Mr = p(
  function({
    ...
    const S = !!m && m.visible !== !1, E = /* @__PURE__ */ c(
      jt,
      {
        ref: S ? void 0 : x,
        className: k(
        ...
        children: [
          ...
          /* @__PURE__ */ c("div", { className: l2[v], children: [
            /* @__PURE__ */ c(
              "div",
              {
                className: k(
                ...
                children: [
                  o && /* @__PURE__ */ r(vs, { avatar: o, size: "lg" }),
    ...
    return S ? /* @__PURE__ */ r(ws, { ref: x, alert: m, fullHeight: g, children: E }) : E;
  }
);
...
const v2 = () => /* @__PURE__ */ r(
  jt,
  {
    ...
    children: /* @__PURE__ */ c("div", { className: "flex flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-row items-center gap-3", children: [
        /* @__PURE__ */ r(ge, { className: "h-10 w-10 rounded-full" }),
  ...
  const v = Q();
  return g === "recording" ? /* @__PURE__ */ c("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    /* @__PURE__ */ r(
      xs,
      {
        stream: m ?? null,
    ...
    /* @__PURE__ */ r("div", { className: "flex items-center gap-2", children: e && /* @__PURE__ */ c(ke, { children: [
      /* @__PURE__ */ r(
        he,
        {
...
function b2({
  ...
  const o = /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    /* @__PURE__ */ r(ce, { icon: kt, size: "md", color: "critical" }),
  ...
  return e.errorMessage ? /* @__PURE__ */ r(ks, { label: e.errorMessage, children: o }) : o;
}
const L2 = {
  soft: {
    text: "",
        ...
        return /* @__PURE__ */ c(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ r(ae, { className: "text-base font-medium text-f1-foreground", children: h }) })
            ]
          },
          String(f.id)
        );
...
const E2 = ({
  ...
  return /* @__PURE__ */ r("div", { className: "p-1", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r("div", { className: "flex items-center py-0.5", children: /* @__PURE__ */ r(ce, { icon: R1, size: "md", color: "default" }) }),
        /* @__PURE__ */ r(
          ae,
          {
  ...
  const s = Ee(), [i, a] = P(""), [d, l] = P(0), [u, f] = P(!1), g = I(null), m = I(null), h = I(null), C = e[d] ?? t;
  return Y(() => {
    const w = () => {
    ...
    if (s)
      return f(!1), a(C), w(), g.current = setTimeout(() => {
    ...
    f(!0), a("");
    let v = 0;
    const x = 50, S = 30, H = 2e3, E = 1e3;
    return m.current = setInterval(() => {
      v < C.length ? (a(C.slice(0, v + 1)), v++) : (m.current && (clearInterval(m.current), m.current = null), g.current = setTimeout(() => {
        h.current = setInterval(() => {
          v > 0 ? (v--, a(C.slice(0, v))) : (h.current && (clearInterval(h.current), h.current = null), g.current = setTimeout(() => {
            const b = (d + 1) % Math.max(e.length, 1);
            l(b);
          }, E));
        }, S);
    ...
    e.length,
    s
  ]), n.length > 0 || o ? null : /* @__PURE__ */ r(Se, { children: /* @__PURE__ */ r(
    se.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
const V2 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ c(
    k1,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ls, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ r(b1, { asChild: !0, children: /* @__PURE__ */ r(
          he,
          {
            variant: "outline",
            label: d.label,
        ...
        a && /* @__PURE__ */ c(
          L1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: S2(a.items).map((d, l) => /* @__PURE__ */ c(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ r(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ r(ce, { icon: m1, size: "sm" })
                      }
                    )
                  ]
                },
...
function $2(e) {
  const [t, n] = P([]), [o, s] = P(null), i = I(
    null
  ), a = I(null), d = Q(), l = e?.onUploadFiles, u = e?.allowedMimeTypes, f = e?.maxFiles, g = J(() => {
    if (u)
  ...
  const w = W(
    async (H) => {
      ...
      const B = (y) => n(
        (V) => V.map(
          (F) => R.includes(F.id) ? { ...F, status: "error", errorMessage: y } : F
        )
      );
      try {
        const y = await l(E);
        if (!Array.isArray(y) || y.length !== E.length) {
          B(d.ai.fileUploadError);
          return;
        }
        n(
          (V) => V.map((F) => {
            const L = b.findIndex(($) => $.id === F.id);
            return L === -1 ? F : y[L] ? {
              ...F,
              status: "uploaded",
              uploadedFile: y[L]
        ...
        const V = y instanceof Error && y.message ? y.message : d.ai.fileUploadError;
        B(V);
      }
    },
    [
    ...
    async (H) => {
      await w(Array.from(H.target.files ?? [])), H.target.value = "";
    },
    [w]
  ), x = W((H) => {
    n((E) => E.filter((b) => b.id !== H));
  }, []), S = W(() => {
    n([]);
  }, []);
  return {
...
function Z2({
  ...
  const [i, a] = P(!1), [d, l] = P(""), [u, f] = P([]), [g, m] = P(!1), [h, C] = P(0), [w, v] = P([]), x = I(-1), S = I(null), H = I(0), E = I(-1);
  Y(() => {
    if (!o) {
      a(!1);
      return;
    ...
    if (L.atIndex === E.current)
      return;
    x.current = L.atIndex, l(L.query), a(!0), C(0), m(!0), S.current && clearTimeout(S.current);
    const $ = ++H.current;
    return S.current = setTimeout(() => {
      o(L.query).then((Z) => {
        $ === H.current && (f(Z), C(0), Z.length === 0 && L.query.length > 0 && (E.current = L.atIndex, a(!1)));
      }).catch(() => {
        $ === H.current && f([]);
      }).finally(() => {
        $ === H.current && m(!1);
  ...
  const b = W(() => {
    ...
    (L) => {
      const $ = x.current;
      if ($ === -1) return;
      const Z = `${L.firstName} ${L.lastName}`.trim(), _ = String(L.id), G = e.slice(0, $), te = e.slice(n), X = `@${Z} `, U = G + X + te, q = G.length + X.length;
      t(U), v((D) => [...D.filter((O) => !(O.id === _ && O.name === Z)), { id: _, name: Z }]), b(), requestAnimationFrame(() => {
        const D = s.current;
        D && (D.focus(), D.setSelectionRange(q, q));
      });
    },
    [e, n, t, s, b]
  ), B = W(
    (L) => {
      if (!i) return !1;
      if (L.key === "Escape")
        return L.preventDefault(), b(), !0;
      if (u.length === 0) return !1;
      switch (L.key) {
        case "ArrowDown":
          return L.preventDefault(), C(($) => ($ + 1) % u.length), !0;
        case "ArrowUp":
        ...
        case "Tab": {
          const $ = u[h];
          if ($) {
            const Z = `${$.firstName} ${$.lastName}`.trim();
            if (d.length === 0 || Z.toLowerCase().startsWith(d.toLowerCase()))
              return L.preventDefault(), R($), !0;
          }
          return !1;
        }
        case "Enter":
          return L.preventDefault(), u[h] && R(u[h]), !0;
        default:
          return !1;
      }
    },
    ...
    (L) => {
      if (w.length === 0) return L;
      let $ = L;
      const Z = [...w].sort((_, G) => G.name.length - _.name.length);
      for (const _ of Z) {
        const G = `@${_.name}`, te = `<entity-ref type="person" id="${O1(_.id)}">${O1(_.name)}</entity-ref>`;
        for (; $.includes(G); )
          $ = $.replace(G, te);
      }
      return $;
  ...
  Y(() => {
    v(
      (L) => L.filter(($) => {
        const Z = `@${$.name}`, _ = e.indexOf(Z);
        if (_ === -1) return !1;
        const G = e[_ + Z.length];
        return G === " " || G === `
` || G === "	";
      })
    );
  ...
  const V = J(() => {
    ...
    const L = s.current;
    if (!L) return null;
    const $ = j2(L, x.current), Z = L.offsetLeft + $.left, G = (L.offsetParent ? L.offsetParent.offsetHeight : 0) - (L.offsetTop + $.top);
    return { left: Z, bottom: G };
  }, [i, e, n, s]), F = J(() => {
    if (!i || u.length === 0) return null;
    const L = u[h];
    if (!L) return null;
    const $ = `${L.firstName} ${L.lastName}`.trim();
...
const _2 = /[\\`*_{}[\]()#+\-.!|~>]/g, O2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(_2, "\\$&")).join(""), C9 = ({
  onSubmit: e,
  onStop: t,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  apiRef: R,
  onChange: B,
  showSubmitButton: y = !0
}) => {
  const V = Q(), F = Ee(), [L, $] = P(""), [Z, _] = P(0), [G, te] = P(!1), [X, U] = P(!1), [q, D] = P(null), ee = I(null), O = I(null), le = I(null), de = a != null, { tracking: re } = Re(), ne = W(
    (K, be) => {
      re?.onWelcomeSuggestionClick?.({
        item: K,
        group: be,
    ...
    const be = Ve.current, i1 = be && !/\s$/.test(be) ? " " : "", Ge = `${be}${i1}${K}`;
    $(Ge), _(Ge.length);
  }, []), t1 = {
    "permission-denied": V.ai.micPermissionDenied,
    "device-error": V.ai.micError,
    "transcription-failed": V.ai.transcriptionError
  }, xe = ys({
    onTranscribe: m,
    onPartial: De,
    onFinal: (K) => {
      De(K), O.current?.focus();
    },
    onError: (K) => Le(t1[K])
  }), r1 = !!m && xe.isSupported, n1 = W(() => {
    re?.onDictationStart?.(), Ve.current = L, xe.start();
  }, [L, xe, re]), o1 = W(() => {
    re?.onDictationCancel?.(), xe.cancel();
  }, [xe, re]);
  sn(R, () => ({
    setContent: (K) => {
      $(K), _(K.length);
    ...
    submit: () => ee.current?.requestSubmit(),
  ...
  const Ze = xe.status === "recording", _e = Ze ? V.ai.listening : V.ai.inputPlaceholder, s1 = oe.filter((K) => K.status === "uploaded"), Te = oe.some((K) => K.status === "uploading"), Oe = oe.some((K) => K.status === "error"), Ae = L.trim().length > 0;
  Y(() => {
    if (!(!X || Te)) {
      if (U(!1), Oe) {
        Le(V.ai.fileUploadBlockedSubmit);
        return;
      }
  ...
  const Ue = async (K) => {
    if (K.preventDefault(), !de) {
      if (ie.close(), n)
        ...
        const be = ie.transformMentions(L.trim()), i1 = O2(be), Ge = s1.flatMap(
    ...
    de || ie.handleKeyDown(K) || K.key === "Enter" && !K.shiftKey && (K.preventDefault(), n || ee.current?.requestSubmit());
  }, Qr = () => {
    _(O.current?.selectionStart ?? 0);
  }, Jr = () => {
    le.current && O.current && (le.current.scrollTop = O.current.scrollTop);
  }, S1 = q ? q.prompt ?? q.title : null, V1 = Ze ? [V.ai.listening] : S1 ? [S1] : s ?? [], en = V1.length > 1, tn = J(() => T2(L, ie.mentions, {
    cursorPosition: Z,
    inlineCompletion: ie.inlineCompletion
  }), [L, ie.mentions, Z, ie.inlineCompletion]), rn = ie.mentions.length > 0 || ie.inlineCompletion !== null, ze = x && !!H && H.length > 0 && !!E ? /* @__PURE__ */ r(
    V2,
    {
      suggestions: H,
      onItemClick: ne,
    ...
    se.div,
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ze && !S && /* @__PURE__ */ r("div", { children: ze }),
          /* @__PURE__ */ r(y2, { creditWarning: i, children: /* @__PURE__ */ c(
            se.form,
            {
              "aria-busy": n,
              ref: ee,
              className: k(
                ...
                de && "after:scale-100 after:opacity-100 border-f1-background-tertiary"
              ),
              animate: {
              ...
              children: [
                ...
                /* @__PURE__ */ r(Se, { initial: !1, children: de ? /* @__PURE__ */ r(
                  se.div,
                  {
                  ...
                  se.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ r(Se, { initial: !1, children: we && /* @__PURE__ */ r(
                        se.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ c(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ r("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ r(Es, { type: "critical", size: "sm" }) }),
                                /* @__PURE__ */ r("p", { className: "font-medium text-f1-foreground-critical", children: we })
                              ]
                            }
                          )
                        },
                      ...
                      /* @__PURE__ */ r(
                        F2,
                        {
                          ...
                          onCursorUpdate: Qr,
                          onScroll: Jr,
                          highlightSegments: tn,
                          hasOverlay: rn,
                          multiplePlaceholders: en,
                          placeholders: V1,
                          resolvedDefaultPlaceholder: _e,
                          inProgress: n
                        }
                      ),
                      /* @__PURE__ */ r(
        ...
        ze && S && /* @__PURE__ */ r("div", { className: "w-full max-w-content", children: ze }),
        v && x && S && /* @__PURE__ */ r("div", { className: "w-full py-4 mx-auto flex max-w-content justify-center", children: v }),
        /* @__PURE__ */ r(Se, { mode: "wait", initial: !1, children: de ? /* @__PURE__ */ c(
          se.div,
          {
          ...
          se.div,
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ r(ae, { className: "text-sm font-medium text-f1-foreground-tertiary", children: w.text }),
...
function He({
  ...
  const h = W(() => {
    ...
    u(!0), g(!1), n(e).then((v) => {
      i.current.set(e, v), m.current && d(v);
    }).catch(() => {
      m.current && g(!0);
    }).finally(() => {
      m.current && u(!1);
  ...
  return /* @__PURE__ */ c(
    Fs,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ns, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          Ss,
          {
            side: "top",
...
function l4({
  ...
  const { entityRefs: n } = Re(), o = n?.resolvers?.candidate, s = Q(), i = n?.urls?.candidate?.(e), a = J(
    () => (l) => {
      const u = [];
...
function d4({ id: e, label: t }) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.expense, s = Q(), i = n?.urls?.expense?.(e), a = J(
    () => (l) => ({
      avatar: {
        type: "icon",
        icon: rr
...
function f4({
  ...
  const { entityRefs: n } = Re(), o = n?.resolvers?.jobPosting, s = Q(), i = n?.urls?.jobPosting?.(e), a = J(
    () => (l) => ({
      title: l.title,
...
function h4({
  ...
  const { entityRefs: n } = Re(), o = n?.resolvers?.requisition, s = Q(), i = n?.urls?.requisition?.(e), a = J(
    () => (l) => {
...
function g4({ id: e, label: t }) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.person, s = Q(), i = n?.urls?.person?.(e), a = J(
    () => (l) => ({
      avatar: {
        type: "person",
        firstName: l.firstName,
...
function p4({ id: e, label: t }) {
  const { entityRefs: n } = Re(), o = n?.resolvers?.vacancy, s = Q(), i = n?.urls?.vacancy?.(e), a = J(
    () => (l) => ({
      title: l.name,
...
function Tr({
  ...
  const a = Q(), d = s.type === "open", l = d ? o ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ c(
    "div",
    {
      className: k(
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          e?.type === "module" && /* @__PURE__ */ r(Ot, { module: e.module, size: "md" }),
          e?.type === "file" && /* @__PURE__ */ r(Ts, { file: e.file, size: "lg" }),
          /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ r(ae, { className: "text-lg font-semibold text-f1-foreground", children: t }),
            n && /* @__PURE__ */ r(ae, { className: "text-base text-f1-foreground-secondary", children: n })
          ] }),
...
const U1 = 7, x4 = 625, z1 = /* @__PURE__ */ new Set();
function k4(e) {
...
function L4(e) {
  const { days: t, hours: n, minutes: o, seconds: s } = As(e), i = [];
...
function Hr(e, t) {
  ...
  if (t === "duration" && typeof e == "number")
    return { type: "item", text: L4(e) };
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const n = e.value;
    return { type: "item", text: (n ? k4(n) : "") || "—" };
  }
  ...
  return { type: "item", text: b4(String(e)) };
}
function Ar({
  formName: e,
  formDescription: t,
  ...
  const { canvasContent: l, openCanvas: u, closeCanvas: f } = Re(), g = w4(e), m = d ?? g, h = I(() => {
  }), C = o ?? e, w = s ?? t ?? "", v = l?.type === "form" && l.formName === e, x = () => u({
    type: "form",
    title: C,
    description: w,
    formName: e,
  ...
  h.current = x, Y(() => {
    typeof window > "u" || window.innerWidth < x4 || z1.has(e) || (z1.add(e), h.current());
  }, [e]);
  const S = i && a ? Object.entries(i).map(([b, R]) => {
    const B = a[b], y = m?.(b, B, {
      fieldType: R.fieldType,
      customFieldName: R.customFieldName
    });
    if (!y && R.fieldType === "custom" && typeof B == "object" && B !== null)
      return null;
    const V = y ?? Hr(B, R.fieldType), F = ["richtext", "textarea"];
    return {
      label: R.label,
      content: V,
      verticalLayout: F.includes(R.fieldType ?? "")
    };
  }).filter((b) => {
    if (!b) return !1;
    const R = Array.isArray(b.content) ? b.content[0] : b.content;
    return !(R?.type === "item" && R.text === "—");
  }) : [], H = S.slice(0, U1), E = S.length > U1;
  return /* @__PURE__ */ r(
    Tr,
    {
      ...
      children: H.length > 0 && !v && /* @__PURE__ */ r("div", { className: "-mx-3 flex w-full flex-col overflow-hidden pb-1", children: /* @__PURE__ */ r(
        Hs,
        {
          details: H.map((b) => ({
            title: b.label,
...
function $r({ anchor: e, onReply: t }) {
  ...
  if (Ct(() => {
    ...
    m < $e && (m = e.rect.bottom + X1), m = Math.min(
      Math.max(m, $e),
      g - u - $e
    );
...
const Ir = Qe(void 0), k9 = () => je(Ir), R4 = (e) => /* @__PURE__ */ r(Ut, { content: e, format: "markdown" }), F4 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const [s, i] = P(""), a = Q(), { title: d, label: l, placeholder: u } = n === "like" ? a.ai.feedbackModal.positive : a.ai.feedbackModal.negative, f = W(() => {
    t(o, s);
  }, [s, o, t]), g = () => {
    e(o);
  };
...
const T4 = ({
  ...
  const o = Q(), { open: s } = jr(), [i, a] = P(null);
  ...
  const [d, l] = P(s), u = Ee(), f = o !== void 0, g = f ? o : d;
  return /* @__PURE__ */ c(
    zt,
    {
...
const Dr = (e) => /* @__PURE__ */ r(Ut, { content: e, format: "markdown" }), I4 = ({
  text: e,
  renderMarkdown: t
}) => /* @__PURE__ */ c("div", { className: "flex max-w-[90%] items-start gap-2 self-end pb-1 pr-2 text-f1-foreground-tertiary", children: [
  /* @__PURE__ */ r("div", { className: "flex h-5 items-center", children: /* @__PURE__ */ r(ce, { icon: R1 }) }),
  ...
  const a = e.rawData, d = $4(
    e?.content,
    a
  ), l = (B4(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = l.length > 0, { anchor: g, clear: m } = Br({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ r(I4, { text: u, renderMarkdown: o }),
...
}, j4 = 35, D4 = 22, Z4 = 400, _4 = 2500, O4 = 220, U4 = ({
  messages: e,
  onClick: t,
  fullscreen: n = !1
}) => {
  ...
  Y(() => {
    ...
    let m;
    if (d === "starting")
      m = setTimeout(() => l("writing"), Z4);
    else if (d === "writing")
      i < u.length ? m = setTimeout(() => a((h) => h + 1), j4) : l("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      m = setTimeout(() => l("erasing"), _4);
    } else d === "erasing" && (i > 0 ? m = setTimeout(() => a((h) => h - 1), D4) : m = setTimeout(() => {
...
function z4({
  ...
  Y(() => {
    ...
    return v.observe(C), v.observe(w), () => v.disconnect();
  }, [e, t]);
  const h = W(() => {
    const C = e.current;
    if (!C) return;
    const { scrollTop: w, scrollHeight: v, clientHeight: x } = C, S = v - w - x;
    u(S > x);
  }, [e]);
  return Y(() => {
    const C = e.current;
    ...
    s > f.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const C = e.current, w = o.current;
        if (!C || !w) return;
        const v = C.getBoundingClientRect(), x = w.getBoundingClientRect(), S = C.scrollTop + (x.top - v.top);
        C.scrollTo({ top: S, behavior: "smooth" });
      });
    }), s === 0 && u(!1), f.current = s;
...
const G4 = {
...
}, b9 = (e) => /* @__PURE__ */ r(S4, { children: /* @__PURE__ */ r(W4, { ...e }) }), W4 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: H, handleSubmit: E, handleClose: b } = V4(
    f ?? G4
  ), R = Q(), B = w ?? F4, y = v ?? P4, V = J(() => {
    const D = o ?? R.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((O) => typeof O == "string" && O.length > 0);
  }, [o, R.ai.defaultInitialMessage]), F = !t && e.length === 0 && V.length > 0, L = I(null), $ = I(null), Z = I(null), _ = I(null), G = I(null), { showScrollBtn: te, turnMinHeight: X, scrollToBottom: U } = z4({
    viewportRef: L,
    contentRef: $,
    endRef: Z,
    lastTurnRef: G,
    ...
    const O = ee === e.length - 1, le = {
      ...
      const fe = O && oe === D.assistantMessages.length - 1, M = D.userMessages.length + oe, T = {
        message: ne,
        inProgress: D.isInProgress,
        index: M,
        isCurrentMessage: fe,
      ...
      return /* @__PURE__ */ r(
        ...
        {
          ...T,
          isGenerating: D.isInProgress && fe,
          isLoading: D.isInProgress && fe && !ne.content
        },
        `${ee}-a-${oe}`
      );
    };
    return /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          D.endIndicator === "thinking" && /* @__PURE__ */ r(u1, { title: R.ai.thinking, status: "executing" }),
          ...
          children: /* @__PURE__ */ c(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r(Se, { children: te && /* @__PURE__ */ r(
                  se.div,
                  {
...
}, q4 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
...
const Y4 = ({
  ...
  const m = Q().ai.clarifyingQuestion.typeYourAnswer, h = e === "single" ? /* @__PURE__ */ r(_r, { isSelected: n && !t }) : /* @__PURE__ */ r(
    qt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const Q4 = ({
  ...
  const x = Ee(), S = (() => {
    ...
    const B = n.findIndex((y) => o.includes(y.id));
    return B >= 0 ? B : 0;
  })(), [H, E] = P(S), b = I([]);
  Y(() => {
  ...
  const R = (B) => {
    ...
    B.preventDefault(), E(V), b.current[V]?.focus();
  };
  return /* @__PURE__ */ c(
    "div",
    {
          ...
          se.div,
          {
            ...
            children: /* @__PURE__ */ r(
              Or,
              {
                ...
                option: B,
                isSelected: o.includes(B.id),
                mode: e,
                isTabStop: e === "single" ? y === H : void 0,
                onToggle: m,
                onKeyNavigate: R
              }
            )
  ...
  } = s, B = I(null), y = S ?? "single", V = a > 1, F = i === 0, L = i === a - 1, $ = V ? n.t("ai.clarifyingQuestion.stepOf", {
    current: String(i + 1),
    total: String(a)
  }) : void 0, Z = x.length > 0, _ = (b ?? "").trim().length > 0, G = Z || R && _ || H === !0, te = t === !0 && L, X = () => {
    te || l();
  }, U = () => {
    te || u();
  }, q = (re) => {
    const ne = y === "single" && x.includes(re);
    d(re), y === "single" && !L && !ne && Promise.resolve().then(l);
  }, D = L ? n.ai.clarifyingQuestion.submit : n.ai.clarifyingQuestion.next, ee = H === !0 && !Z && !(R && _), O = () => {
    C(), requestAnimationFrame(() => {
      B.current?.focus();
    });
  }, le = (re) => {
    re.key === "Escape" && (re.preventDefault(), f());
  }, de = o ? 0 : t6 / 2;
  return /* @__PURE__ */ c("div", { className: "flex flex-col", onKeyDown: le, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(Se, { mode: "wait", initial: !1, children: /* @__PURE__ */ c(
      se.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: de, ease: e6 },
        children: [
          /* @__PURE__ */ r(
            J4,
            {
...
function K1(e, t, n, o) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(n, 20), d = Math.min(i + o, s), l = Math.min(d, Math.floor(e / 2)), u = Math.min(d, Math.floor(t / 2)), f = (O) => O / e * 2 - 1, g = (O) => O / t * 2 - 1, m = 0, h = e, C = 0, w = t, v = l, x = e - l, S = u, H = t - u, E = f(m), b = f(h), R = g(C), B = g(w), y = f(v), V = f(x), F = g(S), L = g(H), $ = 0, Z = 0, _ = 1, G = 1, te = l / e, X = 1 - l / e, U = u / t, q = 1 - u / t, D = new Float32Array([
    // Top strip
    E,
    R,
    b,
...
class F9 {
  ...
  resize(t, n, o) {
    ...
    s.enableVertexAttribArray(w), s.vertexAttribPointer(w, 2, s.FLOAT, !1, 0, 0), this.checkGLError(s, "resize: after position buffer update"), s.bindBuffer(s.ARRAY_BUFFER, l), s.bufferData(s.ARRAY_BUFFER, C, s.STATIC_DRAW);
  ...
  setupGL() {
    ...
    const m = t.getUniformLocation(n, "uResolution"), h = t.getUniformLocation(n, "uTime"), C = t.getUniformLocation(n, "uBorderWidth"), w = t.getUniformLocation(n, "uGlowWidth"), v = t.getUniformLocation(n, "uBorderRadius"), x = t.getUniformLocation(n, "uColors"), S = t.getUniformLocation(n, "uGlowExponent"), H = t.getUniformLocation(n, "uGlowFactor");
    t.useProgram(n), t.uniform1f(C, this.options.borderWidth), t.uniform1f(w, this.options.glowWidth), t.uniform1f(v, this.options.borderRadius), this.options.mode === "dark" ? (t.uniform1f(S, 2), t.uniform1f(H, 1.8)) : (t.uniform1f(S, 1), t.uniform1f(H, 1));
    const E = (this.options.colors || i6).map(a6);
...
const J1 = ["lowp", "mediump", "highp"], c6 = `
void main(void){
...
}`, tt = "iTime", rt = "iTimeDelta", nt = "iDate", ot = "iFrame", st = "iMouse", it = "iResolution", d6 = "iChannel", at = "iChannelResolution", ct = "iDeviceOrientation";
function f6(e, t) {
...
}, d1 = 9729, lt = 9728, m6 = 9987, dt = 33071, ft = 10497;
class C6 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const g = 0, m = n.RGBA, h = 1, C = 1, w = 0, v = n.RGBA, x = n.UNSIGNED_BYTE, S = new Uint8Array([255, 255, 255, 0]), H = n.createTexture();
    if (n.bindTexture(n.TEXTURE_2D, H), n.texImage2D(
      ...
      const B = this.setupVideo(o);
      return n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_S, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_T, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.LINEAR), this._webglTexture = H, this.source = B, this.isVideo = !0, B.play().then(() => this);
    }
    async function E() {
      return new Promise((B, y) => {
        ...
        V.crossOrigin = "anonymous", V.onload = () => {
          ...
          y(new Error(ye(`failed loading url: ${o}`)));
        }, V.src = o ?? "";
      });
    }
    let b = await E(), R = (b.width & b.width - 1) === 0 && (b.height & b.height - 1) === 0;
    return (t.wrapS !== dt || t.wrapT !== dt || t.minFilter !== lt && t.minFilter !== d1) && !R && (b = this.makePowerOf2(b), R = !0), n.bindTexture(n.TEXTURE_2D, H), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, l), n.texImage2D(
      n.TEXTURE_2D,
      g,
      m,
      v,
      x,
      b
    ), R && t.minFilter !== lt && t.minFilter !== d1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || ft
    ), n.texParameteri(
...
const ye = (e) => `react-shaders: ${e}`, ut = (e) => {
  if ("changedTouches" in e) {
    const t = e.changedTouches[0];
    return [t?.clientX ?? 0, t?.clientY ?? 0];
  }
  return [e.clientX, e.clientY];
}, ht = (e, t, n) => e * (1 - n) + t * n, v6 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function w6({
  fs: e,
  vs: t = et,
  textures: n = [],
  ...
  const h = I(null), C = I(null), w = I(null), v = I(null), x = I(void 0), S = I(void 0), H = I(!1), E = I(void 0), b = I(0), R = I([0, 0]), B = I([]), y = I(0), V = I(void 0), F = I({
    ...
    const N = "width" in M ? M.width ?? 0 : 0, j = "height" in M ? M.height ?? 0 : 0, A = F.current.iChannelResolution;
    if (!A) return;
    const z = Array.isArray(A.value) ? A.value : A.value = [];
    z[T * 3] = N * u, z[T * 3 + 1] = j * u, z[T * 3 + 2] = 0;
  }, Z = () => {
    ...
    const M = C.current;
    w.current = M?.createBuffer() ?? null, M?.bindBuffer(M.ARRAY_BUFFER, w.current);
    const T = [
      1,
      1,
      0,
    ...
    M?.bufferData(M.ARRAY_BUFFER, new Float32Array(T), M.STATIC_DRAW);
  }, G = ({
    alpha: M,
    beta: T,
    gamma: N
    ...
    const [T = 0, N = 0] = ut(M), j = T - (E.current?.left ?? 0) - window.pageXOffset, A = (E.current?.height ?? 0) - N - (E.current?.top ?? 0) - window.pageYOffset;
    H.current = !0;
    const z = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
    z && (z[2] = j, z[3] = A), R.current[0] = j, R.current[1] = A;
  }, X = (M) => {
    E.current = h.current?.getBoundingClientRect();
    const [T = 0, N = 0] = ut(M), j = T - (E.current?.left ?? 0), A = (E.current?.height ?? 0) - N - (E.current?.top ?? 0);
    if (l !== 1)
      R.current[0] = j, R.current[1] = A;
    else {
      const z = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
      z && (z[0] = j, z[1] = A);
    }
  }, U = () => {
    const M = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
    M && (M[2] = 0, M[3] = 0);
  }, q = () => {
    const M = C.current;
    if (!M) return;
    E.current = h.current?.getBoundingClientRect();
    const T = u, N = Math.floor(
      (E.current?.width ?? 1) * T
    ), j = Math.floor(
      (E.current?.height ?? 1) * T
    );
    if (M.canvas.width = N, M.canvas.height = j, F.current.iResolution?.isNeeded && v.current) {
      const A = M.getUniformLocation(
        v.current,
        it
      );
      M.uniform2fv(A, [M.canvas.width, M.canvas.height]);
    }
  }, D = (M, T) => {
    const N = C.current;
    if (!N) return null;
    ...
    if (!j) return null;
    if (N.shaderSource(j, T), N.compileShader(j), !N.getShaderParameter(j, N.COMPILE_STATUS)) {
      m?.(ye(`Error compiling the shader:
${T}`));
      const A = N.getShaderInfoLog(j);
      N.deleteShader(j), g?.(ye(`Shader compiler log: ${A}`));
    }
    return j;
  }, ee = (M, T) => {
    const N = C.current;
    if (!N) return;
    const j = D(N.FRAGMENT_SHADER, M), A = D(N.VERTEX_SHADER, T);
    if (v.current = N.createProgram(), !(!v.current || !A || !j)) {
      if (N.attachShader(v.current, A), N.attachShader(v.current, j), N.linkProgram(v.current), !N.getProgramParameter(v.current, N.LINK_STATUS)) {
        g?.(
          ye(
      ...
      N.useProgram(v.current), x.current = N.getAttribLocation(
        v.current,
        "aVertexPosition"
      ), N.enableVertexAttribArray(x.current);
    }
  }, O = () => {
    if (o)
      for (const M of Object.keys(o)) {
        const T = o[M];
        if (!T) continue;
        const { value: N, type: j } = T, A = p6(j);
        if (!A) continue;
        const z = {};
        if (f6(j, N)) {
          const ue = j.length, Ce = Number.parseInt(j.charAt(ue - 3)), we = Math.floor(N.length / (Ce * Ce));
          N.length > Ce * Ce && (z.arraySize = `[${we}]`);
        } else u6(j, N) && (z.arraySize = `[${Math.floor(N.length / Number.parseInt(j.charAt(0)))}]`);
        F.current[M] = {
          type: A,
          isNeeded: !1,
          value: N,
      ...
      if (n && n.length > 0) {
        ...
        const T = n.map(
          (N, j) => (F.current[`${d6}${j}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, $(N, j), B.current[j] = new C6(M), B.current[j]?.load(N).then((A) => {
            $(A, j);
          }))
        );
        Promise.all(T).then(() => {
    ...
    const T = J1.includes(i ?? "highp"), N = `precision ${T ? i : J1[1]} float;
`;
    T || m?.(
      ye(
...
`).concat(M.replace(/texture\(/g, "texture2D("));
    for (const z of Object.keys(F.current))
      if (M.includes(z)) {
        const ue = F.current[z];
        if (!ue) continue;
        j = v6(
          j,
          `uniform ${ue.type} ${z}${ue.arraySize || ""}; 
`,
          j.lastIndexOf(N) + N.length
        ), ue.isNeeded = !0;
      }
    return M.includes("mainImage") && (j = j.concat(c6)), j;
  }, re = (M) => {
    const T = C.current;
    if (!T || !v.current) return;
    const N = y.current ? (M - y.current) / 1e3 : 0;
    y.current = M;
    const j = L.current;
    if (j)
      for (const A of Object.keys(j)) {
        const z = j[A];
        if (z && F.current[A]?.isNeeded) {
          if (!v.current) return;
          const ue = T.getUniformLocation(
            v.current,
            A
          );
          if (!ue) return;
    ...
    if (F.current.iMouse?.isNeeded) {
      const A = T.getUniformLocation(
        v.current,
        st
      );
      T.uniform4fv(A, F.current.iMouse.value);
    }
    ...
    if (F.current.iDate?.isNeeded) {
      const A = /* @__PURE__ */ new Date(), z = A.getMonth() + 1, ue = A.getDate(), Ce = A.getFullYear(), we = A.getHours() * 60 * 60 + A.getMinutes() * 60 + A.getSeconds() + A.getMilliseconds() * 1e-3, Le = T.getUniformLocation(
        v.current,
        nt
      );
      T.uniform4fv(Le, [Ce, z, ue, we]);
    }
    if (F.current.iFrame?.isNeeded) {
      ...
      T.uniform1i(A, z), F.current.iFrame.value = z + 1;
    }
    if (B.current.length > 0)
      for (let A = 0; A < B.current.length; A++) {
        const z = B.current[A];
        if (!z) return;
        const { isVideo: ue, _webglTexture: Ce, source: we, flipY: Le, isLoaded: ie } = z;
        if (!ie || !Ce || !we) return;
        if (F.current[`iChannel${A}`]?.isNeeded) {
          if (!v.current) return;
          const Ve = T.getUniformLocation(
            v.current,
            `iChannel${A}`
          );
          T.activeTexture(T.TEXTURE0 + A), T.bindTexture(T.TEXTURE_2D, Ce), T.uniform1i(Ve, A), ue && z.updateTexture(
            Ce,
            we,
            Le
          );
    ...
    const T = C.current;
    if (!T) return;
    T.viewport(0, 0, T.drawingBufferWidth, T.drawingBufferHeight), T.clear(T.COLOR_BUFFER_BIT | T.DEPTH_BUFFER_BIT), T.bindBuffer(T.ARRAY_BUFFER, w.current), T.vertexAttribPointer(
      x.current ?? 0,
      3,
      T.FLOAT,
      !1,
      0,
      0
    ), re(M), T.drawArrays(T.TRIANGLE_STRIP, 0, 4);
    const N = F.current.iMouse?.value;
    if (F.current.iMouse?.isNeeded && l !== 1 && Array.isArray(N)) {
      const j = N[0] ?? 0, A = N[1] ?? 0;
      N[0] = ht(j, R.current[0] ?? 0, l), N[1] = ht(A, R.current[1] ?? 0, l);
    }
    S.current = requestAnimationFrame(ne);
  }, oe = () => {
    const M = { passive: !0 };
    F.current.iMouse?.isNeeded && h.current && (h.current.addEventListener("mousemove", X, M), h.current.addEventListener("mouseout", U, M), h.current.addEventListener("mouseup", U, M), h.current.addEventListener("mousedown", te, M), h.current.addEventListener("touchmove", X, M), h.current.addEventListener("touchend", U, M), h.current.addEventListener("touchstart", te, M)), F.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      G,
      M
    ), h.current && (V.current = new ResizeObserver(q), V.current.observe(h.current), window.addEventListener("resize", q, M));
  }, fe = () => {
    const M = { passive: !0 };
    F.current.iMouse?.isNeeded && h.current && (h.current.removeEventListener("mousemove", X, M), h.current.removeEventListener("mouseout", U, M), h.current.removeEventListener("mouseup", U, M), h.current.removeEventListener("mousedown", te, M), h.current.removeEventListener("touchmove", X, M), h.current.removeEventListener("touchend", U, M), h.current.removeEventListener("touchstart", te, M)), F.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      G,
      M
    ), V.current && (V.current.disconnect(), window.removeEventListener("resize", q, M));
  };
  return Y(() => {
    L.current = o;
  }, [o]), Y(() => {
    ...
    function T() {
      Z();
      const N = C.current;
      N && h.current && (N.clearColor(...s), N.clearDepth(1), N.enable(N.DEPTH_TEST), N.depthFunc(N.LEQUAL), N.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, O(), le(), ee(de(e || l6), t || et), _(), requestAnimationFrame(ne), oe(), q());
    }
    return requestAnimationFrame(T), () => {
      const N = C.current;
      if (N) {
        if (N.getExtension("WEBGL_lose_context")?.loseContext(), N.useProgram(null), N.deleteProgram(v.current ?? null), M.length > 0)
          for (const j of M)
            N.deleteTexture(j._webglTexture);
        v.current = null;
      }
      fe(), cancelAnimationFrame(S.current ?? 0);
    };
  }, []), /* @__PURE__ */ r(
    "canvas",
    {
...
}`, k6 = 10, b6 = 2, L6 = 0.5, y6 = 0.2, M6 = 1.5, ve = {
  duration: 0.5,
  ease: "easeOut"
}, gt = {
  duration: 0.35,
...
function E6(e, t) {
  const [n, o] = P(k6), {
    ...
    animate: i,
    motionValue: a
  } = We(y6), { value: d, animate: l } = We(b6), { value: u, animate: f } = We(L6), { value: g, animate: m } = We(M6), h = ti(t, {
    fftSize: 512,
...
function N9({
  ...
  const { speed: u, scale: f, amplitude: g, frequency: m, brightness: h } = E6(t, s);
  return /* @__PURE__ */ r(
    Ur,
    {
      ref: d,
...
const S9 = ({
  ...
  const o = Q(), s = Ee();
  return /* @__PURE__ */ c(ke, { children: [
    e && /* @__PURE__ */ r("span", { className: k(S6(), "truncate"), children: e }),
    /* @__PURE__ */ r(Se, { children: n && t && /* @__PURE__ */ r(
      se.div,
      {
      ...
      se.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ c("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ r("span", { className: k(qe()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ r(
            Ds,
            {
          ...
          o === "alert" && /* @__PURE__ */ r(_s, { text: e.alertLabel, level: e.level }),
          o === "balance" && /* @__PURE__ */ r(H6, { balance: e.balance })
        ]
      }
    ),
    n && !T6.has(o) && /* @__PURE__ */ r(
      se.span,
      {
        className: k(qe()),
        animate: { opacity: s ? 0 : 1 },
...
const $6 = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), I6 = ({
  label: e,
  direction: t
}) => {
  const n = Gr[t];
  ...
  const s = `sparkline-gradient-${vt().replace(/:/g, "")}`, i = B6(e, n), a = Gr[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Us, { width: "100%", height: "100%", children: /* @__PURE__ */ c(
          zs,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ r(Gs, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                Ws,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ r(I6, { label: t, direction: i })
      ]
    }
  ) });
}, Wr = p(
  (e, t) => {
    const {
      ...
      className: l,
      ...u
    } = e, [f, g] = P(!1), [m, h] = P(!1), C = f || m, w = Ee(), v = C && !!d, x = {
      duration: w ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, S = () => {
      a?.();
...
const j6 = ["className"], qr = p((e, t) => {
  const n = j6.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
...
const D6 = () => /* @__PURE__ */ c(
  ...
  "balance",
  "sparkline"
], Xr = 180, Z6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Xr, _6 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, O6 = (e) => e.showActions !== !1, U6 = (e) => Object.fromEntries(
...
function z6(e) {
  ...
  } = e, [l, u] = P(!1), f = vt(), g = I(null), m = Z6(
    d
  ), h = i.length > m, C = l ? i : _6(i, m), w = O6(e) ? e : null, v = U6(e);
  return Y(() => {
    l && g.current?.focus();
  }, [l]), /* @__PURE__ */ c(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex items-center gap-3 px-4 py-3", children: [
          t && /* @__PURE__ */ r(Ot, { module: t, size: "md" }),
...
}, W6 = (e) => Bl[e] ?? Ft, q6 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(ce, { icon: W6(e), size: "md", color: "default" }) }) : null;
function X6({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(G6, { icon: w1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(q6, { iconName: s.icon });
...
X6.displayName = "F0AiMessageSources";
async function Y6(e, t, n) {
  const o = await import("./xlsx-Bedf3nwD.js"), s = o.utils.table_to_book(e, { sheet: "Data" });
  o.writeFile(s, `${n}.${t}`);
}
function K6({
  ...
  const o = Q(), s = I(null), i = t ?? o.ai.aiTable.title, a = W(
    (d) => {
      if (!s.current) return;
              ...
              /* @__PURE__ */ r("tbody", { children: e.rows.map((d, l) => /* @__PURE__ */ r("tr", { children: e.columns.map((u) => {
                ...
                return /* @__PURE__ */ r(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ r(ae, { children: f == null ? "" : String(f) })
                  },
                  u
                );
              }) }, l)) })
...
K6.displayName = "F0AiTableCard";
function Q6({ credits: e }) {
  const t = Q(), [n, o] = P(!1), [s, i] = P(!1), [a, d] = P(!1), [l, u] = P(null), f = W(
    (h) => {
        ...
        children: [
          m && /* @__PURE__ */ c("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            ...
            /* @__PURE__ */ c("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ r(ae, { tag: "span", className: "font-medium", children: e.companyName ?? "" }),
...
const J6 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function e9({
  employeeCredits: e
}) {
  const t = Q(), n = Ee(), [o, s] = P(!1), [i, a] = P(!1), [d, l] = P(!1), [u, f] = P(null), g = W(
    (w) => {
      s(w), w && e?.fetchUsage && (a(!0), l(!1), e.fetchUsage().then((v) => {
        f(v), l(!1);
      }).catch(() => {
        l(!0);
      }).finally(() => {
...
const pt = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(e9, { employeeCredits: t }) : e ? /* @__PURE__ */ r(Q6, { credits: e }) : null, H9 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const m = Q(), h = $t(`(max-width: ${qs.md}px)`, {
        ...
        /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ r(
          Pe,
          {
            ...
            children: /* @__PURE__ */ c("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ r(ae, { lines: 1, className: "min-w-0 text-left", children: n ?? m.ai.newConversation }),
              /* @__PURE__ */ r(ce, { icon: v1, color: "default", size: "md" })
            ] })
          }
        ) }),
        /* @__PURE__ */ c(
...
function t9() {
  if (!(typeof navigator > "u"))
    return Ks(navigator.language);
}
function r9(e) {
  const t = new Date(e), n = /* @__PURE__ */ new Date();
  return Xt(t) ? "today" : Yt(t) ? "yesterday" : Xs(t, n) ? "thisMonth" : "older";
}
function n9(e, t) {
  const n = new Date(e), o = t9(), s = I1(n, "p", { locale: o });
  if (Xt(n)) return `${t.today}, ${s}`;
  if (Yt(n)) return `${t.yesterday}, ${s}`;
  const i = !Ys(n, /* @__PURE__ */ new Date());
      ...
      children: [
        /* @__PURE__ */ c(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ r(ae, { lines: 1, className: "text-left font-medium", children: e.title }),
        ...
        /* @__PURE__ */ r(
          "div",
          {
            ...
            children: /* @__PURE__ */ r(e1, { items: d, children: /* @__PURE__ */ r(
              pe,
              {
                icon: Rt,
                variant: "ghost",
...
const A9 = ({
  ...
  const h = J(
    ...
    return o.filter((B) => B.title.toLowerCase().includes(R));
  }, [o, g]), w = J(
    () => C.filter((R) => a.has(R.id)),
    [C, a]
  ), v = J(
    () => C.filter((R) => !a.has(R.id)),
    [C, a]
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ c("div", { className: "flex flex-shrink-0 items-center gap-2 border-0 border-b border-solid border-f1-border-secondary py-2 pl-5 pr-3", children: [
                  /* @__PURE__ */ r(ce, { icon: w1, color: "secondary", size: "md" }),
                  /* @__PURE__ */ r(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ r(
                    Pe,
                    {
                      ...
                      children: /* @__PURE__ */ c("div", { className: "flex w-full items-center gap-2", children: [
                        /* @__PURE__ */ r(ce, { icon: E1, color: "default", size: "md" }),
                        /* @__PURE__ */ r(ae, { lines: 1, className: "text-left", children: f.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ r(i9, {}),
                  !s && i && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: i }),
                  !s && !i && !b && /* @__PURE__ */ r("p", { className: "py-8 text-center text-base text-f1-foreground-tertiary", children: f.ai.noPreviousChats }),
...
function B9({
  ...
  const [o, s] = P([]), [i, a] = P(!1), [d, l] = P(null), [u, f] = P(a9), g = W(async () => {
    a(!0), l(null);
    try {
      const w = await t();
      s(w);
  ...
  const m = W((w) => {
    f((v) => {
      const x = new Set(v);
      return x.add(w), f1(x), x;
    });
  }, []), h = W((w) => {
    f((v) => {
      const x = new Set(v);
      return x.delete(w), f1(x), x;
    });
  }, []), C = W(
    async (w) => {
      try {
        await n(w), s((v) => v.filter((x) => x.id !== w)), f((v) => {
          if (!v.has(w)) return v;
          const x = new Set(v);
          return x.delete(w), f1(x), x;
        });

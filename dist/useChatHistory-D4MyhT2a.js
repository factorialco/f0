...
function Zo(t, e) {
  return ls(t) ? t[ec(0, t.length, e)] : t;
}
function tc(t, e, r) {
...
const sc = "easeInOut", ac = 20;
function ic(t, { defaultTransition: e = {}, ...r } = {}, n, s) {
  ...
  for (let p = 0; p < t.length; p++) {
    ...
    const I = (T, v, C, x = 0, S = 0) => {
      const _ = cc(T), { delay: L = 0, times: b = fs(_), type: N = "keyframes", repeat: D, repeatType: Q, repeatDelay: J = 0, ...se } = v;
      let { ease: ne = e.ease || "easeOut", duration: X } = v;
      const E = typeof L == "function" ? L(x, S) : L, B = _.length, O = ms(N) ? N : s?.[N];
      if (B <= 2 && O) {
        let j = 100;
        if (B === 2 && uc(_)) {
          const ke = _[1] - _[0];
      ...
      const he = b.length - _.length;
      if (he > 0 && ps(b, he), _.length === 1 && _.unshift(null), D) {
        co(D < ac, "Repeat count too high, must be less than 20"), X = Ji(X, D);
        const j = [..._], te = [...b];
        ...
        for (let ke = 0; ke < D; ke++) {
          ...
          for (let R = 0; R < j.length; R++)
            b.push(te[R] + (ke + 1)), ne.push(R === 0 ? "linear" : Zo(le, R - 1));
        }
        nc(b, D);
      }
      const ve = Y + X;
      rc(C, _, ne, b, Y, ve), $ = Math.max(E + X, $), w = Math.max(ve, w);
    };
    if (io(y)) {
      const T = Kr(y, l);
      I(k, M, Qr("default", T));
  ...
  return l.forEach((p, g) => {
    for (const y in p) {
      ...
      for (let v = 0; v < k.length; v++) {
        ...
        M.push(x), $.push(vs(0, w, C)), I.push(S || "easeOut");
      }
      $[0] !== 0 && ($.unshift(0), M.unshift(M[0]), I.unshift(sc)), $[$.length - 1] !== 1 && ($.push(1), M.push(null)), i.has(g) || i.set(g, {
        keyframes: {},
        transition: {}
      });
      const T = i.get(g);
...
const dc = (t) => typeof t == "number", uc = (t) => t.every(dc);
function fc(t, e) {
  return t in e;
}
class hc extends Cs {
...
function Do(t, e, r, n) {
  ...
  if (gc(t, e))
    ...
    for (let l = 0; l < i; l++) {
      const c = a[l], d = c instanceof Element ? pc : mc;
      Dt.has(c) || d(c);
...
function vc(t, e, r) {
  const n = [];
  return ic(t, e, r, { spring: Es }).forEach(({ keyframes: a, transition: i }, l) => {
    n.push(...Do(l, a, i));
  }), n;
}
class Cc {
...
function kc(t) {
  function e(r, n, s) {
    let a = [];
    return xc(r) ? a = vc(r, n, t) : a = Do(r, n, s, t), new wc(a);
  }
  return e;
}
const yc = kc(), bc = (t, e) => /* @__PURE__ */ f(
  "svg",
  {
...
const t2 = (t, e) => /* @__PURE__ */ f(
...
), O2 = m(j2), Z2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Lc,
  Add: _s,
  Ai: Ss,
  ...
  Calculator: Bs,
  Calendar: Us,
  CalendarArrowDown: Xc,
  CalendarArrowLeft: Qc,
  CalendarArrowRight: el,
  CameraPlus: rl,
  CardPin: ol,
  ChartFunnel: al,
  ChartHorizontalBars: cl,
  ChartLine: dl,
  ChartPie: fl,
  ChartVerticalBars: pl,
  Check: fo,
  CheckCircle: zs,
  CheckCircleLine: gl,
  CheckDouble: Ws,
  ...
  Wifi: O2,
  Windows: ni
}, Symbol.toStringTag, { value: "Module" })), D2 = (t, e) => /* @__PURE__ */ o(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const iu = at({
  ...
  ({
    ...
    const $t = B && B !== "none" || O && O !== "none" || Y && Y !== "none" || he && he !== "none", rr = E && E !== "none" || $t, we = { sm: Qt, md: Jt, lg: er, xl: Ft }, Xe = cu.map((Ht) => {
      const It = we[Ht];
      return It ? au(Ht, It) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ o(
...
const nr = oi(
...
}, lu = (t) => Array.isArray(t), du = (t) => Array.isArray(t), tn = ({
  primaryAction: t,
  secondaryAction: e
}) => {
  const r = e, n = t;
  ...
  const l = me(), { onClose: c } = Eo(), d = !!s, u = () => /* @__PURE__ */ o("div", { className: "h-4 w-px self-center bg-f1-background-secondary" }), h = n?.filter(
  ...
  const [M, $] = q(null), I = ee((b) => {
    $(b);
  }, []), T = (b) => {
    b || r();
  }, v = uu(), C = e === "left" || e === "right", x = de(() => v && t ? "bottomSheet" : e === "fullscreen" ? "fullscreen" : C ? "sidePosition" : "center", [v, t, C, e]), S = de(() => (a && !["center", "left", "right"].includes(e) && console.warn(
...
}, u1 = (t) => /* @__PURE__ */ o(pu, { ...t });
u1.displayName = "F0Dialog";
const mu = So(
  wi("F0Dialog", u1)
), gu = ["days", "hours", "minutes", "seconds"], D3 = ["sm", "md"], f1 = [...gu], B3 = ["hours", "minutes"], Be = {
  days: 86400,
  hours: 3600,
  minutes: 60,
  seconds: 1
...
const ku = /^c[^\s-]{8,}$/i, yu = /^[0-9a-z]+$/, bu = /^[0-9A-HJKMNP-TV-Z]{26}$/i, Lu = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i, Mu = /^[a-z0-9_-]{21}$/i, Eu = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/, _u = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/, Su = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i, Ru = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let or;
const Nu = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, Tu = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/, Au = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/, Vu = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/, Fu = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/, Pu = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/, h1 = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))", $u = new RegExp(`^${h1}$`);
function p1(t) {
  let e = "[0-5]\\d";
...
function Zu(t, e) {
  return !!((e === "v4" || !e) && Tu.test(t) || (e === "v6" || !e) && Vu.test(t));
}
class et extends ce {
  _parse(e) {
    ...
    for (const a of this._def.checks)
      if (a.kind === "min")
        ...
        Su.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "email",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "emoji")
        or || (or = new RegExp(Ru, "u")), or.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "emoji",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "uuid")
        Lu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "uuid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "nanoid")
        Mu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "nanoid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "cuid")
        ku.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "cuid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "cuid2")
        yu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "cuid2",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
      else if (a.kind === "ulid")
        bu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
          validation: "ulid",
          code: A.invalid_string,
          message: a.message
        }), n.dirty());
        ...
        message: a.message
      }), n.dirty()) : a.kind === "datetime" ? Iu(a).test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
        code: A.invalid_string,
        validation: "datetime",
        message: a.message
      }), n.dirty()) : a.kind === "date" ? $u.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
        code: A.invalid_string,
        validation: "date",
        message: a.message
      }), n.dirty()) : a.kind === "time" ? Hu(a).test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
        code: A.invalid_string,
        validation: "time",
        message: a.message
      }), n.dirty()) : a.kind === "duration" ? _u.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
        validation: "duration",
        code: A.invalid_string,
        message: a.message
        ...
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "jwt" ? Ou(e.data, a.alg) || (s = this._getOrReturnCtx(e, s), Z(s, {
        validation: "jwt",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "cidr" ? Zu(e.data, a.version) || (s = this._getOrReturnCtx(e, s), Z(s, {
        validation: "cidr",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "base64" ? Fu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
        validation: "base64",
        code: A.invalid_string,
        message: a.message
      }), n.dirty()) : a.kind === "base64url" ? Pu.test(e.data) || (s = this._getOrReturnCtx(e, s), Z(s, {
...
class gt extends ce {
  ...
  _parse(e) {
    ...
    const s = new Fe();
    for (const a of this._def.checks)
      a.kind === "int" ? ue.isInteger(e.data) || (n = this._getOrReturnCtx(e, n), Z(n, {
        code: A.invalid_type,
        expected: "integer",
        received: "float",
        message: a.message
        ...
        exact: !1,
        message: a.message
      }), s.dirty()) : a.kind === "multipleOf" ? Du(e.data, a.value) !== 0 && (n = this._getOrReturnCtx(e, n), Z(n, {
...
class zt extends ce {
  _parse(e) {
    const { status: r, ctx: n } = this._processInputParams(e), s = (a, i) => {
      ...
      return l.valid ? ((sn(a) || sn(i)) && r.dirty(), { status: r.value, value: l.data }) : (Z(n, {
  ...
  _parse(e) {
    ...
    if (a.addIssue = a.addIssue.bind(a), s.type === "preprocess") {
      ...
      if (n.common.async)
        return Promise.resolve(i).then(async (l) => {
          ...
          return c.status === "aborted" ? re : c.status === "dirty" || r.value === "dirty" ? Mt(c.value) : c;
        });
      {
        if (r.value === "aborted")
          return re;
        ...
        return l.status === "aborted" ? re : l.status === "dirty" || r.value === "dirty" ? Mt(l.value) : l;
      }
    }
    if (s.type === "refinement") {
      ...
      if (n.common.async === !1) {
        ...
        return l.status === "aborted" ? re : (l.status === "dirty" && r.dirty(), i(l.value), { status: r.value, value: l.value });
      } else
        return this._def.schema._parseAsync({ data: n.data, path: n.path, parent: n }).then((l) => l.status === "aborted" ? re : (l.status === "dirty" && r.dirty(), i(l.value).then(() => ({ status: r.value, value: l.value }))));
    }
    if (s.type === "transform")
      if (n.common.async === !1) {
  ...
  _parse(e) {
    ...
    if (n.common.async)
      return (async () => {
        ...
        return a.status === "aborted" ? re : a.status === "dirty" ? (r.dirty(), Mt(a.value)) : this._def.out._parseAsync({
          data: a.value,
          path: n.path,
          parent: n
        });
...
const Ee = et.create, lt = gt.create, gn = Cr.create, Ke = Tt.create, G3 = wr.create, q3 = xr.create;
ot.create;
...
((t) => {
  function e({
    ...
    let _ = Ee();
    const L = !v && C === void 0 ? 1 : C;
    L !== void 0 && (_ = _.min(L)), x !== void 0 && (_ = _.max(x));
    const b = v ? _.optional() : _;
    return t(b, S);
  }
  t.text = e;
  function r({ optional: v, ...C }) {
    const x = v ? Ee().email().optional() : Ee().email();
    return t(x, C);
  }
  t.email = r;
  function n({ optional: v, ...C }) {
    const x = v ? Ee().optional() : Ee().min(1);
    return t(
      x,
  ...
  function s({
    ...
    let L = lt();
    S && (L = L.int()), C !== void 0 && (L = L.min(C)), x !== void 0 && (L = L.max(x));
    const b = v ? L.optional() : L;
    return t(b, _);
  }
  t.number = s;
  ...
  function c({ optional: v, ...C }) {
    const x = v ? Ee().url().optional() : Ee().url();
    return t(x, C);
  }
  t.url = c;
  ...
  function h(v) {
    ...
    const { optional: C, ...x } = v, S = x.options.map((L) => L.value), _ = C ? bt(S).optional() : bt(S);
    return t(
      _,
  ...
  function p({ optional: v, ...C }) {
    const x = v ? yt(Ee()).optional() : yt(Ee()).min(1);
    return t(
      x,
  ...
  t.dateRange = M;
  function $({ optional: v, ...C }) {
    const x = Er({
      value: Ee(),
      mentionIds: yt(Ee()).optional()
    }), S = v ? x.optional() : x;
    return t(
      S,
  ...
  function I(v) {
    ...
    if (_ && _.length > 0) {
      ...
      if (b.length > 0) {
        const N = x ? bt(b).optional() : bt(b);
        return t(N, S);
      }
    }
    const L = x ? Ee().optional() : Ee();
    return t(L, S);
  }
  t.select = I;
  function T(v) {
    ...
    const L = yt(Ee()).min(1), b = x ? L.optional() : L;
    return t(b, { ...S, multiple: !0 });
  }
  t.multiSelect = T;
})(Cn || (Cn = {}));
const Uu = /* @__PURE__ */ Symbol("Let zodToJsonSchema decide on which parser to use"), zu = {
  name: void 0,
  $refStrategy: "root",
  basePath: ["#"],
  ...
  const e = Wu(t), r = e.name !== void 0 ? [...e.basePath, e.definitionPath, e.name] : e.basePath;
  return {
    ...e,
...
function qu(t, e) {
  ...
  return t.type?._def && t.type?._def?.typeName !== V.ZodAny && (r.items = pe(t.type._def, {
    ...e,
...
const Ku = (t, e) => pe(t.innerType._def, e);
function k1(t, e, r) {
...
function e4(t, e) {
  return e.effectStrategy === "input" ? pe(t.schema._def, e) : Te(e);
}
function t4(t) {
  return {
    type: "string",
...
const r4 = (t) => "type" in t && t.type === "string" ? !1 : "allOf" in t;
function n4(t, e) {
  const r = [
    pe(t.left._def, {
      ...e,
...
function ar(t, e) {
  return e.patternStrategy === "escape" ? a4(t) : t;
}
const s4 = new Set("ABCDEFGHIJKLMNOPQRSTUVXYZabcdefghijklmnopqrstuvxyz0123456789");
function a4(t) {
  let e = "";
  for (let r = 0; r < t.length; r++)
    s4.has(t[r]) || (e += "\\"), e += t[r];
...
const L4 = (t, e) => pe(t.innerType._def, e), M4 = (t, e, r) => {
  switch (e) {
    case V.ZodString:
      return y1(t, r);
    case V.ZodNumber:
...
function pe(t, e, r = !1) {
  ...
  e.seen.set(t, s);
  const a = M4(t, t.typeName, e), i = typeof a == "function" ? pe(a(), e) : a;
  if (i && _4(t, e, i), e.postProcess) {
...
}, _4 = (t, e, r) => (t.description && (r.description = t.description, e.markdownDescription && (r.markdownDescription = t.description)), r), dt = (t, e) => {
  const r = Gu(e);
...
function Q3({
  ...
  const r = de(
    ...
    queueMicrotask(() => {
      const E = Array.from(n.current.entries()), B = [], O = [];
      let Y = null;
      for (const [ve, j] of E) {
        const te = j.ref.current;
        if (te && (j.virtual ? O.push({
          formName: ve,
          ...j.description ? { description: j.description } : {},
          ...j.module ? { module: j.module } : {},
          cardTitle: "",
          cardDescription: "",
          formSchema: dt(j.schema),
          fieldDescriptions: ir(j.schema),
          sectionDescriptions: cr(j.sections),
          formValues: te.getValues(),
          formErrors: te.getErrors(),
          isDirty: te.isDirty(),
          ...j.defaultValuesParamsSchema ? {
            defaultValuesParamsSchema: dt(
              j.defaultValuesParamsSchema
            )
          } : {},
          ...j.defaultValuesParams ? { defaultValuesParams: j.defaultValuesParams } : {}
        }) : B.push({
          formName: ve,
          ...j.description ? { description: j.description } : {},
          ...j.module ? { module: j.module } : {},
      ...
      he !== s.current && (s.current = he, u(B), w(O), g(Y));
    });
  }, []), $ = ee(
    (E, B, O, Y, he, ve, j, te) => {
      ...
      n.current.set(E, {
        ...
        module: te,
        sections: Y,
        defaultValuesParamsSchema: he ?? le?.defaultValuesParamsSchema,
        defaultValuesFn: ve ?? le?.defaultValuesFn,
    ...
    (E) => {
      ...
      if (B?.virtual) return;
      const O = B?.ref.current?.getValues() ?? {};
      n.current.delete(E);
      const Y = r?.find((he) => he.name === E);
      if (Y) {
        const ve = { ...typeof Y.defaultValues == "function" ? {} : bn(Y.defaultValues), ...O }, { ref: j, dirtyFields: te } = Ln(
          Y.schema,
          ve,
          Y.onSubmit
    ...
    (E, B) => {
      ...
      return O.virtual ? (y.current = E, k.current = {
  ...
  }, []), b = ee((E) => a.current.get(E) ?? 0, []), N = ee((E) => !i.current.has(E), []), D = ee((E) => {
    i.current.add(E);
  }, []), Q = ee(
    (E, B) => {
  ...
  fe(() => {
    ...
    for (const O of E) {
      ...
      const he = typeof O.defaultValues == "function" ? {} : bn(O.defaultValues), { ref: ve, dirtyFields: j } = Ln(
        O.schema,
        he,
        O.onSubmit
      ), te = typeof O.defaultValues == "function" ? (() => {
        const le = O.defaultValues;
        return async (ke) => {
          const R = le(ke);
    ...
    for (const O of ne.current)
      B.has(O) || n.current.get(O)?.virtual && n.current.delete(O);
  ...
  const X = de(
    () => ({
      ...
      queueFillAction: J,
      hasDefaultValuesEverResolved: se
    }),
    [
      $,
      I,
        ...
        return /* @__PURE__ */ f(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "flex min-w-0 flex-1 flex-col", children: /* @__PURE__ */ o(Me, { className: "text-base font-medium text-f1-foreground", children: p }) })
            ]
          },
          String(u.id)
        );
        ...
        a && /* @__PURE__ */ f(
          Pr,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "flex flex-col", children: O4(a.items).map((i, l) => /* @__PURE__ */ f(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
function W4(t) {
  const [e, r] = q([]), [n, s] = q(null), a = z(
    null
  ), i = z(null), l = me(), c = t?.onUploadFiles, d = t?.allowedMimeTypes, u = t?.maxFiles, h = de(() => {
    if (d)
  ...
  const y = ee(
    async (I) => {
      ...
      const x = (S) => r(
        (_) => _.map(
          (L) => C.includes(L.id) ? { ...L, status: "error", errorMessage: S } : L
        )
      );
      try {
        const S = await c(T);
        ...
        r(
          (_) => _.map((L) => {
            const b = v.findIndex((N) => N.id === L.id);
            return b === -1 ? L : S[b] ? {
              ...L,
              status: "uploaded",
              uploadedFile: S[b]
...
function K4({
  ...
  const [a, i] = q(!1), [l, c] = q(""), [d, u] = q([]), [h, w] = q(!1), [p, g] = q(0), [y, k] = q([]), M = z(-1), $ = z(null), I = z(0), T = z(-1);
  fe(() => {
    if (!n) {
      i(!1);
      return;
    ...
    if (b.atIndex === T.current)
      return;
    M.current = b.atIndex, c(b.query), i(!0), g(0), w(!0), $.current && clearTimeout($.current);
    const N = ++I.current;
    return $.current = setTimeout(() => {
      n(b.query).then((D) => {
        N === I.current && (u(D), g(0), D.length === 0 && b.query.length > 0 && (T.current = b.atIndex, i(!1)));
      }).catch(() => {
        N === I.current && u([]);
      }).finally(() => {
        N === I.current && w(!1);
  ...
  const v = ee(() => {
    ...
    (b) => {
      const N = M.current;
      if (N === -1) return;
      const D = `${b.firstName} ${b.lastName}`.trim(), Q = String(b.id), J = t.slice(0, N), se = t.slice(r), ne = `@${D} `, X = J + ne + se, E = J.length + ne.length;
    ...
    (b) => {
      if (!a) return !1;
      if (b.key === "Escape")
        return b.preventDefault(), v(), !0;
      if (d.length === 0) return !1;
      switch (b.key) {
        case "ArrowDown":
          return b.preventDefault(), g((N) => (N + 1) % d.length), !0;
        case "ArrowUp":
          return b.preventDefault(), g(
        ...
        case "Tab": {
          ...
          if (N) {
            ...
            if (l.length === 0 || D.toLowerCase().startsWith(l.toLowerCase()))
              return b.preventDefault(), C(N), !0;
          }
          return !1;
        }
        case "Enter":
          return b.preventDefault(), d[p] && C(d[p]), !0;
        default:
          return !1;
      }
    },
    ...
    (b) => {
      if (y.length === 0) return b;
      let N = b;
      const D = [...y].sort((Q, J) => J.name.length - Q.name.length);
      for (const Q of D) {
        const J = `@${Q.name}`, se = `<entity-ref type="person" id="${Mn(Q.id)}">${Mn(Q.name)}</entity-ref>`;
        for (; N.includes(J); )
          N = N.replace(J, se);
      }
      return N;
...
` || J === "	";
  ...
  const _ = de(() => {
    ...
    const b = s.current;
    if (!b) return null;
    const N = Y4(b, M.current), D = b.offsetLeft + N.left, J = (b.offsetParent ? b.offsetParent.offsetHeight : 0) - (b.offsetTop + N.top);
...
const Q4 = /[\\`*_{}[\]()#+\-.!|~>]/g, J4 = (t) => t.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((e, r) => r % 2 === 1 ? e : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(Q4, "\\$&")).join(""), J3 = ({
  onSubmit: t,
  onStop: e,
  inProgress: r,
  onBeforeSubmit: n,
  ...
  const v = me(), C = De(), [x, S] = q(""), [_, L] = q(0), [b, N] = q(!1), [D, Q] = q(!1), [J, se] = q(null), ne = z(null), X = z(null), E = z(null), B = i != null, { tracking: O } = Ge(), Y = ee(
    (we, Xe) => {
      O?.onWelcomeSuggestionClick?.({
        item: we,
        group: Xe,
  ...
  const be = v.ai.inputPlaceholder, Re = he.filter((we) => we.status === "uploaded"), Ae = he.some((we) => we.status === "uploading"), qe = he.some((we) => we.status === "error"), Ye = x.trim().length > 0;
  fe(() => {
    if (!(!D || Ae)) {
      if (Q(!1), qe) {
  ...
  const it = async (we) => {
    if (we.preventDefault(), !B) {
      if (ie.close(), r)
        ...
        const Xe = ie.transformMentions(x.trim()), Ht = J4(Xe), It = Re.flatMap(
    ...
    L(X.current?.selectionStart ?? 0);
  }, er = () => {
    E.current && X.current && (E.current.scrollTop = X.current.scrollTop);
  }, Ft = J ? J.prompt ?? J.title : null, Pt = Ft ? [Ft] : s ?? [], tr = Pt.length > 1, $t = de(() => D4(x, ie.mentions, {
    cursorPosition: _,
  ...
  return /* @__PURE__ */ f("div", { ref: T, className: "flex flex-col items-center gap-2 px-4 pb-3 pt-2", children: [
    /* @__PURE__ */ f("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
      ...
      /* @__PURE__ */ o(F4, { creditWarning: a, children: /* @__PURE__ */ f(
        Ce.form,
        {
          "aria-busy": r,
          ref: ne,
    ...
    /* @__PURE__ */ o(Oe, { mode: "wait", initial: !1, children: B ? /* @__PURE__ */ f(
      ...
      Ce.div,
      {
        ...
        children: [
          ...
          ) : /* @__PURE__ */ o(Me, { className: "text-sm font-medium text-f1-foreground-tertiary", children: g.text }),
...
function w6({
  ...
  const { entityRefs: r } = Ge(), n = r?.resolvers?.candidate, s = me(), a = r?.urls?.candidate?.(t), i = de(
    () => (c) => {
      const d = [];
...
function x6({ id: t, label: e }) {
  const { entityRefs: r } = Ge(), n = r?.resolvers?.expense, s = me(), a = r?.urls?.expense?.(t), i = de(
    () => (c) => ({
      avatar: {
        type: "icon",
        icon: Uo
...
function k6({
  ...
  const { entityRefs: r } = Ge(), n = r?.resolvers?.jobPosting, s = me(), a = r?.urls?.jobPosting?.(t), i = de(
    () => (c) => ({
      title: c.title,
...
function b6({
  ...
  const { entityRefs: r } = Ge(), n = r?.resolvers?.requisition, s = me(), a = r?.urls?.requisition?.(t), i = de(
    () => (c) => {
...
function L6({ id: t, label: e }) {
  const { entityRefs: r } = Ge(), n = r?.resolvers?.person, s = me(), a = r?.urls?.person?.(t), i = de(
    () => (c) => ({
      avatar: {
        type: "person",
        firstName: c.firstName,
...
function M6({ id: t, label: e }) {
  const { entityRefs: r } = Ge(), n = r?.resolvers?.vacancy, s = me(), a = r?.urls?.vacancy?.(t), i = de(
    () => (c) => ({
      title: c.name,
...
const V1 = 60, F1 = 40, En = 2e3, V6 = 500, F6 = 12e3, P1 = 2, Et = 40, ut = [255, 60, 0], lr = [160, 140, 220], dr = { x: -12, y: 0, z: 0 }, ur = { x: -12, y: 12, z: 90 }, ht = {
  20: 0.72,
  28: 0.66,
  32: 0.72,
  60: 0.77,
  80: 0.8,
  120: 0.85
}, fr = Math.PI / 180, P6 = P1 / 8 * Math.PI, $6 = 4 * Math.PI;
function Yt(t, e) {
  return [
...
const Z6 = Object.keys(ht).map(Number).sort((t, e) => t - e);
function D6(t) {
  const e = Z6;
...
const Sn = Math.sqrt(V1 ** 2 + F1 ** 2), hr = [V1 / Sn, F1 / Sn, 0], B6 = $1(dr.x, dr.y, dr.z), U6 = $1(ur.x, ur.y, ur.z), pt = P1 * 3, Zt = Et + 1, Rn = (pt + 1) * Zt, Xt = 4 * pt * Et, pr = [
  [0, 0, 0, 0],
  [0, 0, 0, 0]
], z6 = (t, e) => t.avgZ - e.avgZ;
function W6() {
...
function Nn(t, e, r, n) {
  const { quads: s, grid: a } = t, i = r * 0.392, l = r / 2, c = r / 2, d = P6 * D6(r), u = e * $6, h = _t(0, 0, 1, n * 2 * Math.PI);
  _n(h, hr[0], hr[1], hr[2], Qe);
  const w = _t(Qe[0], Qe[1], Qe[2], u), p = Yt(w, B6), g = Yt(w, U6);
  pr[0] = p, pr[1] = g;
  let y = 0;
  for (let k = 0; k < 4; k++) {
    const M = pr[k >> 1], $ = k & 1 ? -1 : 1;
    for (let I = 0; I <= pt; I++) {
      const T = $ * (Math.PI / 2 - I / pt * d), v = Math.cos(T), C = Math.sin(T), x = Math.sin(I / pt * Math.PI), S = I * Zt;
      for (let _ = 0; _ <= Et; _++) {
        const L = _ / Et * Math.PI * 2;
        _n(M, v * Math.cos(L), C, v * Math.sin(L), Qe);
        const b = a[S + _];
        b.x = Qe[0], b.y = Qe[1], b.z = Qe[2], b.t = x;
      }
    }
    for (let I = 0; I < pt; I++) {
      const T = I * Zt, v = (I + 1) * Zt;
      for (let C = 0; C < Et; C++) {
        const x = a[T + C], S = a[T + C + 1], _ = a[v + C], L = a[v + C + 1];
        if ((x.t + S.t + _.t + L.t) * 0.25 < 1e-3) continue;
        const N = (x.x + S.x + _.x + L.x) * 0.25, D = (x.y + S.y + _.y + L.y) * 0.25, Q = (x.z + S.z + _.z + L.z) * 0.25, J = N * i, se = D * i, ne = x.x * i - J, X = x.y * i - se, E = Math.sqrt(ne * ne + X * X), B = E > 0 ? (E + 0.9) / E : 1, O = l + J + ne * B, Y = c - se - X * B, he = S.x * i - J, ve = S.y * i - se, j = Math.sqrt(he * he + ve * ve), te = j > 0 ? (j + 0.9) / j : 1, le = l + J + he * te, ke = c - se - ve * te, R = L.x * i - J, H = L.y * i - se, P = Math.sqrt(R * R + H * H), K = P > 0 ? (P + 0.9) / P : 1, U = l + J + R * K, oe = c - se - H * K, ie = _.x * i - J, be = _.y * i - se, Re = Math.sqrt(ie * ie + be * be), Ae = Re > 0 ? (Re + 0.9) / Re : 1, qe = l + J + ie * Ae, Ye = c - se - be * Ae, it = s[y];
        it.points = `${O},${Y} ${le},${ke} ${U},${oe} ${qe},${Ye}`, it.color = O6((N + 1) * 0.5), it.avgZ = Q, y++;
      }
    }
  }
  for (let k = y; k < Xt; k++)
...
const G6 = ({ size: t = 20, className: e, style: r, variant: n = "default" }, s) => {
  const a = z(null), i = z(null), l = z(null);
  l.current === null && (l.current = W6());
  ...
  return fe(() => {
    ...
    let g = null, y = 0, k = 0, M = 0, $ = null, I = "spin", T = !0, v = !1;
    const C = (b) => {
      const N = p.quads;
      ...
      let N = 0, D = !0;
      if (n === "continuous") {
        const ne = En * 2, X = (b - y) % ne / ne;
        N = X < 0.5 ? X * 2 : (1 - X) * 2, D = !1;
      } else I === "spin" ? (N = Math.min((b - y) / En, 1), N >= 1 && (N = 0, I = "pause", M = b)) : (N = 0, b - M >= V6 && (I = "spin", y = b));
      const Q = (b - k) / F6 % 1, J = D ? I6(N) : N, se = Nn(p, J, t, Q);
      C(se), g = requestAnimationFrame(x);
    }, S = () => {
...
function I1({
  ...
  const i = me(), l = s.type === "open", c = l ? n ? s.onClose : s.onOpen : void 0;
  return /* @__PURE__ */ f(
    "div",
    {
      className: F(
      ...
      children: [
        /* @__PURE__ */ f("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          t?.type === "module" && /* @__PURE__ */ o(To, { module: t.module, size: "lg" }),
          t?.type === "file" && /* @__PURE__ */ o(Ni, { file: t.file, size: "lg" }),
          /* @__PURE__ */ f("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ o(Me, { className: "text-lg font-semibold text-f1-foreground", children: e }),
            r && /* @__PURE__ */ o(Me, { className: "text-base text-f1-foreground-secondary", children: r })
          ] }),
...
const An = 7, Y6 = 625, Vn = /* @__PURE__ */ new Set();
function X6(t) {
...
function Q6(t) {
  const { days: e, hours: r, minutes: n, seconds: s } = vu(t), a = [];
...
function j1(t, e) {
  ...
  if (e === "duration" && typeof t == "number")
    return { type: "item", text: Q6(t) };
  if (e === "richtext" && typeof t == "object" && t !== null && "value" in t) {
    const r = t.value;
    return { type: "item", text: (r ? X6(r) : "") || "—" };
  }
  ...
  return { type: "item", text: K6(String(t)) };
}
function O1({
  formName: t,
  formDescription: e,
  ...
  const { canvasContent: c, openCanvas: d, closeCanvas: u } = Ge(), h = q6(t), w = l ?? h, p = z(() => {
  ...
  p.current = M, fe(() => {
    typeof window > "u" || window.innerWidth < Y6 || Vn.has(t) || (Vn.add(t), p.current());
  }, [t]);
  const $ = a && i ? Object.entries(a).map(([v, C]) => {
    const x = i[v], S = w?.(v, x, {
    ...
    if (!S && C.fieldType === "custom" && typeof x == "object" && x !== null)
      return null;
    const _ = S ?? j1(x, C.fieldType), L = ["richtext", "textarea"];
    return {
      label: C.label,
      content: _,
      verticalLayout: L.includes(C.fieldType ?? "")
    };
  }).filter((v) => {
    if (!v) return !1;
    const C = Array.isArray(v.content) ? v.content[0] : v.content;
    return !(C?.type === "item" && C.text === "—");
  }) : [], I = $.slice(0, An), T = $.length > An;
  return /* @__PURE__ */ o(
    I1,
    {
...
const B1 = Vt(void 0), of = () => xt(B1), r9 = (t) => /* @__PURE__ */ o(Ao, { content: t, format: "markdown" }), n9 = ({
  isGenerating: t,
  isLoading: e,
  message: r,
  renderToolCall: n,
  ...
  const [s, a] = q(""), i = me(), { title: l, label: c, placeholder: d } = r === "like" ? i.ai.feedbackModal.positive : i.ai.feedbackModal.negative, u = ee(() => {
    e(n, s);
  }, [s, n, e]), h = () => {
    t(n);
  };
...
const i9 = ({
  ...
  const n = me(), { open: s } = z1(), [a, i] = q(null);
...
const W1 = (t) => /* @__PURE__ */ o(Ao, { content: t, format: "markdown" }), f9 = ({
  text: t,
  renderMarkdown: e
  ...
  const i = t.rawData, l = u9(
    t?.content,
    i
  ), c = (d9(t?.content) ?? "").trim(), d = t?.replyQuote ?? null, u = c.length > 0, { anchor: h, clear: w } = Z1({
    containerRef: a,
    enabled: u
  });
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        d && /* @__PURE__ */ o(f9, { text: d, renderMarkdown: n }),
...
}, p9 = 35, m9 = 22, g9 = 400, v9 = 2500, C9 = 220, w9 = ({ messages: t, onClick: e }) => {
  ...
  fe(() => {
    ...
    let h;
    if (i === "starting")
      h = setTimeout(() => l("writing"), g9);
    else if (i === "writing")
      s < c.length ? h = setTimeout(() => a((w) => w + 1), p9) : l("holding");
    else if (i === "holding") {
      if (t.length <= 1) return;
      h = setTimeout(() => l("erasing"), v9);
    } else i === "erasing" && (s > 0 ? h = setTimeout(() => a((w) => w - 1), m9) : h = setTimeout(() => {
...
function x9({
  ...
  const p = ee(() => {
    const g = t.current;
    if (!g) return;
    const { scrollTop: y, scrollHeight: k, clientHeight: M } = g, $ = k - y - M;
    d($ > M);
  }, [t]);
  return fe(() => {
    const g = t.current;
    ...
    s > u.current && requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        if (!g || !y) return;
        const k = g.getBoundingClientRect(), M = y.getBoundingClientRect(), $ = g.scrollTop + (M.top - k.top);
        g.scrollTo({ top: $, behavior: "smooth" });
      });
    }), s === 0 && d(!1), u.current = s;
...
const k9 = {
...
}, sf = (t) => /* @__PURE__ */ o(s9, { children: /* @__PURE__ */ o(y9, { ...t }) }), y9 = ({
  turns: t,
  isLoadingThread: e = !1,
  interrupt: r,
  initialMessage: n,
  ...
  const { modal: $, handleSubmit: I, handleClose: T } = a9(
    u ?? k9
  ), v = me(), C = g ?? n9, x = y ?? h9, S = de(() => {
    const E = n ?? v.ai.defaultInitialMessage;
    return (Array.isArray(E) ? E : [E]).filter((O) => typeof O == "string" && O.length > 0);
  }, [n, v.ai.defaultInitialMessage]), _ = !e && t.length === 0 && S.length > 0, L = z(null), b = z(null), N = z(null), D = z(null), Q = z(null), { showScrollBtn: J, turnMinHeight: se, scrollToBottom: ne } = x9({
    viewportRef: L,
    contentRef: b,
    endRef: N,
    lastTurnRef: Q,
    ...
    const O = B === t.length - 1, Y = {
      ...
      const le = O && te === E.assistantMessages.length - 1, ke = E.userMessages.length + te, R = {
        message: j,
        inProgress: E.isInProgress,
        index: ke,
        isCurrentMessage: le,
      ...
      return /* @__PURE__ */ o(
        C,
        {
          ...
          isLoading: E.isInProgress && le && !j.content
        },
        `${B}-a-${te}`
      );
    };
...
const M9 = ({
  ...
  const w = me().ai.clarifyingQuestion.typeYourAnswer, p = t === "single" ? /* @__PURE__ */ o(q1, { isSelected: r && !e }) : /* @__PURE__ */ o(
    $o,
    {
      checked: s,
      onCheckedChange: () => d(!s),
...
const _9 = ({
  ...
  const r = me(), n = De(), {
    ...
    customAnswerText: v,
    isCustomAnswerActive: C
  } = s, x = z(null), S = $ ?? "single", _ = i > 1, L = a === 0, b = a === i - 1, N = _ ? r.t("ai.clarifyingQuestion.stepOf", {
    current: String(a + 1),
    total: String(i)
  }) : void 0, D = M.length > 0, Q = (v ?? "").trim().length > 0, J = D || C && Q || I === !0, se = e === !0 && b, ne = () => {
    se || c();
  }, X = () => {
    se || d();
  }, E = (j) => {
    const te = S === "single" && M.includes(j);
    l(j), S === "single" && !b && !te && Promise.resolve().then(c);
  }, B = b ? r.ai.clarifyingQuestion.submit : r.ai.clarifyingQuestion.next, O = I === !0 && !D && !(C && Q), Y = () => {
  ...
  return /* @__PURE__ */ f("div", { className: "flex flex-col", onKeyDown: he, children: [
    /* @__PURE__ */ o("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ o(Oe, { mode: "wait", initial: !1, children: /* @__PURE__ */ f(
      Ce.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ve, ease: X1 },
        children: [
          /* @__PURE__ */ o(
            S9,
            {
...
function jn(t, e, r, n) {
  const s = Math.max(1, Math.min(t, e)), a = Math.min(r, 20), l = Math.min(a + n, s), c = Math.min(l, Math.floor(t / 2)), d = Math.min(l, Math.floor(e / 2)), u = (Y) => Y / t * 2 - 1, h = (Y) => Y / e * 2 - 1, w = 0, p = t, g = 0, y = e, k = c, M = t - c, $ = d, I = e - d, T = u(w), v = u(p), C = h(g), x = h(y), S = u(k), _ = u(M), L = h($), b = h(I), N = 0, D = 0, Q = 1, J = 1, se = c / t, ne = 1 - c / t, X = d / e, E = 1 - d / e, B = new Float32Array([
    // Top strip
    T,
    C,
    v,
...
class ff {
  ...
  setupGL() {
    ...
    const w = e.getUniformLocation(r, "uResolution"), p = e.getUniformLocation(r, "uTime"), g = e.getUniformLocation(r, "uBorderWidth"), y = e.getUniformLocation(r, "uGlowWidth"), k = e.getUniformLocation(r, "uBorderRadius"), M = e.getUniformLocation(r, "uColors"), $ = e.getUniformLocation(r, "uGlowExponent"), I = e.getUniformLocation(r, "uGlowFactor");
    e.useProgram(r), e.uniform1f(g, this.options.borderWidth), e.uniform1f(y, this.options.glowWidth), e.uniform1f(k, this.options.borderRadius), this.options.mode === "dark" ? (e.uniform1f($, 2), e.uniform1f(I, 1.8)) : (e.uniform1f($, 1), e.uniform1f(I, 1));
    const T = (this.options.colors || V9).map(F9);
...
const Zn = ["lowp", "mediump", "highp"], P9 = `
void main(void){
...
}`, Bn = "iTime", Un = "iTimeDelta", zn = "iDate", Wn = "iFrame", Gn = "iMouse", qn = "iResolution", H9 = "iChannel", Yn = "iChannelResolution", Xn = "iDeviceOrientation";
function I9(t, e) {
...
}, mr = 9729, Kn = 9728, B9 = 9987, Qn = 33071, Jn = 10497;
class U9 {
  gl;
  url;
  wrapS;
  ...
  load = async (e) => {
    ...
    const h = 0, w = r.RGBA, p = 1, g = 1, y = 0, k = r.RGBA, M = r.UNSIGNED_BYTE, $ = new Uint8Array([255, 255, 255, 0]), I = r.createTexture();
...
}, to = (t, e, r) => t * (1 - r) + e * r, z9 = (t, e, r) => r > 0 ? t.substring(0, r) + e + t.substring(r, t.length) : e + t;
function W9({
  fs: t,
  vs: e = Dn,
  textures: r = [],
  ...
  const p = z(null), g = z(null), y = z(null), k = z(null), M = z(void 0), $ = z(void 0), I = z(!1), T = z(void 0), v = z(0), C = z([0, 0]), x = z([]), S = z(0), _ = z(void 0), L = z({
    ...
    const P = "width" in R ? R.width ?? 0 : 0, K = "height" in R ? R.height ?? 0 : 0, U = L.current.iChannelResolution;
    if (!U) return;
    const oe = Array.isArray(U.value) ? U.value : U.value = [];
    oe[H * 3] = P * d, oe[H * 3 + 1] = K * d, oe[H * 3 + 2] = 0;
  }, D = () => {
    ...
    const [H = 0, P = 0] = eo(R), K = H - (T.current?.left ?? 0) - window.pageXOffset, U = (T.current?.height ?? 0) - P - (T.current?.top ?? 0) - window.pageYOffset;
    I.current = !0;
    const oe = Array.isArray(L.current.iMouse?.value) ? L.current.iMouse.value : void 0;
    oe && (oe[2] = K, oe[3] = U), C.current[0] = K, C.current[1] = U;
  }, ne = (R) => {
    T.current = p.current?.getBoundingClientRect();
    const [H = 0, P = 0] = eo(R), K = H - (T.current?.left ?? 0), U = (T.current?.height ?? 0) - P - (T.current?.top ?? 0);
    if (c !== 1)
    ...
    const R = Array.isArray(L.current.iMouse?.value) ? L.current.iMouse.value : void 0;
    R && (R[2] = 0, R[3] = 0);
  }, E = () => {
    const R = g.current;
    if (!R) return;
    T.current = p.current?.getBoundingClientRect();
    const H = d, P = Math.floor(
      (T.current?.width ?? 1) * H
    ), K = Math.floor(
      (T.current?.height ?? 1) * H
    );
    if (R.canvas.width = P, R.canvas.height = K, L.current.iResolution?.isNeeded && k.current) {
    ...
    const P = g.current;
    if (!P) return null;
    const K = P.createShader(R);
    if (!K) return null;
    if (P.shaderSource(K, H), P.compileShader(K), !P.getShaderParameter(K, P.COMPILE_STATUS)) {
      w?.(Ue(`Error compiling the shader:
${H}`));
      const U = P.getShaderInfoLog(K);
      P.deleteShader(K), h?.(Ue(`Shader compiler log: ${U}`));
    }
    return K;
  }, O = (R, H) => {
    const P = g.current;
    if (!P) return;
    const K = B(P.FRAGMENT_SHADER, R), U = B(P.VERTEX_SHADER, H);
    if (k.current = P.createProgram(), !(!k.current || !U || !K)) {
      if (P.attachShader(k.current, U), P.attachShader(k.current, K), P.linkProgram(k.current), !P.getProgramParameter(k.current, P.LINK_STATUS)) {
        h?.(
          Ue(
      ...
      P.useProgram(k.current), M.current = P.getAttribLocation(
        k.current,
        "aVertexPosition"
      ), P.enableVertexAttribArray(M.current);
    }
  }, Y = () => {
    if (n)
      for (const R of Object.keys(n)) {
        const H = n[R];
        if (!H) continue;
        const { value: P, type: K } = H, U = D9(K);
        if (!U) continue;
        const oe = {};
        if (I9(K, P)) {
          const ie = K.length, be = Number.parseInt(K.charAt(ie - 3)), Re = Math.floor(P.length / (be * be));
          P.length > be * be && (oe.arraySize = `[${Re}]`);
        } else j9(K, P) && (oe.arraySize = `[${Math.floor(P.length / Number.parseInt(K.charAt(0)))}]`);
        L.current[R] = {
          type: U,
          isNeeded: !1,
          value: P,
      ...
      if (r && r.length > 0) {
        ...
        const H = r.map(
          (P, K) => (L.current[`${H9}${K}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, N(P, K), x.current[K] = new U9(R), x.current[K]?.load(P).then((U) => {
            N(U, K);
          }))
        );
        Promise.all(H).then(() => {
    ...
    const H = Zn.includes(a ?? "highp"), P = `precision ${H ? a : Zn[1]} float;
`;
    H || w?.(
      Ue(
    ...
    let K = P.concat(`#define DPR ${d.toFixed(1)}
`).concat(R.replace(/texture\(/g, "texture2D("));
    for (const oe of Object.keys(L.current))
      if (R.includes(oe)) {
        const ie = L.current[oe];
        if (!ie) continue;
        K = z9(
          K,
          `uniform ${ie.type} ${oe}${ie.arraySize || ""}; 
`,
          K.lastIndexOf(P) + P.length
        ), ie.isNeeded = !0;
      }
    return R.includes("mainImage") && (K = K.concat(P9)), K;
  }, j = (R) => {
    const H = g.current;
    if (!H || !k.current) return;
    const P = S.current ? (R - S.current) / 1e3 : 0;
    S.current = R;
    const K = b.current;
    if (K)
      for (const U of Object.keys(K)) {
        const oe = K[U];
        if (oe && L.current[U]?.isNeeded) {
          if (!k.current) return;
    ...
    if (L.current.iMouse?.isNeeded) {
      ...
      H.uniform4fv(U, L.current.iMouse.value);
    }
    ...
    if (L.current.iFrame?.isNeeded) {
      const U = H.getUniformLocation(
        k.current,
        Wn
      ), oe = L.current.iFrame.value;
      H.uniform1i(U, oe), L.current.iFrame.value = oe + 1;
    }
    if (x.current.length > 0)
      for (let U = 0; U < x.current.length; U++) {
        ...
        if (!qe || !be || !Re) return;
        if (L.current[`iChannel${U}`]?.isNeeded) {
          if (!k.current) return;
    ...
    H.viewport(0, 0, H.drawingBufferWidth, H.drawingBufferHeight), H.clear(H.COLOR_BUFFER_BIT | H.DEPTH_BUFFER_BIT), H.bindBuffer(H.ARRAY_BUFFER, y.current), H.vertexAttribPointer(
      ...
      0,
      0
    ), j(R), H.drawArrays(H.TRIANGLE_STRIP, 0, 4);
    const P = L.current.iMouse?.value;
    if (L.current.iMouse?.isNeeded && c !== 1 && Array.isArray(P)) {
      const K = P[0] ?? 0, U = P[1] ?? 0;
      P[0] = to(K, C.current[0] ?? 0, c), P[1] = to(U, C.current[1] ?? 0, c);
    }
    $.current = requestAnimationFrame(te);
  }, le = () => {
    const R = { passive: !0 };
    L.current.iMouse?.isNeeded && p.current && (p.current.addEventListener("mousemove", ne, R), p.current.addEventListener("mouseout", X, R), p.current.addEventListener("mouseup", X, R), p.current.addEventListener("mousedown", se, R), p.current.addEventListener("touchmove", ne, R), p.current.addEventListener("touchend", X, R), p.current.addEventListener("touchstart", se, R)), L.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      J,
      R
    ...
    const R = { passive: !0 };
    L.current.iMouse?.isNeeded && p.current && (p.current.removeEventListener("mousemove", ne, R), p.current.removeEventListener("mouseout", X, R), p.current.removeEventListener("mouseup", X, R), p.current.removeEventListener("mousedown", se, R), p.current.removeEventListener("touchmove", ne, R), p.current.removeEventListener("touchend", X, R), p.current.removeEventListener("touchstart", se, R)), L.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      J,
      R
  ...
  return fe(() => {
    ...
    function H() {
      D();
      const P = g.current;
      P && p.current && (P.clearColor(...s), P.clearDepth(1), P.enable(P.DEPTH_TEST), P.depthFunc(P.LEQUAL), P.viewport(0, 0, p.current.width, p.current.height), p.current.height = p.current.clientHeight, p.current.width = p.current.clientWidth, Y(), he(), O(ve(t || $9), e || Dn), Q(), requestAnimationFrame(te), le(), E());
    }
    return requestAnimationFrame(H), () => {
      const P = g.current;
      if (P) {
        if (P.getExtension("WEBGL_lose_context")?.loseContext(), P.useProgram(null), P.deleteProgram(k.current ?? null), R.length > 0)
          for (const K of R)
            P.deleteTexture(K._webglTexture);
        k.current = null;
      }
      ke(), cancelAnimationFrame($.current ?? 0);
    };
  }, []), /* @__PURE__ */ o(
    "canvas",
    {
...
}`, q9 = 10, Y9 = 2, X9 = 0.5, K9 = 0.2, Q9 = 1.5, Ve = {
  duration: 0.5,
  ease: "easeOut"
}, ro = {
  duration: 0.35,
...
function J9(t, e) {
  const [r, n] = q(q9), {
    ...
    animate: a,
    motionValue: i
  } = jt(K9), { value: l, animate: c } = jt(Y9), { value: d, animate: u } = jt(X9), { value: h, animate: w } = jt(Q9), p = Ki(e, {
    fftSize: 512,
...
function hf({
  ...
  const { speed: d, scale: u, amplitude: h, frequency: w, brightness: p } = J9(e, s);
  return /* @__PURE__ */ o(
    Q1,
    {
      ref: l,
...
const pf = ({
  ...
  const n = me(), s = De();
  return /* @__PURE__ */ f(ze, { children: [
    t && /* @__PURE__ */ o("span", { className: F(n3(), "truncate"), children: t }),
    ...
    /* @__PURE__ */ f(
      Ce.div,
      {
        ...
        children: [
          ...
          n === "alert" && /* @__PURE__ */ o(Hi, { text: t.alertLabel, level: t.level }),
          n === "balance" && /* @__PURE__ */ o(a3, { balance: t.balance })
        ]
      }
    ),
...
const l3 = ({
  ...
  dataLength: n,
  color: s
}) => r !== n - 1 || t == null || e == null ? null : /* @__PURE__ */ o("circle", { cx: t, cy: e, r: 2, fill: s, stroke: "none" }), d3 = ({
  label: t,
  direction: e
}) => {
  const r = es[e];
  ...
  const s = `sparkline-gradient-${ao().replace(/:/g, "")}`, a = c3(t, r), i = es[a];
  return /* @__PURE__ */ o("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(ji, { width: "100%", height: "100%", children: /* @__PURE__ */ f(
          Oi,
          {
            data: t,
            ...
            children: [
              ...
              /* @__PURE__ */ o(Zi, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ o(
                Di,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ o(d3, { label: e, direction: a })
      ]
    }
  ) });
}, ts = m(
...
const f3 = ["className"], rs = m((t, e) => {
  const r = f3.reduce((n, s) => {
    const { [s]: a, ...i } = n;
    return i;
  }, t);
...
const h3 = () => /* @__PURE__ */ f(
  ...
  "balance",
  "sparkline"
], ns = 180, p3 = (t) => Number.isFinite(t) ? Math.max(0, Math.floor(t)) : ns, m3 = (t, e) => t.length <= e ? t : `${t.slice(0, e).trimEnd()}...`, g3 = (t) => t.showActions !== !1, v3 = (t) => Object.fromEntries(
...
function C3(t) {
  ...
  } = t, [c, d] = q(!1), u = ao(), h = z(null), w = p3(
    l
  ), p = a.length > w, g = c ? a : m3(a, w), y = g3(t) ? t : null, k = v3(t);
  return fe(() => {
    c && h.current?.focus();
  }, [c]), /* @__PURE__ */ f(
    "section",
...
C3.displayName = "F0AiProposalCard";
const w3 = ({
  icon: t,
  title: e,
  children: r
...
}, x3 = (t) => Z2[t] ?? wo, k3 = ({ iconName: t }) => t ? /* @__PURE__ */ o("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ o(ye, { icon: x3(t), size: "md", color: "default" }) }) : null;
function y3({
  sources: t,
  title: e
}) {
  ...
  return /* @__PURE__ */ o(w3, { icon: Tr, title: n, children: /* @__PURE__ */ o("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: t.map((s, a) => {
    const i = /* @__PURE__ */ o(k3, { iconName: s.icon });
...
y3.displayName = "F0AiMessageSources";
...
function L3({
  ...
  const n = me(), s = z(null), a = e ?? n.ai.aiTable.title, i = ee(
    (l) => {
      if (!s.current) return;
              ...
              /* @__PURE__ */ o("tbody", { children: t.rows.map((l, c) => /* @__PURE__ */ o("tr", { children: t.columns.map((d) => {
                ...
                return /* @__PURE__ */ o(
                  "td",
                  {
                    ...
                    children: /* @__PURE__ */ o(Me, { children: u == null ? "" : String(u) })
                  },
                  d
                );
              }) }, c)) })
...
L3.displayName = "F0AiTableCard";
function M3({ credits: t }) {
  const e = me(), [r, n] = q(!1), [s, a] = q(!1), [i, l] = q(!1), [c, d] = q(null), u = ee(
    (p) => {
        ...
        children: [
          w && /* @__PURE__ */ f("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            ...
            /* @__PURE__ */ f("div", { className: "flex min-w-0 flex-col", children: [
              /* @__PURE__ */ o(Me, { tag: "span", className: "font-medium", children: t.companyName ?? "" }),
...
const E3 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function _3({
  employeeCredits: t
}) {
  const e = me(), r = De(), [n, s] = q(!1), [a, i] = q(!1), [l, c] = q(!1), [d, u] = q(null), h = ee(
    (y) => {
...
const no = ({
  credits: t,
  employeeCredits: e
}) => e ? /* @__PURE__ */ o(_3, { employeeCredits: e }) : t ? /* @__PURE__ */ o(M3, { credits: t }) : null, vf = ({
  historyEnabled: t = !1,
  title: e,
  ...
  const w = me(), p = _o(`(max-width: ${Ui.md}px)`, {
        ...
        /* @__PURE__ */ o("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ o(
          Rt,
          {
            ...
            children: /* @__PURE__ */ f("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ o(Me, { lines: 1, className: "min-w-0 text-left", children: r ?? w.ai.newConversation }),
...
function S3() {
  if (!(typeof navigator > "u"))
    return Gi(navigator.language);
}
function R3(t) {
  const e = new Date(t), r = /* @__PURE__ */ new Date();
  return Ho(e) ? "today" : Io(e) ? "yesterday" : zi(e, r) ? "thisMonth" : "older";
}
function N3(t, e) {
  const r = new Date(t), n = S3(), s = Yr(r, "p", { locale: n });
  if (Ho(r)) return `${e.today}, ${s}`;
  if (Io(r)) return `${e.yesterday}, ${s}`;
  const a = !Wi(r, /* @__PURE__ */ new Date());
      ...
      children: [
        /* @__PURE__ */ f(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ o(Me, { lines: 1, className: "text-left font-medium", children: t.title }),
                  ...
                  /* @__PURE__ */ o(
                    Rt,
                    {
                      ...
                      children: /* @__PURE__ */ f("div", { className: "flex w-full items-center gap-2", children: [
                        ...
                        /* @__PURE__ */ o(Me, { lines: 1, className: "text-left", children: u.ai.startNewChat })
                      ] })
                    }
                  ),
                  s && /* @__PURE__ */ o(V3, {}),
...
function wf({
  ...
  const [n, s] = q([]), [a, i] = q(!1), [l, c] = q(null), [d, u] = q(F3), h = ee(async () => {
    i(!0), c(null);
    try {
      const y = await e();
      s(y);

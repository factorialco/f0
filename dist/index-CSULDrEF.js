...
function Us(t = {}) {
  ...
  function d(_, D) {
    ...
    const {
      mergeOptions: $,
      optionsAtMedia: z
    } = D, B = $(Jh, Us.globalOptions), L = $(B, t);
    if (e = z(L), n.scrollSnapList().length <= 1) return;
    u = e.jump, r = !1, i = Zh(n, e.delay);
    const {
      eventStore: V,
      ownerDocument: se
    } = n.internalEngine(), He = !!n.internalEngine().options.watchDrag, We = Qh(n, e.rootNode);
...
var ep = 0.996, tp = function(e, n) {
  return n === void 0 && (n = ep), e * n / (1 - n);
};
function np(t) {
  return t[t.length - 1];
}
...
var ap = 16 * 1.125, lp = typeof window < "u" && window.innerHeight || 800, Ao = [1, ap, lp];
function cp(t) {
...
var ja = 700, fp = function(e) {
  return nn({}, e, {
    axisDelta: e.axisDelta.map(function(n) {
      return ip(n, -ja, ja);
    })
  });
}, Co = process.env.NODE_ENV !== "production", hp = 0.6, pp = 0.96, mp = 2, Fa = 5, za = /* @__PURE__ */ Pn({
...
function yp(t) {
  t === void 0 && (t = {});
  var e = op(), n = e.on, r = e.off, i = e.dispatch, o = za, s = Ba(), a, c = !1, l, u = function(_) {
    ...
    return _ === void 0 && (_ = {}), Object.values(_).some(function(D) {
      return D == null;
    }) ? (Co && console.error("updateOptions ignored! undefined & null options not allowed"), o) : o = Pn(nn({}, za, o, _));
  }, f = function(_) {
    var D = nn({
      event: a,
      isStart: !1,
    ...
    var D = fp(dp(cp(_), o.reverseSign)), $ = D.axisDelta, z = D.timeStamp, B = $a($);
    ...
    s.scrollPointsToMerge.length === mp ? (s.scrollPoints.unshift({
      ...
      timeStamp: rp(s.scrollPointsToMerge.map(function(_) {
        return _.timeStamp;
      }))
    }), b(), s.scrollPointsToMerge.length = 0, s.scrollPoints.length = 1, s.isMomentum || S()) : s.isStartPublished || y();
  }, y = function() {
    s.axisVelocity = np(s.scrollPointsToMerge).axisDelta.map(function(_) {
    ...
    if (s.accelerationFactors.length >= Fa) {
      ...
      var _ = s.accelerationFactors.slice(Fa * -1), D = _.every(function($) {
  ...
  }, N = sp(u), I = N.observe, M = N.unobserve, T = N.disconnect;
  return d(t), Pn({
    on: n,
    off: r,
    observe: I,
...
var vp = process.env.NODE_ENV !== "production";
function Ks(t) {
  t === void 0 && (t = {});
  var e, n = function() {
  };
  function r(o, s) {
    var a, c, l = s.mergeOptions, u = s.optionsAtMedia, d = l(bp, Ks.globalOptions), f = l(d, t);
    e = u(f);
    var h = o.internalEngine(), p = (a = e.target) != null ? a : o.containerNode().parentNode, m = (c = e.forceWheelAxis) != null ? c : h.options.axis, y = yp({
    ...
    function k(P) {
      try {
        ...
        return vp && console.warn("Legacy browser requires events-polyfill (https://github.com/xiel/embla-carousel-wheel-gestures#legacy-browsers)"), n();
      }
...
function Yc(t, e) {
  return [t, e].reduce((n, r) => (wr(r).forEach((i) => {
...
function _p(t, e, n, r, i, o, s, a, c, l, u, d, f, h, p, m, y, b, v) {
  const {
    cross: w,
    direction: S
  } = t, k = ["INPUT", "SELECT", "TEXTAREA"], O = {
    passive: !1
  }, x = xr(), E = xr(), N = sn(50, 225).constrain(h.measure(20)), I = {
    mouse: 300,
    touch: 400
  }, M = {
    mouse: 500,
  ...
  function V(R) {
    ...
    const ae = e;
    x.add(ae, "dragstart", (Ae) => Ae.preventDefault(), O).add(ae, "touchmove", () => {
    }, O).add(ae, "touchend", () => {
    }).add(ae, "touchstart", q).add(ae, "mousedown", q).add(ae, "touchcancel", ke).add(ae, "contextmenu", ke).add(ae, "click", bt, !0);
  }
  function se() {
    x.clear(), E.clear();
  }
  ...
  function tr(R, q) {
    const ae = d.add(qs(R) * -1), Ae = u.byDistance(R, !p).distance;
    return p || ee(R) < N ? Ae : y && q ? Ae * 0.5 : u.byIndex(ae.get(), 0).distance;
  }
  function nr(R) {
    const q = Uo(R, r);
    L = q, B = p && q && !R.buttons && P, P = dr(i.get(), s.get()) >= 2, !(q && R.button !== 0) && (We(R.target) || ($ = !0, o.pointerDown(R), l.useFriction(0).useDuration(0), i.set(s), He(), _ = o.readPoint(R), D = o.readPoint(R, w), f.emit("pointerDown")));
  }
  function je(R) {
    if (!Uo(R, r) && R.touches.length >= 2) return ke(R);
    const ae = o.readPoint(R), Ae = o.readPoint(R, w), ft = dr(ae, _), vt = dr(Ae, D);
    if (!z && !L && (!R.cancelable || (z = ft > vt, !z)))
      return ke(R);
    const Gt = o.pointerMove(R);
    ft > m && (B = !0), l.useFriction(0.3).useDuration(0.75), a.start(), i.add(S(Gt)), R.preventDefault();
  }
  function ke(R) {
    const ae = u.byDistance(0, !1).index !== d.get(), Ae = o.pointerUp(R) * yt(), ft = tr(S(Ae), ae), vt = kp(Ae, ft), Gt = T - 10 * vt, Rt = b + vt / 50;
...
function Wp(t, e, n, r, i, o, s, a, c) {
  const u = vr(i), d = vr(i).reverse(), f = b().concat(v());
  function h(x, E) {
...
function Yp(t, e, n, r, i, o, s, a, c) {
  ...
  function h(b, v) {
    return vr(b).filter((w) => w % v === 0).map((w) => b.slice(w, w + v));
  }
  function p(b) {
    return b.length ? vr(b).reduce((v, w, S) => {
      const k = ot(v) || 0, O = k === 0, x = w === zr(b), E = i[l] - o[k][l], N = i[l] - o[w][u], I = !r && O ? d(s) : 0, M = !r && x ? d(a) : 0, T = ee(N - M - (E + I));
...
function qp(t, e, n, r, i, o, s) {
  const {
    ...
    watchDrag: k,
    watchFocus: O
  } = o, x = 2, E = Np(), N = E.measure(e), I = n.map(E.measure), M = Op(c, l), T = M.measureSize(N), P = Pp(T), _ = Cp(a, T), D = !d && !!v, $ = d || !!v, {
    slideSizes: z,
    slideSizesWithGaps: B,
    startGap: L,
    endGap: V
  } = Gp(M, N, I, n, $, i), se = Yp(M, T, y, d, N, I, L, V, x), {
    snaps: He,
    snapsAligned: We
  } = Fp(M, _, N, I, se), yt = -ot(He) + ot(B), {
    snapsContained: tr,
    scrollContainLimit: nr
  } = Lp(T, yt, We, v, x), je = D ? tr : We, {
    limit: ke
  } = Rp(yt, je, d), bt = qc(zr(je), u, d), Ue = bt.clone(), Q = vr(n), R = ({
    dragHandler: vn,
    scrollBody: wo,
    scrollBounds: xo,
    options: {
    ...
    const Oa = vn.settled(), sf = !of.shouldConstrain(), _a = Ca ? Oa : Oa && sf, Ta = _a && !nf.pointerDown();
    Ta && rf.stop();
    const af = xo.get() * Ea + Qd.get() * (1 - Ea);
    Jr.set(af), Ca && (ef.loop(vn.direction()), tf.loop()), wo.to(Jr.get()), Ta && Aa.emit("settle"), _a || Aa.emit("scroll");
  }, ae = Ep(r, i, () => R(vo), (vn) => q(vo, vn)), Ae = 0.68, ft = je[bt.get()], vt = ur(ft), Gt = ur(ft), Rt = ur(ft), Yt = ur(ft), rr = Mp(vt, Rt, Gt, Yt, f, Ae), yo = Bp(d, je, yt, ke, Yt), bo = Vp(ae, bt, Ue, rr, yo, Yt, s), xa = jp(ke), Sa = xr(), Jd = Kp(e, n, s, m), {
    slideRegistry: ka
  } = zp(D, v, je, nr, se, Q), Zd = Hp(t, n, ka, bo, rr, Sa, s, O), vo = {
    ownerDocument: r,
    ownerWindow: i,
    eventHandler: s,
    containerRect: N,
    ...
    animation: ae,
    axis: M,
    dragHandler: _p(M, t, r, i, Yt, Tp(M, i), vt, ae, bo, rr, yo, bt, s, P, h, p, b, Ae, k),
    eventStore: Sa,
    percentOfView: P,
    index: bt,
    indexPrevious: Ue,
    ...
    previousLocation: Gt,
    options: o,
    resizeHandler: Dp(e, s, i, n, M, w, E),
    scrollBody: rr,
    scrollBounds: Ip(ke, Rt, Yt, rr, P),
    scrollLooper: $p(yt, ke, Rt, [vt, Rt, Gt, Yt]),
    scrollProgress: xa,
    scrollSnapList: je.map(xa.get),
    scrollSnaps: je,
    scrollTarget: yo,
    scrollTo: bo,
    slideLooper: Wp(M, T, yt, z, B, He, je, Rt, n),
    slideFocus: Zd,
    slidesHandler: Up(e, s, S),
    slidesInView: Jd,
    slideIndexes: Q,
    slideRegistry: ka,
    slidesToScroll: se,
...
function Zp(t) {
  ...
  function n(o) {
    const s = o.breakpoints || {}, a = wr(s).filter((c) => t.matchMedia(c).matches).map((c) => s[c]).reduce((c, l) => e(c, l), {});
    return e(o, a);
  }
  function r(o) {
    return o.map((s) => wr(s.breakpoints || {})).reduce((s, a) => s.concat(a), []).map(t.matchMedia);
  }
  return {
    mergeOptions: e,
    optionsAtMedia: n,
...
function Ci(t, e, n) {
  const r = t.ownerDocument, i = r.defaultView, o = Zp(i), s = Qp(o), a = xr(), c = Xp(), {
    mergeOptions: l,
    optionsAtMedia: u,
  ...
  let y = !1, b, v = l(Jp, Ci.globalOptions), w = l(v), S = [], k, O, x;
  function E() {
    const {
      container: Q,
      slides: R
...
function Js(t = {}, e = []) {
  const n = At(t), r = At(e), [i, o] = de(), [s, a] = de(), c = Ye(() => {
    i && i.reInit(n.current, r.current);
  }, [i]);
  return it(() => {
    Gs(n.current, t) || (n.current = t, c());
  }, [t, c]), it(() => {
    Sp(r.current, e) || (r.current = e, c());
  }, [e, c]), it(() => {
    if (xp() && s) {
...
const te = 28, Ka = 16, em = ({ children: t }) => {
  const e = At(null), [n, r] = de(!0), [i, o] = de(!1);
  pc(() => {
    const u = e.current;
    if (!u) return;
...
const Qc = U.forwardRef(({ className: t, ...e }, n) => {
  const r = `linear-gradient(to right, transparent 0px, transparent ${te / 2}px, black ${te}px, black calc(100% - ${te}px), transparent calc(100% - ${te / 2}px), transparent 100%)`, { carouselRef: i, orientation: o } = Br();
  return /* @__PURE__ */ g(
    "div",
    {
      ref: i,
...
const tu = U.forwardRef(({ className: t, variant: e = "outline", ...n }, r) => {
  const { orientation: i, scrollPrev: o, canScrollPrev: s } = Br();
  return /* @__PURE__ */ g(
    "div",
    {
      className: Y(
...
const nu = U.forwardRef(
  ({ className: t, variant: e = "outline", ...n }, r) => {
    const { orientation: i, scrollNext: o, canScrollNext: s } = Br();
    return /* @__PURE__ */ g(
      "div",
      {
        className: Y(
...
const ru = U.forwardRef(({ ...t }, e) => {
  const { api: n } = Br(), [, r] = U.useState(!1), i = U.useRef(null), o = U.useCallback(() => {
    r((f) => !f);
  }, []);
  U.useEffect(() => {
    if (n)
    ...
    Zc,
    {
      ...
      children: /* @__PURE__ */ A("div", { className: "flex flex-col gap-5", children: [
        /* @__PURE__ */ A("div", { className: "relative", children: [
          /* @__PURE__ */ g(Qc, { children: C.Children.map(c, (f, h) => {
            const p = a?.find(
              (m) => m.index === h
            );
            return /* @__PURE__ */ g(
...
function om(t, e, n) {
  const r = ff(), i = n?.locale ?? r.locale ?? hf, o = rm(t, e);
  if (isNaN(o))
  ...
  const l = im(n?.roundingMethod ?? "round"), u = c.getTime() - a.getTime(), d = u / Ia, f = Na(c) - Na(a), h = (u - f) / Ia, p = n?.unit;
  let m;
...
function Ya(t, e = !0) {
  return sm(t, { addSuffix: e });
}
function H1(t, { yesterdayRelative: e = !0 } = {}) {
  return bc(t) ? Ya(t) : vc(t) ? e ? Ya(t) : Nn(t, "p") : Nn(t, "PPPp");
}
const W1 = (t, e) => {
  const n = {
    today: [],
...
}, U1 = Re(cm), um = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";
let Ko = (t = 21) => {
...
var dm = ["points", "className", "baseLinePoints", "connectNulls"];
function kn() {
...
var Xa = function(e) {
  ...
  var i = fr(e, r);
  return "".concat(i.slice(-1) === "Z" ? i.slice(0, -1) : i, "L").concat(fr(n.reverse(), r).slice(1));
}, iu = function(e) {
  var n = e.points, r = e.className, i = e.baseLinePoints, o = e.connectNulls, s = fm(e, dm);
  if (!n || !n.length)
    return null;
  var a = _e("recharts-polygon", r);
  if (i && i.length) {
    var c = s.stroke && s.stroke !== "none", l = vm(n, i, o);
...
}, wm = ["cx", "cy", "innerRadius", "outerRadius", "gridType", "radialLines"];
function Sr(t) {
...
function km(t, e, n) {
  return e = Am(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function Am(t) {
  var e = Cm(t, "string");
...
var Em = function(e, n, r, i) {
  ...
  var n = e.cx, r = e.cy, i = e.radius, o = e.index, s = kr(kr({
    stroke: "#ccc"
  }, W(e, !1)), {}, {
    fill: "none"
  });
  ...
  var n = e.radius, r = e.index, i = kr(kr({
    stroke: "#ccc"
  }, W(e, !1)), {}, {
    fill: "none"
  });
  return /* @__PURE__ */ C.createElement("path", _t({}, i, {
    ...
    key: "path-".concat(r),
    d: Em(n, e.cx, e.cy, e.polarAngles)
  }));
}, Nm = function(e) {
  ...
  return !n || !n.length ? null : /* @__PURE__ */ C.createElement("g", {
    ...
    var s = o;
    return r === "circle" ? /* @__PURE__ */ C.createElement(_m, _t({
      key: s
    }, e, {
      radius: i,
      index: o
    })) : /* @__PURE__ */ C.createElement(Tm, _t({
      key: s
    }, e, {
      radius: i,
      index: o
  ...
  var n = e.cx, r = n === void 0 ? 0 : n, i = e.cy, o = i === void 0 ? 0 : i, s = e.innerRadius, a = s === void 0 ? 0 : s, c = e.outerRadius, l = c === void 0 ? 0 : c, u = e.gridType, d = u === void 0 ? "polygon" : u, f = e.radialLines, h = f === void 0 ? !0 : f, p = xm(e, wm);
  return l <= 0 ? null : /* @__PURE__ */ C.createElement("g", {
    className: "recharts-polar-grid"
  }, /* @__PURE__ */ C.createElement(Om, _t({
    cx: r,
    cy: o,
    innerRadius: a,
    outerRadius: l,
    gridType: d,
    radialLines: h
  }, p)), /* @__PURE__ */ C.createElement(Nm, _t({
    cx: r,
    cy: o,
    innerRadius: a,
    outerRadius: l,
...
var $m = ["cx", "cy", "angle", "ticks", "axisLine"], jm = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function Dn(t) {
  "@babel/helpers - typeof";
...
function Vm(t, e, n) {
  return e = Ei(e), Hm(t, su() ? Reflect.construct(e, n || [], Ei(t).constructor) : e.apply(t, n));
}
function Hm(t, e) {
...
var Kn = /* @__PURE__ */ (function(t) {
  function e() {
    return zm(this, e), Vm(this, e, arguments);
  }
  return Um(e, t), Bm(e, [{
    ...
    key: "renderAxisLine",
    value: function() {
      var r = this.props, i = r.cx, o = r.cy, s = r.angle, a = r.ticks, c = r.axisLine, l = tl(r, $m), u = a.reduce(function(p, m) {
        return [Math.min(p[0], m.coordinate), Math.max(p[1], m.coordinate)];
      }, [1 / 0, -1 / 0]), d = Me(i, o, u[0], s), f = Me(i, o, u[1], s), h = qt(qt(qt({}, W(l, !1)), {}, {
        fill: "none"
      }, W(c, !1)), {}, {
        x1: d.x,
        y1: d.y,
      ...
      return /* @__PURE__ */ C.createElement("line", hr({
    ...
    key: "renderTicks",
    value: function() {
      var r = this, i = this.props, o = i.ticks, s = i.tick, a = i.angle, c = i.tickFormatter, l = i.stroke, u = tl(i, jm), d = this.getTickTextAnchor(), f = W(u, !1), h = W(s, !1), p = o.map(function(m, y) {
        ...
        return /* @__PURE__ */ C.createElement(ie, hr({
          className: _e("recharts-polar-radius-axis-tick", Sc(s)),
    ...
    value: function(r, i, o) {
      var s;
      return /* @__PURE__ */ C.isValidElement(r) ? s = /* @__PURE__ */ C.cloneElement(r, i) : ge(r) ? s = r(i) : s = /* @__PURE__ */ C.createElement(Ki, hr({}, i, {
...
function qm(t, e, n) {
  return e = Oi(e), Xm(t, lu() ? Reflect.construct(e, n || [], Oi(t).constructor) : e.apply(t, n));
}
function Xm(t, e) {
...
var eg = Math.PI / 180, ol = 1e-5, Gn = /* @__PURE__ */ (function(t) {
  function e() {
    return Gm(this, e), qm(this, e, arguments);
  }
  return Zm(e, t), Ym(e, [{
    ...
    key: "getTickTextAnchor",
    value: function(r) {
      var i = this.props.orientation, o = Math.cos(-r.coordinate * eg), s;
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(iu, Jt({
        className: "recharts-polar-angle-axis-line"
      }, l, {
        points: d
      }));
    ...
    value: function() {
      var r = this, i = this.props, o = i.ticks, s = i.tick, a = i.tickLine, c = i.tickFormatter, l = i.stroke, u = W(this.props, !1), d = W(s, !1), f = Xt(Xt({}, u), {}, {
        ...
        return /* @__PURE__ */ C.createElement(ie, Jt({
          className: _e("recharts-polar-angle-axis-tick", Sc(s)),
...
function rg(t, e, n) {
  return e = _i(e), ig(t, uu() ? Reflect.construct(e, n || [], _i(t).constructor) : e.apply(t, n));
}
function ig(t, e) {
...
var Dt = /* @__PURE__ */ (function(t) {
  function e(n) {
    var r;
    return tg(this, e), r = rg(this, e, [n]), Xe(r, "pieRef", null), Xe(r, "sectorRefs", []), Xe(r, "id", $s("recharts-pie-")), Xe(r, "handleAnimationEnd", function() {
  ...
  return sg(e, t), ng(e, [{
    ...
    value: function(r) {
      ...
      var o = this.props, s = o.label, a = o.labelLine, c = o.dataKey, l = o.valueKey, u = W(this.props, !1), d = W(s, !1), f = W(a, !1), h = s && s.offsetRadius || 20, p = r.map(function(m, y) {
        var b = (m.startAngle + m.endAngle) / 2, v = Me(m.cx, m.cy, m.outerRadius + h, b), w = X(X(X(X({}, u), m), {}, {
          stroke: "none"
        }, d), {}, {
          index: y,
          ...
          index: y,
          points: [Me(m.cx, m.cy, m.outerRadius, b), v]
        }), k = c;
        ...
        }, a && e.renderLabelLineItem(a, S, "line"), e.renderLabelItem(s, w, Pe(m, k)));
      });
      return /* @__PURE__ */ C.createElement(ie, {
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(Yi, {
        ...
        return o.forEach(function(w, S) {
          var k = f && f[S], O = S > 0 ? wf(w, "paddingAngle", 0) : 0;
          if (k) {
            var x = Oe(k.endAngle - k.startAngle, w.endAngle - w.startAngle), E = X(X({}, w), {}, {
              startAngle: v + O,
              endAngle: v + x(m) + O
            });
            y.push(E), v = E.endAngle;
          } else {
            var N = w.endAngle, I = w.startAngle, M = Oe(0, N - I), T = M(m), P = X(X({}, w), {}, {
              startAngle: v + O,
              endAngle: v + T + O
            });
    ...
    value: function() {
      ...
      if (o || !s || !s.length || !Ne(l) || !Ne(u) || !Ne(d) || !Ne(f))
        return null;
      var m = _e("recharts-pie", a);
      return /* @__PURE__ */ C.createElement(ie, {
    ...
    value: function(r, i, o) {
      ...
      if (ge(r) && (s = r(i), /* @__PURE__ */ C.isValidElement(s)))
        return s;
      var a = _e("recharts-pie-label-text", typeof r != "boolean" && !ge(r) ? r.className : "");
...
Xe(Dt, "parseCoordinateOfPie", function(t, e) {
  var n = e.top, r = e.left, i = e.width, o = e.height, s = xf(i, o), a = r + Zr(t.cx, i, i / 2), c = n + Zr(t.cy, o, o / 2), l = Zr(t.innerRadius, s, 0), u = Zr(t.outerRadius, s, s * 0.8), d = t.maxRadius || Math.sqrt(i * i + o * o) / 2;
  return {
    cx: a,
    cy: c,
    innerRadius: l,
...
Xe(Dt, "getComposedData", function(t) {
  ...
  if (k > 0) {
    ...
    O = i.map(function(E, N) {
      var I = Pe(E, b, 0), M = Pe(E, u, N), T = (Ne(I) ? I : 0) / k, P;
...
var To, cl;
function cg() {
  return cl || (cl = 1, To = lg()), To;
}
var ug = cg();
const dg = /* @__PURE__ */ Ms(ug);
var fg = ["key"];
function Ln(t) {
  "@babel/helpers - typeof";
...
function yg(t, e, n) {
  return e = Ni(e), bg(t, fu() ? Reflect.construct(e, n || [], Ni(t).constructor) : e.apply(t, n));
}
function bg(t, e) {
...
var Vr = /* @__PURE__ */ (function(t) {
  function e() {
    ...
    for (var r = arguments.length, i = new Array(r), o = 0; o < r; o++)
      i[o] = arguments[o];
    return n = yg(this, e, [].concat(i)), kt(n, "state", {
      isAnimationFinished: !1
  ...
  return wg(e, t), gg(e, [{
    ...
    value: function(r) {
      ...
      return /* @__PURE__ */ C.isValidElement(o) ? u = /* @__PURE__ */ C.cloneElement(o, Ee(Ee({}, this.props), {}, {
        points: r
      })) : ge(o) ? u = o(Ee(Ee({}, this.props), {}, {
        points: r
      })) : u = /* @__PURE__ */ C.createElement(iu, Ti({}, W(this.props, !0), {
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(Yi, {
        ...
        var h = f.t, p = d && d.length / o.length, m = o.map(function(y, b) {
          ...
          if (v) {
            var w = Oe(v.x, y.x), S = Oe(v.y, y.y);
            return Ee(Ee({}, y), {}, {
              x: w(h),
              y: S(h)
            });
          }
          var k = Oe(y.cx, y.x), O = Oe(y.cy, y.y);
          return Ee(Ee({}, y), {}, {
            x: k(h),
            y: O(h)
          });
...
kt(Vr, "getComposedData", function(t) {
  ...
  r.forEach(function(f, h) {
    var p = Pe(f, n.dataKey, h), m = Pe(f, i), y = n.scale(p) + u, b = Array.isArray(m) ? Sf(m) : m, v = he(b) ? void 0 : e.scale(b);
    Array.isArray(m) && m.length >= 2 && (c = !0), l.push(Ee(Ee({}, Me(s, a, v, y)), {}, {
      name: p,
      value: m,
      cx: s,
      cy: a,
  ...
  return c && l.forEach(function(f) {
    if (Array.isArray(f.value)) {
      var h = dg(f.value), p = he(h) ? void 0 : e.scale(h);
      d.push(Ee(Ee({}, f), {}, {
        radius: p
      }, Me(s, a, p, f.angle)));
    } else
...
var Sg = ["x1", "y1", "x2", "y2", "key"], kg = ["offset"];
function an(t) {
  "@babel/helpers - typeof";
...
function pu(t, e) {
  ...
  if (/* @__PURE__ */ C.isValidElement(t))
    ...
    var r = e.x1, i = e.y1, o = e.x2, s = e.y2, a = e.key, c = hl(e, Sg), l = W(c, !1);
    l.offset;
    var u = hl(l, kg);
...
var Mg = function(e, n) {
  ...
  return kc(Ac(me(me(me({}, Ec.defaultProps), r), {}, {
    ticks: Cc(r, !0),
    viewBox: {
      x: 0,
      y: 0,
...
function Yn(t) {
  var e, n, r, i, o, s, a = kf(), c = Af(), l = Cf(), u = me(me({}, t), {}, {
    ...
    x: Ne(t.x) ? t.x : l.left,
    y: Ne(t.y) ? t.y : l.top,
    width: Ne(t.width) ? t.width : l.width,
    height: Ne(t.height) ? t.height : l.height
  }), d = u.x, f = u.y, h = u.width, p = u.height, m = u.syncWithTicks, y = u.horizontalValues, b = u.verticalValues, v = Ef(), w = Of();
  if (!Ne(h) || h <= 0 || !Ne(p) || p <= 0 || !Ne(d) || d !== +d || !Ne(f) || f !== +f)
    return null;
  var S = u.verticalCoordinatesGenerator || Mg, k = u.horizontalCoordinatesGenerator || Ig, O = u.horizontalPoints, x = u.verticalPoints;
  if ((!O || !O.length) && ge(k)) {
  ...
  return /* @__PURE__ */ C.createElement("g", {
    ...
    height: u.height,
    ry: u.ry
  }), /* @__PURE__ */ C.createElement(Tg, Qt({}, u, {
    offset: l,
    horizontalPoints: O,
    xAxis: v,
    yAxis: w
  })), /* @__PURE__ */ C.createElement(Ng, Qt({}, u, {
    offset: l,
    verticalPoints: x,
    xAxis: v,
    yAxis: w
...
var Lg = ["type", "layout", "connectNulls", "ref"], Rg = ["key"];
function Rn(t) {
  "@babel/helpers - typeof";
...
function Wg(t, e, n) {
  return e = Pi(e), Ug(t, mu() ? Reflect.construct(e, n || [], Pi(t).constructor) : e.apply(t, n));
}
function Ug(t, e) {
...
var mn = /* @__PURE__ */ (function(t) {
  function e() {
    ...
    for (var r = arguments.length, i = new Array(r), o = 0; o < r; o++)
      i[o] = arguments[o];
    return n = Wg(this, e, [].concat(i)), et(n, "state", {
      isAnimationFinished: !0,
      totalLength: 0
  ...
  return Gg(e, t), Hg(e, [{
    ...
    value: function(r, i, o) {
      ...
      return /* @__PURE__ */ C.createElement(ie, pr({
    ...
    value: function(r, i, o, s) {
      ...
      a.ref;
      var d = pl(a, Lg), f = Fe(Fe(Fe({}, W(d, !0)), {}, {
        fill: "none",
      ...
      return /* @__PURE__ */ C.createElement(Rs, pr({}, f, {
      ...
      return /* @__PURE__ */ C.createElement(Yi, {
        ...
        if (v) {
          var O = v.length / a.length, x = a.map(function(T, P) {
            ...
            if (v[_]) {
              var D = v[_], $ = Oe(D.x, T.x), z = Oe(D.y, T.y);
              return Fe(Fe({}, T), {}, {
                x: $(k),
                y: z(k)
              });
    ...
    value: function() {
      ...
      if (o || !a || !a.length)
        return null;
      var b = this.state.isAnimationFinished, v = a.length === 1, w = _e("recharts-line", c), S = l && l.allowDataOverflow, k = u && u.allowDataOverflow, O = S || k, x = he(y) ? this.id : y, E = (r = W(s, !1)) !== null && r !== void 0 ? r : {
        r: 3,
        strokeWidth: 2
      }, N = E.r, I = N === void 0 ? 3 : N, M = E.strokeWidth, T = M === void 0 ? 2 : M, P = _f(s) ? s : {}, _ = P.clipDot, D = _ === void 0 ? !0 : _, $ = I * 2 + T;
      return /* @__PURE__ */ C.createElement(ie, {
        className: w
    ...
    value: function(r, i) {
      ...
      if (/* @__PURE__ */ C.isValidElement(r))
        ...
        var s = i.key, a = pl(i, Rg), c = _e("recharts-line-dot", typeof r != "boolean" ? r.className : "");
        o = /* @__PURE__ */ C.createElement(Ls, pr({
          key: s
        }, a, {
          className: c
        }));
...
function Zg(t, e, n) {
  return e = Di(e), Qg(t, yu() ? Reflect.construct(e, n || [], Di(t).constructor) : e.apply(t, n));
}
function Qg(t, e) {
...
var no = /* @__PURE__ */ (function(t) {
  function e() {
    return qg(this, e), Zg(this, e, arguments);
  }
  return ty(e, t), Jg(e, [{
    key: "render",
    value: function() {
...
function sy(t) {
  var e = t.option, n = t.isActive, r = iy(t, ry);
  return typeof e == "string" ? /* @__PURE__ */ C.createElement(Ho, mr({
    option: /* @__PURE__ */ C.createElement(Tf, mr({
      type: e
    }, r)),
    isActive: n,
    shapeType: "symbols"
  }, r)) : /* @__PURE__ */ C.createElement(Ho, mr({
    option: e,
    isActive: n,
    shapeType: "symbols"
  }, r));
...
function cy(t, e, n) {
  return e = Mi(e), uy(t, wu() ? Reflect.construct(e, n || [], Mi(t).constructor) : e.apply(t, n));
}
function uy(t, e) {
...
var Hr = /* @__PURE__ */ (function(t) {
  function e() {
    ...
    for (var r = arguments.length, i = new Array(r), o = 0; o < r; o++)
      i[o] = arguments[o];
    return n = cy(this, e, [].concat(i)), jt(n, "state", {
      isAnimationFinished: !1
  ...
  return fy(e, t), ly(e, [{
    ...
    value: function(r) {
      ...
      return r.map(function(u, d) {
        ...
        return /* @__PURE__ */ C.createElement(ie, gr({
          className: "recharts-scatter-symbol",
          key: "symbol-".concat(u?.cx, "-").concat(u?.cy, "-").concat(u?.size, "-").concat(d)
        }, Gi(i.props, u, d), {
          role: "img"
        }), /* @__PURE__ */ C.createElement(sy, gr({
          option: h,
          isActive: f,
          key: "symbol-".concat(d)
        }, p)));
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(Yi, {
        ...
        var h = f.t, p = o.map(function(m, y) {
          var b = d && d[y];
          if (b) {
            var v = Oe(b.cx, m.cx), w = Oe(b.cy, m.cy), S = Oe(b.size, m.size);
            return Ge(Ge({}, m), {}, {
              cx: v(h),
              cy: w(h),
              size: S(h)
    ...
    value: function() {
      ...
      if (s === "joint")
        ...
        var f = Nf(i), h = f.xmin, p = f.xmax, m = f.a, y = f.b, b = function(S) {
          return m * S + y;
        };
        u = [{
          x: h,
      ...
      return /* @__PURE__ */ C.isValidElement(o) ? d = /* @__PURE__ */ C.cloneElement(o, v) : ge(o) ? d = o(v) : d = /* @__PURE__ */ C.createElement(Rs, gr({}, v, {
        type: a
      })), /* @__PURE__ */ C.createElement(ie, {
    ...
    value: function() {
      ...
      if (i || !o || !o.length)
        return null;
      var y = this.state.isAnimationFinished, b = _e("recharts-scatter", a), v = c && c.allowDataOverflow, w = l && l.allowDataOverflow, S = v || w, k = he(p) ? this.id : p;
      return /* @__PURE__ */ C.createElement(ie, {
        className: b,
...
jt(Hr, "getComposedData", function(t) {
  var e = t.xAxis, n = t.yAxis, r = t.zAxis, i = t.item, o = t.displayedData, s = t.xAxisTicks, a = t.yAxisTicks, c = t.offset, l = i.props.tooltipType, u = Ji(i.props.children, js), d = he(e.dataKey) ? i.props.dataKey : e.dataKey, f = he(n.dataKey) ? i.props.dataKey : n.dataKey, h = r && r.dataKey, p = r ? r.range : no.defaultProps.range, m = p && p[0], y = e.scale.bandwidth ? e.scale.bandwidth() : 0, b = n.scale.bandwidth ? n.scale.bandwidth() : 0, v = o.map(function(w, S) {
    var k = Pe(w, d), O = Pe(w, f), x = !he(h) && Pe(w, h) || "-", E = [{
...
}), vy = { light: "", dark: ".dark" }, ku = U.createContext(null);
function Au() {
  const t = U.useContext(ku);
  if (!t)
...
const wy = ({
  ...
  const a = U.useId(), c = `chart-${t || a.replace(/:/g, "")}`, l = U.useRef(null), [u, d] = de(), f = Ps(() => new ResizeObserver(
  ...
  }, [f, s, l]), /* @__PURE__ */ g(ku.Provider, { value: { config: i }, children: /* @__PURE__ */ A(
    "div",
    {
      ...
      className: Y(
        ...
        r ? by({ aspect: r }) : "aspect-auto h-full",
        e
      ),
      ...o,
      children: [
        /* @__PURE__ */ g(xy, { id: c, config: i }),
        /* @__PURE__ */ g(
          Mf,
          {
            height: u,
...
const xy = ({ id: t, config: e }) => {
  const n = Object.entries(e).filter(([i, o]) => o.theme || o.color);
  if (!n.length)
    return null;
  const r = Object.entries(vy).map(
    ([i, o]) => `
${o} [data-chart=${t}] {
${n.map(([s, a]) => {
  ...
  return /* @__PURE__ */ g(
    "style",
    {
      dangerouslySetInnerHTML: {
        __html: If.sanitize(r.join(`
`))
      }
    }
  );
}, gn = Pf, Kt = U.forwardRef(
  ({
    active: t,
    payload: e,
    className: n,
...
function Xn(t, e = "12px Inter, sans-serif") {
...
const Sy = ({
  ...
  const { enabled: u } = Lf(), d = Object.keys(e), f = Ko(12), h = io(t), p = Math.max(
    ...h.flatMap(
      (w) => d.map(
        (S) => Xn(
      ...
      children: [
            ...
            "linearGradient",
            {
              ...
              children: [
                /* @__PURE__ */ g(
                  ...
                  {
                    offset: "5%",
                    stopColor: e[w].color ? ve(e[w].color) : we(S),
                    stopOpacity: 0.8
                  }
                ),
                /* @__PURE__ */ g(
        ...
        d.map((w, S) => /* @__PURE__ */ g(
          Tc,
          {
            ...
            stroke: e[w].color ? ve(e[w].color) : we(S),
            strokeWidth: 1.5,
      ...
      children: [
        ...
        p.map((b, v) => /* @__PURE__ */ g(
          $r,
          {
            ...
            fill: d ? ((w) => w.fill) : t[b].color ? ve(t[b].color) : we(v),
        ...
        l && /* @__PURE__ */ g(
          Wr,
          {
            content: /* @__PURE__ */ g(qn, { nameKey: "label" }),
            align: "center",
...
}, Ey = Mt(Cy), Oy = ({ data: t, legend: e = !0, hideTooltip: n = !1 }, r) => {
  ...
  return /* @__PURE__ */ A($f, { children: [
    /* @__PURE__ */ g("div", { className: "w-full", ref: r, children: /* @__PURE__ */ g("div", { className: "flex h-2 gap-1 overflow-hidden", children: t.map((o, s) => {
      const a = o.value / i * 100, c = o.color ? ve(o.color) : we(s), l = (u) => {
        const d = u / i * 100;
        return d % 1 === 0 ? d.toFixed(0) : d.toFixed(1);
      };
      return a === 0 ? null : /* @__PURE__ */ A(jf, { children: [
        /* @__PURE__ */ g(
          Ff,
          {
        ...
        !n && /* @__PURE__ */ A(zf, { className: "flex items-center gap-1 text-sm", children: [
          /* @__PURE__ */ g(
            "div",
            {
    ...
    e && /* @__PURE__ */ g(
      "div",
      {
        ...
        role: "list",
        children: t.map((o, s) => {
          const a = o.color ? ve(o.color) : we(s);
          return /* @__PURE__ */ A(
            "div",
            {
      ...
      children: [
        ...
        y.map((x, E) => /* @__PURE__ */ g(
          $r,
          {
            isAnimationActive: !1,
            dataKey: String(x),
            fill: t[x].color ? ve(t[x].color) : we(E),
            radius: 4,
            maxBarSize: 32,
            children: i && /* @__PURE__ */ g(
              hn,
        ...
        b.map((x, E) => /* @__PURE__ */ g(
          mn,
          {
            ...
            dataKey: String(x),
            stroke: t[x].color ? ve(t[x].color) : we(y.length + E),
            strokeWidth: 2,
            dot: d?.dot ?? !1,
            isAnimationActive: !1,
        ...
        v.map((x, E) => /* @__PURE__ */ g(
          ...
          {
            dataKey: String(x),
            fill: t[x].color ? ve(t[x].color) : we(
              y.length + b.length + E
            ),
            r: 4,
            isAnimationActive: !1,
      ...
      children: [
        ...
        l.map((f, h) => /* @__PURE__ */ g(
          mn,
          {
            ...
            isAnimationActive: !1,
            type: i,
            stroke: e[f].color ? ve(e[f].color) : we(h),
            strokeWidth: 1.5,
...
}, My = Mt(Dy), Iy = ({ data: t, dataConfig: e, overview: n, aspect: r, tickFormatter: i }, o) => {
  const s = t.map((l, u) => ({
    ...l,
    fill: e[l.label]?.color ? ve(e[l.label].color) : we(u)
  ...
  return c === 0 && s.push({
    ...
    Ut,
    {
      ...
      "data-chromatic": "ignore",
      style: { height: 380 },
      children: /* @__PURE__ */ A(my, { accessibilityLayer: !0, margin: { left: 0, right: 0 }, children: [
        c !== 0 && /* @__PURE__ */ g(
          gn,
          {
            isAnimationActive: !1,
        ...
        /* @__PURE__ */ g(
          Wr,
          {
            content: /* @__PURE__ */ g(qn, { nameKey: "label", hiddenKey: "-" }),
            align: "center",
            verticalAlign: "bottom",
            layout: "vertical",
            className: "flex-row items-start gap-4 pr-3 pt-2"
...
}, Ly = Mt(Iy), Ry = ({ value: t, max: e = 100, label: n, color: r }, i) => {
  const o = r ? ve(r) : ve("categorical-1"), s = t / e * 100;
...
const Fy = (t) => {
  ...
  const d = Object.keys(t), f = jy(e), h = Math.max(
    ...f.map((b) => Xn(`${b.x}`))
  ), p = d.reduce(
    (b, v) => (b[v] = e.reduce(
      (w, S) => w + S.values[v],
      ...
      children: [
        ...
        d.map((b, v) => /* @__PURE__ */ g(tn, { children: /* @__PURE__ */ g(
          $r,
          {
            ...
            layout: "vertical",
            dataKey: b,
            fill: t[b].color ? ve(t[b].color) : we(v),
            radius: 4,
            maxBarSize: 24,
  ...
  const { x: s = 0, y: a = 0, width: c = 0, height: l = 0 } = t, u = s + c + e, d = a + l / 2, f = r ? r(n) : n, h = Xn(`${f}`), p = i > 0 ? Math.round(Number(n) / i * 100) : 0;
  ...
  return /* @__PURE__ */ g(Nc, { dataTestId: o, children: /* @__PURE__ */ g(
    Ut,
    {
      ...
      aspect: i,
      "data-chromatic": "ignore",
      children: /* @__PURE__ */ A(gy, { accessibilityLayer: !0, data: c, children: [
        /* @__PURE__ */ g(
          gn,
          {
            cursor: !0,
        ...
        a.map((l, u) => /* @__PURE__ */ g(
          ...
          {
            dataKey: l,
            fill: e[l].color ? ve(e[l].color) : we(u),
            stroke: e[l].color ? ve(e[l].color) : we(u),
            strokeWidth: 1.5,
            fillOpacity: 0.3,
            label: e[l].label,
            isAnimationActive: !1
        ...
        Object.keys(e).length > 1 && /* @__PURE__ */ g(Wr, { iconType: "star", content: /* @__PURE__ */ g(qn, {}) })
      ] })
    }
  ) });
}, K1 = Mt(Hy), G1 = Re(
  Pt({ name: "AreaChart", type: "info" }, Ay)
), Y1 = Re(
  Pt({ name: "BarChart", type: "info" }, Ey)
), q1 = Re(
  Pt(
  ...
  Pt({ name: "LineChart", type: "info" }, My)
), J1 = Re(
  Pt({ name: "PieChart", type: "info" }, Ly)
), Z1 = Re(
  Pt(
  ...
  Pt({ name: "ProgressBarChart", type: "info" }, $y)
), eS = Re(
  Pt({ name: "ComboChart", type: "info" }, Py)
), No = [
  {
    id: "bottom",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ A(tn, { children: [
          a === "one-campaign" ? /* @__PURE__ */ g("div", { className: "relative flex h-8 w-8 shrink-0 items-center justify-center", children: /* @__PURE__ */ g(on, { icon: Uy, size: "lg", className: "!h-8 !w-8" }) }) : /* @__PURE__ */ g("div", { className: "relative flex h-8 w-8 shrink-0 items-center justify-center", children: /* @__PURE__ */ g(
            Hf,
            {
              module: c.module,
              size: "lg"
...
const tS = Re(Ky), nS = Wf, rS = {
  ...
  yesterday: {
    label: "Yesterday",
    granularity: "day",
    value: () => Ce.day.toRange(So(/* @__PURE__ */ new Date(), 1))
  },
  last7Days: {
    label: "Last 7 days",
    granularity: "day",
  ...
  lastWeek: {
    label: "Last week",
    granularity: "week",
    value: () => Ce.week.toRange(So(/* @__PURE__ */ new Date(), 7))
  },
  thisMonth: {
    label: "This month",
    granularity: "month",
  ...
  lastMonth: {
    label: "Last month",
    granularity: "month",
    value: () => Ce.month.toRange(or(/* @__PURE__ */ new Date(), 1))
  },
  last3Months: {
    label: "Last 3 months",
    granularity: "month",
    value: () => Ce.month.toRange(or(/* @__PURE__ */ new Date(), 3))
  },
  last6Months: {
    label: "Last 6 months",
    granularity: "month",
    value: () => Ce.month.toRange(or(/* @__PURE__ */ new Date(), 6))
  },
  thisQuarter: {
    label: "This quarter",
    granularity: "quarter",
  ...
  lastQuarter: {
    label: "Last quarter",
    granularity: "quarter",
    value: () => Ce.quarter.toRange(or(/* @__PURE__ */ new Date(), 3))
  },
  thisHalfYear: {
  ...
  lastHalfYear: {
    ...
    granularity: "halfyear",
    value: () => Ce.halfyear.toRange(or(/* @__PURE__ */ new Date(), 6))
  },
  lastYear: {
    label: "Last year",
    granularity: "year",
    value: () => Ce.year.toRange(Ga(/* @__PURE__ */ new Date(), 1))
  },
  last3Years: {
    label: "Last 3 years",
    granularity: "year",
    value: () => Ce.year.toRange(Ga(/* @__PURE__ */ new Date(), 3))
  }
}, Ii = (t, e) => e.view.domAtPos(t).node.offsetParent !== null, Gy = (t, e, n) => {
    ...
    return [
      ...
      new mt({
        ...
        appendTransaction: (t, e, n) => {
          ...
          if (!t.some((y) => y.selectionSet) || !e.selection.empty || !n.selection.empty || !Uf(n, i.name))
            return;
          const { $from: a } = n.selection;
          if (Ii(a.pos, r))
            return;
          const l = Gy(a, (y) => y.type === i, r);
          if (!l)
            return;
...
var re = class {
  ...
  static get(t) {
    return rs(t) || is(t, Jy(t));
  }
};
function Jy(t) {
  if (t.type.spec.tableRole != "table")
    throw new RangeError("Not a table node: " + t.type.name);
  const e = Zy(t), n = t.childCount, r = [];
  let i = 0, o = null;
  const s = [];
...
function Qy(t, e, n) {
  ...
  for (let i = 0; i < t.map.length; i++) {
    ...
    for (let l = 0; l < c.colspan; l++) {
      ...
      d != null && (!c.colwidth || c.colwidth[l] != d) && ((a || (a = eb(c)))[l] = d);
    }
...
function cb(t, e, n) {
  ...
  } else r instanceof nt && ab(r) ? o = nt.create(i, r.from) : r instanceof nt && lb(r) && (o = nt.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = t.tr)).setSelection(o), e;
}
var ub = new $e("fix-tables");
function Pu(t, e, n, r) {
...
function Du(t, e) {
  let n;
  const r = (i, o) => {
    i.type.spec.tableRole == "table" && (n = db(t, i, o, n));
  };
...
function db(t, e, n, r) {
  ...
  for (let c = 0, l = n + 1; c < i.height; c++) {
    ...
    if (f > 0) {
      ...
      const p = [];
      for (let y = 0; y < f; y++) {
        const b = Se(t.schema)[h].createAndFill();
        b && p.push(b);
      }
  ...
  return r.setMeta(ub, { fixTables: !0 });
}
function gt(t) {
...
function Mu(t, { map: e, tableStart: n, table: r }, i) {
  let o = i > 0 ? -1 : 0;
  ib(e, r, i + o) && (o = i == 0 || i == e.width ? null : 0);
...
function pb(t, { map: e, table: n, tableStart: r }, i) {
...
function mb(t, e) {
  ...
  if (e) {
    ...
    for (let i = n.right - 1; pb(r, n, i), i != n.left; i--) {
...
function Iu(t, { map: e, tableStart: n, table: r }, i) {
  ...
  const a = [];
  let c = i > 0 ? -1 : 0;
  gb(e, r, i + c) && (c = i == 0 || i == e.height ? null : 0);
...
function bb(t, e) {
  ...
  if (e) {
    const n = gt(t);
    e(Iu(t.tr, n, n.bottom));
  }
  return !0;
}
function vb(t, { map: e, table: n, tableStart: r }, i) {
  let o = 0;
...
function wb(t, e) {
  ...
  if (e) {
    ...
    for (let i = n.bottom - 1; vb(r, n, i), i != n.top; i--) {
      const o = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc;
      if (!o)
        throw RangeError("No table found");
...
function xb({ width: t, height: e, map: n }, r) {
...
function Sl(t, e) {
  const n = Se(t.schema);
  return Sb(({ node: r }) => n[r.type.spec.tableRole])(t, e);
}
function Sb(t) {
  return (e, n) => {
    var r;
    ...
    if (i instanceof J) {
      ...
      if (o = tb(i.$from), !o) return !1;
      s = (r = Jn(i.$from)) == null ? void 0 : r.pos;
    }
...
function Ab(t) {
  return function(e, n) {
    if (!ut(e)) return !1;
    if (n) {
      const r = Se(e.schema), i = gt(e), o = e.tr, s = i.map.cellsInRect(
        t == "column" ? {
          left: i.left,
          top: 0,
          right: i.right,
...
function Cr(t, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? Ab(t) : function(n, r) {
    if (!ut(n)) return !1;
    if (r) {
      const i = Se(n.schema), o = gt(n), s = n.tr, a = kl("row", o, i), c = kl(
        "column",
        o,
        i
...
function Al(t) {
  return function(e, n) {
    ...
    if (n) {
      ...
      n(
        e.tr.setSelection(nt.between(i, rb(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
function ss(t, e) {
  ...
  return new Gf(n).replace(0, n.content.size, e).doc;
}
function Nb({ width: t, height: e, rows: n }, r, i) {
  if (t != r) {
    const o = [], s = [];
...
function Ol(t, e, n, r, i) {
  ...
  Pb(d, s, o, n, l, u, f) && h(), Cl(d, s, o, n, c, l, a, f) && h(), Cl(d, s, o, n, c, l, u, f) && h(), El(d, s, o, n, a, u, c, f) && h(), El(d, s, o, n, a, u, l, f) && h();
  for (let p = a; p < u; p++) {
...
function Mb(t, e) {
  const n = t.state.doc, r = Jn(n.resolve(e));
...
function Ib(t, e, n) {
  ...
  if (i instanceof J) {
    ...
    return r = Nb(r, a.right - a.left, a.bottom - a.top), Ol(t.state, t.dispatch, s, a, r), !0;
  } else if (r) {
...
function Lb(t, e) {
  ...
  else if (e.shiftKey && r && (i = Jn(t.state.selection.$anchor)) != null && ((n = Po(t, e)) == null ? void 0 : n.pos) != i.pos)
...
function Po(t, e) {
  ...
  return n && n ? Jn(t.state.doc.resolve(n.pos)) : null;
}
var Rb = class {
  constructor(e, n) {
  ...
  const o = new mt({
    ...
    state: {
      init(s, a) {
        ...
        return r && u && (u[d] = (f, h) => new r(f, n, h)), new jb(-1, !1);
      },
      apply(s, a) {
        return a.apply(s);
      }
...
function Bb(t, e, n, r) {
  ...
  if (!s || s.activeHandle == -1 || s.dragging)
    return !1;
  const a = t.state.doc.nodeAt(s.activeHandle), c = Vb(t, s.activeHandle, a.attrs);
  t.dispatch(
...
function Vb(t, e, { colspan: n, colwidth: r }) {
...
function Tl(t, e, n, r) {
  ...
  if (!o) return -1;
  const { pos: s } = o, a = Jn(t.state.doc.resolve(s));
  if (!a) return -1;
...
function Wb(t, e, n) {
  ...
  for (let l = 0; l < o.height; l++) {
    ...
    const p = f.colwidth ? f.colwidth.slice() : Ub(f.colspan);
...
var ri = ({ editor: t }) => {
  ...
  if (!tv(e))
    return !1;
  let n = 0;
  const r = Xf(e.ranges[0].$from, (o) => o.type.name === "table");
...
function iv(t, e, n = {}) {
  var r;
  const i = (r = n.cellLineSeparator) != null ? r : nv;
  ...
  t.content.forEach((p) => {
    ...
    p.content && p.content.forEach((y) => {
      ...
      const v = rv(b), w = y.type === "tableHeader";
...
var ov = iv, sv = Qe.create({
  ...
  renderHTML({ node: t, HTMLAttributes: e }) {
    const { colgroup: n, tableWidth: r, tableMinWidth: i } = Zb(t, this.options.cellMinWidth), o = e.style;
    function s() {
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: t, dispatch: e }) => fb(t, e),
      addColumnAfter: () => ({ state: t, dispatch: e }) => hb(t, e),
      deleteColumn: () => ({ state: t, dispatch: e }) => mb(t, e),
      addRowBefore: () => ({ state: t, dispatch: e }) => yb(t, e),
      addRowAfter: () => ({ state: t, dispatch: e }) => bb(t, e),
      deleteRow: () => ({ state: t, dispatch: e }) => wb(t, e),
      deleteTable: () => ({ state: t, dispatch: e }) => Ob(t, e),
      mergeCells: () => ({ state: t, dispatch: e }) => xl(t, e),
      splitCell: () => ({ state: t, dispatch: e }) => Sl(t, e),
      toggleHeaderColumn: () => ({ state: t, dispatch: e }) => Cr("column")(t, e),
      toggleHeaderRow: () => ({ state: t, dispatch: e }) => Cr("row")(t, e),
      toggleHeaderCell: () => ({ state: t, dispatch: e }) => Cb(t, e),
      mergeOrSplit: () => ({ state: t, dispatch: e }) => xl(t, e) ? !0 : Sl(t, e),
      setCellAttribute: (t, e) => ({ state: n, dispatch: r }) => kb(t, e)(n, r),
  ...
  addExtensions() {
    const t = [];
    return this.options.table !== !1 && t.push(sv.configure(this.options.table)), this.options.tableCell !== !1 && t.push(Yb.configure(this.options.tableCell)), this.options.tableHeader !== !1 && t.push(qb.configure(this.options.tableHeader)), this.options.tableRow !== !1 && t.push(Xb.configure(this.options.tableRow)), t;
  }
});
const lv = av.configure({
  table: { resizable: !0 }
}), cv = Nt(function({ title: e, onClose: n, content: r, primaryAction: i, secondaryAction: o }, s) {
  return /* @__PURE__ */ A(
    "div",
    {
      ref: s,
        ...
        /* @__PURE__ */ A("div", { className: "flex flex-col gap-[1px]", children: [
          /* @__PURE__ */ g(
            "div",
            {
              ...
              children: /* @__PURE__ */ g(Jf, { content: r })
            }
          ),
  ...
  (t, e) => /* @__PURE__ */ g(cv, { ref: e, ...t })
), dv = ({ compact: t }) => /* @__PURE__ */ g(uv, { compact: t });
...
const ju = Lc(
...
] }), vv = ({ isEditable: t }) => t ? /* @__PURE__ */ A("div", { className: "flex flex-col gap-2", children: [
  /* @__PURE__ */ g(j, { className: "h-4 w-1/2 rounded-md" }),
  /* @__PURE__ */ g(j, { className: "h-4 w-full rounded-md" }),
  /* @__PURE__ */ g(j, { className: "h-4 w-3/4 rounded-md" }),
  /* @__PURE__ */ g(j, { className: "h-4 w-1/3 rounded-md" })
] }) : /* @__PURE__ */ g(ju.Skeleton, { compact: !0 }), wv = ({
  node: t,
  updateAttributes: e,
  deleteNode: n,
  extension: r,
  ...
  const s = t.attrs.data, a = r.options.currentConfig || t.attrs.config, { title: c } = hv(a, s), { isLoading: l, handleClick: u } = pv(
    a,
    e
  ), d = !!(s?.selectedAction && !s?.content), f = l || d, h = fv(s);
  if (yv(i, n, o, s), mv(a, e, s), gv(s, u, e), !s || !a || !a.buttons?.length) return null;
  const p = !!s?.content, y = !!(s?.selectedTitle || s?.selectedAction) && p && !s?.isEditable;
  return /* @__PURE__ */ g(Fr, { contentEditable: !1, children: /* @__PURE__ */ A("div", { className: "mb-3", children: [
    f ? /* @__PURE__ */ g(vv, { isEditable: s?.isEditable }) : y ? /* @__PURE__ */ g(
      ju,
      {
        title: c,
        content: h,
  ...
  "table",
  "details"
], kv = new Set(Fu), Fn = (t) => t ? kv.has(t) : !1, zu = (t) => t ? Fn(t.type) && !t.attrs?.id ? !0 : t.content?.some(zu) ?? !1 : !1, Bu = (t) => {
  if (!t)
    return !1;
  ...
  for (let e = 0; e < t.childCount; e += 1)
    if (Bu(t.child(e)))
      return !0;
  return !1;
}, Il = (t) => t ? t instanceof eh ? Bu(t) : zu(t) : !1, Av = pn.create({
  name: "blockId",
  addGlobalAttributes() {
    return [
      {
...
var Ev = ({ key: t, editor: e, onPaste: n, onDrop: r, allowedMimeTypes: i }) => new mt({
...
const _v = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/, Tv = Qe.create({
  ...
  const { src: o, alt: s, title: a, uploading: c, width: l } = t.attrs, u = r.isEditable, d = Un(), [f, h] = de(!1), p = Ye(
    (m) => {
  ...
  return /* @__PURE__ */ g(Fr, { className: "mb-2", children: /* @__PURE__ */ A(
    "div",
    {
      style: { width: `${l ?? en}%` },
      className: Y(
      ...
      children: [
        ...
        c && /* @__PURE__ */ g("div", { className: "absolute inset-0 flex items-center justify-center rounded-lg bg-f1-background-secondary backdrop-blur-[2px] transition-opacity duration-200", children: /* @__PURE__ */ g(nh, { size: "medium" }) }),
  ...
  const i = n.maxFileSize ?? Nv, { onError: o } = n;
  ...
  const a = Un(), [c, l] = de(!o);
  return /* @__PURE__ */ g("div", { className: "relative h-10 w-10", children: /* @__PURE__ */ g(rh, { mode: "popLayout", initial: !!c, children: c ? /* @__PURE__ */ g(
    Qr.div,
    {
...
Lv.displayName = "PulseAvatar";
const Rv = ({
  node: t,
  deleteNode: e,
  updateAttributes: n
}) => {
  const r = Un(), [i, o] = de(t.attrs.isOpen ?? !1), s = t.attrs.data;
  if (!s) return null;
  const a = () => {
    const l = !i;
    o(l), n({ isOpen: l });
  ...
  return /* @__PURE__ */ A(Fr, { contentEditable: !1, children: [
    /* @__PURE__ */ A(
      "div",
      {
...
}), jv = $v, Fv = /(?:https?:\/\/)?(?:www\.)?(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([a-zA-Z0-9_-]+)/, zv = /(?:https?:\/\/)?(?:www\.)?(?:vimeo\.com\/|player\.vimeo\.com\/video\/)(\d+)/, Bv = /^(?:https?:\/\/)?(?:www\.)?(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([a-zA-Z0-9_-]+)(?:\S*)$/gm, Vv = /^(?:https?:\/\/)?(?:www\.)?(?:vimeo\.com\/|player\.vimeo\.com\/video\/)(\d+)(?:\S*)$/gm;
function mi(t) {
  const e = t.match(Fv);
  if (e)
    return {
...
const Hv = ({
  ...
  ({ items: t, groups: e, command: n }, r) => {
    const [i, o] = de(0), s = At(null), a = At(null), c = e || [{ title: "", commands: t }], l = c.flatMap((y) => y.commands), u = Ye(
      (y) => {
        const b = l[y];
        b && n(b);
      },
...
`],
  ...
  addProseMirrorPlugins() {
    return [
      Ah({
        ...
        items: ({ query: r }) => {
          const i = r.toLowerCase().trim(), o = Uv({
            translations: e,
            aiBlockConfig: t,
            imageUploadConfig: n
          }).filter((s) => {
...
}), qv = Yv, st = () => /* @__PURE__ */ new Map(), hs = (t) => {
  const e = st();
  ...
  for (const [n, r] of t)
    if (e(r, n))
      return !0;
  return !1;
}, cn = () => /* @__PURE__ */ new Set(), Do = (t) => t[t.length - 1], Zv = (t, e) => {
  for (let n = 0; n < e.length; n++)
    t.push(e[n]);
}, un = Array.from, Qv = (t, e) => {
...
const Tt = Math.floor, gi = Math.abs, zn = (t, e) => t < e ? t : e, zt = (t, e) => t > e ? t : e, Uu = (t) => t !== 0 ? t < 0 : 1 / t < 0, Ll = 1, Rl = 2, Mo = 4, Io = 8, Er = 32, Ct = 64, Te = 128, e0 = 1 << 29, so = 31, ms = 63, rn = 127, t0 = 2147483647, Ku = Number.MAX_SAFE_INTEGER, n0 = Number.isInteger || ((t) => typeof t == "number" && isFinite(t) && Tt(t) === t), r0 = String.fromCharCode, i0 = (t) => t.toLowerCase(), o0 = /^\s*/g, s0 = (t) => t.replace(o0, ""), a0 = /([A-Z])/g, $l = (t, e) => s0(t.replace(a0, (n) => `${e}${i0(n)}`)), l0 = (t) => {
...
), c0 = (t) => Or.encode(t), u0 = Or ? c0 : l0;
let yr = typeof TextDecoder > "u" ? null : new TextDecoder("utf-8", { fatal: !0, ignoreBOM: !0 });
yr && yr.decode(new Uint8Array()).length === 1 && (yr = null);
class Gr {
  constructor() {
    this.cpos = 0, this.cbuf = new Uint8Array(100), this.bufs = [];
  }
}
const Yr = () => new Gr(), d0 = (t) => {
  const e = Yr();
  return t(e), rt(e);
}, f0 = (t) => {
  let e = t.cpos;
  ...
  for (; e > rn; )
    ue(t, Te | rn & e), e = Tt(e / 128);
  ue(t, rn & e);
}, ea = (t, e) => {
  const n = Uu(e);
  for (n && (e = -e), ue(t, (e > ms ? Te : 0) | (n ? Ct : 0) | ms & e), e = Tt(e / 64); e > 0; )
    ue(t, (e > rn ? Te : 0) | rn & e), e = Tt(e / 128);
}, ys = new Uint8Array(3e4), p0 = ys.length / 3, m0 = (t, e) => {
  if (e.length < p0) {
    const n = Or.encodeInto(e, ys).written || 0;
    H(t, n);
    for (let r = 0; r < n; r++)
      ue(t, ys[r]);
  } else
...
Or.encodeInto ? m0 : g0, ao = (t, e) => {
  ...
  return t.cpos += e, n;
}, y0 = (t, e) => ta(t, 4).setFloat32(0, e, !1), b0 = (t, e) => ta(t, 8).setFloat64(0, e, !1), v0 = (t, e) => (
  /** @type {any} */
  ta(t, 8).setBigInt64(0, e, !1)
), jl = new DataView(new ArrayBuffer(4)), w0 = (t) => (jl.setFloat32(0, t), jl.getFloat32(0) === t), Bn = (t, e) => {
  switch (typeof e) {
    case "string":
      ue(t, 119), Cn(t, e);
      break;
    case "number":
      n0(e) && gi(e) <= t0 ? (ue(t, 125), ea(t, e)) : w0(e) ? (ue(t, 124), y0(t, e)) : (ue(t, 123), b0(t, e));
      break;
    case "bigint":
      ue(t, 122), v0(t, e);
      break;
...
class yi {
   ...
   */
  toUint8Array() {
    return zl(this), rt(this.encoder);
  }
}
const Bl = (t) => {
  if (t.count > 0) {
...
}, Gu = Bt("Unexpected end of array"), Yu = Bt("Integer out of Range");
class lo {
  /**
...
const na = (t) => new lo(t), S0 = (t) => t.pos !== t.arr.length, k0 = (t, e) => {
  const n = new Uint8Array(t.arr.buffer, t.pos + t.arr.byteOffset, e);
  return t.pos += e, n;
}, Ke = (t) => k0(t, Z(t)), _r = (t) => t.arr[t.pos++], Z = (t) => {
  let e = 0, n = 1;
  ...
  if (e === 0)
    return "";
  {
    let n = String.fromCodePoint(_r(t));
    if (--e < 100)
      for (; e--; )
        n += String.fromCodePoint(_r(t));
    else
      for (; e > 0; ) {
  ...
  return t.pos += e, n;
}, E0 = (t) => ia(t, 4).getFloat32(0, !1), O0 = (t) => ia(t, 8).getFloat64(0, !1), _0 = (t) => (
  /** @type {any} */
...
class Vl extends lo {
  ...
  read() {
    return this.count === 0 && (this.s = this.reader(this), S0(this) ? this.count = Z(this) + 1 : this.count = -1), this.count--, /** @type {T} */
    this.s;
  }
}
class bi extends lo {
...
const P0 = crypto.getRandomValues.bind(crypto), D0 = Math.random, qu = () => P0(new Uint32Array(1))[0], M0 = (t) => t[Tt(D0() * t.length)], I0 = "10000000-1000-4000-8000" + -1e11, L0 = () => I0.replace(
  /[018]/g,
  /** @param {number} c */
...
let Xu = new $0(), j0 = !0;
try {
  typeof localStorage < "u" && localStorage && (Xu = localStorage, j0 = !1);
} catch {
}
const F0 = Xu, z0 = Object.assign, Ju = Object.keys, B0 = (t, e) => {
  for (const n in t)
    e(t[n], n);
}, Ul = (t) => Ju(t).length, V0 = (t) => {
  for (const e in t)
    return !1;
  return !0;
}, Zu = (t, e) => {
  for (const n in t)
    if (!e(t[n], n))
      return !1;
  return !0;
}, H0 = (t, e) => Object.prototype.hasOwnProperty.call(t, e), W0 = (t, e) => t === e || Ul(t) === Ul(e) && Zu(t, (n, r) => (n !== void 0 || H0(e, r)) && e[r] === n), U0 = Object.freeze, Qu = (t) => {
  for (const e in t) {
    const n = t[e];
...
}, K0 = (t, e) => e.includes(t), Vn = typeof process < "u" && process.release && /node|io\.js/.test(process.release.name) && Object.prototype.toString.call(typeof process < "u" ? process : 0) === "[object process]", ed = typeof window < "u" && typeof document < "u" && !Vn;
let ht;
const G0 = () => {
  if (ht === void 0)
    if (Vn) {
      ...
      if (t.length !== 0) {
        const [e, n] = t.split("=");
        ht.set(`--${$l(e, "-")}`, n), ht.set(`-${$l(e, "-")}`, n);
      }
    })) : ht = st();
  return ht;
}, vs = (t) => G0().has(t), Ri = (t) => Wl(Vn ? process.env[t.toUpperCase().replaceAll("-", "_")] : F0.getItem(t)), td = (t) => vs("--" + t) || Ri(t) !== null;
td("production");
const Y0 = Vn && K0(process.env.FORCE_COLOR, ["true", "1", "2"]), q0 = Y0 || !vs("--no-colors") && // @todo deprecate --no-colors
!td("no-color") && (!Vn || process.stdout.isTTY) && (!Vn || vs("--color") || Ri("COLORTERM") !== null || (Ri("TERM") || "").includes("color")), X0 = (t) => {
  let e = "";
  for (let n = 0; n < t.byteLength; n++)
    e += r0(t[n]);
  return btoa(e);
}, J0 = (t) => Buffer.from(t.buffer, t.byteOffset, t.byteLength).toString("base64"), Z0 = ed ? X0 : J0, Q0 = (t) => d0((e) => Bn(e, t));
class ew {
  /**
   * @param {L} left
   * @param {R} right
...
const wt = (t, e) => new ew(t, e), tw = (
  /** @type {Document} */
  typeof document < "u" ? document : {}
);
typeof DOMParser < "u" && new DOMParser();
const nw = (t) => Xv(t, (e, n) => `${n}:${e};`).join(""), rw = (t) => class {
  /**
...
}, iw = rw(clearTimeout), nd = (t, e) => new iw(setTimeout(e, t)), Lt = Symbol, rd = Lt(), id = Lt(), ow = Lt(), sw = Lt(), aw = Lt(), od = Lt(), lw = Lt(), sa = Lt(), cw = Lt(), uw = (t) => {
  ...
  [rd]: wt("font-weight", "bold"),
  [id]: wt("font-weight", "normal"),
  [ow]: wt("color", "blue"),
  [aw]: wt("color", "green"),
  [sw]: wt("color", "grey"),
  [od]: wt("color", "red"),
...
const Vt = (t, e, n) => e.clients.forEach((r, i) => {
  ...
  return n !== void 0 && mw(n, e.clock) !== null;
}, la = (t) => {
  t.clients.forEach((e) => {
  ...
  const e = new Zn(), n = Z(t.restDecoder);
  for (let r = 0; r < n; r++) {
    t.resetDsCurVal();
  ...
  const r = new Zn(), i = Z(t.restDecoder);
  for (let o = 0; o < i; o++) {
    t.resetDsCurVal();
...
class yn extends Wu {
   ...
   */
  constructor({ guid: e = L0(), collectionid: n = null, gc: r = !0, gcFilter: i = () => !0, meta: o = null, autoLoad: s = !1, shouldLoad: a = !0 } = {}) {
  ...
  destroy() {
    ...
    if (e !== null) {
      ...
      n.doc = new yn({ guid: this.guid, ...n.opts, shouldLoad: !1 }), n.doc._item = e, G(
        /** @type {any} */
        e.parent.doc,
        (r) => {
          const i = n.doc;
...
class xw {
   ...
   */
  writeDsLen(e) {
    e === 0 && Le(), H(this.restEncoder, e - 1), this.dsCurrVal += e;
  }
}
class co extends xw {
  constructor() {
    super(), this.keyMap = /* @__PURE__ */ new Map(), this.keyClock = 0, this.keyClockEncoder = new Lo(), this.clientEncoder = new yi(), this.leftClockEncoder = new Lo(), this.rightClockEncoder = new Lo(), this.infoEncoder = new Fl(gs), this.stringEncoder = new x0(), this.parentInfoEncoder = new Fl(gs), this.typeRefEncoder = new yi(), this.lenEncoder = new yi();
  }
  toUint8Array() {
    const e = Yr();
...
const Sw = (t, e, n, r) => {
  ...
  if (a.clients.size > 0) {
    const h = new co();
    return fd(h, a, /* @__PURE__ */ new Map()), H(h.restEncoder, 0), { missing: c, update: h.toUint8Array() };
  }
  return null;
}, Cw = (t, e) => fd(t, e.doc.store, e.beforeState), Ew = (t, e, n, r = new $i(t)) => G(e, (i) => {
  i.local = !1;
  let o = !1;
  const s = i.doc, a = s.store, c = kw(r, s), l = Aw(i, a, c), u = a.pendingStructs;
  if (u) {
...
const Gl = () => new Ow(), Yl = (t, e) => t.l.push(e), ql = (t, e) => {
...
const ii = (t, e) => t === e || t !== null && e !== null && t.client === e.client && t.clock === e.clock, F = (t, e) => new En(t, e), Nr = (t) => {
...
const Tw = (t, e, n = 0) => new _w(t, e, n), oi = (t, e, n) => {
  let r = null, i = null;
  return t._item === null ? i = Nr(t) : r = F(t._item.id.client, t._item.id.clock), new ji(r, i, e, n);
}, jo = (t, e, n = 0) => {
  let r = t._start;
  if (n < 0) {
    if (e === 0)
  ...
  if (i !== null) {
    if (oe(r, i.client) <= i.clock)
      return null;
    const u = n ? Cs(r, i) : Nw(r, i), d = u.item;
    if (!(d instanceof K))
      return null;
...
const pd = (t, e) => new ua(t, e), Fo = (t) => pd(gw(t.store), uo(t.store)), Zt = (t, e) => e === void 0 ? !t.deleted : e.sv.has(t.id.client) && (e.sv.get(t.id.client) || 0) > t.id.clock && !Qn(e.ds, t.id), Ss = (t, e) => {
...
class Iw {
   ...
   */
  constructor(e, n, r) {
    this.doc = e, this.deleteSet = new Zn(), this.beforeState = uo(e.store), this.afterState = /* @__PURE__ */ new Map(), this.changed = /* @__PURE__ */ new Map(), this.changedParentTypes = /* @__PURE__ */ new Map(), this._mergeStructs = [], this.origin = n, this.meta = /* @__PURE__ */ new Map(), this.local = r, this.subdocsAdded = /* @__PURE__ */ new Set(), this.subdocsRemoved = /* @__PURE__ */ new Set(), this.subdocsLoaded = /* @__PURE__ */ new Set(), this._needFormattingCleanup = !1;
  }
}
const Jl = (t, e) => e.deleteSet.clients.size === 0 && !Jv(e.afterState, (n, r) => e.beforeState.get(r) !== n) ? !1 : (la(e.deleteSet), Cw(t, e), ca(t, e.deleteSet), !0), Zl = (t, e, n) => {
  const r = e._item;
  ...
  if (e < t.length) {
    ...
    try {
      ...
      }), a.push(() => r.emit("afterTransaction", [n, r])), oa(a, []), n._needFormattingCleanup && nx(n);
    } finally {
      r.gc && Lw(o, i, r.gcFilter), Rw(o, i), n.afterState.forEach((u, d) => {
      ...
      if (!n.local && n.afterState.get(r.clientID) !== n.beforeState.get(r.clientID) && (hw(sa, rd, "[yjs] ", id, od, "Changed the client-id because another client seems to be using it."), r.clientID = dd()), r.emit("afterTransactionCleanup", [n, r]), r._observers.has("update")) {
        const u = new ww();
  ...
  let o = !1, s = null;
  t._transaction === null && (o = !0, t._transaction = new Iw(t, n, r), i.push(t._transaction), i.length === 1 && t.emit("beforeAllTransactions", [t]), t.emit("beforeTransaction", [t._transaction, t]));
  try {
    s = e(t._transaction);
  } finally {
    if (o) {
...
const Ql = (t, e, n) => {
  Vt(t, n.deletions, (r) => {
    r instanceof K && e.scope.some((i) => i === t.doc || Pr(
      ...
      Vt(a, l.insertions, (h) => {
        if (h instanceof K) {
          if (h.redone !== null) {
            ...
            m > 0 && (p = De(a, F(p.id.client, p.id.clock + m))), h = p;
          }
          !h.deleted && o.some((p) => p === a.doc || Pr(
            /** @type {AbstractType<any>} */
            p,
            /** @type {Item} */
            h
        ...
        h instanceof K && o.some((p) => p === a.doc || Pr(
          /** @type {AbstractType<any>} */
          p,
          h
        )) && // Never redo structs in stackItem.insertions because they were created and deleted in the same capture interval.
        !Qn(l.insertions, h.id) && u.add(h);
      }), u.forEach((h) => {
...
class vd extends Wu {
  ...
  constructor(e, {
    ...
    super(), this.scope = [], this.doc = a, this.addToScope(e), this.deleteFilter = i, o.add(this), this.trackedOrigins = o, this.captureTransaction = r, this.undoStack = [], this.redoStack = [], this.undoing = !1, this.redoing = !1, this.currStackItem = null, this.lastChange = 0, this.ignoreRemoteMapChanges = s, this.captureTimeout = n, this.afterTransactionHandler = (c) => {
      ...
      if (this.lastChange > 0 && h - this.lastChange < this.captureTimeout && d.length > 0 && !l && !u) {
        ...
        d.push(new $w(c.deleteSet, f)), p = !0;
      !l && !u && (this.lastChange = h), Vt(
        c,
        c.deleteSet,
        /** @param {Item|GC} item */
        (y) => {
          y instanceof K && this.scope.some((b) => b === c.doc || Pr(
            /** @type {AbstractType<any>} */
            b,
            y
          )) && ma(y, !0);
  ...
  addToScope(e) {
    ...
    e = ps(e) ? e : [e], e.forEach((r) => {
      n.has(r) || (n.add(r), (r instanceof fe ? r.doc !== this.doc : r !== this.doc) && ad("[yjs#509] Not same Y.Doc"), this.scope.push(r));
    });
  }
  /**
   * @param {any} origin
...
class Fw {
   ...
   */
  constructor(e, n) {
    this.gen = jw(e), this.curr = null, this.done = !1, this.filterSkips = n, this.next();
  }
  /**
...
const Bw = (t, e) => {
  ...
  let i = r.map((u) => new Fw(u, !0)), o = null;
  const s = new n(), a = new zw(s);
  for (; i = i.filter((f) => f.curr !== null), i.sort(
    ...
    if (o !== null) {
      ...
      if (d !== o.struct.id.client)
        ...
        p > 0 && (o.struct.constructor === tt ? o.struct.length -= p : f = Bw(f, p)), o.struct.mergeWith(
          /** @type {any} */
          f
        ) || (sr(a, o.struct, o.offset), o = { struct: f, offset: 0 }, u.next());
      }
  ...
  o !== null && (sr(a, o.struct, o.offset), o = null), Vw(a);
  const c = r.map((u) => yw(u)), l = ws(c);
  ...
  t.written > 0 && t.currClient !== e.id.client && wd(t), t.written === 0 && (t.currClient = e.id.client, t.encoder.writeClient(e.id.client), H(t.encoder.restEncoder, e.id.clock + n)), e.write(t.encoder, n), t.written++;
}, Vw = (t) => {
  wd(t);
...
class fo {
   ...
   */
  get path() {
    return this._path || (this._path = Hw(this.currentTarget, this.target));
  }
  /**
...
const Uw = (t) => {
  ...
  let r = t._start, i = 0;
  for (n !== null && (r = n.p, i = n.index, Uw(n)); r.right !== null && i < e; ) {
    if (!r.deleted && r.countable) {
      if (e < i + r.length)
        break;
      i += r.length;
  ...
  r.parent.length / xd ? (Sd(n, r, i), n) : Kw(t._searchMarker, r, i);
}, Dr = (t, e, n) => {
...
const kd = (t, e, n) => {
...
}, _d = () => Bt("Length exceeded!"), Td = (t, e, n, r) => {
  if (n > e._length)
    throw _d();
  if (n === 0)
    return e._searchMarker && Dr(e._searchMarker, n, r.length), Fi(t, e, null, r);
  const i = n, o = ho(e, n);
  let s = e._start;
  ...
  return e._searchMarker && Dr(e._searchMarker, i, r.length), Fi(t, e, s, r);
}, Yw = (t, e, n) => {
...
class _n extends fe {
   ...
   */
  _callObserver(e, n) {
    super._callObserver(e, n), po(this, e, new Xw(this, e));
  }
  /**
...
const Qw = (t) => new Hn(), Ft = (t, e) => t === e || typeof t == "object" && typeof e == "object" && t && e && W0(t, e);
class As {
  /**
   ...
   */
  forward() {
    this.right === null && Le(), this.right.content.constructor === le ? this.right.deleted || er(
...
const rc = (t, e, n) => {
  for (; e.right !== null && n > 0; )
    e.right.content.constructor === le ? e.right.deleted || er(
      e.currentAttributes,
      /** @type {ContentFormat} */
      e.right.content
  ...
  Id(n, i);
  const a = Ld(t, e, n, i), c = r.constructor === String ? new ct(
    /** @type {string} */
    r
  ) : r instanceof fe ? new dt(r) : new bn(r);
  let { left: l, right: u, index: d } = n;
  e._searchMarker && Dr(e._searchMarker, n.index, c.getLength()), u = new K(F(s, oe(o.store, s)), l, l && l.lastId, u, u && u.id, e, null, c), u.integrate(t, 0), n.right = u, n.index = d, n.forward(), Md(t, e, n, a);
}, ic = (t, e, n, r, i) => {
  const o = t.doc, s = o.clientID;
  Id(n, i);
  const a = Ld(t, e, n, i);
...
`;
  ...
  for (; e !== o; ) {
    if (n === e && (c = !0), !e.deleted) {
      ...
      if (l.constructor === le) {
        ...
        (s.get(u) !== l || f === d) && (e.delete(t), a++, !c && (i.get(u) ?? null) === d && f !== d && (f === null ? i.delete(u) : i.set(u, f))), !c && !e.deleted && er(
          i,
          /** @type {ContentFormat} */
          l
        );
  ...
  return G(
    ...
    (n) => {
      ...
      const s = hs(o);
      for (; i; )
        i.deleted === !1 && (i.content.constructor === le ? er(
          s,
          /** @type {ContentFormat} */
          i.content
        ) : (e += Rd(n, r, i, o, s), o = hs(s), r = i)), i = i.right;
    }
  ), e;
}, nx = (t) => {
  ...
  G(n, (r) => {
    Vt(t, t.deleteSet, (i) => {
      ...
      i.content.constructor === le ? e.add(o) : ex(r, i);
    });
    for (const i of e)
      tx(i);
  });
  ...
  return s._searchMarker && Dr(s._searchMarker, e.index, -r + n), e;
};
class rx extends fo {
  /**
   * @param {YText} ytext
          ...
          if (a !== null) {
            ...
            switch (a) {
              ...
              case "insert":
                ...
                break;
              case "retain":
                u > 0 && (h = { retain: u }, V0(c) || (h.attributes = z0({}, c))), u = 0;
                break;
            }
            h && n.push(h), a = null;
          }
...
class be extends dn {
   ...
   */
  _write(e) {
    e.writeTypeRef(Ax), e.writeKey(this.nodeName);
  }
}
const sx = (t) => new be(t.readKey());
class ax extends fo {
  /**
...
class Bi extends Hn {
   ...
   */
  _write(e) {
    e.writeTypeRef(Ex), e.writeKey(this.hookName);
  }
}
const lx = (t) => new Bi(t.readKey());
class Ie extends Ht {
  /**
   * @type {YXmlElement|YXmlText|null}
   */
...
class Je extends pa {
   ...
   */
  write(e, n) {
    e.writeInfo(ux), e.writeLen(this.length - n);
  }
  /**
   * @param {Transaction} transaction
...
const fx = (t) => new Ir(t.readLen()), $d = (t, e) => new yn({ guid: t, ...e, shouldLoad: e.shouldLoad || e.autoLoad || !1 });
class Xr {
  /**
   * @param {Doc} doc
   */
   ...
   */
  copy() {
    return new Xr($d(this.doc.guid, this.opts));
  }
  /**
   * @param {number} offset
   * @return {ContentDoc}
...
const hx = (t) => new Xr($d(t.readString(), t.readAny()));
class bn {
  /**
   * @param {Object} embed
   */
...
const mx = (t) => new le(t.readKey(), t.readJSON());
class Vi {
  /**
   * @param {Array<any>} arr
   */
...
const vx = (t) => new ct(t.readString()), wx = [
  Jw,
  Qw,
  ix,
  sx,
  ...
  lx,
  cx
], xx = 0, Sx = 1, kx = 2, Ax = 3, Cx = 4, Ex = 5, Ox = 6;
class dt {
  /**
   * @param {AbstractType<any>} type
   */
...
const _x = (t) => new dt(wx[t.readTypeRef()](t)), Cs = (t, e) => {
  let n = e, r = 0, i;
  do
  ...
  if (e.parentSub === null) {
    for (d = e.left, f = e; d !== null; ) {
      ...
      b.parent._item !== u; )
        b = b.redone === null ? null : De(t, b.redone);
    ...
    for (d = e; d !== null && d.right !== null && (d.right.redone || Qn(r, d.right.id) || sc(o.undoStack, d.right.id) || sc(o.redoStack, d.right.id)); )
...
class K extends pa {
  ...
  getMissing(e, n) {
    ...
    if (this.origin && (this.left = Xl(e, n, this.origin), this.origin = this.left.lastId), this.rightOrigin && (this.right = De(e, this.rightOrigin), this.rightOrigin = this.right.id), this.left && this.left.constructor === Je || this.right && this.right.constructor === Je)
      this.parent = null;
    else if (!this.parent)
  ...
  delete(e) {
    if (!this.deleted) {
      ...
      this.countable && this.parentSub === null && (n._length -= this.length), this.markDeleted(), Tr(e.deleteSet, this.id.client, this.id.clock, this.length), Zl(e, n, this.parentSub), this.content.delete(e);
    }
  }
  /**
   * @param {StructStore} store
  ...
  gc(e, n) {
    if (!this.deleted)
      throw Le();
    this.content.gc(e), n ? Mw(e, this, new Je(this.id, this.length)) : this.content = new Ir(this.length);
  }
  /**
   * Transform the properties of this type to binary and write it to an
   * BinaryEncoder.
  ...
  write(e, n) {
    ...
    if (e.writeInfo(s), r !== null && e.writeLeftID(r), i !== null && e.writeRightID(i), r === null && i === null) {
      ...
      } else a.constructor === String ? (e.writeParentInfo(!0), e.writeString(a)) : a.constructor === En ? (e.writeParentInfo(!1), e.writeLeftID(a)) : Le();
      o !== null && e.writeString(o);
    }
    this.content.write(e, n);
  }
}
const Fd = (t, e) => Tx[e & so](t), Tx = [
  () => {
    Le();
  },
...
class tt extends pa {
   ...
   */
  write(e, n) {
    e.writeInfo(Nx), H(e.restEncoder, this.length - n);
  }
  /**
   * @param {Transaction} transaction
   * @param {StructStore} store
...
const Px = () => {
  ...
  for (; n < t.length && n < e.length && t[n] === e[n]; )
    n++;
  for (n > 0 && Dx.test(t[n - 1]) && n--; r + n < t.length && r + n < e.length && t[t.length - r - 1] === e[e.length - r - 1]; )
    r++;
  return r > 0 && Mx.test(t[t.length - r]) && r--, {
    index: n,
    remove: t.length - n - r,
    insert: e.slice(n, e.length - r)
  };
}, Lx = Ix, ne = new $e("y-sync"), Et = new $e("y-undo");
new $e("yjs-cursor");
const pt = (t, e) => t >>> e | t << 32 - e, Rx = (t) => pt(t, 2) ^ pt(t, 13) ^ pt(t, 22), $x = (t) => pt(t, 6) ^ pt(t, 11) ^ pt(t, 25), jx = (t) => pt(t, 7) ^ pt(t, 18) ^ t >>> 3, Fx = (t) => pt(t, 17) ^ pt(t, 19) ^ t >>> 10, zx = new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
class Vx {
  constructor() {
    ...
    this._H = new Uint32Array(e, 0, 8), this._H.set(Bx), this._W = new Uint32Array(e, 64, 64);
  }
  _updateHash() {
    const e = this._H, n = this._W;
    for (let d = 16; d < 64; d++)
      n[d] = Fx(n[d - 2]) + n[d - 7] + jx(n[d - 15]) + n[d - 16];
    let r = e[0], i = e[1], o = e[2], s = e[3], a = e[4], c = e[5], l = e[6], u = e[7];
    for (let d = 0, f, h; d < 64; d++)
      f = u + $x(a) + (a & c ^ ~a & l) + zx[d] + n[d] >>> 0, h = Rx(r) + (r & i ^ r & o ^ i & o) >>> 0, u = l, l = c, c = a, a = s + f >>> 0, s = o, o = i, i = r, r = f + h >>> 0;
  ...
  digest(e) {
    ...
    for (; n < e.length; i++)
      for (let s = 3; s >= 0 && n < e.length; s--)
        this._W[i] |= e[n++] << s * 8;
    r || (this._W[i - (n % 4 === 0 ? 0 : 1)] |= Te << (3 - n % 4) * 8), this._W[14] = e.byteLength / e0, this._W[15] = e.byteLength * 8, this._updateHash();
...
const Hx = (t) => new Vx().digest(t), Wx = (t) => {
  for (let n = 6; n < t.length; n++)
    t[n % 6] = t[n % 6] ^ t[n];
  return t.slice(0, 6);
}, Ux = (t) => Z0(Wx(Hx(Q0(t)))), Wi = (t, e) => e === void 0 ? !t.deleted : e.sv.has(t.id.client) && /** @type {number} */
e.sv.get(t.id.client) > t.id.clock && !Qn(e.ds, t.id), Kx = [{ light: "#ecd44433", dark: "#ecd444" }], Gx = (t, e, n) => {
  if (!t.has(n)) {
    if (t.size < e.length) {
      const r = cn();
...
class Xx {
  ...
  constructor(e, n = /* @__PURE__ */ new Map()) {
    this.type = e, this.prosemirrorView = null, this.mux = Px(), this.mapping = n, this.isOMark = /* @__PURE__ */ new Map(), this._observeFunction = this._typeChanged.bind(this), this.doc = e.doc, this.beforeTransactionSelection = null, this.beforeAllTransactions = () => {
  ...
  _isDomSelectionInView() {
    ...
    const i = n.getBoundingClientRect(), o = tw.documentElement;
  ...
  _renderSnapshot(e, n, r) {
    ...
    if (e || (e = Fo(this.doc)), e instanceof Uint8Array || n instanceof Uint8Array)
      if ((!(e instanceof Uint8Array) || !(n instanceof Uint8Array)) && Le(), i = new yn({ gc: !1 }), xs(i, n), n = Fo(i), xs(i, e), e = Fo(i), o._item === null) {
  ...
  _typeChanged(e, n) {
    ...
    this.mux(() => {
      ...
      qx(s, this.beforeTransactionSelection, this), s = s.setMeta(ne, { isChangeOrigin: !0, isUndoRedoOperation: n.origin instanceof vd }), this.beforeTransactionSelection !== null && this._isLocalCursorInView() && s.scrollIntoView(), this.prosemirrorView.dispatch(s);
    });
  }
  /**
...
const Vd = (t, e, n, r, i, o) => {
  ...
  try {
    for (let c = 0; c < a.length; c++) {
      const l = a[c];
      s.push(e.text(l.insert, r1(l.attributes, e)));
    }
  } catch {
    return t.doc.transact((l) => {
      t._item.delete(l);
...
}, Os = (t, e) => t instanceof Array ? Zx(t, e) : Qx(t, e), ac = (t) => typeof t == "object" && t !== null, ga = (t, e) => {
  ...
  return t instanceof Ie && e instanceof Array && Hd(t, e);
  ...
  n.mapping.set(t, e);
  const { nAttrs: r, str: i } = e1(t), o = e.map((l) => ({
    insert: (
      /** @type {any} */
      l.text
    ),
    attributes: Object.assign({}, r, Wd(l.marks, n))
  })), { insert: s, remove: a, index: c } = Lx(
    i,
...
}, n1 = /(.*)(--[a-zA-Z0-9+/=]{8})$/, ya = (t) => n1.exec(t)?.[1] ?? t, r1 = (t, e) => {
  const n = [];
  for (const r in t)
  ...
  return t.forEach((r) => {
    if (r.type.name !== "ychange") {
      ...
      n[i ? `${r.type.name}--${Ux(r.toJSON())}` : r.type.name] = r.attrs;
    }
  }), n;
}, _s = (t, e, n, r) => {
  ...
  t.transact(() => {
    for (; a - l - u > 0 && o - l - u > 0; ) {
      ...
      if (f instanceof Ie && h instanceof Array)
        Hd(f, h) || t1(f, h, r), l += 1;
      else {
    ...
    const d = a - l - u;
    if (a === 1 && o === 0 && s[0] instanceof Ie ? (r.mapping.delete(s[0]), s[0].delete(0, s[0].length)) : d > 0 && (e.slice(l, l + d).forEach((f) => r.mapping.delete(f)), e.delete(l, d)), l + u < o) {
      const f = [];
      for (let h = l; h < o - u; h++)
        f.push(Os(i[h], r));
      e.insert(l, f);
  ...
  for (; r !== null && e !== r; ) {
    if (r instanceof Ie) {
      ...
      if (r._first !== null && t < i)
        ...
        if (t === 1 && r._length === 0 && i > 1)
          return new ji(r._item === null ? null : r._item.id, r._item === null ? Nr(r) : null, null);
        if (t -= i, r._item !== null && r._item.next !== null)
          r = /** @type {Y.ContentType} */
          r._item.next.content.type;
        else {
          if (t === 0)
            return r = r._item === null ? r : r._item.parent, new ji(r._item === null ? null : r._item.id, r._item === null ? Nr(r) : null, null);
          do
            r = /** @type {Y.Item} */
            r._item.parent, t--;
    ...
    if (r === null)
      throw Le();
    if (t === 0 && r.constructor !== Ie && r !== e)
      return i1(r._item.parent, r._item);
  }
  return jo(e, e._length, e.length === 0 ? -1 : 0);
}, i1 = (t, e) => {
  let n = null, r = null;
  return t._item === null ? r = Nr(t) : n = F(t._item.id.client, t._item.id.clock), new ji(n, r, e.id);
}, xi = (t, e, n, r) => {
  const i = Pw(n, t);
  if (i === null || i.type !== e && !Pr(e, i.type._item))
    return null;
  let o = i.type, s = 0;
  if (o.constructor === Ie)
    s = i.index;
    ...
    for (; c < o._length && c < i.index && a !== null; ) {
      if (!a.deleted) {
        ...
        c++, l instanceof Ie ? s += l._length : s += /** @type {any} */
        r.get(l).nodeSize;
      }
      a = /** @type {Y.Item} */
      a.right;
  ...
  for (; o !== e && o._item !== null; ) {
    ...
    if (a._item === null || !a._item.deleted) {
      ...
      for (; c !== null; ) {
        ...
        if (l === o)
          break;
        c.deleted || (l instanceof Ie ? s += l._length : s += /** @type {any} */
...
const s1 = (t) => Et.getState(t)?.undoManager?.undo() != null, a1 = (t) => Et.getState(t)?.undoManager?.redo() != null, l1 = /* @__PURE__ */ new Set(["paragraph"]), c1 = (t, e) => !(t instanceof K) || !(t.content instanceof dt) || !(t.content.type instanceof Ht || t.content.type instanceof be && e.has(t.content.type.nodeName)) || t.content.type._length === 0, u1 = ({ protectedNodes: t = l1, trackedOrigins: e = [], undoManager: n = null } = {}) => new mt({
  key: Et,
  state: {
    init: (r, i) => {
      const o = ne.getState(i), s = n || new vd(o.type, {
        trackedOrigins: new Set([ne].concat(e)),
        deleteFilter: (a) => c1(a, t),
  ...
  view: (r) => {
    const i = ne.getState(r.state), o = Et.getState(r.state).undoManager;
...
pn.create({
  ...
  addCommands() {
    return {
      undo: () => ({ tr: t, state: e, dispatch: n }) => (t.setMeta("preventDispatch", !0), Et.getState(e).undoManager.undoStack.length === 0 ? !1 : n ? s1(e) : !0),
      redo: () => ({ tr: t, state: e, dispatch: n }) => (t.setMeta("preventDispatch", !0), Et.getState(e).undoManager.redoStack.length === 0 ? !1 : n ? a1(e) : !0)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addProseMirrorPlugins() {
    var t;
    const e = this.options.fragment ? this.options.fragment : this.options.document.getXmlFragment(this.options.field), n = u1(this.options.yUndoOptions), r = n.spec.view;
    n.spec.view = (s) => {
...
function m1(t, e, n) {
  ...
  return {
    left: p1(e, a.left + r + o, a.right - i - s),
    top: n
  };
}
function Kd(t) {
...
function g1(t, e) {
  ...
  if (!r.resultNode || r.pos === null)
    return [];
  const i = t.clientX, o = m1(e.view, i, t.clientY), s = e.view.posAtCoords(o);
  if (!s)
    return [];
  const { pos: a } = s;
...
function y1(t, e) {
  ...
  if (!t.dataTransfer)
    return;
  const { empty: r, $from: i, $to: o } = n.state.selection, s = g1(t, e), a = go(i, o, 0), c = a.some((y) => s.find((b) => b.$from === y.$from && b.$to === y.$to)), l = r || !c ? s : a;
  if (!l.length)
    return;
  ...
  l.forEach((y) => {
    const b = n.nodeDOM(y.$from.pos), v = h1(b);
    d.append(v);
...
const uc = (t, e) => {
  ...
  for (; n && n.parentNode && n.parentNode !== t.dom; )
    n = n.parentNode;
  return n;
}, Gd = new $e("dragHandle"), Yd = ({ pluginKey: t = Gd, element: e, editor: n, tippyOptions: r, onNodeChange: i }) => {
...
const v1 = (t) => {
  const { className: e = "drag-handle", children: n, editor: r, pluginKey: i = Gd, onNodeChange: o, tippyOptions: s } = t, [a, c] = de(null), l = At(null);
...
}, va = (t) => typeof t == "object" && t !== null && !Array.isArray(t), w1 = (t, e) => {
...
}, ar = (t) => t.map(wa), x1 = (t) => va(t) ? t.type : void 0, S1 = (t, e) => {
  const n = wa(t);
  return n.type && Fn(n.type) ? w1(n, e) : n;
}, k1 = (t, e) => e.length === 0 ? ye.empty : ye.fromArray(
  e.map((n) => t.schema.nodeFromJSON(n))
), lr = (t, e) => new Ve(k1(t, e), 0, 0), cr = (t, e) => {
  const n = Cv(t, e);
  if (!n)
    throw new A1(e);
  return n;
...
const E1 = (t, e) => {
...
}), hc = (t) => t.isVisible !== !1, T1 = (t) => "isVisible" in t ? t.isVisible !== !1 : !0, N1 = (t) => !!t && "items" in t, P1 = (t) => !!t && "label" in t && !("items" in t), D1 = ({
  primaryAction: t,
  secondaryActions: e = [],
  metadata: n,
  otherActions: r = [],
  ...
  const o = e.filter(hc), s = r.filter(T1), a = t && hc(t), c = o.length > 0, l = s.length > 0, u = c || l || a;
  return /* @__PURE__ */ A("div", { className: "flex flex-col", children: [
    (n && n.length > 0 || u) && /* @__PURE__ */ A("div", { className: "flex flex-col items-start justify-between gap-2 sm:px-6 px-0 py-4 sm:flex-row sm:items-center", children: [
      n && n.length > 0 && /* @__PURE__ */ g($h, { items: n }),
    ...
    i && /* @__PURE__ */ A("div", { className: _1({ variant: i.variant }), children: [
  ...
  const b = Un(), v = At(null), w = At(null), S = mc(), [k] = de(() => r?.content || ""), [O, x] = de(r?.title || ""), [E, N] = de(null), I = (L) => {
    switch (L) {
      case "file-too-large":
  ...
  gc(y, () => ({
    ...
    applyPageDocumentPatch: (L) => T ? P(() => E1(T, L)) : { json: null, html: null },
    insertAIBlock: () => {
  ...
  return T ? /* @__PURE__ */ g(Nc, { dataTestId: m, children: /* @__PURE__ */ A(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ A(Kc, { className: "h-full gap-6", children: [
          B && /* @__PURE__ */ g(
            M1,
            {
              value: O,
                    ...
                    children: /* @__PURE__ */ A("div", { className: "flex flex-row", children: [
                      ...
                      /* @__PURE__ */ g(
                        "div",
                        {
                          ...
                          draggable: !0,
                          "data-drag-handle": !0,
                          children: /* @__PURE__ */ g(on, { icon: Vh, size: "xs" })
                        }
                      )
                    ] })
                  }
  ...
  ({ header: t, actions: e, open: n, onClose: r }, i) => {
    ...
    return /* @__PURE__ */ g(
      Uh,
      {
        open: n && !o,
        onOpenChange: (c) => !c && a?.(),
        children: /* @__PURE__ */ A(Kh, { ref: i, className: "bottom-3 top-auto max-w-[400px]", children: [
          /* @__PURE__ */ A(Gh, { className: "flex flex-col gap-4 px-4 py-5", children: [
            /* @__PURE__ */ g(Gc, { type: t.type, size: "lg" }),
            /* @__PURE__ */ A("div", { className: "flex flex-col gap-0.5", children: [
              /* @__PURE__ */ g(Yh, { className: "text-xl sm:text-lg", children: t.title }),
              /* @__PURE__ */ g(qh, { className: "text-lg sm:text-base", children: t.description })
            ] })
          ] }),
          e && /* @__PURE__ */ A(Xh, { className: "px-4 pb-4 pt-2", children: [
...
const lS = Re(
  ...
  function({
    ...
    return a ? /* @__PURE__ */ g(Xd, { ref: u }) : f ? null : /* @__PURE__ */ A(
      "div",
      {
        ref: u,

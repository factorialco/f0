...
import { bg as Zv, be as iE, de as oE, B as On, aC as Jw, c as Z, aD as Qw, aw as sE, ax as uE, a as ms, df as Vi, br as xe, D as cE, dg as lE, dh as fE, aI as eO, di as dE, dj as pE, bJ as ih, dk as hE, F as vt, E as gs, aT as tO, b0 as oh, au as rO, dl as pn, dm as vE, dn as yE, dp as mE, dq as Jv, dr as Qv, ds as ey, dt as ty, du as ry, dv as nO, dw as fo, dx as gE, dy as bE, cp as Ba, dz as xE, dA as aO, dB as iO, dC as oO, q as sO, V as Qr, r as uO, s as cO, bO as sh, g as le, c9 as wE, bz as uh, bA as ch, bB as lh, bE as fh, b3 as OE, b5 as dh, d0 as SE, cn as _E, ay as AE, av as PE, cv as Ei, u as Jn, aU as EE, by as TE, L as Ut, a9 as lO, Y as CE, Z as fO, _ as jE, d5 as bs, dD as ME, O as Ti, aR as $E, aF as IE, aY as kE, aG as dO, a$ as NE, m as DE, z as ph, e as RE, a4 as LE, n as qE, bL as BE, S as xt, w as pO, dE as hO, y as FE, K as vO, t as zE, cS as $e, dF as yO, dG as mO, dH as Pd, dI as WE, dJ as ny, P as UE, l as HE, o as KE, dc as VE, aa as GE, d2 as YE, az as XE, dK as ZE, f as JE, G as QE, H as eT, J as tT, M as rT } from "./index-CMHM3VV9.js";
function nT(e) {
...
function hh(e, t) {
  ...
  return a !== i ? !1 : r.every((o) => {
    const s = e[o], u = t[o];
    return typeof s == "function" ? `${s}` == `${u}` : !ay(s) || !ay(u) ? s === u : hh(s, u);
  });
}
function iy(e) {
...
function fT(e, t, r, n, a, i, o, s, u, c, f, l, d, p, y, h, v, g, b) {
  const {
    cross: x,
    direction: O
  ...
  function te(j, ee) {
    const U = l.add(yh(j) * -1), ce = f.byDistance(j, !y).distance;
  ...
  function Q(j) {
    const U = f.byDistance(0, !1).index !== l.get(), ce = i.pointerUp(j) * X(), de = te(O(ce), U), we = oT(ce, de), Ge = I - 10 * we, Ze = g + we / 50;
...
function yT(e, t, r, n, a, i) {
  let o = 0, s = 0, u = a, c = i, f = e.get(), l = 0;
  function d() {
    const w = n.get() - e.get(), S = !u;
    let A = 0;
    return S ? (o = 0, r.set(n), e.set(n), A = w) : (r.set(e), o += w / u, o *= c, f += o, e.add(o), A = f - l), s = yh(A), l = f, m;
  }
  function p() {
    const w = n.get() - t.get();
    return Ce(w) < 1e-3;
  ...
  function l() {
    return r.map((y, h) => {
      const {
        min: v,
        max: g
      } = i, b = i.constrain(y), x = !h, O = mh(r, h);
...
function PT(e, t, r, n, a, i, o, s) {
  ...
  function f(p) {
    ...
    function y(h) {
      ...
      vh(b) && (a.useDuration(0), n.index(b, 0), o.emit("slideFocus"));
    }
...
function $T(e, t, r, n, a, i, o) {
  const {
    ...
    watchDrag: m,
    watchFocus: w
  } = i, S = 2, A = pT(), P = A.measure(t), k = r.map(A.measure), E = lT(u, c), I = E.measureSize(P), C = hT(I), M = uT(s, I), $ = !l && !!b, N = l || !!b, {
    slideSizes: R,
    slideSizesWithGaps: q,
    startGap: z,
    endGap: D
  } = jT(E, P, k, r, N, a), L = MT(E, I, v, l, P, k, z, D, S), {
    snaps: F,
    snapsAligned: H
  } = OT(E, M, P, k, L), X = -kt(F) + kt(q), {
    snapsContained: te,
    scrollContainLimit: ne
  } = gT(I, X, H, b, S), re = $ ? te : H, {
    limit: Q
  } = bT(X, re, l), W = bO(Ci(re), f, l), G = W.clone(), Y = Fa(r), j = ({
    dragHandler: un,
    scrollBody: cu,
    scrollBounds: lu,
    options: {
  ...
  }, U = cT(n, a, () => j(uu), (un) => ee(uu, un)), ce = 0.68, de = re[W.get()], we = Pa(de), Ge = Pa(de), Ze = Pa(de), yt = Pa(de), st = yT(we, Ze, Ge, yt, d, ce), ut = _T(l, re, X, Q, yt), Cr = AT(U, W, G, st, ut, yt, o), on = wT(Q), sn = Wa(), Hi = CT(t, r, o, h), {
    slideRegistry: pa
  } = ST($, b, re, ne, L, Y), GP = PT(e, r, pa, Cr, st, sn, o, w), uu = {
    ownerDocument: n,
    ownerWindow: a,
    eventHandler: o,
    containerRect: P,
    ...
    animation: U,
    axis: E,
    dragHandler: fT(E, e, n, a, yt, dT(E, a), we, U, Cr, st, ut, W, o, C, p, y, g, ce, m),
    eventStore: sn,
    percentOfView: C,
    index: W,
    indexPrevious: G,
    ...
    previousLocation: Ge,
    options: i,
    resizeHandler: vT(t, o, a, r, E, x, A),
    scrollBody: st,
    scrollBounds: mT(Q, Ze, yt, st, C),
    scrollLooper: xT(X, Q, Ze, [we, Ze, Ge, yt]),
    scrollProgress: on,
    scrollSnapList: re.map(on.get),
    scrollSnaps: re,
    scrollTarget: ut,
    scrollTo: Cr,
    slideLooper: ET(E, I, X, R, q, F, re, Ze, r),
    slideFocus: GP,
    slidesHandler: TT(t, o, O),
    slidesInView: Hi,
    slideIndexes: Y,
    slideRegistry: pa,
    slidesToScroll: L,
...
function ho(e, t, r) {
  const n = e.ownerDocument, a = n.defaultView, i = NT(a), o = DT(i), s = Wa(), u = IT(), {
    mergeOptions: c,
    optionsAtMedia: f,
  ...
  let v = !1, g, b = c(kT, ho.globalOptions), x = c(b), O = [], m, w, S;
  function A() {
    const {
      container: Y,
      slides: j
...
function gh(e = {}, t = []) {
  ...
  return Ue(() => {
    hh(r.current, e) || (r.current = e, u());
  }, [e, u]), Ue(() => {
    iT(n.current, t) || (n.current = t, u());
  }, [t, u]), Ue(() => {
    if (aT() && o) {
      ho.globalOptions = gh.globalOptions;
...
const je = 28, uy = 16, RT = ({ children: e }) => {
...
function bh(e = {}) {
  ...
  function l(M, $) {
    ...
    const {
      mergeOptions: N,
      optionsAtMedia: R
    } = $, q = N(LT, bh.globalOptions), z = N(q, e);
    if (t = R(z), r.scrollSnapList().length <= 1) return;
    f = t.jump, n = !1, a = qT(r, t.delay);
    const {
      eventStore: D,
      ownerDocument: L
    } = r.internalEngine(), F = !!r.internalEngine().options.watchDrag, H = BT(r, t.rootNode);
...
var FT = 0.996, zT = function(t, r) {
  return r === void 0 && (r = FT), t * r / (1 - r);
};
function WT(e) {
  return e[e.length - 1];
}
...
var GT = 16 * 1.125, YT = typeof window < "u" && window.innerHeight || 800, du = [1, GT, YT];
function XT(e) {
...
var ly = 700, QT = function(t) {
  return Wr({}, t, {
    axisDelta: t.axisDelta.map(function(r) {
      return HT(r, -ly, ly);
    })
  });
}, pu = process.env.NODE_ENV !== "production", eC = 0.6, tC = 0.96, rC = 2, fy = 5, dy = /* @__PURE__ */ Sn({
...
function aC(e) {
  e === void 0 && (e = {});
  var t = KT(), r = t.on, n = t.off, a = t.dispatch, i = dy, o = py(), s, u = !1, c, f = function(M) {
    ...
    return M === void 0 && (M = {}), Object.values(M).some(function($) {
      return $ == null;
    }) ? (pu && console.error("updateOptions ignored! undefined & null options not allowed"), i) : i = Sn(Wr({}, dy, i, M));
  }, d = function(M) {
    var $ = Wr({
      event: s,
      isStart: !1,
    ...
    var $ = QT(JT(XT(M), i.reverseSign)), N = $.axisDelta, R = $.timeStamp, q = cy(N);
    ...
    o.scrollPointsToMerge.length === rC ? (o.scrollPoints.unshift({
      axisDeltaSum: o.scrollPointsToMerge.map(function(M) {
        return M.axisDelta;
      }).reduce(fu),
      timeStamp: UT(o.scrollPointsToMerge.map(function(M) {
        return M.timeStamp;
      }))
    }), g(), o.scrollPointsToMerge.length = 0, o.scrollPoints.length = 1, o.isMomentum || O()) : o.isStartPublished || v();
  }, v = function() {
    o.axisVelocity = WT(o.scrollPointsToMerge).axisDelta.map(function(M) {
    ...
    return M === 0 ? !0 : M <= tC && M >= eC;
  }, O = function() {
    if (o.accelerationFactors.length >= fy) {
      if (u && (u = !1, cy(o.axisVelocity) >= 0.2)) {
        m();
        return;
      }
      var M = o.accelerationFactors.slice(fy * -1), $ = M.every(function(N) {
    ...
    o = py(), o.isStarted = !0, o.startTime = Date.now(), c = void 0, u = !1;
  }, S = /* @__PURE__ */ (function() {
    var C;
    return function() {
  ...
  }, P = VT(f), k = P.observe, E = P.unobserve, I = P.disconnect;
  return l(e), Sn({
    on: r,
    off: n,
    observe: k,
...
var oC = process.env.NODE_ENV !== "production";
function xh(e) {
  e === void 0 && (e = {});
  var t, r = function() {
  };
  function n(i, o) {
    var s, u, c = o.mergeOptions, f = o.optionsAtMedia, l = c(iC, xh.globalOptions), d = c(l, e);
    t = f(d);
    var p = i.internalEngine(), y = (s = t.target) != null ? s : i.containerNode().parentNode, h = (u = t.forceWheelAxis) != null ? u : p.options.axis, v = aC({
    ...
    function m(C) {
      try {
        ...
        return oC && console.warn("Legacy browser requires events-polyfill (https://github.com/xiel/embla-carousel-wheel-gestures#legacy-browsers)"), r();
      }
...
const Yz = ({ children: e, columns: t, showArrows: r = !0, showDots: n = !0, autoplay: a = !1, delay: i = 3e3, showPeek: o = !1, doubleColumns: s }) => {
  const u = T.Children.toArray(e), c = T.useRef(a ? bh({
    delay: i,
    stopOnInteraction: !0
  }) : void 0), f = () => {
  ...
  return t ? _(OO, {
    ...
    plugins: [c.current, xh()].filter(Boolean),
...
function _j() {
  if (tg) return Zc;
  tg = 1;
  var e = Sj(), t = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, r = /\\(\\)?/g, n = e(function(a) {
    var i = [];
...
var jj = Cj();
const Ii = /* @__PURE__ */ xe(jj);
var Mj = Oh();
const oe = /* @__PURE__ */ xe(Mj);
var $j = Or();
const ea = /* @__PURE__ */ xe($j);
var Gi = { exports: {} }, he = {};
var fg;
function Ij() {
  if (fg) return he;
...
var pg;
function Nj() {
  return pg || (pg = 1, process.env.NODE_ENV === "production" ? Gi.exports = Ij() : Gi.exports = kj()), Gi.exports;
}
var Dj = Nj(), sl, hg;
function XO() {
  if (hg) return sl;
...
var Lj = Rj();
const ta = /* @__PURE__ */ xe(Lj);
var qj = XO();
const Bj = /* @__PURE__ */ xe(qj);
var et = function(t) {
...
var Wj = ["viewBox", "children"], Uj = [
  ...
  return Object.keys(t).forEach(function(i) {
    var o = t[i];
    kh.includes(i) && typeof o == "function" && (a || (a = {}), a[i] = Hj(o, r, n));
  }), a;
}, Kj = ["children"], Vj = ["children"];
function mg(e, t) {
  if (e == null) return {};
  var r = Gj(e, t), n, a;
...
var gg = {
  ...
  return zr.forEach(t, function(n) {
    se(n) || (Dj.isFragment(n) ? r = r.concat(e(n.props.children)) : r.push(n));
  }), ll = r, bg = t, r;
};
function ht(e, t) {
  var r = [], n = [];
...
var xg = function(t) {
...
}, Yj = ["a", "altGlyph", "altGlyphDef", "altGlyphItem", "animate", "animateColor", "animateMotion", "animateTransform", "circle", "clipPath", "color-profile", "cursor", "defs", "desc", "ellipse", "feBlend", "feColormatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "filter", "font", "font-face", "font-face-format", "font-face-name", "font-face-url", "foreignObject", "g", "glyph", "glyphRef", "hkern", "image", "line", "lineGradient", "marker", "mask", "metadata", "missing-glyph", "mpath", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "script", "set", "stop", "style", "svg", "switch", "symbol", "text", "textPath", "title", "tref", "tspan", "use", "view", "vkern"], Xj = function(t) {
  return t && t.type && Ii(t.type) && Yj.indexOf(t.type) >= 0;
}, ZO = function(t) {
  return t && jd(t) === "object" && "clipDot" in t;
}, Zj = function(t, r, n, a) {
  var i, o = (i = cl?.[a]) !== null && i !== void 0 ? i : [];
  return !oe(t) && (a && o.includes(r) || Uj.includes(r)) || n && kh.includes(r);
}, ae = function(t, r, n) {
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var a = t;
  ...
  return Object.keys(a).forEach(function(o) {
    var s;
    Zj((s = a) === null || s === void 0 ? void 0 : s[o], o, r, n) && (i[o] = a[o]);
  }), i;
}, Md = function e(t, r) {
  if (t === r)
    return !0;
  ...
  if (se(t) && se(r))
    return !0;
  if (!se(t) && !se(r)) {
    var n = t.props || {}, a = n.children, i = mg(n, Kj), o = r.props || {}, s = o.children, u = mg(o, Vj);
...
}, eM = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function $d() {
...
function Id(e) {
  var t = e.children, r = e.width, n = e.height, a = e.viewBox, i = e.className, o = e.style, s = e.title, u = e.desc, c = tM(e, eM), f = a || {
    width: r,
    height: n,
    x: 0,
    y: 0
...
var fe = /* @__PURE__ */ T.forwardRef(function(e, t) {
  var r = e.children, n = e.className, a = aM(e, nM), i = le("recharts-layer", n);
  return /* @__PURE__ */ T.createElement("g", kd({
    className: i
  }, ae(a, !0), {
    ref: t
  }), r);
}), oM = process.env.NODE_ENV !== "production", Nt = function(t, r) {
  for (var n = arguments.length, a = new Array(n > 2 ? n - 2 : 0), i = 2; i < n; i++)
    a[i - 2] = arguments[i];
  if (oM && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
...
function pM() {
  if (jg) return gl;
  jg = 1;
  var e = dM(), t = e("toUpperCase");
  return gl = t, gl;
}
var hM = pM();
const Es = /* @__PURE__ */ xe(hM);
function _e(e) {
  return function() {
    return e;
  };
}
const QO = Math.cos, mo = Math.sin, qt = Math.sqrt, go = Math.PI, Ts = 2 * go, Nd = Math.PI, Dd = 2 * Nd, kr = 1e-6, vM = Dd - kr;
function eS(e) {
  this._ += e[0];
...
class mM {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? eS : yM(t);
  }
  moveTo(t, r) {
  ...
  arc(t, r, n, a, i, o) {
    ...
    this._x1 === null ? this._append`M${c},${f}` : (Math.abs(this._x1 - c) > kr || Math.abs(this._y1 - f) > kr) && this._append`L${c},${f}`, n && (d < 0 && (d = d % Dd + Dd), d > vM ? this._append`A${n},${n},0,1,${l},${t - s},${r - u}A${n},${n},0,1,${l},${this._x1 = c},${this._y1 = f}` : d > kr && this._append`A${n},${n},0,${+(d >= Nd)},${l},${this._x1 = t + n * Math.cos(i)},${this._y1 = r + n * Math.sin(i)}`);
  }
  rect(t, r, n, a) {
...
}, oS = qt(1 / 3), wM = oS * 2, OM = {
  draw(e, t) {
    const r = qt(t / wM), n = r * oS;
...
}, _M = 0.8908130915292852, sS = mo(go / 10) / mo(7 * go / 10), AM = mo(Ts / 10) * sS, PM = -QO(Ts / 10) * sS, EM = {
  draw(e, t) {
    const r = qt(t * _M), n = AM * r, a = PM * r;
...
}, mt = -0.5, gt = qt(3) / 2, Rd = 1 / qt(12), CM = (Rd / 2 + 1) * 3, jM = {
  draw(e, t) {
    const r = qt(t / CM), n = r / 2, a = r * Rd, i = n, o = r * Rd + r, s = -i, u = o;
...
function UM() {
  var e = _e([]), t = Ld, r = _n, n = zM;
  function a(i) {
    var o = Array.from(e.apply(this, arguments), WM), s, u = o.length, c = -1, f;
    for (const l of i)
      for (s = 0, ++c; s < u; ++s)
...
var vS = {
  ...
  var r = t.type, n = r === void 0 ? "circle" : r, a = t.size, i = a === void 0 ? 64 : a, o = t.sizeType, s = o === void 0 ? "area" : o, u = JM(t, GM), c = Dg(Dg({}, u), {}, {
    type: n,
    size: i,
    sizeType: s
  }), f = function() {
    var v = t2(n), g = MM().type(v).size(r2(i, s, n));
    return g();
...
function u2(e, t, r) {
  return t = Oo(t), c2(e, yS() ? Reflect.construct(t, r || [], Oo(e).constructor) : t.apply(e, r));
}
function c2(e, t) {
...
var bt = 32, Bh = /* @__PURE__ */ (function(e) {
  function t() {
    return i2(this, t), u2(this, t, arguments);
  }
  return f2(t, e), s2(t, [{
    key: "renderIcon",
    value: (
...
function b2() {
  if (Kg) return Cl;
  Kg = 1;
  var e = Ch(), t = YO(), r = g2(), n = Mh(), a = gS(), i = bS(), o = Ps(), s = 1, u = 2;
  function c(f, l) {
...
function C2() {
  if (ib) return zl;
  ib = 1;
  var e = FO(), t = T2(), r = Ah(), n = 1 / 0, a = e && 1 / r(new e([, -0]))[1] == n ? function(i) {
    return new e(i);
  } : t;
  return zl = a, zl;
}
...
function j2() {
  if (ob) return Wl;
  ob = 1;
  var e = $O(), t = P2(), r = E2(), n = kO(), a = C2(), i = Ah(), o = 200;
  function s(u, c, f) {
...
function D2(e, t, r) {
  return t = So(t), R2(e, OS() ? Reflect.construct(t, r || [], So(e).constructor) : t.apply(e, r));
}
function R2(e, t) {
...
var fb = 1, Ur = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = D2(this, t, [].concat(a)), Ms(r, "lastBoundingBox", {
      width: -1,
      height: -1
    }), r;
  }
...
function J2() {
  if (Sb) return rf;
  Sb = 1;
  var e = $h(), t = Ih(), r = Xt(), n = PS(), a = Y2(), i = LO(), o = Z2(), s = ra(), u = ot();
  function c(f, l, d) {
...
function r$() {
  if (Tb) return uf;
  Tb = 1;
  var e = t$(), t = ES(), r = ra(), n = t ? function(a, i) {
    return t(a, "toString", {
      configurable: !0,
      enumerable: !1,
      value: e(i),
...
function o$() {
  if (Ib) return pf;
  Ib = 1;
  var e = _S(), t = J2(), r = i$(), n = $s(), a = r(function(i, o) {
    if (i == null)
      return [];
    var s = o.length;
    ...
    if (f && f.length) {
      var I = {
        ...
        var N = hf({
          ...
          paddingBottom: 4,
          color: M.color || "#000"
        }, s), R = M.formatter || l || y$, q = M.value, z = M.name, D = q, L = z;
        if (R && D != null && L != null) {
          var F = R(q, z, M, $, f);
          if (Array.isArray(F)) {
            var H = u$(F, 2);
...
var ya = "recharts-tooltip-wrapper", x$ = {
  visibility: "hidden"
};
function w$(e) {
...
function E$(e, t, r) {
  return t = _o(t), T$(e, TS() ? Reflect.construct(t, r || [], _o(e).constructor) : t.apply(e, r));
}
function T$(e, t) {
...
var qb = 1, $$ = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    _$(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = E$(this, t, [].concat(a)), Hd(r, "state", {
      dismissed: !1,
  ...
  return j$(t, e), P$(t, [{
    ...
    key: "render",
    value: function() {
      var n = this, a = this.props, i = a.active, o = a.allowEscapeViewBox, s = a.animationDuration, u = a.animationEasing, c = a.children, f = a.coordinate, l = a.hasPayload, d = a.isAnimationActive, p = a.offset, y = a.position, h = a.reverseDirection, v = a.useTranslate3d, g = a.viewBox, b = a.wrapperStyle, x = S$({
...
function R$(e, t, r) {
  return t = Ao(t), L$(e, jS() ? Reflect.construct(t, r || [], Ao(e).constructor) : t.apply(e, r));
}
function L$(e, t) {
...
function W$(e, t) {
  return /* @__PURE__ */ T.isValidElement(e) ? /* @__PURE__ */ T.cloneElement(e, t) : typeof e == "function" ? /* @__PURE__ */ T.createElement(e, t) : /* @__PURE__ */ T.createElement(m$, t);
}
var Ft = /* @__PURE__ */ (function(e) {
  function t() {
    return k$(this, t), R$(this, t, arguments);
  }
  return B$(t, e), D$(t, [{
    key: "render",
    value: function() {
...
function $S() {
  if (Hb) return gf;
  Hb = 1;
  var e = K$(), t = Or(), r = Qn(), n = NaN, a = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, o = /^0o[0-7]+$/i, s = parseInt;
  function u(c) {
    if (typeof c == "number")
      return c;
    if (r(c))
...
function V$() {
  if (Kb) return bf;
  Kb = 1;
  var e = Or(), t = U$(), r = $S(), n = "Expected a function", a = Math.max, i = Math.min;
  function o(s, u, c) {
...
function G$() {
  if (Vb) return xf;
  Vb = 1;
  var e = V$(), t = Or(), r = "Expected a function";
  function n(a, i, o) {
    var s = !0, u = !0;
...
var aI = /* @__PURE__ */ De(function(e, t) {
  ...
  }), A = Q$(S, 2), P = A[0], k = A[1], E = rr(function(C, M) {
    k(function($) {
...
var Ma = function(t) {
  ...
  try {
    ...
    return cn.widthCache[a] = u, ++cn.cacheCount > uI && (cn.cacheCount = 0, cn.widthCache = {}), u;
  } catch {
    return {
      width: 0,
      height: 0
...
var e0 = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, t0 = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, xI = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, wI = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, kS = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
  ...
  Q: 96 / (2.54 * 40),
  px: 1
}, OI = Object.keys(kS), hn = "NaN";
function SI(e, t) {
  return e * kS[t];
}
var Ji = /* @__PURE__ */ (function() {
  function e(t, r) {
    yI(this, e), this.num = t, this.unit = r, this.num = t, this.unit = r, Number.isNaN(t) && (this.unit = ""), r !== "" && !xI.test(r) && (this.num = NaN, this.unit = ""), OI.includes(r) && (this.num = SI(t, r), this.unit = "px");
  }
  return mI(e, [{
    key: "add",
    value: function(r) {
    ...
    key: "parse",
    value: function(r) {
      var n, a = (n = wI.exec(r)) !== null && n !== void 0 ? n : [], i = Po(a, 3), o = i[1], s = i[2];
...
function wf(e) {
  var t = PI(e.slice(5, -1));
  return t === hn ? "" : t;
}
var EI = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], TI = ["dx", "dy", "angle", "className", "breakAll"];
function Gd() {
...
var DS = /[ \f\n\r\t\v\u2028\u2029]+/, RS = function(t) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, s = o === void 0 ? "1em" : o, u = t.capHeight, c = u === void 0 ? "0.71em" : u, f = t.scaleToFit, l = f === void 0 ? !1 : f, d = t.textAnchor, p = d === void 0 ? "start" : d, y = t.verticalAnchor, h = y === void 0 ? "end" : y, v = t.fill, g = v === void 0 ? s0 : v, b = n0(t, EI), x = Qe(function() {
    return NI({
      breakAll: b.breakAll,
      children: b.children,
      maxLines: b.maxLines,
  ...
  }, [b.breakAll, b.children, b.maxLines, l, b.style, b.width]), O = b.dx, m = b.dy, w = b.angle, S = b.className, A = b.breakAll, P = n0(b, TI);
  if (!Fe(n) || !Fe(i))
    return null;
...
function Uh(e) {
  let t, r, n;
  e.length !== 2 ? (t = xr, r = (s, u) => xr(e(s), u), n = (s, u) => e(s) - u) : (t = e === xr || e === DI ? e : RI, r = e, n = e);
...
class u0 extends Map {
  ...
  set(t, r) {
    return super.set(BI(this, t), r);
  }
  delete(t) {
    return super.delete(FI(this, t));
  }
}
...
function FI({ _intern: e, _key: t }, r) {
  const n = t(r);
...
const UI = Math.sqrt(50), HI = Math.sqrt(10), KI = Math.sqrt(2);
function Eo(e, t, r) {
  const n = (t - e) / Math.max(0, r), a = Math.floor(Math.log10(n)), i = n / Math.pow(10, a), o = i >= UI ? 10 : i >= HI ? 5 : i >= KI ? 2 : 1;
  let s, u, c;
...
function VI(e, t, r) {
  if (e = Float64Array.from(LI(e)), !(!(n = e.length) || isNaN(t = +t))) {
...
var Ja = 0.7, To = 1 / Ja, xn = "\\s*([+-]?\\d+)\\s*", Qa = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Ht = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", XI = /^#([0-9a-f]{3,8})$/, ZI = new RegExp(`^rgb\\(${xn},${xn},${xn}\\)$`), JI = new RegExp(`^rgb\\(${Ht},${Ht},${Ht}\\)$`), QI = new RegExp(`^rgba\\(${xn},${xn},${xn},${Qa}\\)$`), ek = new RegExp(`^rgba\\(${Ht},${Ht},${Ht},${Qa}\\)$`), tk = new RegExp(`^hsl\\(${Qa},${Ht},${Ht}\\)$`), rk = new RegExp(`^hsla\\(${Qa},${Ht},${Ht},${Qa}\\)$`), d0 = {
  aliceblue: 15792383,
...
function ei(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = XI.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? v0(t) : r === 3 ? new nt(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? Qi(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? Qi(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = ZI.exec(e)) ? new nt(t[1], t[2], t[3], 1) : (t = JI.exec(e)) ? new nt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = QI.exec(e)) ? Qi(t[1], t[2], t[3], t[4]) : (t = ek.exec(e)) ? Qi(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = tk.exec(e)) ? g0(t[1], t[2] / 100, t[3] / 100, 1) : (t = rk.exec(e)) ? g0(t[1], t[2] / 100, t[3] / 100, t[4]) : d0.hasOwnProperty(e) ? v0(d0[e]) : e === "transparent" ? new nt(NaN, NaN, NaN, 0) : null;
}
function v0(e) {
...
function Qd(e, t, r, n) {
  return arguments.length === 1 ? ik(e) : new nt(e, t, r, n ?? 1);
}
function nt(e, t, r, n) {
...
function lk(e) {
  return (e = +e) == 1 ? US : function(t, r) {
    return r - t ? ck(t, r, e) : Vh(isNaN(t) ? r : t);
  };
}
function US(e, t) {
  var r = t - e;
  return r ? uk(e, r) : Vh(isNaN(e) ? t : e);
}
...
function gk(e, t) {
  ...
  return r < t.length && (i = t.slice(r), s[o] ? s[o] += i : s[++o] = i), s.length < 2 ? u[0] ? mk(u[0].x) : yk(t) : (t = u.length, function(c) {
...
function na(e, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? Vh(t) : (r === "number" ? jo : r === "string" ? (n = ei(t)) ? (t = n, x0) : gk : t instanceof ei ? x0 : t instanceof Date ? hk : dk(t) ? fk : Array.isArray(t) ? pk : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? vk : jo)(e, t);
}
function Gh(e, t) {
  return e = +e, t = +t, function(r) {
...
function ks() {
  ...
  function f() {
    ...
    return o !== rt && (o = wk(e[0], e[d - 1])), s = d > 2 ? Sk : Ok, u = c = null, l;
  }
  function l(d) {
...
function jk(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? _0 : Ak(A0.call(e.grouping, Number), e.thousands + ""), r = e.currency === void 0 ? "" : e.currency[0] + "", n = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", i = e.numerals === void 0 ? _0 : Pk(A0.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", s = e.minus === void 0 ? "−" : e.minus + "", u = e.nan === void 0 ? "NaN" : e.nan + "";
  function c(l) {
    l = ti(l);
    ...
    function k(E) {
      ...
      if (m === "c")
        ...
        E = +E;
        var R = E < 0 || 1 / E < 0;
        if (E = isNaN(E) ? u : A(Math.abs(E), x), O && (E = Tk(E)), R && +E == 0 && y !== "+" && (R = !1), I = (R ? y === "(" ? y : s : y === "-" || y === "(" ? "" : y) + I, C = (m === "s" ? P0[8 + HS / 3] : "") + C + (R && y === "(" ? ")" : ""), P) {
          for (M = -1, $ = E.length; ++M < $; )
...
function Mk(e) {
  return to = jk(e), Zh = to.format, KS = to.formatPrefix, to;
}
function $k(e) {
...
function VS(e, t, r, n) {
  ...
  switch (n = ti(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(i = Ik(a, o)) && (n.precision = i), KS(n, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      n.precision == null && !isNaN(i = kk(a, Math.max(Math.abs(e), Math.abs(t)))) && (n.precision = i - (n.type === "e"));
      break;
    }
    case "f":
    case "%": {
...
function Jh(e) {
  ...
  let n = 10, a, i;
  function o() {
    return a = qk(n), i = Lk(n), r()[0] < 0 ? (a = C0(a), i = C0(i), e(Nk, Dk)) : e(E0, T0), t;
  }
...
function ev(e) {
  var t = e(rt, rt), r = 1;
  function n() {
    return r === 1 ? e(rt, rt) : r === 0.5 ? e(Bk, Fk) : e($0(r), $0(1 / r));
  }
...
const Ds = rn(0), No = rn(1), Uk = rn(2), Hk = rn(3), jn = rn(4), Kk = rn(5), Vk = rn(6);
Ds.range;
No.range;
Uk.range;
Hk.range;
...
const Rs = nn(0), Do = nn(1), Gk = nn(2), Yk = nn(3), Mn = nn(4), Xk = nn(5), Zk = nn(6);
Rs.range;
Do.range;
Gk.range;
Yk.range;
...
const [Jk, Qk] = n_(sr, uv, Rs, r_, ov, av), [eN, tN] = n_(or, sv, Ds, Ri, iv, nv);
function Ef(e) {
  if (0 <= e.y && e.y < 100) {
...
function rD(e) {
  return ln = rN(e), u_ = ln.format, ln.parse, c_ = ln.utcFormat, ln.utcParse, ln;
}
function nD(e) {
  return new Date(e);
}
...
function cv(e, t, r, n, a, i, o, s, u, c) {
  ...
  return f.invert = function(w) {
    ...
    return arguments.length ? d(Array.from(w, aD)) : d().map(nD);
  }, f.ticks = function(w) {
    var S = d();
...
function iD() {
  return Tt.apply(cv(eN, tN, or, sv, Ds, Ri, iv, nv, qr, u_).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function oD() {
  return Tt.apply(cv(Jk, Qk, sr, uv, Rs, Ns, ov, av, qr, c_).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function Ls() {
...
function p_() {
  ...
  return r.domain = function(n) {
    ...
    return Array.from({ length: n + 1 }, (a, i) => VI(e, i / n));
  }, r.copy = function() {
...
function qs() {
  ...
  function y(h) {
    return function(v) {
      var g, b, x;
      return arguments.length ? ([g, b, x] = v, c = bk(h, [g, b, x]), p) : [c(0), c(0.5), c(1)];
    };
  }
...
}, pv, Ee = !0, Pt = "[DecimalError] ", Kr = Pt + "Invalid argument: ", dv = Pt + "Exponent out of range: ", ia = Math.floor, Nr = Math.pow, gD = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, dt, We = 1e7, Pe = 7, b_ = 9007199254740991, Ro = ia(b_ / Pe), J = {};
...
function S_(e) {
  ...
  function a(i) {
    ...
    if (typeof i == "number") {
      ...
      throw Error(Kr + i);
    if (i.charCodeAt(0) === 45 ? (i = i.slice(1), o.s = -1) : o.s = 1, gD.test(i)) Q0(o, i);
    else throw Error(Kr + i);
  }
  if (a.prototype = J, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.clone = S_, a.config = a.set = bD, e === void 0 && (e = {}), e)
...
var AD = function(t) {
  ...
  return t === 1 ? r : tx(function() {
    ...
    return o >= t ? r.apply(void 0, a) : e(t - o, tx(function() {
      ...
      return r.apply(void 0, xD(f).concat(u));
    }));
  });
}, zs = function(t) {
  return PD(t.length, t);
}, np = function(t, r) {
  for (var n = [], a = t; a < r; ++a)
    n[a - t] = a;
  return n;
...
var MD = zs(function(e, t, r) {
  var n = +e, a = +t;
  return n + r * (a - n);
}), $D = zs(function(e, t, r) {
  var n = t - +e;
  return n = n || 1 / 0, (r - e) / n;
}), ID = zs(function(e, t, r) {
  var n = t - +e;
...
const Ws = {
  rangeStep: jD,
  getDigitCount: CD,
  interpolateNumber: MD,
  uninterpolateNumber: $D,
  uninterpolateTruncation: ID
};
function ip(e) {
  return DD(e) || ND(e) || E_(e) || kD();
}
function kD() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function BD(e, t, r) {
  ...
  var o = Math.floor((t - 1) / 2), s = TD(ED(function(u) {
...
var WD = P_(FD), UD = P_(zD), HD = process.env.NODE_ENV === "production", Rf = "Invariant failed";
function at(e, t) {
  if (HD)
    throw new Error(Rf);
...
var KD = ["offset", "layout", "width", "dataKey", "data", "dataPointFormatter", "xAxis", "yAxis"];
function $n(e) {
  "@babel/helpers - typeof";
...
function nR(e, t, r) {
  return t = qo(t), aR(e, M_() ? Reflect.construct(t, r || [], qo(e).constructor) : t.apply(e, r));
}
function aR(e, t) {
...
var Li = /* @__PURE__ */ (function(e) {
  ...
  return oR(t, e), rR(t, [{
    key: "render",
    value: function() {
      var n = this.props, a = n.offset, i = n.layout, o = n.width, s = n.dataKey, u = n.data, c = n.dataPointFormatter, f = n.xAxis, l = n.yAxis, d = JD(n, KD), p = ae(d, !1);
...
var mR = function(t) {
  ...
  }), i = ER[n], o = UM().keys(a).value(function(s, u) {
    return +Ie(s, u, 0);
  }).order(Ld).offset(i);
  return o(t);
}, CR = function(t, r, n, a, i, o) {
  if (!t)
    return null;
...
var zo = Math.PI / 180, BR = function(t) {
  ...
  var n = t.x, a = t.y, i = r.cx, o = r.cy, s = zR({
    x: n,
    y: a
  }, {
    x: i,
  ...
  if (o === 0)
    return !0;
  var f = UR(r), l = f.startAngle, d = f.endAngle, p = s, y;
  if (l <= d) {
    for (; p > d; )
      p -= 360;
    for (; p < l; )
...
var nL = function(t) {
  ...
  var a = t.position, i = t.viewBox, o = t.offset, s = t.className, u = i, c = u.cx, f = u.cy, l = u.innerRadius, d = u.outerRadius, p = u.startAngle, y = u.endAngle, h = u.clockWise, v = (l + d) / 2, g = aL(p, y), b = g >= 0 ? 1 : -1, x, O;
...
function Be(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = JR(e, KR), a = Re({
    offset: r
...
var V_ = function(t) {
  ...
  if (!n)
    return o;
  var s = cL(t.label, r || i);
  return [s].concat(VR(o));
};
Be.parseViewBox = V_;
Be.renderCallByParent = lL;
var qf, vx;
function fL() {
  if (vx) return qf;
  vx = 1;
...
var hL = ["valueAccessor"], vL = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function yL(e) {
  return xL(e) || bL(e) || gL(e) || mL();
}
function mL() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var AL = function(t) {
  return Array.isArray(t.value) ? pL(t.value) : t.value;
};
function _t(e) {
  var t = e.valueAccessor, r = t === void 0 ? AL : t, n = gx(e, hL), a = n.data, i = n.dataKey, o = n.clockWise, s = n.id, u = n.textBreakAll, c = gx(n, vL);
...
function EL(e, t) {
  ...
  if (!r)
    return a;
  var i = PL(e.label, t);
  return [i].concat(yL(a));
}
_t.renderCallByParent = EL;
function li(e) {
  "@babel/helpers - typeof";
...
var ML = function(t, r) {
  ...
  var r = t.cx, n = t.cy, a = t.innerRadius, i = t.outerRadius, o = t.startAngle, s = t.endAngle, u = ML(o, s), c = o + u, f = Ae(r, n, i, o), l = Ae(r, n, i, c), d = "M ".concat(f.x, ",").concat(f.y, `
  ...
  var r = xx(xx({}, IL), t), n = r.cx, a = r.cy, i = r.innerRadius, o = r.outerRadius, s = r.cornerRadius, u = r.forceCornerRadius, c = r.cornerIsExternal, f = r.startAngle, l = r.endAngle, d = r.className;
  if (o < i || f === l)
    return null;
  var p = le("recharts-sector", d), y = o - i, h = tt(s, y, 0, !0), v;
  return h > 0 && Math.abs(f - l) < 360 ? v = $L({
    cx: n,
    cy: a,
    innerRadius: i,
    outerRadius: o,
...
var Sx = {
  ...
  var r = t.type, n = r === void 0 ? "linear" : r, a = t.points, i = a === void 0 ? [] : a, o = t.baseLine, s = t.layout, u = t.connectNulls, c = u === void 0 ? !1 : u, f = RL(n, s), l = c ? i.filter(function(h) {
    return ao(h);
  }) : i, d;
  if (Array.isArray(o)) {
...
var Px;
function X_() {
  return Px || (Px = 1, process.env.NODE_ENV === "production" ? oo.exports = qL() : oo.exports = BL()), oo.exports;
}
var Bf, Ex;
function FL() {
  if (Ex) return Bf;
...
function WL() {
  if (Mx) return Uf;
  Mx = 1;
  var e = X_(), t = FL(), r = /* @__PURE__ */ vv(), n = /* @__PURE__ */ Z_(), a = /* @__PURE__ */ zL(), i = function() {
  };
...
function HL() {
  ...
  if (Ix = 1, process.env.NODE_ENV !== "production") {
    var e = X_(), t = !0;
    io.exports = /* @__PURE__ */ WL()(e.isElement, t);
  } else
    io.exports = /* @__PURE__ */ UL()();
  return io.exports;
}
var KL = /* @__PURE__ */ HL();
const ge = /* @__PURE__ */ xe(KL);
var VL = Object.getOwnPropertyNames, GL = Object.getOwnPropertySymbols, YL = Object.prototype.hasOwnProperty;
function kx(e, t) {
...
function Nx(e) {
  return VL(e).concat(GL(e));
}
var XL = Object.hasOwn || (function(e, t) {
  return YL.call(e, t);
});
function an(e, t) {
  return e === t || !e && !t && e !== e && t !== t;
}
var ZL = "__v", JL = "__o", QL = "_owner", Dx = Object.getOwnPropertyDescriptor, Rx = Object.keys;
function eq(e, t, r) {
  var n = e.length;
  if (t.length !== n)
    return !1;
...
function J_(e, t, r, n) {
  return (n === QL || n === JL || n === ZL) && (e.$$typeof || t.$$typeof) ? !0 : XL(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
var lq = "[object Arguments]", fq = "[object Boolean]", dq = "[object Date]", pq = "[object Error]", hq = "[object Map]", vq = "[object Number]", yq = "[object Object]", mq = "[object RegExp]", gq = "[object Set]", bq = "[object String]", xq = "[object URL]", wq = Array.isArray, Bx = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Fx = Object.assign, Oq = Object.prototype.toString.call.bind(Object.prototype.toString);
function Sq(e) {
  ...
  return function(y, h, v) {
    ...
    if (b === Set)
      return f(y, h, v);
    var x = Oq(y);
    return x === dq ? r(y, h, v) : x === mq ? c(y, h, v) : x === hq ? i(y, h, v) : x === gq ? f(y, h, v) : x === yq ? typeof y.then != "function" && typeof h.then != "function" && s(y, h, v) : x === xq ? d(y, h, v) : x === pq ? n(y, h, v) : x === lq ? s(y, h, v) : x === fq || x === vq || x === bq ? u(y, h, v) : !1;
  };
}
function _q(e) {
  var t = e.circular, r = e.createCustomConfig, n = e.strict, a = {
    areArraysEqual: n ? Sa : eq,
    areDatesEqual: tq,
    areErrorsEqual: rq,
    areFunctionsEqual: nq,
    areMapsEqual: n ? kx(Lx, Sa) : Lx,
    areNumbersEqual: aq,
    areObjectsEqual: n ? Sa : iq,
    arePrimitiveWrappersEqual: oq,
    areRegExpsEqual: sq,
    areSetsEqual: n ? kx(qx, Sa) : qx,
    areTypedArraysEqual: n ? Sa : uq,
    areUrlsEqual: cq
  };
  if (r && (a = Fx({}, a, r(a))), t) {
...
function Pr(e) {
  e === void 0 && (e = {});
  var t = e.circular, r = t === void 0 ? !1 : t, n = e.createInternalComparator, a = e.createState, i = e.strict, o = i === void 0 ? !1 : i, s = _q(e), u = Sq(s), c = n ? n(u) : Aq(u);
  return Pq({ circular: r, comparator: u, createState: a, equals: c, strict: o });
}
function Tq(e) {
  ...
  var e = {}, t = function() {
    ...
    if (!r) {
      if (Array.isArray(i)) {
        if (!i.length)
          return;
        var o = i, s = Cq(o), u = s[0], c = s.slice(1);
        if (typeof u == "number") {
          zx(a.bind(null, c), u);
          return;
        }
...
var Rq = function(t, r) {
  ...
  return t.map(function(a) {
    return "".concat(qq(a), " ").concat(r, "ms ").concat(n);
  }).join(",");
}, Bq = process.env.NODE_ENV !== "production", Uo = function(t, r, n, a, i, o, s, u) {
  if (Bq && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
      console.warn("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
    else {
...
var Ho = 1e-4, tA = function(t, r) {
  ...
  return function(n) {
    var a = tA(t, r), i = [].concat(Hq(a.map(function(o, s) {
      return o * s;
    }).slice(1)), [0]);
    return rA(i, n);
  };
  ...
  var l = Vx(a, o), d = Vx(i, s), p = Yq(a, o), y = function(g) {
...
var Ko = function(t, r, n) {
  ...
  var a = ka(function(i, o) {
    if (gp(o)) {
      var s = t(o.from, o.to, o.velocity), u = nB(s, 2), c = u[0], f = u[1];
      return Ve(Ve({}, o), {}, {
        from: c,
        velocity: f
      });
...
const uB = (function(e, t, r, n, a) {
  var i = Rq(e, t), o = i.reduce(function(v, g) {
    ...
    c || (c = g);
    var b = g - c, x = b / r.dt;
    s = sB(r, s, x), a(Ve(Ve(Ve({}, e), t), d())), c = g, p() || (u = requestAnimationFrame(l));
  }, h = function(g) {
    f || (f = g);
...
var cB = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function lB(e, t) {
  if (e == null) return {};
  var r = fB(e, t), n, a;
  if (Object.getOwnPropertySymbols) {
  ...
  return gB(r, [{
    ...
    value: function(a) {
      ...
      if (s) {
        ...
        if (!(Eq(a.to, f) && a.canBegin && a.isActive)) {
    ...
    key: "runJSAnimation",
    value: function(a) {
      var i = this, o = a.from, s = a.to, u = a.duration, c = a.easing, f = a.begin, l = a.onAnimationEnd, d = a.onAnimationStart, p = uB(o, s, Zq(c), u, this.changeStyle), y = function() {
        i.stopJSAnimation = p();
      };
    ...
    value: function(a) {
      var i = this, o = a.steps, s = a.begin, u = a.onAnimationStart, c = o[0], f = c.style, l = c.duration, d = l === void 0 ? 0 : l, p = function(h, v, g) {
        ...
        return [].concat(Kf(h), [E, b, S]).filter(Lq);
      };
    ...
    value: function() {
      ...
      var u = lB(a, cB), c = zr.count(i), f = this.state.style;
...
var t1 = function(t, r, n, a, i) {
  ...
  var r = e1(e1({}, $B), t), n = Vt(), a = Te(-1), i = SB(a, 2), o = i[0], s = i[1];
  Ue(function() {
...
}, IB = ["points", "className", "baseLinePoints", "connectNulls"];
function vn() {
...
var n1 = function(t) {
  ...
  var r = t.points, n = t.className, a = t.baseLinePoints, i = t.connectNulls, o = kB(t, IB);
  if (!r || !r.length)
    return null;
  var s = le("recharts-polygon", n);
  if (a && a.length) {
    var u = o.stroke && o.stroke !== "none", c = FB(r, a, i);
...
var WB = ["x", "y", "top", "left", "width", "height", "className"];
function Ap() {
...
var XB = function(t, r, n, a, i, o) {
  return "M".concat(t, ",").concat(i, "v").concat(a, "M").concat(o, ",").concat(r, "h").concat(n);
}, ZB = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.top, s = o === void 0 ? 0 : o, u = t.left, c = u === void 0 ? 0 : u, f = t.width, l = f === void 0 ? 0 : f, d = t.height, p = d === void 0 ? 0 : d, y = t.className, h = GB(t, WB), v = UB({
    x: n,
    y: i,
    top: s,
    left: c,
...
var r3 = t3();
const n3 = /* @__PURE__ */ xe(r3);
var a3 = ["cx", "cy", "angle", "ticks", "axisLine"], i3 = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function kn(e) {
  "@babel/helpers - typeof";
...
function c3(e, t, r) {
  return t = Yo(t), l3(e, iA() ? Reflect.construct(t, r || [], Yo(e).constructor) : t.apply(e, r));
}
function l3(e, t) {
...
var Hs = /* @__PURE__ */ (function(e) {
  function t() {
    return s3(this, t), c3(this, t, arguments);
  }
  return d3(t, e), u3(t, [{
    ...
    key: "getViewBox",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, s = n.ticks, u = e3(s, function(f) {
    ...
    key: "renderAxisLine",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, s = n.ticks, u = n.axisLine, c = u1(n, a3), f = s.reduce(function(y, h) {
    ...
    key: "renderTicks",
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, s = a.angle, u = a.tickFormatter, c = a.stroke, f = u1(a, i3), l = this.getTickTextAnchor(), d = ae(f, !1), p = ae(o, !1), y = i.map(function(h, v) {
...
function y3(e, t, r) {
  return t = Xo(t), m3(e, sA() ? Reflect.construct(t, r || [], Xo(e).constructor) : t.apply(e, r));
}
function m3(e, t) {
...
var w3 = Math.PI / 180, d1 = 1e-5, Vs = /* @__PURE__ */ (function(e) {
  function t() {
    return h3(this, t), y3(this, t, arguments);
  }
  return b3(t, e), v3(t, [{
    ...
    value: function() {
      ...
      return /* @__PURE__ */ T.createElement(zB, Dr({
        className: "recharts-polar-angle-axis-line"
      }, c, {
        points: l
      }));
...
function S3() {
  if (h1) return Xf;
  h1 = 1;
  var e = ur(), t = O3(), r = cr(), n = "[object Object]", a = Function.prototype, i = Object.prototype, o = a.toString, s = i.hasOwnProperty, u = o.call(Object);
  function c(f) {
    if (!r(f) || e(f) != n)
      return !1;
    var l = t(f);
...
var b1 = function(t, r, n, a, i) {
  ...
  var r = g1(g1({}, R3), t), n = Vt(), a = Te(-1), i = C3(a, 2), o = i[0], s = i[1];
  Ue(function() {
    if (n.current && n.current.getTotalLength)
      try {
...
}, q3 = ["option", "shapeType", "propTransformer", "activeClassName", "isActive"];
function mi(e) {
  "@babel/helpers - typeof";
...
function w1(e) {
  ...
  switch (t) {
    ...
    case "trapezoid":
      return /* @__PURE__ */ T.createElement(L3, r);
    case "sector":
...
function cA(e) {
  var t = e.option, r = e.shapeType, n = e.propTransformer, a = n === void 0 ? H3 : n, i = e.activeClassName, o = i === void 0 ? "recharts-active-shape" : i, s = e.isActive, u = B3(e, q3), c;
  if (/* @__PURE__ */ It(t))
    c = /* @__PURE__ */ Le(t, Jo(Jo({}, u), V3(t)));
  else if (oe(t))
    c = t(u);
  else if (A3(t) && !T3(t)) {
    var f = a(t, u);
...
function Z3(e, t) {
  var r;
  return Gs(e, t) ? r = G3 : Ys(e, t) ? r = Y3 : gi(e, t) && (r = X3), r;
}
function J3(e, t) {
  var r;
...
function eF(e) {
  var t = e.activeTooltipItem, r = e.graphicalItem, n = e.itemData, a = J3(r, t), i = Q3(r, t), o = n.filter(function(u, c) {
...
function nF(e, t, r) {
  return t = Qo(t), aF(e, lA() ? Reflect.construct(t, r || [], Qo(e).constructor) : t.apply(e, r));
}
function aF(e, t) {
...
var fr = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return tF(this, t), n = nF(this, t, [r]), wt(n, "pieRef", null), wt(n, "sectorRefs", []), wt(n, "id", tn("recharts-pie-")), wt(n, "handleAnimationEnd", function() {
...
var hF = ["Webkit", "Moz", "O", "ms"], vF = function(t, r) {
  var n = t.replace(/(\w)/, function(i) {
    return i.toUpperCase();
  }), a = hF.reduce(function(i, o) {
...
function gF(e, t, r) {
  return t = rs(t), bF(e, hA() ? Reflect.construct(t, r || [], rs(e).constructor) : t.apply(e, r));
}
function bF(e, t) {
...
var SF = function(t) {
  ...
  function t(r) {
    var n;
    return yF(this, t), n = gF(this, t, [r]), lt(n, "handleDrag", function(a) {
  ...
  return wF(t, e), mF(t, [{
    ...
    value: function() {
      ...
      if (!a || !a.length || !V(s) || !V(u) || !V(c) || !V(f) || c <= 0 || f <= 0)
        return null;
      var x = le("recharts-brush", i), O = T.Children.count(o) === 1, m = vF("userSelect", "none");
      return /* @__PURE__ */ T.createElement(fe, {
        className: x,
...
function zF(e, t) {
  var r = e.x, n = e.y, a = BF(e, DF), i = "".concat(r), o = parseInt(i, 10), s = "".concat(n), u = parseInt(s, 10), c = "".concat(t.height || a.height), f = parseInt(c, 10), l = "".concat(t.width || a.width), d = parseInt(l, 10);
...
function YF(e, t, r) {
  return t = as(t), XF(e, gA() ? Reflect.construct(t, r || [], as(e).constructor) : t.apply(e, r));
}
function XF(e, t) {
...
var Er = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = YF(this, t, [].concat(a)), br(r, "state", {
      isAnimationFinished: !1
...
br(Er, "getComposedData", function(e) {
  var t = e.props, r = e.item, n = e.barPosition, a = e.bandSize, i = e.xAxis, o = e.yAxis, s = e.xAxisTicks, u = e.yAxisTicks, c = e.stackedData, f = e.dataStartIndex, l = e.displayedData, d = e.offset, p = SR(n, r);
  if (!p)
    return null;
  var y = t.layout, h = r.type.defaultProps, v = h !== void 0 ? ke(ke({}, h), r.props) : r.props, g = v.dataKey, b = v.children, x = v.minPointSize, O = y === "horizontal" ? o : i, m = c ? O.scale.domain() : null, w = jR({
    numericAxis: O
  }), S = ht(b, Is), A = l.map(function(P, k) {
    var E, I, C, M, $, N;
    c ? E = _R(c[f + k], m) : (E = Ie(P, g), Array.isArray(E) || (E = [w, E]));
    var R = WF(x, mA.defaultProps.minPointSize)(E[1], k);
    if (y === "horizontal") {
...
var l5 = c5();
const f5 = /* @__PURE__ */ xe(l5);
var d5 = KO();
const p5 = /* @__PURE__ */ xe(d5);
var h5 = p5(function(e) {
  return {
    x: e.left,
    y: e.top,
    width: e.width,
...
var bv = /* @__PURE__ */ Lt(void 0), xv = /* @__PURE__ */ Lt(void 0), SA = /* @__PURE__ */ Lt(void 0), _A = /* @__PURE__ */ Lt({}), AA = /* @__PURE__ */ Lt(void 0), PA = /* @__PURE__ */ Lt(0), EA = /* @__PURE__ */ Lt(0), X1 = function(t) {
  var r = t.state, n = r.xAxisMap, a = r.yAxisMap, i = r.offset, o = t.clipPathId, s = t.children, u = t.width, c = t.height, f = h5(i);
...
function S5(e, t, r) {
  return t = os(t), _5(e, MA() ? Reflect.construct(t, r || [], os(e).constructor) : t.apply(e, r));
}
function _5(e, t) {
...
var I5 = function(t, r) {
  ...
  if (a) {
    ...
    return Kt(c, "discard") && EF(m, function(w) {
...
function N5(e) {
  var t = e.x, r = e.y, n = e.segment, a = e.xAxisId, i = e.yAxisId, o = e.shape, s = e.className, u = e.alwaysShow, c = v5(), f = CA(a), l = jA(i), d = g5();
  if (!c || !d)
    return null;
  ...
  var p = gv({
    x: f.scale,
    y: l.scale
  }), y = Fe(t), h = Fe(r), v = n && n.length === 2, g = k5(p, y, h, v, d, e.position, f.orientation, l.orientation, e);
  if (!g)
    return null;
  var b = T5(g, 2), x = b[0], O = x.x, m = x.y, w = b[1], S = w.x, A = w.y, P = Kt(e, "hidden") ? "url(#".concat(c, ")") : void 0, k = J1(J1({
    clipPath: P
  }, ae(e, !0)), {}, {
    x1: O,
    y1: m,
  ...
  }, I5(o, k), Be.renderCallByParent(e, n5({
    x1: O,
    y1: m,
    x2: S,
    y2: A
...
var _v = /* @__PURE__ */ (function(e) {
  ...
  return P5(t, e), O5(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ T.createElement(N5, this.props);
    }
  }]);
})(T.Component);
...
function q5(e, t, r) {
  return t = ss(t), B5(e, IA() ? Reflect.construct(t, r || [], ss(e).constructor) : t.apply(e, r));
}
function B5(e, t) {
...
var U5 = function(t) {
  ...
  function t() {
    return D5(this, t), q5(this, t, arguments);
  }
  return z5(t, e), L5(t, [{
    key: "render",
    value: function() {
...
function G5(e, t, r) {
  return t = us(t), Y5(e, NA() ? Reflect.construct(t, r || [], us(e).constructor) : t.apply(e, r));
}
function Y5(e, t) {
...
var Q5 = function(t, r, n, a, i) {
  ...
  function t() {
    return H5(this, t), G5(this, t, arguments);
  }
  return Z5(t, e), V5(t, [{
    key: "render",
    value: function() {
...
function Av(e, t, r) {
  ...
  if (!a || !a.length || !n)
    return [];
  if (V(u) || Sr.isSsr)
    return r4(a, typeof u == "number" && V(u) ? u : 0);
  ...
  }, v = a.length >= 2 ? et(a[1].coordinate - a[0].coordinate) : 1, g = t4(i, v, p);
  return u === "equidistantPreserveStart" ? n4(v, g, h, a, o) : (u === "preserveStart" || u === "preserveStartEnd" ? d = u4(v, g, h, a, o, u === "preserveStartEnd") : d = s4(v, g, h, a, o), d.filter(function(b) {
    return b.isShow;
  }));
}
var c4 = ["viewBox"], l4 = ["viewBox"], f4 = ["ticks"];
function Un(e) {
  "@babel/helpers - typeof";
...
function v4(e, t, r) {
  return t = ls(t), y4(e, LA() ? Reflect.construct(t, r || [], ls(e).constructor) : t.apply(e, r));
}
function y4(e, t) {
...
var oa = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return p4(this, t), n = v4(this, t, [r]), n.state = {
      fontSize: "",
      letterSpacing: ""
    }, n;
  }
  return g4(t, e), h4(t, [{
    ...
    value: function(n, a) {
      var i = n.viewBox, o = hd(n, c4), s = this.props, u = s.viewBox, c = hd(s, l4);
    ...
    value: function() {
      ...
      if (f)
        return null;
      var l = this.props, d = l.ticks, p = hd(l, f4), y = d;
...
var x4 = ["x1", "y1", "x2", "y2", "key"], w4 = ["offset"];
function Jr(e) {
  "@babel/helpers - typeof";
...
function BA(e, t) {
  ...
  if (/* @__PURE__ */ T.isValidElement(e))
    ...
    var n = t.x1, a = t.y1, i = t.x2, o = t.y2, s = t.key, u = uw(t, x4), c = ae(u, !1);
    c.offset;
    var f = uw(c, w4);
...
function Bi(e) {
  var t, r, n, a, i, o, s = wv(), u = Ov(), c = b5(), f = Xe(Xe({}, e), {}, {
  ...
  }), l = f.x, d = f.y, p = f.width, y = f.height, h = f.syncWithTicks, v = f.horizontalValues, g = f.verticalValues, b = y5(), x = m5();
  if (!V(p) || p <= 0 || !V(y) || y <= 0 || !V(l) || l !== +l || !V(d) || d !== +d)
    return null;
  var O = f.verticalCoordinatesGenerator || M4, m = f.horizontalCoordinatesGenerator || $4, w = f.horizontalPoints, S = f.verticalPoints;
  if ((!w || !w.length) && oe(m)) {
  ...
  return /* @__PURE__ */ T.createElement("g", {
    ...
    height: f.height,
    ry: f.ry
  }), /* @__PURE__ */ T.createElement(E4, Br({}, f, {
    offset: c,
    horizontalPoints: w,
    xAxis: b,
    yAxis: x
  })), /* @__PURE__ */ T.createElement(T4, Br({}, f, {
    offset: c,
    verticalPoints: S,
    xAxis: b,
    yAxis: x
...
var I4 = ["type", "layout", "connectNulls", "ref"], k4 = ["key"];
function Hn(e) {
  "@babel/helpers - typeof";
...
function z4(e, t, r) {
  return t = fs(t), W4(e, FA() ? Reflect.construct(t, r || [], fs(e).constructor) : t.apply(e, r));
}
function W4(e, t) {
...
var Fi = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = z4(this, t, [].concat(a)), Mt(r, "state", {
      isAnimationFinished: !0,
      totalLength: 0
  ...
  return H4(t, e), F4(t, [{
    ...
    value: function(n, a, i, o) {
      ...
      s.ref;
      var l = cw(s, I4), d = ct(ct(ct({}, ae(l, !0)), {}, {
        fill: "none",
    ...
    value: function(n, a) {
      ...
      if (/* @__PURE__ */ T.isValidElement(n))
        ...
        var o = a.key, s = cw(a, k4), u = le("recharts-line-dot", typeof n != "boolean" ? n.className : "");
...
var V4 = ["layout", "type", "stroke", "connectNulls", "isRange", "ref"], G4 = ["key"], WA;
function Kn(e) {
  "@babel/helpers - typeof";
  return Kn = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t) {
    return typeof t;
...
function J4(e, t, r) {
  return t = ds(t), Q4(e, HA() ? Reflect.construct(t, r || [], ds(e).constructor) : t.apply(e, r));
}
function Q4(e, t) {
  if (t && (Kn(t) === "object" || typeof t == "function"))
    return t;
...
var Tr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = J4(this, t, [].concat(a)), Wt(r, "state", {
      isAnimationFinished: !0
...
Wt(Tr, "renderDotItem", function(e, t) {
  ...
  if (/* @__PURE__ */ T.isValidElement(e))
    ...
    var n = le("recharts-area-dot", typeof e != "boolean" ? e.className : ""), a = t.key, i = UA(t, G4);
...
function o6(e, t, r) {
  return t = ps(t), s6(e, VA() ? Reflect.construct(t, r || [], ps(e).constructor) : t.apply(e, r));
}
function s6(e, t) {
...
var dr = /* @__PURE__ */ (function(e) {
  function t() {
    return n6(this, t), o6(this, t, arguments);
  }
  return c6(t, e), i6(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ T.createElement(f6, this.props);
    }
  }]);
})(T.Component);
...
function v6(e, t, r) {
  return t = hs(t), y6(e, XA() ? Reflect.construct(t, r || [], hs(e).constructor) : t.apply(e, r));
}
function y6(e, t) {
...
var x6 = function(t) {
  ...
  function t() {
    return d6(this, t), v6(this, t, arguments);
  }
  return g6(t, e), h6(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ T.createElement(x6, this.props);
    }
  }]);
})(T.Component);
...
var P6 = A6();
const E6 = /* @__PURE__ */ xe(P6);
var yd = new E6(), md = "recharts.syncMouseEvents";
function Oi(e) {
  "@babel/helpers - typeof";
  return Oi = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t) {
    return typeof t;
...
var $6 = /* @__PURE__ */ (function() {
  function e() {
    T6(this, e), gd(this, "activeIndex", 0), gd(this, "coordinateList", []), gd(this, "layout", "horizontal");
  }
  return j6(e, [{
    key: "setDetails",
    value: function(r) {
...
var B6 = ["item"], F6 = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function Yn(e) {
  "@babel/helpers - typeof";
...
function Y6(e, t, r) {
  return t = vs(t), X6(e, tP() ? Reflect.construct(t, r || [], vs(e).constructor) : t.apply(e, r));
}
function X6(e, t) {
...
var Xp = function(t, r, n, a) {
  ...
  var i = a || {
    x: t.chartX,
    y: t.chartY
  }, o = i8(i, n), s = t.orderedTooltipTicks, u = t.tooltipAxis, c = t.tooltipTicks, f = mR(o, s, c, u);
  if (f >= 0 && c) {
    var l = c[f] && c[f].value, d = Xp(t, r, f, l), p = o8(n, s, f, i);
    return {
  ...
  return n.reduce(function(y, h) {
    ...
    I6(g.domain, O, b) && (I = cp(g.domain, null, O), p && (b === "number" || w !== "auto") && (M = Ia(k, x, "category")));
    var $ = iP(b);
    if (!I || I.length === 0) {
      ...
      if (x) {
        if (I = Ia(k, x, b), b === "category" && p) {
          ...
          var z = OR(k, a.filter(function(F) {
  ...
  return n.reduce(function(v, g) {
    ...
    if (!v[x]) {
      ...
      return y ? m = es(0, p) : s && s[x] && s[x].hasStack ? (m = z_(s[x].stackGroups, u, c), m = Vp(l, m, x, i)) : (m = cp(O, D_(d, n.filter(function(w) {
        ...
        hide: !0,
        orientation: pt(n8, "".concat(i, ".").concat(h % 2), null),
        domain: m,
        originalDomain: O,
        isCategorical: y,
        layout: f
  ...
  p && (g.bottom += p.props.height || Ln.defaultProps.height), y && r && (g = xR(g, a, n, r));
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, s = o === void 0 ? ["axis"] : o, u = t.axisComponents, c = t.legendContent, f = t.formatAxisMap, l = t.defaultProps, d = function(g, b) {
    var x = b.graphicalItems, O = b.stackGroups, m = b.offset, w = b.updateId, S = b.dataStartIndex, A = b.dataEndIndex, P = g.barSize, k = g.layout, E = g.barGap, I = g.barCategoryGap, C = g.maxBarSize, M = Ow(k), $ = M.numericAxisName, N = M.cateAxisName, R = f8(x), q = [];
    return x.forEach(function(z, D) {
      ...
      }, re), W = Q[N], G = Q["".concat(N, "Ticks")], Y = O && O[te] && O[te].hasStack && MR(z, O[te].stackGroups), j = nr(z.type).indexOf("Bar") >= 0, ee = Fo(W, G), U = [], ce = R && gR({
        barSize: P,
        stackGroups: O,
        totalSize: p8(Q, N)
      });
    ...
    if (!xg({
      ...
      return null;
    var S = x.children, A = x.layout, P = x.stackOffset, k = x.data, E = x.reverseStackOrder, I = Ow(A), C = I.numericAxisName, M = I.cateAxisName, $ = ht(S, n), N = CR(k, $, "".concat(C, "Id"), "".concat(M, "Id"), P, E), R = u.reduce(function(F, H) {
      var X = "".concat(H.axisType, "Map");
      return B(B({}, F), {}, ie({}, X, c8(x, B(B({}, H), {}, {
        graphicalItems: $,
    ...
    var z = R["".concat(M, "Map")], D = l8(z), L = d(x, B(B({}, R), {}, {
      dataStartIndex: O,
      dataEndIndex: m,
      updateId: w,
      graphicalItems: $,
    ...
    function g(b) {
      var x, O, m;
      return K6(this, g), m = Y6(this, g, [b]), ie(m, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), ie(m, "accessibilityManager", new $6()), ie(m, "handleLegendBBoxUpdate", function(w) {
        if (w) {
        ...
        var S = Jj(w), A = pt(m.props, "".concat(S));
        if (S && oe(A)) {
          var P, k;
        ...
        return /* @__PURE__ */ T.createElement(q6, {
          key: q,
          activeCoordinate: k,
          activePayload: E,
    ...
    return J6(g, v), G6(g, [{
      ...
      value: function(x) {
        if (!this.container)
          return null;
        var O = this.container, m = O.getBoundingClientRect(), w = fI(m), S = {
      ...
      value: function() {
        ...
        if (!xg(this))
          return null;
        var O = this.props, m = O.children, w = O.className, S = O.width, A = O.height, P = O.style, k = O.compact, E = O.title, I = O.desc, C = gw(O, F6), M = ae(C, !1);
        if (k)
...
const b8 = ({ id: e, className: t, children: r, aspect: n, config: a, ...i }, o) => {
...
const x8 = ({ id: e, config: t }) => {
  const r = Object.entries(t).filter(([a, i]) => i.theme || i.color);
  if (!r.length)
    return null;
  const n = Object.entries(g8).map(([a, i]) => `
${i} [data-chart=${e}] {
${r.map(([o, s]) => {
...
const w8 = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";
let O8 = (e = 21) => {
...
const _8 = ({ index: e, visibleTicksCount: t, payload: r, tickFormatter: n, ...a }) => {
  ...
  const { enabled: f } = S8(), l = Object.keys(t), d = O8(12), p = jv(e), y = Math.max(...p.flatMap((x) => l.map((O) => Wi(n?.tickFormatter ? n.tickFormatter(`${x[O]}`) : `${x[O]}`)))), h = n?.width ?? y + 20, v = !n?.hide, g = !r?.hide, b = !a || !f;
  return _(sa, {
    config: t,
    ref: c,
    aspect: s,
...
const Iv = ue.forwardRef(({ className: e, href: t, onClick: r, disabled: n, children: a, ...i }, o) => {
  ...
  return K("div", {
    ref: o,
    role: "article",
    className: Z("flex flex-col items-stretch rounded-xl border border-solid border-f1-border-secondary bg-f1-background-inverse-secondary p-4 shadow", (t || r) && !n && "cursor-pointer transition-all duration-200 hover:border-f1-border-hover hover:shadow-md", e),
    ...i,
    onClick: () => {
      if (!n && !t && r)
        return r();

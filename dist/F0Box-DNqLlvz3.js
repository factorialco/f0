...
import { t } from "./component-DIiKjQeI.js";
import { t as n } from "./utils-CVzxZnoI.js";
import { forwardRef as r } from "react";
import { jsx as i } from "react/jsx-runtime";
//#region src/lib/F0Box/utils/background.ts
var a = { background: {
...
var E = e({
	...
	"lg",
	"xl"
], O = r(({ display: e, position: t, top: r, right: a, bottom: o, left: s, zIndex: c, padding: l, paddingX: u, paddingY: d, paddingTop: f, paddingBottom: p, paddingLeft: m, paddingRight: h, margin: g, marginX: _, marginY: v, marginTop: y, marginBottom: b, marginLeft: x, marginRight: S, gap: C, columns: w, rows: O, colSpan: k, colStart: A, rowSpan: j, width: M, height: N, minWidth: ee, minHeight: te, maxWidth: ne, maxHeight: P, background: F, borderColor: I, border: L, borderTop: R, borderBottom: z, borderLeft: B, borderRight: V, borderRadius: H, borderRadiusTopLeft: U, borderRadiusTopRight: W, borderRadiusBottomLeft: G, borderRadiusBottomRight: K, borderStyle: q, overflow: J, overflowX: Y, overflowY: re, divider: X, dividerColor: Z, boxShadow: ie, alignItems: ae, justifyContent: oe, flexDirection: se, flexWrap: ce, grow: le, shrink: ue, sm: de, md: fe, lg: Q, xl: pe, ...me }, he) => {
	let $ = R && R !== "none" || z && z !== "none" || B && B !== "none" || V && V !== "none", ge = L && L !== "none" || $, _e = {
		sm: de,
		md: fe,
		lg: Q,
		xl: pe
	...
	return /* @__PURE__ */ i("div", {
		...
		className: n($ && "border-0", E({
			...
			shrink: ue,
			boxShadow: ie
		}), ve, ge && !I && "border-f1-border", X && !Z && "divide-f1-border", "scrollbar-macos"),
		...me
	});
});
O.displayName = "F0Box";
//#endregion
//#region src/lib/F0Box/index.tsx
var k = t({
	name: "F0Box",
	type: "layout"
}, O);

...
function $t(e, t, o, n) {
  return typeof e == "string" && p1(t) ? Ir(e, o, n) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function Ss(e, t, o) {
  return e * (t + 1);
}
...
function Bt(e, t) {
  return Pr(e) ? e[Ts(0, e.length, t)] : e;
}
function Hs(e, t, o) {
  for (let n = 0; n < e.length; n++) {
    const s = e[n];
    s.at > t && s.at < o && (Dr(e, s), n--);
  }
}
...
const Is = "easeInOut", Ps = 20;
function js(e, { defaultTransition: t = {}, ...o } = {}, n, s) {
  ...
  for (let g = 0; g < e.length; g++) {
    ...
    if (typeof m == "string") {
      ...
      f.set(m.name, F1(C, m.at, u, f));
      continue;
    }
    let [v, w, x = {}] = m;
    x.at !== void 0 && (C = F1(C, x.at, u, f));
    let H = 0;
    const S = (N, y, k, T = 0, V = 0) => {
      const $ = Ds(N), { delay: F = 0, times: M = Zr($), type: B = "keyframes", repeat: _, repeatType: z, repeatDelay: G = 0, ...re } = y;
      let { ease: Y = t.ease || "easeOut", duration: O } = y;
      const Z = typeof F == "function" ? F(T, V) : F, D = $.length, Q = Ur(B) ? B : s?.[B];
      if (D <= 2 && Q) {
        let ie = 100;
        if (D === 2 && Os($)) {
          const ce = $[1] - $[0];
        ...
        const oe = { ...re };
        O !== void 0 && (oe.duration = zr(O));
        const se = _r(oe, ie, Q);
        Y = se.ease, O = se.duration;
      }
      O ?? (O = i);
      const W = C + Z;
      M.length === 1 && M[0] === 0 && (M[1] = 1);
      const fe = M.length - $.length;
      if (fe > 0 && Or(M, fe), $.length === 1 && $.unshift(null), _) {
        ct(_ < Ps, "Repeat count too high, must be less than 20"), O = Ss(O, _);
        const ie = [...$], oe = [...M];
        ...
        for (let ce = 0; ce < _; ce++) {
          ...
          for (let L = 0; L < ie.length; L++)
            M.push(oe[L] + (ce + 1)), Y.push(L === 0 ? "linear" : Bt(se, L - 1));
        }
        $s(M, _);
      }
      const he = W + O;
      As(k, $, Y, M, W, he), H = Math.max(Z + O, H), p = Math.max(he, p);
    };
    if (at(v)) {
      const N = N1(v, d);
      S(w, x, V1("default", N));
    } else {
      const N = $t(v, w, n, l), y = N.length;
      for (let k = 0; k < y; k++) {
        w = w, x = x;
  ...
  return d.forEach((g, m) => {
    for (const v in g) {
      ...
      for (let y = 0; y < w.length; y++) {
        ...
        x.push(T), H.push(Gr(0, p, k)), S.push(V || "easeOut");
      }
      H[0] !== 0 && (H.unshift(0), x.unshift(x[0]), S.unshift(Is)), H[H.length - 1] !== 1 && (H.push(1), x.push(null)), a.has(m) || a.set(m, {
        keyframes: {},
        transition: {}
      });
      const N = a.get(m);
...
const _s = (e) => typeof e == "number", Os = (e) => e.every(_s);
function Us(e, t) {
  return e in t;
}
class zs extends Wr {
...
function qs(e, t) {
  return at(e) || typeof e == "number" || typeof e == "string" && !p1(t);
}
function It(e, t, o, n) {
  const s = [];
  if (qs(e, t))
    s.push(Jr(e, p1(t) && t.default || t, o && (o.default || o)));
  else {
    const i = $t(e, t, n), a = i.length;
    ct(!!a, "No valid elements provided.");
    for (let d = 0; d < a; d++) {
      const l = i[d], f = l instanceof Element ? Gs : Ws;
      ze.has(l) || f(l);
      const u = ze.get(l), C = { ...o };
      "delay" in C && typeof C.delay == "function" && (C.delay = C.delay(d, a)), s.push(...eo(u, { ...t, transition: C }, {}));
    }
  }
  return s;
}
function Xs(e, t, o) {
  const n = [];
  return js(e, t, o, { spring: to }).forEach(({ keyframes: i, transition: a }, d) => {
    n.push(...It(d, i, a));
  }), n;
}
class Ys {
...
function Js(e) {
  function t(o, n, s) {
    let i = [];
    return Qs(o) ? i = Xs(o, n, e) : i = It(o, n, s, e), new Ks(i);
  }
  return t;
}
const ei = Js(), ti = (e, t) => /* @__PURE__ */ c(
  "svg",
  {
...
const bc = (e, t) => /* @__PURE__ */ c(
...
), c2 = h(a2), l2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: ri,
  Add: ro,
  Ai: ni,
  ...
  Calculator: vo,
  Calendar: wo,
  CalendarArrowDown: Vi,
  CalendarArrowLeft: Ti,
  CalendarArrowRight: Ai,
  CameraPlus: Bi,
  CardPin: Pi,
  ChartFunnel: Di,
  ChartHorizontalBars: _i,
  ChartLine: Ui,
  ChartPie: Gi,
  ChartVerticalBars: qi,
  Check: ut,
  CheckCircle: xo,
  CheckCircleLine: Yi,
  CheckDouble: ko,
  ...
  FaceNeutral: Zo,
  FacePositive: _o,
  FaceSuperNegative: Oo,
  FaceSuperPositive: Uo,
  Feed: Aa,
  File: Ba,
  FileFilled: Pa,
  FileSigned: Da,
  ...
  Wifi: c2,
  Windows: Zn
}, Symbol.toStringTag, { value: "Module" })), d2 = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
  ...
  return /* @__PURE__ */ r(
    ue,
    {
      ...
      variant: "ai",
      ref: t,
      iconRotate: e.icon == u2
    }
  );
});
Gt.displayName = "AIButton";
const Wt = {
  background: {
...
const N2 = Ve({
  ...
  ({
    ...
    const He = D && D !== "none" || Q && Q !== "none" || W && W !== "none" || fe && fe !== "none", Pe = Z && Z !== "none" || He, Je = { sm: Xe, md: Ye, lg: Ie, xl: Ke }, e1 = V2.map((je) => {
      const De = Je[je];
      return De ? F2(je, De) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
const r1 = _n(
  ...
  return u === "recording" ? /* @__PURE__ */ c("div", { className: "flex shrink-0 items-center gap-3 p-3", children: [
    ...
    /* @__PURE__ */ r("div", { className: "flex items-center gap-2", children: e && /* @__PURE__ */ c(Ee, { children: [
      /* @__PURE__ */ r(
        ue,
        {
  ...
  const n = /* @__PURE__ */ c("div", { className: "flex items-center gap-1.5 rounded-lg border border-f1-border-critical bg-f1-background-critical/10 px-2.5 py-1.5", children: [
    ...
    /* @__PURE__ */ r(
      "button",
      {
        ...
        onClick: () => t(e.id),
        children: /* @__PURE__ */ r(le, { icon: Re, size: "md", "aria-hidden": "true" })
      }
    )
  ] });
  return e.errorMessage ? /* @__PURE__ */ r(Un, { label: e.errorMessage, children: n }) : n;
}
const A2 = {
  soft: {
    text: "",
...
function B2({
  ...
  K(() => {
    ...
    const u = a.current, C = u?.offsetParent;
    if (!u || !C) return;
    const p = u.offsetLeft + u.offsetWidth - C.clientWidth;
  ...
  return !e || f ? null : /* @__PURE__ */ r(
    "div",
    {
      ...
      children: l ? Array.from({ length: 3 }, (u, C) => /* @__PURE__ */ c(
        ...
        const p = C === n, g = `${u.firstName} ${u.lastName}`.trim();
        return /* @__PURE__ */ c(
          "div",
          {
            ref: p ? d : void 0,
...
const I2 = ({
  ...
  const s = Le(), [i, a] = I(""), [d, l] = I(0), [f, u] = I(!1), C = P(null), p = P(null), g = P(null), m = e[d] ?? t;
  return K(() => {
    const v = () => {
      p.current && (clearInterval(p.current), p.current = null), g.current && (clearInterval(g.current), g.current = null), C.current && (clearTimeout(C.current), C.current = null);
    };
    if (o.length > 0 || n) {
      u(!1), a(""), v();
      return;
    ...
    if (s)
      return u(!1), a(m), v(), C.current = setTimeout(() => {
    ...
    return p.current = setInterval(() => {
      w < m.length ? (a(m.slice(0, w + 1)), w++) : (p.current && (clearInterval(p.current), p.current = null), C.current = setTimeout(() => {
        g.current = setInterval(() => {
          w > 0 ? (w--, a(m.slice(0, w))) : (g.current && (clearInterval(g.current), g.current = null), C.current = setTimeout(() => {
            const y = (d + 1) % Math.max(e.length, 1);
            l(y);
          }, N));
        }, H);
    ...
    e.length,
    s
  ]), o.length > 0 || n ? null : /* @__PURE__ */ r(Fe, { children: /* @__PURE__ */ r(
    ne.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
...
const _2 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ c(
    u1,
    {
      ...
      children: [
        /* @__PURE__ */ r(Gn, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ r(f1, { asChild: !0, children: /* @__PURE__ */ r(
          ue,
          {
            variant: "outline",
            label: d.label,
        ...
        a && /* @__PURE__ */ c(
          h1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: Z2(a.items).map((d, l) => /* @__PURE__ */ c(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
function O2(e, t, o) {
  ...
  for (const u of t) {
    ...
    let p = 0;
    for (; ; ) {
      const g = e.indexOf(C, p);
      if (g === -1) break;
      i.push({ start: g, end: g + C.length }), p = g + C.length;
    }
  }
...
function W2(e) {
  const [t, o] = I([]), [n, s] = I(null), i = P(
    null
  ), a = P(null), d = X(), l = e?.onUploadFiles, f = e?.allowedMimeTypes, u = e?.maxFiles, C = te(() => {
    if (f)
      return Array.isArray(f) ? f.join(",") : f;
  }, [f]), p = u !== void 0 && t.length >= u, g = P(0);
  K(() => {
    g.current = t.length;
  }, [t]);
  const m = q((S) => {
...
function Q2({
  ...
  const [i, a] = I(!1), [d, l] = I(""), [f, u] = I([]), [C, p] = I(!1), [g, m] = I(0), [v, w] = I([]), x = P(-1), H = P(null), S = P(0), N = P(-1);
  K(() => {
    if (!n) {
      a(!1);
      return;
    ...
    if (M.atIndex === N.current)
      return;
    x.current = M.atIndex, l(M.query), a(!0), m(0), p(!0), H.current && clearTimeout(H.current);
    const B = ++S.current;
  ...
  const y = q(() => {
    ...
    (M) => {
      const B = x.current;
      if (B === -1) return;
      const _ = `${M.firstName} ${M.lastName}`.trim(), z = String(M.id), G = e.slice(0, B), re = e.slice(o), Y = `@${_} `, O = G + Y + re, Z = G.length + Y.length;
...
` || G === "	";
  ...
  const $ = te(() => {
    ...
    const M = s.current;
    if (!M) return null;
    const B = Y2(M, x.current), _ = M.offsetLeft + B.left, G = (M.offsetParent ? M.offsetParent.offsetHeight : 0) - (M.offsetTop + B.top);
...
const J2 = /[\\`*_{}[\]()#+\-.!|~>]/g, el = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, o) => o % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(J2, "\\$&")).join(""), F6 = ({
  onSubmit: e,
  onStop: t,
  inProgress: o,
  onBeforeSubmit: n,
  ...
  const k = X(), T = Le(), [V, $] = I(""), [F, M] = I(0), [B, _] = I(!1), [z, G] = I(!1), [re, Y] = I(null), O = P(null), Z = P(null), D = P(null), Q = a != null, { tracking: W } = be(), fe = q(
    (ee, xe) => {
  ...
  const Ie = Ce.status === "recording", Ke = Ie ? k.ai.listening : k.ai.inputPlaceholder, Qe = he.filter((ee) => ee.status === "uploaded"), Ne = he.some((ee) => ee.status === "uploading"), He = he.some((ee) => ee.status === "error"), Pe = V.trim().length > 0;
  K(() => {
    if (!(!z || Ne)) {
      if (G(!1), He) {
  ...
  const Je = async (ee) => {
    if (ee.preventDefault(), !Q) {
      if (J.close(), o)
        ...
        const xe = J.transformMentions(V.trim()), t1 = el(xe), _e = Qe.flatMap(
  ...
  }, x1 = re ? re.prompt ?? re.title : null, k1 = Ie ? [k.ai.listening] : x1 ? [x1] : s ?? [], Sr = k1.length > 1, Tr = te(() => O2(V, J.mentions, {
    cursorPosition: F,
    inlineCompletion: J.inlineCompletion
  }), [V, J.mentions, F, J.inlineCompletion]), Hr = J.mentions.length > 0 || J.inlineCompletion !== null, Ze = x && !!S && S.length > 0 && !!N ? /* @__PURE__ */ r(
    _2,
    {
      suggestions: S,
      onItemClick: fe,
    ...
    ne.div,
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full max-w-content flex-col gap-2", children: [
          ...
          /* @__PURE__ */ r($2, { creditWarning: i, children: /* @__PURE__ */ c(
            ne.form,
            {
              "aria-busy": o,
              ref: O,
              ...
              children: [
                ...
                /* @__PURE__ */ r(Fe, { initial: !1, children: Q ? /* @__PURE__ */ r(
                  ne.div,
                  {
                  ...
                  ne.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ r(Fe, { initial: !1, children: U && /* @__PURE__ */ r(
                        ne.div,
                        {
                          role: "alert",
                          "aria-live": "polite",
                          ...
                          children: /* @__PURE__ */ c(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ r("div", { className: "h-6 w-6 flex-shrink-0", children: /* @__PURE__ */ r(Xn, { type: "critical", size: "sm" }) }),
                      ...
                      /* @__PURE__ */ r(
                        j2,
                        {
                          ...
                          onCursorUpdate: je,
                          onScroll: De,
                          highlightSegments: Tr,
                          hasOverlay: Hr,
                          multiplePlaceholders: Sr,
                          placeholders: k1,
        ...
        /* @__PURE__ */ r(Fe, { mode: "wait", initial: !1, children: Q ? /* @__PURE__ */ c(
          ne.div,
          {
...
function il({
  ...
  return /* @__PURE__ */ r(Kn, { ...t, variant: "link", href: t.href, children: e });
}
function al({
  children: e,
  ...t
...
function ll({
  ...
  return /* @__PURE__ */ r("li", { ...t, className: b("mb-2", t.className), children: e });
}
...
function gl({
  ...
  return /* @__PURE__ */ r("p", { ...t, className: b("text-base font-normal", t.className), children: e });
}
function Cl({
  children: e,
  ...t
...
function vl({
  ...
  return /* @__PURE__ */ r("strong", { ...t, className: b("font-semibold", t.className), children: e });
}
function wl({
  children: e,
  ...t
}) {
  return /* @__PURE__ */ r("em", { ...t, className: b("italic", t.className), children: e });
}
function Se({
  id: e,
  trigger: t,
  ...
  return /* @__PURE__ */ c(
    Qn,
    {
      ...
      children: [
        /* @__PURE__ */ r(Jn, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          es,
          {
            side: "top",
...
ir.displayName = "CandidateTrigger";
function xl({
  id: e,
  label: t
}) {
...
lr.displayName = "RequisitionTrigger";
function yl({
  id: e,
  label: t
}) {
...
dr.displayName = "PersonTrigger";
function Ml({ id: e, label: t }) {
...
ur.displayName = "VacancyTrigger";
function El({ id: e, label: t }) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex w-full min-w-0 flex-row items-center gap-3", children: [
          ...
          e?.type === "file" && /* @__PURE__ */ r(rs, { file: e.file, size: "lg" }),
...
function Vl(e) {
  ...
  return te(() => !o || o.length === 0 ? null : (n, s, i) => {
    ...
    for (const l of o) {
      ...
      if (!f || !u) continue;
      let C = 0;
      l.formName !== void 0 && (C += 2), l.customFieldName !== void 0 && (C += 1), C > d && (d = C, a = l);
    }
    if (a)
...
const T1 = 7, Sl = 625, H1 = /* @__PURE__ */ new Set();
function Tl(e) {
...
function Al(e) {
  const { days: t, hours: o, minutes: n, seconds: s } = ns(e), i = [];
...
function hr(e, t) {
  ...
  if (t === "duration" && typeof e == "number")
    return { type: "item", text: Al(e) };
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const o = e.value;
    return { type: "item", text: (o ? Tl(o) : "") || "—" };
  }
  ...
  return { type: "item", text: Hl(String(e)) };
}
function gr({
  formName: e,
  formDescription: t,
  ...
  const { canvasContent: l, openCanvas: f, closeCanvas: u } = be(), C = Vl(e), p = d ?? C, g = P(() => {
  ...
  g.current = x, K(() => {
    typeof window > "u" || window.innerWidth < Sl || H1.has(e) || (H1.add(e), g.current());
  }, [e]);
  const H = i && a ? Object.entries(i).map(([y, k]) => {
    ...
    if (!V && k.fieldType === "custom" && typeof T == "object" && T !== null)
      return null;
    const $ = V ?? hr(T, k.fieldType), F = ["richtext", "textarea"];
    return {
      label: k.label,
      content: $,
...
gr.displayName = "FormCard";
function $l() {
  const e = ss(), t = e?.activeForm;
  if (!t) return null;
...
const I1 = 8, Ae = 8;
function pr({ anchor: e, onReply: t }) {
  ...
  if (st(() => {
    ...
    let p = e.rect.top - f - I1;
    p < Ae && (p = e.rect.bottom + I1), p = Math.min(
      Math.max(p, Ae),
      C - f - Ae
    );
...
const mr = Ge(void 0), T6 = () => Be(mr), Pl = (e) => /* @__PURE__ */ r(Rt, { content: e, format: "markdown" }), jl = ({
  isGenerating: e,
  isLoading: t,
  message: o,
  renderToolCall: n,
  ...
  const d = typeof o?.content == "string" ? o.content : "", l = (o && n?.(o)) ?? o?.generativeUI?.() ?? null, f = o?.toolCalls?.[0]?.id, u = !d && !l, C = P(null), { anchor: p, clear: g } = Cr({
    containerRef: C,
    enabled: !!(o?.id && d)
  });
  return K(() => {
    o?.id && !t && !e && i?.(o);
  }, [o, t, e, i]), !t && !e && u ? null : /* @__PURE__ */ r(mr.Provider, { value: f, children: /* @__PURE__ */ c("div", { className: "relative isolate flex w-full flex-col items-start justify-center", children: [
    o && d && /* @__PURE__ */ r(
      "div",
      {
        ref: C,
  ...
  return /* @__PURE__ */ r(vr.Provider, { value: n, children: e });
}, wr = () => {
  const e = Be(vr);
  if (e === null)
    throw new Error(
...
const Ol = ({
  ...
  const n = X(), { open: s } = wr(), [i, a] = I(null);
  ...
  const [d, l] = I(s), f = Le(), u = n !== void 0, C = u ? n : d;
  return /* @__PURE__ */ c(
    Ft,
    {
  ...
  const l = o ? s.ai.thoughtsGroupTitle : t ?? s.ai.thoughtsGroupTitle, f = e.length - 1, u = (C) => !o || n ? "completed" : C === f ? "executing" : "completed";
  return /* @__PURE__ */ r(
    Ul,
    {
      icon: Pt,
      ...
      onOpenChange: a,
      lockOpen: o,
      children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pb-4", children: e.map((C, p) => /* @__PURE__ */ c("div", { className: "relative", children: [
        /* @__PURE__ */ r(
          s1,
          {
            title: C,
...
const xr = (e) => /* @__PURE__ */ r(Rt, { content: e, format: "markdown" }), ql = ({
  text: e,
  renderMarkdown: t
  ...
  /* @__PURE__ */ r("div", { className: "min-w-0 whitespace-pre-wrap text-base leading-5 [&>div]:flex [&>div]:flex-col [&>div]:gap-1 [&_p]:m-0", children: (t ?? xr)(e) })
] }), Xl = ({
  message: e,
  onReplyQuote: t,
  ...
  const a = e.rawData, d = Wl(
    e?.content,
    a
  ), l = (Gl(e?.content) ?? "").trim(), f = e?.replyQuote ?? null, u = l.length > 0, { anchor: C, clear: p } = Cr({
    containerRef: i,
    enabled: u
  });
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        f && /* @__PURE__ */ r(ql, { text: f, renderMarkdown: n }),
        ...
        /* @__PURE__ */ r(
          pr,
          {
            anchor: C,
            onReply: (g) => {
              t?.(g), p(), window.getSelection()?.removeAllRanges();
            }
          }
        )
      ]
...
}, Yl = 35, Kl = 22, Ql = 400, Jl = 2500, e4 = 220, t4 = ({
  messages: e,
  onClick: t,
  fullscreen: o = !1
}) => {
  ...
  K(() => {
    ...
    let p;
    if (d === "starting")
      p = setTimeout(() => l("writing"), Ql);
    else if (d === "writing")
      i < f.length ? p = setTimeout(() => a((g) => g + 1), Yl) : l("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      p = setTimeout(() => l("erasing"), Jl);
    } else d === "erasing" && (i > 0 ? p = setTimeout(() => a((g) => g - 1), Kl) : p = setTimeout(() => {
  ...
  const u = !!t, C = u ? (p) => {
    (p.key === "Enter" || p.key === " ") && (p.preventDefault(), t?.());
  } : void 0;
  return /* @__PURE__ */ r(
    "div",
    {
...
function r4({
  ...
  const [a, d] = I(0), [l, f] = I(!1), u = P(s), C = P(i);
  C.current = i;
  const p = q(
    (m = "smooth") => {
  ...
  }, [s, n, e]), { showScrollBtn: l, turnMinHeight: a, scrollToBottom: p };
}
const o4 = {
  threadId: "",
  onThumbsUp: () => {
...
}, H6 = (e) => /* @__PURE__ */ r(Zl, { children: /* @__PURE__ */ r(n4, { ...e }) }), n4 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: o,
  initialMessage: n,
  ...
  const { modal: S, handleSubmit: N, handleClose: y } = _l(
    u ?? o4
  ), k = X(), T = v ?? jl, V = w ?? Xl, $ = te(() => {
    const D = n ?? k.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((W) => typeof W == "string" && W.length > 0);
  }, [n, k.ai.defaultInitialMessage]), F = !t && e.length === 0 && $.length > 0, M = P(null), B = P(null), _ = P(null), z = P(null), G = P(null), { showScrollBtn: re, turnMinHeight: Y, scrollToBottom: O } = r4({
    viewportRef: M,
    contentRef: B,
    endRef: _,
    lastTurnRef: G,
    turnsCount: e.length,
    freezeTurnMinHeight: C
  }), Z = (D, Q) => {
    const W = Q === e.length - 1, fe = {
      ...
      const ce = W && se === D.assistantMessages.length - 1, L = D.userMessages.length + se, R = {
        message: oe,
        inProgress: D.isInProgress,
        index: L,
        isCurrentMessage: ce,
      ...
      return /* @__PURE__ */ r(
        T,
        {
          ...
          isLoading: D.isInProgress && ce && !oe.content
        },
        `${Q}-a-${se}`
      );
    };
          ...
          children: /* @__PURE__ */ c(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r(Fe, { children: re && /* @__PURE__ */ r(
                  ne.div,
                  {
...
}, s4 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
...
function $6({
  ...
  return /* @__PURE__ */ r(kr.Provider, { value: t, children: e });
}
function B6() {
  const e = Be(kr);
  if (e === null)
...
const a4 = ({
  ...
  const p = X().ai.clarifyingQuestion.typeYourAnswer, g = e === "single" ? /* @__PURE__ */ r(Lr, { isSelected: o && !t }) : /* @__PURE__ */ r(
    St,
    {
      checked: s,
      onCheckedChange: () => f(!s),
...
const l4 = ({
  ...
  const o = X(), n = Le(), {
    ...
    current: String(i + 1),
    total: String(a)
  }) : void 0, _ = x.length > 0, z = (y ?? "").trim().length > 0, G = _ || k && z || S === !0, re = t === !0 && M, Y = () => {
    re || l();
  }, O = () => {
    re || f();
  }, Z = (ie) => {
    const oe = V === "single" && x.includes(ie);
    d(ie), V === "single" && !M && !oe && Promise.resolve().then(l);
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-col", onKeyDown: fe, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(Fe, { mode: "wait", initial: !1, children: /* @__PURE__ */ c(
      ne.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: he, ease: u4 },
        children: [
          /* @__PURE__ */ r(
            d4,
            {
...
function j1(e, t, o, n) {
  const s = Math.max(1, Math.min(e, t)), i = Math.min(o, 20), d = Math.min(i + n, s), l = Math.min(d, Math.floor(e / 2)), f = Math.min(d, Math.floor(t / 2)), u = (W) => W / e * 2 - 1, C = (W) => W / t * 2 - 1, p = 0, g = e, m = 0, v = t, w = l, x = e - l, H = f, S = t - f, N = u(p), y = u(g), k = C(m), T = C(v), V = u(w), $ = u(x), F = C(H), M = C(S), B = 0, _ = 0, z = 1, G = 1, re = l / e, Y = 1 - l / e, O = f / t, Z = 1 - f / t, D = new Float32Array([
    // Top strip
    N,
    k,
    y,
...
class j6 {
  ...
  resize(t, o, n) {
    ...
    const { gl: s, program: i, vao: a, positionBuffer: d, uvBuffer: l, uResolution: f } = this.glr, u = n ?? this.options.ratio ?? window.devicePixelRatio ?? 1, C = Math.max(1, Math.floor(t * u)), p = Math.max(1, Math.floor(o * u));
    this.canvas.style.width = `${t}px`, this.canvas.style.height = `${o}px`, (this.canvas.width !== C || this.canvas.height !== p) && (this.canvas.width = C, this.canvas.height = p), s.viewport(0, 0, this.canvas.width, this.canvas.height), this.checkGLError(s, "resize: after viewport setup");
  ...
  setupGL() {
    ...
    const p = t.getUniformLocation(o, "uResolution"), g = t.getUniformLocation(o, "uTime"), m = t.getUniformLocation(o, "uBorderWidth"), v = t.getUniformLocation(o, "uGlowWidth"), w = t.getUniformLocation(o, "uBorderRadius"), x = t.getUniformLocation(o, "uColors"), H = t.getUniformLocation(o, "uGlowExponent"), S = t.getUniformLocation(o, "uGlowFactor");
    ...
    const N = (this.options.colors || m4).map(v4);
...
const Z1 = ["lowp", "mediump", "highp"], w4 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, x4 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, O1 = "iTime", U1 = "iTimeDelta", z1 = "iDate", G1 = "iFrame", W1 = "iMouse", q1 = "iResolution", k4 = "iChannel", X1 = "iChannelResolution", Y1 = "iDeviceOrientation";
function L4(e, t) {
...
}, o1 = 9729, K1 = 9728, R4 = 9987, Q1 = 33071, J1 = 10497;
class F4 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    const C = 0, p = o.RGBA, g = 1, m = 1, v = 0, w = o.RGBA, x = o.UNSIGNED_BYTE, H = new Uint8Array([255, 255, 255, 0]), S = o.createTexture();
...
}, tt = (e, t, o) => e * (1 - o) + t * o, N4 = (e, t, o) => o > 0 ? e.substring(0, o) + t + e.substring(o, e.length) : t + e;
function V4({
  fs: e,
  vs: t = _1,
  textures: o = [],
  ...
  const g = P(null), m = P(null), v = P(null), w = P(null), x = P(void 0), H = P(void 0), S = P(!1), N = P(void 0), y = P(0), k = P([0, 0]), T = P([]), V = P(0), $ = P(void 0), F = P({
    ...
    const E = "width" in L ? L.width ?? 0 : 0, j = "height" in L ? L.height ?? 0 : 0, A = F.current.iChannelResolution;
    if (!A) return;
    ...
    const [R = 0, E = 0] = et(L), j = R - (N.current?.left ?? 0) - window.pageXOffset, A = (N.current?.height ?? 0) - E - (N.current?.top ?? 0) - window.pageYOffset;
    S.current = !0;
    ...
    const [R = 0, E = 0] = et(L), j = R - (N.current?.left ?? 0), A = (N.current?.height ?? 0) - E - (N.current?.top ?? 0);
    if (l !== 1)
    ...
    const L = Array.isArray(F.current.iMouse?.value) ? F.current.iMouse.value : void 0;
    L && (L[2] = 0, L[3] = 0);
  }, Z = () => {
    const L = m.current;
    if (!L) return;
    ...
    if (L.canvas.width = E, L.canvas.height = j, F.current.iResolution?.isNeeded && w.current) {
    ...
    const E = m.current;
    if (!E) return null;
    const j = E.createShader(L);
    if (!j) return null;
    if (E.shaderSource(j, R), E.compileShader(j), !E.getShaderParameter(j, E.COMPILE_STATUS)) {
      p?.(ke(`Error compiling the shader:
${R}`));
      const A = E.getShaderInfoLog(j);
      E.deleteShader(j), C?.(ke(`Shader compiler log: ${A}`));
    }
    return j;
  }, Q = (L, R) => {
    const E = m.current;
    if (!E) return;
    const j = D(E.FRAGMENT_SHADER, L), A = D(E.VERTEX_SHADER, R);
      ...
      if (o && o.length > 0) {
        ...
        const R = o.map(
          (E, j) => (F.current[`${k4}${j}`] = {
            type: "sampler2D",
            isNeeded: !1
          }, B(E, j), T.current[j] = new F4(L), T.current[j]?.load(E).then((A) => {
            B(A, j);
          }))
        );
        Promise.all(R).then(() => {
...
`,
    ...
    return L.includes("mainImage") && (j = j.concat(w4)), j;
  }, ie = (L) => {
    const R = m.current;
    if (!R || !w.current) return;
    const E = V.current ? (L - V.current) / 1e3 : 0;
    V.current = L;
    const j = M.current;
    if (j)
    ...
    if (T.current.length > 0)
      for (let A = 0; A < T.current.length; A++) {
        ...
        if (F.current[`iChannel${A}`]?.isNeeded) {
          ...
          R.activeTexture(R.TEXTURE0 + A), R.bindTexture(R.TEXTURE_2D, J), R.uniform1i(Ce, A), ae && U.updateTexture(
            J,
            we,
            ye
          );
    ...
    R.viewport(0, 0, R.drawingBufferWidth, R.drawingBufferHeight), R.clear(R.COLOR_BUFFER_BIT | R.DEPTH_BUFFER_BIT), R.bindBuffer(R.ARRAY_BUFFER, v.current), R.vertexAttribPointer(
      ...
      0,
      0
    ), ie(L), R.drawArrays(R.TRIANGLE_STRIP, 0, 4);
    ...
    const L = { passive: !0 };
    F.current.iMouse?.isNeeded && g.current && (g.current.addEventListener("mousemove", Y, L), g.current.addEventListener("mouseout", O, L), g.current.addEventListener("mouseup", O, L), g.current.addEventListener("mousedown", re, L), g.current.addEventListener("touchmove", Y, L), g.current.addEventListener("touchend", O, L), g.current.addEventListener("touchstart", re, L)), F.current.iDeviceOrientation?.isNeeded && window.addEventListener(
      "deviceorientation",
      G,
      L
    ), g.current && ($.current = new ResizeObserver(Z), $.current.observe(g.current), window.addEventListener("resize", Z, L));
  }, ce = () => {
    const L = { passive: !0 };
    F.current.iMouse?.isNeeded && g.current && (g.current.removeEventListener("mousemove", Y, L), g.current.removeEventListener("mouseout", O, L), g.current.removeEventListener("mouseup", O, L), g.current.removeEventListener("mousedown", re, L), g.current.removeEventListener("touchmove", Y, L), g.current.removeEventListener("touchend", O, L), g.current.removeEventListener("touchstart", re, L)), F.current.iDeviceOrientation?.isNeeded && window.removeEventListener(
      "deviceorientation",
      G,
      L
    ), $.current && ($.current.disconnect(), window.removeEventListener("resize", Z, L));
  };
  return K(() => {
    M.current = n;
  }, [n]), K(() => {
    ...
    function R() {
      _();
      const E = m.current;
      E && g.current && (E.clearColor(...s), E.clearDepth(1), E.enable(E.DEPTH_TEST), E.depthFunc(E.LEQUAL), E.viewport(0, 0, g.current.width, g.current.height), g.current.height = g.current.clientHeight, g.current.width = g.current.clientWidth, W(), fe(), Q(he(e || x4), t || _1), z(), requestAnimationFrame(oe), se(), Z());
    }
    return requestAnimationFrame(R), () => {
      const E = m.current;
      if (E) {
        if (E.getExtension("WEBGL_lose_context")?.loseContext(), E.useProgram(null), E.deleteProgram(w.current ?? null), L.length > 0)
          for (const j of L)
...
}`, T4 = 10, H4 = 2, A4 = 0.5, $4 = 0.2, B4 = 1.5, pe = {
  duration: 0.5,
  ease: "easeOut"
}, rt = {
  duration: 0.35,
...
function I4(e, t) {
  const [o, n] = I(T4), {
    ...
    animate: i,
    motionValue: a
  } = Oe($4), { value: d, animate: l } = Oe(H4), { value: f, animate: u } = Oe(A4), { value: C, animate: p } = Oe(B4), g = Ns(t, {
    fftSize: 512,
  ...
  return K(() => {
    switch (e) {
      ...
      case "failed":
      case "disconnected":
        n(10), i(0.2, pe), l(1.2, pe), u(0.4, pe), p(1, pe);
        return;
      case "listening":
      case "pre-connect-buffering":
        n(20), i(0.3, { type: "spring", duration: 1, bounce: 0.35 }), l(1, pe), u(0.7, pe), p([1.5, 2], rt);
        return;
      case "thinking":
      case "connecting":
      case "initializing":
        n(30), i(0.3, pe), l(0.5, pe), u(1, pe), p([0.5, 2.5], rt);
        return;
      case "speaking":
        n(70), i(0.3, pe), l(0.75, pe), u(1.25, pe), p(1.5, pe);
        return;
    }
  }, [
    e,
...
function yr({
  ...
  const g = te(() => j4(a), [a]);
  return /* @__PURE__ */ r("div", { ref: u, className: C, ...p, children: /* @__PURE__ */ r(
    V4,
    {
      fs: S4,
...
function D6({
  ...
  const { speed: f, scale: u, amplitude: C, frequency: p, brightness: g } = I4(t, s);
  return /* @__PURE__ */ r(
    yr,
    {
      ref: d,
...
const Z6 = ({
  ...
  const n = X(), s = Le();
  return /* @__PURE__ */ c(Ee, { children: [
    e && /* @__PURE__ */ r("span", { className: b(Z4(), "truncate"), children: e }),
    /* @__PURE__ */ r(Fe, { children: o && t && /* @__PURE__ */ r(
      ne.div,
      {
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
    /* @__PURE__ */ r("span", { className: b(Mr()), children: t }),
    /* @__PURE__ */ c(
      ne.div,
      {
        ...
        children: [
          n === "person" && /* @__PURE__ */ c("div", { className: "flex items-center gap-1", children: [
            ...
            o && /* @__PURE__ */ r("span", { className: b(Ue()), children: o })
          ] }),
          n === "people" && /* @__PURE__ */ r(
            us,
            {
          ...
          n === "alert" && /* @__PURE__ */ r(hs, { text: e.alertLabel, level: e.level }),
          n === "balance" && /* @__PURE__ */ r(U4, { balance: e.balance })
        ]
      }
    ),
    o && !O4.has(n) && /* @__PURE__ */ r(
      ne.span,
      {
        className: b(Ue()),
        animate: { opacity: s ? 0 : 1 },
...
const W4 = ({
  ...
  dataLength: n,
  color: s
}) => o !== n - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), q4 = ({
  label: e,
  direction: t
}) => {
  const o = Er[t];
  ...
  const s = `sparkline-gradient-${it().replace(/:/g, "")}`, i = G4(e, o), a = Er[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Cs, { width: "100%", height: "100%", children: /* @__PURE__ */ c(
          ps,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r(ms, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                vs,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ r(q4, { label: t, direction: i })
      ]
    }
  ) });
}, Rr = h(
  (e, t) => {
    const {
      ...
      className: l,
      ...f
    } = e, [u, C] = I(!1), [p, g] = I(!1), m = u || p, v = Le(), w = m && !!d, x = {
      duration: v ? 0 : 0.2,
      ease: [0.33, 1, 0.68, 1]
    }, H = () => {
      a?.();
        ...
        "div",
        {
          ...
          children: [
            ...
            f.content === "sparkline" ? /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: b(Mr()), children: n }),
              /* @__PURE__ */ r(
                ne.div,
                {
...
const Y4 = ["className"], Fr = h((e, t) => {
  const o = Y4.reduce((n, s) => {
    const { [s]: i, ...a } = n;
    return a;
  }, e);
  return /* @__PURE__ */ r(Rr, { ref: t, ...o });
});
...
const K4 = () => /* @__PURE__ */ c(
  ...
  "balance",
  "sparkline"
], Nr = 180, Q4 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Nr, J4 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, e6 = (e) => e.showActions !== !1, t6 = (e) => Object.fromEntries(
...
function r6(e) {
  ...
  } = e, [l, f] = I(!1), u = it(), C = P(null), p = Q4(
    d
  ), g = i.length > p, m = l ? i : J4(i, p), v = e6(e) ? e : null, w = t6(e);
  return K(() => {
    l && C.current?.focus();
  }, [l]), /* @__PURE__ */ c(
    "section",
...
r6.displayName = "F0AiProposalCard";
const o6 = ({
  icon: e,
  title: t,
  children: o
...
}, n6 = (e) => l2[e] ?? pt, s6 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(le, { icon: n6(e), size: "md", color: "default" }) }) : null;
function i6({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(o6, { icon: l1, title: n, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(s6, { iconName: s.icon });
...
i6.displayName = "F0AiMessageSources";
async function a6(e, t, o) {
  const n = await import("./xlsx-Bedf3nwD.js"), s = n.utils.table_to_book(e, { sheet: "Data" });
  n.writeFile(s, `${o}.${t}`);
}
function c6({
...
function l6({ credits: e }) {
  ...
  if (!e) return null;
  const C = l ? Math.min(100, Math.round(l.used / l.total * 100)) : 0, p = e.companyName;
  return /* @__PURE__ */ c(u1, { open: o, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ c(
      h1,
      {
        ...
        children: [
          p && /* @__PURE__ */ c("div", { className: "flex min-w-0 max-w-full flex-1 items-center gap-2 overflow-hidden text-left text-lg text-f1-foreground", children: [
            /* @__PURE__ */ r(
              C1,
              {
                name: e.companyName ?? "",
...
const d6 = "linear-gradient(90deg, #E55619, #A1ADE5, #E51943, #E55619)";
function u6({
  employeeCredits: e
}) {
  const t = X(), o = Le(), [n, s] = I(!1), [i, a] = I(!1), [d, l] = I(!1), [f, u] = I(null), C = q(
    (v) => {
  ...
  if (!e) return null;
  const p = !!e.companyName, g = f && f.total > 0 ? Math.min(100, Math.round(f.used / f.total * 100)) : 0, m = f ? Math.max(0, f.total - f.used) : 0;
  return /* @__PURE__ */ c(u1, { open: n, onOpenChange: C, children: [
    /* @__PURE__ */ r(f1, { asChild: !0, children: /* @__PURE__ */ r(
      ue,
      {
        variant: "ghost",
...
const ot = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(u6, { employeeCredits: t }) : e ? /* @__PURE__ */ r(l6, { credits: e }) : null, U6 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const p = X(), g = ks(`(max-width: ${Ls.md}px)`, {
        ...
        /* @__PURE__ */ r("div", { className: "flex min-w-0 flex-1 items-center", children: !s && /* @__PURE__ */ r(
          $e,
          {
            ...
            children: /* @__PURE__ */ c("div", { className: "flex min-w-0 items-center gap-1", children: [
              /* @__PURE__ */ r(de, { lines: 1, className: "min-w-0 text-left", children: o ?? p.ai.newConversation }),
...
function f6() {
  if (!(typeof navigator > "u"))
    return Ms(navigator.language);
}
function h6(e) {
  const t = new Date(e), o = /* @__PURE__ */ new Date();
  return Tt(t) ? "today" : Ht(t) ? "yesterday" : bs(t, o) ? "thisMonth" : "older";
}
function g6(e, t) {
  const o = new Date(e), n = f6(), s = R1(o, "p", { locale: n });
  if (Tt(o)) return `${t.today}, ${s}`;
  if (Ht(o)) return `${t.yesterday}, ${s}`;
  const i = !ys(o, /* @__PURE__ */ new Date());
...
function G6({
  ...
  const [n, s] = I([]), [i, a] = I(!1), [d, l] = I(null), [f, u] = I(v6), C = q(async () => {
    a(!0), l(null);
    try {
      const v = await t();
      s(v);

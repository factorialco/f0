...
import { forwardRef as qe, useState as O, useEffect as M, useContext as ee, createContext as he, useRef as w, useCallback as ie, useMemo as Q } from "react";
import { h as K, A as de, k as G, m as y, l as fe, j as Ye, n as _e, a as Ae, f as Xe, o as Je, p as Ze, q as Qe, r as et, u as L, s as I, B as V, t as tt, v as nt, w as rt, x as ot, y as st, z as at, F as it, D as lt, E as ye, g as Me, G as Se, H as ct, c as ut, J as me, K as dt } from "./F0Thinking-CCdAZFqx.js";
...
const pt = {
  ...
  duration: 0.15,
  ease: "easeOut"
}, Ie = qe(({ valueToCopy: e, onCopy: n, copyTooltipLabel: o, copiedTooltipLabel: r, variant: a = "neutral", size: s = "sm", ...i }, g) => {
  const [m, d] = O(!1), l = K(), p = o ?? l.actions.copy, c = m ? r ?? "Copied" : p;
  return M(() => {
    let x = null;
    return m && (x = setTimeout(() => d(!1), 1e3)), () => {
      x && clearTimeout(x);
    };
  }, [m]), t(de, {
    ref: g,
    ...
    size: s,
    onClick: (x) => {
      x.stopPropagation(), window.navigator.clipboard.writeText(e), d(!0), n?.(x);
    },
    "aria-live": "polite",
    "aria-label": c,
    title: c,
...
const Ne = he(null), Fe = ({ children: e }) => {
  ...
  const s = r?.content || "", i = r?.role === "assistant" && r.toolCalls?.find((c) => c.function.name === "orchestratorThinking"), g = r?.generativeUI?.(i ? {
    status: n ? "executing" : "completed"
  } : void 0), m = !s && !g, d = K(), { open: l } = ge(), [p, f] = O(null);
    ...
    children: [n && !g && t(Ae, {
      ...
      children: [t("div", {
        ...
        children: [t(Ie, {
          ...
          disabled: e,
          onCopy: (c) => {
            c.currentTarget.blur(), a?.(s);
          }
        }), t(de, {
          onClick: (c) => {
            const h = p === "like" ? null : "like";
            h && l(h, r), f(h), c.currentTarget.blur();
          },
          compact: !0,
          mode: "only",
          variant: "ghost",
          "aria-label": d.actions.thumbsUp,
          children: t("div", {
          ...
          mode: "only",
          variant: "ghost",
          "aria-label": d.actions.thumbsDown,
          children: t("div", {
            className: "flex min-w-0 flex-1 items-center justify-center gap-1",
            children: t(fe, {
              size: "md",
              icon: p === "dislike" ? Qe : et,
              color: "default"
            })
          })
        })]
  ...
  return v("header", {
    className: I("flex justify-between border-0 border-solid border-f1-border-secondary px-[16px] py-3"),
    children: [t("h2", {
  ...
  const [a, s] = O(""), [i, g] = O(0), [m, d] = O(!1), l = w(null), p = w(null), f = w(null), c = e[i] ?? n;
  return M(() => {
    const h = () => {
      p.current && (clearInterval(p.current), p.current = null), f.current && (clearInterval(f.current), f.current = null), l.current && (clearTimeout(l.current), l.current = null);
    };
    if (o.length > 0 || r) {
      d(!1), s(""), h();
      return;
    ...
    return p.current = setInterval(() => {
      x < c.length ? (s(c.slice(0, x + 1)), x++) : (p.current && (clearInterval(p.current), p.current = null), l.current = setTimeout(() => {
        f.current = setInterval(() => {
          x > 0 ? (x--, s(c.slice(0, x))) : (f.current && (clearInterval(f.current), f.current = null), l.current = setTimeout(() => {
  ...
  }, [o, r, c, i, e.length]), o.length > 0 || r ? null : t(G, {
    children: t(y.div, {
      initial: {
        opacity: 0
      },
      ...
      className: I("col-start-1 row-start-1", "pointer-events-none", "text-f1-foreground-secondary", "sm:text-[14px] text-[16px] leading-[20px] font-normal", "sm:pt-3 sm:px-3"),
      children: v("div", {
        className: I("overflow-hidden text-ellipsis whitespace-nowrap", "sm:whitespace-pre-wrap sm:break-words sm:overflow-visible"),
  ...
  const [a, s] = O(""), i = w(null), g = w(null), m = K(), { placeholders: d } = L(), l = a.trim().length > 0, p = (h) => {
  ...
  return v(y.form, {
    ...
    onSubmit: p,
    children: [v("div", {
      className: I("grid flex-1 grid-cols-1 grid-rows-1", "min-h-[20px] py-2.5 sm:min-h-[20px] sm:py-0"),
      children: [t("div", {
        "aria-hidden": !0,
        className: I("col-start-1 row-start-1", "pointer-events-none invisible", "min-h-[20px] max-h-[120px] sm:min-h-[20px] sm:max-h-[240px]", "whitespace-pre-wrap break-words", "sm:text-[14px] text-[16px] leading-[20px] font-normal text-f1-foreground", "sm:mt-3 sm:px-3"),
        children: a.endsWith(`
`) ? a + "_" : a
      }), !a && !c && t("p", {
        className: I("col-start-1 row-start-1", "pointer-events-none", "text-f1-foreground-secondary", "sm:text-[14px] text-[16px] leading-[20px] font-normal", "sm:pt-3 sm:px-3", "overflow-hidden text-ellipsis whitespace-nowrap"),
        ...
        onKeyDown: f,
        className: I("col-start-1 row-start-1", "min-h-[20px] max-h-[120px] sm:min-h-[20px] sm:max-h-[240px] sm:h-auto", "resize-none", "whitespace-pre-wrap break-words", "sm:text-[14px] text-[16px] leading-[20px] font-normal text-f1-foreground", "px-0 sm:mt-3 sm:px-3", "overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden", "outline-none", a || !c ? "caret-f1-foreground" : "caret-transparent")
      }), c && t(gt, {
        placeholders: d,
...
}, Le = ({ onClose: e, onSubmit: n, reactionType: o, message: r }) => {
  const [a, s] = O(""), i = K(), { title: g, label: m, placeholder: d } = o === "like" ? i.ai.feedbackModal.positive : i.ai.feedbackModal.negative, l = ie(() => {
    n(r, a);
  }, [a, r, n]), p = () => {
    e(r);
  };
...
const Oe = ({ greeting: e, initialMessages: n = [], suggestions: o = [] }) => {
...
}), At = ({ inProgress: e, children: n, RenderMessage: o, AssistantMessage: r, UserMessage: a, ImageRenderer: s, onRegenerate: i, onCopy: g, markdownTagRenderers: m }) => {
  const d = w(null), { messages: l, interrupt: p } = z(), { threadId: f } = Ce(), { close: c, currentReaction: h, currentMessage: x, isOpen: W } = ge(), P = K(), { greeting: H, initialMessage: D, welcomeScreenSuggestions: X, onThumbsUp: te, onThumbsDown: q } = L(), J = Q(() => Mt(D || P.ai.defaultInitialMessage), [D, P.ai.defaultInitialMessage]), Z = l.length == 0 && (H || J.length > 0), { messagesContainerRef: ne, messagesEndRef: re, showScrollToBottom: oe, scrollToBottom: Y } = Be(), { height: S = 0 } = lt({
    ref: ne,
    box: "border-box"
  }), U = Q(() => Pe(l), [l]), [ce, ue] = ye({
    threshold: 1
  ...
  return M(() => {
    ...
    children: [v("div", {
      ...
      children: [v(y.div, {
        layout: !0,
        className: I("scrollbar-macos relative isolate flex flex-1 flex-col p-[16px] pb-0", "overflow-y-scroll overflow-x-hidden"),
        ref: ne,
        children: [t("div", {
          ref: ce,
          ...
          children: [Z && t(Oe, {
            ...
            return t("div", {
              ...
              style: {
                minHeight: _ ? S * 0.8 : void 0
              },
              children: N.map((u, b) => {
                const A = T === U.length - 1 && b === N.length - 1;
                return Array.isArray(u) && !A ? t(Me, {
                  messages: u,
                  isActive: !1,
                  inProgress: e,
                  RenderMessage: o,
...
function Be() {
  const e = w(null), n = w(null), o = w(!1), r = w(!1), [a, s] = O(!1), i = ie((l = "smooth") => {
    ...
    if (n.current) {
      const { scrollTop: l, scrollHeight: p, clientHeight: f } = n.current, c = 20;
      r.current = l + f + c < p;
    } else
      r.current = !1;
  }, m = () => {
    ...
    const { scrollTop: l, scrollHeight: p, clientHeight: f } = n.current, c = l < p - 3 * f;
    s(c);
  }, d = ie(() => {
    if (o.current) {
      o.current = !1;
...
const De = ({ message: e, ImageRenderer: n }) => {
  const o = e && "image" in e && e.image, r = w(null), s = !!ee(le)?.setInProgress;
  if (M(() => {
...
}), Nt = ({ inProgress: e, RenderMessage: n, AssistantMessage: o, UserMessage: r, ImageRenderer: a, onRegenerate: s, onCopy: i, markdownTagRenderers: g }) => {
  const m = w(null), { messages: d, interrupt: l, isLoading: p } = z(), f = e ?? p, c = o ?? Re, h = r ?? De, x = a ?? (({ image: u, content: b }) => t("img", {
    src: u,
    alt: b || "Assistant image",
    className: "max-w-full rounded-lg"
  })), { threadId: W } = Ce(), { setInProgress: P } = ee(le), { close: H, currentReaction: D, currentMessage: X, isOpen: te } = ge();
  M(() => {
    P(f);
  }, [f, P]);
  const q = K(), { greeting: J, initialMessage: Z, welcomeScreenSuggestions: ne, onThumbsUp: re, onThumbsDown: oe } = L(), Y = Q(() => Ft(Z || q.ai.defaultInitialMessage), [Z, q.ai.defaultInitialMessage]), S = d.length === 0 && (J || Y.length > 0), { messagesContainerRef: U, messagesEndRef: ce, showScrollToBottom: ue, scrollToBottom: B } = Be(), se = Q(() => Pe(d), [d]), N = w(d.length), T = d[d.length - 1]?.content || "", _ = w(T);
  return M(() => {
    const u = d.length > N.current, b = d.length === N.current && T !== _.current;
    if (u || b) {
      const k = d[d.length - 1]?.role === "user", F = (R = "instant") => {
        const E = U.current;
        if (E) {
      ...
      if (u) {
        ...
        return N.current = d.length, _.current = T, () => R.forEach(clearTimeout);
      } else b && F("instant");
    }
    N.current = d.length, _.current = T;
  }, [d.length, T, B]), M(() => {
    const u = U.current;
    if (!u) return;
    let b = !0;
    const A = () => {
      b = u.scrollHeight - u.scrollTop - u.clientHeight < 150;
    }, k = () => {
      ...
      u._startY = C.touches[0].pageY;
    }, E = (C) => {
      const { scrollTop: j, scrollHeight: ae, clientHeight: be } = u, ze = j <= 0, He = j + be >= ae, ve = C.touches[0].pageY, Ue = u._startY || ve, xe = ve > Ue ? "down" : "up";
      (ae <= be || ze && xe === "down" || He && xe === "up") && C.cancelable && C.preventDefault();
    }, $ = new ResizeObserver(k);
    return $.observe(u), u.addEventListener("scroll", A), u.addEventListener("touchstart", R, {
      passive: !0
      ...
      $.disconnect(), u.removeEventListener("scroll", A), u.removeEventListener("touchstart", R), u.removeEventListener("touchmove", E), window.removeEventListener("resize", k), window.removeEventListener("focusin", F), window.visualViewport && (window.visualViewport.removeEventListener("resize", k), window.visualViewport.removeEventListener("scroll", k));
    };
  }, [B]), v(pe, {
    children: [v("div", {
      ref: U,
      className: I("scrollbar-macos flex flex-1 flex-col overflow-y-auto px-4", S ? "justify-end pt-0" : "justify-start pt-3"),
      style: {
        minHeight: 0,
        flex: "1 1 auto",
        ...
        position: "relative",
        touchAction: S ? "none" : "pan-y",
        paddingTop: S ? 0 : void 0,
      ...
      children: [v("div", {
        ref: m,
        className: S ? "flex flex-1" : "flex flex-col gap-8",
        style: {
          width: "100%",
          display: "flex",
          flexDirection: "column",
          minHeight: S ? "100%" : void 0,
          flexGrow: 1,
          flexShrink: 1,
          alignItems: "stretch",
          paddingBottom: S ? "12px" : void 0
        },
        children: [S && t(Oe, {
          greeting: J,
          initialMessages: Y,
          ...
          className: "flex flex-col items-start justify-start gap-2",
          children: u.map((A, k) => {
            const F = b === se.length - 1 && k === u.length - 1;
...
const Rt = () => {
...
}), Lt = ({ enabled: e = !1, greeting: n, initialMessage: o, welcomeScreenSuggestions: r, onThumbsUp: a, onThumbsDown: s, children: i, agent: g, ...m }) => t(dt, {
  enabled: e,
  greeting: n,
  initialMessage: o,
  onThumbsUp: a,
  ...
  return $e(), M(() => {
    ...
    children: v("div", {
      ...
      children: [t("div", {
        ...
        ref: r,
        className: I("flex-shrink-0 w-full bg-white border-t border-f1-border transition-all", "pb-[env(safe-area-inset-bottom,12px)] focus-within:pb-0"),
        style: {
          flexShrink: 0,
          width: "100%",
          display: "flex",
  ...
  const { sendMessage: e } = L(), { interrupt: n } = z(), { inProgress: o } = ee(le);
  return t("div", {
...
}, qt = me("F0AiChat", Dt), Yt = me("F0AiFullscreenChat", $t), _t = me("F0AiChatProvider", Lt), Xt = {
  ai: {

 ...
 */
export type EventValue = EventScalar | EventValue[] | {
    [key: string]: EventValue;
};
export type EventName = "datacollection.filter-change" | "datacollection.sorting-change" | "datacollection.preset-click";

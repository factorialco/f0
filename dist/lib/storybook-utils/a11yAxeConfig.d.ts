 ...
 */
export declare const A11Y_WCAG_TAGS: readonly ["wcag2a", "wcag2aa", "wcag21a", "wcag21aa", "wcag22a", "wcag22aa"];
/** `runOnly` object for `axe.run()` / the addon's `a11y.options`. */
export declare const A11Y_RUN_ONLY: {
    type: "tag";
 ...
 */
export declare const A11Y_CI_CONTEXT = "#storybook-root";

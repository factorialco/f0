 ...
 */
export type NumericFormatter = (value: Numeric, options?: NumericFormatterOptions) => string;
/**
 ...
 */
export type RelaxedNumericWithFormatter = Omit<NumericWithFormatter, "numericValue"> & {

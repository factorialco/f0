 ...
 */
export type RecordPaths<T> = T extends Record<string, unknown> ? {
 ...
 */
export type RecordPathValue<T, P extends string> = P extends keyof T ? T[P] : P extends `${infer K}.${infer Rest}` ? K extends keyof T ? RecordPathValue<T[K], Rest> : never : never;
/**
 ...
 */
export declare function getValueByPath<T extends Record<string, unknown> | undefined | null>(obj: T, path: string): unknown;

export declare const defaultTranslations: {
    ...
    readonly filters: {
        ...
        readonly tagPicker: {
            readonly searchPlaceholder: "Describe people or type a location, role, team...";
            readonly tagsPlaceholder: "Search locations, roles, teams...";
            readonly availableOptions: "Available filter options";
            readonly removeValue: "Remove {{value}} from {{category}}";
            readonly loadingOptions: "Loading options...";
            readonly failedToLoad: "Failed to load {{category}} options";
            readonly retryCategory: "Retry {{category}}";
            readonly loadMoreCategory: "Load more {{category}}";
            readonly keyboardHint: "Write freely. Use arrow keys to navigate suggestions, Enter to add a filter, Shift+Enter to insert a line break, Escape to close, and Backspace or Delete to remove tags.";
            readonly keyboardHintTags: "Type to search. Use arrow keys to navigate suggestions, Enter to add a filter, Escape to close, and Backspace or Delete to remove tags.";
            readonly added: "{{value}} added to {{category}}";
            readonly removed: "{{value}} removed from {{category}}";
        };

export declare const defaultTranslations: {
    ...
    readonly richTextEditor: {
        ...
        readonly table: "Table";
        readonly tableControls: {
            readonly insertLeft: "Insert column left";
            readonly insertRight: "Insert column right";
            readonly insertAbove: "Insert row above";
            readonly insertBelow: "Insert row below";
            readonly deleteColumn: "Delete column";
            readonly deleteRow: "Delete row";
            readonly toggleHeaderColumn: "Toggle header column";

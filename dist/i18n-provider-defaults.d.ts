export declare const defaultTranslations: {
    ...
    readonly meeting: {
        ...
        readonly ended: "The meeting has ended";
        readonly rejoin: "Rejoin";
        readonly weakConnection: "Weak connection";
        readonly recording: "Recording";
        readonly cameraBlocked: "Camera access is blocked. Allow it in your browser settings to turn it on.";
        readonly microphoneBlocked: "Microphone access is blocked. Allow it in your browser settings to speak.";
        readonly cameraUnavailable: "No camera found";
        readonly microphoneUnavailable: "No microphone found";
        readonly cameraInUse: "Your camera is being used by another app";
        readonly microphoneInUse: "Your microphone is being used by another app";
        readonly audioBlocked: "Click to enable sound";
        readonly turnOnMicrophone: "Turn on microphone";
        readonly turnOffMicrophone: "Turn off microphone";
        readonly turnOnCamera: "Turn on camera";
        readonly turnOffCamera: "Turn off camera";
        readonly shareScreen: "Share screen";
        readonly stopSharing: "Stop sharing";
        readonly raiseHand: "Raise hand";
        readonly lowerHand: "Lower hand";
        ...
        readonly minimizeWindow: "Minimize";
        readonly meetingWindow: "Meeting window";
        readonly moveWindow: "Move meeting window";
        readonly resizeWindow: "Resize meeting window";
        readonly pinParticipant: "Pin";
        readonly unpinParticipant: "Unpin";
        readonly modeSwitch: "Meeting position";
        readonly modeSidePanel: "Show in the side panel";
        readonly modeFloating: "Show in a floating window";
        readonly modeFullscreen: "Fill the screen";
        readonly resizePanel: "Resize the meeting panel";
        readonly movedToCorner: "Meeting window moved to the {{corner}}";
        readonly cornerTopLeft: "top left";
        readonly cornerTopRight: "top right";
        readonly cornerBottomLeft: "bottom left";
        readonly cornerBottomRight: "bottom right";
        readonly participantJoined: "{{name}} joined";
        readonly participantLeft: "{{name}} left";
    };
    readonly select: {

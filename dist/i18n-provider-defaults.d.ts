export declare const defaultTranslations: {
    ...
    readonly coCreationForm: {
        ...
        readonly questionTypes: {
            ...
            readonly link: "Link";
            readonly date: "Date";
            readonly entitySelect: "Person selector";
            readonly entitySelectMulti: "Person selector (multi)";
        };
        readonly entitySelectQuestion: {
            readonly placeholder: "Respondents will see a person selector here";
        };

export declare const defaultTranslations: {
    ...
    readonly sharingDialog: {
        readonly peopleLabel: "People";
        readonly peoplePlaceholder: "Select people";
        readonly newPeopleAccessLevel: "Access level for selected people";

export declare const defaultTranslations: {
    ...
    readonly commandPalette: {
        readonly label: "Command palette";
        readonly placeholder: "Search, or type a name then / to act";
        readonly placeholderScoped: "Run an action";
        readonly groups: {
            ...
            readonly unavailable: "Not available here";
        };
        readonly empty: {
            readonly title: "No results";
            readonly description: "Try a different search.";
        };
        readonly footer: {
            readonly act: "Act on a result";
            readonly rowActions: "Row actions";
            readonly ask: "Ask";
            readonly leaveScope: "Leave scope";
            readonly goBack: "Go back";
        };
        readonly scope: {
            readonly remove: "Remove scope, {{name}}";
        };
        readonly rowActions: {
            readonly openInNewTab: "Open in a new tab";
            readonly copyLink: "Copy link";
            readonly linkCopied: "Link copied";
        };
        readonly announce: {
            readonly scoped: {
                readonly one: "Scoped to {{name}}. 1 action.";
                readonly other: "Scoped to {{name}}. {{count}} actions.";
            };
            readonly scopedEmpty: "Scoped to {{name}}. No actions available.";
            readonly cleared: "Scope cleared.";
            readonly unavailable: "{{label}} is not available. {{reason}}";
            readonly linkCopied: "Link copied. {{url}}";
        };
        readonly row: {
            readonly open: "Open {{label}}";
            readonly run: "Run {{label}}";
            readonly select: "Select {{label}}";
            readonly unavailable: "Not available here";
            readonly impact: "{{eligible}} of {{total}}";
            readonly impactWithReason: "{{eligible}} of {{total}} · {{reason}}";
        };
    };
    readonly date: {
        readonly from: "From";

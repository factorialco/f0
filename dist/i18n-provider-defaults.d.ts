export declare const defaultTranslations: {
    ...
    readonly ai: {
        ...
        readonly dataDownload: {
            ...
            readonly downloadPreparing: "Preparing export";
            readonly downloadSuccess: "Download started";
            readonly downloadFailed: "Couldn't export data";
            readonly exportDashboard: "Export dashboard as {{format}}";
            readonly exporting: "Exporting…";
            readonly exportPreparing: "Preparing dashboard export";
            readonly exportSuccess: "Dashboard exported";
            readonly exportEmpty: "No data to export";
            readonly exportEmptyDescription: "Change your filters and try again";
            readonly exportTooLarge: "Too much data to export";
            readonly exportTooLargeDescription: "Narrow your filters and try again";
            readonly exportFailed: "Couldn't export dashboard";
            readonly exportFailedDescription: "Try again";
            readonly exportOverviewSheetName: "Dashboard overview";
            readonly exportOverviewDescription: "Preview every dashboard widget here. Use each widget sheet for its full exported data.";
            readonly exportRowsExported: "{{amount}} rows exported";
            readonly exportPreviewTruncated: "Showing the first {{amount}} rows here. Open the widget sheet for the full export.";
            readonly exportFullDataSheet: "Full data: {{sheetName}}";
        };

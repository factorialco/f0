export declare const defaultTranslations: {
    ...
    readonly dataChart: {
        ...
        readonly table: "Table";
        readonly comboAxis: {
            readonly primaryMeasure: "Primary measure";
            readonly secondaryMeasure: "Secondary measure";
            readonly target: "Target";
        };
        readonly comboAria: {
            readonly primaryAxis: "Left axis, bars: {{axis}}";
            readonly secondaryAxis: "Right axis, lines: {{axis}}";
            readonly singleLineAxis: "Left axis, lines: {{axis}}";
            readonly target: "target {{value}}";
            readonly oneMoreValue: "1 more value";
            readonly moreValues: "{{count}} more values";
            readonly oneMoreSeries: "1 more series";
            readonly moreSeries: "{{count}} more series";
        };
        readonly emptyState: {

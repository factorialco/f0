export declare const defaultTranslations: {
    ...
    readonly npsWidget: {
        readonly survey: "NPS survey";
        readonly notLikely: "Not likely";
        readonly veryLikely: "Very likely";
        readonly next: "Next";
        readonly back: "Back";
        readonly submit: "Submit";
        readonly feedbackPlaceholder: "Write your answer here...";
        readonly feedbackLow: "What could we improve?";
        readonly feedbackHigh: "What do you value most?";
        readonly thankYouHigh: "That means a lot, thank you!";
        readonly thankYouDefault: "Thanks for helping us improve.";
    };
    readonly wizard: {
        readonly previous: "Previous";

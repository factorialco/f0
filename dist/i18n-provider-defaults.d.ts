export declare const defaultTranslations: {
    ...
    readonly audience: {
        readonly selector: {
            readonly typeToSearch: "Start typing to search";
            readonly noResults: "No matches found";
            readonly loading: "Loading...";
            readonly removeItem: "Remove {{name}}";
            readonly kind: {
                readonly team: "Team";
                readonly legalEntity: "Legal entity";
                readonly workplace: "Workplace";
                readonly role: "Role";
                readonly permissionGroup: "Permission group";
                readonly everyone: "Company-wide";
            };
            readonly memberCount: {
                readonly one: "{{count}} person";
                readonly other: "{{count}} people";
            };
        };
        readonly listItem: {
            readonly you: "(You)";
            readonly showMembers: "Show members of {{name}}";
            readonly hideMembers: "Hide members of {{name}}";
            readonly noMembers: "No current members";
            readonly loadError: "Couldn't load members";

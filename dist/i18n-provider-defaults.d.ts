export declare const defaultTranslations: {
    ...
    readonly forms: {
        ...
        readonly requestChange: {
            readonly title: "Request a change to {{label}}";
            readonly description: "This goes to whoever administers this record. They can apply it or turn it down.";
            readonly currentLabel: "It says now";
            readonly newLabel: "It should say";
            readonly reasonLabel: "Why (optional)";

export declare const defaultTranslations: {
    ...
    readonly ai: {
        ...
        readonly switchToVoice: "Switch to voice";
        readonly switchToText: "Switch to text chat";
        readonly voiceModeEnabled: "Voice mode enabled";
        readonly textModeEnabled: "Text mode enabled";
        readonly voiceChatRegion: "Voice chat";

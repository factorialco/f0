import { St as e } from "./OneCalendar-B6RjA05-.js";
import { o as t } from "./tooltip-BPSwDQpD.js";
...
function p(e) {
	let { dataSource: s, data: c, paginationInfo: l, setPage: u, loadMore: p, isLoading: m, idProvider: h, itemUrl: g, activeItemId: _, defaultActiveItemId: v, onActiveItemChange: y } = e, b = i(() => h || (s.idProvider ? (e, t) => s.idProvider(e, t) : f), [h, s.idProvider]), [x, S] = t({
		prop: _,
		defaultProp: v ?? null,
		onChange: (e) => y?.(e ?? null)

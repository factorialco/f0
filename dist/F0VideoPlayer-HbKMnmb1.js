import { u as W, t as je, v as Ge, m as $, x as Xe, y as Ze, z as qe, A as Ye, B as Je, E as Qe, G as et, H as tt, J as nt, K as rt, L as at, M as ot, N as st, O as ye, Q as it, R as Ce, l as ct, U as lt, V as dt, W as ut, w as ft, r as mt } from "./F0CanvasPanel-9wUGqSYf.js";
import { jsxs as R, jsx as l } from "react/jsx-runtime";
import { forwardRef as re, useId as pt, useState as x, useRef as O, useEffect as _, useMemo as J, useCallback as M } from "react";
import { d as H, f as de } from "./tooltip-CMBdJvJA.js";
import { F as Pe, a as ht, b as gt } from "./VolumeMuted-UfTwt2zn.js";
function Se(e) {
...
function ce({
  ...
  return /* @__PURE__ */ R(tt, { children: [
    /* @__PURE__ */ R(nt, { className: Ct, children: [
      /* @__PURE__ */ l(rt, { icon: e }),
      /* @__PURE__ */ l("span", { className: "flex-1", children: t }),
      /* @__PURE__ */ l("span", { className: "text-f1-foreground-secondary", children: y })
    ] }),
    /* @__PURE__ */ l(at, { container: a ?? void 0, children: /* @__PURE__ */ l(ot, { className: Ae, children: /* @__PURE__ */ R(
      st,
      {
        value: m ? r ? o : ie : o,
      ...
      children: [
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ l(
              "button",
              {
                ...
                children: /* @__PURE__ */ l(ut, { icon: Ce, size: "lg", color: "#fff" })
              }
            )
          }
        ),
        N.showing && z.activeCue && /* @__PURE__ */ l(
          "div",
          {
            ...
            children: /* @__PURE__ */ R("p", { className: "max-w-[90%] rounded-md bg-f1-background/70 px-2 py-1 text-center text-base italic text-f1-foreground [text-shadow:0_1px_2px_rgba(0,0,0,0.55)]", children: [

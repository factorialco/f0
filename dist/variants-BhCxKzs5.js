import { a as e, n as t, r as n, t as r } from "./rolldown-runtime-CEFd7nDs.js";
import { t as i } from "./dist-CqnuTXEz.js";
import { t as a } from "./component-Lhh_08kH.js";
import { n as o, o as s, s as c } from "./data-testid-0GIWgc6Q.js";
import { t as l } from "./utils-CVzxZnoI.js";
import { i as u, n as d, r as f, t as p } from "./tooltip-BPSwDQpD.js";
import { t as m } from "./i18n-provider-defaults-B5_EAVz9.js";
import * as h from "react";
import { Children as g, Component as _, Fragment as v, cloneElement as y, createContext as b, createElement as x, forwardRef as S, isValidElement as ee, memo as te, useCallback as ne, useContext as C, useEffect as re, useId as ie, useInsertionEffect as ae, useLayoutEffect as oe, useMemo as w, useRef as T, useState as se } from "react";
import { Fragment as ce, jsx as E, jsxs as D } from "react/jsx-runtime";
...
var O = {}, le = (e, t) => {
	...
	let n = () => {
		Object.entries(O).forEach(([e, t]) => {
			...
			n > 0 && (console.warn(`🚧 The \x1b[1m${e}\x1b[0m component is experimental. Use it at your own risk.`, `Found ${t.uses} uses. ${t.usesReported === -1 ? "" : `New uses found since last report: ${n}`}`), O[e] = {
				...t,
				usesReported: t.uses
			});
		});
	...
	if (t.$$typeof === Symbol.for("react.forward_ref")) {
		let n = t.render, r = S((t, r) => (s() && (i(), O[e] || (O[e] = {
			uses: 0,
			usesReported: -1
		}), O[e] = {
			...O[e],
		...
		return le(t, r), r.displayName ||= `Experimental(${e})`, r;
	}
	if (t.$$typeof === Symbol.for("react.memo")) {
		let n = t.type, r = t.compare, a = (t) => (s() && (i(), O[e] || (O[e] = {
			uses: 0,
			usesReported: -1
		}), O[e] = {
			...O[e],
		...
		a.displayName = `Experimental(${e})`, le(t, a);
		let o = te(a, r);
		return le(t, o), o;
	}
	let a = ((...n) => (s() && (i(), O[e] || (O[e] = {
...
var pe = typeof window < "u", me = pe ? oe : re, he = /* @__PURE__ */ b(null), ge = b({
...
var ye = class extends h.Component {
	getSnapshotBeforeUpdate(e) {
		let t = this.props.childRef.current;
		if (t && e.isPresent && !this.props.isPresent) {
			let e = t.offsetParent, n = ve(e) && e.offsetWidth || 0, r = this.props.sizeRef.current;
...
function be({ children: e, isPresent: t, anchorX: n }) {
	let r = ie(), i = T(null), a = T({
		width: 0,
		height: 0,
		top: 0,
		left: 0,
	...
	return ae(() => {
		...
		childRef: i,
		sizeRef: a,
		children: h.cloneElement(e, { ref: i })
	});
}
//#endregion
...
function Ce(e = !0) {
	...
	let { isPresent: n, onExitComplete: r, register: i } = t, a = ie();
	re(() => {
		if (e) return i(a);
	}, [e]);
	let o = ne(() => e && r && r(a), [
...
var Oe = ({ children: e, custom: t, initial: n = !0, onExitComplete: r, presenceAffectsLayout: i = !0, mode: a = "sync", propagate: o = !1, anchorX: s = "left" }) => {
	let [c, l] = Ce(o), u = w(() => De(e), [e]), d = o && !c ? [] : u.map(Ee), f = T(!0), p = T(u), m = fe(() => /* @__PURE__ */ new Map()), [h, g] = se(u), [_, v] = se(u);
	me(() => {
	...
	if (u !== h) {
		...
		return a === "wait" && y.length && (e = y), v(De(e)), g(u), null;
	}
	...
	let { forceRender: b } = C(de);
	return E(ce, { children: _.map((e) => {
		let h = Ee(e), g = o && !c ? !1 : u === _ || d.includes(h);
		return E(xe, {
			isPresent: g,
...
function Ae(e, t) {
	...
	let u = {
		...
		process: (e) => {
			...
			i = !0, [n, r] = [r, n], n.forEach(l), t && k.value && k.value.frameloop[t].push(c), c = 0, n.clear(), i = !1, a && (a = !1, u.process(e));
		}
	};
	return u;
}
...
function Me(e, t) {
	let n = !1, r = !0, i = {
		...
		timestamp: 0,
		isProcessing: !1
	}, a = () => n = !0, o = ke.reduce((e, n) => (e[n] = Ae(a, t ? n : void 0), e), {}), { setup: s, read: c, resolveKeyframes: l, preUpdate: u, update: d, preRender: f, render: p, postRender: m } = o, h = () => {
		let a = A.useManualTiming ? i.timestamp : performance.now();
		n = !1, A.useManualTiming || (i.delta = r ? 1e3 / 60 : Math.max(Math.min(a - i.timestamp, je), 1)), i.timestamp = a, i.isProcessing = !0, s.process(i), c.process(i), l.process(i), u.process(i), d.process(i), f.process(i), p.process(i), m.process(i), i.isProcessing = !1, n && t && (r = !1, e(h));
	}, g = () => {
		n = !0, r = !0, i.isProcessing || e(h);
	};
	return {
		schedule: ke.reduce((e, t) => {
			let r = o[t];
			return e[t] = (e, t = !1, i = !1) => (n || g(), r.schedule(e, t, i)), e;
		}, {}),
		cancel: (e) => {
			for (let t = 0; t < ke.length; t++) o[ke[t]].cancel(e);
		},
		state: i,
		steps: o
	};
...
var j = /* @__NO_SIDE_EFFECTS__ */ (e) => e, { schedule: M, cancel: N, state: P, steps: Ne } = /* @__PURE__ */ Me(typeof requestAnimationFrame < "u" ? requestAnimationFrame : j, !0), Pe = b({ strict: !1 }), Fe = {
	animation: [
		"animate",
		"variants",
		"whileHover",
...
for (let e in Fe) Ie[e] = { isEnabled: (t) => Fe[e].some((e) => !!t[e]) };
//#endregion
...
function ze(e) {
	return e.startsWith("while") || e.startsWith("drag") && e !== "draggable" || e.startsWith("layout") || e.startsWith("onTap") || e.startsWith("onPan") || e.startsWith("onLayout") || Re.has(e);
}
//#endregion
...
function Je(e, t, n) {
	let r = {};
	for (let i in e) (i !== "values" || typeof e.values != "object") && (Ke(i) || n === !0 && ze(i) || !t && !ze(i) || e.draggable && i.startsWith("onDrag")) && (r[i] = e[i]);
	return r;
}
//#endregion
...
function Xe(e, t, n) {
	e || Ye.has(t) || (console.warn(t), n && console.warn(n), Ye.add(t));
}
//#endregion
...
function Ze(e) {
	...
	return new Proxy((...t) => (process.env.NODE_ENV !== "production" && Xe(!1, "motion() is deprecated. Use motion.create() instead."), e(...t)), { get: (n, r) => r === "create" ? e : (t.has(r) || t.set(r, e(r)), t.get(r)) });
}
//#endregion
...
function rt(e) {
	return $e(e.animate) || nt.some((t) => et(e[t]));
}
function it(e) {
...
function at(e, t) {
	if (rt(e)) {
		...
		return {
			initial: t === !1 || et(t) ? t : void 0,
			animate: et(n) ? n : void 0
		};
	}
...
function ot(e) {
	let { initial: t, animate: n } = at(e, C(Qe));
	return w(() => ({
		initial: t,
		animate: n
	}), [st(t), st(n)]);
...
var ct = Symbol.for("motionComponentSymbol");
//#endregion
...
var dt = (e) => e.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(), ft = "data-" + dt("framerAppearId"), pt = b({}), { schedule: mt, cancel: ht } = /* @__PURE__ */ Me(queueMicrotask, !1);
//#endregion
...
function gt(e, t, n, r, i) {
	let { visualElement: a } = C(Qe), o = C(Pe), s = C(he), c = C(ge).reducedMotion, l = T(null);
	...
	let u = l.current, d = C(pt);
	u && !u.projection && i && (u.type === "html" || u.type === "svg") && _t(l.current, n, i, d);
	let f = T(!1);
	ae(() => {
		u && f.current && u.update(n, s);
	});
	let p = n[ft], m = T(!!p && !window.MotionHandoffIsComplete?.(p) && window.MotionHasOptimisedAnimation?.(p));
	return me(() => {
		u && (f.current = !0, window.MotionIsMounted = !0, u.updateFeatures(), mt.render(u.render), m.current && u.animationState && u.animationState.animateChanges());
	}), re(() => {
...
function _t(e, t, n, r) {
	...
	e.projection = new n(e.latestValues, t["data-framer-portal-id"] ? void 0 : vt(e.parent)), e.projection.setOptions({
		layoutId: i,
		layout: a,
		alwaysMeasureLayout: !!o || s && lt(s),
		visualElement: e,
...
function vt(e) {
	if (e) return e.options.allowProjection === !1 ? vt(e.parent) : e.projection;
}
//#endregion
...
var yt = () => {}, F = () => {};
process.env.NODE_ENV !== "production" && (yt = (e, t) => {
...
function bt({ preloadedFeatures: e, createVisualElement: t, useRender: n, useVisualState: r, Component: i }) {
	e && Le(e);
	function a(a, o) {
		let s, c = {
			...C(ge),
			...a,
			layoutId: xt(a)
		}, { isStatic: l } = c, u = ot(a), d = r(a, l);
		if (!l && pe) {
			St(c, e);
			let n = Ct(c);
			s = n.MeasureLayout, u.visualElement = gt(i, d, c, t, n.ProjectionNode);
		}
		return D(Qe.Provider, {
			value: u,
			children: [s && u.visualElement ? E(s, {
				visualElement: u.visualElement,
				...c
			}) : null, n(i, a, ut(d, u.visualElement, o), d, l, u.visualElement)]
		});
	}
...
function St(e, t) {
	...
	if (process.env.NODE_ENV !== "production" && t && n) {
		...
		e.ignoreStrict ? yt(!1, t) : F(!1, t);
	}
}
function Ct(e) {
	let { drag: t, layout: n } = Ie;
	if (!t && !n) return {};
	let r = {
		...t,
		...n
...
var wt = (e) => (t) => typeof t == "string" && t.startsWith(e), Tt = /*@__PURE__*/ wt("--"), Et = /*@__PURE__*/ wt("var(--"), Dt = (e) => Et(e) ? Ot.test(e.split("/*")[0].trim()) : !1, Ot = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu, kt = {};
function At(e) {
	for (let t in e) kt[t] = e[t], Tt(t) && (kt[t].isCSSVariable = !0);
}
//#endregion
...
function Nt(e, { layout: t, layoutId: n }) {
	return Mt.has(e) || e.startsWith("origin") || (t || n !== void 0) && (!!kt[e] || e === "opacity");
}
//#endregion
...
var Pt = (e, t) => t && typeof e == "number" ? t.transform(e) : e, I = (e, t, n) => n > t ? t : n < e ? e : n, Ft = {
	...
	parse: parseFloat,
	transform: (t) => `${t}${e}`
}), L = /*@__PURE__*/ zt("deg"), R = /*@__PURE__*/ zt("%"), z = /*@__PURE__*/ zt("px"), Bt = /*@__PURE__*/ zt("vh"), Vt = /*@__PURE__*/ zt("vw"), Ht = {
	...R,
...
function Yt(e, t, n) {
	for (let r in t) !B(t[r]) && !Nt(r, n) && (e[r] = t[r]);
}
...
function tn(e, t, n = 1, r = 0, i = !0) {
	...
	let o = z.transform(t), s = z.transform(n);
	e[a.array] = `${o} ${s}`;
}
//#endregion
...
function ln(e = !1) {
	return (t, n, r, { latestValues: i }, a) => {
		let o = (cn(t) ? on : Qt)(n, i, a, t), s = Je(n, typeof t == "string", e), c = t === v ? {} : {
			...s,
			...o,
			ref: r
		}, { children: l } = n, u = w(() => B(l) ? l.get() : l, [l]);
		return x(t, {
			...c,
			children: u
		});
...
var mn = (e) => (t, n) => {
	let r = C(Qe), i = C(he), a = () => pn(e, t, r, i);
	return n ? a() : fe(a);
};
function hn(e, t, n, r) {
	let i = {}, a = r(e, {});
	for (let e in a) i[e] = fn(a[e]);
	let { initial: o, animate: s } = e, c = rt(e), l = it(e);
	t && l && !c && e.inherit !== !1 && (o === void 0 && (o = t.initial), s === void 0 && (s = t.animate));
	let u = n ? n.initial === !1 : !1;
	u ||= o === !1;
	let d = u ? s : o;
	if (d && typeof d != "boolean" && !$e(d)) {
...
function gn(e, t, n) {
	let { style: r } = e, i = {};
	for (let a in r) (B(r[a]) || t.style && B(t.style[a]) || Nt(a, e) || n?.getValue(a)?.liveStyle !== void 0) && (i[a] = r[a]);
	return i;
}
//#endregion
...
function vn(e, t, n) {
	let r = gn(e, t, n);
	for (let n in e) if (B(e[n]) || B(t[n])) {
		let t = jt.indexOf(n) === -1 ? n : "attr" + n.charAt(0).toUpperCase() + n.substring(1);
		r[t] = e[n];
	}
	return r;
}
...
var V = {
	now: () => (Cn === void 0 && V.set(P.isProcessing || A.useManualTiming ? P.timestamp : performance.now()), Cn),
	set: (e) => {
...
var An = 30, jn = (e) => !isNaN(parseFloat(e)), Mn = { current: void 0 }, Nn = class {
	...
	setCurrent(e) {
		this.current = e, this.updatedAt = V.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = jn(this.current));
	}
	setPrevFrameValue(e = this.current) {
		this.prevFrameValue = e, this.prevUpdatedAt = this.updatedAt;
	}
	onChange(e) {
		return process.env.NODE_ENV !== "production" && Xe(!1, "value.onChange(callback) is deprecated. Switch to value.on(\"change\", callback)."), this.on("change", e);
	}
	on(e, t) {
...
var Un = {
	...
	duration: .3
}, qn = (e, { keyframes: t }) => t.length > 2 ? Gn : Mt.has(e) ? e.startsWith("scale") ? Wn(t[1]) : Un : Kn;
//#endregion
...
var H = /* @__NO_SIDE_EFFECTS__ */ (e) => e * 1e3, U = /* @__NO_SIDE_EFFECTS__ */ (e) => e / 1e3, Xn = {
	layout: 0,
	mainThread: 0,
	waapi: 0
...
var er = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, tr = (e, t) => (n) => !!(typeof n == "string" && er.test(n) && n.startsWith(e) || t && !$n(n) && Object.prototype.hasOwnProperty.call(n, t)), nr = (e, t, n) => (r) => {
	...
	transform: ({ red: e, green: t, blue: n, alpha: r = 1 }) => "rgba(" + ir.transform(e) + ", " + ir.transform(t) + ", " + ir.transform(n) + ", " + Zn(It.transform(r)) + ")"
};
//#endregion
...
var sr = {
	...
	transform: ({ hue: e, saturation: t, lightness: n, alpha: r = 1 }) => "hsla(" + Math.round(e) + ", " + R.transform(Zn(t)) + ", " + R.transform(Zn(n)) + ", " + Zn(It.transform(r)) + ")"
}, W = {
...
function _r(e) {
	...
	return {
		values: n,
		split: t.replace(gr, (e) => (W.test(e) ? (r.color.push(a), i.push(fr), n.push(W.parse(e))) : e.startsWith(mr) ? (r.var.push(a), i.push(pr), n.push(e)) : (r.number.push(a), i.push(dr), n.push(parseFloat(e))), ++a, hr)).split(hr),
		indexes: r,
		types: i
	};
}
...
function yr(e) {
	...
	return (e) => {
		...
		for (let a = 0; a < r; a++) if (i += t[a], e[a] !== void 0) {
			let t = n[a];
			i += t === dr ? Zn(e[a]) : t === fr ? W.transform(e[a]) : e[a];
		}
		return i;
	};
}
...
function Or(e) {
	let t = Dr(e);
	if (yt(!!t, `'${e}' is not an animatable color. Use the equivalent color code instead.`), !t) return !1;
	let n = t.parse(e);
	return t === cr && (n = Cr(n)), n;
}
var kr = (e, t) => {
	let n = Or(e), r = Or(t);
	if (!n || !r) return wr(e, t);
	let i = { ...n };
	return (e) => (i.red = Tr(n.red, r.red, e), i.green = Tr(n.green, r.green, e), i.blue = Tr(n.blue, r.blue, e), i.alpha = K(n.alpha, r.alpha, e), ar.transform(i));
...
function Fr(e) {
	return typeof e == "number" ? Pr : typeof e == "string" ? Dt(e) ? wr : W.test(e) ? kr : zr : Array.isArray(e) ? Ir : typeof e == "object" ? W.test(e) ? kr : Lr : wr;
}
function Ir(e, t) {
...
var zr = (e, t) => {
	let n = G.createTransformer(t), r = _r(e), i = _r(t);
	return r.indexes.var.length === i.indexes.var.length && r.indexes.color.length === i.indexes.color.length && r.indexes.number.length >= i.indexes.number.length ? Ar.has(e) && !i.values.length || Ar.has(t) && !r.values.length ? jr(e, t) : Nr(Ir(Rr(r, i), i.values), n) : (yt(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), wr(e, t));
};
//#endregion
...
function Br(e, t, n) {
	return typeof e == "number" && typeof t == "number" && typeof n == "number" ? K(e, t, n) : Fr(e)(e, t);
}
//#endregion
...
var Vr = (e) => {
	...
	return {
		...
		stop: () => N(t),
		now: () => P.isProcessing ? P.timestamp : V.now()
	};
}, Hr = (e, t, n = 10) => {
...
function Yr({ duration: e = q.duration, bounce: t = q.bounce, velocity: n = q.velocity, mass: r = q.mass }) {
	let i, a;
	yt(e <= /* @__PURE__ */ H(q.maxDuration), "Spring duration must be 10 seconds or less");
	let o = 1 - t;
	o = I(q.minDamping, q.maxDamping, o), e = I(q.minDuration, q.maxDuration, /* @__PURE__ */ U(e)), o < 1 ? (i = (t) => {
	...
	if (e = /* @__PURE__ */ H(e), isNaN(c)) return {
...
function ri(e = q.visualDuration, t = q.bounce) {
	...
	}), m = f || 0, h = l / (2 * Math.sqrt(c * u)), g = o - a, _ = /* @__PURE__ */ U(Math.sqrt(c / u)), v = Math.abs(g) < 5;
	...
	let b = {
		...
		next: (e) => {
			...
			if (p) s.done = e >= d;
				...
				let n = e === 0 ? m : 0;
				h < 1 && (n = e === 0 ? /* @__PURE__ */ H(m) : qr(y, e, t));
...
function ii({ keyframes: e, velocity: t = 0, power: n = .8, timeConstant: r = 325, bounceDamping: i = 10, bounceStiffness: a = 500, modifyTarget: o, min: s, max: c, restDelta: l = .5, restSpeed: u }) {
	...
	return ee(0), {
		...
		next: (e) => {
			let t = !1;
			return !S && x === void 0 && (t = !0, b(e), ee(e)), x !== void 0 && e >= x ? S.next(e - x) : (!t && b(e), f);
		}
	};
}
//#endregion
...
function oi(e, t, n) {
	let r = [], i = n || A.mix || Br, a = e.length - 1;
	for (let n = 0; n < a; n++) {
		let a = i(e[n], e[n + 1]);
		t && (a = Nr(Array.isArray(t) ? t[n] || j : t, a)), r.push(a);
	}
	return r;
}
function si(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
	let a = e.length;
	if (F(a === t.length, "Both input and output ranges must be the same length"), a === 1) return () => t[0];
...
var gi = /*@__PURE__*/ hi(.42, 0, 1, 1), _i = /*@__PURE__*/ hi(0, 0, .58, 1), vi = /*@__PURE__*/ hi(.42, 0, .58, 1), yi = (e) => Array.isArray(e) && typeof e[0] != "number", bi = (e) => (t) => t <= .5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2, xi = (e) => (t) => 1 - e(1 - t), Si = /*@__PURE__*/ hi(.33, 1.53, .69, .99), Ci = /*@__PURE__*/ xi(Si), wi = /*@__PURE__*/ bi(Ci), Ti = (e) => (e *= 2) < 1 ? .5 * Ci(e) : .5 * (2 - 2 ** (-10 * (e - 1))), Ei = (e) => 1 - Math.sin(Math.acos(e)), Di = xi(Ei), Oi = bi(Ei), ki = (e) => Array.isArray(e) && typeof e[0] == "number", Ai = {
	...
	if (ki(e)) {
		F(e.length === 4, "Cubic bezier arrays must contain four numerical values.");
		let [t, n, r, i] = e;
		return hi(t, n, r, i);
	}
	return ji(e) ? (F(Ai[e] !== void 0, `Invalid easing type '${e}'`), Ai[e]) : e;
};
//#endregion
...
var zi = class {
	...
	initAnimation() {
		...
		process.env.NODE_ENV !== "production" && s !== Pi && F(o.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${o}`), s !== Pi && typeof o[0] != "number" && (this.mixKeyframes = Nr(Bi, Br(o[0], o[1])), o = [0, 100]);
		let c = s({
			...e,
			keyframes: o
		});
	...
	set speed(e) {
		...
		this.playbackSpeed = e, t && (this.time = /* @__PURE__ */ U(this.currentTime));
	}
	play() {
...
var ta = (e) => e === Ft || e === z, na = /* @__PURE__ */ new Set([
	"x",
	"y",
	"z"
]), ra = jt.filter((e) => !na.has(e));
function ia(e) {
	let t = [];
	return ra.forEach((n) => {
		let r = e.getValue(n);
...
var pa = class {
	...
	scheduleResolve() {
		this.state = "scheduled", this.isAsync ? (oa.add(this), sa || (sa = !0, M.read(da), M.resolveKeyframes(ua))) : (this.readKeyframes(), this.complete());
	}
	readKeyframes() {
...
function wa(e, t, n, { delay: r = 0, duration: i = 300, repeat: a = 0, repeatType: o = "loop", ease: s = "easeOut", times: c } = {}, l = void 0) {
	...
	c && (u.offset = c);
	let d = Ca(s, i);
	Array.isArray(d) && (u.easing = d), k.value && Xn.waapi++;
	let f = {
		delay: r,
		duration: i,
...
var Da = class extends zi {
	constructor(e) {
		...
		this.isPseudoElement = !!i, this.allowFlatten = a, this.options = e, F(typeof e.type != "string", "animateMini doesn't support \"type\" as a string. Did you mean to import { spring } from \"motion\"?");
		let c = Ea(e);
	...
	attachTimeline({ timeline: e, observe: t }) {
		return this.allowFlatten && this.animation.effect?.updateTiming({ easing: "linear" }), this.animation.onfinish = null, e && _a() ? (this.animation.timeline = e, j) : t(this);
	}
}, Oa = {
	anticipate: Ti,
	backInOut: wi,
...
var ja = 10, Ma = class extends Da {
	...
	updateMotionValue(e) {
		...
		let o = new Vi({
			...a,
			autoplay: !1
		}), s = /* @__PURE__ */ H(this.finishedTime ?? this.time);
		t.setWithVelocity(o.sample(s - ja).value, o.sample(s).value, ja), o.stop();
	}
}, Na = (e, t) => t !== "zIndex" && !!(typeof e == "number" || Array.isArray(e) || typeof e == "string" && (G.test(e) || e === "0") && !e.startsWith("url("));
//#endregion
...
function Fa(e, t, n, r) {
	...
	return yt(o === s, `You are trying to animate ${t} from "${i}" to "${a}". ${i} is not an animatable value - to enable this animation set ${i} to a value animatable to ${a} via the \`style\` property.`), !o || !s ? !1 : Pa(e) || (n === "spring" || Ta(n)) && r;
}
//#endregion
...
function Ra(e) {
	...
	if (!ve(t?.owner?.current)) return !1;
...
var za = 40, Ba = class extends zi {
	...
	onKeyframesResolved(e, t, n, r) {
		...
		this.resolvedAt = V.now(), Fa(e, i, a, o) || ((A.instantAnimations || !s) && l?.(Ii(e, n, t)), e[0] = e[e.length - 1], n.duration = 0, n.repeat = 0);
		let u = {
		...
		d.finished.then(() => this.notifyFinished()).catch(j), this.pendingTimeline &&= (this.stopTimeline = d.attachTimeline(this.pendingTimeline), void 0), this._animation = d;
	}
	get finished() {
	...
	Jn(s) || Object.assign(u, qn(e, u)), u.duration &&= /* @__PURE__ */ H(u.duration), u.repeatDelay &&= /* @__PURE__ */ H(u.repeatDelay), u.from !== void 0 && (u.keyframes[0] = u.from);
	let d = !1;
	if ((u.type === !1 || u.duration === 0 && !u.repeatDelay) && (u.duration = 0, u.delay === 0 && (d = !0)), (A.instantAnimations || A.skipAnimations) && (d = !0, u.duration = 0, u.delay = 0), u.allowFlatten = !s.type && !s.ease, d && !a && t.get() !== void 0) {
...
function Wa(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
	...
	for (let t in s) {
		...
		zn(e, t), r.start(Va(t, r, i, e.shouldReduceMotion && Ha.has(t) ? { type: !1 } : o, e, d));
		let f = r.animation;
		f && c.push(f);
	}
...
function to(e) {
	...
	function o(a) {
		...
		for (let t = 0; t < $a; t++) {
			let f = Qa[t], p = n[f], m = o[f] === void 0 ? s[f] : o[f], h = et(m), g = f === a ? p.isActive : null;
			g === !1 && (d = t);
			let _ = m === s[f] && m !== o[f] && h;
			if (_ && r && e.manuallyAnimateOnMount && (_ = !1), p.protectedKeys = { ...u }, !p.isActive && g === null || !m && !p.prevProp || $e(m) || typeof m == "boolean") continue;
			let v = no(p.prevProp, m), y = v || f === a && p.isActive && !_ && h || t > d && h, b = !1, x = Array.isArray(m) ? m : [m], S = x.reduce(i(f), {});
			g === !1 && (S = {});
			let { prevResolvedValues: ee = {} } = p, te = {
				...ee,
				...S
			}, ne = (t) => {
			...
			for (let e in te) {
				...
				let r = !1;
				r = Sn(t) && Sn(n) ? !Ya(t, n) : t !== n, r ? t == null ? l.add(e) : ne(e) : t !== void 0 && l.has(e) ? ne(e) : p.protectedKeys[e] = !0;
			}
...
var ao = class {
	...
	updateAnimationControlsSubscription() {
		...
		$e(e) && (this.unmountControls = e.subscribe(this.node));
	}
	mount() {
...
function Co(e, t, n, r = .5) {
	e.origin = r, e.originPoint = K(t.min, t.max, e.origin), e.scale = J(n) / J(t), e.translate = K(n.min, n.max, e.origin) - e.originPoint, (e.scale >= vo && e.scale <= yo || isNaN(e.scale)) && (e.scale = 1), (e.translate >= bo && e.translate <= xo || isNaN(e.translate)) && (e.translate = 0);
}
function wo(e, t, n, r) {
...
var Qo = class {
	constructor(e, t, { transformPagePoint: n, contextWindow: r, dragSnapToOrigin: i = !1 } = {}) {
		if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
			...
			this.lastMoveEvent = e, this.lastMoveEventInfo = $o(t, this.transformPagePoint), M.update(this.updatePoint, !0);
		...
		let a = $o(fo(e), this.transformPagePoint), { point: o } = a, { timestamp: s } = P;
		this.history = [{
			...o,
			timestamp: s
		}];
...
function is(e, t) {
	...
	for (; n >= 0 && (r = e[n], !(i.timestamp - r.timestamp > /* @__PURE__ */ H(t)));) n--;
	if (!r) return {
		x: 0,
		y: 0
	};
	let a = /* @__PURE__ */ U(i.timestamp - r.timestamp);
	if (a === 0) return {
		x: 0,
		y: 0
	};
...
function us(e, t) {
	let n = .5, r = J(e), i = J(t);
	return i > r ? n = /* @__PURE__ */ ai(t.min, t.max - r, e.min) : r > i && (n = /* @__PURE__ */ ai(e.min, e.max - i, t.min)), I(0, 1, n);
}
function ds(e, t) {
	let n = {};
...
var vs = /* @__PURE__ */ new WeakMap(), ys = class {
	constructor(e) {
		this.openDragLock = null, this.isDragging = !1, this.currentDirection = null, this.originPoint = {
			x: 0,
			y: 0
		}, this.constraints = !1, this.hasMutatedConstraints = !1, this.elastic = Y(), this.visualElement = e;
	}
	start(e, { snapToCursor: t = !1 } = {}) {
		...
		let r = (e) => {
			...
			this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), X((e) => {
			...
			}), i && M.postRender(() => i(e, t)), zn(this.visualElement, "transform");
		...
		}, o = (e, t) => this.stop(e, t), s = () => X((e) => this.getAnimationState(e) === "paused" && this.getAxisMotionValue(e).animation?.play()), { dragSnapToOrigin: c } = this.getProps();
	...
	resolveConstraints() {
		...
		e && lt(e) ? this.constraints ||= this.resolveRefConstraints() : this.constraints = e && n ? ss(n.layoutBox, e) : !1, this.elastic = ps(t), r !== this.constraints && n && this.constraints && !this.hasMutatedConstraints && X((e) => {
	...
	resolveRefConstraints() {
		...
		if (!e || !lt(e)) return !1;
		let n = e.current;
		F(n !== null, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.");
	...
	startAxisValueAnimation(e, t) {
		...
		return zn(this.visualElement, e), n.start(Va(e, n, 0, t, this.visualElement, !1));
	}
	stopAnimation() {
	...
	scalePositionWithinConstraints() {
		...
		this.visualElement.current.style.transform = i ? i({}, "") : "none", n.root && n.root.updateScroll(), n.updateLayout(), this.resolveConstraints(), X((t) => {
	...
	addListeners() {
		...
		let e = this.visualElement.current, t = mo(e, "pointerdown", (e) => {
			...
			lt(e) && e.current && (this.constraints = this.resolveRefConstraints());
		}, { projection: r } = this.visualElement, i = r.addEventListener("measure", n);
		r && !r.layout && (r.root && r.root.updateScroll(), r.updateLayout()), M.read(n);
...
var Ss = class extends ao {
	constructor(e) {
		super(e), this.removeGroupControls = j, this.removeListeners = j, this.controls = new ys(e);
	}
	mount() {
...
var Ds = { correct: (e, t) => {
	...
	componentDidMount() {
		...
		At(js), i && (t.group && t.group.add(i), n && n.register && r && n.register(i), i.root.didUpdate(), i.addEventListener("animationComplete", () => {
			this.safeToRemove();
		}), i.setOptions({
			...i.options,
	...
	getSnapshotBeforeUpdate(e) {
		...
		return a ? (a.isPresent = i, r || e.layoutDependency !== t || t === void 0 || e.isPresent !== i ? a.willUpdate() : this.safeToRemove(), e.isPresent !== i && (i ? a.promote() : a.relegate() || M.postRender(() => {
			let e = a.getStack();
	...
	componentDidUpdate() {
		...
		e && (e.root.didUpdate(), mt.postRender(() => {
...
var Is = [
	...
	"BottomLeft",
	"BottomRight"
], Ls = Is.length, Rs = (e) => typeof e == "string" ? parseFloat(e) : e, zs = (e) => typeof e == "number" || z.test(e);
function Bs(e, t, n, r, i, a) {
	i ? (e.opacity = K(0, n.opacity ?? 1, Hs(r)), e.opacityExit = K(t.opacity ?? 1, 0, Us(r))) : a && (e.opacity = K(t.opacity ?? 1, n.opacity ?? 1, r));
	for (let i = 0; i < Ls; i++) {
		let a = `border${Is[i]}Radius`, o = Vs(t, a), s = Vs(n, a);
		(o !== void 0 || s !== void 0) && (o ||= 0, s ||= 0, o === 0 || s === 0 || zs(o) === zs(s) ? (e[a] = Math.max(K(Rs(o), Rs(s), r), 0), (R.test(s) || R.test(o)) && (e[a] += "%")) : e[a] = s);
	}
...
var Hs = /*@__PURE__*/ Ws(0, .5, Di), Us = /*@__PURE__*/ Ws(.5, .95, j);
function Ws(e, t, n) {
...
function Js(e, t = 0, n = 1, r = .5, i, a = e, o = e) {
	if (R.test(t) && (t = parseFloat(t), t = K(o.min, o.max, t / 100) - o.min), typeof t != "number") return;
	...
	return class {
		constructor(e = {}, n = t?.()) {
			this.id = hc++, this.animationId = 0, this.children = /* @__PURE__ */ new Set(), this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
				...
				this.projectionUpdateScheduled = !1, k.value && (dc.nodes = dc.calculatedTargetDeltas = dc.calculatedProjections = 0), this.nodes.forEach(xc), this.nodes.forEach(Oc), this.nodes.forEach(kc), this.nodes.forEach(Sc), k.addProjectionMetrics && k.addProjectionMetrics(dc);
		...
		update() {
			...
			let e = V.now();
			P.delta = I(0, 1e3 / 60, e - P.timestamp), P.timestamp = e, P.isProcessing = !0, Ne.update.process(P), Ne.preRender.process(P), Ne.render.process(P), P.isProcessing = !1;
		}
		didUpdate() {
			this.updateScheduled || (this.updateScheduled = !0, mt.read(this.scheduleUpdate));
		}
		clearAllSnapshots() {
		...
		removeElementScroll(e) {
			...
			for (let n = 0; n < this.path.length; n++) {
				...
				r !== this.root && i && a.layoutScroll && (i.wasRoot && Q(t, e), Wo(t.x, i.offset.x), Wo(t.y, i.offset.y));
			}
			return t;
		}
		...
		removeTransform(e) {
			...
			for (let e = 0; e < this.path.length; e++) {
				...
				let r = Y();
				Q(r, n.measurePageBox()), Qs(t, n.latestValues, n.snapshot ? n.snapshot.layoutBox : void 0, r);
			}
		...
		resolveTargetDelta(e = !1) {
			...
			if (!(!this.layout || !(r || i))) {
				if (this.resolvedRelativeTargetAt = P.timestamp, !this.targetDelta && !this.relativeTarget) {
					...
					e && e.layout && this.animationProgress !== 1 ? (this.relativeParent = e, this.forceRelativeParentToResolveTarget(), this.relativeTarget = Y(), this.relativeTargetOrigin = Y(), Oo(this.relativeTargetOrigin, this.layout.layoutBox, e.layout.layoutBox), Q(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0;
				}
				if (!(!this.relativeTarget && !this.targetDelta)) {
					if (this.target || (this.target = Y(), this.targetWithTransforms = Y()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), Eo(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : Q(this.target, this.layout.layoutBox), Bo(this.target, this.targetDelta)) : Q(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget) {
						this.attemptToResolveRelativeTarget = !1;
						let e = this.getClosestProjectingParent();
						e && !!e.resumingFrom == !!this.resumingFrom && !e.options.layoutScroll && e.target && this.animationProgress !== 1 ? (this.relativeParent = e, this.forceRelativeParentToResolveTarget(), this.relativeTarget = Y(), this.relativeTargetOrigin = Y(), Oo(this.relativeTargetOrigin, this.target, e.target), Q(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0;
					}
					k.value && dc.calculatedTargetDeltas++;
				}
			}
		}
		...
		startAnimation(e) {
			this.notifyListeners("animationStart"), this.currentAnimation?.stop(), this.resumingFrom?.currentAnimation?.stop(), this.pendingAnimation &&= (N(this.pendingAnimation), void 0), this.pendingAnimation = M.update(() => {
				Ts.hasAnimatedSinceResize = !0, Xn.layout++, this.motionValue ||= Pn(0), this.currentAnimation = Ms(this.motionValue, [0, 1e3], {
					...e,
					velocity: 0,
					isSync: !0,
					onUpdate: (t) => {
		...
		applyTransformsToTarget() {
			...
			if (!(!t || !n || !r)) {
				...
				Q(t, n), Ko(t, i), wo(this.projectionDeltaWithTransform, this.layoutCorrected, t, i);
			}
		}
		...
		getProjectionStyles(e) {
			...
			if (!this.projectionDelta || !this.layout || !r.target) {
				let t = {};
				return this.options.layoutId && (t.opacity = this.latestValues.opacity === void 0 ? 1 : this.latestValues.opacity, t.pointerEvents = fn(e?.pointerEvents) || ""), this.hasProjected && !Po(this.latestValues) && (t.transform = n ? n({}, "") : "none", this.hasProjected = !1), t;
			}
			...
			for (let e in kt) {
				...
				let { correct: n, applyTo: a, isCSSVariable: o } = kt[e], s = t.transform === "none" ? i[e] : n(i[e], r);
				if (a) {
					let e = a.length;
...
function bc(e) {
	...
	if (e.isLead() && e.layout && t && e.hasListeners("didUpdate")) {
		...
		i === "size" ? X((e) => {
			let r = a ? t.measuredBox[e] : t.layoutBox[e], i = J(r);
			r.min = n[e].min, r.max = r.min + i;
		}) : Vc(i, t.layoutBox, n) && X((r) => {
			let i = a ? t.measuredBox[r] : t.layoutBox[r], o = J(n[r]);
...
function xc(e) {
	k.value && dc.nodes++, e.parent && (e.isProjecting() || (e.isProjectionDirty = e.parent.isProjectionDirty), e.isSharedProjectionDirty ||= !!(e.isProjectionDirty || e.parent.isProjectionDirty || e.parent.isSharedProjectionDirty), e.isTransformDirty ||= e.parent.isTransformDirty);
}
function Sc(e) {
...
}, Lc = (e) => typeof navigator < "u" && navigator.userAgent && navigator.userAgent.toLowerCase().includes(e), Rc = Lc("applewebkit/") && !Lc("chrome/") ? Math.round : j;
function zc(e) {
...
function cl(e, t, n = {}) {
	...
	return r.forEach((e) => {
		(n.useGlobalTarget ? window : e).addEventListener("pointerdown", o, i), ve(e) && (e.addEventListener("focus", (e) => ol(e, i)), !nl(e) && !e.hasAttribute("tabindex") && (e.tabIndex = 0));
	}), a;
}
//#endregion
...
function El(e, t, n) {
	for (let r in t) {
		...
		else if (B(a)) e.addValue(r, Pn(i, { owner: e }));
		else if (a !== i) {
			if (e.hasValue(r)) {
				let t = e.getValue(r);
...
function Vl(e, t) {
	let n = Bl(e);
	return n !== Rl && (n = G), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0;
}
//#endregion
...
var Hl = [
	...
	constructor({ parent: e, props: t, presenceContext: n, reducedMotionConfig: r, blockInitialAnimation: i, visualState: a }, o = {}) {
		...
		this.latestValues = s, this.baseTarget = { ...s }, this.initialValues = t.initial ? { ...s } : {}, this.renderState = c, this.parent = e, this.props = t, this.presenceContext = n, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = r, this.options = o, this.blockInitialAnimation = !!i, this.isControllingVariants = rt(t), this.isVariantNode = it(t), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
		let { willChange: l, ...u } = this.scrapeMotionValuesFromProps(t, {}, this);
		for (let e in u) {
			let t = u[e];
			s[e] !== void 0 && B(t) && t.set(s[e], !1);
		}
	}
	mount(e) {
		this.current = e, Tl.set(e, this), this.projection && !this.projection.instance && this.projection.mount(e), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((e, t) => this.bindToMotionValue(t, e)), Cl.current || wl(), this.shouldReduceMotion = this.reducedMotionConfig === "never" ? !1 : this.reducedMotionConfig === "always" || Sl.current, process.env.NODE_ENV !== "production" && Xe(this.shouldReduceMotion !== !0, "You have Reduced Motion enabled on your device. Animations may not appear as expected."), this.parent && this.parent.children.add(this), this.update(this.props, this.presenceContext);
	}
	unmount() {
		this.projection && this.projection.unmount(), N(this.notifyUpdate), N(this.render), this.valueSubscriptions.forEach((e) => e()), this.valueSubscriptions.clear(), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this);
		for (let e in this.events) this.events[e].clear();
	...
	bindToMotionValue(e, t) {
		...
		let r = t.on("change", (t) => {
			this.latestValues[e] = t, this.props.onUpdate && M.preRender(this.notifyUpdate), n && this.projection && (this.projection.isTransformDirty = !0);
	...
	readValue(e, t) {
		...
		return n != null && (typeof n == "string" && (Dl(n) || Ol(n)) ? n = parseFloat(n) : !Pl(n) && G.test(t) && (n = Vl(e, t)), this.setBaseTarget(e, B(n) ? n.get() : n)), B(n) ? n.get() : n;
	}
	setBaseTarget(e, t) {
		this.baseTarget[e] = t;
	}
	getBaseTarget(e) {
		...
		return r !== void 0 && !B(r) ? r : this.initialValues[e] !== void 0 && n === void 0 ? void 0 : this.baseTarget[e];
	}
	on(e, t) {
...
var Kl = 4;
function ql(e, t, n = 1) {
	F(n <= Kl, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`);
	let [r, i] = Gl(e);
	if (!r) return;
...
function Xl(e, t, n) {
	...
	for (; r < e.length && !i;) {
		let t = e[r];
		typeof t == "string" && !Yl.has(t) && _r(t).values.length && (i = e[r]), r++;
	}
...
var tu = class extends Ql {
	...
	readValueFromInstance(e, t) {
		if (Mt.has(t)) return this.projection?.isProjecting ? Zi(t) : $i(e, t);
		{
			let n = eu(e), r = (Tt(t) ? n.getPropertyValue(t) : n[t]) || 0;
...
function ru(e, t, n, r) {
	$l(e, t, void 0, r);
	for (let n in t.attrs) e.setAttribute(nu.has(n) ? n : dt(n), t.attrs[n]);
}
//#endregion
...
var iu = class extends Ql {
	...
	readValueFromInstance(e, t) {
		...
		return t = nu.has(t) ? t : dt(t), e.getAttribute(t);
	}
	scrapeMotionValuesFromProps(e, t, n) {
		return vn(e, t, n);
	}
...
}, au = (e, t) => cn(e) ? new iu(t) : new tu(t, { allowProjection: e !== v }), ou = /*@__PURE__*/ Ze(/* @__PURE__ */ bn({
	...co,
	...bl,
	...Kc,
	...xl
...
}), cu = S(function({ size: e, icon: t, state: n = "normal", color: r = "currentColor", ...i }, a) {
	if (!t) return null;
	let o = t, s = t.displayName?.includes("Animated"), c = r.startsWith("#"), u = ((e) => e === "currentColor" ? "text-current" : e === "default" ? "text-f1-icon" : e.startsWith("#") ? "" : `text-f1-icon-${e}`)(r), d = c ? { color: r } : void 0;
	return s ? /* @__PURE__ */ E(o, {
		ref: a,
		...i,
		animate: n,
		className: l(su({ size: e }), "select-none", u),
		style: d,
		"data-has-color": r === "currentColor" ? void 0 : "true"
	}) : /* @__PURE__ */ E(o, {
		ref: a,
		...i,
		className: l("aspect-square", su({ size: e }), u),
		style: d,
		"data-has-color": r === "currentColor" ? void 0 : "true"
	});
}), lu = o(a({
...
function hu({ emoji: e, size: t, alt: n, mode: r = "image" }) {
	let i = r === "native" ? null : gu(e), a = {
		initial: { scale: .75 },
		animate: { scale: 1 },
		exit: { scale: .75 },
		transition: {
	...
	return r === "native" ? /* @__PURE__ */ E(ou.span, {
		className: l(pu({ size: t }), mu({ size: t }), "inline-flex items-center justify-center leading-none font-emoji"),
		"aria-label": n === "" ? void 0 : n ?? e,
		role: n === "" ? void 0 : "img",
		"aria-hidden": n === "" || void 0,
		...a,
		children: e
	}, e) : i ? /* @__PURE__ */ E(ou.img, {
		src: i.url,
		alt: n ?? e,
		className: pu({ size: t }),
		draggable: !1,
		...a
	}, i.url) : /* @__PURE__ */ E(ou.span, {
		...a,
		children: e
	}, e);
}
var gu = (e) => {
	let [t] = (0, fu.parse)(e, { buildUrl: (e) => `https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/${e}.svg` });
	return t || null;
};
function _u(e) {
	return `${e} emoji`;
...
function vu(e) {
	...
	let n = { title: void 0 };
	return t["aria-label"] == null && t["aria-labelledby"] == null && typeof t.title == "string" && (n["aria-label"] = t.title), y(e, n);
}
var yu = S((e, t) => /* @__PURE__ */ D("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	ref: t,
	...e,
	children: [/* @__PURE__ */ E("title", { children: "Windows" }), /* @__PURE__ */ E("path", {
		fill: "currentColor",
		fillRule: "evenodd",
...
}, Su = (e) => typeof e == "object" && !!e && !Array.isArray(e), Cu = (e, t) => {
	let n = { ...e };
	for (let [e, r] of Object.entries(t)) {
		if (r === void 0) continue;
		let t = n[e];
		n[e] = Su(r) && Su(t) ? Cu(t, r) : r;
	}
	return n;
};
function wu({ children: e, translations: t }) {
	let n = w(() => Cu(m, t), [t]), r = (e, t = {}) => {
		let r = xu(e, n);
		if (r === void 0) return console.warn(`Translation key ${e} not found`), e;
		for (let [e, n] of Object.entries(t)) r = r.replace(`{{${e}}}`, n.toString());
		return r;
	};
	return /* @__PURE__ */ E(bu.Provider, {
		value: {
			...n,
			t: r
		},
...
function Mu({ keys: e, variant: t }) {
	...
	return /* @__PURE__ */ D("div", {
		...
		children: [/* @__PURE__ */ E("span", {
			...
			let r = e.toLowerCase(), a = ju(r), o = a ? i[r] : e, s = typeof o != "string";
			return /* @__PURE__ */ E("kbd", {
				className: l(Ou({ variant: t }), a ? "" : "uppercase", s ? "w-5 px-0.5" : "min-w-5 px-1"),
				children: s ? /* @__PURE__ */ E(lu, {
					icon: o,
					size: "sm"
				}) : o
			}, n);
...
var Nu = o(ue("Shortcut", Mu));
//#endregion
//#region src/experimental/Overlays/Tooltip/index.tsx
function Pu({ label: e, description: t, items: n, children: r, shortcut: i, instant: a = !1, delay: o = 700, onOpen: s }) {
	let [c, m] = se(!1), h = T(null), g = w(() => a ? 100 : o, [o, a]), _ = !!(e || t || n?.length || i), v = ne(() => {
		h.current &&= (clearTimeout(h.current), null);
	}, []), y = ne(() => {
		v(), m(!1);
	}, [v]), b = ne(() => {
		_ && (s?.(), v(), h.current = setTimeout(() => m(!0), g));
	}, [
		v,
		_,
		s,
	...
	return /* @__PURE__ */ E(ce, { children: /* @__PURE__ */ E(f, {
		delayDuration: g,
		...
		children: /* @__PURE__ */ D(p, {
			...
			children: [/* @__PURE__ */ E(u, {
				...
				onPointerDown: () => y(),
				onFocus: (e) => {
					_ && (x(e.currentTarget) ? (s?.(), m(!0)) : y());
				},
				onBlur: () => y(),
				children: vu(r)
			}), /* @__PURE__ */ E(d, {
				className: l("max-w-xs", i && "pr-1.5", a && "pointer-events-none"),
				children: /* @__PURE__ */ D("div", {
					...
					children: [
						...
						n && n.length > 0 && /* @__PURE__ */ E("ul", {
							...
							children: n.map((e, t) => /* @__PURE__ */ E("li", { children: typeof e == "string" ? e : /* @__PURE__ */ D(ce, { children: [/* @__PURE__ */ E("span", {
								className: "font-semibold",
								children: e.title
							}), e.description && /* @__PURE__ */ D(ce, { children: [" ", e.description] })] }) }, `${t}-${typeof e == "string" ? e : e.title}`))
						})
					]
				})
			})]
...
//#endregion
export { Oe as $, Ms as A, Gr as B, Tl as C, qc as D, Sl as E, li as F, Dn as G, H, ci as I, F as J, En as K, si as L, Wa as M, Ta as N, uc as O, yi as P, M as Q, ai as R, Ul as S, Cl as T, Mn as U, K as V, Pn as W, qe as X, Xe as Y, N as Z, lu as _, Wu as a, ue as at, iu as b, Pu as c, Du as d, we as et, Eu as f, du as g, _u as h, Hu as i, de as it, Y as j, lc as k, Nu as l, hu as m, Vu as n, me as nt, Ru as o, yu as p, B as q, Uu as r, fe as rt, Iu as s, Bu as t, ge as tt, wu as u, cu as v, wl as w, tu as x, ou as y, ri as z };

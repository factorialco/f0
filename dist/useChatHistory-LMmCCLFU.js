...
import { useInsertionEffect as rn, forwardRef as p, createElement as $e, useRef as I, useMemo as ee, useEffect as X, useLayoutEffect as vt, useState as P, useCallback as q, createContext as Ye, useContext as Pe, useId as wt } from "react";
import { cm as nn, cn as on, co as sn, cp as an, cq as xt, cr as cn, cs as ln, ct as dn, cu as fn, cv as un, cw as kt, cx as hn, cy as gn, cz as pn, cA as mn, cB as Cn, cC as vn, cD as wn, cE as We, cF as xn, cG as kn, cH as bn, cI as Ln, cJ as yn, Z as bt, cK as Mn, cL as En, cM as Rn, cN as Fn, cO as Nn, cP as Lt, cQ as Sn, cR as Vn, a6 as m1, cS as Tn, aJ as Hn, cT as An, cU as Bn, cV as $n, ag as In, cW as Pn, bR as jn, aa as C1, ad as Dn, cX as Zn, b9 as v1, a1 as yt, S as Ke, cY as Mt, be as _n, cZ as On, c_ as Un, b2 as zn, bQ as Gn, $ as Le, au as Wn, bi as Et, c$ as qn, bO as Xn, d0 as Re, bK as Yn, d1 as Kn, d2 as Rt, b1 as Ft, d3 as Qn, d4 as Jn, d5 as eo, d6 as to, d7 as ro, d8 as Nt, bC as no, bD as oo, d9 as so, da as io, db as ao, dc as co, dd as lo, de as fo, df as uo, dg as ho, dh as go, di as po, dj as mo, dk as Co, dl as vo, dm as wo, bP as xo, ab as ko, by as bo, dn as Lo, dp as yo, dq as Mo, dr as Eo, ds as Ro, dt as Fo, du as No, ap as So, dv as St, M as Vo, a0 as To, dw as Vt, dx as Tt, dy as Ho, bh as Ao, bg as Bo, dz as $o, dA as Io, dB as Ht, dC as Po, b0 as jo, ay as Do, dD as Zo, as as _o, b7 as Oo, dE as At, b6 as Uo, dF as zo, bj as w1, dG as Go, dH as Wo, dI as x1, bM as qo, bL as Xo, bN as Bt, dJ as Yo, G as Ko, E as Qo, dK as Jo, dL as es, dM as ts, dN as rs, dO as ns, dP as $t, dQ as os, ac as ss, dR as is, L as fe, q as Fe, o as x, ae as ce, dS as as, bs as cs, bF as ls, y as It, dT as ds, a5 as Qe, c2 as fs, Q as pe, at as us, H as le, a8 as Pt, a9 as hs, af as jt, bt as Dt, dU as gs, a$ as Zt, v as me, dV as ps, dW as ms, U as ue, u as Y, dX as Cs, cj as _t, a2 as vs, dY as ws, aP as ye, A as Ne, p as oe, aD as k1, dZ as xs, aE as b1, aF as L1, b as Me, d_ as ks, d$ as bs, bG as Ls, V as ys, e0 as Ms, e1 as Es, e2 as Rs, e3 as $1, a3 as Fs, ak as Ot, aS as Ut, e4 as Ns, c1 as Ss, e5 as Vs, e6 as Ts, aX as zt, e7 as Hs, bX as As, e8 as Bs, aU as Ie, b8 as Gt, e9 as Wt, ba as qt, c as u1, ea as Xt, eb as $s, bn as Is, ec as Ps, bd as y1, bz as js, ed as Ds, ee as Zs, ef as _s, eg as Os, eh as Us, z as zs, ei as Yt, ej as Kt, ek as Gs, aj as I1, el as Ws, ai as qs, em as Xs, en as Ys } from "./F0CanvasPanel-BU9pEeuV.js";
...
function Jt(e, t, n, o) {
  return typeof e == "string" && M1(t) ? nn(e, n, o) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e : [e];
}
function ei(e, t, n) {
  return e * (t + 1);
}
...
function er(e, t) {
  return on(e) ? e[ti(0, e.length, t)] : e;
}
function ri(e, t, n) {
  for (let o = 0; o < e.length; o++) {
    const s = e[o];
    s.at > t && s.at < n && (an(e, s), o--);
  }
}
...
function ci(e, { defaultTransition: t = {}, ...n } = {}, o, s) {
  ...
  for (let h = 0; h < e.length; h++) {
    ...
    const T = (E, L, b, A = 0, H = 0) => {
      const y = li(E), { delay: R = 0, times: F = cn(y), type: $ = "keyframes", repeat: _, repeatType: z, repeatDelay: G = 0, ...re } = L;
      let { ease: K = t.ease || "easeOut", duration: O } = L;
      const Z = typeof R == "function" ? R(A, H) : R, D = y.length, Q = fn($) ? $ : s?.[$];
      if (D <= 2 && Q) {
        let ie = 100;
        if (D === 2 && ui(y)) {
          const de = y[1] - y[0];
      ...
      if (he > 0 && dn(F, he), y.length === 1 && y.unshift(null), _) {
        ...
        for (let de = 0; de < _; de++) {
          ...
          for (let M = 0; M < ie.length; M++)
            F.push(ne[M] + (de + 1)), K.push(M === 0 ? "linear" : er(se, M - 1));
        }
        oi(F, _);
      }
      const ge = W + O;
  ...
  return d.forEach((h, C) => {
    for (const v in h) {
      ...
      for (let L = 0; L < w.length; L++) {
        ...
        k.push(A), V.push(hn(0, m, b)), T.push(H || "easeOut");
      }
...
function tr(e, t, n, o) {
  const s = [];
  if (Ci(e, t))
    s.push(xn(e, M1(t) && t.default || t, n && (n.default || n)));
  else {
    ...
    for (let d = 0; d < a; d++) {
      ...
      "delay" in g && typeof g.delay == "function" && (g.delay = g.delay(d, a)), s.push(...kn(f, { ...t, transition: g }, {}));
    }
  }
  return s;
}
function vi(e, t, n) {
  const o = [];
  return ci(e, t, n, { spring: bn }).forEach(({ keyframes: i, transition: a }, d) => {
    o.push(...tr(d, i, a));
  }), o;
}
class wi {
...
const Gc = (e, t) => /* @__PURE__ */ c(
...
), Vl = p(Sl), Tl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  AcademicCap: Mi,
  Add: Ln,
  Ai: Ri,
  ...
  Wifi: Vl,
  Windows: is
}, Symbol.toStringTag, { value: "Module" })), Hl = (e, t) => /* @__PURE__ */ r(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
...
const Ae = Fe({
  ...
  ({
    ...
    const g = s ?? $l[t ?? "body"], m = l ? /* @__PURE__ */ r("span", { className: "text-f1-foreground-critical", "aria-hidden": "true", children: " *" }) : null;
    if (i !== void 0) {
...
const Jl = Fe({
  ...
  ({
    ...
    const He = D && D !== "none" || Q && Q !== "none" || W && W !== "none" || he && he !== "none", De = Z && Z !== "none" || He, o1 = { sm: e1, md: t1, lg: je, xl: r1 }, s1 = e2.map((Ze) => {
      const _e = o1[Ze];
      return _e ? Ql(Ze, _e) : "";
    }).filter(Boolean).join(" ");
    return /* @__PURE__ */ r(
...
}), c1 = { sm: 640, md: 768, "container-md": 448 }, g1 = (e) => "type" in e && e.type === "separator", qe = (e) => "type" in e && e.type === "split", r2 = (e) => !("type" in e), Xe = (e, t, n) => /* @__PURE__ */ r(
  pe,
  {
    label: e.label,
    icon: e.icon,
...
function Z1({
  ...
  const g = I(null), { width: m = 0 } = ls({
    ref: g,
    box: "border-box"
  }), h = a === "sm" || a === "md" ? c1[a] : c1.md, C = It(`(min-width: ${h}px)`, {
    initializeWithValue: !1
  }), v = a === "none" ? !0 : a === "container-md" ? m >= c1["container-md"] : C, w = typeof o == "string" ? o : o.base, k = typeof o == "string" ? o : o.md, V = v ? k : w, T = Array.isArray(
    t
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      style: { gap: s },
      children: v ? /* @__PURE__ */ r(o2, { ...L }, "row") : /* @__PURE__ */ r(n2, { ...L }, "stacked")
    }
  );
}
function n2({
  ...
  return /* @__PURE__ */ c(xe, { children: [
    o.length > 0 && /* @__PURE__ */ r(fs, { items: o }),
    i,
    n && yr(n, s),
    e && Mr(e, s)
  ] });
...
function d2({
  ...
  return !!m || (Array.isArray(t) ? t.length > 0 : !!t) || (n?.length ?? 0) > 0 ? f(
    /* @__PURE__ */ r(
      Z1,
      {
        primaryAction: m,
...
const Er = p(
  function({
    ...
    return T ? /* @__PURE__ */ r(ms, { ref: V, alert: h, fullHeight: m, children: L }) : L;
  }
);
Er.displayName = "F0CardRow";
const f2 = ({ compact: e = !1 }) => /* @__PURE__ */ r(
  Dt,
  {
    className: x(
...
function p2({
  ...
  return e.errorMessage ? /* @__PURE__ */ r(vs, { label: e.errorMessage, children: o }) : o;
}
const m2 = {
  soft: {
    text: "",
...
const y2 = ({
  ...
  return e.length === 0 ? null : /* @__PURE__ */ c(
    k1,
    {
      ...
      children: [
        /* @__PURE__ */ r(xs, { asChild: !0, children: /* @__PURE__ */ r("div", { className: "flex w-full flex-wrap items-center gap-2", children: e.map((d, l) => /* @__PURE__ */ r(b1, { asChild: !0, children: /* @__PURE__ */ r(
          fe,
          {
            variant: "outline",
            label: d.label,
        ...
        a && /* @__PURE__ */ c(
          L1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "flex flex-col", children: L2(a.items).map((d, l) => /* @__PURE__ */ c(
                "button",
                {
                  type: "button",
                  onClick: () => {
...
const B2 = /[\\`*_{}[\]()#+\-.!|~>]/g, $2 = (e) => e.split(/(<entity-ref\b[^>]*>[\s\S]*?<\/entity-ref>)/g).map((t, n) => n % 2 === 1 ? t : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(B2, "\\$&")).join(""), d9 = ({
  onSubmit: e,
  onStop: t,
  inProgress: n,
  onBeforeSubmit: o,
  ...
  const je = Ce.status === "recording", r1 = je ? b.ai.listening : b.ai.inputPlaceholder, n1 = ge.filter((te) => te.status === "uploaded"), Se = ge.some((te) => te.status === "uploading"), He = ge.some((te) => te.status === "error"), De = H.trim().length > 0;
  X(() => {
    if (!(!z || Se)) {
      if (G(!1), He) {
  ...
  const o1 = async (te) => {
    if (te.preventDefault(), !Q) {
      if (J.close(), n)
        ...
        const ke = J.transformMentions(H.trim()), i1 = $2(ke), Ue = n1.flatMap(
  ...
  }, S1 = re ? re.prompt ?? re.title : null, V1 = je ? [b.ai.listening] : S1 ? [S1] : s ?? [], Qr = V1.length > 1, Jr = ee(() => M2(H, J.mentions, {
    cursorPosition: R,
    inlineCompletion: J.inlineCompletion
  }), [H, J.mentions, R, J.inlineCompletion]), en = J.mentions.length > 0 || J.inlineCompletion !== null, Oe = k && !!T && T.length > 0 && !!E ? /* @__PURE__ */ r(
    y2,
    {
      suggestions: T,
      onItemClick: he,
...
function Ve({
  ...
  return /* @__PURE__ */ c(
    Ms,
    {
      ...
      children: [
        /* @__PURE__ */ r(Es, { asChild: !0, children: t }),
        /* @__PURE__ */ r(
          Rs,
          {
            side: "top",
...
const z1 = 7, h4 = 625, G1 = /* @__PURE__ */ new Set();
function g4(e) {
...
function m4(e) {
  const { days: t, hours: n, minutes: o, seconds: s } = Vs(e), i = [];
...
function Ar(e, t) {
  ...
  if (t === "duration" && typeof e == "number")
    return { type: "item", text: m4(e) };
  if (t === "richtext" && typeof e == "object" && e !== null && "value" in e) {
    const n = e.value;
    return { type: "item", text: (n ? g4(n) : "") || "—" };
  }
  ...
  return { type: "item", text: p4(String(e)) };
}
function Br({
  formName: e,
  formDescription: t,
  ...
  const { canvasContent: l, openCanvas: u, closeCanvas: f } = Me(), g = u4(e), m = d ?? g, h = I(() => {
...
const Pr = Ye(void 0), g9 = () => Pe(Pr), x4 = (e) => /* @__PURE__ */ r(zt, { content: e, format: "markdown" }), k4 = ({
  isGenerating: e,
  isLoading: t,
  message: n,
  renderToolCall: o,
  ...
  const d = typeof n?.content == "string" ? n.content : "", l = (n && o?.(n)) ?? n?.generativeUI?.() ?? null, u = n?.toolCalls?.[0]?.id, f = !d && !l, g = I(null), { anchor: m, clear: h } = $r({
    containerRef: g,
    enabled: !!(n?.id && d)
  });
  return X(() => {
  ...
  return /* @__PURE__ */ r(jr.Provider, { value: o, children: e });
}, Dr = () => {
  const e = Pe(jr);
  if (e === null)
    throw new Error(
...
const M4 = ({
  ...
  const o = Y(), { open: s } = Dr(), [i, a] = P(null);
...
const Zr = (e) => /* @__PURE__ */ r(zt, { content: e, format: "markdown" }), S4 = ({
  text: e,
  renderMarkdown: t
  ...
  const a = e.rawData, d = N4(
    e?.content,
    a
  ), l = (F4(e?.content) ?? "").trim(), u = e?.replyQuote ?? null, f = l.length > 0, { anchor: g, clear: m } = $r({
    containerRef: i,
    enabled: f
  });
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        u && /* @__PURE__ */ r(S4, { text: u, renderMarkdown: o }),
...
}, T4 = 35, H4 = 22, A4 = 400, B4 = 2500, $4 = 220, I4 = ({
  messages: e,
  onClick: t,
  fullscreen: n = !1
}) => {
  ...
  X(() => {
    ...
    let m;
    if (d === "starting")
      m = setTimeout(() => l("writing"), A4);
    else if (d === "writing")
      i < u.length ? m = setTimeout(() => a((h) => h + 1), T4) : l("holding");
    else if (d === "holding") {
      if (e.length <= 1) return;
      m = setTimeout(() => l("erasing"), B4);
    } else d === "erasing" && (i > 0 ? m = setTimeout(() => a((h) => h - 1), H4) : m = setTimeout(() => {
...
const j4 = {
...
}, p9 = (e) => /* @__PURE__ */ r(L4, { children: /* @__PURE__ */ r(D4, { ...e }) }), D4 = ({
  turns: e,
  isLoadingThread: t = !1,
  interrupt: n,
  initialMessage: o,
  ...
  const { modal: T, handleSubmit: E, handleClose: L } = y4(
    f ?? j4
  ), b = Y(), A = v ?? k4, H = w ?? V4, y = ee(() => {
    const D = o ?? b.ai.defaultInitialMessage;
    return (Array.isArray(D) ? D : [D]).filter((W) => typeof W == "string" && W.length > 0);
  }, [o, b.ai.defaultInitialMessage]), R = !t && e.length === 0 && y.length > 0, F = I(null), $ = I(null), _ = I(null), z = I(null), G = I(null), { showScrollBtn: re, turnMinHeight: K, scrollToBottom: O } = P4({
    viewportRef: F,
    contentRef: $,
    endRef: _,
    lastTurnRef: G,
...
}, Z4 = () => /* @__PURE__ */ r("div", { className: "flex h-full w-full max-w-content flex-col gap-6", children: /* @__PURE__ */ c("div", { className: "flex flex-col gap-2", children: [
...
const O4 = ({
  ...
  const m = Y().ai.clarifyingQuestion.typeYourAnswer, h = e === "single" ? /* @__PURE__ */ r(Or, { isSelected: n && !t }) : /* @__PURE__ */ r(
    Xt,
    {
      checked: s,
      onCheckedChange: () => u(!s),
...
const z4 = ({
  ...
  const n = Y(), o = ye(), {
    ...
    const ne = H === "single" && k.includes(ie);
    d(ie), H === "single" && !F && !ne && Promise.resolve().then(l);
  ...
  return /* @__PURE__ */ c("div", { className: "flex flex-col", onKeyDown: he, children: [
    /* @__PURE__ */ r("div", { className: "flex flex-col gap-3 pt-3", children: /* @__PURE__ */ r(Ne, { mode: "wait", initial: !1, children: /* @__PURE__ */ c(
      oe.div,
      {
        ...
        animate: { opacity: 1 },
        exit: { opacity: 0 },
        transition: { duration: ge, ease: W4 },
        children: [
          /* @__PURE__ */ r(
            G4,
            {
...
const et = ["lowp", "mediump", "highp"], t6 = `
void main(void){
    vec4 color = vec4(0.0,0.0,0.0,1.0);
    mainImage( color, gl_FragCoord.xy );
    gl_FragColor = color;
}`, r6 = `void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
...
}`, rt = "iTime", nt = "iTimeDelta", ot = "iDate", st = "iFrame", it = "iMouse", at = "iResolution", n6 = "iChannel", ct = "iChannelResolution", lt = "iDeviceOrientation";
function o6(e, t) {
...
}, d1 = 9729, dt = 9728, l6 = 9987, ft = 33071, ut = 10497;
class d6 {
  gl;
  url;
  wrapS;
  ...
  load = async (t) => {
    ...
    return (t.wrapS !== ft || t.wrapT !== ft || t.minFilter !== dt && t.minFilter !== d1) && !b && (L = this.makePowerOf2(L), b = !0), n.bindTexture(n.TEXTURE_2D, T), n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, l), n.texImage2D(
      n.TEXTURE_2D,
      g,
      m,
      w,
      k,
      L
    ), b && t.minFilter !== dt && t.minFilter !== d1 && n.generateMipmap(n.TEXTURE_2D), n.texParameteri(
      n.TEXTURE_2D,
      n.TEXTURE_WRAP_S,
      this.wrapS || ut
    ), n.texParameteri(
...
}, gt = (e, t, n) => e * (1 - n) + t * n, f6 = (e, t, n) => n > 0 ? e.substring(0, n) + t + e.substring(n, e.length) : t + e;
function u6({
  fs: e,
  vs: t = tt,
  textures: n = [],
...
`,
  ...
  return X(() => {
    ...
    function S() {
      _();
      const N = C.current;
      N && h.current && (N.clearColor(...s), N.clearDepth(1), N.enable(N.DEPTH_TEST), N.depthFunc(N.LEQUAL), N.viewport(0, 0, h.current.width, h.current.height), h.current.height = h.current.clientHeight, h.current.width = h.current.clientWidth, W(), he(), Q(ge(e || r6), t || tt), z(), requestAnimationFrame(ne), se(), Z());
    }
...
}`, g6 = 10, p6 = 2, m6 = 0.5, C6 = 0.2, v6 = 1.5, ve = {
  duration: 0.5,
  ease: "easeOut"
}, pt = {
  duration: 0.35,
...
function w6(e, t) {
  const [n, o] = P(g6), {
    ...
    animate: i,
    motionValue: a
  } = ze(C6), { value: d, animate: l } = ze(p6), { value: u, animate: f } = ze(m6), { value: g, animate: m } = ze(v6), h = Qs(t, {
    fftSize: 512,
...
function b9({
  ...
  const { speed: u, scale: f, amplitude: g, frequency: m, brightness: h } = w6(t, s);
  return /* @__PURE__ */ r(
    zr,
    {
      ref: d,
...
const L9 = ({
  ...
  const o = Y(), s = ye();
  return /* @__PURE__ */ c(xe, { children: [
    e && /* @__PURE__ */ r("span", { className: x(L6(), "truncate"), children: e }),
      ...
      oe.div,
      {
        ...
        children: [
          o === "person" && /* @__PURE__ */ c("div", { className: "flex items-center gap-1", children: [
            ...
            n && /* @__PURE__ */ r("span", { className: x(Ge()), children: n })
          ] }),
          o === "people" && /* @__PURE__ */ r(
            Is,
            {
          ...
          o === "alert" && /* @__PURE__ */ r(js, { text: e.alertLabel, level: e.level }),
          o === "balance" && /* @__PURE__ */ r(E6, { balance: e.balance })
        ]
      }
    ),
    n && !M6.has(o) && /* @__PURE__ */ r(
      oe.span,
      {
        className: x(Ge()),
        animate: { opacity: s ? 0 : 1 },
...
const N6 = ({
  ...
  dataLength: o,
  color: s
}) => n !== o - 1 || e == null || t == null ? null : /* @__PURE__ */ r("circle", { cx: e, cy: t, r: 2, fill: s, stroke: "none" }), S6 = ({
  label: e,
  direction: t
}) => {
  const n = Wr[t];
  ...
  const s = `sparkline-gradient-${wt().replace(/:/g, "")}`, i = F6(e, n), a = Wr[i];
  return /* @__PURE__ */ r("div", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Zs, { width: "100%", height: "100%", children: /* @__PURE__ */ c(
          _s,
          {
            data: e,
            ...
            children: [
              ...
              /* @__PURE__ */ r(Os, { hide: !0, domain: ["dataMin - 1", "dataMax + 1"] }),
              /* @__PURE__ */ r(
                Us,
                {
                  type: "linear",
        ...
        /* @__PURE__ */ r(S6, { label: t, direction: i })
      ]
    }
  ) });
}, qr = p(
        ...
        "div",
        {
          ...
          children: [
            ...
            u.content === "sparkline" ? /* @__PURE__ */ c("div", { className: "flex flex-1 flex-col gap-2", children: [
              /* @__PURE__ */ r("span", { className: x(Gr()), children: o }),
              /* @__PURE__ */ r(
                oe.div,
                {
...
const T6 = ["className"], Xr = p((e, t) => {
  const n = T6.reduce((o, s) => {
    const { [s]: i, ...a } = o;
    return a;
  }, e);
  return /* @__PURE__ */ r(qr, { ref: t, ...n });
});
...
const H6 = () => /* @__PURE__ */ c(
  ...
  "balance",
  "sparkline"
], Yr = 180, A6 = (e) => Number.isFinite(e) ? Math.max(0, Math.floor(e)) : Yr, B6 = (e, t) => e.length <= t ? e : `${e.slice(0, t).trimEnd()}...`, $6 = (e) => e.showActions !== !1, I6 = (e) => Object.fromEntries(
...
function P6(e) {
  ...
  } = e, [l, u] = P(!1), f = wt(), g = I(null), m = A6(
    d
  ), h = i.length > m, C = l ? i : B6(i, m), v = $6(e) ? e : null, w = I6(e);
  return X(() => {
    l && g.current?.focus();
  }, [l]), /* @__PURE__ */ c(
    "section",
...
P6.displayName = "F0AiProposalCard";
const j6 = ({
  icon: e,
  title: t,
  children: n
...
}, D6 = (e) => Tl[e] ?? Nt, Z6 = ({ iconName: e }) => e ? /* @__PURE__ */ r("div", { className: "mr-1 flex items-center justify-center", children: /* @__PURE__ */ r(le, { icon: D6(e), size: "md", color: "default" }) }) : null;
function _6({
  sources: e,
  title: t
}) {
  ...
  return /* @__PURE__ */ r(j6, { icon: w1, title: o, children: /* @__PURE__ */ r("div", { className: "flex flex-col gap-1 rounded-lg border border-solid border-f1-border-secondary p-2", children: e.map((s, i) => {
    const a = /* @__PURE__ */ r(Z6, { iconName: s.icon });
...
_6.displayName = "F0AiMessageSources";
async function O6(e, t, n) {
  const o = await import("./xlsx-Bedf3nwD.js"), s = o.utils.table_to_book(e, { sheet: "Data" });
  o.writeFile(s, `${n}.${t}`);
}
function U6({
...
const mt = ({
  credits: e,
  employeeCredits: t
}) => t ? /* @__PURE__ */ r(W6, { employeeCredits: t }) : e ? /* @__PURE__ */ r(z6, { credits: e }) : null, E9 = ({
  historyEnabled: e = !1,
  title: t,
  ...
  const m = Y(), h = It(`(max-width: ${zs.md}px)`, {
...
function q6() {
  if (!(typeof navigator > "u"))
    return qs(navigator.language);
}
function X6(e) {
  const t = new Date(e), n = /* @__PURE__ */ new Date();
  return Yt(t) ? "today" : Kt(t) ? "yesterday" : Gs(t, n) ? "thisMonth" : "older";
}
function Y6(e, t) {
  const n = new Date(e), o = q6(), s = I1(n, "p", { locale: o });
  if (Yt(n)) return `${t.today}, ${s}`;
  if (Kt(n)) return `${t.yesterday}, ${s}`;
  const i = !Ws(n, /* @__PURE__ */ new Date());
...
function F9({
  ...
  const [o, s] = P([]), [i, a] = P(!1), [d, l] = P(null), [u, f] = P(e9), g = q(async () => {
    a(!0), l(null);
    try {
      const v = await t();
      s(v);

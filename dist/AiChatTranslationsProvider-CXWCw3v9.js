...
import { useInsertionEffect as ke, useRef as B, useEffect as ie, useState as Ue, useCallback as Xe, useMemo as Ye, createContext as $e, useContext as qe } from "react";
import { r as He, l as Ke, m as je, n as Qe, o as Me, p as Je, q as Ze, s as et, t as tt, v as rt, w as Ne, x as nt, V as ot, y as it, z as st, A as at, S as ct, H as ut, B as se, D as lt, E as ft, G as dt, J as ht, K as mt, L as pt, M as fe, N as vt } from "./registry-Cy28z-c5.js";
import { useTrackVolume as gt } from "@livekit/components-react";
import { defaultTranslations as wt } from "./i18n-provider-defaults.js";
function Tt(t, e, r) {
  ke(() => t.on(e, r), [t, e, r]);
}
function ue(t) {
...
function Be(t, e) {
  return Ke(t) ? t[Et(0, t.length, e)] : t;
}
function At(t, e, r) {
...
function It(t, { defaultTransition: e = {}, ...r } = {}, n, o) {
  ...
  for (let l = 0; l < t.length; l++) {
    ...
    const U = (y, w, _, P = 0, V = 0) => {
      const b = _t(y), { delay: f = 0, times: F = Je(b), type: O = "keyframes", repeat: z, repeatType: W, repeatDelay: H = 0, ...k } = w;
      let { ease: M = e.ease || "easeOut", duration: S } = w;
      const N = typeof f == "function" ? f(P, V) : f, K = b.length, Z = tt(O) ? O : o?.[O];
      if (K <= 2 && Z) {
        let j = 100;
        if (K === 2 && Pt(b)) {
          const J = b[1] - b[0];
      ...
      if (re > 0 && et(F, re), b.length === 1 && b.unshift(null), z) {
  ...
  return E.forEach((l, T) => {
    for (const C in l) {
      ...
      for (let w = 0; w < h.length; w++) {
        ...
        L.push(P), I.push(nt(0, x, _)), U.push(V || "easeOut");
      }
...
function Ve(t, e, r, n) {
  ...
  if (Bt(t, e))
    ...
    for (let E = 0; E < m; E++) {
      ...
      "delay" in g && typeof g.delay == "function" && (g.delay = g.delay(E, m)), o.push(...ft(p, { ...e, transition: g }, {}));
    }
  }
  return o;
}
function Vt(t, e, r) {
  const n = [];
  return It(t, e, r, { spring: dt }).forEach(({ keyframes: c, transition: m }, E) => {
    n.push(...Ve(E, c, m));
  }), n;
}
class Dt {
...
function oe(t) {
  const [e, r] = Ue(t), n = ht(t), o = B(null);
  Tt(n, "change", (m) => r(m));
  const c = Xe(
    (m, E) => {
      o.current = kt(n, m, E);
...
function hr(t, e) {
  const [r, n] = Ue(cr), {
    ...
    animate: c,
    motionValue: m
  } = oe(fr), { value: E, animate: v } = oe(ur), { value: R, animate: p } = oe(lr), { value: g, animate: x } = oe(dr), l = gt(e, {
    fftSize: 512,
...
function Sr({
  ...
  return /* @__PURE__ */ q(Ge.Provider, { value: e, children: t });
}
function Ir() {
  const t = qe(Ge);
  if (t === null)

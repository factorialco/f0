...
const PeopleAnimated = React.forwardRef(({ animate = "normal", ...props }, ref) => {
    return (_jsxs("svg", { ref: ref, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", strokeWidth: "1.3", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", ...props, children: [_jsxs(motion.g, { initial: "normal", variants: personFrontVariants, animate: animate, transition: defaultTransition, children: [_jsx("circle", { cx: "9", cy: "9", r: "4" }), _jsx("path", { d: "M4.00003 18C4.00003 18 5.50003 16 9.00003 16C12.5 16 14 18 14 18" })] }), _jsxs(motion.g, { initial: "normal", variants: personBackVariants, animate: animate, transition: defaultTransition, children: [_jsx("path", { d: "M16 13C17.6569 13 19 11.6569 19 10C19 8.34315 17.6569 7 16 7" }), _jsx("path", { d: "M17 16C19 16 19.75 17 19.75 17" })] })] }));
});

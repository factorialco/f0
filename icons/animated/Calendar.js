...
const CalendarAnimated = React.forwardRef(({ animate = "normal", ...props }, ref) => {
    return (_jsx("svg", { ref: ref, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", strokeWidth: "1.3", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", ...props, children: _jsxs(motion.g, { variants: pageVariants, animate: animate, initial: "normal", transition: pageTransition, children: [_jsxs("g", { children: [_jsx("path", { d: "M5 10H19" }), _jsx("path", { d: "M5 8C5 6.34315 6.34315 5 8 5H16C17.6569 5 19 6.34315 19 8V10H5V8Z" }), _jsx("path", { d: "M9 3V7" }), _jsx("path", { d: "M15 3V7" })] }), _jsx("path", { d: "M5 10H19V16C19 17.6569 17.6569 19 16 19H8C6.34315 19 5 17.6569 5 16V10Z" }), _jsx("path", { d: "M5 10H19V16C19 17.6569 17.6569 19 16 19H8C6.34315 19 5 17.6569 5 16V10Z" })] }) }));
});

import { type IconName, type IconNamespace } from "./registry";
 ...
 */
export declare function resolveIconName(name: string): IconComponent | undefined;
/**
 ...
 */
export declare function resolveIcon(icon: IconType): IconComponent | undefined;
